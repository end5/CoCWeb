...
import { ValeriaFlags } from 'Content/Scenes/NPCs/Valeria';
...
export class GooArmor extends Armor {
    ...
    public useText(character: Character) { // Produces any text seen when equipping the armor normally
    ...
    public unequipText(): string { // Produces any text seen when removing the armor normally
