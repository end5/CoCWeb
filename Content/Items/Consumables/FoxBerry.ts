...
import { describeAllBreasts, breastCup, describeBreastRow, describeNipple } from 'Content/Descriptors/BreastDescriptor';
import { describeSkin, skinFurScales } from 'Content/Descriptors/SkinDescriptor';
...
export class FoxBerry extends Consumable {
    ...
    public use(character: Character): void | NextScreenChoices {
        ...
        if (character.body.skin.type === SkinType.FUR && character.body.face.type !== FaceType.FOX && changes < changeLimit && randInt(5) === 0) {
            ...
            if (Settings.sillyMode) CView.text("  And they called you crazy...");
            changes++;
