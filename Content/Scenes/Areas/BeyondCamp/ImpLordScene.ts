...
import { describeCockShort, describeCock, describeCockHead, nounCock, describeCocksLight } from 'Content/Descriptors/CockDescriptor';
...
export function impLordEncounter(player: Character): NextScreenChoices {
    ...
    return CombatManager.beginBattle(new Encounter(player, new ImpLord()));
}
