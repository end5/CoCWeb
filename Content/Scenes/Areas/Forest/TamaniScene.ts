...
import { describeAllBreasts, describeNipple, describeBreastRow } from 'Content/Descriptors/BreastDescriptor';
import { describeCock, describeCockHead, describeOneOfYourCocks, describeCocksLight, nounCock } from 'Content/Descriptors/CockDescriptor';
import { describeBalls } from 'Content/Descriptors/BallsDescriptor';
import { mf, boyGirl } from 'Content/Descriptors/GenderDescriptor';
...
function tamaniStartFight(player: Character): NextScreenChoices {
    ...
    return CombatManager.beginBattle(new Encounter(player, new Tamani()));
}
