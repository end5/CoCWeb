...
import { boostLactation, growTopBreastRowDownwards } from 'Content/Modifiers/BreastModifier';
import { displayStretchButt } from 'Content/Modifiers/ButtModifier';
import { numToCardinalCapText, numToCardinalText } from 'Content/Utilities/NumToText';
...
export function encounter(player: Character): NextScreenChoices {
    ...
    return CombatManager.beginBattle(new Encounter(player, new TentacleBeast()));
}
