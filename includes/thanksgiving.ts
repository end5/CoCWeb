...
public  datTurkeyRumpMeeting(): void {
	...
	simpleChoices("Let Approach", letZeTurkeyApproach, "Shoo Away", shooTurkeyAway, "", undefined, "", undefined, "", undefined);
}
...
public  letZeTurkeyApproach(): void {
	...
	simpleChoices("Baste Her", basteThatTurkeyBooty, "No Thanks", noThanksTurkeyGal, "", undefined, "", undefined, "", undefined);
}
...
public  basteThatTurkeyBooty(): void {
	...
	player.orgasm();
	dynStats("sen", -1);
	simpleChoices("Stuff Her", stuffDatTurkeyWithSpoo, "", undefined, "", undefined, "", undefined, "That'll Do", thatllDoTurkey);
}
...
public  stuffDatTurkeyWithSpoo(): void {
	...
	if(flags[kFLAGS.HEL_FUCKBUDDY] == 1 && flags[kFLAGS.HEL_REDUCED_ENCOUNTER_RATE] == 0) {
		...
		simpleChoices("Spit-Roast", spitRoastThatTurkey, "", undefined, "", undefined, "", undefined, "That's Enough", thatllDoTurkey);
	}
...
public  femaleLetZeTurkeyGalApproach(): void {
	...
	simpleChoices("Appetizer", turkeyAppetizer, "Main Course", femaleAndTurkeyMainCourse, "Dessert", haveTurkeyGirlDesertInYourCunt, "", undefined, "", undefined);
}
