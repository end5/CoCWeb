...
public  wormEncounter(): void {
	...
	if (player.findStatusAffect(StatusAffects.MetWorms) < 0) { //First encounter
		...
		simpleChoices("Confront", wormsConfront, "Do Nothing", wormsDoNothing, "", undefined, "", undefined, "Run", wormsRun);
	}
	else {
...
public  wormToggle(): void {
	...
	simpleChoices("Aroused", wormsOn, "Grossed Out", wormsOff, "Who Cares?", wormsPartiallyOn, "", undefined, "", undefined);
}
