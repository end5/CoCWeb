...
public  inquisitorRobesDiscovery(): void {
	...
	simpleChoices("Retribution", retributionArmorIsCoolShit, "Carnality", carnalityArmorIsCoolShitToo, "", undefined, "", undefined, "NOPE!", noThankYouSirIDontWantAwesomeArmors);
}
...
public  dominikaSpellblade(): void {
	outputText("", true);
