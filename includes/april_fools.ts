...
export class april_fools extends CoC {

    //for all april fools gags

    // Encounter Chance 1 out of 40 and only if you're a centaur
    public poniesYN(): boolean {
        if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR && date.date == 1 && date.month == 3 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00118] == 0) {
            outputText("", true);
            ...
            simpleChoices("Approach", this.approachPonies, "", undefined, "", undefined, "", undefined, "Leave", this.leavePonies);
    ...
    public approachPonies(): void {
        ...
        if (this.player.weaponName != "fists") outputText(", especially armed strangers", false);
        outputText(".\n\n", false);
        ...
        simpleChoices("Too creepy", this.derpCreepy, "Yay Party!", this.derpyParty, "", undefined, "", undefined, "Leave", this.derpPolitely);
    }
    ...
    public derpyParty(): void {
        ...
        doNext(this.camp.returnToCampUseEightHours);
    }
    /*Notes:
    ---------------------------------------------------------------------------------------------------------------------------------------------
