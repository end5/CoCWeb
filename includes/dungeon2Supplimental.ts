...
private static  DUNGEON_CAVE_ENTRANCE: number			= 10;
private static  DUNGEON_CAVE_TUNNEL: number			= 11;
private static  DUNGEON_CAVE_GATHERING_HALL: number	= 12;
private static  DUNGEON_CAVE_FUNGUS_CAVERN: number		= 13;
private static  DUNGEON_CAVE_TORTURE_ROOM: number		= 14;
private static  DUNGEON_CAVE_SECRET_TUNNEL: number		= 15;
private static  DUNGEON_CAVE_ZETAZ_CHAMBER: number		= 16;
...
//IMP GANG [ATTACKS!]  
public  imtacularMultiHitzilla(): void {
	//Multiattack:
...
public  impGangVICTORY(): void {
	...
	if(player.lust >= 33 && player.gender > 0) {
		...
		if (player.gender == 1) simpleChoices("Rape", impGangGetsRapedByMale, "", undefined, "", undefined, "", undefined, "Leave", cleanupAfterCombat);
		if (player.gender == 2) simpleChoices("Rape", impGangGetsRapedByFemale, "", undefined, "", undefined, "", undefined, "Leave", cleanupAfterCombat);
		if (player.gender == 3) simpleChoices("Male Rape", impGangGetsRapedByMale, "Female Rape", impGangGetsRapedByFemale, "", undefined, "", undefined, "Leave", cleanupAfterCombat);
	}
	else cleanupAfterCombat();
}

//RAEP -M
public  impGangGetsRapedByMale(): void {
	outputText("", true);
...
//RAEP-F
public  impGangGetsRapedByFemale(): void {
	outputText("", true);
...
public  enterZetazsRoomFromTheSouth(): void {
...
public  encapsulationPodAI(): void {
	//[Round 1 Action]
...
public  loseToThisShitPartII(): void {
	hideUpDown();
	outputText("", true);
	//[OPTIONAL CUM ESCAPE]
	if(player.cumQ() > 3500) {
...
public  encapsulationVictory(): void {
	if(monster.HP <= 0) {
		flags[kFLAGS.ZETAZ_FUNGUS_ROOM_DEFEATED]++;
		outputText("", true);
...
var  heal = undefined;
	...
	simpleChoices("Fix Her", heal, "Sex", (player.gender > 0 ? ValaGetsSexed : undefined), "Reject", rejectFuckingVala, "", undefined, "", undefined);
}

//[Heal]
public  healVala(): void {
	spriteSelect(85);
	outputText("", true);
...
public  healValaPartTwoTheHealingHealsOfRevenge(): void {
	spriteSelect(85);
	outputText("", true);
...
//(Very loose ass)
public  loseToValaMaleIIVeryLoose(): void {
	spriteSelect(85);
	outputText("", true);
...
//(Gaping asshole)
public  loseToValaMaleIIGape(): void {
	spriteSelect(85);
	outputText("", true);
...
public  fightValaVictory(): void {
	...
	if(player.gender > 0) {
		...
		simpleChoices("Fuck", valaFightVictoryFuck, "", undefined, "", undefined, "", undefined, "Leave", cleanupAfterCombat);
	}
	else cleanupAfterCombat();
...
//[Fuck]
public  valaFightVictoryFuck(): void {
	spriteSelect(85);
	outputText("", true);
	//(Female) 
	if(player.gender == 2) {
...
//[Fuck]
public  valaFightVictoryFuckPtII(): void {
	spriteSelect(85);
	outputText("", true);
	//fem2
	if(player.gender == 2) {
...
public  tryToHealValaWHoney2(): void {
	spriteSelect(85);
	outputText("", true);
...
//[Use]
public  useValaOHYEAHSNAPINTOASLIMJIM(): void {
	spriteSelect(85);
	outputText("", true);
	//(Male)
	if(player.gender == 1) {
...
//[Wake]
public  wakeValaUpBeforeYouGoGo(): void {
	spriteSelect(85);
	outputText("", true);
	//(Male)
	if(player.gender == 1) {
...
public  isValaAtBar(): boolean {	return (flags[kFLAGS.FREED_VALA] != 0 && model.time.hours >= 12 && model.time.hours <= 21); }

//Purified Fairy
public  purifiedFaerieBitchBar(): boolean {
...
//[Vala]
public  chooseValaInBar(): void {
	spriteSelect(60);
var  cumBath = undefined;
	...
	if(flags[kFLAGS.ENCOUNTERED_VALA_AT_BAR] == 0) {
		...
		if(flags[kFLAGS.WEEKLY_FAIRY_ORGY_COUNTDOWN] == 0) {
			...
			//[Fairies][You][Leave]
			simpleChoices("Faeries", faerieOrgyFuck, "You", cleansedValaRepeatBrainFucking, "Cum Bath", cumBath, "", undefined, "Leave", telAdre.barTelAdre);
		}
		else simpleChoices("You", cleansedValaRepeatBrainFucking, "", undefined, "Cum Bath", cumBath, "", undefined, "Leave", telAdre.barTelAdre);
		if(flags[kFLAGS.WEEKLY_FAIRY_ORGY_COUNTDOWN] == 0)
...
public  cleansedFirstRemeet(): void {
	...
	//[You][Leave]
	simpleChoices("You", cleansedValaFuckHerBrainsOut, "", undefined, "", undefined, "", undefined, "Leave", telAdre.barTelAdre);
}

//[You] 
public  cleansedValaFuckHerBrainsOut(): void {
	spriteSelect(60);
	outputText("", true);
...
//Part 2
public  cleansedValaFuckHerBrainsOutPtII(): void {
	spriteSelect(60);
	outputText("", true);
	//dicks + growth
	if(player.totalCocks() > 0) {
...
//[You]
public  cleansedValaRepeatBrainFucking(): void {
	spriteSelect(60);
	outputText("", true);
...
public  faerieOrgyFuck(): void {
	...
	if(player.gender == 3) {
		...
		simpleChoices("Male", faerieOrgyFuckMaleContinue, "Female", faerieOrgyFuckFemaleContinue, "", undefined, "", undefined, "", undefined);
	}
...
//[Male]
public  faerieOrgyFuckMaleContinue(): void {
	spriteSelect(60);
	outputText("", true);
...
//[Female]
public  faerieOrgyFuckFemaleContinue(): void {
	spriteSelect(60);
	outputText("", true);
...
public  defeatZetaz(): void {
	...
	simpleChoices("Sexual", sexualInterrogation, "End Him", endZetaz, "Safety", releaseZForInfo, "", undefined, "", undefined);
}
...
public  sexualInterrogation(): void {
	...
	simpleChoices("'Release'", sexualTortureReleaseZetaz, "Tighten", sexualTortureTightenZetaz, "End Him", endZetaz, "", undefined, "", undefined);
}

//[Release Him]
private  sexualTortureReleaseZetaz(): void {
	outputText("", true);
...
public  theSeanShopOffer(): void {
	...
	simpleChoices("Deal", incubusDeal, "No Deal", incubusNoDeal, "", undefined, "", undefined,"", undefined);
}
...
public  bigValaLicksOffDudes(): void {
	clearOutput();
...
public  valaVapulaThreesome(): void {
	//{First Meeting} 
...
public  valaDommyVapula3Some(): void {
	clearOutput();
	valaVapulaThreesome();
...
//[next]
public  valaPartIIWaifuLove(): void {
	clearOutput();
	model.time.hours = 6;
	model.time.days++;
