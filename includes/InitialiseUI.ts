...
// var gButtons: any[] = new Array();
//No longer used, choices now calls addButton:	public var buttonEvents: any[] = new Array();
...
// for (var loopCnt: number = 0; loopCnt < NUM_OF_BUTTONS; loopCnt++)
// {
...
// var index: number = 0;
// var xOffset: number = 200; //Absolute offsets, here to stay?
// var yOffset: number = 668;
// var buttonWidth: number = 160;
// var rowSeparation: number = 52;
