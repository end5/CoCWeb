private static  DUNGEON_FACTORY_FOYER: number				= 9;
private static  DUNGEON_FACTORY_PUMP_ROOM: number			= 1;
private static  DUNGEON_FACTORY_BREAK_ROOM: number			= 2;
private static  DUNGEON_FACTORY_FURNACE_ROOM: number		= 3;
private static  DUNGEON_FACTORY_REPAIR_CLOSET: number		= 4;
private static  DUNGEON_FACTORY_MAIN_CHAMBER: number		= 5;
private static  DUNGEON_FACTORY_FOREMANS_OFFICE: number	= 6;
private static  DUNGEON_FACTORY_PUMP_CONTROL: number		= 7;
private static  DUNGEON_FACTORY_STORE_ROOM: number			= 8;
...
public  enterFactory(): void {
	...
	simpleChoices("Enter", actuallyEnterFactory, "", undefined, "", undefined, "", undefined, "Leave", camp.returnToCampUseOneHour);
}
...
private  succubusTalkOne(): void {
	...
	simpleChoices("For what?", succubusTalkTwo, "Yes", succubusBadEnd, "No", succubusRefuseOffer, "", undefined, "", undefined);
}
...
private  succubusTalkTwo(): void {
	...
	simpleChoices("Sick!", succubusRefuseOffer, "Sounds Fun", succubusBadEnd, "", undefined, "", undefined, "", undefined);
}
...
public  succubusVictoryRape(): void {
	...
	//FEMSAUCE
		...
		if(player.biggestLactation() > 1) {
			...
			simpleChoices("Scissor", dungeonSuccubusForceScissor, "ForceFeed", dungeonSuccubusForceFeed, "", undefined, "", undefined, "", undefined);
		}
...
simpleChoices("Fight", startIncubusFight, "Trade", tradeComic, "Submit", submitToIncubus, "", undefined, "", undefined);
	}
	else {
		...
		simpleChoices("Fight", startIncubusFight, "Submit", submitToIncubus, "", undefined, "", undefined, "", undefined);
	}
}
