...
var  mount = undefined;
	...
	else simpleChoices("Fuck It", fuck, "Mount It", mount, "", undefined, "", undefined, "No Way", camp.returnToCampUseOneHour);
}
...
//>Next
public  pumpkinMountingLevelII(): void {
	clearOutput();
...
//Introduction
public  feraSceneTwoIntroduction(): void {
	clearOutput();
...
public  dickBoostingFuntimes(): void {
	...
	for(var x: number = 0; x < player.cocks.length; x++) {
