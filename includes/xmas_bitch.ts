...
public  xmasBitchEncounter(): void
{
	...
	if (player.cor >= 90 || monk >= 5 || player.findStatusAffect(StatusAffects.Exgartuan) >= 0 || amilyScene.amilyCorrupt() || flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00283] > 0 || flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0 || flags[kFLAGS.NIAMH_STATUS] > 0)
	{
		...
		simpleChoices("OpenPresent", openXmasPresent, "", undefined, "Decline", declineXmasPresent, "", undefined, "", undefined);
		return;
	}
	if (player.gender == 0)
	{
	...
	//[Open Present] [Unwrap Elf] [Decline]
	simpleChoices("OpenPresent", openXmasPresent, "Unwrap Elf", unwrapElfyPresent, "Decline", declineXmasPresent, "", undefined, "", undefined);
}
