...
private static  DUNGEON_HEL_GUARD_HALL: number		= 17;
private static  DUNGEON_HEL_WINE_CELLAR: number	= 18;
private static  DUNGEON_HEL_STAIR_WELL: number		= 19;
private static  DUNGEON_HEL_DUNGEON: number		= 20;
private static  DUNGEON_HEL_MEZZANINE: number		= 21;
private static  DUNGEON_HEL_THRONE_ROOM: number	= 22;
...
public  takeGooArmor(): void {
	...
	simpleChoices("Take Armor", takeGooArmor4Realz, "", undefined, "", undefined, "", undefined, "Back", playerMenu);
...
public  beatUpGooArmor(): void {
	...
	simpleChoices("Take Her", takeGooArmorAndWearIt, "Refuse Her", refuseGooArmorOffer, "", undefined, "", undefined, "", undefined);
...
var  wanked = undefined;
var  rideAnal = undefined;
var  rideVaginal = undefined;
	if(player.lust > 33) {
	...
	choices("Missionary", missionary, "Get Wanked", wanked, "Ride Anal", rideAnal, "Ride Vaginal", rideVaginal, "", undefined, "", undefined, "", undefined, "", undefined, "", undefined, "Back", playerMenu);
}
...
var  hakon = undefined;
	...
	simpleChoices("Hakon", hakon, "Kiri", heliaKiriTalk, "Queen", queen, "", undefined, "Back", playerMenu);
}
...
public  letHarpyQueenGo(): void {
	...
	if(flags[kFLAGS.HEL_KNOWS_ABOUT_HAKON] == 1) {
		...
		simpleChoices("Forgive", harpyQueenLetHerGoForgive, "Berate", harpyQueenLetHerGoBerate, "", undefined, "", undefined, "", undefined);
...
var  anal = undefined;
	...
	simpleChoices("Anal", anal, "Vaginal", vaginalHarpyQueenSex, "", undefined, "", undefined, "Back", playerMenu);
}
