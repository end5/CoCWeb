...
import { BeeGirlFlags } from 'Game/Scenes/Areas/Forest/BeeGirl';
import { JojoFlags } from 'Game/Scenes/NPCs/Jojo';
...
import { isEaster } from 'Game/Utilities/Dates';
import { randAnySizeEgg } from 'Game/Items/Consumables/Eggs';
...
function dropItem(char: Character, enemy: Character): Item | void {
    ...
    if (enemy.charType === CharacterType.Harpy || enemy.charType === CharacterType.Sophie) {
        ...
        else if (randInt(3) === 0 && char.effects.has(EffectType.LuststickAdapted)) itype = ConsumableName.LustStick;
