...
export class Tamani extends Character {
    ...
    public constructor() {
        ...
        this.effects.add(StatusEffectType.BonusVCapacity, { vaginalCapacity: 55 });
        ...
        this.effects.add(StatusEffectType.BonusACapacity, { analCapacity: 40 });
        ...
        this.stats.base.str.value = 32;
        this.stats.base.tou.value = 43;
        this.stats.base.spe.value = 55;
        this.stats.base.int.value = 62;
        this.stats.base.lib.value = 65;
        this.stats.base.sens.value = 65;
        this.stats.base.cor.value = 50;
        this.stats.base.HP.max += 40;
        this.stats.base.HP.value += 40;
        this.stats.base.lust.value = 40;
