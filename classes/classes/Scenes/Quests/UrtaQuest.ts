 ...
 */
    ...
    public urtaBusy(): boolean {
        return (this.telAdre.edryn.pregnancy.type == PregnancyStore.PREGNANCY_TAOTH || this.flags[kFLAGS.URTA_QUEST_STATUS] == -1);
    }
    public isUrta(): boolean {
        if (this.flags[kFLAGS.URTA_QUEST_STATUS] > 0 && this.flags[kFLAGS.URTA_QUEST_STATUS] < 1) {
            if (this.player.short == "Urta") {
                if (this.player.hasCock()) {
                    if (this.player.cocks[0].cockLength == 20 && this.player.cocks[0].cockThickness == 3) {
                        if (this.player.hasVagina()) {
                            if (this.player.breastRows[0].breastRating == 7) return true;
                        }
                    }
                }
            }
    ...
    public talkWithUrtaAboutFamFam(): void {
        ...
        this.flags[kFLAGS.URTA_QUEST_STATUS] = .5;
        //Insert PC options here
        //[Comfort Her] [Yeesh][Who Cares]
        this.menu();
        this.addButton(this, 0, "Comfort Her", this.comfortUrtaAfterFamFamTalk);
        this.addButton(this, 1, "Yeesh", this.yeeshUrtaAfterFamFamTalk);
        this.addButton(this, 2, "Who Cares", this.whoCaresUrtaAfterFamFamTalk);
    }
    ...
    private comfortUrtaAfterFamFamTalk(): void {
        ...
        if (this.urta.urtaDrunk()) this.outputText("boozy ");
    ...
    public infertilityQuestions(): void {
        ...
        this.outputText("\n\nWell, ");
        if (this.player.cor < 33) this.outputText("you have nothing to complain about there.  Your sexual romps with Urta are always a delight.");
        else if (this.player.cor < 66) this.outputText("she's definitely a handful in the sack, you've got to give her that.");
        else this.outputText("she's a willing fuck, so no complaints there.  Now if she would just get on with it - if you wanted to flirt, you would've instigated it.");
        ...
        this.menu();
        this.addButton(this, 0, "Look Into It", this.startUrtaQuest);
        this.addButton(this, 1, "Maybe Later", this.camp.returnToCampUseOneHour);
    }
    ...
    public startUrtaQuest(): void {
        ...
        this.player.itemSlot1 = new ItemSlotClass();
        this.player.itemSlot2 = new ItemSlotClass();
        this.player.itemSlot3 = new ItemSlotClass();
        this.player.itemSlot4 = new ItemSlotClass();
        this.player.itemSlot5 = new ItemSlotClass();
        ...
        this.player.createStatusAffect(StatusAffects.BonusVCapacity, 58, 0, 0, 0);
        ...
        this.player.createPerk(PerkLib.Nymphomania, 0, 0, 0, 0);
        this.player.createPerk(PerkLib.Precision, 0, 0, 0, 0);
        this.player.createPerk(PerkLib.Seduction, 0, 0, 0, 0);
        ...
        this.player.createPerk(PerkLib.Brawler, 0, 0, 0, 0);
        ...
        this.clearOutput();
        this.flags[kFLAGS.URTA_QUEST_STATUS] = .75;
        ...
        this.menu();
        this.addButton(this, 0, "Next", this.towerOfTheCovanant);
    }
    ...
    private towerOfTheCovanant(): void {
        ...
        //[NEXT]
        this.menu();
        this.addButton(this, 0, "Next", this.towerOfTheCovenantII);
    }
    ...
    private towerOfTheCovenantII(): void {
        ...
        if (this.flags[kFLAGS.HEL_FUCKBUDDY] > 0) {
            this.addButton(this, 0, "Stop4ADrink", this.getHelBangedAsUrta);
        }

        this.addButton(this, 1, "Visit", this.visitPCPreUrtaQuest, false);
        this.addButton(this, 2, "Visit Truth", this.visitPCPreUrtaQuest, true);
        this.addButton(this, 3, "Embark", this.runIntoAGoblin);
    }
    ...
    private getHelBangedAsUrta(): void {
        ...
        if (this.flags[kFLAGS.HEL_HARPY_QUEEN_DEFEATED] > 0) this.outputText(", and even how they worked together to bring down an evil sorceress and save her father. Your heart swells with pride as she recounts " + this.player2.short + " doing so a noble thing, and for a moment you know you made the right pick in a lover..");
        ...
        this.menu();
        this.addButton(this, 0, "Head Out", this.leaveB4HelFucksUrta);
        this.addButton(this, 1, "Get \"Help\"", this.fuckHelAndKitsunesAsUrta);
    }
    ...
    private fuckHelAndKitsunesAsUrta(): void {
        ...
        if (this.player2.hasCock()) {
            ...
            else this.outputText("at my beck and call");
        ...
        //{Resume UrtaQUEST!}
        this.menu();
        this.addButton(this, 0, "Next", this.runIntoAGoblin);
    }
    ...
    private visitPCPreUrtaQuest(truth: boolean): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.JojoNightWatch) >= 0 && this.player.findStatusAffect(StatusAffects.PureCampJojo) >= 0)
        ...
        if (this.flags[kFLAGS.ANEMONE_WATCH] > 0 && this.flags[kFLAGS.ANEMONE_KID] > 0)
            this.outputText("A confused-looking anemone with a " + ItemType.lookupItem(this.flags[kFLAGS.ANEMONE_WEAPON_ID]).longName + " nearly sees you, but you duck around a rock and escape her notice.  ");
        if (this.flags[kFLAGS.FUCK_FLOWER_LEVEL] >= 4 && this.flags[kFLAGS.FUCK_FLOWER_KILLED] == 0 && this.flags[kFLAGS.HOLLI_DEFENSE_ON] > 0)
        ...
        if (this.camp.companionsCount() > 2) this.outputText("There are a number of people in the camp, but you avoid them as you head towards " + this.player2.short + "'s bunk.  ");
        ...
        if (this.player.findStatusAffect(StatusAffects.DungeonShutDown) >= 0) this.outputText(", no matter why " + this.player2.mf("he", "she") + " was sent here");
        ...
        if (truth) {
            ...
            if (this.player2.cor < 33) this.outputText(this.player2.mf("he", "she") + " argues that " + this.player2.mf("he", "she") + " should come anyway.  You tell " + this.player2.mf("him", "her") + " no, firmly, even though it breaks your heart.");
        ...
        this.menu();
        this.addButton(this, 0, "Cuddle", this.snuggleWithUrta, truth);
        //Put Urta dick in girl PC's vag(C)*
        if (this.player2.hasVagina())
            this.addButton(this, 1, "FuckHerVag", this.putUrtasWangInPCsCunt, truth);
        //Put a PC dick in Urta's vag(C)*
        if (this.player2.cockThatFits(this.urta.urtaCapacity()) >= 0)
            this.addButton(this, 2, "Ride Dick", this.putAPCDickInUrtaCoochies, truth);
        //Put Urta dick in the PC's asshole [Cocked PCs](C)*
        if (this.player2.hasCock())
            this.addButton(this, 3, "Fuck Ass", this.urtaPutsHerDickInPCsWithDicks, truth);
        //PC blows Urta(C)*
        this.addButton(this, 4, "Get BJ", this.pcBlowsUrtasDong, truth);
    }
    ...
    private urtaPutsHerDickInPCsWithDicks(truth: boolean): void {
        ...
        if (this.player2.tallness < 60) this.outputText(" and let your tits hang over " + this.player2.mf("his", "her") + " " + this.player2.face());
        else if (this.player2.tallness < 76) this.outputText(" and let your tits swing between you");
        else if (this.player2.tallness < 84) this.outputText(" and let your tits smash into " + this.player2.mf("his", "her"));
        else this.outputText(" and let your tits sway over " + this.player2.mf("his", "her") + " belly");
        ...
        if (this.player2.hasVagina()) this.outputText(", past " + this.player2.mf("his", "her") + " pussy,");
        ...
        if (this.player2.analCapacity() > 70) this.outputText("  Thankfully, " + this.player2.mf("he", "she") + "'s nice and stretched from all the butt-fucking " + this.player2.mf("he", "she") + "'s had to take, and you easily pop inside.  It feels so good that your flare grows wider, pulling you deeper into that welcoming, tight anal heat.");
        else if (this.player2.analCapacity() > 50) this.outputText("  Thankfully, " + this.player2.mf("he", "she") + "'s got plenty of give in " + this.player2.mf("his", "her") + " back-door, and you pop inside after applying a little more pressure.  It feels so good that your flare grows wider, slowing your descent into that tight, anal heat.");
        else this.outputText("  Unfortunately, there's not much give in " + this.player2.mf("his", "her") + " back-door, and you have to sit there smearing pre over it, again and again, each time pushing a little harder.  After what feels like the fiftieth try, you finally pop your fat flare into " + this.player2.mf("his", "her") + " rectum, the tight anal heat causing you to flare from the force of " + this.player2.mf("his", "her") + " pressure.  Slowly, you push inch after throbbing inch of your swollen, stallion-like erection into " + this.player2.mf("his", "her") + " asshole.");
        ...
        if (this.player2.cockTotal() > 1) this.outputText("s");
        ...
        if (this.player2.hasVagina()) this.outputText("  You don't notice the female fluids that drip from her sodden slit - they soak into your big balls, already forgotten.");
        ...
        if (this.player2.cumQ() >= 500) {
            ...
            if (this.player2.cockTotal() > 1) this.outputText("s exude");
            else this.outputText(" exudes");
        }
        ...
        if (this.player2.cumQ() >= 500) {
            ...
            if (this.player2.cumQ() < 1000) this.outputText("puddly");
            else if (this.player2.cumQ() < 2500) this.outputText("small lake-sized");
            else this.outputText("massive, lake-sized");
            this.outputText(" mess - only now do you realize just how much your lover could produce!  The");
        }
        else this.outputText(", but the");
        ...
        this.addButton(this, 0, "Next", this.morningAfterCampVisitEmbark, truth);
    }
    ...
    private putAPCDickInUrtaCoochies(truth: boolean): void {
        ...
        if (this.player2.gender == 3) this.outputText("...well, close enough... ");
        ...
        if (this.player2.hasVagina()) this.outputText(", her cunt dripping wetly onto the ground from the stimulus");
        ...
        if (this.player2.isTaur() || this.player2.isDrider()) {
            ...
            if (!this.player2.isDrider()) this.outputText("quadrapedal");
            else this.outputText("octapedal");
            ...
            if (this.player2.cumQ() < 1000) this.outputText("falling face-first into the jizz-mud");
            else this.outputText("not even bothering trying to move your swollen bulk");
        ...
        //Else:
            ...
            if (this.player2.hasVagina()) this.outputText(", her female jizz spattering unnoticed onto the ground beneath the pair of you");
            this.outputText(".");
            ...
            if (this.player2.cumQ() >= 1000) this.outputText(" not to mention the weight of your overstuffed belly");
    ...
    private putUrtasWangInPCsCunt(truth: boolean): void {
        ...
        if (this.player.vaginaType() != 5) this.outputText("pink, ");
        ...
        if (this.player2.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150) this.outputText("the curve of her pregnant belly");
        else if (this.player2.tone >= 65) this.outputText("her toned abdomen");
        else if (this.player2.tone < 30) this.outputText("her soft, forgiving middle");
        else this.outputText("her belly");
        ...
        if (this.player2.isTaur()) {
            ...
            if (this.player2.tailType > TAIL_TYPE_NONE) this.outputText("  You stroke her tail as you shift it aside");
            else this.outputText("  You stroke her swollen sex as you admire it");
            ...
            if (this.player2.wetness() >= 4) this.outputText("  Fuck, she's wetter than Edryn!  Just look at those heavy trails of slick moisture as they run down her rump and hindlegs.");
            else if (this.player2.wetness() >= 2) this.outputText("  Fuck, she's as wet as Edryn!  Beads of moisture are forming on her clit, ready to drop to the ground.");
            else this.outputText("  Fuck, she's almost as wet as Edryn!  Just getting a sniff of her horny horse-snatch has your head swimming!");
            this.outputText("  You give it a lick and shudder, taking in a few deep lungfuls of her scent.");
            if (this.player2.tallness >= 84) this.outputText("  Before you know what you're doing, you've pulled her back to a rock and climbed atop it, bringing your cock level with that heavenly hole.");
            else this.outputText("  Before you know what you're doing, you've raised yourself up to your full height, bringing your cock level with that heavenly hole.");
        }
        //{goo}
            ...
            if (this.player2.clitLength < .5) this.outputText("tiny ");
            else if (this.player2.clitLength >= 2.5) this.outputText("massive ");
        ...
        //{nagas}
            ...
            if (this.player2.wetness() >= 3) this.outputText("  Her moisture drizzles from that wanton slit, basting you with her fragrant femininity, and you have a hard time not taking her here and now.");
        ...
        //{biped}
            ...
            if (this.player2.wetness() < 3) this.outputText("every drop of nectar that she gives up");
            else if (this.player2.wetness() < 4) this.outputText("the copious drops of nectar she gives up");
            else if (this.player2.wetness() < 5) this.outputText("the drizzling moisture that oozes from her twat");
            else this.outputText("the rivers of girl-lube that run unimpeded from her sopping twat");
        ...
        if (this.player2.vaginalCapacity() >= 200) this.outputText(", though you know she can handle cocks with Edryn's ease");
        ...
        if (this.player2.pregnancyIncubation > 0 && this.player2.pregnancyIncubation < 150) this.outputText(" (more than it already is)");
        ...
        if (this.player2.pregnancyIncubation > 0 && this.player2.pregnancyIncubation < 150) this.outputText(" pregnant");
    ...
    private snuggleWithUrta(truth: boolean): void {
        ...
        if (this.player2.isTaur() || this.player2.isDrider()) {
            ...
            if (this.player2.isTaur()) this.outputText("centaur");
            else this.outputText("drider");
            this.outputText(" body, but you manage to press up against " + this.player2.mf("his", "her") + " ");
            if (this.player2.isTaur()) this.outputText("forehoofs");
            else this.outputText("first two pairs of spidery limbs");
            this.outputText(".");
        }
        //[if PC Naga:]
        else if (this.player2.isNaga()) this.outputText("  " + this.player2.mf("His", "Her") + " serpentine coils loop snugly around your waist, curling around your legs and holding you gently in place.");
        //[if PC Goo:
        else if (this.player.isGoo()) this.outputText("  " + this.player2.mf("His", "Her") + " soft, squishy goo-body eagerly accepts you, the gelatinous mass of " + this.player2.mf("his", "her") + " lower torso reaching out to softly envelop you in its cool, wet embrace.");
        //[Else:
        else this.outputText("  Knees to knees, it takes you a few moments to figure out how to properly position your legs, but you eventually manage it.");
        ...
        if (this.player2.cor < 33) this.outputText("playful pat");
        else if (this.player2.cor < 66) this.outputText("gentle stroke");
        else this.outputText("lascivious caress");
    ...
    private morningAfterCampVisitEmbark(truth: boolean): void {
        ...
        this.menu();
        this.addButton(this, 0, "Next", this.runIntoAGoblin, true);
    }
    ...
    public winFuckAGoblinBroodmotherAsUrta(): void {
        ...
        if (this.monster.HP < 1) this.outputText("submissive");
        else this.outputText("feverishly masturbating");
        ...
        this.player.orgasm();
        this.menu();
        this.addButton(this, 0, "Next", this.nagaPleaseNagaStoleMyDick);
    }
    ...
    public urtaLosesToGoblin(): void {
        ...
        //[next]
        this.menu();
        this.addButton(this, 0, "Next", this.loseToGoblinsPartIIAsUrta);
    }
    ...
    private loseToGoblinsPartIIAsUrta(): void {
        ...
        //[Next]
        this.menu();
        this.addButton(this, 0, "Next", this.loseToGoblinsPartIIIAsUrta);
    }
    ...
    private loseToGoblinsPartIIIAsUrta(): void {
        ...
        //[next]
        this.menu();
        this.addButton(this, 0, "Next", this.loseToGoblinsPartIVAsUrta);
    }
    ...
    private loseToGoblinsPartIVAsUrta(): void {
        ...
        this.flags[kFLAGS.URTA_GOBLIN_SLAVE] = 1;
        this.menu();
        this.addButton(this, 0, "Next", this.urtaGameOver);
    }
    ...
    public urtaSpecials(): void {
        //Gone	menuLoc = 3;
        if (this.getGame().inCombat && this.player.findStatusAffect(StatusAffects.Sealed) >= 0 && this.player.statusAffectv2(StatusAffects.Sealed) == 5) {
            this.clearOutput();
        ...
        this.menu();
        this.addButton(this, 0, "Combo", this.urtaComboAttack);
        this.addButton(this, 1, "Vault", this.urtaVaultAttack);
        this.addButton(this, 2, "Sidewinder", this.urtaSidewinder);
    ...
    private urtaSecondWind(): void {
        ...
        this.monster.createStatusAffect(StatusAffects.UrtaSecondWinded, 0, 0, 0, 0);
    ...
    private urtaComboAttack(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.Attacks) < 0)
            this.player.createStatusAffect(StatusAffects.Attacks, 3, 0, 0, 0);
        else {
            this.player.addStatusValue(StatusAffects.Attacks, 1, -1);
            trace("DECREMENDED ATTACKS");
            if (this.player.statusAffectv1(StatusAffects.Attacks) <= 1) {
        ...
        var damage: number;
        //Determine if dodged!
        if (this.monster.findStatusAffect(StatusAffects.Blind) < 0 && (UrtaQuest.rand(3) == 0 || (this.player.findStatusAffect(StatusAffects.Blind) >= 0 && UrtaQuest.rand(2) == 0) || (this.monster.spe - this.player.spe > 0 && Math.floor(Math.random() * (((this.monster.spe - this.player.spe) / 4) + 80)) > 80))) {
        ...
        if (UrtaQuest.rand(100) <= 4 || (this.player.findPerk(PerkLib.Tactician) >= 0 && this.player.inte >= 50 && (this.player.inte - 50) / 5 > UrtaQuest.rand(100))) {
            crit = true;
            damage *= 2;
        }
        ...
        if (this.monster.HP >= 1 && this.monster.lust <= 99) {
            ...
            if (this.monster.HP <= 0) this.doNext(this, kGAMECLASS.endHpVictory);
            else this.doNext(this, kGAMECLASS.endLustVictory);
        }
    }
    ...
    private urtaDirtKick(): void {
        ...
        else this.outputText("Spinning about, you drag your footpaw through the dirt, kicking a wave of debris towards " + this.monster.a + this.monster.short + "!  ");
        //Dodged!
    ...
    private urtaSidewinder(): void {
        ...
        var damage: number;
        //Determine if dodged!
        if ((this.player.findStatusAffect(StatusAffects.Blind) >= 0 && UrtaQuest.rand(2) == 0) || (this.monster.spe - this.player.spe > 0 && Math.floor(Math.random() * (((this.monster.spe - this.player.spe) / 4) + 80)) > 80)) {
            if (this.monster.spe - this.player.spe < 8) this.outputText(this.monster.capitalA + this.monster.short + " narrowly avoids your attack!", false);
            if (this.monster.spe - this.player.spe >= 8 && this.monster.spe - this.player.spe < 20) this.outputText(this.monster.capitalA + this.monster.short + " dodges your attack with superior quickness!", false);
            if (this.monster.spe - this.player.spe >= 20) this.outputText(this.monster.capitalA + this.monster.short + " deftly avoids your slow attack.", false);
            this.outputText("\n\n", false);
        ...
        if (this.monster.findStatusAffect(StatusAffects.Stunned) < 0 && this.monster.findPerk(PerkLib.Resolute) < 0 && damage > 0) {
    ...
    private urtaVaultAttack(): void {
        ...
        else this.outputText("You leap into the air, intent on slamming your " + this.player.weaponName + " into your foe!  ");
        var damage: number;
        //Determine if dodged!
        if ((this.player.findStatusAffect(StatusAffects.Blind) >= 0 && UrtaQuest.rand(2) == 0) || (this.monster.spe - this.player.spe > 0 && Math.floor(Math.random() * (((this.monster.spe - this.player.spe) / 4) + 80)) > 80)) {
            if (this.monster.spe - this.player.spe < 8) this.outputText(this.monster.capitalA + this.monster.short + " narrowly avoids your attack!", false);
        ...
        //Determine if critical hit!
        var crit: boolean = false;
        if (this.monster.findStatusAffect(StatusAffects.Stunned) >= 0 || UrtaQuest.rand(100) <= 4 || (this.player.findPerk(PerkLib.Tactician) >= 0 && this.player.inte >= 50 && (this.player.inte - 50) / 5 > UrtaQuest.rand(100))) {
            crit = true;
            damage *= 2;
        }
        //Start figuring enemy damage resistance
    ...
    public urtaBeatsUpSiriusRadio(): void {
        ...
        //[Rape][Leave]
        this.menu();
        this.addButton(this, 0, "Fuck Him", this.urtaWinFucksSirius);
        this.addButton(this, 1, "Leave", this.leaveSiriusBehind);
    }
    ...
    private leaveSiriusBehind(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Next", this.gnollAlphaBitchIntro);
    }
    ...
    private urtaWinFucksSirius(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Next", this.fuckSiriusRadioII);
    }
    ...
    public urtaLosesToSirriusSnakeRadio(): void {
        ...
        //Loss by HP:
        if (this.player.HP < 1) this.outputText("You cry out in pain as the bruises and buffets you've taken overwhelm you.  You struggle to stay upright, but to no avail; your injured body has reached its limits and you collapse, helpless and at the mercy of your assailant.");
        //Loss by Lust:
        else this.outputText("With a hollow moan of anguish, you cast aside your halberd and fall to your knees, tears stinging your eyes as you desperately jerk and maul at your huge horse-prick.  The cursed thing has betrayed you again, and now you're too addled by lust and need to defend yourself from whatever this naga has in store for you.");
        ...
        this.menu();
        this.addButton(this, 0, "Next", this.siriusSatelliteRadioOwnsYouII);
    }
    ...
    public winRapeHyenaPrincess(): void {
        ...
        if (this.monster.HP < 1) this.outputText(".  In spite of her wounded state, she seems to be quite excited by the situation");
        this.outputText(".");
        ...
        this.player.orgasm();
        this.menu();
        this.addButton(this, 0, "Next", this.urtaNightSleep);
    }
    ...
    public useSuccubiMilkOnGnollPrincesses(): void {
        ...
        if (this.flags[kFLAGS.URTA_FUCKED_HEL] == 1) this.outputText("that salamander slut's cunt");
        else this.outputText("a mino-cum addicted whore's sodden cunt");
    ...
    public loseToGnollPrincessAndGetGangBanged(): void {
        ...
        //[To Loss Epilogue]
        this.menu();
        this.addButton(this, 0, "Next", this.loseToGnollAsUrtaEpilogue);
    }
    ...
    private loseToGnollAsUrtaEpilogue(): void {
        ...
        //Loss Epilogue✓
        //[HP]
        if (this.player.HP < 1) this.outputText("Ouch... what happened to you?  You blink a few times, ignoring the buzzing throb of pain that rises up like a dormant monster in the back of your head.");
        //[Lust]
        else this.outputText("Oh, gods... what happened to you?  You blink a few times, ignoring the gentle throb coming from your well-used member.");
        ...
        if (this.player.HP < 1) this.outputText("I hope I wasn't too rough on you");
        else this.outputText("I hope you enjoyed the journey here");
        this.outputText(".</i>\"");
        ...
        if (this.player.HP >= 1) this.outputText("You shudder at the memory of your meeting, leaking a little more lubricant.  ");
        ...
        //[Next]
        this.menu();
        this.addButton(this, 0, "Next", this.loseToGnollAsUrtaEpilogueBAM);
    }
    ...
    public urtaNightSleep(): void {
        ...
        this.menu();
        this.addButton(this, 0, "SleepNaked", this.urtaSleepsNaked);
        this.addButton(this, 1, "Wear Armor", this.urtaSleepsArmored);
    }
    ...
    private urtaSleepsArmored(): void {
        ...
        this.player.orgasm();
        this.menu();
        this.addButton(this, 0, "Next", this.introSuccubiAndMinotaur);
    }
    ...
    private urtaSleepsNaked(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Next", this.urtaGetsTentaRaped);
    }
    ...
    private urtaGetsTentaRaped(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Tentacles", this.urtaFinishesWithTentacles);
        this.addButton(this, 1, "Big Orange", this.urtaFinishesWithBigOrange);
    }
    ...
    public urtaSubmitsToMinotaurBadEnd(): void {
        ...
        if (this.monster.findStatusAffect(StatusAffects.MinotaurEntangled) >= 0) this.outputText("   Seeing the fire in your eyes change from a determined glare to a lusty look, the minotaur pulls you over, carefully unwinding the chain from around you, so as not to damage you.");
        ...
        //[Next]
        this.menu();
        this.addButton(this, 0, "Next", this.submissiveMinoUrtaBadEndPtII);
    }
    private submissiveMinoUrtaBadEndPtII(): void {
        ...
        //[Next]
        this.menu();
        this.addButton(this, 0, "Next", this.submissiveMinoUrtaBadEndPtIII);
    }
    ...
    public winRapeAMinoLordAsUrta(): void {
        ...
        this.player.orgasm();
        this.menu();
        this.addButton(this, 0, "Next", this.beatMinoLordOnToSuccubi);
    }
    ...
    public urtaLosesToMinotaurRoughVersion(): void {
        ...
        if (this.player.HP < 1) this.outputText("battered and bruised");
        else this.outputText("weak from lust");
        this.outputText(" to continue fighting.  The hulking bull-man snorts as he approaches you, ");
        if (this.monster.lust < 70) this.outputText("barely deigning to give your far smaller cock a contemptuous look, ");
        ...
        this.flags[kFLAGS.URTA_IS_VULQUINE_MENACE] = 1;
        this.menu();
        this.addButton(this, 0, "Next", this.urtaSheHulkPartII);
    }
    ...
    public milkyUrtaTic(): void {
        ...
        if (this.player.lust < 50) this.outputText("Thankfully it hasn't become too distracting yet.");
        else if (this.player.lust < 75) this.outputText("You don't know how much longer you'll be able to withstand the effects of the milk.");
        else this.outputText("Those orbs full of milky goodness are starting to look more attractive by the minute... if you don't finish this quickly you might end up giving up!");
        this.outputText("\n\n");
        this.player.addStatusValue(StatusAffects.MilkyUrta, 1, -1);
        if (this.player.statusAffectv1(StatusAffects.MilkyUrta) <= 0) this.player.removeStatusAffect(StatusAffects.MilkyUrta);
        this.dynStats("lus", 10);
    }
    ...
    public urtaBeatsUpCowcubi(): void {
        ...
        //[Leave] [Fuck]
        this.menu();
        this.addButton(this, 0, "Fuck", this.fuckTheCowCubi);
        this.addButton(this, 1, "Leave", this.leaveTheCowCubi);
    }
    ...
    private leaveTheCowCubi(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Go Inside", this.enteringTaothsShrine);
    }
    ...
    private fuckTheCowCubi(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Move On", this.enteringTaothsShrine);
    }
    ...
    public urtaLosesToCowCubi(): void {
        ...
        if (this.player.HP < this.player.maxHP()) this.outputText(" and healing your wounds");
    ...
    private enteringTaothsShrine(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Next", this.deadGodsDreaming);
    }
    ...
    private deadGodsDreaming(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Next", this.urtaArrivesAtCampForFukks);
        this.resetToPC();
    }
    ...
    private urtaArrivesAtCampForFukks(): void {
        ...
        if (this.player.gender > 0) this.outputText(" fuck the horny fox and help her out of her predicament, or");
        ...
        if (this.player.hasCock()) this.addButton(this, 0, "KnockUrta", this.knockUpUrtaWithGodChild);
        if (this.player.hasVagina()) this.addButton(this, 1, "KnockMe", this.getKnockedUpWithGodChild);
        this.addButton(this, 2, "Edryn", this.urtaAndEdrynGodChild);
    ...
    private knockUpUrtaWithGodChild(): void {
        ...
        if (this.player.cockTotal() == 1) this.outputText(" your own");
        else this.outputText(" [oneCock]");
        ...
        if (this.player.cockTotal() > 1) this.outputText(", the mess made worse by your multiple-cocked virility.  There's so much that the clear juices roll off you to either side, puddling in your blankets below");
        this.outputText(".  Her nipples dig into yours");
        if (this.player.hasFuckableNipples()) {
            this.outputText(", kissing into the ");
            if (this.player.lactationQ() > 50) this.outputText("milky, ");
            this.outputText("wet holes on your tits, drawing fresh gasps of delight from your overwhelmed brain");
        }
        else this.outputText(", shooting tingling excitement through your nubs as you grind against each other");
        ...
        if (this.player.cumQ() > 1000) this.outputText(", belly rounded with wobbly, womb-packing spunk");
        this.outputText(".");
        ...
        this.dynStats("sen", -2);
        this.menu();
        this.addButton(this, 0, "Next", this.postFuckUrtaUp);
    }
    //Post-Sex Epilogue*
    private postFuckUrtaUp(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.DungeonShutDown) >= 0) this.outputText(" - besides, given you know that you're nothing but a sacrifice the demons are too lazy to collect, it's not like they'll really send an invasion through");
        ...
        if (this.camp.followersCount() >= 2) this.outputText("leave instructions to your fellow camp-dwellers to look after the place, ");
        ...
        this.menu();
        this.addButton(this, 0, "Next", this.preggedUrtaWithGodChildEpilogue);
        this.model.time.days++;
    ...
    private preggedUrtaWithGodChildEpilogue(): void {
        ...
        if (this.player.cor > 66) this.outputText(", what do you care, anyway?");
        else this.outputText(".");
    ...
    private getKnockedUpWithGodChild(): void {
        ...
        if (this.player.isPregnant() && this.player.pregnancyIncubation < 150) this.outputText(" already filled");
        ...
        if (this.player.balls > 0) this.outputText(" and lifting your balls");
        this.outputText(", exposing your puffy lips, and spreading them wide to expose your ");
        if (this.player.vaginaType() != 5) this.outputText("pink, ");
        else this.outputText("dusky, ");
        ...
        if (this.player.wetness() >= 4) this.outputText("wet ");
        ...
        if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150) this.outputText("rounded ");
        ...
        if (this.player.biggestTitSize() > 1) this.outputText("soft curve");
        else this.outputText("flat muscles");
        this.outputText(" until she hits your [nipple].  ");
        if (this.player.hasFuckableNipples()) this.outputText("Her tongue plunges inside, savoring the feminine lubricants");
        else this.outputText("Her tongue plays across the surface, the heat of her breath shooting tingles up your spine");
        ...
        if (this.player.vaginalCapacity() < 60) this.outputText("a little painfully");
        else this.outputText("deliciously");
        ...
        else this.outputText(", the slippery wetness of your [vagina] and the sheer hardness of your [clit] overwhelming.");
        ...
        if (this.player.balls > 0) this.outputText("both sets of");
        else this.outputText("her");
        this.outputText(" balls, slathering them with slick spunk.");

        var ballWorship: any[] = [];
        if ((this.amilyScene.amilyFollower() && this.flags[kFLAGS.AMILY_FOLLOWER] == 2) && this.jojoScene.campCorruptJojo()) ballWorship[ballWorship.length] = 0;
        if ((this.amilyScene.amilyFollower() && this.flags[kFLAGS.AMILY_FOLLOWER] == 2) || this.jojoScene.campCorruptJojo()) ballWorship[ballWorship.length] = 1;
        if (this.sophieBimbo.bimboSophie()) ballWorship[ballWorship.length] = 2;
        ...
        //{If Jojo/Amily pet}
            ...
            if (this.jojoScene.campCorruptJojo()) this.outputText("Jojo");
            else this.outputText("Amily");
        ...
        //{Bimbo Sophie ball worship here}
            ...
            if (this.player.balls > 0) this.outputText("  She does the same to your own [balls], even giving your [asshole] a happy, sloppy kiss before returning to polishing the supple, skin-shrouded spheres just ahead.");
        ...
        if (this.player.tailType > TAIL_TYPE_NONE) this.outputText(", though getting your tail angled right to allow her entrance is a bit of a challenge");
        else if (this.player.isTaur()) this.outputText(", though getting down on your hands and forelegs is a bit challenging for you");
        else this.outputText(", [face] buried in your blankets soaked with Urta's musky fluid");
        this.outputText(".");
        ...
        if (this.player.wetness() >= 5) this.outputText("Lady-spunk showers out of your spasming twat, glazing Urta's bouncy ballsack with your lusty liquid.");
        else if (this.player.wetness() >= 3) this.outputText("Lady-spunk drools out of your spasming twat in thick streams, glazing Urta's bouncy ballsack with your liquid lust.");
        else if (this.player.wetness() >= 1) this.outputText("Lady-spunk drips from your spasming twat in steady trickles, glazing Urta's bouncy ballsack with your liquid lust.");
        ...
        //[Next]
        this.menu();
        this.addButton(this, 0, "Next", this.getKnockedUpUrtaEpilogue);
    }
    ...
    private getKnockedUpUrtaEpilogue(): void {
        ...
        if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150) this.outputText("much more ");
        this.outputText("pregnant ");
        if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150) this.outputText("than before");
        else this.outputText("- very pregnant");
        ...
        //[Next]
        this.menu();
        this.addButton(this, 0, "Next", this.getKnockedUpByUrtaEpilogueII);
        this.model.time.days++;
        this.model.time.hours = 7;
    }
    ...
    private getKnockedUpByUrtaEpilogueII(): void {
        ...
        if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150) this.outputText("  Somehow, you're still just as pregnant with something as you were before.");
    ...
    public urtaAndEdrynGodChildEpilogue(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Next", this.urtaAndEdrynGodChildEpilogueII);
    }
    ...
    private urtaAndEdrynGodChildEpilogueII(): void {
        ...
        if (kGAMECLASS.telAdre.edryn.pregnancy.isPregnant) this.outputText("  Just how did she get pregnant again when she was already knocked up?  ...Magic, maybe.");
        ...
        if (kGAMECLASS.telAdre.edryn.pregnancy.isPregnant) this.outputText("massively ");
        ...
        if (kGAMECLASS.telAdre.edryn.pregnancy.isPregnant) this.outputText("  The centaur guardswoman is still just as pregnant with your offspring as before.  Your child is unharmed by whatever just transpired.");
