...
export class MilkySuccubus extends AbstractSuccubus {
    ...
    protected performCombatAction(): void {
        if (this.findStatusAffect(StatusAffects.MilkyUrta) < 0 && MilkySuccubus.rand(3) == 0) this.cowCubiMilkSprayAttack();
    ...
    private drinkMinoCum(): void {
        ...
        if (this.findStatusAffect(StatusAffects.DrankMinoCum) < 0 || this.findStatusAffect(StatusAffects.DrankMinoCum2) < 0) {
            ...
            this.lust += 25;
            this.HP += 400;
            if (this.findStatusAffect(StatusAffects.DrankMinoCum) < 0) this.createStatusAffect(StatusAffects.DrankMinoCum, 0, 0, 0, 0);
