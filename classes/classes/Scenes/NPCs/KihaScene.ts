...
export class KihaScene extends NPCAwareContent {
    ...
    public encounterKiha(): void {
        ...
        if (this.kihaFollower.followerKiha() && this.flags[kFLAGS.KIHA_NEEDS_TO_REACT_TO_HORSECOCKING] == 1) {
            this.kihaFollower.kihaReactsToHorseDicking();
            return;
        }
        //kihaBitchesOutCorruptPCs()
        if (this.flags[kFLAGS.KIHA_AFFECTION_LEVEL] > 0 && this.player.cor >= 66 && this.flags[kFLAGS.KIHA_CORRUPTION_BITCH] != 1) {
        ...
        //Friendly+ meeting
        if (this.flags[kFLAGS.KIHA_AFFECTION_LEVEL] >= 1 && this.flags[kFLAGS.KIHA_CORRUPTION_BITCH] != 1) {
            if (this.flags[kFLAGS.KIHA_AFFECTION_LEVEL] == 2 && this.flags[kFLAGS.KIHA_AFFECTION] >= 100 && this.flags[kFLAGS.KIHA_MOVE_IN_OFFER] == 0) {
        ...
        //PLOT FIGHT TIME!
        if (this.player.cor < 66 && this.flags[kFLAGS.KIHA_AFFECTION_LEVEL] == 0 && this.flags[kFLAGS.KIHA_TALK_STAGE] >= 3 && this.player.gender > 0) {
    ...
    public kihaLossIntro(): void {
        ...
        this.spriteSelect(72);
        //(Lust)
        if (this.player.lust > 99) this.outputText("You give up on fighting, too horny to keep fighting.  Kiha strikes the ground with her axe and snorts out a puff of smoke.  \"<i>What a shameless slut!  You're lusting after me even in the heat of battle, like a common imp!  You aren't worthy to lick between my foot-claws!</i>\"\n\n", false);
        //(HP)
        else this.outputText("You collapse, too wounded to keep fighting.  Kiha strikes the ground with her axe and snorts out a puff of smoke.  \"<i>What a wimp!  I've barely started fighting and you're already beaten!</i>\"\n\n", false);
    ...
    private kihaMilkTitHumiliation(): void {
        ...
        this.outputText("", true);
        this.spriteSelect(72);
        if (this.player.lust > 99) this.outputText("You slide to the ground, too turned on to fight and openly touching yourself.", false);
        ...
        if (this.player.hasCock()) this.outputText("not noticing the stiffening in your loins", false);
        else if (this.player.hasVagina()) this.outputText("not noticing the scent of your growing need", false);
        ...
        else if (this.player.cor < 66) this.outputText("How confusing this all is.  Why can't things be simple like they were back home?", false);
    ...
    private kihaRapesMen(): void {
        ...
        if (this.player.isNaga() || this.player.tailType == TAIL_TYPE_LIZARD) this.outputText("\"<i>Heh, if you had half as much dexterity as you do impudence, I'd let you do this for me.  Fat chance of that,</i>\" she remarks off-handedly.  ", false);
        ...
        if (this.player.balls > 0) this.outputText(", resting the heel of her foot against the swell of your " + this.ballsDescriptLight() + " and applying just enough pressure to feel the cum churning within", false);
        ...
        if (this.player.cockTotal() > 1) {
            if (this.player.cockTotal() > 2) this.outputText("  Your unoccupied shafts spray ropey strands of cum all around you, jerking and straining under the weight of the dragoness.", false);
            else this.outputText("  Your unoccupied shaft sprays ropey strands of cum all around you, jerking and straining under the weight of the dragoness.", false);
        }
    ...
    private tsundereMasturbationChristmasCarol(): void {
        ...
        //If Multi/Herm
        if (this.player.cockTotal() > 1 || this.player.gender == 3) this.outputText("\"<i>W-what are you going to do, you freak of nature?  If you make me play with those, I swear... I swear I'll hit you!</i>\"", false);
        //If Cock
        else if (this.player.hasCock()) this.outputText("\"<i>G-get that away from me!  As if I'd want anything to do with your hard, juicy cock!  Idiot!</i>\"", false);
        //If Vagina
        else if (this.player.hasVagina()) this.outputText("\"<i>What do you think you're going to do with that pathetic, dripping pussy, huh?  I swear, if you make me l-lick that thing...</i>\"", false);
        //If Genderless
        else this.outputText("\"<i>H-huh?  Why the hell are you coming closer?  How can you possibly do anything when you're as smooth as a board down there, you loser!</i>\"", false);

        this.outputText("  Today, however, you don't have any plans to fuck her directly", false);
        if (this.player.gender == 0) this.outputText(", and seeing as you don't have anything to fuck her with, it's not like you could", false);
        ...
        if (this.player.tallness < 72) this.outputText("- though you're hidden behind her tallness", false);
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.cockTotal() == 1) this.outputText("a small bead of pre-cum forming from the tip and slathering her back with your juices.", false);
            else this.outputText("small beads of pre-cum forming from the tips and slathering her back with your juices.", false);
        }
        else this.outputText(this.nippleDescript(0) + "s against the hard ridges of her back, your tongue softly licking her smooth skin.", false);
    ...
    private kihaVictoryPomfTail(): void {
        ...
        if (this.player.biggestTitSize() <= 4) this.outputText("She looks away and blushes as she says, \"<i>It's not like I'd find such tiny breasts attractive!</i>\"  Her mannerisms seem to indicate that she does.", false);
        else if (this.player.biggestTitSize() <= 12) this.outputText("She sighs and says, \"<i>As if I'd be impressed by udders like those!</i>\"", false);
        else this.outputText("She laughs and taunts, \"<i>How do you even walk with ridiculous hooters like those?  Go on, moo, cow!</i>\"", false);
    ...
    private victoryDickKiha(): void {
        ...
        if (this.monster.lust > 99) this.outputText("Just because you've aroused my body doesn't mean I'll enjoy this!", false);
        ...
        if (this.monster.lust > 99) this.outputText(", rubbing it back and forth against her folds without thinking about it", false);
        ...
        if (this.player.lust > 60) this.outputText("only makes " + this.sMultiCockDesc() + " harder.", false);
        else this.outputText("quickly makes " + this.sMultiCockDesc() + " hard", false);
        ...
        if (this.player.hasVagina()) this.outputText("and " + this.vaginaDescript() + " ", false);
        ...
        if (y != -1 && this.player.cockTotal() > 1) {
            ...
            while (this.temp > 0) {
                this.temp--;
                if (this.player.cocks[this.temp].cockType == CockTypesEnum.TENTACLE && this.temp != x && this.temp != y) {
                    z = this.temp;
                    break;
                }
            }
            if (this.player.isNaga() || this.player.tailType == TAIL_TYPE_LIZARD || z >= 0) {
                ...
                if (z >= 0) this.outputText(", plunging the head of your cock in and out of her throat.", false);
                this.outputText("\n\n", false);
            }
            ...
            if (this.player.isNaga() || this.player.tailType == TAIL_TYPE_LIZARD || z >= 0) this.outputText(" gasping mouth,", false);
            this.outputText(" and tight anus with waves of white.", false);
            if (this.player.cumQ() >= 500) this.outputText("  Her belly distends before long, stuffed by the heavy loads of cream you push out.", false);
        ...
        //(SINGLE DICKING VARIANT)
            ...
            if (this.monster.lust > 99) this.outputText("more aroused despite her feigned indifference", false);
            ...
            if (this.player.cumQ() >= 500) this.outputText("A chubby bulge appears on her taut, defined belly, the only visible sign of your copious cum production.  ", false);
            if (this.player.cumQ() >= 1000) this.outputText("Even after that, thick gouts of the stuff spray out through her cock-stuffed lips, forming a puddle beneath your foe.  ", false);
            this.outputText("You pull out", false);
            if (this.player.cor < 33) this.outputText(", clean up, and get dressed, leaving Kiha behind to consider the effects of her arrogance.", false);
            else if (this.player.cor < 66) this.outputText(", wipe your cock off on her face, and get dressed, leaving Kiha to consider being a little more humble.", false);
            else this.outputText(", smear your dribbling cock all over her face, make her lick it clean, and then, get dressed.  Maybe the bitch will consider a little humility when addressing the real owner of this territory - you.", false);
    ...
    private kihaRapesLittleGirlsISawItOnTheNews(): void {
        ...
        if (this.player.tongueType == TONUGE_SNAKE) this.outputText("  You are grateful for your forked tongue, which allows you to cover more of her pussy at once.", false);
        else if (this.player.tongueType == TONUGE_DEMONIC) this.outputText("  Your inhumanly long, prehensile tongue is a blessing here; you can reach into her deepest recesses, slurp your way into every nook and cranny, and generally provide a tongue-fuck that no human ever could.", false);
        this.outputText("\n\n", false);
        ...
        if (this.player.wetness() >= 5) this.outputText("  Your juices spray into her face like cum from a cock, your quantity of lubricants unable to resist cascading from the pressure of your orgasm.", false);
    ...
    private rapeKihaWithWORDS(): void {
        ...
        //Conversation Level 2 (40- Corruption! PUREBABIES ONLY!) (Zed)
            ...
            if (this.silly() && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00281] > 0 && this.telAdre.lottie.lottieMorale() <= 33) this.outputText("  Is that what it feels like to be Lottie?", false);
        }
    ...
    */
    ...
    private analRapuzulaKiha(): void {
        ...
        if (this.player.cockArea(x) <= 20) this.outputText("You quickly shed your " + this.player.armorName + ", letting your " + this.multiCockDescriptLight() + " out to breathe in the warm, swampy air.  Her red eyes widen slightly, but she quickly regains her composure, suddenly all confidence despite her obvious loss.  \"<i>Oh? What do you think you're gonna do with THAT, huh?  Just ravish me like some kind of sex-crazed demon? Is that your genius plan?</i>\"\n\n", false);
        else this.outputText("You quickly shed your " + this.player.armorName + ", letting your " + this.multiCockDescriptLight() + " out to breathe in the warm, swampy air. Her red eyes widen slightly, but she quickly regains her composure, suddenly all confidence despite her obvious loss.  \"<i>Hah, look at that pathetic thing.  You might have gotten me a little hot, but I really doubt you could please anyone with that puny piece of equipment.</i>\"\n\n", false);
        ...
        if (this.player.balls > 0) this.outputText(" and threatening to crush your " + this.ballsDescriptLight(), false);
        ...
        if (this.player.cor < 33) this.outputText("You move your hands from her two mounds and down her sides, resting just above her hips. Hoping that this will work, you begin to tickle the stubborn girl.  ", false);
        else if (this.player.cor < 66) this.outputText("Since she seems to be concentrating on your hands, you frantically try to think of a solution that doesn't involve them.  An idea forms and, deciding it's now or never, you lean forward and nibble on the tip of her ear.  ", false);
        else this.outputText("Since she seems to be concentrating on your hands at the moment, your mind races trying to find a solution that doesn't involve them.  An idea forms and, deciding it's now or never, you lean forward and slowly slide your tongue across her cheek.  ", false);
        ...
        this.outputText("The heat that now encircles your " + Appearance.cockNoun(this.player.cocks[x].cockType) + " is tremendous; her tightness, incredible.  You're nearly overwhelmed by the urge to slam your whole length home and just cum your brains out.  But you want her to enjoy this, too.  You slowly slide back out of her rectum, stopping when just the tip of the head is barely inside. You lean forward, resting your chest against the warm skin of her back, and thrust your " + this.cockDescript(x) + " back into the crushing heat of her asshole.\n\n", false);
        ...
        if (y >= 0) {
            ...
            this.outputText("Kiha shudders in her own climax, soaking her thighs as you finally release your seed into her ravaged ass.  Your other " + Appearance.cockNoun(this.player.cocks[y].cockType) + " follows its brother, painting her leather-colored skin with alabaster cream", false);
            if (this.player.cockTotal() >= 3) {
                if (this.player.cockTotal() == 3) this.outputText("; your remaining cock tarnishes the ground with your cum", false);
                else this.outputText("; your remaining cocks tarnish the ground with your cum", false);
            }
            else if (this.player.hasVagina()) this.outputText("; your " + this.vaginaDescript() + " pulses with pleasure, soaking your thighs with girl-cum as your cocks unload", false);
            this.outputText(".\n\n", false);
            ...
            if (this.player.cockArea(x) <= 20) this.outputText("You move your hands to her breasts, feeling the lightly scaled flesh and begin tweaking her nipples in time to your continued thrusting.  She breaks her self-imposed silence with a long, pleasured sigh, but cuts it short when you laugh at her body's betrayal of her emotions.  \"<i>H-how can anyone even l-like this anyway?</i>\" she pants with barely contained pleasure.  \"<i>All you're doing is sticking your pathetic dick inside something that it isn-isn't designed for.  I-I can barely feel your ti-tiny little cock... uhh... stretching my ass, filling it with s-such force.  Its head tickling my walls with your... ohhh... pathetic attempts to get yourself o-off...</i>\"\n\n", false);
            else this.outputText("You move your hands to her breasts, feeling the lightly scaled flesh and begin tweaking her nipples in time to your continued thrusting.  She breaks her self-imposed silence with a long, pleasured sigh, but cuts it short when you laugh at her body's betrayal of her emotions.  \"<i>H-how can anyone even l-like this anyway?</i>\"  She pants with barely contained pleasure.  \"<i>Dicks don't even belong there, you... you freak!  It... it doesn't even feel good... stretching my ass, filling it with s-such force.  Its head tickling my walls with your... ohhh... pathetic attempts to get yourself o-off...</i>\"\n\n", false);
            ...
            if (this.player.hasVagina()) this.outputText("Your " + this.vaginaDescript() + " pulses with pleasure, but it's an empty orgasm, leaving you wishing you had something to fill that aching void.  Still, you cannot help but marvel at the superior feeling of cumming with a multitude of sexual organs.  ", false);
