...
export class SophieScene extends BaseContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        if (this.flags[kFLAGS.SOPHIE_ANGRY_AT_PC_COUNTER] > 0) this.flags[kFLAGS.SOPHIE_ANGRY_AT_PC_COUNTER]--;
        if (this.flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] == 1 && this.sophieFollowerScene.sophieFollower() && this.flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 0) {
            this.sophieFollowerScene.sophieDaughterDebimboUpdate();
            needNext = true;
        }
        if (!this.sophieAtCamp()) { //Could be at the farm or still in the wild
            if (this.flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 0 && this.pregnancy.isPregnant && this.pregnancy.incubation == 0) { //As long as she's not at the farm it's alright to lay eggs
            ...
            if (this.flags[kFLAGS.SOPHIE_CAMP_EGG_COUNTDOWN] > 0) { //Maturation of the egg she laid
            ...
            if (this.flags[kFLAGS.SOPHIE_DAUGHTER_MATURITY_COUNTER] > 0) { //Maturation of her daughter into an adult
                ...
                if (this.flags[kFLAGS.SOPHIE_DAUGHTER_MATURITY_COUNTER] < 1) {
                    ...
                    switch (this.flags[kFLAGS.SOPHIE_DAUGHTER_MATURITY_COUNTER]) {
                        case 100:
                        case 200:
                        case 325: this.sophiesDaughterDescript(); //At these three times we need to output a message about her daughters
                            needNext = true;
                        default:
                    }
                }
            ...
            if (this.pregnancy.isPregnant) {
                if (this.pregnancy.type == PregnancyStore.PREGNANCY_PLAYER) {
                    ...
                    switch (triggeredEvent) {
                        case 1:
                        case 2:
                        case 3: this.sophiesPregnancyDescript(triggeredEvent);
                            needNext = true;
                            break;
                ...
                if (this.flags[kFLAGS.SOPHIE_HEAT_COUNTER] >= 552) { //She got knocked up while in heat
                ...
                if (this.flags[kFLAGS.SOPHIE_HEAT_COUNTER] == 0) { //Tick over into heat if appropriate
                    ...
                    if (this.flags[kFLAGS.SOPHIE_HEAT_COUNTER] == 552) { //Expire heat if it counts down to 552
                        if (this.sophieBimbo.bimboSophie()) this.sophieBimbo.sophieSeasonExpiration();
                        else this.sophieFollowerScene.sophieFertilityExpired();
                        needNext = true;
                    }
                    if (this.model.time.hours == 10 && (this.player.findPerk(PerkLib.LuststickAdapted) < 0 || SophieScene.rand(3) == 0) && this.sophieBimbo.bimboSophie() && !this.sophieBimbo.sophieIsInSeason() && this.flags[kFLAGS.SOPHIE_CAMP_EGG_COUNTDOWN] == 0) {
    ...
    public timeChangeLarge(): boolean {
        if (this.checkedSophie++ == 0 && this.model.time.hours == 6) {
            if (this.flags[kFLAGS.NO_PURE_SOPHIE_RECRUITMENT] == 0 && this.flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 0 && this.flags[kFLAGS.SOPHIE_FOLLOWER_PROGRESS] >= 5 && !this.pregnancy.isPregnant && this.player.hasCock() && !this.sophieAtCamp()) {
                this.sophieFollowerScene.sophieFollowerIntro();
                return true;
            }
            if (this.flags[kFLAGS.SLEEP_WITH] == "Sophie" && this.player.hasCock()) {
                if (this.sophieBimbo.bimboSophie() && this.flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 0 && SophieScene.rand(2) == 0 && this.player.cockThatFits(this.sophieBimbo.sophieCapacity()) >= 0) {
                ...
                if (this.sophieFollowerScene.sophieFollower() && this.player.lust >= 50 && this.player.smallestCockArea() <= 5 && this.flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 0) {
    ...
    */
    ...
    public sophiesDaughterDescript(): void {
        ...
        if (this.flags[kFLAGS.SOPHIE_DAUGHTER_MATURITY_COUNTER] == 100) {
            ...
            if (this.sophieBimbo.bimboSophie()) this.outputText("boisterous bimbo ");
            else this.outputText("mature harpy ");
            ...
            if (this.sophieBimbo.bimboSophie()) this.outputText(" bimbo ");
            else this.outputText(", avian girlfriend ");
    ...
    public meetSophieRepeat(): void {
        ...
        if (this.player.totalCocks() > 0) {
            ...
            if (SophieScene.rand(2) == 0 && !this.pregnancy.isPregnant) {
                ...
                else this.outputText("The flight is thankfully brief, and she actually gives you a good view of the mountain-side as she brings you up to her nest.", false);
            ...
            if (this.flags[kFLAGS.FUCKED_SOPHIE_COUNTER] > 0) {
                ...
                if (this.pregnancy.isPregnant) this.outputText("I still haven't laid your egg, but if you want it might be fun to take care of your naughty little urges.", false);
    ...
    private sophieMeetingChoseSex(): void {
        ...
        if (this.player.totalCocks() == 0) {
            ...
            if (this.player.hasVagina()) this.outputText(" and insists, \"<i>Well, keep looking; if I wanted a girl I'd be busy with one of my nieces right now.</i>\"", false);
    ...
    private cramANippleInIt(): void {
        ...
        this.outputText("", true);
        //Not a combat win
        if (!this.getGame().inCombat) this.outputText("Sophie steps back and drops onto her knees, balancing herself with her wings.   You pull your " + this.player.armorName + " open with deliberate slowness, exposing your " + this.allBreastsDescript() + " one at a time.  Sophie licks her lips as she patiently awaits the sharing of your bounty.\n\n", false);
        //COMBAT
        else {
            //(Lust Win)
            if (this.monster.lust > 99) this.outputText("Sophie pants and pulls herself up to her knees.  She barely keeps her balance as she rams four of her fingers deep into her dripping pussy, fiddling at her clit with her thumb.  The harpy opens her mouth to beg for your milk with her glossy lips as you slowly undress.\n\n", false);
            //(HP Win)
            else this.outputText("You pull the dazed and defeated harpy up to her knees.  She sways unsteadily as you undress and expose your " + this.allBreastsDescript() + " to the cool mountain air.   Sophie's eyes open wider as she struggles back to consciousness, and the hungry harpy happily opens her mouth into a wide 'O', begging for your milk.\n\n", false);
        }
        ...
        if (this.player.biggestLactation() < 2) {
            ...
            if (this.player.totalNipples() > 2) {
                ...
                if (this.player.totalNipples() < 5) this.outputText("before finishing the last one.", false);
        ...
        //(Medium PG)
            ...
            if (this.player.totalBreasts() > 2) {
                if (this.player.totalNipples() > 2) this.outputText("She drinks from each of the nipples that adorn your " + this.allBreastsDescript() + " until her belly is full and gurgling.", false);
                else this.outputText("She drinks from each breast in turn until her belly is full and gurgling.", false);
            }
        ...
        //(High PG) 
            ...
            if (this.player.totalNipples() >= 4) this.outputText("  With all your nipples, this goes on for quite some time.", false);
            this.outputText("\n\n", false);
        }

        this.outputText("Sophie pulls back with ", false);
        if (this.player.biggestLactation() >= 3.5) this.outputText("an incredibly loud burp and blushes red.", false);
        ...
        if (this.getGame().inCombat) {
            //(Fought HP won:
            if (this.monster.HP < 1) this.outputText("You know you don't have to beat me up to get me to drink your milk right? It's too delicious to turn down!</i>\"\n\n", false);
            //(Fought Lust won:
            else {
                this.outputText("Mmmm, you sure know how to get a woman's blood pumping before you give her what she wants, don't you?", false);
                //(Dick:
                if (this.player.totalCocks() > 0) this.outputText("  Maybe you'll let me try your 'other' milk next time?", false);
        ...
        if (this.player.cor > 60) this.outputText("  You give her wide ass a playful slap and start climbing down before she can retaliate.", false);
    ...
    private consensualHotSophieDickings(): void {
        ...
        if (this.player.biggestTitSize() >= 1) this.outputText("her breasts rubbing against your own", false);
        else {
            if (this.player.tallness <= 48) this.outputText("her breasts pressed into your face", false);
        ...
        if (this.player.cor < 75) this.outputText("making you feel terrible and shamed.  Your entire body flushes with embarrassment", false);
        else this.outputText("making you a bit irritated at the older harpy.  Your entire body flushes with anger and arousal", false);
        ...
        if (this.player.cockArea(x) <= 6) this.outputText("plunging your " + this.cockDescript(x) + " inside the oversized vagina.", false);
        else if (this.player.cockArea(x) <= 150) this.outputText("burying your " + this.cockDescript(x) + " deep into her massive gash.", false);
        else this.outputText("slowly working your " + this.cockDescript(x) + " into her massive gash, finding it barely big enough for you.", false);
        ...
        if (this.player.tallness <= 48) this.outputText("You lean into her breasts and nuzzle her nipple for a moment before suckling it into your mouth.", false);
        else if (this.player.tallness < 72) this.outputText("You lean down and pull her breast up in order to suck the nipple into your mouth.", false);
        else this.outputText("You'd love to suck her nipple but you're just too tall, so you settle for pinching both of her nipples between your thumbs and fore-fingers.", false);
        ...
        if (this.player.tallness <= 48) this.outputText("head back down between her breasts", false);
        else this.outputText("body tightly against her, crushing her breasts in between the two of you", false);
        ...
        if (this.player.cumQ() >= 500) {
            if (this.player.cumQ() < 1000) this.outputText("  Jism starts to spurt from the harpy's pussy by the end, as you've filled her with more cum than her body can handle.", false);
            else this.outputText("  Jism spurts from the harpy's pussy in short order, as the huge eruptions of spooge overfill her poor, unprepared body.", false);
            if (this.player.cumQ() >= 4000) this.outputText("  Her nest is filled with enough spunk that it begins to run out over the lip, sliding down the rocks in a small river.", false);
        }
        ...
        else this.outputText(this.cockDescript(x) + " and prostate", false);
        ...
        else if (this.flags[kFLAGS.FUCKED_SOPHIE_COUNTER] <= 2) this.outputText("You really like it when I milk you don't you?  That must be why you keep coming back for more.", false);
        ...
        else if (this.player.cumQ() < 4000) this.outputText("into the soft, cum-slicked surface of her nest", false);
        ...
        else this.outputText("I'm sorry, I just got so caught up in the moment that I got you all kissed up on my lip-gloss, didn't I cutey?  Why don't you come snuggle with me for a few hours and I can stroke you until it wears off?", false);
        this.outputText("</i>\"\n\n", false);
        //Apply harpy status.
    ...
    private postSophieSexSnuggle(): void {
        ...
        else if (this.player.cumQ() < 1000) this.outputText("drench your body in thick waves of cum", false);
        else this.outputText("erupt over your body and send a thick river flowing down the mountain", false);
        ...
        if (this.player.cor > 50) this.outputText("nearly give her a good-bye kiss, but catch yourself at the last moment.  She quips, \"<i>Too bad, it was nice.</i>\"\n\n", false);
        else this.outputText("give her a kiss on the cheek, knowing all-too-well the dangers of her lips.  She quips, \"<i>Ohh, too bad.  I wanted to stroke you to sleep.</i>\"\n\n", false);
        //Remove luststick
    ...
    private consensualSophieSexNoFit(): void {
        ...
        if (this.player.cor < 50) this.outputText("Her teases and taunts sting far more than they should, making you feel terrible and shamed.  Your entire body flushes with embarrassment ", false);
        else this.outputText("Her teases and taunts sting far more than they should, making you feel irritated and humiliated.  Your entire body flushes with forced embarrassment ", false);
        ...
        if (this.player.balls > 0) this.outputText("your " + this.ballsDescriptLight() + ", careful not to snag them with her talons", false);
        ...
        if (this.player.cumQ() >= 1000) {
            ...
            if (this.player.cumQ() >= 2000) this.outputText("  You continue to spurt, soaking yourself and the nest with waves of spooge until it is as filled as she is.", false);
            if (this.player.cumQ() >= 4000) this.outputText("  A wave of the stuff slides down the mountain-side from your extreme production.", false);
        }
        this.outputText("\n\n", false);
    ...
    public sophieLostCombat(): void {
        ...
        if (this.monster.HP < 1) this.outputText("She's too wounded to fight, and she lies in a miserable heap in the nest.", false);
        else this.outputText("She's too turned on to be a threat and is happily masturbating.", false);
        //RAEP OPTIONS
        if (this.player.gender != 0) {
            ...
            if (this.player.lust >= 33 && this.player.totalCocks() > 0) {
                ...
                //Too big
                if (this.player.cockThatFits(232) == -1) { dickRape = this.maleVictorySophieRapeHUGE; }
                //Fits
            ...
            if (this.player.hasItem(this.consumables.BIMBOLQ)) bimbo = this.sophieBimbo.bimbotizeMeCaptainSophie;
        }
    ...
    private maleVictorySophieRape(): void {
        ...
        if (this.monster.HP < 1) this.outputText("too beaten to resist, and lies on the ground in a semi-conscious heap.", false);
        else this.outputText("too turned on to resist, and is vigorously fisting her large pussy.", false);
        ...
        if (this.player.cumQ() < 50) this.outputText("Spooge spurts inside her until you're satisfied.", false);
        else if (this.player.cumQ() < 300) this.outputText("Spooge spurts inside her until you're satisfied and her belly has a small cum-bloated bump in it.", false);
        else if (this.player.cumQ() < 1000) this.outputText("Spooge bursts inside her until her belly is pregnant with your spunk and you're satisfied.", false);
        else this.outputText("Spooge bursts inside her until her belly looks pregnant with your spunk.  The cum squirts around your cock as it runs out of room inside her, and the nest quickly floods with the rising tide of sexual bliss.  You sigh, satisfied at last.", false);
    ...
    private maleVictorySophieRapeHUGE(): void {
        ...
        if (this.player.cocks[x].cockLength < 36) this.outputText(" each time it pushes into them.", false);
        ...
        if (this.player.cocks[x].cockLength >= 40) {
            ...
            if (this.player.cocks[x].cockLength < 50) this.outputText("before you pull back.", false);
            else this.outputText("before she lets it back out before another push onward.", false);
        }
        if (this.player.cocks[x].cockLength >= 50) this.outputText("  Her tongue darts out and licks the underside when it slips by her head.", false);
        ...
        if (this.player.cumQ() >= 500) {
            ...
            this.outputText(".", false);
            if (this.player.cumQ() >= 2000) this.outputText("  You manage to completely flood her nest, soak her body, and send a torrent of semen down the mountainside by the time you finish.", false);
        }
        this.outputText("  Sophie ", false);
        if (this.player.cocks[x].cockLength < 50) this.outputText("covered the underside of your " + this.cockDescript(x) + " in kisses during your orgasm, but the tingling oral drugs only made it feel better.", false);
        else this.outputText("has been running her drug-laced lip-gloss all over your " + this.player.cockHead(x) + " this entire time!  The tingling made your orgasm even better, but you know you've absorbed a lot of the stuff by now.", false);
        this.outputText("\n\n", false);
    ...
    private sophieVictoryPussyGrind(): void {
        ...
        this.outputText("Sophie is ", false);
        if (this.monster.HP < 1) this.outputText("too beaten to resist, and lies on the ground in a semi-conscious heap.", false);
        else this.outputText("too turned on to resist, and is vigorously fisting her large pussy.  You pull her feathery arm from the horny snatch and shove it to the side.", false);
        ...
        if (this.player.isTaur()) this.outputText("slide one of your four feet under her knee and up along next to her body.", false);
        else if (this.player.isGoo()) this.outputText("engulf one of her legs with your slime-like lower body and flow closer to her.", false);
        else if (this.player.isNaga()) this.outputText("slip your snake-like tail between her legs and slide it up next to her body.", false);
        ...
        if (this.player.biggestTitSize() >= 1) this.outputText("You pinch a " + this.nippleDescript(0), false);
        ...
        if (this.player.cockTotal() > 0) {
            ...
            else if (this.player.cumQ() < 1000) this.outputText("  Jism rains everywhere until she's thoroughly glazed with spooge.", false);
            else this.outputText("  Jism rains everywhere until she's thoroughly glazed with spooge and the nest is brimming with your spunk-puddle.", false);
        }
        ...
        if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_SLAVERING) this.outputText("Juices squirt from the joined pussies", false);
        else if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_SLICK) this.outputText("Juices soak the nesting material", false);
        else if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_WET) this.outputText("Juice trickles from the paired pussies", false);
        ...
        if (this.flags[kFLAGS.TIMES_FUCKED_SOPHIE_LESBIAN] == 0) this.outputText("Cutey, you sure know your way around a pussy, but I just don't like to do this kind of thing.  Don't expect me to be some lesbo bird-slut who'll lick your slit at the drop of a hat.", false);
        else if (this.flags[kFLAGS.TIMES_FUCKED_SOPHIE_LESBIAN] < 6) this.outputText("Cutey, you get me off hard every time, but I'd still rather not mess with another girl.  I much prefer getting a younger man in my nest and letting him ravage me.", false);
        else this.outputText("I'm not sure how you keep making me cum, but I'd appreciate it if you stopped.", false);
        this.outputText("</i>\"\n\n", false);
    ...
    private fuckDatClit(): void {
        ...
        if (SophieScene.rand(2) == 0) this.outputText("to see if it gets thicker when you cum.", false);
        ...
        if (this.player.totalCocks() > 0) {
            ...
            if (this.player.cumQ() < 50) this.outputText("It leaves a small puddle of white submission on Sophie's back.  ", false);
            else if (this.player.cumQ() < 250) this.outputText("It leaves a thick puddle of seed dripping from Sophie's back.  ", false);
            else this.outputText("It leaves a thick puddle of seed that splatters off Sophie's back and fills the nest to the brim.  ", false);
        }
        ...
        if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_DROOLING) this.outputText("Juice dribbles down your " + this.player.legs() + " as your body enjoys the treatment.  ", false);
    ...
    private tinyDickSupremeSophieLoss(): void {
        ...
        if (this.flags[kFLAGS.AMILY_MET] > 0 && this.player.cor > 50) this.outputText("You imagine Amily's voice nattering away about how terrible the corruption is, but it doesn't help!  Y", false);
        ...
        if (this.player.cumQ() < 50) this.outputText("You pump the last of your jism into her folds, arching your back with the pleasure of release.  Sophie sneers, \"<i>As I expected, you can barely squeeze a few spurts into me.  You're lucky my eggs are fertile enough for that little bit to work.</i>\"", false);
        else if (this.player.cumQ() < 250) this.outputText("You pump jism into her folds, arching your back with the pleasure of release.  Sophie sneers down for a second before surprise over-takes her face.  You're still cumming and pumping, thoroughly coating her drippy gash with your white goop.  Sophie muses, \"<i>I guess you had something worthwhile hidden inside that tiny girl-cock after all huh?  A shame you still came like a helpless bitch.</i>\"", false);
        else this.outputText("You blast thick waves of cum into her folds, filling them with creamy whiteness in just seconds.  Her belly bloats from the massive insemination, but most of the spunk runs out of the entrance of her barely-plugged pussy.  Sophie looks down in shock and asks, \"<i>Wow, where did a little girl like you get all that from?  Maybe you ought to grow that baby pecker up so people will be a little less surprised by all this, huh?</i>\"", false);
        this.outputText("\n\n", false);
    ...
    private normalLossRapuuuuSophie(): void {
        ...
        if (this.player.balls > 0) this.outputText("The moisture trickles over your " + this.ballsDescriptLight() + " and they shift and churn, building up a thick load of cum for your harpy lover.  ", false);
        ...
        if (this.player.cumQ() < 50) this.outputText("  You clutch onto her arms as the tidal wave of pleasure rushes through you, barely hanging on.", false);
        else if (this.player.cumQ() < 250) this.outputText("  You clutch onto her arms as the tidal wave of pleasures pushes out greater and greater quantities of spooge.  It's difficult to stay conscious, but you manage to pull it off.", false);
        else {
            ...
            if (this.player.cumQ() >= 1500) this.outputText(", and some of it even pours back out to flood the nest", false);
