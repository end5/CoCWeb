...
export class IzmaScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        if (this.flags[kFLAGS.IZMA_TIME_TILL_NEW_BOOK_AVAILABLE] > 0) this.flags[kFLAGS.IZMA_TIME_TILL_NEW_BOOK_AVAILABLE]--; //BOOKURYUUUU COUNTAH For IZMA
        if (this.izmaFollower() && this.flags[kFLAGS.IZMA_NO_COCK] == 0 && this.flags[kFLAGS.TIMES_IZMA_DOMMED_LATEXY] > 0 && this.latexGirl.latexGooFollower() && this.flags[kFLAGS.IZMA_X_LATEXY_DISABLED] == 0) {
            this.flags[kFLAGS.GOO_FLUID_AMOUNT] = 100;
        }
        if (this.model.time.hours > 23 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00246] > 0) this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00246] = 0;
        return false;
    }

    public timeChangeLarge(): boolean {
        if (this.checkedIzmaSophie++ == 0 && this.sophieBimbo.bimboSophie() && this.flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 0 && this.izmaFollower() && this.flags[kFLAGS.FOLLOWER_AT_FARM_IZMA] == 0 && this.flags[kFLAGS.IZMA_NO_COCK] == 0 && ((this.flags[kFLAGS.TIMES_SOPHIE_AND_IZMA_FUCKED] == 0 && IzmaScene.rand(10) == 0) || this.flags[kFLAGS.TOLD_SOPHIE_TO_IZMA] == 1)) {
    ...
    public meetIzmaAtLake(): void {
        ...
        //(Izmacounter= 1)
            ...
            if (this.player.statusAffectv1(StatusAffects.TelAdre) >= 1) this.outputText("outside the safety of Tel'Adre", false);
            else this.outputText("since you arrived", false);
        ...
        //(after 4+ encounters) (Izmacounter >= 5)
            ...
            else if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= 6 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00238] == 0) {
    ...
    private readSharkCuntManual2(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00238] != 1) this.outputText("head back to your camp.", false);
    ...
    private readSharkgirlPornzYouFuckingPervertAsshole(): void {
        ...
        if (this.player.cor < 33) {
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00238] != 1) this.outputText(" back to your camp", false);
        ...
        //(31-69 Corruption)
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00238] != 1) this.outputText("you head back to camp.", false);
            else this.outputText("you turn back to the center of your camp.", false);
        }
        //(70+ corruption)
    ...
    private talkToASharkCoochie(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00232] == 0) {
            ...
            if (this.player.findStatusAffect(StatusAffects.DungeonShutDown) < 0) this.outputText("You scratch your chin in thought, feeling that this matter warrants further investigation.", false);
            //(If the player has done the Demon Factory)
            else this.outputText("You smile, and detail just what that factory is and what you went on to do in this factory.", false);
        }
    ...
    private fightSharkCunt(): void {
        ...
        //(If Izmafight = 0) 
        if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] == 0) this.outputText("\"<i>All right, show me just what a Champion can do!</i>\" she says, entering a fighting stance.", false);
        //(If Izmafight = 1-2) 
        else if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] > 0 && this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= 2) this.outputText("Izma's eyes narrow at you, and she assumes a fighting stance.  \"<i>You won't get so lucky this time.</i>\"", false);
        //(If Izmafight = 3+)
        else if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] > 2) this.outputText("Izma seems uncertain with herself as she prepares for battle. \"<i>Go a little easier on me this time... please?</i>\"", false);
        //(If Izmafight = -1 or -2 )
        else if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] < 0 && this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -2) this.outputText("\"<i>Hm, really?  Well, maybe you'll get lucky this time,</i>\" she mocks, gesturing at you to strike first.", false);
        //(If Izmafight = -3 to -4)
        else this.outputText("Izma laughs slightly and shakes her head.  \"<i>If you insist.  At least TRY this time, will ya?</i>\"", false);
    ...
    public defeatIzma(): void {
        ...
        if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= 0) {
            ...
            if (this.monster.HP < 1) this.outputText("injuries", false);
            ...
            if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] < 3) {
                ...
                if (this.monster.HP < 1) this.outputText("physical", false);
                else this.outputText("sexual", false);
            ...
            //(Izmafight = 3+) 
            else this.outputText("Izma falls into the sand in an exaggerated fashion.  \"<i>Oh no!  I seem to have lost!  Please don't ravish me again!</i>\" she proclaims loudly as she undresses, her bad acting almost making you laugh your ass off.\n\n", false);
        }
    ...
    public IzmaWins(): void {
        ...
        //(without worms)
            ...
            //(Izmafight =0)
            if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= 0) this.outputText("Izma chuckles slightly as she prowls around your defeated form.  \"<i>Well, as far as things around here stand, you made for a decent fight.  Still no match for me, though.</i>\"", false);
            //(Izmafight = -1 or -2) 
            else if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -2) this.outputText("\"<i>Ya know, just because we're friends doesn't mean you need to hold back... you were holding back, right?</i>\" Izma asks, placing her hands on her hips.", false);
            //(Izmafight = -3 or -4) 
    ...
    private loseToIzma(): void {
        ...
        if (this.player.gender <= 2) {
            ...
            else this.outputText("pucker", false);
            this.outputText(" of yours!</i>\"  ", false);
            //[(If Izmafight is -1 or -2)
            if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -2) this.outputText("With some reluctance, but driven by your promise, you remove pieces of your " + this.player.armorName + " until you stand naked before the hungrily ogling tigershark.", false);
            //(If Izmafight is -3 or less)
            else this.outputText("You are already undressed before Izma has finished speaking.  The tigershark is clearly surprised, and, to be honest, a part of you is surprised too... but it's drowned out by the need to give yourself over to Izma's lusts.", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.HP < 1) this.outputText("fear", false);
            else this.outputText("anticipation", false);
            ...
            if (this.player.HP < 1) this.outputText("too weak to resist", false);
            else this.outputText("feeling very horny", false);
        ...
        if (this.player.gender <= 1) {
            ...
            if (this.player.analCapacity() < 26) {
                ...
                //(If Izmafight <= -4)
                if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= -4) this.outputText("  You find yourself pushing back to speed up the process, desperate for Izma to fill you again.", false);
            ...
            //(If player has middling anus:) 
                ...
                if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= -4) this.outputText("  You find yourself wondering that as well...", false);
                this.player.buttChange(this.monster.cockArea(0), true, true, false);
            }
            ...
            if (this.player.hasCock()) this.outputText(", and your own male organ is hard and throbbing from the stimulation", false);
            this.outputText(".\n\n", false);
            ...
            //(If Izmafight = -4)  
            if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= -4) this.outputText("  If this is how the sharks do it, you could really get used to it...", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cumQ() < 25) this.outputText("a trickle", false);
                else if (this.player.cumQ() <= 150) this.outputText("several squirts", false);
                else this.outputText("a steady stream", false);
            ...
            //(unsex)
            else this.outputText("your own muscles spasming from the immense pleasure.", false);
        ...
        //Female Loss:
            ...
            if (this.player.vaginalCapacity() < 26) {
                ...
                if (this.player.vaginas[0].virgin) this.outputText("First time, huh?", false);
                else this.outputText("That's tight!", false);
        ...
        //Loss Scene- Herm 
            ...
            if (this.player.lust < 40) this.outputText("limp cock and barely-engorged cunt", false);
            else if (this.player.lust < 70) this.outputText("turgid erection and moist cunt", false);
            else this.outputText("throbbing erection and slavering cunt.", false);
            this.outputText("\n\n", false);
            ...
            //(1-10 inch penis)
            if (this.player.cocks[x].cockLength <= 10) this.outputText("Izma manages to supress a snort of laughter at the sight of your cock.  \"<i>Um... wow?  It's simply... heh, huge...</i>\"", false);
            //(10-19 inches)
            else if (this.player.cocks[x].cockLength <= 19) this.outputText("\"<i>Not bad, I'm actually impressed,</i>\" Izma says, nodding slightly in approval.", false);
            //(20+ inches)
            else this.outputText("Izma gives a low whistle at the sight of your " + this.cockDescript(x) + ".  \"<i>Now THAT'S a cock.  Looks like you've got a third leg down there!</i>\"", false);
            ...
            //(If Izmafight <= -4) 
            if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= -4) this.outputText("  You're not even really ashamed to admit that such is the case anymore.", false);
            this.outputText("\n\n", false);
        ...
        //zmafight -1: 
        if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -1) this.outputText("  You realize what you're thinking and shudder, forcing the submission-tinged desires down. Where did they come from, anyway?", false);
        //Izmafight -2: 
        else if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -2) this.outputText("  Though you manage to force them away, the dreams of submitting to Izma are starting to haunt you, their power and seductive allure growing. But, still, you can control them.", false);
        //Izmafight -3: 
        else if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -3) this.outputText("  You hum idly to yourself and enjoy the mental visions for a while, then, with some reluctance, you push them aside. Still, you're sure you can bring them out again when you want to enjoy them.", false);
        //Izmafight -4: 
        else if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -4) this.outputText("  You have only the vaguest thought that maybe you shouldn't be thinking about Izma in that way, but it's so tempting to just immerse yourself in the sexiness of having a hot herm shark-girl dominate you so thoroughly. After all, it's not as if there's any harm in doing so, is there?", false);
        //Izmafight -5: 
        else this.outputText("  You embrace the dreams fully, desperate to cling to them as long as you can. It's getting so hard to care about your former mission anymore; why fight the demons when you can just give it up and surrender yourself to Izma? Yes... such a strong, powerful, worthy alpha she is; Izma is all you need. Let her take control of your life, why don't you?", false);
    ...
    private finalIzmaSubmission(): void {
        ...
        if (!this.player.isTaur()) this.outputText("spine", false);
        ...
        if (this.player.hasCock() || this.player.hasVagina()) {
            ...
            if (this.player.hasVagina()) this.outputText("your " + this.vaginaDescript(0) + " moisten considerably", false);
        }
        this.outputText(".\n\n", false);
        ...
        if (this.player.hasVagina() || this.player.hasCock()) {
            ...
            if (this.player.hasVagina()) this.outputText("your " + this.vaginaDescript(0) + " starts squirting fluids liberally", false);
        }
        this.outputText(".\n\n", false);
        ...
        if (this.player.race() != "shark-morph") this.outputText("  \"<i>But we'll have to make some changes to your body, of course...</i>\"", false);
        this.outputText("\n\n", false);
        this.player.slimeFeed();
        this.player.orgasm();
    ...
    private IzmaBadEnd(): void {
        ...
        if (this.player.gender >= 2) this.outputText(" and a fertile womb", false);
    ...
    private victoryPenisIzma(): void {
        ...
        //[(If Izmafight = 3+)
        if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= 3) this.outputText("  Hell, maybe it was made for you, given just how eager Izma seems to be whenever she sees you.  It's like she loses to you on purpose.", false);
        this.outputText("\n\n", false);
        ...
        if (this.player.gender == 1) {
            ...
            //[(multi) 
            if (this.player.cockTotal() > 1) this.outputText(" and onto her groin", false);
            ...
            if (this.player.cumQ() >= 500) {
                ...
                if (this.player.cumQ() >= 1500) this.outputText(".  Eventually it can swell no more and each new squirt forces cum out from her stuffed pussy, trickling past her asshole", false);
                this.outputText(".", false);
            }
        ...
        this.player.orgasm();
        //[(if Izmafight <=4)
        if (this.flags[kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= 4 || this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00235] > 0) {
    ...
    private useVagooOnIzmaWin(): void {
        ...
        //[(taur)
        if (this.player.isTaur()) this.outputText("your weight pinning her to the sand and preventing her from taking control.", false);
        //(non-taur and height > 4') 
        else if (this.player.tallness > 48) this.outputText("and pin her hands above her head to stop her from trying to change the position. Her heaving breasts rub against your " + this.allBreastsDescript() + " as you ride her in this posture.  She needs to know who's in charge here, after all.", false);
        //(non-taur and height <= 4')
        else this.outputText("but small as you are, you can't stop her as she reaches up and grabs onto your " + this.buttDescript() + ", then begins bouncing you like a goblin cocksleeve.", false);
        this.outputText("\n\n", false);
        ...
        //[(no-taur)
        if (!this.player.isTaur()) this.outputText("  To reward your eager partner for her efforts you reach back with one free hand to massage and grope at her testes.  Izma bites her lip and starts growling loudly, pushing her hips up as far as possible, eager to cum for you.  You decide to return the favor, mashing your pussy down with increasing speed.", false);
        this.outputText("\n\n", false);
    ...
    private nonFightIzmaSmexPAINUS(): void {
        ...
        if (this.player.cockTotal() == 1 && this.player.cocks[0].cockType.Index < 9) {
            ...
            else if (this.player.cocks[0].cockType == CockTypesEnum.HORSE) this.outputText("Seeing your " + this.cockDescript(0) + " causes Izma to lick her lips slowly. \"<i>Well... Equinum is pretty popular, isn't it?</i>\"", false);
            //[Dog cock]
            else if (this.player.hasKnot(0)) this.outputText("Izma stares intently at your " + this.cockDescript(0) + ", as if trying to make up her mind about it. \"<i>Well, it is a rather cute look. Just be careful with the knot, will ya?</i>\"", false);
            //[Tentacle] 
            else if (this.player.cocks[0].cockType == CockTypesEnum.TENTACLE) this.outputText("A puzzled look plays across Izma's face as she stares at your " + this.cockDescript(0) + ".  \"<i>Wow... I've read a lot about the corrupt plants.  Didn't think people could wind up like that.</i>\"", false);
            //[Demon Dick] 
            else if (this.player.cocks[0].cockType == CockTypesEnum.DEMON) this.outputText("Izma looks shocked as she lays eyes on your perverted pecker, having never seen anything quite like it before. \"<i>Um... that looks... awkward. Like having a truncheon between your legs.</i>\"", false);
            //[cat dork] 
            else if (this.player.cocks[0].cockType == CockTypesEnum.CAT) this.outputText("She glances at your barbed pecker and winces.  \"<i>You ate the fruit around here, didn't you?  One of my friends did that, too.</i>\"", false);
            //[lizardick]
            else if (this.player.cocks[0].cockType == CockTypesEnum.LIZARD) this.outputText("Her eyes goggle as you reveal a bulbous purple pecker.  \"<i>Oh wow.  Do you have a green one too?</i>\"", false);
            //[Captain Nemo] 
            else if (this.player.cocks[0].cockType == CockTypesEnum.ANEMONE) this.outputText("She grimaces as you unveil a " + this.cockDescript(0) + ".  \"<i>God, not one of those.  You wind up hornier after cumming than you were before you started touching it.</i>\"", false);
            //[Kangaroo Jack] 
            else if (this.player.cocks[0].cockType == CockTypesEnum.KANGAROO) this.outputText("She looks on blankly as you reveal your sheath, then gives a start as your " + this.cockDescript(0) + " slides out of it after a few strokes.  \"<i>Woah... it's so... thin and pointy.</i>\"", false);
        }
        //Multi or weird new shit.
        else this.outputText("Her eyes bug out as you reveal " + this.sMultiCockDesc() + ".  \"<i>Woah, jeez, look at that one... oh man, and that one's... daaamn.</i>\"", false);
        this.outputText("\n\n", false);
        ...
        if (this.player.mf("m", "f") == "m" && this.player.biggestTitSize() >= 2) {
            ...
            if (this.player.biggestLactation() >= 2) this.outputText("  Catching sight of some milk oozing from your nipples makes Izma step back slightly.  \"<i>You're lactating too?!  Man, there are way too many things that are weird about this...</i>\"  Still, you doubt Izma is as turned off as she acts, what with the raging erection between her legs.", false);
            this.outputText("\n\n", false);
        }
        ...
        if (this.player.cocks[0].cockType == CockTypesEnum.TENTACLE) this.outputText("\"<i>Well, actually...</i>\" you begin, flexing your cock-tentacle.  She cuts you off with a glare.  ", false);
        //(other slot 0)
        else this.outputText("You go to protest further, but stop when she gives you a glare.  ", false);
        this.outputText("You're already too horny to back out now, though.  Sighing in annoyance, you flop back onto the sands and motion at Izma to join you.  Izma nods and smiles, making her way over to you and swinging her hips from side to side as if to tease you further, before positioning her head at your groin and rubbing her own groin against your head.  \"<i>Alright, let's do this,</i>\" Izma says bluntly, wasting no time gorging herself on your " + Appearance.cockNoun(this.player.cocks[0].cockType) + ", wrapping her tongue around it and fellating like a pro.  You gasp slightly at the expert treatment, and decide your previous protests were pointless if you're gonna get this kind of pleasure from the deal.\n\n", false);
        ...
        if (this.player.cockTotal() > 1) this.outputText(" and hair", false);
        this.outputText(".  ", false);
        //[(big/mega skeet)
        if (this.player.cumQ() >= 500) this.outputText("You continue to shoot off stroke after stroke long after her mouth has filled up and she's pulled away.  \"<i>For the love of Marae, " + this.player.short + ", I can't swallow all that!</i>\"  ", false);
    ...
    private nonFightIzmaSmexCUNTPUSSYSNATCHQUIM(): void {
        ...
        if (this.player.hasCock()) this.outputText(" and " + this.multiCockDescriptLight(), false);
        ...
        if (this.player.hasCock()) this.outputText(" and " + this.sMultiCockDesc() + " shooting a weak load across her chest", false);
    ...
    private acceptIzmaAsYourBitch(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00236] == 0 && this.flags[kFLAGS.AMILY_FOLLOWER] == 1) {
        ...
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00237] == 0 && this.player.findStatusAffect(StatusAffects.CampMarble) >= 0) {
            ...
            if (this.player.findPerk(PerkLib.MarblesMilk) >= 0) this.outputText("You couldn't break your addiction, and now you'll die without a steady supply of her milk.", false);
            //(If the player broke their addiction) 
            else this.outputText("Thankfully, though you were able to break her milk's hold, and you realized you love Marble despite all that transpired between you, letting her move in with you.", false);
            this.outputText("\n\n", false);
            ...
            //(Fatally addicted)
            if (this.player.findPerk(PerkLib.MarblesMilk) >= 0) this.outputText("turned you into some weak drug-addict", false);
            //(Broke addiction)
            else this.outputText("drugged you into some twisted relationship", false);
    ...
    */
    ...
    private izmaLakeDominate(): void {
        ...
        //[Female]
            ...
            if (this.player.isTaur()) this.outputText("your weight pinning her to the sand and preventing her from taking control.", false);
            ///(non-taur and height > 4')
            else if (this.player.tallness > 48) this.outputText("and pin her hands above her head to stop her from trying to change the position. Her heaving breasts rub against your " + this.chestDesc() + " as you ride her in this posture.  She needs to know who's in charge here, after all.", false);
            //(non-taur and height <= 4')
            else this.outputText("but small as you are, you can't stop her as she reaches up and grabs onto your " + this.buttDescript() + ", then begins bouncing you like a goblin cocksleeve.", false);
            this.outputText("\n\n", false);
    ...
    private izmaLakeDominateContinueVanilla(vanilla: boolean = true): void {
        ...
        if (this.player.gender == 1) {
            ...
            this.outputText(", causing Izma to cry out loudly.", false);
            //[(big skeet)
            if (this.player.cumQ() >= 500) this.outputText("  Her belly swells as you empty your impressive load into her.", false);
            //[(mega), 
            if (this.player.cumQ() >= 1500) this.outputText("  Eventually it can swell no more and each new squirt forces cum out from her stuffed pussy, trickling past her asshole.", false);
    ...
    private izmaCumsAfterRadarStuffHere(denied: boolean): void {
        var cockIndex: number = this.player.cockThatFits(65);
        if (cockIndex < 0) cockIndex = 0;
        if (!denied) this.outputText("The double stimulation pushes Izma past her limit very quickly, and she starts shooting thick jets of spunk into the air, which begin to rain down on her face and breasts.  Her vaginal walls clamp down on your " + Appearance.cockNoun(this.player.cocks[cockIndex].cockType) + " almost painfully as the orgasm wracks her female genitalia too.\n\n", false);
        //[Remove her hands] 
        else this.outputText("Without another word, or another moment of tormenting impediment, Izma howls with unbridled fury, releasing her hot, sticky load into the air and onto her forehead.  Convulsing with utter euphoria as she finally blows her wad, the walls of her vagina clamp down hard in concert with her feelers, trying ever so valiantly to push you over the edge.  Unfortunately, (for Izma anyway), the unconscious efforts of her body fail to bring you to release. Remarking to Izma that she came so soon, you coo down to her that you are pleased with her ability to speedily heed your commands.\n\n");
    ...
    private submitToLakeIzma(): void {
        ...
        if (this.player.hasLongTail()) this.outputText("your tail waving enticingly, ", false);
        ...
        //(female)
            ...
            if (this.player.pregnancyIncubation == 0) this.outputText("Hauling out a plant, she gingerly removes a leaf and offers it to you.  \"<i>Could you take this please?  It's an anti-pregnancy herb.  I'd be happy to have babies with you someday... but I want to earn your acknowledgment as a mate first.</i>\"  Smiling a bit at how old-fashioned she seems, you take the leaf out of her hands and eat it.", false);
        }
        //(herm)
        else {
            this.outputText("\"<i>Dirty little minx, ain't ya?  You wanted this, didn't you...</i>\" Izma teases, shoving two fingers into your moist nether-lips, to test the waters.  The peneration of your needy cunt does serve to make you whimper softly, almost begging to just be filled.  ", false);
            ...
            //(20+ inches)
            else this.outputText("Izma gives a low whistle at the sight of your " + this.cockDescript(0) + ".  \"<i>Now THAT'S a cock.  Looks like you've got a third leg down there!</i>", false);
            this.outputText("\n\n", false);
            ...
            else this.outputText("gives you a decidedly unchaste kiss before she helps you up.  You dress yourself and head back to camp feeling very sated.", false);
        }
        this.player.orgasm();
        this.dynStats("sen", 2);
        this.player.slimeFeed();
    ...
    public izmaFollowerMenu(): void {
        ...
        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_IZMA] == 0) {
            ...
            switch (this.pregnancy.event) {
                case 2: this.outputText("You can't help noticing that Izma seems very nauseous this morning; she's literally green around the gills.  When you investigate, though, she waves you off, insisting that she's fine; she just has a bit of a stomach bug.", false);
                    break;
                case 3: this.outputText("Izma comes up to you, looking concerned.  \"<i>" + this.player.short + ", do you think I've gained weight?</i>\" she asks.  Looking at her, particularly at the stomach she's holding her hands over, you have to confess that it is starting to bulge out in a noticeable paunch.  At her crestfallen look, you suggest that maybe she's pregnant.  At that, she looks delighted.  \"<i>You really think so?</i>\" she asks, hopefully.  You assure her that you're certain of it; after all, she's very good at watching her weight.  Pleased, she kisses you and then heads off for a swim.", false);
                    break;
                case 4: this.outputText("There is no doubt about it now; Izma's pregnant.  She's grown gravid more rapidly than any of the expecting mothers you remember seeing back in your village, but she seems to be having all of the same aches and pains.  She's grown lethargic and irritable, and complains about not being able to fit into her old clothes.  Still, despite that, she seems happy; she's always rubbing her belly with unmistakable pride.  You also think you've noticed her casting you \"<i>come hither</i>\" looks more frequently than before.", false);
                    break;
                case 5: this.outputText("Izma's started to go around completely naked now.  She insists that she's grown too big to fit into her clothes, but you're kind of skeptical about that; she's as big as the women in your village got when they were near the end, but they managed to fit into their clothes, and theirs were a lot more restrictive than a bikini and grass skirt combo.  Still, you're not objecting to the view it provides, and she definitely seems to enjoy that; you never knew a shark tail could be wiggled in an enticing manner over shapely buttocks until you came to this world...", false);
                    break;
                case 6: this.outputText("Izma's certain the baby will come soon.  You're inclined to believe her; she's huge now.  She still wears no clothing, but there's definitely a practical reason for it");
                    if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("- you don't think her skirt would be able to cope with how often she gets erect now, her huge cock rubbing along");
                    else this.outputText(", her juices staining");
                    ...
                    if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("the friction of her cock against her bulge, you think it has more to do with avoiding being splattered in sexual juices all day long.", false);
                    else this.outputText("the friction of her thighs as she moves, you think it has more to do with avoiding being splattered in sexual juices all day long.", false);
                    break;
                default:
            }
        }
        ...
        var kids = undefined;
        if (this.flags[kFLAGS.IZMA_CHILDREN_SHARKGIRLS] + this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) kids = this.izmaKidsPlaytime;
        var deDickT: string = "";
    ...
    private izmaPearance(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00235] == 0) this.outputText(" and wielding iron gauntlets as a weapon.");
        else this.outputText(".");
    ...
    private izmaSexMenu(): void {
        ...
        if (this.player.hasVagina() && this.flags[kFLAGS.IZMA_NO_COCK] == 0) getVagooFucked = this.inCampRideIzmasDickDongTheWitchIsDead;
        //69 - non-0 gender
        var sixty = undefined;
    ...
    private followerIzmaMountsPC(lastHalf: boolean = false): void {
        ...
        if (!lastHalf) {
            ...
            if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText(" instead of her cock");
            ...
            if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("  Your stomach starts to feel wet, and as you look down you realize her pre is starting to soak into your " + this.player.skinFurScales() + ".\n\n", false);
            else this.outputText("  Your stomach starts to feel wet, and as you look down you realize her feminine lubricant is starting to soak into your " + this.player.skinFurScales() + ".\n\n", false);
            ...
            else this.outputText("  Still, the sight of her curvaceous cleavage bouncing gives you an idea.  You reach up to cup your strong lover's hard bosom, enjoying the sight of her slightly-upturned nipples pointing up at the sky.  You flick them gently as she rides you, sometimes squeezing and tugging encouragingly.\n\n");
        }
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) {
        ...
        if (this.player.hasVagina()) {
            ...
            if (this.player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_SLICK) this.outputText("dripping", false);
            else if (this.player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_DROOLING) this.outputText("gushing", false);
            else this.outputText("cascading", false);
        ...
        if (this.player.cumQ() < 500) this.outputText("You can feel Izma's womb fill with your cum, and she shudders from the sheer pleasure.", false);
        //(High cum production) 
        else this.outputText("Izma squeals loudly as you cum inside her, almost having a second orgasm as her belly is bloated and distended by your inhuman amount of cum.", false);
    ...
    private izmaPreg(): void {
        ...
        //PREGGO CHANCES
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00249] == 1 && !this.pregnancy.isPregnant && IzmaScene.rand(100) < (10 + Math.round(this.player.cumQ() / 100))) {
    ...
    private followerIzmaTakesItInPooper(): void {
        ...
        //[else if player<4.5'] 
        else if (this.player.tallness < 54) this.outputText("pulls you up off the ground in a bear hug to kiss you fiercely", false);
        //[else] 
        else this.outputText("pulls you in to her body and kisses you fiercely", false);
        ...
        //[[if player has legs] 
        if (this.player.isBiped() || this.player.isTaur()) this.outputText("between your legs", false);
        //[else] 
        else this.outputText("against your lower body", false);
        ...
        if (this.player.hasCock()) {
            ...
            //[(if player has balls)
            if (this.player.balls > 0) this.outputText(" and " + this.sackDescript(), false);
            ...
            //[(if player has balls)
            if (this.player.balls > 0) this.outputText(" against your own " + this.ballsDescriptLight(), false);
            //(if no balls and vag)
            else if (this.player.hasVagina()) this.outputText(" against your already-dripping " + this.vaginaDescript(0), false);
            //(else)
            else this.outputText(" against your perineum", false);
            this.outputText(", humiliating you more than she stimulates you.\n\n", false);

            //[if dick0 is <14\"] 
            if (this.player.cocks[0].cockLength < 14) this.outputText("\"<i>Hmm...</i>\" she sighs, as she looks at her glans sticking out past the tip of your dick.  \"<i>It's nice to know who's in charge.</i>\"", false);
            //[dick0 >14 but <16] 
            else if (this.player.cocks[0].cockLength < 16) this.outputText("\"<i>It's nice that we keep things fair around here,</i>\" murmurs Izma, smiling at your similarly-sized cocks.", false);
            //[If dick0 >16]
            else this.outputText("\"<i>Oh fuck,</i>\" she says, her eyes filling with lust as she sees your cock extending well past her own.  She tilts forward and rubs the base of her cock hard against the base of your " + Appearance.cockNoun(this.player.cocks[0].cockType) + ", jerking the both of you off together.  You moan helplessly when she stops, and she sighs, \"<i>It feels so good to be alpha over a powerful cock like yours.</i>\"", false);
            this.outputText("\n\n", false);
        }
        ...
        if (this.player.isBiped()) this.outputText(" behind your knees to immobilize you");
        else this.outputText(" around your [legs] to immobilize you");
        ...
        //[if player has penis: 
        if (this.player.hasCock()) this.outputText("  You try to reach for your cock and get off, but her hands keep your wrists securely pinned to the ground.", false);
        this.outputText("\n\n", false);
        ...
        //(if player has penis)
            ...
            if (this.player.cocks[0].cockLength < 14) {
                ...
                //(huge cum)
                if (this.player.cumQ() >= 1500) this.outputText(" over and over again until you're a sticky mess lying in a pool of your own semen.", false);
                //[(big cum)
                else if (this.player.cumQ() >= 500) this.outputText(" until cum pours off of your body and pools on the ground.", false);
    ...
    private followerIzmaTakesItInVagoo(): void {
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText(", gently lifting her meaty quads up so");
        else this.outputText(", gently parting her muscled thighs so");
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("the other holding her maleness out of the way, teasing her cock with her thumb and flexing her fingers to roll her four balls around in the palm of her hand.");
        else this.outputText("the other slowly spreading the folds of her vulva, teasing her clit with her thumb and flexing her interior muscles to make the pink opening wink at you.");
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText(", while Izma herself reaches around to jerk herself off.\n\n", false);
        else this.outputText(", while Izma herself reaches up to massage her heavy breasts.\n\n");
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText(", and gains speed as she jerks her meat pole");
        this.outputText(".\n\n", false);
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText(", a hot jet of spunk going straight into your mouth, and several subsequent shots hitting you in the lips and face.  ");
        else this.outputText(", a small explosion of fem-cum splattering your belly, and several subsequent squirts dripping down your thighs.  ");
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 1) this.outputText("girl-");
        ...
        if (this.player.cumQ() < 750) this.outputText("You pump straight into her womb, enough to make a trickle of your baby batter dribble from her freshly used cunt when you pull out.", false);
        //(High cum production)
        else this.outputText("Your load is so vast that it bloats and distends her belly, almost giving her a second orgasm from the sensations.", false);
        this.outputText("\n\n", false);
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("licking some of her seed off of your face.  \"<i>Come fill me whenever you need to.</i>\"  You grin at Izma and order her to eat up every drop.\n\n", false);
        else this.outputText("licking you face affectionately.  \"<i>Come fill me whenever you need to.</i>\"  You grin back at Izma knowingly.\n\n", false);

        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("She giggles and runs her tongue over the mess she's made; her tongue lingers on your lips for a few moments before she gives you another long kiss and lets you go.", false);
        else this.outputText("She giggles and runs her tongue over your lips, her tongue lingering for a few moments before she gives you another long kiss and lets you go.", false);
        //PREGGO CHANCES
        this.izmaPreg();
        this.player.orgasm();
        this.dynStats("sen", -2);
    ...
    private wheresItGoing(denied: boolean = false): void {
        this.spriteSelect(32);
        this.outputText("\n\nIzma continues to moan and groan loudly, and starts to mash her own hips against yours, trying to work in as many inches of your " + Appearance.cockNoun(this.player.cocks[0].cockType) + " as she can.  As she ");
        if (!denied) this.outputText("jerks off ");
        else this.outputText("moans fiercely ");
    ...
    private RadarIzmaCumInYourChest(): void {
        ...
        if (this.player.biggestTitSize() >= 1) this.outputText("in between your " + this.chestDesc() + " and coats ");
        this.outputText("against your chest");
        if (this.player.biggestTitSize() < 1) this.outputText(", coating it");
        ...
        //[(Normal cum production)
        if (this.player.cumQ() < 750) this.outputText("liberally lubricating her fuckhole with steamy cum and causing your beta to cry out in blissful pleasure.", false);

        //(High cum production)
        else this.outputText("flooding her love canal with so much sperm that a slew of wet, sloppy noises ring out from her pussy.  Izma's expression betrays a sense of utter disbelief as you stuff her full of your spooge; which begins to flow out of her at a steady rate as each contraction of your dick's muscles fires more and more into her.");
    ...
    private IzmaSelfFacialWheeRadar(): void {
        ...
        this.outputText("\n\nYour own seed ");
        //[(Normal cum production)
        if (this.player.cumQ() < 750) this.outputText("liberally lubricates her fuckhole with steamy cum and causes your luscious beta to cry out in blissful pleasure.", false);
        //(High cum production)
        else this.outputText("floods her love canal with so much sperm that a slew of wet, sloppy noises ring out from her pussy.  Izma's expression betrays a sense of utter disbelief as you stuff her full of your spunk, some of which begins to flow out of her at a steady rate, each contraction of your dick's muscles firing more and more into her.");
    ...
    private followerIzmaTakesIt69(): void {
        ...
        if (this.player.hasCock()) {
            ...
            //[(if herm)
            if (this.player.hasVagina()) this.outputText(" while pushing two fingers into your " + this.vaginaDescript(0), false);
        }
        //(Female)
        else if (this.player.hasVagina()) {
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("You wrap your lips around Izma's own massive erection, sucking and gagging on her almost-two-foot cock as she jerks and twists her hips around.  Her muffled moans seem to assure you that you're doing a great job, and Izma responds by increasing the speed of her head-bobbing.  Your vision is a little obscured by Izma's quartet of balls repeatedly bumping against your forehead and the bridge of your nose, but if anything this serves to arouse you further.\n\n", false);
        else this.outputText("You wrap your lips around Izma's puffy, inhuman lower lips, sucking and swallowing her fragrant fem-juices as she jerks and twists her hips around.  Her muffled moans seem to assure you that you're doing a great job, and Izma responds by increasing the speed of her head-bobbing.  Your vision is a little obscured by Izma's sinuous tail, but if anything this serves to arouse you further.\n\n", false);

        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("In an effort to further pleasure your tigershark partner, you occasionally reach up to fondle her swollen sack and finger her tight, damp cunt.  Izma gasps sharply and shudders from the pleasure you're giving her.  As if to reward you for your efforts, Izma picks up speed with her sucking, drenching every inch of your ", false);
        else this.outputText("In an effort to further pleasure your tigershark partner, you occasionally reach up to caress her orange rump and slide a finger into her tight, damp cunt.  Izma gasps sharply and shudders from the pleasure you're giving her.  As if to reward you for your efforts, Izma picks up speed with her sucking, drenching every inch of your ", false);
        if (this.player.hasCock()) this.outputText(this.cockDescript(0), false);
        else this.outputText(this.vaginaDescript(), false);
        this.outputText(" with her saliva, and as you're so eager for her magic tongue you start thrusting your hips up ", false);
        if (this.player.hasCock()) this.outputText("to reach ", false);
        else this.outputText("to push your " + this.clitDescript(), false);
        this.outputText(" as far into her mouth as you can.\n\n", false);

        if (this.player.hasCock()) this.outputText("Eventually, the two of you manage to bring each other to a powerful simultaneous orgasm, Izma's hot cum shoots down your eager throat, and you ", false);
        else this.outputText("Eventually, the two of you manage to bring each other to a powerful simultaneous orgasm, Izma's slippery cum drenching your face, and you ");
        if (this.player.hasCock()) {
            this.outputText(" fire loads into Izma's cheeks", false);
            //[(multi)
            if (this.player.totalCocks() > 1) this.outputText(" and hair", false);
            this.outputText(".", false);
            //[(big/mega skeet)
            if (this.player.cumQ() >= 750) this.outputText("  You continue to shoot off stroke after stroke long after her mouth has filled up and she's pulled away.  \"<i>For the love of Marae, " + this.player.short + ", I can't swallow all that!</i>\"", false);
        }
        else if (this.player.hasVagina()) this.outputText("drool a sticky mess over Izma's cheeks.", false);
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 1) this.outputText("lady-");
    ...
    private talkWivIzma(): void {
        ...
        //[Talk topic 4.]
            ...
            if (this.flags[kFLAGS.IZMA_NO_COCK] == 1) this.outputText("she used to have a ");
            else this.outputText("she's got a ");
            this.outputText("perfectly functional set of male genitalia.\n\n", false);

            if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("\"<i>Oh, nah.  Pfft, as if that's a challenge,</i>\" she says.  It's interesting to see how Izma, as a hermaphrodite, thinks of herself when it comes to the most basic of gender roles.  She scratches her chin in thought.  \"<i>Well, sexually, I'm more accustomed to my penis, since it's a bit easier to dominate with and the lake life seems to fixate on it.  But for you, I'll use whichever you want.</i>\"\n\n", false);
            else this.outputText("\"<i>Oh, nah.  Pfft, as if that's a challenge,</i>\" she says.  It's interesting to see how Izma, as a hermaphrodite, thinks of herself when it comes to the most basic of gender roles.  She scratches her chin in thought.  \"<i>Well, sexually, I was always more accustomed to my penis, since it was a bit easier to dominate with and the lake life seemed to fixate on it.  For you though, I'll do as you command, my Alpha.</i>\"\n\n");
    ...
    private chooseToFlirtWithIzma(): void {
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("her huge cock barely able to poke past her baby-filled belly, ");
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("  But she glances between her legs and sees her massive cock poking out of her skirt.");
        else this.outputText("  But she glances down to behold her rock-hard nipples jutting out.");
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) {
            ...
            ///(Female/herm)
            else this.outputText("  \"<i>Oh... you'd be so big and curvy, so sexy,</i>\" she purrs.  You advance towards her.  Leaning in, you mention you're willing to try and make a baby, right here and now.  \"<i>I... oh, wow.  We could certainly try,</i>\" she replies, grabbing your neck and pulling you in for a kiss.", false);
        }
        this.izmaSexMenu();
    }
    ...
    private childToggle(): void {
        ...
        //[=Yes=] (TURN ON KID-MODE
            ...
            if (this.flags[kFLAGS.IZMA_CHILDREN_SHARKGIRLS] + this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) {
    ...
    private IzmaPoopsBabies(): void {
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("jerking me off or ");
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("Divvying your time between her raging erection, quartet of sizable balls and dilating cunt while she strains under you is an awkward experience, but you persevere; when Izma stops hissing and gasping in pain and starts instead moaning lightly, it seems more worthwhile.\n\n", false);
        else this.outputText("Divvying your time between her dilating cunt and engorged clit while she strains under you is an awkward experience, but you persevere.  When Izma stops hissing and gasping in pain and starts instead moaning lightly, it seems more worthwhile.\n\n", false);
    ...
    public pcPopsOutASharkTot(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00238] != 1) {
            ...
            else this.outputText("tigershark", false);
            ...
            if (type == 0) this.outputText("shark-girl", false);
            else this.outputText("tigershark", false);
            ...
            if (this.player.breastRows.length > 1) this.outputText("  She then starts on your third breast, and while she slows down at the fourth breast, she still finishes it off.", false);
            //(If player has six breasts: 
            if (this.player.breastRows.length > 2) this.outputText("  She seems to almost be struggling to finish off your third pair, but she manages to suck all six of your breasts dry.", false);
    ...
    private izmaKidsPlaytime(): void {
        ...
        if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] + this.flags[kFLAGS.IZMA_CHILDREN_SHARKGIRLS] >= 2) choices[choices.length] = 3;
        ...
        if (this.model.time.hours < 10 && this.flags[kFLAGS.ANEMONE_KID] > 0 && IzmaScene.rand(2) == 0) {
        ...
        if (this.flags[kFLAGS.IZMA_CHILDREN_SHARKGIRLS] + this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] == 1) this.outputText("There is ", false);
        else this.outputText("There are ", false);
        if (this.flags[kFLAGS.IZMA_CHILDREN_SHARKGIRLS] > 0) {
            if (this.flags[kFLAGS.IZMA_CHILDREN_SHARKGIRLS] == 1) this.outputText("one shark-girl", false);
            else this.outputText(IzmaScene.num2Text(this.flags[kFLAGS.IZMA_CHILDREN_SHARKGIRLS]) + " shark-girls", false);
            if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) this.outputText(" and ", false);
        }
        if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) {
            if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] == 1) this.outputText("one tigershark", false);
            else this.outputText(IzmaScene.num2Text(this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS]) + " tigersharks", false);
        }
        ...
        //NOPE
        if (choice == 1) {
            if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] == 1) this.outputText("Your lone tigershark daughter is off by herself, experimentally stroking and fondling her already-impressive cock.  It doesn't look like it'll be long before she cums; her face is already screwed up in an expression of curious pleasure, gasping softly at the sensations.", false);
            //(Requires 2-3 Tigersharks: 
            else if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] < 4 && this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) this.outputText("Your tigershark daughters are seated together, each experimentally stroking and fondling her sizable erection.  It looks like they're competing to see who will cum first.", false);
            //(Requires 4+ Tigersharks:
            else if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) this.outputText("Your tigershark daughters are seated together, each experimentally jerking off either her own cock or one of her sisters.  Some look to be competing to see who can jerk themselves off first, others are evidently seeing who's better at handjobs.", false);
            if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) this.outputText("  Izma blushes and explains that your children have strong libidos, so it's natural for them to experiment like this.  She assures you that they won't do any real sexual penetration with a family member.\n\n", false);
        }
        ...
        //NOPE
            ...
            //Other children:
            if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] + this.flags[kFLAGS.IZMA_CHILDREN_SHARKGIRLS] > 2) this.outputText("  Your other kids are gathered around, watching with amusement and a little envy as one of your tigershark offspring plows an excited goblin.  \"<i>Oh, yeah, baby, now you folks know how to live!</i>\" she cheers.", false);
            if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 2) this.outputText("  \"<i>Don't worry; you'll get a chance to use a beautiful big cock on me, too - just wait your turn!</i>\" she laughs looking around the circle.  Your other daughters look like they can't wait.", false);
        ...
        if (choice == 4) {
            ...
            if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] + this.flags[kFLAGS.IZMA_CHILDREN_SHARKGIRLS] == 1) this.outputText("your daughter", false);
            else this.outputText("one of your daughters", false);
        ...
        if (choice == 5) {
            ...
            if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] + this.flags[kFLAGS.IZMA_CHILDREN_SHARKGIRLS] == 1) this.outputText("child perks up to see Izma and comes running over to her, throwing herself into her arms", false);
            else this.outputText("children perk up to see Izma and come running over to her, throwing themselves into her arms", false);
            ...
            if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] + this.flags[kFLAGS.IZMA_CHILDREN_SHARKGIRLS] == 1) this.outputText("cries out in joy at the prospect of storytime and eagerly seats herself in front of her, listening as she starts to read.", false);
            else this.outputText("cry out in joy at the prospect of storytime and eagerly seat themselves in front of her, listening as she starts to read.", false);
    ...
    private inCampRideIzmasDickDongTheWitchIsDead(): void {
        ...
        if (this.player.hasCock()) {
            this.outputText("  Your " + Appearance.cockNoun(this.player.cocks[0].cockType) + " rubs against her shaft, sending delicious sparks surging through you.", false);
        }
        ...
        if (this.player.wetness() >= 5) this.outputText("  Not that this stops your nether-lips from drooling your lubricant all over Izma's crotch.", false);
        this.outputText("\n\n", false);
        ...
        if (this.player.cor < 66) this.outputText("you've teased her enough", false);
        else this.outputText("you've delayed your pleasure long enough", false);
        this.outputText(", you sink down onto her, stifling a yelp as she fills your depths.", false);

        //(Tight/Virgin vagina)
        if (this.player.vaginalCapacity() < 20 || this.player.vaginas[0].virgin) this.outputText("  Holy shit, that hurts like a motherfucker! It's as if you're trying to stuff a baguette into your vag!", false);
        //(Loose)
        else if (this.player.vaginalCapacity() < 50) this.outputText("  You groan and shudder slightly as you slide down the generous 15 inches of dick, the slight pain being drowned out by the sensation of being filled as full as you could possibly hold.", false);
        //(Gaping)
        else this.outputText("  You shudder and lick your lips. Izma may be big but you've had bigger, and you fit her cock like a glove.", false);
        this.player.cuntChange(30, true, true, false);
        ...
        if (this.player.cor < 33) this.outputText("Feeling merciful, you tell her that you're almost there... just a little more.  ", false);
        ...
        if (this.player.wetness() < 4) this.outputText("spatters", false);
        else if (this.player.wetness() < 5) this.outputText("gushes", false);
        else this.outputText("fountains", false);
    ...
    private stephenHawkingPorn(): void {
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("continuously to keep the beast in her skirt pinned down.\n\n", false);
        else this.outputText("nervously in an effort to keep from moistening it.\n\n", false);
        this.flags[kFLAGS.IZMA_TIME_TILL_NEW_BOOK_AVAILABLE] = 11;
    ...
    private fuckIzmasPussyDominate(): void {
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("es");
        this.outputText(" now stand");
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 1) this.outputText("s");
        this.outputText(" exposed to the cool air, drooling ");
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("their sexual lubricants");
        else this.outputText("its sexual lubricant");
        ...
        if (this.flags[kFLAGS.IZMA_NO_COCK] == 1) this.outputText("shark-girl");
        ...
        if (this.player.isNaga() || this.player.isTaur() || this.player.isGoo()) this.outputText("With her tail now against your shoulder blade and jutting up in the air, your path to her fuckhole is now clear.  ");
        //(If human or Harpy legs are present: 
        else this.outputText("Lifting your right leg over her rump, you give yourself the superior position needed to ravage her cunt.  ");
    ...
    private radarIzmaGasm(): void {
        ...
        if (this.player.cumQ() <= 750) this.outputText("shooting your hot load into Izma's fuckhole, enveloping the walls of her pussy with your seed.");
        //(Cum production High: 
        else this.outputText("unleashing a cascade of steamy jizz into Izma's well fucked hole.  Your volume is so large that it causes a back draft of semen to rush out of her within mere seconds.");
        ...
        if (this.player.cumQ() > 750) this.outputText("bloated ");
        this.outputText("belly, clamping her legs shut in ");
        if (this.player.cumQ() <= 750) this.outputText("a ");
        else this.outputText("an ultimately ");
    ...
    private radarIzmaAnalDominant(): void {
        ...
        if (this.player.hasVagina()) this.outputText("Your [clit] flushes with");
        else if (this.player.hasCock()) this.outputText("[EachCock] bobs in");
        else this.outputText("You flush with");
        ...
        //(if Virgin to Tight:
        if (this.player.analCapacity() < 35) this.outputText("painfully rending the tight shape of your anus on it, causing both of you to moan in pain as you envelop more and more of her dick inside of you.  Izma slams into you forcefully as she unleashes a huge gasp, face utterly flooded with ecstasy as she stares into the sky behind closed eyes.");
        //(If loose to gaping: 
        else this.outputText("slipping past the fleshy \"gates\" of your anus, requiring little stretching or working of your " + this.assholeDescript() + ".  You're worried that this might not work the way you want it to, given how easy it was to take Izma; a series of wild, erratic thrashings against your ass as the penile intruder tunnels deeper seems to dispel that notion.");
        ...
        if (this.player.isGoo()) this.outputText("and goo");
        ...
        if (this.player.hasVagina()) this.outputText(this.clitDescript());
        else if (this.player.hasCock()) this.outputText(this.cockDescript(0));
        else this.outputText("violated anus");
        ...
        if (this.player.isGoo()) this.outputText("; taking her firm ass into your slippery body's grip, you begin to force Izma to gyrate against you, driving the shark-morph mad with pleasure");
        ...
        if (this.player.hasVagina()) this.outputText("feverish hands as you fingerfuck your " + this.vaginaDescript() + ".");
        //(If PC has balls: 
        else if (this.player.balls > 0) this.outputText("swinging [balls] with each gyration of your hips.");
        //(If PC is genderless: 
        else this.outputText("thighs, thoroughly \"tenderizing\" them with every thunderous impact.");
    ...
    private radarIzmaAnalDomResultTuckIn(): void {
        ...
        if (this.player.str < 70) {
            ...
            else this.outputText("you try and get her to her bedroll, but you are simply too exhausted.  Izma tells you not to worry about her and go get some rest; that she'll be okay in the grass.  You groggily agree as you set her down, telling her she better be ready for more sex if you want it; something she approves of as she hums and drifts off to sleep.");
        }
        else {
    ...
    private radarFucksIzmasAss(): void {
        ...
        if (this.player.cocks[x].cockType != CockTypesEnum.TENTACLE) {
            ...
            if (y >= 0) this.outputText(" as you gently place your other dick against her labia");
            this.outputText(".");
            ...
            if (y == -1) this.outputText("her anus");
            else this.outputText("both of her holes");
            ...
            if (y >= 0) this.outputText("cocks against the unyielding ends of her anus and pussy, unleashing a weak whimper of bliss from under you.");
            else this.outputText("cock against the unyielding end of her anus, unleashing a weak whimper of bliss from under you.");
    ...
    */
    ...
    private internalIzmaAnalCumShot(): void {
        ...
        if (this.player.cockThatFits2(65) >= 0) this.outputText("  The feelers in her pussy glide along the glans of your " + this.cockDescript(this.player.cockThatFits2(65)) + ", driving your dick's unconscious efforts to inseminate her into overdrive as you feel each subsequent stream of semen increase in velocity.");
    }
    ...
    private backJizzShot(): void {
        ...
        if (this.player.cockTotal() == 1) this.outputText("your shaft ");
        else if (this.player.cockTotal() == 2) this.outputText("two shafts ");
        else this.outputText("three shafts");
        ...
        //(Cum volume normal: 
        if (this.player.cumQ() < 500) this.outputText("firing thin streams of semen from [eachCock], lathering Izma's luscious red body and making it glisten in the sun.");
        //(Cum volume high:
        else if (this.player.cumQ() <= 1000) this.outputText("streaming forth like fierce rain down a tree, repeatedly striking Izma across the face and breasts as your orgasm continues unabated for several moments.");
    ...
    public izmaDomsLatexy(): void {
        ...
        //{Repeat}
            ...
            this.outputText("\n\n\"<i>Go on, you need to make me want to use you!</i>\" Izma says while slowly caressing her penis.  She's openly leering down at the reflective, ebon-skinned slut, and the poor, collared woman reluctantly parts her glossy folds, slowly feeding her fist into her capacitive nethers, one knuckle at a time.  Once her wrist disappears, it's only a short moment before she pulls it back out, gasping from unexpected pleasure.  Strings of inky lubricant dangle precariously between her digits and stretched snatch, just about to break until " + this.flags[kFLAGS.GOO_NAME] + "'s hand is plunged back into the inky honeypot.");
    ...
    private izmaDomsLatexyPartI(): void {
        ...
        if (this.latexGirl.gooObedience() > 50) this.outputText("eagerly");
        else this.outputText("sheepishly");
        ...
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] > 0) this.outputText("cock");
        else this.outputText("clit");
        this.outputText(" with a toe, drawing a pleasured gasp from the submissive.");
        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " shudders as she pushes her hand in and out of herself.  Her whole forearm is dripping with onyx moisture, and the noisy squelches are easy to hear from where you're watching.  \"<i>Yes... I'm a slutty, submissive girl...  Can I have your cum, mistress Izma?  Please?  I'm putting on such a good show!</i>\"");
        if (this.latexGirl.gooObedience() < 50) this.outputText("  A look of annoyance flashes across her face as soon as she says it, like she didn't really want to say that so openly.");
        else if (this.latexGirl.gooObedience() <= 80) this.outputText("  A conflicted look flashes across her face as soon as the words slip out, but there's no taking them back.");
        else this.outputText("  A hungry look flashes in her eyes as soon as the words leave her mouth, and she licks her lips hungrily.");
        this.outputText("  A particularly powerful thrust inside herself has " + this.flags[kFLAGS.GOO_NAME] + " whining, her eyelids fluttering closed as she cries, \"<i>Oh, [name]!</i>\"");

        this.outputText("\n\nYou smile in satisfaction as your beta and your submissive, former slime tend to their needs together, proud that in the face of fifteen inches of stripe-cock, " + this.flags[kFLAGS.GOO_NAME] + " still fantasizes about you.");
        this.outputText("\n\n\"<i>Good enough, slut,</i>\" Izma croons in between heavy pants.  She slaps her swollen shark-cock across the black-skinned woman's hungry face.  Gasping in surprise, " + this.flags[kFLAGS.GOO_NAME] + "'s' shocked expression tells you all you need to know, right up until the red boner plunges into her unresisting lips.  Liquid, " + this.flags[kFLAGS.GOO_EYES] + " eyes look up in surprise before fluttering contently closed.  Izma's hand caresses a lock of slippery, latex hair and forces herself deeper into the wet, former goo's throat.  Droplets of inky moisture roll out around the edges of the shaft, painting her four-balled nutsack black before they cool and harden around it.");

        this.outputText("\n\nHands reaching out towards the slippery, sheathed quartette, " + this.flags[kFLAGS.GOO_NAME] + " hums around the throat-stretching bulge as she does her best to milk it, gently squeezing each cum factory in turn.  Izma hooks a leg over " + this.flags[kFLAGS.GOO_NAME] + "'s shoulder and begins to roughly fuck the onyx beauty.  She hammers her cock home with crude thrusts that pound all fifteen inches straight into the goo-girl's core, the only sounds half-strangled hums of pleasure and the heated squelches Izma's groin makes when it bottoms out on her partner's greedy lips.");
    ...
    private stopIzmaLatexy(): void {
        this.clearOutput();
        this.outputText("You step into the middle of it before it can progress any farther.  " + this.flags[kFLAGS.GOO_NAME] + " is yours, and Izma is not to play at being a mistress to YOUR pet.");
    ...
    private izmaLatexyToggle(): void {
        ...
        if (this.flags[kFLAGS.IZMA_X_LATEXY_DISABLED] == 0) {
            this.outputText("You tell Izma you don't want her feeding " + this.flags[kFLAGS.GOO_NAME] + " any more.");
            ...
            this.outputText("You tell Izma that you've changed your mind, and she can keep " + this.flags[kFLAGS.GOO_NAME] + " fluid topped off.  The shark-girl hugs you with a predatory grin splitting her face.  \"<i>I can't wait.</i>\"");
