...
export class SophieFollowerScene extends NPCAwareContent {
    ...
    public sophieFollower(): boolean {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0 && this.flags[kFLAGS.SOPHIE_DEBIMBOED] > 0) return true;
    ...
    public followerSophieMainScreen(): void {
        ...
        //Sophie is in season
        if (this.sophieBimbo.sophieIsInSeason() && this.player.hasCock() && this.flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 0) {
            ...
            if (this.sophieBimbo.bimboSophie()) this.outputText("restoring her intellect made her quite skilled at it again");
            else this.outputText("she's quite skilled at it");
    ...
    private sleepWithSophieToggle(): void {
        ...
        if (this.flags[kFLAGS.SLEEP_WITH] != "Sophie") {
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0) {
                ...
                this.outputText("\n\nYou ");
                if (this.player.cor < 33) this.outputText("sheepishly ");
                ...
                if (this.player.smallestCockArea() <= 5 && this.player.hasCock()) this.outputText(", but don't be surprised if I go a little rough on that tiny dick of yours in the morning");
                this.outputText("!</i>\" she calls.");
                if (this.player.smallestCockArea() <= 5 && this.player.hasCock()) this.outputText("\n\n<b>If you don't want her to tease you about your small penis, you had better tell her to stop sleeping with you.</b>");
            }
            //NORMAL
            else {
                ...
                if (this.player.smallestCockArea() <= 5 && this.player.hasCock()) this.outputText("  \"<i>You won't mind me teasing your cute little dick in the mornings, will you [name]?  It's so cute...</i>\" she muses.\n\n<b>If you don't want her to tease you about your small penis, you had better not sleep with her.</b>");
            }
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] == 0) this.outputText("Well, it is your bed.  Let me know if you want me coming back for snuggles, okay?");
            else this.outputText("Couldn't handle all these curves, huh, [name]?  Don't fret, Momma Sophie will stick around until you can't stop yourself from cuddling up on her.");
            this.outputText("</i>\"");
    ...
    private fuckFollowerSophie(): void {
        ...
        if (this.sophieBimbo.sophieIsInSeason()) this.outputText("gushing, sperm-hungry");
        ...
        if (this.player.inte < 50) this.outputText("\n\nAbruptly");
        ...
        if (y >= 0) this.outputText("fuck it");
        else this.outputText("finger my asshole");
        this.outputText(" while I fuck you, [name]!</i>\" she commands, fixing you with her eyes authoritatively.  ");
        if (y >= 0) this.outputText("You shift to bring your " + this.cockDescript(y) + " up in place, just in time for Sophie's wiggling rectum to spread around it.  It slides on in without so much as a whimper.");
        else this.outputText("You thumb at her asshole hesitantly, right up until her wiggling rectum presses on it, easily dilating around your invading finger.");
        ...
        if (y >= 0) this.outputText(" and anal walls");
        ...
        if (y >= 0) this.outputText("  You pack her intestines full of cum at the same time that you sperm up her clingy cunny tunnel.");
        if (this.sophieBimbo.sophieIsInSeason()) this.outputText("  Her pussy seems to drink the spunky deposit down, her cervix opening to allow in as much in as possible.  You can feel the suction, and if you weren't already riding out a mind-bending orgasm, you're sure you'd be cumming harder than normal right now.");
        ...
        if (this.player.cumQ() >= 500) {
            ...
            if (this.player.cumQ() < 1000) this.outputText("has begun to inflate");
            else this.outputText("has inflated to an absurd degree");
            this.outputText(" due to all the spooge you're squirting");
            if (this.player.cumQ() >= 4000) this.outputText(" and it's still growing larger");
            this.outputText(".");
        }
        ...
        if (y >= 0) this.outputText(" and " + this.cockDescript(y));
    ...
    private sophieVagFollowerFollowup(): void {
        ...
        else if (this.player.cockArea(x) <= 5) this.outputText("Not too bad for a tiny girl-dick!");
    ...
    private sophieFollowerGivesBlowjobs(): void {
        ...
        if (this.player.cockArea(x) <= 5) this.outputText("tiny clit you call a penis");
        else if (this.player.cockArea(x) <= this.sophieBimbo.sophieCapacity() / 2) this.outputText("needy boy-cock");
        else this.outputText("over-swollen engorgement you call a cock");
        ...
        if (this.player.biggestTitSize() >= 1) this.outputText(", right between your [chest]");
        this.outputText(", and she slowly trails it up to your chin, which she gently grabs in her long-nailed fingers.  \"<i>");
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0) this.outputText("You may have given me a bimbo's body and an insatiable need for sex,");
        else this.outputText("You may have seduced me into your camp with hot sex,");
    ...
    private sophieBlowsSixtyNine(): void {
        ...
        if (this.player.cockTotal() > 1) this.outputText("s, searching for her target of the day.  At last, she settles on your " + this.cockDescript(x) + ", giving it an affectionate squeeze");
        else this.outputText(", giving it an affectionate squeeze");
        ...
        if (this.player.hasVagina()) {
            ...
            if (this.player.balls > 0) this.outputText(" reaches under your [balls] and");
        ...
        else this.outputText("She tenderly strokes a long nail across the sensitive skin of your taint.  It seems she's being very considerate to your pleasure, so considerate she has you so hard and full that it almost hurts.");
        ...
        if (this.player.cockArea(x) <= 60) this.outputText("to the [sheath]");
        else this.outputText("as far as she can, gagging slightly");
        ...
        if (this.player.cumQ() >= 1000 || this.player.cockTotal() > 1) this.outputText("  Warm goo covers your [hips] and [butt] once your virile deposit becomes too much for Sophie to handle.");
        if (this.player.cumQ() >= 500) this.outputText("  She quickly gives up on trying to swallow it after she starts showing some cum-pudge, but her hand pumps you energetically as she milks your " + this.cockDescript(x) + ", squeezing the voluminous ropes of cum all over your [chest].");
        if (this.player.cumQ() >= 3000) this.outputText("  You make a big white puddle with all the drippings, sinking into the cummy mud as you eat out the orgasmic harpy matron.");
    ...
    private forceSophieBlowjob(): void {
        ...
        if (this.player.balls > 0) this.outputText("fondling your [balls] with almost eager attention,");
        else this.outputText("rubbing your length with almost eager attention,");
        ...
        if (this.player.cockArea(x) <= 60) this.outputText("as far as it can go, even taking you part way into her throat before she runs out of room");
        else this.outputText("the whole way to your base, inch after inch of dick-flesh vanishing into her pliant throat");
        this.outputText(".");
        ...
        if (this.player.cockTotal() == 2) this.outputText("  Your extra cock flops against her cheek, catching on her ear and slowly leaking pre-cum into her down-soft hair.");
        else if (this.player.cockTotal() > 2) this.outputText("  Your extra cocks flop against her cheeks, catching on her ear and shoulder and slowly leaking pre-cum into her down-soft hair.");
        ...
        if (this.player.balls > 0) this.outputText("  Your [balls] feel almost like they're filling up, taut with liquid weight that begs to pump out");
        else this.outputText("  It feels tight, like you're filling up with a warm liquid weight that's just begging to be let out");
        ...
        if (this.player.balls > 0) this.outputText(" your [sack] and over");
        ...
        if (this.player.hasKnot(x)) this.outputText("  The knot inflates just behind her lips, a golden orb that entraps you within her slick mouth and makes sure all your salty cremè is going to go down her throat.");
        ...
        if (this.player.cumQ() >= 500) {
            ...
            if (this.player.cumQ() >= 2000) this.outputText(", but that's just the beginning.  You bloat her tummy to an obscene, almost spherical shape");
            if (this.player.cumQ() >= 4000) this.outputText(", and then cum some more, the flooding jizz forced to escape from her nostrils after you finish flooding every inch of her digestive system");
            this.outputText(".");
        }

        this.outputText("\n\nAlmost regretfully, you ");
        if (this.player.cocks[x].cockType != CockTypesEnum.DOG) this.outputText("slip your spasming boner out of her golden gates, dripping the last few drops onto her pouty lower-lip.");
        else this.outputText("pull against Sophie's cock-locked mouth, but your knot won't budge.  You sit there waiting for it to go down for what seems like forever, and her lipstick doesn't exactly help - it seems like your cum continues to flow and dribble the entire time, your animal-dong intent on inseminating the harpy's mouth.  Still, you manage to 'pop' free eventually, even though it stretches Sophie's jaw and echoes around your camp.");
        ...
        if (this.flags[kFLAGS.SOPHIE_FOLLOWER_IRRITATION] == 1) this.outputText("Ahhh... not... not as much as... I would if you'd reciprocate!");
        else if (this.flags[kFLAGS.SOPHIE_FOLLOWER_IRRITATION] < 4) this.outputText("Ahhh... I... I don't know how many times I'll put up with this kind of treatment!");
        else if (this.flags[kFLAGS.SOPHIE_FOLLOWER_IRRITATION] < 8) this.outputText("Ahhh... are... are you ever going to reciprocate?");
        else if (this.flags[kFLAGS.SOPHIE_FOLLOWER_IRRITATION] == 8) this.outputText("Ahhh... I think... I've had enough...");
        else this.outputText("Ahhh... actually... I think... <b>I think if you don't treat me nicer, I might leave.</b>");
        this.outputText("</i>\"");
    ...
    public sophieSmallDongTeases(): void {
        ...
        if (this.player.str >= 70) this.outputText("  You could force her off you if you wanted, but you didn't bring her to bed for nothing.");
        ...
        if (this.player.breastRows[0].breastRating >= 1) this.outputText(" and squeezes your " + this.player.breastCup(0) + " breast roughy.");
        else this.outputText(" and lets the talons dig into your " + this.player.skinFurScales() + " just enough to hurt a little.");
        ...
        if (this.flags[kFLAGS.TIMES_MORNING_SOPHIE_FEMDOMMED] > 0) this.outputText("In the back of your mind, you know that if her words weren't true you wouldn't have kept sleeping with her and letting her do this to you.");
        else this.outputText("In the back of your mind, you almost have to wonder if it's true, or if her lipstick is just now getting into your system...");
        ...
        if (this.player.sens / 5 + SophieFollowerScene.rand(20) + 1 <= 20) {
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0) this.outputText("golden");
            else this.outputText("pink");
            ...
            else if (this.player.tone >= 70) this.outputText("toned ");
            ...
            if (this.player.cumQ() >= 500) {
                ...
                if (this.player.cumQ() < 1000) this.outputText(" with huge wet spots over your bodies");
                else this.outputText(" soaked from the waist down");
                this.outputText(".  It feels so good that neither of you mind.");
            }
            if (this.player.cumQ() >= 2000) this.outputText("  Your bed is a reflective, sticky white as well, practically a lake of seed by now.");
        }
        //{High Sensitivity}
        else {
            ...
            if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150) this.outputText(", rolling off the pregnant dome you call your tummy");
            this.outputText(".");
            if (this.player.cumQ() >= 500) this.outputText("  You cum for what seems like hours, emptying your [balls] onto yourself, every drop of wasted seed a testament to your pussy-whipped status.");
            if (this.player.cumQ() >= 1000) this.outputText("  A puddle of jizz forms around you before long, mixing with the drippings from her pussy as she rides you into your own soaked bedding.");
        ...
        if (this.player.cumQ() >= 1000) this.outputText("huge ");
    ...
    private sophieSpecial(): void {
        ...
        if (this.player.balls > 0) this.outputText(", and your [balls] are just waiting to unload a virile, sticky package down her throat");
        ...
        if (this.player.cockArea(x) <= 5) this.outputText("squirting clitty");
        else if (this.player.cockArea(x) <= 30) this.outputText("needy boy-cock");
        else this.outputText("giant piece of a meat rod");
        ...
        if (this.player.balls > 0) this.outputText("[balls] and ");
        ...
        if (this.player.cumQ() < 250) this.outputText("  She milks you for all you're worth.");
        else if (this.player.cumQ() < 750) this.outputText("  She whimpers at how much you've discharged into her.");
        else if (this.player.cumQ() <= 1500) this.outputText("  Your cum soon gushes out into a small puddle from her pussy and onto your [hips].");
        else this.outputText("  Her ass is suddenly pushed out more towards you, cum gushing out of her wet cunt as she starts inflating from the sheer amount of cum in your first load.");

        this.outputText("\n\n\"<i>Good " + this.player.mf("boy", "girl") + " with a nice, obedient ");
        if (this.player.cockArea(x) <= 5) this.outputText("clitty");
        else if (this.player.cockArea(x) <= 30) this.outputText("pretty cock");
        else this.outputText("humongous cunt-stretcher");
        ...
        if (this.player.cumQ() < 250) this.outputText("her pussy dripping your cum down onto the ground");
        else this.outputText("your own semen drowning your [hips] and [butt] in a messy cum-puddle as it drips out of her");
        ...
        if (this.player.cockArea(x) <= 5) this.outputText("dainty little fem-cock");
        else if (this.player.cockArea(x) <= 30) this.outputText("nice, sweet cum-squirter");
        else this.outputText("immense, gorgeous beast of a cock");
        ...
        if (this.player.cumQ() < 250) this.outputText("several ropes");
        else if (this.player.cumQ() < 750) this.outputText("a large, chaotic stream");
        else if (this.player.cumQ() < 2000) this.outputText("wave after wave");
        else this.outputText("massive amounts");
        this.outputText(" of cum into her, causing her to ");
        if (this.player.cumQ() < 500) this.outputText("moan in satisfaction");
        else if (this.player.cumQ() < 1000) this.outputText("groan as her cunny is unable to hold it all");
        else if (this.player.cumQ() < 2000) this.outputText("stretch atop of you, a cum-filled tummy added to the jiggling tits and soft butt");
        else this.outputText("erupt your cum violently around your shaft as you stretch her to pregnancy-looking visage with your cum alone");
        this.outputText(".");
        ...
        if (this.player.cumQ() < 250) this.outputText("  You only drop a meager few squirts inside of her");
        else if (this.player.cumQ() < 750) this.outputText("  Even your large cum production can't keep up with that pace");
        else this.outputText("  Inhuman as your cum factories are, you're only capable of delivering a few big spurts before it slows to a dribble");
    ...
    private kissSophieRecruitment(): void {
        ...
        if (this.player.cockTotal() > 1) this.outputText(", your second one sliding up between her butt");
        if (this.player.cockTotal() > 3) this.outputText(" while the others press against her");
    ...
    private sophieRecruitmentFinale(): void {
        ...
        if (this.camp.companionsCount() >= 3) this.outputText(", sure to introduce her to the other denizens along the way and smooth over any ruffled feathers before things escalate.  Sophie does a good job helping with that.  She seems to have a natural ability to defuse angry situations, something she attributes to raising her many daughters");
        this.outputText(".");
    ...
    public sophieIncestInHerCooterOrSomethingIDunno(): void {
        ...
        if (this.flags[kFLAGS.SOPHIE_ADULT_KID_COUNT] > 1) this.outputText("The prospect of their " + this.player.mf("father", "mother") + "'s attention causes a small scuffle to break out between your feathery daughters. Thankfully, the small fight is soon ended and one of your daughters flies down and stands before you.  ");
        else this.outputText("Your daughter, hearing your call, is more than happy to come to you.  ");
        ...
        //second daughter: 
            ...
            if (this.flags[kFLAGS.DAUGHTER_TWO_BIMBO] > 0 && this.flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] == 0) this.outputText("\"<i>Mmmm... doncha want to just like, pound my sexy ass, " + this.player.mf("Daddy", "Mommy") + "?  It's so big, it's just begging to be spanked and squeezed till it's totally red and sensitive</i>\"");
            else this.outputText("\"<i>Come on, " + this.player.mf("Daddy", "Mommy") + ", touch me, spank me like the bad girl I am, lusting after my " + this.player.mf("Daddy", "Mommy") + " like this.  Give it to me hard, spank my big round ass and pound my hot tight cunt like I know you want</i>\"");
        ...
        //third daughter:
            ...
            if (this.flags[kFLAGS.DAUGHTER_THREE_BIMBO] > 0 && this.flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] == 0) this.outputText("\"<i>L-like, did I do a good job, " + this.player.mf("Daddy", "Mommy") + "?  I so totally did my best for you.  I know I'm not super sexy like Mom and my sisters... but, " + this.player.mf("Daddy", "Mommy") + ".. I will like, still please you, like, totally the best that I can!</i>\"");
            else this.outputText("\"<i>W-well, what did you think, " + this.player.mf("Dad", "Mommy") + "?  Did I do a good job?  I know I'm not as hot as Mom, but I promise I'll please you as best I can!</i>\"");
            ...
            if (this.flags[kFLAGS.DAUGHTER_FOUR_BIMBO] > 0 && this.flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] == 0) this.outputText("\"<i>Come on " + this.player.mf("Daddy", "Mommy") + ", can't you see how totally hot I am?  Don't you just want to let loose and like, just fuck me till I scream.</i>\"");
            else this.outputText("\"<i>Just look at me, " + this.player.mf("Daddy", "Mommy") + ", so curvy, so ready, so hot and wet for you.  Just let loose and show me your love, show me how much you love me, " + this.player.mf("Daddy", "Mommy") + ", fuck me hard, make me scream and claim me as yours.</i>\"");
            ...
            //bimbo speech
            if (this.flags[kFLAGS.DAUGHTER_FOUR_BIMBO] > 0 && this.flags[kFLAGS.SOPHIES_DAUGHTERS_DEBIMBOED] == 0) this.outputText("  \"<i>Ahh... ohhh... oh, " + this.player.mf("Daddy", "Mommy") + "!  You like my butt, don't you; isn't it nice?  It's so good to grab and squeeze.  I bet it would be fun to, like, spank it too....</i>\"");
            //[normal speech:]
            else this.outputText("  \"<i>Mmmm... Oh, " + this.player.mf("Daddy", "Mommy") + ", yessss...  That's it, touch me, touch me and play with me, do whatever you want with me.</i>\"");
    ...
    private phaseTwoOfIncest(daughter: number): void {
        ...
        if (daughter == 1) this.outputText("massive pillowy tits");
        else this.outputText("tender perky breasts");
        ...
        if (this.player.biggestTitSize() >= 1) {
            ...
            //if small bust:
            if (this.player.biggestTitSize() < 3) this.outputText(", perk up as the cool air brushes past your hard, aroused nipples.");
            else if (this.player.biggestTitSize() < 10) this.outputText(", bounce perkily, nipples hard as your handful of breast flesh touches the cool air.");
            else this.outputText(", spring forth in a wave of soft, squeezable bustiness; the kind of breasts one could curl up with and use as a pillow.");
        }
        ...
        if (daughter == 1) this.outputText("The sensation of your lips pressing against her puffy, sensitive lips so roughly only makes her pleasure greater; her pussy quivering around you and clenching hard as you kiss her.  ");
        ...
        //[cum volume low:
        if (this.player.cumQ() < 250) this.outputText("  Squirting over and over into your sweet, lusty girl, you inseminate your fertile daughter, spilling as much of your cream right into her needy, hungry womb as possible.");
        //cum volume medium:
        else if (this.player.cumQ() < 500) this.outputText("  Gushing over and over into your sweet, lusty daughter, you hold yourself tighter against her, making sure you force as much of your spunk into her waiting, hungry womb as you can.");
        //[cum volume high:
        else if (this.player.cumQ() < 2000) this.outputText("  Gush after gush of thick rich cum flows from you, basting your daughter's womb with your virile spunk.  Wedging yourself as tightly against her as you can, you make sure that every drop packs into her fertile belly.  The potent flow of your seed quickly swells her stomach into a cute cum bloated paunch.");
        else this.outputText("  Your seed floods your daughter's tight, squeezing cunt like a flood, wave after wave of your thick, frothy spunk forces its way through her convulsing cunt and right into her eager, waiting womb.  Geysers of thick, frothy spunk force their way into her womb, filling it fuller and fuller until her belly swells and swells.  Her once tight, flat tummy rounds out into a healthy round cumbaby, your thick, yogurt-like spunk overflowing from her overstuffed snatch in thick, sticky streams.");
        ...
        if (bimbo) this.outputText("  \"<i>Oh, " + this.player.mf("Daddy", "Mommy") + ", oh, " + this.player.mf("Daddy", "Mommy") + "...  So good!  My " + this.player.mf("Daddy", "Mommy") + "'s such a hot, sexy " + this.player.mf("stud", "herm") + ".  I so totally thought I was going to like, lose my mind for a second.  I love you, " + this.player.mf("Daddy", "Mommy") + ".</i>\"");
        else this.outputText("  \"<i>Oh, " + this.player.mf("Daddy", "Mommy") + ", oh, " + this.player.mf("Daddy", "Mommy") + "... so good, you're such a fucking " + this.player.mf("stud", "perfect breeder") + "!  I could just get addicted to you.  I love you, " + this.player.mf("Daddy", "Mommy") + ",</i>\"");
