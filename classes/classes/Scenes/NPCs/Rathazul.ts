...
export class Rathazul extends NPCAwareContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        if (this.flags[kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] > 1) {
            ...
            if (this.flags[kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] < 1) this.flags[kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] = 1;
            if (this.flags[kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] > 300) this.flags[kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] = 24;
        }
        if (this.flags[kFLAGS.RATHAZUL_CAMP_INTERACTION_COUNTDOWN] > 0) {
            this.flags[kFLAGS.RATHAZUL_CAMP_INTERACTION_COUNTDOWN]--;
            if (this.flags[kFLAGS.RATHAZUL_CAMP_INTERACTION_COUNTDOWN] < 0) this.flags[kFLAGS.RATHAZUL_CAMP_INTERACTION_COUNTDOWN] = 0;
        }
        return false;
    }
    ...
    public encounterRathazul(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_PURIFICATION_STAGE] == 2 && this.player.findStatusAffect(StatusAffects.MetRathazul) >= 0) {
        ...
        //Camp offer!
        if (this.player.statusAffectv2(StatusAffects.MetRathazul) >= 3 && this.player.statusAffectv3(StatusAffects.MetRathazul) != 1 && this.player.cor < 75) {
            ...
            this.doYesNo(this, this.rathazulMoveToCamp, this.rathazulMoveDecline);
    ...
    public campRathazul(): void {
        ...
        if (this.flags[kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] == 1 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00275] > 0) {
        ...
        if (Rathazul.rand(6) == 0 && this.flags[kFLAGS.RATHAZUL_CAMP_INTERACTION_COUNTDOWN] == 0) {
            ...
            //Pure jojo
            if (this.flags[kFLAGS.JOJO_RATHAZUL_INTERACTION_COUNTER] == 0 && this.player.findStatusAffect(StatusAffects.PureCampJojo) >= 0 && this.flags[kFLAGS.JOJO_DEAD_OR_GONE] == 0) {
                this.finter.jojoOffersRathazulMeditation();
                return;
            }
            if (this.flags[kFLAGS.AMILY_MET_RATHAZUL] == 0 && this.flags[kFLAGS.AMILY_FOLLOWER] == 1 && this.amilyScene.amilyFollower()) {
                this.finter.AmilyIntroducesSelfToRathazul();
                return;
            }
            if (this.flags[kFLAGS.AMILY_MET_RATHAZUL] == 1 && this.flags[kFLAGS.AMILY_FOLLOWER] == 1 && this.amilyScene.amilyFollower()) {
                this.finter.amilyIngredientDelivery();
                return;
            }
            if (this.flags[kFLAGS.AMILY_MET_RATHAZUL] == 2 && this.flags[kFLAGS.AMILY_FOLLOWER] == 1 && this.amilyScene.amilyFollower()) {
        ...
        if (!offered) {
            ...
            if (this.player.findStatusAffect(StatusAffects.CampRathazul) >= 0)
                this.doNext(this, this.camp.campFollowers);
    ...
    private rathazulWorkOffer(): boolean {
        ...
        if (this.player.findStatusAffect(StatusAffects.CampRathazul) >= 0 && this.player.statusAffectv2(StatusAffects.MetRathazul) >= 4) {
            ...
            if (this.flags[kFLAGS.AMILY_MET_RATHAZUL] >= 2) this.outputText("50");
            else this.outputText("100");
        ...
        //SPOIDAH
        if (this.player.findStatusAffect(StatusAffects.CampRathazul) >= 0 && this.player.hasItem(this.useables.T_SSILK) && this.flags[kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00275] == 0) {
            showArmorMenu = true;
            spoken = true;
            totalOffers++;
        ...
        //Vines
        if (this.player.hasKeyItem("Marae's Lethicite") >= 0 && this.player.keyItemv2("Marae's Lethicite") < 3 && this.player.findStatusAffect(StatusAffects.DefenseCanopy) < 0 && this.player.findStatusAffect(StatusAffects.CampRathazul) >= 0) {
        ...
        if (this.player.findStatusAffect(StatusAffects.CampRathazul) >= 0) {
            if (this.flags[kFLAGS.RATHAZUL_DEBIMBO_OFFERED] == 0 && (this.sophieBimbo.bimboSophie() || this.player.findPerk(PerkLib.BimboBrains) >= 0 || this.player.findPerk(PerkLib.FutaFaculties) >= 0)) {
                ...
                else if (!this.player.hasItem(this.consumables.SMART_T, 5)) this.outputText("  You should probably find some if you want that...");
                else this.outputText("  You need more gems to afford that, though.");
                this.outputText("\n\n");
            }
        }
        ...
        if (totalOffers > 0) {
            ...
            this.menu();
            if (showArmorMenu) this.addButton(this, 0, "Armor", this.rathazulArmorMenu);
            if (debimbo > 0) this.addButton(this, 1, "Debimbo", this.makeADeBimboDraft);
            this.addButton(this, 2, "Buy Dye", dyes);
            if (lethiciteDefense != undefined) this.addButton(this, 3, "Lethicite", lethiciteDefense);
            this.addButton(this, 4, "Purify", purify);
            if (reductos != undefined) this.addButton(this, 8, "Reducto", reductos);
            if (this.player.findStatusAffect(StatusAffects.CampRathazul) >= 0)
    ...
    private purifySomething(): void {
        ...
        //Item purification offer
        if (this.player.hasItem(this.consumables.INCUBID)) {
            this.addButton(this, 0, "Incubi Draft", this.rathazulPurifyIncubiDraft);
        }
        if (this.player.hasItem(this.consumables.SUCMILK)) {
            this.addButton(this, 1, "SuccubiMilk", this.rathazulPurifySuccubiMilk);
        }
        if (this.player.hasItem(this.consumables.SDELITE)) {
            this.addButton(this, 2, "S. Delight", this.rathazulPurifySuccubiDelight);
        }
        if (this.player.hasItem(this.consumables.LABOVA_)) {
            this.addButton(this, 3, "LaBova", this.rathazulPurifyLaBova);
        }
        this.addButton(this, 4, "Back", this.rathazulWorkOffer);
    }
    ...
    private rathazulPurifyIncubiDraft(): void {
        ...
        if (this.player.gems < 20) {
            ...
            this.doNext(this, this.returnToRathazulMenu);
            return;
        }
        if (!this.debug)
    ...
    private rathazulDebimboOffer(): void {
        ...
        if (this.flags[kFLAGS.RATHAZUL_DEBIMBO_OFFERED] == 0) {
            if (this.sophieBimbo.bimboSophie()) {
                ...
                this.outputText("\n\nYou await");
                if (this.silly()) this.outputText(" getGoodPost()"); // C# await joke ;_; http://msdn.microsoft.com/en-gb/library/hh156528.aspx
        ...
        //Rath menu
        this.menu();
        this.addButton(this, 0, "Next", this.campRathazul);
    }
    ...
    public rathazulArmorMenu(): void {
        ...
        this.simpleChoices(this, "BeeArmor", beeArmor, "GelArmor", gelArmor, "SpiderSilk", silk, "", undefined, "Back", this.returnToRathazulMenu);
    }
    ...
    private craftSilkArmor(): void {
        ...
        //[Yes] [No]
        this.doYesNo(this, this.commissionSilkArmorForReal, this.declineSilkArmorCommish);
    }
    private commissionSilkArmorForReal(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Armor", this.chooseArmorOrRobes, 1);
        this.addButton(this, 1, "Robes", this.chooseArmorOrRobes, 2);
    }
    ...
    private craftOozeArmor(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.RathazulArmor) < 0) this.player.createStatusAffect(StatusAffects.RathazulArmor, 0, 0, 0, 0);
    }
    ...
    private buyDyes(): void {
        ...
        this.statScreenRefresh();
        this.menu();
        this.addButton(this, 0, "Auburn", this.buyDye, this.consumables.AUBURND);
        this.addButton(this, 1, "Black", this.buyDye, this.consumables.BLACK_D);
        this.addButton(this, 2, "Blond", this.buyDye, this.consumables.BLOND_D);
        this.addButton(this, 3, "Brown", this.buyDye, this.consumables.BROWN_D);
        this.addButton(this, 4, "Red", this.buyDye, this.consumables.RED_DYE);
        this.addButton(this, 5, "White", this.buyDye, this.consumables.WHITEDY);
        this.addButton(this, 6, "Gray", this.buyDye, this.consumables.GRAYDYE);
        this.addButton(this, 9, "Nevermind", this.buyDyeNevermind);
    }
    ...
    private growLethiciteDefense(): void {
        ...
        this.doYesNo(this, this.growLethiciteDefenseYesYesYes, this.growLethiciteDefenseGuessNot);
    }
    ...
    public craftCarapace(): void {
        ...
        if (this.player.cockTotal() > 0 && this.player.biggestCockArea() >= 40) this.outputText("The silken material does little to hide the bulge of your groin, if anything it looks a little lewd.  Rathazul mumbles and looks away, shaking his head.\n\n", false);
        if (this.player.biggestTitSize() >= 8) this.outputText("Your " + this.biggestBreastSizeDescript() + " barely fit into the breastplate, leaving you displaying a large amount of jiggling cleavage.\n\n", false);
