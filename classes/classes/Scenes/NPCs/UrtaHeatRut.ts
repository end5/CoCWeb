...
export class UrtaHeatRut extends NPCAwareContent {
    ...
    public approachSoberUrtaHeatRutProc(): void {
        ...
        this.outputText("As you walk over to the table where your foxy herm-lover sits, you think you see eyes following you, your presence attracting an unusual amount of attention. ");
        if (this.player.inHeat && this.player.inRut && this.player.hasCock() && this.player.hasVagina()) this.outputText(" Males, females and herms alike stare at you with a mixture of puzzlement, longing and hostility, as if unsure whether they want to fight with you, fuck you senseless or be fucked senseless by you.");
        else if (this.player.inRut && this.player.hasCock()) this.outputText(" Males stare at you with a hint of challenge in their eyes, whilst females eye you attentively. Herms don't seem sure whether they want to fight you or fuck you.");
        //(Player in heat
        else if (this.player.inHeat && this.player.hasVagina()) this.outputText(" Males, and individuals who look like females at first, until you spot the telltale bulge of at least one cock in garments or hanging freely between their legs, stare at you with obvious desire as you go, more than a few erections starting to form in your wake.");
        this.outputText("  You ignore them all, concentrating on Urta.");

        this.outputText("\n\nAs you approach, ");

        if (this.urtaLove()) this.outputText(" she opens her arms to embrace you, and smiles.");
        else this.outputText(" she smiles when she sees you, but then gives the air a sniff and immediately seems to gain more color to the skin under her fur.  \"<i>Uh, I, I see.</i>\"  You sit down next to her, but even though she isn't even suggesting anything yet, you already find it hard to control yourself.");

        if (this.player.inRut && this.player.hasCock()) this.outputText("  Urta is right next to you, and she has already proven herself a good lay");
        else this.outputText("  You keep reminding yourself what Urta is packing between her legs and how much precious semen it can give, and can't help but want to try that now");

        this.outputText(".  Not to mention, with or without the monster between her legs, her body is sexy as hell.");

        this.outputText("\n\n\"<i>Well, you do help me with my own releases, so I suppose that's fair....");
        if (this.player.inHeat && this.player.hasVagina()) this.outputText("  You... smell good, so I at least hope you're not here to tease me.");
        this.outputText("</i>\"  She leans closer to you, and ");
        if (this.player.inRut && this.player.hasCock()) this.outputText("your eyes are quickly drawn to her full breasts as she whispers something to you. You're too hypnotized to care.");
        else this.outputText("you lose yourself in your imagination about having Urta take you raw and pump you full of sperm.  There's a faint voice you hear, and you realize it's Urta's as you snap back to reality.");
        this.outputText("  She coughs and repeats herself.  \"<i>Are you here because of your, um, condition? You'd prefer to blow off some steam with ");
        if (this.urtaLove()) this.outputText("your adorable, hot vixen");
        else this.outputText("someone you know and trust");
        ...
        if (this.player.inRut && this.player.hasCock()) this.outputText(" focus is on the hips of the fox-morph");
        else this.outputText(" focus on catching a glimpse of that amazing cock, and you keep imagining what she can do with it");
        this.outputText(".  Your aggressive hormonal state demands that you ");
        if (this.player.inRut && this.player.inHeat && this.player.hasCock() && this.player.hasVagina()) this.outputText(" put a baby in her, then let her put a baby in you");
        else if (this.player.inRut && this.player.hasCock()) this.outputText(" put a baby in her so she can push it out of those beautiful hips");
        else this.outputText(" put that beautiful big cock into your needy [vagina]");
        //[If Urta's fertility quest wasnât done]
        if (!this.urtaQuestDone()) this.outputText(", even if something keeps reminding you that's impossible.");
        else this.outputText(".");

        this.outputText("\n\n\"<i>You know, [name] I'm glad to see you as always.  ");
        if (this.urtaLove()) this.outputText("  I'm really thankful you managed to control yourself and see me with this.  You know that if you need me, I'm always ready to help, love.</i>\"");
        else this.outputText("  I'm really flattered you thought of me when in such a state!</i>\"");
        ...
        if (this.player.inRut && this.player.inHeat && this.player.hasCock() && this.player.hasVagina()) this.outputText("mixed genitals");
        else if (this.player.inRut && this.player.hasCock()) this.outputText("[cock biggest]");
        else this.outputText("[vagina]");
        this.outputText(" against her backside.");
        ...
        //Player in rut:
            ...
            if (this.player.hasVagina()) this.outputText("  Your " + this.multiCockDescriptLight() + " and [vagina] are filling your clothes with mixed juices");
            else this.outputText("  Your [cock biggest] begins to seep precum into your clothes");
            this.outputText(", so you decide to dispose of them as you force Urta against a wall.");
    ...
    public approachDrunkenUrta(): void {
        ...
        //Player in heat:
        else this.outputText("  Males, and individuals who look like females at first, until you spot the telltale bulge of at least one cock in garments or hanging freely between their legs, stare at you with obvious desire as you go, more than a few erections starting to form in your wake.");
        this.outputText("  You ignore them all, concentrating on Urta.");
    ...
    private interestedInUburDrunkurtaRuts(): void {
        ...
        if (this.player.inRut && this.player.inHeat && this.player.hasCock() && this.player.hasVagina()) {
            ...
            else this.outputText("through her quickly-soaked dress");
            this.outputText(".  \"<i>Fuuuck, but you smell so goood... Goddess, I don't know which part of you I want more!  Gimme some of that, sexy... please!</i>\" she begs you desperately.");
    ...
    private drunkUrtaIntroPartDuex(chosenSex: number = 1, newl: boolean = true): void {
        ...
        this.outputText("Suddenly, Urta's hand dashes to ");
        //[if players has balls]
        if (this.player.balls > 0 && chosenSex == 1) this.outputText("your [balls], rolling them in her hand and squeezing a bit too roughly.");
        else if (this.player.hasVagina()) {
            this.outputText("your [clit], rubbing it until it's ");
            if (chosenSex == 1) this.outputText("the very same state [eachCock] seems to be in so often recently, ");
            this.outputText("erect and throbbing.");
        }
        else this.outputText("your [hips], stroking along them towards [eachCock] in an agonizing display of teasing.");
        ...
        if (chosenSex == 1) this.outputText(", and [eachCock] already gets hard in your [armor].");
        ...
        if (chosenSex == 1) this.outputText("hard");
        else this.outputText("wet");
        this.outputText(" for me</i>\"  Moments later, as you feel your naked [butt] against the table, her eyes dart to your ");
        if (chosenSex == 1) this.outputText(this.multiCockDescriptLight());
        else this.outputText("[vagina]");
        this.outputText(".  Her smile opens wider as Urta presents you with a sexy face that seems a mix of positively delighted and predatory.");

        //[If player is in Rut, OR is in Heat AND Rut AND chose "Cock":
        if (chosenSex == 1) this.outputText("\n\n\"<i>Well, I'm sure you don't mind if I take all your spunk and those few hours of fucking all for myself, instead,</i>\" she says as she brings one leg onto the table and the side of you as she sheds her dress, lubricant now drooling from the fox's female half, falling onto your [hips].");
    ...
    private stopTeasingDatHornyFox(): void {
        this.clearOutput();
        this.urta.urtaSprite();
        this.outputText("You decide there's no point taking things too far - besides, Urta seems just about ready to pop now, especially with how she's frantically suckling at her own cockhead.");
    ...
    private keepTeasingDatHornyFawkes(): void {
        this.clearOutput();
        this.urta.urtaSprite();
        this.outputText("You smirk; things are just starting to get fun around here, why would you stop now?  You start to amp up your routine even more, flaunting your scents and your goods for all the bar's occupants, not just the drunken fox-herm feverishly jerking herself off in front of you.  You can't recall if you've ever danced before coming to Mareth, but you don't think you do too bad as you perform an amateur strip-dance for the audience around you, slowly peeling off your [armor] and sensuously discarding them, bending over to let Urta and any other cock-bearing character present in the bar get a good look at your [vagina], ");
        if (this.player.balls > 0) this.outputText("lewdly cupping and fondling your [balls], ");
        this.outputText("slowly beginning to stroke and caress your " + this.multiCockDescriptLight() + " for the benefit of those who bear vaginas.");
        ...
        if (this.player.isGoo() || this.player.isNaga()) this.outputText("what passes for knees on your [legs]");
        else this.outputText("knees.");
        ...
        if (this.player.cor < 50) this.outputText("run");
        else this.outputText("walk triumphantly");
        this.outputText(" from the racous orgy that is the Wet Bitch; truly an auspicious name.");
    ...
    private soberUrtaSatingPCHeat(): void {
        ...
        this.outputText("As she presses your back against the wall, you spread your [legs] wide, allowing Urta easy access to your awaiting womanhood");
        //[If herm]:
        if (this.player.hasCock()) {
            this.outputText(" by shoving your " + this.multiCockDescriptLight());
            if (this.player.hasCock() && this.player.balls > 0) this.outputText(" and [balls]");
            this.outputText(" out of the way");
        }
        else if (this.player.balls > 0) this.outputText(" by shoving your [balls] out of the way");
        this.outputText(".  Slowly, you feel the wide flared head of her magnificent pillar of flesh press onto your opening, spreading your vaginal lips and making your [clit] harden in anticipation just as your [butt] shivers, awaiting the intrusion.  Slowly, Urta's giant member starts to enter you.");
        if (this.player.vaginalCapacity() >= 100) this.outputText("  Your hungry gash eagerly welcomes her, Urta easily sliding herself home.");
        else if (this.player.vaginalCapacity() > 60) this.outputText("  You feel it stretch you in the most pleasuring of ways, filling you with warm, throbbing flesh as she pushes it deeper and deeper.");
        else this.outputText("  You wince in pain at being stretched so much, but you grow wetter and wetter as Urta slowly pushes herself inside your depths, your [vagina] slowly getting wetter and warmer, accepting the intruder.  Pleasure starts to override pain and you let out a gasp.");
        ...
        if (this.player.hasCock()) this.outputText("[cock biggest]");
            ...
            this.outputText("clitoris, ");
            if (this.player.clitLength < 2.5) this.outputText("rubbing the hard, stimulated sensitive spot between her fingers");
            else this.outputText("running her fingers over your entire big clit before stroking it like she'd do with a cock");
        }
        this.outputText(", letting you have a few moments to get used to her mammoth member and accommodate it.");
        ...
        if (this.player.hasCock()) this.outputText(" Cum rushes out of [eachCock] and onto the soft fur of Urta's abdomen, then starts leaking out slowly in time with her thrusts.");
        this.outputText(" Your cunt clamps down tighter onto Urta as you orgasm,");
        if (this.player.wetness() >= 4) this.outputText(" pussy juice shooting out around her member, coating Urta's fur and soaking her balls and the base of her cock.");
        else this.outputText(" love juices flowing liberally out of you, giving the skin of Urta's cock a visible shine and spreading onto her balls.");
        ...
        if (this.player.wetness() >= 4) this.outputText("shooting out all over the place");
        else this.outputText("running down her member and the crack of your [butt], coating the two of you in the proof of your passion");
        this.outputText(".");
        ...
        if (this.player.hasCock()) this.outputText("your own member responding alike to Urta's, shooting out semen, ");
        this.outputText("your [vagina] ");
        if (this.player.wetness() >= 4) this.outputText("once again setting off to coat Urta in your juices.");
        else this.outputText("squeezing on her, trying to milk her of her seed.");
        ...
        this.outputText("\n\n\"<i>What?  ");
        if (!this.urtaLove()) this.outputText("You're still not satisfied?</i>\"");
        else this.outputText("You want to keep going, darling?  I want to make you satisfied, so I'll spare all the time I can!</i>\"");
        ...
        this.outputText("hardening again in response to the act.  Urta continues to slam into your backside, delivering a small smack to your [butt].");
        ...
        //[Hermaphrodite]
        if (this.player.hasCock()) this.outputText("[eachCock] shoots its seed onto the floor of the alley, helplessly");
        else this.outputText("your [vagina] squeezes and tugs on her shooting member, leaking its own juices all over her member, the intensity of the orgasm shaking you right into your core");
        this.outputText(".");
        ...
        this.outputText("\n\n\"<i>That felt amazing!  ");
        if (!this.urtaLove()) this.outputText("If only I had you by hand every time I need to blow a load.");
        else this.outputText("Your pussy is absolutely amazing, sweetheart: I hope I've helped you settle down?  Is your heat sated for the moment?");
        this.outputText("</i>\"");
        ...
        this.outputText("\n\n\"<i>");
        //([Regular Urta]
        if (!this.urtaLove()) this.outputText("Sure thing, I'm here to help,</i>\" she responds with a wink.");
        else this.outputText("I'm here if you need me, love.  Whatever makes you happy.  You've helped me with my own problems so much already, so I owe you at least one.  Not to mention, making love to you feels absolutely amazing!</i>\"");
        ...
        if (!this.urtaQuestDone()) {
            ...
            this.outputText("  She grabs your hand and helps you stand up.");
        }
    ...
    private sateRutWithSoberUrtaButHuegDicked(): void {
        ...
        this.outputText("Urta observes your approaching " + this.cockDescript(x) + " with a hungry, eager expression. Without taking her eyes off of it, she flips up her ");
        if (!this.urtaLove()) this.outputText("skirt");
        else this.outputText("dress");
        this.outputText(", her huge horse-cock whipping up to slap between her breasts, pre already dribbling down the tip.  However, as you get closer, her expression suddenly falls and her cock begins to sink.  \"<i>I'm sorry, but... that's just too big!</i>\" she protests.  \"<i>You smell absolutely gorgeous, and I'm willing to try with something a little bigger than usual, but that's... that's just frigging huge - there's no way I could fit that monster!</i>\" she declares. \"<i>Just because I have a stallion cock doesn't mean I have a mare's cunt!</i>\"");

        this.outputText("\n\nYou stare at your " + this.cockDescript(x) + " in an uncomprehending fashion.  How are you going to find relief now?  You look up as Urta saunters over towards you in a seductive manner, erect cock jutting before her and a mischievous grin on her face.  \"<i>While I'll have to go and attend to this myself later, I can still give you a hand...</i>\" she purrs throatily.  She kneels before you, and you have to watch yourself to avoid having her twenty inches of cock slap your [leg].  Confidently, she reaches out to take hold of your " + this.cockDescript(x) + ", first with one hand, and then the other.");
        ...
        if (!this.urtaLove()) {
            ...
            if (this.player.cumQ() <= 50) this.outputText("spattering spooge onto Urta's face");
            else if (this.player.cumQ() <= 250) this.outputText("splashing her face and tits with your cum");
            else this.outputText("soaking the shocked fox-morph in your jism");
            this.outputText("; though you still feel the urge to breed fertile females, your lust is momentarily sated.  Urta wipes ");
            if (this.player.cumQ() >= 500) this.outputText("halfheartedly ");
            this.outputText("at the cum on her faces and gives you a friendly smile.  \"<i<There, that should feel better; I know what it's like to be all pent up with no release.</i>\"  She rises to her feet, still holding your cock, and gives it a squeeze.  \"<i>In the meantime, if you want to really cut loose, I suggest you go and find something to shrink this down.</i>\"");
        ...
        //Lover Urta Path/
            ...
            this.outputText("\n\nShe pulls her head free and gasps for breath, looking at you in admiration. \"<i>By Marae... how do you manage to do this for me, lover?</i>\" she asks, stunned.  But then, gamely, she returns her attention to your " + this.cockDescript(x) + ", licking, suckling and mouthing at the head.  As she does this, she continues her restless assault with her hands upon the rest of your lengthy shaft with her skilled hands.  She shuffles closer, allowing you to rest yourself between her DD-cups.  \"<i>Can you feel how fast my heart is beating through your cock?  You turn me on so very much,</i>\" she purrs.");

            this.outputText("\n\nIt's no surprise that eventually you can't hold back anymore and release yourself into Urta's ready mouth.  ");
            if (this.player.cumQ() <= 50) this.outputText("She swallows it all without complaint, licking her lips clean of any stray droplets once you remove it from her mouth.");
            else if (this.player.cumQ() <= 250) this.outputText("Her cheeks bulge at the amount you pump into her, but she's able to swallow with an admirable amount of control, gasping for breath.");
            else this.outputText("Rivulets of cum burst from between her lips, but she stubbornly sucks and swallows as much as she can, her stomach starting to bulge from the sudden influx of spooge.  When you stop, she is drooling cum and gasping for breath, but she meets your eyes with pride, even as she gives a wet belch.");
    ...
    private sateRutWithSoberUrta(): void {
        ...
        this.clearOutput();
        this.urta.urtaSprite();
        this.outputText("Urta observes your approaching package with a hungry, eager expression. Without taking her eyes off of it, she flips up her skirt, her huge horse-cock whipping up to slap between her breasts, pre already dribbling down the tip.");
        ...
        this.outputText("\n\nWell, you don't intend to keep the lady waiting any longer then you have to, and you slide it home, allowing her testicles to drop once you are safely inside.  The globular organs bounce atop your " + this.cockDescript(x) + " and rock back and forth against your belly, jiggling with every movement the two of you make, Urta's cock sandwiched firmly between your bodies and held between her breasts.");

        this.outputText("\n\nUrta finally breaks the kiss and leers at you.  \"<i>Kinky " + this.player.mf("boy", "girl") + "...</i>\" she teases you, \"<i>but I like that.</i>\"  She promptly starts to rock back and forth, seeking to simultaneously impale herself repeatedly upon your shaft and to grind her own huge cock between your bodies.");
        if (this.urtaLove()) this.outputText("  \"<i>You're the only one who has ever accepted every part of me,</i>\" she tells you, one hand brushing affectionately against your cheek.");

        this.outputText("\n\nYou simply moan back, your lust-addled mind only able to concentrate on the fact you are surrounded by her womanhood. You thrust back and forth, your " + this.cockDescript(x) + " surging deep inside her and then wetly pulling out, only to slide back home.  You nip and kiss her prominent nipples, making the vixen churr in delight, and she kisses you back.  Her front is plastered with pre now, her cockhead bubbling fluids like a fountain, and you can't resist bending down and playing with her cockhead.  She yips and growls with pleasure as you molest her hermhood, your tongue playing around the tip, lapping the sweet pre as it flows forth.  She surprises you by craning down her neck and starting to lap at it herself, her long, broad tongue curling expertly around its wide-flared tip.  The two of you make a game out of it, seeing who can better lick and lap, occasionally running your tongues over each other's whilst doing so.");
        ...
        if (this.urtaLove()) this.outputText("blows you a kiss with a flirty wink of her eye and then ");
        this.outputText("scrubs off the worst of the cum plastered in her fur with the dry parts of her clothes.  She saunters playfully over to a garbage bin, throwing them inside.");
        if (this.urtaLove()) this.outputText("  Her hips deliberately sway in a mesmerizing fashion, tail flicking from side to side to give you a tantalizing grip of her still-dripping snatch and the now-flaccid prick underneath.");
        this.outputText("  You watch as she pries at a loose stone with her claws, removing it to reveal a small cubby, from which she withdraws a spare set of clothing.");
        ...
        if (this.urtaQuestDone()) {
            ...
            if (!this.urtaLove()) this.outputText("\"<i>And you had better learn to control yourself, " + this.player.mf("mister", "missy") + ".");
            else this.outputText("\"<i>But you should learn to control yourself lover-" + this.player.mf("boy", "girl") + ".");
            this.outputText("  I'd rather do something like this in the privacy of my home than in the middle of the street.</i>\"");
    ...
    private drunkenUrtaFucksPCInHeat(): void {
        this.clearOutput();
        this.urta.urtaSprite();
        this.outputText("You simply smile at her, inhaling deeply through your nose; you can swear you can smell her herm-musk, wafting off of her as strongly as your own pheromones must be wafting off of you.  That wonderful, earthy, primordial scent, the odor of a healthy breeder ready and willing to mate... there's nothing like it.");
        //(Fertility Quest not done:
        if (!this.urtaQuestDone()) this.outputText("  You know that she can't give you babies... but, honestly, at this moment, you couldn't care less. Her wonderful stallion cock is there and ready and it's all for you.");
        else this.outputText("  You dimly recall that Urta could be virile, but she's right there, her huge mare-cock just dripping to plunge into your ripe [vagina] and knock you up.  You don't care anymore; you want her babies!");

        this.outputText("\n\nUrta's eyes glitter with emotion and she bends down to give you another kiss before roughly grabbing her ");
        if (!this.urtaLove()) this.outputText("skirt");
        else this.outputText("dress");
        this.outputText(" and hiking it up to expose her pre-spewing cock.  A steady trickle of feminine lubricant dribbles out of her gash, oozing over her apple-sized balls and dripping noisily onto the floor, but Urta couldn't care less; she's too fixated on plunging her maleness into your ready pussy to notice her feminine urges.");
        ...
        if (this.player.hasCock()) {
            this.outputText(", impatiently nudging aside your " + this.multiCockDescriptLight());
            if (this.player.balls > 0) this.outputText(" and your [balls]");
            this.outputText(" to get to the feminine orifice below");
        }
        this.outputText(". You cry out in joy as your [vagina] is filled, her soft fur brushing against your inner walls before she opens her mouth as wide as she can and sticks out her tongue. The long, broad, vulpine appendage slides out and up your depths, caressing the walls, lapping up your juices, ");
        if (this.player.clitLength < 2.5) this.outputText("playing with your [clit]");
        else this.outputText("lapping around your huge pleasure-button, slurping it into her mouth where she suckles from it");
        this.outputText(", and making you thrash and scream until you think you're going to cum from the pussy-eating alone.  ");
        if (this.player.wetness() >= 4) this.outputText("As if to emphasize this, your squelching, slurping pussy suddenly sprays fem-cum all over Urta's face, making her pull herself free with a shocked shake of her head.");
        else this.outputText("As if sensing your impending orgasm, Urta removes her head from your [vagina], giving you a cocky grin and shaking her head.");
        ...
        if (this.player.hasCock()) this.outputText("nor even your " + this.multiCockDescriptLight());
        this.outputText(", despite usually trying to make it just as good for you.  She begins to thrust into you with even greater force than before.  You groan and whimper under her; partly from the pleasures of being taken so roughly, so triumphantly, and partly to goad her on, to make her feel even more aroused and alpha-male-like.");
    ...
    private sateRutWithDrunkUrtaWithHugeDick(): void {
        ...
        if (this.player.biggestCockArea() < 150) this.outputText("compete with minotaurs or something?");
        else this.outputText("set a world record or something?");
        this.outputText("</i>\"\n\n");
    ...
    private drunkUrtaRidesARutPCsCock(): void {
        ...
        var x: number = this.player.biggestCockIndex();
        this.urta.urtaSprite();
        this.outputText("You decide not to fight the situation; truthfully, the promises given by the sight of the hot hermaphrodite vixen climbing on top of you ignite your lusts and sing to your rut in ways you don't think you'd be able to safely ignore.");

        this.outputText("\n\nUrta lifts her balls and presses your already hard cock against her black pussy lips, justifying your decision.  Slowly, you feel your tip sink into her, then the rest of your member, as she releases a soft moan.  She keeps pressing down, forcing your " + this.cockDescript(x) + " inside her wet gash until you feel her butt pressed against your ");
        if (this.player.balls > 0) this.outputText("[balls]");
        else this.outputText("[hips]");
        this.outputText(", and her own balls resting comfortably on your abdomen.  She grits her teeth as you feel her pussy slowly tighten around and massage your " + this.cockDescript(x) + ", and you groan in response.  Urta starts to bounce up and down on your member, smacking her thighs and ass into your body, not minding her own giant equine member flopping around and occasionally smacking you over your chest.  She lets her tongue flick out into the air for a moment and moans in delight, before picking up the pace and starting to pump your cock in and out of her hungry passage furiously.");
        ...
        if (this.player.balls > 0) this.outputText("feel your balls churning");
        else this.outputText("recognize the tingling sensation from your " + this.cockDescript(x) + " to your spine");
        this.outputText(", a telltale sign that your penis is ready to unload the potent spunk inside the herm-nympho bouncing on top of you.  You try to announce this, but she doesn't slow down.  Moments later, ");
        //[Normal cum production]
        if (this.player.cumQ() <= 50) this.outputText("you unload your thick spunk into her pussy");
        else if (this.player.cumQ() <= 250) this.outputText("you erupt inside her, filling her with wave after wave of warm, thick semen");
        else this.outputText("you blow massive surges of spunk inside her continuously.  The fox's stomach expands, rivulets of semen running down onto the table as she continues her ride on top of you");
        this.outputText(".  As you discharge, the fox's pussy starts squeezing and contracting, and you recognize the hermaphrodite's own orgasm.  Thicker white liquid suddenly drips from the tip of her cock quite copiously and occasionally shoots out into the air.");
        ...
        if (this.player.hasKnot(x)) this.outputText("You slowly feel the blood flow to your erect penis, and the knot at the base of it seems to start to expand");
        else this.outputText("You don't mind staying like this for much, much longer, and the hermaphrodite on top of you seems to share that point of view");
        this.outputText(".  Summoning your slightly exhausted strength, you pull her hips down deeper into your own before starting to return the hermaphrodite's shakes and bounces with thrusts of your own.  It intensifies the sensations, making your lover yelp in surprise before smiling widely and releasing low, content moans and purrs from the depths of her throat.");
        ...
        if (this.player.hasKnot(x)) this.outputText("knot surge with more blood and your erection twitch, ensuring that you're completely trapped inside her until you're empty.");
        else this.outputText("tip expand as you're getting ready to blow another load.");
        this.outputText("  Urta moans on top of you, increasing the speed of her movements and running her hand up and down her own member faster and with more intense strokes.");
        ...
        this.outputText(" Urta masturbates furiously as your body and your " + this.cockDescript(x) + " finally gives in to your rut and the vixen's intense lust.  The two of you come in complete sync this time, her wet, black pussy milking you with vice-like tightness and intense, rhythmic squeezing as she fires a huge rope of jizz onto the floor next to your table before painting your chest and abdomen with lesser white strings.");

        //[If large cum production]
        if (this.player.cumQ() >= 500 && this.player.cumQ() <= 1500) this.outputText("\n\nUrta seems positively full and stretched now, and your rut almost subsides for a moment, her stretched tummy imitating a pregnancy quite well.");
        else if (this.player.cumQ() > 1500) {
            this.outputText("\n\nUrta is stretched and completely full, so, holding your " + this.cockDescript(x) + " in her hand for a moment, she lifts herself off your cock, presses on her abdomen and allows some of your spunk to drip out of her, coating the table, your thighs and your ");
            if (this.player.balls > 0) this.outputText("[balls]");
            else if (this.player.hasVagina() && this.player.clitLength >= 3.5) this.outputText("cock-like clit");
            else if (this.player.hasVagina()) this.outputText("pussy lips");
            else this.outputText("inside of your thighs");
            this.outputText(" with your own thick white semen.  Then, she slides your softening erection back into herself again.");
        }

        this.outputText("\n\n\"<i>Good... so good!  Just a few more rounds, and we'll be done - don't go fucking soft on me!</i>\"");

        this.outputText("\n\nYour " + this.cockDescript(x) + " feels sensitive and tender after the two past orgasms, but the horny nympho just forces it deep into her snatch, the sensitive head and shaft all the way down to your base again squeezed tighter as she starts to bounce up and down, trying to breathe life into your erection.  She kisses you furiously and passionately, exploring your mouth with her tongue as she keeps the stimulation on your groin, cooing, groaning and panting as if trying to breathe her own lust into you.");

        this.outputText("\n\n\"<i>Come on, come on, whatever it takes!  Squeeze those boobies, smack that ass, just get fucking hard!</i>\"");

        this.outputText("\n\nFollowing her plea, you give her breasts a rather rough squeeze, and you feel your " + this.cockDescript(x) + " miraculously harden inside her once again.");
        if (this.player.balls > 0) this.outputText("  Your [balls] don't seem to be completely empty yet");
        else this.outputText("  It doesn't appear to be the end of what your body can produce");
        this.outputText(", and your vulpine lover squeals with delight as she feels you harden inside her.  She smacks your [chest] with her huge, half-hard member.");

        this.outputText("\n\n\"<i>Care to give me a hand with that?  There's quite a lot of cream to squeeze out of this one, too.</i>\"");

        this.outputText("\n\nYour tired and lust-hazed mind sees no reason not to, and you grab her, so Urta's massive mare member starts to be pleasured by her own hand as well as yours.  Squealing in delight, the horny vixen returns to what seems to occupy her mind completely: bouncing fervently on top of you, with your " + this.cockDescript(x) + " trapped in her wet snatch.");
        ...
        if (!this.player.hasVagina() && this.player.balls == 0) this.outputText(" the inside of your thighs");
        else if (this.player.balls > 0) this.outputText(" your [balls]");
        else if (this.player.hasVagina()) this.outputText(" your [clit]");
        this.outputText(" when she's pressed entirely against you.  She smacks her own bottom and you run your other hand over her body as the two of you tug on and pull her massive erection towards your face and over your [chest], thick dollops of pre-cum and leftover semen dripping from her member over your body.  Urta licks her lips as she looks down on you with ");
        if (!this.urtaLove()) this.outputText("intense, unadultered lust");
        else this.outputText("possessiveness and a hungry, but somehow warm expression");
        this.outputText(".");

        this.outputText("\n\nI should make you do this every day!</i>\"");
        if (this.urtaLove()) this.outputText("  She suddenly seems a bit shy and surprised, before saying, \"<i>Make sure to remind me I said that later....</i>\"");
        ...
        if (!this.urtaLove()) this.outputText("Show me you're " + this.player.mf("the man", "the breeder") + " here!");
        else this.outputText("You don't want to make me feel like I'm abusing you, do you?  I know you want this, so pound me!</i>\"");


        this.outputText("\n\nAfter a while, it becomes a torture to resist the stimulation and you try to bring your own orgasm faster by responding to Urta's movement, stretching your [hips] and pushing your " + this.cockDescript(x) + " deeper into her pussy.  Although the two of you have trouble catching a common rhythm, she appears way more vitalized and enthusiastic about this than you are.");

        this.outputText("\n\nAfter a long time of slightly too rough of a ride, your " + this.cockDescript(x) + " twitches inside the horny vixen again, and she almost howls in her own climax before yours is set off. Another shot of cum coats your [chest] as her hungry love-hole milks your member, forcing you to ejaculate for the third time, delivering even more semen into her insides.");
        if (this.player.cumQ() >= 500) this.outputText("  If the two of you were thinking rationally, you'd know quite well it could be quite dangerous to her innards to continue, but Urta seems intent on continuing this ordeal, or at least, that's how you feel when looking at her expression of bliss and ecstasy, eyes rolling to the back of her head and tongue dancing around in the air.");

        this.outputText("\n\nYou try to announce that you're done and that's about it, but the horny nymphomaniac that seems intent on keeping your rutting " + this.cockDescript(x) + " all to herself feels differently.  She allows your member to slide out of her for a moment, but only to let out some of the spunk that's filling her and to stimulate you in a different way.  Urta moves down your body, stroking your [chest] and your [nipples] before lowering her face and arms to your [hips].  She licks your sensitive head for a while before delivering a couple of noisy, strong sucks to your " + this.cockDescript(x) + ".  Afterwards, she licks your ");
        if (this.player.balls > 0) this.outputText("[balls]");
        else if (this.player.hasVagina()) this.outputText("[vagina] and [clit]");
        else this.outputText("taint");
        this.outputText(" before finally running her tongue over your [asshole], and all the way up again, swallowing your member once again as she squeezes your [butt].  You alternate before moaning, groaning, and whimpering as blood seems to leave your head and entire body, surging into your " + this.cockDescript(x) + " and making it hard to think or move, much less resist.");
        ...
        if (this.urtaLove()) this.outputText("  You can rest later!  I'll even give you a massage, so keep giving it to me!");
        this.outputText("</i>\"");
        ...
        if (this.player.cumQ() <= 200) this.outputText("  The table already seems like it'll be stained white by Urta's efforts alone, and your own fluid doesn't help the situation.");
        else if (this.player.cumQ() < 1000) this.outputText("  The two of you are already fucking in a small pool of your mixed semen sauce, making naughty sounds heard all over the bar, and her vagina, dripping with your fluids, only makes the pool seem bigger.");
        else if (this.player.cumQ() >= 2000) this.outputText("  Your mixed sperm is covering the table and the floor, and woe to anyone who will have to clean this place up.  Despite the ridiculous amount of fluids around, she seems set on the idea that the two of you are barely mid-way through the act.");
        ...
        if (this.player.cumQ() >= 1000) this.outputText("  Well, maybe you can, but let's make some twins!");
        this.outputText("  Keep going!</i>\"");
        ...
        if (this.player.tallness <= 93) this.outputText("making you lick, kiss and suck on her flared, wide tip");
        else this.outputText("staring deep into your eyes as her erection smacks you against your [chest]");
        this.outputText(".");
        if (!this.urtaLove()) this.outputText("  She grins at your lack of resistance.");
        else this.outputText("  \"<i>You're mine, right?  Right now, you're mine and mine alone.  My wonderful virile breeder, all " + this.player.mf("his", "her") + " seed just for me.</i>\"");
        ...
        if (this.player.balls > 0) this.outputText(", your [balls] frantically gathering any cum that is left in them to prepare for another surge of shots into the hermaphrodite's eager nethers");
        this.outputText(".  You seem to slowly lose the sensations in most of your body.  The awareness of your surroundings slips away, as all your thoughts and feelings focus in your groin, struggling to keep up with the mad pace of breeding that Urta has kept so far.  It's hard to keep conscious as you feel another surge of ecstasy pass all over your body and focus on your " + this.cockDescript(x) + ", shooting off yet again inside her coaxing hole.  You hear the sound of your name being called and the milking, squeezing sensations that you barely manage to associate with her ravenous, insatiable pussy.");
        ...
        if (this.player.cor > 35 || this.flags[kFLAGS.PC_FETISH] > 0) this.outputText("You tell her it was actually a great experience to have such passionate sex publicly.  She blushes at that suggestion.");

        //[If Urta is infertile]
        if (!this.urtaQuestDone()) {
            this.outputText("\n\n\"<i>Well, I guess it was nice, if painful afterwards, to be of use to someone who was so ready and willing to breed.");
            if (this.urtaLove()) this.outputText("  If only I could... uh, I guess I should just enjoy what I can.");
            this.outputText("</i>\"");
        }
        //[If Urta is fertile]
        else {
        ...
        this.outputText("\n\nShe ");
        if (!this.urtaLove()) this.outputText("winks at you as you get ready to leave.  I hope I'll get to play with you again soon.</i>\"");
        else {
            this.outputText("gives you a quick but loving kiss before getting up and starting to prepare to leave the house.  As you get ready to move, she mumbles something, and reaches, grabbing your arm, shyly.\n\n\"<i>[name], next time, umm: find me when I'm sober.  I'll get to see how it feels to be wanted by someone the way I usually crave you, okay?</i>\"");

            this.outputText("\n\nYou " + this.player.mf("chuckle", "giggle") + " and she punches your shoulder playfully, but keeps her face from blushing more.  She seems pleased that she brought herself to that declaration.");
        }
        //[Both end here]
        this.outputText("\n\nSatisfied even if your body hurts all over and your " + this.cockDescript(x) + " seems empty, dry, burning, and almost ruptured.  You leave the house with a small smile on your face, and a strong stench of sexual fluids following you back to the camp.");
