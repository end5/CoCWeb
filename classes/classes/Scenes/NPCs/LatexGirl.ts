    ...
    */
    public gooFluid(arg: number = 0, output: boolean = true): number {
        if (arg != 0) {
            ...
            if (this.flags[kFLAGS.GOO_FLUID_AMOUNT] > 100) this.flags[kFLAGS.GOO_FLUID_AMOUNT] = 100;
        }
    ...
    private gooTitSize(): number {
        //If tits are lowered
        if (this.flags[kFLAGS.GOO_FLUID_AMOUNT] / 2 >= this.flags[kFLAGS.GOO_PREFERRED_TIT_SIZE] && this.flags[kFLAGS.GOO_PREFERRED_TIT_SIZE] > 0)
            return this.flags[kFLAGS.GOO_PREFERRED_TIT_SIZE];
        else
            return this.flags[kFLAGS.GOO_FLUID_AMOUNT] / 2;
    }
    ...
    public meanGooGirlRecruitment(): void {
        ...
        if (this.player.spe > 60) this.outputText("idly spin it on your finger, tossing it into the air and catching it on the next as you advance");
        else this.outputText("firmly grasp it in your hand as you approach");
    ...
    private PCCarriedGooBackHome(): void {
        ...
        if (this.camp.companionsCount() > 0) this.outputText(", away from prying eyes");
        ...
        if (this.player.totalCocks() > 1) this.outputText("  You can't help but wonder what it would feel like to let her sheath your " + this.multiCockDescriptLight() + " with her juices.");
        ...
        this.outputText("\n\nLooking up at you, her panicked " + this.flags[kFLAGS.GOO_EYES] + " eyes seem as wide as dinner plates.  \"<i>Why did you do this to me?</i>\"");
        ...
        if (this.player.cor < 33) this.outputText("that you'll be a nice [master].  She'll never be in want for the fluids she needs, and so long as she obeys you, you'll see to her other needs.");
        else if (this.player.cor < 66) this.outputText("that you'll be a good [master] for her.  You'll keep her healthy and satisfied, so long as she's obedient.");
        else this.outputText("that so long as she obeys you, she has nothing to fear.  She had better obey.");
    ...
    private nameZeLatexGoo(input: HTMLInputElement): void {
        ...
        else if (this.flags[kFLAGS.GOO_NAME] == "Helia") this.outputText("Helia, huh?  I don't know if I like anal enough for that!");
        else if (this.flags[kFLAGS.GOO_NAME] == "Urta") this.outputText("Urta, huh?  What do you take me for, a furry?  I guess it will have to do,");
        else if (this.flags[kFLAGS.GOO_NAME] == "Tifa") this.outputText("Tifa, huh?  I like the sound of that one!");
        else if (this.flags[kFLAGS.GOO_NAME] == "Aeris") this.outputText("Aeris, huh?  That sounds like a name for a hoity-toity pain in the ass!");
        else if (this.flags[kFLAGS.GOO_NAME] == "Latexy") this.outputText("Latexy, huh? That's, uh... real original...");
        else if (this.flags[kFLAGS.GOO_NAME] == "Goo") this.outputText("Goo, huh?  Wow, not too bright, are you?  Still, I guess I can live with it.  Call me Goo, I guess,");
        else if (this.flags[kFLAGS.GOO_NAME] == "Blacky") this.outputText("Blacky, huh?  Do I look like a horse or something?  I guess it will have to do,");
        else if (this.flags[kFLAGS.GOO_NAME] == "Fetish") this.outputText("Fetish, huh?  You're pretty transparent about your motives, aren't you?");
        else if (this.flags[kFLAGS.GOO_NAME] == "Fenoxo") this.outputText("Fenoxo?</i>\"  Her hair slowly morphs into a fedora.  \"<i>I'm not sure this is quite my look, but it's a lovely name,");
        else if (this.flags[kFLAGS.GOO_NAME] == "Maria") this.outputText("Maria?  Fuck, this isn't Cursed!  You don't expect me to turn you into a woman, do you?");
        else if (this.flags[kFLAGS.GOO_NAME] == "Valeria") this.outputText("Valeria? Wait, I've heard that name before...");
        else if (this.flags[kFLAGS.GOO_NAME] == "Christmas") this.outputText("Christmas, huh?  How very festive.  The big difference is that I can come more than once a year.");
        else if (this.flags[kFLAGS.GOO_NAME] == "Symphonie") this.outputText("Symphonie, eh?  That seems very... fitting.  Snug and comfortable, somehow,");
        else if (this.flags[kFLAGS.GOO_NAME] == "Savin") this.outputText("Savin, huh? Why would you want to name me after the second worst person since Stalin?");
        else if (this.flags[kFLAGS.GOO_NAME] == "Galatea") this.outputText("Galatea?  By Oblimo, that's a beautiful name!");
        else if (this.flags[kFLAGS.GOO_NAME] == "Kara") this.outputText("Kara, huh? Like, that sounds like a name for a girl with big gropable boobs in a French maid outfit!  I, like, totally love it!");
        else if (this.flags[kFLAGS.GOO_NAME] == "Karazelle") this.outputText("Karazelle, huh? Like, that sounds like a name for a girl with big gropable boobs in a French maid outfit!  I, like, totally love it!");
        else if (this.flags[kFLAGS.GOO_NAME] == "Jacques") this.outputText("Jacques?  That's kind of a boy's name isn't it?  ...Did my boobs just get bigger?");
        else if (this.flags[kFLAGS.GOO_NAME] == "Whitney") this.outputText("Whitney?  The farm-girl?  Well, I suppose I can fill in for that frigid cunt.");
        else if (this.flags[kFLAGS.GOO_NAME] == "Hedrah") this.outputText("Hedrah?  A nice strong name.  I approve,");
        else if (this.flags[kFLAGS.GOO_NAME] == "Third") this.outputText("Third, huh?  Do I speak with a silly accent and miss headshots all day long?  Well, I suppose it will work,");
        else if (this.flags[kFLAGS.GOO_NAME] == "Luckster") this.outputText("Luckster, huh?  Strange, I don't feel that Lucky.  Are there any cow-girls about?");
        else this.outputText(this.flags[kFLAGS.GOO_NAME] + ", huh?  I can live with that, I suppose,");
        ...
        if (this.player.cor < 50) this.outputText("Patiently");
        else this.outputText("Impatiently");
        ...
        this.outputText("\n\n\"<i>I don't need that much liquid... not any more,</i>\" " + this.flags[kFLAGS.GOO_NAME] + " says.  \"<i>I can already tell that I'm not losing it like I used to... but I still hunger for... well, juices.  I can probably live on water, but I won't be healthy that way.  I need you to feed me");
        if (this.player.gender == 0) this.outputText(", so please grow some genitals");
    ...
    public encounterLeftBehindGooSlave(): void {
        ...
        if (this.flags[kFLAGS.GOO_TFED_NICE] > 0) {
            ...
            this.outputText("\n\n\"<i>It's... you...</i>\" she moans, looking up at you with wide " + this.flags[kFLAGS.GOO_EYES] + " eyes before they close...  It seems she's fainted.  She looks almost alien in a way... more than she did before, when she was just an aqueous blob with tits and faux hair.  Now, every facet of her being is shiny, reflective latex.  Even her vaginal secretions, which dribble freely, are liquid latex, glossy black juices that slowly harden into a flexible solid once freed from her body.");
            if (this.player.cockTotal() > 1) this.outputText("  You can't help but wonder what it would feel like to let her sheath your " + this.multiCockDescriptLight() + " with her juices.");
            ...
            this.outputText("\n\n");
            if (this.player.cor < 33) this.outputText("Sighing apologetically");
            else if (this.player.cor < 66) this.outputText("Frowning");
            else this.outputText("Smirking");
            this.outputText(", you nod and admit, \"<i>Me.</i>\"  She rises, taking one shuddering step toward you, arms upraised threateningly.  You brace for a fight, but she stops, tumbling down to one knee.  Oily black tears drip from the corners of her " + this.flags[kFLAGS.GOO_EYES] + " eyes, raining unapologetically on the ground as she wails, \"<i>I can't hear them!</i>\"  The black drops splatter on the sand and grass, immediately hardening into a glossy, solid web.  You marvel at that as she continues, \"<i>I'm not a goo any more... my sisters... I'm deaf to them...</i>\"");
    ...
    private pureGooGalRecruitAftermath(): void {
        ...
        this.outputText("\n\nLooking up at you, her panicked " + this.flags[kFLAGS.GOO_EYES] + " eyes seem as wide as dinner plates.  \"<i>W-what happened? I don't... how did... oh, no,</i>\" she whines, covering her face with her hands as sorrowful tears shudder through her new body.");
    ...
    private niceGuysKeepTheirGooGals(): void {
        this.clearOutput();
        this.outputText("You take her by the chin, tilting her head up to look at you.  Of course you'll help her.  How could you not?  Overjoyed by your answer, " + this.flags[kFLAGS.GOO_NAME] + " throws her slender arms around you, pulling herself up so that her slick black lips press against yours.  \"<i>Oh, thank you! Thank you!</i>\" she cries, kissing you again.  Suddenly realizing what she's done, though, the latex-girl releases you and slips back against her rock, looking abashedly away.  \"<i>I'm sorry, I just...  Thank you.  I'm not going to just be a burden on you, I promise!  I don't know how much I can do, but so long as I'm here...  Just ask, for anything, and I promise I'll do my best.  It's the least I can do to pay you back for being so kind to me.</i>\"");
        this.outputText("\n\nYou smile, telling that seeing her safe and sound will be payment enough.  Speaking of which, what exactly is she going to need -- what can you do to help her now?  \"<i>All I used to need to survive was liquid, but... not that much.  Not any more,</i>\" " + this.flags[kFLAGS.GOO_NAME] + " says.  \"<i>I can already tell that I'm not losing it like I used to... but I still hunger for... well, juices.  I can probably live on water, but I won't be healthy that way.  I'll need you to, well, uh... feed me");
        if (this.player.gender == 0) this.outputText(", so you had better grow some genitals");
    ...
    public approachLatexy(): void {
        ...
        //Cuntnips:
        else if (this.flags[kFLAGS.GOO_NIPPLE_TYPE] == -1) this.outputText("  Those proud nipples have a visible slit down the middle, just waiting to be spread into hungry pussies.");
        //Third Line - Fluid content
        //{Above 75}
        if (this.gooFluid() >= 75) this.outputText("  Her onyx lips are plush and inviting, full of liquid.  Likewise, her body seems flush and full of life, certainly not suffering for fluid nutrients.");
        //{Above 50}
        ...
        this.outputText("\n\n");
        //{Dick}
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] > 0) this.outputText("Below her waist, a " + LatexGirl.num2Text(Math.round(this.flags[kFLAGS.GOO_DICK_LENGTH] * 10) / 10) + "-inch, " + this.gooCock() + " hangs, soft and shiny.  ");
        ...
        this.outputText("\n\n");
        //{sub 10}
        if (this.gooObedience() < 10) this.outputText(this.flags[kFLAGS.GOO_NAME] + " gives you a look of pure defiance, ready to disobey at the slightest notice.");
        //{sub 20}
        else if (this.gooObedience() < 20) this.outputText(this.flags[kFLAGS.GOO_NAME] + " idly twirls a raven lock of hair as she awaits your comment, a rebellious look glinting in her " + this.flags[kFLAGS.GOO_EYES] + " eyes.");
        //{sub 30}
        else if (this.gooObedience() < 30) this.outputText(this.flags[kFLAGS.GOO_NAME] + " smirks at you with a rebellious cast on her features.");
        //{sub 40}
        else if (this.gooObedience() < 40) this.outputText(this.flags[kFLAGS.GOO_NAME] + " bats charcoal eyelashes at you as she watches you with " + this.flags[kFLAGS.GOO_EYES] + ", fiery eyes, still far from obedient.");
        //{sub 50}
        else if (this.gooObedience() < 50) this.outputText(this.flags[kFLAGS.GOO_NAME] + " glances downwards for a moment, averting her eyes until she remembers to look up, defying her own submission.");
        //{sub 60}
        else if (this.gooObedience() < 60) this.outputText(this.flags[kFLAGS.GOO_NAME] + " casts her eyes down but peeks up through her charcoal eyelashes to regard you.");
        //{sub 70}
        else if (this.gooObedience() < 70) this.outputText(this.flags[kFLAGS.GOO_NAME] + " keeps her " + this.flags[kFLAGS.GOO_EYES] + " eyes cast down at the ground in deference to you, though she nervously draws in the dirt with a finger while she awaits a command.");
        //{sub 80}
        else if (this.gooObedience() < 80) this.outputText(this.flags[kFLAGS.GOO_NAME] + " fixes her gaze down obediently, her cheeks flushing purplish.  Is she enjoying submitting to you?");
        //{sub 90)
        else if (this.gooObedience() < 90) this.outputText(this.flags[kFLAGS.GOO_NAME] + " prostrates herself on the ground before you, tilting her head back so that she can fix her eyes on your waist, unfit to meet your gaze.");
        //{sub 100)
        else if (this.gooObedience() < 100) this.outputText(this.flags[kFLAGS.GOO_NAME] + " submissively prostrates herself before you, raising her onyx rump high as her forehead lowers.  Her cheeks and rump both manage to blush purple through her latex skin, clearly aroused by her own submissiveness.");
        //{MAX}
        else this.outputText(this.flags[kFLAGS.GOO_NAME] + " plants herself on all fours before you, kissing at your [feet].  Her smooth butt lightens along with her sides and cheeks, blushing violet with lust from the heat of her own submission.  Lewdly, she greets you, \"<i>[Master].</i>\"");
    ...
    private changeGooDick(): void {
        ...
        if (this.gooObedience() >= 60) {
            this.outputText("You ");
            if (this.flags[kFLAGS.GOO_DICK_LENGTH] == 0) this.outputText("ask " + this.flags[kFLAGS.GOO_NAME] + " if she's ever considered growing a dick for fun.");
            else this.outputText("ask her if she'd like to change what kind of dick she has.");
            this.outputText("  She whimpers and moans, \"<i>[Master], I loved growing penises back before I changed.  More than that, ");
            if (this.flags[kFLAGS.GOO_DICK_LENGTH] == 0) this.outputText("I want to grow one for you.  ");
            else this.outputText("I want you to order me to shift it often.  ");
            ...
            if (this.flags[kFLAGS.GOO_DICK_LENGTH] == 0) this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " pulls a hand away from her pussy and says, \"<i>I'll need something masculine if you want me to grow a cock, [Master].  An incubi draft would work, or some minotaur blood, though the blood might make it a horsecock...</i>\"  She shudders and closes her eyes, imagining herself with a rigid equine pole.  Your goo must have a bit of a fetish.");
            else this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " pulls a hand away from her pussy and says, \"<i>What kind of penis would please you most?  I could probably do the human ones, dog dicks, horse cocks, cat pricks, tentacle wangs, or demon dongs.</i>\"  She gives a little shudder at the last one and licks her lips.  \"<i>You'll need to have an appropriate item to assist me though, [Master].  I'm not as flexible as I once was.");
        }
        //High Happiness + Whatever Obedience(F)
        else if (this.gooHappiness() >= 70) {
            this.outputText("You ask " + this.flags[kFLAGS.GOO_NAME] + " if ");
            if (this.flags[kFLAGS.GOO_DICK_LENGTH] == 0) this.outputText("she's ever considered growing a dick for fun.");
            else this.outputText("she'd like to change what kind of dick she has.");
    ...
    private latexyEatsADickItem(item: ItemType): void {
        ...
        this.clearOutput();
        this.outputText(this.flags[kFLAGS.GOO_NAME] + " uses your proffered item without a second though.  Surprisingly she doesn't seem to react in any way, aside from closing her eyes and taking on a look of incredible concentration.  ");
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] == 0) {
            ...
            if (item == this.consumables.MINOBLO) this.outputText("flattened head");
            else this.outputText("bulbous crown");
            ...
            if (item == this.consumables.MINOBLO) this.outputText("horse-");
            this.outputText("cock!</b>");
            this.gooObedience(5);
        }
        else {
            if (item == this.consumables.GROPLUS) {
                this.outputText("Her " + this.gooCock() + " shivers, and starts to sprout outward from the base, lengthening before your very eyes.  One... two... three... new inches of gleaming prick reveal themselves to you!\n\n" + this.flags[kFLAGS.GOO_NAME] + " giggles, \"<i>You sure do like them big!</i>\"");
                this.flags[kFLAGS.GOO_DICK_LENGTH] += 3;
            }
            else if (item == this.consumables.REDUCTO) {
                this.outputText("Her " + this.gooCock() + " trembles, and starts to shrink inward, disappearing into her polished abdomen.  The effect is so startling profound that you have to do a double-take.  " + this.flags[kFLAGS.GOO_NAME] + "'s penis is barely two thirds its original size!\n\nShe giggles, \"<i>Not a fan of the big boys, huh?</i>\"");
                this.flags[kFLAGS.GOO_DICK_LENGTH] = Math.round(this.flags[kFLAGS.GOO_DICK_LENGTH] * .66);
            }
            else {
    ...
    private setLatexysBustSize(): void {
        this.clearOutput();
        this.outputText("You ask " + this.flags[kFLAGS.GOO_NAME] + " if she wouldn't mind keeping her tits around a certain size.");
        //Low Obedience
        if (this.gooObedience() < 60) {
    ...
    private changeLatexyTits(arg: number = 0): void {
        ...
        if (this.gooTitClass(arg) > this.gooTitClass(this.flags[kFLAGS.GOO_PREFERRED_TIT_SIZE]) && this.gooTitClass(this.flags[kFLAGS.GOO_FLUID_AMOUNT] / 2) < this.gooTitClass(arg)) {
            //If already as big as possible
            if (this.gooTitClass(this.flags[kFLAGS.GOO_FLUID_AMOUNT] / 2) == this.gooTitClass(this.gooTitSize()))
                this.outputText(this.flags[kFLAGS.GOO_NAME] + " nods, but her body doesn't change.  \"<i>There's not enough of me to make them any bigger right now.  You'll have to feed me if you want to see what they'll look at... full size.</i>\"");
            //Tits can't quite grow to max size:
            else
                this.outputText(this.flags[kFLAGS.GOO_NAME] + " places her hands on her nipples and takes a deep breath.  She holds it for one second... two... three...  As she exhales, her breasts visibly inflate, not with air, but with ponderous liquid weight.  Unfortunately, they stop short of the size you requested.  " + this.flags[kFLAGS.GOO_NAME] + " just doesn't have enough juice to fill them... yet.  She tells you that once you feed her enough she'll be as rounded as you requested.");
        }
        //To max {Giant}size!
        ...
        //To A {light} sized:
            ...
            this.outputText(this.flags[kFLAGS.GOO_NAME] + " says, \"<i>I'll look anemic!  The other goo-girls will think I'm starving!</i>\"  You give her a condescending look and she sighs.  \"<i>All right, all right.  If my [master] wants tiny tits, " + this.player.mf("he'll", "she'll") + " get them.</i>\"  She grabs hold of her " + this.gooTits() + " and compresses them in her grip.  Amazingly, the latex chest-flesh recedes into her as she pushes, diminishing before your very eyes.  She whimpers when they hit B-cups and groans when they reach A's.  " + this.flags[kFLAGS.GOO_NAME] + " pulls her hands away to show you the fruits of her labors - two tiny breasts, each barely a palmful.  A river of latex lubricants runs from her cleft, her arousal enhanced by the very act of obeying you against her wishes.");
        }
        else {
            this.outputText(this.flags[kFLAGS.GOO_NAME] + " blushes and gives you a smile that would be radiant, were it not on a midnight black canvas.  \"<i>Thank you.</i>\"");
            this.gooHappiness(2);
        }
    ...
    private feedLatexyCumIndirectly(): void {
        ...
        this.outputText("Glancing down at " + this.flags[kFLAGS.GOO_NAME] + ", you tell her that it's feeding time.  She turns her gaze upward, more than a little eagerly");
        if (this.gooObedience() < 70) this.outputText(" and unashamedly reaching for your [armor].  You bat her hands away, forcing her greedy little latex digits to wait along with the rest of her");
        else this.outputText(", obediently waiting with her tongue wagging.");
        if (this.gooFluid() < 33) {
        ...
        if (this.player.cockTotal() > 1) this.outputText("s at once");
        this.outputText(", raining down into the bowl in thick white ropes.");
        if (this.player.cumQ() >= 500) this.outputText("  In a short time, you have overfilled it, so you settle for spraying the remainder over your rubbery prize.  Long strands of sticky, slick breeding fluid rain over her charcoal mane, painting into a gray mop.");
        if (this.player.cumQ() >= 1000) this.outputText("  Still, you relentlessly pump yourself through more and more ejaculations, until the ground can bear no more and a puddle forms below.");
        if (this.player.cumQ() >= 4000) this.outputText("  That puddle swiftly fills into a foot deep lake of spunk, a muddy morass of your own virile semen.");
        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " dives into the bowl with gusto, greedily devouring every drop.  Her tongue hangs free, thrashing against the polished wood as more and more of her latex mouth-muscle spools free to help with the feeding.  In seconds, the bowl is emptied");
        if (this.player.cumQ() >= 500) this.outputText(", and she turns to cleaning herself");
        this.outputText(".");
        if (this.player.cumQ() >= 1000) this.outputText("  Sadly, the copious jizz that puddled up has already been devoured by the dry ground.  It seems the dirt can drink faster than your latex slave.");
    ...
    private feedLatexyGirlCumIndirectly(): void {
        ...
        if (this.gooFluid() < 33) this.outputText("  The hunger in her eyes is so relentless you fear her gaze could drill directly into your [vagina].");
        else if (this.gooFluid() < 66) this.outputText("  The hunger in her eyes is a palpable thing, one you fear could prod her into rash action.");
        else if (this.gooFluid() < 90) this.outputText("  The hunger in her eyes is a lazy thing.  It doesn't seem that strong, but she's always willing to drink more.");
        else this.outputText("  The hunger in her eyes is a decadent, gluttonous thing that's barely roused by the prospect of fresh seed.  It still causes her to smear a lick across her shiny lips.");
        ...
        if (this.player.clitLength >= 3.5) this.outputText("  Soon, it stands out proud and erect, a column of glistening femme-flesh that tingles with every stray breeze.");
        this.outputText("\n\nEnraptured by the arousing view, your latex pet is unable to resist echoing your motions.  One after another, her rubbery fingertips disappear from sight, each nestled deeply into the onyx crevasse below.  The only visible digit is the tip of her thumb, which lewdly circles at her buzzer through the thick, ebony lubricant that oozes out around her palm.  Her " + this.flags[kFLAGS.GOO_EYES] + " eyes look up at you pleadingly from under sable eyelids, her mouth wordlessly begging you for your girl-cum.  A climax rips through her sensitive body, a living fetish shuddering in climax.  Squirts of liquid latex erupt around her wrist as she orgasms.");
        this.outputText("\n\nYou groan, equally enraptured by the display she's putting on for you.  Soon, you're ");
        if (this.player.wetness() < 3) this.outputText("absolutely soaked with your girlish moisture");
        else if (this.player.wetness() < 4) this.outputText("dripping strings of girlish liquid with abandon");
        else this.outputText("practically gushing girlish moisture into the bowl");
        this.outputText(".  You instinctively rock your [hips] forward, slowly pumping them to an instinctive, animalistic beat.  " + this.flags[kFLAGS.GOO_NAME] + " watches raptly, still masturbating herself with relentless finger-fucks.  She watches expectantly, waiting for the first sign of your orgasm with spellbound attention.");
        this.outputText("\n\nRather than disappoint those eager eyes, you cum.  A bolt of electric intensity explodes in your [clit].");
        if (this.player.clitLength >= 3.5) this.outputText("  You wrap your hand around it without meaning to, caressing the slick, womanly shaft so fast that it floods your mind with white waves of unthinking pleasure.");
        ...
        if (this.player.wetness() < 3) this.outputText("Your dribbling cunny paints a thin film of lady-spunk on the bowl, filling it slowly as you drip and squirm.");
        else if (this.player.wetness() < 4) this.outputText("Your ludicrously wet cunt oozes thick flows of lady-spunk into the bowl, rapidly filling it with the proof of your orgasm.");
        else this.outputText("Your gushing cunny sprays a lurid flow of lady-spunk into the bowl, immediately filling it beyond its rim.  It does a fine job of muddying the ground with the proof of your orgasm as your bliss drags on.");
        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " dives into the bowl with gusto, greedily devouring every drop.  Her tongue hangs free, thrashing against the polished wood as more and more of her latex mouth-muscle spools free to help with the feeding.  In seconds, the bowl is emptied.");
        if (this.player.wetness() >= 4) this.outputText("  Sadly, the copious vaginal lube that muddied the ground is already absorbed.  It seems the dirt can eat faster than your pet.");
        //{Boost her fluid quantity, bonus for over 250mL.}
        this.temp = 10;
    ...
    private minotaurCumFeedingGoo(nice: boolean = false): void {
        ...
        if (this.player.minotaurNeed() || this.player.minotaurAddicted()) this.outputText(" and hungrily lick at your lips, always eager to take such a treat yourself");
        this.outputText(".  The latex woman ");
        if (this.flags[kFLAGS.TIMES_FED_LATEXY_MINO_CUM] > 0) this.outputText("claps in excitement, her dark-as-night nipples perking up immediately.  She hasn't forgotten her last taste of the heady treat.");
        else this.outputText(" tilts her head in confusion, though when she realizes that it's cum you carry, her dark-as-night nipples perk up.");
        this.outputText("  You swish the bottle back and forth, commenting on how you've brought your pet a treat.");

        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " babbles without meaning to, \"<i>Really, [Master]?  For me?</i>\"  She presses her inhumanly smooth skin against you in a hug.  Her ebony coating nuzzles right up against you as her cheek brushes your ");
        if (this.player.tallness >= 72) this.outputText("[chest]");
        else if (this.player.tallness >= 60) this.outputText("neck");
        else if (this.player.tallness >= 52) this.outputText("own");
        else this.outputText("hair");
        this.outputText(".  Striking " + this.flags[kFLAGS.GOO_EYES] + " eyes imploringly beg at you, as if to say, \"<i>Can I have it now?</i>\"");
        //{HARD - skip if nice.}
        if (!nice) {
            ...
            if (this.gooObedience() >= 70) this.outputText("  " + this.flags[kFLAGS.GOO_NAME] + " immediately drops to the ground on all fours, rubbing her head against your [foot] and begging, \"<i>Please [Master], may your latex fuckpet have some of that wonderful cum?</i>\"  It seems she can be obedient after all.");
            //[Semi obedient:]
            else if (this.gooObedience() >= 40) {
                this.outputText("  " + this.flags[kFLAGS.GOO_NAME] + " gives a trifling protest, \"<i>Do I have to?  That cum looks really delicious!  I promise, I'll be good!  I'll let you fuck me any way you want.  I'll even fuck you, if you want me to!</i>\"");
                ...
                this.outputText("\n\nThere is a moment's hesitation in the quivering pile of ebony fuckpet.  She seems to want to rebel, but then, she begins to kiss at your [feet], eventually extending her tongue to worship you.  At first, her mouth's muscle is tenderly, experimentally touching you.  Yet, it soon gains in eagerness and speed.  " + this.flags[kFLAGS.GOO_NAME] + " is soon not just licking your [feet] but full on worshiping them, polishing them with her tongue.  A liquid dripping can be heard as she begins to enjoy herself.");
                this.outputText("\n\nOnly then do you allow her to stop, pulling her up by the scruff of the neck.  She's learning.");
                //{+obedience}
            }
            //[Not obedient:]
            else {
                this.outputText("  " + this.flags[kFLAGS.GOO_NAME] + " protests, \"<i>But you captured me!  You ought to at least have the decency to give me some of that yummy food!</i>\"");
        ...
        this.outputText("\n\nNodding, you uncork the bottle and hand it to her.  She immediately throws it back like a sailor with a shot, throat working silently to pass the liquid load directly into her belly.  " + this.flags[kFLAGS.GOO_NAME] + " burps loudly, her breath inundated with spunk-scent");
    ...
    private feedLatexyCumDirectly(): void {
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() == 2) this.outputText("dick fruitlessly paints");
            else this.outputText("dicks fruitlessly paint");
            this.outputText(" her " + this.gooTits() + " with a sheen of white, wasting their moisture in a decadent display of virility.");
        }
        if (this.player.cumQ() >= 500) this.outputText("  You cream her internals so full that her belly distends and jiggles with each fresh pump of spunk.");
        if (this.player.cumQ() >= 1500) this.outputText("  Rounder and rounder she swells, until her middle is almost balloonish, stretched so taut it appears grayish-white thanks to all the white beneath.");
        if (this.player.cumQ() >= 500) this.outputText("  However, by the time your orgasm is winding down, she's already metabolizing it, converting her spunk-plumped belly into supple, denser curves for the rest of her form.");

        this.outputText("\n\nFeeling utterly empty, you sag back against a boulder.  The rough texture of the supporting stone keeps you upright, but there's next to no strength left in your [legs].  " + this.flags[kFLAGS.GOO_NAME] + " is still down there, still slurping and sucking, probing the delicate entrance to your cumvein with gentle licks as she squeezes the last few drops from you.  The sensation feels far too good this soon after climax.  You wriggle and squirm, putting a hand to " + this.flags[kFLAGS.GOO_NAME] + "'s forehead and commanding her to stop.");
        //{OBEDIENT:}
        if (this.gooObedience() >= 60) {
    ...
    private maleDirectFeedLatexGooGoneWrong(): void {
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() > 2) this.outputText("your remaining erections");
            else this.outputText("your other erection");
        ...
        this.outputText(".  " + this.flags[kFLAGS.GOO_NAME] + " looks up at your seizing body, smiling wide around her ");
        if (this.player.biggestCockArea() > 80) this.outputText("impressive ");
        ...
        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " releases you from your oral imprisonment long enough to leak a few trailing strands of spunk from your [cockHead biggest].  ");
        if (this.player.cockTotal() == 1) this.outputText("Her hands fixate on your slick, black-coated length, beginning to stroke it with eager pumps");
        else this.outputText("Her eager pumps never slow, and she moves one of her busy mitts to stroke your black-coated length");
    ...
    private feedLatexyGirlCumDirect(): void {
        ...
        if (this.player.hasCock()) {
            this.outputText("  When " + this.flags[kFLAGS.GOO_NAME] + " glances to your " + this.multiCockDescriptLight() + ", you tut and ");
            if (this.player.balls > 0) this.outputText("lift your [balls]");
            else this.outputText("shift position");
        ...
        this.outputText("\n\nYou confidently approach, stopping just in front of your latex pet.  She immediately drops to her knees, placing her nose a scant few inches from your vulva.  Her " + this.flags[kFLAGS.GOO_EYES] + " eyes lock onto the ");
        if (this.player.wetness() >= 3) this.outputText("glistening ");
        this.outputText("outer lips with excitement, dilating slightly as she leans closer.  " + this.flags[kFLAGS.GOO_NAME] + "'s nostrils flare as she breathes deeply of your scent, inhaling thick lungfuls of your feminine odor, the heady musk of an aroused woman.  Her mouth hangs open slightly, as if in awe of what she sees, and undirected by her conscious mind, she lazily drifts closer.");
        this.outputText("\n\nA shiver of indecent pleasure writhes up your spine when her nose casually crashes into your slit.  Jolting slightly, " + this.flags[kFLAGS.GOO_NAME] + " is roused from her cunt-induced stupor by the hot wetness on her proboscis.  She glances up at you, blushing just the slightest amount of violet, and hesitantly cranes her head to bring her lips in contact with your labia.  At first, she kisses and licks around the outer edges of your vulva, smearing their surface with her inky saliva.  The slick fluid thickens on contact with the air, even as she dives deeper into your [vagina], slowly spreading your inner lips with her exotic tongue.");
        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " quickly loses herself in her own artful ministrations, her world narrowed down to the simmering cleft at the joint of your [hips] and [legs].  Slithering out, snakelike, her tongue burrows into your [vagina].  Its length is as large as it is slick, shiny and so smooth that it glides through your gates with ease.  " + this.flags[kFLAGS.GOO_NAME] + " skillfully twists it around inside you, forcing more of her sable spit into your channel as her lubricated muscle squirms inside you, pressing hard against every tender area.  It's so smooth that if it weren't pushing so pleasantly against you, you'd barely feel it.  As it is, a slick snake is writhing in your cunt and it's set your loins afire.");
        if (this.player.wetness() < 3) this.outputText("  Drizzling wetness pours down your pet's chin as she pleases you.  She swallows most of it with eager bobs of her throat, happy to have such a... moist [master].");
        else if (this.player.wetness() < 4) this.outputText("  Drops of wetness beat on your pet's chin as she pleases you.  She swallows most of it with eager bobs of her throat, pleased to have an appetizer before the main course.");
        else this.outputText("  Lubricant shines on your pet's glossy chin as she pleases you.  She swallows every now and again with eager bobs of her throat, sampling your flavor.");
        this.outputText("\n\nPulling back, the hungry latex woman smiles up at you, though she's muted by the tongue that hangs over the intervening distance, still locked to your pussy by her undulating oral appendage.  Her long lashes blink innocently while that potent mouth muscle massages your box's inner walls.  Taken in by the sensual assault and innocent visage accompanying it, you grab hold of " + this.flags[kFLAGS.GOO_NAME] + "'s face and cram it into your cunt, mashing her mouth up into your nethers hard enough to make an audible squelch.  The corners of " + this.flags[kFLAGS.GOO_NAME] + "'s eyes crinkle merrily.  She's still meeting your gaze, even as you hump her mouth, using her like a living latex sextoy.");
        this.outputText("\n\nHolding as tightly to that thought as your slave's head, you aggressively grind against her, letting the ecstatic pleasure haze your thought processes as it crests into a wave.  She twists and presses her tongue up hard, squeezing a supremely sensitive spot.  The ensuing explosion of heavenly indulgence echoes in your brain, short-circuiting your motor control.  Your limbs thrash freely, though your fingers and arms stay locked on " + this.flags[kFLAGS.GOO_NAME] + ", mashing her tightly into your gash.");
        if (this.player.wetness() >= 4) this.outputText("  You squirt a small river of gushing juices directly into her mouth, her cheeks flooded by the copious outpouring of lubricant.");
        else this.outputText("  You gradually fill her mouth with your free-flowing orgasmic lubricants.");
    ...
    private letLatexGooDrainCuntDry(): void {
        this.clearOutput();
        this.outputText(this.flags[kFLAGS.GOO_NAME] + "'s face remains firmly, stubbornly attached to your loins.  No matter how you writhe or push against her, she stays latched onto your [vagina].  The near supernatural pleasure has turned your arms to jello, and you slump back ineffectually after a few attempts at freedom.  The " + this.flags[kFLAGS.GOO_EYES] + " of your hungry pet's eyes watches you, unblinking.  Mercilessly, she tongues your sodden slit to another orgasm.  The slippery latex lips slip and slide across your womanhood as sexual ecstasy subsumes your thoughts, eyes rolling back as your mind dedicates the whole of its power to simply experiencing the pleasure that's thrust upon you.");
        this.outputText("\n\nWordlessly, you writhe on " + this.flags[kFLAGS.GOO_NAME] + " until the orgasm finally releases you from its grip.  Your pet goo pulls back, even withdrawing her tongue from your well-juiced box.  Her fist doesn't waste any time in replacing in.  In fact, as the smooth limb slides home, you can feel the bulkiest parts smoothing, shaping it into a cylindrical object with a noticeable ridge just above the 'wrist'.  " + this.flags[kFLAGS.GOO_NAME] + " giggles, \"<i>Gosh, you taste good, and we goo girls... we love to drink.  Mmm...</i>\"  Her voice trails into a hum of delight as she digests your newest offering, eventually returning to say, \"<i>Your little slit here seems awful happy, [name]... I don't want to stop, and it's so sweet, so delectable...  Swallowing your cum makes my pussy gush and my stomach purr.  You don't mind if I sample a few more swallows do you?</i>\"");
        ...
        if (this.player.clitLength >= 3) this.outputText("  She happily fellates your female pole in time with the pumping of her arm.");
        else this.outputText("  She happily licks and sucks your most sensitive spot in time with the pumping of her arm.");
        ...
        this.outputText("\n\nA whimper of protest slips out of your mouth, your [vagina] cums again, and " + this.flags[kFLAGS.GOO_NAME] + " drinks deeply once more.  With eyelids fluttering closed, you pass beyond conscious awareness, yielding your body to " + this.flags[kFLAGS.GOO_NAME] + " to claim again and again.");
        this.menu();
        this.player.orgasm();
        this.dynStats("lib", .5, "sen", -3);
    ...
    private assertControlOverCuntDrainingLatexGoo(): void {
        ...
        this.clearOutput();
        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + "'s face remains firmly, stubbornly attached to your loins.  You struggle under her relentless oral assault until you finally manage to get a good grip on the rebellious goo-slut. Putting your impressive strength to work, you flip yourself and the goo-girl over, straddling her shoulders and crushing her beneath your body.  " + this.flags[kFLAGS.GOO_NAME] + " lets out a pathetic squeak as you assume command once again, pinning her onto the ground beneath you.  She's supposed to be the servile one here: it's time for this bitch to learn her place.  You grab her by her slick, latexy hair and mash her face into your twat, shuddering as her nose rubs against your [clit].  You snap a command to finish you a second time.  If she wants your fluids so bad, let her work for it the right way: meekly suckling from your cunt like a good little sub should.");
        this.outputText("\n\nPinned down as she is, " + this.flags[kFLAGS.GOO_NAME] + " struggles against your powerful [legs] for a few moments before another forceful face-shove into your waiting cunt stops her, her intense craving for your femcum overpowering her desire to rebel.  \"<i>I-I'm sorry, ");
        if (this.gooObedience() <= 50) this.outputText("[name]");
        else this.outputText("[Master]");
        ...
        this.outputText("\n\n\"<i>Good girl,</i>\" you moan, arching your back as she slithers more and more of her long tongue into you, filling your [cunt] with black latex.  You run your fingers through her hair, urging " + this.flags[kFLAGS.GOO_NAME] + " on as she begins to explore your passage, still delightfully sensitive and malleable after the recent face-fucking you just received from her.  More and more of her creeps into you, spreading your vaginal walls wide until the tip of her tongue tickles the mouth of your cervix, pleasantly circling it with slow, rhythmic motions.  You remind " + this.flags[kFLAGS.GOO_NAME] + " that this is how it ought to be, with her meekly servicing your needy cunt as you desire; not her trying to dominate you. That isn't how this works, and she should know better by now.");
        this.outputText("\n\n\"<i>I'm sowwy, " + this.player.mf("Mashta", "Mishtrish") + ",</i>\" she mumbles, her words slurred by her tongue being fully buried inside you.  She retracts herself from you, leaving you feeling empty and cold as she adds, \"<i>I didn't mean to, Master... I just, lose control...</i>\"  You smile down at the little latex girl and tell her that she doesn't need to worry.  You'll always be here to keep her nice and full with delicious femcum, so full that she's fit to burst with how much you've given her.  " + this.flags[kFLAGS.GOO_NAME] + " squirms, stirred by your words, and looking over your shoulders, you can see a fresh sprout of liquid latex pouring down between her thighs.");
        this.outputText("\n\nYou release " + this.flags[kFLAGS.GOO_NAME] + "'s head, leaving one hand to stroke her hair as your other plays down her slick, smooth skin, tracing along her shapely curves and huge, jiggling breasts until your fingertips brush along her thighs.  She gasps as a single digit plunges into her, sliding up to the knuckle into her ready cunt in one slow, languid motion.  Your other hand guides her head upwards, urging her back to her duties; she hesitates for a moment, but so do you, both still holding until she finally accepts your demand and resumes, her tongue flicking out to play along your [cunt].  \"<i>Good girl,</i>\" you say again, and start to move your hand, gently fingering her pussy as she tongues up the lubricant freely leaking from your loins.");
        this.outputText("\n\nBefore she can fall into a rhythm of tongue-fucking you, though, you decide to reward her newfound submissiveness: you twist around, leaving her pinned beneath your [legs] as you move your head between her shapely thighs.  You breathe in deep, reveling in the smell of her as " + this.flags[kFLAGS.GOO_NAME] + " slips her long tongue back into you, filling your empty [cunt] with her oral appendage.  You return the favor, gently sliding your middle-three fingers into her eager twat, stretching her until you can slide the whole of your fist in.  She gasps, her breath hot on your sensitive box, but you don't skip a beat as you push your fist into her, sliding in until you run out of cunt to fill.  You start to move, fisting her with slow, gentle motions, enjoying the feeling of her slick passage desperately contracting around the huge block inside it, trying to push you out as you push in; trying to suck you in as you pull out to the knuckles.");
        this.outputText("\n\n\"<i>" + this.player.mf("Masterrrr", "Mistriiiiissss") + "!</i>\"  " + this.flags[kFLAGS.GOO_NAME] + " groans, rolling her head back as you fist-fuck her. She redoubles her oral ministrations, eagerly lapping at your sodden box, desperately trying to bring you to orgasm even as lube spurts liberally from between her legs, signaling her impending climax.  You're closer, though, so close to the edge that you'd cum even if she stopped.  But she wouldn't dare, instead grasping your thighs and shoving her face between your [legs], slurping her tongue through you with mind-wrecking speed.");
        this.outputText("\n\nYou jam your fist as far into " + this.flags[kFLAGS.GOO_NAME] + " as you can before you cum, making her shriek in pleasure and sending reverberations through your cunt as you rocket over the edge.  Your [cunt] practically explodes with femcum, showering " + this.flags[kFLAGS.GOO_NAME] + "'s face with it as your box squeezes down on her tongue, trapping her inside you as you pound her box, throwing her into orgasmic throes beneath you, her tongue writhing and squirming inside you to further your pleasure.");
        this.outputText("\n\nWhen your second orgasm passes, you roll limply off of " + this.flags[kFLAGS.GOO_NAME] + ", utterly sated.  Your [chest] heaving, you sigh peacefully as you close your heavy lids, eager to rest.  A moment later, though, you feel slick skin press against your own as " + this.flags[kFLAGS.GOO_NAME] + " curls up beside you, her face inches from your own.  With a wan smile, you reach out and run your fingers through her hair before pulling her into a long kiss that leaves the taste of womanhood on your lips.");
        //{Low happiness}
        if (this.gooHappiness() < 33) this.outputText("\n\n\"<i>If it's always going to be like that, maybe... being here with you isn't going to be so bad after all,</i>\" " + this.flags[kFLAGS.GOO_NAME] + " whispers.");
        //{Moderate happiness}
        else if (this.gooHappiness() < 66) this.outputText("\n\n\"<i>I'm sorry I got so forceful, [name].  I enjoy serving you... I do.</i>\"");
        //{High happiness}
        else this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " nuzzles against you, her head coming to rest on your [chest].  \"<i>Sorry, [name]. I didn't mean to try and force you.  I love you when you're so assertive, so... dominant.</i>\"");
        this.player.orgasm();
        this.dynStats("sen", -2);
    ...
    private tryToAssertMaleDomWhileLatexGooDrains(): void {
        ...
        this.outputText("\n\nBut this isn't how it's supposed to be!  You're supposed to be in control here, not " + this.flags[kFLAGS.GOO_NAME] + ".  She's meant to serve you, not force herself on you like some goblin slut.  You struggle against her, grabbing " + this.flags[kFLAGS.GOO_NAME] + "'s hair and pulling back, forcing her off your cock with all your strength.  She tumbles back, coughing and gagging, her mouth still locked in an 'O' meant for your [cock biggest].  You dust yourself off, struggling upright before standing, looming over " + this.flags[kFLAGS.GOO_NAME] + " who looks meekly up at you.  \"<i>I... I...</i>\" she starts, but you cut her off, rolling her onto her belly and hiking her plump little ass up.  You sigh, starting to remind her of exactly who's in charge here, of how you're always here to feed her, and yet she tries to force herself on you like that...  Unacceptable. As you speak, you grab her plush buttcheeks, digging your fingers into her backside until a little moan escapes her lips.  \"<i>That's more like it,</i>\" you growl, flopping your [cock biggest] down between her cheeks, rubbing it across the smooth, yielding latex of her ass.");

        this.outputText("\n\n\"<i>I'm sorry, [Master],</i>\" " + this.flags[kFLAGS.GOO_NAME] + " mewls meekly, but the slut inside her starts wiggling her rump, her cheeks gently squeezing around your manhood.  Still, you 'tsk' at her as you begin to slowly rock your [hips], hotdogging yourself between her gropable buttcheeks, enjoying the onahole-like feel, even as latex lube starts to drip to the ground from between " + this.flags[kFLAGS.GOO_NAME] + "'s legs, her body desperately announcing its desire to fuck.  Despite the orgasm that just wracked your body, you can feel your lust stirring, too, spurred on by the oral onslaught " + this.flags[kFLAGS.GOO_NAME] + " attempted to inflict on you.  You give your [cock biggest] one last, rough thrust between her cheeks before pulling back, stroking yourself until your [cockHead biggest] presses against her lube-slicked cunt.  You rub the shaft of your prick along her slick, eager fuckhole, letting her liquid latex lube slosh out onto you as " + this.flags[kFLAGS.GOO_NAME] + " continues to whorishly wiggle her ass, trying to entice you to feed her.");
        this.outputText("\n\nOnce your [cock biggest] is nice and slick with her vaginal excretions, though, you pull back again and dig your fingers back into " + this.flags[kFLAGS.GOO_NAME] + "'s ass, spreading her lush cheeks apart to reveal the tight little star of her backdoor.  " + this.flags[kFLAGS.GOO_NAME] + " gasps as she feels your crown press against her asshole, her mouth opening wide as your oh-so-wet prick plunges the first inch into her without resistance.  You groan with satisfaction as her vice-tight hole squeezes down around your slick shaft, desperately, reflexively trying to repel the intruding cockmeat; but you're so slick, so covered in liquid latex that " + this.flags[kFLAGS.GOO_NAME] + "'s stunned body can't resist you, and you begin to slide inch after inch into her, burying yourself to the hilt in a single long, painfully slow push.");
        this.outputText("\n\nYou pause once you've hilted her, breathing deeply as you enjoy the intense squeeze her anus is applying to you, reveling in the sensation of smooth latex rubbing harshly along your goo-covered shaft, unable to gain traction.  Your fingers knead into " + this.flags[kFLAGS.GOO_NAME] + "'s supple assflesh, working her cheeks like dough in your hands, roughly massaging her backside until she starts to relax around you.  \"<i>Good girl,</i>\" you whisper, reaching forward to stroke " + this.flags[kFLAGS.GOO_NAME] + "'s hair.  \"<i>That's a good girl, just relax.  Take it...  You wanted it so bad.</i>\"");
        this.outputText("\n\n\"<i>I-I'm sorry, [Master],</i>\" " + this.flags[kFLAGS.GOO_NAME] + " repeats, her breath choking up as you grind your hips into her, pushing just a touch more prick into her ass.  \"<i>I didn't mean to...  I'll be a good girl, I promise,</i>\" she whines, groaning as you slowly pull out of her, retracting your cock until just the head remains.  \"<i>Fuck me, [Master], pleeeeaaaassssseeee,</i>\" she cries, \"<i>just fuck me, fuck me, fuck me!</i>\"");
        this.outputText("\n\nYou grab her hips and slam forward, hilting yourself again in a single thrust. " + this.flags[kFLAGS.GOO_NAME] + " cries out, her voice echoing in the distance as you roughly pound her asshole, thrusting into her again and again until you can feel yourself approaching your limit, the near-frictionless hole you're hammering too good to pass up.  But " + this.flags[kFLAGS.GOO_NAME] + " still hasn't been properly put in her place.  You're supposed to be in control here, not her.  You protect her, feed her, care for her, and she still thinks she can control you.  Unacceptable.  You push back into her, forcing yourself in to the hilt, and stop.  You hold yourself utterly still, simply enjoying the smooth liquid feel of her latex-coated ass.");
        this.outputText("\n\n\"<i>M-[Master]?  Please...</i>\" " + this.flags[kFLAGS.GOO_NAME] + " begs, looking pleadingly over her shoulder.  \"<i>I'm still so hungry...</i>\"");
        this.outputText("\n\nAs soon as she says \"<i>hungry,</i>\" you strike. With palm open, you level a harsh stroke across " + this.flags[kFLAGS.GOO_NAME] + "'s backside, sending her ass quivering.  You gasp with delight as the force of your spank carries right through her, making the latex inside her jiggle wildly around your [cock biggest].  " + this.flags[kFLAGS.GOO_NAME] + " sucks in breath through her onyx teeth, but looks back at you with a look filled with lust, as if she can sense how close you are.  She wiggles her ass again, almost invitingly.  You lash out again, spanking her hard enough to nearly knock the two of you over; then again, and again, each time nearly pushed over the edge by the jiggle in her butt after your attack.");
        this.outputText("\n\nEventually, you can take no more.  You feel the rush of semen hurtling through your [cock biggest], and with one last smack, send yourself over the edge.  You throw your head back and roar your pleasure into the sky as cum pours out of your cock-slit and into " + this.flags[kFLAGS.GOO_NAME] + "'s hungry ass, painting her ebony rectal walls white.  As spunk pours out of you, " + this.flags[kFLAGS.GOO_NAME] + " moans lewdly, hungrily, an orgasmic look on her face as the pain of the spanking is replaced by the satisfaction of your seed flowing into her.");
        this.outputText("\n\nWhen your second orgasm passes, you roll limply off of " + this.flags[kFLAGS.GOO_NAME] + ", utterly sated.  Your [chest] heaving, you sigh peacefully as you close your heavy lids, eager to rest.  A moment later, though, you feel slick skin press against your own as " + this.flags[kFLAGS.GOO_NAME] + " curls up beside you, her face inches from your own.  With a wan smile, you reach out and run your fingers through her hair before pulling her into a long kiss that leaves your own taste on your lips.");
        //{Low happiness}
        if (this.gooHappiness() < 33) this.outputText("\n\n\"<i>If it's always going to be like that, maybe... being here with you isn't going to be so bad after all,</i>\" " + this.flags[kFLAGS.GOO_NAME] + " whispers.");
        //{Moderate happiness}
        else if (this.gooHappiness() < 66) this.outputText("\n\n\"<i>I'm sorry I got so forceful, [name].  I enjoy serving you... I do.</i>\"");
    ...
    private femalePCDomFucksLatexGoo(): void {
        this.clearOutput();
        this.outputText("You start to undress, remarking to " + this.flags[kFLAGS.GOO_NAME] + " that you've got an itch she'd be great at scratching.  As if your language wasn't clear enough, you ");
        if (this.player.balls > 0) this.outputText("lift your [sack] out of the way to ");
        else if (this.player.hasCock()) this.outputText("lift your " + this.multiCockDescriptLight() + " out of the way to ");
        this.outputText("expose your [vagina], labia already engorged and rosy with lust.");

        //{NOT OBEDIENT ENOUGH}
        if (this.gooObedience() < 60) {
            if (this.gooFluid() < 33) this.outputText("\n\nLicking her lips with unrepentant hunger");
            else if (this.gooFluid() < 66) this.outputText("\n\nSticking her tongue against her cheek in consternation");
            else this.outputText("\n\nRolling her eyes");
            this.outputText(", " + this.flags[kFLAGS.GOO_NAME] + " ");
            if (this.gooObedience() < 20) this.outputText("boldly retorts");
            else if (this.gooObedience() < 40) this.outputText("answers snarkily");
            else this.outputText("timidly protests");
            ...
            if (this.flags[kFLAGS.GOO_DICK_LENGTH] > 0) this.outputText(" and the rigidity of her " + this.gooCock() + " have");
        ...
        if (this.player.biggestTitSize() >= 1) {
            ...
            if (this.player.lactationQ() > 50) {
                ...
                if (this.player.lactationQ() < 200) this.outputText("dribbles over your fingers");
                else if (this.player.lactationQ() < 500) this.outputText("squirts out unhindered");
                else this.outputText("sprays out in a fountain");
            }
        }
        else this.outputText(", pinching your [nipples]");
        this.outputText(".  Arching your back, you grab hold of " + this.flags[kFLAGS.GOO_NAME] + " by the ankles and drag her against you.  She whimpers at the pressure on her nethers, too sensitive to endure what you're forcing her to experience.  A high-pitched trill of excitement splits the air.  " + this.flags[kFLAGS.GOO_NAME] + " is cumming, hard by the sounds of it.  Hot, inky discharge splatters across your [clit] and into your [vagina].");
        if (this.player.hasCock()) this.outputText("  Some of it even splats onto your " + this.multiCockDescriptLight() + ", leaving tight black spots on your maleness.");
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] > 0) this.outputText("  Her " + this.gooCock() + " practically bursts from within, distending to accommodate its lurid latex discharge.  Most of it splatters against " + this.flags[kFLAGS.GOO_NAME] + "'s skin and rolls down her flesh in a march of onyx droplets.");
        ...
        this.outputText("\n\nYou mash your [vagina] against " + this.flags[kFLAGS.GOO_NAME] + "'s a few more times to savor the aftershocks of climax.  She grunts each time, her mouth widening into simple 'o's.  The sensuously skinned lady fails can't even scream any more.  The best she can do is moan, low and lewd as you finish using her.  As you slowly begin to separate, a tangle of sable webs hangs in the air, glittering with a coating of femcum.  Some of them are already semi-solid and snap at your withdrawal.  The others just come apart, wetly slapping against each twat as they separate.");
        ...
        if (this.player.findPerk(PerkLib.Masochist) >= 0) this.outputText(", so you do, gleefully stripping the material from your skin.  Juices gush from your [vagina] as you torture your mons with masochistic pleasure, peeling the adhesive substance away to reveal pain-reddened skin.  " + this.flags[kFLAGS.GOO_NAME] + " looks up at you in awe, and with a shudder, you pat her on the head.  \"<i>Good pet.</i>\"");
        //{ALT:
        else {
            ...
            this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " enthusiastically puts her tongue to work, and at her touch, the inky substance melts away.  The parting fluid washes you with warmth as it vanishes into your pet's mouth, one drop at a time.  She greedily devours her leavings along with your copious, post-orgasmic lubrication, hungrily devouring it all.  Her tongue dives inside you to clean out your passageway.  Pistoning back and forth, she fucks you with it, making a meal for herself and carrying the liquid latex away on waves of your own lady-lubricants.  " + this.flags[kFLAGS.GOO_NAME] + " appears intent on slaking her unnatural thirst, and she continues to stimulate and drink long past when you think she'd be done.");
            //{FIRST TIME}
            if (this.flags[kFLAGS.LATEX_GOO_TIMES_FEMDOMMED_BY_PC] == 0) {
                this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " will not relent.  You command her, \"<i>Stop, I'm clean!</i>\"  She doesn't.  You push her away with a [foot], nearly dropping as two feet of tongue unspool from your tongue-gaped vagina.  She pants up at you, then tries again.  You boot her back down, this time pinning her under a leg.  " + this.flags[kFLAGS.GOO_NAME] + "'s tongue reaches out, but you grab it in your hand and push her forehead back down with her other.  She whimpers.  Calmly, you tell her that next time you request a cleaning, she had better stop on command.");
                this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " blinks raven-hued tears away, understanding at last.  You release her and step rise, feeling a twinge of fresh arousal.  Your pet appears humbled but sated.  Best of all, she's left a puddle of onyx cunt-juice below her, freshly excreted while she was restrained.  Good girl.");
            }
            //{REPEAT}
            else this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " obeys, remembering the last time.  Two feet of tongue unspool from your [vagina] as she retracts it.  Her shining face obediently lowers in a bow, but you swear you can see a smile twisting the corners of her mouth.  You tell her she's a good pet, and a fresh flow of wetness escapes from her nethers.");
    ...
    private femalePCDomFucksLatexGooFuta(): void {
        this.clearOutput();
        this.outputText("You begin to remove your [armor] under " + this.flags[kFLAGS.GOO_NAME] + "'s curious eye.  She asks, \"<i>[name], what are you doing?</i>\"");
        this.outputText("\n\nWith a salacious wiggle of your [hips], you tell her that you're going to fuck her - to ride her shining pole to orgasm after orgasm.  " + this.flags[kFLAGS.GOO_NAME] + "'s " + this.gooCock() + " immediately stiffens, hard and proud.  ");
        //{NOT OBEDIENT ENOUGH}
        if (this.gooObedience() < 60) {
            if (this.gooFluid() < 33) this.outputText("Licking her lips with unrepentant hunger");
            else if (this.gooFluid() < 66) this.outputText("Sticking her tongue against her cheek in consternation");
            else this.outputText("Rolling her eyes");
            this.outputText(", " + this.flags[kFLAGS.GOO_NAME] + " ");
            if (this.gooObedience() < 20) this.outputText("boldly retorts");
            else if (this.gooObedience() < 40) this.outputText("answers snarkily");
            else this.outputText("timidly protests");
        ...
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] * this.flags[kFLAGS.GOO_DICK_LENGTH] / 6 > this.player.vaginalCapacity()) this.outputText("  Of course, as gigantic as it is, you can't take all of it, but you do your damnedest to try.");
        else this.outputText("  Soon, your [butt] comes to rest against " + this.flags[kFLAGS.GOO_NAME] + "'s oily skin, her erection nestled nicely inside you.");
        ...
        if (this.player.isTaur()) this.outputText("into your haunches");
        else if (this.player.tallness >= 84) this.outputText("against your side");
        else if (this.player.tallness >= 70) this.outputText("into your shoulder");
        else if (this.player.tallness >= 60) this.outputText("into your neck");
        else this.outputText("over your head");
        this.outputText(", trying to pull herself up against you, deeper inside you.");
        this.player.cuntChange(this.flags[kFLAGS.GOO_DICK_LENGTH] * this.flags[kFLAGS.GOO_DICK_LENGTH] / 6, true, true, false);

        this.outputText("\n\nYou bounce atop " + this.flags[kFLAGS.GOO_NAME] + " faster and faster");
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] * this.flags[kFLAGS.GOO_DICK_LENGTH] / 6 <= this.player.vaginalCapacity()) this.outputText(", your [butt] clapping wetly against her onyx thighs");
        ...
        if (this.flags[kFLAGS.GOO_DICK_TYPE] == CockTypesEnum.DOG) this.outputText("stays trapped inside you thanks to your pet's thick knot");
        else this.outputText("sprays out of your [vagina]");
        this.outputText(".  You look over your shoulder and scold, \"<i>I didn't give you permission to cum!</i>\"");

        this.outputText("\n\n\"<i>I couldn't stop myself, [Master]...  You feel too good!  It's like a vice made out of honey just wringing me dry!</i>\" " + this.flags[kFLAGS.GOO_NAME] + " blurts.  Well, it's hard to be mad with a proclamation like that.  She goes on to say, \"<i>Don't worry, I'll stay hard.  I'm a goo-girl, remember?  Shifting a little bodily fluid around is nothing.</i>\"");
        ...
        if (!this.player.isTaur()) {
            ...
            if (this.flags[kFLAGS.GOO_NIPPLE_TYPE] == -1) {
                ...
                if (this.player.hasFuckableNipples()) this.outputText("kiss yours");
                else this.outputText("swallow your nipples");
                this.outputText(".");
            }
            else if (this.flags[kFLAGS.GOO_NIPPLE_TYPE] == 1) {
                this.outputText("  Her nipple-cocks ");
                if (!this.player.hasFuckableNipples()) this.outputText("smear over the tops of your tits");
                else this.outputText("disappear into your nipplecunts");
                this.outputText(".");
            }
            else {
                this.outputText("  Her nipples ");
                if (!this.player.hasFuckableNipples()) this.outputText("rub all over your own");
                else this.outputText("dock into your nipple-cunts");
                this.outputText(".");
            }
        }
        else this.outputText(", you begin to fondle your [nipples] and bounce haunches on her lap.");
        ...
        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " begs, \"<i>May I kiss you, please [Master]?  I-I'm gonna cum soon!</i>\"");
        this.outputText("\n\nAgain?  Feeling a little generous, or maybe just horny, you award her a nod.  She can kiss you.  ");
        if (this.player.isTaur()) this.outputText("The latex woman wastes no time in bending double to kiss your equine ass, even darting forward to smooch your tender ring.");
        else this.outputText("The latex woman wastes no time in placing her glossy lips against yours, even plunging her slick tongue into your mouth.");
        this.outputText("  Her passionate kisses and twitching boner overwhelm your senses, and before you can warn her, you cum.");
        this.outputText("\n\nYou clench down on the " + this.gooCock() + " without warning, immediately setting to massaging it with your velvety interior.  Your pussy seems to know just what to do in order to get what it wants, and " + this.flags[kFLAGS.GOO_NAME] + " is no match.  She stutters, \"<i>G-g-g-onna... OHGODS!</i>\" and begins to spurt, sputtering streams of onyx goop straight into your womb.  Her lips crush back into place, silencing her whimpers of bliss");
        if (!this.player.isTaur()) this.outputText(" along with your own");
        this.outputText(".  Together, the two of you give in to ecstasy and cum... and cum... and cum.");
        if (this.player.hasCock()) this.outputText("  White erupts from your " + this.multiCockDescriptLight() + " with abandon.  You don't even care that it stains " + this.flags[kFLAGS.GOO_NAME] + "'s " + this.gooTits() + ".  It feels so good and she looks so pretty with strands of icing spattering over top of her.");
        if (this.player.hasCock() && this.player.cumQ() >= 750) this.outputText("  Of course, you quickly bury those strands in a wave of alabaster.");
        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " hugs you tight as she finishes unloading inside you.  Those last few squirts of sable spunk make your cunny feel like a mush of pleasure.  Sighing contentedly, you rise up off of your conquest");
        if (this.flags[kFLAGS.GOO_DICK_TYPE] == CockTypesEnum.DOG) this.outputText(", ignoring the loud 'pop' of her knot slipping free,");
    ...
    private malePCDomFucksLatexGoo(): void {
        ...
        //{OBEDIENT ENOUGH}
        this.outputText("\n\nBlowing you a seductive kiss, " + this.flags[kFLAGS.GOO_NAME] + " purrs, \"<i>And how would you like to take me today, [Master]?  In my ass?  In my pussy?  Or do you want to fuck my mouth?</i>\"");
        ...
        if (this.player.cor < 33) this.outputText("Smiling");
        else if (this.player.cor < 66) this.outputText("Smiling knowingly");
        else this.outputText("Tired of her blather");
        ...
        if (this.player.biggestCockArea() < 80) this.outputText("easily encompassing your erection");
        else this.outputText("gleefully stretching into a mold of your erection as it passes into her core");
        ...
        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + "'s vibrant " + this.flags[kFLAGS.GOO_EYES] + " eyes look up at you as her cheeks hollow to provide suction.  You groan again, this time slowly pulling her head back.  As she withdraws, her slick black spit drips from your dick, though much of it gradually hardens into a reflective sheath for your tool.  You draw her off until only your " + this.player.cockHead() + " remains inside that suckling pleasure-hole.  Then, you slam her down, fucking her mouth");
        if (this.player.biggestCockArea() >= 10 && this.player.biggestCockArea() < 50) this.outputText(" and throat");
        else if (this.player.biggestCockArea() >= 50) this.outputText(", throat, and body");
        this.outputText(" with quick strokes.  Faster and faster you bounce her on your loins");
        if (this.player.biggestCockArea() >= 80) this.outputText(", amazed that she can take so much so easily");
        ...
        this.outputText("\n\nWith her looking at you like that, fuck... you're cumming!  You pull her lips tight into your abdominal " + this.player.skinFurScales() + " and release the boiling bliss within you.  Your jizz jumps out of you in thick ropes, as if it was seeking to escape all this time and just now found freedom.  " + this.flags[kFLAGS.GOO_NAME] + " smiles around your " + this.cockDescript(0) + " as it pumps its virile goo down her throat, and she grabs hold of your [butt] to press herself against you harder.");
        if (this.player.cumQ() >= 500) this.outputText("  Squirts of spooge run out of her nostrils after a particularly potent blast, but " + this.flags[kFLAGS.GOO_NAME] + " doesn't mind or even break her gaze.");
        if (this.player.cumQ() >= 1000) this.outputText("  Your copious spunk rounds her belly, but most of that liquid weight transfers to her tits, hips, and ass in moments.");
        if (this.player.cumQ() >= 4000) this.outputText("  That isn't enough to keep up with your potency.  A moment later, the corners of her mouth begin to ooze alabaster, squirting out with each pulse.  Poor girl.");
        this.outputText("  Once finished, you pull her off and leave her to pant for breath.");

        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " licks her lips and admires the latex sheath her spit has molded around [oneCock].  \"<i>One hole down, [Master].</i>\"  She holds up a hand, fingertips lengthening as they grow razor-sharp nails.  Those prickly claws press into your ");
        if (this.player.balls > 0) this.outputText("[sack]");
        else this.outputText("[cock biggest]");
        this.outputText(" without warning, and you hold very, very still.  They stroke you with immaculate, teasing care, somehow feeling good in spite of the traceries of red irritation they leave in their wake.  " + this.flags[kFLAGS.GOO_NAME] + " tickles them across your taint longingly before retracting them wistfully and asking, \"<i>Are you ready for my pussy?</i>\"");
        ...
        this.outputText("\n\nThe teases have the desired effect on you, and you yank her down on your " + this.cockDescript(0) + ".  Like her mouth and throat, her cunt quickly goes gooey once you get past her feminine lips.  Inside, she feels like a combination of warm gelatin and vagina, having all the flexibility and yielding nature of the former combined with the exquisitely textured interior of the latter.  The sensuous, smooth surface of " + this.flags[kFLAGS.GOO_NAME] + "'s ass rubs over your [hips] as her cunt swallows the entirety of your prick.  Tendrils of inescapable excitement worm their way up your spine, fed by your stiff manhood's orgasm-induced sensitivity.  They send you into what can only be described as a sexual frenzy.");
        this.outputText("\n\nYou grab " + this.flags[kFLAGS.GOO_NAME] + "'s hair and pull in between strokes, forcing her to arch her back and display her body in a more pleasing manner.  Smack, smack, smack...  Your [hips] clap against her, growing faster with every moment.  Your hapless fuck-partner whines from pain and excitement, gushing black wetness across your [legs] as she cums.  You spank her rounded bottom again, and as the ripples of your vibration massage your " + this.cockDescript(0) + ", you cum again.  Her slick snatch greedily devours the first few spurts your body can offer up.  It even massages your length from root to " + this.player.cockHead() + " to coax out more.");
        if (this.player.cumQ() >= 1000) this.outputText("  This quickly bloats her into a pregnant-looking state, and after her last injection, she has nowhere to metabolize it all.");
        if (this.player.cumQ() >= 2000) this.outputText("  You keep going until a torrent of alabaster seed is running out of her cunt around your cock.  Glorious.");
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] > 0) this.outputText("  The " + this.gooCock() + " below noisily fires inky loads into the dirt, where it's quickly absorbed.");

        this.outputText("\n\nStaggering back, you rest against a boulder.  In the process, your " + this.cockDescript(0) + " exits " + this.flags[kFLAGS.GOO_NAME] + "'s swelteringly sticky slit.  Webs of glittering black lube dangle from your tip to her entrance, mixed with spermy strands of semen.  Transfixed, you watch them break, one by one snapping back to the closest set of genitals.  A bubbly voice cheers, \"<i>That's number two!");
        if (this.player.cumQ() >= 1000) this.outputText("  And so messy!  I don't know if I can hold any more!");
        this.outputText("</i>\"  A hand that appears to be wearing a latex glove smears the juices that hang from " + this.flags[kFLAGS.GOO_NAME] + "'s mound up and through her crack, coating her asshole with your leftover sperm.");
        ...
        this.outputText("\n\n\"<i>Come on, [Master],</i>\" " + this.flags[kFLAGS.GOO_NAME] + " cheers, \"<i>I'm all ready for your cock... just put it in and I'll take all the cum you've got.</i>\"");
        ...
        if (this.player.cumQ() >= 1000) this.outputText("  Almost immediately, cream drips out around her ass and over your [legs].  She's just too full to take much more - your cum has nowhere to go but out!");
        ...
        this.outputText("\n\n" + this.flags[kFLAGS.GOO_NAME] + " slides off you, going flat on the ground and into a puddle ");
        if (this.player.cumQ() >= 1000) this.outputText("of mixed fluids");
        else this.outputText("of her own leftover sex-juice");
    ...
    private feedLatexySomeMilk(): void {
        this.clearOutput();
        this.outputText("You cup your hands under your milk-laden breasts and ask " + this.flags[kFLAGS.GOO_NAME] + " if she's hungry.");
        //{Not hungry}
        if (this.gooFluid() >= 66) this.outputText("  She shrugs, but gives you a little smile as she sidles closer to you. \"<i>No, but if you need to lighten your load... I'm your girl!</i>\"");
        //{Middling hungry}
        else if (this.gooFluid() >= 33) this.outputText("  She licks her lips in response to your offer, obviously ready for a taste of your delicious milk.");
        //{Really fucking hungry}
        else this.outputText("  Before you've even completed your offer, " + this.flags[kFLAGS.GOO_NAME] + " is on you like a moth to a flame, eagerly pulling at your clothes to try and free your teats.");
        this.outputText("\n\nYou lead " + this.flags[kFLAGS.GOO_NAME] + " off to a nearby rock, and pull yourself up to a sitting position.  With a smile, your latex girl curls up on your lap, her soft, smooth arms affectionately wrapped around your shoulders.  You spare a moment to brush her long, sleek hair, running your fingers through the smooth strands as your other hand works to strip off your [armor].  Eventually, you disrobe, your milky teats popping free of your garments, [nipples] stiffening in the cool air.  " + this.flags[kFLAGS.GOO_NAME] + " opens her mouth hungrily, but to your surprise, presses her lips to yours before she drinks, locking you in a long, loving kiss.  You return her affection, holding her tight against you, embracing the hungry goo before finally guiding her head down to your needy [chest].");
        this.outputText("\n\nA tiny gasp escapes your lips as " + this.flags[kFLAGS.GOO_NAME] + "'s cool, smooth lips brush against your stiff nipple, the tip of her tongue just brushing against your sensitive flesh.  You moan as her full ebony lips finally lock around your teat, her long fingers holding your full breast as the first little suckle brings a drop of milk from within you, depositing it squarely into " + this.flags[kFLAGS.GOO_NAME] + "'s waiting palate.  A moment later, a full stream is pouring forth from you, your latex goo's oral skill tapping deep into your lactic reserves.  You roll your head back and moan lustily as " + this.flags[kFLAGS.GOO_NAME] + " suckles eagerly from you, her cheeks bulging slightly between each swallow, struggling to keep up with the flood of breastmilk she's taking from you.");
        this.outputText("\n\n\"<i>Delicious,</i>\" " + this.flags[kFLAGS.GOO_NAME] + " says with a grin, popping off one of your teats to tend to the other, leaving thick trails of sable saliva connecting her lips to your nipple until you brush them away with your thumb, your finger caressing her chin and cheek.  She nuzzles your hand, a sound not unlike a purr escaping her lips before she slips down, rubbing her cheek against your other breast.  \"<i>Mmm, I love the taste,</i>\" she giggles girlishly, resting her head a moment on your chest.  \"<i>You're wonderful, [name].  So good.</i>\"");
        this.outputText("\n\nYou smile and ruffle " + this.flags[kFLAGS.GOO_NAME] + "'s hair, giving her a gentle nudge toward your other needy tit.  Rather than suckle, she plants a quick kiss right on the tip of your [nipple], sending a shiver of pleasure rolling through you.  Before you've recovered, " + this.flags[kFLAGS.GOO_NAME] + "'s attached herself to you, her hands wrapped tight around your breast as her tongue flicks across your teat, teasing the first droplets of milk from you.  As she urges your first drops into a proper stream of warm, wonderful milk, you curl your fingers through " + this.flags[kFLAGS.GOO_NAME] + "'s hair and pull her tight against you, gently arching your back so that her face is wholly buried in your milky bosom.  She giggles into your titflesh, her laugh letting tiny rivulets of milk trickle down her chin and onto her own massive bosom, the contrast of white smearing onto black catching your eye even as her ebony tongue swirls around your sensitive bud.");
        //{elseif PC has both}
        if (this.player.hasCock() && this.player.hasVagina()) this.outputText("\n\nAs she suckles, " + this.flags[kFLAGS.GOO_NAME] + "'s hands wander downward, her fingers brushing tantalizingly across your supple flesh until her smooth tips find your dual genitals.  One hand quickly wraps around your half-turgid shaft as the other plunges into your slick and eager fuckhole, both aroused and ready by the teasing and suckling you're getting.  " + this.flags[kFLAGS.GOO_NAME] + " moves her hands in unison, one drawing up to the crown of your [cock biggest] as the other plunges deep into your vaginal depths before both release, pulling down to the base or withdrawing to the tips before going again and again.");
        //{If PC has a cock}
        else if (this.player.hasCock()) {
            this.outputText("\n\nAs she suckles, " + this.flags[kFLAGS.GOO_NAME] + "'s hand wanders downward, her fingers brushing tantalizingly across your supple flesh until her smooth tips rub against the half-hard shaft of your [cock biggest].  You stifle a gasp as the latex girl wraps her fingers around your prick, needing only the slightest touch to get you nice and turgid.  She moves her hand in slow, languid motions, slowly drawing her unnaturally smooth hands up and down your shaft, from crown to base, giving gentle twists and squeezes in time with her suckling upon your teat.");
        }
        //{elseif PC has cunt}
        else if (this.player.hasVagina()) this.outputText("\n\nAs she suckles, " + this.flags[kFLAGS.GOO_NAME] + "'s hand wanders downward, her fingers brushing tantalizingly across your supple flesh until her smooth tips rub against the outer folds of your [vagina].  You only just stifle a gasp as her long fingers slip into your ready hole, already aroused and eager to fuck.  Her hand moves into you, feeling like an unnaturally flexible dildo as she pushes inches of latex into you, each thrust in time with a suckle of your teat.");
        //{elseif PC ain't got shit, captain}
        else this.outputText("\n\nAs she suckles, " + this.flags[kFLAGS.GOO_NAME] + "'s hands wander downward, her fingers brushing tantalizingly across your supple flesh until her smooth tips send a shiver up your spine, her knuckles running across your exposed [asshole] as she works her fingers into your [butt].  With no other genitalia on offer, you grit your teeth as " + this.flags[kFLAGS.GOO_NAME] + " slithers a smooth finger into your rectum, pushing into your ass with agonizing slowness, tiny thrusts in and out timed with her suckling from your teat.");
        //{Combine, next paragraph}
        this.outputText("\n\nUnder the latex girl's combined milking and sexual advances, you feel an orgasm rising deep in your gut.  You steel yourself, trying to hold out a moment longer as " + this.flags[kFLAGS.GOO_NAME] + " intensifies her assault, suckling every last drop from you as her fingers work wonders upon your ");
        if (this.player.gender == 3) this.outputText("double genitals");
        else if (this.player.hasCock()) this.outputText("cock");
        ...
        if (this.player.gender > 0) this.outputText("smearing her fingers with a liberal spattering of your cum");
        else this.outputText("your [ass] clamping down hard as her finger milks you from behind");
        this.outputText(".  Suddenly, your teat pops free of her mouth, a streak of milk still spraying until " + this.flags[kFLAGS.GOO_NAME] + " is liberally coated with your white orgasmic offering, laughing girlishly as she licks her fingers and brings her own breast to her mouth, trying to tongue off the milk splattered on her.");
