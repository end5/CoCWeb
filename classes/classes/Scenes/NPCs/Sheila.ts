...
export class Sheila extends Monster {
    ...
    private sheilaFrogPunch(): void {
        ...
        //Miss:
        else if (this.combatMiss() || this.combatFlexibility() || this.combatEvade() || this.combatMisdirect() || this.findStatusAffect(StatusAffects.Blind) >= 0) {
    ...
    private sheilaFlyingKick(): void {
        ...
        this.spe -= 60;
        //Miss:
        if (this.combatMiss() || this.combatFlexibility() || this.combatEvade() || this.combatMisdirect() || (this.findStatusAffect(StatusAffects.Blind) >= 0 && Sheila.rand(3) == 0)) {
    ...
    private suspiciousGlint(): void {
        ...
        //Hit:
            ...
            if (!this.player.hasCock()) this.outputText("burying her drooling tail inside you until it squirts");
            else this.outputText("riding your dick to the hilt");
    ...
    private tittyMonsterAttack(): void {
        ...
        if (this.game.sheilaScene.sheilaCorruption() < 20) this.outputText("  But with nothing there for her to work with, it's a lot like being teased by a dressmaker's mannequin.");
    ...
    private lickEmAndStickEm(): void {
        ...
        if (this.player.hasCock()) this.outputText("[oneCock] fucks Sheila to the base while her tail snakes around and penetrates your [vagOrAss]");
        else this.outputText("you take Sheila from behind by plunging her spaded tail into your [vagina] as she lies face-down on the ground with her ass pushed in the air");
        this.outputText(".");
        //results, no new pg
        //[(int check passed)
        //Miss:
    ...
    private demonSheilaAI(): void {
        ...
        if (this.findStatusAffect(StatusAffects.Counter) < 0) this.createStatusAffect(StatusAffects.Counter, 0, 0, 0, 0);
    ...
    public constructor() {
        ...
        // this.plural = false;
        this.createVagina(this.game.flags[kFLAGS.SHEILA_XP] <= 3 && !sheilaDemon, VAGINA_WETNESS_SLICK, VAGINA_LOOSENESS_NORMAL);
