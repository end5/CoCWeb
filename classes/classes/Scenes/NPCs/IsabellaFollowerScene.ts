...
Optional Morning Oral for small-membered males*/
    ...
    public isabellaFollower(): boolean {
        return this.flags[kFLAGS.ISABELLA_FOLLOWER_ACCEPTED] == 1 && this.flags[kFLAGS.ISABELLA_CAMP_DISABLED] == 0;
    ...
    public isabellaAffection(mod: number = 0): number {
        ...
        if (this.flags[kFLAGS.ISABELLA_AFFECTION] > 100) this.flags[kFLAGS.ISABELLA_AFFECTION] = 100;
        else if (this.flags[kFLAGS.ISABELLA_AFFECTION] < 0) this.flags[kFLAGS.ISABELLA_AFFECTION] = 0;
    ...
    public isabellaMoovesInGreeting(): void {
        ...
        if (this.flags[kFLAGS.ISABELLA_TIMES_OFFERED_FOLLOWER] == 0) {
            ...
            if (this.player.cor < 33) this.outputText("smile, and admit that you do enjoy the time you spend with her.", false);
            else if (this.player.cor < 66) this.outputText("grin and joke that she probably missed you more.", false);
            else this.outputText("smirk and wonder if you missed her or her magnificent body.", false);
            ...
            if (this.player.tallness < 80) this.outputText("crush around your head, smothering you in heavy, milk-filled breast flesh", false);
            else this.outputText("squeeze against your " + this.chestDesc() + ", the four hard nipples capping each milk-flooded breast pressing on your own.", false);
    ...
    public callForFollowerIsabella(): void {
        ...
        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_ISABELLA] == 0) {
            ...
            if (this.player.tallness < 72) this.outputText("picks you up in her arms and embraces you with a crushing hug, nearly burying you in her boobflesh before she lets you go.", false);
            else this.outputText("gives you a crushing hug, smashing her tits flat against your body.", false);
            this.outputText("  She says, \"<i>", false);
            if (this.isabellaAccent()) this.outputText("Hi " + this.player.short + "!  Vat do you need from Izabella?", false);
            else this.outputText("Hiya " + this.player.short + "!  Anything I can help you with?", false);
        ...
        if (this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] < 100) accent = this.isabellasAccentCoaching;
        var milk = undefined;
    ...
    private campIzzySexMenu(): void {
        ...
        if (this.izzyTentacleRapeBool() && this.player.lust >= 33) tentacle = this.tentacleBoneFollowerIzzy;
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.shortestCockLength() <= 9 && this.player.lust >= 33) getSucked = this.isabellaScene.izzyGivesSmallWangsFreeOral;
        }
        this.outputText("\n\n", false);
        this.outputText("You could get a drink of Isabella's delicious milk, straight from the tap.", false);
        if (tentacle != undefined) this.outputText("  Or you could take advantage of your numerous tentacles to show her a truly grand time.", false);
        if (getSucked != undefined) this.outputText("  Or you could have her suck you off now, since she seems quite taken with the size of your penis.", false);
        this.outputText("  There's always the opportunity to climb under her skirt and service her as well.", false);
        if (this.player.lust < 33) this.outputText("  <b>You aren't aroused enough to initiate sex.</b>", false);
    ...
    private isabellasAccentCoaching(): void {
        ...
        if (result < 12) {
            ...
            //(FAIL3) 
                ...
                else if (this.player.hasVagina()) this.outputText(", and you leave the lesson with wet panties.", false);
            ...
            if (this.temp == 0) this.outputText("You spend an hour going over Isabella's language and diction with her.  She seems to make a little progress with it, which makes her happy, but you feel that in the grand scheme of things, she could do better.", false);
            else this.outputText("You go over Isabella's word choice with her and try to correct her whenever she uses the wrong word or slips into her native tongue.  She seems to make a modicum of progress, yet the downward cast of her eyes shows just how much better she feels she could have done.", false);
            accentChange = 4 + IsabellaFollowerScene.rand(5);
        }
        else if (result <= 20) {
            this.temp = IsabellaFollowerScene.rand(2);
            if (this.temp == 0) this.outputText("You spend an hour trying to teach Isabella how to speak properly.  While she is often flustered by her mistakes, she makes notable improvements from this session.  By the time you two finish, she seems quite pleased with herself.", false);
            else if (this.temp == 1) this.outputText("You go over Isabella's word choice with her and try to correct her whenever she uses the wrong word or slips into her native tongue.  It takes some time, but you're happy to tell Isabella that she seems to be making significant progress.", false);
            accentChange = 8 + IsabellaFollowerScene.rand(8);
        }
        else {
            this.temp = IsabellaFollowerScene.rand(2);
            if (this.temp == 0) this.outputText("You sit down with Isabella to work on her language once again.  She gets quite involved in the lesson, and the cow-girl makes large strides toward lessening her accent.", false);
            else this.outputText("You go over Isabella's word choice with her in an effort to reduce her accent.  In short order, the cow-girl is looking at you with rapt, attentive eyes, hanging on to your every word as you help her disguise her tongue to match those she's surrounded by.", false);
            accentChange = 12 + IsabellaFollowerScene.rand(10);
        }
        if (this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] < 100 && this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] + accentChange >= 100)
        ...
        else if (this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] < 90 && this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] + accentChange >= 90)
        ...
        else if (this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] < 75 && this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] + accentChange >= 75)
        ...
        else if (this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] < 50 && this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] + accentChange >= 50)
        ...
        else if (this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] < 25 && this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] + accentChange >= 25)
        ...
        else if (this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] < 10 && this.flags[kFLAGS.ISABELLA_ACCENT_TRAINING_PERCENT] + accentChange >= 10)
    ...
    public isabellaMorningWakeupCall(): void {
        ...
        if (this.flags[kFLAGS.ISABELLA_MORNING_FELLATIO_COUNT] == 1) this.outputText("Isabella is fellating you!?", false);
        else this.outputText("Isabella is giving you one of her traditional good-morning blowjobs.", false);
        ...
        if (this.player.balls > 0) this.outputText(this.ballsDescriptLight() + " against her chin, the cum-bloated orbs bouncing and shuddering with your " + this.cockDescript(x) + " as release nears.", false);
        else {
        ...
        if (this.player.balls > 0) this.outputText("  Your balls clench tightly as they release your seed", false);
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() > 2) this.outputText("the rest of your " + this.multiCockDescriptLight(), false);
        ...
        if (this.player.cumQ() < 250) this.outputText("  She slurps it all down with a smile, giving you a happy wink as her throat swallows the last of your salty load.", false);
        else if (this.player.cumQ() < 500) this.outputText("  She swallows hard, but even with her talents, Isabella can't quite get it all down.  The cum-dribbling red-head gives you a wink as you finish, gathering the spooge with her fingers to swallow down the excess.", false);
        else {
        ...
        if (this.flags[kFLAGS.ISABELLA_MORNING_FELLATIO_COUNT] == 1) {
            if (this.isabellaAccent()) this.outputText("Mmm, your penis has such tasty treats for me.  Keep zat cock small enough for mein mouth and I vill be happy to tend to it every morning, ja?", false);
            else this.outputText("Mmm, your penis has such tasty treats for me.  Keep that cock small enough for my mouth and I'll be happy to tend to it every morning, okay?", false);
        }
        else if (this.player.cumQ() >= 500) {
            if (this.isabellaAccent()) this.outputText("Yum!  You cum so hard for momma Izabella, don't you?</i>\"  The sated cow-girl gives your " + this.cockDescript(x) + " an affectionate squeeze before murmuring, \"<i>So yummy...", false);
            else this.outputText("Yum!  You cum so hard for momma Isabella, don't you?</i>\"  The sated cow-girl gives your " + this.cockDescript(x) + " an affectionate squeeze before murmuring, \"<i>So yummy...", false);
        }
        else {
            if (this.isabellaAccent()) this.outputText("I hope you did not mind me getting zat snack...", false);
    ...
    private toggleIsabellasMorningWoodChopping(): void {
        ...
        if (this.flags[kFLAGS.ISABELLA_BLOWJOBS_DISABLED] == 0) {
            ...
            if (this.isabellaAccent()) this.outputText("Just let Isabella know if you change your mind, ja?</i>\"", false);
            else this.outputText("Just let me know if you change your mind, all right?</i>\"", false);
            ...
            if (this.player.cocks[this.player.shortestCockIndex()].cockLength > 9) {
                if (this.isabellaAccent()) this.outputText("I vill, but only once you shrink zat monster down.  I cannot handle somezing like zat!", false);
                else this.outputText("I will, but only once you shrink that monster down.  I can't handle something like that!", false);
            }
            else {
                if (this.isabellaAccent()) this.outputText("Of course; ve vouldn't vant you to be out zere battling demons unsated.  Who knows vat vould happen?", false);
                else this.outputText("Of course; we wouldn't want you to be out there battling demons unsated.  Who knows what would happen?", false);
            }
            this.outputText("</i>\"", false);
    ...
    private repeatGermanBratwurstInCamp(): void {
        ...
        if (this.flags[kFLAGS.ISABELLA_TIME_SINCE_LAST_HOTDOGGING] < 5 && this.flags[kFLAGS.ISABELLA_TIME_SINCE_LAST_HOTDOGGING] > 0) {
            if (this.isabellaAccent()) this.outputText("mumbles, \"<i>Already?  Did I not just take care of you?</i>\"  The blushing cow-girl teases, \"<i>Are you really zat horny, or do you just like mein heiny that much?", false);
            else this.outputText("mumbles, \"<i>Already?  Didn't I just take care of you?</i>\"  The blushing cow-girl teases, \"<i>Are you really that horny, or do you just like my heiny that much?", false);
        }
        else if (this.player.cockArea(x) > 38) {
            //If too big, use the biggest dick for hotdoggin!
            x = this.player.biggestCockIndex();
            if (this.isabellaAccent()) this.outputText("gasps, \"<i>Oh yes, I see.  It looks so pent up... a shame it is too big to get ze full treatment in mein caboose.  You vill still cum for mein cheeks though, ja?", false);
            else this.outputText("gasps, \"<i>Oh yes, I see.  It looks so pent up... a shame it's too big for you to get the full treatment in my caboose.  You'll still cum for my cheeks though, right?", false);
        }
        else {
            if (this.isabellaAccent()) this.outputText("gleefully muses, \"<i>Oooh, I see.  Of course I vill help you, " + this.player.short + "!</i>\"  She traces a finger around " + this.oMultiCockDesc() + "' outline and continues, \"<i>It vould be mein pleasure to squeeze it all out into mein caboose.  Zat is what you vant, nein?", false);
            else this.outputText("gleefully muses, \"<i>Oooh, I see.  Of course I'll help you, " + this.player.short + "!</i>\"  She traces a finger around " + this.oMultiCockDesc() + "' outline and continues, \"<i>It would be my pleasure to squeeze it all out into my caboose.  That is what you want, no?", false);
        }
        this.outputText("</i>\"\n\n", false);

        if (this.player.cor < 33) this.outputText("Coloring red, you sheepishly answer in the affirmative.", false);
        else if (this.player.cor < 66) this.outputText("Not seeing a reason to hide it, you admit as much.", false);
        else this.outputText("With a knowing twinkle in your eye, you agree with the busty woman's intuition, rocking your hips enticingly.  Her eyes glue to your manhood for a moment, before she remembers herself and meets your gaze.", false);
        ...
        if (this.player.cor < 33) this.outputText("feel the weight of shame settling over you", false);
        ...
        if (this.isabellaAccent()) this.outputText("Isabella crooks a finger at you and commands, \"<i>Come, sit down, but lean back so Isabella has plenty of room to vork at milking zis naughty ", false);
        else this.outputText("Isabella crooks a finger at you and commands, \"<i>Come, sit down, but lean back so I have plenty of room to work at milking this naughty ", false);
        ...
        if (this.isabellaAccent()) this.outputText("\"<i>So hot... Am I making you hot, " + this.player.short + "?  Is your cock twitching for me yet?  Aching and leaking and dribbling a mess all over itself, ja?</i>\"\n\n", false);
        else this.outputText("\"<i>So hot... Am I making you hot, " + this.player.short + "?  Is your cock twitching for me yet?  Aching and leaking and dribbling a mess all over itself?</i>\"\n\n", false);
        ...
        if (this.isabellaAccent()) this.outputText("\"<i>I said not yet.  Do you vant me to help you cum or not?</i>\"", false);
        else this.outputText("\"<i>I said not yet.  Do you want me to help you cum or not?</i>\"", false);
        ...
        if (this.isabellaAccent()) this.outputText("\"<i>Good " + this.player.mf("boy", "girl") + ".  Relax, Momma Isabella vill take care of you.</i>\"\n\n", false);
        else this.outputText("\"<i>Good " + this.player.mf("boy", "girl") + ".  Relax, Momma Isabella will take care of you.</i>\"\n\n", false);
        ...
        if (this.player.cockTotal() == 2) this.outputText("The other penis is shoved to the side, forgotten about as Isabella selects the lucky fuck-stick.  ", false);
        else if (this.player.cockTotal() > 2) this.outputText("The other penises are shoved aside, forgotten about as Isabella selects the lucky fuck-stick.  ", false);
        ...
        if (this.player.cockArea(x) <= 38) this.outputText(", though with your dick completely devoured by her big butt-cheeks, you may as well be.", false);
        ...
        if (this.player.cockArea(x) <= 38) {
            ...
            if (this.isabellaAccent()) this.outputText("Isabella roughly lifts up and tuts, \"<i>No, zat vill not do.</i>\"  ", false);
            else this.outputText("Isabella roughly lifts up and tuts, \"<i>No, that will not do.</i>\"  ", false);
            ...
            if (this.player.cumQ() >= 1000) {
                ...
                if (this.player.cumQ() >= 2000) this.outputText(", eventually growing to a pregnant-looking curve", false);
        ...
        //(Big dicks) 
            ...
            if (this.player.cocks[x].cockLength > 48) this.outputText("to as high as she can reach on the towering shaft's length", false);
            else this.outputText("to " + this.player.cockHead(x), false);
            ...
            if (this.player.cumQ() <= 200) this.outputText("  Her ass gets a nice glaze from your over-sized cock, though the cow-girl stands up just before you finish, letting the last spurt weakly drip on your belly.", false);
            else if (this.player.cumQ() <= 500) this.outputText("  Her ass is completely glazed by your over-sized cock's heavy cum-flow in short order, though she stands up off of you to let you spurt the last few drizzles on your own belly.", false);
            else {
    ...
    private izzyTentacleRapeBool(): boolean {
        ...
        while (counter < this.player.tentacleCocks() && this.temp > 0) {
            ...
            if (this.player.cocks[this.temp].cockType == CockTypesEnum.TENTACLE && this.player.cocks[this.temp].cockLength >= 24) {
                counter++;
            }
        }
    ...
    private tentacleBoneFollowerIzzy(): void {
        ...
        if (this.isabellaAccent()) this.outputText("Oh, mein Gott!  Zey... zey are... so hug- vait, vat, vat are you doing?", false);
        else this.outputText("My God!  They... they are... so hug- wait, what are you doing?", false);
        this.outputText("</i>\"\n\n", false);

        if (this.isabellaAccent()) this.outputText("Without a word, you adroitly guide your squirming bunch of tentacle peckers toward her body, slowly encircling her. In no time your " + this.cockDescript(t1) + " is already wrapping her supple waist, quickly followed by your " + this.cockDescript(t2) + "; using the combined strength of your inhumanly powerful pair of dick muscles, you lift her off the ground.  \"<i>Oh... you're a kinky boy, aren't you? Well, if that's what you want...</i>\"", false);
        else this.outputText("Without a word, you adroitly guide your squirming bunch of tentacle peckers toward her body, slowly encircling her. In no time your " + this.cockDescript(t1) + " is already wrapping her supple waist, quickly followed by your " + this.cockDescript(t2) + "; using the combined strength of your inhumanly powerful pair of dick muscles, you lift her off the ground.  \"<i>Oh... you are a kinky boy, ja?  Vell, if zat is vhat you vant...</i>\"", false);
        ...
        if (this.player.canFly() && this.player.str >= 90) {
            ...
            if (this.isabellaAccent()) this.outputText("But... but vait!  I'm going to fall- I'm going to...</i>\"\n\n", false);
            else this.outputText("But... but wait!  I'm going to fall- I'm going to...</i>\"\n\n", false);
        ...
        //[if demon tongue]
        if (this.player.tongueType == TONUGE_DEMONIC || this.player.tongueType == TONUGE_SNAKE || this.player.tongueType == TONUGE_DRACONIC) {
        ...
        if (t7 >= 0) {
            ...
            //[if 8th cock] - TITS 2
            if (t8 >= 0) this.outputText("  It is soon joined by your " + this.cockDescript(t8) + ", each prick taking care of a nipple, teasing the holes with shallow penetrations by her hard nubs, the pre-cum battling against the flow of milk in the opposite direction and stretching your urethra with a sensation that makes you shiver wildly.", false);
            this.outputText("  You keep man-, or dick-, handling her tits while the rest of your peckers viciously pound her; your ", false);
            if (t8 >= 0) this.outputText("pair of boob-fondling pricks almost tremble in rage, unable to find any hole left to fill. This only makes them tit-fuck her harder and faster.", false);
            else this.outputText("boob-fondling prick almost trembles in rage, unable to find any hole left to fill. This only makes it tit-fuck her harder and faster.", false);
            this.outputText("\n\n", false);
        }
        //[if 9th or 10th cock]
        if (t9 >= 0) {
            ...
            if (t10 >= 0) this.outputText("s are left with nothing to stuff, writhing in frustration.  You think it would be fair to put them to use: you wrap one around her wrists, binding her hands and immobilizing her to ease the penetration of the others, then run the tip across the unused parts of her body, and simply enjoy the caress of her delicate skin against your " + this.cockDescript(t9) + ", feeling her shiver under your fluid tentacle motion.  Your remaining " + this.cockDescript(t10) + " wraps around her face, squeezing her cheeks and pointing its tip toward her eyes, in order to make sure her every sense is saturated with cock.", false);
            else this.outputText(" is left with nothing to stuff, writhing in frustration.  You think it would be fair to put it to use: you wrap it around her wrists, binding her hands and immobilizing her to ease the penetration of the others, then run the tip across the unused parts of her body, and simply enjoy the caress of her delicate skin against your " + this.cockDescript(t9) + ", feeling her shiver under your fluid tentacle motion.", false);
            this.outputText("\n\n", false);
        }

        this.outputText("This thorough tentacle fuck has made you tired and ridiculously aroused.  Your ", false);
        if (this.player.canFly() && this.player.str >= 90) this.outputText("wings and your ", false);
        ...
        if (this.player.canFly() && this.player.str >= 90) this.outputText("you descend, setting your " + this.player.feet() + " on the soil again but still holding Isabella herself in the air; ", false);
        ...
        if (t5 >= 0) {
            ...
            if (this.player.cumQ() >= 1500) this.outputText(" until she looks 8 months pregnant", false);
        }
    ...
    public milktasticLacticLactation(): void {
        this.spriteSelect(31);
        this.outputText("", true);
        if (this.isabellaAccent()) this.outputText("\"<i>Ohh, mein milkers...</i>\"\n\n", false);
        else this.outputText("\"<i>Ohh, my milkers...</i>\"\n\n", false);
    ...
    private izzyMilkingMeinMilkersMya(): void {
        ...
        if (this.isabellaAccent()) this.outputText("Do you zink you could help me vis mein milkers?  Zere must be more zan a week's vorth stored up!</i>\"\n\n", false);
        else this.outputText("Do you think you could help me with my milkers?  There must be more than a week's worth stored up!</i>\"\n\n", false);
        ...
        if (this.isabellaAccent()) this.outputText("\"<i>Ohh, " + this.player.short + ", I had forgotten all about zose milkers vith all ze verk around camp!  Yes, let us go zere immediately!</i>\"\n\n", false);
    ...
    private izzyMilkingMeinMilkersMya2(): void {
        ...
        if (this.player.thickness <= 50) this.outputText("with creaking effort, initially calibrated to your slender form as it was", false);
        else this.outputText("startlingly quickly, being already set to your much weightier bulk", false);
        ...
        if (this.isabellaAccent()) this.outputText("\"<i>Oooh, mein udders... zey feel as zough zey vill pop already!</i>\"\n\n", false);
        else this.outputText("\"<i>Oooh, my udders... they feel as though they will pop already!</i>\"\n\n", false);
        ...
        if (this.isabellaAccent()) this.outputText("The warrioress nods emphatically.  \"<i>Ja, it vould help sooo much vith how busy I am now!  Is zis okay, " + this.player.short + "?  For me to visit once a day und relieve the pressure on mein milkers?</i>\"\n\n", false);
        else this.outputText("The warrioress nods emphatically.  \"<i>Yes, it would help sooo much with how busy I am now!  Is this okay, " + this.player.short + "?  For me to visit once a day and relieve the pressure on my milkers?</i>\"\n\n", false);

        this.outputText("You ", false);
        if (this.player.cor > 50) this.outputText("briefly consider forbidding her outright in order to see that exquisite look of pained pleasure on her face again, but you don't think she'd comply.", false);
        else this.outputText("don't really see a problem with it as long as she has some left to slake your thirst, but that's the question, isn't it?", false);
    ...
    private AllowIzzyMilkerUse(): void {
        ...
        if (this.player.hasCock()) this.outputText("(You have a hunch that you might be able to catch her using the milkers at the farm if you 'explore' there, provided she hasn't been recently milked.)\n\n");
    ...
    private getMilk(): void {
        ...
        if (this.flags[kFLAGS.ISABELLA_MILKED_YET] == -1) {
            if (this.isabellaAccent()) this.outputText("Isabella nods, and fetches you one of the spares from her latest milking session at the farm.  \"<i>Here you go!  Less zan twenty-four hours old, ja?</i>\"", false);
            else this.outputText("Isabella nods, and fetches you one of the spares from her latest milking session at the farm.  \"<i>Here you go!  Less than twenty-four hours old, okay?</i>\"\n\n", false);
        }
        else {
            ...
            if (this.isabellaAccent()) this.outputText("Ja, zat feels great... hurry and let out mein milk...</i>\"", false);
            else this.outputText("Ooh, that feels great... hurry and let out my milk...</i>\"", false);
    ...
    private isabellaSparMenu(): void {
        ...
        if (this.flags[kFLAGS.ISABELLA_SPARRING_INTRO] == 0) {
            ...
            if (this.isabellaAccent()) this.outputText("Zis vill be good for both of us, ya!?</i>\"  The beaming cow-girl taps a finger to her chin and suggests, \"<i>Ve should set up out on ze edges of the plains, so ve don't damage zis camp.</i>\"", false);
            else this.outputText("This ought to be good for both of us!</i>\"  The beaming cow-girl taps a finger to her chin and suggests, \"<i>Why don't we set up a faux camp on the edge of the plains, so we don't damage this one.  Okay?</i>\"", false);
    ...
    private sparring(type: number = 1): void {
        ...
        if (type == 1) this.outputText("  The knowledge that you're playing for keeps makes your heart beat faster.", false);
    ...
    private isabellaBurps(): void {
        ...
        if (this.flags[kFLAGS.ISABELLA_PROBOVA_BURP_COUNT] == 0) {
            ...
            if (this.isabellaAccent()) this.outputText("\"<i>Vell... nuzzing irreversible can happen, ja?</i>\"", false);
            else this.outputText("\"<i>Well... there's nothing we can't change back, right?</i>\"", false);
            this.outputText("\n\n", false);
    ...
    private runAwayFromIzzyBurps(): void {
        ...
        if (this.flags[kFLAGS.ISABELLA_PROBOVA_BURP_COUNT] == 0) {
            ...
            if (this.isabellaAccent()) this.outputText("Vat did you give me?  Zat was zimply embarrassing!", false);
    ...
    private getIzzyBurped(): void {
        ...
        if (this.flags[kFLAGS.ISABELLA_PROBOVA_BURP_COUNT] == 1) {
            ...
            if (this.player.lowerBody != LOWER_BODY_TYPE_HOOFED || this.player.horns <= 0 || this.player.hornType != HORNS_COW_MINOTAUR) {
            ...
            if (this.player.lowerBody != LOWER_BODY_TYPE_HOOFED) {
                ...
                if (this.player.isTaur()) this.outputText("  Confused, you quickly inspect yourself before your gaze settles on your hooves – or should you say, your SINGLE PAIR of hooves.  Triggered by what you surmise are the Pro Bova's fumes, your centaur body has vanished, leaving you with a single pair of cow-like hooves.", false);
                else this.outputText("  Confused, you quickly inspect yourself before your gaze settles on your " + this.player.feet() + " – or should you say, former " + this.player.feet() + ".  Triggered by what you surmise are the Pro Bova's fumes, your " + this.player.feet() + " have quickly and painlessly refashioned themselves into cloven hooves – not unlike those Isabella is currently sporting.", false);
                changed = true;
            }
            //[if no cow horns present]
            if (this.player.horns <= 0 || this.player.hornType != HORNS_COW_MINOTAUR) {
                if (this.player.horns > 0 && this.player.hornType > HORNS_NONE) this.outputText("  Your existing horns quiver, then reform into those of a " + this.player.mf("bull", "cow"), false);
                else this.outputText("  Two nubs sprout from your forehead, swiftly thickening and growing into a large pair of curved bovine horns", false);
            ...
            if (this.player.tailType != TAIL_TYPE_COW) {
                if (this.player.tailType > TAIL_TYPE_NONE) this.outputText("  The tip of your tail reshapes into a burst of fur, the entire length changing to match.", false);
                else this.outputText("  A tail creeps out of your " + this.player.armorName + ", perking up and growing rapidly.  A flare of fur bursts from the tip, the rest of the length changing to match.", false);
                changed = true;
            }
            ...
            if (this.player.hasCock() && this.player.longestCockLength() < 18) {
                ...
                if (this.player.balls < 0) this.outputText("  Two testicles fall into a scrotum near the base of your enlarged meat, already swelling into baseball-sized balls o' fun.", false);
                else if (this.player.ballSize < 4) this.outputText("  Your testicles engorge in the transformative powers of the cow-girl's violent reaction to the Pro Bova, growing to baseball-sized in short order.", false);
                changed = true;
            }
            ...
            if (changed && this.player.hasVagina() && this.player.race() != "cow-girl") {
                ...
                if (this.isabellaAccent()) {
                    if (this.player.tallness < 87) this.outputText("Now, if only ve could make you a bit taller, ve vould be twins!", false);
                    else if (this.player.tallness < 95) this.outputText("Und look at zat, you're as grown up as me!", false);
                    else this.outputText("Zough, of course, you do have me beat in ze height department!", false);
                }
                else {
                    if (this.player.tallness < 87) this.outputText("Now, if only we could make you a bit taller, we would be twins!", false);
                    else if (this.player.tallness < 95) this.outputText("And look at that, you're as grown up as me!", false);
                    else this.outputText("Though, of course, you do have me beat in the height department!", false);
                }
                this.outputText("</i>\"\n\n", false);
            }
            //[if male and player race not cowboy]
                ...
                this.outputText("  \"<i>", false);
                if (this.isabellaAccent()) this.outputText("Nein nein nein nein, zis von't do at all!", false);
                ...
                if (this.player.longestCockLength() < 18) {
                    if (this.isabellaAccent()) this.outputText("  \"<i>Zis did not have to be any bigger!  Vhat a tragedy! Your poor little wiener!</i>\"", false);
                    else this.outputText("  \"<i>This did not have to be any bigger!  What a tragedy! Your poor little wiener!</i>\"", false);
                    this.outputText("  You raise an eyebrow at her selective worry, indicating just how cow-like you've become.  ", false);
                    if (this.isabellaAccent()) this.outputText("\"<i>...Yah, zat is important too, but mein poor pussy...</i>\"", false);
                    else this.outputText("\"<i>I suppose that's important too, but what about my poor girl-parts?</i>\"", false);
                }
                this.outputText("\n\n", false);
            }
            //[if no changes occurred]
                ...
                if (this.isabellaAccent()) this.outputText("mein... gas... did not harm you any, ja?  Zat is good, right?</i>\"  You manage a weak smile and nod, more than a little relieved everything turned out well in the end.\n\n", false);
                else this.outputText("my... gas... didn't harm you any, did it?  That's good, right?</i>\"  You manage a weak smile and nod, more than a little relieved everything turned out well in the end.\n\n", false);
            }
            ...
            if (this.player.lowerBody != LOWER_BODY_TYPE_HOOFED || this.player.horns <= 0 || this.player.hornType != HORNS_COW_MINOTAUR || this.player.earType != EARS_COW || this.player.tailType != TAIL_TYPE_COW || (this.player.hasCock() && this.player.longestCockLength() < 18)) {
                this.outputText("You're not surprised when you take the now-familiar cow-" + this.player.mf("boy", "girl") + " form, ", false);
                if ((!this.player.hasCock() || IsabellaFollowerScene.rand(2) == 0) && this.player.hasVagina()) this.outputText("Isabella beaming with eagerness at your sloshing and swelling bosom.\n\n", false);
                else if (this.player.hasCock()) this.outputText("Isabella not able to keep a little frustration from her face as your dick grows to enviable size.\n\n", false);
            }
            //if all requirements already filled (already a busty cow-girl/well-endowed cowboy)
            else this.outputText("Predictably, her sweet-smelling fumes do nothing but further exacerbate your sex-drive, and from the look in her eyes, she's looking forward to it.\n\n", false);
    ...
    public receiveAllTheCowTOngues(): void {
        ...
        if (this.player.tallness <= 78) this.outputText("you are nearly absorbed by the great big mounds of Isabella's titflesh, sliding between her massive, milky mammaries.");
        else this.outputText("Isabella nuzzles at your neck, your massive frame nearly crushing her into the chair.");
        ...
        if (this.isabellaAccent()) this.outputText("\"<i>I hope you are not zinking about cumming yet, mein friend,</i>\" she chides, kneading your titflesh a little more gently. \"<i>Ve have not even gotten zu ze pussy-licking yet, after all...</i>\"");
        else this.outputText("\"<i>I hope you're not thinking about cumming yet, [name],</i>\" she chides, kneading your titflesh a little more gently. \"<i>We haven't even gotten to the good part yet...</i>\"");
        ...
        if (this.isabellaAccent()) this.outputText("\"<i>Time fur ze main course,</i>\"");
        else this.outputText("\"<i>Time for the main course,</i>\"");
        ...
        if (this.isabellaAccent()) this.outputText("\"<i>Ve vill have to teach you to be mindful vhere you leak!</i>\"");
        else this.outputText("\"<i>Looks like I'll have to teach you to watch where you leak!</i>\"");
        ...
        if (this.player.clitLength < 1) this.outputText(", your clit grinding into her nose,");
        ...
        if (this.isabellaAccent()) this.outputText("\"<i>Vell, how vas zhat, [name]?</i>\"");
        else this.outputText("\"<i>Well, what did you think?</i>\"");
    ...
    private fuckIsabella(): void {
        ...
        if (this.player.cocks[x].cockLength < 9) this.outputText("pulls your small [cockFit " + y + "] out of your armor, preparing to suck you off as normal.  You grab her shoulders to stop her, more interested in... giving back, this time.");
            ...
            if (this.isabellaAccent()) this.outputText("\"<i>I don't know about zhat... I'm more partial to ze cute little cocks... Zey fit me so vell...</i>\"");
            else this.outputText("\"<i>I don't know about that... You know I like 'em cute and tiny. They just fit me so well...</i>\"");
        }
        ...
        if (this.player.cocks[x].cockLength < 9) {
            ...
            if (this.player.tallness < 72) this.outputText(" to tower over your diminutive frame");
            this.outputText(".  ");
            if (this.isabellaAccent()) this.outputText("\"<i>Your tiny little cock ist zo cute, [name], I just couldn't zay no...</i>\"");
            else this.outputText("\"<i>You've got just the cutest little cock, [name]... how could I say no?</i>\"");
        }
        //{If cock bigger than she likes}
            ...
            if (this.isabellaAccent()) this.outputText("\"<i>I zuppose I could do vith some relief of mein own...  Very vell, [name].  Ve vill have zex, you und I.</i>\"");
            else this.outputText("\"<i>I guess I could do with some relief of my own...  Okay, [name], let's do it.</i>\"");
        }
        ...
        if (this.player.cockArea(x) < 50) this.outputText("utterly engulfing your length");
        else this.outputText("surrounding a fair amount of your massive shaft");
        ...
        //[(dick fitzwell)
        if (this.player.cockArea(x) < 80) this.outputText("Ordinarily tight, Isabella is practically soaked with lube, making the effort to cram your cock into her an easy task; soon your hips are pressed against her raised ass, her thick thighs wrapped around your body.  ");
        ...
        if (this.player.cumQ() <= 250) this.outputText("until you're utterly spent");
        else if (this.player.cumQ() <= 1000) this.outputText("until cum spurts out of her passage and stains her thighs");
        else this.outputText("until her belly begins to bloat with the sheer amount of cream you're stuffing into her");
        this.outputText(".\n\n");
    ...
    private fuckIsabellaInTheBarn(): void {
        ...
        this.outputText("\n\n");
        if (this.isabellaAccent()) this.outputText("\"<i>Ach, [name]?  Vhat do you think you are doing?  Sneaking up on people like zhat...</i>\"");
        else this.outputText("\"<i>Oh, [name]?  What do you think you're doing, huh?  Sneaking up on people like that...</i>\"");
        ...
        if (this.player.biggestTitSize() < 1) this.outputText("es");
        ...
        if (this.isabellaAccent()) this.outputText("  \"<i>I vhant it...  please, [name], do not tease me so...</i>\"");
        else this.outputText("  \"<i>Come on, [name], give it to me already...  enough with the teasing...</i>\"");
    ...
    private isabellaBarnFuckPartII(): void {
        ...
        if (this.player.cocks[this.player.smallestCockIndex()].cockLength < 9) {
            ...
            if (this.isabellaAccent()) this.outputText("\"<i>Mmm, zuch a nice fit,</i>\"");
            else this.outputText("\"<i>Mmm, that's a nice fit,</i>\"  Isabella sighs, her vaginal muscles gently caressing your shaft.");
        }
        //{If medium cock}
            ...
            if (this.isabellaAccent()) this.outputText("\"<i>Ach, so big</i>\"");
        ...
        //{If big fucking cock}
            ...
            if (this.isabellaAccent()) this.outputText("It iz sehr too big, zo huge?</i>\"");
            else this.outputText("God it's so huge, I... it's tearing me apart!</i>\"");
        }
        ...
        if (this.player.smallestCockArea() <= 164) this.outputText("in up to the hilt, smearing her wildly contracting walls with thick smears of leaking pre");
        else this.outputText("in until your [cock smallest] batters into her womb, thick globs of pre smearing her seed-catcher");
        ...
        if (this.isabellaAccent()) this.outputText("[name], zhat was...  ah, [name]");
        else this.outputText("Oh, wow, [name], that was...  that was incredible!");
        this.outputText("</i>\" Isabella gasps between ragged breaths.  \"<i>");
        if (this.isabellaAccent()) this.outputText("You really know how to please a voman, nein?");
        else this.outputText("You really know how to show a girl a good time, don't you?");
        this.outputText("</i>\"");
