...
export class SheilaScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    private sheilaPreg(reducedChance: boolean = false): void {
        ...
        if (SheilaScene.rand(100) <= chance)
            this.pregnancy.knockUpForce(PregnancyStore.PREGNANCY_PLAYER, PregnancyStore.INCUBATION_SHIELA);
    }

    public sheilaCorruption(arg: number = 0): number {
	/*if(flags[kFLAGS.SHEILA_CORRUPTION] + arg > 100) flags[kFLAGS.SHEILA_CORRUPTION] = 100;
	else*/ if (this.flags[kFLAGS.SHEILA_CORRUPTION] + arg < 0) this.flags[kFLAGS.SHEILA_CORRUPTION] = 0;
    ...
    public sheilaCup(): string {
        if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 10) return "tiny, almost-absent";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 20) return "A-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 30) return "B-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 40) return "C-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 50) return "D-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 60) return "DD-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 70) return "E-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 80) return "EE-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 90) return "front-running";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 100) return "FF-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 110) return "G-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 120) return "GG-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 130) return "H-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 140) return "HH-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 150) return "'Holy Honkin' Hooters!'-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 160) return "I 'want to squeeze them'-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 170) return "II-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 180) return "Jiggle-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 190) return "JJ-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 200) return "K-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 210) return "KK-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 220) return "L-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 230) return "'Ladylove'-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 240) return "M-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 250) return "'Mega Milk'-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 260) return "N-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 270) return "NN-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 280) return "O-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 290) return "'so big it makes you say' OO-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 300) return "P-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 310 && this.player.cocks.length > 0) return "'would feel great around your' PP-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 310 && this.player.cocks.length == 0) return "PP-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 320) return "Q-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 330) return "QQ-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 340) return "R-u-serious?-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 350) return "RR-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 360) return "S-rank";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 370) return "'Shooting Star'-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 380) return "T-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 390) return "'damn, those are some big' TT-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 400) return "'bigger than' U-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 410) return "UU-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 420) return "V-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 430) return "'Va-Va-Voom'-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 440) return "'War Head'-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 450) return "World-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 460) return "X-Buster-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 470) return "XXXX-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 480) return "'Yay'-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 490) return "YY-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 500) return "Z-Saber-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 510) return "ZZ-cup";
        else return "fuckin' magic";
    }

    public sheilaEncounterRouter(): void {
        trace("Sheila Encounter:");
        trace("Sheila Corruption: " + Math.round(this.sheilaCorruption() * 10) / 10 + " Sheila Preg: " + this.flags[kFLAGS.SHEILA_PREGNANCY_INCUBATION] + " Sheila XP: " + this.flags[kFLAGS.SHEILA_XP]);
        //UNFUCK FLAGS
        if (this.flags[kFLAGS.SHEILA_CLOCK] > 0)
            this.flags[kFLAGS.SHEILA_CLOCK] = 0
        if (this.sheilaCorruption() >= 100 && this.flags[kFLAGS.SHEILA_DEMON] == 0)
            this.flags[kFLAGS.SHEILA_DEMON] = 1;
        if (this.flags[kFLAGS.SHEILA_DEMON] == 1)
            this.flags[kFLAGS.SHEILA_XP] = 4;

        //ACTUALLY PICK ENCOUNTER!
        if (this.flags[kFLAGS.SHEILA_DEMON] == 0) {
            //PREG SHIT
            if (this.pregnancy.isPregnant && this.pregnancy.incubation == 0 && this.flags[kFLAGS.SHEILA_XP] >= -2) {
                if (this.flags[kFLAGS.SHEILA_JOEYS] == 0) this.normalSheilaPregNotifNumberOne();
                else this.normalSheilaPregNotifREPEATEDED();
                return;
            }
            if (this.flags[kFLAGS.SHEILA_XP] == 0) this.sheilaFirstEncounter();
            else if (this.flags[kFLAGS.SHEILA_XP] == -1) this.sheilaApology();
            //XP-2 Sheila's apology (sheila xp = -2 and demon sheila = 0):
            else if (this.flags[kFLAGS.SHEILA_XP] == -2) this.sheilaIsSorrySheRapedYou();
            //XP-3 or XP-4 She-mad (Sheila XP <= -3 and demon sheila = 0):
            else if (this.flags[kFLAGS.SHEILA_XP] == -3 || this.flags[kFLAGS.SHEILA_XP] == -4) this.sheilaReallyMad();
            //XP1: Reconciliation encounter (sheila xp = 1 and demon sheila = 0):
            else if (this.flags[kFLAGS.SHEILA_XP] == 1) this.sheilaReconcile();
            //XP2: Familiarizing (Sheila XP = 2; or Sheila XP = 3 AND time =/= 20:00 and demon sheila = 0):
            else if (this.flags[kFLAGS.SHEILA_XP] == 2 || (this.flags[kFLAGS.SHEILA_XP] == 3 && this.model.time.hours != 20)) this.sheilaGettingFamiliar();
            //XP3: Sexy Time (sheila xp = 3 AND time = 20:00 and demon sheila = 0):
            else if (this.flags[kFLAGS.SHEILA_XP] == 3 && this.model.time.hours == 20) this.sheilaXPThreeSexyTime();
        ...
        //DEMONS!
            ...
            if (this.pregnancy.isPregnant && this.pregnancy.incubation == 0) this.demonImpChildren();
            //Demon Sheila encounter (demon sheila = 1 and sheilapreg < 4)
            else this.demonSheilaEncounter();
    ...
    private sheilaCorruptionUpdate(): void {
        ...
        if (this.player.cor > 90) {
            ...
            //Big change, dump ten.
            if (this.player.cor - this.sheilaCorruption() >= 10) {
                this.dynStats("cor", -10);
                this.sheilaCorruption(10);
            }
            else {
                ...
                while (Math.round(this.player.cor) != Math.round(this.sheilaCorruption())) {
                    this.player.cor -= 1;
                    if (Math.round(this.player.cor) <= Math.round(this.sheilaCorruption())) {
                        break;
                    }
                    else this.sheilaCorruption(1);
                }
            ...
            //Big Change!
            if (this.sheilaCorruption() - this.player.cor >= 10) {
                this.dynStats("cor", 10);
                this.sheilaCorruption(-10);
            }
            else {
        ...
        if (this.flags[kFLAGS.SHEILA_DEMON] == 1) this.dynStats("cor", 1);
    }
    ...
    private sheila1ndEncLookCloserPtII(): void {
        ...
        //[(libido>=50)
        if (this.player.lib >= 50) this.outputText("  Noting you still checking out her body, she smirks and says, \"<i>Enjoying your lookie, then?  Up here, cobber,</i>\" causing you to snap your head up sheepishly.");
        this.outputText("  You nod at the strange woman and introduce yourself.");
        if (this.player.short != "Sheila") this.outputText("  \"<i>" + this.player.short + ", eh?  My mates just call me Sheila.  Bunch of jokers, the bastards.</i>\"");
        else this.outputText("  \"<i>You too, eh?  Sheila's what my mates call me for a nickname.  Don't suppose you got yours from a bunch of adolescent-minded wankers, though.</i>\"");
        ...
        //[(high demon score)
        if (this.player.demonScore() >= 4) this.outputText("  I mean, take a squizz at yourself.  It's like you're not even trying to hide it; I've seen imps that look more like normal people.");
        this.outputText("  Forget it.</i>\"  You deny the accusation, but she continues to glare at you.");
    ...
    private sheilaApology(): void {
        this.clearOutput();
        this.outputText("As you search the plains for god-knows-what, you catch your [leg] on something; a rustling in the brush below you is the only warning you get before a cleverly hidden snare closes on it!");
    ...
    private apologyAvoidSheila(): void {
        this.clearOutput();
        this.outputText("You shake your head at the leery girl, and tell her you'd be just as happy as she would if you never saw each other again.");
    ...
    private apologySheilaApology(): void {
        this.clearOutput();
        this.outputText("You scratch your " + this.player.skinFurScales() + " absently behind an ear, not sure how to broach the topic of reconciliation when you feel like she was the aggressor, but mumble something about being sorry things started off on the wrong foot.");
    ...
    private apologySheilaSlapSult(): void {
        this.clearOutput();
        this.outputText("You say nothing as she finishes with the snare and stands back up.");
        ...
        this.outputText("\n\n\"<i>Fuck you, arsehole!</i>\" she counters, breaking in.  \"<i>I'm not about to stand here and take a bollocking from some mullet who rolls up and expects everyone " + this.player.mf("he", "she") + " meets to fall over " + this.player.mf("his", "her") + " charming self like " + this.player.mf("he", "she") + "'s the storybook hero" + this.player.mf("", "ine") + "!  If you want a girl who'll be your soulmate at the word 'hello' you can go look for sloppy seconds from one of those goblin slags!</i>\"");
    ...
    private apologySheilaSayNothing(): void {
        this.clearOutput();
        this.outputText("You decide to keep your own counsel for now, folding your arms defensively and frowning.");
    ...
    private sheilaPologyFight(): void {
        this.clearOutput();
        this.outputText("Saying nothing, you raise your [weapon] and take a swing!  Sheila starts a bit and dodges just in time, then with a look of resignation, raises her fists as well.  \"<i>That'll be right, I guess.  For what it's worth, I really am sorry.</i>\"");
    ...
    private castArouseAndLeaveSheila(): void {
        this.clearOutput();
        this.outputText("You shake your head sadly.  \"<i>I'm sorry, I haven't the time right now.</i>\"");
    ...
    private castArouseAndLetHer(): void {
        this.clearOutput();
        this.outputText("As soon as you nod, the girl bounds to her feet and jumps you, driving you slightly downward in her ardor.");
    ...
    private sheilaReallyMad(): void {
        this.clearOutput();
        this.outputText("A rustle in the bush claims your attention, and you turn your head to see Sheila, standing up suddenly.  Her eyes narrow when she recognizes you, and she takes off running!");
        ...
        if (this.flags[kFLAGS.SHEILA_CORRUPTION] >= 90) this.outputText("It's so hard to remember myself anymore, and the taint you've put in my body goes crazy when you touch me.  Do you want me to get on my hands and knees?</i>\"  The woman lowers herself to the ground.  \"<i>I beg you.  ");
        this.outputText("Please, please leave me alone.");
        if (this.flags[kFLAGS.SHEILA_XP] == -3) this.outputText("  I know you... you're not as bad as the rest of the monsters out here, so... please.");
        this.outputText("</i>\"");
        //[Stand][Leave]
        this.menu();
    ...
    private sheilaReallyMadStandGround(): void {
        ...
        //[(normal mode)]
        if (!this.silly()) {
            this.outputText("You throw the animals behind you and fold your arms.");
            this.outputText("\n\nSheila shivers, then speaks.  \"<i>Alright, mate.  If that's the way it has to be.</i>\"  She raises her fists half-heartedly.");
        }
        //(silly mode)
        else {
            this.outputText("Throwing the bundle to the side dramatically, you call the name of your stand!  Sheila's eyes widen as your body surges with renewed energy, and she jumps back as a ghostly other self materializes next to you.");
    ...
    private sheilaReconcile(): void {
        this.clearOutput();
        this.outputText("\"<i>Oy, it's you,</i>\" sings out a voice behind you.  \"<i>Back again?</i>\"");
    ...
    private sheilaReconcileDunWanna(): void {
        this.clearOutput();
        this.outputText("Raising your hands in a palms-out gesture, you decline.  Sheila colors a bit, misinterpreting your reluctance.  \"<i>Hey, it's not like I'm cracking onto you or anything.  I was just looking for a reason to eat half a rabbit myself, is all.</i>\"");
    ...
    private sheilaReconcileKay2(): void {
        this.clearOutput();
        this.outputText("Soon enough you've got a firepit going in a small clearing.  \"<i>Ahh, classic bush theater,</i>\" Sheila says, admiring it.  The woman dextrously spits two liberated and skinned rabbit quarters on a long stick and twirls them over the lapping flame, and soon the air is full of the sizzle and pop of meat juices dripping on the hot stones and the simple tune your cook hums.  You stare at ");
        if (this.player.lib < 50) this.outputText("the beckoning hunks of meat");
        else this.outputText("her rising and falling breasts under the pretext of watching her work");
        this.outputText(", until she happens to look up and catch your eye.  \"<i>Sorry, no parsley,</i>\" she says, breaking into an obliviously happy smile.  Seems like her temperament preternaturally suits this lifestyle.");
        ...
        //[(pc is kangaroo)
        if (this.player.race() == "kangaroo-morph") this.outputText(" - except you, I suppose");
        this.outputText(".  We trade our goods in prearranged op shops and dead drops but avoid bringing outsiders into our own settlements, even when they're right corkers.</i>\"");
        ...
        //[(lib >50)]
        if (this.player.lib >= 50) this.outputText(" like yourself - I saw you perving -");
        this.outputText(" make us a little hornier, and evil buggers make us a bit more evil.  Our bodies tend to change on their own to reflect how tainted we are... which is as much as saying there are a sad lot among us who flirt with demonic energy to up our sizes to suit our egos.  But versus the sexual appetite and limitless rapacity of the demons themselves...?</i>\"");
    ...
    private sheilaGettingFamiliar(): void {
        this.clearOutput();
        this.outputText("\"<i>Hey, it's [name].</i>\"");
    ...
    private sheilaFriendlyNoQuestions(): void {
        this.clearOutput();
        this.outputText("You decide to hold your tongue and simply mimic her pose as best you can, relaxing on the grass.  The sun is hot but its angle not insistent here, thanks to the shelter from a broad tree nearby.  Its soft rays almost reduce you to sleep over the next forty-five minutes before your companion speaks, rousing you.");

        this.outputText("\n\n\"<i>Didn't take ya for a quiet " + this.player.mf("bloke", "sheila") + " when we met, [name]... but I find you peaceful company.</i>\"");
    ...
    private sheilaFriendlyComeHereOften(): void {
        this.clearOutput();
        this.outputText("You ask her why she enjoys being on the plains so much.");
    ...
    private sheilaFriendlyHerPeoples(): void {
        this.clearOutput();
        this.outputText("You lie down on the grass yourself, balance the parcel on your stomach, and ask about her people.");
        ...
        if (this.player.femininity < 35) this.outputText("  She looks absently at your crotch.");
        ...
        //(lib >=50)
            ...
            if (this.player.hasCock()) this.outputText(", and you raise the kids at home?  Or put them with a nanny");
            this.outputText("?</i>\"");

            this.outputText("\n\n\"<i>Yeah, I suppose that'll work");
            if (this.player.hasCock()) this.outputText(", and I'll turn the kids over to");
            this.outputText(" - no, I mean, ");
            if (!this.player.hasCock()) this.outputText("if I decide");
            else this.outputText("I'm not ready for");
            this.outputText(" - er... fuck <b>you!</b></i>\"  This last exclamation comes in response to your pealing laughter.  \"<i>Wanker!</i>\"");
    ...
    public sheilaXPThreeSexyTime(): void {
        this.clearOutput();
        this.outputText("You prowl through the twilit grasslands, lazily looking for anything interesting before the bleak, red moon brings on the night and its restrictions.  Nothing much catches your eye, except for a rounded shape cast in silhouette against the horizon.  Initially taking it for a rock, you're surprised when it shivers at the sound of your approach!  It unbends and raises a head, turning toward you and revealing the flushed face of the bush girl, Sheila.  Her eyes quickly change from terror to relief as they settle on you, and she cries out.  \"<i>[name]!  Oh thank god; please help me!</i>\"");
        this.outputText("\n\n\"<i>What's wrong?</i>\"");
    ...
    private sheilaXPThreeSexyTimeDitchHer(): void {
        this.clearOutput();
        this.outputText("You shake your head, pulling away from the woman and telling her she'll be fine.  \"<i>No!</i>\" she shrieks.  \"<i>You gotta help me!</i>\"");
    ...
    private sheilaXPThreeSexyTimeSex(): void {
        this.clearOutput();
        this.outputText("Sheila's eyes widen with your smile, and she pulls back from you.  \"<i>That's, um...</i>\"");
    ...
    private shielaXPThreeSexyTimePostSexStay(): void {
        this.clearOutput();
        this.flags[kFLAGS.SHEILA_XP] = 4;
        this.outputText("You grab her tail, provoking a curious, but not discouraging, look from the woman who was planning to spend the night alone.  \"<i>What is it, [name]?</i>\"");
    ...
    private shielaXPThreeSexyTimePostSexStayII(): void {
        this.clearOutput();
        //(has cockfit 32)
        if (this.player.hasCock() && this.player.cockThatFits(32) >= 0) {
            this.outputText("Her hand slips down to your groin and, overcoming its trepidation, grabs your [cockFit 32] and begins to pump languidly, slowly stimulating blood back into it.  \"<i>I don't know what's come over me,</i>\" she says, giggling.  \"<i>Maybe I'm just greedy, but... I want you again.</i>\"  She pushes you");
            //[(horse)]
            if (this.player.isTaur()) this.outputText(" and you playfully roll");
            this.outputText(" onto your back; Sheila slips her leg over you");
            if (this.player.isTaur()) this.outputText("r own");
            this.outputText(", positioning herself atop your crotch and guiding your tip to her pussy.  It pokes through the labia slightly, welcomed with warm wetness.  \"<i>Is... this ok, [name]?  Can I?</i>\"");
            ...
            //[(not horse)]
            if (!this.player.isTaur()) this.outputText(" just above one " + this.nippleDescript(0));
            else this.outputText(" on the thigh");
            this.outputText(".  \"<i>I'm gonna have to punish you for it, you dag.</i>\"  Excusing herself thusly, she sits up and begins to slide up and down your [cockFit 32].  ");
            //[(not horse)]
            if (!this.player.isTaur()) this.outputText("Your hands squeeze her hips almost of their own volition, helping her slam down with force, and her head rolls back on her neck.  ");
            this.outputText("Her ");
            //[(sheila corruption < 30)]
            if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 30) this.outputText("little breasts rise and fall with increasing frequency atop her ribcage as her pace picks up and her breaths come short and shallow.");
            else if (this.flags[kFLAGS.SHEILA_CORRUPTION] > 60) this.outputText("huge tits jiggle magnificently as she rocks, nearly slapping her in the face as she plunges down and then falling back into place with waves of rippling flesh.");
            else this.outputText("breasts quiver invitingly as she pumps your cock, but before you can think of grabbing one yourself, both of her hands are squeezing and caressing them, drawing sighs from the woman as she toys with her erect nipples.");
            ...
            //(horse)
            if (this.player.isTaur()) this.outputText("barrel");
            else this.outputText("chest");
            this.outputText(" in her soft hair - but her hips keep pumping, incredibly.  ");
            //(pc corr >= 90 or > sheila corruption)
            if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS.SHEILA_CORRUPTION]) {
                this.outputText("  The tight, rippling muscles of her pussy clamp down on you, nearly holding your cock in place as she tries to ride you still but only manages to jerk your dick up and down and squeeze pre-cum from it.  \"<i>S-so full,</i>\" Sheila groans, \"<i>did you just get bigger in me?</i>\"  Her lungs inflate as she sucks in her breath, and her hard nipples push into your " + this.player.skinFurScales() + ".");
            }
            else if (this.player.cor < this.flags[kFLAGS.SHEILA_CORRUPTION]) this.outputText("  Her pussy clamps down around you, the rippling muscles so tight that she wouldn't even be able to pump if it weren't for the hot river of juice you feel around your tool.  \"<i>A-ah,</i>\" Sheila groans, \"<i>you thrust too!  Rail me silly!</i>\"  She tries to push against you with her hands, to return herself to an upright position, but can barely pull her chest apart from you - her nipples just narrowly recede from the surface of your " + this.player.skinFurScales() + " as her efforts peak.");
            //(else if magically equal but < 90)
            else this.outputText("  Her pussy squirts and sucks alternately, trying to find purchase on your cock even as her pumping hips deny it; the sensation drives you wild.  \"<i>[name], your old fella is amazing...</i>\"");
            this.outputText("  Your dick twitches and swells, as if to fulfill her words, and your pelvis rocks into Sheila's as you begin to ejaculate.  \"<i>No... pull out, or you'll get me pregnant,</i>\" she cries, when ");
            //[(single cox)
            if (this.player.cockTotal() == 1) this.outputText("your dick twitches inside her");
            //(multicox)
            else this.outputText("she spies the first bead of pearly semen exiting");
            if (this.player.cockTotal() == 2) this.outputText(" your lonely, unused prick");
            if (this.player.cockTotal() > 2) this.outputText(" each of your lonely, unused pricks");
            this.outputText(".");
            ...
            //[(multi)]
            if (this.player.cockTotal() > 1) this.outputText(", to be joined shortly by a messy external eruption that covers her thighs and belly in blotches of gooey white");
            this.outputText(".");
            //[(big skeet)
            if (this.player.cumQ() >= 1000) this.outputText("  It rolls out of you in waves, packing Sheila's cunt until she fills to capacity and the excess is forced out, sliming your own crotch.");
        ...
        //(if no cockFit 32 and yes vag)
            ...
            //[(horse)]
            if (this.player.isTaur()) this.outputText("You turn around and straddle a leg, squatting to bring your [vagina] atop her crotch.  \"<i>Push up,</i>\" you order, and Sheila obeys eagerly, twisting her body to connect her excited pussy with yours.");
            //(else if naga)
            else if (this.player.isNaga()) this.outputText("You slide it under her and lift gently; Sheila plays along with a disquieted expression, rolling over and raising her pussy into the air, and you press your own against her butt as your tail slides between her legs.  \"<i>See, you just need to be more... flexible,</i>\" you quip.");
            //(else if not horse and not naga)
            else this.outputText("You straddle her legs with your own, pressing her pussy into yours; Sheila gasps as the hot flesh connects and you tentatively rock your hips, dragging your lower lips across.");
            ...
            //(sheila corruption > 30)
            if (this.sheilaCorruption() < 30) this.outputText(" even though they're small and humble");
            //(else sheila corruption > 60)
            else if (this.sheilaCorruption() > 60) this.outputText("; I worry that they're getting too mountainous");
            this.outputText(".</i>\"  A hand drifts up to her nipple, pinching it as her mouth hangs open.  She rolls it in her palm, then presses the breast against her ribcage, and her shiver of arousal transmits to you through");
            if (this.player.isNaga()) {
                this.outputText(" her taut buttcheek");
                this.outputText(".");
                ...
                this.outputText(" her heated, slippery vagina.");
            ...
            //[(naga) 
            if (this.player.isNaga()) this.outputText(" tail, drawing it up the hot opening and coiling it so you can return the warm, lube-slicked length for another pass even as you hump her butt.");
            else this.outputText(" cunt, grinding her like a sex toy in search of your own climax.");
            this.outputText("  \"<i>Do it!</i>\" you order, anxious to feel her pussy convulsing against you, anxious to feel your own squeezing her.  \"<i>Come with your lesbian lover!</i>\"");
            ...
            if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption()) {
                this.outputText("  Her vagina doesn't wait for romance, spasming and opening wide to try to suck you in, pulling at your ");
                if (this.player.isNaga()) this.outputText("scales");
                else this.outputText("pussy");
                this.outputText(" until you can take no more of the heat and come as well.");
                //[(naga)]
                if (this.player.isNaga()) this.outputText("  Her breasts swell in your hands as she sucks in her breath sharply, feeling your pussy drool its juice onto her ass.");
            }
            //(else if PC corr < sheila corruption)
            else if (this.player.cor < this.sheilaCorruption()) {
                this.outputText("  Her vagina doesn't wait for symbolism, dumping a wave of orgasm that splashes almost audibly against you.  Your pussy answers with your own climax, and begins wetting the woman underneath");
                if (this.player.isNaga()) this.outputText("; it feels like her breasts are pulling away from you as she tries to push her ass further into your quivering quim");
                this.outputText(".");
            }
            else {
                this.outputText("  Her vagina drools and spasms, not interested in gestures so much as release, and coats ");
                if (this.player.isNaga()) this.outputText("your tail");
                else this.outputText("your own");
                this.outputText(" with a fresh coat of her hot fluids which trigger the expected response from you.");
            }
            //(if cock)
            if (this.player.hasCock()) {
                this.outputText("  Your neglected ");
                if (this.player.cockTotal() == 1) this.outputText("prick quakes and spurts");
                else this.outputText("pricks quake and spurt");
                this.outputText(" weakly, drooling semen that pools on her skin.");
            }
            //[(not horse)
        ...
        //(else if no cockFit 32 and no vag)
            ...
            this.outputText("Her hand lowers to her crotch and slides her middle finger into her pussy.  \"<i>I don't know what's wrong with me,</i>\" Sheila says, nervously.  \"<i>I'm not even sure why I get hot when I think of you... you don't have anything I can use.</i>\"");

            this.outputText("\n\nYou smile at the admission");
            if (this.player.hasCock()) this.outputText(", stroking your oversized tool despite her dismissal");
            this.outputText(".  \"<i>But you do?</i>\"");
            ...
            if (this.player.hasCock()) {
                ...
                //(mans)
                if (!this.player.isTaur()) this.outputText("falls into your lap");
                //(horse)
                else this.outputText("drifts between your legs");
                this.outputText(", then crawls its way to your [cock].  She begins stroking it, torpidly at first, but with increasing excitement as a drop of pre-cum slides down and wets her palm.  \"<i>What's wrong, goblin girl?</i>\" you ask.  \"<i>Gotta get some sperm no matter what?</i>\"");

                this.outputText("Sheila winces as your probing fingers send a shudder through her.  \"<i>Shut up, you tosser,</i>\" she retorts, yanking on your dick slightly harder in her irritation.");
            }
            //(new PG)
            ...
            //[(pc corr >= 90 or > sheila corruption)]
            if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption()) this.outputText("  Her vagina heats up, squeezing your fingers so hard that you nearly can't pull out to rub her again, and you have a clear view of her breasts swelling up - arguable proof of your prowess, considering what she told you earlier.  Her people must be terrible at faking orgasm.");
            //(pc corr < sheila corruption)
            else if (this.player.cor < this.sheilaCorruption()) this.outputText("  Her vagina gushes with clear fluid, filling the bowl made by your hand with warmth, and you think you can see her breasts tightening up slightly as her back arches, though it's hard to be sure with how she's shaking.");
            else this.outputText("  Her pussy quivers around you, and you draw the fingers out and pop them into Sheila's mouth.  The woman sucks on them greedily, and you raise an eyebrow at her.  She blushes again, but it's evidently not the first time she's done the same thing!");
            ...
            if (this.player.hasCock()) {
                ...
                //[(big skeet)
                if (this.player.cumQ() > 1000) this.outputText("  Her mouth fills quickly, and she writhes in your grip, managing to turn her head.  \"<i>Oh god, no way!</i>\" she coughs, spitting up enough semen to coat her chin as your ongoing orgasm spatters against her cheek.");
                //[(mega skeet)
                if (this.player.cumQ() >= 2000) this.outputText("  Not satisfied with that alone, you turn her head the other way for your finish, ejaculating on the rest of her face and completing her gooey, white beard as she squirms.");
                //[(multicock)
                if (this.player.cockTotal() > 1) this.outputText("  The other strokes not coming from this cock do their part to decorate your lover as well, turning her hair into a slimy mess.");
                this.outputText("  She escapes from your hand as you spend yourself, leaning away and gagging up seed onto the dry grass.");
            }
            this.outputText("\n\nThe woman falls weakly backward");
            //(cock.length > 0)
            if (this.player.hasCock()) this.outputText(", her face still covered in globby white smears");
            this.outputText(".  \"<i>Fuck...</i>\" she groans.  \"<i>You're a jerk, [name].");
            //[(cock.length > 0)
            if (this.player.hasCock()) this.outputText("  I can't believe you called me a goblin, you arsehole.");
            this.outputText("</i>\"");

            this.outputText("\n\nYou ");
            //[(cock.length > 0)
            if (this.player.hasCock()) this.outputText("can't believe how much she acts like one sometimes... but you ");
            this.outputText("just laugh and tug her ear; she flicks it and pulls away from you, backhanding you softly in the gut.  \"<i>Knock it off!</i>\"");

            this.outputText("\n\n\"<i>Are you really so worried about it?</i>\" you ask.  No answer comes");
            //[(cock.length > 0)
            if (this.player.hasCock()) this.outputText(", even after Sheila finishes wiping her face clean and stares at you");
            this.outputText(", so you just content yourself with lying next to the woman for a while.");
            ...
            else this.dynStats("lus", this.player.lib / 4);
            this.sheilaCorruptionUpdate();
            /*
            if(player.cor > sheilaCorruption()) {
                dynStats("cor", -5);
        ...
        this.fatigue(-20);
        this.HPChange(this.player.maxHP() / 2, false);
    ...
    private sheilaXPThreeSexyTimeGuardDuty(): void {
        this.clearOutput();
        this.outputText("You fold your arms and frown at Sheila, but consent to help.  She brightens, then looks confused when you make no further motion.  \"<i>So...</i>\" she begins, \"<i>what should I do?</i>\"");
        ...
        //[(PC level >=8)
        if (this.player.level >= 8) this.outputText(" - which, you suppose, must include imps even though they're so far beneath you they might as well be underground");
        this.outputText(".  You stand there for so long that you nearly slip into a daydream, and are only roused by the noise of a leather belt being carefully unfastened.  Focused again, you can hear Sheila's ragged breathing and her thighs rubbing together, then a hand sliding against skin and fabric... seems like she's made her decision.");
        ...
        //(else lib >= 40)
            ...
            //[(cock.length > 0)
            if (this.player.hasCock()) this.outputText("shift your pelvis forward");
            //(cock.length == 0)
            else this.outputText("stick out your tongue playfully");
            this.outputText(".  The girl giggles at that, relaxing and finally letting herself get into the masturbation.");
    ...
    private fuckBuddySheilaMeetingMaybeLater(): void {
        this.clearOutput();
        this.outputText("You tell her you haven't the time right now, but squeeze her knee as you get up again.");
    ...
    private fuckBuddySheilaMeetingJustHangOut(): void {
        this.clearOutput();
        this.outputText("In answer, you reach down to pinch her butt and then ");
        //[(not horse or drider)
        if (!this.player.isTaur() && !this.player.isDrider()) this.outputText("scoot your own forward");
        else this.outputText("fold your legs under you");
        this.outputText(" to lay in the bush's shade.");
    ...
    private fuckBuddySheilaMeetingChat(): void {
        this.clearOutput();
        this.outputText("\"<i>Feeling talkative?</i>\" Sheila asks.  \"<i>Have at yer.</i>\"");
    ...
    private fuckBuddySheilaMeetingChatFamilyAndFriends(): void {
        this.clearOutput();
        this.outputText("\"<i>Them?  They're doing fine.</i>\"  Sheila stares at you obtusely, trying to will you into changing the subject; you stare right back.  She sighs.  \"<i>No go, huh?</i>\"");
    ...
    private fuckBuddySheilaMeetingChatOldLoves(): void {
        this.clearOutput();
        this.outputText("\"<i>[name], I don't want to talk about that,</i>\" Sheila says, \"<i>it leaves a bad taste in my mouth.</i>\"");

        this.outputText("\n\nYou offer to tell her about your own history, as an enticement, but she shakes her head.  \"<i>I don't want to talk about that either!  Look, no matter how cosmopolitan, nobody really wants to hear about the dicks " + this.player.mf("his", "her") + " girl's had growing out of her face.  I mean, how many is the right answer?</i>\"");
        ...
        if (this.player.lib < 50) {
            ...
            this.outputText("\n\nThe woman colors a bit and looks down.  \"<i>Er...</i>\" she mumbles, \"<i>it means you're great, [name].  Top shelf.  My favorite " + this.player.mf("bloke", "sheila") + ".</i>\"");
        ...
        //(else lib >=50)
            ...
            if (this.player.cor >= 60) this.outputText(" - though it's probably meant to be a defensive gesture, all it does is push her tits together under her white shirt and frame them in light-brown skin");
            this.outputText(".  \"<i>[name], you horny whacker, I'm not gonna marry you.  Having to bull my way through a horde of monsters to see you and stand watch in shifts just to sleep together at night may be romantic once, but it's no kind of thing to do every day for the rest of my life.</i>\"");
            ...
            //[(corr < 30)
            if (this.player.cor < 30) this.outputText("; you lay a hand on her shoulder reassuringly");
            this.outputText(".  Eventually she pulls away again, nose slightly red.  \"<i>Sorry, mate; didn't mean to have a tantrum on you.</i>\"");
    ...
    private fuckBuddySheilaMeetingChatWhyHide(): void {
        ...
        //(if T'A)
        if (this.player.statusAffectv1(StatusAffects.TelAdre) >= 1) {
            this.outputText("  After all, the city in the desert seems to be bustling and bristling with weapons to resist the demons, whatever her feelings may be about it.");
    ...
    private fuckBuddySheilaMeetingChatLiveWithMe(): void {
        this.clearOutput();
        this.outputText("You ask Sheila to move in with you at your camp, and she turns bright red.");
    ...
    private fuckBuddySheilaMeetingChatKids(): void {
        this.clearOutput();
        //if joeycount = 1
        if (this.flags[kFLAGS.SHEILA_JOEYS] == 1) {
            this.outputText("\"<i>Ah?</i>\" Sheila says, turning toward you sheepishly.");
            ...
            if (this.player.femininity > 50) {
                this.outputText("I don't know how he'll react when he sees a pretty face like yours, though; he doesn't know that I'm-");
                //[(PC is herm, fem)
                ...
                this.outputText(" you guess, teasing her as her blush deepens.");
                this.outputText("\n\n\"<i>[name], stop it.</i>\"");
            }
            //else if PC masculine or andro, no new PG)
            else {
                this.outputText("I'm not sure if he intends to shake your hand or punch you, though.</i>\"");
                //[(PC is male or neuter)]
                if (this.player.gender <= 1) this.outputText("\n\n\"<i>Sounds... protective.</i>\"");
        ...
        //if 1 < joeycount < 10
        else if (this.flags[kFLAGS.SHEILA_JOEYS] < 10) {
            this.outputText("\"<i>So how are the kids?</i>\"");
            ...
            if (this.player.lib > 50) this.outputText(" and tight, hot cunt");
            this.outputText(" so well...  \"<i>How long does it take them to grow up?</i>\"");
            ...
            this.outputText("\n\nSheila laughs.  \"<i>No, mate; much older than that.  I'm not going to tell you how much, though.</i>\"  Her eyes narrow in mock suspicion, and she smiles broadly.  \"<i>A " + this.player.mf("gentleman", "lady") + " doesn't ask a");
            if (this.player.gender >= 3) this.outputText("nother");
            this.outputText(" lady's age, after all.</i>\"");

            //[(lib >=50)
            if (this.player.lib >= 50) {
                this.outputText("\n\n\"<i>But I'm no " + this.player.mf("gentleman", "lady") + ",</i>\" you retort, leaning in to tickle her ear with your words.  \"<i>Though, I was only asking because your skin is so smooth and your nipples so perky...</i>\"  You nip at her lobe.  \"<i>And your pussy still squeezes like it's your first time.</i>\"");
        ...
        //if joeycount >= 10
            ...
            this.outputText("\"<i>Kids doing all right?</i>\"");
            ...
            if (this.player.lib < 50) {
                ...
                //[(silly)]
                if (this.silly()) {
                    this.outputText(" and clutching the life-sized [name] bodypillow I made");
                    this.outputText(".  But it's not going to happen right now.</i>\"");
                ...
                if (this.player.cor < 40) this.dynStats("cor", -1);
            }
            //(else lib >=50)
            else {
    ...
    private fuckBuddySheilaMeetingChatKidsRest4Now(): void {
        this.clearOutput();
        this.outputText("\"<i>Always,</i>\" you answer, \"<i>but if you need to relax and sleep for a bit, I'm here for that too.</i>\"  You draw your hand back out, patting her on the cheek.");

        this.outputText("\n\nSheila kisses you on the forehead and then lays her head against your ");
        if (this.player.isTaur()) this.outputText("back");
        else this.outputText("lap");
        this.outputText(".  \"<i>You're sweet... thank you.  I will take you up on both of those offers - but maybe just the nap this arvo.  Would you wake me up in about an hour?</i>\"");
    ...
    private sheilaXP4Sex(display: boolean = false): void {
        if (display) {
            this.clearOutput();
            this.outputText("You slip an arm around the bushranger and lean in.  \"<i>I was thinking we could have some sex... feel up to it?</i>\"");
    ...
    private consensualSheila69(cock: boolean = true): void {
        ...
        if (cock) {
            if (this.player.cockThatFits(32) >= 0) {
                this.outputText("  Though, she smiles openly when you produce your [cockFit 32].");
                ...
                this.outputText(" as she rubs her small, smooth labia vigorously.  \"<i>What do you expect me to do with one of those?</i>\"");
            }
        }
        //(vag)
        else {
            this.outputText("  When you finally drop your bottoms, revealing your wet " + this.vaginaDescript(0) + ", she smiles softly.");
            ...
            if (this.player.clitLength > 8) this.outputText(" and bring your " + this.clitDescript() + " to its erect state.  \"<i>... And quite a stem,</i>\" your lover concludes.  \"<i>You sure that's not a dick?</i>\"");
            else this.outputText(", producing a slight sigh and a wet finger.  \"<i>And I'm the eager one, right?</i>\" your lover asks, wryly - though her finger is just as wet.");
        }
        ...
        if (cock && this.player.cockThatFits(32) < 0) this.outputText("  \"<i>[name], I'm telling you it won't fit!</i>\"");
        else this.outputText("  \"<i>Not talking, then?  Please yourself.</i>\"");
        this.outputText("  Her commentary cuts off as you ");
        if (!this.player.isTaur()) this.outputText("turn around and hang your ");
        else this.outputText("straddle her and squat down to dangle your ");
        if (cock) this.outputText("pre-seeping shaft");
        else this.outputText("wet pussy");
        this.outputText(" over her head, waggling it provocatively as you slip your fingers into her.");

        this.outputText("\n\n\"<i>Ah... ah... you could have just told me,</i>\" Sheila gasps, ");
        //[(cox)
        if (cock) {
            this.outputText("wrapping a hand around your shaft");
            //(big) 
            if (this.player.cockThatFits(32) < 0) this.outputText(" and guiding it to bend comfortably against her chest, drooling a trail of pre-cum as she slides it into position");
            this.outputText(".");
        }
        //(vag)
        else this.outputText("returning the favor and plunging into your " + this.vaginaDescript(0) + " with her hand.");
        this.outputText("  She pumps you once, eliciting a trickle of fluid, and then speaks once more.  \"<i>Bring it lower...</i>\"");

        this.outputText("\n\nYou oblige, ");
        if (!this.player.isTaur()) this.outputText("flattening your back");
        else this.outputText("squatting lower");
        this.outputText(" so your ");
        if (cock) {
            this.outputText("cock sinks down");
            //[(small cock) 
            if (this.player.cockThatFits(32) >= 0) this.outputText(" into her warm, waiting mouth");
            else this.outputText("; she lets go of it to grab her breasts instead, trying to push them around the sensitive shaft as she runs her tongue up the underside");
            this.outputText(".");
        }
        else {
            this.outputText("pussy dangles just over her face; she ");
            if (this.player.clitLength > 8) this.outputText("nips and sucks at the tip of your clit, rolling it with her tongue");
            else this.outputText("parts your labia with her tongue, stroking them gently and tickling your little clitoris");
            this.outputText(".");
        }
        this.outputText("  Not to be outdone in creativity, technique, or audacity, you ");
        if (!this.player.isTaur()) this.outputText("lean down and bury your own tongue all the way inside Sheila, forcing her labia open with your mouth");
        else this.outputText("reach as far as you can to bring both hands into play, stroking and pulling Sheila's labia apart with one as you tease her exposed clitoris or slip inside her vagina with the other");
        this.outputText("; your lover stops licking and you can feel her mouth slip away from your sensitive skin as her head rolls back.");
        ...
        //[(ladyparts)
        if (!cock) {
            this.outputText("slipping her tongue back into you");
            //[(bigclit)
            if (this.player.clitLength > 8) this.outputText(" and stroking your " + this.clitDescript() + " rapidly with one hand");
            this.outputText(".");
        }
        //(smallcox)
        else if (this.player.cockThatFits(32) >= 0) this.outputText("taking you into her mouth once again and licking away a neglected drop of pre-cum.");
        else this.outputText("stroking your cock with one hand as she pushes an erect nipple against its side to trace a line.");
        ...
        if (!this.player.isTaur()) {
            ...
            if (cock && this.player.cockThatFits(32) < 0) this.outputText("shaking, teasing nipples and heaving chest");
            else this.outputText("mouth, humming in delight");
            this.outputText(".");
        }
        //(horse)
        else {
            ...
            if (cock && this.player.cockThatFits(32) < 0) this.outputText("hard nipples");
            else this.outputText("throat");
            this.outputText(".");
        }
        //merge horse with rider
        //[(big cox)
        if (cock && this.player.cockThatFits(32) < 0) this.outputText("\n\n\"<i>[name]!  I'm coming!</i>\" Sheila cries.");
        else this.outputText("\n\n\"<i>Mmmh!  Mm mmnnn!</i>\" Sheila moans, muffled by your body.  The import doesn't hit you until a second later.");
        this.outputText("  Her vagina convulses, ");
        //(pc corr >= 90 or > sheila corruption
        if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS.SHEILA_CORRUPTION]) {
            this.outputText("trying to pull your ");
            if (!this.player.isTaur()) this.outputText("tongue");
            else this.outputText("fingers");
            this.outputText(" in ravenously.  You can literally feel her internal muscles rippling and undulating, stroking you as if they could coax out an ejaculation.  Sheila sucks in her breath as she climaxes, filling her chest; you can feel her tits pushing harder and harder against you.");
        }
        //(PC corr < sheila corruption)
        else if (this.player.cor < this.flags[kFLAGS.SHEILA_CORRUPTION]) {
            this.outputText("pushing out a gush of fluid.  For what seems like several minutes, her pussy deluges your ");
            if (!this.player.isTaur()) this.outputText("mouth, filling you with her taste.");
            else this.outputText("hands, completely soaking them in her orgasm.");
            this.outputText("   Her thighs tense, forcing her pelvis into the air and her cunt toward you as her chest slumps; slowly, you feel the perky nipples pressing into your stomach pull away.");
        }
        //(else if equal but below 90)
        else if (this.player.cor == this.flags[kFLAGS.SHEILA_CORRUPTION] && this.player.cor < 90) {
            this.outputText("drooling a trickle of fluid and licking at you as she screams her ecstasy into your crotch.");
        }
        this.outputText("  Sheila jams her face upward, ");
        //[(big cox)
        if (cock && this.player.cockThatFits(32) < 0) this.outputText("pressing her lips and tongue to the base of your shaft as she masturbates it vigorously.");
        ///(small cox)
        else if (cock) this.outputText("sinking your [cockHeadFit 32] into the warm recesses of her throat where her muscles caress and coax it.");
        else this.outputText("penetrating you deeply with her tongue as her hands reach up to stroke your clit furiously.");
        this.outputText("  Your body gives up under her frenzied assault, laying your crotch onto the woman's face as muscle control abandons you.");
        ...
        if (cock) {
            ...
            //[(cock fits)
            if (this.player.cockThatFits(32) >= 0) {
                this.outputText("pouring out into your lover's waiting throat.  She gags and you can feel the gooey seed oozing back against your [cockHeadFit 32]");
                //[(small cum)
                if (this.player.cumQ() < 250) this.outputText("; you withdraw from her, allowing her throat to force your ejaculate back up and over her lips and cheeks with a splutter.");
                //(big cum)
                else if (this.player.cumQ() < 2000) this.outputText(", but your relentless orgasm forces it down again, dumping more jism into her throat.  You can feel her hands clawing at your [butt] as you relieve your buildup.");
                //[(mega cum)
                else this.outputText(".  Soon, her visibly-rounding stomach fills and the tip of your dick is once again washed in backflow; the next spurts force the cum all the way up, and she begins drooling the slimy semen-saliva blend from her mouth and nose, hands all the more frantic in her alarm.");
            }
            //(else doesn't fit)
            else {
                this.outputText(" squirting onto and between your intertwined bodies to soak your [chest] and neck, and Sheila's softly pumping crotch.");
                //(big skeet)
                if (this.player.cumQ() > 1000) this.outputText("  A wellspring of seed, your body continues producing until the fuzz on her thighs and tail is completely matted down with the whiteness drooling between you.");
                //(multicocks)
                if (this.player.cockTotal() > 1) {
                    this.outputText("  Your other cock");
                    if (this.player.cockTotal() == 2) this.outputText(" spasms");
                    else this.outputText("s spasm");
                    this.outputText(" as well, adding their own issue to the unholy mess covering the poor woman.");
                }
            }
        }
        //(else if vag-focus)
            ...
            if (this.player.wetness() <= 2) this.outputText("trickle out, and are quickly sucked up by her greedy mouth");
            else if (this.player.wetness() <= 4) this.outputText("gush freely, leaving her face slick");
            else this.outputText("overflow, soaking her hair even as she shuts her eyes tight against the cataract");
        ...
        //[(smallcox)
        if (cock && this.player.cockThatFits(32) >= 0) this.outputText(", pulling free of her throat.  She immediately turns over as well and forces herself to her hands and knees, then gags and coughs up a large amount of your jism.  When she's dumped enough to clear her passageway, she collapses forward, smearing the mess onto her chest as she spends a few minutes to catch her breath.  Once she's got it, she turns back over and sits up, strands of your slime linking her breasts to the grass.");
        //(else not smallcox)
        else this.outputText(".  She sits up, wiping sweat and stray fluids away from her eyes.");
        ...
        else if ((this.player.cor > 90 || this.player.cor > this.sheilaCorruption()) && this.sheilaCorruption() >= 80 && this.flags[kFLAGS.SHEILA_XP] != 3) {
            this.sheilaCorruptionUpdate();
        ...
        if (cock && this.player.balls > 0) {
            this.outputText("What you see manages to pull an explosive laugh from you, tired as you are.  Sheila gives you the stink-eye until you've recovered enough to explain the source of your mirth: on her forehead, making a perfect ");
            if (this.player.balls == 2) this.outputText("infinity");
            else this.outputText("double infinity");
            this.outputText(" shape against the rest of her skin, is an imprint of your " + this.ballsDescriptLight() + ".  The kangaroo girl rolls her eyes at the juvenile display and resumes her harangue.  ");
        }
        this.outputText("\"<i>You could give a girl a bloody warning before that sort of behavior.  I thought you were going to kill me!</i>\"");
        ...
        //[(sheila xp = 3)
        if (this.flags[kFLAGS.SHEILA_XP] == 3) {
            this.outputText("\"<i>[name]... thanks.  Even being covered in your mess is better than being stuck outside all night, too scared to touch myself and too horny to run.</i>\"  Sheila kisses you on the cheek.  \"<i>My sloppy hero, eh?  I'm okay now; I can make it 'til morning when the gate reopens.</i>\"");
        ...
        //(else if sheila xp =/= 3)
            ...
            this.outputText("\"<i>Forget it.  With the way you worked me, I forgive you.  Just be careful, you wanker.</i>\"  Sheila closes her eyes and pulls your arm around her shoulder");
    ...
    private consentacleVagSexForKangarooSlutBitches(): void {
        ...
        if (this.sheilaCorruption() <= 30) this.outputText("pert");
        else this.outputText("jiggly");
        this.outputText(" breasts as she fiddles with your own clothing.  She manages to remove the top of your [armor], exposing your [chest]; she then returns your favor by ");
        if (!this.player.hasFuckableNipples()) this.outputText("squeezing and fondling");
        else this.outputText("plunging two fingers into");
        this.outputText(" your own " + this.nippleDescript(0) + "s.  You shiver as she paws at the sensitive nubs on your chest, but don't let up your assault, moving your mouth down to tickle one of hers with your teeth and tongue.  Soon she's quaking and twitching beneath your ministrations; rubbing at her crotch with one hand as she half-heartedly tries to tease you back with the other.");
        ...
        //[(if wangaroo)
        if (this.player.cocks[this.player.cockThatFits(32)].cockType == CockTypesEnum.KANGAROO) this.outputText("tapered, fleshy penis.  \"<i>Wow... you never see those.</i>\"");
        else this.outputText(this.multiCockDescriptLight() + ".");
        ...
        this.outputText("\n\nYou grin.  ");
        //[(no centaur)
        if (!this.player.isTaur()) this.outputText("Taking hold of your " + this.cockDescript(x));
        //(centard)
        else this.outputText("Attempting to maneuver your " + this.cockDescript(x) + " into position");
        this.outputText(", you rub the head along her dripping snatch, smearing her fluid over it.  ");
        //[(non-cent)
        if (!this.player.isTaur()) this.outputText("Gripping her fuzzy thighs next, you lift her bottom and line");
        //(hoers)
        else this.outputText("She lifts her bottom and lines");
        this.outputText(" her slippery passage up with your cock.  \"<i>Here it comes!</i>\" you cry.  With that announcement, you thrust into her, parting her lips with your swollen " + this.player.cockHead(x) + ".  She moans in relief as you finally enter her, but said relief is short-lived as you begin pumping at her slick vagina.  Gasping weakly, she lies back on the ground; ");
        if (this.sheilaCorruption() <= 30) this.outputText("her perky breasts rock back and forth");
        else this.outputText("her jiggling breasts flatten into perfect domes and undulate on her chest");
        this.outputText(" as you draw in and out of her warm, moist pussy.");
        ...
        //[(non-cent)]
        if (!this.player.isTaur()) {
            this.outputText("You pause briefly, adjusting your angle and leaning down to kiss her deeply once again and help caress her ");
            if (this.sheilaCorruption() <= 30) this.outputText("firm");
            else this.outputText("pillowy");
            this.outputText(" tits, then resume thrusting from your new position; her nipples now brush against your [chest] as you pump.  ");
        }
        //(if balls/vag)
        if (this.player.balls > 0 || this.player.hasVagina()) {
            this.outputText("Her stubby tail curls inward toward you, rubbing up against your ");
            if (this.player.balls > 0) this.outputText("[balls]");
            else this.outputText(this.vaginaDescript(0));
            this.outputText(" and tickling you as she writhes in pleasure.  ");
            //(if vag)
            if (this.player.balls == 0 && this.player.hasVagina()) this.outputText("Your cunt twitches and drools a bit of fluid on the furry intruder.  ");
        }
        this.outputText("You fuck harder, stuffing Sheila with such force that her ");
        if (this.sheilaCorruption() < 30) this.outputText("perky, erect nipples trace long arcs against your skin");
        else this.outputText("jiggly tits nearly slap into her face");
        this.outputText(".  \"<i>Ohhh,</i>\" she moans, \"<i>YES!</i>\"  At that moment you feel her vagina clamp around your [cockFit 32], wringing it frantically as she reaches her climax.  You continue pumping as best you're able, but you can't stand up to the siege of her spasming pussy for long; ");

        //[(pc corr >= 90 or > sheila corruption) 
        if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS.SHEILA_CORRUPTION]) {
            this.outputText("something builds to a painful intensity in your crotch.  It feels like two mind-blowing orgasms arriving together and fighting over which one gets to come out first.  You rise toward climax quickly and then are drawn back in moments of maddening frustration, over and over.  In response you intensify your thrusts even more, sawing in and out of the girl at a pace that would be blistering if the two of you weren't leaking enough pre-cum and pussy juice to put out a brushfire.  Eventually the pleasure overwhelms the strange reticence of your orgasm; you cry out loudly as you peak, and squeeze a tiny trickle of cum into her grasping vagina.");
            //[(multi)
            if (this.player.cockTotal() > 1) {
                this.outputText("  Your other ");
                if (this.player.cockTotal() == 2) this.outputText("dick erupts");
                else this.outputText("dicks erupt");
                this.outputText(" as well, festooning her crotch with sticky strings.");
            }
            this.outputText("  The intense sensation begins to ascend your dick slowly; your body works itself into overdrive and your partner's moans increase sympathetically as it nears the tip.  Finally, it exits your body with an enormous squeeze, alongside a jet of jism.  Sheila gives a complementary gasp as this pulse enters her, and her pussy convulses in a second orgasm, causing her back to arch.  Her breasts seem to jiggle more wildly than before as she thrashes on the ground in the grip of her pleasure.");
        }
        //(PC corruption < sheila corruption)
        else if (this.player.cor < this.flags[kFLAGS.SHEILA_CORRUPTION]) {
            this.outputText("your resistance is condemned to die in failure as Sheila lets out a quavering scream of pleasure and wraps her arms and legs around you, pinning you inside.  Her vagina convulses around your cock powerfully; you could swear you feel yourself stretching longer and longer as her rippling pussy pulls you deeper in.  Just when you think that your dick must be a mile long, her whole body tenses up and her fingernails dig into your back.  Wearing a madwoman's expression, Sheila stares open-mouthed at you as her muscles lock and her pussy quivers out its fitful orgasm; even her ");
            if (this.sheilaCorruption() < 30) this.outputText("perky");
            else this.outputText("pillowy");
            this.outputText(" breasts seem to be held taut, compressed and motionless.  Suddenly she rams her hips into yours violently and throws her head back, and before you can issue a word of protest, her cunt wrings your " + this.cockDescript(x) + " one last time with almost supernatural heat; your mind clouds over and a wracking orgasm shoots to the base of your spine, echoing back with the first wave of your ejaculation.");
        }
        //(else if equal but below 90)
        else {
            this.outputText("your orgasm quickly supersedes your control as she wrings you and rubs her nipples against your [chest].  " + this.SMultiCockDesc() + " begins to twitch as it unloads its first squirt of semen into her spasming pussy");
            if (this.player.cockTotal() > 1) this.outputText(" or onto her thighs and belly");
            this.outputText(".");
        }
        ...
        if (!this.player.hasKnot(x)) {
            this.outputText("You oblige shakingly, pulling your " + Appearance.cockNoun(this.player.cocks[x].cockType) + " out of her clenching pussy with a wet, sucking noise.  A trickle of semen drools from between her lips as you unburden yourself of the rest of your load, squirting it onto her groin");
            //[(big skeet)
            if (this.player.cumQ() > 500) this.outputText(", breasts, and face");
            this.outputText(".");
            //[(Huge skeet)
            if (this.player.cumQ() >= 1500) this.outputText("  More and more globs of semen shoot from the end of " + this.sMultiCockDesc() + ", pasting Sheila to the dry grass as you paint her body white.");
        }
        //(dog cock)
        else {
            this.outputText("You attempt to oblige her, but your swollen knot sticks firmly in her squeezing pussy, locking you into place.  After a few fruitless tugs, you give yourself up to your orgasm with an apology, slumping against her heaving chest and helplessly dumping the rest of your load into the twitching woman. ");
            //[(big skeet)
            if (this.player.cumQ() >= 1000) {
                this.outputText("Her belly begins to round as your overproductive gonads push out your massive store of semen");
                //[(huge skeet)
                if (this.player.cumQ() >= 3000) this.outputText(", until it's stretched as far as possible and each successive jet forces out squirts of frothy jism from the tight seal her pussy makes around the knot");
                this.outputText(". ");
            }
            //[(multi)
            if (this.player.cockTotal() > 2) this.outputText("Your other cocks erupt as well, soaking her crotch and matting down the fur on her thighs with whiteness. ");
        }
        this.outputText("Both of your orgasms finish up");
        //(dog-c) 
        if (this.player.hasKnot(x)) this.outputText(" and you finally manage to pull out of her");
        this.outputText("; the two of you lie there breathing raggedly for several minutes.  Sheila breaks the silence first.");
    ...
    private sheilaMutualMasturbation(): void {
        ...
        if (this.player.hasCock()) {
            if ((this.player.isTaur() && this.player.tallness * (5 / 6) < this.player.cocks[this.player.longestCock()].cockLength) || this.player.hasCock()) choices[choices.length] = "cock";
        }
        if (this.player.hasVagina() && !this.player.isTaur()) choices[choices.length] = "vagina";
        if (this.player.hasFuckableNipples()) choices[choices.length] = "nipplecunt";
        ...
        this.outputText("You snatch Sheila's hat and pack, tossing them away, then slide a hand into the girl's shirt, slipping one of her nipples between two fingers as you nibble on her neck, and use the gentle pressure to push her onto her back.  She sighs, moving a hand under her clothes to caress yours.  \"<i>Ah,</i>\" she pants, letting out a soft puff of air, \"<i>what're we gonna do on the grass, [name]");
        if (this.silly()) this.outputText("-chan");
        this.outputText("?</i>\"");
        ...
        //[(horse)
        if (this.player.isTaur()) this.outputText(", folding your legs under you,");
        this.outputText(" and begin ");
        //[(adequate-length cock)
        if (target == "cock") {
            this.outputText("stroking your [cock], pointing it at her as you smear pre-cum onto your fingers");
        }
        //(non-horse vag)
        else if (target == "cunt") this.outputText(" sliding your hand to your [vagina], parting your lips with two fingers");
        //(gross-ass nipcunts)
        else if (target == "nipplecunt") this.outputText("plunging your fingers into one of your awkward, distended nipples");
        //(Unsexed non-centaur only)
        else if (target == "ass" && !this.player.isTaur()) this.outputText("licking a finger and teasing your asshole with shallow strokes, gently circling the ring");
        //(centaur who hasn't got shit)
        else this.outputText("sucking a single digit salaciously, fingerfucking your mouth and coating it with saliva");
        this.outputText(".  \"<i>Oh... are you going to touch me, or just play with that?</i>\" Sheila asks, grinning.");
        ...
        if (target == "cock") this.outputText("You return your hand to your [cock], pumping vigorously to catch up to your lover, spurred onward by the smooth skin she presses into your lips.");
        //(else if nonhorse vag)
        else if (target == "cunt") this.outputText("You slide your hand between your [legs] again, intent on recovering the march Sheila's stolen on you, and begin rubbing your [clit] vigorously while sighing into her breast.");
        //(else if RNG disgusting nipplecunts)
        else if (target == "nipplecunt") this.outputText("Your hand returns to your chest, slipping inside the sensitive flesh of your nipple, and you groan into Sheila's as a trickle of moisture falls from your chest.");
        //(else if non-centaur asshole)
        else if (!this.player.isTaur()) this.outputText("Your hand reaches back to your [asshole], neglected for too long, and a finger spears your pucker, stroking the nerves inside as you hurry to bring your arousal in line with Sheila's.");
        ///(else if fucking nothing)
        else {
            this.outputText("You wish you had something to play with as you watch your lover writhe under you");
            //[(silly), even just a paperclip].]
            if (this.silly()) this.outputText(", even just a paperclip");
            this.outputText(".");
        }
        ...
        //[(if fucking nothing)
        if (target != "cock" && target != "cunt" && target != "nipplecunt") this.outputText(", and yours joins her, slipping into her entrance alongside");
        this.outputText(".  \"<i>Just... say I'm always yours!</i>\"  She turns you toward her face again, locking you in a kiss, and your ");
        //[(if cock)
        if (target == "cock") {
            if (this.player.cockTotal() == 1) this.outputText("prick begins");
            else this.outputText("pricks begin");
            this.outputText(" to twitch, ejaculating a stroke onto Sheila's midriff and wrist.  The girl groans in your mouth at the new heat, and her body shakes in orgasm.");
        }
        //(vag)
        else if (target == "cunt") {
            this.outputText("pussy convulses, ");
            if (this.player.wetness() < 4) this.outputText("drooling");
            else this.outputText("squirting");
            this.outputText(" around your hand.  As your body shakes and your lips rattle against Sheila's, she shivers and her own orgasm begins.");
        }
        //(nipcunts)
        else if (target == "nipplecunt") {
            this.outputText("nipple constricts around your fingers in climax, oozing lubrication onto your partner.  As the drops from your " + this.breastDescript(0) + " hit her own, Sheila's back arches again and her own orgasm begins.");
        }
        //(jack shit)
        else this.outputText("fingers are pulled into her vagina by her muscles as her orgasm begins.");
        //[( pc corr >= 90 or > sheila corruption) 
        if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS.SHEILA_CORRUPTION]) {
        ...
        //(else if equal corr but under 90)
            ...
            this.outputText("She breaks the kiss, drawing her hand from her pussy, and holds your head in front of her; her eyes soften with affection as she shudders.");
            //[(not jack shit)
            if (target == "cunt" || target == "cock" || target == "nipplecunt") this.outputText("  Emptying your reserves, you allow yourself to fall into her arms, resting your head on her chest.");
        }
        ...
        if (target == "cunt" || target == "cock" || target == "nipplecunt") this.player.orgasm();
        ...
        //(else no corruption warning triggered)
            ...
            if (target == "cock") this.outputText("there, staring at the load you left in her bellybutton");
            else this.outputText("together");
            this.outputText(".  \"<i>Oh, I had so much fun, mate.");
            //[(if sex =U and sillymode)
            if (this.player.gender == 0 && this.silly()) this.outputText("  I love you, my Ken doll.");
            this.outputText("</i>\"");
            //[(if sheila xp = 3)
            if (this.flags[kFLAGS.SHEILA_XP] == 3) {
    ...
    private sheilaCorruptionWarningsChooseFondle(): void {
        ...
        if (this.player.hasCock()) this.outputText("erect");
        else if (this.player.hasVagina()) this.outputText("wet");
        else this.outputText("aching");
        this.outputText(".  Even as she goes, you can still see the edges of her amazing, swaying rack around the sides of her torso.");
    ...
    private sheilaCorruptionWarningListenToHer(): void {
        this.clearOutput();
        this.outputText("\"<i>So...</i>\" you answer, your feel frozen in mid-cop, \"<i>what?</i>\"");
    ...
    public sheilaGotWhomped(): void {
        ...
        ///(lust)
        else this.outputText("rubbing her thighs together and smearing around the moisture from her pussy");
        this.outputText(".  As you stand over her, she forces herself to her elbows and tries to scoot away from you, fear written on her face.  \"<i>I'm sorry... please, no...");
        //[(sheila xp > -4)
        if (this.flags[kFLAGS.SHEILA_XP] > -4) this.outputText("  I'll forgive you for everything else, but please, not this!");
        this.outputText("</i>\" she implores.");
        //[(sheila corruption >= 90)
        if (this.sheilaCorruption() >= 90) this.outputText("  \"<i>I-if you touch me again... god, I can't even think straight anymore!  Don't do this!</i>\"");
        //(lust >= 30)
    ...
    private letSheilaGo(): void {
        if (this.flags[kFLAGS.SHEILA_XP] >= -3) this.flags[kFLAGS.SHEILA_XP] = -1;
    ...
    private rapeSheilasCooter(): void {
        ...
        this.outputText("You grab the girl by her fuzzy leg; she tries to kick away from you, but you pull her back, pinning her");
        //[(horse)
        if (this.player.isTaur()) this.outputText(" by planting your forehooves just above her hips");
        this.outputText(".  Reaching down, you take the neck of her shirt in your hand, then rip it open, exposing her ");
        //[(sheila corruption < 30)
        if (this.sheilaCorruption() < 30) this.outputText("tiny ");
        //sheila corruption > 60)
        else if (this.sheilaCorruption() > 60) this.outputText("huge, soft ");
        this.outputText("breasts, which jiggle from the force.  She tries to cover herself with her arms, but you grab and pull them aside, revealing her chest again.  As you appraise her naked flesh, she looks away, shame coloring her cheek.  Her mouth tightens and her eyes shut as you squeeze her tits roughly, flicking the nipples until they're erect.");
        ...
        //[(monster HP < 1)
        if (this.monster.HP < 1) this.outputText("sliding it between her labia and producing a damp spot, then ");
        this.outputText("dragging the wet fabric around her vulva.");

        this.outputText("\n\nSatisfying yourself as to her readiness, you unfasten your [armor] to extract your [cockFit 48]; the " + this.player.cockHead(x) + " drips with pre-cum as you pull it loose, and you lay it on her crotch, letting the goo soak the white fabric until you can see her light-brown skin through it.  She squirms under it, bringing up another droplet with her motion, and you place the tip at the entrance to her pussy, pressing eagerly against the fabric.  \"<i>Please...</i>\" she whimpers, \"<i>I'm begging you; don't.</i>\"");

        //fuck-fork
        //[(corruption < 50)
        if (this.player.cor < 50) {
            this.outputText("\n\nYou frown at the girl.  She still wants to escape, even though her body is eager for this?  You can feel her wet pussy twitching at your " + this.player.cockHead(x) + ".  Dragging the oozing tip along her soaked panties provokes a shiver and another bloom of fluid from the girl, but she bites her lip and refuses to meet your eye.");
            ...
            //[(big skeet)
            if (this.player.cumQ() >= 500) this.outputText("  Soon you've filled her as fully as the shallow penetration will allow, and the panties begin to press back against your cock, oozing onto you whatever semen the porous dam can't contain.");
            //(mega skeet)
            else if (this.player.cumQ() >= 1500) this.outputText("  It sags and bows around the tip of your spear, pulsing with each new stroke as the hemlines leak jizz onto her legs and butt.");
            this.outputText("  Idly, you imagine what it must look like inside, each squirt having its momentum arrested by the cloth, drooling lazily into her until the next one displaces it a bit further forward, and wonder if it'll be enough to get her pregnant.  You pull away from the girl, leaving her gasping and once again averting her gaze.");

            this.outputText("\n\nShe attempts to stand, holding her midriff and looking at you unhappily.  ");
            //[(big skeet)
            if (this.player.cumQ() >= 500) this.outputText("So much cum fills her pussy that it slips out, once again restoring the opacity, though not the dryness, of her panties.  ");
            this.outputText("You return her gaze, turning your nose up dismissively.  Conscious of her nudity, she pulls up her shorts and buttons her vest to conceal herself as you leave her behind.");
            ...
            if (this.player.cockArea(x) > 32) this.outputText(" and the pain of taking a cock slightly too large for her");
            this.outputText(", and she actually rears back to scratch at you with her fingernails.  You catch her hand and hold it, and she responds by spitting at you!  \"<i>Fuck you, arsehole!</i>\" Sheila shrieks.  \"<i>Take it out!</i>\"  Reaching down, you slap her in the face.");
            ...
            if (this.sheilaCorruption() > 10) this.outputText(" jiggles her breasts and");
            this.outputText(" clenches her jaw.  A bloom of red colors her cheeks, one brighter than the other from the blow... though she still refuses to look at you.  Doesn't matter; having sex.  You begin to pump her pussy vigorously, the wetness enough to allow quick, smooth thrusts without any warmup.  \"<i>You're a godawful liar,</i>\" you grunt");
            //[(not centaur)
            if (!this.player.isTaur()) this.outputText(", leaning down to kiss her long neck and collarbone");
            this.outputText(".  Sheila quivers again, still looking away, as you continue.  \"<i>I can actually feel you stroking me with your vagina already.  Are you going to come soon?  Will you tell me how much you're hating this when you do, and wrap your legs around me to punish me by holding me inside?</i>\"  The girl's blush deepens, and she bites her lip in embarrassment.  Confidently, you release her hand");
            //[(nothors)
            if (!this.player.isTaur()) this.outputText(", transferring yours to her breast while brushing her torn shirt to the side");
            this.outputText("; without struggling further, she slowly lowers it");
            //[(nothors)
            if (!this.player.isTaur()) this.outputText(" to rest atop your own");
            this.outputText(", confirming your suspicion.  Her eyes close and her chin raises resignedly");
            //[(nothors)
            if (!this.player.isTaur()) this.outputText(" as you triumphantly squeeze the flesh in your hand and kiss her under the jaw");
            this.outputText(".");
            ...
            //[(mans)
            if (!this.player.isTaur()) this.outputText("place a hand along her face, tuning it toward you, and kiss her on the lips.");
            else this.outputText("bend down, lowering your torso until you can caress her cheek.");
            this.outputText("  \"<i>Of course I won't,</i>\" you answer sweetly.  \"<i>What would be the point?</i>\"  Sheila winces as you hilt yourself, sinking your [cockFit 48] so far into her that your crotch meets hers.  You shudder");
            //[(nonhors)
            if (!this.player.isTaur()) this.outputText(" and squeeze her breast");
            this.outputText(" as your climax arrives and the first of your seed pours into her grasping pussy.  While you fill her, her back arches");
            //[(nonhors) 
            if (!this.player.isTaur()) this.outputText(" and she presses your hand uncomfortably");
            this.outputText(", gasping as her own orgasm begins.  Her knees wrap around your sides, satisfying your predicition, and her vagina");
            //[(pc corr >= 90 or > sheila corruption)
            if (this.player.cor >= 90 || this.sheilaCorruption() < this.player.cor) {
                this.outputText(" pulls greedily at your [cockFit 48], drinking up your semen as fast as you can squirt it.  She sucks in breath as she climaxes, finally opening her eyes as her head tilts back");
                //[(nonhors)
                if (!this.player.isTaur()) this.outputText("; you can almost feel her breast heating up and swelling with blood under your hand, as the nipple pokes into your palm");
                this.outputText(".");
            }
            //(PC corr < sheila corruption)
            else if (this.player.cor < this.sheilaCorruption()) {
                this.outputText(" floods you with juices, dumping so much around your twitching cock that you feel like you're lowering it into a hot spring.");
                //[(nonhors)
                if (!this.player.isTaur()) this.outputText("  She squeezes your hand so hard that you swear you can feel her breast compressing under it as she screams her pleasure.");
            }
            //(else equal but < 90)
            else {
                this.outputText(" drools eagerly as you mingle your juices with hers, until the fluid begins to thicken with white seed.");
            }
            //[(big skeet)
            if (this.player.cumQ() >= 500) this.outputText("  Overabundant as always, your semen quickly fills her to capacity and begins to squirt out around your shaft, staining her thighs.");
            //[(multicock)
            if (this.player.cockTotal() > 1) {
                this.outputText("  Your other ");
                if (this.player.cockTotal() == 2) this.outputText("dick spits");
                else this.outputText("dicks spit");
                this.outputText(" as well, leaving trails all over her light-brown skin.");
            }
    ...
    private forcedSheilaOral(dick: boolean = true): void {
        ...
        //set sheila xp = -4
        this.flags[kFLAGS.SHEILA_XP] = -4;
        this.outputText("You lean down and grab the girl by her shirt-front, raising her to her knees; her hands automatically go to yours.");
        ...
        if (this.sheilaCorruption() >= 50) this.outputText("soft, pillowy");
        else this.outputText("small, perky");
        this.outputText(" breast.  \"<i>You don't want to rip your clothes, do you?  It must be difficult to get nice fabric like this out here in the middle of nowhere.</i>\"");
        ...
        if (this.sheilaCorruption() < 20) this.outputText("little round things that trace gentle curves under her loose shirt.");
        //(else sheila corruption < 50)
        else if (this.sheilaCorruption() < 50) this.outputText("healthy mounds that fill out her shirt.");
        else this.outputText("swollen globes that bulge over her v-neck and strain at the seams of her shirt.");
        this.outputText("  Smiling at the sight, you grab the garment's hem and pull it up roughly.  Sheila blinks dumbly as you expose her erect nipples to the air, then blushes and covers them with her hands.");

        this.outputText("\n\nStill smiling, you unfasten your [armor] and reveal your crotch.  ");
        //[(cock.length > 0)
        if (dick) this.outputText(this.SMultiCockDesc() + " flops free, half-erect and swelling steadily with blood as you appraise the woman's body.");
        //(vag present)
        else this.outputText("Your [vagina] drools slightly, labia parting and [clit] poking up; you imagine what you want to do with it.");
        this.outputText("  Sheila watches your face as you slip into a fantasy, half-playing with her nipples - but just when you start to get into your daydream, she turns and tries to scramble to her feet!");
        ...
        if (dick) {
            ...
            //[(cock width <= 6")
            if (this.player.cocks[this.player.shortestCockIndex()].cockThickness <= 6) {
                this.outputText("parting her lips to pop neatly between them.  It feels good, but one-sided, and you order Sheila to get to work.");
            }
            else {
                this.outputText("jabbing at her undersized mouth with your enormous [cockHead shortest].  \"<i>It's too thick!</i>\" she complains, trying to turn away.");
            ...
            this.outputText("  The reticent woman brings her lips into play, sucking gingerly, ");
            //start length fork, no new PG
            //[(dick length <= 8)
            if (this.player.cocks[this.player.shortestCockIndex()].cockLength <= 8) {
                this.outputText("and the warm embrace of her mouth is welcome stimulation.");
                ...
                if (this.player.balls > 0) this.outputText("your [sack]");
                else this.outputText("the base of your shaft");
                this.outputText(", and the other hesitantly makes its way to her breasts as she gets into the sex.  The woman tweaks her nipple, softly at first but with mounting passion as her attentions on your dick become more lavish.  Catching this from the corner of your eye, you move ");
                if (!this.player.isNaga()) this.outputText("a [foot]");
                else this.outputText("the tip of your tail");
                this.outputText(" between her knees to her crotch, rubbing her pussy through her shorts; Sheila hums into your shaft as a wet spot appears on the cloth, and begins grinding her hips against the pressure.  You answer her enthusiasm by taking her head in your hands and stroking the surface of her long, pointed ears affectionately with your thumbs.  She flushes, then sinks down on your cock, rubbing the nerves on the slit with the back of her tongue and pulling you closer to orgasm.");
                ...
                if (this.player.balls > 0) this.outputText(" and your [balls] tighten up");
                this.outputText(".  She pushes against you with her hands, trying to get free, but you just hold her against your crotch as you lean over her head.");
            }
            //(else dick length > 8)
            else {
                this.outputText("but this sort of half-assed attention won't get you off any time before sundown.");
                ...
                ///(else width > 6)
                    ...
                    if (this.player.balls > 0) this.outputText(" and your [balls] draw closer to your body");
                    this.outputText("; still intent on calling this oral sex, you squeeze Sheila's jaw, forcing her mouth open, then push your drooling slit right up to it as the first squirt of white peeks out.");
                }
            }
            //end width fork and length fork
            //begin corruption worms fork
            //(if corr >= 70 and Infest command is unlocked)
            if (this.player.cor >= 70 && this.player.statusAffectv1(StatusAffects.Infested) == 5) {
                this.outputText("\n\nA wicked idea flits through your head, brought on by the squirming annoyances ");
                if (this.player.balls > 0) this.outputText("packing your [balls] and driving up your lust in their zeal to multiply");
                else this.outputText("deep inside your body, trailing sensation along the nerves in your most intimate places and ramping up your production");
                this.outputText(", and you decide to indulge it.  \"<i>Don't worry about rations for the day,</i>\" you cry out, \"<i>I've got more than enough to feed you!</i>\"  Sheila's resigned expression registers this as little more than masculine braggadocio - all the better for your surprise.  Pulling deep inside yourself, you force out a thick load of wormy jism, depositing it directly into the woman's throat; her body tenses at the texture and she tries again to pull away.  As the writhing mass is pushed down her gullet by yet more arriving after it, she begins to struggle violently, hitting you with tired fists and trying to wrench her head free of your grip, even at the cost of her ears.  Luckily, she lacks the energy to do permanent damage to either you or herself after the fight and the cruel face-fucking, and you pour your infested load into her with abandon.");
                //[(big skeet)
                if (this.player.cumQ() >= 2500) this.outputText("  The volume of semen and slimy worms you pack her with is so great that it strains her stomach; you can actually see dozens of the annelids slithering around in a tight ball under the taut skin of her swollen midriff.");
                this.outputText("  Eventually you finish and pull out, after pushing up every worm you can.  Your ");
                if (this.player.balls > 0) this.outputText("[sack]");
                else this.outputText("body");
                this.outputText(" actually feels lighter by a noticeable amount - though you can still feel some deep inside you, reminding you that you'll be full again soon.  On that note...");
            ...
            //(else if corr < 70 or PC cannot use Infest at will)
                ...
                //[(big skeet)
                if (this.player.cumQ() >= 1000) this.outputText(", and soon you can feel it lapping at the end of your shaft");
                this.outputText(".");
                //[(mega skeet)
                if (this.player.cumQ() >= 3000) this.outputText("  Your body's not done with that, though, and keeps pushing out cum until it spurts around your prick and out Sheila's nose in little squirts.");
                this.outputText("  Emptying yourself, you pull Sheila's mouth away from your [cock shortest] and drag the slimy member on her chest, smearing her tits with spit and semen and wiping away the last of the mess on her shirt.");

                this.outputText("\n\nYou pull the soiled garment down over Sheila's breasts");
                //[(big+ skeet)
                if (this.player.cumQ() >= 1000) this.outputText(", though it's so wet with seed now that you can see them almost as well through it");
                this.outputText(".  \"<i>This really is a nice fabric.  You should take better care of it.</i>\"  With that parting shot, you leave the queasy-looking woman to digest your load and the humiliation.");
            }
            //end worm fork
            ...
            //[(sheila corruption >= 30)
            if (this.sheilaCorruption() >= 30) this.outputText("; her breasts jiggle pleasingly as they settle on her chest, filling you with the urge to play with them");
            this.outputText(".  Straddling her, you lower your [vagOrAss] to her face.  \"<i>Lick,</i>\" you order, rubbing your [butt] on Sheila's nose");
            //[(not horse)
            if (!this.player.isTaur()) this.outputText(" as you fondle her tits");
            this.outputText(".");
            ...
            if ((this.player.hasVagina() && this.player.vaginalCapacity() >= 100) || (!this.player.hasVagina() && this.player.analCapacity() >= 100)) this.outputText("  She keeps hitting the same spot again, too - she's not even bothering to adjust her angle and touch the rest of your stretched opening.");
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00141] > 0) this.outputText("  I know a nice boy in the mountains who keeps dogs, and I'm sure he'd love to have a womb like yours for their seed.  By this time tomorrow, you could have a cock in both holes, filling you with hellhound babies since you can't please a person.");
            this.outputText("</i>\"");

            this.outputText("\n\nYou can feel her face heating up under your [butt] as she flushes with shame; seems like you struck a nerve.  You ");
            //[(no horse)
            if (!this.player.isTaur()) this.outputText("pinch her nipple for emphasis, then grind your hips across her face, mauling her nose with your ass.  \"<i>I could fuck a tree and it wouldn't be as wooden as you in the sack");
            //[(PC has found corrupt glade)
            if (this.player.exploredForest >= 40) this.outputText(" - in fact, there are quite a few I've seen who look like better lovers than you.  Maybe I should carry you to the forest and tie you to a nice pussy-shaped giant flower to give you lessons");
            this.outputText(".  ");
            //[(minotaur addiction score =/= 0%)
            if (this.flags[kFLAGS.MINOTAUR_CUM_ADDICTION_TRACKER] > 0 || this.player.findPerk(PerkLib.MinotaurCumAddict) >= 0) {
                this.outputText("Perhaps I'll turn you over to a minotaur; you're bound to get better at using your tongue when you're addicted to their amazing seed.  Would you like that?  The first thing you'd see in the morning would be a huge flared cock, right in front of you, dripping with heavenly precum and waiting for your mouth... or your cunt.  You could be just another minotaur-fucking slut of the plains.  ");
            }
            this.outputText("Or I could take you home and give you personal training myself, whenever I feel like it, and invite travelers to do the same");
            //[(PC has Izma with cock)
            if (this.izmaFollower() && this.flags[kFLAGS.IZMA_NO_COCK] == 0) this.outputText("; I personally know fifteen inches of fat, orange dick and four heavy balls that'd love to get in at your other end while I ride your face");
            this.outputText(".</i>\"");
            ...
            if (this.player.findStatusAffect(StatusAffects.HairdresserMeeting) >= 0 || this.flags[kFLAGS.LUMI_MET] > 0) {
                this.outputText(" while imagining her turned over to the goblins for experiments, forced to drink potion after potion - most would be dedicated to growing cocks on her or increasing semen production, of course");
            }
            this.outputText(".  Your hole clenches and drools on her, and the woman's rude tongue retreats from the pressure, leaving you painfully empty.");
            //[(no horse)
            if (!this.player.isTaur()) this.outputText("  Even squeezing her breasts viciously can't compel her to reinsert it, though you amuse yourself trying.");
    ...
    private sheilaGetsRapedWithADildont(): void {
        ...
        if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption()) {
            this.outputText("Your face heats as she kisses you sloppily, and not all of the temperature is from her mouth.  It feels like she's pulling energy right out of you, and you can swear that her breasts are growing.");
        }
        //(else PC corr < sheila corruption)
        else if (this.player.cor < this.sheilaCorruption()) {
            this.outputText("Her lips heat up and your body tingles; you can see her breasts shrinking as she shivers and slobbers on your face - or so it seems from the angle.");
        }
        //(else if magically equal but < 90)
        else this.outputText("The kiss is wet and indecent as she shudders through her anal orgasm; her lips don't stay in one place, instead tracking drool all over your face.");
        ...
        //(cock)
        if (this.player.hasCock()) this.outputText("  \"<i>Perhaps next time you'd like to try a real cock in there?</i>\"  Even exhausted and messed up on goblin drugs, she has the presence of mind to shake her head at that.  You laugh.");
        ...
        this.dynStats("lus", this.player.lib / 3, "resisted", false);
        this.cleanupAfterCombat();
    }
    ...
    public getBeatUpBySheila(): void {
        this.clearOutput();
        this.outputText("You slump down before Sheila, breathing heavily; the woman ");
        if (this.monster.lust < 75) {
            this.outputText("takes the opportunity to grab her catch and take off running!  Even if you wanted to, you couldn't catch her now... you collapse, head swimming in ");
            if (this.player.HP < 1) this.outputText("colorful spots");
            else this.outputText("fantasies of her, stark naked but for her hat and waiting with her legs open");
            this.outputText(".");
        ...
        //(else monster lust >= 75)
            ...
            this.outputText("stares at you, desire and nerve at war in her face.  Her thighs rub together involuntarily as she tries and fails to will herself away... slowly, she takes a step toward you.");
            ...
            //[(sheila xp > -4)
            if (this.flags[kFLAGS.SHEILA_XP] > -4) {
    ...
    private sheilaLossRapeRouter(): void {
        ...
        if ((!this.player.hasCock() || SheilaScene.rand(3) == 0)) this.sheilaForcedOralGeneric();
        //loss scene - cowgirl (for M,H)
        //if sheila xp >= -3, set sheila xp = -2
        else {
            this.sheilaCowgirlRapesYou();
            return;
        }
    }
    ...
    private sheilaCowgirlRapesYou(): void {
        this.clearOutput();
        this.outputText("Sheila pushes insistently, and you allow her to force you to the ground and then onto your back");
        if (this.player.isTaur()) this.outputText("; your hooves stick awkwardly out to one side");
        this.outputText(".  She blushes furiously and won't meet your eyes, but it doesn't stop her from stripping off her vest and shirt in one smooth motion, revealing her " + this.sheilaCup() + " chest.  \"<i>T-touch me,</i>\" she demands, \"<i>rub me.</i>\"  Almost as an afterthought, she adds \"<i>... please.</i>\"");

        this.outputText("\n\nYou move your hands to her smooth skin, cupping a ");
        if (this.sheilaCorruption() < 30) this.outputText("petit ");
        else if (this.sheilaCorruption() > 70) this.outputText("massive ");
        this.outputText("breast in each, squeezing them softly and rubbing the hard nipples with your thumbs.  Sheila shudders as you amuse yourself with her body, placing her hands atop yours and guiding you to her favorite spots.  You watch her as she moans; your gazes meet as she rolls her head, and she quickly restrains herself and looks away again.  \"<i>Stop staring at me...</i>\"");

        this.outputText("\n\nEager to see anything but your curious face, Sheila pushes your hands away from her breasts and turns to your crotch.  She ");
        if (this.player.isTaur()) this.outputText("pulls your legs apart");
        else this.outputText("unfastens and strips off your [armor]");
        this.outputText(", revealing your " + this.multiCockDescriptLight() + "; ");
        //[(if no cock fit 32)
        if (this.player.cockThatFits(32) < 0) {
            this.outputText("her eyes widen as " + this.sMultiCockDesc() + " bobs free, half-erect monster meat that fills her with frustration.");
            ...
            //[(horse)
            if (this.player.isTaur()) this.outputText(", or at least as flat as you can get it");
            this.outputText(", then sits on your stomach");
            if (this.player.isTaur()) this.outputText(", sliding her long legs between yours");
            this.outputText(".  She scoots forward slowly, and gasps as her pussy comes to rest against your hot, blood-engorged shaft.");
            ...
            if (this.player.isTaur()) this.outputText("forelegs fold over her torso affectionately");
            else this.outputText("hands search out her breasts, caressing and squeezing");
            this.outputText(" as her gasps and the picture in your head both intensify.  Sheila grabs one with her own hand, pulling it up to her mouth to smother it in kisses");
            if (!this.player.isTaur()) this.outputText("and suck on your fingers");
            this.outputText(".  \"<i>Oh... [name]...</i>\"");
            ...
            this.outputText("Sheila shivers and leans back, hair dangling, as her hips buck and her thighs squeeze your shaft.  ");
            //(PC corr >=90 or > sheila corruption)
            if (this.player.cor >= 90 || this.sheilaCorruption() < this.player.cor) {
                this.outputText("You can feel your prick heating up where her pussy rubs against it... it almost feels like the rest is cooling down at the same time.  The woman atop you arches her back and sucks in her breath sharply, and her tits seem to claim your field of vision, swelling up - though that could just be the angle.");
            }
            else if (this.player.cor < this.sheilaCorruption()) this.outputText("Her orgasm wets your prick, coating it with fluid as she comes.  Sheila wraps herself tighter in your limbs, squeezing her breasts against her chest, and you think you can feel them get a little smaller as your head fuzzes over with her excess emotion.");
            else this.outputText("Her hips lock up when she comes, leaving you to try and finish yourself as she heats up around your shaft.");
            ...
            if (this.player.sens >= 50) {
                ...
                //[(mega skeet)
                if (this.player.cumQ() >= 2000) this.outputText("  The giggles and the strokes stop long before your orgasm, though; eventually Sheila just lies there, dumbfounded, as you deposit layer after layer of white lattice on her skin.  \"<i>Bloody hell,</i>\" she mumbles vaguely, either stone-sober or drunk from the sight of it.");
                this.outputText("  Once the rain of semen peters out, she pulls apart from you, slimy and dripping.");
        ...
        //(else if cock fit 32)
            ...
            this.outputText("as you lean over to catch her expression, you can see her eyes glimmer with desire.  Sheila notices you from her peripheral vision, and her face reddens again.  She turns her back to you.");
            ...
            //[(multicock)]
            if (this.player.cockTotal() > 1) this.outputText("separating out and ");
            this.outputText("stroking your [cockFit 32].  A drop of precum forms, and she touches it with the index finger of her free hand, sending a tingle through you; she pulls the finger away, drawing a string of slick moisture out.  Sheila passes the finger between her breasts, wiping the fluid away on her chest and shivering.  The display is too much for you, and you reach forward, navigating your hands around her waist quietly until you can reach the buckle of her belt.  The girl sighs as you begin to unfasten it, but an errant thought brings her back to reality - she grabs your hands abruptly.");
            ...
            //(else lib >= 25)
                ...
                if (this.player.isTaur()) this.outputText(", pushing your legs apart");
                this.outputText("; looking into your face, her frown evolves into a mischievous grin.  Sheila about-faces, turning her back to you.  \"<i>Blame yourself for this; it's rude to stare,</i>\" she giggles, hovering over your [cockHeadFit 32].  The woman sinks down with an audible sigh, parting her slick, smooth labia with your tip and swallowing your " + SheilaScene.num2Text(Math.round(this.player.cocks[this.player.cockThatFits(32)].cockLength)) + " inches.  \"<i>Ohh...</i>\" Sheila moans.  She slips a hand down to your crotch to check how much of your prick is left to go, and starts a bit when she realizes she's taken the entire shaft on the first stroke!");
                ...
                if (!this.player.isTaur()) this.outputText(", and your hands go to her waist, fairly pushing her up and slamming her back down in your eagerness");
                this.outputText(".  She rolls her head as the fuck gets wetter and faster, dangling her hair over her shoulders as her back muscles shift and flex with her strokes; her ears flick whenever she descends and rubs your neck against one of the sweet spots on her vulva.");
                ...
                //(PC corr >= 90 or > sheila corruption)
                if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption()) this.outputText("You can feel her cum-slick inner walls pulling at you as she begins to orgasm, and your mind clears as you blow your load inside her, wondering when she'll likewise return to sense.");
                //(else PC corr < sheila corruption)
                else if (this.player.cor < this.sheilaCorruption()) this.outputText("Her pussy gushes with her orgasm, pushing out your semen and soaking her inner lips even as she continues riding your cock, and your mind clouds as you think of little except sneaking as much of your cum inside her as possible.");
                //else equal but < 90)
                else this.outputText("Even as she comes mindlessly something makes you hold in your own moans, wondering how long it will take her to notice her pussy being filled with your egg-hunting sperm.");
                //[(small cum)]
                if (this.player.cumQ() <= 250) {
                    this.outputText("  Sheila continues moving her hips even as she comes, lost in bliss; on one particularly lofty ascent, your cock flops out, squirting a line of jizz along ");
                    if (this.player.tailType > TAIL_TYPE_NONE) this.outputText("your tail");
                    else this.outputText("the grass");
                    this.outputText(", and her eyes go wide.");
                }
                //(big cum)
                else {
                    this.outputText("  With how much Sheila is still moving her hips, it's only a matter of time before she notices the mounting pressure in her cunt... on one particularly deep push, she forces out a squirt of white, and her eyes go wide as she pulls off and lets you finish on the grass.");
                }
                ...
                this.outputText(" you groan.  \"<i>Can't believe you didn't notice...</i>\"");
    ...
    private sheilaForcedOralGeneric(): void {
        this.clearOutput();
        this.outputText("Sheila kisses you once more, forcing her tongue into your mouth, and slides a hand into your [armor]; you stare wonderingly into her affectionate, hungry eyes at the sudden change.  It isn't until ");
        if (this.player.hasCock()) this.outputText("her hand slips around your [cock]");
        else if (this.player.hasVagina()) this.outputText("her fingers slip between your labia");
        else this.outputText("she rubs your bare crotch for a few seconds");
        this.outputText(" that her reverie breaks; her face colors and she looks away, averting her gaze in shame.  She draws her hand back out guiltily, then begins to doff her shorts and panties.  \"<i>S-sorry... didn't mean to get familiar.  I'll have this over with quickly.</i>\"");

        this.outputText("\n\n\"<i>That's-</i>\"  Your words are cut off as she suddenly climbs atop you, bringing her pussy to eye level");
        if (this.player.str < 61) this.outputText("; her weight bears you slowly to the ground");
        this.outputText(".  Sheila rubs the smooth slit on your [face], trying to part her labia on you, and shivers a bit when your lips brush hers.");
        ...
        if (this.player.hairType == 4) this.outputText(" and flushing as your stingers release their payloads into her palm");
        this.outputText(".  You obediently stick out your tongue");
        if (this.player.cor > 60) this.outputText(", motivated more by whimsy than the meager, almost playful pain,");
        this.outputText(" and shallowly penetrate Sheila's vagina with it.");
        ...
        if (this.player.tongueType > TONUGE_HUMAN) {
            this.outputText("  A sly look crosses your face at her request; she notices it but has no time to dismount before your long tongue shoots into her, stroking the nerves around her entrance as you unspool.  \"<i>Ah-ahhh!</i>\" she moans, \"<i>What the hell... is with your mouth?</i>\"");
        ...
        //[(PC corr >= 90 or > sheila corruption)]
        if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption()) {
            this.outputText("strangling your tongue with muscles attempting to lock onto it, trying to pull it in.");
            //[(demon/dragon tongue)
            if (this.player.tongueType > TONUGE_HUMAN) this.outputText("  As tired as you are, you simply go along with it, allowing her rippling walls to slowly draw your tip deeper inside until it bumps against her cervix; she shivers and kisses the top of your head as you groggily run your tongue over the entrance to her womb.");
            else this.outputText("  However, it doesn't get very far; you lazily flop it around inside her as she works through her arousal.");
            this.outputText("  Sheila groans loudly and your vision fades; through the fog, you can swear you feel her breasts growing larger against your forehead.");
        }
        //(else PC corr < sheila corruption)
        else if (this.player.cor < this.sheilaCorruption()) {
            this.outputText("filling your mouth with her liquid love.  Your lips and throat heat up as you're forced to drink it from the nearness of her pussy; as she bucks her hips weakly into your face, trying to draw out her climax, you increasingly wish that you could return the favor, ");
            if (this.player.hasCock()) this.outputText("face-fucking her and blowing a load into her mouth, then holding her jaw shut until she swallows it unhappily.");
            else if (this.player.hasVagina()) this.outputText("smearing your gash on her face until you come and drown her in your squirting girl-jizz.");
            else this.outputText("forcing her to tongue your asshole until you come, writhing and pressing her head into the grass with your [butt].");
        }
        else this.outputText("and she pets your head affectionately as her walls squeeze your tongue.  \"<i>Oh, mate...</i>\" she whispers lovingly, completely forgetting the struggle that led to your tryst.");
        ...
        //[(str < 61)
        if (this.player.str < 61) this.outputText("climbing off and kneeling next to you.");
        else this.outputText("letting herself down your body until she can put her long legs on the ground once more.");
        this.outputText("  She looks into your eyes contentedly, rubbing your cheek... but then starts and looks away, guilty once more.  \"<i>Shit...</i>\" she mumbles.  \"<i>I did it again.  Even after I promised myself I wouldn't...</i>\"");
        ...
        if (this.player.tongueType > TONUGE_HUMAN) this.fatigue(15);
        this.dynStats("lus", this.player.lib / 3 + 30, "resisted", false);
        if (this.player.lust >= 100) this.dynStats("lib", 1);
        this.sheilaCorruptionUpdate();
        /*
        if(player.cor >= 90 || player.cor > sheilaCorruption()) {
            dynStats("cor", -10);
    ...
    private normalSheilaPregNotifNumberOne(): void {
        ...
        this.clearOutput();
        this.outputText("Traipsing through the grass, you can see Sheila sitting under the shade of a low tree from a long way off.  The reverse is also true, as she waves to you from her seat, beckoning you over.  You make your way to her curiously.");
        ...
        if (this.player.cor < 50) this.outputText("  A hand placed around her shoulder seems to steady her a bit.");
    ...
    private normalSheilaPregNotifNumberOneYepIssue(): void {
        this.clearOutput();
        this.outputText("\"<i>I see,</i>\" Sheila says, nonplussed.  \"<i>I'm sorry you feel that way...  Truth be told, I'm not keen myself on the idea of having a kid, but what's out is out.</i>\"");
    ...
    private normalSheilaPregNotifREPEATEDED(): void {
        this.clearOutput();
        this.outputText("Sheila is here as you step into the plains, with a grass-wrapped parcel of food open on her lap and her hat sitting upturned next to her, and waves you over.");
        ...
        if (SheilaScene.rand(10) < 7) this.outputText("healthy.  It's eating a lot... frankly, it's a little hellraiser with a strong grip, and it cries well, too.</i>\"");
        else this.outputText("weak... we thought we were going to lose it for a bit.  It wouldn't drink from the nurse unless I was there, so I had to stay up with it all night myself.  Feeling a bit stuffed.</i>\"");
        this.outputText("  She looks over at you, giving you the benefit of her fatigue-lined eyes.");

        this.outputText("\n\nSheila slips her hand into yours");
        if (this.player.cor < 40) this.outputText(", and you give it a squeeze");
        this.outputText(".  \"<i>I just wanted to tell you about your baby.  Can't stay... have to catch up to quota still.</i>\"  She drags to her feet and turns to go, tail listlessly hanging.  Even her ears are drooping; this girl is tired.");
    ...
    private normalSheilaPregNotifREPEATEDEDLetHerGo(): void {
        this.clearOutput();
        this.outputText("Nothing you can do about that - even if you wanted to watch your baby for her, she's keeping it hidden in a hole in the ground.  You hand her the parcel back");
        if (this.player.cor < 40) this.outputText(", imploring her to eat the rest and keep up her strength");
        this.outputText(".  Sheila smiles weakly and takes it, folding the grass around again.  \"<i>Thanks, [name].  I'll see you soon... ish.</i>\"");
    ...
    private normalSheilaPregNotifREPEATEDEDWalkWithHer(): void {
        this.clearOutput();
        this.outputText("You pick up her forgotten hat and rise as well, carefully refolding the grass around Sheila's uneaten lunch and tucking it back into her pack for her.  She takes her hat back from you distantly.");
        ...
        else this.outputText("slither");
        this.outputText(" next to her, easily keeping pace with the tired woman, and she raises her face to you inquiringly.  \"<i>What's up, [name]?</i>\"");
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOut(): void {
        this.clearOutput();
        this.outputText("You pick up her forgotten hat and set it on her head, then fold her lunch back into its grass wrapper and tuck it into her pack.");
        ...
        else if (this.player.canFly() && this.player.hasKeyItem("Bow") >= 0) {
        ...
        //(else spd >= 80 and Runner perk)
        else if (this.player.spe >= 80 && this.player.findPerk(PerkLib.Runner) >= 0) {
            ...
            if (this.player.lib < 50) this.outputText("you pinch her ear, provoking an annoyed flick from it.");
            else this.outputText("you slap her on the ass, grabbing a handful and taking her mind off her own misery.");
            this.outputText("  \"<i>Dammit, [name]... not now,</i>\" she frowns, pulling away from you.");
            ...
            if (!this.player.isGoo()) this.outputText("run");
            else this.outputText("glide");
            this.outputText(", making a long loop around to the rear of the wary animal, then begin to systematically drive it closer to your partner, who has strung a line to the base of a shrub and is gesturing at you to force the hare into it.");
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDWELP(): void {
        this.clearOutput();
        this.outputText("\"<i>Welp,</i>\" you say softly.");
        //[(corr <50)
        if (this.player.cor < 50) this.outputText("  You set a hand on Sheila's shoulder to steady her a bit as the tears start to fall.");
        this.outputText("  \"<i>It'll be alright.</i>\"");
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE(): void {
        this.clearOutput();
        this.outputText("With a wan smile, you pull the woman to her feet.  She doesn't resist, but continues looking into your face disconsolately.  \"<i>I'm so stonkered I can't even think what to do first...</i>\"");
        ...
        if (this.player.isNaga()) this.outputText("coil");
        else this.outputText("seat");
        this.outputText(" yourself, then grabs your arms and pulls them around her waist.");

        //forks in order of priority, no new pg at start
        //[(full gooey body)
        if (this.player.isGoo()) {
            this.outputText("  She considers for a moment, rubbing away some of the slime you've deposited on her shorts, and pulls free from your slimy skin again.  \"<i>Um... do you... would you be offended if I took my kit off, so it doesn't get ruined?</i>\"");
            if (this.player.lib >= 40) this.outputText("  The leer you display is so prurient that she seems on the verge of reconsidering, but you compose yourself and");
            else this.outputText("  You");
            this.outputText(" give assent with little more than a broad smile.  Sheila pulls her shirt over her head, revealing her " + this.sheilaCup() + " breasts, but raises her face to you hesitantly when her hands get to her belt.");
            ...
            this.dynStats("lus", this.player.lib / 5 + this.player.sens / 3, "resisted", false);
        }
        //(naga)
        else if (this.player.isNaga()) {
            ...
            if (this.player.lib >= 40) this.outputText(" - but tighten the one sliding across her breasts just slightly.  Sheila's neck turns red and her ears twitch as you rub her nipples, and you plant a kiss on her nape");
            this.outputText(".  \"<i>Ahh,</i>\" she sighs, shifting in your coils.  \"<i>Hold it right there...</i>\"");
            //(apply libido-based lust damage if lib >= 40)
            if (this.player.lib >= 40) this.dynStats("lus", this.player.lib / 4, "resisted", false);
        }
        //(horse and >=5ft)
        else if (this.player.isTaur() && this.player.tallness >= 60) {
            ...
            if (this.player.sens >= 40) this.outputText("... or would be, if you weren't distracted by the nipples poking into you and the thighs squeezing your flank");
            this.outputText(".");
            //(apply sens-based lust damage if sens >=40)
            if (this.player.sens >= 40) this.dynStats("lus", this.player.sens / 4, "resisted", false);
        }
        //(harpy - minimum score for birdlegs at least)
        else if (this.player.lowerBody == LOWER_BODY_TYPE_HARPY && this.player.tailType == TAIL_TYPE_HARPY) {
        ...
        //(eight-legged freaks)
            ...
            this.player.tailVenom -= 10;
            if (this.player.tailVenom < 0) this.player.tailVenom = 1;
        }
        //(else)
        ...
        if (!this.player.isGoo()) this.outputText("blood");
        else this.outputText("goo");
        this.outputText(" flowing, unsure if you'll be able to get to sleep, but Sheila has no such problems.  Within minutes, the woman is out, head nodding forward.  You suppose that means the first watch is yours... it passes slowly, despite the scenery, but eventually you nudge your partner awake when you can stay up no longer.");

        this.outputText("\n\n\"<i>Mmm... lemme sleep for fifteen minutes more, mate,</i>\" she mumbles.");

        //(corr <60)
        if (this.player.cor < 60) this.outputText("\n\nYou nearly consider it, tired as you are, until you remember that a sleeping person's fifteen minutes are two hours in the waking world and shake her again until she gets up.");
        else {
        ...
        if (!this.player.isTaur()) this.outputText("  She grudgingly repositions, allowing you to rest against her.");
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE2(): void {
        ...
        this.statScreenRefresh();
        this.outputText("Your sleep is fitful, but not totally useless, and you yawn and stir a few hours later when Sheila wakes you");
        if (this.player.isGoo()) this.outputText("; she's already dressed and appears to have just been outside");
        this.outputText(".");
        ...
        if (this.player.lust < 30) this.outputText("  You give her a hand, then help her load up.  She gives you a peck on the cheek before she departs.  \"<i>Thanks, love.</i>\"");
        if (this.player.lust >= 30) {
            this.outputText("  Part of you is actually sad to see your cozy hovel being disassembled if it means her warm body won't be pressed up against yours anymore, and your hands begin to rove over her as she works.");
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutTOCAMP(): void {
        this.clearOutput();
        this.outputText("Wordlessly, you lift the bundle of game animals off of Sheila's shoulders and sling it over your own.  She looks up at you, confused enough to forget about her tears.  \"<i>What're you doing?</i>\"");
        ...
        if (this.player.findStatusAffect(StatusAffects.DefenseCanopy) >= 0) this.outputText("\n\nYou shrug off her objections, pointing at the thorns already growing over your point of entry.  Sheila seems duly impressed by the quasi-magical display.");
        //(else if PC has Jojo and Jojo's n.watch is on)
        else if (this.player.findStatusAffect(StatusAffects.JojoNightWatch) >= 0 || this.player.findStatusAffect(StatusAffects.PureCampJojo) >= 0) {
        ...
        //[(int >=60)]
        if (this.player.inte >= 60) this.outputText("\"<i>The baby will be fine,</i>\" you venture, hazarding a guess.  \"<i>It's what the nurses are there for.</i>\"");
        else this.outputText("You slip an arm around her, and ask if she's okay.");
        this.outputText("  She nods mutely and pulls the food out of the fire.");
        //[(if Jojo present)
        if (this.player.findStatusAffect(StatusAffects.JojoNightWatch) >= 0 || this.player.findStatusAffect(StatusAffects.PureCampJojo) >= 0) this.outputText("  She extends one bird to you and another to Jojo.  He raises his hand and shakes his head, but politely.");
        else if (this.flags[kFLAGS.ANEMONE_WATCH] > 0) this.outputText("  Sheila offers you one of the birds, then extends another to your odd tenant.  The anemone's mouth tightens and she shakes her head vigorously, blushing a deep blue.");
        this.outputText("  You eat in silence until the food is gone, and Sheila clears her throat.");
    ...
    private sheilaGoesDemon(): void {
        ...
        if (this.flags[kFLAGS.SHEILA_XP] < -2) this.outputText("always so bloody eager to fuck me!");
        else this.outputText("me best mate!");
        this.outputText("  Help out!</i>\"");
        ...
        this.player.orgasm();
        this.dynStats("lib", -1, "cor", 3);
        this.player.createKeyItem("Sheila's Lethicite", 0, 0, 0, 0);
        this.flags[kFLAGS.SHEILA_CITE] = 1;
        this.flags[kFLAGS.SHEILA_DEMON] = 1;
    ...
    private demonSheilaEncounter(): void {
        this.clearOutput();
        this.outputText("A shadow drops out of a low tree behind you with a rustle.  \"<i>Hey, lover; been a while... how about spending some time with me?</i>\"");
    ...
    private demonSheilaResist(): void {
        this.clearOutput();
        this.outputText("You back away from the demon and raise your [weapon] with a dour glower.  Sheila purses her lips at you, then says, \"<i>Not in the mood, eh mate?  I'm so horny though... I bet I could get you into it.  Let me show you how much I love you...</i>\"  Her ears twitch furiously, belying her intentions as she");
        //[(sheila corruption < 30)
        if (this.sheilaCorruption() < 30) this.outputText(" thrusts her black spade forward and smears some of the constantly-oozing fluid from its tip down the length with her hand");
        else this.outputText(" kneads her breasts seductively, pinching her nipples");
        this.outputText(".  Your posture softens a bit as she reaches out to you");
        if (this.sheilaCorruption() < 30) this.outputText(", tilting her palm to dribble a handful of strong-scented dark oils");
        this.outputText(", but as she giggles sadistically and starts to approach, you tense up again.  It's pretty clear by the way she swaggers dismissively that she isn't taking the rejection well!");
        //go to fight
        this.startCombat(new Sheila());
    }
    ...
    private demonSheilaTalk(): void {
        this.clearOutput();
        this.outputText("Questions nag at you, and you ask Sheila if she wouldn't mind answering a few of them.  She struts over and ");
        //[(not horse)
        if (!this.player.isTaur()) this.outputText("takes your arm in hers, then slips the other hand into your armor");
        //[(horse)
        else this.outputText("between your legs");
        this.outputText(" to touch your ");
        if (this.player.hasCock()) this.outputText("[cock]");
        else if (this.player.hasVagina()) this.outputText("[vagina]");
        else this.outputText("smooth skin");
        //[(lib <20)
        if (this.player.lib < 20) this.outputText(", giggling as your expression petrifies");
        this.outputText(".  \"<i>Anything for you; I'll just find something to occupy my attention.  What's on your mind, love?</i>\"");
    ...
    private tellSheilaDemonToFuckOff(): void {
        this.clearOutput();
        this.outputText("\"<i>Oh,</i>\" she says.  \"<i>Don't be like that.  You're my best mate, you know.  My beloved.  I'll never let you go, ever.</i>\"  Her eyes gloss over a bit, ");
        //[(RNG decides if dis bitch crazy, bias toward sane)
        if (SheilaScene.rand(10) < 3) {
            this.outputText("and she blurts, \"<i>I know I can make you understand.  You can't go until you say it back!</i>\"  You pull her hand free and back away from her, but she advances again, trying to grab you!");
            this.startCombat(new Sheila());
            return;
        }
        else {
    ...
    private askDemonSheilaAboutDahChange(): void {
        this.clearOutput();
        //[(if sheilacite >= 1)]
        if (this.flags[kFLAGS.SHEILA_CITE] >= 1) {
            this.outputText("Sheila blushes deeply.  \"<i>Silly.  You were there.</i>\"  She looks at you, pupils dancing as she remembers the lovemaking session that led to her current form.  \"<i>I suppose that's not what you're asking, though.</i>\"");
            ...
            if (this.player.hasCock()) this.outputText(", and you feel a monument of your own being erected");
            this.outputText(".  \"<i>Every squeeze of my pussy compressed my focus, too, until my mind was clearer than the juice you made me flow with.  I realized my purpose there, with you.</i>\"");
    ...
    private askDemonSheilaAboutHerColony(): void {
        this.clearOutput();
        this.outputText("\"<i>That place?  Do you wanna go there?</i>\"  Sheila smiles duplicitously, then lifts your chin and steals a kiss before you can pull away.  \"<i>Got no qualms about showing you the way to that nest of prudes, but...</i>\"  Her eyes darken.  \"<i>There's nothing left now.  A shame you didn't insist earlier, they could have stood to learn what a ripper " + this.player.mf("man", "woman") + " is.</i>\"");
        ...
        this.outputText(", you ask what happened to him.  Sheila smiles serenely before answering.  \"<i>Unsurprisingly, his prick was all too eager to fill me with sperm after the countless sermons he preached about it being every woman's duty to expand the clan.  He barely lasted three minutes when I climbed atop him.  Oh, that little squirt was the most satisfying one.  Watching him melt under me drove home how much power I've always had... I wish I could have known when I was just an awkward little girl, sitting through his browbeating lectures on loyalty and servitude.</i>\"");
        ...
        //(corr >=75)
        if (this.player.cor >= 75) this.outputText("harvested that day, you sigh wistfully");
        else this.outputText("stolen that day, you wince");
        this.outputText(".  Sheila, peeking at you with one eye from under her bangs, interprets your expression correctly.  \"<i>Wondering where the others went, love?</i>\"  She releases her grip on your arm and holds out the hand that's not exploring your [armor], displaying several rings.  \"<i>The rings are my closest.  I kept them for sentimental reasons.  The rest, well... I ate them.</i>\"");
        ...
        //[(cock)
        if (this.player.hasCock()) this.outputText("she ties you down and rides you until she's so full of your spunk that she can push it back out just by pressing on her stomach");
        else this.outputText("she binds your hands and sits on you, teasing your helpless body with her oozing, throbbing spade until she comes all over you, spraying dark slimy fluid from it");
        this.outputText(".  You ");
        if (this.player.cor < 50) this.outputText("break eye contact, blushing");
        else this.outputText("stare into her shining eyes, getting hotter and hotter as the vision plays out to the very end");
        this.outputText(".");
    ...
    private talkToDemonSheilaAboutWhatNow(): void {
        ...
        this.outputText("\"<i>What will I do now?  What else, my silly love?</i>\"  Sheila looks out over the plains.  \"<i>I'm always hot for you.  We could have a bit of a naughty, and make each other feel good.</i>\"");
        ...
        //(lib>=30)
        if (this.player.lib >= 30) this.outputText("\n\nYour eyebrows rise.  \"<i>Got your attention, did I?  But,</i>\"");
        else this.outputText("\n\nYour mouth hardens.  \"<i>You're right,</i>\"");
        this.outputText(" Sheila says, \"<i>I'm going to save that one for our honeymoon, instead.</i>\"  Her eyes twinkle with infatuation.  \"<i>I could even pull the taint of this land out of your body and use it to make mine more lewd for you, my " + this.player.mf("knight-champion", "great lady") + "...</i>\"");
        ...
        //(corr<50)
        if (this.player.cor < 50) {
            this.outputText("\"<i>I don't think I will, though, my sooky mate... I'd rather stain you in my colors, even if it costs my body to do it.  Or, would you like me more if my proportions were modest?  You, my confident, courtly " + this.player.mf("lord", "dame") + ", and I, your worshipful, tomboyish " + this.player.mf("squire", "lady-in-waiting") + ", secretly in love with you and game to follow you anywhere and do anything for you to make you acknowledge me and accept ");
            if (this.player.hasCock()) this.outputText("my pussy");
            else this.outputText("the dick I grow for you");
            this.outputText("?  </i>Anything?<i>");
        }
        else {
            this.outputText("\"<i>... would you like that?  If my pointers were so big that all I could do was wait for you patiently as your sex-toy, your possession; growing whatever new parts you need to complement yours, relying on you and welcoming you home at the end of the day, inviting you to rest in the bosom you created after we lie together and make our babies... would that gratify you?  Would you love me then?");
        }
        this.outputText("</i>\"");

        this.outputText("\n\nSheila releases your face and looks forward again.  \"<i>I want you.  I want children with you too, if you'll ");
        if (this.player.hasCock()) this.outputText("give them to me");
        else this.outputText("have them for me");
        this.outputText(".  I dunno what could be simpler.</i>\"");

        this.outputText("\n\nShe's so fixated on having children now, more so than anyone you've met");
        //[(PC has been propositioned by Amily)]
        if (this.flags[kFLAGS.AMILY_OFFER_ACCEPTED] > 0) this.outputText(" save one.  Actually, the two are a bit reminiscent of each other..");
        this.outputText(".  Yet, any offspring a demon makes will be imps, right?");
        ...
        if (this.player.cor < 50) this.outputText("; even though you hide it, I've seen it lurking");
        this.outputText(".  Feel like flying your colors for a while?</i>\"");
    ...
    private demonSheilaTalkAnotherQuestion(): void {
        ...
        if (this.player.lust <= 99) {
            this.outputText("Sheila reaches farther down, ");
            //(cock)
            if (this.player.hasCock()) this.outputText("slipping more of her finger and thumb around your penis");
            else if (this.player.hasVagina()) this.outputText("parting your lips more");
            else this.outputText("rubbing your bare groin");
            this.outputText(" even as she smiles encouragingly.  \"<i>Sure, mate.  Amuse yourself.  I certainly intend to.</i>\"");
    ...
    private sheilaLetHerFuckYou(): void {
        ...
        if (this.sheilaCorruption() >= 40) this.outputText("pillowy ");
        else this.outputText("pert ");
    ...
    private demonImpChildren(): void {
        this.clearOutput();
        this.outputText("\"<i>[name]!</i>\"  A swishing in the grass behind you is the only prelude you get to a nude Sheila pressing herself against you in a hug, ");
        //(sheila corruption < 40)
        if (this.sheilaCorruption() < 40) this.outputText("her perky nipples rubbing into your arm as she snuggles up");
        else this.outputText("her enormous, pendulous breasts practically parting around you to wrap you up alongside her arms");
        this.outputText(".");

        this.outputText("\n\n\"<i>Guess what?  I had your baby!  He was the most darling little thing.</i>\"");

        this.outputText("\n\nShe takes your look of surprise as permission to elaborate.  \"<i>Mmm, why the wide eyes, mate?  Our people always pushed them out fast.  Except instead of tucking him into a snuggly against my tits, I tucked him into somewhere a bit... lower.</i>\"  She hugs your arm closer, fairly rubbing her pussy on the back of your hand and leaving a trail of her lube as she slides her own fingers into your [armor].  \"<i>He has his " + this.player.mf("daddy", "other mommy") + "'s cock.");
        //(if no cock)
        if (!this.player.hasCock()) this.outputText("  Or, had...</i>\" she finishes with a frown as she reaches your bare groin.  \"<i>Where'd you leave that magnificent old fella?  I was lookin' forward to another go.</i>\"  She pulls her hand out, then leans toward you with a pout.  \"<i>I'm so horny, too...</i>\"");
        //(if cock)
        else {
            this.outputText("  Still, it's not the same as having you inside me...</i>\"  She squeezes the neck of your [cock] and then pulls her hand away, slipping it between her own legs.  \"<i>I was thinking you could help me make another, and maybe up the population of men worth a damn around here.</i>\"  Reclining, she spreads her thighs, pulling apart her small, smooth labia ");
            //[(sheila corruption <=80)]
            if (this.sheilaCorruption() <= 80) this.outputText("with her fingers to make sure the invitation is all the way open");
            //(else)
            else this.outputText("with her split tail while she cradles her massive tits to make sure you see the open invitation");
            this.outputText(".  Impatiently, she rubs her stubby, drooling, phallic spade against the hole, accentuating the imagery.  You can feel the blood rushing to your groin as she gives herself shallow, teasing strokes.");
        }
        this.pregnancy.knockUpForce(); //Clear Pregnancy
    ...
    private pregDemonSheilaOtherSex(): void {
        this.clearOutput();
        this.outputText("Her eyebrows knit as you propose an alternative.  ");
        //[(if cock)
        if (this.player.hasCock()) {
            this.outputText("\"<i>Well now, I think I get a say, don't I?  I was really hoping to have your seed inside me... it's practically worth bottling.</i>\"  She ");
            if (this.sheilaCorruption() >= 80) this.outputText("heaves onto her feet, heavy breasts swaying");
            else this.outputText("nimbly hops to her clawed feet");
            this.outputText(", and runs her hands distractingly along the curves of her hips.  \"<i>You can do what you like with my body, love... if you can convince me.  Of course, I'll claim the same privilege!</i>\"  Sheila jumps at you, leaving no doubt what kind of 'convincing' she expects to do!");
            this.startCombat(new Sheila());
        }
        //(if no cock)
        else if (this.player.hasVagina()) {
    ...
    public loseToSheila(consensual: boolean = false): void {
        ...
        if (this.player.HP < 1 && !consensual) {
            this.outputText("Your erstwhile opponent's eyes glimmer with excitement as you collapse from your injuries, and she runs over to you.  The demon strips off your [armor] eagerly, but you can't stay awake for the fun.  Consciousness slips away and you pass out.");
            //--Next--
            this.model.time.hours += 8;
            if (this.model.time.hours > 23) {
                this.model.time.hours -= 24;
                this.model.time.days++;
            }
            this.menu();
            ...
            if (this.player.hasCock() && this.player.biggestCockArea() > 56)
                choices[choices.length] = this.tailSpadeSoundingForFuckHugeDongsWithDemonSheila;
            //Loss - clit-swelling and clit-sounding or clit-anal
            if (this.player.hasVagina())
                choices[choices.length] = this.clitSwellingDemonSheilaClitSoundingAnal;
            //Loss - unsexed joke scene
            if (this.player.gender == 0)
                choices[choices.length] = this.aintGotNoGenderAndKangarooRaped;
            //RUN DAT SHIT, YO!
            choices[SheilaScene.rand(choices.length)]();
        }
    }

    private loseToDemonSheila(): void {
        this.clearOutput();
        this.outputText("Eight hours later, you come to, bruised and sore... and find yourself lying on the ground with your head in Sheila's lap; she's petting your [hair] absently.  \"<i>Awake, are you?</i>\" she grins, looking down at you.  \"<i>Where did you get all those wounds, anyway?  Ya know... you can ask for my help if the wildlife's giving you trouble - we'll just go back to my place and spend all our time in the nuddy.  Our imps can bring us food and drinks.  New playmates, too.  Want to come home with me?</i>\"");
        ...
        this.outputText("\n\nStill shaken, you stand and let Sheila do the same.  She narrows her eyes at you before speaking again.  \"<i>Be more careful, mate.  The idea of my " + this.player.mf("boy", "girl") + " being fucked by trash makes me ill.</i>\"  Saying nothing more, the woman turns and leaves you to walk back to your camp.");
    ...
    private loseToNormalSheilaAndGetRidden(): void {
        ...
        this.outputText(", exposing your " + this.multiCockDescriptLight() + ".");

        this.outputText("\n\n");
        //[(multi)
        if (this.player.cockTotal() > 1) this.outputText("\"<i>All of these look ripper, but... I want this one today,</i>\" she says, selecting your [cockFit 56].  ");
        this.outputText("She wraps her hand around it and begins pumping up and down, squeezing out a drop of precum that she smears onto her palm.  \"<i>You're so eager,</i>\" Sheila giggles.  \"<i>Are you already about to burst?  That's no good... I wanted to play a bit more.</i>\"");

        this.outputText("\n\nThe demon releases your dick, watching raptly as it bobs and twitches, then scoots up to you and");
        if (this.player.isTaur()) this.outputText(", draping your forelegs over her shoulders,");
        this.outputText(" presses her " + this.sheilaCup() + " breasts");
        if (this.sheilaCorruption() < 100) this.outputText(" against you, dragging her nipples against yours.  ");
        else this.outputText(" against you so forcefully that they part around your chest.  ");
        this.outputText("\"<i>Such a " + this.player.mf("handsome bloke", "pretty sheila") + ", with such a nice dong,</i>\" she whispers, \"<i>I'm going to have to take you for a ride.  Try not to come as soon as you get in!</i>\"");

        this.outputText("\n\nSheila grins viciously and sinks down on your [cockFit 56], sliding it into her pussy at a painstaking pace");
        //[(multi)
        if (this.player.hasCock()) this.outputText(" and slipping the unused remainder of your manhood between her thighs");
        this.outputText("; you can feel every new inch of heat as she lowers her body.  The woman moans, gyrating her hips, and " + this.sMultiCockDesc() + " twitches in painful erectness.");
        ...
        if (this.player.balls > 0) {
            ...
            //(not horse)
            if (!this.player.isTaur()) this.outputText("  Sheila takes your face in her hands and presses it into her breasts as she reassures you.");
            ...
            if (this.player.cockTotal() > 1) this.outputText(" and lap");
            this.outputText(" just like she's dumping feelings into your head.  \"<i>Lover!</i>\" she screams.  \"<i>Pack me with your babies!</i>\"");
            ...
            if (this.player.isTaur()) this.outputText("forelegs");
            else this.outputText("hands");
            this.outputText(", displacing a glob of cum from her pussy that's soon followed by others as you ejaculate once more.  The jizz is so dense with sperm that it's thick, almost colloidal; it jiggles on her skin, barely sliding downward as your hips ram against hers.  It takes nearly ");
            //(normal skeet)
            if (this.player.cumQ() < 250) this.outputText("ten minutes and two");
            //(big skeet)
            else if (this.player.cumQ() < 1000) this.outputText("thirty minutes and four");
            else this.outputText("fifty minutes and eight");
            this.outputText(" more orgasms, but finally your balls empty of their demonically-induced load and your lover pulls away and stands up.");
        ...
        //(else if no balls)
            ...
            if (this.player.isTaur()) this.outputText("You force her downward with your forelegs to");
            else this.outputText("You grab her hips and");
            this.outputText(" help her impale herself on your tool.");
            ...
            if (this.player.cockTotal() > 1) this.outputText(" and lap");
            //[(big skeet)
            if (this.player.cumQ() >= 1000) this.outputText("; she quickly reaches capacity and pulls off, jerking your messy, slimy [cockFit 56] and letting you squirt the last of your strokes all over her face and chest");
            if (this.player.cumQ() >= 6000) this.outputText(".  So much is left that she's practically underwater by the time you're finished; she giggles and bubbles form in the oozing liquid covering her lips");
            this.outputText(".");
    ...
    private tailSpadeSoundingForFuckHugeDongsWithDemonSheila(): void {
        ...
        if (this.player.cockTotal() > 1) this.outputText("; unguided, the ");
        if (this.player.cockTotal() == 2) this.outputText("other twitches and sprays");
        else if (this.player.cockTotal() > 2) this.outputText("others twitch and spray");
        if (this.player.cockTotal() > 1) this.outputText(" all over, coating her back, you, the grass, and anything ");
        if (this.player.cockTotal() > 2) this.outputText("else they happen to point at");
        if (this.player.cockTotal() == 2) this.outputText("else it happens to point at");
        this.outputText(".  Your hips automatically try to push your dick further into her warm hole but only succeed in unbalancing her, forcing the demon onto her hands.  As your climax winds down, your head leans back and your cock slips from her vulva, squirting the last stroke onto her ass.");
    ...
    private clitSwellingDemonSheilaClitSoundingAnal(): void {
        this.clearOutput();
        //(no horse)
        if (!this.player.isTaur()) this.outputText("Sheila places her hand in the small of your back and leans in, drawing closer to your face even as she pulls your waist inward.");
        else this.outputText("Sheila sets her hand atop your withers, pressing down gently as she looks into your eyes.");
        this.outputText("  \"<i>Why don't you relax, [name]?  Lie down and let me take care of you...</i>\"  Her eyelids lower and her mouth spreads in a sly smile, and for just a moment you lose your nerve, looking into her devilish expression.  \"<i>Don't worry, love,</i>\" she says, straightening her face.  \"<i>I promise you'll enjoy this.</i>\"");

        this.outputText("\n\nBefogged but still reserved, you nonetheless allow Sheila to lower you to the grass and remove your [armor].  She ");
        //[(not horse)
        if (!this.player.isTaur()) this.outputText("turns around, then straddles your groin and looks over her shoulder.");
        //(Equus ferus caballus)
        else this.outputText("circles you until she reaches your rump, then turns around and kneels down herself, looking at you over her shoulder.");
        this.outputText("  Her black, spaded tail lifts from between her thighs and snakes toward your pussy,");
        //[(if manparts)
        if (this.player.hasCock()) {
            this.outputText(" caressing ");
            if (this.player.balls > 0) this.outputText("your [balls]");
            else this.outputText("the underside of your [cock biggest], before");
        }
        this.outputText(" forcing your lips apart and lingering on your rapidly-swelling " + this.clitDescript() + ".  \"<i>Oh, my.  What's with this ");
        if (this.player.clitLength <= 6) this.outputText("lewd little");
        else this.outputText("grotesque");
        this.outputText(" thing doing growing from a pretty girl like you?  It's just the perfect size for some fun.</i>\"");

        this.outputText("\n\nYour eyes open in alarm at the same time as her mouth does in pleasure; she jams the slit of her spade onto your button");
        if (this.player.clitLength > 6) this.outputText(", taking it several inches deep");
        this.outputText(".  Your head swims as pleasure from your engulfed clitoris overwhelms you, then toes the line to genuine pain.  The copious demonic fluid backing up inside her tail begins to leak around the tip, coating your clit and drooling onto your labia; your muscles tighten as the heat escalates past comfortable levels, and you begin shifting violently, trying to pull your swollen chick-stick free from the demon's anatomy.  \"<i>Ah, ah, god, [name], stop!  Don't thrash so!  You're teasing me too fast!</i>\"  Sheila's words are lost on you, sunken as you are into a hell of oversensitized skin and constant stimulation.  It feels like the nerves exposed to the torment are even multiplying, as if skin you weren't even feeling before suddenly appears to be immersed into the tainted slime.");
        ...
        //[(<=6")
        if (this.player.clitLength <= 6) this.outputText("\n\nAwareness comes to you slowly; that flesh is your clitoris, gratuitously mutated by Sheila's fluids!");
        else this.outputText("Though you're by now accustomed to the sight of your clitoris, more like a cock than a dainty feminine bump, this is something else altogether!  The huge thing poking into her tail is almost twice the thickness of the slim growth you remember and bulges with blood vessels; as you watch it, transfixed, a trickle of Sheila's oily, dark secretion slides down it, then is absorbed into some flesh near your groin, adding another layer of width with a pulse!");
        this.outputText("  \"<i>Fuck, it's so tight!</i>\" the demon gasps, now resting on her elbows with her chest and face pressed to the grass.  Her tail jerks again, yanking your stalk this way and that and releasing more of her backed-up fluids.  They slide all the way to the bottom of your rod before sinking into your skin.");
        ...
        if (this.player.clitLength <= 6) {
            ...
            if (!this.player.isTaur()) this.outputText("Taking your face into her hand, she closes your jaw and then leans in to plant a kiss on your chin.");
            else this.outputText("Her eyes glitter with mirth.");
            this.outputText("  \"<i>Why the look, mate?  Seems like you're saturated for now, and just in time.  This... is...</i>\"  She pulls her tail up from the end of your clitoris, then slides it back down, slowly.  \"<i>... perfect!</i>\"  As her tight hole swallows your sensitive distaff staff once again, your eyes roll and her head drops, dragging her hair");
            //[(horse)
            if (this.player.isTaur()) this.outputText(" through the grass");
            else if (this.player.biggestTitSize() >= 1) this.outputText(" between your " + this.allBreastsDescript());
            else this.outputText(" along your flat chest");
            this.outputText(".  \"<i>Ffuck, even your girl parts are amazing.</i>\"  Sheila plants kiss after kiss on your ");
            if (!this.player.isTaur()) this.outputText("[chest]");
            else this.outputText(this.buttDescript());
            this.outputText(" as she shallowly pumps your " + this.clitDescript() + " in and out of her spade.  Your pelvis twitches uselessly; with her tail waving in the air instead of braced against her, controlling the pace of the fuck is beyond you.  \"<i>Naughty sheila,</i>\" she says, squeezing your wiggling hip with a hand.  You think privately that she could just as easily be talking about herself.  \"<i>Am I not going fast enough for you?  Let me speed up.</i>\"");
        ...
        //(else if clit >6" initially)
            ...
            //[(horse)
            if (this.player.isTaur()) this.outputText(" and rolls onto her back");
            this.outputText(", then wraps her tails around your thickened clit.  They twist and pull, sending spirals of pleasure along the numerous nerves, and begin gently but insistently tugging you toward her tan butt.  Sheila directs the tip right between her cheeks, and you can feel her using it to rub the ring around her hole.  \"<i>I think this should be about the right size for you, love,</i>\" she teases, spearing herself on your " + this.clitDescript() + ".  Inch after inch slides into her slowly, maddening you with warmth, until ");
            if (this.player.clitLength <= 12) this.outputText("all of it is in her bowels and her hot cunt rests against yours");
            else this.outputText("she's taken as much as she can");
            this.outputText(".  She half-smiles and half-winces at you.  \"<i>Don't usually take it in this hole, but I wanted to feel your pussy going crazy for me.</i>\"  ");
            if (this.player.clitLength <= 12) this.outputText("Her hips shift, dragging her lips across yours and stirring your clit through her asshole even as it squeezes you; your pussy twitches at the stimulation.");
            else {
                this.outputText("Her tails, one still swollen from being stretched and tormented by your growing clit, slip into you abruptly, bringing their mild burning sensation with them; if you hadn't been saturated with it already, you'd probably pass out.");
                //[(if virgin vagina)
                if (this.player.hasVirginVagina()) this.outputText("  \"<i>What's this?</i>\" Sheila teases.  \"<i>Why, your virtue is still intact, little girl!  I wouldn't want anything to happen to it!</i>\"  She pulls her tails out a bit, contenting herself with simply teasing your lips and driving you mad for penetration.");
                this.outputText("  The demon shifts around your clit, sending a wave through you that makes your lips wrap around the invaders.");
            }

            this.outputText("\n\nSheila places her long-taloned feet against ");
            //(not naga)
            if (!this.player.isNaga()) this.outputText("your thighs, spreading your [legs] wide and then hooking them over top to touch ");
            this.outputText("the ground next to your ass, and uses the leverage to begin pumping your clit out of and into her asshole, caressing your " + this.vaginaDescript(0) + " every time she slides home.  \"<i>I could get used to this, love.  What say I keep you dosed up like this and you become my dildo?  I'll ride you with a different hole every time!</i>\"  Your eyes roll back in your head, at least partially from the irregular pace at which she's stroking your clit.  Sheila grabs her breasts as she slows down drastically once again, mashing them with her hands and sinking onto you an inch at a time.  \"<i>Fuck... I love your junk, [name].  Maybe I should catch a goblin, too, and make her tease my pussy while you fill my ass.</i>\"  She raises back up and ");
            //[(clit>12")
            if (this.player.clitLength > 12) this.outputText("pulls her black tail free, dripping with your juice, then ");
            this.outputText("begins to work her drooling spade along your clit again, smearing her goo along your chunky chick-stick.  You can feel the edges of the stretched hole in her tip working on your skin, opening and closing ever so slightly as her copious tainted lube oozes out.  Your " + this.clitDescript() + " must be completely saturated already, because the slippery goo lingers on the surface instead of wicking into it.  \"<i>Gonna g-get you nice and wet, love...  Ohh,</i>\" Sheila says, affected to distraction by the pleasure of tracing the slick end of her stubby tail along you.");

            this.outputText("\n\nFinally coating you to satisfaction with the oily secretions, Sheila begins pumping again.  The heated friction from before evaporates, replaced with a dull, distributed warmth as she slides her asshole along your clit.  With less resistance, she's able to up the tempo to frantic, scraping along the ground so fast that she begins to tear up the grass.  You bear up as much as you can under the onslaught of pumping and gyrating hips, but eventually the sensation is too much, and your nerves take over as your climax begins.  Your " + this.vaginaDescript(0) + " spasms, drooling onto her ");
            if (this.player.clitLength <= 12) this.outputText("pussy; her smooth, small labia greedily lap at the fluid when they touch, brushing against yours and drawing further twitches and squirts.");
            else this.outputText("teasing tails; they shift from stroking your labia to holding them open, allowing your pussy to squirt as it pleases.");
            this.outputText("  Suddenly she stops mid-stroke as her asshole quivers, sending shivers up your orgasm-sensitized clitoris.  \"<i>Fffuck!  So soon!  I'm coming too, [name]!</i>\"  Sheila sinks down, burying your " + this.clitDescript() + " into her asshole.");
            //(clit>12")
            if (this.player.clitLength <= 12) {
                this.outputText("  Her tails sink into you as she squirms, parting your lips and pushing their way inside.");
                //[output hymen check, but don't remove virgin flag yet]  
                if (this.player.hasVirginVagina()) this.outputText("  <b>You've lost your virginity!</b>");
                this.outputText("  Buried in your pussy, the spade begins drooling its black fluids in greater and greater volume as Sheila is wracked by her orgasm.");
            }

            //(PC corr<50)
            if (this.player.cor < 50) {
                this.outputText("  The demon's pussy gushes and pours with unnatural levels of fluids, soaking your crotch as a miniature cataract makes its way out of her lower lips.  Sheila spills herself onto you for at least a minute, producing more hot fluid than you thought possible, until she looks utterly dehydrated - even her breasts seem to be smaller and less jiggly.");
            }
            else this.outputText("  The demon's skin seems to parch as she grinds into you relentlessly, evaporating your fluids so fast that most of them don't even have time to fall.  Her hot flesh lays heavily across your netherlips, prolonging your climax and coaxing out more fem-spray than you thought was in you.  Even your mouth seems to dry as she drinks your essence up.");
            ...
            if (this.player.clitLength > 12 && this.player.hasVirginVagina()) {
                this.outputText("  \"<i>Sorry about your hymen, love, but I just couldn't resist making a sweet little slut like you into my girl.  I hope you'll remember me - I only wish I had a proper donger so I could give you my baby, too.</i>\"");
            }
            this.outputText("  Even as tired as you are, what you see on the demon girl makes you laugh.  She starts at this, then follows the direction of your gaze; ");
            if (!this.player.isTaur()) this.outputText("her tits are covered by grass stains from her frenetic pumping.");
            else this.outputText("craning around shows her that her asscheeks are completely green and wet with torn grass from slamming into you so violently and repeatedly.");
            this.outputText("  \"<i>... Oh, god dammit,</i>\" Sheila gripes.  She walks over and forces your face into them with a long, slow shake, then giggles as a joke comes to her.  \"<i>There, [name]; I've stained you with my colors!</i>\"  She plants a long kiss on your grass-smeared forehead, then drops you back to the ground, straightens up, and departs.  Exhausted, you slip into a doze, wondering if you'll be able to fit your swollen clit back into your clothing when you wake or if you'll have to walk back to camp with it sticking out.  It slowly deflates as you sleep, but does retain a bit of additional length.");
        }
        ...
        if (this.player.clitLength > 12 || this.player.cor < 50) {
            this.player.cuntChange(12, false, false, false);
            this.player.slimeFeed();
        }
        this.player.clitLength++;
        if (this.player.findPerk(PerkLib.BigClit) >= 0) this.player.clitLength += .5;
        if (this.player.cor < 50) {
            this.dynStats("cor", 10);
            this.sheilaCorruption(-10);
        }
    ...
    private aintGotNoGenderAndKangarooRaped(): void {
        this.clearOutput();
        this.outputText("Sheila sashays over to you and brazenly sticks her hand in your featureless crotch.  \"<i>It's too bad you've mutilated yourself like this, love... or did you do it just to tease me?  You know, it doesn't bug me that much.</i>\"");
    ...
    public beatUpDemonSheila(output: boolean = true): void {
        if (output) {
            this.clearOutput();
            this.outputText("\"<i>Ahh, you win, mate.  I give up.</i>\"  Sheila slumps to the ground, ");
            if (this.monster.HP < 1) this.outputText("and her wounds begin to close with a soft lilac glow.  \"<i>So fuckin' strong.  I don't suppose you've got any sperm for me, do you?  I'd love to have some of your kids...</i>\"  She looks at you beseechingly, gently fingering herself.");
            //(lust)
            else this.outputText("frigging herself vigorously.  \"<i>Do with me what you will, lover; those were the terms.  Won't you take my body to satisfy yourself, you brute?</i>\"  The audacious woman sticks her tongue out, as if to goad you into treating her roughly.");
        }
        //[(lust < 30)]
    ...
    private missionaryForThePurposesOfCreatingImpsWithSheila(): void {
        this.clearOutput();
        this.outputText("You unfasten your [armor] and strip down completely, as Sheila's eyes drink up your bare flesh.  Denuded, you caress your cock with several strokes, producing a drop of precum.");
        ...
        if (this.player.cor < 40) this.outputText("Your ardor subsides a bit at her performance, but seeing your look of contrition, ");
        else this.outputText("Your scowl hardens at her shameless playacting, and ");
        this.outputText("she breaks into laughter.  \"<i>I'm just having you on, love.  You know my body's yours for the using.</i>\"");
        ...
        if (!this.player.isTaur()) this.outputText("shoulders");
        else this.outputText("flanks");
        this.outputText(" and her pupils dance in excitement; for a moment you even lose yourself in her enthusiasm, forgetting her demonhood and seeing only an earnest, adoring girl under you.  \"<i>Now, push!</i>\"");
        ...
        //(sheila corruption >=40)
        if (this.sheilaCorruption() >= 40) this.outputText("and her soft breasts jiggle ");
        this.outputText("as a twinge of sensation from your thrust provokes a gasp and forces her to reposition herself, to better find it again.  \"<i>That's the spot!  Your dick is the <b>best!</b>  Pound me, you fucking cum-hose!</i>\"");
        ...
        if (!this.player.isTaur()) this.outputText("arms");
        else this.outputText("forelegs");
        this.outputText(" wobble and it takes all your focus not to collapse onto the woman and melt into a boneless puddle; there's little left to prevent your twitching hips from granting her request, and you slam your pelvis into hers repeatedly, provoking delighted cries from your shameless partner.  \"<i>Ohh, yes!  Fill me with your baby batter, asshole!</i>\"  Sheila wraps her arms and legs around your back");
        if (this.player.isTaur()) {
            this.outputText(", practically lifting herself off of the ground] as she impales her cunt on your [cockFit 56] to prevent you from pulling out.");
        }
        //[(silly)
        if (this.silly()) this.outputText("  \"<i>Make me feel like I'm fifteen years old again and playin' with the dog-morphs in the field!</i>\"  Heavens to Betsy!");
        else this.outputText("  \"<i>This is what you're here for!  Don't spill a single drop!</i>\"");
        ...
        if (this.sheilaCorruption() < 40) this.outputText("tight");
        else this.outputText("soft");
        this.outputText(" chest against you");
        if (this.player.isTaur()) this.outputText(" as you slump forward");
        this.outputText(".  Your cock ");
        if (this.player.cockTotal() > 1) {
            this.outputText(" and its ");
            if (this.player.cockTotal() == 2) this.outputText("brother");
            else this.outputText("brethren");
            this.outputText(" swell and squirt");
        }
        else this.outputText("swells and squirts");
        this.outputText(", pouring your semen into Sheila's ravenous pussy");
        if (this.player.cockTotal() > 1) this.outputText(" and coating her crotch with a glaze of white");
        this.outputText("; her eyes glow and it briefly feels as though her body is sucking the ejaculate right out of you");
        if (this.player.cumQ() >= 500) this.outputText(", until she fills up and the rest of your orgasm is drooled out at its own lazy pace");
        this.outputText(".  She kisses you");
        if (this.player.isTaur()) this.outputText("r forelegs");
        this.outputText(" lovingly and deeply");
        if (this.player.cockTotal() > 1 || this.player.cumQ() >= 500) this.outputText(" as the spare seed dribbles from her crotch");
        this.outputText(", then breaks away and looks up into your face.");

        this.outputText("\n\n\"<i>[name], you ");
        if (this.player.cumQ() >= 500 || this.player.cockTotal() > 1) this.outputText("spilled some.  I can't have your baby if you're fucking the grass.  And you ");
        this.outputText("came too soon; I wasn't done.</i>\"");
        ...
        if (SheilaScene.rand(10) <= 6) {
            this.outputText("I used a bit of power to help you finish.  Don't hate me for it; your orgasm face is just so cute when you're giving up your seed to me.</i>\"  The woman places her hand on her stomach, below her navel.  \"<i>Thank you for this.  I hope it takes, so I can raise a big strong imp to be just as " + this.player.mf("productive as his father", "sexy as his mother") + ".</i>\"  She kisses you softly again, and you roll off with a groan.  \"<i>Your sperm are the best,</i>\" Sheila whispers, \"<i>so come see me again soon.  I'll be wantin' more.</i>\"  Your demon stands up and winks at you, then walks off, tails swishing happily as a trickle of white runs down the brown skin of her naked thigh.");
            //(end scene)
            this.player.orgasm();
            this.dynStats("lib", -1);
            this.sheilaPreg();
        ...
        //(else if RNG doesn't end scene)
            ...
            //[(PC corr <50)
            if (this.player.cor < 50) this.outputText("Her pussy convulses as she orgasms, and you feel a wave of heat overtaking your [cock biggest], starting at the tip and moving down the shaft.  As it reaches the base, a gush of her fluids breaches the seal her pussy makes around you, forcing your jizz out along with it in a mixed white and clear squirt.  The demon's vagina squeezes and drools for half a minute, pouring her tainted liquid love out against your tightly-held body until your crotch is soaked with her sticky heat and responds with its own.");
            else this.outputText("Her pussy sucks you in as she climaxes, and you can feel larger and larger waves of precum being pulled from your shaft; it almost feels like she's tugging at your entire being.  It's not long before your cock twitches and begins giving her greedy sex a second helping of your semen.");
            this.outputText("  She goes limp as her twitching cunt takes over and begins drinking every drop it can get from your dick to replace the goo you pushed out");
            if (this.player.cumQ() >= 500) this.outputText("; you nearly manage to fit it all into her this time, with your production still flagging from the last session");
            this.outputText(".  Muscles weakening again, you lower yourself onto her once more and allow her to stroke your ");
            if (!this.player.isTaur()) this.outputText("back");
            else this.outputText("sides");
            this.outputText(" as she cools down.");
            ...
            this.dynStats("lib", -1);
            this.player.slimeFeed();
            if (this.player.cor < 50) this.player.slimeFeed();
            if (this.player.cor < 50) {
                this.dynStats("cor", 10);
                this.sheilaCorruption(-10);
            }
    ...
    private analHateFuck(): void {
        this.clearOutput();
        this.outputText("Fucking bitch, playing with herself like nothing's the matter and you didn't just show her concrete proof of your superiority.  Part of you feels like punishing the insolent woman yourself, pounding her insides and dumping your load without a whit of regard for her own pleasure... but another part is thinking it might be fun to see her completely debased, to hammer home how pathetic she is - something like reducing her to a cock-sleeve for your personal cum-slave.");
    ...
    private sheilaAnalHateFuckAGoGo(): void {
        this.clearOutput();
        this.outputText("Your [cockFit 56] gets hard in your [armor] as you watch her diddle her pussy, but you set your jaw to resist giving her what she wants - a better idea is taking shape in your head.  \"<i>Turn around,</i>\" you demand.");
        ...
        if (!this.player.isTaur()) this.outputText("Slipping one hand around your [cockFit 32]");
        else this.outputText("Straddling her");
        this.outputText(", you pull your hips back and line the [cockHeadFit 32] up, then thrust - right into her asshole.  Her head raises and her teeth grit as you force the slick tip past her ring.  \"<i>[name], what the fuck?!  That hurts!  Go easy if you're going to use that hole; I'm not good at stretching my body yet!</i>\"");

        this.outputText("\n\n\"<i>No.</i>\"  You ");
        //(not centaur)
        if (!this.player.isTaur()) this.outputText("grab her thrashing legs, using them for leverage as you ");
        this.outputText("force your dick into the angry woman.  \"<i>You talk a good game about how you love being full of cock, but when I shove one in you, you get all bitchy and act like you're not ready; why don't you just shut up and get fucked, slut?</i>\"");
        ...
        if (this.sheilaCorruption() >= 90) this.outputText("; her enormous, cushiony breasts spread under her as your prick forces her weight heavily onto them");
        this.outputText(".  She pulls up tufts and pounds the earth impotently with her fists while you sink in as far as you can.  \"<i>Fuck you!  What the fuck is wrong with you, arsehole?!  Let me go, I don't want anything to do with you anymore!</i>\"");
    ...
    private sheilaAnalHateFuckAGoGoNO(): void {
        this.clearOutput();
        this.outputText("\"<i>Go to hell.</i>\"  You bury yourself in the demon's ass as your dick begins to spasm.  Her tails writhe as the first trickle sinks into her.  \"<i>What?  Say something, I dare you.</i>\"");
        ...
        if (this.player.cumQ() >= 500) this.outputText("  Your overproduction floods her insides, and Sheila groans as it begins to leak back out, drooling over her pussy.  \"<i>Hey, you got your wish,</i>\" you tease.  The wanton woman tries to tilt her ass higher, to tip more of your overflow into her cunt, but you laugh and slap her hard on the hip, sending her to one knee again.");
        ...
        if (this.player.cumQ() < 250) this.outputText("trickle");
        else if (this.player.cumQ() < 1000) this.outputText("stream");
        else this.outputText("waterfall");
        this.outputText(" of semen made when her body pushes out some of the foreign substance.");
    ...
    private sheilaAnalHateFuckAGoGoGETYOUSOMEWORMS(): void {
        this.clearOutput();
        this.outputText("\"<i>Mmm...</i>\" you answer, noncommittally.  Your ");
        if (this.player.balls > 0) this.outputText("[balls]");
        else this.outputText("insides");
        this.outputText(" squirm, giving you pause, and you pop your [cockFit 56] out.  \"<i>Actually... I don't think I suit you at all.</i>\"");
        ...
        if (this.player.balls > 0) this.outputText("[sack]");
        else this.outputText("[cockFit 56]");
        this.outputText(", you can actually feel your pent-up pets, eager to be let out to play.  \"<i>No,</i>\" you say, \"<i>I know what's more your speed.  Trash like you should be cast down into the dirt, and should keep company with the creatures of it.</i>\"  Sheila seems alarmed, but as you slip into her grasping pussy, she forgets her question, grinding her hips into you to milk you dry.  You focus, forcing a wave of slimy annelids down your shaft.  \"<i>Here come your new babies!</i>\"");
    ...
    private analHateFucksWithJojo(): void {
        this.clearOutput();
        this.outputText("Watching her sit there and play with herself like nothing's the matter and you didn't just demonstrate her weakness for all the world to see touches a nerve deep inside you.  You scowl and focus your thoughts to call your mousey ex-monk, bent on showing this demon how a proper mendicant should behave.");
        ...
        if (this.sheilaCorruption() < 40) this.outputText("\"<i>What's with these tiny titties?  Could any man possibly be aroused by your bug bites?  I've seen bigger breasts on incubi!</i>\"");
        else this.outputText("\"<i>These disgusting sacks of fat on your chest... are you under the impression that men like giant stretch marks and nipples that hang to your knees?  Why don't you get in shape, you messy bitch?</i>\"");
    ...
    private jojoRuinsTheAnalHateFuck(clear: boolean = true): void {
        ...
        this.outputText("Your mouth spreads in a sickly smile as you contemplate granting her request anyway.  \"<i>Jojo...</i>\"");
        ...
        if (this.sheilaCorruption() >= 90) this.outputText(", mashing her tits together as they thicken");
        this.outputText(".  The mouse himself seems to be growing, in fact.  His feet kick and thrash, sprouting dangerous-looking nails as his legs stretch prodigiously.  As his body mass increases, his white-furred skin begins to burst and peel like old rags, revealing new, dark flesh underneath.");
        ...
        this.dynStats("lus=", 100, "cor", 10, "resisted", false);
        this.flags[kFLAGS.SHEILA_DISABLED] = 4;
    ...
    private bigDickAndThighs(): void {
        this.clearOutput();
        this.outputText("As Sheila diddles herself, you ");
        //[(not horse)
        if (!this.player.isTaur()) {
            this.outputText("doff your [armor]; the demon's eyebrows climb as you haul out " + this.sMultiCockDesc());
            if (this.player.cockTotal() > 2) this.outputText(" one at a time, practically stacking them atop each other");
            this.outputText(".");
        }
        //(horse)
        else {
            this.outputText("slowly draw nearer to her, your " + this.multiCockDescriptLight() + " bobbing with each step.");
        }
        ...
        if (this.player.cor < 40) {
            ...
            this.outputText(" toward her and aim underneath her cunt to rub your [cockHead biggest] against her palm, smearing a glob of precum on it.  You can see her shivering wordlessly, sliding her fingers together to play with the hot, clingy fluid, making translucent webbing between them.");
            //[(multi)
            if (this.player.cockTotal() > 1) {
                if (this.player.cockTotal() == 2) this.outputText("  Both");
                else this.outputText("  All");
                this.outputText(" of them... slide them here, love,</i>\" the demon insists.  You line the remainder of your manhood up and force it between her thighs as well.");
            }
            this.outputText("  She takes the tip of your [cock biggest] in her hand and pulls gently, coaxing your forward; you close the distance until " + this.sMultiCockDesc() + " is peeking through her legs and your crotch is pressed against hers.");

            this.outputText("\n\n\"<i>I'm going to borrow a bit of your sensation...</i>\" Sheila announces quietly.  ");
            //[(not horse and not < 5"0)
            if (!this.player.isTaur() && this.player.tallness >= 60) this.outputText("She unbends and kisses you on the cheek, and your face feels a bit fuzzy where her lips touch.  ");
            ...
            if (this.player.isTaur()) this.outputText(", unseen");
            this.outputText(".");
            ...
            if (this.player.cockTotal() == 1) this.outputText("your dick with both");
            else this.outputText("a prick in each");
            this.outputText(" and angling upward so the precum drools downward and lubes her fingers.");
        }
        //(else corr >= 40)
        else if (this.player.cor >= 40) {
            ...
            if (this.player.cockTotal() > 1) {
                ...
                if (this.player.cockTotal() == 2) this.outputText(", you slide it through her legs between your first cock and her cunt, plowing through her entrance like a furrow; she quakes and you can feel it contracting against your skin.  ");
                else this.outputText("s, you push them through the woman's legs one by one, smearing warm precum on her thighs as you do; her pussy squeezes against the top of your [cock biggest] as you coat her skin with your fluids.  ");
            }
            else this.outputText("\n\n");
            this.outputText("Sheila scoots backward, choking up on monster cock until her ass is pressed against your crotch, and then wraps her hands around and begins to masturbate you, using your drooling fluid and her own wetness for lubrication.");
        ...
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(" and teasing each one; you thrust weakly into her hand, helping guide her hands, but your lonely tip wants for stimulation.  As the feeling becomes so acute that you prepare to say something, Sheila uncannily anticipates you and scoots her pussy along your shaft, popping your [cockHead biggest] into her mouth.  Her tongue dabs at your slit, tasting your fluid, and her hands ");
        if (this.player.cockTotal() > 2) this.outputText("relinquish your other pricks and ");
        if (this.player.cockTotal() == 2) this.outputText("relinquish your other prick and ");
        this.outputText("focus on squeezing more drops out of you.  She fairly coats her lips with it, rubbing your hole against them before popping the whole [cockHead biggest] back into her mouth.  A moan escapes you just as another one returns from Sheila's throat, transmitted through your [cock biggest].");
        ...
        //[(sheila corruption < 50)
        if (this.sheilaCorruption() < 50) this.outputText("  Though her modest breasts can't even begin to encompass your girth, Sheila rubs her cleavage along your skin with gusto while she works your tip with her tongue.");
        else if (this.sheilaCorruption() < 150) this.outputText("  Her large " + this.sheilaCup() + " breasts encompass your girth easily, and she pushes the soft, flushed skin together as she slides it up and down your cock.");
        else {
            this.outputText("  The demon's ridiculously enormous breasts easily cover the entire length of your cock");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" falling between her crotch and her mouth, making her whole body feel like a huge, wet fuckhole");
            if (this.player.cockTotal() > 1) this.outputText(" built for " + SheilaScene.num2Text(this.player.cockTotal()) + " pricks");
            this.outputText(".");
        }
        ...
        if (this.sheilaCorruption() >= 150) {
            this.outputText("Her enormous breasts dangle all the way to the ground, forming a second, softer hole to push into with your swollen prick");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(".  ");
        }
        this.outputText("\"<i>Y-yes,</i>\" she mumbles, \"<i>gonna fuck her... harder...</i>\"");

        this.outputText("\n\nThe apparent answer to your question passes you by as you obliviously force your tool");
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(" through the vise of her legs; losing yourself further and further to pleasure, you don't even notice when Sheila's hips begin to buck in time with your own, pressing her mons down against your ");
        if (this.player.cockTotal() > 1) this.outputText("topmost ");
        this.outputText("dick.  With an enormous, final thrust, you mash your crotch up against hers and begin to ejaculate.  ");
        if (this.player.cor < 50) this.outputText("The sensation seems to reawaken Sheila; she angles her body up to press her pussy close and your embezzled sensation floods back into you - along with an unexpected gift.  You can feel your... no, <i>her</i> demonic pussy convulsing repeatedly, trying to suck up sperm in vain as her own orgasm comes off, and she looks at you with sly eyes.  \"<i>A little reciprocity for my love,</i>\" the woman coos, \"<i>to show you how much I care.</i>\"");
        else this.outputText("\"<i>Oh god!</i>\" Sheila shrieks.  \"<i>I'm coming!  Jizz is going everywhere!</i>\"  Indeed, as your body releases streams of cum, Sheila directs them by aiming " + this.sMultiCockDesc() + ", covering herself and moaning as her hands press out as much as possible.");

        this.outputText("\n\nFinished, you pull your sensitive, soaked shaft");
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(" from between her still-squeezing thighs with a shudder; Sheila shudders with you until you finally draw free and break skin contact, then lowers herself carefully to the ground.  The demon turns toward you, exposing a face and chest splattered with your semen.  She stares at your deflating prick");
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(", looking almost wistful to see ");
        ...
        if (!this.player.hasVagina()) this.outputText("to grow a nice pussy for me so that ");
        this.outputText("I can put it in you any time I want.</i>\"  She sticks her tongue out at you, and the seed dripping from her lips oozes onto it.");
    ...
    private winAgainstDemoNSheilaForVaginas(): void {
        this.clearOutput();
        this.outputText("You drop onto the woman's lap without hesitation, ");
        if (!this.player.isTaur()) this.outputText("mauling her tits roughly with your hands, ");
        this.outputText("and grind your pussy desperately against her midriff.  She slips two fingers into you obligingly, but you ");
        if (!this.player.isTaur()) this.outputText("grab her face, plunging one thumb into the corner of her mouth in your haste, and");
        else this.outputText("turn your head and");
        this.outputText(" stare right into her eyes.  Focusing as hard as you can on your fantasy, you try to transmit your desire for something more to the demon by sheer force of will.  A sly smile parts her lips as she stares back - could this actually work?");
        ...
        if (!this.player.isTaur()) {
            this.outputText("crawl away on your hands");
            //[(tail or naga)
            if (this.player.tailType > TAIL_TYPE_NONE && this.player.isNaga()) this.outputText(" and raise your tail");
        }
        else this.outputText("clamber to your hooves and bend your forelegs");
        this.outputText(" to present your eager [vagina].  Sheila sits up and places her hands on your [hips], then slides her pelvis up, teasing your lower lips with something bulbous and warm.  They sting slightly as it smears its slime along them, a not-entirely-pleasant sensation.");
        ...
        this.outputText("  Oh, god, it burns!  You shake violently as your pussy is assaulted by the fluid from Sheila's black tail, waves of pain twisting through it and forcing its walls to clamp down on the invader.  The demon gasps as you squeeze and leans forward onto your back");
        if (this.sheilaCorruption() > 0) this.outputText(", squashing her tits into you");
        this.outputText(".  \"<i>Calm down!</i>\" she barks, grabbing your arms and pulling them toward her.  With hands held behind you like this, you can do little to check her enthusiasm... but Sheila doesn't begin thrusting yet.  \"<i>It'll fade soon, love, and you'll start feeling it,</i>\" she promises, kissing your ");
        if (!this.player.isTaur()) this.outputText("neck");
        else this.outputText("withers");
        ...
        //[(lib <20)
        if (this.player.lib < 20) this.outputText("even as proud as you are, ");
        this.outputText("there's something appealing about the picture, something powerful in being cherished and used in equal measure.  Sheila screams and releases your hair, digging her fingers into your hips, spraying the inside of your pussy with a thick, oozing heat that spreads out and then dulls as your own pouring juices force her cum out.  Peering between your legs, you can see it falling to the ground; viscous black sludge that bubbles and steams as if it were trying to reach back up to your sex.");
        if (this.player.cor < 50) {
            this.outputText("  She pumps and pumps again, forcing more of the muck into your [vagina] even as she calls you the most filthy things she can think of");
            if (this.sheilaCorruption() > 0) this.outputText("; her tits wobble violently as she thrusts, and then still as she arches her back and jams her spade all the way in");
            this.outputText(".  Sheila howls to the sky as she pours her demonic slime into you in one final, solid stream.  You can feel it pushing eagerly through even your copious fluids until it's at the entrance to your womb... and then inside.");
            //[fertility up if not capped; tingle deep within body, instinctively you know you have become blah blah]
            if (this.player.fertility < 50) {
                this.outputText("  There is a tingle deep inside you, making you more fertile.");
                this.player.fertility++;
            }
        }
        else {
            this.outputText("  She stops pumping, falling against your back and panting as the last of her goo seeps out and is ejected around her shaft by your fountainhead of girl-cum.  You are clearer-headed than before as your orgasm dwindles, though, illogically, you could swear you felt her tits growing against you.");
        }
