...
"KeltOff" - Turns off Kelt */
    ...
    private bowSkill(diff: number): number {
        this.player.addStatusValue(StatusAffects.Kelt, 1, diff);
        if (this.player.statusAffectv1(StatusAffects.Kelt) >= 100) this.player.changeStatusValue(StatusAffects.Kelt, 1, 100);
    ...
    public keltEncounter(): void {
        ...
        //Repeated encounter
            ...
            //Centaur bad end
            if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR && this.player.statusAffectv2(StatusAffects.Kelt) >= 100 && this.player.gender > 1) {
                if (this.player.inte > KeltScene.rand(40) && this.player.statusAffectv2(StatusAffects.Kelt) < 130 && this.player.findStatusAffect(StatusAffects.KeltBadEndWarning) < 0) {
            ...
            if (this.player.statusAffectv3(StatusAffects.Kelt) == 4 && this.player.findStatusAffect(StatusAffects.NakedOn) < 0) {
                this.keltRequiresNakedness();
                return;
            }
            //60+ Submissiveness—First Time Blowjob Requirement
            if (this.player.statusAffectv2(StatusAffects.Kelt) >= 40 && this.player.findStatusAffect(StatusAffects.KeltBJ) < 0) {
    ...
    private keltEagerlyGetNaked(): void {
        ...
        if (this.player.gender == 1 && this.player.biggestTitSize() < 1) this.outputText("\"<i>What are you, a girl?  Get on with it so I can see what I'm dealing with.</i>\"\r\r", false);
        else {
            if (this.player.biggestTitSize() == 0) this.outputText("\"<i>Oops!  Could have sworn I'd find a pair of tits on you.  That's okay... I'm sure you'll hit puberty some day!</i>\"\r\r", false);
            //(Too small, A to DD: 
            else if (this.player.biggestTitSize() <= 5) this.outputText("\"<i>Ha! No wonder you cover up like a sniveling human!  Any centaur maiden would be ashamed to go out in public with " + KeltScene.num2Text(this.player.totalBreasts()) + " mosquito bites like that!  What do they call you back home... 'Tiny Tits'?  Or maybe they all just assume you're a guy!</i>\"\r\r", false);
            //(Medium, E to HHH:
            else if (this.player.biggestTitSize() <= 11) this.outputText("\"<i>Uh oh, boys... look out!  Miss Melons here has been putting on a little weight!  How did someone like you become an adventurer?  From the waist up, you're good for whoring and not much else!</i>\"\r\r", false);
            //(Big, Watermelon and beyond:
            else this.outputText("\"<i>Oooh, doesn't that look yummy?  Be honest... you wanna learn to shoot?  You'll be slapping yourself in the tits with every shot!  Heh... I bet that's the way you like it too!  Time to change your profession, slut.  Wet nurse and milk cow... they're just about all you're suited for!</i>\"\r\r", false);
        }
        ...
        if (this.player.buttRating < 6) this.outputText("\"<i>Well, someone works out!  Got a nice, tight little ass there! Probably a little too tight, huh?  Don't worry, you can tell me... do the mean old monsters hurt when they fuck that poor little ass of yours? HA!</i>\"\r\r", false);
        //(Medium, Large to Heavy:
        else if (this.player.buttRating < 13) this.outputText("\"<i>Hey, nice little cushion you got back here!  Do you get that from sitting around all day?  Nah, can't be that.  I'm sure you get more than a workout on this baby... of course, cock is no substitute for a little exercise, you know!</i>\"\r\r", false);
        //(Big, Voluminous and beyond:
        else this.outputText("\"<i>Now there's a rear end I could get behind!  For someone who claims to be a hero, you sure are built like a fucktoy!  With an ass like that, you remind me of my last lay... of course, she was a horse!</i>\"\r\r", false);
        ...
        //(No Cock:
        if (this.player.totalCocks() == 0) this.outputText("\"<i>Well, aren't you a pretty little thing, all together.  You and I will get along real nice, that's for sure!</i>\"\r\r", false);
        else {
            //(Any Cock: 
            this.outputText("and almost inevitably, his eyes drop down to your " + this.cockDescript(0) + ".  He snorts, ", false);
            //(Human Cock:
            if (this.player.cocks[0].cockType == CockTypesEnum.HUMAN) this.outputText("\"<i>Heh.  Just sporting the normal model, huh?  You know there's a phrase around here... hung like a human!  Trust me... it's not a compliment.  ", false);
            //(Dog Cock:
            if (this.player.cocks[0].cockType == CockTypesEnum.DOG) this.outputText("\"<i>Oh, lookie here!  We got ourselves a little doggie dong!  Well, cock or not, you'll always be a bitch to me, mutt.  ", false);
            //(Horse Cock: 
            ...
            else if (this.player.cocks[0].cockLength <= 20) this.outputText("\"Still, at least you've got a decent sized cock.  You know, for a colt.  Maybe you'll get lucky, and the real women will take pity on you!</i>\"\r\r", false);
            //(Big Size, 21 inches and beyond:
            else this.outputText("\"Now if only they could find a way to get you to stop stepping on your own cock every other step, maybe you'd be a real man!  Can you even get it up, at this point?  Or would that tip you over?  Ha!</i>\"\r\r", false);
        }
    ...
    private keltMainEncounter(): void {
        ...
        //(Submissive 0-30: 
        if (this.player.statusAffectv2(StatusAffects.Kelt) <= 30) this.outputText("You grind your teeth in irritation, but swallow your pride enough to ask him for help.  ", false);
        //(Submissive 30-70:
        else if (this.player.statusAffectv2(StatusAffects.Kelt) <= 70) this.outputText("You nod reluctantly, and Kelt grins.  He may be arrogant, but he is rather good.  ", false);
        //(Submissive 70-100: 
    ...
    private keltMainEncounterAfterNakedReq(): void {
        ...
        //(Naked Off)
            ...
            if (KeltScene.rand(10) <= 5) {
                ...
                if ((this.player.cor + this.player.lib + this.player.lust >= 180 && this.player.inte < 30) || this.player.statusAffectv2(StatusAffects.Kelt) >= 60) {
                    ...
                    if ((this.player.cor + this.player.lib + this.player.lust >= 220 && this.player.inte < 40) || this.player.statusAffectv2(StatusAffects.Kelt) >= 70) {
            ...
            //(Otherwise: 
                ...
                //(Corruption 60+, or Submissive 60+:
                if ((this.player.cor + this.player.lib + this.player.lust >= 180 && this.player.inte < 40) || this.player.statusAffectv2(StatusAffects.Kelt) >= 60) {
                    ...
                    if ((this.player.cor + this.player.lib + this.player.lust >= 220 && this.player.inte < 40) || this.player.statusAffectv2(StatusAffects.Kelt) >= 75) {
                ...
                //(Otherwise: 
                else this.outputText("You ignore his barbed comments as best as you can, and soon enough, he leaves the matter alone, instead critiquing your archery skills.\r\r", false);
            }
        }
        this.keltMainEncounter2();
    }
    ...
    private keltMainEncounter2(): void {
        ...
        if (this.player.statusAffectv2(StatusAffects.Kelt) >= 60 && KeltScene.rand(4) == 0 && this.player.findStatusAffect(StatusAffects.KeltBJ) >= 0) {
    ...
    private keltMainEncounter3(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.NakedOn) < 0) {
            ...
            //(25% Chance: 
            if (this.temp == 0) this.outputText("\"<i>Oh, yes.  Looks like you're shaping up to be a pretty accurate archer.  Just make sure you only fight blind giants.  You know, massive targets that have no chance to dodge.  You'll do fine.</i>\"\r\r", false);
            //(25% Chance: 
            if (this.temp == 1) this.outputText("\"<i>Ha!  You want to become an archer?  Here's a hint... stop thinking about sucking cock for two seconds and AIM.</i>\"\r\r", false);
            //(25% Chance: 
            if (this.temp == 2) this.outputText("\"<i>See the red dot, in the middle of the target?  Imagine that's your ass, and the arrow is a big, fat, minotaur cock.  That should help you hit the target.</i>\"\r\r", false);
            //(25% Chance: 
            if (this.temp == 3) {
                if (this.player.race() != "centaur") this.outputText("\"<i>If you were a centaur, I'd recommend suicide.  Since you're a " + this.player.race() + ", I'd say your best option is to fuck off.</i>\"\r\r", false);
                else this.outputText("\"<i>As a centaur, I'd recommend suicide.  Really, it's that or man the fuck up.</i>\"\r\r", false);
            }
        ...
        //NAKERS
            ...
            if (this.player.inHeat && this.player.gender > 1) {
                ...
                //(Submissive, 0-30: 
                if (this.player.statusAffectv2(StatusAffects.Kelt) <= 30) this.outputText("You shiver and groan, unable to help yourself.  It is clear that Kelt has every intention of breeding you, and you are helpless to stop the urges of your body.  Terrifying images of being raped daily by this cruel beast fill your head... of your belly swelling with his young again and again.  You let out a moaning cry, and orgasm helplessly even as Kelt laughs.\r\r", false);
                //(Submissive, 30-70: 
                else if (this.player.statusAffectv2(StatusAffects.Kelt) <= 70) this.outputText("The thought of that fills you with a dreadful shiver of lust, from your head to your toes.  Your body longs to be bred, again and again, and the idea of submitting to this powerful creature is so powerfully erotic that you cum on the spot, orgasming with delightful abandon.  The thought of being this centaur's breeding slave feels so right!\r\r", false);
                //(Submissive, 70-100: 
                else this.outputText("You whimper in the afirmative helplessly, shivering with delight.  You have a feeling deep inside you that this powerful creature, this paragon of manhood, is your master, and you but his breeding slave.  Your pussy squeezes and milks his member, trying to urge out that explosion of cum that will make you his forever.  The knowledge that your great master will impregnate you soon, filling you with his seed, sends you over the edge into a mind-wracking orgasm.\r\r", false);
            ...
            if (temporary <= 2) {
                ...
                //(Submissive, 0-30:
                if (this.player.statusAffectv2(StatusAffects.Kelt) <= 30) this.outputText("You try to ignore the foul remarks, telling yourself that this is simply the way he is.  It does not help, though, that at times you feel Kelt's eyes wandering across you lustfully.  At least some of his comments are not mockeries, but suggestions.  The entire experience makes you feel a little more uncomfortable around the abusive centaur.", false);
                //(Submissive, 30-70: 
                else if (this.player.statusAffectv2(StatusAffects.Kelt) <= 70) this.outputText("Despite yourself, some of his cruder comments make you blush.  By now, you're getting used to the oft times depraved sexuality of the demon world... but it is a little humiliating to subject yourself to this kind of treatment... and, to your shame, sometimes it's a little arousing.  Though Kelt is insulting, cruel, and crude, you also notice real lust in some of his glances.  By the end of the lesson, you are flushed with arousal as well as exertion.", false);
                //(Submissive, 70-100:
                else this.outputText("Of course, Kelt's words only distract you even more from hitting the target.  Not because you are angry... but because you are aroused.  Somehow, his lewd comments and crude jibes make you shiver with anticipation.  He's just so powerful, so masculine.  Kelt seems well aware of the effect he has on you, and once reaches out to slap your ass heartily.  By the end of the training, you feel intensely horny.", false);
            ...
            if (temporary == 3) {
                ...
                //(Small Size, A-DD: 
                if (this.player.biggestTitSize() <= 5) this.outputText("\"<i>Ha!  Even with your itty-bitty-titty, you have to admit to a certain... weakness, is it?  Awfully sensitive, aren't they?  Ooh, am I making the little girl wet?  Naughty slut!</i>\"\r\r", false);
                //(Medium Size, E-HHH:
                else if (this.player.biggestTitSize() <= 11) this.outputText("\"<i>Just look at these mommy melons!  You want to be an archer?  I'm amazed you don't slap yourself in the tits with every shot!  Easy target to grab onto.  But hey, I bet you like it that way.  Like it when people grope these fat titties of yours?</i>\"\r\r", false);
                //(Big Size, Watermelon and beyond:
                else this.outputText("\"<i>Look at you! You're a miracle of science, you are... any other creature would break their back, trying to haul these milk bags around!  Tell the truth, now... which one of your parents was actually a cow?</i>\"\r\r", false);
    ...
    private keltMainEncounterPostBlowjob(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.BlowjobOn) >= 0) {
            ...
            if (this.player.lust >= 75 || this.player.statusAffectv2(StatusAffects.Kelt) >= 90 && KeltScene.rand(2) == 0) {
                ...
                //(Penis:
                if (this.player.totalCocks() > 0) this.outputText("  Your " + this.cockDescript(0) + " is rock hard, but he ignores it almost contemptuously.  You almost feel ashamed of it, compared to the slowly-growing manhood between his legs.", false);
                //(Vagina:
                if (this.player.hasVagina()) this.outputText("  For a moment, his fingers trace the line of your exposed " + this.vaginaDescript(0) + ", giving you the slightest of warnings before he crudely jams two fingers deep inside, as though scouting out your depths.  You whimper urgently at the treatment, and more so as Kelt removes his fingers, licking with obvious pleasure.", false);
                ...
                //(Penis: 
                if (this.player.totalCocks() > 0) this.outputText("  Beneath you, pressed firmly into the harsh wood of the mounting board, your " + this.cockDescript(0) + " erupts, splattering your stomach with your own cum.  As the thick semen slides down towards your face, you begin slipping on your own warm seed, rocking back and forth with each harsh pounding Kelt delivers to your backside.", false);
                //(Vagina:
                if (this.player.hasVagina()) this.outputText("  Your poor, neglected pussy quivers with delight, convulsing without even being touched.  Thick juices run freely down your leg, dripping off to splatter the hay below you as you moan like a bitch in heat.", false);
                //(Genderless: 
                if (this.player.gender == 0) this.outputText("  Never before has a complete lack of genitalia been so frustrating... or pleasurable.  Not being able to physically cum, the explosions of climax simply rack up within your body... waves of cascading pleasure with no release and no mercy.", false);
                ...
                if (this.player.looseness(false) < 3) this.outputText("\"<i>Fuck!  About time!  Sure got a tight little ass back here, but don't worry, slut.  We'll stretch it out in no time. I promise you this... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\r\r", false);
    ...
    private keltSubmitGivingBJ(): void {
        ...
        if (this.player.statusAffectv2(StatusAffects.Kelt) >= 90) {
            this.player.createStatusAffect(StatusAffects.BlowjobOn, 0, 0, 0, 0);
        }
    ...
    private keltResistance(): void {
        ...
        if (this.player.faceType == FACE_HORSE || this.player.faceType == FACE_DOG) this.outputText("a low growl building in the back of your throat", false);
    ...
    private fuckKeltsShitUp(): void {
        ...
        this.outputText("", true);
        //If naga folks
        if (this.player.faceType == FACE_SNAKE_FANGS && this.player.tongueType == TONUGE_SNAKE && this.player.lowerBody == LOWER_BODY_TYPE_NAGA) {
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cocks[0].cockLength <= 10) {
                    if (this.player.balls > 0) this.outputText("Your " + this.ballsDescriptLight() + " bump into his chin as your cock finds the back of his throat. ", false);
                    else this.outputText("Your genital slit bumps into his chin as your cock finds the back of his throat. ", false);
        ...
        //Standard anti-kelt scene
            ...
            if (this.player.tallness < 50 || this.player.totalCocks() == 0) {
                if (this.player.tallness < 50) this.outputText("Realizing you're too short to dominate him properly, you come up with another plan.  ", false);
            ...
            if (this.player.gender == 0) {
                ...
                if (this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLICK) this.outputText("tasting them experimentally.  ", false);
                else this.outputText("immediately becoming slick with your fuck-me-juices.  ", false);
                ...
                if (this.player.totalCocks() > 0) this.outputText("Your " + this.cockDescript(0) + " splatters cock-cream into his hair, further humiliating him.", false);
                this.outputText("\r\r", false);
            }
            else {
                ...
                if (this.player.cocks[0].cockLength < 10) this.outputText("taking the entire thing easily as his tongue licks you to ", false);
                else if (this.player.cocks[0].cockLength < 25) this.outputText("taking the entire thing deep into his throat.  Apparently centaurs lack a gag-reflex, and you can see his throat stretched around you as you're brought to ", false);
                else this.outputText("taking as much as he can deep into his throat.  Even though his entire neck is distorted by your massive member, his throat simply isn't long enough to take any more.  You writhe as the throat-fucking brings you to ", false);
