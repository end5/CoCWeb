...
export class Jasun extends TelAdreAbstractContent {
    ...
    private meetJasun(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00179] == 0) {
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00179]++;
        ...
        //Met Jasun but not boned!
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00179] > 0 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00180] == 0) {
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00181] == 0) {
            ...
            if (this.player.tone < 75 || this.player.armorName != "slutty swimwear") {
                ...
                else if (this.player.armorName != "slutty swimwear") this.outputText("properly attired", false);
    ...
    private meetJasun2(): void {
        ...
        if (this.player.str < 50) this.outputText("that you're pretty sure you couldn't have moved on your own at all ", false);
