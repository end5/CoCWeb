...
export class Loppe extends TelAdreAbstractContent {
    ...
    */
    ...
    private appearanceOfLoppe(): void {
        this.clearOutput();
        if (this.flags[kFLAGS.LOPPE_FURRY] == 0) {
    ...
    private yesToLoppeMeetingTwo(): void {
        ...
        //[(corr < 40)]
        if (this.player.cor < 40) this.outputText(" as politely as possible. It felt nice to see a display like that here; makes it feel a little less like a wasteland of sex-mad monsters and a little more like home");
        this.outputText(".");
    ...
    private sureBakeryWithLoppe(): void {
        ...
        if (this.player.gems >= 30) {
            ...
            //[(corr > 40)
            if (this.player.cor > 40) this.outputText("  A small voice inside wonders if she'd eat so extravagantly were she footing her own bill.");
            //remove 30 gems
            this.player.gems -= 30;
    ...
    private talkWithLoppeAboutLoppe(): void {
        ...
        //(if first dialogue)
        if (this.flags[kFLAGS.TIMES_ASKED_LOPPE_ABOUT_LOPPE] == 0) {
    ...
    private itsMeFuckingUrtaLoppe(): void {
        ...
        this.flags[kFLAGS.LOPPE_URTA_CHATS] = 1;
    ...
    private gossipWithLoppeAboutLottie(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00299] == 1) {
        ...
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00281] > 0) {
    ...
    private chatWithLoppeAboutHerMom(): void {
        ...
        //(If PC is male:)
        if (this.player.gender == 1) this.outputText("  Well, from what Loppe's told you, Uma wouldn't be attracted to you anyway.");
        ...
        if (this.flags[kFLAGS.LOPPE_TIMES_SEXED] == 0) {
            ...
            if (!bakery) {
                ...
                //(else)
                    ...
                    //[(lib>40)]
                    if (this.player.lib >= 40) this.outputText(".. it almost sounds exciting.");
                }
            ...
            //[(corr < 40)]
            if (this.player.cor < 40) this.outputText("  You tell her they're quite nice... though privately you're curious what the interior looks like.");
            else this.outputText("  They don't seem to work very well - after all, <i>you're</i> here.");
            ...
            if (this.player.hasCock()) {
                if (this.player.smallestCockArea() <= this.loppeCapacity()) this.outputText("Pulling her onto your dick would result in some cowgirl fun, though you'd have to deal with her cock pointed right at you when she came.  ");
                else this.outputText("As good as it would feel to shove your [cock smallest] into her cunt, the nervous looks she's giving it tell you what her response would probably be.  ");
            }
            //[(any cock)
            if (this.player.hasCock()) this.outputText("You could just whip it out and ask what she thinks of it, compared to hers - it might lead to some cross words and crossed swords, though.  ");
            if (this.player.hasVagina()) this.outputText("You could take her monster length vaginally, but if her libido is what she claims, you'll probably wind up quite stretched.  ");
            //[(boobs >= boobjob req)
            if (this.player.biggestTitSize() >= 5) this.outputText("Her hardening horsecock looks like it would fit between your [chest], an act likely to net you a messy demonstration of her enthusiasm.  ");
    ...
    private loppeRidesCocks(): void {
        ...
        //[(not centaur)]
        if (!this.player.isTaur()) this.outputText("on her bed, making yourself comfortable, and start suggestively stroking yourself");
        //(centaur)
        else this.outputText("cumbersomely on the floor, rolling over and spreading your hindlegs to expose yourself");
        ...
        if (y >= 0 && this.player.cockTotal() == 2) this.outputText("  \"<i>In fact... I could just eat both of those up.</i>\"");
        //(3+ fit cocks)
        else if (y >= 0 && this.player.cockTotal() == 3) this.outputText("  \"<i>But I'm afraid I'll only be able to handle two of them.</i>\"");
        if (this.player.cockTotal() > 1 && y >= 0) this.outputText("\n\nBetter than the usual reaction... at least she's willing to give more than one some love.");

        this.outputText("\n\nLoppe pushes you on your back and gently takes hold of ");
        if (y >= 0) this.outputText("two of ");
        ...
        if (y < 0) this.outputText("slide your shaft against her");
        else this.outputText("pinion her shaft between your");
        ...
        if (this.player.balls > 0) this.outputText("  Your [balls] gently brush and rub against her own swollen cum-factories, and you can't wait to empty your overfilled sac into her waiting womb.");
        ...
        if (y >= 0) this.outputText("; its neighbor is aimed for her tight rosebud");
        ...
        if (y >= 0) this.outputText(" and watertight ass");
        ...
        if (this.player.isDrider()) this.outputText("spindly legs");
        else if (this.player.isTaur()) this.outputText("forelegs");
        else this.outputText("arms");
        this.outputText(" around the bunny-girl's ");
        if (this.flags[kFLAGS.LOPPE_FURRY] == 0) this.outputText("silky-smooth");
        else this.outputText("softly furred");
    ...
    private loppeRidesYouNoFaceJizz(): void {
        ...
        if (y >= 0) this.outputText(" while her ass suckles on your second cock with just as much eagerness");
        this.outputText(".");
    ...
    private loppeRidesYouSpunksInYourEye(): void {
        ...
        if (y >= 0) this.outputText(", while her anal ring constricts your " + this.cockDescript(y) + " tightly, intent on holding you in place");
        this.outputText(".");
    ...
    private loppeRidesPCCockFinal(): void {
        ...
        if (y >= 0 || this.player.hasVagina()) {
            ...
            if (y >= 0) this.outputText("your second " + this.cockDescript(y) + " just as easily pumps her perverted ass full of baby juice");
            if (y >= 0 && this.player.hasVagina()) this.outputText(" and ");
            if (this.player.hasVagina()) {
                this.outputText("your [vagina] ");
                if (this.player.wetness() < 3) this.outputText("drizzles");
                else if (this.player.wetness() < 5) this.outputText("spatters");
                else this.outputText("gushes");
        ...
        if (this.player.isDrider() || this.player.isTaur()) this.outputText("forelegs");
        else this.outputText("arms");
        ...
        if (this.flags[kFLAGS.LOPPE_FURRY] == 0) this.outputText("skin");
        ...
        if (y >= 0) this.outputText("s rise");
        else this.outputText(" rises");
        this.outputText(" to full mast again, so swiftly ");
        if (y < 0) this.outputText("it almost smacks");
        else this.outputText("they almost smack");
        ...
        if (this.player.minLust() <= 30 && this.player.lib <= 50) this.outputText("; if I have to stop to tend to you after every coupling, I'll never get these empty");
        ...
        //[(if high cum amount)]
        if (this.player.cumQ() >= 500) this.outputText(" despite your usually messy orgasms");
        this.outputText(".");
        ...
        //[(Exhibitionist)
        if (this.flags[kFLAGS.PC_FETISH] > 0) this.outputText("; it gives you something of a thrill, though nowhere near as much as taking them off for her in the first place did");
    ...
    private loppeWorshipsDicks(): void {
        ...
        if (this.player.biggestCockArea() <= 17.5) {
            ...
            if (this.player.biggestCockArea() > this.loppeCapacity()) this.outputText("even if it does look too big to fit.");
            else this.outputText("or maybe I should get a taste first?");
        ...
        if (this.flags[kFLAGS.LOPPE_FURRY] > 0) this.outputText("fluffy ");
        ...
        //[(lib > 40)
        if (this.player.lib >= 40) this.outputText(" - nor would you want to; she looks just right covered in your fluids");
        this.outputText(".");
        ...
        if (this.player.balls > 0) this.outputText(" and balls to balls");
    ...
    private getFuckedInYerTwatYaCunt(): void {
        ...
        //[(mans)
        if (!this.player.isTaur()) this.outputText("spreading your labia in an invitation that needs no words.");
        else this.outputText("exposing your rump and spreading your hind legs in your best effort to make her feel welcome.");

        this.outputText("\n\nLoppe smirks at you and winks.  \"<i>Don't worry; I'll treat you like a ");
        //[(femininity <= 40)
        if (this.player.femininity > 50) this.outputText("princess.  A sexy, smoking hot princess");
        else this.outputText("prince.  A dashing, dandy prince");
        ...
        if (this.player.vaginas[0].virgin) {
            ...
            //[(low corr)]
            if (this.player.cor < 50) this.outputText("  You look coy, for her benefit, and cast your eyes down shyly.");
            else this.outputText("  You do your best to warn her away from the topic with your eyes, eager to get on with the fuck.");
            //(not for horsez)
            ...
            this.outputText("\n\nYou reach out ");
            if (this.player.cor < 50) this.outputText("and tap her playfully on the nose");
            else this.outputText("in your irritation and squeeze her face imploringly");
        ...
        if (this.player.vaginalCapacity() >= 35) this.outputText(" bottoms out, completely hilted inside you");
        //[else:
        else this.outputText(" bumps against your cervix");
        this.outputText(". You moan in delight as she sinks into you");
        if (this.player.vaginas[0].virgin) this.outputText(", repressing a shiver of pain as she tears through your hymen, taking your virginity");
        else if (this.player.vaginalCapacity() < 35) this.outputText(", forcing your entrance wide to accommodate herself");
        this.outputText(".");
        ...
        //[(not horse)
        if (!this.player.isTaur()) this.outputText("  You wrap your [legs] around her hips as best you can, thrusting in your efforts to meet her strong rhythm, feeling your cunt rippling around her wonderfully long, thick horsecock.");
        ...
        if (this.player.hasCock()) this.outputText(", precum begins to drool from your " + this.multiCockDescriptLight());
        this.outputText(".");
        ...
        if (!this.player.isTaur()) {
            ...
            if (this.player.gender >= 3) this.outputText(" and smearing both your bellies with herm-pre");
            this.outputText(".");
        }
        //Centaur:
        else {
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.cumQ() < 500) this.outputText("between you and painting you both");
            else this.outputText("gushing onto the bedsheets and smearing your belly");
        ...
        if (!this.player.isTaur() && this.player.hasCock()) this.outputText(", giving you a quick peck on the cheek and licking a small gob of cum that seems to have stuck to your chin");
        this.outputText(".");
        ...
        //[(low corr)
        if (this.player.cor < 50) this.outputText("a pleading look... and if there's maybe a trace of horror dancing in the depths of your eyes, well, that's understandable, isn't it?");
        else this.outputText("an incendiary glare, letting her know just what you think of her posturing.");
        ...
        if (this.silly()) this.outputText("  \"<i>Da! Sandvich is kredit to team!</i>\"");
        ...
        //[Libido >=50:
        if (this.player.lib >= 50 || this.player.minLust() >= 30) this.outputText("  Not that you didn't just titillate yourself thinking of it...");
    ...
    private getButtFuckedNonHoarseByLoppe(): void {
        ...
        if (this.player.hasVagina()) this.outputText(" pussy oozing femlube");
        this.outputText("... you beg her to go faster, to do it harder!");

        this.outputText("\n\nLoppe happily complies, thrusting herself deeper and stronger.  ");
        //[(cock)
        if (this.player.hasCock()) this.outputText("One of her hands reaches around to grasp your pre-slickned [cock biggest], stroking you in time with her thrusts.  ");
        if (this.player.gender == 2) this.outputText("One of her hands reaches around to tease your dripping [vagina] and erect [clit], dipping a finger in every time she bottoms out.  ");
        this.outputText("Wet slapping noises fill the room, and you gasp in pleasure each time her cum-churning balls slap against ");
        if (this.player.balls > 0) this.outputText("yours");
        else this.outputText("your [butt]");
        ...
        if (this.player.hasVagina()) {
            ...
            if (this.player.wetness() < 3) this.outputText("spatters");
            else if (this.player.wetness() < 4) this.outputText("splashes");
            else if (this.player.wetness() < 5) this.outputText("drenches");
            else this.outputText("completely soaks");
        ...
        if (this.flags[kFLAGS.SATYR_KIDS] > 0) this.outputText("You laugh softly; hopefully she'll never have to meet the creature that dispelled that same doubt in you.  ");
    ...
    private getAssFuckedByLoppeAsACentaur(): void {
        ...
        //[ass wet)
        if (this.player.ass.analWetness > 0) this.outputText("  She doesn't even have to bother with lube; your ass is wet enough to accommodate her on its own.");
        ...
        if (this.player.balls > 0) this.outputText("rs");
        else if (this.player.hasVagina()) this.outputText("r pussy");
        this.outputText(".");

        this.outputText("\n\nYou moan as she gets into her task");
        if (this.player.hasCock()) this.outputText(", feeling your erect [cock] press against your underbelly, mashed between your centaur half and the soft carpet of Loppe's room.  You hope she doesn't mind a few stains...  ");
        //(else vag)
        else if (this.player.hasVagina()) this.outputText("; your cunt is sopping, making a small pool of juices one the floor.  ");
        else this.outputText(".  ");
        ...
        if (this.player.gender <= 1) this.outputText("  Even if you are the wrong sex entirely for that.");
        ...
        //[PC has cock:
        if (this.player.hasCock()) this.outputText("  The bumps against your prostate send waves of pleasure running through [eachCock] and spreading along your body, until they reach your throat and come out as a ragged groan.  ");
        ...
        if (this.player.hasCock()) this.outputText("  [EachCock] spasms and unloads beneath you, smearing you and the carpet below and pooling thickly with fluid forced out by the prostate stimulation.");
        if (this.player.hasVagina()) this.outputText("  Your vagina contracts, trying to grip at a phantom member as you spill your fluids on the carpet beneath you.");
        ...
        if (this.player.skinType != SKIN_TYPE_SCALES) this.outputText(" have goosebumps all over your body");
        else this.outputText("r scales are practically standing on end");
        this.outputText(".");

        this.outputText("\n\n\"<i>Ohhh... you are incredible, [name].  ");
        //[PC has dick that fits)
        if (this.player.cockThatFits(this.loppeCapacity()) >= 0) this.outputText("Though I hope you won't mind riding me, sometime,</i>\" she laughs.  \"<i>");
    ...
    private loppeSqueezedickWhateverThatIs(): void {
        ...
        else if (this.flags[kFLAGS.LOPPE_DENIAL_COUNTER] == 1) {
        ...
        if (!this.player.isTaur()) this.outputText("on");
        else this.outputText("beside");
    ...
    private superLoppeOrgasmDenialGo(): void {
        ...
        this.outputText("\n\n\"<i>Bye, sugar!");
        if (this.player.hasCock()) this.outputText("  Maybe next time I'll be the one to give you a bit of a holdout!");
        this.outputText("</i>\"");
        //leave, set LoppeDenial flag = 7
        this.flags[kFLAGS.LOPPE_DENIAL_COUNTER] = 5;
        //(very high corr)
        if (this.player.cor >= 90) {
            ...
            this.flags[kFLAGS.LOPPE_DENIAL_COUNTER] = 10;
    ...
    private boobjobLoppe(): void {
        ...
        if (this.player.tongueType >= TONUGE_DEMONIC) this.outputText("retract your tongue into your mouth and ");
        ...
        if ((this.player.str < 50 && !this.player.isTaur()) || (this.player.str < 30 && this.player.isTaur())) {
            ...
            if (this.player.tongueType > TONUGE_HUMAN) this.outputText("looping your inhuman tongue around it and stroking for extra stimulus even while ");
            ...
            if (this.silly()) this.outputText(".  You can't help but think of Family Matters");
            ...
            //end scene
            this.outputText("\n\n");
            if (this.player.cor >= 60) this.outputText("You don't really feel like it, but you figure you had better humor the greedy herm if you want to keep fucking her whenever you like.  ");
        ...
        if ((this.player.str < 50 && !this.player.isTaur()) || (this.player.str < 30 && this.player.isTaur())) this.outputText("- while your stomach is still heavily swollen and gurgles in protest, it's not bad enough to impair you - ");
    ...
    private teaseLoppeNSuck(): void {
        ...
        if (this.player.tongueType > TONUGE_HUMAN) this.outputText(", inhumanly long tongue looping out to coil wetly around the length");
