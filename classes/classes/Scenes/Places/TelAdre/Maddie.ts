...
export class Maddie extends TelAdreAbstractContent {
    ...
    private followMinotaurIntoBackroom(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00241] == 0) {
            ...
            if (this.player.findPerk(PerkLib.MinotaurCumAddict) >= 0) this.outputText("You lick your lips when you realize you're meeting the source of the 'special' éclairs.", false);
    ...
    public handOverIngredientsItBeBakingTimeYo(): void {
        ...
        if (this.player.findPerk(PerkLib.MinotaurCumAddict) >= 0) this.outputText("  You lurch forward involuntarily, craving the rest of his jism, but he pushes you into the wall and grunts, \"<i>No,</i>\" in a tone that brooks no disagreement.  It actually shocks you out of your addicted haze.", false);
        this.outputText("\n\n", false);
    ...
    private waitForSlutCake(): void {
        ...
        if (this.player.cor < 50) this.outputText("it smells normal enough, so you go ahead and sip on it", false);
    ...
    private talkToMaddie(): void {
        ...
        if (this.player.hasCock()) this.outputText("is like, all out of icing mix!  So I'm going to borrow a few cups from you, 'kay?", false);
        else this.outputText("gave me so much icing mix, and you like, would look soooo much better with some vanil- van... yummy frosting!", false);
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.cor < 33) this.outputText("You muster as much authority as you can in such a compromising position and explain to Maddie that what comes out of there is NOT icing.", false);
            else if (this.player.cor < 66) this.outputText("You offhandedly mention that you don't actually make icing.", false);
            else this.outputText("You smirk and mention that what you squirt isn't quite icing.", false);
            ...
            if (this.player.balls > 0) this.outputText(", the cum-heavy spheres bouncing in your twitching sack as they get ready to explode", false);
            ...
            if (this.player.cockTotal() == 1) this.outputText(", your " + this.cockDescript(x) + " emptying every drop of jizz into the baked cum-tank.", false);
            else {
            ...
            if (this.player.cockTotal() > 1) {
                if (this.player.cockTotal() == 2) this.outputText(" along with your other penis", false);
        ...
        //(FEMALE/Genderpoots) 
            ...
            else if (this.player.tone >= 70) this.outputText(", you look like you're carved from stone.  A little softness would do you good", false);
            else this.outputText(", you look like you'd better eat to keep up your gorgeous figure", false);
            ...
            if (this.player.thickness < 60 || this.player.tone >= 50) this.outputText("forward", false);
