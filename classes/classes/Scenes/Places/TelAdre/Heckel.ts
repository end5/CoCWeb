...
export class Heckel extends TelAdreAbstractContent {
    ...
    */
    ...
    public greetHeckel(): void {
        ...
        else if (this.telAdre.brooke.brookeAffection() >= 70 && this.flags[kFLAGS.BROOKE_MEDIUM_SCENE] > 0 && this.flags[kFLAGS.MET_HECKEL] > 0 && this.model.time.hours >= 13 && this.model.time.hours <= 15 && (this.player.hasVagina() || this.player.cockThatFits(this.telAdre.brooke.brookeCapacity()) >= 0)) {
    ...
    private heckelLovesDaAnal(loss: boolean = false): void {
        ...
        //[<IF TONE OVER 80>
        if (this.player.tone >= 80) this.outputText("  \"<i>Damn " + this.player.short + ", you've got one hell of an ass. I bet it's gonna feel even better than it looks.</i>\"", false);
        //[<IF TONE BETWEEN 60-79>
        else if (this.player.tone >= 60) this.outputText("  \"<i>Mmm, not bad " + this.player.short + ", not perfect, but not bad.</i>\"", false);
        this.outputText("\n\n", false);
        ...
        //[<IF PC HAS PENIS>
        else if (this.player.hasCock()) this.outputText(this.SMultiCockDesc() + " is trapped between you and the wooden bench, and you know Heckel won't let you shift position to free it. You hump weakly at the bench in a desperate attempt to get some stimulation, and you can feel the vibrations of Heckel's laugh as she buries her snout in your ass. She doesn't stop you, but the polished wood barely gives any pleasure anyway.\n\n", false);

        //[<IF PC HAS VAGOO>
        else if (this.player.hasVagina()) this.outputText("Your snatch starts to ache while moisture runs down your groin, and you groan at the lack of attention it's receiving. If Heckel notices, she doesn't react and keeps swirling her tongue around your hole. You push weakly backwards, hoping to make her drop her tongue down a few inches, but she instead takes this as an opportunity to bury her snout fully between your ass cheecks, her tongue slipping inside you deeper than before.\n\n", false);
    ...
    private heckelLovesAnal2(): void {
        ...
        //[<IF PC HAS VAGOO>
        else if (this.player.hasVagina()) this.outputText("Heckel's fist-sized balls slap against your ass and grind your snatch with every thrust, driving you crazy with the desperate need to be filled. You moan in anguish, pushing yourself towards her with every thrust, desperate to milk as much stimulation out of her as possible. She laughs above you, but rewards you with harder and faster thrusts. \"<i>You moan like a whore, " + this.player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);
        ...
        //[<IF PC IS FEMALE>
        if (this.player.gender == 2) this.outputText("  \"<i>I'm going to fuck your ass like you wish I'd fuck your cunt,</i>\"", false);
        //[<IF PC IS MALE OR HERM >
        else this.outputText("  \"<i>I'm going to ride your ass like you wish you could ride me,</i>\"", false);
        ...
        //[<HERM PC>
        if (this.player.gender == 3) this.outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your vagina hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + this.vaginaDescript(0) + " spasms and gushes over your soaked " + this.player.legs() + ", your asshole spasming around her cock just as much. Your " + this.multiCockDescriptLight() + " soon follows, shooting your own seed up between your " + this.chestDesc() + " and coating your stomach. Even as your orgasm begins to taper off, you can do little more than lie panting in a pool of your own spunk. Your legs quiver beneath hers as the warmth spreads further up your gut, leading you into a warm and hazy afterglow.\n\n", false);
        //[<MALE PC>
        else if (this.player.hasCock()) this.outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your " + this.ballsDescriptLight() + " and cock, making it twitch at your impending orgasm. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her.  Your " + this.ballsDescriptLight() + " get tight as your trapped " + Appearance.cockNoun(CockTypesEnum.HUMAN) + " twitches, shooting your cum up between your stomach and chest. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n", false);
        //[<FEMALE PC>
        else if (this.player.hasVagina()) this.outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your " + this.vaginaDescript() + " hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + this.vaginaDescript(0) + " spasms and gushes over your soaked thighs, your asshole spasming around her cock just as much. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n", false);
    ...
    public dominateHeckel(): void {
        ...
        if (this.flags[kFLAGS.TIMES_DOMMED_HECKEL] == 0) this.outputText("there's a new top dog just waiting to claim the town bitch");
        else this.outputText("you're back for a taste of your favorite bitch");
        this.outputText(".  Heckel snorts, \"<i>Nice try, fuck-meat, but ");
        if (this.flags[kFLAGS.TIMES_DOMMED_HECKEL] > 0) this.outputText("last time was a fluke");
        else this.outputText("I'm always on top");
        ...
        if (this.flags[kFLAGS.TIMES_LOST_HECKEL_DOM_CHALLENGE] > 0) this.outputText(" again");
        this.outputText("?</i>\"  Her tough finger-tip slams into your solar plexus for emphasis");
        if (this.player.tou < 60) this.outputText(", pushing you back a bit");
        this.outputText(".");
        ...
        //{Win}
            ...
            if (this.flags[kFLAGS.TIMES_DOMMED_HECKEL] > 0) this.outputText(" AGAIN");
            this.outputText("...</i>\"");
    ...
    private dominateHeckelConclusion(): void {
        ...
        if (this.flags[kFLAGS.PC_FETISH] > 0) this.outputText("You grin and blush hotly, imagining the whole of the gym watching you fuck this hyena, their watchful eyes exciting you further.");
        else if (this.player.cor < 33) this.outputText("You blush a bit at that, uncomfortable at your sex being so public but unwilling to stop.");
        else if (this.player.cor < 66) this.outputText("You smirk a little at that while barely acknowledge the worry of being caught nagging at your consciousness.");
        else this.outputText("You grin widely at that and secretly hope that the whole gym will come in to see their 'alpha' laid low.");
        ...
        if (this.player.cockTotal() > 2) this.outputText(", fanning the others across her neck and forehead, burying her in penis.");
        else if (this.player.cockTotal() == 2) this.outputText(", dropping your [cock smallest] alongside it over her eyes, burying her in penis.");
        else this.outputText(", draping her in hard penis.");
        ...
        if (this.player.cockTotal() > 1) this.outputText("s throb and thicken");
        else this.outputText(" throbs and thickens");
        ...
        if (this.player.cumQ() < 250) this.outputText("single drop");
        else if (this.player.cumQ() < 1000) this.outputText("steady drip");
        else this.outputText("never-ending flow");
        ...
        if (this.player.biggestCockArea() > 40) this.outputText("as much of it as possible");
        ...
        if (this.player.balls > 0) this.outputText(", basting your [balls] with her steaming warmth");
        else if (this.player.hasVagina()) this.outputText(", basting your [vagina] with her steaming warmth");
        else this.outputText(", basting your " + this.player.skin() + " with her steaming warmth");
        ...
        if (this.player.cumQ() > 500) {
            ...
            if (this.player.cumQ() >= 1000) this.outputText("  Still, you keep blasting wad after wad of spunk inside her, and her belly rounds nicely, puffed up with virile sperm.");
            if (this.player.cumQ() >= 2000) this.outputText("  Your spooge is seemingly without end, pouring out endlessly long after she's spunk-gravid and nearly immobile.  The rivers that run from her abused cunt-lips quickly turn the table into a puddle.");
            if (this.player.cumQ() >= 3000) {
                ...
                if (this.player.cumQ() >= 4000) {
                    ...
                    if (this.player.cumQ() < 10000) this.outputText("a foot deep");
                    else if (this.player.cumQ() < 15000) this.outputText("knee high by most measurements");
                    else if (this.player.cumQ() < 20000) this.outputText("waist high");
                    else this.outputText("as high as the table");
                }
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() > 2) this.outputText("s contribute");
            else this.outputText(" contributes");
        ...
        if (this.silly()) {
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00281] > 0) this.outputText(", then give Lottie a high five");
