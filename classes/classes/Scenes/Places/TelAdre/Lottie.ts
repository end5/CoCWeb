...
export class Lottie extends TelAdreAbstractContent {
        ...
        if (this.model.time.hours >= 15 && this.model.time.hours <= 23) {
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00281] == 0) {
                ...
                if (display) {
                    //[RANDOM INTROS]
                    //[Encouragement 0 – 30]
                    if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] < 30 && Lottie.rand(6) == 0) {
                        ...
                        if (this.silly()) this.outputText("  What can you say? You love making bacon.", false);
                    }
                    //[Encouragement 0 – 30]
                    else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] < 30 && Lottie.rand(5) == 0) {
                        ...
                        if (this.silly()) this.outputText("  What can you say? Her pork buns are the best.", false);
                    }
                    //[REPEAT INTROS]
                        ...
                        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 33) this.outputText("voluptuous", false);
                        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 66) this.outputText("plump", false);
                        ...
                        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 33) this.outputText("bountiful", false);
                        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 66) this.outputText("chubby", false);
                        ...
                        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 33) this.outputText("voluminous", false);
                        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 66) this.outputText("chubby", false);
                        else this.outputText("cute", false);
                        this.outputText(" rump.", false);
                    }
    ...
    private lottieCup(): string {
        //(d/e/f/g)
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] >= 75) return "D";
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] >= 50) return "E";
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] >= 25) return "F";
        else return "G";
    }

    private encounterLottieCharge(): void { this.encounterLottie(true); }
    ...
    public encounterLottie(charge: boolean = false): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00310] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00311] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00312] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00313] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00314] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00315] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00316] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00317] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00318] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00319] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00320] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00298] > 0 && this.player.lust >= 33) sex = this.lottieFuck;
        ...
        this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00281]++;
        //[INITIAL ENCOUNTER]
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00281] == 1) {
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] = 50;
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] = 50;
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00300] = 50;
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00308] = 50;
        ...
        //[REPEAT ENCOUNTER]
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] >= 50) this.outputText("relaxing", false);
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00297] == 0) this.outputText("Lightly sipping", false);
            else this.outputText("Slurping down", false);
            this.outputText(" what appears to be ", false);
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00297] == 0) this.outputText("some juice", false);
            else this.outputText("a milkshake", false);
            this.outputText(", her eyes wander over the room when she spots you and waves", false);
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] >= 70) this.outputText(" excitedly", false);
            ...
            else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00281] == 2 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00298] > 0) {
            ...
            //[Encouragement moved from 31 to 30, first time]
            else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00301] == 0 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00300] > 30 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] <= 30) {
                ...
                this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00301] = 1;
                this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00300] = this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280];
            }
            ...
            else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00300] <= 30 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] > 30) {
                this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00300] = this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280];
                //first time
            ...
            else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00300] > 80 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] <= 80) {
                this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00300] = this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280];
                //, first time]
            ...
            else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] >= 60) {
                //[Figure 0 – 20]
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 20 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00297] == 0) this.outputText("\"<i>Oh, " + this.player.short + "! Let's do our best today, I really wanna lose those pounds! I know I can do my best when I'm with you!</i>\" Lottie beams, her massive tits pushed against the table. She seems to be excited for what you've got in store today.", false);
                //[Figure 0 - 20, convinced her to accept body]
                else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 20) this.outputText("\"<i>Hey, " + this.player.mf("stud", "cutie") + "! You shouldn't keep a big girl like me waiting; unless you wanna get crushed by these!</i>\" Lottie grins and grabs her luscious breasts firmly, giggling when she notices you're at full attention now. She seems to be excited for what you've got in store today.", false);
                //Figure 20 - 40, haven't convinced her to accept body]
                else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 40 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00297] == 0) this.outputText("\"<i>Ah, " + this.player.short + "! We should probably get started soon; I'm gonna push myself to the limit today!</i>\" Lottie's arms are folded over her chest, subconsciously trying to hide her nervousness, though squishing her pillowy tits in the process. She seems to be excited for what you've got in store today.", false);
                //[Figure 20 - 40, convinced her to accept body]
                else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 40) this.outputText("\"<i>Hey, " + this.player.mf("stud", "cutie") + "! You shouldn't keep me waiting; the only thing I'm losing right now is my patience!</i>\" Lottie grins and punches your arm playfully, squealing when you try to get her back. She seems to be excited for what you've got in store today.", false);
                //[Figure 40 - 60]
                else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 60) this.outputText("\"<i>Hey! I was looking for you earlier, y'know? I can't wait to get started.</i>\" She looks happy that you've arrived. Lottie leans over to grab her beverage, giving you an excellent view of her supple mounds. She seems to be excited for what you've got in store today.", false);
                //[Figure 60 - 80]
                else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 80) this.outputText("\"<i>Yo, " + this.player.mf("big guy", "babe") + "! I've been waiting for you, so you better be pumped! Ready to get started?</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.", false);
                //[Figure 80 - 100]
                else this.outputText("\"<i>Hey, " + this.player.mf("stud", "cutie") + "! You shouldn't keep me waiting, or I'll put you through the burn twice as hard! You ready?</i>\" Lottie winks at you and punches your arm playfully. She seems to be excited for what you've got in store today.", false);
            }
            //[Normal Encounter, Encouragement 30 - 60]
            else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] >= 30) {
                //[Figure 0 - 20]
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 20) this.outputText("\"<i>Oh, " + this.player.short + ", hey. I think we should try and get into it today. I don't think I tried hard enough last time, y'know?</i>\" Lottie leans over to grab her beverage, her massive tits pushed against the table. She seems to be intent on trying her best today.", false);
                //[Figure 20 - 40]
                else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 40) this.outputText("\"<i>A-ah, " + this.player.short + "! We should probably get started soon; I... I want to push myself to the limit today!</i>\" Lottie's arms are folded over her chest, subconsciously trying to hide her nervousness, though squishing her pillowy tits in the process. She seems curious as to what you both plan to do today.", false);
                //[Figure 40 - 60]
                else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 60) this.outputText("\"<i>H-hey! I was looking for you earlier, y'know? I can't wait to get started.</i>\" She looks at ease now that you've arrived. Lottie leans over to grab her beverage, giving you an excellent view of her supple mounds. She seems curious as to what you both plan to do today.", false);
                //[Figure 60 - 80]
                else this.outputText("\"<i>Hello " + this.player.short + "! I've... I've been waiting for you, so you better be ready, hey! Don't hold back!</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.", false);
            }
            //[Normal Encounter, Encouragement 0 - 30]
            else {
                //[Normal Encounter, Figure 0 – 70]
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 70) this.outputText("\"<i>Oh, " + this.player.short + "... I know I haven't been trying the way you want me to. I – I punished myself extra hard last night! Please, let me try again today!</i>\" Lottie leans over and looks at you desperately, her creamy tits pushed against the table. You can see they're redder than before. Has she been trying to slap her fat away? You turn away, not giving her the pleasure of looking at your face. You agree to help her – but don't expect to be looked at by the only person who can stand you if this goes on. Lottie squeals and manages to blurt out a 'th-thank you!' in response.", false);
                //[Normal Encounter, Figure 70 - 100]
                else this.outputText("\"<i>" + this.player.short + "! I know you don't like looking at me, but I... I lost some more weight for you today!</i>\" Lottie removes her top and exposes her curvaceous body, plump tits in full view. You stare her down, and she smiles weakly, grateful for your patience. She waits for your response, but you turn away and tell her to cover up her disgusting body. \"<i>But I – oh god, I'm sorry, I'm so sorry, I'll try extra hard today, I'll try so so hard...</i>\" She babbles on while you go to the counter and order some food for yourself.", false);
            }
        }
        //[Appearance][Talk][Exercise][Give Item][Sex][Hug]
    ...
    private acceptBeingLottiesHamSandwich(): void {
        this.spriteSelect(36);
        this.outputText("", true);
        this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00299] = 1;
        ...
        else if (this.player.tallness > 53) this.outputText("but you can't judge, being roughly the same height", false);
    ...
    private drinkWaterWithYourHamhock(): void {
        ...
        if (this.flags[kFLAGS.TIMES_HAD_YOGA] == 0) this.outputText("You've never had any experience with the yoga classes first hand, but you tell ", false);
    ...
    private drinkLustWithYourHamhock(): void {
        ...
        //[if balls]
        if (this.player.balls > 0) this.outputText(" while her fingers nervously trace around your balls", false);
    ...
    public analLottieMilkshake(): void {
        ...
        if (this.player.totalCocks() == 2) this.outputText(", managing to squeeze in your other cock along with it", false);
        else if (this.player.totalCocks() > 2) this.outputText(", the rest of your dicks poking and prodding against her soft flesh", false);
        ...
        if (this.player.balls > 0) this.outputText(", her soaked pussy rubbing against your balls", false);
        this.outputText(".\n\n", false);
        ...
        if (this.player.balls > 0) this.outputText("Your " + this.sackDescript() + " begins to swell", false);
        ...
        if (this.player.cumQ() >= 500) this.outputText(", a heavy amount leaking from her ass", false);
    ...
    public getSuckedOffByAHamSandwich(): void {
        ...
        //[If the player has a cock between 5' – 12']
            ...
            if (this.player.cockTotal() > 1) this.outputText(", jerking off your " + this.cockDescript(this.player.biggestCockIndex2()) + " with both hands", false);
        ...
        //[If the player has a cock equal to or over 13']
            ...
            if (this.player.cockTotal() > 1) this.outputText(" - using her hands to massage your leftover " + this.cockDescript(this.player.biggestCockIndex2()), false);
        ...
        else if (this.player.biggestTitSize() > 2) this.outputText(" while you play with your " + this.biggestBreastSizeDescript(), false);
        ...
        if (this.player.cockTotal() > 1) {
            if (this.player.cockTotal() == 2) this.outputText("  Your extra cock flails wildly, slapping against her cheeks.", false);
            else if (this.player.cockTotal() > 2) this.outputText("  Your extra cocks flail wildly, slapping against her cheeks.", false);
        }
        ...
        //[if Multi]
        if (this.player.cockTotal() > 1) this.outputText(" stops rubbing your " + this.cockDescript(x) + " to ", false);
        //(Otherwise)
        else this.outputText(" reaches down towards her dripping pussy; plunging two fingers into her wetness while using the other hand to ", false);
        //If Balls]
        if (this.player.balls > 0) this.outputText("knead your " + this.ballsDescriptLight(), false);
        else this.outputText("reach around and squeeze your " + this.buttDescript(), false);
        ...
        //[If the player has a cock equal to or over 13']
        if (this.player.cocks[x].cockLength > 12) this.outputText("your sensitive tip brushing against her eager mouth", false);
        //Otherwise]
        ...
        if (this.player.cumQ() < 500) this.outputText("thick ropes of cum splattering all over her face and pooling in between her tits", false);
        else this.outputText("massive globules of cum splattering all over her face and painting her tits", false);
    ...
    public lottieTone(dif: number = 0): number {
        ...
        if (this.debug) this.outputText("\n<b>(DEBUG: Lottie Tone changed by " + dif + "!)</b>\n", false);
        this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] += dif;
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] > 100) this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] = 100;
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] < 0) this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00279] = 0;
        //Clear blowjob/anal change talk flags in case tone is getting out of whack.
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00306] == 1) this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00306] = 0;
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00307] == 1) this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00307] = 0;
    ...
    public lottieMorale(dif: number = 0): number {
        ...
        this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] += dif;
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] > 100) this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] = 100;
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] < 0) this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280] = 0;
        return this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00280];
    }
    ...
    private lottieFatLoserCulminationHumiliationChoice(): void {
        ...
        if (this.silly()) this.outputText("BACON BACON BACON BACON BACON BACON! GOTTA HAVE BACON!", false);
        else this.outputText("Heyyy *hic* buddy, is she like your *hic* shex-slave or sumthin?", false);
    ...
    private lottieHighMoraleFatLoveSelfOneTimeEvent(): void {
        ...
        if (this.player.cockArea(x) <= 40) this.outputText("her ample cheeks resting on your groin as you bottom out in her", false);
        else this.outputText("though you only reach so far before you've filled her up entirely with your length", false);
        ...
        if (this.silly()) this.outputText(" Before you leave, you make sure to head out to the cafe to buy yourself a bacon shake. You love bacon shakes.\n\n", false);
    ...
    private fuckElleInsteadOfThatFatSlutFirstTime(): void {
        ...
        else this.outputText("uses all four of her hands to handle your " + this.multiCockDescriptLight() + ", jerking each one with ease", false);
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() == 2) this.outputText(" throbs, spilling out its essence along the floor and onto Lottie.", false);
            else this.outputText("s throb, spilling out their essence along the floor and onto Lottie.", false);
        }
        ...
        if (this.silly()) this.outputText(", making sure to grab a bacon shake on the way out. You only need one of those to satisfy you");
    ...
    private lottieWeights(): void {
        ...
        this.outputText("", true);
        var NTR = undefined;
        if (this.lottieMorale() <= 30 && this.flags[kFLAGS.TIMES_FUCKED_IFRIS_BLOWJOB] > 0 && this.player.str >= 75 && this.player.tone >= 60 && this.player.cumQ() >= 1000)
    ...
    public giveLottieAnItem(): void {
        ...
        if (this.player.hasItem(this.consumables.GROPLUS) && this.player.findStatusAffect(StatusAffects.DungeonShutDown) >= 0) gro = this.giveLottieGroPlus;
        if (this.player.hasItem(this.consumables.REDUCTO)) reducto = this.giveLottieReducto;
    ...
    public hamSammitchTimeBIATCH(): void {
        this.spriteSelect(36);
        this.outputText("", true);
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00324] == 0) {
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00324]++;
            ...
            if (this.silly()) this.outputText(", mumbling something about lifetime members receiving free pig-related food items", false);
    ...
    public lottieFuck(): void {
        ...
        if (this.player.tentacleCocks() > 0 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00306] == 2) tentacle = this.tentaDickLottieButtFuckbuttFuckButtFUCKBUTTFUCKBUTTFUCK;
        var x: number = this.player.cockThatFits(40);
        if (x < 0) x = 0;
        this.outputText("", true);
        ...
        if (this.lottieMorale() <= 40) {
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00310] > 0) dog = this.lottieRepeatDoggieStyle;
        ...
        //[If Encouragement 60 – 100]
            ...
            var quickie = (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00314] > 0 ? this.lottieRepeatQuickie : undefined);
    ...
    public lottieRepeatWalkies(): void {
        ...
        if (!this.silly()) this.outputText("Heyyy, is she like *hic* your shex slave er shumthin?", false);
        else this.outputText("Heyyy, do I shmell bacon?  I fucking love bacon!  BACON BACON BACON!", false);
    ...
    public lottieRepeatSUPERNEATORARES(): void {
        ...
        else this.outputText("uses all four of her hands to handle " + this.sMultiCockDesc() + ", jerking each one with ease", false);
    ...
    public hugTheShitOutOfYourHam(): void {
        ...
        if (this.lottieMorale() < 70) this.lottieMorale(1);
        //[If Encouragement 0 – 30]
    ...
    public tentaDickLottieButtFuckbuttFuckButtFUCKBUTTFUCKBUTTFUCK(): void {
        ...
        if (this.lottieMorale() <= 30) this.outputText("  She gives you a gloomy stare, before turning her head back down and plunging it into the mattress, already accepting her defeat", false);
        ...
        if (y >= 0) {
            ...
            if (this.player.cockArea(y) <= 80) this.outputText("the entirety of your " + this.cockDescript(y), false);
            else this.outputText("as many inches of your " + this.cockDescript(y), false);
            ...
            if (z >= 0) {
                ...
                if (this.lottieMorale() < 40) this.outputText("  This pig slut really loves to be used like that!", false);
                else this.outputText("  Your pig lover really loves what you're doing to her!", false);
                    ...
                    if (zzz >= 0) {
                        ...
                        if (zzzz >= 0) {
                            ...
                            if (zzzzz >= 0) {
                                ...
                                if (zzzzzz >= 0) this.outputText("  Seeing the effect your junk had on her, you move your " + this.cockDescript(zzzzzz) + " to her remaining hand and she grips it likewise.", false);
        ...
        if (this.lottieMorale() >= 99) {
            ...
            if (this.silly()) this.outputText("  Before you leave, you make sure to grab a bacon shake from the clerk, high-fiving her as you backflip back to camp.", false);
            this.outputText("\n\n", false);
        }
        //[if enc. 0]
        else {
            ...
            if (this.silly()) this.outputText("  Unfortunately for the spider-clerk, you've raided her cart of bacon shakes on the way out.  You try to backflip back to camp before accidentally dropping the majority of your shakes onto the floor, ultimately deciding to walk back normally - the last beverage you could save gripped firmly in your hands.", false);
        }
        this.player.orgasm();
        this.dynStats("sen", -2);
        this.doNext(this, this.camp.returnToCampUseOneHour);
    ...
    public ifrisAndLottieGetsNTRedLiftingWeights(): void {
        ...
        if (this.player.balls > 0) this.outputText("  Your pace doesn't slow, even when your swollen balls smack loudly against her chin.", false);
    ...
    private lottieAndIfrisNTREpilogue(): void {
        ...
        else this.outputText("I had to make a show of fining you for public indecency, but you'll note your money is all still there.  Pay me back sometime, okay, hun?\n\n-Always up for you, Urta", false);
        this.outputText("</i>\"\n\n", false);
