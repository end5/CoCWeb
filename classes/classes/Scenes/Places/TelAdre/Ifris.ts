...
export class Ifris extends TelAdreAbstractContent {
    ...
    public approachIfris(): void {
        ...
        //2a-Repeat approach, no sex-
        else if (this.flags[kFLAGS.TIMES_FUCKED_IFRIS_BLOWJOB] + this.flags[kFLAGS.TIMES_FUCKED_IFRIS_LICKED] == 0) {
            ...
            if (this.flags[kFLAGS.IFRIS_SHOWED_OFF] == 0) this.outputText("\"<i>Hello darling... here to actually give me a show?</i>\"\n\n", false);
            else this.outputText("\"<i>Hello darling... here to give another show? I did so enjoy your last performance.</i>\"\n\n", false);
        }
    ...
    private showOffForIfris(): void {
        ...
        if (this.player.gender == 0 || (this.player.femininity < 40 && this.player.cor > 75 && this.player.faceType == FACE_COW_MINOTAUR)) {
        ...
        if (this.player.hasCock()) {
            ...
            if (this.flags[kFLAGS.TIMES_FUCKED_IFRIS_BLOWJOB] == 0) {
                ...
                if (this.player.balls > 0) this.outputText("them and gently squeezes the sack.\n\n", false);
                else if (this.player.hasVagina()) this.outputText("your lower lips and gently squeezes.\n\n", false);
                else this.outputText("your taint and gently squeezes.\n\n", false);
            ...
            //5a-Repeat oral scene, male/herm-
                ...
                if (this.player.balls > 0) this.outputText(", her hand cupping your " + this.ballsDescriptLight(), false);
        ...
        //4b4-PC succeeds! Is female!-
            ...
            if (this.flags[kFLAGS.TIMES_FUCKED_IFRIS_LICKED] == 0) {
                ...
                if (this.player.isNaga()) this.outputText("your powerful tail flexing to and fro while your belly clenches", false);
    ...
    private ifrisDP(): void {
        ...
        if (this.player.dogCocks() >= 2) {
            ...
            if (this.player.cumQ() >= 1000) this.outputText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ", false);
        ...
        //(Standard)
            ...
            if (this.player.cockTotal() > 2) {
                ...
                if (this.player.cockTotal() == 1) this.outputText("one unbound prick remaining paints the muscular woman's lower back with goo, but she doesn't seem to mind.", false);
                else this.outputText("other, unbound pricks paint the muscular woman's lower back in goo, but she doesn't seem to mind.", false);
        ...
        if (this.player.cumQ() >= 1000) this.outputText("her body bloated with cum and sloshing audibly with every step", false);
        else if (this.player.cumQ() >= 500) this.outputText("her belly bloated and gurgling with every step", false);
        ...
        this.fatigue(10);
        //Stat changes HERE!
        if (this.player.str < 90) this.dynStats("str", .75);
        if (this.player.tou < 40) this.dynStats("tou", .5);
        this.player.orgasm();
        //Body changes here
        //Muscleness boost!
        this.outputText(this.player.modTone(85, 5 + Ifris.rand(5)), false);
