...
export class Library extends TelAdreAbstractContent {
    ...
    private towerFollowUpVisits(): void {
        this.clearOutput();
        if (this.flags[kFLAGS.TIMES_BEEN_TO_LIBRARY] == -1) { //Return visits before you meet Quinn. Either you meet him or you continue to go to the library at night like some bibliophile vampire
    ...
    private studyInTA(): void {
        ...
        //[Study, 18:00-20:00]
            ...
            if (Library.rand(3) == 0) {
                ...
                if (this.player.inte >= 25 && this.player.findStatusAffect(StatusAffects.KnowsArouse) < 0) {
                ...
                //Smart enough for arouse and doesnt have it
                else if (this.player.inte >= 30 && this.player.findStatusAffect(StatusAffects.KnowsHeal) < 0) {
                ...
                //Smart enough for arouse and doesnt have it
                else if (this.player.inte >= 40 && this.player.findStatusAffect(StatusAffects.KnowsMight) < 0) {
                ...
                //Smart enough for arouse and doesnt have it
                else if (this.player.inte >= 25 && this.player.findStatusAffect(StatusAffects.KnowsCharge) < 0) {
                ...
                //Smart enough for arouse and doesnt have it
                else if (this.player.inte >= 30 && this.player.findStatusAffect(StatusAffects.KnowsBlind) < 0) {
                ...
                //Smart enough for arouse and doesnt have it
                else if (this.player.inte >= 40 && this.player.findStatusAffect(StatusAffects.KnowsWhitefire) < 0) {
