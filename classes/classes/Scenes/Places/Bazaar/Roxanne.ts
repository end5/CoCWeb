...
export class Roxanne extends BazaarAbstractContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 300 && this.model.time.hours == 1 && Roxanne.rand(5) == 0) this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] = 1;
        //hangover status stuff
        if (this.player.findStatusAffect(StatusAffects.Hangover) >= 0) {
            //Countdown
            if (this.player.statusAffectv1(StatusAffects.Hangover) > 0) this.player.addStatusValue(StatusAffects.Hangover, 1, -1);
            else {
        ...
        if (this.model.time.hours > 23 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00227] > 0) this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00227]--; //Reduce drinking contest bonus
        return false;
    }
    ...
    private RoxanneChooseApproachOrRepeat(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00221] == 0) {
            ...
            if (this.player.cor > 66) this.outputText("Yeah, you've got some corruption in you, but I don't think you're contagious like the demons and their ilk yet.  ", false);
            ...
            if (this.player.cor < 33) this.outputText(", but would a champion really do something like that?", false);
        ...
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00222] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00223] <= 0) {
        ...
        //[Approach – lost last contest and she's huge]
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00224] == 2 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 200) {
            ...
            if (this.player.analCapacity() >= 100) this.outputText("she's going to keep you stretched and gaping", false);
            else this.outputText("she's probably going to stretch your ass beyond its normal limits", false);
        ...
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00224] == 1 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] < 200) {
    ...
    private roxanneDrinkingContest(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 200) this.outputText("stumbles over her huge manhood, working towards", false);
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00222] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00223] <= 0 || this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00224] == 2) {
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00224] == 2) this.outputText(" after your last humiliation.", false);
            else this.outputText(" against such a renowned foe.", false);
        }
        else this.outputText("He leers at Roxanne as he fills your mug, remembering her last defeat and likely wishing he could feel her tongue as you did.", false);
        this.outputText("  You ", false);
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00222] + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00223] < 3) this.outputText("hesitantly sniff at the brew, taking in its dark color and heady, hoppy aroma before", false);
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00226] == 0) {
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 200) this.outputText("massive, seam-ripping bulge", false);
        ...
        if (score < (45 + Roxanne.rand(20))) {
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00226] == 0) this.outputText("Nooooo! You're cut off! That means Roxanne won...", false);
            else this.outputText("Yessss!  You finally got so drunk that Roxanne has no excuse not to pack your drunk ass full of lizan-spoo!", false);
    ...
    private roxanneGivesABlowjob(): void {
        ...
        if (this.player.balls > 0) this.outputText("A set of warm, long-nailed fingers squeeze your " + this.ballsDescriptLight() + ", dragging sharp nail-tips along the underside of your sack to tease the poor, cum-packed orbs.  ", false);
        ...
        if (this.player.cockArea(x) < 60) this.outputText("the entire length of your " + this.cockDescript(x), false);
        ...
        if (this.player.hasVagina()) this.outputText(", stopping just short of your female entrance", false);
        this.outputText(".\n\n", false);
        ...
        if (this.player.cumQ() >= 1500) this.outputText("huge torrent utterly drenches her face, horns, neck, and tight top", false);
        else if (this.player.cumQ() >= 500) this.outputText("a huge spurt soaks her face and horns", false);
    ...
    private roxanneCunnilingus(): void {
        ...
        if (this.player.hasFuckableNipples()) {
            ...
            if (this.player.biggestLactation() < 1.5) this.outputText("expertly as the one below", false);
        ...
        if (this.player.hasCock()) this.outputText(this.SMultiCockDesc() + " bounces on her head, between her horns, spilling a trail of sticky seed down her back.  ", false);
    ...
    private roxanneRimjob(): void {
        ...
        if (this.player.biggestTitSize() >= 2) this.outputText(", your breasts cushioning you from the hard wood below", false);
        ...
        if (this.player.hasVagina()) this.outputText("Meanwhile, your neglected box is getting wetter and wetter, with no sign of stopping.  The lizan's massive, questing tongue ignores it.  ", false);
        ...
        if (this.player.hasCock()) {
            ...
            else if (this.player.cumQ() < 1000) this.outputText("  It forms a nicely-sized pool before the ground wicks it up.", false);
            else if (this.player.cumQ() < 1500) this.outputText("  It forms a large pool before the ground soaks it up.", false);
            ...
            if (this.player.wetness() >= 4) this.outputText("soaking them with your gushing orgasms ", false);
    ...
    private roxanneReamsYouNormal(): void {
        ...
        this.player.buttChange(Math.floor(30 + (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] / 4)), true, true, false);
        this.outputText("\n\n", false);
        ...
        if (this.player.balls > 0) this.outputText("against your own, the " + Roxanne.num2Text(this.player.balls + 2) + " orbs rolling around each other in their sweaty sacks", false);
        else if (this.player.hasVagina()) this.outputText("against your " + this.vaginaDescript() + ", the sweaty orbs growing slick with the moisture of your growing need", false);
        else this.outputText("against your taint, the sweaty skin pressing hard between your bodies", false);
        this.outputText(".\n\n", false);
        ...
        if (this.player.findPerk(PerkLib.Masochist) < 0) this.outputText("until you're voluntarily working your abdominal muscles to avoid the pain.", false);
        ...
        if (this.player.hasCock()) {
            ...
            else this.outputText("They bounce against your belly with your heartbeats, loving the anal pressure.  ", false);
        ...
        //(JUST CUNTS:  
            ...
            else if (this.player.wetness() <= 3) this.outputText("soaking your ready vulva.", false);
            else if (this.player.wetness() <= 4) this.outputText("which drip from your ready vulva.", false);
            else this.outputText("which leak in a steady stream from your ready vulva.", false);
            this.outputText("\n\n", false);
        }

        if (this.player.tallness <= 50) this.outputText("Roxanne shifts forward, placing her tits around your head, letting the smooth scales of her mammoth breasts envelop you in their soft embrace.", false);
        else this.outputText("Roxanne shifts forward slightly, heaving the smooth scales of her mammoth breasts a little further up your back.", false);
        ...
        if (this.player.hasCock()) {
            ...
            else this.outputText("An outpouring of spunk drools from " + this.sMultiCockDesc() + ", spurting submissively under the table.", false);
        }
        if (this.player.biggestLactation() >= 2) this.outputText("  Bursts of milk erupt from your pinned " + this.nippleDescript(0) + "s, blasting out while you cum to stain the table white.", false);
    ...
    private roxanneFucksYourAssOHGODITSHUGE(): void {
        ...
        if (this.player.analCapacity() < 150) this.outputText("Oh, poor " + this.player.mf("boy", "girl") + "!  I don't think you can handle me like this.  Let me get the ointment... after all, I want you to come back for more.", false);
        else this.outputText("Oh, wow!  It's so... stretchy.  Mmmm, I won't even have to use the ointment with you.  You're probably used to this kind of thing, aren't you?", false);
        this.outputText("</i>\"\n\n", false);
        ...
        if (this.player.analCapacity() < 150) this.outputText("Thanks to the ointment, there's little discomfort from the gut-distending penetration.", false);
        else this.outputText("Thanks to your experience with that hole, there's little discomfort from the gut-distending penetration.", false);
        ...
        if (this.player.skinType == SKIN_TYPE_PLAIN) this.outputText(", leaving red lines in your unblemished skin", false);
        ...
        if (this.player.skinType == SKIN_TYPE_SCALES) this.outputText("a roughly-scratched 'X' on your scales", false);
        ...
        if (this.player.hasCock() && this.player.cumQ() >= 1000) this.outputText(", drooling spit into the huge puddle of cum you made on her bed", false);
        else if (this.player.hasVagina() && this.player.wetness() >= 4) this.outputText(", drooling spit into the sloppy puddy of fem-cum you splattered on the mattress", false);
        this.outputText(".", false);
    ...
    private applyHangover(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.Hangover) >= 0) this.player.changeStatusValue(StatusAffects.Hangover, 1, 8);
