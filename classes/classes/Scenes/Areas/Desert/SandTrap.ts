...
export class SandTrap extends Monster {
    ...
    public sandTrapWait(): void {
        ...
        if (this.findStatusAffect(StatusAffects.Climbed) < 0) this.createStatusAffect(StatusAffects.Climbed, 0, 0, 0, 0);
    ...
    public trapLevel(adjustment: number = 0): number {
        if (this.findStatusAffect(StatusAffects.Level) < 0) this.createStatusAffect(StatusAffects.Level, 4, 0, 0, 0);
        if (adjustment != 0) {
            this.addStatusValue(StatusAffects.Level, 1, adjustment);
            //Keep in bounds ya lummox
            if (this.statusAffectv1(StatusAffects.Level) < 1) this.changeStatusValue(StatusAffects.Level, 1, 1);
            if (this.statusAffectv1(StatusAffects.Level) > 4) this.changeStatusValue(StatusAffects.Level, 1, 4);
        }
    ...
    protected performCombatAction(): void {
        if (this.findStatusAffect(StatusAffects.Level) >= 0) {
            if (this.trapLevel() == 4 && this.findStatusAffect(StatusAffects.Climbed) < 0) this.nestleQuikSandAttack();
