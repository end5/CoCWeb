...
export class Wanderer extends BaseContent {
    ...
    private wandererFirstMeeting(): void {
        ...
        this.simpleChoices(this, "Help Him", this.wandererHelpHim, "", undefined, "", undefined, "", undefined, "Leave", this.wandererLeave);
    }
    //Leave
    ...
    private wandererRepeatMeeting(): void {
        ...
        this.simpleChoices(this, "Yes", this.wandererHelpHim, "", undefined, "", undefined, "", undefined, "Leave", this.wandererLeave);
    }
    //Volunteer to help
    private wandererHelpHim(): void {
        ...
        this.simpleChoices(this, "Go Demon", this.wandererGoDemon, "Stay Human", this.wandererStayHuman, "", undefined, "", undefined, "", undefined);
    }
    ...
    private wandererDemonEpilogue(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.WandererDemon) >= 0) {
            ...
            if (this.player.statusAffectv1(StatusAffects.WandererDemon) == 0) {
                ...
                this.player.statusAffect(this.player.findStatusAffect(StatusAffects.WandererDemon)).value1 = 1;
            }
            //Second Encounter
    ...
    private wandererEpilogueHuman(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.WandererHuman) >= 0) {
            ...
            if (this.player.statusAffectv1(StatusAffects.WandererHuman) == 0) {
                ...
                if (this.player.cor < 33) this.outputText("You duck back behind a dune, blushing furiously.", false);
                else if (this.player.cor < 66) this.outputText("You blush crimson as you swear you see Lucia look right at you and wink.", false);
                else this.outputText("You openly leer at the crude display, whistling lewdly at the blissful couple.  Marcus looks up and gives a cocky smile, while Lucia licks her lips and gives you a predatory grin.", false);
                this.dynStats("lus", 10);
                //Value 1 is used to track the status of the end state.
                this.player.statusAffect(this.player.findStatusAffect(StatusAffects.WandererHuman)).value1 = 1;
                this.doNext(this, this.camp.returnToCampUseOneHour);
            }
            //Human Epilogue 2
