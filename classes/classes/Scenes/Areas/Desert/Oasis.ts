...
export class Oasis extends BaseContent {
    ...
    private oasisTalkAccept(): void {
        ...
        if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) this.outputText("your rear legs losing their balance and sending you crashing on your flank.  ", false);
        ...
        if (this.player.findStatusAffect(StatusAffects.VoluntaryDemonpack) < 0) this.player.createStatusAffect(StatusAffects.VoluntaryDemonpack, 0, 0, 0, 0);
        else {
    ...
    public oasisSexing(): void {
        ...
        if (this.player.cocks.length > 0) {
            ...
            if (this.player.cocks[0].cockLength > 25) this.outputText("feel your " + this.cockDescript(0) + " slide into a hell-girl's sloppy cunt. The demoness moans and pants in pleasure as your " + this.cockDescript(0) + " bottoms out in her gaping pussy and she begins to ride you like the motionless whore you momentarily are, her gigantic breasts threatening to concuss you as she slides the huge distance up and down your cock in her thirst to fill her cavelike cunt.  ", false);
            else {
                ...
                if (this.player.cocks[0].cockLength > 17) this.outputText("with hardly any of you inside her ", false);
                else if (this.player.cocks[0].cockLength > 12) this.outputText("about halfway down your " + this.cockDescript(0) + " ", false);
                else if (this.player.cocks[0].cockLength > 6) this.outputText("with almost all of you inside of her ", false);
                else if (this.player.cocks[0].cockLength <= 6) this.outputText("as her pussy lips touch the base of your " + this.cockDescript(0) + " ", false);
            ...
            if (this.player.cocks.length > 1) {
                ...
                if (this.player.cocks.length == 2) this.outputText(this.cockDescript(1) + " is", false);
    ...
    private oasisBadEnd(): void {
        ...
        //[If female/herm]
        if (this.player.lowerBody != LOWER_BODY_TYPE_CENTAUR) this.outputText("Your feet are locked up in shackles, though with a chain long enough to leave you room to move or walk without problems. ", false);
        if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) this.outputText("Your four legs are locked up in shackles, though with a chain long enough to leave you room to move or walk without problems. ", false);
    ...
    private oasisBadEndEpilogue(): void {
        ...
        if (this.player.gender <= 1) this.outputText(" and a few doses of fermented succubi milk", false);
        this.outputText("...\n\n", false);
