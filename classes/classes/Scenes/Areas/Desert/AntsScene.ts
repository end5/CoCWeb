...
export class AntsScene extends BaseContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        if (this.flags[kFLAGS.PHYLLA_EGG_LAYING] > 0 && AntsScene.rand(5) == 0 && this.flags[kFLAGS.ANT_KIDS] < 5000) this.flags[kFLAGS.ANT_KIDS]++;
    ...
    public antColonyEncounter(): void {
        //WAIFU GET!
        trace("ANT WINS: " + this.flags[kFLAGS.ANT_ARENA_WINS] + " ANT LOSSES: " + this.flags[kFLAGS.ANT_ARENA_LOSSES]);
        if (this.flags[kFLAGS.ANT_ARENA_WINS] - this.flags[kFLAGS.ANT_ARENA_LOSSES] >= 2 && this.flags[kFLAGS.ANT_ARENA_WINS] >= 4 && this.player.gender > 0) {
            if (this.flags[kFLAGS.PHYLLA_STAY_HOME] > 0) this.bumpIntoTheAntColonyAfterStayHomePhylla();
    ...
    private firstAntColonyEncounter(): void {
        ...
        if (this.player.cor > 75 && this.player.lust > 50) this.outputText(" looking for something to slake your unquenchable lusts, ");
    ...
    private keepHidden(): void {
        ...
        //►If Over 41 - Female
            ...
            //If PC is lactating:
            if (this.player.lactationQ() > 100) this.outputText("  You feel your warm milk flow out of your hardened arola, as your body begs to release its sweet nectar.");
            //If PC has dick(s):
    ...
    private enterTheColony(): void {
        ...
        //[(corruption < 40)
        if (this.player.cor < 40) this.outputText("\"<i>'Champion', you've been sent to this land to resist the demons and your efforts thus far, insignificant though they be, have not escaped my gaze.  ");
    ...
    private cuntmuffinLingusPhyllaDickBig(): void {
        ...
        //If Snake Tongue:
        if (this.player.tongueType == TONUGE_SNAKE) this.outputText("  You run the split of your forked mouth muscle from the tip of her clit to the base.  As your textured feeler makes its way down, you wrap around the rest of her long clitorus, like a boa constrictor.  Once your split reaches the hood of her clit you roll and flick the tip of your tongue rapidly.  Pulling at your hair she gasps for breath in between teeth grinding moans.");
    ...
    private femalePhyllaFirstTimePlusCock(): void {
        ...
        else this.outputText("your " + this.cockDescript(0) + " leaving the lucky member to bask in affectionate glory as the rest of your manhood laments being left out.  \"<i>Don't worry, I have four hands...</i>\" Phylla coos as she works your shaft.");
        ...
        if (this.player.smallestCockArea() > this.phyllaCapacity()) {
            ...
            //Drider body:
            else if (this.player.isDrider()) this.outputText("Phylla immediately realizes this, and flips you over so that you are resting on your head and neck, ducking in past your " + this.multiCockDescriptLight() + " and coming to rest on the border between your spider carapace and soft clit.");
            //Goo body:
        ...
        //If PC has an appropriately sized dick(s):
            ...
            if (this.player.tentacleCocks() > 0) {
                ...
                //PC has:
                //one tentacle dick:
                if (this.player.tentacleCocks() == 1) this.outputText("your cock into her mouth as she continues to rock her hips into yours.");
                //two:
                else if (this.player.tentacleCocks() == 2) this.outputText("your cocks into her mouth and between her breasts as she continues to rock her hips into yours.");
                ...
                else if (this.player.cocks[this.player.smallestCockIndex()].cockLength < 4) this.outputText("your " + this.cockDescript(this.player.smallestCockIndex()) + ", stroking it apologetically as she scissors you.  You feel her almost insatiable appetite for all parts of your body.  You feel Phylla's mind slowly becoming lost in pleasure.");
                //PC only has a dick(s) that('s) (are) more than 4 inches in width:
                else this.outputText("your " + this.cockDescript(this.player.smallestCockIndex()) + ", but she simply can't fit any number of her hands around the entirety of your glans; instead, she takes to caressing the head of your " + this.cockDescript(this.player.biggestCockIndex()) + ".");
    ...
    private eggDatBitch(): void {
        this.clearOutput();
        //PC is a Female/Herm Drider:
        if (this.player.canOvipositSpider()) this.outputText("While Phylla appears to be sexually sated, the heaviness in your spider abdomen begs for release.\n\n");
        //First Time:
