...
export class SandWitchScene extends BaseContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        if (this.pregnancy.isPregnant && this.pregnancy.incubation == 0) this.pregnancy.knockUpForce(); //Silently clear the Sand Witch's pregnancy if the player has not met her in time
        return false;
    }
    ...
    public encounter(): void {
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1 && this.player.cockArea(0) > 100 && this.player.statusAffectv2(StatusAffects.Exgartuan) == 0) {
        ...
        else this.doYesNo(this, this.allowSandWitchMagic, this.refuseSandWitchMagic);
    }
    ...
    private allowSandWitchMagic(): void {
        ...
        if (this.player.hairColor == "sandy blonde") {
            ...
            if (this.getGame().sand == 1) {
                ...
                else this.outputText("You wish you had said no, so you could fuck with her and her magnificent quartet of breasts some more.", false);
            }
        }
        else {
    ...
    public sandwitchRape(): void {
        ...
        if (this.player.lust > 99) {
            ...
            if (this.player.biggestTitSize() >= 9 && this.player.biggestLactation() >= 3 && this.player.cor >= 25) {
                ...
                this.doNext(this, this.sandWitchBadEnd);
                return;
            }
            this.player.orgasm();
            ...
            if (this.player.hairColor.indexOf("sandy blonde") != -1) {
                ...
                if (this.player.averageNipplesPerBreast() < 1) {
                    ...
                    while (this.temp > 0) {
                        ...
                        if (this.player.breastRows[0].nipplesPerBreast < 1) this.player.breastRows[0].nippleLength = .2;
                        this.player.breastRows[0].nipplesPerBreast = 1;
                    }
                    this.dynStats("sen", 2, "lus", 1);
                }
                if (this.player.biggestLactation() > 0) {
                    this.outputText("A strong pressure builds in your chest, painful in its intensity.  You yank down your top as ", false);
                    if (this.player.biggestLactation() < 2) this.outputText("powerful jets of milk spray from your nipples, spraying thick streams over the desert sands.  You moan at the sensation and squeeze your tits, hosing down the tainted earth with an offering of your milk.  You blush as the milk ends, quite embarassed with your increased milk production.  ", false);
                    ...
                    if (this.player.biggestLactation() > 2.6 && this.player.biggestLactation() < 3) this.outputText("thick hoses of milk erupt from your aching nipples, forming puddles in the sand.  You smile at how well you're feeding the desert, your milk coating the sand faster than it can be absorbed.  The constant lactation is pleasurable... in a highly erotic way, and you find yourself moaning and pulling on your nipples, totally outside of your control.  In time you realize the milk has stopped, and even had time to soak into the sands.  You wonder at your strange thoughts and pull your hands from your sensitive nipples.  ", false);
    ...
    private sandWitchBadEnd(): void {
        ...
        this.doNext(this, this.sandWitchBadEndPartTwo);
    }
    ...
    private sandWitchBadEndPartTwo(): void {
        ...
        this.doNext(this, this.sandWitchBadEndPartThree);
    }
    ...
    private sandwitchRaped(): void {
        ...
        if (this.player.gender == 1 || this.player.gender == 3) {
            ...
            if (this.player.cor < 50) {
                ...
                this.simpleChoices(this, "Breasts", this.sandwitchBewbs, "Sex", this.sandwitchSex, "", undefined, "", undefined, "", undefined);
            }
            //Really corrupt
            else {
                //Single cock
                if (this.player.cockTotal() == 1) {
                    //DOGGIES
                    if (this.player.dogCocks() > 0 && this.player.cocks[0].knotMultiplier > 1.4) this.knotSandwitch();
                    else {
    ...
    private sandwitchSex(): void {
        ...
        if (this.player.cockTotal() > 1) this.outputText(SandWitchScene.num2Text(this.player.cockTotal()), false);
    ...
    private sandwitchCentaurBoning(): void {
        ...
        //[win via lust]
        else this.outputText("and her fingers squeezing her nipples as lust overwhelms her. ", false);
        //[has breasts]
        if (this.player.biggestTitSize() > 3) {
            ...
            //[win via HP]
            if (this.monster.HP < 1) this.outputText("is unable to stop herself from slowly licking her lips. ", false);
            //[win via lust]
        ...
        if (this.player.cor < 70) {
            ...
            //[has breasts]
            if (this.player.biggestTitSize() > 0) this.outputText("; your " + this.nippleDescript(0) + "s  become stiff", false);
            //[cock only]
            if (this.player.totalCocks() > 0 && !this.player.hasVagina()) this.outputText(" and your " + this.cockDescript(0) + " hardens.", false);
            //[cunt only]
            if (this.player.hasVagina() && this.player.totalCocks() == 0) this.outputText(" and your " + this.vaginaDescript(0) + " begins to drip with moisture.", false);
            //[cock and cunt]
            if (this.player.hasVagina() && this.player.totalCocks() > 0) this.outputText(" and your " + this.cockDescript(0) + " hardens as your " + this.vaginaDescript(0) + " begins to drip with moisture.", false);
            ...
            //[GoTo: SW-1]
            if (this.SWCentaurMore(1)) return;
        }
        //[Corruption > 70]
        else {
            ...
            //[GoTo: SW-2]
            if (this.SWCentaurMore(2)) return;
        }
    }
    ...
    private SWCentaurMore(argument: number): boolean {
        ...
        if (argument == 2) {
            ...
            if (this.player.cockTotal() > 0 || (this.player.gender == 3 && SandWitchScene.rand(2) == 0)) {
                ...
                if (this.player.cocks[0].cockThickness >= 3) {
                    if (this.player.hasKnot(0)) this.outputText("Seeing its sheer size combined with your swollen knot causes her to gasp in terror and try to run again.  ", false);
                    else this.outputText("Seeing its sheer size causes her to gasp in fear and turn to run again.  ", false);
                }
                ...
                if (this.player.cocks[0].cockLength >= 12) {
                    if (this.player.cockTotal() == 1) this.outputText("Her body surrenders more and more as your " + this.multiCockDescriptLight() + " presses against her cervix. ", false);
                ...
                else this.outputText(", and her cries have long since turned into groans of pleasure. ", false);
                ...
                //[1 cock, tentacle]
                if (this.player.cockTotal() == 1 && this.player.tentacleCocks() == 1) this.outputText("anus", false);
                else {
                    //[largest cock is not wide and/or long]
                    if (this.player.cocks[0].cockLength >= 12 || this.player.cocks[0].cockThickness >= 3) {
                        //[1 cock]
            ...
            //[% no cocks]
                ...
                if (this.player.hasVagina()) {
                    ...
                    //[anus size is normal]
                    else if (this.player.analCapacity() < 20) this.outputText("two of her fingers ", false);
                    //[anus size is large]
                    else this.outputText("a fist ", false);
        ...
        if (argument == 3) {
            ...
            //[STR > 50]
            if (this.player.str > 50) this.outputText("pick her up and toss her onto your back. ", false);
            //[STR < 50]
    ...
    private knotSandwitch(): void {
        ...
        //ORGAZMO
        if (this.player.cumQ() < 25) this.outputText("The cum slicks your dick as you continue trying to hump, easing the over-sensation of your dick while you're glued together by the bulbous knot locked in her snatch.", false);
        if (this.player.cumQ() >= 25 && this.player.cumQ() < 100) this.outputText("Your cum expands her pussy, stretching her out and leaving your " + this.cockDescript(0) + " swimming in your spunk, trapped within her tight-stretched walls by your massive knot.", false);
        if (this.player.cumQ() >= 100 && this.player.cumQ() < 500) this.outputText("Your cum begins to pump into her corked body, filling her hole to the brim.  Surely the pressure is piling the jizz deep into her womb, and after what feels like forever, the overfull spunk shoves back on your knot, a little dribbling out around the edges of her taut feminine folds as her pussy reaches its limit.", false);
        if (this.player.cumQ() >= 500) this.outputText("Your cum spurts into her in rapid jets, coating the inside of her walls briefly white as more continues to pour into her. Her cunt begins to fill, and as she strugles to relieve the pressure that continues to pump into her, she only succeeds in spurring your orgasm to a new height.  You continue to blast within her, your knot holding her fast as she squirms, each shot of cum from your prick managing to squirt a tiny bit of jizz from your locked genitals.", false);
        this.player.orgasm();
    }
    ...
    public beatSandwitch(): void {
        ...
        this.choices(this, "Yes", this.sandwitchRaped, "Dildo Rape", temp2, "Use 3i@-", temp3, "Use Shouldra", shouldra, "Lay Eggs", ovi,
            "Taunt Her", this.sandwitchSpanking, "", undefined, "", undefined, "", undefined, "Leave", this.cleanupAfterCombat);
    }
    ...
    private missingoSex(): void {
        ...
        this.simpleChoices(this, "N*xt", this.missingoSex2, "", undefined, "", undefined, "", undefined, "", undefined);
    }
    //{Next Page}
    private missingoSex2(): void {
        ...
        //[N*xt]
        this.simpleChoices(this, "N*xt", this.missingoSex3, "", undefined, "", undefined, "", undefined, "", undefined);
    }
    ...
    private missingoSex3(): void {
        ...
        //[@*xt]
        this.simpleChoices(this, "@*xt", this.missingoSex4, "", undefined, "", undefined, "", undefined, "", undefined);
    }
    ...
    private missingoSex4(): void {
        ...
        //[Fuck this!]
        this.simpleChoices(this, "Fuck This!", this.missingoSex5, "", undefined, "", undefined, "", undefined, "", undefined);
    }
    ...
    private missingoSex5(): void {
        ...
        //Restore]
        this.simpleChoices(this, "Restore", this.missingoSex6, "", undefined, "", undefined, "", undefined, "", undefined);
    }
    //{Next Page}
    ...
    private ovipositSandWitches(): void {
        ...
        if (this.monster.HP < 1) this.outputText("bruised and battered");
        ...
        if (this.player.totalCocks() > 1) this.outputText(SandWitchScene.num2Text(this.player.cockTotal() + 1));
        ...
        if (this.player.canOvipositBee()) this.outputText("bee-morphs");
        else this.outputText("driders");
        ...
        this.simpleChoices(this, "Foreplay 1st", this.eggwitchForeplay, "Get Fucking", this.getToFuckingWithZeEggsInWitch, "", undefined, "", undefined, "", undefined);
    }
    ...
    private eggwitchForeplay(): void {
        ...
        if (this.player.cockTotal() > 1 || this.player.gender == 3) this.outputText("es");
        ...
        if (this.player.cor > 50) this.outputText("enough ");
        this.outputText("to giving your way of breeding a shot, you quickly get into position on top of the sand witch.  ");
        if (this.player.canOvipositBee()) this.outputText("Sitting");
        else this.outputText("Laying");
        ...
        this.doNext(this, this.laySomeEggsInThatWitchFinally);
        //go to merge
    }
    ...
    private laySomeEggsInThatWitchFinally(): void {
        ...
        if (cunt) this.outputText("opening of your lover's cervix");
        else this.outputText("deepest recesses of her sphincter");
        this.outputText(".  The joining of oviduct to ");
        if (cunt) this.outputText("womb");
        ...
        if (cunt) this.outputText("at the waiting lips of the sand witch's vagina");
        else this.outputText(" through her rectal walls");
        ...
        if (cunt) this.outputText("into her waiting womb");
        else this.outputText("as far as you can safely tuck it");
        ...
        //(Bee, non-horse:
        if (this.player.canOvipositBee() && !this.player.isTaur()) this.outputText("torso");
        else this.outputText("pelvis");
        ...
        if (this.player.cockTotal() > 1 || this.player.gender > 2) this.outputText("es");
        this.outputText(" is the only point of dissatisfaction, a point you make clear when you ");
        if (this.player.hasCock()) this.outputText("take hold of your " + this.multiCockDescriptLight() + " and bring it");
        else this.outputText("bring your " + this.vaginaDescript(0));
        ...
        if (this.player.gender == 3) this.outputText(" and ");
        if (this.player.hasVagina()) this.outputText("your " + this.vaginaDescript(0));
        ...
        else if (facial == 1) this.outputText("the interior of her mouth with sweltering streams of your cum");
        ...
        if (this.player.canOvipositBee()) this.outputText("honey-like");
        else this.outputText("goopy");
    ...
    public sammitchBirthsDriders(): void {
        ...
        if (this.player.cor < 50) this.outputText("Intending to help");
        else this.outputText("Curious");
        ...
        if (this.player.cor < 60) this.helpZeWithBirfBabies();
        else this.reluctantlyHelpZeWitch();
    }
    ...
    private helpZeWithBirfBabies(): void {
        ...
        if (this.player.isTaur() || this.player.isDrider()) {
            ...
            if (this.player.isDrider()) this.outputText("skitter");
        ...
        this.doNext(this, this.sandwitchBirthsYourMonstrosities);
    }
    ...
    private sandwitchBirthsYourMonstrosities(): void {
        ...
        if (this.player.cor < 60) this.outputText(", with a quick kiss on the lips");
    ...
    public witchBirfsSomeBees(): void {
        ...
        if (this.silly()) this.outputText(", echoing tiny little cries of \"<i>@</i>\"");
    ...
    private sandwitchSpanking(): void {
        ...
        if (this.monster.HP < 1) this.outputText("  You can't even stand up!");
        else this.outputText("  You can't even stop masturbating, can you?");
        this.outputText("</i>\"  You kick her hand away, and she tumbles down into a distraught heap, crying softly");
        if (this.monster.lust > 99) this.outputText(" but still masturbating");
        ...
        if (this.player.cor < 33) this.outputText("and though you feel kind of bad about using her this way, she likely would have done worse to you.");
        else if (this.player.cor < 66) this.outputText("and though you aren't sure you ought to be using her this way, she likely would have done worse to you.");
        else this.outputText("and though you used to find things like this distasteful, you don't really give a shit anymore.");
        ...
        if (this.player.hasCock()) this.outputText("Worse still, [eachCock] is now unprotected and pressed against the rough stone by your body-weight.  It's less than pleasant.  ");
        else if (this.player.hasVagina()) this.outputText("Worse still, your [vagina] is pressed up against the rough stone.  It's less than pleasant.  ");
        this.outputText("You bristle at your helplessness");
        if (this.player.findPerk(PerkLib.FireLord) >= 0 || this.player.findPerk(PerkLib.Hellfire) >= 0 || this.player.findPerk(PerkLib.Dragonfire) >= 0) this.outputText(", breathing out a gout of flame in rage, but you can't even direct the blast properly like this.  All it does is melt some of the sand below into glass");
        else this.outputText(", but there's nothing you can do");
        ...
        if (this.player.cor < 50) this.outputText("She sounds almost fanatical in her dedication to her order.");
        else this.outputText("What the hell is she on about?  Does she actually think her little torture session is going change your attitude?");
