...
export class MaleSpiderMorphScene extends BaseContent {
    ...
    public defeatSpiderBoy(): void {
        ...
        if (this.player.hasCock()) {
            if (this.player.cockThatFits(this.monster.analCapacity()) != -1) buttfuck = this.victoryButtFuck;
            if (this.player.biggestCockArea() > this.monster.analCapacity()) frot = this.victoryFrotTheSpoidah;
        }
        ...
        if (this.monster.lust > 99) this.outputText("masturbating with furious abandon, working his ebon dick with such vigor that the spider's pre-cum-slicked dick-skin noisily slides itself back and forth over his fattened glans; it becomes apparent just how much foreskin he truly has at this point, as even with his frenzied rubbing his glans remains shrouded in the thick excess skin while his fist slaps lewdly against his groin.  Dribbles of pre-cum leak from between his fingers to spill on the ground.", false);
        else this.outputText("wobbling back and forth as he tries to stay up and fight.  There's no way he can oppose you, as beaten as he is now.", false);
    ...
    private victoryButtFuck(): void {
        ...
        if (this.monster.lust > 99) this.outputText("He's too distracted by his foreskin fondling to pay much attention to your anal-focused attentions.", false);
        else this.outputText("He's too busy trying to stay upright to fight off your anal-focused attentions.", false);
        ...
        if (MaleSpiderMorphScene.rand(3) == 0) this.outputText("I-I've never had anything in there...", false);
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() == 2) this.outputText(" resting atop the small of his back", false);
        ...
        if (this.player.balls > 0) this.outputText("r own");
        ...
        if (this.player.cockTotal() == 2) this.outputText("  The leftover dick spurts out its half of your load over his ass, making it look more pearly-white than ever before.", false);
        else if (this.player.cockTotal() > 2) this.outputText("  The leftover dicks spurt out their portion of your load across his ass-cheeks, making them look more pearl-white than ever before.", false);
    ...
    private victoryFrotTheSpoidah(): void {
        ...
        if (this.monster.lust > 99) this.outputText("He pants in surprise and pleasure, clearly enjoying the weighty shaft rubbing against his drooping dick-skin", false);
        else this.outputText("He gasps in surprise and slowly growing pleasure, clearly enjoying the weighty shaft rubbing against his drooping dick-skin", false);
    ...
    private victoryCowgirlRidingOnSpiderBoi(): void {
        ...
        if (this.monster.HP < 1) this.outputText("resulting in a stiff, pre-cum-dripping spider-cock.", false);
        else this.outputText("resulting in the spider-cock's hood of excess, sensitive flesh overfilling with sticky, musky pre-cum.", false);
        this.outputText("\n\n", false);
        ...
        if (this.player.cor < 33) this.outputText("taking the time to clean the dripping spunk from your body.", false);
        else if (this.player.cor < 66) this.outputText("casually wiping away the worst of the dripping spunk.", false);
        else this.outputText("paying no heed to the thick flows of spunk that drip down your " + this.player.legs() + ".", false);
    ...
    private spiderBoyLossMaleButtfuck(): void {
        ...
        else this.outputText(", utterly overwhelmed by your desire for sex until the only thing that matters is letting the sexy spider have his way with you.", false);
        ...
        if (this.player.HP < 1) this.outputText("and silently mouth, \"<i>Please, no.</i>\"", false);
        else this.outputText("and give a little nod, too intoxicated by arousal to decline any form of sex.", false);
        ...
        if (this.player.lust > 99) this.outputText(this.SMultiCockDesc() + " bounces atop your belly, reacting strongly to the tingling sensation radiating from your " + this.assholeDescript() + ".", false);
        else {
        ...
        if (this.player.analCapacity() < 40) this.outputText("mercifully easy due to the mess of pre-cum and the forgiving foreskin that clings to his shaft.  It rolls further and further back as he pushes in until his glans is exposed to your clenching guts.", false);
        else this.outputText("quite easy due to how well-stretched your " + this.assholeDescript() + " is.  Watching his fat little cock disappear into your roomy backside actually brings a smile to your lips.", false);
        ...
        if (this.player.cor < 33) this.outputText("You blush shamefully and nod, utterly humiliated by the quick little orgasm.", false);
        else if (this.player.cor < 66) this.outputText("You blush shamefully and nod, humiliated and aroused by how quickly you just came.", false);
        else this.outputText("You blush with arousal and humiliation, shaking your head up and down and hoping he'll hit that spot again.", false);
        ...
        if (this.player.analCapacity() >= 40) this.outputText("I just wish you were less loose, but I guess you must let anyone with a nice fat cock plug your ass every chance you get, huh?  ", false);
        ...
        if (this.player.cumQ() >= 500) this.outputText("semen continues to leak out at the same pace", false);
        ...
        if (this.player.cumQ() < 500) this.outputText(this.SMultiCockDesc() + " bounces on your belly, leaking one last drop from its tip, utterly draining every drop from your " + this.ballsDescriptLight() + ".", false);
        else this.outputText(this.SMultiCockDesc() + " explodes again, dumping every remaining drop from your " + this.ballsDescriptLight() + " directly onto your " + this.chestDesc() + " and belly.", false);
    ...
    private loseToSpiderBoyVagFucked(): void {
        ...
        if (this.player.lust > 99) this.outputText(", caressing yourself with reckless abandon while praying the sexy spider-boy will come violate you with his thick-skinned prick.", false);
        else this.outputText(", clearly too injured and fatigued by the battle to make more than a few token movements.", false);
        ...
        if (this.player.hasFuckableNipples()) this.outputText("into his mouth before plunging his tongue into the tit-pussy's passage", false);
        ...
        if (this.player.HP < 1) this.outputText("Even though you're injured, his oral attentions make the nub get so hard and sensitive that you quickly forget your own pain.", false);
        else this.outputText("Even though you tried to fight him, his oral attentions make your nub so hard and your horny body so eager that you quickly forget.", false);
        ...
        else if (this.player.wetness() >= 3) this.outputText("drools out a steady stream of lube", false);
        ...
        if (this.player.hasFuckableNipples()) this.outputText("drip their own slippery juices", false);
        ...
        if (this.player.hasCock()) this.outputText(this.sMultiCockDesc() + " becomes so full and hard it feels like it could burst, ", false);
        this.outputText("and your " + this.clitDescript() + " ", false);
        if (this.player.clitLength >= 4) this.outputText("bounces up and down on your belly with each beat of your heart", false);
