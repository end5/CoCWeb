...
((Scenario 4, [Frot]))*/
    ...
    public encounterRogarSwamp(): void {
        ...
        if (this.flags[kFLAGS.ROGAR_PHASE] == 0) {
            ...
            if (this.player.cor < 70) this.outputText("You nod at him, wiping at the sludge on your body before frowning at yourself.  Ro'gar rumbles thoughtfully, eyeing you over again.  \"<i>My house's over yonder.  Ain't nobody but m'self 'round here, but I kin find ya somethin' to wipe yer face with.</i>\"  Ro'gar offers his friendly smile again, his formidable rows of teeth defeating the gesture.  Though vainly, you try to ignore the teeth and smile back at the generosity.  Ro'gar's thick finger points to the ground.  \"<i>Ya jus' wait right here an' I'll be back,</i>\" he says as he turns, trotting through the mud casually.  Should you really wait for him?\n\n", false);
            ...
            //((Corruption 70 or more))
                ...
                if (this.player.isNaga() || this.player.tailType > TAIL_TYPE_NONE) this.outputText("  Your tail flicks about happily.", false);
                this.outputText("  Should you really wait for him?", false);
            }
            this.doYesNo(this, this.waitForChunkyOrcLoe, this.dontWaitForRogar);
        }
        //((Ro'gar phase = 1)) (edited)
            ...
            if (this.player.biggestTitSize() >= 2 && this.player.lib >= 50) {
                ...
                if (this.player.inte <= 30) {
                    ...
                    if (this.player.hasVagina()) this.outputText("  When you witnessed him make that other beast submit with strength alone it created a demanding need in your " + this.vaginaDescript() + " during the match, and the memory is doing much the same now.", false);
                    //((if player has cock(s))
                    if (this.player.hasCock()) this.outputText("  You feel " + this.sMultiCockDesc() + " shift as you remember how hard you got from behind the tree, finding yourself absent mindedly stroking yourself with an open palm as pre-cum soaks through your clothing.", false);
            ...
            //((high femininity or breasts >=B-cup, libido less than 50))
                ...
                //[(int <30) 
                if (this.player.inte < 30) this.outputText("Ro'gar apologizes for wrestling for his territory in your sight.", false);
                //(int>=30) 
            ...
            //((androgynous or masculine and breasts <= A-cup, libido less than 50))
                ...
                if (this.player.inte < 30) this.outputText("leftovers from that fight in the swamp still linger on his body.", false);
        ...
        //Not sure what determines this yet
            ...
            //((androgynous or masculine and breasts <= A-cup))
                ...
                //(Dirt Mc Girt = 2)
                if (this.flags[kFLAGS.ROGAR_DIRT] == 2) this.outputText("\"<i>" + this.player.short + ", y'all took off on me real quick like,</i>\" he says through a snicker.  The joke falls flat and the orc seems to blush lime green as you stare at him uncomprehendingly.  He rubs the back of his neck with a hand before continuing.  \"<i>Sorry about that.  I was plumb tuckered out afterwards.</i>\"\n\n", false);
                ...
                //(if player has been to Tel'Adre)
                    ...
                    //(if Dirt Mc Girt = 2) 
                        ...
                        if (this.player.tallness < 48) this.outputText("  Hands hook under your armpits to lift you up gently.", false);
                        //(if player height is taller than 7 feet)
                        if (this.player.tallness >= 84) this.outputText("  A hand on your shoulder tugs you to lower your head.", false);
    ...
    private waitForChunkyOrcLoe(): void {
        ...
        if (this.flags[kFLAGS.ROGAR_PHASE] == 0) {
            ...
            if (this.player.lib < 50) this.outputText("The hulking orc is surprisingly gentle as he cleans you like a young child.  The warm waters and careful touch soothe your tired muscles.  Your skin becomes textured with goose bumps as the tickles of droplets roll down your body and the filth is washed down to the waters below.  You find yourself sighing in relaxation from the treatment.  A smile curls your lips as you look down at Ro'gar, and he returns the pleased look with a toothy smirk.\n\n", false);
            //((If libido is 50 or more))
                ...
                else if (this.player.hasCock()) this.outputText("  " + this.SMultiCockDesc() + " stirs to life, making it obvious how much you are enjoying the rub down, then begins to drool with lust.  Through lidded eyes you faintly make out Ro'gar's toothy smirk becoming a hungry grin.", false);
    ...
    private sexyChoices(): void {
        this.spriteSelect(86);
        this.simpleChoices(this, "Ewww", this.ewwwRogarIsGay, "NoThnxBro", this.noSlowBroIDontWantPokeSex, "Lick Clean", this.okayBroLetsHaveAGayCarwash, "", undefined, "", undefined);
    }
    //((Ewww))
    ...
    private okayBroLetsHaveAGayCarwash(): void {
        ...
        //[(if player has tail) 
        if (this.player.hasLongTail() || this.player.isNaga()) this.outputText("  Your tail brushes along Ro'gar's legs eagerly, tickling his thighs as you service him.", false);
        ...
        if (this.player.hasCock()) this.outputText(this.sMultiCockDesc(), false);
        else if (this.player.hasVagina()) this.outputText("your " + this.vaginaDescript(0), false);
        else this.outputText("your " + this.assholeDescript(), false);
        ...
        //(int <30)
        if (this.player.inte < 30) this.outputText("  That fight between him and his opponent went on for quite a while, so it makes some sense.", false);
        ...
        this.flags[kFLAGS.ROGAR_PHASE] = 2;
        if (this.player.inte < 30) this.doNext(this, this.camp.returnToCampUseTwoHours);
    ...
    public rogarThirdPhase(): void {
        ...
        //((androgynous or masculine and breasts <= A-cup))
            ...
            if (this.player.skinTone == "green") this.outputText("  \"<i>Hey... Have y'ever had somebody randomly run up an' ask ya ta 'Waaagh!'?</i>\" he mutters quietly.  You give him a perplexed look.  The orc laughs off your confusion dismissively.  \"<i>Nothin', nothin'.</i>\"", false);
            this.outputText("\n\n", false);
            ...
            //(else if Dirt Mc Girt = 2)
                ...
                if (this.player.gender == 2 || this.player.gender == 0) {
                    ...
                    else this.outputText("fantasize about those strong hands touching every part of you", false);
                    ...
                    if (this.player.hasLongTail() && this.player.isNaga()) this.outputText(", and you feel your tail flicking rapidly in excitement", false);
                    this.outputText(".\n\n", false);
    ...
    public rogarPhaseFour(): void {
        ...
        if ((this.player.biggestTitSize() >= 2) && this.flags[kFLAGS.ROGAR_WARNING] == 0) {
            ...
            if (this.player.biggestTitSize() >= 2) this.outputText(" and your " + this.chestDesc(), false);
        ...
        //(andro or masculine with tits <= A)
            ...
            else this.outputText("</i>\"  You ", false);
            ...
            if (this.player.gender == 2 || this.player.gender == 0) {
                ...
                if (this.flags[kFLAGS.ROGAR_DIRT] == 1) this.outputText("</i>\"I know ya probably ain't ever imagined hangin' out with a feller like me, but... I could really use the company tonight.</i>\"  ", false);
    ...
    private rogarFuckMenu(): void {
        ...
        this.menu();
        this.addButton(this, 0, "GetAnal", getAnal);
        this.addButton(this, 1, "GiveAnal", giveAnal);
        this.addButton(this, 2, "Frot", frot);
        this.addButton(this, 3, "BroDrink", brodown);
        this.addButton(this, 4, "GetTiedAnal", getTied);
        this.addButton(this, 5, "OrcRubDown", rubdub);
        this.addButton(this, 6, "No Thanks", this.noTHanksRogarIAintGayDudeIjustLickedThatMudToBeNice);
    }
    ...
    private loseButtGinity(): void {
        ...
        if (this.player.ass.analLooseness == 0) {
            ...
            //(if player has balls) 
            if (this.player.balls > 0) this.outputText("  Ro'gar's dark green cockhead rubs over your " + this.ballsDescriptLight() + " and coats the plump sack in his musky goo, like an alpha male marking his territory.", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.hasLongTail() || this.player.isNaga()) this.outputText("  Your tail wraps around Ro'gar's arm for some sort of stability, the tip flicking lazily as it coils and squeezes around a bicep.", false);
            this.outputText("\n\n", false);
        ...
        //(([Get Anal] Scenario 1b: Get fucked (normal)))
            ...
            if (this.player.tallness >= 84) this.outputText("  You lean down as Ro'gar tilts up, your lips connecting with his, both mouths open to let tongues wrestle.", false);
            //(If player height is less than 7 feet)
            if (this.player.tallness < 84) this.outputText("  You lean up into Ro'gar's mouth, his hand caressing your cheek.", false);
            ...
            if ((this.player.thickness >= 75 && this.player.tone < 33) || this.player.tone >= 75) {
                ...
                if (this.player.balls > 0) this.outputText(" and your " + this.ballsDescriptLight() + " clench tight as you feel your limit reached", false);
            ...
            //(else)
                ...
                //[(if player has tail) 
                if (this.player.hasLongTail() || this.player.isNaga()) this.outputText("  Your tail flicks helplessly below you, urgently wrapping around Ro'gar's thigh and trying to pull him deeper into you.", false);
                ...
                //[(If player has balls) 
                if (this.player.balls > 0) this.outputText("  You feel your " + this.ballsDescriptLight() + " pull up tight in your sack as your labored breath comes out in pants.", false);
    ...
    private fuckRogarsButtPussyBoyCuntManMoundSissySlitQueerQuim(): void {
        ...
        if (this.player.tallness < 72) this.outputText("You reach a hand up to cup his chin, yanking it roughly towards your face as you plant a kiss on his lips.", false);
        //(If player is taller than 7 feet)
        else if (this.player.tallness > 84) this.outputText("You reach down and cup Ro'gar's chin, roughly yanking it up to crash his lips against yours.  ", false);
        ...
        //((If cock is between 18 and 4 inches))
            ...
            if (this.player.cocks[0].cockType == CockTypesEnum.CAT) this.outputText("  You grind around in his green pucker, the barbs working over Ro'gar's inner walls.  \"<i>W-what in tarnation?</i>\" Ro'gar grunts as you watch him squirm under you.  You buck your hips, digging deeper into orcflesh with each thrust, his muscled ass tensing with each slam of your hips.", false);
            //(If horse cock)
            else if (this.player.cocks[0].cockType == CockTypesEnum.HORSE) this.outputText("  The flared head of your " + this.cockDescript(0) + " nestles in Ro'gar's hole.  His breath quickens as you push in, the girthy, flared head stretching Ro'gar's insides impossibly.  You simply thrust and buck you way deeper within the green pucker to force more of your lengthy shaft past that olive rosebud each time.\n\n", false);
            //(If dog cock)
            else if (this.player.hasKnot(0)) this.outputText("  Your pointed tip slips in easily and you begin to plunge into Ro'gar's depths, and the burly orc gives satisfied grunts as his strong hand reaches down to touch himself.  You begin to fill his orc hole, the pre-slicked cock working as a lubing tool as you begin to build a nice rhythm within Ro'gar.  Your knot bulges as your climax approaches and begins to ram into Ro'gar's green pucker, the tight ring unable to allow entry as you swell bigger and bigger.", false);
            //(If other cock)
            else this.outputText("  Breaking Ro'gar's orc hole open, you thrust deep within his hot, tight depths.  The burly orc pants with heated breaths, humid air fluttering out of his tusked mouth.  His musclegut heaves, each breath punctuating the thrusts of your hips.  You plow his ass roughly, pulling out until only the head remains inside him before plunging back in further than before.  Ro'gar grunts low in his chest with each bit of progress made, his strong, calloused hand stroking his drooling cock.  \"<i>Mmmf, " + this.player.short + ",</i>\" he groans as you finally hilt yourself within him.", false);
            ...
            if (this.player.cockTotal() > 2) this.outputText("  Your other cocks grind over that firm orc rump, drooling over his skin and making his rear glisten with your sex.", false);
            else if (this.player.cockTotal() > 1) this.outputText("  Your other cock grinds over that firm orc rump, drooling over his skin and making his rear glisten with your sex.", false);
            ...
            //[(If dog cock)
            if (this.player.hasKnot(0)) this.outputText("  Your knot forces past Ro'gar's tight, anal ring to pulse inside him, joining the pair of you together.", false);
            //[(if player has balls)
            if (this.player.balls > 0) this.outputText("  With short jerks of your hips, you begin to unload your pent up orbs into the orc's innards.", false);
            ...
            //[(if multiple cock)
            if (this.player.cockTotal() > 1) this.outputText("  The other meat rubbing over his olive skin outside adds to the coating of spunk, making a giant mess of Ro'gar's body.  In seconds he resembles a well-paid whore beneath your " + this.multiCockDescriptLight() + ".", false);
            this.outputText("\n\n", false);
        }
        //end right fit path
    ...
    private brobrobrobro(): void {
        ...
        this.simpleChoices(this, "FukkinGrabIt", this.takeDatBroBrewFromDaBigMeanOlOrc, "ReversePsych", this.rogarIsDumb, "", undefined, "", undefined, "", undefined);
    }
    //[reverse psychology]
    ...
    private takeDatBroBrewFromDaBigMeanOlOrc(): void {
        ...
        if (this.player.findPerk(PerkLib.BroBody) < 0) {
            ...
            if (this.player.inte > 21) this.player.inte = 21;
        ...
        if (changed) {
            ...
            //(if dick grew)
            if (cocked) this.outputText(", and you smile to yourself as your now-larger endowment rubs against garments not suited to it", false);
    ...
    private frotWithRogar(): void {
        ...
        //(If single cock)
            ...
            //[(If player has balls)
            if (this.player.balls > 0) this.outputText("Your " + this.ballsDescriptLight() + " slap audibly against Ro'gar's heavy green sack.  ", false);
    ...
    private kinkyWithDaOrc(): void {
        ...
        if (this.player.ass.analLooseness < 3) this.outputText("\"<i>Tarnation, " + this.player.short + ".  You're so tight...</i>\"\n\n", false);
        else if (this.player.ass.analLooseness < 5) this.outputText("\"<i>My favorite boy ready for the ride of his life?</i>\"\n\n", false);
        ...
        if (this.player.ass.analLooseness < 3) this.outputText("the tight hole.  Your teeth clench as he stretches you wide around his length, though he continues without hesitation, and finally you cry out with the sting of the bulbous head squeezing into your tiny hole, though it falls on deaf ears as Ro'gar merely groans at your tightness.", false);
        else if (this.player.ass.analLooseness < 5) this.outputText("your well-used hole. You moan with need as he stretches you wide around his length, continuing without hesitation until he's inside.", false);
        this.player.buttChange(25, true, true, false);
    ...
    private rubdubWithDaOrcWithoutDucky(): void {
        ...
        this.simpleChoices(this, "Play with pits", this.sexyOrcPitsAreSexy, "Ignore pits", this.lickSomeMoreOrcButNoPits, "", undefined, "", undefined, "", undefined);
    }
    //[Play with pits]
