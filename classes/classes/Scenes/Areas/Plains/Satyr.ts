...
export class Satyr extends Monster {
    ...
    private satyrAttack(): void {
        ...
        //Evade: 
            ...
            var damage: number = Math.floor((this.str + this.weaponAttack) - Satyr.rand(this.player.tou));
            if (damage > 0) {
    ...
    public satyrCharge(): void {
        ...
        if (this.findStatusAffect(StatusAffects.Blind) >= 0 && Satyr.rand(3) < 1) {
            ...
            else this.outputText("He charges at you, but you successfully deflect it at the last second.");
        }
        this.combatRoundOver();
    }
