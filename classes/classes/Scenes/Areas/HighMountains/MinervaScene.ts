...
export class MinervaScene extends BaseContent {
    ...
    public encounterMinerva(): void {
        ...
        else if (this.flags[kFLAGS.MINERVA_BACKSTORY_LEARNED] > 0 && this.player.gender > 0 && this.flags[kFLAGS.MINERVA_LOVE] == 0 && MinervaScene.rand(2) == 0) this.minervaAfterFiveTalksRomancing();
        else {
            if (MinervaScene.rand(2) == 0) this.minervaThirdPlusEncounter();
            else this.repeatEncounterMinerva();
        }
    }
    ...
    private firstMinervaEncounter(): void {
        ...
        //If Sophie Bimbo=0:
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] == 0 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00283] == 0 && !kGAMECLASS.sophieFollowerScene.sophieFollower()) this.outputText(" that matronly harpy, Sophie");
        ...
        if (this.player.minotaurAddicted()) this.outputText(".  With any luck, you might even find a hunky minotaur to scratch that burning itch in your mind");
    ...
    private takeMinervasPath(): void {
        ...
        if (this.player.tallness <= 96) this.outputText(" one hand");
        else this.outputText(" both hands");
        ...
        //Low corruption: 
        if (this.player.cor < 50) this.outputText("  \"<i>All right, you!  Who are you and what are you doing here?!  I don't get any visitors besides those horny harpies, so what are you after?  Hm?");
        //High corruption:
        else this.outputText("  \"<i>All right, you corrupted beast!  Who are you and what are you doing here?  Your presence is not welcome in this sanctuary... answer quickly or I'll drop you to your death!");
        //Demon Score=3>:
        if (this.player.demonScore() >= 3) this.outputText("  Filthy demon!  Come to finish your work, have you?!  You won't take me without a fight!  Maybe if you beg for your life I'll give you a chance. Speak!  Convince me to not simply kill you here and now!");
        ...
        this.outputText("\n\nWith");
        if (this.player.isGoo()) this.outputText(" your own");
    ...
    private repeatEncounterMinerva(): void {
        ...
        //No romance: 
        if (!this.minervaRomanced()) this.outputText("  \"<i>Ah, [name], you have returned!  What can I do for you?</i>\"");
        else this.outputText("  \"<i>Mmm... my lover has come to see me!  Oh, how I have missed you, my sweet!  Won't you join me for a bath?  Or... is there anything else I can do for you?</i>\"");
    ...
    private minervaThirdPlusEncounter(): void {
        ...
        //No romance:
        if (!this.minervaRomanced()) this.outputText("  \"<i>Welcome back, [name]!  It's good to see you again.  Have you come to give me some company, or would you like to partake in some of the fruit?  Or are you maybe here to sate your thirst?</i>\"");
        else this.outputText("  \"<i>Darling!  Coming to visit me all the way out here!  How sweet of you!</i>\"");
    ...
    private goForASkyRideWithMinervaHeartBaring(): void {
        ...
        //Goo: 
        if (this.player.isGoo()) this.outputText(" while you're barely able to maintain your slimy cohesion");
    ...
    private rejectMinervasLove(): void {
        ...
        if (this.player.cor < 45) this.outputText("The look in the siren's eyes only makes this harder for you as you look into them; you can't help but feel bad that you really don't feel anything special for her.");
        else this.outputText("You can tell she really wants this - the siren is almost desperate for your attention.  Unfortunately for the love starved herm, she won't find the love she craves with you.");
    ...
    private fightMinerva(): void {
        this.startCombat(new Minerva(), true);
        this.spriteSelect(95);
        this.playerMenu();
    }
    ...
    private minervaTalkSelect(bath: boolean = true): void {
        ...
        if (this.minervaRomanced() && this.flags[kFLAGS.MINERVA_BACKSTORY_LEARNED] == 1) choices[choices.length] = this.talkWithMinervaAboutSharkGirlDaughter;
    ...
    private talkingToMinervaAboutBackstory(): void {
        ...
        //PART 3
            ...
            //No Romance: 
            if (!this.minervaRomanced()) this.outputText("  \"<i>You're a good friend to have, and you know that, [name].</i>\"");
            //Romance:
            else this.outputText("  \"<i>You're a wonderful lover, you know.  I couldn't be happier that you found me.</i>\"");
            // PC returns to camp.
    ...
    private talkToMinervaAboutHerCorruption(): void {
        ...
        if (this.flags[kFLAGS.MINERVA_BACKSTORY_LEARNED] == 1) this.outputText("  You remember my firstborn, the shark girl I had?  Well... not long after she reached maturity, she... well, she got a bit amorous...  She seduced me and I... I mated with her.  I mated with her over and over that night.  I enjoyed it... it was like I couldn't get enough...  I probably got her pregnant...  So shameful...  I impregnated my own daughter and made her bear my grandchild,");
    ...
    private minervaMotherhood(): void {
        ...
        if (this.minervaRomanced()) this.outputText("lover");
        else this.outputText("friend");
        ...
        //Romance: 
        if (this.minervaRomanced()) this.outputText(" hug her tightly and kiss her cheek, telling her that she will have children one day, and perhaps you will have to see about helping her with that 'problem.'");
        //No romance:
        else this.outputText(" place a hand on her shoulder and give her a comforting smile before telling her that she will have that one day - you're sure of it.");
    ...
    private minervaSexMenu(display: boolean = true): void {
        if (display) {
            ...
            if (this.flags[kFLAGS.TIMES_MINERVA_SEXED] == 0) {
                ...
                //PC cock, add: 
                if (this.player.hasCock()) this.outputText(" just... not in my vagina, all right?  That's... special.");
                this.outputText("  Did you have anything specific in mind?");
                //PC female, add: "
                if (this.player.hasVagina()) this.outputText("  Would you mind how we do it?  You're the one asking, so... would you want me to fuck your ass?  Or... do you want me to try to fit between those sexy hips of yours?");
                this.outputText("</i>\"");
            }
            ...
            //{Repeated/No romance: 
                ...
                if (this.player.hasVagina()) this.outputText("  Since you don't seem to mind... would you like me to fuck your ass or to squeeze into your cute cunny?");
                this.outputText("</i>\"");
            }
            //Romanced: 
            else {
                ...
                //PC cock, add:
                if (this.player.hasCock()) this.outputText("  Since we're together, I'll even let you have my pussy, I bet you like the sound of that!");
                //PC female, add:
                if (this.player.hasVagina()) this.outputText("  I'd be happy to pound that cute butt of yours and stuff your hot pussy - which would you rather have, my dear?");
                this.outputText("</i>\"");
            }
        }
        this.menu();
    ...
    private fuckMinervasAsshole(): void {
        ...
        if (this.player.hasVagina()) this.outputText(" and your [vagina]");
        this.outputText(" to the open air.");
        this.outputText("\n\nFeeling Minerva's bare ass rubbing against you helps coax your ");
        if (this.player.cockTotal() > 1) this.outputText("shafts");
    ...
    private minervaCowgirlSex(): void {
        ...
        if (this.player.tallness <= 60) this.outputText(", with some trepidation, given the difference in size,");
        ...
        //Repeated:
        else this.outputText("  Minerva runs a hand through her hair and smiles, \"<i>Well... the last time was quite nice, I think it could be fun.  Sure, let's do it.</i>\"");
        ...
        if (this.player.tallness < 96) this.outputText(", as well as her superior size,");
        ...
        if (this.player.cumQ() >= 500) {
            ...
            if (this.player.balls > 0) this.outputText(" your balls and");
            ...
            if (this.player.hasVagina()) this.outputText("  A few even slither down into your [vagina] to sting you there as well, making sure you are, at least temporarily, turned into a sex-hungry beast.");
        }
        ...
        if (this.player.cumQ() < 500) this.outputText(", Minerva's belly visibly bloated by the time you are finished");
        this.outputText(".");
        if (this.player.cumQ() < 500) {
        ...
        if (this.player.cumQ() >= 4000) {
            ...
            if (!this.minervaRomanced()) this.outputText("  \"<i>Oohhh...I'm so... so big... It's almost like you've gotten me pregnant.</i>\"");
            else this.outputText("  \"<i>Oohhh... I'm so... so big... cumming so much, I didn't know you were so desperate to get me pregnant.</i>\"");
        }
        //Low-to-moderate: 
        ...
        this.flags[kFLAGS.TIMES_MINERVA_COWGIRLED]++;
        this.player.orgasm();
        this.dynStats("sen", -1);
        if (this.getGame().inCombat)
            this.cleanupAfterCombat();
    ...
    private minervaLapSex(): void {
        ...
        //PC herm: 
        if (this.player.gender == 3) this.outputText("  One of her hands trail down to your hard herm " + this.cockDescript(x) + ", stroking you softly.");
        ...
        //Nonvirgin: 
        if (!this.player.hasVirginVagina()) this.outputText("  The thick siren prick plunges into your soaked cunt and fills your sweltering hole with her oddly cool cock, both of you groaning in delightful pleasure.");
        //Virgin:
        else this.outputText("  The thick siren prick plunges into your soaked cunt, filling your sweltering pussy with her oddly cool cock, in the process tearing right through your hymen, claiming your first fuck for herself as you bite back a pained yelp, though it is quickly displaced by the pleasure from the stimulation and venom.");
        ...
        if (this.player.hasCock()) {
            ...
            //{Low-moderate cum: 
            if (this.player.cumQ() < 500) this.outputText(" gushing your cum all over both of your bellies");
            //High cum volume:
            else if (this.player.cumQ() < 4000) this.outputText(" splattering thick splooge all over you and Minerva, caking your torsos in fertile jizz");
            //Very high cum:
            else this.outputText(" exploding out onto your unsuspecting bodies, thick ropes of starkly white sperm gushing over your bodies, quickly dousing both of you in buckets of cum and pooling on the ground");
        }
        this.outputText(".");
        ...
        this.flags[kFLAGS.TIMES_MINERVA_LAPSEXED]++;
        this.player.orgasm();
        this.dynStats("sen", -1);
        if (this.getGame().inCombat)
            this.cleanupAfterCombat();
    ...
    private goDownOnAHermAndLoveItYouDirtySlutYou(): void {
        ...
        if (this.player.tallness < 96) this.outputText("your fingers not even able to fit around the herm's hefty girth");
        else this.outputText("your fingers barely wrapping around the meaty member, the fat thing throbbing gently");
    ...
    private noBallsMinervaAndContinuation(clear: boolean = true): void {
        ...
        if (!clear) this.outputText("  Retreating from her throbbing balls, you");
        ...
        //if demonic tongue:
        if (this.player.tongueType == TONUGE_DEMONIC) this.outputText(", your perversely prehensile tongue slowly retracting from her quivering quim, rubbing and teasing as it comes out and nearly sending the overly sensitive herm into another climax");
        this.outputText(".");
    ...
    private letMinervaSuckYouOff(): void {
        ...
        //If naga: 
        if (this.player.isNaga()) this.outputText(" lounge against the rock, spreading open your protective slit and letting your " + this.cockDescript(x) + " hang free.");
        else this.outputText(" sit down, spreading your [legs] and opening up the crotch of your [armor] to the air, letting your " + this.cockDescript(x) + " hang free.");
        ...
        //If balls:
        if (this.player.balls > 0) this.outputText("  Her hand on your hip moves down between your legs, sliding inwards to gently caress and massage your cum-filled [balls] to increase your pleasure even more, her hands trying their best to get your nuts worked up and prepare a good load for her at the end.");
        ...
        //If cockarea 50+:
        if (this.player.cockArea(x) >= 50) this.outputText(", your huge cock deep inside her mouth, and soon far down her throat.  With some difficulty, her slightly angular nose presses down against your crotch, every inch of your " + this.cockDescript(x) + " trapped inside her cool, wet mouth and throat");
        this.outputText(".");
        ...
        if (this.player.balls > 0) this.outputText(", while your [balls] lurch and swell, rising up as you reach your climactic explosion");
        this.outputText(".");
    ...
    private fuckMinervaWithHerHandsBehindHerBack(): void {
        ...
        //If balls: 
        if (this.player.balls > 0) this.outputText("  As you continue to pound the siren, your [balls] swing between your legs, the sperm-filled orbs churning with your fertility, preparing to fill the needy siren with every drop you can muster when you let loose your eventual orgasm.");
        ...
        //Holy shit!:
            ...
            if (this.player.balls > 0) this.outputText("  Minerva groans and lets out mindless gurgles as you unload your overproductive balls into her.");
    ...
    private pcGetsEatenOutByMinerva(): void {
        ...
        if (this.player.hasCock()) this.outputText(", and, perhaps, your more male parts while she's down there");
        this.outputText(".");
        ...
        if (this.player.balls > 0) this.outputText(", one of her hands lifting your [balls] up before giving each of the fertile nuts a kiss");
        ...
        this.outputText("\n\n");
        //If dick:
        if (this.player.hasVagina()) this.outputText("Thanks to her handy stimulation, your musky maleness throbs and dilates along your femininity, the thick cockvein feeding your bloating member as your seed rushes out, splattering up and onto Minerva's back, defiling her smooth skin with your fertility.  ");
        ...
        this.flags[kFLAGS.MINERVA_LEZZES_OUT]++;
        // PC returns to camp
        this.dynStats("sen", -2);
        this.player.orgasm();
        if (this.getGame().inCombat)
    ...
    public loseToMinerva(): void {
        ...
        if (this.player.HP < 1) {
            ...
            this.monster.createStatusAffect(StatusAffects.PeachLootLoss, 0, 0, 0, 0);
