...
export class Izumi extends Monster {
    ...
    protected performCombatAction(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.Chokeslam) >= 0) {
            if (this.combatDebug) trace("ChokeSlam Rounds to Damage: " + this.player.statusAffectv1(StatusAffects.Chokeslam));
        ...
        if ((this.HPRatio() <= 0.25) && (this.findStatusAffect(StatusAffects.UsedTitsmother) <= -1)) {
            ...
            var actions: any[] = [this.straightJab, this.straightJab, this.straightJab, this.roundhouseKick, this.roundhouseKick, this.roundhouseKick, this.chokeSlam];
    ...
    public straightJab(): void {
        ...
        var damage: number = Math.floor((this.str + 175) - Izumi.rand(this.player.tou) - this.player.armorDef);
        if (this.combatMiss() || this.combatEvade() || this.combatFlexibility() || this.combatMisdirect()) {
            ...
            if (this.player.isNaga()) this.outputText(" raise back up onto your [legs]");
            else this.outputText(" stand");
    ...
    public chokeSlamStruggle(): void {
        ...
        if (brokeFree) {
            ...
            if (this.player.str < 90) this.outputText(" immense");
            else this.outputText(" impressive");
    ...
    public chokeSlamDamage(): void {
        ...
        var damage: number = Math.floor((this.str + 225) - Izumi.rand(this.player.tou) - this.player.armorDef);
    ...
    public chokeSlamEscape(): void {
        ...
        if (this.player.isBiped()) this.outputText(" raise a [leg] and kick her roundly");
        else if (this.player.isNaga()) this.outputText(" raise your tail and slap her solidly");
        else this.outputText(" and slap her square");
        ...
        if (brokeFree) {
            ...
            if (Izumi.rand(2) == 0) {
                ...
                if (this.player.hasCock()) {
                    ...
                    if (this.player.totalCocks() > 1) this.outputText(" they get");
                    else this.outputText(" it gets");
                    this.outputText(", the more insistently your");
                    if (this.player.totalCocks() > 1) this.outputText(" erections throb");
                    else this.outputText(" erection throbs");
