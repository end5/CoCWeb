...
export class IzumiScene extends BaseContent {
    ...
    public heightDesc(doName: boolean = true): string {
        if (IzumiScene.rand(4) != 0) return "kid";
            ...
            if (this.player.tallness < 72) return "short-stuff";
            if (this.player.tallness < 84) return "shorty";
            if (this.player.tallness < 96) return "kid";
            else {
                if (doName) return this.player.short;
                else return "kid";
            }
        }
    }
    ...
    public actsLikeACow(): boolean {
        if (this.player.inHeat) return true;
        if (this.player.inRut) return true;
        if (this.player.findStatusAffect(StatusAffects.Dysfunction)) return true;
        return false;
    }
    ...
    public encounter(): void {
        ...
        if (this.flags[kFLAGS.IZUMI_MET] == 0) {
            this.outputText("As you wander the wasted landscape searching for anything of interest, you come across a large rock blocking what appears to be the entrance to a cave.  Wondering about how to best get around it, you suddenly become aware of a strange sound on the edge of your hearing.\n\n");

            this.outputText("Flattening yourself against the stone in case of danger, you strain your ears and scan the horizon, searching for the source of the noise.  The volume gradually increases, and eventually you realize what it is that you’re hearing; someone nearby is loudly humming, a lively tune echoing off the rocks and cliffs.  As best you can tell, it seems to be coming from the other side of the enormous stone blocking your path.\n\n");
    ...
    public enterAfterMet(): void {
        ...
        if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 0) this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] = 2;

        if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 1) {
            this.outputText("Remembering the outcome of your last visit, you peer cautiously around the mouth of the cave.  Izumi, as before, is seated by the fire, happily puffing away at whatever bizarre narcotic she keeps in her pipe.  She sees you almost immediately, raising a hand cheerfully and beckoning for you to enter.\n\n");

            this.outputText("“<i>Hey, it’s you! How’s it going, " + this.heightDesc() + "? Killed any demon kings yet?</i>” Izumi ribs. “<i>Let me guess.. You’re here to take revenge on the big bad Oni, grr argh, right? Or...</i>”  She pauses for a second to shift around into a more comfortable position that - completely inadvertently, you’re sure - ends up with her showing off much more of her thighs and impressive bust.  “<i>Could it be you just came back to ask for another turn, hmm?</i>”\n\n");
        }
        else if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 2) {
            this.outputText("Remembering your last visit, you peer cautiously around the mouth of the cave.  Izumi, as before, is seated by the fire, happily puffing away at whatever bizarre narcotic she keeps in her pipe.  She sees you almost immediately, raising a hand cheerfully and beckoning for you to enter.\n\n");

            this.outputText("“<i>Oh hey, you came back!</i>”  She announces.  “<i>That’s good, ‘cause for a while there I thought you were a wuss.  Crazy idea, right?  So, did you decide to try your luck, or are you just gonna give up and let me have some fun?</i>”\n\n");
        }
        else if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 3) {
            this.outputText("Ranging through mountains and valleys, you find yourself back at Izumi’s camp.  Remembering the outcome of your last visit, you peer cautiously around the mouth of the cave.  Izumi, as before, is seated by the fire, puffing away at whatever bizarre narcotic she keeps in her pipe.  She catches sight of you almost immediately, frowns slightly, then raises a hand in a hesitant greeting.  There’s an awkward silence for a moment, during which Izumi avoids your gaze.\n\n");

            this.outputText("“<i>So, uh...</i>” she begins.  Then she scowls, blushing slightly.  “<i>So, you came back to apologize, right?  You damn well better have!  In fact, I’m not forgiving you until I’ve made you feel as humiliated as I did, so just give in already, okay?!</i>”\n\n");
        }
        else {
    ...
    protected enterFirstTime(): void {
        ...
        if (this.player.tallness >= 108) {
            ...
            if (this.player.str >= 75) {
                this.outputText("Putting your shoulder to the stone, you push with all your might, trying to roll it out of the way.  It resists for a moment, then gives, slowly but surely rattling and scraping across the uneven ground.\n\n");
            }
            // Low strength variant
            else {
                this.outputText("Putting your shoulder to the stone, you push with all your might, trying to roll it out of the way.  It resists, but you are determined, your [feet] scrabbling against loose rocks and gravel, trying to find the purchase you need to move the boulder.\n\n");
            }

            // Shared
            this.outputText("The humming stops almost instantly, and moments later a hand suddenly rests itself on the rock in front of you.  Looking up from your exertions, you find yourself face to face with a woman.  It takes a moment, but then you realize, you really are actually face to face with her - she’s as tall as you are!");

            // Catch logic shit that we just broke
            if (this.player.str < 75) {
                this.outputText("  She gives the boulder a shove - with just one hand - and it starts to give, scraping across the uneven ground.\n\n");
            }
            else {
                this.outputText("\n\n");
            }

            this.outputText("The woman stares at you in suspicion for a moment, giving you the opportunity to study her in return.  She wears a silken kimono, embroidered with stars, dragons and flowers, which you can’t help but notice is of a truly scandalous cut – your eye is inevitably drawn to her enormous breasts, bulging dangerously against the fabric as though straining to escape.  If she were human-sized and remained in proportion, they would probably be around a DD, but at her size, you honestly have no idea.  Not only is she just as tall as you, she’s pretty built physically as well, at least from what you can see of her thighs and arms thanks to her figure-hugging outfit.\n\n");

            this.outputText("When you finally manage to drag your eyes back to her face, her expression is quite different. Instead of suspicion, she treats you to a sly smile.\n\n");

            this.outputText("“<i>Well now,</i>” she drawls in a syrupy, seductive tone, twirling an errant lock of her hair thoughtfully in her fingers.  “<i>You’re a </i>big<i> one, aren’t you?  And here you are,");
            if (this.player.str >= 75) this.outputText(" forcing");
            else this.outputText(" trying to force");
            this.outputText(" your way through little Izumi’s door uninvited.  I’d tell you off, but I’ve got to admit, I don’t get many visitors of your... </i>stature.<i>");

            if (this.player.hornType != HORNS_COW_MINOTAUR) {
                this.outputText("  Or at least, ones without a pair of bulls horns");
                if (this.actsLikeACow() == true) {
                    this.outputText(" - and the temperament to match - ");
                }
                else {
                    this.outputText(", ");
                }
                ...
                if (this.actsLikeACow() == true) {
                    this.outputText("  Or at least, ones without the temperament to match the... physique, ");
                }
            }
            this.outputText("if you follow?</i>”\n\n");

            this.outputText("She turns and heads back into the cave, quickly disappearing into the gloom, the strange woman motioning you to follower her inside with a wave.  You creep slowly into the darkness after her, your sight gradually adapting to the darkness.\n\n");
        }
        // "short" variant
        else {
            this.outputText("You squeeze through the gap, entering the cave.  Almost immediately, a palpable wave of heat rushes over you, sweat already starting to bead on your brow; it’s <i>stuffy</i> in here!\n\n");
        }

        this.outputText("Now that you’ve made it inside, you can see that the cave is dimly lit by two burning braziers on either side of what appears to be a large tent of some sort.  In front of the tent, the fire smolders gently.  It’s difficult to make out details, as the lighting is pretty poor, wreathing everything in strange, animated shadows.  To make matters worse, the entire place is permeated by a thick veil of smoke that makes your eyes sting");
        if (this.player.tou <= 75) this.outputText(" and of course, that obnoxiously endurance-sapping heat");
        this.outputText(".\n\n");

        if (this.player.tallness < 108) {
            this.outputText("You can still hear the humming, but at first, there doesn’t seem to be anyone around.  You creep closer to the tent, until suddenly, a huge shadow at the front of the tent shifts.  You freeze, straining your eyes through the darkness, as you suddenly realize that’s not a shadow at all - it’s an enormous figure!  You must have gasped, as without warning the humming stops.\n\n");

            this.outputText("“<i>Hm?</i>” the shadow grunts, then speaks.  “<i>Oh?  Now how did you find your way in here, I wonder?</i>”  The voice is deep, rich and undeniably female, but has a gravelly edge to it like a cross between magma and molten chocolate.  You hear the hiss of indrawn breath and a small light flares up briefly in the darkness, then the shadow speaks again.  “<i>Well, whatever. It’s been a while since I had company, ");

            if (this.player.minoScore() > 3) this.outputText("plus it looks like you're thinking with the head on top of your neck, rather than the head between your legs, unlike the stupid brutes who usually wander around these parts.  ");
            else if (this.player.dogScore() > 3) this.outputText("plus it looks like you'd actually be able to resist chasing down a stick, if I threw one outta' the cave.  ");
            else if (this.player.goblinScore() > 3) this.outputText("plus you don't seem to be as insufferable as the rest of those little green whores who trollop around these parts, hunting their next lay.  ");
            else if (this.player.demonScore() > 3) this.outputText("plus you're not forever going on about corruption this, enslavement that, demonic taint the other, unlike the insufferable clods who usually wander around these parts.  ");
            else if (this.player.harpyScore() > 3) this.outputText("plus you're not screeching incessantly, like the feathery sluts who usually flap their way around these parts.  They're lucky they </i>can<i> fly, 'cause I'd give them something to really squawk about if I could get my hands on them.  ");
            else if (this.player.lizardScore() > 3) this.outputText("plus, you don't have the same creepy eyes that the scaley idiots from around these parts keep trying to use on me.  ");
            else this.outputText("plus you don’t look like the troglodytes who usually wander around these parts.  ");
            this.outputText("Sit down, sit down!</i>”\n\n");
        }

        this.outputText("Cautiously, you edge towards the lip of the fire, and");
        if (this.player.tallness >= 108) {
            this.outputText(" a");
        }
        else {
        ...
        this.outputText(" shadow leans forward, finally becoming visible.");
        if (this.player.tallness < 108) {
            this.outputText("  For a moment, you’re stunned into silence; the figure looks completely human, aside from two important factors.  The first, her size; she looks as though someone had tried to build a human but got the scale wrong.  By the looks of her, if she was standing upright she would tower at least around eight or nine feet in height, and she looks broad enough to carry a horse on her back.");
        }
        else {
            this.outputText("  With the opportunity to finally study the strange woman in detail, you’re stunned into silence.  She looks completely human, aside from two important factors.  The first, her size; she looks as though someone had tried to build a human but got the scale wrong.  A fact you’re made aware of every time you venture from camp; it’s not every day you meet somebody just as tall as yourself.");
        }

        this.outputText("  The second factor, of course, would be the enormous curved horn of red, rock-like bone that juts proudly from her forehead.  Still, they’re no less inhuman than some of the other creatures you’ve encountered since arriving....\n\n");

        this.outputText("“<i>Hmm?</i>”  She looks blankly at you.  The sudden realisation that you’ve been staring at her horn for an uncomfortably long time hits you.  “<i>What?  Is there something on my face?</i>”  Blushing, you open your mouth to answer, but as you breathe in, a rush of coarse smoke down your throat");
        if (this.player.tou < 60) this.outputText(" causes you to cough and splutter.\n\n");
        else this.outputText(" momentarily steals your voice, having been ill-prepared for the sudden burn.\n\n");

        this.outputText("The strange woman blinks at you in confusion for a moment, then her face cracks into a grin.  “<i>Oh, right, I forgot people like you tend to be pretty fragile.  Hold on");
        if (this.player.tou < 60) this.outputText(", kid. Let");
        else this.outputText(", let");
    ...
    protected enterFirstTimePartII(): void {
        ...
        this.outputText("Still");
        if (this.player.tou < 60) this.outputText(" struggling with");
        else this.outputText(" distracted by");
        this.outputText(" the smoke, you turn to see her, only barely through the gloom, at the boulder blocking entry to the cave.");
        if (this.player.str <= 75) this.outputText("  To your amazement, the boulder begins to move, and as more light - along with a much-needed rush of fresh air - floods into the smoky cavern, you see she’s actually rolling it aside with her <i> bare hands </i>.  Even given her great size, this woman’s strength must be immense!\n\n");
        else this.outputText("  The boulder begins to move, and as more light - along with a welcome rush of fresh air - floods into the smoky cavern, you see she’s rolling it aside with nothing more than her bare hands with graceful, if unnerving, ease.\n\n");

        this.outputText("Finally, the boulder is pushed far enough that about half of the cave mouth is now open to the air. It’s still dark, but at least now you are able to see well enough to make out actual details as the woman strides casually back to you to retake her seat.  She smiles again, her features broad and honest, framed by an enormous chaotic mass of shaggy golden hair, looking for all the world like the mane of some great lion.\n\n");

        // Catch describing her in detail to short players
        if (this.player.tallness < 108) this.outputText("She wears a silken kimono, embroidered with stars, dragons and flowers, which you can’t help but notice is of a truly scandalous cut – your eye is inevitably drawn to her enormous breasts, bulging dangerously against the fabric as though straining to escape.  If she were human-sized and remained in proportion, they would probably be around a DD, but at her size, you honestly have no idea.\n\n");

        this.outputText("She sits, right knee raised so she can rest her arm on it, her left foot tucked behind the right.  As she does so, her kimono slides aside,");
        if (this.player.cor <= 33) this.outputText(" exposing an uncomfortable amount of creamy-white thigh flesh.");
        else if (this.player.cor > 33 && this.player.cor < 66) this.outputText(" exposing a tantalising view of creamy-white thigh flesh.");
        else this.outputText(" exposing a delicious view of her thigh, the creamy-white flesh almost screaming out for your caresses.");
        this.outputText("  If she notices, then she doesn’t seem to care.\n\n");

        this.outputText("“<i>Better, right?</i>” she asks, and you nod.  “<i>Sorry, I didn’t realize the smoke was getting to you at first.  It’s been a while since I’ve seen anything but a minotaur or a demon, at least ones that seem more interested in polite conversation than reaming everything in sight.</i>”  She grimaces, briefly.  “<i>So, what’s your story, " + this.heightDesc(false) + "?</i>”  Whoever she is, she seems friendly enough");
        if (this.player.tallness <= 96) this.outputText(" - if a little... imposing -");
        else this.outputText(",");
        this.outputText(" so you give her your name, and, hesitant to discuss your true quest in any depth, detail some of your past encounters in this strange world.  Nodding encouragingly, she raises a long, elaborately carved pipe to her lips, puffing away as you tell your story....\n\n");

        this.outputText("“<i>Oh, so you’re the heroic type, yeah?  So, I guess it’s my turn now, huh?</i>” She sighs and closes her eyes, reclining and crossing her legs.  You can’t help but notice the way her kimono slithers around her legs, mere inches from becoming truly indecent, nor the way her breasts threaten to burst free of their confinement as she stretches.\n\n");

        this.outputText("“<i>Ah, but where to begin?  My clan calls me ‘Izumi, <b>The Font Of All Strength’</b>.</i>”  She snorts in amusement at your reaction to her name.  “<i>I know, it’s a little pompous, right?  Just use Izumi, I always do.  Either way, I’m a traveller from another world.");

        if (this.player.humanScore() > 3) {
            this.outputText("  I’ve met humans before a few times.  Back home, my people like to play games with them to see how they’ll react; show up, scare the locals, steal a sheep and run off giggling to yourself, that kind of thing.  Sometimes one of them is actually brave enough to come after us.  Sometimes we even slap ‘em on the back, give ‘em the sheep and then drink them under the table.</i>” \n\n");

            this.outputText("She takes a long, powerful drag on her pipe, her lips locked tight around the mouthpiece.  “<i>It was fun for a while, but bothering goatherds for the next thousand years wasn’t my scene, frankly, so I left.  Bailed.  Disappeared.");
        }

        this.outputText("  I didn’t come here to fight demons or any of that nonsense, though.  I’m just looking for something <b>fun</b> to do, you know?  Something to keep my interest for a while.</i>”  She opens her eyes again, two enormous amber irises staring thoughtfully down at you.  For some reason, you find something very uncomfortable about her gaze....");
        if (this.player.str <= 75 || this.player.tallness < 96) this.outputText(" You can’t help but feel like a sheep yourself - one who’s just noticed the wolf is staring it down.\n\n");

        this.outputText("“<i>My mistake coming here, though.  There’s no conversationalists, no challenges, nothing fun. The only other conversations I’ve had since coming here have all gone more or less the same way, you know?  ‘Harharhar, I shall turn you into my slave!  How dare you pick me up, I shall destroy you!  Why are we heading towards that cliff!’  and so on.</i>”\n\n");

        this.outputText("Izumi seems singularly unperturbed by the sex-mad nature of this world, an attitude you find oddly refreshing.  There’s something about her; she seems to exude an aura of steady, unconcerned confidence from every movement, dripping from each word she speaks.  It’s a difficult thought to articulate, but the enormous woman’s lazy smile and relaxed attitude seem... infectious.\n\n");
    ...
    protected smokeEffect(smokedPipe: boolean): void {
        ...
        this.player.createStatusAffect(StatusAffects.IzumisPipeSmoke, this.SMOKE_DURATION, deltaSpd, deltaSns, deltaLib);
        ...
        this.player.spe += deltaSpd;
        this.player.sens += deltaSns;
        this.player.lib += deltaLib;

        if (this.player.spe <= 0) this.player.spe = 1;
        if (this.player.sens >= 100) this.player.sens = 100;
        if (this.player.lib >= 100) this.player.lib = 100;

        this.showStatDown('spe');
        this.showStatUp('sens');
        this.showStatUp('lib');

        this.dynStats("lus", lustMod);
    }
    ...
    public updateSmokeDuration(hours: number): void {
        ...
        if (affectIndex >= 0) {
            ...
            if (this.player.statusAffect(affectIndex).value1 <= 0) {
    ...
    protected smokeEffectWearsOff(): void {
        ...
        if (affectIndex >= 0) {
            ...
            this.player.sens -= this.player.statusAffect(affectIndex).value3;
            this.player.lib -= this.player.statusAffect(affectIndex).value4;

            if (this.player.sens > 100) this.player.sens = 100;
            if (this.player.spe > 100) this.player.spe = 100;
            if (this.player.lib <= 0) this.player.lib = 1;

            this.showStatUp('spe');
            this.showStatDown('sens');
            this.showStatDown('lib');
            ...
            this.player.removeStatusAffect(StatusAffects.IzumisPipeSmoke);
        }
    }
    ...
    protected smokeThePipe(): void {
        ...
        this.outputText("Whatever it is she has in there, the smoke is thick and cloying and even the smallest puff makes");
        if (this.player.tou <= 60) this.outputText(" you cough and splutter");
        else if (this.player.tou < 75) this.outputText(" you flinch, holding back a cough");
        else this.outputText(" your eyes water");
        this.outputText(" - much to your mutual amusement.  You talk and joke for a while longer, the smoke making you feel incredibly relaxed, as though all the tension were simply melting from your body.");
        if (this.player.tou <= 80) this.outputText("  After a while, you find it hard to even raise your arms to reach for the pipe again.\n\n");
        else this.outputText("\n\n");
    ...
    protected dontSmokeThePipe(): void {
        ...
        this.outputText("You do your best to politely refuse the pipe, explaining your unwillingness to eat, drink, chew, chug or otherwise consume various items you’ve come across during your travels, having witnessed some of the effects first-hand.\n\n");
    ...
    protected smokeJoins(): void {
        this.outputText("Finally, the two of you seem to run out of things to speak about and the conversation dies down.  Izumi puffs on her pipe and lets out a long column of smoke, still gazing at you speculatively.  “<i>Hmm.  You’ve been pretty interesting, I didn’t expect to meet anyone who might be </i>fun<i> out here.</i>”  She mutters.  “<i>If you </i>are<i> going to keep going with this whole heroic deeds thing, try not to die, okay?  You’re the only halfway entertaining person I’ve met on this rock, and I’d hate to imagine you winding up as some imp’s body pillow, or whatever....</i>”\n\n");

        this.outputText("You hear Izumi let out a quiet giggle.  Looking up, you see she’s shifted closer to you, edging right up to the fire.  She makes a show of appraising you physically, her golden-amber eyes sparkling in the dancing firelight as her gaze roams over your body, from head to [foot].");
        if (this.player.str <= 75 || this.player.tou <= 75 || this.player.tallness <= 96) this.outputText("  You swallow, hard, suddenly feeling oddly nervous.");
        this.outputText("  She’s even larger up close, and you can clearly see the solid, capable looking muscle that makes up her frame....\n\n");

        if (this.player.tallness < 108) {
            this.outputText("“<i>You know, you’re pretty cute.  Did I already say that?  Well even if I did, it’s true.  I like brave people.  I like people who challenge themselves.  You’re pretty brave, surviving in a place like this all alone, you know?</i>”  Without warning, she leans forwards over the dying fire, the ruddy light from the coals illuminates her face from below, giving her a decidedly sinister air.\n\n");

            this.outputText("“<i>I think it’s about time you repaid me for my hospitality.</i>”  She says, her eyes glittering dangerously in the firelight.  “<i>After all, you came into my camp uninvited... that’s pretty rude, you know?  I think I might take offence to that.</i>”  As she speaks, she slinks closer to you on all fours like some kind of predatory cat, about to make the final killing leap upon its helpless prey... Her personality has changed completely from the gentle giant you were speaking with a second ago.  You suddenly wonder if perhaps the smoke is somehow affecting her.\n\n");

            this.outputText("“<i>I think you’d better make it up to me, yeah?</i>”  She continues, slurring her words slightly as she reaches out with one hammer-like hand, then seizes hold of your [armor].  “<i>Otherwise I might get nasty.  And you don’t want me to get <i>nasty</i> with ya’, do ya’?</i>”\n\n");
        }
        else {
            this.outputText("“<i>You’re pretty impressive, you know?  You’ve even gotten me a little homesick, coming in here looking like that.  How cruel. How cruel....</i>”  She presses a finger to her lips, thoughtfully.  Then she smiles, taking you by the hand and drawing you into the cave. “<i>I know!</i>” She says in a sing-song voice.  “<i>Since you came stomping around here so rudely, it’s only right that I get to discipline you, right?  So, in return for me letting you leave... I get to do whatever I want to you in the meantime.</i>”\n\n");
        }
    ...
    protected fuckinChegIt(): void {
        ...
        this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] = 2;
    ...
    protected fightTheFuckhugeOni(): void {
        ...
        // First time
        if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 0) {
            ...
            this.outputText("“<i>Oh, you think you can take me?  That’s cute, " + this.heightDesc() + ".  That’s real cute,</i>” Izumi says, breaking off the conversation.  She picks herself up from the floor, abruptly breaking off the conversation to wander around the cave, flexing her muscles and rotating her joints as though preparing to exercise - all the while, her grin growing increasingly confident, more... ravenous.\n\n");

            if (this.player.tone <= 75) this.outputText("“<i>Alright!  I’ll tell you what I’ll do... I’ll give myself a handicap.</i>”  Izumi turns to face you, cracks her neck, then extends a hand, folding the other arm behind her back.  “<i>I’ll only use one arm.  I wouldn’t want to put you in your place </i>too<i> quickly.  Where would be the fun in that?</i>”  She leers.\n\n");

            this.outputText("“<i>If you can beat me, I’ll let you go.  If not, well... to the victor go the spoils.  Know what I mean?</i>”  She says, her smirk somehow growing perceptibly wider.\n\n");

            if (this.player.tone <= 75) this.outputText("The idea that she thinks she can beat you with one hand behind her back is insulting to say the least, but on the other hand, her overconfidence could be her downfall.\n\n");

            this.outputText("You nod, rising to your [feet] and dropping into a fighting stance. Izumi grins.  “<i>Let me just say this to start... I am </i>quite<i> strong.</i>”\n\n");
        }
        // PC won last fight
        else if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 3) {
            this.outputText("“<i>So, you’re not gonna apologize?!</i>” Izumi scowls at you, blushing slightly. “<i>You’re a real jerk, you know that?  Fine then, I’ll just have to spank some manners into you!  Don’t cry!</i>”\n\n");

            this.outputText("She drops into a fighting stance once again, but this time, instead of bending one arm behind her back, she hesitantly holds it up in front of her horn.  Her blush deepens as you stare at her.  “<i>Y-You cheat! I’m not falling for that kind of thing again!</i>” she explains hotly.\n\n");
        }
        // PC lost last fight
        else if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 1) {
            this.outputText("There’s no way you’re just going to lie back and let Izumi walk all over you again; at least, not without resistance.\n\n");

            this.outputText("“<i>Alright! I’ll tell you what I’ll do... I’ll give myself a handicap.</i>”  Izumi turns to face you, cracks her neck, then extends a hand, folding the other arm behind her back.  “<i>I’ll only use one arm.  I wouldn’t want to put you in your place </i>too<i> quickly.  Where would be the fun in that?</i>”  She leers, “<i>If you can beat me, I’ll let you go.  If not, well... to the victor go the spoils.  Know what I mean?</i>”\n\n");

            this.outputText("You nod, rising to your feet and dropping into a fighting stance.\n\n");
        }
        // PC ran away
        else if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 2) {
            this.outputText("Sooner or later, you’re going to have to face up to the large Oni.  No time like the present, right?\n\n");

            this.outputText("Izumi can clearly tell that you have no intentions of running away on her... again.  To your surpise, rather than lunging forwards to attack or flying off the handle, she beams at you.  “<i>Alright! I’ll tell you what I’ll do... I’ll give myself a handicap.</i>”  Izumi turns to face you, cracks her neck, then extends a hand, folding the other arm behind her back.  “<i>I’ll only use one arm.  I wouldn’t want to put you in your place </i>too<i> quickly.  Where would be the fun in that?”  She leers, “<i>If you can beat me, I’ll let you go.  If not, well... to the victor go the spoils.  Know what I mean?</i>”\n\n");
        }
        else {
            throw new Error("You done fucked something up in Izumi's fight intro text!");
        }

        this.startCombat(new Izumi());
    }
    ...
    protected fuckhugeOniGetsWhatSheWants(): void {
        ...
        if (this.player.hasCock()) {
            this.outputText("You swallow your pride and shake your head, signalling Izumi that you don’t intend to resist.  Her face splits into a truly lascivious grin and she licks her lips, hungrily.\n\n");

            this.outputText("“<i>Yeah, that’s what I thought.</i>”  She smirks.  “<i>You just do exactly what I say, when I say, and nothing bad will happen to you.  Well... Nothing <i>too</i> bad, anyway.</i>”\n\n");

            this.outputText("Suddenly, she lunges forwards, one enormous hand planting itself onto your");
            if (this.player.isTaur()) this.outputText(" flank and forcing you sideways onto the ground.");
            else this.outputText(" chest and forcing you backwards onto the ground.");
            this.outputText("  You grunt from the impact and try to sit up, but Izumi easily restrains you with a single well-muscled arm.  “<i>Well now, let’s see what we’re workin’ with here, shall we?</i>” she announces casually, as she pulls aside your [armor] to reveal your cock.\n\n");

            if (this.player.biggestCockLength() <= 6) this.surrenderSmallCock();
            else if (this.player.biggestCockLength() <= 14) this.surrenderMediumCock();
            else this.surrenderLargeCock();
        }
        // Female
        ...
        this.flags[kFLAGS.IZUMI_TIMES_SUBMITTED]++;
    ...
    protected surrenderSmallCock(): void {
        this.outputText("“<i>Ohhh!</i>”  She positively purrs as her eyes fall upon your naked [cock biggest] for the first time.  “<i>What’s this?</i>”  She leans forwards to stare at your genitals with undisguised interest.  “<i>Well, now... I figured you [race]s would be pretty");
        if (this.player.isTaur()) this.outputText(" big");
        else this.outputText(" small");
        this.outputText(", but this isn’t what I was expecting at all.  Hmm... I </i>was<i> planning on giving you a handjob, but, uh... I guess this’ll have to do, huh?</i>”  She gives you an almost apologetic smile as she holds up her hand, thumb and forefinger curled into a ring as though to show you what she has planned, before reaching back down to your groin. Her fingers slide over your stiffening flesh and you realize in a flood of soul - crushing embarrassment that she’s right.  You’re so small, she actually can’t fit more than two fingers around your cock at a time.\n\n");

        this.outputText("You try to look away, blushing crimson, but the weight on your");
        if (this.player.isTaur()) this.outputText(" flank");
        else this.outputText(" chest");
        this.outputText(" suddenly disappears as Izumi grips your chin with her free hand, forcing you to lock gazes with her.  “<i>Hey, don’t look away!</i>”  She chides.  “<i>Seeing your face during all this is the best part... aw, hey, are you embarrassed?  You’re blushing!  That’s so </i > cute !” She trills.  “<i> Here, look.  I know what’ll make ya feel better....</i>”  Before you can respond, the domineering Oni woman");
        if (this.player.isTaur()) this.outputText(" perches her muscular ass on your flank, your body making for a suitable seat.");
        else this.outputText(" drops to the floor, laying next to you on her side.");
        this.outputText("  She releases your chin, but her hand snakes around behind your head to your other cheek, pulling you in towards her.  You can’t help but grunt in surprise as the side of your head is forcibly pushed up against one massive, pillowy-soft breast");

        if (this.player.biggestTitSize() >= 1 && this.player.biggestTitSize() < 3) this.outputText(", your [chest] dwarfed by the larger womans own pair.");
        else if (this.player.biggestTitSize() >= 3 && this.player.biggestTitSize() < 5) this.outputText(", your [chest] moulding themselves against the underside of the Oni’s larger pair.");
        else if (this.player.biggestTitSize() >= 5 && this.player.biggestTitSize() <= 8) this.outputText(", your [chest] compressing against the Oni’s larger pair, forming a delicious valley of flesh between your bodies.");
        else this.outputText(", your [chest] dwarfing the larger womans own pair.");

        this.outputText("  “<i>There.</i>”  She announces happily, softly stroking your cheek as though to reassure you.  “<i>All better now, right?  Good.</i>”  She doesn’t even wait for a response before turning her attention back to your [cock biggest]....\n\n");

        this.outputText("Izumi holds you there easily, pinned against her chest as she slowly coaxes your stiffening erection to life, and you finally realize that you’re completely trapped.  If there ever was a chance for you to slip free and escape from this situation you must have missed it, because now you’re locked in the embrace of those strong, iron-muscled arms, all you can do is feel intimidated.  As Izumi casually molests you, you can’t help but realize how much more powerful than you she seems - how much stronger and more confident in everything she does.  At this moment, you feel as though if she desired, she could do anything she wanted to you");
        if (this.player.str <= 75) this.outputText(" and you would be powerless to resist...");
        else this.outputText(" and you would struggle to deny her will...");
        this.outputText(" a feeling that is only compounded by the burning sense of shame you feel as she jacks you off with a measly two fingers.\n\n");

        this.outputText("With the realisation that you’re completely under her control, something inside you simply switches off and your resistance vanishes entirely.  You decide to just let Izumi do as she wills with you; after all, she’s so much stronger than you, how could you oppose her?  Nuzzling your face into Izumi’s breast, you squirm and wriggle under her touch as your [cock biggest] reaches it’s full - if it could even be called such - hardness.  Hopefully, if you just go with whatever she wants to hear, this won’t be so bad.\n\n");

        this.outputText("“<i>So, you’re ashamed of this, are you?</i>”  Izumi suddenly asks.  You don’t respond, so she stares down at you.  “<i>Answer.</i>”  She commands, her tone imperious.  You can’t bring yourself to speak, so you simply nod, burying your face in her silk-covered bust.  “<i>Good.  You answer when I ask you something, " + this.heightDesc() + "</i>”  She nods approvingly and resumes her slow, gentle strokes.  The casual, unhurried pace of her handjob is beginning to drive you insane; it’s certainly pleasurable, but it’s also agonizingly slow, and you long for her to just speed up even the tiniest bit...\n\n");
        ...
        if (this.player.hasVagina()) this.outputText(", sticky moisture dribbling across your thigh, your [vagina] clenching in lust - fueled harmony with your cock");
        this.outputText("... “<i>Hey, don’t get upset.  After all, </i>” She pauses for a moment, her hand lingering in place.  “<i>Some women </i>like<i> ‘em small...</i>”\n\n");

        this.outputText("“<i>So, let me guess.  In a place like this, it’s gotta be weird having something this small, right?  I mean, it’s a pretty unique trait, given the circumstances.</i>”  She continues.  “<i>Hey, tell me something.  Do the harpies leave you alone?  Are you so small that they think you’re ");
        if (this.player.gender == 3) this.outputText(" just a regular");
        else this.outputText(" a");
        this.outputText(" girl?</i>”  Suddenly, her hand bottoms out around your [cock biggest]");

        if (this.player.balls > 0) this.outputText(" and her free fingers reach out to gently stroke against your [balls].");
        else if (this.player.hasVagina()) this.outputText(" and her free fingers reach out to gently stroke against your [vag].");
        else this.outputText(".");

        this.outputText("  At the same time, she leans in close to your ear.  “<i>Do the </i>Minotaurs?”  She hisses suggestively, eyes flashing.\n\n");

        if (this.flags[kFLAGS.MINOTAUR_CUM_ADDICTION_STATE] >= 1) {
            this.outputText("The moment the word ‘Minotaur’ enters your lust-addled brain, your body shifts over to automatic. Your [cock biggest] twitches painfully, loins longing for the release that can only come from being filled full of gallons of hot Minotaur cream, and you let out a distinctly feminine sounding moan as depraved fantasies of being roughly taken by the bull-men rush through your head.\n\n");

            this.outputText("Izumi leers shamelessly at your reddening face, then whispers, softly into your ear.  “<i>Dirty [boy]....</i>”  You realize that she knows exactly what you’ve been doing - or rather, what’s been repeatedly doing <i>you</i> - and that shameful revelation combined with the burning arousal you feel from the very thought of minotaur cum is more than enough to force you over the edge into a sudden orgasm.  Far from being upset, Izumi seems positively overjoyed at your premature ejaculation.\n\n");

            this.outputText("“<i>Ahaha, well now, look at that!</i>”  She cries, beaming.  “<i>I guess I called it right, hmm?  Geez, did the minotaurs do something to you, or were you always this perverted?</i>”  Izumi snickers.  You can’t even muster up the energy to respond, you’re so drained from your sudden orgasm.\n\n");
        }
        else {
            if (!this.player.isTaur()) this.outputText("As you squirm in her arms, she releases your head from her grip, instead pushing you up into a seated position.");

            this.outputText("“<i>Hold on, I want to watch this.</i>”  She says, shifting position until her head is placed on one side of your hip, staring at your [cock biggest]");
            if (!this.player.isTaur()) this.outputText(" as one arm reaches around to continue the handjob from the other side");
            this.outputText(".  She stares intently at your cock, an expectant smirk plastered over her face, her free hand working");
            if (this.player.isTaur()) this.outputText(" over your flank");
            else this.outputText(" you over with increased vigour");
            this.outputText(".  Before you know it the combination of her skilled fingers and the bizarre, embarrassing sensation of being so carefully observed are pushing you over the edge.  Rather than leaving off as you cum, Izumi’s handjob actually speeds up, her eyes widening in excitement as your orgasm floods through you.  The sensation is much more powerful than you usually experience, perhaps due to Izumi’s extensive teasing, and you can only sit and shudder, staring down at yourself in shock as your [cock biggest]");

            if (this.player.cumQ() <= 100) this.outputText(" dribbles a hot, sticky mess onto the cold cavern floor.");
            else if (this.player.cumQ() > 100 && this.player.cumQ() <= 250) this.outputText(" spurts and splutters a hot, sticky mess onto the cold cavern floor.");
            else if (this.player.cumQ() > 250) {
                this.outputText(" shoots out rope after rope of hot, sticky cum across the cold cavern floor");
                if (this.player.cumQ() > 500) {
                    this.outputText(", a small puddle of creamy-white forming between you and the cavern wall");
                    if (this.player.cumQ() > 1000) this.outputText(", slowly expanding into a small lake....\n\n");
                }
                else {
                    this.outputText(".\n\n");
                }
    ...
    protected surrenderMediumCock(): void {
        this.outputText("“<i>Huh.  Not bad, " + this.heightDesc() + "; I gotta say, I thought you people’d be");
        if (this.player.isTaur()) this.outputText(" bigger");
        else this.outputText(" smaller");
        this.outputText(" down here... or are you just a little ‘gifted’?</i>”  She says, giving you a lopsided grin.  You attempt to stammer out a reply, but she ignores you, instead focusing her attention completely on your [cock biggest].  Still restraining you with one hand, her other hand glides across your cock, easily bringing it to hardness.  You can’t help but gasp as you feel her talented fingers playing across your flesh; from the way she seems to naturally gravitate to all of your most sensitive spots in turn, you can’t help but think she must have done this kind of thing before.\n\n");

        this.outputText("In mere moments, you’re fully erect, as hard as you’ve ever been");
        if (this.player.hasVagina()) {
            this.outputText(", your [vagina]");
            if (this.player.wetness() == 0) this.outputText(" moistening");
            else if (this.player.wetness() == 1) this.outputText(" dribbling runnels of sticky fem-juice");
            else if (this.player.wetness() == 2) this.outputText(" constantly oozing feminine arousal");
            else this.outputText(" a soppy mess, gushing a veritable lake of fem-slime");
            this.outputText(" in lust-fueled harmony with your cock.");
        }
        else this.outputText(".");
        this.outputText("  Izumi looks down at you and flashes you an indulgent smile.");

        this.outputText("“<i>So, I guess we can start now.</i>”  Says the Oni as she drops into position,");
        if (this.player.isTaur()) this.outputText(" perching her muscular ass on your flank, your lower body offering a comfortable seat for Izumi.");
        else this.outputText(" laying on her side next to you.");
        this.outputText("  She releases your");
        if (this.player.isTaur()) this.outputText(" flank");
        else this.outputText(" chest");
        this.outputText(" and instead leans on her elbow, leaving you uncomfortably free and completely unsure of what to do with yourself as she wraps her hand around your [cock biggest] and slowly begins to stroke you.  Her palms are warm and pleasingly soft, something you didn’t expect from the well-muscled Oni woman.\n\n");

        this.outputText("Her pace is glacially slow, but as her hand rolls gently up and down your length, she somehow manages to find each and every secret spot, every sensitive place, causing you to flinch and quiver under her grasp.  You grit your teeth and squirm in discomfort as Izumi teases your cock in an entirely new way.  Already, you can feel your body rebelling at the bizarre, paradoxical sensations.  Unable to comprehend what is happening, every fiber in your body screams a single thought in unison; <b>faster</b>.\n\n");

        this.outputText("Without warning, your hips spasm and buck");
        if (this.player.isTaur()) this.outputText(" upwards");
        this.outputText(" almost of their own accord.  Izumi’s fingers tighten a little, just enough to keep her grip, but her gentle motions stop completely.  She simply holds on, grinning slyly at you as you desperately hump into the air.  Izumi’s amber eyes glitter in the gloom as she leans in closer to you, whispering into your ear.\n\n");
    ...
    protected surrenderMediumCockObey(): void {
        this.outputText("Taking a deep breath, you grit your teeth and force yourself to calm down.");
        if (this.player.isTaur()) this.outputText("  Y");
        else this.outputText("  Lowering your shaking hips, y");
        this.outputText("ou manage to relax and simply wait passively for Izumi to resume her handjob.\n\n");

        this.outputText("“<i>That’s better.</i>”  Izumi says approvingly.  “<i>Now, since you played nice...</i>” She trails off dangerously, but before you can try to figure out what she has planned, she hits you with it - her handjob resumes, but much, much faster than before.  Despite her increased speed, she still manages to hit every single spot she was hitting before, causing a whirlwind of pleasure to rush through you.\n\n");

        this.outputText("Almost immediately, you feel your orgasm starting to rise within you.  You try to stammer out a warning, but Izumi’s pace continues unabated.\n\n");
        ...
        this.outputText(" to the very last drop.\n\n");

        this.outputText("Finally, she relents, and your extended orgasm mercifully subsides.  Izumi stares indulgently down at your shivering form for a moment, before muttering a quiet “<i>Heh,</i>” and wandering back over to her tent.  You can only manage to rest there, laid prone in a");
        if (this.player.hasVagina()) this.outputText(" mixed puddle of your own fem-slime and");
        else this.outputText(" puddle of your own");
        this.outputText(" cum, staring at the cavern roof and panting madly for a good few minutes afterwards.  Once you regain the use of your legs, you retrieve your clothes and wander back to camp in a daze.\n\n");
    ...
    protected surrenderMediumCockRefuse(): void {
        this.outputText("Sick of Izumi and the strange, uncomfortable feelings the Oni keeps forcing you to experience, you defy her command.  Instead, you thrust more vigorously into the air, turning this way and that, trying to force some form of stimulation from the hand mercilessly gripping your member.\n\n");

        this.outputText("“<i>Fine.</i>”  Izumi says, apparently unconcerned.  “<i>Go ahead and try.  It won’t do you any good.</i>”\n\n");

        this.outputText("Ignoring her, you continue thrusting, twisting and turning, but always Izumi follows you effortlessly, thwarting every twist and turn you make in a desperate attempt to fuck her hand.  Finally, after an eternity of painful stalemate, you give in, collapsing to the ground, momentarily exhausted.\n\n");

        this.outputText("“<i>All done?</i>”  She asks.  You glare at her, and her grin widens.  “<i>So, you wanna cum, huh?  Well then, let’s do that.</i>”  She announces, happily.  Suddenly, she begins stroking you again - this time at a speed far beyond her previous unhurried pace.  Her hand flies up and down your shaft, stimulating you just as much as before, but at easily three times the speed!  It is, without a doubt, the most amazing handjob you’ve ever experienced.\n\n");

        this.outputText("The insane feeling is just too much, and you feel your orgasm boiling up within you.  Just as you feel yourself rising to crest the orgamsic wave and hit sweet release... Izumi lets go.\n\n");

        this.outputText("You cry out in anger and pain as you find your impending orgasm so cruelly denied, your [cock biggest] twitching and throbbing painfully");
        if (this.player.hasVagina()) this.outputText(", [vagina] spasming in sympathy");
        this.outputText(", desperate for release.  Somehow, she could sense you were on the verge of orgasm, and she chose to deny you that pleasure, you just <b>know</b> it.  You shoot Izumi a vicious, hateful glare, only to see her laying there quite calmly, her expression blank.\n\n");

        this.outputText("“<i>Hm?</i>”  She grunts, looking surprised.  “<i>Oh, do you want some help?  Sure; here, let me handle this for you.</i>”  She says, her tone even.  She reaches out and, very deliberately, softly flicks your [cockhead] with a single finger.\n\n");

        this.outputText("The sensation is almost nothing, but as close as you are, it’s just enough.  You groan in a mix of pleasure and heartbroken anguish as the tiny amount of contact forces you over the edge, your load forcing its way up through your cock with agonizing slowness until finally");
        if (this.player.cumQ() <= 250) this.outputText(" spurting free, spattering down randomly over you as Izumi watches, happily observing the effects of your ruined orgasm.");
        else if (this.player.cumQ() <= 500) this.outputText(" sputtering freely from your [cock], glob after glob of thick jizz showering down randomly over you as Izumi watches, mildly amused with the results of your ruined orgasm.");
        else if (this.player.cumQ() <= 1000) this.outputText(" a torrent of fertile spunk rushes forth from your [cock], glob after glob of thick jizz showering down randomly over you, covering you from head to toe.  Izumi simply watches, amused with the results of your ruined orgasm.");
        else this.outputText("a torrent of fertile spunk rushes forth from your [cock], rope after rope of the thick cum launching into the air and splattering down over you.  Your orgasm continues unabated as you slowly paint yourself in a creamy white layer, Izumi giggling quietly, evidently quite proud of herself.");
        this.outputText("  Finally, you finish cumming, and as you lay panting in the results of her handiwork, Izumi gently pats you on the head.\n\n");

        this.outputText("“<i>So, you learned something today, right?  Next time, just do what I say, and the results are much more... fun.</i>” She smiles, then turns away.  Retrieving your clothes, you drag yourself back to camp, feeling decidedly shaky.\n\n");
    ...
    protected surrenderLargeCock(): void {
        ...
        this.outputText("“<i>Two.</i>”  She teases, her technique changing completely.  Rather than just running her hands and feet gently over your flesh, she grips on tightly, her hands clenching around your [cock biggest] like vices.  Her movements change completely, instead of the simple, slow up-and-down motion she had been using, she begins to alternate the motions of her left and right angles of attack - while her left hand rolls up your shaft, the right slides down to meet it.  Even her feet seem to somehow press in tighter against your flesh, mirroring her hands; the strange technique creating a unique wave-like rolling sensation that feels quite unlike anything you’ve experienced on Mareth before. You wonder briefly if there might be a little bit of magic involved here before your thoughts are obliterated by an avalanche of pleasure - Izumi has begun to speed up.\n\n");

        this.outputText("You can only grunt and shiver under the onslaught as Izumi works you over with this bizarre new approach.  There’s no gentleness here, you realize; no playful teasing or long, drawn out pauses.  This move is designed for one thing, and one thing only - to force you to cum.");
        if (this.player.balls > 0) this.outputText("  You groan, your aching balls coming to the same conclusion as you have, twitching under a passing stroke from one of Izumi’s soles and tensing up in readiness.");
        this.outputText("  You understand now why Izumi warned you about this technique; you are no longer being teased, gently coaxed towards the edge and then pulled back at the last minute.  As of now, you are being milked.\n\n");

        this.outputText("“<i>One.</i>”  She commands, her tone demanding.  After only a few moments, you throw back your head and let out a long, ecstatic moan as you cum, your orgasm fountaining up through you and exploding free of your [cockhead biggest].  As the first jet of semen surges free of your cock and thrusts up into the air, Izumi gasps.  A split second later, she releases you and launches herself backwards in a powerful roll that catapults her across the cave. Your first load splatters explosively down where she had been sitting moments ago, but you’re too busy firing off a second to care.\n\n");

        if (this.player.cumQ() > 500) this.outputText("You remain sat there for a crippling eternity, unable to do anything but moan as you inexplicably continue to cum, your aching erection firing out shot after shot of hot, dripping goo as Izumi watches you from the safety of the shadows, grinning happily like the cat that got the cream.  ");

        this.outputText("Eventually, your orgasm subsides, and you collapse");
        if (this.player.isTaur()) this.outputText(" sideways");
        else this.outputText(" backwards");
        this.outputText(" onto the ground, staring up at the roof of the cave in a daze.  After a few seconds, Izumi’s face appears in your field of vision, albeit upside down.\n\n");

        this.outputText("“<i>Haha... Sorry about that, but I didn’t want you to ruin my clothes, you know?</i>”  She half-apologizes, giggling.  “<i>Hmm... maybe that move was a little much to try on a [race].  I just thought that since you were a little more... <i>robust</i> than most others of your kind that I’ve met, you’d be able to take it.  I did try to warn you, although... It seems like you enjoyed yourself anyway, hmm?</i>”  She beams.  You can barely find the energy to blink, let alone to muster a response.\n\n");

        this.outputText("Izumi returns to her tent and lights up her pipe, unceremoniously abandoning you there on the cave floor, apparently done with you for now.  Still, it’s some time before you are able to drag yourself to your feet and stumble home to your camp, wondering how long it’ll be before you can see straight again...\n\n");
    ...
    protected surrenderOhGodTheFemaleSurrenderContentIsFuckingHugeSendHelp(): void {
        this.outputText("You resign yourself to letting Izumi do as she wills with you, and hesitantly reach to start undressing.");

        // First time addition to the start of the scene
        if (this.flags[kFLAGS.IZUMI_TIMES_SUBMITTED] == 0) {
            this.outputText("  Before you can remove your clothes, however, Izumi grabs a hold of your wrist.\n\n");

            this.outputText("“<i>Not so fast, I’ve never really had a chance to play with a girl before.  I wanna take my time on this one...</i>” She says.  Smiling suggestively, she reaches out and slowly divests you of your [armorname].");
            if (this.player.cor <= 33) this.outputText("  You can’t help but feel a crippling sense of embarrassment as the strange woman undresses you, and you look away, embarrassed, while Izumi’s hands explore your body.");
            else if (this.player.cor >= 66) this.outputText("  As Izumi slowly reveals your naked body to the world, you begin to feel an oh-so-familiar heat building up inside of you.  You look down at Izumi with pride as she inspects your body, running a skillful hand over your chest with a thoughtful look on her face.");
            this.outputText("\n\n");

            // Big knockers!
            if (this.player.biggestTitSize() >= 15) {
                this.outputText("Izumi’s eyes widen in surprise as she pulls aside your clothing to reveal your impressive bust, your [chest] finally free.\n\n");

                this.outputText("“<i>Wha- Wait, these are real?!</i>”  she exclaims, loudly.");

                // Low corruption
                if (this.player.cor < 50) {
                    this.outputText("Sheepishly, you nod as Izumi manhandles your massive mammaries as though looking for evidence of their falseness.  She bites her bottom lip, glaring intently at you as she roughly runs her hands over your breasts.  Although the Oni woman’s palms are surprisingly soft, her treatment of your breasts is not - she practically mauls you, squeezing, groping, even pinching the soft flesh.\n\n");

                    this.outputText("“<i>Unbelievable...</i>” She mutters to herself, bitterly.  She looks up at you, confusion still plain upon your face, then scowls.  “<i>You don’t even know why I’m annoyed, do you?  Does having a chest THIS huge,</i>” she reaches out and pinches one of your [nipples] between her thumb and forefinger, causing you to yelp in surprise and pain.  “<i>Just seem normal to you?!</i>”  She grumbles in frustration before giving the nipple a sharp tug, causing you to cry out once again.  “<i>Forget it.</i>”\n\n");
                }
                // High(er) corruption
                else {
                    this.outputText("You smile and nod proudly as Izumi examines your breasts, experiencing a giddy little thrill at the feeling of her soft palms rolling across your endowments.  She bites her bottom lip, glaring intently at you, and you return her gaze with amused indifference.  Although the Oni woman’s palms are surprisingly soft, her treatment of your breasts is not - she practically mauls you, squeezing, groping, even pinching the soft flesh. The rough treatment is deliciously arousing, and you can’t help but let out a few soft moans at being manhandled so forcefully - much to Izumi’s obvious annoyance.\n\n");

                    this.outputText("“<i>Let me guess, you intentionally made them grow this big?</i>”  She scowls.  She reaches out and pinches one of your nipples between her thumb and forefinger, causing you to let out another excited little groan.\n\n");

                    this.outputText("You respond with a shrug, teasingly, not entirely wanting Izumi’s abuse to stop.  Izumi’s frown deepens and she tweaks your nipple, twisting it painfully to the side, eliciting another gasp from you.\n\n");


                }

                this.outputText("“<i>How shameless.</i>”  She grumbles, returning her gaze to your bust.  “<i>How utterly shameless....</i>”\n\n");
            }
        }
        else {
            this.outputText("Before you can finish removing your clothes, Izumi grabs a hold of your wrist.  She takes over, placing herself firmly in charge of your state of dress.\n\n");
        }

        // PC is an exhibitionist!
        if (this.flags[kFLAGS.PC_FETISH] >= 1) {
            this.outputText("While Izumi takes her time freeing you of your [armor], you experience a little familiar thrill as Ceraph’s cursed piercings start to work their magic.  Every inch of your skin from head to foot tingles with excitement as you relish the prospect of finding yourself on display once again, naked and defenceless for the whole world to stare, or scowl, or leer - it makes your nipples harden just thinking about it.\n\n");

            this.outputText("Looking up at you with a superior smirk, Izumi continues to run her hands over your body, clearly more interested in stealthily groping you to check out the goods than actually undressing you. The tortuous anticipation just makes everything feel that much better though - soon, you’re going to find yourself completely naked in front of this strange woman. Not just yet, but <i>soon</i>, oh so soon....  It’s hard to believe how erotic the idea now seems to you.  Like a child the night before a birthday, you’re equal parts excited and desperate - and before long you’re practically screaming internally for Izumi to hurry up, rip off the rest of your clothes and just strip you <i>bare</i> already.  By the time she gets round to removing the bottom half of your clothing, you’re positively soaking wet.\n\n");

            this.outputText("Izumi grunts in surprise as she surveys your dripping folds");
            if (this.player.hasCock()) this.outputText(", your [cock] slowly thickening under her scrutiny");
            this.outputText(".  You shift in place,");
            ...
            this.outputText(" a little, to ensure that Izumi gets a really <b>good</b> look at you down there.  The shameless act sends a flush of embarrassed warmth through you, making you tremble in pleasure.  You’re unable to keep yourself from smiling a little - you can barely manage to stop yourself from moaning aloud.  You place your hands above your breasts, hoping that Izumi will stop to look at them... which she does, looking up a moment later to say something, then pausing as her eyes linger at the sight of your [chest].\n\n");

            if (!this.player.isNaga()) this.outputText("You rub your thighs together in delight");
            else this.outputText("You wriggle and writhe in delight");
            this.outputText(" as Izumi stares at your proudly displayed chest, enjoying the sensation of being watched and idly wishing you had something to fill the aching void");
            if (this.player.isNaga()) this.outputText(" deep within your [vagina].  You slither around in place, your [leg] shifting and weaving around, moving and undulating... b");
            else this.outputText(" between your [legs] as well.  As you move your weight repeatedly from one [foot] to the other, you shiver in enjoyment.  B");
            this.outputText("eing stared at feels so good.... You blink, suddenly called back to reality by Izumi’s voice.\n\n");

            this.outputText("“<i>Look, " + this.heightDesc() + ", I know I’m kind of an intimidating specimen, but you don’t really need to be scared.</i>” She smirks.  “<i>You keep shivering in fear like that and I’m liable to take offence, yeah?</i>”  You blink again in confusion before realization finally dawns.  Izumi has absolutely no idea how much this is turning you on.  The idea of your secret arousal going completely unnoticed is surprisingly erotic, and that thought turns out to be just enough to push you over the edge.  You wince and bite your lip to stifle your moans, quivering in the throes of a miniature orgasm, even though you’ve really yet to be even touched... and on a whim, you decide to keep eye contact with Izumi for the entire thing.\n\n");

            this.outputText("Staring into those steady amber eyes as you quietly cum adds an entire new level of deliciously wrong-feeling pleasure to the affair, something you resolve to enjoy for as long as possible. Finally, your orgasm subsides, and you visibly relax.\n\n");

            this.outputText("“<i>There.  See?  I ain’t so bad.</i>”  Izumi smiles again, still apparently oblivious to your fun at her expense.  “<i>Now, we get to move on to the good part.  You ready? </i>” She asks.  You smile and nod, still basking in the post-coital warmth of your inner glow.\n\n");
        }
        ...
        if (!this.player.isTaur()) {
            this.outputText("Without warning, Izumi violently lunges forward, grabbing at you.  You are only able to let out a surprised yelp before she grips onto your arms, pulling you towards her and spinning you around.");
            if (!this.player.isNaga()) this.outputText("  Before you know it, she has you down on your knees, the cold stone of the floor digging into your [skinfurscales] a little as she circles behind you, smirking cruelly.");
            else this.outputText("  She takes hold of your shoulders and forces you lower to the ground, forced to slither more and more of your tail out from under yourself, until Izumi towers over you.  She circles behind you, a cruel smirk the only hint of her intentions.");
            this.outputText("\n\n");

            this.outputText("Izumi reaches around from behind you and you half turn to look at her, but she grips you by the chin and firmly turns your head away from her.  Your gaze flits nervously around the cave at random as you feel Izumi’s other hand glide slowly across your [skinfurscales], running along your stomach and down towards your");
            if (this.player.isNaga()) this.outputText(" [leg]");
            else this.outputText(" thighs");
            this.outputText(".\n\n");
        ...
        // Taur variant
            ...
            this.outputText("Izumi shifts herself around to casually lay along the length of your lower body, using  her grip on your wrists to jerk you backward once more, forcing you to arch your back and thrust your [fullchest] out for easier inspection.  You gasp in surprise as you feel her free hand reach around to grope at your breasts, squeezing and massaging them experimentally.  Despite yourself you can’t help but let out a yelp as she squeezes a [nipple] between thumb and forefinger.\n\n");

            this.outputText("As you squirm under Izumi’s body, it begins to dawn on you that you’re not getting away from this.  Your resistance begins to lessen until eventually you begin to relax, finally admitting to yourself that this really doesn’t feel half bad....\n\n");
        }
    ...
    protected surrenderFemaleExhibitionVariant(): void {
        ...
        this.outputText("For some reason, you find that idea to be quite possibly the hottest thought you’ve ever had.  You’re surrounded by a ring of barely-unseen onlookers, all waiting to see you get fucked, many of them already masturbating just at the sight of your naked form.  Without a moment’s hesitation");
        if (this.player.isBiped()) this.outputText(", you spread your legs a little wider,");
        this.outputText(" you");
        this.outputText(" arch your back a little further, muscles straining as you struggle to present a better view to your audience.  You moan with greater enthusiasm, hoping to draw in a larger crowd.  You feel Izumi’s breasts shake, pressed up against your back, as she chuckles to herself.\n\n");
    ...
    protected surrenderFemaleLookitYouTheCenterOfAttentionYouSlut(): void {
        this.outputText("You nod your head vigorously at the idea of getting some of your beloved audience actually involved.  Izumi chuckles again.\n\n");

        this.outputText("“<i>Alright. Let’s get this party started, then.</i>”  Izumi releases you and stands.  You start to follow, thankful of the opportunity to stretch out your strained muscles, but Izumi places a hand firmly on your head and pushes you back down.  “<i>Oh no,</i>” she says, smiling at you. “<i>No, you just sit right back down. You’re going to be staying on your knees for a while, " + this.heightDesc() + ".</i>”  Her words send a chill of excitement rushing through you, so you obediently adopt a kneeling position, waiting patiently.  Izumi’s smirk only grows wider as she pats you on the head.  Then she turns towards the assembled crowd of lurking masturbators.\n\n");

        this.outputText("“<i>Hey out there!  Turns out my friend here is just too big a slut to resist the smell of some juicy cock, and you got her all riled up.  So, with that in mind,</i>” She announces, loudly.  “<i>She’s up for public use.  Who’s first?</i>”\n\n");

        this.outputText("There’s a moment of deathly silence that seems to stretch for minutes.  Then, suddenly, an imp comes hurtling out of cover, already reaching for his loincloth, casting a wary glance at Izumi.  She gives him a winning smile, like a shopkeeper welcoming a client.  You realize that would make you the merchandise in this situation, and for some reason it just turns you on even more.\n\n");

        this.outputText("“<i>Lucky number one!</i>”  Izumi extends a hand towards you in an expansive gesture.  “<i>She’s all yours.  Pick any hole, she’s too cockhungry to care.</i>”  The imp eyes you up for a moment, then steps onto your");
        if (this.player.isBiped()) this.outputText(" thighs");
        else this.outputText(" [legs]");
        this.outputText(", pulling aside his loincloth to reveal his raging erection.  It bobs up and down, the bulbous head mere inches from your face.  “<i>Well?</i>”  Izumi asks.  “<i>What are you waiting for?  Get started, slut!</i>”\n\n");

        this.outputText("Hesitantly, you lean forwards and envelop the imp’s waiting cock into your mouth.  You struggle not to think about the taste as you submissively service the imp, but then you notice from the corner of your eye that the ring of observers have crept a little closer, leaving the safety of their rocky hiding spots to get a better view...  a better view of you.  A better view of you, naked");
        if (this.player.isBiped()) this.outputText(" and on your knees");
        this.outputText(", sucking on an imp’s cock like it was candy.  Suddenly, it doesn’t seem nearly so bad.\n\n");

        this.outputText("“<i>You wanted to give them a show, right?</i>”  Izumi whispers to you, still grinning.  You nod your head as best you can around the stiff phallus invading your mouth.  “<i>Well then, in that case...  do it right, you stupid slut!</i>”  She roars suddenly, grabbing you by the back of the neck and forcing your face down onto the imp’s cock.  You gag and squeak in surprise as you find your nose suddenly pressed up against his stomach, his thick meat invading your throat, cutting off your air.\n\n");

        this.outputText("“<i>This crowd came here to see a whore getting fucked, not to see some amateur try her best.  If you aren’t gonna try, I’ll do it for you.</i>”  Izumi’s expression is almost feral with lust as she forces you into a brutal");
        if (this.player.hasMuzzle()) this.outputText(" muzzle");
        else this.outputText(" face");
        this.outputText("-fuck, tears of exertion streaming down your face.  “<i>Tongue his balls, then you get to come up for air,</i>” she commands, and you comply.  A few seconds later, you’re rewarded with the distinct hot, gloopy sensation of the imp blowing his load into your throat - and, much to your lust-addled surprise, a quick shoulder-squeeze from Izumi.  “<i>Sorry if I’m being a little rough, " + this.heightDesc() + ". Just playing the part, you know?</i>”  She whispers, reassuringly.\n\n");

        this.outputText("The imp pulls himself free of your mouth, staggering away to the safety of the rocks.  More importantly however, you realize that the ring of spectators has begun to close in, apparently satisfied that they’re no longer confined to just spectating.\n\n");

        this.outputText("“<i>Hope you’re ready for round two.</i>” Izumi mutters.  You can’t help but nod, smiling hungrily as you eye the approaching crowd.\n\n");

        this.outputText("An hour later, after having licked, sucked, deepthroated and fucked your way through an endless parade of harpies, goblins and imps, the crowd finally disperses.  Of course by that point, you’re barely aware of it, having lost track of pretty much everything aside from the ‘client’ currently employing your services some time ago in a haze of wanton sluttery.  Izumi swims blearily into focus, shaking her head in amusement.\n\n");
    ...
    public fuckedUpByAFuckhugeOni(titLoss: boolean = false): void {
        ...
        if (this.player.HP <= 0) {
            this.outputText("You fall to the ground, reeling from Izumi’s iron-hard muscles - and other parts besides.  Grinning widely, Izumi visibly relaxes, satisfied that you’re in no fit state to continue fighting.\n\n");
        }
        else if (this.player.lust >= 100) {
            this.outputText("You fall to the ground, too horny to resist further against the Oni’s iron-hard muscles - and other parts beside.  Grinning widely, Izumi visibly relaxes, satisfied that you’re in no fit state to continue fighting.\n\n");
        }

        this.outputText("“<i>So, it’s my win!</i>”  She announces, gleefully.  “<i>And you know what that means, right? It’s </i>playtime....”  The enormous woman looms over you, and you suddenly find yourself feeling distinctly nervous...  without warning, Izumi drops to her hands and knees and leans forwards, her leering face inches from your own.  With her arms on either side of you and her face filling your vision, you can’t help but feel a little enclosed. “<i>Let’s have sex!</i>”  She cries, then looks down towards your crotch, raising a hand threateningly.\n\n");

        this.outputText("Reflexively, you");
        if (this.player.isNaga()) this.outputText(" slither");
        else if (this.player.isDrider()) this.outputText(" scuttle");
        else this.outputText(" scurry");
        this.outputText(" backwards, self-preservation instincts kicking in, intent on escaping the deranged Oni.  To your surprise, rather than snatching or leaping at you, she just blinks and looks at you in confusion.\n\n");

        this.outputText("“<i>Huh?  What’s the matter?</i>”  She asks, looking genuinely nonplussed.  She reaches out towards you and you shuffle away again, putting a little more distance between the two of you.");
        if (this.player.lust >= 100) this.outputText("  Despite how much the fight with the enormous Oni has turned you on, you’re still hesitant to capitulate to her will entirely.");
        this.outputText("  Izumi actually looks a little hurt.  “<i>You... you really don’t want to do it?</i>”  You can only stare at the oversized giantess in utter confusion as she stammers awkwardly.  “<i>D-Did I do something wrong? I was only playing around, so... we can do it now, right?  What’s wrong?!</i>”  Against all your expectations, Izumi actually backs down, settling back into a seated position on her knees, her expression visibly deflating.\n\n");

        this.outputText("“<i>Oh, I get it.  It’s me, right?  You don’t find a girl like me attractive.</i>”  Her face falls as she stares at the floor, looking positively morose.  “<i>It’s okay, I don’t blame you.  This whole situation probably seems pretty weird, right?  One minute I’m smacking you around, the next I’m trying to jump you... I forget sometimes that not everyone acts the way Oni do when it comes to stuff like this.</i>”  She sniffs, rubbing one massive palm into her eye and scowling.\n\n");

        this.outputText("“<i>Ah, stupid.  Don’t mind me, really. You can leave if you want, it’s okay; I won’t chase you or anythin’.  I just got over excited since I don’t get to talk to people very often, but I can’t expect you to want to bang someone who just tried to clean the floor with ya.</i>”  Izumi raises her head and gives you a wavering smile.  “<i>Really.  It’s fine! Oni get a little <b>heated</b> after a good fight, you know?  So, I did a dumb thing and figured you were feelin’ the same.  I shoulda known that ‘no’ doesn’t mean ‘only if you beat me’ to a human, right?!  Ahaha, ah... I’m an idiot.</i>”  She droops her head again.\n\n");

        this.outputText("You hesitate.  It seems like she’s being honest about letting you go, which is unexpected to say the least.  If you wanted to, you’re pretty sure you could just get up and");
        if (this.player.isNaga()) this.outputText(" slither");
        else this.outputText(" walk");
        this.outputText(" out of the cave without any trouble.  On the other hand...");
        if (this.player.lust >= 75) this.outputText(" the idea of sex with Izumi <i>is</i> quite a tantalizing prospect.  F");
        else this.outputText(" f");
        this.outputText("rom your position, you can clearly make out how tightly her kimono clings to her substantial assets, how only a thin scrap of material dangling between those powerful thighs - not even reaching low enough to touch the floor - obscures your vision and prevents you from seeing <i>everything</i>.");
        if (this.player.lust >= 75) this.outputText("  Despite yourself, you have to wonder exactly what it would feel like to slide between those giant sweat-slicked thighs, bury your face into Izumi’s mountainous bust, and just let your libido run wild.");
        this.outputText("\n\n");
    ...
    protected lossSceneLeave(): void {
        ...
        this.outputText("You rise and make your excuses, and to her credit Izumi takes your refusal in stride; already seeming to have cheered up a little after her earlier outburst.  As you exit the cave, she raises a hand in farewell.\n\n");

        this.outputText("“<i>Feel free to come back if you want me to clean your clock again, yeah?</i>”  She calls after you with a grin.  You shake your head ruefully as you make your way down the mountain and back to your camp.  Overall, that could have gone better, but it could have gone a lot worse, too.\n\n");
    ...
    protected lossSceneStay(): void {
        ...
        this.outputText("Your mind made up, you lean forwards, reach out your hands and firmly grasp one of Izumi’s sizeable breasts.\n\n");

        this.outputText("“<i>Oh!</i>”  Izumi yelps, surprised, her head snapping up as you grope at her soft flesh.  “<i>Oh.  </i>Oh...<i></i>”  She repeats as comprehension slowly dawns.  “<i>So, wait, you decided you actually </i>do<i> want to...</i>”  She trails off as you nod, and a sly smile begins to spread across her face.  “<i>I guess there’s a little Oni in you after all, huh?</i>”  She says, leaning in closer to you to draw you into a hug - which you use as an opportunity to enjoy the better access to her breasts.\n\n");

        if (this.player.hasCock()) this.outputText("“<i>Or maybe,</i>”  She whispers seductively into your ear, “<i>You wanna bury that little Oni of yours in </i>me<i>.  Hmmmm?</i>”  You shudder as you feel her hand snake into your underwear and run sinuously across your crotch, readying you for the ordeal ahead...\n\n");
    }
    ...
    public deathBySnuSnuIMeanGiantOniTits(): void {
        ...
        if (this.player.isTaur() || this.player.isDrider() || !this.player.hasCock()) {
        ...
        this.outputText("Try as you might, you find that you just can’t break free of Izumi’s grasp.  Not only that, but the constant rubbing, flexing sensation stimulating [eachCock], combined with the heat of Izumi’s body and the scent of whatever heady drug she was smoking hanging around her like a perfume, you give one final shudder and give in, going limp against the massive woman’s rack.\n\n");

        this.outputText("Slowly, you start to pull back your hips, gently dragging your [cocks] back across Izumi’s stomach.  You realize foggily that underneath her kimono, she must be fairly well-toned, as the muscles in her abdomen provide a pleasingly firm and bumpy surface for you to rub yourself across.  Anxious to satisfy the needy throbbing in your cock, you slowly start to thrust, rolling your hips backwards and forwards as you grind yourself into Izumi’s abs.\n\n");

        this.outputText("The sensation is oddly unique, hard yet yielding, and you find yourself quickly entranced by the pleasure, falling into a steady rhythm, burying your face into Izumi’s bust and wrapping your arms around her for support.  Still fully clothed, you begin to grind yourself against Izumi, mindlessly searching for release.\n\n");

        this.outputText("“<i>Hey, what are you...</i>”  Izumi’s confused murmur drags you back to reality.  Groggily, you raise your head to find her looking down at you with a concerned expression.  One look at your panting, reddened face however, and her face quickly splits into a familiar smirk.  “<i>Oh.  Oh, I see.</i>”  She murmurs. The arm inexpertly pulling you towards her slackens, giving you a little more room to breathe. Meanwhile, her other hand appears from behind her back as she drums her fingers on her cheek, smiling indulgently down at you as though confronted with an errant child.  “<i>You’re kind of a strange one, you know that?  Well, if that’s what you want, I suppose it can’t be helped....  Go ahead kid, I won’t stop you.</i>”  The arm that was previously attempting to choke you slips down to grip your waist, supporting you and hugging you closer to her, causing you to shiver as your erection is pressed ever harder into her flesh.\n\n");

        this.outputText("Gratefully, you nod, too aroused to care about Izumi’s dismissive attitude.  Right now, all you care about is how close this weird new form of stimulation is to helping you get off, and she’s just given you the green light to explore that feeling.  Returning your attention to Izumi’s breasts, you take advantage of the increased support from the arm around your waist to slip your arms inside the upper portion of Izumi’s kimono, running your hands across the expansive breasts within.  Izumi rumbles appreciatively as your hands stumble over her nipples, stroking the hardening flesh, tweaking and gently twisting them until they are hard enough to stand out against the silken fabric of her clothing. Finally, you can’t stand it anymore.  With a powerful gesture, you push both sides of Izumi’s kimono aside at once, exposing her breasts completely and causing them to bounce and jiggle with the force of the motion.\n\n");

        this.outputText("“<i>Ah!</i>”  Izumi yelps. “<i>Greedy!</i>”  She chides, grinning down at you as you simultaneously grope both of her breasts.  You couldn’t care less though, you’re so enflamed by lust at this point that all you can think about is enjoying yourself as much as possible; bringing one of Izumi’s nipples to your mouth, you latch onto her breast and suck powerfully, eliciting a hiss of pleasure from Izumi.  Judging by how Izumi’s breasts begin to heave and shiver under you as her breathing quickens, she seems to be enjoying this almost as much as you are.  Sure enough, after only a few moments, Izumi’s hand snakes down to stroke through your hair, gently but insistently holding you over her breast to continue your oral assault.\n\n");

        if (this.player.tallness <= 60) {
            this.outputText("At the same time, the arm gripping your waist slides downwards too, hooking under your [butt] almost like some kind of seat, freeing you to keep grinding your needy cock");
            if (this.player.totalCocks() > 1) this.outputText("s");
            this.outputText(" into her midsection while you suck at her teat.");
            if (this.player.biggestCockLength() <= 5) {
                this.outputText("  “<i>Hmph.</i>” Izumi grunts, smirking as she cups your balls.  “<i>Just like a baby... in more ways than one, am I right?</i>”  She continues, extending her middle finger to stroke the entirety of the underside of");
                if (this.player.totalCocks() > 1) this.outputText(" one of your");
                else this.outputText(" your");
                this.outputText(" trembling, undersized prick");
                if (this.player.totalCocks() > 1) this.outputText("s");
                this.outputText(", from tip to base, as your hips roll into your backstroke.  You shiver in embarrassment, causing Izumi to snort with amusement.\n\n");
            }
        }

        this.outputText("The thought of Izumi getting turned on too just makes your lust burn even hotter and you renew your efforts, grinding and humping into Izumi’s stomach, running your tongue over the soft skin of her breasts as she strokes your hair indulgently.  The climbing heat of your bodies conspires to melt your thoughts away, your poor dick");
        if (this.player.totalCocks() > 1) this.outputText("s");
        this.outputText(" trapped in the hottest point of all - directly between you.  Assaulted on all sides by the rising heat and the increasingly slippery sensation of rubbing against Izumi’s sweat-soaked body, your cock feels as though it has been transformed into a supernova of arousal, burning with desire and incredibly sensitive.\n\n");

        this.outputText("The two of you remain there in this strange half-standing, half-fucking position for what feels like the best part of an hour as you grind and groan, suckle and slurp.  If just rubbing away at her from the outside feels this good, how much better must it feel to actually feel [oneCock] inside her, part of you wonders... and then another quieter, darker part of you wonders if it wouldn’t be so much hotter if you never found out.\n\n");

        this.outputText("Finally, you start to feel an ominous pressure building up in your groin, your breathing growing laboured and desperate.  Izumi clearly notices your animalistic intent, as she looks down at you and speaks, massaging the back of your neck vigorously as you suck forcefully at her breast.\n\n");

        this.outputText("“<i>Hey, you’re getting close, right?</i>”  She asks. You nod vigorously, but she continues anyway. “<i>You’re gonna do it, right?  You’re gonna cum, just from this, just from rubbing up against me.</i>” You nod even more desperately, feeling your orgasm already starting to rise up inside you.  Izumi actually pants, looking almost as aroused as you feel.  “<i>That’s okay... that’s good.  Go ahead and cum, okay?  I want to see if you can really blow your load just from a little frottage...</i>” Frottage.  You make a mental note to remember that word.  If that’s the name for this, it might be worth knowing, you think.  Then, at long last, your orgasm hits.\n\n");

        this.outputText("You positively explode, throwing open your mouth and howling in ecstasy as your long-awaited orgasm bursts out of you.  You feel a jet of hot, warm goo pulse free from");
        if (this.player.totalCocks() > 1) this.outputText(" each of");
        this.outputText(" your iron-hard cock");
        if (this.player.totalCocks() > 1) this.outputText("s");
        this.outputText("... only to splatter instantly against the insides of your [armor].  Your eyes go wide as you realize in a rush of embarrassment that you forgot to even so much as slip your cock");
        if (this.player.totalCocks() > 1) this.outputText("s");
        this.outputText(" free before humping yourself to a climax against Izumi’s stomach.  The realisation does nothing to hinder your orgasm, however - and may even have heightened it - as surge after surge of baby batter explodes free from your erection");
        if (this.player.totalCocks() > 1) this.outputText("s");
        this.outputText(", coating the insides of your underwear with thick, sticky goo.\n\n");

        this.outputText("Your underwear thoroughly decorated, your cock");
        if (this.player.totalCocks() > 1) this.outputText("s relent");
        else this.outputText(" relents");
        this.outputText(", deflating and ceasing");
        if (this.player.totalCocks() > 1) this.outputText(" their");
        else this.outputText(" it’s");
        this.outputText(" relentless demands.  Puffing and panting, you manage to raise your head enough to look up at Izumi, still wearing that everpresent smirk.\n\n");

        this.outputText("“<i>Aw, what’s the matter?</i>”  She says, reaching down and gripping at your aching bulge.  You groan at the sensation of your own slime being used as lubricant to wring a couple more drops from your aching body.  “<i>Couldn’t even wait to get your clothes off?</i>” She laughs, but there’s no malice there.  Izumi lowers you gently back down until you’re standing on the floor once again, on somewhat unsteady legs.  \n\n");
    ...
    protected fuckhugeOniWantsYourBabiesOrSomeShit(): void {
        ...
        this.outputText("You nod, pulling yourself to your feet and after exchanging a hasty goodbye with Izumi, you stumble towards the exit.  You’re not quite sure about ‘next time’, but you have to admit that really could have gone worse....\n\n");
    ...
    protected noDickNoVagNoService(): void {
        ...
        this.outputText("Izumi’s fingers stroke questingly over your groin for a moment, then she frowns, confused.\n\n");

        this.outputText("“<i>Huh. You, uh... you actually </i>don’t<i> have a dick.</i>” She says, sounding a little taken aback. “<i>You know, I gotta say, I think you’re the first person I’ve met on this rock without a wang?  Seriously.  I just kind of assumed you had one.  Kinda lost track of my gameplan here, ‘cause I was really expecting something to grab onto down here.</i>”  She taps her lip with her free hand while you stare at her, bemused.  Then an ominous, toothy grin spreads slowly across her face.  “<i>Okay, new plan.</i>”  She announces, then her hand staps out to snatch hold of your ankle in an iron grip.  “<i>I guess I’ll just have to eat ya.</i>”\n\n");

        this.outputText("Before you can protest, you find yourself being spun effortlessly upside down by the oversized Oni, suspended by your");
        if (this.player.isNaga()) this.outputText(" tail");
        else this.outputText(" ankle");
        this.outputText(") in an extremely uncomfortable position.  Izumi’s grin becomes positively feral as she tears your clothing free");
        if (!this.player.isNaga()) this.outputText("before grabbing onto your other ankle, forcibly spreading your legs apart and leaving you creating a very undignified Y-shape");
        this.outputText(".\n\n");

        this.outputText("“<i>Well, " + this.heightDesc() + ", you really are weird... no dick </i>or<i> pussy.  I, err...</i>”  She says, the confusion caused your evident lack of equipment spreading across her face.  “<i>I gotta say, I’m fresh out of ideas over here.</i>”\n\n");

        this.outputText("She gently lowers you toward the floor, and releases her grip on your ankles.  “I-I guess you can go, yeah?” She says, motioning toward the entrance to her cave.  Paying you no mind, she heads off toward her tent, clearly no longer interested in you.\n\n");
    ...
    protected littleChampLittleChampFuckhugeOniIsCominTaEatcha(): void {
        ...
        if (this.flags[kFLAGS.IZUMI_SEEN_PC_GENDER] != 2 && !this.player.hasCock()) {
            this.outputText("Izumi’s fingers stroke questingly over your slit for a moment, then she frowns, confused.\n\n");

            this.outputText("“<i>Huh. You, uh.. You actually </i>don’t<i> have a dick.</i>”  She says, sounding a little taken aback.  “<i>You know, I gotta say, I think you’re the first person I’ve met on this rock without a wang? Seriously. I just kind of assumed you had one. Kinda lost track of my gameplan here, ‘cause I was really expecting something to grab onto down here.</i>”  She taps her lip with her free hand while you stare at her, bemused.  Then an ominous, toothy grin spreads slowly across her face.  “<i>Okay, new plan.</i>” She announces, then her hand snaps out to snatch hold of your");
            if (this.player.isNaga()) this.outputText(" tail");
            else this.outputText(" ankle");
            this.outputText(" with an iron grip.  “<i>I guess I’ll just have to eat ya.</i>”\n\n");
        }
    ...
    public touchThatFluffyHorn(): void {
        ...
        // Super awesome Gedan edit mode!
            ...
            this.outputText("Izumi was pretty strong when she claimed to be just playing around and using only a single hand to fight you, but there’s nothing playful about her appearance now.  In fact, in her strange, crouched stance, muscles straining against some invisible force, snarling and roaring at the empty air as she stares into nothing, you can’t help but feel she looks like nothing more than a crazed monster...  a demon, straight out of a story made to scare wayward children. You have to do something, you realize.  You have to interrupt her, before she finishes whatever it is she’s doing!\n\n");

            // Tease victory
            if (this.monster.lust >= 100) // I assume LustMax is always presumed to be 100?
            {
                ...
                this.outputText("[teaseText]");
                this.outputText("Izumi pays your attempts to distract her no mind, focused entirely on her strange ritual. You slink forwards, hoping that something a little more... hands on might do the trick. But ");
            }
            else {
                this.outputText("You dart forwards, hoping to catch Izumi off-guard while she’s distracted, but ");
            }

            this.outputText("as soon as you get close, those crazed, staring eyes lock onto yours - ");

            if (this.player.spe >= 90) {
                this.outputText("her arm lunges out in an uppercutting grab, but your reflexes are faster, managing to dodge out of the way at the last moment.  Sensing an opportunity with the Oni suddenly off-balance, you make for a grab of your own - reaching out for the bright red curve of Izumi’s horn.\n\n");
            }
            else if (this.player.str >= 90) {
                this.outputText("and before you can react, her arm lunges out in an uppercutting grab, her fist latching around your throat and wrenching you from the floor.  You lash out, swinging for Izumi’s arm, managing to pound against the iron-hard limb with enough force to dislodge the choking collar of fingers from your neck.  Sensing an opportunity with the Oni momentarily recovering, you make for a grab of your own - reaching out for the bright red curve of Izumi’s horn.\n\n");
            }
            else if (this.player.inte >= 75) {
                this.outputText("her arm lunges out in an uppercutting grab, her fist latching around your throat and wrenching you from the floor.  Izumi is far too strong to best directly; leverage, you realize, is what you need to free yourself.  You reach out for the bright red curve of Izumi’s horn. \n\n");

            }
            else if (this.player.tou >= 90) {
                this.outputText("her arm lunges out in an uppercutting grab, her fist latching around your throat and lifting you from the floor.  Her grip is crushingly tight, but you can endure it... for now, at least.  Looking to respond in kind, you reach out for the bright red curve of Izumi’s horn.\n\n");
            }
            else if (this.player.lib >= 40 && (this.player.biggestTitSize() >= 2 || this.player.biggestCockLength() >= 5)) {
                this.outputText("her arm lunges out in an uppercutting grab, her fist latching around your throat and wrenching you from the floor.  You struggle, helplessly, against her arm for a moment before an idea strikes; \n\n");

                if (this.player.biggestTitSize() > 2) this.outputText("maybe giving her face a little personal time nestled between your [chest] will finally distract the Oni enough.  You reach out for the bright red curve of Izumi’s horn, ");
                else this.outputText("thinking quickly, you slip open your [armor] with one hand, bearing your [cock] to the world, your other hand reaching for the bright red curve of Izumi’s horn, ");

                this.outputText("trying to force her gaze toward your ‘assets.’\n\n");
            }
            else {
                this.outputText("You lash out, swinging at Izumi’s face, but you can’t concentrate while being held off the floor by your neck!  In desperation, you make a grab for the one thing you can think of to try steadying yourself to brace for a strike - the bright red curve of Izumi’s horn.\n\n");
            }

            this.outputText("As soon as your fingers wrap around it, however, Izumi’s brutal, victorious expression changes.  Specifically, it gets a whole lot redder.\n\n");

            this.outputText("Izumi blinks once, twice, as the hair-raising visage she was maintaining drops almost immediately.\n\n");

            this.outputText("“<i>Um,</i>”  She says, surprisingly quietly given her formerly berserk appearance.");
            if (this.player.spe < 90 || this.player.str < 90) {
                this.outputText("“<i>C-Could you please let go of that?</i>” She asks, slowly sinking to her knees.  Your feet touch solid ground again, Izumi’s hand still wrapped limply around your neck, apparently forgotten.\n\n");
                this.outputText("“<i>Really. Um. Please let go.</i>”");
            }
            else this.outputText("“<i>C-Could you please let go of that?</i>”");

            this.outputText(" she says, swallowing hard and staring at nothing.  Given her sudden change of attitude, you can’t help but wonder if your grip on the horn is somehow responsible.  “<i>T-That isn’t something you should touch.  So, y-you’ll let go now, right?</i>”  Izumi stammers.  You stare at her, fascinated by her complete change of personality; gone is the confident, domineering Oni you originally met.  Instead, Izumi, kneels nervously before you, staring intently into space and trying her level best not to move.\n\n");
    ...
    protected letGoAndFuck(): void {
        ...
        this.outputText("“<i>Haha, hahh,</i>” Izumi mutters, sounding almost regretful, “<i>Ah, geez. I really came, huh... and from you playing with my horn, too...</i>” she laments.  She covers her eyes with one hand and grins ruefully, her face still reddened from her recent orgasm.  “<i>That’s so embarrassing...</i>”\n\n");

        this.outputText("On a whim, you decide to try and cheer the big woman up a little.  Propping yourself up on one shaky arm, you lean forwards and plant a kiss directly on her mouth.  Izumi’s fingers split open in front of you to reveal a pair of amber eyes that can only be described as ‘surprised’, or possibly even ‘shocked’.  You break off the kiss, and she stares at you in complete disbelief, her expression unreadable.  After a long moment, she speaks.\n\n");

        this.outputText("“<i>U-Um. Thanks, but p-please don’t do things like that again,</i>” she stammers. “<i>Not that I hate you for it, or anything!  It was nice, it’s just, I-I don’t, uh... I don’t really know what to, uh, you know...</i>”  She sees your expression and sighs, apologetically.  “<i>Sorry, I just never know how to react to stuff like this. Don’t worry about it, okay?</i>”  She smiles, stroking your hair lovingly.\n\n");

        this.outputText("You decide not to make an issue of it, since Izumi is clearly embarrassed.  The two of you redress, and as you make to leave, Izumi whistles for your attention.  You turn, and she throws you a small leather bag, which you open to discover a handful of gems inside.\n\n");

        this.outputText("“<i>It’s just a little thank you gift. You know, for uh...</i>”  She winks, provocatively.  “<i>Services rendered?</i>”  Smiling, you make your way back to camp, feeling decidedly good about yourself.\n\n");
    ...
    protected gonnaGetMeSomeRevengeButtsexin(): void {
        ...
        if (this.player.biggestCockLength() <= 4) {
            ...
            this.outputText("<i>Smack!</i>  Izumi’s head jerks around, her expression thunderous, as the open palm slap hammers home onto her rump.\n\n");

            this.outputText("“<i>What the </i>hell<i> do you think you’re doing, kid?!</i>”  She bellows.  You grin happily at her, glad you’ve finally gotten her attention.\n\n");

            this.outputText("“<i>Tell me how big it is.</i>”  You command.\n\n");

            this.outputText("“<i>Wha-</i>”  Izumi opens her mouth to object, but is cut off by another blistering slap to the rump.  She winces in pain, then roars in outrage.  “<i>Why, you little piece of-</i>”  Another slap hammers home, cutting her off again.  “<i>Fine! Fine, I’ll- Fine.</i>”  She repeats, apparently more to calm herself down than to reassure you.  There’s a long, awkward pause as she glares off into the gloom of the cave.  You raise your hand again, threateningly, and she grimaces before finally responding.\n\n");

            this.outputText("“<i>It’s big,</i>” she spits.\n\n");

            this.outputText("“<i>How big?</i>” you ask, feeling pleased with yourself.\n\n");

            this.outputText("“<i>Fuck, I don’t-</i>”  You raise an eyebrow, your hand still raised threateningly above her reddening rump.  She glares at it for a moment.  “<i>Fine. I get it, already. It’s.. Really big, okay?  Huge.  Massive.</i>”  She growls.\n\n");

            this.outputText("“<i>Keep going.</i>”  You say, lowering your hand to caress her cheeks as you begin to thrust once again.\n\n");

            this.outputText("“<i>Yeah, keep going, I get it you little pervert...</i>”  Izumi grumbles under her breath, then speaks up, listing off your supposed amazing attributes in the same tone one might discuss the weather. “<i>You’re hung like a monster.  Okay?  I’ve never seen a dick as big and beautiful as yours.  It’s...</i>”  She grits her teeth.  “<i>It’s amazing. I’ve never felt this much pleasure from a single cock before. Uhn. Ahn.</i>”\n\n");

            this.outputText("The fake groans were a nice little touch, you think, pumping happily away at Izumi’s ring while she verbally fellates your imaginary megacock.  It seems that your new plan is working much better than the old one; if Izumi is going to shoot down your every attempt to make this pleasurable for her, you may as well get your jollies by humiliating her instead.  Occasionally you pull back a little too far and accidentally slip out, meaning she has to wait for a few seconds for you to awkwardly replace your cock, but that just seems to add to her discomfort and embarrassment - much to your amusement.\n\n");

            this.outputText("“<i>Ahhn.  Nooo.  If you keep this up, I’ll become your slave.</i>”  She sighs, her voice monotone.");
            if (this.player.cor >= 50) this.outputText("  You hate to admit it, but in a messed up way, her apathy is beginning to turn you on a bit by itself.  You knew you weren’t the most well-endowed adventurer in the first place, and to someone physically huge like Izumi the problem must be magnified.  For some reason, you find that idea hot as hell....\n\n");

            this.outputText("You lean forwards, layering yourself over the broad expanse of Izumi’s back as you reach forwards to grope and massage the vast globes of her tits.  Izumi growls and grumbles in annoyance, but makes no attempt to stop you.  Your questing fingers manage to locate her nipples, which harden swiftly under your tender caress.  You pinch and pull at them, teasing the sensitive nubs, indifferent to Izumi’s grunting protests.\n\n");

            this.outputText("From your new position draped lazily over her back, you’re free to pound your hips against the soft cushion of Izumi’s backside as though you really were a rabbit in heat, hunched over her and humping relentlessly away with a constant barrage of sharp, swift, and above all <i>short</i> strokes.  This time, though, you’re too lost in the heat of the moment to care, as a familiar tingling readiness spreads through you, the heat from Izumi’s body and the bizarrely arousing situation making up for the lack of stimulation from your clearly inadequate cock.\n\n");

            this.outputText("“Oh, getting close, huh?”  She snarls.  “You gonna blow already?  Not much for stamina either, are ya?  Ugh, just hurry up...”  You answer her with only a long, drawn out moan as your orgasm hits, burying yourself - for whatever that’s worth - balls deep in her ass as your first load boils free of your diminutive, spasming cocklet.");
    ...
    protected sayThatsAPrettyFaceBeAShameIfSomebodyJizzedAllOverIt(): void {
        ...
        this.outputText("An evil idea begins to form inside your head.  You give Izumi’s horn a quick yank, causing her to yelp out loud, flinching massively.\n\n");

        this.outputText("You direct her to kneel down with a growl.  Izumi opens her mouth to argue, then thinks better of it.  “<i>Okay! Okay, look, I’m cooperating.  Ha ha, you sure showed me, boy is my face re-Oh.</i>” She stops, eyes widening a little as you use your free hand to pull out [oneCock], stroking it towards hardness mere inches from her face.  She stares, mesmerized, as your hand rolls up and down your stiffening erection right in front of her.  \n\n");

        this.outputText("You smile, and on a whim, you decide to start stroking Izumi’s horn in the same way, matching stroke for stroke.  She flinches again and her hands reach up to grip weakly at your wrist.  “<i>Hands down!</i>” you bark, and they fall away instantly to rest on her knees, her hands clenching and unclenching repeatedly as she grits her teeth against the feeling of you rubbing at her horn.\n\n");

        this.outputText("Finally, you’re fully erect, Izumi’s occasionally-wincing gaze locked on the [cockhead biggest] of your [cock biggest], bobbing in the air in front of her.  Your smile widens into a leer as you put phase two of your ingenious plan into action.\n\n");

        this.outputText("“<i>Kiss it,</i>” you order. Izumi’s eyes flicker briefly to look up at your face, but by this point she knows better than to attempt disobedience.  Leaning hesitantly forwards, Izumi purses her lips as she moves in for the kiss.");

        var cockIndex: number = this.player.biggestCockIndex();

        if (this.player.cocks[cockIndex].cockType == CockTypesEnum.HORSE) this.outputText("  Visibly unsure of where to put herself, Izumi finally settles for brushing her lips against the exact center of the flared mass that makes up the head of your stallion-prick.");
        else if (this.player.cocks[cockIndex].cockType == CockTypesEnum.DOG) this.outputText("  Her eyes darting nervously from side to side, Izumi leans forwards and takes the very tip of your dogcock into her mouth, pressing her lips against the main bulk of what passes for your head.");
        else this.outputText("  You feel the soft, warm sensation of Izumi’s lips brushing against the sensitive head of your cock for a moment, then the process repeats itself as Izumi actually darts in again, unbidden, for a second smooch.");
        this.outputText("\n\n");
        ...
        this.outputText("“<i>Suck it!</i>” you command, as Izumi stares up at you with a pleading expression, tears beginning to form in the corners of her eyes due to lack of oxygen - or possibly just the rough treatment of her hyper-sensitive horn.  She lets out another whimper as you squeeze it, showing her what happens when she’s too slow, then she finally begins to work you over in earnest.\n\n");

        this.outputText("Her mouth latches onto you like a vacuum, sucking on your [cockHead biggest] so strongly it makes your knees weak, her tongue performing bizarre oral gymnastics around your cock.  You can only grunt in surprised appreciation; whatever else you might think about her, Izumi is <i>good</i> at this.  Or maybe she’s just desperate, trying to force you to cum as quickly as possible so that you’ll release her precious horn?  That seems distinctly possible, so you decide to take steps to counter it.\n\n");

        this.outputText("Yanking forwards on Izumi’s horn again, you pull her bodily down your length until you’re buried to the [sheath], swallowed up completely into Izumi’s tingling-hot mouth, her nose pressed up against your stomach.  She lets out another strangled, slightly frustrated cry, staring up at you in confusion.\n\n");

        this.outputText("You order her to stop, and you can see the confusion bloom in her eyes.\n\n");

        this.outputText("Izumi’s oral assault on your cock falters, awaiting your next move.  You simply stand there for a while, enjoying the feeling of having the brash Oni woman completely at your mercy...  and of course, forcing her to think about her situation as well.  How helpless she is, the thick meat filling her throat, her nose pressed deep in against you, every breath filling her lungs with your thick scent.  Idly, you begin to roll her head this way and that, using the poor Oni’s horn as a sort of joystick as you tilt her unresisting head to look at one side, then the other.\n\n");
    ...
    protected tribThatRockyHornGirl(): void {
        ...
        this.outputText("After listening to her request and offer of a bribe in exchange for letting her go unmolested, you respond by giving Izumi a sweet, innocent smile.\n\n");

        this.outputText("“<i>Ah, shit.</i>” She mutters, just before you push her to the ground, forcing her onto her back and swinging your leg over to straddle her chest.  She lets out a little ‘Oof!’ as you land.  You make a mental note to punish her for that, too; just what is she trying to imply, here?\n\n");

        this.outputText("“<i>H-Hey, listen!</i>” She stammers, wincing slightly as you run your hand exploratively over the rocky appendage protruding from her forehead. “<i>Y-You’re not really gonna do this, are you?! I mean, you’re a girl too, right? You’re not gonnauuwuugh come onnn...</i>” She trails off, twitching and shivering as you hit a particularly sensitive spot.  You can’t help but grin in anticipation as you slip out of your [armor], eyeing the horn lustily.  Izumi follows your gaze, initially failing to comprehend your intent, but then her face goes white and she grabs you by the wrist, desperately.\n\n");

        this.outputText("“<i>Wait!  Wait wait wait, you’re not thinking-?!</i>” She yammers.  “<i>You can’t!  You super can’t! Seriously, t-that’s dangerous!  You might hurt yourself, what are you thinking?!  And... a-and if you did that, I’d die!  I’ll really die!</i>”  To your intense surprise, she claps her hands together in front of her face and screws her eyes tight shut in fear, bowing her head in pleading submission.  “<i>Have mercy!</i>”\n\n");

        this.outputText("You can’t help but smirk in amusement at her misplaced terror as you realize what she thinks you’re planning to do.  Although the idea of totally overloading the big woman’s horn to see how she’d react is very tempting, you’re pretty sure forcing it inside yourself would be an incredibly bad idea; at the very least, if Izumi were to lose control of herself and start thrashing around... it is <i>close</i> to what you had in mind though.  \n\n");

        this.outputText("Extricating yourself from Izumi’s clutches, you scoot forwards, ignoring the whimpering girl below you.  You press your [vag] against her horn, causing her to shiver and let out a panicked whine, tensing up as she anticipates the onslaught to come.  Rather than try to pull the horn fully <i>into</i> you, however, you begin to roll your hips, grinding your dampening nethers against the uneven surface.\n\n");

        this.outputText("Izumi’s horn is covered in a myriad small bumps, faults and angles, causing you to let out an appreciative hiss or a surprised gasp whenever an unexpected ridge or lump rubs against your most sensitive parts.  Despite its bony, rocky appearance, Izumi’s horn is actually warm to the touch - a pleasant discovery, given that you were expecting it to be as cold and hard as the stone it resembles.  Judging by the sounds coming from beneath you, it would appear that Izumi has already been reduced to a quivering wreck, unable to do anything but stammer out a long series of croaking, staccato “A-a-aa-a-a” noises.  In a strange way, her helplessness is actually kind of cute.\n\n");

        this.outputText("You have other concerns on your mind just now though, as you’re really beginning to enjoy your new toy.  You roll your [hips] with ever-increasing force, mashing your [vagina] into the slickening protrusion as you use Izumi’s horn to grind yourself closer and closer to your encroaching orgasm.  You grip the horn even tighter, eliciting a high-pitched whine from Izumi as you press it into your crotch as hard as you can manage, rubbing yourself onto it with even greater ferocity, your juices beginning to flow in earnest, trickling down onto Izumi’s face as you ride her face, relentlessly tribbing yourself towards climax.\n\n");

        this.outputText("Dimly, you feel Izumi shift under you, followed by a quiet, breathy grunt.  Izumi’s breathing also changes, becoming less the panicky, stressed out hyperventilating you’ve grown accustomed to, and more an awkward, rhythmic panting.  Casting a glance over your shoulder, it would appear that Izumi still has her eyes clamped shut.  Somewhat more interestingly, however, one musclebound arm has managed to raise itself from her side to slip between her legs, disappearing under the skimpy folds of her kimono.  Her other hand grips the first weakly at the wrist, alternately clenching as you hit a particularly sensitive spot or awkwardly rubbing her forearm as she stealthily masturbates - it seems your self-indulgent play has turned her on almost as much as you.\n\n");

        this.outputText("You let out an amused laugh.  You have to admit, it’s pretty funny that the big bad muscle-girl couldn’t manage to control herself even while she’s technically being raped.\n\n");

        this.outputText("“<i>Having fun?</i>”  You ask, smiling to yourself.  Izumi’s eyes snap open, her face turning an even deeper shade of crimson than before as her eyes flicker down to her crotch.  Poor girl, you think; she might not even have fully realized what she was doing.  Well, she does now...\n\n");

        this.outputText("“<i>I-It’s... it’s not... s-shut up!</i>” She stammers, adding “<i>It’s not my f-fault if you keep t-touching me in weird places and I get... distracted!  </i>You’re<i> the perverted one here, not me!</i>”\n\n");

        if (this.player.cor > 80) this.outputText("“<i>Whatever.  Just try not to cum too hard while I’m making you my bitch, you little slut.</i>” You shoot back, returning");
        else this.outputText("Ignoring her protests entirely, you return");
        this.outputText(" your attention to her horn.  Still though, there’s something missing; as fun as it is molesting and toying with the oversized lout currently protesting her innocence while buried up to the knuckle in her own cunt, you’re not quite feeling it enough to get off yourself.  Clearly, that has to change.\n\n");

        this.outputText("Experimentally, you shift position, leaning back to expose more of your crotch to the wonderful warm, bumpy sensations running through it, supporting your weight with one arm wrapped around the long-suffering Oni’s horn.  That’s <i>much</i> better you think, as you rock bodily back and forth, running yourself across the entire rugged length of the curved protrusion, biting your lip as an errant crag scrapes deliciously across your [clit]. The act sends a searing shiver down your spine, along with a growing, scandalous desire to revisit the sensation.  \n\n");

        this.outputText("With increasing urgency, you frig yourself in earnest on Izumi’s horn, her muted sounds of protest rising in pitch and desperation along with the power of your strokes.  You sense her hips rising behind you as she begins to lose her inhibitions once again in the face of your unflinching assault, slapping away shamelessly at her pussy - which, by the sounds of it, must be absolutely dripping wet by now - two enormous fingers ramming themselves repeatedly home with brutal force.\n\n");

        this.outputText("The thought of the once proud Oni now being reduced to such desperate and wanton masturbation by the idea of being made into your toy makes you want to laugh again, but more than that, it’s somehow incredibly arousing.  You’re not sure which you’d prefer more; to find out that she has a hidden submissive streak and that she’s totally into this kind of thing... or that she <i>isn’t.</i>\n\n");

        this.outputText("Regardless, any further experimentation will have to wait, as before you know it your orgasm is upon you.  Clutching at Izumi’s horn, you ram yourself home one final time, almost as though punishing your wanton pussy by slamming it against the hard surface.  Beneath you, Izumi bucks and jerks, letting out a high and surprisingly girlish wail as you orgasm around her horn, your juices splattering down to cover her face, her horn, your increasingly numb-feeling hand....\n\n");

        this.outputText("With a final thump, Izumi’s hips drop back down to the ground, her arms flopping uselessly to her side.  After a moment or two of mutual, panting recover, you unsteadily step off of her and scratch at your head, as the aftermath of your orgasm begins to subside.  For her part, Izumi lays flat on her back, unmoving, her eyes glassy and unfocused, breathing as though she had just run a marathon.  Between her legs, you can dimly make out an unmistakable damp streak, glistening across the cave floor in the darkness.  You smirk at the sight, deciding to add one final little insult to the proceedings.\n\n");

        this.outputText("“<i>You came, didn’t you?</i>” You ask, sweetly.  Izumi trembles a little, her eyes rolling over to you.  She seems to be having trouble focusing.\n\n");

        this.outputText("“<i>..’es,</i>”  She croaks, almost inaudibly.  She sounds as though she’s on the verge of tears, presumably from embarrassment - you’re pretty certain you haven’t actually done anything that could hurt her.  You shake your head, chuckling to yourself as you redress and rummage through Izumi’s belongings for a trophy.\n\n");

        this.outputText("“<i>I’m taking this,</i>” You announce cheerfully, hefting a small bag of gems in one hand.  “<i>‘Kay.</i>” Izumi’s approval doesn’t matter to you either way, but your smile widens at her submissive, exhausted tone.\n\n");

        this.outputText("By the time you get back to camp, you’re almost feeling good enough to whistle.");
