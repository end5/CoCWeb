    ...
    */
    ...
    public tamaniChest(): string {
        ...
        switch (this.flags[kFLAGS.TAMANI_TIMES_IMPREGNATED]) {
            case -1:
            case 0: descript = (TamaniScene.rand(2) == 0 ? "ample " : "handful of "); break;
            case 1:
            case 2:
            case 3: descript = (TamaniScene.rand(2) == 0 ? "large " : "jiggling "); break;
            case 4:
            case 5:
            case 6: descript = (TamaniScene.rand(2) == 0 ? "wobbling " : "impressive "); break;
            case 7:
            case 8:
            case 9:
            case 10: descript = (TamaniScene.rand(2) == 0 ? "over-proportioned " : "super-sized "); break;
            default: descript = (TamaniScene.rand(2) == 0 ? "massive " : "gigantic "); break;
        }
    ...
    private tamaniFirstTimeConsentual(): void {
        ...
        if (this.player.balls > 0) this.outputText("Your " + this.ballsDescriptLight() + " swell with seed, spurring your desire to new heights.", false);
        else this.outputText("Something inside you swells up with seed, spurring your desire to new heights.", false);
        ...
        if (this.player.cockArea(0) <= 90) {
            ...
            if (this.player.balls > 0) this.outputText(" and drips from your " + this.ballsDescriptLight(), false);
            ...
            if (this.player.cockArea(0) > 30) this.outputText(" and watching her belly bulge from your size", false);
            ...
            //[CORRUPT]
            if (this.player.cor > 66) this.outputText("  Your " + this.cockDescript(0) + " twitches at the thought, ready and wanting more.", false);
        }
        //(TOO BIG)
        else {
            ...
            if (this.player.hasSheath()) {
                ...
                if (this.player.balls > 0) this.outputText("licks all over your balls", false);
                else if (this.player.hasVagina()) this.outputText("sneaks between your folds to tease your now-hardening clit", false);
                else this.outputText("licks the sensitive " + this.player.skinTone + " " + this.player.skinDesc + " of your inner thighs", false);
            }
            this.outputText("\n\n", false);
            ...
            if (this.player.balls > 0 && this.player.hoursSinceCum > 200) this.outputText(", visibly draining your " + this.ballsDescriptLight() + " down to their normal size", false);
    ...
    public tamaniSexLetHer(): void {
        ...
        if (this.getGame().inCombat) {
            ...
            if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
                if (this.player.HP < 1) this.outputText("You stumble, hooves weaving drunkenly as you try to keep your feet.  ", false);
                else this.outputText("You stumble, hooves weaving drunkenly as " + this.sMultiCockDesc() + " ache and drool with need.  ", false);
            ...
            //Not taur
                ...
                if (this.player.HP < 1) this.outputText("You collapse, unable to fight back any longer.  For her part, Tamani seems disappointed with the outcome, but approaches your prone form in spite of your sorry appearance.", false);
                else this.outputText("You tear off your clothes in a frenzy of lust and stagger towards Tamani, openly fondling your groin.   She smirks and pushes you hard, throwing you off balance and onto your back.", false);
                this.outputText("  She wiggles her " + this.tamaniChest() + ", and despite your efforts to control your body, ", false);
                if (this.player.cockTotal() == 1) this.outputText("an erection emerges", false);
                else this.outputText("erections sprout up like weeds", false);
        ...
        if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
            ...
            //If >18 Inches 
                ...
                if (this.player.balls == 0) this.outputText("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics.\n\n", false);
                else this.outputText("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics, before the goblin in question drives all thoughts out of your head by beginning to mash her soft soles into your " + this.ballsDescriptLight() + ".\n\n", false);
                ...
                //High cum: 
                    ...
                    if (this.player.balls > 0) this.outputText("Your " + this.ballsDescriptLight() + " ache and you feel very thirsty indeed.", false);
                    else this.outputText("You feel very thirsty indeed.", false);
        ...
        //Not-taurs
            ...
            if (this.player.cockArea(0) <= 90) {
                ...
                if (this.player.cocks[0].cockLength >= 12) this.outputText("Her body visibly stretches around you, and you silently thank whatever gods or demons adapted goblins to be able to fulfill this role.  ", false);
                ...
                if (this.player.totalNipples() == 2) this.outputText("both", false);
                else this.outputText("all", false);
                ...
                if (this.player.biggestTitSize() >= 2) this.outputText("Your " + this.allBreastsDescript() + " bounce and jiggle obscenely as the goblin twists and pulls, abusing your nipples.", false);
                else this.outputText("Your " + this.nippleDescript(0) + "s burn with pain as the goblin twists and pulls on them, abusing them.  Pleasure and pain mix together, overwhelming you, reducing your world to little more than the slap of genital against genital and the painful torture happening to your chest.\n\n", false);
                ...
                if (this.player.balls > 0) this.outputText("Your " + this.ballsDescriptLight() + " twitch powerfully, venting their contents, releasing a jet of hot cum into the goblin.", false);
                else this.outputText("Your body's internal muscles twitch, pushing a jet of hot cum into the goblin.", false);
                ...
                if (this.player.cumQ() >= 250) this.outputText("  After a while you can feel the pressure building inside her, starting to give her a bit of a belly.  Tamani rubs it and begs, \"<i>More!</i>\"", false);
                if (this.player.cumQ() >= 500) this.outputText("  Your body fulfills her requests and more, stuffing her until she's positively pregnant and your spunk is squirting from her entrance with each wave of sticky spooge.", false);
                else this.outputText("  Sadly, you only manage a few more spurts before your orgasm ends.", false);
                ...
                if (this.player.cumQ() < 250) this.outputText(".  I really enjoy our fucks " + this.player.mf("stud", "hun") + ", and I can't wait to 'bump' into you again.", false);
                else {
                    this.outputText(".  You make sure and let your ", false);
                    if (this.player.balls > 0) this.outputText(this.ballsDescriptLight() + " fill back up with cum, ok?", false);
            ...
            //(Doesnt fit)
                ...
                if (this.player.balls > 0) this.outputText("lifts up your " + this.ballsDescriptLight(), false);
                else this.outputText("leans forwards, looking between your legs", false);
                ...
                if (this.player.hasVagina()) this.outputText("cock's base ", false);
                ...
                if (this.player.cumQ() >= 250) {
                    ...
                    if (this.player.cumQ() >= 500) this.outputText(" as you keep cumming, splattering her tits and face, soaking the little goblin slut", false);
                    this.outputText(".  ", false);
                }
    ...
    public tamaniSexLost(): void {
        ...
        if (this.player.HP < 1) this.outputText("lie there, unable to fight back.  ", false);
        else this.outputText("touch yourself, giving in to the tiny goblin's desire to breed.  ", false);
        ...
        else this.outputText("Somehow the ring fits onto you perfectly, as if it was made exactly for your " + this.cockDescript(0) + ", though it remains painfully tight.\n\n", false);
        ...
        if (this.player.balls > 0) this.outputText("cups your " + this.ballsDescriptLight() + " tightly", false);
        else this.outputText("caresses you around the ring", false);
        ...
        if (this.player.balls > 0) this.outputText("Your balls are getting VERY swollen and tender.", false);
        else this.outputText("Your body aches inside, feeling bloated and ready to pop.", false);
        ...
        if (this.player.cumQ() >= 250) this.outputText("  The bottle quickly overflows, but Tamani happily sets it aside and slides her own cunt under you, letting you pump the rest of your seed into her fertile womb.", false);
        if (this.player.cumQ() >= 500) this.outputText("  She coos happily when you still manage to pump enough jism into her to bloat her belly, but even with your impressive fertility, the orgasm has to end.", false);
        this.outputText("\n\n", false);
    ...
    public tamaniSexWon(): void {
        ...
        if (this.player.cockArea(x) <= 90) {
            ...
            if (this.player.totalCocks() > 1) this.outputText(" and tight asshole", false);
            ...
            if (this.player.gender == 1) this.outputText("man", false);
            ...
            if (this.player.totalCocks() > 1) {
                ...
                if (this.player.cumQ() >= 250) this.outputText("  She pants, turning her head in the mud to watch as her belly visibly inflates, stuffed totally full of cum. ", false);
                if (this.player.cumQ() >= 500) this.outputText("  In no time at all a river of jism pours from her, pooling below as you overwhelm her body's capacity to store spunk.", false);
            }
            else {
            ...
            if (this.player.balls > 0) this.outputText("sexy balls have ", false);
            else this.outputText("sweet cock has ", false);
        ...
        //Too big? Jerk off with feet and bukkake
            ...
            if (this.player.totalCocks() > 1) this.outputText("any of your massive members", false);
            else this.outputText("your massive member", false);
            ...
            if (this.player.cumQ() >= 250) this.outputText("  You continue working your " + this.cockDescript(x) + " with her supple feet, watching your dripping spooge froth and bubble as you continue to pump more onto the sassy wench.", false);
            if (this.player.cumQ() >= 500) this.outputText("  She sputters, blowing some of the caked up semen off her face so she can breathe.  The slut gathers up the goopy mess as you continue to paint her, alternatively devouring it with her mouth and shoveling drippy handfuls into her eager cunt.", false);
            this.outputText("\n\n", false);
    ...
    private tamaniPregnantFuck(): void {
        ...
        if (this.player.biggestTitSize() >= 2) this.outputText(this.allBreastsDescript(), false);
        else this.outputText("chest", false);
        this.outputText(".\n\n", false);
        ...
        //(Doesn't Fit)
            ...
            if (this.player.balls > 0) this.outputText("massaging your balls with her feet", false);
            else this.outputText("jacking the base of your " + this.cockDescript(0) + " with her feet", false);
    ...
    private tamaniPoopsOutBabies(): void {
        ...
        if (this.flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] > 0) this.outputText("with her daughters, ", false); //She always has at least two daughters if she has any
        ...
        if (this.flags[kFLAGS.TAMANI_PREGNANCY_COUNT] > 2) {
            ...
            if (this.flags[kFLAGS.TAMANI_PREGNANCY_COUNT] > 3) {
                ...
                else this.outputText(", and more than you can count", false);
            }
            this.outputText(".", false);
        }
        this.outputText("\n\n", false);
    ...
    public getRapedByTamaniYouHypnoSlut(): void {
        ...
        if (primary >= 0) {
            ...
            if (cocks > 0) this.outputText("main ", false);
            ...
            else this.outputText("She moans and pants, babbling about how good you are to her the whole time.", false);
            ...
            if (cocks > 0) this.outputText(" around your " + this.cockDescript(secondary), false);
            this.outputText(". Her tiny form jiggles, ", false);
            if (this.player.tallness > 55) this.outputText("lifting off the ground as you get into it, giving yourself over to her sex.", false);
            else this.outputText("nearly falling over as you give your body over to her sex.", false);
            ...
            if (this.player.skinType == SKIN_TYPE_FUR) this.outputText("matted", false);
            else this.outputText("slicked", false);
            ...
            if (cocks == 1) this.outputText("her tongue hanging out as she pants nonsensical pleasure-noises.", false);
            else this.outputText("and her mouth is too full of " + this.cockDescript(secondary) + " to do anything but gurgle out nonsensical pleasure-noises.", false);
            ...
            if (this.player.hasKnot(primary)) this.outputText("Your knot balloons inside her, locking her in place", false);
            else if (this.player.cocks[primary].cockType == CockTypesEnum.HORSE) this.outputText("Your flare widens, actually holding itself inside Tamani's womb", false);
            else if (this.player.cocks[primary].cockType == CockTypesEnum.DEMON) this.outputText("The corrupted nodules along your " + this.cockDescript(primary) + " pulsate in rippling, wave-like motions, massaging the interior of Tamani's twat", false);
            else if (this.player.cocks[primary].cockType == CockTypesEnum.TENTACLE) this.outputText("Your tentacle-cock's tip widens, becoming mushroom-like inside Tamani's womb", false);
            else this.outputText("Your sensitive head swells slightly in time with the contractions of your orgasm", false);
            this.outputText(" as you begin to fill your wife's womb with seed.   The orgasm is intense", false);
            if (this.player.cumQ() < 50) this.outputText(", but brief, and after a few moments of spasming pleasure, the flood of cum slows to a trickle.", false);
            else if (this.player.cumQ() < 300) this.outputText(" and voluminous, forcing more and more seed into Tamani's uterus until she sloshes with each new squirt.  After a few long moments of spasming pleasure, the flood of cum slows to a trickle.", false);
            else {
                ...
                if (this.player.cumQ() < 1000) this.outputText("  Though your orgasm tapers off, the additional seed squirts from between her thighs, trickling down to a slow drip of viscous white goo.", false);
                else this.outputText("  Trapped inside her and cumming as hard as ever, you raise the pressure inside the goblin until your seed is washing out of her cunt around you, puddling on the ground.", false);
                if (this.player.cumQ() >= 1000 && this.player.cumQ() < 4000) this.outputText("  It does eventually end, but not until a sizable puddle has formed between the pair of you.", false);
                else this.outputText("  It lasts seemingly forever, and by the time you're done, the two of you are standing in a puddle inches deep.", false);
            }
            if (cocks > 1) {
                ...
                if (this.player.cumQ() > 300) {
                    ...
                    if (this.player.cumQ() > 600) this.outputText("  A few seconds later she pulls back coughing, and the perky goblin takes the rest of your load in her face.", false);
                }
            ...
            if (this.player.tallness > 55) this.outputText(" in spite of the height differential", false);
        ...
        //[DOESNT FIT]
            ...
            this.outputText("Tamani is completely right.  You grab her ass, feeling your fingers sink in to her supple flesh as you pull her back towards your ", false);
            if (cocks > 1) this.outputText("main ", false);
            ...
            else this.outputText("between your " + this.breastDescript(0) + " ", false);
            ...
            if (cocks > 1) this.outputText("primary ", false);
            ...
            if (this.player.tallness > 60) this.outputText("big ", false);
            ...
            if (this.player.cor < 33) this.outputText("beg", false);
            else if (this.player.cor < 66) this.outputText("ask", false);
            else this.outputText("command", false);
            ...
            if (this.player.cumQ() > 250) this.outputText("  In no time, you've filled her to capacity, and white mixes in with the clear sexual fluids that are dripping from the goblin's cunt.", false);
            if (this.player.cumQ() > 700) this.outputText("  A few more blasts visibly bloat her belly, and Tamani pulls her hands away from her pussy to stroke the slowly rounding dome on her abdomen.", false);
            if (this.player.cumQ() > 1500) {
                ...
                if (this.player.cumQ() > 3000) this.outputText(", and by the time you finish, both of you are in a thick puddle of spunk", false);
                this.outputText(".", false);
            }
            if (cocks > 1) {
                if (cocks == 2) this.outputText("  Your other" + this.cockDescript(1), false);
                else this.outputText("  Each of your other " + this.multiCockDescriptLight(), false);
