...
export class BeeGirlScene extends BaseContent {
    ...
    private beeEncounterSelect(clearScreen: boolean = true): void {
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1 && this.player.cockArea(0) > 100 && this.player.statusAffectv2(StatusAffects.Exgartuan) == 0) { //Exgartuan messes with things!
            this.beeEncounterWithExgartuan();
            return;
        }
        if (this.player.findStatusAffect(StatusAffects.Infested) >= 0 || this.player.findStatusAffect(StatusAffects.WormPlugged) >= 0) { //Worms now mess with things too!
    ...
    private beeEncounterAfraidRepeatSex(): void {
        ...
        else this.outputText("slipping her fingere inside your " + this.assholeDescript() + "till you’re ready");
        ...
        if (this.player.analCapacity() < 25) {
            ...
            else this.outputText("<b>Your " + this.assholeDescript() + " has become looser thanks to the knotted appendage penetrating you.</b>");
    ...
    private beeEncounterWithWorms(): void { //If she won't fuck infested players after combat then she shouldn't fuck them here either
        ...
        this.outputText("The bee maiden puts her hands on your shoulders.  She draws you gently into a kiss, but as her sweet saliva prepares you for what is to come you feel one of your annelid passengers slither down " + (this.player.findStatusAffect(StatusAffects.WormPlugged) >= 0 ? "from your cervix and poke out of your cunt" : "your urethra and wrap itself around the tip of your cock") + ".  The bee girl pulls back from the kiss, looks down and jumps back, the color draining from her face.\n\n");
    ...
    private beeEncounterClassicSex(postCombat: boolean = true): void {
        ...
        if (this.player.isTaur()) {
            ...
            if (this.player.longestCockLength() >= 100 || this.player.gender == 0) {
                ...
                if (this.player.gender == 1) {
                    ...
                    //[Without testicles:
                    if (this.player.balls == 0) this.outputText("With your cock quivering and spasming you continue to lap at the honey covered tree until the vibrating bee-girl finishes.  ", false);
                    //[With testicles:
                    else this.outputText("With your cock quivering and spasming semen erupts from the tip.  ", false);
                    //[Little-normal cum amount:
                    if (this.player.cumQ() < 100) this.outputText("You spurt out more cum than you thought your " + this.ballsDescriptLight() + " could hold. White speckles the base of the tree and tiny puddles form underneath you as you groan in satisfaction.\n\n", false);
                    //[Huge cum amount:
                    else this.outputText("Your " + this.ballsDescriptLight() + " goes off like a firehouse, coating the base of the tree along with a number of the ones behind it. Soon you're standing in a massive puddle of your own splooge, the scent threatening to overpower that of the honey. The bee-girl compensates by splashing more onto your back, causing you to release yet another burst of thick white cum.\n\n", false);
                }
                //[Herm (bypasses the bucking scene):
                    ...
                    //[Without testicles:
                    if (this.player.balls == 0) this.outputText("With your cock quivering and spasming and your untended to " + this.vaginaDescript(0) + " squirting repeatedly, you continue to lap at the honey covered tree until the vibrating bee-girl finishes.  ", false);
                    //[With testicles:
                    else this.outputText("With your cock quivering and spasming semen erupts from the tip.  ", false);
                    //[Little-normal cum amount:
                    if (this.player.cumQ() < 100) this.outputText("You spurt out more cum than you thought your " + this.ballsDescriptLight() + " could hold. White speckles the base of the tree and tiny puddles form underneath you as you groan in satisfaction.\n\n", false);
                    //[Huge cum amount:
                    else this.outputText(this.SMultiCockDesc() + " goes off like a firehouse, coating the base of the tree along with a number of the ones behind it. Soon you're standing in a massive puddle of your own splooge, the scent threatening to overpower that of the honey. The bee-girl compensates by splashing more onto your back, causing you to release yet another burst of thick white cum.\n\n", false);
                }
            ...
            //Route 1 
                ...
                if (this.player.biggestTitSize() > 1) {
                    ...
                    //[Fuckable breasts:
                    if (this.player.hasFuckableNipples()) this.outputText("  Your fingers slip in and out of them, sending femcum flying everywhere. But the effects of the bee's honey appear to prevent you from getting off.", false);
                    //[Other:
                    else this.outputText("  No amount of stimulation seems to get you off though.", false);
                }
                this.outputText("\n\n", false);
                ...
                if (this.player.gender == 1) {
                    ...
                    //[Without testicles:
                    if (this.player.balls == 0) this.outputText("You cum violently, your " + this.multiCockDescriptLight() + " quivering and spasming.  ", false);
                    //[With testicles:
                    else this.outputText("You cum violently, your " + this.multiCockDescriptLight() + " quivering and spasming while semen erupts from the tip.  ", false);
                    //[Little-normal cum amount:
                    if (this.player.cumQ() < 100) this.outputText("You spurt out more cum than you thought your " + this.ballsDescriptLight() + " could hold. White speckles your underside and tiny puddles form underneath you as you groan in satisfaction.\n\n", false);
                    //[Huge cum amount:
                    else this.outputText("Your " + this.ballsDescriptLight() + " goes off like a firehouse, coating your underside with white and dripping down your front legs. Soon you're standing in a massive puddle of your own splooge, the scent threatening to overpower that of the honey. The bee-girl compensates by splashing more onto your back, causing you to release yet another burst of thick white cum.\n\n", false);
                }
                //[Female:
                    ...
                    //[Tiny-normal clit:
                    if (this.player.clitLength < 3) this.outputText("Her awkward ministrations to your " + this.clitDescript() + " cause a gush of fluids from your " + this.vaginaDescript(0) + " and you let out a lewd moan of satisfaction.  ", false);
                    //[Cock-like clit:
                    else this.outputText("She quickly finds your " + this.clitDescript() + " and begins to jerk it off like a cock.  The sensation is incredible and you moan lewdly as your " + this.vaginaDescript(0) + " gushes fluid.  ", false);
            ...
            this.player.slimeFeed();
            //Anal bee pregnancy!
            if (BeeGirlScene.rand(3) == 0) this.player.buttKnockUp(PregnancyStore.PREGNANCY_BEE_EGGS, PregnancyStore.INCUBATION_BEE, 1, 1);
            this.player.buttChange(25, true);
        }
        //NON TAURS
        //Dicked version...
        ...
        //non-dicked version
            ...
            if (this.player.vaginas.length == 0) {
                ...
                if (this.player.totalNipples() > 1) this.outputText(", your nipples swollen and red with desire.  ", false);
                else this.outputText(".", false);
            }
            //Coochie talk!
            else {
                if (this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_WET) this.outputText("centering around your now puffy vulva.  ", false);
                if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_WET && this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_DROOLING) this.outputText("growing more potent around your " + this.vaginaDescript(0) + " as it begins to leak with the honey of your desire.  ", false);
                if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_DROOLING) this.outputText("inflaming your " + this.vaginaDescript(0) + " with need, and allowing a river of your wetness to gush from between your puffy vulva.  ", false);
            }
            //Boobies!
            if (this.player.biggestTitSize() > 1) {
                ...
                //if lactating
                if (this.player.biggestLactation() > 1) this.outputText(", humming in surprise as a squirt of milk splatters across the flower's petals.  ", false);
                else this.outputText(".  ", false);
            }
            //Multiboobs!
            if (this.player.breastRows.length > 1) {
                ...
                //Milk bit
                if (this.player.biggestLactation() > 1) this.outputText(" in surprise as a squirt of milk splashes across the flower's petals.  ", false);
                else this.outputText(".  ", false);
            }
            //Continue as normal!
            ...
            if (this.player.vaginas.length > 0) this.outputText(" as your hand is guided to your " + this.vaginaDescript(0), false);
            this.outputText(".\n\n", false);
            //Cum text
            if (this.player.vaginas.length > 0) this.outputText("Your fingers dance over your clit as you lap up her honey", false);
            else this.outputText("Your fingers explore every inch of both your bodies as you lap up her honey", false);
            ...
            if (this.player.vaginas.length > 0) this.outputText(", the constant aphrodisiac honey you're mindlessly devouring, and your fingers' instinctual ravaging of your " + this.vaginaDescript(0) + ", ", false);
            else this.outputText(" and the constant aphrodisiac honey you're mindlessly devouring, ", false);
    ...
    */
    ...
    private beeMaidenPlay(): void {
        ...
        if (this.player.hasVagina()) {
            ...
            if (this.player.wetness() <= CoC.VAGINA_WETNESS_NORMAL)
                this.outputText("barely");
            else if (this.player.wetness() <= CoC.VAGINA_WETNESS_SLICK)
    ...
    private seduceBeeGirl(): void {
        ...
        if (this.player.gender == 3) {
            ...
            if (this.player.balls > 0) this.outputText(", sliding down and over your balls,", false);
        ...
        if (this.player.isTaur()) {
            ...
            if (this.player.HP < 1) {
                ...
                //[Herm:
                    ...
                    this.outputText("The sensations prove too much for your massively engorged " + Appearance.cockNoun(this.player.cocks[0].cockType) + " and sopping " + this.vaginaDescript(0) + " to take and you begin to shake violently, incapable of touching it as one is trapped underneath you with the weight of the bee-girl preventing you from getting the leverage needed to hump the hard ground and the other is hopelessly out of reach.\n\n", false);
            ...
            //Lust:
                ...
                //[Herm:
                    ...
                    this.outputText("The sensation proves too much for your massively engorged " + Appearance.cockNoun(this.player.cocks[0].cockType) + " and " + this.vaginaDescript(0) + " to take and you begin to shake violently, incapable of touching it as one is trapped underneath you with the weight of the bee-girl preventing you from getting the leverage needed to hump the hard ground and the other is hopelessly out of reach.\n\n", false);
            ...
            //Male + venomz
            if ((this.player.findStatusAffect(StatusAffects.ParalyzeVenom) >= 0 || this.player.findStatusAffect(StatusAffects.lustvenom) >= 0) && !sexed && this.player.cockTotal() == 1) {
            ...
            if (this.player.gender == 1) {
                if (this.player.lust >= 100) this.outputText("Overcome by lust, you throw yourself into her waiting arms.  ", true);
                else this.outputText("Overcome by your wounds, you are unable to resist as she lifts you into her arms and embraces you.  ", true);
            ...
            if (this.player.gender == 2) {
                if (this.player.lust < 100) this.outputText("Barely conscious, you look up as the bee approaches.  ", true);
                else this.outputText("Overcome with desire, you look up as the bee approaches.  ", true);
                ...
                if (this.player.isTaur()) this.outputText("After a while, her hot and sweet pussy swiftly disappears from your sight, and you feel the bee-girl's weight on your butt, right before her stinger,", false);
                ...
                else this.outputText("Your moans are muffled by the honeyed pussy on your face, and you hear her starting to squeal loudly. Her thighs clamp tightly around your ears, grinding harder into your face as her stinger picks up the pace.  ", false);
    ...
    public rapeTheBeeGirl(): void {
        ...
        var eggs = undefined;
        if (this.player.canOvipositSpider() && (this.player.faceType == FACE_SNAKE_FANGS || this.player.faceType == FACE_SPIDER_FANGS)) {
        ...
        if (this.player.cor >= 75 && this.player.str >= 60 && (this.player.tongueType == TONUGE_SNAKE || this.player.hasCock() || this.player.hasVagina() || this.player.biggestTitSize() >= 4)) {
    ...
    private rapeTheBeeGirlWithADick(): void {
        ...
        //TAURS GO!
        if (this.player.isTaur()) {
            if (this.monster.lust > 99) this.outputText("The bee-girl plops onto her flower with her legs splayed out, letting you get a clear look at her dripping honeypot. She watches you nervously as you approach, letting her stinger slide out in a pointless threat. She seems taken aback when you smile down at her, but returns the gesture with a nervous smile of her own.\n\n", false);
            ...
            if (this.player.cockArea(x) <= this.monster.vaginalCapacity()) {
                ...
                //Has testicles:
                if (this.player.balls > 0) this.outputText("  Her other hand slides down and begins to massage your " + this.ballsDescriptLight() + ", squeezing and tugging gently at your scrotum. Her tongue joins them, sliding in and out of your ass before wrapping around your sack. You feel incredible and your " + this.cockDescript(x) + " drips pre, forming a puddle on the ground.", false);
                //No testicles:\
                else this.outputText("Her other hand starts pulling it open and soon her tongue joins them, sliding in and out of your ass delicately. Your " + this.cockDescript(x) + " quivers with anticipation and you swish your tail happily.", false);
                this.outputText("\n\n", false);
                ...
                //Has testicles:
                if (this.player.balls > 0) this.outputText("  Your " + this.ballsDescriptLight() + " really feel spectacular, the vibrations causing the hot spunk inside to roil about.", false);
                ...
                //Huge cum amount:
                if (this.player.cumQ() >= 500) this.outputText(" and watching as her lower body sinks into your spunk like a thick white bath", false);
            ...
            if (this.player.isTaur()) this.outputText("as your " + this.cockDescript(x) + " hardens under your belly.", false);
            else this.outputText("as you disrobe, revealing your " + this.cockDescript(x) + " to her.", false);
            this.outputText("  Wasting no time, you get down to the business of ", false);
            if (this.player.cockTotal() == 1) this.outputText("penetrating her slick snatch, forcing in inch after inch.  ", false);
            if (this.player.cockTotal() == 2) this.outputText("cramming your " + this.multiCockDescript() + " into her, double-stuffing the poor bee-slut with your double dongs.  ", false);
            if (this.player.cockTotal() >= 3) this.outputText("cramming two out of your " + BeeGirlScene.num2Text(this.player.cockTotal()) + " " + this.multiCockDescript() + "s into her, double-stuffing the poor bee-slut with double the dicks.  ", false);
            ...
            if (this.player.gender == 3 && this.player.lowerBody != LOWER_BODY_TYPE_CENTAUR) this.outputText("  You reach down and finger your " + this.vaginaDescript(0) + " roughly, lost in the throes of your orgasm.", false);
            this.outputText("\n\n", false);
            //wind down
            ...
            //high cum variances
            if (this.player.cumQ() >= 250 && this.player.cumQ() < 500) this.outputText("You smile proudly at the steady stream of your cum that pours from her abused cunt, pooling underneath her.   Her abdomen even looks bloated with your seed.", false);
    ...
    private rapeABeeGirlWithYourVagina(): void {
        ...
        if (this.player.isTaur()) {
            ...
            if (this.player.breastRows.length > 1) this.outputText(" and " + this.player.allBreastsDescript(), false);
            ...
            if (this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLICK) this.outputText("Thankfully her tongue keeps up its assault, curling 'round your clit and probing your depths in equal measure, keeping you slick and writhing in pleasure.  ", false);
            if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_SLICK && this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLAVERING) this.outputText("Your hips wiggle and writhe on the length of her tongue as it dives into your slippery depths and curls tightly around your clit, jacking it up and down like a cock.  Your girl-cum soaks her chin, drooling happily as she pleasures you.  ", false);
            if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_SLAVERING) this.outputText("Your hips quiver and grind against her face as her unusually long tongue simultaneously probes your depths and works your clit, wrapping around it and jerking it like a cock.   You squirt and drool constantly from her skilled assault, soaking her face and hair with your girl-cum.  ", false);
            if (this.player.clitLength > 3 && this.player.clitLength < 5) this.outputText("Your hips piston your huge clit into her mouth with no warning, forcing her to give your clit a blowjob.  Her slick black lips wrap around it immediately, sucking and licking, filling your body with lust and pleasure.  ", false);
            if (this.player.clitLength >= 5) this.outputText("Your hips shove your massive clit into her mouth without warning, stretching her slicked lips wide around your very un-womanly appendage.   She reacts immediately, sucking it into her mouth and throat.  Her tongue curls around it and begins to caress it sensually as she lets you hammer it in and out of her open throat.  Instinctively you mash your face into her sweetened cunt, losing all control of your lower body as it face-fucks her with reckless abandon.  ", false);
            //New PG - orgasm
            if (this.player.isTaur()) this.outputText("You orgasm in no time, coating her face with girl-cum the process.  You return the favor and dive into her muff, planting kisses and licks down as a reward for your victim's rather skilled efforts.  The taste is sweet and sexy all at once, and you quickly lose track of your reward scheme, simply licking and slurping to get as much of her nectar as possible until she is satisfied as well.", false);
            else this.outputText("In no time you both orgasm, sweet girl-cum coating both your faces as you work each other's cunt with desperation born of desire.  ", false);
        }
        this.player.orgasm();
        this.cleanupAfterCombat();
    }
    ...
    private futaRapesBeeGirl(): void {
        ...
        if (this.player.isTaur()) this.outputText("as you idly fondle your " + this.player.allBreastsDescript() + " as you feel your blood-gorged " + this.multiCockDescriptLight() + " swaying under your belly.  ", false);
        else this.outputText("as you disrobe, revealing your " + this.player.allBreastsDescript() + ", " + this.vaginaDescript(0) + ", and " + this.multiCockDescriptLight() + ".  ", false);
        this.outputText("You step forwards, straddling her and rubbing your outer lips in preparation.  ", false);
        if (this.player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_NORMAL) this.outputText("Your " + this.vaginaDescript(0) + " becomes puffy and moist with excitement, ready for what you have planned.", false);
        if (this.player.vaginas[0].vaginalWetness > VAGINA_WETNESS_NORMAL && this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_DROOLING) this.outputText("Your " + this.vaginaDescript(0) + " squicks wetly from your gentle ministrations as your vulva become sensitive and engorged.", false);
        if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_DROOLING) this.outputText("Your " + this.vaginaDescript(0) + " gushes in response, dripping steadily over your victim's face, covering it with a spattering of girl-cum.", false);
        //New PG
        ...
        if (this.player.balls >= 2) {
            if (this.player.ballSize < 5) this.outputText("Your " + this.ballsDescriptLight() + " droop into her eyes, blinding and humiliating her in equal measure.  ", false);
            else this.outputText("Your " + this.ballsDescriptLight() + " obscure most of her face, making it difficult to see her reactions, but her mouth gives you all the feedback you need.  It doesn't take more than a few moments for her struggles to cease, and soon, her long insectile tongue is worming its way into your " + this.vaginaDescript(0) + ".  ", false);
        }
        ...
        if (this.player.cumQ() < 75) this.outputText(", enjoying the chance to cut loose and explore your male half.  ", false);
        if (this.player.cumQ() >= 75 && this.player.cumQ() < 500) this.outputText(", smearing your hardness in copious pre-cum and reveling at the marvelous sensation it gives you.  ", false);
        if (this.player.cumQ() >= 500) this.outputText(".  A few drops of your pre manage to drip onto her face, mixing with the fluids from your cunt.  ", false);
        ...
        if (this.player.breastRows.length > 0) {
            if (this.player.biggestTitSize() >= 2) this.outputText("You free a hand to tend to your " + this.player.allBreastsDescript() + " and aching nipples, alternating between squeezing your female flesh and tugging on your erect nipples.  ", false);
        }
        this.outputText("\n\n", false);
        //New PG
        ...
        if (this.player.breastRows.length > 0) {
            if (this.player.biggestTitSize() >= 2) {
                ...
                //Lactation junction!
                if (this.player.biggestLactation() > 1 && this.player.biggestLactation() <= 2) this.outputText(", squirting milk all over the bee-girl's midsection.  ", false);
                if (this.player.biggestLactation() > 2 && this.player.biggestLactation() <= 3) this.outputText(", spraying milk all over your bee-bitch, soaking her completely with your milky-white goodness.  ", false);
                if (this.player.biggestLactation() > 3) this.outputText(", hosing milk everywhere, soaking the bee-girl completely.  The force of your orgasm seems to echo through your breasts, making them produce far more milk than normal.  ", false);
                if (this.player.biggestLactation() <= 1) this.outputText(".  ", false);
            }
        }
        if (this.player.balls >= 2) this.outputText("The warmth and pleasurable pressure of your male orgasm builds in your " + this.ballsDescriptLight() + ", growing stronger as it migrates up your groin to the base of your pulsing member.  You squeeze your " + this.cockDescript(0) + " tightly, trying to hold on a bit longer, but the squirming tongue inside you is too much.  ", false);
        //Mmmmmmangasm!
        if (this.player.isTaur()) this.outputText("As you're going to explode, you smile evilly as an idea crosses your mind. You turn around swiftly, leaving her surprised and still in the position of licking your pussy, her slender and squirming tongue out, and her face covered in girl-cum.  ", false);
        if (this.player.cumQ() < 25) {
            ...
            if (this.player.lowerBody != LOWER_BODY_TYPE_CENTAUR) this.outputText("Spent at last, you rise up off of her, shivering as her tongue retracts from your woman-hood.", false);
        }
        if (this.player.cumQ() >= 25 && this.player.cumQ() < 250) {
            ...
            if (this.player.lowerBody != LOWER_BODY_TYPE_CENTAUR) this.outputText("you rise up off her, shivering as her slender and squirming tongue retracts from your " + this.vaginaDescript(0) + ".", false);
        ...
        if (this.player.cumQ() >= 250 && this.player.cumQ() < 500) {
            ...
            if (this.player.lowerBody != LOWER_BODY_TYPE_CENTAUR) this.outputText("You rise up off of her in mid-orgasm, aiming lower and painting her with each blast of seed.  ", false);
            else this.outputText("You aim right at the oval of her face and paint her with each blast of seed.  ", false);
        ...
        if (this.player.cumQ() >= 500) {
            ...
            if (this.player.lowerBody != LOWER_BODY_TYPE_CENTAUR) this.outputText("You stand up off your victim, letting her tongue slip free from your soaked folds, and", false);
    ...
    private beeGirlRapeForTheDistinguishedGentleman(): void {
        ...
        if (select == 0) {
            ...
            //[(if penis then)
            if (this.player.hasCock()) this.outputText(", spraying the fuzzy side of the bee's abdomen with your sticky come,", false);
        ...
        //(if penis)
            ...
            if (this.player.cockArea(0) > this.monster.vaginalCapacity()) this.outputText("  The bee-girl barely winces as the head of your shaft bumps up painfully against her cervix, quickly returning to a rictus of ecstasy as you continue jerking her ovipositor off with your now-sticky hand.", false);
        ...
        //[(if dick)
        if (this.player.hasCock()) this.outputText("stroke your " + Appearance.cockNoun(CockTypesEnum.HUMAN), false);
        else if (this.player.hasVagina()) this.outputText("rub your " + this.vaginaDescript(0), false);
        ...
        if (this.player.hasCock() || this.player.lactationQ() >= 100 || this.player.wetness() >= 5) this.outputText(" and spray your sticky fluids all over her tortured groin", false);
        this.outputText(".\n\n", false);
    ...
    private beeAlternate(): void {
        ...
        if (BeeGirlScene.rand(2) == 0) {
            ...
            if (this.player.cocks.length >= 3) {
                this.outputText("  Her battered " + Appearance.vaginaDescript(this.monster, 0) + " grips down on your dual " + this.multiCockDescriptLight() + "s tightly, draining you of every drop she can.  Rivers of white begin to leak from her abused holes and mingle with her own release as it trails down her abdomen and drips off it slowly onto the forest floor.", false);
                if (this.player.cocks.length == 4) this.outputText("  The " + this.cockDescript(3) + " not inside her shakes wildly as you cum; jets of your semen let loose over her abused frame, coating her in white.", false);
                if (this.player.cocks.length > 4) this.outputText("  The " + this.multiCockDescriptLight() + "s not inside her shake wildly as you cum; jets of your semen let loose over her abused frame, coating her in white.", false);
            }
            //New PG
            this.outputText("\n\n", false);
            ...
            if (this.player.lowerBody != LOWER_BODY_TYPE_CENTAUR) this.outputText("stuffing your " + this.multiCockDescriptLight() + " inside your " + this.player.armorName, false);
            else this.outputText("your glorious but spent " + this.multiCockDescriptLight() + " dangling under your belly,", false);
    ...
    private nagaRapesPt2TheExtremeContinuationOfAwesome(): void {
        ...
        if (this.player.gender == 1 || (this.player.gender == 3 && BeeGirlScene.rand(3) == 0)) {
            ...
            //[if player has testicles]
            if (this.player.balls > 0) this.outputText("your " + this.sackDescript() + " clenches as ", false);
            this.outputText("you explode inside her chest, ", false);
            //[normal cum load]
            if (this.player.cumQ() < 50) this.outputText("a burst of cum settling itself in her belly.", false);
            //[medium cum load]
        ...
        //[Player is female]
            ...
            if (this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_WET) this.outputText("Damp", false);
            else if (this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_DROOLING) this.outputText("Wet", false);
            else if (this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLAVERING) this.outputText("Dripping", false);
            ...
            if (this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLICK) this.outputText("A few drops ", false);
            else if (this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_DROOLING) this.outputText("A gush ", false);
            else if (this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLAVERING) this.outputText("Wave after wave ", false);
        ...
        //[Player is herm]
            ...
            //[if Player cock => 12\"]
            if (this.player.cocks[0].cockLength > 12) this.outputText(", surprising you with its elasticity", false);
            ...
            if (this.player.totalCocks() > 1) {
                ...
                //[three or more]
                if (this.player.cockTotal() > 2) this.outputText("s, giving each a few pumps before moving on to the next", false);
    ...
    private layEggsInABeeSpiderLike(): void {
        ...
        if (this.player.faceType == FACE_SNAKE_FANGS || this.player.faceType == FACE_SPIDER_FANGS) this.outputText(", fanged");
