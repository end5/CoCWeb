...
export class TamainsDaughtersScene extends BaseContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        if (this.flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] > 40 && this.model.time.hours > 23 && this.model.time.days % 4 == 0) {
    ...
    public encounterTamanisDaughters(): void {
        ...
        if (this.flags[kFLAGS.TIMES_ENCOUNTED_TAMANIS_DAUGHTERS] > 0 && TamainsDaughtersScene.rand(10) == 0) {
            TamainsDaughtersScene.tamaniPresent = true;
            this.outputText("While roaming along, you find your path ahead blocked by " + TamainsDaughtersScene.num2Text(Math.floor(this.flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] / 4)) + " goblins.  At the forefront of the mob is Tamani", false);
        ...
        this.outputText(TamainsDaughtersScene.num2Text(Math.floor(this.flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] / 4)) + " goblins.  You ", false);
    ...
    private playDumbToTamanisDaughters(): void {
        ...
        if (this.flags[kFLAGS.TIMES_ENCOUNTED_TAMANIS_DAUGHTERS] == 1) this.outputText("first ", false);
    ...
    private fuckYoDaughtersHomie(): void {
        ...
        if (primary >= 0) {
            ...
            if (TamainsDaughtersScene.tamaniPresent) {
                ...
                if (this.player.balls > 0) this.outputText("cups your " + this.ballsDescriptLight() + ".", false);
            ...
            if (this.player.cumQ() >= 500) this.outputText(", bloating her belly until she gurgles and squishes on top of you", false);
            ...
            if (this.player.cor < 33) this.outputText("You were supposed to save the village from corruption, not breed tiny sluts to overrun it... y", false);
            else if (this.player.cor < 66) this.outputText("You came here to make things better for everyone... well, at least you're helping these girls. Y", false);
            else this.outputText("You came here to make things better, but you know you'll keep knocking up Tamani every chance you get.  It's too much fun to resist adding to the sea of green girls. Y", false);
            ...
            if (!TamainsDaughtersScene.tamaniPresent) this.outputText("your goblin daughter", false);
            ...
            if (daughters > 10) {
                ...
                if (this.player.balls > 0) this.outputText("Your balls visibly puff up and slosh as one of your daughters plays with them, filling with more seed than ever before.", false);
                else this.outputText("Your gut clenches painfully as something inside puffs up.  Pressure builds at the base of your cock and you realize somehow you're more full of cum than ever before.", false);
                this.outputText("\n\n", false);
                ...
                if (this.player.balls > 0) this.outputText(this.ballsDescriptLight() + " empty", false);
                ...
                if (daughters > 20) {
                    ...
                    if (TamainsDaughtersScene.tamaniPresent) this.outputText(" while Tamani walks away", false);
                    ...
                    if (daughters < 50) this.outputText("Girlish giggles sooth you to sleep as the crowd slowly disperses.", false);
                    else this.outputText("Girlish giggles sooth you to sleep as your body caves in to its fatigue.  The last thing you hear is the biggest daughter suggesting, \"<i>We should keep daddy around all the time...</i>\"", false);
                }
            }
            //(Normal end)
            if (daughters <= 20) {
                ...
                if (TamainsDaughtersScene.tamaniPresent) this.outputText(" and Tamani passionately frenches you.", false);
        ...
        //[DOESNT FIT]
            ...
            if (TamainsDaughtersScene.tamaniPresent) {
                ...
                if (this.player.tallness > 48) this.outputText("You can hear her climbing up on something behind you, in order to get to the right height.  ", false);
                ...
                if (this.player.balls > 0) this.outputText("  Your " + this.ballsDescriptLight() + " ache from the strain, but struggle to churn up more sperm.  ", false);
            ...
            //(No Tamani:
            if (!TamainsDaughtersScene.tamaniPresent) this.outputText("She presses something against your backdoor and before you have a chance to react, something hot and wet is filling your " + this.assholeDescript() + ".  You look down as she pulls out a tube of pink residue, and sways with burning desire.\n\n", false);
            ...
            if (!TamainsDaughtersScene.tamaniPresent) this.outputText("You're handed another bottle as t", false);
            ...
            if (!TamainsDaughtersScene.tamaniPresent) this.outputText("You shrug and drink it, ", false);
    ...
    private legTamanisDaughtersRAEPYou(): void {
        ...
        if (primary >= 0) {
            ...
            else if (cocks > 2) this.outputText("More and more hands latch onto the rest of your " + this.multiCockDescriptLight() + ", guiding each of them into a tight cunt-hole.   If you could see around the tight body of the slut on your face, you're sure the scene on your crotch would push you over the edge.", false);
            else this.outputText("You stiffen as a tongue suddenly presses against your " + this.assholeOrPussy() + " sliding inside and intensifying the feelings radiating down your fuck-pole until you're unable to hold on.", false);
            this.outputText("\n\n", false);
            ...
            else if (cocks == 2) this.outputText("your daughters' whorish expressions of pleasure", false);
            else this.outputText("the sultry gaze of Tamani's oldest daughter as she rides your " + this.cockDescript(primary), false);
            this.outputText(", you can do nothing but cum.  ", false);
            if (cocks > 1) this.outputText("Twitching powerfully, your body unloads into the tight, fertile cum-receptacles, giving them exactly what they want.", false);
            else this.outputText("Twitching powerfully, your body unloads into the tight, fertile cum-receptacle, giving her exactly what she wants.", false);
            if (this.player.cumQ() >= 1000) {
                this.outputText("  The near-supernatural amount of spooge you produce easily bloats ", false);
                if (cocks == 1) this.outputText("her belly until she looks a little pregnant", false);
                else this.outputText("each of their uteruses until they look a little pregnant", false);
            ...
            if (TamainsDaughtersScene.tamaniPresent) {
                ...
                if (this.flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] < 10) this.outputText("'Wait... wife... mistress?' your mind wonders, rejecting the foreign thoughts.  You look up at Tamani, confused for a moment", false);
                else this.outputText("Yes, that sounds so right – Tamani is your wife, and it's your husbandly duty to keep her pregnant.  You dwell on that for a moment", false);
                ...
                if (daughters < 20) this.outputText("the small pack of goblins is upon you, forcing liquids down your throat and making you fill cunt after cunt with sticky seed.", false);
                else if (daughters < 30) this.outputText("the pack of goblin daughters is upon you, forcing potent aphrodisiacs down your throat as you're raped for hours, forced to pack cunt after cunt full of jism.", false);
                else this.outputText("the massive group of goblins is on top of you, drugging and raping you over and over until you've had dozens of orgasms and licked off nearly as many cream-bloated sluts.", false);
            ...
            //NO TAMANI:  
                ...
                if (daughters < 20) {
                    ...
                    if (this.player.cumQ() < 100) this.outputText("as you twitch underneath her, emptying the last of your cum inside her.", false);
                    else if (this.player.cumQ() < 500) this.outputText("as you twitch underneath her, pumping her full of cum, thoroughly seeding her womb with spunk.", false);
                    else this.outputText("as you twitch underneath her in powerful spasms, blasting huge gouts of cum into her waiting body until her belly is bloated with seed and it begins to squirt out around you in time with each eruption of spunk.", false);
                    ...
                    if (this.player.cumQ() >= 500) this.outputText("  A few enterprising goblins gather around, gathering up the loose spunk and shoveling it into their holes.", false);
                    this.outputText("\n\n", false);
                ...
                //(MEDIUM PACK (or bigger))
                    ...
                    if (this.player.balls > 0) this.outputText("balls begin swelling, trembling as they visibly inflate, preparing a massive load of seed.", false);
                    else this.outputText("groin shifts uncomfortably, trembling as it begins preparing a massive load of seed.", false);
                    ...
                    if (daughters < 40) {
                        ...
                        if (this.player.balls > 0) this.outputText(this.ballsDescriptLight() + " hurt", false);
        ...
        //[NO FIT]
            ...
            if (!TamainsDaughtersScene.tamaniPresent) {
                ...
                if (cocks == 2) this.outputText("  Another one of the petite sluts climbs aboard your " + this.cockDescript(1) + ", squealing happily to her sister as she joins her in riding you.", false);
                if (cocks > 2) {
                    this.outputText("  A third, wearing slutty pink make-up with platinum blonde hair, lays out across your ", false);
                    if (cocks > 3) this.outputText("remaining " + this.multiCockDescriptLight(), false);
                ...
                if (cocks == 1) {
                    ...
                    //Cum stuff
                    if (this.player.cumQ() < 100) this.outputText("your orgasm ends, pulsing weakly inside the sloppy goblin flesh.", false);
                    else if (this.player.cumQ() < 500) this.outputText("your orgasm drags on, pumping the slut up until she looks slightly pregnant.", false);
                    else {
                        this.outputText("your orgasm drags on, splattering cum everywhere as you plump up the girl until she looks pregnant.", false);
                        if (this.player.cumQ() > 1000) this.outputText("  Seed gushes out her opening, actually pushing the goblin away as your orgasm splatters cum into the grass.", false);
                        if (this.player.cumQ() > 5000) this.outputText("  The other goblins frolic around in the stuff, greedily shoveling it into their dripping pussies with both hands as you form a small lake of seed.", false);
                    }
                }
                //Multi jizz scene
                else {
                    ...
                    //Orgazmo
                    if (this.player.cumQ() < 100) this.outputText("your orgasm ends, pulsing weakly inside the sloppy goblin flesh.", false);
                    else if (this.player.cumQ() < 500) this.outputText("your orgasm drags on, pumping the sluts up till they look slightly pregnant.", false);
                    else {
                        this.outputText("your orgasm drags on, splattering cum everywhere as you plump up the girls until they look pregnant.", false);
                        if (this.player.cumQ() > 1000) this.outputText("  Seed gushes out their openings, actually pushing the goblins away as your orgasm splatters cum into the grass.", false);
                        if (this.player.cumQ() > 5000) this.outputText("  The other goblins frolic around in the stuff, greedily shoveling it into their dripping pussies with both hands as you form a small lake of seed.", false);
                    }
                }
                this.outputText("\n\n", false);
                ...
                //(single)
                if (cocks == 1) this.outputText("The purple-lipped cock-slut grabs your " + this.cockDescript(0) + " and makes a show of smearing the slippery fluid over your shaft, lubricating it as she jacks you off.  Her warm lips form a tight seal on your " + this.player.cockHead() + " as the young goblin begins lapping at your pre-cum as she sucks it from your urethra.   It feels heavenly, and your " + this.hipDescript() + " pump weakly into the air in an instinctive bid to enhance the sensation.", false);
                //(multiple)
                else {
                    ...
                    if (cocks > 2) this.outputText("They spread out until every one of your " + this.multiCockDescriptLight() + " has at least one goblin hanging off it, stroking and touching you.  ", false);
            ...
            //[Tamani is There]
                ...
                if (this.flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] >= 10) this.outputText("wife", false);
                ...
                if (this.player.cor > 66) this.outputText("sigh, actually anticipating what's about to come", false);
                else if (this.player.cor > 33) this.outputText("don't resist, knowing there's no way to stop what's about to happen", false);
                ...
                else if (daughters < 35) this.outputText("we've got a lot of girls to fill up", false);
                else this.outputText("there's a TON of you here so you'll need to move quick if you each want a turn", false);
                ...
                //(SINGLE EXTRA)
                    ...
                    this.outputText("Meanwhile your other " + Appearance.cockNoun(CockTypesEnum.HUMAN) + " is wasting its spunk over your belly, so one of the waiting girls grabs it and pulls it to the side, ramming its tip deep inside her seemingly bottomless fuck-hole.  She giggle and runs their manicured nails over your ", false);
                    if (this.player.biggestTitSize() < 1) this.outputText("chest", false);
                    else this.outputText(this.allBreastsDescript(), false);
                    this.outputText(", circling your sensitive nipples", false);
                    if (this.player.biggestLactation() >= 1) {
                ...
                if (this.flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] > 10) this.outputText("She's the best wife ever.  You nuzzle deep into her cleavage, sighing happily.", false);
                else if (this.flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] > 5) this.outputText("She really is a great wife... wait, wife? You shrug away the thought and enjoy slowly motorboating her breasts.", false);
                else this.outputText("She really isn't that bad to you, is she?  You sigh and nuzzle against her jiggly love-pillows.", false);
    ...
    private tamaniDaughtersCombatLossDrain(): void {
        ...
        else this.outputText("Your abused body slips in and out of consciousness, but the crowd applies salves as they travel to slowly invigorate your form.  Their hands keep touching and stroking you, and despite your mighty efforts to resist, you find yourself aroused and willing in short order.", false);
        this.outputText("\n\n", false);
        ...
        if (this.player.lowerBody != LOWER_BODY_TYPE_CENTAUR) {
            ...
            if (cocks > 1) this.outputText(" things not restrained are your " + this.multiCockDescriptLight() + ", standing at attention despite, or perhaps because of, your predicament.\n\n", false);
            else this.outputText(" thing not restrained is your " + this.multiCockDescriptLight() + ", standing at attention despite, or perhaps because of, your predicament.\n\n", false);
        }
        //(Shit taurs go!)
        else {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00058] == 0) this.outputText("\"<i>Stop worrying.  I invented this while I was waiting on mom to bring me back more of your cum, just in case we ever got our hands on you.  I promise, after you've had a taste of my chair you'll never want to leave.</i>\"\n\n", false);
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00058] == 0) this.outputText("Time for your medicine!  We need you to cum enough for each of us, and maybe have a little left over to play with, so suck up the medicine, okay?  Just relax and let it fill you so that you give us all that yummy cummy!</i>\"\n\n", false);
        ...
        //EXHIBITIONISTZ
        if (this.flags[kFLAGS.PC_FETISH] > 0) this.outputText("unimaginably turned on by being used and abused by such machinery in front of an audience of your own horny children.", false);
        else if (this.player.cor > 60) this.outputText("turned on by being milked in such an obscene way.", false);
        else this.outputText("horrified at the situation but unable to resist arousal as you're constantly sucked and pleasured.", false);
        this.outputText("\n\n", false);
        ...
        if (this.player.balls > 0) this.outputText("Your balls tighten inside your sack and swell up like sponges, slowly increasing in size in time with your desire.", false);
        else this.outputText("Your body feels tight and needy, your gut clenching as your body adjusts to the drugs it's absorbing so readily through your " + this.assholeDescript() + ".", false);
        ...
        if (this.player.balls > 0) this.outputText("Straining and shaking, your " + this.ballsDescriptLight() + " clench against you, feeling tight as your body struggles to pump out the spooge they're producing.", false);
        else this.outputText("Straining and shaking , your body struggles through the orgasm as it tries to deal with all the cum your prostate and glands are putting out.", false);
    ...
    private tamaniDaughtersYesBadEndMePlease(): void {
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1) this.outputText("Exgartuan moans, \"<i>Ohhhhhh yeeeeaaaaahhhh...</i>\" before slipping into silence.\n\n", false);
    ...
    private loseToDaughtersWithTamaniThere(): void {
        ...
        if (this.player.HP < 1) this.outputText("Lying in the dirt, too hurt to fight back, you can only tremble in anticipation of what pleasures they're going to force upon you this time.", false);
        else {
        ...
        if (this.flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] < 2) this.outputText("It tastes syrupy-sweet", false);
        ...
        if (this.flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] > 10) this.outputText("Your body must remember how much it loves being my pussy-hungry husband.", false);
        else this.outputText("That's because your body knows how hot and moist Tamani's pussy is and how much you want to service it.", false);
        this.outputText("</i>\"\n\n", false);
        ...
        if (this.player.skinType == SKIN_TYPE_FUR) this.outputText(", matting your " + this.player.hairColor + " fur", false);
        this.outputText(" as she continues ", false);
        if (this.flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] < 10) this.outputText("filling your mind with truths", false);
        ...
        if (this.player.cumQ() < 50) this.outputText("Cum splatters and drips down Tamani's hand, forming a tiny puddle on your chest.", false);
        //(ALT)
        else if (this.player.cumQ() < 250) this.outputText("Cum splatters over Tamani's hand and forearm, even hitting her ass and hips as you form a thick puddle over your torso that drips to the ground.", false);
        //(ALT2)
        else if (this.player.cumQ() < 600) this.outputText("Cum splatters out in thick waves, soaking Tamani's hand, forearm, and hips with thick puddles of the stuff.  It pools on your belly for a moment, then rolls off you, forming a small pool on the ground as you keep squirting.", false);
        //(ALT3)
        else {
            ...
            if (this.player.cumQ() >= 2000) this.outputText("  Eventually it stops, but by then the pool is huge and nearly five inches deep.", false);
        }
        ...
        if (this.player.cockTotal() == 1) this.outputText("grab your " + this.multiCockDescriptLight() + " and stroke it with long slow strokes, just like their mother.  Unlike her, they don't seem content to wait, and in seconds a slippery gash is stretching to accommodate your cock-head.\n\n", false);
        else this.outputText("each grab one of your " + this.multiCockDescriptLight() + " and stroke it with long slow strokes, just like their mother.  Unlike her, they don't seem content to wait, and in seconds a slippery gash is stretching to accommodate each cock-tip.\n\n", false);
        ...
        if (primary < 0) {
            ...
            if (this.player.cockTotal() == 1) {
                ...
                if (this.player.cumQ() > 700) this.outputText("It gets everywhere as her womb fails to contain your massive load, even after you've bloated her belly with the stuff.", false);
                if (this.player.cumQ() > 2000) this.outputText("After a few more seconds the puddle from before gets even deeper, and your daughters kindly prop up your head to keep you from drowning in the jism pool.", false);
            }
            else {
                ...
                if (this.player.cumQ() > 700) this.outputText("It gets everywhere as their wombs fail to contain your massive load, even after you've bloated their bellies with the stuff.", false);
                if (this.player.cumQ() > 2000) this.outputText("After a few more seconds the puddle from before gets even deeper, and your daughters kindly prop up your head to keep you from drowning in the jism pool.", false);
            }
            this.outputText("\n\n", false);
        ...
        //(FITS)
            ...
            if (this.player.biggestCockArea() < 30) this.outputText(" in spite of the large sizes they usually handle.", false);
    ...
    private knockUpDaughters(): void {
        ...
        if (cum >= 50 && TamainsDaughtersScene.rand(2) == 0) this.flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        if (cum >= 100 && TamainsDaughtersScene.rand(2) == 0) this.flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        if (cum >= 200 && TamainsDaughtersScene.rand(2) == 0) this.flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        if (cum >= 300 && TamainsDaughtersScene.rand(2) == 0) this.flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        if (cum >= 400 && TamainsDaughtersScene.rand(2) == 0) this.flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
        if (cum >= 500 && TamainsDaughtersScene.rand(2) == 0) this.flags[kFLAGS.TAMANI_DAUGHTERS_PREGNANCY_COUNT]++;
