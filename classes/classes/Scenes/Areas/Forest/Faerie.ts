...
export class Faerie extends BaseContent {
    ...
    public encounterFaerie(): void {
        ...
        if (this.player.cockTotal() > 0 && (!this.player.hasVagina() || Faerie.rand(2) == 0)) {
            ...
            if (Faerie.rand(this.player.spe / 2) + this.player.statusAffectv1(StatusAffects.FaerieFucked) > 15) {
            ...
            if (this.player.lust >= 90) {
                ...
                if (this.player.cockTotal() == 1) this.outputText("your dick", false);
                else this.outputText("one of your dicks", false);
    ...
    private faerieRAEP(): void {
        this.spriteSelect(17);
        //Count secksins
        if (this.player.findStatusAffect(StatusAffects.FaerieFemFuck) < 0) this.player.createStatusAffect(StatusAffects.FaerieFemFuck, 1, 0, 0, 0);
        ...
        if (this.player.statusAffectv1(StatusAffects.FaerieFemFuck) == 1) this.outputText("She juices herself and screams, \"<i>Let me goooooooo,</i>\" trying to sound outraged instead of turned on, but the tiny girl's body gives away the lie.", false);
        else if (this.player.statusAffectv1(StatusAffects.FaerieFemFuck) <= 5) this.outputText("She juices herself and moans, \"<i>Stop teasing meeeeee,</i>\" doing her best to wriggle back against you, as if she could somehow impale herself on your digit.", false);
        else this.outputText("She squeals, rocking her hips back against you and moaning, \"<i>Ohhhh I love it when you do that,</i>\" grinding her incredibly small love-button on your digit.", false);
        //Special Taurness
        if (this.player.isTaur()) {
            ...
            if (this.player.clitLength >= 3) {
                ...
                //[Small amount of cum:
                if (this.player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_WET) this.outputText("The fae giggles more and more as the fluid seeps about her and your " + this.vaginaDescript(0) + " ripples. She hugs your " + this.clitDescript() + " tighter and starts gently gnawing at it, such a peculiar sensation that you cum suddenly, and wetly.  Her giggles quickly become all-out laughter, and she loses her grip on your clit, sprawling to the ground into a small puddle of femcum.\n\n", false);
                //[Normal amount of cum:
                else if (this.player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_DROOLING) this.outputText("The fae giggles more and more as the fluid squirts about her and your " + this.vaginaDescript(0) + " ripples. She hugs your " + this.clitDescript() + " tighter and starts gently gnawing at it, such a peculiar sensation that you cum suddenly, and wetly.  Her giggles quickly become all-out laughter, and she loses her grip on your clit, sprawling to the ground into a puddle of femcum.\n\n", false);
                //[Huge amount of cum:
                else this.outputText("The fae giggles more and more as the fluid sprays about her and your " + this.vaginaDescript(0) + " ripples. She hugs your " + this.clitDescript() + " tighter and starts gently gnawing at it, such a peculiar sensation that you cum suddenly, and wetly.  Her giggles quickly become all-out laughter, and she loses her grip on your clit, sprawling to the ground into a huge puddle of femcum, her giggling frame floating on the surface as her legs kick about erratically.\n\n", false);
            }
            //[All other clits:
            else {
                ...
                //[Small amount of cum:
                if (this.player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_WET) this.outputText("You cum suddenly, and wetly. The fae giggles more and more as the fluid seeps about her and your " + this.vaginaDescript(0) + " ripples. Her giggles quickly become all-out laughter, and she loses her grip on your innards, sprawling to the ground into a small puddle of femcum.\n\n", false);
                //[Normal amount of cum:
                else if (this.player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_DROOLING) this.outputText("You cum suddenly, and wetly. The fae giggles more and more as the fluid squirts around her and your " + this.vaginaDescript(0) + " ripples. Her giggles quickly become all-out laughter, and she loses her grip on your innards, sprawling to the ground into a puddle of femcum.\n\n", false);
                //[Huge amount of cum:
                else this.outputText("You cum suddenly, and wetly. The fae tries desperately to hold on to your " + this.clitDescript() + " but the amount of fluid overwhelms her and she's sent spiralling to the ground into a huge puddle of your fluid, her giggling frame floating on the surface as her legs kick about erratically.\n\n", false);
            }
        }
        //Non-Taurs
        else {
            this.outputText("\n\nYou release the lower portion of your " + this.player.armorName + ", revealing your aroused slit to the faerie.  ", false);
            if (this.player.statusAffectv1(StatusAffects.FaerieFemFuck) < 4) this.outputText("Her mood immediately shifts from panic to desire, and she licks her lips hungrily, locking her eyes onto your feminine folds.", false);
            else this.outputText("Her eyes open wide, like a junkie seeing a fix.  She licks her lips hungrily and humps the inside of your hand, ready for action.", false);
            ...
            if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_SLAVERING) this.outputText("releasing a tiny squirt", false);
            else if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_DROOLING) this.outputText("dribbling juices", false);
            else if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_WET) this.outputText("growing so slippery the faerie nearly loses her footing", false);
    ...
    private faerieDoNothing(): void {
        ...
        if (this.player.nippleLength >= 1) {
            ...
            if (this.player.hasVagina()) this.outputText("With your other hand you start diddling your " + this.vaginaDescript(0) + ", adding your own soft moans to hers.  ", false);
            this.outputText("A few blissful moments later, she shudders and you feel her uncontrolled spasms around your nipple.  ", false);
            if (this.player.hasVagina()) this.outputText("You join her shortly after.  ", false);
        ...
        if (this.player.clitLength >= 1.0 && this.player.clitLength <= 4.5 && this.player.hasVagina() && Faerie.rand(2) == 0) {
            ...
            if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_DROOLING) this.outputText("You drench the poor faerie completely in your female juices, soaking her hair and body. Overwhelmed and spent, you drop her to the ground and catch your breath. She licks up what's around her face, but is too weak to do anything else but lie in the dirt.\n\n", false);
    ...
    private faerieCaptureHJ(): void {
        this.spriteSelect(17);
        if (this.player.findStatusAffect(StatusAffects.FaerieFucked) >= 0) this.player.addStatusValue(StatusAffects.FaerieFucked, 1, 2);
        ...
        if (this.player.isTaur()) {
            ...
            if (this.player.cockTotal() > 0) this.outputText("largest " + Appearance.cockNoun(CockTypesEnum.HUMAN), false);
            ...
            if (this.player.balls == 0) this.outputText("Your tiny globules of semen go straight into her open mouth and she sucks them down gleefully before falling with a splat onto the pre soaked ground.\n\n", false);
                ...
                //[Normal amount of cum:
                else if (this.player.cumQ() < 200) this.outputText("Your semen washes into her face and she loses her grip on your " + this.multiCockDescriptLight() + ". She falls with a splat onto the pre soaked ground and you spray her with periodic spurts of fresh cum.\n\n", false);
                //[Huge amount of cum:
                else this.outputText("Your semen collides with her face and she is propelled off of your cock onto the pre soaked ground. Your " + this.ballsDescriptLight() + " continue pumping out cum like a hose until she's almost swimming in it.\n\n", false);
            }
            this.player.orgasm();
            this.dynStats("lib", -.5);
            //Epilogue!
            if (this.player.statusAffectv1(StatusAffects.FaerieFucked) < 10) this.outputText("The faerie burps and giggles again before glaring up at you, accusing you with a mildly unfocused glare and asking, \"<i>Did you know we get drunk on cum?  Caushe I TRY SO HARRD not to get meshed up like this.</i>\"\n\n", false);
            else if (this.player.statusAffectv1(StatusAffects.FaerieFucked) < 15) this.outputText("The faerie burps and laughs drunkenly, patting the side of your " + this.player.leg() + " and slurring, \"<i>Oh by Marae's ripe titsh!  I needed that.  Do you thhink you could catsch me again?  I love feeling your cum coating my body.</i>\"\n\n", false);
            ...
            if (this.player.statusAffectv1(StatusAffects.FaerieFucked) < 15) this.outputText("She licks her fingers and rolls around laughing, \"<i>Hehe, who caresh!  I'm happy! WHEEEEE!</i>\"\n\n", false);
        ...
        //Non-taurs
            ...
            if (this.player.hasKnot(0)) this.outputText("climbs atop your knot, wrapping her legs around the narrower shaft to hold on.  You can feel her cheeks resting atop the 'bulb' of your canine anatomy, teasing you with feminine features you're far too large to penetrate.  ", false);
            else if (this.player.cocks[0].cockType == CockTypesEnum.HORSE) this.outputText("climbs atop your " + this.cockDescript(0) + ", hanging onto your ring of prepuce and wrapping her legs as far around your horse-like maleness as she can.  ", false);
            else if (this.player.cocks[0].cockType == CockTypesEnum.DEMON) this.outputText("climbs atop your " + this.cockDescript(0) + ", hanging on to the corrupted nubs and nodules as she threads her legs between them, squeezing you tightly as she hangs on.  You can feel her wet gash sitting atop a particularly sensitive bump, teasing you with a tiny cunt you'll never be able to penetrate.  ", false);
            else if (this.player.cocks[0].cockType == CockTypesEnum.TENTACLE) this.outputText("climbs onto your squirming " + this.cockDescript(0) + ", wrapping her legs tightly around it as it wiggles and writhes with excitement.  Unbidden, it curls around and rubs its reddish-purple head against her face like an animal.  She gives it a gentle squeeze and licks it.  ", false);
            else this.outputText("climbs on to your hardness, wrapping her legs tightly around it as she secures a perch against you.   You can feel her wet gash rubbing against your sensitive skin, teasing you with a tiny cunt you'll never be able to penetrate.  ", false);
            ...
            if (this.player.cumQ() > 250) {
                ...
                if (this.player.cumQ() > 500) this.outputText("The proof of your release forms a puddle around you as your legs give out and y", false);
                else this.outputText("Falling backwards as your legs give out, y", false);
            }
            ...
            if (this.player.cumQ() > 500) this.outputText(" in the cum", false);
