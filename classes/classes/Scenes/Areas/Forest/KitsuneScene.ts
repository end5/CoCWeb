...
export class KitsuneScene extends BaseContent {
    ...
    private kitsuneSprite(): void {
        ...
        else this.spriteSelect(106);
    }

    //[Enter the Trickster] (Coded)
    public enterTheTrickster(): void {
        if (this.flags[kFLAGS.MET_KITSUNES] > 0) {
            this.willOWisp();
            return;
        }
        this.clearOutput();
        this.outputText("\"<i>H-help!</i>\"\n\n");
        this.outputText("You turn with a start as a woman bursts through the bushes, flinging herself into your arms.  It looks like she's been roughed up a bit - her simple peasant's robes are torn and frayed, and her forehead has a few smudges where it appears as though she was dragged through the dirt.\n\n");
        this.outputText("\"<i>Th-thank goodness!  Please, you must help me!</i>\"  she cries, darting around to take shelter behind you.  \"<i>I was out picking wild berries, and, and...  the wretched, terrible little things attacked me!</i>\"\n\n");
        this.outputText("You are about to question her, but are interrupted as an imp flies out of the thicket, growling and clawing at you menacingly.  At least...  clearly it's <i>trying</i> to be menacing.  The melodramatic display comes off as more hilarious than anything, but the woman cowering behind you obviously feels threatened, so you might as well deal with the pest.");
        // -> Standard Imp Battle
    ...
    public loseKitsuneImpFight(): void {
        ...
        if (KitsuneScene.rand(3) == 0) this.monster.hairColor = "blonde";
        else if (KitsuneScene.rand(2) == 0) this.monster.hairColor = "black";
        else this.monster.hairColor = "red";
        this.kitsuneSprite();
        this.outputText("As you fall to the ground in defeat, you look up to see the imp standing over you.  You prepare yourself for the worst, but are surprised to see the vile creature disappear in a puff of blue flames.\n\n");
        this.outputText("\"<i>Well...  that was...  easier than I thought.  Kind of boring, actually.</i>\"\n\n");
        this.outputText("The woman from earlier bends low over you, smiling bemusedly.  Before your eyes, her face, body, and clothing all begin to shift form.  Clad in a set of loose, revealing robes, she brushes her " + this.monster.hairColor + " hair out of her face, reaching up to straighten out her large triangular fox ears.  Six lustrous, bushy tails sway from side to side behind her, drawing your gaze hypnotically, and a generous layer of ornate tattoos follow the curves of her body.\n\n");
    ...
    public winKitsuneImpFight(): void {
        ...
        this.kitsuneSprite();
        this.outputText("\"<i>Oh, thank you, thank you!  I don't know </i>what<i> would have happened if you hadn't come along.</i>\"\n\n" + ((this.player.cor < 50) ? "As the imp falls at your feet, you lower your [weapon] and turn to the grateful woman.  Beating down an imp is really nothing special, but you were glad to be of assistance, and tell her as much with a friendly smile." : "You scoff haughtily, lowering your [weapon] and turning to the woman.  Beating down an imp was hardly worth your time, you tell her, crossing your arms in irritation.") + "\n\n");
        this.outputText("\"<i>My hero!</i>\"  she swoons, beaming.  \"<i>Oh, if there's </i>anything<i> I can do to repay you, please, tell me!</i>\"\n\n");
        this.outputText("You find yourself gazing deep into her eyes, a dim haze entering your mind as you are drawn deeper and deeper into the glistening green pools.  The corners of her lips curl into a broad smile as she starts to step toward you, and for a moment you swear you can see a subtle change in her.  You rub your eyes, certain they are playing tricks on you, slowly following the gentle sway of her six tails as she strolls up to you." + (((this.player.lust > 70) || (this.player.inte < 40)) ? "  Nope, nothing wrong here...\n\n\"<i>Mm...  my hero...</i>\" she croons again, reaching up to caress your cheek." : "\n\nWait.") + "\n\n");
        //PC saw through glamour
        if ((this.player.lust < 70) || (this.player.inte >= 40)) {
            this.outputText("You push her away, almost cracking your head open as you stumble over a stump.  Now that you have broken free of her sorcery, you can see her for what she is.  A pair of large triangular fox ears poke up from her ");
            if (this.monster.hairColor == "blonde") this.outputText("back-length, flaxen");
            else if (this.monster.hairColor == "black") this.outputText("ass-length, raven");
            else this.outputText("shoulder-length, crimson");
            this.outputText(" hair, six luxuriously furred tails fanning out behind her.\n\n");
        ...
        //With Religious BG:
            ...
            this.outputText("The instant she touches you, she recoils with a yelp, a brilliant flash temporarily blinding you both.\n\n");
            this.outputText("\"<i>Ow, ow, ow!</i>\"\n\n");
            this.outputText("When the spots clear from your eyes, the kitsune's glamour has been dispelled, revealing her for what she truly is.  A pair of large triangular fox ears poke up from her ");
            if (this.monster.hairColor == "blonde") this.outputText("back-length, flaxen");
            else if (this.monster.hairColor == "black") this.outputText("ass-length, raven");
            else this.outputText("shoulder-length, crimson");
            this.outputText(" hair, six luxuriously furred tails fanning out behind her.  A layer of ornate tattoos covers patches of her exposed flesh, accentuating her feminine curves nicely.\n\n");
    ...
    private followTheWillOWisp(firstTime: boolean = false): void {
        this.clearOutput();
        if (!firstTime) {
            this.outputText("The flame suddenly darts off into the darkness of the trees, and you find yourself unable to resist giving chase.  It feels as though you are being drawn to it by some otherworldly force, but every time your suspicions begin to grow, the flame pauses to float around you, tickling your erogenous zones and then pressing onward.");
            //+15 Lust
            this.dynStats("lus", 15);
        }
        if ((this.player.lust >= 100 || this.player.inte < 20) && !firstTime) {
            this.mansion(false, false);
        }
        //Else:
        else {
            this.kitsuneSprite();
            if (!firstTime) {
                this.outputText("You are unsure of how long you have been stumbling after the flame, but in a brief moment of clarity, you stop dead in your tracks and look around cautiously.  Suddenly you deeply regret having followed the flame this far out of your way.  Your skin crawls as you hear that eerie, ghostly laughter once again, making you shudder involuntarily.  As you turn to head back the way you came, you practically jump out of your " + this.player.skinFurScales() + " in surprise.  Mere inches from you stands a strange woman with ");
                if (this.monster.hairColor == "blonde") this.outputText("back-length, flaxen");
                else if (this.monster.hairColor == "black") this.outputText("ass-length, raven");
                else this.outputText("shoulder-length, crimson");
                this.outputText(" hair, smirking precociously.\n\n");
                this.outputText("\"<i>My, my, aren't we the clever one?</i>\"\n\n");
                ...
                this.outputText("\"<i>You resisted my illusions...  that's impressive,</i>\" she says, teasing you with her tails.  You back away from her, but give a start and wheel around when you feel yourself bump into something.\n\n");
            }
            this.outputText("\"<i>Going somewhere?</i>\"\n\n");
    ...
    private talkAfterResistingKitsunellusion(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("Odd as she is, she doesn't seem to be overtly threatening, so you decide to try to talk to her.  Searching for something to say, you end up simply asking her why she led you here.\n\n");

        //Blonde
        if (this.monster.hairColor == "blonde") {
            this.outputText("\"<i>Oh, that's not important, dear,</i>\" she says with a sly grin.  \"<i>You're here now, that's what's important...</i>\"\n\n");
            this.outputText("Since the conversation began, she has been watching you with a hungry look, strolling around you casually.  Every now and again she leans in, caressing you with her tails and giving you a decent angle down the front of her skimpy robes.\n\n");
        }
        //Black Hair
        else if (this.monster.hairColor == "black") {
            this.outputText("You blink, and she is upon you, her index finger circling its way across your chest.  She is practically hanging off of you as she says, \"<i>You're the catch of the day, cutie!  Mm-mm, and such a tasty-looking morsel.</i>\"\n\n");
            this.outputText("You're not sure whether to feel insulted or terrified at the prospect of her calling you food, so you settle on a mixture of the two.  Your eyes are drawn to her, though, as she strolls around, caressing you with her tails and leaning in to tease you with her ample bosom.\n\n");
        }
        //Redhead
        else {
            this.outputText("\"<i>Ah!  You caught me,</i>\" she says, feigning embarrassment.  \"<i>It's just so deliciously adorable the way you mortals stumble around in the woods...  I can hardly resist!</i>\"\n\n");
        ...
        //MERGE
        this.outputText("You twist away, trying to shake off the tingling sensations that are crawling across your body, impairing your ability to think rationally.\n\n");
        this.outputText("\"<i>Oh, you're no fun,</i>\" she says, smirking a bit as you pull away.  \"<i>Won't you come and play?  I promise that you won't be disappointed... my sisters and I will see to that.</i>\"\n\n");
    ...
    private leaveKitsune(talked: boolean = false): void {
        ...
        if (talked) this.outputText("Nervously, you thank her for her generous offer, but decline, turning to leave.");
        //if PC defeated her in combat
        else this.outputText("You turn to leave, ready to put some distance between yourself and the fallen trickster.");
        //MERGE:
        ...
        this.outputText("\"<i>I have something for you...</i>\"\n\n");

        this.outputText("She holds out a small white package tied with string, grinning eagerly.  You hesitate, wondering whether it would be wise to take a gift from this strange woman, but before you can protest, she shoves the package into your hands.  When you look up from the featureless wrapping, there is no sign of her save for the echo of a mischievous giggle through the trees.\n\n");
        this.outputText("<b>You have received a Kitsune's Gift!</b>\n");
        if (this.getGame().inCombat) {
            this.flags[kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.consumables.KITGIFT.id;
            this.cleanupAfterCombat();
        }
        else {
            //add Kitsune's Gift to inventory
            this.inventory.takeItem(this.consumables.KITGIFT, this.camp.returnToCampUseOneHour);
        }
    }
    ...
    private mansion(willing: boolean, firstTime: boolean = false): void {
        ...
        this.flags[kFLAGS.MANSION_VISITED]++;
        this.outputText("\n\n");
    ...
    private kitsuneMaleOrHermMansion(willing: boolean): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("\"<i>Let's just see what we have here,</i>\" the blonde says, sliding herself up to gently lift [eachCock] while licking her lips.  \"<i>Oh my, such vigor!</i>\"  the blonde exclaims, eagerly watching your " + ((this.player.cocks.length > 1) ? "shafts swell to their" : "shaft swell to its") + " full length and girth after just a little bit of stroking from her skillful hands.\n\n");
        this.outputText("Soft, velvety fur caresses your erogenous zones, more tails than you can count wrapping around every limb as plush lips kiss your exposed flesh.  Tongues of blue flame spark to life with a crackle like striking flint, licking along your body, sending ripples of pleasure coursing through you with every touch, drawing out more lust with each passing second.\n\n");
        this.outputText("Three tails envelop [eachCock], squeezing " + ((this.player.cocks.length > 1) ? "them" : "it") + " tightly, while several more constrict your limbs, binding you helplessly.  Your liquor-addled mind is too foggy by now to resist their advances, their disarming caresses breaking down your inhibitions and replacing them with lust and desire.  In unison, the fluffy appendages begin to pump up and down while the sisters continue to lavish you with affection, running their fingers " + ((this.player.hairLength > 0) ? "through your hair" : "across your scalp") + " sensually and teasing your neck with small, affectionate nips.\n\n");
        this.outputText("\"<i>Now for the main course...</i>\" the raven-haired kitsune whispers into your ear, gently nibbling on the outer edge.\n\n");
        this.outputText("The three tails recede from [eachCock] with an agonizing slowness as the black-haired girl lowers the voluptuous globes of her ass down against your " + this.cockDescript(this.player.biggestCockIndex()) + ".  Her hips rise and fall slowly, teasing the underside of your cock with the silky soft flesh of her rear, and the sight of her tattooed hindquarters gently cradling your prick sends fresh blood to your groin.  Your pleasure is only amplified when the blonde begins to stroke and knead it, casting you a sultry smirk as she lowers her lips toward the " + this.player.cockHead(this.player.biggestCockIndex()) + ".  Her soft tongue slides warmly along the top edge, traveling from base to tip and back again, each and every movement carefully measured and controlled to tease and excite you.\n\n");
        this.outputText("Her sensual licks send you into a spiral of pleasure, breaking through your intoxicated haze.  Overcome by lust, you lurch forward in a drunken lunge, bowling the trio over with a lecherous grin.  They yelp with surprise, laughing as you stumble into them, but as you come crashing down into the water on top they easily adjust to their new role, catching you in a net woven of silky tails and spreading their arms invitingly.\n\n");
        this.outputText("\"<i>Oh, you </i>beast<i>!</i>\"  the blonde cries teasingly, dragging her nails gently down the front of your [chest] with the snapping pop of sparks issuing from her fingertips.\n\n");
        this.outputText("You hike her up by the hips, hands travelling down across the gloriously wide curves and reaching around to grope her pillowy behind.  Her sisters crowd in around you, pressing their sizeable breasts against you and giggling coyly as their hands slowly travel up and down your sides.  As the redhead presses herself against you, you can feel a warm bulge pulsing against your " + this.hipDescript() + ".  You look down to find that she possesses a special something extra that her sisters seem to be lacking - and from the devilish grin on her face, you have an inkling of what she intends to do with it.\n\n");
        if (willing) {
    ...
    private kitSuneLetHerMansion(willing: boolean = true): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText(((willing) ? "You decide to let her have her fun, focusing your attention instead on her two lovely sisters.  While you were distracted with the redhead's \"assets\", it appears the precocious blonde and ravenette went ahead and started without you!" : "Your slurred protests fall on deaf ears, your head swimming with the haze of the many decanters of liquor you imbibed.  You move to push her away, but she catches your tipsy assault and gently leans up to give you a disarming peck on the cheek.  Though you try to mentally cling to the dispute, you find your cares gradually slipping away, until all you can focus on is the girl's two sisters, who appear to have started without you.") + "  The black-haired girl lies back, her face buried deep in the rippling flesh of the blonde's behind, slurping away at her dripping folds, while the blonde reciprocates from on top, pounding her sister's puffy pussy with her first two fingers.\n\n");
        this.outputText("The blonde's prodigious posterior bounces and jiggles as she pumps her hips up and down instinctively.  The quivering cheeks entice you, drawing you in almost hypnotizingly, and before you know it your " + this.cockDescript(this.player.biggestCockIndex()) + " is already " + ((this.player.balls > 0) ? "balls" : "hip") + "-deep in her slippery snatch.\n\n");
        this.outputText("The voluptuous fox-woman groans in pleasure as your " + this.cockDescript(this.player.biggestCockIndex()) + " plunges into her deepest fathoms, her warm flesh enveloping your hot prick and squeezing tightly as a rush of feminine fluids spills over the black-haired girl's face." + ((this.player.biggestCockArea() > 50) ? "  Her folds seem to stretch forever, swallowing your engorged tool like a bottomless pit of warmth and pleasure." : "") + "  Your hands sink deep into the pillowy mounds of her mountainous ass, mashing them together as you knead her cheeks like warm dough.\n\n");
        this.outputText("Slender fingers close around your " + this.hipDescript() + " as the redhead pulls herself tight against your [butt], attempting to line up against you while your pelvis mashes wildly against her sister's rippling rump.  Her cock slides up between your cheeks, dripping pre-cum that tingles on your flesh, and she finally manages to align herself to your ");
        if (this.player.gender >= 2) this.outputText(this.vaginaDescript());
        else this.outputText(this.assholeDescript());
        this.outputText(" and thrust in, spearing you on twelve inches of throbbing futa rod.  Buried to the hilt in your ");
        if (this.player.gender == 1) this.outputText("hindquarters");
        else this.outputText("warm folds");
        this.outputText(", she wraps her arms around you and drags her fingertips down your [chest], trailing azure sparks the entire way.");
        if (this.player.gender == 1) this.player.buttChange(14, true, true, false);
        else this.player.cuntChange(14, true, true, false);
        this.outputText("\n\n");
        this.outputText("Sandwiched between the two amorous kitsune, you shudder in pleasure, feeling the blonde's slick pussy squeeze and milk along your length while the redhead bucks up against your twitching hips with an animalistic fervor.  You feel something slick sliding along the " + ((this.player.hasSheath()) ? "sheath" : "base") + " of your " + this.cockDescript(this.player.biggestCockIndex()) + ", the black-haired kitsune's long tongue wrapping around and slurping the blonde's juices off of it hungrily." + ((this.player.balls > 0) ? "  Her pillowy lips press up against your " + this.ballsDescriptLight() + " lovingly, slurping loudly and humming through them with glee." : "") + "\n\n");
        this.outputText("The redhead's hands massage your lower body sensually, ");

        if (this.player.cocks.length > 1) {
            this.outputText("her palms caressing ");
            this.outputText("your remaining " + KitsuneScene.num2Text(this.player.cocks.length - 1) + " cock");
            if (this.player.cockTotal() > 2) this.outputText("s");
            this.outputText(" and squeezing tightly");
        }
        else this.outputText("circling your navel with her index finger and hugging her perky breasts into your back");
        this.outputText(" as she continues to pump into you forcefully.\n\n");

        this.outputText("The blonde's tight passage squeezes your rod tightly, holding you inside with a muscular contraction that forces you to slow your thrusting.  Her powerful pussy muscles release you abruptly, a wash of slippery fem juice rushing out around your " + this.cockDescript(this.player.biggestCockIndex()) + " to soak her sister's face.  The raven-haired girl laps it up happily, then retaliates by throwing her legs up around the blonde's neck and pulling her down into her crotch, making a wonderfully lewd face as the girl goes to work eating her out.\n\n");
        this.outputText("The redhead's pulsating member begins to throb and twitch in your ");
        if (this.player.gender >= 2) this.outputText(this.vaginaDescript());
        else this.outputText(this.assholeDescript());
        this.outputText(" as she builds up toward her climax.  You are nearing your limit as well, the act of holding back your own rising release causing your muscles to constrict around her swollen cock.  The forceful contractions of your ");
        if (this.player.gender >= 2) this.outputText("cunt");
        else this.outputText("rectum");
        this.outputText(" around her shaft sends her over the edge, and she begins to groan loudly in your ear, digging her fingertips into your " + this.hipDescript() + ".  Her turgid rod trembles in your ");
        if (this.player.gender >= 2) this.outputText(this.vaginaDescript());
        else this.outputText(this.assholeDescript());
        this.outputText(", a thick bulge passing through the shaft and erupting into your ");
        if (this.player.gender >= 2) this.outputText("slippery hole");
        else this.outputText("innards");
        this.outputText(" forcefully.  The thick cum hits your ");
        if (this.player.gender >= 2) this.outputText("womb");
        else this.outputText("intestines");
        this.outputText(" like ice water, then quickly turns into an aching warmth, sending shivers up your spine as the cloying seed rushes into your belly.  Your abdomen starts to expand into a bulging belly, the sloshing seed stuffing your insides and choking your passage with futa-sperm as she outpours a truly inhuman amount of jizz into you.\n\n");
        this.outputText("The pleasant pressure in your expanding belly pushes your pleasure to new extremes, and you begin mashing your pelvis into the blonde's quivering ass cheeks in pursuit of your glorious release." + ((this.player.biggestCockArea() > 80) ? "  She lurches forward, her fingers clawing at the wooden deck that runs along the edge of the pool, her entire body heaving with pleasure." : "  As you feel the coiling spring in your lower body near its limit, you suddenly feel the redhead's hand wrap around your " + this.cockDescript(this.player.biggestCockIndex()) + ".  She slyly leans over your shoulder, raising a finger to her lips and whispering to you, \"<i>Shh...</i>\"\n\nWithout warning, she yanks you back, pulling you from the blonde's quivering cunt just as you begin to climax, adjusting the angle quickly and bucking her hips forward to slam your twitching shaft into the blonde's ass!  The soft ring of her anus yields to the invasion with surprising ease, spreading open as if by reflex and then clamping shut around your base when your hips make contact with her quivering cheeks again.  She lurches forward, releasing a surprised gasp and nearly collapsing under your compulsory anal assault, her entire body heaving with a combination of shock and pleasure.") + "\n\n");
        if (this.player.cumQ() <= 150)
            this.outputText("A few virile streams spurt into her, sloppily smearing her " + ((this.player.biggestCockArea() > 80) ? "passage" : "intestines") + " with your thick load.  Her inner muscles squeeze you involuntarily, a deep crimson blush spreading across her cheeks as a thick spray of girlcum erupts from her pussy.  It splatters over the black-haired girl's face, and she opens her mouth to catch it all, pressing her plump lips against her sister's quivering cunt and drinking deeply as she hums a satisfied melody into her clitoris.");
        else if (this.player.cumQ() <= 350) this.outputText("Numerous streams spurt into her, sloppily smearing her tunnel with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft to draw your seed " + ((this.player.biggestCockArea() > 80) ? "toward her convulsing womb." : "deeper into her convulsing bowels.") + "  A deep crimson blush spreads across her cheeks as a thick spray of girlcum erupts from her pussy, splattering over the black-haired girl's face, and she opens her mouth to catch it all, pressing her plump lips against her sister's quivering cunt and drinking deeply as she hums a satisfied melody into her clitoris.");
        else if (this.player.cumQ() <= 1000) this.outputText("Thick ribbons of cum spurt into her, sloppily smearing her " + ((this.player.biggestCockArea() > 80) ? "passage" : "intestines") + " with your potent load.  Her inner muscles squeeze you greedily, massaging your shaft to draw your seed " + ((this.player.biggestCockArea() > 80) ? "toward her convulsing womb.  Her pussy" : "deeper into her convulsing bowels.  Her rectum") + " clenches involuntarily as your cloying seed erupts into her " + ((this.player.biggestCockArea() > 80) ? "quivering cunt and floods her passage" : "ass and floods her intestines") + ", a deep crimson blush spreading across her cheeks as a thick spray of girlcum erupts from her pussy.  It splatters over the black-haired girl's face, and she opens her mouth to catch it all, pressing her plump lips against her sister's quivering cunt and drinking deeply as she hums a satisfied melody into her clitoris.");
        else if (this.player.cumQ() <= 2500) this.outputText("Hot ropes of cum splash into her " + ((this.player.biggestCockArea() > 80) ? "slit" : "ass") + ", smearing her with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, thick streams spurting out of her hole as her stomach begins to distend into a jiggling round belly from the pressure.  Her " + ((this.player.biggestCockArea() > 80) ? "pussy" : "rectum") + " clenches involuntarily as your cloying seed erupts into her " + ((this.player.biggestCockArea() > 80) ? "quivering cunt and floods her passage" : "ass and floods her intestines") + ", her stomach expanding with a jiggle and hanging low and heavy with the weight of your seed.  A deep crimson blush spreads across her cheeks as a thick spray of girlcum erupts from her pussy, splattering over the black-haired girl's face, and she opens her mouth to catch it all, pressing her plump lips against her sister's quivering cunt and drinking deeply as she hums a satisfied melody into her clitoris.");
        else if (this.player.cumQ() > 2500) this.outputText("Hot waves of cum crest against her " + ((this.player.biggestCockArea() > 80) ? "cervix, flooding her womb" : "sphincter, flooding her ass") + " with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, pressurized streams erupting from her " + ((this.player.biggestCockArea() > 80) ? "snatch" : "butt") + " as her abdomen swells to an obscene size.  Her " + ((this.player.biggestCockArea() > 80) ? "pussy" : "rectum") + " squeezes you involuntarily as your cloying seed erupts into her " + ((this.player.biggestCockArea() > 80) ? "quivering cunt and floods her passage" : "ass and floods her intestines") + ", her stomach rapidly swelling into a heavy, gravid belly, sloshing audibly.  A deep crimson blush spreads across her cheeks as a thick spray of girlcum erupts from her pussy, splattering over the black-haired girl's face, and she opens her mouth to catch it all, pressing her plump lips against her sister's quivering cunt and drinking deeply as she hums a satisfied melody into her clitoris.");
        this.outputText("  After what certainly must have felt like an eternity, the blonde's climax begins to ebb, and she collapses fantastically on top of the ravenette.\n\n");

        this.outputText("Her warm " + ((this.player.biggestCockArea() > 80) ? "cunt" : "asshole") + " still grips your cock tightly, dragging you down with her.  You collapse on top of her, sliding off of the redhead's cock as you tumble into the golden curls of the blonde's hair.");
    ...
    private kitsuneShoveHerMansion(willing: boolean = true): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("In spite of your drunken stupor, you are just lucid enough to realize what is going on in time to stop her.  You plant your arm against her chest with a push, and she loses balance and tumbles into the water, kicking up foam.  She breaches the water with a rambunctious cry, inadvertently knocking her sisters off as she grapples with you in the steamy spring.  The surprised pair laughs and shields their eyes as you roll around in the water, tossing hot foam into the air.  When the crashing waves finally die down, you have the boisterous redhead pinned under your elbow against the side of the bath, [eachCock] grinding lewdly against the pillowy cheeks of her upthrust ass.  She struggles for a bit, but once she accepts that you have overpowered her, she slowly relaxes into a submissive state, her muscles relaxing and her ears slouching against the top of her head.\n\n");
        this.outputText("\"<i>F-fine...</i>\" she says quietly, rolling her eyes back in pleasure as you scratch behind her ears and run a finger coercively down her cheek." + (this.flags[kFLAGS.redheadIsFuta] > 0 ? "" : "  Reaching down between her legs, you nod in satisfaction as you feel her cock slowly receding, shrinking down into a pert, solid pleasure bud between her puffy lips.") + "\n\n");

        this.outputText("You let up on the disappointed kitsune a bit, running your fingers down her bare back and watching her shiver in pleasurable agony.  A small scratch applied to the base of her tails breaks down the last of her defenses, and she collapses against the wooden deck bordering the pool with a shuddering sigh.  Her sisters close in once again, brushing their tails up against your nude form and trailing their sparking fingertips across your " + this.player.skin() + " gently.");

        if (this.player.gender == 1 || ((this.player.gender == 3) && this.flags[kFLAGS.redheadIsFuta] == 0)) {
            this.outputText("\n\nThe blonde casually wades over to the redhead, planting her expansive rear down on her sister's back and reclining with a haughty smirk gracing her lips.  The poor redhead trembles under her weight, her cheeks flushed with unmet needs," + (this.flags[kFLAGS.redheadIsFuta] > 0 ? " neglected cock hanging low in the water," : "") + " tails fluttering back and forth between the blonde's legs while the flaxen-haired fox woman leads you on with a finger.  One of the blonde's tails winds around the " + ((this.player.hasSheath()) ? "sheath" : "base") + " of your " + this.cockDescript(this.player.biggestCockIndex()) + ", pulling it into the shimmering tangle of crimson and gold, and though the fluffy forest obscures your view, you can feel the " + this.player.cockHead(this.player.biggestCockIndex()) + " pressing up against the blonde's warm, inviting snatch.\n\n");
            this.outputText("Her tail coils and constricts around your member, drawing you forward to plunge into the waiting folds with a wet slurp." + ((this.player.biggestCockArea() > 50) ? "  Her walls draw you inward for ages, rippling sensually along your length as her cavernous cunt seems to go on forever.  Impossible though it might sound, it seems she intends to take ALL of you." : "") + "  She shudders with satisfaction as your hips lightly press against hers, legs spreading out and wrapping around your " + this.hipDescript() + " to draw you in as far as possible" + ((this.player.cocks.length > 1) ? ", [eachCock] entangled in a jungle of red and gold tails that caress and tickle them teasingly." : ".") + "  The redhead's tails flail sporadically, bristling with pleasure as your " + ((this.player.cocks.length > 1) ? "cocks slide" : "cock slides") + " through the sensitive coils, sending a shiver up her spine and a blush to her cheeks.\n\n");
            this.outputText("You feel something brushing against your " + this.player.legs() + " in the water and look down to find the black-haired girl wedging herself in between the redhead's legs, running her hands up and down her sister's voluptuous thighs and smacking her rear once for good measure.  The redhead lets out a startled cry and raises her hips dutifully as an angry red handprint resolves on her jiggling cheek, faintly visible against the large star-shaped tattoo that adorns it.  With new room to breathe, the black-haired girl raises her head against her sister's fiery crotch and begins to nuzzle it passionately, her plush, pillowy pink lips planting kisses along " + (this.flags[kFLAGS.redheadIsFuta] > 0 ? "the underside of her swollen cock." : "the moist cleft of her vagina.") + "\n\n");
            this.outputText("Holding the blonde's shapely hips, you begin to pump in and out of her hungry gash, moaning shamelessly from the pleasure of her tight, hot walls methodically squeezing your member.  Her marshmallowy breasts jiggle and flop against her chest as she is rocked back and forth over the redhead's back, her arms bending back to grip the deck for support.  She licks her lips hungrily, rolling her eyes back and groaning in ecstasy, playing up the pleasure to extremes in order to tease her sisters.  With expert timing she clamps her muscular snatch down against your " + this.cockDescript(this.player.biggestCockIndex()) + " just as you are about to pull back, sealing like a vice around the shaft such that an audible 'schliiick!' fills the air.\n\n");
            this.outputText("She giggles immaturely at the obscene noise, putting a hand over her mouth and flashing you a \"who, me?\" smirk.  Her slippery cunt flexes, skillfully drawing you back inside with a slurp and spurring you back to your wild thrusting.  Below, the black-haired girl has advanced from her teasing licks and begun to " + (this.flags[kFLAGS.redheadIsFuta] > 0 ? "suck lovingly on the tip of her sister's cock, moaning through the shaft hungrily." : "lap earnestly between her sister's folds, moaning into her slick snatch hungrily.") + "  Sandwiched between her sisters, the redhead trembles with pleasure, grinding her hips down into the hungry ravenette's face" + (this.flags[kFLAGS.redheadIsFuta] > 0 ? ", stuffing her cock down into her throat with a moan.  The gluttonous girl swallows it with glee, her throat bulging as the thick shaft passes through, gulping loudly and hungrily." : ", forcefully, smearing slick juices across the hungry ravenette's face.  The gluttonous girl laps up every drop, running her lengthy tongue up between the slippery folds and penetrating her with the tip.") + "\n\n");
            this.outputText("You edge closer and closer to your climax, shivering with pleasure as pressure builds in your " + ((this.player.balls > 0) ? this.ballsDescriptLight() : "prostate") + ".  The " + ((this.player.hasSheath()) ? "sheath" : "base") + " of your " + this.cockDescript(this.player.biggestCockIndex()) + " bulges outwardly as the first thick glob of cum swells through it, forcing its way into the blonde's unprotected womb.  ");
            if (this.player.cumQ() <= 150) {
                this.outputText("A few virile streams spurt into her, sloppily smearing her tunnel with your thick load.  Just as your potency begins to wane, you feel her golden tail constrict around your base, blocking the flow.  You groan deeply in protest as your shaft spasms dryly, her muscular snatch forcing you out with a loud 'plop!'  As the remainder of your seed builds up painfully behind her tail, she raises a finger to her lips, leering at you slyly.  Before you know what is going on, her tail directs your throbbing shaft downward and you feel yourself plunge into the redhead's " + ((this.player.biggestCockArea() > 80) ? "vagina!" : "defenseless anus!") + "  The unsuspecting girl lurches forward with a moan, and at the same time the blonde releases her grip on your " + ((this.player.hasSheath()) ? "sheath" : "base") + ", allowing your load to freely spill into her sister's tender " + ((this.player.biggestCockArea() > 80) ? "pussy. Her slit " : "butt. Her rectum") + " squeezes you involuntarily, her face caught halfway between shock and orgasmic pleasure.");
            }
            else if (this.player.cumQ() <= 350) {
                this.outputText("Numerous streams spurt into her, sloppily smearing her tunnel with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft to draw your seed toward her convulsing womb.  Just as your potency begins to wane, you feel her golden tail constrict around your base, blocking the flow.  You groan deeply in protest as your shaft spasms dryly, her muscular snatch forcing you out with a loud 'plop!'  As the remainder of your seed builds up painfully behind her tail, she raises a finger to her lips, leering at you slyly.  Before you know what is going on, her tail directs your throbbing shaft downward and you feel yourself plunge into the redhead's " + ((this.player.biggestCockArea() > 80) ? "vagina!" : "defenseless anus!") + "  The unsuspecting girl lurches forward with a moan, and at the same time the blonde releases her grip on your " + ((this.player.hasSheath()) ? "sheath" : "base") + ", allowing your load to freely spill into her sister's tender " + ((this.player.biggestCockArea() > 80) ? "pussy. Her slit " : "butt. Her rectum") + " squeezes you involuntarily as a final glut of seed erupts into her " + ((this.player.biggestCockArea() > 80) ? "passage" : "intestines") + ", her face caught halfway between shock and orgasmic pleasure.");
            }
            else if (this.player.cumQ() <= 1000) {
                this.outputText("Thick ribbons of cum spurt into her, sloppily smearing her tunnel with your potent load.  Her inner muscles squeeze you greedily, massaging your shaft to draw your virile seed toward her convulsing womb, thin streams messily spurting from her entrance as her abdomen begins to bulge from the pressure.  Just as your potency begins to peak, you feel her golden tail constrict around your base, blocking the flow.  You groan deeply in protest as your shaft spasms dryly,  her muscular snatch forcing you out with a loud 'plop!'  One particularly eager spurt of seed manages to escape and dribbles weakly down the tip, and as the remainder of your seed builds up painfully behind her tail, she raises a finger to her lips, leering at you slyly.  Before you know what is going on, her tail directs your throbbing shaft downward and you feel yourself plunge into the redhead's " + ((this.player.biggestCockArea() > 80) ? "vagina!" : "defenseless anus!") + "  The unsuspecting girl lurches forward with a moan, and at the same time the blonde releases her grip on your " + ((this.player.hasSheath()) ? "sheath" : "base") + ", allowing your load to freely spill into her sister's tender " + ((this.player.biggestCockArea() > 80) ? "pussy. Her slit " : "butt. Her rectum") + " squeezes you involuntarily as your cloying seed erupts into her " + ((this.player.biggestCockArea() > 80) ? "pussy and floods her womb" : "ass and floods into intestines") + ", her face caught halfway between shock and orgasmic pleasure as her stomach begins to swell slightly.");
            }
            else if (this.player.cumQ() <= 2500) {
                this.outputText("Hot ropes of cum splash into her womb, smearing her with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, thick streams spurting out of her entrance as her stomach begins to distend into a jiggling round belly from the pressure.  At the peak of your orgasm, you feel her golden tail constrict around your base, blocking the flow.  You groan deeply in protest as your shaft spasms valiantly, her muscular snatch forcing you out with a loud 'plop!'  The pressure in your " + ((this.player.balls > 0) ? this.ballsDescriptLight() : "prostate") + " is too great for her to hold all of it back, and a number of pressurized streams force their way by, streaking her body with hot seed.  She opens her mouth and happily catches an errant stream on her tongue, then raises a finger to her lips and leers at you slyly.  Before you know what is going on, her tail directs your throbbing shaft downward and you feel yourself plunge into the redhead's " + ((this.player.biggestCockArea() > 80) ? "vagina!" : "defenseless anus!") + "  The unsuspecting girl lurches forward with a moan, and at the same time the blonde releases her grip on your " + ((this.player.hasSheath()) ? "sheath" : "base") + ", allowing your load to freely spill into her sister's tender " + ((this.player.biggestCockArea() > 80) ? "pussy. Her slit " : "butt. Her rectum") + "  squeezes you involuntarily as your cloying seed erupts into her " + ((this.player.biggestCockArea() > 80) ? "pussy and floods into her passage" : "ass and floods her intestines") + ", her face caught halfway between shock and orgasmic pleasure as her stomach expands with a jiggle, hanging low and heavy with the weight of your seed.");
            }
            else if (this.player.cumQ() > 2500) {
                this.outputText("Hot waves of cum crest against her " + ((this.player.biggestCockArea() > 80) ? "cervix" : "sphincter") + ", flooding her " + ((this.player.biggestCockArea() > 80) ? "womb" : "anus") + " with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, pressurized streams erupting from her " + ((this.player.biggestCockArea() > 80) ? "snatch" : "pucker") + " as her abdomen swells to an obscene size.  At the peak of your orgasm, you feel her golden tail constrict around your base, trying in vain to stem the flow.  You groan deeply in protest as your shaft spasms violently, her muscular " + ((this.player.biggestCockArea() > 80) ? "snatch" : "pucker") + " forcing you out with a loud 'plop!'  The pressure in your " + ((this.player.balls > 0) ? this.ballsDescriptLight() : "prostate") + " is far too much for her to hold back, and her efforts only succeed in turning your eruptive streams into a sporadic shower of semen that streaks her front with a percussive patter.  She revels in the showering seed, happily catching a few streams on her tongue, then raises a finger to her lips and leers at you slyly.  Before you know what is going on, her tail directs your throbbing shaft downward and you feel yourself plunge into the redhead's " + ((this.player.biggestCockArea() > 80) ? "vagina!" : "defenseless anus!") + "  The unsuspecting girl lurches forward with a moan, and at the same time the blonde releases her grip on your " + ((this.player.hasSheath()) ? "sheath" : "base") + ", allowing your abundant load to freely splatter into her sister's tender " + ((this.player.biggestCockArea() > 80) ? "pussy" : "butt") + ".  Her " + ((this.player.biggestCockArea() > 80) ? "slit" : "rectum") + " squeezes you involuntarily as your cloying seed erupts into her " + ((this.player.biggestCockArea() > 80) ? "pussy" : "ass") + " and floods her " + ((this.player.biggestCockArea() > 80) ? "passage" : "intestines") + ", her face caught halfway between shock and orgasmic pleasure as her stomach rapidly swells into a heavy, gravid belly, sloshing audibly.");
            }
            this.outputText("\n\nThe sudden intrusion " + ((this.player.biggestCockArea() > 80) ? "" : "into her behind ") + "drives her over the edge in an instant, and soon your ears are met with the sound of hungry slurping.  " + (this.flags[kFLAGS.redheadIsFuta] > 0 ? "The black-haired kitsune swallows eagerly around her sister's engorged cock, slurping down stream after stream of thick futa-jizz.  She raises her hand up and slides two fingers into the girl's convulsing cleft, moaning in approval as the copious fountain of semen in her throat thickens even more.  Her other hand slowly massages her gradually expanding stomach, caressing the growing bulge while she pounds her fingertips into her sister's pussy, sucking out every creamy, salty morsel." : "The black-haired kitsune laps eagerly at her sister's convulsing pussy, a thick spray of girlcum splattering across her face as she tries her best to catch it in her mouth.  Her lips wrap around the girl's quivering cunt, and she begins to drink deeply from the viscous fountain, humming her pleasure the entire time.") + "  After what certainly must have felt like an eternity, the girl's climax begins to ebb, and she collapses fantastically beneath the blonde's weight with a splash, narrowly avoiding the raven-haired girl's face on the way down.\n\n");
            this.outputText("Her warm " + ((this.player.biggestCockArea() > 80) ? "cunt" : "asshole") + " still grips your cock tightly, dragging you down with her.  You collapse into the blonde's open arms, finding yourself pressed into the marshmallowy embrace of her mountainous breasts.  As your twitching cock relieves itself of the last of your seed inside the redhead's " + ((this.player.biggestCockArea() > 80) ? "pussy" : "ass") + ", you feel your strength slipping away from you with each spasm, your eyelids growing heavy with an uncommon weariness.\n\n");
        }
        else if ((this.player.gender = 3) && this.flags[kFLAGS.redheadIsFuta] > 0) {
            this.outputText("\n\nThe blonde casually wades over to the redhead, flipping her onto her back and sliding onto her sister's hips with a haughty smirk.  The poor redhead is pinned under her weight, flushing with wanton desire, her cock twitching needfully between the blonde's ass cheeks.  One of the blonde's tails winds around the " + ((this.player.hasSheath()) ? "sheath" : "base") + " of your " + this.cockDescript(this.player.biggestCockIndex()) + ", pulling it into the shimmering tangle of golden coils, and though a fluffy forest obscures your view, you can feel the " + this.player.cockHead(this.player.biggestCockIndex()) + " pressing up against the blonde's warm, inviting snatch.\n\n");
            this.outputText("Her tail coils and constricts around your member, drawing you forward to plunge into the waiting folds with a wet slurp." + ((this.player.biggestCockArea() > 80) ? "  Her walls draw you inward for ages, rippling sensually along your length as her cavernous cunt seems to go on forever.  Impossible though it might sound, it seems she intends to take ALL of you." : "") + "  She shudders with satisfaction as your hips lightly press against hers, a few of her tails lashing around your " + this.hipDescript() + " to draw you in as far as possible" + ((this.player.cocks.length > 1) ? ", [eachCock] entangled in a jungle of gold that caresses and tickles them teasingly." : ".") + "  The redhead's tails flail sporadically beneath her, bristling with pleasure as your " + this.vaginaDescript() + " slides across the tip of her cock teasingly, sending a shiver up her spine and a blush to her cheeks.\n\n");
            this.outputText("You feel something brushing against you and look down to find the black-haired girl pressing her face against your [butt], running her hands up and down your " + this.hipDescript() + " and smacking your cheek once lightly for good measure.  An involuntary shudder zigzags up your spine as her slick tongue runs up your crack, lining your [asshole] with saliva.  Her fingertips dig into the flesh of your bottom, the other hand sliding along your " + this.vaginaDescript() + ", pinching and rolling your " + this.clitDescript() + ".  A moment later, you rise an inch or two off the ground as a squirming invader spears your ass.  Her plush lips press against you like soft pillows, a muffled giggle vibrating up her tongue and into your prostate.  Your strength gives out as she prods your prostate, dragging you down with her weight at the same time to impale you on the redhead's cock.");
            //[virginity loss/ stretching, redhead is 12x2]
            this.player.cuntChange(24, true, true, false);
            this.outputText("\n\n");
            this.outputText("The redhead squeals with pleasure as her throbbing shaft spears your nethers, her hands rising up to the blonde's shoulders and digging into them passionately.  Caught between the blonde's sopping pussy, the redhead's cock, and the ravenette's swirling tongue, you are ensconced in such pleasure that you can no longer distinguish the source.  Your body bucks and trembles from the trio's indulgent onslaught, hips grinding and mashing against each other in a passionate spectacle.\n\n");
            ...
            this.outputText("She giggles immaturely at the obscene noise, looking back over her shoulder and flashing you a \"who, me?\"  smirk.  Her slippery cunt flexes, skillfully drawing you back inside with a slurp and spurring you back to your wild thrusting.  Pinned beneath the blonde, the redhead trembles with pleasure, grinding her hips upward into yours desperately, running her hands up and down her sister's back in pure ecstasy.\n\n");
            this.outputText("You edge closer and closer to your climax, shivering with pleasure as pressure builds in your " + ((this.player.balls > 0) ? this.ballsDescriptLight() : "prostate") + ".  The " + ((this.player.hasSheath()) ? "sheath" : "base") + " of your " + this.cockDescript(this.player.biggestCockIndex()) + " bulges outwardly as the first thick glob of cum swells through it, forcing its way into the blonde's unprotected womb.  ");
            if (this.player.cumQ() <= 150) {
                this.outputText("A few virile streams spurt into her, sloppily smearing her tunnel with your thick load.  Her inner muscles squeeze you involuntarily, a deep crimson blush spreading across her cheeks as a thick spray of girlcum erupts from her pussy.");
            }
            else if ((this.player.cumQ() > 150) && (this.player.cumQ() <= 350)) {
                this.outputText("Numerous streams spurt into her, sloppily smearing her tunnel with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft to draw your seed toward her convulsing womb, a thick spray of girlcum erupting from her pussy.");
            }
            else if (this.player.cumQ() <= 1000) {
                ...
                this.outputText("Hot ropes of cum splash into her womb, smearing her with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, thick streams spurting out of her hole as her stomach begins to distend into a jiggling round belly from the pressure.  Her cunt clenches involuntarily as your cloying seed erupts into her and floods her womb, her stomach expanding with a jiggle and hanging low and heavy against the redhead's abdomen with the weight of your seed, while a thick spray of girlcum erupts from her pussy.");
            }
            else if (this.player.cumQ() > 2500) {
                this.outputText("Hot waves of cum crest against her cervix, flooding her womb with your thick load.  Her inner muscles squeeze you greedily, massaging your shaft as it swells with virile seed over and over again, pressurized streams erupting from her snatch as her abdomen swells to an obscene size.  Her pussy squeezes you involuntarily as your cloying seed erupts into her quivering cunt, her stomach rapidly swelling into a heavy, gravid belly, sloshing audibly and pressing against the redhead's abdomen.");
            }
    ...
    private kitsuneStillHungryMansion(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("Just as you are about to slip out of consciousness, you are roused by the feeling of the kitsune pulling you from her sister's grasp, sliding you onto your back, and bending low over you.\n\n");
        this.outputText("\"<i>Still hungry...</i>\" she says softly, rubbing her chubby stomach gently, a quiet rumble issuing forth.\n\n");
        this.outputText(((this.player.balls > 0) ? "She exposes her upturned palms, rubbing them together for a moment and then blowing into them lightly.  With a snapping crackle, a bright blue flame bursts to life in her hands, and she presses her palms to your " + this.ballsDescriptLight() + ", massaging them gently." : "She extends her index and middle fingers, and with a snapping crackle, a bright blue flame bursts to life at her fingertips.  Before you can protest, your [butt] is invaded by her pyrotechnic digits, pressing against your prostate insistently.") + "  As the cooling tingle of her mystical flame spreads across your " + ((this.player.balls > 0) ? this.ballsDescriptLight() : "prostate") + ", you can feel a tense pressure building up, pleasure coursing through you as your spent stores of seed miraculously begin to replenish themselves, your flagging " + this.cockDescript(this.player.biggestCockIndex()) + " springing to readiness instantly!\n\n");
        this.outputText("Your rock-hard shaft is immediately engulfed in the soft embrace of the girl's breasts, the tip entrapped by the moist prison of her warm mouth.  A tongue of improbable length slides out of the girl's mouth, slathering saliva across your turgid rod and coiling around it with a tight squeeze.  Her plush pink pillows caress your " + this.player.cockHead(this.player.biggestCockIndex()) + " with a sensual suckling, drawing you inward and nibbling on the flesh delicately.\n\n");
        this.outputText(((this.player.biggestCockArea() < 70) ? "In a single stroke she swallows your shaft, her lips gliding all the way down to the hilt as her warm throat envelopes you, squeezing gently." : "She draws the shaft as far into her mouth as possible, her throat stretching around your head and pulling it in.  When she can swallow no more, she pauses to stabilize her breathing through her nose, then sighs contentedly.") + "  Her eyes roll back pleasantly and she glances up at you, the corners of her mouth curled up in a devious smirk, her tongue still curled around your stiff rod just past the edges of her lips.\n\n");
        if (this.flags[kFLAGS.redheadIsFuta] > 0) {
            this.outputText("A trembling moan shudders down your cock as the redhead wades by to join in the fun, giving her sister a light spank.  Her cock slides up between the busty ravenette's expansive buttocks, and then with a swift thrust, plunges into her soaked pussy.  Each time she thrusts forward, the black-haired girl groans with pleasure, her throat clenching around your cock wonderfully.  Ropes of spittle begin to slide down her chin as she is manhandled by her sister, her head bobbing back and forth on your rod as she squeezes her chest around it.\n\n");
        }
        else {
            this.outputText("Fingers trail delicately across your [chest] as the redhead slides in next to you, sparks flying from her fingertips as she encircles your " + this.nippleDescript(0) + ", eliciting a moan.  Her body presses against yours softly, one leg draping over your waist as she lays her head down and begins to run her tongue along the outer edge of your nipple.\n\n");
        }
        this.outputText("You are abruptly aware of a pair of hands caressing the sides of your head gently, your vision subsequently obscured by a pair of shapely cheeks adorned with a crescent moon tattoo that jiggle tantalizingly overhead before lowering toward your face.  The blonde's pussy kisses your lips, filling your nose with its sweet, musky aroma, while her hands lovingly caress the top of your head, pulling you against her crotch softly.  Her hips roll back and forth over your face, her bountiful butt jiggling and quivering with each motion as she grinds her sodden snatch into your lips.\n\n");

        this.outputText("Still overly sensitive from the exhilarating romp you had just taken part in, your " + this.cockDescript(this.player.biggestCockIndex()) + " begins to throb and twitch excitedly within the black-haired girl's throat, already being pushed to the limits of your endurance.  ");
        if (this.flags[kFLAGS.redheadIsFuta] > 0) {
    ...
    private kitsuneFemaleOrGenderless(willing: boolean): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("\"<i>Just relax, darling,</i>\" the blonde says in a crooning tone, sliding her hand down along your " + this.hipDescript() + " under the water.  Her silky-soft fingertips gently circles your " + ((this.player.gender >= 2) ? this.clitDescript() : this.assholeDescript()) + ", making you shudder.  Any reservations you still had are naught but memories now as you" + ((this.player.isBiped()) ? " spread your legs and" : "") + " give yourself over completely to her tender touch.\n\n");
        this.outputText("Your erogenous zones are caressed by numerous velvety tails, a few of them curling around your limbs to keep you from squirming around too much.  Plush lips kiss every inch of exposed flesh, while blue flames spark to life with the sound of striking flint to gently lick and swirl along your body, sending ripples of pleasure coursing through you.  Your liquor-addled mind is too foggy by now to resist their advances, their disarming caresses breaking down your inhibitions and replacing them with lust and desire.\n\n");
        this.outputText("One fingertip is shortly followed by a second, gently invading your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + " up to the second knuckle and making you moan and clench in pleasure.  Tender caresses slide down your [fullChest] as the sisters lavish you with affection - a gentle tweak here, a nip there, every action carefully measured to tease and arouse you.  The black-haired one carefully climbs on top of you, wrapping her lips around one of your " + this.nippleDescript(0) + "s and flicking it gently with her tongue." + ((this.player.lactationQ() > 0) ? "  She titters with excitement as your fresh cream begins to pour into her mouth, massaging your [chest] gently to stimulate the flow and drinking it down eagerly.\n\n\"<i>Mmmm...  So very tasty,</i>\" she says with a smirk, dipping down for another drink." : "Her teeth gently play along the tender flesh, sending shocks of pleasure through you.  Pale blue flames spread from the corners of her lips, elevating the pleasure even further, and you find it hard to stop shivering.") + "\n\n");
        this.outputText("You feel something warm prodding you in the side and look down to find that the redhead possesses a special something that her sisters are lacking - and from the devilish grin on her face, you have an inkling of what she intends to do with it.\n\n");
        if (willing) {
            this.outputText("<b>How do you respond?</b>");
            // display choices:
    ...
    private kitsunesGenderlessShoverHer(willing: boolean): void {
        ...
        this.outputText("\"<i>F-fine...</i>\" she says quietly, rolling her eyes back in pleasure as you scratch behind her ears and run a finger coercively down her cheek." + (this.flags[kFLAGS.redheadIsFuta] > 0 ? "" : "  Reaching down between her legs, you nod in satisfaction as you feel her cock slowly receding, shrinking down into a pert, solid pleasure bud between her puffy lips.") + "\n\n");
        this.outputText("You let up on the disappointed kitsune a bit, running your fingers down her bare back and watching her shiver in pleasurable agony.  A small scratch applied to the base of her tails breaks down the last of her defenses, and she collapses against the wooden deck bordering the pool with a shuddering sigh.  Her sisters close in once again, brushing their tails up against your nude form and trailing their sparking fingertips across your " + this.player.skin() + " gently.\n\n");
        this.outputText("The blonde casually wades over to the redhead, flipping her onto her back and settling down on her sister's hips with a haughty smirk.  The poor redhead is pinned under her weight, flushing with wanton desire, her " + ((this.flags[kFLAGS.redheadIsFuta] > 0) ? "cock twitching needfully between the blonde's ass cheeks." : "oversized clitoris rubbing against her sister's.") + "  One of the blonde's tails winds around the underside of your crotch, pulling you forward into the shimmering tangle of golden coils, and though a fluffy forest obscures your view, you can feel a humid warmth emanating from within it, mere inches away.\n\n");
        this.outputText("Her tails coil and constrict around your thighs, drawing you forward to press against her quivering lips while the tips sensually brush your sensitive nethers, sending light tingles up and down your spine.  " + ((this.player.clitLength > 4) ? "You groan a bit as you feel your " + this.clitDescript() + " gently slipping between the moist folds of her cunt, caressed on all sides by warm, wet flesh, the muscles squeezing down to conform to its shape perfectly.  " : "") + "She shudders with satisfaction as you lightly press against her, a few of her tails lashing around your " + this.hipDescript() + " to hold you tight.  The redhead's tails flail sporadically beneath her, bristling with pleasure as " + (this.flags[kFLAGS.redheadIsFuta] > 0 ? "your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + " slides across the tip of her cock teasingly" : "you are rubbed against her slavering slit") + ", sending a shiver up her spine and a blush to her cheeks.\n\n");
        this.outputText("You feel something brushing against you and look down to find the black-haired girl pressing her face against your [butt], running her hands up and down your " + this.hipDescript() + " and smacking your cheek once lightly for good measure.  An involuntary shudder zigzags up your spine as her slick tongue runs up your crack, lining your [asshole] with saliva.  Her fingertips dig into the flesh of your bottom, " + ((this.player.gender == 2) ? "the other hand sliding along your " + this.vaginaDescript() + ", pinching and rolling your " + this.clitDescript() + "." : "a fingertip gently tracing the curvature of your cheek as sparks snap and pop in its wake.") + "  A moment later, you rise an inch or two off the ground as a squirming invader spears your ass.  Her plush lips press against you like soft pillows, a muffled giggle vibrating up her tongue.  Your strength gives out as she prods your innards, " + (this.flags[kFLAGS.redheadIsFuta] > 0 ? "dragging you down with her weight at the same time" + ((this.player.gender == 2) ? " to impale you on the redhead's cock." : ", her tongue receding just as you are impaled on the redhead's cock.  The slick organ slides around the base of her cock, constricting tightly, and you can feel it swell as the veins and ridges become more pronounced.") : "and while you are at your most vulnerable, she twists two of the redhead's tails into a tight bundle, thrusting it into your " + ((this.player.gender == 2) ? "vagina." : "ass.")));
        this.player.cuntChange(24, true, true, false);
        this.outputText("\n\n");
        this.outputText("The redhead squeals with pleasure " + (this.flags[kFLAGS.redheadIsFuta] > 0 ? "as her throbbing shaft spears your " : "as her tails are thrust unmercifully into your ") + ((this.player.gender == 2) ? "cunt" : "ass") + ", her hands rising up to the blonde's shoulders and digging into them passionately.  Caught between the blonde's sopping pussy, the redhead's " + (this.flags[kFLAGS.redheadIsFuta] > 0 ? "cock" : "tails") + ", and the ravenette's swirling tongue, you are ensconced in such pleasure that you can no longer distinguish the source.  Your body bucks and trembles from the trio's indulgent onslaught, hips grinding and mashing against each other in a passionate spectacle.\n\n");
        this.outputText("Holding the blonde's shapely hips, you begin to grind against her slippery gash, moaning shamelessly as the heat washes over you.  She licks her lips hungrily, rolling her eyes back and groaning in ecstasy, playing up the pleasure to extremes in order to tease her sisters.  Smirking deviously, she raises an index finger into the air and presses it to your " + ((this.player.gender == 2) ? this.clitDescript() : "bare crotch") + ", a pale blue flame sending a spark of pleasure through you.\n\n");
        this.outputText("She giggles immaturely, tracing a small pattern of flames as she teases and toys with you.  Pinned beneath the blonde, the redhead trembles with pleasure, grinding her hips upward into yours desperately, running her hands up and down her sister's back in pure ecstasy.\n\n");

        this.outputText("You edge closer and closer to your orgasm, shivering with pleasure as tension builds in your lower body.  A sensual lick from the black-haired girl's tongue gives you the final push that you need, and your muscles clamp down in a frenzied climax, squeezing the redhead's " + (this.flags[kFLAGS.redheadIsFuta] > 0 ? "cock" : "tails") + " with all their strength.  " + ((this.player.wetness() == 5) ? "A viscous stream of femcum bursts forth from your loins, soaking the blonde and the redhead alike.  " : "") + "At the same time, you can feel the redhead's " + (this.flags[kFLAGS.redheadIsFuta] > 0 ? "shaft" : "tails") + " begin to twitch in your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + ", on the verge of her own climax.");

        if (this.flags[kFLAGS.redheadIsFuta] > 0) {
            this.outputText("\n\nThe blonde glances at you, raising a finger to her lips and leering slyly as one of her tails slithers down between the redhead's hips and your own.  The golden coil lashes around her sporadically twitching rod in a tight ring, and the explosive eruption of seed you were expecting never arrives.  The redhead's face is contorted into a tortured grimace, the base of her cock swollen with the cum backing up painfully behind her sister's tail.  The blonde only giggles, teasing the redhead with a fingertip on her forehead as she cinches her tail up even tighter.  The poor abused redhead trembles with need, groaning through clenched teeth as her orgasm continues to be denied, building up pressure by the second.\n\n");
            this.outputText("With a wry smirk, the blonde finally releases her from her torment, and the thick bulge in her cock swells through her shaft almost instantly, erupting into your womb in a salty, creamy deluge.  The virile onslaught sends shivers up your spine as it floods into your " + ((this.player.gender == 2) ? "uterus" : "innards") + " relentlessly, causing your abdomen to swell and bubble outward.  It inflates slowly, growing into a sloshing, engorged belly not dissimilar to a watermelon in size and proportion.  After what feels like an eternity, the girl's climax begins to ebb, and she collapses fantastically beneath the blonde's weight with a splash.  You follow soon after, slumping forward onto the blonde's chest in exhaustion.\n\n");
            this.outputText("The black-haired girl's slithering tongue coils around the base of the redhead's softening member, pulling it from your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + " with a 'plop!'  " + ((this.player.gender == 2) ? "A flood of seed begins to spill from your abused pussy, gushing over the redhead's groin and spreading into the water.  The flow is soon stemmed by the introduction of the black-haired girl's tongue, plush lips pressed against your cunt as she hungrily sucks down the outpouring of semen.  She gulps loudly and gluttonously, spreading your lips with her thumbs and swallowing every last delicious salty morsel, her stomach swelling and quivering as your own overfull abdomen begins to deflate in equal measure." : "As her cock slides out, a flood of seed begins to spill from your abused ass, gushing over the redhead's groin and spreading into the water and finally relieving the pressure in your abdomen.") + "\n\n");
            this.outputText("With each twitch and spasm of your muscles, you feel your strength slipping away from you with each spasm, your eyelids growing heavy with an uncommon weariness.\n\n");
        }
        else {
    ...
    private genderlessKitsuneStillHungry(willing: boolean): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("Just as you are about to slip out of consciousness, you are roused by the feeling of the black-haired kitsune pulling you from her sister's grasp, sliding you onto your back, and bending low over you.\n\n");
        this.outputText("\"<i>Still hungry...</i>\" she says softly, rubbing her chubby stomach gently, a quiet rumble issuing forth.\n\n");
        this.outputText("She exposes her upturned palms, rubbing them together for a moment and then blowing into them lightly.  With a snapping crackle, a bright blue flame bursts to life in her hands, and she presses her palms to your [chest], massaging gently.  As the cooling tingle of her mystical flame spreads across your chest, you can feel a tense pressure building up, pleasure coursing through you.  Your " + ((this.player.biggestTitSize() < 3) ? ((this.player.biggestTitSize() == 0) ? "flat chest begins" : "breasts begin") + " to swell, jiggling titflesh spilling out with a tense tingle until you are the proud new owner of a sizeable pair of C cups" : "breasts seem to plump up a bit, your nipples growing hard as a tense tingle spreads through them.") + "  You arch your back, clutching your chest as the tingling intensifies, an inferno of pleasure burning in your chest.  At the height of ecstasy, your milk begins to spurt from your nipples, flying into the air like a lewd fountain.\n\n");
        this.outputText("Your rock-hard nipples are immediately engulfed in the soft embrace of the girl's lips, entrapped by the moist prison of her warm mouth.  A tongue of improbable length slides out, slathering saliva across your swollen breasts and coiling around one of them with a tight squeeze.  Her plush pink pillows caress your nipples with a sensual suckling, drawing them inward and nibbling on the flesh delicately as your milk begins to flow down her throat.\n\n");
        if (this.flags[kFLAGS.redheadIsFuta] > 0) {
            this.outputText("A trembling moan shudders through your breasts as the redhead wades by to join in the fun, giving her sister a light spank.  Her cock slides up between the busty ravenette's expansive buttocks, and then with a swift thrust, plunges into her soaked pussy.  Each time she thrusts forward, the black-haired girl groans with pleasure, the humming sensation vibrating through your nipples pleasantly.  Ropes of spittle begin to slide down her chin as she is manhandled by her sister, her head thrust into your cleavage as she presses her own chest against you sensually.\n\n");
        }
        else {
            this.outputText("Fingers trail delicately across your [chest] as the redhead slides in next to you, sparks flying from her fingertips as she encircles your free " + this.nippleDescript(0) + ", eliciting a moan.  Her body presses against yours softly, one leg draping over your waist as she lays her head down and begins to run her tongue along the outer edge, warming you up for her sister.\n\n");
        }
        this.outputText("A shock of pleasure jolts through you as six golden tails press against your body, azure embers sensually sizzling against your skin.  The blonde giggles lightly as she teases you, her eyes full of mischief, one finger lightly tracing the underside of your jaw.  It's a simple gesture, but the way she does it makes you practically melt into her arms, more a slave to pleasure now than ever.\n\n");
        if (this.flags[kFLAGS.redheadIsFuta] > 0) {
        ...
        this.outputText("\"<i>Feed me...</i>\" the black-haired kitsune whispers, pulling away from your milky tits for just a moment.\n\n");
        this.outputText("The introduction of a spark of blue flame around your breasts enforces the request, and they give you no choice but to comply.  An unnatural pressure begins to fill them again, most certainly a result of the kitsune's prior witchery.  Your nipples puff up, thick, creamy hindmilk slowly working its way to the surface, flowing past her plump pink lips.  Your mind goes blank, vision popping with white spots as you moan orgasmically into the air.  Liter after liter of milk" + ((this.player.lactationQ() > 0) ? ", the thickest you've ever produced," : "") + " begins to flow down into the black-haired kitsune's gullet, eagerly swallowed without hesitation.  Twin streams burst from her nose as her cheeks bulge with milk, her lips clasped as tight as possible to contain as much as she can, while her belly continues to jiggle with added weight, sloshing and quivering as more and more of it flows down her throat.\n\n");
        this.outputText("As the four of you ride the waves of pleasure for what feels like ages, each passing second finds you more and more fatigued, and your eyelids grow heavier and heavier, muscles growing weak.\n\n");

        this.outputText("Exhausted by the ordeal, you relax into a blissful stupor, only vaguely aware of the feeling of being dragged onto the deck.  The last thing you recall before slipping into unconsciousness is the three sisters crawling up alongside you, proffering their twisted magics on your spent body.");
    ...
    private outro(tentacles: boolean = false): void {
        ...
        this.kitsuneSprite();
        this.dynStats("tou", -2);
        if (this.player.fatigue > 80 && this.player.fatigue < 100) {
        ...
        if (this.player.fatigue >= 100) {
            ...
            if (tentacles) this.outputText(" - at the very least, your groin seems to be back to its usual configuration");
            this.outputText(".  You sit up, but fall back almost immediately, groaning as the full weight of your hangover hits you like a ton of bricks.  It takes a long time before you can muster up the willpower to gather your things and head back to camp, but as you set out, you swear you could hear the sound of ghostly laughter echoing through the trees.\n\n");
            if (this.player.cumQ() < 10000 || (!this.player.hasCock() && this.player.lactationQ() < 10000)) {
                this.outputText("<b>Due to the residual effects of the sisters' magic, your ");
                if (this.player.hasCock()) {
                    this.outputText("cum ");
                    if (this.player.cumQ() < 500) this.player.cumMultiplier += 3;
                    if (this.player.cumQ() < 2000) this.player.cumMultiplier += 2;
                    if (this.player.cumQ() < 10000) this.player.cumMultiplier += 1;
                }
                else {
                    this.outputText("milk ");
                    if (this.player.lactationQ() < 500) this.player.boostLactation(3);
                    if (this.player.lactationQ() < 2000) this.player.boostLactation(2);
                    if (this.player.lactationQ() < 10000) this.player.boostLactation(1);
                }
                this.outputText("production has been enhanced.</b>");
            }
    ...
    private mansionBadEnd(): void {
        ...
        this.outputText("Your dreams are cut short as you awaken with a start, launching yourself bolt upright.  You are drenched in a frigid sweat, panting from an unexplained sense of dread that still has you in a panic.  The dread only worsens when you take stock of your surroundings.  For a moment you think you are back in Ingnam, but the unfamiliar surroundings push the notion from your mind as soon as it forms.  Neither are you in your bedroll in camp, however.  Gradually, you piece together the events of the previous night through the miserable pounding in your skull.\n\n");
        this.outputText("\n\nThe realization hits you like a bag full of rocks, and you spring to " + ((this.player.isBiped()) ? "your feet" : "action") + " immediately, leaping off the comfortable bed.  Your " + this.player.armorName + " are gone, replaced by exotic robes woven of fine silk.  What's more, you have no weapon to speak of!  Still reeling a bit from your hangover, you stumble out into the hallway, looking for a way out before the mansion's mysterious owners get wind of your egress.\n\n");
        this.outputText("Your muscles are filled with fatigue and soreness from the night's activities, and it feels as though you are carrying a rucksack full of lead on your shoulders.  Just how long were the three of them at it after you passed out?  By the throbbing pain you feel in your hips, it feels like must have kept going all night long.\n\n");
        this.outputText("You wander the meandering hallways of the manor for what feels like ages, searching for any sign of an exit.  At last, you find yourself in a familiar area, vaguely recalling passing through this room on the way to the banquet that the sisters had prepared for you.  Only now can you truly appreciate what a terribly foolish idea it was to accept food from the three mischief-makers.\n\n");
        this.outputText("Escape is in sight, the front door coming into sight as you round the corner.  The hallway seems to stretch on for eternity as you make a beeline for the exit, the door never coming any closer.  A sinking feeling enters the pit of your stomach as your hope of escape is squashed with just four words.\n\n");
        this.outputText("\"<i>Leaving so soon, dear?</i>\"\n\n");
        this.outputText("You wheel around to face the manor's three mistresses, beckoning to you with offerings of food and drink in hand.  Though their expressions are innocently jovial, they carry an air of malevolence as they slowly close in on you.\n\n");
        this.outputText("\"<i>Won't you stay just one more night?  You can rest your weary bones, and drink your fill...</i>\"\n\n");
        this.outputText("You decline their offer, continually backing your way toward the door.  When they are no more than an arm's length away, you make a break for it, spinning in place and dashing madly toward the door - but alas, your ill-fated escape attempt meets with dismal failure.  No sooner have you turned away then you face them once again, and this time they block your escape.\n\n");
        this.outputText("\"<i>Please, be our guest....  It gets so lonesome out here, just the three of us...</i>\"\n\n");
        this.outputText("Throwing caution to the wind, you rush them, pushing past and barging through the door, filling your lungs with the fresh breath of freedom.  What meets you on the other side makes your heart sink, for you find not the open air of the courtyard, but another stretch of hallway, identical to the one you just left.  There to meet you beyond the threshold are the three kitsune, their lips pursed in identical smirks.\n\n");
    ...
    private fightSomeKitsunes(): void {
        this.clearOutput();
        this.outputText("Something just doesn't sit right with you about this woman, and you cautiously raise your " + this.player.weaponName + ", watching her carefully.\n\n");
        this.startCombat(new Kitsune(this.monster.hairColor as "blonde" | "black" | "red"));// TODO refactor
        this.kitsuneSprite();
        //Blonde
        if (this.monster.hairColor == "blonde") this.outputText("\"<i>Ah, so we're going to play like that, are we?</i>\"  she says with a grin, making a small clawing motion in the air.  \"<i>Very well my darling, if that's how you want it, but I won't be taking it easy on you just because you're cute~.</i>\"");
        //Black Hair
        else if (this.monster.hairColor == "black") this.outputText("\"<i>Oh, dear...  are you sure you can't just spare the tiniest morsel?  I'm so hungry...</i>\"\n\nShe licks her lips to accentuate this, rubbing her stomach.  You however, have no intention of being made a meal, or whatever it is she intends to do with you.\n\n\"<i>Well, I guess it can't be helped,</i>\" she says, pursing her lips impishly.");
        //Redhead
        else {
            this.outputText("\"<i>Oh, you're not going to make this easy for me, are you?</i>\"");
        ...
        if (this.monster.hairColor == "blonde") this.outputText("blonde");
    ...
    public loseToKitsunes(): void {
        ...
        //Shared Scenes
        // For Males and Herms
        if (this.player.hasCock()) scene.push(this.loseFightToHerms);
        // For Females and Genderless
        if (this.player.gender != 1) scene.push(this.femalesAndNuetersLoseToKitsunes);
        //Blonde-exclusive
        //Single cock < 9 inches long
        if (this.monster.hairColor == "blonde" && this.player.cockTotal() == 1 && this.player.longestCockLength() < 9) {
            scene.push(this.blondeKitsuneRapesSmallWangs, this.blondeKitsuneRapesSmallWangs, this.blondeKitsuneRapesSmallWangs, this.blondeKitsuneRapesSmallWangs);
        }
        //Black-hair-exclusive
        //Lose while lactating
        if (this.monster.hairColor == "black" && this.player.lactationQ() >= 50) {
            scene.push(this.loseToBlackHairLatexWhileMilky, this.loseToBlackHairLatexWhileMilky, this.loseToBlackHairLatexWhileMilky, this.loseToBlackHairLatexWhileMilky);
        }
        // lose, requires balls and cumQ() > 1000
        if (this.player.hasCock() && this.player.balls > 0 && this.player.cumQ() > 1000) {
            scene.push(this.loseToKitsunesWithBallsAndHighCumQ, this.loseToKitsunesWithBallsAndHighCumQ);
        }
        //Redhead-exclusive
        //Futa rape - chance increases as redhead's lust increases
        if (this.monster.hairColor == "red") {
            scene.push(this.getRapedByRedHeadFutaKitsune);
            if (this.monster.lust > 50) scene.push(this.getRapedByRedHeadFutaKitsune);
            if (this.monster.lust > 70) scene.push(this.getRapedByRedHeadFutaKitsune);
            if (this.monster.lust > 85) scene.push(this.getRapedByRedHeadFutaKitsune);
        }
        scene[KitsuneScene.rand(scene.length)]();
    }
    ...
    private loseFightToHerms(): void {
        ...
        this.outputText("Humming quietly, she carefully removes your " + this.player.armorName + ", neatly arranging them into a pile and shoving them off to the side.  Eying your nude form hungrily, she begins to slowly trail her hands down your [fullChest], letting her fingertips cascade over every ridge and curve of your body while painting streaks of dazzling fire across your flesh.  Her touch sends tingles up and down your spine, making you shiver and moan involuntarily.  Slowly but surely her hands work their way down toward your loins, teasing around your [hips] very gently" + ((this.player.isBiped()) ? ", tickling the insides of your thighs" : "") + " before trailing up to your " + ((this.player.gender >= 2) ? "rapidly moistening cleft.  Her fingers dance along the inside of your labia, circling the entrance and nearly - but never quite - pushing a fingertip inside, snickering in satisfaction as you release a small rush of fluids into her palm.  She glides the tip of one of her tails across your [clit] delicately, like a feather, before turning her attention to her real prize, your " : "") + "gradually hardening [cock biggest].\n\n");
        this.outputText("Holding you firmly around the " + ((this.player.hasSheath()) ? "sheath" : "base") + ", she crawls the fingers of her free hand up and down the shaft, marking the underside with tiny beads of flame that spark and tingle incredibly as they lick across your rigid rod.  It doesn't take but a few moments of this treatment before you are teetering on the edge, but the skillful seductress has other plans for you, and dials back the pleasure mere moments before your release.\n\n");
        this.outputText("\"<i>Oh no dear, the fun's only just begun,</i>\" she says with a mock chastising tone, smirking mischievously.\n\n");
        this.outputText("Quick as lightning, three of her tails lash forward and lasso your cock tightly, wrapping and sliding around the shaft with their remarkably soft fur.  The shimmering coils move up and down your member at a slow, teasing pace, squeezing and twisting gently to drag you toward the edge of pleasure, each time letting you drift back down before resuming their wonderful torture.\n\n");
        this.outputText("Her tails continue to operate independently as she crawls up over you, setting her soft, cushiony behind on your [hips] and scooting backward until [eachCock] is enveloped in the warm globes.  Two tails curl up and gently lift the hem of her robe to expose the soft, jiggling flesh of her ass, and she wiggles her hips teasingly to make the huge cheeks quiver lightly around your [cock biggest].  Sliding her hands down her shoulders and over the jiggling mounds of her breasts, she hooks her fingers into her robes and drags them down so that her perky nipples are just barely contained.  With an agonizing slowness, she strips out of her robes, watching you the entire time and laughing seductively at your reactions to her teasing display.  With her clothes tossed aside and out of the way, you have a full view of her young, lithe body, " + ((this.monster.hairColor == "blonde") ? "flowing golden locks cascading over her toned, voluptuous hourglass shape." : ((this.monster.hairColor == "black") ? "a slight pudge around her belly accentuating her voluptuous figure." : "your eyes drawn immediately down to the pulsating, foot long member that now lays across your stomach.")) + "  Grinning coyly, she strikes an alluring pose and leers at you through half-lidded eyes, one corner of her mouth curled up in a mirthful smirk.\n\n");
        this.outputText("\"<i>Mm...  getting all hot and bothered dear?</i>\"  she says, almost in a whisper, her voice dripping with seduction.\n\n");
        ...
        this.outputText("Her magic flows through your body, permeating your extremities and filling you with a shivering, shuddering lust.  You forget in short order that you are the unwilling participant in this conniving trickster's game, rationality subverted by baser instincts.  The heat of her loins emanates around your [cock biggest], and all you can think about is that glorious, ecstatic moment of penetration.  Surely, it will come soon.  Surely, she can't tease you like this forever...\n\n");
        this.outputText("The tip of her tongue pokes out between her teeth as she carefully raises and lowers her hips, caressing your shaft in the warm valley between her two fleshy cheeks.  Her pace is slow and methodical, perfectly metered to keep you teetering constantly on the edge and yet never quite enough to push you over it.\n\n");
        this.outputText("\"<i>Oh, you poor thing,</i>\" she croons, watching your face contort into a grimace of shameless desire.  Why won't she get on with it already!?  She swats your hands away as you reach up to try to assert control of the situation, two tails curling forward to bind your wrists.  \"<i>Naughty naughty!  You can look, but </i>I'll<i> be the one who does the touching today, dear.</i>\"\n\n");
        this.outputText("You struggle against her bushy coils, but to no avail.  Staring into the limpid green pools of her eyes, it becomes abundantly clear that physical resistance is going to get you nowhere - her hypnotic sorcery has left your muscles sapped of strength, hanging uselessly in the grip of her tails.  Her fingers slowly dance across your [chest] again, drawing intricate patterns of flame down your front and giggling.  You breathe in sharply as she finally begins to raise her hips, sliding the warm, wet cleft of her pussy across your shaft.  Your excitement builds steadily as her moist lips spread around the [cockHead biggest] of your [cock biggest], feminine juices dripping down the side of your shaft slowly.  A moan escapes your lips as she rocks her hips forward and back, circling her entrance with the tip of your member while grinning at you slyly.\n\n");
        this.outputText("\"<i>You want this, huh?  You want it bad?</i>  she teases, putting the tiniest bit of pressure onto your throbbing member.  The head of your cock presses against the tight ring of muscle at her entrance, on the very precipice of penetration, but the kitsune seems to enjoy torturing you immensely, never quite allowing you passage.\n\n");
        this.outputText("You whimper with need as she slides herself back down the underside of your shaft, pinning your cock to your front and grinding her hips forward and back slowly.  Back and forth she slides, the stiff bud of her clit tickling your rod gently as she continues to tease you, grinning with an almost sadistic glee.  The slick juices from her sopping cunt flow over the edges of your shaft, coating you in a thin layer of lubricant in short order" + ((this.monster.hairColor == "red") ? ", while a trickle of precum flows from the tip of her throbbing cock, threads of viscous fluid dripping onto your stomach" : "") + ".\n\n");
        this.outputText("Your eyes roll back in your head and you moan desperately, struggling in vain to thrust your hips upward to give you the push you need to finally finish.  Just as you are sure you'll go out of your mind with pleasure, she slides herself forward, leaning down and grabbing your shoulders while kissing you deeply.  You feel her tails sliding up beneath your cock, lifting it into position, and then your vision explodes into a sea of colors as the intense pleasure of entering her pussy is finally, gloriously given to you." + ((this.player.biggestCockArea() > 50) ? "  There's no possible way that she could fit something of that size inside her comfortably, and yet somehow she does it with ease, inch after inch of warm, incredibly tight pussy flesh stretching to accommodate your massive member." : "") + "  Her hips slide back until they are even with yours, your cock entirely ensconced in the soft, wet warmth that is her vagina.\n\n");
        this.outputText("Her tongue plunges into your mouth passionately as she begins to ride up and down on your [cock biggest], a single tail curled around your " + ((this.player.hasSheath()) ? "sheath" : "base") + " tightly.  Blood rushes into your groin with no escape, making your member swell up within her pussy and intensifying the already incredible feelings of her muscles carefully squeezing and constricting around you.  Tongues of blue flame lick across your " + this.player.skinFurScales() + " as her tails paint sparks along your body like a set of artist's brushes, making you shiver with pleasure.  Each time she draws herself forward off of your cock, powerful muscles squeeze your shaft tightly, rippling across your entire length and then drawing you back inside.\n\n");
        this.outputText("The pleasure proves too much to bear, even more so after her incessant teasing, and it doesn't take long before you feel your " + ((this.player.balls > 0) ? this.ballsDescriptLight() : "prostate") + " swelling with the pressure of your climax.  The tail around your " + ((this.player.hasSheath()) ? "sheath" : "base") + " tightens up considerably, and the kitsune begins to ride you with an even fiercer passion, her expansive cheeks making loud slapping noises each time they slam down on your [hips].\n\n");
        this.outputText("\"<i>Almost, dear!  Mn, just a bit, ah!  More...</i>\"\n\n");
        this.outputText("She leans back and supports herself on your chest, thrusting her hips and mashing her pelvis down against yours with a passionate ferocity that has her breasts bouncing " + ((this.monster.hairColor == "red") ? "and her cock flopping " : "") + "up and down shamelessly.  Her pussy wrings your cock powerfully from " + ((this.player.hasSheath()) ? "sheath" : "base") + " to tip, each rippling motion of her insides caressing you on all sides with an inhuman level of control and skill.  Her pace continues to climb as her own orgasm builds, eyes rolling skyward as she grinds down more forcefully than ever, heedless of your desperate pleas for release." + ((this.monster.hairColor == "red") ? "  As her orgasm draws near, one of her tails curls forward and begins to stroke her cock, drops of salty precum splashing across your lips." : "") + "  With a satisfied shudder, she arches her back, dropping her hips down onto you one last time, and moans in euphoric ecstasy, her tails unwinding from around your limbs.  A rush of fluid drenches your waistline, " + ((this.monster.hairColor == "red") ? "hot streams of cum spurting from her twitching cock and laying streaks of pearly white across your face, neck, and chest." : "a warm spray of femcum arcing from her pussy to spatter across your face, neck, and chest.") + "\n\n");
        this.outputText("As her climax tears through her, her tail slackens its grip around your " + ((this.player.hasSheath()) ? "sheath" : "base") + ", and you are finally able to achieve release from your torment, your thick load rushing up your shaft to explode into the kitsune's quivering loins.  ");
        if (this.player.cumQ() <= 150) {
            this.outputText("Hot, sticky streams spurt up into her, painting her womb white with your cum.  Her walls squeeze and milk your shaft, greedily pulling out every last drop of seed you have to offer.");
        }
        else if (this.player.cumQ() <= 350) {
            this.outputText("Hot ribbons of cum splatter against her cervix, bubbling up into her womb.  Her walls squeeze hard, a muscular rippling drawing every last drop of seed from your shaft and milking it hungrily.");
        }
        else if (this.player.cumQ() <= 1000) {
            this.outputText("Your cock swells from base to tip with each new stream of cum, filling her womb with your warm, potent seed.  Her pussy squirms and squeezes around your cock, milking you for all you're worth.  As more of your frothing jism flows into her, a small bump forms in her belly, stretching out into a gentle curve.");
        }
        else if (this.player.cumQ() <= 2500) {
            this.outputText("A glut of semen rises through your throbbing shaft, erupting into her womb like a sticky white volcano.  Her pussy convulses and squeezes around you, milking your shaft powerfully and sucking out every last drop of your sticky jism.  With every fresh stream that flows into her, her belly expands a bit more, swelling out into a nice, jiggly bulge.");
        }
        else {
            this.outputText("Thick, virile streams of cum swell through your cock, splattering across her walls and flowing into her womb like a river.  As your cock throbs and twitches inside her, her pussy squeezes and convulses powerfully, funneling every drop upward toward her womb.  Her abdomen swells outward, ballooning into an obscene, jiggling sphere that sloshes with the weight of your inhuman load.");
        }
        this.outputText("\n\nSighing deeply in utter satisfaction" + ((this.player.cumQ() > 350) ? " with one hand resting on her stomach" : "") + ", she leans back, swiveling her hips a little to tease your spent cock.  Drenched in her " + ((this.monster.hairColor == "red") ? "musky futa-cum" : "feminine juices") + ", you twitch lightly as bliss and fatigue spread through your body in equal measure.  She leans forward again, dropping her lips to your ear, and whispers a short incantation while stroking the side of your face.\n\n");
        this.outputText("The last thing you see before blacking out is a pair of delightfully plump, round cheeks jiggling happily as the kitsune gathers her robes.");
        this.player.orgasm();
    ...
    private femalesAndNuetersLoseToKitsunes(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("\"<i>My, oh my, finished already?</i>\"  the kitsune says as she leans over your slumped form, grinning coyly.  \"<i>If you were going to give up that easily, you could have said so in the beginning and saved yourself the trouble!</i>\"\n\n");
        this.outputText("Her tittering laughter rings in your ears, broken momentarily as she grunts with the effort of rolling you onto your back.\n\n");
        this.outputText("\"<i>Hehe, time to claim my prize...</i>\"\n\n");
        this.outputText("Humming quietly, she carefully removes your " + this.player.armorName + ", neatly arranging them into a pile and shoving them off to the side.  Eying your nude form hungrily, she begins to slowly trail her hands down your [fullChest], letting her fingertips cascade over every ridge and curve of your body while painting streaks of blue fire across your flesh.  Her touch sends tingles up and down your spine, making you shiver and moan involuntarily.  Slowly but surely her hands work their way down toward your loins, teasing around your [hips] very gently" + ((this.player.isBiped()) ? ", tickling the insides of your thighs" : "") + " before trailing up to your " + ((this.player.gender == 2) ? "rapidly moistening cleft.  Her fingers dance along the inside of your labia" : this.assholeDescript() + ".  Her fingers dance along between your cheeks") + ", circling the entrance and nearly - but never quite - pushing a fingertip inside, snickering in satisfaction as you release a small rush of fluids into her palm." + ((this.player.gender == 2) ? "  She glides the tip of one of her tails across your [clit] delicately, like a feather, flicking it up and down." : "") + "\n\n");
        this.outputText("The tip of her index finger presses " + ((this.player.gender == 2) ? "into the end of your clitoris" : "against your pucker gently") + ", leaving behind a tiny bead of fire that tingles incredibly as the azure tongues lick at your nethers.  It doesn't take but a few moments of this treatment before you are teetering on the edge, but the skillful seductress has other plans for you, and dials back the pleasure mere moments before your release.\n\n");
        this.outputText("\"<i>Oh no dear, the fun's only just begun,</i>\" she says with a mock chastising tone, smirking mischievously.\n\n");
        this.outputText("She slides forward, daintily settling down on your hips and pinning you under the weight of her expansive behind.  " + ((this.player.isBiped()) ? "A pair of fluffy tails slides in between your legs, curling around them and spreading them up and apart, the remaining tails taking advantage of your helpless state and beginning to brush up and down the insides of your thighs, one tip sliding up and down " + ((this.player.gender == 2) ? "the sensitive cleft of your vagina" : "between the cheeks of your " + this.buttDescript()) + "." : "Her tails drift over your sensitive crotch, brushing the tip " + ((this.player.gender == 2) ? "along the cleft of your vagina" : "between the cheeks of your " + this.buttDescript()) + " and tickling it sensually.") + "  Sliding her hands down her shoulders and over the jiggling mounds of her breasts, she hooks her fingers into her robes and drags them down so that her perky nipples are just barely contained.  With an agonizing slowness, she strips out of her robes, watching you the entire time and laughing seductively at your reactions to her teasing display.  With her clothes tossed aside and out of the way, you have a full view of her young, lithe body, " + ((this.monster.hairColor == "blonde") ? "flowing golden locks cascading over her toned, voluptuous hourglass shape." : ((this.monster.hairColor == "black") ? "a slight pudge around her belly accentuating her voluptuous figure." : "your eyes drawn immediately down to the pulsating, foot long member that now lays across your stomach.")) + "  Grinning coyly, she strikes an alluring pose and leers at you through half-lidded eyes, one corner of her mouth curled up in a mirthful smirk.\n\n");
        this.outputText("\"<i>Mm...  getting all hot and bothered dear?</i>\"  she says, almost in a whisper, her voice dripping with seduction.\n\n");
        this.outputText("As she leans down to press her chest to yours, her tails continue to twist and slither over your groin, teasing and painting your " + ((this.player.gender == 2) ? "slick slit " : "anus") + " with their mystical fire.  She starts to gradually grind her hips forward and back on your abdomen, her cheeks quivering gently while she leans forward to caress your face, planting a small kiss just below your chin.  Lush, full lips press against yours, carrying the sweet taste of wintergreen.  Her fingers clasp against the back of your head with a surprisingly strong grip, and she releases a powerful moan into your lips, a tingling coolness spreading over your tongue before moving on to the rest of your body.\n\n");
        ...
        this.outputText("Her tails spread " + ((this.player.gender == 2) ? "the lips of your vagina as wide as they will stretch" : "your cheeks apart") + ", a third gently drawing circles of flame around your " + ((this.player.gender == 2) ? "clitoris while a fourth presses insistently against your entrance" : "puckered anus") + ".  The soft brush pushes forward to meet the resistance of your " + ((this.player.gender == 2) ? "moist, pink flesh" : "muscular ring") + ", teasing you with the promise of penetration, yet never quite finding its way inside.\n\n");
        this.outputText("\"<i>Oh, you poor thing,</i>\" she croons, watching your face contort into a grimace of shameless desire.  Why won't she get on with it already!?  She swats your hands away as you reach up to try to assert control of the situation, two tails curling forward to bind your wrists.  \"<i>Naughty naughty!  You can look, but </i>I'll<i> be the one who does the touching today, dear.</i>\"\n\n");
        this.outputText("You struggle against her bushy coils, but to no avail.  Staring into the emerald pools of her eyes, it becomes abundantly clear that physical resistance is going to get you nowhere - her hypnotic sorcery has left your muscles sapped of strength, hanging uselessly in the grip of her tails.  Her fingers slowly dance across your [chest] again, drawing intricate patterns of flame down your front as she giggles happily.  Slowly, agonizingly, her tail lowers against your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + " again, spiralling and twisting at the entrance.  The soft, luxurious fur feels incredible against your nether regions, excitement building as she comes ever closer to finally thrusting it in, circling just outside it for an unbearably long time.\n\n");

        this.outputText("\"<i>You want this, huh?  Show me just how bad you want it,</i>\" she teases, " + ((this.player.gender == 2) ? "gently reaching back to press her fingertip to your [clit], rolling it back and forth between her thumb and forefinger." : "dragging her index finger in a circle around your navel.") + "  The tip of her tail slips ever so slightly into your needy hole, swiveling and swirling around the inside before withdrawing and leaving you desperately wanting.\n\n");
        this.outputText("You groan and thrash to the best of your ability underneath her, trying in vain to raise your hips to meet her tail, which is hovering tortuously just out of reach.  Slick juices dribble down your abdomen as she grinds herself across you" + ((this.monster.hairColor == "red") ? ", her cock leaking copious amounts of precum onto your belly as well" : "") + ", an intense heat radiating from between her legs and betraying her own desire.\n\n");
        this.outputText("Your eyes roll skyward and you moan lewdly, squirming and thrashing beneath her and trying your hardest to overcome her hypnotic hold on you, that you might take control and grant yourself the release you so desperately need.  Just as you are certain that you'll go out of your mind, she leans forward, grabbing your shoulders and pulling you into a long, drawn-out kiss.  The tail that has been constantly, teasingly strafing your entrance at last twists itself into position, and your vision explodes into a sea of colors as it thrusts inside, burying itself deep inside your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + " in one pass.  Lying flat against your [chest], the kitsune raises her jiggling ass into the air, putting most of her weight into the passionate lip-lock.  A licentious schlick echoes through the air as the kitsune threads a second tail down through the loop of the first, plunging it into her own sopping pussy with a groan.\n\n");
        this.outputText("" + ((this.monster.hairColor == "red") ? "Her cock throbs hotly between your stomach and hers, precum and fem-juice lubricating its passage as she rocks herself back and forth.  " : "") + "Brushlike tails and soft fingertips caress every curve and ridge of your body with a tender passion, leaving trails of flame tingling in their wake.  With each passing second, the tail in your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + " pumps more furiously, slinging droplets of your juices through the air and filling the forest with your scent.\n\n");
        this.outputText("A sudden chill rushes up your spine as an intense tingling begins to emanate through you from the core, sending you into a convulsion of pleasure.  In the seconds before your eyes roll back in ecstasy, you can see a faint light issuing from your abdomen as the kitsune's tail sets you alight from within!  Strength momentarily surges back into your muscles, allowing you to grip the kitsune in an intense embrace, your fingertips digging into her bare back as your body is wracked with pleasure.\n\n");
        this.outputText("Your reaction elicits an excited moan from the tricky fox woman, causing her to redouble the passionate thrusting of her tails.  She breaks the kiss long enough to groan into your ear, a rush of fluids splashing from her slick cunt and dripping down onto yours.\n\n");
        this.outputText("\"<i>Almost, dear!  Mn, just a bit, ah!  More...</i>\"\n\n");
        this.outputText("Grinding her hips along your front shamelessly, she gropes at your shoulders and [chest] while pounding your " + ((this.player.gender == 2) ? "pussy and hers alike" : "asshole and her own sopping fuckhole") + " with her tails.  Faster and faster the slickened coils drive into you, dazzling jets of flame dancing across your groin and sending jolts of pleasure through your body like lightning.  The kitsune's fingers grip your biceps almost painfully as she reaches her climax first, a torrential downpour of juices spraying out around her tail as it whips out of her with a flourish." + ((this.monster.hairColor == "red") ? "  Warmth spreads across your abdomen as her cock twitches and throbs in between your body and hers, thick ribbons of semen spilling out over your stomach.  Stream after stream of thick futa-jizz squelches between your bodies, clinging to your chest and rolling off in glistening, pearly globs." : "") + "\n\n");

        this.outputText("Your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + " bears down on her tail tightly, squeezing and rippling around the soft fur.  Powerful spasms of pleasure shudder through you as your orgasm comes into full effect." + ((this.player.wetness() >= 4) ? "  A hot spray of femcum arcs through the air, splattering across the horny fox lady's behind and drenching her tails with your viscous fluids." : "") + "  Her tail continues to thrust into you violently through your climax, prolonging it for several minutes, heedless of your desperate thrashing.  At long last, it whips out of you, slinging your slick fluids into the air with a wet slap, and exhaustion begins to take pleasure's place.  You feel as though you haven't slept in days, your eyelids growing heavy as the kitsune leans up, her lips touching the edge of your ear as she whispers a short incantation while stroking the side of your face.\n\n");
    ...
    private blondeKitsuneRapesSmallWangs(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("The precocious kitsune closes in on you with a predatory smirk as you fall to the ground, panting furiously.  You look up at her, fearing for whatever she has in store for you.  Mustering up every bit of willpower you have left, you scramble backward, but as you try to drag yourself up to your feet, you find your face pressing into something incredibly soft.  Six shimmering golden tails curl around your body, and you look up from between the kitsune's sizeable breasts to see her grinning down at you, her expression somewhere between doting and hungry.\n\n");
        this.outputText("\"<i>Shh...  It'll be easier if you don't resist,</i>\" she whispers, her warm voice melting down your resistance almost instantly.\n\n");
        this.outputText("Her fingers trail over your cheek, dazzling sparks bursting to life beneath her fingertips and licking across your skin in their wake, making you shiver comfortably.  Though a small part of your mind still urges you to break away from her tender caress, it is extinguished in short order when she slides her hands under your " + this.player.armorName + ", running her fingertips over your bare body.  You groan involuntarily, shuddering powerfully and feeling your muscles go slack.\n\n");
        this.outputText("Without taking her hands off of you, she skillfully pulls your " + this.player.armorName + " off piece by piece using her tails, slowly easing you backward onto the ground.  Fully nude, you give yourself over to her tender touch, shivering as the cool flames zigzag down your [fullChest] toward your groin.  Your " + this.cockDescript(0) + " rises up to brush against the underside of her forearm, twitching lightly.  Smirking gleefully, she gives it a gentle squeeze, pushing it back against your stomach and giggling when she lets it go to watch it spring back, slinging a few thin strings of precum into the air.\n\n");
        this.outputText("\"<i>Aww, it's so cuuute...</i>\" she says, running her index finger up and down the shaft, a little bead of azure flame following after it.\n\n");
        this.outputText("Your member throbs and twitches involuntarily, her magical touch making you squirm and fidget in pleasure as she drags her fingertip across your sensitive prick.  Your hips buck upward all by themselves, a slick string of precum squeezing out of your cock and landing on the kitsune's face just above her nose.\n\n");
        this.outputText("\"<i>No!  Bad!</i>\"  she says, flicking you across the nose with a playful scowl.  She takes your cock in her hand and presses down on your [hips], forcing you back down to the ground and pinning you with a surprising amount of strength.\n\n");
        this.outputText("Her tails snake forward, curling around your limbs, and you find yourself pinned, struggling in vain against the uncommonly strong furred coils.  She nods, satisfied with your helplessness, and leans down to gently nuzzle your " + this.cockDescript(0) + ", cooing softly and sliding her soft, wet tongue along the underside from base to tip with a small giggle.  Her tongue swirls back and forth along the underside of your " + this.player.cockHead() + ", wrapping around it and slurping up your slick precum.\n\n");
        this.outputText("\"<i>Mm...  that's more like it.</i>\"\n\n");
        this.outputText("With a satisfied grin on her face, she sits upright again, pulling her robes down slowly.  You can only lie back and watch her disrobe, your member bobbing back and forth in the air freely now.  She teases and brushes your groin with her silken tails, smirking coyly as she begins a sensual striptease.  As the upper portion of her robes falls away, her voluptuous, perky breasts bounce freely, and she starts rubbing the sensitive pink nubs, making them pop out gently.  Her hands glide downward, drawing your eyes across her bare, creamy flesh.  You count a number of tattoos adorning her body, but your gaze is transfixed on the one you can see peeking out just over her waistband.  Swaying her hips back and forth, she tugs the sash that holds the lower part of her robes up and gently shimmies them down, turning just slightly to show off her well-toned but expansive ass.\n\n");
        this.outputText("You get an even better look at it when she straddles your shoulders, lowering the quivering cheeks down onto your face.  Buried underneath the soft mounds, you moan in protest, which only serves to make the kitsune shiver with pleasure.  Before she can smother you, though, she lays herself across your front, giving you just enough room to tilt your head back and take a gulp of fresh air before the tremendous cheeks cover your face again.  Your tongue meets the sickly sweet taste of her pussy, sliding out to part the moist folds and lap up and down along her clitoris.\n\n");
        this.outputText("Her entire body shudders a bit, and you can now feel her soft breasts squashing against your groin as she leans down to lightly kiss the end of your " + this.cockDescript(0) + ".  She starts to rock her wide, curvy hips back and forth across your face, grinding her crotch into your mouth and moaning.  The tails that aren't pinning your limbs down gently curl underneath your neck, lifting your head up.  You moan into her pussy as you feel her lips softly wrap around the tip of your shaft, her tongue playing along the " + this.player.cockHead() + " lightly.  Her lips make a soft smacking noise as she pulls away, and she starts to toy with your member gleefully, stroking it teasingly with her index finger just to feel your reactions trembling up through her loins.\n\n");
        this.outputText("\"<i>Oh yeah, that's right, just like that!  Be a good " + this.player.mf("boy", "girl") + " and lick mama's pussy,</i>\" she groans, mashing her cunt into your face and riding your tongue with an animalistic passion.\n\n");
        this.outputText("Her tails flex, pulling your arms up and laying your hands across her delicious derriere, and you begin to squeeze the soft, pliable cheeks of her ass before you can stop yourself.  Your fingers sink deep into the fleshy globes, their delightful jiggle filling your head with all manner of lewd fantasies.  You raise your hips in a vain attempt to garner some attention from your foxy assailant, only to have them shoved back down into the dirt.  " + ((this.player.inte > 50) ? "Weakened though you may be, you're certain she can't actually be that strong - it <i>must</i> be another one of her illusions." : "You don't remember her being that strong!") + "\n\n");
        this.outputText("\"<i>No!  You behave, naughty " + this.player.mf("boy", "girl") + "!</i>\" she growls.  You can practically feel her scowling, despite the fact that your vision is almost entirely obscured by her colossal keister.  To punish you for your transgression, her tails pull your hands away from her ass, and she sits up, smothering you with it.\n\n");
        this.outputText("Your tongue continues to plumb her depths while you slowly suffocate beneath her jiggling cheeks.  With every ounce of your will, you try to pull away from her sweet-tasting honeypot, but to no avail.  Her tails have wrapped around the back of your head, keeping you snugly crammed into her crotch, and she rides up and down, heedless of your thrashing protests.\n\n");
        this.outputText("You are finally able to tear yourself away from her slavering cunt with a gasp, sputtering and coughing before taking a deep, desperate gulp of fresh air.  Your chest heaves as you fill your lungs with air, slick juices running down your chin and the smell of her feminine musk permeating your senses.  The respite is brief, however, and your head is mashed back into the dirt by the kitsune's heavy bottom seconds later.  This pattern repeats several more times, and by the end of it you are panting heavily, all thoughts of resistance purged from your mind.\n\n");
        this.outputText("Satisfied with your submission, she slowly lowers her front to your groin again, wrapping her warm, soft breasts around your neglected member.\n\n");
        this.outputText("\"<i>Mm, hey there lil' guy,</i>\" she says in a singsong voice, wrapping one arm around her breasts to squash them down and hold them in place while gently fiddling with the tip of your " + this.cockDescript(0) + " using her index finger.\n\n");

        this.outputText("\"<i>Oooh, right there, lick right there!  If you're a good " + this.player.mf("boy", "girl") + ", I might just let you cum on my tits.</i>\"\n\n");
        this.outputText("You nod your agreement before you can stop yourself, realizing that you are not in control of your own body anymore.  Her tails loosen their grip, permitting you to grab handfuls of her plush ass once again, and she begins to slowly slide her precum-lathered tits up and down your pole, giggling incessantly to herself as she watches it twitch within her cleavage.  She rewards your obedience and submission, happily running her tongue across your " + this.player.cockHead() + " and matching her pace according to how well you please her.\n\n");
        this.outputText("Desperate for release, you force your tongue deeper into her sweet, sodden gash than you thought yourself capable, urging her in the only way you can think of to give you the climax you desire.  She bucks forward at the sudden deep intrusion, her lips wrapping around the tip of your cock as it is thrust up from between her pillowy jugs.  The warmth of her mouth and the softness of her tongue caressing your shaft sends a shock of pleasure up your spine, and it is all you can do to keep yourself from bucking your hips upward again, knowing full well that nothing good can come of it.\n\n");
        this.outputText("Her lips rise and fall around your spasming prick, low moans vibrating through it each time she pulls back.  You can feel her cheeks pulling inward from the strength of her suction, loud smacks filling the air each time a gap forms in the almost airtight seal of her lips.  She squashes her breasts down as much as she can, lowering her lips to kiss your " + ((this.player.hasSheath()) ? "sheath" : "base") + ((this.player.balls > 0) ? " and reaching down to gently stroke your " + this.ballsDescriptLight() : "") + ((this.player.gender == 3) ? ", one of her long, dextrous fingers sliding into your " + this.vaginaDescript() : "") + "\n\n");
        this.outputText("Your moan is muffled by her gushing twat, fingers digging into the malleable flesh of her ass as you stuff your face into her cunt, your lustful wail reverberating through her caverns like a symphony through a concert hall.  In unison, you bury your faces into each other's groins, sucking and licking with unabashed passion.\n\n");
        this.outputText("Her pussy convulses around your tongue, practically sucking it out of your mouth, and you are abruptly met with the heavy taste of her orgasmic juices, a rush of femcum drenching your face and spurting onto your chest.  Cool air washes over your cock as she pulls her mouth away to belt out a moan, and the pressure in your loins reaches its peak, bubbling over.  ");
        if (this.player.cumQ() <= 150) {
            this.outputText("Your cock twitches and spasms wildly, hot streams of cum spurting out to paint thin white streaks across the moaning fox-woman's breasts.  Glistening droplets of seed slowly roll off the curves of her chest, pooling in a small pocket of cleavage as your flagging cock slowly recedes into the warmth of her bosom.");
        }
        else if (this.player.cumQ() <= 350) {
            this.outputText("You spurt hot strings of cum over her jiggling breasts, streaking her with white as a few errant streams manage to fling themselves across her chin.  A glistening bead of seed slides down the curves of her neck, joining the rest in a small pool between her breasts, your flagging cock gradually receding into her cleavage.");
        }
        else if (this.player.cumQ() <= 1000) {
            this.outputText("Milky white ribbons of cum splatter from your cock, arcing high and crashing down on her face and chest.  Thick globs drip and dribble down her chin, falling to join the puddle of seed pooling between her breasts with a steady, pattering slap as your member slowly recedes into her cleavage.");
        }
        else if (this.player.cumQ() < 2500) {
            this.outputText("Your shaft swells with pleasure, slinging thick jets of seed into the air.  In no time, her face, chest, and hair are plastered with a pearly gloss of semen, dribbling and rolling off her in thick, wet globs.  A puddle of seed overflows across her jiggling breasts, your shaft disappearing into the milky white pool as it recedes into her cleavage.");
        }
        else {
            this.outputText("A thick load of semen swells through your cock, spurting high into the air.  A milky white downpour falls across her head and chest in thick streaks, plastering her with a heavy mask of glistening, pearly cum.  It cascades down the curves of her face and breasts, dribbling and sloughing off of her in globs and sheets.  Each breath she takes causes the lake of seed pooling in her cleavage to overflow onto the ground, your shaft long since disappearing into the depths of her cum-soaked cleavage.");
        }
        ...
        this.outputText("Your last sight before blacking out from the kitsune's spell is a span of creamy white flesh jiggling seductively, quivering gently beneath a cluster of tails.");
    ...
    private loseToBlackHairLatexWhileMilky(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("You drop to the ground, struggling to support yourself as your muscles shudder with ");
        if (this.player.HP < 1) this.outputText("fatigue");
        else this.outputText("lust");
        this.outputText(".  As you collapse, you find yourself being cushioned by a group of silky black tails.  They curl around you and cradle you gently, rolling you onto your back and hoisting you up into a sitting position.\n\n");

        this.outputText("The kitsune smirks a bit and quickly goes to work getting you out of your " + this.player.armorName + ", carefully pulling them off and pushing them to the side with one of her tails.  Dragging her fingertips down your [chest] lightly, she leaves little trails of blue fire on your flesh that pop and tingle with each passing second, making you moan with pleasure.  Her index finger circles your [nipple] gently, and her eyes go wide with glee as she sees your creamy milk begin to dribble out, licking her lips hungrily.\n\n");
        this.outputText("\"<i>Oh, I'm having just the most wonderful luck today!</i>\"  she says with a grin, waggling her fingers lecherously while her tails slip around each of your limbs, pinning them down.\n\n");
        this.outputText("With the sound of flint striking steel, her fingertips light up with a dazzling display of blue sparks, and she begins to slowly knead and stroke your [chest], painting tiny circles of crackling flame across your body and watching with delight as you squirm in pleasure.  The tingling intensifies over time, spreading across your chest gradually until it truly does feel like you are on fire.  Finally the effects of the kitsune's sorcery become apparent as you feel your [chest] swelling with added weight, the pressure of your welling milk reserves becoming almost painfully unbearable.\n\n");
        this.outputText("\"<i>Don't worry dear, it won't last for long...</i>\" the kitsune assures you, pinching your turgid nipples teasingly and forcing out a thick stream of milk.\n\n");
        this.outputText("When she finally wraps her lips around your engorged nipples, you can't stop yourself from bellowing out a moan, every sensation upon your milk-laden tits magnified tenfold.  The corners of her lips curl up into a smile as she starts to suckle, looking up at you with mischief in her big green eyes.  As the intense pressure is suddenly relieved, you arch your back and moan, " + ((this.player.cocks.length > 0) ? this.sMultiCockDesc() + " becoming rock hard" : "") + ((this.player.gender == 3) ? " and " : "") + ((this.player.gender >= 2) ? "a puddle beginning to spread between your legs" : "") + " from the sheer pleasure of it." + ((this.player.cocks.length > 0) ? "\n\nSmirking happily, she lifts the back portion of her robes to expose her expansive bottom, lowering the jiggling cheeks against [eachCock].  A few of her tails snake down to coil around " + ((this.player.cocks.length > 1) ? "them" : "it") + ", holding " + ((this.player.cocks.length > 1) ? "them" : "it") + " against her ass and squeezing tightly as they begin to pump up and down slowly.  Though you cannot see it from this angle, you can feel her colossal cheeks quivering sensually around [eachCock], jiggling enticingly with every movement." : "") + "\n\n");
        this.outputText("" + ((this.player.gender >= 2) ? ((this.player.gender == 3) ? "Another" : "A") + " silken black tail slithers down between your legs, tickling your groin teasingly.  It circles your " + this.vaginaDescript() + " slowly, brushing the tip up against your [clit] and gently toying with the sensitive lips, occasionally pressing up against your entrance and yet never actually penetrating you.  The torment is unbearable, but you are helplessly pinned underneath her, so all you can do is accept her tortuous teasings.\n\n" : "") + "");
        this.outputText("Her tongue laps and swirls over your [nipple] incessantly, draining your milk from one breast while she gently squeezes and caresses the other" + ((this.player.breastRows.length > 1) ? "s" : "") + ".  When one of your [fullChest] goes dry, she quickly abandons it for " + ((this.player.breastRows.length > 1) ? "another" : "the other") + " one, using her magic to induce you to produce more.  Over and over, she sucks your tits dry, repeating the cycle at least a half dozen times before you start to lose count.  Every time your breasts begin to fill with milk again, their sensitivity seems to grow.  Eventually you are little more than a shivering, moaning wreck, your [nipples] every bit as sensitive as a clitoris.\n\n");
        this.outputText("Just when you feel there is no end in sight, a growing tension in your chest and groin tells you that you are on the verge of climax.  Shivers course up and down your spine, and you begin to moan, lightly at first, but growing louder by the second" + ((this.player.cocks.length > 0) ? ".  [eachCock] twitch" + ((this.player.cocks.length > 1) ? "" : "es") + ", spurting cum up between the kitsune's ass cheeks and soaking her lower back with your virile spunk" : "") + ((this.player.gender >= 2) ? ((this.player.gender == 2) ? "Every" : ", while every") + " muscle in your neglected fuckhole tenses up, squeezing wantonly at nothing as your fluids rush out into a puddle beneath you" : "") + "\n\n");
        this.outputText("Your orgasm is accompanied by a fountain of creamy milk, and the kitsune can't suppress a giggle at the sight of your tremendous orgasm, licking droplets of your milk off her arms and fingers.  As the last ripples of your climax leave your body, your [chest] returns to its normal size, though it seems you are still lactating quite a bit more than before.  Having downed what surely must have been gallons of your milk, the kitsune's belly is a fair bit chubbier than it used to be, and she sighs in satisfaction, patting her stomach gently.\n\n");
        this.outputText("\"<i>Mm...  that was </i>divine<i>,</i>\" she proclaims, gently leaning forward to kiss you on the forehead.  \"<i>Sleep tight now...  don't let the tentacles bite...</i>\"\n\n");
        this.outputText("She whispers an incantation in a strange language, and you can slowly feel your already pleasure-worn consciousness leaving you, replaced with a warm, comforting darkness.  Your dreams are haunted by visions of yourself being turned into a human dairy cow, forced to live out the rest of your days as a living milk factory for your hungry kitsune mistress.");
        //<b>You'll probably come to your senses in 8 hours or so, missing X gems.</b>" );
    ...
    private loseToKitsunesWithBallsAndHighCumQ(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("Summarily beaten, you fall to the ground, propping yourself up in one final fleeting moment of defiance.  As you collapse in defeat, the fox-woman skips merrily over to your prone form, pausing momentarily to bend down and give you a patronizing kiss on the forehead.  Gripping you under the shoulders, she drags you bodily toward a fallen log" + ((this.player.tallness > 96) ? ", her face going beet red with the strain as she finally heaves your half-comatose frame into position" : ((this.player.tallness > 60) ? ", openly grunting with effort" : "")) + ".\n\n");
        this.outputText("\"<i>Let's just see...</i>\"  she quietly muses to herself, slipping her hands under your " + this.player.armorName + ", <i>\"what we have here...\"</i>\n\n");
        this.outputText("Her coy grin turns to one of delighted surprise as her fingertips pass over your " + this.ballsDescriptLight() + ", giving them a firm but gentle squeeze.  She licks her lips and eagerly pulls your " + this.player.armorName + " off with a hungry glint in her eyes, lifting up your [cock biggest] and flexing it slightly as though examining it.  She leans down, her face close to your balls, and drinks in their scent with a long, drawn-out sigh.\n\n");
        this.outputText("\"<i>Smells like you've got a thick one brewing...</i>\"  she says, softly licking the " + ((this.player.hasSheath()) ? "sheath" : "base") + " with a giggle.  Six inky black tails slither forth to bind your limbs, twisting your wrists behind your back.  \"<i>Let's see if we can't help it along...</i>\"\n\n");
        this.outputText("She snaps her fingers, blue sparks popping from her fingertips and igniting into a wispy azure flame that dances across her hand.\n\n");
        this.outputText("You try and fail to suppress a moan as she presses her palms to your balls, an intense tingle crawling across your scrotum as it tightens up.  The tension in your groin builds steadily, and as the flesh of your sack becomes taut, you realize that her magic is causing your balls to physically swell with seed!\n\n");
        this.outputText("Pulling your [cock biggest] into a double-fisted grip, she squeezes tightly around the base while stroking the shaft vigorously up to full mast.  With a playful smirk, she cups her hand around your [cockHead biggest] and blows into it.  Azure flames cascade down your length, making you arch back and thrust your hips upward involuntarily as cool pleasure spreads across your groin.\n\n");
        this.outputText("Giggling at your shuddering moans and desperate bucking, she pushes your hips back down, dropping low and pinning you in place with her elbows.  Her soft, voluptuous breasts slide around your [cock biggest]" + ((this.player.cocks[this.player.biggestCockIndex()].cockLength > 8) ? " while she lavishly licks the exposed portion, wrapping her improbably large tongue around it and squeezing in a tight spiral." : ", and she dips her head down to wrap her plump lips around the head, lavishly licking the underside with her improbably large tongue.") + "  Her jiggling rump waggles from side to side cheerfully as she goes down on your cock" + ((this.player.biggestCockArea() > 70) ? " as far as she can, letting your oversized shaft stuff her throat with a moan." : ", lips pressed tight to your groin, slurping up your precum with a sublime grin lifting the corners of her mouth.") + "\n\n");
        this.outputText("She pulls back, her plush lips resting just behind the [cockHead biggest] of your cock, the coils of her tongue slowly receding back into her mouth.  The tip gently prods your urethra, and the resultant sensations cause you to shiver heavily.  She wraps one arm underneath her breasts, rolling her shoulders together to squeeze you tightly in her cleavage.  Meanwhile, her other hand slides up beneath your swollen balls, fingertips dancing across the taut flesh daintily.\n\n");
        this.outputText("\"<i>Mn, how'th thath theel?</i>\" she teases you, punctuating it with a wet slurp as she drops down onto your shaft once again, caressing the head with the entrance of her throat.\n\n");
        this.outputText("Her eyelashes flutter gently, a low moan humming down your cock as she begins to lightly tweak and roll her nipples between her fingers.  You moan in kind when you feel her fingertips dragging down the sensitive seam of your sack, pale blue sparks crackling across it to elicit even greater pleasure.  She continues to walk her fingers up and down your balls, leaving behind a trail of ghostly flames that tingle incessantly as they lick against your flesh.  After a while, she switches to cupping them in her palm, gently rubbing them as though she could spur them to produce more seed just by doing so.\n\n");
        this.outputText("Her other arm abandons its duty of holding her breasts against your shaft, and she shifts to an even lower position, letting your [cock biggest] drape across her face as she buries her nose in between your balls.  Green eyes glisten on either side of your shaft as she stares up at you, her cheeks raised and betraying the coy grin that is obscured beyond your swollen testicles.  Her lips open wide, caressing them with the plush pink pillows, while her slick tongue curls underneath them, undulating gently to massage them.\n\n");
        this.outputText("As if to demonstrate her supreme skill with her tongue, she allows her hands to wander freely along your lower body while she continues to bounce and squeeze your balls with her tongue.  " + ((this.player.gender == 3) ? "The tip snakes down, hugging the curvature of your balls, and then begins to experimentally prod your " + this.vaginaDescript() + ", gently flicking your clitoris.  " : "") + "Pleasure turns to surprise when you feel her index finger poking around by your " + this.assholeDescript() + ", and she buries it to the base inside you before you have a chance to formulate a protest.  The sudden intrusion makes your shaft flex, the veins bulging against the surface of the skin as it swells a bit in response.\n\n");
        this.outputText("The wriggling digit finds its way to your prostate and wastes no time going to work, rubbing against you from the inside while she lavishes attention on your balls.  Her free hand glides up and down your shaft, and she occasionally pauses to affectionately nuzzle the underside, rubbing her cheeks along it.  The combination of all these factors is enough to bring you to the verge of climax in just minutes, her skillful licking and stroking sending you to incredible heights of pleasure.  Just as you are about to achieve release, her hand strangles the base of your cock with a vicelike grip, blocking the flow.\n\n");
        this.outputText("\"<i>Naughty naughty, trying to cum outside my mouth,</i>\" she chastises you with a teasing grin, maintaining her grip on your cock as she pulls back, changing positions.  Her fingertip traces the edge of your sensitive prick, and the slightest touch is enough to drive you mad with pleasure.  She waggles her finger admonishingly as you thrash about, trying to break free of her grip, opening her mouth and pointing inside to emphasize her point.\n\n");
        this.outputText("Your struggles are put to rest when she knocks the wind out of your lungs, dropping her heavy rear onto your chest a bit more forcefully than was necessary.  At the very least, you have a prime view of her luscious, jiggling ass, emblazoned with a large sun-shaped tattoo on the right cheek.  It's the last thing you see before the world turns into a multi-colored blur of pleasure - the kitsune's plump lips wrap around your engorged head once again, and the sensations of her tongue sliding across it are magnified nearly to the point of excruciating.\n\n");
        this.outputText("In deference to your desperate state, the kitsune at last seems ready to allow you to fill her with your thick seed...  though it seems as though she still has some teasing to get out of her system as she does so.  Her grip loosens one finger at a time, starting at the pinkie, then the ring finger, then the middle.  The tight ring formed by her thumb and forefinger remains for an agonizingly long time, and then at long last, it falls away, allowing your creamy load to rush up into her waiting throat.\n\n");
        if (this.player.cumQ() <= 2500) {
            this.outputText("The second that the first streams of salty cream hit her throat, she begins to moan in ecstasy, cupping your balls softly with both hands.  With her lips sealed tight around your shaft, her tongue swirls to and fro inside her mouth, gathering up your thick seed and funneling it into her gullet.  Overcome by gluttonous desire, she draws your shaft into the back of her throat, massaging your " + this.ballsDescriptLight() + " while she drinks them dry.  She continues to suck down each new stream of cum even after her stomach begins to expand, swelling up with your roiling load.  As your explosive climax begins to slow, she begins to massage the sides of your shaft, squeezing out the last few globs of semen.  Her tongue coils around your length one last time, and she sucks hard, slurping up the last drop with great embellishment.\n\n");
            this.outputText("\"<i>Mm, not bad...  not bad at all.  For a mortal,</i>\" she teases, sitting up on your chest and rubbing her expanded tummy contentedly.\n\n");
        }
        else if (this.player.cumQ() <= 6000) {
            this.outputText("She moans deeply the moment that your first thick streams of seed begin to flow into her throat, cupping your balls softly with both hands.  With her lips sealed tight around your shaft, her tongue swirls to and fro inside her mouth, gathering up your thick seed and funneling it into her gullet.  Overcome by gluttonous desire, she draws your shaft into the back of her throat, massaging your " + this.ballsDescriptLight() + " while she drinks them dry.  Even as her stomach begins to swell with the added weight of your seed, she never stops sucking down your thick load.  Your explosive climax continues to flow, and although she puts up a valiant effort to swallow it all, a few thick streams manage to escape from the corners of her mouth and nostrils.  As the lengthy orgasm finally begins to wind down, her tongue coils around your length one last time, and she sucks hard, slurping up the last drop with great embellishment.\n\n");
            this.outputText("\"<i>Oh, so thick...  So full,</i>\" she groans, sitting up on your chest and rubbing her expanded tummy contentedly.\n\n");
        }
        else {
            this.outputText("She involuntarily bucks forward as soon as your semen begins to flow into her mouth, both cheeks puffing out as she tightens her lips around the shaft in a desperate bid to keep it contained.  Her hands grip your throbbing shaft to keep it held in place as she drinks deeply of your inhuman load, twin streams of seed flowing from her nostrils while she tries her best to swallow it all.  Despite her efforts, thick streamers of seed burst from the corners of her mouth, splattering to the ground.  Although her stomach has swollen to the size of a watermelon already, she continues to drink deeply of your thick load, eyes rolled back into an expression of utmost ecstasy.  Her stomach continues to expand, jiggling and sloshing audibly with the added weight of your cum.  As the lengthy orgasm finally begins to wind down, she pulls away with a mouthful of cum in her cheeks, swallowing it with a bit of difficulty.\n\n");
            this.outputText("\"<i>So much...  I'm stuffed...</i>\"  she groans, sitting up on your chest and resting both hands on her stomach, now well over the size of a beach ball.\n\n");
        }
        ...
        this.player.orgasm();
        this.dynStats("lib", 1, "sen", 1);
        if (this.player.cumQ() < 30000) this.player.cumMultiplier += 5;
        this.cleanupAfterCombat();
    }
    ...
    private getRapedByRedHeadFutaKitsune(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("You collapse on the ground, too weakened to fight back anymore.  With a mischievous grin, the redhead playfully saunters up to you, crouching down and prodding you in the side.\n\n");
        this.outputText("\"<i>Finished already?  I thought a big strong " + this.player.mf("boy", "girl") + " like you would put up more of a fight.</i>\"\n\n");
        this.outputText("With a light shrug, she ceases chastising you and gets down to business, carefully pulling off your " + this.player.armorName + " and rolling you over to get a good look at your body.  As her hands cascade over your naked form, you struggle in vain against her incessant pinches and gropes, unable to resist becoming aroused.  Her fingertips slide over your [chest], pressing down lightly as they circle your [nipples].  Ethereal flames crackle along behind her fingers as they drag across your flesh, making your whole body tingle with pleasure and forcing a moan from your throat.\n\n");
        this.outputText("As she begins to examine your nethers, a number of her bushy red tails begin to slither around your limbs, binding your arms behind your back." + ((this.player.cocks.length > 0) ? "  She idly lifts [oneCock], playfully wobbling it back and forth and giggling at the pleasured grimace you make." : "") + ((this.player.balls > 0) ? "  Cupping her hand around your " + this.ballsDescriptLight() + ", she hefts them a bit as if sizing them up, using the tip of one of her tails to tickle the underside of your scrotum." : "") + ((this.player.gender >= 2) ? "  Her fingertips then gently walk along your groin, sliding down to caress and part the lips of your " + this.vaginaDescript() + ", coming away with a thin thread of your feminine juices." : "") + "\n\n");
        this.outputText("" + ((this.player.gender == 0) ? "\"<i>Heh, well, this is an awkward situation...</i>\" she says, eying your bizarre, featureless groin.  Flipping you over onto your stomach, she smiles, patting your " + this.buttDescript() + " lightly.  \"<i>But at least it looks like you're still good for </i>some<i> kinds of fun...</i>\"" : "\"<i>Oh, we are gonna have some </i>fun<i>, you and I,</i>\" she says, patting your head softly.") + "\n\n");
        this.outputText("Once she is suitably satisfied with her teasing, she decides to get down to business, stripping out of her robes.  She throws you a sly grin as she pulls them down around her shoulders, letting her large breasts bounce free and giving you a little show, tweaking her nipples and moaning a bit.  Tugging at the sash around her waist, she lets her robes fall off entirely now, and you watch as her throbbing, twelve-inch cock springs to life, no longer held in check by the confines of her clothes.\n\n");
        this.outputText("Though her impressive endowment isn't quite as fearsome as some of the others in this strange land, that eerie blue fire that encircles it gives you reason to worry.  There's little you can do about it though, wrapped up in her tails as you are, unable to resist her advances.  You squirm a bit when you feel her press up against your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + ", struggling in vain against the tails binding you.  Your fears are assuaged somewhat when you feel the head pushing past your ");
        if (this.player.hasVagina()) this.outputText("entrance");
        else this.outputText("anus");
        this.outputText(", and you realize that rather than burning you the ghostly flames are filling you with a cool tingling.");
        ...
        this.outputText("Wrapping her arms around your waist, she stuffs the remainder of her thick member inside you with one thrust, making you howl in ");
        if (this.player.hasVagina()) {
            if (this.player.vaginalCapacity() < 30) this.outputText("a combination of pain and ");
            this.outputText("pleasure.  Your muscles instinctively clench down on the intruder, milking her throbbing shaft in blatant disregard of your own desires, and the kitsune moans in pleasure, rolling her eyes back a little.\n\n");
        }
        else {
            if (this.player.analCapacity() < 30) this.outputText("a combination of pain and ");
            this.outputText("pleasure.  Your muscles instinctively clench down on the intruder, milking her throbbing shaft in blatant disregard of your own desires, and the kitsune moans in pleasure, rolling her eyes back a little.\n\n");
        }
        //Use same text for anal sex, but using analCapacity instead:
        if (this.player.gender >= 2) {
            this.outputText(((this.player.vaginas[0].vaginalLooseness < VAGINA_LOOSENESS_GAPING) ? "\"<i>Ah!  Nice and tight, just how I like it!</i>\"  she groans, gripping your waist tightly and beginning to strongly pump her hips." : "\"<i>Hmm...  a little loose for my tastes, but I suppose it'll have to do.  You haven't been slutting it up on minotaurs and tentacle beasts, have you cutie?</i>\"  she says teasingly, giving you a patronizing pinch on the cheek."));
        }
        else {
            this.outputText(((this.player.ass.analLooseness < 3) ? "\"<i>Ah!  Nice and tight, just how I like it!</i>\"  she groans, gripping your waist tightly and beginning to strongly pump her hips." : "\"<i>Hmm...  a little loose for my tastes, but I suppose it'll have to do.  You haven't been slutting it up on minotaurs and tentacle beasts, have you cutie?</i>\"  she says teasingly, giving you a patronizing pinch on the cheek."));
        }
        ...
        this.outputText("As she uses your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + " as her own personal fuckhole, her many tails begin to stroke and tease along your naked body, tickling you with their bristly tips and painting trails of fire across your flesh.  You are caught up in shivers each time one of them crosses one of your erogenous zones, the cool flames tickling and tingling across your most sensitive areas.  Thrashing and wriggling underneath her, you belt out a trembling moan, every muscle in your body resonating with pleasure from the odd contrast of the gentle caress of her tails with the rough pistonlike pounding of her cock.\n\n");

        this.outputText("\"<i>Yes, yes, oh gods YES!</i>\"  she screams skyward, her tongue hanging out wantonly as she mashes her pelvis into yours with an almost brutal fervor.  Pain has long since been supplanted by pleasure, but you know that you'll probably be sore in the morning when all of this is over.\n\n");
        this.outputText("You feel yourself being lifted off the ground slightly, a single tail gliding up and down your back.  Your muscles clench up involuntarily as it brushes against you, and it is almost as though you can make out every vein and wrinkle on the brash redhead's cock now, feeling the rapid throb of her heartbeat through it.  Her cock swells with a thick load of seed, and you can feel slick hot jets of semen flooding your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + ".  Your insides milk her swollen member of every ounce of futa-jism she has, her hips pumping continuously and sloppily pounding into you like a horny teenager.  Her voluminous load is so immense that you can feel your abdomen begin to swell as pressurized streams of her seed begin to escape, spilling out onto the ground.\n\n");
        this.outputText("When she finally calms down and pulls out with a satisfied sigh, your " + ((this.player.gender >= 2) ? this.vaginaDescript() : this.assholeDescript()) + " lies agape, a small river of seed slowly pouring out.  Your stomach has swollen to the size of a watermelon, jiggling heavily with the weight of her incredible load of futa-cum.  Her spent cock hangs limply between her thighs, a mixture of cum and feminine juices dripping from the tip.\n\n");

        this.outputText("She leans down over you and whispers a line of some strange language into your ear, and almost immediately you can feel your consciousness begin to fail you.  The last thing you see before blacking out is her half-flaccid cock swaying happily between her legs as she bends down to pick up her clothes, flashing you one last look at her wide, round ass.\n\n");
    ...
    public defeatTheKitsunes(display: boolean = true): void {
        if (display) {
            ...
            if (this.monster.HP < 1) {
                this.outputText("The kitsune hits the ground with an 'Oomph', landing roughly on her well-cushioned backside." + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] == 0) ? "  The moment her rounded rump impacts the dirt, a swirling flame crackles to life between her legs, engulfing her exposed cock.  When it dies away, all that remains of her throbbing member is a pert cherry-colored bud between her dripping lips." : "") + "  She rubs her sore posterior, wincing in pain and pouting childishly.\n\n");

                this.outputText("\"<i>I only wanted to play...</i>\" she says, looking crestfallen.\n\n" + ((this.player.lust >= 33) ? "<b>Well, you can certainly think of a few ways to 'play.'  What will you do to her?</b>" : ""));
            }
            //Lust victory
            else {
                this.outputText("The kitsune falls to the ground, one hand buried in her robes as she plays with herself shamelessly, too turned on to continue fighting." + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] == 0) ? "  The moment her rounded rump impacts the dirt, a swirling flame crackles to life between her legs, engulfing her exposed cock.  When it dies away, all that remains of her throbbing member is a pert cherry-colored bud between her dripping lips." : "") + "\n\n" + ((this.player.lust >= 33) ? "<b>As you watch her lewd display, you realize your own lusts have not been sated yet. What will you do to her?</b>" : ""));
            }
        }
        this.menu();
        var button: number = 0;
        ...
        if (this.player.hasCock()) button = this.kitsuneButton(button, "FuckHerVag", this.fuckAKitsuneVaginally);
        ...
        if (this.monster.hairColor == "blonde") {
            if (this.player.hasCock()) {
                //[Fuck Draft]
                if (this.player.hasItem(this.consumables.F_DRAFT)) {
                    if (display) this.outputText("  You could dose her with a fuck draft...");
                    button = this.kitsuneButton(button, "Use F.Draft", this.fuckDraftBlond);
                }
                //[Lactaid]
                if (this.player.hasItem(this.consumables.LACTAID)) {
                    if (display) this.outputText("  You could dose her with lactad...");
                    button = this.kitsuneButton(button, "Use L-Aid", this.lactaidDoseAKitSune);
                }
                //[Ovi Elixir]
                if (this.player.hasItem(this.consumables.OVIELIX)) {
                    if (display) this.outputText("  You could use an oviposition elixir on her...");
        ...
        if (this.monster.hairColor == "black") {
            ...
            if (this.player.cockThatFits(108) >= 0)
        ...
        if (this.monster.hairColor == "red") {
            ...
            if (this.flags[kFLAGS.redheadIsFuta] == 0 && this.player.hasCock())
                button = this.kitsuneButton(button, "Lap HJ", this.nonFutaRedHeadIsWorstRedheadLapsittingHandjobThingIDontKnow);
            //[Helix] - requires herm
            if (this.flags[kFLAGS.redheadIsFuta] > 0 && this.player.gender == 3)
            ...
            if (this.player.hasVagina() && this.flags[kFLAGS.redheadIsFuta] > 0)
                button = this.kitsuneButton(button, "RideHerCock", this.rideDatRedheadKitsuneCockIntoTheSkyDiamonds);
            if (this.flags[kFLAGS.redheadIsFuta] > 0 && this.player.hasVagina() && this.player.biggestTitSize() >= 4 && this.player.armorName == "lusty maiden's armor")
                button = this.kitsuneButton(button, "B.Titfuck", (this.player.armor as LustyMaidensArmor).lustyMaidenPaizuri);
        }
        //[Feeder]
        if (this.player.findPerk(PerkLib.Feeder) >= 0)
    ...
    private putItInAKitsunesAssWin(): void {
        ...
        this.outputText("Your gaze cascades up and down her lovely form, taking in every voluptuous curve and line.  Finally, your eyes come to rest on her expansive, jiggling ass, carefully scrutinizing the large colorful tattoo emblazoned on the right cheek.  Heat surges to [eachCock] as you stare at it, almost entranced by the smooth globes.  Rubbing your hands together and grinning lecherously, you reach down and position the kitsune on her hands and knees, lifting her deliciously plump derriere into the air and tugging her robes apart, tossing them unceremoniously to the side." + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] == 1) ? "  Her half-flaccid cock dangles in between her thighs, a thin trickle of precum hanging from the tip as it swings back and forth." : "") + "\n\n");

        this.outputText("Giving her a firm exploratory slap, you chuckle giddily as the two quivering cheeks shake and jiggle like gelatin for what feels like a full minute before coming to rest.  The kitsune gives a cute cry of arousal, looking back at you and smirking gently, resting her cheek on her arms now.  Far from resistant to your advances, she seems almost delighted when you fish out your " + this.cockDescript(x) + " and lay it across her rounded rump, raising her tails out of the way automatically.\n\n");

        this.outputText("\"<i>Oh, no, such a big, strong cock...  what </i>ever<i> will I do?</i>\"  she says with a wry grin, beginning to slide her plump cheeks up and down your pole, one of her tails coiling down to gently wrap around the " + ((this.player.hasSheath()) ? "sheath" : "base") + ".\n\n");

        this.outputText("Well, if she's not complaining, neither are you!\n\n");

        this.outputText("A second tail dips down, thrusting into her moist twat and coming out with a nice healthy coating of her slippery pussy juices.  Working it like an artist's brush, she twirls it up and down your rapidly hardening erection, painting you with her juices.  It tickles a bit, making you shudder with pleasure as the warm, slick fluids are spread over your shaft.  Once your rod is suitably lubricated, her tail flips up with a flourish and passes under your nose, teasing you with the heavy scent of her feminine musk.\n\n");

        this.outputText("She pulls her hips forward, caressing your member with her silky-soft tails, and guides it to kiss her tight pink pucker, licking her lips a bit as she does so.  Holding onto her wide, curvy hips, you dig your fingers into her flesh and firmly begin to push your " + this.player.cockHead(x) + " against her ass, gasping in pleasure when it slips inside with surprising ease.  Her muscular flesh ring stretches magnificently, welcoming your shaft into its depths and encompassing it with warmth.  You groan a bit as her colon ripples and squeezes around you in ways you never would have thought possible.\n\n");

        this.outputText("\"<i>Don't act so surprised, dear,</i>\" the kitsune says in between moans, working the muscles of her ass to make the cheeks quiver and jiggle independently.  \"<i>It's almost like you've never fucked a kitsune's ass before.</i>\"\n\n");
        ...
        this.outputText("\n\nThe kitsune's tongue hangs out at an odd angle, lolled to the side while she catches her breath.  " + ((this.player.cumQ() > 2400) ? "As you pull out, a veritable torrent of spooge follows your cock, pouring out onto the ground.  Even with a small pond's worth of your cum beneath her, her stomach still maintains a healthy bulge, one of her tails idly stroking across it." : "Her muscles clench instinctively as you pull out, trapping your load inside her while a tail idly strokes her stomach.") + "\n\n");

        this.outputText("\"<i>Heh...  not bad for...  a mortal,</i>\" she says, resuming her previous teasing, though you can tell her heart isn't in it by the satisfied look on her face" + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0) ? " and the lazy droop of her spent, flaccid member" : "") + ".\n\n");

        this.outputText("You take a moment to recuperate, and then begin to gather your things, but when you turn your attention back to the kitsune, there's no sign of her save for the sound of a feminine giggle drifting through the leaves.");
        //Advance time 1hr and return to camp. +Sensitivity, +Libido
        this.player.orgasm();
        this.dynStats("lib", 1, "sen", 1);
        this.cleanupAfterCombat();
    ...
    private tribbingWithAKitsune(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("You eye her suspiciously for a bit, cautiously edging closer to her prone form.  The proverbial bag of tricks seems to be spent, however, and she allows you to close the distance without further harassment, slowly crawling backward across the grass.  Her cautious retreat is unable to outpace your approach, and before long you are planting your hips squarely atop hers, pinning her to the ground" + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0) ? ", her cock pressed to her stomach" : "") + ".\n\n");

        this.outputText("She laughs awkwardly, smirking deviously as you lean in, her deep emerald eyes mere inches from your own.  You press your lips to hers, running your hand through her hair and stroking the sensitive backs of her ears with your fingertips while undressing her with your free hand.  A moan rumbles up through her chest and into your lips, her cheeks burning a deep, flustered red as she begins to lean back, submitting to your passions.\n\n");

        this.outputText("The heat of her loins radiates up into yours, elevating your passion to new heights as you pin the kitsune's shoulders to the ground, sliding your hips to and fro across her pubic mound.  As you grind your pelvis back and forth across hers, your [clit] occasionally slips down into the cleft of her pussy, flicking across her own engorged pleasure bud and sending a buzzing wave of pleasure up your spine." + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0) ? ((this.player.cocks.length > 0) ? "  Together with hers, your cocks twitch and bounce" : "  Her cock twitches and bounces") + " against her stomach each time your hips ride forward, a thread of precum connecting to her navel from the tip." : "") + "\n\n");

        this.outputText("Each time your [clit] passes across hers, you shudder with pleasure, but you soon realize that the position you have taken is...  lacking.  You simply aren't optimally angled for the sort of nerve-shattering pleasure that you seek - this must be remedied.\n\n");

        this.outputText("You quickly flip yourself around, sliding your hands up her luscious thighs and taking hold of her calves.  She yelps in startled bemusement as you flip her hindquarters upward, bending her back over herself so that she is folded double in a lewd contortion, her genitals dripping sweet nectar onto her face.\n\n");

        this.outputText("\"<i>Haha, what do you think you're doing, you silly mortal...</i>\" she says, chuckling as you position yourself over her, settling your [butt] down on her splayed thighs, your " + this.vaginaDescript() + " meshing seamlessly with hers." + ((this.player.cocks.length > 0) ? this.sMultiCockDesc() + " drape" + ((this.player.cocks.length > 1) ? "s" : "") + " over the plump round cheeks of her prodigious posterior, leaking strands of precum onto her bundle of luxurious tails" + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0) ? ", while her own member dangles a few inches above her nose." : ".") : "") + "  When your slow, measured grinding resumes, you moan with approval, finding this new position to be much more satisfying.\n\n");

        this.outputText("Each time you rock your hips forward, her swollen clitoris glides up between your lady lips, and each time you drop down, it meets yours with a fantastic flick." + ((this.player.clitLength > 4) ? "  You gasp as without warning, your [clit] slides easily into her warm, moist passage, drawn into the slick folds of her pussy by a strange sucking sensation.  Her warm vaginal walls compress around you, conforming to the contours of your oversized ladyhood and squeezing tight." : "") + "  Your hands travel down to her expansive hind end, sinking your fingers deep into the soft, pliable flesh and pulling her hips flush against yours.  It jiggles and wobbles like gelatin, ripples flowing through it each time you thrust your hips forward, delightfully distorting the design inscribed upon it.  Continuing the slow, methodical grinding of your groin against hers, you knead her large ass like a mound of soft dough, squeezing and groping it lustfully while moaning in approval.\n\n");

        this.outputText("\"<i>Mmn, oh, that's the spot,</i>\" she coos, pushing her flexible frame upward with her legs stretching to the ground near her shoulders, arms spread out for support.\n\n");

        this.outputText("She matches your grinding thrusts with her own, her sextet of tails curving toward your body like a group of furred serpents.  They coil around you teasingly, tickling across your body in slow and sensual curls, and then begin to drift southward," + ((this.player.cocks.length > 0) ? " wrapping around [eachCock] tenderly and" : "") + " slithering their way around to your rear.  The silky fur bristles along your bottom as her tails constrict around you, and one of the bushy coils works its way down to your nethers, teasing the edges of your labia.  The tip of her tail gently flicks across the upper surface of your [clit], sending a shock of pleasure through you, but it doesn't stop there - with the sound of a flint striking against steel, she conjures a blue flame at the end of her tail, and before you can protest, presses it firmly against the base of your womanhood.\n\n");

        this.outputText("Dazzling tongues of mystical azure lick at your [clit], intensifying every sensation and magnifying your pleasure tenfold as a cool tingling begins to creep through your nerves." + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0) ? "  Your engorged ladyhood swells with the added pleasure, and you can feel the kitsune's pussy growing tighter...  or is it that your clitoris is growing larger?  Regardless of the cause, it feels incredible, and you can only start bucking your hips with a renewed fervor, squeezing her ass as you piston yourself fervently into her inviting hole." : "") + "\n\n");

        this.outputText("She joins you in a lewd chorus, thrusting herself up against you and grasping her own breasts excitedly, flicking her turgid nipples with her fingertips." + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0) ? "  A constant stream of precum dribbles from her cock now, casting a thin, glistening sheen onto her face and breasts." : "") + "  You buck your hips back and forth strongly, gradually building momentum in pursuit of your ever-nearing climax.  The steady 'schlick-schlick-schlick' sounds of lustful tribadism fill the forest, threads and beads of feminine juices connecting your " + this.vaginaDescript() + " to hers and smearing across each other's groins messily.\n\n");

        this.outputText("Like a coiling spring, a tension slowly culminates in your intermeshed netherparts, climbing steadily as a path of heat radiates through your womb.  You lurch forward, a moan catching sideways in your throat as you feel a slender finger sliding up against your [asshole], gently wriggling its way inside.  The addition of this intruder has you near the limits of your endurance, trembling with restraint and digging your fingers deeper into the soft, voluptuous doughiness that is her breathtaking backside.  Deciding to return her kindness, you circle her tensed pucker with a fingertip, plunging it in up to the knuckle.  Her anal ring spreads around your finger without quarrel, the warmth of her rectum drawing the invasive digit inside invitingly" + ((this.player.clitLength > 4) ? ", and her vagina immediately tense around your [clit] in response, trapping it in a vacuumlike suction" : "") + ".\n\n");
    ...
    private tailJobKitsuneWin(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("Eying her silky tails, you come up with a wonderful plan to relieve some tension.  Working quickly, you untie the sash around the kitsune's waist and then retie it so that her arms are pinned to her sides.  Turning her onto her back, you prop her up against a tree and then begin to strip out of your " + this.player.armorName + ", reaching down to gather up her six tails in your arms.  She looks up at you curiously, watching as you wrap one of the fluffy coils around [eachCock], slowly dragging your fingertips through the lustrous fur.  As your fingers slide across their fluffy surface, she gives an involuntary shudder, her cheeks flushing a slight pink.  The tail seems to constrict around you automatically, and without any further encouragement needed the tight ring of fur begins to slide up and down, squeezing and massaging your shaft" + ((this.player.cocks.length > 1) ? "s" : "") + " sensually.\n\n");

        this.outputText("The level of control she has over her tails is absolutely marvelous!  They stroke and tickle along your groin, running their soft, brushlike tips across every inch of exposed flesh that they can find." + ((this.player.balls > 0) ? "  One warm coil begins to wrap itself around your " + this.ballsDescriptLight() + ", leaving the underside exposed so that the tip can curl down, sliding gently back and forth over the seam to send shivers up your spine." : "") + ((this.player.cocks.length > 1) ? "  Her remaining tails begin to weave in between your cocks, curling and wrapping around the shafts.  As they slide up and down, they begin to gently constrict, acting like furry cock rings." : "  Her remaining tails wrap themselves around your member, sliding up and down along the shaft.  One of them coils around your " + ((this.player.hasSheath()) ? "sheath" : "base") + " and begins to constrict it gently, acting like a furry cock ring.") + "  You feel like you could cum almost instantly from their incredibly delicate touch, but every time you feel your climax coming on, the kitsune holds back.\n\n");

        this.outputText("\"<i>Silly mortal...  Are you actually getting off on my tails?</i>\" she teases, looking up at you with a coy smirk as she works her tails, one of them sliding up to stroke under your chin patronizingly.  In spite of her words, the pink blush on her face betrays her true pleasure, her furry tails bristling with each gentle motion they make.\n\n");

        this.outputText("You stammer in protest, " + ((this.silly()) ? "telling her that it's not like you enjoy her super soft tails or anything." : "telling her that she's your prisoner and should behave as such.") + "  She giggles a bit and nods submissively, saying no more and lying back against the tree trunk as her tails continue to tease and caress you.\n\n");

        this.outputText("Seeking something for your hands to do, you prop yourself up on the tree above her with one arm, thrusting your hips against her tails as your free hand slides through her hair lightly.  Over and over again she brings you up to the verge of orgasm, dangling you over the edge teasingly and then pulling you back from the brink at the last second.  It's pure, wonderful torture, and if it didn't feel so good you might be angry at her for having the audacity to pull something like this when she's supposed to be your captive.\n\n");

        this.outputText("It is at the height of one such cycle of pleasure and denial that you feel something cool and tingly washing over you, looking down to see the kitsune's lips pursed at " + ((this.player.balls > 0) ? "the underside of your " + this.ballsDescriptLight() : "the " + ((this.player.hasSheath()) ? "sheath" : "base") + " of your " + this.cockDescript(0)) + ", gently blowing pale flames across your groin.\n\n");

        this.outputText("The intense tingling is all that you needed, hurtling off the edge and into the full force of your climax.  [EachCock] pulses, the tight rings of fur preventing you from achieving your full release even as your muscles spasm in vain." + ((this.player.balls > 0) ? "  Thick spunk begins to well up in your " + this.ballsDescriptLight() + ", making them swell terribly with backed-up seed." : "") + "  Thankfully she seems to tire of teasing you shortly, and withdraws the offending tails.  ");
        if (this.player.cumQ() <= 150) {
            this.outputText("Your thrice prolonged orgasm explodes in her face, streams of thick jism firing out onto her forehead and cheeks, dripping down over her lips.  Sighing slightly, she begins to clean herself off, licking up whatever is within reach of her tongue and wiping the rest off using her sash as a towel.");
        }
        else if (this.player.cumQ() <= 350) {
            this.outputText("Thick ribbons of cum splash across her forehead, matting down her hair and dripping slowly down her face.  Licking up whatever is within reach of her tongue, she cleans the rest off with her hand, using her sash as a towel.");
        }
        else if (this.player.cumQ() <= 1000) {
            this.outputText("You drench her face with thick streamers of spunk, surprising her a little with the volume as you give her a nice thick facial.  She licks up a few of the thick globs that hang around her lips, using her sash as a towel to clean up the remainder.");
        }
        else if (this.player.cumQ() < 2500) {
            this.outputText("Your load erupts all over her face, matting down her hair and covering her with a thick layer of warm, sticky semen.  Heavy globs of jizz dribble down her cheeks and land on her chest, a few errant steams weighing down her ears.  Thoroughly showered in your cum, she runs her tongue along the outside of her lips, and then begins to wipe the rest off using her sash as a towel.");
        }
        else {
            this.outputText("You utterly soak her with your virile ejaculations, releasing thick ropes of semen all over her front.  Her hair, face, and chest are thoroughly drenched with your cum, dribbling down and slopping onto the ground loudly.  She runs her tongue along the outside of her mouth, swallowing whatever she can reach, and then begins to clean herself off, using her sash as a towel.");
        }
        ...
        this.outputText("\"<i>Come look me up anytime, dear!</i>\"  she calls back when she is safely out of sight.  You briefly consider giving chase, but decide it is not worth the effort, gathering your " + this.player.armorName + " and turning back toward camp.");
    ...
    private kitsunesGetBonedBy3PlusTentacles(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("You slowly approach the fallen fox-woman, eying her warily and keeping a safe distance in case of any tricks she still has up her sleeve.  She slowly edges away from you with each step you take toward her, yelping in surprise when you swoop down to grab her by the arms.  She tries to scramble to safety, but her struggles only succeed in sprawling her flat on the ground as she gets tangled in her robes.\n\n");

        this.outputText("You pin her down, leaning in low, and begin to undress her slowly, running your hands lecherously across her curvaceous form.  Her breasts spring free with a tantalizing bounce as you spread her robes apart, untying the sash around her waist and tossing it aside.  She continues to thrash a bit, fighting to get free, but her frantic struggles calm quickly as you run a hand through her hair, scratching the backs of her ears gently.\n\n");

        this.outputText("You trail your fingertips slowly over her smooth skin, tracing the edges of her many exotic tattoos on the way to her plump posterior.  Your fingers sink deep into the cushiony flesh, her expansive rear jiggling enticingly as you squeeze and manipulate it.  Experimentally, you give the fleshy globes a small flick with your finger, eliciting a startled cry from the kitsune.  The rounded cheeks wobble and quiver heavily, flesh rippling and jiggling beneath your hand like gelatin.\n\n");

        this.outputText("Softly, you begin to stroke the fine hairs at the base of her six luxurious tails, chuckling as the pink tone on her cheeks deepens to an intense crimson.  The fur on her tails stands on end with the lightest brush of your fingertips, and small tears well up at the corners of her eyes, her breath becoming labored and quick.  Once she has been satisfactorily reduced to a trembling heap of arousal from your insistent petting, you pull back to strip out of your " + this.player.armorName + ", working slowly and teasingly to give the coy trickster a taste of her own medicine.\n\n");

        this.outputText("As your " + KitsuneScene.num2Text(this.player.tentacleCocks()) + " writhing tentacles twist free of the confines of your " + this.player.armorName + ", the kitsune's eyes open wide with desire, her jaw hanging slack and her tongue lolling out of her mouth.  A trail of drool slides down her chin as she hungrily gawks at your slithering tendrils, leaning forward to crawl on her hands and knees toward you.\n\n");

        this.outputText("\"<i>Tentacles...</i>\" she whispers in an almost reverent tone, reaching up to grasp the largest of them, squeezing it tenderly.  Before you know it, she has her face buried in your crotch, eyes closed and humming happily as her hands glide up and down your wriggling, plantlike shafts.\n\n");

        this.outputText("Your tentacles coil instinctively around her arms, wrapping around her shoulders and drawing her even tighter into your brace of tendrils.  She inhales deeply through her nose, savoring the thick, musky smell of your cocks as her face is buried in your groin.  Her tongue slides out along the underside of your largest tentacle dong, her palm caressing it a bit farther up the shaft.  When you look down, her crystal-clear green eyes are rolled back into her skull, an expression of pure ecstasy plastered across her face.  Her cheeks burn hotly against your numerous tentacle pricks as she rubs her face against them eagerly, groaning with pleasure.\n\n");

        this.outputText("\"<i>So strong...  so thick...</i>\" she moans, sliding her tongue along one wriggling shaft and stroking two others eagerly.  \"<i>Oh, if I'd known...</i>\"\n\n");

        this.outputText("She twitches with delight as your muscular tendrils slip under her armpits, lifting her off the ground.  Her tails lash out, wrapping around whatever they can reach, the serpentine coils of fur caressing your plethora of cocks with a worshipful passion.  Without hesitation, she raises her legs into the air, pulling her ankles up to her ears with her own tails and holding them there.\n\n");

        this.outputText("A trembling moan escapes her throat as a pair of your writhing members begin to slide against her groin, one running across her drenched slit while the other threads itself between her plump cheeks." + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0) ? "  Your tentacle slithers around her cock swiftly, wrapping tightly around the base and squeezing it from end to end." : "") + "  Moaning lewdly, she tries to buck her hips toward you, having some difficulty due to her odd positioning and entanglement in the twisting jungle of your cocks.\n\n");

        this.outputText("The head of the largest cock gently parts her glistening pussy lips, rubbing along her swollen cherry-colored nub and teasing her entrance.  Her nethers squeeze around your tentacle's crown, the muscles rippling over the head and suckling on it hungrily as though trying to draw it inside her body.  She nudges her hips toward your cock eagerly, nodding furiously and whimpering while doing her best to make her desires abundantly clear.\n\n");

        this.outputText("You oblige her with a moan, burying a foot of tentacle into her sloppy snatch with a single thrust.  She groans in approval, her mouth hanging open, and you quickly move one of your squirming tendrils to fill the opening.  Her throat relaxes to accept the intruding member, and before you know it you have her strung up from both ends, driving her mad with pleasure.\n\n");

        this.outputText("Her fingers and toes curl around different parts of your vinelike shafts, stroking them with an adoring fervor.  Your third tentacle continues to writhe obscenely between her fleshy butt cheeks, spreading slick precum around her rosy anal ring.  Her violation becomes complete as your wriggling tentacle plunges swiftly into her tight rear passage, spearing her rectum on a foot of your throbbing plant length.  The warm, inviting tunnel ripples around you, strong musculature working to draw more and more of your squirming tendril inside.\n\n");

        this.outputText("A garbled moan fills the air as her throat vibrates around your second tentacle, her body convulsing in a confused cycle of tensing and relaxation.  Her face glistens faintly as trails of tears roll down to join the lines of drool that dribble from the corners of her mouth, though they can only be tears of pleasure judging from how furiously she continues to drive herself against your thrashing phalluses.\n\n");

        this.outputText("Her hands tremble and shake, reaching out for you pleadingly.  She grasps your shoulders with a vicelike grip, lowering her legs to wrap around your [hips] and pull her tighter to your form.  With her newfound stability, she begins to thrust herself against your tentacles in earnest.  Tears of joy stream from her eyes as you pummel her orifices mercilessly, her flesh distorting visibly from the intrusion of your distended tendrils." + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0) ? "  Her cock trembles and throbs within the coils of one of your tentacles, spurts of precum flinging out as you roughly stroke the pulsing shaft." : "") + "\n\n");

        this.outputText("Your hands glide down her body, drawing her deeper into your tangle of obscene tentacle dicks so that you can grope her fleshy curves.  Again, your fingertips sink into her squeezable ass, your other hand groping her breast roughly.  Her body grinds up and down against yours, afloat in a sea of pleasure and tentacles as she is driven through from end to end.\n\n");

        this.outputText("\"<i>M'm, M'm Fhumming!</i>\" she yells out around your plantlike shaft, her words muffled by the indistinct sounds of slurping and sucking.\n\n");

        this.outputText("A hot gush of femcum sprays from her sodden snatch, her muscular walls trembling and pulsing around you.  Incredibly, it feels like her cunt is actually pulling your vinelike member even deeper inside her absurdly spacious - yet paradoxically tight - vagina.  Her anus clenches tightly around its own invader, the strong muscles of her rectum drawing it inward as well and milking the shaft powerfully." + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0) ? "Her cock throbs and twitches in the coils of your tentacles, " + ((this.player.cor > 15) ? "on the verge of climax.  Just as she is about to achieve release, you cinch the tendril up around her base, grinning.  See how <i>she</i> likes being tricked!\n\nHer shaft swells inordinately below the coil of vine, throbbing and twitching in vain as she tries desperately to overcome the blockage.  Her face contorts into a grimace of pain with the slightest hint of masochistic bliss.  She squirms and writhes in your grip, muffled pleas gurgling around the tentacle in her throat, and finally you decide that she's had enough.  You lean back and angle her twitching rod away from yourself, releasing your grip, and her cock begins to spasm uncontrollably," : "") + "a thick ribbon of cum erupting from her twitching cock and hanging in the air suspensefully before plummeting onto her face.  It is the first of many such streams that spurt from her swollen phallus like a lewd fountain, coating her body with a generous sheen of pearly jizz." : "") + "  You continue to violate her orifices with your frenzied pummeling, pleasure and pressure building in your " + ((this.player.balls > 0) ? this.ballsDescriptLight() : "prostate") + " until finally boiling over in a roiling, trembling orgasm.\n\n");

        this.outputText("You moan in ecstasy as your thick load works its way up the lengths of your tentacles, ");
        if (this.player.cumQ() <= 150) {
            this.outputText("depositing thin ribbons of warm spunk into her body from three directions.  Her ass, throat, and pussy all work together to squeeze out every ounce of semen you can muster, milking your loins with a powerful suction.");
        }
        else {
            this.outputText("dumping hot streams of spunk into her innards from three directions." + ((this.player.cocks.length > 3) ? "  Your excess members spurt sticky streamers across her body, coating her in a glistening web of spunk." : "") + "  Her ass, throat, and pussy all work together to squeeze out every ounce of semen you can muster, milking your loins with a powerful suction.");
        }
        if (this.player.cumQ() > 350) {
            this.outputText("The bases of your writhing tentacles distend slightly as your thick load works its way through them, stretching her lips, asshole and cunt around the swelling shafts when it forces its way past.  ");
        }
        if ((this.player.cumQ() > 350) && (this.player.cumQ() <= 1000)) {
            this.outputText("Hot globules of semen are deposited into her innards from three directions" + ((this.player.cocks.length > 3) ? "while her body is showered with sticky streamers from your excess members " : "") + ", your virile seed stuffing her holes to capacity.  The strong muscles of her ass, throat, and pussy work in tandem, squeezing along the length of your tentacles to draw out all the semen you can muster.  Her abdomen swells slightly from the volume as you pour your sticky spunk into her, distending her womb and stomach while her intestines flood with seed.");
        }
        if ((this.player.cumQ() > 1000) && (this.player.cumQ() < 2500)) {
            this.outputText("You dump load after load of hot spunk into her from three directions" + ((this.player.cocks.length > 3) ? ", your extra cocks showering her from head to toe in a sticky white web of jism" : "") + ", virile seed stuffing her holes to capacity.  Her ass, throat, and pussy work in tandem, milking your cocks with strong squeezing along their lengths.  The volume pouring into her causes her abdomen to balloon outward into a jiggling belly, flooding her womb and innards while thick streams of seed overflow from her abused nethers, spurting out forcefully and splattering on the ground.");
        }
        if (this.player.cumQ() > 2500) {
            this.outputText("Your cocks drill liter after liter of creamy spunk into her from three directions" + ((this.player.cocks.length > 3) ? ", covering her body from head to toe in thick, musky cum and" : ",") + " flooding her innards with thick seed.  Her ass, throat, and pussy work in tandem, drawing out every ounce of seed that you can muster with a powerful suction and muscular squeezing along their lengths.  Her stomach swells up with your cum, jiggling outward heavily and forcing her body away from yours as it stretches to accommodate the expanding volume of seed.  In time, she is filled up to capacity, her orifices clamping down in vain to contain the remainder of your prodigious emissions and failing absolutely.  Pressurized streams erupt from all three orifices, twin jets of semen spurting from her nostrils and soaking her front.");
        }

        this.outputText("\n\nPanting with exertion, you hold her warm body close to yours for some time, watching sense gradually return to her brutalized body.  One by one, your tentacles withdraw, lowering her" + ((this.player.cumQ() > 350) ? " bloated" : "") + " body to the ground carefully.  Her chest heaves deeply, " + ((this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0) ? "her cock flopping limply over her thigh as your tentacle releases its grasp and her" : "") + " tongue hanging out of one side of her open mouth.");

        this.outputText("\n\nShe lazes in the grass in a relaxed stupor, a huge grin plastered across her face.  Her hands slide down across her skin " + (((this.player.cocks.length > 3) || (this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0)) ? "and draw trails in the semen smearing her front" : "") + ((this.player.cumQ() > 350) ? ", caressing her cum-filled belly" : "") + " while she moans in satisfaction, uttering a heaving sigh of approval.\n\n");

        this.outputText("\"<i>Tentacles...</i>\" she repeats, shuddering from head to toe.");
        //Advance time 1hr and return to camp.  +Sensitivity, +Libido
        this.player.orgasm();
        this.dynStats("lib", 1, "sen", 1);
        this.cleanupAfterCombat();
    ...
    private fuckDraftBlond(): void {
        ...
        this.outputText("You smirk mischievously, getting a particularly evil idea.  If she likes tricks so much, well, you've got one hell of a trick for HER!  You reach into your pouch and pull out a vial of bubbling red potion, running your finger over the word \"Fuck\" inscribed on the side.\n\n");

        this.outputText("\"<i>Hey...  wait, what are you do-</i>\"\n\n");

        this.outputText("She cries out in protest as you wrestle her to the ground, uncorking the draft with your thumb and using your other hand to plug her nose.  You press the mouth of the vial up to her lips insistently, and it isn't long before she has to gasp for fresh air, allowing you to dump the contents down her throat.  She coughs and sputters a little, trying to spit it out, but you put a bit of pressure on her jaw to prevent exactly that, massaging her neck gently to help coerce her to swallow.  The moment the potent aphrodisiac begins to flow down her throat, you can feel the surface of her skin turn feverish with lust, a blush of deepest crimson spreading across her face.\n\n");

        this.outputText("The powerful scent of feminine musk fills the air almost instantly, a viscous puddle spreading between her legs and soaking through the crotch of her robes." + ((this.player.dogCocks() > 0) || (this.player.inRut) ? "  As the potent smell fills your nostrils, your " + this.cockDescript(x) + " swells in anticipation, reacting instinctively to the scent of a female in heat.  Lurid fantasies of plugging her sloppy snatch with your " + ((this.player.dogCocks() > 0) ? "knot" : this.cockDescript(x)) + " and stuffing her belly full of kits rush into your mind unbidden" + ((this.player.cor < 20) ? ", disturbing you slightly" : "") + "." : "") + "  Her body trembles and quakes with carnal need, pure animalistic desire burning in her eyes.  As the effects of her chemical-induced heat come into full swing, she struggles to maintain some semblance of rational thought, desperately willing herself to crawl away.\n\n");

        this.outputText("You look on with mild amusement as she drags herself one, two, three feet away, and collapses in a shivering wreck, raising her ample rear into the air.  Her hips flex and pump in defiance of her will, all six of her golden tails raised high and fanned out as she claws out of her robes, exposing her drenched fuckhole and gorgeous tattooed ass.\n\n");

        this.outputText("\"<i>Oooh gods, what did you DO to me?!</i>\"  she demands in between gasps of pleasure, plunging her hand into her soaked twat and pounding her fingers in and out furiously.  \"<i>S-sooo...  hot...  I feel...  Ah!  For the love of Marae, j-just fuck me!</i>\"\n\n");

        this.outputText("You " + ((this.player.cor < 33) ? "stifle a laugh, observing her somewhat humorous plight." : "laugh uproariously, relishing the proud kitsune's utter humiliation.") + "  Her face twists into a beautiful grimace of climactic pleasure, her tongue lolling out shamelessly as she rolls her eyes back and orgasms, abruptly and violently.  Clear feminine cum pours from her convulsing pussy, splattering on the ground in a thick puddle.\n\n");

        this.outputText("With her cheek mashed into the ground, she squirms and bucks her hips, panting heavily.  Her hand dives into her snatch again and again, disappearing into the hungry folds of flesh over and over.\n\n");

        this.outputText("\"<i>Hh...  Why isn't this working!?</i>\"  she cries desperately, tears forming at the corners of her eyes.  \"<i>I...  ah...  cum!  Please, I-I need cum inside me, NOW!</i>\"\n\n");

        this.outputText("You grin a bit at her declaration, reaching forward and sliding your finger down her spine gently.  She practically collapses under your light touch, convulsing in pleasure as every one of her tails bristles in response, nearly orgasming again from that alone." + ((this.player.cor < 33) ? "  You wonder if you've gone too far, and whether you should be somewhat concerned for the poor thing's sanity.  If you don't do something to satisfy her insatiable lust, though, that alone might be enough to break her." : "  You grin evilly, dragging your fingertips down your new pet's back and laughing as she spasms uncontrollably, spraying femcum unceasingly.  The little cocktease was so keen on making a fool of you before - where's her smug sense of superiority now?") + "\n\n");

        if (this.player.dogCocks() > 0 || this.player.inRut) this.outputText("The sweet musk of her voluminous fem-jizz fills your mind with a lustful haze, higher-order thought processes gradually shutting down as animalistic mating instinct begins to take over.  ");
        this.outputText("You slide your " + this.cockDescript(x) + " up between the supple mounds of her ass, groaning in pleasure as she begins to glide her hips back and forth along the shaft, cooing softly.  The warm, moist breath radiating off her sodden vagina caresses your ");
        if (this.player.balls > 0) this.outputText(this.ballsDescriptLight());
        else this.outputText(this.player.legs());
        if (this.silly()) this.outputText(" with a heat you could roast marshmallows over.");
        else this.outputText(" with a heat that sends blood rushing to your groin.");
        this.outputText("  She raises her hips higher, whimpering a little as she desperately tries to line up your " + this.cockDescript(x) + " with her hungry fuckhole.\n\n");

        this.outputText("\"<i>S-stop t-teasing...</i>\" she says breathlessly, whimpering as she fails to catch your " + this.player.cockHead(x) + " in her quivering snatch for the third time in a row.  Her hips clumsily rock back, a desperate whine escaping her throat as she tries to calm her shaking body enough to finally impale herself on your ever-hardening rod.");
        if (this.player.dogCocks() > 0 || this.player.inRut) {
            this.outputText("  Your animalistic need to impregnate the fertile female in front of you battles with your desire to tease her, but impulse is quickly winning out over rationality.  You can only hold yourself back for a few moments longer before you give in to baser instincts and plunge your shaft into her needy pussy");
            if (this.player.cockArea(x) > 50) this.outputText(" heedless of whether she can handle it or not.  Thankfully, you needn't worry - her cunt eagerly swallows your cock whole with room to spare, somehow");
        }
        else {
            this.outputText("  Her needy thrusts do their part to endear you to her desperation, rapidly breaking through your desire to tease her.  You hold out for just a bit longer before finally succumbing to your lusts, driving your rod deep into her needy pussy");
            if (this.player.cockArea(x) > 50) this.outputText(" heedless of whether she can handle it or not.  Thankfully, you needn't worry - her cunt eagerly swallows your cock whole with room to spare, somehow");
        }
        this.outputText(".  Her insides feel like a furnace, the slick walls closing in around your cock, rippling along the length intensely.\n\n");

        this.outputText("A jet of warm girlcum splashes out against your " + ((this.player.balls > 0) ? this.ballsDescriptLight() : this.player.legs()) + " as the kitsune claws at the ground, launched into the throes of another orgasm.  Her walls convulse around your throbbing cock, gripping you like a vice.  They suck you deeper inside, prompting you to begin vigorously thrusting your hips, your loud moans joining her cries in a chorus of pleasure.  As her trembling orgasm begins to subside into the more manageable pleasure of mating, she begins to slam her ass back to meet you, each thrust forcing the air from her lungs and punctuating each moan with a loud grunt.\n\n");

        this.outputText("\"<i>Nngah!  Fuck!  I-it feels s-so good!</i>\"\n\n");

        this.outputText("You dig your fingertips into her massive, plush ass and begin to pound her wet snatch with all your might, grunting and groaning passionately.");
        if (this.player.dogCocks() > 0 || this.player.inRut) this.outputText("  Vivid fantasies of stuffing her pussy full of your virile semen race through your mind, unable to think of anything else.  Come whatever may, you know you MUST impregnate her - there's simply no other option.");
        this.outputText("  The force with which she mashes her voluptuous derriere back into your pelvis would surely leave you sore in the morning were it not for the expansive tattoo-adorned ass cushioning the blows.\n\n");

        //if (dogCocks > 0)
        if (this.player.dogCocks() > 0) {
            this.outputText("The lips of her slippery pussy stretch over your canine knot a little more with every thrust, and with one last savage assault you force the bulge inside her, shaking from head to toe in pleasure.\n\n");

            this.outputText("The kitsune rolls her eyes back and opens her mouth in a cacophonous scream of pleasure, stunned stiff by her hardest climax yet.  Her inner muscles contract around your knot powerfully, rooting you in place as steaming hot orgasmic juices gush out over your groin.\n\n");

            this.outputText("Despite the minor difficulties you had squeezing it inside, her vagina accommodates your knot quite nicely, wrapping around the veiny bulge and rippling pleasantly as she gradually comes down from her high once more.  Tears of pleasure stain her cheeks, mixing with the shameless drool that pools under her chin, her mouth permanently agape in an expression of purest lust.\n\n");
        }
        this.outputText("Gathering her tails into your arms, you pull them tight to your chest, eliciting a pleasured moan from the lust-maddened kitsune.  She lets out a pained squeal when you tug on them suddenly, using them for additional leverage as you redouble your powerful thrusting.  You can feel every pulse of her fluttering heartbeat through the walls of her vagina, liquid heat caressing and milking your cock as more juices squirt out around your " + ((this.player.dogCocks() > 0) ? "knot" : this.cockDescript(x)) + ".\n\n");

        this.outputText("Your pleasure begins to rise to a head, every passionate thrust bringing you closer and closer to your final, incredible release.  In preparation, you drop down over her, placing your hands on top of " + ((this.player.cor < 33) ? "hers." : "her wrists to pin her down.") + (((this.player.dogCocks() > 0) || this.player.inRut) ? "  You are stricken with the urge to bite her neck, and indulge it, pinching the scruff of her shoulder between your teeth." : "") + "  With a roaring moan, you buck your hips one last time, slamming down against her well-cushioned rear with one final thrust, holding there as the pressure in your " + ((this.player.balls > 0) ? this.ballsDescriptLight() : "prostate") + " finally boils over.  ");

        if (this.player.cumQ() <= 150) {
            this.outputText("Your cock spasms uncontrollably, spewing stream after stream of potent jizz into her hungry snatch.  The instant it begins to flow inside her, she locks down into another incredible orgasm, fingers digging into the dirt while tears flow from the corner of her eyes, moaning powerfully.  Her walls milk and massage you, drinking deeply of your virile cum.");
        }
        else if (this.player.cumQ() <= 350) {
            this.outputText("Sticky ribbons of jizz fire into her hungry pussy one after another, coating her slick walls with your thick, salty cum.  The instant it begins to flow inside her, she locks down into another incredible orgasm, fingers digging into the dirt while tears flow from the corner of her eyes, moaning powerfully.  Her muscles contract and convulse, hungrily milking your cock of every drop it has to offer.");
        }
        else if (this.player.cumQ() <= 1000) {
            this.outputText("Your urethra distends as load after load of sticky jizz flows up the shaft of your cock, frothing into the kitsune's belly.  The instant it begins to flow inside her, she locks down into another incredible orgasm, fingers digging into the dirt while tears flow from the corner of her eyes, moaning powerfully.  As her walls rhythmically milk and squeeze your cock, she begins to develop a slight belly, the swelling bulge jiggling a bit with the weight of your emissions.");
        }
        else if (this.player.cumQ() < 2500) {
            this.outputText("The shaft of your cock swells as thick gobs of cum begin to erupt from the tip, rushing down her sopping fuckhole and pouring into her uterus.  The instant it begins to flow inside her, she locks down into another incredible orgasm, fingers digging into the dirt while tears flow from the corner of her eyes, moaning powerfully.  Her muscles continue to squeeze your shaft hungrily long after your abundant reserves have been depleted, her cum-bloated belly sloshing beneath her, jiggling with the weight of your cum.");
        }
        else {
            this.outputText("You can actually hear the sound of your cum pouring into her, stuffing load after load of potent jizz into her fertile womb.  The instant it begins to flow inside her, she locks down into another incredible orgasm, fingers digging into the dirt while tears flow from the corner of her eyes, moaning powerfully.  ");
            if (this.player.hasKnot(x)) this.outputText("Her belly balloons to a ludicrous size, swelling more by the second as you continue to pump her full.  Your knot blocks the only escape, forcing her to endure as her abdomen swells with your seed, sloshing and jiggling heavily.");
            else this.outputText("The sheer volume is more than she can handle, and when her now heavily pregnant-looking belly begins to press against the ground, pressurized streams start to pour out of her tight hole, splattering against your [hips] and [fullChest].");
            this.outputText("  Despite looking quite as though she has swallowed a beach ball, her sloppy cunt continues to milk your shaft of every drop it can squeeze, even long after your incredible reserves are depleted.");
        }
        ...
        this.outputText(((this.player.dogCocks() > 0) ? "  You try to pull out, but are a little dismayed to find that her pussy still has a vice grip on your distended knot.  Sighing, you collapse on top of her, enjoying the warmth of her flesh " + ((this.player.cor < 33) ? "while gently stroking her golden hair " : "") + "as you wait for the swollen bulge to deflate." : "") + "\n\n");

        this.outputText("She releases a small whimper when your shaft begins to slide out, " + ((this.player.cumQ() > 1000) ? "and a small fountain of spooge follows, spurting out in an arc as her belly deflates to relieve some of the pressure." : "her engorged labia rhythmically squeezing around the sudden emptiness.") + "  Exhausted from pleasure, you pass out on top of her, and she beneath you, lying in a puddle of your combined fluids.\n\n");

        this.outputText("You can't be certain how long you were asleep, but when you come to your senses, you are alone.  A musky trail of fluids leads into the underbrush, and though you doubt that she could have gotten far in her condition, you need to return to check on your camp.  As you gather your things, you pause briefly and smirk, certain you can hear the sound of moaning filtering through the trees.");
        //Advance time 1hr and return to camp. +Sensitivity, +Libido
        this.player.orgasm();
        this.dynStats("lib", 1, "sen", 1);
    ...
    private doseAKitsuneWithOviElixirs(): void {
        ...
        if (x < 0) x = this.player.biggestCockIndex();
        this.outputText("You fish in your pouch for a large hexagonal bottle with a picture of an egg tagged to the neck, holding it up to the light and swirling the thick green liquid inside.  The kitsune eyes you suspiciously as you close in on her, slowly crawling backward until she hits a tree.  She scrambles to escape, failing spectacularly when you " + ((this.player.cor < 33) ? "snatch up a fistful of her robes, yanking her into your arms." : "step on one of her tails, making her yelp in surprise and fall flat on her face.") + "\n\n");

        this.outputText("Holding the bottle in one hand, you push out the stopper with a thumb, wrestling her into submission.  She is unable to put up much of a fight, and you are easily able to subdue her feeble struggles, tipping the crystalline flask into her mouth.  Holding her head back, you keep the lip of the bottle up to her mouth until the last drop has disappeared into her throat, then casually dispose of it, stepping back to watch the show.\n\n");

        this.outputText("\"<i>Uugh...  m-my stomach...</i>\" she groans, her hands traveling down to her abdomen as you hear an audible rumbling from within her.  Her flesh practically bubbles as her belly begins to swell, rounding out into a firm bulge.\n\n");

        this.outputText("Panting lightly, she leans back, supporting herself on a tree to catch her breath.  She grins up at you, managing to breathlessly tease, \"<i>S-so, you UGH...  you like pregnant girls, do you?  You'd better...  HNNG...  take responsibility...</i>\"\n\n");

        this.outputText("It's plain to see that she's trying but failing utterly to maintain her sly demeanor, regularly doubling over and clutching her abdomen as her simulated pregnancy advances another stage.  Her magic must be reacting with the potion's, or something to that nature, as her belly has already almost quadrupled in size since you began your little experiment, hanging out over her hips heavily.\n\n");

        this.outputText("Groaning, she slides down the side of the tree, both of her arms supporting the tremendous weight of her curvaceous stomach.  You're certain something fishy is going on now as her breasts spill out of her robes with a bountiful jiggle, twin streams of milk sprinkling from her rapidly expanding tits.  Ovi Elixirs don't do that, at least not to your knowledge.\n\n");

        this.outputText("She sinks down further, stroking her belly lovingly and laying flat on her back, her swollen milk-udders rising and falling with every labored breath she takes.\n\n");

        this.outputText("\"<i>If you just stand there gawking...  HNnn...  you might miss your chance,</i>\" she says, regaining some of her composure now that the intense swelling of eggs within her uterus has calmed.\n\n");

        this.outputText("Her words snap you from your reverie, and you rush over, hurriedly stripping out of your " + this.player.armorName + ".  You drop to the ground near her and begin to run your hands across her body, squeezing her massively engorged breasts, eliciting a light moan.  She coos softly as you slide your palms over the gravid swell of her stomach, caressing the taut flesh gently.  Your touch travels downward, cascading over her thighs momentarily before spreading them apart to get at the puffy lady-lips in between them.\n\n");

        this.outputText("You gently insert a finger into her moistened cunt, relishing the sound of her moans as you slowly pump your digit in and out.  As your finger slides up her slick pink slit, she shivers quite powerfully, a quickening gurgle issuing from her belly.\n\n");

        this.outputText("Realizing that if you delay for much longer you really will miss your chance, you hastily remove your finger and reposition yourself between her splayed legs, stroking your [cock biggest] up to full mast.  She moans and arches her back a little as the " + this.player.cockHead(x) + " presses up against her warm love hole, though the weight of her stomach makes it a little difficult for her.\n\n");

        this.outputText("As you prepare to plunge yourself into her quivering lips, a pair of golden tails slither up around your throbbing member, one curling around your " + ((this.player.hasSheath()) ? "sheath" : "base") + " while the other slowly tickles across the underside of the shaft." + ((this.player.gender >= 2) ? "  It travels slowly up and down your prick, then drifts down toward your " + this.vaginaDescript() + ", teasing your [clit] gently." : "") + "  Her swollen cunt parts around you easily as you delve into her depths, rippling around your member sensually.  The muscular walls stretch around you, a steady trickle of feminine juices spilling out around your " + this.cockDescript(x) + ".\n\n");

        this.outputText(((this.player.biggestCockArea() > 50) ? "No matter how much pulsating cock meat you stuff into her hungry pussy, her quaking walls continue to stretch on forever, swallowing your shaft greedily.  " : "") + "Your pelvis gently bounces against hers, sending a ripple through her gravid stomach, and you slowly start to buck your hips.  Leaning down over her, you begin to grope and knead her swollen tits, running your hands over the soft, pliable flesh and squeezing firmly to force out a little milk.\n\n");

        this.outputText("She relaxes submissively as you toy with her breasts, running her fingers through her own flaxen hair and moaning loudly.  Her legs wrap around the back of your [hips] strongly, pulling you forward to press against the underside of her belly, and you can feel the gentle rumble of the eggs still growing in her womb.\n\n");

        this.outputText("\"<i>H-having fun, I hope?  AAh, I'm so full...</i>\" she says with a husky moan, rolling her eyes back in pleasure.\n\n");
        ...
        if (KitsuneScene.rand(3) == 0) {
            itype = this.consumables.LARGE_EGGS[KitsuneScene.rand(this.consumables.LARGE_EGGS.length)];
        }
        //Small eggs
        else {
            itype = this.consumables.SMALL_EGGS[KitsuneScene.rand(this.consumables.SMALL_EGGS.length)];
        }
        this.outputText(" about the size of ostrich eggs.  You pick one up and examine it, rolling it in your hand a bit.  A rustling in the bushes brings your focus back to the kitsune, but by the time you look up, all you see is a set of golden tails slipping into the underbrush.\n\n");
        this.player.consumeItem(this.consumables.OVIELIX);
        this.outputText("\"<i>Take good care of my little eggies, darling!</i>\"");
        //{replace normal kitsune loot tables with randomly colored eggs}
        this.flags[kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = itype.id;
        //Advance time 1hr and return to camp. +Sensitivity, +Libido
        this.player.orgasm();
        this.dynStats("lib", 1, "sen", 1);
        this.cleanupAfterCombat();
    ...
    private lactaidDoseAKitSune(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("You lick your lips hungrily, staring at her voluptuous tits, just barely contained in her robes.  Reaching into your pouch, you pull out a bottle of Lactaid and swirl it around in your hand, grinning darkly.  As you lean down over her, the kitsune eyes you suspiciously, her gaze moving back and forth between the bottle and you.  She makes a halfhearted attempt to crawl away, letting out a cry when you grab her by the " + ((this.player.cor < 33) ? "hem of her robe" : "tail") + ", pulling her back.\n\n");

        this.outputText("\"<i>Eheh...  you know all that other stuff before was just playing, right?  Eep!</i>\"\n\n");

        this.outputText("Wrestling her to the ground, you tip the bottle of creamy liquid into her mouth, making it abundantly clear that she's to swallow every drop.  You keep the lip of the bottle pressed up to her mouth until she has obediently swallowed the entire contents, then dispose of the empty container.\n\n");

        this.outputText("Almost immediately, her already sizeable breasts begin to expand, swelling up against the inside of her robes before spilling over with a bountiful jiggle.  She moves her hands up to support her rapidly expanding bust, her tits growing several cup sizes in the space of a minute.  Once the swelling in her breasts begins to slow, her nipples follow suit, the areolae puffing out and swallowing her pinkie-sized nubs.  Slowly at first, a creamy white substance begins to drip from her inverted nipples, the flow increasing gradually over time.\n\n");

        this.outputText("\"<i>M-my chest!  F-feels so...  hot...</i>\" she moans, rolling her eyes back and beginning to play with her breasts, kneading the expansive flesh with both hands as milk trickles down the curves and over her fingers.  All told, you judge her tremendous mammaries to be about H-cups in size, far out of proportion for even her curvy frame.\n\n");

        this.outputText("You grin and rub your palms together lecherously, then reach out to snatch them out of her hands, explaining that her fat milk-udders belong to you now.  With one of her obscenely huge tits in each hand, you press them together, squashing them up between your palms and shuddering at the way they feel.  The incredibly soft flesh spills over your fingertips with every squeeze, milk spurting from her puffy, puckered nipples and drenching her front.  Tentatively, you lift one of your milk-soaked fingers to your lips and lick it, savoring the sweet, almost minty aftertaste that sends an involuntary shudder down your spine.\n\n");

        this.outputText("Pleased with the results of your little experiment, you release her gargantuan jugs, letting them bounce and quiver back into position before standing up.  Shedding your " + this.player.armorName + ", you run your hands down over your groin, lowering yourself down over her once again and scooting up to press against the underside of her breasts.  Laying [eachCock] in between the heaving mounds of titflesh, you gather up her breasts and squash them together again, moaning as the soft skin envelops your throbbing member" + ((this.player.cocks.length > 1) ? "s" : "") + ".  Warm milk trickles down into her cavernous cleavage, flowing over your shaft" + ((this.player.cocks.length > 1) ? "s" : "") + " and leaving behind an odd tingling sensation that makes you shudder.\n\n");

        this.outputText("\"<i>Ooh...  that feels...</i>\" she groans, a soft pink blush spreading on her cheeks as she bites her knuckle.\n\n");

        this.outputText("Your hands stray upward toward her puffy areolae, and you circle your thumbs across the sensitive flesh, eliciting a chorus of shameless moans from the kitsune.  She arches her back, thrusting her chest upward underneath you and spurting copious streams of milk into the air like a lewd fountain.  You press your fingertips down into her pliable jugs, watching the way the jiggling flesh ripples and squashes around your hands with an almost giddy delight.  Even the slightest amount of pressure causes a fresh trickle of milk to spill out of her inverted nipples, dribbling down and filling the expansive canyon in between.\n\n");

        this.outputText("You slowly begin to thrust [eachCock] through the slippery passage, revelling in the way her tremendous tits squeeze around your throbbing shaft" + ((this.player.cocks.length > 1) ? "s" : "") + ".  The warmth of her flesh contrasts wonderfully with the cool tingling of her milk coating your cock" + ((this.player.cocks.length > 1) ? "s" : "") + ", heightening your pleasure to incredible levels and making you groan and shiver.  Her chest rises and falls beneath you with every heaving breath she takes, shuddering with her needy moans.\n\n");

        this.outputText("\"<i>Oh Marae, it feels so good!</i>\"  she moans, rolling her eyes in pleasure as you continue to thrust [eachCock] in between her sensitive tits.  \"<i>Fuck my tits, k-keep going!</i>\"\n\n");

        this.outputText("She moves her forearms up to press against the sides of her breasts, hooking her fingers over the top of her bust and squeezing inward with her elbows.  Freed to move your own hands elsewhere, you knead her nipples for a bit, running your thumbs in wide circles around the edges as you slowly spiral them inward.  Pressing your thumbs inward, you spread the puffy pucker of her areolae, inserting your fingers to get at the sensitive nubs inside.  She cries out in ecstasy when you pinch her engorged nipples, squeezing thick streams of milk out as you pull on them gently, forcing them to pop out.  It is only now that you can truly appreciate the effects of the Lactaid you fed her, her sensitive pink nubs having swollen up to the size of large cherries.\n\n");

        this.outputText("Pinching around the base of her overgrown teats, you tilt them toward her face and squeeze, spurting milk into the kitsune's face.  She winces in surprise at first, but then opens her mouth, catching the streams on her tongue and lapping them up eagerly.  With a firm squeeze, you then aim her engorged nipples toward your own mouth, leaning down to drink deeply.  A good deal of it misses your tongue and begins to drip messily down your chin, but you savor the taste of what little you manage to get in your mouth, humming your satisfaction.\n\n");

        this.outputText("Together with her, you squash her jiggling jugs against [eachCock] as tight as you can and begin to thrust with renewed vigor, sending ripples through her chest each time your hips impact her milk-swollen tits.  She moans shamelessly, craning her neck up to lap up her milk from the tops of her breasts and even running her tongue across [oneCock] whenever it is within reach.  Shuddering heavily, she begins to slide her arms up and down the sides of her chest, adding a little extra sensation to the wonderful titfuck.  Her breasts are constantly gushing milk now, her entire front soaked through and a puddle forming around her on the ground.\n\n");

        this.outputText("Bearing down on her chest, you redouble your thrusting, the telltale quivering of an inevitable orgasm starting to build in your loins.  Loud liquid slapping noises fill the air each time you pass in between her immense udders, milk and precum coating every inch of her cleavage.  With a groan, you buck your hips forward one last time, [eachCock] twitching as your climax boils to the surface.\n\n");

        if (this.player.cumQ() <= 150) {
            this.outputText("Spurts of thick semen bubble out in between her breasts, a few pressurized streams flying across the space from her chest to her face and landing wetly on her lips.  Thick globs dribble down to pool in the shallow depression above her sternum.");
        }
        else if (this.player.cumQ() <= 350) {
            this.outputText("Her cavernous cleavage is filled with your bubbling seed, thick spurts of semen splattering out onto her neck and face.  Her chest is plastered with milk and cum, dribbling and flowing down around her shoulders and chin.");
        }
        else if (this.player.cumQ() <= 1000) {
            this.outputText("Pressure builds in your groin, your shaft" + ((this.player.cocks.length > 1) ? "s" : "") + " swelling up in the moments just before your orgasm.  Thick ribbons of cum spurt from between her tits, flying across her face and neck with a series of wet slaps.  Her chest and face are drenched with a creamy mask of milk and cum, a thick pearl necklace slowly dripping down around her shoulders.");
        }
        else {
            this.outputText("Your cock");
            if (this.player.cocks.length > 1) this.outputText("s swell");
            else this.outputText(" swells");
            this.outputText(" up incredibly from the thick loads of seed rushing out all at once, a thick ribbon of cum splattering against the walls of her cleavage and spurting out onto her face.  Load after load of semen spurts from between her breasts, coating her face and chest with a sticky mask that mats down her golden hair.");
            if (this.player.cumQ() >= 2500) this.outputText("  It seems as though your climax goes on forever, fresh streamers of cum flying everywhere until the milky white puddle surrounding her is equal parts milk and seed.");
        }
    ...
    private hotdogAnalInKitsuneButtDontLetTailTickleYourNose(): void {
        ...
        this.outputText("You let your gaze wander lecherously up and down her prone form, taking your time to observe every voluptuous curve.  Finally your eyes come to rest on her enormous ass, her robes haphazardly rolled up to her hips to leave the jiggling flesh exposed.  A large sun-shaped tattoo adorns the right cheek, accentuating the creamy flesh of the rounded globes with an exotic splash of color.  They quiver heavily with even the slightest movement, jiggling in an almost hypnotic fashion that compels you to come closer.  Before you know it, you are on top of her, lifting her expansive rump into the air and grinding against her in unabashed lust.\n\n");

        this.outputText("She cries out in surprise as you manhandle her into position, but sinks low in submission once you settle into a rhythm, her tails swishing to and fro as they wrap around your body.  The shiny black coils work their way under your " + this.player.armorName + ", pulling them away with a practiced skill.  Fluffy, bushy tails caress [eachCock] gently, drawing " + ((this.player.cocks.length > 1) ? "them" : "it") + " up between the mountainous cheeks of her derriere, stroking " + ((this.player.cocks.length > 1) ? "them" : "it") + " fondly with the tips.  Your hands slide along the wide curves of her hips, sinking into her soft love handles as her quivering hind cheeks gently caress the sides of your " + ((this.player.cocks.length > 1) ? "shafts" : "shaft") + ".\n\n");

        this.outputText("Her tails slide away, leaving [eachCock] to be cradled gently by her prodigious posterior.  Instead, they spread out to frame her cream-colored globes against a blanket of raven fur, enhancing their prominence even more.  Easing down onto her elbows, she rests her head on her arms and gives you a sidelong glance through half-lidded eyes, batting her eyelashes flirtatiously.\n\n");

        this.outputText("\"<i>You like my ass, huh?  Well, what can I say, you clearly have exquisite taste,</i>\" she says with a smirk, punctuating her statement by slapping her rump into your hips gently.  Her ass thuds against you heavily, the sun-shaped marking on the right cheek distorting delightfully as the flesh jiggles and ripples from the impact.\n\n");

        this.outputText("You give her a firm slap on the ass, and she moans in response, rolling her eyes back in pleasure and sinking down submissively.\n\n");

        this.outputText("\"<i>Mmn, again...  Spank me!</i>\"\n\n");

        this.outputText("Another hearty 'crack' echoes through the forest as your palm connects with her ass again, sinking into the pliable flesh and sending ripples through it.  Her tongue lolls out obscenely, the fur on her tails frizzing as she bucks forward, panting heavily.  You feel something warm and wet trickling down the front of your " + this.player.legs() + ", and grin when you realize that she's really getting off on this!\n\n");

        this.outputText("You grip her mountainous cheeks firmly in either hand and squeeze them together around [eachCock], thrusting your hips forward slowly and powerfully.  Her expansive rump is nearly large enough to encompass your " + ((this.player.cocks.length > 1) ? "shafts" : "shaft") + " all the way around, warm flesh squashing and jiggling against " + ((this.player.cocks.length > 1) ? "them" : "it") + " on all sides.  Her hips slide back to meet yours with each thrust, eagerly caressing your " + ((this.player.cocks.length > 1) ? "cocks" : "cock") + " with her quivering bottom, moaning contentedly.\n\n");

        this.outputText("One of her tails slides up against your stomach and curls its way downward, encircling your " + this.cockDescript(x) + " with its fluffy warmth.  It gently constricts the base, squeezing you with just enough pressure to make the veins of your shaft swell against the surface, throbbing gently.  The tip of her tail snaps against the underside once or twice, and with the sound of striking a match, your shaft is suddenly engulfed in azure flames that dance around it, leaving a cooling tingle in their wake.  Every sensation is enhanced by the presence of the flames, icy coolness mixing with an ethereal heat that surrounds [eachCock] on all sides.\n\n");

        this.outputText("You squeeze her hips and thrust forward against her rump a few more times, feeling the tension of your climax approaching.  Enough foreplay, then - it's time for the main event.  Sliding your " + this.cockDescript(x) + " between her shuddering cheeks one last time, you draw back and angle her hips up a bit, lining up against her tight pink asshole.  As you thrust forward, the muscular ring guarding her rectum gives way with a surprising ease, almost drawing you inward of its own volition as it squeezes your throbbing rod.  She licks her lips and pushes her hips back to fully engulf your cock with her warm, tight ass, reaching back to grasp her own ass cheek as she bears down with her anus, trapping you inside.\n\n");

        this.outputText("\"<i>Oh, you're as good as mine, now,</i>\" she says with a pleasureful sigh, her cheeks flushing a deep red as you pull back to plunge forward again, squeezing the cheeks of her ass together around your shaft as you do so.  \"<i>Got you right...  ah!  Where I want...  you...</i>\"\n\n");

        this.outputText("She does, does she?  Somehow, her bluff falls a bit flat, especially when she has to pant it out between gasps of pleasure as you roughly pound into her ass.  Of course, since this was what she wanted in the first place, in a way she's right.  Rather than waste your time thinking about the intricacies of the situation, you resume your rhythmic thrusting, pummeling her rear with your " + this.cockDescript(x) + " as she moans shamelessly in utter bliss.\n\n");

        this.outputText("Strong muscles ripple up and down the length of your rod, squeezing you in ways you previously would have never thought possible.  Her innards clamp around you with an otherworldly warmth, caressing your length and milking the shaft skillfully.  Each time you pull back, it feels almost as though her ass draws you inward again, sucking you back into her depths.\n\n");

        this.outputText("The loud slapping of your hips buffeting her expansive rear fills the air, joining her moans in a percussive rhythm of ecstatic pleasure.  Her tails lash themselves to your limbs, pulling you forward, and in her enthusiasm, she inadvertently loses control, pulling you onto her back.  As you tumble forward, her legs give out, and she collapses beneath you, the sudden impact knocking the wind from her lungs.\n\n");

        this.outputText(((this.player.cor > 45) ? "Without waiting to confirm if she is unharmed," : "After briefly confirming that she is for the most part unharmed,") + " you readjust your balance and resume your rhythm, holding onto her shoulders for support.  As you pull back for another thrust, she closes her thighs together gently, causing her prominent cheeks to become even more pronounced.  They serve well to cushion the blows as you pump downward powerfully, jiggling like gelatin with each pounding buck of your hips.\n\n");

        this.outputText("You grip her love handles tightly, sinking your fingertips into the soft, plushy flesh, and eagerly pummel her tight ass, slapping your hips into her bountiful butt cheeks over and over.  Her thighs tense and relax in time with your thrusts, working along with the inner muscles to give your " + this.cockDescript(x) + " a sensual massage rivalling that of a master masseuse.  Everything above her waist, however, is utterly relaxed, splayed out into a lewd heap of decadent desire.  The merest hint of a sliver of emerald is visible as her eyes roll into the back of her head, her tongue flopping out of her mouth along with a healthy trail of drool.\n\n");

        this.outputText("One last slap echoes through the clearing when you slam yourself into her ass for the final time, moaning in ecstasy as your " + this.cockDescript(x) + " twitches wildly in climax.  ");

        if (this.player.cumQ() <= 150) {
            this.outputText("The convulsing muscles of her rectum milk your shaft strongly, squeezing from base to tip as you spill stream after stream of thick, cloying cum into her innards.  At the peak of your pleasure, you resume your lustful thrusting, her flesh quivering in shallow waves as your orgasm begins to wane.  As the last stream spurts into her abused asshole, you plant your palms against her thick ass cheeks and squeeze them together around your shaft, pulling back slowly as her anus clamps down, milking the last of your load from your urethra.\n\n");

            this.outputText("She lies spread eagle on her face, panting contentedly as her six ebony tails waft left and right in the air.  A small spurt of cum follows your cock shortly after you pull out, dribbling onto the ground between her thighs.");
        }
        else if ((this.player.cumQ() <= 350)) {
            this.outputText("The convulsing muscles of her rectum milk your shaft strongly, squeezing from base to tip as you spill hot ribbons of thick, sticky seed into her innards.  At the height of your pleasure, you resume your lustful thrusting, her flesh quivering continuously as your orgasm begins to wane.  As one last stream spurts into her abused asshole, you plant your palms against her thick ass cheeks, digging your fingertips into the flesh and squeezing them together around your shaft.  Her anus clamps down around your throbbing rod as you slowly pull back, squeezing the last of your load out of your urethra.\n\n");
            this.outputText("She lies spread eagle on her face, panting contentedly as her six ebony tails waft left and right in the air.  A small spurt of cum follows your cock shortly after you pull out, splattering onto the ground between her thighs.");
        }
        else if ((this.player.cumQ() <= 1000)) {
            this.outputText("The convulsing muscles of her rectum milk your shaft strongly, rippling sensations squeezing you repeatedly from base to tip as you pour out thick ribbons of seed into her innards, splattering her intestines with your cloying cum.  At the height of your pleasure, you resume your lustful thrusting, her flesh quivering continuously in time with each powerful spurt of cum as your orgasm begins to wane.  As the last few thick streams fill her abused asshole, you dig your fingertips into her pliable flesh and squeeze her ass cheeks together around your shaft.  Her anus clamps down hard around your throbbing rod as you slowly pull back, squeezing the last of your load from your urethra.\n\n");
            this.outputText("She lies spread eagle on her face, panting contentedly as her six ebony tails waft left and right in the air.  A thick gush of cum follows your cock shortly after you pull out, splattering onto the ground between her thighs.");
        }
        else if ((this.player.cumQ() <= 2500)) {
            this.outputText("The convulsing muscles of her rectum milk your shaft strongly, heavy rippling sensations squeezing you repeatedly from base to tip as you pour out inhuman amounts of seed into her innards, stuffing her intestines with your cloying cum.  A husky groan escapes her throat as she begins to rise off the ground a little, the obscene amounts of semen distending her stomach as you fill her utterly and completely.  At the height of your pleasure, you resume your lustful thrusting, her flesh quivering continuously in time with each powerful spurt of cum as your orgasm begins to wane.  As the last thick streams stuff her abused asshole, you dig your fingertips into her pliable flesh and squeeze her ass cheeks together around your shaft.  Her anus clamps down hard around your throbbing rod as you slowly pull back, hungrily milking the last of your load from your urethra.\n\n");
            this.outputText("She lies spread eagle on her face, panting contentedly as her six ebony tails waft left and right in the air.  An outpouring of cum follows your cock shortly after you pull out, pooling on the ground one stream at a time between her thighs.");
        }
        else {
            this.outputText("The convulsing muscles of her rectum milk your shaft strongly, heavy rippling sensations squeezing you repeatedly from base to tip as you pour out truly monstrous amounts of seed into her innards, stuffing her with your cloying cum.  A husky groan escapes from her throat as she begins to rise off the ground, the obscene amounts of semen filling her stomach like a balloon as your seed surges through her intestines.  Her hindquarters are raised into the air as she tilts forward on her cum-bloated belly, now filled out to the size of an exercise ball.  At the height of your pleasure, you resume your lustful thrusting, her flesh quivering continuously as you fill her to excess, pressurized jets of semen spurting out around your " + this.cockDescript(x) + ".  As the last of your load stuffs her abused asshole, you dig your fingertips into her pliable, cum-streaked flesh and squeeze her ass cheeks together around your shaft.  Her anus clamps down hard around your throbbing rod as you slowly pull back, hungrily milking the last of your load from your urethra.\n\n");
            this.outputText("She lies spread eagle on her face, panting contentedly as her six ebony tails waft left and right in the air.  A continuous river of cum follows your cock shortly after you pull out, pooling on the ground between her thighs in a slippery puddle.");
        }
        this.outputText("\n\nShe rolls onto her side, curling up in a puddle of sweat and sex, resting her hands on her " + ((this.player.cumQ() > 1000) ? "inflated" : "pudgy") + " stomach and sighing contentedly, the tips of her tails gently twitching with residual pleasure.  You take a moment to recuperate, then gather your things and turn toward camp, leaving the insensate kitsune to recover on her own.");
        //Advance time 1hr and return to camp. +Sensitivity, +Libido
        this.player.orgasm();
        this.dynStats("lib", 1, "sen", 1);
        this.cleanupAfterCombat();
    ...
    private getABJFromAFoxGirl(): void {
        ...
        this.outputText("Standing over the beaten kitsune, you hear a barely audible groan.  Curiously, you lean down, and are surprised to find that the sound is coming from the girl's stomach.\n\n");

        this.outputText("She gently rubs her somewhat pudgy tummy, sighing and whimpering, \"<i>So hungry...</i>\"\n\n");

        this.outputText("So, she's hungry, is she?  With a smirk, you tell her you have just the thing to fix that.\n\n");

        this.outputText("Stripping out of your " + this.player.armorName + ", you pull her into a kneeling position and press her back against a tree, presenting your " + this.cockDescript(x) + " with a grin.  She ogles it hungrily and licks her lips, eyes wide with desire.  As she reaches up to take it into her hands, you grab her wrists instead and pin them to the trunk of the tree.  You explain that she is to use only her mouth, and that if she does her job properly, <i>then</i> you will satiate her hunger.\n\n");

        this.outputText("She pouts coyly, pursing her plush, kissable lips.  Your eyes are drawn to them, and it is only now that you notice just how juicy and full-looking they truly are.  As she leans forward to press them to your " + this.player.cockHead(x) + ", they seem to plump up even more, their warm wetness sending a shiver of pleasure through your groin.\n\n");

        this.outputText("Grinning up at you, she dips underneath your shaft, lifting it up with her nose, flattening out her tongue around the underside of your " + ((this.player.hasSheath()) ? "sheath" : "base") + " and running it slowly upward.  Having her wrists restrained doesn't seem to be hampering her ability to pleasure you much at all - it even seems to be turning her on.  She pushes your " + this.cockDescript(x) + " up against your stomach using her nose, kissing along the underside longingly and making wet smacking sounds.\n\n");

        this.outputText("\"<i>Mmn...  it'th tho delithiouth...  can'th waith thil 'oo fee' me lotth of tasthty cu'n,</i>\" she slurs around your hardening member, always staring up at you demurely with those big green eyes.\n\n");

        this.outputText("Inch by inch she trails her tongue up the shaft, lavishing your cock with affection as she loudly and shamelessly licks and laps her way up and down.  With one final exaggerated slurp, she runs her wet tongue from " + ((this.player.hasSheath()) ? "sheath" : "base") + " to " + this.player.cockHead(x) + ", narrowing her eyes mischievously.  Warm wetness encases the end of your member, a gentle breeze cascading over it as she exhales slowly from her nose.  The contrast of her cool, minty breath and the warmth of her mouth sends sparks of flaming pleasure zig-zagging down your shaft, making you shiver.\n\n");

        this.outputText("You have to admit, the gluttonous slut certainly has skills!  You have to suppress a moan when she parts her plump lips into a large O and engulfs your member, her cheek bulging out as she tilts her head to one side, trapping you there.  Righting herself, she begins to bob her head, pushing you to the back of her throat repeatedly.  The pillowy caress of her plush pink lips sliding around your member ripples through your loins, making you groan deeply in pleasure.  Before you can get too ahead of yourself, though, she pulls back, lips squeezing tightly every inch of the way until your throbbing cock breaks free of her lips with a resounding 'plop'!  She skillfully catches the tip on her lower lip, her tongue snaking out to gently cup the underside.\n\n");

        this.outputText("\"<i>Mmn...  I'n tho lucky...</i>\" she croons, the corners of her mouth curling up as she kisses it gently, blowing cool azure flames across the tip.  \"<i>Doeth it theel good?</i>\"\n\n");

        this.outputText("Your shaft is swallowed up once more, forced to the back of her throat as she gulps down inch after inch of your throbbing meat.  She pulls back, sucking as though her life depended on it, then dips down again, slurping up your salty precum desperately.  The " + this.player.cockHead(x) + " of your cock hits the back of her throat again and again, ");
        if (this.player.cocks[x].cockLength > 9) {
            this.outputText("each bob of her head inching her lips closer and closer to your ");
            if (this.player.balls > 0) this.outputText(this.ballsDescriptLight());
            else this.outputText("[sheath]");
            this.outputText(".  She hungrily swallows along your length, moaning into your engorged prick as she finally presses her lips to your " + ((this.player.hasSheath()) ? "sheath" : "base") + " and rolls her eyes back in pleasure, her neck bulging slightly from the presence of your shaft.\n\n");
        }
        else this.outputText("her lips squeezing sensually around the " + ((this.player.hasSheath()) ? "sheath" : "base") + " each time she goes down you.  Moaning intensely, she closes her eyes and rolls your " + this.cockDescript(x) + " back and forth in her mouth, swirling her tongue sensually along it.\n\n");

        this.outputText("Her throat muscles ripple and pulse around you, making loud slurping and gulping noises that only fuel your lust.  She pulls back, her lips pursed around just the very tip as she stares up at you needfully for a moment before closing her eyes and downing your entire length once more.  With her face impaled on your member, you can feel her tongue slithering out of her mouth, looking down to see the obscenely long appendage coiling around your member and squeezing gently.  Your cock bulges out around it, swelling up incredibly, and the kitsune looks up at you, playing innocent.\n\n");

        this.outputText("She resumes her wild deep-throating, moaning through your cock as she swallows it whole time and time again.  Strings of saliva mixed with precum start to fly from the corners of her mouth with each bob of her head, dribbling down your shaft" + ((this.player.balls > 0) ? " and over your " + this.ballsDescriptLight() : "") + ".  Driven by lust, you opt to forgo your prior negotiations, releasing her wrists to instead grab the back of her head.  A light giggle trembles through your cock as you thrust your hips forward, tilting her head back a little and moaning deeply.\n\n");

        this.outputText("Taking advantage of her newfound freedom, the kitsune slides her hands up and down your sides, wisps of flame sparking to life and dancing along her fingertips, seeking only to heighten your pleasure.");

        this.outputText((((this.player.balls > 0) || (this.player.vaginas.length > 0)) ? "  Trailing them across your sides, she " + ((this.player.balls > 0) ? "cups your " + this.ballsDescriptLight() + " in her hand, squeezing tightly" + ((this.player.vaginas.length > 0) ? " and " : "") : "") + ((this.player.vaginas.length > 0) ? "runs her index finger teasingly along your slit" : "") + "." : ""));

        this.outputText("  Her throat muscles relax entirely, and she happily submits herself to your brutal face-fucking.\n\n");

        this.outputText(((this.player.cocks[x].cockLength > 15) ? "Again and again, you thrust your [hips] forward, mashing your pelvis against her face.  Your " + this.cockDescript(x) + " glides down her throat, making her neck bulge outward, and her only response is to moan into it, swallowing hungrily.  She massages your shaft sensually with her lips, using her tongue and throat" : "She massages your shaft sensually with her lips, using her tongue") + " to eagerly draw you inside again each time you pull back.  From the intense moaning that is vibrating through your bucking groin, you judge that she must enjoy being used like this, a thought that only heightens your desire even more.\n\n");

        this.outputText("You feel a tightness swelling in your " + ((this.player.balls > 0) ? this.ballsDescriptLight() : "prostate") + " as your pleasure starts to come to a head, running your fingers down through her soft, raven-colored hair.  Her glistening green eyes roll back in her head as she opens her throat to accept your orgasm gleefully, her tongue dancing along your length.  When your climax hits, a thick bulge begins to swell up just behind where her tongue still has a tight grip on your " + ((this.player.hasSheath()) ? "sheath" : "base") + ".  It builds until the pressure is too much to hold back, and then releases all at once, the kitsune moaning powerfully into your cock as the delicious, salty cream pours into her throat.\n\n");

        this.outputText("She sucks it down hungrily, gripping your shaft with both hands and milking it for all it's worth, as though it is the last meal she'll ever have.  ");
    ...
    private redheadsDontDeserveToHavePenisesBecauseTheyreTooGayForPenisOrSomethingIDontReallyKnowHowThisWorksOrWhyThisFunctionNameIsSoFuckingLong(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("You squint slightly, leering at the bulge between the kitsune's legs with a slight frown.  Your gaze travels up and down her voluptuous form, eying the girl's lovely curves carefully.  It's decided - if you're going to be having fun with her, that thing has got to go.\n\n");

        this.outputText(((this.silly()) ? "\"<i>Not liking dicks, what are you, gay?</i>\"  the kitsune teases in a perfect deadpan." : "\"<i>Oh, how boring,</i>\" she mutters disappointedly, her lower lip quivering in a mocking pout.") + "\n\n");

        this.outputText("You grumble in exasperation and jab your finger toward her groin, then thumb the air over your shoulder with an insistent whistle.\n\n");

        this.outputText("Rolling her eyes, she hesitantly complies, a wreath of flame engulfing her mismatched genitals with the crackling snap of a flint being struck.  When the azure blaze dissipates, her foot long cock has regressed into a pert cherry-colored nub.\n\n");

        this.outputText("\"<i>Fine, you beat me.  Fair's fair...");
        if (this.silly()) this.outputText(" you monster.");
        this.outputText("</i>\"\n\n");

        this.outputText("<b>What will you do with her now?</b>");
        // Set flag (redheadIsFuta = false)
        this.flags[kFLAGS.redheadIsFuta] = 0;
        // Display shared scenes + nonfuta options
        //kitsune sex
        this.defeatTheKitsunes(false);
    }
    ...
    private bringBackDick(): void {
        this.clearOutput();
        this.kitsuneSprite();
        this.outputText("You look her over contemplatively, rubbing your chin in thought as you stare at her crotch.  Somehow, it seems...  empty.  Something is missing.\n\n");
        ...
        this.outputText("As the last wisps of flame curl off into the air and disappear, her cock solidifies, standing proud and erect with a thin trickle of precum already dribbling down the shaft.\n\n");

        this.outputText("\"<i>Mn...  About time you decided to walk on the wild side,</i>\" she teases, smirking at you coyly.");
        // Set flag (redheadIsFuta = true)
        this.flags[kFLAGS.redheadIsFuta] = 1;
    ...
    public kitsuneShrine(): void {
        this.clearOutput();
        if (this.flags[kFLAGS.KITSUNE_SHRINE_VISIT] == 0) {
            this.outputText("Your travels take you down a winding path through the forest today, deep in the heart of the woods.  Each step you take makes it feel even more like the dense foliage is creeping in even closer, the rough-hewn dirt path dwindling down to almost nothing up ahead.  Whatever the trail was used for long ago, it is in the late stages of being reclaimed by the wilderness now.\n\n");

            this.outputText("While you are mindful of this land's dangers, you are curious what secrets this part of the forest might hold.  You press on, trudging through the weed-choked trail, doing your best to keep your wits about you as you march onwards.\n\n");

            this.outputText("You emerge from the dense foliage into a large clearing.  Your eye is immediately drawn to an absurdly large tree in the center, its weathered trunk covered in knots and gnarls.  Odd-looking paper talismans hang from some of the branches, swaying eerily in a nonexistent breeze.  Worn down flagstones wind around the ancient-looking tree to a small, run-down wooden building that looks like it could comfortably accommodate a single person if it wasn't in such a dilapidated state.\n\n");

            this.outputText("You call out, but the place seems to be abandoned.  Shrugging, you decide to take a look around the building, hefting a rotten timber out of the way of the door and creeping inside carefully, just in case you aren't really alone.\n\n");

            this.outputText("It takes a moment for your eyes to adjust to the dim light inside the musty shed, but you eventually start to piece together the makings of a simple dwelling.  An old bedroll lies in one corner, assorted cooking implements hung with care over a small fire pit.  In the rear of the one-room building is enshrined a small pedestal, atop of which stands a small gold statue of an androgynous figure with nine tails.  A short distance away stands a bookcase filled with musty tomes and scrolls of all shapes and sizes.\n\n");

            this.outputText("Judging by the layer of dust on everything, whoever lived here hasn't been around in quite some time.  You're sure they wouldn't mind if you helped yourself to some of those books - you might just learn a thing or two.  That gold statue is pretty tempting too, but on the other hand it seems to have some sort of spiritual significance - stealing it from its rightful place might not be the wisest idea.  Of course, you could always try praying to it.");
        }
        else {
            this.outputText("You find your way to the abandoned kitsune shrine again.  The place is full of rotten timber, but it has a bookcase stuffed with well-maintained tomes.  The remains of a camp are in here as well, though the owner is curiously absent.  Judging by the layer of dust on everything, whoever lived here hasn't been around in quite some time.  You're sure they wouldn't mind if you helped yourself to some of those books - you might just learn a thing or two.");
        }
    ...
    private readKitsuneBooks(): void {
        this.clearOutput();
        this.outputText("You decide to peruse the selection of old tomes on the bookshelf.  To your dismay, many of them seem to be written in a strange script that you can't understand.  After a bit of searching, though, you find a couple that you can read, carefully thumbing through the old, dusty pages.\n\n");
    ...
    private meditateLikeAKitsuneEhQuestionMark(): void {
        this.clearOutput();
        if (this.player.hasItem(this.consumables.FOXJEWL) && this.player.tailType == TAIL_TYPE_FOX && this.player.tailVenom < 9 && this.player.tailVenom + 1 <= this.player.level && this.player.tailVenom + 1 <= this.player.inte / 10 && this.player.earType == EARS_FOX && this.player.findPerk(PerkLib.CorruptedNinetails) < 0 && this.player.findPerk(PerkLib.EnlightenedNinetails) < 0) {
            //20% chance if PC has fox ears, 1 or more fox tails, carries a Fox Jewel, and meets level & INT requirements for the next tail:
            this.outputText("You sit down carefully on a small mat in front of the shrine and clear your mind.  Closing your eyes, you meditate on the things you've learned in your journey thus far, and resolve to continue fighting against the forces of corruption that permeate the land.\n\n");

            this.outputText("Nearing the end of your meditation, you are inexplicably compelled to reach into your bag and pull out the small teardrop-shaped jewel you were carrying.  As you stare past the translucent surface of the bead and into the dancing fire within, the jewel begins to dissolve in your hand, the pale flames within spilling out and spreading over your body.\n\n");
            if (this.player.tailVenom < 8) {
                this.outputText("Sitting in a silent reverie, you allow the flames to wash over you, and begin to feel a bit more...  enlightened.  Your bushy tail" + ((this.player.tailVenom > 1) ? "s" : "") + " begin" + ((this.player.tailVenom > 1) ? "s" : "") + " to glow with an eerie, ghostly light, and with a crackle of electrical energy, split" + ((this.player.tailVenom > 1) ? "s" : "") + " into " + (this.player.tailVenom + 1) + "!");
                this.player.tailVenom++;
            }
            else {
                ...
                this.outputText("Your bushy tails begin to glow with an eerie, ghostly light, and with a crackle of electrical energy, split into nine tails.  <b>You are now a nine-tails!  Untold cosmic power radiates from your very being!  Use it wisely...</b>");
    ...
    private takeAKitsuneStatue(): void {
        this.clearOutput();
        this.outputText("The thought of how many gems you'll be able to get for it is enough to quickly suppress those feelings, avarice winning out over guilt.");
        //+10 COR, add Gold Statue to inventory, Advance 1hr and return to camp
        this.dynStats("lus", 10);
        this.inventory.takeItem(this.useables.GLDSTAT, this.camp.returnToCampUseOneHour);
        this.flags[kFLAGS.TOOK_KITSUNE_STATUE] = 1;
    }

    //[Put it Back]
    private putKitsuneStatueBack(): void {
        this.clearOutput();
        this.outputText("Regretting your decision, you replace the statue on the pedestal, your guilty conscience winning out over greed today.");
    ...
    public kitsuneStatue(): void {
        this.outputText("You pull out the gold statue and turn it around in your hands a few times, carefully examining the intricate filigree and inscriptions covering the masterfully crafted idol.  Whoever made this certainly put a lot of time and love into their craft." + ((this.player.cor < 50) ? "  Examining the painstaking detail that went into it, you feel a slight pang of guilt for having stolen it from its rightful place.  You push the thoughts away, reasoning that it won't be missed - after all, the owner was long gone before you arrived." : "") + "\n\n");
        this.outputText("It's not much use to you other than decoration, but based on the craftsmanship alone you judge that you could get a fair price for it if you pawned it off.");
    }
}
