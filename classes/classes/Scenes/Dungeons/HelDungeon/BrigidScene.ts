...
export class BrigidScene extends BaseContent {
    ...
    public pcDefeatsBrigid(): void {
        ...
        if (this.monster.lust > 99) this.outputText("too turned on");
        else this.outputText("too badly beaten");
    ...
    private brigitPostQueenDeathBadEndII(): void {
        ...
        if (this.player.gender <= 1 || this.player.pregnancyIncubation > 0) {
            ...
            if (!this.player.hasCock()) {
                ...
                if (this.player.pregnancyIncubation > 0) this.outputText("  Once this disgusting thing you're carrying falls out of you, we'll use you more traditionally, but...</i>\"  She pauses to press uncomfortably on your pregnant belly, then resumes speaking.  \"<i>I have no intention of letting you sit idle for however long that takes.");
            ...
            if (this.player.cockTotal() > 1 || this.player.cumQ() > 1000) this.outputText("  " + this.SMultiCockDesc() + " holds forth for a while, until Kiri's ass, pussy, and tailfeathers are soaked with oozing, white cum.");
        ...
        //(else if not visibly pregnant F or H)
            ...
            if (this.player.hasCock()) this.outputText(this.sMultiCockDesc() + " bobbing up and down, drooling pre-cum, as ");
            ...
            if (this.player.hasCock()) this.outputText(" as the phoenix's cunt slides onto your [cock smallest]");
