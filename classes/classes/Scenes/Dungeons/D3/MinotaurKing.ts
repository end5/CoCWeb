...
export class MinotaurKing extends Monster {
    ...
    public get orgasms(): number { return this._orgasms; }
    ...
    private headbutt(): void {
        ...
        var damage: number = ((this.str + this.weaponAttack) / 2) - MinotaurKing.rand(this.player.tou);
    ...
    private dickslap(): void {
        ...
        if (this._orgasms > 0) {
            ...
            if (this.player.findPerk(PerkLib.MinotaurCumAddict) >= 0) this.outputText(" Delicious.");
    ...
    public lustDump(): void {
        ...
        if (this.player.findPerk(PerkLib.MinotaurCumAddict) >= 0) this.outputText(" You’re jealous. All that cum must feel exquisite!");
