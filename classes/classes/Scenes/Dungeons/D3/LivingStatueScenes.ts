...
export class LivingStatueScenes extends BaseContent {
    ...
    public encounter(): void {
        ...
        if (this.silly()) this.outputText(" On the plus side, it seems to lack knees. That should make dodging its attacks a bit easier.");
    ...
    private takeTheStone(): void {
        ...
        // 9999 dis shit.
        if (this.player.hasKeyItem("Marae's Lethicite")) this.outputText(" easily as big as Marae's.");
        else this.outputText(" like the purple crystals in the factory, only this one is three times as big.");
