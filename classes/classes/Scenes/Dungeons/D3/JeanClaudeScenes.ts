...
export class JeanClaudeScenes extends BaseContent {
    ...
    public gogoFuckTheseBasilisks(): void {
        ...
        if (this.player.hasKeyItem("Laybans") >= 0) this.outputText(", put your shades on")
        ...
        if (this.player.demonScore() > 4) this.outputText("  You can’t be mistaken for anything but a demon, after all.");
        ...
        if (this.player.isNaga()) this.outputText("  You’re probably imagining things but the passage of your sinuous form over the wire surface seems absurdly loud, an endless rubbing of sandpaper which seems to fill the hall.");
        else if (this.player.isGoo()) this.outputText("  Godsdamn this form... you try not to think as you slide across the wire surface, intensely aware of the slimy sound you make as you go, of the steady drip of your fluids through the mesh, trying not to think of it splashing down on curious, blunt heads.");
        else this.outputText("  Clack, clack, clack. You are intensely aware of the sound of your [feet] on the wire surface. You close your eyes and tell yourself you’re only imagining that it’s loud, that it echoes around the hall, that the basilisks would have to be deaf not to hear you.");
        ...
        if (this.player.hasKeyItem("Laybans") < 0) {
            ...
            if (this.player.spe < 90) {
                ...
                if (!this.player.canFly()) this.outputText(" almost");
                else this.outputText(" literally");
    ...
    public capturedByBasilisks(): void {
        ...
        if (this.player.hasVagina()) this.outputText(" your [vagina] beading with excitement");
        if (!this.player.hasCock() && !this.player.hasVagina()) this.outputText(" your loins aflame with excitement");
    ...
    private capturedbyBasilisksTaunt(): void {
        ...
        this.startCombat(new JeanClaude());
    }

    public beatDaFuckhugeBasilisk(hpVictory: boolean): void {
        this.clearOutput();
        this.flags[kFLAGS.D3_JEAN_CLAUDE_DEFEATED] = 1;
        ...
        if (this.player.mf("m", "f") == "f" && this.silly()) this.outputText("  You raise your fists in glee and crow “<i>I AM THE LIZARD QUEEN!</i>” at the ceiling.");
    ...
    private goAway(): void {
        ...
        this.flags[kFLAGS.D3_BASILISKS_REMOVED_FROM_MAGPIE_HALL] = 1;
    ...
    public basiliskBadEnds(): void {
        if (this.player.findPerk(PerkLib.BasiliskWomb) >= 0) this.bwombBadEnd();
        else this.regularBadEnd();
    }
    ...
    private regularBadEnd(): void {
        ...
        if (this.player.hasVagina()) this.outputText(" your [vagina] beads with excitement");
        if (this.player.hasCock() && this.player.hasVagina()) this.outputText(" and");
        if (this.player.hasCock()) this.outputText(" [eachCock] hardens");
        if (this.player.hasCock() || this.player.hasVagina()) this.outputText(" as");
        ...
        if (this.player.findStatusAffect(StatusAffects.RemovedArmor) > 0) this.outputText("  You realize vaguely you already have taken your clothes off, undoubtedly your own subconscious preparing you for this moment.");
        else this.outputText("  You really are uncomfortably hot underneath the glare of those eyes. Hardly even aware you’re doing it, you begin to take off your [armor]. Piece after piece falls to the floor until you are naked before him.");
        ...
        if (this.player.skinAdj != "smooth" && this.player.skinAdj != "latex" && this.player.skinAdj != "rubber") {
            ...
            if (this.player.skinType == SKIN_TYPE_FUR) this.outputText("  Your fur drops away in ragged clumps as you drink.");
        ...
        if (this.player.hasVagina()) this.outputText(" your [vagina] dribbling excitement");
        if (this.player.hasVagina() && this.player.hasCock()) this.outputText(" and");
        if (this.player.hasCock()) this.outputText(" your [cock] straining helplessly");
        ...
        if (this.player.isBiped()) this.outputText("  The transformation isn’t quite complete; your mouth opens as a will not your own forces your arms and legs to open, leaving you completely exposed. It takes you a few seconds to realize that your mouth opening wasn’t your doing, either. It won’t close.");
        else this.outputText("  The transformation isn’t quite complete; your mouth opens as a will not your own forces your arms to open and your monstrous bottom half to take on a stance as close to complete submission as it will allow, your [hips] flared to the world. It takes you a few seconds to realize that your mouth opening wasn’t your doing, either. It won’t close.");
    ...
    private bwombBadEnd(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.RemovedArmor) >= 0) {
            ...
            if (this.player.isBiped()) this.outputText(" spread your [hips]");
            else this.outputText(" position yourself");
        ...
        if (!this.player.hasCock()) this.outputText("  His other dick bats into your stomach, thrusting upwards towards your [chest] as he speaks, his eyes transfixing you, drawing you further into his savage, potent, golden dreams of lust and conquest as he speaks.");
        else this.outputText("  His other dick thrusts against your own [cock], hardening it with incessant rubbing as he speaks, his eyes transfixing you, drawing you further into his savage, potent, golden dreams of lust and conquest as he speaks.");
