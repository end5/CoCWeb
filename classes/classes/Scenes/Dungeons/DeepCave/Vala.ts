...
export class Vala extends Monster {
    ...
    public valaCombatDialogue(): void {
        if (this.findStatusAffect(StatusAffects.Vala) < 0) {
            ...
            if (this.statusAffectv1(StatusAffects.Vala) == 1) this.outputText("\"<i>If you won't fuck Bitch, you must not be a master,</i>\" she realizes, the fight invigorating her lust-deadened brain. \"<i>You get to be a pet for the masters, too!</i>\"", false);
            else if (this.statusAffectv1(StatusAffects.Vala) == 2) this.outputText("\"<i>If the masters like you, maybe they will let Bitch keep you for herself! Won't you like that?</i>\"", false);
            else if (this.statusAffectv1(StatusAffects.Vala) == 3) this.outputText("\"<i>We obey the masters. They fed Bitch until she became big enough to please them. The masters love their pets so much, you'll see.</i>\"", false);
            else if (this.statusAffectv1(StatusAffects.Vala) == 4) this.outputText("\"<i>Thoughts are so hard. Much easier to be a toy slut. Won't you like being a toy? All that nasty memory fucked out of your head.</i>\"", false);
            else if (this.statusAffectv1(StatusAffects.Vala) == 5) this.outputText("\"<i>Bitch has given birth to many of the masters' children. She will teach you to please the masters. Maybe you can birth more masters for us to fuck?</i>\"", false);
            else this.outputText("\"<i>Bitch loves when her children use her as their fathers did. Sluts belong to them. Slut love them. You will love them too!</i>\"", false);
        }
    }
    ...
    protected performCombatAction(): void {
        ...
        //Select Attack
        //BLood magic special
        if (this.HPRatio() < .85 && Vala.rand(3) == 0) this.valaSpecial1();
    ...
    public constructor() {
        ...
        if (this.game.flags[kFLAGS.TIMES_PC_DEFEATED_VALA] > 0) lustVuln += .25;
        if (this.game.flags[kFLAGS.TIMES_PC_DEFEATED_VALA] > 2) lustVuln += .5;
        ...
        if (this.flags[kFLAGS.TIMES_PC_DEFEATED_VALA] == 0) this.drop = new WeightedDrop(this.consumables.NUMBROX);
