...
export class Giacomo extends BaseContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        if (this.model.time.hours > 23) {
            if (this.flags[kFLAGS.CERULEAN_POTION_BAD_END_FUTA_COUNTER] > 0) this.flags[kFLAGS.CERULEAN_POTION_BAD_END_FUTA_COUNTER] -= 0.5; //Reduce bad-end for cerulean herms number
        }
        return false;
    }

    public timeChangeLarge(): boolean {
        if (this.checkedSuccubi++ == 0 && this.model.time.hours == 4 && this.player.findStatusAffect(StatusAffects.SuccubiNight) >= 0 && (this.player.hasCock() || this.player.gender == 0)) { //Call secksins!
            if (this.player.findStatusAffect(StatusAffects.RepeatSuccubi) >= 0) {
                if (this.getGame().vapula.vapulaSlave() && this.player.hasCock() && this.flags[kFLAGS.VAPULA_THREESOMES] > 0 && this.flags[kFLAGS.FOLLOWER_AT_FARM_VAPULA] == 0) //VapulaSurprise
    ...
    public giacomoEncounter(): void {
        ...
        if (kGAMECLASS.giacomo == 0) {
        ...
        else if (this.player.findStatusAffect(StatusAffects.WormOffer) < 0 && this.player.findStatusAffect(StatusAffects.Infested) >= 0) { //If infested && no worm offer yet
            ...
            if (this.player.gems < 175) { //Broke as a joke
                ...
                //Remove/No
                this.doYesNo(this, this.wormRemoval, this.giacomoEncounter);
                return;
            }
        }
        ...
        var deworm = (this.player.findStatusAffect(StatusAffects.WormOffer) >= 0 && this.player.findStatusAffect(StatusAffects.Infested) >= 0 ? this.wormRemovalOffer : undefined);
        this.simpleChoices(this, "Potions", this.potionMenu, "Books", this.bookMenu, "Erotica", this.eroticaMenu, "Worm Cure", deworm, "Leave", this.camp.returnToCampUseOneHour);
    ...
    private potionMenu(): void {
        ...
        this.simpleChoices(this, "Vitality T.", this.pitchVitailtyTincture, "Scholars T.", this.pitchScholarsTea,
    ...
    private bookMenu(): void {
        ...
        this.simpleChoices(this, "Dangerous Plants", this.pitchDangerousPlantsBook, "Traveler's Guide", this.pitchTravellersGuide, "Hentai Comic", this.pitchHentaiComic,
            "Yoga Guide", (this.flags[kFLAGS.COTTON_UNUSUAL_YOGA_BOOK_TRACKER] > 0 ? this.pitchYogaGuide : undefined), "Back", this.giacomoEncounter);
        this.statScreenRefresh();
    }
    ...
    private eroticaMenu(): void {
        ...
        if (this.player.gender == 1)
            this.simpleChoices(this, "Dildo", this.pitchDildo, "Onahole", this.pitchOnahole, "D Onahole", this.pitchDeluxeOnahole, "", undefined, "Back", this.giacomoEncounter);
        if (this.player.gender == 2)
            this.simpleChoices(this, "Dildo", this.pitchDildo, "Stim-Belt", this.pitchSelfStimulationBelt, "AN Stim-Belt", this.pitchAllNaturalSelfStimulationBelt, "", undefined, "Back", this.giacomoEncounter);
        if (this.player.gender == 3)
            this.choices(this, "Onahole", this.pitchOnahole, "D Onahole", this.pitchDeluxeOnahole, "AN Onahole", this.pitchAllNaturalOnahole, "Stim-Belt", this.pitchSelfStimulationBelt, "AN Stim-Belt", this.pitchAllNaturalSelfStimulationBelt, "Dual Belt", this.pitchDualStimulationBelt, "", undefined, "", undefined, "Dildo", this.pitchDildo, "Back", this.giacomoEncounter);
        if (this.player.gender == 0)
            this.simpleChoices(this, "Dildo", this.pitchDildo, "Onahole", this.pitchOnahole, "Stim-Belt", this.pitchSelfStimulationBelt, "", undefined, "Back", this.giacomoEncounter);
        this.statScreenRefresh();
    }
    ...
    private pitchVitailtyTincture(): void {
        ...
        this.doYesNo(this, this.buyVitailtyTincture, this.potionMenu);
    }
    ...
    private buyVitailtyTincture(): void {
        ...
        if (this.player.gems < 15) {
            ...
            this.doNext(this, this.potionMenu);
        }
        else {
            this.player.gems -= 15;
    ...
    private pitchScholarsTea(): void {
        ...
        this.doYesNo(this, this.buyScholarsTea, this.potionMenu);
    }
    ...
    private pitchCeruleanPotion(): void {
        ...
        this.doYesNo(this, this.buyCeruleanPotion, this.potionMenu);
    }
    ...
    private pitchDangerousPlantsBook(): void {
        ...
        if (this.player.hasKeyItem("Dangerous Plants") >= 0) {
            ...
            this.doNext(this, this.bookMenu);
            return;
        }
        ...
        this.doYesNo(this, this.buyDangerousPlantsBook, this.bookMenu);
    }
    ...
    private pitchTravellersGuide(): void {
        ...
        this.doYesNo(this, this.buyTravellersGuide, this.bookMenu);
    }
    ...
    private pitchHentaiComic(): void {
        ...
        this.doYesNo(this, this.buyHentaiComic, this.bookMenu);
    }
    ...
    private pitchYogaGuide(): void {
        ...
        this.doYesNo(this, this.buyYogaGuide, this.bookMenu);
    }
    ...
    private pitchDildo(): void {
        ...
        if (this.player.hasKeyItem("Dildo") >= 0) {
            ...
            this.doNext(this, this.eroticaMenu);
            return;
        }
        ...
        this.doYesNo(this, this.buyDildo, this.eroticaMenu);
    }
    ...
    private pitchSelfStimulationBelt(): void {
        ...
        this.doYesNo(this, this.buySelfStimulationBelt, this.eroticaMenu);
    }
    ...
    private pitchAllNaturalSelfStimulationBelt(): void {
        ...
        this.doYesNo(this, this.buyAllNaturalSelfStimulationBelt, this.eroticaMenu);
    }
    ...
    private pitchOnahole(): void {
        ...
        this.doYesNo(this, this.buyOnahole, this.eroticaMenu);
    }
    ...
    private pitchDeluxeOnahole(): void {
        ...
        this.doYesNo(this, this.buyDeluxeOnahole, this.eroticaMenu);
    }
    ...
    private pitchAllNaturalOnahole(): void {
        ...
        this.doYesNo(this, this.buyAllNaturalOnahole, this.eroticaMenu);
    }
    ...
    private pitchDualStimulationBelt(): void {
        ...
        this.doYesNo(this, this.buyDualStimulationBelt, this.eroticaMenu);
    }
    ...
    private wormRemovalOffer(): void {
        ...
        if (this.player.gems < 175) {
            ...
            this.doNext(this, this.giacomoEncounter);
        }
        //Can afford
        else {
    ...
    private nightSuccubiFirstTime(): void {
        ...
        this.doNext(this, this.ceruleanSuccubusEncounterPart2);
    }
    ...
    private ceruleanSuccubusEncounterPart2(): void {
        ...
        this.doNext(this, this.ceruleanSuccubusEncounterPart3);
    }
    ...
    private ceruleanSuccubusEncounterPart3(): void {
        ...
        this.player.orgasm();
        this.dynStats("lib", .5);
        this.doNext(this, this.ceruleanSuccubusEncounterPart4);
    }
    ...
    private nightSuccubiRepeat(): void {
        ...
        if (this.player.gender == 1) {
            if (this.player.cor < 66) {
                ...
                if (this.player.isTaur()) this.outputText(" crouch between your legs and impale herself on your " + this.cockDescript(0) + " with a wet sound caused by her well-lubricated vulva. Y", false);
                else this.outputText(" open her womb and quickly consume your " + this.cockDescript(0) + ". She embraces you, entrapping your head in her cleavage as y", false);
                ...
                if (this.player.isTaur()) this.outputText("Pushing on your forelegs, she engulfs even more of your " + this.cockDescript(0), false);
                else this.outputText("Almost crushing your pelvis, she wraps her legs around your body", false);
                ...
                if (this.player.isTaur()) this.outputText("arches under your belly as you feel your " + this.cockDescript(0) + " bending pleasurably inside her, and", false);
                else this.outputText("releases you from her grip, allowing you to finally breathe deeply, and leans back, arching high to reveal your joined genitals in the moonlight. You visibly see", false);
                ...
                if (this.player.isTaur()) this.outputText("pushes on your forelegs, impaling herself even deeper on your " + this.cockDescript(0), false);
                ...
                if (this.player.isTaur()) this.outputText("She moans inhumanly, and reflexively digs her claws into your forelegs. Searing with lust, the pain means little to you as you only feel the sensation of your body forcing your fluids out of your body and into hers. You press your " + this.cockDescript(0) + " into her", false);
                else this.outputText("She embraces you, moaning inhumanly, and reflexively digs her claws into your back. Searing with lust, the pain means little to you as you only feel the sensation of your body forcing your fluids out of your body and into hers. You slam your pelvis into hers", false);
            ...
            if (this.flags[kFLAGS.CERULEAN_POTION_BAD_END_FUTA_COUNTER] > 10 && this.player.cor > 50) {
                ...
                if (this.player.balls > 0) this.outputText("  Even your nuts are unbearably sore.", false);
                ...
                if (this.player.horseScore() + this.player.dogScore() + this.player.nagaScore() + this.player.goblinScore() + this.player.sharkScore() + this.player.minoScore() + this.player.cowScore() > 5) this.outputText("  All of the other corruptions and changes to your body have faded away as your new form has taken shape.", false);
