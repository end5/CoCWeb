...
export class Gargoyle extends BaseContent {
    ...
    private gargoyleConfidence(arg: number = 0): number {
        if (arg != 0) {
            ...
            else if (this.flags[kFLAGS.GAR_CONFIDENCE] < 0) this.flags[kFLAGS.GAR_CONFIDENCE] = 0;
        }
    ...
    public gargoylesTheShowNowOnWBNetwork(): void {
        ...
        if (this.player.exploredDesert > 0) this.outputText(", making even the desert seem healthy and full of life");
        ...
        if (this.player.statusAffectv1(StatusAffects.TelAdre) >= 1) this.outputText("or the ruins of one of Tel'Adre's more distant neighbors, ");
        ...
        //[Next]
        this.menu();
        this.addButton(this, 0, "Next", this.gargoyleMeeting2);
    ...
    private gargoyleMeeting2(): void {
        ...
        if (this.player.lib >= 40) this.outputText("  Maybe you could take this with you as a life-sized sex toy?");
        ...
        this.menu();
        this.addButton(this, 1, "Don't Break", this.dontBreakThatShit);
        this.addButton(this, 0, "Break Chains", this.breakZeChains);
    }
    ...
    private breakZeChains(): void {
        ...
        //if using your hands:
        if (this.player.weaponName == "fists") this.outputText("  \"<i>OW! Dammit, that hurt!</i>\"  What the hell were you thinking!?  Still, looks like you got results...");
        ...
        this.menu();
        this.addButton(this, 0, "Next", () => this.nameZeGargoyle(input));
    ...
    private gargoyleStarterMenu(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Funny Order", this.giveGargoyleAFunnyOrder);
        this.addButton(this, 1, "Carnal Order", this.carnalOrder);
        this.addButton(this, 2, "Talk", this.firstGargoyleTalk);
    }
    ...
    private giveGargoyleAFunnyOrder(): void {
        ...
        this.outputText("\n\nTo her credit, " + this.flags[kFLAGS.GAR_NAME] + " hesitates only for a moment before dropping to the floor and rolling belly-up, limbs upraised like a puppy in training.  Stifling a chuckle, you lean down and do just that, giving her a quick belly rub.  Her skin is cool to the touch, and impeccably smooth, as you might expect from a marble statue.  Seemingly pleased, " + this.flags[kFLAGS.GAR_NAME] + " scrambles back to a low crouch before you, awaiting your next command.");
        this.gargoyleStarterMenu();
    }
    ...
    private carnalOrder(): void {
        this.clearOutput();
        this.outputText("Well, well. " + this.flags[kFLAGS.GAR_NAME] + " seems willing to follow any order you give, no matter how carnal, and you could not help but notice her rather <i>arousing</i> attributes earlier.  Smirking wickedly, you command your new gargoyle to finger herself.");
        ...
        if (this.player.cor < 40) this.outputText("flustered");
    ...
    private firstGargoyleTalk(): void {
        this.clearOutput();
        this.outputText("You decide against giving " + this.flags[kFLAGS.GAR_NAME] + " an order for now.  Instead, you right a nearby toppled pew and seat yourself across from the crouching gargoyle, returning her intense stare with one of your own.");
        ...
        this.outputText("\n\nSuddenly, " + this.flags[kFLAGS.GAR_NAME] + " breaks the stare and looks away, as if in shame.  \"<i>The demons' doom that even now blights Mareth took its toll here, too.  The people of a town no longer here believed they were safe under Marae's roof.  Protected.  Their faith was. . . Misplaced.</i>\"");

        this.outputText("\n\nIt seems the events that led to the cathedral's destruction weigh heavily on " + this.flags[kFLAGS.GAR_NAME] + "'s heart.  What do you do?");
        //(Display options: [Berate] and [Reassure])
        this.menu();
        this.addButton(this, 0, "Berate", this.berateTheGargoyle);
        this.addButton(this, 1, "Reassure", this.reassureTheGargoyle);
    }
    ...
    private berateTheGargoyle(): void {
        ...
        this.outputText("\n\n" + this.flags[kFLAGS.GAR_NAME] + " recoils, flinching from you in expectation of assault. Instead, you spit on the ground and start for the exit.  You shout over your shoulder for her to stay here and wallow in her failure until you deign to use her.");
    ...
    private reassureTheGargoyle(): void {
        ...
        this.outputText("\n\n" + this.flags[kFLAGS.GAR_NAME] + " looks up at you, her ruby-red eyes shining in the dim hit of light in the cathedral.  You cup her cheek and give her a smile.  \"<i>Come on, now,</i>\" you reply, offering her a hand up.  \"<i>Let's get out of here.</i>\"");
        ...
        this.outputText("\n\nYou rustle " + this.flags[kFLAGS.GAR_NAME] + "'s hair and assure her you will before you take your leave and return to camp.");
    ...
    public returnToCathedral(woken: boolean = false): void {
        ...
        if (!woken) {
            this.clearOutput();
            if (Gargoyle.rand(3) == 0) this.outputText("You make your way back to the ruined Cathedral in the wastelands.  You notice some of the debris has been cleared away from the courtyard, and some of the windows have been boarded up.  " + this.flags[kFLAGS.GAR_NAME] + "'s obviously been working since you last left, trying to make the building more habitable.  With your path less obstructed than before, you enter.");
            //[b]Player Returns to the Cathedral B[/b]
            else if (Gargoyle.rand(2) == 0) this.outputText("You spot the Cathedral in the distance, and see plumes of smoke rising. Alarmed, you ready your [weaponName] and rush over.  To your relief, however, you discover the burning objects are just a few dead imps that were looking for easy pillage, but found the Cathedral's newly-awoken protector instead.  Stepping around their charred corpses, you enter.");
            //[b]Player Returns to the Cathedral C[/b]
            else this.outputText("You wander into the Cathedral grounds, and are rather alarmed to see a pair of little green goblin sluts poking around outside, trying to cart off some of the stone tombstones for their nefarious schemes.  They see you approaching, however, and quickly flee – more interested in salvage than fighting or fucking today.  Chuckling to yourself, you enter.");
        }
        this.menu();
        ...
        if (this.model.time.hours <= 9 || this.model.time.hours >= 18 || woken) {
            if (!woken) {
                this.outputText("\n\nIn the dim ");
                if (this.model.time.hours <= 9) this.outputText("early morning");
                else this.outputText("late evening");
                this.outputText(" light streaming in from the broken windows, you see " + this.flags[kFLAGS.GAR_NAME] + " poking around some of the rubble, slowly but surely making efforts to repair the damage done to the Cathedral.  Seeing you, however, she immediately drops what she was doing and ");
                if (this.gargoyleConfidence() < 70) this.outputText("kneels before you, head bowed low.");
                else if (this.gargoyleConfidence() < 99) this.outputText("bows low before you, a small smile on her stone lips.");
                else this.outputText("with a sexy sway of her hips, approaches you and lays a small but tender kiss upon your cheek before bowing her head to you.");

                this.outputText("\n\n\"<i>Master has returned,</i>\" " + this.flags[kFLAGS.GAR_NAME] + " says ");
                if (this.gargoyleConfidence() > 50) this.outputText("happily.");
            ...
            if (this.player.lust >= 33) this.addButton(this, 0, "Sex", this.gargoyleSexMenu);
            this.addButton(this, 1, "Rituals", this.ritualGargoyle);
            if (this.flags[kFLAGS.GAR_HISTORY] < 3 || this.flags[kFLAGS.GAR_CATHEDRAL] < 3 || this.flags[kFLAGS.GAR_NAME_TALKS] < 3) this.addButton(this, 2, "Talk", this.talkToGargoyle);
            this.addButton(this, 3, "Appearance", this.gargoyleAppearance);
            if (this.gargoyleConfidence() >= 70 && this.flags[kFLAGS.RITUAL_INTRO] > 0) this.addButton(this, 4, "Kinky Rituals", this.gargoyleKinkyRituals);
        }
        //[b]Cathedral Interior: 10:00 –> 17:00[/b]
        else {
            if (!woken) {
                this.outputText("\n\nWithin the ruins, you can see " + this.flags[kFLAGS.GAR_NAME] + " perched atop her pedestal in a low, predatory crouch, much as you found her.  Waving a hand in front of her eyes, you confirm she's in some sort of dormant mode.  A simple touch from her Master could revive her");
                if (this.player.lust >= 33) this.outputText(", or you could use her to satisfy your own urges, not unlike a life-size sex toy");
                this.outputText(".");
            }
            //(Display options: [Wake Her] [Use Her (if Lust >= 30)] [Appearance] and [Leave])
            this.addButton(this, 0, "Wake Her", this.returnToCathedral, true);
            if (this.player.lust >= 33) {
                if (this.player.hasCock()) this.addButton(this, 1, "Use Her", this.useGargoyleMaleHerm);
                else if (this.player.hasVagina()) this.addButton(this, 1, "Use Her", this.useHerGargoyleFemale);
            }
            this.addButton(this, 3, "Appearance", this.gargoyleAppearance);
        }
    ...
    private gargoyleSexMenu(): void {
        this.clearOutput();
        this.outputText("You approach " + this.flags[kFLAGS.GAR_NAME] + " and tell her you have some... pressure that needs relieving.");
        //(if Confidence =< 69:
        if (this.gargoyleConfidence() <= 69) this.outputText("  The gargoyle bows low before you, her face expressionless.  \"<i>By your command, Master.  How would you have me?</i>\"");
        else this.outputText("  Her ruby-red eyes lock with yours and a sultry grin plays across her gray marble features.  She slides an arm around your waist and presses her sizable, surprisingly soft breasts against your chest.  \"<i>How would Master have me?</i>\"");
        this.menu();
        //(If Male, display options: [Vaginal] [Anal] [Titfuck] [Strap-on] [Leave])
        if (this.player.gender == 1) {
            this.addButton(this, 1, "Anal", this.gargoyleAnal);
            this.addButton(this, 0, "Vaginal", this.gargoyleCoochiiGetsPlowed);
            this.addButton(this, 2, "Titfuck", this.titFuckTheGargoyle);
            this.addButton(this, 3, "Strap-On", this.strapOnGargoyle);
            this.addButton(this, 4, "Leave", this.returnToCathedral);
        }
        //(If Female, display options: [Tail Fuck] and [Ride Strap-on] [Leave])
        if (this.player.gender == 2) {
            this.addButton(this, 0, "Tail Fuck", this.tailFuckGargoyleScene);
            this.addButton(this, 1, "Strap-On", this.strapOnGargoyle);
            this.addButton(this, 4, "Leave", this.returnToCathedral);
        }
        ...
        if (this.player.gender == 3) {
            ...
            this.addButton(this, 2, "Titfuck", this.titFuckTheGargoyle);
            this.addButton(this, 3, "Strap-On", this.strapOnGargoyle);
            this.addButton(this, 4, "Tail Fuck", this.tailFuckGargoyleScene);
            this.addButton(this, 9, "Leave", this.returnToCathedral);
        }
    ...
    private gargoyleAnal(): void {
        ...
        this.outputText("\n\n" + this.flags[kFLAGS.GAR_NAME] + " makes a sharp little gasp as you push your finger into her.  You slide into her with surprising ease, reveling in how <i>cold</i> her interior is.  She's like ice inside!  You start thrusting your finger faster, trying to get her warmed up a little as your prepare her anus.  " + this.flags[kFLAGS.GAR_NAME] + " squirms and moans softly as you finger-fuck her bum, slowly changing from moans of discomfort to little gasps of pleasure.");
        ...
        if (this.player.cocks[this.player.biggestCockIndex()].cockLength >= 50) {
            this.outputText("\n\nKnowing full well the living statue doesn't have much in the way of anatomy, you continue to push more and more of monstrous manhood into " + this.flags[kFLAGS.GAR_NAME] + "'s asshole, watching with glee as her stomach begins to distend with the massive size of your prick.  Then her chest bulges, making her gasp in pain and clutch at her breast; that doesn't stop you, though.  With one mighty, massive thrust, you slam yourself up to the hilt in " + this.flags[kFLAGS.GAR_NAME] + "'s ass, and watch with glee as the head bursts out of her mouth, squirting pre and drool all over the floor.  The poor gargoyle makes a muffled scream and starts flailing around helplessly, trying to do <i>something</i> about the massive member now protruding from her mouth.");

            this.outputText("\n\nWith gusto, you start hammering away at your living cock-sleeve, using her entire body as one great big ona-hole to take your gargantuan girth.  Resigned to her fate, " + this.flags[kFLAGS.GAR_NAME] + " slumps forward and grasps the head of your [cock biggest], giving you a handy through her mouth as her innards milk the rest of your shaft.");
    ...
    private gargoyleCoochiiGetsPlowed(): void {
        ...
        this.outputText("You gently push " + this.flags[kFLAGS.GAR_NAME] + " onto her back and spread her long, marble legs, giving you a clear view of her tight little pussy.  You brush your hand along her thighs, making her gasp with the sensation as your knuckles run along her smooth, cool flesh.  Your fingers come to her small clit, and you caress her tiny pleasure buzzer, eliciting a tiny moan from the gargoyle.  Grinning, you give it another flick; " + this.flags[kFLAGS.GAR_NAME] + " squirms, trying to either enhance or end the sensation, you can't be sure.  You start to finger her clitty harder, creating little circles around it as you slip another finger into her tight passage.");

        this.outputText("\n\nYou're rewarded for your efforts by " + this.flags[kFLAGS.GAR_NAME] + " bucking her hips into your hands, moaning, \"<i>M-Master... please...</i>\"  Not done teasing her yet, you put your other hand on her flat belly and start to crawl it up, tickling her as you make your way toward her sizable breasts.  You glomp onto one of them, giving it a rough squeeze as you drive your finger into her a little further than before.  \"<i>Masterrrrr...</i>\" " + this.flags[kFLAGS.GAR_NAME] + " whines, reaching up to stroke your cheek.  Deciding you've teased the poor girl enough, you prepare for the main course.");

        this.outputText("\n\nYou pull your " + this.cockDescript(x) + " from your [armor], letting it flop down atop her crotch.  Embarrassed, " + this.flags[kFLAGS.GAR_NAME] + " looks away as you rub the underside of your cock across her mons, spitting on it for a bit of extra lubricant.  You lean back, lining the tip of your cockhead with the gargoyle's tight slit, and press forward.  She lets out a sharp gasp as your cock presses against her, pushing it past her lips and finally slipping into her depths.");
        ...
        if (this.player.cockArea(x) > 60) this.outputText("as far as she can take you.");
        else this.outputText("up to the hilt inside her.");
        ...
        if (this.gargoyleConfidence() >= 70) this.outputText("  Before you can stand, though, " + this.flags[kFLAGS.GAR_NAME] + " hugs her arms tightly around you pulling you down on top of her and mashing your face between her soft tits.");
    ...
    private titFuckTheGargoyle(): void {
        this.clearOutput();
        this.outputText("You situate yourself on a pew and spread your legs.  You pat your thighs, telling " + this.flags[kFLAGS.GAR_NAME] + " to sit between your legs as you fish out your [cock biggest].  She approaches, hesitantly placing herself on the floor between your legs as you recline and stroke your shaft to full hardness.  You let the gargoyle sit there, watching you wide-eyed as you continue to masturbate.  Though you're only preparing for the main act, you can't help but enjoy the sensation of such a basic sexual act, made all the more pleasurable by the creature at your feet, her face barely an inch from your cock's head as you stroke yourself.");

        this.outputText("\n\nOnce you're satisfied at your cock's rigid hardness, you tell " + this.flags[kFLAGS.GAR_NAME] + " to put those big, soft tits of hers to work.  \"<i>M-Master?</i>\" she gasps, making a cute little “o” with her mouth just an inch from your shaft.  You repeat the order, and giver her a thump on the nose with your cock for emphasis.  Shyly, she cups her D-cups and leans into you, squeezing your [cock biggest] between them.");

        this.outputText("\n\nWith a little encouragement, " + this.flags[kFLAGS.GAR_NAME] + " starts to rise and fall on her knees, dragging your shaft through her soft, cool mounds.  With a pleasured sigh, you reach down and stroke her hair, petting the girl as she begins to slowly but steadily titfuck you.  Still mumbling encouragements, you sit back and let the pleasure run over you, reveling in the incredible softness of her sizable chest massaging your cock, making steady progress toward stroking the cum out of you.");

        this.outputText("\n\nSuddenly, you feel an overwhelming wetness on your cock.  You look down, expecting to see pre flowing freely from you, but are instead greeted with the sight of " + this.flags[kFLAGS.GAR_NAME] + " sliding the tip of your cock into her mouth, starting to fellate you on top of the tittyfuck.  You give her a few more words of encouragement and press her head down further onto your shaft, forcing her to take all that's left over from her breasts.  Despite her marble nature, her mouth is moist and surprisingly warm, and her long tongue is quick to wrap around your [cock biggest], wringing it in time with her chest-thrusts.");
        ...
        this.outputText("\n\nYou grab " + this.flags[kFLAGS.GAR_NAME] + " and push her down hard, slamming your cock down her throat as you cum.  A human would surely have choked with this maneuver – instead, " + this.flags[kFLAGS.GAR_NAME] + " squirms and flails, but you can see and feel her swallow your cum as it pours into her mouth, her throat massaging your flaring head, milking it harder than any tit-job ever could have.  Once her face has been ground into your pubes, you buck your hips sharply, thrusting into her throat as the last of your jizz spurts out and down her gizzard.");

        this.outputText("\n\nBy the time you're done, " + this.flags[kFLAGS.GAR_NAME] + "'s face is an utter mess, with white lines trickling down her cheeks.  You drag your [cock biggest] out of her with a wet POP, unleashing a dam of jizz that quickly leaks out of her agape mouth to stain her breasts and belly.  You chuckle at the sight");
        if (this.gargoyleConfidence() >= 70) this.outputText(", and to your surprise, so does " + this.flags[kFLAGS.GAR_NAME] + "");
        this.outputText(".");
    ...
    private strapOnGargoyle(): void {
        ...
        if (this.player.hasVagina()) {
            ...
            this.outputText("\n\nWithout further ado, you drop down on the strap-on, lowering yourself onto the tingling metal rod until your groin is pressed against " + this.flags[kFLAGS.GAR_NAME] + "'s.  She, all the while, is biting her lower lip and whimpering with pleasure as your [vagina] swallows her length. Once you've taken all she has to offer, you begin grinding your hips against her, rocking back and forth atop the gargoyle.  To your surprise, " + this.flags[kFLAGS.GAR_NAME] + " grabs you, squeezing her long fingers into your [hips] and pulling you up, almost off her rod. You decide to go with it; you grab her tits for support and start to bounce on her cock.");
            this.player.cuntChange(15, true, true, false);
            this.outputText("\n\nSoon, you're both moaning with pleasure, bucking and thrusting your hips to meet each other as you continue to ride " + this.flags[kFLAGS.GAR_NAME] + "'s strap-on.  However, you can feel the clenching sensation of a coming orgasm building in your gut, and if the strained panting of your partner is any indication, she isn't far behind.  You start bouncing faster, increasing to a wild pace as your cunt contracts on the metal rod inside it, trying to milk the fake cock as waves of pleasure roll over you.  You don't let up throughout the orgasm, quite literally riding it out until " + this.flags[kFLAGS.GAR_NAME] + " lets out a high-pitched shriek and grabs your back, smashing your face into her tits and holding you tight as she, too cums.  Suddenly she's the one pounding you, thrusting her hips into your [vagina].");

            this.outputText("\n\nBy the time she's done, both your hips and thighs are spattered with your sweat and girlcum. Still panting from the ordeal, you slowly drag yourself off of " + this.flags[kFLAGS.GAR_NAME] + "'s cock and roll onto your back, exhausted. By the time you've recovered enough to stumble to your feet, " + this.flags[kFLAGS.GAR_NAME] + " is fast asleep beside you, snoring cutely, her metal cock still standing straight up in the air.  You give her a gentle pat on the thigh and get dressed, leaving the gargoyle snoozing peacefully as you head back to camp.");
        }
        //(ELSE, PC has no vagina:)
        else {
            this.outputText("\n\n" + this.flags[kFLAGS.GAR_NAME] + " is panting with lust by the time you're done teasing and stripping for her. Now nude, you drop back to your knees over her holy rod-cock, straddling her hips and lining her up with your [asshole].  You lower yourself until the tip of the rod is pressing against your clenched backdoor – and you're pleasantly surprised by the warm tingling sensation that quickly spreads out around the point of contact. Your anus responds immediately by utterly relaxing, letting just the tip of " + this.flags[kFLAGS.GAR_NAME] + "'s strap-on slide inside you.");

            this.outputText("\n\nWithout further ado, you drop down on the strap-on, lowering yourself onto the tingling metal rod until your ass is pressed against " + this.flags[kFLAGS.GAR_NAME] + "'s thighs.  She, all the while, is biting her lower lip and whimpering with pleasure as your ass swallows her length.  Once you've taken all she has to offer, you begin grinding your hips against her, rocking back and forth atop the gargoyle.  To your surprise, " + this.flags[kFLAGS.GAR_NAME] + " grabs you, squeezing her long fingers into your [hips] and pulling you up, almost off her rod.  You decide to go with it; you grab her tits for support and start to bounce on her cock.");
            this.player.buttChange(15, true, true, false);
            this.outputText("\n\nSoon, you're both moaning with pleasure, bucking and thrusting your hips to meet each other as you continue to ride " + this.flags[kFLAGS.GAR_NAME] + "'s strap-on.  However, you can feel the clenching sensation of a coming anal orgasm building in your gut, and if the strained panting of your partner is any indication, she isn't far behind.  You start bouncing faster, increasing to a wild pace as your hole contracts on the metal rod inside it, instinctively trying to force out the intruder, but only serving to let waves of pleasure roll over you.  You don't let up throughout the orgasm, quite literally riding it out until " + this.flags[kFLAGS.GAR_NAME] + " lets out a high-pitched shriek and grabs your back, smashing your face into her tits and holding you tight as she, too cums.  Suddenly she's the one pounding you, thrusting her hips into your [asshole] until you've both cum, hard, clutching each other as orgasmic pleasure slams through you.");

            this.outputText("\n\nStill panting from the ordeal, you slowly drag yourself off of " + this.flags[kFLAGS.GAR_NAME] + "'s cock and roll onto your back, exhausted. By the time you've recovered enough to stumble to your feet, " + this.flags[kFLAGS.GAR_NAME] + " is fast asleep beside you, snoring cutely, her metal cock still standing straight up in the air.  You give her a gentle pat on the thigh and get dressed, leaving the gargoyle snoozing peacefully as you head back to camp.");
        }
        this.player.orgasm();
        this.dynStats("sen", -1);
        this.doNext(this, this.camp.returnToCampUseOneHour);
    ...
    private tailFuckGargoyleScene(): void {
        ...
        this.outputText("\n\nBefore you can get used to the anal intruder, your eyes have rolled back in your head with pleasure.  Girlcum spurts from your cunt, splattering " + this.flags[kFLAGS.GAR_NAME] + "'s face with your juices as you cum.  Your holes squeeze down on her appendages, trapping them inside you as your ride out the orgasm, bouncing on her rigid, rapidly-moistening tail until your body settles down.");

        this.outputText("\n\nWhen you've finished, you carefully extricate yourself from the gargoyle's tail and, a bit bow-legged, gather up your [armor].  By the time you're dressed, " + this.flags[kFLAGS.GAR_NAME] + "'s cleaned herself off and is eagerly awaiting some token of your approval.");

        this.outputText("\n\n\"<i>Was Master satisfied?</i>\" she asks");
        if (this.gargoyleConfidence() > 70) this.outputText(" with just a hint of a smile");
        this.outputText(".");
    ...
    private useGargoyleMaleHerm(): void {
        ...
        this.outputText("\n\nBut you aren't quite satisfied just pounding an insensate hole.  Knowing that you have the power to \"revive\" " + this.flags[kFLAGS.GAR_NAME] + " through touch, you decide to put this to rather devious use.  You reach around her body and grab one of her breasts, giving it a few hard squeezes until you hear the faintest gasp from the little gargoyle.  You release it immediately.  Your hand switches down to her taut ass and gives it a loud swat.  You repeat the action twice, and finally feel her cunt contract – just a bit – around your shaft.  You switch your attentions down to her thighs, gently running your hands along both expanses of gray skin beneath your thrusting [cock biggest].  You feel her shudder, ever so slightly, but just as she's on the verge of reviving, you pull back your hands.");

        this.outputText("\n\nYou return to thrusting into her, going fast and furious as your pleasure climbs steadily towards climax.  Only when you're bursting over the threshold of orgasm do you lay your hands on " + this.flags[kFLAGS.GAR_NAME] + " again, grabbing her ass and giving one last massive thrust into her, shoving your [cock biggest] in to the hilt.  You cum inside her just as she awakens, moaning lustily into her ear as spunk drizzles out around your member.");

        this.outputText("\n\n\"<i>M-Master?</i>\" " + this.flags[kFLAGS.GAR_NAME] + " gasps, giving a full-body shudder as you slowly pull out from inside her.  Your cum drools out of her snatch and pools beneath her.  Playfully, you jam your fingers up between her legs, damming your sperm inside her.  To your glee, this simple act sends " + this.flags[kFLAGS.GAR_NAME] + " right over the edge: convulsing, she collapses on the floor with a heavy THUNK!");
    ...
    private ritualGargoyle(): void {
        ...
        if (this.flags[kFLAGS.RITUAL_INTRO] == 0) {
            ...
            this.outputText("You note that the sanctuary's altar has been cleared of rubble, and a number of candles have been lit upon it. Resting atop the flat stone surface is a simple iron bowl filled with what appears to be water. Curious, you ask " + this.flags[kFLAGS.GAR_NAME] + " what she's been up to.");
            ...
            if (this.gargoyleConfidence() < 50) this.outputText(" Forgive my impertinence, but");
        ...
        //[b]Ritual (Any after First)[/b]
            ...
            this.outputText("You walk to the church's alter, shortly followed by " + this.flags[kFLAGS.GAR_NAME] + ".  You ask her if she's still able to perform the church's Rituals, to which she replies \"<i>Of course, Master.  Do you have need of one?</i>\"");

        }
        //(Display Options: [Body] [Mind] [Banish (only with Exgartuan or Worms)] and [Leave])
        this.menu();
        this.addButton(this, 0, "Body", this.bodyRitual);
        this.addButton(this, 1, "Mind", this.mindGargoyleRitual);
        if (this.player.findStatusAffect(StatusAffects.Infested) >= 0 || this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) this.addButton(this, 2, "Banish", this.banishmentGargoyleRitual);
        this.addButton(this, 4, "Leave", this.returnToCathedral);
    }
    ...
    private bodyRitual(): void {
        this.clearOutput();
        this.outputText("You tell " + this.flags[kFLAGS.GAR_NAME] + " that you could stand to reverse some of the corruption that has affected your body.  With an solemn nod, she takes you to a side alcove near the altar and instructs you to spread your arms and legs.  Hesitantly, you do so, and from the floor and ceiling " + this.flags[kFLAGS.GAR_NAME] + " produces leather straps with rough looped straps.  Before you can react, she binds your arms and legs, spreading you eagle against the cold stone wall.");

        this.outputText("\n\n\"<i>With pain comes purity,</i>\" " + this.flags[kFLAGS.GAR_NAME] + " says, so quietly you can barely hear her.  \"<i>Prepare yourself, Master,</i>\" she adds, and your heart nearly skips a beat when you hear the crack of a whip behind you.  Oh, shit, this is going to hu-CRACK!  You see stars as white-hot pain arcs through your body, making you scream into the wall.  You can feel the burning streak left across your back by the bullwhip, throbbing mercilessly in the moments before CRACK!  She hits you again, throwing you forward against your bonds with the force of the blow.");

        this.outputText("\n\nOver your ragged, pained breathing, you can just hear " + this.flags[kFLAGS.GAR_NAME] + " chanting: \"<i>With pain comes purity... CRACK!  With agony comes enlightenment... CRACK!  Through torment comes holiness... CRACK!</i>\"  The last crack of the whip leaves you groaning, breathless, sagging in your bonds. Somehow, though, you do feel... cleaner?  Like a weight was just lifted from your heart.  And you know you're going to be thicker-skinned after that!  Quietly, reservedly, " + this.flags[kFLAGS.GAR_NAME] + " releases you from your bonds, and you stagger into her waiting arms.  She helps you over to the altar and lays you down, letting you rest after your ordeal.  She stands over you, watching you pant and gasp.  You suppose you could get some vengeance for her brutality – or you could be kind.  What do you do?");
        this.dynStats("lib", -.5, "sen", -2);
        this.player.takeDamage(Math.round(this.player.maxHP() / 2));
        //(Display options: [Nothing] [Revenge] and [Cuddle])
        this.menu();
        this.addButton(this, 0, "Nothing", this.noReactionToBodyRitual);
        this.addButton(this, 1, "Cuddle", this.gargoyleCuddleAfterBodyRitual);
        this.addButton(this, 2, "Revenge", this.gargoyleRevengeAfterBodyRitual);
    }

    //[b]Nothing[/b]
    private noReactionToBodyRitual(): void {
        this.clearOutput();
        this.outputText("You simply lie still and try to recover from " + this.flags[kFLAGS.GAR_NAME] + "'s \"gentle ministrations.\"  After a few minutes, you've caught your breath and, gathering your possessions, make your way out of the Cathedral without another word.  Damn, you're sore.");
        this.doNext(this, this.camp.returnToCampUseOneHour);
    ...
    private mindGargoyleRitual(): void {
        this.clearOutput();
        this.outputText("You tell " + this.flags[kFLAGS.GAR_NAME] + " that you've been plagued with dirty thoughts, and would like to undo some of the corruption that's spread to your mind.  " + this.flags[kFLAGS.GAR_NAME] + " nods respectfully and tells you to kneel before the altar. You do so, assuming a low, supplicating stance before the tree-idol at the Cathedral's head as the gargoyle picks up the bowl of water and raises it on high.");
        ...
        this.outputText("  " + this.flags[kFLAGS.GAR_NAME] + " brings the invocation to a quiet close, and rests the bowl back upon the altar. \"<i>Drink of this, Master,</i>\" she says, offering you the bowl, \"<i>and be healed of mind.</i>\"");

        this.outputText("\n\nYou do so, taking a long draught of the holy water.  By the time you've set the bowl down, you feel light-headed, as if a fog has receded from your mind.  You gasp happily, able to think more clearly than you have in days.  You thank " + this.flags[kFLAGS.GAR_NAME] + ", give her a pat on the head, and head back to camp with a skip in your step.");
    ...
    private banishmentGargoyleRitual(): void {
        this.clearOutput();
        this.outputText("Talking about " + this.flags[kFLAGS.GAR_NAME] + "'s rituals, you explain that you seem to have picked up ");
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) this.outputText("a hitchhiker");
        else this.outputText("some hitchhikerss");
        ...
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) this.outputText("this bastard");
        else this.outputText("these bastards");
        this.outputText(" out of your system.");

        this.outputText("\n\nFrom beneath the altar, " + this.flags[kFLAGS.GAR_NAME] + " withdraws what looks like a perfectly cylindrical dildo, covered with dozens of dark, dimly-glowing blue runes.  Slowly, she makes her way around you and kneels behind your [butt].  \"<i>Take a deep breath, Master, and relax yourself.  It will be better this way.</i>\"");
        ...
        if (this.gargoyleConfidence() >= 50) this.outputText(" soothingly, using her free hand to stroke your thighs");
        ...
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) this.outputText("creature within you has");
        else this.outputText("creatures within you have");
        this.outputText(" been absorbed and purged by the rod, which " + this.flags[kFLAGS.GAR_NAME] + " proceeds to chuck out a window.  Hopefully she has more, in case you ever get ");
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) this.outputText("possessed");
        else this.outputText("infested");
        this.outputText(" again.");

        this.outputText("\n\nStill panting and gasping from your ordeal, you notice " + this.flags[kFLAGS.GAR_NAME] + " looming over you, smiling.  You could be a dick for all that pain she caused you, or thank her for helping you.");
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) this.player.removeStatusAffect(StatusAffects.Exgartuan);
        else this.player.removeStatusAffect(StatusAffects.Infested);
        this.player.takeDamage(Math.round(this.player.maxHP() / 3));
        this.fatigue(10);
        //(Display options: [Nothing] [Revenge] and [Cuddle])
        this.addButton(this, 0, "Nothing", this.dontFreakOutAfterBanishment);
        this.addButton(this, 1, "Cuddle", this.cuddleForBanishments);
        this.addButton(this, 2, "Revenge", this.getRevengeForBanishments);
    }
    ...
    private gargoyleKinkyRituals(): void {
        ...
        if (this.flags[kFLAGS.KINKY_RITUALS_SPOKEN] == 0) {
            this.outputText("You broach the subject of rituals to your gargoyle and are met with a surprisingly coy smile from her.  You ask her what's on her mind, to which " + this.flags[kFLAGS.GAR_NAME] + " chuckles and says, \"<i>I've been thinking, Master. If you so desire, it may be possible to... enhance... the rituals that I've been using.</i>\"");
        ...
        //(While Confidence 70+)
            ...
            this.outputText("You walk to the church's alter, shortly followed by " + this.flags[kFLAGS.GAR_NAME] + ".  You tell her you need one of her holy rituals, but that you'd prefer to have some fun as well.  Grinning, she says, \"<i>It would be my pleasure, my Master. What shall we do?</i>\"");
        }
        //(Display Options: [Body] [Mind] [Banish (only with Exgartuan or Worms)] and [Leave])
        this.menu();
        this.addButton(this, 0, "Body", this.kinkyBodyRitual);
        this.addButton(this, 1, "Mind", this.mindRitualPervy);
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0 || this.player.findStatusAffect(StatusAffects.Infested) >= 0) this.addButton(this, 2, "Banish", this.banishPervRitual);
        this.addButton(this, 4, "Leave", this.returnToCathedral);
    }
    ...
    private kinkyBodyRitual(): void {
        ...
        //(Confidence +2)
        //(PC decreases Libido and Sensitivity. Suffers 20% Max HP damage, to a minimum of 1 pt. remaining)
        this.outputText("You tell " + this.flags[kFLAGS.GAR_NAME] + " that you could stand to reverse some of the corruption that has affected your body.  With an eager nod, she strips you down, takes you to a side alcove near the altar and instructs you to spread your arms and legs.  Putting your trust in your little gargoyle, you do so, allowing her to bind you spread-eagle with long leather straps.");
        ...
        if (this.player.biggestTitSize() >= 1) this.outputText(", cupping your [chest] in her cold stone hands");
        ...
        this.outputText(".  She breaks the kiss and steps back, laying on one last time – CRACK! with the crop, stinging you again with an intense mix of pain and pleasure.  Gasping and panting from stimulation, you nearly collapse when " + this.flags[kFLAGS.GAR_NAME] + " unbinds you, though she's quick to catch you before you fall.");

        this.outputText("\n\nShe guides you over to the altar and helps you lie atop it to rest.  Once you're comfortably situated, " + this.flags[kFLAGS.GAR_NAME] + " slips up beside you, resting her cheek ");
        if (this.player.biggestTitSize() < 1) this.outputText("on your chest");
        else this.outputText("between your [chest]");
        ...
        this.outputText("\n\nYou spend a few minutes cuddling with " + this.flags[kFLAGS.GAR_NAME] + ", but sadly, you know you can't leave your camp unattended for too long.  Giving her a pat on the head and a kiss on the brow, you gather up your clothes and head on back to camp.");
    ...
    private banishPervRitual(): void {
        this.clearOutput();
        //(PC is cleared of Worms and/or Exgartuan)
        this.outputText("You explain to " + this.flags[kFLAGS.GAR_NAME] + " that you seem to have picked up ");
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) this.outputText("a hitchhiker");
        else this.outputText("some hitchhikers");
        this.outputText(" in your travels, and you're tired of ");
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) this.outputText("it");
        else this.outputText("them");
        this.outputText(".  She gives you an understanding nod and tells you to strip.  As you do so, she dips beneath the altar, reappearing with a silver, blue-rune covered rod nestled into what looks like a leather thong.  " + this.flags[kFLAGS.GAR_NAME] + " slips the thong on, letting a slight gasp escape her lips as the inner end of the rod enters her.");

        this.outputText("\n\nShe gives the shaft of the strap-on a few experimental strokes and, satisfied, says, \"<i>I've turned down the power of the runes, so it will not hurt you so much... though it will take longer than normal.  I suggest you lubricate it, Master.</i>\"  Smiling, she sits herself atop the alter and presents her silver “cock” to you.  You kneel and slip your face between her spread legs, giving the rod a quick lick.  It's incredibly smooth and quite cold, much like its wearer, but your tongue comes away with a warm tingle spreading through it – not pain, but more like numbness.  You take the rod into your mouth, running your tongue across its length and thrusting your face against it, blowing it like a cock while getting it sopping wet with your saliva.  You've only been at it for a minute when you notice " + this.flags[kFLAGS.GAR_NAME] + " is bucking her hips slightly and moaning quietly, obviously getting more than a little enjoyment from the sensation.  Perhaps she can feel through it, like a real dick?  Grinning, you redouble your efforts to suck her off.");

        this.outputText("\n\n\"<i>Enough, Master,</i>\" she gasps, pushing you back.  Breathing heavily, she takes you by the hand and gets you to brace yourself against the altar.  Your entire mouth is numb now, tingling from the strange sensation given off by the holy rod-cock.  " + this.flags[kFLAGS.GAR_NAME] + " slips behind you, putting a cool, soft hand on your [hips] as she lines up for penetration.  You grip down hard on the edge of the altar, and try your best to relax your sphincter as you begin to feel a tingling pressure against your back door.");
        if (this.player.ass.analWetness > 0) this.outputText("  She slips in easily, sliding her tingling holy rod into you until her hips are pressed against your [butt]");
        else this.outputText("  She slowly but surely coaxes the holy rod into your asshole, making long and slow thrusts into you until she finally bottoms out");
        this.outputText(".");
        ...
        this.outputText("\n\nSuddenly, the holy rod jammed up your [asshole] makes a loud hissing sound, and withdraws. Panting, you collapse to the ground, gripping your gut.  It's over, and though a part of you feels suddenly very empty, it's soon forgotten as " + this.flags[kFLAGS.GAR_NAME] + " slips down beside you, having already tossed the holy rod out the window.  The creature");
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) this.outputText(" within you has");
        else this.outputText("s within you have");
        this.outputText(" been absorbed and purged by the rod; and you can't help but hope she has more... just in case.");

        this.outputText("\n\nStill panting and gasping from your ordeal, you slip an arm around " + this.flags[kFLAGS.GAR_NAME] + "'s shoulders, bringing her into a tight embrace.  Smiling cutely, she nuzzles her cheek against your chest, and winds her large bat-wings around the two of you, wrapping you together.  You give her a long, tender kiss on the brow, and let her remain like that for a good long while, basking in each others' presence.");

        this.outputText("\n\nEventually, though, you know you need to get back to camp.  You try to tell " + this.flags[kFLAGS.GAR_NAME] + ", but to your surprise, she's fast asleep, snoring softly.  With a grin, you untangle yourself from her embrace and find something to cover her with before giving her another kiss and making your way home.");
        //(Return PC to camp, advance time 1 hour)
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) this.player.removeStatusAffect(StatusAffects.Exgartuan);
        else this.player.removeStatusAffect(StatusAffects.Infested);
        this.player.takeDamage(Math.round(this.player.maxHP() / 3));
    ...
    private talkToGargoyle(output: boolean = true): void {
        ...
        this.menu();
        if (this.flags[kFLAGS.GAR_HISTORY] < 3) this.addButton(this, 0, "History", this.historyGo);
        if (this.flags[kFLAGS.GAR_CATHEDRAL] < 3) this.addButton(this, 1, "Cathedral", this.cathedralTalks);
        if (this.flags[kFLAGS.GAR_NAME_TALKS] < 3) this.addButton(this, 2, "Her", this.talkAboutGarName);
        this.addButton(this, 4, "Back", this.returnToCathedral);
    }

    private historyGo(): void {
        if (this.flags[kFLAGS.GAR_HISTORY] == 0) {
            this.flags[kFLAGS.GAR_HISTORY] = 1;
            this.talkToGargoyleHistoryA();
        }
        else if (this.flags[kFLAGS.GAR_HISTORY] == 1) {
            this.historyOfGargoylesB();
            this.flags[kFLAGS.GAR_HISTORY] = 2;
        }
        else {
            this.flags[kFLAGS.GAR_HISTORY] = 3;
    ...
    private talkToGargoyleHistoryA(): void {
        ...
        this.outputText("You ask " + this.flags[kFLAGS.GAR_NAME] + " what she can tell you about the history of Mareth.  She shrugs lightly.  \"<i>I can't tell you much, Master.  I've spent my entire life on these grounds.  Most of what I know was doctrine taught by the church. Is that acceptable?</i>\"");
        ...
        this.menu();
        this.addButton(this, 0, "Berate", this.berateGargoyleForBeingDumb);
        this.addButton(this, 1, "Comfort", this.comfortGargoyleDumbness);
    ...
    private historyOfGargoylesB(): void {
        this.clearOutput();
        this.outputText("You ask " + this.flags[kFLAGS.GAR_NAME] + " to tell you a little bit about the demons coming to Mareth");
    ...
    private gargoyleHistoryC(): void {
        ...
        if (kGAMECLASS.izmaScene.izmaFollower() && kGAMECLASS.isabellaFollowerScene.isabellaFollower()) {
            this.outputText("You ask " + this.flags[kFLAGS.GAR_NAME] + " to tell you a little bit about the world of Mareth.  Giving it a few moments of quiet thought, she answers: \"<i>I do not have any experience outside of the church grounds, Master, but I remember the words of the last Master, and the parishioners before her.  There are... the world has a vast expanse of plains and woodlands, broken up by a mountain range and lake.  Those last two are populated by savage beasts, minotaurs, cow-girls, anemone, and shark-people, both of whom will rend your flesh or rape you half to death.</i>\"");
            this.outputText("\n\nWhoa, there. You stop " + this.flags[kFLAGS.GAR_NAME] + " and explain to her that some of your lovers – mates, even – are just such beasts.  You tell her a little bit about Izma and Isabella, enforcing the fact that they're both not only quite friendly, but sweet as well.  They're just regular people");
            if (this.gargoyleConfidence() > 50) this.outputText(" just like her");
            this.outputText(".  If she could, you're sure " + this.flags[kFLAGS.GAR_NAME] + " would be blushing bright crimson as you educate her on a little inter-special tolerance and understanding.  Chastened, she nods her comprehension when you're finished and, after a long pause, asks, \"<i>I-If Master really has many... girlfriends... does... no, it's silly, of course not...</i>\"");
            ...
            this.menu();
            this.addButton(this, 0, "Dodge", this.izmaAndIsabellaDodge);
            this.addButton(this, 1, "Slave", this.gargoylesAreSlavesYo);
            this.addButton(this, 2, "Girlfriend", this.gargoylesAreGirlfriends);
        }
        //(If PC has Marble as a follower)
        else if (this.player.findStatusAffect(StatusAffects.CampMarble) >= 0) {
            this.outputText("You ask " + this.flags[kFLAGS.GAR_NAME] + " to tell you a little bit about the world of Mareth.  Giving it a few moments of quiet thought, she answers: \"<i>I do not have any experience outside of the church grounds, Master, but I remember the words of the last Master, and the parishioners before her.  I believe there is a lake not far from here.  Beyond that, the world has a vast expanse of plains and woodlands, broken up by a great mountain range – strange monsters live there, but worst of all are savage bull-like beasts called Minotaurs.  And the cow-girls... Lacta-Bovines, I think they're called, who're just as nasty.</i>\"");
            this.outputText("\n\nYou cut " + this.flags[kFLAGS.GAR_NAME] + " off right there, and explain that one of those 'savage beasts' is your lover, Marble, who's really quite sweet.  The gargoyle makes a horrified gasp and covers her mouth.  \"<i>I'm so sorry, Master! I didn't know...  All I'd heard were stories, years ago.  I didn't mean... but...  I-I didn't know Master had a girlfriend,</i>\" she whines pitifully.  Obviously, knowing that she's not your only lady-friend has upset the poor thing.");
            this.outputText("\n\nWell.  What do you say to that: that you're not exclusive with Marble, or that " + this.flags[kFLAGS.GAR_NAME] + " doesn't count, being a statue and all?");
            //(Display Options: [Not Exclusive] [Doesn't Count])
            this.menu();
            this.addButton(this, 0, "Not Exclusive", this.marbleAintExclusiveBiatch);
            this.addButton(this, 1, "Doesn'tCount", this.gargoyleDoesntCountAsAWaifu);
        }
        //(If PC has Izma as a follower)
        else if (kGAMECLASS.izmaScene.izmaFollower()) {
            this.outputText("You ask " + this.flags[kFLAGS.GAR_NAME] + " to tell you a little bit about the world of Mareth.  Giving it a few moments of quiet thought, she answers: \"<i>I do not have any experience outside of the church grounds, Master, but I remember the words of the last Master, and the parishioners before her.  There are... the world has a vast expanse of plains and woodlands, broken up by a great mountain range.  There is a lake not far from here, if I recall; a race of very dangerous shark-folk live there.</i>\"  With a chuckle, you tell " + this.flags[kFLAGS.GAR_NAME] + " that you're more than well aware of that; indeed, you consider one such creature to be your mate, your beta.  She makes a slight gasp, and gushes out an apology.  \"<i>I'm so sorry, Master!  I hadn't realized... I thought...</i>\" she falls silent for a moment, then says shyly, \"<i>I wasn't aware Master had a girlfriend.</i>\"  Obviously, knowing that she's not your only lady-friend has upset the poor thing.");

            this.outputText("\n\nWell. What do you say to that: that you're not exclusive with Izma, or that she doesn't count, being a statue and all?");
            //(Display Options: [Not Exclusive] [Doesn't Count])
            this.menu();
            this.addButton(this, 0, "Not Exclusive", this.sharkgirlsArentExclusiveBiatch);
            this.addButton(this, 1, "Doesn'tCount", this.gargoylesDontCountAsSharkWaifus);
        }
        else {
    ...
    private izmaAndIsabellaDodge(): void {
        ...
        //(Confidence -5)
        this.gargoyleConfidence(-5);
        this.outputText("You make a shitty joke and laugh awkwardly, trying to avoid the topic altogether.  " + this.flags[kFLAGS.GAR_NAME] + " makes a pitiful little sniffle, but takes the hint and falls silent, allowing you to change the subject.");
    ...
    private gargoylesAreGirlfriends(): void {
        ...
        this.gargoyleConfidence(15);
        this.outputText("You smile at " + this.flags[kFLAGS.GAR_NAME] + " and tussle her hair.  Warmly, you tell her that, if she wants, she can be your girlfriend too.  Polyamory is just your thing, you suppose.  With a happy gasp, the little gargoyle leaps into your lap and wraps her arms around you, hugging you so tight you almost can't breathe.  She gives you a flurry of little kisses all along your neck and cheek before planting a long, deep one on your lips.  You kiss her back, soon laughing amicably as you return her embrace.  Once she's calmed down, " + this.flags[kFLAGS.GAR_NAME] + " settles into your lap, resting her cheek against your chest and wrapping her tail and wings lovingly around you.  You give her a little peck on the forehead and nuzzle your chin into her hair, content to stay like this forever.");

        this.outputText("\n\nYet, you're soon surprised when " + this.flags[kFLAGS.GAR_NAME] + " withdraws slightly from you, though her arms are still hooked about your neck.  \"<i>Master... if you want me to be your girlfriend, then... we should – if you want, Master, of course – maybe...  Master, will you make love to me?</i>\" she blurts, suddenly taken aback by her own forwardness.");
        ...
        this.menu();
        if (this.player.hasCock()) this.addButton(this, 0, "Vaginal", this.gargoyleCoochiiGetsPlowed);
        else this.addButton(this, 1, "Strap-on", this.strapOnGargoyle);
        this.addButton(this, 4, "Leave", this.camp.returnToCampUseOneHour);
    }

    private cathedralTalks(): void {
        if (this.flags[kFLAGS.GAR_CATHEDRAL] == 0) {
            this.flags[kFLAGS.GAR_CATHEDRAL]++;
            this.talkCathedralA();
        }
        else if (this.flags[kFLAGS.GAR_CATHEDRAL] == 1) {
            this.cathedralBTalk();
            this.flags[kFLAGS.GAR_CATHEDRAL] = 2;
        }
        else {
            this.cathedralC();
            this.flags[kFLAGS.GAR_CATHEDRAL] = 3;
        }
    }
    ...
    private cathedralC(): void {
        this.clearOutput();
        this.outputText("As you sit down with " + this.flags[kFLAGS.GAR_NAME] + " to talk, you remember her words when you first met indicating that she could not – or would not – leave the Cathedral, even if you asked her to.   You ask her about that.");
        this.outputText("\n\n\"<i>Master,</i>\" " + this.flags[kFLAGS.GAR_NAME] + " says, now looking you straight in the eye, \"<i>the Cathedral is my home, the only home I've ever known.  Even if I could leave, I would not want to");
        if (this.gargoyleConfidence() > 69) this.outputText(" unless it were to be with you, that is");
        ...
        this.menu();
        this.addButton(this, 0, "Berate", this.berateDatGargoyle4SomeSavin);
        this.addButton(this, 1, "Comfort", this.comfortGargoyle);
    ...
    private comfortGargoyle(): void {
        ...
        this.outputText("\n\nTo your surprise, " + this.flags[kFLAGS.GAR_NAME] + " follows you, running to catch up with you.  She takes your hand in hers and wraps one of her wings around you as you walk, holding you close as you make your way out the doors and onto the grounds.  Soon, though, you see " + this.flags[kFLAGS.GAR_NAME] + " slowing and grimacing – approaching the edge of her boundary.  The two of you stop at the wrought-iron fence surrounding the Cathedral, and face each other.");
    ...
    private talkAboutGarName(): void {
        if (this.flags[kFLAGS.GAR_NAME_TALKS] == 0) {
            this.flags[kFLAGS.GAR_NAME_TALKS] = 1;
            this.garNameA();
        }
        else if (this.flags[kFLAGS.GAR_NAME_TALKS] == 1) {
            this.flags[kFLAGS.GAR_NAME_TALKS] = 2;
            this.garNameB();
        }
        else {
            this.flags[kFLAGS.GAR_NAME_TALKS] = 3;
            this.garNameC();
        }
    }
    ...
    private garNameA(): void {
        this.clearOutput();
        this.outputText("Curious about your gargoyle, you ask " + this.flags[kFLAGS.GAR_NAME] + " to tell you a little bit about her life before you arrived.  She makes a nervous chuckle at the request, and shyly says, \"<i>Master is too kind...  I am no one special...</i>\"");
        ...
        if (this.player.race() == "human") this.outputText("are");
        else this.outputText("once were");
        ...
        if (this.gargoyleConfidence() > 69) this.outputText("  She continues, \"<i>though even were I not compelled to, I would still serve you,</i>\" she says with a playful wink.");
        ...
        //If Confidence =<69:
        if (this.gargoyleConfidence() <= 69) this.outputText("\n\nAfter what she did to me, I cannot enjoy sex; just the thought of it makes me shudder.</i>\"");
        else this.outputText("After what she did to me, I never thought I'd enjoy sex again.</i>\"  With a loving smile, " + this.flags[kFLAGS.GAR_NAME] + " takes your hand in hers and brushes it against her cheek.  \"<i>But for you, Master, I think I could make an exception.</i>\"");
        ...
        //If Confidence =<69:
        if (this.gargoyleConfidence() <= 69) this.outputText("  \"<i>I'm sorry, Master, I can't... it hurts too much to think about it.</i>\"");
        else this.outputText("  \"<i>Sorry, Master. I just....Don't want to talk about it right now.  Ask me again some time.</i>\"");
    ...
    private garNameB(): void {
        ...
        this.outputText("\n\nYou don't need to prompt " + this.flags[kFLAGS.GAR_NAME] + " this time.  \"<i>She left, perhaps ten years ago.  One day I was following orders to Master's pleasure, and the next I was bound to my pedestal, wearing the chains that Master broke to set me free.</i>\"");
    ...
    private garNameC(): void {
        ...
        this.menu();
        this.addButton(this, 0, "Comfort", this.comfortGarNameC);
        this.addButton(this, 1, "Berate", this.berateGargoyleC);
    }
    ...
    private comfortGarNameC(): void {
        this.clearOutput();
        this.outputText("You pull " + this.flags[kFLAGS.GAR_NAME] + " onto your lap and run your hand through her hair.  You tell her that she's wrong – dead wrong.  She is a person, and she is not helpless.  She's anything but.");
        ...
        this.outputText("\n\nShe smiles weakly, and rests her head on your chest.  \"<i>As you command, Master,</i>\" she says, and falls silent.  You sit there for a long while, stroking the gargoyle's soft hair and hoping you have made an impression on her.  But, eventually, you know you have to part.  You give " + this.flags[kFLAGS.GAR_NAME] + " a little kiss on the forehead and tell her to do whatever she wants while you're gone.");
        ...
        this.outputText("\n\nSighing, you pat " + this.flags[kFLAGS.GAR_NAME] + " on the head and tell her you'd be happy to stay for a while longer.  Beaming, she asks you what you'd like to do.");
    ...
    private gargoyleAppearance(): void {
        this.clearOutput();
        this.outputText("" + this.flags[kFLAGS.GAR_NAME] + " is a gray marble statue that, through magics you can't quite grasp, has been animated.");
        ...
        if (this.gargoyleConfidence() < 70) this.outputText("glow timidly, reflecting a submissive and servile nature in the gargoyle.");
        else this.outputText("have a cool fire in them, showing her steadily-growing confidence and warmth toward you.");
        this.outputText("  Her skin is cold and smooth to the touch, a consequence of her marble material, yet she is quite soft, almost squishy.  " + this.flags[kFLAGS.GAR_NAME] + " has a pair of cute little horns upon her brow, and has bat-like wings sprouting from her back which give a gentle flap every few seconds, an unconscious gesture on her part as you stare at her.  She has a long, spiked tail that curls ");
        if (this.gargoyleConfidence() < 70) this.outputText("timidly");
        else this.outputText("playfully");
