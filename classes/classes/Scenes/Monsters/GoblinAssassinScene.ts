...
export class GoblinAssassinScene extends BaseContent {
    ...
    public gobboAssassinBeatYaUp(): void {
        ...
        if (this.player.cockThatFits(this.monster.vaginalCapacity()) >= 0 && this.player.hasCock() && (!this.player.hasVagina() || GoblinAssassinScene.rand(2) == 0)) {
            ...
            if (this.player.cockTotal() == 1) this.outputText("that thing");
            else this.outputText("those things");
            ...
            if (this.player.balls > 0) this.outputText("[sack], giving it a gentle caress before vanishing.");
            else if (this.player.hasVagina()) this.outputText(this.vaginaDescript() + ", the tips giving your soaked mound only the barest ghost of a touch.");
            else this.outputText("taint, the tips giving your sensitive skin only the barest ghost of a touch.");
            ...
            if (this.player.femininity < 40) this.outputText("almost ");
            ...
            if (this.player.hasSheath()) this.outputText(" the sheath");
            else this.outputText("your base");
            ...
            this.outputText("\n\n\"<i>");
            if (this.silly()) this.outputText("Stop right there, criminal scum.");
            else this.outputText("Hold your horses.");
            ...
            if (this.player.balls > 0) this.outputText("  A hand squeezes your [sack] encouragingly");
            else this.outputText("  Hands squeeze your [butt] encouragingly");
            ...
            if (this.player.cumQ() >= 750) {
                ...
                if (this.player.cumQ() >= 2000) this.outputText("  It swells to a rounded, pregnant dome by the time you finish.");
            }
        ...
        //ii. Lust Loss - Male - No Fit
            ...
            if (this.player.biggestCockLength() > this.player.tallness / 2) this.outputText("  Your incredibly long phallus blocks your view of the sultry goblin, and you never see the blow coming.");
            ...
            if (this.player.biggestCockLength() < this.player.tallness / 2) this.outputText("sitting on your face, the " + this.player.cockHead(x) + " of your maleness jutting against her drooling lips.");
            else this.outputText("sitting on the ground ‘above’ you, your " + this.player.cockHead(x) + " reaching all the way up to spear her moist box, judging by what you’re feeling anyway.");
            ...
            if (this.player.cumQ() >= 1000) this.outputText("You spurt huge dollops of pre-cum into her waiting twat thanks to your prodigious virility, though it is only a hint of things to come.  ");
            else if (this.player.cumQ() >= 250) this.outputText("You drool a steady flow of pre-cum into her waiting twat, though it’s only a hint of things to come.  ");
            ...
            if (this.player.biggestCockLength() >= this.player.tallness / 2) this.outputText("pulsating, iron-hard cock");
            else this.outputText("captor’s pillowy asscheeks");
            ...
            if (this.player.cumQ() <= 10) this.outputText("dribbles");
            else if (this.player.cumQ() <= 100) this.outputText("squirts");
            else if (this.player.cumQ() <= 250) this.outputText("thick wads");
            else if (this.player.cumQ() <= 1750) this.outputText("waves of gooey spooge");
            else this.outputText("rivers of cum");
            this.outputText(" into the goblin’s box.");
            if (this.player.cumQ() >= 2500) this.outputText(" Her belly rounds up nicely under your voluminous attentions.");
        ...
        //iii. Lust Loss - Female
            ...
            if (this.player.hasFuckableNipples()) this.outputText("piston in and out of your [nipple], masturbating it just as hard as the real thing.");
            else this.outputText("squeeze around a taut nipple, twisting and pulling on it unthinkingly.");
