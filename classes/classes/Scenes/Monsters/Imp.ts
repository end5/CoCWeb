...
export class Imp extends Monster {
    ...
    protected lustMagicAttack(): void {
        ...
        if (this.player.lust >= 30 && this.player.lust < 60) this.outputText("Blood rushes to your groin as a surge of arousal hits you, making your knees weak.  ");
        if (this.player.lust >= 60) this.outputText("Images of yourself fellating and fucking the imp assault your mind, unnaturally arousing you.  ");
