...
export class LustyMaidensArmor extends Armor {
    ...
    public canUse(): boolean {
        if (this.game.player.biggestTitSize() < CoC.BREAST_CUP_A) { //{No titties}
        ...
        if (this.game.player.biggestTitSize() < CoC.BREAST_CUP_D) { //{Too small titties}
