...
export class BreastStore extends Utils implements SaveAwareInterface {
    ...
    public canTitFuck(): boolean { return this._cupSize >= CoC.BREAST_CUP_C; }

    public cup(): string { return Appearance.breastCup(this._cupSize); } //The cup size alone
    ...
    public hasBreasts(): boolean { return this._cupSize != CoC.BREAST_CUP_FLAT; }
