...
export class Mutations extends BaseContent {
    ...
    public succubiMilk(tainted: boolean, player: Player): void {
        ...
        if (player.cor >= 35 && player.cor < 70) {
            ...
            if (player.gender == 2 || player.gender == 3) {
                this.outx(`  The taste alone makes your ${this.vaginaDescript(0)} feel `, false);
        ...
        if (player.sens < 60 && changes < changeLimit && Mutations.rand(3) == 0) {
            ...
            // (BIG boost 1/3 chance)
                ...
                if (player.gender == 1) {
                    ...
                    this.outx(`your ${this.vaginaDescript(0)} and ${this.clitDescript()}`, false);
        ...
        if (
            ...
            if (player.lib < 40) {
                ...
                if (player.hasVagina())
                    ...
                    this.outx(` The hardness of ${this.sMultiCockDesc()} seems to agree.`, false);
                this.dynStats("lus", 5);
            }
            // (sub 75 lib)
