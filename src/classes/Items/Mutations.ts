...
import { ANTENNAE_NONE, ARM_TYPE_HARPY, ARM_TYPE_HUMAN, ARM_TYPE_SPIDER, EARS_BUNNY, EARS_CAT, EARS_COW, EARS_DOG, EARS_ELFIN, EARS_FERRET, EARS_FOX, EARS_HORSE, EARS_HUMAN, EARS_KANGAROO, EARS_LIZARD, EARS_MOUSE, EARS_RACCOON, EYES_BLACK_EYES_SAND_TRAP, EYES_FOUR_SPIDER_EYES, EYES_HUMAN, FACE_BUCKTEETH, FACE_BUNNY, FACE_CAT, FACE_COW_MINOTAUR, FACE_DOG, FACE_FERRET, FACE_FERRET_MASK, FACE_FOX, FACE_HORSE, FACE_HUMAN, FACE_KANGAROO, FACE_LIZARD, FACE_MOUSE, FACE_RACCOON, FACE_RACCOON_MASK, FACE_SHARK_TEETH, FACE_SNAKE_FANGS, FACE_SPIDER_FANGS, HAIR_ANEMONE, HAIR_GOO, HORNS_COW_MINOTAUR, HORNS_DEMON, HORNS_DRACONIC_X2, HORNS_DRACONIC_X4_12_INCH_LONG, HORNS_NONE, LOWER_BODY_FERRET, LOWER_BODY_TYPE_BEE, LOWER_BODY_TYPE_BUNNY, LOWER_BODY_TYPE_CAT, LOWER_BODY_TYPE_CENTAUR, LOWER_BODY_TYPE_CHITINOUS_SPIDER_LEGS, LOWER_BODY_TYPE_DEMONIC_CLAWS, LOWER_BODY_TYPE_DEMONIC_HIGH_HEELS, LOWER_BODY_TYPE_DOG, LOWER_BODY_TYPE_DRIDER_LOWER_BODY, LOWER_BODY_TYPE_FOX, LOWER_BODY_TYPE_GOO, LOWER_BODY_TYPE_HARPY, LOWER_BODY_TYPE_HOOFED, LOWER_BODY_TYPE_HUMAN, LOWER_BODY_TYPE_KANGAROO, LOWER_BODY_TYPE_LIZARD, LOWER_BODY_TYPE_NAGA, LOWER_BODY_TYPE_PONY, LOWER_BODY_TYPE_RACCOON, SKIN_TYPE_FUR, SKIN_TYPE_GOO, SKIN_TYPE_PLAIN, SKIN_TYPE_SCALES, TAIL_TYPE_BEE_ABDOMEN, TAIL_TYPE_CAT, TAIL_TYPE_COW, TAIL_TYPE_DEMONIC, TAIL_TYPE_DOG, TAIL_TYPE_DRACONIC, TAIL_TYPE_FERRET, TAIL_TYPE_FOX, TAIL_TYPE_HARPY, TAIL_TYPE_HORSE, TAIL_TYPE_KANGAROO, TAIL_TYPE_LIZARD, TAIL_TYPE_MOUSE, TAIL_TYPE_NONE, TAIL_TYPE_RABBIT, TAIL_TYPE_RACCOON, TAIL_TYPE_SHARK, TAIL_TYPE_SPIDER_ADBOMEN, TONUGE_DEMONIC, TONUGE_HUMAN, TONUGE_SNAKE, VAGINA_LOOSENESS_GAPING, VAGINA_LOOSENESS_LOOSE, VAGINA_LOOSENESS_TIGHT, VAGINA_WETNESS_DROOLING, VAGINA_WETNESS_DRY, VAGINA_WETNESS_NORMAL, VAGINA_WETNESS_SLAVERING, VAGINA_WETNESS_SLICK, VAGINA_WETNESS_WET, WING_TYPE_BAT_LIKE_LARGE, WING_TYPE_BAT_LIKE_TINY, WING_TYPE_BEE_LIKE_LARGE, WING_TYPE_BEE_LIKE_SMALL, WING_TYPE_FEATHERED_LARGE, WING_TYPE_GIANT_DRAGONFLY, WING_TYPE_HARPY, WING_TYPE_NONE, WING_TYPE_SHARK_FIN } from "../../includes/appearanceDefs";
...
export class Mutations extends BaseContent {
    ...
    public ceruleanPotion(player: Player): void {
        ...
        //All else
            ...
            if (player.findStatusAffect(StatusAffects.RepeatSuccubi) >= 0) this.outputText("You look forwards to tonight's encounter.", false);
            //First timer huh?
            else this.outputText("You do not notice any real effects.  Did the merchant con you?", false);
        }
    ...
    public vitalityTincture(player: Player): void {
        ...
        if (player.HP < player.maxHP()) this.outputText("  Any aches, pains and bruises you have suffered no longer hurt and you feel much better.", false);
        ...
        if (Mutations.rand(3) == 0) this.outputText(player.modTone(95, 3), false);
    }
    ...
    public scholarsTea(player: Player): void {
        ...
        if (Mutations.rand(3) == 0) this.outputText(player.modTone(15, 1), false);
    ...
    public incubiDraft(tainted: boolean, player: Player): void {
        ...
        if (player.cor > 33 && player.cor <= 66) this.outputText("reminding you of something you just can't place.", false);
        if (player.cor > 66) this.outputText("deliciously sinful in all the right ways.", false);
        if (player.cor >= 90) this.outputText("  You're sure it must be distilled from the cum of an incubus.", false);
        //Lowlevel changes
        if (rando < 50) {
            if (player.cocks.length == 1) {
                if (player.cocks[0].cockType != CockTypesEnum.DEMON) this.outputText("\n\nYour " + this.cockDescript(0) + " becomes shockingly hard.  It turns a shiny inhuman purple and spasms, dribbling hot demon-like cum as it begins to grow.", false);
                ...
                if (this.temp < .5) this.outputText("  It stops almost as soon as it starts, growing only a tiny bit longer.", false);
                if (this.temp >= .5 && this.temp < 1) this.outputText("  It grows slowly, stopping after roughly half an inch of growth.", false);
                if (this.temp >= 1 && this.temp <= 2) this.outputText("  The sensation is incredible as more than an inch of lengthened dick-flesh grows in.", false);
                if (this.temp > 2) this.outputText("  You smile and idly stroke your lengthening " + this.cockDescript(0) + " as a few more inches sprout.", false);
                if (tainted) this.dynStats("int", 1, "lib", 2, "sen", 1, "lus", 5 + this.temp * 3, "cor", 1);
                else this.dynStats("int", 1, "lib", 2, "sen", 1, "lus", 5 + this.temp * 3);
                if (player.cocks[0].cockType != CockTypesEnum.DEMON) this.outputText("  With the transformation complete, your " + this.cockDescript(0) + " returns to its normal coloration.", false);
                else this.outputText("  With the transformation complete, your " + this.cockDescript(0) + " throbs in an almost happy way as it goes flaccid once more.", false);
            }
            if (player.cocks.length > 1) {
                ...
                if (temp3 < .5) this.outputText("  It stops almost as soon as it starts, growing only a tiny bit longer.", false);
                if (temp3 >= .5 && temp3 < 1) this.outputText("  It grows slowly, stopping after roughly half an inch of growth.", false);
                if (temp3 >= 1 && temp3 <= 2) this.outputText("  The sensation is incredible as more than an inch of lengthened dick-flesh grows in.", false);
                if (temp3 > 2) this.outputText("  You smile and idly stroke your lengthening " + this.cockDescript(temp2) + " as a few more inches sprout.", false);
        ...
        if (rando >= 50 && rando < 93) {
            ...
            if (player.cocks.length == 1) {
                ...
                //Display the degree of thickness change.
                if (temp3 >= 1) {
                    if (player.cocks.length == 1) this.outputText("  Your cock spreads rapidly, swelling an inch or more in girth, making it feel fat and floppy.", false);
                    else this.outputText("  Your cocks spread rapidly, swelling as they grow an inch or more in girth, making them feel fat and floppy.", false);
                }
                if (temp3 <= .5) {
                    if (player.cocks.length > 1) this.outputText("  Your cocks feel swollen and heavy. With a firm, but gentle, squeeze, you confirm your suspicions. They are definitely thicker.", false);
                    else this.outputText("  Your cock feels swollen and heavy. With a firm, but gentle, squeeze, you confirm your suspicions. It is definitely thicker.", false);
                }
                if (temp3 > .5 && temp2 < 1) {
                    if (player.cocks.length == 1) this.outputText("  Your cock seems to swell up, feeling heavier. You look down and watch it growing fatter as it thickens.", false);
                    if (player.cocks.length > 1) this.outputText("  Your cocks seem to swell up, feeling heavier. You look down and watch them growing fatter as they thicken.", false);
                }
                if (tainted) this.dynStats("lib", 3, "sen", 5, "lus", 10, "cor", 3);
                else this.dynStats("lib", 3, "sen", 5, "lus", 10);
            }
        ...
        player.genderCheck();
        if (Mutations.rand(4) == 0 && tainted) this.outputText(player.modFem(5, 2), false);
        if (Mutations.rand(4) == 0 && tainted) this.outputText(player.modThickness(30, 2), false);
    }
    ...
    public tatteredScroll(player: Player): void {
        ...
        if (player.hairColor == "sandy blonde") {
            ...
            if (player.biggestLactation() > 0) {
                ...
                if (player.biggestLactation() < 2) this.outputText("powerful jets of milk spray from your nipples, spraying thick streams over the ground.  You moan at the sensation and squeeze your tits, hosing down the tainted earth with an offering of your milk.  You blush as the milk ends, quite embarassed with your increased milk production.  ", false);
                if (player.biggestLactation() >= 2 && player.biggestLactation() <= 2.6) this.outputText("eruptions of milk squirt from your nipples, hosing thick streams everywhere.  The feeling of the constant gush of fluids is very erotic, and you feel yourself getting more and more turned on.  You start squeezing your breasts as the flow diminishes, anxious to continue the pleasure, but eventually all good things come to an end.  ", false);
                if (player.biggestLactation() > 2.6 && player.biggestLactation() < 3) this.outputText("thick hoses of milk erupt from your aching nipples, forming puddles on the ground.  You smile at how well you're feeding the earth, your milk coating the ground faster than it can be absorbed.  The constant lactation is pleasurable... in a highly erotic way, and you find yourself moaning and pulling on your nipples, your hands completely out of control.  In time you realize the milk has stopped, and even had time to soak into the dirt.  You wonder at your strange thoughts and pull your hands from your sensitive nipples.  ", false);

                if (player.biggestLactation() >= 3) this.outputText("you drop to your knees and grab your nipples.  With a very sexual moan you begin milking yourself, hosing out huge quantities of milk.  You pant and grunt, offering as much of your milk as you can.  It cascades down a hill in a small stream, and you can't help but blush with pride... and lust.  The erotic pleasures build as you do your best to feed the ground all of your milk.  You ride the edge of orgasm for an eternity, milk everywhere.  When you come to, you realize you're kneeling there, tugging your dry nipples.  Embarrassed, you stop, but your arousal remains.  ", false);
    ...
    public minotaurCum(player: Player): void {
        ...
        if (this.flags[kFLAGS.MINOTAUR_CUM_ADDICTION_STATE] == 0) this.outputText("potent musk washes over you.", false);
        else this.outputText("heavenly scent fills your nostrils.", false);
        if (this.flags[kFLAGS.MINOTAUR_CUM_ADDICTION_TRACKER] < 50) this.outputText("  It makes you feel dizzy, ditzy, and placid.", false);
        else this.outputText("  It makes you feel euphoric, happy, and willing to do ANYTHING to keep feeling this way.", false);
        ...
        else if (player.cor < 75) this.dynStats("cor", .5);
        ...
        if (player.cocks.length > 0) {
            ...
            if (player.cockTotal() == 1) this.outputText("Y", false);
        ...
        if (player.hasVagina()) {
            ...
            if (player.clitLength < 3) this.outputText("parting your lips.", false);
            else this.outputText("bursting free of your lips and bobbing under its own weight.", false);
            if (player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_NORMAL) this.outputText("  Wetness builds inside you as your " + this.vaginaDescript(0) + " tingles and aches to be filled.", false);
            else if (player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_SLICK) this.outputText("  A trickle of wetness escapes your " + this.vaginaDescript(0) + " as your body reacts to the desire burning inside you.", false);
            else if (player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_DROOLING) this.outputText("  Wet fluids leak down your thighs as your body reacts to this new stimulus.", false);
            else this.outputText("  Slick fluids soak your thighs as your body reacts to this new stimulus.", false);
        }
        //(Minotaur fantasy)
        if (!kGAMECLASS.inCombat && Mutations.rand(10) == 1) {
            ...
            this.dynStats("lib", 1, "lus", Mutations.rand(5) + player.cor / 20 + this.flags[kFLAGS.MINOTAUR_CUM_ADDICTION_TRACKER] / 5);
        }
        ...
        if (player.findPerk(PerkLib.MinotaurCumAddict) >= 0 && this.flags[kFLAGS.MINOTAUR_CUM_REALLY_ADDICTED_STATE] <= 0) {
    ...
    public minotaurBlood(player: Player): void {
        ...
        if (Mutations.rand(3) == 0 && changes < changeLimit) {
            ...
            //stronger characters gain less
                ...
                if (player.str >= 75) this.dynStats("str", .5);
                //faster from 50-75
        ...
        if (Mutations.rand(3) == 0 && changes < changeLimit) {
            ...
            //stronger characters gain less
                ...
                //small growth if over 75
                if (player.tou >= 75) this.dynStats("tou", .5);
                //faster from 50-75
        ...
        if (player.lowerBody != LOWER_BODY_TYPE_HOOFED && player.lowerBody != LOWER_BODY_TYPE_CENTAUR) {
            if (changes < changeLimit && Mutations.rand(3) == 0) {
                ...
                if (player.skinType != SKIN_TYPE_FUR) this.outputText("  A fine coat of fur grows out below your waist, itching briefly as it fills in.");
        ...
        if (!this.flags[kFLAGS.HYPER_HAPPY]) {
            ...
            if (changes < changeLimit && player.bRows() > 1 && Mutations.rand(3) == 0) {
                ...
                if (player.bRows() >= 3) this.outputText("abdomen", false);
                ...
                if (player.skinType == SKIN_TYPE_FUR) this.outputText(player.hairColor + " " + player.skinDesc, false);
                else this.outputText(player.skinTone + " " + player.skinDesc, false);
            ...
            //Shrink boobages till they are normal
                ...
                //multiple
                    ...
                    temp2 = 0;
                    temp3 = 0;
                    if (player.biggestTitSize() >= 1) this.outputText("\n", false);
                    while (temp3 < player.breastRows.length) {
                        if (player.breastRows[temp3].breastRating >= 1) {
                            ...
                            if (temp2 > 1) this.outputText("...and y", false);
        ...
        if (player.cocks.length > 0 && Mutations.rand(2) == 0 && changes < changeLimit) {
            ...
            if (selectedCockValue != -1) {
                ...
                if (player.horseCocks() > 1) this.outputText("nother")
        ...
        if (changes < changeLimit && Mutations.rand(3) == 0 && player.earType == EARS_COW && player.tailType == TAIL_TYPE_COW) {
            temp = 1;
            ...
            if (player.hornType == HORNS_COW_MINOTAUR || player.hornType == HORNS_NONE) {
                ...
                if (player.hornType == HORNS_COW_MINOTAUR) {
                    ...
                    //Males horns get 'uge.
                        ...
                        if (player.horns < 3) this.outputText("They are the size of tiny nubs.", false);
                        if (player.horns >= 3 && player.horns < 6) this.outputText("They are similar to what you would see on a young bull.", false);
                        if (player.horns >= 6 && player.horns < 12) this.outputText("They look like the horns on a grown bull, big enough and dangerous enough to do some damage.", false);
                        if (player.horns >= 12 && player.horns < 20) this.outputText("They are large and wicked looking.", false);
                        if (player.horns >= 20) this.outputText("They are huge, heavy, and tipped with dangerous points.", false);
        ...
        if (player.earType != EARS_COW && changes < changeLimit && player.tailType == TAIL_TYPE_COW && Mutations.rand(2) == 0) {
        ...
        if (changes < changeLimit && Mutations.rand(4) == 0 && ((player.ass.analWetness > 0 && player.findPerk(PerkLib.MaraesGiftButtslut) < 0) || player.ass.analWetness > 1)) {
        ...
        if (Mutations.rand(4) == 0) this.outputText(player.modFem(5, 10), false);
        if (Mutations.rand(4) == 0) this.outputText(player.modTone(85, 3), false);
        if (Mutations.rand(4) == 0) this.outputText(player.modThickness(70, 4), false);
        //Default
        if (changes == 0) {
    ...
    public equinum(player: Player): void {
        ...
        if (player.skinType == SKIN_TYPE_FUR && player.faceType == FACE_HORSE && player.tailType == TAIL_TYPE_HORSE && (player.lowerBody != LOWER_BODY_TYPE_HOOFED)) {
            ...
            //Bad End
            if (Mutations.rand(4) == 0 && player.findStatusAffect(StatusAffects.HorseWarning) >= 0) {
                ...
                if (player.statusAffectv1(StatusAffects.HorseWarning) > 0) {
                    ...
                    if (player.cockTotal() > 0) {
                        ...
                        if (player.horseCocks() > 0) {
                            ...
                            if (player.gender == 0 || player.gender == 3) this.outputText("horse ", false);
                            if (player.gender == 1) this.outputText("stallion ", false);
                            if (player.gender == 2) this.outputText("mare ", false);
                            ...
                            if (player.gender == 0 || player.gender == 1) this.outputText("He is clearly a male, but you are somewhat confused as you can see not one but three bulges where his manhood would be.\n\n", false);
                            if (player.gender == 2) this.outputText("She is clearly a female, as you can see her six breasts jiggle as she walks towards you, small stains appearing on her shirt where her nipples are.\n\n", false);
                            if (player.gender == 3) this.outputText("You are somewhat confused as you can see a bulge near her thighs but also huge boobs jiggling as she walks, and you can't say if she's a male or female.\n\n", false);
        ...
        if (Mutations.rand(2) == 0) {
            ...
            if (player.tou >= 75) {
                ...
                if (player.gender == 1 || player.gender == 3) this.outputText("stallion's.", false);
                else this.outputText("mare's.", false);
            }
            //NOT MAXXED
            else {
        ...
        if ((player.gender == 1 || player.gender == 3) && Mutations.rand(1.5) == 0 && changes < changeLimit) {
            ...
            if ((player.horseCocks() + player.demonCocks()) < player.cocks.length) {
                ...
                if (player.cocks.length == 1) {
                    ...
                    if (temp3 == 1) this.outputText("  <b>Your penis has transformed into a horse's!</b>", false);
                }
                //MULTICOCK
                else {
                    this.dynStats("lib", 5, "sen", 4, "lus", 35);
                    ...
                    if (player.horseCocks() > 1 || player.dogCocks() > 0) this.outputText("  Your sheath tingles and begins growing larger as the cock's base shifts to lie inside it.", false);
                    else this.outputText("  You feel a tightness near the base where your skin seems to be bunching up.  A sheath begins forming around your " + this.cockDescript(temp) + "'s root, tightening and pulling your " + this.cockDescript(temp) + " inside its depths.", false);
                    temp2 = player.increaseCock(temp, Mutations.rand(4) + 4);
            ...
            //Players cocks are all horse-type - increase size!
                ...
                this.outputText("\n\n", false);
                if (temp2 > 2) this.outputText("Your " + this.cockDescript(temp) + " tightens painfully, inches of taut horse-flesh pouring out from your sheath as it grows longer.  Thick animal-pre forms at the flared tip, drawn out from the pleasure of the change.", false);
                if (temp2 > 1 && temp2 <= 2) this.outputText("Aching pressure builds within your sheath, suddenly releasing as an inch or more of extra dick flesh spills out.  A dollop of pre beads on the head of your enlarged " + this.cockDescript(temp) + " from the pleasure of the growth.", false);
                if (temp2 <= 1) this.outputText("A slight pressure builds and releases as your " + this.cockDescript(temp) + " pushes a bit further out of your sheath.", false);
                changes++;
            }
            ...
            if (Mutations.rand(2) == 0 && changes < changeLimit && player.horseCocks() > 0) {
                ...
                if (player.cor + player.lib < 50) this.outputText(" to have such a splendid tool.  You idly daydream about cunts and pussies, your " + Appearance.cockNoun(CockTypesEnum.HORSE) + " plowing them relentlessly, stuffing them pregnant with cum", false);
                if (player.cor + player.lib >= 50 && player.cor + player.lib < 80) this.outputText(" to be this way... You breath the powerful animalistic scent and fantasize about fucking centaurs night and day until their bellies slosh with your cum", false);
                if (player.cor + player.lib >= 75 && player.cor + player.lib <= 125) this.outputText(" to be a rutting stud.  You ache to find a mare or centaur to breed with.  Longing to spend your evenings plunging a " + Appearance.cockNoun(CockTypesEnum.HORSE) + " deep into their musky passages, dumping load after load of your thick animal-cum into them.  You'd be happy just fucking horsecunts morning, noon, and night.  Maybe somewhere there is a farm needing a breeder..", false);
                if (player.cor + player.lib > 125) this.outputText(" to whinny loudly like a rutting stallion.  Your " + Appearance.cockNoun(CockTypesEnum.HORSE) + " is perfect for fucking centaurs and mares.  You imagine the feel of plowing an equine pussy deeply, bottoming out and unloading sticky jets of horse-jizz into its fertile womb.  Your hand strokes your horsecock of its own accord, musky pre dripping from the flared tip with each stroke.  Your mind wanders to the thought of you with a harem of pregnant centaurs.", false);
                this.outputText(".", false);
                if (player.cor < 30) this.outputText("  You shudder in revulsion at the strange thoughts and vow to control yourself better.", false);
                if (player.cor >= 30 && player.cor < 60) this.outputText("  You wonder why you thought such odd things, but they have a certain appeal.", false);
                if (player.cor >= 60 && player.cor < 90) this.outputText("  You relish your twisted fantasies, hoping to dream of them again.", false);
                if (player.cor >= 90) this.outputText("  You flush hotly and give a twisted smile, resolving to find a fitting subject to rape and relive your fantasies.", false);
        ...
        if (player.gender == 2 || player.gender == 3) {
            ...
            if (player.vaginas.length == 1) {
                if (player.vaginas[0].vaginalLooseness <= VAGINA_LOOSENESS_GAPING && changes < changeLimit && Mutations.rand(2) == 0) {
                ...
                if (player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_NORMAL && changes < changeLimit && Mutations.rand(2) == 0) {
            ...
            //Multicooch
                ...
                if (player.vaginas[temp].vaginalWetness <= VAGINA_WETNESS_NORMAL && changes < changeLimit && Mutations.rand(2) == 0) {
            ...
            if (player.statusAffectv2(StatusAffects.Heat) < 30 && Mutations.rand(2) == 0 && changes < changeLimit) {
            ...
            if (!this.flags[kFLAGS.HYPER_HAPPY]) {
                if (Mutations.rand(2) == 0 && changes < changeLimit) {
                    ...
                    //multiple
                        ...
                        if (player.biggestTitSize() > 3) this.outputText("\n", false);
                        while (temp3 > 0) {
                            temp3--;
                            if (player.breastRows[temp3].breastRating > 3) {
                                ...
                                temp2++;
                                this.outputText("\n", false);
                                if (temp3 < player.breastRows.length - 1) this.outputText("...and y", false);
                                else this.outputText("Y", false);
                                this.outputText("our " + this.breastDescript(temp3) + " shrink, dropping to " + player.breastCup(temp3) + "s.", false);
                            }
                        }
        ...
        //Tail -> Ears -> Fur -> Face
        //Centaur if hooved
        if (changes < changeLimit && Mutations.rand(6) == 0 && player.lowerBody == LOWER_BODY_TYPE_HOOFED) {
            changes++;
        ...
        if (changes < changeLimit && Mutations.rand(5) == 0 && player.eyeType > EYES_HUMAN) {
            if (player.eyeType == EYES_BLACK_EYES_SAND_TRAP) {
                ...
                if (player.eyeType == EYES_FOUR_SPIDER_EYES) this.outputText("  Your multiple, arachnid eyes are gone!</b>", false);
        ...
        if (Mutations.rand(3) == 0) this.outputText(player.modTone(60, 1), false);
        //FAILSAFE CHANGE
        if (changes == 0) {
    ...
    public succubiMilk(tainted: boolean, player: Player): void {
        ...
        if (player.cor < 35) this.outputText("You wonder why in the gods' names you would drink such a thing, but you have to admit, it is the best thing you have ever tasted.", true);
        if (player.cor >= 35 && player.cor < 70) {
            ...
            if (player.gender == 2 || player.gender == 3) {
                ...
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_DRY) this.outputText("tingly.", false);
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_NORMAL) this.outputText("wet.", false);
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_WET) this.outputText("sloppy and wet.", false);
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_SLICK) this.outputText("sopping and juicy.", false);
                if (player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_DROOLING) this.outputText("dripping wet.", false);
            }
            else if (player.hasCock()) this.outputText("  You feel a building arousal, but it doesn't affect your cock.", false);
        }
        if (player.cor >= 70) {
            ...
            if (player.gender == 2 || player.gender == 3) {
                ...
                if (player.vaginas.length > 1) this.outputText(" quiver in orgasm, ", false);
                if (player.vaginas.length == 1) this.outputText(" quivers in orgasm, ", false);
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_DRY) this.outputText("becoming slightly sticky.", false);
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_NORMAL) this.outputText("leaving your undergarments sticky.", false);
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_WET) this.outputText("wet with girlcum.", false);
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_SLICK) this.outputText("staining your undergarments with cum.", false);
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_DROOLING) this.outputText("leaving cunt-juice trickling down your leg.", false);
                if (player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_SLAVERING) this.outputText("spraying your undergarments liberally with slick girl-cum.", false);
                player.orgasm();
            }
            else if (player.gender != 0) {
                if (player.cocks.length == 1) this.outputText("  You feel a strange sexual pleasure, but your " + this.multiCockDescript() + " remains unaffected.", false);
                else this.outputText("  You feel a strange sexual pleasure, but your " + this.multiCockDescript() + " remain unaffected.", false);
            }
        }
        ...
        if (rando <= 75) {
            ...
            if (!this.flags[kFLAGS.HYPER_HAPPY]) {
                ...
                if (player.cocks.length > 0) {
                    ...
                    while (temp2 > 0) {
                        temp2--;
                        if (player.cocks[this.temp].cockLength <= player.cocks[temp2].cockLength) this.temp = temp2;
                    }
                    //Shrink said cock
                    if (player.cocks[this.temp].cockLength < 6 && player.cocks[this.temp].cockLength >= 2.9) {
                        player.cocks[this.temp].cockLength -= .5;
                        temp3 -= .5;
                        if (player.cocks[this.temp].cockThickness * 6 > player.cocks[this.temp].cockLength) player.cocks[this.temp].cockThickness -= .2;
                        if (player.cocks[this.temp].cockThickness * 8 > player.cocks[this.temp].cockLength) player.cocks[this.temp].cockThickness -= .2;
                        if (player.cocks[this.temp].cockThickness < .5) player.cocks[this.temp].cockThickness = .5;
                    }
        ...
        //Increase pussy wetness or grow one!!
            ...
            if (player.vaginas.length > 0) {
                ...
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_SLAVERING) {
                    if (player.vaginas.length == 1) this.outputText("Your " + this.vaginaDescript(0) + " gushes fluids down your leg as you spontaneously orgasm.", false);
                    else this.outputText("Your " + this.vaginaDescript(0) + "s gush fluids down your legs as you spontaneously orgasm, leaving a thick puddle of pussy-juice on the ground.  It is rapidly absorbed by the earth.", false);
                    player.orgasm();
                    if (tainted) this.dynStats("cor", 1);
                }
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_DROOLING) {
                    if (player.vaginas.length == 1) this.outputText("Your pussy feels hot and juicy, aroused and tender.  You cannot resist as your hands dive into your " + this.vaginaDescript(0) + ".  You quickly orgasm, squirting fluids everywhere.  <b>You are now a squirter</b>.", false);
                    if (player.vaginas.length > 1) this.outputText("Your pussies feel hot and juicy, aroused and tender.  You cannot resist plunging your hands inside your " + this.vaginaDescript(0) + "s.  You quiver around your fingers, squirting copious fluids over yourself and the ground.  The fluids quickly disappear into the dirt.", false);
                    player.orgasm();
                    if (tainted) this.dynStats("cor", 1);
                }
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_SLICK) {
                    if (player.vaginas.length == 1) this.outputText("You feel a sudden trickle of fluid down your leg.  You smell it and realize it's your pussy-juice.  Your " + this.vaginaDescript(0) + " now drools lubricant constantly down your leg.", false);
                    if (player.vaginas.length > 1) this.outputText("You feel sudden trickles of fluids down your leg.  You smell the stuff and realize it's your pussies-juices.  They seem to drool lubricant constantly down your legs.", false);
                }
                ...
                if (player.vaginas[0].vaginalWetness == VAGINA_WETNESS_NORMAL) {
                    if (player.vaginas.length == 1) this.outputText("A feeling of intense arousal passes through you, causing you to masturbate furiously.  You realize afterwards that your " + this.vaginaDescript(0) + " felt much wetter than normal.", false);
                    else this.outputText("A feeling of intense arousal passes through you, causing you to masturbate furiously.  You realize afterwards that your " + this.vaginaDescript(0) + " were much wetter than normal.", false);
                }
                ...
                while (this.temp > 0) {
                    this.temp--;
                    if (player.vaginas[0].vaginalWetness < VAGINA_WETNESS_SLAVERING) player.vaginas[this.temp].vaginalWetness++;
                }
            }
        }
        if (rando >= 90) {
            if (player.skinTone == "blue" || player.skinTone == "purple" || player.skinTone == "indigo" || player.skinTone == "shiny black") {
                if (player.vaginas.length > 0) {
                    ...
                    if (player.clitLength > 3 && player.findPerk(PerkLib.BigClit) < 0) this.outputText("  After some time it shrinks, returning to its normal aroused size.  You guess it can't get any bigger.", false);
                    if (player.clitLength > 5 && player.findPerk(PerkLib.BigClit) >= 0) this.outputText("  Eventually it shrinks back down to its normal (but still HUGE) size.  You guess it can't get any bigger.", false);
        ...
        if (tainted) {
            ...
            if (Mutations.rand(3) == 0) this.outputText(player.modTone(15, 2), false);
        }
        else {
            this.outputText(player.modFem(90, 1), false);
            if (Mutations.rand(3) == 0) this.outputText(player.modTone(20, 2), false);
        }
        player.genderCheck();
    }
    ...
    public caninePepper(type: number, player: Player): void {
        ...
        if (type == 0) {
            ...
            else this.outputText("The pepper is strangely spicy but very tasty.", false);
        }
        //Oversized pepper
        if (type == 1) {
            crit = Math.floor(Math.random() * 20) / 10 + 2;
        ...
        //OVERDOSE Bad End!
        if (type <= 0 && crit > 1 && player.skinType == SKIN_TYPE_FUR && player.faceType == FACE_DOG && player.earType == EARS_DOG && player.lowerBody == LOWER_BODY_TYPE_DOG && player.tailType == TAIL_TYPE_DOG && Mutations.rand(2) == 0 && player.findStatusAffect(StatusAffects.DogWarning) >= 0) {
        ...
        if (type == 3) {
            ...
            if (player.cor < 50) this.outputText("  You shake your head, blushing hotly.  Where did that thought come from?", false);
        }
        ...
        if (player.inte > 30 && Mutations.rand(3) == 0 && changes < changeLimit && type != 3) {
            ...
            this.outputText("\n\nYou feel ", false);
            if (crit > 1) this.outputText("MUCH ", false);
        ...
        if (type == 4) {
            ...
            if (player.cockTotal() > 0) {
                ...
                if (player.dogCocks() > 0) {
                    ...
                    while (this.temp > 0) {
                        this.temp--;
                        if (player.cocks[this.temp].cockType == CockTypesEnum.DOG && player.cocks[this.temp].knotMultiplier < player.cocks[temp2].knotMultiplier) temp2 = this.temp;
                    }
                    ...
                    this.outputText("\n\n", false);
                    if (temp3 < .06) this.outputText("Your " + Appearance.cockNoun(CockTypesEnum.DOG) + " feels unusually tight in your sheath as your knot grows.", false);
                    if (temp3 >= .06 && temp3 <= .12) this.outputText("Your " + Appearance.cockNoun(CockTypesEnum.DOG) + " pops free of your sheath, thickening nicely into a bigger knot.", false);
                    if (temp3 > .12) this.outputText("Your " + Appearance.cockNoun(CockTypesEnum.DOG) + " surges free of your sheath, swelling thicker with each passing second.  Your knot bulges out at the base, growing far beyond normal.", false);
        ...
        if (player.cocks.length > 0) {
            ...
            if (type == 1) {
                ...
                //Multicock
                    ...
                    this.dynStats("sen", 1, "lus", 10);
                    if (player.cocks[this.temp].cockThickness <= 2) player.cocks[this.temp].thickenCock(1);
                }
            ...
            if (player.breastRows[0].breastRating > 0 && player.vaginas.length > 0) {
                ...
                if (player.breastRows.length < 3 && Mutations.rand(2) == 0 && changes < changeLimit) {
                    ...
                    if (player.breastRows.length > 2 && player.breastRows[0].breastRating > player.breastRows.length) {
                        ...
                        if (player.breastRows[this.temp].breastRating < 0) player.breastRows[this.temp].breastRating = 0;
                        if (player.breastRows[this.temp - 1].breastRating < 0) player.breastRows[this.temp - 1].breastRating = 0;
                        if (player.breastRows[this.temp].breastRating == 0) this.outputText("\n\nYour abdomen tingles and twitches as a new row of breasts sprouts below the others.  Your new breasts stay flat and masculine, not growing any larger.", false);
                ...
                //If already has max doggie breasts!
                    ...
                    while (this.temp > 1 && temp2 == 0) {
                        ...
                        if (player.breastRows[this.temp].breastRating + 1 < player.breastRows[this.temp - 1].breastRating) {
                            ...
                            this.outputText("\nYour ", false);
                            if (this.temp == 0) this.outputText("first ", false);
                            if (this.temp == 1) this.outputText("second ", false);
                            if (this.temp == 2) this.outputText("third ", false);
                            if (this.temp == 3) this.outputText("fourth ", false);
                            if (this.temp == 4) this.outputText("fifth ", false);
                            if (this.temp > 4) this.outputText("", false);
        ...
        if (Mutations.rand(2) == 0 && player.earType != EARS_DOG && player.tailType == TAIL_TYPE_DOG && changes < changeLimit) {
    ...
    public impFood(player: Player): void {
        ...
        if (player.cocks.length > 0) {
            ...
            if (Mutations.rand(30) == 0 && player.skinTone != "red") {
                if (player.skinType == SKIN_TYPE_FUR) this.outputText("\n\nUnderneath your fur, your skin ", false);
    ...
    public succubisDelight(tainted: boolean, player: Player): void {
        ...
        if (player.cor < 33) this.outputText("  This stuff is gross, why are you drinking it?", false);
        //high corruption
        if (player.cor >= 66) this.outputText("  You lick your lips, marvelling at how thick and sticky it is.", false);
        //Corruption increase
    ...
    */
    ...
    public brownEgg(large: boolean, player: Player): void {
        ...
        if (Mutations.rand(3) == 0) {
            if (large) this.outputText(player.modThickness(100, 8), false);
            else this.outputText(player.modThickness(95, 3), false);
        }
    }
    ...
    public purpleEgg(large: boolean, player: Player): void {
        ...
        if (Mutations.rand(3) == 0) {
            if (large) this.outputText(player.modThickness(80, 8), false);
            else this.outputText(player.modThickness(80, 3), false);
        }
    }
    ...
    public pinkEgg(large: boolean, player: Player): void {
        ...
        if (Mutations.rand(3) == 0) {
            if (large) this.outputText(player.modFem(100, 8), false);
            else this.outputText(player.modFem(95, 3), false);
        }
    }
    ...
    public blueEgg(large: boolean, player: Player): void {
        ...
        if (!large) {
            ...
            if (player.cocks.length > 0) {
                ...
                if (player.cocks.length == 1) {
                    ...
                    //Display the degree of thickness change.
                    if (temp3 >= 1) {
                        if (player.cocks.length == 1) this.outputText("  Your " + this.multiCockDescriptLight() + " spreads rapidly, swelling an inch or more in girth, making it feel fat and floppy.", false);
                        else this.outputText("  Your " + this.multiCockDescriptLight() + " spread rapidly, swelling as they grow an inch or more in girth, making them feel fat and floppy.", false);
                    }
                    if (temp3 <= .5) {
                        if (player.cocks.length > 1) this.outputText("  Your " + this.multiCockDescriptLight() + " feel swollen and heavy. With a firm, but gentle, squeeze, you confirm your suspicions. They are definitely thicker.", false);
                        else this.outputText("  Your " + this.multiCockDescriptLight() + " feels swollen and heavy. With a firm, but gentle, squeeze, you confirm your suspicions. It is definitely thicker.", false);
                    }
                    if (temp3 > .5 && temp2 < 1) {
                        if (player.cocks.length == 1) this.outputText("  Your " + this.multiCockDescriptLight() + " seems to swell up, feeling heavier. You look down and watch it growing fatter as it thickens.", false);
                        if (player.cocks.length > 1) this.outputText("  Your " + this.multiCockDescriptLight() + " seem to swell up, feeling heavier. You look down and watch them growing fatter as they thicken.", false);
                    }
                    this.dynStats("lib", 1, "sen", 1, "lus", 20);
                }
        ...
        //LARGE
            ...
            if (player.bRows() > 1 || player.buttRating > 5 || player.hipRating > 5 || player.hasVagina()) this.outputText("\n\n", false);
            //Kill pussies!
            if (player.vaginas.length > 0) {
                ...
                if (player.bRows() > 1 || player.buttRating > 5 || player.hipRating > 5) this.outputText("  ", false);
                player.removeVagina(0, 1);
                player.clitLength = .5;
                player.genderCheck();
            }
            ...
            if (player.bRows() > 1) {
                ...
                if (player.buttRating > 5 || player.hipRating > 5) this.outputText("  ", false);
                //Remove lowest row.
            ...
            if (player.buttRating > 5) {
                ...
                if (player.hipRating > 5) this.outputText("  ", false);
                player.buttRating -= 2;
            }
        ...
        if (Mutations.rand(3) == 0) {
            if (large) this.outputText(player.modFem(0, 8), false);
            else this.outputText(player.modFem(5, 3), false);
        }
    }
    ...
    public blackRubberEgg(large: boolean, player: Player): void {
        ...
        if (!large) {
            ...
            if ((player.skinAdj != "smooth" && player.skinAdj != "latex" && player.skinAdj != "rubber") || player.skinDesc != "skin") {
                ...
                if (player.skinType == SKIN_TYPE_PLAIN) this.outputText(" loses its blemishes, becoming flawless smooth skin.", false);
                if (player.skinType == SKIN_TYPE_FUR) this.outputText(" falls out in clumps, revealing smooth skin underneath.", false);
                if (player.skinType == SKIN_TYPE_SCALES) this.outputText(" begins dropping to the ground in a pile around you, revealing smooth skin underneath.", false);
                if (player.skinType > SKIN_TYPE_SCALES) this.outputText(" shifts and changes into flawless smooth skin.", false);
        ...
        if (large) {
            ...
            if (player.skinDesc == "skin" && player.skinAdj == "smooth") {
                ...
                if (player.cor < 66) this.outputText("You feel like some kind of freak.", false);
                else this.outputText("You feel like some kind of sexy " + player.skinDesc + " love-doll.", false);
    ...
    */
    ...
    public useMarbleMilk(player: Player): void {
        ...
        if (player.statusAffectv2(StatusAffects.Marble) < 30 && player.statusAffectv3(StatusAffects.Marble) == 0) this.outputText("You gulp down the bottle's contents; Marble makes some good tasting milk.\n\n", false);
        //[before the player is addicted, Addiction < 50]
        else if (player.statusAffectv3(StatusAffects.Marble) <= 0) this.outputText("You gulp down the bottle's contents; Marble makes some really good tasting milk.\n\n", false);
        else if (player.statusAffectv3(StatusAffects.Marble) > 0) {
            //[player is completely addicted]
            if (player.findPerk(PerkLib.MarblesMilk) >= 0) this.outputText("You gulp down the bottle's contents; it's no substitute for the real thing, but it's a nice pick me up.\n\n", false);
            else {
                //[player is no longer addicted]
                if (player.findPerk(PerkLib.MarbleResistant) >= 0) this.outputText("You gulp down the bottle's contents; you're careful not to get too attached to the taste.\n\n", false);
                //[player is addicted]
    ...
    public laBova(tainted: boolean, enhanced: boolean, player: Player): void {
        ...
        if (enhanced) this.outputText("Pro Bova", false);
        else this.outputText("La Bova", false);
        ...
        if (player.cocks.length > 0 && Mutations.rand(2) == 0 && !this.flags[kFLAGS.HYPER_HAPPY]) {
            ...
            if (player.cocks[temp].cockLength < 2) {
                ...
                if (player.cockTotal() == 1 && !player.hasVagina()) {
                    ...
                    if (player.balls > 0) this.outputText("  At the same time, your " + this.ballsDescriptLight() + " fall victim to the same sensation; eagerly swallowed whole by your crotch.", false);
        ...
        if (enhanced) {
            ...
            if (player.breastRows[0].nipplesPerBreast == 1) {
                ...
                if (player.breastRows.length >= 3 && player.breastRows[2].nipplesPerBreast == 1) {
                    ...
                    if (player.bRows() == 3) this.outputText("third row of " + this.breastDescript(2) + " mutates along with its sisters, sprouting into a wonderland of nipples.", false);
        ...
        if (player.findStatusAffect(StatusAffects.Feeder) < 0 && player.biggestLactation() >= 3 && Mutations.rand(2) == 0 && player.biggestTitSize() >= 5 && player.cor >= 35) {
        ...
        if (player.hasVagina()) {
            if (player.vaginas[0].vaginalLooseness < VAGINA_LOOSENESS_LOOSE && changes < changeLimit && Mutations.rand(2) == 0) {
        ...
        if (tainted && player.tailType != TAIL_TYPE_COW && changes < changeLimit && Mutations.rand(3) == 0) {
            if (player.tailType == TAIL_TYPE_NONE) this.outputText("\n\nYou feel the flesh above your " + this.buttDescript() + " knotting and growing.  It twists and writhes around itself before flopping straight down, now shaped into a distinctly bovine form.  You have a <b>cow tail</b>.", false);
            else {
                if (player.tailType < TAIL_TYPE_SPIDER_ADBOMEN || player.tailType > TAIL_TYPE_BEE_ABDOMEN) {
                    this.outputText("\n\nYour tail bunches uncomfortably, twisting and writhing around itself before flopping straight down, now shaped into a distinctly bovine form.  You have a <b>cow tail</b>.", false);
        ...
        if (tainted && player.earType != EARS_COW && changes < changeLimit && Mutations.rand(4) == 0 && player.tailType == TAIL_TYPE_COW) {
            this.outputText("\n\nYou feel your ears tug on your scalp as they twist shape, becoming oblong and cow-like.  <b>You now have cow ears.</b>", false);
            player.earType = EARS_COW;
            changes++;
        }
        ...
        if (!enhanced && player.lowerBody == LOWER_BODY_TYPE_HOOFED && player.faceType != FACE_HUMAN && changes < changeLimit && Mutations.rand(4) == 0) {
        ...
        //New horns or expanding mino horns
        if (tainted && changes < changeLimit && Mutations.rand(3) == 0 && player.faceType == FACE_HUMAN) {
        ...
        //Nipples Turn Back:
        if (player.findStatusAffect(StatusAffects.BlackNipples) >= 0 && changes < changeLimit && Mutations.rand(3) == 0) {
        ...
        if (Mutations.rand(3) == 0) this.outputText(player.modFem(79, 3), false);
        if (Mutations.rand(3) == 0) this.outputText(player.modThickness(70, 4), false);
        if (Mutations.rand(5) == 0) this.outputText(player.modTone(10, 5), false);
    }
    ...
    public lustDraft(fuck: boolean, player: Player): void {
        player.slimeFeed();
        this.outputText("You drink the ", true);
        if (fuck) this.outputText("red", false);
        else this.outputText("pink", false);
        ...
        if (player.lust >= 100 && !kGAMECLASS.inCombat) {
            ...
            if (player.gender == 0) this.outputText("body begins to quiver with orgasmic bliss.  ", false);
    ...
    public goblinAle(player: Player): void {
        ...
        if (changes < changeLimit && Mutations.rand(3) == 0 && player.hasVagina() && player.statusAffectv1(StatusAffects.BonusVCapacity) < 40) {
        ...
        else if (player.cocks.length == 1 && Mutations.rand(2) == 0 && changes < changeLimit && !this.flags[kFLAGS.HYPER_HAPPY]) {
            if (player.cocks[0].cockLength > 12) {
                changes++;
                var temp3: number = 0;
                this.outputText("\n\n", false);
        ...
        //Skin/fur
        if (player.skinType != SKIN_TYPE_PLAIN && changes < changeLimit && Mutations.rand(4) == 0 && player.faceType == FACE_HUMAN) {
        ...
        if (player.skinTone != "green" && player.skinTone != "grayish-blue" && player.skinTone != "dark green" && player.skinTone != "pale yellow" && changes < changeLimit && Mutations.rand(2) == 0) {
            ...
            if (player.skinType == SKIN_TYPE_FUR) this.outputText("skin", false);
            else this.outputText(player.skinDesc, false);
            this.outputText(" turned " + player.skinTone + ".  No way!  It's staying, it really changed color!", false);
        }
        //Face!
        if (player.faceType != FACE_HUMAN && changes < changeLimit && Mutations.rand(4) == 0 && player.earType == EARS_ELFIN) {
            changes++;
            player.faceType = FACE_HUMAN;
    ...
    public gooGasmic(player: Player): void {
        ...
        if (Mutations.rand(2) == 0) this.outputText(player.modFem(85, 3), false);
        if (Mutations.rand(2) == 0) this.outputText(player.modThickness(20, 3), false);
        if (Mutations.rand(2) == 0) this.outputText(player.modTone(15, 5), false);
    }
    ...
    public sharkTooth(type: number, player: Player): void {
        ...
        if (Mutations.rand(2) == 0) changeLimit++;
        if (player.findPerk(PerkLib.HistoryAlchemist) >= 0) changeLimit++;
        if (type == 0) this.outputText("You have no idea why, but you decide to eat the pointed tooth. To your surprise, it's actually quite brittle, turning into a fishy-tasting dust. You figure it must just be a tablet made to look like a shark's tooth.", true);
        else if (type == 1) this.outputText("You have no idea why, but you decide to eat the pointed, glowing tooth. To your surprise, it's actually quite brittle, crumbling into a fishy-tasting dust. Maybe it's just a tablet made to look like a shark's tooth.", true);
        //STATS
        ...
        //Transformations:
        //Mouth TF
        if (player.faceType != FACE_SHARK_TEETH && Mutations.rand(3) == 0 && changes < changeLimit) {
            this.outputText("\n\n", false);
            if (player.faceType > FACE_HUMAN && player.faceType < FACE_SHARK_TEETH) this.outputText("Your " + player.face() + " explodes with agony, reshaping into a more human-like visage.  ", false);
        ...
        //Skin
        if (((player.skinTone != "rough gray" && player.skinTone != "orange and black striped") || player.skinType != SKIN_TYPE_PLAIN) && Mutations.rand(7) == 0 && changes < changeLimit) {
            this.outputText("\n\n", false);
            if (player.skinType == SKIN_TYPE_FUR || player.skinType == SKIN_TYPE_SCALES) this.outputText("Your " + player.skinDesc + " falls out, collecting on the floor and exposing your supple skin underneath.  ", false);
            else if (player.skinType == SKIN_TYPE_GOO) this.outputText("Your gooey skin solidifies, thickening up as your body starts to solidy into a more normal form. ", false);
            else if (type == 0) this.outputText("Your skin itches and tingles becoming slightly rougher and turning gray.  ", false);
            if (type == 0) {
        ...
        //FINZ R WINGS
        if (player.wingType != WING_TYPE_SHARK_FIN && changes < changeLimit && Mutations.rand(3) == 0) {
            this.outputText("\n\n", false);
            if (player.wingType > WING_TYPE_NONE) this.outputText("Your wings fold into themselves, merging together with your back.  ", false);
    ...
    public snakeOil(player: Player): void {
        ...
        //(if outside combat)
        if (!kGAMECLASS.inCombat) this.outputText("  Minutes pass as you start wishing you had water with you, to get rid of the aftertaste.", false);
        //+ speed to 70!
        if (player.spe < 70 && Mutations.rand(2) == 0) {
            ...
            if (player.spe < 40) this.outputText("  Of course, you're nowhere near as fast as that.", false);
            changes++;
        }
        //Removes wings
        ...
        //9c) III The fangs
        if (changes == 0 && player.tongueType == TONUGE_SNAKE && player.faceType != FACE_SNAKE_FANGS && Mutations.rand(3) == 0 && changes < changeLimit) {
        ...
        if (changes == 0 && player.faceType == FACE_SNAKE_FANGS && player.lowerBody != LOWER_BODY_TYPE_NAGA && Mutations.rand(4) == 0 && changes < changeLimit) {
            ...
            if (player.balls > 0 && player.ballSize > 10) this.outputText("  You're happy not to have to drag those testicles around with you anymore.", false);
    ...
    public catTransformation(player: Player): void {
        ...
        if (Mutations.rand(4) == 0 && changes < changeLimit) {
            ...
            //medium intelligence
                ...
                if (Mutations.rand(2) == 0) {
                    ...
                    this.temp = Mutations.rand(3);
                    if (this.temp == 0) this.outputText("toss a ball around or something", false);
                    else if (this.temp == 1) this.outputText("play with some yarn", false);
                    else if (this.temp == 2) this.outputText("take a nap and stop worrying", false);
                }
                else this.outputText("in the sun and let your troubles slip away", false);
                this.outputText(".", false);
            }
            //High intelligence
        ...
        if (player.lib < 80 && changes < changeLimit && Mutations.rand(4) == 0) {
            ...
            if (player.catCocks() > 0) {
                ...
                if (player.cor < 33) this.outputText("You need to control yourself better.", false);
                else if (player.cor < 66) this.outputText("You're not sure how you feel about the fantasy.", false);
                else this.outputText("You hope to find a willing partner to make this a reality.", false);
            }
            //Else –
            else {
                ...
                if (player.lust > 60) this.outputText("even more ", false);
        ...
        if (Mutations.rand(4) == 0 && changes < changeLimit) {
            ...
            if (player.goIntoHeat(false)) {
                if (intensified) {
                    ...
                    if (player.skinType == SKIN_TYPE_FUR) this.outputText("underneath your fur ", false);
                    this.outputText("as images and fantasies ", false);
                    if (player.cor < 50) this.outputText("assault ", false);
                    else this.outputText("fill ", false);
                ...
                for (var k: number = 0; k < player.breastRows.length; k++) {
                    ...
                    if (player.breastRows[k].breastRating > temp2) {
                        ...
                        if (player.breastRows[k].breastRating > 10) {
                            ...
                            else this.outputText("  The change moves down to your " + Mutations.num2Text2(k + 1) + " row of " + this.breastDescript(0) + ". They shrink greatly, losing a couple cup-sizes.", false);
                        }
                        //Small change
                        else {
                            ...
                            else this.outputText("  Your " + Mutations.num2Text2(k + 1) + " row of " + this.breastDescript(k) + " gives a tiny jiggle as it shrinks, losing some off its mass.", false);
                        }
        ...
        if (player.cockTotal() > 0 && player.catCocks() < player.cockTotal() &&
            ...
            if (!player.hasSheath()) {
                ...
                if (player.balls > 0) this.outputText("  Thankfully, your balls appear untouched.", false);
            }
            else this.outputText("Then, it disappears back into your sheath.", false);
            player.cocks[i].cockType = CockTypesEnum.CAT;
            player.cocks[i].knotMultiplier = 1;
            changes++;
        }
        //Cat penorz shrink
        if (player.catCocks() > 0 && Mutations.rand(3) == 0 && changes < changeLimit && !this.flags[kFLAGS.HYPER_HAPPY]) {
            ...
            if (this.temp == 1) {
                ...
                if (temp2 == 1) this.outputText("  Upon further inspection, all your " + Appearance.cockNoun(CockTypesEnum.CAT) + "s have shrunk!", false);
                changes++;
            }
        }
        ...
        if (player.tailType == TAIL_TYPE_CAT && player.earType == EARS_CAT &&
            ...
            if (player.lowerBody == LOWER_BODY_TYPE_HOOFED || player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
                ...
                if (player.lowerBody == LOWER_BODY_TYPE_CENTAUR) this.outputText("  You feel woozy and collapse on your side.  When you wake, you're no longer a centaur and your body has returned to a humanoid shape.", false);
            }
            //Goo to cat
        ...
        if (changes < changeLimit) {
            if (Mutations.rand(2) == 0) this.outputText(player.modThickness(5, 2), false);
            if (Mutations.rand(2) == 0) this.outputText(player.modTone(76, 2), false);
            if (player.gender < 2) if (Mutations.rand(2) == 0) this.outputText(player.modFem(65, 1), false);
            else this.outputText(player.modFem(85, 2), false);
        }
    }
    ...
    public reptilum(player: Player): void {
        ...
        if (player.lib < 100 && changes < changeLimit && Mutations.rand(3) == 0) {
            ...
            if (player.cocks.length > 0 && (player.gender != 3 || Mutations.rand(2) == 0)) {
                ...
                if (player.cocks.length > 1) this.outputText("each of ", false);
            ...
            //(COOCH)
            else if (player.hasVagina()) this.outputText("puddling in your " + this.vaginaDescript(0) + ".  An instinctive desire to mate and lay eggs spreads through you, increasing your lust and boosting your sex-drive.", false);
            //(TARDS)
            else this.outputText("puddling in your featureless crotch for a split-second before it slides into your " + this.assDescript() + ".  You want to be fucked, filled, and perhaps even gain a proper gender again.  Through the lust you realize your sex-drive has been permanently increased.", false);
        ...
        if (player.lizardCocks() == 0 && player.cockTotal() > 0 && changes < changeLimit && Mutations.rand(4) == 0) {
            ...
            if (player.hasSheath()) this.outputText("sheath ", false);
            ...
            if (player.cor < 33) this.outputText("horrifies you.", false);
            else if (player.cor < 66) this.outputText("is a little strange for your tastes.", false);
            else {
                this.outputText("looks like it might be more fun to receive than use on others.  ", false);
                if (player.hasVagina()) this.outputText("Maybe you could find someone else with one to ride?", false);
                else this.outputText("Maybe you should test it out on someone and ask them exactly how it feels?", false);
            }
        ...
        if (player.cockTotal() > 1 && player.lizardCocks() > 0 && player.cockTotal() > player.lizardCocks() && Mutations.rand(4) == 0 && changes < changeLimit) {
            ...
            if (player.cockTotal() == 2) this.outputText("your other dick", false);
            else this.outputText("another one of your dicks", false);
            ...
            if (player.cumQ() < 50) this.outputText("pre-cum oozes from the tip", false);
            else if (player.cumQ() < 700) this.outputText("Thick pre-cum rains from the tip", false);
            else this.outputText("A wave of pre-cum splatters on the ground", false);
        ...
        if (player.lizardCocks() == player.cockTotal() && changes < changeLimit && player.findStatusAffect(StatusAffects.Infested) >= 0) {
            ...
            if (player.balls > 1) this.outputText("  The remaining " + Mutations.num2Text(player.balls - 1) + " slither out the pre-stretched holes with ease, though the last one hangs from your tip for a moment before dropping to the ground.", false);
        ...
        if (player.biggestLactation() >= 1 && changes < changeLimit && Mutations.rand(4) == 0) {
            if (player.totalNipples() == 2) this.outputText("\n\nBoth of your", false);
            ...
            if (player.hasFuckableNipples()) this.outputText("but sexual fluid ", false);
        ...
        if (player.averageNipplesPerBreast() > 1 && changes < changeLimit && Mutations.rand(4) == 0) {
            ...
            if (player.biggestTitSize() < 1) this.outputText("'breast'.", false);
            else this.outputText("breast.", false);
            changes++;
        ...
        //-VAGs
        if (player.hasVagina() && player.findPerk(PerkLib.Oviposition) < 0 && changes < changeLimit && Mutations.rand(5) == 0 && player.lizardScore() > 3) {
        ...
        if (player.hornType != HORNS_DRACONIC_X4_12_INCH_LONG && changes < changeLimit && Mutations.rand(5) == 0) {
            //No dragon horns yet.
            ...
            //ALREADY DRAGON
                ...
                if (player.hornType == HORNS_DRACONIC_X2) {
                    if (player.horns < 12) {
                        ...
                        if (player.horns >= 12) this.outputText("  <b>Your horns settle down quickly, as if they're reached their full size.</b>", false);
                        changes++;
                    }
                    //maxxed out, new row
                    else {
        ...
        //-Hair stops growing!
        if (this.flags[kFLAGS.HAIR_GROWTH_STOPPED_BECAUSE_LIZARD] == 0 && changes < changeLimit && Mutations.rand(4) == 0) {
        ...
        if (player.tailType != TAIL_TYPE_LIZARD && player.lowerBody == LOWER_BODY_TYPE_LIZARD && changes < changeLimit && Mutations.rand(5) == 0) {
            //No tail
        ...
        if (player.earType != EARS_LIZARD && player.tailType == TAIL_TYPE_LIZARD && player.lowerBody == LOWER_BODY_TYPE_LIZARD && changes < changeLimit && Mutations.rand(5) == 0) {
        ...
        if (player.skinType != SKIN_TYPE_SCALES && player.earType == EARS_LIZARD && player.tailType == TAIL_TYPE_LIZARD && player.lowerBody == LOWER_BODY_TYPE_LIZARD && changes < changeLimit && Mutations.rand(5) == 0) {
            //(fur)
        ...
        //-Lizard-like face.
        if (player.faceType != FACE_LIZARD && player.skinType == SKIN_TYPE_SCALES && player.earType == EARS_LIZARD && player.tailType == TAIL_TYPE_LIZARD && player.lowerBody == LOWER_BODY_TYPE_LIZARD && changes < changeLimit && Mutations.rand(5) == 0) {
    ...
    */
    ...
    public neonPinkEgg(pregnantChange: boolean, player: Player): void {
        ...
        else this.outputText("", true);
        //If not pregnancy, mention eating it.
        if (!pregnantChange) this.outputText("You eat the neon pink egg, and to your delight it tastes sweet, like candy.  In seconds you've gobbled down the entire thing, and you lick your fingers clean before you realize you ate the shell – and it still tasted like candy.", false);
        ...
        if (pregnantChange) {
            ...
            if (player.pregnancyType == PregnancyStore.PREGNANCY_BUNNY) {
                ...
                if (player.buttPregnancyType == PregnancyStore.PREGNANCY_BUNNY) this.outputText("and ", false);
            }
            if (player.buttPregnancyType == PregnancyStore.PREGNANCY_BUNNY) this.outputText("backdoor ", false);
            if (player.buttPregnancyType == PregnancyStore.PREGNANCY_BUNNY && player.pregnancyType == PregnancyStore.PREGNANCY_BUNNY) this.outputText("rumble", false);
            else this.outputText("rumbles", false);
        ...
        if (changes < changeLimit && Mutations.rand(5) == 0) {
            ...
            if (player.lib < 60) {
                ...
                if (!player.hasCock() || (player.gender == 3 && Mutations.rand(2) == 0)) {
                    if (player.lib < 30) {
                        ...
                        if (player.cor < 25) this.outputText("You're repulsed by such shameful thoughts.", false);
                        else if (player.cor < 60) this.outputText("You worry that this place is really getting to you.", false);
                        else if (player.cor < 90) this.outputText("You pant a little and wonder where the nearest fertile male is.", false);
                        else this.outputText("You grunt and groan with desire and disappointment.  You should get bred soon!", false);
                    }
                ...
                if (player.hasCock()) {
                    if (player.lib < 30) {
                        ...
                        if (Mutations.rand(2) == 0) this.outputText("female hare until she's immobilized by all her eggs", false);
                        else this.outputText("herm rabbit until her sack is so swollen that she's forced to masturbate over and over again just to regain mobility", false);
                        this.outputText(". ", false);
                        if (player.cor < 25) this.outputText("You're repulsed by such shameful thoughts.", false);
                        else if (player.cor < 50) this.outputText("You worry that this place is really getting to you.", false);
                        else if (player.cor < 75) this.outputText("You pant a little and wonder where the nearest fertile female is.", false);
                        else this.outputText("You grunt and groan with desire and disappointment.  Gods you need to fuck!", false);
                    }
            ...
            //Libido over 60? FUCK YEAH!
                ...
                if (player.skinType > SKIN_TYPE_PLAIN) this.outputText(" through your " + player.skinDesc, false);
                this.outputText(".  ", false);
                if (player.gender == 1) this.outputText("Compression tightens down on " + this.sMultiCockDesc() + " as it strains against your " + player.armorName + ".  You struggle to fight down your heightened libido, but it's hard – so very hard.", false);
                else if (player.gender == 0) this.outputText("Sexual hunger seems to gnaw at your " + this.assholeDescript() + ", demanding it be filled, but you try to resist your heightened libido.  It's so very, very hard.", false);
                else if (player.gender == 2) this.outputText("Moisture grows between your rapidly-engorging vulva, making you squish and squirm as you try to fight down your heightened libido, but it's hard – so very hard.", false);
                else this.outputText("Steamy moisture and tight compression war for your awareness in your groin as " + this.sMultiCockDesc() + " starts to strain against your " + player.armorName + ".  Your vulva engorges with blood, growing slicker and wetter.  You try so hard to fight down your heightened libido, but it's so very, very hard.  The urge to breed lingers in your mind, threatening to rear its ugly head.", false);
            }
            //MEGALIBIDO
            else {
                ...
                if (player.cor < 33) this.outputText("You sigh, trying not to give in completely.", false);
                else if (player.cor < 66) this.outputText("You pant and groan, not sure how long you'll even want to resist.", false);
                else {
                    this.outputText("You smile and wonder if you can ", false);
                    if (player.lib < 100) this.outputText("get your libido even higher.", false);
                    else this.outputText("find someone to fuck right now.", false);
                }
            }
        }
        ...
        if (player.sens < 60 && changes < changeLimit && Mutations.rand(3) == 0) {
            ...
            //(BIG boost 1/3 chance)
                ...
                if (player.hasFuckableNipples()) {
                    ...
                    if (player.biggestLactation() > 2) this.outputText("milk-leaking nipple-twats", false);
                    else this.outputText("slippery nipple-twats", false);
                }
                else if (player.biggestLactation() > 2) this.outputText(", sliding over the milk-leaking teats with ease", false);
                else this.outputText(" catching on each of the hard nubs repeatedly", false);
                ...
                if (player.gender == 1) {
                    ...
                    if (player.balls > 0) this.outputText(this.ballsDescriptLight(), false);
                    else this.outputText(this.assholeDescript(), false);
                }
                else if (player.gender == 2) this.outputText("your " + this.vaginaDescript(0) + " and " + this.clitDescript(), false);
                ...
                //oh god genderless
                else this.outputText("you " + this.assholeDescript(), false);
        ...
        //-VAGs
        if (player.hasVagina() && player.findPerk(PerkLib.BunnyEggs) < 0 && changes < changeLimit && Mutations.rand(4) == 0 && player.bunnyScore() > 3) {
            this.outputText("\n\nDeep inside yourself there is a change.  It makes you feel a little woozy, but passes quickly.  Beyond that, you aren't sure exactly what just happened, but you are sure it originated from your womb.\n\n", false);
        ...
        if ((player.balls > 0 || player.hasCock()) && player.cumQ() < 3000 && Mutations.rand(3) == 0 && changeLimit > 1) {
            ...
            if (player.balls > 0) {
                ...
                //(medium cum quantity) < 250
                    ...
                    if (player.hasCock()) this.outputText("  In the process, you brush " + this.sMultiCockDesc() + " and discover a bead of pre leaking at the tip.", false);
                }
                //(large cum quantity) < 750
                    ...
                    if (player.hasCock()) this.outputText(this.SMultiCockDesc() + " leaks and dribbles pre-cum down your " + player.legs() + " as your body's cum production kicks up even higher.", false);
                    else this.outputText("You wince, feeling pent up and yet unable to release.  You really wish you had a cock right about now.", false);
                }
                //(XL cum quantity) < 2000
                    ...
                    if (player.hasCock()) this.outputText("A thick trail of slime leaks from " + this.sMultiCockDesc() + " down your " + player.leg() + ", pooling below you.", false);
                    else this.outputText("You grunt, feeling terribly pent-up and needing to release.  Maybe you should get a penis to go with these balls...", false);
                ...
                //(XXL cum quantity)
                    ...
                    if (player.hasCock()) this.outputText("pre-cum explodes from " + this.sMultiCockDesc() + ", running down your " + player.leg() + " and splattering into puddles that would shame the orgasms of lesser " + player.mf("males", "persons") + ".  You rub yourself a few times, nearly starting to masturbate on the spot, but you control yourself and refrain for now.", false);
                    else this.outputText("You pant and groan but the pleasure just turns to pain.  You're so backed up – if only you had some way to vent all your seed!", false);
                }
            }
        ...
        if (player.lowerBody != LOWER_BODY_TYPE_BUNNY && changes < changeLimit && Mutations.rand(5) == 0 && player.earType == EARS_BUNNY) {
            ...
            //Non-taurs
                ...
                if (player.tailType > TAIL_TYPE_NONE) this.outputText(", nearly smashing your tail flat", false);
                else this.outputText(" hard enough to sting", false);
        ...
        if (player.earType == EARS_BUNNY && player.faceType != FACE_BUNNY && Mutations.rand(3) == 0 && changes < changeLimit) {
            this.outputText("\n\n", false);
            changes++;
            //Human(ish) face
            if (player.faceType == FACE_HUMAN || player.faceType == FACE_SHARK_TEETH) this.outputText("You catch your nose twitching on its own at the bottom of your vision, but as soon as you focus on it, it stops.  A moment later, some of your teeth tingle and brush past your lips, exposing a white pair of buckteeth!  <b>Your face has taken on some rabbit-like characteristics!</b>", false);
            //Crazy furry TF shit
            else this.outputText("You grunt as your " + player.face() + " twists and reforms.  Even your teeth ache as their positions are rearranged to match some new, undetermined order.  When the process finishes, <b>you're left with a perfectly human looking face, save for your constantly twitching nose and prominent buck-teeth.</b>", false);
            player.faceType = FACE_BUNNY;
        }
        //DAH BUNBUN EARZ - requires poofbutt!
        if (player.earType != EARS_BUNNY && changes < changeLimit && Mutations.rand(3) == 0 && player.tailType == TAIL_TYPE_RABBIT) {
        ...
        //DAH BUNBUNTAILZ
        if (player.tailType != TAIL_TYPE_RABBIT && Mutations.rand(2) == 0 && changes < changeLimit) {
    ...
    public goldenSeed(type: number, player: Player): void {
        ...
        if (player.spe < 100 && Mutations.rand(3) == 0) {
            ...
            if (player.spe < 40) this.dynStats("spe", .5);
            if (player.spe < 75) this.dynStats("spe", .5);
            this.dynStats("spe", .5);
        }
            ...
            if (player.lib >= 40) {
                ...
                if (player.hasCock() && (player.gender != 3 || Mutations.rand(2) == 0)) {
                    ...
                    if (Mutations.rand(2) == 0) {
                        ...
                        if (player.cockTotal() > 1) {
                            ...
                            if (player.cockTotal() > 2) this.outputText("es rub ", false);
                            else this.outputText("rubs ", false);
                ...
                //Cunts!
                    ...
                    if (Mutations.rand(2) == 0) {
                        ...
                        if (player.hasFuckableNipples()) this.outputText("and pussy leaking over ", false);
                        else if (player.biggestLactation() >= 1.5) this.outputText("dripping milk inside ", false);
                        else this.outputText("rubbing inside ", false);
        ...
        //-Remove extra breast rows
        if (changes < changeLimit && player.breastRows.length > 1 && Mutations.rand(3) == 0 && !this.flags[kFLAGS.HYPER_HAPPY]) {
            changes++;
            this.outputText("\n\nYou stumble back when your center of balance shifts, and though you adjust before you can fall over, you're left to watch in awe as your bottom-most " + this.breastDescript(player.breastRows.length - 1) + " shrink down, disappearing completely into your ", false);
            if (player.breastRows.length >= 3) this.outputText("abdomen", false);
            else this.outputText("chest", false);
            this.outputText(". The " + this.nippleDescript(player.breastRows.length - 1) + "s even fade until nothing but ", false);
            if (player.skinType == SKIN_TYPE_FUR) this.outputText(player.hairColor + " " + player.skinDesc, false);
            else this.outputText(player.skinTone + " " + player.skinDesc, false);
        ...
        else if (changes < changeLimit && player.breastRows.length == 1 && Mutations.rand(3) == 0 && player.breastRows[0].breastRating >= 7 && !this.flags[kFLAGS.HYPER_HAPPY]) {
            changes++;
        ...
        if (changes < changeLimit && player.breastRows[0].breastRating < 2 && Mutations.rand(3) == 0) {
            ...
            if (player.breastRows[0].breastRating < 1) this.outputText("  <b>You have breasts now!</b>", false);
            player.breastRows[0].breastRating = 2;
        }
        //****************
        //General Appearance:
        ...
        if ((player.skinTone != "tan" && player.skinTone != "olive" && player.skinTone != "dark" && player.skinTone != "light") && changes < changeLimit && Mutations.rand(5) == 0) {
            ...
            if (player.skinType == SKIN_TYPE_FUR) this.outputText("the skin under your " + player.hairColor + " " + player.skinDesc, false);
            else this.outputText("your " + player.skinDesc, false);
        ...
        //-Feathery Tail
        if (player.tailType != TAIL_TYPE_HARPY && changes < changeLimit && (type == 1 || player.wingType == WING_TYPE_FEATHERED_LARGE) && Mutations.rand(4) == 0) {
            //(tail)
        ...
        //-Propah Wings
        if (player.wingType == WING_TYPE_NONE && changes < changeLimit && (type == 1 || player.armType == ARM_TYPE_HARPY) && Mutations.rand(4) == 0) {
        ...
        //-Remove old wings
        if (player.wingType != WING_TYPE_FEATHERED_LARGE && player.wingType > WING_TYPE_NONE && changes < changeLimit && Mutations.rand(4) == 0) {
        ...
        //-Feathery Arms
        if (player.armType != ARM_TYPE_HARPY && changes < changeLimit && (type == 1 || player.hairType == 1) && Mutations.rand(4) == 0) {
        ...
        //-Feathery Hair
        if (player.hairType != 1 && changes < changeLimit && (type == 1 || player.faceType == FACE_HUMAN) && Mutations.rand(4) == 0) {
        ...
        //-Human face
        if (player.faceType != FACE_HUMAN && changes < changeLimit && (type == 1 || (player.earType == EARS_HUMAN || player.earType == EARS_ELFIN)) && Mutations.rand(4) == 0) {
        ...
        if ((player.earType != EARS_HUMAN && player.earType != EARS_ELFIN) && changes < changeLimit && Mutations.rand(4) == 0) {
        ...
        if (player.findPerk(PerkLib.HarpyWomb) < 0 && player.lowerBody == LOWER_BODY_TYPE_HARPY && player.tailType == TAIL_TYPE_HARPY && Mutations.rand(4) == 0 && changes < changeLimit) {
    ...
    public kangaFruit(type: number, player: Player): void {
        ...
        //-Fur (Req: Footsies)
        if (player.skinType != SKIN_TYPE_FUR && (player.lowerBody == LOWER_BODY_TYPE_KANGAROO || type == 1) && changes < changeLimit && Mutations.rand(4) == 0) {
        ...
        //-Roo tail (Req: Ears)
        if (player.tailType != TAIL_TYPE_KANGAROO && changes < changeLimit && Mutations.rand(4) == 0 && (type != 1 || player.earType == EARS_KANGAROO)) {
            //gain roo tail:
            ...
            //gain roo tail from bee tail:
                ...
                if (player.tailType == TAIL_TYPE_BEE_ABDOMEN) this.outputText("hollow stinger drops out of the end, taking the venom organ with it.", false);
                else this.outputText("spinnerets drop out of the end, taking the last of your webbing with it.", false);
        ...
        if (player.findPerk(PerkLib.Diapause) < 0 && player.kangaScore() > 4 && Mutations.rand(4) == 0 && changes < changeLimit && player.hasVagina()) {
    ...
    public sweetGossamer(type: number, player: Player): void {
        ...
        if (player.findPerk(PerkLib.HistoryAlchemist) >= 0) changeLimit++;
        //Consuming Text
        if (type == 0) this.outputText("You wad up the sweet, pink gossamer and eat it, finding it to be delicious and chewy, almost like gum.  Munching away, your mouth generates an enormous amount of spit until you're drooling all over yourself while you devour the sweet treat.", false);
        else if (type == 1) this.outputText("You wad up the sweet, black gossamer and eat it, finding it to be delicious and chewy, almost like licorice.  Munching away, your mouth generates an enormous amount of spit until you're drooling all over yourself while you devour the sweet treat.", false);
        ...
        if (player.str > 70 && Mutations.rand(3) == 0) {
            ...
            if (player.spiderScore() < 4) this.outputText("Wait, you're not a spider, that doesn't make any sense!", false);
            else this.outputText("Well, maybe you should put your nice, heavy abdomen to work.", false);
            this.dynStats("str", -1);
            changes++;
        }
        //****************
        ...
        if (player.hasCock() && changes < changeLimit && Mutations.rand(4) == 0) {
            ...
            if (this.temp == 1) {
                ...
                if (player.cockTotal() == 1) this.outputText("it", false);
        ...
        if (player.earType != EARS_HUMAN && player.earType != EARS_ELFIN && Mutations.rand(4) == 0 && changes < changeLimit) {
        ...
        //(Fur/Scales fall out)
        if (player.skinType != SKIN_TYPE_PLAIN && (player.earType == EARS_HUMAN || player.earType == EARS_ELFIN) && Mutations.rand(4) == 0 && changes < changeLimit) {
            ...
            if (player.skinType == SKIN_TYPE_SCALES) this.outputText("are", false);
        ...
        //(Gain human face)
        if (player.skinType == SKIN_TYPE_PLAIN && (player.faceType != FACE_SPIDER_FANGS && player.faceType != FACE_HUMAN) && changes < changeLimit && Mutations.rand(4) == 0) {
        ...
        if (changes < changeLimit && player.bRows() > 2 && Mutations.rand(3) == 0 && !this.flags[kFLAGS.HYPER_HAPPY]) {
            changes++;
            this.outputText("\n\nYou stumble back when your center of balance shifts, and though you adjust before you can fall over, you're left to watch in awe as your bottom-most " + this.breastDescript(player.breastRows.length - 1) + " shrink down, disappearing completely into your ", false);
            if (player.bRows() >= 3) this.outputText("abdomen", false);
            else this.outputText("chest", false);
        ...
        //Nipples Turn Black:
        if (player.findStatusAffect(StatusAffects.BlackNipples) < 0 && Mutations.rand(6) == 0 && changes < changeLimit) {
        ...
        //eyes!
        if (player.skinType == SKIN_TYPE_PLAIN && (player.faceType != FACE_SPIDER_FANGS || player.faceType != FACE_HUMAN) && player.eyeType == EYES_HUMAN && Mutations.rand(4) == 0 && changes < changeLimit) {
        ...
        //(Gain spider fangs)
        if (player.faceType == FACE_HUMAN && player.skinType == SKIN_TYPE_PLAIN && changes < changeLimit && Mutations.rand(4) == 0) {
        ...
        if (player.armType != ARM_TYPE_SPIDER && changes < changeLimit && Mutations.rand(4) == 0) {
            this.outputText("\n\n", false);
            //(Bird pretext)
            if (player.armType == ARM_TYPE_HARPY) this.outputText("The feathers covering your arms fall away, leaving them to return to a far more human appearance.  ", false);
        ...
        //Drider butt
        if (type == 1 && player.findPerk(PerkLib.SpiderOvipositor) < 0 && player.isDrider() && player.tailType == TAIL_TYPE_SPIDER_ADBOMEN && changes < changeLimit && Mutations.rand(3) == 0 && (player.hasVagina || Mutations.rand(2) == 0)) {
        ...
        if (((type == 1 && player.lowerBody != LOWER_BODY_TYPE_DRIDER_LOWER_BODY && player.lowerBody != LOWER_BODY_TYPE_CHITINOUS_SPIDER_LEGS) || (type != 1 && player.lowerBody != LOWER_BODY_TYPE_CHITINOUS_SPIDER_LEGS)) && (!player.isGoo() && !player.isNaga() && !player.isTaur()) && changes < changeLimit && Mutations.rand(4) == 0) {
        ...
        if (player.tailType != TAIL_TYPE_SPIDER_ADBOMEN && (player.lowerBody == LOWER_BODY_TYPE_CHITINOUS_SPIDER_LEGS || player.lowerBody == LOWER_BODY_TYPE_DRIDER_LOWER_BODY) && player.armType == ARM_TYPE_SPIDER && Mutations.rand(4) == 0) {
            this.outputText("\n\n", false);
            //(Pre-existing tails)
        ...
        if (type == 1 && player.lowerBody == LOWER_BODY_TYPE_CHITINOUS_SPIDER_LEGS && Mutations.rand(4) == 0 && player.tailType == TAIL_TYPE_SPIDER_ADBOMEN) {
    ...
    */
    ...
    public broBrew(player: Player): void {
        ...
        if (player.findPerk(PerkLib.BimboBody) >= 0) {
            ...
            this.outputText("\n\n", false);
            if (player.findPerk(PerkLib.BimboBrains) >= 0) this.outputText("<b>(Lost Perks - Bimbo Brains, Bimbo Body)\n", false);
        ...
        if (player.inte > 50) this.outputText(", though you're a bit worried by how much you enjoyed the simple, brutish act", false);
        this.outputText(".\n\n", false);

        //(Tits b' gone)
        if (player.biggestTitSize() >= 1) {
            this.outputText("A tingle starts in your " + this.nippleDescript(0) + "s before the tight buds grow warm, hot even.  ", false);
            if (player.biggestLactation() >= 1) this.outputText("Somehow, you know that the milk you had been producing is gone, reabsorbed by your body.  ", false);
        ...
        if (player.tone >= 70) this.outputText("further define themselves", false);
        else this.outputText("become extraordinarily visible", false);
        ...
        //(No dick)
            ...
            if (player.balls == 0) this.outputText("  Two rounded orbs drop down below, filling out a new, fleshy sac above your " + player.legs() + ".  Sweet!  You can probably cum buckets with balls like these.", false);
            this.outputText("\n\n", false);
            player.createCock();
    ...
    public isabellaMilk(player: Player): void {
        ...
        if (player.fatigue > 0) this.outputText("  You feel much less tired! (-33 fatigue)", false);
        this.fatigue(-33);
    }
    ...
    public shriveledTentacle(player: Player): void {
        ...
        if (Mutations.rand(4) == 0 && changes < changeLimit && player.tailType == TAIL_TYPE_BEE_ABDOMEN) {
        ...
        if (Mutations.rand(4) == 0 && (player.wingType == WING_TYPE_BEE_LIKE_SMALL || player.wingType == WING_TYPE_BEE_LIKE_LARGE) && changes < changeLimit) {
    ...
    public numbRocks(player: Player): void {
        ...
        if (Mutations.rand(5) == 0) {
            if (player.findStatusAffect(StatusAffects.Dysfunction) < 0) {
                ...
                if (player.cockTotal() > 0) {
                    this.outputText(this.sMultiCockDesc(), false);
                    if (player.hasVagina()) this.outputText(" and", false);
                    this.outputText(" ", false);
                }
                if (player.hasVagina()) {
                    if (!player.hasCock()) this.outputText("your ");
                    this.outputText(this.vaginaDescript(0) + " ", false);
                }
                if (!(player.hasCock() || player.hasVagina())) this.outputText(this.assholeDescript() + " ", false);
                ...
                player.createStatusAffect(StatusAffects.Dysfunction, 50 + Mutations.rand(100), 0, 0, 0);
            }
            else {
        ...
        if (player.findPerk(PerkLib.ThickSkin) < 0 && player.sens < 30 && Mutations.rand(4) == 0) {
            ...
            if (player.skinType == SKIN_TYPE_PLAIN) this.outputText("your skin", false);
            else this.outputText("the skin under your " + player.skinDesc, false);
    ...
    public sensitivityDraft(player: Player): void {
        ...
        if (Mutations.rand(4) == 0 && player.findStatusAffect(StatusAffects.LustyTongue) < 0) {
            ...
            if (player.hasVagina()) this.outputText("your", false);
            else this.outputText("a woman's", false);
    ...
    public foxTF(enhanced: boolean, player: Player): void {
        ...
        if (player.faceType == FACE_FOX && player.tailType == TAIL_TYPE_FOX && player.earType == EARS_FOX && player.lowerBody == LOWER_BODY_TYPE_FOX && player.skinType == SKIN_TYPE_FUR && Mutations.rand(3) == 0) {
            if (this.flags[kFLAGS.FOX_BAD_END_WARNING] == 0) {
                ...
                this.outputText("\n\nYou scarf down the ");
                if (enhanced) this.outputText("fluid ");
                ...
                if (player.tailVenom > 1) this.outputText("  Your tails thrash around violently as they begin to fuse painfully back into one, the fur bristling back out with a flourish.");
        ...
        if (changes < changeLimit && enhanced && player.bRows() < 4 && player.breastRows[player.bRows() - 1].breastRating > 1) {
            ...
            if (!enhanced) this.outputText("berry ");
            ...
            if (player.biggestTitSize() >= 8) this.outputText("it's difficult to see past the wall of tits obscuring your view.");
            ...
            if (player.breastRows[player.bRows() - 1].nipplesPerBreast > 1) this.outputText(", not to mention number");
            else if (player.hasFuckableNipples()) this.outputText(", not to mention penetrability");
        ...
        //HEAT!
        if (player.statusAffectv2(StatusAffects.Heat) < 30 && Mutations.rand(6) == 0 && changes < changeLimit) {
            if (player.goIntoHeat(true)) {
                changes++;
            }
        }
        //[Grow Fur]
        //FOURTH
        if ((enhanced || player.lowerBody == LOWER_BODY_TYPE_FOX) && player.skinType != SKIN_TYPE_FUR && changes < changeLimit && Mutations.rand(4) == 0) {
            //from scales
        ...
        //[Grow Fox Legs]
        //THIRD
        if ((enhanced || player.earType == EARS_FOX) && player.lowerBody != LOWER_BODY_TYPE_FOX && changes < changeLimit && Mutations.rand(5) == 0) {
            ...
            //reg legs, not digitigrade
                ...
                if (player.lowerBody == LOWER_BODY_TYPE_BEE) this.outputText(", while a hideous cracking fills the air");
        ...
        //Grow Fox Ears]
        //SECOND
        if ((enhanced || player.tailType == TAIL_TYPE_FOX) && player.earType != EARS_FOX && changes < changeLimit && Mutations.rand(4) == 0) {
        ...
        if (player.skinType == SKIN_TYPE_FUR && player.faceType != FACE_FOX && changes < changeLimit && Mutations.rand(5) == 0) {
            ...
            if (this.silly()) this.outputText("  And they called you crazy...");
            changes++;
    ...
    public godMead(player: Player): void {
        ...
        if (Mutations.rand(3) == 0) {
            ...
            if (this.silly()) this.outputText("  Maybe you should run around shirtless, drink, and fight!  Saxton Hale would be proud.");
            this.dynStats("str", 1);
        }
        //Tough:
        else {
    ...
    public foxJewel(mystic: boolean, player: Player): void {
        ...
        if (player.hasVagina() && ((mystic && Mutations.rand(2) == 0) || (!mystic && Mutations.rand(3) == 0)) && player.statusAffectv1(StatusAffects.BonusVCapacity) < 200 && changes < changeLimit) {
        ...
        //[Vag of Holding] - rare effect, only if PC has high vaginal looseness
        else if (player.hasVagina() && ((mystic) || (!mystic && Mutations.rand(5) == 0)) && player.statusAffectv1(StatusAffects.BonusVCapacity) >= 200 && player.statusAffectv1(StatusAffects.BonusVCapacity) < 8000 && changes < changeLimit) {
            ...
            if (this.silly()) this.outputText("  <b>Your vagina has become a universe unto itself, capable of accepting colossal insertions beyond the scope of human comprehension!</b>");
        ...
        //**********************
        //[Grow Fox Tail]
        if (player.tailType != TAIL_TYPE_FOX && changes < changeLimit && ((mystic && Mutations.rand(2) == 0) || (!mystic && Mutations.rand(4) == 0))) {
            //if PC has no tail
            if (player.tailType == TAIL_TYPE_NONE) {
        ...
        if (!mystic && player.earType == EARS_FOX && player.tailType == TAIL_TYPE_FOX && player.tailVenom == 8 && Mutations.rand(3) == 0) {
        ...
        else if (player.tailType == TAIL_TYPE_FOX && player.tailVenom < 8 && player.tailVenom + 1 <= player.level && player.tailVenom + 1 <= player.inte / 10 && changes < changeLimit && ((mystic && Mutations.rand(2) == 0) || (!mystic && Mutations.rand(3) == 0))) {
        ...
        else if (mystic && Mutations.rand(4) == 0 && changes < changeLimit && player.tailType == TAIL_TYPE_FOX && player.tailVenom == 8 && player.level >= 9 && player.earType == EARS_FOX && player.inte >= 90 && player.findPerk(PerkLib.CorruptedNinetails) < 0 && player.findPerk(PerkLib.EnlightenedNinetails) < 0) {
        ...
        //[Grow Fox Ears]
        if (player.tailType == TAIL_TYPE_FOX && ((mystic && Mutations.rand(2) == 0) || (!mystic && Mutations.rand(4) == 0)) && player.earType != EARS_FOX && changes < changeLimit) {
        ...
        if (player.skinType == SKIN_TYPE_FUR || player.skinType == SKIN_TYPE_SCALES && ((mystic) || (!mystic && Mutations.rand(2) == 0))) {
            ...
            if (player.skinType == SKIN_TYPE_FUR) this.outputText("  You stare in horror as you pull your fingers away holding a handful of " + player.hairColor + " fur!  Your fur sloughs off your body in thick clumps, falling away to reveal patches of bare, " + player.skinTone + " skin.");
            else if (player.skinType == SKIN_TYPE_SCALES) this.outputText("  You stare in horror as you pull your fingers away holding a handful of dried up scales!  Your scales continue to flake and peel off your skin in thick patches, revealing the tender " + player.skinTone + " skin underneath.");
        ...
        //From Tan, Olive, or Light skin tones
            ...
            if (mystic) this.outputText("angular");
    ...
    */
    ...
    public trapOil(player: Player): void {
        ...
        if (player.cor < 30) this.outputText("hesitantly ");
        else if (player.cor > 70) this.outputText("eagerly ");
        ...
        if (player.biggestTitSize() > 1 && Mutations.rand(4) == 0 && changes < changeLimit) {
            ...
            while (this.temp < player.bRows()) {
                if (player.breastRows[this.temp].breastRating > 70) player.breastRows[this.temp].breastRating -= Mutations.rand(3) + 15;
                else if (player.breastRows[this.temp].breastRating > 50) player.breastRows[this.temp].breastRating -= Mutations.rand(3) + 10;
                else if (player.breastRows[this.temp].breastRating > 30) player.breastRows[this.temp].breastRating -= Mutations.rand(3) + 7;
                else if (player.breastRows[this.temp].breastRating > 15) player.breastRows[this.temp].breastRating -= Mutations.rand(3) + 4;
                else player.breastRows[this.temp].breastRating -= 2 + Mutations.rand(2);
                if (player.breastRows[this.temp].breastRating < 1) player.breastRows[this.temp].breastRating = 1;
                this.temp++;
            }
            changes++;
        }
        ...
        if (player.longestCockLength() >= 3.5 && player.hasCock() && Mutations.rand(2) == 0 && changes < changeLimit) {
            ...
            if (player.cockTotal() == 1) this.outputText("s");
        ...
        //Testicle Reduction:
        if (player.balls > 0 && player.hasCock() && (player.ballSize > 1 || player.findStatusAffect(StatusAffects.Uniball) < 0) && Mutations.rand(4) == 0 && changes < changeLimit) {
        ...
        if (player.hasVagina() && Mutations.rand(4) == 0 && changes < changeLimit) {
            ...
            this.dynStats("sen", -2);
            //High fertility:
            if (player.fertility >= 30) this.outputText("It feels like your overcharged reproductive organs have simmered down a bit.");
            //Average fertility:
            else if (player.fertility >= 5) this.outputText("You feel like you have dried up a bit inside; you are left feeling oddly tranquil.");
            //[Low/No fertility:
            else {
                this.outputText("Although the numbness makes you feel serene, the trap oil has no effect upon your ");
                if (player.fertility > 0) this.outputText("mostly ");
                this.outputText("sterile system.");
                //[Low/No fertility + Trap/Corruption  >70:
                if (player.cor > 70) this.outputText("  For some reason the fact that you cannot function as nature intended makes you feel helpless and submissive.  Perhaps the only way to be a useful creature now is to find a dominant, fertile being willing to plow you full of eggs? You shake the alien, yet oddly alluring thought away.");
            }
        ...
        //Remove odd eyes
        if (player.eyeType == EYES_FOUR_SPIDER_EYES && Mutations.rand(2) == 0 && changes < changeLimit) {
            this.outputText("\n\nYou blink and stumble, a wave of vertigo threatening to pull your " + player.feet() + " from under you.  As you steady and open your eyes, you realize something seems different.  Your vision is changed somehow.", false);
            if (player.eyeType == EYES_FOUR_SPIDER_EYES) this.outputText("  Your multiple, arachnid eyes are gone!</b>", false);
            this.outputText("  <b>You have normal, humanoid eyes again.</b>", false);
            player.eyeType = EYES_HUMAN;
        ...
        //PC Trap Effects
        if (player.eyeType != EYES_BLACK_EYES_SAND_TRAP && Mutations.rand(4) == 0 && changes < changeLimit) {
        ...
        if (player.hasVagina() && player.vaginaType() != 5 && Mutations.rand(4) == 0 && changes < changeLimit) {
            ...
            //(Wet:
            if (player.wetness() >= 3) this.outputText("  Your natural lubrication makes it gleam invitingly.");
            //(Corruption <50:
            if (player.cor < 50) this.outputText("  After a few cautious touches you decide it doesn't feel any different- it does certainly look odd, though.");
        ...
        //Dragonfly Wings:
        if (player.wingType != WING_TYPE_GIANT_DRAGONFLY && Mutations.rand(4) == 0 && changes < changeLimit) {
    ...
    public ringtailFig(player: Player): void {
        ...
        if (player.hasCock()) {
            ...
            if (player.balls == 0 && player.skinType == SKIN_TYPE_FUR && 9999 == 9999 && Mutations.rand(3) == 0 && changes < changeLimit) {
        ...
        //bodypart changes:
        if (player.tailType != TAIL_TYPE_RACCOON && Mutations.rand(4) == 0 && changes < changeLimit) {
            //grow da tail
            //from no tail:
            if (player.tailType == TAIL_TYPE_NONE) {
        ...
        //gain fur
        if ((player.lowerBody == LOWER_BODY_TYPE_RACCOON && player.earType == EARS_RACCOON) && player.skinType != SKIN_TYPE_FUR && changes < changeLimit && Mutations.rand(4) == 0) {
        ...
        //gain feet-coon
        if (player.earType == EARS_RACCOON && player.lowerBody != LOWER_BODY_TYPE_RACCOON && changes < changeLimit && Mutations.rand(4) == 0) {
            ...
            //from hooves or hard feet, including centaurs and bees
                ...
                if (player.lowerBody == LOWER_BODY_TYPE_HOOFED || player.lowerBody == LOWER_BODY_TYPE_CENTAUR || player.lowerBody == LOWER_BODY_TYPE_PONY) this.outputText("pops right out of its hoof just in time");
            ...
            //from human, demon, paw feet
                ...
                if ((player.lowerBody == LOWER_BODY_TYPE_HUMAN || player.lowerBody == LOWER_BODY_TYPE_DEMONIC_HIGH_HEELS || player.lowerBody == LOWER_BODY_TYPE_DEMONIC_CLAWS) && player.skinType != SKIN_TYPE_FUR) this.outputText("The sensation of walking around on what feels like a second pair of hands is so weird that you miss noticing the itchy fur growing in over your legs...  ");
        ...
        if (player.faceType != FACE_RACCOON_MASK && player.faceType != FACE_RACCOON && Mutations.rand(4) == 0 && changes < changeLimit) {
            ...
            if (player.faceType == FACE_HUMAN || player.faceType == FACE_SHARK_TEETH || player.faceType == FACE_SNAKE_FANGS || player.faceType == FACE_BUNNY) {
                ...
                else this.outputText("A dark, almost black mask shades the " + player.skinFurScales() + " around your eyes and over the topmost portion of your nose, lending you a criminal air!  <b>You now have a raccoon mask!</b>");
            }
            //from snout (will not overwrite full-coon snout but will overwrite others)
                ...
                if (((player.hairColor == "black" || player.hairColor == "midnight") && (player.skinType == SKIN_TYPE_FUR || player.skinType == SKIN_TYPE_SCALES))) this.outputText("your face apparently returned to normal shape, albeit still covered in " + player.skinFurScales() + ".  You look closer and discover a darker, mask-line outline on your already inky visage.  <b>You now have a barely-visible raccoon mask on your otherwise normal human face.</b>");
                else if ((player.skinTone == "ebony" || player.skinTone == "black") && (player.skinType == SKIN_TYPE_PLAIN || player.skinType == SKIN_TYPE_GOO)) this.outputText("your face apparently returned to normal shape.  You look closer and discover a darker, mask-line outline on your already inky visage.  <b>You now have a barely-visible raccoon mask on your normal human face.</b>");
        ...
        else if (player.faceType == FACE_RACCOON_MASK && player.lowerBody == LOWER_BODY_TYPE_RACCOON && player.skinType == SKIN_TYPE_FUR && Mutations.rand(4) == 0 && changes < changeLimit) {
        ...
        else if (Mutations.rand(2) == 0 && changes < changeLimit && (player.faceType != FACE_RACCOON_MASK && player.faceType != FACE_RACCOON)) {
    ...
    public mouseCocoa(player: Player): void {
        ...
        if (!player.isTaur()) this.outputText("sit and ");
        ...
        if (player.tallness < 60 && (player.analCapacity() < 100 || (player.vaginalCapacity() < 100 && player.hasVagina())) && changes < changeLimit && Mutations.rand(3) == 0) {
            this.outputText("\n\nYour ");
            if (player.vaginalCapacity() < 100 && player.hasVagina()) this.outputText("[vagina]");
            ...
            if (player.isTaur()) this.outputText("Backing up to a likely rock, you rub your hindquarters against it, only to be surprised when you feel your hole part smoothly against the surface, wider than you're used to!");
            ...
            if (player.isTaur()) this.outputText("back away from your erstwhile sedimentary lover");
        ...
        if (player.earType != EARS_MOUSE && changes < changeLimit && Mutations.rand(4) == 0) {
            this.outputText("\n\nYour ears ");
            if (player.earType == EARS_HORSE || player.earType == EARS_COW || player.earType == EARS_DOG || player.earType == EARS_BUNNY || player.earType == EARS_KANGAROO) this.outputText("shrink suddenly");
        ...
        //gain tail
        //from no tail
        if (player.earType == EARS_MOUSE && player.tailType != TAIL_TYPE_MOUSE && changes < changeLimit && Mutations.rand(4) == 0) {
            //from other tail
            if (player.tailType > TAIL_TYPE_NONE) {
                ...
                if (player.tailType == TAIL_TYPE_HORSE) this.outputText("elongating");
        ...
        if (player.earType == EARS_MOUSE && (player.faceType == FACE_HUMAN || player.faceType == FACE_SHARK_TEETH || player.faceType == FACE_BUNNY || player.faceType == FACE_SPIDER_FANGS || player.faceType == FACE_RACCOON_MASK) && Mutations.rand(4) == 0 && changes < changeLimit) {
            ...
            if (player.faceType != FACE_HUMAN) this.outputText("the sharp teeth receding and ");
        ...
        if (player.skinType == SKIN_TYPE_FUR && player.faceType != FACE_MOUSE && (player.faceType != FACE_HUMAN || player.faceType != FACE_SHARK_TEETH || player.faceType != FACE_BUNNY || player.faceType != FACE_SPIDER_FANGS || player.faceType != FACE_RACCOON_MASK) && Mutations.rand(4) == 0 && changes < changeLimit) {
        ...
        //get fur
        if ((player.skinType != SKIN_TYPE_FUR || (player.skinType == SKIN_TYPE_FUR && (player.hairColor != "brown" && player.hairColor != "white"))) && changes < changeLimit && Mutations.rand(4) == 0) {
            //from skinscales
            if (player.skinType != SKIN_TYPE_FUR) {
                this.outputText("\n\nYour " + player.skinFurScales() + " itch");
                if (player.skinType > SKIN_TYPE_PLAIN) this.outputText("es");
                this.outputText(" all over");
                if (player.tailType > TAIL_TYPE_NONE) this.outputText(", except on your tail");
                ...
                if (player.skinType == SKIN_TYPE_SCALES) this.outputText(", pushing your scales out with little pinches");
    ...
    private demonChanges(player: Player): void {
        ...
        if (player.tailType != TAIL_TYPE_DEMONIC && player.horns > 0) {
            if (player.tailType != TAIL_TYPE_NONE) {
                this.outputText("\n\n", false);
                if (player.tailType == TAIL_TYPE_SPIDER_ADBOMEN || player.tailType == TAIL_TYPE_BEE_ABDOMEN) this.outputText("You feel a tingling in your insectile abdomen as it stretches, narrowing, the exoskeleton flaking off as it transforms into a flexible demon-tail, complete with a round spaded tip.  ", false);
                else this.outputText("You feel a tingling in your tail.  You are amazed to discover it has shifted into a flexible demon-tail, complete with a round spaded tip.  ", false);
        ...
        if (player.horns == 0 || (Mutations.rand(player.horns + 3) == 0)) {
            if (player.horns < 12 && (player.hornType == HORNS_NONE || player.hornType == HORNS_DEMON)) {
                ...
                else this.outputText("Another pair of demon horns, larger than the last, forms behind the first row.", false);
        ...
        //remove fur
        if ((player.faceType != FACE_HUMAN || player.skinType != SKIN_TYPE_PLAIN) && Mutations.rand(3) == 0) {
            //Remove face before fur!
            ...
            //De-fur
                ...
                this.outputText("\n\n", false);
                if (player.skinType == SKIN_TYPE_FUR) this.outputText("Your skin suddenly feels itchy as your fur begins falling out in clumps, <b>revealing inhumanly smooth skin</b> underneath.", false);
                if (player.skinType == SKIN_TYPE_SCALES) this.outputText("Your scales begin to itch as they begin falling out in droves, <b>revealing your inhumanly smooth " + player.skinTone + " skin</b> underneath.", false);
                player.skinType = SKIN_TYPE_PLAIN;
                player.skinDesc = "skin";
            }
        }
        ...
        //Grow demon wings
        if (player.wingType != WING_TYPE_BAT_LIKE_LARGE && Mutations.rand(8) == 0 && player.cor >= 50) {
    ...
    public ferretTF(player: Player): void {
        ...
        if (!this.flags[kFLAGS.HYPER_HAPPY] && (player.biggestTitSize() > 2 || (player.hasCock() && player.biggestTitSize() >= 1)) && Mutations.rand(2) == 0 && changes < changeLimit) {
        ...
        if (player.hasCock()) {
            ...
            if (temp >= 0 && Mutations.rand(2) == 0 && changes < changeLimit) {
                if (player.cocks[temp].cockLength > 6 && !this.flags[kFLAGS.HYPER_HAPPY]) {
                    ...
                    if (player.cocks[temp].cockLength >= 9) player.cocks[temp].cockLength -= Mutations.rand(3) + 1;
        ...
        if (player.eyeType == EYES_FOUR_SPIDER_EYES && Mutations.rand(3) == 0 && changes < changeLimit) {
        ...
        if (player.faceType == FACE_FERRET_MASK && player.skinType == SKIN_TYPE_FUR && player.earType == EARS_FERRET && player.tailType == TAIL_TYPE_FERRET && player.lowerBody == LOWER_BODY_FERRET && Mutations.rand(4) == 0 && changes < changeLimit) {
        ...
        if (player.faceType != FACE_HUMAN && player.faceType != FACE_FERRET_MASK && player.faceType != FACE_FERRET && Mutations.rand(3) == 0 && changes < changeLimit) {
        ...
        if (player.skinType != SKIN_TYPE_FUR && player.earType == EARS_FERRET && player.tailType == TAIL_TYPE_FERRET && player.lowerBody == LOWER_BODY_FERRET && Mutations.rand(4) == 0 && changes < changeLimit) {
        ...
        //Tail TFs!
        if (player.tailType != TAIL_TYPE_FERRET && player.earType == EARS_FERRET && Mutations.rand(3) == 0 && changes < changeLimit) {
        ...
        else if (player.isNaga() && player.earType == EARS_FERRET && Mutations.rand(4) == 0 && changes < changeLimit) {
        ...
        if (player.lowerBody != LOWER_BODY_FERRET && player.earType == EARS_FERRET && player.tailType == TAIL_TYPE_FERRET && Mutations.rand(4) == 0 && changes < changeLimit) {
        ...
        if (player.earType != EARS_FERRET && Mutations.rand(4) == 0 && changes < changeLimit && Mutations.rand(2.5) == 0 && changes < changeLimit) {
