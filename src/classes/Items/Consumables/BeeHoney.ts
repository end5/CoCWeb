...
export class BeeHoney extends Consumable {
    ...
    public useItem(): boolean {
        ...
        if (changes < changeLimit && player.bRows() > 2 && Utils.rand(3) == 0 && !this.getGame().flags[kFLAGS.HYPER_HAPPY]) {
            changes++;
            ...
            if (player.skinType == CoC.SKIN_TYPE_FUR) this.outputText(player.hairColor + " " + player.skinDesc);
