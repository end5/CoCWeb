    ...
    public useItem(): boolean {
        if (this.game.player.findPerk(PerkLib.BroBody) >= 0) {
            ...
            if (this.game.player.biggestTitSize() < 7) {
                ...
                else this.outputText("  You feel a tingling inside your breasts.  ");
            ...
            if (this.game.player.findPerk(PerkLib.BroBrains) >= 0) this.outputText(", Bro Brains");
            this.outputText(")\n");
            ...
            if (this.game.player.hasCock()) {
                ...
                if (this.game.player.cockTotal() == 1) this.outputText("a penis");
                else this.outputText("penises");
                this.outputText("!</b>");
            ...
            if (this.game.player.clitLength >= 3) this.outputText("jerk ");
