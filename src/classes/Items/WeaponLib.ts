...
export class WeaponLib {
    ...
    public URTAHLB: Weapon = new Weapon(
        "UrtaHlb",
        "UrtaHlb",
        "halberd",
        "a halberd",
    ...
    public L__AXE: Weapon = new Weapon(
        ...
        "L. Axe ",
        "large axe",
        "an axe large enough for a minotaur",
        "cleave",
        15,
        100,
    ...
    public S_GAUNT: Weapon = new Weapon(
        "S.Gaunt",
        "S.Gauntlet",
        "spiked gauntlet",
        "a spiked gauntlet",
