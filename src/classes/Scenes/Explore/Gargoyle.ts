...
export class Gargoyle extends BaseContent {
    ...
    public gargoylesTheShowNowOnWBNetwork(): void {
        ...
        if (this.player.exploredDesert > 0)
            this.outx(", making even the desert seem healthy and full of life");
        this.outx(
        ...
        if (this.player.statusAffectv1(StatusAffects.TelAdre) >= 1)
            this.outx("or the ruins of one of Tel'Adre's more distant neighbors, ");
        this.outx(
    ...
    private gargoyleMeeting2(): void {
        ...
        if (this.player.lib >= 40)
            this.outx("  Maybe you could take this with you as a life-sized sex toy?");
    ...
    private breakZeChains(): void {
        ...
        this.outx("You swing your [weapon] up over your head and strike the chains.");
        // if using your hands:
    ...
    private nameZeGargoyle(input: HTMLInputElement): void {
        ...
        if (input.value == "") {
            ...
            this.clearOutput();
            this.outx("<b>You must name her.</b>");
    ...
    private carnalOrder(): void {
        ...
        if (this.player.cor < 40) this.outx("flustered");
        ...
        if (this.model.time.hours <= 9 || this.model.time.hours >= 18 || woken) {
            if (!woken) {
                ...
                if (this.gargoyleConfidence() < 70) this.outx("kneels before you, head bowed low.");
                    ...
                    this.outx("bows low before you, a small smile on her stone lips.");
                else
                    this.outx(
    ...
    private gargoyleAnal(): void {
        ...
        // (if PC doesn't qualify for the above:)
            ...
            // if Balls:
            if (this.player.balls > 0) this.outx(", your balls slapping against her butt");
            this.outx(
    ...
    private gargoyleCoochiiGetsPlowed(): void {
        ...
        if (this.player.cockArea(x) > 60) this.outx("as far as she can take you.");
        else this.outx("up to the hilt inside her.");
        this.outx(
    ...
    private tailFuckGargoyleScene(): void {
        ...
        if (this.gargoyleConfidence() > 70) this.outx(" with just a hint of a smile");
        this.outx(".");
    ...
    private ritualGargoyle(): void {
        ...
        if (this.flags[kFLAGS.RITUAL_INTRO] == 0) {
            ...
            if (this.gargoyleConfidence() < 50) this.outx(" Forgive my impertinence, but");
            this.outx(
    ...
    private banishmentGargoyleRitual(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) this.outx("this bastard");
        else this.outx("these bastards");
    ...
    private kinkyBodyRitual(): void {
        ...
        if (this.player.biggestTitSize() >= 1)
            this.outx(", cupping your [chest] in her cold stone hands");
        this.outx(
        ...
        // if Male/Herm:
        if (this.player.hasCock()) this.outx(this.cockDescript(0));
    ...
    private banishPervRitual(): void {
        ...
        else this.outx("s within you have");
        this.outx(
    ...
    private historyOfGargoylesB(): void {
        ...
        // if Confidence >70:
        if (this.gargoyleConfidence() > 70)
            this.outx(", and I despise them with every fiber of my being");
        this.outx('.  I may not be the most fair nor most balanced source of information.</i>"');
    ...
    private garNameA(): void {
        ...
        if (this.player.race() == "human") this.outx("are");
        else this.outx("once were");
        this.outx(
    ...
    private gargoyleAppearance(): void {
        ...
        if (this.gargoyleConfidence() < 70)
            this.outx("glow timidly, reflecting a submissive and servile nature in the gargoyle.");
        else
            this.outx(
