...
export class Gargoyle extends BaseContent {
    ...
    public gargoylesTheShowNowOnWBNetwork(): void {
        ...
        this.outputText(
            ".  Your trip soon begins to seem unproductive, having found no new areas of Mareth or any contact with its inhabitants.  You sigh and turn back towards camp."
        );
    ...
    private dontBreakThatShit(): void {
        this.clearOutput();
        this.outputText(
            "Oh, no.  Nope.  Nuh-uh.  Not going to happen.  You're not falling for that trick!  No, siree.  As soon as you chop those chains, it'll probably just come to life and try to kill - or rape - you.  Feeling rather smart, you turn on a heel and exit the cathedral – there's nothing else to see right now."
        );
    ...
    private breakZeChains(): void {
        ...
        this.outputText(
            "  An ear-splitting <i>SCHING!</i> echoes through the cathedral as shards of gold go flying.  You recoil, shielding your face from the surprisingly explosive force of the chains' shattering.  When the dust settles you cautiously lower your arms, giving you a good view of what lies – or rather, kneels – before you:"
        );
    ...
    private nameZeGargoyle(input: HTMLInputElement): void {
        ...
        if (input.value == "") {
            ...
            this.clearOutput();
            this.outputText("<b>You must name her.</b>");
    ...
    private carnalOrder(): void {
        ...
        this.outputText(
            " heartbeat.  The way she watches you, unblinking, as she fingers herself is rather unnerving, and you soon command her to stop.  She does so immediately, though with what you think might have been a sigh, and assumes a low crouch to await your next command."
        );
        this.gargoyleStarterMenu();
    }
        ...
        // [b]Cathedral Interior: 10:00 –> 17:00[/b]
            ...
            if (!woken) {
                ...
                if (this.player.lust >= 33)
                    this.outputText(
                        ", or you could use her to satisfy your own urges, not unlike a life-size sex toy"
                    );
                this.outputText(".");
            }
    ...
    private titFuckTheGargoyle(): void {
        ...
        if (this.gargoyleConfidence() >= 70)
            this.outputText(", and to your surprise, so does " + this.flags[kFLAGS.GAR_NAME] + "");
        this.outputText(".");
    ...
    private tailFuckGargoyleScene(): void {
        ...
        this.outputText(
            "You shudder as you finally bottom out on her tail, taking it until your cunt is almost painfully stretched by her ever - thickening tail and you can feel the tip pressing against the entrance to your womb."
        );
    ...
    private banishmentGargoyleRitual(): void {
        ...
        this.outputText(
            ' in your travels, and would like to rid yourself of them.  She tells you to strip and brace yourself against the altar.  "<i>Unfortunately, as you have been invaded, so too is this a very... invasive ritual.</i>"  You nod your assent – you really want to get '
        );
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0)
    ...
    private kinkyBodyRitual(): void {
        ...
        this.outputText(
            ".  Your [nipples] go rock hard from her cold touch, and you shudder as she gently nips your ear and drags the length of the crop along your thighs."
        );
        ...
        this.outputText(
            ".  Already, you feel more thick-skinned and less lusty, and so give an appreciative grin to your cute little gargoyle.  In response, she nuzzles against you and wraps her bat-like wings protectively around the two of you."
        );
    ...
    private banishPervRitual(): void {
        ...
        if (this.player.ass.analWetness > 0)
            this.outputText(
                "  She slips in easily, sliding her tingling holy rod into you until her hips are pressed against your [butt]"
            );
        else
            this.outputText(
                "  She slowly but surely coaxes the holy rod into your asshole, making long and slow thrusts into you until she finally bottoms out"
            );
        this.outputText(".");
        ...
        this.outputText(
            " been absorbed and purged by the rod; and you can't help but hope she has more... just in case."
        );
    ...
    private talkToGargoyle(output = true): void {
        if (output) {
            ...
            // if Confidence = 51-69:
                ...
                this.outputText(
                    "  Happily, she takes a seat beside you and slips an arm around your shoulders, locking you in companionable closeness."
                );
            this.outputText(
    ...
    private historyOfGargoylesB(): void {
        ...
        this.outputText(
            '.  I may not be the most fair nor most balanced source of information.</i>"'
        );
    ...
    private cathedralC(): void {
        ...
        this.outputText(
            '.  But I am bound to this place, Master. I could not leave even if I wanted to.  My makers were wary of their creation, and chose to bind me here; they thought that if I ever rebelled, I would not do much harm if contained within the Cathedral.</i>"'
        );
    ...
    private garNameA(): void {
        ...
        this.outputText(
            ', Master, and more.  We were to be their guardians, protectors – their perfect servants.</i>"'
        );
        ...
        if (this.gargoyleConfidence() > 69)
            this.outputText(
                '  She continues, "<i>though even were I not compelled to, I would still serve you,</i>" she says with a playful wink.'
            );
        ...
        if (this.gargoyleConfidence() <= 69)
            ...
            this.outputText(
                '  "<i>Sorry, Master. I just....Don\'t want to talk about it right now.  Ask me again some time.</i>"'
            );
    ...
    private gargoyleAppearance(): void {
        ...
        if (this.gargoyleConfidence() < 70)
            this.outputText(
                "glow timidly, reflecting a submissive and servile nature in the gargoyle."
            );
        else
            this.outputText(
        ...
        this.outputText(
            " about her thighs.  She has two normal human legs sculpted to end in normal human feet."
        );
