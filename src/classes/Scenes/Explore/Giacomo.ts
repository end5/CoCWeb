...
export class Giacomo extends BaseContent implements TimeAwareInterface {
    ...
    public giacomoEncounter(): void {
        ...
        if (kGAMECLASS.giacomo == 0) {
            ...
            this.outputText(
                "You ask how he knows of your change and the merchant giggles heartily.\n\n"
            );
            this.outputText(
    ...
    private firstEncounter(): void {
        ...
        this.outputText(
            '"<i>Greetings, traveler! My name is Giacomo.  I am, as you can see, a humble purveyor of items, curios and other accoutrements.  While I am not in a position to show you my full wares as my shop is packed on this push-cart, I do offer some small trinkets for travelers I meet.</i>"\n\n'
        );
        this.outputText(
        ...
        this.outputText(
            '"<i>So stranger, be you interested in some drafts to aid you in your travels, some quick pamphlets to warn you of dangers on journeys or...</i>"\n\n'
        );
        this.outputText(
        ...
        this.outputText(
            '"<i>...maybe you would be interested in some items that enhance the pleasures of the flesh?  Hmmm?</i>"\n\n'
        );
        this.outputText(
            "Giacomo's grin is nothing short of creepy as he offers his wares to you.  What are you interested in?"
        );
    ...
    private pitchVitailtyTincture(): void {
        ...
        this.clearOutput();
        this.outputText(
            "Giacomo holds up the item and says, \"<i>Ah, yes!  The quintessential elixir for all travelers, this little bottle of distilled livelihood will aid you in restoring your energy on your journey and, should you be hurt or injured, will aid the body's ability to heal itself.  Yes " +
    ...
    private buyVitailtyTincture(): void {
        ...
        if (this.player.gems < 15) {
            this.clearOutput();
            this.outputText(
                "\n\nGiacomo sighs, indicating you need " +
                    String(15 - this.player.gems) +
                    " more gems to purchase this item."
            );
    ...
    private pitchHentaiComic(): void {
        ...
        this.outputText(
            'Giacomo takes out a colorfully written magazine from his bag.  The cover contains well-drawn, overly-endowed women in sexual poses.  "<i>Perhaps your taste in reading is a bit more primal, my good ' +
                this.player.mfn("man", "lady", "...err, whatever you are") +
    ...
    private buyYogaGuide(): void {
        ...
        if (this.player.hasKeyItem("Yoga Guide") >= 0) {
            ...
            this.outputText(
                "You exchange 100 gems for the tome.  Now you can finally enjoy a workout with Cotton!"
            );
    ...
    private buyAllNaturalSelfStimulationBelt(): void {
        ...
        this.outputText(
            "After making the payment, Giacomo hands you the All-Natural Self-Stimulation Belt"
        );
    ...
    private wormRemoval(): void {
        ...
        this.outputText(
            "Upon seeing the fat worm, Giacomo displays a freakish celerity by jumping off his cart, grabbing an empty container and collecting the fat worm. Regaining your senses, you look at him with inquisitive shock at what he just did.\n\n"
        );
        this.outputText(
            '"<i>You have to realize that I AM a merchant, after all.</i>", he calmly replies. "<i>Hell for you is heaven for someone else. This bugger will easily fetch 10,000 gems to some noble looking for a quick buzz. Don\'t WE know better!</i>"\n\n'
        );
        this.outputText(
    ...
    private nightSuccubiFirstTime(): void {
        ...
        if (this.player.gender == 0) {
            ...
            this.outputText(
                '"<i>Wait a fucking minute,</i>" the Succubus says, "<i>Where\'s your dick?!</i>"\n\n'
            );
            this.outputText(
                'As you state your genderless nature, the succubus hops off and from nowhere pulls out a large folder marked "<i>Corruption of Champions-Script</i>" and begins thumbing through the pages.  After finding the page she is looking for, she reads it and looks off into the distance in disgust.\n\n'
            );
            this.outputText(
                '"<i>Hey Fenoxo and Dxasmodeus!!!!!!</i>" the Succubus crows, "<i>The goddamn script says that I should be milking someone\'s DICK!!!  Man, futa, herm, I don\'t give a shit.  YOUR OWN FUCKING SCRIPT SAYS I SHOULD BE MOUNTING AND MILKING A COCK!!!!  THIS IS A SEX GAME!!!!!!  THAT MEANS FUCKING!  WHAT THE HELL AM I SUPPOSED TO FUCK???!!!</i>"\n\n'
            );
            this.outputText(
            ...
            this.outputText(
                'The Succubus stops, turns and points to you in derision.  "<i>And YOU!  You no-cock, no-cunt having pissant!  Take your ass back to the lab before they find out you escaped!!!!!</i>"\n\n'
            );
            this.outputText(
        ...
        if (this.player.gender == 1)
            ...
            this.outputText(
                "As the Succubus looks down at your " +
                    this.cockDescript(0) +
            ...
            this.outputText(
                "You quickly try to struggle, but find the Succubus to be utterly dominating.  She wraps her arms around your back and entwines her lean legs around your hips.  The Succubus playfully licks your lips and grins.\n\n"
            );
            this.outputText(
                '"<i>You are getting your dick milked,</i>" the Succubus says flatly, "<i>Accept it.  Trust me, when I am done, you will want more of me, anyway.</i>"\n\n'
            );
            this.outputText(
                "As the Succubus finishes her ultimatum, you feel churning vaginal contractions stroking your massive cock.  Heavy, powerful, coordinated undulations work your dick as surely as the best handjob.  You quickly moan in shock and pleasure at such rough treatment."
            );
        }
    ...
    private ceruleanSuccubusEncounterPart2(): void {
        ...
        if (this.player.gender == 1) {
            ...
            this.outputText(
                "\"<i>See,</i>\" the Succubus says triumphantly, \"<i>You are already enjoying it.  You don't even have to hump.  My cunt does all the work.  Try THAT with a human woman.  Good fucking luck.  Half of them don't even know how to keep a prick hard once it's inside them and then they bitch because THEY didn't cum.</i>\"\n\n"
            );
            this.outputText(
                "The fierce milking continues for several minutes until you reflexively buck your hips as your inner organs fill with the white, milky life-water the demoness demands in order to slake her thirst.  Quick to take notice of your muscular reaction, the succubus snickers.\n\n"
            );
            this.outputText(
                '"<i>Ready to burst, are you?</i>" the Succubus playfully challenges.  "<i>Well, then.  No reason for you to hold back.</i>"'
            );
        }
        this.dynStats("tou", 0.3, "lib", 0.5, "sen", 0.5, "lus", 5, "cor", 1);
    ...
    private ceruleanSuccubusEncounterPart3(): void {
        ...
        if (this.player.gender == 1) {
            ...
            this.outputText(
                "She places the mouth of the jar next to one of her fat nipples and begins milking her tit into the jar, filling it back up with her fluids.  She places the jar next to you and stands up.\n\n"
            );
            this.outputText(
                '"<i>It has been a long time since I soaked up a load that good,</i>" she says, "<i>Anytime you want more of that, just drink my milk again.  It\'s only fair.  I take your milk, you take mine.</i>"\n\n'
            );
            this.outputText(
    ...
    private ceruleanSuccubusEncounterPart4(): void {
        ...
        if (this.player.gender == 1) {
            ...
            if (this.player.tallness < 80)
                this.outputText(
                    "you see that she towers over you.  She must stand well over seven feet in height.  "
                );
            if (this.player.tallness >= 80 && this.player.tallness < 90)
                this.outputText(
                    "you see she is about as tall as you - around seven feet in height.  "
                );
            if (this.player.tallness >= 90)
                this.outputText(
                    "you see she's definitely shorter than you, only about seven feet tall.  "
                );
            this.outputText(
            ...
            this.outputText(
                "She gives a giggle and disappears before your eyes.  At that moment the fatigue from the massive fucking you received catches up with you and you pass out in a slump."
            );
            this.dynStats("str", 0.5, "lus", 4);
        }
    ...
    private nightSuccubiRepeat(): void {
        ...
        if (this.player.gender == 0) {
            ...
            // REPEAT
                ...
                this.outputText(
                    "As the cacophony fades, you only hear one facetiously toned word,\n\n",
                    false
                );
        ...
        if (this.player.gender == 1) {
            if (this.player.cor < 66) {
                ...
                if (this.player.isTaur())
                    this.outputText(
                        " crouch between your legs and impale herself on your " +
                            this.cockDescript(0) +
                    ...
                    this.outputText(
                        " open her womb and quickly consume your " +
                            this.cockDescript(0) +
                            ". She embraces you, entrapping your head in her cleavage as y",
                        false
                    );
                this.outputText(
                    "ou quickly feel her superhuman vaginal muscles work and stroke your " +
                        this.cockDescript(0) +
                ...
                if (this.player.isTaur())
                    this.outputText(
                        "Pushing on your forelegs, she engulfs even more of your " +
                            this.cockDescript(0),
                        false
                    );
                else
                    this.outputText(
                        "Almost crushing your pelvis, she wraps her legs around your body",
                        false
                    );
                this.outputText(
                ...
                if (this.player.isTaur())
                    this.outputText(
                        "arches under your belly as you feel your " +
                            this.cockDescript(0) +
                ...
                if (this.player.isTaur())
                    this.outputText(
                        "pushes on your forelegs, impaling herself even deeper on your " +
                            this.cockDescript(0),
                        false
                    );
                ...
                if (this.player.isTaur())
                    this.outputText(
                        "She moans inhumanly, and reflexively digs her claws into your forelegs. Searing with lust, the pain means little to you as you only feel the sensation of your body forcing your fluids out of your body and into hers. You press your " +
                            this.cockDescript(0) +
                            " into her",
                        false
                    );
            ...
            if (
                ...
                if (
                    this.player.horseScore() +
                        ...
                        this.player.nagaScore() +
                        this.player.goblinScore() +
                        this.player.sharkScore() +
                        this.player.minoScore() +
