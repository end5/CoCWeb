...
export class Giacomo extends BaseContent implements TimeAwareInterface {
    ...
    public giacomoEncounter(): void {
        ...
        if (kGAMECLASS.giacomo == 0) {
            ...
            this.outx("You ask how he knows of your change and the merchant giggles heartily.\n\n");
            this.outx(
            ...
            if (this.player.gems < 175) {
                ...
                // Can afford
                this.outx("Do you purchase his cure?");
                // Remove/No
    ...
    private pitchDangerousPlantsBook(): void {
        ...
        if (this.player.hasKeyItem("Dangerous Plants") >= 0) {
            this.outx("<b>You already own the book 'Dangerous Plants'.</b>");
    ...
    private pitchTravellersGuide(): void {
        ...
        if (this.player.hasKeyItem("Traveler's Guide") >= 0) {
            this.outx("<b>You already own the book 'Traveler's Guide'.</b>");
            this.doNext(this.bookMenu);
            return;
        }
        this.outx(
    ...
    private pitchHentaiComic(): void {
        ...
        if (this.player.hasKeyItem("Hentai Comic") >= 0) {
            this.outx("<b>You already own a Hentai Comic!</b>");
            this.doNext(this.bookMenu);
            return;
        }
        this.outx(
    ...
    private buyYogaGuide(): void {
        ...
        if (this.player.hasKeyItem("Yoga Guide") >= 0) {
            this.outx("<b>You already own a yoga guide!</b>");
        } else if (this.player.gems < 100) {
            this.outx("You cannot afford a yoga guide!");
        } else {
            this.outx(
    ...
    private pitchDildo(): void {
        ...
        if (this.player.hasKeyItem("Dildo") >= 0) {
            this.outx("<b>You already own a Dildo!</b>");
    ...
    private buyDildo(): void {
        ...
        if (this.player.gems < 20) {
            ...
            this.outx("After making the payment, Giacomo hands you the Dildo");
            this.doNext(this.eroticaMenu);
            this.player.gems -= 20;
    ...
    private pitchSelfStimulationBelt(): void {
        ...
        if (this.player.hasKeyItem("Self-Stimulation Belt") >= 0) {
            this.outx("<b>You already own a Self-Stimulation Belt!</b>");
            this.doNext(this.eroticaMenu);
            return;
        }
        this.outx(
    ...
    private buySelfStimulationBelt(): void {
        ...
        this.outx("After making the payment, Giacomo hands you the Self-Stimulation Belt");
    ...
    private pitchAllNaturalSelfStimulationBelt(): void {
        ...
        if (this.player.hasKeyItem("All-Natural Self-Stimulation Belt") >= 0) {
            this.outx("<b>You already own an All-Natural Self-Stimulation Belt!</b>");
            this.doNext(this.eroticaMenu);
            return;
        }
        this.outx(
    ...
    private pitchOnahole(): void {
        ...
        if (this.player.hasKeyItem("Plain Onahole") >= 0) {
            this.outx("<b>You already own a Plain Onahole!</b>");
            this.doNext(this.eroticaMenu);
            return;
        }
        this.outx(
    ...
    private buyOnahole(): void {
        ...
        this.outx("After making the payment, Giacomo hands you the Plain Onahole");
    ...
    private pitchDeluxeOnahole(): void {
        ...
        if (this.player.hasKeyItem("Deluxe Onahole") >= 0) {
            this.outx("<b>You already own a Deluxe Onahole!</b>");
            this.doNext(this.eroticaMenu);
            return;
        }
        this.outx(
    ...
    private buyDeluxeOnahole(): void {
        ...
        this.outx("After making the payment, Giacomo hands you the Deluxe Onahole");
    ...
    private pitchAllNaturalOnahole(): void {
        ...
        if (this.player.hasKeyItem("All-Natural Onahole") >= 0) {
            this.outx("<b>You already own an All-Natural Onahole!</b>");
            this.doNext(this.eroticaMenu);
            return;
        }
        this.outx(
    ...
    private buyAllNaturalOnahole(): void {
        ...
        this.outx("After making the payment, Giacomo hands you the All-Natural Onahole");
    ...
    private pitchDualStimulationBelt(): void {
        ...
        if (this.player.hasKeyItem("Dual Belt") >= 0) {
            this.outx("<b>You already own a dual belt!</b>");
            this.doNext(this.eroticaMenu);
            return;
        }
        this.outx(
    ...
    private buyDualStimulationBelt(): void {
        ...
        this.clearOutput();
        if (this.player.gems < 50) {
            this.outx("You do not have enough gems to purchase this item.");
        } else {
            this.outx(
    ...
    private ceruleanSuccubusEncounterPart4(): void {
        ...
        if (this.player.gender == 1) {
            this.clearOutput();
            this.outx("She stands up and helps you to your feet.  While dazed, ");
            ...
            if (this.player.tallness >= 80 && this.player.tallness < 90)
                this.outx("you see she is about as tall as you - around seven feet in height.  ");
    ...
    private nightSuccubiRepeat(): void {
        ...
        if (this.player.gender == 0) {
            ...
            // REPEAT
                ...
                this.outx('"<i><b>Problem?</b></i>"', false);
            }
            this.doNext(this.playerMenu);
            return;
        }
        ...
        if (this.player.gender == 1) {
            if (this.player.cor < 66) {
                ...
                this.outx("Fatigue takes you and you collapse into a deep sleep.  ");
            } else {
                this.outx(
