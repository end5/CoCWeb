...
export class EncapsulationPod extends Monster {
    ...
    public get long(): string {
        ...
        //[Round 4 Description]
            ...
            if (this.player.biggestTitSize() >= 1) _long += "the underside of your " + this.game.allBreastsDescript();
