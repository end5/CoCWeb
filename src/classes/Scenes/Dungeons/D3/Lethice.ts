...
export class Lethice extends Monster {
    ...
    private p2DemonFuck(hpVictory: boolean): void {
        ...
        this.outputText(
            "Rather than advance on Lethice, you turn your attention to the pile of demons"
        );
    ...
    private fuckDemon(): void {
        ...
        if (this.player.hasFuckableNipples())
            this.outputText(
                " until you give her a wicked grin and guide the tip inside your [nipple]"
            );
    ...
    private parasiteThrowingStars(): void {
        ...
        if (this.combatMiss()) {
            ...
            this.outputText(
                " Your misdirecting movements allow you to avoid the living throwing stars."
            );
        } else if (this.combatFlexibility()) {
    ...
    private whiptrip(): void {
        ...
        if (this.combatMiss()) {
            ...
            this.outputText(
                " You evade her trip, but the heat pouring off the whip singes your [feet]."
            );
            minDamage = true;
        } else {
            this.outputText(
