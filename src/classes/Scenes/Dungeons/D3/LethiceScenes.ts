...
export class LethiceScenes extends BaseContent {
    ...
    public defeated(hpVictory: boolean): void {
        ...
        if (hpVictory) {
            this.outputText(
                "<i>“No,”</i> Lethice cries, dropping onto all fours, barely able to support herself. <i>“How c-can this be...”</i> She shakes her head, tries to stand, and collapses once more. <i>“My reign was to be eternal and unquestioned.”</i> Hatred burns in her eyes. <i>“You ruined it all.”</i> She spits on the ground, then struggles not to collapse into it."
            );
        } else {
            this.outputText(
                "<i>“No,”</i> Lethice cries, shaking her head in denial. <i>“How c-can this be? How can you do this to me.”</i> She shudders, dropping onto all fours, barely keeping a hand out of her cunt by sheer force of will. It dances across the slip of fabric at her crotch, threatening to rebel at any moment. <i>“I’m not some ditsy, succubus slut.”</i> A whole-body shiver wracks her from head to toe. <i>“Gods, am I?”</i>"
            );
        }
    ...
    private plowHerPussy(): void {
        ...
        this.outputText(
            "Lethice is primed and ready, spanked into submission twice over and drooling with her eagerness for a victorious fucking. You have to wonder when the last time this haughty bitch was put on the bottom - how long has she gotten to play top dog, with nobody to tell her otherwise?"
        );
    ...
    private plowHerDouble(): void {
        ...
        this.outputText(
            "You smirk down at Lethice’s winged back and reddened ass, letting your multiple cocks tell her what’s in store. Your [cock] presses against the tight, dark ring of her asshole while the"
        );
        if (this.player.cocks.length == 2) this.outputText(" other");
        else this.outputText(" next");
        this.outputText(
            " member sloppily nestles between the lips of her pussy, slathering its crown with demonic juices. Lethice can only groan and weakly struggle against your firm, dominant hand when she realizes what you intend."
        );
        ...
        if (this.player.isBiped())
            this.outputText(
                " and prop your feet up on the Demon Queen’s prostrate back, smearing her face down in your seed"
            );
        this.outputText(".");
    ...
    private queenHer(): void {
        ...
        this.outputText(
            "The Demon Queen is defeated. Some part of you knew this was where it had to end ever since you first heard of Lethice: with one of you on her knees, completely at the mercy of the other. Now, though... She looks almost... normal, in a way. Her default form, such as it is, seems like nothing more than a tall, lanky girl with horns - she doesn’t even sport the huge, drooling cock and tits of most of her slack-jawed minions standing around. If she closed her eyes and furled back her wings, you could almost imagine her as any of the priestesses from Ingnam."
        );
        ...
        this.outputText(
            " forward, pulling your [armor] off as you loom over the defeated demoness."
        );
        ...
        this.outputText(
            " and arching your back as you feel her long, sinuous muscle slithering inside you like a snake - or a tentacle! Her talents as a shapeshifter become readily apparent as her tongue grows thicker and thicker, yet no less dexterous, spreading your pussy-lips and straining your slit with growing girth."
        );
        ...
        if (this.player.hasCock())
            this.outputText(
                " and dragging your [cock] across her face, smearing pre all through her hair"
            );
        this.outputText(
            ". She keeps wriggling under you, trying to rest herself free of your pin, but you’re relentless in your determination: she’s not moving from this spot until you cum all over her face!"
        );
        ...
        this.outputText(
            ". Lethice is lying stunned on the ground, eyes rolled back in her head and face utterly smeared with your orgasmic juices. That’s a good look for you, you decide. Content in your final victory, you swing yourself into her throne"
        );
        if (this.player.isBiped())
            this.outputText(
                " and prop your feet up on the Demon Queen’s prostrate back, smearing her face down in your seed"
    ...
    private boobPlay(hpVictory: boolean): void {
        ...
        this.outputText(
            ". She looks almost... normal, in a way. Her default form, such as it is, seems like nothing more than a tall, lanky girl with horns - she doesn’t even sport the huge, drooling cock and tits of most of her slack-jawed minions standing around. Strange, for a shapeshifter... maybe you can force her to fix that before you reap the fruits of your conquest!"
        );
        ...
        if (this.player.hasCock()) {
            ...
            this.outputText(
                ", pumping out of the Demon Queen like cum out of a real cock. It feels... good. <b>Really</b> good! The milk might be cold, but you feel a heat start spreading through your loins, spurring you to start really moving - to start taking all the pleasure that Lethice’s mutable body can give you!"
            );

            this.outputText("\n\n");
            if (this.player.hasVagina()) {
                this.outputText(
                    "One cock’s not enough for you now. Not at the end of your adventure, after everything this bitch and her minions have put you through. You need <b>more</b>! You hike"
                );
                if (!this.player.isNaga()) this.outputText(" a leg");
                else this.outputText(" your coils");
                this.outputText(
                    " over Lethice’s body, starting to ride her sideways. The feeling of her nipple-cock twisting around inside you, gushing milk all the harder, but it’s not what you’re looking for. Instead, you reach back and grab the other dick-nipple, angling it towards your [asshole]. Like the first, it’s slicked with plenty of tainted milk, making the entrance as easy as you’d like. You give out a shuddering sigh as you sink down on both of the Demon Queen’s dicks, filling your holes with throbbing, milky meat.\n\n"
                );
            }

            this.outputText(
                "You start to move, grinding against Lethice’s jiggling rack and drawing her dick-nipple"
            );
            if (this.player.hasVagina()) this.outputText("s");
            this.outputText(
                " through you, again and again. The demons around you hoot and holler, driven wild with lust as you rape their queen, and you can’t help but smile."
            );
            if (this.player.cor >= 66) this.outputText(" You’re finally where you belong!");
            else
                this.outputText(
                    " Even the demons recognize what you’ve done! Now the only question is what to do with them afterwards..."
                );
            this.outputText(
                " For now, though, you sate yourself by riding faster, bouncing on Lethice’s plump chest. Faster and faster, you piston your [hips] until you and Lethice both are moaning with pleasure, your bodies quaking with growing ecstasy."
            );
            ...
            if (this.player.hasVagina()) this.outputText("s");
            this.outputText(
                " as hard and fast as you can, letting purple milk spray from your hole as Lethice’s milky tits cum their corrupted load inside you. She screams, back arching and wings beating like hammers against the stone. But that doesn’t matter to you - not right now, not when you’re so close! You shove the demoness down, pinning her between your pounding hips and the unrelenting stone."
            );
            ...
            if (this.player.hasVagina()) this.outputText("s");
            this.outputText(
                ", gushing their lactic load inside you. You keep pistoning your hips as fast as you can, dragging out every iota of pleasure that you can before the climax passes over you, leaving you panting and gasping and leaking corrupted fluids from your hole"
            );
            if (this.player.hasVagina()) this.outputText("s");
            this.outputText(".");
    ...
    private redemption(hpVictory: boolean): void {
        ...
        if (hpVictory)
            this.outputText(
                " battered and beaten demon, once so full of haughty pride and self-assured in her power, fills you with a sense of pity."
            );
        else this.outputText(" horny, desperate demon before you fills you with a sense of pity.");
        this.outputText(
            " She’s defenseless now - the greatest of the demons has fallen at your hand, but to what end? What about all the other countless demons swarming the vast palace, and the world outside. Merely killing Lethice accomplishes precious little. Another will rise in her place, won’t they?"
        );
    ...
    private redemptionIIIGoName(input: HTMLInputElement): void {
        ...
        if (this.flags[kFLAGS.LETHICE_NAME] == "Lethice") {
            this.outputText(
                "You decide to tell her the truth - to give her back the name she bore as the Demon Queen. Trying to hide who and what she was from her - and from the world - will do you no good. The rest of the demons, and those who fight against them, deserve to see that there is hope. That even the Demon Queen could be made whole again."
            );
    ...
    private joinHer(): void {
        ...
        this.outputText(
            " and smile. Lethice cocks a bemused brow, crossing her legs and tracing her slender fingers around the rim of her Lethicite-filled goblet. None of her remaining minions move to stop you, allowing you to approach their queen, right to the foot of her throne."
        );
        ...
        if (
            this.flags[kFLAGS.DRIDERINCUBUS_KILLED] == 0 ||
            this.flags[kFLAGS.MINOTAURKING_KILLED] == 0
        )
            this.outputText(" humiliated");
        else this.outputText(" slain");
        this.outputText(
            " by your hand back to back. Compared to you, they were nothing. Pathetic, really. Are they the best the mighty demons have to offer?"
        );
    ...
    public won(hpVictory: boolean, pcCameWorms: boolean): void {
        ...
        if (!hpVictory) this.outputText(" by your own rampant sexual desires");
            ...
            this.outputText(
                " beneath the demoness’s merciless assault. She’s more powerful than you could have ever imagined, far more so than a wisp of a girl like her has any right to be"
            );
        ...
        if (hpVictory)
            this.outputText(
                " to hide just how turned on she’s left you... how close you are to orgasm, just in need of her lurid touch"
            );
        else
            this.outputText(
                " not to let her see how weak you are, how easy it really would be for her to kill you... or worse"
            );
        this.outputText(
            ". The Demon Queen just smiles all the wider as she turns from you, striding towards her throne. She stops after a few long-legged paces, casting a gaze over her shoulder to you. <i>“What are you waiting for, </i>dog<i>? Come along...”</i>"
        );
    ...
    private woofwoof(): void {
        ...
        this.outputText(
            " as your swollen knot is yanked from the dragon-girl’s hole. You tumble across the floor with a pathetic whine, drooling spunk from your twitching member. Your beloved Mistress gives you a disapproving scowl as you recover."
        );
        ...
        if (this.player.findStatusAffect(StatusAffects.DungeonShutDown) >= 0)
            this.outputText(
                "Your predecessor destroyed our welcoming facility. Otherwise I’m sure a certain imp would have revealed the truth to you long ago, before joining you with our breeding machines."
            );
        else {
            this.outputText(
                "How did you escape from the factory, I wonder? And so clean and pure, too... you’re belly’s not yet swollen with imps, and your breasts are so small. Did you slip through"
            );
    ...
    private woofwoofII(): void {
        ...
        this.outputText(
            "You bark excitedly, ready to be your loving, forgiving mistress’s means of meeting out punishment. The Champion’s eyes turn to you, and her jaw drops like an anchor."
        );
    ...
    private goHomeJustice(): void {
        ...
        if (this.getGame().camp.companionsCount() > 0)
            this.outputText(
                " to say nothing of " + this.player.mf("his", "her") + " bizarre friends"
            );
        this.outputText(
    ...
    private claimFortress(): void {
        this.clearOutput();
        this.outputText(
            "This fortress would be a fitting seat to your power. But the question remains, what would you do from such a fortress? You could gather the pure forces of the land together into one army, and from here purge the demon’s corrupted taint from the land, or you could set yourself up in Lethice’s place. Many demons could be turned to serve you, now that you think about it. Surely you could rule better than she!"
        );
    ...
    private hasChildren(): boolean {
        ...
        if (this.flags[kFLAGS.KELLY_KIDS_MALE] > 0 || this.flags[kFLAGS.KELLY_KIDS] > 0)
            return true;
    ...
    private purgeShit(): void {
        ...
        if (levelOfFuckedness <= 50) {
            ...
            if (this.player.findStatusAffect(StatusAffects.FactoryOverload) < 0)
                this.outputText(
                    " Marae reclaimed the full network of her roots and single-handedly purged the last holdouts of corruption from the lands, choking it out of her world like weeds from a garden."
                );
            else
                this.outputText(
                    " Marae fought for a time, but even corrupted goddesses cannot hold back your tide of purity. Her fall was the biggest blight on your campaign, a sad footnote on an otherwise successful reclamation."
                );
            ...
            if (this.player.findStatusAffect(StatusAffects.FactoryOverload) < 0)
                this.outputText(
                    "Marae is a wonderful aid in your quest, always able to manifest in her newly purified roots and offer words of wisdom or encouragement. Her magical might is a rock you can lean upon when times are tough. You aren’t sure how long you could keep this up without her."
                );
            else
                this.outputText(
                    "Marae is always there, always lending her power to the demons, even when you dig her roots out of the ground with shovels and axes, burning the greasy lumber into nothingness. This task would be so much easier if the goddess was on your side, but still, you persevere."
                );
            this.outputText(
            ...
            if (this.player.findStatusAffect(StatusAffects.FactoryOverload) < 0)
                this.outputText(
                    " Those few pockets that escaped your armies could not escape Marae’s all-encompassing roots. Mareth is purified once more."
                );
            else
                this.outputText(
                    " A few places are tainted still, but it’s impossible to cleanse every cave. Instead, you make instructions to maintain the army. Should evidence of corruption arise anywhere, your forces will swiftly put it to flame."
                );
    ...
    private conquer(): void {
        ...
        if (this.player.cor <= 33) {
            this.outputText(
                "You could definitely run this place better than Lethice, and though she had many corrupted lieutenants, surely their worst depredations could be reigned in by your steady hand. You"
            );
            if (this.getGame().camp.companionsCount() > 0) {
            ...
            if (this.flags[kFLAGS.LETHICE_KILLED] == 0)
                this.outputText(
                    " Lethice herself is even brought back, though this time securely leashed and empty-eyed."
                );
            this.outputText(
                " You order the worst of their factories shut down and put an end to attempts to locate Tel’Adre. No more will the demons be all-consuming force."
            );
            this.outputText(
            ...
            this.outputText(
                "Lethice truly didn’t know what she was doing. She had one of the mightiest armies Mareth had ever seen at her beck and call. Her scientists and magicians worked never-before-seen wonders at her behest. The technology on display in one of her factories alone could advance the civilizations of the realm by decades. Yet she squandered it all on pointless armies and perverse devices with little practical use."
            );
            this.outputText(
            ...
            this.outputText(
                "For all her might, Lethice had no idea what she was doing. She subsumed herself in corruption to no effect, washing away her reason in order to consistently and constantly overindulge in pleasure."
            );
            this.outputText(
            ...
            this.outputText(
                ". With Lethice’s rule broken, there’s no danger of a demonic invasion of your homeland, and you’ll have any surviving rogues in hand soon enough."
            );
            this.outputText(
