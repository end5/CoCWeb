...
export class LethiceScenes extends BaseContent {
    ...
    private plowHer(): void {
        ...
        this.outx("\n\nYou");
        if (!this.player.isNaga()) this.outx(" step");
        ...
        if (this.player.cocks.length == 1) this.outx(" [cock]");
    ...
    private plowHerDouble(): void {
        ...
        if (this.player.cocks.length == 2) this.outx(" other");
        else this.outx(" next");
        this.outx(
    ...
    private queenHer(): void {
        ...
        this.outx(" forward, pulling your [armor] off as you loom over the defeated demoness.");
        ...
        if (this.player.biggestTitSize() >= 2) this.outx(" cupping a tit");
        else this.outx(" pinching one of your nipples");
        this.outx(
        ...
        if (this.player.isBiped()) this.outx(" to your feet");
        else this.outx(" off");
        this.outx(
    ...
    private boobPlay(hpVictory: boolean): void {
        ...
        this.outx("So this is the great and powerful Demon Queen, brought low");
        if (!hpVictory) this.outx(" by your superior sexual acumen");
        else this.outx(" by the might of your [weapon]");
        this.outx(
        ...
        if (this.player.cor >= 66) this.outx(" throw her roughly onto her back");
        else this.outx(" push her onto her back");
        this.outx(
        ...
        if (this.player.hasCock()) this.outx(" They’re easily big enough to fuck now!");
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.cor >= 66) this.outx(" any other corrupted soul of her court");
            else this.outx(" like you’re some kind of demon yourself");
            this.outx(" is maddening!");
            ...
            if (this.player.hasVagina()) {
                ...
                if (!this.player.isNaga()) this.outx(" a leg");
                else this.outx(" your coils");
                this.outx(
            ...
            if (this.player.cor >= 66) this.outx(" You’re finally where you belong!");
            else
                this.outx(
            ...
            if (this.player.hasVagina()) this.outx(" holes");
            else this.outx(" ass");
            this.outx(" from the Demon Queen’s swollen breast");
            if (this.player.hasVagina()) this.outx("s");
            this.outx(
    ...
    private redemptionII(): void {
        ...
        this.outx("<b>A day of travel later...</b>");
        ...
        if (this.player.isBiped()) this.outx(" kneeling");
        else this.outx(" leaning");
        this.outx(
        ...
        this.outx("\n\nWarily, you");
        if (this.player.weapon == WeaponLib.FISTS) this.outx(" flip a knife out of your pack");
        else this.outx(" take your [weapon]");
        this.outx(
    ...
    private redemptionIII(): void {
        ...
        this.outx("What name do you give the new woman you and Marae have made?");
    ...
    private joinHer(): void {
        ...
        this.outx("Stepping towards the infamous Demon Queen, you");
        if (this.player.weapon == WeaponLib.FISTS) this.outx(" raise your empty hands");
        else this.outx(" set aside your [weapon]");
        this.outx(
        ...
        if (
            ...
            this.outx(" humiliated");
        else this.outx(" slain");
        this.outx(
        ...
        if (
            ...
            this.outx(" Carved a bloody swathe");
        else this.outx(" Fucked your way");
        this.outx(" through my keep. And all this to... what? Become my new bodyguard?”</i>");
    ...
    private joinHerII(): void {
        ...
        this.outx("<b>Time passes in Mareth...</b>");
    ...
    public won(hpVictory: boolean, pcCameWorms: boolean): void {
        ...
        if (!hpVictory) this.outx(" by your own rampant sexual desires");
        else
            this.outx(
        ...
        this.outx(". Gasping, you slump");
        if (!this.player.isBiped()) this.outx(" down");
        else this.outx(" to your knees");
        this.outx(",");
        if (this.player.weapon != WeaponLib.FISTS)
            this.outx(" your [weapon] clattering away across the stone");
        else this.outx(" too weak to even ball your fists");
    ...
    private woofwoof(): void {
        ...
        if (this.player.dogCocks() == 0) this.outx(" newly-grown doggy cock");
        else this.outx(" thick, throbbing dog-member");
        this.outx(
    ...
    private purgeShit(): void {
        ...
        this.outx("You gather an army of friends, companions");
        if (this.hasChildren()) this.outx(", offspring");
        this.outx(
        ...
        if (levelOfFuckedness <= 50) {
            ...
            this.outx(" Peace returns to the land. You did it. You saved this world.");
            this.outx(
    ...
    private conquer(): void {
        ...
        if (this.player.cor <= 33) {
            ...
            if (this.getGame().camp.companionsCount() > 0) {
                this.outx(" gather your follower");
                if (this.getGame().camp.companionsCount() > 1) this.outx("s");
                this.outx(" in the citadel itself and");
            }
            this.outx(
            ...
            if (this.getGame().camp.companionsCount() > 0) this.outx("your followers from");
            this.outx(
