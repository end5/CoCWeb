...
export class DopplegangerScenes extends BaseContent {
    public getDemGlasses(): void {
        ...
        this.startCombat(new Doppleganger());
    }

    public punchYourselfInTheBalls(): void {
        this.flags[kFLAGS.D3_DOPPLEGANGER_DEFEATED] = 1;
        this.player.createKeyItem("Laybans", 0, 0, 0, 0);

        this.clearOutput();
        this.outputText(
            "The doppelganger falls to the floor, sobbing and broken. For one long moment you feel the nagging pull to exactly replicate [his] actions... and then it’s gone. The world comes back sharply into focus. You have won."
        );
    ...
    public fuckYourself(): void {
        ...
        if (this.player.cocks.length >= 1 && !this.player.hasVagina()) {
            this.outputText(
            ...
            if (this.player.isNaga())
                ...
                this.outputText(
                    "  You clamber on top of him, the rough mingling of your fur sparking deep urges within you, your animal half dreaming of frenzied, bestial mating in the wild. Your hardening dick presses against his [tail] and he groans raggedly in response."
                );
            else
                this.outputText(
            ...
            if (this.player.ass.analWetness > 3)
                this.outputText(
                    "  No problem for a clone of you, though. You sigh as you push your bulging head against his rose, easily opening him and pushing deep into his oily, pliable depths."
                );
            else
                this.outputText(
                    "  Well, tough. He is a demon, after all. You sigh as you push your bulging head against his rose, slowly working it loose with the repetitive, pleasurable motion until he finally relaxes enough for you to push into his warm, tight depths."
                );
            ...
            if (
                this.player.findPerk(PerkLib.Buttslut) >= 0 ||
                this.player.findPerk(PerkLib.MaraesGiftButtslut) >= 0
            )
                this.outputText(
                    "  You glory in your own decision to transform into an eager butt slut; the doppelganger’s back passage is tight, warm butter, accepting and clenching around your bulging prick like the perfect little boypussy you know it to be."
                );
            this.outputText(
                "  Now that you’re locked into your defeated clone you feel no real wish to cause him pain. Indeed, as you lose yourself to the rhythm to the slow, tight, gradual sex a desire to force him to feel pleasure grows. Where is the fun in seeing your mirror image suffer, after all?"
            );
            ...
            if (this.player.cumQ() >= 1000)
                ...
                this.outputText(
                    "  You ride your high, pumping his guts full of your warm seed as you force him along with you, guttering jizz on the floor in front of you."
                );
            ...
            if (this.player.isDrider())
                this.outputText(
                    "  For a moment you consider mounting her from behind, allowing your monstrous instincts to take over and fuck her ovipositor in a deathly arachnid craze, but the tangle of spindly legs in front of you puts you off. Better to do it face-to-face. You want to drink in your mirror image’s every reaction. Your prick pressing against the human softness which rises above her gleaming chitin as your body presses heavily down onto its mirror counterpart, making her groan raggedly."
                );
            if (this.player.skinType == SKIN_TYPE_FUR)
                this.outputText(
                    "  You clamber on top of her, the rough mingling of your fur sparking deep urges within you, your animal half dreaming of frenzied, bestial mating in the wild. Your dick presses into her digitigrade thigh and she groans raggedly in response."
                );
            else
                this.outputText(
            ...
            this.outputText(" batting back into her stomach as you expose her [vagina], ");
            if (this.player.averageVaginalWetness() < 3) this.outputText(" gleaming invitingly");
            else this.outputText(" drooling lubricant eagerly");
            this.outputText(
                "- as you knew it would be. You glory in your decision to transform yourself so that you could enjoy the best of both genders. If this isn’t clear vindication of being a hermaphrodite, what is? Your doppelganger wriggles and whines but can’t resist as you push your bulging head against her pussy, slowly pushing her oily lips wide and into her warm, tight depths."
            );
            ...
            if (this.player.cumQ() >= 1000)
                ...
                this.outputText(
                    "  You ride your high, pumping her full of your warm seed as you force her along with you, guttering jizz on the floor in front of you."
                );
            ...
            this.outputText(
                " - as you knew it would be. Your doppelganger wriggles and whines but can’t resist as you push your pussy into hers, the mirrored sex meeting with a pleasingly wet sound."
            );
            ...
            if (this.player.thickness > 75 || this.player.tone < 25)
                this.outputText(
                    " sending your shared jiggly flesh rippling in separate directions"
                );
            else this.outputText(" your shared, muscled flesh barely moving");
            this.outputText(
                " as you push your clit into her wet opening, making her cry out with that same delicious cadence as she closes her eyes. There is an ominous snap behind you as more cracks thread themselves over the mirror’s surface."
            );
            ...
            if (this.player.cumQ() > 1000)
                ...
                this.outputText(
                    "  You ride your high, shared female delirium wetting your thighs as you force her to ride her high locked deep into you."
                );
    ...
    public inSovietCoCSelfFucksYou(): void {
        ...
        if (this.player.hasCock())
            this.outputText(", the way your turgid [cock] feels when you grasp it at the base.");
        else if (this.player.hasVagina())
            this.outputText(
                ", the way your [vagina] feels when you slide your fingers along its lips."
            );
        else {
            this.outputText(", the way your");
            this.player.createVagina();
            this.outputText(
                " [vagina] feels when you slide your fingers against your... Wait, where did that come from? You push your fingers in more forcefully, determined to see through this illusion, but all you manage to do is arouse yourself beyond all reasonable measure. Somehow, <b>you've grown a tight, wet pussy to match your duplicate's!</b>"
            );
        }
        if (this.player.hasCock() && !this.player.hasVagina()) {
            ...
            if (this.player.cocks.length > 1)
                this.outputText(
                    "  Your other cocks deliriously tighten and spurt their own loads at the same time, an uncontrollable storm of a high."
                );
        } else if (this.player.hasCock() && this.player.hasVagina()) {
            this.outputText(
