...
export class DopplegangerScenes extends BaseContent {
    ...
    public fuckYourself(): void {
        this.clearOutput();
        this.outx("This, you feel, is an opportunity which is not likely to arise again.");

        if (this.player.hasVirginVagina())
            this.outx(
                "  You smile widely at your clone as you undress. Now neither of you will be virgins."
            );
        else this.outx("  You smile widely at your clone as you begin to shake off your [armor].");
        this.outx(
        ...
        if (this.player.cocks.length >= 1 && !this.player.hasVagina()) {
            ...
            this.outx(" batting back into her stomach as you expose her [vagina], ");
            if (this.player.averageVaginalWetness() < 3) this.outx(" gleaming invitingly");
            else this.outx(" drooling lubricant eagerly");
            this.outx(
            ...
            if (this.player.thickness > 75 || this.player.tone < 25)
                this.outx(" sending your shared jiggly flesh rippling in separate directions");
            else this.outx(" your shared, muscled flesh barely moving");
            this.outx(
    ...
    public inSovietCoCSelfFucksYou(): void {
        ...
        if (this.player.hasCock())
            this.outx(", the way your turgid [cock] feels when you grasp it at the base.");
        else if (this.player.hasVagina())
            this.outx(", the way your [vagina] feels when you slide your fingers along its lips.");
        else {
            this.outx(", the way your");
            this.player.createVagina();
            this.outx(
