...
export class IncubusMechanicScenes extends BaseContent {
    ...
    public meetAtElevator(): void {
        if (this.flags[kFLAGS.D3_MECHANIC_LAST_GREET] == this.MECHNIC_NO_SELECTION) {
            this.outx("\n\nA");
            if (this.metIncubusMechanicInD1()) this.outx(" familiar,");
            this.outx(" demonic mechanic lounges against a gleaming, metallic control panel");
            ...
            this.outx("\n\n");
            if (this.metIncubusMechanicInD1()) this.outx('"<i>Once more, you bumble');
            else this.outx("\"<i>You've bumbled");
            this.outx(
    ...
    public suckIncubusDick(): void {
        ...
        if (this.player.hasVagina()) {
            this.outx(" You find your crotch becoming");
            if (this.player.wetness() <= 2) this.outx(" even more soaked than normal");
            else if (this.player.wetness() <= 4) this.outx(" wet with fresh lust");
            else this.outx(" sticky with lust");
            this.outx(" at his masculine scent and appearance.");
    ...
    public beatDaMechanic(hpVictory: boolean): void {
        ...
        this.clearOutput();
        this.outx("The mechanic collapses, his overalls");
        if (hpVictory) this.outx(" falling off his prone from, shredded.");
        else
            this.outx(
    ...
    private letMechanicGo(hpVictory: boolean): void {
        ...
        this.outx("\n\nThe incubus");
        if (hpVictory) this.outx(" slowly struggles to his feet");
        else this.outx(" reluctantly stops masturbating");
        this.outx(
    ...
    private buttfuckTheMechanic(hpVictory: boolean): void {
        ...
        if (!hpVictory) this.outx(" throbbing hard");
        else this.outx(" gently bobbing");
        this.outx(
        ...
        if (this.player.cocks.length > 1) this.outx(" one");
        else this.outx(" it");
        this.outx(" in hand, pumping slowly as you eye your tainted prey. He whimpers");
        if (hpVictory) this.outx(" in need, and");
        else this.outx(", but");
        this.outx(
        ...
        if (this.player.cumQ() <= 250) {
            this.outx("\n\nYou pull");
            if (this.player.hasKnot(x)) this.outx(", popping your knot");
            this.outx(
        ...
        // Huge cum
            ...
            if (this.player.cumQ() <= 5000) this.outx(" pudgy");
            else if (this.player.cumQ() <= 10000) this.outx(" swollen");
            else this.outx(" absolutely gravid");
            this.outx(
    ...
    private rideMechanicsCock(): void {
        ...
        if (this.player.tailType != 0) this.outx(", tail draped across his face");
        this.outx(
    ...
    private rideMechanicsCockII(cType: number): void {
        ...
        if (pCuntArea >= mCockArea * 1.5) {
            ...
            if (cType == this.MECHANIC_HORZ_GOG)
                ...
                this.outx(", your lips slurping noisily about his knot");
            this.outx(".");
        }
        ...
        if (this.player.findStatusAffect(StatusAffects.IncubusBribed) >= 0)
            this.outx(" Nothing but hentai mags for you to drain your balls with....");
        this.outx('</i>"');
        ...
        this.outx(" His only reaction is to gasp and groan, balls lurching in his sack.");
        ...
        if (cType == this.MECHANIC_HORZ_GOG)
            this.outx(", the head flaring to seal itself against your cervix");
        else if (cType == this.MECHANIC_DOG_COCK)
            this.outx(", the knot popping in just in time to start bloating, locking you in place");
        this.outx(", and jism begins to shoot out in waves.");
        if (!this.player.isPregnant()) {
            this.outx(" Your empty womb drinks up the virile, seed-filled sludge with abandon.");
            if (cType == this.MECHANIC_HORZ_GOG)
                this.outx(
            ...
            if (cType != this.MECHANIC_DOG_COCK)
                this.outx(" and drip out over his balls, much to his chagrin.");
            else this.outx(" and stretch you further.");
        }
        ...
        if (!this.player.isPregnant()) this.outx(" insemination");
        else this.outx(" tryst");
        this.outx(".");
    ...
    private errybodyelseLossToMechanic(hpVictory: boolean): void {
        ...
        // Genderless HP Loss
            ...
            if (this.player.hasFuckableNipples())
                ...
                this.outx(" pinching and tugging on");
                ...
                else this.outx("your [nipples] one after another");
            }
            this.outx(
        ...
        if (this.player.isNaga()) this.outx("r coils don't get sore");
        else if (!this.player.isBiped()) this.outx(" don't even need to support yourself anymore");
        else this.outx(" knees don't get sore");
        this.outx(
        ...
        if (this.player.clitLength > 5) this.outx(", even if that makes it truly monstrous indeed");
        this.outx(
