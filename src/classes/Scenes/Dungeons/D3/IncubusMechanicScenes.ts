...
export class IncubusMechanicScenes extends BaseContent {
    ...
    private useLiftPostDefeat(): void {
        this.clearOutput();
        this.outputText(
            "You spend a minute or two fiddling with the lift controls, trying to understand how, exactly, to control the contraption. When you think you've got a handle on the system, you tug on a lever with authority and hastily step onto the platform."
        );
        this.outputText(
    ...
    public suckIncubusDick(): void {
        ...
        if (this.player.gems < 500)
            this.outputText(
                'You spare a glance to your depleted pouches and admit, "<i>I guess I\'ll suck your dick then.</i>"'
            );
        else
            this.outputText(
                'You shrug and smile. "<i>I guess now is as good a time as any to suck some dick, huh?</i>"'
            );
        ...
        if (this.player.hasVagina()) {
            ...
            this.outputText(
                " You feel a heady, turgid warmth growing in your own crotch, mirroring the ardor displayed by the cock you're about to service."
            );
        }
        this.outputText(
            " A patch of neatly trimmed pubic hairs lead up his abdomen to a set well-defined muscles, half-hidden under his loose not-so-coveralls."
        );
    ...
    public beatDaMechanic(hpVictory: boolean): void {
        ...
        if (hpVictory) this.outputText(" falling off his prone from, shredded.");
            ...
            this.outputText(
                " hanging open as he reaches down for his exposed, dangling cock to wildly masturbate."
            );
        this.outputText(
            " He seems surprisingly human like that, just as mortal as anyone. You could let him go, play with him some, or cleanse the world of another demon."
        );
    ...
    private killMechanic(): void {
        ...
        this.clearOutput();
        this.outputText(
            "He proves blessedly easy to kill, and you roll the body off the cliffs to avoid alerting any of Lethice's other ilk."
        );
    ...
    private letMechanicGo(hpVictory: boolean): void {
        ...
        this.outputText(
            ', nodding. His skin cracks as two leathery wings unfurl. <i>"If that\'s how it has to be.... For what it\'s worth, I hope you win. Lethice is a bitch."</i> Slowly walking towards the cliff, he beats his wings and lifts off the ground. "<i>Come visit me sometime. Maybe I can show you a good time as thanks.</i>"'
        );
    ...
    private buttfuckTheMechanic(hpVictory: boolean): void {
        ...
        this.outputText(
            " dick, but you've got a better idea. You got more than one look at the curvature of his butt while you were fighting, tempting your burgeoning bulge to the point of distraction. You hastily remove your [armor] and smile. [EachCock] springs up, full and hard. You take"
        );
        ...
        this.outputText(
            " his cock seems to get even bigger and harder. The poor guy doesn't realize what a reaming he's in for."
        );
        ...
        // Huge cum
            ...
            if (this.player.hasKnot(x)) this.outputText(", popping your knot");
            this.outputText(
                " out after depositing a massive, belly-bulging load directly into the demon's guts. A tidal wave of goo bursts out of his over-pressurized asshole to fall on the ground, and as it dies off, small rivers of ivory spunk escape the lake in his ass to run down his balls and cock. His belly is"
            );
            ...
            this.outputText(
                " with the distended weight of the cum packing his body. From time to time, fresh streamers of sperm squirt out of his thoroughly cream-pied backdoor."
            );
        }
    ...
    private rideMechanicsCockII(cType: number): void {
        ...
        if (this.player.wetness() <= 2)
            this.outputText(
                ", letting your free-flowing pussyjuice wash over it, lubricating it with your glorious girlcum"
            );
        else if (this.player.wetness() <= 3)
            this.outputText(
                ", letting your oh-so-juicy vagina drip and dribble, soaking it with your copious girlcum"
            );
        ...
        if (this.player.clitLength >= 5)
            this.outputText(
                " You grab hold of it in your hand and start to stroke it to the tempo your rising and falling body is setting, pumping the oversensitive organ like a dick. Every stroke sends your walls into fits of fluttering ecstasy. It feels so good that you don't think you'll be able to stop until you're cumming and gushing all over your demonic lover."
            );
        else
            this.outputText(
                " You thumb at it, rubbing in slow circles around it. Sometimes you push on its hood. Other times you oh-so-gently squeeze at it. It feels so good that the touches drive you crazy with ecstasy, and your walls flutter excitedly around your demonic lover."
            );
        ...
        if (cType == this.MECHANIC_HORZ_GOG)
            ...
            this.outputText(
                ", the knot popping in just in time to start bloating, locking you in place"
            );
        this.outputText(", and jism begins to shoot out in waves.");
        if (!this.player.isPregnant()) {
            this.outputText(
                " Your empty womb drinks up the virile, seed-filled sludge with abandon."
            );
            if (cType == this.MECHANIC_HORZ_GOG)
                this.outputText(
                    " After all, that bestial horse-cock doesn't really leave it anywhere else to go. The demonic animal-cunt just continues spurting straight on in to have its way with your eggs, and you're sure there isn't a contraceptive this side of Mareth that could stop you from having his imps."
                );
            else if (cType == this.MECHANIC_DOG_COCK)
                this.outputText(
                    " After all, that immense knot doesn't really leave it anywhere else to go. Once every fold is bathed in alabaster doggie-cream, the continued ejaculations start pouring in after your eggs. His knot is so big and stretching you so wide; you don't think he would pop out even if he filled your belly to look nine months pregnant. Worse, or perhaps better, you're sure with how thick and virile his seed feels that you'll be getting pregnant with his imps from this."
                );
            this.player.knockUp(PregnancyStore.PREGNANCY_IMP, PregnancyStore.INCUBATION_IMP);
        } else {
            this.outputText(
                " Your blocked womb deflects the seed, forcing it all to stay in your channel"
            );
        ...
        this.outputText(
            ". The pleasure is so great that you can feel electric impulses arcing between neurons, short-circuiting your throughs into involuntary ecstasy. Your eyes roll back, and your [hips] twitch and shake, vibrating around the object that brough you to this perfect"
        );
    ...
    private maleLossToMechanic(hpVictory: boolean): void {
        ...
        if (this.player.cocks.length > 1) {
            ...
            if (!allDemon)
                this.outputText(
                    " The skin of your transforming length is darkening to a purplish hue, and in the wake of the magical cock-ring, nodules are slowly emerging, growing into an imitation of the cock you're still suckling."
                );
            this.outputText(
    ...
    private maleLossToMechanicII(): void {
        this.clearOutput();
        this.outputText(
            "An agonizingly perfect pussy is suddenly pressing down on your cock, subsuming it in slick, hot depths that cling and squeeze with undulations so skillful you'd be cumming already if it weren't for the magic ring."
        );
    ...
    private errybodyelseLossToMechanic(hpVictory: boolean): void {
        ...
        // Genderless HP Loss
            ...
            if (this.player.hasFuckableNipples())
                this.outputText(
                    " slipping inside a [nipple] to thrust just like your other hand. You work your upper and lower pussies like a woman possessed."
                );
            else {
                this.outputText(" pinching and tugging on");
                if (this.player.totalNipples() > this.player.totalBreasts())
                    this.outputText(
                        " nipple after nipple, your myriad breastly endowments providing you with oh so many buttons to tend to"
                    );
                else this.outputText("your [nipples] one after another");
            }
            this.outputText(
                " Alas, all good things must come to an end, and your lovely, lovely little lollipop is rudely pulled from your questing lips with a noisy pop."
            );
        ...
        this.outputText(
            ". How wonderful! If you move just right, you can make the whole contraption sway slightly to get a proper dick-sucking rhythm going. His pearly pre-cream oozes onto your tongue, and you swallow as much of it as you can."
        );
        ...
        this.outputText(
            ". It drips long, sticky strands of girlish lust as you swallow, only becoming more soaked as time passes as your body becomes even more productive. A plaintive whimper escapes around the edges of your phallic gag, but your cry falls on deaf ears. The incubus is too busy fitting pipes together beneath you to care."
        );
