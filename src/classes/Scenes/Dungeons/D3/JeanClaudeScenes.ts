...
export class JeanClaudeScenes extends BaseContent {
    ...
    public gogoFuckTheseBasilisks(): void {
        ...
        this.outx("You breathe deep, steel yourself");
        if (this.player.hasKeyItem("Laybans") >= 0) this.outx(", put your shades on");
        this.outx(
        ...
        if (this.player.demonScore() > 4)
            this.outx("  You can’t be mistaken for anything but a demon, after all.");
        this.outx(
        ...
        if (this.player.hasKeyItem("Laybans") < 0) {
            ...
            if (this.player.spe < 90) {
                ...
                if (!this.player.canFly()) this.outx(" almost");
                else this.outx(" literally");
                this.outx(
    ...
    public capturedByBasilisks(): void {
        ...
        if (this.player.hasCock()) this.outx(" [eachCock] stiffening");
        if (this.player.hasCock() && this.player.hasVagina()) this.outx(" and");
        if (this.player.hasVagina()) this.outx(" your [vagina] beading with excitement");
        if (!this.player.hasCock() && !this.player.hasVagina())
            this.outx(" your loins aflame with excitement");
        this.outx(
    ...
    private regularBadEnd(): void {
        ...
        if (this.player.hasVagina()) this.outx(" your [vagina] beads with excitement");
        if (this.player.hasCock() && this.player.hasVagina()) this.outx(" and");
        if (this.player.hasCock()) this.outx(" [eachCock] hardens");
        if (this.player.hasCock() || this.player.hasVagina()) this.outx(" as");
        this.outx(
        ...
        if (
            ...
            if (this.player.skinType == SKIN_TYPE_FUR)
                this.outx("  Your fur drops away in ragged clumps as you drink.");
            this.outx(
        ...
        if (this.player.hasVagina()) this.outx(" your [vagina] dribbling excitement");
        if (this.player.hasVagina() && this.player.hasCock()) this.outx(" and");
        if (this.player.hasCock()) this.outx(" your [cock] straining helplessly");
        this.outx(
        ...
        this.outx(" push roughly against your [asshole]");
    ...
    private bwombBadEnd(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.RemovedArmor) >= 0) {
            ...
            if (this.player.isBiped()) this.outx(" spread your [hips]");
            else this.outx(" position yourself");
            this.outx(" for him, your breeder’s body aching to be taken.");
        } else {
            this.outx(
