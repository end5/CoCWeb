...
export class DriderIncubusScenes extends BaseContent {
    ...
    public spooderbuttGetsANewCockSleeveIII(): void {
        ...
        if (this.player.cor >= 50) this.outputText(", you’ve let yourself become corrupted");
            ...
            this.outputText(
                ", you’ve been sorely tempted by the rampant corruption of these lands"
            );
        this.outputText(".");
        if (this.player.findStatusAffect(StatusAffects.FactoryOverload) >= 0)
            this.outputText(
                " You couldn’t even save one of the last pure spirits in this place, Marae."
            );
    ...
    public buttfuckDrider(): void {
        ...
        if (this.player.cor > 75)
            this.outputText(
                " <i>“Watch closely - this is what </i>you<i>’re in for, too, bitch!”</i>"
            );
