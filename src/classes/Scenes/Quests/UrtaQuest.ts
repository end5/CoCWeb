...
export class UrtaQuest extends NPCAwareContent {
    ...
    public urtaBusy(): boolean {
        return (
            this.telAdre.edryn.pregnancy.type == PregnancyStore.PREGNANCY_TAOTH ||
    ...
    private comfortUrtaAfterFamFamTalk(): void {
        ...
        this.outputText(
            'kiss on your lips as she hugs you tight - tight enough that you feel every vein through the concealing silk of her outfit.  "<i>I\'m a lucky girl.</i>"'
        );
    ...
    public infertilityQuestions(): void {
        this.clearOutput();
        this.outputText(
            "You ask her about her infertility - specifically, how someone could be infertile AND unable to use transformative items without adverse effects.  Urta stirs her drink before shrugging noncommittally."
        );
        this.outputText(
        ...
        if (this.player.cor < 33)
            this.outputText(
                "you have nothing to complain about there.  Your sexual romps with Urta are always a delight."
            );
        else if (this.player.cor < 66)
            this.outputText("she's definitely a handful in the sack, you've got to give her that.");
        else
            this.outputText(
                "she's a willing fuck, so no complaints there.  Now if she would just get on with it - if you wanted to flirt, you would've instigated it."
            );
        this.outputText(
    ...
    private leaveB4HelFucksUrta(): void {
        this.clearOutput();
        this.outputText(
            "As quickly as you can, you blather out some excuse and grab your gear, trying to cover your huge erection as you run toward the door, blurting an awkward thanks over your shoulder for the drink..."
        );
        this.outputText(
    ...
    private visitPCPreUrtaQuest(truth: boolean): void {
        ...
        if (
            ...
            this.outputText(
                "You easily sneak past a mouse monk.  He's looking towards the sky mostly, perhaps watching for imps.  "
            );
        ...
        if (
            ...
            this.outputText(
                "A dangling tentacle nearly hits you in the dark.  You roll aside at the last moment, looking up to see dozens of the things idly dangling around.  When did this camp get such a corrupt tree in it?  You suppose it must have its uses in defending against foes from the sky...  "
            );
    ...
    private urtaPutsHerDickInPCsWithDicks(truth: boolean): void {
        ...
        if (this.player2.tallness < 60)
            ...
            this.outputText(
                " and let your tits sway over " + this.player2.mf("his", "her") + " belly"
            );
        this.outputText(
            ", giving " +
                this.player2.mf("him", "her") +
        ...
        if (this.player2.cumQ() >= 500) {
            ...
            this.outputText(
                " mess - only now do you realize just how much your lover could produce!  The"
            );
    ...
    private putAPCDickInUrtaCoochies(truth: boolean): void {
        ...
        if (this.player2.isTaur() || this.player2.isDrider()) {
            ...
            if (this.player2.hasVagina())
                this.outputText(
                    ", her female jizz spattering unnoticed onto the ground behind the pair of you"
                );
            this.outputText(".");
        ...
        //Else:
            ...
            if (this.player2.hasVagina())
                this.outputText(
                    ", her female jizz spattering unnoticed onto the ground beneath the pair of you"
                );
            this.outputText(".");
    ...
    private putUrtasWangInPCsCunt(truth: boolean): void {
        ...
        this.outputText(
            "pulsing interior.  The sight is exciting in the extreme, immediately sending your heartbeat through the roof.  Your tremendous horse-cock is immediately stiffened by your ardor, along with your coal-black nipples, and your armor-plated skirt begins to rise, as if by magic."
        );
        ...
        this.outputText(
            ".  The attentions drive your attempts to dislodge the offending garments from your lusty frame to new levels.  Metal rivets slowly give before finally snapping apart to free your left shoulder.  Your left nipple tingles with pleasant, palpable relief, and you turn to the other side, intent on ripping it off, so that you can be with your lover, skin to skin."
        );
        ...
        if (this.player2.isTaur()) {
            ...
            this.outputText(
                ", making sure you've got the perfect view of her lube-slimed horse-cunt.  Unbidden, your cock thickens, disgorging a potent trail of animal-pre down its underside in anticipation."
            );
            if (this.player2.wetness() >= 4)
                this.outputText(
                    "  Fuck, she's wetter than Edryn!  Just look at those heavy trails of slick moisture as they run down her rump and hindlegs."
                );
            else if (this.player2.wetness() >= 2)
                this.outputText(
                    "  Fuck, she's as wet as Edryn!  Beads of moisture are forming on her clit, ready to drop to the ground."
                );
            else
                this.outputText(
                    "  Fuck, she's almost as wet as Edryn!  Just getting a sniff of her horny horse-snatch has your head swimming!"
                );
            this.outputText(
                "  You give it a lick and shudder, taking in a few deep lungfuls of her scent."
            );
            if (this.player2.tallness >= 84)
                this.outputText(
                    "  Before you know what you're doing, you've pulled her back to a rock and climbed atop it, bringing your cock level with that heavenly hole."
                );
            else
                this.outputText(
        ...
        //{goo}
            ...
            if (this.player2.clitLength < 0.5) this.outputText("tiny ");
        ...
        //{nagas}
            ...
            if (this.player2.wetness() >= 3)
                this.outputText(
                    "  Her moisture drizzles from that wanton slit, basting you with her fragrant femininity, and you have a hard time not taking her here and now."
                );
            this.outputText(
        ...
        //{biped}
            ...
            this.outputText(
                ".  You sniff in great lungfuls of her, your head swimming with need, and before you know it, you've risen behind her, your oozing flare just inches from that delectable opening."
            );
        }
    ...
    private morningAfterCampVisitEmbark(truth: boolean): void {
        ...
        if (truth) {
            this.outputText(
                ' before you promise, "<i> I\'ll come back to you, stronger and ready for kids, I promise.</i>"\n\n'
            );
        } else {
            this.outputText(".  ");
        }
    ...
    public urtaSpecials(): void {
        ...
        if (
            ...
            this.player.statusAffectv2(StatusAffects.Sealed) == 5
        ) {
            this.clearOutput();
            this.outputText(
                "You try to ready a special attack, but wind up stumbling dizzily instead.  <b>Your ability to use physical special attacks was sealed, and now you've wasted a chance to attack!</b>\n\n"
            );
    ...
    private urtaSecondWind(): void {
        ...
        this.outputText(
            "Closing your eyes for a moment, you focus all of your willpower on pushing yourself to your absolute limits, forcing your lusts down and drawing on reserves of energy you didn't know you had!\n\n"
        );
        kGAMECLASS.enemyAI();
    }
    ...
    private urtaComboAttack(): void {
        ...
        if (
            ...
            (UrtaQuest.rand(3) == 0 ||
                ...
                (this.monster.spe - this.player.spe > 0 &&
                    Math.floor(Math.random() * ((this.monster.spe - this.player.spe) / 4 + 80)) >
                        80))
        ) {
        ...
        if (
            ...
            (this.player.findPerk(PerkLib.Tactician) >= 0 &&
                this.player.inte >= 50 &&
                (this.player.inte - 50) / 5 > UrtaQuest.rand(100))
        ) {
            crit = true;
            damage *= 2;
        }
    ...
    private urtaDirtKick(): void {
        ...
        if (UrtaQuest.rand(20) + 1 + this.monster.spe / 20 > 15 + this.player.spe / 20) {
            ...
            this.outputText(
                this.monster.mf("He", "She") + "'s already blinded.  What a waste.\n\n"
            );
        } else {
    ...
    private urtaSidewinder(): void {
        ...
        if (
            ...
            (this.monster.spe - this.player.spe > 0 &&
                Math.floor(Math.random() * ((this.monster.spe - this.player.spe) / 4 + 80)) > 80)
        ) {
            if (this.monster.spe - this.player.spe < 8)
                this.outputText(
                    this.monster.capitalA + this.monster.short + " narrowly avoids your attack!",
        ...
        if (
            ...
            this.monster.findPerk(PerkLib.Resolute) < 0 &&
            damage > 0
        ) {
    ...
    private leaveSiriusBehind(): void {
        this.clearOutput();
        this.outputText(
            "You decide that he's just not worth your time and leave to continue your journey."
        );
        this.menu();
    ...
    public winRapeHyenaPrincess(): void {
        ...
        if (this.monster.HP < 1)
            this.outputText(
                ".  In spite of her wounded state, she seems to be quite excited by the situation"
            );
        this.outputText(".");
    ...
    public useSuccubiMilkOnGnollPrincesses(): void {
        ...
        this.outputText(
            ".  As you start to pick up the pace, bucking your hips into the thick cushion of her rump, the gnoll princess starts mewling pathetically, panting and moaning like a little slut."
        );
    ...
    public loseToGnollPrincessAndGetGangBanged(): void {
        ...
        if (this.player.lust > 99) {
            this.outputText(
                'Sinking to your knees, utterly overwhelmed by lust, you gaze up the clit-cocked amazon, licking your chops. She responds by disdainfully pushing you down with one of her soft, padded paws.  "<i>Did you really think you could trespass in my mother\'s territory and go unpunished?</i>"'
            );
    ...
    private loseToGnollAsUrtaEpilogue(): void {
        ...
        this.outputText(
            "  There's a constant, loud thrum of many voices talking all at once that makes it hard to think, and when you finally come to focus in the dim lighting, you can see why.  There are dozens, if not hundreds, of gnolls here, assembled in the faint light of some kind of feast hall, most of them male."
        );
        ...
        if (this.player.HP >= 1)
            this.outputText(
                "You shudder at the memory of your meeting, leaking a little more lubricant.  "
            );
        this.outputText(
            "As if by magic, a knife appears in the gnoll princess' hand, and she swiftly lays into the bindings holding your feet.  With your feet free, you can flex your legs a little.  They ache from being immobile so long.  Just how long were you hanging there, anyway?  The gnoll princess - it bears to reason she can only be a princess, considering how she is dressed compared to the rest of the gnolls here - rises up on her paws to reach the leather around your arm.  Quickly, she slashes through both restraints.  There's a moment of panic when you begin to fall; you can't possibly catch yourself on your weakened legs.  The princess secures you easily as she discards the knife.  \"<i>Did you think I'd let my favorite piece of property get damaged?</i>\""
        );
    ...
    private loseToGnollAsUrtaEpilogueBAM(): void {
        this.clearOutput();
        this.outputText(
            "Ouch!  Something smacks your face, and it fucking hurts!  You look up, seeing a strong, spotted paw pulling away, trailing a web of spooge in its wake."
        );
    ...
    private introSuccubiAndMinotaur(): void {
        this.clearOutput();
        this.outputText(
            "After getting and departing your makeshift camp, the pendant begins to glow again.  It flickers dully, then goes dark.  Damn!  You turn and change direction, and thankfully, the light returns.  You can see forest ahead, and you advance, your path lit by the strengthening glow of Gul's magical amulet."
        );
        this.outputText(
    ...
    public urtaSubmitsToMinotaurBadEnd(): void {
        this.clearOutput();
        this.outputText(
            "You mouth opens, drooling with hunger that you know only the sexy beast across from you can sate."
        );
        if (this.monster.findStatusAffect(StatusAffects.MinotaurEntangled) >= 0)
            this.outputText(
                "   Seeing the fire in your eyes change from a determined glare to a lusty look, the minotaur pulls you over, carefully unwinding the chain from around you, so as not to damage you."
            );
        this.outputText(
            "  Your once foe removes his loincloth to fully expose the mammoth between his legs, three feet long and nearly twice as girthy as your own.  You're so dazed by his imposing manhood, that you totally miss him flinging his loincloth at you.  It smacks wetly into your face, smothering you in his syrupy spooge."
        );
        this.outputText(
    ...
    public beatMinoLordOnToSuccubi(): void {
        this.clearOutput();
        this.outputText(
            'The succubus claps slowly as she gets up from her perch on a ruined column.  "<i>I\'m impressed.</i>"  She says, stepping in the light as she walks towards you.  You gasp, this succubus looks like a cow!'
        );
        this.outputText(
    ...
    public milkyUrtaTic(): void {
        ...
        if (this.player.lust < 50)
            ...
            this.outputText(
                "You don't know how much longer you'll be able to withstand the effects of the milk."
            );
        else
            this.outputText(
                "Those orbs full of milky goodness are starting to look more attractive by the minute... if you don't finish this quickly you might end up giving up!"
            );
        this.outputText("\n\n");
        this.player.addStatusValue(StatusAffects.MilkyUrta, 1, -1);
        if (this.player.statusAffectv1(StatusAffects.MilkyUrta) <= 0)
            this.player.removeStatusAffect(StatusAffects.MilkyUrta);
        this.dynStats("lus", 10);
    }
    ...
    private fuckTheCowCubi(): void {
        this.clearOutput();
        this.outputText(
            '"<i>Come on girl, strip down so I can see what you\'re hiding under that leather skirt of yours.  Besides, we both know you want me, I can see that tent,</i>" she laughs, licking her lips seductively.'
        );
    ...
    public urtaLosesToCowCubi(): void {
        ...
        this.outputText(
            ".  Your own nipples have long since become fully engorged, taut black tit-caps, pebbly and sensitive.  They drag up and down the fat bottoms of the demoness's swollen underbust with every swallow and gasping breath you take."
        );
    ...
    private deadGodsDreaming(): void {
        this.clearOutput();
        this.outputText(
            'Your eyes spring open and you stare in dumbfounded shock at the statue as it starts to move, joints flexing with the awful sound of stone grating on stone.  Carved eyelids open to reveal flames of myriad colors, ever-shifting before your eyes.  "<i>Welcome, vessel.  It is time that we spoke.</i>"'
        );
    ...
    private knockUpUrtaWithGodChild(): void {
        ...
        if (this.player.cockTotal() > 1)
            this.outputText(
                ", the mess made worse by your multiple-cocked virility.  There's so much that the clear juices roll off you to either side, puddling in your blankets below"
            );
        ...
        if (this.player.hasFuckableNipples()) {
            ...
            this.outputText(
                "wet holes on your tits, drawing fresh gasps of delight from your overwhelmed brain"
            );
        } else
            this.outputText(
                ", shooting tingling excitement through your nubs as you grind against each other"
            );
        this.outputText(
        ...
        this.outputText(
            " tints off-white from your liquid, squirting out of her tunnel faster than ever when she climaxes with you"
        );
    ...
    private postFuckUrtaUp(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.DungeonShutDown) >= 0)
            this.outputText(
                " - besides, given you know that you're nothing but a sacrifice the demons are too lazy to collect, it's not like they'll really send an invasion through"
            );
        this.outputText(
            ".  Urta's joyous expression makes it quite clear that you chose the right choice.  The two of you gather your things, dress Urta in her clothes as best you can (adding a blanket for extra protection and modesty), "
        );
        if (this.camp.followersCount() >= 2)
            this.outputText(
                "leave instructions to your fellow camp-dwellers to look after the place, "
            );
        this.outputText(
            "and set off into the wasteland in the direction of Tel'Adre.  Urta needs to stop and rest on several occasions, weighed down by her sudden and highly advanced pregnancy, but she soldiers on without complaint, taking whatever support you give to her.  You can feel the strange god-child kicking incessantly inside her belly as you walk together."
        );
    ...
    private getKnockedUpWithGodChild(): void {
        ...
        this.outputText(
            'glistening interior.  Urta whines, high pitched and keening, and she doubles over, pumping her cock with both hands, unashamedly masturbating at the sight of your exposed, vulnerable womanhood.  She grunts, swinging her hips lewdly back and forth, actually fucking her hands now, mouth open and panting, "<i>Gonna... gonna fuck ya!  Fullofbabies!</i>"'
        );
        ...
        this.outputText(
            "belly.  Urta's rigid onyx nipples tickle your [legs] as they drag upward, each immensely erect and engorged, just a little pebbly in texture.  She reaches your [chest], kissing up the "
        );
        ...
        if (this.player.hasFuckableNipples())
            ...
            this.outputText(
                "Her tongue plays across the surface, the heat of her breath shooting tingles up your spine"
            );
        this.outputText(
            ".  The further she climbs, the further up your [legs] you can feel her stallion-cock rising, a trail of clear pre-cum in its wake."
        );
        ...
        if (this.player.hasCock()) {
            ...
            this.outputText(
                ", the slippery wetness of your [vagina] and the sheer hardness of your [clit] overwhelming."
            );
        this.outputText(
            "  This feels better than it really ought to, perhaps in part thanks to your partner's copious fluids and supernaturally warm, feverish dick."
        );
        ...
        if (
            ...
            this.jojoScene.campCorruptJojo()
        )
            ballWorship[ballWorship.length] = 0;
        if (
            (this.amilyScene.amilyFollower() && this.flags[kFLAGS.AMILY_FOLLOWER] == 2) ||
            this.jojoScene.campCorruptJojo()
        )
        ...
        //{Bimbo Sophie ball worship here}
            ...
            if (this.player.balls > 0)
                this.outputText(
                    "  She does the same to your own [balls], even giving your [asshole] a happy, sloppy kiss before returning to polishing the supple, skin-shrouded spheres just ahead."
                );
            this.outputText(
        ...
        if (this.player.tailType > TAIL_TYPE_NONE)
            this.outputText(
                ", though getting your tail angled right to allow her entrance is a bit of a challenge"
            );
        else if (this.player.isTaur())
            this.outputText(
                ", though getting down on your hands and forelegs is a bit challenging for you"
            );
        ...
        if (this.player.wetness() >= 5)
            this.outputText(
                "Lady-spunk showers out of your spasming twat, glazing Urta's bouncy ballsack with your lusty liquid."
            );
        else if (this.player.wetness() >= 3)
            this.outputText(
                "Lady-spunk drools out of your spasming twat in thick streams, glazing Urta's bouncy ballsack with your liquid lust."
            );
        else if (this.player.wetness() >= 1)
            this.outputText(
                "Lady-spunk drips from your spasming twat in steady trickles, glazing Urta's bouncy ballsack with your liquid lust."
            );
    ...
    private getKnockedUpUrtaEpilogue(): void {
        ...
        this.outputText(
            ".  Whatever Urta just put inside you, it's developing fast.  Fast enough to give you a wobbling gait and a straining midriff.  You give the snoring fox a prod.  Her only reaction is to swat at your finger with her fluffy tail and roll over snoring, so this time, you jab her hard, in the butt-cheek.  She yelps, sitting upright immediately."
        );
        this.outputText(
    ...
    private getKnockedUpByUrtaEpilogueII(): void {
        ...
        if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150)
            this.outputText(
                "  Somehow, you're still just as pregnant with something as you were before."
            );
        this.outputText(
            "  You're filled with vigor at the touch, the stress of the birth fading immediately.  Even your poor, tortured vagina tingles, the pain fading.  You can feel the pregnant gape receding, as if the birth never happened."
        );
    ...
    private urtaAndEdrynGodChildEpilogueII(): void {
        ...
        this.outputText(
            "pregnant flanks rippling with muscular contractions.   Something is bulging against her nether-lips, stretching the massive horse-cunt wider and wider with each passing moment."
        );
        ...
        if (kGAMECLASS.telAdre.edryn.pregnancy.isPregnant)
            this.outputText(
                "  The centaur guardswoman is still just as pregnant with your offspring as before.  Your child is unharmed by whatever just transpired."
            );
