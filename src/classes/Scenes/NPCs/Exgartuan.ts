    ...
    public timeChange(): boolean {
        ...
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) {
            ...
            if (
                ...
                // Tit removal
                this.outx(
                    `\n<b>Black milk dribbles from your ${this.getGame().nippleDescript(
                        0
...
//  */
                        ...
                        if (this.model.time.hours % 9 == 0) {
                            ...
                            if (Exgartuan.rand(3) == 0) {
                                ...
                                if (Exgartuan.rand(2) == 0)
                                    this.outx(
                                        `You feel warm and tingly, good all over.  Wait a second, your hands are playing with your ${this.getGame().breastDescript(
                                            0
                                        )}.  You yank your hands away, but it only makes Exgartuan laugh with demonic pleasure!`
                                    );
                                else {
                                    this.outx(
                                        `Your hands knead and caress your ${this.getGame().breastDescript(
                                            0
    ...
    private drinkFountainEndowment(): void {
        ...
        if (Exgartuan.rand(3) == 0 && this.player.biggestTitSize() > 1) {
            this.outx(
                `\n\nYour ${this.allBreastsDescript()} balloon, each growing about four bra-sizes larger... they feel so... jiggly and sensitive.  Even your nipples seem to grow with them!  Your ${
        ...
        if (Exgartuan.rand(3) == 0 && this.player.totalCocks() > 0) {
            this.outx(
                `\n\nYour ${this.multiCockDescriptLight()} feels tighter inside your ${
                    this.player.armorName
        ...
        if (Exgartuan.rand(4) == 0 && this.player.hasVagina()) {
            this.outx(
                `\n\nYour ${this.clitDescript()} plumps up, visibly parting your lips even when you aren't turned on.  It probably `,
                false
            );
    ...
    private exgartuanInfestDick(): void {
        ...
        if (this.player.cocks[0].cockType != CockTypesEnum.DEMON) {
            ...
            this.outx(
                `\n\nYou look down, and find your demonic cock pointing directly at you, and shaking with... indignation?  The ground hits your ${this.buttDescript()} hard as you fall backwards, too surprised to maintain your footing.  Is your dick talking to you?`,
                false
            );
            this.outx(
    ...
    private exgartuanInfestTits(): void {
        this.outx(
            `\n\nYour ${this.allBreastsDescript()} jiggle as they grow MUCH larger, turning into obscene mounds that shake with every motion of your body.  All your ${this.nippleDescript(
                0
        ...
        this.outx(
            `\n\nThe ground hits your ${this.buttDescript()} hard as you fall backwards, too surprised to maintain your footing.  Are your breasts really talking to you?`,
            false
        );
        this.outx(
            `\n\n"<i>Yes I am,</i>" mutters Exgartuan, spurting a trickle of milk from your ${this.nippleDescript(
                0
    ...
    public exgartuanMasturbation(): void {
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1) {
            ...
            if (this.player.cor >= 30 && this.player.cor < 60)
                this.outx(
                    `You happily remove your ${
                        this.player.armorName
                    }, eager to pleasure yourself.  Your possessed ${this.cockDescript(
                        0
                    )} throbbs happily.\n\n`,
                    false
                );
            ...
            if (this.player.cor < 33) {
                ...
                this.outx(
                    `There's no use fighting, it feels too good.  Your tongue hangs out of your mouth as you break under the assault, caving in to your physical needs.  The tip of your ${this.cockDescript(
                        0
            ...
            // Medium corruption characters
                ...
                this.outx(
                    `You squeeze out a few thick dollops of pre-cum, slicking the ${this.cockDescript(
                        0
            ...
            // high corruption characters
                ...
                this.outx(
                    `Happily giving in to the desires of your inner demon, you grab hold of your ${this.cockDescript(
                        0
                ...
                this.outx(
                    `He's so right too.  You could keep making him bigger until it's hard to move and he drags on the ground, but you're sure his demon-magics would entice plenty of corrupted sluts, and haze the minds of any uncorrupted person enough to bring them under the spell of your ${this.cockDescript(
                        0
                ...
                this.outx(
                    `"<i>That's the ticket, ${this.player.short}, you're sooo good at this.  Now go ahead and let it out.  I want to paint your face with seed and watch it drip off.  You'll let me do that right?  Who am I kidding, I feel so good you'll let me do whatever I want, won't you slut?</i>"\n\n`,
                    false
                );
                this.outx(
        ...
        // TITURBATION
            ...
            // (ALT 1st PG)
                ...
                this.outx(
                    `You shrug off your top eagerly, ready to cooperate with the demon inside your ${this.allBreastsDescript()} and enjoy a relaxing tit-massage.  You slide the offending material to the side and marvel at the wondrously large orbs on your chest.  Truly any place that can give you such wonderful endowments can't be evil.  You lean back, enjoying the warmth in the air as it flows over every extra-sensitive inch of your mounds, more than ready to get started.\n\n`,
                    false
                );
            }
            this.outx(
            ...
            this.outx(
                `, pausing to gently squeeze and caress any particularly sensitive spots.  Soft sighs escape your lips from the self-imposed pleasure-assault.  Your body relaxes totally, slouching down against a rock while you continue to happily play with your ${this.allBreastsDescript()}.  The entire time your hands never touch one of your ${this.nippleDescript(
                    0
    ...
    public exgartuanBored(): void {
        ...
        if (
            ...
            switch (select) {
                case 0:
                    this.outx(
                        `You feel an ominous jiggling in your ${this.breastDescript(
                            0
                ...
                case 2:
                    this.outx(
                        `Exgartuan wakes, making your ${this.allBreastsDescript()} wobble pleasantly.  The need to have them groped and fondled slowly grows with the demoness's wakefulness.  She barks out, "<i>Oi, bitch!  Touch your titties!</i>"\n\nYou sigh.`,
                        false
                    );
                    break;
                case 3:
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1) {
            ...
            // (+Lust in combat) for girls
                ...
                switch (select) {
                    ...
                    case 4:
                        this.outx(
                            `This fight has gone on long enough; all you really want is to shove your ${this.cockDescript(
                                0
                    ...
                    case 7:
                        this.outx(
                            `Maybe it would be best to just lay down your arms and strip off your ${
                                this.player.armorName
                            }. Just give yourself up to the ${this.monster.a}${
                                this.monster.short
                ...
                switch (select) {
                    ...
                    case 3:
                        this.outx(
                            `The waist of your ${
                                this.player.armorName
                            } expands as your ${this.cockDescript(
                                0
                    ...
                    case 7:
                        this.outx(
                            `All of a sudden, your ${
                                this.player.armorName
                            } splays open, your ${this.cockDescript(
                                0
    ...
    public exgartuanBeeRape(): void {
        ...
        this.outx(
            `Walking forward with a bit of supernaturally-induced swagger, you close the remaining distance with your trembling victim, oblivious to the fact that your ${
                this.player.armorName
            } are rapidly disengaging themselves from your body and dropping to the forest floor.  She weakly protests, exposing her stinger, but the threat is clearly futile.  There's no way she'd touch you or your magnificent ${this.cockDescript(
                0
        ...
        this.outx(
            `"<i>You sure know your knots!   Speaking of knots, I got an idea...</i>" exclaims the demon inside your ${this.cockDescript(
                0
        ...
        this.outx(
            `The bee-girl's abused body is becoming more and more limp with every brutal penetration, relaxing further and further to take in more of your ${this.cockDescript(
                0
        ...
        this.outx(
            `You pull out with a satisfied grunt, enjoying the wet 'schlick' sound your ${this.cockDescript(
                0
    ...
    private exgartuanSleepSurprise(): void {
        ...
        if (this.player.cor <= 20 && this.player.findPerk(PerkLib.BulgeArmor) >= 0) {
            ...
            if (
                ...
                this.outx(
                    `  You remove your ${this.player.armorName} piece by piece, leaving only the magically-altered centerpiece that your favorite demon ever so generously "<i>gifted</i>" to you.\n\n`,
                    false
                );
            // [else]
            else
                this.outx(
                    `  You glare at your ${this.player.armorName}, its altered state so graciously bestowed upon you by the ever-thoughtful demon that resides in your crotch.\n\n`,
                    false
                );
            ...
            if (this.player.gender == 3) {
                ...
                if (this.player.balls == 0) {
                    ...
                    this.outx(
                        ` surrounding your sex, teasing you with the barest hint of sensation while your ignorant hands maul your ${this.cockDescript(
                            0
                ...
                // (Herms + Balls)
                    ...
                    this.outx(
                        ` skin of your outer lips is engorged and ready, but with your hands so focused on your ${this.cockDescript(
                            0
                        )}, there's little for your ${this.vaginaDescript(
                            0
                        )} to feel.  The closest it gets to pleasure is the sensation of your ${this.sackDescript()} slapping against it with the steady rhythm of your masturbation.  If only you had taken care of yourself earlier!  You might have had enough control over your rebellious tool to let a hand attend to your OTHER needs.\n\n`,
                        false
                    );
                }
            }
            ...
            this.outx(
                `  Liquid-hot pressure slides over the underside of your ${this.cockDescript(
                    0
    ...
    private exgartuanBulgeTortureII(): void {
        ...
        this.outx(
            `  Too preoccupied with whatever's going on down below, you can't seem to focus enough to get the job done right.  Your peer down your body at your ${this.cockDescript(
                0
    ...
    private exgartuanBulgeTortureIII(): void {
        this.outx("", true);
        this.outx(
            `Fueled by pure spite and just a hint of loathing, you begin to regain some sort of composure through controlled breathing and what little concentration you can manage.  A few minutes of counting stitches in the top of your tent is all you accomplish, however; your once dormant limp ${this.cockDescript(
                0
        ...
        this.outx(
            `Eyes re-widened, teeth clenched, you grasp for where the glans of your ${this.cockDescript(
                0
        ...
        this.outx(
            `Your frantic breathing seems to be competing with your pounding heartbeat, acting as if it were emanating from within your skull.  Your hands cling to the dirt and scant pieces of grass below you, unable to stop shaking or heed any of your commands.  Your already obscured vision begins to darken, more and more of the vague blobs fading into darkness.  Your ${this.player.legs()} continue their numb strike against you while helping your ${this.player.feet()} dig helplessly into the ground.  ...You've run out of ideas, left with an insatiable hunger for sex, a body that refuses to do little more than convulse, and a mound of misfortune where your crotch resides.\n\n`,
            false
        );
    ...
    private exgartuanBulgeTortureIV(): void {
        ...
        this.outx(
            `  You pay one more glance to Exgartuan, the ${this.cockDescript(
                0
    ...
    private boobGartuanSURPRISE(): void {
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) {
            ...
            this.outx(
                `"<i>${this.player.short}!</i>" he shouts snidely, a sneer working its way across his face, "<i>How long has it been?</i>"\n\n`,
                false
            );
            this.outx('"<i>', false);
            ...
            this.outx(
                `Your warning turns to moaning as the imp's hands quickly latch onto your ${this.chestDesc()}, discarding the walking stick and golden idol to the hard floor.  "<i>I don't need any of your words of wisdom, ${
                    this.player.short
    ...
    private boobgartuanSurprise2(): void {
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) {
            ...
            this.outx(
                `Nemus is up there barking orders and waving his cane around, his free hand still clutching his wound.  "<i>I want this ${this.player.mf(
                    "asshole",
                    "slut"
    ...
    public exgartuanNagaStoleMyMasturbation(): void {
        ...
        this.outx(
            ` load working its way up your ${this.cockDescript(
                0
