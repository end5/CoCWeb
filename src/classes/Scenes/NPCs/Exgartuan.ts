    ...
    public timeChange(): boolean {
        ...
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0) {
            ...
            if (
                ...
                (!this.player.hasCock() || this.player.cockArea(0) < 100)
            ) {
                ...
                if (this.player.statusAffectv2(StatusAffects.Exgartuan) > 0) {
...
//  */
                        ...
                        if (this.model.time.hours % 9 == 0) {
                            ...
                            if (Exgartuan.rand(3) == 0) {
                                ...
                                if (Exgartuan.rand(2) == 0)
                                    this.outx(
                                        "You feel warm and tingly, good all over.  Wait a second, your hands are playing with your " +
                                            this.getGame().breastDescript(0) +
                                            ".  You yank your hands away, but it only makes Exgartuan laugh with demonic pleasure!"
                                    );
                                else {
                                    this.outx(
                                        "Your hands knead and caress your " +
                                            this.getGame().breastDescript(0) +
                                            ", eagerly touching every inch of soft flesh.  You gasp when you realize what you're doing and pull them away"
                                    );
                                    if (this.player.cor < 50)
                                        this.outx(
                                            ", angry at yourself for falling prey to the demon's directions"
                                        );
                                    this.outx(".");
    ...
    public fountainEncounter(): void {
        ...
        this.outx("Do you drink from the fountain?");
        // [Yes] [No]
    ...
    private drinkFountainEndowment(): void {
        ...
        if (Exgartuan.rand(3) == 0 && this.player.biggestTitSize() > 1) {
            this.outx(
                "\n\nYour " +
                    ...
                    " balloon, each growing about four bra-sizes larger... they feel so... jiggly and sensitive.  Even your nipples seem to grow with them!  Your " +
                    this.player.armorName +
                    " feels tighter than ever!",
                false
            );
            this.player.nippleLength += 0.3;
        ...
        if (Exgartuan.rand(3) == 0 && this.player.totalCocks() > 0) {
            this.outx(
                "\n\nYour " +
                    ...
                    " feels tighter inside your " +
                    this.player.armorName +
                    ", even when flaccid.  You shudder and realize you've probably gained more than a few inches in total length, and who knows how your thickness has changed.",
                false
            );
            ...
            while (this.temp > 0) {
                ...
                this.player.cocks[this.temp].cockThickness += 0.3;
            }
            changed = true;
        }
        // (+Big Clit)
        if (Exgartuan.rand(4) == 0 && this.player.hasVagina()) {
            this.outx(
                "\n\nYour " +
                    this.clitDescript() +
                    " plumps up, visibly parting your lips even when you aren't turned on.  It probably ",
                false
            );
            this.player.clitLength += 2;
            if (this.player.clitLength < 6) this.outx("gets as big as a cock");
            else this.outx("gets bigger than most cocks");
            this.outx(" now!");
            changed = true;
        }
    ...
    private exgartuanInfestDick(): void {
        ...
        if (this.player.cocks[0].cockType != CockTypesEnum.DEMON) {
            ...
            this.outx(
                "\n\nYou look down, and find your demonic cock pointing directly at you, and shaking with... indignation?  The ground hits your " +
                    this.buttDescript() +
                    " hard as you fall backwards, too surprised to maintain your footing.  Is your dick talking to you?",
                false
            );
            this.outx(
            ...
            this.player.cocks[0].cockThickness += 0.5;
        }
        // (+Demon dick possession – not demondicked)
            ...
            this.outx(
                "\n\nYour " +
                    this.cockDescript(0) +
                    " puffs up, growing even larger as it absorbs the fountain's essence.  It dribbles pre-cum and twitches about as if sniffing the air, feeling very warm and sensitive.",
                false
            );
            this.outx(
                '\n\nA voice suddenly splits the air, demanding, "<i>Satiate me mortal, or I\'ll make you find someone who will!</i>"',
    ...
    private exgartuanInfestTits(): void {
        this.outx(
            "\n\nYour " +
                this.allBreastsDescript() +
                " jiggle as they grow MUCH larger, turning into obscene mounds that shake with every motion of your body.  All your " +
                this.nippleDescript(0) +
                "s puff up with them, gaining volume to match their new, larger homes.  They feel hot and ache to be touched.",
            false
        );
        this.temp = this.player.breastRows.length;
        while (this.temp > 0) {
        ...
        this.outx(
            "\n\nThe ground hits your " +
                this.buttDescript() +
                " hard as you fall backwards, too surprised to maintain your footing.  Are your breasts really talking to you?",
            false
        );
        this.outx(
            '\n\n"<i>Yes I am,</i>" mutters Exgartuan, spurting a trickle of milk from your ' +
                this.nippleDescript(0) +
                's for emphasis, "<i>and you had better take me back to that lovely camp I can see in your memories and give me a nice long massage.</i>"',
            false
        );
        this.outx(
            "\n\nWell now... this was certainly unexpected.  Perhaps there's a way to be rid of this thing?",
    ...
    public exgartuanMasturbation(): void {
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1) {
            ...
            if (this.player.cor < 15)
                this.outx(
                    'You sheepishly find some rocks to hide in, where you remove your clothes.  Exgartuan loudly grumbles, "<i>Quit fucking around and hiding.  I WANT someone to walk in on this!</i>"\n\nDisgusting...\n\n',
                    false
                );
            if (this.player.cor >= 15 && this.player.cor < 30)
                this.outx(
                    'You make sure you are alone and strip naked.  Exgartuan mutters, "<i>Why did you wait until you were alone?  Wouldn\'t it be fun to have a succubus wander in on us?</i>"\n\n',
                    false
                );
            if (this.player.cor >= 30 && this.player.cor < 60)
                this.outx(
                    "You happily remove your " +
                        this.player.armorName +
                        ", eager to pleasure yourself.  Your possessed " +
                        this.cockDescript(0) +
                        " throbbs happily.\n\n",
                    false
                );
            if (this.player.cor >= 60 && this.player.cor < 80)
                this.outx(
                    "You strip naked in an exaggerated fashion, hoping someone might be watching.  The demon-possessed member at your groin pulses happily, flooding you with lust in reward for your attitude.\n\n",
                    false
                );
            if (this.player.cor >= 80)
                this.outx(
                    "You strip naked, fondling your naughty bits as you do so and casting seductive looks around, hoping someone or something is nearby to fuck you.  Your possessed member wiggles happily, flooding your body with feelings of lust and desire in reward.  Maybe it can call in a demonic companion for you?\n\n",
                    false
                );
            ...
            if (this.player.cor < 33) {
                ...
                this.outx(
                    "You sigh, squeezing out thick globs of pre-cum as you fondle the nodule-ringed crown of your " +
                        this.cockDescript(0) +
                ...
                if (this.player.tentacleCocks() > 0)
                    this.outx(
                        "  A tentacle-cock curls up, tightening around the base like an organic cock-ring.  It makes each of the corrupt nodules grow bigger, harder, and even more sensitive.",
                        false
                    );
                ...
                this.outx(
                    '"<i>No, it\'s not like that!</i>" you yell, while pumping away, reveling in the feeling of your hands sliding up and down your pre-cum-soaked shaft.  Tiny moans interrupt your denial, punctuating it with short sharp moans of pleasure.\n\n',
                    false
                );

                this.outx(
                    "\"<i>Oh, you're already giving in to me?  I can feel the cum boiling in your ",
                    false
                );
                if (this.player.balls > 0) this.outx(this.ballsDescriptLight(), false);
                else this.outx("loins");
                this.outx(
            ...
            // Medium corruption characters
                ...
                this.outx(
                    "Unable to handle the artificial lust the demon living in your crotch forces upon you, you grab hold of the monster with both hands, shivering at how good it feels.  Nothing should ever feel this good, but while it does, you may as well enjoy it, right?  Your body reddens as you really start to enjoy the feelings, as your hands caress every nodule-covered inch of your " +
                        this.cockDescript(0) +
                        ".  On one hand, you can't believe the pleasure you're feeling, but on the other you feel like you should be doing more to resist it.  Oh well, too late now...\n\n",
                    false
                );
                this.outx(
                    "You squeeze out a few thick dollops of pre-cum, slicking the " +
                        this.cockDescript(0) +
                        " with the copious slippery stuff it drools out.  It never put out quite this much before, perhaps the demon Exgartuan is responsible.  You gasp when your hands squeeze the lubricated shaft between them, tightly jacking up and down, heedless of your desires and acting as slaves to the demon's needs.  You're feeling more and more like a passenger in your own body, but you really don't mind.  It's so easy to just relax and enjoy the hotness welling up inside you.\n\n",
                    false
                );
                this.outx(
                    'The demon speaks up, teasing you, "<i>Already caving in to my corruption slut?  Are you truly so happy to let a demon control your body so lewdly?  Shouldn\'t you at least try to pretend not to be pleased by acting like such a wanton whore?</i>"\n\n',
                    false
                );
                ...
                if (this.player.biggestTitSize() >= 5)
                    this.outx(
                        "shove the bloated demon between your " +
                            this.allBreastsDescript() +
                            ", surrounding it in a home of jiggling flesh.  The wet demon-pre soaks into the skin of your tits, lubricating the passage as you mash them around, vigorously tit-fucking the source of your unholy desires.",
                        false
                    );
                else
                    this.outx(
                        "work the shaft relentlessly, drawing out more and more of the demon's pre-seed until your forearms and upper thighs are coated in the stuff, shining darkly.",
                        false
                    );
                this.outx(
                    "  You pant and moan, forced to feel such wonderfully obscene sensations.\n\n",
                    false
                );
                this.outx(
                    "\"<i>You should look at yourself, panting and moaning like a rutting animal.  I wonder, are you still a champion  or a slave to the things I'm doing to you?  You look like a sex slave, but are you truly addicted to the feeling of squirting thick demonic jism?  Such a slutty champion you've become, " +
                        this.player.short +
                        ',</i>" taunts Exgartuan.  Part of you wants to object, to shout down his suggestions, but every time you open your mouth the only sound to escape is a wanton moan.\n\n',
                    false
                );
                this.outx(
                    "Your orgasm spreads through the demon like a wave.  You briefly wonder if it's the demon causing this to feel so good, or your own corrupt desires.  The thoughts are scattered by the feeling of a fat gob of spooge splattering over your " +
                        this.player.face() +
                        ".  You blink your eyes clear in time to see the fat, pulsating tip of your " +
                        this.cockDescript(0) +
                        " hovering in front of your face.  Your urethra spreads wide, launching another spurt and splattering it into your " +
                        this.hairDescript() +
                        ".\n\n",
                    false
                );
                this.outx(
                    '"<i>Oh, if only your elders could see you now, soaking yourself in cum after submitting to a demon\'s will.  Ooooh, that feels good,</i>" mutters your possessed prick as it continues to paint you, the hot eruptions tapering off into a steady trickle of whiteness, running down your ' +
                        this.allBreastsDescript() +
                        ".  You lie back, humiliated, but smiling happily at how RELIEVED you are after creating such a massive eruption.\n\n",
                    false
                );

                this.outx(
                    "Temporarily sated, Exgartuan deflates, not even bothering to taunt you while you try to clean up the goop now splattered over your upper body.",
                    false
                );
            }
            // high corruption characters
                ...
                this.outx(
                    "Happily giving in to the desires of your inner demon, you grab hold of your " +
                        this.cockDescript(0) +
                        " with both hands, feeling its heavy mass slowly expanding inside your tight grip. It pulsates with dark powers and corrupted lusts, tingling pleasantly as it grows to its full, erect size.  You pet it gently, soothing the demon inside with expert touches that fill the both of you with explosions of pure delight.  Each of the hundreds of nodules covering its surface grow erect in a wave, filling up as you become more and more turned on.\n\n",
                    false
                );
                this.outx(
                ...
                this.outx(
                    "He's so right too.  You could keep making him bigger until it's hard to move and he drags on the ground, but you're sure his demon-magics would entice plenty of corrupted sluts, and haze the minds of any uncorrupted person enough to bring them under the spell of your " +
                        this.cockDescript(0) +
                        ".  Gosh it makes you hot!  Just thinking about having a harem of goblin girls massaging your mighty member while another grinds her eager gash against your tip... you NEED to make this happen.  Perhaps you could breed an army of the little sluts, to bear you around on a litter and squeeze out cum anytime you have the barest hint of lust.\n\n",
                    false
                );
                this.outx(
                    "Your " +
                        this.cockDescript(0) +
                        " seems quite taken with the idea, spurting hot globules of pre-cum until it's glazed itself in a coating of slick wetness.  Both of your hands rub along the surface, soaking themselves in the copious demon-goo, working it entirely of their own volition.  You manage to control your hips at least, and put them to work thrusting up, increasing the stimulation further, and spurring your " +
                        this.cockDescript(0) +
                        " to drizzle even more of its corrupt fluid.  It feels too good to try to resist, and there really isn't any reason to, is there?\n\n",
                    false
                );
                this.outx(
                    "\"<i>That's the ticket, " +
                        this.player.short +
                        ", you're sooo good at this.  Now go ahead and let it out.  I want to paint your face with seed and watch it drip off.  You'll let me do that right?  Who am I kidding, I feel so good you'll let me do whatever I want, won't you slut?</i>\"\n\n",
                    false
                );
                this.outx(
                    "Oh gods he's right, you're going to let him aim at you and splatter you with waves of demonic jizz.  The worst part is, you can feel a large part of you looking forward to it.  You wonder what has happened to you as you give in, oblivious to the feeling of ",
                    false
                );
                if (this.player.biggestTitSize() >= 5)
                    this.outx(
                        "your hands smashing your " +
                            this.allBreastsDescript() +
                            " around the " +
                            this.cockDescript(0) +
            ...
            this.player.orgasm();
            this.dynStats("lib", 0.25, "cor", 1);
        }
        // TITURBATION
        else if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 2) {
            if (this.player.cor < 50) {
                this.outx(
                    "You shrug off your top, preparing to give into the demon's demands.  'At least I'll get to enjoy it too,' you muse, as you finish stripping the offending material from your torso.  You look down over your " +
                        this.allBreastsDescript() +
                        ", and they don't look particularly evil.  Yet you know that within those wonderful mounds of breast-flesh lurks a great force of corruption, and worse yet, you know you're giving it exactly what it wants.\n\n",
                    false
                );
            }
            // (ALT 1st PG)
                ...
                this.outx(
                    "You shrug off your top eagerly, ready to cooperate with the demon inside your " +
                        this.allBreastsDescript() +
                        " and enjoy a relaxing tit-massage.  You slide the offending material to the side and marvel at the wondrously large orbs on your chest.  Truly any place that can give you such wonderful endowments can't be evil.  You lean back, enjoying the warmth in the air as it flows over every extra-sensitive inch of your mounds, more than ready to get started.\n\n",
                    false
                );
            }
            this.outx(
                "Both hands rise unbidden and begin to caress your " +
            ...
            if (
                ...
                this.outx("flesh");
            else if (this.player.skinType == SKIN_TYPE_FUR) this.outx("furry-covered flesh");
            else if (this.player.skinType == SKIN_TYPE_SCALES) this.outx("soft scaley flesh");
            else this.outx("gooey surface");
            this.outx(
                ", pausing to gently squeeze and caress any particularly sensitive spots.  Soft sighs escape your lips from the self-imposed pleasure-assault.  Your body relaxes totally, slouching down against a rock while you continue to happily play with your " +
                    this.allBreastsDescript() +
                    ".  The entire time your hands never touch one of your " +
                    this.nippleDescript(0) +
                    "s, merely circling them from time to time, making you arch your back in need.\n\n",
                false
            );
            this.outx(
                'A voice taunts, "<i>Oh, does my champion tit-massager need a little nipple-play?  And to think I thought I was the one needing to get off.  Go ahead then, submit to your desires and play with your nipples.  Wallow in the pleasure that I can give you and remember who your true master is!</i>"\n\n',
                false
            );
            this.outx(
                "At last, fingers wrap themselves about your " +
                    this.nippleDescript(0) +
            ...
            if (this.player.hasVagina()) {
                this.outx("Juice");
                if (this.player.totalCocks() > 0) this.outx(" and pre-cum");
                this.outx(" soaks your groin");
            } else if (this.player.totalCocks() > 0) this.outx("pre-cum soaks your groin");
            else this.outx("Warmth radiates through your body");
            this.outx(
                " as you're more and more turned on by the feelings coming from your chest.  Fingertips ",
                false
            );
            if (this.player.nippleLength < 2)
                this.outx("pinch together and pull, and it's too much for you.");
            else
                this.outx(
            ...
            this.outx(
                " You shake and wriggle, overcome with a strange type of pleasure unlike a 'normal' orgasm.  The boobgasm does feel wonderful, but it does nothing for the aching lust that has built up in your crotch.  Perhaps you'll need to satisfy that as well.\n\n",
                false
            );
            // (lust + 15)
            this.dynStats("sen", 0.25, "lus", 15, "cor", 1);
            if (this.player.biggestLactation() > 1)
                this.outx(
                    "As you calm down you realize your " +
                        this.nippleDescript(0) +
    ...
    public exgartuanBored(): void {
        ...
        if (
            ...
            if (select == 0) {
                ...
                this.outx(
                    'A tiny voice mutters, "<i>How can you live with so few orgasms?  We need some quality time, ' +
                        this.player.short +
                        ".  You've got a LOT of tension building up...</i>\"",
                    false
                );
            } else if (select == 2) {
                this.outx(
                    "You feel a stirring inside your " +
                        this.player.armorName +
                        ' as it rubs against the material.  A muffled voice says, "<i>Hey!  Don\'t forget me!  I need some air!</i>"',
                    false
                );
            } else if (select == 3) {
                this.outx(
                    "\"<i>Hey!  WHATTHEFUCK ARE YOU DOING!?  I'll tell you what you're doing: NOT TAKING CARE OF YOUR DICK.  Get on it, or I'll make sure something gets on you!</i>\" Exgartuan orders.  What a prick.",
                    false
                );
            } else if (select == 4)
                this.outx(
                ...
                this.outx(
                    "Your " +
                        this.player.armorName +
                        ' suddenly bulges, a stifled voice picking up along with it, "<i>There has to be a hole out there for me to fuck.  A mouth, a cunt... stop slacking off and get on it!</i>"',
                    false
                );
            else if (select == 6) {
                this.outx("It's getting harder to concentrate... Exgartuan is ");
                if (this.player.balls > 0) this.outx("teasing your ballsack");
                // [if vagina, no balls]
                else if (this.player.hasVagina()) this.outx("poking your labia");
                else this.outx("stroking your perineum");
                this.outx(
                ...
                this.outx(
                    'Your possessed prick shuffles from side to side, "<i>Have you just FORGOT how a dick works or something? I\'ll help remind you; step one: GIVE IT SOME AIR.</i>"',
                    false
                );
            } else if (select == 8) {
                this.outx(
            ...
            switch (select) {
                case 0:
                    this.outx(
                        "You feel an ominous jiggling in your " +
                            this.breastDescript(0) +
                ...
                case 1:
                    this.outx(
                        "After a few hours of peace, Exgartuan begins to stir.  You can feel a desire to be touched building within your " +
                            this.allBreastsDescript() +
                            ".  What a needy demon.",
                        false
                    );
                ...
                case 2:
                    this.outx(
                        "Exgartuan wakes, making your " +
                            this.allBreastsDescript() +
                            ' wobble pleasantly.  The need to have them groped and fondled slowly grows with the demoness\'s wakefulness.  She barks out, "<i>Oi, bitch!  Touch your titties!</i>"\n\nYou sigh.',
                        false
                    );
                    break;
                case 3:
                    this.outx(
                        "Suddenly your " +
                            this.chestDesc() +
                            " feel as if they trying to force their way off your chest.  The strange motions are accompanied by some loud moaning, as if they are stretching awake.  Looks like the delightful peace and quiet has ended.",
                        false
                    );
                    break;
                case 4:
                    this.outx(
                        "Your arms suddenly hug against your " +
                            this.chestDesc() +
                            " of their own accord, the squeeze filling you with a hint of warmth.  The demoness is awake and filling you with longing to be touched and teased.",
                        false
                    );
                    break;
                case 5:
                    this.outx(
                        "Your " +
                            this.chestDesc() +
                            ' fidget ominously, a muffled female voice piping up, "<i>No cloth, metal, latex, or gel can protect you from me, champion.  Give in and caress these cans!</i>"',
                        false
                    );
                    break;
                case 6:
                    this.outx(
                        "The silent alone time you've been enjoying is coming to an end as the demoness dwelling within your bosom shifts in your " +
                            this.player.armorName +
                            ".  She wastes no time in stuffing you full of chest-focused temptations.",
                        false
                    );
                    break;
                case 7:
                    this.outx(
                        'A menacing jiggle emanates from your bosom as they begin to speak, "<i>Someone out there must be looking for a home to nestle their cock or some sweet milk to quench their gullet, champion.  Stop wasting their time and get on it.</i>"',
                        false
                    );
                    break;
            }
    ...
    public exgartuanCombatUpdate(): boolean {
        ...
        if (
            this.monster.short == "tentacle beast" ||
            this.monster.short == "worms" ||
            this.monster.short == "demons"
        )
            return false;
        // VARS
        let select = 0;
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1) {
            ...
            if (this.monster.short == "goblin" && Exgartuan.rand(3) == 0) {
                this.outx(
                    "A strangely harmonic voice chants gibberish, rising in volume and pitch.  It's coming from your groin!  The goblin girl giggles and squeals, \"<i>Stop that!  It's using magic on my coo-chiieeeeeee!!!</i>\"",
                    false
                );
                // (+20 or 10% of cocksize, whichever is greater to vag capacity
                this.monster.addStatusValue(
                    StatusAffects.BonusVCapacity,
                    1,
                    this.player.cockArea(0) * 0.1
                );
            ...
            // [FETISH CULTISTS TURNED ON BY DEMON-COCK]
                ...
                switch (select) {
                    case 0:
                        this.outx(
                            "The fetish cultist's eyes fixate on your groin, never seeming to leave as combat continues.  Exgartuan seems to have quite the effect on her, judging by the growing scent of feminine arousal in the air.",
                            false
                        );
                        break;
                    case 1:
                        this.outx(
                            "Openly touching herself, the fetish cultist's gaze never leaves your crotch, locked onto the outline of Exgartuan in your " +
                                this.player.armorName +
                                ".  What a slut.",
                            false
                        );
                    ...
                    case 2:
                        this.outx(
                            "The fetish cultist seems fixated by the twitching lump that resides in your groin, following it back and forth as you tease her, swiveling your hips.  Damnit why is this bitch even wasting time fighting?  She definitely wants to play with Exgartuan...",
                            false
                        );
                        break;
                }
            ...
            // (+Lust in combat) for girls
                ...
                switch (select) {
                    case 0:
                        this.outx(
                            "Thoughts of " +
                                ...
                                this.monster.short +
                                ", wrapping " +
                                this.monster.mf("him", "her") +
                                "self around your throbbing demonic member consume you, flooding your body with lust.",
                            false
                        );
                        if (this.player.cor < 50)
                            this.outx(
                                "  You glance down at the sensitive bulge in your " +
                                    this.player.armorName +
                                    " and sigh.  Damned demons.",
                                false
                            );
                        break;
                    case 1:
                        this.outx(
                            "Desire courses through your veins, growing stronger as you watch " +
                                this.monster.a +
                                this.monster.short +
                                "'s form.  You somehow realize the desire is artificial, but it doesn't make you want to mount " +
                                this.monster.mf("him", "her") +
                                " any less...",
                            false
                        );
                    ...
                    case 2:
                        this.outx(
                            "Warmth spreads throughout your body as visions of yourself mounting " +
                                this.monster.a +
                                this.monster.short +
                                " over and over flutter through your mind.  You might have to make them a reality...",
                            false
                        );
                        if (this.player.cor < 50)
                    ...
                    case 3:
                        this.outx(
                            "You really want to end this fight and bend " +
                                this.monster.a +
                                this.monster.short +
                                " over... Why is this taking so long, your " +
                                this.cockDescript(0) +
                        ...
                        if (this.player.cor < 50)
                            this.outx(
                                "  You snap back to reality and curse yourself for falling to the demon's desires.",
                                false
                            );
                        break;
                    case 4:
                        this.outx(
                            "This fight has gone on long enough; all you really want is to shove your " +
                                this.cockDescript(0) +
                                " into the " +
                                this.monster.a +
                                this.monster.short +
                    ...
                    case 6:
                        this.outx(
                            "Pleasure begins to radiate through your being, suddenly.  You snap back to your senses in time to see your hands stroking the bulge in your " +
                                this.player.armorName +
                                ", answering to the whims of an unholy force.",
                            false
                        );
                        break;
                    case 7:
                        this.outx(
                            "Maybe it would be best to just lay down your arms and strip off your " +
                                this.player.armorName +
                                ". Just give yourself up to the " +
                                this.monster.a +
                                this.monster.short +
                                " and let fate decide. Surely, " +
                                this.monster.pronoun1 +
                                " would return the gesture by embracing your " +
                                this.cockDescript(0) +
                    ...
                    case 8:
                        this.outx(
                            "Tight loving assholes and gaping vaginas, slick long red tongues and breasts like fine china.  Succubi and the hot sexings they bring, these are a few of your favorite things!  ...Wait, what?  Was that musing your own?  And why are you absently stroking your " +
                                this.cockDescript(0) +
                                "?",
                            false
                        );
                    ...
                    case 9:
                        this.outx(
                            "It's becoming increasingly difficult to see this battle to its end when your mutinous mushroom is increasingly stiffening with each passing moment.  Exgartuan's weight is bad enough to your poise without extending it away from you.  What a jerk.",
                            false
                        );
                        break;
                }
            ...
            // (Taunts Male Foes -enemy lust)
                ...
                switch (select) {
                    case 0:
                        this.outx(
                            "Without any control over it, your hands undo your " +
                                this.player.armorName +
                                " and reveal your " +
                                this.cockDescript(0) +
                    ...
                    case 1:
                        this.outx(
                            "Heedless of your orders, both hands undo your gear, displaying your possessed member to " +
                                this.monster.a +
                                this.monster.short +
                                ".  A disembodied voice taunts, \"<i>You really can't compete with me.  Seriously.  Take a good long look.  I'm the fucking business.  Why don't you tuck that pathetic excuse for a cock between your legs and chuck down some succubi milk until you're a girl?  You'd be better off.</i>\"",
                            false
                        );
                        break;
                    case 2:
                    ...
                    case 3:
                        this.outx(
                            "The waist of your " +
                                ...
                                " expands as your " +
                                this.cockDescript(0) +
                                ' flies skyward fully erect, "<i>Tremble in fear, peon! My ' +
                                Exgartuan.num2Text(this.player.cocks[0].cockLength) +
                    ...
                    case 4:
                        this.outx(
                            "Disobeying your will, your hands promptly undo your " +
                                this.player.armorName +
                                ", your " +
                                this.cockDescript(0) +
                                " springing forth and flaring its urethra menacingly at the " +
                                this.monster.a +
                                this.monster.short +
                    ...
                    case 5:
                        this.outx(
                            "Suddenly, your " +
                                this.player.armorName +
                                " pitches an impossible tent, the colossal bulge pointing directly at the " +
                                this.monster.a +
                                this.monster.short +
                                '.  You can only wince in discomfort as the back of your outfit pushes against you while a muffled voice taunts, "<i>How can something so insignificant remain so ANNOYING?  Your mere presence dulls the obvious radiance before you. DROP DEAD!</i>"',
                            false
                        );
                        break;
                    case 6:
                        this.outx(
                            "Your " +
                                this.player.armorName +
                                " unexpectedly opens itself of its own accord, prompting your " +
                                this.cockDescript(0) +
                    ...
                    case 7:
                        this.outx(
                            "All of a sudden, your " +
                                ...
                                " splays open, your " +
                                this.cockDescript(0) +
                                ' quickly slithering up and around your back, stopping uncomfortably close to your face while pointing at your opponent, "<i>Look at this pitiful cretin, ' +
                                this.player.short +
                                ".  We could be out spreading hot dickings to the wanting cunts of the land.  But, no!  This " +
                                this.monster.a +
                                this.monster.short +
        ...
        // Exgartuan in tittays!
            ...
            if (this.monster.totalCocks() > 0) {
                ...
                switch (select) {
                    case 0:
                        this.outx(
                            "A flirty female voice with a rumbling undertone of demonic corruption teases, \"<i>Why fight us?  Just sit back and watch the giant breasts jiggle.  Maybe if you're good we'll let you slide in between our wonderful mammaries.  Isn't that nice?</i>\"",
                            false
                        );
                        break;
                    case 1:
                        this.outx(
                            "Your breasts wobble of their own accord, and " +
                                this.monster.a +
                                this.monster.short +
                                " watches spellbound as they do so.  You silently thank Exgartuan for the help – maybe this fight will be easy.",
                            false
                        );
                        break;
                    case 2:
                        this.outx(
                            "A girlish voice calls out to " +
                                this.monster.a +
                                this.monster.short +
                                ", \"<i>Hey cutey pie!  Why not just give up and submit, and maybe we'll let you play with our wondrous breasts.  Wouldn't that be nice?</i>\"",
                            false
                        );
                        break;
                    case 3:
                        this.outx(
                            "Your " +
                                this.chestDesc() +
                                " begin to playfully bounce up and down, making it difficult for you to focus on your fight.  You aren't too worried, however, as the " +
                                this.monster.a +
                                this.monster.short +
                                " seems to be hypnotized by the movement.",
                            false
                        );
                        break;
                    case 4:
                        this.outx(
                            "A sultry woman's voice teases the " +
                                this.monster.a +
                                this.monster.short +
                                ', "<i>There\'s no need for hostilities, is there?  Merely lay down your arms and come help fondle these marvels of creation.</i>"  Your ' +
                                this.chestDesc() +
                                " shimmy for emphasis.",
                            false
                        );
                    ...
                    case 5:
                        this.outx(
                            'An alluring female voice perks up from seemingly nowhere, "<i>We all know that you just want to nestle your head between these ferocious funbags.  No need to fight for them, just ask nicely!</i>"',
                            false
                        );
                        break;
                    case 6:
                        this.outx(
                            'You feel a moistness forming on your chest as a womanly voice takes shape, "<i>Come now, ' +
                                this.monster.short +
                                ".  Surely this fight has made you thirsty.  I wouldn't want to let all of this delicious breastmilk go to waste after all...</i>\"  Oh, gods...",
                            false
                        );
                        break;
                }
                ...
                switch (select) {
                    case 0:
                        this.outx(
                            "A brief fantasy of " +
                                this.monster.a +
                                this.monster.short +
                                " brutally squeezing and caressing your chest fills your mind.  You break free of the twisted daydream and pull your hands away from your " +
                                this.breastDescript(0) +
                    ...
                    case 1:
                        this.outx(
                            "A blush colors your cheeks as warm pleasure spreads through your chest.  You spare a downward glance and nearly shriek when you see both hands busy massaging your massive mounds.  You don't have time for this!  You pull your hands away in a huff.",
                            false
                        );
                        break;
                    case 2:
                        this.outx(
                            "A moan escapes your lips as mental images of having your breasts touched and licks leap into your mind unbidden.  You force them aside to focus on the situation you're in.",
                            false
                        );
                        break;
                    case 3:
                        this.outx(
                            "Your battle stance is interrupted as your fingers decide they would rather begin groping your tits.  Your bewitched bosom is getting to be a nuisance.  You retract your hands with a huff, anxious to end this battle.",
                            false
                        );
                        break;
                }
    ...
    public exgartuanArmorShift(): void {
        ...
        if (this.player.armor == this.armors.BEEARMR) {
            ...
            this.outx(
                "The green gel-plate protecting your groin thins and presses tightly against you, molding around your " +
                    this.cockDescript(0) +
            ...
            this.outx(
                "Your leather armor shifts, pressing tightly against your upper " +
                    this.player.legs() +
                    " and molding itself around your " +
                    this.cockDescript(0) +
            ...
            this.outx(
                "The chainmail bikini of your indecent steel armor rearranges and bends its interlocking rings to best shape itself around your " +
                    this.cockDescript(0) +
            ...
            this.outx(
                "The thin, transparent material of your red bodysuit begins to firmly press against your groin, perfectly shaping to your " +
                    this.cockDescript(0) +
            ...
            this.outx(
                "The fine silk that makes up your armor suddenly undoes itself around your crotch, exposing your " +
                    this.cockDescript(0) +
            ...
            this.outx(
                "The miniscule piece of swimwear that doubles as a tent to your " +
                    this.cockDescript(0) +
            ...
            this.outx(
                "You're taken by surprise as the binds of your chainmail begin to flatten and rearrange themselves, doing their best to match the curves of your " +
                    this.cockDescript(0) +
            ...
            this.outx(
                "Your chainmail bikini rearranges and bends its interlocking rings to best shape itself around your " +
                    this.cockDescript(0) +
                    ", leaving very little else to the imagination.",
                false
            );
            ...
            this.outx(
                "You begin to clench your fists as your steel platemail heats up around your " +
                    this.player.legs() +
                    " and crotch. Slowly it begins to press itself against your " +
                    this.cockDescript(0) +
            ...
            this.outx(
                "The steel scales that make up your armor begin to flap wildly around your crotch. They bend and shift as they attempt to match the profile of your " +
                    this.cockDescript(0) +
                    ".",
                false
            );
            ...
            this.outx(
                "You begin to feel your rubber outfit compressing itself against your upper " +
                    this.player.legs() +
                    " and " +
                    this.cockDescript(0) +
            ...
            this.outx(
                "The layer beneath your tunic begins to compress against your " +
                    this.cockDescript(0) +
            ...
            this.outx(
                "The denim of your overalls begins to press tightly against your " +
                    this.cockDescript(0) +
            ...
            this.outx(
                "Your clothing shifts, tightening up about your crotch until every curve and nodule of your " +
                    this.cockDescript(0) +
        ...
        if (this.player.cor < 33)
            this.outx(
                "  You cringe and blush bright crimson, raging against the demon inside you and wishing he would stop tormenting you!",
                false
            );
        else if (this.player.cor < 66)
            this.outx(
                "  You cringe a bit at the exhibitionist outfit you're forced to wear, but spend a little time admiring just how well the changes show off your package... Maybe Exgartuan isn't all bad?",
                false
            );
        else
            this.outx(
                "  You pivot your hips forwards, doing your best to show off your sensational package with every step.  Oh, very nice, you'll have to thank Exgartuan later...",
                false
            );
        if (changed) {
            ...
            if (this.player.findPerk(PerkLib.BulgeArmor) < 0)
                this.player.createPerk(PerkLib.BulgeArmor, 0, 0, 0, 0);
        }
    }
    ...
    public exgartuanLactationAdjustment(): void {
        ...
        if (this.player.biggestLactation() > 1) {
            ...
            if (Exgartuan.rand(2) == 0 || this.player.findStatusAffect(StatusAffects.Feeder) >= 0) {
                this.outx(
                    "Your nipples grow warm and sensitive, then start dripping milk into your " +
                        this.player.armorName +
                        ".  Exgartuan appears to be having some fun with you again...",
                    false
                );
            ...
            // (Stops)
                ...
                this.outx(
                    "Your " +
                        this.nippleDescript(0) +
                        "s tighten up.  What's that demon up to?  Realization dawns on you when you realize your " +
                        this.allBreastsDescript() +
                        " no longer feel so 'full'.  Your lactation has stopped!",
                    false
                );
        ...
        // (Not lactating)
            ...
            if (Exgartuan.rand(2) == 0) {
                this.outx(
                    "Your chest feels cold.  You touch your " +
                        this.player.armorName +
                        " experimentally and discover a few drops of milk have leaked from your " +
                        this.nippleDescript(0) +
            ...
            // Nipple stuff
                ...
                if (Exgartuan.rand(2) == 0) {
                    this.outx(
                        "The inner surface of your " +
                            this.player.armorName +
                            " arouses you as it rubs against your " +
                            this.nippleDescript(0) +
                ...
                // (SHORTER NIPPLES!)
                else if (this.player.nippleLength > 0.5) {
                    this.outx(
                        "As time passes you realize something feels different about your chest.  A quick glance confirms your suspicious – your nipples have somehow been shortened by about half an inch.  You've no doubt Exgartuan is responsible.",
                        false
                    );
                    this.player.nippleLength -= 0.5;
                }
    ...
    public exgartuanBeeRape(): void {
        ...
        this.outx("", true);
        this.outx(
            "You grin and embrace the demon's idea as if it were your own.  Maybe it's time the bee-girl had her own lesson in fluid insemination...\n\n",
            false
        );
        this.outx(
            "Walking forward with a bit of supernaturally-induced swagger, you close the remaining distance with your trembling victim, oblivious to the fact that your " +
                this.player.armorName +
                " are rapidly disengaging themselves from your body and dropping to the forest floor.  She weakly protests, exposing her stinger, but the threat is clearly futile.  There's no way she'd touch you or your magnificent " +
                this.cockDescript(0) +
                " with such an inferior organ.\n\n",
            false
        );
        this.outx(
        ...
        this.outx(
            '"<i>You sure know your knots!   Speaking of knots, I got an idea...</i>" exclaims the demon inside your ' +
                this.cockDescript(0) +
                ".  You wonder at what the demon could have in mind this time as you finish spreading the bee-bitch's legs in preparation.  The scent wafting out from her genitals is unreal, making you simultaneously hungry and incredibly horny.  You pull up the ginormous flanged tip with both hands and rub it over her honey-slicked crotch, mixing your demonic pre-seed with her honey as you smear it all over her downy inner thighs.\n\n",
            false
        );
        this.outx(
            '"<i>No, please, it\'ll never fit!</i>" she cries, trying to squirm against your bindings.\n\n',
            false
        );
        this.outx(
        ...
        this.outx(
            "You pull out with a satisfied grunt, enjoying the wet 'schlick' sound your " +
                this.cockDescript(0) +
                " makes as it pulls free of the bee-girl's once-tight hole.  Where once there was a honey-coated slit now resides a gaping monster, drooling a gooey mixture of slime and your tainted demonic seed.  Well, maybe her queen will have an easier time packing her full of eggs.\n\n",
            false
        );
        this.outx(
            "You redress, whistling happily as you prepare to leave.  Your victim is practically unconscious, still shaking from the intense experience and leaking eggs and honey from the organ on her backside.  Do you cut her down or leave her bound up for the locals to enjoy?",
            false
        );
        this.player.orgasm();
    ...
    private freeBeePostRape(): void {
        this.outx("", true);
        this.outx(
            "You take pity on the slut and untie her.  Hopefully she'll recover before something worse finds her.  You'd hate to let a tentacle-beast get your sloppy seconds.",
            false
        );
        this.doNext(this.camp.returnToCampUseOneHour);
        this.dynStats("cor", -1);
    ...
    private leaveBeePostRape(): void {
        this.outx("", true);
        this.outx(
            "You smile cruelly and give her glittering vulva a gentle smack before you walk away, leaving her tied up there.  Maybe some lonely imps will find a use for her...",
            false
        );
        this.doNext(this.camp.returnToCampUseOneHour);
        ...
        if (this.player.cor <= 20 && this.player.findPerk(PerkLib.BulgeArmor) >= 0) {
            ...
            if (
                ...
                this.outx(
                    "  You remove your " +
                        this.player.armorName +
                        ' piece by piece, leaving only the magically-altered centerpiece that your favorite demon ever so generously "<i>gifted</i>" to you.\n\n',
                    false
                );
            // [else]
            else
                this.outx(
                    "  You glare at your " +
                        this.player.armorName +
                        ", its altered state so graciously bestowed upon you by the ever-thoughtful demon that resides in your crotch.\n\n",
                    false
                );
            ...
            this.outx('A voice thrums in your head, "<i>', false);
            // Split based on how often done
            if (this.flags[kFLAGS.TIMES_AUTOFELLATIOED_EXGARTUAN] == 0) {
                this.outx(
                    "This is how you fucking please a dick!  If you aren't going to take care of our needs, then I will!  Every night if I have to!",
                    false
                );
            } else if (this.flags[kFLAGS.TIMES_AUTOFELLATIOED_EXGARTUAN] < 2) {
                this.outx(
                    "Oh come on, remember how hard you came last time?  Why don't you stroke the shaft with your hands and I'll see if I can pump more into your belly.",
                    false
                );
            } else if (this.flags[kFLAGS.TIMES_AUTOFELLATIOED_EXGARTUAN] < 10) {
                this.outx(
                    "How many times have we done this now?  It's probably past time you got used to sucking yourself off at night and quit making a fuss about it.  Now that you're awake, let's put that tongue to use and get to stroking.  I feel a big finish coming!",
                    false
                );
            } else {
                ...
                this.outx(".  We're so horny aren't we, my needy little champion?");
            }
            this.outx('</i>"\n\n', false);
            ...
            if (this.player.cor < 33) {
                ...
                if (this.player.biggestTitSize() >= 2)
                    this.outx(
                        " and bouncing your " + this.allBreastsDescript() + " around it",
                        false
                    );
                this.outx(
                    ".  Moans of pleasure vibrate the " +
                        this.player.cockHead() +
                        " lodged in your throat while bubbles of wetness begin to slide down the lower half of your esophagus into your gullet.\n\n",
                    false
                );
            } else {
                ...
                // (MED+COR, DONE A LOT:
                    ...
                    this.outx(
                        "You grab hold of the swollen flesh with both hands and start to stroke it, reveling at the feel of your palms sliding along the veiny, pre-cum slicked flesh.  You gurgle happily, your moans of pleasure vibrating the " +
                            this.player.cockHead() +
                            " in your esophagus.  The swollen cock-tip dumps globules of pre-cum down your stretched throat, directly into your hungry gullet.  With both eyes crossed and your hands absorbed in fondling your member, you quickly forget your irritation at being woken up in such a way.  You get to cum SO HARD when you're fucking yourself like this!",
                        false
                    );
                    if (this.player.biggestTitSize() >= 2) {
                        this.outx(
                            "  Your biceps squeeze around your " +
                                this.allBreastsDescript() +
                                ", mashing them into your " +
                                this.cockDescript(0) +
                        ...
                        else if (this.player.hasFuckableNipples()) this.outx("  Lubricants ");
                        else if (this.player.biggestLactation() > 1) this.outx("  Milk ");
            ...
            if (this.player.gender == 3) {
                ...
                if (this.player.balls == 0) {
                    ...
                    if (this.player.skinType == SKIN_TYPE_SCALES) this.outx("scales");
                    else this.outx("skin");
                    this.outx(
                        " surrounding your sex, teasing you with the barest hint of sensation while your ignorant hands maul your " +
                            this.cockDescript(0) +
                            " at Exgartuan's behest.  If only you had taken care of yourself earlier, you might have had the control to slip a digit into your " +
                ...
                // (Herms + Balls)
                    ...
                    this.outx(
                        " skin of your outer lips is engorged and ready, but with your hands so focused on your " +
                            this.cockDescript(0) +
                            ", there's little for your " +
                            this.vaginaDescript(0) +
                            " to feel.  The closest it gets to pleasure is the sensation of your " +
                            this.sackDescript() +
                            " slapping against it with the steady rhythm of your masturbation.  If only you had taken care of yourself earlier!  You might have had enough control over your rebellious tool to let a hand attend to your OTHER needs.\n\n",
                        false
                    );
                }
            }
            this.outx(
                "Spit foams around the tumescent intruder's girth, bubbling from the uncontrollable pistoning of Exgartuan's wrath at your " +
                    this.player.face() +
                    ".  The taut, bulging flesh of your own member is rammed so deeply into your own throat that you can feel the pre dripping into your stomach, but you want more.  ",
                false
            );
            if (this.player.cor < 33)
                this.outx(
                    "The desire shocks you with the sheer... wrongness of it, but you cannot deny the pleasure of drilling your own slobbering mouth.",
                    false
                );
            else if (this.player.cor < 66)
                this.outx(
                    "The desire sinks its hooks into the lust-addled flesh of your brain and drags you deeper into lust.  You can't deny the pleasure of drilling your own slobbering mouth.",
                    false
                );
            else
                this.outx(
                    "The desire rushes through your blood as you imagine how you must look, sprawled out, eyes rolled back, and cock drilling at your own slobbering mouth.",
                    false
                );
            this.outx(
                "  Liquid-hot pressure slides over the underside of your " +
                    this.cockDescript(0) +
                    ", licking wetly at the pulsating, need-filled demon-prick.  Your rogue tongue's attentions have the desired effect, and the cries of your pleasure are muffled by your own thick flesh and its rapidly distending urethra.\n\n",
                false
            );

            this.outx("If someone were watching");
            if (
                this.monk >= 5 &&
            ...
            if (this.temp < 50) this.outx("surprisingly light");
            else if (this.temp < 150) this.outx("sticky");
            else if (this.temp < 300) this.outx("large, thick");
            else if (this.temp < 800) this.outx("long, thick blast of your");
            else this.outx("immensely voluminous");
            this.outx(
            ...
            this.outx(
                " with obscene, liquid sloshing.  Your " +
                    ...
                    " and " +
                    this.assDescript() +
                    " rise off the ground with your back as your muscles lock",
                false
            );
            if (this.player.balls > 0)
                this.outx(
            ...
            this.temp = this.player.cumQ();
            if (this.temp > 500) {
                this.outx("  A gradual curve quickly rises on your belly");
                if (this.temp > 1500)
                    this.outx(
            ...
            if (
                ...
                this.outx(
                    "The splatter of mouse-cum erupting in the wood reaches your ears, bringing a wistful smile to your face.  That slutty mouse is such a peeping tom!  ",
                    false
                );
            }
            this.outx(
            ...
            if (this.player.biggestTitSize() < 1) this.outx("over your chest");
            else this.outx("between your tits");
            this.outx(
            ...
            else if (this.player.lib < 80) this.dynStats("lib", 0.5);
            else this.dynStats("lib", 0.25);
    ...
    private exgartuanBulgeTortureII(): void {
        ...
        if (
            this.player.armorName == "crotch-hugging full platemail" ||
            this.player.armorName == "crotch-hugging scale-mail armor"
        )
            this.outx(
                "your " +
                    this.player.armorName +
                    " feels as if it's become incredibly stiff, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.",
                false
            );
        ...
        if (
            this.player.armorName == "crotch-hugging practically indecent steel armor" ||
            this.player.armorName == "crotch-hugging full-body chainmail" ||
            this.player.armorName == "crotch-hugging revealing chainmail bikini"
        )
            this.outx(
                "your " +
                    this.player.armorName +
                    " feels as if it's become incredibly dense, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.  What's worse, the links that make up your armor have narrowed and sealed shut.",
                false
            );
        else
            this.outx(
                "your " +
                    this.player.armorName +
                    ' feels as if it were made from 6</i>" thick steel, refusing to neither budge your package or impart any sense of feeling or vibration to what lies underneath.  You continue to run your hands across it, having trouble believing that the material has become so incredibly dense and rigid despite its appearance.',
                false
            );
        this.outx(
            "  A little more pushing, pulling, knocking, groping, and stroking confirms what you feared: your " +
                this.cockDescript(0) +
        ...
        if (this.player.biggestTitSize() >= 2 && this.player.bRows() == 1)
            this.outx(
                "  Your quest begins squarely on your pair of " +
                    this.chestDesc() +
                    ", your mitts feverishly groping and tugging away in the hope of finding any sanctuary from your encroaching lust.  Unable to extract any meaningful solace from your magnificent mounds, your sights set on your " +
                    this.nippleDescript(0) +
                    "s.",
                false
            );
        // [if ≥2 rows of breasts]
            ...
            this.outx(
                "  The " +
                    this.allBreastsDescript() +
                    " lined down your chest should serve a proper conquest.  Your palms set off to work at once, manhandling as much titflesh as they can satisfy at once.  They dart from one row to the next, inside to out, anything to relieve your libido.  You don't appear to be settling down any, however, so you draw your focus on your top row of " +
                    this.nippleDescript(0) +
                    "s.",
                false
            );
            ...
            this.outx(
                "  With little else to turn to, your " +
                    this.nippleDescript(0) +
        ...
        if (this.player.hasFuckableNipples())
            this.outx(
                "  You waste little time in pushing four fingers into each gaping teat, anxious for any sort of pleasure.  You tickle and tease, push and pull, anything you can think to release you from this torment.",
                false
            );
        else
            this.outx(
                "  A little tapping, tickling, and teasing is about all the effort you can seem to muster.",
                false
            );
        this.outx(
            "  Too preoccupied with whatever's going on down below, you can't seem to focus enough to get the job done right.  Your peer down your body at your " +
                this.cockDescript(0) +
                ", still flaccid and on lockdown.  The most you can respond is with another deep sigh, retreating your attention to the canvas up above you.  You figure the best course of action from here is to just try and make it until morning when you can find some help.  Confessing shame to some third party seems a much better alternative to going any more rounds with this nonsense.  Your fists clench and you take some deep breaths, prepared to ride out the remainder of the night with your sanity intact.\n\n",
            false
        );
    ...
    private exgartuanBulgeTortureIII(): void {
        this.outx("", true);
        this.outx(
            "Fueled by pure spite and just a hint of loathing, you begin to regain some sort of composure through controlled breathing and what little concentration you can manage.  A few minutes of counting stitches in the top of your tent is all you accomplish, however; your once dormant limp " +
                this.cockDescript(0) +
                " is showing a sign of life. Your eyes widen as you feel your possessed pole stiffen up, pressing hard against your " +
                this.player.armorName +
                " as it grows out along with your dick, still impossibly clinging to its every facet.  It stops after only gaining a few inches, but not before driving the fight right back out of you.  Thread-counting is the last thing in your head as you quickly sit right back up, instinctually grasping for your cock.  But the situation refuses to change; your " +
                this.player.armorName +
                " is just as exceedingly resilient as it was before.\n\n",
            false
        );

        this.outx(
            "Your desire only increasing, you begin desperately clawing at the edges of your " +
                this.player.armorName +
                ".  Your stuck skin only grows red from your efforts, eschewing even the notion that it might break free.  Your breathing begins to draw to a panicked pace as you stop and try to form some coherent thought.  The best your lust-addled brain can come up with is to try moving your " +
                this.hipDescript() +
                ", and see if you can make any contact with your imprisoned penis.  Grinding, thrusting... anything you can think of to just make the slightest bit of contact.  However, your only accomplishment is in putting your " +
                this.player.legs() +
                " to sleep.  A tingling sensation works it way down your lower half, followed by numbness.  But before you can start adding that to your frustrations, a glint of something catches your eye- a single bead of pre-cum resting on the tip of your slightly hard " +
                this.cockDescript(0) +
        ...
        if (
            ...
            this.outx(
                "  As you stare in bewilderment, you can't even begin to fathom how it possibly seeped through the steel of your solid " +
                    this.player.armorName,
                false
            );
        // [if armorname IS EQUAL TO \"<i>crotch-hugging practically indecent steel armor</i>\" OR \"<i>crotch-hugging full-body chainmail</i>\" OR \"<i>crotch-hugging revealing chainmail bikini</i>\"]
            ...
            this.outx(
                "  Your fixation on the drop draws to question just how it managed its way through the sealed chains of your " +
                    this.player.armorName,
                false
            );
        else
            this.outx(
                "  A strange feeling of betrayal casts over as you begin to question how the liquid worked its way through the material when none of your struggles have registered even the slightest sensation.",
                false
            );
        this.outx(
            "  You run your thumb and forefinger through it, skeptical of your eyes' discovery.  All it takes is that familiar touch followed by that telltale aroma to further break down what last defenses your brain was mounting against your all-consuming avidity.\n\n",
            false
        );

        this.outx(
            "Eyes re-widened, teeth clenched, you grasp for where the glans of your " +
                this.cockDescript(0) +
                " would be, letting out an anguished groan.  You slam your vision shut in frustration, whirling your body around to begin slamming the unflinching codpiece repeatedly into your bedroll.  Over and over again, the concrete mass just refuses to budge.  Shaking adds on to your list of symptoms brought on by your maddening lust.  Your arms and legs simply unable to maintain your inconsequential thrusting, your body goes limp leaving your midsection held awkwardly in the air by the bane of your existence.  At this point, your breathing has reached a fevered rate while your entire body is moist from sweat.  Running out of options your disoriented wits can work out, your frenzied gaze darts out at the opening of your tent that you neglected to shut earlier.  Desperate to find anything you can use, you begin dragging yourself out of the tent towards the smoldering embers that remain of your campfire, your solid " +
                this.player.armorName +
                " grinding uselessly away beneath you.  It becomes harder to make out where you're going as your vision begins to cloud and shake, your nervous trembling having made its way to your eyes.  It seems to require every fiber of your being with each pull and tug you make, your " +
                this.player.legs() +
                " growing more ineffective as they become more numb and slick.\n\n",
            false
        );
        ...
        this.outx(
            "Your frantic breathing seems to be competing with your pounding heartbeat, acting as if it were emanating from within your skull.  Your hands cling to the dirt and scant pieces of grass below you, unable to stop shaking or heed any of your commands.  Your already obscured vision begins to darken, more and more of the vague blobs fading into darkness.  Your " +
                this.player.legs() +
                " continue their numb strike against you while helping your " +
                this.player.feet() +
                " dig helplessly into the ground.  ...You've run out of ideas, left with an insatiable hunger for sex, a body that refuses to do little more than convulse, and a mound of misfortune where your crotch resides.\n\n",
            false
        );

        this.outx(
            "However, just before you can give up the ghost, the aforementioned mound begins stirring yet again.  A belabored moan is all you can muster, begging for this torment to cease.  Suddenly, the chill air makes contact below your waistline.  You try to raise your head to make sure you haven't gone even more insane, your tense muscles able to lift it enough to see that your " +
                this.player.armorName +
                " has started to split down the middle.  You dig your hands deeper into the ground in an attempt to make sure you haven't started hallucinating, too.  But as the cool air hits your newly exposed skin, any lingering doubts begin to fade away, replaced by mounting awe.  As your outfit continues to crack open, a heady musk hits you like a ton of bricks, furthering your deranged desire.  The rupture continues straight down the middle of your garb, uncovering the base of your cock to the elements and filling it with a newfound life as it begins to pulsate.  Your " +
                this.cockDescript(0) +
        ...
        // [if cocks ≥3]
            ...
            this.outx(
                "  Your extra cocks remain flaccid beside this bronze adonis, as if sapped of all their life.",
                false
            );
        this.outx(
            "  Through the blurry, trembling mess that is your vision, you can make out the mighty titan, its figure silhouetted against the blood-red moon behind it.  After what feels like forever, your majestic manhood slowly descends from its great heights towards you, pulsating in time with your frenzied heartbeat.  As if it were a god descending from heaven to bless a mortal, the " +
                this.cockDescript(0) +
                " stops right above your gaze, its urethra slowly widening, continuing to spill pre-cum all over your plagued form.\n\n",
            false
        );

        this.outx(
            "A lifetime seems to have passed by in that dead stare.  You manage to catch your breath, your shuddering body calming as it prepares for salvation.",
            false
        );
        // [if first occurrence of scene]
        if (this.flags[kFLAGS.EXGARTUAN_TIGHTPANTS_MASTURBATE_COUNT] == 0)
            this.outx(
                "  No words are exchanged; no thoughts dare to cross your mind. The only sound is that of your heart, its rhythm acting as prelude for the action you desperately covet.  Mixed emotions of guilt, fright, awe, and satisfaction claw at you.",
                false
            );
        // [if occurrence ≥2]
        else if (this.flags[kFLAGS.EXGARTUAN_TIGHTPANTS_MASTURBATE_COUNT] < 6)
            this.outx(
                "  \"<i>Your will cannot even begin to compare to my might, my helpless little champion. You really shouldn't continue acting as if you're above temptation; I'd hate to see what would happen.</i>\"",
                false
            );
        // [if occurrence ≥6]
        else if (
            this.flags[kFLAGS.EXGARTUAN_TIGHTPANTS_MASTURBATE_COUNT] >= 6 &&
            this.flags[kFLAGS.EXGARTUAN_TIGHTPANTS_MASTURBATE_COUNT] < 10
        )
            this.outx(
                '  "<i>You know, I never thought I would enjoy even the mere thought of celibacy-not even for a moment.  But watching such an <b>honest</b> champion break down to a quivering pile of helplessness is worth it when the attention I receive afterward is so... thorough.</i>"',
                false
            );
        // [if occurrence ≥10]
        else if (
            ...
            this.outx(
                '"<i>I can keep this up much longer than you can, ' +
                    this.player.armorName +
                    ".  As much as I enjoy watching you struggle to maintain some form of morality and moderation, I would much rather be exploring the world and its many orifices.  Some day you'll leave that fantasy realm you keep running to and join me in the real world.</i>\"",
                false
            );
        // [if occurrence ≥12]
        else
            this.outx(
                "\"<i>Oh, it's that time again, I see.  Sorry, I was still thinking about how much I enjoyed myself the <b>last</b> occasion you tried to forget about me!  Well, let's not waste any more time; you know the routine.</i>\"",
                false
            );
        this.outx("\n\n", false);
        this.outx("Exgartuan.\n\n", false);
        ...
        this.outx(
            'The self-proclaimed "<i>Devil of Dickings</i>" is finally through teasing you.  Before you can begin to think about how to respond- as if you could- something triggers in your mind.  Like a sprinter at the sound of the starting pistol, you leap forward onto him, your arms excitedly grasping all over the ' +
                this.cockDescript(0) +
        ...
        if (this.player.biggestTitSize() > 1)
            this.outx(
                "  Your " +
                    this.chestDesc() +
                    " work just as hard, smothering Exgartuan in all of their jiggly glory.",
                false
            );
        this.outx(
            "  From base to tip, you leave no skin, vein, bump, or glan untraced; all the while covering yourself in the devil's endless demonic drizzle.  Unearthly pleasure responds to your every effort, preparing you to move on to the climax.  You lighten your full embrace, firmly grasping the " +
                this.cockDescript(0) +
        ...
        if (this.player.balls > 0)
            this.outx(
                "  Your " +
                    this.ballsDescriptLight() +
                    " churn with mighty force, roiling in anticipation.",
                false
            );
        this.outx("\n\n", false);
        ...
        // [if cumQ()<50]
        if (this.player.cumQ() < 50) this.outx("modest");
        // [if cumQ()<150]
        else if (this.player.cumQ() < 150) this.outx("sizably sticky");
        // [if cumQ()<300]
        else if (this.player.cumQ() < 300) this.outx("mighty thick");
        // [if cumQ()<800]
        else if (this.player.cumQ() < 800) this.outx("immensely voluminous");
        // [else]
        else this.outx("monumental");
        this.outx(
        ...
        // [cumQ()<500]
        if (this.player.cumQ() < 500) this.outx("a blast of thick demonic jizz");
        // [else]
        else this.outx("a colossal wave of heavy demonic jizz");
        this.outx(
    ...
    private exgartuanBulgeTortureIV(): void {
        this.outx("", true);
        this.outx(
            "You wake the next morning, nestled inside your bedroll.  Realizing where you are, a relaxing feeling of easiness washes over you.  You throw off your cover to greet the day, only becoming confused as it peels off your sticky skin.  You glance down at your waist, still wearing ",
            false
        );
        ...
        this.outx(
            ".  As you rise to your feet, a few streams of cum run down your " +
                this.player.legs() +
                ".",
            false
        );
        ...
        if (this.camp.hasCompanions())
            this.outx(
                "  For a moment, you consider asking someone outside if they remember anything from last night.  But you decide it's better to just keep it to yourself, afraid of what you might find out.",
                false
            );
        // [else]
        else
            this.outx(
                "  You glance around at your tent, searching for anything that may clue you in on what transpired last night.  After a few moments, however, you decide it better to just move on with your day.",
                false
            );
        this.outx(
            "  You pay one more glance to Exgartuan, the " +
                this.cockDescript(0) +
                " comfortably resting away in your outfit.\n\n",
            false
        );
        this.outx("Damn demons.");
        this.player.changeStatusValue(StatusAffects.Exgartuan, 2, 25);
        this.doNext(this.playerMenu);
    }
    ...
    private boobGartuanSURPRISE(): void {
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) {
            ...
            this.outx(
                '"<i>' +
                    this.player.short +
                    '!</i>" he shouts snidely, a sneer working its way across his face, "<i>How long has it been?</i>"\n\n',
                false
            );
            this.outx('"<i>', false);
            ...
            this.outx('</i>" you reply, throwing back his sarcastic expression.\n\n', false);
            ...
            this.outx(
                "The imp snickers to himself, beginning to draw in closer towards you.  There's a bit of a limp to his step, granting an explanation to the cane.  Along the way, the imp extends his walking stick beneath the table, hooking it on a little stepstool and dragging it out in front of you.  Even with the leverage, his eyes only meet your lower lip.  \"<i>Three long years, " +
                    this.player.short +
                    ".  Three years... to take back what's rightfully mine.</i>\"\n\n",
                false
            );
            ...
            this.outx(
                '"<i>Finally, with both idols I can finally unlock Ecsepoan\'s tomb... and claim his ancient power.</i>" Nemus clenches the idol in his palm, his snide expression growing more deranged, "<i>This world will grovel at my feet, as it has always meant to be.</i>"\n\n',
                false
            );

            this.outx(
                'Your face remains calm, a hint of superiority still swimming through it, "<i>Will it really be that simple, Nemus? We both know there\'s more to that tomb than...</i>"\n\n',
                false
            );

            this.outx(
                "Your warning turns to moaning as the imp's hands quickly latch onto your " +
                    this.chestDesc() +
                    ", discarding the walking stick and golden idol to the hard floor.  \"<i>I don't need any of your words of wisdom, " +
                    this.player.short +
                    ',</i>" Nemus teases, his eyes meeting yours while he continues to caress your breasts, "<i>You are little more than my trophy now.  Hardly a position befitting of giving advice, wouldn\'t you agree?</i>" You start to tilt your head back as his grubby mitts continue to grope your massive mammaries.  The fiend slowly moves in on you, his unkempt nails teasing your sensitive ' +
                    this.player.skin() +
                    ".  You begin to feel the rough fabric of his overalls brushing up against you, brought on by his stiffening member.  Nemus continues to draw closer to you.\n\n",
                false
            );
            ...
            if (this.player.cor < 33) this.outx("I always wondered where you kept this.");
            else if (this.player.cor < 66)
                this.outx(
                    "This is one delivery that you'll just have to return to sender, I'm afraid.",
                    false
                );
            else this.outx("You scheme about as well as you fuck, Nemus.");
            this.outx(
    ...
    private boobgartuanSurprise2(): void {
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) {
            ...
            this.outx('"<i>', false);
            if (this.player.cor < 33) this.outx('Hey, Teensy, remember me?</i>"', false);
            // [if corruption ≥30 & <70]
            else if (this.player.cor < 66)
                this.outx(
                    "I see you haven't gotten any prettier since last time we met, Teensy.</i>\"",
                    false
                );
            // [if corruption ≥70]
            else this.outx('Timed to get fucked, stud,</i>"', false);
            this.outx(
            ...
            if (this.player.cor < 33)
                this.outx(
                    "Your " +
                        this.chestDesc() +
                        " brush against the imp's enormous scrotum, causing him to eventually tumble over from the sensation, blocking the impeding entourage of imps behind you.",
                    false
                );
            // [if corruption ≥30 & <70]
            else if (this.player.cor < 66)
                this.outx(
                    "As you coast under the beast, you take the opportunity to slap around his crown jewels, playing them as if they were a novelty pair of bongos.  The sensation causes him to tumble over, blocking the impeding entourage of imps behind you.",
                    false
                );
            else
                this.outx(
                    "A devilish smile cracks across your face as you coast under the lummox, delivering a quick peck of a kiss on his hanging ballsack.  The sensation causes him to tumble over in confusion, blocking the impeding entourage of imps behind you.",
                    false
                );
            this.outx("\n\n", false);
            ...
            this.outx(
                'Nemus is up there barking orders and waving his cane around, his free hand still clutching his wound.  "<i>I want this ' +
                    this.player.mf("asshole", "slut") +
                    ' DEAD! DO WHATEVER IT TAKES!</i>" The burning rage in his eyes sets his comrades into motion.  They leap for the cannons, preparing a final desperate assault against you.  You take this bout of organization as your cue to skedaddle, resuming your bountiful stride towards the exit.  Luckily, the little imps are about as good with their aim as they are at keeping you restrained, the downpour doing little to aid in their quest.  Projectiles destroy everything around you, splinters, dirt, and mud scattering every which way.  You deftly dodge from side to side, easily outmaneuvering everything heading your way.\n\n',
                false
            );
            ...
            this.outx(
                "A jump, a climb, and a showy flip later and you've arrived atop the imps' last line of defense, one more leap away from escape.  You turn back one last time and ",
                false
            );
            // [if corruption <30]
            if (this.player.cor < 33) this.outx("wave goodbye to Nemus");
            // [if corruption ≥30 & <70]
            else if (this.player.cor < 66) this.outx("blow a kiss to Nemus");
            // [if corruption ≥70]
            else this.outx("flip Nemus a mighty bird");
            this.outx(
    ...
    private boobgartuanSurprise3(): void {
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0) {
            this.outx(
                "The moon greets your wide-eyed gaze, bathing you in its dim crimson glow.  Seeing as you don't appear to have drowned, it looks as though you just had a dream... or perhaps a nightmare.  Judging by the stupid things you said, you decide to go with nightmare.  You don't even know a \"<i>Nemus</i>\"... you think.  Anyway, y",
                false
            );
        }
        // [else]
            ...
            this.outx(
                "A light tickle on your chin pulls you from your shut-eye, the familiar blood-red moon greeting your groggy gaze.  Y",
                false
            );
        }
        this.outx(
        ...
        this.outx(
            "Thankfully you were more prepared this time, your reflexes heightened enough to keep you from slamming your noggin yet again.  You also felt just where the shove originated from: your " +
                this.chestDesc() +
                ".  ",
            false
        );
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0)
            this.outx(
                "As you sit up and begin to piece the puzzle together, you're interrupted by a familiar voice, \"<i>You have time to fuck everyone in Mareth silly, but can't be bothered to spend an instant of it with these magnificent mounds?</i>\" You feel your " +
                    this.chestDesc() +
                    " jiggle as Exgartuan speaks, only to have them yank you forward, planting your face back in the ground.  \"<i>I'll just have to make sure you'll never forget again.</i>\"",
                false
            );
        // [if occurrence ≥1]
        else if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 4) {
            this.outx(
                "It's Exgartuan again; you haven't fondled her in a while.  \"<i>Rarin' for another round, eh, champion?</i>\" your " +
                    this.chestDesc() +
                    ' ask you, jiggling furiously for emphasis, "<i>I had hoped the previous lesson',
                false
            );
            // [if occurrence ≥2]
        ...
        // if occurrence ≥4
            ...
            this.outx(
                '</i>"ARE YOU DENSE, CHAMPION?</i>" Exgartuan shouts, your mammoth melons bouncing furiously on her every word, "<i>I will knock you SENSELESS until I clear some space in that vapid cesspool between your ears!</i>" You want to try and calm her down, but your ' +
                    this.chestDesc() +
                    ' promptly launch your face square into the dirt.  "<i>Don\'t go on thinking for another SECOND that you can ignore ME!</i>"',
                false
            );
        // [if occurrence ≥8]
        else
            this.outx(
                "Before another thought can cross your mind, your " +
                    this.chestDesc() +
                    ' fly up and smack you in the gob! "<i>' +
                    this.player.short +
        ...
        if (this.player.cor < 50)
            this.outx("  Exgartuan's tormenting has gone on long enough tonight.");
        else
            this.outx(
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0)
            this.outx(
                '"<i>Don\'t think you can overpower me like those puny imps that infest your dreams, champion.</i>"',
                false
            );
        // [if occurrence ≥1]
        else if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 4)
            this.outx('"<i>We haven\'t even started the curriculum yet, champion.</i>"', false);
        // [occurrence ≥4]
        else if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 8)
            this.outx(
                '"<i>HOW can you forget to caress these cans!?  Tease these teats!?</i>"',
                false
            );
        // [if occurrence ≥8]
        else
            this.outx(
                '"<i>Did you find anything to grab onto this time besides weeds? It doesn\'t look like you have.</i>"',
                false
            );
        this.outx(
            "  You make out a slight warmth radiating through your chest, followed by your " +
                this.chestDesc() +
                " pulling you up into the air!  Your weak bonds to the earth either slip free or unroot, leaving you at the mercy of your possessed pillows.  Not long after you return to your feet does your chest remount its attack, flinging you with ease from side to side while Exgartuan laughs at you.  By the third time you tumble towards the terrain, you finally decide to lock your arms around your mutinous milk cans, your fingers clamping down as hard as they can into your " +
                this.player.skin() +
                ".  Your powerful puppies flow over your death grip, the pressure becoming pleasure, your struggle dissolving into confusion.  The demoness pushes and shakes against your hold as your footing keeps up to compensate.  It seems as though her desire to be fondled is stronger than her desire to fight, your turbulent tatas' harsh movements slowly becoming much more smooth and relaxed.\n\n",
            false
        );
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0)
            this.outx(
                '"<i>Well, I suppose you\'ve had enough, champion,</i>" Exgartuan yields, building lust betraying her usual taunting behavior, "<i>Now why don\'t we move on to what we both want, hm?</i>"',
                false
            );
        // [if occurrence ≥1]
        else if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 4)
            this.outx(
                '"<i>Ready for your final, eh, ' +
                    this.player.short +
                    '?</i>" Exgartuan teases, a faint lustful waver in her voice contrasting against her dominating demeanor, "<i>Let\'s make this one to remember.</i>"',
                false
            );
        // [if occurrence ≥4]
        else if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 8)
            this.outx(
                '"<i>Do you think you\'ll remember now!</i>" Exgartuan shouts exasperatedly, your breasts pushing against your grasp one final time, "<i>Now stop wasting my time and get to the only thing you\'re halfway decent at.</i>"',
                false
            );
        // [if occurrence ≥8]
        else
            this.outx(
                '"<i>I suppose that ends tonight\'s opening act,</i>" Exgartuan goads, her voice as domineering as ever, "<i>I know you\'re dying to get on to the grand finale.</i>"',
                false
            );
        this.outx(
            "  Your solid hold around your " +
                this.chestDesc() +
                " slowly loosens, your tits perking up as they prepare for their much craved attention.  ",
            false
        );
        // [if corruption <50]
        if (this.player.cor < 50)
            this.outx(
                "Though the mounting need to manhandle your mounds is slowly growing, you at least have the wherewithal to brush the mess of dirt and grass off your body before you begin.  You may be slowly succumbing to the evil corruption radiating from your dainty dumplings, but there's no reason you have to look the part, too.  A smooth rock at the edge of the clearing serves as your backrest once you relocate; you would like to at least try to keep from wallowing around in the earth any more tonight.  Even in the dark of the night, you can make out your " +
                    this.chestDesc() +
                    ", defying gravity as they anxiously await your touch, their perky pomp silently degrading your resolve.",
                false
            );
        // [else]
        else
        ...
        this.outx(
            "As your hands rise to get to work, you feel your control over them slip away.  The demoness has rolled into the driver's seat as she tends to do.  ",
            false
        );
        // [if corruption <50]
        if (this.player.cor < 50)
            this.outx(
                "It is becoming increasingly clear to you that she evidently just cannot seem to sit idly by when you actually do decide to pay her heed.",
                false
            );
        // [else]
        else
            this.outx(
                "You're glad to sit back and bask in the expert manhandling that only she can deliver you.",
                false
            );
        this.outx(
        ...
        if (this.player.gender > 0) {
            this.outx(
                "  Your " + this.hipDescript() + " begin grinding together, moist with ",
                false
            );
            // [if cock >0]
            if (this.player.hasCock() && !this.player.hasVagina()) this.outx("pre-cum");
            // [if vagina >0]
            if (this.player.hasVagina() && !this.player.hasCock()) this.outx("juice");
            // [if cock >0, vagina >0]
            if (this.player.hasCock() && this.player.hasVagina())
                this.outx("an aromatic cocktail of pre and juice");
            this.outx(" as your tit massage begins to excite your nether regions.");
        }
        this.outx(
        ...
        this.outx(
            "  You finally bear down and grasp onto... nothing?  <b>Your nipples are nowhere to be found!</b>  The passion is beginning to flatline as you confusedly grope around your " +
                this.chestDesc() +
                '.  "<i>What\'s wrong, champion?</i>" Exgartuan asks knowingly, "<i>Is this too hard for you?</i>" The tips of your fingers comb around your areolas until you discover an inward bend in your ' +
                this.player.skin() +
                " where your nipples should be.  Apparently, Exgartuan isn't through having fun with you; the blasted seductress managed to suck your teats inward!  Before you can fathom just how she pulled it off without your knowledge, your humble howitzers start to tingle.  You feel an anxious quiver work its way up your spine before a familiar need begins to course through your being: the need to be milked!",
            false
        );
        // [if corruption <50]
        if (this.player.cor < 50)
            this.outx(
                "  Brought on artificially or not, you cannot deny it; you would probably be cursing the wretched demoness if you were not already preoccupied contending with your mounting passion and desire.",
                false
            );
        this.outx(
            "  As you paw uselessly at the firm seal, you begin to feel moisture seeping out.",
            false
        );
        // [if not lactating]
        ...
        // [if lacationmultipler <4]
            ...
            this.outx(
                "  <b>Your breasts are only mounting up their lactation to new heights.</b>",
                false
            );
        if (this.player.biggestLactation() < 4) this.player.boostLactation(3);
        this.outx(
            "  But with your nipples in their inverted state, release is a hard sought dream, resulting in your tits slowly expanding as they fill with breastmilk.\n\n",
            false
        );
        ...
        if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] == 0)
            this.outx(
                "Perhaps instead of dreaming of being fucked by imps and raiding tombs, you'll remember to take care of these luscious love muffins.",
                false
            );
        // [if occurrence ≥1]
        else if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 4)
            this.outx(
                "I guess you're ready to graduate.  Just don't forget what you've learned here today.",
                false
            );
        // [if occurrence ≥4]
        else if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 8)
            this.outx(
                "Never again forget that these tantalizing tits are the most important things in your life, champion.  Or I'll make sure that you remember again.",
                false
            );
        // [if occurrence ≥8]
        else
            this.outx(
                "Well, this has been fun, " +
                    this.player.short +
                    ".  I look forward to beating you senseless and enjoying the wonderful makeup massage should you forget to see to my means yet again.",
                false
            );
        this.outx('</i>"\n\n', false);
        ...
        this.outx(
            "Your " +
                this.chestDesc() +
                " begin to rumble and quake, filling you with a mix of anxiety, dread, and passion.  One moment later, an enormous force bursts forth against your hands; your nipples have popped back out, soaking and ready to - wait a second...",
            false
        );
        // [if nipplesPerBreast >1]
        if (this.player.averageNipplesPerBreast() > 1) {
            this.outx(
                "  Where once you had multiple nipples, there now rests one on each breast",
                false
            );
            // [if nippleLength <4]
        ...
        // [if nipplesPerBreast <1 AND nippleLength <4]
            ...
            if (this.player.nippleLength < 4) {
                this.outx(
                    "  Your nipples have become much larger than before, each having swollen to at least four inches in length and around 3 inches in diameter!",
                    false
                );
            } else
                this.outx(
                    "  Your nipples are much thicker than you remember, increasing to at least 3 inches in diameter.",
                    false
                );
        }
        this.outx(
            "  You pay the alterations little mind, though.  Your bewitched bosom has grown at least an entire cup size and is dribbling milk all over you",
            false
        );
        // [if cock or vagina present]
        if (this.player.gender > 0) {
            this.outx(", mixing in with the ");
            // [if cock >0]
            if (this.player.gender == 1) this.outx("pre");
            // [if vagina >0]
        ...
        this.outx(
            "Your hands go to work on your nips, a tug here, a stroke there, your fingers exploring the ins and outs of your titantic teats.  You punch in just a scant number of moments before your faucets reach their crescendo, your hands holding on for all their worth as milk sprays out everywhere, your " +
                this.chestDesc() +
                " writhing with each squirt.  It's hard to make out just how much or how far your cream has gone in the dark, but judging by what seemed like an eon of excitement, you're confident that you've made your mark.  You know that Exgartuan has fallen into her slumber when your otherwise perky pompoms succumb to the laws of gravity and return to their original state, soreness seeping in after a night of tossing, tugging and teasing.",
            false
        );
        // [if corruption <50]
        if (this.player.cor < 50)
    ...
    public exgartuanNagaStoleMyMasturbation(): void {
        ...
        if (this.player.cor < 15)
            this.outx(
                'You sheepishly find some rocks to hide in, where you remove your clothes.  "Keeping me all to yourself, slut? Hide as much as you want, it\'ll never keep me down," Exgartuan gloats.\n\n',
                false
            );

        this.outx("Irritating... ");
        // [if corruption ≥15 & <30]
        if (this.player.cor <= 25)
            this.outx(
                'You make sure you are alone and strip naked.  Exgartuan chides, "Yes, champion, wallow around in the shadows.  Keep pretending you can continue to hide my brilliance from the world."',
                false
            );
        // [if corruption ≥30 & <60]
            ...
            this.outx(
                "You happily remove your " +
                    this.player.armorName +
                    ", eager to pleasure yourself.  Your possessed cock pulses happily as you remove the last article.",
                false
            );
        // [if corruption ≥60 & <80]
        else if (this.player.cor <= 75)
            this.outx(
                "You strip naked in an exaggerated fashion, hoping someone might be watching.  Exgartuan begins flooding you with lust in response to your willing inclination.",
                false
            );
        // [if corruption ≥80]
        else
            this.outx(
                "You strip naked, fondling your naughty bits as you do so and casting seductive looks around, hoping someone or something is nearby to fuck you.  Your demonic dong throbs happily from within you, anxious to move on with the festivities.",
                false
            );
        this.outx("\n\n", false);
        ...
        if (this.player.cor < 33) {
            ...
            // [if cocks == 2]
            if (this.player.cockTotal() == 2)
                this.outx(", your remaining tool hiding away inside you, uninvited.");
            // [if cocks ≥ 3]
            else if (this.player.cockTotal() >= 3)
                this.outx(", your remaining poles hiding away inside you, uninvited.");
            else this.outx(".");
            this.outx(
            ...
            this.outx(
                'Well, you had planned on it.  Your arms have frozen in place above your unholy pecker.  "I have no need for your inexperienced fumbling today, my needy little slut.  Sit back and tremble as I rock your world."\n\n',
                false
            );
        }
        // [if corruption ≥33 & <66]
        if (this.player.cor > 33 && this.player.cor < 66) {
            this.outx("  You shouldn't be looking forward to this, should you?");
            this.outx(
                "  You haven't even quite figured out just how much of the pleasure one of these sessions garners is actually genuine.  But that doesn't make it any less savory.  \"What's wrong, " +
                    this.player.short +
                    '," your perverse pecker chimes in, obviously reacting to your internal conflict, "Having any second thoughts?  You aren\'t suddenly feeling as if you\'re above the fun I have on tap, are you?"\n\n',
                false
            );

            this.outx(
                "No, wait, it's pretty fucking clear you love the fucking; it's the fucking demon that you fucking can't tolerate.  You think.  Fuck.  You shake your head to try and clear your thoughts, focusing on what you came over here to do.  Your erect " +
                    this.cockDescript(0) +
        ...
        // [else]
            ...
            if (this.player.cockTotal() == 2)
                this.outx(
                    "  Speaking of resisting, it appears your second tool has been forced to stay in the shed.",
                    false
                );
            // [if cocks ≥ 3]
            else if (this.player.cockTotal() >= 3)
                this.outx(
                    "  Speaking of resisting, it appears your remaining tools have been forced to stay in the shed.",
                    false
                );
            this.outx(
                "  Your " +
                    this.cockDescript(0) +
                    " makes good on its end of the bargain by pumping out its own never-ending supply of lubricant, making your master massage all the more slick and smooth along its surface.  You lay off for a moment to admire your work, your demonic dong throbbing happily now that its full of blood and as tall and thick as a tree.  The corrupt warmth and comfort flowing through your body pleases you to no end.\n\n",
                false
            );
        ...
        if (this.player.inte > 9)
            this.outx(
                "You aren't stupid; you can hazard more than just a guess as to what's about to happen.",
                false
            );
        // [else]
        ...
        if (this.player.cocks[0].cockLength >= this.player.tallness * 0.5)
            this.outx(
                "  There's not quite enough of you to fully envelop the horny monument, however.  Its head pokes out of the top of the scaley volcano, continuing to spew its not-quite-so-molten lava.",
                false
            );
        // [else]
        else
            this.outx(
                "  As impressive as Exgartuan's mighty length is in these lands, your tail is plenty capable of completely enveloping the titan in its scaley embrace.",
                false
            );
        this.outx(
        ...
        this.outx(
            "Self stimulation should never feel this good.  This doesn't even seem like masturbation.  All you've been able to contribute to this action are clenched fists, various sounds, and shuffling expressions.  ",
            false
        );
        // [if corruption <33]
        if (this.player.cor < 33)
            this.outx(
                "\"<i>You can't measure up to treatment of this magnitude, champion,\" Exgarutan insults you, his voice trembling as the slick massage persists, \"But don't think that I'm giving you permission to slack off.  A slut like you can go on dreaming; one day maybe you'll have the perseverance to get close.\"",
                false
            );
        // [if corruption ≥33 & <66]
        else if (this.player.cor < 66)
            this.outx(
                "Your corrupt cock begins to speak up, the demon's unrelenting motions refusing to ease off, \"You're loving every bit of this champion.  There isn't a hint of uncertainty lingering in your senses.  If only you were this accepting all the time.\"",
                false
            );
        // [else]
        else
            this.outx(
                "\"<i>Isn't this great, " +
                    this.player.short +
                    "? With both of our sexual expertise combined, we'll own this land in no time, and enjoy the fuck out of any downtime.\"",
                false
            );
        this.outx(
        ...
        this.outx(
            " load working its way up your " +
                this.cockDescript(0) +
                "... and stop.  You sit up in an involuntary attempt to release the pressure, only to be met by your coiled-up shaft bending to greet your face, its urethra spread wide open...\n\n",
            false
        );
