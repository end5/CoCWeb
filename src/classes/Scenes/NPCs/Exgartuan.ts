...
export class Exgartuan extends NPCAwareContent implements TimeAwareInterface {
    ...
    */
            ...
            // (+Lust in combat) for girls
                ...
                switch (select) {
                    ...
                    case 2:
                        ...
                        if (this.player.cor < 50)
                            this.outputText(
                                "  That's terrible!  It's all that demon's fault!",
                                false
                            );
                        break;
                    case 3:
    ...
    private exgartuanSleepSurprise(): void {
        ...
        if (this.player.cor <= 20 && this.player.findPerk(PerkLib.BulgeArmor) >= 0) {
            ...
            if (this.flags[kFLAGS.TIMES_AUTOFELLATIOED_EXGARTUAN] == 0) {
                ...
                this.outputText(
                    "Wakey wakey sleepyhead.  You know the routine.  Go ahead, ",
                    false
                );
            ...
            if (this.player.cor < 33) {
                ...
                if (this.flags[kFLAGS.TIMES_AUTOFELLATIOED_EXGARTUAN] < 5) {
                    ...
                    if (this.player.biggestTitSize() >= 2)
                        ...
                        this.outputText(
                            "you squeeze and caress your " + this.cockDescript(0),
                            false
                        );
                    this.outputText(
            ...
            if (
                ...
                this.outputText(
                    ", and judging by Jojo's high pitched whines, he certainly is,",
                    false
                );
            this.outputText(
    ...
    private exgartuanBulgeTortureIV(): void {
        ...
        else this.outputText("the single piece of your " + this.player.armorName, false);
        this.outputText(
    ...
    private boobgartuanSurprise3(): void {
        ...
        // [if occurrence ≥1]
            ...
            this.outputText(
                '"<i>We haven\'t even started the curriculum yet, champion.</i>"',
                false
            );
        // [occurrence ≥4]
        else if (this.flags[kFLAGS.BOOBGARTUAN_SURPRISE_COUNT] < 8)
    ...
    public exgartuanNagaStoleMyMasturbation(): void {
        ...
        if (this.player.cor > 33 && this.player.cor < 66) {
            ...
            if (this.player.cockTotal() == 2)
                this.outputText(
                    ", your remaining tool still hiding away inside you, uninvited.",
                    false
                );
            // [if cocks ≥ 3]
            else if (this.player.cockTotal() > 2)
                this.outputText(
                    ", your remaining poles still hiding away inside you, uninvited.",
                    false
                );
            else
                this.outputText(
        ...
        // [else]
            ...
            this.outputText(
                "You may be stupid, but it's incredibly clear what's going on here.",
                false
            );
        this.outputText(
