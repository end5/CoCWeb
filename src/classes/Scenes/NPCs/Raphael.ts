...
export class Raphael extends NPCAwareContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        if (this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER] > 1 && this.player.gems >= 5)
            this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER]--;
        ...
        if (
            ...
            this.flags[kFLAGS.RAPHAEL_DRESS_TIMER] = 4;
        return false;
    }
    ...
    public timeChangeLarge(): boolean {
        if (
            ...
            this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER] >= 0 &&
            this.player.hasKeyItem("Camp - Chest") >= 0 &&
            this.player.gems >= 5 &&
            ...
            if (this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == 0) {
                ...
                if (this.RaphaelLikes()) {
                    ...
                    if (this.flags[kFLAGS.RAPHAEL_MET] == 0) {
                        ...
                        // Already met!
                        if (
                            this.flags[kFLAGS.RAPHAEL_DRESS_TIMER] == 0 &&
                            this.flags[kFLAGS.RAPHAEL_SECOND_DATE] == 0
                        ) {
                            // Not given dress yet
                            this.outx("<b>\nSomething unusual happens that morning...</b>\n");
                        ...
                        if (
                            this.player.armor == this.armors.R_BDYST &&
                            this.flags[kFLAGS.RAPHAEL_DRESS_TIMER] > 1 &&
                            this.flags[kFLAGS.RAPHAEL_DRESS_TIMER] <= 4
                        ) {
                            this.outx("<b>\nSomething unusual happens that morning...</b>\n");
            ...
            } else if (this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == 1) {
                // FINALE
                this.outx("<b>\nSomething unusual happens that morning...</b>\n");
    ...
    public RaphaelLikes(): boolean {
        ...
        if (!this.player.isBiped()) return false;
    ...
    private meetRaphaelPtII(): void {
        this.outx("", true);
        this.outx(
            "Suddenly, Raphael's features grow soft and surprised as he looks down upon you. You get the feeling he's eyeing you up and catching a peek at your cleavage, but you can't be sure.\n\n",
            false
        );

        this.outx(
            '"<i>Marae must have cursed me for my audacity, for I am growing blind even at my young age.</i>" The fox puts his hand to his forehead and pretends to faint. He rights himself just before he hits the ground, however and lands in a kneel before your feet.\n\n',
            false
        );

        this.outx(
            "You can't help but smile a little at the amount of theatrical flourish.\n\n",
            false
        );

        this.outx(
            '"<i>Here I thought I had searched the entire camp, found every treasure, pilfered every gem...</i>" He states while sauntering towards you in a disarming, wide stride. "<i>... but it seems I\'ve overlooked the greatest jewel of all!</i>" Raphael kneels before you, taking you by the hand and planting a kiss upon it. "<i>Can you ever forgive me for my blindness, my fair lady?</i>" He takes your hand in both his paws, while looking deeply into your eyes. His own are a deep emerald green, contrasting sharply with his bright red coat. They are set below a sturdy brow that gives him playful maturity and a rough regal elegance.\n\n',
            false
        );
    ...
    private RaphaelFirstMeetingSLAP(): void {
        this.outx("", true);
        this.outx(
            "With an offended scowl you throw a flat palm across his face. You make sure to catch his nose and sharp snout, sending him a clear message.\n\n",
            false
        );

        this.outx(
            "It takes Raphael completely by surprise. The fox keeps his head in the wake of the blow for a good five seconds in disbelief, but tries once more when he recovers.\n\n",
            false
        );

        this.outx(
            '"<i>I can assure you señorita, that I had no intention of tainting your honor.</i>" He pats your hand.\n\n',
            false
        );

        this.outx(
            "This time you wrestle your hand from Raphael's hold and throw him the heavier back of your hand, sending him to fall on his back. You're actually getting angry at him. How dare he sneak into your camp, try to rob you and then seduce you! By the time it occurs to you to actually apprehend him, Raphael has already beaten a hasty retreat by hopping back up on the wall.\n\n",
            false
        );
        ...
        this.outx(
            'Raphael curtsies and tips his hat before making his escape. "<i>You have my condolences.</i>"\n\n',
            false
        );

        this.outx(
            "You resolve to wash your hand. You're sure you've not seen the last of the russet rogue, but it will be time in coming before that happens with the severity of your rejection.",
            false
        );
    ...
    private RaphaelFirstMeetingSWOON(): void {
        this.outx("", true);
        this.outx(
            "You snicker softly, shift your weight on one leg and blush a little. He's quite the charmer; almost good enough to forgive him for robbing you. The attention he showers you with doesn't leave you cold either.\n\n",
            false
        );

        this.outx(
            '"<i>Normally I rob opulent merchants and criminals. I have no idea what drew me into your camp. Perhaps destiny willed this fateful meeting?</i>" He looks up and burrs with a suave accent. "<i>Then again, I am attracted to extraordinary splendor.</i>" He gazes at you with an emerald shimmer in his rich green eyes.\n\n',
            false
        );

        this.outx("Curious, you finally ask him who he really is.\n\n", false);

        this.outx(
            '"<i>Why I am Raphael!</i>" He lisps affectionately and rises slowly. "<i>Adventurer extraordinaire, redistributors of misplaced wealth and connoisseur of all things fine in life.</i>" He strides into camp with the kind of respectful confidence that makes the place his own. He pops open the tightly locked trunk with the mere kick of the boot and places his ill-gotten gains back into your belongings. "<i>The orphanage will have to wait. Tonight, I will regale the small ones with tales of exceptional beauty instead.</i>"\n\n',
            false
        );
        ...
        this.outx(
            '"<i>For now, do not worry yourself my shining jewel. The russet rogue never forgets a mark. I will answer all your questions in good stead, but for now, patience. I can already tell a woman like you is deserving of delicacy and finesse, like the blooming rose needs nurturing and time to reveal her innermost beauty.</i>"\n\n',
            false
        );

        this.outx(
            'In a blink of an eye, the red fox jumps back up the wall. "<i>We will meet again!</i>" He exclaims in a hushed tone, while slinking over to the other side of the wall.\n\n',
            false
        );

        this.outx("You hold the hand he touched close to your chest.");
    ...
    private RaphaelFirstMeetingTALK(): void {
        ...
        this.outx(
            "You squint your eyes at him, pulling on your arm to wrestle it from his hold. When you remark he stole from you and ask him to return your goods, Raphael simply throws you a vulpine smirk.\n\n",
            false
        );

        this.outx(
            '"<i>Mere souvenirs fair blossom, to remind me of your beauty!</i>" He schmoozes and strides into camp with the kind of confidence that makes him own the place. He pops open the tightly locked trunk with the mere kick of a boot and places his ill-gotten gains back into your belongings. From within the large sack, he pinches a small pouch of your gems and quickly spirits it away. With his lightning quick fingers, you see him place it between his shoulders.\n\n',
            false
        );

        this.outx(
            'You insist he return all of it, but the Russet Rogue merely smiles as he walks back towards you. "<i>My, whatever do you mean, pretty señorita? Are you accusing me of being less than forthright?</i>" He raises his shoulders.\n\n',
            false
        );

        this.outx(
            "Tiring of his charades, you reach behind his neck to retrieve the pilfered pouch, but when you do, there is none to be found. It's the only place he could have put it, but it's gone and he isn't using his arms! You frown. It's clear that the fox is as good as his reputation. He's hiding the pouch with the skill of a pickpocket. You begin to consider how he does it, but before you do, the fox comments on your body posture.\n\n",
            false
        );

        this.outx(
            "\"<i>My, aren't we frisky. What happened to foreplay? Shouldn't you be buying me dinner before you ravish me? Breakfast perhaps?</i>\" Raphael clucks. You jump away as you realize you've had your hands all over his body.\n\n",
            false
        );

        this.outx(
            '"<i>No, my lady. If you ever want to inspect these particular goods, we will have to meet again!</i>"  Raphael hops up the same wall, spinning about on one leg. "<i>Do not worry yourself, my fair flower. The russet rogue never leaves a lady wanting. For now, patience. I can already tell a woman like you is deserving of delicacy and finesse, like the blooming rose needs nurturing and time to present her full glory.</i>"\n\n',
            false
        );

        this.outx(
            'In a blink of an eye, the red fox jumps back up the wall. "<i>We will meet again!</i>" He exclaims in a hushed tone, while slinking over the wall to land on the other side.\n\n',
            false
        );
    ...
    private RaphaelDress(): void {
        this.outx("", true);
        this.outx(
            "A small pebble hits the ground near you, waking you up. When a second one hits, you're sure someone is trying to draw your attention.\n\n",
            false
        );

        this.outx(
            "Rubbing your eyes, you pull yourself out of bed, wondering what's going on. Sticking your head through the front wall of your tent, you take a curious peek outside, but find no one around.\n\n",
            false
        );

        this.outx(
            "The first thing you do is open your storage chest, to see if the Russet Rogue has robbed you again. This doesn't appear to be the case, and instantly, your eye is drawn to an addition instead of a subtraction from its contents. You seem to have gained a new outfit! Upon a carefully folded fabric of rose red color, a note is left below a gorgeous ruby pendant upon a golden setting and carried by a filigree chain. Curiously, you open the note and read it.\n\n",
            false
        );

        this.outx(
            '"<i>I happened across this beautiful ensemble and was instantly reminded of the one thing in Mareth that makes its splendor pale in comparison. Fair trappings, to fit around a beautiful body.\n\n',
            false
        );

        this.outx("Yours faithfully,\n  - The Russet Rogue\n\n", false);

        this.outx(
            'P.S. The clothes are my gift to you. I would delight to see you wear it whenever you desire to meet. Ownership of the ruby however, remains to be seen.</i>"\n\n',
            false
        );

        this.outx(
            "You hold the ruby pendant to the light. It must be priceless. Its crimson shimmer is enough to make you forget to ask yourself where Raphael could have gotten it from. You wonder what he means by ownership. It very clearly is in your possession now.\n\n",
            false
        );

        this.outx(
            "Soon enough you put it down and begin to inspect the equally lustrous garment he left you. You unfold it and marvel at the Bordeaux colored clothes.",
            false
        );
        // nxt page
    ...
    private RaphaelEncounterIIDressFollowup(): void {
        ...
        this.outx(
            "You awake to the soft patter of footsteps moving away from you. For a second you think nothing of it, but soon awake to the realization you might have been robbed again. When you sit up and notice a weight off your chest, you realize someone has made off with the priceless ruby pendant Raphael gifted you earlier. They swiped it straight off your neck!\n\n",
            false
        );

        this.outx(
            "You rush out of your tent, but when you look around and spot something red lying on the small ruined wall on the outskirts of your camp, you realize that the situation isn't as urgent as you had feared. You begin to understand what the wily fox meant to imply with uncertain ownership of the pendant.\n\n",
            false
        );

        this.outx(
            "Curious, you amble towards the Russet Rogue. Raphael, this time armed with a picnic basket and a bottle of fine wine, makes a nonchalant impression as he lies leisurely on top of the wall. His tail flicks about playfully, while he swirls a small amount of wine within a crystal glass. At first he looks at the fluid casually and takes a sip, before rolling his head sideways to look down upon you.\n\n",
            false
        );
        ...
        if (this.RaphaelLikes()) {
            this.outx(
                '"<i>How long ago was it, that you had a decent breakfast, hhhmmm?</i>" He smirks. "<i>One that didn\'t include imp gut and hellhound testicles. A worn out camp like this one is no place for a lady. Let me at least endeavor to give a woman of your caliber a taste of the good life.</i>"\n\n',
                false
            );

            this.outx(
                "When you inspect the rest of his body, it's clear that Raphael is still the sly fox. Your ruby pendant hangs from his belt. He has once again stolen it from you after gifting it earlier, like it was some game. When he notices your interest, he flicks his tail over it, causing the necklace to disappear.\n\n",
                false
            );

            this.outx(
                '"<i>The temporary price of admission for a moment of wonder.</i>" He assures you. "<i>Trust me that it\'ll be worth it. Join me, and I might even teach you the tricks of the trade. That is, unless you\'re cunning enough to frisk me for it.</i>" He smiles playfully.\n\n',
                false
            );
        ...
        // ({If player does not meet the first encounter requirements:}
            ...
            this.outx("When he catches sight of you, he spurts out the sip.\n\n", false);

            this.outx(
                '"<i>Mon Dieu!</i>" he states in shock and stands up on top of his wall.\n\n',
                false
            );

            this.outx(
                '"<i>What terrible tragedy! The land has taken its toll on the once so beautiful.</i>" He looks down on you.\n\n',
                false
            );
            ...
            if (
                ...
                this.outx(
                    '"<i>You\'re missing half your body!</i>" He refers to your morphed legs.\n\n',
                    false
                );
            // ({If player has above E cup breasts}
            if (this.player.biggestTitSize() >= 7)
                this.outx(
                    '"<i>Your female curves... replaced with such... udders!</i>" He looks at your bosom. "<i>No woman could be elegant with such monstrosities up front!</i>"\n\n',
                    false
                );
            // ({If player has below C cup breasts}
            if (this.player.biggestTitSize() < 3)
                this.outx(
                    '"<i>Your female curves... gone!</i>" He looks at your bosom. "<i>It\'s hard to tell you apart from a little girl!</i>"\n\n',
                    false
                );
            // ({If player has grown less than girly hips}
            if (this.player.hipRating < 6)
                this.outx(
                    '"<i>What happened to that fine hourglass shaped figure? Those comely hips?</i>"\n\n',
                    false
                );
            // ({If player has gotten a massive butt}
            ...
            if (this.player.tallness > 72)
                this.outx(
                    'Raphael rolls his eyes across your giant body and looks intimidated. "<i>I can forget about remaining unseen when I take someone of your size somewhere!</i>"\n\n',
                    false
                );
            // ({If female player has gotten smaller than 4 feet}
            if (this.player.tallness < 48)
                this.outx(
                    "Raphael squints like he has trouble seeing you from there, because of your dimunitive size. \"<i>I've dated goblins once... didn't work out.</i>\"\n\n",
                    false
                );
            // ({If player has grown ANY cock and balls}
            if (this.player.balls > 0 || this.player.cockTotal() > 0)
                this.outx(
                    '"<i>What is that bulge below the tight outfit I gave you?</i>" The fox inspects your groin. "<i>No, never mind. I don\'t want to know.</i>"\n\n',
                    false
                );
            // (For now:
            // ({If player has lost all gender}
            if (this.player.gender == 0)
                this.outx(
                    '"<i>There\'s... something different about you today. Your smell, it has changed.</i>"\n\n',
                    false
                );

            this.outx(
                "The fox looks dissapointed. \"<i>Beauty is in the eye of the beholder, but it certainly isn't gracing mine right now.  señorita... or what remains of you, please clean yourself up. Meanwhile, I just remembered: I have a sick mother to take care of. I hope you'll excuse me!</i>\" he mentions before hopping back of the wall and making a hasty retreat.\n\n",
                false
            );

            this.outx("You clench your jaw as he vanishes, more than a bit offended.");
    ...
    private RaphaelSelectDate(): void {
        this.outx("", true);
        this.outx(
            "You smile bashfully, not expecting this sort of gesture from anyone in Mareth. You hardly care about the pendant and you nod at him.\n\n",
            false
        );

        this.outx(
            '"<i>Ha-ha!</i>" Raphael hops to his feet on top the wall and gloats at you. "<i>You\'re sure you\'re ready for this journey? Because I\'m going to show you the time of your life!</i>" He kneels down on top his wall and extends you his hand on approach.\n\n',
            false
        );

        this.outx(
            "It almost feels like you're consenting when you reach for his soft, cushioned padded furry paw, after which he pulls you up and helps you over the wall.",
            false
        );
        // {Unlocks Picnic}
    ...
    private RaphaelChooseFrisk(): void {
        ...
        this.outx("", true);
        this.outx(
            "You flash a playful smile and express the desire to get your jewelry back.\n\n",
            false
        );

        this.outx(
            "Challenged, Raphael hops from his perch and leans against the wall like a misbehaved rascal at your approach. With his back towards the boulders, he has his hands behind his head and one foot up against the stacked cobblestone; braving his body like he's eager for your touch. \"<i>My, whatever are you talking about, señorita? Know something I don't?</i>\"\n\n",
            false
        );

        this.outx(
            "Noticing how Raphael leaves more room between his hands and his head than necessary, you reach beind his neck to retrieve the pilfered pendant, but when you do, there is none to be found. It's the only place he could have put it, but it's gone and he isn't using his arms!\n\n",
            false
        );
        ...
        if (this.player.inte < 24 && this.player.spe < 24 && this.player.cor < 19) {
            this.outx(
                "You frown, befuddled and eyeing the body you hold close to yours. He must be a magician, you conclude.\n\n",
                false
            );

            this.outx(
                "When you look up again, you realize you have your arms around his neck. His verdant green eyes peer into yours daringly and before the awkward moment has a chance to pass, the russet rogue steals a kiss. Putting the tip of his snout on your lips, he gives you a kiss more passionate and skilled than you thought possible with a sharp muzzle such as his. He discontinues before you have the time to either enjoy it or feel intimidated by it.\n\n",
                false
            );

            this.outx(
                '"<i>Forgive me...</i>" He growls softly with low tone. "<i>You\'re just so cute when consternated.</i>"\n\n',
                false
            );

            this.outx(
                '"<i>But the day is young!</i>" He proclaims before slipping from your hold and up the wall, extending you his paw. "<i>Join me! Together we shall paint the forest russet red!</i>" He winks at you while pulling you up. "<i>Maybe I could even show you how I do it, huh?</i>"\n\n',
                false
            );
            // {Next scene picnic}
            this.doNext(this.RaphaelPicnic);
        ...
        // ({Int or Spe between 24-36 and Cor is not higher than that}
            ...
            this.outx(
                "Not outdone through wit, you notice how the fox is moving his tail about. The wileful rogue is using his fifth limb to move the pendant about his body! You quickly reach around and pat him across the back and flanks, but inspecting the tip of his tail leaves the pendant nowhere to be found. By then Raphael is moving his arms and legs to misplace it further. In a game of cat and mouse all through his red fur, you follow the movement from his lower back, to his feet and his thighs. The sly vulpine clearly enjoys leading you on your hunt across his skin and supple deerskin attire, as you graze over taut leather spanned across a contoured, masculine body. Raphael always appears one step ahead. That is, until the trail ends near his crotch.\n\n",
                false
            );
            ...
            if (this.player.cor <= 15)
                this.outx(
                    "You have the stronge urge to grab hold of the oddly enlarged bulge between his legs and retrieve the necklace from within his pants, but the lewdness of the gesture keeps you from it.\n\n",
                    false
                );
            // {If player corruption is at or higher than 15}
            else
                this.outx(
                    "With no intention to relent, you grab him by the oddly enlarged bulge in his tight leather pants and squeeze softly, discovering how several of his jewels are harder than others. He hid your gem amongst his own!\n\n",
                    false
                );

            this.outx(
                '"<i>My, aren\'t we frisky. What happened to foreplay? Shouldn\'t you be buying me dinner before you ravish me? Breakfast perhaps?</i>" Raphael clucks. "<i>Although frankly.</i>" He growls softly with low tone. "<i>I would gladly suffer through a thousand indignities, for a mere touch from one such as you.</i>"\n\n',
                false
            );

            this.outx(
                '"<i>But the day is young!</i>" He proclaims before slipping from your hold and up the wall, extending you his paw. "<i>Join me! Together we shall paint the forest russet red!</i>" He winks at you while pulling you up. "<i>You have skill though. Stick with me and maybe I can teach you.</i>"\n\n',
                false
            );
            // {Next scene picnic}
            this.doNext(this.RaphaelPicnic);
        ...
        // {If player's corruption is higher than 19 and higher than Intelligence.}
            ...
            this.outx('"<i>My, such an eager little thing.</i>" He comments, pleased.\n\n', false);

            this.outx(
                "You ask yourself the age old question if he's just happy to see you, but you suspect differently when you reach out for the firm lump and cup it.\n\n",
                false
            );
    ...
    private friskAcceptChoice(): void {
        ...
        this.outx("", true);
        this.outx(
            '"<i>Come on then!</i>" He proclaims before shooting up the wall, extending you his paw. "<i>Join me! Together we shall paint the forest russet red!</i>"\n\n',
            false
        );

        this.outx(
            'You waive his paw and choose to walk around the 8 foot long wall, instead of struggling to climb over it. Raphael flashes a grin of delight when you do. "<i>I can see I\'ve caught on to a smart one! Stick with me and I could even finish your education. I promise that graduation will be something... special.</i>"\n\n',
            false
        );
        // {Next scene picnic}
        this.doNext(this.RaphaelPicnic);
    ...
    private friskRejectChoice(): void {
        this.outx("", true);
        this.outx(
            "You scoff, cross your arms and reject the offer by telling Raph your answer from across your shoulder, with your back still turned to him aloofly. Pleased with yourself, you add that he's nothing more than a carnie with an accent and that you won't be needing his help.\n\n",
            false
        );

        this.outx(
            '"<i>As you say, my desert rose. It is clear that I have no more to teach you then.</i>"\n\n',
            false
        );

        this.outx(
            "You startle when you hear the fox bang against your chest. When you turn around, he's once again stealing from you!\n\n",
            false
        );

        this.outx(
            '"<i>There\'s no teaching those of lesser stock a sense of grace and refinement. Those are still decidedly my domain!</i>" He guffaws with a bag of goods across his back and runs off.\n\n',
            false
        );

        this.outx(
            '"<i>Even without a belt on?</i>" You ask him, holding up the leather strap he wore across his waist a mere minute ago. You took the time to swipe it along with the pendant.\n\n',
            false
        );

        this.outx(
            "As Raphael bolts, he has a look of surprise on his face. He doesn't last long before his pants drop to his ankles and he falls flat on his face.\n\n",
            false
        );

        this.outx(
            "He yelps when he loses hold of the bag, which drops to the ground. The fox uses both hands to protect his modesty by holding up his pantaloons, slipping over the spilt gems a few good times and flailing about, before finally making it to the wall with nothing to show for it.\n\n",
            false
        );

        this.outx(
            '"<i>I will regain my honor!</i>" He exclaims while waving his hands in a theatrical flourish, causing his pants to drop once more.\n\n',
            false
        );

        this.outx(
            "You laugh as he blushes, beating a sound retreat. You're sure this won't be the last you'll see of him however.",
            false
        );
        // {Game removal}
        this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER] = 14;
    ...
    private friskFondleChoice(): void {
        this.outx("", true);
        this.outx(
            "You gently massage the leathery package. It increases in size until a distinct shape of some length forms above it. When Raphael moves his hips forward appreciatively, you look up, throw him a smile and slip your hand into his pants. He's not wearing any underwear, you notice as you rummage about. Struggling to restrain yourself, you slip past the throbbing meat of his naked cock and dig around his jewels instead, removing the ruby from behind them.\n\n",
            false
        );

        this.outx(
            '"<i>Such a good girl you are.</i>" He smirks lewdly. "<i>You have a lot of talent in those fingers. A distinct gift. There\'s a lot I could show a feisty little minx such as you.</i>"\n\n',
            false
        );

        this.outx(
            "You deftly remove the sweat stained, fogged up stones and tug them away between your breasts.\n\n",
            false
        );

        this.outx('"<i>And I in turn, will have to retrieve those.</i>" He growls low.\n\n', false);

        this.outx(
            '"<i>But the day is young!</i>" He proclaims before shooting up the wall and extending you his paw. "<i>Join me! Together we shall paint the forest russet red!</i>" He winks at you while pulling you up. "<i>Stick with me and I could finish your education. I will promise that your graduation will be... everything you hoped for. Like the wild mare is shown what is expected from her, the russet rogue never leaves a lady wanting.</i>"\n\n',
            false
        );
        this.dynStats("str", -1, "tou", -1, "spe", 3, "sen", 1, "lus", 25);
        // {Next scene Picnic}
    ...
    private friskSqueezeChoice(): void {
        this.outx("", true);
        this.outx(
            "Vicious and eager to teach him some humility, you dig into the tender package and squeeze hard enough to drive the sharp edges of your pendant into Raphael's jewels. The fox immediately grabs you by the wrist, but this is one trap he isn't wriggling out of. You drive him to his knees while he lets out a high pitched, muffled squeal replete with a blank, agonized expression on his face.\n\n",
            false
        );

        this.outx(
            '"<i>You have some balls stealing from me fox.</i>" You comment and grin. "<i>Just checking. Is that too soft or should I squeeze harder?</i>"\n\n',
            false
        );

        this.outx(
            "Raphael shakes his head while a tear wells up in his eyes. When you roll his privates into the sharp edges, he finally lets out a cry loud enough to hear from miles away.\n\n",
            false
        );

        this.outx(
            "You chuckle and look around you to see if anyone heard. When you look back to see him squirming between your fingers however, all you're holding onto is the ruby pendant. Raphael has pulled off an amazing switching trick and has escaped. Instead, he stands on top the wall panting and defiant.\n\n",
            false
        );

        this.outx(
            '"<i>I\'ll be sure to repay the favor.</i>" He warns you with a high pitched voice while clasping his poor genitals. "<i>Nobody touches my goods like that and gets away with it.</i>"\n\n',
            false
        );

        this.outx(
            'He raises just a single finger to the air and groans painfully. "<i>We will meet again!</i>"\n\n',
            false
        );
    ...
    private RaphaelPicnicII(): void {
        this.outx("", true);
        this.outx(
            "You clear your throat and look at the fox knowingly. A look only returned to him by a coy smile of innocence, while he pours you another glass. You'll indulge him for now...\n\n",
            false
        );
    ...
    private RaphaelPicnicEnd(): void {
        ...
        if (this.flags[kFLAGS.FUCK_OFF_THEIVING_RAPHAEL] == 0) {
            ...
            this.outx(
                "A minute of silence follows and just when it has been long enough to reassure you, he makes his excuses and sets about heading back to... whatever it is the sly fox spends his days doing.\n\n",
                false
            );

            this.outx("You recollect yourself and head back to camp.");
        }
        this.doNext(this.playerMenu);
    }
    ...
    private RaphaelPicnicSkill(): void {
        ...
        if (this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 0) {
            this.outx(
                "You allow yourself to be distracted by the sheer opulence of the picnic. Crystal glasses, fine linen blanket, intricately woven basket... and then the clothes and pendant he put on you. Where does he get these things from? It almost leaves you jealous. While you peer across the arrangement, Raphael even manages to retrieve a small guitar. With his long slender fingers, he picks the snares and fine-tunes it. When the Russet Rogue frowns seriously and occupies himself with the small instrument - cradling in its arms focusing on its tortured plinks - you notice just how dedicated and dashing he is.\n\n",
                false
            );

            this.outx(
                "Whatever else is on display however, your eye is consistently caught by the fox's rapier. Raphael has left it sheathed in a scabbard reinforced with silver upon the hard brown leather. The sword's guard sticks out from the sheath and is fashioned out of fine golden filigree that domes around a red hilt. The weapon makes you curious. It appears so delicate that you can hardly believe it to be serviceable in battle.\n\n",
                false
            );

            this.outx(
                'When you ask Raphael if such a small weapon ever managed to impress anyone, he snaps one of the snares in shock and draws a long face. "<i>It is not a thin, flimsy thing!</i>" He balks in his unique accent and loses his cool for a moment. "<i>I\'ll have you know it\'s perfectly average compared to those of others!</i>" He defends himself with an excitable hand gesture.\n\n',
                false
            );

            this.outx(
                "There's a moment of awkward silence as you realize the young man places more pride in his sword than you thought. However, Raphael recollects himself with a smile and chuckles at himself like he's been had by someone who just doesn't understand.\n\n",
                false
            );

            this.outx(
                '"<i>No, my lady. This is a man\'s weapon in every definition of the word.</i>" He beams and picks it up, pulling the blade from the sheath with a cold iron swish. "<i>Notice how its long hard length stands tall and fierce upon a sturdy hilt designed for deep thrusts.</i>"\n\n',
                false
            );

            this.outx(
                'Holding it up, it indeed gleams sensually in the sun. However, Raphael then points it downwards and directly at you, carefully tracing the point across your outfit. You can feel the cool edge glide across. "<i>Notice the roving tip, how she searches for an opening upon a quivering body\'s wavering guard.</i>"\n\n',
                false
            );

            this.outx(
                "When Raphael places the point between your breasts, you cannot help but stare at the steely needle with fascination. Driven by long steel, the sharp tip feels heavy enough to slide into your flesh in a single thrust. The feeling is only stronger for wearing an outfit such as yours, leaving your body so acutely vulnerable against the outside world. You stand corrected; there is something very intimidating about it.\n\n",
                false
            );

            this.outx(
                '"<i>Could I learn to use it?</i>" You ask Raphael, who then begins to snicker into his fist and snorts unseemly.\n\n',
                false
            );

            this.outx(
                'When you don\'t flinch and just stare at him in earnest, the fox looks up with surprise. "<i>Oh, you are serious about that?</i>" He remarks and snaps out of it by adopting the coy frown typical of the wileful fox.\n\n',
                false
            );

            this.outx(
                'When you ask him if he thinks that\'s weird, the vulpine rogue shakes his head. "<i>Not at all mademoiselle. In fact, I am of the opinion that every woman of your remarkable beauty should know how to defend herself. Perish the thought of having to relinquish your womanhood to anything other than a true gentleman, or having it ravished by beasts instead. And if you must fight, I cannot think of a weapon more suited for a woman than the rapier. I would be honored to teach you.</i>"\n\n',
                false
            );

            this.outx('"<i>Shall we?</i>" He jumps to his feet and extends you an arm.\n\n', false);

            this.outx(
                'When you ask him if you shouldn\'t be wearing armor instead of wafer-thin silk bodystockings, he laughs. "<i>I assure you. For the Rapier, you are dressed perfectly.</i>"\n\n',
                false
            );
        ...
        if (this.player.spe < 30 || this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 0) {
            ...
            this.outx(
                '"<i>Join me my fine fae, and I will teach you to dance.</i>" He states while discarding the blade.\n\n',
                false
            );

            this.outx(
                '"<i>Dance?</i>" You mumble with a smile, walking up to him and taking him by his hand.\n\n',
                false
            );

            this.outx(
                '"<i>Dance!</i>" He snarls certain, wrapping his paw around your waist and pulling you close to him.\n\n',
                false
            );

            this.outx(
                "Raphael tries to lead you off into a slow tango, but obviously overestimates the amount of nimbleness you own feet possess. You quickly rectify this by tripping over his boots and stepping on his toes. Each time provokes a little yelp from the fox, who soon realizes he has his work cut out for him. Whatever Raphael is, he does not give up easy, and you soon dance the morning away on top of his tortured toes.\n\n",
                false
            );

            this.outx(
                "In the end, you're forced to stop practice at Raphael's urging, barely even developing a sense for rhythm. You're simply not fast enough to keep up with the fox... yet. Meanwhile the poor fox has taken off his boots and has seated himself upon a nearby boulder, where he tries to rub the feeling back into his sensitive feet. You can't help but smile a little at your own bungling and feel sorry for the daunting amount of time and effort Raphael needed to put into you with so little to show for it. With you in hand, the otherwise delicate dancer is slowed down into a broken mess. You are determined to try and get better at it though.\n\n",
                false
            );

            this.outx(
                '"<i>I was very impressed by your earlier show.</i>" You walk over and reassure him. Raphael looks somewhat discouraged.\n\n',
                false
            );

            this.outx(
                '"<i>That was the most beautiful thing I ever saw. Do you really think I could ever master that much elegance and refinement, mister fox?</i>" You chime appreciatively, running a teasing finger down his neck.\n\n',
                false
            );

            this.outx(
                'Raphael\'s smile returns for him. "<i>Raphael!</i>" He burrs. "<i>And for someone like you I\'d gladly suffer a dozen broken toes at once!</i>" He boasts. "<i>I will teach you grace becoming of your beauty yet!</i>"\n\n',
                false
            );

            this.outx(
                '"<i>Again!</i>" He stands up and extends you an arm with renewed energy.',
                false
            );
            this.dynStats("str", -1, "tou", -1, "spe", 3, "sen", 1, "lus", 25);
        ...
        // {Fencing practice variables: Speed 30-39 Must play out at least once}
            ...
            this.outx(
                '<i>"Magnefique."</i> Raphael comments, pleased.  <i>"You could use some work on how to wield it properly, but only because you weren\'t born with one in hand like I was."</i> He smiles, saunters closer to you and releases the rapier from your intoxicated grip by fondling your fingers.  <i>"You still need a master to show you how to thrust and parry properly."</i>\n\n',
                false
            );
        ...
        // {Warning when you have 50 speed, played through all 3 variables and choose {Skill} at the opening picnic}
            ...
            this.outx(
                "Regardless of the picnic's splendor, you are quickly drawn to Raphael's rapier again, having gained real feelings for the weapons during your previous sessions with it.  The fox chuckles.  <i>\"My fair fae; she is a woman of taste.  She knows what she wants.\"</i>\n\n",
                false
            );
            ...
            this.outx('<i>"Would you like to own it?"</i> he suddenly asks you.\n\n', false);
            ...
            this.outx(
                '<i>"Spar with me over it."</i> The master fencer challenges you to what could only be an impossible fight.  He has taught you everything you know about fencing.\n\n',
                false
            );
    ...
    private fenceOfferChangeToDiscuss(): void {
        this.outx("You blush, intimidated, and change the subject.\n\n", true);
    ...
    private fenceRaphaelSexily(): void {
        ...
        this.outx(
            '<i>"En garde,"</i> the fox states with confidence, calm playfulness, and certain arrogance.\n\n',
            false
        );
    ...
    private fenceRaphaelSexilyPtII(): void {
        ...
        this.outx(
            '<i>"My lady,"</i> the fox states delicately, <i>"that was truly magnificent.  You are a natural, I can tell."</i>\n\n',
            false
        );
        ...
        if (this.player.inte > 49) {
            this.outx(
                "Still possessing the fighting spirit of earlier and enough wits to resist him, it seems fitting to stand your ground and you push Raphael away from you.  Surprised, he looks you in the eyes and realizes you're still very much in control of your mind and of the situation.  To take you roughly on the moss instead of sweeping you off your feet would be a thing unbecoming of the refined fox. He needs you to consent, to win the game.\n\n",
                false
            );

            this.outx(
                '<i>"I have never met a woman with your skills in the rapier,"</i> he sighs at you.  <i>"My lady, I must have you.  It would only be right."</i>\n\n',
                false
            );

            this.outx(
                '<i>"Oh my, are you soliciting me, mister fox?  Right here in the wilds, crudely upon the moss?"</i> you tease coyly.  <i>"Wouldn\'t that mean I lose the game?"</i>\n\n',
                false
            );
    ...
    private RaphaelPostFenceSex(): void {
        ...
        this.outx(
            "You tremble as Raphael shifts back, angles his cock into the furrow of your womanhood and takes your moist opening in a single inward incursion.  ",
            false
        );
        this.player.cuntChange(12, true);
        this.outx(
            "After that he slowly begins to oscillate into you.  You're turned into a wreck as you hold on for dear life, feeling the russet rogue enter you repeatedly.  His paw continues to trace around your body to tease your tits or bother your lovebud.  Your one remaining foot has long since begun to buckle under the repeated bumps against your g-spot.  Raphael does not have an impressive girth, but he uses it well in rapid plunges into your yielding loins.  He often changes his angle, until not an inch of your loosening walls have been deprived of an pleasurable inner invasion, as he brushes into your walls with deep lunges.\n\n",
            false
        );

        this.outx(
            "Finally, you can bear it no more with his hot breath across your neck.  Your body convulses limply around his upright impalement, the fox still standing tall and firm.  You try to close your leg or slip down his body, but with two firm hands Raphael holds you in climactic embrace like captured prey.  Only after you howl and rock your hips forth to the involuntary rhythm of orgasm does Raphael allow you to drop to the moss. The dew-dappled meadows feel like salvation, but little do you know that it does not end there.\n\n",
            false
        );

        this.outx(
            "With a victorious glint, Raphael rolls you on your back while you're still dazed.  The fox, taking the sash from his hips and tying either end around your knees, brings your legs towards your chest.  He holds them there without any effort on the part of either of you, by putting his chest down on the cloth tied between them and mounting you again, lying on top of you.  More deep thrusts follow, this time deep enough for the tip to titilate even your cervix, while the slender knot at his base parts the sensitive entrance a little wider with every bottoming bump into you.\n\n",
            false
        );

        this.outx(
            "It is how you spend the rest of that morning, filled a thousands times over and constantly driven past the edge of orgasmic bliss by the master fencer's trained thrusts.  His civilized smile has long since given way to the mean smirk of a sexual victor driving his victim to the edge of madness.",
            false
        );
        this.player.orgasm();
    ...
    private postRaphaelCoitus(): void {
        ...
        this.outx(
            "When you wake up on a bed of soft moss, Raphael has disappeared completely.\n\n",
            false
        );
        ...
        if (this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 4) {
            this.outx(
                "The only thing left behind is his rapier, sticking out of the moss.  He's bound it with his red sash around the length like a ribbon, as though he has now gifted it to you.  Perhaps it is his way of congratulating you.\n\n",
                false
            );
        ...
        if (this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 4) {
            this.outx(
                "However, you realize he's left you with more than just pleasant memories of sitting with him around the picnic.  Realizing how skillfully you declined him and how deftly you led him around, you realize you may have mastered his art of keeping another's attention and leading them around with cunning and acting.  This misdirection could have great applications in battle.\n\n",
                false
            );
        ...
        this.outx(
            "You return to camp, having cleaned up the picnic and taking the rations that were left with you.  You can't help but wonder if you'll ever see him again though.\n\n",
            false
        );
    ...
    private declinePuttingOutForRogues(): void {
        this.outx("", true);
        this.outx(
            '<i>"No."</i> You shake your head, dropping the atonal monosyllable as if it were the last note in a musical play.\n\n',
            false
        );

        this.outx(
            "The horny fox frowns.  It's like raising an invincible shield between you.  He reaches out towards your face and body, but he cannot touch anymore.\n\n",
            false
        );

        this.outx(
            "Some of the magic of the moment is still there in the fine young man leaning over your aroused body.  He could still take you right there and right now and you know you'd probably enjoy it too.  However, it would be unseemly.  It would be to rape an equal and to Raphael, that would deprive him too of the dignity he tries so hard to maintain.  You can tell it from his face; the agonized quandary.\n\n",
            false
        );

        this.outx(
            "When he gets off your body, you've won.  You've caught Raphael in his own game.  You've led him around.  He'd probably do anything for it, but cannot obtain it.\n\n",
            false
        );

        this.outx(
            '<i>"Fine,"</i> he mumbles.  He rolls off and sits sulking a few paces away from you.  It\'s the first time the young man fails to keep a cheerful attitude.\n\n',
            false
        );

        this.outx(
            "You smile, a bit sorry for the way you broke him, but you try to convince him that he shouldn't mope.  The two of you had fun.  It's getting late and you occupy yourself with cleaning up the picnic.\n\n",
            false
        );

        this.outx(
            'After a small while, the fox finally speaks.  <i>"It seems like there isn\'t anything more I can teach you,"</i> the fox claims.  <i>"... I\'m proud of you, my greatest student."</i>\n\n',
            false
        );

        this.outx("You turn around to smile at him.  However, Raphael has vanished.\n\n", false);

        // ({When player had reached the SPE fencing apex}
        if (this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 4) {
            this.outx(
                "The only thing left behind is his rapier, sticking out of the moss. He's bound it with his red sash around the length like a ribbon, like he has now gifted it to you. Perhaps it is his way of congratulating you.\n\n",
                false
            );
            // [Weapon: Rapier. Speed, instead of strength, influences the damage rating. Never as strong as the heavier weapons or sword, but works great with speed & evasion, encouraged by the rapier.])
            this.inventory.takeItem(this.weapons.RRAPIER, this.playerMenu);
        ...
        if (this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 4) {
            this.outx(
                "You realize he's left you with more than just pleasant memories of sitting with him around the picnic, though. Realizing how skillfully you declined him and how deftly you led him around, you realize you may have mastered his art of keeping another's attention and leading them around with cunning and acting. This misdirection could have great applications in battle.\n\n",
                false
            );
            // [Optional Perk: Misdirection. Intelligence adds to the chance to evade. Turns you into a true rogue together with the bodysuit.])
            this.player.createPerk(PerkLib.Misdirection, 0, 0, 0, 0);
        ...
        this.outx(
            "You return to camp, having cleaned up the picnic and taking the rations that were left with you.  You can't help but wonder if you'll ever see him again.\n\n",
            false
        );
    ...
    private RaphaelPicnicChooseThieving(newl = true): void {
        ...
        // {Int Thieving Apex Warning: When the PC's intelligence is at 50 or higher.}
            ...
            this.outx(
                "You've gotten used to dealing with the rogue, at least in respects to witty repartee and jousts of flirting.  You disregard the exuberant display of food between you, as you size up your opponent.  His rapier is lying exactly between the two of you, even though steel has not been the weapon you've engaged him with last.\n\n",
                false
            );

            this.outx(
                "The fox is doing the exact same thing. It seems that the longer you have spent time with him, the broader that fine, sharp, attractive head of his has become.  In the same light, you also notice how there's something different about him today.  He has the same playful smile, but while he lies on his side leaning on a single elbow, he also has a patient, determined look about him.  When he scoops up a bottle of wine and wields it like a phallic symbol pouring you another glass, there's an imposing quality about him that you thought he lost earlier.\n\n",
                false
            );

            this.outx(
                '<i>"Ready for another chat, mademoiselle?"</i> he drawls lusciously.\n\n',
                false
            );

            this.outx(
                "You realize that he's preparing for the long haul.  You might not get off quite as easily as earlier, should you decide to flirt with him again.\n\n",
                false
            );

            this.outx(
                "It occurs to you to change the subject to that of the rapier at his side but you are equally drawn to engaging the fox and satisfying your... curiosity.\n\n",
                false
            );
    ...
    private thieveryEnding(): void {
        ...
        this.outx(
            "A brooch that can only be described as priceless decorates the soft silk sash.  ",
            false
        );
        // ({When player has not reached the apex of fencing lessons/Optional: and also has less than 60 speed}
        if (this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] != 4)
            this.outx(
                "You try to reach for the magnificent ornament hanging off his hips, but as the fox continues to move, you lack the nimbleness to remove it.\n\n",
                false
            );
        // ({When player has also reached the apex of fencing lessons
        else
            this.outx(
                "You reach and fondle the magnificent ornament hanging off his hips. With a few nimble flicks of your fingers, you manage to get it off.\n\n",
                false
            );
        ...
        this.outx(
            "You're enjoying yourself and so is Raphael, for as long as you keep the illusion up he might manage to woo his way into your pants.  He's so fragile right now.  You're almost literally holding the horny fox's desires and pride in the palm of your hand.  You are in complete control.\n\n",
            false
        );

        this.outx(
            '<i>"I have never before met a woman of your breathtaking insight.  Of such deep beauty."</i>  He sighs at you.  <i>"My lady, I must have you,"</i> he burrs.\n\n',
            false
        );

        this.outx(
            '<i>"Oh my, are you soliciting me, mister fox? Right here in the wilds, crudely upon the moss?"</i> you answer coyly.  <i>"Wouldn\'t that mean I lose the game?"</i>\n\n',
            false
        );
    ...
    private RaphaelThieverySmex(): void {
        this.outx("", true);
        this.outx(
            "You need no words.  You place your hand on the back of Raphael's neck and pull his lisping tongue closer to your ears.  After that, you lose yourself to the weight of a man atop you as the fox starts tending to your quivering body.\n\n",
            false
        );
        ...
        this.outx(
            "With a victorious glint, the fox takes the sash from his hips and, tying either end around your knees, brings your legs towards your chest. He holds them there without any effort on the part of either of you, by putting his chest down on the cloth tied between them and mounting you again, lying on top of you. More deep thrusts follow, this time deep enough for the tip to titilate even your cervix, while the slender knot at his base parts the sensitive entrance a little wider with every bottoming bump into you.\n\n",
            false
        );

        this.outx(
            "It is how you spend the rest of that morning, filled a thousands times over and constantly driven past the edge of orgasmic bliss by the master fencer's trained thrusts. His civilized smile has long since given way to the mean smirk of a sexual victor, driving his prey to the edge of madness.",
            false
        );
    ...
    private RaphaelThieverySmexPtII(): void {
        ...
        if (this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 4) {
            ...
            // [Optional Perk: Misdirection. Intelligence adds to the chance to evade. Turns you into a true rogue together with the bodysuit.])
            this.player.createPerk(PerkLib.Misdirection, 0, 0, 0, 0);
            this.outx("(Gained Perk: Misdirection!)\n\n");
        }
        this.outx(
            "You return to camp, having cleaned up the picnic and taking the rations that were left with you. You can't help but wonder if you'll ever see him again though.",
            false
    ...
    private quiksilverFawkesEndGame(): void {
        ...
        if (this.flags[kFLAGS.REJECTED_RAPHAEL] == 1) {
            this.outx(
                "You're immediately confused and you ask him what's going on, but the fox is out of breath.  What's more, a similar howl now calls out from the opposite direction too!  Whatever these sounds are or this fog is, they have the camp surrounded!\n\n",
                false
            );
        }
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00149] == 1) {
            this.outx(
                "You're a bit miffed at the fox.  You haven't heard from him for more than a week after he slept with you, and now he only shows up because he's looking for help.  The fox however, is out of breath.  What's more; a similar howl now calls out from the opposite direction too!  Whatever these sounds are or this fog is, they have the camp surrounded!\n\n",
                false
            );
        }

        this.outx(
            '<i>"They hound me night and day!  I can\'t outrun them any longer!"</i> he wheezes.  <i>"Please!  You don\'t know what they\'ll do to me when they catch me!"</i>\n\n',
            false
        );

        this.outx(
            "You don't have the chance to respond before the sounds of snapping branches and rustling leaves near camp.  Raphael jumps up and dives into the barrel you keep in camp for the storage of water, hiding himself and leaving you to face the oncoming threats by yourself.\n\n",
            false
        );

        this.outx(
            "In the hazy distance, you spot a massive shadow rushing through the mist and it dissapears before you get a good look.  An eerie silence follows and you sharpen your eyes and hearing to the danger.  When you look up, your heart sinks as the massive shape has jumped up and now descends on you from above.  It happens so fast that you barely realize what's going on.  Before you know it, you're sent sliding across the floor with the dark shape on top of you, pinning you down to the ground with its weight.\n\n",
            false
        );

        this.outx(
            '<i>"Smelled of elderberries, huh?"</i> it snarls.  <i>"And what was that about my mother?"</i> When you open your eyes again, you\'re greeted by a row of razor-sharp white teeth, set in a pitch-black face. Above them, two smoldering yellow eyes stare down on you, infuriated.\n\n',
            false
        );

        this.outx('<i>"Hati!"</i> an identical voice calls out from elsewhere.\n\n', false);

        this.outx(
            'Suddenly, the teeth above you vanish and the eyes grow soft and surprised.  <i>"Oh!"</i> the shadow exclaims, its expression apologetic and startled.\n\n',
            false
        );

        this.outx(
            "It removes itself from atop your body.  After having the breath knocked out of you, you take a moment to recover it and finally manage to get back up and meet the two monsters of the mist.",
            false
        );
    ...
    private QuiksilverFawkesPtII(): void {
        ...
        if (this.flags[kFLAGS.REJECTED_RAPHAEL] == 1)
            this.outx(
                '<i>"I can smell traces of him,"</i> Hati states, nearing the waterbarrel, <i>"but it\'s hard to tell.  There\'re too many other scents here."</i>\n\n',
                false
            );
        // Played around/special ending
        else
            this.outx(
                'Hati breaks into the conversation.  <i>"She must know.  The entire camp reeks of him. She has his scent on her.  I can smell strong trails leading towards a nearby meadow.  A bit stale.  Might have been a while ago."</i>  He nears the water barrel.  <i>"...but it\'s hard to tell. There\'s too many other scents here."</i>\n\n',
                false
            );

        this.outx(
            "Your heart jumps as Hati manages to discover a pile of Raphael's clothes, near the barrel.  It's irrefutable proof.  Raphael must have put them there to throw the wolves off.  Hati gives you a look of dissapointment.  <i>\"He's nude. They must have slept together.\"</i>",
            false
        );
        // ({If player is wearing red bodysuit}
        if (this.player.armorName == "red, high-society bodysuit")
            this.outx(
                "  Suddenly, his eyes and ears perk.  <i>\"Isn't that the stolen clothing of the widow Camembert that she's wearing? You know, before she mysteriously dropped the charges after a nightly visit from the fox? Should we confiscate it anyway?\"</i>",
                false
            );
        this.outx("\n\n", false);

        this.outx(
            '<i>"Come now, Hati. No need to concern ourselves with that,"</i> Skoll reproves.  <i>"I\'m sure we can rely on our upstanding citizens not to actively harbor a criminal."</i>  He looms in over you.\n\n',
            false
        );
        ...
        this.outx(
            "You glance at your waterbarrel.  Hati is keeping an obsessive watch over the water's surface, like he's already closed in on the fox.\n\n",
            false
        );

        this.outx(
            "You could sell Raphael out, or you could cover for him.  What do you do?",
            false
        );
    ...
    private coverForRaphael(): void {
        this.outx("", true);
        this.outx(
            "You stare back into the wolf's yellow eyes, keep a stiff back and answer him.  <i>\"I'm not seeing him right now.\"</i>\n\n",
            false
        );
        ...
        if (this.player.cor < 30)
            this.outx(
                "You instantly feel bad for lying to the wolf. More so because he doesn't get troubled, disappointed or vexed.  He seems to instantly believe you... or at least, he wants to believe you, even though being a detective probably keeps him cynical.  You'll only be adding to that cynicism if he discovers your lie.\n\n",
                false
            );

        this.outx(
            '<i>"Cute answer,"</i> his partner remarks, taking a break from staring at the water barrel.\n\n',
            false
        );
        this.outx(
            'Your hair stands upright when he leans back in over the barrel and appears to look down into the water, but you struggle not to slake a sigh of relief when he merely starts drinking from it instead.  A few long laps with his tongue and the wolf is sent cringing and shaking his head at the taste.  <i>"Even the water tastes of him."</i>\n\n',
            false
        );

        this.outx(
            '<i>"Hati, enough!"</i> The wolf in front of you turns his head, throws back his cuneate ears and snarls at his partner.  <i>"We\'re not in the habit of throwing around accusations without material proof."</i>  His anger starts to decrease. <i>"Don\'t help Raphael turn us into the bad guys."</i>  Skoll turns back to you with just as much friendly patience as ever.  <i>"I\'m sure she would have told us if she knew anything about that."</i>',
            false
        );
        // ({If cor is below 30}
        if (this.player.cor < 30)
            this.outx(
                "  You slowly shake your head, tortured by the trusting twinkle in the wolf's soft yellow eyes.",
                false
            );
        this.outx("\n\n", false);

        this.outx(
            '<i>"The trail is strongest over towards the meadows.  He might have gone there."</i> Hati remarks after circling your camp one more time.\n\n',
            false
        );

        this.outx(
            '<i>"I hope you will let us know when you see him again..."</i>  Skoll nods at you, his feral features pulling away from you.\n\n',
            false
        );

        this.outx(
            "Skoll picks up Raphael's clothes.  The two brothers then get on all four of their limbs and speed off into the fog.  Fierce, dangerous beasts they are.\n\n",
            false
        );
        // ~~~ Next page ~~~
    ...
    private coverForRaphaelII(): void {
        ...
        this.outx(
            "It doesn't take more than a minute for Raphael to make use of the wolves' departure.  Not even bothering to climb out with dignity, he tips the barrel over as he rushes out of the water.  Like a drowned cat, he climbs out coughing and gasping for air on all fours.\n\n",
            false
        );

        this.outx(
            "He hasn't lost his ways however.  The first words out of him are as suave and composed as ever.\n\n",
            false
        );

        this.outx(
            '<i>"Merci, mademoiselle,"</i> he wheezes softly.  <i>"You have whisked me away from the snatches of great injustice, as well as a fair share of humiliation.  Normally I am capable of outrunning them myself, but it seems that faith has blessed me with a guardian angel on the day I find myself less capable."</i>\n\n',
            false
        );

        this.outx(
            "You're upset towards him for asking you to lie to law enforcement, but Raphael's current state keeps you from being too furious.  He's not so bushy anymore.  His soaked hair falls flat against his body and causes him to lose quite a bit of his imposing physique. Strands of it run across his face. You spend a little time yelling at him, though.\n\n",
            false
        );

        this.outx(
            '<i>"No.  It is nothing like that,"</i> he splutters, in response to one of your rants.  <i>"We go way back.  The wolves and Urta, they carry out a personal vendatta against me that has no bearing on the law."</i>\n\n',
            false
        );

        this.outx("You spend some time considering the dubiosity of this revelation.\n\n", false);

        this.outx(
            '<i>"Please, señorita."</i>  He manages to rise to one knee.  <i>"Is this the face of a hardened criminal?"</i>  He looks up and into your eyes with his own brilliant green ones.  He\'s still a mess, hair disheveled and his features weather-beaten, but he\'ll dry up again eventually, to be dashing once again.  <i>"Since when have I treated you anything less than courteously?  A handful of gems, certainly, yes, but do I deserve such police brutality because of that?  Do I deserve to be hunted down in the forests and carried through the streets in chains?  Just because my antics leave the world with a smile?"</i>\n\n',
            false
        );

        this.outx(
            "Before you manage to answer him, Raphael rushes back to his usual spot on the small crumbled wall on the outskirts of the camp proper.  Not as quick as previously, tired and weary perhaps, but still quite fast.  He doesn't seem so intimidating without his clothes on.  Knowing shame, unlike the wolves, the young man even covers his privates with a leg bent sideways.\n\n",
            false
        );

        this.outx(
            '<i>"Mademoiselle, this day, I owe you a great boon.  The russet rogue never forgets a debt.  Visit Tel\'Adre after things die down and look for the orphanage.  You will be welcomed like a queen! Ah-ha!"</i> he exclaims, before hopping down the wall.\n\n',
            false
        );

        this.outx(
            "You blink as he fades off into the mist and you're left to absorb the morning's events by yourself.  For a minute you're concerned with the wolves, but at least you've managed to keep Raphael as a friend.  Though, you are curious what he means by 'orphanage'.",
            false
        );
        // Concludify things
    ...
    private betrayRaphael(): void {
        ...
        this.outx(
            '<i>"Tell it to Urta and the judge,"</i> one of the wolves announces loudly, causing the other to chuckle.  <i>"You have the right to remain silent. Anything you say will make us hold something against you, not necessarily in the court of law."</i> Sullenly, Raphael quiets down inside the sealed barrel.\n\n',
            false
        );

        this.outx(
            'Effortlessly, one of the wolves lifts the barrel up onto his shoulder.  Before he carries it off, he throws one more look backwards and beams at you. <i>"Check in with Urta.  She will reimburse you for the barrel, along with rewarding you with the outstanding bounty on our foxy friend.  Visit even later than that and you might even be allowed to enjoy his sentence."</i>\n\n',
            false
        );

        this.outx(
            "The other spends a little longer regarding you, wagging his tail playfully and smiling a friendly smile at you.  He then looks back and sees his brother heading in the wrong way.  <i>\"We're not heading back to Tel'Adre right away?\"</i>  His voice is almost as low as his brother's.\n\n",
            false
        );

        this.outx(
            '<i>"We caught him in record time,"</i> Skoll remarks.  <i>"I\'m sure Urta won\'t mind it if we keep him for ourselves for just a day.  You know... collect evidence... interrogate the culprit..."</i>  His voice is carried off by the mist.\n\n',
            false
        );

        this.outx(
            "Hati throws you one more amicable glance before turning, getting on all fours, and running off.\n\n",
            false
        );

        this.outx(
            "You blink as he fades and you're left to reflect on these morning's events by yourself.  For a minute you're concerned for the fox, but the wolves don't seem like the types to harm him... much.  You are curious what they plan to do with him and what his 'sentence' might be, though.",
            false
        );
    ...
    private raphaelIntroPageTwo(): void {
        this.clearOutput();
        this.outx(
            '"<i>This place isn\'t really an orphanage, is it?</i>" you ascertain sagely, still waiting for a reply.'
        );
        this.outx(
    ...
    private getTheFuckOutOfDodge(): void {
        this.clearOutput();
        this.outx(
            'You politely inform Raphael that you have to go, and though he seems crestfallen, he demurs, "<i>Very well then, ma chère.  I shall await you in the hours of late evening, in case you change your mind.</i>"'
        );
        this.outx("\n\nWell, that went well.");
    ...
    private cunnilingusWithRaphael(): void {
        ...
        if (this.player.wetness() < 3) this.outx("your cunt fluttering");
        // ({Medium wetness multiplier}
        else if (this.player.wetness() < 4)
            this.outx("sending out a small spurt of femcum landing on your belly");
        // ({High wetness multiplier}
        else this.outx("gushing a torrent of femcum into the air");
        this.outx(
            ".  Raphael backs off a bit afterwards, giving you a few more laps of admiration around the throbbing fissure and cleaning you of any spillage. He ends with a tiny kiss, just inside your inner thigh."
        );
        this.player.orgasm();
        this.dynStats("sen", -2);
        this.doNext(this.camp.returnToCampUseOneHour);
