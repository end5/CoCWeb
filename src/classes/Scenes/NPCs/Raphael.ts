...
export class Raphael extends NPCAwareContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        if (this.flags[kFLAGS.RAPHAEL_DRESS_TIMER] > 1 && this.player.gems >= 5) this.flags[kFLAGS.RAPHAEL_DRESS_TIMER]--;
        if (this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER] > 1 && this.player.gems >= 5) this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER]--;
        //Fix 'hangs' - PC is at the bottom of the dress countdown
        if (this.flags[kFLAGS.RAPHAEL_DRESS_TIMER] == 1 && this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == 0 && this.RaphaelLikes()) this.flags[kFLAGS.RAPHAEL_DRESS_TIMER] = 4;
        return false;
    }

    public timeChangeLarge(): boolean {
        if (this.checkedRussetRogue++ == 0 && this.model.time.hours == 6 && this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER] >= 0 && this.player.hasKeyItem("Camp - Chest") >= 0 && this.player.gems >= 5 && this.player.statusAffectv1(StatusAffects.TelAdre) >= 1) {
            ...
            if (this.flags[kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == 0) { //Countdown to finale not currently engaged!
                ...
                if (this.RaphaelLikes()) { //Not yet met!  MEETING TIEM!
                    ...
                    //Finale!
                    if (this.flags[kFLAGS.RAPHAEL_DRESS_TIMER] == 1) {
                        this.flags[kFLAGS.RAPHAEL_DRESS_TIMER] = -1;
    ...
    private RaphaelDressPtII(): void {
        ...
        //({If player has tail}
        if (this.player.tailType > TAIL_TYPE_NONE) this.outputText("  Your tail peeks out through the cut.", false);
        ...
        this.flags[kFLAGS.RAPHAEL_DRESS_TIMER] = 7;
    ...
    private RaphaelChooseFrisk(): void {
        this.flags[kFLAGS.FUCK_YOU_GOT_MINE_RAPHAEL] = 0;
        this.outputText("", true);
    ...
    private friskAcceptChoice(): void {
        this.flags[kFLAGS.FUCK_OFF_THEIVING_RAPHAEL] = 1;
        this.outputText("", true);
    ...
    private RaphaelPicnicEnd(): void {
        ...
        if (this.flags[kFLAGS.FUCK_OFF_THEIVING_RAPHAEL] == 0) {
            ...
            this.flags[kFLAGS.FUCK_OFF_THEIVING_RAPHAEL] = 0;
    ...
    private RaphaelPicnicSkill(): void {
        ...
        if (this.player.spe < 30 || this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 0) {
            ...
            this.dynStats("str", -1, "tou", -1, "spe", 3, "sen", 1, "lus", 25);
            this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] = 1;
        }
        //{Fencing practice variables: Speed 30-39 Must play out at least once}
        else if (this.player.spe < 39 || this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 1) {
            ...
            this.dynStats("str", -1, "tou", -1, "spe", 3, "sen", 1, "lus", 25);
            this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] = 2;
        }
        //{Fencing practice variables: Speed 40-49, Must play out at least once}
        else if (this.player.spe < 49 || this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 2) {
            ...
            this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] = 3;
        }
    ...
    private postRaphaelCoitus(): void {
        this.outputText("", true);
        this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00149] = 1;
        ...
        if (this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 4) {
            ...
            this.player.createPerk(PerkLib.Misdirection, 0, 0, 0, 0);
        }
    ...
    private RaphaelPicnicChooseThieving(newl: boolean = true): void {
        ...
        if (this.player.inte < 30 || this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 0) {
            ...
            this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] = 1;
        }
        //{Picnic Thieving 30-39 Int. Must play out at least once.}
        else if (this.player.inte < 39 || this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 1) {
            ...
            this.dynStats("str", -1, "tou", -1, "int", 3, "sen", 1, "lus", 40);
            this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] = 2;
        }
        //{Picnic Thieving at 40-49 Int. Must play out at least once.}
        else if (this.player.inte < 39 || this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 2) {
            ...
            this.flags[kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] = 3;
        }
    ...
    private thieveryEnding(): void {
        ...
        if (this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] != 4) this.outputText("You try to reach for the magnificent ornament hanging off his hips, but as the fox continues to move, you lack the nimbleness to remove it.\n\n", false);
        //({When player has also reached the apex of fencing lessons
        else this.outputText("You reach and fondle the magnificent ornament hanging off his hips. With a few nimble flicks of your fingers, you manage to get it off.\n\n", false);
    ...
    private quiksilverFawkesEndGame(): void {
        ...
        if (this.flags[kFLAGS.REJECTED_RAPHAEL] == 1) {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00149] == 1) {
    ...
    private QuiksilverFawkesPtII(): void {
        ...
        if (this.flags[kFLAGS.REJECTED_RAPHAEL] == 1) this.outputText("<i>\"I can smell traces of him,\"</i> Hati states, nearing the waterbarrel, <i>\"but it's hard to tell.  There're too many other scents here.\"</i>\n\n", false);
        //Played around/special ending
        else this.outputText("Hati breaks into the conversation.  <i>\"She must know.  The entire camp reeks of him. She has his scent on her.  I can smell strong trails leading towards a nearby meadow.  A bit stale.  Might have been a while ago.\"</i>  He nears the water barrel.  <i>\"...but it's hard to tell. There's too many other scents here.\"</i>\n\n", false);
        ...
        if (this.player.armorName == "red, high-society bodysuit") this.outputText("  Suddenly, his eyes and ears perk.  <i>\"Isn't that the stolen clothing of the widow Camembert that she's wearing? You know, before she mysteriously dropped the charges after a nightly visit from the fox? Should we confiscate it anyway?\"</i>", false);
        this.outputText("\n\n", false);
    ...
    private coverForRaphael(): void {
        ...
        //({If cor is below 30}
        if (this.player.cor < 30) this.outputText("  You slowly shake your head, tortured by the trusting twinkle in the wolf's soft yellow eyes.", false);
        this.outputText("\n\n", false);
    ...
    public orphanageIntro(): void {
        this.clearOutput();
        if (this.RaphaelLikes()) {
            if (this.flags[kFLAGS.TIMES_ORPHANAGED_WITH_RAPHAEL] == 0) {
    ...
    private cunnilingusWithRaphael(): void {
        ...
        if (this.player.wetness() < 3) this.outputText("your cunt fluttering");
        //({Medium wetness multiplier}
        else if (this.player.wetness() < 4) this.outputText("sending out a small spurt of femcum landing on your belly");
        //({High wetness multiplier}
        else this.outputText("gushing a torrent of femcum into the air");
