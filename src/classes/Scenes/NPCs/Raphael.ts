...
export class Raphael extends NPCAwareContent implements TimeAwareInterface {
    ...
    private RaphaelChooseFrisk(): void {
        ...
        // {If player's corruption is higher than 19 and higher than Intelligence.}
            ...
            this.outputText(
                '"<i>My, such an eager little thing.</i>" He comments, pleased.\n\n',
                false
            );
    ...
    private friskFondleChoice(): void {
        ...
        this.outputText(
            '"<i>And I in turn, will have to retrieve those.</i>" He growls low.\n\n',
            false
        );
    ...
    private RaphaelPicnicSkill(): void {
        ...
        if (this.flags[kFLAGS.RAPHAEL_RAPIER_TRANING] == 0) {
            ...
            this.outputText(
                '"<i>Shall we?</i>" He jumps to his feet and extends you an arm.\n\n',
                false
            );
    ...
    private declinePuttingOutForRogues(): void {
        ...
        this.outputText(
            "You turn around to smile at him.  However, Raphael has vanished.\n\n",
            false
        );
    ...
    private coverForRaphaelII(): void {
        ...
        this.outputText(
            "You spend some time considering the dubiosity of this revelation.\n\n",
            false
        );
