...
export class ShouldraFollower extends NPCAwareContent {
    ...
    private shouldraSleeping(changes = 0, reset = false): boolean {
        ...
        if (this.flags[kFLAGS.SHOULDRA_SLEEP_TIMER] < 0)
    ...
    private noFollowerShoulders(): void {
        ...
        this.spriteSelect(67);
        this.outx(
            'Somewhat bluntly, you inform her of your lack of interest regarding having a ghostly tagalong.  Though she looks a bit disappointed, she nods, scuffing her shoes against the ground and huffing a little sigh.  "<i>At least I\'ll see you later, hey?</i>"'
        );
        this.outx(
    ...
    private shouldraAndValaGetBigger(): void {
        ...
        this.outx(
            "You decide to make your way down to the Wet Bitch to introduce Vala to her.  A few minutes into your stay, you see the fairy serving a few tables while holding a tray filled with drinks and empty glasses.  Pointing her out, Shouldra gives a delighted squeal."
        );
        this.outx(
    ...
    private pureValaAndShouldraMacroMax(): void {
        ...
        this.outx(
            "Before she can do anything, you shout out a rather unusual suggestion, though to you it sounds quite exciting.  Vala or Shouldra, whoever she is, smiles wickedly and nods, lifting you up towards the glittering gash between her legs."
        );
        this.outx(
        ...
        if (this.player.gender > 0) {
            ...
            if (this.player.hasCock())
                ...
                this.outx(
                    ", growing wet, though in this slick fluid, your contribution is a mere drop in the ocean."
                );
        }
        this.outx(
            '  The warm fleshy dream is abruptly ended as Shouldra yanks you out by your [feet].  "<i>I\'m gonna put you the whole way in.  Do me a solid and get me off a few times, will ya?</i>"'
        );
        ...
        this.outx(
            " against the slick walls.  You push your way towards the pinkish slit in the distance begin to slide your [legs] over the inner edges of her lips, pressing your arms up above you for stability."
        );
        this.outx(
        ...
        if (this.player.hasCock()) {
            this.outx(
                "  [EachCock] is quickly brought to orgasm by the exotic situation, and you fire off your own load into the deluge of sex-juice."
            );
            if (this.player.cumQ() >= 1000)
                this.outx(
                    "  Somehow, you pour out almost as much spunk as Vala's orgasm, turning the inside of her honeypot into an off-white mess."
                );
        } else if (this.player.hasVagina()) {
            this.outx(
                "  Your [vagina] can scarcely resist the allure of the sweet, female flesh pressing against it, and with an explosion of hot bliss, you climax"
            );
            if (this.player.wetness() >= 4) this.outx(", squirting with joy");
            this.outx(".");
        }
        this.outx(
        ...
        if (this.player.gender == 0) this.outx(" somehow");
        this.outx(", but she vanishes with a high-pitched giggle.");
    ...
    public shouldraMeetsCorruptVala(): void {
        ...
        if (this.player.hasCock())
            this.outx(
                "  Your cock slips past the folds, pressed up against your stomach as the underside is massaged with the gentle tightness within."
            );
        this.outx(
            "  Once you're up to your chest, Vala stops, instead grasping your shoulders between her thumb and forefingers as she begins to gently slide you in and out of her."
        );
    ...
    public sandWitchGetsGhostly(): void {
        ...
        if (this.player.hasCock() && (!this.player.hasVagina() || ShouldraFollower.rand(2) == 0)) {
            ...
            if (!this.player.hasFuckableNipples())
                this.outx(
                    '"<i>You know, maybe I should give you a couple of those chest-mounted treats.  They\'re pretty fun,</i>" Shouldra teases, tweaking your [nipples].  '
                );
            this.outx(
                "With a very telling exasperated sigh, you snatch up your [armor] and march back to camp."
            );
        }
    ...
    private shouldraFappinTimes(): void {
        ...
        if (this.player.hasCock() && this.player.findStatusAffect(StatusAffects.Infested) >= 0) {
            ...
            this.player.hasCock() &&
            (!this.player.hasVagina() || ShouldraFollower.rand(2) == 0)
        )
    ...
    private genderlessShouldraMasturbation(): void {
        this.clearOutput();
        this.spriteSelect(67);
        this.outx("Shouldra runs your fingers along your ");
        // [if (femininity < 50)
        if (this.player.femininity < 50) this.outx("masculine ");
        else if (this.player.femininity > 50) this.outx("feminine ");
        this.outx(
        ...
        // if event occurrence > 0
            ...
            else this.outx("You sure as hell wouldn't have bothered asking if you weren't.");
        }
        this.outx(
            "  The ghost girl promptly discards your [armor] before hurrying your naked body along into the wilderness away from camp."
        );
        this.outx(
        ...
        if (
            ...
            this.outx("Within lies a rather rustic yet well-built chest.");
        else if (
            this.flags[kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] > 0 &&
            this.flags[kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] == 0
        )
        ...
        if (
            ...
            this.outx("familiar, ");
        this.outx(
            'bumpy, eight-inch demon vibrator firmly in her "grasp."  A tingling sensation coursing through your hind end draws your attention away from the ghost as she inspects her quarry.  You honestly aren\'t too surprised to peer around and discover your [butt] plumping up, each burst of expansion quaking your flesh.'
        );
        ...
        if (this.player.ass.analLooseness < 3) {
            ...
            // [if (corruption < 50)
            if (this.player.cor < 50) this.outx("..  This only worries you further.");
            this.outx(
        ...
        // if analLooseness >= 3
            ...
            if (this.player.cor < 50) this.outx(", which only serves to confuse you");
            this.outx(".");
        }
        ...
        this.outx(
            "  Shouldra smacks the dildo of doom onto a nearby boulder as she wearily rises you to your [feet].  The inferior, forgotten playthings slide out uselessly from the ghoul's gasping craw as she slowly clambers over top the wiggling horsey wang."
        );
        this.outx(
    ...
    private nongenderlessAnalShouldraMasturbation(): void {
        ...
        if (this.flags[kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] == 0) {
            ...
            this.outx(
                '"<i>Up for another round then, Champ?</i>" she asks, your body striking a familiar boxing stance from bouts long since fought.  "<i>If you think I\'ll be pulling any punches then you don\'t have a ghost of a chance.</i>"  Only if you had control of your body could you respond with even half the appropriate groan.'
            );
        }
        this.outx(
            "  The ghost girl promptly discards your [armor] before hurrying your naked body along into the wilderness away from camp."
    ...
    private maleMasturbationProper(): void {
        ...
        this.spriteSelect(67);
        this.outx(
            "You are nearly overwhelmed by Shouldra's delight when you allow her to focus on your [cock].  She instantly takes the lead, steering you behind a good-sized boulder and flinging your [armor] piece-by-piece as you go."
        );
        this.outx(
        ...
        // if buals:
        if (this.player.balls > 0) this.outx("\n\nYour sack");
        else this.outx("\n\nYour prostate");
        this.outx(
        ...
        this.outx(
            "  She reaches into her tunic and tosses you a full bottle of ectoplasm, giving you a wink before incorporealizing once more and floating into you.  All's well that ends well."
        );
        this.player.orgasm();
        this.dynStats("sen", -2);
        this.outx("\n\n", false);
    ...
    private girlyMasturbationWithGhosts(): void {
        ...
        this.outx(
            '"<i>Tsk!  Saying those kinds of things aloud!  Still... if you want to let it out so badly, I might let you if you beg a little more...</i>"'
        );
        this.outx(
    ...
    private shouldraTongueLicksPCs(): void {
        ...
        if (
            ...
            this.outx(
                "  The consistency of your forgetfulness while traveling this path leads you to believe that your ethereal inhabitant would rather you not come back here on your own."
            );
        this.outx(
        ...
        if (
            ...
            this.outx(
                "  \"<i>You didn't think I'd leave my most treasured possessions behind for some goblin to run into, did you?</i>\"  It's the ghost girl's chest of dildos, as well-kept as the last time you laid worried eyes on it."
            );
        else
            this.outx(
                "  Inside rests the ghost's familiar treasure trove of dildos and other toys you have yet to discover."
        ...
        if (this.flags[kFLAGS.SHOULDRA_TONGUE_LICKS_TIMES] == 0) {
            ...
            if (this.player.tongueType > TONUGE_HUMAN) this.outx("some of ");
            this.outx(
                "your tongue out, examining it.  Already, you think you've got a pretty good idea of where she's going to take this."
            );
            this.outx(
        ...
        // if demon tongue
            ...
            this.outx(
                'sliding fingers along the wet appendage, humming a little tune over your tongue until more than an additional foot of it droops from your mouth.  "<i>Now we\'re getting somewhere,</i>" you hear her thinking as she works her magic.  There doesn\'t seem to be a limit to how much she can pull out of your mouth, and soon she has more than three feet of pure tongue coiled in your lap.  Furrowing your brow in concentration, she tries to move your tongue about, but can\'t manage to wiggle more than the tip.  "<i>Too thin,</i>" she mutters, "<i>much too weak. Doesn\'t feel right...</i>"'
            );
            this.outx(
                "\n\nTaking the midsection of your tongue in your hand, she slowly starts to rub her hand along some of its length.  It feels... odd, somehow, but not entirely unpleasant.  Though you shudder at the first rub, they start to feel more natural as she pushes you on.  Actually, it feels sort of good.  Her strokes remain constant, though some part of you wishes she'd go faster.  It doesn't even register as odd in your addled mind that your tongue is swelling in your hand with every stroke.  Shouldra starts to make wider movements along your smooth stretch of muscle.  Its girth plumps up to fill your palm nicely wherever she brings your hand, and the strange sensations of your flesh on its nerves wrack your body with shudders of pleasure even through Shouldra's grip."
            );
        ...
        if (this.flags[kFLAGS.SHOULDRA_TALK_NEEDED] == 1) {
            ...
            if (this.flags[kFLAGS.SHOULDRA_PLOT_LEVEL] == 1) {
                ...
                if (this.player.findPerk(PerkLib.Incorporeality) >= 0)
                    this.outx(
                        "  Shouldra bumps you to the side a little as she makes her next point, \"<i>Even with your hoaky quasi-possession power, you don't really know what it's like to actually possess someone.</i>\" You look at her funny, unaware that you weren't really getting the full effect.  Not that you care!"
                    );
                this.outx(
                ...
                this.outx(
                    ".  \"<i>No matter what treasure trove of knowledge I dig up from you, there's always something I'm more interested in.</i>\"  Your hand lifts back up, and you watch as Shouldra's hand splits off from your own, meeting below the wrist.  She holds your hand with her own ghostly appendage, resting her head on your shoulder.  The ghost girl sits there for a moment, silent, leaving you to wonder if maybe, just maybe, you're starting to mean a little more to her than just a sex toy."
                );
                this.outx(
            ...
            // Talk 2 - First Transformation Discussion
                ...
                if (this.player.gender > 0) {
                    this.outx(
                        "  Your [if (hasCock = true) [cock]][if (isHerm = true)  and ][if (hasVagina = true) [vagina]] start to swell up; looking up at the ghost, you realize that she hasn't uttered a single word!"
                    );
                } else
                    this.outx(
                        "  A fleshy, penis-shaped bulge begins to swell out of your loins; looking up at the ghost, you realized she hasn't uttered a single word!"
                    );
                this.outx(
                ...
                if (this.player.gender == 0) this.outx("dick");
                this.outx(
                    " [if (isHerm = false) continues its][if (isHerm = true) continue their] march of magnification while your fingers vigorously explore their new frontiers."
                );
                this.outx(
                ...
                if (this.player.gender == 0) this.outx("burgeoning dickflesh");
                this.outx(
                    ".  It takes some gumption for you to work through the arousal and contribute to the conversation, but you manage to point out how you're pretty sure there are other people in Mareth with the same sort of power, to some degree at least."
                );
                this.outx(
            ...
            // Talk 3 - "Recent" Goblin Possession Discussion
                ...
                if (this.player.hasCock())
                    this.outx(
                        '</i>"  Shouldra eyes your [cock] gingerly, acting as if she can stare right through your outfit at it.  "<i>'
                    );
                else this.outx("  ");
                this.outx(
                    "The half-millenium or so of scarcity has really shaped my interests.  I'm at the point now where I just lose it whenever I get these ghostly mitts on a slab of meat.  And the big ones?  "
                );
                if (this.player.biggestCockArea() >= 200) this.outx("Ones like yours?  ");
                this.outx(
                    "Then I'm just in heaven.</i>\"  Hold on.  She can turn any dick into a towering monument.  What's so special about ones that come pre-packaged, you ask?  \"<i>I kinda break the one rule I had at that point, but when I find someone with a big boner, it just... feels so good to me.  There's just something about an all-natural magnum opus that just lights my fire.</i>\""
                );
                this.outx(
    ...
    private shouldraGivesYaSomeFukkinTeats(): void {
        ...
        this.spriteSelect(67);
        this.outx(
            'Shouldra rubs your hands together in anticipation, "<i>A beautiful blossoming pair of nipples is what you need to really compliment a nice set of tits.</i>"  Your hands gleefully tweak your [nipples] as the spirit\'s incantation gets underway.'
        );
        this.outx(
    ...
    private shouldraReductosYourTits(): void {
        ...
        this.spriteSelect(67);
        this.outx(
            'Your arms clasp themselves around your [fullChest].  "<i>Not the gals!  What monster would want to deflate their knockers?</i>"  This monster, evidently.  Shouldra sighs, holding your hands in a weak casting stance as she gets the heinous act over with.'
        );
    ...
    private shouldraMakesCocksDisappear(): void {
        ...
        if (this.player.cocks.length == 1) {
            ...
            if (choice == 0) this.outx("murderer");
            else if (choice == 1) this.outx("bastard");
            else if (choice == 2) this.outx("jerk");
            else if (choice == 3) this.outx("monster");
            else if (choice == 4) this.outx("cretin");
            else if (choice == 5) this.outx("fiend");
            else if (choice == 6) this.outx("asshole");
            else if (choice == 7) this.outx("villain");
            else this.outx("dick");
            this.outx(
                '!</i>" it shouts.  The tiny voice fades away as your [cock] goes still, resting at two thirds of its original size.  A single tear rolls down your cheek; you suspect the melodramatic spirit is at fault here.'
            );
    ...
    private shrinkDatBootyForYoGhost(): void {
        ...
        this.spriteSelect(67);
        this.outx(
            'Your hands quickly grasp at your bare [butt].  "<i>You... you\'re desecrating a national treasure here!</i>"  The rather odd declaration gets a chuckle from you, but you remain firm in your request to dull your derriere.  The ghost girl furthers her attempts to change your mind, but without literally changing your mind, you remain steadfast.  Defeated, your hands take one last trip around your posterior before the poltergeist recites her incantation.'
        );
    ...
    private kickFollowerShouldraOut(): void {
        ...
        if (
            ...
            this.outx(
                "\"<i>Ah, you're booting me out, hey?</i>\"  Shouldra asks innocently, tumbling out of your body and corporealizing. \"<i>Wouldn't be the first, and won't be the last.  I do realize I have certain 'needs' that got cloying to many of my former hosts.</i>\""
            );
            this.outx(
    ...
    public shouldersWarnings(): boolean {
        ...
        // 7 days (168 hours) since last Shouldra scene
            ...
            if (ShouldraFollower.rand(3) == 0) {
                ...
                if (this.player.gender == 0) this.outx("libido seems to be going haywire");
                this.outx(
                    ".  Shouldra's unfulfilled sexual needs are starting to blend into your own.  Nothing you do will satisfy your urging until she's seen to her own.\n\n<b>Minimum lust raised by 20.</b>\n"
                );
            } else if (ShouldraFollower.rand(2) == 0) {
                this.outx(
    ...
    public nightTimeShouldraRapesThePC(): void {
        ...
        if (this.player.biggestTitSize() >= 1)
            this.outx(", circling their entire lengths around your [fullChest]");
        this.outx(
            ".  It's quite amazing how ecstatic the tour feels, each pre-smeared exploration smothering you in sensual vibes.  Just moving the stiff little devils - particularly at your joints - sends shivers up your arm."
        );
        this.outx(
        ...
        this.outx(
            " back to a much less craggy complexion.  Shouldra slowly drags you back to your [feet] after a minute or two of blissful respite and walks you closer to the cliffside to stare off into the moonlit horizon.  It never really dawned on you just how fucking high you are; just where the fuck did she take you?"
        );
        this.outx(
        ...
        if (this.player.hasCock()) this.outx("flailing cock");
        else this.outx("moist vagina");
        this.outx(".");
        // if cock
        if (this.player.hasCock()) {
            this.outx(
    ...
    public shouldraWakesUpOrPokesPCsForShitsAndGigglesIdunnoHowLongCanIMakeThisFunctionNameQuestionMark(): void {
        ...
        if (
            ...
            this.player.findPerk(PerkLib.MaraesGiftProfractory) >= 0 ||
        ...
        switch (select) {
            ...
            case 1:
                ...
                if (subSelect == 0)
                    this.outx(
                        "Your [cock] tingles, and your [armor] suddenly feels much tighter.  A little giggle from Shouldra reveals her intention.  Though adamant about making you as big and virile as possible, Shouldra does realize it <b>is</b> your body, and your meat shrinks at least three inches to its former glory."
                    );
                else if (subSelect == 1)
                    this.outx(
                        "An uncomfortable stirring in your nether regions has you stop to undo your [armor] and figure out what's the matter.  Your [cock] is wagging enthusiastically.  Shouldra's face quickly sprouts from your shoulder, \"<i>Oh look, he's happy to see you!</i>\" You pay her an irritated glance which she returns with a content snicker.  With your cock under control, you redo your [armor] and continue on your way."
                    );
                else if (subSelect == 2)
                    this.outx(
                        "You're distracted as you notice your [cock] snaking its way down your [leg], quickly growing larger.  You make your displeasure obvious, causing it to recoil back to its original size.  Seems as though your ghostly friend is getting restless."
                    );
                else if (subSelect == 3)
                    this.outx(
                        "You come to a halt as you suddenly lose control of your arms, forcing you to watch your hands dart down your [armor] to fiercely grab at your [cock].  Though you let out a growl for her to stop, it takes Shouldra a minute to return your arms to you.  She must be getting restless."
                    );
                else if (subSelect == 4 && this.player.horseCocks() == 0)
                    this.outx(
                        "There's a sudden twisting pain in your [cock], forcing you to undo your [armor] and see what's wrong.  To your dismay, a large equine dong is staring back at you, leaking profusely.  \"<i>Just testing out some new transformations, Champ,</i>\" Shouldra snickers.  You yell out again as your dick quickly turns back to normal."
                    );
                else
                    this.outx(
                        'One of your hands begins playing with your [cock], no doubt spurred on by your paranormal passenger.  "<i>You know, Champ, I could make you some easy gems.  Just find some know-nothing and introduce them to The Amazing Penis, capable of astounding feats like responding to any vocal coital commands!</i>"  Playing the part of a sideshow attraction is quite the tangent to your typical daily activities.  Probably best not to think about it.'
                    );
                break;
            case 2:
                // PC with BIG COCK
            ...
            case 3:
                ...
                if (subSelect == 0)
                    this.outx(
                        "Your [balls] are getting warm.  They're getting... really hot.  \"<i>Don't mind me, Champ. Just... checking something out.</i>\"  You decide the best course of action would probably be not to pry any further into whatever machination the ghost girl is working on."
                    );
                else if (subSelect == 1)
                    this.outx(
                        "A tightness in your [armor] reveals to you your swelling [balls].  Shouldra continues to try and convince you of the importance of a virile package, but you remind her as to who's in control of this ship.  Regretfully conceding, the ghost girl returns your sac to its original proportions."
                    );
                else if (subSelect == 2)
                    this.outx(
                        "You suddenly fall [if (isBiped = true) to your knees][if (isBiped = false) to the ground] as your [balls] begin to thrash and vibrate wildly!  \"<i>Interesting. That was way more effective than I would have guessed.  I'll have to make a note of that,</i>\" your paranormal passenger says, ending the spell.  With a mild case of confusion, you're left to your thoughts as you go about your business."
                    );
                else if (subSelect == 3 && this.player.hasCock())
                    this.outx(
                        'You feel your [balls] quickly swell then tighten out of nowhere, forcing some of their payload out your [cock].  Suddenly your hand darts down your [armor] and delivers the errant cum directly to your mouth!  "<i>Had some time on my hands, so I decided to try out some new recipes.  What do you think?</i>" Shouldra asks.  Tastes... citrus-y?  That your loins are being used as an experimental factory is... disconcerting.'
                    );
                else
                    this.outx(
            ...
            case 5:
                ...
                if (subSelect == 0)
                    ...
                    this.outx(
                        "You almost don't realize your hand creeping its way into your [armor], trying to sneak a quick fingering. Looks like Shouldra is getting antsy."
                    );
                else if (subSelect == 3)
                    this.outx(
                        "What the... ?  Your [vagina] has started gushing fluids everywhere, absolutely soaking your [legs]!  \"<i>Don't mind me, Champ.  I'm just testing to see how far I can push this. Part of something I have in mind for later...</i>\"  No good can come of this..."
                    );
                else
                    this.outx(
            ...
            case 6:
                ...
                if (subSelect == 0)
                    this.outx(
                        "While minding your business, you realize faint whispering is coming from your [cock].  Shouldra and Exgartuan are scheming something, probably something you wouldn't be a fan of.  Every so often your wang lets out a chuckle.  Maybe getting these two together wasn't in your best interest."
                    );
                else if (subSelect == 1)
                    this.outx(
                        "Your [cock] is wiggling around inside your [armor], making you incredibly uncomfortable.  You go to undo your outfit when the demonic dong plows its way out anyway, scaring you half to death.  Shouldra and Exgartuan just laugh, too content with one another to pay you much mind.  You never expected them to get along THIS well."
                    );
                else if (subSelect == 2)
                    this.outx(
                        '"<i>So what other sorts of things can you concoct?</i>" Exgartuan asks, shuffling around in your armor.  You\'re incredibly confused by the sudden question.\n\n"<i>Honestly, that put me in the mood to make all of mother nature our bitch,</i>" you respond... Shouldra responds.  The spirit is gabbing through your mouth to your possessed pecker.  The two prattle on like this for some time.'
                    );
                else if (subSelect == 3)
                    this.outx(
                        'Your hands slip inside your [armor], exploring your [cock].  Your fingers caress each little nub and nodule they come across.  "<i>That\'s the ticket,</i>" Exgartuan gleefully responds, getting rigid in the tight confines of your outfit.  Looks like your ghostly partner is out to make everyone happy.'
                    );
                else if (subSelect == 4)
                    this.outx(
                        "\"<i>Why don't you help out during battles, babe?</i>\" Exgartuan asks rather bluntly.\n\n\"<i>Hey, I've offered to help out with Champ's more seductive poses like you do...</i>\"\n\nIt isn't like you have much choice in the matter as far as Exgartuan is concerned!  The two continue their discussion, belittling your apparently meager combat performance.  Maybe your possessors could actually help deal some real damage for a change!"
                    );
                else
                    this.outx(
            ...
            case 7:
                ...
                if (subSelect == 0)
                    this.outx(
                        '"<i>Yoooo, Champ, are we gonna fuck something, or am I just gonna stagnate here?</i>" Shouldra moans, managing to steal control of an arm long enough to give your [butt] a honk.  You sigh.'
                    );
                else if (subSelect == 1)
                    this.outx(
                        "Out of nowhere, a colossal yawn bursts forth from your craw.  \"<i>Come on, Champ. I'm dying to try out some new stuff I've cooked up.</i>\" What is this sense of dread consuming your being?"
                    );
                else if (subSelect == 2)
                    this.outx(
                        "It's been pretty quiet recently.  No doubt Shouldra is up to something -- she always is.  Honestly, you've forgotten what it's like to not having your body passing for a bloated something or other."
                    );
                else if (subSelect == 3)
                    this.outx(
                        "As you are going about your business, you swear you make out muttering emanating from somewhere on your person. It sounds like the ghost girl is reciting some magic, but you don't feel any different. This only worries you even more."
                    );
                else if (subSelect == 4)
                    this.outx(
                        '"<i>Do foot fetishes still apply if it\'s your own foot?</i>" Shouldra asks.  For a moment you wonder how such a feat would even be possible.  But only for a brief, forgetful moment...'
                    );
                else if (subSelect == 5)
                    this.outx(
                        'A familiar voice works its way from the back of your mind, "<i>Hey, Champ.  You think there\'s any way to make armpits sexy?  What about knees or noses?</i>"  This line of questioning could lead to some very troubling consequences...'
                    );
                else
                    this.outx(
            ...
            case 17:
                ...
                if (
                    ...
                    this.outx("That shark daughter of yours is");
                else this.outx("Those shark daughters of yours are");
                this.outx(
    ...
    private shouldraAndWormsYoureGonnaHaveABadTime(): void {
        ...
        if (this.player.cocks[0].cockLength < 48)
            this.outx(
                " and cuts right to the chase, ballooning your [cock] into a rigid, wide, four-foot tall slab of meat"
            );
        this.outx(
            ".  Unable to contain her delight, she hastily hugs your enormous dick firmly against your body and squeezes vigorously, rubbing your face against your [cockHead].  A warm stream of pre oozes out and onto your possessed face."
        );
        this.outx(
        ...
        if (this.model.time.hours <= 12) this.outx("morning ");
        else if (this.model.time.hours <= 5) this.outx("afternoon ");
        else this.outx("evening ");
        this.outx(
            "air.  Your hands clue the eidolon in to further activity, introducing her to your urethra all the way down to your [balls], every square wriggling inch chock-full of the little buggers, exploring their extended living quarters."
        );
        this.outx(
    ...
    private kickOutShouldra4YoWormyBuddies(): void {
        ...
        if (this.player.cocks[0].cockLength < 48)
            this.outx(
                "  With that little ordeal dealt with, you now are left to decide how best to manage the time until your cock returns to its normal size."
            );
        this.outx(
    ...
    public shouldraAndExgartumonFightGottaCatchEmAll(): void {
        ...
        // Unlocks Argue 2
        this.spriteSelect(67);
        this.outx("Your bedroll looks mighty comfortable after a hard day's ");
        if (this.player.cor < 50) this.outx("work");
        else this.outx("fucking");
        this.outx(
            ".  Just when you're [armor] and about to tuck in for the night, however, your [cock] goes fully erect!  The throbbing demonic mass is flailing about, knocking into your shit and making a mess.  You clutch onto the bucking bronco in an attempt to prevent any further damage when Exgartuan begins to shout, \"<i>Don't FUCKING touch me, you goddamn cunt!</i>\""
        );
        this.outx(
    ...
    public exgartuMonAndShouldraShowdown(): void {
        ...
        if (this.silly())
            this.outx(
                "  It's a man's right to choose what's done with his body.  Not anyone else's!"
            );
        this.outx(
    ...
    private keepShouldraAndKickOutExgartuan(): void {
        ...
        this.spriteSelect(67);
        this.outx(
            "You decide to jump to Shouldra's side on this one, explaining to your demonic cock your desire to go your separate ways.  Exgartuan heartily laughs at you, your [cock] wiggling in the air with each mighty heave."
        );
        this.outx(
    ...
    private keepAllTheGhosts(): void {
        ...
        if (this.player.cumQ() >= 1000) this.outx(", trails of your cum pouring out from them");
        this.outx(".");
        this.outx(
    ...
    public shouldraBakeryIntro(): void {
        ...
        this.spriteSelect(67);
        this.outx(
            "You set off towards the bakery, and it's not long before the smell of freshly-baked pastries and sugary candies wafts through the air.  Something stirs in your mind as a familiar ghostly presence makes herself known; seems you're not the only one who noticed the scent of cinnamon."
        );
        this.outx(
        ...
        if (this.flags[kFLAGS.SHOULDRA_BAKERY_TIMES] == 0)
            ...
            this.outx(
                "You point out that she's already had something at the bakery.  \"<i>Yeah, I did.  And now I'm hungry again.  Deal with it."
            );
        this.outx(
    ...
    private bailOut(): void {
        ...
        this.spriteSelect(67);
        this.outx(
            "You quickly turn around and head back the way you came.  There's a moan of disappointment from Shouldra, before she settles down and goes back to doing whatever she usually does.  You try not to think about it as you leave the city and return to camp."
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private feedShouldraACake(): void {
        ...
        // after first time:
        if (this.flags[kFLAGS.SHOULDRA_BAKERY_TIMES] > 0)
            this.outx("Well, nothing <i>permanent</i>, anyway.  ");
        this.outx(
            "You press on, soon arriving at the ramp leading down into the bakery's interior.  It's as busy as ever, with patrons milling about, chatting between bites of pastry."
        );
        this.outx(
    ...
    private shouldraAndMaddieSittingInATree(): void {
        ...
        if (this.player.tone >= 60) this.outx("well-toned");
        else if (this.player.thickness < 50) this.outx("trim");
    ...
    private goAlongWIthShouldrasEatingSpree(): void {
        ...
        if (this.flags[kFLAGS.PC_FETISH] > 0) this.outx(", though not completely unwelcome");
        this.outx(".  You blush furiously and back into the corner of the (now rather cold) booth");
        if (this.flags[kFLAGS.PC_FETISH] > 0) {
            this.outx(" as your heart races and blood rushes down towards your ");
            if (this.player.hasCock()) {
                this.outx("drowsy member");
                if (this.player.hasVagina()) this.outx(" and ");
            }
            if (this.player.hasVagina()) this.outx("trembling nether-lips");
            if (this.player.gender == 0) this.outx("groin");
        }
        this.outx(
            ', before you realize that nobody seems to notice your predicament.  Shouldra reads your thoughts and responds, "<i>Thought you might appreciate some privacy'
        );
        if (this.flags[kFLAGS.PC_FETISH] > 0) this.outx(", even with that kink of yours");
        this.outx(
            ", Champ.  Here's something extra anyway, just in case.</i>\" One ghostly incantation later, and "
        );
        if (this.player.femininity <= 50) this.outx("a buttoned shirt and pair of belted jeans");
        else this.outx("a tight-fitting tank top and skirt");
        this.outx(" adorn your person.");
        ...
        if (this.player.hasCock()) {
            ...
            if (this.silly()) this.outx("  This is a <i>fucking good eclair</i>.");
            this.outx(
            ...
            if (this.player.cocks[0].cockLength < 8 || this.player.cocks[0].cockLength > 25)
                this.outx(
                    '"<i>First though, let\'s change it to something more manageable.</i>" Arcane sounds float up towards you, causing your shaft to shift and morph until your throbbing rod is around 2 feet long and dripping pre.  "<i>Mmm, much better!</i>"  '
                );
            this.outx(
                "Her eyes close as those sumptuous icing-white lips wrap around the [cockHead] of your aching dick, the cherry tongue canvassing your cockflesh like an artist, until she slowly, oh-so-slowly gulps down inch after gradual inch of your girth.  Her enormous chocolate rump is visible on the other side of the booth, lulling back and forth in contented bliss."
            );
            this.outx(
