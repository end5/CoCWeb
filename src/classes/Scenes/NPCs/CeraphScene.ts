...
export class CeraphScene extends NPCAwareContent {
    ...
    public maleFuckCeraphsPussy(): void {
        ...
        if (this.player.lowerBody != LOWER_BODY_TYPE_CENTAUR && this.player.biggestCockArea() > 500 && (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1 || this.monk >= 5)) {
        ...
        if (this.player.cockArea(0) <= this.monster.vaginalCapacity()) {
            ...
            if (this.player.cor < 33) this.outputText("Her words shame you.  Have you really sunk this low?  You wonder just how much this world has already corrupted you as you ready yourself to rape a sex-demon.", false);
            else if (this.player.cor < 66) this.outputText("Her words confuse you.  You never would've done this when you first came here, but you're horny and you know demons don't really mind.", false);
            else this.outputText("Her dishonest words anger you, and you slap her in the face.  Both of you know that she wants this almost as much as she wanted to rape you, and any pretense at disliking this act is a deceitful sham.", false);
            ...
            else this.outputText("and with a mighty effort, you force your over-sized cock inside her.  For a moment all you can do is stare in awe as it distorts her body – the fact that such a thing is possible puzzles you", false);
            ...
            if (this.player.cumQ() >= 500 && this.player.cumQ() < 1000) this.outputText("  Her belly begins to rise with the volume of cum she's absorbed, and you finish your orgasm with a mildly pregnant demon underneath you.", false);
            else if (this.player.cumQ() >= 1000) this.outputText("  Her belly rises quickly from the volume of cum you're pumping into her, swelling up until she looks ready to give birth, but her taut purple body seems to handle the strain quite well, save for her belly-button turning into an outtie with an abrupt 'pop'.", false);
            ...
            if (this.player.cor < 33) this.outputText("You groan, just wishing she would stop reminding you of the consequences of this little tryst.  In a hurry to leave the demon behind, you get dressed and take off for camp.\n\n", false);
            else if (this.player.cor < 66) this.outputText("You groan, wondering why she just won't get over her little act.  Even though this wasn't your best idea, it isn't nearly as bad as she makes it out to be.  You get dressed and leave, eager to be rid of her.\n\n", false);
            else this.outputText("You bend over, rub her belly softly and whisper into her ear, \"<i>I'll be sure to spit him on my cock first chance I get, dear.</i>\"\n\n", false);
            ...
            if (this.player.cocks[0].cockLength < 18) this.outputText("Your " + this.player.cockHead() + " crests between her breasts with every stroke, bumping against her chin.  It grows larger as the pleasure of the act intensifies to orgasmic levels.\n\n", false);
            else if (this.player.cocks[0].cockLength < 24) this.outputText("Your " + this.player.cockHead() + " slides over her cheek with every stroke, leaving a trail of pre-cum on her face.  The smudges of glistening pre grow larger and larger as the pleasure of the act nears orgasmic levels.\n\n", false);
            else this.outputText("Your " + this.cockDescript(0) + " slides over her face with every stroke, smearing the demon's hair with your thick pre-seed before you pull back and dribble it on her face.  The pleasure of the act is incredible, and you feel yourself getting harder as the sensation nears orgasmic levels.\n\n", false);
            ...
            if (this.player.cumQ() >= 1000) this.outputText("  Your prodigious fertility quickly forms a puddle around her, leaving the deceptive seductress practically submerged in cum.", false);
            this.outputText("\n\n", false);
            ...
            else this.outputText("You bend over, rub her belly softly and whisper into her ear, \"<i>I'll be sure to spit them on my cock first chance I get, dear.</i>\"\n\n", false);
    ...
    public rideCeraphsCockLikeaBAWSSexclamation11eleven(): void {
        ...
        if (this.player.cor < 33) this.outputText("Her words shame you.  Have you really sunk this low?  You wonder just how much this world has already corrupted you as you ready yourself to get off on a sex-demon's tool.", false);
        else if (this.player.cor < 66) this.outputText("Her words confuse you.  You never would've done this when you first came here, but you're horny and you know demons don't really mind.", false);
        else this.outputText("Her dishonest words anger you, and you slap her in the face.  Both of you know that she wants this almost as much as she wanted to rape you, and any pretense at disliking this act is a deceitful sham.", false);

        this.outputText("\n\nIt's too late for her to have any hope of swaying you anyway.  You strip off your " + this.player.armorName + " ", false);

        if (this.flags[kFLAGS.PC_FETISH] >= 1) this.outputText("getting an exhibitionist thrill ", false);
        ...
        if (this.player.vaginalCapacity() < 12) this.outputText("unable to take the entire exquisite cock inside you.  The nubs squirm and wiggle, practically vibrating and massaging your internal muscles, and you're unable to stop yourself from bouncing on top of her, spearing yourself repeatedly upon the thick rod.\n\n", false);
        else this.outputText("able to take the entire exquisite cock inside you.  The nubs squirm and wiggle, practically vibrating and massaging your internal muscles, and you're unable to stop yourself from bouncing on top of her, spearing yourself repeatedly upon the thick rod.\n\n", false);
        ...
        if (this.player.pregnancyIncubation == 0) this.outputText("You're only feeding the swarms of imps that are despoiling this land.", false);
        else this.outputText("I'm sure whatever baby you have in there won't enjoy being so soaked in corruption.", false);
        this.outputText("</i>\"\n\n", false);

        if (this.player.cor < 33) this.outputText("You groan, just wishing she would stop reminding you of the consequences of this little tryst.  In a hurry to leave the demon behind, you get dressed and take off for camp.\n\n", false);
        else if (this.player.cor < 66) this.outputText("You groan, wondering why she just won't get over her little act.  Even though this wasn't your best idea, it isn't nearly as bad as she makes it out to be.  You get dressed and leave, eager to be rid of her.\n\n", false);
        else this.outputText("You bend over and rub your belly while whispering in her ear, \"<i>Like mother, like child.</i>\"\n\n", false);
    ...
    private loseToCeraphAndGetPiercingsInEarsOrSomethingSomehow(): void {
        ...
        if (this.player.earsPierced > 0) this.outputText("With a dismissive gesture, Ceraph murmurs words of dark magic and the piercings in your ears drop to the ground, leaving behind smooth, unbroken flesh.  ", false);
    ...
    private loseToCeraphAnGetPierced2(): void {
        ...
        //If already pierced
        if (this.player.nipplesPierced > 0) this.outputText("With a dismissive gesture, Ceraph murmurs words of dark magic, and the piercings in your nipples drop to the ground, leaving behind smooth, unbroken flesh.  ", false);
        //Business as usual!
    ...
    private getPiercedByCeraphLoss3(): void {
        ...
        if (this.player.totalCocks() > 0) {
            ...
            if (this.player.cocks[0].pierced > 0) this.outputText(", the old piercing clattering to the ground as it slides out of your flesh, ", false);
    ...
    private agreeToBecomeCeraphsFuckpetBondageToyBitchSlut(): void {
        ...
        if (this.player.hasVagina()) this.outputText("  Your " + this.vaginaDescript(0) + " tingles as you wonder how many piercings and fetishes she could fit into your labia.", false);
        else if (this.player.cockTotal() > 0) this.outputText("  Your " + this.cockDescript(0) + " grows rock hard as you wonder if she'll give you a Jacob's ladder full of new fetishes and thoughts.", false);
        else this.outputText("  Your body hums with arousal as you wonder if she'll give you a cock and cunt, pierce them both, and fill you with new fetishes and sexy submissive thoughts.", false);
        ...
        //if pierced there
        if (this.player.lipPierced > 0) this.outputText("The previous piercing has vanished!  ", false);
    ...
    private ceraphFirstTimeVolunteer(): void {
        ...
        if (this.player.earsPierced > 0) this.outputText("Miraculously, your old earrings just fall out.  ", false);
    ...
    public winRapeChoices(): void {
        ...
        if (!this.getGame().inCombat) {
            ...
            this.monster.HP = 2;
            if (this.player.lust < 34) this.player.lust = 34;
        }
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00291] >= 4) {
        ...
        this.spriteSelect(7);
        this.outputText("", true);
        if (this.monster.HP < 1) this.outputText("Ceraph collapses in a beaten, bloody heap.", false);
        ...
        if (this.player.lust >= 33 && this.player.gender > 0) {
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cockThatFits(this.monster.analCapacity()) != -1) buttsmexing = this.buttRapeCeraph;
                else this.outputText("  <b>There's no way you could fit inside her ass - you're too big.</b>", false);
            }
            var cunting = undefined;
            if (this.player.hasVagina()) cunting = this.rideCeraphsCockLikeaBAWSSexclamation11eleven;
    ...
    public loseFUCKME(): void {
        ...
        this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00291] = 0;
        this.spriteSelect(7);
        if (this.flags[kFLAGS.PC_FETISH] == 0) this.loseToCeraphAndGetPiercingsInEarsOrSomethingSomehow();
        else if (this.flags[kFLAGS.PC_FETISH] == 1) this.loseToCeraphAnGetPierced2();
        else if (this.flags[kFLAGS.PC_FETISH] == 2) this.getPiercedByCeraphLoss3();
        else {
    ...
    public ceraphRapesYouBADDAWGYODIGGITY(): void {
        ...
        this.spriteSelect(7);
        this.outputText("", true);
        if ((!this.getGame().inCombat) && this.flags[kFLAGS.PC_FETISH] < 3) this.outputText("The demoness touches your forehead, and suddenly your mind is awash with fetishes!  Judging by the playful look she has, it's temporary, and you play along.  ", false);
        ...
        if (this.player.biggestTitSize() > 1) this.outputText(", right between your " + this.player.allBreastsDescript(), false);
    ...
    private hugeCorruptionForceFuckCeraph(): void {
        ...
        if (this.monster.HP < 1) this.outputText("Her hands are too busy starting to pump away at her nodule-covered demon-dick to help her crawl away.", false);
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1) this.outputText("You pat your " + this.cockDescript(x) + " and say, \"<i>A little help please, Exgartuan?</i>\"  ", false);
        else this.outputText("You blink your eyes closed and focus your corruptive powers in your crotch.  ", false);
        ...
        if (this.player.cocks[x].cockLength < 68) this.outputText("  It's impossible!  You aren't long enough for that.  Her body must have shrunk itself to a more appropriate length...", false);
        this.outputText("\n\n", false);

        this.outputText("As you're squeezed and massaged by ", false);
        if (this.player.cocks[x].cockLength < 68) this.outputText(CeraphScene.num2Text(Math.floor(this.player.cocks[x].cockLength / 12)), false);
        else this.outputText("six", false);
        this.outputText(" feet of love-tunnel, you struggle not to blow your load.  ", false);
        if (this.player.cocks[x].cockLength > 84) this.outputText("You've still got a lot more dick to get wet, and you start pushing the rest through her, using her like a plus-sized, organic onahole.  ", false);
        else {
        ...
        if (this.player.cumQ() < 100) this.outputText("You squirt your load into the dirt, but some rolls back along the underside of your urethra, catches on Ceraph's upper lip, and drips up her cheek into her tangled hair.", false);
        else if (this.player.cumQ() < 1000) this.outputText("You squirt your copious cum everywhere, splattering the dirt and dripping white goo onto Ceraph's face, forehead, and hair.  By the time you finish she's got a nice glaze going on.", false);
        else this.outputText("You expel huge waves of seed in what can only be described as eruptions.  They splatter into the dirt, forming thick puddles that are joined together with each successful splash of goo.  In between blasts, a steady stream leaks from the tip, travels down the underside, and catches on Ceraph's lip.  The spunk-flow is pulled over her face and into her hair by gravity.  She's glazed white and dripping into a puddle by the time you finish.", false);
        this.outputText("\n\n", false);

        this.outputText("You push the used fuck-toy off your " + this.cockDescript(0), false);
        if (this.player.cockTotal() == 2) this.outputText(" and marvel at the cum your other cock dumped into the puddle", false);
        else if (this.player.cockTotal() > 2) this.outputText(" and marvel at the cum your other cocks dumped into the puddle", false);
        ...
        if (this.flags[kFLAGS.PC_FETISH] > 0) this.outputText("I'll remove some of my magic from you if you want, and I'll even let you keep the piercing.  Would you like that?", false);
        else this.outputText("I'd be willing to give you a few extra gems to keep you motivated to do something like this again.  I LIKE surprises. How about it?", false);
        this.outputText("</i>\"\n\n", false);
    ...
    private ceraphsNiceOffer(): void {
        ...
        if (this.flags[kFLAGS.PC_FETISH] > 0) {
            ...
            if (this.flags[kFLAGS.PC_FETISH] == 1) this.outputText("your exhibitionism is gone!", false);
            else if (this.flags[kFLAGS.PC_FETISH] == 2) this.outputText("your bondage fetish is gone!", false);
    ...
    public friendlyNeighborhoodSpiderManCeraph(): void {
        ...
        if (this.player.cor > 66) this.outputText("and without a second thought you disrobe, tossing your " + this.player.armorName + " to the side.  It thumps heavily in the dry mountain dust.", false);
        else if (this.player.cor > 33) this.outputText("and you squirm and writhe within your " + this.player.armorName + ", the material itching on your skin.  Ultimately, you manage to resist.", false);
        else this.outputText("and you stifle a laugh at the ridiculous thought, ignoring your fingers while they scratch at the itch under your gear.", false);
        ...
        if (this.player.cor > 66) this.outputText("I can see just how hot I'm making you, I'm so glad you gave in and got undressed for me", false);
        else this.outputText("You can't take your eyes off me.  It's a shame you didn't get undressed.  Didn't anyone tell you this mountain has a dress code?  Or should I say, an undress code", false);
        ...
        if (this.player.cor > 66) this.outputText("Are you going to try to fight me in the buff?  If you're going to do that then you can go ahead and get dressed, I wouldn't want to accidentally leave a scar in the wrong place.", false);
        else this.outputText("Are you going to try to fight me?  If you're going to do that, I suppose we can.  You do seem to need some practice at indulging your fetishes.", false);
        this.outputText("</i>\"\n\n", false);
    ...
    private tradeCeraphSomething(): void {
        ...
        if (this.player.hasItem(this.consumables.BIMBOLQ)) {
            ...
            if (this.player.gender > 0 || this.player.biggestTitSize() > 2) this.outputText("  Or if you'd rather keep it, I could take one of your endowments for my own use and remove a single fetish.  It's always fun giving one of my old pets a new part to play with.", false);
            ...
            if (this.player.gender > 0 || this.player.biggestTitSize() > 2) endowment = this.tradeCeraphCrotchityBits;
        }
        //(No Bimbo Liquer)
            ...
            if (this.flags[kFLAGS.PC_FETISH] == 1) this.outputText("your fetish for you.</i>\"\n\n", false);
            else this.outputText("one of your fetishes for you.</i>\"\n\n", false);
    ...
    private tradeCeraphCrotchityBits(): void {
        ...
        if (this.player.hasVagina()) {
            ...
            if (CeraphScene.rand(2) == 0) choices[choices.length] = 2;
        }
        //Add tits
        ...
        while (this.temp > 0) {
            ...
            if (this.player.breastRows[this.temp].breastRating > 2) choices[choices.length] = 3;
        }
        //Think about it...
        ...
        //(DICKS)
            ...
            if (this.player.cocks[temp2].cockType == CockTypesEnum.HORSE) this.outputText("Oooh, is that a horse-cock?  Those are quite nice.  I love the feel of a flare inside me, or even better, plunging one deep into a slut's poor, abused asshole.", false);
            else if (this.player.cocks[temp2].cockType == CockTypesEnum.DOG) this.outputText("Oooh, is that a dog-cock?  Those are quite nice.  It's oh-so-fun to enhance the knots on those and then watch them puff up enough to distend some poor slave's gut.", false);
            else if (this.player.cocks[temp2].cockType == CockTypesEnum.DEMON) this.outputText("Oooh, is that a demon-cock?  As you can see I'm QUITE familiar with those, but it might be fun to replace one of my girl's tongues with it.", false);
            else if (this.player.cocks[temp2].cockType == CockTypesEnum.CAT) this.outputText("Oooh, is that a kitty-dick?  The spines on those feel so good while they rub down all your walls or catch your prostate.  Meow.", false);
            else if (this.player.cocks[temp2].cockType == CockTypesEnum.LIZARD) this.outputText("Wow, you've got a snake-dick?  I haven't seen one of those in a while.  I love the bulbous, knot-like texture.  Maybe I'll graft it onto a chair and make one of my boys sit on it for a few days.", false);
            else if (this.player.cocks[temp2].cockType == CockTypesEnum.TENTACLE) this.outputText("Oooh, a tentacle cock?  How lucky to find one of those on you!  I've been meaning to add another poor tentacle-slave.", false);
            else if (this.player.cocks[temp2].cockType == CockTypesEnum.ANEMONE) this.outputText("Oooh, an anemone-cock?  Simply marvelous!  I might have to crank up the strength of the venom and use it myself!", false);
            else this.outputText("Oooh, a normal, uncorrupted cock.  How utterly droll!  You'd think these would be more common, but it's quite a treat to come across one.", false);
        ...
        //(Cunts)
            ...
            if (this.player.wetness() >= 5) this.outputText("My my, what a juicy box you have there.  Tell me, doesn't it bother you to be soaking in your own lubricants all the time?  Perhaps I'll put it on one of my slaves and mount her on the wall.  Then I can simply slip in and lube up before giving one of my other pets a proper lesson.", false);
            else if (this.player.wetness() >= 3) this.outputText("My my, what a nice wet pussy you have there.  I really feel that you have a perfect blend of moisture and practicality down there.  I might have to snatch that snatch and give it to one of my drier pets.", false);
            else if (this.player.vaginalCapacity() >= 150) this.outputText("My my, what a terrifically gaped hole you have there.  Do minotaurs even feel anything while they rail you?  Perhaps I could use that when I'm playing with Shenandoah.  She's had a few too many incubi drafts and can be a little difficult to handle.", false);
            else this.outputText("My my, such a pretty pussy.  I bet it would be fun to replace one of my noisier pet's mouth with.  She never did learn not to bite.", false);
            this.outputText("</i>\"\n\n", false);
        }
        //(Tits)
        else {
            this.outputText("Ceraph's hands reach up to cup the swell of your " + this.biggestBreastSizeDescript() + " as she asks, \"<i>", false);
            if (this.player.biggestTitSize() > 14) this.outputText("Oh wow... just wow.  How do you walk?  With melons like this you could tit-fuck three or four people at once!  Absolutely exquisite.", false);
            else if (this.player.biggestTitSize() > 6) this.outputText("Tell me dear, are they real?  I mean, were they always this size, or did you have to get a little bit of work done?", false);
            else this.outputText("Well, these are a bit small.  Have you ever considered trying some Gro Plus?  I hear it's all the rage with Lethice's lackeys nowadays.", false);
            this.outputText("</i>\"\n\n", false);
        }
    ...
    private giveUpYourBallsOrWhateverForLessFetishes(): void {
        ...
        //(Cock)
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00217] == 1) {
    ...
    public ceraphBodyPartDreams(): void {
        ...
        //pussies
        this.temp = this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00219];
        while (this.temp > 0) {
            this.temp--;
            choices[choices.length] = 2;
        }
        this.temp = this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00220];
        while (this.temp > 0) {
            this.temp--;
        ...
        if (choice == 2) {
            ...
            if (subChoice == 0) {
                ...
                if (!this.player.hasVagina()) this.outputText("You don't have a vagina any more, do you?", false);
            ...
            //PUSSY CLITPUMP
                ...
                if (!this.player.hasVagina()) this.outputText("Wait... you don't have a clit any more... Ceraph took that away.  ", false);
                else this.outputText("Wait... that's not your " + this.clitDescript() + "... it's the one Ceraph took from you.  ", false);
            ...
            //PUSSY FLESHLIGHT
                ...
                if (!this.player.hasVagina()) this.outputText("Wait... you don't have a pussy anymore.  ", false);
            ...
            //Tit Volleyball
                ...
                if (this.silly()) this.outputText("Pink Flamingo ");
                ...
                if (this.silly()) this.outputText("horsecocks ");
                else this.outputText("demonic cocks ");
                ...
                if (this.silly()) this.outputText(" and what possible ramifications it has for your mental health");
    ...
    public buttRapeCeraph(): void {
        ...
        if (this.monster.HP < 1) this.outputText("her tail hanging limp between her legs.  She spits a wad of bloody saliva and says, \"<i>What's the matter?  Beat a girl senseless and lose your nerve?  I thought you were going to rape me.</i>\"", false);
        else this.outputText("her rump up in the air while her tail plunges violently into her cunt over and over again.  She moans up to you, \"<i>What's the matter?  Are you nervous about putting it inside me?  Come on... rape me already!  Punish my gushing-wet cunt with your divine rod!</i>\"", false);
        ...
        if (this.player.cockTotal() == 2) this.outputText("  The other " + this.cockDescript(x) + " rubs against her butt-cheeks, sliding through them with ease thanks to her copious secretions.", false);
        else if (this.player.cockTotal() > 2) this.outputText("  The rest of your male genitals slide between the demoness' pert butt-cheeks in one huge, femcum-slicked bundle.", false);
        ...
        if (this.monster.HP < 1) this.outputText("  Cunt-juice splatters over your " + this.player.legs() + " as Ceraph's now-energetic tail plunges into her sodden box, pumping into it in time with the penetration of her asshole.", false);
        else this.outputText("  Cunt-juice dribbles over your " + this.player.legs() + " as Ceraph's tail slowly and purposefully plows her box, mimicking the penetration of her asshole.", false);
        this.outputText("\n\n", false);
        ...
        if (this.player.cumQ() >= 500 && this.player.cumQ() < 1500) this.outputText("Her belly bulges slightly from the cummy deposit, marking her even more obviously as a cum-bucket for your cock.  ", false);
        else if (this.player.cumQ() >= 1500) this.outputText("Her belly burbles and swells, bulging out to look positively pregnant, though you know she's packed from the other end.  ", false);
