...
export class CeraphScene extends NPCAwareContent {
    ...
    private finalCeraphEncounterChoiceNo(): void {
        ...
        this.outputText(
            "With that declaration she departs, leaving you confused and horny.",
            false
        );
    ...
    public encounterCeraph(): void {
        ...
        if (this.flags[kFLAGS.PC_FETISH] == 1) {
            this.outputText(
                "Though you spend an hour exploring, you don't find anything of note.",
                true
            );
            return;
        }
    ...
    public ceraphBodyPartDreams(): void {
        ...
        if (choice == 2) {
            ...
            // Tit Volleyball
                ...
                if (this.silly())
                    this.outputText(
                        " and what possible ramifications it has for your mental health"
                    );
                this.outputText(
    ...
    public buttRapeCeraph(): void {
        ...
        this.outputText("", true);
        this.outputText(
            "Completely defeated, the haughty demoness lies face down in the dirt, ",
            false
        );
        if (this.monster.HP < 1)
            this.outputText(
