    ...
    private victoryDickKiha(): void {
        ...
        if (y != -1 && this.player.cockTotal() > 1) {
            ...
            if (this.player.isNaga() || this.player.tailType == TAIL_TYPE_LIZARD || z >= 0) {
                ...
                if (z >= 0)
                    this.outputText(
                        ", plunging the head of your cock in and out of her throat.",
                        false
                    );
                this.outputText("\n\n", false);
            }
        ...
        // (SINGLE DICKING VARIANT)
            ...
            this.outputText(
                "  Somehow, you doubt she'll learn anything from the encounter.",
                false
            );
        }
        this.player.orgasm();
    ...
    private analRapuzulaKiha(): void {
        ...
        if (y >= 0) {
            ...
            if (this.player.cockTotal() >= 3) {
                if (this.player.cockTotal() == 3)
                    this.outputText(
                        "; your remaining cock tarnishes the ground with your cum",
                        false
                    );
                else
                    this.outputText(
                        "; your remaining cocks tarnish the ground with your cum",
                        false
                    );
            } else if (this.player.hasVagina())
                this.outputText(
