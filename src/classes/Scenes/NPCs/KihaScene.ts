...
export class KihaScene extends NPCAwareContent {
    ...
    public kihaLossIntro(): void {
        ...
        // Rape texts if horny
            ...
            this.outx(
                "Leaving her axe to rest a few feet away, stuck on the ground, Kiha strips off your " +
    ...
    private kihaMilkTitHumiliation(): void {
        ...
        this.outx(
            "Kiha recoils at the drops of white beading atop your " +
        ...
        this.outx(
            "The scaly woman leans down to tug on your " +
                this.nippleDescript(0) +
    ...
    private kihaRapesMen(): void {
        ...
        this.outx(
            "You try to rise, but the dragon girl whips around, her long, thick tail delivering a subduing crack against the side of your head, dropping you back onto your " +
                this.buttDescript() +
                ".  Triumphantly standing over you, the scaled woman eyes you with a panting breathlessness that betrays the coldness in her gaze.  She squints, arcing an imperious eyebrow as she looks you up and down, drawing her hands back to shoulder level and barely brushing against her breasts.  Her tail lashes back and forth between her legs, wrapping around her calves as she lifts a clawed foot and rests it lightly upon your stiffening groin.  Apparently, your fight left her wanting more than just your gems.  Her flexible toes squeeze your " +
        ...
        this.outx(
            "With a swift kick to your collarbone, Kiha knocks you on your back and stands over you, her vulva swollen with excitement despite her frosty insults.  She opens your " +
                this.player.armorName +
                " with her long, clenching talons just enough to expose " +
                this.sMultiCockDesc() +
                ".  The dragoness curls her tail between her legs, the warm, scaled surface of the dexterous limb rubbing your tender flesh impatiently, tip flicking " +
                this.oMultiCockDesc() +
                ' before coiling around the crest of your cockhead.  The narrow point of her backside pokes at your urethra, parting the narrow slit and tickling the sensitive, silken interior to draw a weak gasp from you.  "<i>Yeah, I bet you\'d love to get penetrated,</i>" she scoffs, wrapping her hands around the thick girth of tail poking between her thighs like a massive, scale-textured cock.  She strokes the fat plates and thumbs the ridge-like nobs lining its underside with a hip-swaying motion that sends her chest wobbling.  "<i>But,</i>" she continues, her tail lifting off of your ' +
                this.multiCockDescriptLight() +
                ' and curling upwards, "<i>this isn\'t about what you want.</i>"\n\n',
            false
        );
        ...
        this.outx(
            "Before long, her cunny practically drools, but you're not sure what she's getting off on more, the tail teasing her clit or your dick stiffening uncontrollably at her feet.  She grins, more to show her teeth than in pleasure, and begins to feed her tail into her snatch, the girl's folds parting eagerly to the rough limb, her honeypot polishing her scales to a liquid gleam almost immediately.  As she pumps long, slow thrusts inside herself, Kiha shifts to one leg, bringing her adept foot to your " +
                this.cockDescript(x) +
                " once more",
            false
        );
        if (this.player.balls > 0)
            this.outx(
                ", resting the heel of her foot against the swell of your " +
                    this.ballsDescriptLight() +
                    " and applying just enough pressure to feel the cum churning within",
                false
            );
        this.outx(
        ...
        this.outx(
            "The gushing honey pooled and slathered along her tail and asscheeks while she was frigging herself gives you more than enough lubrication to part the dragon's silken passage, muscled sphincter clenching rhythmically, more to pull you deeper inside than in response to the sudden intrusion.  You cry out at the intense tightness sucking at your " +
                this.cockDescript(x) +
                " and reach up to grab the girl's breasts, but she smacks your hands away with a sharp blow.  \"<i>If you dirty my scales with your filthy mitts, I'll crush you between my thighs!</i>\" she gasps, running her own hands through her hair as her head rolls back in delight.  She rides you hard, bouncing off of your lap without regard for the bruising her athletic ass is giving your " +
                this.hipDescript() +
        ...
        this.outx(
            "With a rumbling growl, the dragoness impales herself on your " +
                this.cockDescript(x) +
        ...
        if (this.player.balls > 0)
            this.outx(
                ", your " +
                    this.ballsDescriptLight() +
                    " practically leaping in over-burdened joy as their heavy load rushes through your flesh",
                false
            );
        this.outx(
            ".  A geyser of hot spunk sprays from your " +
                this.cockDescript(x) +
        ...
        this.outx(
            "When you come to, your throat feels raw, the taste of her pussy still on your lips.  Surprisingly, your groin is wet, but not sticky, without a trace of semen anywhere.  She must've licked " +
                this.sMultiCockDesc() +
                " clean after you passed out.  Your " +
                this.hipDescript() +
                " are still sore from the wild woman's ride, so it takes you longer than usual to limp your way back to camp.",
            false
        );
        this.player.orgasm();
        this.cleanupAfterCombat();
    ...
    private kihaRapesHerms(): void {
        ...
        this.outx(
            'The dragoness rolls her eyes and closes the distance between the two of you with a slow, deliberate pace.  She easily bats away your weakened defenses until she is standing inches from you, her tail whipping back and forth as a cold smile curls on her dusky lips.  "<i>Strip,</i>" she commands, her voice a quiet whisper.  When you fail to comply, a crimson thunderbolt cracks across your sight and your face explodes with pain.  Blinking, you stagger back a few steps, Kiha\'s backhand still raised.  Annoyance playing over her face, she holds you in a smoldering glare as she hisses, "<i>I don\'t repeat myself,</i>" from between clenched teeth.  Rather than antagonize the dragon girl further, you comply, shedding your ' +
                this.player.armorName +
                ' to bare your exposed body to her.  A flash of delight flickers across her mouth but is quickly quelled by her mask of disdain.  "<i>Weak, puny, and utterly incapable.  Tch, I suppose it can\'t be helped,</i>" she mutters, loudly enough for you to hear.  Advancing on you once again, she places a clawed hand on your ' +
                this.chestDesc() +
                ", almost tenderly.  Then, in a swift motion, she punches the heel of her palm against your sternum, abruptly knocking you to the ground.  Bending over your prone body, she lowers herself to straddle your " +
                this.hipDescript() +
        ...
        this.outx(
            ", Kiha repositions herself so that her ashen-hued vulva presses moistly against your " +
                ...
                ", the plush lips of her nethers lapping at yours in a torrid embrace.  Rocking against you in an angular motion, the dragon's sweltering sex grinds against your own sensitive flesh, small shocks of overstimulation arcing through your hips as her stiff, pink pearl brushes against your " +
                this.clitDescript() +
                ".  You mirror her motions, rubbing into the girl with increasing urgency as your flesh engorges, nearly forgetting the throbbing imperative of your " +
                this.multiCockDescriptLight() +
                ".\n\n",
            false
        );
    ...
    private tsundereMasturbationChristmasCarol(): void {
        ...
        this.spriteSelect(72);
        this.outx(
            "You walk towards the draconic woman, removing your " +
                this.player.armorName +
        ...
        if (this.player.hasCock()) {
            this.outx(this.multiCockDescriptLight() + " against her soft flesh, ", false);
            if (this.player.cockTotal() == 1)
                this.outx(
    ...
    private kihaVictoryPomfTail(): void {
        ...
        this.outx(
            "  Now nude, you sway your " +
                this.hipDescript() +
                " back and forth sensually, forcing Kiha to watch your body before you use her.  ",
            false
        );
        ...
        this.outx(
            "Satisfied that it is sufficiently lubricated, you squeeze the now-slippery tail and point its nubby tip at your entrance.  It bumps your " +
                this.clitDescript() +
                " as you wrangle with the struggling hind-limb, only turning you on all the more.  Feeling the tip circling your tunnel's opening, you push it up and seat the tentacle-like tail deep inside yourself.  ",
            false
        );
        this.player.cuntChange(1, true, false, true);
        this.outx(
            "Gods she's so... warm, and the ridges, they're stroking every inch of your interior, even your g-spot!  Your " +
                this.player.legs() +
                " wobble unsteadily, but spurred by lust, you keep an iron grip on your new-found toy.  Kiha doesn't stop resisting either.\n\n",
            false
        );

        this.outx(
            "Leaning back against the tree the dragon previously occupied, you slide down, letting your " +
                this.player.legs() +
                " go completely nerveless.  Kiha's struggles unintentionally add to your pleasure, turning her tail into the world's warmest, most powerful vibrator.  Your hands begin to push more of her girthy thickness inside, stretching your poor puss further and further.  ",
            false
        );
        ...
        this.outx(
            "Well, that's her loss.  You keep fucking yourself on her ridged posterior, enjoying the rapid twitches, hard wiggles, and other constant movements.  It almost feels like it's attacking your pussy, battering your womanhood with pleasurable strikes.  Your " +
                this.hipDescript() +
        ...
        this.outx(
            " girl-cum, your " +
                this.vaginaDescript() +
                " cums hard.  It squeezes down with clenching, rippling action that finally stop the tail's frantic struggles, immobilizing it in your womanhood.\n\n",
            false
        );
    ...
    private victoryDickKiha(): void {
        ...
        if (this.monster.lust > 99)
            this.outx("Just because you've aroused my body doesn't mean I'll enjoy this!", false);
        ...
        if (this.player.lust > 60)
            this.outx("only makes " + this.sMultiCockDesc() + " harder.", false);
        else this.outx("quickly makes " + this.sMultiCockDesc() + " hard", false);
        this.outx(
        ...
        if (this.player.hasVagina()) this.outx("and " + this.vaginaDescript() + " ", false);
        this.outx(
        ...
        this.outx(
            "You advance on her helpless form and repeat your actions, raising her leg and shoving her tail aside.  She resists, but not as fiercely as before.  Her tail is easily kept at bay while you lower yourself to align your " +
                this.hipDescript() +
                " with the Kiha's moist cunt.  The heat rolling out of her loins is unreal.  Her pussy seems to fog the air with its combination of warmth and wetness, and as you press your " +
                this.cockDescript(x) +
        ...
        if (y != -1 && this.player.cockTotal() > 1) {
            ...
            if (this.player.isNaga() || this.player.tailType == TAIL_TYPE_LIZARD || z >= 0) {
                ...
                if (z >= 0)
                    this.outx(", plunging the head of your cock in and out of her throat.", false);
                this.outx("\n\n", false);
            }
            ...
            this.outx(
                "Dully, you realize " +
                    this.sMultiCockDesc() +
                    " are twitching, her powerful clenching holes combining with your frenzied strokes too much for you to endure.  Heat boils out from your " +
                    this.ballsDescriptLight() +
                    " as your orgasm approaches, threatening to burst from your loins even as blackness eats at the edges of your vision.  Screw it - if she's choking you out, you're at least going to get to cum first.  You grab both her nipples as you hilt yourself and twist, HARD.  Jizm spurts from your cocks, glazing Kiha's hot, juicy puss,",
                false
            );
            if (this.player.isNaga() || this.player.tailType == TAIL_TYPE_LIZARD || z >= 0)
        ...
        // (SINGLE DICKING VARIANT)
            ...
            this.outx(
                "That perfect, dripping entrance beckons for your " +
                    this.cockDescript(x) +
                    ', and without hesitation, you slide inside.  Kiha growls, "<i>That\'s it?  How artless.</i>"  In spite of her disappointed tone, her slippery passage squeezes down on your member with miraculous tightness, embracing your ' +
                    this.cockDescript(x) +
            ...
            this.outx(
                "Eventually, you become accustomed to the feel of the reptilian tunnel's simmering juices, and eager for more stimulation, you begin to saw your " +
                    this.cockDescript(x) +
            ...
            this.outx("  Somehow, you doubt she'll learn anything from the encounter.", false);
        }
        this.player.orgasm();
        this.cleanupAfterCombat();
    }
    ...
    private kihaRapesLittleGirlsISawItOnTheNews(): void {
        ...
        this.outx(
            "Despite the pleasure of your crumbling restraint, the pleading shudders of your cumming body makes her even more aggressive than before.  \"<i>Yes!  Beg for mercy!  You don't deserve a minute of my time! How could someone like me ever be interested in a pig like you?</i>\"  To punctuate the game she's playing with your honeypot, Kiha pinches your " +
                this.clitDescript() +
                " between her fingers, the narrow nails of her claws squeezing your sensitive nub so tightly your jaw drops in a soundless scream of bliss.\n\n",
            false
        );

        this.outx(
            '"<i>Here\'s how this is going to go,</i>" she murmurs when you\'ve finally stopped gasping for breath.  "<i>You will lick me until I tell you to stop, and every time you displease me I\'m going to take it out on your sensitive little fuck hole.</i>"  She swings around and sits on your face, smashing her wet cunt on your ' +
                this.player.face() +
                ".  \"<i>Be grateful that I'm letting you do this,</i>\" she gurgles, pinching your clit again for emphasis.  Doing as you're told, you lick deeply into the warm velvet of the dragon's folds.",
            false
        );
    ...
    */
    ...
    private analRapuzulaKiha(): void {
        ...
        if (this.player.cockArea(x) <= 20)
            this.outx(
                "You quickly shed your " +
                    ...
                    ", letting your " +
                    this.multiCockDescriptLight() +
                    ' out to breathe in the warm, swampy air.  Her red eyes widen slightly, but she quickly regains her composure, suddenly all confidence despite her obvious loss.  "<i>Oh? What do you think you\'re gonna do with THAT, huh?  Just ravish me like some kind of sex-crazed demon? Is that your genius plan?</i>"\n\n',
                false
            );
        else
            this.outx(
        ...
        this.outx(
            "You begin to feel the temperature around your cockhead rise.  The intense heat from her drooling cunt gets your blood flowing, getting " +
                this.sMultiCockDesc() +
                " to grow to its full size.  You stop your cheek-sawing and place your member against her slick labia, thrusting against her taint for additional lubrication in preparation for your backdoor adventure.\n\n",
            false
        );
        ...
        this.outx(
            "As soon as your fingers touch her skin, her tail whips around your " +
                this.multiCockDescriptLight() +
                ", wrapping up your groin",
            false
        );
        if (this.player.balls > 0)
            this.outx(" and threatening to crush your " + this.ballsDescriptLight(), false);
        this.outx(
        ...
        this.outx(
            "She shrieks in shock from your sudden treatment. Having the desired effect, your distraction gives you the split second you need to slip your genitals out of her tail's grasp. You quickly place your " +
                this.cockDescript(x) +
        ...
        if (y >= 0) {
            ...
            this.outx(
                "You pull out one final time, placing them at her gaping ring.  Knowing what you're about to do, the dragon visibly relaxes in an attempt to make it as painless as possible.  Getting a good grip on her hips, you thrust your dongs forward and pull her back onto your cocks simultaneously.  Your " +
                    this.cockDescript(y) +
                    " slips from the exposed hole and slides itself between her buttcheeks, while your remaining " +
                    this.cockDescript(x) +
                    " hits home.\n\n",
                false
            );
            ...
            this.outx(
                "Kiha shudders in her own climax, soaking her thighs as you finally release your seed into her ravaged ass.  Your other " +
            ...
            if (this.player.cockTotal() >= 3) {
                if (this.player.cockTotal() == 3)
                    this.outx("; your remaining cock tarnishes the ground with your cum", false);
                else this.outx("; your remaining cocks tarnish the ground with your cum", false);
            } else if (this.player.hasVagina())
                this.outx(
                    "; your " +
                        this.vaginaDescript() +
                        " pulses with pleasure, soaking your thighs with girl-cum as your cocks unload",
                    false
                );
            this.outx(".\n\n", false);

            this.outx(
                "The dragoness slumps and falls to the ground, drawing your spent shaft from her ass's depths.  It appears that she has fainted from overwhelming pain, pleasure, and exhaustion. Deciding that you're done here, you retrieve your " +
                    this.player.armorName +
                    " and leave the girl in a mixed puddle of your cum and hers.  Perhaps now she'll treat you with a little more respect.  You return to camp.",
                false
            );
        } else {
            if (this.player.cockArea(x) <= 20)
            ...
            this.outx(
                "Her moans become louder as you continue the butt-fuck, her hole becoming as wet as her pussy as your intruding member slides in and out of her dilated sphincter.  Her involuntary signs of enjoyment spur you on and pre flows freely from your member, allowing you to ignore her crushing tightness and enjoy the hot pleasure that envelops your " +
                    this.cockDescript(x) +
            ...
            if (this.player.hasVagina())
                this.outx(
                    "Your " +
                        this.vaginaDescript() +
                        " pulses with pleasure, but it's an empty orgasm, leaving you wishing you had something to fill that aching void.  Still, you cannot help but marvel at the superior feeling of cumming with a multitude of sexual organs.  ",
                    false
                );
            this.outx(
            ...
            this.outx(
                "Deciding that you are done here, you retrieve your " +
                    this.player.armorName +
                    " and leave the girl. Perhaps now she'll treat you with a little more respect. You return to camp.",
                false
            );
        }
        this.player.orgasm();
