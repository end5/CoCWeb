    ...
    */
    ...
    private PCCarriedGooBackHome(): void {
        ...
        if (this.player.totalCocks() > 1)
            this.outputText(
                "  You can't help but wonder what it would feel like to let her sheath your " +
    ...
    private nameZeLatexGoo(input: HTMLInputElement): void {
        ...
        if (this.flags[kFLAGS.GOO_NAME] == "Cattleya")
            ...
            this.outputText(
                "Urta, huh?  What do you take me for, a furry?  I guess it will have to do,"
            );
            ...
            this.outputText(
                "Aeris, huh?  That sounds like a name for a hoity-toity pain in the ass!"
            );
            ...
            this.outputText(
                "Fetish, huh?  You're pretty transparent about your motives, aren't you?"
            );
            ...
            this.outputText(
                this.flags[kFLAGS.GOO_NAME] + ", huh?  I can live with that, I suppose,"
            );
        this.outputText(
    ...
    public approachLatexy(): void {
        ...
        if (this.gooTitSize() >= 35)
            this.outputText(
                "Utterly filled with moisture, her " +
                    this.gooTits() +
                    " are so big her arms can barely encompass them, her hands pressing fruitlessly against the sloshing sides.  The bubbly black surface bulges obscenely, barely containing the liquid weight within."
            );
        ...
        // {Pretty nice sized}
            ...
            this.outputText(
                "Big enough to hide most of her torso, the " +
                    this.gooTits() +
                    " sway and bounce ponderously.  Light reflects off the shiny, hypnotizing surface of her chest as she supports it with her hands."
            );
        // {Big SizedVolley}
        else if (this.gooTitSize() > 4)
            this.outputText(
                "Well-rounded and jiggly, her " +
                    this.gooTits() +
                    " ripples slightly as she moves.  Those well-rounded spheres seem soft and firm at the same time."
            );
        // {LargeDD}
        else if (this.gooTitSize() > 3)
            this.outputText(
                "Sitting high on her chest, a proud pair of " +
                    this.gooTits() +
                    " jiggle slightly with her every movement.  They're still nice and round, but nowhere near the mammoths she had before."
            );
        // {MediumC}
            ...
            this.outputText(
                "High and curvy, her " +
                    this.gooTits() +
                    " looks pert and perky, topped with dark chocolate nipples.  The reflective surface makes them appear larger than they truly are, a feast of midnight darkness for your eyes."
            );
        // {LightA}
        else
            this.outputText(
                "Sitting high on her chest, her " +
                    this.gooTits() +
                    " seems almost disproportionately tiny for her frame.  The perky onyx nipples protrude invitingly, tiny caps of inviting midnight."
            );
        // {Regardless}
        this.outputText(
            "  You estimate " +
                this.flags[kFLAGS.GOO_NAME] +
                "'s chest would fit a " +
                Appearance.breastCup(this.gooTitSize()) +
        ...
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] > 0)
            this.outputText(
                "Below her waist, a " +
                    LatexGirl.num2Text(Math.round(this.flags[kFLAGS.GOO_DICK_LENGTH] * 10) / 10) +
                    "-inch, " +
                    this.gooCock() +
                    " hangs, soft and shiny.  "
            );
        this.outputText(
        ...
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] == 0) {
            ...
            this.outputText(
                '\n\n"<i>You\'re making it harder!</i>" ' +
                    ...
                    this.flags[kFLAGS.GOO_NAME] +
                    " now has a " +
                    LatexGirl.num2Text(this.flags[kFLAGS.GOO_DICK_LENGTH]) +
                    "-inch "
            );
            ...
            if (item == this.consumables.GROPLUS) {
                this.outputText(
                    "Her " +
                        this.gooCock() +
                        " shivers, and starts to sprout outward from the base, lengthening before your very eyes.  One... two... three... new inches of gleaming prick reveal themselves to you!\n\n" +
                        this.flags[kFLAGS.GOO_NAME] +
                ...
                this.outputText(
                    "Her " +
                        this.gooCock() +
                        " trembles, and starts to shrink inward, disappearing into her polished abdomen.  The effect is so startling profound that you have to do a double-take.  " +
                        this.flags[kFLAGS.GOO_NAME] +
                ...
                this.outputText(
                    "Her " +
                        this.gooCock() +
                        " rapidly erects, rising to full tumescence in seconds.  The veins begin to shift, crawling around under her onyx skin like little worms as her penis reshapes it.  A muffled moan escapes from " +
                        this.flags[kFLAGS.GOO_NAME] +
    ...
    private changeLatexyTits(arg = 0): void {
        ...
        // To huge {very nice} size!
            ...
            if (this.gooTitClass(this.gooTitSize()) < 6)
                this.outputText(
                    this.flags[kFLAGS.GOO_NAME] +
                        " places her hands on the underside of her breasts and winks.  As you watch, her " +
                        this.gooTits() +
        ...
        // To DDish {large} sized:
            ...
            // Smaller: " +
                ...
                this.outputText(
                    this.flags[kFLAGS.GOO_NAME] +
                        ' groans in disappointment, "<i>I liked em big!  Well, you\'re the boss...</i>"  She clenches her fists and closes her eyes.  Nothing happens at first, but after a moment, her ' +
                        this.gooTits() +
                        " tighten up.  Over the span of a few dozen seconds, " +
                        this.flags[kFLAGS.GOO_NAME] +
        ...
        // To C {medium} sized:
            ...
            // Smaller:
                ...
                this.outputText(
                    this.flags[kFLAGS.GOO_NAME] +
                        " shudders, but obeys.  First, she presses down on her " +
                        this.gooTits() +
                        ', then, she blinks her eyes closed and shivers.  Before your eyes, the breast-flesh diminishes, eventually settling on a pair of curvy C-cups.  "<i>I look like I must be dehydrated!  Good thing the other girls can\'t see me!</i>"'
                );
        }
        // To A {light} sized:
            ...
            this.outputText(
                this.flags[kFLAGS.GOO_NAME] +
                    ' says, "<i>I\'ll look anemic!  The other goo-girls will think I\'m starving!</i>"  You give her a condescending look and she sighs.  "<i>All right, all right.  If my [master] wants tiny tits, ' +
                    this.player.mf("he'll", "she'll") +
                    ' get them.</i>"  She grabs hold of her ' +
                    this.gooTits() +
                    " and compresses them in her grip.  Amazingly, the latex chest-flesh recedes into her as she pushes, diminishing before your very eyes.  She whimpers when they hit B-cups and groans when they reach A's.  " +
                    this.flags[kFLAGS.GOO_NAME] +
    ...
    private feedLatexyCumIndirectly(): void {
        ...
        this.outputText(
            "\n\nRather than disappoint those eager eyes, you cum.  The torrent of heat that swells inside you doubles in power and then, explodes.  You arch your back and pump forward, barely remembering to angle your " +
                this.multiCockDescriptLight() +
                " down toward the bowl before you spurt.  Spooge squirts from "
        );
    ...
    private minotaurCumFeedingGoo(nice = false): void {
        ...
        if (this.player.minotaurNeed()) {
            ...
            this.outputText(
                "  You pull back, panting and unsated, wishing you had drank it yourself"
            );
    ...
    private feedLatexyCumDirectly(): void {
        ...
        if (this.player.cockTotal() > 1) {
            ...
            this.outputText(
                " her " +
                    this.gooTits() +
                    " with a sheen of white, wasting their moisture in a decadent display of virility."
            );
        }
        if (this.player.cumQ() >= 500)
            this.outputText(
    ...
    private feedLatexyGirlCumDirect(): void {
        ...
        if (this.player.wetness() >= 4)
            ...
            this.outputText(
                "  You gradually fill her mouth with your free-flowing orgasmic lubricants."
            );
        this.outputText(
    ...
    private assertControlOverCuntDrainingLatexGoo(): void {
        ...
        this.outputText(
            "\n\n\"<i>I'm sowwy, " +
                this.player.mf("Mashta", "Mishtrish") +
        ...
        this.outputText(
            '\n\n"<i>' +
                this.player.mf("Masterrrr", "Mistriiiiissss") +
                '!</i>"  ' +
                this.flags[kFLAGS.GOO_NAME] +
    ...
    private femalePCDomFucksLatexGoo(): void {
        ...
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] > 0)
            this.outputText(
                "  Meanwhile, the " +
                    this.gooCock() +
                    " sways uselessly above the conjoined vaginas, leaking its own secretions as it's ignored."
            );
        this.outputText(
        ...
        if (this.player.hasCock())
            this.outputText(
                "  Some of it even splats onto your " +
                    this.multiCockDescriptLight() +
                    ", leaving tight black spots on your maleness."
            );
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] > 0)
            this.outputText(
                "  Her " +
                    this.gooCock() +
                    " practically bursts from within, distending to accommodate its lurid latex discharge.  Most of it splatters against " +
                    this.flags[kFLAGS.GOO_NAME] +
    ...
    private femalePCDomFucksLatexGooFuta(): void {
        ...
        this.outputText(
            "\n\nWith a salacious wiggle of your [hips], you tell her that you're going to fuck her - to ride her shining pole to orgasm after orgasm.  " +
                ...
                "'s " +
                this.gooCock() +
                " immediately stiffens, hard and proud.  "
        );
        // {NOT OBEDIENT ENOUGH}
        if (this.gooObedience() < 60) {
            ...
            this.outputText(
                ', "<i>No.  You can\'t make me.  I may be stuck in this camp and separated from my people, but I will not let myself be some sexual toy.</i>"  A trickle of inky lubricant between her legs and the rigidity of her ' +
                    this.gooCock() +
                    " have you doubting that claim, but she seems resolute in her desire to avoid direct sex, for now."
            );
            if (this.gooFluid() < 10)
                this.outputText(
                    "  Her hunger is palpable, perhaps it would be best if you simply 'fed' her soon?"
        ...
        this.outputText(
            "rump bulges out a bit when she settles out on it, and you pause a moment to admire the curvy onyx shape before you.  Her " +
                this.gooCock() +
                " stiffens before your eyes.  Its reflective obsidian skin slowly goes taut, making it shine in the light.  Bigger and bigger, it grows until it reaches its limit, and even then, " +
                this.flags[kFLAGS.GOO_NAME] +
        ...
        this.outputText(
            "\n\nYou gently pat the " +
                this.gooCock() +
                " and snicker at her - of course she did.  How fortuitous that she'll get to be your dildo today, then.  You stroke the iron-hard penis with a thumb and it jumps high, bouncing up towards the contact like a cat wanting to be petted.  Snickering, you brush through the black bubble, smearing pre-cum up and down over the turgid erection.  The liquid latex pre-cum quickly dries on your hand to give it the appearance of a gloss-black glove.  You figure you may as well complete the look, and after switching hands, you have matching mitts.  The latex woman's tool remains defiantly unchanged by her pre-cum - it seems to absorb directly into her skin once it dries, leaving it as slippery and black as ever.  As fun as this is, you don't want her to blow just yet, at least not until you've had your fun."
        );
        this.outputText(
            "\n\nGrabbing it by the base, you angle the " +
                this.gooCock() +
                " up towards you.  Its tip thickens noticeably as if reading your intentions.  You swivel your [hips] around to hover above it, and without preamble, you push down, absorbing the slippery latex dick into your slick passage.  Between its pre-cum and your own lubricants, the penetration is blessedly easy."
        );
        if (
        ...
        this.outputText(
            "  You take a few experimental bounces, enjoying the feeling of that " +
                this.gooCock() +
                " pressing on your folds and stirring against your insides.  Your pet reaches up to grab onto your [hips] for support.  She pants "
        );
        ...
        this.outputText(
            ".  All too soon, you feel a telltale twitching of the " +
                this.gooCock() +
                " inside you, and before you can stop it, a thick, slick feeling of warmth radiates outward from your womb.  Accompanying the explosion of moisture and bodily heat, a gradual pressure wells up in your womb, culminating in an explosion of slick sable goop that "
        );
        ...
        this.outputText(
            "\n\nYou clench down on the " +
                this.gooCock() +
                " without warning, immediately setting to massaging it with your velvety interior.  Your pussy seems to know just what to do in order to get what it wants, and " +
                this.flags[kFLAGS.GOO_NAME] +
        ...
        this.outputText(
            ".  Together, the two of you give in to ecstasy and cum... and cum... and cum."
        );
        if (this.player.hasCock())
            this.outputText(
                "  White erupts from your " +
                    this.multiCockDescriptLight() +
                    " with abandon.  You don't even care that it stains " +
                    this.flags[kFLAGS.GOO_NAME] +
                    "'s " +
                    this.gooTits() +
                    ".  It feels so good and she looks so pretty with strands of icing spattering over top of her."
            );
    ...
    private malePCDomFucksLatexGoo(): void {
        this.clearOutput();
        this.outputText(
            "You open your [armor] to expose your " +
                this.multiCockDescriptLight() +
                " to your latex-based lover.  She eyes it with unabashed affection and licks her lips unthinkingly, already tasting the flavor of semen on her tongue.  " +
                this.flags[kFLAGS.GOO_NAME] +
        ...
        this.outputText(
            ".  Past her mouth, her insides become far less solid.  It feels like a mass of warm goo that deep inside her, and combined with the feel of her slippery tongue caressing the underside of your " +
                this.cockDescript(0) +
        ...
        this.outputText(
            "\n\n" +
                ...
                "'s vibrant " +
                this.flags[kFLAGS.GOO_EYES] +
                " eyes look up at you as her cheeks hollow to provide suction.  You groan again, this time slowly pulling her head back.  As she withdraws, her slick black spit drips from your dick, though much of it gradually hardens into a reflective sheath for your tool.  You draw her off until only your " +
                this.player.cockHead() +
                " remains inside that suckling pleasure-hole.  Then, you slam her down, fucking her mouth"
        );
        ...
        this.outputText(
            "\n\nWith her looking at you like that, fuck... you're cumming!  You pull her lips tight into your abdominal " +
                this.player.skinFurScales() +
                " and release the boiling bliss within you.  Your jizz jumps out of you in thick ropes, as if it was seeking to escape all this time and just now found freedom.  " +
                this.flags[kFLAGS.GOO_NAME] +
                " smiles around your " +
                this.cockDescript(0) +
        ...
        this.outputText(
            "\n\nThe teases have the desired effect on you, and you yank her down on your " +
                this.cockDescript(0) +
        ...
        this.outputText(
            "\n\nYou grab " +
                ...
                this.cockDescript(0) +
                ", you cum again.  Her slick snatch greedily devours the first few spurts your body can offer up.  It even massages your length from root to " +
                this.player.cockHead() +
                " to coax out more."
        );
        if (this.player.cumQ() >= 1000)
        ...
        if (this.flags[kFLAGS.GOO_DICK_LENGTH] > 0)
            this.outputText(
                "  The " +
                    this.gooCock() +
                    " below noisily fires inky loads into the dirt, where it's quickly absorbed."
            );

        this.outputText(
            "\n\nStaggering back, you rest against a boulder.  In the process, your " +
                this.cockDescript(0) +
                " exits " +
                this.flags[kFLAGS.GOO_NAME] +
        ...
        this.outputText(
            "\n\nOnce fully inside, her tight sphincter clamps on your " +
                this.cockDescript(0) +
        ...
        this.outputText(
            "\n\nAgain and again, you claim your prize's anal star.  Your hips seem to go on autopilot, plumbing that black butthole with rough passion.  Squirts of gooey ink and leftover, smeared spunk dribble out as you fuck her, and you grab hold of her " +
                this.gooTits() +
                ", as if a handhold would help you wrangle the unruly pleasure any better.  " +
                this.flags[kFLAGS.GOO_NAME] +
        ...
        this.outputText(
            "\n\nAs you get dressed, you realize your " +
                this.cockDescript(0) +
