...
export class UrtaPregs extends NPCAwareContent {
    ...
    */
    ...
    private IAintGotTimeForUrtaBirfs(): void {
        this.clearOutput();
        this.outx('The centaur looks perplexed at your refusal.  "<i>I - what?  Really?</i>"');
        this.outx(
    ...
    public getUrtaLetter(): void {
        ...
        if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] == 1) this.outx("son");
        else if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] == 2) this.outx("daughter");
        else this.outx("hermaphrodite daughter");
        this.outx(", though.\n");
    ...
    private goVisitUrtaBirfs(withUrta = false): void {
        ...
        if (gender == 2) this.outx("girl!");
        else if (gender == 1) this.outx("boy!");
        else
            this.outx(
        ...
        if (gender == 1 || gender == 3) {
            if (UrtaPregs.rand(2) == 0) {
                ...
                if (gender == 1) this.outx("son");
                else this.outx("daughter");
                this.outx("'s groin from where you are.");
            ...
            // [Horse Dick:
                ...
                this.outx('\n\n"<i>...My, my; looks like ');
                if (gender == 3) this.outx("s");
                this.outx("he takes after ");
                if (gender == 3) this.outx("her");
                else this.outx("his");
                this.outx(
                ...
                if (gender == 1) this.outx("he");
                else this.outx("she");
                this.outx(" is going to be quite a big ");
                if (gender == 1) this.outx("boy when he grows up.");
                else this.outx("girl when she grows up.");
        ...
        if (gender >= 2) this.outx("daughter");
        else this.outx("son");
        this.outx("... look, [name], ");
        // [she's]
        if (gender >= 2) this.outx("she's");
        else this.outx("he's");
        this.outx(' really here; our beautiful, beautiful little baby...</i>" She sobs, ');
        if (this.urtaKids() == 0) this.outx("overwhelmed by the fact she's a mother at long last");
        else this.outx("still as delighted as ever to have a new addition to your growing brood");
        this.outx(".");
    ...
    private wakeUpWithUrtaAfterStaying(): void {
        ...
        if (this.flags[kFLAGS.URTA_KIDS_MALES] == 1) this.outx("son");
        else this.outx("daughter");
        this.outx(
        ...
        this.outx("\n\nYou hold the shaft ");
        if (this.player.cor < 50) this.outx("gently,");
        else this.outx("tightly,");
        this.outx(" earning a ");
        if (this.player.cor < 50) this.outx("whimpering moan");
        else this.outx("gasping shudder");
        this.outx(
        ...
        if (this.urtaKids() == 1) this.outx("a child");
        ...
        if (this.urtaKids() == 1) this.outx("new ");
        else this.outx("newest ");
        this.outx(
        ...
        if (this.urtaKids() == 1) this.outx("him");
        else this.outx("her");
        this.outx(".");
        if (this.urtaKids() == 2)
            this.outx(
    ...
    private drinkSomeUrtaPostBirthTitMilk(): void {
        ...
        if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] == 1) this.outx("his");
        else this.outx("her");
        this.outx(
    ...
    public urtaPregooUpdates(): boolean {
        ...
        // 4:
            ...
            if (this.pregnancy.type != PregnancyStore.PREGNANCY_PLAYER)
                this.outx("sounding somewhat jealous that it's you carrying and not her.");
            else this.outx("sounding a little smug as she caresses her own gravid tummy.");
            this.outx(
    ...
    public PCGivesBirf(): void {
        ...
        this.outx(" out here.  I know you wouldn't let anything bad happen to ");
        if (gender >= 2) this.outx("her");
        else this.outx("him");
        this.outx(", but, well, you can't really take care of ");
        if (gender >= 2) this.outx("her");
        else this.outx("him");
        this.outx(' properly in this wilderness, now can you?</i>"');

        this.outx(
            "\n\nYou are eventually forced to admit that it would probably be better for the baby if "
        );
        if (gender >= 2) this.outx("she");
        else this.outx("he");
        this.outx(
    ...
    public urtaIsAPregnantCopScene(): void {
        ...
        if (kGAMECLASS.telAdre.edryn.pregnancy.isPregnant)
            this.outx("  Edryn's pregnant belly isn't helping her, either.");
    ...
    public urtaSpecialDeliveries(): void {
        ...
        if (kGAMECLASS.telAdre.edryn.pregnancy.isPregnant)
            this.outx("as quickly as a pregnant mare can, anyway,");
        this.outx(" leaving you to head on to Urta's house.");
        ...
        if (this.pregnancy.event >= 7) this.outx("heavily ");
        this.outx(
    ...
    public talkToUrtaAboutHerHouse(): void {
        ...
        if (this.player.cor < 50) this.outx(" despite it having some emotional value to you.");
        ...
        if (this.urtaKids() > 1) this.outx("or two ");
        this.outx(
    ...
    private yesUrtaHouseSex(): void {
        this.clearOutput();
        this.outx("You smile seductively at her and raise a brow.");
    ...
    private noUrtaHouseSex(): void {
        this.clearOutput();
        this.outx("You smile at her and apologize, you're just not in the mood right now.");
    ...
    private talkAboutLiana(): void {
        this.clearOutput();
        this.outx("You tell Urta that you need to talk with her about something.");
        ...
        if (this.urtaKids() > 1) this.outx("ren have");
        else this.outx(" has");
        this.outx(' a special place in her heart.</i>"');
    ...
    private preggoUrtaSmexOrSomething(): void {
        ...
        switch (this.pregnancy.event) {
            case 7:
                this.outx("dripping wetly onto the floor");
                break;
            case 8:
            case 9:
                this.outx("slopping into the filling bucket");
                break;
            default:
                this.outx("staining her dress");
        }
        this.outx(
    ...
    private massagePregnantUrtasBelly(): void {
        ...
        if (this.player.tongueType == TONUGE_SNAKE) this.outx("forked ");
        ...
        this.outx("tongue hang and begin licking the cream off her breasts");
        ...
        this.outx(".  You make sure to pay extra attention to her cream covered nubs.");
    ...
    private urtaMassageClimax(): void {
        ...
        this.outx("  You walk out of her house, taking care to lock the door on your way out.");
    ...
    private urtaBoobWorshipScene(): void {
        ...
        if (
            ...
            this.outx(", always minding your sharp teeth");
        this.outx(
        ...
        if (this.player.hasCock()) this.outx(", tasting a bit of yourself,");
        this.outx(
    ...
    private urtaPregCravings(): void {
        ...
        if (this.player.lactationQ() >= 200)
            this.outx(", which automatically causes milk to trickle forth");
        this.outx('.  "<i>Nope, not it either...');
        if (this.player.lactationQ() >= 200) this.outx(" sweet, though.");
        this.outx(
        ...
        if (this.player.balls > 0) this.outx(" with your [balls]");
        this.outx(
        ...
        if (this.player.balls > 0 || this.player.hasVagina()) {
            this.outx(", a hand playing expertly with ");
            if (this.player.balls > 0) {
                this.outx("your balls");
                if (this.player.hasVagina()) this.outx(" and another with ");
            }
            if (this.player.hasVagina()) this.outx("your pussy");
        }
        this.outx(
    ...
    private getBlownByPregnantUrta(): void {
        ...
        if (this.player.balls > 0) this.outx("your balls churn and ");
        this.outx(
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() > 2) this.outx("s as they join");
            else this.outx(" as it joins");
            this.outx(" in on the onslaught.");
        }
    ...
    private holdOnYouAintGettingYerCumYetYouNaughtyFox(): void {
        ...
        this.outx("  Urta eagerly gulps and slurps, doing her best to swallow every drop.");

        // (Low Cum Amount)
        if (this.player.cumQ() < 250) {
            this.outx("\n\nYou feed her all you can, ");
            if (this.player.cockTotal() > 1) {
                this.outx("even splashing some cum over her face as your other cock");
                if (this.player.cockTotal() == 2) this.outx(" convulses");
                else this.outx("s convulse");
                this.outx(" in orgasm, ");
            }
            this.outx(
        ...
        // (Medium Cum Amount)
            ...
            if (this.player.cockTotal() > 1) {
                this.outx("Your other cock");
                if (this.player.cockTotal() == 2) this.outx(" contributes");
                else this.outx("s contribute");
                this.outx(" by making a complete mess of her as ");
                if (this.player.cockTotal() > 2) this.outx("they randomly spatter");
                else this.outx("it randomly spatters");
                this.outx(" her with cum, not that she seems to mind.");
            }
            this.outx(
        ...
        // (High Cum Amount)
            ...
            if (this.player.cockTotal() > 1) {
                this.outx("  Your other cock");
                if (this.player.cockTotal() > 2) this.outx("s shoot their loads");
                else this.outx(" shoots its load");
                this.outx(
            ...
            if (this.player.hasKnot(this.player.biggestCockIndex()))
                this.outx(", just above your knot,");
            this.outx(
        ...
        if (this.player.cumQ() >= 500) this.outx(", audibly gurgling");
        this.outx(
    ...
    private weirdUrtaCravingsConclusion(): void {
        ...
        if (this.player.cumQ() < 1000) this.outx("completely clean.");
        else this.outx("lacking the extra bit of paunch you gave her earlier.");
        this.outx(
    ...
    private urtaRaepsJoo(): void {
        ...
        if (this.player.cockTotal() > 0) {
            if (this.player.cockTotal() > 1) this.outx("  [EachCock] tenses in unison");
            else this.outx("  [EachCock] throbs, tensing in preparation");
            // (Low Cum Amount)
            if (this.player.cumQ() < 250)
                this.outx(
            ...
            // (High Cum Amount)
                ...
                this.outx(" and you let your prodigious load escape the confines of your ");
                if (this.player.balls > 0) this.outx("churning balls");
                else this.outx("being");
                this.outx(
        ...
        if (this.player.hasVagina()) {
            ...
            if (this.player.wetness() >= 4) this.outx("squirting");
            else this.outx("leaking");
            this.outx(
                " juices that paint Urta's balls, which are resting flush against your [vagina].  The spilled juice slides down Urta's balls"
            );
            if (this.player.wetness() >= 4) this.outx(" to join your previous discharge on");
            else this.outx(" and down towards");
            this.outx(" the floor, where it gathers in a ");
            this.outx("puddle of its own.");
        }
        // Genderless:
        if (this.player.gender == 0) {
            ...
            this.outx(" anal muscles milk Urta's shaft much like a pussy would.");
        ...
        if (puddle > 0) {
            if (puddle == 1) this.outx("small");
            else if (puddle == 2) this.outx("reasonable");
            else this.outx("enormous");
            this.outx(" puddle of cum you created");
        } else this.outx("floor");
        this.outx(
    ...
    private partTwoOfUrtaBoning(): void {
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (!this.player.isTaur())
                this.outx("  So close that you can almost feel its heat against your [cockHead].");
            this.outx(
    ...
    public visitKidsFirstTime(): void {
        this.clearOutput();
        this.outx("You ask Urta if she can take you to see your child");
    ...
    private newBabyComing(): void {
        ...
        if (this.urtaKids() < 8) {
            this.outx("\n\nAs ");
            if (this.urtaKids() == 1) {
                if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] >= 2) this.outx("she");
                else this.outx("he");
                this.outx(" approaches");
            } else this.outx("they gather");
            this.outx(" and curiously look");
            if (this.urtaKids() == 1) this.outx("s");
            this.outx(" at you, Urta gives ");
            if (this.urtaKids() > 1) this.outx("them");
            else if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] >= 2) this.outx("her");
            else this.outx("him");
            this.outx(" a loving smile.");
            ...
            // One person preg:
                ...
                if (this.pregnancy.type == PregnancyStore.PREGNANCY_PLAYER) this.outx("her");
                else this.outx("your");
                this.outx(" belly.");
            }
            this.outx("\n\nYour child");
            if (this.urtaKids() > 1) this.outx("ren are");
            else this.outx(" is");
            this.outx(" silent for a moment, digesting this information.  Then ");
            if (this.urtaKids() == 1) this.outx("a small fluffy bundle is");
            else this.outx("several small fluffy bundles are");
            this.outx(" doing ");
            if (this.urtaKids() == 1) this.outx("its");
            else this.outx("their");
            this.outx(" best to hug you both; ");
            if (this.urtaKids() > 1) this.outx("they");
            else if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] >= 2) this.outx("she");
            else this.outx("he");
            if (this.urtaKids() == 1) this.outx(" is");
            else this.outx(" are");
            this.outx(
                " clearly delighted at the prospect.  You and Urta smile at each other over "
            );
            if (this.urtaKids() > 1) this.outx("their");
            else if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] >= 2) this.outx("her");
            else this.outx("his");
            this.outx(" head");
            if (this.urtaKids() > 1) this.outx("s");
            this.outx(", then return the embrace, pleased that ");
            if (this.urtaKids() > 1) this.outx("they");
            else if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] >= 2) this.outx("she");
            else this.outx("he");
            if (this.urtaKids() == 1) this.outx(" is");
            else this.outx(" are");
            this.outx(" excited at the prospect.");
        }
        // If UrtaKids =>8:
        else {
            this.outx(
    ...
    private hugAttackScene(): void {
        ...
        this.outx(" insistently pull");
        if (this.urtaKids() == 1) this.outx("s");
        this.outx(" you towards the backyard, while your lover chuckles at your predicament.");
    ...
    private bathtime(): void {
        this.clearOutput();
        this.outx("You tell Lianna you just wanted to check in on your ");
        if (this.urtaKids() > 1) this.outx("kids");
        else if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] >= 2) this.outx("daughter");
        else this.outx("son");
        this.outx(
    ...
    private giveTheKidsABath(): void {
        ...
        if (this.urtaKids() == 1) {
            if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] == 1) this.outx("your son");
            else this.outx("your daughter");
        } else this.outx("the kids");
        this.outx(
        ...
        if (this.urtaKids() == 1) {
            if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] == 1) this.outx("son");
            else this.outx("daughter");
        } else if (this.urtaKids() < 8) this.outx("kids");
        else this.outx("army of kids");
        this.outx('.  "<i>All right, ');
        if (this.urtaKids() > 1) this.outx("everyone ");
        this.outx('strip up and hop in.</i>"  ');
        if (this.urtaKids() == 1) {
            if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] == 1) this.outx("He");
            else this.outx("She");
        } else this.outx("They");
        this.outx(
        ...
        if (this.flags[kFLAGS.URTA_KIDS_MALES] > 0) {
            ...
            if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] == 1) {
                this.outx("  Your firstborn is ");
                if (this.flags[kFLAGS.URTA_KIDS_MALES] == 1) this.outx("the only one,");
                else this.outx("among them,");
                this.outx(" sporting a");
                if (this.flags[kFLAGS.URTA_FIRSTBORN_COCKTYPE] == 2) this.outx(" vulpine penis");
                else this.outx("n equine phallus, similar to what Urta has");
                this.outx(".");
            }
            if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] == 1 && this.urtaKids() > 1) {
                this.outx("  Your newest is ");
                if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] == 1) this.outx("also ");
                this.outx("a boy, with a");
                if (this.flags[kFLAGS.URTA_LATESTBORN_COCKTYPE] == 2) this.outx(" vulpine penis");
                else this.outx("n equine phallus, just like his mom's");
                this.outx(".");
            }
            this.outx("  You have a feeling ");
            if (this.flags[kFLAGS.URTA_KIDS_MALES] > 1) this.outx("they're");
            else this.outx("he's");
            this.outx(" going to be quite developed when ");
            if (this.flags[kFLAGS.URTA_KIDS_MALES] > 1) this.outx("they hit");
            else this.outx("he hits");
            this.outx(" puberty, if not as big as Urta.  Urta is quite proud of ");
            if (this.flags[kFLAGS.URTA_KIDS_MALES] > 1) this.outx("them");
            else this.outx("him");
            this.outx(", and often boasts that ");
            if (this.flags[kFLAGS.URTA_KIDS_MALES] > 1) this.outx("they");
            else this.outx("he");
            this.outx(" will grow up to be ");
            if (this.flags[kFLAGS.URTA_KIDS_MALES] > 1) this.outx("strong fighters like she is.");
            else this.outx("a strong fighter like she is.");
        }
        ...
        if (this.flags[kFLAGS.URTA_KIDS_HERMS] > 0) {
            ...
            if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] == 3) {
                this.outx("  Your firstborn is a hermaphrodite, sporting a");
                if (this.flags[kFLAGS.URTA_FIRSTBORN_COCKTYPE] == 2) this.outx(" vulpine penis");
                else this.outx("n equine phallus, a peculiarity she inherited from her mother");
                this.outx(".");
            }
            if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] == 3 && this.urtaKids() > 1) {
                this.outx("  Your latest addition is ");
                if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] == 3) this.outx("also ");
                this.outx("a herm, with a");
                if (this.flags[kFLAGS.URTA_LATESTBORN_COCKTYPE] == 2) this.outx(" vulpine penis");
                else
                    this.outx(
            ...
            this.outx("  You have a feeling ");
            if (this.flags[kFLAGS.URTA_KIDS_HERMS] > 1) this.outx("they're");
            else this.outx("she's");
            this.outx(" going to be quite developed when ");
            if (this.flags[kFLAGS.URTA_KIDS_HERMS] > 1) this.outx("they hit");
            else this.outx("she hits");
            this.outx(" puberty, if maybe not quite as big as Urta.  Urta particularly dotes on ");
            if (this.flags[kFLAGS.URTA_KIDS_HERMS] > 1) this.outx("them");
            else this.outx("her");
            this.outx(
        ...
        if (this.flags[kFLAGS.URTA_KIDS_FEMALES] > 0) {
            ...
            if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] == 2) {
                this.outx("  Your firstborn is a girl.");
            }
            if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] == 2 && this.urtaKids() > 1) {
                this.outx("  Your latest addition is ");
                if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] == 2) this.outx("also ");
                this.outx("a girl.");
            }
            this.outx("  Urta loves to play with ");
            if (this.flags[kFLAGS.URTA_KIDS_FEMALES] > 1) this.outx("them");
            else this.outx("her");
            this.outx(", and swears ");
            if (this.flags[kFLAGS.URTA_KIDS_FEMALES] > 1) this.outx("they will");
            else this.outx("she will");
            this.outx(" be quite the heartbreaker");
            if (this.flags[kFLAGS.URTA_KIDS_FEMALES] > 1) this.outx("s");
            this.outx(" when ");
            if (this.flags[kFLAGS.URTA_KIDS_FEMALES] > 1) this.outx("they grow");
            else this.outx("she grows");
            this.outx(" up.");
        }
        ...
        if (this.urtaKids() > 1) this.outx("nearest ");
        this.outx("furry little form of your child and gently tug them over to you.  ");
        if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outx("She");
        else this.outx("He");
        this.outx(" kicks and splashes with ");
        ...
        this.outx(" has no intention of winding up with soap in ");
        if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outx("her");
        else this.outx("his");
        this.outx(" eyes.  Lianna turns the bucket, letting the water cascade over ");
        if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outx("her");
        else this.outx("his");
        this.outx(
        ...
        this.outx(" head, kicking up a cascade of water as ");

        if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outx("she");
        else this.outx("he");
        this.outx(" does so");
        if (this.urtaKids() > 2) {
            this.outx(", to the delight of ");
            if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outx("her");
            else this.outx("his");
            this.outx(" siblings, who are safely watching from the other side of the bath");
        }
        this.outx(".");
        ...
        this.outx(" hair is done, shaking some of the water out of your own face.");
        ...
        if (this.urtaKids() == 1) {
            ...
            this.outx("self up and out so Lianna can start tending to ");
            if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outx("her");
            else this.outx("his");
            this.outx(" tail.  You promptly make yourself useful and start scrubbing as well...");
        } else {
            this.outx('\n\n"<i>Good, now who\'s next?</i>"  "<i>Me!</i>"  ');
            if (this.urtaKids() > 2) this.outx("One of your other children");
            else this.outx("Your other child");
            this.outx(" pipes up.  You let go of the ");
            if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outx("girl");
            else this.outx("boy");
            this.outx(" you're currently holding so ");
            if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outx("she");
            else this.outx("he");
            this.outx(" can swim away, allowing the new volunteer to take ");
            if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outx("her");
            else this.outx("his");
            this.outx(" place.  You promptly make yourself useful and start scrubbing as well...");
        }
        this.outx(
    ...
    private takeTheKidsForWalk(): void {
        ...
        this.outx("  It's hard not to want to live up to that title with such ");
        if (this.urtaKids() == 1) this.outx("a happy face");
        else this.outx("happy faces");
        ...
        if (this.urtaKids() > 10) this.outx("army of ");
        this.outx("child");
        if (this.urtaKids() > 1) this.outx("ren");
        this.outx(".");
    ...
    private talkToLianaAboutHerResearch(): void {
        ...
        if (this.player.cor >= 50) this.outx("however half-heartedly it may be, ");
    ...
    private lubeSpraySideEffects(): void {
        ...
        if (this.player.cor < 33) this.outx("mild");
        else if (this.player.cor < 66) this.outx("some");
        else this.outx("great");
        this.outx(" reluctance.");
    ...
    private sexWithLianna(): void {
        ...
        if (this.player.cockTotal() > 1)
            this.outx("  Your lower garments suddenly feel much tighter.");
    ...
    private acceptARandomGenderFromASkunk(): void {
        ...
        // if PC becomes Herm:
            ...
            if (this.player.biggestTitSize() < 3) {
                ...
                if (this.player.biggestTitSize() < 1) this.outx("s");
                this.outx(" swelling into a soft C-Cup.");
                if (this.player.nippleLength < 0.5) {
                    this.outx(
                        "  Your nipples erect into small, half-inch nubs, complementing the transformation."
                    );
    ...
    private getEggsHarvested(): void {
        ...
        if (this.flags[kFLAGS.LIANNA_HAVESTED_LADIES] == 0) {
            this.outx("confusion, wondering what she's playing at");
            this.flags[kFLAGS.LIANNA_HAVESTED_LADIES]++;
        } else this.outx("remembrance, knowing what's coming next");
        this.outx(
        ...
        if (this.player.looseness() >= 4) this.outx("; your loose pussy doesn't hurt, either");
        this.outx(
        ...
        if (this.player.hasCock()) {
            this.outx(" except for the ");
            if (this.player.cumQ() < 50) this.outx("small");
            else if (this.player.cumQ() < 250) this.outx("normal");
            else if (this.player.cumQ() < 1000) this.outx("sizable");
            else this.outx("huge");
            this.outx(" splatters of cum from your neglected penis");
        }
        this.outx(
    ...
    private liannaHandjobbies(): void {
        ...
        if (this.player.cockTotal() > 1)
            this.outx('  "<i>However I think milking just one is good enough.</i>"');
        this.outx("  She motions to the bed.");
        ...
        if (this.player.balls > 0) this.outx("occasionally stopping to caress your [balls], ");
        this.outx(
        ...
        if (this.player.cumQ() < 1000) {
        } else if (this.player.cumQ() < 2000) this.outx("big");
        else if (this.player.cumQ() < 3000) this.outx("huge");
        else this.outx("giant");
        this.outx(
