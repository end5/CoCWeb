...
export class UrtaPregs extends NPCAwareContent {
    ...
    */
    ...
    private get pregnancy(): PregnancyStore {
        return kGAMECLASS.urta.pregnancy;
    }
    ...
    public urtaPregAppearance(): void {
        switch (this.pregnancy.event) {
            ...
            case 2:
                this.outputText(
                    "Urta is sitting at her usual table, looking more clear-eyed and sober than usual.  She looks extremely happy, tail wagging gently behind her, and she gives you a thrilled look when she sees you, smiling blissfully and patting her belly in a meaningful gesture."
                );
                break;
            case 3:
            case 4:
            ...
            case 7:
                this.outputText(
                    "Urta has moved from her usual table to a more private stall, apparently for the comfort of its padded seats.  Her bulging belly makes it obvious she's pregnant - and the wide grin that seems fixed to her face makes it obvious she's ecstatic about it."
                );
                break;
            case 8:
            case 9:
                this.outputText(
                    "Urta's pregnancy has caused her to outgrow the stall; she's moved herself to an entirely new position in a quiet, out of the way part of the bar.  Looking at the sheer size of her, she's doubtlessly going to pop any day now."
                );
            default:
        }
    }
        ...
        switch (this.pregnancy.event) {
            case 1:
                ...
                if (this.flags[kFLAGS.URTA_TIME_SINCE_LAST_CAME] == 0) {
                    ...
                    this.outputText(
                        "  The lack of cock-on-wood sounds or motion on Urta's part makes it clear she's not feeling amorous right this moment.  Breaking the kiss, she licks her glossy lips clean and looks at you with a good-natured smirk.  \"<i>Feeling up to talking for a little while?</i>\""
                    );
            ...
            case 5:
                ...
                //Else:
                    ...
                    this.outputText(
                        'She places the glass down and licks her lips.  "<i>Mmm... that stuff tastes a lot better than you think, especially when you\'re pregnant.  So, sexy, what brings you here?  Wanted to check up on us?</i>"  She pats her belly with a smile.  "<i>Or did you maybe want to talk?  ...Or perhaps <b>talk</b> a little?</i>"  She grins wickedly.'
                    );
                this.addButton(0, "Sex", this.preggoUrtaSmexOrSomething);
                this.addButton(1, "Talk", this.urta.urtaDialogueMenu);
                this.addButton(9, "Leave", this.telAdre.barTelAdre);
            ...
            case 8:
                this.outputText(
                    "Urta's finally outgrown even her booth, her belly now looking like she swallowed a prize-winning watermelon whole.  She's taken to sitting in a shapeless, very well-stuffed couch in an out-of-the-way nook of the bar.  Her hands stroke her gut and her erect dick at more or less the same time, precum dripping noisily into a bucket positioned under her erection.  She sees you coming and her cock bounces eagerly, belching another spurt of precum into the bucket from a surge in arousal."
                );
                this.outputText(
    ...
    private IAintGotTimeForUrtaBirfs(): void {
        this.clearOutput();
        this.outputText(
            'The centaur looks perplexed at your refusal.  "<i>I - what?  Really?</i>"'
        );
        this.outputText(
        ...
        else if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] == 2)
            this.flags[kFLAGS.URTA_KIDS_FEMALES]++;
        ...
        if (this.urtaKids() == 1) {
            ...
            this.flags[kFLAGS.URTA_FIRSTBORN_COCKTYPE] = this.flags[
                kFLAGS.URTA_LATESTBORN_COCKTYPE
            ];
        }
    ...
    private goVisitUrtaBirfs(withUrta: boolean = false): void {
        ...
        if (!withUrta)
            this.outputText(
                "The trip to the clinic where Urta is giving birth to your child is a blur; all that matters is getting there as fast as possible.  The centaur abandons you at the hospital doors, and you make your own way inside, approaching the counter inside."
            );
        ...
        if (gender == 2) this.outputText("girl!");
            ...
            this.outputText(
                "boy...?  Well... isn't that unusual, looks like you actually gave birth to a healthy herm!"
            );
        this.outputText('</i>"');
        ...
        if (gender == 1 || gender == 3) {
            if (UrtaPregs.rand(2) == 0) {
                ...
                this.outputText(
                    "he's a perfectly normal little fox,</i>\" the doctor notes, and you can catch a quick glimpse of a somewhat bigger than normal vulpine sheathe on your "
                );
            ...
            //[Horse Dick:
                ...
                this.outputText(
                    " mother,</i>\" the doctor comments.  Snatching a quick glance reveals the leathery sheath of an equine phallus swaying between the newborn's legs.  Although infantile, it already promises that "
                );
        ...
        this.outputText(
            ' to the breast, watching with joyous awe as the little fox-morph roots for her black nipple and then latches on.  Tears begin to roll down her cheeks at the sight.  "<i>Our '
        );
        ...
        if (this.urtaKids() == 0)
            ...
            this.outputText(
                "still as delighted as ever to have a new addition to your growing brood"
            );
        this.outputText(".");
        ...
        this.outputText(
            " mother's breast.  \"<i>Looks like my work here is done for now... I'll be back later to give a quick check-up on the baby, but from what I can see you have nothing to worry about.  Excuse me then.</i>\"  The doctor gets up and leaves the room, letting you have some privacy with the fox-herm."
        );
    ...
    private goAfterUrtaBirf(): void {
        this.clearOutput();
        this.outputText(
            "You apologize, but there are pressing matters you need to attend to today... but you'll make it up to her somehow, you promise.  Urta looks disappointed, but sighs sadly and nods her head.  \"<i>Of course.  You're still a busy adventurer and all that.  Well, don't worry; I'll make sure this little one gets home and settled in safely.</i>\""
        );
    ...
    private stayAfterUrtaBirf(): void {
        ...
        this.outputText(
            "Of course, if that's what she wants, you'd be happy to oblige.  The vixen smiles at you thankfully.  \"<i>You won't regret it, [name]; I have an eventful day planned for us,</i>\" she finishes with a mischievous grin and a giggle of delight."
        );
    ...
    private wakeUpWithUrtaAfterStaying(): void {
        ...
        //PC Wakes with Urta
        this.outputText(
            "As the morning sun shines on the blinds, you open your eyes.  Then you remember the events of the last day.  You spent the whole day with Urta, not having sex, just walking together and buying stuff for your newborn "
        );
        if (this.flags[kFLAGS.URTA_KIDS_MALES] == 1) this.outputText("son");
        else this.outputText("daughter");
        this.outputText(
            ", then you went home and spent the better part of the evening making out with Urta which, of course, led to hot vixen sex in her bedroom.  After that... you probably fell asleep on her bed, and considering the current state of affairs, she didn't mind it one bit."
        );
        ...
        this.outputText(
            " from the vixen, then begin stroking her and pushing her to the side.  The fox grumbles and shudders, rolling over to the side.  \"<i>Mmm... [name], while that's nice, I don't really wanna have to do laundry right after getting up,</i>\"  she mumbles in a sleepy voice."
        );
        ...
        //1st time:
        if (this.flags[kFLAGS.URTA_TIMES_BIRTHED] == 1)
            this.outputText(
                "You look at her questioningly; she's breast-feeding, so she shouldn't be drinking alcohol.  \"<i>Oh, don't worry; even I don't drink booze in the morning.  It's a little pick-me-up of my own invention; totally non-alcoholic.  It's mostly fruit juice with a few spices thrown in.</i>\"  Urta laughs.  "
            );
        this.outputText(
            "  Your only reply is to reach behind her balls and gently insert a wandering finger into her pussy."
        );
        ...
        this.outputText(
            ' to look after now; I can\'t be leaving broken glass around, now can I?</i>"  She puts her hands behind her head and stretches, perhaps not so coincidentally thrusting out her naked breasts.  "<i>Mmm... now I feel awake.  Come on, lover; you\'re clearly in the mood, and last night was wonderful... ready for round two, hmm?</i>"  She croons, wriggling herself over to sit right next to you and leaning onto your shoulder.'
        );
        ...
        this.outputText(
            "little monster,</i>\" she notes, already walking off to the nursery, indifferent to any need for clothes.  After all, it's not like the baby will mind that she's not wearing pants while feeding "
        );
        ...
        if (this.urtaKids() == 2)
            this.outputText(
                "  The other kid is staying at Edryn's, so there's no risk of you two needing to answer... complicated questions."
            );
        if (this.urtaKids() > 2)
            this.outputText(
                "  The other kids are staying at Edryn's, so there's no risk of you two needing to answer... complicated questions."
            );
    ...
    private drinkSomeUrtaPostBirthTitMilk(): void {
        this.clearOutput();
        this.outputText(
            "You decide to ask if Urta wouldn't mind you getting breakfast before going.  Your hand wanders to caress her unoccupied breast.  She moans appreciatively and then giggles.  \"<i>Naughty [name]... but, I'm okay with that.  Just let me finish up with this little one first; I can't juggle the two of you at the same time.</i>\""
        );
        this.outputText(
        ...
        this.outputText(
            " together... but that's a poor substitute if you don't ever come back.  Please, be careful with yourself, [name],</i>\" she tells you solemnly.  You kiss her goodbye, giving her shaft a teasing grope then step out of the room."
        );
    ...
    public urtaPregooUpdates(): boolean {
        ...
        //4:
            ...
            this.outputText(
                "  You shake your head, but considering how far you are into the pregnancy, it shouldn't take long... if Urta keeps visiting, you're pretty sure it'll be kicking the next time she comes around."
            );
        ...
        //5
            ...
            this.outputText(
                "</i>\" She babbles happily, tail wagging so enthusiastically you wonder if it's going to fall off."
            );
    ...
    private noHelpForUrtaPreggoPC(): void {
        this.clearOutput();
        this.outputText(
            'You caress her cheek before saying a flat, "<i>No</i>".  Urta actually gives you puppy dogs eyes at that, then lets out a wounded-sounding huff.  "<i>All right, [name]; I guess I better get back to work, then.  Now you take care of yourself; you\'ve got a little one on board, now.</i>"  She chastises you.'
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private getUrtaHelpPreggoPC(): void {
        this.clearOutput();
        this.outputText(
            'Good, you hope this means she\'ll be having plenty of time, because you sure could use a fair share of vixen right now.  "<i>As long as you want me, I\'ll be here.</i>"  Urta laughs already starting to fiddle with the straps of her armor.  "<i>Do you have any preferences for what we do?</i>"'
        );
    ...
    private getUrtaSexWhenPreggoz(): void {
        this.clearOutput();
        this.outputText(
            "Well... you could use a break from minding your passenger, so how does she plan to help you take your mind off your current predicament?  You ask with a knowing smile."
        );
    ...
    private getAnUrtaMassageWhenPreggo(): void {
        this.clearOutput();
        this.outputText(
            'You tell her that a backrub sounds fine, but you\'d rather not lie down.  It could hurt the baby.  "<i>Right, sorry, what was I thinking?  Well, I think I can be flexible...</i>"  Urta grins, cracking her fingers. "<i>Now, let\'s just find somewhere comfortable to put you first...</i>"'
        );
    ...
    private declineUrtaLevelSixPreggoHelps(): void {
        this.clearOutput();
        this.outputText(
            "You thank Urta for the offer, but you'll have to decline.  You still have business to take care of, so you'll just rest for a while longer then be on your way.  Besides, it wouldn't look good for her to be absent for too long, she has a city to take care of."
        );
    ...
    private acceptUrtaLevelSixPreggoHelps(): void {
        this.clearOutput();
        this.outputText(
            "You're feeling really tired right now, and besides, spending a whole day with Urta would be nice, so you gladly accept her offer."
        );
    ...
    public PCGivesBirf(): void {
        ...
        if (gender == 1) {
            ...
            this.outputText(
                " sheath between his legs that looks like it's going to be bigger than normal when he grows up."
            );
            this.flags[kFLAGS.URTA_KIDS_MALES]++;
            this.flags[kFLAGS.URTA_LATESTBORN_GENDER] = 1;
        }
        ...
        //Herm:
            ...
            this.outputText(
                " sheath between her legs that looks like it's going to be bigger than normal when she grows up."
            );
            this.flags[kFLAGS.URTA_KIDS_HERMS]++;
            this.flags[kFLAGS.URTA_LATESTBORN_GENDER] = 3;
        }
        ...
        this.outputText(
            " was brought up in Tel'adre.  Urta smiles thankfully and gives both of you one particularly eager cuddle.  \"<i>Thank you for understanding, [name].  "
        );
        //[She]
        if (gender >= 2) this.outputText("She");
        else this.outputText("He");
        this.outputText(
            ' will be brought up safely, I promise.</i>"  With that, she carefully bundles up the sleeping child and quietly vanishes into the wilderness, leaving you to take yourself off to bed for a proper rest.\n'
        );
    ...
    public urtaSpecialDeliveries(): void {
        ...
        this.outputText(
            "As you enter through the gates, Edryn clops up to you, a small basket swinging from the crook of one arm"
        );
        if (kGAMECLASS.telAdre.edryn.pregnancy.isPregnant)
        ...
        this.outputText(
            "pregnant vixen is snoring softly, laying on her side under the covers, forming a sizable bump in the soft, fluffy quilt that practically envelops her, almost invisible amidst the big plump cushions that serve to keep her comfortable as she sleeps. "
        );
    ...
    public talkToUrtaAboutHerHouse(): void {
        this.clearOutput();
        this.outputText(
            "You've been wondering why Urta keeps her old apartment if she has a nicer and bigger house now.  It would be much better for her to put the lease money towards something more productive than keeping that apartment..."
        );
        if (this.player.cor < 50)
        ...
        this.outputText(
            'pipes up asking what we\'re doing.</i>"  She shakes her head with amused smirk.  "<i>No, I\'d rather keep the old place for our little love nest; we can have our fun there, then come home and be all respectable around the kids.</i>"'
        );
    ...
    private yesUrtaHouseSex(): void {
        ...
        if (this.player.lib > 50)
            this.outputText(
                "  Sometimes you almost give up on waiting to get to her apartment and instead strip and do her right then and there... but it wouldn't bode well for the Watch captain to get a fine for public indecency."
            );
    ...
    private talkAboutLiana(): void {
        ...
        //{Had sex with Lianna:
        if (
            this.flags[kFLAGS.LIANNA_HAVESTED_LADIES] > 0 ||
            this.flags[kFLAGS.LIANNA_HAVESTED_MALES] > 0
        ) {
            this.outputText(
    ...
    private preggoUrtaSmexOrSomething(): void {
        this.clearOutput();
        this.outputText(
            "You let Urta know that you're for helping her vent some steam, if that's what she wants."
        );
    ...
    private massagePregnantUrtasBelly(): void {
        ...
        if (this.flags[kFLAGS.TIMES_MASSAGED_URTA_BELLY] == 0)
            this.outputText(
                '  She looks at you and her newly cream-adorned belly contemplatively.  "<i>I never knew my sweet tooth would bring me to this...</i>"'
            );
        ...
        if (this.player.tongueType > TONUGE_HUMAN)
            this.outputText(
                ", a task that is made far easier due to your tongue's ability to stretch to a surprising length"
            );
    ...
    private rubUrtaPussy(): void {
        this.clearOutput();
        this.outputText(
            'You decide that by "her," she could only mean her pussy.  So you stretch your arm, as if reaching for her shaft, then find your way under her furry balls to her waiting slit, gently touching and massaging her labia, teasing her clit with little pinches, forcing her wetness out of her slavering honeypot.  She lets out a surprised yelp, then laughs, "<i>Not actually what I wanted... ooh!  But I\'m not complaining...</i>"'
        );
    ...
    private urtaMassageClimax(): void {
        ...
        if (this.player.cor < 33)
            this.outputText(
                "  You walk up to her and carefully remove her condom, tying it up with a knot to prevent any of her seed from escaping, then dispose of it."
            );
        //Medium Cor:
        else if (this.player.cor < 66)
            this.outputText(
                "Well, whatever, she's probably too sleepy to do anything about it either way."
            );
        //High Cor:
        else
            this.outputText(
                "You walk up to her with a smirk and remove her condom, then pour down its contents over her belly, chuckling to yourself.  Now that's a great cream topping for your lovely fox-herm."
            );
        this.outputText(
            "  You walk out of her house, taking care to lock the door on your way out."
        );
    ...
    private urtaBoobWorshipScene(): void {
        this.clearOutput();
        this.outputText(
            'You gaze at Urta\'s breasts, heavy with their milky load, a few droplets already escaping her black nipples.  "<i>Oh, you like these, do you?  You like a nice, big pair of foxy-boobs, huh?</i>"  She jokes, jiggling them for your amusement, before wincing at their sensitivity.'
        );
        ...
        this.outputText(
            " and tell her you'll be back to check up on her later.  She gives you a sleepy smile and nods absently, already practically asleep.  You quickly find your [armor] and don them, leaving Urta to rest for a spell in her apartment."
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private nurseFromMommaUrtasBooBees(): void {
        this.clearOutput();
        this.outputText(
            "You look at Urta's breasts, full of milk and dripping, and absentmindedly lick your lips. Urta follows your gaze and gives you a knowing smile.  \"<i>You know, no matter how much I milk myself, I always seem to fill up again right away... I wonder if that's part of Taoth's so-called parting gift,</i>\" she muses to herself."
        );
        ...
        this.outputText(
            "tongue.  Urta lets out a sigh of pleasure, yipping softly as your tongue tantalizes her over-sensitive black nipples.  Noticing that she seemed to enjoy the licking you keep doing so, slathering her soft mounds in a thin layer of saliva, alternating between breasts."
        );
        if (this.player.tongueType > TONUGE_HUMAN)
            this.outputText(
                "  Every few licks you coil your tongue around one of her nipples and gently pull at it, milking a thin strand of white goodness straight on your tongue, much to the fox-herm's delight."
            );
    ...
    private titWorshipAndStroke(): void {
        this.clearOutput();
        this.outputText(
            'You smile mischievously around Urta\'s breast and eagerly grab her shaft with a hand, careful not to hurt her, but roughly enough for her to feel what you just did.  Urta lets out a surprised groan.  "<i>Lover?  What are you...?</i>"  She moans again as your fingers shift on her distended dick.'
        );
    ...
    private ignoreUrtaBonerWhenWorship(): void {
        this.clearOutput();
        this.outputText(
            "You have other things to worry about right now, but you're glad she seems to be enjoying your ministrations."
        );
        this.finishTitWorshipWivUrta();
    }
    ...
    private milkPregnantUrta(): void {
        this.clearOutput();
        this.outputText(
            'You tell her that you feel like playing with her toys.  Urta smiles and nods.  "<i>Sure, though I prefer a more... personal touch... myself.  They\'re in that cupboard over there,</i>" she finishes, pointing it out.'
        );
        ...
        if (this.player.hasCock())
            this.outputText(
                "Urta promptly stops stroking your dick, though whether it's because she wants to be helpful or because she's annoyed you've stopped is anyone's guess.  "
            );
        this.outputText(
        ...
        if (
            this.player.hasCock() &&
            !this.player.isTaur() &&
            this.player.cockThatFits(this.urta.urtaCapacity())
        ) {
            this.outputText(
    ...
    private goHomeHorsecock(): void {
        this.clearOutput();
        this.outputText(
            "You nod at Urta and gather your clothes, redressing in an instant.  Before going you ask if Urta needs anything.  She smiles and shakes her head, a soft smile on her face.  You bid her a good rest and leave her apartment."
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private stayForHorseDickings(): void {
        this.clearOutput();
        this.outputText(
            "You yawn yourself, and suggest that maybe Urta would like some company.  You're kinda sleepy yourself.  She smirks and reclines on the bed, \"<i>Help yourself, lover - there's plenty of me to cuddle,</i>\" she giggles softly as she pats her swollen belly."
        );
    ...
    private urtaPregCravings(): void {
        this.clearOutput();
        this.outputText(
            "You decide to ask Urta if she has any particular cravings right now.  The pregnant fox visibly thinks about, then surreptitiously eyes your crotch."
        );
        //noDick:
        if (!this.player.hasCock()) {
            this.outputText(
        ...
        this.outputText(
            " to the tip.  You can't resist moaning as her vulpine tongue laps at your sensitive [cock biggest]."
        );
        ...
        this.outputText(
            '.  She suddenly pops free, licking her lips.  "<i>Come on, lover.  I thought you offered to help me with my craving?  And yet you won\'t give me any of that salty load of yours?  So hungry... gimme!</i>"  She pleads, looking up at you with hopeful eyes even as she continues to stroke your shaft.'
        );
        this.menu();
    ...
    private getBlownByPregnantUrta(): void {
        this.clearOutput();
        this.outputText(
            "If she wants it so bad, she can have it, you think to yourself, bucking against her hand as you finally feel "
        );
        if (this.player.balls > 0) this.outputText("your balls churn and ");
        this.outputText(
            "cum travelling down your urethra, expanding your shaft with the force of their passage, and finally jetting out of your [cockHead biggest] to arch gracefully through the air and splatter against Urta's face."
        );
        ...
        if (this.player.cockTotal() > 1) {
            this.outputText(
                "  Even if it did, you wouldn't be able to do anything about your other cock"
            );
        ...
        if (this.player.cumQ() < 250) {
            this.outputText(
                "  Soon, all too soon, you're spent.  Urta is left with strands of cum covering her naked body, only a few having made it inside her open maw.  You pant as you slump down, satisfied with the outcome."
            );
            this.outputText(
    ...
    private holdOnYouAintGettingYerCumYetYouNaughtyFox(): void {
        this.clearOutput();
        this.outputText(
            "You're not going to give in so easily.  If she wants it she'd best work hard for it.  You smile at her mischievously, even as you hump against her grip."
        );
        this.outputText(
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() > 2)
                this.outputText(
                    "s bulging ominously as they too prepare to deposit their loads on the willing fox-herm."
                );
            else
                this.outputText(
                    " bulging ominously as it too prepares to deposit its load on the willing fox-herm."
                );
        }
        ...
        if (this.player.cumQ() < 250) {
            ...
            this.outputText(
                "but ultimately you reach your limit and can do nothing but slump as she continues sucking on your [cock biggest] like a straw, hungry for your male milk."
            );
        ...
        //(Medium Cum Amount)
            ...
            this.outputText(
                "  You lay down and relax, letting the cock-hungry fox-herm suck you dry as you continue pumping your male milk.  By the time she's done her belly looks a little larger, and you know that some of that bloating is not entirely due to the baby.  You smile happily at the vixen hungrily slurping on your [cock biggest] despite there being nothing more for her to drink."
            );
        ...
        //(High Cum Amount)
            ...
            if (this.player.cockTotal() > 1) {
                ...
                this.outputText(
                    " erratically, some of it splattering against Urta's face, but most of it winds up making a complete mess of the room."
                );
            }
            ...
            this.outputText(
                " with both hands, trying to pinch it shut long enough to inhale a couple of deep breaths, then goes back to trying to drink every last drop; she must really have a hankering for what you're packing."
            );
        ...
        this.outputText(
            " belly, clearly feeling tired even though she wasn't the one being pleasured this time."
        );
    ...
    private weirdUrtaCravingsConclusion(): void {
        ...
        this.outputText(
            '  You gaze at her questioningly.  "<i>I woke up before you and went and... shall we say cleaned myself up a little,</i>" she replies, flicking her ears in the direction of the shower.'
        );
    ...
    private urtaRaepsJoo(): void {
        ...
        if (this.player.hasCock())
            this.outputText(
                "Every time her swollen tip rubs against your prostate you feel droplets of pre escape your dilating cum-hole.  "
            );
        if (this.player.hasVagina())
            this.outputText(
                "Each slap of her balls against your [vagina] sends electric waves of pleasure that expand throughout your body.  "
            );
        this.outputText(
            "You moan audibly, making it pretty clear you're getting off from this kind of treatment.  \"<i>See?  I knew you'd enjoy this too, now that I'm not so tense...</i>\"  She draws out the last word as she makes a particularly deep thrust inside of you.  \"<i>Mmm...  I can feel your sexy ass squeezing my dick; you're enjoying this, really, aren't you?</i>\""
        );
        ...
        if (this.player.cockTotal() > 0) {
            ...
            if (this.player.cumQ() < 250)
                this.outputText(
                    " and you unload on the floor, spilling rope after rope of cum, forming a small puddle where you stand.  An undeniable testament to your enjoyment of the kinkiness of the act, however small."
                );
            //(Medium Cum Amount)
            else if (this.player.cumQ() < 1000)
                this.outputText(
        ...
        if (this.player.hasVagina()) {
            ...
            this.outputText(
                " juices that paint Urta's balls, which are resting flush against your [vagina].  The spilled juice slides down Urta's balls"
            );
        ...
        if (this.player.gender == 0) {
            ...
            if (this.player.ass.analWetness > 0)
                this.outputText(
                    " It even secretes its own wetness to slide lovingly down the fox-herm's balls and drip on the floor, an undeniable proof of your enjoyment."
                );
        }
        this.outputText(
        ...
        this.outputText(
            " and close your eyes, letting sleep take you over even as the fox behind you drools on your back and continues to pound your ass raw."
        );
    ...
    private partTwoOfUrtaBoning(): void {
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (!this.player.isTaur())
                this.outputText(
                    "  So close that you can almost feel its heat against your [cockHead]."
                );
            this.outputText(
                "  \"<i>Oh, don't feel embarrassed; I know what it's like to wake up with morning wood,</i>\" she jests, clearly unphased by your erect state."
            );
        }
        if (this.player.hasVagina()) {
            this.outputText(
    ...
    private declineARimJob(): void {
        this.clearOutput();
        this.outputText(
            "You tell her that you appreciate the offer, but you're going to sit this one out.  Though she tries to hide it, she looks relieved at your refusal; she probably isn't really comfortable with that level of kinkiness.  Instead, she eagerly captures your lips with hers, murmuring into your mouth as she devours your kiss, tongue sliding between your lips to caress your own tongue."
        );
        //Both choices converge here.
        this.outputText(
    ...
    private acceptUrtaRimJobbies(): void {
        this.clearOutput();
        this.outputText(
            'Well... she is responsible for your state, and her broad vulpine tongue must feel amazing on your sensitive ass... so you nod in acceptance of her offer.  "<i>All right then... you do know you\'re the only person I\'d ever do this for, right?</i>" Urta comments.  "<i>Now, roll around and present yourself to me; you can\'t expect a pregnant lady to do a lot of bending, now can you?</i>"  She smirks.'
        );
        ...
        if (this.player.cockTotal() > 1)
            ...
            this.outputText(
                "  Especially not if your [cock] has anything to say about it, throbbing at the mere feeling of Urta's wet tongue."
            );
    ...
    public visitKidsFirstTime(): void {
        ...
        if (this.flags[kFLAGS.URTA_TIME_SINCE_LAST_CAME] == 0)
            this.outputText(
                ", erection already diminishing as she forgets about her horniness in her parental pride"
            );
        this.outputText(
            ".  You waste no time in following her; indeed, she seems liable to leave you behind in her excitement to go and see her offspring."
        );
    ...
    private pickKidSceneHere(): void {
        ...
        if (
            (this.pregnancy.type == PregnancyStore.PREGNANCY_PLAYER ||
                (this.player.pregnancyIncubation < 300 &&
    ...
    private newBabyComing(): void {
        ...
        if (this.urtaKids() < 8) {
            ...
            this.outputText(
                " clearly delighted at the prospect.  You and Urta smile at each other over "
            );
    ...
    private hugAttackScene(): void {
        this.clearOutput();
        this.outputText(
            "Before you can exchange any further pleasantries the sound of running padded feet fills the house.  Lianna simply looks at the approaching foxling"
        );
        if (this.urtaKids() > 1) this.outputText("s");
        this.outputText(
        ...
        if (this.urtaKids() == 1) this.outputText("s");
        this.outputText(
            " you towards the backyard, while your lover chuckles at your predicament."
        );
    ...
    private noPlayTimeForKids(): void {
        this.clearOutput();
        this.outputText(
            'You shake your head, telling your family that you\'re sorry but you have to go.  "<i>Really?  All right... but, you should at least hang around long enough to take some on the go.</i>"  Urta insists.  You tell her you\'ll be fine, but you\'ll definitely stop by to eat with them sometime.  Urta gives a melodramatic sigh and rolls her eyes, then nods and smiles.  "<i>All right... just make sure you do.</i>"  She tells you, then gives you a quick hug and a kiss.  "<i>We worry about you out there; come home safe to us.</i>"  She says, then lets you go.'
        );
    ...
    private stayToPlay(): void {
        this.clearOutput();
        this.outputText(
            'You nod your head in acceptance.  Urta smiles in delight.  "<i>Take a seat, please, make yourself comfortable - I\'ll go and get it,</i>" she says happily, tail wagging as she saunters off to the kitchen.'
        );
    ...
    private bathtime(): void {
        ...
        this.outputText(
            '.  "<i>Sure, but they need a bath, maybe you\'d like to help me bathe them?</i>"'
        );
        //[Yes] [No]
        this.menu();
    ...
    private noBathTiemPlease(): void {
        this.clearOutput();
        this.outputText(
            '"<i>I see, in that case excuse me,</i>"  She says with a blank expression.  Looks like you don\'t have any business here for now, so you decide to leave.'
        );
        //(Back to TA/Camp)
        this.menu();
        this.addButton(0, "Next", this.telAdre.telAdreMenu);
    ...
    private giveTheKidsABath(): void {
        ...
        this.outputText(
            '.</i>"  You contemplate what to do, then remove your outer layer of clothes, carefully placing them on a shelf in case they get splashed.  Now you just need to wait for Lianna to return.'
        );
        ...
        if (this.flags[kFLAGS.URTA_KIDS_MALES] > 0) {
            ...
            if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] == 1) {
                ...
                if (this.flags[kFLAGS.URTA_FIRSTBORN_COCKTYPE] == 2)
            ...
            if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] == 1 && this.urtaKids() > 1) {
                ...
                if (this.flags[kFLAGS.URTA_LATESTBORN_COCKTYPE] == 2)
                    this.outputText(" vulpine penis");
            ...
            if (this.flags[kFLAGS.URTA_KIDS_MALES] > 1)
        ...
        if (this.flags[kFLAGS.URTA_KIDS_HERMS] > 0) {
            ...
            if (this.flags[kFLAGS.URTA_FIRSTBORN_GENDER] == 3) {
                ...
                if (this.flags[kFLAGS.URTA_FIRSTBORN_COCKTYPE] == 2)
                    ...
                    this.outputText(
                        "n equine phallus, a peculiarity she inherited from her mother"
                    );
                this.outputText(".");
            }
            if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] == 3 && this.urtaKids() > 1) {
                ...
                if (this.flags[kFLAGS.URTA_LATESTBORN_COCKTYPE] == 2)
                    ...
                    this.outputText(
                        "n equine phallus.  No doubt such a characteristic was passed from her mother"
                    );
                this.outputText(".");
            }
            this.outputText("  You have a feeling ");
            ...
            this.outputText(
                " puberty, if maybe not quite as big as Urta.  Urta particularly dotes on "
            );
            if (this.flags[kFLAGS.URTA_KIDS_HERMS] > 1) this.outputText("them");
            else this.outputText("her");
            this.outputText(
                ", maybe because she remembers how much her parents hated her for being a herm."
            );
        }
        ...
        this.outputText(
            " little legs, but smiles up at you, clearly willing to cooperate, giving you no problem as you spurt a generous dollop of the soapy goo into "
        );
        if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outputText("her");
        else this.outputText("his");
        this.outputText(
            " hair and start to massage it... now, just how do you shampoo somebody covered from head to toe in fur...?"
        );
        ...
        this.outputText(
            " tail, splashing Lianna with water.  The skunkette, however, fails to display any reaction at this."
        );
        ...
        this.outputText(
            " sides as she does so.  The little fox giggles and squirms, clearly finding the actions quite ticklish, and you have to hold on a little harder to keep "
        );
        if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outputText("her");
        else this.outputText("him");
        this.outputText(
            ' from escaping.  "<i>Now all you have to do is rinse off.</i>"  She grabs a small bucket nearby, scooping up some water.  "<i>Close your eyes, dear.</i>"  Your child does as Lianna instructs; this is evidently a familiar enough routine that '
        );
        if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outputText("she");
        else this.outputText("he");
        ...
        this.outputText(
            " head.  Your little fox squeals and then shakes wildly to fling the water off of "
        );
        if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outputText("her");
        else this.outputText("his");
        ...
        if (this.urtaKids() == 1) {
            ...
            this.outputText(
                ' tail.  Get out of the tub.</i>"  The skunkette instructs.  The young fox nods and scrabbles at the side of the bath, hauling '
            );
            if (this.flags[kFLAGS.URTA_LATESTBORN_GENDER] >= 2) this.outputText("her");
            else this.outputText("him");
            ...
            this.outputText(
                " tail.  You promptly make yourself useful and start scrubbing as well..."
            );
        } else {
            ...
            this.outputText(
                " place.  You promptly make yourself useful and start scrubbing as well..."
            );
        }
        this.outputText(
    ...
    private noBathPleaseUrtaLian(): void {
        this.clearOutput();
        this.outputText(
            'You politely refuse her invitation.  "<i>Okay, but can you wash mine then?</i>" she asks.  You give the idea a moment\'s thought and then agree; it\'s a harmless offer, right?  "<i>Thanks,</i>" she replies, getting out of the tub and sitting on a small wooden bench nearby.  "<i>Use the flower extract shampoo, please.</i>"  You nod your head in understanding as you climb out after her, taking up the indicated shampoo and approaching her before asking how much you should use.  "<i>Plenty,</i>" is her reply.'
        );
    ...
    private getABackWashFromLianna(): void {
        this.clearOutput();
        this.outputText(
            "You tell Lianna that if she is willing, you wouldn't object to her washing your back."
        );
        this.outputText(
    ...
    private takeTheKidsForWalk(): void {
        ...
        if (this.urtaKids() > 1) this.outputText("ren");
        this.outputText(
            " are suitably dressed for a traipse around a desert city, you usher your kit"
        );
        if (this.urtaKids() > 1) this.outputText("s");
        this.outputText(
        ...
        if (this.urtaKids() > 1) this.outputText("ren");
        this.outputText(
            " pick out flavours while the shopkeeper scoops them up onto wafer cones.  Once he's done, you thank the wolf and leave the shop followed by your "
        );
        ...
        this.outputText(
            " along with your own, greedily licking up melting droplets.  There's just a bit of cone left as you return to Urta's house, and you quickly polish that off, upon entering.  \"<i>Oh, hey.  You're back.</i>\"  Lianna greets you in her usual inexpressive fashion."
        );
        ...
        if (this.urtaKids() == 1) this.outputText("s");
        this.outputText(
            " off to the bathroom.  You can't help but note how good Lianna is at making kids do what she says."
        );
    ...
    private liannasAppearance(): void {
        this.clearOutput();
        this.outputText(
            "Lianna is a healthy looking young anthro, a skunk-morph covered in sleek, shiny black fur, with white adorning her swishing, fluffy-looking tail.  Her hair is pure black with streaks of white, tied out of the way into a short ponytail, and her green eyes glitter behind round, silver-rimmed glasses that perch atop her nose.  She wears a conservative short-sleeved blouse, and pants that, while slightly baggy, still manage to show off her nice legs.  They're certainly tight enough that you can tell she's all girl; no hidden surprises here.  She goes without shoes, exposing her paw-like feet.  She has a very nicely rounded, generous handful of an ass, and womanly hips; up top, she is no less stacked, with what are easily E-cup breasts making her even bustier than her employer is; despite all that, she tries to tone them down with her style of dress."
        );
        //(Display Options)
        this.menu();
    ...
    private talkToLiana(output: boolean = true): void {
        if (output) {
            this.clearOutput();
            this.outputText(
                'You tell her you\'d like to talk her.  She adjusts her glasses.  "<i>Oh?  What about?</i>"'
            );
        }
        this.menu();
        ...
        if (
            this.flags[kFLAGS.LIANNA_HAVESTED_MALES] + this.flags[kFLAGS.LIANNA_HAVESTED_LADIES] >
            0
        )
            this.addButton(2, "Her Spray", this.talkAboutLiannasLubeSpray);
        if (this.flags[kFLAGS.DISCUSSED_LUBE_SPRAY] > 0)
    ...
    private talkToLianaAboutHerJob(): void {
        this.clearOutput();
        this.outputText(
            "You ask her about her jobs, both for Urta and what she intends to do afterwards."
        );
        this.outputText(
    ...
    private talkToLianaAboutHerResearch(): void {
        this.clearOutput();
        this.outputText(
            "You ask her why she's so eager to get samples from you, a human.  What sort of research is she doing that she needs human samples?"
        );
        this.outputText(
    ...
    private talkAboutLiannasLubeSpray(): void {
        ...
        this.outputText(
            "You ask why it is that she produces a lubricating liquid rather than a noxious one, like you would expect of a skunk."
        );
    ...
    private lubeSpraySideEffects(): void {
        this.clearOutput();
        this.outputText(
            "So, if she's experimented on herself in the past, that must have gone wrong for her at least once or twice in the past, you comment."
        );
    ...
    private sexWithLianna(): void {
        this.clearOutput();
        this.outputText(
            '"<i>So you want to help me with my experiments?  Great!</i>"  She takes your hand and basically drags you into her room.  You allow her to lead you, wondering what she has in mind.'
        );
    ...
    private refuseGenderlessInjection(): void {
        this.clearOutput();
        this.outputText(
            "Lianna's face falls at your refusal, but she sighs.  \"<i>All right, I can understand; I mean, you must have your reasons.  Still, if ever you get a gender, remember that I'd be happy to use some of your seed, please.</i>\""
        );
        this.outputText(
    ...
    private acceptARandomGenderFromASkunk(): void {
        this.clearOutput();
        this.outputText(
            "You decide that it's worthwhile to go along and indicate that you'll let Lianna experiment on you with her \"genderiser\"."
        );
        this.outputText(
        ...
        if (this.player.isTaur())
            this.outputText(
                "  Or at least hold on to something, this might sting a little and I don't need you kicking down anything in here."
            );
        this.outputText('</i>"');
        ...
        this.outputText(
            "  You really should be more surprised, but, sadly, this is kind of predictable; you were more hoping than anything that this would be an oral delivery, or at least an injection."
        );
        ...
        //if PC becomes Female:
            ...
            if (this.player.biggestTitSize() < 1) {
                ...
                if (this.player.nippleLength < 0.5) {
                    this.outputText(
                        "  Your nipples erect into small half-inch nubs, complementing the transformation."
                    );
        ...
        //if PC becomes Herm:
            ...
            if (this.player.biggestTitSize() < 3) {
                ...
                this.outputText(
                    "  You watch the soft mounds in your chest, unable to do anything but pant."
                );
    ...
    private getEggsHarvested(): void {
        this.clearOutput();
        this.outputText(
            '"<i>All right, let\'s get this show on the road.</i>"  She ducks out into her closet once more, and comes out carrying what looks like a dildo and a lollipop.  "<i>So, let me explain.  It\'s pretty simple really.</i>"  She takes the dildo in her hand.  "<i>This is a special dildo I had custom-made for this experiment, It will pleasure you at the same time it lets me harvest your pussy juice and hopefully one of your ovum.  All you have to do is sit back and relax.  Any questions?</i>"'
        );
        this.outputText(
        ...
        this.outputText(
            ".  She unceremoniously begins shoving it inside without even a hint of pleasure or discomfort; the dildo slides in without resistance, spreading her buttcheeks apart and penetrating her with a wet squelch.  You watch the display, not sure whether or not you should find this kinky."
        );
        ...
        if (this.player.vaginalCapacity() >= 50)
            this.outputText(
                '  "<i>Hmm, I might not have had to lube it up after all...</i>"  The skunkette remarks.'
            );
        this.outputText(
            "  She aligns the tip of the dildo with you and without saying a word she begins pushing in.  Instinctively you moan and try to spread yourself as wide as possible."
        );
        ...
        this.outputText(
            ".  Finally, you can feel it stop inside of you, the tip pushing against your cervix, which is what has brought it to a halt."
        );
        ...
        this.outputText(
            "; the dildo has absorbed it all.  You can feel it clenching tighter, shrinking down so that it no longer fills you up so perfectly, leaving you panting in release as Lianna gently frees it from inside you."
        );
    ...
    private liannaHandjobbies(): void {
        ...
        this.outputText(
            '"<i>All right, let\'s get this show on the road.</i>"  She ducks out into her closet once more, and comes out carrying what looks like a condom and a lollipop.  "<i>Here\'s how this works.  You put on this condom and I milk your seed out of you.  Simple, yes?</i>"'
        );
        ...
        this.outputText(
            "while the other massages your [cockHead biggest], rolling the steadily growing bubble of pre around as she kneads it."
        );
