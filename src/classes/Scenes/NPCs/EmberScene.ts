...
export class EmberScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    public emberCampMenu(): void {
        this.clearOutput();
        this.outx(this.images.showImage("ember-visit-at-camp"));
        // Low Affection:
    ...
    public emberEggInteraction(): void {
        ...
        // (If the egg Corruption level is 75-100, aka \"<i>Corrupt</i>\")
            ...
            if (this.player.gender == 0) this.outx("cum, if you had any... ");
            else {
                if (this.player.hasCock()) this.outx("white ");
                else this.outx("glistening girl-");
                this.outx("cum... ");
            }
            this.outx(" You stop yourself and shake your head.  Where did that thought come from?");
    ...
    private useIncubusDraftOnEmber(purified = false): void {
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] == 3 || this.flags[kFLAGS.EMBER_GENDER] == 0) {
            this.outx("  The egg's shell slowly changes to a soft, pastel blue.");
            this.flags[kFLAGS.EMBER_GENDER] = 1;
        } else if (this.flags[kFLAGS.EMBER_GENDER] == 2) {
            this.outx("   The egg's shell slowly changes to a lavender hue.");
    ...
    private useSuccubiMilkOnEmber(purified = false): void {
        ...
        // (If Unsexed or Herm:
        if (this.flags[kFLAGS.EMBER_GENDER] == 3 || this.flags[kFLAGS.EMBER_GENDER] == 0) {
            this.outx("  The egg's shell slowly changes to a muted pink color.");
            this.flags[kFLAGS.EMBER_GENDER] = 2;
        }
        // If Male:
    ...
    private hairExtensionSerum(): void {
        ...
        if (this.flags[kFLAGS.EMBER_HAIR] == 0) {
            this.outx("a narrow tiger-stripe pattern suddenly develop");
            this.flags[kFLAGS.EMBER_HAIR] = 1;
        } else {
            this.outx("the tiger-stripes multiply");
            this.flags[kFLAGS.EMBER_HAIR] = 2;
        }
        this.outx(" on the egg.");
        this.flags[kFLAGS.EMBER_EGG_FLUID_COUNT]++;
        this.doNext(this.playerMenu);
    }
    ...
    private giveEmberBludSausages(): void {
        ...
        if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 0) {
            this.outx(" but the egg just glows its excitement, as if it wanted still more.");
            this.flags[kFLAGS.EMBER_INTERNAL_DICK] = 1;
        } else {
            this.outx(", but nothing does.  How disappointing.");
    ...
    private masturbateOntoAnEgg(): void {
        ...
        if (this.player.gender == 1) {
            ...
            if (this.player.cockTotal() <= 2) this.outx("pumping vigorously.");
            else
                this.outx(
            ...
            else if (this.player.cumQ() <= 1000) this.outx("gout");
            else this.outx("wave");
            this.outx(" of cum onto the egg.");
            this.outx(
        ...
        // Female Version (Z)
            ...
            if (this.player.wetness() <= 3) this.outx("few drops");
            else if (this.player.wetness() < 5) this.outx("squirt");
            else this.outx("torrent");
            this.outx(" of girlcum jumps from your pussy onto the egg.");
            this.outx(
    ...
    private hatchZeMuzzles(): void {
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] == 0) this.outx("white ");
        else if (this.flags[kFLAGS.EMBER_GENDER] == 1) this.outx("blue ");
        else if (this.flags[kFLAGS.EMBER_GENDER] == 2) this.outx("pink ");
        else this.outx("purple ");
        this.outx("dust.");
        // FURRAH
        if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 0) {
            // Male Anthro (Z)
            if (this.flags[kFLAGS.EMBER_GENDER] == 1) {
                ...
                if (this.flags[kFLAGS.EMBER_MILK] > 0)
                    this.outx(", drooling nipples notwithstanding");
                this.outx(".");
            }
            // Female Anthro (Z)
            else if (this.flags[kFLAGS.EMBER_GENDER] == 2) {
        ...
        // Boring version
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] == 1) {
                ...
                if (this.flags[kFLAGS.EMBER_MILK] > 0 || this.flags[kFLAGS.EMBER_HAIR] > 0)
                    this.outx(", complete with ");
                if (this.flags[kFLAGS.EMBER_MILK] > 0) {
                    this.outx("huge breasts, easily F-cups");
                    if (this.flags[kFLAGS.EMBER_HAIR] > 0) this.outx(" and ");
                }
                if (this.flags[kFLAGS.EMBER_HAIR] > 0) this.outx("long, feminine locks of hair");
                this.outx(", but his maleness is undeniable.  Especially when you spot ");
                if (this.flags[kFLAGS.EMBER_INTERNAL_DICK] > 0)
                    this.outx(
                        "the slit in his pelvis that disgorges a foot and a half-long inhuman penis"
                    );
                else this.outx("a foot and a half long human penis that sways between his legs");
                this.outx(", completed by apple-size nuts held inside a fleshy sack.");
            }
            ...
            // Herm Monstergirl (Z)
                ...
                if (this.flags[kFLAGS.EMBER_INTERNAL_DICK] == 0) this.outx("huge, human prick");
                else this.outx("huge inhuman cock hanging from some kind of internal sheath");
                this.outx(
    ...
    private embersAppearance(): void {
        this.clearOutput();
        this.outx(this.images.showImage("ember-examine-appearance"));
        ...
        if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 0) {
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] == 1) {
                ...
                if (this.flags[kFLAGS.EMBER_MILK] > 0) this.outx(" dribbling breasts,");
                this.outx(
            ...
            switch (this.pregnancy.event) {
                case 2:
                    this.outx("  At the moment there's a slight pudgyness to her golden belly.");
                    break;
                case 3:
                    this.outx("  Her golden belly is a little larger and firmer than usual.");
                    break;
                case 4:
                case 5:
                    this.outx(
            ...
            else this.outx("masculine pectorals");
            this.outx(".");
        ...
        // Dragon-girl Appearance (By Radar) (Z)
            ...
            this.outx("Ember is a 7' 3</i>\" tall ");
            if (this.flags[kFLAGS.EMBER_GENDER] == 1) this.outx("male");
    ...
    private talkToEmber(): void {
        ...
        this.clearOutput();
        this.outx("What will you talk about?");
    ...
    private discussExplorationWithEmber(): void {
        ...
        if (choice == 0) {
            ...
            if (subChoice == 0) {
                ...
                if (this.flags[kFLAGS.EMBER_GENDER] == 3) this.outx(" like me");
                this.outx(". They were on the beach, fucking each other's brains out.");
            } else {
            ...
            // (if player hasn't solved Marcus & Lucia's argument)
                ...
                if (this.player.isNaga()) this.outx("She looked a lot like you.");
                else this.outx("I've never seen anything like her before.");
            }
        }
        this.outx('</i>"');
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private talkToEmberAboutYourself(): void {
        ...
        // (If PC Int < 90)
            ...
            this.outx('"<i>I see wisdom in your eyes, but you could always use more lessons.</i>"');
            // (+1 point)
            points++;
        }
        // (If PC Int >= 90)
    ...
    private emberIsPregnantFirstTimeTalkScene(): void {
        ...
        if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 1) this.outx(" and blushes");
        this.outx(
    ...
    private emberTFs(): void {
        ...
        if (
            ...
            this.outx("  <b>You now have a dragon penis.</b>");
    ...
    private emberIsAnEggFactory(): void {
        this.clearOutput();
        this.outx("You ask Ember if she would be willing to lay an egg for you.");
        // (Low Affection)
        if (this.emberAffection() <= 25) {
            this.outx(
            ...
            if (this.player.cor >= 40) this.outx("or sell it for quick cash ");
            this.outx("anyway, but you don't tell her that.");
            this.outx(
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS.EMBER_GENDER] == 3) {
                ...
                if (
                    ...
                    this.outx("dragon-dick jutting from its slit,");
                else this.outx("veiny, bulbous penis fully");
                this.outx(" erect");
            }
            this.outx(
            ...
            // [(if Ember has a dick)
            if (this.flags[kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS.EMBER_GENDER] == 3)
                this.outx(" and her throbbing cock is soft enough to hide");
            this.outx(" before she presents the egg to you.");
            this.outx(
        ...
        // (Medium Affection)
            ...
            this.outx("\n\nEmber gasps");
            if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 1)
                this.outx(" and her cheeks grow red with embarrassment");
            this.outx(
        ...
        // (High Affection)
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS.EMBER_GENDER] == 3)
                this.outx(", and her cock points you accusingly");
            this.outx(".");
            this.outx(
            ...
            if (this.player.tongueType > TONUGE_HUMAN) this.outx(" and out... and out...");
            this.outx(
            ...
            this.outx(", savoring the unmistakable taste of her intimate juices.");
            this.outx(
            ...
            if (this.player.tongueType > TONUGE_HUMAN) this.outx("which is quite far indeed, ");
            this.outx(
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] == 3)
                this.outx(" and dribbling down her painfully stiff dick");
            this.outx(", you think you're doing rather well.");
            this.outx(
    ...
    private dontWatchEmberLayEgg(): void {
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] == 3)
            this.outx(".. it even drips with some kind of off-white fluid.");
        this.outx(
    ...
    private watchMediumAffectionEmberEggLay(): void {
        ...
        // (if Ember has a cock:
        if (this.flags[kFLAGS.EMBER_GENDER] == 3) this.outx(", cock poking straight out");
        ...
        if (this.player.lib >= 50) this.outx(" she doesn't ask you to, beaming a salacious grin");
        this.outx(".");
        this.outx(
        ...
        if (this.player.gender > 0) {
            this.outx("; ");
            if (this.player.hasCock()) {
                this.outx("the bulge inside your [armor]");
                if (this.player.hasVagina()) this.outx(" and ");
            }
            if (this.player.hasVagina()) this.outx("wetness gathering in your own pussy");
            this.outx(" more than indicate");
            if (!this.player.hasCock() || !this.player.hasVagina()) this.outx("s");
            this.outx(" your desire to break your promise.");
        }
        this.outx(
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] == 3) this.outx(" and caressing her throbbing cock");
        this.outx(".");
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] == 3) this.outx(" and her cock hanging out");
        this.outx(", it's hard to see her as the same angrily defensive ice queen from before.");
        this.outx(
    ...
    private getMilkFromEmber(): void {
        this.clearOutput();
        this.outx(this.images.showImage("ember-drink-her-milk"));
        ...
        if (this.emberAffection() <= 25) {
            ...
            if (
                ...
                this.outx("  Though, a sudden swell of lust races through your ");
                if (this.player.hasCock()) {
                    this.outx(this.cockDescript(0));
                    if (this.player.hasVagina()) this.outx(" and ");
                }
        ...
        // (Medium Affection)
            ...
            if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 1) this.outx("flesh");
            else this.outx("scales");
            this.outx(
        ...
        // (High Affection)
            ...
            } else this.outx("small beads of moisture gathering on her honeypot");
            this.outx(
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS.EMBER_GENDER] == 3) {
                ...
                if (
                    ...
                    this.outx(" strangely ridged, almost scaly");
                this.outx(" surface");
            } else
                this.outx(
    ...
    private catchAnal(): void {
        ...
        if (this.player.hasVagina()) {
            ...
            this.outx(" to puddle underneath you");
            if (this.player.hasCock())
                this.outx(
        ...
        if (this.player.hasVagina())
            this.outx("your cunt gushing feminine lubricant to glaze Ember's belly");
        if (this.player.hasVagina() && this.player.hasCock()) this.outx(" and ");
        if (this.player.hasCock()) {
            this.outx("your cock ");
            if (this.player.cumQ() < 250)
                this.outx("spurting gouts of cum onto Ember's upper torso");
    ...
    private suckEmberCock(): void {
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] == 1) {
            if (
                ...
                this.outx("his single genital slit");
            else this.outx("his genitals");
        } else {
            if (
                this.flags[kFLAGS.EMBER_ROUNDFACE] == 0 ||
                this.flags[kFLAGS.EMBER_INTERNAL_DICK] == 1
        ...
        this.outx(".  Up and up it rises, until all 16 inches of ");
        if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS.EMBER_INTERNAL_DICK] == 1)
            this.outx("dragon ");
        this.outx(
        ...
        this.outx(" lower belly");
        if (this.pregnancy.event > 3) this.outx(", though the gravid orb resists you");
        this.outx(
    ...
    private stickItInEmbersButt(): void {
        ...
        // (High Affection)
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] >= 2) this.outx("dripping pussy");
            this.outx(" make it obvious that the idea is at least partially arousing.");
        }
        ...
        this.outx(", and you groan to Ember that you're going to cum, soon.");
    ...
    private slurpDraggieCunnies(): void {
        this.clearOutput();
        this.outx(this.images.showImage("ember-eat-out-her-vagoo"));
        this.outx(
        ...
        if (this.emberAffection() <= 25) {
            ...
            if (!this.silly()) this.outx("with me");
            else this.outx("on my affection meter");
            this.outx(" just because you're offering to do this,</i>\" the dragon hastily adds.");
        }
        // (Medium Affection)
        else if (this.emberAffection() < 75) {
            this.outx(
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS.EMBER_GENDER] == 3)
                this.outx(" and slowly hardening shaft");
            this.outx(".");
        }
        // (High Affection)
        else {
        ...
        if (this.flags[kFLAGS.EMBER_ROUNDFACE] > 0) this.outx("blushing all the while and ");
        this.outx("panting from the stimulation.");
        ...
        if (this.player.tongueType > TONUGE_HUMAN) this.outx("inhuman ");
        this.outx(
        ...
        if (this.silly()) this.outx("  My meter's not that full!");
        this.outx('</i>"');
        ...
        if (this.player.hasCock()) this.outx("stiffened shaft");
        if (this.player.gender == 3) this.outx(" and ");
        if (this.player.hasVagina()) this.outx("moist cunt");
        if (this.player.gender == 0) this.outx("empty crotch");
        this.outx(" in sympathy, you head back to camp.");
    ...
    private getEatenOutByEmbra(): void {
        ...
        if (this.player.wetness() >= 4) this.outx("spattering");
    ...
    private penetrateEmbrah(): void {
        this.clearOutput();
        this.outx(this.images.showImage("ember-fuck-her-in-the-vagoo-with-your-penor"));
        ...
        // (High Affection)
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] == 3) {
                if (
                    ...
                    this.outx(" and her cock peek out of its protective slit");
                else this.outx(" and her cock begin hardening");
            }
            this.outx(' in anticipation.  "<i>Yeah... maybe... why do you ask?</i>"');
        }
        // (First Time)
        if (this.flags[kFLAGS.EMBER_PUSSY_FUCK_COUNT] == 0) {
            ...
            if (this.player.cor <= 75) this.outx("cute... but very troublesome");
            else this.outx("irritating as hell");
            this.outx(
        ...
        this.outx("\n\nYou ");
        if (this.player.cor < 50)
            this.outx("hasten to undress yourself for the impatient dragoness, quickly pulling");
        else
            this.outx(
        ...
        if (this.player.cockThatFits(this.emberVaginalCapacity()) == -1) {
            ...
            if (this.player.cockTotal() == 1) this.outx("that... that... monster inside me,");
            else this.outx("any of those... those... monsters inside me,");
            this.outx(
                " you'll tear me apart!</i>\"  Ember finishes by exhaling a puff of smoke in frustration... clearly she wants this as much as you."
            );

            this.outx('"<i>Find some way to shrink ');
            if (this.player.cockTotal() == 1) this.outx("that");
        ...
        this.outx("smile and, with a flamboyant grace, ");
        this.outx(
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS.EMBER_GENDER] == 3)
            this.outx("; her own erect cock spurts a small jet of pre");
        this.outx(".");
        ...
        if (this.player.cumQ() < 250) this.outx("dribble");
        else if (this.player.cumQ() < 1000) this.outx("flow");
        else this.outx("gush");
        this.outx(
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS.EMBER_GENDER] == 3)
            this.outx(", and her cock, while engorged and swollen, hasn't poured forth yet");
        this.outx(".");
        ...
        // (High Cum Amount)
            ...
            if (this.player.balls == 0) this.outx("prick is ");
            else this.outx("[balls] are ");
            this.outx(
    ...
    private getPenetratedByEmberLastSexSceneWoooo(): void {
        this.clearOutput();
        this.outx(this.images.showImage("ember-sticks-her-penor-in-your-vagoo"));
        this.outx("Your eyes are drawn to the 16 inches of cool, throbbing ");
        if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS.EMBER_INTERNAL_DICK] > 0)
            this.outx("dragon");
        ...
        if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS.EMBER_INTERNAL_DICK] > 0)
            this.outx("draconic ");
        else this.outx("human-like ");
        this.outx("cock begins making its way past your labia.");
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.cumQ() < 250) this.outx("spatter");
            else if (this.player.cumQ() < 1000) this.outx("drench");
            else if (this.player.cumQ() < 2000) this.outx("completely cover");
            else this.outx("utterly soak");
    ...
    private getPenetratedByEmberLastSexSceneWooooPartII(): void {
        ...
        else this.outx("limp cock and balls");
    ...
    public emberRapesYourHeatness(): void {
        ...
        if (
            ...
            this.outx("your [vagina] aching to be filled and your womb put to its proper purpose");
        else this.outx("[eachCock] burning to be seeding ripe, ready wombs");
        this.outx(".");
        ...
        if (
            ...
            this.outx("humping against you, smearing your thigh with dragon pre.");
        else this.outx("tightly pressing her drooling, puffy netherlips on your thighs.");
        this.outx(
    ...
    private getKnockedUpByEmbrahBroBaby(): void {
        ...
        this.outx(".  Yawning, you curl up to the dragon for a quick nap of your own.");
        this.player.orgasm();
        this.dynStats("sen", -2);
    ...
    private breedEmberPregnantAsIfThereWasAnyOtherKindOfBreeding(): void {
        ...
        if (this.player.hasVagina())
            this.outx("  The tip of her tail gently teases your slick [vagina] with tiny strokes.");
        this.outx(
        ...
        if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 0) this.outx("scale-covered ");
        this.outx("orbs gently squish ");
        if (this.flags[kFLAGS.EMBER_MILK] > 0) this.outx("and leak milk ");
        this.outx("under your grasp.");
        ...
        if (this.flags[kFLAGS.EMBER_MILK] > 0)
            this.outx("the slowly trickling rivulets of milk along with ");
        this.outx(
            "Ember's pleased moans are enough to make you push away such thoughts, you're glad she has those!"
        );

        this.outx("\n\nYou hungrily kiss her ");
        if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 0) this.outx("draconic ");
        else this.outx("oh-so-human ");
        this.outx(
        ...
        if (this.emberHasCock()) this.outx("her cock spurts a few jets of cum onto your [chest]; ");
        this.outx(
        ...
        if (this.emberHasCock()) this.outx("her spent cock throb; ");
        this.outx(
        ...
        if (this.emberHasCock()) this.outx("cum-slick ");
        this.outx("belly and laying there to regain your strength, ");
        if (this.emberHasCock())
            this.outx("dismissive of the spent cock lying sandwiched between you as you start ");
    ...
    private emberBreedingAfterMathWatchOutForRadioactiveFallout(emberPregged = true): void {
        ...
        // (if PC now pregnant:
        if (!emberPregged)
            this.outx("  You touch your belly with a smirk.  Very certain they took indeed...");
        this.doNext(this.playerMenu);
    }
    ...
    public emberGivesBirth(): void {
        ...
        if (this.flags[kFLAGS.EMBER_OVIPOSITION] == 0) {
            ...
            if (this.flags[kFLAGS.EMBER_ROUNDFACE] > 0) this.outx("head crowning");
            else this.outx("tip of the muzzle jutting out");
            this.outx(
            ...
            if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 0) this.outx("n anthro dragon");
            else this.outx(" hybrid of human and dragon");
            this.outx(".  It's a beautiful strong, healthy little ");
            const roll: number = EmberScene.rand(100);
            if (roll < 40) this.outx("boy");
            else if (roll < 80) this.outx("girl");
            else this.outx("herm");
            this.outx(".");

            this.outx("\n\nYou cradle ");
            if (roll < 40) this.outx("him");
            else this.outx("her");
            this.outx(
            ...
            if (roll < 40) this.outx("son");
            else this.outx("daughter");
            this.outx(" out for her to take.");
            ...
            this.outx("  With a contented expression on your face, you leave Ember and your ");
            if (this.emberChildren() <= 1) this.outx("new child");
            else this.outx("newly expanded draconic brood");
            this.outx(" to get some rest, leaving the den.\n");
    ...
    public giveBirthToEmberKids(): void {
        ...
        if (this.flags[kFLAGS.EMBER_OVIPOSITION] == 0) {
            ...
            if (this.player.findPerk(PerkLib.Masochist) >= 0) this.outx("deliciously ");
            this.outx(
            ...
            this.outx(" was getting hungry and I didn't know what to do,</i>\" Ember explains.");
            if (this.flags[kFLAGS.EMBER_MILK] > 0) {
                this.outx('  "<i>I tried to feed ');
                if (roll < 40) this.outx("him");
                else this.outx("her");
                this.outx(" myself, but ");
                if (roll < 40) this.outx("he");
                else this.outx("she");
                this.outx(' wanted yours...</i>"');
            }
            ...
            this.outx(" face and starts to cry softly.  You gently help ");
            if (roll < 40) this.outx("him");
            else this.outx("her");
            this.outx(" up onto your shoulder and gently pat ");
            if (roll < 40) this.outx("him");
            else this.outx("her");
            this.outx(" on the back between ");
            if (roll < 40) this.outx("his");
            else this.outx("her");
            this.outx(" little wings, eliciting a burp that clearly leaves ");
            if (roll < 40) this.outx("him");
            else this.outx("her");
            this.outx(" feeling better.  ");
            if (roll < 40) this.outx("He");
            else this.outx("She");
            this.outx(
        ...
        // PC Lays Egg
            ...
            this.outx(", anyway.  The dragon ");
            if (this.flags[kFLAGS.EMBER_ROUNDFACE] > 0) this.outx("blushes and then ");
            this.outx(
    ...
    private highAffectionEmberLustFuck(): void {
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] == 3) this.outx(" and");
        if (this.flags[kFLAGS.EMBER_GENDER] >= 2)
            this.outx(" her pussy beginning to drip in excitement");
        this.outx(".");
        ...
        if (this.flags[kFLAGS.TIMES_EMBER_LUSTY_FUCKED] == 0) {
            ...
            this.outx("\n\nYou nod");
            if (this.player.lib < 50 && this.player.minLust() < 40) {
                this.outx(", grabbing a vial of Lust Draft from your pouches");
                this.player.consumeItem(this.consumables.L_DRAFT);
            }
            this.outx(".");
        }
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] == 1) {
            ...
            this.outx("\n\nYour ");
            if (this.flags[kFLAGS.EMBER_ROUNDFACE] == 0) this.outx("she-dragon");
            else this.outx("dragon-girl");
            this.outx(
        ...
        // else if Ember has a pussy and the PC more than one cock:
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] == 3)
                this.outx(", not to mention the stiffness of her dick");
            this.outx(
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] == 3)
                this.outx(", cock dribbling precum onto her belly");
            this.outx(".");

            this.outx("\n\nThe feeling of having ");
            if (this.player.cockTotal() == 2) this.outx("both ");
            else this.outx("two of ");
            this.outx(
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] >= 2 && this.player.cockTotal() > 1)
            this.outx(" and ass");
        this.outx(" rippling and squeezing your intruding member");
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] >= 2) {
            ...
            if (this.player.cockTotal() > 1) this.outx(" and tight ass");
        } else this.outx(" tight ass");
        ...
        if (this.flags[kFLAGS.EMBER_GENDER] >= 2) {
            ...
            if (this.flags[kFLAGS.EMBER_GENDER] == 3) this.outx(", and her ");
            else this.outx(", ");
        }
        ...
        else this.outx("holes squeeze");
        this.outx(" you, milking your ");
        if (this.flags[kFLAGS.EMBER_GENDER] == 1)
            this.outx(
        ...
        // {twin shafts} as {her cunt spasms wetly, drenching your lap with fresh femcum} {and/or} {[her] cock spurts dragon-seed onto the leaves below {her}, filling the air with the scent of spunk and matting them into a steaming morass}
            ...
            if (this.player.cockTotal() == 1)
                this.outx("shaft as her cunt spasms wetly, drenching your lap with fresh femcum");
            else
                this.outx(
        ...
        if (this.player.cockTotal() > 1 && this.flags[kFLAGS.EMBER_GENDER] >= 2) this.outx("s");
        this.outx(
    ...
    private noStayingForCuddlesPostLustFuck(): void {
        ...
        else this.outx("grunt an acknowledgement");
        this.outx(" and then gather your things before heading off to wash yourself down.");
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private stayWithEmberAfterLustFuck(): void {
        ...
        // else if Ember is female:
            ...
            if (this.flags[kFLAGS.EMBER_MILK] > 0) this.outx("milk-filled ");
            this.outx(
            ...
            if (this.flags[kFLAGS.EMBER_ROUNDFACE] > 0) this.outx("-girl");
            this.outx(
    ...
    private frottingWithEmber(clear = true): void {
        ...
        if (this.flags[kFLAGS.EMBER_HAIR] == 0 && this.flags[kFLAGS.EMBER_ROUNDFACE] == 0)
            this.outx(" head");
        else if (this.flags[kFLAGS.EMBER_HAIR] == 2) this.outx(" mane");
        else this.outx(" hair");
    ...
    private penetrateWithEmber(clear = true): void {
        ...
        if (this.flags[kFLAGS.EMBER_MILK] > 0) this.outx(", milk seeping across your fingers,");
        this.outx(
        ...
        this.outx("\n\nThe dragon");
        if (this.flags[kFLAGS.EMBER_ROUNDFACE] > 0) this.outx("-girl");
        this.outx(" moans at your ministrations");
        if (this.flags[kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS.EMBER_GENDER] == 3) {
            this.outx(
            ...
            this.outx("your belly");
            if (this.player.biggestTitSize() > 1) this.outx(",");
            this.outx(" and Ember's own.");
        }
        this.outx(
        ...
        this.outx("your [butt], grabbing the ");
        this.outx(
        ...
        if (this.flags[kFLAGS.EMBER_MILK] > 0)
            this.outx("Drink my milk, I've been saving it up specially for you,");
        else
            this.outx(
