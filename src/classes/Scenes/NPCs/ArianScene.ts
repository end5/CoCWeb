...
export class ArianScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    public visitThePark(): void {
        ...
        if (this.flags[kFLAGS.ARIAN_PARK] == 1) {
            this.outx("\n\nFeeling ");
            if (this.player.cor < 50) this.outx("curious");
            else this.outx("bored");
            this.outx(", you decide to ask him what his story is.");
        ...
        // Visit 3
            ...
            if (this.player.cor >= 66)
                this.outx(", keeping your real reasons for bothering with him to yourself");
            this.outx(".");
    ...
    public visitAriansHouse(): void {
        ...
        if (this.arianFollower()) {
            ...
            if (temp == 0) {
                ...
                if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
                    if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx("mixed sexual fluids");
                    else this.outx("jizz");
                } else this.outx("femjizz");
                this.outx(" and, indeed, still hovering over [Arian eir] ");
                if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
                    if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx("twin sexual slits");
                    else {
                        this.outx("cock");
                        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
                    }
            ...
            if (this.flags[kFLAGS.ARIAN_PARK] == 4) {
                ...
                if (this.player.cor < 33) this.outx("curiously");
                else if (this.player.cor < 66) this.outx("casually");
                else this.outx("indifferently");
                this.outx(" ask why he's thanking you.");
                ...
                else this.outx("seat your tauric body on the floor");
                this.outx(
                ...
                // 50-74 health
                    ...
                    if (!this.player.isTaur()) this.outx("take the offered chair");
                    else this.outx("the offered chair");
                    this.outx(".");
                    this.outx(
                ...
                // 75-100 health:
                    ...
                    if (!this.player.isTaur()) this.outx(" and offers you the chair nearby");
                    this.outx(
    ...
    private dontSleepWithArian(): void {
        this.clearOutput();
        this.outx("You decide not to sleep with Arian at night, for now.");
    ...
    private peepOnArian(): void {
        ...
        if (this.player.lizardCocks() > 0) this.outx(" just like yours");
        this.outx(", though this isn't stopping him from enthusiastically stroking himself off.");
    ...
    private arianStoryDialogue1(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.MetMarae) >= 0)
            this.outx("Marae herself told you they showed up about, what, 20-30 years ago?");
        else
            this.outx(
    ...
    private arianStoryDialogue2(): void {
        this.clearOutput();
        this.arianHealth(1);
        this.outx("You look Arian over, remarking that he seems to be getting better after all.");
        this.outx(
    ...
    private arianStoryPry(): void {
        ...
        if (this.player.cor < 40)
            this.outx("; he'll sleep better with the burden off [Arian eir] conscience");
        this.outx(".");
        this.outx(
    ...
    private arianMagicLessons(): void {
        this.clearOutput();
        this.arianHealth(1);
        this.outx("You ask Arian if [Arian ey] wouldn't mind giving you some magic lessons.");
        ...
        if (this.player.inte < 25) {
            ...
            if (!this.arianFollower()) this.outx("make your way back to your camp.");
            else this.outx("return to your duties.");
        }
        // (else if PC int < 50 //Teach Charge Weapon if PC doesn't know.
            ...
            if (!this.arianFollower()) this.outx(", making your way back to camp.");
            else this.outx(", exiting [Arian eir] tent and going about your business.");
            ...
            this.outx("<b>Game Note: This isn't canon and will be re-written soonish.</b>");
            ...
            if (!this.arianFollower()) this.outx("begin the trek home.");
            else this.outx("exit [Arian eir] tent.");
    ...
    private inviteArianToCamp(): void {
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
            if (this.flags[kFLAGS.ARIAN_VAGINA] == 0) this.outx("man");
            else this.outx("herm");
    ...
    private takeYerLizardHomePartII(): void {
        ...
        if (this.camp.followersCount() > 1) this.outx(" and your other companions");
        this.outx(".");
    ...
    private arianSexMenu(output = true): void {
        if (output) {
            this.clearOutput();
            this.outx("You ask Arian if [Arian ey] feels strong enough to do a little lovemaking.");
            // (if ArianHealth < 30)
    ...
    private giveArianAnal(): void {
        ...
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
            this.outx(this.images.showImage("arianfemale-home-giveArianAnal"));
        else this.outx(this.images.showImage("arianmale-home-giveArianAnal"));
        ...
        if (this.flags[kFLAGS.ARIAN_ANAL_XP] < 33) {
            ...
            if (this.flags[kFLAGS.ARIAN_VAGINA] < 1) {
                ...
                if (this.flags[kFLAGS.ARIAN_COCK_SIZE] == 0) this.outx("girl");
                else this.outx("herm");
                this.outx(
            ...
            if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) {
                this.outx("the puffy lips of [Arian eir] drooling vagina");
                if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) this.outx(" and ");
            }
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
                this.outx(this.arianMF("his", "her") + " erecting ");
                if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("pair of reptilian pricks");
                else this.outx("reptilian prick");
            }
            this.outx(
            ...
            if (this.player.balls == 0) this.outx("the base of your cock");
            else this.outx("the bottom of your balls");
            this.outx(
            ...
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0)
                this.outx("spewing forth large gobs of cum of [Arian eir] own");
        ...
        // Loose, sensitive enough to make Arian scream in pleasure. (It's like a tight vagina, feels like one too, minor pain)
            ...
            if (this.flags[kFLAGS.ARIAN_VAGINA] < 1) {
                ...
                if (this.flags[kFLAGS.ARIAN_BREASTS] == 1) this.outx(" perky");
                else if (this.flags[kFLAGS.ARIAN_BREASTS] == 2) this.outx(" rounded");
            ...
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
                this.outx(" a");
                if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx(" pair of dripping cocks");
                else this.outx(" dripping cock");
                if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx(" and");
            }
            if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx(" a sopping wet pussy");
            this.outx(" greet");
            if (
                (this.flags[kFLAGS.ARIAN_VAGINA] == 0 &&
            ...
            if (this.arianFollower()) this.outx("tent");
            else this.outx("bedchamber");
            this.outx(
            ...
            if (this.flags[kFLAGS.ARIAN_VAGINA] < 1) this.outx("boypussy");
            else this.outx("nether-pussy");
            this.outx(
            ...
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
                if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] == 0) this.outx("cock spews its load");
                else this.outx("twin cocks spew their loads");
                this.outx(" on the bedsheets");
                if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx(" and [Arian eir] ");
            }
            if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
                this.outx(" contracting pussy paints your lower body with lizan femcum");
            this.outx(
            ...
            if (this.player.balls == 0) this.outx("base of your spine");
            else this.outx("depths of your balls");
            this.outx(
            ...
            if (!this.arianFollower()) this.outx("room");
            else this.outx("tent");
            this.outx(".");
        }
        // AnalXP <= 100
        // Very Loose, sensitive enough to make Arian cum just from insertion. (Feels better than anything else. Yep, Arian really becomes a buttslut at this point)
            ...
            if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
                this.outx("wet gash is positively leaking lizan juices");
            if (this.flags[kFLAGS.ARIAN_VAGINA] > 0 && this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0)
                this.outx(" and [Arian eir] ");
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0)
                this.outx("erect cock is already leaking pre like a sieve");
            this.outx(
            ...
            if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
                this.outx("her pussy clenches, spilling a flood of juices; ");
            if (this.flags[kFLAGS.ARIAN_VAGINA] > 0 && this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0)
                this.outx(" and ");
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0)
                this.outx("his cock throbs and shoots rope after rope of cum onto the bedsheets");
            this.outx(
            ...
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
                ...
                if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx(", and her");
            }
            if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
                this.outx(
            ...
            if (this.flags[kFLAGS.ARIAN_ASS_CHAT] == 0) {
                ...
                if (9999 == 9999) this.outx(" as hypocritical as that may be");
                this.outx(
                ...
                if (!this.arianFollower())
                    this.outx("back to Tel'Adre's streets, and from there back to camp.");
                else this.outx("out of [Arian eir] tent.");
    ...
    private getBlownByArian(): void {
        ...
        this.arianHealth(3);
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
            this.outx(this.images.showImage("arianfemale-home-getbj"));
        else this.outx(this.images.showImage("arianmale-home-getbj"));
        this.outx(
        ...
        if (this.player.cumQ() < 250) this.outx("small");
        else if (this.player.cumQ() < 1500) this.outx("big");
        else this.outx("huge");
        this.outx(
        ...
        this.outx("; is [Arian ey] sure [Arian ey]'s all right?");
        ...
        else this.outx(" out of Arian's tent.");
        this.player.orgasm();
    ...
    private penetrateArian(): void {
        ...
        this.outx(this.images.showImage("arianfemale-home-penetrate"));
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) this.outx("dick");
        this.outx("girl.");
        ...
        this.outx('.  "<i>Err... readier?</i>"  She asks, smiling nervously.');
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] == 3) {
            this.outx(", her exposed cock");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
            this.outx(" hardening at what she's about to do");
        } else if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
            this.outx(", her bulbous cock");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s peeking out of their");
            else this.outx(" peeking out of its");
            this.outx(" hiding place, already at full mast in anticipation");
        }
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] == 0) this.outx("female");
        else this.outx("herm");
        this.outx(" lizan, until you have managed to hilt yourself inside of her.");
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
            this.outx("  Her ");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("twin shafts");
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
            this.outx("  Her cock");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s twitch as they spurt ");
            else this.outx(" twitches as it spurts ");
            this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
            this.outx("Arian's ");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("twin cocks throb");
            else this.outx("cock throbs");
            this.outx(
        ...
        if (this.player.balls == 0) this.outx("you");
        ...
        this.outx("ou unleash your essence right into the lizan's burning womb.");
        ...
        if (this.player.cumQ() < 250) this.outx("lean");
        else if (this.player.cumQ() < 1000) this.outx("full");
        else this.outx("overfilled");
        this.outx(' belly.  "<i>Stay with me, like this, a little longer?</i>" Arian asks.');
    ...
    private getButtWreckedByArian(): void {
        ...
        this.arianHealth(3);
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
            this.outx(this.images.showImage("arianfemale-home-getArianAnal"));
        else this.outx(this.images.showImage("arianmale-home-getArianAnal"));
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] >= 3) {
            this.outx("exposed cock");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s harden");
            else this.outx(" hardens");
            this.outx(" to full mast.");
        } else {
            this.outx(this.arianMF("his", "her") + " cock");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s peek out of their");
            else this.outx(" peeks out of its");
            this.outx(" hiding place, rising to full mast.");
        }

        this.outx(
            "\n\nYou sashay yourself towards the prone lizan, straddling [Arian eir] legs and reaching out to grasp [Arian eir] "
        );
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("primary ");
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) {
            this.outx("  [Arian Eir] other shaft twiches and sprays your ");
            if (this.player.tailType == TAIL_TYPE_NONE) this.outx("back");
            else this.outx("tail");
            this.outx(".");
        }
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0)
            this.outx("stroking [Arian eir] other cock and sliding it between your ass cheeks, ");
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_ANAL_XP] > 66) this.outx("eager ");
        this.outx("ass, probing for [Arian eir] prostrate...");

        this.outx(
            "\n\nThe reaction is almost instantaneous; Arian moans into your kiss and you feel [Arian eir] "
        );
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0)
            this.outx("pair of lizan-cocks practically jump");
        else this.outx("lizan-cock practically jump");
        this.outx(" back to full mast, even surprising you with Arian's eagerness.");
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0)
            this.outx("sliding [Arian eir] neglected prick through your ass-cheeks, ");
        this.outx(
        ...
        if (this.player.hasVagina()) this.outx("cunt dripping with arousal");
        if (this.player.hasCock() && this.player.hasVagina()) this.outx(" and ");
        if (this.player.hasCock()) {
            this.outx("cock");
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(" drooling precum onto [Arian eir] belly");
        }
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s twitch");
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx(", as well as your butt");
        this.outx(", as Arian climaxes");
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
            this.outx(
        ...
        // (if AnalXP <= 100)
            ...
            if (this.player.hasCock()) {
                ...
                else this.outx(".  You're too big to fit inside Arian's ass, though.");
    ...
    private suckAriansDick(): void {
        ...
        this.arianHealth(3);
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
            this.outx(this.images.showImage("arianfemale-home-suckariandick"));
        else this.outx(this.images.showImage("arianmale-home-suckariandick"));
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 3) {
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outx("exposed cocks hardening to full mast");
            else this.outx("exposed cock hardening to full mast");
        } else {
            this.outx("cock");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s emerging from their");
            else this.outx(" emerging from its");
            this.outx(" hiding place, already fully erect");
            this.outx(".");
        }
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("uppermost ");
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("twin ");
        this.outx("shaft");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s tremble");
        else this.outx(" trembles");
        this.outx(" and throb");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] == 0) this.outx("s");
        this.outx(" against your hand; pre quickly forming on the tip");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
        this.outx(" only to slowly slide down the bulbous surface of Arian's lizan prick");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
        this.outx(
        ...
        this.outx(" one more time and erupts into your waiting mouth");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx(" and chin");
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx(" and tickle her cunt with a finger");
        this.outx(
    ...
    private getPenetratedByArianAndHisHitlerMustache(): void {
        ...
        this.arianHealth(3);
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
            this.outx(this.images.showImage("arianfemale-home-getpenetrated"));
        else this.outx(this.images.showImage("arianmale-home-getpenetrated"));
        this.outx("You look at Arian's ");
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] < 3)
            this.outx("slit, and think of what it's hiding in there");
        else {
            this.outx("exposed cock");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
        }
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("twin cocks");
        else this.outx("cock");
        this.outx(" a bit of a workout?");
        ...
        if (this.player.isBiped()) this.outx("spread your [legs] and ");
        this.outx(
            "expose your [vagina] to [Arian eir] viewing pleasure.  The reaction is almost instantaneous; Arian's "
        );
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] >= 3) this.outx("exposed");
        else this.outx("hidden");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx(" twin shafts immediately fill");
        else this.outx(" shaft immediately fills");
        this.outx(" with blood, growing fully erect in ");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("their");
        else this.outx("its");
        this.outx(" bulbous, throbbing glory.");
        ...
        this.outx("kneels between your [legs]");
        this.outx(", aligning the tip of ");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("each of ");
        this.outx(this.arianMF("his", "her") + " ");
        this.outx("shaft");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
        this.outx(" with your [vagina]");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx(" and [asshole]");
        this.outx(
            ".  [Arian Ey] looks at you, waiting for you to confirm that [Arian ey] should indeed get going.  You smile and nod"
        );
        if (this.player.hasLongTail()) this.outx(", looping your tail around [Arian eir] waist");
        this.outx(".");
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("twin bulbous shafts feel");
        else this.outx("bulbous shaft feels");
        this.outx(" exquisite, and ");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("their");
        else this.outx("its");
        this.outx(" bumps massage your entrance");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_VAGINA] == 0) this.outx("[Arian ey] himself ");
        else this.outx("she ");
        this.outx("is being overwhelmed by, spraying your ");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] == 0) this.outx("cavity");
        else this.outx("cavities");
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("and ass ");
        this.outx("contracting, trying ");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] == 0) this.outx("its");
    ...
    private doublePenetrateArian(): void {
        ...
        this.flags[kFLAGS.ARIAN_VIRGIN] += 1;
        this.arianHealth(3);
        this.outx(this.images.showImage("arianfemale-home-doublepenetrate"));
        ...
        if (this.flags[kFLAGS.ARIAN_ANAL_XP] <= 33) this.outx("tight");
        else if (this.flags[kFLAGS.ARIAN_ANAL_XP] <= 66) this.outx("loose");
        else this.outx("throbbing");
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_PENETRATION_CHAT] == 0) {
            ...
            if (!this.arianFollower()) this.outx("bedchambers");
            else this.outx("tent");
            this.outx(".");
        } else {
            this.outx(
    ...
    private arianDocking(): void {
        ...
        this.arianHealth(3);
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
            this.outx(this.images.showImage("arianfemale-home-docking"));
        else this.outx(this.images.showImage("arianmale-home-docking"));
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("pair of ");
        this.outx("pecker");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
        this.outx(" from your prying eyes.");
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
        this.outx(" of Arian's dick");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
        this.outx(".  You brush your fingers against the tip");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
        this.outx(", seeing what kind of reaction that will elicit from your scaly lover.");
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] == 0)
            this.outx(" brushing up against [Arian eir] own lizan pecker");
        else this.outx("sandwiched between [Arian eir] two lizard dicks");
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("pair of cummy masts emerge");
        else this.outx("cummy mast emerges");
        this.outx(" to feebly shoot a couple more ropes of jism, before returning limply to ");
        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("their");
        else this.outx("its");
        this.outx(' hiding place.  "<i>Ahhh,</i>" is all Arian says, before slumping down.');
    ...
    private giveIncubusDraftToArian(): void {
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0)
            this.outx("if [Arian ey] would like to make [Arian eir] cock bigger");
        else this.outx("if she'd like to have a touch of her old malehood back");
        this.outx(".");
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] == 0) {
            ...
            this.outx(" new size as Arian moans and cums all over [Arian em]self.");
            ...
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s back into their");
            else this.outx(" back into its");
            this.outx(" slit.");
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] == 2) {
                ...
                if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("them");
                else this.outx("it");
                this.outx(
    ...
    private succubiMilkForArian(): void {
        ...
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx("further ");
        this.outx("in touch with [Arian eir] feminine side.  For you?");
        ...
        if (this.flags[kFLAGS.ARIAN_VAGINA] == 0) {
            ...
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
            this.outx(" having already softened and retracted");
            // if ArianCockSize >= 3:
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] == 3) this.outx(" as far as it'll go");
            this.outx(" into its protective slit.");
            ...
            if (this.flags[kFLAGS.ARIAN_BREASTS] == 2) {
                ...
                if (this.flags[kFLAGS.ARIAN_COCK_SIZE] >= 3)
                    this.outx(" and her exposed shaft begins to grow hard");
                this.outx(".");
            } else {
                this.outx(
                ...
                if (this.flags[kFLAGS.ARIAN_COCK_SIZE] == 3)
                    this.outx(" and you see her exposed shaft slowly rising to point at you");
                this.outx(".");
    ...
    private giveArianLactaid(): void {
        ...
        if (this.flags[kFLAGS.ARIAN_BREASTS] == 0) {
            ...
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] == 3)
                this.outx(", her exposed cock growing hard as she flushes with arousal");
            this.outx(".  Her hands grip the sheets and you watch her ");
            if (this.flags[kFLAGS.ARIAN_BREASTS] == 1) this.outx("perky");
            else if (this.flags[kFLAGS.ARIAN_BREASTS] == 2) this.outx("luscious");
            else this.outx("pillowy");
            this.outx(
    ...
    private useReductoOnAriansBreasts(): void {
        ...
        this.outx("You point at Arian's ");
        if (this.flags[kFLAGS.ARIAN_BREASTS] == 1) this.outx("small");
        else if (this.flags[kFLAGS.ARIAN_BREASTS] == 2) this.outx("generous");
        else this.outx("pillowy");
        this.outx(
    ...
    private useReductoOnArianCocks(): void {
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] == 3) {
            ...
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("pair of exposed lizard cocks");
            else this.outx("exposed lizard cock");
            this.outx(" into full erection.  Finally [Arian ey] begins applying the paste.");

            this.outx(
                "\n\nThe changes are almost immediate; Arian groans and watches as [Arian eir] oversized dick"
            );
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
            this.outx(" slowly shrink");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] == 0) this.outx("s");
            this.outx(
            ...
            this.outx(" hiding place; it's a tight fit, but it fits.");
            ...
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outx("s from their tight hiding place");
            else this.outx(" from its tight hiding place");
            this.outx(", and into full erection.  Finally [Arian ey] begins applying the Reducto.");

            this.outx(
                "\n\nIt takes mere moments for the changes to occur; Arian groans in slight discomfort as [Arian eir] cock"
            );
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s return to their");
            else this.outx(" returns to its");
            this.outx(" original size.  Once the transformation is complete, [Arian ey] retracts ");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("them");
            else this.outx("it");
            this.outx(" back into [Arian eir] genital slit.");
    ...
    private useReductoOnAriansAsshole(): void {
        ...
        // (else if AnalXP < 33)
            ...
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
                this.outx(", [Arian eir] cock");
                if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outx("s suddenly jolting from their sheathe");
                else this.outx(" suddenly jolting from its sheathe");
                if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx(" and ");
            }
            if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) {
                if (this.flags[kFLAGS.ARIAN_COCK_SIZE] == 0) this.outx(", ");
                this.outx("her pussy growing wet from the stimulation");
            }
            this.outx(
    ...
    private giveArianReptilum(): void {
        ...
        if (!this.player.hasVagina() && !this.player.hasCock()) this.outx("genderless crotch");
        this.outx(
            '.  "<i>Hmm, that looks much tastier than candy actually.</i>"  [Arian Ey] licks your '
        );
        if (this.player.hasCock()) this.outx("cock from base to tip");
        else if (this.player.hasVagina())
            this.outx("pussy all the way from the back to the tip of your [clit]");
        else this.outx("your sweaty crotch");
        this.outx(
            '.  "<i>Yummy!  I could use seconds, but roleplay time is over; let\'s... masturbate each other!</i>"  [Arian Ey] begins stroking [Arian eir] '
        );

        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
            this.outx(this.images.showImage("arianfemale-home-mutualmasturbation"));
        else this.outx(this.images.showImage("arianmale-home-mutualmasturbation"));

        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] == 1) {
            this.outx("quickly erecting lizan cock");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
            if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx(" and her ");
        }
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx("slavering vagina");
        this.outx(".");
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
            this.outx("shooting thick ropes of cum up into the air to land on [Arian eir] ");
            if (this.flags[kFLAGS.ARIAN_BREASTS] == 0) this.outx("chest");
            else if (this.flags[kFLAGS.ARIAN_BREASTS] == 1) this.outx("perky little breasts");
            else if (this.flags[kFLAGS.ARIAN_BREASTS] == 2) this.outx("soft breasts");
            else this.outx("pillowy breasts");
            if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) this.outx(" while ");
        }
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
            this.outx("her vagina doing its best to soak her bed with lizan femcum");
        this.outx(".");
    ...
    private treatCorruption(): void {
        ...
        if (this.flags[kFLAGS.ARIAN_TREATMENT] == 1) {
            ...
            if (this.player.cor == 0)
                this.outx(" - in fact, you're quite sure that Arian has purified you entirely");
            this.outx(".  You thank the lizan for [Arian eir] magical treatment.");
    ...
    private imbueTalisman(): void {
        this.clearOutput();
        this.outx("You tell Arian that, if it's not too much trouble, you'd like [Arian em] to ");
        if (this.player.hasKeyItem("Arian's Talisman") >= 0)
            this.outx("place a spell in the enchanted talisman [Arian ey] created for you");
        else this.outx("change the spell in the talisman [Arian ey] created for you");
    ...
    */
    ...
    public sleepWithArian(newl = false): void {
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
            this.outx("You can clearly see [Arian eir] exposed cock");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
            this.outx(" stiffening at the sight.  ");
        }
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
            this.outx(
    ...
    private listenToLowAnalXPArian(): void {
        ...
        this.outx("You turn you head to try and catch what Arian might be dreaming about.");
    ...
    private listenToMediumAnalXPArian(): void {
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.cor >= 66) this.outx(", despite the silly lizan being deserving of it");
            this.outx(
    ...
    private TeaseHighAnalXPArian(): void {
        ...
        if (this.flags[kFLAGS.ARIAN_VAGINA] > 0)
            this.outx(this.images.showImage("arianfemale-camp-dreamingArian"));
        else this.outx(this.images.showImage("arianmale-camp-dreamingArian"));
        this.flags[kFLAGS.ARIAN_MORNING] = 1;
        ...
        if (this.player.hasCock()) {
            ...
            if (this.flags[kFLAGS.ARIAN_ANAL_XP] < 33) {
                ...
                if (this.flags[kFLAGS.ARIAN_VAGINA] > 0) {
                    ...
                    this.outx(this.arianMF("his", "her") + " ");
                    if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("twin shafts are");
                    else this.outx("shaft is");
                    this.outx(" squirting white ropes of lizan cum all over the bedsheets;");
                }
                this.outx(" what a naughty little lizan.");
            ...
            if (this.flags[kFLAGS.ARIAN_ANAL_XP] < 33) {
                ...
                if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
                    this.outx(this.arianMF("his", "her") + " ");
                    if (this.flags[kFLAGS.ARIAN_COCK_SIZE] >= 3) this.outx("exposed ");
                    this.outx("bulbous shaft");
                    if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s begin");
                    else this.outx(" begins");
                    this.outx(" sporting an erection");
                    if (this.flags[kFLAGS.ARIAN_COCK_SIZE] < 3) {
                        this.outx(", poking ");
                        if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] == 1) this.outx("its tip");
                        else this.outx("their tips");
                        this.outx(" out of Arian's genital slit");
                    }
                    this.outx(".");
                ...
                this.outx('  [Arian Ey] pants, eyes glazed.  "<i>Uhh... [name]...</i>"');
    ...
    private pickAnEggArian(color = "pink"): void {
        ...
        this.outx("You tell Arian you'd like her to make you a " + color + " egg.");
        this.outx(
    ...
    public arianLaysEggs(): void {
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) this.outx("herm");
        else this.outx("girl");
        this.outx(
    ...
    private arianDildoFun(): void {
        ...
        if (this.flags[kFLAGS.TIMES_ARIAN_DILDOED] == 0) {
            this.outx("Looking over your reptilian girlfriend, your eyes go down her body");
            if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
                this.outx(", past her cock");
                if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
            } else this.outx(",");
            this.outx(
            ...
            if (this.player.hasKeyItem("Dildo") >= 0) this.outx("bought from Giacomo");
            else this.outx("got from Tamani");
            this.outx(", asking if she's willing to give this a try.");
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
            this.outx("brushing it tantalizingly across the sensitive skin of her pre-oozing cock");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s");
            this.outx(" before");
        }
        this.outx(
        ...
        if (this.flags[kFLAGS.ARIAN_COCK_SIZE] > 0) {
            this.outx("Her cock");
            if (this.flags[kFLAGS.ARIAN_DOUBLE_COCK] > 0) this.outx("s throb");
            else this.outx("throbs");
            this.outx(" throb as a jet of whiteness escape them.  ");
        }
        this.outx(
