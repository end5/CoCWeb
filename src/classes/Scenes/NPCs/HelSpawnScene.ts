...
export class HelSpawnScene extends NPCAwareContent {
    ...
    public heliasAppearanceScreen(): void {
        ...
        if (this.flags[kFLAGS.HEL_BONUS_POINTS] < 150) this.outx("bright orange glow");
        else this.outx("bright white glow");
        this.outx(
        ...
        if (this.flags[kFLAGS.HELSPAWN_NAME] != "") {
            ...
            switch (kGAMECLASS.helScene.pregnancy.event) {
                case 1: // She's pregnant, but no special text yet
                    break;
                case 2:
                    this.outx("  Hel's just starting to show a little bulge of pregnancy.");
                    break;
                case 3:
                    this.outx(
    ...
    private helSpawnsAppearanceScreen(): void {
        ...
        if (this.flags[kFLAGS.HEL_ISABELLA_THREESOME_ENABLED] >= 1)
            this.outx(", with a brightly-colored scarf wrapped around her neck");
        this.outx(". She has a human face, with ");
        if (this.flags[kFLAGS.HELSPAWN_DADDY] == 0) this.outx("golden");
        else if (this.flags[kFLAGS.HELSPAWN_DADDY] == 2) this.outx("bright green");
        else this.outx("crimson");
        this.outx(
        ...
        if (this.flags[kFLAGS.HELSPAWN_DADDY] == 2) this.outx("puppy-dog");
        else this.outx("reptilian");
        this.outx(
    ...
    public heliaBonusPointsAward(): void {
        ...
        if (this.player.hasVagina() && this.player.hasCock())
            this.outx(" and your [chest] and your [vagina]");
        if (!this.player.hasCock() && this.player.hasVagina()) this.outx(" [vagina] and [chest]");
        this.outx(
    ...
    private heliaLoveFollowup(): void {
        ...
        if (this.player.hasVagina()) this.outx("even another woman, it seems, ");
        this.outx('we... change.</i>"');
        ...
        if (this.flags[kFLAGS.HEL_LOVE] == -1)
            ...
            this.outx("I love you, [name].  I love you so much.  I want to share this with you.  ");
        ...
        this.outx("  So what do you say, [name]?  Let's have a kid!</i>\"");
        this.menu();
        if (
            this.player.hasCock() &&
    ...
    public haveAKid(): void {
        ...
        if (this.player.biggestTitSize() <= 2)
            this.outx("supports her, pressing down on your [chest]");
        else
            this.outx(
        ...
        if (this.player.pregnancyIncubation > 0) this.outx("We're going to be mothers!");
        else this.outx("You're going to be a father... and me a mother!");
        this.outx(
    ...
    private HaveAHellKidPartII(): void {
        ...
        if (this.flags[kFLAGS.HEL_LOVE] == 1)
            this.outx(", and I'm so very, very glad you love me back.");
        else
            this.outx(
    ...
    private noKidsHel(): void {
        ...
        if (
            ...
            this.outx("You couldn't if you wanted to anyway - you're too big to fit.  ");
        this.outx(
    ...
    public helGotKnockedUp(): void {
        ...
        if (this.flags[kFLAGS.HELSPAWN_DADDY] == 2) this.outx("warm ");
        else this.outx("wan ");
        this.outx(
    ...
    private sureHelGimmeSpidahBoyDetails(): void {
        ...
        if (this.followerKiha()) this.outx(", toward hotwings' old place");
        this.outx(
        ...
        if (this.player.biggestCockArea() >= 20)
            this.outx(", though still nothing compared to you, lover mine");
        this.outx(
    ...
    private youWantABoy(): void {
        this.clearOutput();
        this.spriteSelect(68);
        this.outx('"<i>Is that so? Yeah, I can see it.  ');
    ...
    private youWantAGirl(): void {
        this.clearOutput();
        this.spriteSelect(68);
        this.outx('"<i>Yeah, a girl would be pretty great.  ');
        // if PC is male:
        if (this.player.hasCock() && !this.player.hasVagina()) {
            this.outx(
    ...
    private encouragePregalia(): void {
        ...
        if (this.flags[kFLAGS.HEL_LOVE] == 1) this.outx("You love Hel");
        else this.outx("Hel's your friend");
        this.outx(
    ...
    private helsLifestyle(): void {
        ...
        if (this.flags[kFLAGS.HEL_LOVE] == 1)
            this.outx("and I hope that's part of why you love me");
        else this.outx("even though I know that's probably part of why you can't love me back");
        this.outx(
    ...
    public heliaBirthtime(): void {
        ...
        if (this.flags[kFLAGS.HELSPAWN_DADDY] == 1) this.outx("your ");
        else this.outx("her ");
        this.outx(
    ...
    private nameDatHelspawn(): void {
        this.clearOutput();
        this.spriteSelect(68);
        this.outx("You and Helia share a laugh, looking down at ");
        if (this.flags[kFLAGS.HELSPAWN_DADDY] == 0) this.outx("your ");
        else this.outx("her ");
        this.outx(
    ...
    private applyHelspawnName(input: HTMLInputElement): void {
        ...
        if (
            ...
            this.clearOutput();
            if (input.value == "") this.outx("<b>You must select a name.</b>");
            else if (input.value == "Hellgirl")
                this.outx('"<i>Hey, that\'s copyright infringement.  Probably.</i>"');
            else if (input.value == "Kid") this.outx('"<i>Wow, what are you, five?</i>"');
            ...
            else if (input.value == "Savin") this.outx("\"<i>That's a boy's name, dumbass.</i>\"");
                ...
                this.outx('"<i>Oh yeah, Kiha\'ll get a laugh out of that.  You ass.</i>"');
        ...
        if (this.flags[kFLAGS.HELSPAWN_NAME] == "Syn")
            this.outx('"Awesome.  I was hoping you\'d choose that one, lover mine.</i>"\n\n');
    ...
    public heliaTalkEight(): void {
        ...
        if (this.flags[kFLAGS.HELSPAWN_DADDY] == 0) this.outx("parental ");
        else this.outx("care giver's ");
        this.outx(
    ...
    public helspawnDiscoversBooze(): void {
        ...
        if (this.player.race() != "cat-boy" && this.player.race() != "cat-girl") this.outx("a cat");
        else this.outx("the cat you are");
    ...
    private encourageHelspawn(): void {
        ...
        this.outx("scales and the smell of a burning brewery.");
    ...
    private snipermanders(): void {
        ...
        this.outx("daughter will be a warrior worthy of her parent");
        if (this.flags[kFLAGS.HELSPAWN_DADDY] == 0) this.outx("s");
        this.outx(".");
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    public helspawnsMainMenu(): void {
        ...
        else this.outx("throwing her arms around you and hugging you tightly");
        this.outx(
    ...
    private talkToHelspawn(): void {
        ...
        if (this.flags[kFLAGS.HAD_FIRST_HELSPAWN_TALK] == 0) {
            ...
            this.outx("  She wouldn't need monsters with you around.");
            this.menu();
    ...
    public beatUpYourDaughter(): void {
        ...
        if (this.flags[kFLAGS.HELSPAWN_PERSONALITY] >= 50 && this.monster.lust > 99) {
            ...
            if (this.flags[kFLAGS.HELSPAWN_INCEST] == 0)
                ...
                if (!this.player.hasCock()) this.outx("sex");
            ...
            if (this.monster.HP < 1) this.outx(", rubbing her many bruises");
            else this.outx(", blushing brightly after your slutty display");
            this.outx(
    ...
    public spiderBrosGift(): void {
        ...
        if (this.isabellaFollower())
            this.outx(", or aunt Isabella might have knitted me a new one, I don't know");
        this.outx('.</i>"');
    ...
    public hakonAndKiriComeVisit(): void {
        ...
        if (this.camp.companionsCount() > 1)
            this.outx(" and everyone else's too, much to their chagrin");
        this.outx(
        ...
        if (this.flags[kFLAGS.HELSPAWN_DADDY] == 0) this.outx("your old man");
        else this.outx("[name]");
        this.outx(', too.</i>"');
    ...
    private goHuntingBitches(): void {
        this.clearOutput();
        this.spriteSelect(68);
        this.outx('"<i>Sure,</i>" you say, quickly earning approving nods from Hakon and Helia.');
        this.outx(
