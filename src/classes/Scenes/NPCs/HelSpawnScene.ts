...
export class HelSpawnScene extends NPCAwareContent {
    ...
    public heliasAppearanceScreen(): void {
        ...
        this.outputText(
            "Hel the salamander stands seven feet tall, with pale skin and thick, bright-red scales covering her arms and legs, though she has a normal human torso and face.  A fiery tail swishes gaily behind her, blazing with a "
        );
        if (this.flags[kFLAGS.HEL_BONUS_POINTS] < 150) this.outputText("bright orange glow");
        else this.outputText("bright white glow");
        this.outputText(
            " that lets off a pleasant heat, though it never seems to burn you.  Hel is wearing her scale bikini and a leather thong, and using her scimitar as a weapon"
        );
        // if Isabella is cool:
        if (this.flags[kFLAGS.HEL_ISABELLA_THREESOME_ENABLED] >= 1)
            this.outputText(
                "; she’s got her blue bandanna wrapped around her head, mostly obscured by her fiery hair"
            );
        this.outputText(
            ".  She has a human face, with bright red eyes, gentle, feminine features and a smattering of pale scales on her cheeks, like freckles.  Hel has long, bright-red hair bound in a pony-tail that hangs down her back.  She has wide-flared hips and a soft, squishy butt.  Her two reptilian legs are visibly adorned with scales and claws, ending in soft, leathery soles."
        );
        if (this.flags[kFLAGS.HELSPAWN_NAME] != "") {
            ...
            switch (kGAMECLASS.helScene.pregnancy.event) {
                ...
                case 3:
                    this.outputText(
                        "  Hel’s belly is starting to look fairly bloated, swelling with her child."
                    );
                    break;
                case 4:
                    this.outputText(
                        "  Hel’s belly is positively gravid, full of a little salamander child."
                    );
                    break;
                default:
                    // She's not pregnant, check if she's ready for it
                    if (this.flags[kFLAGS.HEL_BONUS_POINTS] >= 150)
                        this.outputText(
                            "  Hel’s long, reptilian tail is currently burning white-hot, signaling her body’s ready for motherhood."
                        );
            }
        }
        this.outputText(
    ...
    private helSpawnsAppearanceScreen(): void {
        ...
        this.outputText(
            " eyes, girlish features, and a smattering of pale red scales on her cheeks, like freckles.  Her short, dark-red hair cuts off just below her "
        );
    ...
    public heliaBonusPointsAward(): void {
        ...
        this.outputText("\n<b>That night...</b>\n");
        this.outputText(
            'Your sleep is disturbed by a gentle tugging on your [armor].  You groggily swat at whatever\'s nudging at you, groaning about the hour until your eyes finally open wide enough to recognize Helia kneeling over you, a deeply distraught look in her eyes.  "<i>[name]? [name] wake up, I need to talk to you. Please?</i>"'
        );
        ...
        if (this.camp.companionsCount() == 1)
            this.outputText(
                "You cock an eyebrow, saying that you're already alone, but she shakes her head, saying she needs somewhere private, away from prying eyes.  "
            );
        this.outputText(
        ...
        this.outputText(
            " and everything else about you.  But... but that doesn't mean anything.  It doesn't.  I say I love minotaur dicks, and centaurs, and those two fox pricks at the bar filling both my holes, and I love beer and fighting and ramming my tail up peoples' assholes.  But that's not real love, right?  Love is - oh, god, I'm making a mess of this.  Again. I keep doing this; it always works out so much better in my head.</i>\""
        );
    ...
    private noYouDontLoveHeliaYouMonster(): void {
        ...
        this.spriteSelect(68);
        this.outputText(
            "As much as you enjoy the sex, as much as you like Hel, you can't say you feel that way towards her.  You grasp her shoulders, telling her as gently as possible how you feel.  She nods slowly as you speak, rubbing at her eyes by the time you're finished."
        );
        this.outputText(
    ...
    private yesHeliaILoveYourButtHoleReaming(): void {
        ...
        this.spriteSelect(68);
        this.outputText(
            "Smiling, you tell her yes.  The salamander cries out with joy, jumping into your arms and kissing you, squeezing you so tightly that you feel like you're about to black out by the time she breaks the kiss, stepping back with chest heaving."
        );
        this.outputText(
    ...
    private heliaLoveFollowup(): void {
        ...
        if (this.flags[kFLAGS.HEL_LOVE] == -1)
            this.outputText(
                "Even if you don't love me, you'd love our child, right?  You can fuck me full of kids, or even... even get someone else to, I don't care.  I just </i>need<i> it, [name].  More than anything else in the whole wide world."
            );
        else {
            this.outputText(
                "I love you, [name].  I love you so much.  I want to share this with you.  "
            );
            if (this.player.hasCock())
                this.outputText(
                    "You'll fuck me full of kids, right?  Please?  Give me your seed, [name].  Give it all to me until I'm fucking gravid with your salamander babies."
                );
            else
                this.outputText(
                    "Even if you can't fuck me full of babies... you could grow a dick!  There's plenty of things in this god-forsaken world that do that. O-or if you don't want to, I bet I can get one of the fox-girls, or a minotaur, or something.  You know I can find a dick somewhere, just say the word."
                );
        }
        ...
        if (
            this.player.hasCock() &&
            this.player.cockThatFits(this.helFollower.heliaCapacity()) >= 0
        )
            this.addButton(0, "Have A Kid", this.haveAKid);
        else if (this.player.hasCock())
            this.outputText(
                "  <b>Unfortunately, you're too big to squeeze inside Helia to do the business yourself.  You might need to shrink down some.</b>"
            );
    ...
    public haveAKid(): void {
        ...
        this.outputText(
            ".</i>\"  You start to reply, when you're suddenly upended, landing back on your back with Helia atop you, fingers brushing along the cock buried twixt her legs.  \"<i>Oh, don't think you're getting away that easy, lover mine... my love.  I've gotta make sure your seed took, and that... that's going to take all night long.</i>\""
        );
    ...
    private HaveAHellKidPartII(): void {
        ...
        if (this.flags[kFLAGS.HEL_LOVE] == 1)
            ...
            this.outputText(
                ", even if you can't say the same.  And that's alright; it doesn't change my heart, and it never will. I love you"
            );
        this.outputText('.</i>"');
        ...
        this.outputText(
            "at you, holding you tight for a long moment before stepping away, still holding your hands.  \"<i>This is all new to me, [name].  I never pictured myself as a mother, with a mate and a stable, safe home - or as stable and safe as anything these days - but with you by my side, there's nothing I can't take on.</i>\""
        );
    ...
    private getAnotherDad(): void {
        ...
        if (!this.player.hasCock()) {
            this.outputText(
                "You tell Helia you'd love to a share a child with her, but you're not... properly equipped for the endeavor.  \"<i>That's fine!  I can... I can wait, a little.  I-if you want to go grow one, I mean.  If not, then we can find someone with a cock.  "
            );
            if (this.player.statusAffectv1(StatusAffects.TelAdre) >= 1)
                this.outputText(
                    "There's Miko and Mai from the bar.  Mai's said she wanted a kid, but can't take care of one... she'd probably be willing to fuck one into me!  If that's not alright, then... lemme think.  "
                );
            this.outputText(
        ...
        // [Another Dad] (PC has a dick)
            ...
            this.outputText(
                '"<i>W-wha?</i>" Hel says, cocking an eyebrow.  "<i>You sure, [name]?  I-if you don\'t want to be the dad, I guess I understand.  But why?  Am I not... no, nevermind.  I don\'t want to know.  Okay, uh, we can find someone with a cock.  '
            );
            if (this.player.statusAffectv1(StatusAffects.TelAdre) >= 1)
                this.outputText(
                    "There's Miko and Mai from the bar.  Mai's said she wanted a kid, but can't take care of one... she'd probably be willing to fuck one into me!  If that's not alright, then... lemme think.  "
    ...
    private spiderboyWouldBeBestDad(): void {
        ...
        this.spriteSelect(68);
        this.outputText(
            "You tell Helia to go find a spider boy to jump.  She beams at you, and skips off toward the swamp calling, \"<i>Thank you, thank you thank you, [name]!</i>\" over her shoulder as she goes.  You suppose the next time you see her, Hel's probably going to be pregnant with the child you'll be helping to raise."
        );
        kGAMECLASS.helScene.pregnancy.knockUpForce(
            PregnancyStore.PREGNANCY_PLAYER,
            PregnancyStore.INCUBATION_SALAMANDER
    ...
    private growingDicks4Hel(): void {
        ...
        this.spriteSelect(68);
        this.outputText(
            "You tell Hel to give you a little while, that you'll go find something to grow a cock for her."
        );
        this.outputText(
    ...
    private noKidsHel(): void {
        ...
        this.spriteSelect(68);
        this.outputText(
            "You shake you head and say no, you don't want to have children.  Not right now, anyway.  "
        );
        if (
            this.player.hasCock() &&
            this.player.cockThatFits(this.helFollower.heliaCapacity()) >= 0
        ...
        this.outputText(
            'As the words leave your lips, you can see Hel\'s shoulders slump, a crestfallen look spreading across her face.  "<i>A-are you sure?  Please, [name], I really, really want a child.  For </i>us<i> to have one.</i>"'
        );
        this.outputText(
    ...
    public helGotKnockedUp(): void {
        ...
        this.outputText(
            "smile as you approach, scooting over to allow you to sit beside her.  She almost seems distant, though she's quick to wrap her tail around your waist, hugging you close against her."
        );
    ...
    private sureHelGimmeSpidahBoyDetails(): void {
        ...
        this.outputText(
            ". Took a while, but eventually I just sort of stumbled on this couple of spidergirls, just as cute as could be.  They wander up to me, all cautious, and ask if I was serious about the whole baby thing.  So I say, 'Yeah, sure,' and they get this big, dopey grin, the both of 'em.</i>\""
        );
    ...
    public bulgyCampNotice(): void {
        ...
        this.spriteSelect(68);
        this.outputText(
            "As you're walking through camp, your eyes wander over toward Helia, sunning herself on a stone near the edge of camp.  You can just see that her belly's starting to bulge out from under her, and Hel's hands lie protectively over her full womb, absently rubbing the bulge of her stomach."
        );
        this.doNext(this.playerMenu);
    }
    ...
    public heliaSwollenNotice(): void {
        ...
        this.spriteSelect(68);
        this.outputText(
            "You note that Hel's wandering aimlessly around camp, one hand over her belly as she mumbles to herself.  You could swear she was cursing her now quite swollen belly, but suddenly she gives a girlishly happy cry and waves you over.\n"
        );
    ...
    private youWantABoy(): void {
        ...
        if (this.player.hasCock() && !this.player.hasVagina())
            this.outputText(
                "If I were a guy, I'd want a big strong son to hang out with, too.  Take him fishing, teach him how to fight the way you do... you'll make a great dad, my love.  I'm sure you will."
            );
        else
            this.outputText(
                "Would be nice to have a man around here, you know?  I miss hanging around the boys back home, watching 'em strut like peacocks for every passing girl."
            );
        this.outputText(
            " And any son of mine is going to be a real lady killer, mark my words.  We're going to have to fight off whole hordes of goblin sluts, all looking for a piece of our handsome little boy before you know it.</i>\""
        );
        this.outputText(
    ...
    private youWantAGirl(): void {
        ...
        if (this.player.hasCock() && !this.player.hasVagina()) {
            ...
            this.outputText(
                "We're going to be a gaggle of tittering girls before you know it, though.  Salamanders grow up so fast, [name]...  I just hope she doesn't turn out like me, you know?  I don't know if I could stomach seeing my little girl becoming a wanton slut like her mom.  I might get jealous, after all..."
            );
        this.outputText(
            "  Any daughter of ours is going to be a real beauty, mark my words. She'll make a succubus look like a toad before she's out of swaddling.</i>\""
        );
    ...
    public heliaTalkSeven(): void {
        ...
        if (this.flags[kFLAGS.HELSPAWN_DADDY] != 0)
            this.outputText(
                ", even if he's not your get, I can hope, you know?  If he spends enough time around you, maybe he'll take more after you than me"
            );
        this.outputText('.</i>"');
        this.menu();
    ...
    private encouragePregalia(): void {
        ...
        this.spriteSelect(68);
        this.outputText(
            "You squeeze Hel's shoulder and tell her that she's going to be a great mother, and that her child would do well to learn from a beautiful, powerful warrior like dear old mom.  "
        );
        if (this.flags[kFLAGS.HEL_LOVE] == 1) this.outputText("You love Hel");
        else this.outputText("Hel's your friend");
        this.outputText(
            ', and if her child follows in her footsteps, so much the better.  Your lover manages a half-hearted laugh, blushing at your words.  Her tail tip brushes your cheek as its owner cuddles up against you, smiling.  "<i>Thanks, lover mine.  I just hope I - we - can do right by the kid.  That\'s all.</i>"'
        );
    ...
    private helsLifestyle(): void {
        ...
        if (this.flags[kFLAGS.HEL_LOVE] == 1)
            ...
            this.outputText(
                "even though I know that's probably part of why you can't love me back"
            );
        this.outputText(
            ".  I'll try and rein it in, but maybe... it'd be better if you were the one who raised my child, [name].  God knows I'm the least qualified person to do it.</i>\""
        );
    ...
    private nameDatHelspawn(): void {
        ...
        this.outputText(
            "little girl as she suckles.  After a few happy, blissful minutes though, Hel turns to you with a question:"
        );
        this.outputText(
    ...
    private applyHelspawnName(input: HTMLInputElement): void {
        ...
        if (
            ...
            if (input.value == "") this.outputText("<b>You must select a name.</b>");
                ...
                this.outputText(
                    '"<i>Oh hell no.  You\'re not naming my little girl after one of those... things!  Sorry Kiri, but still!</i>"'
                );
            else if (input.value == "Savin")
                this.outputText("\"<i>That's a boy's name, dumbass.</i>\"");
            else if (input.value == "Helia")
                this.outputText(
                    "\"<i>My favorite name!  Except it's kinda taken, love.  Don't want things to get too confusing around here, do you?</i>\""
                );
        ...
        // Easter Egg Names:
        this.clearOutput();
        if (this.flags[kFLAGS.HELSPAWN_NAME] == "Helspawn")
            this.outputText(
                '"<i>That\'s what I was gonna call her!  Except not at all.  God dammit, seriously, [name]?</i>"\n\n'
            );
        if (this.flags[kFLAGS.HELSPAWN_NAME] == "Jayne")
            this.outputText(
                '"<i>That sounds like a hero\'s name... I like it.  A name that demands respect!</i>"\n\n'
            );
        if (this.flags[kFLAGS.HELSPAWN_NAME] == "Hesper")
            this.outputText(
                '"<i>Ah, the Evening Star.  She\'ll be the star of my life, alright...</i>"\n\n'
            );
        if (this.flags[kFLAGS.HELSPAWN_NAME] == "Kiri")
            this.outputText(
                "\"<i>Aw, that's great, lover.  Sis'll shit her pants when she hears her niece is named after her!  Gonna get confusing, though...</i>\"\n\n"
            );
        if (this.flags[kFLAGS.HELSPAWN_NAME] == "Mai")
            this.outputText(
                "\"<i>Aw, that's great, lover.  Mai'll be honored, I know it.  And it is a great name...</i>\"\n\n"
            );
        if (this.flags[kFLAGS.HELSPAWN_NAME] == "Tanis")
            this.outputText(
                "<i>I don't... I don't know if I want her to have that name, lover.  It's got a lot of baggage, but... but it does my mother an honor.  More than I could ever give her.</i>\"\n\n"
            );
        // Syn:
        if (this.flags[kFLAGS.HELSPAWN_NAME] == "Syn")
            this.outputText('"Awesome.  I was hoping you\'d choose that one, lover mine.</i>"\n\n');
        if (this.flags[kFLAGS.HELSPAWN_NAME] == "Chara")
        ...
        this.outputText(
            " little girl's going to grow up big and strong with a name like that... and with you around to guide her,</i>\" Hel says, kissing your cheek.  \"<i>Why don't you give me a minute to catch my breath and get the little one situated, and let's talk.  Alright?</i>\""
        );
    ...
    public heliaTalkEight(): void {
        ...
        this.spriteSelect(68);
        this.outputText(
            "Watching your little daughter crawl around, you and Hel sit down together arm in arm, smiling as the little salamander girl plays with bits and pieces of Hel's gear."
        );
        this.outputText(
        ...
        this.outputText(
            "pride, either.  She really is growing up faster, many times faster than a human girl.  And, by the sound of things, many times faster than a salamander ought to.  You ask Hel if that's right, and she nods gravely."
        );
        ...
        this.outputText(
            " little girl's going to be a big girl damn soon.  Let's enjoy it while we can, eh?</i>\""
        );
    ...
    public helSpawnGraduation(): void {
        ...
        this.outputText(
            "-scaled figure curled up next to Helia; Hel herself is looking wide-eyed down at the drowsy figure on her breast, just barely opening her eyes.  \"<i>Y-you're... you're huge!</i>\" Hel manages to gasp out, pushing herself back and away from her daughter."
        );
        ...
        if (this.flags[kFLAGS.HELSPAWN_DADDY] == 2)
            this.outputText(
                "And the puppy ears, now more wolf-like, are a dead giveaway.  Utterly unique to her.  "
            );
        this.outputText(
            "You sit down beside the obviously confused girl and stroke her hair, telling her it's all right, her mother's just startled, that's all."
        );
    ...
    private snipermanders(): void {
        ...
        this.outputText(
            "You tell Hel to take a break: you've got this handled. Grabbing your bow and quiver from over your shoulder, you hand them over to "
        );
        if (this.flags[kFLAGS.HELSPAWN_DADDY] == 0) this.outputText("your");
        else this.outputText("Hel's");
        this.outputText(
        ...
        this.outputText(
            ", and you find yourself having to correct her grip on the haft several times.  But, finally, you get her ready to shoot."
        );
    ...
    private swordAndBoardmander(): void {
        ...
        this.outputText(
            "You tell Hel to take a break: you've got this handled.  You grab some kindling and string from your supplies, and a few minutes later you've got a pair of small, vaguely sword-like practice weapons pieces together.  Tossing one to the young salamander, you tell her to come get some."
        );
        ...
        this.outputText(
            " daughter on her toes.  She learns quickly, though, and soon she hardly needs reminding to keep her shield up and stance braced against Helia's overwhelming assaults."
        );
    ...
    private helSpawnStopFucking(): void {
        ...
        // If No Hel Love:
        if (this.flags[kFLAGS.HEL_LOVE] != 0)
            this.outputText(
                "  You don't want to be a whore like your mother, do you?  The girl that everyone's had a ride with."
            );
        // if HelLove:
        if (this.flags[kFLAGS.HEL_LOVE] == 1)
            this.outputText(
    ...
    public helspawnAllGrownUp(): void {
        ...
        this.outputText(
            "like a woman.  The time to raise her, to shape her development, is over.  You can only hope you've done a good enough job to keep her safe in this hellish world; to give her sound judgment and the abilities she'll need to protect herself in the years and adventures to come."
        );
    ...
    private talkToHelspawn(): void {
        ...
        if (this.flags[kFLAGS.HAD_FIRST_HELSPAWN_TALK] == 0) {
            ...
            if (this.flags[kFLAGS.HELSPAWN_PERSONALITY] >= 50)
                this.outputText(
                    "  Even if she wants to be just like mom, she shouldn't be bringing monsters home.  Some of them may be dangerous, and she's not a warrior quite like you and Helia yet."
                );
            else
                this.outputText(
                    "  She should know better than to bring monsters back.  She's not her mother; lust doesn't have to dominate her life like that."
                );
            ...
            if (this.flags[kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText(
                    "Of course, as her father, you could always say it's your duty to keep her happy..."
                );
            else
                this.outputText(
                    "Of course, as her adoptive father, you could always say that you love her in a different, more intimate way."
                );
        ...
        // {Needs Rath at camp]
            ...
            if (this.amilyScene.amilyFollower() && !this.amilyScene.amilyCorrupt())
                this.outputText(
                    "Little Amily's solution was makeshift at best, and the children are beyond my reach to study.  Still.  "
                );
            this.outputText(
                'Imagine whole legions of children reared and raised in the time it takes a goblin to do the same. We might have a fighting chance for once, with numbers to match the demons.</i>"'
            );
        ...
        // {Isabella must be at camp}
            ...
            this.outputText(
                "Unfortunately, there doesn't seem to be anything in particular to talk about at the moment.  The two of you spend the time in companionable quiet, making smalltalk."
            );
            this.doNext(this.camp.returnToCampUseOneHour);
        }
    }
    ...
    private helSpawnSureMilkHerLater(): void {
        this.clearOutput();
        this.outputText(
            "You chuckle, telling her to let the poor girl sleep.  There'll be plenty of milk later."
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private helSpawnMilkHerNow(): void {
        this.clearOutput();
        this.outputText(
            '"<i>Oh, no.  You\'re not getting out of your chores that easy, kiddo.  In you go,</i>" you say, giving her a little push toward the edge of the pool.'
        );
    ...
    public beatUpYourDaughter(): void {
        ...
        if (this.flags[kFLAGS.HELSPAWN_PERSONALITY] >= 50 && this.monster.lust > 99) {
            this.outputText(
                '"<i>N-no more...</i>" the slutty little salamander moans, slumping down to the ground, arms wrapping around herself.  "<i>Fuck, you\'re sexy... so horny...</i>" she groans, hands slipping down to her soaked bikini bottom.'
            );
            ...
            // If No Incest:
            if (this.flags[kFLAGS.HELSPAWN_INCEST] == 0)
                this.outputText(
                    "  You wash your hands of the defeated slut and head back to camp, leaving her to work through her tension herself."
                );
            else {
                this.outputText(
                    "  You reach down and give your lovely, lusty daughter a pat on her expansive rear, telling her she'll always look her best with her ass in the air, begging for "
                );
                if (!this.player.hasCock()) this.outputText("sex");
                else this.outputText("your cock");
                this.outputText(
                    "... and that if she's lucky, you might tend to her when you've cooled off."
                );
            }
        } else {
            this.outputText(
            ...
            this.outputText(
                ".  You chuckle and ruffle her hair, \"<i>C'mon, kiddo, let's get some food in you.</i>\""
            );
            this.outputText(
    ...
    public hakonAndKiriComeVisit(): void {
        ...
        this.outputText(
            "As you're returning to camp, you notice Helia running around like a chicken with her head cut off, fussing about damn near everything in her part of the camp"
        );
        if (this.camp.companionsCount() > 1)
            this.outputText(" and everyone else's too, much to their chagrin");
        this.outputText(
            ". As she's furtively polishing off her giant still, trying to get the dingy old thing to shine, you approach and clear your throat. She gives a sharp yelp and spins around, but seems to relax as she sees it's just you."
        );
        this.outputText(
    ...
    private goHuntingBitches(): void {
        ...
        this.spriteSelect(68);
        this.outputText(
            '"<i>Sure,</i>" you say, quickly earning approving nods from Hakon and Helia.'
        );
        this.outputText(
    ...
    private noHuntingBitches(): void {
        ...
        this.spriteSelect(68);
        this.outputText(
            '"<i>I\'ll pass,</i>" you say with a laugh, earning a shrug from the salamanders.'
        );
        this.outputText(
