...
export class SophieBimbo extends NPCAwareContent {
    ...
    */
    public sophieSprite(): void {
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00283] == 0) this.spriteSelect(83);
        else this.spriteSelect(53);
    }

    public bimboSophie(): boolean {
        return (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00283] == 0 && this.flags[kFLAGS.SOPHIE_DEBIMBOED] == 0);
    }
    ...
    public sophiePregChance(): void {
        ...
        if (SophieBimbo.rand(4) == 0 || this.player.cumQ() > SophieBimbo.rand(1000)) {
            this.pregnancy.knockUpForce(PregnancyStore.PREGNANCY_PLAYER, PregnancyStore.INCUBATION_HARPY);
        }
    }
    ...
    private acceptBimboSophie(): void {
        ...
        if (this.pregnancy.isPregnant) this.pregnancy.knockUpForce(this.pregnancy.type, Math.floor(this.pregnancy.incubation * 1.75));
        ...
        if (this.player.canFly()) this.outputText(" and unable to bring your wings to bear with arms pinning them to your back", false);
        this.outputText(".\n\n", false);
        ...
        if (this.player.findStatusAffect(StatusAffects.CampRathazul) >= 0) {
        ...
        else if (this.flags[kFLAGS.AMILY_FOLLOWER] > 0 && this.flags[kFLAGS.AMILY_BLOCK_COUNTDOWN_BECAUSE_CORRUPTED_JOJO] == 0) {
            this.outputText("  Afterwards, she offers to lick Amily's twat, if Amily will do the same to her.  Amily ", false);
            if (this.flags[kFLAGS.AMILY_FOLLOWER] == 1) this.outputText("flushes hotly and denies the bimbo's request with a terse 'no'.", false);
            else this.outputText("flushes hotly and wiggles her hips Sophie's way.  The slutty, corrupted mouse and Sophie will clearly be helping to sate each other's needs in your absence.", false);
        }
        else if (this.monk >= 5 && this.player.findStatusAffect(StatusAffects.NoJojo) < 0 && this.flags[kFLAGS.JOJO_DEAD_OR_GONE] == 0) {
            ...
            if (this.isabellaAccent()) this.outputText("\"<i> Nein!  But you can drink mein milk from time to time.</i>\"");
    ...
    public sophieCampLines(): void {
        ...
        if (choice == 0) this.outputText("Sophie is sitting by herself, applying yet another layer of glittering lip gloss to her puffy bimbo lips.", false);
        else if (choice == 1) this.outputText("Sophie is sitting by herself, idly diddling her twat and noisily moaning.  She keeps looking your way, hoping you'll approach.", false);
        else if (choice == 2) this.outputText("The beach-blond harpy is preening herself with a vapid, brainless look plastered on her face.  Her puffy, bee-stung lips are slightly parted and lacquered with a heavy layer of golden gloss.", false);
        else this.outputText("Your personal bimbo, Sophie, is playing with her breasts, touching and caressing the heavy orbs in between sighs of pleasure.  She keeps glancing your way, hoping you'll join her.  She's insatiable!", false);
        this.outputText("\n\n", false);
    }
    //Approach Texts
            ...
            if (output) {
                ...
                if (this.sophieIsInSeason() && this.player.hasCock()) {
                    ...
                    if (choice == 0) {
                        ...
                        if (this.player.hasCock()) this.outputText(" cock-pillows slurping around your member.", false);
                        else if (this.player.hasVagina()) this.outputText(", fuckable pussy-pillows crushing against your quim.", false);
                        else this.outputText(", fuckable pillows locking you in their embrace.", false);
                        if (this.player.cor < 33) this.outputText("  You find yourself nodding and blushing heavily as you drink in the bimbo's body.", false);
                        else if (this.player.cor < 66) this.outputText("  You find yourself nodding and giving a lewd grin as you drink in the bimbo's body.", false);
                        else this.outputText("  You nod vigorously, giving the harpy a lecherous leer as you take in her body.", false);
    ...
    private sophieBimboAppearance(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0) this.outputText("so immense they would drag her to the ground if she tried to fly, a sexy, lingering aftereffect of the draft you gave her.  The wobbly bimbo-tits look to be about F-cups.");
        else this.outputText("unusually large.  The buxom harpy does seem slightly encumbered by them, but still capable of flight.  Her breasts look to be about DD-cups, nice and big enough for a soft squeeze or rough tit-fuck.");
    ...
    private stopHarvest(): void {
        ...
        else this.outputText("“<i>I only wish I was good with numbers and things,</i>” Sophie sighs wistfully, picking at her bellybutton. “<i>Then I’d know when to give you my eggs and, and when to give them to the doggie. Whatever you say anyways, babe!</i>”");
    ...
    public bimboSophieLustStickSurprise(): void {
        ...
        if (select == 0) {
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.hasVagina()) this.outputText("vulva, sucking at your clitoral hood.  Those gold, slobbery pussy-lickers look good on your groin, and you find yourself releasing your wetness from her oral attentions.  It might be time to fuck her soon...", false);
                else this.outputText("smooth groin, eventually licking at your [asshole].  Those gold, slobbery lickers look good pressed against you.  It might be time to fuck her soon...", false);
            }
            this.sophieScene.luststickApplication(5);
        }
        else {
    ...
    private bimboSophieLicksRugs(): void {
        ...
        if (this.player.cor < 33) this.outputText("You nod nervously, blushing hotly at the thought of your bimbo-slut's fat lips kissing and lapping at your slit.", false);
        else if (this.player.cor < 66) this.outputText("You nod and smile, blushing a bit in anticipation of feeling your bimbo-slut's fat, pussy-licking lips against your slit.", false);
        else this.outputText("You confidently smile and scoot your " + this.hipDescript() + " forward, anticipating the feeling of your bimbo-bitch's fat, pussy-licking lips on your slit.", false);
        ...
        if (this.player.clitLength < 3) this.outputText("hums on your clit and doubles the speed of her licking while you watch her finger-fucking her sloppy cunt.", false);
        else this.outputText("pumps on your clit with her hand and doubles the speed of her lashing tongue while you watch her finger-fucking her sloppy cunt.", false);
        ...
        if (!this.player.hasCock()) this.outputText("  It's a good thing you don't have a penis!", false);
        else this.outputText("You groan as your groin burns with desire, filling your " + this.multiCockDescriptLight() + " with blood.  Images of yourself relentlessly fucking your bimbo bride pregnant over and over again fill your mind.  You shudder and blush, trying to resist the artificial needs pounding through your body, but you realize your body is ready.", false);
        this.outputText("\n\n", false);
    ...
    private bimboSophieSixtyNineAfterCunnilingus(): void {
        ...
        if (!this.player.hasCock() || this.player.cockThatFits(this.sophieCapacity()) == -1) {
            ...
            if (this.pregnancy.event >= 2) this.outputText("Her pregnant belly rests against your middle, untouched by the rough fall.  ");
            ...
            if (this.player.clitLength >= 3) this.outputText(", even pausing to jack it off like a penis", false);
            ...
            if (this.pregnancy.event >= 2) this.outputText(", egg-swollen belly smushing between you");
        ...
        //SixtyNine Continuation - DUDES
            ...
            if (this.pregnancy.event >= 2) this.outputText("Her gravid belly bumps up against your own, somehow untouched by the rough-and-tumble fall.  ");
            this.outputText("How did she do that?  Your questions fade away as you look up and spot your target - the cum-slicked delta of Sophie's cunt, so moist it seems to fog the air, beckoning you to plunge your tongue inside and taste it.\n\n", false);
            ...
            if (this.player.cumQ() >= 500) {
                ...
                if (this.player.cumQ() >= 1000) this.outputText("  After a moment of this, the full-bellied harpy pulls back and lets you paint the remainder over her face, hair, and mountainous breasts.", false);
            }
            this.outputText("\n\n", false);

            this.outputText("Sophie gives an airheaded giggle and jumps up, ignoring the slosh of your sexual fluids in her belly");
            if (this.pregnancy.event >= 2) this.outputText(" and the way her egg-stuffed womb jiggles");
    ...
    private buttFuckBimboSophie(): void {
        ...
        if (this.pregnancy.event >= 2) this.outputText("  Just like her breasts, her gravid tummy sways a little as well, plush with the weight of the egg you've given her.");
        ...
        if (this.player.balls > 0) this.outputText("Your balls seize up at Sophie's request, and you swear you can actually hear the fluid churning and sloshing of your cum before it burns a path of warmth through your body.", false);
        else this.outputText("Your insides seem to seize up at Sophie's request, and you swear you can actually feel the fluid churning a path of warmth through your body.", false);
        ...
        if (this.player.cumQ() >= 500) {
            ...
            if (this.player.cumQ() >= 1000) this.outputText(", filling her belly with spooge", false);
    ...
    private fuckBimboSophiesTits(): void {
        ...
        if (this.pregnancy.event >= 2) this.outputText("Her swollen tummy pushes against your [legs] as she assumes the position, the weighty egg-distorted lump pressing against you.  ");
        ...
        if (this.player.cocks[x].cockThickness < 8) this.outputText("completely surround yourself", false);
        ...
        if (this.player.balls > 0) this.outputText("all over your balls whenever she needs a break, and you feel your " + this.ballsDescriptLight() + " growing heavier by the moment.", false);
        else this.outputText("all over your taint and asshole, and you feel your body churning, building up more seed for your moronic mate.", false);
    ...
    private beBimboSophiesSugarDaddy(): void {
        ...
        var x: number = this.player.cockThatFits(this.sophieCapacity());
        if (x < 0) x = this.player.smallestCockIndex();
        if (this.player.hasItem(this.consumables.OVIELIX)) this.player.consumeItem(this.consumables.OVIELIX);
        else if (this.inventory.hasItemInStorage(this.consumables.OVIELIX)) this.inventory.consumeItemInStorage(this.consumables.OVIELIX);
    ...
    private rideDatSophieVag(nice: boolean = false): void {
        ...
        if (nice) {
            ...
            if (this.pregnancy.event >= 2) this.outputText("  Her pregnancy-imbued middle doesn't really help, either.");
            ...
            if (this.player.balls > 0) this.outputText("your [balls] bouncing and slapping against what parts of Sophie's bubble butt they can reach, ");
        ...
        if (this.player.cockTotal() == 1) {
            ...
            //{if (cocks = 1) and (cumMedium = true)} 
                ...
                if (this.pregnancy.event >= 2) this.outputText(" (or at least all over her channel, since her womb is bound up with your egg)");
            ...
            //{if (cocks >= 2) and (cumHigh = true)} 
                ...
                else if (this.player.cockTotal() > 3) this.outputText(", along with the rest of your cocks, your entire mass of lengths getting your seed all over her.");
        ...
        if (this.pregnancy.event >= 2) this.outputText("resting your head on her gravid tummy and smiling to yourself.");
    ...
    private sophieImpregnationSex(): void {
        ...
        if (this.player.cockTotal() > 1) this.outputText(", the rest of your lipstick-smeared shafts slipping and sliding between the soft, lube-slicked thighs");
        ...
        if (this.player.balls > 0) this.outputText(", and your [balls] begin to rhythmically pulse in your [sack]");
        ...
        if (this.player.cockTotal() > 1) this.outputText("  Ropes of creamy spunk drizzle over the ground and the underside of Sophie's tits, but the lust-drunk harpy doesn't seem to mind any more than you do.");
        this.outputText("  Her hungry twat drinks down the seed with gusto, drawing it out of you even as it milks you for more.");
        if (this.player.cumQ() >= 500) this.outputText("  You give her exactly what she wants, drowning her pussy with jism.");
        if (this.player.cumQ() >= 1000) this.outputText("  Alabaster spooge oozes out of her lips after you stuff her womb full, dripping down your [legs] and her own feathery thighs.");
        if (this.player.cumQ() >= 2000) this.outputText("  The ground quickly becomes a salty quagmire that Sophie's hands are sinking into.");
        if (this.player.cumQ() >= 5000) this.outputText("  Soon, those droplets become thick gouts, as your immense virility asserts itself.  You hold her there, letting her belly balloon underneath you as you forcefully inseminate her, flooding her with hot seed.");
        ...
        if (y >= 0) this.outputText("  A sinful tightness clenches your " + this.cockDescript(y) + " at the same time.  You accidently started double penetrating her!  The sloppy vaginal heat around your second member is enough to make you forget that it was even an accident.");
    ...
    private giantCocksImpregnateSophie(): void {
        ...
        if (this.player.cumQ() >= 500) this.outputText("  In no time, Sophie's belly begins to form into a bump, and the pressure leaves more and more of your seed to be wasted on the bimbo's thighs.");
        if (this.player.cumQ() >= 1000) this.outputText("  Your intense ejaculations quickly balloon that petite bump into a rounded dome.  Torrents of spunk run out of her around your tip, fountaining slightly with each fresh dose.  You simply can't pack any more cum into her, and the excess puddles around her plush bottom.");
    ...
    private yesSophieSleepWith(): void {
        ...
        switch (this.pregnancy.event) {
            case 1: this.outputText("burgeoning"); break;
            case 2: this.outputText("swollen"); break;
            case 3:
            case 4: this.outputText("huge, gravid"); break;
    ...
    public sophieFenCraftedSex(morning: boolean = false): void {
        ...
        //{Regular Sex}
            ...
            if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150) this.outputText("pregnant ");
        ...
        if (this.player.balls > 0) this.outputText("  Sophie's immense backside slides over your [balls] each time she bottoms out, her tail feathers tickling at the bottom of your [sack].");
        ...
        if (this.pregnancy.isPregnant) {
            ...
            if (this.player.cumQ() >= 500) this.outputText("  You cum so hard that torrents of spooge wash out of her slit, her womb obstructed by the egg you made with her.");
        }
        if (this.player.cumQ() >= 2000) this.outputText("  The oozing spunk soaks you thoroughly, and Sophie's thighs become matted with the gallons of gunk that squirts out of her lips.");
    ...
    public fuckYoPregnantHarpyWaifu(morning: boolean = false): void {
        ...
        //REGULAR FUCK
            ...
            if (this.player.lust > 50) this.outputText("feeling its firmness.  \"<i>Wow, you're so hard already, [name]!</i>\" she comments.");
            else this.outputText("slowly stroking it until it begins to pulse to life, thickening in her hand.");
        ...
        if (this.player.balls > 0) this.outputText("[balls], where they hang in thick drops before falling to the ground,");
        ...
        if (this.player.cumQ() >= 500) {
            ...
            else if (this.player.cumQ() < 2000) this.outputText("soak your blankets and the ground below");
            else if (this.player.cumQ() < 5000) this.outputText("soak your blankets and form a giant puddle below, leaving you feeling like you're on a waterbed made of spunk.");
            else this.outputText("soak your blankets and create a lake the two of you sink partway into, surrounded by muddy, cum-flavored mud.");
        }
        ...
        if (morning) this.outputText(" when you go wash up to get dressed.  It's going to be a good day.");
    ...
    private sophiePreggoTitJobs(): void {
        ...
        if (this.player.cocks[x].cockLength > 30) this.outputText("the underside of your immense erection");
        ...
        if (this.player.cocks[x].cockLength > 30) this.outputText("  Sophie pulls back long enough to gasp, \"<i>You're so long, I can't even take the tip!</i>\"");
    ...
    private goHogWildOnSophieBewbs(): void {
        ...
        if (this.player.cocks[x].cockLength <= 30) this.outputText(this.player.cockHead(x) + " pushes into through her startled cock-pillows, muffling her more effectively than any gag.  She immediately sucks on it, a happy look in her eyes.  The bimbo seems to want nothing more than to lie there and polish your rod.");
        else this.outputText(" immense rod smacks across her face, too long to try to jam down her throat.  It completely covers her face, smothering her features with rigid, veiny dickflesh.  She immediately begins to lavish the underside with licks and long wet kisses, aided by her plus-sized bimbo lips.  When her eyes peek out from under your " + this.cockDescript(x) + ", they seem placid and happy.  It seems the slut wants nothing more than to lie there and service your cock.");
        ...
        if (this.player.balls > 0) this.outputText(", cupping your [balls] with a hand and massaging them to aid your ejaculation");
        ...
        if (this.player.hasKnot(x)) this.outputText("  Your knot inflates to a ludicrous degree, squeezed down on from all sides by slick, gold-painted tits, happy to be engulfed by warm flesh.");
        ...
        if (this.player.cumQ() > 1000) this.outputText("  Again and again, you continue to paint her white.  Your orgasm seems almost without end as you ejaculate.  Sophie's face is soaked with it, and her breasts have become glazed mountain-peaks.");
        if (this.player.cumQ() > 2500) this.outputText("  By the time you finish, the stuff is puddled under her.  The best your harpy pet can manage is a spermy smile as she languishes in your seed.");
    ...
    private letSophieMilkYoDick(): void {
        ...
        if (this.player.balls > 0) this.outputText("Your [balls] drag across her pregnant belly as she goes to work, but you don't mind in the slightest.  There's something erotic about having them bumping up against the fruit of your union.  ");
        ...
        if (this.player.cocks[x].cockLength <= 30) {
            ...
            if (this.player.cumQ() < 250) this.outputText(" swallows it without complaint, her eyes twinkling mirthfully as she suckles down your small load.  Surprisingly, you dump a few more pulses into her, each weaker than the last.  The bird-woman drinks it with ease, never looking away from you.");
            else if (this.player.cumQ() < 500) this.outputText("'s cheeks bulge from the size of your load, but she manages to get it down with a big gulp.  Surprisingly, you dump a few more jets of thick cream into her waiting gullet, each weaker than the last but big enough to make it hard for her to swallow.  She never looks away from you as she takes it.");
            else if (this.player.cumQ() < 1000) this.outputText("'s cheeks bulge cartoonishly at your immense deposit, cream escaping from the corners of her mouth as her poor mouth floods.  Her throat bobs ludicrously, trying to keep up with the flow, but when you follow up that virile blast with several smaller, still potent deposits, she gives up and lets the jizz run down her lip and face, dripping onto her tits.  Through it all, her eyes never leaves yours.");
            else {
        ...
        //On top of her.
            ...
            this.outputText("  Sophie");
            if (this.player.cumQ() < 250) this.outputText(" giggles happily when the cum jets into the air and down atop her head, moaning against your dick while it seeps through her platinum feathers.  Throughout it all, she licks and sucks on your shaft, milking out every drop and never looking away.");
            else if (this.player.cumQ() < 800) this.outputText(" moans when your heavy deposits splatter into her hair, dripping through the downy blond feathers in a messy web.  Throughout it all, she sucks and licks at you, polishing your " + this.cockDescript(x) + " until she's sure every single drop of jizz has been expelled onto her curvy frame.");
            else {
    ...
    public sophieBirthsEgg(): void {
        ...
        if (this.bimboSophie()) this.outputText("Come here, [name]!  I... whooooaaaa... I wanna like, hold your hand when the egg comes out!");
        else this.outputText("Come here, [name]!  I... whoooaaaa...  I need something to hold on to while this comes out!");
        this.outputText("</i>\"");

        if (this.player.cor < 33) this.outputText("  You sit down next to her, and figuring this must be normal for her, you hold her hand with one arm and grope at her free breast with the other.");
        else if (this.player.cor < 66) this.outputText("  You sit down next to her with a sigh.  Well, at least you can grope her tit with your other hand!");
        else this.outputText("  You plop down next to her, but ignore her proffered hand for one of those juicy melons on her chest.  Grinning, you can't help but think that this is a far more tender thing to hold anyway.");
        ...
        if (this.flags[kFLAGS.SOPHIE_ADULT_KID_COUNT] == 0) this.outputText("  Can you handle having another harpy living in your camp?\n");
    ...
    public sophiesEggHatches(): void {
        ...
        if (this.flags[kFLAGS.SOPHIE_ADULT_KID_COUNT] < 4) {
            ...
            if (this.flags[kFLAGS.SOPHIE_ADULT_KID_COUNT] == 0) {
                ...
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0) this.outputText(", though her lips are a little larger than you'd think was normal - maybe she inherited it from her mom?");
                else this.outputText(".");
            ...
            //-Not that curvy, but has human feet and purple feathers. (violet eyes)
                ...
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0) this.flags[kFLAGS.DAUGHTER_THREE_BIMBO] = 1;
            }
            //Fourth Harpy:
            //-Curvy like Sophie, but with well-developed wings and extra-soft feathers (WINGJOBS).  Pink plumage.  (blue eyes)
                ...
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00282] > 0) this.outputText(" like her mother used to have before her bimbofication");
        ...
        //Every Other daughter*
            ...
            if (this.bimboSophie()) this.outputText("\"<i>Oohhhhh, just look at you!  My baby girl is sooo cute!  Soooo totally fluffy and like, suuuuper soft!</i>\"");
            else this.outputText("\"<i>Oohhhhh, you're so cute!  My baby girl is sooo cute! Oh, the boys will be all over you when you grow up, I just know it!</i>\"");
        }
        ...
        if (this.bimboSophie()) this.outputText("\"<i>Oh dearie, there there, like, calm down, sweetie.  Don't worry, Momma Sophie's here.</i>\"  The matronly harpy gently hugs the squirming fluff-ball into her big, soft breasts, her hands gently stroking her fussy daughter's feathery hair.");
        else this.outputText("\"<i>There there, calm down, baby.  Momma Sophie's here...  I'm here.</i>\"  The matronly harpy gently hugs the squirming fluff-ball into her big, soft breasts, her hands gently stroking her fussy daughter's feathery hair.");
    ...
    public sophieKidMaturation(): void {
        ...
        if (this.bimboSophie()) this.outputText("  From the inquisitive look on her face and spark of intelligence in her eyes, it seems that she hasn't lost her mind to her inner bimbo.");
    ...
    private watchIzmaSophie(): void {
        ...
        if (this.player.hasCock()) {
            if (this.player.cumQ() >= 1000) this.outputText(", leaving you in a puddle of your own slimy mess");
        }
