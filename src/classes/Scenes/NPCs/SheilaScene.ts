...
export class SheilaScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    public constructor() {
        ...
        this.pregnancy = new PregnancyStore(
            kFLAGS.SHEILA_PREGNANCY_TYPE,
            kFLAGS.SHEILA_PREGNANCY_INCUBATION,
            0,
            0
        );
    ...
    private sheilaPreg(reducedChance: boolean = false): void {
        ...
        if (SheilaScene.rand(100) <= chance)
            this.pregnancy.knockUpForce(
                ...
                PregnancyStore.INCUBATION_SHIELA
            );
    }
    ...
    public sheilaCup(): string {
        ...
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 290)
            return "'so big it makes you say' OO-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 300) return "P-cup";
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 310 && this.player.cocks.length > 0)
        ...
        else if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 390)
    ...
    public sheilaEncounterRouter(): void {
        ...
        if (this.flags[kFLAGS.SHEILA_DEMON] == 1) this.flags[kFLAGS.SHEILA_XP] = 4;
        ...
        if (this.flags[kFLAGS.SHEILA_DEMON] == 0) {
            ...
            else if (this.flags[kFLAGS.SHEILA_XP] == -3 || this.flags[kFLAGS.SHEILA_XP] == -4)
            ...
            //XP2: Familiarizing (Sheila XP = 2; or Sheila XP = 3 AND time =/= 20:00 and demon sheila = 0):
                ...
                this.flags[kFLAGS.SHEILA_XP] == 2 ||
                (this.flags[kFLAGS.SHEILA_XP] == 3 && this.model.time.hours != 20)
            )
                this.sheilaGettingFamiliar();
            //XP3: Sexy Time (sheila xp = 3 AND time = 20:00 and demon sheila = 0):
            else if (this.flags[kFLAGS.SHEILA_XP] == 3 && this.model.time.hours == 20)
    ...
    private sheila1stEncStayHidden(): void {
        this.clearOutput();
        this.outputText(
            "You regulate your breathing and hold yourself still to avoid rustling anything softly, waiting for the creature to finish its business and leave."
        );
    ...
    private sheila1ndEncLookCloserPtII(): void {
        ...
        if (this.player.lib >= 50)
            this.outputText(
                '  Noting you still checking out her body, she smirks and says, "<i>Enjoying your lookie, then?  Up here, cobber,</i>" causing you to snap your head up sheepishly.'
            );
        ...
        if (this.player.short != "Sheila")
            ...
            this.outputText(
                "  \"<i>You too, eh?  Sheila's what my mates call me for a nickname.  Don't suppose you got yours from a bunch of adolescent-minded wankers, though.</i>\""
            );
        ...
        if (this.player.demonScore() >= 4)
            this.outputText(
                "  I mean, take a squizz at yourself.  It's like you're not even trying to hide it; I've seen imps that look more like normal people."
            );
        this.outputText(
            '  Forget it.</i>"  You deny the accusation, but she continues to glare at you.'
        );
    ...
    private sheila1ndEncLookCloserPtIILeave(): void {
        this.clearOutput();
        this.outputText(
            '"<i>Good onya.  Maybe I\'ll see you around.</i>"  With that, you take your leave of the strange woman.'
        );
        //set sheila xp = 1
    ...
    private sheila1ndEncLookCloserPtIITalkLeave(): void {
        this.clearOutput();
        this.outputText(
            "Wordlessly, you get up and back away from the woman... though not without a dirty glance.  She follows you with her eyes until you judge yourself far enough away to turn your back to her."
        );
        //go to camp
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private sheilaApology(): void {
        this.clearOutput();
        this.outputText(
            "As you search the plains for god-knows-what, you catch your [leg] on something; a rustling in the brush below you is the only warning you get before a cleverly hidden snare closes on it!"
        );
    ...
    private apologyAvoidSheila(): void {
        this.clearOutput();
        this.outputText(
            "You shake your head at the leery girl, and tell her you'd be just as happy as she would if you never saw each other again."
        );
        this.outputText(
    ...
    private apologySheilaSayNothing(): void {
        this.clearOutput();
        this.outputText(
            "You decide to keep your own counsel for now, folding your arms defensively and frowning."
        );
    ...
    private sheilaIsSorrySheRapedYou(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.KnowsArouse) >= 0)
    ...
    private sheilaIsSorryButLeaveMeAlone(): void {
        this.clearOutput();
        this.outputText(
            'You shake your head and turn away, dismissing Sheila with a pointed gesture.  "<i>H-hey!</i>" the girl calls angrily from behind you.  "<i>Dammit, I said I was sorry, you bastard!  Screw you!  See if I talk to you again!</i>"'
        );
        //set sheilapreg = -1
        this.flags[kFLAGS.SHEILA_DISABLED] = 1;
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private sheilaPologyFight(): void {
        this.clearOutput();
        this.outputText(
            "Saying nothing, you raise your [weapon] and take a swing!  Sheila starts a bit and dodges just in time, then with a look of resignation, raises her fists as well.  \"<i>That'll be right, I guess.  For what it's worth, I really am sorry.</i>\""
        );
    ...
    private sheilaPologyCastArouse(): void {
        ...
        this.fatigue(15, 1);
        this.outputText(
            "You nod at the woman and tell her that you forgive her, even as the gears of revenge turn in the dark corners of your mind.  As she smiles and begins to babble in relief, you focus on her slender body and recite under your breath the first of the formulae that will leave her a gibbering, begging mess."
        );
    ...
    private castArouseAndLeaveSheila(): void {
        this.clearOutput();
        this.outputText(
            "You shake your head sadly.  \"<i>I'm sorry, I haven't the time right now.</i>\""
        );
    ...
    private castArouseAndLetHer(): void {
        this.clearOutput();
        this.outputText(
            "As soon as you nod, the girl bounds to her feet and jumps you, driving you slightly downward in her ardor."
        );
    ...
    private sheilaReallyMad(): void {
        this.clearOutput();
        this.outputText(
            "A rustle in the bush claims your attention, and you turn your head to see Sheila, standing up suddenly.  Her eyes narrow when she recognizes you, and she takes off running!"
        );
        ...
        if (this.flags[kFLAGS.SHEILA_CORRUPTION] >= 90)
            this.outputText(
                "It's so hard to remember myself anymore, and the taint you've put in my body goes crazy when you touch me.  Do you want me to get on my hands and knees?</i>\"  The woman lowers herself to the ground.  \"<i>I beg you.  "
            );
        this.outputText("Please, please leave me alone.");
        if (this.flags[kFLAGS.SHEILA_XP] == -3)
            this.outputText(
                "  I know you... you're not as bad as the rest of the monsters out here, so... please."
            );
        this.outputText('</i>"');
        //[Stand][Leave]
        this.menu();
    ...
    private sheilaReallyMadStandGround(): void {
        ...
        //(silly mode)
            ...
            this.outputText(
                "Throwing the bundle to the side dramatically, you call the name of your stand!  Sheila's eyes widen as your body surges with renewed energy, and she jumps back as a ghostly other self materializes next to you."
            );
            this.outputText(
    ...
    private sheilaReconcile(): void {
        this.clearOutput();
        this.outputText(
            '"<i>Oy, it\'s you,</i>" sings out a voice behind you.  "<i>Back again?</i>"'
        );
    ...
    private sheilaReconcileDunWanna(): void {
        this.clearOutput();
        this.outputText(
            "Raising your hands in a palms-out gesture, you decline.  Sheila colors a bit, misinterpreting your reluctance.  \"<i>Hey, it's not like I'm cracking onto you or anything.  I was just looking for a reason to eat half a rabbit myself, is all.</i>\""
        );
    ...
    private sheilaReconcileKay(): void {
        this.clearOutput();
        this.outputText(
            'Some fresh meat does sound pretty tempting.  You nod at the woman and she climbs to her feet.  "<i>Beaut!  Do me the favor and fossick about for some tinder.</i>"'
        );
        //--Next--
        this.menu();
    ...
    private sheilaReconcileKay2(): void {
        this.clearOutput();
        this.outputText(
            'Soon enough you\'ve got a firepit going in a small clearing.  "<i>Ahh, classic bush theater,</i>" Sheila says, admiring it.  The woman dextrously spits two liberated and skinned rabbit quarters on a long stick and twirls them over the lapping flame, and soon the air is full of the sizzle and pop of meat juices dripping on the hot stones and the simple tune your cook hums.  You stare at '
        );
        if (this.player.lib < 50) this.outputText("the beckoning hunks of meat");
        else
            this.outputText(
                "her rising and falling breasts under the pretext of watching her work"
            );
        this.outputText(
            ', until she happens to look up and catch your eye.  "<i>Sorry, no parsley,</i>" she says, breaking into an obliviously happy smile.  Seems like her temperament preternaturally suits this lifestyle.'
        );
        ...
        this.outputText(
            ".  We trade our goods in prearranged op shops and dead drops but avoid bringing outsiders into our own settlements, even when they're right corkers.</i>\""
        );
        ...
        this.outputText(
            ' make us a little hornier, and evil buggers make us a bit more evil.  Our bodies tend to change on their own to reflect how tainted we are... which is as much as saying there are a sad lot among us who flirt with demonic energy to up our sizes to suit our egos.  But versus the sexual appetite and limitless rapacity of the demons themselves...?</i>"'
        );
    ...
    private sheilaFriendlyHerPeoples(): void {
        this.clearOutput();
        this.outputText(
            "You lie down on the grass yourself, balance the parcel on your stomach, and ask about her people."
        );
        this.outputText(
        ...
        //(lib >=50)
            ...
            this.outputText(
                ' - er... fuck <b>you!</b></i>"  This last exclamation comes in response to your pealing laughter.  "<i>Wanker!</i>"'
            );
            this.outputText(
    ...
    public sheilaXPThreeSexyTime(): void {
        this.clearOutput();
        this.outputText(
            'You prowl through the twilit grasslands, lazily looking for anything interesting before the bleak, red moon brings on the night and its restrictions.  Nothing much catches your eye, except for a rounded shape cast in silhouette against the horizon.  Initially taking it for a rock, you\'re surprised when it shivers at the sound of your approach!  It unbends and raises a head, turning toward you and revealing the flushed face of the bush girl, Sheila.  Her eyes quickly change from terror to relief as they settle on you, and she cries out.  "<i>[name]!  Oh thank god; please help me!</i>"'
        );
        this.outputText('\n\n"<i>What\'s wrong?</i>"');
    ...
    private sheilaXPThreeSexyTimeDitchHer(): void {
        this.clearOutput();
        this.outputText(
            'You shake your head, pulling away from the woman and telling her she\'ll be fine.  "<i>No!</i>" she shrieks.  "<i>You gotta help me!</i>"'
        );
    ...
    private sheilaXPThreeSexyTimeSex(): void {
        this.clearOutput();
        this.outputText(
            "Sheila's eyes widen with your smile, and she pulls back from you.  \"<i>That's, um...</i>\""
        );
    ...
    private sheilaXPThreeSexyTimePostSexLetHerBe(): void {
        this.clearOutput();
        this.outputText(
            "Pulling away from you, Sheila gathers her clothing and departs, looking satisfied.  The glance she gives you over her shoulder is even a little warmer than before."
        );
        //i had snoo-snoo!
        this.flags[kFLAGS.SHEILA_XP] = 4;
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private shielaXPThreeSexyTimePostSexStay(): void {
        ...
        this.flags[kFLAGS.SHEILA_XP] = 4;
        this.outputText(
            'You grab her tail, provoking a curious, but not discouraging, look from the woman who was planning to spend the night alone.  "<i>What is it, [name]?</i>"'
        );
    ...
    private shielaXPThreeSexyTimePostSexStayII(): void {
        ...
        if (this.player.hasCock() && this.player.cockThatFits(32) >= 0) {
            this.outputText(
                'Her hand slips down to your groin and, overcoming its trepidation, grabs your [cockFit 32] and begins to pump languidly, slowly stimulating blood back into it.  "<i>I don\'t know what\'s come over me,</i>" she says, giggling.  "<i>Maybe I\'m just greedy, but... I want you again.</i>"  She pushes you'
            );
            //[(horse)]
            ...
            this.outputText(
                ', positioning herself atop your crotch and guiding your tip to her pussy.  It pokes through the labia slightly, welcomed with warm wetness.  "<i>Is... this ok, [name]?  Can I?</i>"'
            );
            ...
            if (!this.player.isTaur())
                this.outputText(
                    "Your hands squeeze her hips almost of their own volition, helping her slam down with force, and her head rolls back on her neck.  "
                );
            this.outputText("Her ");
            //[(sheila corruption < 30)]
            if (this.flags[kFLAGS.SHEILA_CORRUPTION] < 30)
                this.outputText(
                    "little breasts rise and fall with increasing frequency atop her ribcage as her pace picks up and her breaths come short and shallow."
                );
            else if (this.flags[kFLAGS.SHEILA_CORRUPTION] > 60)
                this.outputText(
                    "huge tits jiggle magnificently as she rocks, nearly slapping her in the face as she plunges down and then falling back into place with waves of rippling flesh."
                );
            else
                this.outputText(
                    "breasts quiver invitingly as she pumps your cock, but before you can think of grabbing one yourself, both of her hands are squeezing and caressing them, drawing sighs from the woman as she toys with her erect nipples."
                );
            ...
            //(else if magically equal but < 90)
                ...
                this.outputText(
                    '  Her pussy squirts and sucks alternately, trying to find purchase on your cock even as her pumping hips deny it; the sensation drives you wild.  "<i>[name], your old fella is amazing...</i>"'
                );
            this.outputText(
                "  Your dick twitches and swells, as if to fulfill her words, and your pelvis rocks into Sheila's as you begin to ejaculate.  \"<i>No... pull out, or you'll get me pregnant,</i>\" she cries, when "
            );
            //[(single cox)
            ...
            if (this.player.cockTotal() > 1)
                this.outputText(
                    ", to be joined shortly by a messy external eruption that covers her thighs and belly in blotches of gooey white"
                );
            this.outputText(".");
            //[(big skeet)
            if (this.player.cumQ() >= 1000)
                this.outputText(
                    "  It rolls out of you in waves, packing Sheila's cunt until she fills to capacity and the excess is forced out, sliming your own crotch."
                );
        ...
        //(if no cockFit 32 and yes vag)
            ...
            if (this.player.isTaur())
                this.outputText(
                    'You turn around and straddle a leg, squatting to bring your [vagina] atop her crotch.  "<i>Push up,</i>" you order, and Sheila obeys eagerly, twisting her body to connect her excited pussy with yours.'
                );
            //(else if naga)
            else if (this.player.isNaga())
                this.outputText(
                    'You slide it under her and lift gently; Sheila plays along with a disquieted expression, rolling over and raising her pussy into the air, and you press your own against her butt as your tail slides between her legs.  "<i>See, you just need to be more... flexible,</i>" you quip.'
                );
            //(else if not horse and not naga)
            else
                this.outputText(
                    "You straddle her legs with your own, pressing her pussy into yours; Sheila gasps as the hot flesh connects and you tentatively rock your hips, dragging your lower lips across."
                );
            ...
            this.outputText(
                '.</i>"  A hand drifts up to her nipple, pinching it as her mouth hangs open.  She rolls it in her palm, then presses the breast against her ribcage, and her shiver of arousal transmits to you through'
            );
            ...
            if (this.player.isNaga())
                this.outputText(
                    " tail, drawing it up the hot opening and coiling it so you can return the warm, lube-slicked length for another pass even as you hump her butt."
                );
            else
                this.outputText(" cunt, grinding her like a sex toy in search of your own climax.");
            this.outputText(
                '  "<i>Do it!</i>" you order, anxious to feel her pussy convulsing against you, anxious to feel your own squeezing her.  "<i>Come with your lesbian lover!</i>"'
            );
            ...
            if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption()) {
                this.outputText(
                    "  Her vagina doesn't wait for romance, spasming and opening wide to try to suck you in, pulling at your "
                );
                ...
                if (this.player.isNaga())
                    this.outputText(
                        "  Her breasts swell in your hands as she sucks in her breath sharply, feeling your pussy drool its juice onto her ass."
                    );
            }
            //(else if PC corr < sheila corruption)
            else if (this.player.cor < this.sheilaCorruption()) {
                this.outputText(
                    "  Her vagina doesn't wait for symbolism, dumping a wave of orgasm that splashes almost audibly against you.  Your pussy answers with your own climax, and begins wetting the woman underneath"
                );
                if (this.player.isNaga())
                    this.outputText(
                        "; it feels like her breasts are pulling away from you as she tries to push her ass further into your quivering quim"
                    );
                this.outputText(".");
            } else {
                this.outputText(
                    "  Her vagina drools and spasms, not interested in gestures so much as release, and coats "
                );
                if (this.player.isNaga()) this.outputText("your tail");
                else this.outputText("your own");
                this.outputText(
                    " with a fresh coat of her hot fluids which trigger the expected response from you."
                );
            }
            //(if cock)
            if (this.player.hasCock()) {
        ...
        //(else if no cockFit 32 and no vag)
            ...
            this.outputText(
                "Her hand lowers to her crotch and slides her middle finger into her pussy.  \"<i>I don't know what's wrong with me,</i>\" Sheila says, nervously.  \"<i>I'm not even sure why I get hot when I think of you... you don't have anything I can use.</i>\""
            );
            ...
            if (this.player.hasCock()) {
                ...
                this.outputText(
                    ', then crawls its way to your [cock].  She begins stroking it, torpidly at first, but with increasing excitement as a drop of pre-cum slides down and wets her palm.  "<i>What\'s wrong, goblin girl?</i>" you ask.  "<i>Gotta get some sperm no matter what?</i>"'
                );

                this.outputText(
                    'Sheila winces as your probing fingers send a shudder through her.  "<i>Shut up, you tosser,</i>" she retorts, yanking on your dick slightly harder in her irritation.'
                );
            }
            //(new PG)
            this.outputText(
            ...
            if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption())
                this.outputText(
                    "  Her vagina heats up, squeezing your fingers so hard that you nearly can't pull out to rub her again, and you have a clear view of her breasts swelling up - arguable proof of your prowess, considering what she told you earlier.  Her people must be terrible at faking orgasm."
                );
            //(pc corr < sheila corruption)
            else if (this.player.cor < this.sheilaCorruption())
                this.outputText(
                    "  Her vagina gushes with clear fluid, filling the bowl made by your hand with warmth, and you think you can see her breasts tightening up slightly as her back arches, though it's hard to be sure with how she's shaking."
                );
            else
                this.outputText(
                    "  Her pussy quivers around you, and you draw the fingers out and pop them into Sheila's mouth.  The woman sucks on them greedily, and you raise an eyebrow at her.  She blushes again, but it's evidently not the first time she's done the same thing!"
                );
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cumQ() > 1000)
                    this.outputText(
                        '  Her mouth fills quickly, and she writhes in your grip, managing to turn her head.  "<i>Oh god, no way!</i>" she coughs, spitting up enough semen to coat her chin as your ongoing orgasm spatters against her cheek.'
                    );
                //[(mega skeet)
                if (this.player.cumQ() >= 2000)
                    this.outputText(
                        "  Not satisfied with that alone, you turn her head the other way for your finish, ejaculating on the rest of her face and completing her gooey, white beard as she squirms."
                    );
                //[(multicock)
                if (this.player.cockTotal() > 1)
                    this.outputText(
                        "  The other strokes not coming from this cock do their part to decorate your lover as well, turning her hair into a slimy mess."
                    );
                this.outputText(
                    "  She escapes from your hand as you spend yourself, leaning away and gagging up seed onto the dry grass."
                );
            }
            ...
            this.outputText(
                'just laugh and tug her ear; she flicks it and pulls away from you, backhanding you softly in the gut.  "<i>Knock it off!</i>"'
            );
            ...
            if (this.player.hasCock())
                this.outputText(
                    ", even after Sheila finishes wiping her face clean and stares at you"
                );
            this.outputText(
                ", so you just content yourself with lying next to the woman for a while."
            );
    ...
    private sheilaXPThreeSexyTimeGuardDuty(): void {
        this.clearOutput();
        this.outputText(
            'You fold your arms and frown at Sheila, but consent to help.  She brightens, then looks confused when you make no further motion.  "<i>So...</i>" she begins, "<i>what should I do?</i>"'
        );
        ...
        if (this.player.level >= 8)
            this.outputText(
                " - which, you suppose, must include imps even though they're so far beneath you they might as well be underground"
            );
        this.outputText(
            ".  You stand there for so long that you nearly slip into a daydream, and are only roused by the noise of a leather belt being carefully unfastened.  Focused again, you can hear Sheila's ragged breathing and her thighs rubbing together, then a hand sliding against skin and fabric... seems like she's made her decision."
        );
        ...
        //(else lib >= 40)
            ...
            this.outputText(
                ".  The girl giggles at that, relaxing and finally letting herself get into the masturbation."
            );
    ...
    private fuckBuddySheilaMeetingMaybeLater(): void {
        this.clearOutput();
        this.outputText(
            "You tell her you haven't the time right now, but squeeze her knee as you get up again."
        );
    ...
    private fuckBuddySheilaMeetingChatFamilyAndFriends(): void {
        this.clearOutput();
        this.outputText(
            '"<i>Them?  They\'re doing fine.</i>"  Sheila stares at you obtusely, trying to will you into changing the subject; you stare right back.  She sighs.  "<i>No go, huh?</i>"'
        );
    ...
    private fuckBuddySheilaMeetingChatOldLoves(): void {
        this.clearOutput();
        this.outputText(
            '"<i>[name], I don\'t want to talk about that,</i>" Sheila says, "<i>it leaves a bad taste in my mouth.</i>"'
        );
        ...
        //(else lib >=50)
            ...
            if (this.player.cor >= 60)
                this.outputText(
                    " - though it's probably meant to be a defensive gesture, all it does is push her tits together under her white shirt and frame them in light-brown skin"
                );
            this.outputText(
                ".  \"<i>[name], you horny whacker, I'm not gonna marry you.  Having to bull my way through a horde of monsters to see you and stand watch in shifts just to sleep together at night may be romantic once, but it's no kind of thing to do every day for the rest of my life.</i>\""
            );
            ...
            this.outputText(
                '.  Eventually she pulls away again, nose slightly red.  "<i>Sorry, mate; didn\'t mean to have a tantrum on you.</i>"'
            );
    ...
    private fuckBuddySheilaMeetingChatWhyHide(): void {
        ...
        if (this.player.statusAffectv1(StatusAffects.TelAdre) >= 1) {
            this.outputText(
                "  After all, the city in the desert seems to be bustling and bristling with weapons to resist the demons, whatever her feelings may be about it."
            );
    ...
    private fuckBuddySheilaMeetingChatLiveWithMe(): void {
        this.clearOutput();
        this.outputText(
            "You ask Sheila to move in with you at your camp, and she turns bright red."
        );
        this.outputText(
    ...
    private fuckBuddySheilaMeetingChatKids(): void {
        ...
        if (this.flags[kFLAGS.SHEILA_JOEYS] == 1) {
            ...
            if (this.player.femininity > 50) {
                this.outputText(
                    "I don't know how he'll react when he sees a pretty face like yours, though; he doesn't know that I'm-"
                );
                //[(PC is herm, fem)
            ...
            //else if PC masculine or andro, no new PG)
                ...
                this.outputText(
                    "I'm not sure if he intends to shake your hand or punch you, though.</i>\""
                );
        ...
        //if joeycount >= 10
            ...
            if (this.player.lib < 50) {
                ...
                if (this.player.cor < 40)
                    this.outputText(
                        '  You pat her shoulder carefully and suggest, "<i>I could watch them for a while.</i>"'
                    );
    ...
    private fuckBuddySheilaMeetingChatKidsRest4Now(): void {
        this.clearOutput();
        this.outputText(
            '"<i>Always,</i>" you answer, "<i>but if you need to relax and sleep for a bit, I\'m here for that too.</i>"  You draw your hand back out, patting her on the cheek.'
        );
        ...
        this.outputText(
            '.  "<i>You\'re sweet... thank you.  I will take you up on both of those offers - but maybe just the nap this arvo.  Would you wake me up in about an hour?</i>"'
        );
    ...
    private sheilaXP4Sex(display: boolean = false): void {
        if (display) {
            this.clearOutput();
            this.outputText(
                'You slip an arm around the bushranger and lean in.  "<i>I was thinking we could have some sex... feel up to it?</i>"'
            );
            this.outputText(
    ...
    private consensualSheila69(cock: boolean = true): void {
        ...
        if (cock) {
            if (this.player.cockThatFits(32) >= 0) {
                ...
                this.outputText(
                    ' as she rubs her small, smooth labia vigorously.  "<i>What do you expect me to do with one of those?</i>"'
                );
            }
        }
        //(vag)
            ...
            if (this.player.clitLength > 8)
                ...
                this.outputText(
                    ', producing a slight sigh and a wet finger.  "<i>And I\'m the eager one, right?</i>" your lover asks, wryly - though her finger is just as wet.'
                );
        }
        ...
        this.outputText(
            " over her head, waggling it provocatively as you slip your fingers into her."
        );
        ...
        if (cock) {
            ...
            if (this.player.cockThatFits(32) < 0)
                this.outputText(
                    " and guiding it to bend comfortably against her chest, drooling a trail of pre-cum as she slides it into position"
                );
            this.outputText(".");
        }
        //(vag)
        ...
        if (cock) {
            ...
            if (this.player.cockThatFits(32) >= 0) this.outputText(" into her warm, waiting mouth");
                ...
                this.outputText(
                    "; she lets go of it to grab her breasts instead, trying to push them around the sensitive shaft as she runs her tongue up the underside"
                );
            this.outputText(".");
        } else {
            ...
            if (this.player.clitLength > 8)
                this.outputText(
                    "nips and sucks at the tip of your clit, rolling it with her tongue"
                );
            else
                this.outputText(
                    "parts your labia with her tongue, stroking them gently and tickling your little clitoris"
                );
            this.outputText(".");
        }
        ...
        if (!this.player.isTaur())
            this.outputText(
                "lean down and bury your own tongue all the way inside Sheila, forcing her labia open with your mouth"
            );
        else
            this.outputText(
                "reach as far as you can to bring both hands into play, stroking and pulling Sheila's labia apart with one as you tease her exposed clitoris or slip inside her vagina with the other"
            );
        this.outputText(
            "; your lover stops licking and you can feel her mouth slip away from your sensitive skin as her head rolls back."
        );
        ...
        if (!cock) {
            ...
            if (this.player.clitLength > 8)
                this.outputText(
                    " and stroking your " + this.clitDescript() + " rapidly with one hand"
                );
            this.outputText(".");
        }
        //(smallcox)
            ...
            this.outputText(
                "taking you into her mouth once again and licking away a neglected drop of pre-cum."
            );
        else
            this.outputText(
                "stroking your cock with one hand as she pushes an erect nipple against its side to trace a line."
            );
        ...
        if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS.SHEILA_CORRUPTION]) {
            ...
            this.outputText(
                " in ravenously.  You can literally feel her internal muscles rippling and undulating, stroking you as if they could coax out an ejaculation.  Sheila sucks in her breath as she climaxes, filling her chest; you can feel her tits pushing harder and harder against you."
            );
        }
        //(PC corr < sheila corruption)
        else if (this.player.cor < this.flags[kFLAGS.SHEILA_CORRUPTION]) {
            this.outputText(
                "pushing out a gush of fluid.  For what seems like several minutes, her pussy deluges your "
            );
            ...
            this.outputText(
                "   Her thighs tense, forcing her pelvis into the air and her cunt toward you as her chest slumps; slowly, you feel the perky nipples pressing into your stomach pull away."
            );
        }
        //(else if equal but below 90)
        else if (this.player.cor == this.flags[kFLAGS.SHEILA_CORRUPTION] && this.player.cor < 90) {
            this.outputText(
                "drooling a trickle of fluid and licking at you as she screams her ecstasy into your crotch."
            );
        }
        ...
        ///(small cox)
            ...
            this.outputText(
                "penetrating you deeply with her tongue as her hands reach up to stroke your clit furiously."
            );
        this.outputText(
            "  Your body gives up under her frenzied assault, laying your crotch onto the woman's face as muscle control abandons you."
        );
        ...
        if (cock) {
            ...
            if (this.player.cockThatFits(32) >= 0) {
                this.outputText(
                    "pouring out into your lover's waiting throat.  She gags and you can feel the gooey seed oozing back against your [cockHeadFit 32]"
                );
                //[(small cum)
                if (this.player.cumQ() < 250)
                    this.outputText(
                        "; you withdraw from her, allowing her throat to force your ejaculate back up and over her lips and cheeks with a splutter."
                    );
                //(big cum)
                else if (this.player.cumQ() < 2000)
                    this.outputText(
                        ", but your relentless orgasm forces it down again, dumping more jism into her throat.  You can feel her hands clawing at your [butt] as you relieve your buildup."
                    );
                //[(mega cum)
                else
                    this.outputText(
                        ".  Soon, her visibly-rounding stomach fills and the tip of your dick is once again washed in backflow; the next spurts force the cum all the way up, and she begins drooling the slimy semen-saliva blend from her mouth and nose, hands all the more frantic in her alarm."
                    );
            }
            //(else doesn't fit)
            else {
                this.outputText(
                    " squirting onto and between your intertwined bodies to soak your [chest] and neck, and Sheila's softly pumping crotch."
                );
                //(big skeet)
                if (this.player.cumQ() > 1000)
                    this.outputText(
                        "  A wellspring of seed, your body continues producing until the fuzz on her thighs and tail is completely matted down with the whiteness drooling between you."
                    );
                //(multicocks)
                if (this.player.cockTotal() > 1) {
                    ...
                    this.outputText(
                        " as well, adding their own issue to the unholy mess covering the poor woman."
                    );
                }
            }
        }
        //(else if vag-focus)
            ...
            if (this.player.wetness() <= 2)
                ...
                this.outputText(
                    "overflow, soaking her hair even as she shuts her eyes tight against the cataract"
                );
            this.outputText(
                ".  As you climax, you wrap around her head, squeezing so hard that you flatten her ears against her skull.  Her hands latch onto your butt, trying to pull you off, but having already spent herself on her throes of passion, she's no match for yours, still ongoing, and you hold tight until your body relaxes."
            );
        }
        ...
        if (cock && this.player.cockThatFits(32) >= 0)
            this.outputText(
                ", pulling free of her throat.  She immediately turns over as well and forces herself to her hands and knees, then gags and coughs up a large amount of your jism.  When she's dumped enough to clear her passageway, she collapses forward, smearing the mess onto her chest as she spends a few minutes to catch her breath.  Once she's got it, she turns back over and sits up, strands of your slime linking her breasts to the grass."
            );
        //(else not smallcox)
        ...
        //[(corruption threshold warning if sheila corruption >= 80 and PC corr > sheila corruption and sheila xp =/= 3)
            ...
            (this.player.cor > 90 || this.player.cor > this.sheilaCorruption()) &&
            this.sheilaCorruption() >= 80 &&
            this.flags[kFLAGS.SHEILA_XP] != 3
        ) {
            this.sheilaCorruptionUpdate();
        ...
        if (cock && this.player.balls > 0) {
            this.outputText(
                "What you see manages to pull an explosive laugh from you, tired as you are.  Sheila gives you the stink-eye until you've recovered enough to explain the source of your mirth: on her forehead, making a perfect "
            );
        ...
        this.outputText(
            '"<i>You could give a girl a bloody warning before that sort of behavior.  I thought you were going to kill me!</i>"'
        );
        ...
        if (this.flags[kFLAGS.SHEILA_XP] == 3) {
            this.outputText(
                '"<i>[name]... thanks.  Even being covered in your mess is better than being stuck outside all night, too scared to touch myself and too horny to run.</i>"  Sheila kisses you on the cheek.  "<i>My sloppy hero, eh?  I\'m okay now; I can make it \'til morning when the gate reopens.</i>"'
            );
            this.outputText(
        ...
        //(else if sheila xp =/= 3)
            ...
            this.outputText(
                '"<i>Forget it.  With the way you worked me, I forgive you.  Just be careful, you wanker.</i>"  Sheila closes her eyes and pulls your arm around her shoulder'
            );
            if (cock && this.player.cockThatFits(32) >= 0)
                this.outputText(", smearing your dangling hand into the mess on her tits");
            this.outputText(
                '.  The two of you lie like that for a while, until she gets up.  "<i>I should really go... need to cure my catch.  Not to mention I\'ll have to clean up before I can even put my damn clothes back on.</i>"  Sheila picks up her stuff.  "<i>Hehe... see you soon.</i>"'
            );
        }
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private consentacleVagSexForKangarooSlutBitches(): void {
        ...
        this.outputText(
            " breasts as she fiddles with your own clothing.  She manages to remove the top of your [armor], exposing your [chest]; she then returns your favor by "
        );
        ...
        //(centard)
            ...
            this.outputText(
                "Attempting to maneuver your " + this.cockDescript(x) + " into position"
            );
        this.outputText(
            ", you rub the head along her dripping snatch, smearing her fluid over it.  "
        );
        //[(non-cent)
        if (!this.player.isTaur())
        ...
        if (this.sheilaCorruption() <= 30) this.outputText("her perky breasts rock back and forth");
            ...
            this.outputText(
                "her jiggling breasts flatten into perfect domes and undulate on her chest"
            );
        ...
        if (!this.player.isTaur()) {
            this.outputText(
                "You pause briefly, adjusting your angle and leaning down to kiss her deeply once again and help caress her "
            );
            if (this.sheilaCorruption() <= 30) this.outputText("firm");
            else this.outputText("pillowy");
            this.outputText(
                " tits, then resume thrusting from your new position; her nipples now brush against your [chest] as you pump.  "
            );
        }
        //(if balls/vag)
        if (this.player.balls > 0 || this.player.hasVagina()) {
            ...
            if (this.player.balls == 0 && this.player.hasVagina())
                this.outputText(
                    "Your cunt twitches and drools a bit of fluid on the furry intruder.  "
                );
        }
        ...
        //(dog cock)
            ...
            this.outputText(
                "You attempt to oblige her, but your swollen knot sticks firmly in her squeezing pussy, locking you into place.  After a few fruitless tugs, you give yourself up to your orgasm with an apology, slumping against her heaving chest and helplessly dumping the rest of your load into the twitching woman. "
            );
            //[(big skeet)
            if (this.player.cumQ() >= 1000) {
                this.outputText(
                    "Her belly begins to round as your overproductive gonads push out your massive store of semen"
                );
                //[(huge skeet)
                if (this.player.cumQ() >= 3000)
                    this.outputText(
                        ", until it's stretched as far as possible and each successive jet forces out squirts of frothy jism from the tight seal her pussy makes around the knot"
                    );
                this.outputText(". ");
            }
            //[(multi)
            if (this.player.cockTotal() > 2)
                this.outputText(
                    "Your other cocks erupt as well, soaking her crotch and matting down the fur on her thighs with whiteness. "
                );
        }
        ...
        this.outputText(
            "; the two of you lie there breathing raggedly for several minutes.  Sheila breaks the silence first."
        );
        ...
        if (this.flags[kFLAGS.SHEILA_XP] == 3) {
            this.outputText(
                '  Sheila looks over, thankfulness written on every inch of her brow.  "<i>[name]... I really appreciate what you did.  I\'d rather be knocked up than caught by some nightmare because I was too horny to hide properly until the colony opened - er, not that I want to be knocked up by you, sweet as you are.</i>"'
            );
        ...
        //(else sheila xp =/= 3)
            ...
            if (this.player.cumQ() < 500)
                this.outputText(
                    "as she strokes the " + this.player.skinFurScales() + " of your chest"
                );
    ...
    private sheilaMutualMasturbation(): void {
        ...
        this.outputText(
            "You snatch Sheila's hat and pack, tossing them away, then slide a hand into the girl's shirt, slipping one of her nipples between two fingers as you nibble on her neck, and use the gentle pressure to push her onto her back.  She sighs, moving a hand under her clothes to caress yours.  \"<i>Ah,</i>\" she pants, letting out a soft puff of air, \"<i>what're we gonna do on the grass, [name]"
        );
        ...
        if (target == "cock") {
            this.outputText(
                "stroking your [cock], pointing it at her as you smear pre-cum onto your fingers"
            );
        }
        //(non-horse vag)
        else if (target == "cunt")
            this.outputText(
                " sliding your hand to your [vagina], parting your lips with two fingers"
            );
        //(gross-ass nipcunts)
        ...
        //(Unsexed non-centaur only)
            ...
            this.outputText(
                "licking a finger and teasing your asshole with shallow strokes, gently circling the ring"
            );
        //(centaur who hasn't got shit)
        else
            this.outputText(
                "sucking a single digit salaciously, fingerfucking your mouth and coating it with saliva"
            );
        this.outputText(
            '.  "<i>Oh... are you going to touch me, or just play with that?</i>" Sheila asks, grinning.'
        );
        ...
        if (target == "cock")
            this.outputText(
                "You return your hand to your [cock], pumping vigorously to catch up to your lover, spurred onward by the smooth skin she presses into your lips."
            );
        //(else if nonhorse vag)
        else if (target == "cunt")
            this.outputText(
                "You slide your hand between your [legs] again, intent on recovering the march Sheila's stolen on you, and begin rubbing your [clit] vigorously while sighing into her breast."
            );
        //(else if RNG disgusting nipplecunts)
        else if (target == "nipplecunt")
            this.outputText(
                "Your hand returns to your chest, slipping inside the sensitive flesh of your nipple, and you groan into Sheila's as a trickle of moisture falls from your chest."
            );
        ...
        this.outputText(
            '.  "<i>Just... say I\'m always yours!</i>"  She turns you toward her face again, locking you in a kiss, and your '
        );
        //[(if cock)
        if (target == "cock") {
            ...
            this.outputText(
                " to twitch, ejaculating a stroke onto Sheila's midriff and wrist.  The girl groans in your mouth at the new heat, and her body shakes in orgasm."
            );
        }
        //(vag)
        else if (target == "cunt") {
            ...
            this.outputText(
                " around your hand.  As your body shakes and your lips rattle against Sheila's, she shivers and her own orgasm begins."
            );
        }
        //(nipcunts)
        else if (target == "nipplecunt") {
        ...
        //(jack shit)
            ...
            this.outputText(
                "fingers are pulled into her vagina by her muscles as her orgasm begins."
            );
        //[( pc corr >= 90 or > sheila corruption)
        if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS.SHEILA_CORRUPTION]) {
            this.outputText(
        ...
        //(else if equal corr but under 90)
            ...
            this.outputText(
                "She breaks the kiss, drawing her hand from her pussy, and holds your head in front of her; her eyes soften with affection as she shudders."
            );
            //[(not jack shit)
            if (target == "cunt" || target == "cock" || target == "nipplecunt")
                this.outputText(
                    "  Emptying your reserves, you allow yourself to fall into her arms, resting your head on her chest."
                );
        }
    ...
    private sheilaCorruptionWarningsChooseFondle(): void {
        ...
        this.outputText(
            ".  Even as she goes, you can still see the edges of her amazing, swaying rack around the sides of her torso."
        );
    ...
    public sheilaGotWhomped(): void {
        ...
        this.outputText(
            ".  As you stand over her, she forces herself to her elbows and tries to scoot away from you, fear written on her face.  \"<i>I'm sorry... please, no..."
        );
        //[(sheila xp > -4)
        ...
        if (this.sheilaCorruption() >= 90)
            this.outputText(
                "  \"<i>I-if you touch me again... god, I can't even think straight anymore!  Don't do this!</i>\""
            );
        //(lust >= 30)
        ...
        if (this.player.lust >= 33) {
            ...
            if (this.player.hasCock()) {
                if (
                    (!this.player.isTaur() &&
                        this.player.shortestCockLength() <= this.player.tallness * 0.35) ||
                    (this.player.isTaur() &&
                        this.player.tallness * 1.2 <= this.player.shortestCockLength() &&
                        this.player.shortestCockLength() <= this.player.tallness * 1.55)
                ) {
    ...
    private rapeSheilasCooter(): void {
        ...
        this.outputText(
            ".  Reaching down, you take the neck of her shirt in your hand, then rip it open, exposing her "
        );
        //[(sheila corruption < 30)
        ...
        this.outputText(
            "breasts, which jiggle from the force.  She tries to cover herself with her arms, but you grab and pull them aside, revealing her chest again.  As you appraise her naked flesh, she looks away, shame coloring her cheek.  Her mouth tightens and her eyes shut as you squeeze her tits roughly, flicking the nipples until they're erect."
        );
        ...
        if (this.player.cor < 50) {
            ...
            if (this.player.cumQ() >= 500)
                this.outputText(
                    "  Soon you've filled her as fully as the shallow penetration will allow, and the panties begin to press back against your cock, oozing onto you whatever semen the porous dam can't contain."
                );
            //(mega skeet)
            else if (this.player.cumQ() >= 1500)
                this.outputText(
                    "  It sags and bows around the tip of your spear, pulsing with each new stroke as the hemlines leak jizz onto her legs and butt."
                );
            this.outputText(
                "  Idly, you imagine what it must look like inside, each squirt having its momentum arrested by the cloth, drooling lazily into her until the next one displaces it a bit further forward, and wonder if it'll be enough to get her pregnant.  You pull away from the girl, leaving her gasping and once again averting her gaze."
            );
            ...
            if (this.player.cumQ() >= 500)
                this.outputText(
                    "So much cum fills her pussy that it slips out, once again restoring the opacity, though not the dryness, of her panties.  "
                );
            this.outputText(
                "You return her gaze, turning your nose up dismissively.  Conscious of her nudity, she pulls up her shorts and buttons her vest to conceal herself as you leave her behind."
            );
            ...
            this.outputText(
                ', and she actually rears back to scratch at you with her fingernails.  You catch her hand and hold it, and she responds by spitting at you!  "<i>Fuck you, arsehole!</i>" Sheila shrieks.  "<i>Take it out!</i>"  Reaching down, you slap her in the face.'
            );
            ...
            this.outputText(
                ", confirming your suspicion.  Her eyes close and her chin raises resignedly"
            );
            //[(nothors)
            if (!this.player.isTaur())
                this.outputText(
                    " as you triumphantly squeeze the flesh in your hand and kiss her under the jaw"
                );
            this.outputText(".");
            ...
            if (!this.player.isTaur())
                this.outputText(
                    "place a hand along her face, tuning it toward you, and kiss her on the lips."
                );
            else this.outputText("bend down, lowering your torso until you can caress her cheek.");
            this.outputText(
                '  "<i>Of course I won\'t,</i>" you answer sweetly.  "<i>What would be the point?</i>"  Sheila winces as you hilt yourself, sinking your [cockFit 48] so far into her that your crotch meets hers.  You shudder'
            );
            //[(nonhors)
            if (!this.player.isTaur()) this.outputText(" and squeeze her breast");
            this.outputText(
                " as your climax arrives and the first of your seed pours into her grasping pussy.  While you fill her, her back arches"
            );
            //[(nonhors)
            if (!this.player.isTaur()) this.outputText(" and she presses your hand uncomfortably");
            this.outputText(
                ", gasping as her own orgasm begins.  Her knees wrap around your sides, satisfying your predicition, and her vagina"
            );
            //[(pc corr >= 90 or > sheila corruption)
            if (this.player.cor >= 90 || this.sheilaCorruption() < this.player.cor) {
                this.outputText(
                    " pulls greedily at your [cockFit 48], drinking up your semen as fast as you can squirt it.  She sucks in breath as she climaxes, finally opening her eyes as her head tilts back"
                );
                //[(nonhors)
                if (!this.player.isTaur())
                    this.outputText(
                        "; you can almost feel her breast heating up and swelling with blood under your hand, as the nipple pokes into your palm"
                    );
                this.outputText(".");
            }
            //(PC corr < sheila corruption)
                ...
                this.outputText(
                    " floods you with juices, dumping so much around your twitching cock that you feel like you're lowering it into a hot spring."
                );
                //[(nonhors)
                if (!this.player.isTaur())
                    this.outputText(
                        "  She squeezes your hand so hard that you swear you can feel her breast compressing under it as she screams her pleasure."
                    );
            }
            //(else equal but < 90)
            else {
                this.outputText(
                    " drools eagerly as you mingle your juices with hers, until the fluid begins to thicken with white seed."
                );
            }
            //[(big skeet)
            if (this.player.cumQ() >= 500)
                this.outputText(
                    "  Overabundant as always, your semen quickly fills her to capacity and begins to squirt out around your shaft, staining her thighs."
                );
            //[(multicock)
            if (this.player.cockTotal() > 1) {
                this.outputText("  Your other ");
    ...
    private forcedSheilaOral(dick: boolean = true): void {
        ...
        this.flags[kFLAGS.SHEILA_XP] = -4;
        this.outputText(
            "You lean down and grab the girl by her shirt-front, raising her to her knees; her hands automatically go to yours."
        );
        ...
        this.outputText(
            ' breast.  "<i>You don\'t want to rip your clothes, do you?  It must be difficult to get nice fabric like this out here in the middle of nowhere.</i>"'
        );
        ...
        //(else sheila corruption < 50)
            ...
            this.outputText(
                "swollen globes that bulge over her v-neck and strain at the seams of her shirt."
            );
        this.outputText(
            "  Smiling at the sight, you grab the garment's hem and pull it up roughly.  Sheila blinks dumbly as you expose her erect nipples to the air, then blushes and covers them with her hands."
        );
        ...
        //(vag present)
            ...
            this.outputText(
                "Your [vagina] drools slightly, labia parting and [clit] poking up; you imagine what you want to do with it."
            );
        this.outputText(
            "  Sheila watches your face as you slip into a fantasy, half-playing with her nipples - but just when you start to get into your daydream, she turns and tries to scramble to her feet!"
        );
        ...
        if (dick) {
            ...
            if (this.player.cocks[this.player.shortestCockIndex()].cockThickness <= 6) {
                this.outputText(
                    "parting her lips to pop neatly between them.  It feels good, but one-sided, and you order Sheila to get to work."
                );
            } else {
                this.outputText(
                    'jabbing at her undersized mouth with your enormous [cockHead shortest].  "<i>It\'s too thick!</i>" she complains, trying to turn away.'
                );
                this.outputText(
            ...
            if (this.player.cocks[this.player.shortestCockIndex()].cockLength <= 8) {
                ...
                this.outputText(
                    ", and the other hesitantly makes its way to her breasts as she gets into the sex.  The woman tweaks her nipple, softly at first but with mounting passion as her attentions on your dick become more lavish.  Catching this from the corner of your eye, you move "
                );
                if (!this.player.isNaga()) this.outputText("a [foot]");
                else this.outputText("the tip of your tail");
                this.outputText(
                    " between her knees to her crotch, rubbing her pussy through her shorts; Sheila hums into your shaft as a wet spot appears on the cloth, and begins grinding her hips against the pressure.  You answer her enthusiasm by taking her head in your hands and stroking the surface of her long, pointed ears affectionately with your thumbs.  She flushes, then sinks down on your cock, rubbing the nerves on the slit with the back of her tongue and pulling you closer to orgasm."
                );
                ...
                this.outputText(
                    ".  She pushes against you with her hands, trying to get free, but you just hold her against your crotch as you lean over her head."
                );
            }
            //(else dick length > 8)
            else {
                this.outputText(
                    "but this sort of half-assed attention won't get you off any time before sundown."
                );
                ...
                ///(else width > 6)
                    ...
                    this.outputText(
                        "; still intent on calling this oral sex, you squeeze Sheila's jaw, forcing her mouth open, then push your drooling slit right up to it as the first squirt of white peeks out."
                    );
                }
            }
            ...
            //(else if corr < 70 or PC cannot use Infest at will)
                ...
                if (this.player.cumQ() >= 3000)
                    this.outputText(
                        "  Your body's not done with that, though, and keeps pushing out cum until it spurts around your prick and out Sheila's nose in little squirts."
                    );
                this.outputText(
                    "  Emptying yourself, you pull Sheila's mouth away from your [cock shortest] and drag the slimy member on her chest, smearing her tits with spit and semen and wiping away the last of the mess on her shirt."
                );
                ...
                if (this.player.cumQ() >= 1000)
                    this.outputText(
                        ", though it's so wet with seed now that you can see them almost as well through it"
                    );
                this.outputText(
                    '.  "<i>This really is a nice fabric.  You should take better care of it.</i>"  With that parting shot, you leave the queasy-looking woman to digest your load and the humiliation.'
                );
            }
            //end worm fork
            ...
            if (this.sheilaCorruption() >= 30)
                this.outputText(
                    "; her breasts jiggle pleasingly as they settle on her chest, filling you with the urge to play with them"
                );
            this.outputText(
                '.  Straddling her, you lower your [vagOrAss] to her face.  "<i>Lick,</i>" you order, rubbing your [butt] on Sheila\'s nose'
            );
            //[(not horse)
            ...
            if (
                (this.player.hasVagina() && this.player.vaginalCapacity() >= 100) ||
                (!this.player.hasVagina() && this.player.analCapacity() >= 100)
            )
                this.outputText(
                    "  She keeps hitting the same spot again, too - she's not even bothering to adjust her angle and touch the rest of your stretched opening."
                );
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00141] > 0)
                this.outputText(
                    "  I know a nice boy in the mountains who keeps dogs, and I'm sure he'd love to have a womb like yours for their seed.  By this time tomorrow, you could have a cock in both holes, filling you with hellhound babies since you can't please a person."
                );
            this.outputText('</i>"');
            ...
            if (!this.player.isTaur())
                this.outputText(
                    "pinch her nipple for emphasis, then grind your hips across her face, mauling her nose with your ass.  \"<i>I could fuck a tree and it wouldn't be as wooden as you in the sack"
                );
            //[(PC has found corrupt glade)
            if (this.player.exploredForest >= 40)
                this.outputText(
                    " - in fact, there are quite a few I've seen who look like better lovers than you.  Maybe I should carry you to the forest and tie you to a nice pussy-shaped giant flower to give you lessons"
                );
            this.outputText(".  ");
            ...
            if (
                ...
                this.outputText(
                    "Perhaps I'll turn you over to a minotaur; you're bound to get better at using your tongue when you're addicted to their amazing seed.  Would you like that?  The first thing you'd see in the morning would be a huge flared cock, right in front of you, dripping with heavenly precum and waiting for your mouth... or your cunt.  You could be just another minotaur-fucking slut of the plains.  "
                );
            }
            this.outputText(
                "Or I could take you home and give you personal training myself, whenever I feel like it, and invite travelers to do the same"
            );
            //[(PC has Izma with cock)
            if (this.izmaFollower() && this.flags[kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText(
                    "; I personally know fifteen inches of fat, orange dick and four heavy balls that'd love to get in at your other end while I ride your face"
                );
            this.outputText('.</i>"');
            ...
            if (
                ...
                this.flags[kFLAGS.LUMI_MET] > 0
            ) {
                this.outputText(
                    " while imagining her turned over to the goblins for experiments, forced to drink potion after potion - most would be dedicated to growing cocks on her or increasing semen production, of course"
                );
            }
            this.outputText(
                ".  Your hole clenches and drools on her, and the woman's rude tongue retreats from the pressure, leaving you painfully empty."
            );
            //[(no horse)
            if (!this.player.isTaur())
                this.outputText(
                    "  Even squeezing her breasts viciously can't compel her to reinsert it, though you amuse yourself trying."
                );
    ...
    private sheilaGetsRapedWithADildont(): void {
        ...
        if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption()) {
            this.outputText(
                "Your face heats as she kisses you sloppily, and not all of the temperature is from her mouth.  It feels like she's pulling energy right out of you, and you can swear that her breasts are growing."
            );
        }
        //(else PC corr < sheila corruption)
        else if (this.player.cor < this.sheilaCorruption()) {
            this.outputText(
                "Her lips heat up and your body tingles; you can see her breasts shrinking as she shivers and slobbers on your face - or so it seems from the angle."
            );
        }
        //(else if magically equal but < 90)
        else
            this.outputText(
                "The kiss is wet and indecent as she shudders through her anal orgasm; her lips don't stay in one place, instead tracking drool all over your face."
            );
        ...
        if (this.player.hasCock())
            this.outputText(
                '  "<i>Perhaps next time you\'d like to try a real cock in there?</i>"  Even exhausted and messed up on goblin drugs, she has the presence of mind to shake her head at that.  You laugh.'
            );
    ...
    public getBeatUpBySheila(): void {
        ...
        if (this.monster.lust < 75) {
            this.outputText(
                "takes the opportunity to grab her catch and take off running!  Even if you wanted to, you couldn't catch her now... you collapse, head swimming in "
            );
            if (this.player.HP < 1) this.outputText("colorful spots");
            else
                this.outputText(
                    "fantasies of her, stark naked but for her hat and waiting with her legs open"
                );
            this.outputText(".");
        ...
        //(else monster lust >= 75)
            ...
            this.outputText(
                "stares at you, desire and nerve at war in her face.  Her thighs rub together involuntarily as she tries and fails to will herself away... slowly, she takes a step toward you."
            );
            this.outputText(
    ...
    private sheilaCowgirlRapesYou(): void {
        this.clearOutput();
        this.outputText(
            "Sheila pushes insistently, and you allow her to force you to the ground and then onto your back"
        );
        ...
        if (this.player.cockThatFits(32) < 0) {
            ...
            this.outputText(
                ".  She scoots forward slowly, and gasps as her pussy comes to rest against your hot, blood-engorged shaft."
            );
            ...
            this.outputText(
                " as her gasps and the picture in your head both intensify.  Sheila grabs one with her own hand, pulling it up to her mouth to smother it in kisses"
            );
            ...
            this.outputText(
                "Sheila shivers and leans back, hair dangling, as her hips buck and her thighs squeeze your shaft.  "
            );
            //(PC corr >=90 or > sheila corruption)
            if (this.player.cor >= 90 || this.sheilaCorruption() < this.player.cor) {
                this.outputText(
                    "You can feel your prick heating up where her pussy rubs against it... it almost feels like the rest is cooling down at the same time.  The woman atop you arches her back and sucks in her breath sharply, and her tits seem to claim your field of vision, swelling up - though that could just be the angle."
                );
            } else if (this.player.cor < this.sheilaCorruption())
                this.outputText(
                    "Her orgasm wets your prick, coating it with fluid as she comes.  Sheila wraps herself tighter in your limbs, squeezing her breasts against her chest, and you think you can feel them get a little smaller as your head fuzzes over with her excess emotion."
                );
            else
                this.outputText(
                    "Her hips lock up when she comes, leaving you to try and finish yourself as she heats up around your shaft."
                );
            ...
            if (this.player.sens >= 50) {
                ...
                if (this.player.cumQ() >= 2000)
                    this.outputText(
                        '  The giggles and the strokes stop long before your orgasm, though; eventually Sheila just lies there, dumbfounded, as you deposit layer after layer of white lattice on her skin.  "<i>Bloody hell,</i>" she mumbles vaguely, either stone-sober or drunk from the sight of it.'
                    );
                this.outputText(
                    "  Once the rain of semen peters out, she pulls apart from you, slimy and dripping."
                );
        ...
        //(else if cock fit 32)
            ...
            this.outputText(
                "as you lean over to catch her expression, you can see her eyes glimmer with desire.  Sheila notices you from her peripheral vision, and her face reddens again.  She turns her back to you."
            );
            ...
            this.outputText(
                "stroking your [cockFit 32].  A drop of precum forms, and she touches it with the index finger of her free hand, sending a tingle through you; she pulls the finger away, drawing a string of slick moisture out.  Sheila passes the finger between her breasts, wiping the fluid away on her chest and shivering.  The display is too much for you, and you reach forward, navigating your hands around her waist quietly until you can reach the buckle of her belt.  The girl sighs as you begin to unfasten it, but an errant thought brings her back to reality - she grabs your hands abruptly."
            );
            ...
            //(else lib >= 25)
                ...
                if (!this.player.isTaur())
                    this.outputText(
                        ", and your hands go to her waist, fairly pushing her up and slamming her back down in your eagerness"
                    );
                this.outputText(
                    ".  She rolls her head as the fuck gets wetter and faster, dangling her hair over her shoulders as her back muscles shift and flex with her strokes; her ears flick whenever she descends and rubs your neck against one of the sweet spots on her vulva."
                );
                ...
                if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption())
                    this.outputText(
                        "You can feel her cum-slick inner walls pulling at you as she begins to orgasm, and your mind clears as you blow your load inside her, wondering when she'll likewise return to sense."
                    );
                //(else PC corr < sheila corruption)
                else if (this.player.cor < this.sheilaCorruption())
                    this.outputText(
                        "Her pussy gushes with her orgasm, pushing out your semen and soaking her inner lips even as she continues riding your cock, and your mind clouds as you think of little except sneaking as much of your cum inside her as possible."
                    );
                //else equal but < 90)
                else
                    this.outputText(
                        "Even as she comes mindlessly something makes you hold in your own moans, wondering how long it will take her to notice her pussy being filled with your egg-hunting sperm."
                    );
                //[(small cum)]
                if (this.player.cumQ() <= 250) {
                    this.outputText(
                        "  Sheila continues moving her hips even as she comes, lost in bliss; on one particularly lofty ascent, your cock flops out, squirting a line of jizz along "
                    );
                ...
                //(big cum)
                    ...
                    this.outputText(
                        "  With how much Sheila is still moving her hips, it's only a matter of time before she notices the mounting pressure in her cunt... on one particularly deep push, she forces out a squirt of white, and her eyes go wide as she pulls off and lets you finish on the grass."
                    );
                }
    ...
    private sheilaForcedOralGeneric(): void {
        this.clearOutput();
        this.outputText(
            "Sheila kisses you once more, forcing her tongue into your mouth, and slides a hand into your [armor]; you stare wonderingly into her affectionate, hungry eyes at the sudden change.  It isn't until "
        );
        ...
        this.outputText(
            " that her reverie breaks; her face colors and she looks away, averting her gaze in shame.  She draws her hand back out guiltily, then begins to doff her shorts and panties.  \"<i>S-sorry... didn't mean to get familiar.  I'll have this over with quickly.</i>\""
        );
        ...
        this.outputText(
            ".  Sheila rubs the smooth slit on your [face], trying to part her labia on you, and shivers a bit when your lips brush hers."
        );
        ...
        if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption()) {
            this.outputText(
                "strangling your tongue with muscles attempting to lock onto it, trying to pull it in."
            );
            //[(demon/dragon tongue)
            if (this.player.tongueType > TONUGE_HUMAN)
                this.outputText(
                    "  As tired as you are, you simply go along with it, allowing her rippling walls to slowly draw your tip deeper inside until it bumps against her cervix; she shivers and kisses the top of your head as you groggily run your tongue over the entrance to her womb."
                );
            else
                this.outputText(
                    "  However, it doesn't get very far; you lazily flop it around inside her as she works through her arousal."
                );
            this.outputText(
                "  Sheila groans loudly and your vision fades; through the fog, you can swear you feel her breasts growing larger against your forehead."
            );
        }
        //(else PC corr < sheila corruption)
        else if (this.player.cor < this.sheilaCorruption()) {
            this.outputText(
                "filling your mouth with her liquid love.  Your lips and throat heat up as you're forced to drink it from the nearness of her pussy; as she bucks her hips weakly into your face, trying to draw out her climax, you increasingly wish that you could return the favor, "
            );
            if (this.player.hasCock())
                this.outputText(
                    "face-fucking her and blowing a load into her mouth, then holding her jaw shut until she swallows it unhappily."
                );
            else if (this.player.hasVagina())
                this.outputText(
                    "smearing your gash on her face until you come and drown her in your squirting girl-jizz."
                );
            else
                this.outputText(
                    "forcing her to tongue your asshole until you come, writhing and pressing her head into the grass with your [butt]."
                );
        } else
            this.outputText(
                'and she pets your head affectionately as her walls squeeze your tongue.  "<i>Oh, mate...</i>" she whispers lovingly, completely forgetting the struggle that led to your tryst.'
            );
        ...
        if (this.player.str < 61) this.outputText("climbing off and kneeling next to you.");
            ...
            this.outputText(
                "letting herself down your body until she can put her long legs on the ground once more."
            );
        this.outputText(
            '  She looks into your eyes contentedly, rubbing your cheek... but then starts and looks away, guilty once more.  "<i>Shit...</i>" she mumbles.  "<i>I did it again.  Even after I promised myself I wouldn\'t...</i>"'
        );
    ...
    private normalSheilaPregNotifNumberOneYepIssue(): void {
        this.clearOutput();
        this.outputText(
            '"<i>I see,</i>" Sheila says, nonplussed.  "<i>I\'m sorry you feel that way...  Truth be told, I\'m not keen myself on the idea of having a kid, but what\'s out is out.</i>"'
        );
    ...
    private normalSheilaPregNotifREPEATEDED(): void {
        this.clearOutput();
        this.outputText(
            "Sheila is here as you step into the plains, with a grass-wrapped parcel of food open on her lap and her hat sitting upturned next to her, and waves you over."
        );
        ...
        if (SheilaScene.rand(10) < 7)
            this.outputText(
                "healthy.  It's eating a lot... frankly, it's a little hellraiser with a strong grip, and it cries well, too.</i>\""
            );
        else
            this.outputText(
                "weak... we thought we were going to lose it for a bit.  It wouldn't drink from the nurse unless I was there, so I had to stay up with it all night myself.  Feeling a bit stuffed.</i>\""
            );
        this.outputText(
            "  She looks over at you, giving you the benefit of her fatigue-lined eyes."
        );
        ...
        if (
            (this.player.spe > 80 && this.player.findPerk(PerkLib.Runner) >= 0) ||
            this.player.isTaur() ||
            this.player.isNaga() ||
            (this.player.canFly && this.player.hasKeyItem("Bow") >= 0)
        )
    ...
    private normalSheilaPregNotifREPEATEDEDLetHerGo(): void {
        this.clearOutput();
        this.outputText(
            "Nothing you can do about that - even if you wanted to watch your baby for her, she's keeping it hidden in a hole in the ground.  You hand her the parcel back"
        );
        if (this.player.cor < 40)
            this.outputText(", imploring her to eat the rest and keep up her strength");
        this.outputText(
            '.  Sheila smiles weakly and takes it, folding the grass around again.  "<i>Thanks, [name].  I\'ll see you soon... ish.</i>"'
        );
    ...
    private normalSheilaPregNotifREPEATEDEDWalkWithHer(): void {
        this.clearOutput();
        this.outputText(
            "You pick up her forgotten hat and rise as well, carefully refolding the grass around Sheila's uneaten lunch and tucking it back into her pack for her.  She takes her hat back from you distantly."
        );
        ...
        this.outputText(
            ' next to her, easily keeping pace with the tired woman, and she raises her face to you inquiringly.  "<i>What\'s up, [name]?</i>"'
        );
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOut(): void {
        this.clearOutput();
        this.outputText(
            "You pick up her forgotten hat and set it on her head, then fold her lunch back into its grass wrapper and tuck it into her pack."
        );
        ...
        //(else spd >= 80 and Runner perk)
            ...
            if (this.player.lib < 50)
                ...
                this.outputText(
                    "you slap her on the ass, grabbing a handful and taking her mind off her own misery."
                );
            this.outputText(
                '  "<i>Dammit, [name]... not now,</i>" she frowns, pulling away from you.'
            );
            ...
            this.outputText(
                ", making a long loop around to the rear of the wary animal, then begin to systematically drive it closer to your partner, who has strung a line to the base of a shrub and is gesturing at you to force the hare into it."
            );
        ...
        if (this.model.time.hours + 4 < 21) this.doNext(this.camp.returnToCampUseFourHours);
            ...
            this.addButton(
                0,
                "StayWithHer",
                this.normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE
            );
            if (
                !(
                ...
                this.addButton(
                    1,
                    "To Camp",
                    this.normalSheilaPregNotifREPEATEDEDHelpABitchOutTOCAMP
                );
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDWELP(): void {
        ...
        if (this.player.cor < 50)
            this.outputText(
                "  You set a hand on Sheila's shoulder to steady her a bit as the tears start to fall."
            );
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE(): void {
        this.clearOutput();
        this.outputText(
            "With a wan smile, you pull the woman to her feet.  She doesn't resist, but continues looking into your face disconsolately.  \"<i>I'm so stonkered I can't even think what to do first...</i>\""
        );
        ...
        if (this.player.isGoo()) {
            this.outputText(
                "  She considers for a moment, rubbing away some of the slime you've deposited on her shorts, and pulls free from your slimy skin again.  \"<i>Um... do you... would you be offended if I took my kit off, so it doesn't get ruined?</i>\""
            );
            if (this.player.lib >= 40)
                this.outputText(
                    "  The leer you display is so prurient that she seems on the verge of reconsidering, but you compose yourself and"
                );
        ...
        //(naga)
            ...
            if (this.player.lib >= 40)
                this.outputText(
                    " - but tighten the one sliding across her breasts just slightly.  Sheila's neck turns red and her ears twitch as you rub her nipples, and you plant a kiss on her nape"
                );
            this.outputText(
                '.  "<i>Ahh,</i>" she sighs, shifting in your coils.  "<i>Hold it right there...</i>"'
            );
        ...
        //(horse and >=5ft)
            ...
            if (this.player.sens >= 40)
                this.outputText(
                    "... or would be, if you weren't distracted by the nipples poking into you and the thighs squeezing your flank"
                );
            this.outputText(".");
        ...
        this.outputText(
            " flowing, unsure if you'll be able to get to sleep, but Sheila has no such problems.  Within minutes, the woman is out, head nodding forward.  You suppose that means the first watch is yours... it passes slowly, despite the scenery, but eventually you nudge your partner awake when you can stay up no longer."
        );
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE2(): void {
        ...
        this.statScreenRefresh();
        this.outputText(
            "Your sleep is fitful, but not totally useless, and you yawn and stir a few hours later when Sheila wakes you"
        );
        if (this.player.isGoo())
        ...
        if (this.player.lust < 30)
            this.outputText(
                '  You give her a hand, then help her load up.  She gives you a peck on the cheek before she departs.  "<i>Thanks, love.</i>"'
            );
        if (this.player.lust >= 30) {
            this.outputText(
                "  Part of you is actually sad to see your cozy hovel being disassembled if it means her warm body won't be pressed up against yours anymore, and your hands begin to rove over her as she works."
            );
            ...
            this.addButton(
                9,
                "LeaveHerBe",
                this.normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDEREBUTLEAVEHERBE
            );
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDEREBUTLEAVEHERBE(): void {
        this.clearOutput();
        this.outputText(
            'You relent, allowing the woman to free herself with a peck on your cheek.  She loads up her catch, and then turns to you.  "<i>Thanks, [name].  Owe you one.</i>"'
        );
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutTOCAMP(): void {
        this.clearOutput();
        this.outputText(
            "Wordlessly, you lift the bundle of game animals off of Sheila's shoulders and sling it over your own.  She looks up at you, confused enough to forget about her tears.  \"<i>What're you doing?</i>\""
        );
        ...
        //(else if PC has Jojo and Jojo's n.watch is on)
            ...
            this.player.findStatusAffect(StatusAffects.JojoNightWatch) >= 0 ||
        ...
        if (this.player.inte >= 60)
            this.outputText(
                '"<i>The baby will be fine,</i>" you venture, hazarding a guess.  "<i>It\'s what the nurses are there for.</i>"'
            );
        ...
        if (
            ...
            this.outputText(
                "  She extends one bird to you and another to Jojo.  He raises his hand and shakes his head, but politely."
            );
        else if (this.flags[kFLAGS.ANEMONE_WATCH] > 0)
            this.outputText(
                "  Sheila offers you one of the birds, then extends another to your odd tenant.  The anemone's mouth tightens and she shakes her head vigorously, blushing a deep blue."
            );
        this.outputText(
            "  You eat in silence until the food is gone, and Sheila clears her throat."
        );
        ...
        //(if watch)
            ...
            if (this.flags[kFLAGS.SLEEP_WITH] != "")
                this.outputText(
                    "She looks with some distaste at the nearby sleeper, and steps past.  You pick up the bedroll and follow her, reasoning that if she keeps her promise to be gone before dawn, it shouldn't raise any questions.  \"<i>Making friends, I see,</i>\" Sheila mutters... but as you unroll the bed again, her eyes zero in on it like a drowning man's on a raft, and she says nothing else.  "
                );
            this.outputText(
                "She lies down first, allowing you to cozy up to her as far as you dare.  Just as you're about to drift off, you feel Sheila take your hand and pull your arm over her body."
            );
        }
    ...
    private sheilaGoesDemon(): void {
        ...
        if (this.flags[kFLAGS.SHEILA_XP] < -2)
    ...
    private demonSheilaEncounter(): void {
        this.clearOutput();
        this.outputText(
            'A shadow drops out of a low tree behind you with a rustle.  "<i>Hey, lover; been a while... how about spending some time with me?</i>"'
        );
    ...
    private demonSheilaResist(): void {
        this.clearOutput();
        this.outputText(
            'You back away from the demon and raise your [weapon] with a dour glower.  Sheila purses her lips at you, then says, "<i>Not in the mood, eh mate?  I\'m so horny though... I bet I could get you into it.  Let me show you how much I love you...</i>"  Her ears twitch furiously, belying her intentions as she'
        );
        //[(sheila corruption < 30)
        if (this.sheilaCorruption() < 30)
            this.outputText(
                " thrusts her black spade forward and smears some of the constantly-oozing fluid from its tip down the length with her hand"
            );
        ...
        this.outputText(
            ", but as she giggles sadistically and starts to approach, you tense up again.  It's pretty clear by the way she swaggers dismissively that she isn't taking the rejection well!"
        );
        //go to fight
        this.startCombat(new Sheila());
    }
    ...
    private demonSheilaTalk(): void {
        this.clearOutput();
        this.outputText(
            "Questions nag at you, and you ask Sheila if she wouldn't mind answering a few of them.  She struts over and "
        );
        //[(not horse)
        if (!this.player.isTaur())
        ...
        this.outputText(
            ".  \"<i>Anything for you; I'll just find something to occupy my attention.  What's on your mind, love?</i>\""
        );
    ...
    private askDemonSheilaAboutDahChange(): void {
        ...
        if (this.flags[kFLAGS.SHEILA_CITE] >= 1) {
            this.outputText(
                'Sheila blushes deeply.  "<i>Silly.  You were there.</i>"  She looks at you, pupils dancing as she remembers the lovemaking session that led to her current form.  "<i>I suppose that\'s not what you\'re asking, though.</i>"'
            );
            this.outputText(
            ...
            this.outputText(
                '.  "<i>Every squeeze of my pussy compressed my focus, too, until my mind was clearer than the juice you made me flow with.  I realized my purpose there, with you.</i>"'
            );
            this.outputText(
    ...
    private askDemonSheilaAboutHerColony(): void {
        ...
        this.outputText(
            ", you ask what happened to him.  Sheila smiles serenely before answering.  \"<i>Unsurprisingly, his prick was all too eager to fill me with sperm after the countless sermons he preached about it being every woman's duty to expand the clan.  He barely lasted three minutes when I climbed atop him.  Oh, that little squirt was the most satisfying one.  Watching him melt under me drove home how much power I've always had... I wish I could have known when I was just an awkward little girl, sitting through his browbeating lectures on loyalty and servitude.</i>\""
        );
        this.outputText(
        ...
        this.outputText(
            '.  Sheila, peeking at you with one eye from under her bangs, interprets your expression correctly.  "<i>Wondering where the others went, love?</i>"  She releases her grip on your arm and holds out the hand that\'s not exploring your [armor], displaying several rings.  "<i>The rings are my closest.  I kept them for sentimental reasons.  The rest, well... I ate them.</i>"'
        );
        ...
        if (this.player.hasCock())
            this.outputText(
                "she ties you down and rides you until she's so full of your spunk that she can push it back out just by pressing on her stomach"
            );
        else
            this.outputText(
                "she binds your hands and sits on you, teasing your helpless body with her oozing, throbbing spade until she comes all over you, spraying dark slimy fluid from it"
            );
        this.outputText(".  You ");
        if (this.player.cor < 50) this.outputText("break eye contact, blushing");
        else
            this.outputText(
                "stare into her shining eyes, getting hotter and hotter as the vision plays out to the very end"
            );
        this.outputText(".");
    ...
    private talkToDemonSheilaAboutWhatNow(): void {
        ...
        this.outputText(
            '"<i>What will I do now?  What else, my silly love?</i>"  Sheila looks out over the plains.  "<i>I\'m always hot for you.  We could have a bit of a naughty, and make each other feel good.</i>"'
        );
        ...
        if (this.flags[kFLAGS.AMILY_OFFER_ACCEPTED] > 0)
    ...
    private demonSheilaTalkAnotherQuestion(): void {
        ...
        if (this.player.lust <= 99) {
            ...
            this.outputText(
                ' even as she smiles encouragingly.  "<i>Sure, mate.  Amuse yourself.  I certainly intend to.</i>"'
            );
    ...
    private demonImpChildren(): void {
        this.clearOutput();
        this.outputText(
            '"<i>[name]!</i>"  A swishing in the grass behind you is the only prelude you get to a nude Sheila pressing herself against you in a hug, '
        );
        ...
        if (this.sheilaCorruption() < 40)
            ...
            this.outputText(
                "her enormous, pendulous breasts practically parting around you to wrap you up alongside her arms"
            );
        this.outputText(".");
        ...
        if (!this.player.hasCock())
            this.outputText(
                '  Or, had...</i>" she finishes with a frown as she reaches your bare groin.  "<i>Where\'d you leave that magnificent old fella?  I was lookin\' forward to another go.</i>"  She pulls her hand out, then leans toward you with a pout.  "<i>I\'m so horny, too...</i>"'
            );
        //(if cock)
        else {
            this.outputText(
                '  Still, it\'s not the same as having you inside me...</i>"  She squeezes the neck of your [cock] and then pulls her hand away, slipping it between her own legs.  "<i>I was thinking you could help me make another, and maybe up the population of men worth a damn around here.</i>"  Reclining, she spreads her thighs, pulling apart her small, smooth labia '
            );
            ...
            //(else)
                ...
                this.outputText(
                    "with her split tail while she cradles her massive tits to make sure you see the open invitation"
                );
            this.outputText(
    ...
    private pregDemonSheilaOtherSex(): void {
        ...
        if (this.player.hasCock()) {
            this.outputText(
                "\"<i>Well now, I think I get a say, don't I?  I was really hoping to have your seed inside me... it's practically worth bottling.</i>\"  She "
            );
            if (this.sheilaCorruption() >= 80)
                this.outputText("heaves onto her feet, heavy breasts swaying");
            else this.outputText("nimbly hops to her clawed feet");
            this.outputText(
                ", and runs her hands distractingly along the curves of her hips.  \"<i>You can do what you like with my body, love... if you can convince me.  Of course, I'll claim the same privilege!</i>\"  Sheila jumps at you, leaving no doubt what kind of 'convincing' she expects to do!"
            );
            this.startCombat(new Sheila());
        }
        //(if no cock)
    ...
    public loseToSheila(consensual: boolean = false): void {
        ...
        if (this.player.HP < 1 && !consensual) {
            this.outputText(
                "Your erstwhile opponent's eyes glimmer with excitement as you collapse from your injuries, and she runs over to you.  The demon strips off your [armor] eagerly, but you can't stay awake for the fun.  Consciousness slips away and you pass out."
            );
            //--Next--
    ...
    private loseToNormalSheilaAndGetRidden(): void {
        ...
        if (this.player.isTaur())
            this.outputText(
                " and you're forced to put your forelegs down for support as you come to rest on your haunches"
            );
        else
            this.outputText(
        ...
        if (this.player.cockTotal() > 1)
            this.outputText(
                '"<i>All of these look ripper, but... I want this one today,</i>" she says, selecting your [cockFit 56].  '
            );
        this.outputText(
            'She wraps her hand around it and begins pumping up and down, squeezing out a drop of precum that she smears onto her palm.  "<i>You\'re so eager,</i>" Sheila giggles.  "<i>Are you already about to burst?  That\'s no good... I wanted to play a bit more.</i>"'
        );
        ...
        if (this.player.hasCock())
            this.outputText(
                " and slipping the unused remainder of your manhood between her thighs"
            );
        this.outputText(
        ...
        if (this.player.balls > 0) {
            ...
            if (!this.player.isTaur())
                this.outputText(
                    "  Sheila takes your face in her hands and presses it into her breasts as she reassures you."
                );
            this.outputText(
            ...
            this.outputText(
                ' just like she\'s dumping feelings into your head.  "<i>Lover!</i>" she screams.  "<i>Pack me with your babies!</i>"'
            );
            ...
            this.outputText(
                ", displacing a glob of cum from her pussy that's soon followed by others as you ejaculate once more.  The jizz is so dense with sperm that it's thick, almost colloidal; it jiggles on her skin, barely sliding downward as your hips ram against hers.  It takes nearly "
            );
            //(normal skeet)
            ...
            this.outputText(
                " more orgasms, but finally your balls empty of their demonically-induced load and your lover pulls away and stands up."
            );
        ...
        //(else if no balls)
            ...
            if (this.player.cumQ() >= 1000)
                this.outputText(
                    "; she quickly reaches capacity and pulls off, jerking your messy, slimy [cockFit 56] and letting you squirt the last of your strokes all over her face and chest"
                );
            if (this.player.cumQ() >= 6000)
                this.outputText(
                    ".  So much is left that she's practically underwater by the time you're finished; she giggles and bubbles form in the oozing liquid covering her lips"
                );
            this.outputText(".");
    ...
    private tailSpadeSoundingForFuckHugeDongsWithDemonSheila(): void {
        ...
        this.outputText(
            ".  Your hips automatically try to push your dick further into her warm hole but only succeed in unbalancing her, forcing the demon onto her hands.  As your climax winds down, your head leans back and your cock slips from her vulva, squirting the last stroke onto her ass."
        );
    ...
    private clitSwellingDemonSheilaClitSoundingAnal(): void {
        ...
        if (!this.player.isTaur())
            this.outputText(
                "Sheila places her hand in the small of your back and leans in, drawing closer to your face even as she pulls your waist inward."
            );
        else
            this.outputText(
                "Sheila sets her hand atop your withers, pressing down gently as she looks into your eyes."
            );
        this.outputText(
            '  "<i>Why don\'t you relax, [name]?  Lie down and let me take care of you...</i>"  Her eyelids lower and her mouth spreads in a sly smile, and for just a moment you lose your nerve, looking into her devilish expression.  "<i>Don\'t worry, love,</i>" she says, straightening her face.  "<i>I promise you\'ll enjoy this.</i>"'
        );
        ...
        //(Equus ferus caballus)
            ...
            this.outputText(
                "circles you until she reaches your rump, then turns around and kneels down herself, looking at you over her shoulder."
            );
        this.outputText(
            "  Her black, spaded tail lifts from between her thighs and snakes toward your pussy,"
        );
        //[(if manparts)
        if (this.player.hasCock()) {
        ...
        this.outputText(
            " thing doing growing from a pretty girl like you?  It's just the perfect size for some fun.</i>\""
        );
        ...
        if (this.player.clitLength <= 6)
            ...
            this.outputText(
                "Though you're by now accustomed to the sight of your clitoris, more like a cock than a dainty feminine bump, this is something else altogether!  The huge thing poking into her tail is almost twice the thickness of the slim growth you remember and bulges with blood vessels; as you watch it, transfixed, a trickle of Sheila's oily, dark secretion slides down it, then is absorbed into some flesh near your groin, adding another layer of width with a pulse!"
            );
        this.outputText(
            '  "<i>Fuck, it\'s so tight!</i>" the demon gasps, now resting on her elbows with her chest and face pressed to the grass.  Her tail jerks again, yanking your stalk this way and that and releasing more of her backed-up fluids.  They slide all the way to the bottom of your rod before sinking into your skin.'
        );
        ...
        if (this.player.clitLength <= 6) {
            ...
            if (!this.player.isTaur())
                this.outputText(
                    "Taking your face into her hand, she closes your jaw and then leans in to plant a kiss on your chin."
                );
            else this.outputText("Her eyes glitter with mirth.");
            this.outputText(
                '  "<i>Why the look, mate?  Seems like you\'re saturated for now, and just in time.  This... is...</i>"  She pulls her tail up from the end of your clitoris, then slides it back down, slowly.  "<i>... perfect!</i>"  As her tight hole swallows your sensitive distaff staff once again, your eyes roll and her head drops, dragging her hair'
            );
            //[(horse)
            ...
            if (this.player.cor < 50) {
                ...
                this.outputText(
                    ', and your clit swells even further inside your tormented partner.  Sheila groans, "<i>Fuck you, [name]...</i>"'
                );
        ...
        //(else if clit >6" initially)
            ...
            this.outputText(
                '.  She half-smiles and half-winces at you.  "<i>Don\'t usually take it in this hole, but I wanted to feel your pussy going crazy for me.</i>"  '
            );
            if (this.player.clitLength <= 12)
                this.outputText(
                    "Her hips shift, dragging her lips across yours and stirring your clit through her asshole even as it squeezes you; your pussy twitches at the stimulation."
                );
            else {
                this.outputText(
                    "Her tails, one still swollen from being stretched and tormented by your growing clit, slip into you abruptly, bringing their mild burning sensation with them; if you hadn't been saturated with it already, you'd probably pass out."
                );
                //[(if virgin vagina)
                if (this.player.hasVirginVagina())
                    this.outputText(
                        '  "<i>What\'s this?</i>" Sheila teases.  "<i>Why, your virtue is still intact, little girl!  I wouldn\'t want anything to happen to it!</i>"  She pulls her tails out a bit, contenting herself with simply teasing your lips and driving you mad for penetration.'
                    );
                this.outputText(
                    "  The demon shifts around your clit, sending a wave through you that makes your lips wrap around the invaders."
                );
            }
            ...
            if (this.player.clitLength <= 12)
                this.outputText(
                    "pussy; her smooth, small labia greedily lap at the fluid when they touch, brushing against yours and drawing further twitches and squirts."
                );
            else
                this.outputText(
            ...
            if (this.player.clitLength <= 12) {
                this.outputText(
                    "  Her tails sink into you as she squirms, parting your lips and pushing their way inside."
                );
                //[output hymen check, but don't remove virgin flag yet]
                if (this.player.hasVirginVagina())
                    this.outputText("  <b>You've lost your virginity!</b>");
                this.outputText(
                    "  Buried in your pussy, the spade begins drooling its black fluids in greater and greater volume as Sheila is wracked by her orgasm."
                );
            }
            ...
            if (this.player.clitLength > 12 && this.player.hasVirginVagina()) {
                this.outputText(
                    "  \"<i>Sorry about your hymen, love, but I just couldn't resist making a sweet little slut like you into my girl.  I hope you'll remember me - I only wish I had a proper donger so I could give you my baby, too.</i>\""
                );
            }
            this.outputText(
                "  Even as tired as you are, what you see on the demon girl makes you laugh.  She starts at this, then follows the direction of your gaze; "
            );
            if (!this.player.isTaur())
                this.outputText("her tits are covered by grass stains from her frenetic pumping.");
            else
                this.outputText(
                    "craning around shows her that her asscheeks are completely green and wet with torn grass from slamming into you so violently and repeatedly."
                );
            this.outputText(
                '  "<i>... Oh, god dammit,</i>" Sheila gripes.  She walks over and forces your face into them with a long, slow shake, then giggles as a joke comes to her.  "<i>There, [name]; I\'ve stained you with my colors!</i>"  She plants a long kiss on your grass-smeared forehead, then drops you back to the ground, straightens up, and departs.  Exhausted, you slip into a doze, wondering if you\'ll be able to fit your swollen clit back into your clothing when you wake or if you\'ll have to walk back to camp with it sticking out.  It slowly deflates as you sleep, but does retain a bit of additional length.'
            );
        }
        ...
        if (this.player.findPerk(PerkLib.BigClit) >= 0) this.player.clitLength += 0.5;
        if (this.player.cor < 50) {
            this.dynStats("cor", 10);
            this.sheilaCorruption(-10);
        } else {
    ...
    private aintGotNoGenderAndKangarooRaped(): void {
        this.clearOutput();
        this.outputText(
            "Sheila sashays over to you and brazenly sticks her hand in your featureless crotch.  \"<i>It's too bad you've mutilated yourself like this, love... or did you do it just to tease me?  You know, it doesn't bug me that much.</i>\""
        );
    ...
    public beatUpDemonSheila(output: boolean = true): void {
        if (output) {
            this.clearOutput();
            this.outputText(
                '"<i>Ahh, you win, mate.  I give up.</i>"  Sheila slumps to the ground, '
            );
            if (this.monster.HP < 1)
                this.outputText(
                    "and her wounds begin to close with a soft lilac glow.  \"<i>So fuckin' strong.  I don't suppose you've got any sperm for me, do you?  I'd love to have some of your kids...</i>\"  She looks at you beseechingly, gently fingering herself."
                );
            //(lust)
            else
                this.outputText(
                    'frigging herself vigorously.  "<i>Do with me what you will, lover; those were the terms.  Won\'t you take my body to satisfy yourself, you brute?</i>"  The audacious woman sticks her tongue out, as if to goad you into treating her roughly.'
                );
        }
        //[(lust < 30)]
    ...
    private missionaryForThePurposesOfCreatingImpsWithSheila(): void {
        this.clearOutput();
        this.outputText(
            "You unfasten your [armor] and strip down completely, as Sheila's eyes drink up your bare flesh.  Denuded, you caress your cock with several strokes, producing a drop of precum."
        );
        ...
        if (this.player.cor < 40)
            this.outputText(
                "Your ardor subsides a bit at her performance, but seeing your look of contrition, "
            );
        else this.outputText("Your scowl hardens at her shameless playacting, and ");
        this.outputText(
            "she breaks into laughter.  \"<i>I'm just having you on, love.  You know my body's yours for the using.</i>\""
        );
        ...
        this.outputText(
            ' and her pupils dance in excitement; for a moment you even lose yourself in her enthusiasm, forgetting her demonhood and seeing only an earnest, adoring girl under you.  "<i>Now, push!</i>"'
        );
        ...
        this.outputText(
            'as a twinge of sensation from your thrust provokes a gasp and forces her to reposition herself, to better find it again.  "<i>That\'s the spot!  Your dick is the <b>best!</b>  Pound me, you fucking cum-hose!</i>"'
        );
        ...
        if (this.player.isTaur()) {
            this.outputText(
                ", practically lifting herself off of the ground] as she impales her cunt on your [cockFit 56] to prevent you from pulling out."
            );
        }
        //[(silly)
        if (this.silly())
            this.outputText(
                "  \"<i>Make me feel like I'm fifteen years old again and playin' with the dog-morphs in the field!</i>\"  Heavens to Betsy!"
            );
        else
            this.outputText(
                "  \"<i>This is what you're here for!  Don't spill a single drop!</i>\""
            );
        this.outputText(
        ...
        this.outputText(
            "; her eyes glow and it briefly feels as though her body is sucking the ejaculate right out of you"
        );
        if (this.player.cumQ() >= 500)
            this.outputText(
                ", until she fills up and the rest of your orgasm is drooled out at its own lazy pace"
            );
        ...
        if (this.player.cumQ() >= 500 || this.player.cockTotal() > 1)
            this.outputText(
                "spilled some.  I can't have your baby if you're fucking the grass.  And you "
            );
        ...
        //(else if RNG doesn't end scene)
            ...
            if (this.player.hasVagina())
                ...
                this.outputText(
                    " as her imp spawn gather around, stroking themselves and occasionally squirting their hot, tainted cum on her body or yours as orgasm takes them"
                );
            this.outputText(".  ");
            if (this.player.lib < 40) this.outputText("Shocked");
            else this.outputText("Flushing hotly");
            this.outputText(
                ", you look away and break the connection, but Sheila's smile only widens."
            );
            ...
            if (!this.player.isTaur())
                this.outputText(
                    "You kiss Sheila on the lips, pushing your tongue through to play with hers, as your arms push your spent body into position to thrust again."
                );
            else
                this.outputText(
                    "You reach down with a hand and place it alongside Sheila's face; her ear twitches as she looks at you brightly, and for a moment you recapture your earlier impression of her as a sweet, devoted lover.  Your legs struggle to push your equine bulk upwards as you return to a thrusting position, dragging her groin into the air by your erect cock."
                );
            this.outputText(
            ...
            if (this.player.cor < 50)
                this.outputText(
                    "Her pussy convulses as she orgasms, and you feel a wave of heat overtaking your [cock biggest], starting at the tip and moving down the shaft.  As it reaches the base, a gush of her fluids breaches the seal her pussy makes around you, forcing your jizz out along with it in a mixed white and clear squirt.  The demon's vagina squeezes and drools for half a minute, pouring her tainted liquid love out against your tightly-held body until your crotch is soaked with her sticky heat and responds with its own."
                );
            else
                this.outputText(
                    "Her pussy sucks you in as she climaxes, and you can feel larger and larger waves of precum being pulled from your shaft; it almost feels like she's tugging at your entire being.  It's not long before your cock twitches and begins giving her greedy sex a second helping of your semen."
                );
            this.outputText(
                "  She goes limp as her twitching cunt takes over and begins drinking every drop it can get from your dick to replace the goo you pushed out"
            );
            if (this.player.cumQ() >= 500)
                this.outputText(
                    "; you nearly manage to fit it all into her this time, with your production still flagging from the last session"
                );
            this.outputText(
                ".  Muscles weakening again, you lower yourself onto her once more and allow her to stroke your "
            );
            if (!this.player.isTaur()) this.outputText("back");
    ...
    private analHateFuck(): void {
        this.clearOutput();
        this.outputText(
            "Fucking bitch, playing with herself like nothing's the matter and you didn't just show her concrete proof of your superiority.  Part of you feels like punishing the insolent woman yourself, pounding her insides and dumping your load without a whit of regard for her own pleasure... but another part is thinking it might be fun to see her completely debased, to hammer home how pathetic she is - something like reducing her to a cock-sleeve for your personal cum-slave."
        );
    ...
    private sheilaAnalHateFuckAGoGo(): void {
        this.clearOutput();
        this.outputText(
            'Your [cockFit 56] gets hard in your [armor] as you watch her diddle her pussy, but you set your jaw to resist giving her what she wants - a better idea is taking shape in your head.  "<i>Turn around,</i>" you demand.'
        );
        ...
        this.outputText(
            ", you pull your hips back and line the [cockHeadFit 32] up, then thrust - right into her asshole.  Her head raises and her teeth grit as you force the slick tip past her ring.  \"<i>[name], what the fuck?!  That hurts!  Go easy if you're going to use that hole; I'm not good at stretching my body yet!</i>\""
        );
        ...
        this.outputText(
            "force your dick into the angry woman.  \"<i>You talk a good game about how you love being full of cock, but when I shove one in you, you get all bitchy and act like you're not ready; why don't you just shut up and get fucked, slut?</i>\""
        );
        ...
        if (this.sheilaCorruption() >= 90)
            this.outputText(
                "; her enormous, cushiony breasts spread under her as your prick forces her weight heavily onto them"
            );
        this.outputText(
            '.  She pulls up tufts and pounds the earth impotently with her fists while you sink in as far as you can.  "<i>Fuck you!  What the fuck is wrong with you, arsehole?!  Let me go, I don\'t want anything to do with you anymore!</i>"'
        );
    ...
    private sheilaAnalHateFuckAGoGoNO(): void {
        this.clearOutput();
        this.outputText(
            '"<i>Go to hell.</i>"  You bury yourself in the demon\'s ass as your dick begins to spasm.  Her tails writhe as the first trickle sinks into her.  "<i>What?  Say something, I dare you.</i>"'
        );
        ...
        if (this.player.cumQ() >= 500)
            this.outputText(
                '  Your overproduction floods her insides, and Sheila groans as it begins to leak back out, drooling over her pussy.  "<i>Hey, you got your wish,</i>" you tease.  The wanton woman tries to tilt her ass higher, to tip more of your overflow into her cunt, but you laugh and slap her hard on the hip, sending her to one knee again.'
            );
    ...
    private sheilaAnalHateFuckAGoGoGETYOUSOMEWORMS(): void {
        ...
        this.outputText(
            ' squirm, giving you pause, and you pop your [cockFit 56] out.  "<i>Actually... I don\'t think I suit you at all.</i>"'
        );
        ...
        this.outputText(
            ', you can actually feel your pent-up pets, eager to be let out to play.  "<i>No,</i>" you say, "<i>I know what\'s more your speed.  Trash like you should be cast down into the dirt, and should keep company with the creatures of it.</i>"  Sheila seems alarmed, but as you slip into her grasping pussy, she forgets her question, grinding her hips into you to milk you dry.  You focus, forcing a wave of slimy annelids down your shaft.  "<i>Here come your new babies!</i>"'
        );
    ...
    private analHateFucksWithJojo(): void {
        this.clearOutput();
        this.outputText(
            "Watching her sit there and play with herself like nothing's the matter and you didn't just demonstrate her weakness for all the world to see touches a nerve deep inside you.  You scowl and focus your thoughts to call your mousey ex-monk, bent on showing this demon how a proper mendicant should behave."
        );
        ...
        if (this.sheilaCorruption() < 40)
            this.outputText(
                "\"<i>What's with these tiny titties?  Could any man possibly be aroused by your bug bites?  I've seen bigger breasts on incubi!</i>\""
            );
        else
            this.outputText(
                '"<i>These disgusting sacks of fat on your chest... are you under the impression that men like giant stretch marks and nipples that hang to your knees?  Why don\'t you get in shape, you messy bitch?</i>"'
            );
        this.outputText(
    ...
    private jojoRuinsTheAnalHateFuck(clear: boolean = true): void {
        ...
        this.outputText(
            'Your mouth spreads in a sickly smile as you contemplate granting her request anyway.  "<i>Jojo...</i>"'
        );
        ...
        this.outputText(
            ".  The mouse himself seems to be growing, in fact.  His feet kick and thrash, sprouting dangerous-looking nails as his legs stretch prodigiously.  As his body mass increases, his white-furred skin begins to burst and peel like old rags, revealing new, dark flesh underneath."
        );
    ...
    private bigDickAndThighs(): void {
        ...
        if (this.player.cor < 40) {
            ...
            this.outputText(
                " toward her and aim underneath her cunt to rub your [cockHead biggest] against her palm, smearing a glob of precum on it.  You can see her shivering wordlessly, sliding her fingers together to play with the hot, clingy fluid, making translucent webbing between them."
            );
            //[(multi)
            if (this.player.cockTotal() > 1) {
                ...
                this.outputText(
                    ' of them... slide them here, love,</i>" the demon insists.  You line the remainder of your manhood up and force it between her thighs as well.'
                );
            }
            this.outputText(
            ...
            if (!this.player.isTaur() && this.player.tallness >= 60)
                this.outputText(
                    "She unbends and kisses you on the cheek, and your face feels a bit fuzzy where her lips touch.  "
                );
            this.outputText(
            ...
            this.outputText(
                " and angling upward so the precum drools downward and lubes her fingers."
            );
        }
        //(else corr >= 40)
            ...
            if (this.player.cockTotal() > 1) {
                ...
                if (this.player.cockTotal() == 2)
                    this.outputText(
                        ", you slide it through her legs between your first cock and her cunt, plowing through her entrance like a furrow; she quakes and you can feel it contracting against your skin.  "
                    );
                else
                    this.outputText(
                        "s, you push them through the woman's legs one by one, smearing warm precum on her thighs as you do; her pussy squeezes against the top of your [cock biggest] as you coat her skin with your fluids.  "
                    );
            } else this.outputText("\n\n");
            this.outputText(
                "Sheila scoots backward, choking up on monster cock until her ass is pressed against your crotch, and then wraps her hands around and begins to masturbate you, using your drooling fluid and her own wetness for lubrication."
            );
        ...
        this.outputText(
            "focus on squeezing more drops out of you.  She fairly coats her lips with it, rubbing your hole against them before popping the whole [cockHead biggest] back into her mouth.  A moan escapes you just as another one returns from Sheila's throat, transmitted through your [cock biggest]."
        );
        ...
        if (this.sheilaCorruption() < 50)
            this.outputText(
                "  Though her modest breasts can't even begin to encompass your girth, Sheila rubs her cleavage along your skin with gusto while she works your tip with her tongue."
            );
            ...
            this.outputText(
                "  The demon's ridiculously enormous breasts easily cover the entire length of your cock"
            );
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(
        ...
        if (this.sheilaCorruption() >= 150) {
            this.outputText(
                "Her enormous breasts dangle all the way to the ground, forming a second, softer hole to push into with your swollen prick"
            );
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(".  ");
        }
        ...
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(
            " from between her still-squeezing thighs with a shudder; Sheila shudders with you until you finally draw free and break skin contact, then lowers herself carefully to the ground.  The demon turns toward you, exposing a face and chest splattered with your semen.  She stares at your deflating prick"
        );
        if (this.player.cockTotal() > 1) this.outputText("s");
        ...
        this.outputText(
            'I can put it in you any time I want.</i>"  She sticks her tongue out at you, and the seed dripping from her lips oozes onto it.'
        );
    ...
    private winAgainstDemoNSheilaForVaginas(): void {
        ...
        this.outputText(
            "and grind your pussy desperately against her midriff.  She slips two fingers into you obligingly, but you "
        );
        if (!this.player.isTaur())
            this.outputText(
                "grab her face, plunging one thumb into the corner of her mouth in your haste, and"
            );
        else this.outputText("turn your head and");
        this.outputText(
            " stare right into her eyes.  Focusing as hard as you can on your fantasy, you try to transmit your desire for something more to the demon by sheer force of will.  A sly smile parts her lips as she stares back - could this actually work?"
        );
        ...
        if (!this.player.isTaur()) {
            ...
            //[(tail or naga)
            if (this.player.tailType > TAIL_TYPE_NONE && this.player.isNaga())
                this.outputText(" and raise your tail");
        } else this.outputText("clamber to your hooves and bend your forelegs");
        this.outputText(
            " to present your eager [vagina].  Sheila sits up and places her hands on your [hips], then slides her pelvis up, teasing your lower lips with something bulbous and warm.  They sting slightly as it smears its slime along them, a not-entirely-pleasant sensation."
        );
        ...
        this.outputText(
            "  Oh, god, it burns!  You shake violently as your pussy is assaulted by the fluid from Sheila's black tail, waves of pain twisting through it and forcing its walls to clamp down on the invader.  The demon gasps as you squeeze and leans forward onto your back"
        );
        if (this.sheilaCorruption() > 0) this.outputText(", squashing her tits into you");
        this.outputText(
            '.  "<i>Calm down!</i>" she barks, grabbing your arms and pulling them toward her.  With hands held behind you like this, you can do little to check her enthusiasm... but Sheila doesn\'t begin thrusting yet.  "<i>It\'ll fade soon, love, and you\'ll start feeling it,</i>" she promises, kissing your '
        );
        if (!this.player.isTaur()) this.outputText("neck");
        else this.outputText("withers");
        this.outputText(
            " as her strange, still shaft continues drooling into your pussy.  Your groin heats up in response to the pain, and her words ring hollow.  The burning doesn't seem to be getting any better; you look back over your shoulder at her, fear and hurt evident on your tightened features.  She smiles nervously at you, but the flow of goo doesn't stop.  It feels wetter and slicker in your pussy every second, and soon you can feel the slime begin to seep back out of your [vagina].  Trickle after trickle of fluid escapes you, falling to the ground underneath."
        );
        ...
        if (this.player.cor < 50) {
            this.outputText(
                "  She pumps and pumps again, forcing more of the muck into your [vagina] even as she calls you the most filthy things she can think of"
            );
            if (this.sheilaCorruption() > 0)
                this.outputText(
                    "; her tits wobble violently as she thrusts, and then still as she arches her back and jams her spade all the way in"
                );
            this.outputText(
                ".  Sheila howls to the sky as she pours her demonic slime into you in one final, solid stream.  You can feel it pushing eagerly through even your copious fluids until it's at the entrance to your womb... and then inside."
            );
            ...
            this.outputText(
                "  She stops pumping, falling against your back and panting as the last of her goo seeps out and is ejected around her shaft by your fountainhead of girl-cum.  You are clearer-headed than before as your orgasm dwindles, though, illogically, you could swear you felt her tits growing against you."
            );
        }
        this.outputText(
