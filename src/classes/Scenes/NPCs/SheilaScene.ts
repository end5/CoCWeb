...
export class SheilaScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    private sheila1ndEncLookCloserPtII(): void {
        ...
        this.outx('  Forget it.</i>"  You deny the accusation, but she continues to glare at you.');
    ...
    private apologySheilaSlapSult(): void {
        this.clearOutput();
        this.outx("You say nothing as she finishes with the snare and stands back up.");
        this.outx(
    ...
    private sheilaReallyMad(): void {
        ...
        this.outx("Please, please leave me alone.");
    ...
    private sheilaReallyMadLeave(): void {
        this.clearOutput();
        this.outx("Huffing, you throw the animals down and turn away.  What a display.");
    ...
    private sheilaReallyMadStandGround(): void {
        ...
        // [(normal mode)]
        if (!this.silly()) {
            this.outx("You throw the animals behind you and fold your arms.");
            this.outx(
    ...
    private sheilaReconcile(): void {
        this.clearOutput();
        this.outx('"<i>Oy, it\'s you,</i>" sings out a voice behind you.  "<i>Back again?</i>"');
    ...
    private sheilaReconcileKay2(): void {
        ...
        if (this.player.lib < 50) this.outx("the beckoning hunks of meat");
        else this.outx("her rising and falling breasts under the pretext of watching her work");
        this.outx(
        ...
        // [(pc is kangaroo)
        if (this.player.race() == "kangaroo-morph") this.outx(" - except you, I suppose");
        this.outx(
        ...
        // [(lib >50)]
        if (this.player.lib >= 50) this.outx(" like yourself - I saw you perving -");
        this.outx(
    ...
    private sheilaFriendlyComeHereOften(): void {
        this.clearOutput();
        this.outx("You ask her why she enjoys being on the plains so much.");
        this.outx(
    ...
    private sheilaFriendlyHerPeoples(): void {
        ...
        if (this.player.femininity < 35) this.outx("  She looks absently at your crotch.");
        ...
        // (lib >=50)
            ...
            if (this.player.hasCock())
                this.outx(", and you raise the kids at home?  Or put them with a nanny");
            this.outx('?</i>"');

            this.outx("\n\n\"<i>Yeah, I suppose that'll work");
            if (this.player.hasCock()) this.outx(", and I'll turn the kids over to");
            this.outx(" - no, I mean, ");
            if (!this.player.hasCock()) this.outx("if I decide");
            else this.outx("I'm not ready for");
            this.outx(
    ...
    private shielaXPThreeSexyTimePostSexStayII(): void {
        ...
        if (this.player.hasCock() && this.player.cockThatFits(32) >= 0) {
            ...
            // [(horse)]
            if (this.player.isTaur()) this.outx(" and you playfully roll");
            this.outx(" onto your back; Sheila slips her leg over you");
            if (this.player.isTaur()) this.outx("r own");
            this.outx(
            ...
            // (horse)
            if (this.player.isTaur()) this.outx("barrel");
            else this.outx("chest");
            this.outx(" in her soft hair - but her hips keep pumping, incredibly.  ");
            ...
            // [(single cox)
            if (this.player.cockTotal() == 1) this.outx("your dick twitches inside her");
            // (multicox)
            else this.outx("she spies the first bead of pearly semen exiting");
            if (this.player.cockTotal() == 2) this.outx(" your lonely, unused prick");
            if (this.player.cockTotal() > 2) this.outx(" each of your lonely, unused pricks");
            this.outx(".");
        ...
        // (if no cockFit 32 and yes vag)
            ...
            // (sheila corruption > 30)
            if (this.sheilaCorruption() < 30) this.outx(" even though they're small and humble");
            // (else sheila corruption > 60)
            else if (this.sheilaCorruption() > 60)
                this.outx("; I worry that they're getting too mountainous");
            this.outx(
            ...
            if (this.player.isNaga()) {
                ...
                this.outx(" her heated, slippery vagina.");
            ...
            else this.outx(" cunt, grinding her like a sex toy in search of your own climax.");
            this.outx(
            ...
            if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption()) {
                ...
                if (this.player.isNaga()) this.outx("scales");
                else this.outx("pussy");
                this.outx(" until you can take no more of the heat and come as well.");
                // [(naga)]
                if (this.player.isNaga())
                    this.outx(
            ...
            // (else if PC corr < sheila corruption)
                ...
                if (this.player.isNaga()) this.outx("your tail");
                else this.outx("your own");
                this.outx(
            ...
            // (if cock)
            if (this.player.hasCock()) {
                this.outx("  Your neglected ");
                if (this.player.cockTotal() == 1) this.outx("prick quakes and spurts");
                else this.outx("pricks quake and spurt");
                this.outx(" weakly, drooling semen that pools on her skin.");
            }
            // [(not horse)
            if (!this.player.isTaur())
                this.outx(
        ...
        // (else if no cockFit 32 and no vag)
            ...
            if (this.player.hasCock())
                this.outx(", stroking your oversized tool despite her dismissal");
            this.outx('.  "<i>But you do?</i>"');
            ...
            if (this.player.hasCock()) {
                ...
                // (mans)
                if (!this.player.isTaur()) this.outx("falls into your lap");
                // (horse)
                else this.outx("drifts between your legs");
                this.outx(
            ...
            // (cock.length > 0)
            if (this.player.hasCock()) this.outx(", her face still covered in globby white smears");
            this.outx('.  "<i>Fuck...</i>" she groans.  "<i>You\'re a jerk, [name].');
            // [(cock.length > 0)
            if (this.player.hasCock())
                this.outx("  I can't believe you called me a goblin, you arsehole.");
            this.outx('</i>"');

            this.outx("\n\nYou ");
            // [(cock.length > 0)
            if (this.player.hasCock())
                this.outx("can't believe how much she acts like one sometimes... but you ");
            this.outx(
            ...
            // [(cock.length > 0)
            if (this.player.hasCock())
                this.outx(", even after Sheila finishes wiping her face clean and stares at you");
            this.outx(", so you just content yourself with lying next to the woman for a while.");
    ...
    private sheilaXPThreeSexyTimeGuardDuty(): void {
        ...
        // (else lib >= 40)
            ...
            // [(cock.length > 0)
            if (this.player.hasCock()) this.outx("shift your pelvis forward");
            // (cock.length == 0)
            else this.outx("stick out your tongue playfully");
            this.outx(
    ...
    private fuckBuddySheilaMeetingJustHangOut(): void {
        this.clearOutput();
        this.outx("In answer, you reach down to pinch her butt and then ");
        // [(not horse or drider)
        if (!this.player.isTaur() && !this.player.isDrider()) this.outx("scoot your own forward");
        else this.outx("fold your legs under you");
        this.outx(" to lay in the bush's shade.");
    ...
    private fuckBuddySheilaMeetingChat(): void {
        this.clearOutput();
        this.outx('"<i>Feeling talkative?</i>" Sheila asks.  "<i>Have at yer.</i>"');
    ...
    private fuckBuddySheilaMeetingChatOldLoves(): void {
        ...
        // (else lib >=50)
            ...
            // [(corr < 30)
            if (this.player.cor < 30) this.outx("; you lay a hand on her shoulder reassuringly");
            this.outx(
    ...
    private fuckBuddySheilaMeetingChatLiveWithMe(): void {
        this.clearOutput();
        this.outx("You ask Sheila to move in with you at your camp, and she turns bright red.");
        this.outx(
    ...
    private fuckBuddySheilaMeetingChatKids(): void {
        ...
        if (this.flags[kFLAGS.SHEILA_JOEYS] == 1) {
            this.outx('"<i>Ah?</i>" Sheila says, turning toward you sheepishly.');
            ...
            if (this.player.femininity > 50) {
                ...
                this.outx(" you guess, teasing her as her blush deepens.");
                this.outx('\n\n"<i>[name], stop it.</i>"');
            }
            // else if PC masculine or andro, no new PG)
                ...
                if (this.player.gender <= 1) this.outx('\n\n"<i>Sounds... protective.</i>"');
                else
                    this.outx(
        ...
        // if 1 < joeycount < 10
            ...
            this.outx('"<i>So how are the kids?</i>"');
            this.outx(
            ...
            if (this.player.lib > 50) this.outx(" and tight, hot cunt");
            this.outx(' so well...  "<i>How long does it take them to grow up?</i>"');
        ...
        // if joeycount >= 10
            ...
            this.outx('"<i>Kids doing all right?</i>"');
            this.outx(
            ...
            if (this.player.lib < 50) {
                ...
                // [(silly)]
                if (this.silly()) {
                    this.outx(" and clutching the life-sized [name] bodypillow I made");
                    this.outx(".  But it's not going to happen right now.</i>\"");
                    this.outx(
    ...
    private fuckBuddySheilaMeetingChatKidsRest4Now(): void {
        ...
        if (this.player.isTaur()) this.outx("back");
        else this.outx("lap");
        this.outx(
    ...
    private consensualSheila69(cock = true): void {
        ...
        if (cock) {
            if (this.player.cockThatFits(32) >= 0) {
                this.outx("  Though, she smiles openly when you produce your [cockFit 32].");
                this.outx(
        ...
        if (cock && this.player.cockThatFits(32) < 0)
            this.outx("  \"<i>[name], I'm telling you it won't fit!</i>\"");
        else this.outx('  "<i>Not talking, then?  Please yourself.</i>"');
        this.outx("  Her commentary cuts off as you ");
        if (!this.player.isTaur()) this.outx("turn around and hang your ");
        else this.outx("straddle her and squat down to dangle your ");
        if (cock) this.outx("pre-seeping shaft");
        else this.outx("wet pussy");
        this.outx(" over her head, waggling it provocatively as you slip your fingers into her.");

        this.outx('\n\n"<i>Ah... ah... you could have just told me,</i>" Sheila gasps, ');
        // [(cox)
        if (cock) {
            this.outx("wrapping a hand around your shaft");
            // (big)
            if (this.player.cockThatFits(32) < 0)
                this.outx(
        ...
        this.outx("\n\nYou oblige, ");
        if (!this.player.isTaur()) this.outx("flattening your back");
        else this.outx("squatting lower");
        this.outx(" so your ");
        if (cock) {
            this.outx("cock sinks down");
            // [(small cock)
            if (this.player.cockThatFits(32) >= 0) this.outx(" into her warm, waiting mouth");
            else
                this.outx(
            ...
            this.outx("pussy dangles just over her face; she ");
            if (this.player.clitLength > 8)
                this.outx("nips and sucks at the tip of your clit, rolling it with her tongue");
            else
                this.outx(
        ...
        this.outx("  Not to be outdone in creativity, technique, or audacity, you ");
        if (!this.player.isTaur())
            this.outx(
        ...
        if (!this.player.isTaur()) {
            ...
            if (cock && this.player.cockThatFits(32) < 0)
                this.outx("shaking, teasing nipples and heaving chest");
            else this.outx("mouth, humming in delight");
            this.outx(".");
        }
        // (horse)
        else {
            ...
            if (cock && this.player.cockThatFits(32) < 0) this.outx("hard nipples");
        ...
        this.outx("  Her vagina convulses, ");
        // (pc corr >= 90 or > sheila corruption
        if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS.SHEILA_CORRUPTION]) {
            this.outx("trying to pull your ");
            if (!this.player.isTaur()) this.outx("tongue");
            else this.outx("fingers");
            this.outx(
        ...
        // (PC corr < sheila corruption)
            ...
            if (!this.player.isTaur()) this.outx("mouth, filling you with her taste.");
            else this.outx("hands, completely soaking them in her orgasm.");
            this.outx(
        ...
        this.outx("  Sheila jams her face upward, ");
        // [(big cox)
        if (cock && this.player.cockThatFits(32) < 0)
            this.outx(
        ...
        if (cock) {
            ...
            // (else doesn't fit)
                ...
                // (multicocks)
                if (this.player.cockTotal() > 1) {
                    this.outx("  Your other cock");
                    if (this.player.cockTotal() == 2) this.outx(" spasms");
                    else this.outx("s spasm");
                    this.outx(
        ...
        // (else if vag-focus)
            ...
            if (this.player.wetness() <= 2)
                this.outx("trickle out, and are quickly sucked up by her greedy mouth");
            else if (this.player.wetness() <= 4) this.outx("gush freely, leaving her face slick");
            else
                this.outx(
        ...
        // (else not smallcox)
        else this.outx(".  She sits up, wiping sweat and stray fluids away from her eyes.");
        ...
        // (else if sheila xp =/= 3)
            ...
            if (cock && this.player.cockThatFits(32) >= 0)
                this.outx(", smearing your dangling hand into the mess on her tits");
            this.outx(
    ...
    private consentacleVagSexForKangarooSlutBitches(): void {
        ...
        // [(non-cent)
        if (!this.player.isTaur())
            this.outx("Gripping her fuzzy thighs next, you lift her bottom and line");
        // (hoers)
        ...
        this.outx(" as you draw in and out of her warm, moist pussy.");
        ...
        if (!this.player.isTaur()) {
            ...
            if (this.sheilaCorruption() <= 30) this.outx("firm");
        ...
        if (this.player.balls > 0 || this.player.hasVagina()) {
            this.outx("Her stubby tail curls inward toward you, rubbing up against your ");
            if (this.player.balls > 0) this.outx("[balls]");
            else this.outx(this.vaginaDescript(0));
            this.outx(" and tickling you as she writhes in pleasure.  ");
            // (if vag)
            if (this.player.balls == 0 && this.player.hasVagina())
                this.outx("Your cunt twitches and drools a bit of fluid on the furry intruder.  ");
        }
        this.outx("You fuck harder, stuffing Sheila with such force that her ");
        if (this.sheilaCorruption() < 30)
            this.outx("perky, erect nipples trace long arcs against your skin");
        else this.outx("jiggly tits nearly slap into her face");
        this.outx(
        ...
        if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS.SHEILA_CORRUPTION]) {
            ...
            // [(multi)
            if (this.player.cockTotal() > 1) {
                this.outx("  Your other ");
                if (this.player.cockTotal() == 2) this.outx("dick erupts");
                else this.outx("dicks erupt");
                this.outx(" as well, festooning her crotch with sticky strings.");
            }
            this.outx(
        ...
        this.outx("Both of your orgasms finish up");
        // (dog-c)
        if (this.player.hasKnot(x)) this.outx(" and you finally manage to pull out of her");
        this.outx(
    ...
    private sheilaMutualMasturbation(): void {
        ...
        if (choices.length == 0) {
            CocSettings.error("");
            this.outx("ERROR - SHEILA MASTURBATE BROKE, SON");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        // [(horse)
        if (this.player.isTaur()) this.outx(", folding your legs under you,");
        this.outx(" and begin ");
        ...
        // (non-horse vag)
            ...
            this.outx(" sliding your hand to your [vagina], parting your lips with two fingers");
        // (gross-ass nipcunts)
        else if (target == "nipplecunt")
            this.outx("plunging your fingers into one of your awkward, distended nipples");
        ...
        if (target == "cock")
            this.outx("begin stroking your shaft, drooling pre-cum onto her skin and ");
        // (non-horse vag)
        else if (target == "cunt")
            this.outx("demonstrate by slipping your fingers into your own [vagina] and ");
        this.outx(
        ...
        /// (else if fucking nothing)
            ...
            if (this.silly()) this.outx(", even just a paperclip");
            this.outx(".");
        }
        ...
        if (target != "cock" && target != "cunt" && target != "nipplecunt")
            this.outx(", and yours joins her, slipping into her entrance alongside");
        this.outx(
            '.  "<i>Just... say I\'m always yours!</i>"  She turns you toward her face again, locking you in a kiss, and your '
        );
        // [(if cock)
        if (target == "cock") {
            if (this.player.cockTotal() == 1) this.outx("prick begins");
            else this.outx("pricks begin");
            this.outx(
        ...
        // (vag)
            ...
            this.outx("pussy convulses, ");
            if (this.player.wetness() < 4) this.outx("drooling");
        ...
        // (jack shit)
        else this.outx("fingers are pulled into her vagina by her muscles as her orgasm begins.");
        // [( pc corr >= 90 or > sheila corruption)
        if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS.SHEILA_CORRUPTION]) {
            this.outx(
        ...
        // (else no corruption warning triggered)
            ...
            this.outx('.  "<i>Oh, I had so much fun, mate.');
            // [(if sex =U and sillymode)
            if (this.player.gender == 0 && this.silly()) this.outx("  I love you, my Ken doll.");
            this.outx('</i>"');
            // [(if sheila xp = 3)
            if (this.flags[kFLAGS.SHEILA_XP] == 3) {
    ...
    private sheilaCorruptionWarningsChooseFondle(): void {
        ...
        if (this.player.hasCock()) this.outx("erect");
        else if (this.player.hasVagina()) this.outx("wet");
        else this.outx("aching");
        this.outx(
    ...
    private sheilaCorruptionWarningListenToHer(): void {
        this.clearOutput();
        this.outx('"<i>So...</i>" you answer, your feel frozen in mid-cop, "<i>what?</i>"');
    ...
    public sheilaGotWhomped(): void {
        this.clearOutput();
        this.outx("Sheila collapses, ");
        // [(HP)
        if (this.monster.HP < 1) this.outx("completely spread-eagled from her injuries");
        /// (lust)
        else
            this.outx(
        ...
        if (this.flags[kFLAGS.SHEILA_XP] > -4)
            this.outx("  I'll forgive you for everything else, but please, not this!");
        this.outx('</i>" she implores.');
        // [(sheila corruption >= 90)
    ...
    private rapeSheilasCooter(): void {
        ...
        // [(horse)
        if (this.player.isTaur()) this.outx(" by planting your forehooves just above her hips");
        this.outx(
            ".  Reaching down, you take the neck of her shirt in your hand, then rip it open, exposing her "
        );
        // [(sheila corruption < 30)
        if (this.sheilaCorruption() < 30) this.outx("tiny ");
        // sheila corruption > 60)
        else if (this.sheilaCorruption() > 60) this.outx("huge, soft ");
        this.outx(
        ...
        if (this.monster.HP < 1)
            this.outx("sliding it between her labia and producing a damp spot, then ");
        ...
        if (this.player.cor < 50) {
            ...
            if (this.player.cockArea(x) > 32)
                this.outx(" and the pain of taking a cock slightly too large for her");
            this.outx(
            ...
            if (this.sheilaCorruption() > 10) this.outx(" jiggles her breasts and");
            this.outx(
            ...
            // [(not centaur)
            if (!this.player.isTaur())
                this.outx(", leaning down to kiss her long neck and collarbone");
            this.outx(
            ...
            this.outx("; without struggling further, she slowly lowers it");
            // [(nothors)
            if (!this.player.isTaur()) this.outx(" to rest atop your own");
            this.outx(
            ...
            else this.outx("bend down, lowering your torso until you can caress her cheek.");
            this.outx(
            ...
            // [(nonhors)
            if (!this.player.isTaur()) this.outx(" and squeeze her breast");
            this.outx(
                " as your climax arrives and the first of your seed pours into her grasping pussy.  While you fill her, her back arches"
            );
            // [(nonhors)
            if (!this.player.isTaur()) this.outx(" and she presses your hand uncomfortably");
            this.outx(
            ...
            if (this.player.cockTotal() > 1) {
                this.outx("  Your other ");
                if (this.player.cockTotal() == 2) this.outx("dick spits");
                else this.outx("dicks spit");
                this.outx(" as well, leaving trails all over her light-brown skin.");
            }
            this.outx(
    ...
    private forcedSheilaOral(dick = true): void {
        ...
        if (this.sheilaCorruption() >= 50) this.outx("soft, pillowy");
        else this.outx("small, perky");
        this.outx(
        ...
        if (this.sheilaCorruption() < 20)
            this.outx("little round things that trace gentle curves under her loose shirt.");
        // (else sheila corruption < 50)
        else if (this.sheilaCorruption() < 50) this.outx("healthy mounds that fill out her shirt.");
        else
            this.outx(
        ...
        if (dick) {
            ...
            this.outx("  The reticent woman brings her lips into play, sucking gingerly, ");
            // start length fork, no new PG
            // [(dick length <= 8)
            if (this.player.cocks[this.player.shortestCockIndex()].cockLength <= 8) {
                this.outx("and the warm embrace of her mouth is welcome stimulation.");
                this.outx(
                ...
                if (!this.player.isNaga()) this.outx("a [foot]");
                else this.outx("the tip of your tail");
                this.outx(
                ...
                if (this.player.balls > 0) this.outx(" and your [balls] tighten up");
                this.outx(
            ...
            // (else dick length > 8)
                ...
                if (this.player.cocks[this.player.shortestCockIndex()].cockThickness <= 6) {
                    ...
                    if (this.player.balls > 0) this.outx(" and your [balls] begin to rise");
                    this.outx(
                ...
                /// (else width > 6)
                    ...
                    if (this.player.balls > 0)
                        this.outx(" and your [balls] draw closer to your body");
                    this.outx(
            ...
            // (else if corr < 70 or PC cannot use Infest at will)
                ...
                // [(big skeet)
                if (this.player.cumQ() >= 1000)
                    this.outx(", and soon you can feel it lapping at the end of your shaft");
                this.outx(".");
                // [(mega skeet)
                if (this.player.cumQ() >= 3000)
                    this.outx(
            ...
            // [(not horse)
            if (!this.player.isTaur()) this.outx(" as you fondle her tits");
            this.outx(".");
    ...
    public getBeatUpBySheila(): void {
        this.clearOutput();
        this.outx("You slump down before Sheila, breathing heavily; the woman ");
        if (this.monster.lust < 75) {
            ...
            if (this.player.HP < 1) this.outx("colorful spots");
            else
                this.outx(
    ...
    private sheilaCowgirlRapesYou(): void {
        ...
        if (this.sheilaCorruption() < 30) this.outx("petit ");
        else if (this.sheilaCorruption() > 70) this.outx("massive ");
        this.outx(
        ...
        if (this.player.cockThatFits(32) < 0) {
            ...
            // [(horse)
            if (this.player.isTaur()) this.outx(", or at least as flat as you can get it");
            this.outx(", then sits on your stomach");
            if (this.player.isTaur()) this.outx(", sliding her long legs between yours");
            this.outx(
            ...
            if (this.player.isTaur()) this.outx("forelegs fold over her torso affectionately");
            else this.outx("hands search out her breasts, caressing and squeezing");
            this.outx(
            ...
            if (!this.player.isTaur()) this.outx("and suck on your fingers");
            this.outx('.  "<i>Oh... [name]...</i>"');
        ...
        // (else if cock fit 32)
            ...
            // [(multicock)]
            if (this.player.cockTotal() > 1) this.outx("separating out and ");
            this.outx(
            ...
            // (else lib >= 25)
                ...
                if (this.player.cumQ() <= 250) {
                    ...
                    else this.outx("the grass");
                    this.outx(", and her eyes go wide.");
                }
                // (big cum)
                else {
                    this.outx(
                ...
                if (this.player.cumQ() <= 250) this.outx('\n\n"<i>A-all of it...</i>"');
                else this.outx('\n\n"<i>A little...</i>"');
                this.outx(" you groan.  \"<i>Can't believe you didn't notice...</i>\"");
    ...
    private sheilaForcedOralGeneric(): void {
        ...
        if (this.player.hasCock()) this.outx("her hand slips around your [cock]");
        else if (this.player.hasVagina()) this.outx("her fingers slip between your labia");
        else this.outx("she rubs your bare crotch for a few seconds");
        this.outx(
        ...
        if (this.player.str < 61) this.outx("; her weight bears you slowly to the ground");
        this.outx(
        ...
        if (this.player.hairType == 4)
            this.outx(" and flushing as your stingers release their payloads into her palm");
        this.outx(".  You obediently stick out your tongue");
        if (this.player.cor > 60)
            this.outx(", motivated more by whimsy than the meager, almost playful pain,");
        this.outx(" and shallowly penetrate Sheila's vagina with it.");
        ...
        // [(str < 61)
        if (this.player.str < 61) this.outx("climbing off and kneeling next to you.");
        else
            this.outx(
    ...
    private normalSheilaPregNotifNumberOne(): void {
        ...
        if (this.player.cor < 50)
            this.outx("  A hand placed around her shoulder seems to steady her a bit.");
    ...
    private normalSheilaPregNotifREPEATEDED(): void {
        ...
        this.outx("  She looks over at you, giving you the benefit of her fatigue-lined eyes.");

        this.outx("\n\nSheila slips her hand into yours");
        if (this.player.cor < 40) this.outx(", and you give it a squeeze");
        this.outx(
    ...
    private normalSheilaPregNotifREPEATEDEDLetHerGo(): void {
        ...
        if (this.player.cor < 40)
            this.outx(", imploring her to eat the rest and keep up her strength");
        this.outx(
    ...
    private normalSheilaPregNotifREPEATEDEDWalkWithHer(): void {
        ...
        if (!this.player.isNaga()) this.outx("walk");
        else this.outx("slither");
        this.outx(
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOut(): void {
        ...
        // (else spd >= 80 and Runner perk)
            ...
            if (this.player.lib < 50)
                this.outx("you pinch her ear, provoking an annoyed flick from it.");
            else
                this.outx(
                    "you slap her on the ass, grabbing a handful and taking her mind off her own misery."
                );
            this.outx('  "<i>Dammit, [name]... not now,</i>" she frowns, pulling away from you.');
            ...
            if (!this.player.isGoo()) this.outx("run");
            else this.outx("glide");
            this.outx(
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE(): void {
        ...
        if (this.player.isNaga()) this.outx("coil");
        else this.outx("seat");
        this.outx(" yourself, then grabs your arms and pulls them around her waist.");
        ...
        if (!this.player.isGoo()) this.outx("blood");
        else this.outx("goo");
        this.outx(
        ...
        if (!this.player.isTaur())
            this.outx("  She grudgingly repositions, allowing you to rest against her.");
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE2(): void {
        ...
        if (this.player.isGoo())
            this.outx("; she's already dressed and appears to have just been outside");
        this.outx(".");
    ...
    private normalSheilaPregNotifREPEATEDEDHelpABitchOutTOCAMP(): void {
        ...
        else this.outx("You slip an arm around her, and ask if she's okay.");
        this.outx("  She nods mutely and pulls the food out of the fire.");
        // [(if Jojo present)
        if (
            this.player.findStatusAffect(StatusAffects.JojoNightWatch) >= 0 ||
            this.player.findStatusAffect(StatusAffects.PureCampJojo) >= 0
        ...
        this.outx("  You eat in silence until the food is gone, and Sheila clears her throat.");
    ...
    private sheilaGoesDemon(): void {
        ...
        if (this.flags[kFLAGS.SHEILA_XP] < -2) this.outx("always so bloody eager to fuck me!");
        else this.outx("me best mate!");
        this.outx('  Help out!</i>"');
    ...
    private demonSheilaResist(): void {
        ...
        else this.outx(" kneads her breasts seductively, pinching her nipples");
        this.outx(".  Your posture softens a bit as she reaches out to you");
        if (this.sheilaCorruption() < 30)
            this.outx(", tilting her palm to dribble a handful of strong-scented dark oils");
        this.outx(
    ...
    private demonSheilaTalk(): void {
        ...
        // [(not horse)
        if (!this.player.isTaur())
            this.outx("takes your arm in hers, then slips the other hand into your armor");
        // [(horse)
        else this.outx("between your legs");
        this.outx(" to touch your ");
        if (this.player.hasCock()) this.outx("[cock]");
        else if (this.player.hasVagina()) this.outx("[vagina]");
        else this.outx("smooth skin");
        // [(lib <20)
        if (this.player.lib < 20) this.outx(", giggling as your expression petrifies");
        this.outx(
    ...
    private askDemonSheilaAboutDahChange(): void {
        ...
        if (this.flags[kFLAGS.SHEILA_CITE] >= 1) {
            ...
            if (this.player.hasCock())
                this.outx(", and you feel a monument of your own being erected");
            this.outx(
    ...
    private askDemonSheilaAboutHerColony(): void {
        ...
        // (corr <30)
        if (this.player.cor < 30) this.outx("\n\nHorrified");
        ...
        // (corr >=75)
        if (this.player.cor >= 75) this.outx("harvested that day, you sigh wistfully");
        else this.outx("stolen that day, you wince");
        this.outx(
        ...
        this.outx(".  You ");
        if (this.player.cor < 50) this.outx("break eye contact, blushing");
        else
            this.outx(
    ...
    private talkToDemonSheilaAboutWhatNow(): void {
        ...
        if (this.player.hasCock()) this.outx("give them to me");
        else this.outx("have them for me");
        this.outx('.  I dunno what could be simpler.</i>"');
        ...
        if (this.flags[kFLAGS.AMILY_OFFER_ACCEPTED] > 0)
            this.outx(" save one.  Actually, the two are a bit reminiscent of each other..");
        this.outx(".  Yet, any offspring a demon makes will be imps, right?");
        ...
        if (this.player.cor < 50) this.outx("; even though you hide it, I've seen it lurking");
        this.outx('.  Feel like flying your colors for a while?</i>"');
    ...
    private demonSheilaTalkAnotherQuestion(): void {
        ...
        if (this.player.lust <= 99) {
            this.outx("Sheila reaches farther down, ");
            // (cock)
            if (this.player.hasCock())
                this.outx("slipping more of her finger and thumb around your penis");
            else if (this.player.hasVagina()) this.outx("parting your lips more");
            else this.outx("rubbing your bare groin");
            this.outx(
    ...
    private sheilaLetHerFuckYou(): void {
        ...
        if (this.sheilaCorruption() >= 40) this.outx("pillowy ");
        else this.outx("pert ");
        this.outx("breasts against you.");
    ...
    private demonImpChildren(): void {
        ...
        if (this.sheilaCorruption() < 40)
            this.outx("her perky nipples rubbing into your arm as she snuggles up");
        else
            this.outx(
        ...
        // (if cock)
            ...
            if (this.sheilaCorruption() <= 80)
                this.outx("with her fingers to make sure the invitation is all the way open");
            // (else)
            else
                this.outx(
    ...
    private pregDemonSheilaOtherSex(): void {
        this.clearOutput();
        this.outx("Her eyebrows knit as you propose an alternative.  ");
        // [(if cock)
        if (this.player.hasCock()) {
            this.outx(
            ...
            if (this.sheilaCorruption() >= 80)
                this.outx("heaves onto her feet, heavy breasts swaying");
            else this.outx("nimbly hops to her clawed feet");
            this.outx(
    ...
    private loseToNormalSheilaAndGetRidden(): void {
        ...
        if (this.player.balls > 0) {
            ...
            if (this.player.isTaur()) this.outx("forelegs");
            else this.outx("hands");
            this.outx(
            ...
            // (normal skeet)
            if (this.player.cumQ() < 250) this.outx("ten minutes and two");
            // (big skeet)
            else if (this.player.cumQ() < 1000) this.outx("thirty minutes and four");
            else this.outx("fifty minutes and eight");
            this.outx(
        ...
        // (else if no balls)
            ...
            if (this.player.isTaur()) this.outx("You force her downward with your forelegs to");
            else this.outx("You grab her hips and");
    ...
    private tailSpadeSoundingForFuckHugeDongsWithDemonSheila(): void {
        ...
        if (this.player.cockTotal() > 1) this.outx("; unguided, the ");
        if (this.player.cockTotal() == 2) this.outx("other twitches and sprays");
        else if (this.player.cockTotal() > 2) this.outx("others twitch and spray");
        if (this.player.cockTotal() > 1)
            this.outx(" all over, coating her back, you, the grass, and anything ");
        if (this.player.cockTotal() > 2) this.outx("else they happen to point at");
        if (this.player.cockTotal() == 2) this.outx("else it happens to point at");
        this.outx(
    ...
    private clitSwellingDemonSheilaClitSoundingAnal(): void {
        ...
        // [(not horse)
        if (!this.player.isTaur())
            this.outx("turns around, then straddles your groin and looks over her shoulder.");
        ...
        if (this.player.clitLength > 6) this.outx(", taking it several inches deep");
        this.outx(
        ...
        if (this.player.clitLength <= 6) {
            ...
            else this.outx("Her eyes glitter with mirth.");
            this.outx(
        ...
        // (else if clit >6" initially)
            ...
            else this.outx("she's taken as much as she can");
            this.outx(
            ...
            if (this.player.clitLength <= 12) {
                ...
                if (this.player.hasVirginVagina())
                    this.outx("  <b>You've lost your virginity!</b>");
                this.outx(
            ...
            if (!this.player.isTaur())
                this.outx("her tits are covered by grass stains from her frenetic pumping.");
            else
                this.outx(
    ...
    public beatUpDemonSheila(output = true): void {
        if (output) {
            this.clearOutput();
            this.outx('"<i>Ahh, you win, mate.  I give up.</i>"  Sheila slumps to the ground, ');
            if (this.monster.HP < 1)
                this.outx(
    ...
    private missionaryForThePurposesOfCreatingImpsWithSheila(): void {
        ...
        else this.outx("Your scowl hardens at her shameless playacting, and ");
        this.outx(
        ...
        if (!this.player.isTaur()) this.outx("shoulders");
        else this.outx("flanks");
        this.outx(
        ...
        // (sheila corruption >=40)
        if (this.sheilaCorruption() >= 40) this.outx("and her soft breasts jiggle ");
        this.outx(
        ...
        else this.outx("  \"<i>This is what you're here for!  Don't spill a single drop!</i>\"");
        this.outx(
        ...
        if (this.sheilaCorruption() < 40) this.outx("tight");
        else this.outx("soft");
        this.outx(" chest against you");
        if (this.player.isTaur()) this.outx(" as you slump forward");
        this.outx(".  Your cock ");
        if (this.player.cockTotal() > 1) {
            this.outx(" and its ");
            if (this.player.cockTotal() == 2) this.outx("brother");
            else this.outx("brethren");
            this.outx(" swell and squirt");
        } else this.outx("swells and squirts");
        this.outx(", pouring your semen into Sheila's ravenous pussy");
        if (this.player.cockTotal() > 1) this.outx(" and coating her crotch with a glaze of white");
        this.outx(
        ...
        this.outx(".  She kisses you");
        if (this.player.isTaur()) this.outx("r forelegs");
        this.outx(" lovingly and deeply");
        if (this.player.cockTotal() > 1 || this.player.cumQ() >= 500)
            this.outx(" as the spare seed dribbles from her crotch");
        this.outx(", then breaks away and looks up into your face.");
        ...
        this.outx("came too soon; I wasn't done.</i>\"");
        ...
        // (else if RNG doesn't end scene)
            ...
            // (if vag)
            if (this.player.hasVagina())
                this.outx(" as her imp spawn take turns doing the same to you from behind");
            else
                this.outx(
            ...
            this.outx(".  ");
            if (this.player.lib < 40) this.outx("Shocked");
            else this.outx("Flushing hotly");
            ...
            if (!this.player.isTaur()) this.outx("back");
            else this.outx("sides");
            this.outx(" as she cools down.");
    ...
    private sheilaAnalHateFuckAGoGo(): void {
        ...
        if (!this.player.isTaur()) this.outx("Slipping one hand around your [cockFit 32]");
        else this.outx("Straddling her");
        this.outx(
        ...
        // (not centaur)
        if (!this.player.isTaur())
            this.outx("grab her thrashing legs, using them for leverage as you ");
        this.outx(
    ...
    private sheilaAnalHateFuckAGoGoNO(): void {
        ...
        if (this.player.cumQ() < 250) this.outx("trickle");
        else if (this.player.cumQ() < 1000) this.outx("stream");
        else this.outx("waterfall");
        this.outx(" of semen made when her body pushes out some of the foreign substance.");
    ...
    private sheilaAnalHateFuckAGoGoGETYOUSOMEWORMS(): void {
        this.clearOutput();
        this.outx('"<i>Mmm...</i>" you answer, noncommittally.  Your ');
        if (this.player.balls > 0) this.outx("[balls]");
        else this.outx("insides");
        this.outx(
    ...
    private jojoRuinsTheAnalHateFuck(clear = true): void {
        ...
        if (this.sheilaCorruption() >= 90) this.outx(", mashing her tits together as they thicken");
        this.outx(
        ...
        if (this.sheilaCorruption() >= 40)
            this.outx("Her breasts tighten up, shedding cup sizes rapidly; t");
        else this.outx("T");
        this.outx(
    ...
    private bigDickAndThighs(): void {
        ...
        if (this.player.cor < 40) {
            ...
            // [(multi)
            if (this.player.cockTotal() > 1) {
                if (this.player.cockTotal() == 2) this.outx("  Both");
                else this.outx("  All");
                this.outx(
            ...
            this.outx(" and angling upward so the precum drools downward and lubes her fingers.");
        }
        // (else corr >= 40)
        ...
        if (this.player.cockTotal() > 2) this.outx("relinquish your other pricks and ");
        if (this.player.cockTotal() == 2) this.outx("relinquish your other prick and ");
        this.outx(
        ...
        this.outx('"<i>Y-yes,</i>" she mumbles, "<i>gonna fuck her... harder...</i>"');
        ...
        if (this.player.cockTotal() > 1) this.outx("topmost ");
        this.outx(
        ...
        if (this.player.cockTotal() > 1) this.outx("s");
        this.outx(", looking almost wistful to see ");
        ...
        if (!this.player.hasVagina()) this.outx("to grow a nice pussy for me so that ");
        this.outx(
    ...
    private winAgainstDemoNSheilaForVaginas(): void {
        this.clearOutput();
        this.outx("You drop onto the woman's lap without hesitation, ");
        if (!this.player.isTaur()) this.outx("mauling her tits roughly with your hands, ");
        this.outx(
        ...
        else this.outx("turn your head and");
        this.outx(
        ...
        if (!this.player.isTaur()) {
            this.outx("crawl away on your hands");
            // [(tail or naga)
            if (this.player.tailType > TAIL_TYPE_NONE && this.player.isNaga())
                this.outx(" and raise your tail");
        } else this.outx("clamber to your hooves and bend your forelegs");
        this.outx(
        ...
        if (this.sheilaCorruption() > 0) this.outx(", squashing her tits into you");
        this.outx(
        ...
        if (!this.player.isTaur()) this.outx("neck");
        else this.outx("withers");
        this.outx(
        ...
        // [(lib <20)
        if (this.player.lib < 20) this.outx("even as proud as you are, ");
        this.outx(
        ...
        if (this.player.cor < 50) {
            ...
            if (this.player.fertility < 50) {
                this.outx("  There is a tingle deep inside you, making you more fertile.");
