...
export class ShouldraScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    private littlePigLittlePigLetMeIn(): void {
        ...
        if (
            ...
            this.outputText(
                "You could take her to the lake to find someone to play with...\n\n",
                false
            );
    ...
    private ghostIzmaPenis(): void {
        ...
        if (this.player.balls > 0)
            this.outputText(
                "  Your enchanted testes give an audible groan as you reach climax.",
                false
            );
        else
            this.outputText(
    ...
    private slimeGinaFlation(): void {
        ...
        if (this.player.isNaga())
            this.outputText(
                "your tail is thrust to one side to make way for the penetration",
                false
            );
        ...
        if (this.player.biggestTitSize() < 1)
            this.outputText(
                "see your " + this.nippleDescript(0) + " wiggling sporadically.",
                false
            );
        else
            this.outputText(
    ...
    private shouldraGiantCockLoss(): void {
        ...
        this.outputText(
            ". The ghost girl pinches a quickly-stiffening nipple and pulls it out, ",
            false
        );
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
        ...
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] <= 4)
            this.outputText(
                "they have kept at least a cup size of flesh from their experience",
                false
            );
        else
            this.outputText(
    ...
    private genderlessShouldrasLossRapes(): void {
        ...
        this.outputText(
            "She hops up and makes for the decrepit hut you first saw her in.  ",
            false
        );
        if (this.flags[kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0)
            this.outputText(
