...
export class ShouldraScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        if (this.shouldraFollower.followerShouldra()) {
            ...
            if (
                ...
                (this.flags[kFLAGS.SHOULDRA_SLEEP_TIMER] < 0 &&
                    this.flags[kFLAGS.SHOULDRA_SLEEP_TIMER] % 16 == 0)
            ) {
                this.shouldraFollower.shouldraWakesUpOrPokesPCsForShitsAndGigglesIdunnoHowLongCanIMakeThisFunctionNameQuestionMark();
                needNext = true;
            }
            if (
                this.flags[kFLAGS.SHOULDRA_PLOT_COUNTDOWN] > 0 &&
                this.getGame().model.time.hours == 3
            )
                this.flags[kFLAGS.SHOULDRA_PLOT_COUNTDOWN]--;
        }
        return needNext;
    }
    ...
    public timeChangeLarge(): boolean {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00365] > 0) {
            if (
                ...
                this.player.horns > 0 ||
                this.player.cor > 15 ||
                this.player.longestCockLength() > 10 ||
    ...
    public shouldraGreeting(): void {
        ...
        if (this.flags[kFLAGS.TIMES_MET_SHOULDRA] < 3) {
            ...
            this.outx(
                "Finally, she acknowledges your readiness to fight. With a sigh and a shrug, she raises her arms and drops into an orthodox boxing stance. Once again, you heft your " +
                    this.player.weaponName +
                    ".",
                false
            );
        ...
        // (after three encounters with her)
            ...
            if (
                ...
                this.flags[kFLAGS.TIMES_MET_SHOULDRA] % 10 == 0
            ) {
            ...
            this.outx(
                'You step into the ruins of the village cautiously, zigzagging through passageways and searching for anything worth pocketing. A now-familiar sound from inside one of the half-collapsed cottages gives you pause, and you\'re not surprised when a normal-looking girl steps out and faces you. She plants her hands on her hips, cocking her head curiously. "<i>You again?</i>" she asks amiably, the beginnings of a grin playing across her freckled features. "<i>Now, you couldn\'t have come back just to see me.</i>"\n\n',
                false
            );

            this.outx(
                'Before you can either confirm or deny her suspicions, she falls into a fighting crouch, beaming at you from behind her raised fists. "<i>What say we have a friendly little brawl?</i>" she asks. "<i>I win, I get to play with you.</i>"  With a nod, you heft your ' +
                    this.player.weaponName +
                    ' and get ready for a fight.  "<i>You don\'t stand a ghost of a chance,</i>" she teases.\n\n',
                false
            );
    ...
    private novemberAlphaHotel(): void {
        ...
        this.outx("", true);
        this.outx(
            "You shake your head slowly, raising your " +
                this.player.weaponName +
                ' as you regard her.  "<i>Ah, so that\'s how you want it?</i>" she titters, a smile gracing her features.  "<i>In that case, enough talk... have at you!</i>"\n\n',
            false
        );
        this.startCombat(new Shouldra());
    }
    ...
    public defeatDannyPhantom(): void {
        ...
        if (this.monster.HP < 1) {
            ...
            if (this.flags[kFLAGS.TIMES_POSSESSED_BY_SHOULDRA] >= 1) this.outx("ghost ");
            this.outx(
        ...
        // (defeat by lust)
            ...
            if (this.flags[kFLAGS.TIMES_POSSESSED_BY_SHOULDRA] < 1)
                this.outx("Strangely, the action seems to have little to no effect.");
            else
                this.outx(
    ...
    private noSlimingSlimer(): void {
        this.spriteSelect(67);
        this.outx("", true);
        this.outx("You shake your head angrily at the brazen girl, ");
        // ([if first time]
        if (this.flags[kFLAGS.TIMES_POSSESSED_BY_SHOULDRA] == 0)
            this.outx("not feeling up to heed the strange girl's whims.");
        else this.outx("mystified at the thought of letting a ghost possess your body.", false);
        this.outx(
        ...
        // ([if first time]
        if (this.flags[kFLAGS.TIMES_POSSESSED_BY_SHOULDRA] == 0)
            this.outx("girl (what was that about her 'taking over' a goblin?)");
        else this.outx("spirit");
        this.outx(", and a twinge of guilt runs through you.");
        this.cleanupAfterCombat();
    }
    ...
    private littlePigLittlePigLetMeIn(): void {
        this.spriteSelect(67);
        this.outx("", true);
        this.outx("You decide ");
        if (this.flags[kFLAGS.TIMES_POSSESSED_BY_SHOULDRA] == 0)
            this.outx(
                "you can afford being a little adventurous with the obviously desperate girl",
                false
            );
        else this.outx("having a spiritual tag-along might be a bit of fun");
        this.outx(
        ...
        // [if <~7' tall]
        if (this.player.tallness < 84) this.outx(" into your arms for a tight hug");
        else this.outx(" up into your arms for a tight hug");
        this.outx(
        ...
        if (
            ...
            ((this.player.findStatusAffect(StatusAffects.BoatDiscovery) >= 0 &&
                ...
                this.flags[kFLAGS.TIMES_MET_OOZE] > 0)
        ) {
            this.outx("You could take her to the lake to find someone to play with...\n\n", false);
        ...
        if (this.player.biggestTitSize() >= 1)
            this.outx(
                ", " +
                    ...
                    " squishing and squashing against her own barely-clad bosom",
                false
            );
        this.outx(
    ...
    private sharkyEctoginas(): void {
        ...
        // [if repeat]
        if (this.flags[kFLAGS.TIMED_SHARKGINAS] > 0) this.outx(" again...");
        this.outx('</i>" she pants, brow suddenly furrowed with worry.  ', false);
        if (this.flags[kFLAGS.TIMED_SHARKGINAS] == 0)
            this.outx(
                "You begin to ask what she's talking about, but the words die in your mouth when",
                false
            );
        else this.outx("You can only shake your head resignedly as");
        this.outx(
        ...
        // [if breasts present]
        if (this.player.biggestTitSize() >= 1)
            this.outx("and caking your cleavage with the excess lubrication");
        this.outx(
    ...
    private ghostIzmaPenis(): void {
        ...
        this.outx(
            "You swiftly disrobe and lay your " +
                ...
                " to the side, revealing your stiffening " +
        ...
        if (this.player.balls > 0)
            this.outx(
                " and cradling your " +
                    ...
                    " with almost reverent gentleness, running her coarse shark-skinned fingers across your sack as gently as she can manage",
                false
            );
        this.outx(".\n\n", false);
        ...
        if (this.flags[kFLAGS.TIMES_SHARKPENISED] == 0)
            this.outx("whose expression reveals she's as clueless as you are.");
        else
            this.outx(
        ...
        this.outx(
            '  "<i>That wasn\'t nearly what the spell should have been,</i>" the girl muses, licking her lips ',
            false
        );
        if (this.flags[kFLAGS.TIMES_SHARKPENISED] == 0)
            this.outx(
                "absently as she contemplates what could have caused the lengthening of your loins",
                false
            );
        else
            this.outx(
                "in anticipation for the experience you both are about to undergo, yet again",
                false
            );
        this.outx(
            ". Your jaw drops as her lips puff out, suddenly looking much more sultry and far fuller than before. Your spiritual seductress swiftly takes note, as well, and her lips curl up into a mischievous smile ",
            false
        );
        if (this.flags[kFLAGS.TIMES_SHARKPENISED] == 0)
            this.outx(
                'as she deduces the nature of the spell. "<i>I think... oh my... my host\'s saliva may have expansive qualities on... sexual aspects of the body,</i>" she explains. "<i>So, if I were to do this...</i>"',
                false
            );
        else
            this.outx(
                '"<i>Would you look at that, my magic spittle still works! How about I just...</i>"',
                false
            );
        this.outx("\n\n", false);
        ...
        if (this.player.balls > 0) this.outx(" and softly churning sack");
        this.outx(
        ...
        if (this.player.balls > 0)
            this.outx("  Your enchanted testes give an audible groan as you reach climax.", false);
        else
            this.outx(
                "  You feel something stirring in your groin, and you squirm as the tingling intensifies.",
                false
            );
        this.outx(
            "  Your urethra bulges as thick, very thick seed surges through it, and the little bit of extra girth is all the ghost girl needs to reach her own orgasm, hands passionately roaming her inflated body and voice climbing to a shriek as the sensation rocks her. Your first and second spurt of semen rounds her distended belly out, and by the third blast, the shark girl's midsection looks like the aftermath of a week-long demonic orgy. Finally, with your fourth and last explosive gout, her lips relinquish their vice-like grip on your shaft, and the massive wave of semen and spunk rains down upon you, nearly filling the boat and leaving you floating in a bath of sex.\n\n",
            false
        );

        this.outx(
            "The ghost girl doesn't even bother to extricate herself from your towering cock, dangling happily until the magic begins to wear off. She whimsically rides your cock down to the boat, and plants her feet on either side, balancing over you as her own measurements regulate. You rise, dive into the lake to wash the smelly fluids off you, then wander back onto shore where the possessed shark-girl is waiting. You walk into her outstretched arms, lips locking into a soft kiss as the girl leaps back into your waiting throat. You are a bit relieved when the shark girl doesn't even question the events that just took place, just turning and wading back into her watery home, leaving you alone with your ghost.\n\n",
            false
        );
    ...
    private ghostGooGurlzDuckfaces(): void {
        ...
        if (this.player.hasCock() && !this.player.hasVagina())
            ...
            this.outx(" slipping a hand down to your " + this.clitDescript() + " eagerly.", false);
        // [if herm]
        ...
        if (this.player.gender == 3) {
            if (
                ...
                this.flags[kFLAGS.SHOULDRA_SLIME_PENOR_TIMES] > 0
            )
    ...
    private slimeGinaFlation(): void {
        ...
        // ([if corruption <50]
        if (this.player.cor < 50) this.outx("you beg her to stop before this gets out of hand.");
        else
            this.outx(
        ...
        this.outx(
            'The ghost girl gives a concerned groan. "<i>It\'s not me... this thing, it\'s... hungry,</i>" in an increasingly desperate voice. "<i>I\'m sorry!</i>"  With that, the protrusion lances up your ' +
                this.assholeDescript() +
                ", wriggling its way through your colon eagerly. Although not as painful as you'd imagine, the insertion still inspires a sharp breath hissed through clenched teeth. Before you can stop it, the green slime shoots another prehensile appendage straight towards your " +
                this.player.face() +
                ". The thing floods your mouth and bulges your cheeks as it demands entry. You keep your jaw firmly shut, knowing you must keep the situation from getting out of hand, but tiny tentacles simply break off the main one and begin to seek other means of access. Two of the things slide through your nose, and your eyes widen as they wriggle through and down into the back of your mouth. The monstrous ooze jiggles in victory, though the ghostly visage within winces worriedly. Once inside, the goo surges against your jaw, forcing it open just far enough to open the floodgates. Like a jade river, the stuff flows down your throat. You snap your head back to attempt to extricate the stuff, but it simply follows you, pushing you even farther backwards as it goes. A muffled cry is the only protest you are allowed at the grotesque triple penetration. Your only consolation is you can still somehow breathe, and you figure your spiritual friend has something to do with that.\n\n",
            false
        );
        ...
        if (this.player.biggestTitSize() < 1)
            this.outx("Your frame is jostled about as the slime under you shrinks.");
        else
            this.outx(
        ...
        this.outx(
            "Content in taking second place, your anus also stretches as the bulb flows into it. Moments later, before you are even allowed to recover from the first two, your jaw is forced farther open to make room for the bulbous deposit. You hum unhappily as your throat widens, not unlike a croaking frog. Your already-huge belly burgeons with the new additions until it's at least twice as large as ",
            false
        );
        if (this.player.findStatusAffect(StatusAffects.MeetWanderer) >= 0)
            this.outx("both of Markus's testicles, combined!");
        else this.outx("a wheelbarrow!");
        this.outx("\n\n", false);

        this.outx(
            "The slime is too small to keep you up at this point, and your " +
                this.buttDescript() +
        ...
        if (this.player.isNaga()) this.outx("snake-like lower body");
            ...
            this.outx("arms and " + this.player.legs(), false);
        else this.outx("arms, " + this.player.legs() + ", and tail", false);
        this.outx(
        ...
        if (this.player.biggestTitSize() < 1)
            this.outx("see your " + this.nippleDescript(0) + " wiggling sporadically.", false);
        else
            this.outx(
                "see your " +
                    this.allBreastsDescript() +
        ...
        this.outx(
            "  Your jaw drops as your chest heaves forward, filled with the same slime that was just stuffing your stomach.\n\n",
            false
        );
    ...
    private slimeyPenorsAhoy(): void {
        ...
        if (this.player.balls > 0) this.outx("and teasing your quaking testes ");
        this.outx(
        ...
        if (this.player.isNaga()) this.outx("slapping against your tail");
        else if (this.player.isGoo()) this.outx("smooshing against your goo");
        else this.outx("swiftly bruising your thighs");
        this.outx(
        ...
        if (this.player.balls > 0) this.outx("balls to churn");
        else this.outx("body to prepare itself for release");
        this.outx(
        ...
        if (this.player.balls > 0)
            this.outx(
                "waddle over to where the mewling ghost girl is twitching on the ground; your now-shrinking testicles hindering your gait.",
                false
            );
        else
            this.outx(
                "limp over to where the mewling ghost girl is twitching on the ground; your now-shrinking prostate hinders your gait.",
                false
            );
        this.outx(
            '  Like pushing through a huge plate of jello, you reach into the distended slime\'s stomach, fishing around for any signs of... afterlife. A slender hand catches onto yours, and you heave the ghost girl out of her host easily. She floats in circles around you. "<i>Thank you so much,</i>" she cries happily. "<i>I was nearly lost in there!  There was so much... emptiness.</i>"\n\n',
            false
        );

        this.outx(
            'You smile and shake your head. How much of her was left in that slime at the end, you wonder. Enough to recall a spell... oh well, you decide. You all came out unharmed, eventually. As soon as the ghost girl materializes, she rushes you and wraps you in a big hug. "<i>I should be getting back now,</i>" she admits. "<i>Can\'t stick around here all day. Oh, before I go...</i>"  She brazenly undoes her leggings, pulling them away from her crotch and reaching into her box. She extricates a good amount of ectoplasm, then pulls a small bottle from a pocket inside her tunic and squeezes the goop inside. With an amiable grin, she hands the bottle to you, and you nod your appreciation. You send her off, then begin back to your own camp. While redressing, you can\'t help a final cursory glance at the pile of slime, still humanoid in shape and now rubbing its enlarged measurements in mindless bliss. Interesting...\n\n',
            false
        );
        this.player.orgasm();
    ...
    private genderlessGhostBuster(): void {
        ...
        this.outx(
            "Excited to help relieve the girl of her accumulating lust, you allow her control of your arms. She eagerly cups a hand against your crotch to feel... nothing. Confused, she quickly wriggles out of your " +
                this.player.armorName +
                " and goes in for another grope, feeling nothing but skin. \"<i>Son of a...please don't tell me you don't have any sexual bits I can play with!</i>\" she huffs, and you chuckle sheepishly, not knowing what to tell her. She groans and falls back onto your " +
                this.buttDescript() +
                ', muttering a string of curse words under your breath. "<i>That\'s it!</i>" she fumes. "<i>I\'m going to get off, whether you want me to or not!</i>" She resumes cursing and wiggling your hips for a bit longer, then stops suddenly, a smirk playing across your face. "<i>Whether you want me to or not...</i>"\n\n',
            false
        );

        this.outx(
            "She hops to your feet and makes for the decrepit hut you first saw her in.  ",
            false
        );
        if (this.flags[kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0)
            this.outx(
                "You raise an eyebrow, genuinely curious as to how she'll figure out how to relieve her desire.  ",
                false
            );
        this.outx(
            "Darting inside, the ghost girl heads unerringly towards a warped and half-rotted dresser. After searching several drawers filled with various knickknacks and trinkets, the spirit squeaks in excitement as she produces a seemingly regular egg carton. She moves to the other side of her room and opens a curiously well-made chest, setting the carton on a nightstand as she goes.  ",
            false
        );
        if (this.flags[kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0)
            this.outx(
                "Curious as to its contents, you glance inside—it's a chest of dildos, of every shape and size. Before you can ask why the hell a ghost would carry a CHEST of dildos, ",
                false
            );
        else
            this.outx(
                "You recall distinctly the contents of that chest, and are not surprised ",
                false
            );
        this.outx(
        ...
        if (this.player.biggestTitSize() < 1) this.outx("two new additions bud on your chest.");
        else if (this.player.biggestTitSize() <= 8)
            this.outx("your " + this.allBreastsDescript() + " begin to bounce all around.", false);
        else
            this.outx(
                "your " +
                    this.allBreastsDescript() +
        ...
        this.outx("As the ghost continues darting around the room, ");
        // [if flat to E-cup]
        if (this.player.biggestTitSize() <= 8) this.outx("your new EE-cup breasts settle");
        else
            this.outx(
        ...
        if (!this.player.hasFuckableNipples()) this.outx("new ");
        else this.outx("even larger ");
        this.outx(
        ...
        this.outx(
            "She smacks it between your legs, seemingly forgetting about your lack of genitalia, and grudgingly goes for the next penetrable orifice; your " +
                this.assholeDescript() +
        ...
        this.outx(
            "You chuckle to yourself, admittedly impressed by her prowess. A pressure lifts from your chest, and you absently raise a hand to find ",
            false
        );
        if (this.player.biggestTitSize() < 1)
            this.outx(
                "your tits, along with the elongated nipples, receding back into a flat chest.",
                false
            );
        else if (this.player.biggestTitSize() <= 8)
            this.outx(
                "your boobflesh shrinking back down into its normal size, nipples included.",
                false
            );
        else
            this.outx(
                "the nipples shortening once again, and the lactation finally stabilizing.",
                false
            );
        this.outx(
            "  With a happy sigh, you heave yourself upright, slipping back into your " +
                this.player.armorName +
                " and moving out into the ruins once more.",
            false
        );
        this.outx(
    ...
    private penisLossThatIsntALoss(): void {
        ...
        if (this.flags[kFLAGS.SHOULDRA_PENIS_DEFEAT_TIMES] == 0)
            this.outx(
                'She abruptly gasps in excitement and begins moving your hands towards your groin, though you swiftly reclaim control. "<i>You have a penis,</i>" she telepathically pulses to you with an anxious and excited edge to her voice. "<i>My hosts... they rarely... they...</i>"',
                false
            );
        else
            this.outx(
                "She chuckles softly as she recalls the times you've shared, and she hungrily goes for your maleness once more, though you throw her off of it.",
                false
            );
        this.outx(
        ...
        if (this.player.inte < 50)
            ...
            this.outx(
                'You begin to gain an edge, but the ghost girl is craftier than you expected. She begins to pulse mental intrusions at you, scrambling your thoughts just long enough for her to overtake you and push you to the side.  "<i>You are one hundred years too early to challenge me,</i>" she chides. "<i>My intellect has long surpassed most any living creature on this plane.</i>"',
                false
            );
        else {
            ...
            this.outx(
                "She moves to leave in a huff, but you stop her with a single telepathic demand. She's yours, you remind her, and since she's gone through the trouble of trying to get you off, she might as well finish the job. Even as her lips purse in a stubborn pout, a dominating wave of influence sweeps over her, and regardless of herself, she begins unsteadily moving towards you. Resolving to meet halfway, you stride over to her and push her to your knees. As she watches, you shed your " +
                    this.player.armorName +
                    " and hoist your " +
                    this.cockDescript(x) +
                    ' up to her lips, leaving a fairly clear implication of your expectations. The ghost girl\'s eyes widen at the sight of your manhood, and she cringes as a new wave of arousal sweeps through her. She gives a little whimper at her inability to quell her overwhelming libido, but you simply laugh mockingly and gesture at your maleness.  "<i>Ghost blowjob,</i>" you mutter snidely.\n\n',
                false
            );

            this.outx(
                "You don't even give her the chance to act of her own volition, simply reaching out, taking ahold of her head, and slamming her onto your " +
                    this.cockDescript(x) +
                    ".  She takes it surprisingly well, unsurprisingly easily, taking most of the shaft in the first thrust alone.  With not as much as even a sputter, she impatiently double-handedly grabs your " +
                    this.buttDescript() +
                    " and thrusts her head forward.  Before you know it, your entire " +
                    this.cockDescript(x) +
            ...
            if (this.player.cockTotal() > 1) {
                ...
                else this.outx("the rest of " + this.multiCockDescriptLight(), false);
                ...
                if (this.player.cockTotal() == 2)
                    ...
                    this.outx("your other two shafts and pumps them vigorously.");
                else this.outx("two other shafts and pumps them vigorously.");
            }
            this.outx("\n\n", false);

            this.outx(
                "The ghost girl goes to town on your genitals, the combination of your will and her still-rising lust fueling her movements.\n\n",
                false
            );

            this.outx(
                "Although her mouth is quite full, her voice rings clearly in your head as she starts casting a spell.  You glance down at her, surmising from her almost serene expression and heavy-rimmed eyes that she's even gotten over her inability to orgasm.  She finishes her spell with the usual flourish before once more focusing her attention to your pleasure.  ",
                false
            );
            if (this.player.cockTotal() == 2)
                this.outx("Taking her hand away from your other dick, the ");
            else if (this.player.cockTotal() >= 3)
                this.outx("Taking her hands away from your other dicks, the ");
            else this.outx("The ");
            this.outx(
            ...
            if (this.player.balls > 0) this.outx("in your " + this.ballsDescriptLight(), false);
            ...
            this.outx(
                "The strange feeling focuses on your testes, making it a bit hard to concentrate on keeping the ghost girl subdued.  Your management of willpower does not waver until you feel your legs being pushed farther apart.  A curious glance turns into a horrified stare as you gaze upon your now "
            );
            if (this.player.ballSize >= 9) this.outx("gargantuan");
            else this.outx("basketball");
            this.outx("-sized balls.\n\n", false);
        ...
        this.outx("\n\n", false);
        this.outx(
            "Taking complete control of your body as if it was never actually yours, she removes your " +
                this.player.armorName +
                " and throws them carelessly to the ground. Grabbing up your " +
                this.cockDescript(x) +
                " in both hands and fondling it awkwardly, she strikes you as obviously inexperienced with the male anatomy, despite her levels of intelligence. She continues to grope your lengthening member, admitting, \"<i>Even with the rare male bodies I have possessed, I rarely got to play with their...</i>\" You feel your face flush as the ghost girl relives her awkward previous possessions. Your penis finally extends to its full length, and your hands slide up and down its length in a clumsy yet admittedly effective technique. Sweat soon begins lathering your body as you sink to your knees, confusingly overwhelmed by the pleasure of a simple self-stimulation. You've never felt this good while masturbating! You figure the otherworldly influence of your new 'room-mate' has something to do with this. As if to prove your theory, your mouth moves in the strange archaic language of the girl, and your body stiffens in both pain and pleasure as ",
            false
        );
        if (this.player.balls > 0) this.outx("your testicles churn with fertility and ");
        this.outx(
    ...
    private letShouldraIn(): void {
        ...
        this.outx("", true);
        this.outx(
            "The ghost girl squeals in excitement as you allow her partial control- only enough for her to feel your penis as if it were her own.  With an ecstatic, victorious scream, she impales herself upon your dick, taking the entire thing down her throat like it's nothing.  Your jet-stream of cum rockets into her gob, blasting her head straight off your dick to slam into your " +
                this.chestDesc() +
                ' with an "<i>Oof.</i>"\n\n',
            false
        );
    ...
    private ghostBJFinisher(inside: boolean): void {
        ...
        if (inside) this.outx("excitedly convulsing");
        else this.outx("practically lust-paralyzed");
        this.outx(
        ...
        if (inside) {
            ...
            this.outx(
                "You watch her move off into the ruins with a new spring in her step, chuckling as she goes before heading back to camp yourself.",
                false
            );
        }
    ...
    private dewormYourGhost(): void {
        ...
        this.outx("", true);
        this.outx(
            "As the ghost girl settles into your body, she swiftly recognizes the unfamiliar bulge against your " +
                this.player.armorName +
                ', and you feel a wave of joy run though your body as she regards your dick. The skin on the back of your hand shudders, and you jump in surprise when the spirit\'s face appears on it. She waits patiently for you to get over the initial shock, then asks, "<i>May I... please... I mean, you... ah...</i>" You guess she must be slightly overwhelmed by her discovery. You softly ask her if she is referring to your maleness, and she responds with a suddenly anxious "<i>Mmhmm!</i>"\n\n',
            false
        );

        this.outx(
            "Chuckling to yourself, you consent to her pleadings, and she falls back into your body with a gleeful squeal. You climb out of your " +
                this.player.armorName +
                " and put a hand on your not-so-erect maleness, taking pleasure in the way she coos as blood begins to surge into your tool. Soon enough, your penis pulses in your hand, erect and ready for stimulation. You give it a little squeeze, not even noticing when one of the worms sheltering in your crotch slips out and wriggles across the floor, but the ghost girl surely does, and she makes herself known with a shrill scream that leaves your ears ringing and your head pounding. Worried, you ask her what's the matter ",
            false
        );
        if (this.flags[kFLAGS.SHOULDRA_WORM_SCENE_COUNTER] == 0)
            this.outx(
                ', and she responds by taking control of your hand and pointing down at the wriggling creature that crawled out of your junk. "<i>Oh, that?</i>" you scoff, waving your other hand in the air dismissively; your other, ghost-controlled appendage still quivers stubbornly as you attempt to explain. "<i>There are tons of the little guys crawling around inside me. Wanna see?</i>"',
                false
            );
        else
            this.outx(
                ", and your eyes flare with a yellow light as she takes control of your mouth. \"<i>You're still carrying those disgusting, awful, terrible, horrible things!?</i>\" she cries in disbelief, and it's obvious she doesn't understand the allure of the wriggly creatures. You try to appeal to her on a more basic level, informing her of the tactical advantages of combat-ready dickworms.",
                false
            );
        this.outx("\n\n", false);
    ...
    private penisGartuanGhostSmexVictory(): void {
        ...
        this.outx(
            "You feel an almost overwhelming surge of anxious arousal as the ghost girl regards your excessively large " +
                this.cockDescript(x) +
                ". You decide to play along and place your hand over the bulge in your " +
                this.player.armorName +
                ', enjoying her gleeful titter as your member twitches and hardens, just a tad. You begin to strip, but are halted by a familiar booming voice coming from the half-erect member. "<i>WHO THE HELL IS THIS BITCH?</i>" a perplexed Exgartuan yells grumpily. "<i>Living in peoples\' bodies is MY THING!</i>"\n\n',
            false
        );
        ...
        this.outx(
            "After a moment's more of hesitation, the ghost girl sinks down to your waist, pushing her head out of your " +
                this.hipDescript() +
                '.  "<i>I apologize, sir, but our- er, sorry, your host did not mention he was already... occupied,</i>" she admits in her soft, feminine voice.\n\n',
            false
        );
        ...
        if (this.silly())
            this.outx(
                '  In the middle of your ejaculatory adventure, a flap of wings alerts you to a presence above. Although unable to move your head in your current situation, you\'re made very well-aware of the nature of the intruder when a bird-like voice shrieks, "<i>SLUUUUUUUUUUUUT,</i>" at the top of her lungs. With a final caw, she flies away without a trace.',
                false
            );
        this.outx(
        ...
        this.outx(
            "When the proverbial dust settles, you stir groggily. Blinking the sleep out of your eyes, you do a double take at the sheer amount of semen flooding the street. You feel a sensation building in your finally flaccid member, and you glance down. A pale, transparent smoke flows gently from your urethra, reforming into a very tired, moderately sore, but incredibly satisfied ghost girl.  ",
            false
        );
        if (this.flags[kFLAGS.SHOULDRA_EXGARTUAN_SPIRIT_SEX_COUNT] == 0)
            this.outx(
                '"<i>Spirit sex... I can\'t say I\'ve ever tried that,</i>" she admits. "<i>Damn if it isn\'t good.</i>"\n\n',
                false
            );
        else
            this.outx(
                '"<i>Damn,</i>" she sighs, "<i>that is still a great ride, I\'d say...</i>"\n\n',
                false
            );
    ...
    private ghostGinaWinSexings(): void {
        ...
        this.outx("", true);
        this.outx(
            "The ghost girl heaves a mildly disappointed sigh as she settles into your body fully.  \"<i>I've had... many female hosts,</i>\" she explains. You momentarily feel embarrassed by the ghost's disapproval, and you almost move to apologize before the words catch in your throat and you cross your arms defensively.  ",
            false
        );
        if (this.flags[kFLAGS.SHOULDRA_VAGINAL_POSSESSIONS] == 0)
            this.outx(
                'She \'hmm\'s several times inside your head, but you can feel a surge of elation as she apparently reaches a solution. "<i>Of course!</i>" she cries excitedly.  "<i>I actually have never done this before!</i>"\n\n',
                false
            );
        else
            this.outx(
                '"<i>Oh well, I suppose we can always just do that again,</i>" she muses. "<i>It worked well enough the first time.</i>"\n\n',
                false
            );

        this.outx(
            "You are about to question exactly what she is referring to, but quickly fall silent as she gently but firmly takes control of your body, sliding out of your " +
                this.player.armorName +
                " and idly stroking your cunt. You allow her control of your mouth, and she chants a fairly lengthy spell, her absent-minded masturbation steadily gaining fervor as she progresses. With a final, shouted word of power, both of you cry out as your clitoris suddenly pulses and swells into your hand, the increased sensitivity nearly driving you insane. Your bitch-button does not stop there, however, puffing up with each heartbeat. Your eyes roll back in your head and small primitive grunts and moans escape your lips as your clit engorges in the ghostly magic, not stopping until it reaches at least four times its original length. A breeze blows through the ruined rooftops, and you scream as the wind brushes against your elongated bitch-button.  Too sensitive... the thing is way too sensitive!\n\n",
            false
        );

        this.outx(
            "Against your will, and against all of your better instincts, the ghost-girl, as aroused as you are uncomfortable, moves both hands to your sex, gripping it and giving it a squeeze. Your entire body locks up, causing you to fall backwards onto the pavement as a devastating orgasm rocks through your system. A strangled cry is the only reaction you can give to the explosive sensations. The ghost-girl, however, not satisfied with the suddenness of the climax, begins feverishly stroking your clitoris with one hand, the other reaching into your love-tunnel and stimulating the rosy flesh inside. You arch your back and attempt to dig small holes into the road with your " +
                this.player.feet() +
                " as shock-waves run through your system over and over, never giving you a chance to recuperate. You hear, as if from a great distance, a mix of frenzied laughter and orgasmic cries of pleasure ringing inside your head. Finally, mercifully, you fade into unconsciousness, leaving the ghost girl to her constant stimulation.\n\n",
            false
        );

        this.outx(
            "You awake some time later in a prodigious puddle of girly spunk. Your attempt to sit up is impeded by a clunk against the ground.  A clunk? You prop yourself up on your elbows and glance down to see a large metal pipe, stuck in your vagina presumably some time during your black-out. Reaching down, you extricate a full ten inches of piping from your cunt, and shake your head at the tenacity of your unworldly bodily invader. You are happy to feel a tightening in your crotch, however, as the magic finally wears off, returning your womanliness to a " +
                this.vaginaDescript(0) +
                ". You also note the absence of your gigantic clitoris, and give yourself a little stroke to confirm; it's reverted to normal size as well. All's well that ends well, you suppose.\n\n",
            false
        );
        this.outx(
            "Her pleasure dealt with, the ghost girl appears head-first from your belly, flowing out and reconstituting herself into the normal, brown-eyed girl you first encountered.  Almost as an afterthought, she smiles, moving to her clothing and swiftly dressing, then gives you a little wave before wandering away, rounding a corner and disappearing from sight. You resolve to find her again- her magic was pretty fun!",
    ...
    private hermaphroditeGhostsCumEctoplasm(): void {
        ...
        if (this.player.inte < 50)
            ...
            this.outx(
                'You begin to gain an edge, but the ghost girl is craftier than you expected, and she begins to pulse mental intrusions at you, scrambling your thoughts for just long enough for her to overtake you and push you to the side.  "<i>You are one hundred years too early to challenge me,</i>" she chides. "<i>My intellect has long surpassed most any living creature on this plane.</i>"',
                false
            );
        else {
            x = this.player.cockThatFits(80);
            ...
            this.outx(
                "She moves to leave in a huff, but you stop her with a single telepathic demand. She's yours, you remind her, and since she's gone through the trouble of trying to get you off, she might as well finish the job. Even as her lips purse in a stubborn pout, a dominating wave of influence sweeps over her, and regardless of herself, she begins unsteadily moving towards you. Resolving to meet halfway, you stride over to her and push her to her knees.  As she watches, you shed your " +
                    this.player.armorName +
                    " and hoist your " +
                    this.cockDescript(x) +
                    ' up to her lips, leaving a fairly clear implication of your expectations. The ghost girl\'s eyes widen at the sight of your manhood, and she cringes as a new wave of arousal sweeps through her. She gives a little whimper at her inability to quell her overwhelming libido, but you simply laugh mockingly and gesture at your maleness.  "<i>Ghost blowjob,</i>" you mutter snidely.\n\n',
            ...
            if (this.player.ballSize > 10) this.outx("gargantuan");
            else this.outx("basketball");
            this.outx("-sized balls.\n\n", false);
        ...
        this.outx(
            "Taking complete control of your body as if it was never actually yours, she removes your " +
                ...
                " and throws them carelessly to the ground. Grabbing up your " +
                this.cockDescript(x) +
                ' in both hands and fondling it awkwardly, she strikes you as obviously inexperienced with the male anatomy, despite her levels of intelligence. She continues to grope your lengthening member, admitting, "<i>Even with the rare male bodies I have possessed, I rarely got to play with their...</i>"\n\n',
            false
        );
        ...
        if (this.player.balls > 0)
            this.outx(
                "Stopping her double-handed stroke technique, she slips your hand under your obtrusive " +
                    this.ballsDescriptLight() +
                    " and gently pushes them aside to get a better look at your previously unnoticed female sex.  ",
                false
            );
        this.outx(
            "She chuckles malevolently, and you groan, mind cycling through the possible outcomes of the girl's impulses. Your lips curl unbidden in an evil smile, then begin mouthing an archaic incantation. You wince inwardly, bracing for the worst. She finishes and goes back to the vigorous stroking, and you are left to wonder what the spell was meant to do- that is, until you feel a tingling beginning at the base of your " +
                this.cockDescript(x) +
                ", slowly climbing up the shaft until your entire length is covered in the sensation.\n\n",
            false
        );
    ...
    public loseToShouldra(): void {
        ...
        if (this.player.hasCock())
            this.outx("Each pulse pushes her a bit further onto your hardening manhood", false);
        else if (this.player.hasVagina())
            this.outx(
                "You can't deny the heat slowly welling up in your loins, your love-tunnel getting more lubricated by the moment",
                false
            );
        else this.outx("You can't deny the heat slowly starting to gather in your bare loins");
        this.outx(
            ". Finally, the waistband of her poor garment bursts, and several handfuls of butt spill onto your torso.\n\n",
            false
        );
        ...
        if (this.player.hasCock()) this.outx("quivering member");
        else if (this.player.hasVagina()) this.outx("sopping gash");
        else this.outx("sensitive crotch-flesh");
        this.outx(
        ...
        if (this.player.gender == 1) {
            ...
            else if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1)
    ...
    private ourDadTaughtUsNotToBeAshamedOfOurDicks(): void {
        ...
        // [first encounter]
        if (this.flags[kFLAGS.SHOULDRA_PENIS_DEFEAT_TIMES] == 0)
            this.outx("She abruptly gasps in excitement, ");
        else this.outx("She 'ooo's softly as she recalls your anatomy, ");
        this.outx(
            "and you feel your hands moving unbidden towards your crotch. You snap the sneaky extremities back to your sides, knowing exactly what she wants to do. The ghost girl soon proves herself the stronger in the contest of wills, however, and eventually, your will breaks and she takes complete control once again. She forces your body to stand, removing your " +
                this.player.armorName +
                " and throwing them carelessly to the ground. She takes your " +
                this.cockDescript(x) +
                ' in both hands and fondles it awkwardly, obviously inexperienced with the male anatomy.  "<i>Most of my hosts have been women,</i>" she explains as she continues to grope your lengthening member.  "<i>And even then, I rarely got to play with their...</i>"\n\n',
            false
        );
    ...
    private loseToShouldraWithWorms(): void {
        ...
        this.outx(
            "and you feel your hands moving unbidden towards your crotch. The ghost girl soon proves herself the stronger in the contest of wills, however, and eventually, your will breaks and she takes control. She heaves your body off the ground, removing your " +
                ...
                " and throwing them carelessly to the ground. She takes your " +
                this.cockDescript(0) +
                ' in both hands and fondles it awkwardly, obviously inexperienced with the male anatomy. "<i>Most of my hosts have been- WHAT THE FUCK!?</i>"\n\n',
            false
        );
    ...
    private ghostGinaLosses(): void {
        ...
        if (this.flags[kFLAGS.SHOULDRA_VAGINAL_POSSESSIONS] == 0)
            this.outx(
                'She \'hmm\'s several times, raising your hand and tapping your finger against your chin. She snaps your fingers as a revelation washes over her.  "<i>Of course!</i>" she cries excitedly.  "<i>I actually have never done this before!</i>"',
                false
            );
        else
            this.outx(
                '"<i>Oh well, I suppose I can always just do that again,</i>" she muses. "<i>It worked well enough the first time.</i>"',
                false
            );
        this.outx("\n\n", false);

        this.outx(
            "You are about to question exactly what she is referring to, but quickly fall silent as she slides out of your " +
                this.player.armorName +
                " and idly strokes your cunt. She takes control of your mouth and chants a fairly lengthy spell, her absent-minded masturbation steadily gaining fervor as she progresses. With a final, shouted word of power, both of you cry out as your clitoris suddenly pulses and swells into your hand, the increased sensitivity nearly driving you insane. Your bitch-button does not stop there, however, puffing up with each heartbeat. Your eyes roll back in your head and small primitive grunts and moans escape your lips as your clit engorges in the ghostly magic, not stopping until it reaches at least four times its original length. A breeze blows through the ruined rooftops, and you scream as the wind brushes against your elongated bitch-button. Too sensitive... the thing is way too sensitive!\n\n",
            false
        );
        ...
        this.outx(
            "You awake some time later in a prodigious puddle of girly spunk and attempt to slowly sit up, only to be impeded by a clunk against the ground.  A clunk?  You prop yourself up on your elbows and glance down to see a large metal pipe, stuck in your vagina presumably some time during your black-out. Reaching down, you extricate a full ten inches of piping from your cunt, and shake your head at the tenacity of your unworldly bodily invader. You are happy to feel a tightening in your crotch, however, as the magic finally wears off, returning your womanhood back to a " +
                this.vaginaDescript(0) +
                ". You also note the absence of your gigantic clitoris, and give yourself a little stroke to confirm; it's reverted to normal size as well. All's well that ends well, you suppose.\n\n",
            false
        );
    ...
    private loseToShouldraAsHerm(): void {
        ...
        if (this.flags[kFLAGS.SHOULDRA_HERMSEX_COUNT] == 0)
            this.outx("She abruptly gasps in excitement, ");
        else this.outx("She coos softly as she recalls your anatomy, ");
        this.outx(
            "and you feel your hands moving unbidden towards your crotch. You snap the sneaky extremities back to your sides, knowing exactly what she wants to do. The ghost girl soon proves herself the stronger in the contest of wills, however, and eventually, your will breaks and she takes complete control once again. She forces your body to stand, removing your " +
                this.player.armorName +
                " and throwing them carelessly to the ground. She takes your " +
        ...
        this.outx(
            "Finally, the seed spills out with an explosive splash into your carnal canal, and your scream only intensifies, the ghost girl joining in with her own melodic voice inside your mind. Gout after gout of cum bursts into you. Your vibrating head keeps the semen from leaking out as your belly protrudes a bit to accommodate. After many blissful moments, your orgasm winds down, and you collapse. Luckily, you remain mindful enough to drag your dick, with the vibration dying down, back out into the open, a torrential mixture of female lovejuice and semen pouring out and pooling around your " +
                this.buttDescript() +
                ". You lie there for minutes, gathering your wits and feeling your penis gradually stiffen once more, the effects worn out. After several attempts, you manage to summon enough strength slide yourself into a sitting position, wondering what happens now.\n\n",
            false
        );
    ...
    private shouldraGiantCockLoss(): void {
        ...
        // [if first time]
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0) this.outx("bemused ");
        ...
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
            this.outx(
                "searches her body for any signs of change, and when she finds none, begins pouting.",
                false
            );
        else
            this.outx(
        ...
        this.outx("  By this time, the ghost girl has finished with the spell, ");
        // [if first time]
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
            this.outx("and instead of offering an explanation, she merely ");
        else this.outx("and, to the green girl's obvious delight, ");
        this.outx("reaches over and kneads the goblin's ");
        // ([if first time]
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
            this.outx("small, firm B-cups");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 1)
            this.outx("perky, sizeable C-cups");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 2)
            this.outx("well-formed, jiggly D-cups");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 3)
            this.outx("big and squishy E-cups");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 4)
            this.outx("oversized, heaving F-cups");
        else this.outx("gigantic and openly-bared G-cups");
        this.outx(". The goblin ");
        // [if first time]
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
            this.outx(
        ...
        else this.outx("cries out in ecstasy at the still-incredible sensation, ");
        // [if first time]
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
            this.outx(
            ...
            this.outx(
                "and you can't help but notice the excited blush running across the second goblin's face",
                false
            );
        this.outx(". The ghost girl pinches a quickly-stiffening nipple and pulls it out, ", false);
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
            this.outx("and... pulls the breast along with it?");
        else this.outx("and pulls the breast along with it.");
        this.outx("  You inwardly gasp ");
        // [if first time]
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
            this.outx("as the effects of the magic are revealed");
        else this.outx("despite seeing the magic before, always enthralled by the process", false);
        this.outx(
            "; it has turned the goblin's breasts into an almost putty-like substance",
            false
        );
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0) this.outx(", evidently!");
        else this.outx(" once again");
        this.outx(
        ...
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
            this.outx("gasps in amazement, ");
        else this.outx("can't restrain her urges any longer, ");
        this.outx("swiftly reaching down to roughly grab at her own ");
        // [if first time]
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0) this.outx("petite boobs");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 1)
            this.outx("modest bosom");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 2)
            this.outx("sizable chest");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 3)
            this.outx("large endowments");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 4)
            this.outx("huge tits");
        else this.outx("titanic melons");
        this.outx(
            ", crying in excitement as her breasts also begin to billow out under her own ministrations.\n\n",
            false
        );

        this.outx("The first goblin's breasts, at this time, have reached at least ");
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0) this.outx("E-cups");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 1) this.outx("F-cups");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 2) this.outx("G-cups");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 3) this.outx("H-cups");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 4) this.outx("I-cups");
        else this.outx("J-cups");
        this.outx(
        ...
        // [if first time]
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0) this.outx("HH-cups");
        // [if repeated once]
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 1) this.outx("II-cups");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 2) this.outx("JJ-cups");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 3) this.outx("KK-cups");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 4) this.outx("LL-cups");
        else this.outx("MM-cups");
        this.outx(
        ...
        // ([if first time]
        if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
            this.outx("DD-cup (and C-cup, on the other side)");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 1)
            this.outx("EE-cup (and D-cup, on the other side)");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 2)
            this.outx("FF-cup (and E-cup, on the other side)");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 3)
            this.outx("GG-cup (and F-cup, on the other side)");
        else if (this.flags[kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 4)
            this.outx("HH-cup (and G-cup, on the other side)");
        else this.outx("II-cup (and H-cup, on the other side)");
        this.outx(
        ...
        this.outx(
            ", which they happily fondle as they wander away, side-by-side. Moving to your " +
                this.player.armorName +
                " and redressing, you shake your head, wondering, not for the first time, if such a large appendage is truly beneficial to you, and wondering if this was the last you've seen of your two new goblin friends.\n\n",
            false
        );
        this.outx(
            'A strange sensation begins in your midsection, and you press a hand against the flesh curiously. You remove it swiftly as a familiar head suddenly pushes out, wiggling about until it faces you. She smiles, then draws her arms out of her torso and uses them as leverage (with a whispered spell to make her hands tangible) to remove herself from you completely. Muttering an incantation and solidifying her again-unremarkable form, she winks at you and gathers her tunic, slipping it over her frame. As you watch, she slips her thumb and forefinger into her satisfied snatch, producing a healthy helping of a spooky gooey substance. Reaching into a pocket inside her tunic, she draws out a small bottle, which she promptly squishes the ectoplasm into. She offers you the bottle, explaining, "<i>The product of a... ghost climax, if you will. Keep it, it\'s good for you.</i>"  With a happy goodbye, she wanders into an alley, grabbing her ruined leggings and discarded shoes as she goes, and disappears into the shadows. You move to leave, but find your ' +
    ...
    private genderlessShouldrasLossRapes(): void {
        ...
        this.outx(
            "Excited to find out what manner of host you are, the ghost-girl swiftly assumes complete control of your body and cups a hand against your crotch to feel... nothing. Confused, she quickly wriggles out of your " +
                this.player.armorName +
                " and goes in for another grope, feeling nothing but skin. \"<i>Son of a... please don't tell me you don't have any sexual bits I can play with!</i>\" she huffs, and you chuckle sheepishly, not knowing what to tell her. She groans unhappily and falls back onto your " +
                this.buttDescript() +
                ', muttering a string of curse words under your breath. "<i>That\'s it!</i>" she fumes. "<i>I\'m going to get off, whether you want me to or not!</i>" She resumes cursing and wiggling your hips for a bit longer, then stops suddenly, a smirk playing across your face. "<i>Whether you want me to or not...</i>"\n\n',
            false
        );

        this.outx("She hops up and makes for the decrepit hut you first saw her in.  ", false);
        if (this.flags[kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0)
            this.outx(
                "You raise an eyebrow, genuinely curious as to how she'll figure out how to relieve her desire.  ",
                false
        ...
        this.outx(
            "when she reaches in and rummages about, producing two eight-inch vibrators with bumpy demon-shafts. She moves back to the center of the room, launching into a short spell as she goes. She sets the dildos on the same nightstand and opens the carton, pulling out four large white eggs.\n\n",
            false
        );

        this.outx(
            "You marvel at how resourceful the ghost-girl is, then pause and consider the ramifications of the eggs. Your suspicions are confirmed as ",
            false
        );
        if (this.player.biggestTitSize() < 1) this.outx("two new additions bud on your chest.");
        else if (this.player.biggestTitSize() <= 8)
        ...
        this.outx("  As the ghost continues darting around the room, ");
        if (this.player.biggestTitSize() <= 8) this.outx("your new EE-cup breasts settle");
        else this.outx("the lactation continues");
        this.outx(
        ...
        this.outx("She smacks it ");
        if (this.player.isNaga()) this.outx("against your naga-crotch");
    ...
    private ghostGartuanLossSceneOrSomeShit(): void {
        ...
        this.outx(
            "Your entire body shivers in delight as the ghost girl regards your excessively large " +
                this.cockDescript(x) +
                ". She places your hand over the bulge in your " +
                this.player.armorName +
                ' and titters in glee as your member twitches and hardens, just a tad. She strips eagerly, but is halted by a familiar booming voice coming from the half-erect member. "<i>WHO THE HELL IS THIS BITCH?</i>" a perplexed Exgartuan yells grumpily. "<i>Living in peoples\' bodies is MY THING!</i>"\n\n',
            false
        );
        ...
        if (this.player.gender == 3) this.outx("like this bitch here");
        this.outx('?</i>"\n\n', false);
    ...
    private courtCrazyGirlsDotCom(): void {
        ...
        this.outx(
            'Her smile widens as she regards your venerable visage. "<i>Is that so?</i>" she says softly. "<i>Interesting. I\'ll be back in a moment.</i>" She returns to her "<i>house,</i>" rummaging around for some time before returning to you, hands hidden behind her. "<i>If I am to be sought by a paladin, we must do things right,</i>" she explains, handing you a small silk handkerchief. The white fabric slides around your fingers like a sacrosanct flow of holy water, and you reverently tuck her gift into your ' +
                this.player.armorName +
                ", laying it over your heart. \"<i>Come back in two days' time, please,</i>\" she asks softly. Your eyes meet for a long moment, and it appears as if she's struggling to say something. She instead breaks away and starts back towards her shelter. \"<i>Be safe,</i>\" she advises, and with a smile and a wave, she's gone. For moments you stand silently, then you turn and start away with long, saintly strides. There's more work to do.\n\n",
            false
        );
    ...
    private ginaBoobgartuanShouldra(): void {
        ...
        this.clearOutput();
        this.outx(
            '"<i>Ah,</i>" she sighs while settling into your form, "<i>only ladyparts... well... ugh.</i>"  You can sense her disappointment, and regardless of the ridiculousness of the situation, you feel cheering her up would be helpful. On sudden inspiration, you begin to tickle and tease your ' +
                this.allBreastsDescript() +
                ".  Before long, the ghost girl's protests change to grunts of satisfaction.  \"<i>Those are... nice,</i>\" she admits, and with her pleasure in mind, you knead the torpedoes more forcibly, eliciting a small gasp from her.  What you didn't have in mind, however, was the occupant of the oversized orbs you're handling.  With a boobquake that actually forces your hands away, the archdemon Exgartuan surges to alertness."
        );
        this.outx(
            '\n\n"<i>RIGHT, THEN, WHAT THE FUCK IS THIS!?</i>"  Several moments pass before you realize your demonic knockers are referring to your temporary "roommate."    Before you can begin to explain, the spirit moves her essence up into your shoulder, her head pushing out of the skin to get a better look at your moving, talking ' +
                this.allBreastsDescript() +
                "."
        );
        this.outx(
            '\n\n"<i>Who the fuck is THIS?</i?" she retorts, her sharp tone making you wince.  "<i>And why are you in this gal\'s boobs?  Oh, and-</i>"  She\'s cut short, her face contorting into a mask of discomfort.  The specter\'s head begins bobbing, as if she something were tugging her foot.  With a small yelp, she disappears completely, pulled back into your body, and... into your breasts?  Indeed, you can actually feel the spirit moving into the ' +
                ...
                ", and you can't help but shudder at the sensation.  As you're moving a hand curiously to your endowments, a voice -- it has to be the ghost girl's -- rings out.  \"<i>Oh nooo!  I've been caught!</i>\" she wails, but despite the words, you detect nearly cloying overtones of arousal.  While you're pondering her change of heart, you suddenly fall into a dream-like trance.  When your vision clears, you're struck with a vision of two figures in a huge chamber. The walls, you notice, have a suspiciously fleshy texture."
        );
        this.outx(
            "\n\nCombined with the semi-spherical shape of the room, you can easily surmise where the \"dream\" is located.  The two figures shift, and your view is brought closer in.  Your eyes immediately lock on what can only be Exgartuan, and you can't help but stare at her personification.  The demon's " +
                this.allBreastsDescript() +
                " glisten, illuminated by the fel fire simmering in her eyes.  Unconsciously, your eyes begin moving south, taking in her impossibly narrow waist and the comparatively enormous pair of hips.  The exquisitely proportioned woman approaches the kneeling ghost girl, the sway of her lower body holding both you and the spirit in a mild trance."
        );
        this.outx(
            "\n\nBefore either of you can react, Exgartuan has closed the distance.  The demon deliberately runs a finger under the ghost's chin, propping her head up gently.  As if bogged down by the sheer amount of lust, she slowly blinks and parts her lips, trying to speak to the demoness.  As soon as her mouth opens, however, it's filled with Exgartuan's " +
                this.nippleDescript(0) +
                ", eyes widening shortly before dipping out of sight as your corrupted copycat presses her huge breast into the wraith's face.  Her freckled features are completely buried in a sea of flesh.  With no alternatives presented, the ghost simply begins suckling passionately on the nub, groaning happily into the wall of breast threatening to engulf her."
        );
        this.outx(
        ...
        this.outx(
            "\n\nThough exhausted and a little sore from Exgartuan's treatment of your body, you keep the presence of mind to lean down -- pushing your " +
                this.breastDescript(0) +
                " out of the way -- and scoop up a little ectoplasm from her still-gaping box.  You make a point to ignore Exgartuan's triumphant chortle as you leave the ghost girl to her sleep and walk back to camp.  What a day."
        );
        this.player.orgasm();
        if (this.getGame().inCombat) {
            this.flags[kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.consumables.ECTOPLS.id;
    ...
    private slimeGhostGalForHerms(clearOut = false): void {
        ...
        if (this.flags[kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] == 0)
            this.outx("I've got this thing all figured out.");
        // event occurrence =1
        else if (this.flags[kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] == 1)
            this.outx("I've got this thing all figured out.  For real this time.");
        // event occurrence >=2
        else if (this.flags[kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] == 2)
            this.outx("I've got this thing all figured out.  For real this time.  Promise.");
        // event occurrence >=3
        else this.outx("Well... don't worry TOO much.");
        this.outx('</i>"');
        this.outx(
        ...
        if (this.flags[kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] <= 2)
            this.outx("Maybe she really does have a firm grip on the reigns of this beast.");
        // event occurrence >=3
        else
            this.outx(
        ...
        // vaginalLooseness == 0
        if (this.player.looseness() == 0) this.outx("tight");
        // vaginalLooseness == 1
        else if (this.player.looseness() == 1) this.outx("forgiving");
        else if (this.player.looseness() == 2) this.outx("loose");
        else if (this.player.looseness() == 3) this.outx("gaping");
        else this.outx("cavernous");
        this.outx(", velvety scabbard.  Hands too busy latched onto one another's hips, ");
        if (this.player.biggestTitSize() > 0)
            this.outx(
                "both you and the spooky slime press your tits together, your swaying thrusts only enhancing the mammary meltdown."
            );
        else
            this.outx(
                "the spooky slime presses her tits hard into your flat chest, your gyrations teasing them to no end."
            );
        this.outx(
            "  The fierce battle increases in tempo; the sly leering the two of you used to try and psyche the other out is giving way to slight head-lashing and gasps through clenched teeth."
        );
        this.outx(
        ...
        if (this.flags[kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] > 0) this.outx("  Again.");
        this.outx(
        ...
        this.outx(
            '"<i>Boo!</i>"  your face shouts at you, triggering a panicked backwards jolt from you which then results in you slipping back down on your [butt].  The spook easily phases out of you during your tumble, standing perfectly still from your previous position as she glares down at you with the same mischievous smile from earlier.'
        );
        this.outx(
            '"<i>Yea, I jumped ship from that senseless slime the moment it finished filling you up to christen the S.S.  Ballsac,</i>" she explains, her tone free of any responsibility.  "<i>You\'re lucky I was around to pick up the slack for you.  '
        );
        if (this.flags[kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] == 0)
            this.outx(
                "You couldn't spank it even to save your life, as we've learned today.</i>\""
            );
        else
            this.outx(
                "Evidently, you haven't put in any meaningful practice since last time,</i>\" the specter chides you while making an exaggerated jerking-off motion."
            );
        if (this.flags[kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] == 1)
            this.outx('  "<i>I was afraid you\'d have... given up the ghost.</i>"');
        else if (this.flags[kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] > 1)
            this.outx(
                '  "<i>But I\'m more than willing to do it again next time with a conclusion like that!</i>"'
            );
        this.outx(
