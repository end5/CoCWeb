...
export class MarblePurification extends NPCAwareContent {
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
    ...
    public visitRathazulToPurifyMarbleAfterLaBovaStopsWorkin(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.CampRathazul) < 0) {
            this.outx(
                `\n\n"<i>Whoa, hold on there, ${this.player.mf(
                    "boy",
                    "girl"
    ...
    public voluntarilyChooseCowCuntBadEndYouBad(): void {
        this.clearOutput();
        this.outx(
            `Giving into the desires that your addiction has granted you, you return to Clara’s breast, much to the young cow-girl’s moans and sighs of pleasure.  "<i>Ahh, yes, that's a goood ${this.player.mf(
                "boy",
                "girl"
    ...
    public mediumIntelligenceDoesntDrinkCowCuntsTea(): void {
        ...
        this.outx(
            `\n\n"<i>You really are a smart ${this.player.mf(
                "boy",
                "girl"
    ...
    public losingToCowCuntsPageII(): void {
        ...
        this.outx(
            `\n\nIt feels like you’re ordering the deaths of everyone you’ve ever cared about, but you do nod your head.  "<i>That’s not goood enough, ${this.player.mf(
                "lover-boy",
                "lover-girl"
    ...
    public badEndDickThatFitsClara(): void {
        ...
        this.outx(
            `You’re still erect from the arousal that nursing from Clara gave you.  The young cow-girl straddles your calves and gives your ${this.cockDescript(
                x
        ...
        this.outx(
            `\n\nWell, she certainly isn’t wasting any time, as the very next instant she has lowered her opened labia onto the tip of your ${this.cockDescript(
                x
    ...
    public cocklessPCsGetAbusedByCowCunts(): void {
        ...
        if (this.player.tongueType > 0) {
            ...
            this.outx(
                `\n\nClara finally releases your head from her death grip, and lets you move around again.  "<i>Wow, ${this.player.mf(
                    "lover-boy",
                    "lover-girl"
    ...
    public defeatClaraCuntInAFight(cheated = false): void {
        ...
        this.outx(
            `\n\n"<i>Getting a mate, what doo you think?  I was going to take ${this.player.mf(
                "lover-boy",
                "lover-girl"
            )} here away to live with me,</i>" comes the incredulous reply.`
        );
        this.outx(
            `\n\n"<i>Getting a... out of my sweetie?!  We're already mates, where do you go off thinking you can just come in here and steal ${this.player.mf(
                "him",
                "her"
            )}?</i>"`
        );
        ...
        this.outx(
            `\n\n"<i>Admit it, you don't feel like '${this.player.mf(
                "lover-boy",
                "lover-girl"
            )}' here actually cares for you.  How could they if they won't drink your milk?  You're a Lacta Bovine, giving your milk is the most important thing in the world to you.  This isn't love.  Without ${this.player.mf(
                "him",
                "her"
            )} actually being addicted to you, it's just a one sided infatuation.  I was doing you a favor by taking ${this.player.mf(
                "him",
                "her"
            )} away from you.</i>"`
        );
        ...
        this.outx(
            `\n\nThe younger cow-girl scoffs, "<i>Haven't you been listening to me sis?  ${this.player.mf(
                "He",
                "She"
        ...
        this.outx(
            `\n\n"<i>Really?  Didn't you say that the reason you were purifying yourself was so that ${this.player.mf(
                "he",
                "she"
    ...
    public pcAndMurbleDoubleTeamCowButt(): void {
        ...
        if (this.player.hasCock() && x >= 0 && this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0) {
            ...
            this.outx(
                `\n\nMarble looks to the side of her sister's head, and gives you a solemn nod.  You take that as an invitation to begin the violation and grab a good grip of Clara's expansive rear.  Then you prod your ${this.cockDescript(
                    x
            ...
            this.outx(
                `\n\nSuddenly Clara's anus clamps down sharply on your ${this.cockDescript(
                    x
            ...
            this.outx(
                `\n\nInstantly Marble's expression changes and she lets out a long low moan.  As a reward, you switch from quick thrusts to a slow rub against her entrance.  This proves to be quite a reward indeed as you feel a flood of Clara's juices spill out onto your groin from around the ${this.cockDescript(
                    x
    ...
    public NTRIsClearlyTheWorstFetishWhyWouldYouWriteThisOMG(): void {
        ...
        if (this.player.hasCock() && x >= 0) {
            this.outx(
                `she drops herself onto your ${this.cockDescript(
                    x
    ...
    public dealingWithCowCuntPostPurification(): void {
        ...
        this.outx(
            `\n\n"<i>Congratulations!  You're not a Lacta Bovine anymore.  It isn't like I was trying to stop you from doing that, but now you sure as hell don't deserve a mate anymore.  You can't even claim one.</i>"  Clara turns her attention to you, "<i>Did you hear that, ${this.player.mf(
                "lover-boy",
                "lover-girl"
        ...
        this.outx(
            `\n\n"<i>Fuck off, mutant,</i>" she dismisses her sister in an instant.  "<i>I want to tell my destined mate what kind of a life ${this.player.mf(
                "he",
                "she"
