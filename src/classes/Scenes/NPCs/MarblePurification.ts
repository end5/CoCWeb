...
export class MarblePurification extends NPCAwareContent {
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////*/
    ...
    public BLUHBLUH(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] <= 1) this.outx("human");
        else this.outx("bovine");
        this.outx(
        ...
        if (
            ...
            this.outx("  ...Has she been fighting with ");
            if (this.amilyScene.amilyFollower() && !this.amilyScene.amilyCorrupt())
                this.outx("Amily");
            else if (this.followerKiha()) this.outx("Kiha");
            else this.outx("Izma");
            this.outx("?");
        }
    ...
    public giveMarblePureQuestLabova(): void {
        ...
        if (this.flags[kFLAGS.TIMES_GIVEN_MARBLE_PURE_LABOVA] == 0) {
            ...
            if (this.player.statusAffectv2(StatusAffects.MarbleSpecials) == 4) this.outx("eight");
            else this.outx("two");
            this.outx(
        ...
        // Every other time
            ...
            if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] > 1) this.outx(", fur covered");
            this.outx(
    ...
    public visitRathazulToPurifyMarbleAfterLaBovaStopsWorkin(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.CampRathazul) < 0) {
            this.outx("You spot the elderly alchemist's camp on the lake once more.\n\n");
        }
        this.outx(
    ...
    public rathazulsMurbelReport(): void {
        ...
        this.outx("When you wake and join Marble ");
        if (kGAMECLASS.camp.companionsCount() > 2) this.outx("and your other followers ");
        this.outx(
    ...
    public claraShowsUpInCampBECAUSESHESACUNT(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] <= 1) this.outx("your mate has");
        else this.outx("what your mate use to have");
        this.outx(
        ...
        if (this.player.inte >= 60) this.outx(" with a odd smile on her face");
        this.outx(
        ...
        if (this.player.inte >= 60) this.outx(" somewhat unconvincingly");
        this.outx(".");
    ...
    public partTwoOfLowIntelligencePCsFallingForTheIncrediblyObviousCowCuntsTrap(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] <= 1) this.outx("face");
        else this.outx("muzzle");
        this.outx(
        ...
        if (this.player.weaponName != "fists") this.outx("your [weapon] is nearby, and ");
        this.outx(" you’re still wearing your [armor].");
    ...
    public highIntelligenceOutcomesVsCowCuntDrugs(teaDrinkers = 0): void {
        ...
        if (teaDrinkers <= 1) this.outx("Marble");
        else this.outx("your followers");
        this.outx(", just not drink any tea yourself, or drink it anyway?");
    ...
    public loseToClara(combat = true): void {
        ...
        if (this.player.tallness < 70) this.outx("much too big for you.");
        ...
        else this.outx("You’re completely naked.");
    ...
    public losingToCowCuntsPageII(): void {
        ...
        if (kGAMECLASS.camp.loversCount() == 1) this.outx("Marble");
        else this.outx("the others");
        this.outx(".  Then your eyes drop down to Clara’s chest, and you think of your need.");
    ...
    public cockTooBigForCowCuntageBadEndage(): void {
        this.clearOutput();
        this.outx('"<i>Now, we do have one problem.  ');
        if (this.player.cockTotal() > 1) {
            this.outx("All of your penises are");
        } else this.outx("Your penis is");
        this.outx(
    ...
    public defeatClaraCuntInAFight(cheated = false): void {
        ...
        if (
            ...
            this.outx("have sex in front of Clara so she can see what your love really is, ");
        // (if Marble is a futa)
        if (this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0)
            this.outx("egg Marble into violating Clara with her cock, ");
        this.outx(" or try to calm Marble down so that she doesn't do anything to her sister.");
    ...
    public rathazulFinishingMarblesPotion(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_KIDS] > 0) {
            this.outx("Then we'll be ready to purify you and your child");
            if (this.flags[kFLAGS.MARBLE_KIDS] > 0) this.outx("ren");
            this.outx(".  ");
        }
        this.outx('So come back a little later.</i>"  The rodent returns to his reactions.');
    ...
    public theFormulaIsDone(): void {
        ...
        this.outx('Of course, you know what happened next,</i>" she sighs.');
    ...
    public purifyMarbleComplete(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_KIDS] > 0) {
            ...
            this.outx(" right away.  Give ");
            if (this.flags[kFLAGS.MARBLE_KIDS] == 1) this.outx("her");
            else this.outx("each");
            this.outx(
            ...
            if (this.flags[kFLAGS.MARBLE_KIDS] > 1) this.outx("each of ");
            this.outx("your child");
            if (this.flags[kFLAGS.MARBLE_KIDS] > 1) this.outx("ren");
            this.outx(" two drops of the formula.  ");
            if (this.flags[kFLAGS.MARBLE_KIDS] > 1) this.outx("They ");
            else this.outx("She ");
            this.outx("take");
            if (this.flags[kFLAGS.MARBLE_KIDS] == 1) this.outx("s");
            this.outx(" it easily enough, and while there are no outward effects, ");
            if (this.flags[kFLAGS.MARBLE_KIDS] == 1) this.outx("your ");
            else this.outx("each ");
            this.outx("child does report feeling like something was lifted from ");
            if (this.flags[kFLAGS.MARBLE_KIDS] > 1) this.outx("their");
            else this.outx("her");
            this.outx(" mind.");
    ...
    public purifiedSuccubusMilkForPureMarbles(): void {
        this.clearOutput();
        this.outx("Do you want to ask Marble to grow her breasts bigger?");
    ...
    public actuallyGrowPureMarblesTittiesForFunzies(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_BREAST_SIZE] < 3) {
            ...
            this.outx(kGAMECLASS.marbleScene.marbleBreastSize() + " melons!");
    ...
    public pureMurbleUsesReducto(): void {
        this.clearOutput();
        this.outx("Do you want to ask Marble to shrink her breasts down?");
        this.menu();
    ...
    public pureMurblePCChoosesYesToShrinkeyTits(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_BREAST_SIZE] > 0) {
            ...
            this.flags[kFLAGS.MARBLE_BREAST_SIZE]--;
            this.outx(kGAMECLASS.marbleScene.marbleBreastSize() + " sized breasts.");
            if (this.flags[kFLAGS.MARBLE_BREAST_SIZE] == 0) {
                this.outx(
    ...
    public nursingFromPureMarble(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] < 4) {
            ...
            if (this.player.tallness < 65) {
                ...
                this.outx("You lean forward and ");
            } else {
                this.outx("You lift up the cow-lady to get access, ");
            }
            this.outx(
    ...
    public marbleLeavesThePCOverCorruption(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_KIDS] > 1) this.outx(" , and with her children in tow");
        // else if (PC has one child with Marble)
        else if (this.flags[kFLAGS.MARBLE_KIDS] == 1) this.outx(", and holding her child's hand");
        this.outx(
    ...
    public pureMarbleDecidesToBeLessOfABitch(): void {
        ...
        // if (PC has at least one child with Marble)
        if (this.flags[kFLAGS.MARBLE_KIDS] > 0) this.outx(" and that of your child");
