...
export class MarblePurification extends NPCAwareContent {
    ...
    public BLUHBLUH(): void {
        this.clearOutput();
        this.outputText(
            "When you return to camp, you find Marble seated at the campfire, staring gloomily into the ashes. Curious, you approach your bovine lover and ask her what the matter is. She looks up at you, her "
        );
        if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] <= 1) this.outputText("human");
        else this.outputText("bovine");
        this.outputText(
            ' head still in her hands, and sighs loudly. <i>"I’m sorry, sweetie, I just... I’ve tried to ignore it, but I just don’t feel comfortable here."</i>'
        );
        ...
        if (
            ...
            this.outputText("  ...Has she been fighting with ");
            if (this.amilyScene.amilyFollower() && !this.amilyScene.amilyCorrupt())
                this.outputText("Amily");
            else if (this.followerKiha()) this.outputText("Kiha");
            else this.outputText("Izma");
            this.outputText("?");
        }
        ...
        if (this.player.hasItem(this.consumables.PURHONY))
            this.outputText(
                "  You then recall that bottle of honey the bee-girl gave you, and ask if maybe it might work?"
            );
        if (this.player.findStatusAffect(StatusAffects.PureCampJojo) >= 0)
            this.outputText(
                "  You remember how Jojo helped you become pure, and suggest maybe his meditations could assist Marble?"
            );
    ...
    public giveMarblePureQuestLabova(): void {
        this.clearOutput();
        this.player.consumeItem(this.consumables.P_LBOVA);
        this.outputText(
            "You tell Marble that you managed to get some LaBova alchemically purified, and you want her to drink some."
        );
        //First time
        if (this.flags[kFLAGS.TIMES_GIVEN_MARBLE_PURE_LABOVA] == 0) {
            //Marble’s corruption is reduced by 4
            this.player.addStatusValue(StatusAffects.Marble, 4, -4);
            this.outputText(
        ...
        else if (this.player.statusAffectv4(StatusAffects.MarbleSpecials) <= 30) {
            this.outputText(
        ...
        //Every other time
            ...
            if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] > 1) this.outputText(", fur covered");
            this.outputText(
                " breasts to dangle freely. Stoically she bears the pain as her stomach loudly rumbles and groans, holding her breasts up proudly as her "
            );
            if (this.player.statusAffectv2(StatusAffects.MarbleSpecials) == 4)
                this.outputText("eight");
            else this.outputText("two");
    ...
    public visitRathazulToPurifyMarbleAfterLaBovaStopsWorkin(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.CampRathazul) < 0) {
            this.outputText("You spot the elderly alchemist's camp on the lake once more.\n\n");
        }
        this.outputText(
            "As you approach the rodentine alchemist, you remember Marble’s problems and resolve to ask him if he can possibly help you. Once he finishes greeting you, you politely return the greeting and ask if he would be willing to lend his opinion on a problem you have."
        );
        this.outputText(
    ...
    public pageTwoOfVisitingTheRatForMurblesPurification(): void {
        this.clearOutput();
        this.outputText(
            'Fortunately, Marble is at your camp rather than off at Whitney’s, and your bovine lover looks up at you hopefully as you approach. "<i>Did he say he could help?</i>" she asks, excitedly.'
        );
        this.outputText(
    ...
    public rathazulsMurbelReport(): void {
        ...
        this.outputText("When you wake and join Marble ");
        if (kGAMECLASS.camp.companionsCount() > 2) this.outputText("and your other followers ");
        this.outputText(
            "for breakfast this morning, you find a bleary-eyed Rathazul waiting at the campfire. Marble clucks her tongue and gives him a mug of something strong, which he accepts gratefully, noisily slurping down a mouthful. He takes a seat, staring into his mug, and then sighs softly."
        );
        this.outputText(
        ...
        this.outputText(
            '\n\n"<i>Then that’s the solution!</i>" Marble declares, full of cheer. But then her face falls. "<i>But it’ll take me a few days to get from here to home, and then more to get back. ' +
                this.player.short +
                ', I don’t want to leave you here alone if you need my help,</i>" she insists.'
        );
        this.outputText(
        ...
        this.addButton(
            0,
            "Go",
            this.murbleShouldGoRunAlongAndGetHerCuntySisterSoTheyCanBeCuntsTogether
        );
    ...
    public stayHereAndDontGoGetYerSisterShesABitch(): void {
        this.clearOutput();
        this.outputText(
            "You shake your head and tell Marble that you still need her at the camp; you’ll tell her when you can spare her."
        );
        this.outputText(
    ...
    public murbleShouldGoRunAlongAndGetHerCuntySisterSoTheyCanBeCuntsTogether(): void {
        this.clearOutput();
        this.outputText(
            "You tell Marble that if she needs some time off to go and see her family for this matter, it’s okay with you."
        );
        this.outputText(
    ...
    public claraShowsUpInCampBECAUSESHESACUNT(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] <= 1) this.outputText("your mate has");
        else this.outputText("what your mate use to have");
        this.outputText(
            "; cow legs, ears, horns, and large breasts.  However, she doesn’t have Marble’s brown fur, instead having black and white blotched fur across her legs and ears and a mane of white hair atop her head.  She is wearing a one piece thick cloth dress, with a great deal of fancy embroidery decorating it.  You also guess that she’s a bit smaller than Marble, in both the chest and height departments."
        );
        ...
        if (this.player.inte >= 60) this.outputText(" with a odd smile on her face");
        this.outputText(
        ...
        if (this.player.inte >= 60) this.outputText(" somewhat unconvincingly");
        this.outputText(".");
        ...
        this.outputText(
            '\n\nAt this point Rathazul suddenly interjects. "<i>If ' +
                this.player.short +
                " gets the milk by suckling on your breasts, " +
                this.player.mf("he", "she") +
                " would probably contaminate it with " +
                this.player.mf("his", "her") +
                ' saliva and make it useless. I need it to be as pure as possible; hand-milking would be preferable, if you can do that, but if you must use the milkers at Whitney’s farm, that will suffice.</i>"'
        );
    ...
    public partTwoOfClaraShowingUpAndBeingACunt(): void {
        this.clearOutput();
        this.outputText(
            "You turn back to the camp and continue going about your morning routine.  By the time you’re ready to head out, the girls have come back from the farm, bearing a bottle of Clara’s milk.  The spotted bovine’s foul mood seems to have improved as well."
        );
        ...
        if (kGAMECLASS.camp.companionsCount() >= 3) {
            ...
            if (this.isabellaFollower()) {
                ...
                if (this.isabellaAccent()) {
                    this.outputText(
                        "  Isabella jumps from her chair, “<i>Tea?  Ooh, ja!  I hear tea und milk iz sehr gut combination, ja?</i>”  Well, she seems rather enthusiastic if nothing else."
                    );
                } else {
                    this.outputText(
                        "  Isabella jumps from her chair, “<i>Tea? Ooh, yes!  I hear tea and milk is a really good combination, yes? I've never had the opportunity to try it though...</i>”  Well, she seems rather enthusiastic if nothing else."
                    );
                }
        ...
        this.flags[kFLAGS.MURBLE_TEA_DRINKER_COUNT] = teaDrinkers;
    ...
    public dumbshitCowCuntsTryToDrugYouBecauseTheyreCunts(teaDrinkers: number): void {
        ...
        if (this.player.inte >= 60)
            this.addButton(0, "Next", this.highIntelligenceOutcomesVsCowCuntDrugs);
        else if (this.player.inte >= 30)
            this.addButton(0, "Next", this.mediumIntelligenceReactsToDrugging);
    ...
    public lowIntelligenceGetsDruggedByCowSluts(): void {
        this.clearOutput();
        this.outputText(
            'Once everyone has a cup, Clara smiles at all of you and holds her own cup up to her mouth and says, "<i>To Marble’s purification and meeting new friends.</i>"'
        );
        ...
        this.addButton(
            0,
            "Next",
            this.partTwoOfLowIntelligencePCsFallingForTheIncrediblyObviousCowCuntsTrap
        );
    }
    public partTwoOfLowIntelligencePCsFallingForTheIncrediblyObviousCowCuntsTrap(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] <= 1) this.outputText("face");
        else this.outputText("muzzle");
        this.outputText(
            ", you try to figure out what the heck is going on.  You remember meeting Marble’s sister, then getting tea, and then...  What did Clara say to Marble?  You groan slightly, your body feeling an odd old craving."
        );
        ...
        if (this.player.weaponName != "fists") this.outputText("your [weapon] is nearby, and ");
    ...
    public fightCowCuntAfterBeingTotesMcGoatsDrugged(): void {
        this.clearOutput();
        this.outputText("You steel yourself, ");
        if (this.player.weaponName == "fists") this.outputText("raise your fists");
        else this.outputText("grab your " + this.player.weaponName);
        this.outputText(
    ...
    public startCombatWithMarbleSister(inCamp: boolean = true): void {
        ...
        if (inCamp && this.player.findStatusAffect(StatusAffects.ClaraFoughtInCamp) < 0)
            this.player.createStatusAffect(StatusAffects.ClaraFoughtInCamp, 0, 0, 0, 0);
    }
    //Chose submit
    public voluntarilyChooseCowCuntBadEndYouBad(): void {
        this.clearOutput();
        this.outputText(
            "Giving into the desires that your addiction has granted you, you return to Clara’s breast, much to the young cow-girl’s moans and sighs of pleasure.  \"<i>Ahh, yes, that's a goood " +
                this.player.mf("boy", "girl") +
                ',</i>" is whispered in your ear.'
        );
    ...
    public mediumIntelligenceReactsToDrugging(): void {
        this.clearOutput();
        this.outputText(
            "While Clara is handing out the cups, you can’t help but think how strange everything about this feels.  You can’t put your finger on what exactly is wrong, but neither can you put the unsettling feeling out of your mind."
        );
        this.outputText(
    ...
    public mediumIntelligenceDoesntDrinkCowCuntsTea(): void {
        ...
        if (kGAMECLASS.camp.companionsCount())
            this.outputText("\n\nYou rush over to your fallen companion");
        else this.outputText("\n\nYou rush over to one of your fallen companions");
        this.outputText(
            " to see what has happened, only to find that she has passed out.  Noticing the tea cup again, you turn around to face the person who prepared it.  Clara stands behind you with a disturbing smile on her face.  You demand to know what was in the tea, like Marble did before."
        );

        this.outputText(
            '\n\n"<i>You really are a smart ' +
                this.player.mf("boy", "girl") +
                ',</i>" the girl speaks, ignoring your question, "<i>I shoould have known you wouldn’t be so easy to trick.</i>"  You make your demand of her once more.  "<i>Don’t worry about them, my darling.  They’ll be awake in an hour or so, but by that time we’ll be long goone.</i>"'
        );
        this.outputText(
    ...
    public mediumIntelligencesFightCowCunts(): void {
        this.clearOutput();
        this.outputText(
            'You ready yourself for battle as Clara pulls an angry looking heavy mace out and says, "<i>Fine, we’ll doo this the hard way.</i>"'
        );
        //start battle with Clara
        this.startCombatWithMarbleSister(true);
    }
    //Submit
    public mediumIntelligencesSubmitCowCunts(): void {
        this.clearOutput();
        this.outputText(
            'You sigh and accept the cup from the cow-girl’s hands and down its contents.  In moments, your vision clouds over, and you fall into her soft arms.  Just before everything goes black, you hear a voice say, "<i>Come on now, lets run away toogether.  I’ll make sure you’re addicted before you next wake up.</i>"'
        );
        //go to bad end
        this.menu();
        this.addButton(0, "Next", this.loseToClara, false);
    ...
    public highIntelligenceOutcomesVsCowCuntDrugs(teaDrinkers: number = 0): void {
        ...
        if (teaDrinkers <= 1) this.outputText("Marble");
        else this.outputText("your followers");
    ...
    public highIntelligenceCallClaraOut(): void {
        ...
        if (this.camp.companionsCount() >= 3) {
            ...
            this.outputText(
                "\n\nYou stand up as well and ready your " +
                    this.player.weaponName +
                    ", since even with such opposition it looks like the mad cow-girl still plans on fighting you.  A few minutes and bruises later, her beaten body proves this to have been a bit of a mistake on her part."
            );
    ...
    public loseToClara(combat: boolean = true): void {
        ...
        if (combat) {
            if (this.player.HP < 1)
                this.outputText(
                    "Your body gives out from the strain, and you fall to the ground.  The last thing you hear before you pass out, is Clara’s triumphant laughter."
                );
            //proceed to loss scene
            //PC loses via lust
            else
                this.outputText(
                    "You just can’t fight it anymore, and desperately start to masturbate in front of Clara.  Laughing triumphantly, Clara walks up to you and forces a pill down your throat.  A moment later, you pass out."
                );
            this.outputText("\n\n");
        }
        //proceed to loss scene
        ...
        this.outputText(
            "You dream of odd things, distorted images that you called out for help to.  Then you were dragged away.  You kept seeing more shapes that felt familiar and important somehow, but you couldn’t focus on them.  You’d call again and again, only to be dragged away by something else again.  Eventually your cries for help become weaker and halfhearted; you know what’s going to happen next, so why bother?  Suddenly you realize that it is a cow-girl that is dragging you away; her face looks like Marble’s at first, then it splits into a huge, wicked smile, and you panic."
        );
        this.outputText(
        ...
        if (this.player.tallness < 70) this.outputText("much too big for you.");
        else if (this.player.tallness <= 82) this.outputText("just your size.");
        else this.outputText("way too small for your stature.");
        this.outputText(
            "  You also find that you aren’t wearing your " +
        ...
        if (
            this.player.hasCock() &&
            this.player.smallestCockArea() <= 40 &&
            this.player.biggestTitSize() <= 25 &&
            !this.player.isTaur() &&
            !this.player.isNaga() &&
            !this.player.isGoo() &&
            ...
            this.outputText(
                "Instead a plain but rather slim form fitting two piece garb adorns your body.  Whoever dressed you in that definitely wanted your bodily assets to be fully visible to anyone looking at you."
            );
        else this.outputText("You’re completely naked.");
    ...
    public losingToCowCuntsPageII(): void {
        this.clearOutput();
        this.outputText(
            "It is then that you realize with a shock that a familiar urge is welling up inside you.  No, it is much stronger than you remember it being before.  You want breastmilk.  You <i>need</i> breastmilk, and if you don’t get it, you’ll die.  To make matters worse, you know whose breastmilk it is too.  Clara, Marble’s younger sister, has fatally addicted you to her milk."
        );
        this.outputText(
        ...
        if (this.player.statusAffectv3(StatusAffects.Marble) == 1) {
            this.outputText(
                '"<i>Oh?  Wondering how I know about that?  Marble told me when she was explaining about you breaking free of the addiction.  Unlike her, I’m going to make sure you behave yourself.</i>"  '
            );
        } else {
            this.outputText(
                '"<i>Confused?  That was one of the things Marble found out when she was researching the nature of her addiction.  She said she didn’t want to trouble you with that knowledge, but I don’t see why.</i>"  '
            );
        }
        this.outputText(
            "This woman is nothing like her sister, she loves the power she has over you, and loves to show you just how much she has."
        );
        ...
        if (kGAMECLASS.camp.loversCount() == 1) this.outputText("Marble");
        else this.outputText("the others");
        this.outputText(
            ".  Then your eyes drop down to Clara’s chest, and you think of your need."
        );

        this.outputText(
            '\n\nIt feels like you’re ordering the deaths of everyone you’ve ever cared about, but you do nod your head.  "<i>That’s not goood enough, ' +
                this.player.mf("lover-boy", "lover-girl") +
                '.  I want to hear you say, ‘I love you, I love only you, and I will love only you.’  If you don’t, then there will be no milk for you.</i>"  An exaggerated sad expression falls across her face, and it sounds like she is chastising a misbehaving child as she says that.'
        );
        this.outputText(
    ...
    public cowCuntBadEndPartIII(): void {
        ...
        if (this.player.hairLength > 0) this.outputText("through your " + this.hairDescript());
        else this.outputText("across your scalp");
        this.outputText(
    ...
    public cowCuntBadEndPartIV(): void {
        this.clearOutput();
        this.outputText(
            "Now you get a chance to see a softer side to Clara.  The cow-girl gently takes your head and guides you to the other nipple.  She continues to hold you with one arm as you gently start drinking.  With her other hand, she caresses you.  She starts with your head, slowly cleaning up your " +
                this.hairDescript() +
                '.  Your feeder then delivers a small pinch to your cheek, and you hear her say, "<i>You really are a damn sexy piece of woork.</i>"'
        );
        this.outputText(
        ...
        if (this.player.hasCock() && !this.player.hasVagina()) {
            this.outputText(
                "At this point your " +
                    ...
                    " is rock hard, and Clara gives it a few strokes.  She does seem to lose interest surprisingly quick though."
            );
        } else if (this.player.hasVagina() && !this.player.hasCock()) {
            this.outputText(
                "You’ve become quite wet at this point, and Clara gives your " +
                    this.vaginaDescript() +
                    " a few rubs, before tugging on your " +
                    this.clitDescript() +
                    " once."
            );
        } else if (this.player.hasCock() && this.player.hasVagina()) {
            this.outputText(
                "Your arousal at this point is quite apparent on the whole of your genitals.  Clara gives you a few touches and caresses, but doesn’t seem all that interested."
            );
        } else {
            this.outputText(
                "Or rather, your lack of thereof.  Clara doesn’t seem to mind too much; Marble must have told her about this part of you too."
            );
        }
        //Clara fingers the PC’s asshole
        this.outputText(
            "\n\nIt then becomes rather apparent exactly what Clara really wants to play with now, and you feel her fingers slip down and around your body.  She gets herself a handful of your " +
                this.buttDescript() +
                ", and then slips her fingers into your crevice.  That finger doesn't stop until it's pushed itself inside your " +
                this.assholeDescript() +
                " and triggered a response that makes Clara laugh with delight.  Feeling emboldened, the bovine girl thrusts another finger into your back entrance and starts wiggling them around."
        );
        this.outputText(
        ...
        else if (this.player.cockThatFits(20) < 0)
            this.addButton(0, "Next", this.cockTooBigForCowCuntageBadEndage);
    ...
    public badEndDickThatFitsClara(): void {
        ...
        if (
            ...
            this.outputText(
                "In seconds she’s freed you of the form fitting garment that you woke up in.  "
            );
        }
        this.outputText(
            "You’re still erect from the arousal that nursing from Clara gave you.  The young cow-girl straddles your calves and gives your " +
                this.cockDescript(x) +
                ' a slight flick with her finger and continues to smile broadly at you.  "<i>One thing that I was really worried about was that you woouldn’t have a penis that I could actually fit inside me.  Thankfully, that isn’t the case, and that pretty pecker is just my size!</i>"  She pulls apart the lips of her womanhood before continuing, "<i>This will be my first time ever putting anything in here, take note just how special of a slave you are to me!</i>"'
        );

        this.outputText(
            "\n\nWell, she certainly isn’t wasting any time, as the very next instant she has lowered her opened labia onto the tip of your " +
                this.cockDescript(x) +
                ".  The passage is already wet and slick, thanks to her previous orgasm.  Immediately, an expression of both pain and pleasure crosses over the bovine woman’s face and she starts to pant.  You lift up your hands, bClara issues a sharp command that you aren’t to do anything at all while she has the sex she wants.  You can’t do much else but just lie back and take it."
        );
        this.outputText(
    ...
    public cockTooBigForCowCuntageBadEndage(): void {
        this.clearOutput();
        this.outputText('"<i>Now, we do have one problem.  ');
        if (this.player.cockTotal() > 1) {
            this.outputText("All of your penises are");
        } else this.outputText("Your penis is");
        this.outputText(
            ' too big for a virgin like me to fit!  How the hell am I suppose to get that inside me?</i>"  Clara stands up and starts stomping around the room.  '
        );
        //if (PC has at least one dick that will fit inside Marble’s current capacity)
        if (this.player.cockThatFits(this.marbleScene.marbleCuntCapacity()) >= 0) {
            this.outputText(
                '"<i>‘It’s not a flaw, it’s a feature,’ she said, ‘This is why we train ourselves to take big endowments,’ she said!  Fuck you Marble!  I’m not sticking that stupid big thing inside me.</i>"  '
            );
        } else {
            this.outputText(
        ...
        this.outputText(
            'She continues ranting for several minutes before turning to you.  "<i>YOOU!  Didn’t you ever stop to consider the needs of dainty girls like me before you started abusing transformatives?</i>"  She sighs, apparently running out of steam.  "<i>Who knew this plan would be so hard?'
        );
        this.outputText(
    ...
    public cocklessPCsGetAbusedByCowCunts(): void {
        this.clearOutput();
        this.outputText(
            'Clara straddles your head with her legs and looks down at you.  "<i>Now you’re going to lick me until I’m satisfied.  Also, don’t you dare doo anything unless I tell you to, got it?</i>"  She doesn’t wait for a response.  "<i>Goood, now let\'s get started.</i>"  The cow-girl promptly drops her snatch onto your face.'
        );
        ...
        if (this.player.tongueType > 0) {
            ...
            this.outputText(
                '\n\n"<i>Mhh, huh, ah, higher!</i>"  You obey, and move up to Clara’s clit, and the hood around it.  She has already become heavily engorged, and the instant your ' +
                    this.tongueDescript() +
                    ' touches the bovine woman’s erect love button, she lets out a low shriek of pleasure!  "<i>Woah!  Wah, mah, mooo!</i>" she cries out as a torrent of fluid sprays from her womanhood and drenches your face.  Clara is unquestionably an inexperienced virgin, given her rapid and unexpected orgasm.  She spends several moments trying to catch her breath.'
            );
            ...
            this.outputText(
                "\n\nAbruptly, a large torrent of fluid comes rushing down the hole you’ve been pleasing.  Much to your dismay, the flood of fluid actually forces your " +
                    this.tongueDescript() +
                    " out of her passage before nearly drowning you in girl cum.  You cough and sputter for several seconds until air finally returns to your lungs.  What energy you had before now is now gone."
            );
            ...
            this.outputText(
                '\n\nClara finally releases your head from her death grip, and lets you move around again.  "<i>Wow, ' +
                    this.player.mf("lover-boy", "lover-girl") +
                    '.  I never imagined you’d be able to do that!  I guess the slave I got had an unexpected feature.  I’m still going to be changing you up to give me anoother kind of pleasure, but damn!  Look at what you made me doo!</i>"  She indicates the large pool of vaginal fluids covering the floor.  The bedroll you woke up on is completely ruined.'
            );
            this.outputText(
    ...
    public finalBadEndWithCowCunt(): void {
        ...
        this.outputText(
            '\n\nSpeaking of that friendly fox, there he is now; picking some strawberries and potatoes for supper.  You call out to him in greeting and head over to have a more personal talk.  "<i>Hey there ' +
                this.player.short +
        ...
        this.outputText(
            '\n\n"<i>Sam, that you?  Is ' +
                this.player.short +
                ' back with something?</i>" a timid voice calls out when you let yourself through the cottage door.  You reply by asking him to come and see for himself.  A short, slim, feline male comes racing into the room.  Catching sight of just what something you brought back was, a look of amazement crosses his face.  "<i>Woah, now that’s a catch!  I’m glad to see you managed to get something this time, the girls won’t stop asking for something other than veggies...</i>"  You move into the kitchen with him, while two excited cow-girls come clopping out.  If things get really bad, you’ll have to start harvesting tainted meat.  Tim grimaces, "<i>I’m not looking forward to that, I kinda like having kids that actually stay as kids right now.</i>"'
        );
        this.outputText(
            '\n\nYou give the small feline a pat on the head.  He shouldn’t worry too much right now, we’re actually in good shape today.  That cute face perks up, "<i>You’re right ' +
                this.player.short +
                '.  I’m sure you’ll be able to figure something out anyway, that’s why you’re the first husband.</i>"  That certainly is true.  There is no way you could ever let down your loved ones, especially your mistress.  You wash up, and go up stairs.  She will want to see you before supper.  She always does.'
        );
        ...
        this.outputText(
            '\n\n"<i>Coome here milk slave.  Beg for your sustenance and maybe I will indulge you,</i>" she says with a dismissive wave.  With reluctance (<i>reverence</i>) you get down on the ground in front of her, <i>it feels right to acknowledge your superior</i>.  After several minutes of postulating yourself, the voice of the vane and voluptuous woman above you calls out once more, <i>Goood, speak now ' +
                this.player.short +
                '.</i>"  Turning your head up, with great hesitance (<i>eagerness!</i>) you recite the same demeaning words you have said every day for the last several years.'
        );
        this.outputText(
    ...
    public defeatClaraCuntInAFight(cheated: boolean = false): void {
        if (cheated) this.clearOutput();
            ...
            else if (this.player.findStatusAffect(StatusAffects.ClaraFoughtInCamp) < 0) {
                this.outputText(
                    "Worried about the others, you head out of the cellar and drag Clara and her things with you.  Thanks to the strange way that travel works in this world, it doesn't take you long to find your way back to camp.  You catch your followers there just before they head out to go looking for you and dump your would be kidnaper before them.  Marble steps up next to you and looks down at her sister."
                );
        ...
        this.outputText(
            '"<i>Clara, what the hell were you trying to pull there?</i>" Marble demands of her sister, her hands shaking in rage.'
        );
        this.outputText(
            '\n\n"<i>Getting a mate, what doo you think?  I was going to take ' +
                this.player.mf("lover-boy", "lover-girl") +
                ' here away to live with me,</i>" comes the incredulous reply.'
        );
        this.outputText(
            "\n\n\"<i>Getting a... out of my sweetie?!  We're already mates, where do you go off thinking you can just come in here and steal " +
        ...
        this.outputText(
            '\n\n"<i>No sis, you had your chance.  ' +
                this.player.short +
                " isn't addicted to you, that means that " +
                this.player.mf("he", "she") +
        ...
        this.outputText(
            '\n\nMarble looks at her hands in horror, just barely above a whisper you manage to hear her say, "<i>His hands were shaking, just like ' +
                this.player.short +
                "'s...</i>\""
        );
        this.outputText(
        ...
        this.outputText(
            "\n\n\"<i>Admit it, you don't feel like '" +
                this.player.mf("lover-boy", "lover-girl") +
                "' here actually cares for you.  How could they if they won't drink your milk?  You're a Lacta Bovine, giving your milk is the most important thing in the world to you.  This isn't love.  Without " +
                this.player.mf("him", "her") +
                " actually being addicted to you, it's just a one sided infatuation.  I was doing you a favor by taking " +
                this.player.mf("him", "her") +
                ' away from you.</i>"'
        );
        this.outputText(
        ...
        this.outputText(
            "\n\n\"<i>There, you see?  Now I'm sure you understand why me and " +
                this.player.short +
                " here belong toogether.  I won't deny the proper order of things, and I'll make sure that " +
                this.player.mf("he", "she") +
                " leads a fulfilling life as my milk slave.  " +
                this.player.mf("He", "She") +
                "'ll even by my first husband!</i>\""
        );
        ...
        this.outputText(
            "\n\nThe younger cow-girl scoffs, \"<i>Haven't you been listening to me sis?  " +
                this.player.mf("He", "She") +
                "'ll be addicted to me.  That.  Is.  Love.  How else can you show just how much you care?</i>\""
        );
        ...
        this.outputText(
            "\n\n\"<i>Really?  Didn't you say that the reason you were purifying yourself was so that " +
                this.player.mf("he", "she") +
                " would nurse from you again?  Sounds pretty selfish to me after what you were saying about doing things for who you 'love'.</i>\""
        );
        this.outputText(
        ...
        this.outputText(
            '\n\nAt this Clara bursts out laughing, "<i>Oh, and save the world I take it?  This ' +
                this.player.race() +
                "?  Don't be ridiculous.</i>\""
        );
        this.outputText("\n\nMarble starts quivering in rage once more.");
        this.outputText(
            '\n\n"<i>Seriously, there is no damn way someone as pathetic as ' +
                this.player.short +
                ' could accomplish that,</i>" she continues while struggling to her feet.  "<i>You need to be like a twenty foot giant, champion fighter, god master of magic to pull a stunt like wiping out the demons.  ' +
                this.player.short +
                " is none of those things.  Do you really think someone who could would actually care about a lowly Lacta Bovine like you?</i>\"  Clara pokes her finger into Marble's chest.  \"<i>I guess the saying among our kind is right, 'the first daughter has the sourest milk.'</i>\""
        );
        this.outputText(
        ...
        if ((this.player.hasCock() && this.player.cockThatFits(20) >= 0) || this.player.hasVagina())
            this.outputText(
                "use Marble's unstable state of mind to get her into a forceful threesome with Clara, "
            );
        //(if PC either has a cock that will fit Marble, or has a vagina)
        if (
            (this.player.hasCock() &&
                this.player.cockThatFits(this.marbleScene.marbleCuntCapacity()) >= 0) ||
            this.player.hasVagina()
        )
            this.outputText("have sex in front of Clara so she can see what your love really is, ");
        //(if Marble is a futa)
        if (this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0)
            this.outputText("egg Marble into violating Clara with her cock, ");
        this.outputText(
            " or try to calm Marble down so that she doesn't do anything to her sister."
        );
        ...
        if ((this.player.hasCock() && this.player.cockThatFits(20) >= 0) || this.player.hasVagina())
            this.addButton(1, "Threesome", this.pcAndMurbleDoubleTeamCowButt);
        if (
            (this.player.hasCock() &&
                this.player.cockThatFits(this.marbleScene.marbleCuntCapacity()) >= 0) ||
            this.player.hasVagina()
        )
            this.addButton(2, "NTR", this.NTRIsClearlyTheWorstFetishWhyWouldYouWriteThisOMG);
        if (this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0)
            this.addButton(
                3,
                "Marble Cock",
                this.futaMarbleIsAHugeCowToCowCuntAndStuffsCowCuntsCuntFullOfCowCock
            );
    ...
    public murbleSpanksCowCunt(): void {
        this.clearOutput();
        this.outputText(
            "Marble seems to have a good idea on how to punish Clara already, so you just sit back and watch."
        );
        this.outputText(
        ...
        this.outputText(
            "\n\nWith the white haired bovine's pale bare bottom high in the air, Marble gruffly commands, \"<i>Now, say you're sorry for trying to kidnap " +
                this.player.short +
                '.</i>"'
        );
        this.outputText(
    ...
    public pcAndMurbleDoubleTeamCowButt(): void //does not work with centaur, naga, drider, or goo bodies.  However, I don't particularly want to just say you can't do this scene if you have them.
    {
        ...
        this.outputText(
            "\n\n\"<i>What?  I don't want to have a threesome with my sister!  Only " +
                this.player.short +
                ' should be able to touch me!</i>"'
        );
        this.outputText(
        ...
        if (this.player.hasCock() && x >= 0 && this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0) {
            //n is the index of the PC's biggest cock under 20 area.
            this.outputText(
                "Eventually you pull her up and sandwich her between your bodies.  Marble expresses an aversion to anal, so you take the backside while she takes the front.  \"<i>Hey, you can't do this to me!  I don't want to lose my virginity to my sister!</i>\" Clara cries out indignantly."
            );
            this.outputText(
            ...
            this.outputText(
                "\n\nMarble looks to the side of her sister's head, and gives you a solemn nod.  You take that as an invitation to begin the violation and grab a good grip of Clara's expansive rear.  Then you prod your " +
                    this.cockDescript(x) +
                    " at the entrance to her anus, prompting a gasp and plea from the woman you're about to penetrate to stop.  Her sister doesn't heed her begging, and neither do you."
            );
            this.outputText(
            ...
            this.outputText(
                '\n\n"<i>You will if you don\'t want me to twist your ears,</i>" comes the response.  You prod your ' +
                    this.cockDescript(x) +
            ...
            this.outputText(
                "\n\nInstantly Marble's expression changes and she lets out a long low moan.  As a reward, you switch from quick thrusts to a slow rub against her entrance.  This proves to be quite a reward indeed as you feel a flood of Clara's juices spill out onto your groin from around the " +
                    this.cockDescript(x) +
                    " teasing her insides.  You, however, aren't finished yet.  You start a mix of both thrusting into her womanhood, and twisting your length around her innards."
            );
            this.outputText(
            ...
            this.outputText(
                '\n\n"<i>Gah, sis, does your milk taste as bad as your pussy juices?  No wonder ' +
                    this.player.short +
                    " didn't want yoou!</i>\"  Another shock of anger shoots through Marble's features.  Is she going to try and inflict more punishment on her sister?"
            );
        }
        //else if (PC does not have a cock, Marble does)
            ...
            this.outputText(
                "\n\nYou grab ahold of her ears and give them a slight tug.  She'd better go along with her punishment like a good girl, or you'll be adding some extra pain onto her head.  \"<i>Of course, if you're sorry for what you tried to do to " +
                    this.player.short +
                    '...</i>" Marble suggests.'
            );
            this.outputText(
                '\n\n"<i>What?  Why the hell would I be sorry for that?  Moop!</i>"  There is a low slurp as your mate pushes her newly acquired seven inch shaft deep inside her sister\'s womanhood.  "<i>Hey!  Yo-mmph,</i>"  You silence her with your ' +
                    this.vaginaDescript() +
                    ", roughly forcing it into her face.  You give a slight twist to the young bovine's ears to remind her what she should be doing, and right away her tongue comes out and starts giving you experimental licks."
            );
            this.outputText(
            ...
            this.outputText(
                "\n\nYou express your disappointment to Marble at her sister's unfinished performance, so the fucking continues.  Thankfully, it seems that the bad bovine did get the message and has started to tease and suck on your " +
                    this.clitDescript() +
                    " as well as continuing with her teases of your folds and depths.  You'd almost feel bad for doing what you two are doing to her if she wasn't evidently enjoying it as much as she is.  Muffled but loud gasps and moos are constantly being uttered into your " +
                    this.vaginaDescript() +
        ...
        //PC and Marble only have their vaginas
            ...
            this.outputText(
                "\n\nEventually you roll her onto her back.  Then Marble sits down on her sister's face while you put your mouth to Clara's womanhood and raise your " +
                    this.buttDescript() +
                    " up into the air so that your mate can reach your own " +
                    this.vaginaDescript() +
                    "."
            );
            this.outputText(
            ...
            this.outputText(
                "\n\nNow you get to experience the pleasure of Marble's tongue starting to tease your " +
                    this.vaginaDescript() +
                    " with her bovine tongue.  It's easily twice the length of a human's and quite adept at pleasuring a woman's passages.  Your mate is certainly quite willing to put it to that very use, using it to plunge deep inside your depths and also expertly explore and pleasure your " +
                    this.clitDescript() +
                    "."
            );
            this.outputText(
            ...
            this.outputText(
                "\n\nYour hot and sweaty bodies separate from one another, each face bearing the fluids of one another's orgasms.  Clara is coughing and sputtering, \"<i>Gah, sis, does your milk taste as bad as your pussy juices?  No woonder " +
                    this.player.short +
                    " didn't want you!</i>\"  Another shock of anger shoots through Marble's features.  Is she going to try and inflict more punishment on her sister?"
            );
        }
        this.player.orgasm();
    ...
    public NTRIsClearlyTheWorstFetishWhyWouldYouWriteThisOMG(): void {
        ...
        this.outputText("You ");
        this.outputText(
            "step forward and tell Marble that you think that since Clara thinks your love for one another isn't real, how about the two of you show her just how real it is?  \"<i>Good idea, " +
                this.player.short +
                ",</i>\" your lover tersely replies through her still seething visage and steps forwards.  In an instant you're forcibly pulled into a strong passionate kiss upon humanlike lips while a decidedly inhumanly long tongue invades your mouth.  “<i>Wait, are you two just gooing to fuck right in front of me?</i>\" comes an incredulous voice from somewhere behind the woman you're kissing.  Neither of you pay it any mind and continue to taste, devour, and lavish affection on each other's mouths.  An angry grunt comes once more from the woman you're showing what loves means to, and sounds of a struggle accompany it."
        );
        this.outputText(
            "\n\nProper lovemaking does not stop at kissing.  You have to be sure to show a would be thief the whole process.  Your partner is already working on that matter through efforts to free your body from the " +
                this.player.armorName +
                " that contains it.  Not one to be outdone, you begin to remove the familiar top that oh-so-often holds bovine breasts at bay.  With Marble's melons free, she immediately pulls your head down into the great valley of flesh her breasts create."
        );
        this.outputText(
        ...
        if (this.player.hasCock() && x >= 0) {
            this.outputText(
                "she drops herself onto your " +
                    this.cockDescript(x) +
                    ".  Since your bovine mate isn't in the habit of wearing any form of undergarments, her skirt doesn't really do much to get in the way of penetration.  A shriek of dismay accompanies this act."
            );
            this.outputText(
        ...
        else if (this.player.hasVagina() && this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0) {
            this.outputText(
    ...
    public futaMarbleIsAHugeCowToCowCuntAndStuffsCowCuntsCuntFullOfCowCock(): void {
        this.clearOutput();
        this.outputText(
            'You call out to Marble and suggest that she should use her new "appendage" to punish Clara.  She hesitates for a moment, then nods.  You doubt that you could have ever gotten her to do something like that if she wasn\'t as worked up as she is.'
        );
        this.outputText(
        ...
        this.outputText(
            '\n\nThe older sister hesitates for a moment, "<i>Are you sorry for trying to steal ' +
                this.player.short +
                ' from me?</i>"'
        );
    ...
    public calmMurblesFatAssDown(): void {
        ...
        if (
            (this.player.tallness >= 80 && this.flags[kFLAGS.MARBLE_BOVA_LEVEL] < 2) ||
            (this.player.tallness >= 86 && this.flags[kFLAGS.MARBLE_BOVA_LEVEL] >= 2)
        ) {
            this.outputText(
                "tightly hugs herself against your body.  Gently stroking her hair, you're happy to be a shoulder for her to cry on, given both your affection for the gentle girl and the awareness that you're able to help her feel better."
            );
        }
        //else if (PC taller than 5 feet)
        else if (this.player.tallness >= 60) {
            this.outputText(
                "returns the hug.  Rocking back and forth against one another, you're happy to be here for her, given both your affection for the lovely lady and the warm feeling of being so close to one you care so much for."
            );
        } else {
            this.outputText(
                "scoops you up, hugging you tightly into her chest.  Sandwiched between her massive mammaries, you're happy to serve as her temporary comfort doll, given both your affection for the big bovine and the pleasant accommodation of her bountiful breasts."
            );
        }
        this.outputText(
    ...
    public rathazulFinishingMarblesPotion(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_KIDS] > 0) {
            this.outputText("Then we'll be ready to purify you and your child");
            if (this.flags[kFLAGS.MARBLE_KIDS] > 0) this.outputText("ren");
            this.outputText(".  ");
        }
        this.outputText('So come back a little later.</i>"  The rodent returns to his reactions.');
    ...
    public theFormulaIsDone(): void {
        this.clearOutput();
        this.outputText(
            "Rathazul tells you that the formula is ready, so you head over to Marble to let her know."
        );
        ...
        this.outputText(
            "\n\nMarble's forced smile fades and her features resume the crestfallen look she had earlier, thinking about the right words to say to you.  Seeing as there is no other way around the conversation she says, \"<i>To be honest sweetie, you're right, I'm not all right.</i>\"  There is a moment's hesitation before she continues, \"<i>Oh " +
                this.player.short +
                ", so much has happened in such a short time and it's all that's on my mind. After all the things that Clara has said I just don't know what to do.</i>\""
        );
        this.outputText(
        ...
        this.outputText(
            '\n\nMarble looks at you once more, somewhat passively.  You swear her expression is that of someone waiting for her execution.  "<i>So, ' +
                this.player.short +
                ", now you know the real me.  Can you still love me?</i>\"  You reach out to your lover's face and caress her cheek.  She then takes your hand and holds it tight against her face. In an instant, her stoicism shatters, and tears look to be on the verge of streaming down her face once more.  You tell her that everything will work out; it'll just take one step at a time."
        );
        ...
        this.outputText(
            '\n\nMarble bursts into tears and pulls you into a nearly back-breaking hug, calling out your name and declaring her love for you as she continues to embrace you.  She gives you a deep kiss and you return it wholeheartedly.  When she finally lets you go, she jumps down from the wall, giving you a delightful, beautiful smile.  "<i>You really are too good for me, ' +
                this.player.short +
                '.  I feel a lot better now.</i>"'
        );
        this.outputText(
    ...
    public purifyMarbleComplete(): void {
        this.clearOutput();
        this.outputText(
            'The two of you arrive at Rathazul\'s workspace, and find the owner awaiting you, holding a bottle of whitish fluid with gold streaks running throughout.  "<i>So is that the formula?</i>"  Marble asks looking at the bottle.'
        );
        this.outputText(
        ...
        this.outputText(
            '\n\nYou call out to her in worry, begging for her to come back to you.  After a moment, her eyes go back into focus, and you hear her voice call out hesitantly, "<i>' +
                this.player.short +
                '?</i>"  You let out a sigh of relief and ask how she feels.  "<i>I feel... different.  Like I\'m seeing the world for the first time.</i>"  You help her to her feet.  "<i>I guess that makes sense, I was born corrupt, so being purified is something I\'ve never felt before.  It\'ll be a while before I can really give you an idea of what this is like.  What I can say is that my mind feels... clean, free.</i>"'
        );
        this.outputText(
        ...
        if (this.flags[kFLAGS.MARBLE_KIDS] > 0) {
            ...
            this.outputText(" right away.  Give ");
            if (this.flags[kFLAGS.MARBLE_KIDS] == 1) this.outputText("her");
            else this.outputText("each");
            this.outputText(
                ' a two drop dose,</i>" the alchemist instructs you and hands over the bottle of his formula.'
            );

            this.outputText(
                "\n\nYou and Marble waste no time in heading over to the nursery and feed "
            );
            if (this.flags[kFLAGS.MARBLE_KIDS] > 1) this.outputText("each of ");
            this.outputText("your child");
            if (this.flags[kFLAGS.MARBLE_KIDS] > 1) this.outputText("ren");
            this.outputText(" two drops of the formula.  ");
            if (this.flags[kFLAGS.MARBLE_KIDS] > 1) this.outputText("They ");
            else this.outputText("She ");
            this.outputText("take");
            if (this.flags[kFLAGS.MARBLE_KIDS] == 1) this.outputText("s");
            this.outputText(" it easily enough, and while there are no outward effects, ");
            if (this.flags[kFLAGS.MARBLE_KIDS] == 1) this.outputText("your ");
            else this.outputText("each ");
            this.outputText("child does report feeling like something was lifted from ");
            if (this.flags[kFLAGS.MARBLE_KIDS] > 1) this.outputText("their");
            else this.outputText("her");
            this.outputText(" mind.");
    ...
    public dealingWithCowCuntPostPurification(): void {
        this.clearOutput();
        this.outputText(
            "Now there is only one more loose end in this whole effort to purify Marble: her sister."
        );
        this.outputText(
        ...
        this.outputText(
            "\n\n\"<i>Congratulations!  You're not a Lacta Bovine anymore.  It isn't like I was trying to stop you from doing that, but now you sure as hell don't deserve a mate anymore.  You can't even claim one.</i>\"  Clara turns her attention to you, \"<i>Did you hear that, " +
                this.player.mf("lover-boy", "lover-girl") +
                "?  You don't deserve a pseudo Lacta Bovine like her.  I can give you want you really want.</i>\""
        );
        ...
        this.outputText(
            '\n\n"<i>Fuck off, mutant,</i>" she dismisses her sister in an instant.  "<i>I want to tell my destined mate what kind of a life ' +
                this.player.mf("he", "she") +
        ...
        this.outputText(
            '\n\nMarble sighs, then speaks once more, "<i>I figured you should know at least that, sister, before we decided what to do with you.</i>"  She turns to you, "<i>Well, ' +
                this.player.short +
                ', you were the one she tried to kidnap and enslave.  What do you think we should do with her?</i>"'
        );
        this.outputText(
    ...
    public purifyMurblesSister(): void {
        this.clearOutput();
        this.outputText(
            "You ask Marble for the bottle of Rathazul's formula.  She nods, hands it to you and says, \"<i>Yeah, I think that's the best choice too.</i>\""
        );
        this.outputText(
    ...
    public cageDatCowCunt(): void {
        this.clearOutput();
        this.outputText(
            "You say that you're going to be keeping Clara a prisoner in the camp.  She deserves to be imprisoned so she'll no longer be a threat to anyone anymore.  Marble looks uncertain at you and asks if you're sure she needs to be locked up now that she's been purified.  You say you're certain, and your mate nods to you and says that she trusts your judgment on this matter."
        );
        this.outputText(
    ...
    public letGoOfMarblesCowCuntSister(): void {
        this.clearOutput();
        this.outputText(
            "You say that now that Clara is no danger to anyone any more, she is free to go, so long as she promises to never bother you or your followers again.  Marble nods at this and says she agrees with your decision."
        );
        this.outputText(
    ...
    public dontPurifyClara(): void {
        this.clearOutput();
        this.outputText(
            "No, you'll offer her the mercy of letting her keep her precious corruption.  Marble tells you she will respect your decision on that matter.  Now the question is what to do with her."
        );
        this.outputText(
            '\n\nYou guess you could also build a cage in the camp if you really want to keep an eye on her yourself.  That will make her another mouth to feed, and you\'ll have to hear her ranting every day.  Still, the saying does go, "keep your enemies closer."'
        );
    ...
    public stickUnpurifiedClaraInACage(): void {
        this.clearOutput();
        this.outputText(
            "You say that you're going to be keeping Clara a prisoner in the camp.  She deserves to be imprisoned so she'll be no threat to anyone anymore.  Marble nods to you and says that she trusts your judgment on this matter."
        );
        this.outputText(
    ...
    public purificationQuestFinal(): void {
        this.clearOutput();
        this.outputText(
            '"<i>It has been quite the morning, hasn\'t it sweetie?</i>"  It certainly has been, but at least now, your lover is finally free of her corruption once and for all.'
        );
        ...
        this.flags[kFLAGS.MARBLE_PURIFIED] = 1;
        this.player.changeStatusValue(StatusAffects.Marble, 4, 10);
    ...
    public actuallyGrowPureMarblesTittiesForFunzies(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_BREAST_SIZE] < 3) {
            this.outputText(
                '\n\n"<i>Alright, if you say so.</i>"  Marble lifts the bottle to her mouth, and drinks the substance down.  She lets out a soft sigh and starts massaging her bouncy tit flesh as it expands outwards.  Through her shirt, you can see her ' +
                    kGAMECLASS.marbleScene.marbleBreastSize() +
                    " breasts balloon into "
            );
            //increase Marble's breast size by 1
            this.flags[kFLAGS.MARBLE_BREAST_SIZE]++;
            this.outputText(kGAMECLASS.marbleScene.marbleBreastSize() + " melons!");
            //if (Marble's breast size == 1)
            if (this.flags[kFLAGS.MARBLE_BREAST_SIZE] == 1) {
                this.outputText(
            ...
            else if (this.flags[kFLAGS.MARBLE_BREAST_SIZE] == 2) {
                this.outputText(
    ...
    public pureMurblePCChoosesYesToShrinkeyTits(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_BREAST_SIZE] > 0) {
            this.outputText(
                '\n\n"<i>Alright, if you say so.</i>"  Marble opens the jar of reducto, lifts up her top, and slathers the green gel onto her breasts.  She lets out a soft sigh as the substance takes effect, and her tremendous ' +
                    kGAMECLASS.marbleScene.marbleBreastSize() +
                    " tits slowly shrink in size, becoming a pair of more modest "
            );
            //decrease Marble's breast size by 1
            this.flags[kFLAGS.MARBLE_BREAST_SIZE]--;
            this.outputText(kGAMECLASS.marbleScene.marbleBreastSize() + " sized breasts.");
            if (this.flags[kFLAGS.MARBLE_BREAST_SIZE] == 0) {
                this.outputText(
            ...
            else if (this.flags[kFLAGS.MARBLE_BREAST_SIZE] == 1) {
                this.outputText(
    ...
    public lactaidForPureMurble(): void {
        ...
        this.flags[kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] += 10;
    ...
    public nursingFromPureMarble(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] < 4) {
            this.outputText(
                "Feeling a bit thirsty, you ask Marble if there’s any chance she has some milk for you.  She gives you a sad look and informs you that no, she hasn't yet built up enough milk for you to have more.  Purifying her has made it take a bit longer for her to produce milk."
            );
            ...
            this.outputText(
                "\n\nOnce you arrive, your lover teases you a bit by grabbing her " +
                    kGAMECLASS.marbleScene.marbleBreastSize() +
                    " breasts through her top and playing around with them for a moment.  The bouncy flesh rolls around her hands in a very pleasant manner, and you feel your mouth water in anticipation of the delicious milk hidden within."
            );
            this.outputText(
            ...
            if (this.player.tallness < 65) {
                ...
                this.outputText("You lean forward and ");
            } else {
                this.outputText("You lift up the cow-lady to get access, ");
            }
            this.outputText(
            ...
            this.HPChange(Math.round(this.player.maxHP() * 0.2), false);
            //Restore 30 fatigue
            this.fatigue(-30);
            //increase lust by 15
    ...
    public marbleLeavesThePCOverCorruption(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_KIDS] > 1) this.outputText(" , and with her children in tow");
        //else if (PC has one child with Marble)
        else if (this.flags[kFLAGS.MARBLE_KIDS] == 1)
            this.outputText(", and holding her child's hand");
        this.outputText(
    ...
    public pureMarbleDecidesToBeLessOfABitch(): void {
        ...
        this.clearOutput();
        this.outputText(
            'While checking your traps to ensure that they\'re still working, you hear a voice call out from outside the camp, "<i>Sweetie!</i>"  You look up and see the smiling face of Marble'
        );
        //if (PC has at least one child with Marble)
    ...
    public claraCampAddition(): void {
        ...
        if (this.flags[kFLAGS.CLARA_PURIFIED] > 0) {
            if (MarblePurification.rand(10) == 0)
                this.outputText(
            ...
            if (kGAMECLASS.time.hours <= 7 || kGAMECLASS.time.hours >= 20)
                this.outputText(
                    "Clara is laying sprawled out on the ground of her cage, snoring loudly."
                );
            else {
                this.temp = MarblePurification.rand(4);
                switch (this.temp) {
                    case 0:
                        this.outputText(
                    ...
                    case 2:
                        this.outputText(
                            "Clara is currently engaged in trying to tempt you into letting her out of her cage and becoming addicted to her.  It's much the same as all of her previous attempts...."
                        );
                        break;
                    case 3:
                        this.outputText(
