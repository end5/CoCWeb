...
export class MarbleScene extends NPCAwareContent implements TimeAwareInterface {
    ...
    */
    ...
    public timeChange(): boolean {
        ...
        if (this.player.findStatusAffect(StatusAffects.CampMarble) >= 0) {
            ...
            if (this.flags[kFLAGS.MARBLE_RATHAZUL_COUNTER_1] > 0) {
                ...
                if (this.flags[kFLAGS.MARBLE_RATHAZUL_COUNTER_1] <= 1) this.flags[kFLAGS.MARBLE_RATHAZUL_COUNTER_1] = 1;
            }
            //Counting down to purity!
            if (this.flags[kFLAGS.MARBLE_PURIFICATION_STAGE] == 0) {
                if (this.flags[kFLAGS.MARBLE_COUNTUP_TO_PURIFYING] < 200) this.flags[kFLAGS.MARBLE_COUNTUP_TO_PURIFYING]++;
            }
            //Counter 2!
            if (this.flags[kFLAGS.MARBLE_RATHAZUL_COUNTER_2] > 0) {
                this.flags[kFLAGS.MARBLE_RATHAZUL_COUNTER_2]--;
                //Stick it at 1 so I can trigger it off the camp screen.
                if (this.flags[kFLAGS.MARBLE_RATHAZUL_COUNTER_2] <= 1) this.flags[kFLAGS.MARBLE_RATHAZUL_COUNTER_2] = 1;
            }
            ...
            if (this.flags[kFLAGS.MARBLE_PURIFICATION_STAGE] >= 5) {
                ...
                if (this.flags[kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] > 1000) this.flags[kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] = 1000;
            }
            //Reset Marble corruption warning
            if (this.flags[kFLAGS.MARBLE_WARNED_ABOUT_CORRUPTION] == 1 && this.player.cor < 50) this.flags[kFLAGS.MARBLE_WARNED_ABOUT_CORRUPTION] = 0;
            //Lactation whoopie!
            if (this.flags[kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] < 100) this.flags[kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS]++;
            ...
            if (this.player.statusAffectv4(StatusAffects.Marble) > 50) this.flags[kFLAGS.MARBLE_LUST] += .3;
            if (this.player.statusAffectv4(StatusAffects.Marble) > 70) this.flags[kFLAGS.MARBLE_LUST] += .3;
            //If bitch-bin is in construction
            if (this.flags[kFLAGS.MARBLE_NURSERY_CONSTRUCTION] > 0 && this.flags[kFLAGS.MARBLE_NURSERY_CONSTRUCTION] < 100 && this.marbleScene.marbleAtCamp()) {
            ...
            //Marble find items check
            else if (this.player.findStatusAffect(StatusAffects.MarbleHasItem) < 0 && this.marbleScene.marbleAtCamp()) {
                // Off cooldown
                if (this.player.findStatusAffect(StatusAffects.MarbleItemCooldown) < 0) {
                    if (MarbleScene.rand(10) == 0) {
                        ...
                        this.player.createStatusAffect(StatusAffects.MarbleItemCooldown, (24 + MarbleScene.rand(24)), 0, 0, 0);
                        this.player.createStatusAffect(StatusAffects.MarbleHasItem, MarbleScene.rand(10), 0, 0, 0);
                        needNext = true;
                    }
                }
            }
        ...
        if (this.player.findStatusAffect(StatusAffects.MarbleItemCooldown) >= 0) {
            ...
            if (this.player.statusAffectv1(StatusAffects.MarbleItemCooldown) < 1) this.player.removeStatusAffect(StatusAffects.MarbleItemCooldown);
        }
        ...
        if (this.player.statusAffectv3(StatusAffects.Marble) > 0 && this.player.findPerk(PerkLib.MarbleResistant) < 0 && this.player.findPerk(PerkLib.MarblesMilk) < 0 && this.player.statusAffectv2(StatusAffects.Marble) > 25) {
            //If player does not have marble's milk or bottled milk, go into withdrawl
            if (this.player.findStatusAffect(StatusAffects.MarblesMilk) < 0 && this.player.findStatusAffect(StatusAffects.BottledMilk) < 0) {
        ...
        if (this.player.statusAffectv3(StatusAffects.Marble) <= 0) {
            if (this.player.statusAffectv2(StatusAffects.Marble) > 60) this.player.changeStatusValue(StatusAffects.Marble, 2, 60);
        }
        ...
        if (this.player.findStatusAffect(StatusAffects.BottledMilk) >= 0) {
            ...
            if (this.player.statusAffectv1(StatusAffects.BottledMilk) <= 0) this.player.removeStatusAffect(StatusAffects.BottledMilk);
        }
        if (this.model.time.hours > 23) {
            this.flags[kFLAGS.MARBLE_PLAYED_WITH_KIDS_TODAY] = 0;
            if (this.player.findStatusAffect(StatusAffects.Marble) >= 0 && this.player.statusAffectv2(StatusAffects.Marble) > 0) this.marbleStatusChange(0, -1);
        }
        return needNext;
    }
    ...
    public timeChangeLarge(): boolean {
        ...
        if (this.player.statusAffectv3(StatusAffects.Marble) > 0 && this.player.statusAffectv2(StatusAffects.Marble) < 25 && this.player.findPerk(PerkLib.MarblesMilk) < 0 && this.player.findPerk(PerkLib.MarbleResistant) < 0 && this.model.time.hours == 6) {
            this.spriteSelect(41);
            ...
            if (this.player.statusAffectv3(StatusAffects.Marble) == 1) {
                ...
                if (this.player.statusAffectv1(StatusAffects.Marble) >= 30 && this.player.statusAffectv1(StatusAffects.Marble) < 90) {
                ...
                if (this.player.statusAffectv1(StatusAffects.Marble) >= 90) {
                    ...
                    if (kGAMECLASS.isabellaFollowerScene.isabellaFollower() && this.flags[kFLAGS.FOLLOWER_AT_FARM_ISABELLA] == 0) this.flags[kFLAGS.ISABELLA_MURBLE_BLEH] = 1;
                    //if amily is there, tag it for freakout
                    if (this.flags[kFLAGS.AMILY_FOLLOWER] > 0 && this.flags[kFLAGS.FOLLOWER_AT_FARM_AMILY] == 0) {
                    ...
                    if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00238] == 1 && this.flags[kFLAGS.FOLLOWER_AT_FARM_IZMA] == 0) {
            ...
            //Ashamed Marble
                ...
                if (this.player.statusAffectv1(StatusAffects.Marble) >= 30 && this.player.statusAffectv1(StatusAffects.Marble) < 70) {
        ...
        if (this.player.statusAffectv3(StatusAffects.Marble) > 0 && this.player.statusAffectv2(StatusAffects.Marble) >= 100 && this.player.findPerk(PerkLib.MarblesMilk) < 0 && this.player.findPerk(PerkLib.MarbleResistant) < 0 && this.model.time.hours == 6) {
            this.spriteSelect(41);
            ...
            if (this.player.statusAffectv3(StatusAffects.Marble) == 1) {
                ...
                if (this.player.statusAffectv1(StatusAffects.Marble) >= 50 && this.player.statusAffectv1(StatusAffects.Marble) < 79) {
    ...
    public marbleFightWin(): void {
        ...
        //Win by hp
        if (this.monster.HP < 1) this.outputText("Marble falls to the ground defeated; she looks up at you helplessly, wondering what you're going to do next.  ", false);
        //win by lust
        else this.outputText("Marble collapses and looks at you longingly, pulling up her skirt with a look of desperation in her eyes.  ", false);
    ...
    public marbleFightLose(): void {
        ...
        this.outputText("", true);
        //lose by hp
        if (this.player.HP < 1) this.outputText("After a few too many blows to the head, you topple over to the ground.  ", false);
        //lose by lust
        else this.outputText("Overcome by desire, you fall to your knees, and start masturbating furiously.  Disgusted with you, Marble hits you upside the head once more, knocking you over.  ", false);
    ...
    private forceFeedMarble(): void {
        ...
        if (this.player.findPerk(PerkLib.Feeder) >= 0) this.outputText("You bet this cow-girl loves to get milked and nursed on just like you, but how often does she get to taste the creamy sweetness of milk?  Having her suck on your own leaky tits would be doing her a favor, right?  You approach the defeated cow-girl; her eyes are still locked onto you, wondering what you're going to do next.  Well, not that you can do much with this crowd watching you...\n\n");
        ...
        if (this.player.biggestTitSize() <= 2) this.outputText("\n\nYou push her soft lips against your nipple");
    ...
    private marblePicksYouUpInitially(): void {
        ...
        if (this.player.earType > EARS_HUMAN) this.outputText("gently scratches behind your ears.  ", false);
    ...
    private suckleMarble(): void {
        ...
        if (this.player.tallness < 60) this.outputText("Realizing you might have trouble reaching her breasts, you grab one of the chairs from the table.  ", false);
    ...
    public encounterMarbleExploring(): void {
        ...
        if (this.player.tallness < 60) this.outputText("Marble gives her customary greeting of hugging you to her breast before telling you that she is off to get milked at the barn.  ", false);
        //[player hight >= 5 feet]
        else this.outputText("You exchange a quick greeting before Marble tells you that she is off to get milked at the barn.  ", false);
        //[affection <30]
        if (this.player.statusAffectv1(StatusAffects.Marble) < 30) {
    ...
    private drinkMarbleMilk(): void {
        ...
        if (this.player.earType > EARS_HUMAN) this.outputText(" and occasionally scratching behind your ears", false);
    ...
    public encounterMarbleExploring2(): void {
        ...
        //[player height <5]
        if (this.player.tallness < 60) this.outputText("As you step into her room, she eagerly rushes over and hugs you to her breast. \"<i>You're as cute as ever, sweetie!</i>\"  ", false);
    ...
    private AcceptMarblesSexualAdvances(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.FuckedMarble) < 0) this.player.createStatusAffect(StatusAffects.FuckedMarble, 0, 0, 0, 0);
    ...
    public helpMarble1(): void {
        ...
        //[player str >=50, <80]
        if (this.player.str >= 50 && this.player.str < 80) this.outputText("You put your back into the job and manage to match Marble in her efforts.  She is really impressed with your strength, and together you can cut the number of trips needed in half.\n\n", false);
        //[player str >=80]
        if (this.player.str >= 80) this.outputText("Marble may be strong, but you are stronger.  She is amazed as you manage to take even more crates at a time than she can, only held back by the number you can balance.  Thanks to your efforts, the chore only takes a third of the number of trips it normally would have taken.\n\n", false);
    ...
    private marbleAddiction(newPage: boolean): void {
        this.spriteSelect(41);
        //[start a new page]
        if (newPage) this.outputText("", true);
    ...
    */
    ...
    private AshamedAddictionComfort(): void {
        ...
        if (this.player.tallness < 60) this.outputText("She pulls you into her chest and you feel relieved to see the Marble you know is still in there.  You feel warm drops of water fall on your head and look up to find Marble crying fresh tears, but this time with a big smile on her face.\n\n", false);
        //[player height greater than or equal to 5 feet]
        else this.outputText("You hear her breath start to come in short breaths and look at her face to find Marble crying fresh tears, but this time with a big smile on her face.\n\n", false);
    ...
    private extendedMurbelFarmTalkz(): void {
        ...
        switch (this.flags[kFLAGS.MURBLE_FARM_TALK_LEVELS]) {
            ...
            case 3:
                ...
                if (this.player.tallness < 60) this.outputText("  \"<i>Sorry, sorry, it's just that you're so cute!  I can't picture you as some great hero leaving behind home and family for a mission.</i>\"  She wipes a few tears from her face.");
                //[if PC is over 7 feet tall]
                else if (this.player.tallness > 84) this.outputText("  \"<i>I'm sure a giant like you was the perfect choice for this mission.</i>\"");
                ...
                if (this.player.statusAffectv1(StatusAffects.Marble) >= 60) this.outputText("  \"<i>Even though the start of the trip didn't turn out all that well, I think I found what I was looking for.</i>\"");
            ...
            case 5:
                ...
                if (this.player.findPerk(PerkLib.HistorySlut) >= 0 || this.player.findPerk(PerkLib.HistoryWhore) >= 0) this.outputText("Well, you certainly gave an arousing description.  I think I can share something in return.");
                else if (this.player.cor < 33) this.outputText("Sweetie, after you told me such a nice story, of course I will.");
                else if (this.player.cor < 66) this.outputText("Sweetie, I can tell that you care a great deal about what happened, even if you try to hide it. Of course I'll share.");
                else this.outputText("Well, you certainly gave an arousing description.  I think I can share something in return.");
            ...
            default:
                ...
                if (this.player.str < 90) this.outputText("  In fact, I don't think there's anyone out there who is stronger than me.");
                else this.outputText("  You're probably the only other person I've ever met who is stronger than me.");
                this.outputText("</i>\"");
                ...
                if (this.player.findStatusAffect(StatusAffects.CampMarble) < 0) {
                    ...
                    if (this.player.statusAffectv3(StatusAffects.Marble) == 2) this.outputText("  I really just wanted someone who loved me and loved nursing from my breast.  I had no idea what that would do to you.");
                    //[if addiction quest is active, and Marble is happy with her milk]
                    else if (this.player.statusAffectv3(StatusAffects.Marble) == 1) this.outputText("  But I think that I've found the one who will change that.  Right sweetie?");
                    //[if addiction quest has not yet triggered]
                    else this.outputText("  Though, I'm not giving up hope yet.");
                    this.outputText("</i>\"");
                }
                else this.outputText("  Until I met you, I was actually really lonely on the inside.</i>\"");
    ...
    public postAddictionFarmHelpings(): void {
        ...
        if (this.player.findPerk(PerkLib.MarbleResistant) >= 0) this.outputText("She assures you that you can't get addicted to it again if you don't drink her milk directly from her breasts.", false);
    ...
    public postAddictionCampMornings(extra: boolean = true): void {
        ...
        if (this.player.lib < 40) this.dynStats("lib", .1);
        ...
        if (!this.player.hasItem(this.consumables.M__MILK, 5)) {
            ...
            if (this.player.findPerk(PerkLib.MarbleResistant) >= 0) this.outputText("She assures you that you'll be fine as long as you don't drink directly from her breasts.", false);
    ...
    private standardSex(newpage: boolean = true): void {
        ...
        if (this.player.gender > 0) {
            ...
            //(player is not wearing fetish gear)
                ...
                if (this.player.biggestTitSize() >= 2) this.outputText("running one of your hands down them before continuing.", false);
                //[player has small or no breasts]
                else this.outputText("running one of your hands over them before continuing on.", false);
    ...
    public marbleSex2Continued(genders: number): void {
        ...
        if (genders == 1) {
            ...
            if (this.player.cocks[0].cockLength < 8) this.outputText("You easily slide all the way into her depths before beginning your hungry thrusts.  ", false);
            //[player is more than 8 inches in length]
            else this.outputText("She is unable to take all of you, but you're hardly discouraged as you begin your hungry thrusts.  ", false);
            ...
            if (this.player.cocks[0].cockLength < 8 && this.player.hasKnot(0)) this.outputText(", and with a pop, your knot slips inside of her", false);
        ...
        //(player is female, I hope I did this right, I'm not familiar with the exact mechanics of female/female toys)
            ...
            //[player is between 4 and 5 feet in height]
            if (this.player.tallness < 60 && this.player.tallness >= 48) this.outputText("squeezes your head into her breasts.  ", false);
            //[player is not between 4 and 5 feet in height]
            ...
            //[player has at least one dick]
            if (this.player.totalCocks() > 0) this.outputText(".  Your " + this.multiCockDescriptLight() + " erupts while clamped between your bodies", false);
    ...
    private marbleMilkSex(newpage: boolean = true): void {
        ...
        if (this.player.cockTotal() > 0) {
            ...
            if (this.player.cockTotal() > 1) this.outputText("\"<i>So, which one is your favorite?</i>\"  Marble asks you while taking measure of your " + this.multiCockDescriptLight() + ".  Before you have a chance to answer, Marble grabs a hold of your central " + this.cockDescript(0) + " and says \"<i>I'll bet it's this one.</i>\"  ", false);
            ...
            if (this.player.cocks[0].cockLength < 8) this.outputText("every bit of your " + this.cockDescript(0) + " is deep inside.  ", false);
            // //[dick(0) is more than 8 inches long]
            else this.outputText("Marble bottoms out at eight inches and you can go no further.  ", false);
        ...
        //(player is female)
            ...
            if (this.player.totalBreasts() > 2) this.outputText(" with each of your " + this.allBreastsDescript(), false);
            else this.outputText(" with each of your " + this.breastDescript(0), false);
            ...
            if (this.player.hasFuckableNipples()) {
                ...
                //[player is lactating]
                if (this.player.biggestLactation() > 1) this.outputText("  The whole while, Marble continues to gulp down your milk.", false);
            }
            //[if player is lactating]
            else if (this.player.biggestLactation() > 1) this.outputText("Her suckling soon brings a stream of milk to her lips that she gulps down eagerly.  You give a contented sigh, but are soon brought out of your revelry as her sucking becomes more stimulating and intense.", false);
            //[player is neither lactating or has nipplecunts]
            if (this.player.biggestLactation() <= 1 && !this.player.hasFuckableNipples()) this.outputText("Of course, since you aren't lactating, nothing but your " + this.nippleDescript(0) + " reaches her lips.  Marble doesn't seem to be put off by this and still gives you a thoroughly enjoyable experience.", false);
            this.outputText("\n\n", false);
    ...
    public marbleAddictionSex(newpage: boolean = true): void {
        ...
        if (this.player.tallness < 66) this.outputText("Marble bends over and kisses you deeply on the lips, a kiss that you eagerly return.  She lifts you up into the air, her lips still locked on yours, and holds you tightly against her body. A full minute passes before she lowers you down so your bodies can be joined.\n\n", false);
        //[player is between 5.5 feet and 6.5 feet in height]
        else if (this.player.tallness < 78) this.outputText("Marble lowers her head and locks her lips with yours, a show of passion that you eagerly return.  The two of you stay like that for a while, time seeming to standing still.  Then Marble breaks the kiss and looks deeply into your eyes as a sly grin spreads across her face.\n\n", false);
        //[player is over 6.5 feet in height]
        else this.outputText("Marble grabs a hold of your head and pulls your mouth to hers for a passionate kiss.  You are only too eager to comply and join in.  Even without her vice grip on your head, it feels like you couldn't possibly leave her wonderful mouth. But you eventually push back and look into her eyes intensely.\n\n", false);
        //[player has at least one dick]
        if (this.player.totalCocks() > 0) {
            ...
            if (this.player.tallness >= 48 && this.player.tallness <= 60) this.outputText(", the breasts your head is clamped between,", false);
        ...
        //[player only has a vagina]
            ...
            //[player height is between 4 feet and 5 feet]
            if (this.player.tallness >= 48 && this.player.tallness <= 60) this.outputText(" and the breasts your head is clamped between", false);
    ...
    public marbleStatusChange(affection: number, addiction: number, isAddicted: number = -1): void {
        if (this.player.findStatusAffect(StatusAffects.Marble) < 0) this.player.createStatusAffect(StatusAffects.Marble, 0, 0, 0, 40);
        //Values only change if not brought to conclusion
        if (this.player.findPerk(PerkLib.MarblesMilk) < 0 && this.player.findPerk(PerkLib.MarbleResistant) < 0) {
    ...
    private applyMarblesMilk(): void {
        ...
        if (this.player.statusAffectv1(StatusAffects.MarblesMilk) > 36) this.player.changeStatusValue(StatusAffects.MarblesMilk, 1, 36);
    ...
    */
    ...
    public interactWithMarbleAtCamp(): void {
        ...
        this.clearOutput();
        if (this.flags[kFLAGS.MARBLE_PURIFICATION_STAGE] != 2) this.outputText("How will you interact with Marble?");
        ...
        if (this.player.findStatusAffect(StatusAffects.MarbleHasItem) >= 0) gatherEvent = this.marbleGathered;
        if (this.flags[kFLAGS.MARBLE_KIDS] > 0) playtime = this.marbleKidsPlaytime;

        if (this.flags[kFLAGS.MARBLE_PURIFICATION_STAGE] == 3 && this.flags[kFLAGS.MARBLE_RATHAZUL_COUNTER_1] == 0) {
    ...
    private marbleKidsPlaytime(): void {
        ...
        if (select == 4) {
            ...
            if (this.flags[kFLAGS.MARBLE_KIDS] == 2) this.outputText("both");
            else this.outputText("about half of your children");
        ...
        if (select == 5) {
            ...
            //[Height below 5 feet]
            if (this.player.tallness < 60) this.outputText("grabs you and immediately lifts you up to her chest, giving you a big hug.");
            //[Height above 5 feet]
            else this.outputText("embraces you strongly, pressing her warm body against yours.");
    ...
    private talkWithMarbleAtCamp(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.MetMarae) >= 0 && this.flags[kFLAGS.MARBLE_CAMPTALK_LEVEL] < 1) {
        ...
        else if (this.player.findStatusAffect(StatusAffects.FoundFactory) >= 0 && this.flags[kFLAGS.MARBLE_CAMPTALK_LEVEL] < 2) {
        ...
        else if (this.player.findStatusAffect(StatusAffects.DungeonShutDown) >= 0 && this.flags[kFLAGS.MARBLE_CAMPTALK_LEVEL] < 3) {
        ...
        else if (this.player.findStatusAffect(StatusAffects.MaraeComplete) >= 0 && this.player.findStatusAffect(StatusAffects.FactoryOverload) < 0 && this.flags[kFLAGS.MARBLE_CAMPTALK_LEVEL] < 4) {
        ...
        else if (this.flags[kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ] > 0 && this.flags[kFLAGS.MARBLE_CAMPTALK_LEVEL] < 5) {
        ...
        else if (this.player.statusAffectv1(StatusAffects.TelAdre) >= 1 && this.flags[kFLAGS.MARBLE_TELADRE_STORY] == 0) {
        ...
        else if (this.flags[kFLAGS.DEFEATED_ZETAZ] > 0 && this.flags[kFLAGS.MARBLE_CAMPTALK_LEVEL] < 6) {
        ...
        else this.outputText("You have no new stories to share with Marble, so you chat for a bit about inconsequential things.", false);
        ...
        else if (this.player.findStatusAffect(StatusAffects.MetMarae) >= 0 && this.player.findStatusAffect(StatusAffects.FoundFactory) < 0) {
            //check if the player is far too weak to go to the factory
            if (this.player.level < 3) this.outputText("\"<i>I think we should help out Marae and shut down that factory she mentioned was in the mountains, but I don't think you're ready to go into the Mountains yet. They can be brutal - get a little more practice, and make sure you've got a good weapon.</i>\"", false);
            else this.outputText("\"<i> I think we should help out Marae and shut down that factory she mentioned was in the mountains. I have no idea what will happen in there, though, so make sure you're as ready as you can be before you go.</i>\"\n\n", false);
        }
        //Player has found factory but not shut it down.
        else if (this.player.findStatusAffect(StatusAffects.FoundFactory) >= 0 && this.player.findStatusAffect(StatusAffects.DungeonShutDown) < 0)
        ...
        else if (this.player.findStatusAffect(StatusAffects.DungeonShutDown) >= 0 && this.player.findStatusAffect(StatusAffects.MaraeComplete) < 0 && this.player.findStatusAffect(StatusAffects.MetCorruptMarae) < 0)
        ...
        else if (this.flags[kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ] == 0 || this.player.statusAffectv1(StatusAffects.TelAdre) == 0)
        ...
        else if (this.flags[kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ] == 0 && this.player.statusAffectv1(StatusAffects.TelAdre) >= 1)
        ...
        else if (this.flags[kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ] > 0 && this.flags[kFLAGS.DEFEATED_ZETAZ] == 0)
    ...
    private marbleGathered(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_PURIFICATION_STAGE] != 1 && this.player.statusAffectv1(StatusAffects.MarbleHasItem) <= 4)
        ...
        else if (this.flags[kFLAGS.MARBLE_PURIFICATION_STAGE] != 1 && this.player.statusAffectv1(StatusAffects.MarbleHasItem) <= 7)
    ...
    private marbleInfo(): void {
        ...
        if (this.player.findPerk(PerkLib.MarblesMilk) >= 0) {
            ...
            if (this.flags[kFLAGS.MARBLE_PURIFIED] == 0) this.outputText("So long as you don't drink milk from Marble's breasts again, you don't have to worry about getting addicted.  ", false);
    ...
    private canGiveItem(): boolean {
        ...
        if (this.player.hasItem(this.consumables.PROBOVA, 1) && this.flags[kFLAGS.MARBLE_BOVA_LEVEL] < 2) return true;
        if (this.player.hasItem(this.consumables.P_LBOVA, 1) && this.flags[kFLAGS.MARBLE_PURIFICATION_STAGE] == 1) return true;
        if (this.flags[kFLAGS.MARBLE_PURIFICATION_STAGE] >= 5) {
    ...
    public giveMarbleLactaid(): void {
        ...
        if (this.player.tallness < 60) this.outputText("lifts you up to her chest before saying breathlessly saying \"<i>Drink now!</i>\"  You waste no time obliging her.\n\n", false);
        else if (this.player.tallness > 72) this.outputText("breathlessly says\"<i>Drink now!</i>\"  You waste no time and descend upon her breasts.\n\n", false);
        else this.outputText("breathlessly says, \"<i>Drink now!</i>\"  You quickly move forward to get a drink.\n\n", false);
    ...
    */
    private marbleCampSexNew(): void {
        ...
        if (!this.player.isNaga()) {
            //Feeding
            if (this.player.findPerk(PerkLib.MarblesMilk) >= 0 && this.player.gender > 0 && MarbleScene.rand(2) == 0) {
                ...
                if (this.player.hasCock()) {
                    ...
                    if (this.player.cumQ() < 500) this.outputText("  You cover her hand as she keeps jerking you off, squeezing out tiny little droplets once you're done ejaculating.");
                    else if (this.player.cumQ() < 1000) this.outputText("  Your load is as large as always, and ropes of cum fly into the air, covering her arm and your abdomen... and you swear one string even lands of her right breast along the way.  \"<i>That's it, sweetie, shoot all you have.</i>\"");
                    else this.outputText("  You pretty much cover yourself, Marble, and the surrounding ground with your enormous white load of cum.  She seems numbed from the sheer output you're capable of.  \"<i>Uh... sweetie...</i>\"");
                ...
                //[Female]
                    ...
                    if (this.player.wetness() >= 4) this.outputText("  Messy as it is, Marble never stops, wanting to make the orgasm as intense as possible.");
                    //([Squirter]
                    if (this.player.wetness() > 4) this.outputText("  Soon, you're shooting your femcum all over her arm, and she giggles at the intensity and visibility of your orgasm.");
            ...
            //ORAL
                ...
                if (this.player.hasCock()) this.outputText("a tent growing in your " + this.player.armorName);
                else if (this.player.hasVagina()) this.outputText("a moistness growing under your " + this.player.armorName);
                ...
                if (this.player.hasVagina() && !this.player.hasCock()) this.outputText("probing her tongue in your " + this.vaginaDescript(0) + ", licking you in the most appropriate places");
                else this.outputText("wrapping her tongue around your rod of dickflesh, squeezing and pumping beads of pre-cum up your shaft");
                ...
                if (this.player.hasVagina() && !this.player.hasCock()) this.outputText("poking your cunt");
                else this.outputText("suckling the juices out of your urethra and literally absorbing the drops of pre-cum as they spurt out of the tip of your junk.");
                //[if multicock]
                if (this.player.cockTotal() > 1) this.outputText("  She alternatively sucks and jerks every cock you have, making sure there isn't a single meat-tower that isn't being taken care of.");
                if (this.player.balls > 0) this.outputText("  Her hands softly rub your [balls], making them churn and swell in pure arousal.");
                ...
                //[if vagina]
                else this.outputText("  Her flexible, yet firm tongue really feels like a dong and it keeps provoking you with its prolonged digging. With a mighty thrust, you shove her against your " + this.vaginaDescript() + ", forcing the entirety of her oral muscle inside.");
                ...
                else if (this.player.cor + this.player.statusAffectv4(StatusAffects.Marble) < 132) {
                ...
                if (this.player.cocks.length > 0) {
                    ...
                    if (this.player.cumQ() < 25) this.outputText("  In moments, a small amount of your cum is covering Marble's breasts.", false);
                    else if (this.player.cumQ() < 250) this.outputText("  After a few moments, a fair amount of your cum is covering Marble's breasts and face.", false);
                    else if (this.player.cumQ() < 500) this.outputText("  You keep cumming and cumming, until eventually Marble is completely drenched in your cum.", false);
                    else this.outputText("  Your seemingly endless orgasm eventually results in the two of you becoming completely drenched in your cum, as well as a large part of the ground around you.", false);
                }
                ...
                if (this.player.vaginas.length > 0) {
                    ...
                    if (this.player.vaginas[0].vaginalWetness < VAGINA_WETNESS_WET) this.outputText("  As you recover, you see that a small amount of your girly fluids has leaked onto Marble's breasts.", false);
                    else if (this.player.vaginas[0].vaginalWetness <= VAGINA_WETNESS_SLICK) this.outputText("  As you recover, you see that Marble has been covered fairly liberally with your girly fluids.", false);
                    else if (this.player.vaginas[0].vaginalWetness < 5) this.outputText("  As you recover, you see that Marble is decently drenched in your girly fluids.", false);
                    else this.outputText("  It takes you a minute to recover, but upon doing so, you blush and realize just how soaked with fluid you've become.", false);
                }
                //finally some philosophy on what an orgasm would feel like for someone who is genderless
                if (this.player.gender == 0) this.outputText("  It's not quite the same as when you had genitals, but it is undeniably an orgasm.  While it is essentially a pointless orgasm, it's also almost pure in a way.  There is not a feeling inside you but the explosion of pleasure.", false);
        ...
        //NAGAS
            ...
            if (this.player.lib >= 50) this.outputText("  Quietly, you reach down and hook your fingers into the hem of her clothing, allowing her to pull it half off with her next shift and expose her pussy");
            if (this.flags[kFLAGS.MARBLE_DICK_LENGTH] > 0) this.outputText(" and " + this.marbleCock());
            ...
            if (this.player.gender > 0) {
                ...
                if (this.player.hasVagina()) this.outputText(this.vaginaDescript());
                ...
                if (this.player.hasCock()) this.outputText("grabs your shaft");
                else this.outputText("penetrates your pussy");
                this.outputText(", while using her long tongue to lick the ");
                if (this.player.hasCock()) this.outputText("tip");
                ...
                if (this.player.hasCock()) this.outputText("  [EachCock] unleashes a load of semen right into her mouth, which she swallows with pink-faced, wanton gusto.");
                if (this.player.hasVagina()) this.outputText("  Your [pussy] runs and squirts as you moan, drooling your juices into the little valley where Marble's breasts press against your scales.");
            }
            else {
    ...
    private marbleNips(): string {
        ...
        if (this.player.statusAffectv2(StatusAffects.MarbleSpecials) == 0) this.player.changeStatusValue(StatusAffects.MarbleSpecials, 2, 1);
    ...
    private marbleCock(): string {
        ...
        if (Math.floor(Math.random() * 3) == 0) {
            ...
            if (this.flags[kFLAGS.MARBLE_DICK_LENGTH] >= 3 && this.flags[kFLAGS.MARBLE_DICK_LENGTH] < 5) descript = "short ";
            if (this.flags[kFLAGS.MARBLE_DICK_LENGTH] >= 5 && this.flags[kFLAGS.MARBLE_DICK_LENGTH] < 7) descript = "average ";
            if (this.flags[kFLAGS.MARBLE_DICK_LENGTH] >= 7 && this.flags[kFLAGS.MARBLE_DICK_LENGTH] < 9) descript = "long ";
            if (this.flags[kFLAGS.MARBLE_DICK_LENGTH] >= 10 && this.flags[kFLAGS.MARBLE_DICK_LENGTH] < 13) descript = "huge ";
            if (this.flags[kFLAGS.MARBLE_DICK_LENGTH] >= 13 && this.flags[kFLAGS.MARBLE_DICK_LENGTH] < 18) descript = "massive ";
            if (this.flags[kFLAGS.MARBLE_DICK_LENGTH] >= 18 && this.flags[kFLAGS.MARBLE_DICK_LENGTH] < 30) descript = "enormous ";
        ...
        if (Math.floor(Math.random() * 3) == 0) {
            ...
            if (this.flags[kFLAGS.MARBLE_DICK_THICKNESS] <= .75) descript += "narrow ";
            if (this.flags[kFLAGS.MARBLE_DICK_THICKNESS] > 1 && this.flags[kFLAGS.MARBLE_DICK_THICKNESS] <= 1.4) descript += "ample ";
            if (this.flags[kFLAGS.MARBLE_DICK_THICKNESS] > 1.4 && this.flags[kFLAGS.MARBLE_DICK_THICKNESS] <= 2) descript += "broad ";
            if (this.flags[kFLAGS.MARBLE_DICK_THICKNESS] > 2 && this.flags[kFLAGS.MARBLE_DICK_THICKNESS] <= 3.5) descript += "fat ";
    ...
    public marbleBadEndFollowup(): void {
        ...
        if (this.player.humanScore() >= 5 && morph == "corrupted mutant") morph = "somewhat human mutant";
        if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) morph = "centaur";
        if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) morph = "centaur";
    ...
    public marblePoopsBaybees(): void {
        ...
        if (this.pregnancy.type == PregnancyStore.PREGNANCY_PLAYER) {
            ...
            if (this.flags[kFLAGS.MARBLE_PURIFIED] > 0 && MarbleScene.rand(2) == 0) {
                ...
                if (this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0) this.outputText(", but you notice that she does not have a cock of any kind. It seems that trait isn't passed on", false);
    ...
    public marbleNightSleepFlavor(): boolean {
        ...
        if (this.flags[kFLAGS.MARBLE_NURSERY_CONSTRUCTION] == 0 && this.player.pregnancyType == PregnancyStore.PREGNANCY_MARBLE && (this.player.pregnancyIncubation <= 128)) {
        ...
        switch (this.pregnancy.eventTriggered()) {
            case 2: this.outputText("<b>You notice that Marble seems to have gained some weight.</b>\n\n", false); //3 days in
                break;
            case 3: this.outputText("<b>Marble's belly has gotten a fair bit bigger; she may be pregnant.</b>\n\n", false); //8 days in
                break;
            case 4: this.outputText("<b>Marble's belly has gotten bigger; she is obviously pregnant.", false); //12 days in
                ...
                if (this.flags[kFLAGS.MARBLE_NURSERY_CONSTRUCTION] == 0 && this.pregnancy.type != PregnancyStore.PREGNANCY_OVIELIXIR_EGGS) {
                    this.flags[kFLAGS.MARBLE_NURSERY_CONSTRUCTION]++;
                    this.outputText("  She lets you know that she'll be busy working on a nursery for her child for a while.", false);
                }
                this.outputText("</b>\n\n", false);
                break;
            case 5: this.outputText("<b>Marble's pregnancy has advanced further still, though the structure of her body keeps it from slowing her down.</b>\n\n", false); //18 days in
                break;
        ...
        if (this.player.gender == 0) {
            ...
            if (this.flags[kFLAGS.MARBLE_LUST] < 0) this.outputText("She makes a point of turning to face away from you when you climb into your bedroll.  Looks like she's still annoyed at you.");
            else if (this.flags[kFLAGS.MARBLE_LUST] < 20) this.outputText("She lies next to you contentedly when you climb into your bedroll.");
            else if (this.flags[kFLAGS.MARBLE_LUST] < 30) this.outputText("Marble gives a soft sigh when you climb into your bedroll.");
            else if (this.flags[kFLAGS.MARBLE_LUST] < 40) this.outputText("Marble fidgets around a bit when you climb into your bedroll.");
            else this.outputText("Marble seems rather worked up when you climb into your bedroll.");
            if (this.player.lust < 33 && this.flags[kFLAGS.MARBLE_LUST] < 20) this.outputText("  After a few moments of getting comfortable, you drift off to sleep.");
                ...
                else this.outputText("  However, you're not aroused enough to consider sex.");
            }
            else {
    ...
    private pcPregWithMarblesKids(): boolean {
        return this.player.pregnancyType == PregnancyStore.PREGNANCY_MARBLE && this.player.pregnancyIncubation <= 280;
    ...
    private marbleCuddlin(): void {
        ...
        if (!this.pcPregWithMarblesKids() && !this.marblePregWithPCKids()) {
            ...
            if (this.player.tallness <= 78) this.outputText("pulls your head on top of her chest.  She idly strokes your " + this.hairDescript() + " and says, \"<i>Sweetie, how about I be your pillow for the night?</i>\"  You happily agree, and soon you drift off to the sound of her steady breathing while you lay between her sizable breasts.", false);
            else this.outputText("wraps her arms around you, gently pulling you against her.  \"<i>Sweetie, do you mind if we stay like this for a while?</i>\"  There is no way you could refuse, and before long, the two of you drift off to sleep in each other's arms.", false);
        }
        //Preg-cuddles
        else {
    ...
    private marbleNightSexDudes(): void {
        ...
        if (this.player.cor + this.player.lib < this.player.statusAffectv4(StatusAffects.Marble) + 10) {
    ...
    private marbleNightSexChicks(): void {
        ...
        //PC is female, Marble is a herm
            ...
            if (this.player.vaginalCapacity() > this.flags[kFLAGS.MARBLE_DICK_LENGTH] * this.flags[kFLAGS.MARBLE_DICK_THICKNESS]) {
            ...
            this.player.cuntChange(this.flags[kFLAGS.MARBLE_DICK_THICKNESS] * this.flags[kFLAGS.MARBLE_DICK_LENGTH], true);
        }
        this.marbleSexFinish();
    }
    ...
    private marblePreggoChance(preggerMult: number): void {
        ...
        if (MarbleScene.rand(100) < preggerOdds && (this.player.findPerk(PerkLib.MarblesMilk) >= 0 || this.flags[kFLAGS.MARBLE_PURIFICATION_STAGE] >= 5)) {
    ...
    private marbleNomNoms(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0) {
            ...
            if (this.player.findStatusAffect(StatusAffects.SlimeCraving) >= 0 || this.player.lib + this.player.cor - this.player.inte > 35) {
    ...
    */
    ...
    private marbleAppearance(): void {
        ...
        else if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] == 1) this.outputText("6 foot 8 ");
        else this.outputText("7 foot 4 ");
        ...
        if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] <= 1) this.outputText("She has a fairly normal soft human face, with light-colored skin.  ");
        else this.outputText("She has a soft face that is a mix of bovine and human features, with thick brown fur covering her body.  ");
        ...
        if (this.player.statusAffectv4(StatusAffects.Marble) <= 20) this.outputText("Two small horns grow from her forehead, similar in size and appearance to those on a young female bovine.  ", false);
        else if (this.player.statusAffectv4(StatusAffects.Marble) <= 50) this.outputText("Two medium sized horns grow from her forehead, similar in size and appearance to those on a female bovine.  ", false);
        else this.outputText("Two fairly large horns grow from her forehead, similar in appearance to those on a female bovine.  ", false);
        ...
        if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] <= 1) this.outputText(", human until about half-way down her thigh.  The lower portion of her legs is covered in thick dark brown fur and ends in a pair of bestial hooves.\n\n", false);
        else this.outputText(" that are oddly jointed and end in a pair of bestial hooves.\n\n", false);

        if (this.player.statusAffectv4(StatusAffects.Marble) <= 15) this.outputText("She has two pillowy breasts, each supporting a 0.4-inch lactating " + this.marbleNip() + ".  She could easily fill a " + this.marbleBreastSize() + " bra.\n\n", false);
        else if (this.player.statusAffectv4(StatusAffects.Marble) <= 25) this.outputText("She has two large breasts, each supporting a 0.6-inch lactating " + this.marbleNip() + ".  She could easily fill a " + this.marbleBreastSize() + ".\n\n", false);
        else if (this.player.statusAffectv4(StatusAffects.Marble) <= 35) this.outputText("She has two basketball-sized breasts, each supporting a 0.8-inch milk-seeping " + this.marbleNip() + ".  She could easily fill a " + this.marbleBreastSize() + " bra.\n\n", false);
        else this.outputText("She has two basketball-sized breasts, each supporting a 1-inch milk-seeping " + this.marbleNip() + ".  She could easily fill an " + this.marbleBreastSize() + " bra.\n\n", false);
        ...
        switch (this.pregnancy.event) {
            case 2: this.outputText("It looks like she's put on some weight since coming to your camp.\n\n", false); //3 to 8 days in
                break;
            case 3: this.outputText("Her belly has swollen a bit; she may be pregnant.\n\n", false); //8 to 12 days in
                break;
            case 4: this.outputText("Her belly is obviously swollen; she is almost certainly pregnant.\n\n", false); //12 to 18 days in
                break;
            case 5: this.outputText("Her belly is very swollen; she is very pregnant.\n\n", false); //18 to 24 days in
                break;
        ...
        if (this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0) this.outputText("She has grown a " + this.marbleCock() + " since you brought her to camp. It is " + MarbleScene.num2Text(Math.floor(this.flags[kFLAGS.MARBLE_DICK_LENGTH])) + " inches long and " + MarbleScene.num2Text(Math.floor(this.flags[kFLAGS.MARBLE_DICK_THICKNESS])) + " inches thick.\n\n", false);

        if (this.player.statusAffectv4(StatusAffects.Marble) <= 50) this.outputText("She has a pussy, with a 0.5 inch clit.\n\n", false);
        else if (this.player.statusAffectv4(StatusAffects.Marble) <= 75) this.outputText("She has a cunt, with a 0.6 inch clit.  You can see moisture gleaming from it.\n\n", false);
        else this.outputText("She has a fuck-hole, with a 0.7 inch clit.  Moisture gleams in her cunt, its lips slightly parted.\n\n", false);
    ...
    private milkMarble(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_MILKED_BEFORE] < 1) {
            ...
            if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] < 1) this.outputText("two");
            else this.outputText("eight");
    ...
    private milkMarbleCunnilingling(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_BOVA_LEVEL] < 1) this.outputText("semi-human");
        else this.outputText("inhuman");
        ...
        if (this.player.isBiped()) this.outputText("get down on your knees, and slowly crawl forward");
        else this.outputText("lower your body close to the ground, and slowly inch forward");
        ...
        if (this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0) this.outputText("With the first flick across its pink flesh, Marble grabs ahold of her " + this.marbleCock() + ", and tightly squeezes it, slowly pushing her hand down it.");
        else this.outputText("With the first flick across its pink flesh, Marble grabs onto an arm of her chair, gripping it tightly.");
        ...
        if (this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0) this.outputText("Of course, there is also a spurt of white which sprays out over her lap and your head.  ");
    ...
    private milkMarbleFuckDatCowPussy(): void {
        ...
        else this.outputText("[pg]\"<i>Hmm, yes, I think that will work.  Come closer so I can make a more thorough inspection.</i>\"");
        ...
        if (this.player.findPerk(PerkLib.MarblesMilk) >= 0) {
            ...
            this.dynStats("lib", .3);
            if (this.player.cor < this.player.statusAffectv4(StatusAffects.Marble)) this.dynStats("cor", 1);
            this.dynStats("tou", .1);
            this.dynStats("str", .1);
            this.dynStats("sen", -2);
            this.marblePreggoChance(1);
    ...
    private milkMarbleTakeHerDick(): void {
        ...
        if (this.player.tallness < 56) this.outputText(", grab a box,");
        ...
        if (this.player.vaginalCapacity() < this.flags[kFLAGS.MARBLE_DICK_LENGTH] * this.flags[kFLAGS.MARBLE_DICK_THICKNESS]) this.outputText("With each new bit of length inserted, she waits a few moments for you to adjust to her size, letting you fill out to accommodate her.  ");
        ...
        if (this.player.buttRating <= 4 && !this.player.isGoo()) this.outputText("taut");
        else this.outputText("jiggling");
        this.outputText(" flesh while her " + MarbleScene.num2Text(Math.round(this.flags[kFLAGS.MARBLE_DICK_LENGTH])) + " inch length continues to push and pull into your womanhood.  Egged on by her enthusiasm, you start putting in some effort into the sex yourself by pushing your backside tight against her with each push forward and shaking it back and forth with each pull out of your interior.");
    ...
    private milkMarbleBarFollowTail(): void {
        ...
        if (x >= 0) {
            ...
            if (y >= 0) this.outputText("  You find your " + this.cockDescript(y) + " slides up comfortably in between her cheeks, and squeeze them together a bit to give it a nice tight valley of soft flesh to run through.");
    ...
    private milkMarbleBarPullTail(): void {
        ...
        if (this.flags[kFLAGS.MARBLE_DICK_TYPE] > 0) this.outputText("  She grabs her erect member, and rubs it against your cheek a few times, spreading around some of her pre-cum.");
        ...
        if (this.flags[kFLAGS.MARBLE_DICK_TYPE] == 0) {
            ...
            if (this.player.tongueType > TONUGE_HUMAN) this.outputText("You take full advantage of your inhumanly long tongue to fill her up, running across her passage all the way to the entrance to her womb and then back to her lower lips.");
            else this.outputText("You send your tongue as far into her passage as it will go and wriggle around her lower lips, trying to please your aggressive bovine lover to the best of your abilities.");
        }
        else {
            this.outputText("[pg]She forces your mouth open and pushes her hips forward, roughly shoving her " + MarbleScene.num2Text(Math.round(this.flags[kFLAGS.MARBLE_DICK_LENGTH])) + "-inch cock into your hapless mouth and down your throat.  You choke and sputter in surprise at the sudden suffocation, but it only lasts a few seconds before she pulls back out.");
        ...
        if (this.silly()) this.outputText("  Want to brush your teeth with my tail next time?");
