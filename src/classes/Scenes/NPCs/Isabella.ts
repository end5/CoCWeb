...
export class Isabella extends Monster {
    ...
    public isabellaAttack(): void {
        ...
        //("Misdirection"
        else if (this.player.findPerk(PerkLib.Misdirection) >= 0 && Isabella.rand(100) < 10 && this.player.armorName == "red, high-society bodysuit") {
    ...
    protected performCombatAction(): void {
        ...
        if (this.HPRatio() < .7 && Isabella.rand(3) == 0) this.drankMalkYaCunt();
        //if PC has spells and isn't silenced, 1/3 chance of silence.
        else if (this.player.hasSpells() && this.player.findStatusAffect(StatusAffects.ThroatPunch) < 0 && Isabella.rand(3) == 0) {
            this.isabellaThroatPunch();
        }
        //if PC isn't stunned, 1/4 chance of stun
        else if (this.player.findStatusAffect(StatusAffects.IsabellaStunned) < 0 && Isabella.rand(4) == 0) {
            this.isabellaStun();
        }
