...
export class CeraphFollowerScene extends NPCAwareContent {
    ...
    public ceraphFollowerAppearance(output = true): void {
        ...
        if (output) {
            ...
            this.outx("<b>What will you do with your slave?</b>  ");
        }
        let dickToggle = "";
    ...
    private helpWithFarm(): void {
        ...
        this.outx("You ask Ceraph if she can help you with the farm you recently acquired.");
    ...
    private noFarmShitYet(): void {
        ...
        this.outx("“<i>Very well,</i>” she smirks. “<i>Anything else?</i>”");
    ...
    public submissiveCeraphOffer(): void {
        this.spriteSelect(7);
        this.outx("", true);
        this.outx("Once again, Ceraph ");
        if (this.monster.HP < 1)
            this.outx("drops on the ground in front of you, completely beaten.");
        else
            this.outx(
        ...
        this.outx("  She ");
        if (this.monster.HP < 1) this.outx("looks up at you and asks");
        else this.outx("manages to stop fapping long enough to look up at you and ask");
        this.outx(', "<i>Why do I even bother?</i>"\n\n', false);
        ...
        if (this.player.cor < 33) this.outx("a nervous chuckle");
        else if (this.player.cor < 66) this.outx("a surprised laugh");
        else this.outx("a bemused smirk");
        this.outx(
    ...
    private collarCeraph(): void {
        ...
        if (this.player.cor < 33)
            ...
            this.outx("on how much you'll enjoy using the former dom as your personal ", false);
            if (this.player.hasCock()) this.outx("cum-dump");
            else this.outx("tongue-slave");
            this.outx(".");
        }
        this.outx(
        ...
        if (this.monster.lust > 99) this.outx("resume stroking");
        else this.outx("stroke");
        this.outx(
    ...
    private carryCarephsToken(): void {
        ...
        this.outx("<b>(Received Key Item: Onyx Token)</b>\n\n", false);
    ...
    private getCeraphFollowerPiercing(): void {
        ...
        this.outx("You bare your midriff to your new slut with ");
        if (this.player.cor < 40) this.outx("a little hesitation.");
        else this.outx("a smirk, secure in your knowledge of her defeat.");
        this.outx(
    ...
    private CeraphHandsOutNewFetishesLikePervCandy(): void {
        ...
        // *Fetish level = 0
        if (this.flags[kFLAGS.PC_FETISH] == 0) {
            this.outx("Ceraph comes forward on your command, whispering calmly as she ", false);
            ...
            this.outx("Ceraph watches your ");
            if (this.player.cockTotal() > 0)
                this.outx("cock bounce in time with your fluttering heartbeats");
            ...
            this.outx("Ceraph is right – <b>you're an exhibitionist now.</b>");
            if (this.player.earsPierced == 0) {
        ...
        // *Fetish level = 1
            ...
            if (this.player.nipplesPierced == 0) {
                ...
                if (this.player.hasFuckableNipples()) this.outx("slutty");
                else if (this.player.nippleLength < 1) this.outx("cute");
                else this.outx("tight");
                this.outx(
        ...
        // *Fetish level = 2
            ...
            // [else]
                ...
                this.outx("snaps the diamond stud into your eye-brow, piercing it");
                if (this.player.eyebrowPierced > 0)
                    this.outx(" and discarding your old jewelry like a piece of garbage", false);
                this.outx(".  It hurts more than it ought to, fuzzing your vision red.\n\n", false);
    ...
    private goThroughWithCeraphUnfetishification(): void {
        ...
        else this.outx("You slap her across the face for her temerity.");
    ...
    private fuckFollowerCeraphsVagoo(): void {
        ...
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outx(" and half-erect, throbbing cock");
        this.outx(".  ");
        if (this.player.cor < 33)
            this.outx(
            ...
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outx("and her dick releasing a squirt of pre-cum ");
            this.outx(
        ...
        this.outx("  You grab Ceraph's thighs");
        if (this.player.str < 60)
            this.outx(
                " and heave, lifting her up off the ground and forcing her to straddle you.",
                false
            );
        else this.outx(" and easily lift her, forcing her to straddle you.");
        this.outx(
        ...
        else this.outx("immersing yourself in the decadent wetness.\n\n", false);
        ...
        if (y >= 0) {
            ...
            if (this.player.cockTotal() >= 3) {
                this.outx("  Sadly, your extra penis");
                if (this.player.cockTotal() > 3)
                    this.outx(
        ...
        // (Single Penn!)
            ...
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outx(" while her cock spews ropes of pre-cum into the dirt");
            this.outx(
        ...
        this.outx("You hold yourself there, deep inside the wanton hole");
        if (y >= 0) this.outx("s");
        this.outx(" and basting the corrupt slave's tunnel");
        if (y >= 0) this.outx("s");
        this.outx(
        ...
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outx(", and her cock starts pumping more demonic spunk into the mud");
        this.outx(
        ...
        this.outx("Ceraph sighs, ");
        if (this.player.cumQ() >= 700) this.outx("rubbing her ");
        if (this.player.cumQ() >= 1400) this.outx("bloated, ");
        if (this.player.cumQ() >= 700) this.outx("bulging belly as she purrs, ");
        else this.outx("purring, ");
        this.outx(
        ...
        if (this.player.tallness >= 80) this.outx("chest");
        else if (this.player.tallness >= 60) this.outx("lips");
        else this.outx("forehead");
        this.outx(' and mouths, "<i>Thank you.</i>"\n\n', false);
    ...
    private followerCeraphTongueFucking(): void {
        ...
        if (this.player.hasCock()) this.outx(" and " + this.multiCockDescriptLight(), false);
        this.outx(".\n\n", false);

        this.outx('"<i>Serve me with your tongue,</i>" you command.\n\n', false);
        ...
        if (this.player.lust < 50) this.outx("still-hooded");
        else this.outx("engorged");
        this.outx(
        ...
        else if (this.player.wetness() < 4) this.outx("wet");
        else this.outx("soaking");
        this.outx(
        ...
        if (this.player.wetness() >= 5)
            ...
            this.outx(", even though she has to gulp it down from time to time.");
        else if (this.player.wetness() >= 2)
            this.outx(", even though you produce enough for her to gulp.");
        else
            this.outx(
    ...
    private ceraphTentacleGrape(): void {
        ...
        if (this.player.cockTotal() == 1) this.outx("all of your girth");
        else this.outx("in all of your members simultaneously");
        this.outx(
        ...
        if (this.player.cumQ() >= 800) this.outx("bulges wide from the sheer size, sucking");
        else this.outx("sucks");
        this.outx(
    ...
    private fuckCeraphsCatgirls(): void {
        ...
        if (this.player.biggestLactation() > 1)
            ...
            else this.outx("vibrating it wildly back and forth.");
        }
        this.outx(
    ...
    private ceraphLackeyCorruption(): void {
        ...
        if (!this.player.hasCock()) {
            ...
            if (this.player.hasVagina())
                this.outx("your " + this.clitDescript() + " swells", false);
            else this.outx("a small bump forms on your mons");
            this.outx(
    ...
    private sweetieNOOOO(): void {
        ...
        if (this.player.hasKeyItem("Breast Milker - Installed At Whitney's Farm") >= 0)
            this.outx("similar to the one you got from the factory.");
        else
            this.outx(
    ...
    private postUdderChoice(newl = false): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00296] == 1)
            this.outx(", making sure to prep four extra tubes for her udder");
        this.outx(
        ...
        this.outx("She can be <b>your</b> slave, for once.\n\n", false);
        ...
        if (this.player.balls > 0)
            this.outx("your " + this.ballsDescriptLight() + " tightening", false);
        else this.outx("a readiness in your body");
        this.outx(", and you wind up for one last thrust into her depths.  ");
        ...
        if (this.player.cockTotal() == 2) this.outx("  Your other cock sprays ");
        else if (this.player.cockTotal() > 2) this.outx("  Your other cocks spray ");
        if (this.player.cockTotal() > 1) {
            this.outx("a ");
            if (cum < 50) this.outx("gentle");
            else if (cum < 250) this.outx("generous");
            else if (cum < 750) this.outx("heady");
            else if (cum < 1500) this.outx("wild");
            else this.outx("massive");
            this.outx(" amount of semen all over the nearby stalls and equipment");
            if (cum >= 250 && cum < 1000) this.outx(", spattering the entire area");
            else if (cum >= 1000 && cum < 3000) this.outx(", drenching the area in white");
            else if (cum >= 3000) this.outx(", coating the area in a thick sheet of alabaster");
            this.outx(".");
        }
        this.outx("\n\n", false);
    ...
    private cerminika(): void {
        ...
        if (this.player.hasCock()) {
            ...
            // [CERAPH COCK:
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outx("  Her dick presses up into your crotch.");
            this.outx(
            ...
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outx(", and her prick has remained firm and hard");
            this.outx(
            ...
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outx(", and the heat of her prick bouncing into your lap");
            this.outx(
                '.  "<i>Hey,</i>" she gasps, "<i>Don\'t you want to savor it?</i>"\n\n',
                false
            );

            this.outx("You slap her tit.\n\n", false);
            ...
            if (this.player.biggestTitSize() >= 1) this.outx(" and slap at your own chest");
            this.outx(
            ...
            this.outx('"<i>Yes,</i>" you answer calmly.\n\n', false);
    ...
    public encounterZetsuko(): void {
        ...
        if (this.flags[kFLAGS.ZETSUKO_MET] == 1) {
            ...
            this.outx("Will you make use of Zetsuko now, or send her back to Ceraph?");
    ...
    private fuckZetsukosTonguepussy(): void {
        ...
        this.outx("In no time at all, you ");
        if (this.player.cockArea(x) >= 100) this.outx("somehow ");
        this.outx(
        ...
        if (this.player.balls > 0)
            this.outx("slithering across your " + this.ballsDescriptLight() + ", ", false);
        else if (this.player.hasVagina())
            this.outx("gently licking the outer edges of your labia, ");
        this.outx("moving along to the back, ");
        if (this.player.balls > 0 || this.player.hasVagina()) this.outx("and ");
        this.outx(
            "teasing your " +
                this.assholeDescript() +
    ...
    private getTonguedByZetsuko(): void {
        ...
        this.outx("heading straight toward your slit.\n\n", false);
        ...
        if (x >= 0) {
            ...
            this.outx(" up using her toes and stroking along the underside of the shaft", false);
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(
            ...
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(" almost as skillfully as if she were using her hands!\n\n", false);
        }
        ...
        this.outx('"<i>Oooh, Mistress\'s pussy is delicious!</i>"\n\n', false);
    ...
    private zetsukoBanana(): void {
        ...
        this.outx("Oh, so a banana is a fruit? *THUD*\n\n", false);

        this.outx('"<i>FUCK!</i>"\n\n', false);

        this.outx("You'll take that as a yes.\n\n", false);
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private giveFollowerBodyBits(): void {
        ...
        if (this.player.hasCock() || this.player.hasVagina() || this.player.hasBreasts()) {
            if (this.player.hasCock()) this.outx("  I could take your cock.");
            if (this.player.hasVagina())
                this.outx(
            ...
            if (this.player.hasBreasts())
                this.outx("  I could even make off with your tits if you like.");
        } else
            this.outx(
    ...
    private ceraphFollowerTitTaking(rowNum = 0): void {
        ...
        // Top row is only row
            ...
            this.outx("your now-flat chest slowly gains two tiny, quarter-inch nipples.", false);
        ...
        // everybody else
            ...
            this.outx("your torso leaves the now-empty spot as a flat, featureless void.", false);
            this.player.removeBreastRow(x, 1);
        }
        ...
        this.outx("You gasp when Ceraph ");
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00217] == 3)
            this.outx("rolls the nipples in her hands");
        else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00217] == 4)
            this.outx("pushes her fingertips inside the leaky nipple-cunts");
        else this.outx("squeezes out a squirt of milk");
        this.outx(
    ...
    private stuffSomeNippleCunts(): void {
        ...
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0) this.outx(" and proud demon-dick");
        this.outx(
        ...
        if (this.player.bRows() > 1) {
            this.outx("  A second later, ");
            if (this.player.bRows() == 2) this.outx("another row of female flesh begins");
            else this.outx("more rows of female flesh begin");
            this.outx(
        ...
        else this.outx(", her pussy dripping weakly in sympathetic release.");
        this.outx(
    ...
    private portalFuckWithFollowerCeraph(): void {
        ...
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0) this.outx(" and eager cock");
        this.outx(
    ...
    private layEggsInSlaveCeraph(): void {
        ...
        if (!this.player.isTaur())
            this.outx("absently rub the sensitive bulge in your abdomen as you ");
        this.outx(
    ...
    private sumissivenessToCeraphFollower(): void {
        ...
        if (this.player.gender == 3) {
            this.outx(", both in the hardness of your manhood");
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(" and the moisture leaking from under your equipment");
        } else if (this.player.gender == 2)
            this.outx(", what with the beads of moisture forming between your legs");
        else
            this.outx(
        ...
        else this.outx("your rigid clit");
        this.outx(" with ticklishly-soft touches");
        if (this.player.balls > 0) this.outx(" before gently squeezing your [sack]");
        this.outx(
            ", savoring your state.  You groan out loud at the sudden sensation, and a bead of "
        );
        if (this.player.hasCock())
            this.outx("pre-cum has begun to form on your [cockHead biggest]");
        else this.outx("girl-cum has begun to form at your quivering entrance");
        this.outx(
    ...
    private barkToCeraphOnce(dog = true): void {
        ...
        this.spriteSelect(87);
        this.outx('"<i>');
        if (dog) this.outx('Arf!</i>" you bark');
        else this.outx('Meowwwww!</i>" you mew');
        this.outx(", loud and almost proudly");
        if (this.player.tailType > TAIL_TYPE_NONE) this.outx(", wagging your tail excitedly");
        this.outx(".");
        this.outx("\n\nCeraph casually pulls her panties a bit lower to ");
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outx("ease the pressure on her tightly-contained phallus");
        else this.outx("allow a penis to grow, fully-formed from where her clit was");
        this.outx(
        ...
        this.outx('\n\n"<i>');
        if (dog) this.outx("ARF!  ARF!");
        else this.outx("REOOOOW!");
        this.outx('</i>" you ');
        if (dog) this.outx("bark");
        else this.outx("meow");
        this.outx(" in distress, trying to crawl away.  You didn't mean to get ");
        if (this.player.hasCock()) this.outx("milked ");
        else this.outx("fucked ");
        this.outx(
        ...
        if (dog) this.outx("doggie");
        else this.outx("kitty-cat");
        this.outx('.</i>"  Her hips press the hot spear harder against your [asshole].  ');
        ...
        if (this.player.hasCock()) this.outx("your twitching maleness");
        else if (this.player.hasVagina()) this.outx("to your achingly empty pussy");
        if (this.player.cockTotal() > 1) this.outx("es");

        this.outx(".  Almost immediately, you squirt out a huge dollop of ");
        if (this.player.hasCock()) this.outx("pre-cum");
        else this.outx("lady spunk");
        this.outx(".  It dangles heavily enough to ");
        if (this.player.hasCock()) this.outx("make your [cock biggest] bob below");
        else this.outx("tantalize and tease your clit");
        this.outx(
        ...
        if (this.player.hasCock()) this.outx("rams straight into your inner, cock-milk reserve");
        else
            this.outx(
                "rubs against your quivering vaginal walls, stimulating you from the inside out"
            );
        this.outx(", and fireworks start to go off inside your brain.");

        this.outx("\n\n");
        if (this.player.hasCock()) this.outx("Dick-milk");
        else this.outx("Love-juice");
        this.outx(" drizzles from ");
        if (this.player.hasCock()) this.outx("[eachCock]");
        else this.outx("your slightly parted twat");
        this.outx(
        ...
        if (this.player.gender == 2) this.outx("fem-");
        this.outx("cum is just ");
        if (this.player.hasCock()) this.outx("sliding");
        else this.outx("pouring");
        this.outx(" smoothly out of it as your ");
        if (this.player.hasCock()) this.outx("inner reservoir is squeezed");
        else this.outx("cunt walls are stimulated through your anal walls");
        this.outx(
        ...
        if (this.player.hasCock()) this.outx("prostate");
        else this.outx("walls");
        this.outx(".  ");
        if (this.player.hasCock())
            this.outx(
        ...
        if (this.player.hasCock()) this.outx("the 'pressure'");
        else this.outx("a need within you");
        this.outx(" feels released, you're still horny");
        if (this.player.hasCock()) {
            if (this.player.cockTotal() == 1) this.outx(", even with a soft cock");
            else this.outx(", even with soft cocks");
        }
        this.outx(
        ...
        if (dog) this.outx("bark in pleasure like the cum-slut doggy that you are");
        else this.outx("mewl in delight like the cock-loving kitty that you are");
        this.outx(
            " and start to push back against her before long.  Those nodules rub your insides so well, and they keep you dripping wasted "
        );
        if (this.player.hasCock()) this.outx("semen");
        else this.outx("juices");
        this.outx(" from your ");
        if (this.player.hasCock()) {
            this.outx("limp cock");
            if (this.player.cockTotal() > 1) this.outx("s");
        } else this.outx("snatch");
        this.outx(
        ...
        if (this.player.hasCock()) this.outx("prostate is getting pushed up against each time");
        else this.outx(", depressingly empty cunt walls are getting teased with every thrust");
        this.outx(".");
        ...
        if (this.player.hasCock()) this.outx("prostate is");
        else this.outx("vaginal walls are");
        this.outx(
        ...
        if (this.player.hasCock()) this.outx("straight onto your sore prostate");
        else this.outx("putting more delicious pressure on your sensitive walls");
        this.outx(".  You scrunch your eyes closed as Ceraph claims your ass for her own, and ");
        if (this.player.hasCock()) {
            if (this.player.cockTotal() > 1) this.outx("each of your cocks");
            else this.outx("your cock");
            this.outx(" lets go the very last of your sticky, stinky, pet-cum");
        } else
            this.outx("your pussy lets go of the last of its sticky, slippery snatch secretions");
        this.outx(".");
        ...
        if (dog) this.outx("tasty bone-shaped biscuit");
        else this.outx("fishy-smelling treat");
        this.outx(
    ...
    private barkOrMeowTwiceToCeraph(dog = true): void {
        ...
        this.spriteSelect(87);
        this.outx('"<i>');
        if (dog) this.outx('Arf! Arf!</i>" you bark');
        else this.outx('Meow!  Meowwwww!</i>" you mew');
        this.outx(", wiggling your ");
        ...
        if (select == 0) {
            ...
            if (this.player.hasCock()) {
                if (this.player.cockTotal() > 1) this.outx("one of ");
                this.outx("your rebellious boner");
                if (this.player.cockTotal() > 1) this.outx("s");
                this.outx(
            ...
            this.outx(".  ");
            if (this.player.hasCock()) this.outx("It bounces against your tummy");
            else this.outx("Your vaginal muscles clench and contract");
            this.outx(
        ...
        // Corrupt Jojo or Amily
            ...
            if (
                ...
                if (jojo) this.outx("He");
                else this.outx("She");
                this.outx(' asks, "<i>[Master], what are you doing?</i>"');
                this.outx("\n\nCeraph looks down at you with her hand tight on your leash.");
                ...
                if (!jojo) this.outx("cum-slut is");
                else this.outx("I guess I'm");
                this.outx(' her pet too...</i>" ');
                if (!jojo) this.outx("Amily");
                else this.outx("Jojo");
                this.outx(
                ...
                this.outx(" rub up against each other.  Having a ");
                if (!jojo) this.outx("sister");
                else this.outx("brother");
                this.outx("-pet is somewhat comforting, but being constantly exposed to ");
                if (jojo) this.outx("his");
                else this.outx("her");
                this.outx(
            ...
            if (this.amilyFollower() && this.flags[kFLAGS.AMILY_FOLLOWER] == 2) this.outx("Amily");
            if (
                this.amilyFollower() &&
                this.flags[kFLAGS.AMILY_FOLLOWER] == 2 &&
                this.campCorruptJojo()
        ...
        // Generic
            ...
            if (this.player.hasCock()) this.outx("goblins");
            else this.outx("imps");
            this.outx(" seem intrigued by the sight of your compulsively ");
            if (this.player.hasCock()) this.outx("erect maleness");
            else this.outx("quivering quim");
            if (this.player.cockTotal() > 1) this.outx("es");
            this.outx(
            ...
            this.outx(" even notices your state and comments on it, holding ");
            if (this.player.hasCock()) this.outx("her");
            else this.outx("his");
            this.outx(" hand beneath your freely drooling ");
            if (this.player.hasCock()) this.outx("erection");
            else this.outx("pussy");
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(" to collect a palmful of slippery ");
            if (this.player.hasCock()) this.outx("boy");
            else this.outx("girl");
            this.outx("-honey.  ");
            if (this.player.hasCock()) this.outx("She");
            else this.outx("He");
            this.outx(
            ...
            this.outx(".  Maybe you'll change your mind sometime.</i>\"");
            ...
            if (this.player.hasCock()) this.outx("pre-cum rockets");
            else this.outx("fem-juice spurts");
            this.outx(
                " onto the ground while you whine softly.  Your owner notices and commands, \"<i>Now, pet, we can't have you making this "
            );
            if (this.player.hasCock()) this.outx("goblin");
            else this.outx("imp");
            this.outx("'s home a mess.  Lick it up.</i>\"");
            this.outx(
            ...
            if (this.player.hasCock()) this.outx("pre-ejaculate");
            else this.outx("lady jizz");
            this.outx(' landed.  "<i>Good enough.  Come on, ');
            if (dog) this.outx("doggy");
            else this.outx("cat");
            this.outx(", let's finish our walk!</i>\"");
            ...
            if (this.player.hasCock()) this.outx("boner");
            else this.outx("twat");
            if (this.player.cockTotal() > 1) this.outx("s");
            if (this.player.cockTotal() > 1) this.outx(" feel like they");
            else this.outx(" feels like it");
            this.outx(" could go off at any second.  The journey is murder for your poor, ");
            if (this.player.hasCock()) this.outx("over-inflated maleness");
            else this.outx("puffy, aching cleft");
            if (this.player.totalCocks() > 1) this.outx("es");
            this.outx(", but you somehow make the whole way home without ");
            if (this.player.hasCock()) this.outx("popping");
            else this.outx("tipping over the edge");
            this.outx(
