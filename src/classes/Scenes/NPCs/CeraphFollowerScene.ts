...
export class CeraphFollowerScene extends NPCAwareContent {
    ...
    public ceraphIsFollower(): boolean {
        return (
            ...
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00287] > 0
        );
    }

    public ceraphFollowerEncounter(forceCeraph = false): void {
        if (forceCeraph) {
            this.ceraphFollowerAppearance();
            return;
        }

        if (CeraphFollowerScene.rand(24) == 0 && this.player.hasCock()) this.catgirlEncounter();
        else if (
            CeraphFollowerScene.rand(24) == 0 &&
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00293] == 0
        )
            this.carephCorruptionSlaves();
        else if (CeraphFollowerScene.rand(24) <= 1 && this.player.gender > 0)
            this.encounterZetsuko();
        else this.ceraphFollowerAppearance();
    }
    ...
    public ceraphFollowerAppearance(output = true): void {
        ...
        if (output) {
            ...
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                ...
                this.outputText(
                    "  Thankfully, she seems to have removed or hidden her demonic cock somehow, so as not to disrupt her fragile outfit with unfeminine bulges",
                    false
                );
            this.outputText(
                ".  Tight buckles link her corset to the long thigh high boots over her legs, the platforms and heels adding nearly a foot to her height.  Red stripes run right down the front of them and along the soles, as an imitation of laces.\n\n",
                false
            );

            this.outputText(
                "Ceraph's liquid black eyes twist, the surfaces spiralling inward to the pinpricks of her pupils.  Her irises, now that you can see them, are purplish, like her skin, though they're glittery and as reflective as precious gems.  The omnibus drops onto her knees before you, not looking you in the eye without a command.  She whispers, \"<i>You called, " +
                    this.player.mf("Master", "Mistress") +
                    '?</i>"\n\n',
                false
            );
            this.outputText(
                'Ceraph offhandedly mentions, "<i>If you\'re into that sort of thing, [Master], I could take one of your <b>delectable</b> body-parts and use it with my harem.  From what I understand, the original owner will often be able to experience the sensations of their gift while their consciousness is relaxed - while sleeping, usually.</i>"\n\n'
            );
        ...
        if (
            this.flags[kFLAGS.FOLLOWER_AT_FARM_CERAPH] == 0 &&
    ...
    private ceraphSexMenu(): void {
        ...
        if (this.player.hasCock() && this.player.cockThatFits(100) >= 0) {
            this.outputText(
                "You could use your penis but see if Ceraph has some magic to mix it up.  "
            );
    ...
    private followerCeraphRoleplay(): void {
        ...
        this.outputText(
            "You tell Ceraph you'd like to do a little roleplaying.  Her nipples turn hard under their latex bindings as she asks, \"<i>What will it be, " +
                this.player.mf("Master", "Mistress") +
                "?  Shall I pretend you've just teased me into sexual submission, or would you like to switch things up and have your bottom play at being top again?  Or maybe... you'd like me to shapeshift into some other girl, and do all the dirty, depraved things she never would?</i>\"",
            false
        );
        this.outputText(
    ...
    public submissiveCeraphOffer(): void {
        ...
        if (this.monster.HP < 1)
            ...
            this.outputText(
                "drops down and starts masturbating, practically fisting her drooling pussy while she pumps her demonic dick with reckless abandon.",
                false
            );
        ...
        this.outputText(
            "You're a bit surprised by her tone - depression and defeat aren't exactly her style.  The only thing you manage to respond with is ",
            false
        );
        ...
        this.outputText(
            ".  Ceraph presses on, \"<i>This whole time I've been trying to bring you into my harem, but I've ignored the obvious.  Each time we've tangled, you come out on top... in more ways than one.</i>\"  The demon looks up at you with meek, hooded eyes and says, \"<i>Perhaps I've had it backwards all along... I belong in your harem.</i>\"\n\n",
            false
        );

        this.outputText(
            "Letting your eyes play over the demon's exotic, sculpted skin, you can't help but be tempted by her offer... Ceraph sees you mulling it over and produces a collar as she purrs, \"<i>No pressure... " +
                this.player.mf("Master", "Mistress") +
                ".  You could always just take me here like usual, and perhaps, the next time you'll stop being so lucky...</i>\"\n\n",
            false
        );
    ...
    private collarCeraph(): void {
        ...
        this.spriteSelect(7);
        this.outputText(
            "You reach down and snatch the collar from Ceraph's shaking hand.  Turning it over in your grip, you get a feel for the soft, supple leather.  Blood-red studs poke out around the black strap's surface, vaguely reminding you of a dog's collar, though with the aggression cranked up to max.  The snap mechanism looks simple enough to connect, but you can't see any way to release the latch.  It makes sense that Ceraph would have one-way collars; slaves shouldn't be able to remove the symbol of their station.\n\n",
            false
        );

        this.outputText(
            "Leaning over, you slide the collar around your new slave's suddenly flush neck, feeling her heart hammering away just beneath the skin.  Snapping it closed, you muse ",
            false
        );
        if (this.player.cor < 33)
            this.outputText(
                "that you never expected making a demon into your slave would factor into your quest.  On one hand it seems wrong, but... she's a demon.  The fewer you have opposing you, the easier it will be to end their threat completely.",
                false
            );
        else if (this.player.cor < 66)
            this.outputText(
                "that taking a demon as a slave would've been abhorrent to you when you started this journey.  Now, it's just a means to a very pleasurable end.",
                false
            );
        else {
            this.outputText(
                "on how much you'll enjoy using the former dom as your personal ",
                false
            );
        ...
        this.outputText(
            "  Ceraph pulls herself up to her knees and kisses your " +
                this.player.feet() +
                ", a show of absolute submission and obedience.\n\n",
            false
        );

        this.outputText(
            'The defeated demon explains, "<i>Though I am now and forever your slut, your slave, your bitch... those in my harem cannot be abandoned.  I am sad to say I cannot live with you, ' +
                this.player.mf("Master", "Mistress") +
                ".</i>\"  She sees the look forming in your eyes and hastily adds, \"<i>Oh, I'll still be at your beck and call, but if I can't make it, I'll be sure to send you one of my pets.  Just rub this charm whenever you want my services, " +
                this.player.mf("Master", "Mistress") +
                ", and I'll be there.</i>\"  Ceraph holds out a tiny onyx bar tipped with rubies.  The gems shine and glitter with their own inner light, while the black shaft seems to drink in everything around it, leaving behind darkness.\n\n",
            false
        );

        this.outputText(
            "Well, with a harem as large as hers, it makes sense that she'd have to keep them in her lair and tend to them.  There's no way you could foster the people in your camp, and besides, since their Mistress is your slave, they're <b>now yours by extension, as well</b>.  Ceraph reaches down to ",
            false
        );
        if (this.monster.lust > 99) this.outputText("resume stroking", false);
        else this.outputText("stroke", false);
        this.outputText(
            ' her nodule-studded demon-dick with her free hand.  She whimpers, "<i>Would my ' +
                this.player.mf("Master", "Mistress") +
                " prefer to carry " +
                this.player.mf("his", "her") +
                " slave's token, or wear it as a belly-button piercing?</i>\"\n\n",
            false
        );
    ...
    private carryCarephsToken(): void {
        ...
        this.spriteSelect(7);
        this.outputText(
            "You inform your living property that you've heard quite enough about her piercings and snatch the token from her hand.  Ceraph's eyes go wide and she nods, more than a little fearfully.  Seeing the Omnibus so cowed brings a smile to your face.\n\n",
            false
        );

        this.outputText(
            'Ceraph asks, "<i>So, before my ' +
                this.player.mf("Master", "Mistress") +
                ' leaves, would you like to fuck your new slut one of the old ways, one last time?</i>"\n\n',
            false
        );
    ...
    private getCeraphFollowerPiercing(): void {
        ...
        this.outputText(
            "  Ceraph shimmies forward and holds the oily stud against your midriff, pressing it into you with her palm.  There's a moment of tingling warmth, followed by an ache of unholy numbness.  When the demoness removes her hand, your belly-button is studded with the magical jewelry, glowing and not at the same time.\n\n",
            false
        );

        this.outputText(
            "There's no lingering compulsion, no mental assault, just a new piercing.  You're kind of awestruck by the gesture - even though she seemed sincere, a small part of you still believed the fetish-obsessed demon was using this whole thing as a setup to trick you.\n\n",
            false
        );
    ...
    private cawkTawgle(): void {
        ...
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0) {
            ...
            this.outputText(
                'She lets out a low hum, then suddenly arches her back as her hand sinks in an inch.  "<i>O-oh-oh!</i>" she moans, pulling it away with a small string of pre-cum tying it to her now-bulgeless panties.  Absently she licks the fluid from her fingers and asks, "<i>Was there anything else, my ' +
                    this.player.mf("Master", "Mistress") +
                    '?</i>"\n\n',
                false
            );
            ...
            this.outputText(
                "You tell Ceraph that you want her to have her demonic cock on display when around you.  She nods, breaking into an eager smile, and slips a hand into the front of her latex panties.  The veneer of rapt concentration on her face is only dispelled when you glance down at her crotch and notice her vigorously fingering her clitoris under the fabric, bowing out the surface as she flexes and caresses.\n\n",
                false
            );

            this.outputText(
                "A low moan gathers in intensity as Ceraph strokes, and then abruptly she jerks her hips forward as a bulge emerges between her fingertips and travels up the front of her undergarment.  It overreaches the panty line and the purple glans peeks out, smeared and dribbling with copious pre-cum.  She strokes the shaft almost automatically, as she addresses her next hopeful question to you.  \"<i>Was there anything <b>else</b> you'd like to do, " +
                    this.player.mf("Master", "Mistress") +
    ...
    private CeraphHandsOutNewFetishesLikePervCandy(): void {
        ...
        if (this.flags[kFLAGS.PC_FETISH] == 0) {
            ...
            if (this.player.earsPierced == 0)
                this.outputText(
                    "pulls a pair of gleaming, green piercings from a pouch.  \"<i>Oh, don't worry " +
                        this.player.mf("Master", "Mistress") +
                        "; you're going to love this so much.  These piercings are special, and they'll give you exactly what you want.</i>\"",
                    false
                );
            else
                this.outputText(
                    "places her hands upon your pierced ears.  She whispers softly, \"<i>Don't worry " +
                        this.player.mf("Master", "Mistress") +
                        ", I can easily use the piercings you already have.  It won't hurt.</i>\"",
                    false
                );
            this.outputText("\n\n", false);
            // (NOT PIERCED)
            ...
            this.outputText(
                " as the new thoughts and desires settle themselves inside you.  She gives you a gentle pat and explains, \"<i>It's ok " +
                    this.player.mf("Master", "Mistress") +
                    "; you're an exhibitionist now.  Would you like your piercing slave to give you even more?</i>\"\n\n",
                false
            );
        ...
        // *Fetish level = 1
            ...
            if (this.player.nipplesPierced == 0) {
                this.outputText(
                    "She's all too happy to build up the suspense as she pulls out a pair of shining black studs, \"<i>Oh, do you know what these are going to do?  Well, how about I slide them into your ",
                    false
                );
                ...
                this.outputText(
                    " nipples, and you tell me all about your fetishes and which one makes you the hottest.  Oh, you'll love it " +
                        this.player.mf("Master", "Mistress") +
                        '!</i>"\n\n',
                    false
                );
            ...
            if (this.player.nipplesPierced > 0)
                this.outputText(
                    "your " +
                        ...
                        "s, circling her fingers all around the fleshy nubs.  Goosebumps run over your body in a wave, accompanied by a similar chill and a pressure behind your temples.  You shudder, but it quickly fades.",
                    false
                );
            else
                this.outputText(
                    "aligning the business ends of the piercings with your sensitive nipple-flesh.  Your right " +
                        this.nippleDescript(0) +
                        " is pierced in one smooth motion, nearly making you scream in pain.  As she fastens it on, you feel goosebumps spread over your body in a wave.  The second piercing doesn't seem to hurt as bad, but the sensation of spreading goosebumps is far more noticeable.",
                    false
                );
            this.outputText(
                "  Your eyes dart around, curious what fetish your demonic slave has given you this time.\n\n",
                false
            );

            this.outputText(
                "Ceraph smiles down at you and whimpers, \"<i>I hope you're pleased with the new fetish " +
                    this.player.mf("Master", "Mistress") +
                    '.  Just think about how similar being paralyzed is to being tied down and tell me if you like it.</i>"\n\n',
                false
            );

            this.outputText(
                "Your body goes beet-red as it suddenly tries to struggle against the invisible binding of her magic.  It... it feels good!  You nearly cry out with lust as the restraint turns you on more and more.  Ceraph's magic has given you a fetish for being tied up!  You nearly faint when you think of all the strange things in this land that might try to restrain you, and you know you have no hope of resisting if they ever catch you.  <b>Though somehow you think you might enjoy being a bondage fetishist...</b>",
                false
            );
            this.dynStats("lus", 25, "cor", 1);
            if (this.player.nipplesPierced == 0) {
        ...
        // *Fetish level = 2
            ...
            this.outputText(
                "The idea of facing the denizens of this land without even so much as the ability to throw a punch turns you on immensely, and you pant and gasp as ",
                false
            );
            ...
            if (this.player.totalCocks() > 0) {
                ...
                if (this.player.cocks[0].pierced > 0)
                    this.outputText(
                        ", the old piercing clattering to the ground as it slides out, ",
                        false
                    );
                this.outputText(
                    " and snaps the diamond stud through your sensitive flesh, making your vision haze red in pain.\n\n",
                    false
                );
            ...
            // [else]
                ...
                if (this.player.eyebrowPierced > 0)
                    this.outputText(
                        " and discarding your old jewelry like a piece of garbage",
                        false
                    );
                this.outputText(
            ...
            this.outputText(
                "You rub a hand through the demon's pitch-black hair and let her know that it's exactly what you asked for.\n\n",
                false
            );

            this.outputText(
                "Ceraph gives an excited squeak and holds herself still, allowing you to pet her.  Once you stop, she gives a disappointed sigh, but holds her position.",
                false
            );
    ...
    private unfetishifyYourselfWithFollowerCeraph(): void {
        ...
        this.spriteSelect(87);
        this.outputText(
            'You ask Ceraph to remove one of the fetishes she generously donated earlier.  She sighs and nods, saying, "<i>' +
                this.player.mf("Master", "Mistress") +
                ", are you sure? It isn't that easy to do, and I love knowing my owner is aroused by my piercings!</i>\"\n\n",
            false
        );
        this.outputText(
            'Growling in irritation, you tell her, "<i>Yes, I would like a fetish removed.</i>"\n\n',
            false
        );
        this.outputText(
            'The demoness slumps her shoulders and nods.  She explains, "<i>I have to do them in the reverse order that I added them... just hold still, okay?</i>"\n\n',
            false
        );
    ...
    private goThroughWithCeraphUnfetishification(): void {
        ...
        this.spriteSelect(87);
        this.outputText(
            'Ceraph steps closer, her shining outfit squeaking from the movement.  Her hands gently touch your forehead, though she tries to avoid meeting your gaze.  The submissive slut keeps her eyes downcast, as is proper for a slave, and she begins to rub at your temples, working her magic to undo her mischief.  Warmth surges out, rushing through your temples and leaving a slack looseness in its wake.  Ceraph grunts and lets go, staggering back and panting.  She mumbles, "<i>So much harder... to take those without changing... something else.</i>"\n\n',
            false
        );
        this.outputText(
            'After a few moments, she seems to recover, and she asks, "<i>Was there something else you needed me here for, ' +
                this.player.mf("Master", "Mistress") +
                ', or did you just want to waste my time?</i>"\n\n',
            false
        );

        if (this.player.cor < 33)
            this.outputText(
                "It seems there's still a spark of Ceraph's fire under all her submission.",
                false
            );
        else if (this.player.cor < 66)
            this.outputText(
                "You sigh and wonder if you should punish her for giving you such lip.",
                false
            );
    ...
    private fuckFollowerCeraphsVagoo(): void {
        let x: number = this.player.cockThatFits(115);
        if (x < 0) x = 0;
        const y: number = this.player.cockThatFits2(115);
        this.outputText("", true);
        this.spriteSelect(87);
        ...
        this.outputText(
            "You let Ceraph know that you'll be using her pussy.  She sighs and says, \"<i>Yes, " +
                this.player.mf("Master", "Mistress") +
                ',</i>" unable to hide the disappointment in her tone.  Ceraph shifts, the panties of her outfit fading away to reveal her dripping cunny',
            false
        );
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
        ...
        if (this.player.cor < 33)
            this.outputText(
                'She gets down on all fours, then lays her cheek in the dirt.  Her arms cross behind her back, suddenly bound there by the abrupt appearance of those same panties, tied in a knot.  Supported by only her knees, her tits, shoulders, and her face, she asks, "<i>Grab me and fuck me ' +
                    this.player.mf("Master", "Mistress") +
                    ", please grind your slave's face in the dirt!</i>\"\n\n",
                false
            );
        else if (this.player.cor < 66)
            this.outputText(
                'She gets down on all fours, then lays her cheek in the dirt.  Her arms cross behind her back, and you pin them there for her, smiling as her panties appear as if by magic, tied in a binding knot around her wrists.  With only her knees and upper body supporting her, Ceraph begs, "<i>Be rough with me.</i>"\n\n',
                false
            );
        else {
            this.outputText(
                "You push her onto all fours, then grab her arms and fold them behind her back, grinding her face into the dirt.  The demoness groans, her pussy dripping ",
                false
            );
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText("and her dick releasing a squirt of pre-cum ", false);
            this.outputText(
                'as she gets more turned on by the rough, sexual play.  Suddenly, as if by magic, her panties appear around her wrists, and you tie them tightly to bind her securely.  With only her knees and upper body supporting her, Ceraph begs, "<i>Be rough with me.</i>"\n\n',
                false
            );
        }
        ...
        if (this.player.cor < 33)
            this.outputText(
                "Well, that wasn't quite what you would have thought of doing, but you've got a good idea what she wants, and you may as well go along with it.  The idea of taking her in such a rough, hard way stirs something primal within you, and you have an easy time slipping into a meaner, rougher persona.",
                false
            );
        else if (this.player.cor < 66)
            this.outputText(
                "Well, with a request like that, you'll have no problem fucking her rough and hard.  The situation evokes something primal within you, and the inviting delta between Ceraph's thighs practically beckons you to ravage it.",
                false
            );
        else
            this.outputText(
                "With an invitation like that, there's no way you'll decline.  Looking over her, a predatory thrill runs through you, urging you to utterly violate her.",
                false
            );
        this.outputText("  You grab Ceraph's thighs", false);
        if (this.player.str < 60)
            this.outputText(
                " and heave, lifting her up off the ground and forcing her to straddle you.",
                false
            );
        else this.outputText(" and easily lift her, forcing her to straddle you.", false);
        this.outputText(
            "  Dragging the demon back, you bring her slutty, sodden puss up to your " +
                this.cockDescript(x),
            false
        );
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outputText(
                ", ignoring the rope of dangling pre-cum that hangs from her bumpy prick.",
                false
            );
        else
            this.outputText(
                ", feeling the heat washing off her mons and onto your " +
                    this.player.cockHead(x) +
                    ".",
                false
            );
        this.outputText(
            "  Yanking back, you bury all " +
                CeraphFollowerScene.num2Text(Math.round(this.player.cocks[x].cockLength)) +
                " inches of your " +
                this.cockDescript(x) +
                " into Ceraph's unholy, warm snatch, ",
            false
        );
        if (this.player.cockArea(x) > 150)
            this.outputText(
                "distorting her body around the sheer bulk of your massive member.\n\n",
                false
            );
        else this.outputText("immersing yourself in the decadent wetness.\n\n", false);

        this.outputText(
            "For a moment, the two of you simply stay like that: you buried to the hilt and her moaning in the dirt.  Ceraph's arms are flexing against her bondage as if she could rip through the latex panties by sheer force; though she could free herself by magic, she's chosen to struggle in futility.  Perhaps she accepts her bondage as a true submissive slut should?  Deciding it's time to reward her, you squeeze her thighs again and languidly withdraw, gazing at the marvelous wetness now soaking your tool.  The demoness whimpers at the emptiness, her voice carrying only simpering, anguished desire.  Lazily, you slide back, gently rocking her body when your crotches clasp together, twisting Ceraph's face.\n\n",
            false
        );

        this.outputText(
            'Your slut moans, "<i>Ohhhh, yesssssss,</i>" while you slide home, culminating in an inarticulate gurgle.  Heavy drops of drool hang from her lips, turning the earth below into a thin layer of viscous mud for your pet to pillow her head in while you rail her.  Starting slow, you gently work your whore\'s pussy over, gleefully watching her girlish lube drip from the puffy, purple lips of her sex.  ',
            false
        );
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outputText(
                "Her cock dangles towards the ground, dripping thick ropes of pre-spunk as readily as her pussy.  ",
                false
            );
        this.outputText(
            "Somehow, she feels as tight around your " +
                this.cockDescript(x) +
                " as any virgin and three times as wet.  The gentle claps of genital against genital send ripples through Ceraph, smearing her cheek in the growing mud-puddle while her tits wobble dangerously inside the sheer latex bra.\n\n",
            false
        );
        ...
        if (y >= 0) {
            this.outputText(
                "A wicked idea crosses your mind, and you reach down to grab your " +
                    this.cockDescript(y) +
                    ", aiming it at the flexing asshole just above the slave's squelching snatch.  Your next thrust plows it deep into Ceraph's anus, thankfully lubricated by the demon's constant squirting.  Growling at the mounting, doubling pleasure, you resume your tempo and slam both your cocks hilt-deep in Ceraph.  ",
                false
            );
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText(
                    "She squeals and sprays a thick rope of jizz from her bloated cock.  It seems a little prostate pressure was all it took to put her maleness over the edge.  ",
                    false
                );
            this.outputText(
                "Your slave's reaction is to wiggle her backside at you and curl her tail about your waist, trying to pull you even further into her body.  Delirious and high on pleasure, you " +
                    this.player.mf("chuckle", "giggle") +
                    " and pound away, heedless of anything but your own pending climax.",
                false
            );
            if (this.player.cockTotal() >= 3) {
                ...
                if (this.player.cockTotal() > 3)
                    this.outputText(
                        "es have nothing to do but slide across her cheeks, dripping pre-cum all over her smooth skin.",
                        false
                    );
                else
                    this.outputText(
                        " has nothing to do but slide across her cheeks, dripping pre-cum all over her smooth skin.",
                        false
                    );
            }
            this.outputText("\n\n", false);
        ...
        if (y >= 0) this.outputText("s", false);
        this.outputText(
            ' with sloppy spooge.  Ceraph screams, "<i>Yes!  Yes!  Fuck me!  Fill me!  Use me ' +
                this.player.mf("Master", "Mistress") +
                '!  Pump me full of cum while you grind my whorish face in the dirt!</i>"  Her voice goes ragged, high pitched and screaming',
            false
        );
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outputText(", and her cock starts pumping more demonic spunk into the mud", false);
        this.outputText(
            ".  It trails off, though her pussy continues teasing your " +
                this.cockDescript(x) +
                ", wringing the last of your seed from your " +
        ...
        this.outputText(
            '"<i>Thank you... you\'re such a good dom for a horny bitch like me.</i>"\n\n',
            false
        );

        this.outputText(
            "You smirk and drop her into her own muddy cum-puddle, then help her up to her feet.  She's filthy, debased, and dripping ropes of your goo.  Ceraph gives you a kiss on your ",
            false
        );
        ...
        this.outputText(
            "Nodding, you give her ass a slap and send her off, noting Ceraph has freed her hands at some point and returned them to their normal position.  She hasn't done anything about the sexual filth coating her body, but knowing her, she probably doesn't want to.",
            false
        );
        this.player.orgasm();
    ...
    private followerCeraphTongueFucking(): void {
        ...
        this.outputText(
            "Desirous of being pleasured by your demonic slave, you spread out your " +
                this.player.legs() +
                " to allow easy access to your " +
                this.vaginaDescript(),
            false
        );
        ...
        this.outputText(
            "Ceraph nods, the barest hint of a twinkle in her eyes as she drops down to her knees in order to examine your vulva.  She meekly kisses your slit, planting her wet lips against your " +
                this.vaginaDescript() +
        ...
        this.outputText(
            " clit, and stops over your sensitive pubic skin.  Then, her tongue begins to extend from her mouth, hanging further and further down as if it were unspooling from a hidden reel in her throat.  Ceraph doesn't stop letting out more of the slippery organ until she's got three feet of tongue dangling between her tits.  Just looking at it there, undulating below your mons, makes you wet.\n\n",
            false
        );

        this.outputText(
            "With a sharp intake of breath, she reels in the prodigious proboscis, shortening it down to a more usable ten or eleven inches.  Starting between her parted lips, the tongue thickens, becoming cylindrical in shape and widening until you're sure it's at least two inches across.  Veins pulsate and texture the demon's tongue as it fills, giving it a decidedly... phallic appearance.  The transformation finishes, capping Ceraph's cock-like tongue with a rounded, penile cap that completes the illusion.\n\n",
            false
        );

        this.outputText(
            "The tainted slut winks and licks at you with the crown, coating it in moist, feminine wetness, letting you feel the warmth of her tongue-cock upon your flesh.  It feels wonderful, like being licked by a thick, flexible prick that's been slathered in saliva.  Slowly, agonizingly slowly, it works its way into your passage, pushing past your engorged outer lips to snuggle into your ",
            false
        );
        ...
        this.outputText(
            " canal.  She twists her flexible mouth-dick inside you, making sure to rub over your g-spot, and then she slides another few inches in, forcing what feels like half of it inside you.\n\n",
            false
        );

        this.outputText(
            "Now breathing heavily, your " +
                this.hipDescript() +
                " begin trembling, aching to mount the invading member, fuck it, mate with it; anything to sate your growing desires.  Ceraph gives you a knowing wink and sidles forward, sliding the last several inches through your spread nether-lips into the velvety embrace of your " +
                this.vaginaDescript() +
        ...
        this.outputText(
            "A jolt of pleasure blasts the image from your mind and nearly takes your " +
                this.player.legs() +
                " out from under you.  With a start, you realize Ceraph has opened her lips wide enough to slurp your " +
                this.clitDescript() +
                " into her mouth, and somehow, she's produced a second tongue to service it.  With the stimulation of a tentacular tongue constantly hitting your g-spot and a second oral organ ",
            false
        );
        ...
        this.outputText(
            " at your " +
                this.clitDescript() +
                ", you start to shudder, trying to stave off what you know is coming.  You don't want Ceraph to get too uppity, thinking she can get you off this fast, but you're dangerously close, and her pumping, teasing mouth-cock is relentless.\n\n",
            false
        );

        this.outputText(
            "You grab Ceraph's head and mash it against your sodden, constricting box, as you command, \"<i>Drink my cum, bitch.  Swallow all of your Mistress' slick leavings.  And don't think for a minute I won't punish you if you miss any.</i>\"\n\n",
            false
        );

        this.outputText(
            "Ceraph closes her eyes and hums, her twin tongues redoubling their efforts inside you.  Every nerve ending inside your climaxing quim seems to explode at once, and with your back arched, you cum on your slave's face.  Ceraph gurgles in happiness, her voice muffled by the plush, feminine flesh quivering over her face.  She happily swallows every ounce of fluid you produce",
            false
        );
        if (this.player.wetness() >= 5)
            this.outputText(
                ", even though her cheeks are bulging and her throat struggles to devour all of the fountaining girl-spunk.",
                false
            );
        else if (this.player.wetness() >= 4)
            this.outputText(
                ", even though her cheeks are slightly bulged and she's gulping it down.",
                false
            );
            ...
            this.outputText(
                ", even though your pussy doesn't gush like most of the corrupted creatures in this realm.",
                false
            );
        this.outputText(
            "  Still shaking and clenching, you start to come down, still holding Ceraph in her proper place.  She doesn't show any sign of discomfort, and as a matter of fact, once you deign to look down at her, her eyes are twinkling happily and her face is flushed.  ",
            false
        );
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00289] == 0)
            this.outputText(
                'Did she... get off with her tongue?\n\nSeeing the confusion on your face, Ceraph releases your spit-slathered genitals, her tongue returns to normal, and she says, "<i>Mmm, of course, dear.  If only men knew what they were missing... tasting a woman\'s pussy while it climaxes on your cock is divine.</i>"\n\n',
                false
            );
        else
            this.outputText(
                "Shuddering, Ceraph returns her tongue to normal and slides it out of your tender quim with a knowing smile.\n\n\"<i>I'll never get tired of that, " +
                    this.player.mf("Master", "Mistress") +
                    ',</i>" she quips.\n\n',
                false
            );
        ...
        this.outputText(
            "You pull her back to your " +
                this.vaginaDescript() +
                " to lick the last of your lady-spunk from your nethers, then send her on her way with a smile on your face.  Your expression widens when you see Ceraph stagger, still a bit shaky from her own orgasm.",
            false
        );
    ...
    private ceraphTentacleGrape(): void {
        ...
        this.outputText(
            "You tear off your " +
                this.player.armorName +
                ' and instruct Ceraph, "<i>Please me.  All of me.</i>"  To her credit, Ceraph only spends a moment eyeing you before she springs into action.  Her panties vanish into shreds of flying latex, utterly demolished by the sudden growth of a pair of purple, undulating tendrils, each tipped with a swollen cockhead.  Squeezing up behind them is a third, slower tentacle.  Unlike its brothers, this one is capped with a sucking orifice, drooling clear slime and ringed by nub-like nodules, peeking out from folds of skin that remind you of clitoral hoods.',
            false
        );
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outputText(
                "  You can vaguely see Ceraph's hard, demonic-dick underneath all the waving tentacles.  She must have taken your command to keep her dick out for your use quite literally, even though there's little chance you'll get to put it anywhere.",
                false
            );
        this.outputText("\n\n", false);

        this.outputText(
            "The two amethyst cocks wind their way over your " +
                this.player.legs() +
                " and lift you into the air with unholy strength, dangling you upside down while they crawl over your body, the smooth skin rubbing and stroking at your " +
                this.player.skinFurScales() +
                ".  They curl up and slide through your hands, allowing you to feel the inhuman warmth of Ceraph's passion.  Smiling, you indulge your slave, marvelling at the incredible degree of control she has over her shape-shifting.  Ceraph slides the two phallic tendrils between your loins and butt-cheeks, threading one in from the front and the other from the back.  They grind on your " +
                this.vaginaDescript() +
                " and " +
        ...
        this.outputText(
            "A warm, sucking orifice aligns itself with your " +
                this.multiCockDescriptLight() +
                ", making obscene squelching noises as it dilates to take ",
            false
        );
        ...
        this.outputText(
            ".  You arch your back in pleasure, trying to push even more of your tingling cock-flesh into the tentacle-pussy.  The interior is FLOODED with lube, so much that it leaks from the clit-ringed seal at your ",
            false
        );
        if (this.player.hasSheath()) this.outputText("sheath", false);
        else this.outputText("base", false);
        this.outputText(
            ".  Even better, there are what feels like thousands of wriggling cilia squirming in the syrupy tunnel, each of them caressing and licking at " +
                this.sMultiCockDesc() +
                " repeatedly.  Like thousands of hungry tongues, they seem to set off every nerve in your " +
                this.multiCockDescriptLight() +
                ", nearly making you forget the rhythmic, pulsating suction of the tendril as it fellates you.\n\n",
            false
        );

        this.outputText(
            "You get so distracted by this that you forget your " +
                this.vaginaDescript() +
        ...
        this.outputText(
            "You smile and nod, licking your lips as the tentacles bring you lower and closer, still fucking you.  Ceraph latches onto your lips, her tongue making love to your mouth while you hang, suspended in her tendrils' grip.  Spit-slathered mouths press together harder, and you french-kiss your demonic slave as passionately as you can, trying to do to her mouth what her cocks are doing to your " +
                this.vaginaDescript() +
                " and " +
                this.assholeDescript() +
        ...
        if (
            this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0 &&
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00290] == 0
        ) {
            this.outputText(
                "Suddenly pulling you back, Ceraph lowers you down further, spearing her pulsating, pre-cum soaked prick into your throat.  You gurgle from the sudden intrusion and the slippery, sweet cream she's leaking.  She might need a punishment later, but for now, there's nothing to do but suck.  You slurp and lick, the motions coming easy to you thanks to the silken caresses of the sloppy cunt-tentacle's cilia around your own " +
                    this.multiCockDescriptLight() +
                    ".  Her nodules bulge out in your mouth, rippling in wave-like motions from her base up to the fat cock-tip, signalling that her orgasm is at hand.  The thick, textured cock explodes, pouring Ceraph's load straight into your mouth.  At the same time, the dick-tentacles in your pussy and ass release their own seed, stuffing your womb and rectal cavity so full of cum that you're left with a bit of extra pudge in your belly.  You swallow and gulp, trying to keep up with the demon's hot, spouting jizz.  After a moment, Ceraph's control loosens, and you're pulled up into the air, temporarily freeing your mouth.\n\n",
                false
            );
        } else
            this.outputText(
                "Suddenly pulling you away, Ceraph throws her head back and moans.  You can feel the tentacles piston faster, and through your haze of arousal, you realize she's about to orgasm.  The warning does little to prepare you for what's coming, and as one, the twin tentacles blast cum deep into your nethers and asshole, stuffing both body cavities full of potent demon-sperm.  It's warm - hot even - and your innards tingle and soak in the corruptive spooge while they continue to pump more inside.  After a few spurts, you feel absolutely stuffed and even have a bit of extra pudge on your belly from the hefty fluid-filling.\n\n",
                false
            );

        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outputText(
                "Ceraph's cock sprays cum all over her belly as her climax winds on, her poor, ignored prick blasting seed with reckless abandon.\n\n",
                false
            );

        this.outputText(
            "Your body seizes up and explodes with pleasure, spraying sexual fluids into and over Ceraph's new additions.  The cunt-tentacle ",
            false
        );
        ...
        this.outputText(
            " down your cum as it erupts from your " +
                this.multiCockDescriptLight() +
                ".  As it swallows every drop, you hazily wonder what she'll do with it all, but then the still-fucking tentacles move faster, spraying their cum out from your too-packed orifices to rain over both of you.  Your " +
                this.vaginaDescript() +
                " and " +
                this.assholeDescript() +
                " flutter and contract, involuntarily squeezing the purple-skinned invaders for even greater levels of sensations.  It's too much and too hard.  You black out with a moan of satiated pleasure.\n\n",
            false
        );

        this.outputText(
            "You come to in a puddle of cum, both yours and Ceraph's.  The demoness is sitting down across from you, her appearance returned to normal.  She brightens when she wakes and kneels, saying, \"<i>Thank you for allowing me to serve you so... completely, " +
                this.player.mf("Master", "Mistress") +
                '.  It was... thrilling.</i>"\n\n',
            false
        );
    ...
    public catgirlEncounter(): void {
        ...
        if (
            ...
            this.player.spe / 5 + CeraphFollowerScene.rand(20) < 22
        )
            this.outputText(
                "flies into you, knocking you to the ground.  After a moment, you find yourself faced with a pair of overeager cat-morphs grinning down at you.",
                false
            );
        else
            this.outputText(
                "just barely misses you and crashes into the ground behind you.  After a moment, two bodies disentangle themselves from the impact site.  Once they stand up, you can see that a pair of overeager cat morphs have arrived in your camp.",
                false
            );
        this.outputText("\n\n", false);
        ...
        this.outputText(
            'As a chorus, the two start to speak.  "<i>Mistress Ceraph couldn\'t come, so she has sent us to help you with your needs; the sisters are here for your pleasure.</i>"  The choice is yours; do you play with these furry, eager, cat-faced girls, or send them away?\n\n',
            false
        );
    ...
    private fuckCeraphsCatgirls(): void {
        ...
        this.outputText(
            "You smile at them and say that you'd be happy to have them for your pleasure; their horns suggest that they'll be quite a trip.  The two purr happily and instruct you to lie on your back to start the fun.  You relax as directed and the cat slaves unfasten your " +
                this.player.armorName +
                " from your body.  As they work, they make sure to gently stroke every inch of your newly exposed flesh with their soft furry hands as it's revealed; all the while moving closer and closer to your most personal parts.  When " +
                this.oMultiCockDesc() +
                " finally tastes the air, it gets even more attention.\n\n",
            false
        );
        ...
        this.outputText(
            "You can't help but put your hands to their heads and start rubbing and scratching them behind their ears.  Suddenly, one of them steps back as the other moves down in front of your " +
                this.cockDescript(x) +
                " and pulls it inside her breasts.  In response, both your hands end up on her head, forcing it down onto your cock, and you feel your manhood start to vibrate as the catgirl begins to purr.  You cry out in pleasure at your shaft being massaged by soft-furred breastflesh while she hums into the tip.\n\n",
            false
        );
        ...
        this.outputText(
            "The other sister has been looking for something else to rub herself on, and she seems to have decided on your " +
                this.chestDesc() +
                ".  While your lower half is being covered by one cat (which is fine too), the other moves to your top half and drapes her breasts over your head while she gropes and plays with your " +
                this.nippleDescript(0) +
                "s.",
            false
        );
        if (this.player.biggestLactation() > 1)
            this.outputText(
                "  When some of your milk seeps out, she leans forward and latches onto a nipple eagerly, alternating between sucking on the tip and licking the drops off of it.",
                false
            );
        else {
            this.outputText(
                "  She seems to delight in playing with her chest, modest though it may be, pushing it into your face and tweaking the fuzzy nipples just past your nose.  You blow a raspberry and shake your face into her cleavage, ",
                false
            );
            if (CeraphFollowerScene.rand(5) == 0)
                this.outputText(
                    " but some of the fur tickles your nose a bit <i>too</i> deeply; you deliver a sudden sneeze into her bosom, causing it to heave and jiggle.",
                    false
                );
            else this.outputText("vibrating it wildly back and forth.", false);
        }
        this.outputText(
            "  Her sister, watching all this, shakes with muffled laughter delivered directly into your cockhead, sending rough jolts of sensation down the shaft and forcing out a drop of pre-cum.\n\n",
            false
        );

        this.outputText(
            "The cat lying on your face sits up as her sister's eyes glimmer desirously upon tasting the drop; apparently she has recognized the expression, because she looks down at you and says, \"<i>Please, don't give all your rich, tasty cream to my sister.  She always steals my fair share, the bad kitty!</i>\"  Her meaning is obvious in context, moreso when she moves around to your groin, trying to shoulder her sibling aside and ",
            false
        );
        if (this.player.cockTotal() == 1)
            this.outputText(
                "sliding her hand between the furry tits, down the base of your " +
                    this.cockDescript(x) +
                    ".",
                false
            );
            ...
            this.outputText(
                "grabbing the lonely, neglected dickflesh left outside the warm embrace of her sister's breasts and shoving them into her own while caressing the tip with her tongue.",
                false
            );
        this.outputText("\n\n", false);

        this.outputText(
            "Thanks to all the stimulation from before, their expert tongues almost immediately bring your body to a shuddering orgasm, and " +
                this.sMultiCockDesc() +
                " ",
            false
        );
        if (this.player.cumQ() >= 1000)
            this.outputText(
                "unleashes a torrent of ejaculate, coating the two girls liberally; each yowls in happiness, slurping at the nearby cock-head and swallowing mightily.",
                false
            );
        else if (this.player.cumQ() >= 300)
            this.outputText(
                "lets out a generous load of 'cream' which each girl sloppily gulps down, lapping at the jism and its source roughly.",
                false
            );
        else
            this.outputText(
                "squeezes out a few immodest squirts of semen, which the girls push and fight over, each vying to be the one to gulp down the next stroke.",
                false
            );
        this.outputText("\n\n", false);

        this.outputText(
            "You relax on your back, spent from the treatment and the orgasm; the kitty twins",
            false
        );
        if (this.player.cumQ() >= 1000)
            this.outputText(
                " clean the remnants off of their fur eagerly, mollified by the sheer amount into actually helping lick each other clean with their tongues, and",
                false
            );
        this.outputText(
            " thank you for the 'cream'.  You nod weakly and they jump to their feet and swish their tails at you, then depart.\n\n",
            false
        );
    ...
    private ceraphUrtaRoleplay(): void {
        ...
        this.outputText(
            '"<i>Roleplay? My ' +
                this.player.mf("Master", "Mistress") +
                " is wonderfully exploitative with " +
                this.player.mf("his", "her") +
                " pet's lewd body,</i>\" Ceraph purrs, lips curling into a sly smile. Holding your arms at your sides, you nod at the subjugated demon, indicating that she should strip you. Keeping her eyes averted, she obediently complies, removing your " +
                this.player.armorName +
                ' piece by piece until you stand nude, in all your splendor. Turning upon her, you issue your curt command, briefly describing the form that she is to take. Surprisingly, she knows exactly who you\'re talking about. "<i>Ah, the fox-bitch,</i>" she muses, eyes flashing solid black again for a moment. "<i>She\'s been such a thorn in my side for so long... letting you defile her will be a particularly intense pleasure, ' +
                this.player.mf("Master", "Mistress") +
                '.</i>"\n\n',
            false
        );
        ...
        this.outputText(
            '"<i>Oh! ' +
                this.player.short +
                "! I, um, didn't expect to find you here! This... this isn't what it looks like,</i>\" she apologizes, flushing deeply, nervous shame sending humiliated shivers through her shoulders. She longingly eyes the bottle in her hand and, without lifting her head, raises her eyes to yours, silently asking what she should do.",
            false
        );
    ...
    private ceraphUrtaRoleplayDrunk2(): void {
        ...
        this.outputText(
            '"<i>Oh damnit, damnit, damnit,</i>" Utra chants as she presses her erection against your drooling slit, the equine inches slipping along the sweat-oiled plumpness of your thighs. Inching forward, she presses the flared tip of her head against your tender lips, the distended flesh struggling against the tightness of your snatch, lubricated depths unwillingly parting bit by bit until finally, the bulbous cockhead slips into you, your cunt tightening down around it, firmly locking the guard captain inside you. "<i>Ah! Ffffffuck!</i>" she curses.  "<i>How are you always so tight?</i>" she groans, happily. Unable to restrain herself, she begins bucking in place, sliding the first three inches of her throbbing member back and forth inside you, savoring the ripples her rocking motion sends through your ' +
                this.buttDescript() +
                ", your hypnotic hips mesmerizing the girl riding you. Raising an amber hand, she cracks an open palm against your tender ass as she drives another two inches inside you, your gut lurching with the force. You try to ",
            false
        );
        ...
        this.outputText(
            ' to make the penetration easier, but the vixen has your lower body firmly trapped between her knees, keeping your hips as tightly clenched as possible, heart-shaped rump throbbing at the fleshy weight within you. "<i>Don\'t you love the long arm of the law?</i>" she snickers, hiccupping  as she gives you another swat across your ' +
                this.player.skin() +
                ", this time plunging half her length into your " +
                this.vaginaDescript() +
        ...
        this.outputText(
            "Pounding you faster and faster, you can feel her cock swelling within you dangerously. Rutting frantically, she leans down, pressing her smooth sienna skin against your jizz-soaked back, her tits rubbing the fox-girl's spunk into your " +
                this.player.skin() +
                '. Lowering her head, she whispers into your ear, "<i>No condoms for sneaky bitches who spike drinks,</i>" her husky voice right on the edge.  "<i>Fur isn\'t the only thing I\'ve lost. I\'m potent again,</i>" she drunkenly insists. "<i>I can feel it in my big, swollen balls.',
            false
        );
        if (this.amilyFollower() || this.marbleFollower() || this.izmaFollower())
            this.outputText(
                "  After I knock you up, try explaining the fox tails on your kids to those other bitches.",
                false
            );
        this.outputText(
            "</i>\"  Reaching out to brace herself, Urta grabs your shoulder with her left hand, but her right goes wild and she ends up hooking her fingers in your mouth, jerking your cheek to the side. With the added grip, she wriggles deeper, the remaining inches snaking into your uterus until the elephantine flare rubs against your cervix, the bottom ridge of her fleshy sheath teasingly flicking against your swollen clit. Sensations crash over you: the gentle curves of her fit abdomen stroking your ass, her wobbling chest pressing button-stiff nipples into your back, the sweet taste of your tongue stroking the fingers in your mouth. It is too much and your body clenches down in a gushing orgasm on the invading member, drool leaking from your gaping mouth as your heavily lidded eyes lose focus, allowing the fox-girl to use you to her heart's content.\n\n",
            false
        );

        this.outputText(
            "When she cums for the third time, you can feel the blast directly on your cervix, the force of her load parting the muscled sphincter, ropes of newly virile seed flooding your womb.  The weight of her distended scrotum pulses between your thighs and your belly bulges under the impregnating torrent. Urta's body tenses as she inundates your depths with the excess of her loins, the influx cascading through your uterus to burst like a tide, your body flush with her pouring jizz.",
            false
        );
        if (this.player.hasCock())
            this.outputText(
        ...
        if (
            ...
            this.player.knockUp(
                ...
                PregnancyStore.INCUBATION_IMP - 32,
                61
            ); // Ceraph causes faster pregnancies
    ...
    private ceraphUrtaRoleplaySober2(): void {
        ...
        this.outputText(
            "When the two of you reach the crest of your climax this time, neither of you has the strength to hold back, triumphantly surging toward your simultaneous orgasms. Urta squeezes your hand so tightly your knuckles crack in her hands while her legs pull your " +
                this.hipDescript() +
                " into an iron embrace. Your " +
        ...
        this.outputText(
            "Retrieving your " +
                this.player.armorName +
                ', when you turn around again, Urta is gone, the moment vanishing like a drop of water in an endless sea. "<i>Thank you, ' +
                this.player.mf("Master", "Mistress") +
                ",</i>\" Ceraph's voice demurely whispers, gratitude floating on the wind.",
            false
        );
        this.player.orgasm();
        this.dynStats("lib", -1, "sen", -2, "cor", 2);
    ...
    public carephCorruptionSlaves(): void {
        this.outputText("", true);
        this.outputText(
            "You call on Ceraph, but rather than the familiar sight of the purple omnibus, you see a human girl being brought into the camp by a gang of imps.  They approach you and pull the girl's collar down, forcing her to kneel before you.\n\n",
            false
        );

        this.outputText(
            'One of the imps steps forward and opens a letter, then begins reading.  "<i>Lady Ceraph apologizes to her ' +
                this.player.mf("Master", "Mistress") +
                ", but she finds herself unable to service you.  So she has sent this human as an offering for the " +
                this.player.mf("Master", "Mistress") +
                " to corrupt.  To this end, she has prepared a concoction for you.  Drinking this will provide you with what you need for the job, " +
                this.player.mf("Master", "Mistress") +
                '.</i>"\n\n',
            false
        );
        ...
        if (this.player.cor >= 75) {
            ...
            this.outputText(
                'The imp recoils and offers a quick apology.  "<i>No, of course not, ' +
                    this.player.mf("Master", "Mistress") +
                    '.  Forgive us, we did not wish to offend.</i>"\n\n',
                false
            );

            this.outputText(
                "Gruffly, you dismiss him with a wave of your hand.  The imp bows, thankful for your mercy.\n\n",
                false
            );
        }
        this.outputText(
            'He closes the scroll and holds out a bubbling black vial labelled "<i>Drink me!</i>" to you.  The other imps form a line behind the girl.\n\n',
            false
        );
    ...
    private makeCarephsLackeysLeave(): void {
        this.outputText("", true);
        this.outputText(
            "You wave the imps away and tell them that you're not interested.  One of the imps protests, \"<i>But, " +
                this.player.mf("Master", "Mistress") +
                '-</i>"  You cut him off before he has a chance to finish, saying that you wanted Ceraph, not some human girl!  Then, you toss the potion away and tell them to take the girl away.\n\n',
            false
        );
        ...
        this.outputText(
            '"<i>Y-Yes, ' +
                this.player.mf("Master", "Mistress") +
                '...</i>" the imps reply meekly, pulling on the collar to drag the girl away.',
            false
        );
    ...
    private ceraphLackeyCorruption(): void {
        this.outputText("", true);
        this.outputText(
            "You grin and tell the imps that you will accept Ceraph's offering.  Then you circle the girl, appraising her.\n\n",
            false
        );

        this.outputText(
            "She is quite beautiful... about 5'4\" tall, with shoulder-length blonde hair.  Her face is covered by a blindfold, which you forcefully yank from her.  She gasps in fear and looks at you; her eyes are blue like the ocean, while her lips are pink and full.\n\n",
            false
        );

        this.outputText(
            "You gaze lower to appraise her breasts, guessing that they're at least a fair D-cup, and see that she's wearing a pair of nipple clamps connected by a chain. Her hands are held behind her by a pair of leather cuffs.\n\n",
            false
        );

        this.outputText(
            "You reach down between her legs, spreading them to probe her pussy; she gasps as you do so. You feel her pussy and realize it's moist... ha! The bitch is enjoying her predicament! You show her your glistening fingers and she looks away in shame.\n\n",
            false
        );

        this.outputText(
            "The vial of black fluid the imps offered you tastes sour and thick, and as it slides down your throat you can feel it burning a path of liquid heat through your throat.  The liquid settles in your belly and the heat spreads through your body; then focuses on your crotch.\n\n",
            false
        );
        ...
        if (!this.player.hasCock()) {
            ...
            this.outputText(
                ", then develops into a huge 16-inch long, 3-inch thick erection!  The tip practically explodes from the foreskin vainly trying to contain it.  ",
                false
            );
        }
        let x = 0;
        ...
        if (this.player.cockArea(this.player.biggestCockIndex()) < 48 && this.player.hasCock()) {
            this.outputText(
                "Your " +
                    this.cockDescript(x) +
                    " throbs, veins bulging as it grows larger, ballooning to a generous 20-inch long, 3-inch thick size.  ",
                false
            );
        }
        ...
        if (!this.player.hasCock() || !demon) {
            ...
            this.outputText(
                "You stroke your demonic prick, bringing it to full mast; it throbs as if knowing what is coming.\n\n",
                false
            );
        }

        this.outputText(
            "You admire the pulsating demonic member as pre-cum leaks from the tip, lubricating your shaft and dripping obscene gobs into the dirt; the girl looks at you, terrified.  The imps stare at your tainted dick and the girl's fearful expression, panting with arousal as their own cocks harden at the sight.\n\n",
            false
        );

        this.outputText(
            "You order them to remove the girl's bindings and hold her down. They quickly oblige, removing the leather cuff and pinning the girl down, then spreading her legs to allow you better access to her moist tunnel.\n\n",
            false
        );

        this.outputText(
            "You grab her hips and tease the poor girl by rubbing your nubbly shaft against her clit, forcing moans of unwanted pleasure out of her; moments later she screams in orgasm, her pussy juices already splashing against your ",
            false
        );
        if (this.player.balls > 0) this.outputText("scrotum and ", false);
        this.outputText(
            this.player.legs() +
                ".  The imps on her extremities laugh at the girl as she relaxes and her head slumps into the ground; you motion for the imps to release her and step back, then align yourself with her pussy.\n\n",
            false
        );
    ...
    private iQuitCeraphCorruptionDemons(): void {
        this.outputText("", true);
        this.outputText(
            "You tell her, loudly and in no uncertain terms, that you have no interest in playing make-believe with her, and that next time Ceraph can come herself or have an ACTUAL innocent brought for you to corrupt.\n\n",
            false
        );
    ...
    private declineCeraphFauxCorruption(): void {
        this.outputText("", true);
        this.outputText(
            "You tell her you have no interest in granting release to lowly imps.  If they want pleasure, then they should earn it themselves.\n\n",
            false
        );

        this.outputText(
            '"<i>Sorry boys, ' +
                this.player.mf("Master's", "Mistress") +
                " orders.</i>\"  She extends her wings and flies away, and the horny imps follow suit, still busy masturbating.  A 'pit-pat-pat' sound follows them, the noise of their pre-cum hitting the dry dirt from on high.\n\n",
            false
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private acceptMoreCeraphFauxCorruption(): void {
        this.outputText("", true);
        this.outputText(
            "You smirk, seeing that this might be interesting... so you order her to pleasure the imps, all of them at the same time.\n\n",
            false
        );

        this.outputText(
            "The imps' eyes glow at your command, and they only stop masturbating long enough to pounce on the succubus and drag her to the ground.  She just smiles, offering no resistance as the imps hurry to fill her mouth, pussy, and ass, not to mention keeping her hands busy.\n\n",
            false
        );

        this.outputText(
            "The sight is arousing; the imps tug, grope and pull at the succubus, all while brutally fucking her.  The huge deposit you made inside her tight vagina splatters about with each wet slap of the imp fucking her pussy; the one inside her ass pushes brutally, as if trying to climb up her anus cockfirst; the one on her mouth makes use of her breasts whenever he pulls out; and finally the ones using her hands splatter pre on top of her, painting her purple skin white.\n\n",
            false
        );

        this.outputText(
            "The show doesn't last long, however.  The imps quickly climax with echoing cries. The one using her mouth cums so hard that some ejaculate backflows out of the succubus' nose.  The ones using her ass and pussy fill their respective holes, pulling out in the last spurt to paint the succubus' body in spooge.  Her hands, of course, complete the job by painting whatever was left  with the last two imp dicks.  By the end of the ordeal, the succubus is coughing and sputtering.\n\n",
            false
        );

        this.outputText(
            '"<i>Look at what happened to me... used and transformed, then forced to service a bunch of dirty imps...  Thank you, ' +
                this.player.mf("Master", "Mistress") +
                ',</i>" she moans with a lewd smile.\n\n',
            false
        );

        this.outputText(
            "Licking the cum off her body, she sashays towards you to give you a little peck on the cheek.  \"<i>Hmm, you're such a good " +
                this.player.mf("Master", "Mistress") +
                ", I might have to leave Ceraph's harem and join yours instead.  See you around, hot stuff.</i>\"  She rounds up the tired imps and extends her wings, setting off alongside them.",
            false
        );
    ...
    private sweetieNOOOO(): void {
        ...
        this.outputText(
            '"<i>Aaaah, not satisfied with me, ' +
                this.player.mf("Master", "Mistress") +
                '?</i>" Ceraph huffs, feigning exasperation.  She pointedly runs a hand along her muscular thigh, up her taut belly, and around one of her perfectly-formed lilac breasts.  "<i>And what did you have in mind for our... playtime?</i>"\n\n',
            false
        );

        this.outputText(
            'After taking a moment to form your thoughts, you begin describing a tall country-style girl, with huge breasts and an aptitude for pet names.  Ceraph cuts you off with a high-pitched cackle, and she actually slaps her palm against her forehead in her excitement.  "<i>Marble?</i>" she asks between bouts of laughter.  "<i>You want me to turn into that cow?  Oh, ' +
                this.player.mf("Master", "Mistress") +
                ', but you surely are a mystery to me.</i>"  A sharp stare from you cuts off her reverie, and she sobers instantly, going so far as to cringe.  "<i>My apologies, ' +
        ...
        this.outputText(
            "First, she gestures once again at the environment, changing from a mountainous terrain to the inside of... Whitney's barn?  Sure enough, you look past her and see a milker ",
            false
        );
        if (this.player.hasKeyItem("Breast Milker - Installed At Whitney's Farm") >= 0)
            ...
            this.outputText(
                "not too different from the ones you've seen in Ingnam, although modified for human use, it seems.",
                false
            );
        this.outputText(
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00294] == 0)
            ...
            this.outputText(
                "You simply chuckle knowingly at the apparent size disparity of the garment.",
                false
            );
        this.outputText(
            "  She reaches up and takes a tentative grasp of her curved, demonic horns, straightening and molding them into more bovine models.  The spade-tip of her tail shrinks, then puffs out with hair, and the whole appendage droops as it becomes remarkably more cow-like.  Almost as an afterthought, she paces up to you and slowly strips you of your " +
                this.player.armorName +
                ".  She teases " +
                this.oMultiCockDesc() +
                " a bit before gliding back to her previous position.\n\n",
            false
        );
        ...
        this.outputText(
            "A ruffle of her hair sparks a similar coloration shift to the same brown as her leg fur, and the black of her eyes shift to whites with brown irises.\n\n",
            false
        );

        this.outputText(
            '"<i>One last touch,</i>" she moans as her whole frame begins to jostle about.  With a shake, her entire body leaps up a couple inches in height, and another, and another until she\'s roughly the same size as that familiar cowgirl.',
            false
        );
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00295] == 1) this.doNext(this.postUdderChoice);
            ...
            this.outputText(
                '  "<i>Now then, ' +
                    this.player.mf("Master", "Mistress") +
                    '... or, should I say, Sweetie,</i>" she breathes, her sultry tones smoothing into an earthy, slightly drawn-out accent, "<i>there\'s one more detail that she - sorry, I - don\'t have; would you like me to have... an udder?</i>"\n\n',
                false
            );
            this.outputText(
    ...
    // [in a pig's eye, pal]
    private noUdderPlz(perm = false): void {
        this.outputText("", true);
        this.spriteSelect(41);
        if (perm) this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00295] = 1;
        this.outputText(
            'A sharp head-shake is the only declination she needs.  "<i>Of course, Sweetie, that wouldn\'t be very... Marble-like, would it?</i>"\n\n',
            false
        );
    ...
    private postUdderChoice(newl = false): void {
        this.spriteSelect(41);
        if (newl) this.outputText("", true);
        this.outputText(
            'That out of the way, she pulls her overall back over her shoulders and turns her back to you, waiting several seconds before turning around.  "<i>Sweetie!?</i>" she exclaims in horror, eyes wide and arms flung in front of her as she cowers from you.  "<i>What-... what are you doing...</i>"\n\n',
            false
        );
        ...
        if (cum < 50)
            this.outputText(
                "Her ass has no problem in taking your ejaculatory package, lapping it up like it was nothing.",
                false
            );
        else if (cum < 250)
            this.outputText(
                "She groans a bit from the amount of seed you pump into her butt, but she doesn't seem overly concerned by it.",
                false
            );
        else if (cum < 750)
            this.outputText(
                "Her belly actually bulges out a bit more as you shoot your sperm into her perfect butthole, but her only response is an approving grunt.",
                false
            );
        else if (cum < 2000)
            this.outputText(
                "Normal girls might not be able to take this much cum at one time, but 'Marble' simply bucks her hips happily as her belly is stretched as least as large as her boobs to make room for the load.",
                false
            );
        else
            this.outputText(
                "Her entire body writhes in ecstatic bliss as your gigantic load pumps into her, wave after wave of baby-batter inflating her gut so full of cum.  By the time you're done, her navel is an outtie; what's more, it's actually scraping the barn floor, and if her arms were free, you don't doubt she'd be rubbing happily at it.",
                false
            );
        if (cum >= 10000)
            this.outputText(
                '  Marble\'s body convulses so hard it actually dislodges the funnel, dragging the tube free of her mouth.  "<i>SWEETIE!</i>" she screams, grinding herself against you as her stomach burgeons forward, filled with enough seed to propagate an entire city of goblins for months.  "<i>MORE!</i>"  You\'re able to give her just that, bloating her billowing belly obscenely, stretching the creamy skin to its near-breaking point with your virility.  Even if you wanted to pull out, you couldn\'t, not with her anal walls clamped onto your ' +
                    this.cockDescript(0) +
                    " like this.  Her belly actually gains enough mass to nearly fill up the stall, pushing her tits up into her chin.",
                false
            );
        ...
        this.outputText(
            "Finally spent, you free yourself of Marble's butt and straighten, moving to the side to take in just how far the cowgirl has fallen.  The milkers' storage tanks are fit to bust from the amount of cream your cumslut has pumped into them, but Marble herself is staring at you with heavy-lidded eyes.  You don't even remove her restraints, just dismissively press a foot into her gut",
            false
        );
        if (cum >= 2000 && this.player.cor >= 66)
            this.outputText(
                " and chuckle at the drizzle of semen that issues from her butt and mouth",
                false
            );
        this.outputText(
            '.  After a few more moments of observation, you turn away, planting your hands on your hips victoriously.  You simply thank the cowgirl, and she responds with a satisfied moan.  Suddenly, a massive splashing sound - as if gallons of liquid were suddenly released - reaches your ears, and the barn shimmers and fades into the familiar setting of your camp.  You feel a hand on your shoulder, and you glance down to see a creamy-colored hand, veins of purple creeping along the surface and inching up her fingers.  "<i>Thank you, ' +
                this.player.mf("Master", "Mistress") +
                ',</i>" Ceraph replies amiably, tittering to herself.  "<i>You\'ve got some kinks to work out, don\'t you?  I like that.</i>"\n\n',
            false
        );
    ...
    private cerminika(): void {
        ...
        if (this.flags[kFLAGS.CERAPH_ROLEPLAY_AS_DOMINIKA_COUNT] == 0) {
            ...
            this.outputText(
                'You explain about the dark-lipped witch to your demon whore.  "<i>Mmm, tattoos, that\'s gonna be rough,</i>" she muses, licking her lower lip in thought.  "<i>Think about her for a moment?</i>"  You were already thinking of Dominika given that you were explaining who she was to Ceraph, but you suppose dealing with her idiocy is the price you pay for the sex.  Still, you acknowledge that you are.  Ceraph places her hands on your forehead and closes her eyes for a few moments, before purring and grinning.  "<i>Oo, she\'s cute. Ask her if she likes piercings.</i>"\n\n',
                false
            );
        }
        ...
        this.outputText(
            "Dominika stands before you, nude and unrestricted. She licks her lips slowly.\n\n",
            false
        );
        ...
        if (this.player.hasCock()) {
            ...
            this.outputText(
                '  "<i>I dare say,</i>" she purrs between the kiss, pressing her forehead to yours, "<i>You may have seduced me, champion.</i>"\n\n',
                false
            );

            this.outputText(
                'Pressing her hands on your shoulders she eases you down, straddling your lap.  "<i>I linger in chastity out of fear that my dignity shall be taken from me in this land,</i>" she purrs softly, tracing her hand across your chest.  ',
                false
            );
            if (this.player.biggestTitSize() >= 0)
                this.outputText(
                    "She casually and playfully gives the gentlest squeeze to your " +
                        this.chestDesc() +
                        ".  ",
                    false
                );
            this.outputText(
                '"<i>But if I can rely on you – perhaps I do not need to worry.</i>"  She pulls your ' +
                    this.player.armorName +
                    " away, letting her hands roam hungrily across your body.  Blatantly turned on, her pussy rubs its juices against your crotch",
                false
            );
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText(", and her prick has remained firm and hard", false);
            this.outputText(
                ".  Her tongue roams hungrily over her inky lips, and an almost predatory grin sets across her features as she pulls up your " +
                    this.cockDescript(0) +
                    ".  Her fingernails cup under your head delicately and carefully tease you, rubbing her palm into the underside of your shaft.\n\n",
                false
            );

            this.outputText(
                '"<i>How long,</i>" she purrs, "<i>Have you wanted to really be inside me?</i>"\n\n',
                false
            );

            this.outputText(
                "Dominika slides her body back, rubbing the softness of her folds against your " +
                    this.cockDescript(0) +
                    ".  ",
                false
            );
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText(
                    "The very base of her prick teases the veins of your own shaft, but she seems focused on the pleasure of her cunt for now.  ",
                    false
                );
            this.outputText(
                'She grins at you as she reaches the top of your cock, grinding back and forth across it.  "<i>Mmm,</i>" she muses quietly, biting her lower lip for a moment.  "<i>It\'s been a long time since I let someone have me.  I forgot just how... warm a prick can feel down there.</i>"  Her pussy casually clenches, brushing herself across your tip.  "<i>You should feel honored.</i>"\n\n',
                false
            );
            ...
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText(
                    "  The degree that her cock abruptly shoots straight up is perhaps the most amusing part of the act.",
                    false
                );
            this.outputText(
                "  You simply smirk at her, starting to bounce her into your lap and shoving your " +
                    this.cockDescript(0) +
                    " deeper inside. Once more she bites her lip, fingers digging into your stomach. No matter how classy she wants to appear, you can quite easily feel how wet she is",
                false
            );
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText(", and the heat of her prick bouncing into your lap", false);
            this.outputText(
                '.  "<i>Hey,</i>" she gasps, "<i>Don\'t you want to savor it?</i>"\n\n',
                false
            );
            ...
            this.outputText(
                'The inability to frame her expression and hang it on a tree in your campsite is the greatest injustice the world has ever known.  Her black lips sit in a stunned part as she stares at you, even as you hump away at her sopping mound.  She blinks a few times, shakes her head once, the entire disbelief package.  Eventually her hands slide down her side to find your own, rubbing over your fingers as they hold her hips.  Then, sharply and surprisingly painfully, she digs her fingernails into your wrists, forcing you to let go.  "<i>No,</i>" she says with a wicked grin as she brings your hands to the side of your head, leaning forward and slowly undulating her hips in your lap.  "<i>Really. Enjoy me.</i>"\n\n',
                false
            );

            this.outputText(
                "You give her a carefully crafted retort that demonstrates your intellectual superiority, but she just gives you a fake smile and pats your cheek.  Eyes half-closed she slowly slides herself along you, enjoying the sensation of each inch of your " +
                    this.cockDescript(0) +
                    ' as it brushes along her walls.  "<i>Mmmm,</i>" she lets herself purr out, "<i>Worth... the wait.</i>"  Her toes curl slightly, one of her legs shifting back slightly to alter the angle you enter her at.  It seems to work how she wants it to, as a deep, satisfied breath accompanies the next downward slide of her hips.',
                false
            );
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText(
                    "  A single bead of pre-cum forms slowly at the tip of her prick, growing larger until it finally slips down into the curve of her head, sliding down her shaft and into your lap.",
                    false
                );
            this.outputText(
            ...
            this.outputText(
                'Grabbing her shoulders, you surprise her once more by twisting and rolling on top of her.  "<i>No!</i>" she shouts immediately, knowing your plot, "<i>You ' +
                    this.player.mf("bastard", "bitch") +
                    '!  No one puts me on my own back!</i>"  You remind her that facts need more proof than the assumption that things will never change.  She spits at you, but you take solace in the fact that your hands are over her wrists and your ' +
                    this.cockDescript(0) +
                    " is shoved so deep in Dominika there's a chance she could spit up cum when you're done rather than swallow it.  Presuming, of course, that her vagina is connected to her stomach, which it probably is not.\n\n",
                false
            );

            this.outputText(
                "Yet.  You haven't decided what you'll make her put in her mouth now that she's here.\n\n",
                false
            );

            this.outputText(
                '"<i>F-fuck!</i>"  Those dark lips manage to stammer out, "<i>Stop fucking me! Let me ride you, you piece of shit!</i>"  She manages to pull her hands free from the grip you have on them, only to beat on your chest a few times and push futilely against it.  ',
                false
            );
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText(
                    "Her prick bounces between her belly and yours as you take her.  ",
                    false
                );
            this.outputText(
                "For your part you have no interest in slowing down, gripping back onto her hips and pounding away at the delightfully tight cunt presently dominated by your " +
                    this.cockDescript(0) +
                    ".  More in charge than you were before, you have a chance to truly appreciate the sensation of her labia being shoved apart for your needs.  Absolutely soaked with her needy juices, it's easy to penetrate the sorceress.  Forcing so much of her sopping nectar out is making a terrible mess of her thighs, but given how stuck up she's been about finally letting you take her, she could stand to get a little messy.  Her fingernails claw at your collarbone",
                false
            );
            ...
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText(
                    "A light spurt of pre-cum from her prick warms the flesh where your hips meet.  ",
                    false
                );
            this.outputText(
                "Slowly her fingers trail up to your shoulders, gripping you tightly and gritting her teeth as you thrust.  Sweating and grunting in tempered exertion from the pounding you put her through, the bun in her hair begins to fall apart.  Some of her blonde locks cling to her forehead.  Her legs curl around you, rubbing against your body and clenching with each strangled gasp coming from her dark lips.  The backs of her heels dig into your backside, rubbing in as she pins you closer.  You think little of it, until you attempt to take a deep thrust only to be rudely tugged back in by her feet. Gripping you tighter with her hands and holding onto the back of your head, she hisses happily, rocking her hips against you to feel your " +
                    this.cockDescript(0) +
                    ' shift inside.  "<i>I said enjoy me,</i>" she hisses wickedly, licking her ebony lips and casually nipping at you.  "<i>Stay here, ' +
                    this.player.mf("handsome", "gorgeous") +
                    '.</i>"\n\n',
                false
            );
            ...
            this.outputText(
                "It's surprisingly easy to spear yourself into the cabalist's plush posterior.  You had expected a woman of her nature to be tighter than she is, but the pussy juices soaking your " +
                    this.cockDescript(0) +
                    " are sufficient for a slippery and enjoyable entry.  She grunts and gasps dissatisfaction, but there's a deepness in her breath that betrays the excitement building within.  At the same time, she seems curiously nervous, and shakes not just in pleasure.\n\n",
                false
            );

            this.outputText(
                "\"<i>P-please,</i>\" she stammers out, even as her asshole clenches around you.  Though it was easy to force yourself into Dominika's puckered button, you're impressed at how well her colon squeezes your shaft.  There's no blown-out anal whore here, just a petite fucktunnel the perfect size to be broken by your " +
                    this.cockDescript(0) +
                    '.  You part aside her bunghole, claiming her ass in your name – colonizing her colon.  The entire reason those cheeks exist is cushioning for your crotch as you pound away at her, the juices her cunt left on your cock squirting out as your prick dominates every inch of those fleshy walls.  "<i>Please,</i>" she gets out again, "<i>I\'ve held out... so long...</i>" She turns her head to look at you.  Tucked just behind the part of her hair, two small horns push from her skull.  A moment of confusion takes you, before it is replaced by a knowing smirk.  Jeering at the corrupted sorceress, you mock her inability to defend herself.  Without her chastity belt to protect her from the pleasure of the demon realm, it is free to feed upon her body and devour what purity remained, leaving behind just another succubus.  "<i>Don\'t... make me cum,</i>" she gasps.\n\n',
                false
            );

            this.outputText(
                "Under most circumstances you would have no opposition to denying a slut like her an orgasm, but considering the precipice she dangles over, you don't feel bad giving her a push.  Your " +
                    this.cockDescript(0) +
                    " continues its obscene assault on her backside, splitting her juicy cheeks to either side as you bend her guts to your dick's will.  Dominika lets out a moan that seems as though she may have intended it to be a scream of frustration, but her body is too far gone into pleasure to protest.  Like ink running through paper a deep dark purple begins to spread from her tattoos.  The color runs into itself and grows larger, leaving behind no lines where it joins.  The tan of her skin begins to disappear under the corruption.  \"<i>You " +
                    this.player.mf("bastard", "bitch") +
                    ',</i>" she pants, shuddering as the horns grow larger.  "<i>You would destroy my humanity... just for your pleasure?</i>"\n\n',
                false
            );
            ...
            this.outputText(
                "She wails in mixed frustration and pleasure, juices splattering against the ground as her hungry cunt grows hornier.  A darkness overtakes her eyes, and her nails grow long and sharp, and through it all your " +
                    this.cockDescript(0) +
                    " continues to degrade her ass.  As though a heartbeat pumping blood through her body, each thrust spreads the color over her skin a little more.  Her feet push and scrabble lightly against the ground in tormented frustration, but she is helpless beneath you.  You go without stopping, only slowing when wings unexpectedly burst from her shoulder blades, dark and starry.\n\n",
                false
            );

            this.outputText(
                "Grabbing your sorceress-cum-succubus fucktoy firmly around the hips, you go upright, lifting her off the ground and bouncing her against your body.  Moaning and squirting her juices against the ground, Dominika lifts her legs to help you, swelling indigo tits bouncing from your forceful thrusts.",
                false
            );
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText(
                    "  Her prick has become engorged and infernal, covered with abnormal bumps and veins. It practically spits up pre-cum, gurgling with a greatly increased supply.",
                    false
                );
            this.outputText(
                '  "<i>Take it then,</i>" she gasps, "<i>Take me... j-just give me... moreeeee...</i>"  Her long nails – more slutclaws than anything else – dig into your arms as you hold her up almost painfully.  Squealing ecstatically, a long demonic tongue slips past her full corrupted ebony lips, slapping against her collarbone as her eyes roll up in pleasure.  Blonder and fuller, her hair naturally pulls back into an exaggerated bimbo-esque bun, and her horns have grown large and sinister.\n\n',
                false
            );
            ...
            if (this.player.cumQ() >= 500)
                ...
                this.outputText(
                    "  She shudders as your " +
                        this.cockDescript(0) +
                        " fills her guts with warmth, hips seizing as she rides out her assgasm.",
                    false
                );
            this.outputText(
                "  Her cunt nearly waterfalls her juices, squirting obscenely as she rides out the pleasure.",
                false
            );
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText(
                    "  The demonic prick placed between her legs stops bouncing only because of how rock-hard it is as it spews her own filthy fucksludge across her body, splattering onto her tits and across her face.  The volume of off-white cream it spews out takes even longer to finish than you do, painting her obscenely.",
                    false
                );
            this.outputText("\n\n", false);

            this.outputText(
                "Her hands drag across your chest as she slinks off you, moaning and shaking.  You shift back on your ass to sit down after the long fuck, only to smirk as she eventually crawls back up to you.",
                false
            );
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
                this.outputText(
                    "  Her own filthy jizz has already been licked clean by her hungry mouth, so as not to dirty your handsome prick.",
                    false
                );
            this.outputText(
                "  The demoness laps at your " +
                    this.cockDescript(0) +
                    ", cleaning it of spunk, sweat, and all the various filth it accumulates, sucking and dragging her fat, midnight lips across them.  Dominika purrs her happiness, her joy at being forced into such a whorish form.\n\n",
                false
            );
            ...
            if (this.player.cockArea(0) >= 75)
                this.outputText(
                    "I doubt her ass could actually take you so well, but... I wanted my " +
                        this.player.mf("master", "mistress") +
                        " to enjoy a perfect asshole.  Sue me.  ",
                    false
                );
            this.outputText(
                "I hope that little slut appreciates what she's missing out on.</i>\"  She laps at your dick a few more times in the corrupted cabalist's visage, eventually sitting upright and slipping around behind you to massage your shoulders.\n\n",
                false
            );

            this.outputText(
                '"<i>That said,</i>" she whispers in your ear, "<i>If you get a chance to do that to that cunt, do invite me.</i>"',
                false
            );
        }
        this.player.orgasm();
    ...
    public encounterZetsuko(): void {
        ...
        if (this.flags[kFLAGS.ZETSUKO_MET] == 1) {
            ...
            this.outputText(
                "\"<i>Zetsuko apologizes for Mistress's absence, " +
                    this.player.mf("Master", "other Mistress") +
                    ".  Mistress wasn't able to be here, so she sent Zetsuko instead.  She hopes Zetsuko will be to your liking...</i>\"\n\n",
                false
            );

            this.outputText(
                "She punctuates her sentence with a creepy grin that shows off her oversized canine teeth, an evil gleam in her eyes hinting at an inner turmoil boiling just under the surface.  As she licks her lips with an almost animalistic hunger, you see that her tongue is extremely long and sports a large stud as well.  You quirk your brow at her peculiar manner of speech, but try your best to parse the information.\n\n",
                false
            );

            this.outputText(
                '"<i>Zetsuko was wondering if ' +
                    this.player.mf("Master", "Mistress") +
                    ' could perhaps... loosen her jacket?</i>" she says, struggling in her straitjacket a bit.  "<i>Mistress tied it a little too tightly...</i>"\n\n',
                false
            );

            this.outputText(
                "When she turns to offer you her bindings, you spot a small note pinned to her back, and reach out to take it.  It seems to have been written to you by Ceraph.\n\n",
                false
            );
            ...
            this.outputText(
                "You give a confused blink, re-reading the last line.  As you begin to wonder what it means, Zetsuko spins around and plops down on her cushy rear, looking up at you indignantly.\n\n",
                false
            );
            ...
            this.outputText(
                '"<i>' +
                    this.player.mf("Master", "Mistress") +
                    " isn't going to let Zetsuko out, is " +
                    this.player.mf("he", "she") +
                    "? Hehe... Too smart... Zetsuko is a bad girl, yes... many bad habits, trying to trick " +
                    this.player.mf("Master", "Mistress") +
                    '.  Mistress tries to teach her, but Zetsuko has far too much fun being bad.</i>"\n\n',
                false
            );

            this.outputText(
                "Her legs are splayed out lewdly, and at last you start to understand what Ceraph meant in her note as your eyes are drawn to Zetsuko's drooling cunt.  Drooling, in this case, being literal — as you watch, an obscenely long tongue lined with studs is slithering its way out of her vagina, licking along the outer edges of her labia and dripping with what appears to be a mixture of saliva and pussy juices.  Thankfully, there don't seem to be any teeth, but the way that enormous tongue is wriggling around is so disturbingly erotic that you can't seem to pull your eyes away long enough to check.\n\n",
                false
            );

            this.outputText(
                "\"<i>Is Zetsuko's pussy to " +
                    this.player.mf("Master", "Mistress") +
                    "'s liking?</i>\" she says, laying on her back and spreading her legs further to proudly display her freakish appendage to you, putting on a display as she begins to tongue her own clit, flicking her hood piercing gently.\n\n",
                false
            );
    ...
    private fuckZetsukosTonguepussy(): void {
        ...
        const x: number = this.player.biggestCockIndex();
        this.outputText(
            "Your lust and curiosity get the best of you as the sight of that licentious tongue wriggling around between her legs sends a heat to your groin, blood rushing into your " +
                this.multiCockDescriptLight() +
                ".  Zetsuko lays flat on her back, grinning up at you as her pussy licks itself in anticipation, and as you lower yourself down, her tongue snakes out even more, beginning to wrap itself around " +
                this.oMultiCockDesc() +
                " and slathering it with her saliva-like juices.  Your sensitive member can feel that the surface of her tongue is covered in hundreds of tiny bumps and nubs that massage your shaft, and the multiple studs that line it rub you sensually as the bizarre organ coils around your " +
                this.cockDescript(x) +
                " like a snake, the very tip gently stimulating around the edges of your urethra.\n\n",
            false
        );

        this.outputText(
            "You marvel at the incredible degree of control she seems to have over her tongue, watching as it begins to stroke and squeeze along your shaft, coating you in slick saliva from base to tip.  Its grip around you tightens up a bit, and you can feel it tugging you down gently, drawing your " +
                this.cockDescript(x) +
                " ever closer to her entrance.  Her vagina lips spread open as you approach, gaping wide like a hungry mouth, and as it does so, you can see that the inner surface of her pussy has a number of soft bumpy nodules lining it in a downward spiral pattern.\n\n",
            false
        );

        this.outputText(
            "\"<i>Zetsuko can't wait to have " +
                this.player.mf("Master's", "Mistress's") +
                " dick in her pussy...  she knows " +
                this.player.mf("Master", "Mistress") +
                ' will just love it...</i>" she says, wiggling her hips a bit as she pulls you up against her entrance, her lips sucking on the tip gently.',
            false
        );
        if (this.player.cockArea(x) >= 100)
            this.outputText(
                "  You wonder just how she plans to fit you inside, but there's not much you can do about it at this point.  You'll just have to trust that she knows what she's doing, crazy or not.",
                false
            );
        this.outputText(
            "  As you begin to grope her enormous jiggling breasts, you keep looking down to watch as her tongue slithers along your length, stretching out across it and then squeezing tight.  It begins to contract, the motion squeezing the first inch or so of your cock inside, and she sends up a moan, repeating the motion again and again, each time pulling a bit more of you inside.\n\n",
            false
        );
        ...
        this.outputText(
            "teasing your " +
                this.assholeDescript() +
                " gently.  You gather up a mound of her soft tit flesh in each hand and begin squeezing along them lustfully, pushing on her pierced nipples with your thumbs gently while her tongue continues to lick and pleasure everything within its reach.\n\n",
            false
        );
        ...
        this.outputText(
            '"<i>Ooo-oohh! ' +
                this.player.mf("Master's", "Mistress's") +
                ' cock tastes so good in Zetsuko\'s pussy!</i>" she moans, rolling her eyes back as you feel her begin to "<i>suck</i>" on your ' +
                this.cockDescript(x) +
                " deeply, rocking her hips back and forth.  The suction inside her drooling cunt feels like one of the most intense deepthroats you've ever felt, and you forget for a moment that it's coming from her vagina until Zetsuko's loudest moan yet snaps you back to reality.\n\n",
            false
        );

        this.outputText(
            "Deciding to give the crazy slut a little payback for so rudely interrupting your fantasy, you reach down and begin to twist the studs in her nipples lightly, grinning like a maniac as her slavering cunt suddenly clenches up around you from the sensations.\n\n",
            false
        );
        ...
        this.outputText(
            '"<i>Ahh! Yes, ' +
                this.player.mf("Master", "Mistress") +
                '! Punish bad Zetsuko! More, more, please!</i>"\n\n',
            false
        );

        this.outputText(
            'As you continue to torture her nipples, she arches her back in ecstasy and begins to buck wildly, her pussy-tongue slapping around erratically now, flinging saliva-juices everywhere.  The tongue in her normal mouth is hanging out now, long enough to reach her chest, her eyes rolled back with a blissful grin on her face.  You can feel your climax coming on, and apparently Zetsuko can too as she yells out between moans, "<i>Ah! ' +
                this.player.mf("Master", "Mistress") +
                ', give Zetsuko your tasty cum!</i>"\n\n',
            false
        );

        this.outputText(
            "With the way her pussy and tongue are squeezing you now, it would be nearly impossible not to indulge her request.  Your " +
                this.cockDescript(x) +
                ' twitches inside her, releasing a creamy deluge that causes Zetsuko to begin drooling from both ends.  "<i>Oooh...  so good, so thick, so creamy...  Fill Zetsuko up, yes!</i>"',
            false
        );
        if (this.player.cumQ() <= 100)
            this.outputText(
                "  Your orgasm ends quicker than it seems Zetsuko wanted it to, the last of your few thin streams of cum spraying into her pussy.  It seems to suck on you all the harder, as if trying to dredge out just a few more drops.",
                false
            );
        else if (this.player.cumQ() <= 500)
            this.outputText(
                "  You fire creamy ribbons of cum into her, feeding what seems to be a never-ending hunger for semen as her pussy clenches and squeezes you for every drop.  Her tongue wraps around your member and squeezes along the length inside her to force out the remaining contents of your urethra, and a strong swallowing motion inside her vagina carries your thick load away.",
                false
            );
        else
            this.outputText(
                '  The strong sucking motions of her cunt milk your shaft for everything it has, her pussy greedily swallowing load after load of your hot spunk.  Her walls continue to milk you even as her abdomen begins to swell with the volume of your seed, growing outward into a gravid, jiggling belly.  When your orgasm finally ends, Zetsuko looks like she\'s several months pregnant, and she has a look of utter satisfaction on her face.  "<i>NNnnnaaaaahhhhh....  Zetsuko...  is full.</i>"',
                false
            );
        this.outputText("\n\n", false);

        this.outputText(
            "Her pussy continues to suck on you gently as you pull out, and when your " +
                this.cockDescript(x) +
                " finally comes free of her bizarre lovehole, her tongue gently swirls around the lips before retracting itself inside.  You back up, wondering if you should help the bound kitsune to her feet, but as you are considering this, she flashes you a crazed grin and is suddenly bathed in purple flames, disappearing before your eyes.\n\n",
            false
        );

        this.outputText(
            '"<i>Zetsuko hopes to taste ' +
                this.player.mf("Master", "Mistress") +
                ' again sometime...</i>"',
            false
        );
        this.player.orgasm();
        this.dynStats("lib", 0.25, "sen", -5, "cor", 2);
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private getTonguedByZetsuko(): void {
        ...
        this.outputText(
            "Heat rushes to your groin as you stare at the outlandish appendage wriggling between Zetsuko's legs, feeling yourself becoming wet with anticipation.  Seeking to entice you further, she rolls herself back, placing most of her weight on her shoulders as she curls her lower body up into the air, her tongue slithering back and forth along her thighs.\n\n",
            false
        );

        this.outputText(
            '"<i>Pleeeease, let Zetsuko taste Mistress\'s pussy?</i>" she says, grinning up at you as you approach.  "<i>She\'s certain her tongue can please Mistress greatly...</i>"\n\n',
            false
        );

        this.outputText(
            "The salacious organ slithers toward you, caressing the outer lips of your " +
                this.vaginaDescript(0) +
                " and gently prodding your " +
                this.clitDescript() +
                ' before receding, making what can only be described as a "<i>come hither</i>" motion.  You take a step forward, pressing your hips up against the heavy cushions of her ass, and her tongue immediately curls toward your groin, ',
            false
        );
        if (x >= 0)
            this.outputText(
                "wrapping itself around your " +
                    this.cockDescript(x) +
                    " and squeezing momentarily before ",
                false
            );
        this.outputText("heading straight toward your slit.\n\n", false);

        this.outputText(
            "As the tip begins to probe your depths, you can feel that the surface of her tongue is covered in hundreds of tiny nubs and bumps that give it an incredible texture.  You can't help letting out a lewd moan as the muscular organ pushes yet deeper still inside you, flexing and contorting into various shapes to augment the intense sensations.\n\n",
            false
        );

        if (x >= 0) {
            this.outputText(
                "In a somewhat impressive feat of contortion, Zetsuko brings her feet in toward her groin to stimulate your " +
                    this.multiCockDescriptLight() +
                    ", lifting ",
                false
            );
            ...
            this.outputText(
                " up using her toes and stroking along the underside of the shaft",
                false
            );
            if (this.player.cockTotal() > 1) this.outputText("s", false);
            this.outputText(
                " with the soles of her feet.  Her toes are surprisingly dextrous, able to curl around and grip your " +
                    this.cockDescript(x) +
                    " lightly, gently pinching and tugging at the skin just under the head and manipulating your throbbing member",
                false
            );
            if (this.player.cockTotal() > 1) this.outputText("s", false);
        ...
        this.outputText(
            "You slide your hips forward, curling her body back further and resting your weight on the pillowy cushions of her bottom, riding down onto her tongue and shivering deliriously.  You can feel it plumbing your depths, slithering into you and filling every nook and cranny as it swells and flows along your walls to take up every last bit of room you have.  The degree of control she has over it is simply incredible, becoming thicker to stretch your " +
                this.vaginaDescript(0) +
                " and then suddenly retracting to swirl itself into a spiralling tendril that drills your hole lewdly.\n\n",
            false
        );
        ...
        this.outputText(
            "Grabbing hold of her thighs, you begin to rock yourself back and forth across her tongue, moaning powerfully as you feel it begin to thrust in and out of you now.  The numerous studs that line the center of the organ begin to press firmly against the roof of your " +
                this.vaginaDescript(0) +
                ", stimulating your G-spot and flicking your " +
                this.clitDescript() +
                " each time her tongue dives back inside you.  Your fingers dig into her flesh like a vice now as you grind yourself down on the indecent tendril, moaning salaciously as the waves of your climax begin to overtake you.\n\n",
            false
        );
        ...
        this.outputText(
            "Your " +
                this.vaginaDescript(0) +
                " cinches tight around Zetsuko's tongue, and it continues to wriggle inside you while you ride out your orgasm.",
            false
        );
        if (x >= 0) {
            this.outputText(
                "  " + this.SMultiCockDesc() + " twitches powerfully between her feet, ",
                false
            );
            if (this.player.cumQ() <= 100)
                this.outputText(
                    "spurting a healthy spray of hot cum all over her face and chest.",
                    false
                );
            else if (this.player.cumQ() <= 500)
                this.outputText(
                    "distending visibly as it begins to pump out thick streams of spunk all over her waiting face and tits.",
                    false
                );
            else
                this.outputText(
                    "unleashing a heavy downpouring of cum all over her face and tits that soaks through her straitjacket and mats her hair down with your thick load.",
                    false
                );
            this.outputText(
                '  She grins lasciviously and opens her mouth to reveal her other freakishly long studded tongue, using it to lap up your spunk hungrily and clean herself off.  "<i>Mistress\'s cum is so tasty...</i>"',
                false
            );
        }
        this.outputText("\n\n", false);
        ...
        this.outputText(
            "The slick juices of your climax trickle down, pooling inside Zetsuko's gaping pussy",
            false
        );
        if (this.player.wetness() >= 4)
            this.outputText(
                " and overflowing to dribble down her bountiful ass cheeks and stomach",
                false
            );
        this.outputText(
            '.  You hear an odd gurgling sound, and watch as the puddle of juices slowly begins to drain down into her vagina, a visible swallowing motion carrying it away inside her.  "<i>MMmmmm...  Zetsuko loves the taste of Mistress\'s juices...</i>"\n\n',
            false
        );

        this.outputText(
            "Fully spent, you pull yourself back, grasping Zetsuko's still-writhing tongue in your hand and sliding it out of you, letting her lower body thump to the ground.  You watch as her tongue gently swirls around the lips and then retracts within the bizarre orifice, looking for all the world to be an ordinary — if slightly overstretched — pussy.  You wonder if you should help her up for a moment, but as you are considering reaching down to bring her to her feet, she is suddenly bathed in corrupted flames, disappearing before your eyes.\n\n",
            false
        );
    ...
    private zetsukoBanana(): void {
        ...
        this.outputText(
            "As the word leaves your lips, you see the studs on Zetsuko's collar glow, and she is suddenly forced down to the ground again, face mashed in the dirt and her ass raised high while her pussy-tongue flails about wildly between her thighs.\n\n",
            false
        );

        this.outputText(
            '"<i>Hah... hah...  Zetsuko dislikes... those fruit... immensely,</i>" she says, avoiding speaking the word aloud herself as she tries to lift herself back up yet again.\n\n',
            false
        );
    ...
    private noZetsukoLoveToday(): void {
        this.outputText("", true);
        this.outputText(
            "You tell her to be gone; you wanted Ceraph, not some lowly slave that can't even be bothered to show you proper respect.  You order her to tell Ceraph not to waste your time with undisciplined servants that she's too inept to properly break.\n\n",
            false
        );

        this.outputText(
            '"<i>Oohoh, Mistress is certain to be FURIOUS with Zetsuko...</i>" she says, licking her lips and showing off the numerous studs that line her normal tongue as well.  "<i>Zetsuko cannot wait...</i>"',
            false
        );
        this.doNext(this.camp.campSlavesMenu);
    }
    ...
    private giveFollowerBodyBits(): void {
        ...
        this.clearOutput();
        this.outputText(
            "You ask Ceraph just what all giving up a body-part would entail.  Your submissive demonic slut presses herself against you, stroking her hands under your " +
                this.player.armorName +
                " as she answers, \"<i>Well, [Master], I would use my body-shifting black magics to remove a choice portion of your 'fun-bits', if you know my meaning."
        );
        if (this.player.hasCock() || this.player.hasVagina() || this.player.hasBreasts()) {
            ...
            if (this.player.hasVagina())
                this.outputText(
                    "  I could remove your snatch.  Don't worry, once it's off of you, anything I put in it won't wind up in your womb."
                );
            if (this.player.hasBreasts())
                this.outputText("  I could even make off with your tits if you like.");
        } else
            this.outputText(
                "  Sadly, you don't have anything that would be worth taking right now.  A true shame, my [Master]."
            );
        this.outputText('</i>"');
    ...
    private ceraphFollowerCockTaking(smallest = false): void {
        this.spriteSelect(87);
        this.clearOutput();
        ...
        const y: number = x + 1;
        this.outputText(
            "You sigh and undress enough to point at your [cock " +
                y +
                '], indicating that Ceraph is welcome to have it.  Ceraph titters, "<i>With pleasure, my [Master].</i>"'
        );
        this.outputText(
        ...
        this.outputText(
            " in her hand!  At the base there's smooth flesh and an arcane mark, somehow keeping the disembodied dick alive to pulse and squirm in her grasp.  The place on your groin is left completely smooth and featureless, as if it had never been there at all.",
            false
        );
        this.outputText(
    ...
    private ceraphFollowerCuntTaking(): void {
        ...
        this.clearOutput();
        this.outputText(
            'You undress, just enough to point at your [vagina].  Ceraph smiles happily and muses, "<i>I have just the troublesome slut that could learn a thing or two by having her mouth replaced by a pussy.  Face-fucking is such an effective discipline technique, thank you dear.</i>"'
        );
        this.outputText(
    ...
    private ceraphFollowerTitTaking(rowNum = 0): void {
        this.spriteSelect(87);
        this.clearOutput();
        ...
        this.outputText(
            "You pull down your [armor] to bare your bosom to Ceraph and indicate that you'd like her to take it.  She smiles like a cat who's gotten the cream and whispers, \"<i>Your wish is my command, [Master].</i>\""
        );
        this.outputText(
            "\n\nCeraph bounces your " +
    ...
    private stuffSomeNippleCunts(): void {
        ...
        this.clearOutput();
        this.outputText(
            "Wanting to take advantage of some of the more extreme of your body's changes, you pull down your [armor] to bare your hungry nipple-twats, the well-lubricated tips of your nipples slowly opening in anticipation of what's to come.  You kick the discarded gear aside and command, \"<i>Slave, fuck my nipples.</i>\""
        );
        this.outputText(
        ...
        this.outputText(
            ".  She grabs your [chest] to examine, and her fingers probe hesitantly around the entrances of your budding chest-cunnies.  Ceraph smiles with wicked intent.  Her fingers thrust in forcefully, drawing a sensual moan from your lips as she violates "
        );
        ...
        if (this.player.totalNipples() > 2)
            this.outputText(
                "  She moves from pussy to pussy with ease, exploring every single one of your myriad holes, a gleeful smile on her face."
            );
        if (this.player.lactationQ() > 0)
            this.outputText(
                "  A squirt of breastmilk nearly takes your slave in the eye, your milk letting down uncontrollably from the tit-puckering finger-fuck."
            );
        if (this.player.hasCock())
            this.outputText(
                "  [EachCock] is so hard by this point that it's smearing its pre-cum all over Ceraph's belly, but she doesn't mind."
            );
        if (this.player.hasVagina())
            this.outputText(
                "  As for your [vagina], you've grown more than wet enough for a hard dicking, but honestly, right now, all you want is your [nipples] to be perfectly and completely fucked."
            );
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outputText(
        ...
        if (this.player.bRows() > 1) {
            ...
            this.outputText(
                " to sprout beneath her top pair, the demoness's chest mimicking yours in size and structure.  While the top pair of super-sized nipples continue to grow into massive teats, Ceraph repeats her caresses lower, and the newly-formed nipples mimic their big brothers, filling out to obscene length."
            );
        }
        this.outputText(
            "  At first, the changes make her areola look more like something that belongs on an udder, but as they enlarge beyond even that, you realize they're taking on a distinctly masculine shape, with a slight ridge just below their bulbous tips.  After growing out almost seven inches, the upward-curving nipples stop filling out.  Ceraph has sprouted nipple-dicks!"
        );
        if (this.player.averageNipplesPerBreast() > 1)
            this.outputText(
                "  She strokes them, one by one, and they split down the middle, dividing into a multitude of penises, a perfect match to your quad-nipplecunts."
            );
        this.outputText(
        ...
        this.outputText(
            "\n\nYour freakishly-endowed minion steps forward with an enthusiastic expression plastered on her face, taking care and time to line up each of her tit-mounted tools with your [nipples].  Ceraph glances up at you deferentially, and you nod, perhaps a bit more eagerly than you intended to.  At once, " +
                CeraphFollowerScene.num2Text(this.player.totalNipples()) +
        ...
        this.outputText(
            "\n\nBiting down on Ceraph's lower lip, you get her to pull back long enough for you to command, \"<i>Cum inside me pet, fill my tits!</i>\"  Ceraph's violet eyes cross ever so slightly, the black sclera glittering with moisture as her eyelids flutter in rapture.  She throws herself down on top of you with bruising force, bottoming out all " +
                CeraphFollowerScene.num2Text(this.player.totalNipples()) +
                " twitching dicks inside you, just in time to release their creamy cargo.  Gods, she's filling you up so good!  You reach up with your hands and squeeze the edges of your [chest] hard enough to feel the rigid, cum-spouting flesh inside you.  Jizz wells up from each entrance in sync as you begin to tremble and shake.  Ceraph lets out a low moan as she fills you"
        );
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outputText(
                ", her cock spouting its own ivory wetness onto your belly in sympathetic release."
            );
        else this.outputText(", her pussy dripping weakly in sympathetic release.");
        this.outputText(
            "  Her hands run through your [hair] and pull your [face] into her shoulder.  She holds you tightly, clingingly even.  If you weren't so enraptured by the sensation of your sperm-filled nipples, you might actually care."
        );
        this.outputText(
            "\n\nThe two of you slowly relax, dueling climaxes winding down to return some level of sanity at last.  As soon as the demoness' eyes uncross, she stands up, " +
                CeraphFollowerScene.num2Text(this.player.totalNipples()) +
                " dicks sliding free of clutching, spunk-stuffed twats at once.  You gasp and shudder, the sensitive flesh nearly setting you off again.  As she stretches, Ceraph's new appendages shrink, losing their masculinity and even faster their size.  You rise while trying to ignore the runnels of demon-spunk that spout from your well-fucked chest, your [chest] wobbling fantastically with the extra fluid weight.  Ceraph leans over to suck a [nipple] into her mouth, and after a few quick swallows, she sighs contently."
        );
        this.outputText(
    ...
    private portalFuckWithFollowerCeraph(): void {
        this.spriteSelect(87);
        this.clearOutput();
        const x: number = this.player.cockThatFits(100);
        const y: number = x + 1;
        // FIRST TIME:
        if (this.flags[kFLAGS.TIMES_CERAPH_PORTAL_FUCKED] == 0) {
            ...
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 1)
                this.outputText(
                    "  Of course, you don't seem to like that appendage, so my ring won't get much use today, will it?"
                );
            this.outputText('</i>"');
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 1)
                this.outputText(
                    "  Ceraph twirls one of the rings into her palm, where it promptly vanishes in a puff of purple smoke."
                );
            this.outputText(
            ...
            this.outputText(
                "You suggest Ceraph retrieve her fantastically enchanted cock-rings, and with an impish smile, your slave produces a pair of them in puffs of purple smoke."
            );
            if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 1)
                this.outputText(
                    "  She sadly teleports one of them away, knowing you've commanded her to stay female for you."
                );
            this.outputText(
                '  The mauve miscreant tosses your ring to you, still warm from her body heat and tingling with the embedded magic.  She requests, "<i>Please, [Master], do me like you did before!  It was so hot for you to watch me like that!</i>"'
            );
        }
        this.outputText(
        ...
        this.outputText(
            ".  She scoots her ass up so that it's resting against your [legs] and the front side of the chair, a tantalizing heart-shaped butt just within arms' reach.  You give it a slap, which garners a delighted coo from the tainted slut."
        );
        this.outputText(
            "\n\nNow that everything is in position, it's time for the moment of truth.  You push the ring down on your [cockHead " +
                y +
                "] until the warm metal frame is snugly secured just above your [sheath].  The tingling you could feel when it was in your hand was a mild pinprick compared to the prickling sensations it shoots through your [cock " +
                y +
                "].  They aren't unpleasant, but they are certainly intense, and combined with the tightness of the ring, they keep you nice and hard."
        );
        if (this.flags[kFLAGS.TIMES_CERAPH_PORTAL_FUCKED] == 0)
            this.outputText(
                "  Well, your dick doesn't look any different, aside from the gilden adornment stuck near the bottom.  Now, if it were hilt-deep in the demon's cunt, that would be something!"
            );
        else
            this.outputText(
                "  Well, no sense wasting time!  You look down at Ceraph's moist box and imagine your dick spearing through her folds."
            );
        this.outputText(
            "\n\nWhite light flashes along with a wave of tingling pinpricks under the ring on your [cock " +
                y +
                "]!  You blink and look down, seeing a strange arcane symbol INSIDE the cock-ring's center.  That glimmering glyph has become the terminus of your suddenly-stunted, plateau-like member.  Ceraph's coo of pleasure tears your gaze further down, and you see a matching glyph just above her pussy, with the rest of your [cock " +
                y +
                "] completely buried into her wetness.  You don't just see it, you can feel it too.  Her wet snugness is molding around your girth, yielding to the intrusion like a glove wrapping around a hand."
        );
        this.outputText(
        ...
        this.outputText(
            "\n\nYou stand up and stretch, your cock still lodged tight in Ceraph's cooch.  Alas, all good things must come to an end, and with one slow tug, you remove the ring from your [cock " +
                y +
                "] (and your maleness from her cunt).  You toss the borrowed item back to her, letting it fall on your slave's heaving bosom as she tries to recover, a fucked-out mess in the dirt.  You turn to get dressed, and when you glance back, Ceraph is gone, until the next time you call for her."
        );
        this.player.orgasm();
        this.dynStats("cor", 1);
    ...
    private layEggsInSlaveCeraph(): void {
        ...
        if (this.player.hasCock())
            ...
            this.outputText(
                '  Ceraph frowns as she glances towards your crotch.  She is disciplined enough to answer you quickly, however, with a sharp "<i>Yes, [master].</i>"'
            );
        ...
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outputText(
                "  The whole garment creaks and strains under the pressure of her hardening member."
            );
        ...
        if (this.flags[kFLAGS.CERAPH_HIDING_DICK] == 0)
            this.outputText(
                "; unable to keep it penned up, her demonic cock spills out the side, waving back and forth obscenely as you saw the offending garment into her crotch"
            );
        this.outputText(".");

        this.outputText(
            '\n\n"<i>Stop!</i>" Ceraph cries as you jerk the bottoms back and forth savagely, "<i>I\'ll take them off, ' +
                this.player.mf("Master", "Mistress") +
                "!  I'm sorry!</i>\""
        );
        ...
        if (!this.player.isTaur())
            this.outputText(
                ", and your fingers tremble slightly as you trace its segmented length, leaving a trail of lubricating mucus from tip to base"
            );
        this.outputText(
            ".  When you order your demonic slut to present her pussy to you, she slides an impeccably manicured hand between her thighs, opening her dark, glistening lips for you."
        );
        ...
        if (this.player.gender > 0)
            this.outputText(
                "Your orgasm spatters your degraded demon's rear, adding to the sopping mess your ovipositor is leaving.  "
            );
        this.outputText(
    ...
    private sumissivenessToCeraphFollower(): void {
        ...
        this.spriteSelect(87);
        this.outputText(
            "When you broach the idea of submitting to your fetish queen, delight washes across Ceraph's face.  Before another word can be spoken, she lashes out with her whip (where did she get that from?) and catches you around the neck with the taut leather, yanking hard enough to drag you to the ground and make you sputter for air.  The shining leather slides off as soon as your hands hit the ground, but the demoness is already standing above you, pushing on you with her stiletto-like heels to roll you aside."
        );
        this.outputText(
            "\n\n\"<i>That's a better place for a useless little " +
                this.player.mf("boy", "girl") +
                ' like you, down in the dirt where you belong,</i>" the demoness declares, pacing back and forth.  She crouches next to you and whispers in your ear, "<i>The safe word is \'apple\', you pitiful pig.</i>"'
        );
        this.outputText(
        ...
        this.outputText(
            "\n\nYou start to stand up, but Ceraph again lashes out with her whip, striking you across the back four or five times.  It's hard to keep count through the pain.  Stinging welts rise on your " +
                this.player.skin() +
                ", and a heady thrill runs through your groin.  You're totally stiff by the time she finishes the punishment, and it's plainly visible to the cruel hermaphrodite above."
        );
        ...
        if (this.player.gender == 3) {
            ...
            this.outputText(
                ".  Your hardness is easily visible to anyone who knows where to look, and the demoness definitely knows where to look"
            );
        this.outputText(".");

        this.outputText(
            '\n\nCeraph smirks and asks, "<i>Does my subby slut like it when I play rough?  Or did you just get hard when you realized how right I am?  There\'s no shame in enjoying your station, pet.  After all, animals are there to please their owners.</i>"  She strokes your ' +
                this.hairDescript() +
                " with an unfamiliar gentleness.  It's like a pleasant balm after the rough whipping, and you find yourself leaning into it, accepting the demeaning affection just to feel something that doesn't hurt."
        );

        this.outputText(
            '\n\n"<i>Good ' +
                this.player.mf("boy", "girl") +
                ',</i>" the purple-skinned dom coos as she begins to undress you, keeping you on the ground the whole time.  "<i>Let\'s get you out of these pesky clothes.  Good pets are naked, and I can see how <b>hard</b> you\'re trying to be a good pet.</i>"  Her hand dances across '
        );
        ...
        this.outputText(
            ", savoring your state.  You groan out loud at the sudden sensation, and a bead of "
        );
        if (this.player.hasCock())
        ...
        this.outputText(
            ".  The crystal-clear droplet of congealed lust slowly begins to dangle down, connected for a few seconds by a string of moisture before it snaps and disappears into the dirt."
        );

        this.outputText(
            '\n\n"Oh, pet is dripping?</i>" Ceraph wonders aloud as she stands and pivots, immediately taking a seat on your back.  "<i>Perhaps pet is feeling a little pent up.</i>"  She loops the whip around your neck and tugs slightly, enough to make you realize that she could control your breathing right now, if she wanted to.  The damnable magic of that whip has your blood boiling, and the erotic tingle of the treated leather against your ' +
                this.player.skinFurScales() +
                ' doesn\'t help.  Another drop falls, and you start to answer, "<i>Yes...</i>"'
        );
        this.outputText(
    ...
    // [Either Once]
    private barkToCeraphOnce(dog = true): void {
        this.clearOutput();
        this.spriteSelect(87);
        this.outputText('"<i>');
        ...
        this.outputText(
            "like... like that!  Her whip snaps taut before dragging you back.  You scrabble in the dirt for a half-second, choking yourself before you give up and sag limply down at her feet.  Slowly, you lift your [butt] up into the air to allow Ceraph access, regretfully yielding to her like you should have initially."
        );
        ...
        if (this.player.ass.analLooseness == 0) {
            this.outputText(
                "Even though you're a virgin, the cunt-slick tool worms its way into your rectum with ease, the nodules massaging your sorely-stretched anal ring as it accommodates to handle the bigger width, forever ruined by Ceraph's boner."
            );
        } else if (this.player.analCapacity() < 20)
            this.outputText(
                "Even though you're pretty tight, the cunt-slick tool slides into your rectum with ease, the semi-soft nodules massaging your anal ring as it adjusts to the heated impalement."
            );
        else if (this.player.ass.analLooseness >= 4)
            this.outputText(
                "The cunt-slick tool has no problem wiggling inside your well-used and abused asshole, hilted in a split second, the hundreds of nubs gently caressing your anal ring like a lover as they nestle inside you."
            );
        else
            this.outputText(
                "The cunt-slick tool slides right on in thanks to your capacitative anus, the gentle nubs each massaging your snug ring as they slide on through."
            );
        this.outputText(
            "  You groan as you're taken by your owner, catching yourself halfway and arresting the pleasured grunt as soon as you can, but it doesn't matter - the damage is already done."
        );
        ...
        this.outputText(
            ", and you give up another grunt of pleasure while your hips press harder against your owner's."
        );
        ...
        if (this.player.hasCock())
            ...
            this.outputText(
                "rubs against your quivering vaginal walls, stimulating you from the inside out"
            );
        ...
        this.outputText(
            " into a pool on the floor as you're expertly brought to a tingly, body-quivering, anal orgasm.  It can barely be called an ejaculation, really.  The "
        );
        ...
        this.outputText(
            ".  Ceraph continues to push, but her dicktip slips off its mark, and she quickly buries herself back inside, each nodule responsible for small blurts of jism as they slip across your orgasmically tightening "
        );
        ...
        if (this.player.hasCock())
            this.outputText(
                "Ironically, [eachCock] has begun to lose some of its stiffness, and you grow limper and limper as more of your cum leaks from you"
            );
        else
            this.outputText(
                "Strangely, the more femcum that leaks from your winking, tender twat, the more your body tingles and shivers with barely-constrained delight"
            );
        this.outputText(".");
        ...
        this.outputText(
            '.  Ceraph purrs, "<i>I told you that I was a good owner, didn\'t I?  Now just lie there and enjoy myself on your sensitive tush.</i>"'
        );
        ...
        this.outputText(
            " and start to push back against her before long.  Those nodules rub your insides so well, and they keep you dripping wasted "
        );
        ...
        this.outputText(
            " the entire time, tingling in ecstatic pleasure.  Soon, you're panting hard while Ceraph's hips slap off your [butt] hard enough to sound like miniature thunderclaps, and your poor "
        );
        if (this.player.hasCock())
        ...
        this.outputText(
            " being smashed flat.  Warmth explodes inside your intestines, slowly spreading out around the flaring, demonically enhanced dick as it orgasms.  You can hear your owner's lady-spunk splattering into the ground behind you as she whimpers, \"<i>G-g-good... " +
                this.player.mf("boy", "girl") +
                '...</i>", her dick firmly spraying its thick, tainted milk '
        );
        ...
        this.outputText(
            ".  You scrunch your eyes closed as Ceraph claims your ass for her own, and "
        );
        if (this.player.hasCock()) {
            ...
            this.outputText(
                "your pussy lets go of the last of its sticky, slippery snatch secretions"
            );
        this.outputText(".");
        if (this.player.cumQ() >= 700)
            this.outputText(
                "  It floods out everywhere.  You're just so productive that your hands and [legs] sink partway into the mess."
            );
        ...
        this.outputText(
            " for you to gobble down, and she pats you on the head as you gratefully accept your reward."
        );
        this.outputText(
            '\n\n"<i>Good, ' +
                this.player.mf("boy", "girl") +
    ...
    // [Either Twice]
    private barkOrMeowTwiceToCeraph(dog = true): void {
        this.clearOutput();
        this.spriteSelect(87);
        this.outputText('"<i>');
        ...
        this.outputText(
            " happily.  For some reason, the idea of denying yourself release in exchange for more humiliation is appealing to you."
        );
        ...
        else if (this.campCorruptJojo()) choices[choices.length] = 1;
        choices[choices.length] = 2;

        const select: number = choices[CeraphFollowerScene.rand(choices.length)];
        ...
        if (select == 0) {
            ...
            // {Intimidated Holli}
                ...
                this.outputText(
                    ",</i>\" she says, thrilled to see you so debased and no longer concerned with obeying you.  The shame is more potent than a minotaur's spunk, and when combined with the magic of your demonic 'collar', it twists in your head, twining inexorably with arousal to make you leak even harder.  It feels soooo good to wallow in the piteous, condescending touches."
                );
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cockTotal() > 1) this.outputText("s");
                this.outputText(
                    ", which has the unintended side-effect of making it puff up even harder"
                );
            } else
                this.outputText(
                    "your rebellious clitoris, which has the unintended side-effect of making it and your drooling cuntlips puff up, redder than ever before"
                );
            this.outputText(".  ");
        ...
        // Corrupt Jojo or Amily
            ...
            if (
                ...
                this.outputText(
                    " says, dropping to all fours and crawling up alongside you.  Ceraph tears a strip of their clothing off nonchalantly and fixes it into another improvised collar that she ties on to her whip.  The three of you then continue the walk, though you're scolded again and again when you and "
                );
                if (!jojo) this.outputText("Amily");
                else this.outputText("Jojo");
                ...
                this.outputText(
                    " sexual scent is more than distracting.  Ceraph squirts the two of you with water a half-dozen times to keep you from fucking, and each time the shame is greater.  You really are a pet, one that can't even keep " +
                        this.player.mf("his", "her") +
                        " most basic needs in check."
                );
            }
            ...
            if (
                ...
                this.outputText("s");
            this.outputText(
                ", and you thoroughly enjoy the degrading experience.  Lust and humiliation are all jumbled up inside you into one big mass of sex, such that getting turned on from this humiliates you, and being humiliated gets you even more aroused"
            );
            this.outputText(
                ".  It's an endless feedback loop of sexual excitement that has you about to blow, except you're back in camp.  The collar is untied, and your owner's sweet voice whispers, \"<i>Good walk, pet.</i>\" before vanishing into the wind."
            );
            ...
            if (
                ...
                this.outputText(
                    "look around uncertainly before darting back to their usual places, knowing you'll give the command if you want them to take care of your desires."
                );
            else
                this.outputText(
        ...
        // Generic
            ...
            if (this.player.cockTotal() > 1) this.outputText("es");
            this.outputText(
                ", and often offer Ceraph a bounty of gems to fuck you.  Your mistress insists that you don't need any such sexual release, because you are a good "
            );
            if (dog) this.outputText("doggie");
            else this.outputText("kitty");
            this.outputText(
                " and get all you need out of obedience.  Her words draw an exaggerated whimper from your lips along with a few fresh drops of pearly "
            );
            if (this.player.hasCock()) this.outputText("cock");
            else this.outputText("cunt");
            this.outputText(
                "-cream, but you hold still, [legs] quaking eagerly.  It feels like all it would take to get your release would be a few soft touches on your aching "
            );
            if (this.player.hasCock()) this.outputText("cock");
            ...
            this.outputText(
                ' holds it up in front of her nose and sniffs it, sighing, "<i>' +
                    this.player.mf("He", "She") +
                    " certainly does seem to be well tamed, miss demon.  You're lucky you caught " +
                    this.player.mf("him", "her") +
                    " before I did.  With "
            );
            if (this.player.hasCock())
                this.outputText(
                    "cum this nice, I'd be milking " +
                        this.player.mf("him", "her") +
                        " dry every time " +
                        this.player.mf("he", "she") +
                        " could get it up"
                ...
                this.outputText(
                    "a scent like this, I'd be fucking " +
                        this.player.mf("him", "her") +
            ...
            this.outputText(
                " onto the ground while you whine softly.  Your owner notices and commands, \"<i>Now, pet, we can't have you making this "
            );
            ...
            this.outputText(
                ".  The trail of musky slime that clearly marks your journey is another thing though."
            );
