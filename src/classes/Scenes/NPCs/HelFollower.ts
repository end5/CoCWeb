...
export class HelFollower extends NPCAwareContent {
    ...
    public heliaFollowerIntro(): void {
        ...
        if (this.player.tallness > 84) this.outx("waist");
        else this.outx("shoulders");
        this.outx(
        ...
        if (this.flags[kFLAGS.HARPY_QUEEN_EXECUTED] > 0) this.outx("kill");
        else this.outx("bring down");
        this.outx(
    ...
    private iCantLetFireButtsRapeMyCampsButt(): void {
        ...
        if (
            ...
            this.outx("like usual");
        this.outx(', and maybe you and I can spend some quality time together.  Alright?"</i>');
    ...
    public helFollowersIntro(): void {
        ...
        // If Bimbo Sophie is at Camp:
            ...
            if (this.player.inte >= 40 || this.player.inte / 5 + HelFollower.rand(20) + 1 > 10) {
                this.outx("Or, maybe there's a way to make this work...");
    ...
    private bootHelOutForBimboSophie(): void {
        this.clearOutput();
        this.outx('<i>"Nope, you get out,"</i> you answer, scowling at the salamander.');
    ...
    public angryHelAndIzzyCampHelHereFirst(): void {
        ...
        this.outx('hat are YOU doing here?!"</i>');
    ...
    public PCBeatsUpSalamanderSparring(): void {
        ...
        if (this.monster.HP < 1) this.outx('<i>"Kick my ass a little harder, why don\'t you?"</i>');
        else this.outx("<i>\"Turn me on till I can't think straight, why don't you?\"</i>");
        this.outx(
    ...
    private talkToHel(): void {
        ...
        // Hel Talk 4(C)
            ...
            // Hel Talk 4(C)
            this.outx("You ask Hel if she has a few minutes to spare.");
            this.outx(
        ...
        // Hel Talk 5(C)
            ...
            if (this.helSpawnScene.helPregnant()) this.outx("beer ");
            else this.outx("fizzy, non-alcoholic beer ");
            this.outx(
            ...
            this.outx("\n\nHel laughs ");
            if (!this.helSpawnScene.helPregnant()) this.outx("drunkenly");
            else this.outx("happily");
            if (!this.helSpawnScene.helPregnant()) {
                this.outx(
                ...
                if (this.kihaFollower.followerKiha())
                    this.outx("further pissing off Kiha, who throws a rock at Hel, and ");
                this.outx("shooting up like a beacon over the wasteland.");
            } else {
                this.outx(
        ...
        // Hel Talk 6 (Needs Isabella and Kiha at camp; at least 1 gem)(C)
            ...
            if (!this.isabellaAccent()) this.outx(", obviously only somewhat interested");
            this.outx(".");
    ...
    private hugASmokeyTail(): void {
        ...
        if (this.model.time.hours >= 21) {
            ...
            if (this.player.tailType > TAIL_TYPE_NONE) this.outx("s");
            this.outx(
    ...
    private centaurMountsCampHel(): void {
        ...
        if (this.player.cockArea(x) > this.heliaCapacity())
            this.outx("she can cram in, the rest of your length twitching between her legs");
        else this.outx("you have to offer her");
        this.outx(
    ...
    private heliaFollowerTentafuck(): void {
        ...
        if (this.player.balls > 0) this.outx("[balls]");
        else this.outx("wriggling tentacles");
        this.outx(
    ...
    private muddyLizardFeet(): void {
        ...
        if (this.player.balls > 0) this.outx("her heel coming to caress your taut sack");
        else if (this.player.hasVagina())
            this.outx("her heel brushing against the nub of your [clit]");
        else
            this.outx(
        ...
        else this.outx("your groin meets Helia's, your [cock] wholly enveloped within her");
        this.outx(
    ...
    private takeABath(): void {
        ...
        // {Repeat Intro (If you taught Hel to swin; else, play 1st Time)}
            ...
            this.clearOutput();
            this.outx("You ruffle Hel's hair and ask if the fiery salamander's up for a dip.");
            this.outx(
    ...
    private teachHelToSwim(): void {
        this.clearOutput();
        this.outx("Putting a hand on Hel's shoulder, you offer to teach her how to swim.");
    ...
    private heliaAndVapula(): void {
        ...
        if (!this.followerHel()) {
            this.outx("  You kiss her and ask if she'll be able to find her way back to her home.");
    ...
    private dudeHeliaAndKihaThreeSome(): void {
        ...
        if (this.player.cockTotal() == 1)
            this.outx("the rest of your shaft, her own tongue coiling around your tool");
        else
            this.outx(
    ...
    private helGuardToggle(): void {
        ...
        // [If Hel IS guarding Camp]
            ...
            this.outx("You tell Hel she doesn't need to keep watch at night anymore.");
            this.outx(
    ...
    private heliaAnalTrainingPrompt(): void {
        ...
        if (this.player.tallness < 60) this.outx("her bosom towering over you");
        else if (this.player.tallness < 72) this.outx("towering over you");
        else if (this.player.tallness < 90) this.outx("meeting you eye to eye");
        else this.outx("looking up at you confidently");
        this.outx(" as she boldly reaches into your [armor] to squeeze your ");
        if (this.player.cockTotal() > 1) this.outx("biggest ");
        this.outx(
    ...
    private giveHeliaAnalTraining(): void {
        ...
        if (this.player.cockTotal() > 1)
            this.outx("selecting the biggest and heaviest to stroke as you near her");
        else this.outx("grabbing it and stroking it as you near her");
        this.outx(
        ...
        if (this.player.balls > 0) this.outx(", hard enough to lift your nuts in their [sack]");
        this.outx(
    ...
    private yesMakeHeliaAGapeSlut(): void {
        ...
        this.outx(". The slutty salamander eventually pulls it off and ");
    ...
    private goWithHelia(): void {
        ...
        if (
            ...
            if (this.camp.companionsCount() > 1) this.outx("s are");
            else this.outx(" is");
            this.outx(
        ...
        // if less than 7' PC:
        if (this.player.tallness < 84) this.outx("sweeping you off your feet");
        else this.outx("hanging off you");
        this.outx(
        ...
        if (this.player.tallness <= 72) this.outx(", her head resting on your shoulder");
        this.outx(
        ...
        */
        ...
        if (this.flags[kFLAGS.HARPY_QUEEN_EXECUTED] > 0)
            this.outx("who forgave us for the queen's death");
        else this.outx("who wanted to be friends still, even after the Tower");
        this.outx(" and... it sort of became a thing.  Hope you don't mind!</i>\"");
        ...
        if (this.flags[kFLAGS.FREED_VALA] == 1)
            this.outx("a certain waitress fairy having... supplied the icing herself");
        else this.outx("a certain minotaur chef having supplied the icing himself");
        this.outx(
        ...
        if (this.flags[kFLAGS.HEL_FOXY_FOURSOME_WARNED] == 1)
            this.outx("a pair of lovely fox-eared herms");
        else this.outx("Miko and Mai");
        this.outx(
    ...
    private heliaDrinks(): void {
        ...
        // if PC is male:
        if (this.player.hasCock() && this.player.hasVagina()) this.outx(" just as you do");
        this.outx(
    ...
    private heliaPhoenixes(): void {
        ...
        if (this.flags[kFLAGS.HARPY_QUEEN_EXECUTED] > 0) this.outx("dead");
        else this.outx("deposed");
        this.outx(
        ...
        this.outx(", and you figure you know what they mean.");
    ...
    private heliaAndFoxTwins(): void {
        ...
        if (this.flags[kFLAGS.HEL_FOXY_FOURSOME_WARNED] == 1) this.outx("Mai");
        else this.outx("one of the foxes");
        this.outx(
    ...
    private helAndSluttyHarpyMale(): void {
        ...
        if (this.player.biggestCockLength() >= 8) this.outx(" no longer be hilted inside");
        else this.outx(" slip out of");
        this.outx(
        ...
        // 2-3 cocks
            ...
            if (this.player.cumQ() < 500) this.outx(" with your cum");
            else {
                this.outx(" full of cum");
                if (this.player.cumQ() <= 1000) {
                    this.outx(" until it overflows");
                    if (this.player.cumQ() >= 5000) this.outx(", pooling around your knees");
                }
            }
            this.outx(".");
            if (this.player.cocks.length == 3)
                this.outx(" Your unused cock splatters the two with hot, white jizz.");
            if (this.player.vaginas.length > 0)
                this.outx(
        ...
        // > 4 cocks
            ...
            if (this.flags[kFLAGS.HELIA_ANAL_TRAINING] == 0) this.outx(" tight");
            else if (this.flags[kFLAGS.HELIA_ANAL_TRAINING] == 1) this.outx(" well-trained");
            else if (this.flags[kFLAGS.HELIA_ANAL_TRAINING] >= 2) this.outx(" gaped");
            this.outx(
            ...
            if (this.player.cocks.length > 4)
                this.outx(" Your extra cocks spray pearly cum all over the nearby ground.");
            if (this.player.vaginas.length > 0)
                this.outx(
