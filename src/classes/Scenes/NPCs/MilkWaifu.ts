...
export class MilkWaifu extends NPCAwareContent {
        ...
        if (kGAMECLASS.farm.farmCorruption.hasTattoo("milky")) {
            ...
            if (kGAMECLASS.farm.farmCorruption.milkyFullTribalTats()) {
                ...
                if (this.flags[kFLAGS.MILKY_TATTOO_COLLARBONE] != "")
                    this.outputText(this.flags[kFLAGS.MILKY_TATTOO_COLLARBONE] + "\n");
                if (this.flags[kFLAGS.MILKY_TATTOO_SHOULDERS] != "")
                    this.outputText(this.flags[kFLAGS.MILKY_TATTOO_SHOULDERS] + "\n");
                if (this.flags[kFLAGS.MILKY_TATTOO_LOWERBACK] != "")
                    this.outputText(this.flags[kFLAGS.MILKY_TATTOO_LOWERBACK] + "\n");
                if (this.flags[kFLAGS.MILKY_TATTOO_BUTT] != "")
                    this.outputText(this.flags[kFLAGS.MILKY_TATTOO_BUTT] + "\n");
            }
        }
    ...
    private milkBathTime(): void {
        ...
        if (this.flags[kFLAGS.MILK_SIZE] == 0)
            this.outputText(
                "starting to shift her breasts' bulk toward a comfortable spot for a nap"
            );
        else
            this.outputText(
                "struggling to her feet, legs shaky with the afterglow of a might boobgasm"
            );
        this.outputText(".");
    ...
    private relaxWithMilkWaifu(): void {
        this.clearOutput();
        this.outputText(
            "You sit in the tub for a while, letting the fragrant fluids soak into your " +
                this.player.skinFurScales() +
                ".  You spend the better part of an hour lounging, letting your cares float away in " +
                this.flags[kFLAGS.MILK_NAME] +
    ...
    private communalBath(): void {
        ...
        if (this.emberScene.followerEmber())
            this.outputText(
                "\n\nEmber approaches the pool, reptilian tail swishing eagerly.  " +
                    this.emberScene.emberMF("He", "She") +
                    " lowers " +
                    this.emberScene.emberMF("himself", "herself") +
                    " in with ease, sighing contentedly as milk washes over " +
                    this.emberScene.emberMF("his", "her") +
                    ' scaled body.  "<i>Is this how you humans bathe normally?</i>"  ' +
                    this.emberScene.emberMF("He", "She") +
        ...
        this.outputText(
            "\n\nWithout prompting, " +
                this.flags[kFLAGS.MILK_NAME] +
                " shifts around to rub a little milk into your skin, gently bathing you.  Her dark fingers run through your hair, washing it thoroughly before moving down to your arms, [chest], and legs, cleansing every inch of your " +
                this.player.skinFurScales() +
                ".  You relax to " +
                this.flags[kFLAGS.MILK_NAME] +
    ...
    private pullInZeMilkGirl(): void {
        ...
        this.outputText(
            ".  Before you can get too far, though, " +
                this.flags[kFLAGS.MILK_NAME] +
                " turns on a heel, her huge rack pushing you back through the milky pool and then against the opposite rim.  You're dazed for only a brief second before her breasts press firmly into your back, so hard that a new streak of milk pours from her teats, wetting your back much as you did hers.  You relax against the rim as she cups up handfuls of milk, rubbing it into your own hair and shoulders, deft fingers massaging every muscle in your back with the skill of the greatest masseuses, and you can feel the tension bleeding from your muscles.  You yawn powerfully, resting your chin on your arms and letting the milky girl massage you, coating your " +
                this.player.skinFurScales() +
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.balls > 0)
                this.outputText(
                    ", her other hand cupping your [balls], rolling the " +
                        MilkWaifu.num2Text(this.player.balls) +
    ...
    private fuckDatMilkSlat(): void {
        ...
        this.outputText(
            "Sitting behind the milky girl, chest pressed to her back tight enough to feel her every breath, you can't help but feel " +
                this.flags[kFLAGS.MILK_NAME] +
                "'s full, round ass brushing against your " +
                this.cockDescript(x) +
        ...
        this.outputText(
            "\n\nOne of your hands drifts down from " +
                this.flags[kFLAGS.MILK_NAME] +
                "'s teats, fingers tracing along her supple skin and ample curves to the hem of her panties.  You pull them down with one smooth motion, baring the full mounds of her dusky ass cheeks.  She pushes back immediately, humping up and down your rod as you work to free yourself from your [armor].  Finally, your " +
                this.cockDescript(x) +
        ...
        this.outputText(
            "\n\nYou shift forward ever so slightly, dragging your " +
                this.cockDescript(x) +
                " from " +
                this.flags[kFLAGS.MILK_NAME] +
                "'s butt-cleavage and into the welcoming embrace of her womanhood.  You both moan with lust as your " +
                this.player.cockHead(x) +
                " presses into her, parting the folds of her cunny to feel the hot touch of her walls kissing your tip.  You slide into her with measured ease, " +
                this.cockDescript(x) +
        ...
        this.outputText(
            "\n\nYou can feel your orgasm mounting, surging on as your " +
                this.cockDescript(x) +
                ...
                this.flags[kFLAGS.MILK_NAME] +
                " a hard spank right on the ass, making her shriek with pleasure and pain, her cunt squeezing your " +
                this.cockDescript(x) +
    ...
    private titFuckDatMilkSlut(): void {
        ...
        if (this.player.balls > 0)
            this.outputText(
                ", shivering as her tongue darts out around your cock to flick your nads"
            );
        this.outputText(".");
