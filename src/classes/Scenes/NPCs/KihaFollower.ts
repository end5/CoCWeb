...
export class KihaFollower extends NPCAwareContent {
    ...
    public kihaSpiderEventIntro(): void {
        ...
        this.outx(
            "\"<i>Bullshit!  You're working for the demons!</i>\" she howls.  \"<i>First you try and make me go soft, tell me I don't need to fight, and then suddenly you're sneaking into my home.  Well, no more!</i>\"  Her axe swings around to point straight at you.  \"<i>I've killed the Demon Queen's agents before, and if I have to, I'll kill you too, " +
                this.player.short +
                '!</i>"\n\n',
            false
        );
    ...
    public playerBeatsUpKihaPreSpiderFight(): void {
        ...
        this.outx(
            'To your surprise, Kiha hangs her head and whispers, "<i>Just go, ' +
                this.player.short +
                ".  You've already beaten me, and they'll punish me for my weakness...  I deserve whatever's coming to me.  So JUST GO!</i>\"\n\n",
            false
        );
    ...
    private warnKihaOfHerImpendingDemise(): void {
        ...
        this.spriteSelect(72);
        this.outx(
            '"<i>Kiha! Behind you!</i>" you shout, desperately pointing at the group of monsters closing in behind her.\n\n',
            false
        );

        this.outx(
            'She smirks.  "<i>Come on, ' +
                this.player.short +
                '.  What do you think I am, stupid?</i>"\n\n',
            false
        );
    ...
    private helpKihaAgainstSpoidahs(): void {
        ...
        this.outx(
            "\"<i>W-what are... what do you think you're doing, " +
                this.player.short +
                '?</i>" she snaps, recoiling away from you.  "<i>I told you to run!</i>"\n\n',
            false
        );

        this.outx(
            'Beckoning once again with your hand, you look at her with as much seriousness as you can manage and say, "<i>Join with me if you want to live.</i>"\n\n',
            false
        );
    ...
    public beatSpiderMob(): void {
        ...
        this.spriteSelect(72);
        this.outx(
            '"<i>Fall back!</i>" screams the largest of the two driders, clutching a nasty wound you\'ve left on her breast.  "<i>Let\'s get out of here!</i>"[pg]',
            false
        );
        ...
        this.outx(
            '"<i>Why, ' +
                this.player.short +
                '?</i>" she asks, her voice barely more than a whisper.  "<i>Why... why did you help me?  I tried to hurt you, and you just... turned around and saved me.  I don\'t get it.</i>"[pg]',
            false
        );
        ...
        this.outx("[pg]You ");
        if (this.player.cor < 50) this.outx("squeeze her shoulder and ");
        this.outx("tell her that maybe now, the two of you can be friends.");
        ...
        this.outx(
            '[pg]"<i>H-hey, ' +
                this.player.short +
                '!</i>"  Kiha suddenly shouts, causing you to turn at the shore.  "<i>D-don\'t forget... um, I mean... remember where this place is, all right?  Friends, uh, visit each other sometimes, I guess.</i>"',
            false
        );
    ...
    public kihaFriendlyGreeting(output = true): void {
        ...
        if (
            output &&
            this.flags[kFLAGS.KIHA_AFFECTION_LEVEL] == 1 &&
            this.flags[kFLAGS.KIHA_TALK_STAGE] >= 7
        ) {
        ...
        if (output && this.flags[kFLAGS.KIHA_TALK_STAGE] == 6 && this.player.cor <= 50) {
            ...
            this.outx(
                '[pg]"<i>Bah!  You just watch, ' +
                    this.player.short +
                    ".  The queen bitch isn't just sitting on her ass; she won't rest until the whole world's ruined!  The demons already ruined the seasons, caused an endless drought.  Who's to say they can't shoot a giant dick into the sky, or make it rain corrupted cum forever, until we're all slavering monsters?  What's to stop them, huh?</i>\"",
                false
            );
            this.outx(
            ...
            this.outx(
                "[pg]\"<i>Then why... why haven't we done something, " +
                    this.player.short +
                    "?  Why couldn't we just have gone... together?</i>\"",
                false
            );
            this.outx(
            ...
            this.outx("You walk over to the ring of trees and call out for the dragoness.", false);
            ...
            this.outx(
                '[pg]"<i>Oh, uh, hey, ' +
                    this.player.short +
                    ',</i>" she says leaning on her greataxe.  "<i>It\'s... good to see you again, I guess.  Did you, uh, want something?</i>"',
                false
            );
        }
        let talk;
    ...
    public winSparWithKiha(): void {
        ...
        if (!this.followerKiha()) {
            ...
            this.outx(
                "[pg]Even though it was just a mock match, you can clearly see the dragoness took the loss as a personal failure.  She flops back down, unable to rise again, and curses at herself.  \"<i>If... if I can't defeat you, " +
                    this.player.short +
                    ', how the hell am I supposed to beat Lethice?</i>"',
                false
            );
            this.outx(
            ...
            this.outx("[pg]You sigh and head back towards your stuff.");
            this.kihaAffection(20);
        }
        this.cleanupAfterCombat();
    }
    ...
    public sparWithFriendlyKihaLose(): void {
        ...
        if (!this.followerKiha()) {
            ...
            this.outx(
                '[pg]"<i>Bam. You\'re dead!</i>" she laughs, giving you a little pop on the chin before slinging it back over her shoulder.  "<i>Come on, ' +
                    this.player.short +
                    '!</i>"  she jeers, "<i>How the hell do you think you\'re going to beat the Demon Queen if you can\'t even beat me, huh?</i>"',
                false
            );
            this.outx(
    ...
    private hugFriendWarmKiha(): void {
        this.clearOutput();
        this.spriteSelect(72);
        this.outx("With a little grin, you grab Kiha in a tight surprise hug!");
        this.outx(
        ...
        this.outx("[pg]You shake your head and head on back to camp.");
    ...
    private talkToFriendlyKiha(): void {
        ...
        if (this.flags[kFLAGS.KIHA_TALK_STAGE] <= 3) {
            ...
            this.outx(
                "You ask the dragoness if she wouldn't mind talking for a few minutes.",
                false
            );
            this.outx(
        ...
        // Talk to Friendly Kiha - Third Time (Z)
            ...
            this.outx(
                '[pg]"<i>Dammit, ' +
                    this.player.short +
                    '!</i>"  she hisses, waving away the smoke.  "<i>I\'m fucking done talking!  Why the hell do you keep this shit up, huh?  All this talk and talk and talk!  You keep coming here, talking your precious morals and acting like you ACTUALLY give a shit about me.  Well, fucking stop!</i>"',
                false
            );
            this.outx(
    ...
    public kihaXSalamander(): void {
        ...
        this.outx(
            '[pg]She rises to her feet, leaning heavily on her greataxe.  "<i>Well, well,</i>"  she sneers, a thin grin on her lips.  "<i>Coming to visit me, ' +
                this.player.short +
                '?  How thoughtful.</i>"',
            false
        );
        this.outx(
            '[pg]You attempt to explain that you were just exploring, but before you can finish half a sentence, Kiha swings her axe up into a fighting pose.  "<i>Fuck that,</i>"  the dragoness growls.  "<i>I\'m in the mood for a fight, so come on, ' +
                this.player.short +
                "!  Put 'em up!</i>\"",
            false
        );
    ...
    private lieThere(): void {
        ...
        this.outx(
            '[pg]"<i>OH HELL NO, you scaly bitch,</i>"  Hel growls, leering down at Kiha as the dragoness leaps to her feet, axe raised.  "<i>You do NOT fucking touch my ' +
                this.player.short +
                ' and get away with it.  You hear me?</i>"',
            false
        );
        this.outx(
        ...
        this.outx(
            '[pg]"<i>That\'s right, you bitch.  So get your fat scaly ass out of the way!</i>"',
            false
        );
        this.outx(
            '[pg]"<i>FAT!?</i>"  Hel fumes, her tail swaying dangerously behind her.  "<i>You\'re just jealous you don\'t have an ass as fine as this one!</i>"',
            false
        );
        this.outx(
            '[pg]Kiha scowls, turning a half-circle so her muscular ass is clearly visible.  "<i>Ha! Like I have ANYTHING to be jealous of!  You\'re the one that ought to be jealous!</i>"',
            false
        );
        this.outx(
            '[pg]Hel stomps her foot in outrage.  "<i>Oh, fuck you! My ass is LEAGUES better than that mound of shitter-muscle.</i>"',
            false
        );
        this.outx('[pg]"<i>SHITTER MUSCLE!?!</i>"', false);
        this.outx(
            '[pg]"<i>Shitter muscle,</i>" Hel says with a sneer.  "<i>And to top it all off... You\'ve got small tits.  Why the hell would ' +
                this.player.short +
                ' want those little things over THESE,</i>" she laughs, cupping her big E-cups for emphasis.',
            false
        );
        this.outx(
            '[pg]"<i>Oh, like ' +
                this.player.short +
                ' would even look twice at those floppy things!</i>" Kiha growls, grabbing her own D-cups defensively.  "<i>' +
                this.player.mf("He", "She") +
                " OBVIOUSLY prefers smaller, perkier boobs.  Don't you, " +
                this.player.short +
                '?</i>"',
            false
        );
        this.outx(
            "[pg]You start to stammer an answer, but before you know it, Hel's put a foot on your chest, pushing you just a little deeper into the still-hot mud.  \"<i>How the hell would YOU know what " +
                this.player.short +
                " likes, huh?  <i>I</i> know exactly what makes " +
        ...
        this.outx(
            '[pg]Kiha yells in feral outrage.  "<i>HOW THE FUCK DARE YOU!?</i>"  she screams, storming over.  "<i>Get your filthy feet off ' +
                this.player.short +
                '!</i>"',
            false
        );
        ...
        this.outx(
            '[pg]Suddenly, Hel rises from the dirt beside you, her tail flaming dangerously.  "<i>Oh, FUCK YOU!</i>"  Hel cries, stamping back to stand beside Kiha.  "<i>How the FUCK would you know ANYTHING about what ' +
                this.player.mf("he", "she") +
        ...
        this.outx(
            '[pg]"<i>See?</i>"  Kiha shouts, grabbing at the stain you\'ve left on her thighs, "<i>' +
                this.player.short +
                " obviously likes me better - " +
                this.player.mf("he", "she") +
                " dropped " +
                this.player.mf("his", "her") +
                " cum RIGHT next to my vag.  " +
                this.player.mf("He", "She") +
                " probably wants to knock me up even, don't you, " +
                this.player.short +
                '?</i>"',
            false
        );
        this.outx(
            '[pg]"<i>Oh, is that right?</i>"  Hel laughs, giving her ample hips a shake forceful enough to dislodge your spooge, hitting Kiha full on the face.  "<i>' +
                this.player.short +
                " put a load right in my asscheeks - " +
                this.player.mf("he", "she") +
                " gave me the last AND the dirtiest load.  What do you get? Oh, that's right, a vag shot.  How unique!</i>\"",
            false
        );
        this.outx(
            '[pg]"<i>What would you even know about it, slut?</i>"  Kiha roars, breathing fire right in Hel\'s face.  The salamander just waves it off indignantly.',
            false
        );
        this.outx(
        ...
        this.outx(
            '[pg]"<i>Like her better!  Ha!  Come on, ' +
                this.player.short +
                ', you and I both know you like ME better.  AND that I give the best footsies.</i>"',
            false
        );
        this.outx(
        ...
        this.outx(
            '[pg]"<i>Fine,</i>"  Kiha says, putting up a cocky grin.  "<i>If ' +
                this.player.short +
                " can tolerate you, then I guess... you're welcome in my swamp, I guess.</i>\"",
            false
        );
        this.outx('[pg]"<i>And hey... if you ever go to the plains...</i>"', false);
        this.outx(
            '[pg]"<i>Not on your life, bitch!</i>"  Kiha yells, laughing, and shoots up into the air, raining mud and loam behind her.',
            false
        );
        ...
        this.outx(
            "[pg]Your [armorName] squelches wetly all the way, full of your cum as it is.",
            false
        );
        this.player.orgasm();
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private jumpDaBitches(): void {
        ...
        if (this.player.isBiped()) this.outx("stride over");
        else if (this.player.isNaga()) this.outx("slither over");
        else this.outx("move toward her");
        this.outx(
            ' and plant a [foot] on her chest, pinning her to the ground.  "<i>Hey, what the fuck!  Get off me!</i>"'
        );
        this.outx(
            '[pg]After what she just tried to pull, you tell her to sit down and shut up.  Behind you, Hel squirms around until you grab her arm and drag her over to sit by Kiha.  "<i>' +
                this.player.short +
                '!  I was trying to help you!</i>"  You just scowl and grab both scaly girls by the hair, dragging them up to kneel in front of you.  They squirm and struggle in your grasp, until you give the both of them a hand slap.  That shuts them up for the moment.',
            false
        );
        this.outx(
    ...
    private kihaAdmitsSheLikesYourWang(): void {
        ...
        if (this.flags[kFLAGS.KIHA_ADMITTED_WARM_FEELINZ] == 0) {
            ...
            this.outx(
                "While exploring the swamp, you find yourself in your dragoness friend's familiar territory.  Kiha, always one for a flashy entrance, glides down from the treetops, her wings casting a fearsome shadow over the clearing.  She lands with a light touch, just a few feet away from you and leaning casually on her axe.  The dragoness harrumphs, \"<i>Back to visit already?  Well, I guess you're better than some of the other beasties that could be calling on me.</i>\"  As always, she's trying to wrong-foot you, and before you can answer her insinuations, she keeps right on going, \"<i>Why do you keep coming around?  Don't you have any real friends?  It'd be kind of pathetic if I'm the only one you have to talk to.</i>\""
            );
            this.outx(
                "[pg]Kiha's scaly tail curls up beside you and gives you a playful swat on the rump.  You jump in surprise.  Wait a second... is she blushing?  Is that affection she has buried under her tough, mean demeanor?  A show of tenderness might widen the cracks in the wall around her heart..."
            );
            this.outx(
        ...
        // Warm Kiha Admittance Repeat
            ...
            this.outx(
                "Kiha lightly drops out of the trees in front of you, kicking up a small splash of fetid water as she comes to rest a few feet away.  She rests her axe over her shoulder nonchalantly and smiles as she says, \"<i>Did you come back to get your ass kicked?  You wouldn't be the first to throw fights so you could check me out while you're lying on the ground.</i>\"  Her tail swings around to playfully catch you on the " +
                    this.buttDescript() +
                    ', a hint of crimson spreading on her dark skin, matching the ruby hue of her shimmering scales.  Kiha strikes a battle-ready pose that looks a bit more lewd than normal as she asks, "<i>So, you here to fight, or waste more time talking?</i>"'
            );
            this.outx(
    ...
    private lovinHugKiha(): void {
        ...
        this.outx("[pg]Kiha looks ");
        if (this.player.tallness >= 95) this.outx("up ");
        else if (this.player.tallness <= 60) this.outx("down ");
        this.outx(
        ...
        this.outx(
            "[pg]The warrioress's axe stands a few feet back, like a silent sentinel.  It's been forgotten in the heat of moment.  Kiha's prodigious, normally suppressed libido reveals itself when she forces a long tongue into your mouth, tying up your own oral organ while her mischievous, clawed fingers gently remove your " +
                this.player.armorName +
                ", one piece at a time.",
            false
        );
        if (this.player.hasCock())
            this.outx(
                '[pg][EachCock] springs free, smacking into Kiha\'s thigh as it fully engorges.  She gives it a gentle pump before commenting, "<i>Acceptable, I suppose.</i>"',
                false
            );
        ...
        if (this.player.canFly())
            this.outx(
                "You could fly yourself, but you hang on for now, enjoying the embrace.",
                false
            );
        else
            this.outx(
                "You've no choice but to hang on to her for dear life as she lifts off.",
                false
            );
        this.outx(
    ...
    private lovingHugDickings(): void {
        ...
        if (this.player.biggestCockArea() > 100)
            ...
            this.outx(
                "How can you enjoy sex with something that small?  I don't know if I'll even feel it."
            );
        this.outx(
            '</i>"  She goes right on to squeeze ' +
                this.oMultiCockDesc() +
        ...
        if (this.player.biggestCockArea() <= 9) this.outx("little ");
        this.outx(
            "tool and you're putty in my hands.</i>\"  Tiring of her tirade, you summon up your strength and pull her down next to you, climbing atop her torso to rest your " +
                this.cockDescript(x) +
                " squarely between her tits.  You grab her nipples and roughly pull them inward, drawing a gasp of mixed pain and pleasure from your lover.  The gasp turns into a lurid moan once you begin sliding your dribbling dick through the brown-hued valley that is her cleavage",
            false
        );
        if (this.player.cocks[this.player.biggestCockIndex()].cockLength >= 36)
            this.outx(", even though you bump her repeatedly in the nose with your moist tip");
        this.outx(
            ".  Kiha's soft breasts envelop as much of your dick as possible in cushiony chest-flesh, and though she isn't as well-endowed up there as many of the women in this land, her extra-warm body-heat suffuses your member with more than enough pleasure to let you blow your load."
        );
        this.outx("[pg]");
        if (
            this.player.horseScore() > 4 ||
            this.player.dogScore() > 4 ||
            this.player.catScore() > 4
        )
            this.outx("Growling");
        else this.outx("Grunting");
        this.outx(", you clench for a moment as climax works through your body, expelling ", false);
        if (this.player.cumQ() > 400) this.outx("thick ");
        this.outx("jets of cum over Kiha's face, neck, ");
        ...
        this.outx(
            '[pg]You pointedly remind her that she already did.  She gets even redder, her tail lashing back and forth behind her from embarrassment. Kiha scowls and retorts, "<i>Well, I\'m not satisfied yet, so you better keep it up.</i>"  She gives your ' +
                this.cockDescript(x) +
        ...
        this.outx(
            "[pg]Hips thrusting, you fuck Kiha as if your life depended on it, and with the way she's clawing at your back, it just might!  Her tight, hot little pussy squirts small rivulets of dragon-jizz each time your " +
                this.cockDescript(x) +
                " batters its way back inside.  Her clawed feet cross behind your back after a particularly forceful push and trap you there, "
        );
        if (this.player.cockArea(x) < 50) this.outx("hilted inside her soaked love-tunnel,");
        else this.outx("as far in as your prodigious size with allow,");
        this.outx(
            " your " +
                this.player.cockHead(x) +
                " butting up against the entrance of her womb. Kiha turns and bites your shoulder while her tail spirals around the two of you, forcing you into the most intimate of embraces.  Her whole body quakes once, twice, and then goes into tiny, rhythmic convulsions.  A low, pleasured moan hisses out Kiha's mouth as her mouth disengages from your flesh, and you're able to see her eyes roll part-way back from the intensity of it all."
        );
        this.outx(
            "[pg]The dragoness's slippery cunt caresses your " +
                this.cockDescript(x) +
                " from root to crown over and over, begging you to release your seed.  You arch your back as much as you're able and happily comply.  Cum erupts from " +
                this.sMultiCockDesc() +
                " to claim its prize - your blissed-out mate's jizz-hungry uterus."
        );
        if (this.player.cockTotal() > 1) {
            this.outx("  Thanks to your ");
            if (this.player.cockTotal() == 2) this.outx("dual ");
            else this.outx("multiple ");
            this.outx(
                "manhoods, the twitching woman's front gets coated just as well as her insides."
            );
        }
        if (this.player.cumQ() >= 500)
            this.outx(
                "  Jet after jet of your creamy batter soaks the reptilian womb in spunk, the proof of your virility."
            );
        if (this.player.cumQ() >= 1000) {
            this.outx(
                "  It doesn't take long for you to flood the poor cum-receptacle and drizzle out onto the bed.  Feeling way too good to care, you just keep moaning while you "
            );
            if (this.player.cumQ() <= 2000) this.outx("fill Kiha's bed");
            else this.outx("turn Kiha's abode into your spermy swimming pool");
            this.outx(".");
        }
        this.outx(
            "  Even after as you wind down, the feisty woman's pussy seems to suck on your cock, still lost in its own pleasure."
        );
        this.outx(
            '[pg]Kiha continues to cum for some time, but eventually, she does come down from her orgasmic high.  Her distant, irritable demeanor seems gone (for now), and all you can see in her unusual eyes is love.  The dragoness holds you tight and whispers, "<i>Acceptable...</i>"'
        );
    ...
    private lovingHugsGirlFuckSex(): void {
        ...
        this.outx(
            '[pg]Kiha mutters, "<i>Gonna... gonna...</i>" into your pussy, but before she can finish, you slam yours down on her face, grinding yourself off on her nose while you take her to orgasm.  Your body burns with lust, and once you taste the warrior-woman\'s burst of girl-honey on your tongue, you moan and buck your ' +
                this.hipDescript() +
        ...
        if (output) {
            ...
            if (this.followerKiha()) {
                ...
                if (this.flags[kFLAGS.KIHA_CAMP_WATCH] > 0)
                    this.addButton(8, "Stop Guard", this.guardMyCampKiha);
    ...
    private hangOutWithKiha(): void {
        ...
        if (select == 0) {
            this.outx(
                "With a smile, you offer the dragoness your arm and ask if she'd like to take a walkabout.  She seems rather surprised at the suggestion, adding it's rather tame all things considered; but, with a little urging, you're soon walking arm in arm "
            );
            if (!this.followerKiha()) this.outx("through the dense overgrowth of the swamp");
            else this.outx("back to her old haunt in the swamp");
            this.outx(".");
            this.outx(
            ...
            this.outx(
                "[pg]You can't help but grin as she boasts of protecting her mate from the vile monsters of the realm. You know you could easily have beaten the drider, but you let Kiha have the moment - she's quite cute when she's being protective of you.  Before she can launch into a full-blown tirade, though, you grab the dragon-girl and pull her into a tight hug.  She lets out a short little gasp, but utterly melts in your arms when you plant your lips on hers."
            );
            this.outx('[pg]"<i>You... ');
            if (this.player.tallness >= 72) this.outx("big");
            else this.outx("little");
            this.outx(
                ' idiot,</i>" she whimpers when you finally break the kiss.  Gently, you stroke her cheek and thank her for "<i>protecting</i>" you.  A few minutes later and '
            );
            if (!this.followerKiha())
                this.outx(
                    "you're back at Kiha's little islet, waving to the dragoness as she flies back home and you head to camp"
                );
            else this.outx("you're walking arm in arm again, heading home");
            this.outx(".");
        }
        // Hang Out 2
        else if (select == 1) {
            this.outx(
                'You fish around in your mind for something you and Kiha can do together, but the dragoness herself surprises you by saying, "<i>So, uh, ' +
                    this.player.short +
                    ". I was just about to eat... I-I've got enough for two, if you want.</i>\"  You smile and tell her that would be lovely, thank you.  Awkwardly, she returns your grin, obviously unused to eating with others.",
                false
            );
            if (!this.player.canFly())
                this.outx(
            ...
            this.outx(
                "[pg]You start to question if she expects you to eat raw... whatever it is... but the dragoness cuts you off mid-sentence by rearing back and belching up a burst of flame onto the mystery meat, roasting it instantly and singeing the hairs on your face.  She lets out a boisterous laugh as you shake off the rather explosive effects of her fiery breath, but you have to admit it was effective: your meal is now a pile of medium-well cooked strips fit to be eaten."
            );
            this.outx(
                "[pg]Satisfied with her handiwork, Kiha sits down across from you.  She stares at you for a long moment, glancing quickly from you to the smoking meat in front of you.  Apparently, she wants you to take the first bite.  Gingerly, you pick up a strip of the greasy meat and, looking into Kiha's waiting eyes, pop it into your mouth."
            );
            this.outx('[pg]"<i>W-well?  It\'s good... right?</i>"');
            this.outx(
        ...
        // Hang Out 3
            ...
            if (!this.followerKiha()) {
                ...
                if (this.model.time.hours < 21)
                    this.outx(
                        "particularly cloudy day above you, with great pink and purple clouds drifting across the demonically-tainted horizon"
                    );
                else this.outx("stars are out, a thousand little pin-pricks in the heavens", false);
                this.outx(".");
            } else {
                this.outx("Looking up from your dragoness lover, you note the particularly clear ");
                if (this.model.time.hours < 21)
                    this.outx(
                        "day around your camp - thick pink and purple clouds are rolling lazily over the wasteland, shimmering behind the great maw of the portal"
                    );
                else
                    this.outx(
                        "night in the wastelands.  The stars are out, as they always are at night in your part of Mareth, a thousand thousand little pin-pricks in the heavens"
                    );
                this.outx(".");
            }
            this.outx(
                "[pg]With your dragoness friend close at hand, what might have been an average "
            );
            if (this.model.time.hours < 21) this.outx("day");
            else this.outx("night");
            this.outx(
                " seems suddenly romantic.  With a playful grin, you wrap an arm around Kiha's supple waist, point up to the heavens and bid her look at the "
            );
            if (this.model.time.hours < 21) this.outx("clouds");
            else this.outx("stars");
            this.outx(
                ".  The dragoness does as you ask, following your pointing finger up to the sky."
            );
            this.outx(
                '[pg]"<i>Hey,</i>" she says, snuggling close in your arms.  "<i>I remember what you said a while ago, after I... when you and I first looked up at the sky.  I\'ve been thinking about what you said, doofus.  You\'re stupid sometimes... but you\'re not wrong.</i>"'
            );
            this.outx(
                "[pg]Kiha grins at you - before you know it, you're on the ground, wrapped tight in the dragoness's powerful arms, face pressed between her soft, dusky mounds.  You shift a moment in her grasp before settling in, cuddling up to your lover and staring with her into the heavens.  Kiha holds you close, resting her chin on the crown of your head, occasionally running her scaly fingers through your [hair] or brushing your thighs with her long, flexible tail.  You bask in her warmth, a soft glow that spreads throughout your body; you nuzzle your cheek into her pillowy bosom, looking for a moment from the sky to the beautiful woman holding you."
            );
            this.outx(
                "[pg]Kiha's been staring at you for a long time, it seems.  She smiles at you as your gazes meet, her hand running through your hair one last time.  \"<i>Oh, you "
            );
            if (this.player.tallness >= 72) this.outx("big");
            else this.outx("little");
            this.outx(
            ...
            this.outx(
                "[pg]Time seems meaningless in your draconic lover's embrace, yet eventually you know you must part - for the moment.  Giving her another long kiss, you pick yourself up from between Kiha's hefty bosom and, say your goodbyes."
            );
            this.outx(
                '[pg]Kiha gives you a wry smirk as you extricate yourself from your arms.  "<i>I\'ll see you soon... Doofus.</i>"'
            );
        }
        this.doNext(this.camp.returnToCampUseOneHour);
        this.kihaAffection(5);
    ...
    private boneTheShitOutofKihaHolesWithHorsecock(): void {
        ...
        if (this.player.horseCocks() > 0) {
            ...
            while (this.temp > 0) {
                this.temp--;
                if (
                    this.player.cocks[this.temp].cockType == CockTypesEnum.HORSE &&
                    this.player.cockArea(this.temp) >= 40
                ) {
                    x = this.temp;
                    y = x + 1;
                    break;
        ...
        this.outx("You remove your [armor] as you close in with Kiha, happy to let the ", false);
        if (this.player.minLust() < 50) this.outx("half-turgid");
        else this.outx("always semi-hard");
        ...
        this.outx(
            ".  \"<i>Idiot, you're gonna get raped pulling stunts like this, you know that, right?</i>\" Kiha asks, gazing you up and down with a hungry look in her eyes.  You shrug and get closer, doing your best to ignore the puff of flame that shoots from her nostril as she snorts in disdain, \"<i>Fine, I'll help ya with this, but it's only because I wanna bring Lethice down.  I don't normally like this sort of thing.</i>\""
        );
        this.outx("[pg]Kiha drops down to her knees");
        if (this.player.isTaur()) this.outx(", crawling under your horse body");
        this.outx(", the better to examine your ");
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("bestial equine dong");
        else this.outx("[cock " + y + "]");
        this.outx(" and its slowly-filling ");
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("flared ");
        this.outx(
            "tip.  A single dollop of creamy ooze drips from the wide, semi-dilated cum-slit in the center to plop on the floor, a strong reminder of your unquenched lust and potent virility.  The powerful warrioress sniffs experimentally, taking in the musky, aromatic odor of your thick maleness.  She licks her lips as she cradles the heavy shaft in her hands.  It pulses hotly from her touches, thrumming with each hammering beat of your heart.  She seems distracted by something, but shakes her head to clear it."
        );
        this.outx(
            "[pg]You part your lips to speak, ready to inquire about Kiha's distraction, at least, until Kiha's dark, spit-glossed lips press against your urethra, slowly spreading across the top of your "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("flare's mesa");
        else this.outx(this.player.cockHead(x));
        this.outx(" as she opens wide.  ");
        if (this.player.hasSheath()) this.outx("She pumps you just above the sheath");
        else this.outx("She pumps your shaft");
        this.outx(" with one hand, using slow, even strokes that tickle every sensitive area.  ");
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE)
            this.outx(
                "Her other caresses the skin of your sheath, fingers slipping in between the folded outer skin and your dick's concealed, untouched flesh.  "
            );
        else if (this.player.balls > 0)
            this.outx(
                "Her other fondles your [balls], steadily increasing your desire for release.  "
            );
        else
            this.outx(
                "Her other fondles your taint, steadily increasing your desire for release.  "
            );
        this.outx("It feels almost supernaturally sensitive.");
        if (this.player.inte < 20) {
            this.outx("  An unthinking, ");
            if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("bestial whinny ");
            else this.outx("groan ");
            this.outx("of pleasure bursts from your lips, ");
            if (this.player.isTaur()) this.outx("hooves stamping as ");
            this.outx(
                "your concern for the dragon evaporating thanks to the pleasure coursing through your "
            );
            if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("animal");
            else this.outx("well");
            this.outx("-endowed form.");
        } else this.outx("  A ");
        ...
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE || this.player.isTaur())
            horse = true;
        this.outx("starts in your throat, but ");
        if (horse) this.outx("you catch yourself before you start braying like an animal");
        else this.outx("you catch yourself before it manages to escape your lips");
        this.outx(".  Between your inner embarrassment and the pleasure shooting through your ");
        if (horse) this.outx("animal");
        else this.outx("well");
        this.outx("-endowed form, you forget all about your concern for the dragon.");
        this.outx(
            "[pg]Filled with mirth, the fiery orbs of Kiha's eyes watch your every reaction.  Her lips slowly stretch into a wide, obscene 'O' in order to accommodate the entire circumference of your mouth-wrecking "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("beast-");
        this.outx("prick.  The ");
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("thick flare");
        else this.outx(this.player.cockHead(x));
        this.outx(
            " proves a satisfying challenge for your partner.  Working slowly, her jaw spreads wider and wider, the puffy softness of her lips squeezing and struggling waves of sensation up the root of your cock.  The blissful agony is soon over, as Kiha works the turgid "
        );
        if (horse) this.outx("animal ");
        this.outx(
            "endowment into the interior of her mouth, the dragon-like tongue coiling your member as easily as a snake encircles its prey."
        );
        this.outx(
            "[pg]Your reptilian lover bobs haltingly on your shaft.  Even with her efforts, she's struggling to slide more than a half-inch at a time through the lip-lined gateway to her mouth.  Consternated, she begins to pump you faster, "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE)
            this.outx(
                "her free hand eagerly caressing you inside your own sheath with inhuman warmth"
            );
        else {
            if (this.player.balls > 0)
                this.outx(
                    "her tongue working as much of your shaft as possible with inhuman warmth."
                );
            else this.outx("her free hand eagerly caressing your [balls] with inhuman warmth.");
        }
        this.outx(
            ".  Her eyes seem a trifle irritated, but the fire of arousal is far more visible in her gaze than that lesser, blighted emotion.  She works your dick like a woman possessed, rubbing, stroking, licking, and squeezing, every motion designed to please your "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE)
            this.outx("big, pony-like prick.");
        else this.outx("[cock " + y + "].");
        if (this.player.balls > 0)
            this.outx(
                "  Your [balls] smear and shudder against her chin, so tight, hot, and ready to explode."
            );
        this.outx("[pg]Kiha ");
        ...
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("flare");
        else this.outx(this.player.cockHead(x));
        this.outx(
            ", an incredulous yet hungry look plastered on her somewhat confused face.  The next second, she's gurgling and gulping, her mouth flooding with seed as you pump it out like a firehose.  "
        );
        if (c <= 250) this.outx("She manages to guzzle it all down without too much difficulty.");
        else if (c <= 1000)
            this.outx(
                "Her eyes water, and trickles of cum run from her nose, but she still manages to gulp most of it down."
            );
        else {
            this.outx(
        ...
        if (horse) {
            if (this.player.isTaur())
                this.outx(
                    "clambers out from beneath you, pulling herself onto a nearby rock, putting herself into position for your horse-body to mount her. She spreads her legs wide, her slick vagina releasing a tantalizing musk that begs for a cock to fill it"
                );
        } else
            this.outx(
                "leans back against a rock and spreads her legs, exposing you to a tantalizing, cock-filling scent"
            );
        this.outx(
            ".  Pre-cum trails from your tip in thick ropes, swaying beneath your bobbing, blood-filled "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("horse-");
        this.outx(
            "cock.  That aroma... that wondrous odor.  It fills your nostrils, and as your hormone-flooded consciousness slowly turns it over, you recognize it for what it is - breeding scent.  You're smelling a female... no, a fertile female - a bitch, a "
        );
        if (horse) this.outx("mare");
        else this.outx("slut");
        this.outx(
        ...
        if (this.player.cocks[x].cockType.Index > 0) {
            ...
            this.outx(
                '[if (isTaur = true) "throwing your hooves onto the rock, looming over Kiha" else "fondling your ' +
                    this.cockDescript(x) +
                    ' with one hand"]'
            );
        }
        this.outx(
            ", the bobbing motions flinging ropes of pre-cum from your " +
                this.cockDescript(x) +
                " every which way.  "
        );
        if (horse) this.outx('"<i>Fuck, am I... rutting?!</i>"  ');
        else this.outx('"<i>Fuck, why am I... ?!</i>"  ');
        this.outx(
            'you manage to wonder, instantly sidetracking yourself, "<i>Mmmm... yes... fucking...</i>"'
        );
        this.outx(
            "[pg]Kiha gives you an odd look when you roughly spread her legs and batter your "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("flat ");
        this.outx(
            "cockhead against her unprepared cunt.  A frightened squeak slips through her lips as you push harder and harder, eventually popping in with little care for your partners feelings - you're far too focused on plugging her womb full of your "
        );
        if (horse) this.outx("horse-");
        this.outx("spunk to worry about such trivialities.  The dragoness ");
        if (this.player.isTaur()) this.outx("punches your underside");
        else this.outx("tries to push you back");
        this.outx(
            ', shouting, "<i>What are you doing, [name]? HEY?! ARE YOU FUCKING LISTENING TO ME?</i>"'
        );
        this.outx("[pg]Growling in irritation, you pop out of the breed-ready ");
        if (horse) this.outx("mare");
        else this.outx("slut");
        this.outx(
            "'s cunt, and slap her across the face with your cum-dripping, pussy-wetted member.  Her eyes go wide in absolute, complete shock.  She didn't expect that.  Nevertheless, you press on, smearing your "
        );
        if (horse) this.outx("savage shaft");
        else this.outx(this.cockDescript(x));
        this.outx(
            " over her face and forcing her to get a good whiff of your potent cock-scent.  Her eyes gradually lose their focus, gravitating down the thick cylinder of "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("horse-");
        this.outx(
            "meat slapping at her cheeks.  Soon, she is licking it in a daze.  Her breeding-scent is now much stronger in the air, perhaps double what it was before.  Judging her ready, you give her jaw a gentle smack and return to your previous task: insemination."
        );
        this.outx(
            '[pg]Kiha babbles, "<i>Wh-what\'s g-going onnn... mmm... smells nice... fuck me?</i>"  Happily, you oblige.  After battering her lips open the first time, the repeat insertion goes much more smoothly, allowing the '
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE)
            this.outx("wide head of your stallion-shaft");
        else this.outx(this.player.cockHead(x) + " of your " + this.cockDescript(x));
        this.outx(
            " to spear through Kiha's entrance and into her womanly canal.  She groans appreciably, and the wordless exultations of your mate are all the encouragement you need to push deeper, shoving inch after inch of "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE)
            this.outx("well-lubed horse-dick");
        else this.outx(this.cockDescript(x));
        this.outx(
            " into Kiha's fully-dilated pussy.  The dragon-cunt is nice and tight around your large"
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx(", mammalian");
        this.outx(
        ...
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE)
            this.outx("flat-tipped horsecock");
        else this.outx(this.cockDescript(x));
        this.outx(
            " up against her inner entrance, pre-cum slipping through the tiny opening to baste her womb.  Each time you butt up against it, you feel Kiha's cervix give a little bit more, open up just a little wider.  Sweat runs down your body as you pump Kiha's cunt mercilessly, fucking her hard, just like the little "
        );
        if (horse) this.outx("mare ");
        else this.outx("slut ");
        this.outx(
            "deserves.  She's so very hot, practically burning up.  Her body even seems to steam from it as she writhes beneath you, but her hips begin to rise and fall to your tempo, obedient to your dominance and pliantly acquiescing  to your unspoken desire to mate."
        );
        this.outx(
            "[pg]You growl savagely and thrust particularly hard, easily popping your swollen cock-tip through her dilated cervix"
        );
        if (this.flags[kFLAGS.KIHA_CERVIXGINITY_TAKEN] == 0) {
            this.outx(" to steal her womb cherry");
            this.flags[kFLAGS.KIHA_CERVIXGINITY_TAKEN]++;
        } else this.outx(" to plow your favorite dragon-hole");
        this.outx(
            '.  Kiha winces and shakes her head, rousing from her sexual stupor to question, "<i>W-what, oh shit you\'re... you\'re breaking meeee!</i>"  She shudders and shakes as her eyes roll back from the raw sensation.  Panting and moaning, Kiha idly licks your cock-sludge from her lips and babbles, "<i>W-why is it so goooood?</i>"'
        );
        if (this.player.balls)
            this.outx(
                "  You slap your [balls] into in her ass hard as you thrust, smearing them all over her sweaty ass and tail."
            );
        else
            this.outx(
                "  You slap into her hard as you thrust, feeling her tail thrashing beneath your [butt]."
            );
        this.outx(
            "  The lust-lost warrior violently thrashes and begins to scream, not in pain, but bliss.  Her snatch clenches like a vice, wringing your "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("equine ");
        else this.outx("thick ");
        this.outx(
            "inseminator in achingly tight hotness.  You bellow and bury yourself fully inside of her, clenching heat surging out from your [balls], dick-tip "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("flaring ");
        else this.outx("engorging ");
        this.outx(
            "to seal itself inside your fuck-broken lover's baby-hole.  What feels like a gallon of seed lurches out from your cock.  Kiha's innards turn white from the creamy deluge"
        );
        if (c <= 250) this.outx(", stuffed up with hot cum");
        else if (c <= 1500) this.outx(", her belly inflating to pregnant proportions");
        else if (c <= 3000) this.outx(", her belly inflating to pregnant equine proportions");
        else
            this.outx(
                ", her belly distending hugely, grossly even, utterly filled with cum until it's squirting from her pussy in a river of white"
            );
        this.outx(".");
        this.outx(
        ...
        if (this.player.isTaur()) this.outx(" until the shaft bumps your belly");
        this.outx(".  You've just started to breed this bitch!");
        this.outx("[pg]Kiha's ");
        if (c > 250) this.outx("cum-gravid ");
        else this.outx("spunk-stuffed ");
        this.outx(
            "form proves easy to move.  She barely seems conscious of you - too busy sighing and rubbing at her pussy to really care how she's moved.  You wipe her cunt-stink from your shaft on the inside of her butt-cheeks, thankful that the scales fade to skin that close to her puckered tailhole.  Pulling her tail aside to give you a better view, "
        );
        if (this.player.isTaur())
            this.outx("you push her onto her hands and knees atop the rock and re-mount her, and ");
        this.outx(
            "you slide your cock between Kiha's sweat-soaked asscheeks.  Some small part of you is aware that there's no sense mating this hole, but with the air so heavily laden in fuck-scent, you don't really care."
        );
        this.outx("[pg]You shove your ");
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("flare");
        else this.outx(this.player.cockHead(x));
        this.outx(
            " against Kiha's tight anal opening, eliciting a squeal of surprise from your breeding bitch at the unexpected thrust.  Unfortunately, it's so tightly closed that you can't quite get in, even with all the juices soaking your cock.  Regretfully, you dip your dick into the river of slime that trails from your "
        );
        if (horse) this.outx("mare");
        else this.outx("slut");
        this.outx("'s cunny and try again.  Still, you cannot quite force your way in.  ");
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE)
            this.outx(
                "The unique shape of your cockhead makes such penetration difficult, but with animalistic stubbornness, you keep at it."
            );
        else
            this.outx(
                "The sheer size of your cockhead makes such penetration difficult, but with animalistic stubbornness, you keep at it."
            );
        this.outx(
            "  Battering against her pucker, relaxing, and circling the tight hole with your "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("flare");
        else this.outx(this.player.cockHead(x));
        this.outx(", you work her asshole until it begins to give.  It won't be long now.");
        if (this.player.isTaur()) this.outx("[pg]You reach down and grab Kiha's tail, providing ");
        else this.outx("[pg]The dragon's limp tail provides ");
        this.outx(
            "a suitable handhold to help level your tool into her dark, rear cavern.  Pulling hard on it, you ram forward, and at last, your slime-slicked "
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("horse-");
        this.outx(
            "cock pops through Kiha's sphincter to nestle in her gut.  She's blessedly hot, and her back-door feels twice as tight as her well-fucked pussy.  It will be more than suitable for breeding.  "
        );
        if (!this.player.isTaur())
            this.outx("You run a hand over her rump, stopping only to give it familiar slaps as y");
        else this.outx("Y");
        this.outx("ou force the rest of your thick ");
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("animal-");
        this.outx(
            "cock into the dragon's butthole.  Her tight, anal ring acts like a cock-ring for your immense member, keeping it ultra-hard inside her even as it kisses up "
        );
        if (this.player.hasSheath()) this.outx("to your sensitive sheath");
        else this.outx("to your sensitive loins");
        this.outx(
            ".  You realize you're too big for this to be comfortable for her, but you begin to fuck her ass anyway, knowing that as a female, she'll enjoy your dominance as much as she'll love being bred, even in the ass."
        );
        this.outx(
            '[pg]"<i>F-fuck, you\'re so goddamn BIG!</i>" Kiha cries as she pants in the dirt.  You can feel her stuffed womb sloshing against you through the thin walls of her guts'
        );
        if (c < 250) this.outx(", and see the unique equine shape buried in her tight tummy");
        this.outx(
            ".  Of course you're big, you think, you're the alpha, the " +
                this.player.mf("stud", "breeder") +
                ", the one in charge.  You "
        );
        if (this.player.isTaur()) this.outx("lean down to ");
        this.outx(
            "smack her rear in appreciation of your bitch's loyal service and jackhammer against her bouncy butt, holding tight to her tail lest it go wild from her pleasure."
        );
        this.outx(
            "[pg]Kiha begins moaning, and you occasionally feel her semen-soaked fingertips bumping against your "
        );
        if (this.player.balls > 0) this.outx("[balls]");
        else this.outx("sheath");
        this.outx(
            ".  She gives you encouraging squeezes while you destroy her anus, egging you on to utterly ravish her.  Those tender fingertips soon disappear back into the dragoness's hungry twat, masturbating her quim with your heavy spunk as lube.  You sneer and slap the bitch's cum-hungry ass, watching it jiggle slightly as the light reflects off the scaled portion.  Not satisfied with fucking every one of her body's holes in turn, you grab her ruby tresses and pull back, forcing your "
        );
        if (horse) this.outx("mare ");
        else this.outx("slut ");
        this.outx(
            "to arch her back into a serpentine curve.  The view nearly sets you off, but your body isn't quite ready to blow yet.  You need a little more."
        );
        this.outx('[pg]You command, "<i>beg,</i>" with ');
        if (horse) this.outx("the unquestionable authority of a herd alpha.");
        else this.outx("an unquestionable air of authority.");
        this.outx(
            '  Kiha twists her head slightly, wincing as it pulls her hair.  She can only get far enough to let you see one of her reptilian eyes, but you can see drool hanging from her dusky lips as she speaks, "<i>G-give it to me.  F-fill my ass.  Mount me!  CLAIM ME!</i>"  You grunt and bottom out in her gut, your '
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HORSE) this.outx("flare ");
        else this.outx(this.player.cockHead(x) + " ");
        this.outx(
            "spreading wide as you reach your absolute apex.  Cum surges through your body, stretching your urethra, opening the tip of your sensitive cumslit as it launches into your slut's rear.  She groans happily, her eyes rolling back and tongue lolling from her mouth.  Kiha's vocalizations aren't even words at this point, just animal grunts of pleasure, much like your own.  You flood her rectum with seed, pumping her rump with jism.  You hold her immobile against you until you finish inseminating her, and then, with a quick smack on her reddening cheek, you slide out and release her hair."
        );
        if (c >= 3000)
            this.outx(
                "[pg]A torrent of cum runs from her overfilled butthole and cunt.  It seems there just isn't enough room inside her to hold it all, and with two plus-sized loads in her bottom holes, most of it has to escape.  Even with that, she still looks heavily pregnant, a perfect tribute to your unholy virility."
            );
        else if (c >= 1000)
            this.outx(
                "[pg]A wash of cum runs from her overfilled butthole and cunt.  Even with that, she still looks heavily pregnant, a perfect tribute to your potent virility."
            );
        else
            this.outx(
                "[pg]Trickles of cum run from her butthole and well-ravished cunt, a potent reminder of your virility and the dominance you have over your females."
            );
        this.outx(
            '  Kiha rolls onto her side, cradling her belly, both holes gaping and marked by your spunk.  She mewls, "<i>So... good,</i>" and dips a finger back into her pussy, gathering up more of your seed to taste.'
        );
        this.outx(
            "[pg]You circle and lower yourself in front of her face, the perfect height, and you rest your cum-soaked shaft on her face, the " +
                this.player.cockHead(x) +
                " drooping into her hair to leak seed into the reddish tresses.  Kiha sniffs your "
        );
        if (this.player.balls > 0) this.outx("[balls]");
        ...
        if (this.flags[kFLAGS.KIHA_HORSECOCK_FUCKED] == 0) {
            ...
            if (this.player.cor <= 33) this.outx(" and wince");
            this.outx(", wondering just what caused you to go so lust-crazy.  ");
            if (this.player.lib < 80 && this.player.minLust() < 50)
                this.outx("Was it the lust draft?  Or");
            else this.outx("Was it");
            this.outx(
                " something Kiha's body - or yours - did?  You shake your head and hope she won't hold the incident against you."
            );
            if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1)
                this.outx(
                    '  Exgartuan suggests, "<i>She probably loved it if she had as much fun as I did.</i>"'
                );
        ...
        if (this.player.minLust() < 50 && this.player.lib < 80) {
            this.outx("[pg]<b>(You used up one lust draft!)</b>");
        }
    ...
    public kihaReactsToHorseDicking(): void {
        ...
        this.outx(
            "[pg]You push her back and look the teary dragoness in the eyes as you ask her what she means.  She replies, \"<i>You don't know?  Oh... okay.  Well... one of the things the demons did to us... it was supposed to make us able to manipulate our pheromones, in order to exploit our enemies.  We... we broke out before we learned how to use it.  I think... I might have used it a little bit when we had sex... and somehow... somehow I think I did it to both of us.  You might have even reacted to it somehow, I don't know.  You smelled so goddamn good!</i>\""
        );
        this.outx(
            "[pg]Wow!  You hug her again and laugh, glad that she seems to be okay after everything that happened.  She scowls and punches your shoulder, hard enough that it will probably bruise."
        );
        this.outx(
            '[pg]"<i>Idiot!  I all but mind-control you into a ravenous fuck-beast and all you can do is laugh about it?  You jackass!</i>" Kiha yells.  You pull her back into your arms and explain that it felt pretty goddamn good, even if things did get a little out of hand.  Kiha goes limp in your arms and whispers, "<i>...better than good, doofus.</i>"'
        );
        this.outx(
            '[pg]You ask her if she thinks she could do it again.  She looks at you, emotions warring behind her reptilian eyes before she answers, "<i>Maybe... I can\'t really control it.  If we acted like that again... I... it would probably happen again.</i>"'
        );
        this.outx("[pg]You aren't sure if she looks hopeful or scared.");
        this.outx("[pg]Do you want to do anything with Kiha?");
    ...
    private kihaPlaysWithBigassCocksFemDomAhoy(): void {
        ...
        if (this.player.tallness >= 84) this.outx("up ");
        else if (this.player.tallness <= 60) this.outx("down ");
        this.outx(
            "at you with feigned indifference, but her vertically slit eyes seem a tad more moist than normal.  Her warm, soft body heat suffuses you, rousing your loins to wakefulness.  Like a long-dormant beast, your " +
                this.cockDescript(x) +
                " rises from its slumber.  It snakes between your bodies, easily escaping from your [armor] to smush past Kiha's soft cleavage.  The [cockHead biggest] peaks out to nuzzle your scaly lover's cheek, pulsing hotly against the smattering of tiny, freckle-like scales that dot her visage"
        );
        if (this.player.cocks[x].cockLength > 48)
            this.outx(
                " for a moment before climbing higher.  It quickly blocks your view of your lover."
            );
        else this.outx(" for a moment before thickening and twitching against her.");
        this.outx("  Elephant in the room indeed.");
        this.outx(
            "[pg]Kiha nips at it with her teeth, pulling on your thick cock-skin to get your attention.  \"<i>A little over-eager, huh?  You're hopeless, doofus.  What'd you do, use Gro+ as lube?</i>\" she wonders, even as she peels you out of your [armor].  \"<i>You know, if you don't learn to control yourself, you're going to wind up strapped into a demon fucking machine for the rest of your life.  Though, with a dick like this, maybe that's what you've been getting ready for.</i>\"  Kiha sighs, \"<i>Pathetic,</i>\" and circles your [cockHead biggest] with delicate touches of her fingertips and feather-light caresses from her claws."
        );
        this.outx(
            '[pg]Smiling, you inform your domineering partner that you only got that way because of her.  Because her lovely, sculpted form was so very close to you.  She turns crimson (well, more crimson than normal), and slaps your [cock biggest] with her palm.  "<i>R-really... I did... THIS?</i>" she stammers.  You nod, as sagely as you can with an erection '
        );
        if (this.player.cocks[x].cockLength > 48) this.outx("bigger than");
        else this.outx("the size of");
        this.outx(
            " your torso.  Kiha actually giggles, a sound you never would have expected her to make when you first met, and she playfully begins to jack off your [cock biggest], humming happily when it gets slightly larger and harder in her hands."
        );
        this.outx("[pg]You lean back against a ");
        if (this.followerKiha()) this.outx("rock");
        else this.outx("tree");
        this.outx(
            " and sigh in contentment, happy to let Kiha tend to the omnipresent beast that hangs down with your [legs].  The heavy, sensitive burden that is your [cock biggest] is always making it hard to move, and worse, it practically immobilizes you when it gets hard.  But in moments like this, you're glad you have so much sensitive dick for Kiha's hands to explore"
        );
        if (this.player.cocks[x].cockType == CockTypesEnum.HUMAN)
            this.outx(", particularly your medial ring and the sensitive edge of your flare.");
        else if (this.player.hasKnot(x))
            this.outx(", particularly your massive, bulging canid knot.");
        else if (this.player.cocks[x].cockType == CockTypesEnum.DEMON)
            this.outx(", particularly the hundreds of demonic nodules that ring your shaft.");
        else if (this.player.cocks[x].cockType == CockTypesEnum.ANEMONE)
            this.outx(", particularly the groups of aphrodisiac laced tentacles under your crown.");
        else if (this.player.cocks[x].cockType == CockTypesEnum.TENTACLE)
            this.outx(", particularly the underside of your tentacle's mushroom-like tip.");
        else if (this.player.cocks[x].cockType == CockTypesEnum.CAT)
            this.outx(
                ", particularly the hundreds of rubbery spines covering your feline maleness."
            );
        else this.outx(".");
        this.outx(
            "  The whole world seems to spin as Kiha's attentions bring you to ever-higher levels of pleasure, and you grab hold of her hips to steady yourself when you nearly slide off your resting place.  She "
        );
        if (this.player.cocks[x].cockLength > 48) this.outx("pulls your cockhead down and ");
        this.outx(
            "sticks out a remarkably long, reptilian tongue.  It encircles your tip like a snake, though instead of crushing the life from its prey, it appears content to try and squeeze the cum out of you."
        );
        this.outx(
            '[pg]The onslaught of affection batters the strength from your [legs], leaving you to slump down to the ground.  Kiha gets down on her knees to maintain her position.  Her tongue untwists from around your [cock biggest] quickly, feeling so good it almost hurts and nearly unleashing your load at the same time.  She kisses the moist cum-slit at your tip and looks around your shaft, her lips coated in pre as she teases, "<i>Such a big, virile ' +
                this.player.mf("male", "specimen") +
                ', and yet... this thing makes you so easy to defeat.</i>"'
        );
        this.outx("[pg]Kiha twists her tail ");
        if (this.player.hasKnot(x)) this.outx("beneath your knot ");
        else {
            this.outx("around your base");
            if (this.player.hasSheath()) this.outx(", just above the sheath, ");
            else this.outx(" ");
        }
        this.outx(
        ...
        this.outx(
            '[pg]You nod, too overwhelmed by the symphony of touches up on your shaft.  Kiha shuffles closer, then spins around to sit half in your lap, half on her tail.  Her steamy box grinds on you while her ruby tresses tickle your nose and cascade in waves over your [chest].  The movement wraps another half-coil of tail around your [cock biggest], the bottom ring pulling even tighter, in turn making you even harder.  Kiha wraps her arms around your maleness for support and lifts her legs, placing the hot, supple soles of her feet on either side of your mammoth urethral bulge.  A huge dollop of pre-cum beads at your [cockHead biggest], but Kiha slurps it down before it can escape.  "<i>Can\'t have you running around covered in your own sex-stink can we?  Goblins would be all over you before you know it, and an idiot like you would probably make them all pregnant with this... this... mmm... uh, gross thing.</i>"'
        );
        this.outx(
            "[pg]Kiha interlocks her fingers and begins pumping you fast and hard.  Her feet rub along either side of your [cock biggest] in circular motions to the same tempo.  She leans back over her shoulder to kiss you, the dragon's extra-warm body temperature making you sweat and drip.  It's so hot... so very hot.  You can feel the warmth building in your core.  "
        );
        if (this.player.balls > 0)
            this.outx("Your balls clench and relax in time with the waves of pleasure, and y");
        else this.outx("Y");
        this.outx(
            'our dick feels ready to burst.  Kiha is shaken by your massive prick\'s twitching, and frenches you more aggressively before whispering, "<i>Go on, cum.  Cum for me, my toy.  Let your dick rejoice just this once, and cum for me.</i>"  Kiha circles your [cockHead biggest] with her tongue, lashing the saliva-soaked appendage back and forth across the summit of your bloated organ.  You groan loudly and clench, feeling the cum start to pump from your [balls], up through your bulging, flooding urethra.'
        );
        this.outx(
            "[pg]Kiha comments, \"<i>That's it, that's a good " +
                this.player.mf("boy", "girl") +
                ',</i>" just in time to watch the first globules of semen blast into the air.  You clench and unload another geyser of sperm into the air before the first rains down over Kiha, splattering over her hair and face'
        );
        if (this.player.cumQ() >= 1000)
            this.outx(", effectively bukkaking her from the sheer volume of your ejaculate");
        this.outx(
            ".  Some of it even hits you, but you're too busy clenching rhythmically, expelling every drop of your creamy white juicy into the air for Kiha's still-pumping soles.  "
        );
        if (this.player.cumQ() >= 2000)
            this.outx(
                "Wave after wave of spunk rains down over you, forming a gratuitous puddle and utterly, completely sliming you both.  "
            );
        this.outx(
            'Kiha shivers slightly and brushes a few ropes of jism away from her eyes as she says, "<i>Idiot!  You got me wet!</i>"'
        );
        this.outx(
            '[pg]You slump down with a dopey smile, dragging the spooge-spattered dragoness with you, back into a hug.  Kiha snorts a puff of fire in irritation, but admits, "<i>You know, if I do that to you... I wouldn\'t mind you getting all hot and bothered for me more often.  J-just keep it out of my hair next time, doofus!</i>"  She stands, uncoiling her tail from your slowly-softening shaft and stretching, forcing you to look at the absolutely soaked wetness of her pussy.  The lips are tinged reddish and enflamed with lust, though Kiha seems to manage it well as she saunters away towards a stream.'
        );
        if (this.flags[kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) {
            if (this.player.cor < 50)
                this.outx("  You hope she doesn't get jumped upby your tiger-shark children.");
            else
                this.outx(
                    "  You wonder what would happen if she got jumped by your tiger-shark children."
                );
        }
        this.outx("[pg]Wiping up as best you can, you don your [armor] and walk back");
        if (
            this.monk >= 5 &&
            ...
            if (!this.jojoScene.tentacleJojo())
                this.outx(", ignoring the sounds of Jojo feverishly masturbating in the woods");
            else
                this.outx(
                    ", ignoring the sound of Jojo vigorously fucking himself with all his tentacles in the trees"
                );
        }
        this.outx(".");
        if (this.sophieBimbo.bimboSophie())
            this.outx(
                "  Sophie greets you when you return, though she seems crestfallen once she smells the sex on you and realizes how thoroughly you've been sated."
            );
        if (this.amilyScene.amilyCorrupt())
            this.outx(
                '  Amily begs, "<i>May I help to service you next time, ' +
    ...
    private kihaGirlGirlSex(): void {
        ...
        this.spriteSelect(72);
        this.outx(
            "You pull Kiha into your arms and ask, \"<i>Up for a little play?</i>\"  She blushes and gives a tiny, curt nod.  You smile as you pinch Kiha's nipples softly, tweaking the dragoness's twin buds with just enough pressure to make them firm up in your grip.  Rolling them back and forth, you watch as Kiha's expression flashes between annoyance, desire, and unrepentant lust.  When you hear the 'drip... drip...drip...' of her juices on the ground, you know she's ready."
        );
        this.outx(
            "[pg]Kiha stands before you, back arched to present her chest to you, mouth open slightly, and pussy drooling wantonly.  Perfect! You lick the smooth curve of one of her well-rounded breasts, the soft flesh giving just the right amount when you nuzzle against it.  Even with Kiha's supernaturally warm body, you can feel her excitement heating her and see the telltale blush spreading through her chocolate-hued skin.  You lap at her nipple, then reluctantly part from her delectable breast-flesh to undress.  Tossing your [armor] to the side, you bare your body to the reptilian woman and reveal the flush of your own arousal."
        );
        this.outx(
            "[pg]The scaly texture of her tail suddenly encircles your waist and pulls violently to the side, yanking you down on to the ground.  A moment later, Kiha is on top of you, savagely kissing and nipping at your body - first your neck, then your collar bone, and then your nipples.  Nothing is safe from Kiha's crude affections, not even your pussy.  Kiha traces a fingertip down your navel, stopping just above your cunt.  You gasp, feeling deliciously hot and growing wetter and wetter from the thought of being caressed down there so roughly.  "
        );
        if (this.player.wetness() < 4) this.outx("Trickles");
        else this.outx("Small rivers");
        this.outx(
            " of lubricant run down your [legs] as Kiha molests you, always pulling back just when it seems she'll finally touch your feminine core."
        );
        this.outx(
            '[pg]In a flash, the dragoness flips about to smother your face in sopping muff.  "<i>Lick,</i>" she growls, simultaneously parting your labia with one of her knuckles.  You gasp in response, taking in a mouthful of dragon-cunt without meaning to, then lolling out your tongue to lick at your lover\'s tasty cooch.  Kiha sighs and massages your vulva with her palm, feeling your sensitive entrance up before putting her knuckle back inside.  She flicks her thumb over your [clit]'
        );
        if (this.player.clitLength >= 10)
            this.outx(", gasping when it grows to a ridiculous size.");
        else if (this.player.clitLength >= 3)
            this.outx(", humming appreciably when it grows to cock-like length.");
        else this.outx(", humming happily when it stiffens against her.");
        this.outx(
        ...
        this.outx(
            "[pg]The dragoness's clit swells slightly in your mouth, the only warning you get before a flood of tangy girl-spunk is released from Kiha's climaxing pussy.  Her tongue goes wild inside you, slamming back and forth at the walls of your vaginal canal, sending unintentional spikes of pleasure that make it hard to focus on the quivering cunt you're still pumping.  You give her clit one last lick, then give in to the pleasure and mash your " +
                this.vaginaDescript() +
                " back into Kiha's mouth and nose.  You cum just as hard as your lover, releasing a "
        );
        if (this.player.wetness() < 3) this.outx("trickle");
        else if (this.player.wetness() <= 3) this.outx("small gush");
        else if (this.player.wetness() <= 4) this.outx("river");
        else this.outx("explosion");
        this.outx(" of lady-spooge to mess her face.");
        this.outx(
            "[pg]Mouths stuffed in each others' twats, you lie with your lover, lazily lapping at fragrant girl-honey while your bodies shiver from aftershocks of bliss.  Kiha admits, \"<i>Okay, you're - lick - not too bad - lick - at this.</i>\"  You swat her rump and stroke her happily swaying tail before thanking her."
        );
        this.player.orgasm();
        this.dynStats("sen", -1);
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private savinTheAnalForKiha(): void {
        ...
        if (this.player.tallness >= 60) this.outx("her shoulders ");
        else this.outx("the small of her back ");
        this.outx(
            "and grabbing both of her lush, soft buttcheeks in your hands.  Kiha makes a show of growling and squirming in your grasp, but does not resist as you tease, eventually even swishing her tail over to rub your thighs and your own [butt]."
        );
        this.outx(
            '[pg]"<i>Gah!</i>"  the dragoness gasps as she feels your hardening ' +
                this.cockDescript(x) +
                ' pressing into her butt, barely restrained by your [armorName].  "<i>Oh, of all the things to obsess over!</i>"  she groans, but to your delight Kiha wiggles her hips in your grip, grinding her soft butt against your prick.  You give her a sharp little spank, and laugh as Kiha draws a sharp breath and clenches her derriere - just in time for you to free the beast, your ' +
                this.cockDescript(x) +
        ...
        // (depending on length:
        if (this.player.cocks[x].cockLength < 12) this.outx("belly");
        else this.outx("chest");
        this.outx(' and her butt.  "<i>You want a little assplay, is that it?  You ');
        ...
        this.outx(
            ".  Moving your hips in tandem with hers, the two of you must look to any observers like a couple engaged in some perverse dance, grinding, teasing, and groping at each other until you're both flush and Kiha's thighs are slick with her girl-lube"
        );
        if (this.player.hasVagina()) this.outx(", just as yours are");
        this.outx(".");
        this.outx(
            "[pg]Suddenly, Kiha thrusts her hips back - you stumble and fall, your back hitting a "
        );
        if (!this.followerKiha()) this.outx("tree");
        else this.outx("rock");
        this.outx(
            " nearby.  Before you can recover, Kiha's straddling you, a savage grin on her face.  \"<i>For a so-called Champion, you're a total pervert... After all that, I bet you wanna stick that,</i>\" she glances down to your stiff " +
                this.cockDescript(x) +
                ", already dribbling pre, \"<i>in my ass, don't you?  After all, you're so obsessed with it...</i>\""
        );
        this.outx(
            '[pg]You nod eagerly, your mind ensnared by her soft butt and the thought of your prick sliding into her tight, hot passage.  Kiha makes a <i>tsk</i> sound, "<i>Such a dirty mind, thinking about such dirty places,</i>" you groan as she, already positioned to easily just slide down on your cock, stands and steps back.  "<i>Oh, don\'t worry, I\'ll give you what you want.... but not yet!</i>"'
        );
        this.outx(
            "[pg]Kiha spits, her glob of saliva hitting the bottom of your cock with a warm, wet smack.  You shudder at the sudden heat on your " +
                this.cockDescript(x) +
                ", but it turns into a writhe of pleasure as Kiha grabs your prick between two of her big, scaly toes, her claws hanging menacingly around your girth.  She grins, looking over you as she pushes your prick back down against your belly.  Her supple, leathery soles press down on your rod, slowly sliding up and down your length, grinding her saliva into your cock, spreading her lubricant around."
        );
        this.outx(
            "[pg]You groan in need as the dragoness runs her scaly foot across your dick, desperately wanting to stick yourself into her warm hole, or even to buck your hips, but Kiha holds you down, her claws brushing gently across your sensitive crotch-flesh; your skin tingles at her lightest touch, made dangerously sensitive by the lack of penetration.  Kiha grins, watching the effect she's having on you, and spits again to add a bit more lube to your cock, rubbing it in at length with her soft heel. It doesn't seem as though she's satisfied, however."
        );
        this.outx(
            "[pg]Kiha takes her foot off your dick and slips down onto her hands and knees, crawling "
        );
        if (this.player.isNaga()) this.outx("along your long naga tail");
        else this.outx("between your [legs]");
        this.outx(
            ".  Her movements are slow, sensual, teasing as she advances on you.  Her large, dusky breasts brush the ground, stiff nipples coming to rest on either side of your abused prick, dabbling into the pool of pre and spit she's left around the base of your cock. Laying atop you, the dragoness takes her breasts and wraps them around your shaft, enveloping your " +
                this.cockDescript(x) +
                " in warm, soft titflesh.  You let out a low, animalistic moan as she drags her tits along the entire length of your prick, keeping them pressed tightly together and spitting again and again onto you.  Her tits are as good as a wet pussy, not too tight but deliciously wet. You desperately want to cum, to smear her big tits with your seed, and the mere thought causes a long trickle of pre to leak out of your " +
                this.player.cockHead(x) +
                ", adding itself to the sodden mess your lover's turned your shaft into.  Kiha grins devilishly at you, her long tongue flicking out to taste your seed."
        );
        this.outx(
            "[pg]\"<i>Mmm, not bad.  And so much... you must be dying to stick your cock in, aren't you?  Do you want that " +
                this.cockDescript(x) +
                " inside me, doofus; to feel my tight little asshole swallow you up? I think you're about ready...</i>\""
        );
        this.outx(
            "[pg]Kiha shifts, straddling your [hips] and spreading her ass cheeks wide.  She lowers herself, slowly, moving down just enough to let your sensitive " +
                this.player.cockHead(x) +
                " brush the tight ring of her pucker.  You both gasp at once, a little lightning bolt of pleasure connecting you for a fraction of a second.  Kiha groans, slowly sliding down, just enough so that your head pokes through her clenched sphincter, brushing against the hot, moist walls of her anal passage."
        );
        this.outx(
            "[pg]She stops, though, suspending your prick in the air between the two of you.  She reaches up, tweaking your [nipples] playfully"
        );
        if (this.player.biggestTitSize() >= 3)
            this.outx(" as she palms your " + this.biggestBreastSizeDescript(), false);
        this.outx(
            ".  She leans forward, pressing her chest to yours, as she wraps her arms around your shoulders.  She pulls you tight, holding you close as she resumes her descent upon your cock, her previously domineering attitude vanishing in a second as you stretch the walls of her anus.  Your well-lubricated cock has little trouble sliding into her, but the insertion is nonetheless nearly overwhelming.  Kiha's innards are hot and tight, squeezing down on your shaft like a warm, wet vice."
        );
        this.outx("[pg]You hug Kiha close, pulling her in tight as she finally ");
        if (this.player.cocks[x].cockLength >= 40) this.outx("bottoms out on your cock");
        else this.outx("rests her cheeks on your crotch");
        this.outx(".  Both of you are gasping and panting from the slow descent, Kiha ");
        if (this.flags[kFLAGS.TIMES_KIHA_ANALED] >= 5) this.outx("growing pleased by");
        else this.outx("unused to anal penetration");
        this.outx(
            " and you already so sensitive from edging again and again.  Kiha slowly rolls her hips, dragging out an inch of your cock at a time before her gripping asshole swallows it back up; when she moves, though, she's careful never to seperate the two of you, always holding each other close as she gently rides your " +
                this.cockDescript(x) +
                ".  You grin as she finally allows you to move, your hips reaching up to meet hers as she begins making short, quick bounces, still holding you tight enough to nip your ear and trace kisses along your neck."
        );
        this.outx(
            "[pg]You move together, pressing your cock deep into Kiha's hot bowels before withdrawing nearly to the tip.  Again and again your " +
                this.cockDescript(x) +
                " slides in and out of Kiha's asshole, slowly stretching her until the going gets easy.  She starts to pick up the pace, pulling you up from the "
        );
        if (this.followerKiha()) this.outx("rock");
        else this.outx("tree");
        this.outx(
            " you've been resting against and mashing your face between her pre-slicked tits as she starts to well and truly ride your dick, hammering her hips down and down again on your throbbing shaft until you're aching with the need for release."
        );
        this.outx(
            "[pg]Kiha bites her lip, moaning openly from the anal penetration.  Deciding not to cum alone, you reach down and sink a few fingers into her wet box.  She screams in pleasure as you snake your hand into her hot, needy cunt.  Instantly your fingers are submerged in her juices, warm and sticky and sweet.  You finger her for a moment, then bring your digits out and press them against Kiha's parted lips, letting the dragoness taste the need you've created in her.  She suckles on you, lapping up her own juices as you shift your other hand to fingering her, easily sliding a fist into her ready twat."
        );
        this.outx(
            "[pg]Your massive insertion nearly sets her off.  Kiha groans, grinding her teeth along your knuckles as you start to thrust into her faster, creating a double rhythm inside her.  You can feel your dick pounding her through her vaginal walls, and vice-versa.  Grinning, you try to touch yourself through her insides, straining and tickling Kiha's innermost depths - and touching a very certain spot."
        );
        this.outx(
            "[pg]Kiha screams and cums, clamping down hard on your fist and cock as gushers of hot girlcum flood out of her loins.  \"<i>Y-yeaaaahh!</i>\"  she cries, \"<i>Come on, you think... you think I'll just let you cum... Just like that!?  Just for getting me... getting me off til I can't - aaaahhhh! - think straight... and I'd let you cum too; shoot a big hot load right up that ass you're so obsessed with?</i>\""
        );
        this.outx('[pg]"<i>Well you\'re fucking right, dumbass!  CUM ALREADY!</i>"');
        this.outx(
            "[pg]Your lover's orgasm and crying demand launch you into your own climax.  Finally able to let yourself go, you unleash a torrent of white, hot seed into Kiha's asshole, shooting globs of spunk deep inside her.  She grips down on your " +
                this.cockDescript(x) +
                " hard, digging her claws into your shoulders and biting your neck, thrashing herself up and down your spasming shaft as the two of you cum together, riding out a powerful orgasm until your mind is nearly blank with pleasure."
        );
        this.outx(
            '[pg]By the time you recover, Kiha\'s turned around, now sitting in your lap, your cum-soaked cock stuffed up her ass and your hands wrapped around her waist.  She nestles against your chest, reaching back to run her fingers through your hair.  "<i>N-not bad, for a pervert,</i>" Kiha chuckles, rubbing the small part of your prick not tucked inside her.  "<i>If you\'re lucky... I might just let you do this again.</i>"'
        );
        this.outx(
            '[pg]Grinning, you give your dragoness a long, loving kiss on the lips.  You sit entwined for a long while, kissing and cuddling, until Kiha eventually draws herself off of you.  "<i>Don\'t just sit there all day, doofus,</i>" she teases, "<i>Don\'t you have demons to defeat?</i>"'
        );
        this.outx(
            '[pg]You give Kiha a playful swat on the butt as you depart, laughing as the impact causes a trickle of your cum to leak out and down her thigh.  "<i>Oh, you idiot!</i>"  she growls as you run off back to your duties.'
        );
        this.player.orgasm();
    ...
    private fuckKihasVagInCamp(): void {
        ...
        this.outx(
            "[pg]You close the intervening distance and climb atop your lover, meeting her heavy, lidded gaze with one of mirth and wonder, always amazed to have such unfettered access to Kiha's long closed-off heart.  She's beautiful, a sparkling ruby jewel you're fortunate enough to take for your own.  Kiha purrs, \"<i>Come on then, </i>lover<i>... show me this... love-making of yours.</i>\""
        );
        this.outx(
            "[pg]You need no further encouragement.  Taking your [cockFit 67] in hand, you rub it against Kiha's outer lips, the hot moisture from her furnace-like twat seeming to bubble over your crown.  The dragoness happily hums, \"<i>Mmmm, I could get used to this, if this is what 'love' is...</i>\" as you gradually increase the pleasure.  Her slit, while muscular, is as yielding and pliant as the rest of her right now, a moist fruit that is yours for the plucking. You slip right on inside her.  That cunt... that juicy, hot cunt... squeezes your [cockFit 67] with just enough pressure to make you twitch, spikes of pleasure firing nonstop through your rod until it seems to be flexing inside her, as hungry for the eventual release as you."
        );
        this.outx(
            "[pg]Kiha wraps her hands around your neck to pull you down for a wet, draconic kiss.  You respond by reaching back to give the dragon's booty a familiar squeeze, encouraging her to keep it up. She runs one hand's claws down your back, hard enough for the dagger-sharp tips to "
        );
        if (this.player.skinType != SKIN_TYPE_SCALES)
            this.outx("leave long, red scratches on your back.");
        else this.outx("dislodge the occasional old scale from your hide.");
        this.outx(
            "  The other stays in place, helping to hold you steadily in lip-lock, even while you impale her folds with your hard-as-adamantium dragonlance.  You thrust hard, pulling back from the dragon's dusky, pouting lips as you watch her facial expression gradually become even more lewd, forced into lasciviousness by your assault on her nethers."
        );
        this.outx(
            '[pg]Kiha whines, "<i>Mine... harder, please... give me... mine.</i>"  Her breathy exhalations are colored so thickly with unspoken desire you can practically see it in the air.'
        );
        this.outx(
            ' You nibble at her ear and whisper, "<i>Yes, and you\'re mine.  Lie back and take it.  All you have to do is enjoy it.</i>"'
        );
        this.outx(
            " The usually-serious dragon-girl nods into your shoulder as you begin to jackhammer at her cunt.  Juices soak your loins, small spatters spraying out from Kiha's pussy with each hip-jarring impact of groin to loin.  Faster and faster, you drive your [cockFit 67] into her sodden snatch.  It's perfect - a welcoming, hot little hole to snuggle your penis with pleasure until you can take it no longer.  The familiar upwelling of pleasure starts in your [balls], surging up through your waist until [eachCock] is spasming and unloading sticky white jets of love."
        );
        if (this.player.cockTotal() > 1)
            this.outx("[pg]Kiha's belly is quickly glazed white with goo, and her ");
        else this.outx("[pg]Kiha's ");
        this.outx(
            "pussy is soon filled up with the stuff.  She squeals in pleasure, wriggling slowly under you as she digs her claws into your arms involuntarily.  Rivulets of spooge trickle from her pussy down the crack of her ass, mixed in with her clear girl-honey."
        );
        if (this.player.cumQ() >= 500)
            this.outx(
                "  Such a meager display is only the start.  You fire rope after rope of cum, enough to slightly distend the dragoness's belly with your seed."
            );
        if (this.player.cumQ() >= 1500)
            this.outx(
                "  Jizz pumps and pumps, squirting from her filled pussy almost as fast as you inject, yet you still manage to make her look nearly pregnant by the time you finish."
            );
        if (this.player.cumQ() >= 1000)
            this.outx("  The drippings form a nice big puddle under Kiha.");
        this.outx(
            '[pg]After some languid snuggling, Kiha beams up at you radiantly.  "<i>That was... okay,</i>" she declares, a quaver of uncertainty in her voice as her emotional defenses come back up.  You stand and slowly stretch the kinks from your muscles.  Teasingly, you remind her that it seemed a little better than \'okay\'.  A tail sweeps your [legs] out from under you, a moment before Kiha pounces you with cat-like agility.  She hisses, "<i>It was better than okay, alright?  It was great.  You\'ve made me happy, [name]!</i>"'
        );
        this.outx(
            '[pg]Kiha punches you in the chest before climbing off you.  "<i>I don\'t have time for those emotions, doofus... not while Lethice lives.</i>"  Well, it was a nice moment.'
        );
        this.player.orgasm();
        this.dynStats("lib", -1, "sen", -1);
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private giveKihaIncubusDraft(): void {
        ...
        this.outx(
            '[pg]Kiha staggers back, dropping her greataxe and gripping her stomach as the draft sloshes through her system.  You grin as a sudden squirt of fem-lube erupts from her bare pussy, followed by a sudden twitch and shift of the flesh just above her soaked cunt.  "<i>W-what did you give me, ' +
                this.player.short +
                '?  You... you idiot!</i>" she screams as the skin above her groin violently erupts, a long, hard human-like prick bursting forth into the light.  Kiha lets out a wail of pleasure as her newly-formed prick takes shape, already jetting great white globs of cum onto her thighs and legs.  Her legs give, and Kiha collapses, squirming as her new cock twitches and spasms between her once-powerful legs.'
        );
        this.outx(
    ...
    private fuckKihaWithATentacle(): void {
        ...
        this.outx(
            'You smile warmly and undress yourself, eying your fiery companion with desire and fondness. Kiha doesn\'t understand at first; she stands there suspiciously as you remove your [armor]: "<i>Huh? What are you doing, [name]? Is it one of your petty tricks?</i>"'
        );
        if (this.silly())
            this.outx(
                '  You whisper slowly, "<i>Shhhh... no tears now.  Only dreams... and tentacles.</i>"'
            );
        this.outx(
            "  You shake your head, still grinning; a few seconds later, your vegetal-like junk is fully exposed, its long and enormous tentacles wriggling around as they taste the cold air after being contained for too long in your narrow clothing. Kiha appears to be stunned by your abundant and flourishing genitalia.  \"<i>W-what is THAT? What do you think you're going to do with that, [name]? I dare you to approach me with "
        );
        if (this.player.tentacleCocks() > 1) this.outx("those monstrous things");
        else this.outx("that monstrous thing");
        this.outx('.  I fucking dare you!</i>"');
        this.outx(
            "[pg]Sighing in disappointment, you patiently explain that you want to share a 'special' experience with her. You say you want to please her with your tentacle dicks; you say you thought she would be aroused by the sight of such versitale, talented cocks."
        );
        this.outx(
            "[pg]\"<i>D-don't think you're turning me on or anything!  This is just... gross. These wriggling things... so long... so obscenely big... and that scent - wait what are you doing GET AWAY FROM ME!</i>\""
        );
        this.outx(
            "[pg]While the dark reptilian girl stood there naked, you had seized the opportunity to launch your penile appendages around her, effectively entrapping her with your [cock all].  The lianas keep writhing around her luscious body, encircling her waist and chest as they slither between her scales.  As you gently feel her up with your junk, you tell her to relax; you want her to feel good, and you know you will.  Your cocks keep rubbing every part of her nude body, saturating her every sense with dick. As [oneCock] slides along her breasts, you notice she can't help but bow down and take a quick lick.  Genuinely amused, you ask her if she's finally starting to like your dicked ministrations."
        );
        this.outx(
            "[pg]\"<i>Y-no! Stop it! You're driving me crazy, your dicks are everywhere!  It's all around me... I can smell it... I can taste it... don't think you can win me over like this, i-it feels so... aaaah...</i>\""
        );
        this.outx(
            "[pg]As you wrap more and more of your [cock all] around her, Kiha's complaints eventually fade into slow, ragged breaths betraying her rising lust.  With a triumphant laugh, you grab Kiha's body and bring her closer to you, feeling her hot breath intertwining with yours as you both keep eye contact.  Her gaze seems to be filled with frustration and lust, but also trust.  You keep whispering tender words as your tentacle dongs grind ever harder against her limbs and scales.  Then, staring at her intensely, you move the tip of your [cock " +
                x +
                "] upwards and plunge it directly into her mouth."
        );
        this.outx(
            "[pg]The scaly woman is too surprised at first, and her jaw hangs open as you force more and more inches down her hot throat.  You feel her warm tongue and saliva slowly dampening your rod, providing you with the most pleasant tingles.  As you gradually feel your own lust building up, you keep complimenting your draconic lover, telling her how she's good at this and begging her never to stop.  Kiha looks at you with teasing eyes and a wicked grin - well, you suppose it would look wicked if it weren't so deformed by your enormous [cock " +
                x +
                "] -, relieved to see she still has some control over you. You let her work over your tentacle prick, enjoying the contact of her boiling-hot mouth as her tongue and lips effortlessly slide up and down your vegetal dick-tower."
        );
        this.outx(
            "[pg]It feels heavenly good, but you have other uses for your junk.  With a bit of regret, you slowly pop out your [cock " +
                x +
                "], leaving Kiha panting with delight - and anguished desire."
        );
        this.outx(
            '[pg]"<i>[name]... who do you think you are, playing with me like that?  I\'m not a pet to be toyed with-</i>"'
        );
        this.outx(
            '[pg]"<i>Shhh.</i>"  Before she can let out another whimper, you grab hold of her neck and fiercely kiss her lips, your saliva being mixed with hers and your own dick-juice.  You ferociously embrace the dragon girl, hands and tentacles clasping her to your chest as if you wanted to overwhelm her last shows of defiance with your love.  When her nervous struggles completely cease, you pull back and agitate your [cock ' +
                x +
                "] in front of her eyes, so she can see the cause of her imminent pleasure.  She stares at your rod with dumbfounded eyes as it wriggles its way through the warm folds and scales of her plush body; your tentacle circumvents her toned butt before lodging itself in front of her backdoor, ready for an imminent anal penetration.  Her glinting eyes are now only full of sheer hunger; she wants you as much as you want her, if not more."
        );
        this.outx(
            "[pg]Still not breaking eye contact, you murmur in the sweetest, kindest voice: \"<i>I love you.</i>\"  With a mighty but love-filled thrust, you devastate Kiha's interior.  The scaly woman shrills from the firm yet tender intrusion, but you can see her eyes dilating, her mouth opening frantically; her whole body becomes languid as she abandons herself to your arms.  You hold her tight as if to reassure her and start pumping in and out of her relaxed butthole, using her own saliva as a lube.  Kiha's infernal recesses are nearly setting your [cock " +
                x +
                "] on fire, but the excruciating pleasure acts only as an incentive to pound deeper, and harder. As you rectally ravage your lover, you can hear her muffled cries of felicity; as reluctant as she may have been at first, it is obvious she is enjoying her butt-treatment.  You can tell from the flexibility and relative looseness of her anal walls that your dragon girl is quite used to back-dickings, and it is always relieving not to have to fight your way through someone's asshole as your [cock " +
                x +
                "] pushes forward.  On the contrary, it seems her anal ring is contracting on its own volition, facilitating the colon insertion before squeezing mercilessly once your [cock " +
                x +
                "] lodges in it."
        );
        ...
        if (y != -1) {
            this.outx(
                "[pg]You stare at Kiha's blissful face; the strong dragon woman is wincing in pain and pleasure mixed under your repeated assaults.  Leaning closer to her, you gently whisper words of encouragement, warning her that this is only the beginning.  As you speak, you uncoil your [cock " +
                    y +
                    "] and place it directly at her vaginal entrance, ready for an imminent double-penetration.  Although Kiha didn't seem to notice your hushed words, you feel her jolt within your arms as your secondary dong knocks on her baby-maker.  Seeing that the scaly girl is pretty much aroused to oblivion, you don't take many precautions and roughly shove the tip of your [cock " +
                    y +
                    "] down her love-tunnel, filling inch after inch of her hot, moist recesses.  Eventually, her fuck-hole is entirely filled with tentacle dick"
            );
            if (this.player.cockArea(y - 1) < 24)
                this.outx(" and your rod buried to the hilt within her");
            this.outx(
                ".  As you alternatively pound away at her front and back door, you can feel her dark scaly body contorting between your arms: Kiha is drowning in an unholy fountain of pleasure.  She thrashes wildly and nearly escapes your grasp; the ferocious girl isn't one to be dominated, and in her oblivious passion she lets her inhumane vitality express to its full extent.  Although you were rather rough and unsubtle with her cunt, it is literally dripping cascades of fem-spunk; the shimmering liquid flows down her toned thighs and releases hot steam as it impregnates the cursed floor.  Some of her boiling sexual essence is coated on your [cock " +
                    y +
            ...
            if (z != -1) {
                this.outx(
                    "[pg]While you certainly appreciate the vision of a fiery and powerful girl writhing against your body, you think her ecstatic face is missing something, and you know what it is: a juicy meaty cock!  Her gaping mouth letting out hectic moans is surely a pleasant sight to see, but you would rather see those pulpy lips encircling some dick.  Moving your wriggling [cock " +
                        z +
                        "] toward Kiha's face, you teasingly ask her if she wants some more cock, making sure to pound her hard at every word.  The flaring tip of your [cock " +
                        z +
                        "] is simmering in arousal before her eyes, giving her a perfect view of your extravagant junk.  The dragoness is too shaken up to give a proper answer; every now and then she mutters a single incoherent sound, her words being mangled by intermittent moans at every thrust from your [cock " +
                        x +
                        "] and your [cock " +
                        y +
                        '] into her holes: "<i>Aah... wait... aah... no... ooh... aah... wait... y-yeaAAAAH! YES! Oh... yesyesyesyeESSSSSSSS! AAAAaaah... aah....</i>"'
                );
                this.outx(
                    "[pg]How could you refuse such an invitation?  You graciously give in to her needy demands for cock and approach her with your [cock " +
                        z +
                        "]; however, still unwilling to be treated as a mere fuck-toy, Kiha acts first: her flexible tongue grabs your plant-like rod and she gulps down the entirety of your length, suckling and squeezing ferociously.  Her lips cling to your [cock " +
                        z +
    ...
    public kihaOffersToMoveIn(): void {
        ...
        this.outx(
            '[pg]You smile at her nervous query and nod.  She can be a real bitch sometimes, but you know, deep down inside, she well and truly likes you.  Kiha beams and slugs your shoulder, saying, "<i>I knew it, you wimp!</i>"'
        );
        this.outx(
            '[pg]You punch her back just as hard and retort, "<i>Whatever, I\'m not anywhere near your territory this time!  Who was missing who?</i>"'
        );
        this.outx(
            '[pg]Kiha digs her claws into the moist, swampy ground and wrings her hands, lost in thought.  You wait expectantly until she realizes you saw her, and then, she sighs heavily, "<i>Okay, okay... I missed you, [name].</i>"  She stabs a clawed fingertip against your [chest] as she concludes, "<i>There!  I said it!  I guess I might even lo... like you!  Maybe, if you feel the same way, we could... spend more time together?</i>"'
        );
        this.outx(
            "[pg]You grin and hug her, comforting the nervous dragoness until she recovers and gives you a surprise slap on the ass with her tail.  Same old Kiha..."
        );
        this.outx(
            "[pg]It sounds like she might be wanting to move in with you, if you were to ask."
        );
    ...
    private inviteKihaForDickings(): void {
        ...
        this.spriteSelect(72);
        this.outx(
            'You lean back against a tree and ask the haughty dragoness if she would like to come to your camp... maybe even stay a while.  She stops for a moment to consider, her hands clenching nervously as she digests the delicious news.  Looking back your way, her eyes brighten, her face lifts, and she cheers, "<i>REALLY!?</i>"'
        );
        this.outx(
            '[pg]Nodding, you take her hands and assure her, "<i>Really.  Move in with me, Kiha.</i>"'
        );
        this.outx(
            "[pg]The reptilian woman coughs nervously and attempts to salvage what little is left of her haughty exterior, saying, \"<i>I... uh, mean, I guess, if you haven't totally fucked it up.</i>\"  Her vertically slit pupils seem to twinkle with amusement as she says so, and though you can tell she doesn't mean it, you aren't particularly inclined to take the insult after making such an important offer."
        );
        this.outx(
            "[pg]You keep your retort light-hearted, but with an edge of seriousness that ought to keep her off-balance and get you a clear, truthful answer.  \"<i>You don't have to come if you don't want to, you know?</i>\""
        );
        this.outx(
            "[pg]Kiha stops, dark-skin paling until she looks like a shadow of her former self.  Moisture puddles at the corner of her eyes while she tries to hold back tears, the cracks in her hard facade widening from within and without.  She looks back at you with a touch of anger and defiance in her eyes, but she's unable to ignore, or to hide, what's in her heart.  Kiha's face comes alive as she breaks through her emotion mask, tears running down her cheeks unchecked.  She embraces you in a crushing bear hug, holding onto you like a drowning man would cling to driftwood.  Her words are as unexpected as they are heartfelt."
        );
        this.outx(
            "[pg]\"<i>No...[name], I... I'm sorry.  I would love to see your camp,</i>\" she says as she snuggles her tears away on your shoulder.  She pauses and whispers to you, still holding you tight, \"<i>Don't leave me alone, please... I-I... I love you.</i>\"  You tenderly stroke her ruby locks as she confesses her feelings, \"<i>I sh-should've told you sooner - I almost did.  It's so hard to trust anyone out here, so very hard.  I mean... I'm fucked up... the demons broke me in so many ways.  I still don't even know who I am, and you... you put up with my shit.  You fought me tooth and nail, but you didn't hold it against me.  You kept coming back, and never let me despair alone.  I love you, [name], and don't you forget it.</i>\""
        );
        this.outx(
            '[pg]Kiha sniffles softly and continues, "<i>I almost feel bad for Lethice to have you as an enemy.  Do me a favor and kick her in the twat for me when you find her, okay?</i>"  You both share a nervous laugh at that and slowly end the hug.  Dabbing at one of her tears, you suggest, "<i>Come on, let\'s carry your stuff over and get you moved in.</i>"  Kiha\'s tail wags happily, and the two of you begin gathering her things.'
        );
        this.outx("[pg]<b>(Kiha has joined your camp as a lover!)</b>");
    ...
    private ghostboobiesKiha(): void {
        ...
        this.spriteSelect(72);
        this.outx(
            'Gaze flitting between the syringe in your outstretched grasp and your eager face, Kiha seems to be struggling not to punch you in the face.  "<i>\'Gro+\'?</i>" she repeats incredulously, tail swishing in annoyance.  "<i>And what do you plan to do with that, exactly?</i>"'
        );
        this.outx(
    ...
    public kihaBitchesOutCorruptPCs(): void {
        ...
        if (!this.followerKiha()) {
            this.outx(
                "You make your way through the murky swamp, your mind turning to thoughts of your dragoness "
            );
            if (this.flags[kFLAGS.KIHA_AFFECTION_LEVEL] == 1) this.outx("friend");
            ...
            this.outx(
                "[pg]As if your thoughts had summoned her, Kiha slips out from behind a tree, her wide hips swaying slightly with each of her powerful, predatory movements...  Her battleaxe flares in her hands, a fiery haze surrounding its brutal curve.  Well, shit."
            );
            this.outx(
            ...
            this.outx(
                "Kiha approaches you, her belongings gathered in her hands.  The sexy dragoness seems visibly upset, and before you can say a word, she interrupts, \"<i>Don't say a word, [name].  You're corrupt.  I can smell the corruption rolling off you from over here.  I won't be here when you turn into a demon, and I don't want to fight you... but if you come after me, I won't hesitate to defend myself!</i>\""
            );
            this.outx(
                "[pg]Kiha closes her eyes and launches herself into the air, only leaving a few tears for the parched wasteland to claim."
            );
            this.doNext(this.playerMenu);
        }
    ...
    public kihaUnbitchesUncorruptedFolks(): void {
        ...
        if (!this.followerKiha()) this.kihaFriendlyGreeting(false);
            ...
            this.outx("  You make your way back to camp, arm in arm.");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
    }
    ...
    private kihaCampAppearance(): void {
        ...
        this.spriteSelect(72);
        this.outx(
            "Kiha is a 6 foot tall dragoness, with dark skin and blood-red scales covering much of her body.  She is naked, shameless of her nudity, and carries a tremendous enchanted greataxe, the head of which blazes with heat.  She has a sharp, predatory face with dark red eyes bearing black, reptilian slits.  Long red hair grows from her scalp, reaching down past her shoulders.  She has strong, child-bearing hips and a squishy bubble-butt.  She has two reptilian legs adorned with scales and claws, ending in soft, leathery soles."
        );
        this.outx(
            "[pg]She has a pair of dusky, soft D-cup tits, with a single 0.5 inch nipple on each breast."
        );
        this.outx(
            "[pg]Kiha has a loose twat between her legs which constantly drips a warm, wet lubricant that stains her thighs."
        );
        this.outx(
            "[pg]Between her gropable butt-cheeks, Kiha has a single tight asshole, right where it belongs."
        );
    ...
    private dominateKihasFaceWithStuffAndStuffOrSomethingIDunnoWhyImStillWritingThis(): void {
        ...
        this.outx(
            "Feeling that Kiha's natural inclination for dominance has grown a little stale, you broach the idea of YOU dominating Her.  The dragoness glances your way and grins toothily as she cracks her knuckles.  \"<i>Why would I want to let you dominate me, doofus?  I've been fighting to stay on top out in the swamps as long as I can remember.  What makes you think I'd want to submit to some cute " +
                ...
                ' I just met?</i>"  She blushes a little when she realizes she just called you cute.'
        );
        this.outx(
            "[pg]Sighing, you fold your arms across your chest and tell her that you won't take no for an answer.  Kiha snorts derisively, two tiny puffs of flame shooting from her nostrils as she cracks her neck and stands.  She grabs her axe out of the dirt and whirls to face you."
        );
        this.outx(
            '[pg]"<i>If you want have your way with me, you\'ll need to earn it, just like anyone else,</i>" Kiha explains.  She narrows her eyes at you and questions, "<i>The question is, are you ' +
                this.player.mf("man", "woman") +
                " enough to take what you want?  I wouldn't want you to get hurt.</i>\""
        );
    ...
    private beABitchDumbass(): void {
        ...
        this.outx(
            '[pg]"<i>Maybe once you grow some balls,</i>" the dragoness taunts, giving you a wink.'
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    // [Fight for position]
    private fightForDominanceWithDragonCunnies(): void {
        ...
        this.spriteSelect(72);
        this.outx(
            "You inform her that you doubt she'll be hurting you today.  With an almost child-like sense of glee, you ready your [weapon] and step into the dragoness's intimidating presence."
        );
        this.outx(
    ...
    public pcWinsDomFight(): void {
        ...
        if (this.player.hasCock())
            this.outx("pull your quickly hardening " + this.multiCockDescriptLight());
        else if (this.player.hasVagina())
        ...
        if (this.flags[kFLAGS.KIHA_CHOKED_OUT_PC] > 0) this.outx("  Not again!");
        this.outx(
            "[pg]\"<i>Like a moth to an open flame!  If all some demon has to do is fake their defeat and spread their legs to get you into </i>this<i> position, then you will be easy prey indeed.  The real world doesn't arbitrarily roll over and concede defeat after a friendly spar!  The fight's not over till it's over, and right now it looks like you've lost.  Submit, and let me do what I do best,</i>\" Kiha coos confidently.  You're in for it now."
        );

        this.outx("[pg]Wrapping her attractive thighs around your ");
        if (this.player.hasCock()) this.outx(this.hipDescript());
        else this.outx("face");
        this.outx(", the dragoness draws ");
        if (this.player.hasCock()) this.outx("you ");
        else this.outx("your tongue ");
        this.outx(
            "past her love button and into her eager pussy.  Moaning out in callous pleasure, Kiha pumps you against her twat and takes the time to mock you while you grunt from the sensation of soft pussy against your "
        );
        if (this.player.hasCock()) this.outx(this.cockDescript(x));
        else this.outx("mouth muscle");
        this.outx(
            ...
            if (KihaFollower.rand(2) == 0)
                this.outx(
                    '[pg]"<i>Ha!  The Champion still has some fight in ' +
                        this.player.mf("him", "her") +
                        "!  Keep me here if you can, wimp!  I WILL pin you down and cum all over your face!  You'll lap it all up like a good little " +
                        this.player.mf("boy", "girl") +
                        ' to bo- UGH!</i>"'
                );
        ...
        this.outx(
            '[pg]Subdued for the time being, you push onward with coitus and brutalize Kiha\'s ever moistening pussy, the female dragon morph crying out in sheer delight at the "<i>punishment</i>" being inflicted upon her '
        );
        if (select == 0 || !this.player.hasVagina()) this.outx("love canal");
        else this.outx("clit");
        this.outx('.  "<i>Come on, idiot!  Give me all you\'ve got, if you have the balls!</i>"');

        // PC is male or herm, nutless:
        if (this.player.gender != 2 && this.player.balls == 0)
            this.outx("[pg]You're not sure if that's an insult or a challenge to step it up.");
        this.outx(
        ...
        if (select == 0)
            this.outx(
                "works her way on top of your pelvis and impales herself on your " +
                    this.cockDescript(x) +
                    ', grinning like a mad fool as she does so.  "<i>Told you!</i>"  She remarks. "<i>Was that really the best you could do?  With the hair pulling?</i>"  She sighs.  "<i>I guess I have to teach you a thing or two...</i>"  Lowering herself down in between savage slams of her rump against your pelvis, the cool and arrogant woman takes the ' +
                    this.player.skin() +
        ...
        // Kiha ensnares the PC between her legs for cunnilingus (universal):
            ...
            this.outx(
                'quickly wraps her legs around your head and rolls your body into a belly down prone.  "<i>Eat it ' +
                    this.player.mf("big boy", "you delectable slut") +
                    "!  I've got you in a hold you can't possibly escape from!  Lap it up bitch!</i>\"  For the time being you comply, if only to give you time to find a way out of this as you probe her cunt with your tongue.  \"<i>Yeeeaahhhah, just like that.  Good " +
                    this.player.mf("boy", "girl") +
        ...
        // Kiha traps the player in a submissive 69 (universal):
            ...
            this.outx(
                ' in her mouth.  "<i>Get used to that angle [name]; it\'s your new favorite position.</i>"  She taunts, before '
            );
            if (!this.player.hasCock()) this.outx("lapping viciously at your cunt.");
            else this.outx("ramming your cock down her craw.");
        }
        this.outx(
            "[pg]This won't do at all!  You're going to dominate her, whether she likes it or not!  Mustering your strength, you wait for the best moment to break free and "
        );
        if (select <= 1) this.outx("not have your neck's flesh ripped up in the process");
        else this.outx("not have a mishap with your genitalia");
        this.outx(
            ".  Finally, your chance for freedom arrives and you take it, raising your arms up and twisting against her body with all your might.  The move works and Kiha is flung from your lap and down the incline you both were rutting against.  Unfortunately... or fortunately, you find yourself rolling down the same hill as her; the world spinning around violently as you slip and tumble towards even ground.  After what feels like a dizzying eternity, you feel the evenness of earth under your spinning body, and come to rest against an old wooden stump of a dead tree."
        );
        this.outx(
        ...
        // Random event two of three: Footjobs and missionary, oh my!
            ...
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(".  Gazing downward, you come to realize that the dragoness has your prick");
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(
                " in her clawed foot!  You gasp out in pleasured shock as she stimulates the tender softness of your dick"
            );
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(
                ', all the while having to stare up at her as she smiles in triumph.  "<i>The Champion puts up a hell of a fight, but in the end, falls to a simple footjob.  What hope do you have against the demons, [name]?  Might as well let me take on your crusade and resign yourself to being my bitch!</i>"  She arrogantly decrees.'
            );
            this.outx("[pg]Not a chance, you think. She's getting dominated, here and now!");

            this.outx(
                '[pg]Reacting quickly, you clench your hands up into fists and smash the pressure points of Kiha\'s hips, causing her to lose control of her legs momentarily.  "<i>OH, FUCK ME!</i>" she screams in agony, releasing your member'
            );
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(
                ' from her clawed foot.  Gracefully, you transition your "<i>attack</i>" into a powerful leg sweep, knocking her feet from underneath her and sending her ass-first onto the ground.  She groans in pain, then euphoria as you slide on top and forcefully plant your cock deep in her pussy.  "<i>Yeah, that\'s the idea,</i>" You chide.  "<i>But you\'ve been a bad girl; I think I need to work you over until you\'re nice and ready for me...</i>"'
            );
            ...
            this.outx(
                '[pg]Her breathing becoming plagued with arousal and stimulus overload, she finally yields, beseeching you to stop playing with her breasts and to get on with "<i>more important things.</i>"'
            );

            this.outx(
                "[pg]Trapped in the missionary position and horny beyond belief, Kiha can only wrap her legs and arms around you, babbling and ceaselessly begging you to fuck her, to flood her pussy with your seed."
            );
        ...
        // Random Scene three of three: Standing dominant cunnilingus, with a reversal:
            ...
            this.outx(
                "[pg]You need a moment to plan how to get out of this, so you grudgingly go along with it for now.  Like a rattlesnake's tail, you flick the tip of your tongue rapidly over her clitty; the dragoness moans her approval and grabs you by the hair to help \"<i>guide</i>\" you.  \"<i>Gods, you eat pussy well! That's about all you're good for if you can't beat me, right?</i>\"  She says mockingly, as if she was daring you to make a move.  Sensing weakness in her grip, you do just that."
            );
            this.outx(
                '[pg]Grabbing at her ankles, you give a mighty tug and yank them out from underneath her, breaking her grip on you and sending her crashing into the dirt.  Still in your grasp, you work her legs all the way up to her ears and bury your face in her snatch, teasing and tormenting the needy sex with mean-spirited effectiveness.  The dragoness only whines and groans in delight, offering no strong resistance as you bring her to climax, legs twitching uncontrollably as she coats you in a rush of pussy juice.  Taking a moment to clean yourself, you lap up the fluids that Kiha has so "<i>graciously</i>" shared with you.  "<i>Oh... wow.  We have to do that again sometime!</i>"  Kiha remarks, exhausted and panting for air.  A grin cracks across your face, realizing that you haven\'t cum yet.  "<i>Who says it\'s over?</i>"  You say with a grin, as you grab her and pin her against a tree.  Slumped against the ground, she\'s in the perfect position for '
            );
            if ((this.player.hasCock() && KihaFollower.rand(2)) || !this.player.hasVagina()) {
                this.outx(
                    "a facial.[pg]You tell your lover to stay there and don't move while you conclude the act, furiously stroking your length"
                );
                if (this.player.cockTotal() > 1) this.outx("s");
                this.outx(
                    ' only inches away from Kiha\'s face.  Her body perks up as it dawns on her what you have in mind, and she arcs her head back for your impending release.  "<i>Come on... come on... yeah, cum baby, I want it so bad...</i>" she whines in between pants of lust, impatiently longing for your orgasm.  A few moments later you feel the warmth of seed gushing from your ' +
                        this.player.cockHead(x) +
                        ", strings of sperm slamming against Kiha's pretty features.  She gasps in satisfaction as your cum rains down on her, moaning as your ejaculate coats her cheeks and brow.  Not one to let jism go to waste, you take her by the back of the head and press your " +
                        this.cockDescript(x) +
                ...
                this.outx("finishing you off.");
                this.outx(
                    '[pg]Helpless to offer any resistance, and perhaps unwilling to resist, even if she could, Kiha lays back and accepts that you have won this "<i>battle</i>", licking, suckling and kissing your ' +
                        this.clitDescript() +
                        " as you grind against her.  The sensation of her long, reptilian tongue pressing against and sliding sensuously over your nether-lips and clit is incredibly intense and satisfying, and it isn't long until you bellow a " +
                        this.player.mf("manly", "girlish little") +
                        " cry and cum hard, your muscles tensing with pleasure as you drench the dragoness' face in lady-cum.  She readily licks it all up as it flows, moaning as she swallows your sexual essence."
                );
            }
        }
        ...
        // outx("[pg]Kiha nods, as best she can with her head pinned against the tree trunk, and then grins.  \"<i>Just the way I like it, [name]. Let's get back to camp; no doubt there are demons that need our feet up their asses.</i>\"  That sounds like a good idea.  (And maybe she can clean herself up when she gets back).");
        this.outx(
