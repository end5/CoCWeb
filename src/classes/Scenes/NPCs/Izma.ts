...
export class Izma extends Monster {
    ...
    private IzmaSpecials1(): void {
        ...
        //("Misdirection"
        if (this.player.findPerk(PerkLib.Misdirection) >= 0 && Izma.rand(100) < 10 && this.player.armorName == "red, high-society bodysuit") {
    ...
    private IzmaSpecials2(): void {
        ...
        else this.outputText("laugh as her blades scape uselessly at your armor-clad back", false);
