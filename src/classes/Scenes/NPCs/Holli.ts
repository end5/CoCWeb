...
export class Holli extends Monster {
    ...
    public escapeFailWithHolli(): void {
        this.clearOutput();
        this.outputText("You ");
        if (this.player.canFly()) this.outputText("beat your wings and ");
    ...
    private fuckinJamanjiFlowerDarts(): void {
        ...
        if (this.findStatusAffect(StatusAffects.Blind) >= 0) this.outputText("  Though the demon herself is blinded, the fresh eye on the flower seems more than capable of aiming for her!");
        ...
        //Hit
            ...
            if (this.player.hasCock()) this.outputText("come inside me");
            else this.outputText("have me inside you");
    ...
    public struggleOutOfHolli(): void {
        ...
        else if (this.player.str / 10 + Holli.rand(20) + 1 + this.player.statusAffectv1(StatusAffects.HolliConstrict) > 30) {
    ...
    protected performCombatAction(): void {
        ...
        else if (Holli.rand(4) == 0 && this.player.findStatusAffect(StatusAffects.HolliConstrict) < 0) this.holliConstrictAttack();
