...
export class CorruptedDriderScene extends BaseContent {
    ...
    public driderEncounter(): void {
        ...
        this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00277]++;
    ...
    public defeatDriderIntro(): void {
        ...
        if (this.monster.HP < 1) this.outputText("to try to continue the fight, her movements slowed by pain and weakness.", false);
        else this.outputText("to masturbate her swollen pussy-lips and the thick, juicy demon-cock that's sprouted in place of her clit.  She's so focused on getting off that she utterly gives up on the idea of fighting back, let alone dominating you as she seemed to plan originally.", false);
        this.outputText("  The spider-herm lies in a miserable, defeated heap.", false);

        var buttFuckBUTTFUCKBUTTTFUCKBUTTFUCK = undefined;
        if (this.player.cockThatFits(this.monster.analCapacity()) >= 0) buttFuckBUTTFUCKBUTTTFUCKBUTTFUCK = this.buttFuckADriderOhBaby;
        ...
        if (this.player.hasCock() && this.player.lust >= 33) {
            if (this.player.cockThatFits(this.monster.vaginalCapacity()) >= 0) {
                ...
                if (this.player.tailType == TAIL_TYPE_SPIDER_ADBOMEN || this.player.hasItem(this.useables.T_SSILK)) {
    ...
    public loseToDrider(): void {
        ...
        if (this.player.gender == 0 || (this.player.gender > 0 && CorruptedDriderScene.rand(3) == 0)) select[select.length] = 2;
    ...
    private winDriderPCDickInSpiderCunt(): void {
        ...
        if (this.monster.lust > 99) {
            ...
            if (this.monster.nipplesPierced > 0) this.outputText(", the chains jingling loudly as she does so", false);
        ...
        if (this.monster.nipplesPierced > 0) this.outputText("  The chains binding her nipples make a delightful clinking noise with each squeeze and stroke.", false);
        this.outputText("\n\n", false);
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() > 2) this.outputText("es fan out to the side, forgotten while you give yourself over to the silken caresses of her glorious vagina.", false);
            else this.outputText(" sticks out to the side, forgotten while you give yourself over to the silken caresses of her glorious vagina.", false);
        }
        else this.outputText("Your " + this.cockDescript(x) + " seems to bulge inside her, giving itself over to the silken caresses of her glorious vagina.", false);
        ...
        if (this.player.cumQ() > 1000) this.outputText("  Amazingly, you actually manage to cum enough to fill her massive womb, and after the first few squirts, the cum slowly bubbles out around your shaft with each fresh deposit of jism.", false);
        this.outputText("\n\n", false);
        ...
        if (this.player.cor > 80 && this.player.lib > 50) this.outputText("Of course it's the truth, the cunt's clearly got a good grasp on the obvious. Unwilling to lose your grip on dominance, however, you try to keep struggling to get the upper hand.\n\n", false);

        else this.outputText("No, that's not right.  You're not some rutting beast, you're the champion.  Sure, you've got your " + this.cockDescript(x) + " locked hilt-deep inside her squirming slit, but that doesn't mean you're some kind of " + this.player.mf("stud", "slut") + " who jumps on a cunt without a second thought, does it?  You blink your eyes while you try to think.  She does have a point though, if you hadn't been in such a hurry for some sex, you wouldn't be sagging into her tits and feeling so awfully relaxed.\n\n", false);
        ...
        if (this.player.cor > 80 && this.player.lib > 50) this.outputText("You grumble out a denial.  You're not dumb, you just like to take charge and fuck. There's no reason to resist jumping on a nice wet pussy and making it squirt while you pack it full... but you can't quite get your limbs to move.\n\n", false);

        else this.outputText("You mumble out a denial.  You're not a beast... you just like to take charge and fuck.  It's just so hard to resist jumping on a nice wet pussy and making it squirt while you pack it full... no!  That's not what...\n\n", false);
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1) this.outputText("  Exgartuan mumbles telepathicaly, \"<i>Fuck yes I do, but I wanna see how this plays out.</i>\"", false);
        ...
        if (this.player.cor > 80 && this.player.lib > 50) this.outputText("that it's because of her own venom paralyzing your muscles so effectively.\n\n", false);
        else this.outputText("there was something wrong about what she was saying... something important.\n\n", false);
        ...
        if (this.player.cor > 80 && this.player.lib > 50) this.outputText("Gods it was a bad idea not to bind her lips... ", false);
        ...
        if (this.player.cumQ() > 1000) this.outputText(", even though you've packed it full once already", false);
        ...
        if (this.player.cumQ() > 1000) {
            ...
            if (this.player.cumQ() > 2000) this.outputText("  The flow thickens into a river, and soon the puddle of cum looks more like a pond, turning the dirt into a soup of muddy cum.", false);
        }
        this.outputText("\n\n", false);
    ...
    private winDriderPCDickInSpiderCunt2(): void {
        ...
        if (this.player.cor > 80 && this.player.lib > 50) this.outputText("The longer you sit there, the more your strength returns to you, and the more the submissiveness placed into you by her venom recedes. Still, you've tired yourself out too much to leave at the moment.", false);
        else this.outputText("The longer you sit there, the more you remember of yourself, and the more you forget the animal, the rut-beast that the spider-woman placed inside you.", false);
    ...
    private winVSDriderTakeItsCockInCunt(): void {
        ...
        if (this.player.vaginalCapacity() < this.monster.cockArea(0)) this.outputText("bottoms out", false);
        else if (this.player.vaginalCapacity() < this.monster.cockArea(0) * 2) this.outputText("fits tightly", false);
        ...
        if (this.monster.nipplesPierced > 0) this.outputText("pierced nipples, circling the metallic stud", false);
        else this.outputText("nipples, circling the moist bud", false);
        this.outputText(" with your tongue", false);
        if (this.player.tongueType > TONUGE_HUMAN) this.outputText(" as the rest of its demonic length lashes out and wraps around her pillowy bosom", false);
        ...
        //GET KNOCKED UP
        //Pregnancy Goes Here
        this.player.knockUp(PregnancyStore.PREGNANCY_DRIDER_EGGS, PregnancyStore.INCUBATION_DRIDER, 151);
    ...
    private victoryVSDriderRideOviVaginal(): void {
        ...
        if (this.monster.HP < 1) {
            ...
            if (this.player.hasCock()) this.outputText(" and " + this.sMultiCockDesc() + " twitch", false);
    ...
    private victoryVSDriderRideOviAnal(): void {
        ...
        if (this.player.clitLength >= 4 && this.player.hasVagina()) this.outputText(", and pressing your monster chick-stick into it; the gooey heat sends a tingle of shock up your spine and your pussy convulses", false);
        ...
        //([not mans]
        if (!this.player.hasCock()) this.outputText("\"<i>I never would've thought you were an anal-pregnancy slut,</i>\" hisses the spider in pleasure, flexing her organ harder while it curls through your guts, so deep inside you that you wonder how much further she can go.", false);
        else this.outputText("\"<i>Just because I have an exoskeleton doesn't mean I can't feel you dripping on me.  I thought I was the corrupt bitch here, but you... you take the cake.</i>\"", false);
        this.outputText("\n\n", false);

        this.outputText("With a final hard shove, the last few segments pop inside you", false);
        if (this.player.hasCock()) this.outputText(", nearly crushing your prostate from the tight squeeze", false);
        this.outputText(".  ", false);
        if (!this.player.hasCock() && this.player.hasVagina()) this.outputText("You gasp and dribble a few strands of girl-goo, the contractions of your achingly empty pussy intensifying.  ", false);
        if (this.player.hasCock()) this.outputText("You gasp and squirt a few weak ropes of cum, having a miniature orgasm on the spot.  ", false);
        this.outputText("Writhing happily, you sigh ", false);
        if (this.player.hasCock()) this.outputText("while your " + this.multiCockDescriptLight() + " dribbles white, wasted goo onto the black and " + this.monster.hairColor + " striped carapace below", false);
        else if (this.player.hasVagina()) this.outputText("while your " + this.vaginaDescript(0) + " dribbles fem-slime onto the black and " + this.monster.hairColor + " striped carapace below", false);
        else this.outputText("while your fingers tweak your " + this.nippleDescript(0) + "s and your starved sphincter sucks at its slimy, squirming stuffing", false);
        ...
        if (this.player.hasCock()) this.outputText(" and milk your prostate as they push past", false);
        this.outputText(".\n\n", false);
        ...
        if (this.player.gender > 0) {
            ...
            else if (this.player.hasVagina()) this.outputText("a siege of spray-scattering spasms from your snatch", false);
        ...
        //GET KNOCKED UP
        this.player.buttKnockUp(PregnancyStore.PREGNANCY_DRIDER_EGGS, PregnancyStore.INCUBATION_DRIDER - 200, 10); //Butt pregnancy goes faster
        this.player.slimeFeed();
        this.player.orgasm();
        this.dynStats("cor", .5);
        this.cleanupAfterCombat();
    ...
    private victoryVSDriderStickDickInSpinneret(): void {
        ...
        if (this.monster.nipplesPierced > 0) this.outputText("grasp the intersection of her nipple-chains, ", false);
        ...
        if (this.player.biggestTitSize() >= 3) this.outputText("  The semi-sticky stuff soaks into the cleavage of your " + this.player.allBreastsDescript() + ", the feeling surprisingly enjoyable.  You even knead the web in a bit, biting your bottom lip from the sensation.", false);
        ...
        if (this.player.balls > 0) this.outputText(", even giggling a little as your " + this.ballsDescriptLight() + " slap against her nose", false);
        this.outputText(".\n\n", false);
        ...
        if (this.player.cumQ() < 50) this.outputText("  She easily keeps in rhythm with your spurts.", false);
        else if (this.player.cumQ() < 350) this.outputText("  She sputters a bit from the amount of semen, but she catches up well enough.", false);
        else if (this.player.cumQ() < 1000) this.outputText("  She's hard-pressed to swallow enough of your seed before another waves washes in.", false);
        else this.outputText("  Her throat bulges from the sheer amount of cum you deposit into her mouth, and she nearly chokes as she attempts to swallow all of it.", false);
        if (this.player.cockTotal() > 1) {
    ...
    private loseVSDriderGetAnalledOvi(): void {
        ...
        else this.outputText("calm your racing thoughts and resist showing how eager you are", false);
        ...
        if (this.player.tallness < 66) this.outputText(this.player.face() + ", sliding down across your cheeks and along your lips", false);
        else this.outputText("chest, trickling between your " + this.nippleDescript(0) + "s", false);
    ...
    private loseVSDriderAndVaginallyImpreggleOvi(): void {
        ...
        if (this.player.isBiped() || this.player.isGoo()) this.outputText("down onto your back", false);
        ...
        if (!this.player.isNaga()) this.outputText("pull your own " + this.player.feet() + " apart", false);
        ...
        else this.outputText("spraying webbing across your tail and weighing it down to pin it against the earth", false);
        ...
        if (!this.player.isTaur()) this.outputText("Her fingers then move to the sides of your head, lacing webbing through your hair and sticking it firmly to the ground. More vulnerable than ever, you can't lift your head without ripping your hair from your scalp in chunks.", false);
        else {
            ...
            if (this.player.biggestTitSize() > 4) this.outputText("With pain and then a pop, your " + this.player.allBreastsDescript() + " squash out to the sides as she presses your torso into your knees.  ", false);
        ...
        if (this.player.hasCock() && this.monster.nipplesPierced > 0) this.outputText("  Chains brush over " + this.sMultiCockDesc() + " as her chest passes your crotch.", false);
        this.outputText("  Her fangs trail teasingly along your belly, her fingers crawling up your sides.", false);
        if (this.player.biggestTitSize() > 3) this.outputText("  Venom dribbles down the cleavage of your " + this.biggestBreastSizeDescript() + " as she approaches your vulnerable face.  Her own quartet of matronly tits comes to rest on them as her torso appears over their horizon.", false);
        this.outputText("\n\n", false);
        ...
        if (this.player.hasCock()) this.outputText("  Worse still, its blood-swollen protuberance is met with no reaction from the drider.", false);
        ...
        if (this.player.hasCock()) this.outputText("  Even your " + this.cockDescript(0) + " spurts some pre-cum of its own.", false);
        ...
        if (!this.player.isTaur()) this.outputText(", cutting your head loose from the imposed bondage with sharp, hard fingertips", false);
    ...
    private loseVSDriderAndGetFuckedANDAnalImpreggegity(): void {
        ...
        this.outputText("", true);
        if (this.player.lust > 99) this.outputText("Unable to resist the desire coursing through your body, you strip off your " + this.player.armorName + " and start stroking " + this.sMultiCockDesc() + ", displaying it in the hope that it will draw the drider's attention, while at the same time just trying to get yourself off and attain release.", false);
        else {
        ...
        if (this.monster.nipplesPierced > 0) this.outputText(", the crossed chains digging into your " + this.chestDesc(), false);
    ...
    public birthSpiderEggsFromAnusITSBLEEDINGYAYYYYY(): void {
        ...
        if (this.player.hasCock()) this.outputText(this.SMultiCockDesc() + " stays limp, but drools a heavy flow of semen, puddling up a nice thick batch of your pleasure alongside your goo-pile.  ", false);
        if (this.player.hasVagina()) {
    ...
    public driderPregVagBirth(): void {
        ...
        if (this.player.isNaga()) this.outputText("At last, when no more eggs seem to be coming, you flop over onto your back, careful not to crush any of your dormant offspring.", false);
        else this.outputText("Looking between your legs you can see another slick, green egg slide from your body to join the sizable pile behind you.  At last, when no more seem to be following it, you flop over onto your back, careful not to crush any of your dormant offspring.", false);
        ...
        if (this.player.biggestTitSize() >= 2) {
            ...
            if (this.player.bRows() > 1) this.outputText("  Following their sister's lead, more little driders take their place at each of your nipples and begin to drink.", false);
            else this.outputText("  Following her sister's lead, another little drider takes her place at your other nipple and begins to drink.", false);
            if (this.player.lactationQ() >= 3000) this.outputText("  One of your offspring seemed to be grasping your breast too tightly and drinking too greedily as suddenly you see one propelled away from you before she lands in a small puddle of milk nearby.  She seems to be struggling to right herself as she writhes around in the milk puddle, and so with a grin you reach over to pluck up the clumsy child and place her back at your waiting teat.", false);
            this.outputText("\n\n", false);
        }
        ...
        if (this.player.eyeType != EYES_FOUR_SPIDER_EYES) this.outputText("  Suddenly she flops forward, leaning against your eyebrows and causing you to cross your eyes in an attempt to focus on her.  She seems confused by the way your eyes are different to hers.", false);
        if (this.player.isNaga()) this.outputText("  A few baby driders crawl ponderously across your scaled tail.  You give your tail a little wiggle and suddenly they go wild crawling around it and letting out the faintest, cute little squeals.", false);
        else this.outputText("  A few baby driders sit on each of your legs, facing each other.  Some gesture and squeak at each other in wonder while others pull faces.", false);
        this.outputText("\n\n", false);
    ...
    private driderVagSmartFuck(): void {
        ...
        if (this.monster.HP < 1) this.outputText("parted slightly and glistening with beads of sweat from the adrenaline of battle.");
        else this.outputText("stuffed with her fingers, femcum streaming down the front of her spider-half as she desperately plays with herself.");
        ...
        if (this.player.tailType == TAIL_TYPE_SPIDER_ADBOMEN) {
            ...
            if (this.player.isDrider()) this.outputText("scuttle");
            else this.outputText("saunter");
    ...
    private driderTiedUpPartTwo(useItem: boolean): void {
        ...
        if (this.monster.lust > 99) this.outputText(" and away from her quivering snatch");
        ...
        if (!useItem) this.outputText("Shifting yourself, you withdraw your hand from her quivering slit, reaching back to collect another handful of stretchy silk.");
