...
export class SwordInStone extends AbstractLakeContent {
    ...
    private tryToTakeSwordInStone(): void {
        ...
        if (this.player.cor >= 25) {
            ...
            if (this.player.str > 70) this.outputText("pull mightily, making the tree strain and groan from the force, ", false);
            if (this.player.str <= 70 && this.player.str >= 40) this.outputText("pull hard, feeling your muscles tighten from the strain, ", false);
        ...
        //If not corrupted...
            ...
            if (this.player.str > 70) this.outputText("pull so hard you fall on your ass when the sword slips free.  The tip buries itself a few inches from your head.  You count yourself lucky and stand up.  ", false);
            if (this.player.str <= 70 && this.player.str >= 40) this.outputText("give a mighty pull and nearly fall over as the sword easily slides free from the tree.  ", false);
            if (this.player.str < 40) this.outputText("easily pull the sword free, surprising yourself with how easy it was to remove.  ", false);
