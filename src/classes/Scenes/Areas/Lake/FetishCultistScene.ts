...
export class FetishCultistScene extends AbstractLakeContent {
    ...
    public cultistRapesYou(): void {
        ...
        if (
            ...
            if (
                ...
                if (this.player.cocks[0].cockType == CockTypesEnum.HORSE) {
                    ...
                    this.outx(
                        `With a cry that sounds more like a neigh than anything else, your ${this.cockDescript(
                            0
            ...
            // Naga
                ...
                // girl's surprise
                    ...
                    this.outx(
                        `and to your shame, you feel your pelvic slit open up to reveal your ${this.vaginaDescript(
                            0
        ...
        if (FetishCultistScene.rand(2) == 0 && !sexed) {
            ...
            if (this.player.cocks.length > 0 && !changed) {
                ...
                this.outx(
                    `\n\nThe nurse stops humming before setting the syringe aside and climbs on top of your legs. She giggles softly before lowering herself and taking your ${this.cockDescript(
                        0
                    )} between her breasts and starts rubbing and playing with them while running your ${this.cockDescript(
                        0
            ...
            if (this.player.vaginas.length > 0 && !changed) {
                ...
                this.outx(
                    `Soon you have a fully formed ${this.cockDescript(
                        0
                    )} standing tall and proud where your old femininity used to lie.  The nurse sets the syringe aside and climbs on top of your legs. She giggles softly before lowering herself and taking your ${this.cockDescript(
                        0
                    )} between her breasts and starts rubbing and playing with them while running your ${this.cockDescript(
                        0
            ...
            if (this.player.gender == 0 && !changed) {
                ...
                this.outx(
                    `Soon you have a fully formed ${this.cockDescript(
                        0
                    )} standing tall and proud where your bare crotch used to lie.  The nurse sets the syringe aside and climbs on top of your legs. She giggles softly before lowering herself and taking your ${this.cockDescript(
                        0
                    )} between her breasts and starts rubbing and playing with them while running your ${this.cockDescript(
                        0
                    )} between them.  It is an exquisite experience having her tit fuck your brand new ${this.cockDescript(
            ...
            if (this.player.vaginas.length > 0 && this.player.cocks.length > 0) {
                this.outx(
                    ...
                    } becoming a nice, comfortable outfit of a white shirt and black pants that make you look well-suited to work in a manor... if they didn't have an exposed crotch and butt that puts your ${this.multiCockDescriptLight()}, your ${this.vaginaDescript(
                        0
                    )}, and your ${this.buttDescript()} on full display.  Any undergarments you had are now gone.\n\n`,
                    false
                );
                if (this.player.armorValue == 0)
                ...
                this.outx(
                    `After a minute of this, she stops you and says, "<i>Good; I am now ready to have you inside of me, toy.  Lie down and start fingering your ${this.vaginaDescript(
                        0
                    )} while I use the ${this.multiCockDescriptLight()} that I keep you here for.</i>"\n\n`,
                    false
                );
                this.outx(
                    `With your hands slightly trembling in anticipation, you lie down and grab at your very erect ${this.multiCockDescriptLight()} just before you slip your fingers into your ${this.vaginaDescript(
                        0
                    )}, ready to please your mistress the best way you can.  You watch your mistress rise off her chair and slowly lower herself onto your ${this.cockDescript(
                        0
                ...
                if (
                    ...
                    this.outx(
                        `After a minute of this, she stops you and says, 'Good, I am now ready to have you inside of me boy.  Show me your ${this.multiCockDescriptLight()} that I keep you here for.'\n\n`,
                        false
                    );
                    this.outx(
                ...
                // (variant 2: maid, requires vagina)
                    ...
                    this.outx(
                        `After a minute of this, she says, 'Good.  Now finger yourself before me, girl.  Show me that ${this.vaginaDescript(
                            0
                        )} that I keep you here for.'\n\n`,
                        false
                    );
                    this.outx(
                        `You lay back on the ground and raise your skirt, showing off your engorged ${this.clitDescript()} and ${this.vaginaDescript(
                            0
            ...
            if (this.player.gender == 0) {
                this.outx(
                    `You see that your ${
                        this.player.armorName
                    } have become a nice and comfortable outfit of a shirt white and black pants, that make you look well suited to work in a manor.  However, you notice that there is a flap on your pants that gives easy access to your ${this.buttDescript()}.\n\n`,
                    false
                );
    ...
    public playerRapesCultist(): void {
        ...
        if (this.monster.armorName == "pervy nun's clothing") {
            ...
            // (if player has a vagina)
                ...
                this.outx(
                    `She meekly lies back on the ground and spreads her legs, one slightly in the air.  You have a clear view of her needy hole through the large opening in her clothing.  "<i>My lord, please scissor me!</i>" she begs you.  You stand and stride over to her. "<i>Yes little girl, accept my divine lips on your pussy,</i>" you reply.  You grab the leg she had in the air and pull yourself between her legs, pressing your ${this.vaginaDescript(
                        0
            ...
            // foreplay
            this.outx(
                `You advance on the defeated cultist, whose outfit seems to have fixated on such a ridiculously skimpy swimming suit that she might as well be naked.  She looks up at you with a worried expression as you take a closer look at her.  The cultist slowly starts to speak, ""<i>Ah, hey there ${this.player.mf(
                    "mister",
                    "miss"
    ...
    private plugSwimsuitVag(): void {
        ...
        this.outx(
            `When you push your ${this.cockDescript(
                x
    ...
    public fetishCultistHasAMilkFetish(): void {
        ...
        this.outx(
            `You remove your ${
                this.player.armorName
            }, standing naked in front of the beaten fetish-girl with your lactating ${this.breastDescript(
                0
        ...
        this.outx(
            `What is she talking about? ${this.player.mf(
                "Master",
                "Mistress"
        ...
        this.outx(
            `Soon her thong becomes wet with arousal and her mouth comes off your ${this.nippleDescript(
                0
            )} to ask, "<i>Please ${this.player.mf(
                "Master",
                "Mistress"
        ...
        if (this.player.hasCock()) {
            ...
            this.outx(
                `our ${this.multiCockDescriptLight()} becomes fully erect as it rubs up against her warm ass cheeks, which is enough to fulfill its desire.   Her cum bubbles into the palm of your hand while your cum drizzles her ass with sticky whiteness.\n\n`,
                false
            );
        }
        // [ELSE Pussy]
