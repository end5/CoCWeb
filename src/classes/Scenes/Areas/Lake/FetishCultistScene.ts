...
export class FetishCultistScene extends AbstractLakeContent {
    ...
    public cultistRapesYou(): void {
        ...
        if (
            ...
            if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
                ...
                if (this.player.tallness > 72) this.outx("mighty");
                else if (this.player.tallness < 60) this.outx("mini");
                this.outx(
            ...
            // Naga
                ...
                if (this.player.gender == 0) {
                    this.outx("but there is nothing you can do but wait.\n\n", false);
                }
                // boy's surprise
        ...
        if (FetishCultistScene.rand(2) == 0 && !sexed) {
            ...
            this.outx('"<i>Um, ', false);
            if (this.player.gender <= 1) this.outx("sir");
            else this.outx("madam");
            ...
            if (this.player.hasFuckableNipples()) {
                ...
                if (this.player.biggestLactation() < 1) {
                    this.outx("they have even started to lactate.  ");
                    this.player.boostLactation(1.5);
                }
                // [if breasts are already lactating]
                else {
                    this.outx("they are producing more milk than before.  ");
            ...
            if (this.player.biggestTitSize() > 1 && !changed) {
                ...
                // [if breasts are not lactating]
                else this.outx(" start lactating.  ");
                this.outx(
    ...
    public playerRapesCultist(): void {
        ...
        if (this.monster.armorName == "pervy nun's clothing") {
            ...
            if (
                ...
                this.outx(' in your pussy,</i>" you reply.  ', false);
                if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR)
                    this.outx(
                ...
                if (this.player.cocks.length > 1) {
                    ...
                    if (this.player.cocks.length > 2) {
                        ...
                        if (this.player.cocks.length == 3) this.outx("last");
                        if (this.player.cocks.length > 3) this.outx("rest");
                        this.outx(" in the same way.  ");
                    } else this.outx(".  ");
                }
                this.outx(
                ...
                if (this.player.cumQ() < 50) this.outx(".");
                if (this.player.cumQ() >= 50 && this.player.cumQ() < 200)
                    this.outx(" before streams of cum begin to run down her thighs.");
            ...
            this.outx("Satisfied, you continue on your way.");
            this.player.orgasm();
            ...
            if (this.player.hasCock()) {
                ...
                else this.outx('"<i>I want this so damn much!</i>"\n\n', false);
            }
            ...
            else this.outx("With a wicked smile, you push her to her knees.  ");
            // (if player has a dick)
            if (
                this.player.cocks.length > 0 &&
                (this.player.gender != 3 || FetishCultistScene.rand(2))
    ...
    private plugSwimsuitVag(): void {
        ...
        else this.outx("You tell her you're gonna fuck her.  ");
        this.outx(
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() == 2) this.outx(" lets loose its load");
            else this.outx("s let loose their loads");
            this.outx(" onto her back and legs, ");
            if (this.player.cumQ() < 50) this.outx("adding a little white decoration");
            else if (this.player.cumQ() < 200)
                this.outx("adding a liberal coating of white to her body");
            else this.outx("drenching her in your cum");
            this.outx(".");
        }
        this.outx("\n\n", false);
    ...
    private swimsuitVibrators(): void {
        ...
        // It fits!
            ...
            else this.outx("It easily slips inside your well-stretched hole.");
            this.outx(
    ...
    public fetishCultistHasAMilkFetish(): void {
        ...
        this.outx('"<i>Zee merechaing ong?</i>"\n\n', false);

        this.outx("You can't understand the gibberish coming out of her mouth.\n\n", false);

        this.outx('"<i>Ummmmm... no? Please return to your reward.</i>"\n\n', false);
        ...
        // [High Int]
        else this.outx("and everything goes back to normal.  ");
