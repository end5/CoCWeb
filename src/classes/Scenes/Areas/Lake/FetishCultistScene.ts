...
export class FetishCultistScene extends AbstractLakeContent {
    ...
    public cultistRapesYou(): void {
        ...
        if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR || this.player.lowerBody == LOWER_BODY_TYPE_NAGA) {
            //Special centaur version by Astronomy
            if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR && this.player.balls > 0 && this.player.totalCocks() > 0 && FetishCultistScene.rand(4) < 3) {
                if (this.player.cocks[0].cockType == CockTypesEnum.HORSE) {
                    ...
                    if (this.player.armorValue == 0) this.player.modArmorName = "bridle bit and saddle set";
                    ...
                    //(ending after all cultist rape scenes)
                        ...
                        if (this.player.armorValue > 0) this.outputText("You find your " + this.player.armorName + " back on your body with no sign of the strange clothes you were wearing before.  ", false);
                        else this.outputText("You are still wearing the " + this.player.armorName + " that she gave you, and there is no sign of your old clothes.  ", false);
            ...
            //Naga
                ...
                if (this.player.armorValue == 0) this.player.modArmorName = "headdress, necklaces, and many body-chains";
        ...
        if (FetishCultistScene.rand(2) == 0 && !sexed) {
            ...
            if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
                ...
                if (this.player.cockTotal() > 0) this.outputText("  As you see your " + this.multiCockDescriptLight() + ", 'incredibly large' is the only qualifier you can think of.", false);
            }
            this.outputText("\n\n", false);
            if (this.player.armorValue == 0) this.player.modArmorName = "bondage patient clothes";
            ...
            if (this.player.biggestTitSize() > 1 && !changed) {
                ...
                //[if breasts are already lactating]
                if (this.player.biggestLactation() >= 1) this.outputText(" start lactating even more.  ", false);
                //[if breasts are not lactating]
            ...
            if (this.player.vaginas.length > 0 && this.player.cocks.length > 0) {
                ...
                if (this.player.armorValue == 0) this.player.modArmorName = "crotch-revealing clothes";
                ...
                if (this.player.cocks.length > 0 && (this.player.vaginas.length == 0 || FetishCultistScene.rand(2) == 0)) {
                    ...
                    if (this.player.vaginas.length) this.outputText(", your " + this.vaginaDescript(0) + ",", false);
                    this.outputText(" and your " + this.buttDescript() + ".  Any undergarments you had are now gone.\n\n", false);
                    if (this.player.armorValue == 0) this.player.modArmorName = "cute servant's clothes";
                    ...
                    if (this.player.vaginas.length > 0) this.outputText("You feel desire start to well up in your " + this.vaginaDescript(0) + ", but you resist the urge to act on it; that's not why your mistress keeps you. ", false);
                    this.outputText("She starts to rock back and forth, your " + this.cockDescript(0) + " bringing her to the height of pleasure. ", false);
                    if (this.player.cocks.length == 2) this.outputText("Your " + this.cockDescript(1) + " rubs against her skin pleasantly.  ", false);
                    if (this.player.cocks.length > 2) this.outputText("The rest of your " + this.multiCockDescriptLight() + " rub against her skin pleasantly.  ", false);
                ...
                //(variant 2: maid, requires vagina)
                    ...
                    //[if player has a dick]
                    if (this.player.cocks.length > 0) this.outputText("You feel a desire rising in your erect " + this.multiCockDescriptLight() + " but you ignore it; that's not what your mistress told you to play with.  ", false);
            ...
            if (this.player.gender == 0) {
                ...
                if (this.player.armorValue == 0) this.player.modArmorName = "servant's clothes";
    ...
    public playerRapesCultist(): void {
        ...
        if (this.monster.armorName == "pervy nun's clothing") {
            ...
            if (this.player.cor < 40) this.outputText("You are rather taken aback by this odd declaration, but in the end you decide: <i>what the hell, I'm horny.</i>\n\n", false);
            else this.outputText("You nod to yourself thinking: <i>that's right, I am a sex god.</i>\n\n", false);
            ...
            if (this.player.cocks.length > 0 && (this.player.gender != 3 || FetishCultistScene.rand(2))) {
                ...
                if (this.player.cocks.length > 1) this.outputText("s", false);
                this.outputText(" in your pussy,</i>\" you reply.  ", false);
                if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) this.outputText("You command her to get on all fours, then cover her and push ", false);
                else this.outputText("You grab hold of and lift her legs, then kneel down and push ", false);
                if (this.player.cocks.length > 1) this.outputText("the first of ", false);
                ...
                if (this.player.cocks.length > 1) {
                    ...
                    if (this.player.cocks.length > 2) {
                        ...
                        if (this.player.cocks.length == 3) this.outputText("last", false);
                        if (this.player.cocks.length > 3) this.outputText("rest", false);
                ...
                if (this.player.cumQ() < 50) this.outputText(".", false);
                if (this.player.cumQ() >= 50 && this.player.cumQ() < 200) this.outputText(" before streams of cum begin to run down her thighs.", false);
                if (this.player.cumQ() >= 200) this.outputText(" before torrents of cum begin to run down her legs and onto the ground.", false);
            ...
            else if (this.player.vaginas.length > 0 && this.player.lowerBody != LOWER_BODY_TYPE_CENTAUR) {
            ...
            //Horsey
            if (this.player.vaginas.length > 0 && this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
            ...
            if (this.flags[kFLAGS.PC_FETISH] > 0) this.outputText("Given your experience with Ceraph, you can definitely understand why she is having so much fun showing off her body.  In fact, you think you'll start to do the same.", false);
            else this.outputText("You don't really understand what could be so arousing about showing off your body to others, but you decided you were going to rape her, so you might as well strip down now.", false);
            ...
            //corruption check!
            if (this.player.cor < 33) this.outputText("Well, she obviously wants this, so you guess there isn't anything wrong with enjoying what's on offer, is there?\n\n", false);
            else if (this.player.cor < 66) this.outputText("You think to yourself how awesome this is.  It isn't often a defeated foe is so eager.\n\n", false);
            else this.outputText("You're almost disappointed at how easy she is making this; but hey, a fuck is a fuck, so what do you care?\n\n", false);
            //end of the foreplay
            ...
            if (this.player.hasCock()) {
                ...
                //if (PC has a vagina)
                if (this.player.hasVagina()) this.outputText("Then, she hesitates for some reason, before saying, \"<i>Um, I'm not sure why I'm asking this since you've got a good tool there already, but... I've got some vibrators, if you want to play with them instead...</i>\"\n\n", false);
            ...
            if (this.player.cor < 40) this.outputText("You stop, thinking that maybe you should let her go, but she grabs your hand and gives you a look of desperation.  Deciding to finish the job, you push her to her knees and the look of fear returns to her face.  ", false);
    ...
    private plugSwimsuitVag(): void {
        ...
        if (this.player.hasVagina()) this.outputText("You decline the vibrators; you'd much rather take her incredibly wet pussy.  ", false);
        else this.outputText("You tell her you're gonna fuck her.  ", false);
        ...
        if (this.player.cockArea(x) < 50) this.outputText("push further and further until you're all the way inside her.", false);
        else if (this.player.cockArea(x) < 200) this.outputText("push further and further, until to your great delight, she manages to take all of your massive member without any trouble!", false);
        else this.outputText("manage to get your monster cock further and further inside her.  To your immense shock, she manages to take the whole thing, without it seeming to warp her body at all!", false);
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() == 2) this.outputText(" lets loose its load", false);
            else this.outputText("s let loose their loads", false);
            this.outputText(" onto her back and legs, ", false);
            if (this.player.cumQ() < 50) this.outputText("adding a little white decoration", false);
            else if (this.player.cumQ() < 200) this.outputText("adding a liberal coating of white to her body", false);
            else this.outputText("drenching her in your cum", false);
    ...
    private swimsuitVibrators(): void {
        ...
        //It fits!
            ...
            if (this.player.vaginalCapacity() < 75) this.outputText("It takes some effort to get it inside you, but is well worth the effort.", false);
            else this.outputText("It easily slips inside your well-stretched hole.", false);
            ...
            if (this.player.wetness() < 3) this.outputText("a trickle", false);
            else if (this.player.wetness() <= 4) this.outputText("a wave", false);
            else this.outputText("a torrent", false);
    ...
    public cultistBadEnd2(): void {
        ...
        if (this.player.gender == 1) genderTag = "man";
        if (this.player.gender == 2 || this.player.gender == 3) genderTag = "woman";
        if (this.player.gender == 0) {
            if (this.player.biggestTitSize() > 1) genderTag = "woman";
            else genderTag = "man";
        }
    ...
    public fetishCultistHasAMilkFetish(): void {
        ...
        //[Genderless]
        else this.outputText("Your entire body tenses up, like you're approaching an orgasm. The release of this tension flows through your body as she cums into the palm of your hand. You sigh with relief as the phantom orgasm lingers.\n\n", false);
