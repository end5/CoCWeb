...
export class GooGirlScene extends AbstractLakeContent {
    ...
    public encounterGooGirl(): void {
        ...
        this.outx(
            "As you walk around the lake, you notice a pale red light pulsing in the ",
            false
        );
        if (this.player.findStatusAffect(StatusAffects.FactoryOverload) < 0) this.outx("sapphire ");
        else this.outx("murky ");
        this.outx(
        ...
        this.outx(
            this.gooColor() +
                " slime body sculpting itself into a humanoid shape. The girl curiously tilts her head to one side, as if trying to figure out why you're backing away, before she happily surges forward!",
            false
        );
    ...
    private coreDropChance(): void {
        if (
            ...
            this.outx(
                "\n\nAs the goo-girl slithers away, into the lake's placid waves, you notice she seems to have left behind a small blob. Upon investigation, it appears to be a tiny, ruby heart, encased in a slimy " +
                    this.gooColor8() +
                    " membrane. As you reach to pick it up, the jelly ball quivers and pulses with a warm, cheerful light. Your fingers close on it and the nucleus slides through your palm, into your body!\n\n",
                false
            );
    ...
    private gooColor(): string {
        return this.gooGirl().gooColor();
    }
    private gooColor2(): string {
        return this.gooGirl().gooColor2();
    }
    private gooColor3(): string {
        return this.gooGirl().gooColor3();
    }
    private gooColor4(): string {
        return this.gooGirl().gooColor4();
    }
    private gooColor5(): string {
        return this.gooGirl().gooColor5();
    }
    private gooColor6(): string {
        return this.gooGirl().gooColor6();
    }
    private gooColor7(): string {
        return this.gooGirl().gooColor7();
    }
    private gooColor8(): string {
        return this.gooGirl().gooColor8();
    }
    private gooColor9(): string {
        return this.gooGirl().gooColor9();
    }
    private gooColor10(): string {
        return this.gooGirl().gooColor10();
    }
    private gooColor11(): string {
    ...
    private gooGirlBadEnd(): void {
        this.outx("", true);
        this.outx(
            "You collapse, your strength gone, body open to the investigation of the goo-girl.  Her expression, however, has become one of excitement and focus rather than playful curiosity.  With exaggerated gestures, the " +
                this.gooColor() +
                " girl tilts her head left and right, shakes her shoulders, and wraps her fingers together, as if cracking her knuckles. Rubbing the dripping palms of her hands together, she draws backward before leaping at you. Instead of the slimy, semi-solid splash you were expecting, the girl sinks INTO your body, her muck penetrating your membrane and filling you in a way you've never felt before. Her crimson nucleus flashing rapidly within you, every inch of your body quivers and bulges under the pressure of her added mass.\n\n",
            false
        );
        ...
        this.outx(
            "Panting, trying to come to terms with your new memories, you notice that the girl's nucleus appears to be half a heart, neatly bisected down the middle. You look at yourself and find the other half floating inside your chest, shedding its soft, scarlet light in time to your gasping breath. The half-hearted girl smiles mischievously and winks at you. A sudden wash of heat erupts from her " +
                this.gooColor2() +
                " body and it's all you can do to avert your face from the blaze of magma she's made of herself. The meaning of the girl's warmth is immediately apparent- all across the surface of the lake, dozens of cute, curious heads poke above the water, gel-like faces locking onto the intense signal of your companion. Sliding swiftly, the other girls rush toward you, their faces positively brimming with an expression that almost seems like lustful hunger.\n\n",
            false
        );
    ...
    public getBeatByGooGirl(): void {
        ...
        if (this.flags[kFLAGS.GOOGIRL_CONSECUTIVE_LOSSES] >= 5 && this.player.gooScore() >= 4)
            this.gooGirlBadEnd();
        else if (this.player.gender == 0) this.genderlessLoseToGooGal();
        else if (this.player.gender == 1) this.dudeLoseToGooGal();
        else if (this.player.gender == 2) this.femaleLoseToGooGal();
        else this.hermLoseToGooGal();
    ...
    private genderlessLoseToGooGal(): void {
        ...
        this.outx(
            "Easily slipping through your digestive sphincters, the girl's slime-crafted cock plunges into your stomach and inflates so suddenly that you almost choke on the goo's kiss. Your body fattens to overflowing and your " +
                this.player.legs() +
                " give out. You break the slime's kiss to steal a deep breath before your head sinks beneath the waves. You blink at the white foam in your eyes and when your vision clears, the goo-girl is inches from your face, her expression one of mindless rapture. The fat cockhead in your gut twitches and pulses dangerously before a wave of dizzying fullness floods your chest. An insistent bulge enters your esophagus, working its way up your throat and past your tonsils before slapping the back of your teeth. You open your mouth in surprise and a " +
                this.gooColor5() +
                " blob as large as your head spills from your lips, floating in the water around you. The goo-girl is cumming in your belly and- with the other direction plugged up by her throbbing cock- it's being forced out of your head! Several smaller loads bubble up and you helplessly let them plop past your jaw to join the halo of swirling ejaculate around the two of you. Close on their heels, her shaft begins ascending through your throat, your neck distending at its passage. Your lack of air begins to take its toll as blackness creeps at the edges of your vision and your chest burns with suffocation. Through your woozy haze, you can feel the " +
                this.gooColor6() +
                " cockhead burst from your maw, poking several inches past your nose, just under your eyes. The goo-girl leans in again, this time opening her mouth to swallow her cock before sealing her lips around yours. The last thing you remember is the sensation of bulges moving up your whole body as the girl's mouth fills with her own cum. Then, there is only darkness.\n\n",
            false
        );

        this.outx(
            "You awaken with a sputtering hack, water and gooey " +
                this.gooColor() +
                " cum spilling from your lungs. You've been returned to shore and other than a full-body soreness and a splitting headache, you seem none the worse for wear. Who knew cute little slimes could be so aggressive when they don't have sex organs to suck on?",
            false
        );
    ...
    private dudeLoseToGooGal(): void {
        ...
        this.outx(
            "Reeling, you stumble backwards, trying and failing to shake the dizziness from your eyes. The " +
                this.gooColor() +
                " girl nods, emboldened, and leaps at you, her gushing body splashing heavily against your chest, knocking you to the ground. Your landing takes the breath from your throat and you struggle weakly as the " +
                this.gooColor5() +
                " muck below the girl's knees flows around your limbs, sucking your hands and feet into her slimy membrane with a slurping schlick. Trying to pull free, you stretch her body this way and that, but the goo holds fast, bonding you to her slippery form like warm, elastic shackles. The slime gurgles with pleasure at your struggles, her body rippling with your weak movements, her mouth curled into a happy grin. She gives you a wicked wink and rubs her hands over your hips, her dripping fingers slipping under your " +
                this.player.armorName +
                " and spreading across your flesh like a second skin. With squeezing tickles her groping digits massage her sludgy muck into your " +
                this.player.skin() +
                ". Pursing her mouth into a cute pucker, she grips your vestments between her lips and deftly pulls them aside just enough to let your " +
                this.cockDescript(x) +
                " flop free.\n\n",
            false
        );
        ...
        if (this.player.balls > 0)
            this.outx(
                "The lithe layer of ooze that creeps across your body wraps around your " +
                    ...
                    ", its silken touch like the caressing tips of dozens of fingers, nestling against your swollen testicles, cradling them to feel the rush of cum inflating your sac at the building suction of her mouth.  Even with your " +
                    this.player.armorName +
                    " still on, it feels like she's licking your bulging pouch with her sylphlike hands.  The slime's gooey grip presses against your scrotum with steady strokes, rolling your overinflated balls in their pouch as if the silent girl were playing some mischievous game. You shake your head as your " +
                    this.ballsDescriptLight() +
                    " bloat fuller and fuller at the coy girl's sport.\n\n",
                false
            );
        ...
        if (this.player.cumQ() <= 500)
            ...
            this.outx(
                "The girl's expression goes from pleased triumph to mild panic when your orgasm shows no sign of flagging, load after load racing into her body. She quickly snakes her tongue out of your urethra and tries to pull off of your " +
                    this.cockDescript(x) +
                    ", but her arm is too deep in your ass and she finds herself stuck! You rest your hands on the " +
                    this.gooColor4() +
    ...
    private femaleLoseToGooGal(): void {
        this.outx("", true);
        this.outx(
            "You sway, finding it difficult to maintain your balance. When you fall, your " +
                this.buttDescript() +
                " splashes wetly in the enveloping folds of the goo-girl's eager slime. You weakly hold your hand up to keep her back, but the wide-eyed victor disregards the gesture with playful disdain. She slithers against you, moist muck slurping at your flesh with a hungry heat. Her semi-solid hands take yours, pulling your arms apart to bare your chest. She cranes her dripping head around your shoulders, skillfully removing your " +
                this.player.armorName +
                " with only her mouth. Your " +
                this.chestDesc() +
                " heave as the irrepressible heat of the slime sears your " +
                this.nippleDescript(0) +
                "s until beads of sweat well up on your " +
                this.player.skin() +
                " and trickle down your curves, leaving a wet sheen over your body.\n\n",
            false
        );
        ...
        //  [If the player is not obviously pregnant/small breasts/not lactating]
            ...
            this.outx(
                "Shrugging, you gesture at yourself, unsure what she's trying to communicate to you. The goo-girl rolls her eyes and soundlessly sighs in exasperation. She grabs hold of you and runs her hands from your head to your hips, her body rippling as she does so, sculpting itself into a crude copy. She brings your attention to her belly and breasts, pointing to them as they swell and grow, nipples leaking " +
                    this.gooColor8() +
                    " goo-milk. Her stomach plumps further and further until she squeezes her whole body and a small, spherical blob tumbles from between her legs before being reabsorbed in her puddle. It's pretty obvious that the slime is telling you that you're pregnant.\n\n",
                false
            );
            this.outx(
                "Disparagingly, she pokes your " +
                    this.player.allBreastsDescript() +
                    " and shakes her head, an expression of disappointment on her face. She smiles and strokes your cheek, patting you comfortingly on the head with a dripping appendage. She quirks her head to the side and her blank eyes light up in the excitement of inspiration. Grabbing the sides of her hair, she lifts two of the gooey hair clumps and sculpts them into tiny cow horns. With a focused determination, she bites down on her lower lip and balls her mitten-like hands into fists, inflating her chest larger and larger, until it begins to dwarf the rest of her body. Her arms stretch out, around the titanic chest and grab the back of your head, pulling your mouth against her wobbling breast. Pulling your lips apart, she seals your face around a shimmering nipple.\n\n",
                false
            );

            this.outx(
                "Tentatively, you take an experimental swallow, a thin trickle of " +
                    this.gooColor7() +
                    " gel rolling warmly down your throat. The taste is vaguely familiar, but you can't quite place it. Taking another gulp, you roll the milky goo around in your mouth, trying to identify the flavor, but it continues to elude you. For some reason, it seems very important to determine the maddening fluid and you suck as hard as you can, steady streams of slimy cream filling your belly with a blossoming heat. When the goo-girl pulls you off, you're a little surprised to see that your breasts have grown! The liquid weight in your stomach seems to have expanded your chest. You tweak a " +
                    this.nippleDescript(0) +
        ...
        if (this.player.pregnancyIncubation <= 280 && this.player.pregnancyIncubation >= 1) {
            this.outx(
                "The fluid woman squeezes her goopy breasts against yours and the globes jiggle with their liquid weight. The " +
                    this.gooColor() +
                    " girl wriggles against you with an ecstatic expression, delighting in the quivering vibrations of your body. She presses her palms to your breasts and the warm goo engulfs your " +
                    this.nippleDescript(0) +
                    " with a wet plop. She plays with your tits, rolling them in her hands while the slurping goop of her body sucks at your swollen mammaries. She bends down to pepper your pulsing tit-flesh with tiny, moist kisses that leave " +
                    this.gooColor() +
                    " lip prints on your " +
                    this.player.skin() +
                    ". Rocking her body against yours, the girl's expression mimicks the helpless, agonized bliss of your face, her cheeks even flushing indigo to imitate your blush. She darts in and gives you a deep, full-bodied kiss of pregnant joy and your " +
                    this.player.allBreastsDescript() +
                    " burst with creamy milk, even as your climax leaves your body as quivering as the goo-girl's. Feeding on your sexual release, she arches her back and her hearts flicker wildly, her body losing some of its focus as it appears to melt under her orgasmic heat.\n\n",
                false
            );

            this.outx(
                "Thick trails of milk squirt into the slime's hands and down her arms, filling the girl's " +
                    this.gooColor() +
                    " body with your creamy milk.",
                false
            );
            ...
            // [medium milk only:
                ...
                this.outx(
                    "  You bite your lip and let go, torrents of rich, pearl fluid rushing through her arms and inflating the surprised girl before your eyes. The milk gushing into her fills the goo from base to breast, giving the once-" +
                        this.gooColor5() +
                        " girl an opalescent shine, her over-filled body bloated as if she were carrying triplets.",
                    false
                );
            this.outx(
        ...
        // [If the player isn't pregnant]
            ...
            this.outx(
                "The goo-girl flashes a broad smile and tickles under your chin to get your attention. Apparently trying to communicate her intent, she puffs out her cheeks and pats her belly, jiggling her amorphous frame in the process. Next, she taps your nose and pats your belly, slapping your " +
                    this.player.skin() +
                    " with a moist splat of her hand. Your expression remains blank and she sighs soundlessly, turning cold in annoyance. The slime presses you on your back and lifts your " +
                    this.player.legs() +
                    " into the air. In a splattering motion, the goo lets her lower half sink into the thick sludge of her feet until only her upper torso remains. Then, with impatient force, she descends on your " +
                    this.vaginaDescript(0) +
                    ", her yielding breasts rolling across your lower body.\n\n",
                false
            );

            this.outx(
                "The girl's face finds your all-too-eager pussy swiftly enough, her tongue tracing every fleshy fold of your labia while the warming slime of her lips suck at the moisture of your rapidly lubricating slit. She pushes a little harder, forcing the oozing length of her tongue inside of you, its pulsing surface expanding and contracting, leaving you squirming and gasping, biting at one of your knuckles while the goo prods the limits of your womanhood. Seemingly satisfied, she screws her face into an expression of intense focus and slaps her head down, between your thighs. The delicate features of her nose and face press against your lower lips with an insistence that practically melts you before, shockingly, her head begins to squeeze into your " +
                    this.vaginaDescript(0) +
                    "!\n\n",
                false
            );
            ...
            this.outx(
                "You try to stop the girl's progress, frantically, wagging your legs and clenching your inner walls together, but your strength has left you and her " +
                    this.gooColor() +
            ...
            if (this.player.vaginalCapacity() <= 30)
                ...
                this.outx(
                    "More and more of her ooze thrusts into you, shivers of overstimulation tearing through your mind like fists through wet parchment. Your eyes roll aimlessly as the pressure makes it difficult to breathe. With a squelching slurp, the last of the girl's form is pulled inside your slavering pussy.",
                    false
                );
            this.outx(
                "  Your body is wildly distorted by the intruder, some aspect of her slimy coating anesthetizing your anticipated pain with tooth-grinding pleasure. You stroke your bloated form, thoughts turning to sweet daydreams of pregnancy, your body full of a pulsing, liquid life, dependent upon you and squirming with eager desire.\n\n",
                false
            );

            this.outx(
                "When the girl begins sliding back out, it's all you can do not to vocalize your disappointment with a feeble moan. Splashing in an expanding puddle, the girl gradually molds her features back into a humanoid shape, but you notice she's smaller than before. Touching your belly, you can feel a jiggling orb still inside of you. You nearly bite your tongue when the straggler presses up against your cervix and forces its way into your womb with wriggling suction. Your body clenches in orgasm, but the slime's fluid body works past your sphincter-tight barrier and distends your gut with its occupancy. You shake in the squirting throes of your climax and the reduced woman rubs her cheek against your goo-slick breasts affectionately. Dimly, you notice that her heart-shaped core has been split right down the center, the other half, presumably, inside your body. With a wave goodbye, she plunges back into the lake, leaving you hot, wet, and pregnant- or what passes for pregnancy in asexual creatures.",
                false
            );
            if (this.player.pregnancyIncubation >= 1)
                this.outx(
                    "  Everything she pumped into you runs back out after.  For some reason or another, it didn't take.",
                    false
                );
            else {
                this.player.knockUp(
                    PregnancyStore.PREGNANCY_GOO_GIRL,
                    PregnancyStore.INCUBATION_GOO_GIRL,
                    1,
                    1
                );
            }
        ...
        if (this.player.gender == 0 || this.player.lust < 33) {
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.hasVagina()) {
                    sex3S = "Herm Sex";
                    sex3N = this.victoryHermSex;
                }
            } else if (this.player.hasVagina()) {
                sex1S = "Fuck";
                sex1N = this.normalFemaleRapesAGooGirl;
            ...
            if (
                ...
                this.flags[kFLAGS.TIMES_FUCKED_NORMAL_GOOS] >= 2
            ) {
                if (
                    this.player.cor < 50 &&
                    ...
                    if (
                        ...
                        this.outx("  Good thing you have those handy!");
                        gooTF = kGAMECLASS.latexGirl.meanGooGirlRecruitment;
                    }
                }
            }
            if (valeria != undefined) {
                this.outx(
                ...
                if (this.flags[kFLAGS.TIMES_VALERIA_GOO_THREESOMED] == 0)
                    this.outx(
                        "Do you offer a threesome with the girl to Valeria? It could get a little weird...."
                    );
                else
                    this.outx(
        ...
        if (this.player.cocks[x].cockLength < 24) {
            this.outx(
                "Dropping to the goo-girl's level, you roughly grab her pulsing breasts, fingers sinking an inch into the slime before her surface tension gives you something to grip. Her membrane squishes between your fingers with lewd squelches as you squeeze harder, rolling the " +
                    this.gooColor() +
                    " orbs in your palms, her " +
                    this.gooColor2() +
                    " nipples bulging outward the harder you press. She noiselessly coos at your stimulation and shivers of delight ripple through her body. Stroking your body with soft hands, the goo-girl leaves " +
                    this.gooColor9() +
                    " film of warm slime across your " +
                    this.player.armorName +
                    " that quickly leaves you too hot to stay clothed. You strip and the buxom slime flashes a happy smile of victory.\n\n",
                false
            );

            this.outx(
                "Noticing your hardening length, the goo-girl claps her hands in gushing pleasure and gently pushes you back onto your " +
                    this.buttDescript() +
                    ". Rubbing her moist cheek against yours, she slides down your " +
                    this.chestDesc() +
                    " and perches over your groin. Slowly, she moves back and forth, stroking your shaft with the perky wetness of her stiff nipples. She hovers over your manhood for a moment before dropping down, her sloping cleavage stroking your cock between her slimy pillows with a slurping squelch. Pressing her balled-up fists to either side, she squeezes your " +
                    this.cockDescript(x) +
                    " between her breasts and begins to slowly pump your stiffening organ. The natural lubrication of her gooey skin makes the tit-fuck pleasantly slick, softness sucking your flesh with wet gulps as she rolls from base to tip, your cockhead popping between her cleavage at a brisk pace, cooled by the air for only a moment before it is swallowed once more by the seething heat of her chest. Through her transparent skin, you can see your " +
                    this.cockDescript(x) +
                    " being massaged by the gooey embrace of her tits. Your body trembles to the precipice of an orgasm, muscle spasms and a shortness of breath makes each pump of your slime-oiled hardness more exquisite than the last, as if the girl's murky breasts were pulling the air from your lungs.\n\n",
                false
            );
        ...
        // [Dick 2ft or larger]
            ...
            this.outx(
                "You hook your hands under her arms and haul the girl upwards, legs forming as her amorphous puddle shrinks and pools together into blobby limbs. She wobbles, finding it difficult to stand on two feet, and wraps her arms around your neck to steady herself. Squishing her body against yours, the goo-girl's " +
                    this.gooColor4() +
                    " slime leaks under your " +
                    this.player.armorName +
                    ", warm moisture lapping at your skin. Your shaft begins to stiffen under her boiling, wet hug and you peel off your clothes to let your mammoth girth stand free. Turning the girl around in your arms, you slap your burgeoning cock between her jiggling ass cheeks and haul her hands back, gripping the delicate, murky " +
                    this.gooColor() +
                    " fingers in one palm. With your other hand, you press down on the back of her head, bending the girl at a right angle. The slime shimmers and eyes open up in the back of her head, trying to figure out what you're doing.\n\n",
                false
            );
            ...
            this.outx(
                "With a forceful thrust, you push into the girl's drooling hole and are disappointed when you bottom out after a mere three inches. Clearly, she has entirely the wrong idea of sufficient depth. Giving her arms a jerk, you pump into her harder, pounding her recess until the slimy, sucking walls give before the pressure of your insistent member. She curls her mouth into a surprised O and molds her tunnel deeper, allowing you to feed more of your twitching fuck-pole into her. Eight, then ten, then twelve inches slap into the girl, your manhood visibly bisecting the goo as you slam past her rolling ass and squishy hips, into her belly. By the time twenty inches of your " +
                    this.cockDescript(x) +
                    " are inside her, your tip is just about level with her chest, breasts wobbling heavily as you impale the girl on your straining flesh-rod.\n\n",
                false
            );

            this.outx(
                "As your tip nears the girl's red core, she begins to squirm, your ceaseless pounding exciting her vibration-sensitive membrane. Her heart-shaped nucleus retreats into her head, making room for your seemingly endless cock. Finally, at twenty-three inches, it seems you've reached the end of her stretchy capabilities, her inner walls pulled so tightly around your colossal prick that every pulse of blood through your " +
                    this.cockDescript(x) +
                    " sends ripples through her body. You take a moment to bask in the heavenly fullness of the gooey onahole, her liquid mass suckling at your skin, pulsing with the eager need for your sweet protein.\n\n",
                false
            );

            this.outx(
                "But, if she was going to get fucked how she wanted, you reason, she should've put up a better fight in your little scuffle. Releasing her arms, you grab the goo-girl's pliable hips and fall backward, landing on your " +
                    this.buttDescript() +
                    " and dragging her with you. She flails her arms as the inflated globes of her ass squelch against your lap, penetrating the integrity of her inner passage as you slam the rest of the way up her throat. The girl opens her mouth in shock just as your tip emerges from her neck, pushing her jaw down and pulling her lips in a tight circle around your twitching glans. The girl's sultry body clenches down, trying to reseal the hole you've fucked all the way through her, giving you the final tension you need to climax.\n\n",
                false
            );

            this.outx(
                "Your orgasm bursts from your loins, thick loads pumping in bloated bulges up her squirming body and erupting from your corona in an ivory shower that splatters in wet ropes across the girl's stuffed face, her wobbling tits, and all along her translucent " +
                    this.gooColor5() +
                    " body. Like an unwilling cum hose, the girl wriggles, unable to disentangle herself from the flagpole of your " +
                    this.cockDescript(x) +
                    ". She settles with gathering your slippery, pearl seed with her hands, stuffing the nutrient-rich jizz into her belly button, which expands to slurp up the spunk like a second mouth. When the last of your climax is spent, you unsteadily regain your feet and slide the slime off your titanic shaft, her interior resealing with a gurgling plop. She rubs her stretched jaw and shoots you a look of playful annoyance before patting the milk-like bloat of her belly. She flashes a grin and slithers back into the lake.\n\n",
                false
            );

            this.outx(
                "If only all of Mareth's denizens were so accommodating, you muse, as you gather your things and depart.",
                false
            );
            this.coreDropChance();
        }
    ...
    private victoryHermSex(): void {
        ...
        this.outx("", true);
        this.outx(
            "The goo-girl relents, her body sloshing into the puddle at her feet. Apparently convinced you want to explore her body, she composes her face into a willing smile and raises her arms at her sides, baring her " +
                this.gooColor8() +
                " torso for inspection. The slime's chest juts out in perfect hemispheres, untouched by gravity and topped with puffy, " +
                this.gooColor4() +
                " nipples that steadily drip a gooey imitation of milk. Her waist is whip-thin but broadens at her hips to accommodate her smooth, shiny rump, which she wiggles happily. Her hourglass figure would be life-threatening on any solid organism, but on the goo-girl, it merely appears she's been molded by someone with a dim grasp of anatomy.  Apparently, if slimes can't touch an organ, they don't consider it terribly important.\n\n",
            false
        );

        this.outx(
            "Reaching out, you take hold of her breasts, the gelatinous orbs jiggling at your touch. Her slick membrane is strangely warm, curtains of heat playing across her skin in an attempt to speak a language you don't understand. You communicate in your own way by giving the girl a slap across her tits, the fluid mammaries rippling from the impact. Her mouth curls into a little 'o' of shocked pleasure and she nods in encouragement. Giving her another open-palmed smack, you notice that her breasts begin to enlarge, providing more surface area for you to strike. The slime seems to be getting off on the spanking, so you slap her again and again, " +
                this.gooColor() +
                " jelly quivering in " +
                this.gooColor5() +
                " tidal waves, her bloating chest swallowing her belly and waist as it inflates under your stimulation. Her body heaves in imitation of orgasmic panting and her arms sink into her oceanic bosom, squeezing the shimmering pillows together for you.\n\n",
            false
        );

        this.outx(
            "Quickly stripping, you let your " +
                this.multiCockDescriptLight() +
                " slap against her turbulent membrane, the warm muck gurgling wetly at your turgid stiffness. Sinking your fingers into the girl's yielding breasts, you push forward, pulsing flesh sliding into the " +
                this.gooColor2() +
                " depths of her expanded cleavage. The goo-girl's chest sucks eagerly at you, pliant slime drooling warm " +
                this.gooColor5() +
                " beads of unnecessary lubrication as you pick up your pace. Staring at your " +
                this.multiCockDescriptLight() +
                " moving in and out of the girl's chest through her transparent skin, you are surprised to see her body shifting further under your pounding. A vertical slit opens between her breasts and her membrane quickly folds itself in delicate petals around the edges. Your next thrust pushes into the new cavity and the organic texture confirms your suspicion: she's created a vagina between her breasts for you to fuck!\n\n",
            false
        );

        this.outx(
            "Slowing yourself to enjoy the experience, you note that she seems to have made her new cunny too tight- every inch you push in displaces her mass, forming a bulge beneath her abdomen. Without even pausing, you lower yourself to sit atop the girl's lap and jam your " +
                this.cockDescript(x) +
                "  into her narrow tunnel. The bulge rises into your dripping pussy, her moist shaft conforming to your inner walls for a moment before stiffening into a replica of your own dick.  "
        );
        this.player.cuntChange(this.player.cockArea(0), true, false, true);
        this.outx(
            "Every time you withdraw from the squirming slime, she pulls out of you and every time you slam back in, your pussy fills with the aching delight of the gooey copy-cock. Through the girl's mimicking body, you've found a way to fuck yourself by proxy! The thought fuels your pace as you accelerate to a fevered pitch. Slamming the " +
                this.gooColor5() +
                " mirror of your " +
                this.cockDescript(x) +
                " into your sloppy cunt, you ride yourself with reckless abandon.  The force of your fucking is too much for the goo-girl and she silently cries out in ecstatic bliss before the pulsing scarlet heart in her chest is violently ejected from her body, splashing a hundred yards away in the lake's depths. With no core, the empty girl's face becomes wanton, little more than a lusty slut unable to sate her need to fuck, her tongue dangling out of the side of her mouth.\n\n",
            false
        );

        this.outx(
            "Before long, you find yourself mimicking the heartless whore, eyes lidded heavily and mouth agape at the doubled sensations of the hard fucking you're giving yourself. You know your body's sensitive weaknesses too well, it seems, and you're unable to hold out for very long. The slime-duplicate cock that strokes every delicate inch of your drooling pussy blends into the slippery cunt between the goo's breasts, tightening in pulsing rings of lubricated, velvet muscle. When you cum, both organs twitch in orgasmic spree, the feeling of filling and being filled scrambling your mind with sensory overload. Thick globs of cum splurt into the slime girl's body, pushing equally huge bubbles of seething hot muck into your clenched lower lips, splooshing gunk plopping against your cervix and sloshing together into one gurgling blob of slime-ejaculate. Wrapping her arms around you in a big, cheerful hug, the mindless shell keeps you pinned down until your cunt aches and your dick begins to stiffen again. Before a second round, however, the goo loses her consistency, the lack of a nucleus melting her wobbling form into a seed-saturated sludge that wiggles back toward the water's edge. You rise, panting hotly, deciding it's time to move on.",
            false
        );
    ...
    private victoryRapeAGooGalAsFeeder(): void {
        ...
        this.outx(
            "Stripping your " +
                this.player.armorName +
                " to the waist, you settle on your ass, guiding the slime to a sitting position in front of you, her gaze darting back and forth, debating if she still has a chance to run. Before she can weigh the option any further, you seize her head with both hands and brace your thumbs on either side of her jaw. With a bit of pressure, her gelatinous head squishes between your fingers, mouth opening under the force of your grip while her eyes fill with silent panic. Your chest heaves in the open air, the heat of the goo-girl's muck feeding into the furnace your thumping heart has made of your flesh. Unbidden, pale cream bubbles along the sensitive surface of your nipples, beading like sweat on your skin. You pull the girl's head against your leaking mammary, guiding her " +
                this.gooColor4() +
                " lips into a suckling seal around your areola, squelching slime lapping at your trembling mound. A pressure builds just beyond your ribs and you grit your teeth, clenching your eyes shut as you push past the resistance, squeezing your thighs together. With a sweet, trembling wave of blissful release, your breast gushes into the girl's mouth, a torrent released from the swollen bounty of your heavy peak. Your fingers dig into the girl's head as you press her pliant softness into the yielding swell of your " +
                this.player.allBreastsDescript() +
                ". The girl sucks gently, but every licking ripple of the slime's molded mouth excites your tingling breast with the familiar, surging sensations that creeps into your mind, clawing out all rational thought and leaving behind only the primal need to nurse.\n\n",
            false
        );

        this.outx(
            'The slime swallows, creamy milk floating down her neck and into her belly as she pops her lips off of your breast. "<i>Not enough,</i>" you pant, mouth twisting into a snarl. Sliding your thumbs from her jaw to her mouth, you hook your digits into the sides of her lips and pull outward, stretching her mouth wider and wider. Thrusting your chest forward, almost violently, you press your breasts together, between the sides of your arms, rubbing your nipples against each other. Jamming them into her stretched mouth, you begin jerking her head back and forth, fucking her face with your nipples. She gasps and the action seals her mouth as tight as a pussy around your intruding peaks, ' +
                this.player.allBreastsDescript() +
                " squirting increasing loads with every thrust. On some level, you delight in the knowledge that the girl doesn't need to breathe as you have no desire to relent your milk-heavy assault, orbs throbbing with every pink-tipped smack against her " +
                this.gooColor5() +
                " face. After a few minutes of your pounding, she's given up struggling against you, rounded eyes relenting to a vacant expression as you use her head as a slimy milking machine.\n\n",
            false
        );

        this.outx(
            "Again and again, you fill her cheeks with your glistening warmth, and it's all she can do to swallow as quickly as possible, her throat bulging with the alabaster loads rolling into her over-full belly. Overwhelmed, the goo-girl's ruby heart rolls helplessly in the fattening slime's body, unable to digest the sheer volume of lactate you're pumping into her. Running out of places to store it, the girl's own breasts begin to inflate, her " +
                this.gooColor2() +
                " nipples leaking in bubbling rivulets to mirror your own aching mounds. She cycles through cup-sizes faster than you can list them, the burgeoning promise of her curved bounty weighing her down until her chest bounces against the puddle of her feet with every jiggling gulp. The " +
                this.gooColor8() +
                " hair sliding across your fingers begins to writhe and twist, gooey strands merging and rising to the sides of her head forming two little horns on either side of her head, her body morphing into a shape more appropriate for the sloshing udders her chest has become under the suckling you're forcing on the girl. You've fed her so much that she's become a milk cow, you realize with a shuddering pleasure that touches the addiction center of your brain so intensely that you feel yourself creaming in a sequence of full-body contractions, muscles clenching with shivering rapture. It's just so right, you muse, panting through the coiling suffocation of your orgasm, to awaken in others the NEED to be fed. How sweet to nurse and to be used! And how much sweeter to teach others the mind-erasing desire to be little more than a beast, addicted to the lust of being milked!  ",
            false
        );
        if (this.player.hasVagina())
            this.outx(
                "Even without stimulation, your clit practically vibrates under your climax, squeezing your body to its limits until everything fades into a pearl haze and you lose yourself to the euphoria.\n\n",
                false
            );
        else if (this.player.hasCock())
            if (this.player.hasVagina())
                this.outx(
                    "Even without stimulation, your cock practically vibrates under your climax, squeezing your body to its limits until everything fades into a pearl haze and you lose yourself to the euphoria.\n\n",
                    false
                );
            else if (this.player.hasVagina())
                this.outx(
                    "Even without stimulation, your tingling anus practically vibrates under your climax, squeezing to its limits until everything fades into a pearl haze and you lose yourself to the euphoria.\n\n",
                    false
                );

        this.outx(
            "When you regain consciousness, your breasts finally feel empty, milked dry by your rough treatment of the goo-girl. Shaking your head, you look for a sign of the girl and spot something a short distance off in the lake. You almost don't recognize her at first, until you notice the tiny, jiggling horns poking out of the sides of her head. The cow-slime has apparently captured a shark girl and an anemone, her pale " +
                this.gooColor() +
                " membrane wrapping around their bodies like giant fists. She's holding them to each giant breast, kneading their faces against her quivering membrane as her periwinkle nipples gush with your milk, soaking their heads and filling their senses with your addictive fragrance. In short order, they wrap their mouths around the " +
                this.gooColor5() +
                " faucets and begin to drink deeply, the cow-goo's face a silent mirror of your previous climax. Two more girls being taught the joys of lactation, you murmur, touching yourself with a gleeful shudder. Forcing yourself to master the desire to keep watching, you clean yourself up and head out, pleased gurgles fading into the distance.",
            false
        );
        this.coreDropChance();
        this.player.orgasm();
    ...
    private exhibitionismGooGirlVictoryRape(): void {
        ...
        this.outx("", true);
        this.outx(
            "The slimy girl wobbles back and forth, curiously eyeing you with her mouth turned up in an expectant smile. Glancing around, you notice that your little scuffle with the slime has attracted several onlookers! From deeper in the lake, a grey-tinted shark girl and violet-colored anemone seem to be watching you with mild interest while on the shore a robed man has interrupted his secretive journey to eye the two of you warily. Further away, a small minotaur stands, surprisingly far from the mountains, sniffing the air and taking his measure of potential mates. The variety of eyes upon your body brings a cold sweat to your brow and you bite your lower lip with a ragged suck of air between your teeth. Fists clenched, you bow your head as your pulse quickens. With trembling hands, you reach up and loosen your " +
                this.player.armorName +
                " with deliberate slowness, stripping them from your form until you stand, bare skin exposed to all five viewers. With a nervous smile, you move closer to the goo-girl. Every step you take is followed so carefully by your watchers that it sends a thrill of excitement to your gut that ignites your loins with a steady dripping between your thighs. The slime girl purses her lips at your advance before seeming to notice the figures watching the two of you with a delighted clap of her mitt-like hands.\n\n",
            false
        );

        this.outx(
            "You close the distance with the " +
                this.gooColor8() +
                " girl and she rises up out of her puddle to meet you shoulder to shoulder, wrapping her slimy arms around your waist with an eager grope. You blush at the warm contact and can almost hear the intake of breath from your audience when you press your " +
                this.player.allBreastsDescript() +
                " into your partner's, flesh and membrane squishing against each other and gooshing out at the sides, as your stiff nipples rub against her slippery peaks. The goo's mouth opens in a silent moan and her wobbly membrane begins dripping thick beads of " +
                this.gooColor2() +
                ". The goo rubs against you in a steady, circular motion, her hands tracing the small of your back and up along your spine, her slippery slickness covering your skin in a " +
                this.gooColor4() +
                " film so thin and shimmering that it looks almost as though she is oiling your body with a " +
                this.gooColor6() +
                " lacquer. In your lust-filled mind, it is as if the gazes on your exposed form are filling your flesh with the heat of their desire until you realize that your body temperature actually is increasing with each passing second. The goo-girl's oil seems to retain the slime's rippling warmth and it caresses your torso with her playful glee, infectious giddiness adding fuel to the fetish worming its way through your brain. You guide your hands over your hips and across your " +
                this.player.skin() +
        ...
        this.outx(
            "Your hands find the goo-girl's and your fingers entwine around the girl's oozing digits, palms pressed together hard enough to send ripples down her arms. You lean forward and lick the side of her face, surprised to find that, despite the girl's heat, she tastes cold and sweet, like " +
                this.gooColor10() +
                " washed in a mountain stream. She kisses your cheek, leaving a " +
                this.gooColor5() +
    ...
    private normalFemaleRapesAGooGirl(): void {
        ...
        this.outx("", true);
        this.outx(
            "The slimy girl wobbles back and forth, curiously eyeing you with her mouth turned up in an expectant smile. You don't doubt that she'd enjoy playing with your body given half a chance, but your victory in the scuffle has given you a rare opportunity to try out something that been lurking in the back of your head for a while. With a devious smile, you remove your " +
                this.player.armorName +
                " until your bare flesh shivers at the cool wind blowing over the surface of the lake. You hook a beckoning finger to the goo-girl and she shrugs, a willing grin on her face. Splashing toward you, the girl's puddle laps at your " +
                this.player.feet() +
                ", " +
                this.gooColor2() +
                " muck lapping around you until you hold a palm up to stop her. Reaching down, you wrap your hands under her arms and haul her upward, plump legs forming under her waist as she grows taller and taller until you're eye to eye with the slime. Placing your fingers on her hips, you turn the girl around until her jiggling butt is pressed against your " +
                this.hipDescript() +
                ", warm goop wobbling with your every movement. Taking a deep breath, you shake out your shoulders and swallow. Here goes nothing.\n\n",
            false
        );
        ...
        this.outx(
            "With your hands wrapped around the goo-girl's waist, you take a step forward. The pliant ooze of the girl's body squelches at the pressure of your legs straining against her membrane, spilling out to the side of her hips and she perks her head up, unfamiliar with what you're trying to do. You push harder, keeping her in place as you move against her, more forcefully this time. Her body squeaks with the slapping pressure against her yielding form and she furrows her brow, pointing at her mouth and between her legs. You just smile and pull her against you harder and harder, her expression becoming pinched with the force of your attempt to move through her. Finally, her mouth gapes in discomfort and her membrane parts, gooey legs becoming permeable and squishing around " +
                this.player.legs() +
                ", engulfing your lower body in her " +
                this.gooColor4() +
                " slime. Your " +
                this.vaginaDescript(0) +
                " sinks into the muck of the girl's body and her heat washes over you in a wonderful embrace of fluid tightness that caresses as much as it gurgles across your sensitive flesh. Wet and soft, the inside of the girl's gelatinous form sculpts itself around yours like a slimy mold. As delightful as the moist embrace is for you, it seems to be getting the goo off even more, the rest of her membrane trembling, unable to maintain firmness in the assault of your invading body. You easily push your arms into her shoulders and down the dripping shafts of her " +
                this.gooColor8() +
                " limbs, fingers siding into hers like moist gloves of gelatin.  Your " +
                this.player.allBreastsDescript() +
                " goosh against her back and the tiny red heart in her chest retreats into her head as your orbs sink into the translucent girl's sapphire torso and rest within her wobbling breasts, her tits cupping your flush mounds like huge, warm mouths, her " +
                this.gooColor5() +
                " nipples tweaking yours ever so slightly as they pop into the pert nubs. You take another deep breath and release it, savoring the sensation as her back slowly closes up around your shoulder blades, sealing you to the neck in the goo-girl's body.\n\n",
            false
        );
        ...
        this.outx(
            "The sensations are so strange all over your body that it is overwhelming at first. You have to steady your breathing to keep the heat and tightness from subsuming your mind, so you take inventory of your body, focusing the cresting ecstasy of complete immersion down to more manageable chunks. The slime embracing your " +
                this.clitDescript() +
                " vibrates ever so slightly, teasing you so lightly it is maddening, your fingers twitching with the desire to rub yourself more vigorously. The goo around your pussy and ass is less coy, pressing inward with every heartbeat, penetrating you by inches as the bunch at your feet rolls upward to fill every nook and crevice of your curves with its oily " +
                this.gooColor2() +
                ". The goo inside you is just thick enough to make it difficult for you to take deep breaths, but soft enough to let your body squeeze and clench with gushing spasms that leave you swaying in place, not daring to move too much. Your breasts feel weightless, suspended in the thick fluid of the goo's body, leaving you light-headed and almost giddy, unable to help yourself as you play with your chest, wobbling the " +
                this.gooColor2() +
                " mammaries and giggling at the endless ripples that radiate over your chest, the motion sending curtains of heat rolling over your sensitive " +
                this.player.skin() +
                ".\n\n",
            false
        );
