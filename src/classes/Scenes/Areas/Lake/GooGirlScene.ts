...
export class GooGirlScene extends AbstractLakeContent {
    ...
    private gooGirlBadEnd(): void {
        this.outx("", true);
        this.outx(
            `You collapse, your strength gone, body open to the investigation of the goo-girl.  Her expression, however, has become one of excitement and focus rather than playful curiosity.  With exaggerated gestures, the ${this.gooColor()} girl tilts her head left and right, shakes her shoulders, and wraps her fingers together, as if cracking her knuckles. Rubbing the dripping palms of her hands together, she draws backward before leaping at you. Instead of the slimy, semi-solid splash you were expecting, the girl sinks INTO your body, her muck penetrating your membrane and filling you in a way you've never felt before. Her crimson nucleus flashing rapidly within you, every inch of your body quivers and bulges under the pressure of her added mass.\n\n`,
            false
        );
        ...
        this.outx(
            `Panting, trying to come to terms with your new memories, you notice that the girl's nucleus appears to be half a heart, neatly bisected down the middle. You look at yourself and find the other half floating inside your chest, shedding its soft, scarlet light in time to your gasping breath. The half-hearted girl smiles mischievously and winks at you. A sudden wash of heat erupts from her ${this.gooColor2()} body and it's all you can do to avert your face from the blaze of magma she's made of herself. The meaning of the girl's warmth is immediately apparent- all across the surface of the lake, dozens of cute, curious heads poke above the water, gel-like faces locking onto the intense signal of your companion. Sliding swiftly, the other girls rush toward you, their faces positively brimming with an expression that almost seems like lustful hunger.\n\n`,
            false
        );
    ...
    private dudeLoseToGooGal(): void {
        ...
        this.outx(
            `Reeling, you stumble backwards, trying and failing to shake the dizziness from your eyes. The ${this.gooColor()} girl nods, emboldened, and leaps at you, her gushing body splashing heavily against your chest, knocking you to the ground. Your landing takes the breath from your throat and you struggle weakly as the ${this.gooColor5()} muck below the girl's knees flows around your limbs, sucking your hands and feet into her slimy membrane with a slurping schlick. Trying to pull free, you stretch her body this way and that, but the goo holds fast, bonding you to her slippery form like warm, elastic shackles. The slime gurgles with pleasure at your struggles, her body rippling with your weak movements, her mouth curled into a happy grin. She gives you a wicked wink and rubs her hands over your hips, her dripping fingers slipping under your ${
                this.player.armorName
            } and spreading across your flesh like a second skin. With squeezing tickles her groping digits massage her sludgy muck into your ${this.player.skin()}. Pursing her mouth into a cute pucker, she grips your vestments between her lips and deftly pulls them aside just enough to let your ${this.cockDescript(
                x
            )} flop free.\n\n`,
            false
        );
        ...
        if (this.player.balls > 0)
            this.outx(
                `  Your scrotum lurches with the force of your load, balls slapping against her cobalt chin as thick cum churns against the obstructing tongue plugging your release. Some chemical in her saliva seems to be reacting inside your ${this.ballsDescriptLight()}, the gurgling ejaculate multiplying, semen filling your pouch and bloating it before your eyes. The rubbing pressure on your prostate just worsens the condition and, for a moment, you fear your balls will swell too large for you to move!\n\n`,
                false
            );
        ...
        if (this.player.cumQ() <= 500)
            ...
            this.outx(
                `The girl's expression goes from pleased triumph to mild panic when your orgasm shows no sign of flagging, load after load racing into her body. She quickly snakes her tongue out of your urethra and tries to pull off of your ${this.cockDescript(
                    x
    ...
    private hermLoseToGooGal(): void {
        ...
        this.outx(
            ` in rippling walls of needy slime. Coils of hot and cold run up and down your ${this.cockDescript(
                x
            )}, as playful tongues part your labia and trace every petal-like fold of your ${this.vaginaDescript(
                0
    ...
    private femaleLoseToGooGal(): void {
        ...
        if (this.player.pregnancyIncubation <= 280 && this.player.pregnancyIncubation >= 1) {
            this.outx(
                `The fluid woman squeezes her goopy breasts against yours and the globes jiggle with their liquid weight. The ${this.gooColor()} girl wriggles against you with an ecstatic expression, delighting in the quivering vibrations of your body. She presses her palms to your breasts and the warm goo engulfs your ${this.nippleDescript(
                    0
                )} with a wet plop. She plays with your tits, rolling them in her hands while the slurping goop of her body sucks at your swollen mammaries. She bends down to pepper your pulsing tit-flesh with tiny, moist kisses that leave ${this.gooColor()} lip prints on your ${this.player.skin()}. Rocking her body against yours, the girl's expression mimicks the helpless, agonized bliss of your face, her cheeks even flushing indigo to imitate your blush. She darts in and gives you a deep, full-bodied kiss of pregnant joy and your ${this.player.allBreastsDescript()} burst with creamy milk, even as your climax leaves your body as quivering as the goo-girl's. Feeding on your sexual release, she arches her back and her hearts flicker wildly, her body losing some of its focus as it appears to melt under her orgasmic heat.\n\n`,
                false
            );
        ...
        // [If the player isn't pregnant]
            ...
            this.outx(
                `The goo-girl flashes a broad smile and tickles under your chin to get your attention. Apparently trying to communicate her intent, she puffs out her cheeks and pats her belly, jiggling her amorphous frame in the process. Next, she taps your nose and pats your belly, slapping your ${this.player.skin()} with a moist splat of her hand. Your expression remains blank and she sighs soundlessly, turning cold in annoyance. The slime presses you on your back and lifts your ${this.player.legs()} into the air. In a splattering motion, the goo lets her lower half sink into the thick sludge of her feet until only her upper torso remains. Then, with impatient force, she descends on your ${this.vaginaDescript(
                    0
    ...
    private gooMaleRape(type = 1): void {
        ...
        if (this.player.cocks[x].cockLength < 24) {
            this.outx(
                `Dropping to the goo-girl's level, you roughly grab her pulsing breasts, fingers sinking an inch into the slime before her surface tension gives you something to grip. Her membrane squishes between your fingers with lewd squelches as you squeeze harder, rolling the ${this.gooColor()} orbs in your palms, her ${this.gooColor2()} nipples bulging outward the harder you press. She noiselessly coos at your stimulation and shivers of delight ripple through her body. Stroking your body with soft hands, the goo-girl leaves ${this.gooColor9()} film of warm slime across your ${
                    this.player.armorName
            ...
            this.outx(
                `Noticing your hardening length, the goo-girl claps her hands in gushing pleasure and gently pushes you back onto your ${this.buttDescript()}. Rubbing her moist cheek against yours, she slides down your ${this.chestDesc()} and perches over your groin. Slowly, she moves back and forth, stroking your shaft with the perky wetness of her stiff nipples. She hovers over your manhood for a moment before dropping down, her sloping cleavage stroking your cock between her slimy pillows with a slurping squelch. Pressing her balled-up fists to either side, she squeezes your ${this.cockDescript(
                    x
                )} between her breasts and begins to slowly pump your stiffening organ. The natural lubrication of her gooey skin makes the tit-fuck pleasantly slick, softness sucking your flesh with wet gulps as she rolls from base to tip, your cockhead popping between her cleavage at a brisk pace, cooled by the air for only a moment before it is swallowed once more by the seething heat of her chest. Through her transparent skin, you can see your ${this.cockDescript(
                    x
        ...
        // [Dick 2ft or larger]
            ...
            this.outx(
                `You hook your hands under her arms and haul the girl upwards, legs forming as her amorphous puddle shrinks and pools together into blobby limbs. She wobbles, finding it difficult to stand on two feet, and wraps her arms around your neck to steady herself. Squishing her body against yours, the goo-girl's ${this.gooColor4()} slime leaks under your ${
                    this.player.armorName
                }, warm moisture lapping at your skin. Your shaft begins to stiffen under her boiling, wet hug and you peel off your clothes to let your mammoth girth stand free. Turning the girl around in your arms, you slap your burgeoning cock between her jiggling ass cheeks and haul her hands back, gripping the delicate, murky ${this.gooColor()} fingers in one palm. With your other hand, you press down on the back of her head, bending the girl at a right angle. The slime shimmers and eyes open up in the back of her head, trying to figure out what you're doing.\n\n`,
                false
            );
    ...
    private victoryHermSex(): void {
        ...
        this.outx("", true);
        this.outx(
            `The goo-girl relents, her body sloshing into the puddle at her feet. Apparently convinced you want to explore her body, she composes her face into a willing smile and raises her arms at her sides, baring her ${this.gooColor8()} torso for inspection. The slime's chest juts out in perfect hemispheres, untouched by gravity and topped with puffy, ${this.gooColor4()} nipples that steadily drip a gooey imitation of milk. Her waist is whip-thin but broadens at her hips to accommodate her smooth, shiny rump, which she wiggles happily. Her hourglass figure would be life-threatening on any solid organism, but on the goo-girl, it merely appears she's been molded by someone with a dim grasp of anatomy.  Apparently, if slimes can't touch an organ, they don't consider it terribly important.\n\n`,
            false
        );

        this.outx(
            `Reaching out, you take hold of her breasts, the gelatinous orbs jiggling at your touch. Her slick membrane is strangely warm, curtains of heat playing across her skin in an attempt to speak a language you don't understand. You communicate in your own way by giving the girl a slap across her tits, the fluid mammaries rippling from the impact. Her mouth curls into a little 'o' of shocked pleasure and she nods in encouragement. Giving her another open-palmed smack, you notice that her breasts begin to enlarge, providing more surface area for you to strike. The slime seems to be getting off on the spanking, so you slap her again and again, ${this.gooColor()} jelly quivering in ${this.gooColor5()} tidal waves, her bloating chest swallowing her belly and waist as it inflates under your stimulation. Her body heaves in imitation of orgasmic panting and her arms sink into her oceanic bosom, squeezing the shimmering pillows together for you.\n\n`,
            false
        );

        this.outx(
            `Quickly stripping, you let your ${this.multiCockDescriptLight()} slap against her turbulent membrane, the warm muck gurgling wetly at your turgid stiffness. Sinking your fingers into the girl's yielding breasts, you push forward, pulsing flesh sliding into the ${this.gooColor2()} depths of her expanded cleavage. The goo-girl's chest sucks eagerly at you, pliant slime drooling warm ${this.gooColor5()} beads of unnecessary lubrication as you pick up your pace. Staring at your ${this.multiCockDescriptLight()} moving in and out of the girl's chest through her transparent skin, you are surprised to see her body shifting further under your pounding. A vertical slit opens between her breasts and her membrane quickly folds itself in delicate petals around the edges. Your next thrust pushes into the new cavity and the organic texture confirms your suspicion: she's created a vagina between her breasts for you to fuck!\n\n`,
            false
        );

        this.outx(
            `Slowing yourself to enjoy the experience, you note that she seems to have made her new cunny too tight- every inch you push in displaces her mass, forming a bulge beneath her abdomen. Without even pausing, you lower yourself to sit atop the girl's lap and jam your ${this.cockDescript(
                x
