...
import { ANAL_LOOSENESS_NORMAL, ANAL_WETNESS_NORMAL, BUTT_RATING_AVERAGE, HIP_RATING_AVERAGE, LOWER_BODY_TYPE_DOG, SKIN_TYPE_FUR, TAIL_TYPE_DOG } from "../../../../includes/appearanceDefs";
...
export class HellHound extends Monster {
    protected hellhoundFire(): void {
        ...
        if (this.player.findPerk(PerkLib.Evade) >= 0 && this.player.spe >= 35 && HellHound.rand(3) != 0) {
        ...
        else if (this.player.findPerk(PerkLib.Misdirection) >= 0 && HellHound.rand(100) < 20 && this.player.armorName == "red, high-society bodysuit") {
        ...
        else if (this.player.findPerk(PerkLib.Flexibility) >= 0 && this.player.spe > 30 && HellHound.rand(10) != 0) {
