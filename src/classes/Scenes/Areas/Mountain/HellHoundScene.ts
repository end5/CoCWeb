...
export class HellHoundScene extends BaseContent {
    ...
    private giveALLTHELETHICITES(): void {
        ...
        if (this.player.dogCocks() >= 2) {
            // the male bad end
            this.outx(
                `This hound is quite clearly a she, bearing a massive septuplet of breasts, and wide hips.  She is also quite clearly pregnant, and radiates an intense aura of power.  One of her two heads intones towards the crazed omnibus, "<i>You called me master?</i>"  "<i>Yes I did my precious Cremera!  Have sex with this imitation at once!  ${this.player.mf(
                    "He",
                    "She"
            ...
            // female part
            this.outx(
                `The hound is quite clearly a he, carrying a pair of 15 inch long black pointed shafts, and a sack containing a quad of cantaloupe sized balls.  He radiates an intense aura of power.  One of his two heads intones towards the crazed omnibus, "<i>You called me master?</i>"  "<i>Yes I did my precious Cimer!  Have sex with this imitation at once!  ${this.player.mf(
                    "He",
                    "She"
                )} is to become your third head!</i>"\n\n`,
                false
            ...
            this.outx(
                `After what feels like hours of painful pleasure without release, you're smacked on your rear one last time, and it feels like Cimer bursts through your body completely.  This finally frees the floodgates, and you feel like you're releasing everything in your body in the most powerful orgasm you've ever felt.  You pant for a moment and look down in front of you.  You can see your ${this.player.allBreastsDescript()} and your pregnant belly in front of you. You also see a package of demonic dicks sticking out in front of you, with a quad of hot balls resting underneath.  In front of you is a large pool of white steaming fluid, with a pink crystal resting in the middle.\n\n`,
                false
            );
