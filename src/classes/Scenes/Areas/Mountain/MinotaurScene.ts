...
export class MinotaurScene extends BaseContent {
    ...
    */
    ...
    private takeMinoCumDirectly(): void {
        ...
        this.outputText("", true);
        this.outputText(
            "Relishing your victory, you breathe deeply, shivering and stretching.  ",
            false
        );
        ...
        if (this.flags[kFLAGS.MINOTAUR_CUM_ADDICTION_TRACKER] < 50) {
            ...
            if (this.flags[kFLAGS.MINOTAUR_CUM_ADDICTION_STATE] > 0) {
                ...
                if (this.player.cor > 60)
                    ...
                    this.outputText(
                        "and resolve to give the beasts a wide berth from now on.",
                        false
                    );
                this.outputText("</b>\n", false);
                this.flags[kFLAGS.MINOTAUR_CUM_ADDICTION_STATE] = 0;
    ...
    public minoAddictionBadEndEncounter(): void {
        ...
        if (this.flags[kFLAGS.MINOTAUR_CUM_ADDICTION_STATE] == 3) {
            ...
            this.outputText(
                "Do you follow the minotaur-scent like the addict that you are?",
                false
            );
            // [Yes] [No]
    ...
    private minotaurBlowjob(): void {
        ...
        if (!this.player.isTaur())
            this.outputText(
                "finding your hands leaving his horns for the back of his head ",
                false
            );
        this.outputText(
