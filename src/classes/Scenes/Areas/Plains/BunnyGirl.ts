...
export class BunnyGirl extends BaseContent {
    ...
    public bunnbunbunMeet(): void {
        ...
        if (this.flags[kFLAGS.MET_BUNBUN] == 0) {
            this.outx("A ");
            if (this.player.tallness > 64) this.outx("short ");
            this.outx(
            ...
            if (this.player.lib > 50)
                ...
                this.outx("and you find yourself thankful for her modesty.");
            else
                this.outx(
        ...
        // Met her
            ...
            if (this.player.cockThatFits(40) >= 0) {
                ...
                this.outx("  Fuck her vagina?");
            } else if (this.player.cockTotal() > 0)
                this.outx("  <b>You're too to big fit inside her...</b>");

            // Dick requires one 40 area or smaller.
            if (this.player.hasVagina()) {
                DickInV = this.bunbunFucksYourVag;
                this.outx("  Her dick in your vagina?");
            }
    ...
    private talkToBunnyBunBun(): void {
        ...
        if (this.player.cockThatFits(40) >= 0) {
            ...
            this.outx("  <b>You're too big to fit inside her...</b>");
        if (this.player.gender > 0) {
            sixtyNine = this.bunbun69;
            this.outx("  Sixty-nine her?");
        }
    ...
    private bunbunFucksYourVag(): void {
        ...
        if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_SLICK)
            this.outx(", not that you needed it");
        this.outx(
        ...
        if (this.player.tallness >= 72) {
            ...
            if (this.player.cor < 33)
                this.outx("You'll have to try to slow your descent next time!  ");
            else
                this.outx(
        ...
        if (this.player.cockTotal() > 0) {
            ...
            else if (this.player.cocks[0].cockLength < 28) this.outx("on the bunny's face");
            else this.outx("past the bunny's head");
            this.outx(", and your free hand wastes no time in tending to your male ");
        ...
        if (this.player.cockTotal() > 0) {
            ...
            if (this.player.cumQ() > 500) this.outx(".");
        }
        this.outx("\n\n", false);
    ...
    private bunbunFucksPCInAss(): void {
        ...
        if (!this.player.hasFuckableNipples()) {
            this.outx("pulling and tugging on them");
            if (this.player.biggestLactation() >= 1) {
                this.outx(", spurting out ");
                if (this.player.biggestLactation() >= 4) this.outx("sprays");
                else this.outx("drops");
                this.outx(" of milk");
            }
            this.outx(".");
        } else
        ...
        if (this.player.biggestLactation() >= 1) {
            this.outx("  Milk ");
            if (this.player.biggestLactation() < 2) this.outx("leaks");
    ...
    private bunbunGetsFucked(): void {
        ...
        if (y != -1)
            ...
            if (this.player.balls > 0) this.outx(", belly, and balls");
            else this.outx(" and belly");
            this.outx(
        ...
        this.outx("You bottom out with brutal force");
        if (this.player.balls > 0) this.outx(", slapping your balls against her ass");
        this.outx(", as your ");
        ...
        if (y != -1) {
            this.outx("  Her ass gurgles from your deposit");
            if (this.player.cumQ() > 500)
                this.outx(
        ...
        if (this.player.cumQ() > 250) this.outx("  One more follows, giving her quads");
    ...
    private bunbun69(): void {
        ...
        if (this.player.isTaur()) {
            if (BunnyGirl.rand(2) == 0) {
                ...
                this.outx('"<i>You\'re weird,</i>" declares the rabbit.\n\n', false);
                ...
                this.outx('"<i>Hahah! Egg on your face! Ahahah!</i>"\n\n', false);
        ...
        if (this.player.cockTotal() > 0) {
            ...
            if (this.isEaster()) {
                ...
                if (this.player.earType != EARS_BUNNY) {
                    this.outx("  The top of your head is next, it seems.");
                    // [No antennae:
                    this.outx(
                ...
                if (this.player.cumQ() < 250) this.outx("a slight swell");
                else if (this.player.cumQ() < 1000) this.outx("a noticeable girth");
                else this.outx("bloated obscenely");
                this.outx(
            ...
            // REGULAR SHOW
                ...
                if (this.player.earType != EARS_BUNNY) this.outx("new ");
                this.outx(
    ...
    public layEggsInBunbuns(): void {
        ...
        if (this.player.gender == 0) this.outx(" against the empty place of your crotch.");
        else {
            if (this.player.hasCock()) this.outx(" alongside [eachCock]");
            if (this.player.hasVagina())
                this.outx(
        ...
        if (this.player.gender > 0) {
            ...
            this.outx(" lathering the bunny-girl in ");
            if (this.player.hasCock()) this.outx("spunk");
            if (this.player.gender == 3) this.outx(" and ");
        ...
        if (this.player.gender > 0) {
            this.outx("  You add to the mess, ");
            if (this.player.hasCock())
                this.outx(
                    "spraying a long, thick load against the bunny's soft tits from your [eachCock]"
                );
            if (this.player.gender == 3) this.outx(" and ");
            if (this.player.hasVagina()) this.outx("splashing her balls with your girlcum");
            this.outx(".");
        }
        this.outx(
    ...
    public ovipositBunnyEaster(): void {
        ...
        if (this.player.canOvipositBee()) this.outx("insect");
        else this.outx("arachnid");
        this.outx(
        ...
        // {Plenty of eggs}
            ...
            if (!this.player.canOvipositBee()) this.outx("arachnid");
            else this.outx("insectile");
            this.outx(
        ...
        // {Lots of Eggs!}
            ...
            if (this.silly()) this.outx("like an energizer bunny");
            else this.outx("like some kind of endless, pregnancy-inducing fuck-beast");
            this.outx(
    ...
    private adjathaEggsplosions(): void {
        ...
        if (!this.isEaster()) this.outx("dusky");
        else this.outx("chocolate");
        this.outx(" skinned woman.  Atop her ");
        if (!this.isEaster()) this.outx("tanned");
        else this.outx("caramel");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("thin, gushing pre-cum");
        else this.outx("thick, syrupy cream");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("olive");
        else this.outx("cinnamon");
        this.outx(
            ' skin.  "<i>Oh thank goodness,</i>" she pants, her tongue lolling under her tiny buck teeth.  "<i>You have to help me,</i>" the '
        );
        if (!this.isEaster()) this.outx("coffee");
        else this.outx("toffee");
        this.outx(
        ...
        if (this.player.hasCock()) {
            ...
            else this.outx("  <b>You're too big to fuck her!</b>");
        }
    ...
    private freeHerOhGodWhyDidYouDoThis(): void {
        ...
        if (!this.isEaster()) this.outx("sheen of sweat");
        else this.outx("shimmering glaze");
        this.outx(", her urgent lust pulsing in every inch of her ");
        if (!this.isEaster()) this.outx("freckled brown");
        else this.outx("pudding rich");
        this.outx(
        ...
        if (this.isEaster()) this.outx("cony ");
        this.outx("cock jerks in the air with every hyperventilating breath, ");
        if (!this.isEaster()) this.outx("bubbling pearls");
        else this.outx("gooey marshmallows");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("the carnal fruit of her unwelcome, monstrous couplings");
        else
            this.outx(
        ...
        if (!this.isEaster()) this.outx("splattering spoo");
        else this.outx("climaxing cream");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("bright pink eggs");
        else this.outx("candy-coated confections");
        this.outx(" issue forth amid the ");
        if (!this.isEaster()) this.outx("cum");
        else this.outx("icing");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("pert");
        else this.outx("gum drop");
        this.outx(
    ...
    private fuckTheEggBoundBun(): void {
        ...
        if (!this.isEaster()) this.outx("dusky");
        else this.outx("caramel-skinned");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("supple mounds");
        else this.outx("taut dough");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("yielding flesh");
        else this.outx("semi-spongy hotcakes");
        this.outx(
        ...
        if (this.player.cor < 33)
            this.outx("grimace at the vulgar goo that washes over your flesh");
        else if (this.player.cor < 66)
            this.outx("swallow a gulp as the lewd spoo squelches around your member");
        else
            this.outx(
        ...
        if (!this.isEaster()) this.outx("darkly freckled thighs ivory");
        else this.outx("savory, chocolate thighs with pale cream");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("flooding her semen-gorged cunt with fresh issue");
        else this.outx("glazing her cream-filled center with your silky spunk");
        this.outx(".  She bucks helplessly as her gut swells under your load, ");
        if (this.player.cumQ() < 250) this.outx("steady streams of cum seeping from her pussy");
    ...
    private getEggflated(): void {
        ...
        if (!this.isEaster()) this.outx("twitching length");
        else this.outx("succulent delicacy");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("ring");
        else this.outx("donut");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("pre-cum");
        else this.outx("milky cream");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("thick pole");
        else this.outx("sweet shaft");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("swollen mast");
        else this.outx("bloated baster");
        this.outx(".  Pressing her backwards, the two of you lean against her ");
        if (!this.isEaster()) this.outx("supple");
        else this.outx("marshmallow");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("well-padded bedding");
        else this.outx("sponge cakes baked for a giant");
        this.outx(".");
        ...
        if (!this.isEaster()) this.outx("gurgling seed");
        else this.outx("saccharine seed");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("twitching tuft");
        else this.outx("cotton candy poof");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("swollen dick");
        else this.outx("candied cock");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("jizz-burbling");
        else this.outx("jelly-bubbling");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("tingling, liquid passion");
        else this.outx("fattening, cream filling");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("load");
        else this.outx("treat");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("advanced pregnancy");
        else this.outx("gluttonous excess");
        this.outx(
        ...
        if (!this.isEaster()) this.outx("bunny seed");
        else this.outx("marshmallow and chocolate");
        this.outx(
        ...
        this.outx(this.player.modThickness(100, 3));
        this.outx(this.player.modTone(0, 3));
        this.player.orgasm();
        this.dynStats("lib", 1, "sen", -3);
        this.doNext(this.camp.returnToCampUseEightHours);
    }
