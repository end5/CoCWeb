...
export class BunnyGirl extends BaseContent {
    public isItEaster(): boolean {
        return (this.date.date >= 30 && this.date.date <= 31 && this.date.month == 2) || (this.date.month == 3 && this.date.date <= 1);
    }
    ...
    public bunnbunbunMeet(): void {
        ...
        if (this.flags[kFLAGS.MET_BUNBUN] == 0) {
            this.outputText("A ", false);
            if (this.player.tallness > 64) this.outputText("short ", false);
            this.outputText("bunny-girl appears from behind some bushes, hopping about and clutching a basket full of multicolored eggs tightly in front of her muscular, fur-covered thighs.  She hops around a few times, peering closely at the ground as if searching for something.  Her slow, deliberate hopping comes to an end as she looks up and spots you.  The bunny's eyes widen into shocked dinner-plates, like she's utterly amazed someone saw her.  She freezes completely still, watching you, and you're given the chance to give her a good looking over.\n\n", false);

            this.outputText("Starting above the bunny's hips, her fur vanishes into dusky, olive skin, save for two 'poofs' of fur that ring her wrists like bracelets and a large, fluffy white tail above her butt-cheeks. It twitches nigh-constantly, the only part of the girl that's moving.  Her breasts are small - perhaps B-cups – and pear-shaped.  A tight, bright pink nipple perches atop each tiny tit's fleshy swell, hard from arousal or cold. Her face is human save for a bright pink nose and a few whiskers that sprout from the freckles on her cheeks.  The strange woman's groin is concealed behind the basket, ", false);

            if (this.player.lib > 50) this.outputText("and you find yourself wondering what sort of treasures she conceals behind it.", false);
            else if (this.player.cor < 40) this.outputText("and you find yourself thankful for her modesty.", false);
            else this.outputText("and you find yourself considering tearing away the basket so you can see what she's hiding down there.", false);
            this.outputText("\n\n", false);
        ...
        //Met her
            ...
            this.outputText("While exploring the plains, you spy the familiar ears of a bunny-girl bobbing up and down behind a particularly tall patch of grasses.  You peek over the top of the grasses to find the dusky-skinned rabbit-girl playing with herself.  Both of her dainty, dextrous hands are clamped tightly around the wet, dripping length of her 14-inch cock as she hammers at the ground with her feet and humps away at her tightly-balled fists.\n\n", false);
            this.outputText("You lean forwards for a better look, dislodging a small pebble with your " + this.player.foot() + " while shifting position.  The bunny-girl leaps to her feet in a panic until her terrified irises lock onto your " + this.player.face() + ".  Her panic turns to embarrassment and in a flash every inch of her tanned skin is colored red.  She asks, \"<i>Ummm, since I'm still in s-season, c-could we b-breed or something?  Maybe just a little fuck?</i>\"\n\n", false);

            this.outputText("She claps both hands over her mouth, leaving her swollen prick to bounce precipitously while she awaits your response.\n\n", false);

            this.outputText("(If you're going to sex her, which of her body parts will you use?", false);
            ...
            else if (this.player.cockTotal() > 0) this.outputText("  <b>You're too to big fit inside her...</b>", false);
            ...
            if (this.player.canOviposit() && this.player.lust >= 33) {
                if (!this.player.canOvipositBee() || BunnyGirl.rand(2) == 0)
    ...
    private talkToBunnyBunBun(): void {
        ...
        else if (this.player.cockTotal() > 0) this.outputText("  <b>You're too big to fit inside her...</b>", false);
        if (this.player.gender > 0) {
            sixtyNine = this.bunbun69;
            this.outputText("  Sixty-nine her?", false);
        }
    ...
    private rapeBunBun(): void {
        ...
        if (this.player.spe < 60) {
            this.outputText("You lunge forward off your " + this.player.feet() + ", trying to tackle and pin the poor girl, but at the first sign of movement from you, she bounds off in the other direction!  She's hopping so fast there's no way you could possibly catch her, and in a matter of seconds you're left totally alone.  Well, perhaps not TOTALLY alone – there's one small egg nestled in the grass.  It fell from the bunny's basket in her haste to flee!", false);
        ...
        //[Rape Her Faster]
            ...
            this.flags[kFLAGS.MET_BUNBUN]++;
            this.outputText("You lunge forward off your " + this.player.feet() + ", trying to tackle and pin the poor girl, but at the first sign of movement from you,  she launches herself up and back with a powerful hop.  She didn't count on your speed, and you manage to tackle her mid-air.  Both of you slam into the ground, the bunny pinned tightly underneath you.  Her basket and eggs went flying when you hit her, and now there's a few dozen eggs scattered in the tall grass.   The girl wriggles, trying to squeeze out of your grip, but you hold firm to her as she cries, \"<i>YOU MEANIE!</i>\"\n\n", false);

            this.outputText("Your belly feels warm and wet, and as you pull back to examine the bunny, the source of the moisture is revealed.  The girl isn't a girl at all!  She's got a hard 14-inch dick and a pair of bouncing, egg-sized balls that are working quite hard to leak bunny-cum onto you.  You reach down underneath the orbs and thankfully find another source of wetness.  At least you weren't completely wrong!  You're dealing with a hermaphrodite, and a horny one at that.  Why would she bother resisting when her body is so thrilled to be so close to you?\n\n", false);

            this.outputText("The horny bun-herm follows your gaze and breaks into a slowly spreading grin, revealing a pair of cute buck-teeth as she asks, \"<i>Oh, you just wanted to fuck?  Why didn't you just ask?  I thought you were going to eat me!</i>\"  Her confident declaration does little to hide the bright red blush coloring her cheeks, making it clear this situation is a little strange to her.\n\n", false);
    ...
    private bunbunFucksYourVag(): void {
        this.spriteSelect(13);
        this.outputText("", true);
        this.outputText("A anticipatory grin widens across your " + this.player.face() + " as you speedily disrobe, discarding your " + this.player.armorName, false);

        if (this.player.weaponName != "fists") this.outputText(" and " + this.player.weaponName, false);
        this.outputText(" in a hurry.   Meanwhile the bunny looks on in a semi-aroused stupor, stroking her length with one hand while her other teases one of the hard nubs of her nipples.  You sigh with excitement as you position yourself above her, lining up her somewhat angular crown with the entrance to your " + this.vaginaDescript(0) + " before you start to drop.", false);
        if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_DROOLING) this.outputText("  Moisture leaks in a steady drizzle, mixing with bunny-pre to totally slick the soon-to-be invading member.", false);
        this.outputText("\n\n", false);

        this.outputText("Gasping hotly, you swallow her pointed tip into your depths, feeling the rabbit-like girl's tip swell and pump out a few more drops of lube", false);
        if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_SLICK) this.outputText(", not that you needed it", false);
        this.outputText(".  You don't need any more encouragement.  The long, slow slide down her thick bunny-dick is heavenly, as the veins on its surface scratch your 'itch' in just the right way.  ", false);
        if (this.player.vaginalCapacity() < 20) this.outputText("By the time you're getting close to the bottom you have to work to encompass her length and girth within your velvet folds and grunt with discomfort from each new inch of throbbing fuck-stick, but you take it all.  ", false);
        else if (this.player.vaginalCapacity() < 50) this.outputText("By the time you get to the bottom you're panting and moaning, delighting in the feeling of being so perfectly impaled on a rigid fuck-stick.   With her entirely inside you, you're ready to fuck her in earnest.  ", false);
        else this.outputText("It doesn't take long to slide down the more-than footlong meat-pole, and to be honest you wish she was a bit bigger.  Your " + this.vaginaDescript(0) + " is so ready for big dicks that this disproportionate member is average at best.  Still, you clench your thigh muscles to wring it a little tighter, and swoon from the feeling of warm maleness filling your loins.  ", false);
        this.player.cuntChange(35, true);
        this.outputText("\n\n", false);

        this.outputText("While the bunny was content to remain passive up until this point, a fire lights in her eyes now that she's had a taste of pussy.  Her petite hands grab hold of your " + this.assDescript() + " while she pulls her powerful, oddly-jointed legs underneath of her.  A split second later she pushes up with enough force to bounce you a few inches into the air before you drop down on top of her.  ", false);
        if (this.player.tallness >= 72) {
            this.outputText("Your sheer weight makes her grunt in discomfort when you land back atop her, but the squish of copious sexual fluids nearly drowns it out. She even squirts another thick gout of pre inside you.  ", false);
            if (this.player.cor < 33) this.outputText("You'll have to try to slow your descent next time!  ", false);
            else this.outputText("If she's going to fuck you like this, she can handle your weight!  ", false);
        }
        else this.outputText("Your bodies clap together with a loud squish of copious sexual fluids, and another thick burble of pre warms your cunny.  ", false);
        this.outputText("How much pre-cum can she squirt?!\n\n", false);

        this.outputText("You reach down and grab the bunny's hips for support as she bounces you again, higher this time.  A solid five or six inches of her length slide in and out of your " + this.vaginaDescript(0) + " before you slap into her, and a split second later, you're airborne again.  She bounces you harder and harder until each thrust of her muscled thighs is launching you nearly a foot off her loins and letting gravity guide you back down her shaft.", false);
        if (this.player.clitLength >= 4) this.outputText("  Your " + this.clitDescript() + " bounces on her belly, tingling like mad every time it slaps into her tanned, sweat-slicked skin.", false);
        if (this.player.biggestLactation() >= 1) this.outputText("  Milk begins to bead on your " + this.player.allBreastsDescript() + " from the sensation of the bunny's brutal, almost mechanical fucking.", false);
        this.outputText("  The eager girl moans, \"<i>Ooooh fuckfuckyes... gotta fuck... gotta breed... ungh... eggs eggs eggs!</i>\"\n\n", false);

        this.outputText("Eggs?  Is she going to knock you up with eggs?  The confusion she's caused actually distracts you from the sex long enough to push back your orgasm, but the amorous bunny-gal pushes herself over the edge with one last thrust, hard enough to nearly launch you from her tumescent cock.  You slide back down the exhausted bunny, but don't feel the telltale spurting and warmth you'd expect to be bursting inside your " + this.vaginaDescript(0) + ".  Sure, there is a trickle of warmth, but your convulsing lover's rod hasn't spurted like a male's organ should.   You turn to get a better look at her and notice that she STILL seems lost in orgasm, and her balls are GONE!\n\n", false);

        this.outputText("Your eyes cross from a sudden, massive change in thickness of your lover's pole.  It starts out at your lower lips, spreading them until they're positively gaping.  Muscular contractions in the bunny's shaft make her dick pulse inside you, slowly pushing the bulge upwards and stretching your " + this.vaginaDescript(0) + "'s walls as it travels towards your womb.  More and more fluid leaks inside of your channel until your " + this.player.legs() + " relax and go limp.  It isn't just pre-cum anymore – it's dulling the pain and relaxing your body!  You can actually feel your cervix starting to open involuntarily as the bulge passes the halfway point.  From the distended spot downwards, your cunt hangs loosely around the swollen cock, but another knot emerges at the base and starts to slide up your abused tunnel.  ", false);
        //(Cunt Change HERE)
        this.player.cuntChange(70, true);
        this.outputText("\n\n", false);

        this.outputText("The girl underneath you is thrashing and moaning, chanting, \"<i>Yes... eggs eggs EGGS! YES!</i>\" while her ovipositor-like cock robs you of your strength and slides egg-shaped bulges inside you.  Amazingly, your " + this.vaginaDescript(0) + " is awash with pleasure, and you reach down to ", false);
        if (this.player.clitLength >= 4) this.outputText("fondle your " + this.clitDescript() + " a moment before wrapping your hand around it and stroking the girl-cock excitedly.", false);
        else this.outputText("caress your " + this.clitDescript() + " a moment before you start to circle it with a finger, teasing it expertly.", false);
        if (this.player.cockTotal() > 0) {
            this.outputText("  " + this.SMultiCockDesc() + " twitches and drools ", false);
            if (this.player.cocks[0].cockLength < 10) this.outputText("on the bunny's belly", false);
            else if (this.player.cocks[0].cockLength < 18) this.outputText("between the bunny's tiny tits", false);
            else if (this.player.cocks[0].cockLength < 28) this.outputText("on the bunny's face", false);
            else this.outputText("past the bunny's head", false);
            this.outputText(", and your free hand wastes no time in tending to your male ");
            if (this.player.cockTotal() == 1) this.outputText("half's needs, slathering it in pre-cum and stroking hard and fast.", false);
            else this.outputText("halfs' needs, slathering them in pre-cum and stroking hard and fast.", false);
        }
        this.outputText("  The futanari rabbit's dick-head swells as the egg reaches her tip, completely opening your womb, and then with one last explosive push, launches it deep inside you.\n\n", false);

        this.outputText("You get off hard.  Despite the drug-induced relaxation that's overwhelmed you from the waist down, rippling convulsions erupt up and down your " + this.vaginaDescript(0) + ", squeezing the egg-spurting cock tightly.  This only speeds the passage of the bunny's second bulge, and in seconds her distended cock-head is stretched wider than before, locking her inside you for a moment.   The pair of you rock and grind your hips together futilely until the final egg erupts inside of you, accompanied by a huge wave of whatever it is that's made your lower body so nerveless.", false);
        if (this.player.cockTotal() > 0) {
            this.outputText("  At last, " + this.sMultiCockDesc() + " blasts sticky ropes of seed everywhere, cumming with you as your body slides sideways off the exhausted bunny into the dirt.  A few thick strands hit her tits and face, but judging by her half-closed eye-lids and questing tongue, she doesn't mind.", false);
            if (this.player.cumQ() > 500) this.outputText("  Not content with that, " + this.sMultiCockDesc() + " continues to pump until the bunny is coated with a generous layer of seed", false);
            if (this.player.cumQ() > 2000) this.outputText(" and the excess is running down the hill in a small river", false);
            if (this.player.cumQ() > 500) this.outputText(".", false);
        }
        this.outputText("\n\n", false);

        this.outputText("You sprawl out, leaking sexual fluids as your womb closes in around the foreign cargo, closing your cervix to hold in both the eggs.  An indeterminate amount of time has passed, but the forced euphoria of your new pregnancy makes it hard to get up just yet.  You see the bunny standing up with her dick finally going limp and no balls to speak of.  She leans down and gives you a kiss on the lips before whispering, \"<i>", false);
        if (this.player.bunnyScore() < 4) this.outputText("It's so good to finally think straight!  I don't know why I went into heat right now, but it's so much easier to think now that I've gotten rid of those eggs.  Don't worry, you won't be popping out rabbits since you aren't an easter-bun.  Your body will probably absorb them in a few days.  Just don't be surprised if you feel a little bloated or feel a little weird after.</i>\"\n\n", false);
        //Pregnant already
        else if (this.player.pregnancyIncubation > 0) this.outputText("It's so good to finally think straight!  I don't know why I went into heat right now, but it really is a shame you're pregnant.  Your body will destroy the little eggs before they can even do anything!  Well, at least I feel sooo much better...</i>\"\n\n", false);
        //Preggers
        else this.outputText("It's so good to finally think straight!  I don't know why I went into heat right now, but it feels so good to pour my babies into a nice, ready breeder-mom like yourself.  I bet the kids come out so cute!  Oh, I feel so much better.</i>\"\n\n", false);

        this.outputText("She walks away, her puffy tail twitching with the breeze while your eyes drift closed.", false);
        //(Easter vag-preg + 8 hours pass)
        if (this.player.bunnyScore() < 4) {
            this.player.knockUp(PregnancyStore.PREGNANCY_BUNNY, PregnancyStore.INCUBATION_BUNNY_EGGS);
        }
        else {
            this.player.knockUp(PregnancyStore.PREGNANCY_BUNNY, PregnancyStore.INCUBATION_BUNNY_BABY, 60);
        }
        this.player.orgasm();
    ...
    private bunbunFucksPCInAss(): void {
        this.spriteSelect(13);
        this.outputText("", true);
        this.outputText("You get a very naughty idea and silently discard your " + this.player.armorName + ", tossing it aside as you turn around and present your " + this.assDescript() + " to the bunny-girl.  With a lewd shake, you tease her and give her a good view of your " + this.assholeDescript() + " while it lowers closer and closer to the turgid bunny-cock, just inches away.  Drops of clear pre-cum roll down her shaft as it twitches eagerly, and the girl watches you through a gleam of sexual excitement while her shaft gets closer and closer to your rear entrance.  You let your " + this.player.legs() + " relax a little until it's pressing tightly against your sphincter, feeling it slather pre-cum in preparation for the coming penetration.\n\n", false);

        this.outputText("Looking over your shoulder at the bunny's beet-red face, you let a little of your weight down and start to spread around the bunny-herm's cock.  It slides inside you easily, aided by her copious drops of pre-cum, but ", false);
        if (this.player.analCapacity() < 20) this.outputText("it stretches you dangerously wide as you slide down the thick shaft.  The further down it gets, the more you have to work to relax your muscles and push yourself along.  With enough time, patience, and copious bunny-pre, you manage to take it completely inside you.  It twitches happily while you adjust to the intrusion, but you know you're just getting started.", false);
        else if (this.player.analCapacity() < 40) this.outputText("you have to keep pausing as you slide down to let more of her pre-cum bubble out and lubricate the fourteen inch shaft.  It fills you nicely, pressing on your innards in all the right ways as you slowly engulf the bunny-cock with your " + this.assholeDescript() + ".  After bottoming out, your nervous lover's prick pulsates happily inside you, but you're just getting started.", false);
        else {
            this.outputText("you wish it was a bit bigger.  A few seconds is all it takes to get her thick shaft completely inside your " + this.assholeDescript() + ".  You clench and squeeze your muscles around it as you sit on the bunny-", false);
            if (this.player.cor < 50) this.outputText("girl", false);
            else this.outputText("bitch", false);
            this.outputText("'s lap, giggling as you feel it twitch happily inside you, but you're just getting started.", false);
        }
        //(BUTT CHANGE HERE)
        this.player.buttChange(35, true);
        this.outputText("\n\n", false);

        this.outputText("Your partner gasps in surprise as you pull yourself up, dragging her cock slowly through the tight ring of your pucker until she's about to slip out, and then dropping back down to envelop her again.  She involuntarily grunts wordless pleasure noises, thrilled with the sensation your warm body provides.  Her hands grab her nipples as you repeat your actions, working her with a slow, smooth rhythm that should bring her to orgasm... eventually.  ", false);
        if (this.player.totalCocks() > 0) this.outputText("Each time she bumps and slides past your prostate a dollop of your pre-cum spurts from " + this.sMultiCockDesc() + " onto the ground, and you have a hard time not using your new lover like an anal toy and masturbating yourself.  ", false);
        this.outputText("The long-eared slut makes a display of touching her nipples, pulling and twisting on them as you watch her over your shoulder.\n\n", false);

        this.outputText("Without meaning to, you begin to pick up the speed of your up and down strokes.  Your body is feeling horny and warm from all the sex, and having such a strange, attractive lover mating with your backside isn't helping.  ", false);
        if (this.player.hasVagina()) {
            if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_SLICK) this.outputText("Juices begin to run from your " + this.vaginaDescript(0) + ", but you ignore the empty feeling and focus on the throbbing meat inside your backdoor.  ", false);
        }
        this.outputText("Fingers find their way to your nipples without conscious thought, and begin ", false);
        if (!this.player.hasFuckableNipples()) {
            this.outputText("pulling and tugging on them", false);
            if (this.player.biggestLactation() >= 1) {
                this.outputText(", spurting out ", false);
                if (this.player.biggestLactation() >= 4) this.outputText("sprays", false);
                else this.outputText("drops", false);
                this.outputText(" of milk", false);
            }
            this.outputText(".", false);
        }
        else this.outputText("sliding inside them, fucking their cunt-like interiors as you start to lose yourself to the pleasure.", false);
        this.outputText("  The bunny reaches down to your " + this.assDescript() + " and gives it a gentle caress and squeeze.  A moment later both her hands are holding your butt-cheeks, guiding you up and down as you bounce atop her faster and faster.\n\n", false);

        this.outputText("You stroke the downy fur of her thighs through your fingers, marveling at her softness as you let the bunny start to set a tempo so fast that her pre-cum is squirting out with each wet, gushy fuck.   She occasionally gives your ass a gentle slap and starts moaning and panting out loud with every heated penetration, \"<i>Fuck... breed... mmm... yes... eggs eggs pleaseletmeegg!</i>\" It's hard to pay attention with the rising pleasure surging through your body", false);
        if (this.player.cockTotal() > 0) {
            this.outputText(", and " + this.sMultiCockDesc() + " pouring incredibly sticky pre-cum each time she squeezes your prostate", false);
        }
        else if (this.player.hasVagina()) this.outputText(", and your " + this.vaginaDescript(0) + " clenching and dripping on the verge of orgasm", false);
        this.outputText(".", false);
        if (this.player.biggestLactation() >= 1) {
            this.outputText("  Milk ", false);
            if (this.player.biggestLactation() < 2) this.outputText("leaks", false);
            else if (this.player.biggestLactation() < 4) this.outputText("drips", false);
            else this.outputText("pours", false);
            this.outputText(" from your " + this.nippleDescript(0) + "s, turning your front to a leaky mess as you ride the very edge of pleasure.", false);
        }
        this.outputText("\n\n", false);

        this.outputText("Wait a second, what was that about eggs?  The confusion that comes with that thought distracts you enough to keep you from cumming, but the bunny orgasms before you have a chance to reconsider your position atop her.  She convulses, her rod twitching and thickening slightly, but you don't feel the warmth of erupting cum that you would expect.  You look down at her, but the bunny-girl is too insensate to provide any answer, and it's not until you notice that her balls are missing that you realize something is wildly different about the way her orgasms work.\n\n", false);

        this.outputText("You gasp in pain as the thickness at the base of your lover's shaft doubles.  It stretches your " + this.assholeDescript() + " wide, almost painfully wide as something starts to push up her dick from the inside.  Before you can pull yourself off her, a massive gush of fluid drizzles inside of you, quickly numbing any pain and stealing the strength from your " + this.player.legs() + " and muscles.  You twist back and forth, but the pleasure intensifies as the bulge slips past your sphincter, leaving your body slightly agape in its wake.  You find the rest of its passage to be more comfortable ", false);
        if (this.player.cockTotal() > 0) {
            this.outputText("and as it squeezes past your prostate, " + this.sMultiCockDesc() + " spurts thick cum on the ground, though you don't QUITE orgasm.", false);
        }
    ...
    private bunbunGetsFucked(): void {
        ...
        this.outputText("You disrobe and toss your " + this.player.armorName + " to the side, immediately forgetting about it as the bunny-girl lifts her sack to expose the bright pink flesh of her femininity.  It glistens, practically steaming up the air with her plentiful lubricants.  She runs a slender finger around the moist hole, beckoning you to plunge inside and fill her hungry flesh with your " + this.cockDescript(x) + ".  Lust burns through you as you drop to your knees and line your " + this.cockDescript(x) + " up with that ready opening", false);
        if (y != -1) this.outputText(", taking care to align your " + this.cockDescript(y) + " with her tightly puckered backdoor as well.", false);
        else this.outputText(", barely able to restrain yourself as the time for penetration approaches.", false);
        this.outputText("\n\n", false);

        this.outputText("The nubile bunny's eyes cross as you push forwards, sliding your " + this.player.cockHead(x) + " over her love-slicked lips until it has a generous coating and pressing harder.  ", false);
        if (y != -1) this.outputText("She squeaks at the pressure on her tender asshole, but doesn't object as your pre-cum smears over it.  ", false);
        this.outputText("At once, her greedy breeding hole relaxes ", false);
        if (y != -1) this.outputText("along with her anus ", false);
        this.outputText("and your " + this.cockDescript(x), false);
        if (y != -1) this.outputText(" and " + this.cockDescript(y) + " sink", false);
        else this.outputText(" sinks", false);
        this.outputText(" into her slippery, warm depths.  She pants and groans with happiness, going so far as to vocalize her pleasure, \"<i>Oooh yes, I don't know why but it feels just as good as breeding season!  If you keep this up, " + this.player.mf("stud", "sexy") + ", you might... ahhhh.. make me egg!</i>\"\n\n", false);

        this.outputText("You don't try to make sense of it and instead plunge further forward, watching with delight as more and more of your length is devoured by the horny bunny's body.  ", false);
        if (this.player.cockArea(x) >= 25) this.outputText("Her belly bulges pleasantly, displaying the vaguely cylindrical shape of a cock through her skin in a way that makes you feel utterly dominant over this 'female'.  ", false);
        this.outputText("Once you bottom out, the hermaphrodite actually starts to squirt pre-cum onto herself.  It isn't quite as much as you'd expect from a real orgasm, but it's enough that she makes a slippery mess of her tits and belly.  She gathers it up and starts stroking herself off with it, and you watch the enthusiastic bunny masturbate herself.\n\n", false);

        this.outputText("\"<i>Nooooooo,</i>\" she cries, thinking you meant to stop, but you savagely slam back in, rocking her body and making her petite, pre-cum-glazed tits jiggle pleasantly.   Her 'no' turns into an 'OHHH' in that split second, and before she can stop or catch her breath, you start fucking hard, watching her cum-shined breasts wobble underneath you.  ", false);
        if (y != -1) this.outputText("Her tight asshole slowly loosens around your " + this.cockDescript(y) + ", and so much lubricant splatters from her cunt with each thrust that the sensations of both your dicks become nigh-identical, save for the tight ring gripping the bottom one.", false);
        else {
            this.outputText("So much lubricant splatters from her cunt that your thighs", false);
            if (this.player.balls > 0) this.outputText(", belly, and balls", false);
            else this.outputText(" and belly", false);
            this.outputText(" are soon sticky with the stuff, but it only spurs you on to fuck her harder.", false);
        }
        this.outputText("\n\n", false);

        this.outputText("The bunny-girl never lets up on the fourteen inch monster between her legs, and it seems to have gotten a little bit thicker and harder from all the attention.  Her cock has never stopped dripping and spurting pre-cum in all this time, and she's turning into a syrupy, cum-slicked mess before either of you have even gotten off.  The moans and heat pouring off her loins make it very clear that's going to change very soon, so you reach down and give her taut ass a rough slap.  It sets off a far different orgasm than you would've expected.\n\n", false);

        this.outputText("Before your eyes the rabbit-girl's balls disappear and the flesh of her sack pulls tight against her.  It actually looks like she never had one at all.  You look to her for answers, but her eyes are rolled back, her body is quaking around you, and her mouth is babbling, \"<i>Eggfuck... eggbreedegg... ungungegg... eggegg,</i>\" over and over.  Her cunt clamps down on you with a vice-like grip that makes your eyes cross and your crotch bubble with the heat of a coming orgasm.", false);
        if (y != -1) this.outputText("  Surprisingly, her asshole stays about the same, but it was already a little tighter and you know you'll be pumping it full of goo in a second.", false);
        this.outputText("\n\n", false);

        this.outputText("The bunny's convulsions take on a manic, thrashing pace, and before your eyes the base of her swollen cock begins to distend, nearly doubling in width from some internal object.  You wonder how she could enjoy something like that, but maybe her body is built for it?  It slowly works its way up the shaft while your long-eared lover stays locked in orgasm, panting, gasping, and leaking whiter-colored pre-cum that stops the convulsions anywhere it hits.  There must be something in it that forcibly relaxes the muscles, but before you can ponder it further your own climax has arrived.\n\n", false);

        this.outputText("You bottom out with brutal force", false);
        if (this.player.balls > 0) this.outputText(", slapping your balls against her ass", false);
        this.outputText(", as your ", false);
        if (this.player.hasSheath()) this.outputText("sheath", false);
        else this.outputText("base", false);
        this.outputText(" rubs her passion-inflamed pussy-lips.  " + this.SMultiCockDesc() + " unloads, splattering out ropes of cum into ", false);
        if ((this.player.cockTotal() == 2 && y == -1) || this.player.cockTotal() > 2) this.outputText("and onto ", false);
        this.outputText("the insensate bunny-breeder.  Her silken pussy milks and squeezes as you cum, seeming to draw your seed from your cock itself and pull it deeper inside, leaving none to waste.", false);
        if (y != -1) {
            this.outputText("  Her ass gurgles from your deposit", false);
            if (this.player.cumQ() > 500) this.outputText(", and her stomach gains a bit of pudge from the copious jism deluge you pump into her", false);
            this.outputText(".", false);
        }
        if (this.player.cumQ() > 500) this.outputText("  You keep cumming, slamming blast after blast of spooge into her welcoming nethers, delighted that none seems to leak out.", false);
        if (this.player.cumQ() >= 1500) this.outputText("  Somehow her womb never seems to fill or bulge, even though you must be pumpings gallons of fertile baby-batter into her cunt.  By the time your orgasm winds down, you feel a little confused by it all, but sated.", false);
        this.outputText("\n\n", false);

        this.outputText("The bunny's swollen cock has pushed the bulge all the way up to the tip, though you see another forming at the base.  She doesn't seem to mind, in fact she actually stops babbling and moaning long enough to scream with delight as she launches an egg onto her tits.  It sits between her small mounds, rolling and dripping white goo onto her nipples.  Her dick spurts out a few more blasts of whatever her 'cum' is before trailing off.  The other bulge isn't far from her still-somewhat stretched tip, and you know she'll be 'laying' another egg soon.\n\n", false);

        this.outputText("There's a feminine grunt, a moan, and a burst of fluid as the second egg falls onto her belly.  The bunny-girl finally stops convulsing as she soaks herself with more white goop, and though her eyes make an attempt to focus on you, they seem a little more dilated than they should be.  The only movements she bothers to make are breathing and weakly pushing a globule of white stuff away from her eyes.  The bunny sighs dreamily while you pull out, and pets her eggs as she comes down from the absurdly long and unusual orgasm.\n\n", false);
        ...
        if (this.player.cumQ() > 100) this.outputText("  A few seconds later another rolls in, cramming three into her increasingly obscene looking 'sack'.", false);
        if (this.player.cumQ() > 250) this.outputText("  One more follows, giving her quads", false);
        var z: number = 8 + BunnyGirl.rand(this.player.cumQ() / 100);
        if (z > 50) z = 50;
        if (this.player.cumQ() > 700) this.outputText(", but she's not done.  Her gut rumbles loudly, and then one after another egg after egg pours into the sack, stretching it out until you're sure she has at least " + z + " in there and will have trouble walking.", false);
        else this.outputText(".", false);
        this.outputText("  She moans contentedly and closes her eyes, sighing blissfully.\n\n", false);

        this.outputText("You shrug and pick up one of her eggs, noticing that it's turned neon pink in color.  The bunny mumbles, \"<i>Have it, iz good for youuuu...</i>\" before she starts to snore and murmur out a sexual dream.\n\n", false);
    ...
    private bunbun69(): void {
        ...
        if (this.player.isTaur()) {
            if (BunnyGirl.rand(2) == 0) {
                ...
                this.outputText("Without thinking it over beyond 'that sounds hot', you declare your intention to 69 the bunny girl.  She stands there, mouth hanging open and heat briefly forgotten.\n\n", false);

                this.outputText("\"<i>What?</i>\"\n\n", false);

                this.outputText("By now you've realized the absurdity of your statement, but you're too proud to admit it and simply restate your goal.  You cross your arms to try to look as serious as possible.  She looks down at your equine portion while idly stroking her cock, making sure your \"equipment\" is where she thinks it is.\n\n", false);

                this.outputText("\"<i>You're weird,</i>\" declares the rabbit.\n\n", false);

                this.outputText("Before you can return with a witty remark, the bunny has hopped off, leaving you alone in the field with your face in your palm.\n\n", false);
                //- Intelligence
                //+ Lust
                this.player.orgasm();
                this.dynStats("int", -2);
                ...
                this.outputText("\"<i>No, no, stop – ahaha - you're killing me - haha!</i>\" she splutters.  \"<i>Hahaha - oh gods - I'm going to egg from laughter - HAHAHA!</i>\"\n\n", false);

                this.outputText("You realize the absurdity of your proposition just as she falls backwards, one hand on her belly and one on her cock.  You try to imagine some way to make your proposal work and save face, but the humiliation of having said something so ridiculous and thoughtless leaves you bereft of any more suggestions.\n\n", false);

                this.outputText("She's laughing so hard that her entire body starts to shake violently.  Thinking that it wasn't <i>that</i> funny, you're about to turn and leave when one of her testicles disappears.  You watch in mixed curiosity and confusion as the lump makes its way up the hysterical rabbit's cock and launches into the air, revealing itself to be a pastel pink and white egg.  You bend down to pick it up just as the other \"teste\" splatters onto your face.\n\n", false);

                this.outputText("\"<i>Hahah! Egg on your face! Ahahah!</i>\"\n\n", false);

                this.outputText("You wipe off what you can of the sticky goop and trot off with a scowl, leaving the hysterical rabbit to calm herself down.\n\n", false);
                //- Intelligence
                this.player.orgasm();
                this.dynStats("int", -2);
                //+ Lust
        ...
        if (this.player.cockTotal() > 0) {
            ...
            //REGULAR SHOW
                ...
                if (this.player.balls > 0) this.outputText("balls", false);
                else if (this.player.hasVagina()) this.outputText("clit", false);
                else this.outputText("groin", false);
                this.outputText(", whiskers vibrating with a happy little hum, her buck teeth massaging your root enthusiastically, impatient for her own creamy meal. Her hands slide from the back of your head, along your neck, down your back, and to your ass, fingers wrapping around to find your " + this.player.assholeOrPussy() + ". Slipping both middle fingers in, she strokes your ", false);
                if (!this.player.hasVagina()) this.outputText("prostate", false);
                else this.outputText("inner walls", false);
                this.outputText(" until your orgasm overpowers your bunny-fucked daze and you peak, your egg-bloated body spurting in gushing jets of pale seed to paint the olive girl's insides white.\n\n", false);

                this.outputText("Her second egg forces its way down your throat with pulsing shudders and you can feel your hips straining against the weight of your overburdened stomach. You're a little afraid of what the second one will do to you as it slides out of the flared tip of the bunny's fourteen inches. Maybe it's the milking motion of the bunny's head bobbing in happy hops on your cock or maybe it's the swelling numbness of the eggs, but your body begins to feel hot and your flesh tingles at your scalp and butt. You clench your eyes, grunting through the heat of the bunny's eggs and, to your surprise, your belly begins to feel like it's emptying.", false);

                if (this.player.tailType != TAIL_TYPE_RABBIT) {
                    //[No Tail:
                    if (this.player.tailType == TAIL_TYPE_NONE) this.outputText("  The heat around your lower back clutches at your tail bone and you feel a fluffy explosion swell around your butt cheeks as a fluffy bunny's tail pops out of your back, twitching excitedly!", false);
                    //Existing tail:
                    else this.outputText("  Your tail jiggles and shrinks, slowly sucking back into your body until only a tiny nub remains which quickly explodes with fluff into a cuddly, twitching bunny tail!", false);
                }
                if (this.player.earType != EARS_BUNNY) {
                    this.outputText("  The top of your head is next, it seems.", false);
                    //[No antennae:
                    this.outputText("  Your eyebrows feel like they're being drawn upwards, your eyes getting larger and larger until you're almost painfully aware of every color and sound around you. You shake your head and large, floppy bunny ears bounce in front of your eyes.", false);
                }
                this.outputText("\n\n", false);
                ...
                this.outputText(", your spunk calming the egg-laying passion. She pulls her shrinking phallus from your mouth with a wet slurp, the taste of her strange cum sweet on your lips. She rises to a crouch and gives your ", false);
                if (this.player.earType != EARS_BUNNY) this.outputText("new ", false);
        ...
        //CUNTS
            ...
            this.outputText("With a happy sigh, the girl rubs your slick honey off of her face and gives your clit a final, pleased lick. She pulls her shrinking phallus from your mouth with a wet slurp, the taste of her cum sweetly icy on your lips. She rises to a crouch and gives your ", false);
            if (this.player.earType != EARS_BUNNY) this.outputText("new ", false);
            this.outputText("ears a playful tweak between her thumb and forefinger. \"<i>Sorry about that, I don't know what came over me! I certainly didn't expect this, though! Kind of makes me want to stick around and see if you and I could pop out more bunnies,</i>\" she winks. \"<i>But unfortunately, I've got to get going! Maybe I'll try to find you again, some time down the line.</i>\" She gives you a moist little kiss and hops away, still energetic after all that. You groan, still recovering from the eggs.", false);
            this.player.tailType = TAIL_TYPE_RABBIT;
            this.player.earType = EARS_BUNNY;
    ...
    public layEggsInBunbuns(): void {
        this.clearOutput();
        this.outputText("The displayed lapin in front of you has you excited, but not for a simple roll in the grass.  Your ");
        if (this.player.eggs() < 20) this.outputText("eager egg-tube slips free, ready to show the rabbit you can play the egg game too.");
        else if (this.player.eggs() < 40) this.outputText("distended bug part quivers in anticipation, the ovipositor pushing into view with a drop of honeyed pre on its tip.");
        else this.outputText("low-hanging bee abdomen drools honey-like ichor down its carapace from the bulge where the thick black organ shows its need to relieve your burden.");
        this.outputText("  The bunny gasps upon noticing it, the herm's hips wiggling. \"<i>Oh my, could... could you mount me with that?  I need to egg so badly.</i>\"  Not needing to be urged further, you arch your bee-section up underneath you while lifting the lusty bunny against you.");
        ...
        if (this.player.gender == 0) this.outputText(" against the empty place of your crotch.");
        else {
            if (this.player.hasCock()) this.outputText(" alongside [eachCock]");
            if (this.player.hasVagina()) this.outputText(" and her hefty oval balls rubbing the [vagina] tucked between your thighs");
            this.outputText(".");
        }
        this.outputText("  She braces herself with arms around your shoulders, trying to nearly jump onto you as you ram your engorged ovipositor into her tight ass.");
        ...
        if (this.player.gender > 0) {
            ...
            if (this.player.hasVagina()) this.outputText("your [vagina]");
            this.outputText(" lathering the bunny-girl in ");
            if (this.player.hasCock()) this.outputText("spunk");
            if (this.player.gender == 3) this.outputText(" and ");
            if (this.player.hasVagina()) this.outputText("femcum");
        }
        this.outputText(".  Stuffing a warm hole with egg after egg is not only fulfilling (for <i>both</i> involved) but is also damn fun, which the rabbit agrees with!");
        ...
        if (this.player.gender > 0) {
            this.outputText("  You add to the mess, ");
            if (this.player.hasCock()) this.outputText("spraying a long, thick load against the bunny's soft tits from your [eachCock]");
            if (this.player.gender == 3) this.outputText(" and ");
            if (this.player.hasVagina()) this.outputText("splashing her balls with your girlcum");
            this.outputText(".");
        }
    ...
    public ovipositBunnyEaster(): void {
        this.clearOutput();
        this.outputText("Smiling a little over-eagerly, you suggest, \"<i>You know, if you really like eggs, I know where you can get a few...</i>\"");
        ...
        if (this.player.canOvipositBee()) this.outputText("insect");
        else this.outputText("arachnid");
        this.outputText(" claiming an incubator.  When she feels your groin pressing on the small of her back, the fluffy hare grows concerned, looking over her shoulder and declaring, \"<i>You... you can't put eggs in me like THAT!</i>\"");
        ...
        //{Plenty of eggs}
            ...
            if (!this.player.canOvipositBee()) this.outputText("arachnid");
            else this.outputText("insectile");
            this.outputText(" cargo, but you aren't empty, so you force more and more inside her.  She's so stretchy that it's easy to do, and before long she has a nicely rounded, pregnant belly (even if it is a little bit bumpy).  Shuddering, you release a few long, thick squirts of lubricant over your leavings and sag down, spent.");
        }
        //{Lots of Eggs!}
        else {
    ...
    private adjathaEggsplosions(): void {
        this.clearOutput();
        this.outputText("Your trek through the plains is interrupted by a shrill, piercing cry that jolts you out of the daydreams that were floating through your mind.  The piercing wail of a woman in distress grabs your attention and you hurry over the rising hills to the source of the howling bluster.  You weren't sure exactly what to expect, but as the source of the commotion comes into view, you have to admit this wasn't exactly what you thought you'd find.");

        this.outputText("\n\nLying in a shallow valley is a ");
        if (!this.isEaster()) this.outputText("dusky");
        else this.outputText("chocolate");
        this.outputText(" skinned woman.  Atop her ");
        if (!this.isEaster()) this.outputText("tanned");
        else this.outputText("caramel");
        this.outputText(" head, two large pairs of bunny ears flop back and forth helplessly as she shakes her head in frustrated tension. Her long, muscled legs kick the ground in futile anguish, though you notice her feet are long and fuzzy, ending in thick paws with little pink pads underneath. Her arms appear to be secured behind her back by a corded rope that has her bound to a pair of tawny boulders. Between her legs, a fourteen inch erection throbs, fully erect and frothing with ");
        if (!this.isEaster()) this.outputText("thin, gushing pre-cum");
        else this.outputText("thick, syrupy cream");
        this.outputText(". It's a bunny-girl, certainly, but who would go through the effort of tying her up and then just leave?");
    ...
    private freeHerOhGodWhyDidYouDoThis(): void {
        this.clearOutput();
        this.outputText("Taking a chance, you step up to the wriggling bunny and inspect her bonds.  The girl's body is covered in a ");
        if (!this.isEaster()) this.outputText("sheen of sweat");
        else this.outputText("shimmering glaze");
        this.outputText(", her urgent lust pulsing in every inch of her ");
        if (!this.isEaster()) this.outputText("freckled brown");
        else this.outputText("pudding rich");
        this.outputText(" skin.  Her abdomen is slightly rounded with a pot-bellied pout that you assume must be the seed of the previous Samaritans.  Due to her inability to climax, her pussy must be clenching so tightly that only a thin trickle of cum is able to escape.  Her ");
        if (this.isEaster()) this.outputText("cony ");
        this.outputText("cock jerks in the air with every hyperventilating breath, ");
        if (!this.isEaster()) this.outputText("bubbling pearls");
        else this.outputText("gooey marshmallows");
        this.outputText(" of pre dribbling from the narrow, spear-like crest. The lustful girl's balls are even more lewd close up, gargantuan orbs obscenely stuffed with ");
        if (!this.isEaster()) this.outputText("the carnal fruit of her unwelcome, monstrous couplings");
        else this.outputText("candied plenty, her saccharine treats swimming amid a warm sea of honeyed spunk");
        this.outputText(". She bites down on her lower lip with her prominent front two teeth, her eyes following your motions intently, hoping for the best but braced for the worst.");
        ...
        if (!this.isEaster()) this.outputText("splattering spoo");
        else this.outputText("climaxing cream");
        this.outputText(".  The showering spray continues in an unbroken outpouring, a river of alabaster arcing and gushing in a throbbing surge that white-washes everything within ten feet of her frontal arc.  Countless ");
        if (!this.isEaster()) this.outputText("bright pink eggs");
        else this.outputText("candy-coated confections");
        this.outputText(" issue forth amid the ");
        if (!this.isEaster()) this.outputText("cum");
        else this.outputText("icing");
        this.outputText(" geyser, plopping moistly here and there.  Some stop in plain sight, others roll into hidden hollows, left for some curious treasure hunter.");
        ...
        if (!this.isEaster()) this.outputText("pert");
        else this.outputText("gum drop");
        this.outputText(" nipples as her big, soft toes dig rutting furrows into the ground beneath her.  Her orgasmic throes send spasms of bliss through her whole body, her clenched inner muscles finally relaxing enough to release the jism inside her womb, vulgar globules oozing down her trembling inner thighs.");
    ...
    private fuckTheEggBoundBun(): void {
        this.clearOutput();
        this.outputText("It's not often you find a treat gift wrapped so neatly for you; what kind of ingrate would you be if you just turned it down?  You step up to the wriggling bunny and inspect her carefully.  The girl's body is covered in a ");
        if (!this.isEaster()) this.outputText("sheen of sweat");
        else this.outputText("shimmering glaze");
        this.outputText(", her urgent lust pulsing in every inch of her ");
        if (!this.isEaster()) this.outputText("freckled brown");
        else this.outputText("pudding rich");
        this.outputText(" skin.  Her abdomen is slightly rounded with a pot bellied pout that you assume must be the seed of the previous Samaritans.  Due to her inability to climax, her pussy must be clenching so tightly that only a thin trickle of cum is able to escape.  Her cony cock jerks in the air with every hyperventilating breath, ");
        if (!this.isEaster()) this.outputText("bubbling pearls");
        else this.outputText("gooey marshmallows");
        this.outputText(" of pre dribbling from the narrow, spear-like crest.  The lustful girl's balls are even more lewd close up, gargantuan orbs obscenely stuffed with ");
        if (!this.isEaster()) this.outputText("the carnal fruit of her unwelcome, monstrous couplings");
        ...
        if (!this.isEaster()) this.outputText("dusky");
        else this.outputText("caramel-skinned");
        this.outputText(" bunny-girl with an easy smile.  Loosening your [armor] just enough to let your stiffening cock");
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(" free, you set your hands lightly on her ample hips, guiding your fingertips up her narrow waist and along the slick flesh of her tensed arms.  She trembles at your touch, but the boiling lust within her turns the fearful shudder into an orgasmic one in the very next second.  In this state, even just the touch of your fingers is enough to set her off, the bound hare's shaft spasming fruitlessly as the thick bronze of her cock ring holds back the torrential flood of her impotent climax.  You wrap your hands around her back, guiding them back down, over the ");
        if (!this.isEaster()) this.outputText("supple mounds");
        else this.outputText("taut dough");
        this.outputText(" of her wiggling ass and across the fidgeting girl's athletic legs.  Hooking one hand under her knee, you hoist up one leg and spin the girl in place, pushing her face-first into her own colossal, egg-bloated ballsac.  She lets out a thin \"<i>eep!</i>\" as her boundless energy sets off another futile bout of struggling against her bindings.");
        ...
        if (!this.isEaster()) this.outputText("yielding flesh");
        else this.outputText("semi-spongy hotcakes");
        this.outputText(".  Some light prodding tells you that her ass is far too tightly squeezed from the tension in her bloated organs to have any hope of penetration.  Her snatch is nearly as secure, but the drooling seed of her earlier suitors, along with her own glistening honey should provide all the lubrication you need.  The slimy spunk of countless suitors is warm against the throbbing flesh of your [cock] and you ");
        if (this.player.cor < 33) this.outputText("grimace at the vulgar goo that washes over your flesh");
        else if (this.player.cor < 66) this.outputText("swallow a gulp as the lewd spoo squelches around your member");
        else this.outputText("revel in the profane stimulation of bestial batter anointing your length in impure, liquid virility");
        this.outputText(".");
        ...
        if (!this.isEaster()) this.outputText("darkly freckled thighs ivory");
        else this.outputText("savory, chocolate thighs with pale cream");
        this.outputText(".  Reaching your own threshold, you lean forward, pressing your cheek against hers, the intake of your breath hissing between your teeth.  She instinctively understands, slamming her ass against your [hips] with as much force as she can muster.");

        this.outputText("\n\nYou orgasm, [oneCock] erupting inside the frenzied woman's womb with thick gouts of heavy seed ");
        if (!this.isEaster()) this.outputText("flooding her semen-gorged cunt with fresh issue");
        else this.outputText("glazing her cream-filled center with your silky spunk");
        this.outputText(".  She bucks helplessly as her gut swells under your load, ");
        if (this.player.cumQ() < 250) this.outputText("steady streams of cum seeping from her pussy");
        else if (this.player.cumQ() < 1000) this.outputText("bulging enough that her belly button turns outward as the cum oozing from her pussy gushes between the two of you");
        else this.outputText("growing larger and larger as cum splatters in thick streams from her saturated pussy. Your seemingly endless gallons of flooding cum wash the remnants of her previous partners away, immersing the caramel woman in the fluid wealth of your liquid possession.");
        this.outputText("  No sooner has your spunk taken root inside her, than the bunny's already colossal testes tremble anew.  Before your eyes, they balloon even larger, fattening with the profit of your claim.  You remain inside her a moment longer to marvel at the impossible bulk of her egg-stuffed body, before withdrawing and stepping back to clean yourself off.  Bulbous dollops of spunk bubble from her cunny as she impotently grinds her shaft against the mammoth bulk of her stoppered balls.  Satisfied, you head back to camp, leaving the bunny to the mercies of the next rescuer.");
    ...
    private getEggflated(): void {
        ...
        if (!this.isEaster()) this.outputText("twitching length");
        else this.outputText("succulent delicacy");
        this.outputText(" before you.  The thought of letting her empty her eggs into your body flickers across your mind.  It's a mad impulse, you have to admit, but you kind of want to see what she's capable of.  Stripping your [armor] and setting it far enough away to avoid potential spills, you carefully place your fingers on the bronze ");
        if (!this.isEaster()) this.outputText("ring");
        else this.outputText("donut");
        this.outputText(" around her conical cock.  The engorged flesh is swollen with pent-up need and you almost swear it gets a bit bigger when your fingertips press against her bindings.  Slowly, carefully, you start to remove the cock ring.  Luckily, the steady flow of her ");
        if (!this.isEaster()) this.outputText("pre-cum");
        else this.outputText("milky cream");
        this.outputText(" has lubricated her shaft enough to make the loop's passage relatively simple.  Up, up, up it slides, over bulging veins and over the flared peak of her cockhead until, at last, you peel the cinch from her distressed member.  She reflexively bucks at the air, groping for any friction with a weak whimper.  You take a deep breath to steady your own accelerating heart rate and prepare yourself.");
        ...
        if (!this.isEaster()) this.outputText("frothy juices");
        else this.outputText("slick honey");
        this.outputText(", her spear-like head slips easily past your labia, fervent flesh filling your trembling cavity. The girl's ");
        if (!this.isEaster()) this.outputText("thick pole");
        else this.outputText("sweet shaft");
        this.outputText(" sends ripples of hot and cold through your gut as her peculiar, almost numbing jism bubbles up inside you.  In another moment, you find yourself completely impaled on her turgid length, despite the throbbing girth of her ");
        if (!this.isEaster()) this.outputText("swollen mast");
        else this.outputText("bloated baster");
        this.outputText(".  Pressing her backwards, the two of you lean against her ");
        if (!this.isEaster()) this.outputText("supple");
        else this.outputText("marshmallow");
        this.outputText(" testes, their soft, pliant surface enveloping her as you straddle the helpless bunny.  Testing the tension of her scrotum, you find that the egg-filled sac is firm enough to support both of your weights without causing the girl any pain.  Gleefully, you wrap your arms around her waist and push forward, rolling up and over until the two of you rest atop the gargantuan balls like spherical, ");
        if (!this.isEaster()) this.outputText("well-padded bedding");
        else this.outputText("sponge cakes baked for a giant");
        this.outputText(".");
        this.player.cuntChange(28, true, true, false);
        ...
        if (!this.isEaster()) this.outputText("gurgling seed");
        else this.outputText("saccharine seed");
        this.outputText(", you realize there's really only one thing left to do.  Sliding a hand between her waist and the tender flesh the two of you are balanced upon, your fingers seek out the ");
        if (!this.isEaster()) this.outputText("twitching tuft");
        else this.outputText("cotton candy poof");
        this.outputText(" of her fluffy tail.  You find the junction where it meets the base of her spine and bear down on the sensitive point with your knuckles, eliciting a shrieking squeal of bliss from the over-burdened bunny-girl.  An intense pressure floods your cunt as her ");
        if (!this.isEaster()) this.outputText("swollen dick");
        else this.outputText("candied cock");
        this.outputText(" distorts under the heft of the emerging eggs.  As the first oval bulge travels up her shaft, you grind and slam deeper on her until the narrow point of her ");
        if (!this.isEaster()) this.outputText("jizz-burbling");
        else this.outputText("jelly-bubbling");
        this.outputText(" crest presses hotly against your cervix.  The sputtering flood of her opiate spunk saturates your inner walls, giving them a yielding elasticity.  As the egg nears her tip, you spear yourself down on the climaxing girl's prominence, feeling her dilating peak penetrating your womb.  With an exquisite moan of drugged euphoria, you watch your abdomen bulge as the egg pops free, followed by jets of ");
        if (!this.isEaster()) this.outputText("tingling, liquid passion");
        else this.outputText("fattening, cream filling");
        this.outputText(".  Another egg rushes up, followed by another, the pace accelerating as you bounce atop the vivacious hare with fast, short strokes that rub your [clit] against her cum-bloated belly.");

        this.outputText("\n\nEgg after egg fills your womb, swelling your abdomen with the heavy ");
        if (!this.isEaster()) this.outputText("load");
        else this.outputText("treat");
        this.outputText(". You pant, finding it difficult to draw a breath with the burden massing in your inner recess, your tongue hanging freely  and drool trickling down the side of your mouth.");
        //Futa:
        if (this.player.hasCock()) {
            this.outputText("  Quite without realizing it, [eachCock] spasms in messy orgasm, spurting ropes of spunk  across the bunny girl's tawny skin like a gooey glaze.");
        }
        this.outputText("  Your vision swims and when you blink back the dizziness, you find your gut has bloated to the size of ");
        if (!this.isEaster()) this.outputText("advanced pregnancy");
        else this.outputText("gluttonous excess");
        this.outputText(".  Though her cushioning balls have emptied some of their load inside you, they're still huge enough to support you both, so you regretfully begin to slide off the bunny girl's cock, eggs filling the gap her distended shaft leaves.  Pausing, with the tip at the cusp of your flush lower lips, you turn around atop the delirious bunny, popping her crest out, a rivulet of ");
        if (!this.isEaster()) this.outputText("cum");
        else this.outputText("cream");
        this.outputText(" leaking from your freshly stuffed snatch.  With a guiding hand, you steer her surging spout to your [ass] and drop your full ");
        if (!this.isEaster()) this.outputText("egg-loaded");
        else this.outputText("candy fattened");
        this.outputText(" weight on the conical cock.  With fresh space to fill, the eggs flow into you once more, one pushing another in a procession up your large intestine.");
        //Futa:
        if (this.player.hasCock()) this.outputText("  The steady movement of the orbs pushing past your prostate drills another, even messier orgasm from your " + this.multiCockDescriptLight() + ", cum arcing into the air to shower down on the two of you in pearl beads.");

        this.outputText("\n\nTime seems to flow from one moment to the next, your consciousness fading in and out as a small deluge of ");
        if (!this.isEaster()) this.outputText("bunny seed");
        else this.outputText("marshmallow and chocolate");
        this.outputText(" loads up your belly as fully as your twitching, clenching womb.  You can practically taste the sweetness in the back of your throat by the time the bunny-girl's orgasm ends.  Your body is inflated far beyond anything you could've imagined, eggs and spunk leaking from your gravid abdomen.  The bunny girl is lost to the world, dazed in a private bliss as her basketball-sized balls slowly push the last few eggs out of her dusky stalk with splattering plops.  You couldn't move if you wanted to, so you just remain on the ground, enjoying the feeling of utter, immobile bounty.  Gradually, the eggs in your belly and womb begin to melt, losing their firmness in favor of a fresh flux of raw warmth that wrings a final climax from your overtaxed body.");

        this.outputText("\n\n");
        //Futa:
        if (this.player.hasCock()) {
            this.outputText("Your exhausted " + this.multiCockDescriptLight() + " somehow find" + (this.player.cocks.length > 1 ? "" : "s") + " the strength for a gushing orgasm of " + (this.player.cocks.length > 1 ? "their" : "its") + " own, strands of spoo spilling across your own body, white hot spunk bringing a fresh sheen to your sweat-slick [chest].  ");
        }
        this.outputText("Eventually, enough of the eggs melt to let you stand under your own power.  You grab your [armor] but hold off on putting it on until you have a chance to shrink down to a more normal size.  Before you leave, you make sure to remove the rope from her wrists, for when she gathers her orgasm-blasted wits.");
        ...
        this.outputText(this.player.modThickness(100, 3));
