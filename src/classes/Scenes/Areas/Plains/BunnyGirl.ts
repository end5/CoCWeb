...
export class BunnyGirl extends BaseContent {
    public isItEaster(): boolean {
        return (
            (this.date.date >= 30 && this.date.date <= 31 && this.date.month == 2) ||
            (this.date.month == 3 && this.date.date <= 1)
        );
    }
    ...
    public bunnbunbunMeet(): void {
        ...
        // Met her
            ...
            this.outputText(
                "You lean forwards for a better look, dislodging a small pebble with your " +
                    this.player.foot() +
                    " while shifting position.  The bunny-girl leaps to her feet in a panic until her terrified irises lock onto your " +
                    this.player.face() +
                    '.  Her panic turns to embarrassment and in a flash every inch of her tanned skin is colored red.  She asks, "<i>Ummm, since I\'m still in s-season, c-could we b-breed or something?  Maybe just a little fuck?</i>"\n\n',
                false
            );
            ...
            if (this.player.cockThatFits(40) >= 0) {
                ...
                this.outputText("  Fuck her vagina?");
            } else if (this.player.cockTotal() > 0)
                this.outputText("  <b>You're too to big fit inside her...</b>");

            // Dick requires one 40 area or smaller.
            if (this.player.hasVagina()) {
                DickInV = this.bunbunFucksYourVag;
                this.outputText("  Her dick in your vagina?");
            }
            if (this.player.gender > 0) {
                sixtyNine = this.bunbun69;
                this.outputText("  Sixty-nine her?");
            }
            ...
            if (this.player.canOviposit() && this.player.lust >= 33) {
                ...
                else eggs = this.layEggsInBunbuns;
            }

            this.outputText("  Her dick in your ass?)");
            // var Ass: number = 0;
    ...
    private talkToBunnyBunBun(): void {
        ...
        this.outputText("", true);
        this.outputText(
            "You slowly introduce yourself, and let the bunny-girl know that you mean her no harm. She doesn't move until you finish, but as you conclude she visibly relaxes and nods.  It doesn't stop her tail from twitching, and if anything, her nose joins it in twitching, but she asks, \"<i>How is it you can see me?  I've got a lot of eggs to hide and normally no one sees me.</i>\"\n\n",
            false
        );

        this.outputText(
            "A shrug of your shoulders is the only answer you've got.  Does she think she's some kind of invisible bunny?  How crazy is that!\n\n",
            false
        );
        ...
        this.outputText(
            'Rose color erupts on her face as she drops her basket and covers her mouth, "<i>Did I just say fuck!? EEP!</i>"  With her basket no longer in hand, her groin is revealed!  A mammoth, 14-inch dong bounces proudly between her legs.  It\'s veiny and tipped with a narrow head while a pair of egg-shaped orbs bounce in the sack underneath it.  She jumps and tries to cover it up again, but all she succeeds in doing is accidentally giving it a stroke.  A dollop of pre-cum squirts onto her hand as she moans without thinking, "<i>Ooooh damn I need to breed.</i>"\n\n',
            false
        );
        ...
        if (this.player.cockThatFits(40) >= 0) {
            ...
            this.outputText("  <b>You're too big to fit inside her...</b>");
        if (this.player.gender > 0) {
            sixtyNine = this.bunbun69;
            this.outputText("  Sixty-nine her?");
        }
    ...
    private rapeBunBun(): void {
        ...
        // [Rape Her Faster]
            ...
            this.outputText(
                "You lunge forward off your " +
                    this.player.feet() +
                    ", trying to tackle and pin the poor girl, but at the first sign of movement from you,  she launches herself up and back with a powerful hop.  She didn't count on your speed, and you manage to tackle her mid-air.  Both of you slam into the ground, the bunny pinned tightly underneath you.  Her basket and eggs went flying when you hit her, and now there's a few dozen eggs scattered in the tall grass.   The girl wriggles, trying to squeeze out of your grip, but you hold firm to her as she cries, \"<i>YOU MEANIE!</i>\"\n\n",
                false
            );

            this.outputText(
                "Your belly feels warm and wet, and as you pull back to examine the bunny, the source of the moisture is revealed.  The girl isn't a girl at all!  She's got a hard 14-inch dick and a pair of bouncing, egg-sized balls that are working quite hard to leak bunny-cum onto you.  You reach down underneath the orbs and thankfully find another source of wetness.  At least you weren't completely wrong!  You're dealing with a hermaphrodite, and a horny one at that.  Why would she bother resisting when her body is so thrilled to be so close to you?\n\n",
                false
            );

            this.outputText(
                'The horny bun-herm follows your gaze and breaks into a slowly spreading grin, revealing a pair of cute buck-teeth as she asks, "<i>Oh, you just wanted to fuck?  Why didn\'t you just ask?  I thought you were going to eat me!</i>"  Her confident declaration does little to hide the bright red blush coloring her cheeks, making it clear this situation is a little strange to her.\n\n',
                false
            );
    ...
    private bunbunFucksYourVag(): void {
        ...
        this.outputText("", true);
        this.outputText(
            "A anticipatory grin widens across your " +
                this.player.face() +
                " as you speedily disrobe, discarding your " +
        ...
        this.outputText(
            " in a hurry.   Meanwhile the bunny looks on in a semi-aroused stupor, stroking her length with one hand while her other teases one of the hard nubs of her nipples.  You sigh with excitement as you position yourself above her, lining up her somewhat angular crown with the entrance to your " +
        ...
        if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_DROOLING)
            this.outputText(
                "  Moisture leaks in a steady drizzle, mixing with bunny-pre to totally slick the soon-to-be invading member.",
                false
            );
        this.outputText("\n\n", false);

        this.outputText(
            "Gasping hotly, you swallow her pointed tip into your depths, feeling the rabbit-like girl's tip swell and pump out a few more drops of lube",
            false
        );
        if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_SLICK)
            this.outputText(", not that you needed it");
        this.outputText(
            ".  You don't need any more encouragement.  The long, slow slide down her thick bunny-dick is heavenly, as the veins on its surface scratch your 'itch' in just the right way.  ",
            false
        );
        if (this.player.vaginalCapacity() < 20)
            this.outputText(
                "By the time you're getting close to the bottom you have to work to encompass her length and girth within your velvet folds and grunt with discomfort from each new inch of throbbing fuck-stick, but you take it all.  ",
                false
            );
        else if (this.player.vaginalCapacity() < 50)
            this.outputText(
                "By the time you get to the bottom you're panting and moaning, delighting in the feeling of being so perfectly impaled on a rigid fuck-stick.   With her entirely inside you, you're ready to fuck her in earnest.  ",
                false
            );
        else
            this.outputText(
                "It doesn't take long to slide down the more-than footlong meat-pole, and to be honest you wish she was a bit bigger.  Your " +
                    this.vaginaDescript(0) +
        ...
        this.outputText(
            "While the bunny was content to remain passive up until this point, a fire lights in her eyes now that she's had a taste of pussy.  Her petite hands grab hold of your " +
                this.assDescript() +
                " while she pulls her powerful, oddly-jointed legs underneath of her.  A split second later she pushes up with enough force to bounce you a few inches into the air before you drop down on top of her.  ",
            false
        );
        if (this.player.tallness >= 72) {
            this.outputText(
                "Your sheer weight makes her grunt in discomfort when you land back atop her, but the squish of copious sexual fluids nearly drowns it out. She even squirts another thick gout of pre inside you.  ",
                false
            );
            if (this.player.cor < 33)
                this.outputText("You'll have to try to slow your descent next time!  ");
            else
                this.outputText(
                    "If she's going to fuck you like this, she can handle your weight!  ",
                    false
                );
        } else
            this.outputText(
                "Your bodies clap together with a loud squish of copious sexual fluids, and another thick burble of pre warms your cunny.  ",
                false
            );
        this.outputText("How much pre-cum can she squirt?!\n\n", false);

        this.outputText(
            "You reach down and grab the bunny's hips for support as she bounces you again, higher this time.  A solid five or six inches of her length slide in and out of your " +
                this.vaginaDescript(0) +
        ...
        if (this.player.clitLength >= 4)
            this.outputText(
                "  Your " +
                    this.clitDescript() +
                    " bounces on her belly, tingling like mad every time it slaps into her tanned, sweat-slicked skin.",
                false
            );
        if (this.player.biggestLactation() >= 1)
            this.outputText(
                "  Milk begins to bead on your " +
                    this.player.allBreastsDescript() +
                    " from the sensation of the bunny's brutal, almost mechanical fucking.",
                false
            );
        this.outputText(
        ...
        this.outputText(
            "Your eyes cross from a sudden, massive change in thickness of your lover's pole.  It starts out at your lower lips, spreading them until they're positively gaping.  Muscular contractions in the bunny's shaft make her dick pulse inside you, slowly pushing the bulge upwards and stretching your " +
                this.vaginaDescript(0) +
                "'s walls as it travels towards your womb.  More and more fluid leaks inside of your channel until your " +
                this.player.legs() +
        ...
        this.outputText(
            'The girl underneath you is thrashing and moaning, chanting, "<i>Yes... eggs eggs EGGS! YES!</i>" while her ovipositor-like cock robs you of your strength and slides egg-shaped bulges inside you.  Amazingly, your ' +
                this.vaginaDescript(0) +
        ...
        if (this.player.clitLength >= 4)
            this.outputText(
                "fondle your " +
                    this.clitDescript() +
                    " a moment before wrapping your hand around it and stroking the girl-cock excitedly.",
                false
            );
        else
            this.outputText(
                "caress your " +
                    this.clitDescript() +
                    " a moment before you start to circle it with a finger, teasing it expertly.",
                false
            );
        if (this.player.cockTotal() > 0) {
            this.outputText("  " + this.SMultiCockDesc() + " twitches and drools ", false);
            if (this.player.cocks[0].cockLength < 10)
                this.outputText("on the bunny's belly");
            else if (this.player.cocks[0].cockLength < 18)
                this.outputText("between the bunny's tiny tits");
            else if (this.player.cocks[0].cockLength < 28)
                this.outputText("on the bunny's face");
            else this.outputText("past the bunny's head");
            this.outputText(", and your free hand wastes no time in tending to your male ");
            if (this.player.cockTotal() == 1)
                this.outputText(
                    "half's needs, slathering it in pre-cum and stroking hard and fast.",
                    false
                );
            else
                this.outputText(
                    "halfs' needs, slathering them in pre-cum and stroking hard and fast.",
                    false
                );
        }
        this.outputText(
            "  The futanari rabbit's dick-head swells as the egg reaches her tip, completely opening your womb, and then with one last explosive push, launches it deep inside you.\n\n",
            false
        );

        this.outputText(
            "You get off hard.  Despite the drug-induced relaxation that's overwhelmed you from the waist down, rippling convulsions erupt up and down your " +
                this.vaginaDescript(0) +
        ...
        if (this.player.cockTotal() > 0) {
            this.outputText(
                "  At last, " +
                    this.sMultiCockDesc() +
                    " blasts sticky ropes of seed everywhere, cumming with you as your body slides sideways off the exhausted bunny into the dirt.  A few thick strands hit her tits and face, but judging by her half-closed eye-lids and questing tongue, she doesn't mind.",
                false
            );
            if (this.player.cumQ() > 500)
                this.outputText(
                    "  Not content with that, " +
                        this.sMultiCockDesc() +
                        " continues to pump until the bunny is coated with a generous layer of seed",
                    false
                );
            if (this.player.cumQ() > 2000)
                this.outputText(" and the excess is running down the hill in a small river");
            if (this.player.cumQ() > 500) this.outputText(".");
        }
        this.outputText("\n\n", false);

        this.outputText(
            'You sprawl out, leaking sexual fluids as your womb closes in around the foreign cargo, closing your cervix to hold in both the eggs.  An indeterminate amount of time has passed, but the forced euphoria of your new pregnancy makes it hard to get up just yet.  You see the bunny standing up with her dick finally going limp and no balls to speak of.  She leans down and gives you a kiss on the lips before whispering, "<i>',
            false
        );
        ...
        if (this.player.bunnyScore() < 4) {
            ...
            this.player.knockUp(
                PregnancyStore.PREGNANCY_BUNNY,
                PregnancyStore.INCUBATION_BUNNY_BABY,
                60
            );
        }
        this.player.orgasm();
    ...
    private bunbunFucksPCInAss(): void {
        ...
        this.outputText(
            "You get a very naughty idea and silently discard your " +
                this.player.armorName +
                ", tossing it aside as you turn around and present your " +
                this.assDescript() +
                " to the bunny-girl.  With a lewd shake, you tease her and give her a good view of your " +
                this.assholeDescript() +
                " while it lowers closer and closer to the turgid bunny-cock, just inches away.  Drops of clear pre-cum roll down her shaft as it twitches eagerly, and the girl watches you through a gleam of sexual excitement while her shaft gets closer and closer to your rear entrance.  You let your " +
                this.player.legs() +
                " relax a little until it's pressing tightly against your sphincter, feeling it slather pre-cum in preparation for the coming penetration.\n\n",
            false
        );

        this.outputText(
            "Looking over your shoulder at the bunny's beet-red face, you let a little of your weight down and start to spread around the bunny-herm's cock.  It slides inside you easily, aided by her copious drops of pre-cum, but ",
            false
        );
        if (this.player.analCapacity() < 20)
            this.outputText(
                "it stretches you dangerously wide as you slide down the thick shaft.  The further down it gets, the more you have to work to relax your muscles and push yourself along.  With enough time, patience, and copious bunny-pre, you manage to take it completely inside you.  It twitches happily while you adjust to the intrusion, but you know you're just getting started.",
                false
            );
        else if (this.player.analCapacity() < 40)
            this.outputText(
                "you have to keep pausing as you slide down to let more of her pre-cum bubble out and lubricate the fourteen inch shaft.  It fills you nicely, pressing on your innards in all the right ways as you slowly engulf the bunny-cock with your " +
                    this.assholeDescript() +
                    ".  After bottoming out, your nervous lover's prick pulsates happily inside you, but you're just getting started.",
                false
            );
        else {
            this.outputText(
                "you wish it was a bit bigger.  A few seconds is all it takes to get her thick shaft completely inside your " +
                    this.assholeDescript() +
                    ".  You clench and squeeze your muscles around it as you sit on the bunny-",
                false
            );
            if (this.player.cor < 50) this.outputText("girl");
            else this.outputText("bitch");
            this.outputText(
                "'s lap, giggling as you feel it twitch happily inside you, but you're just getting started.",
                false
            );
        }
        // (BUTT CHANGE HERE)
        ...
        this.outputText(
            "Your partner gasps in surprise as you pull yourself up, dragging her cock slowly through the tight ring of your pucker until she's about to slip out, and then dropping back down to envelop her again.  She involuntarily grunts wordless pleasure noises, thrilled with the sensation your warm body provides.  Her hands grab her nipples as you repeat your actions, working her with a slow, smooth rhythm that should bring her to orgasm... eventually.  ",
            false
        );
        if (this.player.totalCocks() > 0)
            this.outputText(
                "Each time she bumps and slides past your prostate a dollop of your pre-cum spurts from " +
                    this.sMultiCockDesc() +
                    " onto the ground, and you have a hard time not using your new lover like an anal toy and masturbating yourself.  ",
                false
            );
        this.outputText(
        ...
        this.outputText(
            "Without meaning to, you begin to pick up the speed of your up and down strokes.  Your body is feeling horny and warm from all the sex, and having such a strange, attractive lover mating with your backside isn't helping.  ",
            false
        );
        if (this.player.hasVagina()) {
            if (this.player.vaginas[0].vaginalWetness >= VAGINA_WETNESS_SLICK)
                this.outputText(
                    "Juices begin to run from your " +
                        this.vaginaDescript(0) +
        ...
        this.outputText(
            "Fingers find their way to your nipples without conscious thought, and begin ",
            false
        );
        if (!this.player.hasFuckableNipples()) {
            this.outputText("pulling and tugging on them");
            if (this.player.biggestLactation() >= 1) {
                this.outputText(", spurting out ");
                if (this.player.biggestLactation() >= 4) this.outputText("sprays");
                else this.outputText("drops");
                this.outputText(" of milk");
            }
            this.outputText(".");
        } else
            this.outputText(
                "sliding inside them, fucking their cunt-like interiors as you start to lose yourself to the pleasure.",
                false
            );
        this.outputText(
            "  The bunny reaches down to your " +
                this.assDescript() +
                " and gives it a gentle caress and squeeze.  A moment later both her hands are holding your butt-cheeks, guiding you up and down as you bounce atop her faster and faster.\n\n",
            false
        );

        this.outputText(
            'You stroke the downy fur of her thighs through your fingers, marveling at her softness as you let the bunny start to set a tempo so fast that her pre-cum is squirting out with each wet, gushy fuck.   She occasionally gives your ass a gentle slap and starts moaning and panting out loud with every heated penetration, "<i>Fuck... breed... mmm... yes... eggs eggs pleaseletmeegg!</i>" It\'s hard to pay attention with the rising pleasure surging through your body',
            false
        );
        if (this.player.cockTotal() > 0) {
            this.outputText(
                ", and " +
                    this.sMultiCockDesc() +
                    " pouring incredibly sticky pre-cum each time she squeezes your prostate",
                false
            );
        ...
        if (this.player.biggestLactation() >= 1) {
            ...
            if (this.player.biggestLactation() < 2) this.outputText("leaks");
            else if (this.player.biggestLactation() < 4) this.outputText("drips");
            else this.outputText("pours");
            this.outputText(
                " from your " +
        ...
        this.outputText(
            "Wait a second, what was that about eggs?  The confusion that comes with that thought distracts you enough to keep you from cumming, but the bunny orgasms before you have a chance to reconsider your position atop her.  She convulses, her rod twitching and thickening slightly, but you don't feel the warmth of erupting cum that you would expect.  You look down at her, but the bunny-girl is too insensate to provide any answer, and it's not until you notice that her balls are missing that you realize something is wildly different about the way her orgasms work.\n\n",
            false
        );

        this.outputText(
            "You gasp in pain as the thickness at the base of your lover's shaft doubles.  It stretches your " +
                this.assholeDescript() +
                " wide, almost painfully wide as something starts to push up her dick from the inside.  Before you can pull yourself off her, a massive gush of fluid drizzles inside of you, quickly numbing any pain and stealing the strength from your " +
                this.player.legs() +
                " and muscles.  You twist back and forth, but the pleasure intensifies as the bulge slips past your sphincter, leaving your body slightly agape in its wake.  You find the rest of its passage to be more comfortable ",
            false
        );
        if (this.player.cockTotal() > 0) {
            this.outputText(
                "and as it squeezes past your prostate, " +
                    this.sMultiCockDesc() +
                    " spurts thick cum on the ground, though you don't QUITE orgasm.",
                false
            );
        } else this.outputText("and your arousal returns in force.");
        // (BUTT CHANGE HERE)
        this.player.buttChange(70, true);
        this.outputText("\n\n", false);

        this.outputText(
            "A moment before the bulge reaches the tip of the rabbit-cock, you feel another sliding through your " +
                this.assholeDescript() +
                ".  The bunny-dick's head thickens for a moment before it dwindles down to its normal shape.  You feel something warm and orb shaped inside you – it's an egg!  The strangeness of the insemination can't hold back the excitement your body built up or the feelings the second egg's passage is leaving in its wake, and you cum hard.  Somehow your body gets enough control to squeeze the girl's penis tightly, but all it accomplishes is speeding the eggs passage as it spurts into your rectum along with another big burst of pleasant, relaxing fluids.",
            false
        );
        if (this.player.cockTotal() > 0) {
            this.outputText(
                "  " +
                    this.SMultiCockDesc() +
                    " erupts in truth, spraying and splattering white goop over the grass and ground.",
                false
            );
            if (this.player.cumQ() > 500)
                this.outputText(
                    "  The splattering of your seed only increases in volume as it makes a rather large puddle",
                    false
                );
            if (this.player.cumQ() > 2000)
                this.outputText(
                    ", but you just keep going until you create a lazily winding river of cum that flows its way through the grasses",
                    false
                );
            if (this.player.cumQ() > 500) this.outputText(".");
        }
    ...
    private bunbunGetsFucked(): void {
        ...
        this.outputText(
            "You disrobe and toss your " +
                this.player.armorName +
                " to the side, immediately forgetting about it as the bunny-girl lifts her sack to expose the bright pink flesh of her femininity.  It glistens, practically steaming up the air with her plentiful lubricants.  She runs a slender finger around the moist hole, beckoning you to plunge inside and fill her hungry flesh with your " +
                this.cockDescript(x) +
                ".  Lust burns through you as you drop to your knees and line your " +
                this.cockDescript(x) +
        ...
        if (y != -1)
            ...
            this.outputText(
                ", barely able to restrain yourself as the time for penetration approaches.",
                false
            );
        this.outputText("\n\n", false);

        this.outputText(
            "The nubile bunny's eyes cross as you push forwards, sliding your " +
        ...
        if (y != -1)
            this.outputText(
                "She squeaks at the pressure on her tender asshole, but doesn't object as your pre-cum smears over it.  ",
                false
            );
        this.outputText("At once, her greedy breeding hole relaxes ");
        if (y != -1) this.outputText("along with her anus ");
        this.outputText("and your " + this.cockDescript(x), false);
        if (y != -1) this.outputText(" and " + this.cockDescript(y) + " sink", false);
        else this.outputText(" sinks");
        this.outputText(
            " into her slippery, warm depths.  She pants and groans with happiness, going so far as to vocalize her pleasure, \"<i>Oooh yes, I don't know why but it feels just as good as breeding season!  If you keep this up, " +
                this.player.mf("stud", "sexy") +
                ', you might... ahhhh.. make me egg!</i>"\n\n',
            false
        );

        this.outputText(
            "You don't try to make sense of it and instead plunge further forward, watching with delight as more and more of your length is devoured by the horny bunny's body.  ",
            false
        );
        if (this.player.cockArea(x) >= 25)
            this.outputText(
                "Her belly bulges pleasantly, displaying the vaguely cylindrical shape of a cock through her skin in a way that makes you feel utterly dominant over this 'female'.  ",
                false
            );
        this.outputText(
            "Once you bottom out, the hermaphrodite actually starts to squirt pre-cum onto herself.  It isn't quite as much as you'd expect from a real orgasm, but it's enough that she makes a slippery mess of her tits and belly.  She gathers it up and starts stroking herself off with it, and you watch the enthusiastic bunny masturbate herself.\n\n",
            false
        );

        this.outputText(
            "\"<i>Nooooooo,</i>\" she cries, thinking you meant to stop, but you savagely slam back in, rocking her body and making her petite, pre-cum-glazed tits jiggle pleasantly.   Her 'no' turns into an 'OHHH' in that split second, and before she can stop or catch her breath, you start fucking hard, watching her cum-shined breasts wobble underneath you.  ",
            false
        );
        if (y != -1)
            this.outputText(
                "Her tight asshole slowly loosens around your " +
                    this.cockDescript(y) +
            ...
            this.outputText("So much lubricant splatters from her cunt that your thighs");
            if (this.player.balls > 0) this.outputText(", belly, and balls");
            else this.outputText(" and belly");
            this.outputText(
                " are soon sticky with the stuff, but it only spurs you on to fuck her harder.",
                false
            );
        }
        this.outputText("\n\n", false);
        ...
        this.outputText(
            'Before your eyes the rabbit-girl\'s balls disappear and the flesh of her sack pulls tight against her.  It actually looks like she never had one at all.  You look to her for answers, but her eyes are rolled back, her body is quaking around you, and her mouth is babbling, "<i>Eggfuck... eggbreedegg... ungungegg... eggegg,</i>" over and over.  Her cunt clamps down on you with a vice-like grip that makes your eyes cross and your crotch bubble with the heat of a coming orgasm.',
            false
        );
        if (y != -1)
            this.outputText(
                "  Surprisingly, her asshole stays about the same, but it was already a little tighter and you know you'll be pumping it full of goo in a second.",
                false
            );
        this.outputText("\n\n", false);

        this.outputText(
            "The bunny's convulsions take on a manic, thrashing pace, and before your eyes the base of her swollen cock begins to distend, nearly doubling in width from some internal object.  You wonder how she could enjoy something like that, but maybe her body is built for it?  It slowly works its way up the shaft while your long-eared lover stays locked in orgasm, panting, gasping, and leaking whiter-colored pre-cum that stops the convulsions anywhere it hits.  There must be something in it that forcibly relaxes the muscles, but before you can ponder it further your own climax has arrived.\n\n",
            false
        );

        this.outputText("You bottom out with brutal force");
        if (this.player.balls > 0) this.outputText(", slapping your balls against her ass");
        this.outputText(", as your ");
        if (this.player.hasSheath()) this.outputText("sheath");
        else this.outputText("base");
        this.outputText(
            " rubs her passion-inflamed pussy-lips.  " +
                this.SMultiCockDesc() +
                " unloads, splattering out ropes of cum into ",
            false
        );
        if ((this.player.cockTotal() == 2 && y == -1) || this.player.cockTotal() > 2)
            this.outputText("and onto ");
        this.outputText(
            "the insensate bunny-breeder.  Her silken pussy milks and squeezes as you cum, seeming to draw your seed from your cock itself and pull it deeper inside, leaving none to waste.",
            false
        );
        if (y != -1) {
            this.outputText("  Her ass gurgles from your deposit");
            if (this.player.cumQ() > 500)
                this.outputText(
                    ", and her stomach gains a bit of pudge from the copious jism deluge you pump into her",
                    false
                );
            this.outputText(".");
        }
        ...
        if (this.player.cumQ() > 100)
            this.outputText(
                "  A few seconds later another rolls in, cramming three into her increasingly obscene looking 'sack'.",
                false
            );
        if (this.player.cumQ() > 250)
            this.outputText("  One more follows, giving her quads");
        let z: number = 8 + BunnyGirl.rand(this.player.cumQ() / 100);
        if (z > 50) z = 50;
        if (this.player.cumQ() > 700)
            this.outputText(
                ", but she's not done.  Her gut rumbles loudly, and then one after another egg after egg pours into the sack, stretching it out until you're sure she has at least " +
                    z +
                    " in there and will have trouble walking.",
                false
            );
        else this.outputText(".");
        this.outputText(
            "  She moans contentedly and closes her eyes, sighing blissfully.\n\n",
            false
        );

        this.outputText(
            'You shrug and pick up one of her eggs, noticing that it\'s turned neon pink in color.  The bunny mumbles, "<i>Have it, iz good for youuuu...</i>" before she starts to snore and murmur out a sexual dream.\n\n',
            false
        );
    ...
    private bunbun69(): void {
        ...
        if (this.player.isTaur()) {
            if (BunnyGirl.rand(2) == 0) {
                ...
                this.outputText(
                    "By now you've realized the absurdity of your statement, but you're too proud to admit it and simply restate your goal.  You cross your arms to try to look as serious as possible.  She looks down at your equine portion while idly stroking her cock, making sure your \"equipment\" is where she thinks it is.\n\n",
                    false
                );
                ...
                this.outputText(
                    "Without thinking it over too hard beyond 'that sounds hot', you declare your intention to 69 the bunny girl.  She bursts into laughter.  You're a little perturbed by this and make it clear you're quite serious by restating your goal.\n\n",
                    false
                );

                this.outputText(
                    '"<i>No, no, stop – ahaha - you\'re killing me - haha!</i>" she splutters.  "<i>Hahaha - oh gods - I\'m going to egg from laughter - HAHAHA!</i>"\n\n',
                    false
                );

                this.outputText(
                    "You realize the absurdity of your proposition just as she falls backwards, one hand on her belly and one on her cock.  You try to imagine some way to make your proposal work and save face, but the humiliation of having said something so ridiculous and thoughtless leaves you bereft of any more suggestions.\n\n",
                    false
                );

                this.outputText(
                    "She's laughing so hard that her entire body starts to shake violently.  Thinking that it wasn't <i>that</i> funny, you're about to turn and leave when one of her testicles disappears.  You watch in mixed curiosity and confusion as the lump makes its way up the hysterical rabbit's cock and launches into the air, revealing itself to be a pastel pink and white egg.  You bend down to pick it up just as the other \"teste\" splatters onto your face.\n\n",
                    false
                );
        ...
        if (this.player.cockTotal() > 0) {
            ...
            if (this.isEaster()) {
                ...
                if (this.player.earType != EARS_BUNNY) {
                    this.outputText("  The top of your head is next, it seems.");
                    // [No antennae:
                    this.outputText(
            ...
            // REGULAR SHOW
                ...
                if (this.player.balls > 0) this.outputText("balls");
                else if (this.player.hasVagina()) this.outputText("clit");
                else this.outputText("groin");
                this.outputText(
                    ", whiskers vibrating with a happy little hum, her buck teeth massaging your root enthusiastically, impatient for her own creamy meal. Her hands slide from the back of your head, along your neck, down your back, and to your ass, fingers wrapping around to find your " +
                        this.player.assholeOrPussy() +
                        ". Slipping both middle fingers in, she strokes your ",
                    false
                );
                ...
                this.outputText(
                    ", your spunk calming the egg-laying passion. She pulls her shrinking phallus from your mouth with a wet slurp, the taste of her strange cum sweet on your lips. She rises to a crouch and gives your ",
                    false
                );
                if (this.player.earType != EARS_BUNNY) this.outputText("new ");
                this.outputText(
                    "ears a playful tweak between her thumb and forefinger. \"<i>Sorry about that, I don't know what came over me! I certainly didn't expect this, though! Kind of makes me want to stick around and see if you and I could pop out more bunnies,</i>\" she winks. \"<i>But unfortunately, I've got to get going! Maybe I'll try to find you again, some time down the line.</i>\" She gives you a moist little kiss and hops away, still energetic after all that. You groan, still recovering from the eggs.",
                    false
                );
        ...
        // CUNTS
            ...
            this.outputText(
                "With a happy sigh, the girl rubs your slick honey off of her face and gives your clit a final, pleased lick. She pulls her shrinking phallus from your mouth with a wet slurp, the taste of her cum sweetly icy on your lips. She rises to a crouch and gives your ",
                false
            );
            if (this.player.earType != EARS_BUNNY) this.outputText("new ");
            this.outputText(
    ...
    public layEggsInBunbuns(): void {
        this.clearOutput();
        this.outputText(
            "The displayed lapin in front of you has you excited, but not for a simple roll in the grass.  Your "
        );
        if (this.player.eggs() < 20)
            this.outputText(
                "eager egg-tube slips free, ready to show the rabbit you can play the egg game too."
            );
        else if (this.player.eggs() < 40)
            this.outputText(
                "distended bug part quivers in anticipation, the ovipositor pushing into view with a drop of honeyed pre on its tip."
            );
        else
            this.outputText(
                "low-hanging bee abdomen drools honey-like ichor down its carapace from the bulge where the thick black organ shows its need to relieve your burden."
            );
        this.outputText(
            '  The bunny gasps upon noticing it, the herm\'s hips wiggling. "<i>Oh my, could... could you mount me with that?  I need to egg so badly.</i>"  Not needing to be urged further, you arch your bee-section up underneath you while lifting the lusty bunny against you.'
        );
        this.outputText(
        ...
        if (this.player.gender == 0) this.outputText(" against the empty place of your crotch.");
            ...
            if (this.player.hasVagina())
                this.outputText(
                    " and her hefty oval balls rubbing the [vagina] tucked between your thighs"
                );
            this.outputText(".");
        }
        this.outputText(
            "  She braces herself with arms around your shoulders, trying to nearly jump onto you as you ram your engorged ovipositor into her tight ass."
        );
        ...
        this.outputText(
            ".  Stuffing a warm hole with egg after egg is not only fulfilling (for <i>both</i> involved) but is also damn fun, which the rabbit agrees with!"
        );
        this.outputText(
        ...
        if (this.player.gender > 0) {
            ...
            if (this.player.hasCock())
                this.outputText(
                    "spraying a long, thick load against the bunny's soft tits from your [eachCock]"
                );
            if (this.player.gender == 3) this.outputText(" and ");
    ...
    public ovipositBunnyEaster(): void {
        this.clearOutput();
        this.outputText(
            'Smiling a little over-eagerly, you suggest, "<i>You know, if you really like eggs, I know where you can get a few...</i>"'
        );
        this.outputText(
        ...
        this.outputText(
            ' claiming an incubator.  When she feels your groin pressing on the small of her back, the fluffy hare grows concerned, looking over her shoulder and declaring, "<i>You... you can\'t put eggs in me like THAT!</i>"'
        );
        this.outputText(
    ...
    private freeHerOhGodWhyDidYouDoThis(): void {
        this.clearOutput();
        this.outputText(
            "Taking a chance, you step up to the wriggling bunny and inspect her bonds.  The girl's body is covered in a "
        );
        ...
        this.outputText(
            " skin.  Her abdomen is slightly rounded with a pot-bellied pout that you assume must be the seed of the previous Samaritans.  Due to her inability to climax, her pussy must be clenching so tightly that only a thin trickle of cum is able to escape.  Her "
        );
        ...
        this.outputText(
            " of pre dribbling from the narrow, spear-like crest. The lustful girl's balls are even more lewd close up, gargantuan orbs obscenely stuffed with "
        );
        if (!this.isEaster())
            this.outputText("the carnal fruit of her unwelcome, monstrous couplings");
        else
            this.outputText(
                "candied plenty, her saccharine treats swimming amid a warm sea of honeyed spunk"
            );
        this.outputText(
            ". She bites down on her lower lip with her prominent front two teeth, her eyes following your motions intently, hoping for the best but braced for the worst."
        );
        ...
        this.outputText(
            ".  The showering spray continues in an unbroken outpouring, a river of alabaster arcing and gushing in a throbbing surge that white-washes everything within ten feet of her frontal arc.  Countless "
        );
        ...
        this.outputText(
            " geyser, plopping moistly here and there.  Some stop in plain sight, others roll into hidden hollows, left for some curious treasure hunter."
        );
        ...
        this.outputText(
            " nipples as her big, soft toes dig rutting furrows into the ground beneath her.  Her orgasmic throes send spasms of bliss through her whole body, her clenched inner muscles finally relaxing enough to release the jism inside her womb, vulgar globules oozing down her trembling inner thighs."
        );
    ...
    private fuckTheEggBoundBun(): void {
        this.clearOutput();
        this.outputText(
            "It's not often you find a treat gift wrapped so neatly for you; what kind of ingrate would you be if you just turned it down?  You step up to the wriggling bunny and inspect her carefully.  The girl's body is covered in a "
        );
        if (!this.isEaster()) this.outputText("sheen of sweat");
        else this.outputText("shimmering glaze");
        this.outputText(", her urgent lust pulsing in every inch of her ");
        ...
        this.outputText(
            " skin.  Her abdomen is slightly rounded with a pot bellied pout that you assume must be the seed of the previous Samaritans.  Due to her inability to climax, her pussy must be clenching so tightly that only a thin trickle of cum is able to escape.  Her cony cock jerks in the air with every hyperventilating breath, "
        );
        if (!this.isEaster()) this.outputText("bubbling pearls");
        else this.outputText("gooey marshmallows");
        this.outputText(
        ...
        if (this.player.cor < 33)
            ...
            this.outputText(
                "revel in the profane stimulation of bestial batter anointing your length in impure, liquid virility"
            );
        this.outputText(".");
        ...
        this.outputText(
            ".  Reaching your own threshold, you lean forward, pressing your cheek against hers, the intake of your breath hissing between your teeth.  She instinctively understands, slamming her ass against your [hips] with as much force as she can muster."
        );
        ...
        if (this.player.cumQ() < 250)
            ...
            this.outputText(
                "bulging enough that her belly button turns outward as the cum oozing from her pussy gushes between the two of you"
            );
        else
            this.outputText(
                "growing larger and larger as cum splatters in thick streams from her saturated pussy. Your seemingly endless gallons of flooding cum wash the remnants of her previous partners away, immersing the caramel woman in the fluid wealth of your liquid possession."
            );
        this.outputText(
    ...
    private getEggflated(): void {
        this.clearOutput();
        this.outputText(
            "Deciding it'd be too cruel to leave her like this, you resolve to put the bunny-girl at ease. However, you're not so foolish that you're willing to just untie her - if that hungry look in her eyes is any warning.  Stepping up to the wriggling bunny, you inspect her carefully.  The girl's body is covered in a "
        );
        if (!this.isEaster()) this.outputText("sheen of sweat");
        else this.outputText("shimmering glaze");
        this.outputText(", her urgent lust pulsing in every inch of her ");
        ...
        this.outputText(
            ", her spear-like head slips easily past your labia, fervent flesh filling your trembling cavity. The girl's "
        );
        if (!this.isEaster()) this.outputText("thick pole");
        else this.outputText("sweet shaft");
        this.outputText(
            " sends ripples of hot and cold through your gut as her peculiar, almost numbing jism bubbles up inside you.  In another moment, you find yourself completely impaled on her turgid length, despite the throbbing girth of her "
        );
        ...
        this.outputText(
            ", you realize there's really only one thing left to do.  Sliding a hand between her waist and the tender flesh the two of you are balanced upon, your fingers seek out the "
        );
        if (!this.isEaster()) this.outputText("twitching tuft");
        else this.outputText("cotton candy poof");
        this.outputText(
            " of her fluffy tail.  You find the junction where it meets the base of her spine and bear down on the sensitive point with your knuckles, eliciting a shrieking squeal of bliss from the over-burdened bunny-girl.  An intense pressure floods your cunt as her "
        );
        if (!this.isEaster()) this.outputText("swollen dick");
        else this.outputText("candied cock");
        this.outputText(
            " distorts under the heft of the emerging eggs.  As the first oval bulge travels up her shaft, you grind and slam deeper on her until the narrow point of her "
        );
        if (!this.isEaster()) this.outputText("jizz-burbling");
        else this.outputText("jelly-bubbling");
        this.outputText(
            " crest presses hotly against your cervix.  The sputtering flood of her opiate spunk saturates your inner walls, giving them a yielding elasticity.  As the egg nears her tip, you spear yourself down on the climaxing girl's prominence, feeling her dilating peak penetrating your womb.  With an exquisite moan of drugged euphoria, you watch your abdomen bulge as the egg pops free, followed by jets of "
        );
        if (!this.isEaster()) this.outputText("tingling, liquid passion");
        else this.outputText("fattening, cream filling");
        this.outputText(
            ".  Another egg rushes up, followed by another, the pace accelerating as you bounce atop the vivacious hare with fast, short strokes that rub your [clit] against her cum-bloated belly."
        );
        ...
        if (this.player.hasCock())
            this.outputText(
                "  The steady movement of the orbs pushing past your prostate drills another, even messier orgasm from your " +
                    ...
                    ", cum arcing into the air to shower down on the two of you in pearl beads."
            );
        ...
        if (this.player.hasCock()) {
            this.outputText(
                "Your exhausted " +
                    ...
                    " own, strands of spoo spilling across your own body, white hot spunk bringing a fresh sheen to your sweat-slick [chest].  "
            );
        }
        this.outputText(
