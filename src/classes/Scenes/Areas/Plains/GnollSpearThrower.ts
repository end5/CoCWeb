import { ANAL_LOOSENESS_STRETCHED, ANAL_WETNESS_DRY, BUTT_RATING_TIGHT, HIP_RATING_AMPLE, SKIN_TYPE_FUR, VAGINA_LOOSENESS_LOOSE, VAGINA_WETNESS_DROOLING } from "../../../../includes/appearanceDefs";
