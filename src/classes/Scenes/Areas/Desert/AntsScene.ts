...
export class AntsScene extends BaseContent implements TimeAwareInterface {
    ...
    public constructor() {
        ...
        this.pregnancy = new PregnancyStore(
            kFLAGS.PHYLLA_VAGINAL_PREGNANCY_TYPE,
            kFLAGS.PHYLLA_DRIDER_INCUBATION,
            0,
            0
        );
    ...
    public timeChange(): boolean {
        ...
        if (
            ...
            AntsScene.rand(5) == 0 &&
            this.flags[kFLAGS.ANT_KIDS] < 5000
        )
        ...
        if (this.model.time.hours > 23) {
            ...
            if (this.flags[kFLAGS.PHYLLA_EGG_LAYING] > 0)
                this.flags[kFLAGS.DAYS_PHYLLA_HAS_SPENT_BIRTHING]++;
            if (this.flags[kFLAGS.PHYLLA_GEMS_HUNTED_TODAY] > 0)
                this.flags[kFLAGS.PHYLLA_GEMS_HUNTED_TODAY] = 0;
    ...
    public antColonyEncounter(): void {
        ...
        if (
            this.flags[kFLAGS.ANT_ARENA_WINS] - this.flags[kFLAGS.ANT_ARENA_LOSSES] >= 2 &&
            this.flags[kFLAGS.ANT_ARENA_WINS] >= 4 &&
            this.player.gender > 0
        ) {
            if (this.flags[kFLAGS.PHYLLA_STAY_HOME] > 0)
                this.bumpIntoTheAntColonyAfterStayHomePhylla();
            else this.antGirlGoodEnd();
        } else if (this.flags[kFLAGS.PC_READY_FOR_ANT_COLONY_CHALLENGE] == 1)
            this.antColonyChallenge();
        else if (this.flags[kFLAGS.PHYLLA_SAVED] == 1) this.enterTheColony();
        else this.firstAntColonyEncounter();
    }
    ...
    private firstAntColonyEncounter(): void {
        this.clearOutput();
        this.outx("While traversing an unfamiliar part of this desert wasteland, ");
        if (this.player.cor > 75 && this.player.lust > 50)
            this.outx(" looking for something to slake your unquenchable lusts, ");
        this.outx(
            "you come across an abandoned merchant's cart.  The cart looks eerily disheveled, with a majority of its contents strewn about the sand.  Whoever or whatever deserted this thing did so in a hurry, and for seemingly no reason. Curious, you decide to inspect it for anything worthwhile."
        );
        this.outx(
    ...
    private keepHidden(): void {
        ...
        // ►(If Over 41 - Male)
            ...
            this.outx(
                "You know exactly what's going to happen once the demons 'subdue' their prey.  The growing throbbing in your loins begs for release, and you quickly and quietly take off your " +
                    this.player.armorName +
                    ", making sure the demons don't notice you.  You might as well watch the show as you're not gonna be able to leave unnoticed until the demons are done anyways."
            );
            this.outx(
                "\n\nWatching from your hiding spot you start to stroke your " +
                    this.cockDescript(0) +
                    "."
            );
            ...
            if (this.player.cocks[x].cockLength >= 20)
                this.outx(
                    "  Licking the head of your [cock " +
                        (x + 1) +
                        "] in anticipation of what's to come only adds to your growing lust."
                );
            // If player cock size tiny:
            else if (this.player.cockArea(x) < 6)
                this.outx(
                    "  Though your cock isn't the most impressive, it's 'got it where it counts' and you intend to make the most of it.  You lovingly tease yourself until you're fully erect; running your fingers down the ridge causes a bead of pre-cum to form on your tip."
                );
            // If player cock size normal:
            else if (this.player.cockArea(x) < 12)
                this.outx(
                    "  You hold your cock like the hilt of a sword and start to pump your shaft slowly.  Your breathing becomes heavier and labored, as you stroke yourself with mounting passion."
                );
            // If player cock size large:
            else if (this.player.cockArea(x) < 30)
                this.outx(
                    "  The fear of having your cock give away your position quickly passes through your mind, but it's too late now.  The only way out of this is to cum, so you might as well enjoy it.  You firmly grasp your cock and start jacking off, hoping that you'll finish sooner rather than later."
                );
            // If player cock size MASSIVE:
            else
                this.outx(
                    "  The towering meat log jutting from your crotch gives away your 'hiding' spot, but the demons don't seem to mind, as they're too busy with their new toy.  You doubt even if they did care that any of them would be able to satisfy you. You wrap your arms around your fully erect cock and start to pump, hoping to release your load soon."
                );
            ...
            this.outx(
                "\n\nThe hermaphrodite struggles to cram itself inside the ant-girl and eventually succeeds.  With each stomach-contorting thrust you hear the ant's muffled moans of pain and ecstasy from between the legs of the female demon.  The hermaphrodite quickens his thrusts and, in turn, you keep speed.  With near-precision timing, you and the demon finish together.  " +
                    this.SMultiCockDesc() +
                    " throbs and a wave of euphoria washes over you.  Groaning in pleasure you release your "
            );
            // [no new PG, Start Cum Check
            if (this.player.cumQ() < 100) this.outx("sizable");
            else if (this.player.cumQ() < 1000) this.outx("huge");
            else if (this.player.cumQ() < 10000) this.outx("massive");
            else this.outx("titanic");
            this.outx(
                " load.  Once you can refocus your eyes, you see the hermaphrodite pull out, and as it does a burst of cum sprays out of the ant-morph's vagina as her stomach deflates slightly.  She's been filled with so much corrupt seed that it's stretched her belly to the point it resembles a third-trimester pregnancy."
            );
            this.outx(
        ...
        // ►If Over 41 - Female
            ...
            this.outx(this.images.showImage("ants-desert-female-firstencounter"));
            this.outx(
                "Watching from your hiding spot, you consider what's going to happen and feel your pussy immediately moisten.  Your practiced hands move with deftness, slipping into your [armor]."
            );
            this.outx(
            ...
            if (this.player.lactationQ() > 100)
                this.outx(
                    "  You feel your warm milk flow out of your hardened arola, as your body begs to release its sweet nectar."
                );
            // If PC has dick(s):
            if (this.player.hasCock())
                this.outx(
                    "  Feeling [eachCock] throb between your legs, you run one of your hands down your chest and start to stroke lovingly."
                );
    ...
    private playHero(): void {
        ...
        this.outx(
            "As the demons bear down on the ant-girl, you burst from your hiding place, raising your [weapon] to the air and uttering an impressive war cry.  Nobody, ant or otherwise, is getting raped if you have any say in the matter!"
        );
    ...
    private antColonyChallenge(): void {
        ...
        if (this.flags[kFLAGS.MET_ANT_ARENA] == 0) {
            ...
            this.outx("  After a moment he looks down and scribbles something on his chart.");
        ...
        // Introduction Subsequent Times
            ...
            this.outx(
                "Your feet bring you back to the ant colony and the guard motions you down the only lit tunnel once more.  You enter the colosseum, and as you step out into the cavern, you are greeted, again, by a thin male ant-morph holding a clipboard.  He looks up at you."
            );
            this.outx(
    ...
    private leaveAntColony(): void {
        this.clearOutput();
        this.outx(
            "Deciding to better prepare yourself first, you inform the thin fight manager that you will return later.  You leave the colony, heading back to camp."
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private antColiseumFight(): void {
        ...
        // ►[Fight #3]
            ...
            // (Gnoll - Intro)
            if (this.flags[kFLAGS.MET_ANT_ARENA_GNOLL] == 0)
                this.outx(
                    "With due ceremony, the manager leads you down to one of the staging areas for the arena.  You watch through the bars as the stadium fills far past capacity.  There must be a thousand ants here... maybe even the whole colony.  Gazing out into the crowd, you pick out the royal seating and in it, Princess Phylla.  The princess is in much finer attire than you're used to seeing - her chest is actually covered by a fine red and blue dress and her hair is combed, framing her face nicely.  Her mother is nowhere to be seen, and you can tell that Phylla is taking full advantage.  She waves and cheers for you just like the crowd is and, perhaps by her orchestration, you hear the crowd pick up a chant in your name.  Seeing Phylla chant with them makes you feel invigorated.  As the gates raise, you charge out into the center of the arena, roaring your finest battle cry; your opponent is taken somewhat aback but finds resolve and braces for your charge."
                );
            // ►(Gnoll - Intro Repeat - for people that lost once)
            else
                this.outx(
                    "You move through the network of tunnels and caves and come to the colosseum once more.  You are greeted by the event manager and he ushers you down to one of the staging areas for the arena.  The noise intensifies as the colosseum fills to the brim with spectators; Phylla herself is up in her box waving to you.  You look across the arena floor and the gnoll at the other side of the arena seems just as excited to fight as you are.  The gates open and you charge each other!"
                );
    ...
    public phyllaTentaclePCLoss(): void {
        this.clearOutput();
        this.outx(
            "After your defeat in the arena, you set off to leave but are stopped.  Princess Phylla is standing with a troupe of armed guards by the exit, holding a vial of clear liquid.  She doesn't look like she wants to give it to you but she extends it to you all the same."
        );
    ...
    public phyllaBeatAMino(): void {
        this.outx(
            "As you exit the arena, amidst the cheers and roars of the crowd, you are met by Princess Phylla and slightly fewer guards than the last time.  She sees you coming and her face lights up, then runs over to you and starts doting over you. You smile and let her do her thing.  Once she's done, she looks deep into your eyes."
        );
        this.outx(
    ...
    public phyllaPCLostToMino(): void {
        this.outx(
            'After your staggering defeat and subsequent humiliation in the arena two guards approach you as you try to leave.  One of them holds out a small vial.  Princess Phylla is off in the corner of the room crying, and you try to move closer to her but one of the guards steps in front of you.  "<i>Drink!</i>" he commands, uncorking the vial.'
        );
        this.outx(
    ...
    public phyllaPCBeatsGnoll(): void {
        ...
        if (this.flags[kFLAGS.ANTS_PC_BEAT_GNOLL] == 0) {
            ...
            this.flags[kFLAGS.ANT_ARENA_WINS] - this.flags[kFLAGS.ANT_ARENA_LOSSES] >= 2 &&
            this.flags[kFLAGS.ANT_ARENA_WINS] >= 3 &&
            this.player.gender > 0
        ) {
        ...
        // ►(Gnoll - Win Repeat) Standard Gnoll Win Scene. +
            ...
            this.outx(
                "This isn't the first time you've accomplished this, but it still brings the crowd to their feet.  You simply stand in the center of the arena, taking it all in.  Phylla makes her way to you, blushing as the rowdy audience follows her with catcalls and demands for her to give her champion a kiss.  She tends to you as always and, when she's done, takes your hand in hers and looks at you expectantly.  You smile at her, brushing the hair from her face with your other hand; she colors deeply at the contact as two guards appear to lead you both off.  Having no more reason to stay, you allow your guide to return you to the surface."
            );
        }
        // (+1 Win Score)
        this.flags[kFLAGS.ANT_ARENA_WINS]++;
    ...
    private antastrophyBadEnd(): void {
        this.clearOutput();
        this.outx("As you go to leave the arena queen Chylla and four bodyguards approach you.");
        this.outx(
    ...
    private antGirlGoodEnd(): void {
        ...
        if (this.player.hasVagina())
            this.addButton(1, "Use Vagina", this.femalePhyllaFirstFuckGooooo);
    }
    ...
    private gigititigitigitigitigityAntGirl(): void {
        ...
        if (this.player.cockArea(x) < 36) {
            ...
            if (this.player.cockTotal() > 1)
                this.outx(
                    "\n\nShe probably won't be able to handle ONE, let alone all of your " +
        ...
        // ***Dick(s) size more than 36 inches, but less than 72 inches:
            ...
            this.outx(
                "\n\nThe constant bobbing and twitching of your " +
                    this.multiCockDescriptLight() +
                    " is apparently not obvious enough to her that your trousers aren't built to accommodate the size of your loins.  You grimace in response as the fabric of your pants become painfully constrictive and unyielding. Snapping out of her inexperienced musings, the Ant Morph sees your obvious predicament."
            );
            this.outx(
                "\n\nIn an effort to get your loins free she rushes in, all four of her arms working feverishly to help spring you free.  After a quick flurry of motions, your " +
                    this.multiCockDescriptLight() +
                    ' snap out of your britches; the size of which apparently intimidates the Ant Morph, whose eyes go wide.  "<i>H-Ho- How am I... wow...</i>"'
            );
            // PC has more than one dick:
            if (this.player.cockTotal() > 1)
                this.outx(
        ...
        // ***Dick(s) size more than 72 inches:
            ...
            this.outx(
                "\n\nThe fabric of your pants simply cannot contain your " +
                    this.multiCockDescriptLight() +
                    " any longer as you frantically tug and yank at the button, trying to get your loins free before you injure yourself or ruin a good pair of trousers. Phylla's absent mindedness comes to an abrupt end when she sees your face flush with red and fury as you desperately work to free yourself."
            );
            this.outx(
        ...
        this.outx(
            "\n\nToo late!  With a final groan and a rip, your pants give way to the force and power of your quickly hardening " +
                this.multiCockDescriptLight() +
                ", sending a cursed button flying asunder from your waistline. The button connects with Phylla's forehead with a mighty 'thwack' and careens off her skull.  Fortunately for you, and her, she's more fixated on what's coming out of your pants rather than the pants themselves."
        );
        // Dick Size huge:
        if (this.player.cockArea(x) >= 72) {
            ...
            if (this.player.cockTotal() > 1)
                this.outx(
                    "\n\nOverwhelmed by the sight of ONE of your members, Phylla arguably goes catatonic when she sees all of what your packing.  She probably won't be able to handle the one, let alone all of your " +
                        this.multiCockDescriptLight() +
                        "!"
                );
            ...
            if (this.player.tentacleCocks() > 0) {
                ...
                this.outx(
                    " forward and wrap them tightly around Phylla, taking her hand and tugging her in close."
                );
            }
            ...
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(
                " from around her and hang it in front of her face, grinning your antics on your face as Phylla stares at "
            );
            if (this.player.cockTotal() == 1) this.outx("it");
            else this.outx("them");
            this.outx(", slightly intimidated.");
            ...
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(
                " looking for something more sizeable.  You can tell Phylla is more scared of what might happen to her than what might happen to you."
            );
    ...
    private malePhyllaContinuation(x: number): void {
        this.clearOutput();
        this.outx(
            "Phylla stares down at your " +
                this.multiCockDescriptLight() +
                " and starts nervously rubbing her hands together.  \"<i>It's my first time... I mean, I hope it isn't going to be bad for you...</i>\" she says, before trailing off; uncertain of her sexual prowess."
        );
        ...
        if (this.player.isGoo())
            this.outx(
                ", leaving traces of your slimy lust along her body for her to wear, allowing your detached bits of mass to ignite her sexual fires"
            );
        this.outx(".");
        this.outx(
        ...
        this.outx(
            "\n\nSimply dragging your " +
                this.cockDescript(x) +
                " along the entrance her of moist pussy causes her to moan and wiggle under you. Parting her pink little lips with the head of your cock, you finally hit the sweet spot for penetration. With "
        );
        if (this.player.cor < 75) this.outx("a gentle amount of force, ");
        else this.outx("an uncaring, brutish amount of force, ");
        this.outx(
            "you push past the tight opening of Phylla's folds.  You hear Phylla inhale sharply as she stretches to accommodate your width. In what seems to be a prolonged amount of time, you finally manage to ease the head of your " +
                this.cockDescript(x) +
                " into her.  The act takes a loud and pained turn as Phylla moans and shifts in obvious discomfort.  You feel her squeeze her vaginal walls tightly around your cock as her considerable strength almost cuts off blood flow.  After a moment, Phylla realizes how much pressure she's exerting and her body relaxes, realizing the potential for injuring her partner.  Sighing heavily, she moves her hips down to take even more of you in. As you slide further in, her eyes flash with pain as she bites down on her lip, it becomes glaringly clear that something has yielded inside of Phylla."
        );
        ...
        if (this.player.cor < 75)
            this.addButton(0, "Next", this.phyllaFirstTimePureBabiesFuckEnding);
    ...
    private phyllaFirstTimePureBabiesFuckEnding(): void {
        ...
        this.outx(
            "For a while, you allow Phylla to slowly adapt to your presence inside of her and the stretching of her vaginal walls; something she reacts to with soft moans of pleasurable appreciation.  She wears her obvious discomfort at being forcefully stretched by your " +
                this.cockDescript(x) +
                ", but you see she can hardly complain as her body cradles yours in an attempt to keep you where you are.  Once you feel she's comfortable you start slowly pumping away at her, gradually building your own rut."
        );
        this.outx(
        ...
        if (this.player.cumQ() >= 100 && this.player.cumQ() < 1000)
            this.outx(
                "  Truly amazing considering how much your loads usually contain.  You think you see a little bulge in her stomach that wasn't there before."
            );
        // If cum milliliters over 1000:
        else if (this.player.cumQ() >= 1000)
            this.outx(
                "  As you look down at her nethers your mind struggles to understand just how she could... then looking up her body, you see.  Her belly is bloated with your sperm, almost to the point of already looking pregnant."
            );
        ...
        if (this.player.canOvipositSpider()) {
            ...
            if (this.player.inte / 20 + AntsScene.rand(20) + 1 < 16) {
                // Persuasion failure:
                this.outx(
                ...
                if (this.pregnancy.isPregnant)
                    this.outx(
                        "  I just can't hold anything else inside me. I'm sorry! Please don't be mad... I mean I will!  Just a-after... this batch..."
                    );
            ...
            // Persuasion success:
            {
                ...
                if (this.player.cor >= 75)
                    this.outx(
                        "  Little does poor Phylla know, you're going to just use her as a baby maker to ease the tension of your own sacks."
                    );
                this.outx(
    ...
    private phyllaCorruptMascEnding(): void {
        this.clearOutput();
        this.outx(
            'For a few moments longer, you pump yourself hard against her rump in an attempt to "break" your new fucktoy in.  Once you\'re satisfied that she will be able to handle what is to come, you take to sliding yourself along against her fuckhole as you grab her by the hair.  The backside of her abdomen grinds along your '
        );
        if (this.player.tallness >= 72) this.outx("chest");
        else this.outx("belly");
        this.outx(
            ", but it will only serve to help you.  You will need a brace for what you're about to pull and her rigid abdomen will do just fine.  Phylla makes a confused noise, glancing over her shoulder with a look of concern growing on her face."
        );
        this.outx(
        ...
        if (y >= 0) {
            ...
            if (this.player.cockTotal() > 2) this.outx("one of your free cocks");
            else this.outx("your free cock");
            this.outx(" against her tight ass. Feeling this new intruder, she turns back to you.");
            this.outx(
        ...
        if (this.player.cockTotal() > 1) this.outx("s twitch, ");
        else this.outx(" twitches, ");
        this.outx("ushering forth your corrupted seed into her womb");
        if (y >= 0) this.outx(" and her ass.");
        else this.outx(", and onto the bedspread below.");
        this.outx("  As her pulsing cunt works to suck the semen out of your ");
        if (this.player.balls > 0) this.outx("balls");
        else this.outx("shaft");
        this.outx(
            ", Phylla retaliates with her own orgasm, flooding your groin with her sticky girl cum.  You glance down to your joined nethers and find a massive amount of Phylla's cum has pooled around your knees and more seems to be flowing every second.  Clearly, she's a squirter."
        );
    ...
    private cuntmuffinLingusPhyllaDickBig(): void {
        this.clearOutput();
        this.outx(
            "Sadly, as you gaze down at your " +
                this.multiCockDescriptLight() +
                ", you realize that trying to penetrate Phylla with your freakishly large prick"
        );
        if (this.player.cockTotal() > 1) this.outx("s");
        this.outx(
            " isn't going to work.  Phylla's eyes begin to tear up as she also comes to the realization that her first time is a non-starter."
        );
        this.outx(
        ...
        this.outx(
            '\n\n"<i>W-What are you doing?</i>" she asks, somewhat upset that she won\'t be getting the traditional first time sex.  Arcing your ' +
                this.multiCockDescriptLight() +
                ", you "
        );
        // Dick Size Over 48 but Under 69 inches:
        if (this.player.longestCockLength() < 69) {
            this.outx("angle your hips so that ");
            if (this.player.cockTotal() == 1) this.outx("it points");
            else this.outx("they point");
            this.outx(" at the ceiling, placing them out of the way for what you have in mind.");
        }
        // Dick size Over 70 inches::
        else {
            this.outx("angle your hips so that ");
            if (this.player.cockTotal() == 1) this.outx("it is");
            else this.outx("they are");
            this.outx(" aimed out the doorway.");
        }
        this.outx(
            "  You wickedly beckon Phylla over to you with a hooked finger.  Phylla looks at you quizzically for a moment before it dawns on her.  Her eyes widen and cooing she scrambles over to you."
        );
        ...
        if (this.player.cockTotal() == 1) this.outx(" switches and bobs");
        else this.outx("s switch and bob");
        this.outx(", loudly brushing against the ");
        if (this.player.longestCockLength() < 69) this.outx("ceiling");
        else this.outx("wall in the hallway");
        this.outx(".");
        this.outx(
        ...
        if (this.player.tongueType == TONUGE_SNAKE)
            this.outx(
                "  You run the split of your forked mouth muscle from the tip of her clit to the base.  As your textured feeler makes its way down, you wrap around the rest of her long clitorus, like a boa constrictor.  Once your split reaches the hood of her clit you roll and flick the tip of your tongue rapidly.  Pulling at your hair she gasps for breath in between teeth grinding moans."
            );
        this.outx(
        ...
        this.outx(
            "\n\nAt this rate it won't be long before she reaches her peak, so you might as well make the finish one to remember.  Driving your fingers against her clit and teasing her labia you begin to rub at a lightning pace.  Phylla almost instantly loses her balance and stumbles backwards onto your " +
                this.multiCockDescriptLight()
        );
        if (this.player.isGoo()) this.outx(", tumbling out of your mass as she tears free");
        this.outx(
            ".  She holds one of her hands out in an attempt to catch her breath.  Ignoring her, you dive in and continue your unrelenting assault as her legs twitch uncontrollably over your head, like a dog having its stomach petted.  Screaming out, Phylla seemingly sputters a garbled string of nonsense until she takes your head in a vice like grip between her thighs.  Feeling her vaginal muscles convulse and tighten on your tongue you notice the signaling of climax.  With one final body contracting pulse Phylla arches her back and roars in orgasmic bliss.  You open your mouth in eager anticipation as her orgasm washes over you.  Her girl cum seems almost never ending as pulse after pulse of it squirt out of her.  You swallow at least two mouthfuls before turning your head, only to feel more splash on your cheek.  Still holding you firmly in between her legs, your Ant Morph lover continues to grind and spurt out juices all over your [face]."
        );
        this.outx(
        ...
        if (this.player.cockTotal() > 1) this.outx("s");
        this.outx(
            ' and pants heavily, having just gone through the equivalent of an orgasm triathlon.  As you sigh, you can hear her giggle in what sounds like disbelief.  "<i>Heh... I didn\'t think I had it in me to do... that,</i>" she coos, staring mischievously up at you.  "<i>Just... could you shrink '
        );
        if (this.player.cockTotal() == 1) this.outx("this monster");
        else this.outx("these monsters");
        this.outx(
            " down?  I mean, I'm not complaining!  But I... just... I mean... you... inside me,</i>\" she shyly remarks, obviously wanting something more... traditional."
        );
    ...
    private femalePhyllaFirstFuckGooooo(): void {
        this.clearOutput();
        this.outx(
            "Eager to get to some good old fashion fun, you direct your thoughts to Phylla, telling her to 'remove her clothing'.  After all of the pieces of her royal attire are removed, she closes in and rubs her naked body against yours.  Her fingers move fluidly as she slowly traces her ever hardening nipples along your chest and along the ridges of your back, sending a sensual chill up and down your spine.  Your " +
        ...
        if (this.player.lactationQ() > 250)
            this.outx(
                '\n\nYou can feel her suck some of the milk from your breasts, slating her weak thirst in the process as she becomes immensely aroused at the sensation of "nursing" from her lover\'s ' +
    ...
    private girlFiller(): void {
        ...
        this.outx(
            '"<i>I-I\'ve... never,</i>" she stammers, but you just want her to experience this before she ruins the moment.'
        );
        this.outx(
    ...
    private femalePhyllaFirstTimePlusCock(): void {
        ...
        if (this.player.smallestCockArea() > this.phyllaCapacity()) {
            // Dicks too Big:
            this.outx(
                "\n\nDespite your best efforts to try and get into a comfortable position to scissor, your painfully erect  " +
                    this.multiCockDescriptLight() +
                    " prevent you from doing so, given that they are now compressed against the ceiling.  While the display of rainbows is pretty to watch on your " +
                    this.multiCockDescriptLight() +
                    ", the crushing pain and the unyielding nature of your " +
                    this.multiCockDescriptLight() +
                    " is too much.  "
            );
            ...
            if (this.player.isTaur())
                this.outx(
                    "Seeing your impending predicament, Phylla quickly scrambles with all four of her arms to collect a bunch of cushions.  She stacks them in a makeshift 'resting place' and helps you into a comfortable position as your cocks precede to grow uncontrollably."
                );
            // Drider body:
            else if (this.player.isDrider())
                this.outx(
                    "Phylla immediately realizes this, and flips you over so that you are resting on your head and neck, ducking in past your " +
                        this.multiCockDescriptLight() +
                        " and coming to rest on the border between your spider carapace and soft clit."
                );
            // Goo body:
            else if (this.player.isGoo())
                this.outx(
                    'Phylla immediately realizes this, and flips you over so that you are resting on your head and neck, and she works her way through your goopy mass, connecting her clit with yours in little time or effort. "<i>This is a little weird... but I like it...</i>" she flirts. Hardening your mass slightly, you snugly secure Phylla against your body, telling her that things "might" get rough.'
                );
            // Human/Harpy/Naga legs:
            else
                this.outx(
                    "Phylla immediately realizes this, and flips you over so that you are resting on your head and neck, and curls your [legs] towards her."
                );

            this.outx(
                "  Your " +
                    this.multiCockDescriptLight() +
                    " now resting comfortably out of the open room, Phylla positions herself to scissor your pussy."
            );
            this.outx(
        ...
        // If PC has an appropriately sized dick(s):
            ...
            this.outx(
                '\n\n[EachCock] hungers for attention, having been let go by Phylla when you shifted into a scissoring position.  Reaching down to start taking care of yourself; Phylla interrupts you abruptly.  "<i>Oh, I\'m sorry! I mean... I forgot... just feels... so gooood,</i>" she coos between moans of ecstasy.  After a moment she seems to forget as waves of pleasure wash over her.  You make a playful throat clearing noise and gesture to your ' +
                    this.multiCockDescriptLight() +
                    ".  Phylla quickly snaps back into reality and takes hold of "
            );
            // Tentacle dick check
            if (this.player.tentacleCocks() > 0) {
                // PC has (a) Tentacle dick(s):
                this.outx("your tentacle dick");
                if (this.player.tentacleCocks() > 1) this.outx("s");
                this.outx(
                    ".  Clearly she's never seen anything like it before as she doesn't know what to do.  Laughing, you tell Phylla she doesn't need to do anything except hold still.  You snake your tentacle cock"
                );
                if (this.player.tentacleCocks() > 1) this.outx("s");
                this.outx(
                    ' up her body, making sure to caress her most tender places on their way.  She screams out loudly in shock only to realize what happened when she looks down.  "<i>God, you scared me!</i>" she yells, embarrassed that she got frightened half to death by your dick'
                );
                if (this.player.tentacleCocks() > 1) this.outx("s");
                this.outx(".  Laughing at her display, you motion to your prick");
                if (this.player.tentacleCocks() > 1) this.outx("s and wiggle them ");
                else this.outx(" and wiggle it ");
                this.outx(
                    'in front of her, like a worm to a bird in her face.  "<i>Aw, does someone need some attention?</i>" Phylla teases, taking '
                );
                // PC has:
                // one tentacle dick:
                if (this.player.tentacleCocks() == 1)
                    this.outx(
                        "your cock into her mouth as she continues to rock her hips into yours."
                    );
                // two:
                else if (this.player.tentacleCocks() == 2)
                    this.outx(
                        "your cocks into her mouth and between her breasts as she continues to rock her hips into yours."
                    );
                else
                    this.outx(
                        "your cocks into her mouth, between her breasts, and along her body.  The ones on her body tightly wrap around her insectile joints, using her muscular curves to get you off."
                    );
                ...
                if (
                    this.player.cockTotal() == 2 &&
                    this.player.cockArea(this.player.smallestCockIndex2()) +
                        this.player.cockArea(this.player.smallestCockIndex()) <=
                        this.phyllaCapacity()
                )
                    this.outx(
                        "two of your " +
                            this.multiCockDescriptLight() +
                            ", stroking them apologetically as she scissors you.  You feel her almost insatiable appetite for all parts of your body.  You feel Phylla's mind slowly becoming lost in pleasure."
                    );
                // TODO: "player.cocks[player.smallestCockIndex()] < 4" changed to cockLength. Not sure if it is the appropriate attribute.
                    ...
                    this.outx(
                        "your " +
                            this.cockDescript(this.player.smallestCockIndex()) +
                            ", stroking it apologetically as she scissors you.  You feel her almost insatiable appetite for all parts of your body.  You feel Phylla's mind slowly becoming lost in pleasure."
                    );
                // PC only has a dick(s) that('s) (are) more than 4 inches in width:
                    ...
                    this.outx(
                        "your " +
                            this.cockDescript(this.player.smallestCockIndex()) +
                            ", but she simply can't fit any number of her hands around the entirety of your glans; instead, she takes to caressing the head of your " +
    ...
    private getAntWaifuYoShit(): void {
        this.clearOutput();
        this.outx(
            "You smile at her and tell her you would love for her to join you at your camp.  Her face brightens like the sun and she quickly gathers the very few possessions she owns - mostly clothing, the pillows, and some jewelry.  Together you promptly leave the colony and head back to camp."
        );
    ...
    private bumpIntoTheAntColonyAfterStayHomePhylla(): void {
        this.clearOutput();
        this.outx(
            "You make your way down a strangely familiar path that leads to Phylla's room.  Her head quickly snaps around upon seeing your shadow in her doorway."
        );
    ...
    public introductionToPhyllaFollower(): void {
        ...
        if (this.flags[kFLAGS.PHYLLA_EGG_LAYING] == 0)
            this.addButton(2, "Lay Eggs", this.phyllaLaysEggsToggle);
        else this.addButton(2, "No Eggs", this.phyllaLaysEggsToggle);
        if (this.flags[kFLAGS.ANT_KIDS] > 0)
            this.addButton(3, "Children", this.phyllasKidsChildren);
    ...
    private phyllaSexMenu(): void {
        ...
        if (this.player.hasCock()) {
            ...
            if (this.flags[kFLAGS.PHYLLA_EGG_LAYING] > 0 && this.flags[kFLAGS.ANT_KIDS] >= 10)
                this.addButton(1, "Fuck Her", this.dudesFuckEggLayingBitches);
            if (this.flags[kFLAGS.ANT_KIDS] > 10 && this.player.cor >= 75)
                this.addButton(3, "Orgy (Male)", this.orgyWithDatColonyCorruptDudes);
        }
        ...
        if (this.player.hasVagina()) {
            ...
            if (this.flags[kFLAGS.PHYLLA_EGG_LAYING] > 0 && this.flags[kFLAGS.ANT_KIDS] >= 10)
                this.addButton(2, "Lesbian Sex", this.birfingSexWithAntsForDasLadies);
            // Orgy w/ Colony (Female)
            // You tell Phylla you're interested in 'inspecting' your children.
            if (this.flags[kFLAGS.ANT_KIDS] > 10 && this.player.cor >= 75)
                this.addButton(4, "Orgy (Female)", this.antColonyOrgy4Ladies);
        }
    ...
    private talkAboutAntHistory(): void {
        ...
        this.outx(
            "You relax on one of the many available pillows and ask Phylla about her race's history. She pulls a pillow up next to yours and cuddles in.  \"<i>It's not a very happy story, are you sure you want to hear it?</i>\" You nod and move your hand to hold one of hers."
        );
    ...
    private talkAboutAntMatingAndRituals(): void {
        this.clearOutput();
        this.outx(
            "You've always wondered how Phylla can project thoughts and images of her life into your mind. Seeing as how she's not busy, you ask her about it.  She tilts her head, trying to think of a way to explain it.  You can see this is taking some thought as she stays silent for almost a minute."
        );
        this.outx(
        ...
        if (this.flags[kFLAGS.PHYLLA_TIMES_DRIDER_EGG_LAYED] > 0)
            this.outx(
        ...
        // If corruption more than 60:
            ...
            if (this.player.cor >= 80) {
                ...
                if (this.flags[kFLAGS.PHYLLA_EGG_LAYING] > 0)
                    this.outx(", sending jets of milk shooting out onto the floor");
                this.outx(
                    ".  With a loud moan she orgasms, covering her smaller two forearms, her inner thighs, and the floor below her in thick, sweet-smelling, girl cum."
                );
    ...
    private phyllasLifePastAndFuture(): void {
        ...
        if (kGAMECLASS.izmaScene.izmaFollower() && this.flags[kFLAGS.PHYLLA_IZMA_TALK] == 0) {
            ...
            this.outx(
                "Phylla seems to be a little distant today as you sit down to talk.  You point it out to her and she cautiously asks about Izma."
            );
            this.outx(
            ...
            this.outx(
                "You take a seat on one of the many fluffy cushions in her room and she proceeds to cuddle in close, pressing her head against your chest and wrapping her abdomen around you.  She then looks up at you and asks what's on your mind."
            );
            this.outx(
    ...
    private phyllaBeeeJays(): void {
        ...
        // Subsequent Blowjobs:
            ...
            this.outx(
                "Approaching Phylla, you cross your arms and lean against the wall of her bedchamber while sporting a tell-tale tent in your pants.  Phylla stares down at your bulge and picks up immediately on your intentions."
            );
            this.outx('\n\n"<i>Y-You gonna ask me nicely, or let your penis');
            if (this.player.cockTotal() > 1) this.outx("es");
            this.outx(
                ' do all the convincing?</i>"  She teases.  Shrugging, you inform her that whatever works for her works for you.'
            );
        }
        // Continued...
        // If Phylla is not Laying Eggs:
        ...
        if (this.player.cockArea(x) < 60) {
            this.outx(
                "\n\nWithout even having to utter a word, Phylla jumps right in and starts to work your " +
                    this.multiCockDescriptLight() +
                    " free of "
            );
            ...
            if (this.player.cocks[x].cockLength < 5)
                this.outx(' "tall" and proud, rock hard and ready for action.');
            else this.outx(" tall and proud, rock hard and ready for action.");
        } else {
            // Dick size more than 60 inches (First Time):
            if (this.flags[kFLAGS.PHYLLA_BLOWJOBS] == 1) {
                this.outx("\n\nPhylla jumps in to tug and free your member");
                if (this.player.cockTotal() > 1) this.outx("s");
                this.outx(" from your pants, but apparently doesn't realize just how big ");
                if (this.player.cockTotal() == 1) this.outx("this");
                else this.outx("these");
                this.outx(" battering ram");
                if (this.player.cockTotal() > 1) this.outx("s");
                this.outx(
                    " can get.  Chuckling at her ignorance, you tell Phylla she'd better back up.  Phylla rolls her eyes and looks up at you, giving you an unamused look."
                );
                ...
                this.outx(
                    "\n\nYou work to release yourself from your clothing.  Once you're completely free you watch as Phylla's eyes widen in horror.  Smiling, you start to stroke your " +
                        this.multiCockDescriptLight() +
                        " and work "
                );
                if (this.player.cockTotal() == 1) this.outx("it");
                ...
                this.outx(
                    ' up to a full raging erection, achieving your maximum state of "<i>readiness</i>" in no time at all.'
                );

                this.outx(
                    "\n\nDumbfounded, Phylla stares in awe at how big your " +
                        this.multiCockDescriptLight() +
                        " can really get; you can see the look of complete intimidation on her face and who could blame her?  You've seen ship cannons that pale in comparison to your man meat."
                );
                // If multiple cocks:
                if (this.player.cockTotal() > 1) {
                    this.outx(
                ...
                this.outx(
                    '\n\n"<i>I don\'t know if I can... wow...</i>" She sputters out.  Laughing out loud, you grin down at her and inform her that, in this instance, her slight ignorance IS bliss.  Twitching the muscles in your ' +
                        this.multiCockDescriptLight() +
                        ' to bob a bit in her face you let her know that you rose to the challenge; now it\'s time for her to "<i>fulfill</i>" her end of the bargain: the cock end that is.'
                );
            }
            // Dick size more than 60 inches (subsequent blowjobs):
                ...
                if (this.flags[kFLAGS.PHYLLA_BLOWJOBS] == 2) this.outx("last time");
                else this.outx("our first time");
                this.outx(".  I'll help to free ");
                if (this.player.cockTotal() == 1) this.outx("that monster");
                else this.outx("those monsters");
                this.outx(
                    ', but p-please be careful about my valuables.</i>"  Phylla asks nervously.'
                );
                this.outx(
                    "\n\nYou tell her that as long as she's helping, there shouldn't be any \"<i>accidents.</i>\"  With synchronous effort, your hulking " +
                        this.multiCockDescriptLight() +
                        " "
                );
                ...
                this.outx(
                    ' freed once more, ready and raring to "re-acquaint" with Phylla.  Taking the hint, Phylla closes in and takes the '
                );
                // Dick size less than 16 inches:
                if (this.player.cocks[x].cockLength < 16) this.outx("base");
                else this.outx("middle");
                this.outx(
                    " of your shaft against her tongue.  You hear a mix of a giggle and hum as she drags her tongue towards the head of your " +
                        this.cockDescript(x) +
                        ".  Phylla teases your shaft as she reaches the peak and suckles at your urethral opening.  You feel her drawing up as much pre-cum as she can and lapping it up like she's dying of thirst.  She continues this for a bit, until it becomes apparent that she's either not too sure of what else to do, or that she's never heard of how to properly fellate someone."
                );
                this.outx(
                    "\n\nWith a chuckle, you pull your " +
                        this.cockDescript(x) +
                        ' away from her mouth and ask her to look up at you. Clearly embarrassed at your realization of her skills, she begins to tremor softly.  "<i>S-sorry! I mean, I\'ve never done this!  This act is uncommon for my people.  Such things are not proper for a queen to be...  taught, or learn.</i>"  She apologizes, begging your forgiveness with her body language and demeanor.'
                );
            }
        }
        this.menu();
    ...
    private purePhyllaBJOver(): void {
        ...
        this.outx(
            "\n\nHappy and secure that you're willing to tolerate her lack of experience, Phylla lowers herself back down to your " +
                this.cockDescript(x) +
                " and gives you a tender lick on your head, slurping in all the pre-cum you've been accumulating.  You opt to help her with a more direct approach; you lower your hand down to her chin and tilt her head up so her eyes meet yours.  The tension in Phylla's jaw is fierce, and you tell her that she's putting too much thought and effort into this: just relax. You move your thumb over her lips and part her mouth slightly.  A calm washes over her as your directive registers."
        );
        this.outx(
            "\n\nPeacefully, you tell her to open her mouth just a bit and to let your " +
                this.cockDescript(x) +
                " slide into her mouth, advising her to watch the teeth.  Once she's got it in there, you tell her she can massage your head with her tongue and lips to begin with.  Eventually she'll work her way up to experimenting with the interior of her mouth.  Then once she gets that down, she can take you into her throat, but that's a more 'advanced technique.'"
        );
        this.outx(
            "Taking your directions, Phylla takes the head of your cock along the top of her wet and humid tongue, leisurely batting around before trapping it with her lips."
        );
        ...
        if (this.player.cockTotal() > 1) {
            ...
            else this.outx("the rest of your dicks");
            this.outx(
                '; if she would be "<i>so kind.</i>" With gusto, her four hands shoot up and take your '
            );
            if (this.player.cockTotal() == 2) this.outx("cocks into their firm grips");
            else this.outx("cock into their firm grips");
            this.outx(
                ".  Phylla mumbles something but absentmindedly realizes she still has your cock in her mouth and gives up on whatever it was she was trying to say."
            );
        }
        // Vagina:
        if (this.player.hasVagina()) {
            this.outx(
                "\n\nYou ask Phylla if she can take care of your womanhood while she's at it.  Phylla moves one of her small arms in between your legs and rubs against your " +
                    this.clitDescript() +
                    ".  She caresses your labia in between her fingers before inserting them inside of you.  Phylla begins working her wrist diligently in conjunction with her head bobbing."
            );
        }
    ...
    private nopeNotOnMouthOrWhateverFuckThisNoise(): void {
        this.clearOutput();
        this.outx("You pass on her offer, not wanting to know what THAT sensation");
        // If PC can't Autofellatio:
        if (!this.player.canAutoFellate()) this.outx(" or anything like it would feel like.");
        else this.outx(" feels like with Phylla's mind linked to your own.");
    ...
    private pureBJEnding(linked = true): void {
        ...
        if (!linked) this.outx(".");
            ...
            this.outx(
                "leading to you jesting through the link and calling her a damn dirty cheater."
            );
        }
        if (this.flags[kFLAGS.TIMES_LINKED_BJ_SUCK] > 0)
            this.outx(
        ...
        if (this.player.cumQ() < 250) this.outx("thin");
        else if (this.player.cumQ() > 1000) this.outx("thick");
        this.outx(" strands of cum hang wildly between her lips and your prick.");
        // If cum volume over 1000ml::
        if (this.player.cumQ() > 1000)
            this.outx(
                "  Though she might have a mouthful, you're not finished yet!  You continue to unload the remainder of your hot load on her breasts and stomach."
            );
        if (this.player.cockTotal() > 1) {
            // If multi cock::
            this.outx("  Your other cock");
            if (this.player.cockTotal() > 2) this.outx("s shower");
            else this.outx(" showers");
            this.outx(" her hands and body in your white goo as she continues to pump ");
            if (this.player.cockTotal() == 2) this.outx("on each of ");
            this.outx("them lovingly.");
        }

        this.outx("\n\nWith a heavy sigh, and significantly lighter ");
        if (this.player.balls > 0) this.outx("balls");
        else this.outx("in the pelvis");
        this.outx(", you rub Phylla's hair playfully");
        if (this.flags[kFLAGS.PHYLLA_BLOWJOBS] != 1) this.outx(".");
        // If first time:
        else this.outx(" and congratulate her on her first time.");
    ...
    private corruptPhyllaEndings(): void {
        ...
        this.outx(
            "\"<i>A slut that can't suck a dick... how can this get any worse?</i>\"  You ponder to yourself while rubbing your nasal bridge. You tell the innocent little ant that she'll learn how to suck a mean cock, even if it kills her.  You're knee deep at this point - might as well turn her into something salvageable.  Commanding her attention, you lift her face up and hover your " +
                this.cockDescript(x) +
                " close to her lips, smothering her lips with your precum.  She attempts to turn away but you react before she can.  Holding her head in place you comment on how this is what you want from her."
        );
        this.outx(
        ...
        // If first time:
        if (this.flags[kFLAGS.PHYLLA_BLOWJOBS] == 1) this.outx("achieved the desired effect.");
        // Every other time:
        else this.outx("improved since the last time.");
        ...
        this.outx(
            "\n\nPhylla groans at the rough treatment, not used to being treated so coarsely as your " +
                this.cockDescript(x) +
                " lunges back and forth in her mouth, grinding along her cheek and tongue. Your cock seems to have a mind of its own as you somehow manage to wrap her tongue around yourself, knowing full well Phylla lacks the technique required to do it on her own.  The little queen is about to receive a rude awakening about pleasing her master."
        );
        this.outx(
            "\n\nMoan after muffled moan escapes from Phylla's mouth as you continue your callous fucking of her delicate little face.  Your little slut is trying her best to keep up with your thrusts but is ultimately failing.  Perhaps she needs a little motivation?  Withdrawing your " +
                this.cockDescript(x) +
                ", you tell her she doesn't get to suck your dick anymore unless she fingers her tight little hole. Desperate to fulfill your desires, she quickly darts a hand to her pussy and fingers that little fuckhole like her life depends on it.  Within seconds you see her long clit protruding, begging to be touched."
        );
        ...
        if (this.player.cockTotal() > 1) {
            ...
            this.outx(
                ' if she would be "<i>so kind</i>".  With gusto, her four hands shoot up and take your cocks into their firm grips.  Phylla mumbles something but absentmindedly realizes she still has your cock in her mouth and gives up on whatever it was she was trying to say.'
            );
        }
        // Vagina:
        if (this.player.hasVagina()) {
        ...
        if (this.player.cumQ() < 10) this.outx("tiny");
        else if (this.player.cumQ() < 100) this.outx("respectable");
        else this.outx("massive");
        this.outx(" facial, covering her petite features in cum.");
        ...
        if (this.silly()) {
            ...
            this.outx(
                ".  Somehow, you succeed your fortitude roll and remain conscious without passing out even after plummeting to the ground from sheer exhaustion.  You and Phylla can't help but slowly drift off to sleep in a pool of your cum to dream about the bizarre pleasures you two have indulged in."
            );
        }
        ...
        if (!this.silly()) {
            this.outx(
                "\n\nPhylla works your " +
                    this.cockDescript(x) +
                    " the entire time you cum, as if pleading for just a little more to come out.  You grab her hands, signaling you've have just about enough.  Coming down from your climax, you thank your slut for the oral and sit down on the bed and start gathering your scattered clothing."
            );
            this.outx(
    ...
    private dickPhylla(): void {
        ...
        if (this.flags[kFLAGS.PHYLLA_BLOWJOBS] == 0) {
            ...
            this.outx(
                "\n\nCutting her off, you gently place your hand on the back of her head as " +
                    this.sMultiCockDesc() +
                    " hardens even further.  With a slight pressure you force Phylla's head down onto the head of [oneCock]. At this point she gets the picture."
            );
        }
        ...
        // 3-4 times:
        if (this.flags[kFLAGS.PHYLLA_FUCKS] >= 3)
            this.outx(" she asks playfully, knowing full well that that's what you came here for.");
        // (First time)
        else if (this.flags[kFLAGS.PHYLLA_FUCKS] == 0) this.outx(" You nod quickly.");
        // (Subsequent fucks)
        if (this.flags[kFLAGS.PHYLLA_FUCKS] > 0)
            this.outx(
        ...
        this.outx(
            "\n\nHer eyes widen in surprise as your " +
                this.cockDescript(x) +
                " fills her.  She howls a blissful scream as she drools forth her girl fluids, coating your cock "
        );
        if (this.player.balls > 0) this.outx("and balls ");
        this.outx("in her sexual liquids.");
        ...
        if (this.player.cockTotal() >= 2 && this.player.cockTotal() <= 5) {
            if (this.player.hasVagina()) {
                ...
                this.outx(
                    "\n\nYou look at Phylla and shrug at her, telling her you aren't sure if you can do that, given that you have some... 'members' that are feeling a little left out.  With a flirty yet annoyed expression,  your lover reaches down and takes hold of your unloved  " +
                        this.multiCockDescriptLight() +
                        ".  She coos as she starts to pump "
                );
    ...
    private lesbianFisting(): void {
        ...
        this.outx(
            "\n\nMoaning loudly into the air, the aroma of earth, sweat, and sex fills your nostrils.  You can't help but feel a little embarrassed to be so fully exposed to her, but that quickly passes as one of her fingers slips along your labia and brushes past the opening of your " +
                this.vaginaDescript() +
                ".  Guided by the wetness of your ever eager pussy, her hard fingertips slide forward into your body.  You moan again at this slow insertion.  Encouraged, Phylla rubs up and down the walls of your vagina, leisurely at first but with mounting vigor, searching for your G-spot."
        );
    ...
    private dudesFuckEggLayingBitches(): void {
        this.clearOutput();
        this.outx(
            "Phylla looks completely taken aback when you suggest you want to have sex with her.  Obviously self conscious about how she looks right now, she covers her enlarged breasts with all four of her hands as she sits back in her seat."
        );
        this.outx(
        ...
        if (this.player.cor < 50)
            this.outx(
                "don't care how she looks right now. Besides, some creatures around here appreciate a little carnal love; it helps with the birthing process."
            );
        // If Corruption is more than 50:
        else
            this.outx(
                "could care less for her pathetic attempts at concealing her pregnant form; you're horny, and she's going to put out, regardless of her insecurities."
            );

        this.outx("\n\nYou walk over to her and ");
        if (this.player.cor < 50) this.outx("lovingly");
        else this.outx("apathetically");
        this.outx(
            " pull her hands away from her breasts.  She resists you at first, but once she sees there's no stopping you she shyly resigns herself to you."
        );
        ...
        // (If corruption is more than 50:
        if (this.player.cor > 50) this.outx("\n\n(Oh, great, here we go again...)");
        ...
        if (this.player.balls > 0)
            this.outx(" your balls slap against the smoothness of her pelvis.");
        else this.outx(" your knees grind along the edge of her makeshift throne.");
    ...
    private birfingSexWithAntsForDasLadies(): void {
        this.clearOutput();
        this.outx(
            "Phylla looks completely taken aback when you suggest that you want to have sex with her.  You can tell she is self conscious about the way she looks right now by the way she covers her enlarged breasts with all four of her hands as she sits back in her seat."
        );
        this.outx(
        ...
        this.outx(
            " allowing her to see the sensual swivel of your " +
                this.buttDescript() +
                " from left to right and back again as you visibly entice Phylla's mind to lustful thoughts.  Once you're facing Phylla once again, you see her lower two hands are still covering her breasts and the upper two are gripping the stone chair she sits in."
        );
        ...
        if (this.player.cor < 75) {
            ...
            else if (this.player.statusAffectv1(StatusAffects.Birthed) > 0)
                this.outx(
        ...
        this.outx(
            "\n\nThe smell of earth mixed with her sex and the taste of her milk on your lips is too much.  You dive into her like a sex-crazed animal.  Plowing your face against her love button, you press her outer labia against your lips before taking her tender clit into your lips and wrapping your tongue around it, sucking hard.  Her lower arms take a full grasp of your " +
                this.hairDescript() +
                " as she guides your face, intent on having you eat her deeply sooner rather than later.  Taking your cue, you release your tongue from her clit and move it inside of her and allow the bumpy texture of it to tease and caress her hot fuckhole."
        );
        ...
        if (this.player.cor <= 50)
            this.outx(
                '  You probe her mind and are almost taken aback."<i>NO!  Just please keep going!</i>"  You hear her voice ring out in your head.'
            );
        ...
        if (this.player.cor <= 50) {
            ...
            this.outx(
                "\n\nYou continue your attack on her pussy as she tries desperately to contain her moans of pleasure, causing a muffled echo to ring out in the bedchamber as you slide your tongue in and along her pussy.  She's got to be close to cumming, you think to yourself, and realize you've lost yourself in the moment; your " +
                    this.vaginaDescript() +
                    " has been neglected... perhaps it's her turn to tend to you?  As if you had said it out loud, Phylla eases her grip on your hair and unwraps her legs from behind your head, composing herself before rising to her feet."
            );
            this.outx(
        ...
        // If Corruption is over 50:
            ...
            this.outx(
                "\n\nSensing that she is nearing an orgasm, you pull back and wrestle out from betwixt her legs.  Finally free, you see she's sprawled out on the bed, her massive abdomen hanging off to the side.  Settling yourself over the top of her, you slide your " +
                    this.clitDescript() +
                    " along her nose, intent on getting your scent entrenched in her body, wanting to make her crave your pussy, something that occurs as she takes a long whiff of air and moans like a whore in heat."
            );
        ...
        // EAT PUSSY:
        this.outx(
            "\n\nLike a starving animal, Phylla's mouth waters as she takes hold of your thighs and spreads your legs apart.  You grab hold of her hair and shove her head inbetween your legs, impacting your " +
                this.clitDescript() +
                " and causing you to moan slightly.  She certainly isn't shy now, you think, as her tongue starts to work its way into you.  You can \"<i>hear</i>\" Phylla giggle back in response. Thoughts of grinding your pussy across her mouth and face flood your mind, and instinct takes over as your hips start to rock in response to Phylla's eager attack.  Running your hands through her hair,  you grind Phylla's pretty face harder and deeper into your soaking " +
                this.vaginaDescript() +
                ".  The poor ant can only respond by moaning fiercely as she eagerly sucks and kisses your love button, completely overwhelmed by the desire that has overtaken her."
        );
        ...
        if (this.player.cockTotal() > 0 && this.player.cockThatFits(42) >= 0) {
            ...
            this.outx(", stroking ");
            if (this.player.cockTotal() == 1) this.outx("it");
            else if (this.player.cockTotal() == 2) this.outx("them");
            else this.outx("as many as you can");
            this.outx(" as fiercely as your body will let you.");
        }

        this.outx(
            "\n\nAs you feel your stiff " +
                this.clitDescript() +
                " glide along her lips, you can begin to taste bits of her almost primal hunger for you.  As well, you sense that the growing contractions in her abdomen are getting quicker and stronger."
        );
        ...
        // If Corruption is more than 50:
            ...
            this.outx(
                "\n\nIf she lays an egg before you're done with her, not only will you be furious, but you'll have to scare your kids away.  " +
                    this.player.mf("Daddy", "Momma") +
                    " needs to get " +
                    this.player.mf("his", "her") +
                    " rocks off first before any annoying kids get in the way."
            );
        ...
        this.outx(
            "\n\nYour " +
                this.clitDescript() +
                " comes to rest on her lips again as her head starts to bob between her own strong legs.  Returning the sentiment, you dart in-between her legs, tongue first.  You hit that sweet tasting little pussy of hers with force.  Phylla moans, your intentions crystal clear as she bears down on your pussy hard, intently working for your sexual release.  She reaches up with her lower set of arms and gives both your " +
                this.nippleDescript(0) +
        ...
        if (this.player.cockTotal() > 0 && this.player.cockThatFits(42) >= 0)
            this.outx(
                "\n\nWithout warning, Phylla begins to alternate between giving your " +
                    this.clitDescript() +
                    " oral and sucking your " +
                    this.multiCockDescriptLight() +
                    "; the dual stimulation overwhelms you as she devilishly teases your sexes."
            );
        this.outx(
        ...
        if (this.player.cockTotal() > 0 && this.player.cockThatFits(42) >= 0) {
            ...
            this.outx(
                " against the back of her throat.  Unable to contain the pleasure from this, you howl and blow your hot load into her throat."
            );
        } else if (this.player.hasCock())
            this.outx(
                "\n\nFeeling your own " +
                    this.multiCockDescriptLight() +
                    " about to erupt, you quickly roll off your lover.  Just in time, too - you fire your jizzum up at the ceiling, coating it quite well before your salty load falls back down on top of the two of you."
            );
        ...
        if (this.player.biggestCockArea() >= 500) {
            this.outx(
                "\n\nYour " +
                    this.multiCockDescriptLight() +
                    " twitches with orgasmic release, bulging as your load works its way through your urethra"
            );
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(
                ".  With a heavy heave, you feel the hot and sticky ejaculate launch from your dick, hitting the interior decorations as you do so; what exactly you hit, you can't say... but you'll likely be tripping over your mess on the way out."
            );
        }

        this.outx(
            "\n\nYou struggle to breathe for a moment as a massive amount of warm girl cum seems to flood from Phylla's vagina to completely cover your face and soak most of your " +
                this.hairDescript() +
                ".  While you catch your breath, you can hear Phylla noisily slurping up your fluids before compressing her face against your " +
                this.clitDescript() +
                " in an eager effort to lather her face in your juices for just a little longer.  Contentment and fulfilled desire - not only your own, but Phylla's as well - spreads like wildfire through your brain.  You grin to yourself, satisfied at the effect you've had on Phylla during your session."
        );
        ...
        if (this.player.cor < 75) {
            ...
            if (!this.player.findPerk(PerkLib.SluttySeduction))
                this.outx(
    ...
    private orgyWithDatColonyCorruptDudes(): void {
        ...
        this.outx(
            "You tell Phylla to call in your strongest and most virile children for 'inspection.'"
        );
        ...
        if (this.flags[kFLAGS.PHYLLA_EGG_LAYING] > 0) this.outx("large, lactating ");
        ...
        if (this.player.cockTotal() > 1 && this.player.cockTotal() <= 3) {
            ...
            else this.outx("s are");
            this.outx(
                " getting sucked off by two of your children, who themselves are being sucked off."
            );
        }
        // If player has four-6 six dicks:
        if (this.player.cockTotal() >= 4 && this.player.cockTotal() <= 6)
            this.outx(
        ...
        this.outx(
            "\n\nWhen you've felt your mind completely sync up with everyone else in the room, it's like being drunk on sexual euphoria.  You almost lose yourself in it for a moment, but focusing your mind, you snap your eyes open. You see Phylla in front of you looking like a drugged slut; she runs all four of her hands over your " +
                this.cockDescript(x) +
                " at the entrance of her flooded cunt while her children play with her nipples and suck each other off.  Aggressively, you grab her arms and pin her down while simultaneously shoving your cock into her."
        );
        ...
        this.outx(
            "\n\nOne of your brood leans down and starts to feverishly lick the base of Phylla's clit as your cock slides in and out of her. His warm saliva coupled with Phylla's natural lubricant warms your cock and sends even more pleasure throughout your " +
                this.cockDescript(x) +
                "."
        );
        ...
        if (this.player.cockTotal() > 1) this.outx("s");
        this.outx(
            " sucked, stroked, inserted, and finally orgasming so many times that you lose track. Hours pass and you eventually pass out sitting atop Phylla's throne watching the writhing mass before you."
        );
    ...
    private antColonyOrgy4Ladies(): void {
        ...
        if (this.flags[kFLAGS.TIMES_CORRUPT_FEMALE_ANT_ORGY] == 1) {
            this.outx(
                "She gives you a confused look, but does as you command. Tilting her head back and closing her eyes you watch as she silently 'communicates' to her children."
            );
            this.outx(
        ...
        if (this.player.isBiped())
            this.outx("  Setting one foot on his shoulder, you present your [vagina] to him.");
        else this.outx(" Now at the perfect height, you present your [vagina] to him.");
        this.outx(
        ...
        if (this.player.isBiped()) this.outx(" from between your legs.");
        else this.outx(" from your cunt.");
        this.outx("  You beckon him to follow you as you strut over to where Phylla is.");
        this.outx(
        ...
        if (this.player.hasCock()) {
            this.outx("  You feel hands run up and down your shaft");
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(", causing you to spurt bursts of pre all over the floor.");
        }
        this.outx(
        ...
        if (this.player.hasCock()) {
            this.outx(
                "  Not forgetting you have 'other needs' the ant mounting you reaches down with his larger arms and grabs hold of [eachCock].  Keeping his smaller arms on your hips to keep stable with each thrust, he pumps vigorously at your cock"
            );
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(".");
        }
        ...
        if (this.player.cockTotal() > 0) {
            ...
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(".  You feel your load");
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(" splash into your [chest] and chest as ");
            if (this.player.cockTotal() == 1) this.outx("it");
            else this.outx("they");
            this.outx(" unload.");
        }
    ...
    private phyllaLaysEggsToggle(): void {
        ...
        if (this.flags[kFLAGS.PHYLLA_EGG_LAYING] == 0) {
            ...
            this.outx(
                "Phylla seems confused as to what you're thinking as you gaze deeply into her eyes.  You gather all four of her hands between the two of yours and tell her that children are wanted.  Not just one or two; you want as many as she can muster."
            );
            // If you've talked to her about history:
            if (this.flags[kFLAGS.TALKED_WITH_PHYLLA_ABOUT_HISTORY] > 0)
                this.outx(
                    "  You tell her you want a colony like those she spoke of in the times before the corruption."
                );
        ...
        // (Stop Laying Eggs)
            ...
            this.flags[kFLAGS.PHYLLA_EGG_LAYING] = 0;
            this.outx(
                "You sigh to yourself; you never really wanted this conversation but you knew it might happen someday.  You make a stern face and put a determined fatherly tone in your voice.  Phylla immediately senses you mean business and you have her full attention.  You try to tell her as gently as possible that you don't think it is safe for her to keep having children."
            );
    ...
    private lickThatAntButt(): void {
        this.clearOutput();
        this.outx(
            "You tilt your head slightly.  You thought she said she could start to lay any time after the first time you had sex with her."
        );
    ...
    private dontLickAntButt(): void {
        ...
        if (this.flags[kFLAGS.ANT_KIDS] > 1)
            this.outx("; the children can tend to the eggs and I can really use the rest");
        this.outx(
            ".  You should get back to your duties...  B-but I wouldn't mind if you came back later...</i>\""
        );
    ...
    private phyllaLaysSomeDriderEggs(): void {
        ...
        if (this.player.cor < 75) {
            ...
            if (this.flags[kFLAGS.PHYLLA_EGG_LAYING] > 0)
                this.outx("both eggs are just fine on their own");
            else this.outx("the egg is just fine on its own");
            this.outx(
                ", you redirect your focus to helping Phylla through the labor.  Each subsequent egg that finds its way to freedom causes Phylla's once pain filled screams to turn into pleasurable moans of euphoric delight as her pussy becomes overwhelmed by the stimulation of each of your eggs working their way out.  At long last, the final egg slithers out of her vagina and lands gently on the bedding.  Her ordeal over, Phylla breathes a long sigh of relief."
            );
            // First Time:
            if (this.flags[kFLAGS.PHYLLA_TIMES_DRIDER_EGG_LAYED] == 0)
                this.outx(
        ...
        this.flags[kFLAGS.PHYLLA_DRIDER_BABIES_COUNT] += 5 + AntsScene.rand(4);
    }
    ...
    private driderDoublePhllaMount(): void {
        this.clearOutput();
        this.outx(
            "No longer able to control yourself, you rip free of your [armor] and charge up to Phylla's bed, catching her by surprise as she looks up at you.  With a seductive smile, you pin her down and slather your ovipositor against her fuck hole."
        );
        this.outx(
    ...
    private letPhyllaRecover(): void {
        this.clearOutput();
        this.outx(
            "Working up all of your self control, you decide that Phylla could use the rest.  You wink at Phylla as you leave, telling her that you'll be back to fuck her brains out shortly... once she feeds your children.  She only musters the strength to smile and mutter something about motherhood but you're already halfway out the door."
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private phyllasKidsChildren(): void {
        ...
        if (this.flags[kFLAGS.DAYS_PHYLLA_HAS_SPENT_BIRTHING] < 10)
            this.outx(
        ...
        else if (this.flags[kFLAGS.DAYS_PHYLLA_HAS_SPENT_BIRTHING] < 40)
            this.outx(
        ...
        if (this.flags[kFLAGS.PHYLLA_TIMES_DRIDER_EGG_LAYED] > 10)
            this.outx(
    ...
    private phyllaDigsForGems(): void {
        ...
        if (this.flags[kFLAGS.PHYLLA_GEMS_HUNTED_TODAY] == 0 && AntsScene.rand(20) + kidsMod > 10) {
            ...
            if (this.flags[kFLAGS.PHYLLA_EGG_LAYING] == 0) {
                this.outx(
                    "You ask Phylla is she's found any gems while digging out her colony.  She nods happily and runs over to a small stone chest and rifles though it.  After a moment, she runs back over to you and holds up all four of her hands."
                );
                this.outx(
        ...
        // Failure
            ...
            this.outx(
                "You ask Phylla if she's found any more gems while digging.  \"<i>No, I'm sorry.  I haven't.  Not since the last time you asked.  I'll do better!  I mean, I know you like them.  They're rare... even down here.  I'll do better...</i>\""
            );
            // If corruption is less  than 50
            if (this.player.cor < 50)
    ...
    private eggDatBitch(): void {
        ...
        if (this.player.canOvipositSpider())
            this.outx(
                "While Phylla appears to be sexually sated, the heaviness in your spider abdomen begs for release.\n\n"
            );
        // First Time:
        if (this.flags[kFLAGS.TIMES_EGG_IMPREGNATING_PHYLLA] == 0) {
            this.outx(
                "Turning to Phylla, you tell her that you can help to make her wishes of being a brood-mother come true.  She looks at you a bit taken back, as if what you already did wasn't enough already."
            );
            this.outx(
        ...
        // Subsequent Times:
            ...
            this.outx(
                "You give Phylla a knowing look then glance back at your swollen spider abdomen.  Playfully you thrust your ovipositor at her.  Phylla giggles a little, knowing what you want to do to her."
            );

        // Persuade Phylla - Random chance of failing, affected by INT and whether she's already housing eggs in her vagina.
        // Persuasion failure
        if (AntsScene.rand(20) + 1 + this.player.inte / 20 < 10) {
            this.outx(
                "\n\nPhylla ponders for a moment and shakes her head.  \"<i>I'm sorry, [name], I'm not comfortable with that right now."
            );
