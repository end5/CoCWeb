...
export class SandTrapScene extends BaseContent {
    ...
    private dontSaveTheTarps(): void {
        ...
        if (this.player.femininity <= 65) this.outx("woman");
        else this.outx("man");
        this.outx('.  "<i>Please!</i>" ');
        if (this.player.femininity <= 65) this.outx("she");
        else this.outx("he");
        this.outx(
        ...
        this.outx(" suddenly thrusts upwards and plunges a fist into the fluid sand surrounding ");
        if (this.player.femininity <= 65) this.outx("her");
        else this.outx("him");
        this.outx(
    ...
    private dickwieldersLoseToSandTarps(): void {
        ...
        if (!this.player.isTaur()) this.outx("armpits");
        ...
        if (this.player.hasVagina()) this.outx(" and cunt");
        this.outx(
    ...
    private stickWangInSandgina(): void {
        ...
        if (this.silly()) this.outx(", though with fewer pouting blue lips and doe eyes");
        this.outx(
        ...
        if (this.player.balls > 0) this.outx("balls ache and your ");
        this.outx(
    ...
    private sandTrapBadEndFinale(): void {
        ...
        if (this.player.gender > 0) {
            ...
            if (this.player.hasCock()) this.outx("cock harden");
            else this.outx("vagina dribble");
        }
        this.outx(".  Yes.  You remember your quest.");
        ...
        if (this.player.hasCock()) this.outx(" and masturbating [oneCock] desperately");
        else if (this.player.hasVagina()) this.outx(" and fingering your [vagina] desperately");
        this.outx(
