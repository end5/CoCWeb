...
export class SandTrapScene extends BaseContent {
    ...
    private dickwieldersLoseToSandTarps(): void {
        ...
        // More than 15 inches:
            ...
            this.outx(
                `\n\nThe creature owns an incredibly tight sex which grasp you possessively once it is on you.  Sweat beads the sandtrap's elegant brow as it forces itself brutally down your huge shaft; when it finally stops with a sizable portion of your ${this.cockDescript(
                    0
        ...
        if (this.player.hasVagina())
            this.outx(
                `  Ignored entirely, your ${this.vaginaDescript(
                    0
    ...
    public birfSandTarps(): void {
        this.spriteSelect(97);
        this.outx(
            `\nYour eyes widen as a gout of oil suddenly gushes from your ass.  Before panic can set in, an incredible light-headedness overtakes you.  Dreamily, you discard your [armor] and squat.  More oil oozes out of you, and in your hazy euphoria, you scoop some of it up and rub it dreamily into your ${this.nippleDescript(
                0
        ...
        // Female:
            ...
            this.outx(
                `  You roll your eyes to the sky and moan, your ${this.vaginaDescript(
                    0
        ...
        if (this.player.gender == 1) {
            ...
            if (this.player.cocks[0].cockLength < 6) {
                ...
                if (this.player.balls == 0)
                    this.outx(
                        `\n\nThe sandtrap only needs one hand to pump your diminutive cock; it barely moves its wrist as it jerks you, occasionally wriggling its oily fingers along the bottom of your ${this.cockDescript(
                            0
            ...
            // Cock 6-16 inches:
                ...
                if (this.player.balls == 0)
                    this.outx(
                        `\n\nThe sandtrap glides its hand up and down your ${this.cockDescript(
                            0
            ...
            // Two cocks:
                ...
                this.outx(
                    `  As the sandtrap begins to pump you faster, your disregarded ${this.cockDescript(
                        1
                    )} bobs in hard, eager concert with your ${this.cockDescript(
                        0
            ...
            // Three cocks:
                ...
                this.outx(
                    `\n\nAs the sandtrap begins to pump you faster, your two other, disregarded cocks bob in hard, eager concert with your ${this.cockDescript(
                        0
                    )}.  You gasp as the trap slows down momentarily to reach one of its hands down to grasp your second sex, and then stops entirely as  one of its hands clutching your ass releases and snakes back around to take hold of your ${this.cockDescript(
                        2
            ...
            // Four cocks:
                ...
                this.outx(
                    `\n\nAs the sandtrap begins to pump you faster, your three other, disregarded cocks bob in hard, eager concert with your ${this.cockDescript(
                        0
                    )}.  You gasp as the trap slows down momentarily to reach one of its hands down to grasp your second sex, and then stops entirely as both of its hands clutching your ass release and snake back around to take hold of your ${this.cockDescript(
                        2
            ...
            // More than four cocks:
                ...
                this.outx(
                    `\n\nAs the sandtrap begins to pump you faster, your many other, disregarded cocks bob in hard, eager concert with your ${this.cockDescript(
                        0
                    )}.  You gasp as the trap slows down momentarily to reach one of its hands down to grasp your second sex, and then stops entirely as its two hands clutching your ass snake back around to take hold of your ${this.cockDescript(
                        2
                    )} and ${this.cockDescript(
                        3
        ...
        // Herm:
            ...
            // Two cocks:
                ...
                this.outx(
                    `\n\nAs the sandtrap begins to pump you faster, your disregarded ${this.cockDescript(
                        1
                    )} bobs in eager concert with your ${this.cockDescript(
                        0
            ...
            // hree cocks:
                ...
                this.outx(
                    `\n\nAs the sandtrap begins to pump you faster, your two other, disregarded cocks bob in eager concert with your ${this.cockDescript(
                        0
                    )}.  You gasp as the trap slows down momentarily to reach both hands clutching your ass back around to take hold of your ${this.cockDescript(
                        1
                    )} and ${this.cockDescript(
                        2
            ...
            // More than three cocks:
                ...
                this.outx(
                    `\n\nAs the sandtrap begins to pump you faster, your many other, disregarded cocks begin to harden in eager concert with your ${this.cockDescript(
                        0
                    )}.  You gasp as the trap slows down momentarily to reach both of its hands clutching your ass back around to take hold of your ${this.cockDescript(
                        1
                    )} and ${this.cockDescript(
                        2
                    )}.  It is clumsy at first as it works its way around the rather complex arrangement you have down below, but it moves its lubricated palms with increasing confidence, until it is jerking three of your cocks whilst fingering you in rhythm.  You laugh into the sky with an almost hysterical edge at how mindbogglingly good getting a quadruple handjob feels, and the trap giggles slightly as well despite itself.  Hazily you wonder if it is too much to wish that this creature, with its excellent wrist action, had just one or two more hands to its name.`
    ...
    private stickWangInSandgina(): void {
        ...
        // Megacock:
            ...
            this.outx(
                `\n\nThe creature's moist sex is tight and you honestly doubt it can even take your obscenely massive tool.  Never say never, though.  You work your way in carefully, letting it get used to your girth, slowly working it loose enough to take your ${this.cockDescript(
                    0
        ...
        this.outx(
            `\n\n"<i>Hhhhyes!  That'sz it lion, oh do me, do it to me hard!  Give me yyyyour strong spunk - uh! give hhit to me szo I can sink yyour children into evvryone I catch - yes!  Hhhhso the whole world can know hhwhat a ${this.player.mf(
                "man",
                "woman"
            )} you arrrrrhhhhhe!</i>"  The creature's words subside into a high fluttering cry as it cums.  Its ovipositor spasms and clenches, milking you down your ${this.cockDescript(
                x
            )} for all it is worth.  Even if you wanted to, you could not pull back from the brink.  You come with near-painful intensity, your jizz shooting out of you as if your dick were trapped in a vacuum, losing yourself in ecstasy - you feel nothing but the grasping wet around your ${this.cockDescript(
                x
    ...
    private nagaThreesomeWithSandTrap(): void {
        ...
        if (this.player.hasCock()) {
            this.outx(
                `\n\nYou press your hardening ${this.cockDescript(
                    0
        ...
        // Female:
            ...
            if (this.player.wetness() < 4)
                this.outx(
                    `  Its gentle worship of your ${this.vaginaDescript(
                        0
            ...
            this.outx(
                `\n\nThe naga is soon deep within the sandtrap's oil fuge and she slows her thrusting down as it relaxes her and amplifies what she can feel, smiling euphorically as she slowly rotates on the creature's leaking pseudo-cock.  You pace yourself in sympathy; having already reached one ecstatic high you're more than happy to simply sit back and enjoy the sandtrap's worshipful ministrations, tending to every corner of your ${this.vaginaDescript(
                    0
