...
export class SandTrapScene extends BaseContent {
    ...
    public encounterASandTarp(): void {
        ...
        if (
            ...
            this.player.wingType == WING_TYPE_GIANT_DRAGONFLY
        ) {
            this.sandTrapBadEnd();
            return;
        }
    ...
    private dontSaveTheTarps(): void {
        ...
        this.spriteSelect(97);
        this.outputText(
            "You carefully step backwards from the quicksand, not taking your eyes off the stricken "
        );
        ...
        this.outputText(
            ' cries, neck sinking into the drift.  "<i>Don\'t let me die like this... oh, very well.  Have it YOUR way!</i>"  The '
        );
        if (this.player.femininity <= 65) this.outputText("woman");
        else this.outputText("man");
        this.outputText(
            " suddenly thrusts upwards and plunges a fist into the fluid sand surrounding "
        );
        if (this.player.femininity <= 65) this.outputText("her");
        else this.outputText("him");
        this.outputText(
            ".  The dune you are standing on caves inwards, turning into a shifting slide to the morass below you.  You stumble and hop backwards as fast as you can, managing to stay just ahead of the "
        );
        if (this.player.femininity <= 65) this.outputText("woman");
        else this.outputText("man");
        this.outputText(
            "'s spell.  In front of you, sand collapses downwards into a great conical depression, at the epicentre of which is your supposed rescuee.  With "
        );
        if (this.player.femininity <= 65) this.outputText("her");
        else this.outputText("his");
        this.outputText(
            " midriff exposed and glamour gone, the creature looks quite different; six eyes as black as its hair look at you hungrily from its beautiful androgynous face, whilst four slender arms trail patterns in the sand around its willowy, flat-chested midsection.  It wriggles its body tauntingly at you, making the sand beneath it move ponderously.  You glimpse insect chitin beneath its flat humanoid belly; the buried half of this creature must be monstrous."
        );
        this.outputText(
    ...
    public sandtrapmentLoss(clear: boolean = false): void {
        ...
        //PC lust loss:
            ...
            this.outputText(
                "You feel as radiant and molten as the sun above you... you just want to sink into the warm sand surrounding you forever.  Why are you struggling against it again?  You can't remember; with a sigh, you fall backwards onto the soft powder and allow yourself to be carried right down to the bottom.  The sandtrap chuckles softly as it envelopes you in its waiting arms.  \"<i>Good " +
    ...
    public pcBeatsATrap(): void {
        ...
        if (this.monster.HP < 1)
            this.outputText(
                "The sandtrap groans and collapses forwards into the dirt.  With the creature no longer controlling it, the sand underneath you feels a great deal more stable... climbing out won't be too difficult."
            );
        //PC lust victory:
        else
            this.outputText(
        ...
        if (
            this.player.isNaga() &&
            this.player.findStatusAffect(StatusAffects.Naga) >= 0 &&
    ...
    private dickwieldersLoseToSandTarps(): void {
        ...
        this.outputText(
            '.  You try and turn your head to see what it is doing but it gently but insistently pushes your face into the yielding sand.  "<i>You arrrrhe a fine little drone.  I wwill thank you for yourrh hard work... with the fruits of ssame hard work.</i>" What does it mean by...?'
        );
        ...
        this.outputText(
            "  The creature pushes your head down, making soothing shushing noises as it feeds more of its bulbous length into your ass."
        );
        if (this.player.analCapacity() < 40)
            this.outputText(
                "  Although the oil which coats your thoughts and reflexes with sensual supplication makes things easier, the feeling is still incredibly intense, and you grit your teeth as something round travels down the creature's ovipositor and stretches your tight hole wide."
            );
        else
            this.outputText(
                "  Your accommodating ass feels like it was made for this purpose, and with the creature's oil soothing your thoughts and reflexes you savor the creature taking you like this as if it were your quim.  You moan as something round travels down the creature's ovipositor and into your wet ass, the sensation making [eachCock] hard again."
            );
        ...
        this.outputText(
            " flexing out more moisture into the sand beneath you.  The oil-induced serenity and the sexual marathon the sandtrap has put you through are too much and, even with the creature still relentlessly pumping away at you, you pass out."
        );
    ...
    private chicksLoseToSandTarp(): void {
        ...
        if (this.monster.findStatusAffect(StatusAffects.Fertilized) >= 0)
            ...
            this.outputText(
                '  "<i>A cute little wwworker hasz fallen into my home, but I have no fertile eggsz to givve it.  Wwwell, that isz ok.  Hwwe can still have fun, can\'t we?</i>"'
            );
        ...
        this.outputText(
            "  The prong base rubs against your [clit] rhythmically and suddenly you find yourself orgasming in tandem with it, crying out as the creature groans and ejaculates its delicious ooze deliriously into you."
        );
        this.outputText(
        ...
        if (this.player.analCapacity() < 30)
            this.outputText(
                "Although the oil which coats your thoughts and reflexes with sensual supplication makes things easier, the feeling is still incredibly intense, and you grit your teeth as something round travels down the creature's ovipositor and stretches your tight ass wide."
            );
        else
            this.outputText(
                "Your accommodating ass feels like it was made for this purpose, and with the creature's oil soothing your thoughts and reflexes you savor the creature taking you like this as if it were your second quim.  You moan as something round travels down the creature's ovipositor and into your wet ass."
            );
        this.outputText(
            "  Slowly the creature begins to pick up its rhythm again, sliding in and out of your pussy as it breeds you."
        );
        this.outputText(
    ...
    private genderlessLoss(): void {
        ...
        if (this.monster.findStatusAffect(StatusAffects.Fertilized) >= 0)
            ...
            this.outputText(
                '"<i>Not a worker OR a drone! Wwwell, that isz ok.  Hwwe can still have fun, can\'t we?</i>"'
            );
        ...
        if (this.player.analCapacity() < 30)
            ...
            this.outputText(
                "Your accommodating ass feels like it was made for this purpose, and with the creature's oil soothing your thoughts and reflexes you savor the creature taking your [asshole] like this as if it were a quim.  You moan as something round travels down the creature's ovipositor and into your wet ass."
            );
        this.outputText(
            "  Slowly the creature begins to pick up its rhythm again, sliding in and out of your butt as it breeds you."
        );
    ...
    private sandTrapPregChance(): void {
        ...
        if (this.monster.findStatusAffect(StatusAffects.Fertilized) >= 0)
            this.player.buttKnockUp(
                ...
                PregnancyStore.INCUBATION_SANDTRAP,
                1,
                1
            );
        else
    ...
    public birfSandTarps(): void {
        this.spriteSelect(97);
        this.outputText(
            "\nYour eyes widen as a gout of oil suddenly gushes from your ass.  Before panic can set in, an incredible light-headedness overtakes you.  Dreamily, you discard your [armor] and squat.  More oil oozes out of you, and in your hazy euphoria, you scoop some of it up and rub it dreamily into your " +
                this.nippleDescript(0) +
                "s.  Part of you is disgusted at yourself, questioning what you are doing, but that is one voice in a million-strong chorus crooning you into total relaxation... the oil clings to your skin and seems to radiate warmth and softness.  Something round stretches your rectum wide, but in your state the sensation is practically orgasmic."
        );
        //[Male:
        if (this.player.gender == 1) {
            this.outputText(
                "  You roll your eyes to the sky and moan, [eachCock] growing hard as you push out the egg."
            );
            ...
            if (
                ...
                this.outputText(
                    "  Your oily hands descend upon your cock, and you massage your shaft as you feel the pressure in your bowels intensify again."
                );
        }
        //Female:
        else if (this.player.gender == 2) {
            this.outputText(
                "  You roll your eyes to the sky and moan, your " +
                    this.vaginaDescript(0) +
                    " moistening as you push out the egg."
            );
            //[(no fukken horses from here)]
            if (!this.player.isTaur())
                this.outputText(
                    "  Your oily hands push softly into your cleft, fingering your needy " +
                        this.clitDescript() +
                        " as you feel the pressure in your bowels intensify again."
                );
        }
        //Herm:
        else if (this.player.gender == 3) {
            this.outputText(
                "  You roll your eyes to the sky and moan, [eachCock] growing hard and your [vagina] moistening as you push out the egg."
            );
            //[(no horses)]
            if (!this.player.isTaur())
                this.outputText(
                    "  Your oily hands descend upon your genitals and you begin to slowly pump your shaft and finger your needy " +
                        this.clitDescript() +
                        " as you feel the pressure in your bowels intensify again."
                );
        }
    ...
    private useSandTarpsHands(): void {
        ...
        if (this.player.gender == 1) {
            ...
            if (this.player.cocks[0].cockLength < 6) {
                ...
                if (this.player.balls == 0)
                    this.outputText(
                        "\n\nThe sandtrap only needs one hand to pump your diminutive cock; it barely moves its wrist as it jerks you, occasionally wriggling its oily fingers along the bottom of your " +
                            this.cockDescript(0) +
                            " to stimulate you even further."
                    );
                else
                    this.outputText(
                        "\n\nThe sandtrap only needs one hand to pump your diminutive cock; it barely moves its wrist as it jerks you, occasionally wriggling its oily fingers along the bottom of your " +
                            this.cockDescript(0) +
                            " to incite you even further, whilst it uses its free hand to gently cup your [balls]."
                    );
                this.outputText(
                    "  Your small size doesn't seem to bother it; if anything, judging from the red rising in its thin cheeks and its shortening breath, the girliness of your cock actually seems to excite it.  It pauses and, whilst you are both panting lightly, it slowly and gently circles your head with its index finger whilst it still holds the entirety of your cock with the rest of its hand."
                );
            }
            //Cock 6-16 inches:
                ...
                if (this.player.balls == 0)
                    this.outputText(
                        "\n\nThe sandtrap glides its hand up and down your " +
                            this.cockDescript(0) +
                            ", picking up a warm smooth rhythm."
                    );
                //Balls:
                else
                    this.outputText(
                        "\n\nThe sandtrap glides its hand up and down your " +
                            this.cockDescript(0) +
                            ", picking up a warm smooth rhythm as it gently cups your [balls] with its free hand.]  It slows down intermittently to move its palm around your length, letting every inch of your dick feel the tips of its delicate fingers."
                    );
            }
            //Cock more than 16 inches:
            else
                this.outputText(
                    "\n\nThe sandtrap quickly comes to the realisation it needs both hands for this.  Still cupping your behind, it moves one oily hand up the top end of your massive shaft, while the other works the other half.  You sigh with deep satisfaction, enjoying the all-too-rare sensation of having every inch of your " +
                        this.cockDescript(0) +
                        " immersed in pleasure.  The creature screws its face up and looks away in distaste at the size of your straining dick, which is in danger of poking it in the nose.  As you enjoy the warm, slippery sensation inundating you, you find you couldn't care less what it thinks."
                );
            //number of cock fork
            //One cock:
            if (this.player.cockTotal() == 1) {
                this.outputText(
                    "  The sandtrap pumps you faster and faster until its slippery hands are a blur of motion.  It clutches onto your butt cheeks so tightly you hazily realize the indents of its slender digits will be with you for hours afterwards."
                );
                this.outputText(
            ...
            //Three cocks:
                ...
                this.outputText(
                    "\n\nAs the sandtrap begins to pump you faster, your two other, disregarded cocks bob in hard, eager concert with your " +
                        this.cockDescript(0) +
                        ".  You gasp as the trap slows down momentarily to reach one of its hands down to grasp your second sex, and then stops entirely as  one of its hands clutching your ass releases and snakes back around to take hold of your " +
                        this.cockDescript(2) +
                        ".  It is clumsy at first as it works its way around the rather complex arrangement you have down below, but it moves its lubricated palms with increasing confidence, until it is jerking all three of your cocks in rhythm."
                );
                if (this.player.balls > 0)
                    this.outputText(
                        "  It grins up at you shyly and, with its final hand, cups your [balls].  ]You laugh with an almost hysterical edge to the sky at how mindboggling getting a triple handjob feels, and the trap giggles slightly as well despite itself."
                    );
                this.outputText(
            ...
            //Four cocks:
                ...
                this.outputText(
                    "\n\nAs the sandtrap begins to pump you faster, your three other, disregarded cocks bob in hard, eager concert with your " +
                        this.cockDescript(0) +
                        ".  You gasp as the trap slows down momentarily to reach one of its hands down to grasp your second sex, and then stops entirely as both of its hands clutching your ass release and snake back around to take hold of your " +
                        this.cockDescript(2) +
                        " and " +
                        this.cockDescript(3) +
                        ".  It is clumsy at first as it works its way around the rather complex arrangement you have down below, but it moves its lubricated palms with increasing confidence, until it is jerking all four of your cocks in rhythm.  You laugh into the sky with an almost hysterical edge at how mindbogglingly good getting a quadruple handjob feels; it glances up at you and giggles shyly as you look into each other's eyes and share a thought.  \"<i>At last, I've found somebody who complements my body perfectly.</i>"
                );
                this.outputText(
            ...
            //More than four cocks:
                ...
                this.outputText(
                    "\n\nAs the sandtrap begins to pump you faster, your many other, disregarded cocks bob in hard, eager concert with your " +
                        this.cockDescript(0) +
                        ".  You gasp as the trap slows down momentarily to reach one of its hands down to grasp your second sex, and then stops entirely as its two hands clutching your ass snake back around to take hold of your " +
                        this.cockDescript(2) +
                        " and " +
                        this.cockDescript(3) +
                        ".  It is clumsy at first as it works its way around the incredibly complex arrangement you have down below, but it moves its lubricated palms with increasing confidence, until it is jerking four of your cocks in rhythm.  You laugh into the sky with an almost hysterical edge at how mindbogglingly good getting a quadruple handjob feels, and the trap giggles slightly as well despite itself.  Hazily you wonder if it is too much to wish that this creature, with its excellent wrist action, had just one or two more hands to its name."
                );
                this.outputText(
                    "\n\nThe warm, oily quadrupled sensation is unbearably good and although you try to hold on to savor it as long as possible, it isn't long before you reach a toe-curling peak and, with a wordless bark, spurt out line after line of jizz.  The trap flinches slightly when your first shots hit it in the face and chest, but then goes back to gently rubbing you, guiding you up and down your warm, slippery multiple orgasm as you spurt like a cum sprinkler in front of it."
                );
        ...
        //Female:
            ...
            if (this.player.tone < 60)
                this.outputText(
                    "  It picks up the pace gradually and soon it is doubly frigging you as fast as its fingers will allow, its other hands sinking deep into your soft, pillowy behind as it clutches onto you."
                );
            else
                this.outputText(
                    "  It picks up the pace gradually and soon it is doubly frigging you as fast as its fingers will allow, its other hands clutching onto your tight, muscled behind so tightly you hazily realize the indents of its slender digits will be with you for hours afterwards."
                );
            this.outputText(
        ...
        //Herm:
            ...
            this.outputText(
                '\n\nOne pair of the creature\'s hands slowly brush up your inner thighs whilst the other two feel around your "<i>armor</i>", clumsily loosening clasps and belts as it finds them.  One hand finds your ' +
                    this.cockDescript(0) +
                    " and, after pausing for a split second, slides its fingers around your shaft and begins to slowly rub up and down.  You sigh as you quickly harden in the creature's smooth, dry, enveloping grasp.  You look into the sandtrap's face as it works; blushing, it looks down from your gaze and concentrates upon what it is doing.  It begins to pump you faster and you hiss slightly at the abrasion this causes.  At this the sandtrap makes a throaty sound.  Curiously you look down in time to see it bring its other pair of hands up to its mouth and deposit a great dollop of clear ooze into its cupped palms.  Your disgust turns to delight as it swaps its hands and begins to massage its oil into your length, the warm lubricant allowing the creatures' fingers to glide around your shaft and head like they were made of silk.  As it moves its first hand up and down, it tentatively moves its second further between your legs.  It finds your [vagina] and, after pausing for a split second, slides its slender fingers into your moistness.  Although it is clumsy at first, the oil which coats its digits make them glide over your shaft and labia as if they were entirely frictionless.  It quickly gains confidence and begins to gently frig you as it slides its warm, slippery grasp up and down your " +
                    this.cockDescript(0) +
                    ", circling your [clit] whilst occasionally dipping into your dripping hole.  You sigh and begin to lose yourself in the wet, silky sensation."
            );
            //Cock less than 6 inches:
            if (this.player.cocks[0].cockLength < 6) {
                //[no balls:
                ...
                this.outputText(
                    "  Your small size doesn't seem to bother it; if anything, judging from the red rising in its thin cheeks and its shortening breath, the girliness of your cock actually seems to excite it.  It pauses and, while you are both panting lightly, it slowly and gently circles your head with its index finger, still holding the entirety of your cock with the rest of its hand."
                );
            }
            //Cock 6-16 inches:
            else if (this.player.cocks[0].cockLength < 16) {
                if (this.player.balls == 0)
                    ...
                    this.outputText(
                        "\n\nThe sandtrap glides its hand up and down your " +
                            this.cockDescript(0) +
                            ", picking up a warm smooth rhythm as it gently cups your [balls] with its free hand.]  It slows down intermittently to move its fingers around your length, letting every inch of your dick feel the tips of its delicate fingers."
                    );
            } else {
                this.outputText(
                    "\n\nThe sandtrap quickly comes to the realisation it needs both hands for this.  Still cupping your behind, it moves one oily hand up the top end of your massive shaft, whilst the other works the other half.  You sigh with deep satisfaction, enjoying the all-too-rare sensation of having every inch of your " +
                        this.cockDescript(0) +
                        " immersed in pleasure.  The creature screws its face up and looks away in distaste at the size of your straining dick, which is in danger of poking it in the nose.  As you enjoy the warm, slippery sensation inundating you, you find you couldn't care less what it thinks."
                );
            }
            ...
            //Two cocks:
                ...
                this.outputText(
                    "\n\nAs the sandtrap begins to pump you faster, your disregarded " +
                        this.cockDescript(1) +
                        " bobs in eager concert with your " +
                        this.cockDescript(0) +
                        ".  You gasp as the trap slows down momentarily to reach one of the hands gripping your ass back around to grasp your second manhood.  It is clumsy at first as it moves its lubricated palms in tandem, then with increasing confidence as it finds a position and rhythm that suits it, it is jerking and flicking you off furiously, clutching your butt cheek with its final hand for what seems like dear life."
                );
                this.outputText(
            ...
            //hree cocks:
                ...
                this.outputText(
                    "\n\nAs the sandtrap begins to pump you faster, your two other, disregarded cocks bob in eager concert with your " +
                        this.cockDescript(0) +
                        ".  You gasp as the trap slows down momentarily to reach both hands clutching your ass back around to take hold of your " +
                        this.cockDescript(1) +
                        " and " +
                        this.cockDescript(2) +
            ...
            //More than three cocks:
                ...
                this.outputText(
                    "\n\nAs the sandtrap begins to pump you faster, your many other, disregarded cocks begin to harden in eager concert with your " +
                        this.cockDescript(0) +
                        ".  You gasp as the trap slows down momentarily to reach both of its hands clutching your ass back around to take hold of your " +
                        this.cockDescript(1) +
                        " and " +
                        this.cockDescript(2) +
                        ".  It is clumsy at first as it works its way around the rather complex arrangement you have down below, but it moves its lubricated palms with increasing confidence, until it is jerking three of your cocks whilst fingering you in rhythm.  You laugh into the sky with an almost hysterical edge at how mindbogglingly good getting a quadruple handjob feels, and the trap giggles slightly as well despite itself.  Hazily you wonder if it is too much to wish that this creature, with its excellent wrist action, had just one or two more hands to its name."
    ...
    private rideDatSandTarpLikeIts1999(): void {
        ...
        if (this.player.hasCock())
            this.outputText(
                "  [EachCock] flexes in delicious concert with your quim, spurting jizz onto the trap's chest and face."
            );
        this.outputText(
    ...
    private stickWangInSandgina(): void {
        ...
        //Megacock:
            ...
            this.outputText(
                "\n\nThe creature's moist sex is tight and you honestly doubt it can even take your obscenely massive tool.  Never say never, though.  You work your way in carefully, letting it get used to your girth, slowly working it loose enough to take your " +
                    this.cockDescript(0) +
            ...
            if (this.player.balls > 0)
                this.outputText(
                    "  Your " +
                        ...
                        " slap against the creature's wet opening.  "
                );
            this.outputText(
    ...
    private nagaThreesomeWithSandTrap(): void {
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.cocks[0].cockLength < 14) {
                this.outputText(
                    "\n\nYour " +
                        this.cockDescript(0) +
                        " is a good fit for the sandtrap's mouth and soon the creature is taking your whole length, lavishing its oil and saliva into your straining cock, lying its head back and opening its mouth wide so you can begin to piston into its submissive opening with fervor, "
                );
                if (this.player.balls > 0)
                    this.outputText(
                        "slapping your " +
                            this.ballsDescriptLight() +
                            " into its nose, forcing your cock all the way to the top of its tight throat."
                    );
            }
            //14 inches or more:
            else {
                this.outputText(
                    "\n\nYour " +
                        this.cockDescript(0) +
                        " is bigger than what the sandtrap's mouth can accommodate, and it isn't long before you are beginning to push into the creature's tight throat.  It lavishes its oil and saliva onto your straining cock, lying its head back and opening its mouth as wide as it can to aid you in your task, and soon you are "
                );
                ...
                if (this.player.balls > 0)
                    this.outputText(
                        "your " +
                            this.ballsDescriptLight() +
                            " swinging heavily in front of the sandtrap's nose, "
                    );
                this.outputText(
        ...
        //Female:
            ...
            this.outputText(
                "\n\nThe naga is soon deep within the sandtrap's oil fuge and she slows her thrusting down as it relaxes her and amplifies what she can feel, smiling euphorically as she slowly rotates on the creature's leaking pseudo-cock.  You pace yourself in sympathy; having already reached one ecstatic high you're more than happy to simply sit back and enjoy the sandtrap's worshipful ministrations, tending to every corner of your " +
                    this.vaginaDescript(0) +
                    ".  You've also had enough oil rubbed into you to feel quite dreamy yourself; the sand, the sun and even your own vagina seem bigger and more encompassing than they were before."
            );
            this.outputText(
    ...
    private sandTrapBadEnd(): void {
        ...
        if (this.player.hasCock())
            this.outputText(
                "[EachCock] hardens and your thin frame feels aflame, barely understood impulses deep within you begging you to walk down and submit to the Sandtrap's will.  "
            );
        //Female:
        else if (this.player.hasVagina())
            this.outputText(
                "Your [vagina] moistens and your thin frame feels aflame, barely understood impulses deep within you begging you to walk down and submit to the Sandtrap's will.  "
            );
        this.outputText(
            "You inhale hard and try to clear your head, forcing yourself not to sleepwalk downwards into the Sandtrap's waiting embrace.  The creature doesn't seem to mind your hesitation; it smiles softly and confidently, waiting for you with the infinite patience of its kind.  You need to make a choice here fast, before your burning body makes it for you."
        );
    ...
    private sandTrapBadEndFight(): void {
        ...
        this.spriteSelect(97);
        this.outputText(
            'You shake yourself out of your fog, clench your [weapon] and grit your teeth.  You are your own person, dammit, and you will show this creature just what that means!  The Sandtrap slowly lowers its arms and looks at you with almost parental disappointment as you march into its pit with the obvious intention of beating the crap out of it.  "<i>You want to dance again, Flytrap?</i>" it sighs.  "<i>I would prefer that you look at yourself and accept what you are, but I will force you to accept it if that is what you wish.</i>"'
        );
    ...
    private leaveSandTrapBadEnd(): void {
        ...
        this.spriteSelect(97);
        this.outputText(
            "With some effort you break your stare with the Sandtrap, turn away and step back towards camp, resolving to leave this disturbing scenario with its disturbing thoughts behind."
        );
        this.outputText(
    ...
    private desztiny(): void {
        ...
        this.spriteSelect(97);
        this.outputText(
            "The Sandtrap is right.  What your body and subconscious are telling you is so right.  At your acceptance of what the creature is saying warmth floods through your body; your mind bubbles as blood rushes towards your skin, making you feel incredibly sensitive, incredibly sexual.  "
        );
        //Male:
        if (this.player.hasCock())
            this.outputText(
                "Your cock strains upwards and you moan; feeling as sensitive as you do, you are both desperate to be touched and desperate not to be.  "
            );
        //Female:
        else if (this.player.hasVagina())
            this.outputText(
                "You feel but barely hear the drip of moisture on the sand, both your [asshole] and [vagina] beading with oily need.  "
            );
        this.outputText(
        ...
        this.outputText(
            '\n\n"<i>Good ' +
                this.player.mf("boy", "girl") +
                ',</i>" says the Sandtrap, giggling slightly as it caresses you.  "<i>Of course, that word doesn\'t mean anything to you anymore.</i>"  You blearily look into its thin, beautiful face to ask what it means by that, and the creature takes the opportunity to plunge its tongue into your unresisting mouth.'
        );
    ...
    private sandTrapBadEndFinale(): void {
        ...
        this.outputText(
            ".  But, of course, as a fresh dominant urge takes you and drags you reluctantly from your needy genitals, there is much still left to be done."
        );
