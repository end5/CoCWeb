...
export class IzumiScene extends BaseContent {
    ...
    public encounter(): void {
        ...
        if (this.flags[kFLAGS.IZUMI_MET] == 0) {
            ...
            this.outputText(
                "Considering how your last visit to the cave ended, you hesitate for a moment and wonder if you should push forward to enter Izumi’s home... or if turning back to camp would be a wiser decision.\n\n"
            );
    ...
    public enterAfterMet(): void {
        ...
        if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 1) {
            this.outputText(
                "Remembering the outcome of your last visit, you peer cautiously around the mouth of the cave.  Izumi, as before, is seated by the fire, happily puffing away at whatever bizarre narcotic she keeps in her pipe.  She sees you almost immediately, raising a hand cheerfully and beckoning for you to enter.\n\n"
            );
            ...
            this.outputText(
                "Remembering your last visit, you peer cautiously around the mouth of the cave.  Izumi, as before, is seated by the fire, happily puffing away at whatever bizarre narcotic she keeps in her pipe.  She sees you almost immediately, raising a hand cheerfully and beckoning for you to enter.\n\n"
            );

            this.outputText(
                "“<i>Oh hey, you came back!</i>”  She announces.  “<i>That’s good, ‘cause for a while there I thought you were a wuss.  Crazy idea, right?  So, did you decide to try your luck, or are you just gonna give up and let me have some fun?</i>”\n\n"
            );
        } else if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 3) {
            this.outputText(
                "Ranging through mountains and valleys, you find yourself back at Izumi’s camp.  Remembering the outcome of your last visit, you peer cautiously around the mouth of the cave.  Izumi, as before, is seated by the fire, puffing away at whatever bizarre narcotic she keeps in her pipe.  She catches sight of you almost immediately, frowns slightly, then raises a hand in a hesitant greeting.  There’s an awkward silence for a moment, during which Izumi avoids your gaze.\n\n"
            );

            this.outputText(
                "“<i>So, uh...</i>” she begins.  Then she scowls, blushing slightly.  “<i>So, you came back to apologize, right?  You damn well better have!  In fact, I’m not forgiving you until I’ve made you feel as humiliated as I did, so just give in already, okay?!</i>”\n\n"
            );
        } else {
    ...
    protected abortabortleavethefukkencave(): void {
        ...
        this.outputText(
            "Spelunking in random caves around these parts is probably not the best idea; especially considering the kinds of creatures that you keep tripping over whenever you <i>do</i> decide to poke your nose somewhere it doesn't belong.\n\n"
        );
    ...
    protected nopeLeavePlz(): void {
        ...
        this.outputText(
            "You decide discretion is the better part of valour and choose not to barge into the strange woman's cave again, opting to slip away before she notices you hanging around outside her home."
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    protected enterFirstTime(): void {
        ...
        if (this.player.tallness >= 108) {
            ...
            if (this.player.str >= 75) {
                this.outputText(
                    "Putting your shoulder to the stone, you push with all your might, trying to roll it out of the way.  It resists for a moment, then gives, slowly but surely rattling and scraping across the uneven ground.\n\n"
                );
            }
            // Low strength variant
            else {
                this.outputText(
                    "Putting your shoulder to the stone, you push with all your might, trying to roll it out of the way.  It resists, but you are determined, your [feet] scrabbling against loose rocks and gravel, trying to find the purchase you need to move the boulder.\n\n"
                );
            }

            // Shared
            this.outputText(
                "The humming stops almost instantly, and moments later a hand suddenly rests itself on the rock in front of you.  Looking up from your exertions, you find yourself face to face with a woman.  It takes a moment, but then you realize, you really are actually face to face with her - she’s as tall as you are!"
            );

            // Catch logic shit that we just broke
            if (this.player.str < 75) {
                this.outputText(
                    "  She gives the boulder a shove - with just one hand - and it starts to give, scraping across the uneven ground.\n\n"
                );
            } else {
                this.outputText("\n\n");
            }
            ...
            this.outputText(
                "“<i>Well now,</i>” she drawls in a syrupy, seductive tone, twirling an errant lock of her hair thoughtfully in her fingers.  “<i>You’re a </i>big<i> one, aren’t you?  And here you are,"
            );
            if (this.player.str >= 75) this.outputText(" forcing");
            else this.outputText(" trying to force");
            this.outputText(
                " your way through little Izumi’s door uninvited.  I’d tell you off, but I’ve got to admit, I don’t get many visitors of your... </i>stature.<i>"
            );
            ...
            if (this.player.hornType != HORNS_COW_MINOTAUR) {
                ...
                if (this.actsLikeACow() == true) {
                    this.outputText(
                        "  Or at least, ones without the temperament to match the... physique, "
                    );
                }
            }
            ...
            this.outputText(
                "She turns and heads back into the cave, quickly disappearing into the gloom, the strange woman motioning you to follower her inside with a wave.  You creep slowly into the darkness after her, your sight gradually adapting to the darkness.\n\n"
            );
        }
        // "short" variant
        else {
        ...
        if (this.player.tallness < 108) {
            ...
            this.outputText(
                "“<i>Hm?</i>” the shadow grunts, then speaks.  “<i>Oh?  Now how did you find your way in here, I wonder?</i>”  The voice is deep, rich and undeniably female, but has a gravelly edge to it like a cross between magma and molten chocolate.  You hear the hiss of indrawn breath and a small light flares up briefly in the darkness, then the shadow speaks again.  “<i>Well, whatever. It’s been a while since I had company, "
            );

            if (this.player.minoScore() > 3)
                this.outputText(
                    "plus it looks like you're thinking with the head on top of your neck, rather than the head between your legs, unlike the stupid brutes who usually wander around these parts.  "
                );
            else if (this.player.dogScore() > 3)
                this.outputText(
                    "plus it looks like you'd actually be able to resist chasing down a stick, if I threw one outta' the cave.  "
                );
            else if (this.player.goblinScore() > 3)
                this.outputText(
                    "plus you don't seem to be as insufferable as the rest of those little green whores who trollop around these parts, hunting their next lay.  "
                );
            else if (this.player.demonScore() > 3)
                this.outputText(
                    "plus you're not forever going on about corruption this, enslavement that, demonic taint the other, unlike the insufferable clods who usually wander around these parts.  "
                );
            else if (this.player.harpyScore() > 3)
                this.outputText(
                    "plus you're not screeching incessantly, like the feathery sluts who usually flap their way around these parts.  They're lucky they </i>can<i> fly, 'cause I'd give them something to really squawk about if I could get my hands on them.  "
                );
            else if (this.player.lizardScore() > 3)
                this.outputText(
                    "plus, you don't have the same creepy eyes that the scaley idiots from around these parts keep trying to use on me.  "
                );
            else
                this.outputText(
                    "plus you don’t look like the troglodytes who usually wander around these parts.  "
                );
        ...
        if (this.player.tallness < 108) {
            this.outputText(
                "  For a moment, you’re stunned into silence; the figure looks completely human, aside from two important factors.  The first, her size; she looks as though someone had tried to build a human but got the scale wrong.  By the looks of her, if she was standing upright she would tower at least around eight or nine feet in height, and she looks broad enough to carry a horse on her back."
            );
        } else {
            this.outputText(
                "  With the opportunity to finally study the strange woman in detail, you’re stunned into silence.  She looks completely human, aside from two important factors.  The first, her size; she looks as though someone had tried to build a human but got the scale wrong.  A fact you’re made aware of every time you venture from camp; it’s not every day you meet somebody just as tall as yourself."
            );
        }

        this.outputText(
            "  The second factor, of course, would be the enormous curved horn of red, rock-like bone that juts proudly from her forehead.  Still, they’re no less inhuman than some of the other creatures you’ve encountered since arriving....\n\n"
        );

        this.outputText(
            "“<i>Hmm?</i>”  She looks blankly at you.  The sudden realisation that you’ve been staring at her horn for an uncomfortably long time hits you.  “<i>What?  Is there something on my face?</i>”  Blushing, you open your mouth to answer, but as you breathe in, a rush of coarse smoke down your throat"
        );
        if (this.player.tou < 60) this.outputText(" causes you to cough and splutter.\n\n");
        else
            this.outputText(
                " momentarily steals your voice, having been ill-prepared for the sudden burn.\n\n"
            );

        this.outputText(
            "The strange woman blinks at you in confusion for a moment, then her face cracks into a grin.  “<i>Oh, right, I forgot people like you tend to be pretty fragile.  Hold on"
        );
        if (this.player.tou < 60) this.outputText(", kid. Let");
        else this.outputText(", let");
        this.outputText(
            " me get some air in here for you...</i>”  She launches herself to her feet with surprising speed and breezes past you.\n\n"
        );
    ...
    protected enterFirstTimePartII(): void {
        ...
        this.outputText(
            " the smoke, you turn to see her, only barely through the gloom, at the boulder blocking entry to the cave."
        );
        if (this.player.str <= 75)
            this.outputText(
                "  To your amazement, the boulder begins to move, and as more light - along with a much-needed rush of fresh air - floods into the smoky cavern, you see she’s actually rolling it aside with her <i> bare hands </i>.  Even given her great size, this woman’s strength must be immense!\n\n"
            );
        else
            this.outputText(
                "  The boulder begins to move, and as more light - along with a welcome rush of fresh air - floods into the smoky cavern, you see she’s rolling it aside with nothing more than her bare hands with graceful, if unnerving, ease.\n\n"
            );
        ...
        if (this.player.tallness < 108)
            this.outputText(
                "She wears a silken kimono, embroidered with stars, dragons and flowers, which you can’t help but notice is of a truly scandalous cut – your eye is inevitably drawn to her enormous breasts, bulging dangerously against the fabric as though straining to escape.  If she were human-sized and remained in proportion, they would probably be around a DD, but at her size, you honestly have no idea.\n\n"
            );

        this.outputText(
            "She sits, right knee raised so she can rest her arm on it, her left foot tucked behind the right.  As she does so, her kimono slides aside,"
        );
        if (this.player.cor <= 33)
            ...
            this.outputText(
                " exposing a delicious view of her thigh, the creamy-white flesh almost screaming out for your caresses."
            );
        ...
        this.outputText(
            " so you give her your name, and, hesitant to discuss your true quest in any depth, detail some of your past encounters in this strange world.  Nodding encouragingly, she raises a long, elaborately carved pipe to her lips, puffing away as you tell your story....\n\n"
        );

        this.outputText(
            "“<i>Oh, so you’re the heroic type, yeah?  So, I guess it’s my turn now, huh?</i>” She sighs and closes her eyes, reclining and crossing her legs.  You can’t help but notice the way her kimono slithers around her legs, mere inches from becoming truly indecent, nor the way her breasts threaten to burst free of their confinement as she stretches.\n\n"
        );

        this.outputText(
            "“<i>Ah, but where to begin?  My clan calls me ‘Izumi, <b>The Font Of All Strength’</b>.</i>”  She snorts in amusement at your reaction to her name.  “<i>I know, it’s a little pompous, right?  Just use Izumi, I always do.  Either way, I’m a traveller from another world."
        );

        if (this.player.humanScore() > 3) {
            this.outputText(
                "  I’ve met humans before a few times.  Back home, my people like to play games with them to see how they’ll react; show up, scare the locals, steal a sheep and run off giggling to yourself, that kind of thing.  Sometimes one of them is actually brave enough to come after us.  Sometimes we even slap ‘em on the back, give ‘em the sheep and then drink them under the table.</i>” \n\n"
            );

            this.outputText(
                "She takes a long, powerful drag on her pipe, her lips locked tight around the mouthpiece.  “<i>It was fun for a while, but bothering goatherds for the next thousand years wasn’t my scene, frankly, so I left.  Bailed.  Disappeared."
            );
        }

        this.outputText(
            "  I didn’t come here to fight demons or any of that nonsense, though.  I’m just looking for something <b>fun</b> to do, you know?  Something to keep my interest for a while.</i>”  She opens her eyes again, two enormous amber irises staring thoughtfully down at you.  For some reason, you find something very uncomfortable about her gaze...."
        );
        if (this.player.str <= 75 || this.player.tallness < 96)
            this.outputText(
                " You can’t help but feel like a sheep yourself - one who’s just noticed the wolf is staring it down.\n\n"
            );

        this.outputText(
            "“<i>My mistake coming here, though.  There’s no conversationalists, no challenges, nothing fun. The only other conversations I’ve had since coming here have all gone more or less the same way, you know?  ‘Harharhar, I shall turn you into my slave!  How dare you pick me up, I shall destroy you!  Why are we heading towards that cliff!’  and so on.</i>”\n\n"
        );
    ...
    protected smokeThePipe(): void {
        ...
        this.outputText(
            "Whatever it is she has in there, the smoke is thick and cloying and even the smallest puff makes"
        );
        ...
        this.outputText(
            " - much to your mutual amusement.  You talk and joke for a while longer, the smoke making you feel incredibly relaxed, as though all the tension were simply melting from your body."
        );
        if (this.player.tou <= 80)
            this.outputText(
                "  After a while, you find it hard to even raise your arms to reach for the pipe again.\n\n"
            );
        else this.outputText("\n\n");
    ...
    protected dontSmokeThePipe(): void {
        ...
        this.outputText(
            "You do your best to politely refuse the pipe, explaining your unwillingness to eat, drink, chew, chug or otherwise consume various items you’ve come across during your travels, having witnessed some of the effects first-hand.\n\n"
        );
    ...
    protected smokeJoins(): void {
        ...
        this.outputText(
            "You hear Izumi let out a quiet giggle.  Looking up, you see she’s shifted closer to you, edging right up to the fire.  She makes a show of appraising you physically, her golden-amber eyes sparkling in the dancing firelight as her gaze roams over your body, from head to [foot]."
        );
        ...
        this.outputText(
            "  She’s even larger up close, and you can clearly see the solid, capable looking muscle that makes up her frame....\n\n"
        );

        if (this.player.tallness < 108) {
            this.outputText(
                "“<i>You know, you’re pretty cute.  Did I already say that?  Well even if I did, it’s true.  I like brave people.  I like people who challenge themselves.  You’re pretty brave, surviving in a place like this all alone, you know?</i>”  Without warning, she leans forwards over the dying fire, the ruddy light from the coals illuminates her face from below, giving her a decidedly sinister air.\n\n"
            );

            this.outputText(
                "“<i>I think it’s about time you repaid me for my hospitality.</i>”  She says, her eyes glittering dangerously in the firelight.  “<i>After all, you came into my camp uninvited... that’s pretty rude, you know?  I think I might take offence to that.</i>”  As she speaks, she slinks closer to you on all fours like some kind of predatory cat, about to make the final killing leap upon its helpless prey... Her personality has changed completely from the gentle giant you were speaking with a second ago.  You suddenly wonder if perhaps the smoke is somehow affecting her.\n\n"
            );

            this.outputText(
                "“<i>I think you’d better make it up to me, yeah?</i>”  She continues, slurring her words slightly as she reaches out with one hammer-like hand, then seizes hold of your [armor].  “<i>Otherwise I might get nasty.  And you don’t want me to get <i>nasty</i> with ya’, do ya’?</i>”\n\n"
            );
        } else {
            this.outputText(
                "“<i>You’re pretty impressive, you know?  You’ve even gotten me a little homesick, coming in here looking like that.  How cruel. How cruel....</i>”  She presses a finger to her lips, thoughtfully.  Then she smiles, taking you by the hand and drawing you into the cave. “<i>I know!</i>” She says in a sing-song voice.  “<i>Since you came stomping around here so rudely, it’s only right that I get to discipline you, right?  So, in return for me letting you leave... I get to do whatever I want to you in the meantime.</i>”\n\n"
            );
        }
    ...
    protected fuckinChegIt(): void {
        ...
        this.outputText(
            "Spotting an opening, you decide to beat a hasty retreat, as far away from the immense woman as possible.\n\n"
        );
    ...
    protected fightTheFuckhugeOni(): void {
        ...
        if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 0) {
            this.outputText(
                "You don’t know what Izumi is thinking, but there’s no way you’re just going to lie back and let some strange woman walk all over you, metaphorically <b>or</b> literally - and you tell her exactly that.  To your surprise, rather than lunging forwards to attack or flying off the handle, she actually beams at you.\n\n"
            );
            ...
            if (this.player.tone <= 75)
                this.outputText(
                    "“<i>Alright!  I’ll tell you what I’ll do... I’ll give myself a handicap.</i>”  Izumi turns to face you, cracks her neck, then extends a hand, folding the other arm behind her back.  “<i>I’ll only use one arm.  I wouldn’t want to put you in your place </i>too<i> quickly.  Where would be the fun in that?</i>”  She leers.\n\n"
                );

            this.outputText(
                "“<i>If you can beat me, I’ll let you go.  If not, well... to the victor go the spoils.  Know what I mean?</i>”  She says, her smirk somehow growing perceptibly wider.\n\n"
            );

            if (this.player.tone <= 75)
                this.outputText(
                    "The idea that she thinks she can beat you with one hand behind her back is insulting to say the least, but on the other hand, her overconfidence could be her downfall.\n\n"
                );

            this.outputText(
                "You nod, rising to your [feet] and dropping into a fighting stance. Izumi grins.  “<i>Let me just say this to start... I am </i>quite<i> strong.</i>”\n\n"
            );
        }
        // PC won last fight
        else if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 3) {
            this.outputText(
                "“<i>So, you’re not gonna apologize?!</i>” Izumi scowls at you, blushing slightly. “<i>You’re a real jerk, you know that?  Fine then, I’ll just have to spank some manners into you!  Don’t cry!</i>”\n\n"
            );

            this.outputText(
                "She drops into a fighting stance once again, but this time, instead of bending one arm behind her back, she hesitantly holds it up in front of her horn.  Her blush deepens as you stare at her.  “<i>Y-You cheat! I’m not falling for that kind of thing again!</i>” she explains hotly.\n\n"
            );
        }
        // PC lost last fight
        else if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 1) {
            this.outputText(
                "There’s no way you’re just going to lie back and let Izumi walk all over you again; at least, not without resistance.\n\n"
            );

            this.outputText(
                "“<i>Alright! I’ll tell you what I’ll do... I’ll give myself a handicap.</i>”  Izumi turns to face you, cracks her neck, then extends a hand, folding the other arm behind her back.  “<i>I’ll only use one arm.  I wouldn’t want to put you in your place </i>too<i> quickly.  Where would be the fun in that?</i>”  She leers, “<i>If you can beat me, I’ll let you go.  If not, well... to the victor go the spoils.  Know what I mean?</i>”\n\n"
            );

            this.outputText(
                "You nod, rising to your feet and dropping into a fighting stance.\n\n"
            );
        }
        // PC ran away
        else if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 2) {
            this.outputText(
                "Sooner or later, you’re going to have to face up to the large Oni.  No time like the present, right?\n\n"
            );

            this.outputText(
                "Izumi can clearly tell that you have no intentions of running away on her... again.  To your surpise, rather than lunging forwards to attack or flying off the handle, she beams at you.  “<i>Alright! I’ll tell you what I’ll do... I’ll give myself a handicap.</i>”  Izumi turns to face you, cracks her neck, then extends a hand, folding the other arm behind her back.  “<i>I’ll only use one arm.  I wouldn’t want to put you in your place </i>too<i> quickly.  Where would be the fun in that?”  She leers, “<i>If you can beat me, I’ll let you go.  If not, well... to the victor go the spoils.  Know what I mean?</i>”\n\n"
            );
        } else {
    ...
    protected fuckhugeOniGetsWhatSheWants(): void {
        ...
        if (this.player.hasCock()) {
            this.outputText(
                "You swallow your pride and shake your head, signalling Izumi that you don’t intend to resist.  Her face splits into a truly lascivious grin and she licks her lips, hungrily.\n\n"
            );

            this.outputText(
                "“<i>Yeah, that’s what I thought.</i>”  She smirks.  “<i>You just do exactly what I say, when I say, and nothing bad will happen to you.  Well... Nothing <i>too</i> bad, anyway.</i>”\n\n"
            );

            this.outputText(
                "Suddenly, she lunges forwards, one enormous hand planting itself onto your"
            );
            ...
            this.outputText(
                "  You grunt from the impact and try to sit up, but Izumi easily restrains you with a single well-muscled arm.  “<i>Well now, let’s see what we’re workin’ with here, shall we?</i>” she announces casually, as she pulls aside your [armor] to reveal your cock.\n\n"
            );
    ...
    protected surrenderSmallCock(): void {
        this.outputText(
            "“<i>Ohhh!</i>”  She positively purrs as her eyes fall upon your naked [cock biggest] for the first time.  “<i>What’s this?</i>”  She leans forwards to stare at your genitals with undisguised interest.  “<i>Well, now... I figured you [race]s would be pretty"
        );
        if (this.player.isTaur()) this.outputText(" big");
        else this.outputText(" small");
        this.outputText(
            ", but this isn’t what I was expecting at all.  Hmm... I </i>was<i> planning on giving you a handjob, but, uh... I guess this’ll have to do, huh?</i>”  She gives you an almost apologetic smile as she holds up her hand, thumb and forefinger curled into a ring as though to show you what she has planned, before reaching back down to your groin. Her fingers slide over your stiffening flesh and you realize in a flood of soul - crushing embarrassment that she’s right.  You’re so small, she actually can’t fit more than two fingers around your cock at a time.\n\n"
        );
        ...
        if (this.player.biggestTitSize() >= 1 && this.player.biggestTitSize() < 3)
            ...
            this.outputText(
                ", your [chest] moulding themselves against the underside of the Oni’s larger pair."
            );
        else if (this.player.biggestTitSize() >= 5 && this.player.biggestTitSize() <= 8)
            this.outputText(
                ", your [chest] compressing against the Oni’s larger pair, forming a delicious valley of flesh between your bodies."
            );
        else this.outputText(", your [chest] dwarfing the larger womans own pair.");

        this.outputText(
            "  “<i>There.</i>”  She announces happily, softly stroking your cheek as though to reassure you.  “<i>All better now, right?  Good.</i>”  She doesn’t even wait for a response before turning her attention back to your [cock biggest]....\n\n"
        );

        this.outputText(
            "Izumi holds you there easily, pinned against her chest as she slowly coaxes your stiffening erection to life, and you finally realize that you’re completely trapped.  If there ever was a chance for you to slip free and escape from this situation you must have missed it, because now you’re locked in the embrace of those strong, iron-muscled arms, all you can do is feel intimidated.  As Izumi casually molests you, you can’t help but realize how much more powerful than you she seems - how much stronger and more confident in everything she does.  At this moment, you feel as though if she desired, she could do anything she wanted to you"
        );
        ...
        if (this.player.hasVagina())
            this.outputText(
                ", sticky moisture dribbling across your thigh, your [vagina] clenching in lust - fueled harmony with your cock"
            );
        this.outputText(
            "... “<i>Hey, don’t get upset.  After all, </i>” She pauses for a moment, her hand lingering in place.  “<i>Some women </i>like<i> ‘em small...</i>”\n\n"
        );

        this.outputText(
            "“<i>So, let me guess.  In a place like this, it’s gotta be weird having something this small, right?  I mean, it’s a pretty unique trait, given the circumstances.</i>”  She continues.  “<i>Hey, tell me something.  Do the harpies leave you alone?  Are you so small that they think you’re "
        );
        ...
        if (this.player.balls > 0)
            this.outputText(
                " and her free fingers reach out to gently stroke against your [balls]."
            );
        else if (this.player.hasVagina())
        ...
        this.outputText(
            "  At the same time, she leans in close to your ear.  “<i>Do the </i>Minotaurs?”  She hisses suggestively, eyes flashing.\n\n"
        );

        if (this.flags[kFLAGS.MINOTAUR_CUM_ADDICTION_STATE] >= 1) {
            this.outputText(
                "The moment the word ‘Minotaur’ enters your lust-addled brain, your body shifts over to automatic. Your [cock biggest] twitches painfully, loins longing for the release that can only come from being filled full of gallons of hot Minotaur cream, and you let out a distinctly feminine sounding moan as depraved fantasies of being roughly taken by the bull-men rush through your head.\n\n"
            );

            this.outputText(
                "Izumi leers shamelessly at your reddening face, then whispers, softly into your ear.  “<i>Dirty [boy]....</i>”  You realize that she knows exactly what you’ve been doing - or rather, what’s been repeatedly doing <i>you</i> - and that shameful revelation combined with the burning arousal you feel from the very thought of minotaur cum is more than enough to force you over the edge into a sudden orgasm.  Far from being upset, Izumi seems positively overjoyed at your premature ejaculation.\n\n"
            );

            this.outputText(
                "“<i>Ahaha, well now, look at that!</i>”  She cries, beaming.  “<i>I guess I called it right, hmm?  Geez, did the minotaurs do something to you, or were you always this perverted?</i>”  Izumi snickers.  You can’t even muster up the energy to respond, you’re so drained from your sudden orgasm.\n\n"
            );
        } else {
            if (!this.player.isTaur())
                this.outputText(
                    "As you squirm in her arms, she releases your head from her grip, instead pushing you up into a seated position."
                );

            this.outputText(
                "“<i>Hold on, I want to watch this.</i>”  She says, shifting position until her head is placed on one side of your hip, staring at your [cock biggest]"
            );
            if (!this.player.isTaur())
                this.outputText(
                    " as one arm reaches around to continue the handjob from the other side"
                );
            this.outputText(
                ".  She stares intently at your cock, an expectant smirk plastered over her face, her free hand working"
            );
            if (this.player.isTaur()) this.outputText(" over your flank");
            else this.outputText(" you over with increased vigour");
            this.outputText(
                ".  Before you know it the combination of her skilled fingers and the bizarre, embarrassing sensation of being so carefully observed are pushing you over the edge.  Rather than leaving off as you cum, Izumi’s handjob actually speeds up, her eyes widening in excitement as your orgasm floods through you.  The sensation is much more powerful than you usually experience, perhaps due to Izumi’s extensive teasing, and you can only sit and shudder, staring down at yourself in shock as your [cock biggest]"
            );
            ...
            if (this.player.cumQ() <= 100)
                ...
                this.outputText(
                    " spurts and splutters a hot, sticky mess onto the cold cavern floor."
                );
            else if (this.player.cumQ() > 250) {
                this.outputText(
                    " shoots out rope after rope of hot, sticky cum across the cold cavern floor"
                );
                if (this.player.cumQ() > 500) {
                    this.outputText(
                        ", a small puddle of creamy-white forming between you and the cavern wall"
                    );
    ...
    protected surrenderMediumCock(): void {
        ...
        this.outputText(
            "“<i>So, I guess we can start now.</i>”  Says the Oni as she drops into position,"
        );
        if (this.player.isTaur())
            this.outputText(
                " perching her muscular ass on your flank, your lower body offering a comfortable seat for Izumi."
            );
    ...
    protected surrenderMediumCockObey(): void {
        ...
        this.outputText(
            "Finally, she relents, and your extended orgasm mercifully subsides.  Izumi stares indulgently down at your shivering form for a moment, before muttering a quiet “<i>Heh,</i>” and wandering back over to her tent.  You can only manage to rest there, laid prone in a"
        );
        if (this.player.hasVagina()) this.outputText(" mixed puddle of your own fem-slime and");
        else this.outputText(" puddle of your own");
        this.outputText(
            " cum, staring at the cavern roof and panting madly for a good few minutes afterwards.  Once you regain the use of your legs, you retrieve your clothes and wander back to camp in a daze.\n\n"
        );
    ...
    protected surrenderMediumCockRefuse(): void {
        ...
        this.outputText(
            "“<i>Fine.</i>”  Izumi says, apparently unconcerned.  “<i>Go ahead and try.  It won’t do you any good.</i>”\n\n"
        );
        ...
        this.outputText(
            "You cry out in anger and pain as you find your impending orgasm so cruelly denied, your [cock biggest] twitching and throbbing painfully"
        );
        if (this.player.hasVagina()) this.outputText(", [vagina] spasming in sympathy");
        this.outputText(
            ", desperate for release.  Somehow, she could sense you were on the verge of orgasm, and she chose to deny you that pleasure, you just <b>know</b> it.  You shoot Izumi a vicious, hateful glare, only to see her laying there quite calmly, her expression blank.\n\n"
        );

        this.outputText(
            "“<i>Hm?</i>”  She grunts, looking surprised.  “<i>Oh, do you want some help?  Sure; here, let me handle this for you.</i>”  She says, her tone even.  She reaches out and, very deliberately, softly flicks your [cockhead] with a single finger.\n\n"
        );

        this.outputText(
            "The sensation is almost nothing, but as close as you are, it’s just enough.  You groan in a mix of pleasure and heartbroken anguish as the tiny amount of contact forces you over the edge, your load forcing its way up through your cock with agonizing slowness until finally"
        );
        if (this.player.cumQ() <= 250)
            this.outputText(
                " spurting free, spattering down randomly over you as Izumi watches, happily observing the effects of your ruined orgasm."
            );
        else if (this.player.cumQ() <= 500)
            this.outputText(
                " sputtering freely from your [cock], glob after glob of thick jizz showering down randomly over you as Izumi watches, mildly amused with the results of your ruined orgasm."
            );
        else if (this.player.cumQ() <= 1000)
            this.outputText(
                " a torrent of fertile spunk rushes forth from your [cock], glob after glob of thick jizz showering down randomly over you, covering you from head to toe.  Izumi simply watches, amused with the results of your ruined orgasm."
            );
        else
            this.outputText(
                "a torrent of fertile spunk rushes forth from your [cock], rope after rope of the thick cum launching into the air and splattering down over you.  Your orgasm continues unabated as you slowly paint yourself in a creamy white layer, Izumi giggling quietly, evidently quite proud of herself."
            );
        this.outputText(
            "  Finally, you finish cumming, and as you lay panting in the results of her handiwork, Izumi gently pats you on the head.\n\n"
        );

        this.outputText(
            "“<i>So, you learned something today, right?  Next time, just do what I say, and the results are much more... fun.</i>” She smiles, then turns away.  Retrieving your clothes, you drag yourself back to camp, feeling decidedly shaky.\n\n"
        );
    ...
    protected surrenderLargeCock(): void {
        ...
        this.outputText(
            "“<i>Six!</i>”  She shouts, suddenly, making you flinch in surprise as her right hand snaps out and latches onto your cock, just below the sensitive [cockHead biggest].  Izumi grins, slowly rotating her wrist and wringing her hand around in place, but she doesn’t start up any kind of up-and-down motion - yet.\n\n"
        );

        this.outputText(
            "“<i>Five!</i>”  She yells, and her left hand joins the first in gripping your cock, this time about halfway down your shaft.  Again, her wrist rotates gently as she massages the area, but her hand doesn’t actually go anywhere.  Her grin widens into a truly ominous smile as she leans forwards conspiratorially.\n\n"
        );

        this.outputText(
            "“<i>Four.</i>”  She whispers, and without warning her legs unfold, both feet flying out from beneath her and latching onto the [sheath] of your [cock biggest]!  Izumi leers at you with undisguised amusement as she watches your reaction to the sensation of her bare soles rolling over the [sheath] of your shaft"
        );
        if (this.player.balls > 0 && !this.player.hasVagina())
            this.outputText(
                ", occasionally sliding down to massage your [balls] before returning to your cock."
            );
        ...
        this.outputText(
            " onto the ground, staring up at the roof of the cave in a daze.  After a few seconds, Izumi’s face appears in your field of vision, albeit upside down.\n\n"
        );

        this.outputText(
            "“<i>Haha... Sorry about that, but I didn’t want you to ruin my clothes, you know?</i>”  She half-apologizes, giggling.  “<i>Hmm... maybe that move was a little much to try on a [race].  I just thought that since you were a little more... <i>robust</i> than most others of your kind that I’ve met, you’d be able to take it.  I did try to warn you, although... It seems like you enjoyed yourself anyway, hmm?</i>”  She beams.  You can barely find the energy to blink, let alone to muster a response.\n\n"
        );
    ...
    protected surrenderOhGodTheFemaleSurrenderContentIsFuckingHugeSendHelp(): void {
        ...
        if (this.flags[kFLAGS.IZUMI_TIMES_SUBMITTED] == 0) {
            this.outputText(
                "  Before you can remove your clothes, however, Izumi grabs a hold of your wrist.\n\n"
            );
            ...
            if (this.player.cor <= 33)
                this.outputText(
                    "  You can’t help but feel a crippling sense of embarrassment as the strange woman undresses you, and you look away, embarrassed, while Izumi’s hands explore your body."
                );
            else if (this.player.cor >= 66)
                this.outputText(
                    "  As Izumi slowly reveals your naked body to the world, you begin to feel an oh-so-familiar heat building up inside of you.  You look down at Izumi with pride as she inspects your body, running a skillful hand over your chest with a thoughtful look on her face."
                );
            this.outputText("\n\n");
            ...
            if (this.player.biggestTitSize() >= 15) {
                this.outputText(
                    "Izumi’s eyes widen in surprise as she pulls aside your clothing to reveal your impressive bust, your [chest] finally free.\n\n"
                );
                ...
                this.outputText(
                    "“<i>How shameless.</i>”  She grumbles, returning her gaze to your bust.  “<i>How utterly shameless....</i>”\n\n"
                );
            }
        } else {
            this.outputText(
                "Before you can finish removing your clothes, Izumi grabs a hold of your wrist.  She takes over, placing herself firmly in charge of your state of dress.\n\n"
            );
        }
        ...
        if (this.flags[kFLAGS.PC_FETISH] >= 1) {
            ...
            this.outputText(
                " as Izumi stares at your proudly displayed chest, enjoying the sensation of being watched and idly wishing you had something to fill the aching void"
            );
            if (this.player.isNaga())
                this.outputText(
                    " deep within your [vagina].  You slither around in place, your [leg] shifting and weaving around, moving and undulating... b"
                );
            else
                this.outputText(
                    " between your [legs] as well.  As you move your weight repeatedly from one [foot] to the other, you shiver in enjoyment.  B"
                );
            this.outputText(
                "eing stared at feels so good.... You blink, suddenly called back to reality by Izumi’s voice.\n\n"
            );
            ...
            this.outputText(
                "“<i>There.  See?  I ain’t so bad.</i>”  Izumi smiles again, still apparently oblivious to your fun at her expense.  “<i>Now, we get to move on to the good part.  You ready? </i>” She asks.  You smile and nod, still basking in the post-coital warmth of your inner glow.\n\n"
            );
        }
        ...
        if (!this.player.isTaur()) {
            this.outputText(
                "Without warning, Izumi violently lunges forward, grabbing at you.  You are only able to let out a surprised yelp before she grips onto your arms, pulling you towards her and spinning you around."
            );
            if (!this.player.isNaga())
                this.outputText(
                ...
                this.outputText(
                    "  She takes hold of your shoulders and forces you lower to the ground, forced to slither more and more of your tail out from under yourself, until Izumi towers over you.  She circles behind you, a cruel smirk the only hint of her intentions."
                );
            this.outputText("\n\n");
    ...
    protected surrenderFemaleNonExhibitionVariant(): void {
        ...
        if (this.player.biggestTitSize() <= 2) {
            ...
            this.outputText(
                "“<i>It’s fine.  Relax, kitten; I don’t care what kind of crazy kinks you think you need to get yourself off,</i>” She murmurs, reassuringly. Then you feel her hand take gentle hold of your wrist. “<i>But I </i>do<i> want to see it happen...</i>” She adds"
            );
            if (!this.player.isTaur())
                this.outputText(
                    ", guiding your hand down to your own nethers, which you’re shocked - in a foggy, distant kind of way - to discover are sopping wet"
                );
            this.outputText(".\n\n");
            ...
            this.outputText(
                "“<i>Come back any time, sweet-stuff,</i>” She says, blowing you a kiss as she wanders back to her pipe. “<i>Always got time for cute little morsels like you.</i>” You nod, absently, as you stagger from the cave and make your way back to camp.\n\n"
            );

            this.outputText(
                "A schoolgirl outfit would be a pretty kinky thing to own, you have to admit...\n\n"
            );
        }
        // C-Cup+
        else {
            this.outputText(
                "“<i>Hrm.. Not bad, I guess. Not bad at all,</i>”  Izumi grunts, somewhat appreciatively, as she manhandles your rack with skilled, articulate fingers. “<i>Yeah, I’d say you’re just about the right size here.</i>”  Her hands glide over your ample bust, examining it in detail, the soft sensation of her palms gliding over your bare skin, coaxing your nipples to hardness, gently squeezing or massaging the flesh, all of it feeling decidedly good.\n\n"
            );
            ...
            if (this.player.isNaga()) this.outputText(" over your [hip].");
                ...
                this.outputText(
                    " between your thighs, slapping them lightly to force you to open them wider."
                );
            this.outputText(
                "  The pressure of her breasts pushing into your back increases as she draws you into a one armed hug, resting her chin on your shoulder and nuzzling her face into your neck.  “<i>Let’s play!</i>”  She announces in a cheery, sing-song voice.  Then her tongue snakes out, feeling inhumanly long as it slides across your flesh from the base of your neck to your cheek.  “<i>Well, I say ‘let’s’... don’t worry, kitten. I’m just gonna mess your head up for a little while, that’s all.  I’ll try not to make you swear off men for good, though...</i>”  She chuckles breathily into your ear as her questing hand snakes"
            );
            if (this.player.isNaga()) this.outputText(" along");
            else this.outputText(" between");
            this.outputText(
                " your [legs] to trail ever-so-softly over your nethers, a feather-light touch clearly designed to leave you wanting more.\n\n"
            );
            ...
            if (this.player.looseness() <= VAGINA_LOOSENESS_NORMAL)
                this.outputText(
            ...
            else if (this.player.looseness() >= VAGINA_LOOSENESS_GAPING)
                this.outputText(
            ...
            this.outputText(
                "“<i>I guess someone’s been busy, huh? And here was me thinking you were a nice girl.</i>”  Izumi teases.  “<i>Well, I guess we can skip the foreplay then....</i>”\n\n"
            );
            ...
            this.outputText(
                "Finally, you realize - with a slight note of disappointment - that Izumi has finished, her hand snaking back down"
            );
    ...
    protected surrenderFemaleExhibitionVariant(): void {
        ...
        this.outputText(
            "For some reason, you find that idea to be quite possibly the hottest thought you’ve ever had.  You’re surrounded by a ring of barely-unseen onlookers, all waiting to see you get fucked, many of them already masturbating just at the sight of your naked form.  Without a moment’s hesitation"
        );
        if (this.player.isBiped()) this.outputText(", you spread your legs a little wider,");
        this.outputText(" you");
        this.outputText(
            " arch your back a little further, muscles straining as you struggle to present a better view to your audience.  You moan with greater enthusiasm, hoping to draw in a larger crowd.  You feel Izumi’s breasts shake, pressed up against your back, as she chuckles to herself.\n\n"
        );

        this.outputText(
            "“<i>Get off on being watched, huh?  That’s kinda slutty, you know?  Well, I don’t mind playing you in front of a crowd,</i>” She purrs into your ear.  “<i>But if you’re <b>that</b> kind of kinky, maybe you wanna try a little... Audience participation?</i>”\n\n"
        );
    ...
    protected surrenderFemaleLookitYouTheCenterOfAttentionYouSlut(): void {
        ...
        this.outputText(
            "“<i>Hey out there!  Turns out my friend here is just too big a slut to resist the smell of some juicy cock, and you got her all riled up.  So, with that in mind,</i>” She announces, loudly.  “<i>She’s up for public use.  Who’s first?</i>”\n\n"
        );
        ...
        this.outputText(
            "“<i>Lucky number one!</i>”  Izumi extends a hand towards you in an expansive gesture.  “<i>She’s all yours.  Pick any hole, she’s too cockhungry to care.</i>”  The imp eyes you up for a moment, then steps onto your"
        );
        if (this.player.isBiped()) this.outputText(" thighs");
        else this.outputText(" [legs]");
        this.outputText(
            ", pulling aside his loincloth to reveal his raging erection.  It bobs up and down, the bulbous head mere inches from your face.  “<i>Well?</i>”  Izumi asks.  “<i>What are you waiting for?  Get started, slut!</i>”\n\n"
        );
        ...
        this.outputText(
            ", sucking on an imp’s cock like it was candy.  Suddenly, it doesn’t seem nearly so bad.\n\n"
        );

        this.outputText(
            "“<i>You wanted to give them a show, right?</i>”  Izumi whispers to you, still grinning.  You nod your head as best you can around the stiff phallus invading your mouth.  “<i>Well then, in that case...  do it right, you stupid slut!</i>”  She roars suddenly, grabbing you by the back of the neck and forcing your face down onto the imp’s cock.  You gag and squeak in surprise as you find your nose suddenly pressed up against his stomach, his thick meat invading your throat, cutting off your air.\n\n"
        );

        this.outputText(
            "“<i>This crowd came here to see a whore getting fucked, not to see some amateur try her best.  If you aren’t gonna try, I’ll do it for you.</i>”  Izumi’s expression is almost feral with lust as she forces you into a brutal"
        );
        ...
        this.outputText(
            "The imp pulls himself free of your mouth, staggering away to the safety of the rocks.  More importantly however, you realize that the ring of spectators has begun to close in, apparently satisfied that they’re no longer confined to just spectating.\n\n"
        );

        this.outputText(
            "“<i>Hope you’re ready for round two.</i>” Izumi mutters.  You can’t help but nod, smiling hungrily as you eye the approaching crowd.\n\n"
        );
    ...
    public fuckedUpByAFuckhugeOni(titLoss = false): void {
        ...
        if (this.player.HP <= 0) {
            this.outputText(
                "You fall to the ground, reeling from Izumi’s iron-hard muscles - and other parts besides.  Grinning widely, Izumi visibly relaxes, satisfied that you’re in no fit state to continue fighting.\n\n"
            );
        } else if (this.player.lust >= 100) {
            this.outputText(
                "You fall to the ground, too horny to resist further against the Oni’s iron-hard muscles - and other parts beside.  Grinning widely, Izumi visibly relaxes, satisfied that you’re in no fit state to continue fighting.\n\n"
            );
        }

        this.outputText(
            "“<i>So, it’s my win!</i>”  She announces, gleefully.  “<i>And you know what that means, right? It’s </i>playtime....”  The enormous woman looms over you, and you suddenly find yourself feeling distinctly nervous...  without warning, Izumi drops to her hands and knees and leans forwards, her leering face inches from your own.  With her arms on either side of you and her face filling your vision, you can’t help but feel a little enclosed. “<i>Let’s have sex!</i>”  She cries, then looks down towards your crotch, raising a hand threateningly.\n\n"
        );
        ...
        this.outputText(
            "You hesitate.  It seems like she’s being honest about letting you go, which is unexpected to say the least.  If you wanted to, you’re pretty sure you could just get up and"
        );
        if (this.player.isNaga()) this.outputText(" slither");
        ...
        if (this.player.lust >= 75)
            this.outputText(
                " the idea of sex with Izumi <i>is</i> quite a tantalizing prospect.  F"
            );
        else this.outputText(" f");
        this.outputText(
            "rom your position, you can clearly make out how tightly her kimono clings to her substantial assets, how only a thin scrap of material dangling between those powerful thighs - not even reaching low enough to touch the floor - obscures your vision and prevents you from seeing <i>everything</i>."
        );
        if (this.player.lust >= 75)
            this.outputText(
                "  Despite yourself, you have to wonder exactly what it would feel like to slide between those giant sweat-slicked thighs, bury your face into Izumi’s mountainous bust, and just let your libido run wild."
            );
        this.outputText("\n\n");
    ...
    protected lossSceneLeave(): void {
        ...
        this.outputText(
            "“<i>Feel free to come back if you want me to clean your clock again, yeah?</i>”  She calls after you with a grin.  You shake your head ruefully as you make your way down the mountain and back to your camp.  Overall, that could have gone better, but it could have gone a lot worse, too.\n\n"
        );
    ...
    public deathBySnuSnuIMeanGiantOniTits(): void {
        ...
        this.outputText(
            "“<i>Ah!</i>”  Izumi yelps. “<i>Greedy!</i>”  She chides, grinning down at you as you simultaneously grope both of her breasts.  You couldn’t care less though, you’re so enflamed by lust at this point that all you can think about is enjoying yourself as much as possible; bringing one of Izumi’s nipples to your mouth, you latch onto her breast and suck powerfully, eliciting a hiss of pleasure from Izumi.  Judging by how Izumi’s breasts begin to heave and shiver under you as her breathing quickens, she seems to be enjoying this almost as much as you are.  Sure enough, after only a few moments, Izumi’s hand snakes down to stroke through your hair, gently but insistently holding you over her breast to continue your oral assault.\n\n"
        );

        if (this.player.tallness <= 60) {
            this.outputText(
                "At the same time, the arm gripping your waist slides downwards too, hooking under your [butt] almost like some kind of seat, freeing you to keep grinding your needy cock"
            );
            ...
            if (this.player.biggestCockLength() <= 5) {
                this.outputText(
                    "  “<i>Hmph.</i>” Izumi grunts, smirking as she cups your balls.  “<i>Just like a baby... in more ways than one, am I right?</i>”  She continues, extending her middle finger to stroke the entirety of the underside of"
                );
                ...
                if (this.player.totalCocks() > 1) this.outputText("s");
                this.outputText(
                    ", from tip to base, as your hips roll into your backstroke.  You shiver in embarrassment, causing Izumi to snort with amusement.\n\n"
                );
            }
        }
        ...
        this.outputText(
            "“<i>Hey, you’re getting close, right?</i>”  She asks. You nod vigorously, but she continues anyway. “<i>You’re gonna do it, right?  You’re gonna cum, just from this, just from rubbing up against me.</i>” You nod even more desperately, feeling your orgasm already starting to rise up inside you.  Izumi actually pants, looking almost as aroused as you feel.  “<i>That’s okay... that’s good.  Go ahead and cum, okay?  I want to see if you can really blow your load just from a little frottage...</i>” Frottage.  You make a mental note to remember that word.  If that’s the name for this, it might be worth knowing, you think.  Then, at long last, your orgasm hits.\n\n"
        );

        this.outputText(
            "You positively explode, throwing open your mouth and howling in ecstasy as your long-awaited orgasm bursts out of you.  You feel a jet of hot, warm goo pulse free from"
        );
        if (this.player.totalCocks() > 1) this.outputText(" each of");
        this.outputText(" your iron-hard cock");
        if (this.player.totalCocks() > 1) this.outputText("s");
        this.outputText(
            "... only to splatter instantly against the insides of your [armor].  Your eyes go wide as you realize in a rush of embarrassment that you forgot to even so much as slip your cock"
        );
        if (this.player.totalCocks() > 1) this.outputText("s");
        this.outputText(
            " free before humping yourself to a climax against Izumi’s stomach.  The realisation does nothing to hinder your orgasm, however - and may even have heightened it - as surge after surge of baby batter explodes free from your erection"
        );
        if (this.player.totalCocks() > 1) this.outputText("s");
        ...
        this.outputText(
            " relentless demands.  Puffing and panting, you manage to raise your head enough to look up at Izumi, still wearing that everpresent smirk.\n\n"
        );

        this.outputText(
            "“<i>Aw, what’s the matter?</i>”  She says, reaching down and gripping at your aching bulge.  You groan at the sensation of your own slime being used as lubricant to wring a couple more drops from your aching body.  “<i>Couldn’t even wait to get your clothes off?</i>” She laughs, but there’s no malice there.  Izumi lowers you gently back down until you’re standing on the floor once again, on somewhat unsteady legs.  \n\n"
        );
    ...
    protected cowedIntoPuttingItInIntoHerGiantOniButt(): void {
        ...
        this.outputText(
            "“<i>Hey,</i>”  Izumi whispers, fingers rolling tantalizingly over [eachCock].  “<i>Let’s try something dirty...</i>”\n\n"
        );

        this.outputText(
            "She pushes you gently onto your back, pulling your clothes aside and freeing your erection"
        );
        if (this.player.totalCocks() > 1) this.outputText("s");
        this.outputText(
    ...
    protected littleChampLittleChampFuckhugeOniIsCominTaEatcha(): void {
        ...
        this.outputText(
            " in an extremely uncomfortable position.  Izumi’s grin becomes positively feral as she tears your clothing free before"
        );
        if (!this.player.isNaga())
            this.outputText(
                " grabbing onto your other ankle, forcibly spreading your legs apart and leaving you creating a very undignified Y-shape"
            );
        this.outputText(".\n\n");
    ...
    public touchThatFluffyHorn(): void {
        ...
        if (this.flags[kFLAGS.SILLY_MODE_ENABLE_FLAG] == true) {
            ...
            this.outputText(
                "Izumi blinks, once, twice, as the hair-raising aura dissipates almost immediately.\n\n"
            );
            ...
            this.outputText(
                "“<i>Really.  Um.  Please let go.</i>”  She says, swallowing hard and staring at nothing.  Given her sudden change of attitude, you can’t help but wonder if your grip on the horn is somehow responsible.  After all, maybe you’ve seized on the source of all her magical strength, or something?  You have no idea, so you decide to simply ask.  “<i>No.  Um.  No... It’s just, um.  T-That isn’t something you should touch.  So, y-you’ll let go now, right?</i>”  Izumi stammers.  You stare at her, fascinated by her complete change of personality; gone is the confident, domineering Oni you originally met.  Instead, Izumi, kneels nervously before you, staring intently into space and trying her level best not to move.  Interesting....\n\n"
            );

            this.outputText(
                "Experimentally, you roll your thumb over the rocky surface of the horn.  Instantly, Izumi <i>visibly</i> flinches, her eyes widening in surprise and shock.  “<i>Hey,</i>” she says, simply, her voice wavering.  “<i>Hey,</i>” she repeats. “<i>Come on now.  Enough is enough, right?</i>”\n\n"
            );
        }
        // Super awesome Gedan edit mode!
            ...
            if (this.monster.lust >= 100) {
                ...
                this.outputText(
                    "Izumi pays your attempts to distract her no mind, focused entirely on her strange ritual. You slink forwards, hoping that something a little more... hands on might do the trick. But "
                );
            } else {
                this.outputText(
                    "You dart forwards, hoping to catch Izumi off-guard while she’s distracted, but "
                );
            }

            this.outputText(
                "as soon as you get close, those crazed, staring eyes lock onto yours - "
            );

            if (this.player.spe >= 90) {
                this.outputText(
                    "her arm lunges out in an uppercutting grab, but your reflexes are faster, managing to dodge out of the way at the last moment.  Sensing an opportunity with the Oni suddenly off-balance, you make for a grab of your own - reaching out for the bright red curve of Izumi’s horn.\n\n"
                );
                ...
                this.outputText(
                    "her arm lunges out in an uppercutting grab, her fist latching around your throat and wrenching you from the floor.  Izumi is far too strong to best directly; leverage, you realize, is what you need to free yourself.  You reach out for the bright red curve of Izumi’s horn. \n\n"
                );
            } else if (this.player.tou >= 90) {
                this.outputText(
                    "her arm lunges out in an uppercutting grab, her fist latching around your throat and lifting you from the floor.  Her grip is crushingly tight, but you can endure it... for now, at least.  Looking to respond in kind, you reach out for the bright red curve of Izumi’s horn.\n\n"
                );
            } else if (
                this.player.lib >= 40 &&
                (this.player.biggestTitSize() >= 2 || this.player.biggestCockLength() >= 5)
            ) {
                this.outputText(
                    "her arm lunges out in an uppercutting grab, her fist latching around your throat and wrenching you from the floor.  You struggle, helplessly, against her arm for a moment before an idea strikes; \n\n"
                );

                if (this.player.biggestTitSize() > 2)
                    this.outputText(
                        "maybe giving her face a little personal time nestled between your [chest] will finally distract the Oni enough.  You reach out for the bright red curve of Izumi’s horn, "
                    );
                else
                    this.outputText(
                        "thinking quickly, you slip open your [armor] with one hand, bearing your [cock] to the world, your other hand reaching for the bright red curve of Izumi’s horn, "
                    );

                this.outputText("trying to force her gaze toward your ‘assets.’\n\n");
            } else {
                this.outputText(
                    "You lash out, swinging at Izumi’s face, but you can’t concentrate while being held off the floor by your neck!  In desperation, you make a grab for the one thing you can think of to try steadying yourself to brace for a strike - the bright red curve of Izumi’s horn.\n\n"
                );
            }

            this.outputText(
                "As soon as your fingers wrap around it, however, Izumi’s brutal, victorious expression changes.  Specifically, it gets a whole lot redder.\n\n"
            );
            ...
            this.outputText(
                "“<i>Um,</i>”  She says, surprisingly quietly given her formerly berserk appearance."
            );
            if (this.player.spe < 90 || this.player.str < 90) {
                this.outputText(
                    "“<i>C-Could you please let go of that?</i>” She asks, slowly sinking to her knees.  Your feet touch solid ground again, Izumi’s hand still wrapped limply around your neck, apparently forgotten.\n\n"
                );
                this.outputText("“<i>Really. Um. Please let go.</i>”");
            } else this.outputText("“<i>C-Could you please let go of that?</i>”");

            this.outputText(
                " she says, swallowing hard and staring at nothing.  Given her sudden change of attitude, you can’t help but wonder if your grip on the horn is somehow responsible.  “<i>T-That isn’t something you should touch.  So, y-you’ll let go now, right?</i>”  Izumi stammers.  You stare at her, fascinated by her complete change of personality; gone is the confident, domineering Oni you originally met.  Instead, Izumi, kneels nervously before you, staring intently into space and trying her level best not to move.\n\n"
            );
        ...
        if (this.player.hasCock()) {
            ...
            this.addButton(
                4,
                "RevengeOral",
                this.sayThatsAPrettyFaceBeAShameIfSomebodyJizzedAllOverIt
            );
    ...
    protected letGoAndFuck(): void {
        ...
        this.outputText(
            "“<i>I’ve got some gems back here somewhere...</i>” she says, but you interrupt, grabbing her sleeve and pulling her back towards you.  Deciding to take the direct route, you surprise Izumi by ambushing her with a sudden hug, burying your [face] in her expansive bust.  “<i>Huh?! I- What are you- Oh. </i>Oh!<i></i>”  She says as comprehension dawns.  “<i>You want to, uh...?</i>” she trails off, staring at you as you look up at her from your comfortable position sandwiched between her breasts - got it in one.\n\n"
        );

        this.outputText(
            "“<i>Huh,</i>”  Izumi murmurs, rubbing her chin thoughtfully.  “<i>So you get the best of me, get me in a compromising position, then just let me go ‘cause I ask... But you still wanna fuck?</i>”  You nod emphatically, causing Izumi to chuckle.  “<i>You’re pretty unusual, kid, you know that? It’s not often I run into the chivalrous type. I gotta admit, it’s a refreshing change from the ‘a penis in every hole’ crowd. Hmm...</i>”  She eyes you thoughtfully for a moment, then gives a defeated shrug, smiling broadly.  “<i>Well, ya beat me, so it looks like ya get to do whatever ya want. I’m completely at your mercy, so if you were gonna do something lewd, I guess I’d have no choice but to go along with it.</i>”  The burly woman grins"
        );
        if (this.player.tallness < 80) this.outputText(" down");
        else if (this.player.tallness > 108) this.outputText(" up");
        this.outputText(
            " at you, planting her hands on her hips.  “<i>So, what are ya gonna do to me now you’ve won, hotshot?</i>”\n\n"
        );
        ...
        this.outputText(
            "“<i>Hey,</i>” she groans quietly.  “<i>I’ve got two, you know?</i>”  She pulls her kimono aside, a blush beginning to spread across the broad plain of her features as she awkwardly presents her other breast to you. You can’t help but smirk a little as you change position slightly to suckle and grope at the new arrival instead, much to Izumi’s clear enjoyment.\n\n"
        );
        ...
        this.outputText(
            "“<i>Ahahh, hey now... not bad, kid.  Not bad at all.</i>”  Izumi leans back, allowing you to lay across her stomach while she relaxes, resting her back against the cave wall and smiling at you encouragingly.  You take the time to adjust to the new sensations enveloping your cock, steeling yourself to give Izumi the fucking of a lifetime.  Satisfied that you’re ready, you begin to move, thrusting your hips - slowly at first - into Izumi.  She wets her lips a little, one arm snaking over your back to draw you into a gentle hug,"
        );
        ...
        if (this.player.biggestTitSize() >= 1 && this.player.biggestTitSize() < 3)
            ...
            this.outputText(
                " your [chest] compressing against the Oni’s larger pair, forming a delicious valley of flesh.\n\n"
            );
        else if (this.player.biggestTitSize() > 8)
            this.outputText(
                " your [chest] dominating the Oni’s own in the battle for space between the two of you.\n\n"
            );
        else this.outputText(" pressing you into her chest.\n\n");

        this.outputText(
            "“<i>You don’t need to be so restrained.  It’s not like you’re gonna hurt me if you pick up the pace a little.</i>”  She looks away, her blush visibly deepening.  “<i>N-Not that this isn’t nice by itself, you understand, I just... you know, if ya want to, you can go faster, I don’t mind...</i>”\n\n"
        );
        ...
        this.outputText(
            "“<i>Um.  This is really nice.  I just... can you maybe do a thing for me?  It’s nothing hard!</i>” she murmurs, so quietly you can barely hear her.  “<i>D-Do you think you could maybe... you know. Touch it?</i>”  She looks away again, shyly.  You aren’t quite sure what she means at first, so you just stare at her blankly for a moment.  \n\n"
        );

        this.outputText(
            "She looks back, clocking your expression, then bites her lip.  “<i>M-My horn. Since we’re already, you know... gettin’ intimate anyway, it’s okay, so...</i>”  She trails off, clearly embarrassed beyond belief.  Feeling a little bemused, but willing to oblige, you steady yourself on one hand and reach up to gently grip Izumi’s horn with the other.\n\n"
        );
        ...
        this.outputText(
            "“<i>Haha, hahh,</i>” Izumi mutters, sounding almost regretful, “<i>Ah, geez. I really came, huh... and from you playing with my horn, too...</i>” she laments.  She covers her eyes with one hand and grins ruefully, her face still reddened from her recent orgasm.  “<i>That’s so embarrassing...</i>”\n\n"
        );
        ...
        this.outputText(
            "“<i>It’s just a little thank you gift. You know, for uh...</i>”  She winks, provocatively.  “<i>Services rendered?</i>”  Smiling, you make your way back to camp, feeling decidedly good about yourself.\n\n"
        );
    ...
    protected gonnaGetMeSomeRevengeButtsexin(): void {
        ...
        this.outputText(
            "“<i>Okay, fine,</i>” She says hotly, slipping out of her clothing. “<i>You’re just gonna take a quick look and then you’ll let go, right?  And by the way, you’re pretty perverted for making a girl strip in front of you, you know?!</i>”  She has no idea...\n\n"
        );
        ...
        if (this.player.biggestCockLength() <= 4) {
            ...
            this.outputText(
                "“<i>Fuck, I don’t-</i>”  You raise an eyebrow, your hand still raised threateningly above her reddening rump.  She glares at it for a moment.  “<i>Fine. I get it, already. It’s.. Really big, okay?  Huge.  Massive.</i>”  She growls.\n\n"
            );

            this.outputText(
                "“<i>Keep going.</i>”  You say, lowering your hand to caress her cheeks as you begin to thrust once again.\n\n"
            );

            this.outputText(
                "“<i>Yeah, keep going, I get it you little pervert...</i>”  Izumi grumbles under her breath, then speaks up, listing off your supposed amazing attributes in the same tone one might discuss the weather. “<i>You’re hung like a monster.  Okay?  I’ve never seen a dick as big and beautiful as yours.  It’s...</i>”  She grits her teeth.  “<i>It’s amazing. I’ve never felt this much pleasure from a single cock before. Uhn. Ahn.</i>”\n\n"
            );
            ...
            this.outputText(
                "“<i>Ahhn.  Nooo.  If you keep this up, I’ll become your slave.</i>”  She sighs, her voice monotone."
            );
            if (this.player.cor >= 50)
                this.outputText(
                    "  You hate to admit it, but in a messed up way, her apathy is beginning to turn you on a bit by itself.  You knew you weren’t the most well-endowed adventurer in the first place, and to someone physically huge like Izumi the problem must be magnified.  For some reason, you find that idea hot as hell....\n\n"
                );
        ...
        // Regular dicks
            ...
            this.outputText(
                "“<i>Tch, I should have known...</i>”  Izumi grumbles.  “<i>Well, whatever.  Just just hurry up and blow your load before- H-Hey wait, what are you doing back there?!</i>”  She raises her voice in alarm as your intent becomes clear, lining your [cock biggest] up not with her obediently displayed pussy, but with her asshole.\n\n"
            );

            this.outputText(
                "“<i>Hey!  W-Who said you could use that hole?!</i>” she yells.  You just flash her a charming smile, then return to the much more interesting business of getting ready to fuck her ass raw.  She glares at you for a moment, then turns back to the wall with a snort.  “<i>Whatever.  I won’t lose,</i>”  she growls.\n\n"
            );
            ...
            this.outputText(
                "“<i>Will you cut that out?!  Stop trying to get all romantic or whatever, you....  Just stop it!  Okay?!  I thought you were meant to be </i>raping<i> me!?</i>”\n\n"
            );
    ...
    protected tentacruelRevengeFux(): void {
        ...
        this.outputText(
            "“<i>H-Hey,</i>” She stammers, staring at your writhing crotch in a mixture of revulsion and fascination.  “<i>W-Why didn’t you leave some dicks for the rest of the class?!  Uh..</i>” If that was an attempt to distract you, it was sadly pointless.  Izumi yelps in what seems like actual fright as your tentacles surge forwards, snatching at her arms and legs, plunging down her neckline and <i>pulling</i>, causing her kimono to slip open and freeing her bountiful bust. \n\n"
        );

        this.outputText(
            "“<i>You’re weird!  You’re really weird!</i>” She yells, a note of panic entering her voice as she strains against your rampaging organs.  For a moment, you’re a bit worried she might actually break free of the tentacles wrapping her up - which would be, at the very least, <i>extremely painful</i> - but then you deploy your coup de grace maneuver. One of your prehensile tentacle-dicks slithers up Izumi’s grimacing face, rears back, then wraps itself completely around her horn in one seamless motion.\n\n"
        );
        ...
        if (this.player.tentacleCocks() >= 10)
            this.outputText(
                "  You decide to test the theory, snaking another prehensile appendage into each of her open, outstretched palms.  Sure enough, after a few fumbling attempts, Izumi manages to grasp the concept of a handjob and awkwardly starts to jerk them off."
            );
    ...
    protected sayThatsAPrettyFaceBeAShameIfSomebodyJizzedAllOverIt(): void {
        ...
        this.outputText(
            "You direct her to kneel down with a growl.  Izumi opens her mouth to argue, then thinks better of it.  “<i>Okay! Okay, look, I’m cooperating.  Ha ha, you sure showed me, boy is my face re-Oh.</i>” She stops, eyes widening a little as you use your free hand to pull out [oneCock], stroking it towards hardness mere inches from her face.  She stares, mesmerized, as your hand rolls up and down your stiffening erection right in front of her.  \n\n"
        );

        this.outputText(
            "You smile, and on a whim, you decide to start stroking Izumi’s horn in the same way, matching stroke for stroke.  She flinches again and her hands reach up to grip weakly at your wrist.  “<i>Hands down!</i>” you bark, and they fall away instantly to rest on her knees, her hands clenching and unclenching repeatedly as she grits her teeth against the feeling of you rubbing at her horn.\n\n"
        );
        ...
        else if (this.player.cocks[cockIndex].cockType == CockTypesEnum.DOG)
            this.outputText(
        ...
        this.outputText(
            "“<i>Wha-</i>” she stammers hazily, but you jerk her horn powerfully upwards, causing her face to freeze up in an agonized grimace as you force her down onto her back.  Repositioning yourself, you forcibly insert your cock once again into the warm, welcoming confines of Izumi’s throat.  Unfortunately, you still can’t really get into it from this angle, but then an idea hits you.  Still buried in Izumi’s mouth, you suddenly spin around to rest one leg on either side of her face - and causing Izumi to let out an incensed squeak as your [cock biggest] swirls around inside her mouth.  You lean back, grabbing her horn with a fresh hand before releasing the by now quite awkward grip you had before.\n\n"
        );

        this.outputText(
            "From this angle, you have a much better line of approach to Izumi’s throat, giving you a far deeper maximum thrust - something you happily take advantage of almost immediately in order to fuck Izumi’s mouth in earnest."
        );
        if (this.player.balls > 0)
            this.outputText(
                "  As an amusing added bonus to your new angle, Izumi’s face actually provides a comfortable little platform for you to rest your [balls] on. You can’t help but smile when she lets out an aggravated little growl as your balls come to rest on her face for the first time, the warm air rushing in and out of her nose as she tries - and fails - not to breathe <i>too</i> deeply, providing a surprisingly pleasant sensation.\n\n"
            );
        ...
        if (this.player.cumQ() > 500)
            this.outputText(
                "  Her surprise only deepens when you simply keep cumming, your prolonged orgasm flooding her mouth faster than she can swallow, forcing her cheeks to bulge out and tiny rivulets of cum to occasionally slip free of the tight seal her lips have formed around your cock.\n\n"
            );
    ...
    protected tribThatRockyHornGirl(): void {
        ...
        this.outputText(
            "“<i>Ah, shit.</i>” She mutters, just before you push her to the ground, forcing her onto her back and swinging your leg over to straddle her chest.  She lets out a little ‘Oof!’ as you land.  You make a mental note to punish her for that, too; just what is she trying to imply, here?\n\n"
        );

        this.outputText(
            "“<i>H-Hey, listen!</i>” She stammers, wincing slightly as you run your hand exploratively over the rocky appendage protruding from her forehead. “<i>Y-You’re not really gonna do this, are you?! I mean, you’re a girl too, right? You’re not gonnauuwuugh come onnn...</i>” She trails off, twitching and shivering as you hit a particularly sensitive spot.  You can’t help but grin in anticipation as you slip out of your [armor], eyeing the horn lustily.  Izumi follows your gaze, initially failing to comprehend your intent, but then her face goes white and she grabs you by the wrist, desperately.\n\n"
        );

        this.outputText(
            "“<i>Wait!  Wait wait wait, you’re not thinking-?!</i>” She yammers.  “<i>You can’t!  You super can’t! Seriously, t-that’s dangerous!  You might hurt yourself, what are you thinking?!  And... a-and if you did that, I’d die!  I’ll really die!</i>”  To your intense surprise, she claps her hands together in front of her face and screws her eyes tight shut in fear, bowing her head in pleading submission.  “<i>Have mercy!</i>”\n\n"
        );

        this.outputText(
            "You can’t help but smirk in amusement at her misplaced terror as you realize what she thinks you’re planning to do.  Although the idea of totally overloading the big woman’s horn to see how she’d react is very tempting, you’re pretty sure forcing it inside yourself would be an incredibly bad idea; at the very least, if Izumi were to lose control of herself and start thrashing around... it is <i>close</i> to what you had in mind though.  \n\n"
        );
        ...
        this.outputText(
            "“<i>Having fun?</i>”  You ask, smiling to yourself.  Izumi’s eyes snap open, her face turning an even deeper shade of crimson than before as her eyes flicker down to her crotch.  Poor girl, you think; she might not even have fully realized what she was doing.  Well, she does now...\n\n"
        );

        this.outputText(
            "“<i>I-It’s... it’s not... s-shut up!</i>” She stammers, adding “<i>It’s not my f-fault if you keep t-touching me in weird places and I get... distracted!  </i>You’re<i> the perverted one here, not me!</i>”\n\n"
        );

        if (this.player.cor > 80)
            this.outputText(
                "“<i>Whatever.  Just try not to cum too hard while I’m making you my bitch, you little slut.</i>” You shoot back, returning"
            );
        else this.outputText("Ignoring her protests entirely, you return");
        this.outputText(
            " your attention to her horn.  Still though, there’s something missing; as fun as it is molesting and toying with the oversized lout currently protesting her innocence while buried up to the knuckle in her own cunt, you’re not quite feeling it enough to get off yourself.  Clearly, that has to change.\n\n"
        );
        ...
        this.outputText(
            "“<i>You came, didn’t you?</i>” You ask, sweetly.  Izumi trembles a little, her eyes rolling over to you.  She seems to be having trouble focusing.\n\n"
        );

        this.outputText(
            "“<i>..’es,</i>”  She croaks, almost inaudibly.  She sounds as though she’s on the verge of tears, presumably from embarrassment - you’re pretty certain you haven’t actually done anything that could hurt her.  You shake your head, chuckling to yourself as you redress and rummage through Izumi’s belongings for a trophy.\n\n"
        );

        this.outputText(
            "“<i>I’m taking this,</i>” You announce cheerfully, hefting a small bag of gems in one hand.  “<i>‘Kay.</i>” Izumi’s approval doesn’t matter to you either way, but your smile widens at her submissive, exhausted tone.\n\n"
        );

        this.outputText(
            "By the time you get back to camp, you’re almost feeling good enough to whistle."
        );
