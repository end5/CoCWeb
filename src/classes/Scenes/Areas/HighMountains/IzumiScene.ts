...
export class IzumiScene extends BaseContent {
    ...
    protected abortabortleavethefukkencave(): void {
        ...
        this.outx("You head back to camp, having found nothing else of interest.");
    ...
    protected enterFirstTime(): void {
        ...
        if (this.player.tallness >= 108) {
            ...
            if (this.player.str >= 75) this.outx(" forcing");
            else this.outx(" trying to force");
            this.outx(
            ...
            if (this.player.hornType != HORNS_COW_MINOTAUR) {
                this.outx("  Or at least, ones without a pair of bulls horns");
                if (this.actsLikeACow() == true) {
                    this.outx(" - and the temperament to match - ");
                } else {
                    this.outx(", ");
                }
            } else {
        ...
        if (this.player.tou <= 75)
            this.outx(" and of course, that obnoxiously endurance-sapping heat");
        this.outx(".\n\n");
        ...
        if (this.player.tallness < 108) {
            ...
            this.outx("Sit down, sit down!</i>”\n\n");
        }

        this.outx("Cautiously, you edge towards the lip of the fire, and");
        if (this.player.tallness >= 108) {
            this.outx(" a");
        } else {
            this.outx(" the");
        }
        this.outx(" shadow leans forward, finally becoming visible.");
        if (this.player.tallness < 108) {
            this.outx(
        ...
        if (this.player.tou < 60) this.outx(" causes you to cough and splutter.\n\n");
        else
            this.outx(
        ...
        if (this.player.tou < 60) this.outx(", kid. Let");
        else this.outx(", let");
        this.outx(
    ...
    protected enterFirstTimePartII(): void {
        ...
        this.outx("Still");
        if (this.player.tou < 60) this.outx(" struggling with");
        else this.outx(" distracted by");
        this.outx(
        ...
        if (this.player.cor <= 33)
            this.outx(" exposing an uncomfortable amount of creamy-white thigh flesh.");
        else if (this.player.cor > 33 && this.player.cor < 66)
            this.outx(" exposing a tantalising view of creamy-white thigh flesh.");
        else
            this.outx(
    ...
    protected smokeThePipe(): void {
        ...
        if (this.player.tou <= 60) this.outx(" you cough and splutter");
        else if (this.player.tou < 75) this.outx(" you flinch, holding back a cough");
        else this.outx(" your eyes water");
        this.outx(
    ...
    protected smokeJoins(): void {
        ...
        if (this.player.str <= 75 || this.player.tou <= 75 || this.player.tallness <= 96)
            this.outx("  You swallow, hard, suddenly feeling oddly nervous.");
        this.outx(
    ...
    protected fightTheFuckhugeOni(): void {
        ...
        // PC lost last fight
            ...
            this.outx("You nod, rising to your feet and dropping into a fighting stance.\n\n");
        }
        // PC ran away
        else if (this.flags[kFLAGS.IZUMI_LAST_ENCOUNTER] == 2) {
            this.outx(
    ...
    protected fuckhugeOniGetsWhatSheWants(): void {
        ...
        if (this.player.hasCock()) {
            ...
            this.outx("Suddenly, she lunges forwards, one enormous hand planting itself onto your");
            if (this.player.isTaur()) this.outx(" flank and forcing you sideways onto the ground.");
            else this.outx(" chest and forcing you backwards onto the ground.");
            this.outx(
    ...
    protected surrenderSmallCock(): void {
        ...
        if (this.player.isTaur()) this.outx(" big");
        else this.outx(" small");
        this.outx(
        ...
        this.outx("You try to look away, blushing crimson, but the weight on your");
        if (this.player.isTaur()) this.outx(" flank");
        ...
        else this.outx(" drops to the floor, laying next to you on her side.");
        this.outx(
        ...
        if (this.player.biggestTitSize() >= 1 && this.player.biggestTitSize() < 3)
            this.outx(", your [chest] dwarfed by the larger womans own pair.");
        ...
        else this.outx(", your [chest] dwarfing the larger womans own pair.");
        ...
        if (this.player.str <= 75) this.outx(" and you would be powerless to resist...");
        else this.outx(" and you would struggle to deny her will...");
        this.outx(
        ...
        if (this.player.gender == 3) this.outx(" just a regular");
        else this.outx(" a");
        this.outx(" girl?</i>”  Suddenly, her hand bottoms out around your [cock biggest]");
        ...
        if (this.flags[kFLAGS.MINOTAUR_CUM_ADDICTION_STATE] >= 1) {
            ...
            if (!this.player.isTaur())
                this.outx(" as one arm reaches around to continue the handjob from the other side");
            this.outx(
                ".  She stares intently at your cock, an expectant smirk plastered over her face, her free hand working"
            );
            if (this.player.isTaur()) this.outx(" over your flank");
            else this.outx(" you over with increased vigour");
            this.outx(
            ...
            if (this.player.cumQ() <= 100)
                this.outx(" dribbles a hot, sticky mess onto the cold cavern floor.");
            else if (this.player.cumQ() > 100 && this.player.cumQ() <= 250)
                this.outx(" spurts and splutters a hot, sticky mess onto the cold cavern floor.");
                ...
                if (this.player.cumQ() > 500) {
                    ...
                    if (this.player.cumQ() > 1000)
                        this.outx(", slowly expanding into a small lake....\n\n");
                } else {
                    this.outx(".\n\n");
                }
            }
    ...
    protected surrenderMediumCock(): void {
        ...
        this.outx("In mere moments, you’re fully erect, as hard as you’ve ever been");
        if (this.player.hasVagina()) {
            this.outx(", your [vagina]");
            if (this.player.wetness() == 0) this.outx(" moistening");
            else if (this.player.wetness() == 1)
                this.outx(" dribbling runnels of sticky fem-juice");
            else if (this.player.wetness() == 2) this.outx(" constantly oozing feminine arousal");
            else this.outx(" a soppy mess, gushing a veritable lake of fem-slime");
            this.outx(" in lust-fueled harmony with your cock.");
        } else this.outx(".");
        this.outx("  Izumi looks down at you and flashes you an indulgent smile.");
        ...
        else this.outx(" laying on her side next to you.");
        this.outx("  She releases your");
        if (this.player.isTaur()) this.outx(" flank");
        else this.outx(" chest");
        this.outx(
        ...
        this.outx("Without warning, your hips spasm and buck");
        if (this.player.isTaur()) this.outx(" upwards");
        this.outx(
        ...
        this.outx("“<i>Lay back and settle down, or I ruin your fun.</i>” she purrs.\n\n");
    ...
    protected surrenderMediumCockObey(): void {
        this.outx("Taking a deep breath, you grit your teeth and force yourself to calm down.");
        if (this.player.isTaur()) this.outx("  Y");
        else this.outx("  Lowering your shaking hips, y");
        this.outx(
        ...
        this.outx("cock");
        this.outx(" to the very last drop.\n\n");
        ...
        if (this.player.hasVagina()) this.outx(" mixed puddle of your own fem-slime and");
        else this.outx(" puddle of your own");
        this.outx(
    ...
    protected surrenderMediumCockRefuse(): void {
        ...
        if (this.player.hasVagina()) this.outx(", [vagina] spasming in sympathy");
        this.outx(
    ...
    protected surrenderLargeCock(): void {
        ...
        this.outx("Izumi releases you from the floor, allowing you to sit");
        if (this.player.isTaur()) this.outx(" back on your haunches, front end raised");
        this.outx(
        ...
        if (this.player.balls > 0 && !this.player.hasVagina())
            ...
            this.outx(", occasionally sliding down to tease at the lips of your [vagina].");
        else if (this.player.balls > 0 && this.player.hasVagina())
            this.outx(
        ...
        this.outx("Eventually, your orgasm subsides, and you collapse");
        if (this.player.isTaur()) this.outx(" sideways");
        else this.outx(" backwards");
        this.outx(
    ...
    protected surrenderOhGodTheFemaleSurrenderContentIsFuckingHugeSendHelp(): void {
        ...
        if (this.flags[kFLAGS.IZUMI_TIMES_SUBMITTED] == 0) {
            ...
            if (this.player.biggestTitSize() >= 15) {
                ...
                this.outx("“<i>Wha- Wait, these are real?!</i>”  she exclaims, loudly.");
        ...
        if (this.flags[kFLAGS.PC_FETISH] >= 1) {
            ...
            this.outx("Izumi grunts in surprise as she surveys your dripping folds");
            if (this.player.hasCock())
                this.outx(", your [cock] slowly thickening under her scrutiny");
            this.outx(".  You shift in place,");
            if (this.player.isNaga()) this.outx(" wriggling atop your [legs]");
            else this.outx(" subtly parting your [legs] and even ");
            if (this.player.isTaur()) this.outx(" rolling your butt upward");
            else this.outx(" tilting your hips forwards");
            this.outx(
            ...
            if (!this.player.isNaga()) this.outx("You rub your thighs together in delight");
            else this.outx("You wriggle and writhe in delight");
            this.outx(
    ...
    protected surrenderFemaleNonExhibitionVariant(): void {
        ...
        this.outx("“<i>Get lost, ya scummy vultures!</i>” She yells,");
        if (this.player.isTaur()) this.outx(" sitting upright on your back and");
        this.outx(
        ...
        if (this.player.hasMuzzle()) this.outx(" maw");
        ...
        // C-Cup+
            ...
            if (this.player.isNaga()) this.outx(" along");
            else this.outx(" between");
            this.outx(
            ...
            if (this.player.isNaga()) this.outx(" to");
            else this.outx(" between");
            this.outx(" your [legs] as she returns her attention to your groin.\n\n");
    ...
    protected surrenderFemaleExhibitionVariant(): void {
        ...
        if (this.player.isBiped()) this.outx(", you spread your legs a little wider,");
        this.outx(" you");
        this.outx(
    ...
    protected surrenderFemaleLookitYouTheCenterOfAttentionYouSlut(): void {
        ...
        if (this.player.isBiped()) this.outx(" thighs");
        else this.outx(" [legs]");
        this.outx(
        ...
        if (this.player.isBiped()) this.outx(" and on your knees");
        this.outx(
    ...
    public fuckedUpByAFuckhugeOni(titLoss = false): void {
        ...
        this.outx("Reflexively, you");
        if (this.player.isNaga()) this.outx(" slither");
        else if (this.player.isDrider()) this.outx(" scuttle");
        else this.outx(" scurry");
        this.outx(
        ...
        this.outx(" out of the cave without any trouble.  On the other hand...");
        if (this.player.lust >= 75)
            this.outx(" the idea of sex with Izumi <i>is</i> quite a tantalizing prospect.  F");
        else this.outx(" f");
        this.outx(
    ...
    public deathBySnuSnuIMeanGiantOniTits(): void {
        ...
        if (this.player.tallness <= 60) {
            ...
            this.outx(" into her midsection while you suck at her teat.");
            if (this.player.biggestCockLength() <= 5) {
                ...
                this.outx(" trembling, undersized prick");
                if (this.player.totalCocks() > 1) this.outx("s");
                this.outx(
        ...
        if (this.player.totalCocks() > 1) this.outx("s");
        this.outx(", coating the insides of your underwear with thick, sticky goo.\n\n");

        this.outx("Your underwear thoroughly decorated, your cock");
        if (this.player.totalCocks() > 1) this.outx("s relent");
        else this.outx(" relents");
        this.outx(", deflating and ceasing");
        if (this.player.totalCocks() > 1) this.outx(" their");
        else this.outx(" it’s");
        this.outx(
    ...
    protected cowedIntoPuttingItInIntoHerGiantOniButt(): void {
        ...
        if (this.player.totalCocks() > 1) this.outx("s");
        this.outx(" twitch in response to the sight.");
        ...
        if (this.player.totalCocks() > 1) {
            this.outx(", the cock");
            if (this.player.totalCocks() > 2) this.outx("s");
            this.outx(
    ...
    protected fuckhugeOniWantsYourBabiesOrSomeShit(): void {
        ...
        this.outx(" into her twitching pussy.\n\n");
    ...
    protected noDickNoVagNoService(): void {
        ...
        if (this.player.isNaga()) this.outx(" tail");
        else this.outx(" ankle");
        this.outx(
    ...
    protected littleChampLittleChampFuckhugeOniIsCominTaEatcha(): void {
        ...
        if (this.flags[kFLAGS.IZUMI_SEEN_PC_GENDER] != 2 && !this.player.hasCock()) {
            ...
            this.outx(" with an iron grip.  “<i>I guess I’ll just have to eat ya.</i>”\n\n");
        }
    ...
    public touchThatFluffyHorn(): void {
        ...
        this.outx("Izumi slips backwards onto one knee and holds up a hand for pause,");
        if (this.player.HP / this.player.maxHP() <= 0.1)
            this.outx(" the brief reprieve giving both of you a moment to recover.\n\n");
        else if (this.monster.lust >= 100)
            this.outx(
                " the Oni’s cheeks tinged a rosy peach in contrast to her alabaster skin.\n\n"
            );
        else this.outx(" momentarily staggered by your furious onslaught.\n\n");
        ...
        if (this.flags[kFLAGS.SILLY_MODE_ENABLE_FLAG] == true) {
            ...
            this.outx("Specifically, it gets a whole lot redder.\n\n");
        ...
        // Super awesome Gedan edit mode!
            ...
            this.outx("as soon as you get close, those crazed, staring eyes lock onto yours - ");
            ...
            if (this.player.spe >= 90) {
                ...
                this.outx("trying to force her gaze toward your ‘assets.’\n\n");
            } else {
                this.outx(
            ...
            if (this.player.spe < 90 || this.player.str < 90) {
                ...
                this.outx("“<i>Really. Um. Please let go.</i>”");
            } else this.outx("“<i>C-Could you please let go of that?</i>”");
    ...
    protected letGoAndFuck(): void {
        ...
        if (this.player.tallness < 80) this.outx(" down");
        else if (this.player.tallness > 108) this.outx(" up");
        this.outx(
        ...
        if (this.player.tallness < 80) this.outx(" from above");
        else if (this.player.tallness > 108) this.outx(" from below");
        this.outx(".\n\n");
        ...
        if (this.player.biggestTitSize() >= 1 && this.player.biggestTitSize() < 3)
            this.outx(" smothering your [chest] with her own, much larger, pair.\n\n");
        else if (this.player.biggestTitSize() >= 3 && this.player.biggestTitSize() < 5)
            this.outx(" your [chest] moulding themselves against the Oni’s larger pair.\n\n");
        else if (this.player.biggestTitSize() >= 5 && this.player.biggestTitSize() <= 8)
            this.outx(
        ...
        else this.outx(" pressing you into her chest.\n\n");
        ...
        if (this.player.biggestTitSize() > 0) this.outx(" against your own");
        this.outx(" as she gasps for air.\n\n");
    ...
    protected gonnaGetMeSomeRevengeButtsexin(): void {
        ...
        if (this.player.biggestCockLength() <= 4) {
            ...
            this.outx("“<i>Tell me how big it is.</i>”  You command.\n\n");
            ...
            this.outx("“<i>It’s big,</i>” she spits.\n\n");

            this.outx("“<i>How big?</i>” you ask, feeling pleased with yourself.\n\n");
        ...
        // Regular dicks
            ...
            this.outx("“<i>Oh, just going all the way");
            if (this.player.balls > 0) this.outx(" balls");
            else this.outx(" hilt");
            this.outx(
    ...
    protected sayThatsAPrettyFaceBeAShameIfSomebodyJizzedAllOverIt(): void {
        ...
        this.outx("You order her to stop, and you can see the confusion bloom in her eyes.\n\n");
    ...
    protected tribThatRockyHornGirl(): void {
        ...
        else this.outx("Ignoring her protests entirely, you return");
        this.outx(
