...
export class MinervaScene extends BaseContent {
    ...
    public encounterMinerva(): void {
        ...
        if (this.flags[kFLAGS.MET_MINERVA] == 0) this.firstMinervaEncounter();
            ...
            this.flags[kFLAGS.MINERVA_BACKSTORY_LEARNED] > 0 &&
            this.player.gender > 0 &&
            this.flags[kFLAGS.MINERVA_LOVE] == 0 &&
    ...
    private firstMinervaEncounter(): void {
        ...
        if (
            ...
            this.outx(" that matronly harpy, Sophie");
        else this.outx(" something interesting");
        this.outx(", or get some good plunder from some of the local beasts");
    ...
    private ignoreMinervasPath(): void {
        this.clearOutput();
        this.outx(
            "Deciding to play it safe, you turn away from the new path and continue your search elsewhere."
        );
        // PC returns to camp.
    ...
    private takeMinervasPath(): void {
        ...
        this.spriteSelect(95);
        this.outx(
            "Knowing that a new path could lead to great things, you can't help but wonder where this one could lead."
        );
        this.outx(
        ...
        if (this.player.tallness <= 96) this.outx(" one hand");
        else this.outx(" both hands");
        this.outx(
        ...
        if (this.player.isGoo()) {
            ...
            // Corruption=75>:
            if (this.player.cor >= 75) this.outx('... "<i>yet</i>", you think to yourself.');
        ...
        // High corruption:
        if (this.player.cor > 66) this.outx("  She is wise not to fully trust you.");

        this.outx("\n\nWith");
        if (this.player.isGoo()) this.outx(" your own");
        else this.outx(" a");
        this.outx(
            " relieved sigh, you take in the sight of the strange shark... harpy... harpy-shark... sharpy?  What an odd combination!  Looking the woman up and down, you take in her whole appearance."
        );
    ...
    private leaveMinervasFirstEncounter(): void {
        ...
        this.spriteSelect(95);
        this.outx(
            "You decide that you don't want to risk going into Minerva's lair as, for all you know, it could be a trap.  Therefore, you turn around and skedaddle back down the mountain.  As you leave, Minerva turns and watches you for a bit, a sad look on her face before she turns back and heads inside her home, alone."
        );
        // PC returns to camp.
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private repeatEncounterMinerva(): void {
        ...
        if (!this.minervaRomanced())
            this.outx('  "<i>Ah, [name], you have returned!  What can I do for you?</i>"');
        else
            this.outx(
    ...
    private minervaThirdPlusEncounter(): void {
        ...
        if (!this.minervaRomanced())
            ...
            this.outx(
                '  "<i>Darling!  Coming to visit me all the way out here!  How sweet of you!</i>"'
            );
        this.outx(
            "  Minerva says as she strides toward you, her generous hips swaying back and forth, as if to entice you into her arms."
        );
    ...
    private goForASkyRideWithMinervaHeartBaring(): void {
        this.clearOutput();
        this.spriteSelect(95);
        this.outx("You grin with excitement and");
        if (this.player.isGoo()) this.outx(" cling");
        else this.outx(" hold");
        this.outx(" onto the large shark-harpy, telling her that you don't mind flying with her.");
        // No or small wings:
        ...
        // Goo:
        if (this.player.isGoo())
            this.outx(" while you're barely able to maintain your slimy cohesion");
        this.outx(
    ...
    private rejectMinervasLove(): void {
        ...
        this.spriteSelect(95);
        this.outx(
            "You stare at Minerva awkwardly as she waits for your response, her electric blue eyes looking at you with hope.  "
        );
        if (this.player.cor < 45)
            this.outx(
                "The look in the siren's eyes only makes this harder for you as you look into them; you can't help but feel bad that you really don't feel anything special for her."
            );
        else
            this.outx(
                "You can tell she really wants this - the siren is almost desperate for your attention.  Unfortunately for the love starved herm, she won't find the love she craves with you."
            );
        this.outx(
            "  You look away from her and pull back a bit before speaking.  You confess to her that, while she is a nice person, you do not feel that sort of bond with her, and you apologize if she was misled by your actions, but that you would like to be friends with her still."
        );
    ...
    private talkingToMinervaAboutBackstory(): void {
        ...
        // PART 3
            ...
            // No Romance:
            if (!this.minervaRomanced())
                this.outx('  "<i>You\'re a good friend to have, and you know that, [name].</i>"');
            // Romance:
            else
                this.outx(
    ...
    private talkToMinervaAboutHerCorruption(): void {
        ...
        this.spriteSelect(95);
        this.outx(
            "Telling Mineva that you just want to talk brings a smile to her face, the siren eager to speak with you.  Guiding you over to a soft spot of moss by the spring, she sits next to you and looks into the pond, her smile slowly fading as she looks into the clear waters."
        );
        this.outx(
        ...
        this.outx('</i>" she declares sourly as she stares into the pure waters of the spring.');
        this.outx(
    ...
    private minervaMotherhood(): void {
        ...
        if (this.player.hasVagina()) {
            ...
            // friend/lover
            if (!this.minervaRomanced()) this.outx("friend");
        ...
        if (this.player.gender == 1) this.outx(" and those goblins");
        // PC vagina:
        else if (this.player.gender == 2) this.outx(" and that bee-girl");
        // PC herm:
        if (this.player.gender == 3) this.outx(", goblins and that bee-girl");
        this.outx(
        ...
        this.outx(
            ' Hearing your words brings a smile to her black glossy lips.  "<i>Thank you so much; that means a lot to me, really,</i>" she coos, her hands gingerly stroking yours before pulling away.  "<i>But... I guess we have been here for a while.  I\'m sure you have a great deal of work to do as such a brave champion.</i>"'
        );
    ...
    private noBathTime(): void {
        this.clearOutput();
        this.outx(
            'Looking down, she sighs, a brief moment passes before she returns her attention to you.  "<i>Well, that\'s all right, maybe next time.  So you wanted to talk; what would you like to know?</i>"'
        );
        this.menu();
    ...
    private minervaSexMenu(display = true): void {
        if (display) {
            this.clearOutput();
            this.spriteSelect(95);
            this.outx("You tell Minerva that, this time, you'd like to have sex with her.");
            // Default, first time:
            if (this.flags[kFLAGS.TIMES_MINERVA_SEXED] == 0) {
                ...
                // PC cock, add:
                if (this.player.hasCock())
                    this.outx(" just... not in my vagina, all right?  That's... special.");
                this.outx("  Did you have anything specific in mind?");
                // PC female, add: "
                if (this.player.hasVagina())
                    this.outx(
            ...
            // Dick Too Big - PC exceed capacity
                ...
                MinervaScene.rand(2) == 0 &&
                this.player.hasCock() &&
                this.player.cockThatFits(this.minervaACapacity()) < 0
            )
                this.outx(
            ...
            // {Repeated/No romance:
                ...
                if (this.player.hasVagina())
                    this.outx(
                        "  Since you don't seem to mind... would you like me to fuck your ass or to squeeze into your cute cunny?"
                    );
                this.outx('</i>"');
            }
            // Romanced:
        ...
        if (
            this.player.hasCock() &&
            this.player.cockThatFits(this.minervaVCapacity()) >= 0 &&
            this.minervaRomanced()
        ) {
        ...
        if (this.player.hasVagina()) this.addButton(btnIdx++, "TakeHerDick", this.minervaLapSex);
        this.addButton(btnIdx++, "EatHerOut", this.goDownOnAHermAndLoveItYouDirtySlutYou);
        if (this.player.hasCock()) this.addButton(btnIdx++, "Get BJ", this.letMinervaSuckYouOff);
    ...
    private fuckMinervasAsshole(): void {
        ...
        if (this.player.hasVagina()) this.outx(" and your [vagina]");
        this.outx(" to the open air.");
        this.outx("\n\nFeeling Minerva's bare ass rubbing against you helps coax your ");
        if (this.player.cockTotal() > 1) this.outx("shafts");
        else this.outx("shaft");
        this.outx(
            " to erectness, and you begin to teasingly drag [oneCock] through the crack of her curvy, spankable ass, hesitating to actually penetrate her until you're ready.  Your vexation brings a brighter blush to her cheeks, her tail squirming gently against you as she takes the hint.  Her hips start pushing back and forth, using her soft rounded rump to massage [eachCock], wanting to get you just as needy as she is."
        );
    ...
    private minervaCowgirlSex(): void {
        ...
        if (x < 0) x = this.player.smallestCockIndex();
        this.flags[kFLAGS.TIMES_MINERVA_SEXED]++;
        this.outx("You look the attractive siren up and down and");
        if (this.player.tallness <= 60)
            this.outx(", with some trepidation, given the difference in size,");
        this.outx(
        ...
        if (this.player.tallness < 96) this.outx(", as well as her superior size,");
        this.outx(
        ...
        if (this.player.cumQ() >= 500) {
            ...
            if (this.player.hasVagina())
                this.outx(
                    "  A few even slither down into your [vagina] to sting you there as well, making sure you are, at least temporarily, turned into a sex-hungry beast."
                );
        }
        ...
        if (this.player.cumQ() < 500)
            this.outx(", Minerva's belly visibly bloated by the time you are finished");
        this.outx(".");
        if (this.player.cumQ() < 500) {
            this.outx(
        ...
        if (this.player.cumQ() >= 500 && this.player.cumQ() < 4000) {
            ...
            if (this.minervaRomanced()) this.outx(" with your child");
            this.outx(".");
        }
        // Very High:
        if (this.player.cumQ() >= 4000) {
            ...
            if (!this.minervaRomanced())
                this.outx(
                    "  \"<i>Oohhh...I'm so... so big... It's almost like you've gotten me pregnant.</i>\""
                );
            else
                this.outx(
    ...
    private minervaLapSex(): void {
        ...
        // PC herm:
        if (this.player.hasCock()) {
            this.outx(", your own throbbing phallus");
            if (this.player.cockTotal() > 1) this.outx("es");
            this.outx(" cumming alongside,");
            // {Low-moderate cum:
            if (this.player.cumQ() < 500)
                this.outx(" gushing your cum all over both of your bellies");
            // High cum volume:
            else if (this.player.cumQ() < 4000)
                this.outx(
    ...
    private goDownOnAHermAndLoveItYouDirtySlutYou(): void {
        ...
        if (this.player.tallness < 96)
            this.outx("your fingers not even able to fit around the herm's hefty girth");
        else
            this.outx(
                "your fingers barely wrapping around the meaty member, the fat thing throbbing gently"
            );
        this.outx(
            " as you stroke it slowly.  Your touches are clearly adding to your partner's pleasure, her thick masculinity pulsating under your grip, her tentacles reacting to your presence, the dexterous things curling around your hands and fingers, touching you gently, but not stinging you."
        );
    ...
    private noBallsMinervaAndContinuation(clear = true): void {
        ...
        this.spriteSelect(95);
        this.outx(
            "Your careful ministrations soon have the poor siren shuddering and squirming, looking about ready to pop from your skilled hands and mouth."
        );
        if (!clear) this.outx("  Retreating from her throbbing balls, you");
        else this.outx("  You");
        this.outx(
            " move back up to her now soaking snatch, your tongue eagerly lapping up all the tasty juices from her lips before delving deep into her refreshingly cool cunt, hungrily licking up every slick drop of her succulent sweetness.  The act of worming your tongue back inside her hungry hole again drives Minerva ever closer to the brink of her climax, each slurp and stroke of your tongue and hands pushing the near-climactic herm right to the edge and sending her off into the blissful, pleasure-filled abyss of a mind-blowing double orgasm."
        );
    ...
    private letMinervaSuckYouOff(): void {
        ...
        // If balls:
        if (this.player.balls > 0) this.outx(" before licking and teasing your [balls]");
        this.outx(".");
        ...
        if (this.player.balls > 0)
            this.outx(
                ", while your [balls] lurch and swell, rising up as you reach your climactic explosion"
            );
        this.outx(".");
    ...
    private fuckMinervaWithHerHandsBehindHerBack(): void {
        ...
        // Holy shit!:
            ...
            if (this.player.balls > 0)
                this.outx(
                    "  Minerva groans and lets out mindless gurgles as you unload your overproductive balls into her."
                );
            this.outx(
                "  To even your amazement, her hungry womb is able to contain much of your sperm before she can take no more, each blast of potent cum now gushing from between your bodies, the floor soon looking like someone dumped a barrel full of raw milk on the ground before you're finally done."
            );
            this.outx(
    ...
    private pcGetsEatenOutByMinerva(): void {
        ...
        if (this.player.hasCock())
            this.outx(", and, perhaps, your more male parts while she's down there");
        this.outx(".");
        ...
        if (this.player.balls > 0)
            this.outx(
                ", one of her hands lifting your [balls] up before giving each of the fertile nuts a kiss"
            );
        this.outx(" and moving down to your sweet cunt, just waiting for her attentions.");
    ...
    */
    ...
    private getADrinkYouBitch(): void {
        ...
        this.dynStats("lus", -25, "cor", -0.5, "resisted", false);
