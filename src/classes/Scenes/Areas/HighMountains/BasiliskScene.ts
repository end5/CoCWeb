...
export class BasiliskScene extends BaseContent {
    ...
    public basiliskBirth(): void {
        ...
        if (this.player.findPerk(PerkLib.BasiliskWomb) >= 0) {
            ...
            if (this.player.hasCock()) this.outx(" and [eachCock] starting to leak pre-cum");
            this.outx(
            ...
            if (this.player.hasCock()) this.outx(" and a downpour of hermcum");
            this.outx(".");
            ...
            // (eggNumber)
            this.outx(BasiliskScene.num2Text(Math.floor(this.player.totalFertility() / 10)));
            this.outx(
            ...
            if (this.flags[kFLAGS.BENOIT_EGGS] > 0) this.outx(" as well");
            this.outx(
                ".  You place the egg back down and gather them all up, moving them closer to the campfire to stay warm while you recover from your exertions."
            );
            this.outx(
    ...
    private basiliskBadEnd(): void {
        ...
        this.outx("You have no voice, and you must scream.");
    ...
    private driderPCEggLaysBasilisk(): void {
        ...
        if (this.monster.HP < 1) this.outx("exhaustion");
        ...
        if (this.silly()) this.outx("Pinning him between a rock and a hardening place, ");
        this.outx("Shoving him up against the cool stone, ");
        this.outx(
        ...
        if (this.player.hasVagina()) this.outx("already-dripping pussy");
        ...
        if (this.player.hasCock()) this.outx("wrap tightly around your waiting prick");
        else this.outx("burrow deep into your needy slit");
        this.outx(
        ...
        if (this.player.fertilizedEggs() == 0) this.outx("un");
        this.outx(
        ...
        this.outx(" across your partner's face and neck.");
        this.outx(
    ...
    private layBeeEggsInABasilisk(): void {
        ...
        if (
            ...
            this.outx("buzz lightly over to the basilisk's writhing body");
        else this.outx("saunter arrogantly over to the basilisk's crumpled up figure");
        this.outx(
            " and lightly nudge him in his ribs with your [foot].  His eyes are closed from to the "
        );
        if (this.monster.HP < 1) this.outx("pain");
        else this.outx("arousal");
        this.outx(
        ...
        if (this.player.isTaur() || this.player.gender == 0)
            ...
            if (this.player.totalCocks()) this.outx("s");
            this.outx(
        ...
        if (this.player.isTaur()) this.outx("above");
        else this.outx("behind");
        this.outx(
        ...
        if (this.player.fertilizedEggs()) this.outx("fertilized offspring");
        else this.outx("burdensome load");
        this.outx(".");
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.balls > 0) this.outx("and inside your balls ");
            this.outx(
