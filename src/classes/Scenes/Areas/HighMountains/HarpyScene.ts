...
export class HarpyScene extends BaseContent {
    ...
    public harpyVictoryuuuuu(): void {
        ...
        if (this.player.hasVagina()) {
            if (this.player.isNaga()) this.outx("  If you weren't a naga, you could scissor her.");
    ...
    private harpyGooGenderlessLoss(): void {
        ...
        this.outx('"<i>Penis?</i>" she eventually asks.\n\n', false);

        this.outx("You tell her no.\n\n", false);
    ...
    private harpyLossLust(): void {
        ...
        this.outx(".  When she smirks, you know you're in for quite a ride.\n\n", false);
        ...
        if (this.player.hasVagina() && x < 0) {
            ...
            if (this.player.skinType == SKIN_TYPE_PLAIN)
                this.outx(", always followed by a soothing brush of their feathers");
            this.outx(
    ...
    private winAndRapeHarpyAnally(): void {
        ...
        // (if breasts)
        if (this.player.biggestTitSize() >= 2)
            this.outx("her chest mashing against yours as she becomes still, ");
        this.outx(
    ...
    private harpyScissorSurprise(): void {
        this.clearOutput();
        this.outx("You stare down at the defeated harpy, watching as ");
        if (this.monster.HP < 1)
            this.outx(
        ...
        if (this.monster.HP < 1) this.outx("vulnerable");
        else this.outx("lust-mad");
        this.outx(" harpy.");
        ...
        if (this.monster.HP < 1) this.outx("worry");
        else this.outx("desire");
        this.outx(
        ...
        if (this.monster.lust > 99) this.outx(" again");
        this.outx(
    ...
    private spoidahsLegEggsInHarpeis(): void {
        ...
        if (this.player.tallness > 78) this.outx("up");
        else if (this.player.tallness == 78) this.outx("forward");
        else this.outx("down");
        this.outx(
    ...
    private clitFuckAHarpy(): void {
        ...
        if (this.player.wetness() < 3)
            this.outx("  Runnels of your lubricant are dripping down your [legs] in streams,");
        else if (this.player.wetness() < 4)
            this.outx("  Streams of lubricant are soaking down your [legs] in waves,");
        else
            this.outx(
                "  Squirts of lubricant are gushing down your [legs] to puddle on the floor,"
            );
        this.outx(" evidence of just how hungry your clenching, empty hole is.");
        this.outx(
