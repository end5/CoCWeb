...
export class PhoukaScene extends BaseContent implements TimeAwareInterface {
            ...
            switch (
                ...
                case 6: // Offers you a chance to submit, which leads to the various defeat sex scenes
                    ...
                    if (this.player.hasVagina())
                        ...
                        this.outputText(
                            "  If it ain't then tough shite, cause that's what I want.”</i>"
                        );
                    this.menu();
    ...
    protected phoukaDrinkAccept(): void {
        ...
        if (this.player.tou < 70) {
            this.outputText(
                "  It looks like the phouka is holding his liquor about as well as you are."
            );
        } else {
            this.outputText("  It seems you can handle your liquor better than the phouka.");
        }
        this.outputText(
            "  Soon both of you start to share stories about your adventures in Mareth."
        );
        ...
        if (hpVictory) {
            ...
            if (this.player.lust < 33) {
                ...
                if (this.player.cor < 34)
                    ...
                    this.outputText(
                        ".  You could take advantage of the situation to slake your lust."
                    );
                else
                    this.outputText(
    ...
    public phoukaSexBunny(postCombat: boolean, lustLoss: boolean): void {
        ...
        if (postCombat) {
            ...
            if (lustLoss) this.outputText("mind so overcome with lust you can't");
    ...
    public phoukaSexGoat(postCombat: boolean, lustLoss: boolean): void {
        ...
        if (postCombat) {
            ...
            if (this.player.cor <= 50)
                this.outputText(
                    "You steel yourself for an asspounding while you remove your [armor]."
                );
            else
                this.outputText(
    ...
    protected phoukaSexPregnate(postCombat: boolean): void {
        ...
        if (this.player.isPregnant()) {
            ...
            if (isFirstTime)
                ...
                this.outputText(
                    "At least you know what to expect from this form of pregnancy now."
                );
        } else
            this.outputText(
    ...
    protected phoukaSexPregnateEnd(postCombat: boolean): void {
        ...
        if (PhoukaScene.phoukaForm == PhoukaScene.PHOUKA_FORM_FAERIE) {
            ...
            if (this.player.cor > 50)
                this.outputText(
                    "  But either way you plan to return and give all of them that lesson."
                );
            if (postCombat) {
                kGAMECLASS.clearStatuses(false);
                kGAMECLASS.awardPlayer(); // This will provide loot and return to camp, 1 hour used
            ...
            if (PhoukaScene.phoukaForm == PhoukaScene.PHOUKA_FORM_HORSE && !this.player.isTaur())
                this.outputText(
                    "wait for the throbbing pain in your pelvis to subside.  Then you "
                );
            if (postCombat) {
                this.outputText(
