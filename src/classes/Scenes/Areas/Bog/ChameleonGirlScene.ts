...
export class ChameleonGirlScene extends BaseContent {
    ...
    public loseToChameleonGirl(): void {
        ...
        // Lose by HP
        else this.outx("Too weak to keep fighting, you stagger back and fall to your knees.");
    ...
    private loseToChameleonWithCockAnBallsAnCunt(): void {
        ...
        this.outx(".  She blushes as she watches your breaths turn to pants from the pleasure.");
    ...
    private dudesLoseToChamChams(): void {
        ...
        if (this.player.cockArea(x) <= this.monster.vaginalCapacity())
            this.outx("to the base of its shaft");
        else this.outx("as far as you can go into her");
        this.outx(
    ...
    private femaleHasWinSexWithChamCham(): void {
        ...
        if (this.monster.lust > 99) this.outx("  She coos lustily at the sensation.");
        else
            this.outx(
    ...
    private giveTheChameleonASuccubiMilk(): void {
        ...
        if (this.player.hasLongTail()) this.outx(" with your tail,");
        else this.outx(" by straddling her,");
        this.outx(
