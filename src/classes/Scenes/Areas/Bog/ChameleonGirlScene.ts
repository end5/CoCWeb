...
export class ChameleonGirlScene extends BaseContent {
    ...
    public loseToChameleonGirl(): void {
        ...
        if (this.player.gender == 3 && ChameleonGirlScene.rand(2) == 0) this.loseToChameleonWithCockAnBallsAnCunt();
        else if (this.player.gender == 1 || (this.player.gender == 3 && ChameleonGirlScene.rand(2) == 0)) this.dudesLoseToChamChams();
        else if (this.player.hasVagina()) this.loseToChamChamWithPCCunt();
        else {
    ...
    private loseToChameleonWithCockAnBallsAnCunt(): void {
        ...
        //[if(cockarea <40)
        if (this.player.cockArea(x) < 40) this.outputText(" and occasionally lifting it to take the shaft between two dexterous toes and work it more delicately");
    ...
    private dudesLoseToChamChams(): void {
        ...
        if (this.player.lust > 99) this.outputText("overwhelmed by lust");
        else this.outputText("battered");
        ...
        if (this.player.cockArea(x) <= this.monster.vaginalCapacity()) this.outputText("to the base of its shaft");
        else this.outputText("as far as you can go into her");
        ...
        if (this.player.cumQ() > 500) this.outputText(", filling her with so much cum that it leaks out of her and drips to the water below");
    ...
    public defeatChameleonGirl(): void {
        ...
        if (this.monster.lust > 99) {
            ...
            if (this.player.lust >= 33) this.outputText("  Do you help the horny girl to get you both off?  Or maybe you could punish her bad attitude with something from your bag...");
        }
        //-Win by HP
        else {
            ...
            if (this.player.lust >= 33) this.outputText("  Do you use the girl in her weakened state to get yourself off?  Or maybe you could punish her bad attitude with an item from your bags...");
        }
    ...
    private fuckDatChameleonAsACoolGuyGirlHerm(): void {
        ...
        this.outputText("\n\nNot ");
        if (this.player.cor < 50) this.outputText("one to be selfish");
        else this.outputText("feeling quite as selfish as usual");
        ...
        if (this.player.cor < 50) this.outputText("and guiltily ");
    ...
    private manFucksChameleonWithBiggishWang(): void {
        ...
        if (this.monster.lust > 99) this.outputText("her masturbating even more furiously than before at the thought of having your cock.");
        //[if lost by HP:
        else this.outputText("her starting to work the fingers of her free hand in and out of her own sex.");
        ...
        if (this.player.balls > 0) this.outputText("your " + this.ballsDescriptLight() + " clench and ");
        ...
        if (this.player.cumQ() > 750) this.outputText("  The torrent of cum bursting from your cock just doesn't stop, and her eyes roll back into her head as your semen coats her face and runs off her tongue, drenching her breasts and belly in white.  Her head falls back and her tongue goes limp as she's sent into ecstasy by the flood.");
        ...
        if (this.player.cumQ() > 750) this.outputText("  Even the murky water around her is turned white as the pools of your cum on her body run off into it.");
    ...
    private femaleHasWinSexWithChamCham(): void {
        ...
        if (this.monster.lust > 99) this.outputText(", her moans of pleasure growing more desperate as you approach");
        ...
        if (this.monster.lust > 99) this.outputText("  She coos lustily at the sensation.");
        else this.outputText("  Her eyes widen, and she looks from your hand to your face and back again.");
        ...
        if (this.player.cor < 50) this.outputText("and somewhat guiltily ");
    ...
    private giveTheChameleonASuccubiMilk(): void {
        ...
        if (this.player.hasLongTail()) this.outputText(" with your tail,");
        else this.outputText(" by straddling her,");
        ...
        this.player.orgasm();
        if (this.player.hasItem(this.consumables.P_S_MLK)) this.player.consumeItem(this.consumables.P_S_MLK);
        else {
