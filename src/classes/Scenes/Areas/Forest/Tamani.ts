...
export class Tamani extends Goblin {
    ...
    public tamaniHypnoTease(): void {
        ...
        if (this.flags[kFLAGS.TAMANI_TIMES_HYPNOTISED] < 5) {
            ...
            if (selector == 0) this.outputText("You reluctantly pull your stare away from the heavenly entrance between her legs.  There's an urge to walk over to her and plunge yourself inside her over and over, but you dismiss it.", false);
            if (selector == 1) this.outputText("You find it hard to pull your gaze from her inviting twat, but you manage.  You shake your head, clearing away thoughts of fertilizing your wife.  Her rhetoric must be getting to you.", false);
            if (selector == 2) this.outputText("No matter the case, her actions shifted a fair bit of your blood-flow to your groin.", false);
        }
        //MEDIUM HYPNO VALUE:
            ...
            if (selector == 0) {
                ...
                if (this.player.lust < 70) this.outputText("  Still, you don't want to fuck her right now!", false);
            }
            else {
                ...
                if (this.player.lust < 70) this.outputText("  Regardless, you're resolute in your desire not to fuck her right now!", false);
            }
        }
        //HIGH HYPNO VALUE
        else {
        ...
        this.game.dynStats("lus", (Tamani.rand(this.player.lib / 5) + 3 + (this.flags[kFLAGS.TAMANI_TIMES_HYPNOTISED])));
    ...
    public defeated(hpVictory: boolean): void {
        ...
        if (this.player.lust >= 33 && this.player.totalCocks() > 0) {
            ...
            var temp = undefined;
            var temp2 = undefined;
            if (this.player.hasCock() && this.player.cockThatFits(this.analCapacity()) >= 0) temp = this.game.forest.tamaniScene.tamaniAnalShits;
            //NOT PREGGERS
