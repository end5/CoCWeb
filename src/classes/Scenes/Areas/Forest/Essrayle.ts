...
export class Essrayle extends BaseContent {
    ...
    public essrayleMeetingI(): void {
        this.clearOutput();
        if (this.flags[kFLAGS.MET_ESSY] == 0) {
            ...
            if (this.player.cor < 33) this.outputText("Despite however chivalric you think yourself");
            else if (this.player.cor < 66) this.outputText("Despite your better sense");
            else this.outputText("Perhaps best of all");
            ...
            if (this.player.cor < 33) this.outputText("hastily looking away from her nude body");
            else if (this.player.cor < 66) this.outputText("looking away out of courtesy");
            else this.outputText("letting your eyes roam over her as you search for even more depraved features on her nubile body");
            this.outputText(".");
            ...
            if (this.player.biggestTitSize() >= 10) this.outputText("own");
    ...
    private plantsForMe(): void {
        ...
        if (this.flags[kFLAGS.ACCEPTED_ESSY_FIRST_MEETING] == 0) {
            this.flags[kFLAGS.ACCEPTED_ESSY_FIRST_MEETING] = 1;
        ...
        //(If breasts
        if (this.player.biggestTitSize() > 1) this.outputText("Your nipples stiffen, breasts puffing out with a heated breath");
        else this.outputText("You arch your back gently, unconsciously pressing into her slender fingers a bit further");
        ...
        if (this.player.breastRows[0].breastRating >= 1) {
            ...
            if (this.player.bRows() > 1) this.outputText(" of your uppermost pair");
            ...
            if (this.player.bRows() > 1) this.outputText(", steadily working over the multitude of fleshy mounds on your body");
            this.outputText(".");
            if (this.player.hasFuckableNipples()) this.outputText("  Her fingers play with your nipples and press gently to tease at them.  She seems quite surprised as they sink in with minimal effort.  A grin spreads over her face as she begins to steadily thrust those digits in and out of your nipples, fingers swirling about the interiors all the while.");
    ...
    private plantsForMe2(BE: number = 0): void {
        ...
        if (this.player.hasCock() && this.player.hasVagina()) this.outputText("find the dual sexes there.  Another hand joins the first, one gripping and tugging on your hardening cock as the other cups and squeezes over your pussy.");
        ...
        else this.outputText("stroke about the puffy, now-inflamed lips of your own flower, taking the lips between two fingers and stroking up and down across their length fully before switching to your moist core.");
        ...
        if (!this.player.isTaur()) this.outputText("lifting you slowly into the air");
        else this.outputText("forcing you to rear up");
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.breastRows[0].breastRating >= 1) this.outputText(" and " + this.player.breastCup(0) + " breasts");
        ...
        if (this.player.biggestTitSize() >= 1) {
            ...
            if (this.player.lactationQ() >= 400) this.outputText("your milk and ");
        ...
        if (BE == 1) {
            ...
            if (this.player.totalNipples() > 2) this.outputText("s have");
            ...
            if (this.player.bRows() > 1) this.outputText("  She eventually dislodges with a wet pop, setting your new breasts to wobbling about as she moves down your body, repeating the gestures upon each set of breasts in return.");
            ...
            if (this.player.bRows() > 1) this.outputText(", the top pair being largest, descending in size with each subsequent pair");
            this.outputText(".");
    ...
    private feedTrappedEssy(): void {
        ...
        this.flags[kFLAGS.ESSY_DUNGEON_FUCKED]++;

        if (this.player.gender == 1) this.hasCockFeedEssy(false);
        if (this.player.gender == 2) this.hasPussyFeedEssy(false);
    ...
    private hasCockFeedEssy(newPage: boolean = true): void {
        ...
        if (this.player.biggestCockLength() < 20) this.outputText("her lower pair of wobbling udders");
        else this.outputText("both sets of milk-bloated breasts");
        this.outputText(" faster and faster, the hot slapping of her bountiful bosom against your [cock]");
        if (this.player.balls > 0) this.outputText(" and your swollen, heavy balls against her fecund belly");
    ...
    private hasPussyFeedEssy(newPage: boolean = true): void {
        ...
        if (this.player.looseness() < 2) this.outputText("a gasping grunt of effort");
        else if (this.player.looseness() < 4) this.outputText("little resistance");
        else this.outputText("virtually no resistance at all");
    ...
    public askMotherToReleaseEssy(): void {
        this.clearOutput();
        if (this.flags[kFLAGS.SAND_WITCHES_COWED] == 0) {
