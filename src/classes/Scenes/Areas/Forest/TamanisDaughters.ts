import { ANAL_LOOSENESS_TIGHT, ANAL_WETNESS_DRY, BUTT_RATING_NOTICEABLE, HIP_RATING_AMPLE, VAGINA_LOOSENESS_TIGHT, VAGINA_WETNESS_DROOLING } from "../../../../includes/appearanceDefs";
...
export class TamanisDaughters extends Goblin {
    private midRoundMadness(): void {
        ...
        if (selector == 0) {
            ...
            if (this.player.balls > 0) {
                if (TamanisDaughters.rand(2) == 0) this.outputText(this.player.multiCockDescriptLight(), false);
    ...
    protected performCombatAction(): void {
        ...
        switch (TamanisDaughters.rand(select)) {
            case 0:
                this.createStatusAffect(StatusAffects.Attacks, Math.floor(this.flags[kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] / 20), 0, 0, 0); //Tamani's Daughters get multiattacks!
                this.eAttack();
                break;
            case 1:
                this.special1();
