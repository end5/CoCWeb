...
export class Faerie extends BaseContent {
        ...
        if (this.player.cockTotal() > 0 && (!this.player.hasVagina() || Faerie.rand(2) == 0)) {
            ...
            if (
                ...
                if (this.player.statusAffectv1(StatusAffects.FaerieFucked) < 5) {
                    ...
                    this.outputText(
                        "It would be cute if she wasn't dressed up like such a slut.  You bet you could get her to help pleasure you, but she might not like it.  Or you could be a nice " +
                            this.player.guyGirl() +
                    ...
                    this.outputText(
                        '\n\nYou lazily make a grab for her and easily snatch her out of the air.  Her body is sticky with a mix of desire and your last encounter.  You can feel her humping against your pinky while she begs, "<i>Come on, let me crawl into your ' +
                            this.player.armorName +
                            " and wrap myself around your shaft.  I promise I'll only drink a little pre-cum this time, just enough to let me get off.  I'll be a good faerie slut, just let me get you off!</i>\"\n\nDo you let the faerie get you off?",
                        false
                    );
        ...
        if (this.player.isTaur()) {
            this.outputText(
                "\n\nYou bop the tiny Faerie on the head to daze her briefly, then place her on a branch. You back yourself up against the tiny creature, lifting your tail so she can see your " +
                    ...
                    ". The scent washes toward her and you hear a high pitched giggle; evidently that was more than enough to give her quite the contact high.  You feel a strange sensation in your slit as she slides her legs inside you and wraps her arms around your " +
                    this.clitDescript() +
                    ".\n\n",
                false
            );
            ...
            if (this.player.clitLength >= 3) {
                this.outputText(
                    "The tiny fae begins jerking your clit like a cock, squeezing her arms tightly around you and sliding in and out of your " +
                        this.vaginaDescript(0) +
                        ". Her motions are frenetic and unpredictable, but incredibly pleasurable.  She starts licking at your " +
                        this.clitDescript() +
                ...
                //[Huge amount of cum:
                    ...
                    this.outputText(
                        "The fae giggles more and more as the fluid sprays about her and your " +
                            ...
                            " ripples. She hugs your " +
                            this.clitDescript() +
                            " tighter and starts gently gnawing at it, such a peculiar sensation that you cum suddenly, and wetly.  Her giggles quickly become all-out laughter, and she loses her grip on your clit, sprawling to the ground into a huge puddle of femcum, her giggling frame floating on the surface as her legs kick about erratically.\n\n",
                        false
                    );
            }
            //[All other clits:
                ...
                //[Huge amount of cum:
                    ...
                    this.outputText(
                        "You cum suddenly, and wetly. The fae tries desperately to hold on to your " +
                            this.clitDescript() +
                            " but the amount of fluid overwhelms her and she's sent spiralling to the ground into a huge puddle of your fluid, her giggling frame floating on the surface as her legs kick about erratically.\n\n",
                        false
                    );
            }
        }
        //Non-Taurs
            ...
            this.outputText(
                "\n\nYou release the lower portion of your " +
                    this.player.armorName +
                    ", revealing your aroused slit to the faerie.  ",
                false
            );
            ...
            if (this.player.clitLength <= 0.5) {
                this.outputText(
                    "She pulls apart your lips, revealing your tiny bud and repositioning herself to plant her feet inside you.  The flawless skin of her thighs pulls another gasp of pleasure from your lips.  They squeeze tightly around your " +
                        this.clitDescript() +
                        ", scissoring her gash across its sensitive surface.   You squirm, too engrossed in the rough grinding your button is receiving to worry about the faerie.   She clings to you, hanging on for dear life as your crotch nearly throws her free.  During the gyrations, she's slammed back into the " +
                        this.clitDescript() +
                        ", instantly penetrated by the nub with a wet 'schlick'.\n\n",
                    false
                );
                this.outputText(
                    "Squealing and bouncing as she hangs on tightly, the faerie noisily orgasms around your clit, squirting her own fluids into your aching " +
                        this.vaginaDescript(0) +
                        ".  The fluid tingles, and you shove your fingers in, smearing the sticky-sweet faerie-cum through your passage.   Before you can get far with it, your own orgasm goes off, squeezing your fingers and rippling around them, trying to milk your hand as if it was a dick.  Your legs go weak and wobbly, forcing you down on your " +
                        this.buttDescript() +
            ...
            //(medium) <= .1.25\"
                ...
                this.outputText(
                    "She orgasms on you, squirting copiously, drenching your " +
                        this.clitDescript() +
                        " and " +
                        this.vaginaDescript(0) +
                        " in clear faerie-fluid.  It tingles, wicking into your button and soaking into your snatch, enhancing every sensation.  You can feel the cool forest air as it flows over your vulva, seeming to stroke you, and without any chance of holding yourself back, you plunge your fingers into your " +
                        this.vaginaDescript(0) +
            ...
            //(streeeetch – large) <= 4.5\"
                ...
                this.outputText(
                    "Entranced by the growing " +
                        this.clitDescript() +
                        ', the faerie caresses her body, watching your love-button swell up, not stopping until it looks too huge for her tiny frame.  She climbs in a circle around it, awestruck by the size and majesty of your cock-like button.    She looks up at you, aroused but worried, saying, "<i>You\'re so... BIG.  Oh goddess, I want to feel it inside me!</i>"\n\n',
                    false
                );
                this.outputText(
                    "She grabs hold of its slippery surface with both hands and jumps, lifting her lower body up before gravity yanks it back down onto the tip of your " +
                        this.clitDescript() +
                        ".  The tip barely slips in, despite the slippery wetness of the faerie.   She screams, though in pleasure or pain you cannot be sure.  You reason that it must be pleasure, because the faerie is wiggling her hips and grabbing hold of the rest of your " +
                        this.clitDescript() +
                        ", straining to pull herself further down the fem-cock.  Her belly starts to distort, displaying the cylindrical bulge on her tummy, expanding and contracting slightly as each of your heart-beats works through your clit.\n\n",
                    false
                );
                this.outputText(
                    "In time, she manages to fully impale herself, quivering in orgasm as she gets off from the vibrations your pounding heart sends through your " +
                        this.clitDescript() +
                        ".  Her tongue lolls out and her eyes roll back, shut down by the extreme penetration, pain, and pleasure of the act.  You feel her cum soaking into you, sliding down into your slit and making your sensitive slit tingle.  Watching her get off is all it takes to bring you to orgasm with her, and the walls of your " +
                        this.vaginaDescript(0) +
    ...
    private faerieDoNothing(): void {
        ...
        if (this.player.nippleLength >= 1) {
            ...
            this.outputText(
                "Eventually you both find a rhythm and soon she's moaning loudly.  ",
                false
            );
            if (this.player.hasVagina())
                this.outputText(
                    "With your other hand you start diddling your " +
                        this.vaginaDescript(0) +
    ...
    private faerieCaptureHJ(): void {
        ...
        this.outputText(
            "You let her loose and she hovers in place, as if pondering her one last chance to escape.  She sighs and looks back up, blushing fiercely as she lands on your hip and gazes down at the bulge of your groin.  You can't help but laugh as she slips under your " +
                this.player.armorName +
                ", crawling across your sensitive thigh towards your " +
        ...
        if (this.player.isTaur()) {
            ...
            if (this.player.cockTotal() > 0)
                this.outputText("largest " + Appearance.cockNoun(CockTypesEnum.HUMAN), false);
            this.outputText(
            ...
            this.outputText(
                "She smashes onto the end of your " +
                    this.multiCockDescriptLight() +
                ...
                //[Huge amount of cum:
                    ...
                    this.outputText(
                        "Your semen collides with her face and she is propelled off of your cock onto the pre soaked ground. Your " +
                            ...
                            " continue pumping out cum like a hose until she's almost swimming in it.\n\n",
                        false
                    );
            }
            this.player.orgasm();
            ...
            if (this.player.statusAffectv1(StatusAffects.FaerieFucked) < 10)
                ...
                this.outputText(
                    "The faerie burps and laughs drunkenly, patting the side of your " +
                        this.player.leg() +
                        ' and slurring, "<i>Oh by Marae\'s ripe titsh!  I needed that.  Do you thhink you could catsch me again?  I love feeling your cum coating my body.</i>"\n\n',
                    false
                );
            else
                this.outputText(
        ...
        //Non-taurs
            ...
            this.outputText(
                "Your internal muscles clench unconsciously, squeezing out a dollop of pre that rolls down into the faerie's hair, soaking her head and face.  You can't see her reaction, but you can feel it oozing between her body and you, lubricating her as she humps and rubs against you.  Tiny muffled moans escape your " +
                    this.player.armorName +
                    ", indicating that some part of her is enjoying the task.\n\n",
                false
            );
            this.outputText(
                "Though she can only stimulate a few inches of you at a time, it feels really good – better than it should, and a budding warmth on the edge of release builds inside you.  Too late you realize you should have gotten at least partially undressed.  You cum before you can do anything about it, splattering your " +
                    this.player.armorName +
                    " with seed and leaving a wet patch on the crotch.  You can feel it dripping back onto you and the faerie as more spunk squirts out, soaking the tiny girl in spooge as the wet spot grows.  ",
                false
            );
            if (this.player.cumQ() > 250) {
                this.outputText(
                    "You cum uncontrollably, regretting your fertility as your body paints the inside of your " +
                        this.player.armorName +
                        " with goopy whiteness.  ",
                    false
                );
