...
export class ErlKingScene extends BaseContent {
    ...
    protected firstWildHuntChase(waited: boolean = false): void {
        ...
        if (waited == false) {
            ...
            if (this.player.findStatusAffect(StatusAffects.MetWhitney) >= 0)
                this.outputText(
                    ", and for a moment all you can think of are Whitney’s canine peppers"
                );
            this.outputText(".\n\n");
    ...
    protected surrenderToTheHounds(): void {
        ...
        this.outputText(
            "Instead, you curl your stomach, trying to reach your cock with your mouth."
        );
    ...
    protected predatoryPrey(): void {
        ...
        this.outputText(
            "You smile seductively, asking the Erlking exactly what he’s offering.\n\n"
        );
    ...
    protected howDareYou(): void {
        ...
        if (this.player.hasVagina() && !this.player.hasCock()) {
            ...
            this.outputText(
                "“<i>Dirty little slut,</i>” you growl.  “<i>Did you like that?</i>”\n\n"
            );
    ...
    protected gwynnGetsDickmilked(): void {
        ...
        this.outputText(
            "“<i>My Lord, are you sure?</i>” she says, tilting her head to the side.\n\n"
        );
