...
export class AkbalScene extends BaseContent {
        ...
        // Centaur RAPPUUUUU
            ...
            if (this.player.totalCocks() > 0) {
                ...
                // (Lg Penis: 13 inches and up)
                    ...
                    this.outputText(
                        "You grin as you realize that this may take a while...\n\n",
                        false
                    );
    ...
    private girlsRapeAkbalPart2(): void {
        ...
        // Loose
            ...
            this.outputText(
                ", his face twisted into a snarl of pleasure and satisfaction.\n\n",
                false
            );
    ...
    private akbalDeny(): void {
        ...
        this.outputText(
            "Knowing he's found a new toy, Akbal allows you to leave unmolested.",
            false
        );
    ...
    private akbalSubmit(): void {
        ...
        if (this.player.lowerBody == LOWER_BODY_TYPE_CENTAUR) {
            ...
            this.outputText(
                "You close your eyes, willingly falling into a sex induced sleep.",
                false
            );
            // [+ 4-12 Corruption]
            this.dynStats("cor", 4 + AkbalScene.rand(8));
    ...
    private akbalBigButtSubmit(): void {
        ...
        else if (this.player.hasVagina()) this.outputText(" and [vagina]");
        this.outputText(
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.cumQ() >= 500) {
                ...
                if (this.player.cumQ() >= 1000) {
                    if (this.player.cumQ() < 3000) this.outputText(" into a small lake");
                    else this.outputText(" into a deep, slimy morass");
                }
            }
        } else if (this.player.hasVagina()) {
            this.outputText(", ");
        ...
        if (this.player.hasCock() && this.player.cumQ() >= 1000) this.outputText("dry, ");
        this.outputText(
    ...
    private topAkbitchFromDaBottom(): void {
        ...
        // [if (biped = true)
            ...
            if (this.player.hasVagina()) this.outputText("clit");
    ...
    private topAkbitchFromBottomDuex(): void {
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.hasVagina()) this.outputText("both ");
            this.outputText("your sex organ");
            if (this.player.hasVagina()) this.outputText("s climax at once");
            else this.outputText(" climaxes");
            this.outputText(
    ...
    private akbitchHighStrengthVariant(): void {
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.cocks[x].cockLength > 12) this.outputText("another");
            ...
            if (this.player.hasVagina()) this.outputText("nether lips");
            else this.outputText("entrance");
            this.outputText(
    ...
    private akbitchToughness(): void {
        ...
        // {female/genderless}
            ...
            if (this.player.thickness <= 33) this.outputText("slim");
            else if (this.player.thickness <= 66) this.outputText("muscular");
            else this.outputText("voluptuous");
            this.outputText(
