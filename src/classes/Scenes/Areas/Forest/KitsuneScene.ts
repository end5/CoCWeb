...
export class KitsuneScene extends BaseContent {
    ...
    public winKitsuneImpFight(): void {
        ...
        if (this.player.lust < 70 || this.player.inte >= 40) {
            ...
            else this.outx("shoulder-length, crimson");
            this.outx(" hair, six luxuriously furred tails fanning out behind her.\n\n");
    ...
    private willOWisp(): void {
        ...
        this.outx("It seems to be beckoning you to follow it.");
    ...
    private leaveKitsune(talked = false): void {
        ...
        this.outx('"<i>I have something for you...</i>"\n\n');
        ...
        this.outx("<b>You have received a Kitsune's Gift!</b>\n");
        if (this.getGame().inCombat) {
    ...
    private mansion(willing: boolean, firstTime = false): void {
        ...
        // MERGE:
        this.outx('"<i>Welcome');
        if (this.flags[kFLAGS.MANSION_VISITED] > 0) this.outx(" back");
        this.outx(
        ...
        if (this.flags[kFLAGS.MANSION_VISITED] > 0)
            this.outx("the trio of familiar kitsune sisters.");
        else {
            this.outx("a trio of lovely maidens -");
            if (willing) this.outx(" including the one that led you here,");
            this.outx(
    ...
    private kitSuneLetHerMansion(willing = true): void {
        ...
        if (this.player.gender == 1) this.outx("hindquarters");
        else this.outx("warm folds");
        this.outx(
        ...
        this.outx("The redhead's pulsating member begins to throb and twitch in your ");
        if (this.player.gender >= 2) this.outx(this.vaginaDescript());
        else this.outx(this.assholeDescript());
        this.outx(
        ...
        this.outx(", a thick bulge passing through the shaft and erupting into your ");
        if (this.player.gender >= 2) this.outx("slippery hole");
        else this.outx("innards");
        this.outx(" forcefully.  The thick cum hits your ");
        if (this.player.gender >= 2) this.outx("womb");
        else this.outx("intestines");
        this.outx(
    ...
    private outro(tentacles = false): void {
        ...
        if (this.player.fatigue >= 100) {
            ...
            if (
                ...
                this.outx("<b>Due to the residual effects of the sisters' magic, your ");
                if (this.player.hasCock()) {
                    this.outx("cum ");
                ...
                this.outx("production has been enhanced.</b>");
            }
    ...
    private mansionBadEnd(): void {
        ...
        this.outx('"<i>Leaving so soon, dear?</i>"\n\n');
        this.outx(
    ...
    private fightSomeKitsunes(): void {
        ...
        // Redhead
            ...
            this.outx('"<i>Oh, you\'re not going to make this easy for me, are you?</i>"');
            this.outx(
        ...
        if (this.monster.hairColor == "blonde") this.outx("blonde");
        else if (this.monster.hairColor == "black") this.outx("black-haired");
        else this.outx("red-haired");
        this.outx(" kitsune!</b>");
        this.doNext(this.playerMenu);
    }
    ...
    private loseFightToHerms(): void {
        ...
        this.outx('"<i>Almost, dear!  Mn, just a bit, ah!  More...</i>"\n\n');
        this.outx(
    ...
    private loseToBlackHairLatexWhileMilky(): void {
        ...
        if (this.player.HP < 1) this.outx("fatigue");
        else this.outx("lust");
        this.outx(
    ...
    private getRapedByRedHeadFutaKitsune(): void {
        ...
        if (this.player.hasVagina()) this.outx("entrance");
        else this.outx("anus");
        this.outx(
        ...
        if (this.player.hasVagina()) {
            if (this.player.vaginalCapacity() < 30) this.outx("a combination of pain and ");
            this.outx(
            ...
            if (this.player.analCapacity() < 30) this.outx("a combination of pain and ");
            this.outx(
                "pleasure.  Your muscles instinctively clench down on the intruder, milking her throbbing shaft in blatant disregard of your own desires, and the kitsune moans in pleasure, rolling her eyes back a little.\n\n"
            );
        }
    ...
    private fuckAKitsuneVaginally(): void {
        ...
        this.outx('"<i>Ah-aah!  S-stop, y-you\'ll-</i>"\n\n');
        ...
        this.outx('"<i>J-just this once...</i>"\n\n');
    ...
    private putItInAKitsunesAssWin(): void {
        ...
        this.outx("Well, if she's not complaining, neither are you!\n\n");
        ...
        if (this.monster.hairColor == "red" && this.flags[kFLAGS.redheadIsFuta] > 0) {
            this.outx("Her cock throbs and twitches in your grip, ");
    ...
    private kitsunesGetBonedBy3PlusTentacles(): void {
        ...
        this.outx('"<i>Tentacles...</i>" she repeats, shuddering from head to toe.');
        // Advance time 1hr and return to camp.  +Sensitivity, +Libido
        this.player.orgasm();
        this.dynStats("lib", 1, "sen", 1);
        this.cleanupAfterCombat();
    ...
    private fuckDraftBlond(): void {
        ...
        this.outx('"<i>Hey...  wait, what are you do-</i>"\n\n');
        ...
        else this.outx(this.player.legs());
        if (this.silly()) this.outx(" with a heat you could roast marshmallows over.");
        else this.outx(" with a heat that sends blood rushing to your groin.");
        this.outx(
        ...
        this.outx('"<i>Nngah!  Fuck!  I-it feels s-so good!</i>"\n\n');
    ...
    private doseAKitsuneWithOviElixirs(): void {
        ...
        this.outx('"<i>Take good care of my little eggies, darling!</i>"');
    ...
    private lactaidDoseAKitSune(): void {
        ...
        if (this.player.cumQ() <= 150) {
            ...
            this.outx("Your cock");
            if (this.player.cocks.length > 1) this.outx("s swell");
            else this.outx(" swells");
            this.outx(
    ...
    private feederTheKitsunes(): void {
        ...
        if (this.monster.hairColor == "black") this.outx("lustrous black ");
        else this.outx(this.monster.hairColor);
        this.outx("hair.\n\n");
    ...
    private getABJFromAFoxGirl(): void {
        ...
        if (this.player.cocks[x].cockLength > 9) {
            this.outx("each bob of her head inching her lips closer and closer to your ");
            if (this.player.balls > 0) this.outx(this.ballsDescriptLight());
    ...
    private redheadsDontDeserveToHavePenisesBecauseTheyreTooGayForPenisOrSomethingIDontReallyKnowHowThisWorksOrWhyThisFunctionNameIsSoFuckingLong(): void {
        ...
        this.outx("\"<i>Fine, you beat me.  Fair's fair...");
        if (this.silly()) this.outx(" you monster.");
        this.outx('</i>"\n\n');

        this.outx("<b>What will you do with her now?</b>");
    ...
    private nonFutaRedHeadBondageIGuessYouTieHerUpWithYourPenisThenHuh(): void {
        ...
        this.outx('"<i>Wh-what are we going to-</i>"\n\n');
    ...
    /* Use whichever enhancement scene(s) you feel like.
     ...
     outx( "Lumi snatches the jewel from your hand, staring wide-eyed into the fathoms of its depths.  She remains like that for several moments before you clear her throat, and then hurries off to work.  Flitting back and forth between the various beakers and test tubes that litter the workshop, she mixes chemicals seemingly at random, many of which bubble or explode rather violently.\n\n
