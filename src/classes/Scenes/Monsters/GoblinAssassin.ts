...
export class GoblinAssassin extends Monster {
    protected goblinDrugAttack(): void {
        ...
        //Dodge chance!
        if ((this.player.findPerk(PerkLib.Evade) >= 0 && GoblinAssassin.rand(10) <= 3) || (GoblinAssassin.rand(100) < this.player.spe / 5)) {
    ...
    protected dualShot(): void {
        ...
        //Hit:
            ...
            var damage: number = Math.floor((this.str + this.weaponAttack + 40) - GoblinAssassin.rand(this.player.tou) - this.player.armorDef);
    ...
    public constructor(noInit: boolean = false) {
        ...
        this.drop = new WeightedDrop().
            ...
            addMany(1, this.consumables.L_DRAFT,
                ...
                this.consumables.PURPDYE);// TODO this is a copy of goblin drop. consider replacement with higher-lever stuff
        this.checkMonster();
    }

    protected performCombatAction(): void {
        var actions: any[] = [this.eAttack, this.goblinDrugAttack, this.lustNeedle, this.dualShot, this.goblinExplosion];
