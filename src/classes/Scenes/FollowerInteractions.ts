...
export class FollowerInteractions extends NPCAwareContent {
    ...
    public amilyMeetsPureJojo(): void {
        ...
        this.outx("", true);
        this.outx(
            'Amily appears to have located Jojo, and the two of them are actually hugging!  The smaller female mouse is crying, and Jojo looks a little misty-eyed as well.  They break apart as you approach; when out of the blue, Amily socks Jojo with a right hook!  He stumbles back, rubbing at his jaw as she yells, "<i>That\'s for not coming back to the village and finding me!  Oh sure, you could fight demons in the forest for years, but Marae forbid you come back to look for survivors!</i>"\n\n',
            false
        );
        ...
        this.outx(
            "Amily sighs and hugs him again, \"<i>You're a pansy. You know that Jojo?  But I'm glad " +
                this.player.short +
                ' reunited us so that we could meet again.</i>"\n\n',
            false
        );

        this.outx(
            'Jojo replies, "<i>Me too,</i>" before he notices you and coughs.  Amily pulls back and beams a brilliant, buck-toothed smile at you.  She rushes into your arms and gives you a kiss before she runs off.  Jojo looks a little embarrassed and scratches his ear as he centers himself.\n\n',
            false
        );
        this.dynStats("lus", 5);
    ...
    public amilyIsPissedAtYouForRuiningJojo(): void {
        ...
        this.outx(
            "Amily screams, \"<i>Don't even try to lie!  I met him before you did this to him, and HE TOLD ME IT WAS YOU before he passed out!  We... we have to fix him.  I don't know why you would do something like this, but he- he's broken.  Utterly.  Please.  Find some pure honey and we can fix him!</i>\"\n\n"
        );
    ...
    private tellAmilyToFuckOffRuinedJojo(): void {
        ...
        this.clearOutput();
        this.outx(
            "You chuckle, \"<i>He's a better fuck like this than you ever were.  Why don't you piss off and leave us alone?</i>\"\n\n"
        );

        this.outx(
            'The sadness she exudes is palpable, but her eyes harden into ice as she replies, "<i>Fine. I don\'t want anything to do with a demon anyway.</i>"  She turns around and jogs off, glancing back over her shoulder with tears in her eyes before she disappears.\n\n'
        );
    ...
    private agreeToHelpAmilyFixJojo(): void {
        ...
        this.clearOutput();
        this.outx("You nod, ");
        if (this.player.cor < 33) this.outx("feeling genuinely sorry for what you've done.");
        else if (this.player.cor < 66) this.outx("unsure if you're making the right choice.");
        else
            this.outx(
                "wondering if this will wind up as an empty promise to placate the angry mouse-cunt."
            );
        this.outx(
            "  You say, \"<i>All right, when I find some pure-honey I'll bring it to you so we can fix him, okay?  I don't know what came over me; the corruption of this place just... got to me.  Let's fix him together.</i>\"\n\n"
        );
    ...
    public fixJojoOOOOHYEEEEAHSNAPINTOASLIMJIM(): void {
        ...
        else if (this.player.cor > 33) this.outx("a little confused by the whole situation");
        else this.outx("glad the damage you did to Jojo wasn't permanent");
        this.outx(".");
    ...
    private stopJojoDeathInTheNameOfLove(): void {
        this.jojoScene.jojoSprite();
        this.clearOutput();
        this.outx('You grab her by the shoulders and say, "');
    ...
    public amilyIngredientDelivery(): void {
        this.outx("", true);
        this.outx("As you make your way to Rathazul's lab, a ");

        if (this.flags[kFLAGS.AMILY_NOT_FURRY] == 1) this.outx("big-eared blur whizzes past you");
        else this.outx("blur of fur whizzes past you");
    ...
    public rathazulFreaksOverJojo(): void {
        ...
        this.outx(
            "Rathazul comes up to you with a serious, worried expression.  You ask him what's wrong, and he explains, \"<i>There is a creature in the woods.  I've seen glimpses of it numerous times, and I believe it to be some kind of demon-tainted mouse.  We must deal with it, lest it strike while we are unawares!</i>\"\n\n"
        );

        this.outx(
            "You work hard to keep a straight face.  The 'creature' is clearly your fuck-pet, Jojo.  What do you tell the old mouse?  "
        );
    ...
    private tellRathazulYouOwnJojo(): void {
        ...
        this.clearOutput();
        this.outx(
            "You tell Rathazul, \"<i>Oh that's just Jojo.  He's been corrupted, but he isn't evil and he hangs around because he knows I like to sleep with him.</i>\"\n\n"
        );

        this.outx(
            'Rathazul scratches his head in confusion and stutters, "<i>You, uh, f-fuck the creature?  Well, umm... okay.  I guess I don\'t have to worry about it then...</i>"\n\n'
        );

        this.outx(
            "He blushes red and lurches back towards his laboratory, muttering under his breath about crazy kids."
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    // [I can handle it]
    private tellRathazulYouCanHandleIt(): void {
        ...
        this.clearOutput();
        this.outx(
            "You tell Rathazul, \"<i>Don't worry about it.  I've been all over the woods and fought that mouse before.  He's a pushover, and if he tries to sneak up on either of us I'll take care of it.</i>\"\n\n"
        );

        this.outx(
            'Rathazul looks you over and asks, "<i>Why didn\'t you kill it?  With all the corruption in this world, we would be better off nipping these things in the bud.</i>"\n\n'
        );

        this.outx(
            "You answer, \"<i>Do I look like a demon to you?  I don't kill my enemies if I can help it.  Trust me, we're safe.</i>\"\n\n"
        );

        this.outx(
            "The rat seems satisfied by your response and nods respectfully.  He lurches back towards his laboratory, wringing his clawed hands with worry."
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    // [Its harmless]
    private TellRathazulJojoIsHarmless(): void {
        ...
        this.clearOutput();
        this.outx(
            "You explain to Rathazul, \"<i>That's just Jojo.  He got pretty fucked up and is hoping I'll let him fuck me.  The little mouse is a push-over, and nothing to worry about.</i>\"\n\n"
        );

        this.outx(
            'Rathazul looks a little incredulous at the declaration and he asks, "<i>Can we do something about him?  He\'s very creepy.</i>"\n\n'
        );

        this.outx(
            "You snort disdainfully and answer, \"<i>It's fine.  He's not interested in you – it's me he wants, and he won't be getting any of me unless I decide to let him.</i>\"\n\n"
        );

        this.outx(
            'With the conversation concluded, Rathazul wanders off, murmuring, "<i>Oh my, no...</i>"'
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    public jojoOffersRathazulMeditation(): void {
        ...
        this.outx(
            "Jojo is at Rathazul's lab.  The smaller, white mouse is asking the elderly rodent if he would like to meditate.  Rathazul considers for a moment and agrees, \"<i>I'll have to try it when I have some time.  A little reflection would do my old soul some good.  However we cannot now; " +
                this.player.short +
                ' has need of me.</i>"\n\n',
            false
        );

        this.outx("Jojo turns to you, gives a quick bow, and departs.");
        // [To rathazul]
        this.doNext(kGAMECLASS.rathazul.returnToRathazulMenu);
    }
    // [Rathazul Napping]
    ...
    public marbleVsAmilyFreakout(): void {
        ...
        this.outx(
            'Within moments, Marble has walked up to Amily and, with a forced smile on her face, asks, "<i>May I ask who you are?</i>"\n\nWithout realizing what is happening yet, Amily cheerfully responds. "<i>I\'m Amily, ' +
                this.player.short +
                "'s lover.  Who're you?</i>\" She extends her hand towards Marble.  At this moment you hear something like a low growl coming from Marble as she turns to face you, absolutely livid.  \"<i>YOU!  Why didn't you tell me about this girl?!  I trusted you!</i>\"\n\nHow do you respond?",
            false
        );
        ...
        // Silent -> Otherwise (A4)
            ...
            this.outx(
                'Turning to face you with her hammer raised, Marble says to you "<i>So I guess that I\'m nothing but a fuck to you then, hun?!  After all I sacrificed to help you get over your addiction, just so that you could be with someone else?!</i>"  She swings her hammer at you and you barely dodge it in time and look back at the angry cowgirl.  "<i>' +
                    this.player.short +
                    '!</i>" Amily calls out to you while rushing to your side and wiping her tears.  "<i>Fine!</i>"  Marble yells at the two of you. "<i>You two can be together and have as many kids with each other as you want!  I\'m leaving ' +
                    this.player.short +
    ...
    public amilyUrtaReaction(): void {
        this.outx("", true);
        this.outx(
            "As you finish making your way back to camp, Amily surprises you from behind a rock, her arms folded across her chest.  \"<i>Hey, remember when you told me about that city in the desert?  I decided to check it out.</i>\"  You don't remember, but you're too busy absorbing the implications to respond.  \"<i>You'll never guess what I heard!  It seems someone just like you has been seen in the company of one of their prominent citizens,</i>\" she continues.  \"<i>I can't say I didn't expect something like this might happen.  I mean... she's not some demon, right?  Still... I thought we had something special, " +
                this.player.short +
                '.</i>"  As you try to formulate a reply, she seizes her tail and twists it pensively in her hands, already deciding her next move.  "<i>I-I\'ve got to meet her... to know what you see in her.</i>"\n\n',
            false
        );
    ...
    public askAboutAmily(): void {
        ...
        // before Urta goes on duty at 1400:
            ...
            this.outx(
                "This is met with a chittering squeal you distinctly recognize as Amily's.  \"<i>Oooohhh... I see why " +
                    this.player.short +
                    ' - yeah, gimme all you got! - fell for you!</i>"\n\n',
                false
            );
            ...
            this.outx(
                "pregnant.  The mouse is holding a half-full bottle of what you think is Barkardi 151, waving it enthusiastically through the air even as she thumps up and down in Urta's lap, trying to coax one last orgasm from the visibly-drained hermaphrodite.  She giggles with delight and takes a messy swig from her bottle, spilling some of the booze onto her " +
                    ...
                    " before twisting around and sloppily kissing Urta, trying to feed the contents of her mouth to the fox but dribbling half down her neck.\n\n",
                false
            );
    ...
    private askAboutAmilyPt2(): void {
        this.outx("", true);
        this.outx(
            'Amily breaks the kiss and gives Urta a drunkenly affectionate smile, gently stroking her cheek.  "<i>Mmm... I wish ' +
                this.player.short +
                " had introduced ush earlier... I think we're gonna be good friendsh,</i>\" she slurs.  Urta simply nods, giving her a goofy grin but clearly miles away, mentally. The mouse promptly yawns, dropping the now empty bottle to the floor, shuts her eyes and snuggles up to Urta, who cuddles her close and also drifts off.\n\n",
            false
        );
    ...
    private cheatingSloots(): void {
        this.outx("", true);
        this.outx(
            'You kick open the door and roar, "<i>What the fuck is this!?</i>"  Both Amily and Urta turn to you and look at you with puzzled expressions before the severity of the situation seeps into their alcohol-fuzzed consciousnesses.  Almost simultaneously, they yell, "<i>' +
                this.player.short +
                '!</i>" and stumble apart drunkenly, leaking each other\'s slime all over the floor.  Urta slurs, "<i>We didn\'t mean to... it jusht... happened...</i>"\n\n',
            false
        );
        this.outx(
            'You growl and turn to Amily, who quietly squeaks, "<i>I thought... I thought if I knew her better *hic* I could find a way to save what we had... *burp* I am REALLLY out of it, but I thought... ya know, if I was willing to sleep with her too that we could all be happy together.</i>"\n\n',
            false
        );
    ...
    private endThisMadness(): void {
        ...
        if (FollowerInteractions.rand(2) == 0) {
            this.outx(
                '"<i>' +
                    this.player.short +
                    ', I did this for you!  I loved you so much I worked to see what you liked in Urta!</i>" cries Amily.  Her face blushes, not in shame, but in anger as her temper flares.  She actually says, "<i>Everything, all of this, it was me wanting things to be perfect for YOU!  FOR US!  You... you... asshole!</i>"\n\n',
                false
            );
            this.outx(
        ...
        this.outx("You shrug.  Well, that puts an end to that.");
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private beADickToAmily(): void {
        ...
        this.outx(
            '"<i>F-fuck you, ' +
                this.player.short +
                ',</i>" she finally rejoins.  "<i>You did the same damn thing.</i>"\n\n',
            false
        );
    ...
    private smileAndNodToAmilyXUrta(): void {
        ...
        this.outx("You nod and leave her to sleep.");
    ...
    public amilyUrtaSex(): void {
        ...
        this.outx("", true);
        this.outx(
            'With a knowing smirk, you ask how Amily would feel about going to see Urta and maybe having a little fun with her.  The mouse-girl flushes with embarrassment, but you can see the eagerness in her body language.  "<i>Okay, sure; I kind of like going to the city... besides, between you and me?  I think Urta needs all the friends she can get... never thought I\'d feel sorry for a hermaphrodite.</i>"  She mumbles this last part to herself, but you can still hear her.',
            false
        );
        ...
        this.outx(
            'With a gesture, the two of you set off.  As soon as you pass through the gates, you head towards the Wet Bitch.  Sure enough, Urta is at her usual table, and she smiles in delight to see you.  "<i>' +
                this.player.short +
                ', Amily, hello!</i>"  You take seats at the same table, as she ',
            false
        );
        if (!this.urtaLove())
    ...
    private amilyUrtaSexWatch(): void {
        ...
        this.outx(
            "Urta groans, unable to resist groping Amily's " +
                this.amilyScene.amilyTits() +
                ".  \"<i>Let me sit down, first, squeaky; I've never been one for sex while standing up</i>\".  She slowly lowers herself to the ground and then pulls Amily down into her lap, idly grinding her mare-cock against Amily's torso",
            false
        );
        ...
        if (this.flags[kFLAGS.AMILY_WANG_LENGTH] > 0)
            this.outx(
                ", a bead of pre-cum stretching into a line connecting their two members",
                false
            );
        this.outx(
            '.  Straddling Urta and aligning the heavy horse-cock with her moist snatch, Amily teases, "<i>Ready for this, foxy?</i>"  Her eyes dart towards you for a split second.\n\n',
            false
        );

        this.outx(
            'You just smile gently and watch Urta, who swallows hard, tongue lolling out with anticipation before she remembers herself.  "<i>Anytime, little mouse; if you can handle all of this.</i>"  She\'s obviously trying to be bold about this - maybe your presence is unnerving her more than you thought.\n\n',
            false
        );

        this.outx(
            'Amily spares you another quick glance and lets gravity do its work, spearing herself on Urta\'s equine dick; she squeaks in pleasure and pain at the sudden intrusion.  Urta lets out a soft whine of delight, all attention lost from you and focused on the womanly folds now gripping her shaft.  "<i>Are you all right?</i>" she asks, a worried look eclipsing any show of pleasure.\n\n',
            false
        );
