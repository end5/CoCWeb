...
export class TelAdre extends BaseContent {
    ...
    private piercingStudio(): void {
        ...
        if (!this.flags[kFLAGS.LOW_STANDARDS_FOR_ALL])
            ...
            this.choices(
                ...
                null,
                "AsFemale",
                this.createCallBackFunction(this.letsDoYaraSex, true),
                "AsMale",
                this.createCallBackFunction(this.letsDoYaraSex, false),
                "About Her",
                about,
                "",
                null,
    ...
    private eyebrowPierce(): void {
        ...
        this.piercingLoc = 3;
        this.outputText(
            '"<i>Ah, that\'s a good look!  What do you want there?</i>" asks Yara.',
            true
        );
        this.simpleChoices(
            "Stud",
    ...
    */
    ...
    public tailorShoppe(): void {
        ...
        this.choices(
            ...
            this.createCallBackFunction(this.buyClothes, this.armors.CLSSYCL),
            this.armors.RBBRCLT.shortName,
            this.createCallBackFunction(this.buyClothes, this.armors.RBBRCLT),
            this.armors.ADVCLTH.shortName,
            this.createCallBackFunction(this.buyClothes, this.armors.ADVCLTH),
            this.armors.TUBETOP.shortName,
            this.createCallBackFunction(this.buyClothes, this.armors.TUBETOP),
            this.armors.OVERALL.shortName,
            this.createCallBackFunction(this.buyClothes, this.armors.OVERALL),
            this.armors.B_DRESS.shortName,
            this.createCallBackFunction(this.buyClothes, this.armors.B_DRESS),
            this.armors.T_BSUIT.shortName,
            this.createCallBackFunction(this.buyClothes, this.armors.T_BSUIT),
            this.armors.M_ROBES.shortName,
            this.createCallBackFunction(this.buyClothes, this.armors.M_ROBES),
            this.armors.LTHRPNT.shortName,
            this.createCallBackFunction(this.buyClothes, this.armors.LTHRPNT),
            "Leave",
            this.telAdreMenu
        );
    }
    ...
    private buyClothes(itype: ItemType): void {
        ...
        this.outputText(
            '"<i>' + itype.value + ' gems and it can be yours,</i>" she says.  ',
            false
        );
    ...
    public armorShop(): void {
        ...
        this.choices(
            ...
            this.createCallBackFunction(this.armorBuy, this.armors.CHBIKNI),
            this.armors.FULLCHN.shortName,
            this.createCallBackFunction(this.armorBuy, this.armors.FULLCHN),
            this.armors.FULLPLT.shortName,
            this.createCallBackFunction(this.armorBuy, this.armors.FULLPLT),
            this.armors.INDECST.shortName,
            this.createCallBackFunction(this.armorBuy, this.armors.INDECST),
            this.armors.LTHRROB.shortName,
            this.createCallBackFunction(this.armorBuy, this.armors.LTHRROB),
            this.armors.SCALEML.shortName,
            this.createCallBackFunction(this.armorBuy, this.armors.SCALEML),
            "",
            null,
            "Eggshell",
            egg,
    ...
    public weaponShop(): void {
        ...
        this.choices(
            ...
            this.createCallBackFunction(this.weaponBuy, this.consumables.W_STICK),
            this.weapons.CLAYMOR.shortName,
            this.createCallBackFunction(this.weaponBuy, this.weapons.CLAYMOR),
            this.weapons.WARHAMR.shortName,
            this.createCallBackFunction(this.weaponBuy, this.weapons.WARHAMR),
            this.weapons.KATANA.shortName,
            this.createCallBackFunction(this.weaponBuy, this.weapons.KATANA),
            this.weapons.SPEAR.shortName,
            this.createCallBackFunction(this.weaponBuy, this.weapons.SPEAR),
            this.weapons.WHIP.shortName,
            this.createCallBackFunction(this.weaponBuy, this.weapons.WHIP),
            this.weapons.W_STAFF.shortName,
            this.createCallBackFunction(this.weaponBuy, this.weapons.W_STAFF),
            this.weapons.S_GAUNT.shortName,
            this.createCallBackFunction(this.weaponBuy, this.weapons.S_GAUNT),
            "",
            null,
            "Leave",
            this.telAdreMenu
    ...
    private weightLifting(): void {
        ...
        if (this.player.fatigue > 75) {
            ...
            if (this.flags[kFLAGS.LIFETIME_GYM_MEMBER] == 0)
                this.outputText(
                    "It'd be better to save your money and come back after you've rested.",
                    false
                );
            this.doNext(this.telAdreMenu);
            return;
    ...
    private letsDoYaraSex(girl = true): void {
        ...
        this.outputText(
            "Not content with simple penetration, it seems, the cat girl gets to work.",
            false
        );
    ...
    private flirtWithVictoria(itype: ItemType): void {
        ...
        if (this.player.tallness >= 65) this.outputText("your stomach.");
        else if (this.player.tallness >= 55) this.outputText("your chest.");
        else this.outputText("your face.");
        this.outputText(
