...
export class Bazaar extends BaseContent {
    ...
    public findBazaar(): void {
        ...
        if (this.flags[kFLAGS.BAZAAR_ENCOUNTERED] == 0) {
            ...
            this.outx(
                "Once again you smell a campfire through the tall grass, and as you close the distance you hear the familiar sounds of the traveling bazaar.  You peek through the weeds and behold the caravan's gate-keeper - a red-skinned, muscular giant of a man.",
                false
            );
        }
    ...
    public enterTheBazaarAndMenu(demons = true): void {
        ...
        if (this.model.time.hours >= 9 && this.model.time.hours <= 17) {
            if (
                (this.flags[kFLAGS.FEMOIT_NEXTDAY_EVENT_DONE] == 1 &&
                    this.getGame().model.time.days >= this.flags[kFLAGS.FEMOIT_NEXTDAY_EVENT]) ||
                this.flags[kFLAGS.FEMOIT_NEXTDAY_EVENT_DONE] != 1
            ) {
        ...
        if (
            (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00292] == 1 ||
                this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00292] == 2) &&
            demons &&
            Bazaar.rand(10) == 0
        ) {
            // [Repeat Variant]
    ...
    private theSlipperySqueeze(): void {
        ...
        // (Repeat visit:
            ...
            this.outx(
                "The price list indicate it's 10 gems for a massage, though the gleefully illustrated 'oil' reminds you just what they plan to use on you.\n\n",
                false
            );
            if (this.player.findPerk(PerkLib.Androgyny) < 0) {
                this.outx(
                    "There also appears to be an option for a special 'Androgyny Treatment' that costs 500 gems.  Joey catches you looking at it and mutters, \"<i>That treatment isn't fun like our massages.  It would unlock the full potential of your visage, allowing it to be as masculine or feminine as possible.</i>\"\n\n",
                    false
                );
        ...
        if (this.isEaster()) {
            ...
            if (this.player.gems < 20) this.outx("  You can't afford it.");
    ...
    private joeyAndrogyny(): void {
        ...
        if (this.player.gems < 500) {
            this.outx("You haven't got enough gems for that treatment!");
        ...
        if (this.player.gender == 1) this.outx("you'll be able to be as cute as me!");
        else if (this.player.gender == 2)
            this.outx("you'll be able to be as masculine as you want!");
        else this.outx("you'll be able to be as cute as me or as masculine as you want!");
        this.outx(
            "</i>\" explains the bunny-eared fem-boy.   You allow yourself to be lead into a small back room, where you're guided into a soft, padded chair.  Joey turns about in the cramped interior, his shapely ass mere inches from your face, tail tickling your nose.  You struggle not to sneeze or stare too deeply at the curvy fem-boy's butt-cheeks, but it's hard to focus with that delicious target waggling in front of you.\n\n",
            false
        );
        ...
        this.outx(
            "Thanking the cute bunny-boy for his help, you hand over the payment and head back to check on camp.",
            false
        );
    ...
    private joeysMassageWifNoExtraJizz(): void {
            ...
            if (this.player.totalCocks() > 1) {
                ...
                if (this.player.totalCocks() > 2) {
                    ...
                    if (this.player.totalCocks() > 3)
                        ...
                        this.outx(
                            `, coating your ${this.cockDescript(2)} with dick-drenching bunny spit.`
                        );
                }
            }
        ...
        // (Dickgasms
            ...
            this.outx(
                "Globules of spooge squirt in time to your motions, feeding those ruby lips the treat them seem to ache for.  The rain of slick, syrupy cum on your face intensifies, spurting heavier ropes of bunny-cream each time you make the poof-tailed fem-boy swallow.  He gasps hard in between each semen-sucking gulp, all while giving you an impressive facial.  If you could see yourself, you would probably look like you're wearing enough boy-sludge to knock up an entire village.  The perverse mental image sets off a whole new set of contractions, releasing a few more waves of bliss and 'tension'.\n\n",
                false
            );
            this.outx(
                "Joey climbs off once you've wound down and laps at the cum over your eyes, nose, and mouth, cleaning you enough to see properly.  The first thing you see is a girlish, cum-stained face.  He makes a show of cleaning the spunk from himself, but throws you a towel as he does so. You lick the last of his flavorful cum from your mouth, noting that while he's already put his thong back on, it's bulging obscenely and he's still squirting inside!",
                false
            );
            if (this.player.cumQ() >= 700) {
                this.outx(`  A smile widens your ${this.player.face()} when you see the `);
                ...
                this.outx("  He won't be hungry for some time.");
            }
            this.outx(
        ...
        if (this.player.sens > 40) this.dynStats("lib", -0.5);
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private joeysMassageWithEXTRASpooge(): void {
        ...
        this.outx(
            "Of course you don't complain, not with the growing puddle forming between you and the cum-soaked sheets.  Every time your masseuse shifts, the movement makes you slide in your sticky mess, the cum-lubed friction of the sheets helping the constant jizz-flow to thicken into a steady river of seed.  ",
            false
        );
        if (this.player.balls > 0)
            this.outx(
                "Your balls pull and relax and pull tight, bouncing below you over and over, all while working hard to produce more juice for you to gush.  ",
                false
            );
        this.outx(
            "Even though you're draining spunk at an alarming rate, it doesn't feel like a normal orgasm.  There's no wave of pressure and subsequent release, just a constant, pulsing contraction that makes you melt with ever-increasing feelings of satisfaction.\n\n",
            false
        );

        this.outx(
            "Joey giggles, turning about to put his lotion-dispenser on the small of your back, and you feel the hot bunny-spoo pour onto you in a wave.   It's gathered up and pushed up your back.  Globs of it roll down your side, sliding over the semi-waterproofed sheets to mix with your growing spunk-lake.  With the slippery-seed aiding Joey's massage, he somehow manages to work out even more of your tension.  By this point your muscles feel like jello melting in the afternoon sun.  You feel like you could melt into your cum, and you sigh in bliss",
            false
        );
        if (this.player.cumQ() >= 1500)
            this.outx(
                ".  The sound of your rivers of spooge splattering against the floor barely registers, but a part of you is proud to be so incredibly fertile",
                false
            );
        this.outx(".\n\n", false);
        ...
        if (this.player.cumQ() >= 1500)
            this.outx(
                "  Joey's jaw drops from the unexpectedly large volume you're producing, and he watches in awe as each huge globule of cum rolls off you towards the floor.",
                false
            );
        this.outx("\n\n", false);
        ...
        if (this.player.skinType != SKIN_TYPE_FUR) this.outx(`over your ${this.player.skinDesc}`);
        ...
        this.outx(
            "Joey leaves, his poofy tail bobbing back and forth.  You can see his thong is distended, virtually packed with his own still-pumping spooge, and you marvel at his perverse ingenuity when you realize his thong is waterproofed and shaped to guide all the jizz between his thighs and into his back-door.  Kinky.",
            false
        );
    ...
    private joeyBigBalls(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00348] == 0) {
            ...
            this.outx(
                "You push the panicked lagomorph back a pace so that you can breathe and appraise the situation.  Joey's legs are drenched, soaked with sloppy spooge.  His thong is on the verge of bursting.  Most notable, his bloated balls look more like cantaloupes than testicles, and these melons are ripening to an unseen Demeter's power, swelling ever-so-slightly larger with each passing second.  You estimate that there's precious little time.\n\n",
                false
            );

            this.outx(
                "Why is it that no one ever desperately requires your assistance with a mundane task?  Sighing, you judge",
                false
            );
            if (this.player.cor > 60) this.outx(", with no more than a bit of wishful thinking,");
            this.outx(
    ...
    private joeyWanksItOut(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00349] == 0) {
            this.outx(
                "You tell Joey that if he masturbates to erectness, his body should be able to shoot it out faster.  He smacks his forehead and runs into a back room, his thong disintegrating around his growing testes as he runs. The door slams, leaving you in peace.  A little freaked out, you head back to camp for now.",
                false
            );
            this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private suckOffJoeysGardenHose(): void {
        ...
        this.outx(
            'Joey\'s rouged lips silently mouth, "<i>Oh gods,</i>" as he delivers the next, even bigger rope to your eager maw, stuffing your mouth so quickly that his jism squirts from the corners before you can react.  You shiver from the semen overload',
            false
        );
        if (this.player.minotaurAddicted())
            this.outx(
                " and find yourself wishing you had one of these potions to use on a minotaur.  It would be divine!",
                false
            );
        else
            this.outx(
                " and keep at it.  The knowledge that you're helping a friend is almost as filling as his delicious cum.",
                false
            );
        this.outx(
            "  White goo drips down your chin towards the floor, but you note that his balls are now back down to the size of grapefruits.  You're making progress!\n\n",
            false
        );
        ...
        this.outx(
            "Joey moans, \"<i>You're so good at this!  B-but I still feel so pent up... so full.  I don't think it's slowing down yet!</i>\"\n\n",
            false
        );
        this.outx(
        ...
        else if (this.player.cor < 66) this.outx("also kind of fun, in a naughty way.");
        else this.outx("exactly the kind of nasty stuff that gets your blood pumping.");
        this.outx(
        ...
        this.outx("Joey blushes again and begins looking for a mop.");
    ...
    private overHearDemonsAboutSyrena(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00292] == 0) {
            this.outx(
                "A whisper of conversation catches your ear while you're wandering the bazaar, and overcome by curiosity, you veer towards it.\n\n",
                false
            );
            this.outx(
                "As you're closing in on the voices, the dialogue grows clear enough to understand.\n\n",
                false
            );
            this.outx(
                "\"<i>-old him if he doesn't finish this week's experiments, she's going to drop him into a submission tank instead of the champion!</i>\" exclaims the first voice, sounding quite feminine.\n\n",
                false
            );
            this.outx(
                "A baritone response rings out, \"<i>You're shitting me!  Syrena's off her fucking rocker if she thinks Lethice will let her turn another of our researchers into a gibbering slut.  We've got enough of those.</i>\"\n\n",
                false
            );
            this.outx(
        ...
        // [Listen in repeat]
            ...
            this.outx(
                '"<i>-still sore!  I can\'t believe she did that to me!</i>" groans the male.\n\n',
                false
            );
            this.outx(
                'Smiling cruelly, the slick-pussied succubus says, "<i>You deserved it.  Honestly, you turned in cum-stained reports to your boss, and you\'re surprised that she took your ass for a ride as punishment?  If you ask me, you planned all this.  Who do you think had to clean up the huge mess you left on the floor?</i>"\n\n',
                false
            );
            this.outx(
                'For once, the incubus seems speechless.  He mutters, "<i>Well, I didn\'t plan it.  I-I was just having fun with one of the new slaves - for inspiration - while I finished up the paperwork.</i>"  He looks over and punches the leering female\'s arm.  "<i>Besides, I thought you liked cleaning up my cum?  I\'ve never seen you complain before.</i>"\n\n',
                false
            );
            this.outx(
                "The succubus laughs and slaps his ass as she answers, \"<i>Don't worry, you taste great... just not as good as the boss.  I dunno what concoction she made that did it, but her spunk is heavenly.  I could just... mmm... swallow that delicious cream all day long.  Do ya think she's part minotaur?</i>\"\n\n",
                false
            );
            this.outx(
                "\"<i>Babe, you're sliming everywhere again.  Why don't we go blow off some steam?</i>\"  The two horny demons run off and disappear.\n\n",
                false
            );
        }
        // [Listen in Repeat 2]
            ...
            this.outx(
                "Meanwhile, the male incubus is knocking back a beer, grumbling, \"<i>Could you take it down a notch?  It isn't like this is the first time you've had to lug around a load of imps - don't be so melodramatic.</i>\"\n\n",
                false
            );
            this.outx(
                "His pregnant companion growls and tugs at her undersized labcoat, failing to conceal the blueberry-colored bulge of her belly from him as she retorts, \"<i>You didn't have to get all these fucked into you, now did you?  Hell, she even shot me up with fertility-plus first!  It feels like there's two dozen of the little bastards packed in there!  I figure in another day or two I won't even be able to walk.</i>\"\n\n",
                false
            );
            this.outx(
                "\"<i>So does that mean you won't mind if I stop by whilst you're laid up?  I mean you can't get any more pregnant with imps, and it might pass the time,</i>\" suggests the well-muscled male.\n\n",
                false
            );
            this.outx(
                'Smirking, the demoness retorts, "<i>Sure, but next time you fuck up, I\'m loaning Syrena some of my girly stuff to make you suffer just like this.</i>"  Her hands both point at the imp-engorged skin of her midsection for emphasis.\n\n',
                false
            );
            this.outx(
                "The incubus rises and taunts, \"<i>If I fucked up as often as you did, I'd be feeding the furnace in a factory somewhere or fed to the hellhounds.  Come on, let's get you home before I have to roll you back.</i>\"\n\n",
                false
            );
            this.outx(
    ...
    private gretasGarments(): void {
        ...
        if (this.flags[kFLAGS.FOUND_SOCKS] == 1 && this.flags[kFLAGS.SOCK_COUNTER] == 0) {
            this.outx(
                "As you enter the store, you're surprised to see that a variety of products line the shelves.  Clothing of various materials, sizes and shapes lay folded on shelves and tables around the little shop.  A lone, surprisingly anatomically correct mannequin stands by the counter nude except for a thin lacy piece of fabric held taut over its wooden penis."
            );
            this.outx(
        ...
        if (this.flags[kFLAGS.FOUND_SOCKS] < 2) {
            ...
            if (this.flags[kFLAGS.OWN_MAIDEN_BIKINI] == 0)
                this.outx(
                    ", except maybe a super-skimpy chain bikini that's chased with white and gold highlights"
                );
        } else {
            this.outx(
    ...
    private askGretaAboutInventory(): void {
        this.clearOutput();
        this.outx(
            "Curious about the lack of selection, you broach the topic with the slutty shopkeeper, asking just where the items she has for sale are at."
        );
        this.outx(
    ...
    private askGretaAboutZeBikini(): void {
        ...
        // [Buy It] [Back]
        this.menu();
        if (this.player.gems < 500) this.outx("\n\n<b>You can't afford it.</b>");
    ...
    private buyGretasBikini(): void {
        ...
        this.player.gems -= 500;
        this.statScreenRefresh();
        this.outx('Greta\'s eyes widen in surprise.  "<i>Really?</i>"');
        this.outx(
    ...
    private browseDemSocksSon(): void {
        this.clearOutput();
        this.outx("What type of cock-sock do you want to look at?");
        // Cock-sock Menu
        this.menu();
    ...
    private cockSelectionMenu(): void {
        this.menu();
        if (
            (this.flags[kFLAGS.SOCK_HOLDING] == "amaranthine" && this.player.gems >= 1000) ||
            (this.flags[kFLAGS.SOCK_HOLDING] == "gilded" && this.player.gems >= 3000) ||
            (this.flags[kFLAGS.SOCK_HOLDING] == "cobalt" && this.player.gems >= 250) ||
            (this.flags[kFLAGS.SOCK_HOLDING] == "scarlet" && this.player.gems >= 250) ||
            (this.flags[kFLAGS.SOCK_HOLDING] == "viridian" && this.player.gems >= 1000) ||
            (this.flags[kFLAGS.SOCK_HOLDING] == "cockring" && this.player.gems >= 100) ||
            (this.flags[kFLAGS.SOCK_HOLDING] == "alabaster" && this.player.gems >= 25) ||
            (this.flags[kFLAGS.SOCK_HOLDING] == "wool" && this.player.gems >= 10)
        )
    ...
    private yesPutDatSockOnMe(target: number): void {
        ...
        if (this.flags[kFLAGS.SOCK_HOLDING] == "cockring") {
            ...
            if (this.player.findPerk(PerkLib.PentUp) < 0)
                this.player.createPerk(PerkLib.PentUp, 10, 0, 0, 0);
        ...
        if (!conflict) {
            // There's no conflict. DO IT!!!
            this.player.cocks[target].sock = this.flags[kFLAGS.SOCK_HOLDING];
            this.statScreenRefresh();

            this.outx(
                "With one hand she lifts your limp cock up, giving it a pleasant little stroke."
            );
    ...
    private takeOffDatSock(): void {
        this.clearOutput();
        this.outx("Which cock-sock would you like to get removed?");
    ...
    private removeTargettedSock(index: number): void {
        ...
        if (this.player.cockArea(index) >= 100)
            this.outx(", almost knocking Greta over in the process");
        this.outx(
            ", the cock-sock suddenly feeling unforgivingly tight.  With a light giggle, Greta gives your dick a soft kiss, and the burning arousal seems to dissipate, replaced with a cool, relaxing sensation that spreads throughout your body."
        );
        this.outx(
        ...
        if (extra && storage == "cockring") {
            if (this.player.perkv1(PerkLib.PentUp) >= 10)
                this.player.addPerkValue(PerkLib.PentUp, 1, -5);
    ...
    */
    ...
    private joeySweetMassage(): void {
        ...
        this.statScreenRefresh();
        this.outx(
            "Joey claps excitedly, his little puffy tail bouncing happily.  \"<i>Great!  It's a customer favorite, so I'm sure you'll just love, love, love it!</i>\"  He takes your hand and leads you towards the back rooms, letting the door shut behind the two of you with a soft click.  As usual, in the center of the room is a padded bed meant for you, and at Joey's insistence you disrobe to lie down on it.  You put your face through the rounded oval and relax, taking the moment to watch Joey's bare feet with their cute painted nails prance in and out of sight as he bustles around the room.  He pauses briefly by the coal-fired steam-oven, stoking it for a minute before turning back towards you."
        );
    ...
    private eggsInButt(eggButt = false): void {
        ...
        this.outx(
            ", spreading his sweet bounty all over.  His fingers to go work, rubbing up and down"
        );
        if (!this.player.hasCock()) this.outx(", in and out");
        this.outx(", removing all that pent up tension from inside you.  ");
        if (this.player.hasCock())
            this.outx(
                "[EachCock] begins leaking pre-cum, mixing with Joey's on your belly to create what looks like a chocolate-white chocolate marbled confection."
            );
        else if (this.player.hasVagina())
            this.outx(
                "Your cunt grows ever wetter, and not just because of the new chocolate coating.  Despite Joey's femboy appearance, you've got to hand it to him, he does know his way around a pussy."
            );
        else
            this.outx(
                "Your asshole winks and clenches, aching for release that Joey is kind, and skilled, enough to give."
            );
        ...
        if (this.player.hasCock())
            this.outx(
                "takes hold of [oneCock] and strokes gently, rubbing his thumb against the head"
            );
        else if (this.player.hasVagina())
            this.outx(
                "reaches between his legs, slipping two fingers inside you while his thumb gently rubs your clit"
            );
        else
            this.outx(
                "reaches between his legs, slipping two fingers inside your ass while his thumb rubs against your perineum"
            );
        this.outx(", and with his free hand he leans forward, tweaking a [nipple] softly.");
        ...
        if (this.player.hasCock())
            this.outx(
                "[eachCock] pulses and spasms, loosing rope after rope of white jizz through the air, splattering against the wall and floor messily"
            );
        else if (this.player.hasVagina())
            this.outx(
                "your pussy tightens around his fingers, suddenly releasing a flood of femcum that splatters messily against the table"
            );
        else
            this.outx(
                "your asshole twitches and spasms, unable to do much more than grant you a vague half-orgasm"
            );
        this.outx(
            ".  Your entire body tingles as you slowly descend back to the table, practically melting into it as if you were nothing more than the bunny-spunk covering your skin."
        );
        ...
        if (this.player.hasCock()) {
            if (this.player.biggestCockArea() >= 30) this.outx(", especially compared to you.");
            else if (this.player.smallestCockArea() < 6)
                this.outx(", of course, if he's considered tiny, what does that make you?");
        } else this.outx(".");
        this.outx(
            "  You suck and slurp, slipping your tongue up and down his length until not a trace of chocolate remains.  His penis continues to leak the chocolatey pre-cum, but the deeper you take him, the less it matters, until he's practically pumping the chocolate directly into your stomach."
        );
    ...
    private abuseHisAss(): void {
        ...
        if (this.player.smallestCockLength() >= 16) {
            ...
            if (this.player.totalCocks() == 1)
                ...
                this.outx(
                    "  Your fattest cock grinds between the tiger man's rear, dripping spunk over his back and clothing while your other cocks make a sloppy mess of his ass."
                );
            this.outx(
    ...
    private collectSomeButtSmex(): void {
        this.clearOutput();
        this.outx(
            "Your body crashes into a wooden table and you choke, feeling the wind knocked out of you.  You struggle to lift your head and catch your breath, only to find yourself laying in... poker chips?"
        );
        ...
        if (this.player.hasCock()) this.outx(" and hard shaft");
        ...
        if (this.player.lib < 50) this.outx("fear");
        else this.outx("excitement");
        this.outx(".");
    ...
    private finalGayFinallee(road = 0): void {
        ...
        if (road == 0) {
            ...
            if (this.player.gender > 0)
                this.outx(
                    "  Your lips part as you moan, feeling your climax building before coating the tiger's hand and your lower body in your sex.  The tiger man just brings his hand up to his lips to taste your juices before hilting into you one last time."
                );
            this.outx(
                "  A third wave  of warmth floods you, the pressure growing even higher as you resemble an overstuffed, breeding bitch.  Exhaustion catches up with you and you begin to feel your eyes grow heavy.  The last thing you see is the feline's face contorted in pleasurable orgasm before you nod off."
            );
        ...
        // ((Ending 2 , suck bear, //crazy steel jaw))
            ...
            if (this.player.gender > 0)
                this.outx(
                    "  Your lips part as you moan, feeling your climax building before coating the bear's hand and your lower body in your sex.  The bear just brings his hand up to his lips to taste your honey before hilting into you one last time."
                );
            this.outx(
                "  A third wave of warmth floods you, the pressure growing even higher as you resemble an overstuffed, breeding bitch.  Exhaustion catches up with you and you begin to feel your eyes grow heavy.  The last thing you see is the bear's face contorted in pleasurable orgasm before you nod off."
            );
        ...
        // ((Ending 3 , suck none, //No furry plx))
            ...
            if (this.player.gender > 0)
                this.outx(
                    "  Your lips part as you feel your climax building, and soon you coat the orc's hand and your lower body in your lust.  The orc just brings his hand up to taste your juices before hilting into you one last time."
                );
            this.outx(
                "  A third wave of warmth floods you and the pressure grows even higher as you resemble an overstuffed breeding bitch.  Exhaustion catches up with you and your eyes begin to grow heavy.  The last thing you see is the orc's face twisted in orgasmic pleasure before you pass out."
            );
            ...
            if (this.player.gems > 1) {
                this.outx("The only thing missing is a few gems.  ");
                this.player.gems -= 3 + Bazaar.rand(4);
                if (this.player.gems < 0) this.player.gems = 0;
            }
            this.outx(
