...
*/
    ...
    public sharkGirlEncounter(exploreLoc = 0): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.SharkGirl) < 0)
            this.player.createStatusAffect(StatusAffects.SharkGirl, 0, 0, 0, 0);
        else if (
            this.player.statusAffectv1(StatusAffects.SharkGirl) >= 7 &&
        ...
        this.outx(
            "A grey blur bursts from the water and lands on the ground a few feet away from you.\n\n",
            false
        );
        this.outx(
        ...
        this.outx("You're fighting a shark girl!");
    ...
    public sharkWinChoices(): void {
        ...
        if (this.monster.HP < 1) {
            this.outx("The shark-girl falls, clearly defeated.", true);
        }
        // Lust win
        else {
            this.outx(
        ...
        if (this.player.lust >= 33 && this.player.gender > 0) {
            this.outx("  Do you have your way with her or leave?");
            const dildo =
    ...
    private sharkgirlSixtyNine(): void {
        ...
        if (this.player.isNaga()) {
            ...
            this.outx(
                "Making up your mind to rape the shark girl, you remove your " +
            ...
            if (this.player.gender == 3)
                this.outx(
                    ". You remind her not to neglect your " +
                        this.cockDescript(0) +
                        ", and the shark girl responds by thoroughly licking your hard erection and sucking at your " +
            ...
            this.outx("\n\n", false);
            this.outx(
                "You shove the shark girl down onto the ground and quickly plant your crotch on her face, ordering the shark girl to continue. She complies enthusiastically, licking with a greater intensity and clearly loving the sensation of being dominated. You have to admit, you are enjoying your role as master.\n\n",
                false
            );
            this.outx(
                "To reward your little slut for her efforts, your hand reaches back between her legs and slips under her skimpy black thong. You get to work fingering her moist cunt and you soon hear a series of muffled moans coming from beneath your legs. But she's smart enough to know not to stop licking, and you smirk at the effect you're having on the shark girl.  A cute little cry escapes from your little slave's mouth, and you pull your hand from her cunt before licking her sweet juices from your fingers. Shortly after, you cry out in orgasm",
                false
            );
            if (this.player.gender == 2)
            ...
            this.outx(
                "Thoroughly satisfied, you leave the shark girl on the ground covered in your fluids and depart for your camp.",
                false
            );
        }
        this.cleanupAfterCombat();
    ...
    public sharkLossRape(): void {
        ...
        if (this.player.gender == 0) {
            this.outx("You slump down in defeat, too ");
            if (this.player.HP < 1) this.outx("hurt ");
            ...
            this.outx(
                "The shark girl does a little victory dance, swaying her hips to and fro before moving over to you. She quickly removes your " +
                    this.player.armorName +
                    ', but her smile fades to a blank expression when she notices you lack any genitalia. "<i>What the...</i>" she mumbles, poking you in the groin. Finding you completely useless, she growls in frustration and stomps on your face in anger. The sudden pain makes you pass out.',
                false
            );
            this.cleanupAfterCombat();
            this.dynStats("tou", -2);
        ...
        if (
            ...
            this.outx(
                "The shark girl giggles and moves over to you, tugging at your " +
                    this.player.armorName +
                    "  impatiently. Her tail swishes around and smacks your " +
                    this.assDescript() +
                    '. "<i>You\'re gonna make me very happy, you hear? Otherwise...</i>" she opens her mouth wide and you see her fangs glinting menacingly in the light. You gulp hard and nod, bringing a smile from the shark girl.\n\n',
                false
            );
            this.outx(
        ...
        // Male:
            ...
            this.outx(
                "You feel the shark girl's bare foot press against your chest and she roughly pushes you onto your back. \"<i>Oh man, I can't even remember the last time I had an actual man...</i>\" the shark girl says, pulling your pants down to your ankles. Seeing your stiff erection, your opponent smirks and wets her lips before taking your entire " +
                    this.cockDescript(0) +
                    " into her mouth. The feeling is heavenly, her long tongue slithering around your shaft.\n\n",
                false
            );
            this.outx(
                "But before you can begin to really enjoy it, she pulls her head away, visible strands of saliva still linking her mouth and your " +
                    this.cockDescript(0) +
                    ". The shark girl quickly maneuvers herself so that she's straddling your cock and presses herself down, the two of you gasping sharply from the sensation. \"<i>Hmm, good boy... You make me cum first, and I won't bite you. Deal?</i>\" You nod, though given that peculiar feelers inside her cunt are massaging your cock, you don't know how long you can really hold out.\n\n",
                false
            );

            this.outx(
                "The shark girl has no such qualms and rides you like a mechanical bull, hammering up and down your " +
                    this.cockDescript(0) +
                    " with incredible speed. It certainly feels nice, but the rough nature of the ride also certainly hurts. You'll be walking funny for a while after this, that's for sure.\n\n",
                false
            );

            this.outx(
                'Eventually, her vagina clamps down on your cock and she cries out in orgasm. You grunt loudly and cum a few seconds after, pumping your seed into her womb. The shark girl leans over and plants a tiny kiss on your lips. "<i>Good boy. I\'ll be sure to see you again</i>". She gets up again and you watch her re-enter the water before you pass out.',
                false
            );
            this.player.orgasm();
            this.dynStats("sen", 1);
