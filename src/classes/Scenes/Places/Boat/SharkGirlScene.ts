...
*/
    ...
    public sharkGirlEncounter(exploreLoc: number = 0): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00230] == 0) this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00230] = 1;
        if (this.player.findStatusAffect(StatusAffects.SharkGirl) < 0) this.player.createStatusAffect(StatusAffects.SharkGirl, 0, 0, 0, 0);
        else if (this.player.statusAffectv1(StatusAffects.SharkGirl) >= 7 && this.player.totalCocks() > 0) {
    ...
    private sharkgirlDickFuck(): void {
        ...
        //Non-nagaz
            ...
            //[if herm]
            if (this.player.gender == 3) this.outputText("  The sensation is incredible, and you find yourself massaging your " + this.biggestBreastSizeDescript() + " and tweaking your " + this.nippleDescript(0) + "s in an attempt to bring your pleasure to even greater heights.", false);
            this.outputText("\n\n", false);
    ...
    public sharkLossRape(): void {
        ...
        if (this.player.hasVagina() && (this.player.totalCocks() == 0 || SharkGirlScene.rand(2) == 0)) {
            ...
            //[if herm]
            if (this.player.gender == 3) this.outputText("Seeing your " + this.cockDescript(0) + " puts a smile on the shark girl's face as she takes a firm grip on your erection. \"<i>Well, you're just full of surprises, aren't you? Maybe I'll give this bad boy a whirl sometime. For now though...</i>\"  ", false);
