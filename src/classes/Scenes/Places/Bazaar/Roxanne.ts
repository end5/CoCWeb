...
export class Roxanne extends BazaarAbstractContent implements TimeAwareInterface {
    ...
    public timeChange(): boolean {
        ...
        this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225]++;
        //Reset if she finds someone to take it (random at high values)
        if (
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 300 &&
            this.model.time.hours == 1 &&
            Roxanne.rand(5) == 0
        )
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] = 1;
        //hangover status stuff
        if (this.player.findStatusAffect(StatusAffects.Hangover) >= 0) {
            //Countdown
            if (this.player.statusAffectv1(StatusAffects.Hangover) > 0)
                this.player.addStatusValue(StatusAffects.Hangover, 1, -1);
            else {
                this.outputText(
                ...
                //Restore stats
                this.player.str += this.player.statusAffectv2(StatusAffects.Hangover);
                this.player.spe += this.player.statusAffectv3(StatusAffects.Hangover);
                this.player.inte += this.player.statusAffectv4(StatusAffects.Hangover);
                this.dynStats("cor", 0);
                //Clear status
                this.player.removeStatusAffect(StatusAffects.Hangover);
                return true;
            }
        }
    ...
    public RoxanneAppearance() {
        ...
        if (this.model.time.hours > 12 && this.model.time.hours < 19) {
            //(Not Met)
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00221] == 0)
                this.outputText(
    ...
    private Roxanne1stApproach(): void {
        ...
        this.outputText(
            "You hesitantly approach the drinking lizard-folk, taking note of their unusual garments and appearance.  They all wear black jackets with silver trim, tight-fitting leather pants, and tall, black boots.  Oddly, the most feminine of them appears to be the leader.  Her jacket is filled out with large, well-rounded DD-cup breasts, and her boots forgo the traditional shape for a sluttier, higher heel.  Her scales are a dark purple, glittering darkly in the light, and while her head has a lizard-like shape, a pair of dragon-like horns bulge from the back of her skull in place of hair.  The other lizans all appear to be males, but they act as if they're quite intimidated by the feminine leader.\n\n",
            false
        );
        this.outputText(
            'Suddenly, the alpha-lizan glances up and meets your eye, her expression turning into a leering sneer as she asks, "<i>See something you like ' +
                this.player.mf("buddy", "girly") +
                '?  Come on over, tell us your story!</i>"\n\n',
            false
        );
    ...
    private RoxanneChooseApproachOrRepeat(): void {
        ...
        //[Approach – met but not drank yet]
            ...
            this.outputText(
                "\"<i>I see you've come back again " +
                    this.player.short +
                    '.   Did you come back for the free drinks, or... ?</i>" Roxanne trails off, wiggling her tongue at you.  She pats the huge, barely concealed bulge and asks, "<i>Or did you want to lose?  Remember, if I win I get to plug your ass with this beast.  If you win, I\'ll give you oral service that only a lizard can.  Now come on, let\'s drink until we forget this wretched place.</i>"\n\n',
                false
            );
            this.outputText("Do you engage Captain Poisontail in a drinking contest?", false);
        }
        //[Approach – lost last contest and she's huge]
        else if (
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00224] == 2 &&
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 200
        ) {
            this.outputText(
                "\"<i>Oooh, praise the sea god Ulrun, you've returned.  " +
                    this.player.short +
                    ", it's been a while, and I've gotten sooooo big,</i>\" cheers an ecstatic Roxanne.  To emphasize her point she shows the seam-splitting bulge in her pants, rubbing it from the base all the way down to the tip, which rests next to her knee.  She's so big, and a damp spot appears at her pant-leg's knee while the huge cock-sausage visibly inflates.  Captain Poisontail asks, \"<i>So, can I count on you to get sauced and help me take care of this beast again, or do you actually think you have a chance of winning now?</i>\"\n\n",
                false
            );
            this.outputText(
                "It looks like she wants to engage you in another drinking contest.  If you lose ",
                false
            );
            if (this.player.analCapacity() >= 100)
                this.outputText("she's going to keep you stretched and gaping", false);
            else
                this.outputText(
                    "she's probably going to stretch your ass beyond its normal limits",
                    false
                );
            this.outputText(".  Do you enter a drinking contest with Roxanne?", false);
        }
    ...
    private roxanneDrinkingContestLoseDeliberately(): void {
        this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00226] = 1;
        this.roxanneDrinkingContest();
    }
    ...
    private roxanneDrinkingContest(): void {
        this.spriteSelect(78);
        this.outputText("", true);
        this.outputText("Roxanne ", false);
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 200)
            this.outputText("stumbles over her huge manhood, working towards", false);
        else this.outputText("saunters over to", false);
        this.outputText(
        ...
        this.outputText(
            "You take the mug and hand it to the tainted 'taur working the tap.  ",
            false
        );
        if (
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00222] +
            ...
            this.outputText(
                "He smirks at you as he fills it, radiating amusement at your attempt to out-drink Roxanne Poisontail.  It seems the locals don't believe you can win",
                false
            );
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00224] == 2)
                this.outputText(" after your last humiliation.", false);
            else this.outputText(" against such a renowned foe.", false);
        } else
            this.outputText(
                "He leers at Roxanne as he fills your mug, remembering her last defeat and likely wishing he could feel her tongue as you did.",
                false
            );
        ...
        if (
            ...
            this.outputText(
                "hesitantly sniff at the brew, taking in its dark color and heady, hoppy aroma before",
                false
            );
        ...
        //(REPEAT: PC HAS LOST BEFORE BUT WON LAST TIME)
            ...
            this.outputText(
                '"<i>Don\'t get cocky, pup.  Roxanne Poisontail has defeated and claimed bigger sailors than you in her lifetime.  That last time was a fluke,</i>" she proclaims.  The determined lizan swishes her full mug around for a moment before downing it in one huge, throat-bulging gulp.   Her prehensile tail slaps your ' +
                    this.buttDescript() +
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00226] == 0) {
            this.outputText(
                "The 'taur at the tap quickly grows bored with the constant bantering between the scaly swashbuckler and yourself, only bothering to look your way when the two of you walk back for a refill.  The gluttonous chugging that started the contest gives way to a more languid pace as you and Roxanne become increasingly intoxicated, slowing down in hopes that the other will be judged unfit first.  It does get a little hard to focus with the way she's constantly eyeballing you, and her curvy figure and ",
                false
            );
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 200)
                this.outputText("massive, seam-ripping bulge", false);
            else this.outputText("hard-to-hide bulge", false);
            this.outputText(
                " give you more than an eyeful every time you return her leer.  Still, the scaly shemale must be feeling the same way, judging by the large damp spot her cock is making.\n\n",
                false
            );
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00226] == 0)
            score =
                this.player.tallness *
                    ((this.player.thickness + 100) / 200) *
                    (this.player.tou / 100) +
                this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00227];
        ...
        if (score < 45 + Roxanne.rand(20)) {
            ...
            this.outputText(
                "Giggling and nearly tripping up on your own " +
                    this.player.feet() +
                    ', you stumble up to the corrupted deer-taur.  He looks at your wobbling stance, nearly-vacant eyes, and dopey grin before he shakes his head from side to side and says, "<i>No.</i>"  ',
                false
            );
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00226] == 0)
                this.outputText("Nooooo! You're cut off! That means Roxanne won...", false);
            else
                this.outputText(
                    "Yessss!  You finally got so drunk that Roxanne has no excuse not to pack your drunk ass full of lizan-spoo!",
                    false
                );
            this.outputText(
                "  A scaled hand slaps your " +
                    this.buttDescript() +
                    " spinning you around to fall drunkenly into the pirate's soft, cushy chest.  \"<i>Don't worry, I'll be gentle,</i>\" she whispers, hooking an arm around your sagging frame.",
                false
            );
            //CHOOSE SEX SCENE
            ...
            if (
                ...
                this.player.tone <= 50 &&
                this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00223] > 1 &&
                Roxanne.rand(2) == 0
            )
                this.doNext(this.bigBootyRoxanneContestLoss);
            //TO huge or regular anal
            else if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 200)
        ...
        //[WIN]
            ...
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00224] = 1;
            //Gain small bonus
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00227] += 4;
            this.outputText(
                "Laughing uproariously, you watch with a bemused expression while Roxanne tries to stumble up to the tap, tripping over her tail three times before she finally manages to ask for another mug.  The partly-corrupted deer-taur shakes his head and folds his arms across his chest.  She's been cut off!  You win!  The lecherous lizan stamps her heeled boot in the dirt before tramping back over to you, hips swaying drunkenly.  She trips on her tail again, this time falling face-first into your lap.  Hiccuping drunkenly, Roxanne slurs, \"<i>Well at leasht I don't havta go far to give you your winningshh, huh?</i>\"\n\n",
                false
            );
            this.outputText(
                "The other lizans are looking at you with a watchful eye.  It looks like you'll have to stick by the terms of the contest.  What manner of oral service do you make her provide?",
                false
            );
    ...
    private roxanneGivesABlowjob(): void {
        ...
        this.outputText(
            "You open the lower portion of your " +
                ...
                " and, pulling it back, hang out your " +
                this.multiCockDescriptLight() +
                "; ",
            false
        );
        if (this.player.lust < 70) this.outputText("it stiffens to a full, erect state.", false);
        else this.outputText("the already-hard cock-flesh stands proud and erect.", false);
        this.outputText(
            "  Roxanne giggles drunkenly, her half-lidded eyes looking up as she wobbles back and forth on her knees.  \"<i>I don't do thish that much, but when you've got a dick that getsh as big as mine... you learn just where the good spotsh are.</i>\"\n\n",
            false
        );

        this.outputText("Roxanne's smooth, scaled hand curls around the ", false);
        if (this.player.hasKnot(x)) this.outputText("knot", false);
        else if (this.player.hasSheath()) this.outputText("sheath", false);
        else this.outputText("base", false);
        this.outputText(
            ", squeezing you softly while she steadies herself on your " +
                this.cockDescript(x) +
                ".  She titters, letting a few inches of tongue slip through her lips to envelop your sensitive " +
        ...
        if (this.player.balls > 0)
            this.outputText(
                "A set of warm, long-nailed fingers squeeze your " +
                    this.ballsDescriptLight() +
                    ", dragging sharp nail-tips along the underside of your sack to tease the poor, cum-packed orbs.  ",
                false
            );
        this.outputText(
        ...
        this.outputText(
            "You slump back in your chair, sprawling out your " +
                this.player.legs() +
                " around you, completely relaxed by the alcohol flowing through your veins and the exquisite oral service.  Roxanne returns her focus to your " +
                this.cockDescript(x) +
        ...
        if (this.player.cockArea(x) < 60)
            this.outputText("the entire length of your " + this.cockDescript(x), false);
        else this.outputText("as much of your over-sized member as she can encompass", false);
        this.outputText(
            ", constricting, snake-like, to hold you in a slippery, warm embrace.  Suddenly, a pointed nail drags over your taint, pressing just hard enough to hold you still while the shemale pirate works your " +
                this.cockDescript(x) +
                " with her tongue",
            false
        );
        if (this.player.hasVagina())
            this.outputText(", stopping just short of your female entrance", false);
        this.outputText(".\n\n", false);

        this.outputText(
            "Slurping and pumping, the pulsating tongue drags over your " +
                this.cockDescript(x) +
                ", molding into a perfect cock-sleeve.  At first it's a slow, gradual pump that smears your shaft with booze-flavored spit, but when the first dollop of pre-cum rolls onto the flexible fellatio-tool, the pirate goes into over-drive, pumping with wild abandon.  Her tail whips back and forth, passionately slapping the table, chairs, and dirt in her excitement.\n\n",
            false
        );

        this.outputText(
            "A few demons start to approach, but the lizan crew interposes themselves between their captain and the interlopers, shooing them off before they can start something.  You barely notice, so focused are you on the feel of saliva running down your " +
                this.cockDescript(x) +
                " and the soft, pliant mouth flesh trying to wring the jism from your shaft.   The warmth of orgasm starts to build in your loins, and you begin to pump at the tongue instinctively, hips rising up off the chair in spite of the sharp fingernail's warning.\n\n",
            false
        );

        this.outputText(
            "SMACK!  Roxanne's tail slaps into your " +
                this.buttDescript() +
                ", stinging the exposed " +
                this.player.skinDesc +
                ".  Her eyebrows narrow in irritation while she wraps her arms around your waistline, steadying her off-balance body while she spanks and pumps you in a drunken frenzy.  You hump her face, pressing your " +
                this.player.cockHead(x) +
        ...
        this.outputText(
            "The wiggling, flexible tongue-tip presses down on your urethra, bottling the cum up inside you.  Tiny rivulets of white goo squirt and leak around the pink blockage, rolling over the many rings of tongue while your urethra bloats wide.  The lizan looks up, her dull, glazed eyes locking on to yours as she uncovers your cum-slit, then shivering as a ",
            false
        );
        if (this.player.cumQ() >= 1500)
            this.outputText(
                "huge torrent utterly drenches her face, horns, neck, and tight top",
                false
            );
        else if (this.player.cumQ() >= 500)
            this.outputText("a huge spurt soaks her face and horns", false);
        else this.outputText("big spurt splatters her face", false);
        this.outputText(
            " with cum.  Her soft, oral organ squeezes the spit-slick surface, milking the rest of your cum from your " +
                this.cockDescript(x) +
                " and " +
                this.ballsDescriptLight() +
                ".\n\n",
        ...
        this.outputText(
            "The pirate pulls back, uncoiling her tongue to slurp the heavy load from her face",
            false
        );
        if (this.player.cumQ() >= 1500) this.outputText(" and body", false);
        this.outputText(
            '.  "<i>Jeeze, pent up much?</i>" she laughs, struggling to stand while giggling at her own supposed cleverness.  Happy with how the contest worked out, you slip ' +
                this.sMultiCockDesc() +
                " into your " +
                this.player.armorName +
    ...
    private roxanneCunnilingus(): void {
        ...
        this.outputText(
            "You shimmy out of your " +
                this.player.armorName +
                " and lean back, exposing your " +
                this.vaginaDescript() +
                " to the drunken lizan's maw.  She wobbles back and forth for a moment, clutching at your " +
                this.player.legs() +
                " to steady herself before she leans in, brushing her scaled nose against your vulva.  You shudder from the sudden contact with her scales, but she doesn't rush it, instead huffing and sniffing at the moist entrance.  Her alcohol-lidded eyes gaze up at you, the bleary orbs slightly confused as her jaw slowly opens to release her tongue.\n\n",
            false
        );
        this.outputText(
            "The pink length of Poisontail's tongue oozes out like a sentient creature, waggling slightly as if sniffing the air before it presses on the ",
            false
        );
        if (this.player.wetness() >= 4) this.outputText("juice-dribbling ", false);
        else if (this.player.wetness() >= 2) this.outputText("juicy ", false);
        this.outputText(
            "entrance of your loins.  You swoon, leaning against the chair's back and scooting your crotch forward in a fit of wanton need.  The tip of Roxanne's nose disappears into the moist lips, her slick, oral organ engulfed by your lusty tunnel.  It squirms and wriggles inside you, the thick pink protrusion lashing about, swirling in a circular motion to lap the juice from your walls.  Spit begins to drip down your " +
                this.player.legs() +
                " and you see Roxanne's saliva frothing at the corners of her mouth while she works you over.\n\n",
            false
        );

        this.outputText(
            "Face blushing red, you groan and hump at the lizan, grabbing her horns so that you can smear her nose into your " +
                this.clitDescript() +
                '.  She pulls back, resisting your insistent pulls with inebriated strength, but before you can let go she reverses direction and smashes her forehead into your gut, winding you.  Your fingers release immediately, clutching at your aching middle while the angry lizard snarls, "<i>You\'re getting oral, NOT using me as a dildo!  ...but I am sorry I hit you that hard. I just needed to breathe.  Relax and let me make it up to you...</i>"\n\n',
            false
        );

        this.outputText(
            "The drunken lizan puts her soft, lightly scaled fingers around you to squeeze at your " +
                this.buttDescript() +
                " and leans in to give your " +
                this.clitDescript() +
                " a tender kiss.  Her massive tongue ",
            false
        );
        if (this.player.clitLength < 16) this.outputText("dwarfs", false);
        else this.outputText("envelops", false);
        this.outputText(" the ", false);
        if (this.player.clitLength < 1) this.outputText("little pleasure buzzer", false);
        else if (this.player.clitLength < 3) this.outputText("swollen love-button", false);
        else this.outputText("cock-like lady-part", false);
        this.outputText(
            ", slobbering over it with a lewd tongue-kiss. Her frothy spit completely soaks it ",
            false
        );
        if (this.player.clitLength >= 3)
            this.outputText(
                "before she curls tightly around the female member, enveloping it with flexible, gooey tongue.  You catch your breath just in time to exhale the noisy sounds of your pleasure, and groan out loud.  Roxanne takes the auditory encouragement to heart and begins pumping her tongue while she places her lower lips against your " +
                    this.vaginaDescript() +
                    " and hums.  As if that wasn't enough, she begins twisting the curled tongue up and down your " +
                    this.clitDescript() +
                    " rotating it as she pumps you.",
                false
            );
        else
            this.outputText(
                "before she lets her spit-sloppy tongue push through the saliva-soaked entrance of your mound.  You catch your breath just in time to exhale noisy sounds of pleasure, groaning out loud while you're speared with flexible, gooey tongue. Roxanne takes the auditory encouragement to heart and begins to pump her tongue deep inside you, at least two feet of constantly-thickening appendage coiling over your entrance before sliding inside to kiss your cervix.  As if that wasn't enough, a moment later she starts to hum, nuzzling at your " +
                    this.clitDescript() +
                    " while she tongue-fucks you.",
                false
            );
        this.outputText("\n\n", false);
        ...
        //(ORGASM HERE!)
        this.outputText(
            "Helplessly twitching in your place, you fight with your body's desire to copulate, trying not to impale your quivering snatch on the pirate's nose.  ",
            false
        );
        if (this.player.hasFuckableNipples()) {
            this.outputText(
                "Roxanne pulls her hands off your ass and reaches up, swaying unsteadily until she catches your " +
            ...
            if (this.player.biggestLactation() < 1.5)
                this.outputText("expertly as the one below", false);
            else this.outputText("they begin to squirt milk around her", false);
            this.outputText(".  ", false);
        }
        this.outputText(
            "Unable to dam the pressure up inside you any longer, you cum with brain-breaking, mouth-babbling intensity.  The lizan doesn't relent in the slightest as you begin to spasm",
            false
        );
        if (this.player.wetness() >= 5) this.outputText(" and squirt", false);
        this.outputText(
            " against her.  She tightens her grip and speeds up her tongue's sensual massaging, nearly blacking you out while you writhe in her embrace.  Heat, pure, blissful heat, spreads through you, draining the strength from your uncontrollable twitches and leaving languid warmth in its place.  ",
            false
        );
        if (this.player.hasCock())
            this.outputText(
                this.SMultiCockDesc() +
                    " bounces on her head, between her horns, spilling a trail of sticky seed down her back.  ",
                false
            );
        this.outputText(
        ...
        this.outputText(
            'The cocky, drunken lizan slurs, "<i>Boysh, I\'ma need a while to schleep this one off.  Next time I plug her asssshh!</i>"\n\n',
            false
        );

        this.outputText(
            "You smirk back, slowly putting your clothes back on.  Roxanne can do little to prevent you from noting the massive, unmistakable cock-outline in her pre-cum-soaked pants.  She gives you a smoky glare filled with lust and aggression, but she won't be getting her prize this time!",
            false
        );
        //(-100 lust, -1 int)
        this.player.orgasm();
    ...
    private roxanneRimjob(): void {
        ...
        this.outputText(
            "You shimmy out of your " +
                this.player.armorName +
                " and smirk, turning around to lean onto the table",
            false
        );
        if (this.player.biggestTitSize() >= 2)
            this.outputText(", your breasts cushioning you from the hard wood below", false);
        this.outputText(
            ".  Poisontail eyeballs the ring of your " +
                this.assholeDescript() +
                ", salivating as she grabs your " +
                this.buttDescript() +
                " in her scaled hands.  With anguished slowness, she pulls the cheeks as wide apart as possible.  You hear her gasp in delight a split-second before you do the same.  Her tongue launched from her mouth and found your " +
                this.assholeDescript() +
                " immediately!  Now she's sliding it in circles around the sensitive ring, making the skin of that pucker tighten and wink.\n\n",
            false
        );

        this.outputText(
            "Roxanne groans and gives your " +
                this.buttDescript() +
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.lust < 70) this.outputText("hardens", false);
            else this.outputText("pulses with need", false);
            this.outputText(", a bead of pre-cum already hanging from the tip.  ", false);
        }
        if (this.player.hasVagina())
            this.outputText(
                "Meanwhile, your neglected box is getting wetter and wetter, with no sign of stopping.  The lizan's massive, questing tongue ignores it.  ",
                false
            );
        this.outputText(
            "Completely focused on your anal ring, Roxanne keeps her tongue exactly where it is, working the sparking nerves around your rectum incessantly.\n\n",
            false
        );
        ...
        if (this.player.hasCock()) {
            this.outputText(
                "Surprisingly, one of the pirate's hands comes off your " +
                    this.buttDescript() +
                    " to tug on ",
                false
            );
            if (this.player.totalCocks() > 1) this.outputText("one of ", false);
            this.outputText("your member", false);
            if (this.player.cockTotal() > 1) this.outputText("s", false);
            this.outputText(
                ", milking the shaft like a cow's teat.  Smooth, scaled fingers circle it at the base and slowly slide down, tugging at your skin and squeezing out thick dollops of pre-cum with every pull.\n\n",
                false
            );
        }
        //(Optional pussy milking if no cock)
            ...
            this.outputText(
                "Surprisingly, one of the pirate's hands comes off your " +
                    ...
                    " to play with your " +
                    this.vaginaDescript() +
                    ".  Long, sharp nails play over the sensitive skin of your vulva while the supple, scaled thumb presses between them.  Juicy girl-cum quickly coats her fingers, but it doesn't seem to bother her in the least.\n\n",
                false
            );

        this.outputText(
            "The long, wondrous tongue pushes forward, wriggling inside you.  At first it's just the tip, but the drunken lizard forces inch after inch inside you with constant intensity.  You can feel her spit frothing around your " +
                this.assholeDescript() +
        ...
        this.outputText(
            "Orgasm hits you powerfully, your " +
                this.assholeDescript() +
                " doing its best to choke the massive, pink tongue inside it.  You throw back your head and howl with pleasure, bumping your " +
                this.buttDescript() +
                " into your lizan lover's nose unconsciously.  She gives you a knowing squeeze while her tongue keeps up the attack, forcing waves of unfiltered, raw pleasure into your cerebellum.",
            false
        );
        if (this.player.hasCock()) {
            this.outputText(
                "  You spurt in her hand, letting her squeeze out dollop after dollop of cum.  Somehow you keep your whimpering to a minimum while that long, perfect tongue rubs your prostate and her hand squeezes every last drop into the dirt.",
                false
            );
            if (this.player.cumQ() < 500) {
            } else if (this.player.cumQ() < 1000)
                this.outputText(
                    "  It forms a nicely-sized pool before the ground wicks it up.",
                    false
                );
            else if (this.player.cumQ() < 1500)
                this.outputText("  It forms a large pool before the ground soaks it up.", false);
            else this.outputText("  It forms a massive pool before the ground soaks it up.", false);
        } else if (this.player.hasVagina()) {
            this.outputText("  You quiver and cum on her fingers, ", false);
            if (this.player.wetness() >= 4)
                this.outputText("soaking them with your gushing orgasms ", false);
            else this.outputText("sliming them with copious girl-cum ", false);
            this.outputText(
                "while she teases your " +
                    this.clitDescript() +
                    " with those terribly-slow touches.",
                false
            );
        }
        this.outputText("\n\n", false);
    ...
    private roxanneReamsYouNormal(): void {
        ...
        this.outputText("", true);
        this.outputText(
            "A foot interposes itself between you and the table, and a shove sends you flopping onto the booze-soaked planks face-down, the last few inches of descent slowed by Roxanne's firm hands.  A scaled digit digs under your " +
                this.player.armorName +
                ", pulling and tugging.  As each piece is forcibly removed, you're left more and more naked, totally exposed to the heat of the fire and the smooth scales of the lizan's body.  The room lurches when you to try to move and stop her, and you flop back down, ignoring the drunken spin of your surroundings.  Laughing heartily, the pirate leans over you to pin your hands to the table.  While her position has the intended effect of restraining you, it also gives you the enviable ability to feel Roxanne's iron-hard nipples pressing into your back.\n\n",
            false
        );

        this.outputText(
            "You giggle underneath the lizan, your face mopping up the frothy brew that spilled during the previous bout of binge drinking.  Lapping it up, you forget about your predicament as you adjust to the warm, scaled body overtop you.  Roxanne leaves you to your distractions while she wiggles out of her pants, her tail swaying to counterbalance the now-freed bulk of her member.  The sodden shaft rises to bump your butt, dripping with pre-cum as it wiggles between your cheeks.  It prods your " +
                this.assholeDescript() +
                ", rousing you from your drunken stupor and earning a look back, but the pirate begins to tongue the edge of your ear, making you giggle and relax into sexy, alcohol-lubricated acquiescence.\n\n",
            false
        );
        ...
        this.player.buttChange(
            Math.floor(30 + this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00225] / 4),
            true,
            true,
            false
        );
        ...
        if (this.player.balls > 0)
            this.outputText(
                "against your own, the " +
                    Roxanne.num2Text(this.player.balls + 2) +
            ...
            this.outputText(
                "against your " +
                    this.vaginaDescript() +
                    ", the sweaty orbs growing slick with the moisture of your growing need",
                false
            );
        else
            this.outputText(
                "against your taint, the sweaty skin pressing hard between your bodies",
                false
            );
        this.outputText(".\n\n", false);
        ...
        if (this.player.tailType > TAIL_TYPE_NONE) this.outputText("tail-hole", false);
        else this.outputText("anus", false);
        this.outputText(".  It begins to feel good", false);
        if (this.player.hasCock()) this.outputText(", very good,", false);
        this.outputText(
            " as she bumps and grinds against your deepest places, spurting drops of pent-up need from her swollen shaft.\n\n",
            false
        );

        this.outputText(
            "\"<i>Unf... you're so fucking tight, " +
                this.player.short +
        ...
        this.outputText(
            "You shake your head no, and are rewarded for your disobedience with a violent, butt-jiggling tail-whip.  Gasping from the pain, your " +
                this.assholeDescript() +
                " contracts involuntarily, milking Roxanne's member for a few more drops of pre.  The aggressive lizard really gets into it, her massive, DD-cup tits pinning you to the table while she smacks your cheeks with her flexible lizan tail.   Pounding and slapping you, she abuses you for every dick-milking squeeze you'll give her, ",
            false
        );
        if (this.player.findPerk(PerkLib.Masochist) < 0)
            ...
            this.outputText(
                "until you're moaning with delight from every butt-reddening strike.",
                false
            );
        this.outputText(
        ...
        if (this.player.hasCock()) {
            this.outputText(
                "The constant pressure of her thrusts seems to flow straight to " +
                    this.sMultiCockDesc() +
                    " as if each of Roxanne's prostate-pounding bumps is injecting you with her lust.  ",
                false
            );
            if (this.player.cockTotal() == 1)
                this.outputText(
                    "It bounces against your belly with your heartbeats, loving the forced anal pressure.  ",
                    false
                );
            else
                this.outputText(
                    "They bounce against your belly with your heartbeats, loving the anal pressure.  ",
                    false
                );
            this.outputText(
                "Sticky droplets of pre-cum leak from you, and you can't stifle the pleasured gasps that burst from your maw.",
                false
            );
            if (this.player.hasVagina())
                this.outputText(
                    "  To your delight and shame, your pussy is equally aroused by the action, musky and wet from the pirate's lewd anal battering.",
                    false
                );
            this.outputText("\n\n", false);
        }
        //(JUST CUNTS:
            ...
            this.outputText(
                "The constant pressure of her thrusts seems to flow straight to your " +
                    this.vaginaDescript() +
                    ", inflaming your moistening labia.  You can feel her mass compressing your feminine organs, rubbing your inner walls against each other.  The sublime internal friction releases your natural lubricants, ",
                false
            );
            if (this.player.wetness() < 2) this.outputText("sliming your ready vulva.", false);
            else if (this.player.wetness() <= 3)
                this.outputText("soaking your ready vulva.", false);
            else if (this.player.wetness() <= 4)
                this.outputText("which drip from your ready vulva.", false);
            else this.outputText("which leak in a steady stream from your ready vulva.", false);
            this.outputText("\n\n", false);
        }

        if (this.player.tallness <= 50)
            this.outputText(
                "Roxanne shifts forward, placing her tits around your head, letting the smooth scales of her mammoth breasts envelop you in their soft embrace.",
                false
            );
        else
            this.outputText(
        ...
        this.outputText(
            "  She doubles her pace suddenly, balls slapping loudly into you while she moans and howls lustily.  You feel the telltale bulging of an impending orgasm in your gut, and her balls drag up your " +
                this.player.skinDesc +
                ", preparing to disgorge their steamy cargo.  The lizan grabs your hair and twists her fingers through it while she hilts you, screaming out her pleasure for all to hear.\n\n",
            false
        );

        this.outputText(
            "Your insides froth and churn while they're filled with pent-up lizan cum.  The shemale's balls bounce against you, violently relaxing and contracting in time with the bursts of cream filling your intestines.  Wetness fills you completely, but the spurts go on relentlessly.  Suddenly, small squirts of hot cum escape your tender " +
                this.assholeDescript() +
                ", running down Roxanne's still-pulsing balls.  The action smears the cummy lather everywhere, and while the discomfort of being so completely filled rises, the pleasure grows in equal measure until you're twitching and moaning with whorish delight.\n\n",
            false
        );
        ...
        if (this.player.hasCock()) {
            ...
            if (this.player.cumQ() >= 1500) {
                this.outputText(
                    "A torrential outpouring of spunk pours from " +
                        this.sMultiCockDesc() +
                        ", leaking in a steady, submissive flow to grow a ",
                    false
                );
                if (this.player.cumQ() <= 2500) this.outputText("puddle", false);
                else this.outputText("lake", false);
                this.outputText("below the table.", false);
            } else
                this.outputText(
                    "An outpouring of spunk drools from " +
                        this.sMultiCockDesc() +
                        ", spurting submissively under the table.",
                    false
                );
        }
        if (this.player.biggestLactation() >= 2)
            this.outputText(
                "  Bursts of milk erupt from your pinned " +
                    this.nippleDescript(0) +
        ...
        this.outputText(
            "You wake in the lizan's bed<b> with a nasty hangover</b>, her arm curled around your gurgling belly.  From how sore your rear feels, she kept 'winning' at least two or three more times.  Your head is pounding, your " +
                this.player.legs() +
                " are weak, and you dribble cum with every movement.  It takes some doing to extricate yourself from Roxanne's slumbering form, but you find your equipment and leave, hanging your head in shame under the leering eyes of the caravan-goers.",
            false
        );
    ...
    private roxanneFucksYourAssOHGODITSHUGE(): void {
        ...
        this.outputText("", true);
        this.outputText(
            "Gosh, Roxanne is so strong... she's such a good friend to help you into her wagon, even while she has to drag the weight of her huge prick.  The lizan spins you in her arms and kisses you full on the face, her massive tongue battering through your lips to explore the recesses of your still-slack mouth.  A moment later, your sluggish reflexes catch up to the kiss, and you lick and suck at her tongue, clinging to the ",
            false
        );
        if (this.player.tallness >= 80) this.outputText("small ", false);
        else if (this.player.tallness < 50) this.outputText("large ", false);
        this.outputText(
            "shemale for support.  The room sways under you while you struggle to remain upright, tonguing the sweet lizan 'lady' with as much coordination as you can muster.  She laughs and pushes back onto her bed, giggling when you fall onto the mattress with all the grace of a three-legged dog.\n\n",
            false
        );
        ...
        this.outputText(
            "\"<i>Ohhh, I've waited for this for so long " +
                this.player.short +
                ".  You have no idea of the need... it just builds and builds, getting bigger and bigger until every step is a cacophony of pleasure that never ends.  I'm never sated... never rested... I can't even please myself.  I just have to let it grow... and grow until I can find a drunk " +
                this.player.mf("boy", "slut") +
        ...
        this.outputText(
            "The nude newhalf pounces, her thigh-sized monster-cock gushing pre-cum over your belly and twitching in anticipation of the violation to come.  Her need is so cute... endearing even, but it isn't until your gear is being removed that you remember Roxanne intends to hilt that thing inside you.  Your eyes go wide, your mouth stammering and blubbering about how it will never fit.  She places a scaled finger on your boozy lips and whispers, \"<i>Shhhh, don't struggle.  You knew what you were getting into, " +
                this.player.mf("my dear", "sexy girl") +
                ".  You wouldn't welch out on a wager, would you?  Besides, it's much too late for you to do anything... my nude, drunken cock-holster.</i>\"\n\n",
            false
        );

        this.outputText(
            "Oh gods, Roxanne's right.  She finished getting you naked while she was talking, and you're completely exposed.  Her hands grab your arm and pull, rolling you onto your front and letting your " +
                this.player.legs() +
                " hang off the side of her bed toward the floor.  It's such a silly pose that you nearly forget how perfect a target it makes your " +
                this.buttDescript() +
                "!  The now-confident lizan gives your butt-cheek a slap, giggling when you start in surprise.  ",
            false
        );
        if (this.player.tailType > TAIL_TYPE_NONE) this.outputText("She lifts your tail ", false);
        else this.outputText("She spreads your cheeks ", false);
        this.outputText(
            "to examine your " +
                this.assholeDescript() +
                ', licking the ring before she prods it with a gentle finger-tip.  The excited pirate exclaims, "<i>',
            false
        );
        if (this.player.analCapacity() < 150)
            ...
            this.outputText(
                "Oh, wow!  It's so... stretchy.  Mmmm, I won't even have to use the ointment with you.  You're probably used to this kind of thing, aren't you?",
                false
            );
        this.outputText('</i>"\n\n', false);
        ...
        this.outputText(
            "Roxanne stops and pants lustily, her two-foot prehensile tongue hanging into her cavernous cleavage while she strokes the exposed half of her member.  She traces one of her fingers over the swell of your left cheek, letting her nail leave behind ",
            false
        );
        if (this.player.skinType == SKIN_TYPE_SCALES)
            this.outputText("a roughly-scratched 'X' on your scales", false);
        else this.outputText("an irritated, red 'X' on your skin", false);
        this.outputText(
            ".  You whimper from the pain and the awkward fullness, but she asks, \"<i>Should we get that tattooed on there?  A nice red 'X' to claim Roxanne Poisontail's favorite treasure... wouldn't that be nice?</i>\"  A submissive mewl escapes your lips while you try to focus on her words, but the alcohol and complete body distention keep your frazzled consciousness from digesting anything but more cock.\n\n",
            false
        );
        ...
        this.outputText(".", false);
        this.outputText(
            "  <b>You'll wake and head back to camp with a massive hangover.</b>",
            false
        );
        //(-100 lust, -1 int, hangover effect)
        this.player.orgasm();
    ...
    private applyHangover(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.Hangover) >= 0)
            this.player.changeStatusValue(StatusAffects.Hangover, 1, 8);
        //No hangover yet?  Create and yoink stats
        else {
            this.player.createStatusAffect(StatusAffects.Hangover, 8, 0, 0, 0);
            //Strength minus 5
            this.temp = 5;
            while (this.temp > 0) {
                this.temp--;
    ...
    private bigBootyRoxanneContestLoss(): void {
        ...
        this.clearOutput();
        this.outputText(
            "Gods, your head is swimming!  The room is pitching from side to side, and you " +
                this.player.mf("chuckle", "giggle") +
                " as you idly wonder if this is what it would be like aboard Roxanne's ship.  Still, the well-endowed shemale doesn't seem to mind your tipsy bumbling in the slightest.  She hooks her hands under your [butt] and squeezes the spacious ass-flesh appreciatively, then growls, \"<i>Such a nice, round ass; perfect for stuffing with cock!  You're wasted as a champion.  You'd make a better cabin-" +
                this.player.mf("boy", "girl") +
                ',</i>" into your ear as she drags you towards her wagon.'
        );
        this.outputText(
        ...
        this.outputText(
            '[if (hasVagina = true) "Meanwhile, your [vagina] gets slicker and slicker, your lust permeating the air with potent female musk.  Oh, if only Roxanne would fuck you there too!"]'
        );
        this.outputText("  Roxanne grunts, \"<i>That's a good girl...");
        if (!this.player.hasVagina())
            this.outputText(
                " \"<i>Oh, I know you don't have a pussy, but tonight, you're my big-bootied, cum-dumpster bitch!</i>\""
            );
        else
            this.outputText(
                "\"<i>Oh, you'll make such a great anal cum-dumpster for me.  Your poor pussy will be so cum-starved, but you'll be so stuffed with jizz that you'll look pregnant anyhow!</i>\""
            );
        this.outputText(
        ...
        this.outputText(
            "\n\nThe drunken, scaled dick-girl pulls most of the way out a few seconds later, teasing, \"<i>Feeling empty, dear?  I'll fill you up, my cabin-" +
                this.player.mf("boy", "girl") +
                ',</i>" before plunging back in.  Roxanne\'s hips begin to pump your gaping asshole with practiced efficiency, every stroke smearing her rounded cock-tip [if (hasCock = true) "across your pre-greased prostate.  You cannot help but moan in forced bliss." else "through every sensitive part of your body, hard enough to make you shiver from the onslaught of sensation."] Roxanne cries out ecstatically and shoots large globules of fluid into your rectum.  Muffled, wet squishes and audible liquid churning can be heard from your guts, but you\'re pretty certain it\'s still only pre-cum.'
        );
        this.outputText(
        ...
        this.outputText("\n\n<b>LATER...</b>\n");
        this.outputText(
            "You wake in the lizan's bed, her arm curled around your gurgling belly.  From how sore your rear feels, she probably kept 'winning' at least two or three more times.  Your head is pounding, your " +
                this.player.legs() +
                " are weak, and you dribble cum from your ass with every movement.  It takes some doing to extricate yourself from Roxanne's slumbering form, but you find your equipment and leave, hanging your head in shame under the leering eyes of the caravan-goers."
        );
        //(-100 lust, -1 int, hangover effect)
        this.player.orgasm();
        this.dynStats("int", -1);
