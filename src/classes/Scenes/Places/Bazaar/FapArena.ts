...
export class FapArena extends BazaarAbstractContent {
    ...
    private fapArenaPageII(): void {
        ...
        if (this.player.cor > 66) this.outputText("You eagerly seize the rod on your right side; squeezing it a bit in impatience.  A  little tingle alerts you to your left neighbor grabbing " + this.oMultiCockDesc() + " with an expert hand.  Everyone around you quickly grabs hold of the nearest cock on their right side.  Some of them are trembling because of the induced stress and arousal.\n\n", false);
        else if (this.player.cor > 33) this.outputText("You nervously grab hold of the rod on your right side.  In your stress, you can't help but give it a little squeeze.  You tremble as your left neighbor grabs " + this.oMultiCockDesc() + " with an expert hand.  Most people are as nervous as you, their whole naked body trembling in stress.\n\n", false);
        else {
    ...
    private fapResults(place: number = 3): void {
        ...
        if (place == 3) {
            ...
            //[if player lactates]
            if (this.player.biggestLactation() > 1.5) this.outputText("  Your " + this.allBreastsDescript() + " also release a milky flood of their own, the soft feeling of cream teasing your nipple only prolonging your orgasm.", false);
            this.outputText("\n\n", false);
        ...
        //[else, the player wins]
            ...
            if (this.player.biggestLactation() > 1.5) this.outputText("  Your " + this.allBreastsDescript() + " also release a milky flood of their own, the soft feeling of cream teasing your nipple only prolonging your orgasm.\n\n", false);
        }
        //Post fap
        ...
        //[if first time]
        if (this.flags[kFLAGS.FAP_ARENA_RULES_EXPLAINED] == 1) this.outputText("You stand here, a little lost, wondering what will happen next.", false);
        else this.outputText("You join them, congratulating some on the strength of their stroke, and commenting on the various aspects of the fapping game you've just had.\n\n", false);
        ...
        //[if corr < 50]
        if (this.player.cor < 50) this.outputText("You find yourself yelling with them, astounded by everyone's enthusiasm and eagerness to be fucked in the ass, even after this rough masturbating session.  You wish you weren't so blindly following others, but they are so hypnotizing, their hard glistening cocks pointing at the air as they keep shouting over and over again, \"<i>BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!</i>\"  ", false);
        //[else, corr >50]
        else this.outputText("Your body tenses and " + this.sMultiCockDesc() + " hardens at the perspective of a collective anal orgy.  You yell in lust like a minotaur in rut, \"<i>BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!</i>\" along with the others.  ", false);
        //end of global condition about PC's corr, display the following
        ...
        //[if you won]
        if (place <= 1) this.outputText("Since you're the winner, you walk to the tail of the butt-fuck train, enjoying your prize.  ", false);
        //[if you didn't win, didn't lose]
        else if (place <= 2) this.outputText("You place yourself between two horny bodies.  The lust and confusion have obscured your senses and all you see is a rock-hard dick and a gaping anus, both waiting for you to play with.  ", false);
        //[if you lost]
        else {
        ...
        if (place <= 1) {
            ...
            if ((this.player.cockTotal() > 2) || (!tent && this.player.cockTotal() > 1)) {
                ...
                if (this.player.cockTotal() > 3 || (!tent && this.player.cockTotal() > 2)) this.outputText("their ", false);
        ...
        //[else if you didn't win]
            ...
            //[1/2 chance of this]
            if (FapArena.rand(2) == 0) this.outputText("You eagerly grab the luxurious, gelatinous butt cheeks in front of you.  You notice a pussy underneath that fine ass, freely spilling sexual juices.  If the compelling order weren't resonating deep in your mind, you would easily lose yourself in the herm's glorious depths.  Nevertheless, your " + this.cockDescript(x) + " remembers its job and starts pushing its way between these tender orbs, then into the herm's tight anus.\n\n", false);
            else this.outputText("You eagerly grab the firm, muscular ass cheeks in front of you, probably belonging to some vigorous male.  You grind your " + this.cockDescript(x) + " against his back and it automatically starts spilling pre-cum; as soon as the seminal liquid trickles down his shapely butt, you can feel his body tensing, as if his lust reached a new level.  Nevertheless, your " + this.cockDescript(x) + " remembers its job and starts pushing its way between these gorgeous buttocks, then into the man's tight anus.\n\n", false);
        ...
        //[else, if you lost]
            ...
            if (this.player.lib > 50) this.outputText("  Maybe losing wasn't that bad? You feel like you could lose a few more times...", false);
            this.outputText("\n\n", false);
        }
        ...
        if (place <= 1) {
            ...
            this.flags[kFLAGS.FAP_ARENA_VICTORIES]++;
            this.player.orgasm();
    ...
    private tentacleFapSpecial(place: number): void {
        ...
        if (this.player.cocks[x].cockLength >= 40 && this.player.cocks[x].cockType == CockTypesEnum.TENTACLE) {
            ...
            if (place <= 2) {
                ...
                if (place == 1) this.outputText("  Such raw power, fucking two people at the same time, and one from so far away...  You're basically fucking a wagon of people twice.  The enormity of the act makes you laugh, adding to your pleasure-induced confusion.", false);
                else this.outputText("  Your resistance is quickly fading because of the triple fuck and the mix of feelings combining to provide the richest, dirtiest orgasm; but you feel consoled in knowing the herm girl you're fucking is completely lost.", false);
