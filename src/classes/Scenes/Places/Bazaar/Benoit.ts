    ...
    private talkToBenoit(): void {
        ...
        // Subsequent Talk
            ...
            if (choice == 0) {
                ...
                this.outputText(
                    "You ask " + this.benoitMF("Benoit", "Benoite") + " about the dog."
                );
                this.outputText(
                ...
                this.outputText(
                    "You ask if " + this.benoitMF("he", "she") + " has always been blind."
                );
                this.outputText(
                    '\n\n"<i>I don\'t know,</i>" ' +
                        this.benoitMF("he", "she") +
    ...
    private eggySuggest(): void {
        ...
        if (this.player.isTaur()) {
            ...
            if (this.player.lactationQ() > 100) {
                ...
                else this.outputText("trickle over his fingers");
                this.outputText(
                    '.  "<i>Mammals are so damn weird,</i>" he mutters, making you giggle.'
                );
            }
            this.outputText(
    ...
    public femoitBirths(): void {
        ...
        if (this.flags[kFLAGS.FEMOIT_HELPED_LAY] == 0) {
            ...
            if (this.benoitVeryHeavyPreggers() || this.benoitExtremePreggers())
                this.outputText(
                    "... which is good, because you can tell there're a lot of them coming"
                );
            this.outputText(
