...
export class Benoit extends BazaarAbstractContent {
    ...
    */
    ...
    public benoitIntro(): void {
        ...
        else if (!this.benoitInClutch() && !this.benoitPreggers() && (this.getGame().model.time.days - this.flags[kFLAGS.FEMOIT_NEXTDAY_EVENT] >= 30) && (this.flags[kFLAGS.BENOIT_STATUS] > 0)) {
        ...
        if (this.flags[kFLAGS.BENOIT_SUGGEST_UNLOCKED] > 0 && this.player.hasVagina() && this.flags[kFLAGS.BENOIT_STATUS] == 0) {
            suggest = this.eggySuggest;
            suggestText = "Suggest";
        }
        ...
        if (this.flags[kFLAGS.BENOIT_WOMB_TALK_UNLOCKED] == 1 && this.player.findPerk(PerkLib.BasiliskWomb) < 0 && this.flags[kFLAGS.BENOIT_TESTED_BASILISK_WOMB] == 0 && this.flags[kFLAGS.BENOIT_STATUS] == 0) womb = this.tryToConvertToBassyWomb;
    ...
    private benoitSellTransact(slot: number, sellMod: number): void {
        ...
        else this.outputText("Following a painstaking examination of what you've given him with his hands and nose, Benoit grudgingly accepts it and carefully counts out your reward.");
    ...
    private talkToBenoit(): void {
        ...
        //Subsequent Talk
            ...
            if (choice == 0) {
                ...
                //[(male Benoit only)
                if (this.benoitMF("he", "she") == "he") this.outputText("  There's a hint of longing jealousy in the basilisk's voice and when he lapses into silence you decide not to push the subject.");
            }
    ...
    private suggestSexAfterBasiWombed(later: boolean = true): void {
        ...
        if (!this.player.isTaur()) {
            ...
            if (this.player.hasCock()) this.outputText("  He deliberately rubs himself up and down your body, and the [cock] trapped between your warm bodies quickly hardens against the warm, smooth friction.");
            ...
            //[Herm:
            if (this.player.hasCock()) this.outputText("  He deliberately moves his hand over [oneCock] before trapping it in his warm grasp.   It quickly hardens against his warm, smooth friction.");
