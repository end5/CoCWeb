    ...
    */
    ...
    public circlejerk(): void {
        ...
        this.outputText(
            "There’s no reason to not have some fun with the two of them... plus you don’t think you’d be able resist the allure of joining two of your favourite girls in their bonding.  Stripping off your " +
                ...
                " you step behind the two girls and embrace Urta into a hug, hands wandering her body to loosen the straps of her armor.\n\n"
        );
        this.outputText(
            "Urta seems to jump at your touch.  “<i>" +
                this.player.short +
                "?  What are you doing, you naughty [boy]?</i>”  She giggles.  Kath looks at you and smirks, “<i>Couldn’t resist getting into this, huh, " +
                this.player.short +
                "?  Well, why not?  After all, we’re technically a </i>ménage à trois</i>, aren’t we?</i>”\n\n"
        );
        this.outputText(
        ...
        this.outputText(
            "“<i>Is that a challenge, " +
                this.player.short +
                "?  That you can get vixxy here to cum before she gets me to cum, hmm?</i>” Kath asks, grinning and showing needle-like teeth.  “<i>Well, since you went and got so obligingly naked for us, I’m gonna make this a little more challenging...</i>”  She reaches out, her fingers "
        );
        if (this.player.hasCock())
        ...
        this.outputText(
            "The vixen yelps in shock, trailing off into a throaty moan of pleasure, but shakes her head, eager to win as well.  Her hand promptly starts sliding up and down Katherine’s prick, but her lack of familiarity with the " +
                ...
                " means it’s not as effective as it might have been.  Still, she struggles admirably, fingers flexing and caressing even as her palm glides up and down, stroking and teasing " +
                this.katherine.cockType("the canine-cocked cat", "Kath's shaft and knot") +
                ".\n\n"
        );
        this.outputText(
        ...
        this.outputText(
            "Kath cums first; whether because Urta is that good or because she’s just that inexperienced with being masturbated, you can’t say.  She arches her back and lets out a very feline shriek of ecstasy, her body quaking as her feminine orgasm pours onto the floor under her, wetting her ass with her sexual leavings, while gouts of cum spray from her " +
                this.katherine.cockMultiple("", "twin ") +
                this.katherine.cockType("pointy-tipped", "barbed") +
                " prick" +
        ...
        if (kathCumQ < 500)
            ...
            this.outputText(
                "utterly covers her from head to toe with her massive eruption of spooge"
            );
        this.outputText(
        ...
        this.outputText(
            "They look at each other, look at you, then look at each other again and grin.  “<i>Alright... if you insist...</i>” they say, their tones ringing with blatantly false innocence, before they suddenly get on all fours, slinking towards you.  Uh oh... you barely have time to turn tail and run before you see a pair of blurs, one " +
                this.katherine.catGirl(
                    "of pale flesh and " + this.katherine.hairColor + "hair",
                    "black"
                ) +
                " and the other " +
                this.katherine.catGirl("gray", "of gray fur") +
    ...
    public threeSixtyNine(): void {
        ...
        if (this.katherine.hasCock())
            this.outputText(
                this.katherine.cockMultiple("Katherine’s cock", "the lower of Katherine’s cocks") +
        ...
        this.outputText(
            " like it’s a lollipop.  While Kath is distracted you come from behind and force your shaft between her thighs.  Urta " +
                ...
                " you into Kath’s quim and you feel the cat " +
                this.katherine.catGirl("girl", "morph") +
                " stiffen up.\n\n"
        );
        this.outputText(
        ...
        if (this.katherine.hasCock())
            this.outputText(
                "thrusts forward, nearly driving her knot" +
                    this.katherine.cockMultiple(
                        " past Urta’s lips.  It",
    ...
    public roastYou(): void {
        ...
        if (
            ...
            this.outputText(
                "Urta spies you edging toward the door and decides to demonstrate the voice of authority to both of you.  “<i>Katherine, " +
                    this.player.short +
                    "!  Hold it right there!</i>” she shouts, causing both you and Kath to pause.  Then Urta launches herself your way.  You manage to dodge clear, but Urta slams bodily into the door, blocking it.  She grins like a fox that just woke up inside the henhouse.\n\n"
            );
            this.outputText(
            ...
            if (!this.player.hasVagina()) this.outputText("your ass");
            else
                this.outputText(
        ...
        else if (this.player.balls > 0) this.outputText("massages your nutsack");
        else if (this.player.hasVagina()) this.outputText("runs her finger up and down your slit");
        ...
        if (this.katherine.cockNumber == 1)
            this.outputText(
                "her " +
                    ...
                    " inch " +
                    this.katherine.cockType("doggy dick", "cat cock") +
                    " into your " +
            ...
            this.outputText(
                "her " +
                    this.katherine.cockType() +
                    "  cocks into your body, caring little that your ass wasn’t built to take her twin " +
                    this.katherine.cockLength +
                    " inch shafts"
            );
        this.outputText(
        ...
        this.outputText(
            "Kath pushes a little deeper before pulling you off the floor and onto your hands and knees.  “<i>Don’t be a tease Urta, give " +
        ...
        this.outputText(
            "She moves close enough and gestures toward her glistening horsecock.  “<i>Salted enough for your tastes?</i>” she asks.  By now Kath’s " +
                this.katherine.cockMultiple(
        ...
        this.outputText(
            "“<i>Oh yeah, that’s a good " +
                ...
                " to hear.  The two herms start to work in tandem - Kath pulling out as Urta shoves her cock deeper and then Urta pulling back far enough for you to tongue the tip of her cock while Kath sinks in up to her knot" +
                this.katherine.cockMultiple("", "s") +
                ".\n\n"
        );
        this.outputText(
            "They keep up this pace until you decide to push some of Urta’s buttons.  Reaching up blind your hand finds her balls and you begin to rub her sperm filled sack.  Urta shudders, reverses herself and thrusts forward at the same time as Kath.  All of a sudden you’ve got a foot of horsecock down your throat and Katherine’s " +
                this.katherine.cockType() +
                this.katherine.cockMultiple(" shlong", " meatsticks") +
                " buried knot deep in"
        );
        if (!this.player.hasVagina()) this.outputText(" your ass");
        else if (this.katherine.cockNumber > 1) this.outputText(" both your other holes");
        ...
        if (this.player.hasVagina())
            if (this.player.cuntChange(this.katherine.cockArea(), true)) this.outputText("\n\n");
        if (wasButtStretched) {
        ...
        switch (this.player.gender) {
            case 0: //Genderless
                ...
                this.outputText(
                    "Kath’s " +
                        this.katherine.catGirl("nails", "claws") +
                        " dig into your hips and you feel jet after jet of cum filling your colon.  Combined with the load Urta pumped into your belly it bloats you enough to make you feel green.  Yet at the same time the pulsing cock" +
                        this.katherine.cockMultiple("", "s") +
            ...
            case 2: //Female
                ...
                this.outputText(
                    "Urta’s playful fingers quickly cause you to cum and, as Urta predicted, your orgasm triggers Kath’s.  " +
                        ...
                        this.katherine.cockMultiple(" throbs", " and colon throb") +
                        " painfully in protest but with Kath’s knot" +
                        this.katherine.cockMultiple("", "s") +
                        " mercilessly blocking the exit" +
                        this.katherine.cockMultiple(" it has", "s they have") +
            ...
            default:
                ...
                this.outputText(
                    "Urta’s fingers wrap around your cock.  Ignored until now it jumps at the attention.  “<i>Yes, of course I’ll help you,</i>” says Urta, softly stroking your member.  “<i>You just need a little something - like " +
                        this.player.short +
                        "’s tight little bum squeezing your cock" +
                        this.katherine.cockMultiple("", "s") +
                        " as he cums.</i>”\n\n"
                );
                this.outputText(
                    "Urta’s playful fingers slide up and down your shaft.  You were already on edge and the added pleasure soon causes your " +
                        ...
                        " to tighten, spraying your load across the floor uselessly.  As Urta predicted, your orgasm triggers Kath’s.  With one last mighty heave she buries her prick" +
                        this.katherine.cockMultiple("", "s") +
                        " just a tiny bit deeper.  Then the flood begins.  Already stuffed with Urta’s load your belly expands even further.  Your colon throbs painfully, but with Kath’s knot" +
                        this.katherine.cockMultiple("", "s") +
                        " mercilessly blocking the exit it has no choice but to take every drop."
                );
        }
        this.outputText(
            "\n\nKath collapses on top of you, spent.  Urta twists you around enough to give you and Kath each a kiss.  “<i>Thanks " +
                this.player.short +
                ", that’s exactly what I needed.</i>”\n\n"
        );
        this.outputText(
            "“<i>Me too,</i>” purrs Kath as she snuggles up against your back for a nap.  You stick around long enough for " +
                this.katherine.cockMultiple("Katherine’s knot", "Kath’s knots") +
    ...
    public spitroastKath(): void {
        ...
        if (atBar)
            ...
            this.outputText(
                "Urta grabs Kath from behind, locking her arms so she can’t advance on you."
            );
        this.outputText(
            "  Never one to look a gift horse in the mouth you start to play with Kath’s nipples " +
                this.katherine.clothesChoice(
        ...
        this.outputText(
            ".\n\nSince Kath isn’t going anywhere Urta grabs her " +
                this.katherine.catGirl("smooth", "fuzzy") +
        ...
        else this.outputText("face into your groin. ");
        this.outputText(
    ...
    public pinAndFuck(): void {
        ...
        this.outputText(
            "Once the three of you get inside the room together Urta gets aggressive.  She shoves both you and Kath against the wall and starts trying to pull your clothes off.  As she concentrates on " +
                this.katherine.clothesChoice(
        ...
        if (this.player.isTaur()) this.outputText("rest your belly on top of");
        else this.outputText(this.player.isNaga() ? "quickly coil your tail over" : "kneel atop");
        this.outputText(
            " her prone form.  She growls playfully and squirms, trying to get herself free from your grapple.  You look behind you and see that Kath has been quick to strip off her clothes.  Her throbbing cock" +
                this.katherine.cockMultiple(" stands", "s stand") +
                " proud in the cool air.\n\n"
        );
        this.outputText(
            "You lift Urta’s skirt and tell Kath that her captain needs some help.  She claps her hands together gleefully as you pull aside Urta’s panties.  From beneath you Urta shouts, “<i>No!  It’s my turn.  Present pussy, damn it.</i>”  She shudders as Kath’s cockhead" +
                this.katherine.cockMultiple(
        ...
        this.outputText(
            "Kath gently turns your head and gives you a kiss before sheathing herself inside her captain.  Urta groans as her body is invaded" +
                this.katherine.cockMultiple(
        ...
        this.outputText(
            ".</i>”  Katherine doesn’t take long to give Urta what she wants.  Kath’s knot" +
                this.katherine.cockMultiple(
        ...
        if (this.player.hasCock()) this.outputText("your cock");
        else if (this.player.hasVagina()) this.outputText("your slit");
        else this.outputText("the barren flesh between your legs");
        this.outputText(
    ...
    private pinAndFuckMountUrta(): void {
        ...
        this.outputText(
            "You roll Kath and Urta over so you can get access to Urta’s equine cock.  It’s a little soft but a couple of strokes along its cum slicked length start to change that.  Urta opens her eyes and tries to focus on you but you’re already " +
                ...
                ".  Underneath you both Kath lets out a happy “<i>Oh!</i>”  You’re guessing Urta’s muscles are clamping down on Kath’s cock" +
                this.katherine.cockMultiple("", "s") +
                ".\n\n"
        );
        ...
        if (!this.player.hasVagina()) this.outputText(", filling your colon like a balloon,");
        ...
        else if (this.player.isPregnant()) this.outputText(", spattering against your cervix,");
        else
            this.outputText(
        ...
        this.outputText(
            "\n\nUrta puts one hand on your stretched stomach and places your hand on her own bloated belly.  She just smiles contentedly, her cock buried in your pussy and Katherine’s dick" +
                this.katherine.cockMultiple(
    ...
    private pinAndFuckStuffKath(): void {
        ...
        this.outputText(
            "When Kath flopped on top of Urta her legs spread apart and gave you a great view of " +
                ...
                " things.  Her" +
                this.katherine.cockMultiple("", " lower") +
                " knot, hot and hard, buried in Urta’s pussy" +
                this.katherine.cockMultiple(
        ...
        this.outputText(
            "\n\nUnderneath both of you Urta tries to look over her shoulder to see why Kath’s cock" +
                this.katherine.cockMultiple(" is", "s are") +
        ...
        if (this.player.cumQ() < 500)
            ...
            if (this.katherine.pregSize() > 0)
                this.outputText(
                    "It must be particularly painful since her womb is closed for business."
                );
            else
                this.outputText(
            ...
            this.outputText(
                "  The bulge in Kath’s belly is large enough to lift her off Urta, though not enough to release Katherine’s knot" +
                    this.katherine.cockMultiple("", "s") +
                    ".  Now that Kath is almost sitting upright above Urta she turns and kisses you."
            );
        }
        this.outputText(
            "\n\nAt the bottom of the pile you hear Urta say “<i>Oh - " +
                this.katherine.cockMultiple("its", "they’re") +
                " getting bigger again!</i>”\n\n"
        );
        this.outputText(
            "A quick check with your fingers tells you she’s right, Kath’s knot" +
                this.katherine.cockMultiple(" has", "s have") +
                " returned to full strength, binding the two herms together.\n\n"
        );
        this.outputText(
            "You pull out of Kath and give her a pat on the back.  You tell Urta that there are two ways to shrink " +
                this.katherine.cockMultiple("that knot", "those knots") +
    ...
    private watchMainBody(urtaIsDrunk: boolean): void {
        ...
        this.outputText(
            "The three of you quickly commandeer one of the back rooms.  Urta is " +
                ...
                " so she sits down on a spare chair in the corner and yanks off her clothes.  You kiss Kath and concentrate on getting her naked, giving Urta a show as you " +
                this.katherine.clothesChoice(
                    ...
                    "pull the tube top over her head and then " +
                        this.katherine.clothesLowerChoice(
        ...
        this.outputText(
            "After a short and one sided grappling match Urta has Kath’s arms locked behind her body.  She turns Kath to face you, then pulls the cat " +
                this.katherine.catGirl("girl", "morph") +
                " backwards, downwards and onto her lap.  Urta’s cock now juts out from between Kath’s legs, rubbing against "
        );
        if (this.katherine.hasCock())
            this.outputText(
                "the underside of Kath’s own " +
                    this.katherine.cockMultiple("", "lower ") +
                    "cock.\n\n"
            );
        else this.outputText("Kath's dripping slit.\n\n");
        this.outputText(
            "Kath’s a little surprised, but she recovers quickly and calls out to you, “<i>Please save me " +
        ...
        if (this.katherine.hasCock()) {
            ...
            this.outputText(
                "Urta looks up at you just in time to feel Kath slip her " +
                    this.katherine.cockType() +
                    " shaft" +
                    this.katherine.cockMultiple(" into her pussy", "s into her cunt and rectum") +
                    ".\n\n"
            );
        } else {
            this.outputText(
            ...
            this.outputText(
                " and the tip of your tail does that little wiggle you don’t think anyone notices.  And you rush through all your paperwork once you know I’ll be at the bar because you love staring at my body" +
                    (this.flags[kFLAGS.KATHERINE_URTA_DATE] == Katherine.KDATE_LITTLE
                        ? " and you’re hoping like crazy " +
                          this.player.short +
                          " will be here so we can fuck all through the night"
                        : "")
            );
        this.outputText(
        ...
        if (this.katherine.hasCock()) {
            this.outputText(
                "the chair and pushes hard.  Urta lets out a surprised “<i>Ah!</i>” as Kath’s " +
                    this.katherine.cockMultiple("knot forces its", "twin knots force their") +
                    " way inside.  Then Kath pushes on the chair, yanking " +
                    this.katherine.cockMultiple("it", "them") +
            ...
            this.outputText(
                "Urta's balls and strokes them gently with her sharp " +
                    this.katherine.catGirl("nails", "claws") +
    ...
    public kathLicksOutUrta(): void {
        ...
        this.outputText(
            'Kath snakes back up from under the table, her whole head wet with spunk.  She works quickly to clean herself up using her tongue and some napkins, then looks at Urta.  "<i>Awww, I think I broke her,</i>" she giggles drunkenly.  Say, ' +
                this.katherine.playerText() +
                ", you wanna have some fun while one-shot here recovers?\n\n"
        );
    ...
    public knothole(): void {
        ...
        this.outputText(
            "Urta just sighs and looks up at you with an expression that asks ‘will she ever learn?’  She twists Kath’s arms behind her back, but that doesn’t stop her struggling either.  Then Urta snickers to herself.  She hauls Kath along the floor toward a large knothole.  “<i>Gonna cooperate?</i>” she asks the struggling cat " +
                this.katherine.catGirl("girl", "morph") +
                ".\n\n"
        );
        this.outputText("“<i>No!  Gonna fuck you,</i>” says Kath.\n\n");
        this.outputText(
            "Urta slides her a little further forward, gets one hand free and uses it to angle Katherine’s " +
                this.katherine.cockMultiple("", "lower ") +
                "cock into the hole.  Kath is so surprised at suddenly having an opening around " +
                this.katherine.cockMultiple("her prick", "one of her pricks") +
        ...
        this.outputText(
            "Urta reaches down and rubs " +
                ...
                ".  “<i>I think it’s a bit late to ask me that,</i>” Urta replies.  Kath groans and thumps her fist against the ground.  With the cat " +
                this.katherine.catGirl("girl", "morph") +
        ...
        this.outputText(
            "“<i>Yes.  Yes, please,</i>” begs Kath, spreading her legs wider than anyone but a cat " +
                this.katherine.catGirl("girl", "morph") +
        ...
        if (this.player.isTaur()) this.outputText("stand over");
        ...
        this.outputText(
            "You all lie there in a tangle, spent and happy.  Urta is the first to recover, gently turning Katherine’s head around so she can give her a long kiss.  She smiles at you and says “<i>Thanks again for introducing the two of us " +
                this.player.short +
                ".  Now how about you get back to your camp and I take care of this trapped kitty, hmmm?</i>”\n\n"
        );
        this.outputText(
    ...
    public sandwich(): void {
        ...
        this.outputText(
            "When Urta is mostly naked Kath gets behind her and puts her cock" +
                this.katherine.cockMultiple("", "s") +
                " between Urta’s thighs.  Taken by surprise Urta closes her legs.  Kath grabs Urta’s hips and purrs in her ear as she starts to slide her member" +
                this.katherine.cockMultiple("", "s") +
                " in and out.  You see them start to glisten with Urta’s juices and when Kath next pulls back she winks at you.  Her " +
                this.katherine.cockMultiple(
                    "",
        ...
        this.outputText(
            "You put your hands on Urta’s shoulders, pushing her back towards Katherine.  When Kath sinks her shaft" +
                this.katherine.cockMultiple("", "s") +
                " into Urta you comment that they’re really getting along well.  You’re glad to see there isn’t much friction between them.\n\n"
        );
        this.outputText(
            "“<i>How could there be when she’s cumming buckets?</i>” asks Kath, her cock" +
                this.katherine.cockMultiple("", "s") +
    ...
    private sandwichGetFucked(): void {
        ...
        if (this.player.isTaur()) this.outputText("turn around and flick your tail at her");
        else
            this.outputText(
                this.player.isNaga()
        ...
        this.outputText(
            ".  Urta, already horny thanks to Kath’s ministrations, wastes no time.\n\n"
        );
        this.outputText(
    ...
    private sandwichGetLicked(): void {
        ...
        this.outputText(
            ".  Every time she thrusts her rack jiggles delightfully.  At the same time Urta’s expert tongue is " +
                (this.player.hasCock()
                    ? "sliding around your cockhead"
                    : "busy teasing your folds") +
                ", nudging you towards an orgasm.\n\n"
        );
        this.outputText(
            "With a powerful thrust Kath manages to force her partially inflated knot" +
                this.katherine.cockMultiple("", "s") +
                " inside Urta.  Urta gasps, but more importantly she also loses her grip on your hips.  Kath is so lost in pleasure she doesn’t even notice.  She pulls back and you hear her knot" +
                this.katherine.cockMultiple("", "s") +
                " pop out.  Then she rams " +
                this.katherine.cockMultiple("it", "them") +
        ...
        if (this.player.hasCock()) {
            if (this.player.cumQ() < 500) {
                ...
                this.outputText(
                    "Urta tenses up as you release a fountain of cum into her stomach.\n\n"
                );
                this.outputText(
        ...
        if (this.urta.pregnancy.isPregnant) {
            ...
            this.outputText(
                "The cock Katherine has planted in Urta’s ass " +
                    this.katherine.cockMultiple(
            ...
            this.outputText(
                "Kath collapses as her " +
                    ...
                    " last few squirts into Urta’s ass.  " +
                    this.katherine.cockMultiple(
                        "",
    ...
    private sandwichMaleCentaurLicked(): void {
        ...
        if (this.katherine.cockNumber > 1) this.outputText("ass and pussy");
        ...
        this.outputText(
            "Kath pulls herself free and gives you a wink.  Then she shoves forward, catching Urta by surprise and ramming your cock down Urta’s gullet.  When Urta pulls back Kath grabs her hips and pulls the fox back onto her own cock" +
                this.katherine.cockMultiple("", "s") +
        ...
        this.outputText(
            "Kath really starts to pant and her hips start to jackhammer into Urta.  Looking down you get a front row seat as Kath slams her knot" +
                this.katherine.cockMultiple("", "s") +
                " in and out of Urta’s abused hole" +
                this.katherine.cockMultiple("", "s") +
        ...
        this.outputText(
            "Since Kath and Urta are now solidly joined you take hold of the exhausted cat " +
                this.katherine.catGirl("girl", "morph") +
        ...
        if (this.player.cumQ() < 500)
            ...
            this.outputText(
                "It doesn’t take long before you feel her belly expanding under pressure, making her look three months pregnant, four months, five!  There’s serious backpressure, as the cum in her other hole" +
                    this.katherine.cockMultiple("", "s") +
            ...
            this.outputText(
                "When you release your load your cock expands in girth under the pressure.  You knock the wind out of Urta as you explode inside her throat.  A long stream of cum sprays directly into her stomach" +
                    (this.katherine.cockNumber > 1 || this.urta.pregnancy.isPregnant
                        ...
                        : "") +
                    ".  Urta’s hands and feet scrabble across the floor, trying to find some escape.  Kath’s deposit" +
                    this.katherine.cockMultiple(" has", "s have") +
    ...
    private sandwichCommonEnd(): void {
        ...
        if (this.katherine.ballSize > 0) this.outputText("her recently drained balls");
        else
            this.outputText(
                "the base of her " + this.katherine.cockMultiple("", "lower ") + "cock"
            );
        this.outputText(".\n\n");
        this.outputText(
    ...
    public orgy(): void {
        ...
        this.outputText(
            "Urta is so drunk that she doesn’t care that her prick is standing erect and waving free in the open air.  Kath cares even less about what people think and slowly draws her hand down Urta’s cock, from the tip to the root.  Urta shudders under the attention and quickly undoes " +
                this.katherine.clothesLowerChoice(
                    "Kath’s blouse",
                    "Kath’s blouse",
        ...
        if (this.player.hasCock()) this.outputText("crotch");
        ...
        if (valaHere) {
            ...
            if (this.flags[kFLAGS.KATHERINE_VALA_TIMES_SEX] > 0)
                ...
                this.outputText(
                    "“<i>Hi " +
                        this.player.short +
                        ",</i>” she says cheerfully, “<i>I see you brought a friend.  Did you save her too?</i>”\n\n"
                );
                this.outputText(
        ...
        else this.outputText("Kath" + (valaHere ? ", Urta and Vala all" : " and Urta both"));
                ...
                "... Vala surprising Kath by " +
                    (this.katherine.hasCock()
                        ? "settling on top of her " +
                          this.katherine.cockAdj() +
                          "shaft and then taking it, knot and all, inside her tiny body"
        ...
        if (this.player.hasCock()) this.outputText("deepthroated your cock");
        else this.outputText(this.player.hasVagina() ? "licked you out" : "fisted your ass");
        this.outputText(
            " while she was bent over the table and getting fucked from behind by Urta.\n\n"
        );
        if (valaHere) {
            this.outputText(
            ...
            this.outputText(
                "Kath mumbles, “<i>Worth it,</i>” at the floor, then seems to pass out.\n\n"
            );
        ...
        this.outputText(
            "She tosses a spermy bit of your clothing to you and says, “<i>You should get out of here " +
                this.player.short +
                ".  Don’t you worry, I’ll take care of this.</i>”  Poking Katherine with her foot, she adds, “<i>Besides, Kath needs a bit more education on the subject of Watch paperwork.</i>”\n\n"
        );
        this.outputText(
            "“<i>Aw - not paperwork,</i>” groans Kath as you wave and escape out the door."
        );
        this.player.orgasm();
        this.katherine.orgasm();
        this.katherine.katherineAndUrtaHadSex(true);
    ...
    public doubleStuffKath(): void {
        ...
        this.outputText(
            "Urta " +
                this.katherine.clothesLowerChoice(
                    ...
                    "rubs the " +
                        (this.katherine.hasCock()
                            ? this.katherine.cockAdj() + "bulge in the "
                            : "") +
        ...
        this.outputText(
            "Urta lifts Kath’s leg and presses the flat face of her cock against Kath’s dripping pussy.  Kath distracts her by squeezing Urta’s breasts, then " +
                (this.katherine.hasCock()
                    ? "presses her own cock against"
                    : "slides her finger over") +
                " Urta’s sex.\n\n"
        );
        this.outputText(
        ...
        if (this.katherine.hasCock())
            ...
            this.outputText(
                "You hear an “<i>Oh!</i>” from Urta and she plants her equine shaft as deep as she can inside Kath's pussy.  Kath's eyes glaze over as Urta grunts and holds Kath in place while her seed flows, filling Katherine's belly 'til it takes the shape of a " +
                    this.katherine.catGirl("", "fuzzy ") +
        ...
        this.outputText(
            "Kath regains her strength first and forces herself up onto her elbows.  She smiles at you and simply opens her mouth.  You smile back, " +
                (this.player.hasCock()
                    ? "feed her your cock"
                    : "press your crotch against her face") +
    ...
    public doublePenetrateKath(): void {
        ...
        this.outputText(
            "Urta rips off the last few bits of her own clothing and then starts on Kath’s garments.  She looks over at you and says, “<i>Better hurry up " +
                this.player.short +
                ".  I don’t think you want to get left out of this.</i>”  Just as she says the final word she pulls off the last of Kath’s clothes and cups both Kath’s " +
                this.katherine.breasts.adj() +
        ...
        this.outputText(
            "Katherine’s tongue lolls out of her mouth as her cunt stretches wider.  When Urta starts to pull back Kath looks at you lustily and asks, “<i>What about you, " +
                this.katherine.playerText() +
                "?</i>”\n\n"
        );
        this.outputText(
        ...
        if (this.katherine.hasCock())
            ...
            this.outputText(
                "pussy releasing a flood of girl cum that " +
                    this.katherine.catGirl("wets her skin", "mats her fur") +
        ...
        if (this.katherine.hasCock())
            this.outputText(
                "uselessly humping as her dick" +
                    this.katherine.cockMultiple(" sprays", "s spray") +
        ...
        if (this.player.cumQ() < 500)
            ...
            if (this.player.cor < 25)
                this.outputText(
                    "You hope you aren’t doing any permanent damage with such a big load."
                );
            else if (this.player.cor < 75)
                ...
                this.outputText(
                    "Secretly you try to force even more sperm from your " +
                        ...
                        ".  You want to see just how far you can stretch out your cat " +
                        this.katherine.catGirl("girl", "morph") +
        ...
        this.outputText(
            "\n\nUrta stops moving for a second and takes Katherine’s chin in her hand.  “<i>I see " +
                this.player.short +
                " has already cum.  You like it when [he] cums inside you?</i>”  She puts a hand against Kath’s belly and rubs it.  “<i>You like all that warm spunk inside you?</i>”\n\n"
        );
        this.outputText(
            "Kath nods her head slowly.  It’s almost like she’s under Urta’s spell.\n\n"
        );
        this.outputText(
        ...
        if (this.flags[kFLAGS.KATHERINE_URTA_AFFECTION] == 1) {
            ...
            this.outputText(
                "“<i>Mmmm yes.  I’m always ready to cum inside a hot kitty like you,</i>” says Urta.  “<i>You know " +
                    this.player.short +
                    ", you don’t <b>have</b> to get us wasted.  Kath and I are always willing to fuck.</i>”\n\n"
            );
            this.outputText(
    ...
    public doubleStuffVala(): void {
        ...
        this.outputText(
            "You pull apart Vala’s folds, giving her pleasure and Kath a good look.  With your other hand you stroke Kath’s " +
                this.katherine.cockType() +
                " cock" +
                this.katherine.cockMultiple("", "s") +
                " and feel Vala wiggle her hips, trying to impale herself.  It’s what you want so you grip Kath’s cock" +
                this.katherine.cockMultiple(
                    " tightly and guide it",
                    "s tightly, forcing the tips together, and guide them"
                ) +
                " into Vala’s passage.  Both girls moan as the head" +
                this.katherine.cockMultiple(" sinks", "s sink") +
                " in.  Then you put your hands on Vala’s ass and push her forward.  You know from experience how elastic she can be and sure enough " +
                this.katherine.cockMultiple(
        ...
        this.outputText(
            "  It feels wonderful, especially since you can feel " +
                this.katherine.cockMultiple("Kath’s shaft", "both of Kath’s shafts") +
        ...
        this.outputText(
            "You grab Vala’s slender hips and yank her down onto your cock" +
                (this.player.cocks.length > 1 ? "s" : "") +
                ".  Kath’s hands slap down on top of yours and she does exactly the same thing.  Inside you feel Kath’s knot" +
                this.katherine.cockMultiple("", "s") +
        ...
        if (this.player.cumQ() < 1500) {
            this.outputText(
                "Your " +
                    ...
                    " to work much harder than usual to force your cum past Katherine’s engorged knot" +
                    this.katherine.cockMultiple("", "s") +
            ...
            this.outputText(
                "Despite Katherine’s engorged knot" +
                    this.katherine.cockMultiple("", "s") +
                    " your " +
                    (this.player.balls > 0 ? "balls are" : "prostate is") +
    ...
    public eatOutVala(): void {
        ...
        this.outputText(
            "You pull Vala into your arms and then walk her backwards, toward Kath.  Vala doesn’t notice what you’re doing and Kath backs up into a wall.  You keep moving and press Vala against Kath.  Neither of them have anywhere to go and you feel the tip" +
                this.katherine.cockMultiple(" of Kath’s cock", "s of Kath’s cocks") +
                " poking out from between Vala’s legs.\n\n"
        );
        this.outputText(
            "Perfect!  You give each of them a kiss and then grab Vala’s ass with both hands, lifting her off the ground and spreading her cheeks as far apart as you can manage.  You tell Kath to line her " +
                this.katherine.cockMultiple("", "twin ") +
                this.katherine.cockType() +
                " member" +
                this.katherine.cockMultiple("", "s") +
                " up with Vala’s ass but it’s Vala who reacts first.  With the speed and agility you’d expect from a faerie she takes Kath’s cock" +
                this.katherine.cockMultiple(
        ...
        this.outputText(
            "You lower her and Vala sighs as Kath’s rod" +
                this.katherine.cockMultiple(" rams", "s ram") +
        ...
        this.outputText(
            "They reach the table and you push them forward.  If you didn’t know how tough Vala is you’d worry that Kath was going to crush her.  Instead you hear moans from beneath the cat " +
                this.katherine.catGirl("girl", "morph") +
        ...
        this.outputText(
            "As you run your tongue across her clit you feel a surge of heat in the knot" +
                this.katherine.cockMultiple("", "s") +
    ...
    public fistKathAndVala(): void {
        ...
        this.outputText(
            "“<i>" +
                this.player.short +
                "?</i>” Vala asks, “<i>aren't you going to... to... oh!</i>”  You never learn what she was trying to say.  Your talented fingers keep her busy until Kath decides she's tired of waiting.  She grabs Vala's head and pulls her in for another kiss.\n\n"
        );
        this.outputText(
        ...
        if (this.katherine.hasCock())
            this.outputText(
                "  Kath's cock" +
                    this.katherine.cockMultiple("", "s") +
                    ", which you've ignored this whole time, " +
                    this.katherine.cockMultiple(
    ...
    private valaCommonPostSex(theyWereFucking: boolean): void {
        ...
        if (this.flags[kFLAGS.KATHERINE_VALA_TIMES_SEX] == 0) {
            ...
            if (theyWereFucking) {
                ...
                this.outputText(
                    "Kath looks totally embarrassed until Vala reaches down and rubs the base of Kath's knot" +
                        this.katherine.cockMultiple("", "s") +
                        ".  "
                );
            }
        ...
        this.outputText(
            "\n\nKath sighs and rubs Vala’s " +
                ...
                ".  She’s so relaxed that she looks half-asleep.  “<i>Mmmm - " +
                this.katherine.playerText() +
                (theyWereFucking
