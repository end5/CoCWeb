...
export class Jasun extends TelAdreAbstractContent {
    ...
    public changingRoom(): void {
        ...
        if (this.flags[kFLAGS.LIFETIME_GYM_MEMBER] == 0) {
            this.outx("You toss ten gems to centaur and head towards the back.\n\n", false);
            this.player.gems -= 10;
    ...
    private meetJasun(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00179] == 0) {
            ...
            if (this.silly()) this.outx("six");
            else this.outx("three");
            this.outx(
            ...
            this.outx(
                "Before long, you blink a couple of times and break through your prior distraction.  You can see in the mirror before the man that he has been watching your revelry of his form.  A grin plays across the man's features and within it you find several rows of razor-sharp teeth, forcing you to gulp instinctively as you think of what sort of damage those could do to your tender flesh.  ",
                false
            );
            ...
            if (this.player.gender <= 1) {
                ...
                this.outx(
                    "You doubt he'd have the nerve to murder someone here, but you feel like you've wasted your time.",
                    false
                );
            ...
            // IF FEMALE
                ...
                if (this.player.tone < 75) {
                    ...
                    this.outx("You book it out of there.  What a waste.");
                    this.doNext(this.camp.returnToCampUseOneHour);
                    return;
                }
        ...
        // Met Jasun but not boned!
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00181] == 0) {
                this.outx(
                    "While you look around the changing room, one of the gym's other patron asks you if you're looking for Jasun.  Seeing your confusion, they describe the hunky shark guy you met before.  You nod and smile, happy to have learned his name.\n\n",
                    false
                );
            ...
            if (this.player.gender <= 1) {
                ...
                this.outx(
                    '"<i>Eyes to yourself, boy. Try to play any games and I\'ll tear you apart limb from limb. Now get out of here before I do it anyway.</i>" The shark-morph snarls threateningly before turning to walk away.\n\n',
                    false
                );
                this.outx(
                    "You doubt he'd have the nerve to murder someone here, but you feel like you've wasted your time.",
            ...
            if (this.player.tone < 75 || this.player.armorName != "slutty swimwear") {
                ...
                else this.outx("a little more compatible with me");
                this.outx(
            ...
            this.outx(
                'Jasun comes out of his stall and smiles when he sees you, already beginning to strain against the skimpy fabric of his bottom.  He asks, "<i>Would you like to come swimming with me?</i>" though his tone indicates that swimming may involve more than a few laps.',
                false
            );
        ...
        // Repeat
            ...
            if (this.player.gender <= 1) {
                ...
                this.outx(
                    "You doubt he'd have the nerve to murder someone here, but it's clear that so long as you lack a vagina Jasun will have no interest in you.  What a waste.",
                    false
                );
                this.doNext(this.camp.returnToCampUseOneHour);
                return;
    ...
    private meetJasun2(): void {
        ...
        this.spriteSelect(33);
        this.outx(
            "You and he walk together for what can't be a very long time. He winds around the back side of the gym, avoiding the weightlifting room and going past the track altogether. You didn't even know that there were areas of the gym beyond what you had previously seen. He easily pushes aside a very thick door with one arm ",
            false
        );
