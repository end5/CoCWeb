...
export class SexMachine extends TelAdreAbstractContent {
    public exploreShowers(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00182] <= 1) {
            this.outx(
                "Having worked your body to a pleasant soreness as well as coating your " +
                    this.player.skinDesc +
                    " in a thin sheen of sweat and pheromones, you decide to hit up the showers to wash off and relax in the hot water.  ",
                false
            );
            this.outx(
            ...
            this.outx("Do you use it or not?");
    ...
    private leaveShowers(): void {
        this.outx("", true);
        this.outx(
            "You shake your head.  You've had enough of a workout for the day, and you remember you're in a land where curiosity almost certainly kills (well, more thoroughly rapes) the cat.  You leave the room and continue to search for the showers, eventually finding them and heading back to camp.",
            false
        );
    ...
    private useTheSexMachine(): void {
        ...
        if (this.player.gender == 1) {
            if (this.flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_MALE] == 0) {
                ...
                this.outx(
                    "It takes little time for " +
                        this.sMultiCockDesc() +
                        " to grow hard, your lust betraying you as another phallic shaped metallic length is presented in front of your face. A small shock is delivered to your " +
                        this.assholeDescript() +
                        ", causing you to gasp, and allowing the phallic length to slip deep into your mouth, giving you little choice but to suck on the device. The tube-like length on your " +
                        this.cockDescript(0) +
                ...
                this.outx(
                    "Shaking your head as the machine forcibly pleasures you, you quickly realize that with each drop of cum your cock has drained from it, the phallus against your anus gets a little more moist. It's using your own pre-cum to lube your asshole!\n\n",
                    false
                );

                this.outx(
                    "It doesn't take long for the phallus to slip past your anal ring, filling your anus with firm strokes while you let out muffled moans.",
                    false
                );
                ...
                this.outx(
                    "You are surprised when the machine doesn't pump your own seed into your mouth and anus, instead slowly letting you back down. A platform lifts up in front of the machine, with a small metallic mini-keg. Once you're released and the keg is presented, the machine \"dings\", as if it had finished, leaving you exhausted and utterly violated.\n\n",
                    false
                );

                this.outx(
                    "Within moments, the goblin comes out of the back room - the small redheaded woman looks surprised to see you. Covered head to toe in thick grease and dirty clothes, she fits every last stereotype of an engineer.\n\n",
                    false
                );

                this.outx(
                    '"<i>What are you doing to my baby?!</i>" she cries out, until she notices the keg sitting in front of her.  "<i>Wait, it works? It works!</i>" she cheers with glee, quickly rushing over and snatching up the keg of your seed. Within moments she\'s gone back through her locked door, leaving you alone with the machine, whose screen goes blank after noting that it had "saved your measurements". Probably to rape you more efficiently next time...\n\n',
                    false
                );
            }
            // [Male repeat scene]
                ...
                this.outx(
                    "Walking down the back halls of the gym, it doesn't take you long to find the back room with the odd machine once more, looking much as it did prior. The room is silent and empty, the machine sitting with its screen turned off until once again, you sit on the padded bench, and the screen flickers to life. It displays your measurements as if it can somehow tell who you are, and asks you in a very polite manner to place your limbs into the safety straps.\n\n",
                    false
                );

                this.outx(
                    "You eagerly place your legs into the straps, and buckle your waist down. Placing your arms into the cuffs, the machine whirs to life, revealing its newest additions. It seems there's been improvements since your last visit! The machine raises a onahole to your slowly stiffening " +
                        this.cockDescript(0) +
                        ", already removing your shorts as it works your arms and legs to a tiring stiffness. The false vaginal opening seems to glisten in the light with some form of self lubrication, and you feel a familiar pressure against your " +
                        this.assholeDescript() +
                        ". A second phallus lowers to your lips, and once more you're shocked and gagged with the dildos, the onahole quickly going to work on your stiff cock.\n\n",
                    false
                );

                this.outx(
                    "Within moments you're rock hard, being roughly fucked by the wet sex toy. You can feel the machine rippling the length of the slick tunnel, massaging your " +
                        this.cockDescript(0) +
                        " and focusing on your sensitive " +
                        this.player.cockHead() +
                        ", causing every nerve ending to light up in pleasure.  As you slowly leak pre-cum, the phallus is slipped once more into your anus, almost instantly pressing against your prostate to stroke and milk it as if it were a prehensile finger, not a metal toy in your ass.",
                    false
                );
                this.player.buttChange(30, true, true, false);
                this.outx("\n\n", false);
        ...
        // [If you decide to mess with the machine, female:]
            ...
            if (this.flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_FEMALE] == 0) {
                this.outx(
                    "You gently sit on the padded bench, curious as to what this machine might actually accomplish, noting the various odds and ends that seem more devious in nature than exercise inclined. The screen before you quickly flickers to life, welcoming you and asking you to kindly place your " +
                        this.player.feet() +
                        " in the appropriate safety straps and place your arms in the secure cuffs. You wonder briefly if this is a good idea, but work your way into the tight fitting straps anyways.\n\n",
                    false
                );

                this.outx(
                    'Within moments, the machine lifts you up, pulling your arms out and apart, away from your sore aching body.  After such a workout you can do little to fight the strong pull of the mechanical assailant. It whirs to life, stating that it is beginning "Phase 1: Preconditioning".\n\n',
                    false
                );

                this.outx(
                    "You feel the machine begin to tug at your clothes with various mechanical clamps.  It pulls your clothing free in moments, revealing your " +
                ...
                this.outx(
                    "Continuing its molestations, the machine attaches a small sucker hose to your " +
                        this.clitDescript() +
                        ", quickly suctioning it erect.  The device follows suit with your " +
            ...
            // [Female repeat scene]
                ...
                this.outx(
                    "As you sit on the bench, the screen once more flares to life, quickly scrolling various body information about you past, not limited to vaginal depth, optimal ovulation periods, bust size... attempting to read it all is dizzying! You rub your forehead, sighing softly as you buckle yourself in.  Then you slip your arms and legs into the restraints of the machine, and once again it lifts you up in the air and strips your " +
                ...
                this.outx(
                    "The cool air makes your nipples stand out, and you notice a pleasant surprise: the cocks slipping between your ass-cheeks and thighs are made of a soft, but firm, latex.  They warm as they leak cum on your " +
                        this.assholeDescript() +
                        " and labia. You blush, willingly opening your mouth for the cock in front of you.  Sucking it in to taste the heady seed, you close your eyes, enjoying the ride as your labia softly part, wet and ready for the intruding member.\n\n",
                    false
                );

                this.outx(
                    "You moan lustfully as the members slip into your " +
                        this.vaginaDescript() +
                        " and " +
                        this.assholeDescript() +
                        ", filling you deeply.",
                ...
                this.player.cuntChange(30, true, true, false);
                this.player.buttChange(30, true, true, false);
                this.outx("  They begin to stroke slowly");
                if (this.player.biggestTitSize() >= 2)
                    this.outx(
        ...
        // [Sexless]
            ...
            if (this.flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_EUNUCH] == 0) {
                this.outx(
                    "You sit down on the padded bench and look around at the odd weight-lifting machine nearby. Various parts look less than pleasant, and less than exercise orientated on further inspection.  It makes you question the uses of this machine. The screen before you flashes to life, politely asking you to place your arms and legs in the cuffs and buckle yourself in.\n\n",
                    false
                );

                this.outx(
                    "You raise an eyebrow, wondering what you're getting yourself into as you buckle yourself to the machine, hoping this isn't a mistake. It doesn't take long for you to realize it is. The machine lifts you up, stripping your " +
                        this.player.armorName +
                        ' off of you and spreading your arms and legs. First, a round device that appears to be made to hold a penis slips up, rubbing against your flat pelvis. It tries for a few moments, lifting up two other smaller devices made for smaller dicks before it gives up, the screen reading "error". Shortly afterward, a cock-like metallic device is lifted up to your groin, rubbing around as it leaks lubrication, searching for an entrance until once again the screen reads "error".\n\n',
                    false
                );

                this.outx(
                    "It whirs for a moment, confused. It seems to ponder matters for a second before simply lifting you up into a sitting position. It doesn't take but a moment for you to feel a firm steel tip press against your anus, the machine bouncing you slowly in your restraints on the mechanical cock, each bounce smearing more and more cum on your " +
                        this.assholeDescript() +
                        ", lubing you up for your eventual penetration.\n\n",
                    false
                );

                this.outx(
                    "You gasp with each bounce, your ass finally lubed enough that each gentle jostle forces you to sink another half-inch down on the thick phallic member. With a groan you finally bottom out, your anus stretched around the thick member.  ",
                    false
                );
                this.player.buttChange(30, true, false, true);
                this.outx(
                    "The machine forces you forwards, onto your hands and knees, the thick cock beginning to slip in and out of your ass, pounding away with fervor to the sound of your exhausted moans. Each thrust seems to get closer and closer to a pleasurable spot, as if homing in on it slowly.\n\n",
                    false
                );

                this.outx(
                    "It doesn't take long for every thrust of the thick metal cock to ram that pleasant spot, pushing you closer and closer to your climax. You close your eyes as they roll back in your head, moaning loudly as you orgasm, the cock erupting inside of you, filling your rectum with thick spurts of cum.\n\n",
                    false
                );

                this.outx(
                    "Slowly, the machine pulls out of your asshole, releasing the straps and leaving you unceremoniously on the padded bench, facedown with your gaped anus hanging the air, leaking cum.\n\n",
                    false
                );

                this.outx(
                    "After you collect yourself and your gear, you quietly slip out of the room, the machine quiet and inactive now. However, you can't help but feel like you were being watched...",
                    false
                );
            }
            // [Sexless Repeat]
                ...
                this.outx(
                    "You casually strip yourself naked, saving the machine the effort, and sit on the padded bench. It whirrs to life, blinking a few statistics on the screen, including what seems to be measurements of your rectum and anus. Why would it need those?\n\n",
                    false
                );

                this.outx(
                    "You shrug it off, slipping, as directed, into the various straps and buckles to secure yourself to the machine, and once more it lifts you into the air. You feel a firm pressure against your " +
                        this.assholeDescript() +
                        " once again, teasing you with a surprise: you feel a flexible latex head probing your asscheeks, leaking cum all over them!\n\n",
                    false
                );

                this.outx(
                    "You turn your head, look back, and gasp. You expected to see a latex cock molesting your backdoor, but instead see a latex tentacle brushing cum against your anus. What is this machine planning to do?!\n\n",
                    false
                );
                ...
                this.outx(
                    "It doesn't take long for your " +
                        this.assholeDescript() +
                        " to be slathered in cum, the machine pressing on your muscular ring with the tip of its tentacle cock, starting to fill your ass with its prehensile member. Inch after inch slips inside of you, each humming ring of the cock stroking your anus as it fills your ass, vibrating deep inside of you.",
                    false
                );
                this.player.buttChange(30, true, false, true);
                this.outx(
                    "  You moan, closing your eyes and enjoying the pleasure, only to have a second tentacled cock thrust into your mouth, and down your throat. It doesn't take long for them both to begin thrusting, vibrating in both your holes.\n\n",
                    false
                );
                ...
                this.outx(
                    "About ten minutes pass until you stand up, limping weakly out of the room.",
                    false
                );
            }
        ...
        // [Hermaphrodite]
            ...
            if (this.flags[kFLAGS.TIMES_USED_SEX_MACHINE_AS_HERM] == 0) {
                ...
                if (this.player.cockTotal() > 1) this.outx("primary cock");
                ...
                this.outx(
                    " is gently stroked by the sheathe-like device now slipping over it. It rubs the flaccid member gently, stroking it up and down as it begins to swell with blood, growing harder by the second. You shudder with pleasure, wondering what could come next, only to be forced to gasp by a firm press on your " +
                        this.assholeDescript() +
                        ". A metallic cock presses hard against your muscular ring, taking the opportunity given by your gasp of surprise to force another cock into your mouth.\n\n",
                    false
                );

                this.outx(
                    "It's almost impossible to stay focused on any one stimulation at once, your mind flowing effortlessly between your asshole as the cock lubes it up, your cock as it's milked slowly, your throat as it's slowly fucked by another cock, and your pussy as it grows wet, slowly allowing inch after inch of the invading phallus to penetrate your walls and stretch you wide open.",
                    false
                );
                this.player.cuntChange(30, true, true, false);
                this.player.buttChange(30, true, true, false);
                this.outx(
                    "  You moan lustfully, your girly juices beginning to flow down your thighs as the cock begins to thrust deep inside of you.  The metallic sleeve on your member thrusts down around you, even as the machine penetrates your " +
                        this.vaginaDescript() +
                        ". It's almost as if you were fucking your own cunt!\n\n",
                    false
                );

                this.outx(
                    "You moan around the cock in your mouth, tasting the heady and thick cum it gives you, letting it trickle down the back of your throat slowly as it bucks in your mouth, leaving you helpless to call for help as every part of you is fucked.",
                    false
                );
                if (this.player.biggestTitSize() >= 2)
                    this.outx(
                        "  Well, not every part of you, but that is rapidly fixed as a final cock rubs against your " +
                            this.chestDesc() +
                            ", starting to stimulate your chest as well.",
                        false
                    );
                this.outx("\n\n", false);
                ...
                if (this.player.biggestTitSize() >= 2)
                    this.outx(
                        "  The cock on your chest pumps cum onto your " +
                            this.chestDesc() +
                            ", as y",
                        false
                    );
            ...
            // [Hermaphrodite repeat scene]
                ...
                this.outx(
                    "You pant as you are let down, the straps loosening. Once more toweling yourself off, more from cum than sweat this time, you walk out of the room, heading to the showers.",
                    false
                );
            }
        ...
        if (this.player.hasVagina()) {
            ...
            switch (this.temp) {
                ...
                default:
                    this.player.knockUp(
                        PregnancyStore.PREGNANCY_CENTAUR,
