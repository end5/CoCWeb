...
export class Niamh extends TelAdreAbstractContent implements TimeAwareInterface {
    ...
    public telAdreNiamh(): void {
        if (this.flags[kFLAGS.MET_NIAMH] == 0) {
            ...
            if (this.model.time.hours <= 8)
                ...
                this.outputText(
                    "moderately manageable G-cups, trembling with every breath she takes"
                );
            this.outputText(
    ...
    public niamhPostTelAdreMoveOut(): void {
        ...
        if (this.flags[kFLAGS.NIAMH_STATUS] == 1) this.outputText("demonic-looking");
        else this.outputText("hourglass-shaped");
        ...
        else this.outputText("\"<i>W'heeeey, honey!  I never thought I'd see yaaaagain!</i>\"");
        this.outputText(
        ...
        if (this.flags[kFLAGS.NIAMH_STATUS] == 1) this.outputText("dark");
        else this.outputText("light");
    ...
    private barBeerOrgyTits(): void {
        ...
        if (
            ...
            this.outputText(
                "  You are essentially a pile of " + this.boozeBoobsType() + " filled tits."
            );
