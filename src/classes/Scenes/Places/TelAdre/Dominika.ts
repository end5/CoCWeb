...
export class Dominika extends TelAdreAbstractContent {
    ...
    private timesFellatrixSucked(): number {
        return (
            ...
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00152] +
    ...
    public fellatrixBarApproach(): void {
        ...
        this.outx("", true);
        this.outx(this.images.showImage("dominika-first-meeting-at-bar"));
        ...
        if (
            ...
            this.flags[kFLAGS.DOMINIKAS_SWORD_GIVEN] == 0
        ) {
        ...
        this.outx("ERROR, ERROR, ALERT THE FENFEN!", true);
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    // [\"<i>No thanks</i>\"]
    private turnDownDominikasKnowledge(): void {
        ...
        this.outx("", true);
        this.outx(
            '"<i>Fair enough,</i>" Dominika nods. "<i>Let me know if you change your mind.</i>" The two of you make small talk for a while longer, before you decide to get back to work and excuse yourself.\n\n',
            false
        );
        this.cheatTime(1);
        this.doNext(this.telAdre.barTelAdre);
    ...
    private acceptDominikasKnowledge(): void {
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00155] == 0) {
            ...
            this.outx(
                '"<i>Now then,</i>" she says. Her hands glow with a brief sense of power, and many of the tattoos shine with equal illumination. She gestures with her hand and the lamps all acquire an unearthly light, as green glowing circles appear interlinked on the floor. "<i>How much do you know about magic?</i>"\n\n',
                false
            );
            ...
            if (this.player.spellCount() == 6) {
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00154] == 0) {
                    ...
                    this.outx(
                        'You blink, then casually mention that you actually know quite a bit about magic. Dominika listens to you explain your skill in white and black magic, then coughs awkwardly and glances to the side. "<i>O-oh,</i>" she says, "<i>Well. Uhm. I guess we can talk about magical theory, maybe?</i>"\n\n',
                        false
                    );
                } else
                    this.outx(
            ...
            // [If player knows no spells]
                ...
                this.outx(
                    '"<i>So sorry, again,</i>" she says, those black lips curving into a big smile. "<i>I guess I\'ll take that to mean \'not much\', so, here. Let me show you some things.</i>"\n\n',
                    false
                );
    ...
    private fellatrixSexWarmup(): void {
        ...
        this.outx("She walks towards you, resting her hands on your collarbone.  ");
        // (If breasts)
        ...
        if (this.fellatrixSucked()) this.outx(" again");
        this.outx('?</i>"\n\n', false);
    ...
    private declineFellatrixOral(): void {
        ...
        if (!this.fellatrixSucked()) {
            ...
            this.outx(
                'She pauses. "<i>Or cunnilingus, I mean, I haven\'t looked between your legs yet. You know what this place is like.</i>"\n\nYou suppose it might not hurt.  Do you want to receive some oral?',
                false
            );
    ...
    private declineFellatrixOralHARDCORE(): void {
        ...
        this.outx("", true);
        this.outx(
            '"<i>Really?</i>" she asks again. "<i>But, I mean... fucking look at these!</i>" She purses her dark lips, running her tongue over them to emphasize how they glisten in the light. "<i>Don\'t tell me you don\'t think these would feel fucking rad on you.</i>"\n\nIt\'s VERY tempting.  Maybe one little round of fellatio?',
            false
        );
    ...
    private declineFellatrixOralSUPERHARDCORE(): void {
        ...
        this.outx("", true);
        this.outx(
            'Dominika stares at you incredulously, then turns away. "<i>Fine. Just go then. You know where the door is.</i>" She walks away into another room, closing the door behind her.\n\n',
            false
        );

        this.outx("You let yourself out.");
    ...
    private acceptFellatrixOral(): void {
        this.spriteSelect(58);
        this.outx("", true);
        this.outx(this.images.showImage("dominika-oral-sex"));
        ...
        if (this.player.hasVagina() && (this.player.gender == 2 || Dominika.rand(2) == 0)) {
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00153] == 0) {
                ...
                this.outx(
                    "Her lower lip brushes against your " +
                        this.clitDescript() +
                        ", and another groan leaves your throat. You hadn't expected a touch there so soon, but it sends pleasure all through your body and your breath immediately starts to come quicker. That lip slips down as she opens her mouth, and her topmost pillow remains pressed to your " +
                        this.clitDescript() +
                        ", continuing to offer more stimulation. She grinds her plump puckers slowly along the outer folds of your " +
            ...
            // Repeat
                ...
                this.outx(
                    "Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to descend upon your " +
                        this.vaginaDescript(0) +
                        ". She lays you on the bed again, removing the bottom of your " +
                        this.player.armorName +
                        " and laying beneath you. Gliding her hands over your thighs she aggressively begins lapping at your " +
                        this.vaginaDescript(0) +
                        ' with her tongue, coating it in spit. "<i>Mmm, I hope you squirt a river,</i>" she purrs, giving your ' +
                        this.clitDescript() +
                        " a kiss as intimate as a lover's. The way her lips move is intoxicating, sliding their slippery glossy surface over every inch of your " +
                        this.vaginaDescript(0) +
                ...
                this.outx(
                    "Her tongue aggressively shoves itself into you once more, slapping against the walls of your " +
                        this.vaginaDescript(0) +
                        " as though trying to break them down. You can practically feel your juices splattering across your cunt and then slurped up by her in the frenzy she approaches you with. Your world becomes consumed by raw sensation as effortlessly as your own " +
                        this.vaginaDescript(0) +
                ...
                this.outx(
                    "You don't speak, cannot speak as she sucks and gulps at your flesh. You can only offer up strangled gasps and shuddered squeals to her actions, prostrated like a servant before her, gripping the covers and mattress beneath you. Your " +
                        this.vaginaDescript(0) +
                        " is hers, to impose whatever demands she wishes, and the insatiable suckling upon you makes her demands clear. Her tongue twists about in you and against you, mocking your fingers with how much better it seems to know your pleasure.\n\n",
                    false
                );
                this.outx(
                    "You cannot resist for long after she takes over your spot once again, grinding against it and forcing you to arc your back. Pleasure surrounds you as effortlessly as her lips surround your " +
                        this.clitDescript() +
                        ", and you find yourself cumming hard against her. She drinks everything you give her, sucking on your " +
                        this.vaginaDescript(0) +
            ...
            if (this.flags[kFLAGS.DOMINIKA_TIMES_MULTICOCK_SLOBBERED] == 0) {
                this.outx(
                    'She licks her teeth rather than her lips, reminding you in some ways of a predator observing prey.  You scarcely have time to contemplate this before she tugs you into the next room.  If the exceedingly comfortable-looking bed is any indication this would be where she sleeps.  Dominika insists upon you sitting on it and you find it to be exactly as comfortable as it looks, if not more so.  "<i>I knew it was an offer you\'d accept,</i>" she coos.  "<i>So few are worth my attentions, but you... you caught my eye, champion.</i>"  She approaches you with a seductive slink in her step, grabbing hold of your ' +
                        this.player.armorName +
                        " and tugging away the bottom.  Her eyes light up with mischievous anticipation as she sees what waits beneath it.\n\n",
                    false
                );

                this.outx(
                    '"<i>My my my, you must have been looking forward to this, you brought me a bouquet,</i>" she teases.  Curling her palm around your ' +
                        this.cockDescript(0) +
                        ', Dominika tosses you a smug smile.  "<i>Although I hope I\'m not disappointing you if I call it more of a buffet.</i>"  While continuing to tease your ' +
                        this.cockDescript(0) +
                        " with gentle friction, her other hand roams along your crotch.  The gentle fingers tease between your " +
                        this.multiCockDescriptLight() +
                        ', taking the time to familiarize themselves with the texture of your flesh.  The grin spread across her deep lips does not lessen as her skin tastes yours.  "<i>I\'m always curious about the circumstances that lead to this point,</i>" Dominika admits as her fingertips play about your head.  "<i>Was it an addiction to Incubus Draft? A spell gone wrong? You certainly didn\'t come here equipped like this. But then...</i>"  She leans in, flicking her tongue across the tip of your ' +
                        this.cockDescript(0) +
                ...
                this.outx(
                    "She leans in close to continue, her breasts rubbing across your " +
                        this.multiCockDescriptLight() +
                        ' as a result.  "<i>We\'re not after life stories, or deep introspection here,</i>" she whispers slowly, her breath flowing heatedly over your ' +
                        this.cockDescript(0) +
                        '.  "<i>You want me to do things to your body. It\'s that simple. And I...</i>" Her black lower lip drags itself over your head, its full curve teasing your cumslit as it passes by.  "<i>I want this.</i>"  Fingernails trail over your skin as she runs the verbal foreplay across your ' +
                        this.cockDescript(0) +
                        ', carried in her breath.  Her tongue flicks across your slit, taunting it while her hands roam freely over you.  In the relaxation her pleasure provides, you reach forward to rest your hand on her head, only to be abruptly reprimanded by a slap to your wrist.  "<i>No,</i>" she hisses smugly, letting her lips drag against the side of your ' +
                        this.cockDescript(0) +
                        ' as she speaks.  Their softness quickens your breath, and you focus on the words she speaks to keep your head.  "<i>I\'m not interested in letting you set the pace, dear.  This is mine to play with.</i>"\n\n',
                    false
                );

                this.outx(
                    "She shifts in deeper, slurping lightly on the side of your base.  Her chin rubs against your " +
                        this.cockDescript(1) +
                        " as she teases your primary wang, letting her skin taunt everything in your lap from your thighs to your pricks with her proximity.  The plumpness of her breasts makes for a suitable cockrest as her ebony puckers glide over the straining flesh of your " +
                        this.cockDescript(0) +
                        ".  They shift and move with her, pressing into your thigh as she swaps sides and sucks on the meat of your shaft.  Her dark lips feel better than you had imagined.  Their fullness belied a delicate touch that now, in the moment of finally experiencing them, borders on ecstasy.  You let your hands fall to the side to support yourself as Dominika works over your lap, accepting her terms if it means she labors over you like this.  The continued teasing over the side of your " +
                        this.cockDescript(0) +
                        " makes you eager to actually enter her mouth, but the casual way she claims dominion over your lap so that she can blow you is too enjoyable to interrupt.\n\n",
                    false
                );

                this.outx(
                    "Fortunately, you don't have to wait long. As her midnight cocksuckers drag up your " +
                        this.cockDescript(0) +
                        " once more, they curl around your head.  Finally your dick finds the warmth and clinging flesh of a hole. A groan forces itself past your lips and you can feel Dominika's dark puckers smirk.  They twist from side to side around your shaft, her breasts shifting and knocking against your " +
                        this.multiCockDescriptLight() +
                        " and catching some of the sweat from your crotch on them. Her fingers play wantonly where they please, at times squeezing and rubbing into your thighs, at others caressing randomly across your flesh.  Your " +
                        this.cockDescript(1) +
                        " soon comes to know their touch quite intimately.  Despite all this – despite much of your " +
                        this.multiCockDescriptLight() +
                        " simply sitting out in the air, pressing against the tattooed woman for warmth – your mind is drawn to the sensations of her mouth, and the sensations of those  deep, dark lips.  You only lust for them more as they drag along you.  Every little twist, every gulp that pushes them in another direction sends a tensing shiver down your " +
                        this.cockDescript(0) +
            ...
            // [Follow up Multi]
                ...
                this.outx(
                    'You barely have time to nod your assent before Dominika drags you into the other room with a grin, nearly throwing you to the bed and licking her lips.  "<i>C\'mon then you cumfactory,</i>" she smirks, tossing aside the bottom of your ' +
                        this.player.armorName +
                        " carelessly.  Her fingers trail at your thighs as she looks down at your " +
                        this.multiCockDescriptLight() +
                        ' with an unsubtle hunger.  "<i>Show me just how much you like what I do.</i>"  Her hand curls around your ' +
                        this.cockDescript(1) +
                        ", jerking it recklessly and lewdly.  You're hardly about to not get erect at her half-naked form and the administrations to your crotch – much less the sight of those deep, delicious lips – so the command feels a little silly.  You really stop caring about how silly it is as soon as her mouth slides over your " +
                        this.cockDescript(1) +
                        ".  She sucks casually on the prick, roaming over the base with one hand while the other taunts the head of your " +
                        this.cockDescript(0) +
                        ".  Though you try to relax, a small amount of tension still sits in you, brought about by the knowledge of just how recklessly Dominika can assault your prick with her succulent full puckers.\n\n",
                    false
                );

                this.outx(
                    "It's clear that it won't take long for her to reach that point.  Though she soon squeezes your cocks together and lashes her tongue across them, you can see her eyes settling on your " +
                        this.cockDescript(0) +
                        ", hungry for the fattest one.  Those dark cocksuckers kiss every cumslit wetly in turn, but wrap around the foremost of your pricks soon after.  They slide and shift messily around, the cabalist unafraid to spit and drool over your " +
                        this.cockDescript(0) +
                        " as she works it over.  Every movement the soft flesh makes excites you.  Your prick presses into the roof of her mouth, into her cheeks, pressing down her tongue.  It roams about the wet maw not freely, but where she demands it go.  The wet warmth pulling at your prick ensures you don't mind at all.  Her tongue nearly flays your prick in her ravenous domination, grinding so intimately into you they might have been joined as one.  Saliva drips down your prick from her squeezing ebony kiss, only allowing her to move slicker and quicker about you.  The plump 'O'-shaped puckers dominate your thoughts as easily as they dominate your lap, nearly sealing around your " +
                        this.cockDescript(0) +
                        " and ensuring that you will not leave her mouth until she is ready for you to.  The control she exhibits is wildly arousing and you happily drool pre-cum into her gulping mouth.  She swallows it up at the same time as she pulls you into her throat, claiming your prick even more.\n\n",
                    false
                );

                this.outx(
                    "All the while the rest of your " +
                        this.multiCockDescriptLight() +
                        " find themselves in the grip of her delicate hands. Their softness speaks to the life of a magic-user. It seems as though the hardest she may have worked in her life was the rough pumping she gave your " +
                        this.cockDescript(1) +
        ...
        // [If \"<i>Yes</i>\" and penis small enough to suck]
            ...
            if (this.player.hasKnot(x)) {
                ...
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00156] == 0) {
                    ...
                    this.outx(
                        'You were not prepared for the brief laugh that escapes her inky lips. "<i>Ah, sorry, sorry,</i>" she quickly explains, though she still smirks, "<i>Just... mmm, fan of spicy food, I take it?</i>" She brushes her hands over your ' +
                            this.cockDescript(x) +
                            ' and briefly rubs your knot with two fingers. "<i>As long as you give me my food we shouldn\'t have any problems.</i>" Those dark lips turn once more into a grin both confident and wicked. Leaning forward, her plump lower lip rests against the shaft of your ' +
                            this.cockDescript(x) +
                    ...
                    this.outx(
                        "Softly her lips press against yours, and you start to relax. Glancing down, your " +
                            this.cockDescript(x) +
                            ' has long since finished (though the knot remains thick), and Dominika sits beside you smirking. She gently massages your head as you recover from the fellatio, groaning slightly. It\'s hard to remember those last few moments, though you feel incredible. Just the sensation of the air on your sensitive prick makes you whimper a little. "<i>I think I gave him a bit of a workout,</i>" she teases, "<i>It\'s always good to remind a dick that a good mouth can do oh so much to it.</i>" You voice your appreciation, but can\'t help but ask why she wanted to blow you. "<i>Oh I told you, dear,</i>" she laughs slightly, licking her lips, "<i>I need to eat. Still though, even if I wanted to...</i>"\n\n',
                        false
                    );
            ...
            // Horsecock suck
                ...
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00174] == 0) {
                    this.outx(
                        'The smile that spreads across her face might have looked sinister on someone else. She takes your hand and guides you to the other room, licking her lips. Within rests an extraordinarily comfortable-looking bed, featuring a level of finery you had nearly forgotten existed. The cabalist leads you to it, and helps you sit down. "<i>Yeah,</i>" she smirks, "<i>I figured you might say yes.</i>" She reaches down to remove the bottom of your ' +
                            this.player.armorName +
                            ", before chuckling lightly at the sight of your " +
                            this.cockDescript(x) +
                            '. "<i>Oh yeah?</i>" she says, "<i>Do they call you the Icathian Stallion?</i>"\n\n',
                        false
                    );

                    this.outx(
                        'You blink in confusion at her. "<i>...You know, like... it\'s a nickname from... you know what, never mind.</i>" She waves her hand dismissively and smiles. "<i>I\'m sure no matter how uninformed you are, you still blow a load.</i>" Her hands reach down to slowly rub against the stiffening ' +
                            this.cockDescript(x) +
                            ", eager to have its fun with the topless arcanist standing before it. There's a comfortable softness to her thumb as it plays over your flared tip. She settles down to kneel before you, continuing to stroke your " +
                            this.cockDescript(x) +
                            " and entice it into a much fuller form. Even just this close you can begin to feel her breath emanating from between those luscious, deeply-coloured lips. The warmth of the sensation is seductive, carrying promises of what is yet to come. Your " +
                            this.cockDescript(x) +
                            " practically leans towards her in anticipation.\n\n",
                        false
                    );

                    this.outx(
                        "A single finger traces along the rim of the excited " +
                            this.cockDescript(x) +
                            '. Pulsing and hungry you grunt a little as a portion of pre-cum begins to form, slipping down from the cumslit. Your tattooed companion leans forward, catching it with her tongue before it slides down your shaft, and snapping it back into her mouth. A light smile tugs at the edge of her dark lips in turn. "<i>Glad to see you\'re of some use,</i>" she muses. Her fingers slip away from your head and stroke along the length of your prick instead, not wanting to get in the way of her intent. Once more her tongue touches the flat head of your ' +
                            this.cockDescript(x) +
                            ", dragging up from the bottom and across your cumhole before flicking calmly off the top.  Then her lips touch you.\n\n",
                        false
                    );

                    this.outx(
                        "You nearly melt. You've had blowjobs before. You've kissed lips, put your fingers on them, had them brush across your cheek. You know what lips feel like. The ones resting on the top of your " +
                            this.cockDescript(x) +
                            " have a softness, a plumpness, and a fullness to them you can barely process. Immediately you take a breath and then let out a groan. You feel rather than hear her chuckle against your dick, each motion of those dark pillows rubbing across you as they pull in a slight smile. Stammering out some degree of praise (though with how distracted you have abruptly grown you're not sure that you even formed a coherent sentence) you grind your " +
                            this.cockDescript(x) +
                            " forward in hopes of pushing past the simple kiss that graces your top. Those pursed lips remain steadfast in their act and press lightly to your cumslit, before widening slightly and flicking her tongue against it.\n\n",
                        false
                    );

                    this.outx(
                        'Moaning once again, your hands come forward to stroke through her hair and encourage her, but you are abruptly surprised by the slapping of your wrists. "<i>Down,</i>" Dominika says to you, her fingers returning to stroking your base once your hands return to the bed. "<i>This is mine to play with, not yours.</i>" You respond the most well-spoken way you can at the moment, namely by panting slightly. Still, the thought of letting those dark lips act upon you is appealing. You can\'t come up with any compelling reasons to disobey her desires. Apparently satisfied with your passive inaction, Dominika returns her attentions to your ' +
                            this.cockDescript(x) +
                            ", dragging those lush, gorgeous lips over your head and letting all of the sensitive flesh feel and grow enamored with them.\n\n",
                        false
                    );

                    this.outx(
                        "To your regret, they soon slip away. To your delight, they move to the side of your " +
                            this.cockDescript(x) +
                            ", dragging her mouth up and down the side of your prick while her palm curls around your flattened crown. She opens up her warm maw enough that her tongue can press against your engorged shaft but not so much that it covers the fat bottom lip that slides deliciously along you. You think of all the times you've had to jerk yourself off at camp and wish that you had at least had just this much more to aid you. Even without entering her, the glossy slide of her inky, pillowy cocksuckers elicits uncontrollable and desperate throbbing from your " +
                            this.cockDescript(x) +
                            ", alive with a need it only just developed. More pre-cum rises out of your prick, practically bubbling in its eagerness to be devoured.\n\n",
                        false
                    );

                    this.outx(
                        "Dominika fulfills its desire. Her flawless lips slide back up along the shaft, dragging themselves with a tauntingly slow speed up to the perverse summit of the " +
                            this.cockDescript(x) +
                    ...
                    this.outx(
                        "You find yourself obsessing over those lips, picturing them in your mind when you are forced to lean back and blur your vision in your pleasure. You stare at nothing in particular – at the walls, the ceilings, the shifting blonde bun – and as you do you imagine them, pulling at your dick and sucking it into her mouth, their ebony flawless fatness curved in an obscene O. You can imagine them engulfing and pulling on your " +
                            this.cockDescript(x) +
                            " so vividly, and their image is so perfectly formed and dominant in your mind that it is hard to think about anything else. It is as though those gorgeous dark lips are sucking directly on your mind – but then, given how much the needs of your " +
                            this.cockDescript(x) +
                            " dominate your every action, perhaps they are.\n\n",
                        false
                    );

                    this.outx(
                        "She bobs deeper, moving her head rougher. You enter her throat a few times before it becomes a far more frequent and rapid occurrence. It's difficult to remember that you're simply sitting down on the cabalist's bed, as the aggressive facefuck greatly resembles an uncontrolled rut. The act is all hers, assertively controlling your crotch with her mouth and using you for her own needs, recklessly slurping and coating your " +
                            this.cockDescript(x) +
                            " in her spit. She less fellates your prick than mounts it, treating her mouth as a slut's hungry cunt and aggressively claiming your crotch as a dildo for her needs. In the back of your mind you remember, though. It's not the sex she wants from you. It's your cum.\n\n",
                        false
                    );

                    this.outx(
                        "This thought proves catalyst enough for the last vestiges of control over your " +
                            this.cockDescript(x) +
                            " to vanish. Your mouth gapes in a deep and struggling moan, your body shaking as you lean back and let loose. The heat of your cum surges up the length of your " +
                            this.cockDescript(x) +
                            " and into Dominika's sucking, swallowing maw. Your prick becomes a delivery device for your thick spooge squeezed into submission by her fat, gorgeous, black, full, plush... you can barely process them. They're formed in your mind with such impossible perfection and desire. You long for them, ache for them, your entire body bucking and twisting with a desire to please the lips that curl around your base, engulfing your " +
                            this.cockDescript(x) +
                            " and using you, feasting on you. More, you have to cum more, you have to keep giving her everything you have. You're not even certain if you are cumming anymore, your mind locked in the brain-wiping haze of orgasm...\n\n",
                        false
                    );
                    ...
                    this.outx(
                        "Softly her lips press against yours, and you start to relax. Glancing down, your " +
                            this.cockDescript(x) +
                            ' has long since finished, and Dominika sits beside you smirking. She gently massages your sensitive shaft as you recover from the fellatio, groaning slightly. It\'s hard to remember those last few moments, though you feel incredible. Just the sensation of the air on your sensitive prick makes you whimper a little. "<i>That\'s a good stallion,</i>" she teases, "<i>It\'s always good to remind a dick that a good mouth can do oh so much to it.</i>" You voice your appreciation, but can\'t help but ask why she wanted to blow you. "<i>Oh I told you, dear,</i>" she laughs slightly, licking her lips, "<i>I need to eat. Still though, even if I wanted to...</i>"\n\n',
                        false
                    );
            ...
            // Human/fallback wang
                ...
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00151] == 0) {
                    this.outx(
                        'Dominika smiles, taking your hand and leading you to another room. Within is a surprisingly rich-looking bed, and she encourages you to sit down. "<i>Thank you,</i>" she says, and immediately follows it up with a truly wicked grin. "<i>Now to make you realize you should be thanking me.</i>"\n\n',
                        false
                    );
                    this.outx(
                        "She removes the bottom of your " +
                            this.player.armorName +
                            " and kneels in front of you. Taking your " +
                            this.cockDescript(x) +
                            " into her hands, her fingers begin a slow and steady massage along the length. She leans down and brings her lips to a soft kiss right on the tip of your " +
                            this.cockDescript(x) +
                    ...
                    if (this.player.balls > 0)
                        this.outx(
                            "Meanwhile her mouth slips down your dick, planting a few kisses along the way before reaching your " +
                                this.sackDescript() +
                                ". Her dark lips press against each of your " +
                                this.ballsDescriptLight() +
                                " in turn, granting each her moist smooch. She exhales warmly over them, teasing the cumfactories with a grin. Her mouth slips partially over one, her tongue slipping around the soft flesh. She is gentle and delicate in her administrations, and you feel comfortable about your " +
                                this.sackDescript() +
                                " sitting in her warm mouth – though you would prefer she wrap those plump lips around something else. Your head continues to be stimulated by her soft palm, and now adds pre-cum to the saliva she slowly spreads. A grunt makes her smirk, lifting from your " +
                                this.sackDescript() +
                                " and sliding her lips slowly up your dick.\n\n",
                            false
                        );
                    this.outx(
                        '"<i>You like this, mm?</i>" she asks, emphasizing her question with a gentle squeeze of her hand. "<i>To think of the path I\'ve walked,</i>" she muses, "<i>Once a capable cabalist, and now I\'m a better fellatrix.  Still – as long as you enjoy your work.</i>" She leans forward and quickly slurps up a drop of pre, gulping it down visibly. The trail of spit on your shaft hides any evidence that it was ever there, leaving only her smug grin as a tribute to its existence. Still holding your prick in her hand she ducks lower, using her tongue to take long deep slurps of your ' +
                            this.cockDescript(x) +
                            ". Teasing swirls flick across your base and her jaw rubs into the space between your thighs.  Dripping dragged paths of saliva are tracked along either side of your length, before she returns to your head.\n\n",
                        false
                    );
                    this.outx(
                        "The rush of pleasure could have staggered you if you were standing. One moment your " +
                            this.cockDescript(x) +
                            " was pressing into those soft black lips and moments later they had slipped around your head. She squeezes firmly with them and her tongue twists and contorts around your bulb, prostrating itself like an adherent before a god. Entering her mouth had been almost effortless. Her lips slipped apart like they were made to, while clinging to your girth like life support. A wet gulping noise accompanied a tight squeeze, her head beginning to shift around your " +
                            this.cockDescript(x) +
                            " in a careful and deliberate polishing.\n\n",
                        false
                    );
                    this.outx(
                        "Her hands travel along your length and roam along your thighs, squeezing them and slipping over your flesh. She seems to revel in the sensations of sucking on you, her eyes closed and her head bobbing rhythmically. The warm heat of her mouth slips along your " +
                            this.cockDescript(x) +
                            ", her slick lips managing to generate more than enough friction, and more than you expected. Her flesh hugs to your " +
                            this.cockDescript(x) +
                            " as tight as any cunt you've encountered so far, and as she begins to move her head more and more excitedly it becomes easy to forget. Only the wriggling tongue constantly rubbing and slipping along your meat and the palpable pucker of her perfect lips inform you of the fuckhole she's using to get you off.  It's difficult for your mind to not fixate on the black curves working you over. They seem as though they could truly be more comfortable, more soft and slick and smooth to slide into than anything else you've ever entered.\n\n",
                        false
                    );
                    this.outx(
                        "Her hands press to your thighs and push them apart slightly, and the reason why becomes quickly clear. She knocks your " +
                            this.cockDescript(x) +
                            " against the back of her  throat a few times before jamming you in, beginning to throatfuck herself on you. You gasp eagerly and move your hands up to her hair, but almost brutally she comes up and grabs your wrists, forcing you to place them on either side as she brutalizes her face on you. Spit practically flies off her chin and your shaft, dripping onto the bed and the floor. She fucks her mouth on you recklessly, acting like she was jamming a dildo into her cunt in a desperate frenzy to get off, but instead you feel her nose slamming into your crotch.  Those ebony slick suckers taunt you with how frictionless they seem to move, but they simultaneously push tightly against your skin with every inch they pass. You adore them.\n\n",
                        false
                    );
                    this.outx(
                        "The friction, the mess, and the obscenity of it all prove too much for you. Giving a strangled noise your " +
                            this.cockDescript(x) +
                            " throbs and starts to fire its load. She shoves herself into your lap, her lips wrapping tight around your base and her cheeks hollowing in as she sucks your load out. Her hunger for your spunk feels ravenous, and it's almost as though she's tugging it directly out of you. If she had sucked this hard to begin with, perhaps she would have! Still, you can't object to her need, and you moan helplessly as your " +
                            this.cockDescript(x) +
                            " blasts its creamy load directly down her throat and into her belly, aching to just keep cumming. Your hips press forward, trying to insert more of your dick into those perfect black lips, almost flawlessly imagined in your mind. You want to cum, you want to keep splattering your thick spunk between those fat puckers, those immaculate dark cockpillows.  Their image dominates your mind, the thought of them curving into that wet O ripping more cum from you. Your orgasm is only enhanced by the knowledge that you can spread them into that obscene shape, helping to demonstrate every nuance of their gorgeous form.\n\n",
                        false
                    );
                    this.outx(
                        'A wet pop signals her lips slipping over your tip. "<i>Mmm...</i>" she purrs softly. Your hips thrust forward slightly still, your ' +
                            this.cockDescript(x) +
                            ' tense and barely even relaxing, but your orgasm still rides out, pleasure overwhelming you. Gasping and weakly thrusting to the air, you shudder with tormented delight. Did the blowjob stop? It\'s hard to say. Your mind still fixates on those flawless lips, imagining their plush grip on your base. It was so good. It is so good, did it stop? You have to give them more cum, their plushness, their fullness needs to be helped.  She glides her hands up your body and rises. A soft kiss to your lips and you find your body willing to stop at last, falling back against her bed and gasping. "<i>I appreciate it, love,</i>" she smiles, climbing up and leaning against you, running a hand along your ' +
                            this.hairDescript() +
                            '. "<i>You were delicious.</i>"\n\n',
                        false
                    );
                    this.outx(
                        "She gently massages your head as you recover from the fellatio, groaning slightly. You look back down at your " +
                            this.cockDescript(x) +
                            ', watching it drip with saliva. "<i>I think I gave him a bit of a workout,</i>" she teases, "<i>It\'s always good to remind a dick that a good mouth can do oh so much to it.</i>" You voice your appreciation, but can\'t help but ask why she wanted to blow you. "<i>Oh I told you, dear,</i>" she laughs slightly, licking her lips, "<i>I need to eat. Still though, even if I wanted to...</i>"\n\n',
                        false
                    );
                    this.outx(
                ...
                // [Follow-up Sex, player has penis]
                    ...
                    this.outx(
                        "Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to suck your " +
                            ...
                            " and kneels in front of you. Taking your " +
                            this.cockDescript(x) +
                            ' into her hands, she aggressively begins lapping at it with her tongue, coating it in spit. "<i>Mmm, give me all your cum,</i>" she purrs, giving the top of your ' +
                            this.cockDescript(x) +
                            " a kiss as intimate as a lover's. The way her lips move is intoxicating, sliding their slippery glossy surface over every inch of your " +
                            this.cockDescript(x) +
                            " before engulfing the sweaty meat.\n\n",
                        false
                    );
                    this.outx(
                    ...
                    this.outx(
                        "Like before she facefucks herself on you, treating her mouth the same way an alley whore would treat her cunt. Ravenous and depraved noises arise from your lap, the fellatrix finding intense pleasure in sucking on your " +
                            this.cockDescript(x) +
                    ...
                    this.outx(
                        "You don't speak as it continues, merely grunting and gasping in the rapture that at that moment it seems only her mouth can bring. You try to push your " +
                            this.cockDescript(x) +
        ...
        // [If \"<i>Yes</i>\" and penis too big to suck]
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00152] == 0) {
                this.outx(
                    'A surprisingly big grin spreads across Dominika\'s face and she takes your hand, leading you to a side room. Within is a very comfortable looking bed, and she encourages you to sit down upon the covers. "<i>Excellent,</i>" she says, before grinning just a little wickedly, "<i>Now to break you upon my knee and leave you gasping for more.</i>" You don\'t have words for that one. At least she\'s confident.\n\n',
                    false
                );
                this.outx(
                    "She removes the bottom of your " +
                        this.player.armorName +
                        ", then blinks in surprise. Curiously she leans forward, running her hand over your head, then lifting your " +
                        this.cockDescript(x) +
                        ' to look closer at it. Almost adorably she opens her mouth and leans forward, apparently comparing the two, before looking back up at you. "<i>So in retrospect I probably should have noticed that you were barely keeping this contained, but uhm...</i>" She lets out an awkward light cough, then glances back at your dick. There\'s an intake of breath as she figures out how precisely she wants to say whatever she\'s about to say. "<i>I don\'t think I can fit this in my mouth...</i>" Tilting her head in thought as she strokes slowly along you, she eventually smirks and shrugs. "<i>Well I mean, not that I need to.</i>"\n\n',
                    false
                );
                this.outx(
                    'Her dark lips press forward, wetly moving against your cumslit in a slow kiss. That first contact is electric – their ebony curves are exactly as soft and slick as you could have wished for. Her tongue teases the hole briefly as she flicks across it. "<i>Mm, the taste is not... undesirable,</i>" she muses, winking at you. The slippery appendage slips out beneath your head to run along your glans, slipping between your foreskin and your flesh. You can\'t help but give an appreciative groan as her mouth begins its work. Her devilishly black pillows glide down the underside of your head to curl around your foreskin, pulling on it slightly before gently tugging it back. They circle slowly around the loose flesh, her chin and cheeks sliding against your ' +
                        this.cockDescript(x) +
                        " in the process. Every last inch of foreskin finds itself gently lifted from your head, pulled away by a full, soft lip – clinging to the dark surface as it is almost adoringly. The fullness of your erection soon makes such play impossible, standing tall and proud before the tattooed acolyte.\n\n",
                    false
                );
                this.outx(
                    'Once more her mouth shifts, moving its attention to the curve just beneath your head. Her tongue slips and grinds along the flare of your rod. "<i>You don\'t get to bathe much as an adventurer, do you?</i>" she muses as she does so. You\'re not sure how to take the comment.  Her lips occasionally close against your skin, sucking and kissing briefly. "<i>I can taste all the grime and musk on you.</i>" She purrs briefly, letting you know that she was not insulting you – this too then, was not undesirable to her. She takes long drags of her tongue along your flesh, before moving in close and grinding her dark, perfect lips from side to side across your ' +
                        this.cockDescript(x) +
                        ". You can't help but watch them, entranced. The way those curving pillows of flesh tease you is incredible. More blood than ever seems to rush into your " +
                        this.cockDescript(0) +
                ...
                if (this.player.balls > 0)
                    this.outx(
                        "While her mouth performs its work, you can't help but become aware of sensation elsewhere. One hand presses to your " +
                            this.ballsDescriptLight() +
                            ", rolling in slow circles across them. The touch is slow, gentle – but at the same time firm. You get the sense she's inquiring about them, handling them like a customer examining fruit. Well, let her handle you how she wants, as long as it feels this good. Her slender fingers slip along the wrinkles as if massaging them out, while her thumb presses at the front of your sac just firmly enough to ensure you don't slip away. The touch is taunting, even more so when the delicate and barely felt slip of her fingernails crosses your sac, but she thankfully makes no attempts to harm you. You know you can trust those dark lips.\n\n",
                        false
                    );
                this.outx(
                    "She shifts slightly, arcing her back a bit more to bring her breasts into greater visibility. Pressing forward she begins to rub the soft flesh over your shaft. Occasionally her nipple brushes across your veiny girth, sending a brief but agreeable little blush of pleasure. Your prick's sweat serves as suitable lubrication for the slow glide of her breasts, slipping against but not around your meat. Her back rocks repeatedly to grind her tits along you, in turn letting your " +
                        this.cockDescript(x) +
                ...
                this.outx(
                    "Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to suck on your " +
                        ...
                        " a kiss as intimate as a lover's. The way her lips move is intoxicating, sliding their slippery glossy surface over every inch of your " +
                        this.cockDescript(x) +
                        " before messily pressing to the top in a wide O.\n\n",
                    false
                );
                this.outx(
                    "She pushes your legs open and forces your " +
                        this.cockDescript(x) +
                        " to stand prominent, as though offering it up to her. Any attempt to hold on to her or guide her is quickly rebuffed, slapped away with her own hands. There is nothing submissive about her position. Her lips twist from side to side around your head, messily spilling warm drool down your prick. Your cumslit rubs against the roof of her mouth, against the inside of her cheek, tantalized and tormented by the wet flesh within. She gulps and sucks on your " +
                        this.cockDescript(x) +
                        " even with your limited entry, pulling on the flesh in a ravenous, sensual hunger. She fucks her mouth the best she can on your tremendous girth, only causing an increasingly wet mess.\n\n",
                    false
                );
                this.outx(
                    "Soon her hands and her tits comes to bear against your flesh, grinding up and around your veiny and oversized " +
                        this.cockDescript(x) +
                        ". They make use of the dripping spit along your shaft to slip and rub faster against your phallus, relying on soft aggressive friction to get you gasping. It succeeds, your mouth hanging open as you moan in pleasure, rocking your hips forward as though you could descend further into those darkly vibrant and beautifully plump cocksuckers, but even through your bliss you can feel them stretched to their limit. You can imagine them perfectly in your mind, in an ebony immaculate O, and the imagery is too much for you.\n\n",
                    false
                );
                this.outx(
                    "Your bucking hips seize and tremble as the first sticky load flings itself into her waiting maw. Her hands grip you with a possessive tightness, stroking along your " +
                        this.cockDescript(x) +
                        " as though coaxing every last drop out – and indeed, you give her every last drop you can, cumming until you can't anymore. Even then the orgasmic pleasure lingers in your mind, and you can't stop rocking your hips forward in a desire to let it continue. She slips away from your prick, finally rising up to kiss you on the lips. The touch of those dark puckers relaxes you, and you come down from the pleasure with a low, happy groan.\n\n",
                    false
                );
                this.outx(
                    '"<i>As always, delicious,</i>" she smiles, cuddling with you in the afterglow of her meal. She caresses you until you regain your strength, and then politely helps you re-dress and sends you on your way, giving you a kiss to remember her. Those black lips linger in your mind as you walk the streets of Tel\'Adre on your way back to camp.',
        ...
        if (this.timesFellatrixSucked() >= 4 && this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00175] == 0)
            this.doNext(this.dominidrama);
    ...
    private agreeWithDominika(): void {
        ...
        if (this.flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] > 0) {
            ...
            this.outx(
                '"<i>I knew you were strong when I saw you,</i>" she purrs softly. Though the folds of her skirt cover the belt you can feel its steel firmness pressing into your lap. "<i>And through you, I can recover the strength stolen from me.</i>" Her hand runs along your ' +
                    this.hairDescript() +
                    ' before she climbs off you, glancing out the window. "<i>You should go though,</i>" she says, "<i>It\'s late.</i>" There\'s a pause, before she says something she\'s never said before. "<i>I look forward to seeing you again.</i>"\n\n',
                false
            );
            ...
            this.outx(
                '"<i>I knew you were strong when I saw you,</i>" she purrs softly.  Though the folds of her skirt cover the belt she is close enough that you can feel the firmness of its steel pressing against you.  "<i>And through you, I can recover the strength stolen from me.</i>"  Her hand runs along your ' +
                    this.hairDescript() +
                    ' before she relaxes off you, glancing out the window.  "<i>You should go though,</i>" she says, "<i>It\'s late.</i>"  There\'s a pause, before she says something she\'s never said before.  "<i>I look forward to seeing you again.</i>"\n\n',
                false
            );
    ...
    private ehhhhDominika(): void {
        ...
        this.outx("", true);
        this.outx(
            'You make a small grunt, not even sitting up. Dominika\'s eyebrows lower after a time, and a bored but amused expression comes to her features. "<i>I suppose I shouldn\'t bother asking you anything after we\'re done, mm?</i>" She seems content to amuse herself with this telling of events, and you don\'t question it. "<i>Well, you should get going soon,</i>" she says, turning back to her mirror and adjusting her hair. "<i>You don\'t want to walk through the desert too late at night. Do visit again.</i>"\n\n',
            false
        );
    ...
    private dominidramaYes(): void {
        ...
        this.outx("Weary, you continue on your way out of Tel'Adre.");
    ...
    private dominidramaNo(): void {
        ...
        this.outx(
            'She turns to leave down the street, then pauses and turns back to you. "<i>Where are you from, anyway?</i>" she asks, "<i>I don\'t recognize your accent.</i>" You mention your home. "<i>Ingnam? Hmm. Never heard of it.</i>" She shrugs lightly, then leaves.\n\n',
            false
        );

        this.outx(
            'You feel warm inside, filled with a confidence that seemed to come out of nowhere. You can imagine Dominika\'s dark lips in your mind smiling, opening and curving as if to say "<i>Good work.</i>" The thought empowers you. It feels good to protect her, you think to yourself. You stride confidently out of the city.',
            false
        );
    ...
    private dominikaBlowjobs(): void {
        this.outx("", true);
        this.outx(this.images.showImage("dominika-gives-you-blowjob"));
        let x: number = this.player.cockThatFits(36);
        ...
        this.outx(
            '"<i>You have come so far,</i>" she muses as she steps over your body.  "<i>You have survived everything this cursed realm has dared to put in your way, and escaped... not untouched, but without surrender.</i>"  The cabalist kneels.  Her belt is uncomfortable against your belly, but no more so than the floor to your back.  ',
            false
        );
        if (this.player.canFly())
            this.outx("Your wings barely have room to avoid being crushed.  ");
        this.outx(
        ...
        if (this.player.hasCock()) {
            if (this.player.cockArea(x) <= 36) {
                this.outx(
                    '"<i><b>You are my champion,</b></i>" Dominika hisses slowly, trailing a finger over your lower lip.  "<i><b>And it is my will you shall serve.</b></i>"  With a low exhale the room settles from the warped space that had dominated the background.  You let out a staggering breath, realizing for the first time the edge you had been kept on.  Your ' +
                        this.cockDescript(x) +
                        ' aches with an uncanny stiffness, as solid as stone and as erect as a spire.  Dominika stands above you, her expression one of confidence.  An arcane circle-constellation forms in the air beneath her hand, her fingers looping through intangible curves.  "<i>Off,</i>" she says simply.  Piece by piece your ' +
                        this.player.armorName +
                        ' removes itself, at times flinging into a corner of the room.  Soon you lay before her nude and vulnerable, forcibly but willingly exposed.  "<i><b>You will give me everything.</b></i>" Her hand closes, the circle dissipating, and she lowers herself once more.  Down she slinks past the limited vision your magical constriction offers.  Unable to see her features you must rely on sensation to know where she lurks – and it is clear that she is lurking in your lap.\n\n',
                    false
                );

                this.outx(
                    "Her fingertips trail slowly down the swollen veins of your " +
                        this.cockDescript(x) +
                        ...
                        this.cockDescript(x) +
                        " enters her deep and hungry mouth.  The clenching heat of her throat pulls at your shaft as it slides down, swallowing around you.  Her hands no longer caress you to encourage your erection but instead clench your thighs to hold the cabalist up.\n\n",
                    false
                );

                this.outx(
                    "The incredible and oppressive ache that had dominated the thick stiffness of your " +
                        this.cockDescript(x) +
                        " is relieved in the tight fleshy confines that restrain it.  You still burn with the need for the pleasure  but it no longer seems like a darkness without end – or at least, an aid in the form of a different darkness is near.  The portal of her full lips squeezes tighter than you've felt in a long time, as though her mouth was locked as tightly around you as the belt around her waist.  Involuntarily, one of your thighs briefly spasms.  Being pinned in this position with a deep mouth pulling you in should be uncomfortable, but the sensation of flesh around your " +
                        this.cockDescript(x) +
                        " soaks up your focus. Dominika's lips reach your base, her mouth doing a light twist on your prick.  Your hips jerk up in shocked reflex.  Wet and thick breathing comes from between your legs before she rises.  Fingernails press painfully into your skin as she uses your helpless body for her desires.\n\n",
                    false
                );
                ...
                this.outx(
                    "A loud deep gulp of your " +
                        this.cockDescript(x) +
                        " drowns out the thought.  She dives down the length of your shaft every time, her throat so warm and tight that the air touching your spit-covered skin is almost agonizing in the chill it gives you.  Your " +
                        this.cockDescript(0) +
                        " spits pre-cum into her gut.  An incredible, strong suck of your prick soon accompanies it, as though she was hoping to pull the rest of your cum out right then and there.  She descends down into your lap, her plump fat lips squeezing around you, and then she sucks again.\n\n",
                    false
                );
                ...
                this.outx(
                    '"<i>Good ' +
                        ...
                        ',</i>" Dominika says. "<i><b>Again.</b></i>"\n\n',
                    false
                );

                this.outx(
                    "Blood surges into your " +
                        this.cockDescript(x) +
                        ".  Though still riding off the high of your last delicious orgasm an incredible desire engulfs and consumes you.  You want to fuck again.  No, you want to get sucked off by Dominika again.  You want to drown in her mouth, enslaved and consumed.  Your " +
                        this.cockDescript(x) +
                        " is so fucking sore, desperately aching for warmth and comfort.  Dominika touches her lips to your tip and in a single wet motion provides it.  The noise that slips between your lips is downright " +
                        this.player.mf("emasculating", "humiliating") +
                        ", but what do you care?  The comfort that clenches back around you is worth any girlish whimpers that may have come from your throat.  Cumming in her throat will fully make up for it.  Fuck, you want to cum in her.  It would be so easy to just relax, and let your " +
                        this.cockDescript(x) +
                        " relax unabashedly...\n\n",
                    false
                );
                ...
                this.outx(
                    "You adore the feeling of the 'O' her lips make as your " +
                        this.cockDescript(x) +
                        " surges with cum again. Those lips are so fucking beautiful.  Immaculate.  Even as she grinds them over something as obscene and lewd as your " +
                        this.cockDescript(x) +
                        " they're almost impossibly beautiful.  Occasionally your thighs spasm into the hands holding them down, the raw sensation of that constant dripping wet presence around your prick overwhelming and dominating your mind, making you lose control of your muscles.  The cabalist pulls at your " +
                        this.cockDescript(x) +
                        " with every inch of her throat.  Her lips, tongue, throat, teeth, cheeks all take your prick with singleminded intensity, expressing no concerns other than facilitating the emptying of the cum flooding through it.\n\n",
                    false
                );
                ...
                this.outx(
                    "Your " + this.cockDescript(x) + " surges with artificial desire.\n\n",
                    false
                );
                ...
                this.outx(
                    '"<i><b>You are my champion,</b></i>" Dominika hisses slowly, trailing a finger over your lower lip.  "<i><b>And it is my will you shall serve.</b></i>"  With a low exhale the room settles from the warped space that had dominated the background.  You let out a staggering breath, realizing for the first time the edge you had been kept on.  Your ' +
                        ...
                        ' aches with an uncanny stiffness, as solid as stone and as erect as a spire.  Dominika stands above you, her expression one of confidence.  An arcane circle-constellation forms in the air beneath her hand, her fingers looping through intangible curves.  "<i>Off,</i>" she says simply.  Piece by piece your ' +
                        this.player.armorName +
                        ' removes itself, at times flinging into a corner of the room.  Soon you lay before her nude and vulnerable, forcibly but willingly exposed.  "<i>I am going to give you what you always desired, little lamb,</i>" she says smugly, "<i>I am going to take you inside my deep, dark, perfect lips.  In exchange, <b>you will give me everything.</b></i>"  Her hand closes, the circle dissipating, and she lowers herself once more. Down she slinks past the limited vision your magical constriction offers.  Unable to see her features you must rely on sensation to know where she lurks – and it is clear that she is lurking in your lap.\n\n',
                    false
                );

                this.outx(
                    "Her fingers trace strange patterns over your " +
                        this.cockDescript(x) +
                        ", ones that seem both sensual and sinister.  The incredible stiffness you feel makes it difficult to focus on their actual shape, only their presence.  You are perceptive enough to realize that their increasing size is not before she drags them further across your prick, however.  It's getting smaller.  Dominika is taking the size of your " +
                        this.cockDescript(x) +
                        ' from you.  "<i>Just relax, little lamb,</i>" she purrs softly, "<i>I\'ll give it back.  I just need you to fit, tonight.  You want that, don\'t you?</i>" she breathes hotly over your prick, dragging her fat, luscious lips over it.  "<i>You want these around you?</i>"\n\n',
                    false
                );
                ...
                this.outx(
                    "The incredible and oppressive ache that had dominated the thick stiffness of your " +
                        this.cockDescript(x) +
                        " is relieved in the tight fleshy confines that restrain it.  You still burn with the need for the pleasure but it no longer seems like a darkness without end – or at least, an aid in the form of a different darkness is near.  The portal of her full lips squeezes tighter than anything you've felt in a long time, as though her mouth was locked as tightly around you as the belt around her waist.  Involuntarily, one of your thighs briefly spasms.  Being pinned in this position with a deep mouth pulling you in should be uncomfortable, but the sensation of flesh around your " +
                        this.cockDescript(x) +
                        " soaks up your focus.  Dominika's lips reach your base, her mouth doing a light twist on your prick.  Your hips jerk up in shocked reflex.  Wet and thick breathing comes from between your legs before she rises.  Fingernails press painfully into your skin as she uses your helpless body for her desires.\n\n",
                    false
                );
                ...
                this.outx(
                    "You cum. You didn't realize  how strong, how good it could feel when she sucked – you couldn't, until now.  The eruption splatters into her throat, and you imagine the strands of your cum clinging and dripping down the delicious throat-cunt you're so hungry to fill.  You have to cum for her, you're so fucking horny, so eager to dump everything your balls have into her.  As she pulls off of your softening prick (the very sensation of her lips gliding off of your head fills you with a certain disappointment) and your entire body heaves with your panting, you hear her chuckle.  \"<i>Good " +
                        this.player.mf("boy", "girl") +
                        ',</i>" Dominika says. "<i><b>Again.</b></i>"\n\n',
                    false
                );
            ...
            this.outx(
                '"<i>Mm, you\'ve kept yourself so pure,</i>"  Dominika purrs over your crotch.  You can feel the breath coming from her mouth.  Her fingers trail slowly over your labia, quietly tracing the lines of your ' +
                    this.vaginaDescript(0) +
                    '.  "<i>Well, relatively speaking,</i>" she adds.  You think you can feel her smirk.  "<i>You don\'t have some quartet of tentacles writhing about.  Just a nice, polite little pussy.</i>"  The next sensation she torments you with is her tongue, grinding slowly up the delicate flesh between your legs.  It flicks in a slow pattern, gliding lazily around the needy flesh.  She seems to refuse to plant it inside of you, even with your needy panting begging for deeper penetration, for some penetration.  You\'re wildly, heatedly horny, and nothing sounds like a better solution for that than Dominika\'s tongue plunging into your ' +
                    this.vaginaDescript(0) +
                    " to slap and grind along the walls of your pussy.  Her fingers slide slowly over your skin, working their way down your legs to massage against your thighs.  They press in tightly, grinding into the stiff and restrained muscles firmly enough that the psuedo-massage forces occasional muscle spasms.  Why can't she just rub those deep full lips closer?  Why does she have to tease you with this delicate touch?\n\n",
                false
            );

            this.outx(
                '"<i>Such a pretty little flower,</i>" Dominika purrs again.  She shifts over to the very top of your ' +
                    this.vaginaDescript(0) +
                    " and kisses your clit carefully.  Your " +
                    this.clitDescript() +
                    " is sensitive enough that you can pick up on every motion the fat black flesh makes.  The wrinkles from the pucker pull slowly away as she takes the time to rub your clit over her lips, reminding you of the delicious soft sensations they provide.  Your hips arch subtly, rolling towards her in a desire to have their depths explored.   You whine and plead for more, shuddering in the circle.  As her lips pass over your skin, you feel them smirk.\n\n",
                false
            );

            this.outx(
                "Despite your desperation, the slow tantalizing whorls of her tongue return.  Your " +
                    this.vaginaDescript(0) +
                    " drools over it, beginning to create a puddle that the very bottom of your bum brushes embarrassingly against.  As she has been since she first placed those sinfully dark lips upon you, Dominika does not care about your needs or your whimpering desire.  Her pace is hers alone, though with the bindings pinning your body tight you could not influence it if you wanted to.  The sorceress has you.  The tip of her tongue drags itself up and down your " +
                    this.vaginaDescript(0) +
                    ", twisting and shifting from side to side and never quite giving you anything beyond that persistent taunting stimulation.  You long for her to give you more with those dark lips, to slip her tongue inside you or truly torment your " +
                    this.clitDescript() +
                    ", but she remains as she is.\n\n",
                false
            );

            this.outx(
                "Her hands roam up from your thighs, grazing above your crotch.  If her fingers teased your folds with a delicate touch, they are far more ruthless in their manner as they grind into your skin.  It serves as a sharp contrast to the insufferable gentility she continues to apply to your " +
                    this.vaginaDescript(0) +
                    " and a firm reminder that she could do so much more to you.  The compulsion to desire more consumes your thoughts uncontrollably.  Why must she torment you like this? Why can she not overwhelm your constrained form and flood you with the pleasure you hunger for?  Surely she wants to feed on you as much as you want to feed your lusts off her.\n\n",
                false
            );

            this.outx(
                '"<i>You want more?</i>" she taunts you.  Such an asinine fucking question.  She knows you want more.  She made you want more.  Were you not bound and helpless under her you would... no, you know you would whimper helplessly and beg.  Those lips enthrall you.  She barely rubs them against your ' +
                    this.vaginaDescript(0) +
                    " just to ensure that you are perpetually reminded of them.  Their form consumes your mind.  You adore Dominika's mouth and any earlier concerns about your position have been banished.  This is what you long for.\n\n",
                false
            );

            this.outx(
                "There's no ceremony when it finally happens, though in some ways it feels like one.  You don't know how long you laid there tormented by her but you know when the torment stops.  Her tongue plunges into your " +
                    this.vaginaDescript(0) +
                    ", twisting inside and finding the perfect spot in seconds.  The time she's spent with your cunt is fully on display.  Your voice escapes you as your hips buck in equal parts surprise and pleasure.  Perhaps it's the sudden shift that makes you cum, the abrupt transition from tranquil touches to torrid tonguing, but you writhe helplessly in Dominika's oral grip.  Long ago you might have been ashamed of how quickly you start moaning when she shifts, but now you are only relieved that the pleasure can flood you so easily.  You're dimly aware of Dominika's mouth over you, drinking in your nectar, but the touch feels a world away.  Deep and dark pleasure – as full and consuming as the lips that engulf your mind – fills your senses.  The already dim room goes even darker as your vision swims.  Stars flicker into view above you, then blink.  Dominika's eyes gaze into yours with confidence.\n\n",
                false
            );

            this.outx(
                '"<i>Does that feel good?</i>" she teases you again as your orgasm continues to ride out.  Her fingers play over your ' +
                    this.vaginaDescript(0) +
                    ', her body laying alongside you.  You couldn\'t get mad at her for the torment now, not with the seizing pleasure still flickering through your nerves.  The smug self-satisfaction on Dominika\'s features only grows.  She leans in and relaxes more next to you, resting her nose against your cheek and breathing against you.  "<i>Such a pleasant face you have, when wracked with pleasure,</i>" she muses, taking the time to ensure that every word she speaks results in her dark lips grazing along your skin.  The delicate flesh shifts and teases your ear.  "<i>Let\'s see it <b>again</b>.</i>"\n\n',
                false
            );

            this.outx(
                "Her middle finger presses into your " +
                    this.vaginaDescript(0) +
                    ' and grinds firmly into the perfect spot lurking within.  You gag briefly, the pleasure from the act shocking you in its intensity.  No single finger should be able to do that with one gesture.  Your hips buck into her hand, incredible lust devouring all other feelings and leaving you singleminded in its pursuit.  "<i>Aaand... there,</i>" Dominika purrs against your ear.  For just a moment you recognize the touch of magic before another orgasm shudders through your body, spreading from that single point where her finger meets your cunt.  It washes over you in ripples from that touch.  Your vision drowns in darkness, your eyes losing control.  Perhaps all of you loses control.  You can\'t tell.\n\n',
                false
            );

            this.outx(
                '"<i><b>Again.</b></i>" Dominika says it before your current orgasm feels even close to finished.  Another pulse of pleasure overwhelms you, colliding and joining with the existing one.  Your body strains in the binds, muscles twitching.  "<i><b>Again.</b></i>"  The individual sensations are impossible to note.  They consume each other and yourself.  Drool twitches out of your mouth.  Nothing is present but the pleasure... and Dominika.  She doesn\'t shift from her position beside you, continuing to work her finger into your ' +
                    this.vaginaDescript(0) +
                    ".  Her lips continue to play over your ear even when she is silent, and you must think of them as you cum.  You cannot stop yourself.\n\n",
                false
            );

            this.outx(
                '"<i>Again.</i>"  This time - rather than strain and yearn for more more more - your body collapses, falling into the puddle of your juices spread across the floor.  It\'s too much.  The pleasure is too much, too fast, too absolute.  Your ' +
                    this.vaginaDescript(0) +
                    ' feels nearly numb.  Your head lolls to the side.  Dominika\'s starry eyes are directly in front of yours, but you do not match her gaze.  You could not look at her if you tried.  "<i>You are drained, little lamb of Ingnam,</i>" she whispers to you, through you.  "<i>You have nothing left.  Your body has failed you.  Your people have abandoned you.  You are alone and nothing before the infinite night.  <b>Take this emptiness, this nothingness,</b></i>" she hisses, and you know that the darkness you see is the pitch of her lips.  "<i><b>And fill it with me.</b></i>"\n\n',
                false
            );

            this.outx(
                'Her hand trails over your belly, down to your crotch. "<i><b>Again.</b></i>"\n\n',
                false
            );
        }
        this.player.orgasm();
