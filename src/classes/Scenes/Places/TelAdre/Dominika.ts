    ...
    private acceptFellatrixOral(): void {
        ...
        if (this.player.hasVagina() && (this.player.gender == 2 || Dominika.rand(2) == 0)) {
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00153] == 0) {
                ...
                this.outx(
                    `Nails dig into your thighs abruptly as she tightens her grip. Hungrily she opens her mouth wider and pushes her tongue into your ${this.vaginaDescript(
                        0
            ...
            // Repeat
                ...
                this.outx(
                    `Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to descend upon your ${this.vaginaDescript(
                        0
        ...
        // MULTICAWWWWK
            ...
            if (this.flags[kFLAGS.DOMINIKA_TIMES_MULTICOCK_SLOBBERED] == 0) {
                ...
                this.outx(
                    `"<i>My my my, you must have been looking forward to this, you brought me a bouquet,</i>" she teases.  Curling her palm around your ${this.cockDescript(
                        0
                ...
                this.outx(
                    `She leans in close to continue, her breasts rubbing across your ${this.multiCockDescriptLight()} as a result.  "<i>We're not after life stories, or deep introspection here,</i>" she whispers slowly, her breath flowing heatedly over your ${this.cockDescript(
                        ...
                        0
                    )}, carried in her breath.  Her tongue flicks across your slit, taunting it while her hands roam freely over you.  In the relaxation her pleasure provides, you reach forward to rest your hand on her head, only to be abruptly reprimanded by a slap to your wrist.  "<i>No,</i>" she hisses smugly, letting her lips drag against the side of your ${this.cockDescript(
                        0
                ...
                this.outx(
                    `She shifts in deeper, slurping lightly on the side of your base.  Her chin rubs against your ${this.cockDescript(
                        1
                    )} as she teases your primary wang, letting her skin taunt everything in your lap from your thighs to your pricks with her proximity.  The plumpness of her breasts makes for a suitable cockrest as her ebony puckers glide over the straining flesh of your ${this.cockDescript(
                        0
                    )}.  They shift and move with her, pressing into your thigh as she swaps sides and sucks on the meat of your shaft.  Her dark lips feel better than you had imagined.  Their fullness belied a delicate touch that now, in the moment of finally experiencing them, borders on ecstasy.  You let your hands fall to the side to support yourself as Dominika works over your lap, accepting her terms if it means she labors over you like this.  The continued teasing over the side of your ${this.cockDescript(
                        0
            ...
            // [Follow up Multi]
                ...
                this.outx(
                    `You barely have time to nod your assent before Dominika drags you into the other room with a grin, nearly throwing you to the bed and licking her lips.  "<i>C'mon then you cumfactory,</i>" she smirks, tossing aside the bottom of your ${
                        ...
                        1
                    )}.  She sucks casually on the prick, roaming over the base with one hand while the other taunts the head of your ${this.cockDescript(
                        0
        ...
        // [If \"<i>Yes</i>\" and penis small enough to suck]
            ...
            if (this.player.hasKnot(x)) {
                ...
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00156] == 0) {
                    ...
                    this.outx(
                        `You were not prepared for the brief laugh that escapes her inky lips. "<i>Ah, sorry, sorry,</i>" she quickly explains, though she still smirks, "<i>Just... mmm, fan of spicy food, I take it?</i>" She brushes her hands over your ${this.cockDescript(
                            x
                        )} and briefly rubs your knot with two fingers. "<i>As long as you give me my food we shouldn't have any problems.</i>" Those dark lips turn once more into a grin both confident and wicked. Leaning forward, her plump lower lip rests against the shaft of your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `Her tongue returns to the base of your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `Saliva flicks across your tip as she finishes the slow lick. The lewd schlorp that follows makes you spasm, thighs twitching as you jerk forward. A strangled gasp is ripped from your throat, the abrupt penetration of the sorceress' mouth catching you unprepared even in your obsession with her maw in your mind.  She fills her mouth with you, wetly slipping around your ${this.cockDescript(
                            x
                        )}, shoving your tip into her cheeks. It grinds against the soft and heated flesh within until she can no longer fit the swelling shaft between teeth and cheek. Her tongue then becomes the focus of the slow grind, rubbing itself from side to side along the underbelly of your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `The ache of your desire feels so palpable you want to strangle it. You long to reach forward and take the occultist's head, to shove her down and let your knot lock her to your crotch and to dump endless depravity into her stomach. Every time you think of it you are reminded of the firm instructions she gave you not to, and the thought of disregarding those lips stresses you to uncomfortable levels. Your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `Softly her lips press against yours, and you start to relax. Glancing down, your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `You arrive at the second-story apartment and Dominika unceremoniously drags you into the other room. "<i>C'mon, bitch,</i>" she says playfully, licking those deep lips.  She sits you on the bed and pulls your ${
                            this.player.armorName
                        } away from you, kneeling down. "<i>I trust you've built up a good meal?</i>" She rapidly starts pumping your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `Like your last visit, she facefucks herself on you, treating her mouth the way you've come to expect – acting as her only and favorite sex organ. Ravenous and depraved noises arise from your lap, the fellatrix finding intense pleasure in sucking on your ${this.cockDescript(
                            x
                ...
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00174] == 0) {
                    this.outx(
                        `The smile that spreads across her face might have looked sinister on someone else. She takes your hand and guides you to the other room, licking her lips. Within rests an extraordinarily comfortable-looking bed, featuring a level of finery you had nearly forgotten existed. The cabalist leads you to it, and helps you sit down. "<i>Yeah,</i>" she smirks, "<i>I figured you might say yes.</i>" She reaches down to remove the bottom of your ${
                            this.player.armorName
                        }, before chuckling lightly at the sight of your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `You blink in confusion at her. "<i>...You know, like... it's a nickname from... you know what, never mind.</i>" She waves her hand dismissively and smiles. "<i>I'm sure no matter how uninformed you are, you still blow a load.</i>" Her hands reach down to slowly rub against the stiffening ${this.cockDescript(
                            x
                        )}, eager to have its fun with the topless arcanist standing before it. There's a comfortable softness to her thumb as it plays over your flared tip. She settles down to kneel before you, continuing to stroke your ${this.cockDescript(
                            x
                        )} and entice it into a much fuller form. Even just this close you can begin to feel her breath emanating from between those luscious, deeply-coloured lips. The warmth of the sensation is seductive, carrying promises of what is yet to come. Your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `She bobs deeper, moving her head rougher. You enter her throat a few times before it becomes a far more frequent and rapid occurrence. It's difficult to remember that you're simply sitting down on the cabalist's bed, as the aggressive facefuck greatly resembles an uncontrolled rut. The act is all hers, assertively controlling your crotch with her mouth and using you for her own needs, recklessly slurping and coating your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `This thought proves catalyst enough for the last vestiges of control over your ${this.cockDescript(
                            x
                        )} to vanish. Your mouth gapes in a deep and struggling moan, your body shaking as you lean back and let loose. The heat of your cum surges up the length of your ${this.cockDescript(
                            x
                ...
                // Reppppppeat
                    ...
                    this.outx(
                        `Nearly dragged into Dominika's bedroom, she pushes you to the bed so unceremoniously you fall onto your back. "<i>Come on then,</i>" she purrs aggressively as she moves towards you, licking those darkly-painted lips, "<i>Show me you're more than an infertile mule.</i>" She climbs up on the bed and puts a foot to your chest as you try to sit up, giggling and grinning at the controlling position before shifting down to her side. She tugs the bottom portion of your ${
                            this.player.armorName
                        } away to reveal your ${this.cockDescript(
                            x
            ...
            // Human/fallback wang
                ...
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00151] == 0) {
                    ...
                    this.outx(
                        `She removes the bottom of your ${
                            this.player.armorName
                        } and kneels in front of you. Taking your ${this.cockDescript(
                            x
                        )} into her hands, her fingers begin a slow and steady massage along the length. She leans down and brings her lips to a soft kiss right on the tip of your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `The rush of pleasure could have staggered you if you were standing. One moment your ${this.cockDescript(
                            x
                        )} was pressing into those soft black lips and moments later they had slipped around your head. She squeezes firmly with them and her tongue twists and contorts around your bulb, prostrating itself like an adherent before a god. Entering her mouth had been almost effortless. Her lips slipped apart like they were made to, while clinging to your girth like life support. A wet gulping noise accompanied a tight squeeze, her head beginning to shift around your ${this.cockDescript(
                            x
                        )} in a careful and deliberate polishing.\n\n`,
                        false
                    );
                    this.outx(
                        `Her hands travel along your length and roam along your thighs, squeezing them and slipping over your flesh. She seems to revel in the sensations of sucking on you, her eyes closed and her head bobbing rhythmically. The warm heat of her mouth slips along your ${this.cockDescript(
                            x
                        )}, her slick lips managing to generate more than enough friction, and more than you expected. Her flesh hugs to your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `Her hands press to your thighs and push them apart slightly, and the reason why becomes quickly clear. She knocks your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `She gently massages your head as you recover from the fellatio, groaning slightly. You look back down at your ${this.cockDescript(
                            x
                ...
                // [Follow-up Sex, player has penis]
                    ...
                    this.outx(
                        `Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to suck your ${this.cockDescript(
                            x
                        )}. She removes the bottom of your ${
                            this.player.armorName
                        } and kneels in front of you. Taking your ${this.cockDescript(
                            x
                        )} into her hands, she aggressively begins lapping at it with her tongue, coating it in spit. "<i>Mmm, give me all your cum,</i>" she purrs, giving the top of your ${this.cockDescript(
                            x
                        )} a kiss as intimate as a lover's. The way her lips move is intoxicating, sliding their slippery glossy surface over every inch of your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `Like before she facefucks herself on you, treating her mouth the same way an alley whore would treat her cunt. Ravenous and depraved noises arise from your lap, the fellatrix finding intense pleasure in sucking on your ${this.cockDescript(
                            x
                    ...
                    this.outx(
                        `You don't speak as it continues, merely grunting and gasping in the rapture that at that moment it seems only her mouth can bring. You try to push your ${this.cockDescript(
                            x
        ...
        // [If \"<i>Yes</i>\" and penis too big to suck]
            ...
            if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00152] == 0) {
                ...
                this.outx(
                    `She removes the bottom of your ${
                        this.player.armorName
                    }, then blinks in surprise. Curiously she leans forward, running her hand over your head, then lifting your ${this.cockDescript(
                        x
                ...
                this.outx(
                    `Once more her mouth shifts, moving its attention to the curve just beneath your head. Her tongue slips and grinds along the flare of your rod. "<i>You don't get to bathe much as an adventurer, do you?</i>" she muses as she does so. You're not sure how to take the comment.  Her lips occasionally close against your skin, sucking and kissing briefly. "<i>I can taste all the grime and musk on you.</i>" She purrs briefly, letting you know that she was not insulting you – this too then, was not undesirable to her. She takes long drags of her tongue along your flesh, before moving in close and grinding her dark, perfect lips from side to side across your ${this.cockDescript(
                        x
                    )}. You can't help but watch them, entranced. The way those curving pillows of flesh tease you is incredible. More blood than ever seems to rush into your ${this.cockDescript(
                        0
                ...
                this.outx(
                    `She shifts slightly, arcing her back a bit more to bring her breasts into greater visibility. Pressing forward she begins to rub the soft flesh over your shaft. Occasionally her nipple brushes across your veiny girth, sending a brief but agreeable little blush of pleasure. Your prick's sweat serves as suitable lubrication for the slow glide of her breasts, slipping against but not around your meat. Her back rocks repeatedly to grind her tits along you, in turn letting your ${this.cockDescript(
                        x
                ...
                this.outx(
                    `Her hands roaming over the girth of your ${this.cockDescript(
                        x
                ...
                this.outx(
                    `Once you arrive at the second-story apartment, Dominika practically pulls you into the other room, eager to suck on your ${this.cockDescript(
                        x
                    )}. She removes the bottom of your ${
                        this.player.armorName
                    } and kneels in front of you. Taking your ${this.cockDescript(
                ...
                this.outx(
                    `Soon her hands and her tits comes to bear against your flesh, grinding up and around your veiny and oversized ${this.cockDescript(
                        x
                ...
                this.outx(
                    `Your bucking hips seize and tremble as the first sticky load flings itself into her waiting maw. Her hands grip you with a possessive tightness, stroking along your ${this.cockDescript(
                        x
    ...
    private dominikaBlowjobs(): void {
        ...
        if (this.player.hasCock()) {
            if (this.player.cockArea(x) <= 36) {
                ...
                this.outx(
                    `The incredible and oppressive ache that had dominated the thick stiffness of your ${this.cockDescript(
                        x
                    )} is relieved in the tight fleshy confines that restrain it.  You still burn with the need for the pleasure  but it no longer seems like a darkness without end – or at least, an aid in the form of a different darkness is near.  The portal of her full lips squeezes tighter than you've felt in a long time, as though her mouth was locked as tightly around you as the belt around her waist.  Involuntarily, one of your thighs briefly spasms.  Being pinned in this position with a deep mouth pulling you in should be uncomfortable, but the sensation of flesh around your ${this.cockDescript(
                        x
                ...
                this.outx(
                    `A loud deep gulp of your ${this.cockDescript(
                        x
                    )} drowns out the thought.  She dives down the length of your shaft every time, her throat so warm and tight that the air touching your spit-covered skin is almost agonizing in the chill it gives you.  Your ${this.cockDescript(
                        0
                ...
                this.outx(
                    `Blood surges into your ${this.cockDescript(
                        x
                    )}.  Though still riding off the high of your last delicious orgasm an incredible desire engulfs and consumes you.  You want to fuck again.  No, you want to get sucked off by Dominika again.  You want to drown in her mouth, enslaved and consumed.  Your ${this.cockDescript(
                        x
                    )} is so fucking sore, desperately aching for warmth and comfort.  Dominika touches her lips to your tip and in a single wet motion provides it.  The noise that slips between your lips is downright ${this.player.mf(
                        "emasculating",
                        "humiliating"
                    )}, but what do you care?  The comfort that clenches back around you is worth any girlish whimpers that may have come from your throat.  Cumming in her throat will fully make up for it.  Fuck, you want to cum in her.  It would be so easy to just relax, and let your ${this.cockDescript(
                        x
                    )} relax unabashedly...\n\n`,
                    false
                );
                ...
                this.outx(
                    `You adore the feeling of the 'O' her lips make as your ${this.cockDescript(
                        x
                    )} surges with cum again. Those lips are so fucking beautiful.  Immaculate.  Even as she grinds them over something as obscene and lewd as your ${this.cockDescript(
                        x
                    )} they're almost impossibly beautiful.  Occasionally your thighs spasm into the hands holding them down, the raw sensation of that constant dripping wet presence around your prick overwhelming and dominating your mind, making you lose control of your muscles.  The cabalist pulls at your ${this.cockDescript(
                        x
                ...
                this.outx(`Your ${this.cockDescript(x)} surges with artificial desire.\n\n`, false);

                this.outx('"<i><b>Again.</b></i>"\n\n', false);

                this.outx(
                    `Matching the fall of your ${this.cockDescript(
                        x
                ...
                this.outx(
                    `Her fingers trace strange patterns over your ${this.cockDescript(
                        x
                    )}, ones that seem both sensual and sinister.  The incredible stiffness you feel makes it difficult to focus on their actual shape, only their presence.  You are perceptive enough to realize that their increasing size is not before she drags them further across your prick, however.  It's getting smaller.  Dominika is taking the size of your ${this.cockDescript(
                        x
                ...
                this.outx(
                    `The incredible and oppressive ache that had dominated the thick stiffness of your ${this.cockDescript(
                        x
                    )} is relieved in the tight fleshy confines that restrain it.  You still burn with the need for the pleasure but it no longer seems like a darkness without end – or at least, an aid in the form of a different darkness is near.  The portal of her full lips squeezes tighter than anything you've felt in a long time, as though her mouth was locked as tightly around you as the belt around her waist.  Involuntarily, one of your thighs briefly spasms.  Being pinned in this position with a deep mouth pulling you in should be uncomfortable, but the sensation of flesh around your ${this.cockDescript(
                        x
                    )} soaks up your focus.  Dominika's lips reach your base, her mouth doing a light twist on your prick.  Your hips jerk up in shocked reflex.  Wet and thick breathing comes from between your legs before she rises.  Fingernails press painfully into your skin as she uses your helpless body for her desires.\n\n`,
                    false
                );
            ...
            this.outx(
                `"<i><b>You are my champion,</b></i>" Dominika hisses slowly, trailing a finger over your lower lip.  "<i><b>And it is my will you shall serve.</b></i>"  With a low exhale, the room settles from the warped space that had dominated the background.  You let out a staggering breath, realizing for the first time the edge you had been kept on.  Your ${this.vaginaDescript(
                    0
            ...
            this.outx(
                `Despite your desperation, the slow tantalizing whorls of her tongue return.  Your ${this.vaginaDescript(
                    0
            ...
            this.outx(
                `Her hands roam up from your thighs, grazing above your crotch.  If her fingers teased your folds with a delicate touch, they are far more ruthless in their manner as they grind into your skin.  It serves as a sharp contrast to the insufferable gentility she continues to apply to your ${this.vaginaDescript(
                    0
            ...
            this.outx(
                `"<i>You want more?</i>" she taunts you.  Such an asinine fucking question.  She knows you want more.  She made you want more.  Were you not bound and helpless under her you would... no, you know you would whimper helplessly and beg.  Those lips enthrall you.  She barely rubs them against your ${this.vaginaDescript(
                    0
            ...
            this.outx(
                `There's no ceremony when it finally happens, though in some ways it feels like one.  You don't know how long you laid there tormented by her but you know when the torment stops.  Her tongue plunges into your ${this.vaginaDescript(
                    0
            ...
            this.outx(
                `"<i>Does that feel good?</i>" she teases you again as your orgasm continues to ride out.  Her fingers play over your ${this.vaginaDescript(
                    0
            ...
            this.outx(
                `Her middle finger presses into your ${this.vaginaDescript(
                    0
            ...
            this.outx(
                `"<i>Again.</i>"  This time - rather than strain and yearn for more more more - your body collapses, falling into the puddle of your juices spread across the floor.  It's too much.  The pleasure is too much, too fast, too absolute.  Your ${this.vaginaDescript(
                    0
