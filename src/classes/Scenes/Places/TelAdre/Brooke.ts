...
export class Brooke extends TelAdreAbstractContent {
    ...
    public helpBrookeOut(): void {
        ...
        if (this.player.gender == 3)
            this.outputText("your loins beginning to stir, each and every part of you enticed");
        this.outputText(
    ...
    public gropeDatBrooke(): void {
        ...
        this.outputText(
            "  The tension is beginning to get a little unbearable and your resolve wavers."
        );
    ...
    public brookeAnal(): void {
        ...
        this.outputText(
            "; and you cum into her, blasting rope after rope of your jism inside her."
        );
        if (this.player.cockTotal() > 1)
            this.outputText(
    ...
    public tribadism(): void {
        ...
        if (this.player.gender == 3)
            this.outputText(" and all the way to the base of your now-straining, pre-leaking cock");
        this.outputText(".");
    ...
    public getLaidByBrooke(): void {
        ...
        if (this.player.hasCock())
            this.outputText(" [eachCock], now fully erect and at attention, just for her");
        else
            this.outputText(
        ...
        // {female scene}
            ...
            if (this.player.cor <= 49)
                this.outputText("  That would almost be embarrassing enough to turn you off.");
            else
                this.outputText(
        ...
        if (this.player.cockTotal() >= 3)
            this.outputText(", and letting the excess wash from her fur half-heartedly");
        this.outputText(
        ...
        if (this.player.hasCock())
            this.outputText(", snowballing what she hasn't swallowed quite yet");
        this.outputText(
    ...
    public doubleDicked(): void {
        ...
        this.outputText(
            "  She gasps and jerks with your every thrust, and you grunt, shoving yourself"
        );
    ...
    public brookeSpecialMediumSceneContinued(): void {
        ...
        if (x >= 0 && !this.player.hasVagina()) {
            ...
            if (this.player.hairLength >= 1)
                this.outputText(", running her fingers through your " + this.hairDescript());
            this.outputText(
    ...
    public nopeOutofBroke(): void {
        this.clearOutput();
        this.outputText(
            "You shake your head at Heckel, not feeling like playing second fiddle today."
        );
        this.outputText(
    ...
    public submitHeckelXBrookeThreesome(): void {
        ...
        if (this.player.hasCock())
            this.outputText(
                "engulfing your " + this.cockDescript(0) + " into her warm, busy mouth"
            );
        if (this.player.cockTotal() == 2)
            this.outputText(
    ...
    public brookeVHeckelBrookeWins3(): void {
        ...
        if (!this.player.hasCock())
            this.outputText(", muffled from your [vagina] still plugging her lips");
        this.outputText(
