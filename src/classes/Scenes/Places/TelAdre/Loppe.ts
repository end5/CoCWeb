    ...
    */
    ...
    private appearanceOfLoppe(): void {
        ...
        if (this.flags[kFLAGS.LOPPE_FURRY] == 0) {
            this.outputText(
                "Loppe is a 6'2\" bunny-girl with deep brown eyes set in her pretty face.  Shoulder-length black hair and a pair of snow-white rabbit ears adorn the top of her head, tilted and lying backward to conceal the insides.  Curiously, her face is that of a normal human woman."
            );
            this.outputText(
    ...
    public loppeFirstMeeting(): void {
        this.clearOutput();
        this.outputText(
            "Wandering towards the bar, you notice an unusual commotion; there are a lot more people hanging around here than is usual for the time of day.  Feeling curious, you go over to investigate, and ask a bystander what all of this is about."
        );
        this.outputText(
    ...
    private yesToLoppeMeetingTwo(): void {
        ...
        if (this.player.cor < 40)
            this.outputText(
                " as politely as possible. It felt nice to see a display like that here; makes it feel a little less like a wasteland of sex-mad monsters and a little more like home"
            );
        this.outputText(".");
    ...
    private sureBakeryWithLoppe(): void {
        ...
        this.outputText(
            "\n\nYou tell her that you aren't, you just didn't expect her to have such an appetite.  With a playful smile, you ask what other not-so-dainty secrets she's hiding; does she burp loudly to show she enjoyed her meal?  Loppe smiles mischievously, \"<i>Oh, my sweet " +
                this.player.mf("boy", "girl") +
                '...  When I get my hands on something I like, I eat it up whole...</i>"  Slowly, you feel a foot gently glide across your [legs].'
        );
        ...
        if (this.player.gems >= 30) {
            ...
            if (this.player.cor > 40)
                this.outputText(
                    "  A small voice inside wonders if she'd eat so extravagantly were she footing her own bill."
                );
            // remove 30 gems
            this.player.gems -= 30;
    ...
    private NoWayLoppe(): void {
        this.clearOutput();
        this.outputText(
            'Loppe lets out a breath she had obviously been holding in a bitter sigh, the ghost of the words, "<i>I knew it</i>" echoing faintly as she does so.  "<i>Well, I understand.  I just had to give it a try all the same.  It was nice talking to you, [name].  Might see you again, someday.  Sorry for wasting your time...</i>"'
        );
    ...
    private okayLoppeLetsGo(): void {
        ...
        this.outputText(
            '\n\n"<i>Hey, [name],</i>" she says quietly, "<i>you\'re really ' +
                this.player.mf("handsome", "beautiful") +
                ", y'know?  And kind... how about a quick stop at my place, before we say goodbye?</i>\""
        );
    ...
    private noLoppesHouse(): void {
        this.clearOutput();
        this.outputText(
            'Loppe gives a disappointed sigh, but smiles at you all the same.  "<i>I understand... if you ever feel like talking some more, you can find me in the gym.  I need to keep myself in tip-top shape for my dancing shows, after all.</i>"'
        );
    ...
    public loppeGenericMeetings(): void {
        this.clearOutput();
        this.outputText(
            "You decide to approach the bunny-girl.  Loppe smiles and wipes the sweat off her brow with the towel.  \"<i>Hey there, [name], nice seeing you around here.  So... do you want to do something?  Talk, maybe?  Or go to my place for a 'workout'?</i>\" she asks with a smirk."
        );
        // Appearance
        // Talk
        // Sex
    ...
    private talkWithLoppe(): void {
        this.clearOutput();
        this.outputText(
            "That 'workout' is going to have to be postponed; you have some questions."
        );
        this.outputText(
        ...
        if (
            this.flags[kFLAGS.TIMES_ASKED_LOPPE_ABOUT_LOPPE] > 0 &&
            this.flags[kFLAGS.LOPPE_TIMES_SEXED] > 0
        )
    ...
    private talkWithLoppeAboutLoppe(): void {
        this.clearOutput();
        this.outputText(
            "You tell the laquine that you're curious about her, that you'd like to know more about her: who she is, where she comes from, et cetera."
        );
    ...
    private askLoppeAboutChildren(): void {
        this.clearOutput();
        this.outputText(
            "You decide to ask Loppe for her thoughts on children.  Has she considered having any?"
        );
        this.outputText(
        ...
        if (this.flags[kFLAGS.EDRYN_NUMBER_OF_KIDS] + this.flags[kFLAGS.COTTON_KID_COUNT] > 0)
            this.outputText(
    ...
    private noOpinionOnLoppeArt(): void {
        this.clearOutput();
        this.outputText(
            'You decline to answer, waving the question off.  Loppe raises an eyebrow at that.  "<i>Haven\'t thought about it either, huh?</i>"'
        );
    ...
    private loppeIDontReallyWantKidsYouStupidTwat(): void {
        this.clearOutput();
        this.outputText(
            "You confess you aren't really a 'kids' person; you don't think you could ever envision yourself as a parent, especially in this crazy world."
        );
    ...
    private loppeIWantKidsSoonOkayCanWeFuck(): void {
        this.clearOutput();
        this.outputText(
            "With a faint smile, you declare that having children is definitely in your future.  You want to be a parent; all you need is to find somebody who feels similar to you."
        );
        ...
        this.outputText(
            "\n\nLoppe grins at you.  \"<i>Oh... I don't know.  I'm sure a " +
                this.player.mf("handsome", "beautiful") +
                " person like you has already drawn quite a few stares,</i>\" Loppe teases, batting her eyes at you.  \"<i>But, if the time is right, and you ask nicely... I'm pretty sure there's a certain bunny-girl around here who wouldn't mind...</i>\""
        );
    ...
    private gossipWithLoppe(): void {
        this.clearOutput();
        this.outputText(
            "You ask Loppe if she has any comments on the other residents of Tel'Adre.  The laquine smiles at you.  \"<i>It's not polite to pry into other people's lives, y'know?</i>\""
        );
        this.outputText(
    ...
    private gossipWithLoppeAboutUrta(): void {
        ...
        if (
            ...
            this.outputText(
                "\"<i>Ah, so you've met Watch Captain Urta?  She's famous around here, you know; people say she's a legendary bare-knuckle brawler and one of the toughest guards on the force.  The only problem is that she's not really that easy to approach... I guess she prefers to keep to herself.  Although she acts very friendly with that pretty centauress, Edryn.</i>\""
            );
            this.outputText(
            ...
            this.outputText(
                "Loppe smirks at you.  \"<i>I heard she's been getting along nicely with a certain outsider; you wouldn't happen to know anything about that, would you, [name]?</i>\""
            );
            // [It's Me] [No]
            this.menu();
        ...
        // (if LoppeUrtaKnowledge > 0)
            ...
            this.outputText(
                '"<i>Urta again, huh?</i>"  Loppe stares you, but her curious expression turns into one of smug triumph, like a cat that\'s caught a mouse.  "<i>So... she has a big horse-cock.  I\'m beginning to see a pattern here, sugar.   You like women with huge equine parts?  Is that why you hang out with me?  With Urta?</i>"'
            );
            this.menu();
    ...
    private noLoppeWhosFuckingUrta(): void {
        this.clearOutput();
        this.outputText(
            "You shake your head, claiming that you have no idea what she's talking about.  Loppe looks at you, then shrugs, clearly not caring if you don't have any gossip on the subject to share."
        );
        // end scene
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private playAlongWivLoppesesUrtaGossip(): void {
        this.clearOutput();
        this.outputText(
            "And... what would she do if, hypothetically, you <i>did</i> have a fetish for dickgirls ready to give a stallion an inferiority complex?"
        );
        this.outputText(
    ...
    private admitToLoppeThatYouLoveZeHorsecock(): void {
        this.clearOutput();
        this.outputText(
            "You look her in the eyes and tell her she's hit the nail on the head; you do have a fetish for chicks with dicks, and having a horsecock makes a dickgirl even sexier to you."
        );
        this.outputText(
    ...
    private dontLoppesHouse4Fucks(): void {
        this.clearOutput();
        this.outputText(
            "Loppe raspberries you.  \"<i>You tell me you love herms with big horse cocks and now you won't have sex with me?  You're one big tease, [name].</i>\""
        );
        this.outputText(
    ...
    private denyToLoppeThatYouLoveZeHorsecock(): void {
        this.clearOutput();
        this.outputText(
            "Not in the mood to play along with Loppe's little game, you simply state that your reasons are your own and will stay that way for now."
        );
        this.outputText(
    ...
    private gossipWithLoppeAboutScylla(): void {
        this.clearOutput();
        this.outputText(
            '"<i>The nun who likes sucking on dicks?</i>" Loppe asks you.  "<i>Yes, I\'ve run into her at the Wet Bitch.  She offered to blow me too.  I was tempted, y\'know?  She has those wonderful looking lips... nice big breasts too... but ultimately I wound up refusing.  It\'s just... not right.</i>"'
        );
        this.outputText(
    ...
    private gossipWithLoppeAboutHeckel(): void {
        this.clearOutput();
        this.outputText(
            "You ask if Loppe's ever had a run-in with a herm hyena who's usually running in the track at the gym."
        );
        this.outputText(
    ...
    private gossipWithLoppeAboutEdryn(): void {
        this.clearOutput();
        this.outputText(
            "\"<i>That pretty centauress watchwoman that hangs in the Wet Bitch when she's off duty?  Yes, it's no secret that she specializes in particular sorts of wetwork for those with... compatible endowments,</i>\" Loppe says, giving you a lecherous wink."
        );
    ...
    private gossipWithLoppeAboutLottie(): void {
        this.clearOutput();
        this.outputText(
            '"<i>That pig-girl that started hanging around the gym in the evenings?  I heard about her... I believe she wants to get fit,</i>" Loppe comments conversationally.'
        );
    ...
    private talkWithLoppeAboutWorking(): void {
        this.clearOutput();
        this.outputText(
            "Her curse naturally impacts her social life, but what about work?  How do she and her mother put food on the table?"
        );
        this.outputText(
    ...
    private chatWithLoppeAboutHerMom(): void {
        ...
        // req LoppeChat > 0
        this.outputText(
            'Loppe rubs her chin, deep in thought.  "<i>Where do I start?  I guess by saying that my mom is a super mom.  She raised me all on her own, and she\'s always had time for me, despite having to keep up with her job.  I love her very much.</i>"'
        );
        this.outputText(
        ...
        if (this.player.gender == 1)
            this.outputText(
                "  Well, from what Loppe's told you, Uma wouldn't be attracted to you anyway."
            );
        this.outputText(
        ...
        if (this.flags[kFLAGS.LOPPE_PC_MET_UMA] == 0) {
            ...
            this.outputText(
                "Loppe looks you over, thoughtful.  \"<i>To be honest... I don't think she would mind.  Want me to introduce you to her?  To become my 'official' " +
                    this.player.mf("boy", "girl") +
                    "friend?  I know I certainly wouldn't mind having a 'serious' relationship with a cutie like you.</i>\"  The dancer winks at you. \"<i>How about it Sugar, do you wanna go visit my mom?</i>\""
            );
        }
    ...
    private loppeSexChoice(bakery: boolean = false): void {
        ...
        if (this.flags[kFLAGS.LOPPE_TIMES_SEXED] == 0) {
            ...
            if (this.player.cor < 40)
                this.outputText(
                    "  You tell her they're quite nice... though privately you're curious what the interior looks like."
                );
            else
                this.outputText(
                    "  They don't seem to work very well - after all, <i>you're</i> here."
                );
            ...
            if (this.player.hasCock()) {
                if (this.player.smallestCockArea() <= this.loppeCapacity())
                    this.outputText(
                        "Pulling her onto your dick would result in some cowgirl fun, though you'd have to deal with her cock pointed right at you when she came.  "
                    );
                else
                    this.outputText(
                        "As good as it would feel to shove your [cock smallest] into her cunt, the nervous looks she's giving it tell you what her response would probably be.  "
                    );
            }
            // [(any cock)
            if (this.player.hasCock())
                this.outputText(
                    "You could just whip it out and ask what she thinks of it, compared to hers - it might lead to some cross words and crossed swords, though.  "
                );
            if (this.player.hasVagina())
                this.outputText(
                    "You could take her monster length vaginally, but if her libido is what she claims, you'll probably wind up quite stretched.  "
                );
            // [(boobs >= boobjob req)
            if (this.player.biggestTitSize() >= 5)
                this.outputText(
                    "Her hardening horsecock looks like it would fit between your [chest], an act likely to net you a messy demonstration of her enthusiasm.  "
                );
            this.outputText(
        ...
        // Repeat Intro (edited)
            ...
            // [(loppesexed)
            this.outputText(
                "  Just jerking that cock and squeezing it so hard her balls swell up when she comes, though, that might be fun.  It'd be interesting to see how big they can get."
            );
    ...
    private loppeRidesCocks(): void {
        ...
        this.outputText(
            "Looking over the hermaphroditic, horse-cocked bunny-girl, you contemplate your options.  You settle yourself "
        );
        // [(not centaur)]
        if (!this.player.isTaur())
            this.outputText(
                "on her bed, making yourself comfortable, and start suggestively stroking yourself"
            );
        // (centaur)
        else
            this.outputText(
                "cumbersomely on the floor, rolling over and spreading your hindlegs to expose yourself"
            );
        this.outputText(
        ...
        this.outputText(
            '\n\n"<i>I would love to, sugar!</i>"  Loppe gazes at your ' +
        ...
        this.outputText(
            ', rubbing gently.  "<i>Just sit back and leave everything in my capable hands, sugar.</i>"'
        );
        ...
        if (y >= 0) this.outputText("s");
        this.outputText(
            " nice and slick.  You gasp in pleasure and surprise as you feel Loppe's erect cock sidle up to yours, helping lube you with its leaking pre. Raising up your hips, you clumsily try to "
        );
        if (y < 0) this.outputText("slide your shaft against her");
        else this.outputText("pinion her shaft between your");
        this.outputText(
            " own, shivering from the sensation of your sensitive " +
                this.player.skin() +
                " against her proud horseflesh, already drooling even though you can plainly feel that it's only half-erect."
        );
        if (this.player.balls > 0)
            this.outputText(
                "  Your [balls] gently brush and rub against her own swollen cum-factories, and you can't wait to empty your overfilled sac into her waiting womb."
            );

        this.outputText(
            '\n\n"<i>Okay, that\'s enough foreplay!</i>" Loppe announces suddenly, eyeing your ' +
                this.cockDescript(x) +
                " with a hunger that you never expected to see on her face.  Loppe quickly straddles you, aligning it with her pussy"
        );
        if (y >= 0) this.outputText("; its neighbor is aimed for her tight rosebud");
        this.outputText(
            '.  "<i>Itadakimasu!</i>" Loppe says, licking her lips as she finally slides you home.'
        );
        ...
        this.outputText(
            ", yet squeezing you as tightly as a velvety vise.  In fact, she's gripping you so hard that you can't seem to push yourself any further into her depths; she's squeezing you much too tightly to move in or out, an outright amazing feat, if Loppe gets half as much action as she claims to."
        );
        ...
        if (y >= 0) this.outputText("s");
        this.outputText(
            " with happy squeals of pleasure and happiness, softly accompanied by the wet sounds of your coupling.  You gasp and cry, savoring every motion as she squeezes and wriggles, her inner walls rippling so deliciously around your cock"
        );
        if (y >= 0) this.outputText("s");
        this.outputText(
            ", stroking them in the most delicious way.  You thrust your hips, trying to slip deeper inside her, but still she's holding you at bay."
        );
        ...
        this.outputText(
            ".  The sensation borders on the thin line between pleasure and pain, and you can't help but moan into Loppe's kiss; you wrap your "
        );
        ...
        this.outputText(
            " back and hold her tight against you, her long horse-cock sandwiched between your bellies, smearing both of you with drooling precum, rivers of the stuff flowing out steadily with every thrust and grind the two of you make."
        );
        ...
        if (!this.player.isTaur()) {
            this.outputText(
                "<b>You realize that if you keep holding onto Loppe, you're going to end up with a face covered in herm-cum - if you act quickly, though, you can avoid the impromptu facial.  You could even turn her hose of a cock back on her.</b>"
            );
    ...
    private loppeRidesYouNoFaceJizz(): void {
        ...
        if (this.player.isTaur())
            ...
            this.outputText(
                "hand lunges forward and places itself underneath, fingers curling around as you push it further up, aiming it over your shoulder.  You can feel it throbbing like mad against your fingers, can feel the impressive bulge of semen as it distends her urethra and surges up towards her flared tip."
            );
        this.outputText(
            "  With an ululation of ecstasy, she literally explodes into orgasm, a great gout of cum visibly flying through the air with such force you can hear it splattering against the wall.  This is followed by a second eruption, then a third, a fourth... they just keep coming!  All the while, she bounces, moans, and writhes, her rapacious pussy gripping and squeezing"
        );
        if (y >= 0)
            this.outputText(
                " while her ass suckles on your second cock with just as much eagerness"
            );
        this.outputText(".");
    ...
    private loppeRidesPCCockFinal(): void {
        ...
        if (y >= 0 || this.player.hasVagina()) {
            ...
            if (y >= 0)
                this.outputText(
                    "your second " +
                        this.cockDescript(y) +
                        " just as easily pumps her perverted ass full of baby juice"
                );
            ...
            if (this.player.hasVagina()) {
                ...
                this.outputText(
                    " femcum onto the bed below you, forgotten during the act but not unsympathetic to her ministrations"
                );
            }
        }
        this.outputText(
            ".  You cry out as you cum long and hard, arching your back off of the bed in your pleasure before finishing and collapsing, gasping for breath as, above you, the laquine comes to her own climactic end."
        );
        ...
        this.outputText(
            this.multiCockDescriptLight() +
                " and slides down your body, pressing her soft, cum-slickened breasts against you.  You moan as the smooth curves of her chest press against [eachCock]; the cum-slick "
        );
        ...
        if (y < 0) this.outputText("s");
        this.outputText(
            " an involuntary shudder from you; the erotic stimulation sends blood pulsing back into your veins, and your shaft"
        );
        ...
        this.outputText(
            " the laquine on her nose, leaving you ready to be mounted by her once again."
        );
        ...
        if (this.player.minLust() <= 30 && this.player.lib <= 50)
            this.outputText(
                "; if I have to stop to tend to you after every coupling, I'll never get these empty"
            );
        this.outputText(
            ".</i>\"  She points with a smirk to her swollen balls.  Er... didn't she just blow her load? Her balls look at least as full as, if not fuller than, when you started, and they nearly slosh with eagerness to be rid of their cargo!"
        );
        ...
        if (y >= 0) this.outputText("s");
        this.outputText(
            " once more.  You moan as once again you follow the lusty dickgirl into the throes of pleasure..."
        );

        this.outputText("\n\n<b>One hour and several orgasms later...</b>");

        this.outputText(
            '\n\n"<i>Thanks, sugar.  You\'re the best!  I feel completely satisfied!</i>" Loppe says, happily smiling and hugging you tightly.  As she snuggles up to you, you can feel the distinct bump of her gravid-looking belly rubbing against your ' +
                this.player.skin() +
                "; the cum-filled flesh deforms as the pressure pushes some of the skin-stretching load out of her nethers and further smears the proof of your pleasure on your entwined lower halves, but even so she still looks ready to pop with three or four kids.  You consider answering her, but find that you lack the will to do so... in fact, you lack the energy to do anything at all, Loppe having fucked you until you were shooting blanks"
        );
        // [(if high cum amount)]
        ...
        if (this.flags[kFLAGS.PC_FETISH] > 0)
            this.outputText(
                "; it gives you something of a thrill, though nowhere near as much as taking them off for her in the first place did"
            );
        this.outputText(".  Finished, you depart.");
        this.player.orgasm();
        this.dynStats("tou", 0.5, "lib", 0.5, "sen", -4);
    ...
    private loppeWorshipsDicks(): void {
        ...
        this.outputText(
            "As your eyes sweep over the naked half-breed's form, they focus on her equine masculinity, already standing proud and eager at the prospect of sex.  Distinctly aware of your own male appendage"
        );
        if (this.player.cockTotal() > 1) this.outputText("s");
        this.outputText(
            ", you conversationally ask Loppe what she thinks of your [cock biggest], an idea starting to form in your mind."
        );
    ...
    private getFuckedInYerTwatYaCunt(): void {
        ...
        this.outputText(
            "As you contemplate the delicious possibilities that the herm presents, your eyes are drawn to her admirable piece of horse-meat.  With a half-grin, you settle yourself on her bed, "
        );
        // [(mans)
        if (!this.player.isTaur())
            ...
            this.outputText(
                "exposing your rump and spreading your hind legs in your best effort to make her feel welcome."
            );
        ...
        if (this.player.vaginas[0].virgin) {
            ...
            if (this.player.cor < 50)
                ...
                this.outputText(
                    "  You do your best to warn her away from the topic with your eyes, eager to get on with the fuck."
                );
            // (not for horsez)
            if (!this.player.isTaur())
                this.outputText(
            ...
            this.outputText(
                ".  Would you be here, with your clothes off in Loppe's bed, if you weren't okay with it?"
            );
        ...
        if (this.player.vaginas[0].virgin)
            this.outputText(
                ", repressing a shiver of pain as she tears through your hymen, taking your virginity"
            );
        ...
        if (!this.player.isTaur())
            this.outputText(
                "  You wrap your [legs] around her hips as best you can, thrusting in your efforts to meet her strong rhythm, feeling your cunt rippling around her wonderfully long, thick horsecock."
            );
        ...
        if (!this.player.isTaur() && this.player.hasCock())
            this.outputText(
                ", giving you a quick peck on the cheek and licking a small gob of cum that seems to have stuck to your chin"
            );
        this.outputText(".");
        ...
        if (this.player.cor < 50)
            this.outputText(
                "a pleading look... and if there's maybe a trace of horror dancing in the depths of your eyes, well, that's understandable, isn't it?"
            );
        else
            this.outputText(
                "an incendiary glare, letting her know just what you think of her posturing."
            );
        this.outputText(
            '  Loppe bursts out laughing.  "<i>Just kidding, sugar.  If we go another round I think my dick might fall off.</i>"'
        );
        ...
        this.outputText(
            '  Your lover laughs, "<i>Okay, you got me there... but, anyway, I have some chores to run for my mom, so I guess I\'ll see you later?</i>"'
        );
    ...
    private getButtFuckedNonHoarseByLoppe(): void {
        ...
        if (this.player.hasCock())
            this.outputText(
                "One of her hands reaches around to grasp your pre-slickned [cock biggest], stroking you in time with her thrusts.  "
            );
        if (this.player.gender == 2)
            this.outputText(
                "One of her hands reaches around to tease your dripping [vagina] and erect [clit], dipping a finger in every time she bottoms out.  "
            );
        this.outputText(
            "Wet slapping noises fill the room, and you gasp in pleasure each time her cum-churning balls slap against "
        );
        if (this.player.balls > 0) this.outputText("yours");
        else this.outputText("your [butt]");
        this.outputText(
            ".  Loppe lays down on top of you, panting hotly on your neck, moaning in pleasure each time your sphincter contracts."
        );
        ...
        if (this.flags[kFLAGS.SATYR_KIDS] > 0)
            this.outputText(
                "You laugh softly; hopefully she'll never have to meet the creature that dispelled that same doubt in you.  "
            );
        this.outputText(
            '"<i>I think this is time for sleeping, not joking.</i>"  With a trace of wounded dignity, she lays herself down and curls into your back, one arm wrapped around your gurgling belly.'
        );
        ...
        if (this.flags[kFLAGS.LOPPE_TIMES_SEXED] == 0) {
            this.outputText(
                "Loppe laughs nervously.  \"<i>Sorry about that.  It's just that I usually can't bag a real cutie like you, and I think I might have gone a bit overboard... is there anyway I can make it up to you?</i>\""
            );
    ...
    private getAssFuckedByLoppeAsACentaur(): void {
        ...
        this.outputText(
            "You swallow as your eyes are drawn to the equine sausage jutting out between the bunny-girl's legs, and know you just have to have it.  But is she confident in her ability, even with your shape?"
        );
        ...
        if (this.player.ass.analWetness > 0)
            this.outputText(
                "  She doesn't even have to bother with lube; your ass is wet enough to accommodate her on its own."
            );
        ...
        if (this.player.hasCock())
            this.outputText(
                ", feeling your erect [cock] press against your underbelly, mashed between your centaur half and the soft carpet of Loppe's room.  You hope she doesn't mind a few stains...  "
            );
        // (else vag)
        else if (this.player.hasVagina())
            this.outputText(
                "; your cunt is sopping, making a small pool of juices one the floor.  "
            );
        else this.outputText(".  ");
        this.outputText(
            'She seems more worked up than usual, perhaps because you have a horse-like lower body?  "<i>Are your instincts acting up?</i>" you tease her.  "<i>Or do you just love ass that much?</i>"'
        );
        ...
        if (this.player.hasCock())
            this.outputText(
                "  The bumps against your prostate send waves of pleasure running through [eachCock] and spreading along your body, until they reach your throat and come out as a ragged groan.  "
            );
        ...
        if (this.player.hasCock())
            this.outputText(
                "  [EachCock] spasms and unloads beneath you, smearing you and the carpet below and pooling thickly with fluid forced out by the prostate stimulation."
            );
        if (this.player.hasVagina())
            this.outputText(
                "  Your vagina contracts, trying to grip at a phantom member as you spill your fluids on the carpet beneath you."
            );
        ...
        if (this.player.cockThatFits(this.loppeCapacity()) >= 0)
            this.outputText(
                'Though I hope you won\'t mind riding me, sometime,</i>" she laughs.  "<i>'
            );
        this.outputText(
            "How about another round, hmm?  Big strong 'taur like you should certainly be able to hold a little more loving inside of you, right?</i>\"  She croons happily, running her hands up and down your ass as if trying to entice you."
        );
        ...
        this.outputText(
            '\n\n"<i>[name]?  [name], are you... oh.</i>"  Loppe smiles as she sees you\'ve dozed off.  Quietly she slips away to the bed and pulls off her blanket, moving around to carefully seat herself against your bloated stomach, draping her blanket over the both of you and gently resting her head on your distended horse-gut.  "<i>Sweet dreams, lover-' +
                this.player.mf("boy", "girl") +
                ',</i>" she stage-whispers to you, then closes her eyes, just as eager for some rest, listening to the gurgling of your flooded stomach as she drifts off.'
        );
        ...
        this.outputText(
            "  Anyway, your clothes are back in my room; sorry to fuck and run, but I've got some errands to run before mom gets home - you'll have to see yourself out, okay?</i>\""
        );
    ...
    private loppeSqueezedickWhateverThatIs(): void {
        ...
        if (this.flags[kFLAGS.LOPPE_DENIAL_COUNTER] == 0) {
            this.outputText(
                "After seeing Loppe's prodigious output, you wonder how she would handle not being able to orgasm."
            );
        ...
        if (this.player.cor < 50) {
            this.outputText(
                "  You loosen your grip; this was supposed to be pleasurable, not painful, so it's definitely time to stop."
            );
            // Goto [Let Go]
            this.menu();
        ...
        // (High Corruption, no new pg)
            ...
            this.outputText(
                "  You suppose you could let her go... on the other hand, it might be fun to see just how big she'll get if you keep holding her in."
            );
            this.menu();
            this.addButton(0, "Let Go", this.letsLoppeGoCum);
            this.addButton(1, "Hold", this.superLoppeOrgasmDenialGo);
    ...
    private superLoppeOrgasmDenialGo(): void {
        ...
        this.outputText(
            "For fear of not being able to hold her back anymore, you return both hands to tightly gripping her shaft.  Tears escape Loppe's eyes as she's denied yet again.  \"<i>Stop...</i>\" she says meekly."
        );
    ...
    private boobjobLoppe(): void {
        ...
        this.outputText(
            "You contemplate your options, unthinkingly rubbing your breasts.  As you do so, you notice your lover is observing your hands very keenly.  With a grin, you grope your tits and ask if Loppe likes your display."
        );
        ...
        this.outputText(
            "\n\nEmboldened, you clasp your breasts firmer together and start to rise and fall, slowly scraping your " +
                this.player.skin() +
                " up and down the half-breed's prick.  It feels so hot and firm against your chest, growing increasingly damp as Loppe oozes gouts as voluminous as the cumshots of ordinary men, making your breasts and her prick alike equally slippery and enabling you to stroke her faster and faster. \"<i>K-keep that up and I'm gonna shoot anytime,</i>\" Loppe groans, trying to hump into your cleavage."
        );
        ...
        if (
            (this.player.str < 50 && !this.player.isTaur()) ||
            (this.player.str < 30 && this.player.isTaur())
        ) {
            this.outputText(
                "  Struggle as you may, you're powerless to stop the drooling laquine as she sends you crashing down on her bed.  The whole piece of furniture shakes ominously with the force of your impact, and for a moment you think it will break apart."
            );
            this.outputText(
            ...
            if (this.player.tongueType > TONUGE_HUMAN)
                this.outputText(
                    "looping your inhuman tongue around it and stroking for extra stimulus even while "
                );
            this.outputText(
                'grabbing your breasts and squeezing the horsemeat between them.  The sooner you help her get over this frenzy, the sooner she\'ll get off of you... hopefully.  "<i>Ah, sugar!  I knew you liked it rough!</i>" your suddenly forceful lover shouts, ominously.'
            );
            ...
            this.outputText(
                '.  You simply nod and groan, hands cradling your distended gut.  Loppe snuggles up against you, rubbing your bloated midriff.  "<i>Sorry about that... hmm, how about we just cuddle and rest?</i>"'
            );
            ...
            this.outputText(
                '  You hold the laquine\'s arms and force her onto the floor; she lands with an audible "<i>oomph</i>" and you grin as you hold the eager herm down.'
            );
            ...
            this.outputText(
                "\n\nLooking at your own " +
                    ...
                    ", now off-white from the glazing she's given you inadvertently, you concede the point to yourself.  Still..."
            );
            ...
            if (this.player.cor >= 60)
                this.outputText(
                    "You don't really feel like it, but you figure you had better humor the greedy herm if you want to keep fucking her whenever you like.  "
                );
            this.outputText(
                'Oh, well... you reach down and heft the surprised hybrid off of the floor and onto her spattered bed, then slide yourself into it as best you can, wrapping your arms around her.  She hugs you back, then yawning widely.  "<i>Naptime...</i>"'
            );
            this.outputText(
        ...
        if (
            ...
            this.outputText(
                "- while your stomach is still heavily swollen and gurgles in protest, it's not bad enough to impair you - "
            );
        this.outputText(
            "before going over and dressing yourself.  Loppe waves goodbye to you as you head out once again."
        );
    ...
    private beATeaseAndLeaveLoppeAfterSexInvite(): void {
        ...
        this.outputText(
            "Despite the hybrid beauty standing stark naked before you, you decide that you aren't in the mood after all."
        );
    ...
    private fondleAndTease(output: boolean = true): void {
        if (output) {
            this.clearOutput();
            this.outputText(
                'You lean in over the table and tell Loppe you\'d like to talk about her.  She looks vaguely confused.  "<i>Well, I already told you about everything I can think of.  Was there something you wanted to explore in more detail?</i>"'
            );
    ...
    private teaseLoppeNHJ(): void {
        this.clearOutput();
        this.outputText(
            'You know exactly how to help her with her problem.  Loppe looks at you and gives a quizzical little smile.  "<i>Uh... yeah, I kind of know how you can help me too.  Why do you say that?</i>" She asks, clearly baffled and obviously expecting you to lead her out of the cafe and back to her place for some quick nookie.'
        );
        this.outputText(
    ...
    private teaseLoppeNSuck(): void {
        this.clearOutput();
        this.outputText(
            'You lean over the table and give the laquine a kiss.  Confused, but not displeased, Loppe eagerly returns it, then watches as you break the lip lock and start to slide yourself under the table.  "<i>Umm... sugar?  What are you doing?</i>"'
        );
        ...
        this.outputText(
            ".  You suckle gently, letting the salty tang of hot spunk wash over your tastebuds, and then start to gulp and swallow your way down her prick's sizable length."
        );
    ...
    private teaseLoppeKissRun(): void {
        ...
        this.dynStats("lus", 5 + this.player.lib / 20, "cor", 0.5);
        this.doNext(this.camp.returnToCampUseOneHour);
    }
}
