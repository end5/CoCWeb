...
export class Loppe extends TelAdreAbstractContent {
    ...
    */
    ...
    private noLoppeInterest(): void {
        this.clearOutput();
        this.outx("Dancers aren't really your thing, and you shake your head.");
    ...
    private mebbeLaterToLoppe(): void {
        this.clearOutput();
        this.outx("You're not really in the mood for this right now, so you leave the bar.");
    ...
    private yesToMeetingLoppe(): void {
        ...
        this.outx("There's no harm in staying a while...");
    ...
    private yesToLoppeMeetingTwo(): void {
        ...
        this.outx(this.images.showImage("loppe-show-at-bar"));
        this.outx(
    ...
    private notReallyInterestedInLoppe(): void {
        this.clearOutput();
        this.outx("You decline, and the girl gives you a look of disappointment.");
        this.outx(
    ...
    private talkWithLoppe(): void {
        this.clearOutput();
        this.outx("That 'workout' is going to have to be postponed; you have some questions.");
        this.outx(
    ...
    private chatWithLoppeAboutLoppesVillage(): void {
        this.clearOutput();
        this.outx("You ask if Loppe would be willing to tell you about her village.");
        this.outx(
    ...
    private loppeSexChoice(bakery = false): void {
        ...
        if (this.flags[kFLAGS.LOPPE_TIMES_SEXED] == 0) {
            ...
            if (!bakery) {
                this.outx("That 'workout' seems like a nice option right now.");
                this.outx(
                ...
                // (else)
                    ...
                    // [(lib>40)]
                    if (this.player.lib >= 40) this.outx(".. it almost sounds exciting.");
                }
                this.outx(
            ...
            else this.outx("  They don't seem to work very well - after all, <i>you're</i> here.");
        ...
        // Repeat Intro (edited)
            ...
            this.outx("Loppe's other 'workout' sounds pretty good right now.");
            this.outx(
    ...
    private loppeRidesCocks(): void {
        this.clearOutput();
        this.outx(this.images.showImage("loppe-rides-your-cocks"));
        this.outx(
        ...
        if (y >= 0 && this.player.cockTotal() == 2)
            this.outx('  "<i>In fact... I could just eat both of those up.</i>"');
        // (3+ fit cocks)
        else if (y >= 0 && this.player.cockTotal() == 3)
            this.outx("  \"<i>But I'm afraid I'll only be able to handle two of them.</i>\"");
        ...
        if (y >= 0) this.outx("; its neighbor is aimed for her tight rosebud");
        this.outx(
        ...
        if (y >= 0) this.outx(" and watertight ass");
        this.outx(
        ...
        if (this.player.isDrider()) this.outx("spindly legs");
        else if (this.player.isTaur()) this.outx("forelegs");
        else this.outx("arms");
        this.outx(" around the bunny-girl's ");
        if (this.flags[kFLAGS.LOPPE_FURRY] == 0) this.outx("silky-smooth");
        else this.outx("softly furred");
        this.outx(
    ...
    private loppeRidesYouNoFaceJizz(): void {
        ...
        if (this.player.isTaur())
            this.outx("foreleg tucks under her cock, angling it away from your body.");
        else
            this.outx(
        ...
        if (y >= 0)
            this.outx(" while her ass suckles on your second cock with just as much eagerness");
        this.outx(".");
    ...
    private loppeRidesYouSpunksInYourEye(): void {
        ...
        this.outx("You keep your ");
        if (this.player.isDrider()) this.outx("legs");
        else this.outx("arms");
        this.outx(
    ...
    private loppeRidesYouHoseHer(): void {
        ...
        if (this.player.cockTotal() > 1) this.outx("s");
        this.outx(" until you can't help it and cum yourself.");
        this.loppeRidesPCCockFinal();
    }
    ...
    private loppeRidesPCCockFinal(): void {
        ...
        this.outx(this.images.showImage("loppe-rides-your-cock"));
        ...
        if (y >= 0 || this.player.hasVagina()) {
            ...
            if (y >= 0 && this.player.hasVagina()) this.outx(" and ");
            if (this.player.hasVagina()) {
                this.outx("your [vagina] ");
                if (this.player.wetness() < 3) this.outx("drizzles");
                else if (this.player.wetness() < 5) this.outx("spatters");
                else this.outx("gushes");
                this.outx(
        ...
        if (this.player.isDrider() || this.player.isTaur()) this.outx("forelegs");
        else this.outx("arms");
        this.outx(
        ...
        if (y >= 0) this.outx("s rise");
        else this.outx(" rises");
        this.outx(" to full mast again, so swiftly ");
        if (y < 0) this.outx("it almost smacks");
        else this.outx("they almost smack");
        this.outx(" the laquine on her nose, leaving you ready to be mounted by her once again.");
    ...
    private loppeWorshipsDicks(): void {
        this.clearOutput();
        this.outx(this.images.showImage("loppe-worships-your-cock"));
        this.outx(
        ...
        if (this.player.biggestCockArea() <= 17.5) {
            ...
            if (this.player.biggestCockArea() > this.loppeCapacity())
                this.outx("even if it does look too big to fit.");
            else this.outx("or maybe I should get a taste first?");
            this.outx('</i>"  She licks her lips.');
        }
        this.outx(
        ...
        if (this.flags[kFLAGS.LOPPE_FURRY] > 0) this.outx("fluffy ");
        this.outx("cleavage; her ");
        if (this.flags[kFLAGS.LOPPE_FURRY] == 0) this.outx("skin");
        else this.outx("fur");
        this.outx(
        ...
        if (this.player.lib >= 40)
            this.outx(" - nor would you want to; she looks just right covered in your fluids");
        this.outx(".");
        ...
        if (this.player.balls > 0) this.outx(" and balls to balls");
        this.outx(", the delicious friction pushing you over the edge.");
    ...
    private getFuckedInYerTwatYaCunt(): void {
        this.clearOutput();
        this.outx(this.images.showImage("loppe-sticks-it-in-your-vagoo"));
        this.outx(
        ...
        // [(mans)
        if (!this.player.isTaur())
            this.outx("spreading your labia in an invitation that needs no words.");
        else
            this.outx(
        ...
        // [(femininity <= 40)
        if (this.player.femininity > 50) this.outx("princess.  A sexy, smoking hot princess");
        else this.outx("prince.  A dashing, dandy prince");
        this.outx(
        ...
        if (this.player.vaginas[0].virgin) {
            ...
            if (this.player.cor < 50)
                this.outx("  You look coy, for her benefit, and cast your eyes down shyly.");
            else
                this.outx(
            ...
            this.outx("\n\nYou reach out ");
            if (this.player.cor < 50) this.outx("and tap her playfully on the nose");
            else this.outx("in your irritation and squeeze her face imploringly");
            this.outx(
        ...
        if (this.player.vaginalCapacity() >= 35)
            this.outx(" bottoms out, completely hilted inside you");
        // [else:
        else this.outx(" bumps against your cervix");
        this.outx(". You moan in delight as she sinks into you");
        if (this.player.vaginas[0].virgin)
            this.outx(
                ", repressing a shiver of pain as she tears through your hymen, taking your virginity"
            );
        else if (this.player.vaginalCapacity() < 35)
            this.outx(", forcing your entrance wide to accommodate herself");
        this.outx(".");
        ...
        if (!this.player.isTaur()) {
            ...
            if (this.player.gender >= 3) this.outx(" and smearing both your bellies with herm-pre");
            this.outx(".");
        }
        // Centaur:
        else {
        ...
        if (this.player.hasCock()) {
            this.outx(", neglected cock fountaining cum ");
            if (this.player.cumQ() < 500) this.outx("between you and painting you both");
            else this.outx("gushing onto the bedsheets and smearing your belly");
            this.outx(" with this aspect of your dual-sexed orgasm");
        }
        this.outx(".");
        ...
        if (this.silly()) this.outx('  "<i>Da! Sandvich is kredit to team!</i>"');
        ...
        if (this.player.lib >= 50 || this.player.minLust() >= 30)
            this.outx("  Not that you didn't just titillate yourself thinking of it...");
        this.outx(
    ...
    private getButtFuckedNonHoarseByLoppe(): void {
        this.clearOutput();
        this.outx(this.images.showImage("loppe-sticks-it-in-your-butt"));
        this.outx(
        ...
        if (this.player.hasCock()) {
            this.outx(", cock");
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(" dripping pre");
            if (this.player.hasVagina()) this.outx(" and");
        } else if (this.player.hasVagina()) this.outx(", ");
        if (this.player.hasVagina()) this.outx(" pussy oozing femlube");
        this.outx("... you beg her to go faster, to do it harder!");
        ...
        if (this.player.balls > 0) this.outx("yours");
        ...
        if (this.player.hasVagina()) {
            this.outx("  A gush of sexual fluids from your crotch ");
            if (this.player.wetness() < 3) this.outx("spatters");
            else if (this.player.wetness() < 4) this.outx("splashes");
            else if (this.player.wetness() < 5) this.outx("drenches");
            else this.outx("completely soaks");
            this.outx(" the bed-linen under you.");
        }
    ...
    private getAssFuckedByLoppeAsACentaur(): void {
        this.clearOutput();
        this.outx(this.images.showImage("loppe-sticks-it-in-your-butt-you-centaur"));
        this.outx(
        ...
        if (this.player.balls > 0) this.outx("rs");
        else if (this.player.hasVagina()) this.outx("r pussy");
        this.outx(".");
        ...
        // (else vag)
            ...
            this.outx("; your cunt is sopping, making a small pool of juices one the floor.  ");
        else this.outx(".  ");
        this.outx(
        ...
        if (this.player.gender <= 1)
            this.outx("  Even if you are the wrong sex entirely for that.");
        ...
        this.outx("If she keeps this up for too much longer, you will pop any moment now...");
        ...
        if (this.player.skinType != SKIN_TYPE_SCALES)
            this.outx(" have goosebumps all over your body");
        else this.outx("r scales are practically standing on end");
        this.outx(".");

        this.outx('\n\n"<i>Ohhh... you are incredible, [name].  ');
        // [PC has dick that fits)
        if (this.player.cockThatFits(this.loppeCapacity()) >= 0)
            this.outx('Though I hope you won\'t mind riding me, sometime,</i>" she laughs.  "<i>');
        this.outx(
    ...
    private loppeSqueezedickWhateverThatIs(): void {
        this.clearOutput();
        this.outx(this.images.showImage("loppe-orgazm-denial"));
        // (if LoppeDenial == 0)
        ...
        if (!this.player.isTaur()) this.outx("on");
        else this.outx("beside");
        this.outx(
    ...
    private letsLoppeGoCum(): void {
        this.clearOutput();
        this.outx(this.images.showImage("loppe-comes-after-orgasm-denial"));
        this.outx(
    ...
    private superLoppeOrgasmDenialGo(): void {
        this.clearOutput();
        this.outx(this.images.showImage("loppe-comes-after-moar-orgasm-denial"));
        this.outx(
        ...
        this.outx('\n\n"<i>Bye, sugar!');
        if (this.player.hasCock())
            this.outx("  Maybe next time I'll be the one to give you a bit of a holdout!");
        this.outx('</i>"');
    ...
    private boobjobLoppe(): void {
        this.clearOutput();
        this.outx(this.images.showImage("loppe-give-her-a-titty-fuck"));
        this.outx(
        ...
        if (this.player.tongueType >= TONUGE_DEMONIC)
            this.outx("retract your tongue into your mouth and ");
        this.outx(
        ...
        if (
            ...
            if (this.silly()) this.outx(".  You can't help but think of Family Matters");
            this.outx(
    ...
    private beATeaseAndLeaveLoppeAfterSexInvite(): void {
        this.clearOutput();
        this.outx(this.images.showImage("loppe-teaze-and-leave"));
        this.outx(
    ...
    private teaseLoppeNSuck(): void {
        ...
        if (this.player.tongueType > TONUGE_HUMAN)
            this.outx(", inhumanly long tongue looping out to coil wetly around the length");
        this.outx(
