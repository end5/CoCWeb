...
export class Scylla extends TelAdreAbstractContent {
    ...
    public talkToScylla(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-first-meeting"), false);
        this.outx(
        ...
        this.outx("You're pretty sure you know what the demon drink did to Scylla.\n\n", false);
    ...
    private helpScylla(): void {
        ...
        this.outx("", true);
        this.outx(this.images.showImage("scylla-first-help"), false);
        this.outx(
        ...
        if (this.player.balls > 0) this.outx(" and you feel your balls tightening");
        this.outx(
    ...
    private scyllaRoundIIPartII(): void {
        ...
        this.outx("Without a release, the two of you are sealed, face to groin.\n\n", false);
    ...
    private scyllaRoundIIPartIII(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-two-part-three"), false);
    ...
    public scyllaRoundThreeCUM(): void {
        this.scyllaSprite();
        this.clearOutput();
        this.outx(this.images.showImage("scylla-help-round-two-jizz"), false);
        this.flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA]++;
        // Standard
    ...
    private scyllaLevelIIIRoundIIIFIGHT(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-three"), false);
        // [one dick]-
        ...
        // [two dicks]-
            ...
            if (this.player.cockTotal() > 2) this.outx("two ");
            else this.outx("both ");
            this.outx(
    ...
    public scyllaRoundIVGo(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-four"), false);
        this.flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA]++;
        this.outx(
    ...
    private scyllaRoundIVPtIII(): void {
        ...
        this.hideUpDown();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-four-pt-three"), false);
        this.outx(
    ...
    private scyllaPtVFirstTime(): void {
        ...
        // (First time)
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-firt-time"), false);
        this.outx(
    ...
    private scyllaPtVFirstTimeII(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-firt-time-pt-two"), false);
        this.outx(
    ...
    private scyllaPtVTakeAdvantage(): void {
        ...
        this.flags[kFLAGS.TIMES_SCYLLA_ADDICT_GROUP_EXPLOITED]++;
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-take-advantage"), false);
        // [Corruption up]
        this.dynStats("cor", 1);
    ...
    private scyllaPtVShare(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-share"), false);
        // FIRST TIEM
        ...
        this.flags[kFLAGS.TIMES_MET_SCYLLA_IN_ADDICTION_GROUP]++;
        this.outx("What addiction would you like to discuss?");
        // Set choices
        let milk;
        if (
    ...
    private scyllaPtVMilk(): void {
        ...
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-with-milk-one"), false);
        this.outx(
    ...
    private scyllaPtVMilkII(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-with-milk-two"), false);
        this.outx(
    ...
    private scyllaPtVMilkIII(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-with-milk-three"), false);
        this.outx(
    ...
    private scyllaPtVMilkV(): void {
        this.outx(this.images.showImage("scylla-help-round-five-with-milk-five"), false);
        this.scyllaSprite();
        this.outx("", true);
        this.outx(
    ...
    private scyllaPtVCum(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-jizz-pt-one"), false);
    ...
    private scyllaPtVCumII(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-jizz-pt-two"), false);
        const x: number = this.player.biggestCockIndex();
        this.outx(
    ...
    private scyllaPtVCumIV(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-jizz-pt-four"), false);
        const x: number = this.player.biggestCockIndex();
        // [2 DICKS]
        if (this.player.totalCocks() >= 2) {
            if (this.player.balls > 0)
    ...
    private scyllaPtVCumV(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-jizz-pt-five"), false);
        // [Sensitivity down ]
    ...
    private scyllaPtVSex(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-sex-pt-one"), false);
    ...
    private scyllaPtVSexIII(): void {
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-sex-pt-three"), false);
        this.scyllaSprite();
        const x: number = this.player.biggestCockIndex();
        this.outx(
    ...
    private scyllaPtVSexIV(): void {
        this.scyllaSprite();
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-sex-pt-four"), false);
        this.outx(
    ...
    private addictionAdvantageMultiDickGreatTimeParty(): void {
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-multi-cock-one"), false);
        this.scyllaSprite();
        // [First time]
    ...
    private addictionScyllaTakeAdvantageDicksIII(): void {
        this.outx("", true);
        this.outx(this.images.showImage("scylla-help-round-five-multi-cock-three"), false);
        this.scyllaSprite();
        this.outx(
    ...
    private shareTentaclesWithScylla(): void {
        this.clearOutput();
        this.outx(this.images.showImage("scylla-share-tentacle-addiction-one"), false);
        this.outx(
    ...
    private shareTentaclesWithScylla2(): void {
        this.clearOutput();
        this.outx(this.images.showImage("scylla-share-tentacle-addiction-two"), false);
        // [Two Tentacles:
    ...
    private shareTentaclesWithScylla3(): void {
        this.clearOutput();
        this.outx(this.images.showImage("scylla-share-tentacle-addiction-three"), false);
        this.outx(
    ...
    public scyllasFlyingSolo(): void {
        ...
        this.outx(this.images.showImage("scylla-feed-bar-intro"), false);
    ...
    private feedScyllaSomeJizzDatJunkieNeedsIt(): void {
        this.clearOutput();
        this.outx(this.images.showImage("scylla-feed-jizz-solo-one"), false);
        this.scyllaSprite();
    ...
    private feedingScyllaCumStepTwo(): void {
        this.clearOutput();
        this.outx(this.images.showImage("scylla-feed-jizz-solo-two"), false);
        this.scyllaSprite();
        if (this.flags[kFLAGS.TIMES_SOLO_FED_NUN] == 1) {
            this.outx(
            ...
            if (this.player.balls > 0) {
                ...
                if (this.player.balls == 2) this.outx("twin");
                else if (this.player.balls == 4) this.outx("fourfold");
                else this.outx("many");
                this.outx(" deities hung from your loins.");
            }
            this.outx(
    ...
    private cumFeedScyllaShesACoolGirl(): void {
        ...
        this.scyllaSprite();
        this.clearOutput();
        this.outx(this.images.showImage("scylla-feed-jizz-solo-three"), false);
        if (this.flags[kFLAGS.TIMES_SOLO_FED_NUN] == 1) {
    ...
    public openTheDoorToFoursomeWivScyllaAndFurries(): void {
        ...
        if (this.flags[kFLAGS.SCYLLA_FURRY_FOURSOME_COUNT] == 0)
            this.outx("busts her nuts like a champ.");
        else if (this.flags[kFLAGS.SCYLLA_FURRY_FOURSOME_COUNT] <= 1)
            this.outx("fills condoms like some kind of balloon-making machine.");
        else if (this.flags[kFLAGS.SCYLLA_FURRY_FOURSOME_COUNT] <= 2)
            this.outx("busts condoms just about every other orgasm now.");
        else if (this.flags[kFLAGS.SCYLLA_FURRY_FOURSOME_COUNT] <= 3)
            this.outx("busts condoms if she even thinks about using ‘em.");
        else
            this.outx(
        ...
        if (this.player.biggestCockLength() <= 12) this.outx("a foot");
        else if (this.player.biggestCockLength() < 24) this.outx("over a foot");
        else this.outx("a few feet");
        this.outx(" of cock choking off her throat.");
        this.outx(
        ...
        if (this.player.cockTotal() > 1) {
            this.outx(" It’s nowhere near as strange as the fact that your other ");
            if (this.player.cockTotal() == 2) this.outx("dick goes");
            else this.outx("dicks go");
            this.outx(" limp, seemingly unable to waste a single drop of your viscous release.");
        }
        this.outx(
        ...
        if (this.player.lib >= 80 || this.player.minLust() > 50)
            this.outx("slapping into your belly, still hard but spent");
        else this.outx("starting to go limp");
        this.outx(
