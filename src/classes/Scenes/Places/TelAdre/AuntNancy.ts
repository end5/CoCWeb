...
export class AuntNancy extends TelAdreAbstractContent {
    ...
    public auntNancy(display = true): boolean {
        if (this.model.time.hours >= 6 && this.model.time.hours <= 14) {
            if (display) {
                ...
                // [If MetNancy = 0]
                if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00263] == 0) this.outx("  She");
                else this.outx("  Aunt Nancy");
                this.outx(" glances up at you and smiles as you enter");
                // [(if unmet)
    ...
    public interactWithAuntNancy(): void {
        ...
        if (
            ...
            this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00266] == 0
        ) {
            this.outx(
                "As you enter the bar, looking forward to spending some time with Aunt Nancy, you see that she is cleaning up and getting ready to leave.  She spots you with one of her eyes and smiles, waving you closer with a single hand as the other three set glasses under the bar.\n\n",
                false
            );

            this.outx(
                '"<i>Afternoon, friend!</i>" she says, cheerily.  "<i>You\'ve certainly been coming in a lot, and I can\'t say I don\'t appreciate your company.</i>"  Aunt Nancy looks you over a little, smiling a little more wistfully and melancholically now.  "<i>You remind me a little of my husband,</i>" she admits, finishing up and skittering out from behind the bar on her many legs as the afternoon shift bartender takes her place.  "<i>It\'s... nothing I can put my finger on.  Just, you have a certain... <b>quality</b> to you.</i>"\n\n',
                false
            );
        ...
        // [If Time >= 1400 - (100*(Relationship with Aunt Nancy/30), Relationship with Aunt Nancy >= 30, and PillowTalk= 1]
            ...
            this.outx(
                "Aunt Nancy looks up as you walk over to her, and her eyes light up.  Happily, she greets you with a prim little hand atop yours, a bit of evidence of the intimacy you've shared.\n\n",
                false
            );
    ...
    private strongStuff(): void {
        ...
        this.outx(
            "You ask for a strong drink anyway, and Aunt Nancy nods.  Easily, she picks up a glass with one hand, reaches out with another two, and fills it with something greenish.\n\n",
            false
        );

        this.outx(
            'The bartender sees your gaze and smiles.  "<i>Heavy mead,</i>" she explains, hefting it.  "<i>We make it from honeybee honey.  Have a taste, friend.</i>"\n\n',
            false
        );

        this.outx(
            "You pay a few gems and take a sip.  The alcohol burns a bit, but it tastes deliciously, achingly sweet, and before you know it the glass is empty.\n\n",
            false
        );
    ...
    private lightStuff(): void {
        ...
        this.player.gems -= 5;
        this.dynStats("tou", 0.5, "int", -0.5, "lus", 7);
        this.outx(
        ...
        this.outx(
            "Once she gives you the drink, you take a tentative sip, and find it very sweet and refreshing, without seeming very strong or alcoholic.  It's very good, and you quickly have another.",
            false
        );
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00265] == 0) {
            ...
            this.outx(
                '"<i>So,</i>" she says, settling one set of arms on the bar and supporting her head with the other, "<i>what\'s your story, friend?  You have a certain...</i>" Aunt Nancy waves with a hand. "<i>look about you.  Like my late husband, Marae send him to his reward.  You\'re an... adventurer, I take it?  You live off the land, fighting monsters for gems, scavenging all your equipment off what you can find or put together yourself?</i>"\n\n',
                false
            );

            this.outx(
                "You nod, hesitantly, remembering that here, at least, you're in no danger from demons.\n\n",
                false
            );
            ...
            */
            ...
            this.outx(
                "You tell her of some of your recent exploits in the demon realm.  Like most stories in this strange land, it ends up focusing on the strange, perverted sexuality of the monsters that dwell here, but she doesn't seem to mind.\n\n",
                false
            );

            this.outx(
                'The bartender listens, entranced, and reacts on all the right beats, her bosom bouncing on the particularly shocking ones.  When you\'re done, she smiles at you, and says, "<i>Well, that was quite a tale.  Let me tell you one...</i>"\n\n',
                false
            );

            this.outx(
                "Aunt Nancy pours herself a glass of the same drink you're having, and gulps down a long pull.\n\n",
                false
            );
            ...
            // [If PC is human:]
            if (this.player.humanScore() >= 4) this.outx("like you,");
            else this.outx("like poor little Yara at the earring shop,");
            this.outx(
                ' and, well, one thing led to another, and I ended up chasing him out into the wider world.</i>"\n\n',
                false
            );

            this.outx(
                'Aunt Nancy sighs, dreamily.  "<i>Oh, the adventures we had together, friend!  We\'d wrestle over ancient treasures, fight midst old ruins, argue over who actually finished off that omnibus, fuck like rabbits and then insist that the other one came first.</i>"  She seems to be staring off into midair, a wistful smile on her face.  "<i>Marae on earth, how I miss him.  It\'s been almost a decade now, since I last saw him.  Somedays, I still think he\'ll just... walk in here, with that cocky smile on his face and that shiny old magic sword over his shoulder and make a pun.</i>"\n\n',
                false
            );

            this.outx(
                'She takes another drink, melancholically, before shaking her head to clear it.  "<i>Well, thank you for sharing some time with an old widow like me.</i>"  She flutters her still-beautiful eyelashes at you once or twice, then chuckles.  "<i>Come back some time.</i>"\n\n',
                false
            );
    ...
    private declineAuntNancyMassage(): void {
        this.outx("", true);
        this.outx(
            'Aunt Nancy listens as you politely turn her down, and nods her head, the hungry look fading from her eyes.  "<i>I understand completely.  Sorry to have bothered you.</i>"  She starts to walk out of the bar, stops, and turns back to size you up again.  "<i>Of course,</i>" she says, "<i>if you ever change your mind... just come by whenever my shift\'s over.</i>"\n\n',
            false
        );
    ...
    private timeForAuntNancySpiderCooch(): void {
        this.outx("", true);
        this.outx(
            'You look the still-beautiful spider-lady in the eye, and, half-mesmerized, nod in agreement.  She smiles broadly (and, you can\'t help but notice, quite lewdly) and puts one of her lower arms through one of yours, while putting the upper one on your shoulder.  "<i>Well then,</i>" Aunt Nancy says, "<i>I suppose we should be off.</i>"\n\n',
            false
        );

        this.outx(
            "She leads you through the streets of Tel'Adre, weaving through crowds and back alleys, before you finally end up just outside a modest little adobe building tucked away in a side street.  Slowly, she wraps all four of her arms around you, giving you a gentle hug",
            false
        );
        if (this.player.biggestTitSize() >= 1)
            this.outx(
                " and taking the opportunity to grope your " +
        ...
        this.outx(
            '"<i>Come into my parlor,</i>" she whispers into your ear, licking it gently before sticking the tip of her long tongue into the hole before pressing her soft lips against the lobe of it.\n\n',
            false
        );
    ...
    private auntNancyPoonPartII(): void {
        this.outx("", true);
        this.outx(
            "Slowly, you follow Aunt Nancy into her home. Inside, the building is fairly dark and gloomy, even in the middle of the day, with thick curtains of unidentifiable white matter keeping most of the sun outside. Blinded, your vision still attuned to the bright desert, you can discern little of the house's insides before you hear a sudden skittering sound behind you and, as you turn to face it, are pushed further into the gloom. Your heel is caught by a thick strand of what feels like rope, and you fall flat onto your back, arms and legs splayed out to either side of you, as you land on some sort of taut net.\n\n",
            false
        );

        this.outx(
            "You try to climb back up, only to find that your flesh and " +
                this.player.armorName +
                " alike are caught fast against the adhesive matter of the net, which, you suddenly realize, is actually a thick web, spread across the house's floor. You feel a surge of panic and begin to pull and struggle, when suddenly you feel a smooth, cool hand on your face. Your night vision is beginning to recover, and you make out Aunt Nancy's face, her pale skin seeming to glow in the gloom, as she leans over you, staring into your eyes with hers, one finger trailing across your face before covering your lips in a gesture for quiet.\n\n",
            false
        );

        this.outx(
            "With her other three hands, the spider-lady lights a match and ignites a little lantern, which she raises to hang from the wall.  In the little area it illuminates, you can see that Aunt Nancy has removed her neck-less black dress, letting her impressive bosom bounce modestly as she works, and catch a glimpse of her unusual genitals before she turns to face you again.\n\n",
            false
        );
        ...
        else this.outx("question whether or not the spider-lady's kiss is responsible");
        this.outx(".\n\n", false);

        this.outx(
            "As you unwind at her touch, her many arms are working to strip away your " +
                this.player.armorName +
                ", gently peeling them away with care until you are naked and needy in the spider-lady's web.\n\n",
            false
        );

        this.outx(
            "You are soon hanging in utter relaxation, idly wondering whether the ongoing massage Aunt Nancy's many hands are still performing all over your " +
                this.chestDesc() +
                ", " +
                this.buttDescript() +
                ", back, and neck, or the loving, strange kiss of her lips and long, curling tongue is more responsible.  Ultimately, however, she pulls her white-haired head away from yours, and removes her many hands from your trunk.  Smiling at your sudden unhappy look, Aunt Nancy begins to kiss her way down your body, first along the curve of your neck, sliding her long, moist tongue against your chest as you shiver in pleasure at the sensation and pressing her soft lips against your " +
        ...
        this.outx(
            "Aunt Nancy licks her lips, a hungry look in her many eyes as she look down at you, clearly quite pleased by what she sees.\n\n",
            false
        );
        ...
        if (this.player.balls > 0) {
            ...
            if (this.player.ballSize < 15) {
                if (this.player.ballSize > 5 && this.player.ballSize < 15) this.outx("taking one");
                else this.outx("both of them");
                this.outx(
                    " into her mouth to soak in her saliva as she wraps and caresses ",
                    false
                );
                if (this.player.ballSize <= 5) this.outx("them");
                else this.outx("it");
                this.outx(" with her long, dextrous tongue.\n\n", false);
            } else
                this.outx(
                    "kissing and licking at them with those moist, relaxing lips.\n\n",
                    false
                );
        }
        ...
        if (this.player.hasCock()) {
            this.outx(
                "Aunt Nancy gently caresses your " +
                    ...
                    " with her smooth black hands, enjoying your moans of delight, before lowering her head to kiss the head of your " +
                    this.cockDescript(0) +
                    ".  Her tongue snakes around it, and the spider-lady sucks a little, drinking up the little stream of pre-cum now leaking out, before raising her head up to look at you, a gentle smile on her face as her many hands continue to rub and explore your " +
                    this.multiCockDescriptLight() +
                    '.  "<i>Not as good as my husband\'s,</i>" she whispers, "<i>but quite a piece, certainly.</i>"\n\n',
                false
            );
        }
        ...
        this.outx(
            "Two of her hands suddenly wrap themselves around the cheeks of your " +
                this.buttDescript() +
                ', and squeeze gently.  "<i>Very nice,</i>" the spider-lady whispers, and then her long tongue spools out to slide over the surface of your ' +
                this.buttDescript() +
                ".  The tip of it even slips inside, gently, and you feel her saliva coating the inside of your bum.  It feels sensitive, and much more relaxed now than a minute ago.\n\n",
            false
        );
        ...
        if (this.player.hasCock()) {
            this.outx(
                "Gently, she picks " +
                    this.oMultiCockDesc() +
                    ", and brings it up to her pussy. You see its entrance, two parted shell-plates dripping wet fluid, and would almost panic at the unfamiliar sight if you weren't so very relaxed.  With loving guidance, Aunt Nancy slides the full length of your " +
                    this.cockDescript(x) +
                    " deep inside of her.  Both of you moan in delight as your dick rubs and stimulates her in a way she's clearly been missing for a long, long while; her exotic insides, smooth and silky and deep, squeeze and caress your " +
                    this.cockDescript(x) +
                    " like a velvet glove.  Little feelers inside of her begin to massage your cock, and the wet, dripping fluids inside of her are just as relaxing as her saliva.\n\n",
                false
            );
            ...
            if (this.player.cockTotal() >= 2) {
                if (this.player.cocks[y].cockLength >= 22) {
                    titFucked = true;
                    this.outx(
                        "As Aunt Nancy rides you enthusiastically, the spider-lady lifts ",
                        false
                    );
                    if (this.player.totalCocks() > 2) this.outx("another one of ");
                    this.outx("your ");
                    if (this.player.cockTotal() == 2) this.outx("other cock ");
                    else this.outx("cocks ");
                    this.outx(
                        'up to her heaving bosom, and slips it between her soft, lovely breasts.  "<i>Want something else nice?</i>" asks the spider-lady, eyes twinkling.\n\n',
                        false
                    );

                    this.outx(
                        "Still rising and falling atop your body as she rides you, Aunt Nancy grips her breasts with two of her black-shelled hands and begins to slide them up and down on either side of your tall, dripping " +
                            this.cockDescript(y) +
                            ", ",
                        false
                    );
                    if (this.player.cocks[y].cockLength >= 30)
                        this.outx(
                            "letting its head slip into her mouth, where she sucks and licks at it hungrily, ",
                            false
                        );
                    else
                        this.outx(
                            "letting her long, dexterous tongue dangle down from her mouth to wrap around the head of her dick, occasionally licking at her own impressive bosom as well, ",
                            false
                        );
                    this.outx("all the while staring down into your eyes.\n\n", false);

                    this.outx(
                        "The sensation, both of her soft, pillowy bosom wrapped around your " +
                            this.cockDescript(y) +
                ...
                if (this.player.cockTotal() > 2) {
                    if (this.player.cockTotal() == 3)
                        this.outx(
                            "Another of her hands wraps itself around your other cock",
                            false
                        );
                    else
                        this.outx(
                            "Her other hands wrap themselves around more of your cocks",
                            false
                        );
                    this.outx(", milking and stroking the ");
                    this.outx("pulsating prick");
                    if (this.player.cockTotal() > 3) this.outx("s");
                    this.outx(" for all ");
                    if (this.player.cockTotal() == 3) this.outx("it's");
            ...
            if (!titFucked && this.player.biggestLactation() >= 1) {
                this.outx(
                    "As milk leaks slowly from your " +
                        this.nippleDescript(0) +
                        "s, the spider-lady notices.  She lowers her head and wraps her soft, lovely lips around the tip of one of your " +
                        this.player.allBreastsDescript() +
                        ", sucking gently and frantically flicking her tongue against your " +
                        this.nippleDescript(0) +
            ...
            if (!titFucked || (titFucked && this.player.cockTotal() <= 2)) {
                ...
                this.outx(
                    "massaging your " +
                        this.chestDesc() +
                        ".  Occasionally, they stroke through your " +
                        this.hairDescript() +
                        ".\n\n",
                    false
                );
        ...
        // [If player has vagina but no dicks: (Nancy prefers dicks and will always choose them over lesbian sex)]
            ...
            this.outx(
                "With your face turned, you suddenly spot a once-well-made dildo lying on the floor beneath the web.  You see that it has been worn down as smooth as an apple rind and probably much thinner than it was before, and you suddenly wonder just how pent up the widow's sexual desires really are.\n\n",
                false
            );

            this.outx(
                "Such thoughts are interrupted when you suddenly feel Aunt Nancy's fingers on the lower half of your body again, caressing your ",
                false
            );
            ...
            this.outx(
                this.vaginaDescript(0) +
                    " and " +
                    this.buttDescript() +
                    ".  Aunt Nancy turns your head to face hers, and rises up onto her legs again as her fingers begin to sink deep into your " +
                    this.vaginaDescript(0) +
                    " and your " +
                    this.assholeDescript() +
                    ".  You moan, loudly and long at the sensation, and Aunt Nancy smiles lewdly, her other hands still exploring and squeezing your " +
                    this.chestDesc() +
                    ", rubbing and kneading them softly and occasionally pinching and pulling at your " +
                    this.nippleDescript(0) +
                    "s.\n\n",
                false
            );
            ...
            this.outx(
                'Suddenly, you realize that your left hand is now free, courtesy of one of Aunt Nancy\'s smooth, gentle arms.  She whispers, quietly, "<i>A little for me too, please.</i>"  Realizing exactly what she means, you press the ' +
                    this.player.skinFurScales() +
                    " of your hand against her pussy.  Its entrance, two parted shell-plates dripping wet fluid, would almost be scary if you weren't so very relaxed.  Gently, your press your fingers into her body, and hear her moan, loudly, feel her own hands scrabbling inside of your " +
                    this.vaginaDescript(0) +
                    " and " +
                    this.assholeDescript() +
                    ", pawing your chest and " +
                    this.buttDescript() +
                    ", trailing through your " +
                    this.hairDescript() +
                    ".\n\n",
                false
            );
        ...
        // [If the PC has no genitals at all:]
            ...
            this.outx(
                "Gently, Aunt Nancy leans down to stroke your face as two of her other hands reach out and begin stroking your " +
                    this.chestDesc() +
                    ' while a fourth explores the smooth, fleshless expanse where your genitals once were.  "<i>Such a pretty little fly,</i>" the spider-lady whispers as she stares at your face, her bright red eyes full of longing.  She presses her face against the side of your head, and you gently turn it to allow her access to your ear, which she quickly slips her tongue into again, enjoying the feeling as you quiver and yelp beneath her.\n\n',
                false
            );
            ...
            this.outx(
                "Such thoughts are interrupted when you suddenly feel Aunt Nancy's fingers on the lower half of your body, caressing your " +
                    this.buttDescript() +
                    " before rising again to your lack of genitals.\n\n",
                false
            );

            this.outx(
                "Smiling at the puzzle before her, Aunt Nancy gently runs her hands over your " +
                    this.nippleDescript(0) +
                    "s and " +
                    this.hairDescript() +
                    " as she thinks over how best to make love to you.  Gently, her white-haired head returns to your " +
                    this.buttDescript() +
                    ", and her long tongue snakes out again, sliding between its lobes.  As you relax, it slips inside of you, just far enough for you to moan at the nigh-sexual pleasure of total relaxation.  The spider-lady removes her tongue from your anus, much to your dissatisfaction, and carefully wipes it off on a nearby bit of cloth before returning it to her mouth, then, smiling up at your petulant expression, slips a few of her fingers into your now-loose and sensitive " +
                    this.assholeDescript() +
                    ".\n\n",
                false
            );
            ...
            this.outx(
                'Aunt Nancy climbs back atop you as you moan at the welcome new sensation, licking at your chest as she does.  "<i>Bet you didn\'t think I could do it,</i>" she purrs to you, as you enjoy the many, many sensations working at you.\n\n',
                false
            );

            this.outx(
                'Suddenly, you realize that your left hand is now free, courtesy of one of Aunt Nancy\'s smooth, gentle arm.  She whispers, quietly, "<i>A little for me too, please.</i>"  Realizing exactly what she means, you press the ' +
                    this.player.skinFurScales() +
                    " of your hand against her pussy.  Its entrance, two parted shell-plates dripping wet fluid, would almost be scary if you weren't so very relaxed.  Gently, your press your ingers into her body, and hear her moan, loudly, feel her own hands scrabbling inside of your " +
                    this.assholeDescript() +
                    ", pawing your chest and " +
                    this.buttDescript() +
                    ", trailing through your " +
    ...
    private auntNancyPoonPartIII(): void {
        ...
        if (this.player.hasCock()) {
            ...
            this.outx(
                "You cum, and cum hard.  Thick wet jets of sticky semen pour into Aunt Nancy's seemingly-bottomless pussy, whose feelers and soft, smooth interior continue to rub at and stroke your " +
                    this.cockDescript(x) +
                    " even as it vents the immense pressure in your " +
                    this.ballsDescriptLight() +
            ...
            if (this.player.cocks[y].cockLength >= 22 && this.player.cockTotal() > 1) {
                this.outx(
                    "Aunt Nancy unwraps her tongue from your " +
                        this.cockDescript(y) +
                        " to cry out in delight, even as her hands let go of her lovely breasts to grab at your trunk.  Nonetheless, her big, pillowy boobs are more than firm enough to keep the shaft of your " +
                        this.cockDescript(y) +
                        " snugly inside as she bucks and shrieks atop you, and they more than contribute to your own sexual pleasure.\n\n",
                    false
                );
                ...
                if (this.player.cockTotal() > 1) {
                    ...
                    // [Else]
                        ...
                        this.outx(
                            "The rest of your " +
                                this.multiCockDescriptLight() +
                                " fire off too, her smooth, shell-covered hands still wrapped around them, and they make even more of a mess, splattering over both of you.\n\n",
                            false
                        );
                }
            }
            ...
            if (this.player.hasVagina()) {
                ...
                if (
                    ...
                    this.outx(
                        "squeezing the fingers on Aunt Nancy's hand still tickling your insides",
                        false
                    );
                else this.outx("making you long for something inside of it");
                this.outx(", as " + this.sMultiCockDesc() + " spasms in ecstacy.\n\n", false);
            }
            // [All w/ penis:]
            this.outx(
            ...
            if (this.player.cockTotal() >= 2 && this.player.cumQ() >= 700)
                ...
                this.outx(
                    "Aunt Nancy puts one hand beneath her dripping pussy and squeezes some powerful internal muscle.  A thick dollop of gooey cum falls onto it from inside of her, and she lifts it in front of her mouth.",
                    false
                );
            this.outx(
                "  Snaking her long tongue around her fluid-smeared hand, the spider-lady licks up a thick load of the contents of your ",
                false
            );
            if (this.player.balls > 0) this.outx(this.ballsDescriptLight(), false);
            else this.outx("body");
            this.outx(", and throws back her head to let it slide into her mouth.\n\n", false);

            this.outx(
                '"<i>Mmmmm...</i>" she purrs.  Aunt Nancy notices the look on your face and smiles sexily.  "<i>What? A lady needs her protein, friend.  Do you think I can spin my webs out of nothing?</i>"\n\n',
                false
            );
        }
        // [Else:]
            ...
            this.outx(
                "You howl in pleasure, feeling the orgasm coursing through you like hot metal up and down your spine.  You let out a exclamation of pleasure of your own, as you feel her hands tighten on your " +
                    this.chestDesc() +
            ...
            this.outx(
                " fingers are soon soaked in the lovely, sweet-smelling juices of her pussy.\n\n",
                false
            );
        ...
        this.outx(
            '"<i>Not a chance on Marae\'s green earth, friend,</i>" she purrs, her voice like hoarse velvet as she rubs the surface of her still-needy pussy against your belly.  "<i>I haven\'t had a lover in my bed in more than ten years, and you\'re not going anywhere until I say you can.</i>"  That last part was punctuated with a wicked squeeze of your ' +
                this.buttDescript() +
                ", and Aunt Nancy presses her lips to yours again, much less gently and more passionately this time.  You moan into her mouth, feeling her aphrodisiacal bodily fluids seeping in, and, as she soon frees your upper body and presses your head into her soft, silky pussy, you know she's right.\n\n",
            false
        );

        this.outx(
            '"<i>And I\'ll be damned if I do all the work this time,</i>" Aunt Nancy adds, before letting out a satisfied groan at the touch of your lips.',
            false
        );
    ...
    private auntNancyPoonPartIV(): void {
        this.outx("", true);
        this.outx("<b>Two passionate, sticky hours pass...</b>\n\n", false);
        ...
        if (this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00266] == 0) {
            ...
            this.outx(
                "Tentatively, you smile back, before getting cleaned up, getting dressed, and walking out into the suddenly-blinding sun of Tel'Adre.\n\n",
                false
            );
        }
        // [Else]
