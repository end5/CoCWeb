...
export class UmasShop extends TelAdreAbstractContent {
    ...
    public firstVisitPart1(): void {
        ...
        if (this.flags[kFLAGS.LOPPE_TIMES_SEXED] <= 3) {
            ...
            this.outputText(
                " and the homely building has caught your eye once or twice in the past.  "
            );
        } else {
    ...
    public firstVisitPart2(): void {
        ...
        this.outputText(
            "Loppe holds your hand and the two of you begin detailing how you met....\n\n"
        );
    ...
    public massagePower(): void {
        ...
        this.outputText(
            "You tell Uma that you're interested in the strength-boosting massage.\n\n"
        );
        this.outputText(
    ...
    public massageMain(selectedMassage: number): void {
        ...
        if (this.player.gems < 75) {
            this.outputText(
                "You tell her that you don't have that many gems on you right now.\n\n"
            );
            this.outputText(
    ...
    public talkMenu(): void {
        ...
        this.outputText(
            '"<i>Sure, what would you like to talk about?</i>"  Uma replies with a smile.'
        );
    ...
    public talkLoppesFirstGirlPart4(): void {
        ...
        this.outputText(
            '"<i>It\'s open.</i>" Loppe hears through the door. Well, here goes...\n\n'
        );
        this.outputText(
    ...
    public talkLoppesFirstBoyfriendPart4(): void {
        ...
        this.outputText(
            '"<i>H-Half an hour!</i>"  Hyou groans, flopping on Loppe\'s bed limply.\n\n'
        );
        this.outputText(
        ...
        //{More than five blowjobs!}
            ...
            if (this.player.cumQ() <= 25)
                ...
                if (this.player.balls > 0)
                    this.outputText(
                        "  It rolls down to your [sack], coating it in warm, wet cum-shine."
                    );
            } else {
                this.outputText(
            ...
            if (this.player.cockTotal() > 1) {
                ...
                this.outputText(
                    "lewd dance continues on in imitation of your main member's pleasure.  "
                );
    ...
    private sexEatHerOut(): void {
        ...
        this.outputText(
            "Uma moans and groans appreciatively, one hand reaching down to rub your head "
        );
