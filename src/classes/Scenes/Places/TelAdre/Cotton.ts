...
export class Cotton extends TelAdreAbstractContent implements TimeAwareInterface {
    ...
    private cottonFucksYouInShowerRepeat(): void {
        ...
        //(Repeat get fucked for humanoids and nagas)
            ...
            this.outputText(
                "She continues kissing a trail down your belly and to your crotch.",
                false
            );
            if (this.player.hasCock()) {
                //(If PC has a large penis, bigger than Cotton's capacity, add)
    ...
    private cottonPopsOutAKid(): void {
        ...
        //(Replaces the Approach scenes)
            ...
            this.outputText(
                '!</i>" she says happily, pulling you into a hug.  "<i>We could go see '
            );
            if (kid != 1) this.outputText("her");
            else this.outputText("him");
    ...
    private cottonContraceptionToggle(): void {
        ...
        if (this.flags[kFLAGS.COTTON_KID_COUNT] < 3)
            this.outputText(
                'Well that\'s true,</i>" she admits.  "<i>But I leave it up to you, pet.'
            );
        else
            this.outputText(
    ...
    public birthingCottonsKids(): void {
        ...
        this.outputText(
            " feet end in tiny pristine hooves, and a little brush of a tail extends from "
        );
        if (kid == 1) this.outputText("his");
        else this.outputText("her");
    ...
    private visitCottonKids(): void {
        ...
        if (scene == 0) {
            ...
            this.outputText(
                " in that way that parents of small children tend to do.  When the little "
            );
