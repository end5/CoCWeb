...
export class Cotton extends TelAdreAbstractContent implements TimeAwareInterface {
    ...
    public constructor() {
        ...
        this.pregnancy = new PregnancyStore(
            kFLAGS.COTTON_PREGNANCY_TYPE,
            kFLAGS.COTTON_PREGNANCY_INCUBATION,
            0,
            0
        );
    ...
    public timeChange(): boolean {
        ...
        if (this.flags[kFLAGS.COTTON_KID_COUNT] > 0 && this.model.time.hours == 23)
            this.flags[kFLAGS.COTTON_OLDEST_KID_AGE]++;
        trace(
            "\nCotton time change: Time is " +
    ...
    private pregCottonChance(bonusMult = 1): void {
        ...
        if (this.flags[kFLAGS.COTTON_HERBS_OFF] > 0) {
            if (
                Cotton.rand(5) == 0 ||
                this.player.cumQ() > Cotton.rand(1000) ||
                this.player.virilityQ() >= 0.5
            ) {
                this.pregnancy.knockUpForce(
                    PregnancyStore.PREGNANCY_PLAYER,
                    PregnancyStore.INCUBATION_COTTON
                );
            }
        }
        // HERBS ON - LESS CHANCE
            ...
            if (this.flags[kFLAGS.COTTON_KID_COUNT] == 0) {
                if (
                    Cotton.rand(5) == 0 ||
                    this.player.cumQ() * this.player.virilityQ() >= Cotton.rand(1000)
                ) {
                    this.pregnancy.knockUpForce(
                        PregnancyStore.PREGNANCY_PLAYER,
                        PregnancyStore.INCUBATION_COTTON
    ...
    public cottonGreeting(): void {
        ...
        this.outx("", true);
        this.outx(this.images.showImage("cotton-greeting"));
        ...
        if (this.flags[kFLAGS.COTTON_MET_FUCKED] == 0) {
            ...
            if (this.player.tallness > 78)
                this.outx("Despite her impressive stature, you still look down on her.", false);
            ...
            else this.outx("She is truly tall, and you have to look up to her.");
            this.outx(
            ...
            if (this.player.isTaur() || this.player.isNaga()) {
                /* outx("\"<i>I'd love to teach you, but I'm afraid I don't know any good routines for your... body type. Sorry, pet.</i>\"", false);
                // Back to gym!
                doNext(13);
                return;*/
        ...
        // Met before
            ...
            // (If Centaur or Naga)
            if (this.player.isTaur() || this.player.isNaga()) {
                /* outx("You approach Cotton, who gives you a friendly smile. \"<i>Hey, there little pet. I'm afraid I don't know any good stretches for your body... Maybe some other time.</i>\"", false);
                doNext(13);
                return;*/
                this.centaurNagaBodyBookStuff();
    ...
    private cottonGreetingCommonEnd(): void {
        if (
            ...
            switch (this.pregnancy.event) {
                ...
                default:
                    this.outx(
                        'You approach Cotton, who smiles and says, "<i>Hey there my little pet, if you\'d like a work out, just get changed and come on back.</i>"\n\nDo you want to engage in yoga with her?'
                    );
            }
        }
        this.cottonMenu();
    ...
    private cottonMenu(): void {
        ...
        if (this.flags[kFLAGS.COTTON_KID_COUNT] > 0)
            this.addButton(1, "Visit Kids", this.visitCottonKids);
        if (this.pregnancy.isPregnant || this.flags[kFLAGS.COTTON_KID_COUNT] >= 1)
            this.addButton(2, "Herbs", this.cottonContraceptionToggle);
    ...
    private centaurNagaBodyBookStuff(): void {
        ...
        // First time with book
            ...
            this.outx("Do you want to engage in Yoga with her?");
            this.flags[kFLAGS.COTTON_UNUSUAL_YOGA_BOOK_TRACKER]++;
            this.cottonMenu();
        } else this.cottonGreetingCommonEnd();
    }
    ...
    private turnDownYogaWifCottonFirstTime(): void {
        ...
        this.outx("", true);
        this.outx(
            "\"<i>That's all right, to each their own.  I'll be here if you ever change your mind.</i>\"  With that, Cotton returns to her mat and continues stretching in various poses.\n\n",
            false
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private acceptYoga(): void {
        this.spriteSelect(12);
        this.outx("", true);
        this.outx(this.images.showImage("cotton-yoga"));
        let fuckHer;
        let getFucked;
        let option3;
        ...
        if (this.flags[kFLAGS.LIFETIME_GYM_MEMBER] == 0 && this.player.gems < 10) {
            this.outx(
                'Before you can start the yogo the centauress steps in and says, "<i>Ten gems for gym fees.</i>"\n\nYou fish around in your pouches, but you just don\'t have enough.  Maybe some other time!',
                false
            );
            this.doNext(this.camp.returnToCampUseOneHour);
            return;
        ...
        if (this.flags[kFLAGS.LIFETIME_GYM_MEMBER] == 0) {
            ...
            this.outx(
                "The centauress collects ten gems for gym fees before the two of you can get into it.\n\n",
                false
            );
        }
        // (Yes) LAMAZE
        ...
        // First time
            ...
            this.outx(
                "She then helps you into an outfit identical to her own and you both return to the gym proper.\n\n",
                false
            );
        ...
        // Done yoga > 0 && met type = 1
            ...
            this.outx(
                "You change into your yoga clothes and approach Cotton, saying you'd love another yoga workout. Cotton smiles and sets up a mat for you. You spend the next half an hour trying different poses and stretches while she corrects you, sometimes pressing her body against yours to show you how it's done.\n\n",
                false
            );
            ...
            // (If Edryn has been knocked up, and PC didn't reject it)
                ...
                this.outx(
                    "While you're doing your stretches, you find yourself chatting about the folks of Tel'Adre. \"<i>Edryn?</i>\" Cotton says and giggles, \"<i>I hear you knocked her up, good on you. I think she'll make a great mom, and you " +
                        this.player.mf("a great dad", "as well") +
    ...
    private leaveAfterYoga(): void {
        ...
        this.outx("", true);
        this.outx(
            "\"<i>Suit yourself. You can run around all stinky, meanwhile I'm going to go wash. Feel free to drop by later for some more yoga if you'd like.</i>\"  With that, Cotton heads off to the showers and you leave the gym.\n\n",
            false
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private cottonShowerFunTimes(): void {
        ...
        this.outx('"<i>Well? Care for a little... post-workout stretching?</i>"', false);
    ...
    private cottonFirstTimeFuckHer(): void {
        ...
        this.outx("", true);
        this.outx(this.images.showImage("cotton-first-fuck"));
        ...
        this.outx(
            "Her pussy quivers and trembles around your tongue. You can tell she's so close to orgasm... but that's not what you want right now.  With a small amount of regret, you pull back from her delicious snatch, wipe the water and juices from your face and stand, stroking your " +
                this.cockDescript(x) +
                " to full attention and pressing it against her ready hole. Grasping her hips firmly, you whisper dirty words into your horse lover's ear before slowly thrusting in. Cotton gives an ever-so-slight whinny and a gasp, her body moving back into yours.\n\n",
            false
        );
        ...
        this.outx(
            "After several minutes of this, you just can't take it anymore and your " +
                this.cockDescript(x) +
                " explodes within her, coating her insides with your seed, and as you do you feel Cotton's pussy clamp down on you tightly, working every last drop out of you. Her own cock explodes, coating the wall and floor beneath you in her musky scent. Nearly exhausted, you collapse on top of Cotton momentarily while you catch your breath. The two of you sink down to the shower floor, letting the hot water wash away the evidence of your love making.\n\n",
            false
        );

        this.outx(
            "After another minute, you pull your flaccid cock out of your horse lover's hole and take the moment to carefully wash the both of you up.\n\n",
            false
        );

        this.outx(
            "Your 'post-workout stretch' and shower done, the two of you dry off, redress and leave the gym. Cotton takes you by the arm and says, \"<i>That was great, pet. Come by the gym anytime. I'll be waiting.</i>\"  Then, she heads back home.  With a little grin on your face, you do the same.\n\n",
            false
        );
    ...
    private cottonFucksYou(): void {
        ...
        this.flags[kFLAGS.COTTON_MET_FUCKED] = 2;
        this.outx("", true);
        this.outx(this.images.showImage("cotton-fucks-you"));
        ...
        if (this.player.gender == 1) {
            ...
            this.outx(
                "Cotton smiles, continuing to massage the soap in until she gets to your buttocks. There, she gets another handful of soap and presses it into your crack, gently soaping you up from taint to tailbone. Then she carefully inserts one finger into your " +
                    this.assholeDescript() +
                    ' then two, three and before long her entire hand is exploring your depths. She giggles and withdraws her hand, "<i>My my, such an eager little ass you have, my pet.</i>"\n\n',
                false
            );
            ...
            this.outx(
                '"<i>Oh now pet, don\'t be so scared,</i>" Cotton whispers into your ear, then lifts her cock from your back and places it at your ' +
                    this.assholeDescript() +
                    ". She reaches forwards and you hear the squeak of the temperature nozzle being turned. Seconds later, the water pouring down on you gets hotter, causing your whole body to heat up in response. Using this time, Cotton presses forwards, her equine cock invading your " +
                    this.assholeDescript() +
            ...
            this.outx(
                "Before long you find yourself moaning beneath her, your " +
                    this.assholeDescript() +
                    ' clenching and unclenching uncontrollably. "<i>Ooh, my little pet likes it now, hmmm?</i>" She whispers into your ear and nibbles on it ever-so-slightly. You can\'t help but give a breathless "<i>Yes</i>" in response. Cotton giggles and speeds up her thrusts. You find yourself pushing back into her, urging her to go deeper and deeper. Your own dick is completely limp in the presence of this godly cock, but tingles with pleasure and anticipation.\n\n',
                false
            );

            this.outx(
                "After a few minutes of this, neither of you can take much more. Both of you give a deep moan of orgasmic pleasure as your " +
                    this.assholeDescript() +
                    " clenches and you feel your equine lover's cock twitch and spasm within you, flooding your hole with her hot seed. Your own limp member shudders with orgasm, but instead of spurting, it leaks a small torrent of cum right down onto the floor.",
                false
            );
            if (this.player.cumQ() >= 1000)
                this.outx(
                    "  You nearly clog the drain with all the spooge leaking from your flaccid shaft.",
                    false
                );
            this.outx("\n\n", false);

            this.outx(
                "The two of you slip down onto the floor, right into your puddle of cum, letting the water rinse you off for the time being. After a minute, Cotton pulls her now flaccid (but still impressive) cock from your rear, which gapes open for several minutes afterward, and proceeds to clean the both of you up.\n\n",
                false
            );

            this.outx(
                "Your 'post-workout stretch' and shower done, the two of you dry off, redress and leave the gym. Cotton takes you by the arm and says, \"<i>That was great, little pet. Come by the gym anytime. I'll be waiting.</i>\"  Then, she heads back home.  With a little grin on your face, you do the same.\n\n",
                false
            );
            this.player.orgasm();
            this.dynStats("sen", 2);
        ...
        // (Get fucked, as Female)
            ...
            this.outx(
                "Cotton smiles, continuing to massage the soap in until she gets to your rear. There, she gets another handful of soap and presses it into your crevasse, gently soaping you up from " +
                    this.clitDescript() +
                    ' to tailbone. Then she carefully inserts one finger into your pussy, then two, three, and before long her entire hand is exploring your most personal depths. She giggles and withdraws her hand, "<i>My my, such an eager little cunt you have, my pet.</i>"\n\n',
                false
            );
            ...
            this.outx(
                "The two of you slip down onto the floor, letting the water rinse you off for the time being. After a minute, Cotton pulls her now flaccid (but still impressive) cock from your folds, which gapes open for several minutes afterward, and proceeds to clean the both of you up.\n\n",
                false
            );
        ...
        // (Get fucked, as Herm)
            ...
            this.outx(
                'Before long you find yourself moaning beneath her, your cunt clenching and unclenching uncontrollably. "<i>Ooh, my little pet likes it now, hmmm?</i>" She whispers into your ear and nibbles on it ever-so-slightly. You can\'t help but give a breathless "<i>Yes</i>" in response. Cotton giggles and speeds up her thrusts. You find yourself pushing back into her, urging her to go deeper and deeper. Your ' +
                    this.clitDescript() +
                    " twinges with pleasure after every thrust, and your own " +
                    this.cockDescript(0) +
    ...
    private serviceFirstTimeCotton(): void {
        ...
        this.player.slimeFeed();
        this.outx("", true);
        this.outx(this.images.showImage("cotton-first-time-give-her-blowjob"));
        this.outx(
        ...
        this.outx(
            "Nodding, you gulp and grasp her cock, feeling along its warm semi-rigid length. You get it under the spray of water and rub gently, letting it harden. You occasionally glance up at Cotton, to make sure you're doing ok, and she just smiles back at you, wordlessly urging you to continue.\n\n",
            false
        );
        ...
        this.outx(
            "You gulp it down, mildly surprised at how sweet it tastes. Taking two fingers you collect some of the cum deposited on your face and lick it off, then you carefully lick Cotton's rapidly shrinking member, until not a drop of cum remains.\n\n",
            false
        );
    ...
    private fuckCottonInShowerRepeat(): void {
        ...
        this.spriteSelect(12);
        this.outx("", true);
        this.outx(this.images.showImage("cotton-shower-fuck-repeat"));
        let x: number = this.player.cockThatFits(60);
        if (x < 0) x = 0;

        /* OLD ORIGINAL REPEAT SHOWER SEX
        outx("You decide to take her up on her offer, pulling her into the showers and quickly disrobing. Seeing the look on your face, she does too, and quickly enters the showers, turning only one shower-head on. She turns around and grabs you, pulling you into an embrace as you kiss under the steaming water. Both your cocks stir, rising and rubbing together while you make out.\n\n", false);

        outx("Finally breaking the kiss, you reach down and hook your arm under one of her legs, lifting her leg up while you position your rock hard member at her pussy. She leans forward to kiss again as you thrust forwards, causing her to moan into your mouth. You thrust in and out while her horse-cock bounces between the two of you, only adding to the excitement.\n\n", false);

        outx("After several minutes, the hot shower, hot woman and hot sex are just too much for you, and give one last thrust, pushing your bodies forward to slam against the wall. It's clearly too much for Cotton as well, as she groans out in orgasmic ecstasy. Her cock, sandwiched between you, tenses and explodes just as yours does, covering Cotton in cum inside and out.\n\n", false);

        outx("After a moment you pull out, share a deep kiss, and wash each other up before redressing and leaving the gym.");
        */
        ...
        if (this.player.isTaur()) {
            this.outx(
                "You decide to take her up on her offer and lead her into the showers, quickly disrobing and turning on an available shower-head. Cotton strips as well and you pull her under the stream of water, letting your horse body remain out of the water for now, sharing a kiss as steam begins to form around you. She runs a hand through your " +
                    this.hairDescript() +
                    " and grips the back of your neck, "
            );
            ...
            else this.outx("pulling you closer.\n\n", false);
            ...
            if (this.player.cockArea(x) >= 100) {
                ...
                // (If PC has multiple cocks)
                    ...
                    this.outx(
                        "You feel your " +
                            ...
                            " stirring beneath your large body, while Cotton's remains curiously limp.  While her cock dangles, your group of cocks strains for attention.",
                        false
                    );
            } else {
                if (this.player.cockTotal() == 1)
                ...
                // (If PC has multiple cocks)
                    ...
                    this.outx(
                        "You feel your " +
                            this.multiCockDescriptLight() +
                            " stirring beneath your large body, while you watch Cotton's do the same. Her cock rubs against your stomach while your group of cocks strains for attention.",
                        false
                    );
            }
            ...
            if (this.player.hasVagina())
                this.outx(
                    "  Meanwhile, your " +
                        this.vaginaDescript(0) +
                        " behind you moistens both from the steam and from arousal, and your " +
                        this.clitDescript() +
                        " aches, craving attention.",
                    false
                );
            this.outx("\n\n", false);
            ...
            // (if player is too small (under 4</i>\")
                ...
                if (this.pregnancy.event > 1)
                    this.outx(
                        "Don't worry pet, it's plenty adequate for me.  And you've got to admit,</i>\" she smirks, rubbing her round belly, \"<i>It gets the job done, doesn't it?"
                    );
                else this.outx("Don't worry pet, it's plenty adequate for me.");
                this.outx(
                    '</i>" Letting a little smile cross your lips, you push your ' +
                        this.cockDescript(x) +
                        " fully into her, not a big accomplishment for one of your size, but still enough to make you feel good.",
                    false
                );
            }
            ...
            this.outx(
                "You keep this up for a while, fatigue not really an issue with a body of your size and shape. Cotton, meanwhile, gasps for breath audibly and has taken to laying her front half down on the bench, her ass right up in the air. She strokes your forelegs lovingly, showing she's still ready for more.  "
            );
            if (this.player.cockArea(x) >= 100)
                this.outx(
                    "Oblivious to you, her own limp cock leaks cum down onto the bench as an orgasm rocks her body."
                );
            else if (this.pregnancy.event > 1)
                this.outx(
                    "Oblivious to you, her own cock twitches and spasms, letting loose a spray of cum across her swollen, pregnant belly, breasts and the bench as an orgasm rocks her body."
                );
            else
                this.outx(
            ...
            if (this.player.cockArea(x) > 70)
                this.outx(
                    "  Even with all the pounding you've been doing, you can't fit your entire girth into her, but she doesn't care. Her eyes seem to roll back and forth like it's hard to focus, and her tongue drips water, sweat and saliva onto her body. She's panting for breath and you are able to make out faint, \"<i>Oh gods, oh gods</i>\" over the running water. Were you able to see her toned stomach, you're sure you could see the outline of your " +
                        this.cockDescript(x) +
                        " in it. Her back arches under the shower, her red hair messily draped around her face and bench, and she bites her lip as another orgasm rocks her body.",
                    false
                );
            this.outx("\n\n", false);
            ...
            this.outx("  You give a couple more token thrusts and pull out. As you do, ", false);
            if (this.player.cumQ() < 200) this.outx("cum begins to seep from her folds");
            else if (this.player.cumQ() < 700)
                this.outx("a gush of cum escapes from Cotton's folds");
            else if (this.player.cumQ() < 1200)
                this.outx("a small torrent of cum escapes from Cotton's folds");
            else if (this.player.cumQ() < 2000) this.outx("cum surges from her abused hole");
            else this.outx("a massive flood of cum escapes from her cunt");
            this.outx(", immediately getting washed towards the drain.\n\n", false);

            this.outx(
                "You both bask in the afterglow for a few moments before you stand up and help Cotton up. You return to the task of cleaning yourselves, sensually washing each other's private areas. Yoga, sex and cleanup done, you get dressed and leave the gym, giving Cotton's hand a final squeeze before departing.",
                false
            );
        }
        // (Repeat fuck her, for nagas)
            ...
            if (this.player.cockArea(x) >= 100) {
                ...
                if (this.player.cockTotal() == 1)
                    this.outx(
                        "  You feel your " +
                            this.cockDescript(x) +
                            " stirring beneath you, slowly coming to attention, though Cotton's remains curiously limp.  Your " +
            ...
            if (this.player.hasVagina())
                this.outx(
                    "Your " +
                        this.vaginaDescript(0) +
                        " meanwhile moistens both from the water and from arousal, and your " +
                        this.clitDescript() +
                        " aches, craving attention.",
                    false
                );
            ...
            this.outx(
                "Suitably turned on now, you coil your body around Cotton's torso, with your tail spreading her legs apart while you place your " +
                    this.cockDescript(x) +
            ...
            // (if player is too small (under 4</i>\") add)
                ...
                this.outx(
                    '</i>" Giving her a little smile, you push your ' +
                        this.cockDescript(x) +
                        " fully into her, not a big accomplishment for one of your size, but still enough to give you a little smile.",
                    false
                );
            }
            // (otherwise add)
            ...
            this.outx(
                "You keep this up for a while, before fatigue takes over. You carefully lay Cotton down in the spray of water, coiling your body under her so her rear end is up in the air, hooves resting on the ground, and continue your work unhindered. She kisses your lips, neck, and whatever she can get her mouth on.  "
            );
            if (this.player.cockArea(x) >= 100)
                this.outx(
                    "Her own cock, still limp, visibly twitches and begins leaking cum onto her belly as an orgasm rocks her body."
                );
            else if (this.pregnancy.event > 1)
                this.outx(
                    "Her own cock twitches and spasms, letting loose a spray of cum across her swollen, pregnant belly, breasts and face as an orgasm rocks her body."
                );
            else
                this.outx(
        ...
        // (Repeat Fuck Her, for humanoid bodies)
            ...
            if (this.player.hasVagina())
                this.outx(
                    "  Your " +
                        this.vaginaDescript(0) +
                        " moistens both from the water and from arousal, and your " +
                        this.clitDescript() +
                        " aches, craving attention.",
                    false
                );
            ...
            this.outx(
                "Suitably turned on now, you reach down and hook your arm under one of Cotton's legs, lifting it up while you position your " +
                    this.cockDescript(x) +
                    " at her pussy. You slowly push in, and Cotton bites her lip, looking at you in approval.",
                false
            );
            ...
            this.outx(
                "You keep this up for a while before fatigue takes over. You carefully lay Cotton down in the spray of water and continue your work unhindered. She kisses your lips, neck, and whatever she can get her mouth on.  "
            );
            if (this.player.cockArea(x) >= 100)
                this.outx(
                    "Her own cock, still limp, visibly twitches and begins leaking cum onto her belly as an orgasm rocks her body."
                ...
                this.outx(
                    "Her own cock twitches and spasms, loosing a spray of cum across her swollen, pregnant belly, breasts and face as an orgasm rocks her body."
                );
            else
                this.outx(
                    "Her own cock twitches and spasms, letting loose a spray of cum across her belly, breasts and face as an orgasm rocks her body.",
    ...
    private cottonFucksYouInShowerRepeat(): void {
        ...
        this.flags[kFLAGS.COTTON_MET_FUCKED] = 2;
        this.outx("", true);
        this.outx(this.images.showImage("cotton-shower-fucks-you-repeat"));
        /* OLD SEX SCENES HERE
        if(player.hasCock() && (player.gender != 3 || rand(2) == 0)) {
            outx("You decide to take her up on her offer, and she pulls you towards the showers, quickly disrobing the both of you. She turns only one shower-head on and pulls you into an embrace underneath the rapidly heating stream. Cotton's cock stirs between you, and though yours tingles, it remains limp in her presence.\n\n", false);

            outx("Finally breaking the kiss, Cotton reaches down and hooks her arms under both your legs. You quickly wrap your arms around her neck as she lifts you off the ground. You carefully grip her with your legs as she uses one arm to position her dick at your waiting entrance. You give her a kiss just as she presses into you, and moan into her mouth. She gives a couple careful thrusts before her free hand returns to holding you.\n\n", false);

            outx("At this angle she can't quite get her entire girth into you, but that doesn't matter, as it feels absolutely exquisite.");
            player.buttChange(72,true,true,false);
            outx("  You take turns kissing each other's necks and nibbling each other's ears while she thrusts in and out. And after several minutes neither of you can take much more. She gives one last thrust, pulling you down further onto her cock as it explodes within you. Your whole body shudders with orgasmic energy and you bury your head into her neck, stifling a scream.\n\n", false);

            outx("After a moment, Cotton pulls you up, letting her shrinking member flop to the floor, and sets you down. Only now you notice your flaccid cock also came at some point, covering both your bodies in seed. You share a deep kiss again and wash each other up before redressing and leaving the gym.\n\n", false);
            player.orgasm();
            dynStats("sen", 1);
        }
        // (Shower Sex, Get Fucked as Female)
        else {
            outx("You decide to take her up on her offer, and she pulls you towards the showers, quickly disrobing the both of you. She turns only one shower-head on and pulls you into an embrace underneath the rapidly heating stream. Cotton's cock stirs between you, and your " + vaginaDescript() + " burns with anticipation.\n\n", false);

            outx("Finally breaking the kiss, Cotton reaches down and hooks her arms under both your legs. You quickly wrap your arms around her neck as she lifts you off the ground. You carefully grip her with your legs as she uses one arm to position her dick at your waiting entrance. You give her a kiss just as she presses into you, and moan into her mouth. She gives a couple careful thrusts before her free hand returns to holding you.");
            player.cuntChange(72,true,true,false);
            outx("\n\n", false);

            outx("At this angle she can't quite get her entire girth into you, but that doesn't matter, as it feels absolutely exquisite. You take turns kissing each other's necks and nibbling each other's ears while she thrusts in and out. And after several minutes neither of you can take much more. She gives one last thrust, pulling you down further onto her cock as it explodes within you. Your whole body shudders with orgasmic energy and you bury your head into her neck, stifling a scream.\n\n", false);

            outx("After a moment, Cotton pulls you up, letting her shrinking member flop to the floor, and sets you down. You share a deep kiss again and wash each other up before redressing and leaving the gym.");
            player.orgasm();
            dynStats("sen", -1);
        }*/
        ...
        if (this.player.isTaur()) {
            ...
            // (If PC has a penis and vagina)
                ...
                this.outx(
                    "  Your " +
                        this.cockDescript(0) +
                        " tingles betwixt your legs, but remains limp in the presence of Cotton's impressive member, while your " +
                        this.vaginaDescript(0) +
            ...
            this.outx(
                "Cotton continues the kisses down to your " +
                    this.player.legs() +
                    " and stands, dragging over a bench from the locker room before standing on it and giving your " +
                    this.buttDescript() +
                    " a good smack. You turn back and give her a coy look, which she returns and gives your flank another smack.",
                false
            );
            this.outx(
                "  She takes a moment to get some water from the shower over your rear end before pressing her cock against your " +
            ...
            this.outx(
                "At this angle, she easily slips her entire length and girth into you, letting her balls slap against your crotch with a smack. She smacks your backside over and over while she thrusts, and you find yourself laying back on your centaur body in a blissful trance.  "
            );
        ...
        // (Repeat get fucked for humanoids and nagas)
            ...
            // (If PC has a penis and vagina)
                ...
                this.outx(
                    "  Your " +
                        this.cockDescript(0) +
                        " tingles beneath you, but remains limp in the presence of Cotton's impressive member while your " +
                        this.vaginaDescript(0) +
                        " moistens almost immediately from the steam and arousal.",
                    false
                );
            ...
            this.outx("She continues kissing a trail down your belly and to your crotch.", false);
            if (this.player.hasCock()) {
                // (If PC has a large penis, bigger than Cotton's capacity, add)
            ...
            if (this.player.isNaga()) {
                this.outx(
                    "Cotton continues the kisses down to your " +
                        this.player.legs() +
                        ", and stands, grabbing you by the waist and lifting you up off the ground.  "
                );
                if (this.pregnancy.event > 1)
                    this.outx(
                        "Moving quickly, you wrap your arms around Cotton's neck and coil your body around her waist, just below her round, pregnant belly, and down one leg.  You can feel her swollen midriff rubbing against the scales on your serpentine half with each motion you make."
                    );
                else
                    this.outx(
                        "Moving quickly, you wrap your arms around Cotton's neck and coil your body around her waist and down one leg.",
                        false
                    );
            }
            // (If Humanoid body)
                ...
                this.outx(
                    "Cotton continues the kisses down to your " +
                        this.player.legs() +
                        " and stands, hooking an arm underneath each of your legs and lifting you up off the ground.  "
                );
                if (this.pregnancy.event > 1)
                    this.outx(
                        "Moving quickly, you wrap your arms and legs around Cotton so you don't fall over, carefully avoiding her pregnant belly, which is no mean feat. Her belly is pressed into yours, letting you feel the solid weight of it, gentle kicks from your unborn child within."
                    );
                else
                    this.outx(
                        "Moving quickly, you wrap your arms and legs around Cotton so you don't fall over.",
                        false
                    );
            }
            this.outx(
                "  She gives you a quick kiss and moves her cock to your " +
                    this.player.assholeOrPussy() +
            ...
            this.outx(
                "She can't quite fit her entire girth into you at this angle, but that doesn't matter as it feels absolutely exquisite. You take turns kissing each other's necks and nibbling on each other's ears while she thrusts in and out.  "
            );
            if (this.pregnancy.event > 1) {
                this.outx(
            ...
            this.outx(
                "Your body shivers and quakes as a miniature orgasm rockets through you, somehow making your whole body more sensitive.  "
            );
            this.outx(
                "Your powerful partner holds you close, her jet black cock pistoning in and out of your hole. You feel safe in her arms, secure in a way you rarely feel elsewhere. You wrap your arms more tightly around her, hugging Cotton close and biting your lip, stifling your moans and groans of passion.\n\n",
                false
            );
            ...
            this.outx(
                "Exhausted, Cotton sets you down on the shower floor under the spray of water, though cum leaks from your abused hole and your " +
                    this.player.legs() +
                    " quivering so much you nearly collapse. Your partner steadies you, however, and you regain your footing quickly. You return to the task of cleaning yourselves, sensually washing each other's most intimate areas. Yoga, sex and cleanup done, you get dressed and leave the gym, giving Cotton's hand a final squeeze before departing.",
                false
            );
        }
    ...
    public cottonTantricSex(): void {
        this.spriteSelect(12);
        this.outx("", true);
        this.outx(this.images.showImage("cotton-tantric-sex"));
        this.player.slimeFeed();
        this.flags[kFLAGS.COTTON_MET_FUCKED] = 2;
        // OLD TANTRIC SMEX
        /* outx("You decide to ask instead about using yoga to blow off some steam. She grins, \"<i>I know just what you need. It's called tantric sex, and I think you're just limber and quick enough to try it.</i>\"\n\n", false);

        outx("She leads you to a private room in the gym and sets up a larger mat. She disrobes and you do the same. She sits on the mat and you sit opposite her. You spend a couple minutes just breathing, exploring your partner's body with your eyes only. Then Cotton slips her legs outwards, and leans backwards, letting her enormous member to waggle freely in the air. She curls a finger at you, and gives you your instructions.\n\n", false);

        outx("You stand and straddle her hips, facing her, carefully lowering yourself down onto her length. You take your time, matching your breathing with hers, until you're completely impaled. Then you stretch your legs out behind your partner and also lean back. You both gyrate your hips as your bodies glisten with a light sheen of sweat.");
        player.buttChange(72,true,true,false);
        outx("\n\n", false);

        outx("After several minutes of this you switch positions, with Cotton leaning forward and grabbing you under the waist while you curl your legs under you. Then Cotton pulls herself up into a kneeling position while still inside you, pushing your head and shoulders down onto the mat and your legs up into the ceiling. Several more positions later, your breathing is a little ragged but still in sync, and it's clear neither of you can take much more of this.\n\n", false);

        outx("With one last pose, you both stand, Cotton grabs your hips and you lean down to grab your ankles. Your whole body shivers with sexual energy, feeling like it's on fire with orgasmic light as your equine lover gives one final thrust into you and explodes, her own body shivering and shuddering. Unable to remain standing any longer, you flop down onto the mat, letting Cotton's seed slowly leak out of you, while Cotton lays down next to you, equally exhausted.\n\n", false);

        outx("\"<i>I must say, my little pet, you are the best yoga partner I've had in a long time.</i>\" You share a kiss and take a moment to rest before heading to the showers and then heading home.", false);*/
        // NU HOTNESSSSS
        ...
        this.outx(
            '"<i>And our spirits are joined... for now,</i>" she laughs and runs her hands along her upper torso, and in a weird, sort of detached way, you feel it. You touch your chest, rubbing a ' +
                this.nippleDescript(0) +
        ...
        if (this.player.hasCock()) this.outx(" familiar");
        else this.outx(" alien");
        this.outx(
        ...
        this.outx(
            "Though there's no real thrusting or vulgar movements of any kind, the feelings are intense, likely heightened by your tantric link. You can simultaneously feel Cotton's long equine cock pulse within you, as well as feel your own " +
                this.player.assholeOrPussy() +
                " clamping down on a cock that is not your own.",
            false
        );
        if (this.player.hasVagina()) this.player.cuntChange(72, true, true, false);
        else this.player.buttChange(72, true, true, false);
        ...
        this.outx('"<i>Now let\'s move on to the Lotus,</i>" Cotton says, and sits up.', false);
        // (Naga body, add)
        if (this.player.isNaga())
            this.outx(
        ...
        this.outx(
            '"<i>One last pose, pet, the head game.</i>"  She grips your ' +
                this.hipDescript() +
        ...
        // (for Humanoid bodies)
            ...
            this.outx(
                "Cotton takes a firm grip on your hips and ass, making sure you don't slip, so you carefully extend your " +
                    this.player.legs() +
                    " out, then over and around Cotton's arms, only pausing to make sure she has a decent grip on your new position, and rest both of your feet on your equine lover's shoulders. The feeling is quite intense and unique, though at this angle Cotton's cock doesn't fit completely inside you.",
                false
            );
        this.outx("\n\n", false);
        ...
        this.outx(
            "Then in a flash, it's gone. The lightning subsided, you both collapse sideways onto the floor, panting. The tantric link is apparently gone, and you suddenly feel very alone. Cotton, seemingly sensing this, pulls out and curls up next to you, cuddling you until the sudden feeling of loss dissipates.\n\n",
            false
        );
        ...
        this.player.orgasm();
        this.dynStats("tou", 0.25, "spe", 0.25, "lib", -0.25, "sen", -0.25);
        if (this.player.hasVagina()) this.cottonPregPCChance();
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private leaveCotton(): void {
        this.spriteSelect(12);
        this.outx("", true);
        this.outx("You thank Cotton for her time, shower and head back to camp.");
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    public nomSomeTitMilkCereal(): void {
        ...
        this.outx(
            "Cotton sets the bowl down in your lap and pulls down the front of your " +
                ...
                ", exposing your " +
                this.chestDesc() +
                " to the cool morning breeze. A shiver runs down your spine and your nipples immediately begin to harden, as if knowing what this equine girl has in mind. Cotton leans down and wraps her lips around one " +
                this.nippleDescript(0) +
        ...
        this.outx(
            "You feel the familiar sensation of fluids being drawn from you, and soon Cotton is suckling from your milky tit. She relinquishes her hold on the teat, smacks her lips, and brings the bowl up to your breast. With the other hand, she grabs your " +
                this.nippleDescript(0) +
        ...
        this.outx(
            "Just like that, Cotton's hand leaves your breast, though the hot and aroused feeling doesn't leave. You open your eyes and look at her. She gives you a smile and takes a bite of grains.\n\n",
            false
        );

        this.outx(
            '"<i>Mmm, you are so tasty, pet,</i>" she trills, "<i>Here, try a bite.</i>" She lifts a spoon full of grain, oats and milk to your mouth. You hesitantly take a bite and can\'t help but smile. The sweet, smooth taste of your milk perfectly complements the grains. You munch on it and swallow, and have another bite.\n\n',
            false
        );

        this.outx(
            "You chat about inconsequential things, mostly the Tel'Adre rumor mill, while you both eat from the bowl. When it's completely gone, Cotton licks out the bowl and packs everything up.\n\n",
            false
        );

        this.outx(
            "\"<i>Thanks, pet, that was delicious. I'll be sure to stop by another time so we can share a meal. Feel free to come by the gym too. We can get a little more... personal.</i>\" She kisses you on the cheek, and then departs back towards Tel'Adre.",
            false
        );
    ...
    private cottonPregnantAlertII(): void {
        this.clearOutput();
        this.outx(this.images.showImage("cotton-you-got-her-preggo"));
        this.outx(
            '"<i>Hello, pet,</i>" she says, and you notice worry in her voice.  There are slight bags under her eyes, and her crimson ponytail is a little unkempt, with hair jutting out at odd angles.  Something clearly has her frazzled.'
        );
        this.outx(
        ...
        if (
            this.flags[kFLAGS.EDRYN_NUMBER_OF_KIDS] > 0 ||
            (this.telAdre.edryn.pregnancy.isPregnant &&
                this.flags[kFLAGS.EDRYN_PREGNANT_AND_NOT_TOLD_PC_YET] != 0)
        )
            this.outx("  Should have figured as much after you got Edryn pregnant.");
        this.outx(
            '</i>"  She wrenches her hands nervously and looks you in the eye. The cool, confident yoga instructor has clearly melted away, revealing the real her.  "<i>I know we\'re not serious, but '
        );
        if (this.flags[kFLAGS.EDRYN_NEVER_SEE_AGAIN] == 0)
            this.outx("you'll stick with me through this, right?");
        else this.outx("you won't abandon me like you did Edryn, will you?");
        this.outx('</i>"');
        // [Leave Her] [Stay]
        this.menu();
    ...
    private beABadCottonDad(): void {
        this.clearOutput();
        this.outx(
            "You shake your head.  You certainly can't deal with a kid.  You tell her point blank that you want nothing to do with the child.  Tears well up in her eyes, and her mouth opens and closes several times, without a single sound coming out."
        );
        this.outx(
        ...
        if (this.flags[kFLAGS.EDRYN_NEVER_SEE_AGAIN] == 0)
            this.outx("and slaps you as hard as she can");
        else this.outx("and punches you as hard as she can");
        this.outx(". \"<i>Fuck you 'pet'.");
        if (this.flags[kFLAGS.EDRYN_NEVER_SEE_AGAIN] > 0) this.outx("  That was for Edryn too.");
        this.outx('</i>"  With that, she turns on her hoof and leaves.');
        // bold
        this.outx("<b>(Cotton will no longer speak with you.)</b>");
    ...
    private beAGoodCottonDad(): void {
        this.clearOutput();
        this.outx(
            "You take her by the shoulders and nod.  You confirm that of course you'll be there for her, whatever she needs."
        );
        this.outx(
    ...
    private cottonPopsOutAKid(): void {
        ...
        this.clearOutput();
        this.outx(this.images.showImage("cotton-giving-birth"));
        if (this.flags[kFLAGS.COTTON_KID_COUNT] == 0) {
            this.outx(
            ...
            // {Silly Mode:}
            if (this.silly()) this.outx("As long as the cube shark isn't there.  ");
            this.outx("Let's go.</i>\"");
            // (Depending on PC height:
            if (this.player.tallness < 60) this.outx("She wraps an arm around your neck");
            else if (this.player.tallness < 70) this.outx("She places a hand on your shoulder");
            else if (this.player.tallness < 86)
                this.outx("She wraps an arm around your midsection");
            else this.outx("She wraps an arm around your waist");
            this.outx(
            ...
            if (Cotton.rand(3) == 0) kid = 1;
            else if (Cotton.rand(2) == 0) kid = 2;
            else kid = 3;
            this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] = kid;
            if (kid == 1) this.outx("male");
            else if (kid == 2) this.outx("female");
            else this.outx("herm");
            this.outx(" foal.");

            this.outx("\n\nCotton turns and <i>awww's</i> as she catches sight of her ");
            if (kid == 1) this.outx("son");
            else this.outx("daughter");
            this.outx(" for the first time.  Though you don't want to let ");
            if (kid != 1) this.outx("her");
            else this.outx("him");
            this.outx(" go, you relinquish your grasp as Cotton's arms sweep ");
            if (kid != 1) this.outx("her");
            else this.outx("him");
            this.outx(
                " up.  With one hand she lifts up her top, exposing her large brown nipples, and pulls the child to one, where it latches on and suckles like a pro.  You just watch, ready to look away if Cotton asks, but she seems too preoccupied with nursing her new baby to pay much attention to you."
            );
            this.outx(
            ...
            if (kid == 3) this.outx("  I guess it runs in the family.");
            this.outx('</i>"');
            ...
            if (kid < 2) this.outx("guy");
            else this.outx("girl");
            this.outx(
                ' situated.</i>"  She takes the bundle from you, retrieves a fresh clean blanket, and within seconds has '
            );
            if (kid != 1) this.outx("her");
            else this.outx("him");
            this.outx(
                " expertly swaddled.  Cotton sets the child in the crib and stands back to admire her handiwork. You step up beside her and wrap an appreciative arm around her waist, telling her that she's done a wonderful job."
            );
            this.outx(
        ...
        // (Replaces the Approach scenes)
            ...
            if (kid == 1) this.outx("boy");
            else if (kid == 2) this.outx("girl");
            else this.outx("herm");
            this.outx('!</i>" she says happily, pulling you into a hug.  "<i>We could go see ');
            if (kid != 1) this.outx("her");
            else this.outx("him");
            this.outx(" if you like, ");
            if (kid != 1) this.outx("she");
            else this.outx("he");
            this.outx("'s at the daycare here, I wanted to keep a close eye on ");
            if (kid != 1) this.outx("her");
            else this.outx("him");
            this.outx(' today.</i>"');
            ...
            this.outx(", if Cotton thinks that won't upset ");
            if (kid != 1) this.outx("her");
            else this.outx("him");
            this.outx(".");
            ...
            this.outx(" good to see ");
            if (kid != 1) this.outx("her");
            else this.outx("him");
            this.outx(
                ' daddy,</i>" she says, and leads you down a corridor and into a room marked "<i>DAYCARE</i>".  As soon as the door opens, you\'re assaulted by the laughs and giggles of kids playing.'
            );
            ...
            this.outx("'s just down for a nap right now.  Would you like to see ");
            if (kid != 1) this.outx("her");
            else this.outx("him");
            this.outx(
                "?</i>\"  You both nod your heads in the affirmative, and are taken to an off-room.  It's dark, but there's a crib just by the door, and you can make out a slumbering baby with its mother's horse ears twitching as it dreams whatever babies dream."
            );
            ...
            this.outx(
                " over and then back out of the room, content with the knowledge that you'll get to spend more time with "
            );
            if (kid != 1) this.outx("her");
            else this.outx("him");
            this.outx(
    ...
    private cottonContraceptionToggle(): void {
        ...
        this.outx("You ask the ");
        if (this.pregnancy.isPregnant) this.outx("pregnant ");
        this.outx("she-stallion if she's still taking her contraceptive herbs.");
        ...
        // (Cottonpreg:
        if (this.player.gender != 3 || this.pregnancy.isPregnant) this.outx("virile");
        else this.outx("fertile");
        this.outx(
            "; you actually broke right through the protection they were supposed to give me from ending up a mommy or a daddy.  I may as well not be taking them at all when I'm with you, don't you think?</i>\" she concludes."
        );

        this.outx(
            "\n\nYou admit that kind of makes sense to you, but it's not as if you're guaranteed to get through their protection, right?\n\n\"<i>"
        );
        if (this.flags[kFLAGS.COTTON_KID_COUNT] < 3)
            this.outx('Well that\'s true,</i>" she admits.  "<i>But I leave it up to you, pet.');
        else
            this.outx(
                "Well, considering the brood we have, they've already proven pretty useless, haven't they?   So, while I'll keep taking them if you want me to, I don't see much point in it."
            );
        this.outx('</i>"');
    ...
    private tellCottonStopEatingHorsePills(): void {
        this.clearOutput();
        this.outx(
            "You tell Cotton that, if they're going to be that useless to her, and she doesn't mind the idea of potentially having more kids, she has your permission to stop taking them."
        );
        this.outx(
    ...
    private tellCottonToKeepFiringBlanksAsshole(): void {
        this.clearOutput();
        this.outx(
            "You tell Cotton you'd rather not force her to have any more kids, so she should keep taking the herbs; in your opinion, imperfect protection is better than no protection."
        );

        this.outx('\n\nCotton nods, "<i>All right then.  As they say, better safe than ');
        if (!this.silly()) this.outx("sorry");
        else this.outx("overrun by a herd of little horsefolk");
        this.outx(', right?</i>"');
    ...
    public goTellCottonShesAMomDad(): void {
        this.clearOutput();
        this.outx(
            "Convinced that Cotton is the father of the child in your womb, at daybreak, you pack your usual things and head off to Tel'Adre.  Stopping in at the gym, you ask for directions to Cotton's place, and then make your way there."
        );
        this.outx(
    ...
    public birthingCottonsKids(): void {
        ...
        this.outx("!  Like ");
        if (kid == 1) this.outx("his");
        else this.outx("her");
        this.outx(" 'father', ");
        if (kid == 1) this.outx("he");
        else this.outx("she");
        this.outx("'s hairless except on ");
        if (kid == 1) this.outx("his");
        else this.outx("her");
        this.outx(" head, where there's a light sprinkling of dark hair.  ");
        if (kid == 1) this.outx("His");
        else this.outx("Her");
        this.outx(" feet end in tiny pristine hooves, and a little brush of a tail extends from ");
        if (kid == 1) this.outx("his");
        else this.outx("her");
        this.outx(" backside.");
        ...
        this.outx(", bundle ");
        if (kid == 1) this.outx("him");
        else this.outx("her");
        this.outx(" up good and tight, get dressed, and head off towards Tel'Adre.");
        ...
        this.outx(
            ".  Eventually they remember you're here and disperse, waving you inside.  As you look back, you see one guard light up a cigar and pass others around."
        );
        ...
        if (this.flags[kFLAGS.PC_IS_A_DEADBEAT_COTTON_DAD] > 0) {
            ...
            this.outx(".  She takes the child from you, holding ");
            if (kid == 1) this.outx("him");
            else this.outx("her");
            this.outx(" close with practiced grace.");
        ...
        // [First Child with Cotton?]
            ...
            if (kid == 1) this.outx("He'll");
            else this.outx("She'll");
            this.outx(
                " be so happy here, pet, I promise you.  I'm an excellent momma, or daddy, as the case may be.  I don't know if I've ever told you, but I had a couple of kids a few years back.  Twins.  Boy they were rambunctious little devils.  Couldn't sit still,</i>\" she smiles wistfully."
            );
        ...
        // [Additional Kids]
            ...
            this.outx("'s so cute, pet.  We sure do make 'em good.  ");
            if (kid == 1) this.outx("He");
            else this.outx("She");
            this.outx("'ll just love it here with ");
            if (kid == 1) this.outx("his");
            else this.outx("her");
            this.outx(
                ' family,</i>" Cotton declares.  You nod your head, then ask if Cotton will be okay looking after one more child?'
            );
    ...
    private visitCottonKids(): void {
        this.clearOutput();
        this.outx(
            "You tell Cotton that, if it's okay with her, you'd like to skip exercising today; you were hoping that you could visit your "
        );
        if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) this.outx("kid");
        else this.outx("kids");
        this.outx(
            ", instead? Cotton's eyes widen in surprise before a happy grin splits her face.  \"<i>Sure, pet, all you had to do was ask!  Give me a minute to get my stuff, and then we'll go and see "
        );
        if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) {
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] == 1) this.outx("him");
            else this.outx("her");
        } else this.outx("them");
        this.outx(
            ', all right?</i>"  You nod your head and watch as the equine yoga instructor busies herself gathering her few daily belongings, then follow her as she heads back home, eager to see how your '
        );
        if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) {
            this.outx("child is");
        } else this.outx("children are");
        this.outx(" doing.");
        ...
        if (scene == 0) {
            this.outx("\n\nYour ");
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("baby girl is");
            else this.outx("baby boy is");
            this.outx(" sitting up in ");
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
            else this.outx("his");
            this.outx(
                " crib when you both enter, cooing happily and babbling like babies do, clearly happy in "
            );
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
            else this.outx("his");

            this.outx(' own little way to see you.  Cotton smiles at you, "<i>Watch this; ');
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("she");
            else this.outx("he");
            this.outx(
                ' loves this game,</i>" she tells you, and then slowly kneels before the crib.  "<i>Hello, my little sweet, hellooo.</i>"  Cotton coos, patting the '
            );
            if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) this.outx("baby");
            else this.outx("babies");
            this.outx(" on the nose and babbling to ");

            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] == 1) this.outx("him");
            else this.outx("her");

            this.outx(" in that way that parents of small children tend to do.  When the little ");
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] == 1) this.outx("colt");
            else this.outx("filly");
            this.outx(
                ' foal is giggling merrily, Cotton slowly cover her eyes with her hands.  "<i>Where\'s the baby? Where\'s the little baby?</i>" she asks, then quickly uncovers her eyes, adopting an exaggerated expression of surprise.  "<i>Why, there '
            );
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] == 1) this.outx("he");
            else this.outx("she");
            this.outx(
                ' is!</i>"  She gasps, making the baby laugh in delight.  She repeats this several times, the baby enjoying it thoroughly.  You ask Cotton if you can try, and she agrees; '
            );
            this.outx("your baby seems");
            this.outx(" a little surprised to see you, but that doesn't stop ");

            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
            else this.outx("him");
            this.outx(" from laughing just as hard at you as ");
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] == 1) this.outx("he");
            else this.outx("she");
            this.outx(
            ...
            if (this.flags[kFLAGS.COTTON_KID_COUNT] > 1) {
                this.outx("\n\nYour other ");
                if (this.flags[kFLAGS.COTTON_KID_COUNT] == 2) this.outx("baby is");
                else this.outx("babies are");
                this.outx(
                    " clearly enjoying it just as much as your first-born, giggling and clapping at yours and Cotton's antics, even clumsily trying to mimic the game themselves."
                );
            }
            this.outx("\n\nEventually, though, ");
            if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) {
                if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("she grows tired");
                else this.outx("he grows tired");
            } else this.outx("they grow tired");
            this.outx(" and, still giggling, settle");
            if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) this.outx("s");
            this.outx(" down to sleep.  You and Cotton fuss over ");
            if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) {
                if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
                else this.outx("him");
            } else this.outx("them");
            ...
            this.outx(" in and mussing ");
            if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) {
                if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
                else this.outx("his");
            } else this.outx("their");
            this.outx(" hair gently, but watch until ");
            if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) {
                if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("she goes");
                else this.outx("he goes");
            } else this.outx("they go");
            this.outx(" to sleep.  You share a smile with your equine lover, kiss your ");
            if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) {
                this.outx("kid on the cheek");
            } else this.outx("kids on the cheeks");
            this.outx(
        ...
        // Little Angel
            ...
            if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) this.outx("your baby is");
            else this.outx("all your children are");
            this.outx(" fast asleep.  Rather than disturb ");
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
            else this.outx("him");
            this.outx(
            ...
            this.outx(" to get some rest together.");
        }
        // Breastfeeding
        else if (scene == 2) {
            ...
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("daughter");
            else this.outx("son");
            this.outx(
                ' starts to wail and cry, the mare looking tired.  "<i>Oh, you\'re hungry again my little one?  All right, all right, mommy will get your milk, just give me a moment...</i>"'
            );
            if (this.flags[kFLAGS.COTTON_KID_COUNT] > 1)
                this.outx(
            ...
            if (this.player.lactationQ() >= 50) {
                this.outx("  You could probably offer to nurse your ");
                if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] != 1) this.outx("daughter");
                else this.outx("son");
                this.outx(
        ...
        // Cuddlebug
            ...
            this.outx(" stares up at you with eyes wide and wet, sniffling audibly as ");
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("she");
            else this.outx("he");
            this.outx(
                ' makes tiny little sobs.  "<i>Aw, looks like somebody was lonely,</i>" Cotton coos, then gives you a meaningful nudge.  Realising she wants you to hold your child, you step forward and gently lift '
            );
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
            else this.outx("he");
            this.outx(" up into your arms, commenting on what a big, heavy ");
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("girl");
            else this.outx("he");
            this.outx(
                "'s getting to be.  The baby is scared and hesitant, and bursts into tears at first, but you croon and shush "
            );
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
            else this.outx("he");
            this.outx(" gently, holding the foal close to your ");
            this.outx("[chest] and rocking ");
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
            else this.outx("him");
            this.outx(
                " back and forwards; soon enough, the foal's cooing and snuggling eagerly against you as you cuddle "
            );
            if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
            else this.outx("him");
            this.outx(".");
            ...
            this.outx(
                " little ears flick in the most adorable manner.  So caught up are you in cuddling your child that you don't notice Cotton until she has her arms wrapped around you, leaning her head against you as she embraces the pair of you."
            );
    ...
    private feedYourCottonKids(): void {
        this.clearOutput();
        this.outx(
            "You interrupt Cotton by pointing out that you have breasts full of milk; you'd be happy to nurse the little "
        );
        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("filly ");
        else this.outx("cotton ");
        this.outx(" for her, if she wants.");
        ...
        this.outx(" to you, by which time you have already exposed your [chest].");

        this.outx("\n\nYou carefully take your child from Cotton's hands, feeling ");
        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
        else this.outx("his");
        this.outx(" weight in your arms, before bringing ");

        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
        else this.outx("him");

        this.outx(" in close");
        this.outx(".  At first, the baby is confused and whimpers quietly in fear, but ");

        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
        else this.outx("his");

        this.outx(
            " presence and weight make your boobs start releasing their sweet cargo.  As the scent of milk fills the air, the baby's instincts take over and it brings its little face in to first nuzzle your [nipple], and then finally close "
        );
        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
        else this.outx("his");
        this.outx(" lips around it.");
        ...
        this.outx(
            " back and forth, quietly starting to sing whatever dredges of lullabies you can remember overhearing from the nursing mothers back in your own village in Ingnam.  You can feel "
        );
        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
        else this.outx("his");
        this.outx(" little heart beating inside ");
        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
        else this.outx("his");
        this.outx(" breast, and you wonder if ");
        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("she");
        else this.outx("he");
        this.outx(" can hear your heart inside of yours.");
        ...
        if (this.flags[kFLAGS.COTTON_KID_COUNT] == 1) this.outx(" needs");
        else this.outx("ren need");
        this.outx(
            ' all the energy they can get.</i>" Her hands begin to massage your shoulders and back, kneading the flesh, helping you to relax.'
        );
        ...
        this.outx(
            " is just a sleepy little thing who needs to go to bed, you tell her, and you gently put the baby back in "
        );
        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
        else this.outx("his");
        this.outx(
            " crib to get some sleep.  You recover your breasts and ask if Cotton will be okay looking after them now, or if you should stick around and help out a little longer?"
        );
    ...
    private letCottonFeedKids(): void {
        ...
        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2)
            this.outx('her down for her nap, hm pet?</i>"');
        else this.outx('him down for his nap, hm pet?</i>"');

        this.outx("\n\nYou nod your head to her and gently place the sleepy baby back in ");
        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
        else this.outx("his");
        this.outx(" crib.  You ruffle ");
        if (this.flags[kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2) this.outx("her");
        else this.outx("his");
        this.outx(
            " hair and tell Cotton that she makes some gorgeous little foals.  She just nods and gives your shoulder a little squeeze, content to watch in silence for a moment."
        );
