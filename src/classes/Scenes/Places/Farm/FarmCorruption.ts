...
export class FarmCorruption extends AbstractFarmContent {
    ...
    public collectTheGoodies(): void {
        ...
        if (this.flags[kFLAGS.FARM_SUCCUMILK_STORED] > 0) {
            this.outx("<b>" + this.flags[kFLAGS.FARM_SUCCUMILK_STORED] + "x ");
            if (this.flags[kFLAGS.FARM_SUCCUMILK_STORED] == 1) this.outx("vial of Succubi milk.");
            else this.outx("vials of Succubi milk.");
            this.outx("</b>\n");
            this.addButton(
                0,
        ...
        if (this.flags[kFLAGS.FARM_INCUDRAFT_STORED] > 0) {
            this.outx("<b>" + this.flags[kFLAGS.FARM_INCUDRAFT_STORED] + "x ");
            if (this.flags[kFLAGS.FARM_INCUDRAFT_STORED] == 1) this.outx("vial of Incubi draft.");
            else this.outx("vials of Incubi draft.");
            this.outx("</b>\n");
            this.addButton(
                1,
        ...
        if (this.flags[kFLAGS.FARM_EGG_STORED] > 0) {
            this.outx("<b>" + this.flags[kFLAGS.FARM_EGG_STORED] + "x ");
            this.outx(
                "large " + this.flags[kFLAGS.FOLLOWER_PRODUCTION_SOPHIE_COLORCHOICE] + " egg"
            );
            if (this.flags[kFLAGS.FARM_EGG_STORED] > 1) this.outx("s");
            this.outx(".");
            this.outx("</b>\n");
            this.addButton(
                2,
        ...
        if (this.flags[kFLAGS.FARM_CONTRACEPTIVE_STORED] > 0) {
            this.outx("<b>" + this.flags[kFLAGS.FARM_CONTRACEPTIVE_STORED] + "x ");
            this.outx("bundle of Herbal Contraceptive.");
            this.outx("</b>\n");
            this.addButton(
                3,
    ...
    protected takeoverPromptKelly(): void {
        ...
        if (kGAMECLASS.amilyScene.amilyCorrupt() || kGAMECLASS.jojoScene.campCorruptJojo()) {
            this.outx(" and the rodent slut");
            if (kGAMECLASS.amilyScene.amilyCorrupt() && kGAMECLASS.jojoScene.campCorruptJojo()) {
                this.outx("s");
            }
            this.outx(" before him");
        }
        this.outx("?");
    }
    ...
    public takeoverPromptNow(): void {
        ...
        if (
            ...
            if (this.flags[kFLAGS.KELT_BREAK_LEVEL] >= 4) this.outx(" Kelt");
            else this.outx(" Marble");
            this.outx(
    ...
    public rootScene(): void {
        ...
        if (!this.whitneyCorrupt()) {
            ...
            this.outx("You stand on your rise and take in your slave farm. ");
            if (this.silly()) {
                this.outx(
                    this.player.mf(
    ...
    private keltAChangeInManagement(): void {
        ...
        if (this.player.balls == 0) this.outx(" So to speak, anyway.");
        this.outx(
    ...
    private dogeNotCorruptYet(): void {
        ...
        if (this.whitneyCorruption() >= 91 && this.whitneyCorruption() <= 119) {
            ...
            if (this.flags[kFLAGS.WHITNEY_MENU_91_119] == 0) {
                ...
                // Subsequent 91-119:
                this.outx("Whitney lays down her work eagerly as you approach. ");
    ...
    private whitneyAppearanceCorrupt(): void {
        ...
        this.outx("Whitney is a 5’8” dog");
        ...
        if (this.whitneyHasTattoo()) {
            ...
            if (this.flags[kFLAGS.WHITNEY_TATTOO_COLLARBONE] != "")
                this.outx(this.flags[kFLAGS.WHITNEY_TATTOO_COLLARBONE] + "\n");
            if (this.flags[kFLAGS.WHITNEY_TATTOO_SHOULDERS] != "")
                this.outx(this.flags[kFLAGS.WHITNEY_TATTOO_SHOULDERS] + "\n");
            if (this.flags[kFLAGS.WHITNEY_TATTOO_LOWERBACK] != "")
                this.outx(this.flags[kFLAGS.WHITNEY_TATTOO_LOWERBACK] + "\n");
            if (this.flags[kFLAGS.WHITNEY_TATTOO_BUTT] != "")
                this.outx(this.flags[kFLAGS.WHITNEY_TATTOO_BUTT] + "\n");
        }

        this.outx("\n");
        if (!this.whitneyDefurred())
            this.outx("Her fur is sandy, dusking to black at her extremities");
        else this.outx("Her skin is a sandy color, and she wears black nail varnish");
        this.outx(
    ...
    private prosperityGoNotCorrupt(): void {
        ...
        this.outx("You ask her how the help is coming on.");
    ...
    private doBreastMilkerInvestment(): void {
        ...
        this.outx("You silently hand over a hefty bag of gems. Whitney stows it away.");
    ...
    private doContraceptiveInvestment(): void {
        ...
        if (!this.whitneyCorrupt()) {
            this.outx("You hand over the dough. Whitney stows it away.");
    ...
    private dontDeFurDoge(): void {
        ...
        if (this.player.hasCock()) this.outx(" crotch into");
        else this.outx(" hips against");
        this.outx(
    ...
    private dogeCorruptedMissionComplete(output = true): void {
        ...
        if (this.whitneyDom() && output) {
            this.outx("Whitney is in front of you before you’ve finished calling her name.");
    ...
    private firstOralTraining(): void {
        ...
        this.outx(". You tell her huskily it’s time she learned how to service you.");
        ...
        if (this.player.hasCock()) this.outx(" cocksucker");
        else
            this.outx(
                " pussy eater" +
        ...
        if (this.silly()) this.outx(" “<i>Do. Or do not. There is no try.</i>”");
        else this.outx(" “<i>You will.</i>”");
        this.outx(" Determination lines the dog woman’s mouth.");
    ...
    private firstCockOralTrainingStageTwo(): void {
        ...
        if (!this.player.hasVagina()) {
            ...
            if (this.player.cocks.length > 1) this.outx(" and [cock biggest2]");
            this.outx(
    ...
    private firstCockOralTrainingStageThree(): void {
        ...
        if (!this.player.hasVagina()) {
            ...
            if (this.player.cocks.length > 2) {
                ...
                if (this.player.cocks.length > 1)
                    this.outx(" jerking both your cocks with her smooth, exacting grasp in tandem");
                this.outx(".");
            }
            ...
            if (this.player.cocks.length > 1) {
                this.outx(" all the while your [cock biggest2]");
                if (this.player.cocks.length > 2) this.outx(" and [cock biggest3]");
                this.outx(" bulge and vibrate with pleasure in her pumping hand");
            ...
            if (this.player.cocks.length > 1 || this.player.cumQ() >= 1500) this.outx("\n\n");
            if (this.player.cocks.length > 1) {
                this.outx("She doesn’t forget the cock");
                if (this.player.cocks.length > 2) this.outx("s");
                this.outx(" trapped in her grasp for a moment; she milks");
                if (this.player.cocks.length > 2) this.outx(" them");
                else this.outx(" it");
                this.outx(" as hard as you’re fucking her mouth, and");
                if (this.player.cocks.length > 2) this.outx(" they flex");
                else this.outx(" it flexes");
                this.outx(
                    " out cum just as eagerly as the first, delirium seizing you as you are clenched by your"
                );
                if (this.player.cocks.length == 2) this.outx(" twin");
                else if (this.player.cocks.length == 3) this.outx(" triple");
                else this.outx(" transcendent");
                this.outx(" high;");
                if (this.player.cocks.length > 2) this.outx(" they paint");
                else this.outx(" it paints");
                this.outx(" her skirt with");
                if (this.player.cocks.length > 2) this.outx(" their");
                else this.outx(" its");
                this.outx(" generous discharge. ");
            }
            if (this.player.cumQ() >= 1500) {
                this.outx(
        ...
        // Herm
            ...
            if (this.player.biggestCockLength() < 8) this.outx("the back of her mouth");
            else this.outx("her gullet");
            this.outx(" as you spear decisively inwards.");
            ...
            if (this.player.wetness() > 2) this.outx("soaking her arm as it gutters your juices, ");
            this.outx("heightening the ecstasy you feel to mind-blowing heights. ");
            if (this.player.cocks.length > 1)
                this.outx(
    ...
    private cockOralTrainingStageThree(): void {
        ...
        if (this.player.cocks.length >= 2) this.outx(", allowing your other cock");
        if (this.player.cocks.length > 2) this.outx("s");
        if (this.player.cocks.length >= 2) this.outx(" to unfurl and bob behind it");
        if (this.player.hasVagina() && this.player.cocks.length >= 2) this.outx(" and");
        if (this.player.hasVagina()) this.outx(", leisurely exposing your moist [vagina]");
        if (this.player.cocks.length >= 2 && this.player.hasVagina())
            this.outx(" at the same time");
        this.outx(", perfuming the air around her with your heavy musk.");
        ...
        if (!this.player.hasVagina()) {
            ...
            if (this.player.balls > 0)
                this.outx(", your saliva-glossed [balls] beating against her chin");
            this.outx(
            ...
            if (this.player.cocks.length > 1) {
                ...
                this.outx(" as hard as you’re fucking her mouth, and");
                if (this.player.cocks.length == 2) this.outx(" it flexes");
                else this.outx(" they flex");
                this.outx(
                    " out cum just as eagerly as the first, delirium seizing you as you are clenched by your"
                );
                if (this.player.cocks.length == 2) this.outx(" twin");
                ...
                this.outx(" high;");
                if (this.player.cocks.length == 2) this.outx(" it paints");
                else this.outx(" they paint");
                this.outx(" her skirt with ");
                if (this.player.cocks.length == 2) this.outx(" its");
            ...
            if (this.player.cocks.length > 1) this.outx(" all of");
            this.outx(" your cock");
            ...
            if (this.player.cocks.length > 1) this.outx("s");
            this.outx(" to make the last of it drool out.");
        ...
        // Herm
            ...
            if (this.player.biggestCockLength() < 8) this.outx("mouth");
            ...
            if (this.player.cocks.length > 1) {
                ...
                if (this.player.cocks.length == 2) this.outx("triple");
                else this.outx("transcendent");
                this.outx(" high; it paints her skirt with its generous discharge.");
            }
    ...
    private cockOralTrainingMaxed(): void {
        ...
        if (!this.player.hasVagina()) {
            ...
            this.outx(" You open your mouth to the shifting delectation inundating [eachCock].");
            ...
            if (this.player.cocks.length > 1)
                this.outx("In the long, delicious daze that follows you move her around");
            if (this.player.cocks.length == 2)
                this.outx(", switching her attention to your [cock biggest2] for a while");
            else if (this.player.cocks.length >= 3)
                this.outx(" switching her attention first to one cock and then the other");
            if (this.player.cocks.length > 1)
                this.outx(
            ...
            if (this.player.balls > 0)
                this.outx(" and her tongue once again sliding across your [balls], ");
            this.outx(
            ...
            if (this.player.cocks.length > 1)
                this.outx(", her hands wrapping back around your other cock");
            if (this.player.cocks.length > 2) this.outx("s");
            if (this.player.cocks.length > 1) this.outx(" as if they never left them");
            this.outx(
        ...
        // Herm
            ...
            if (this.player.cocks.length >= 3)
                this.outx(", switching her first to one cock then another");
            if (this.player.cocks.length > 1)
                this.outx(
                    " so that each of your fiercely erect pricks has time to enjoy the tight, sucking embrace of her mouth."
                );
            ...
            if (this.player.cocks.length > 1)
                this.outx(" and her other hand wrapping back around your [cock biggest2]");
            this.outx(
    ...
    private firstVaginaOralTraining(): void {
        ...
        if (this.player.clitLength > 3)
            this.outx(" despite the fact it must be practically poking her in the eye");
        this.outx(
    ...
    private firstVaginaOralTrainingStageTwo(): void {
        ...
        if (this.player.lactationQ() > 0) this.outx(" dripping slightly");
        else this.outx(" semi-erect");
        this.outx(
        ...
        if (this.player.hasFuckableNipples()) this.outx(" obscene folds");
        else this.outx(" sensitive points");
        this.outx(
        ...
        if (this.player.hasFuckableNipples())
            this.outx(" sends her tongue questing into its sensitive inside.");
        else this.outx("bites it ever so gently.");
        ...
        if (this.player.wetness() <= 2) this.outx(" wetting both your slave’s hand and mouth");
        else this.outx(" absolutely soaking your slave’s face and arm");
        this.outx(
    ...
    private vaginaOralTrainingStageTwo(): void {
        ...
        this.outx(", leaving your nipples");
        if (!this.player.hasFuckableNipples()) this.outx(" rock-hard and");
        this.outx(" shining and your [vagina] beading eagerly.");
        ...
        if (this.player.wetness() >= 5) this.outx(", fountaining fem juice down her throat");
        this.outx(
        ...
        if (this.player.wetness() >= 5)
            this.outx(", soaking her again and again with warm, female approval");
        this.outx(".");
    ...
    private firstVaginaOralTrainingStageThree(): void {
        ...
        this.outx(" She sinks downwards leaving your nipples");
        if (!this.player.hasFuckableNipples()) this.outx(" rock-hard and");
        this.outx(" shining, your [vagina] beading eagerly.");
        ...
        if (this.player.wetness() >= 5)
            this.outx(", soaking her mouth and face again and again with warm, female approval");
        this.outx(
    ...
    private vaginaOralTrainingStageThree(): void {
        ...
        this.outx(". It’s a process which is beautifully sensuous.");
        if (this.player.lactationQ() > 0)
            this.outx(
    ...
    private vaginaOralTrainingMaxed(): void {
        ...
        this.outx(" Having left your [chest] gleaming with warm, oily saliva and your nipples");
        if (!this.player.hasFuckableNipples()) this.outx(" rock-hard and");
        this.outx(" shining, she sinks down to the next stage.");
        ...
        if (this.player.buttRating < 4) this.outx("firm butt");
        if (this.player.buttRating < 8) this.outx("supple rump");
        else this.outx("soft ass");
        this.outx(
    ...
    private repeatWhitneyDomPleasure(): void {
        this.outx("You say you could do with some relaxation.");
    ...
    private whitneyDomStraponDoggy(): void {
        ...
        if (capacity >= 36) {
            ...
            if (this.player.hasVagina()) this.outx("deep, eager vagina");
            else this.outx("oily, well-used passage");
            this.outx(
            ...
            if (this.player.hasVagina())
                this.outx("sit and spread ‘em for anything going, don’t you?");
            else
                this.outx(
                    "I bet you get on your knees for anything with a nice, juicy cock, right?"
                );
            this.outx(" What would your other slaves think of that? My secret little slut.</i>” ");
            ...
            if (this.player.hasVagina()) this.outx("take of your tight cunt");
            else this.outx("give of your tight ass");
            this.outx(
            ...
            if (this.player.hasVagina()) this.outx("servants, you tight, bossy little bitch");
            else this.outx("cattle, you tight, bossy little boy-bitch");
            this.outx(".</i>” ");
    ...
    private dontGetBrandingStuff(): void {
        ...
        if (this.whitneyDom()) this.outx(" “<i>You’ll pay for that later, I swear!</i>”");
        this.outx(" Grinning, you turn and leave.");
    ...
    private brandingAvailableTalk(): void {
        ...
        if (this.whitneyDefurred()) this.outx(" fingernail");
        else this.outx(" claw");
        this.outx(
    ...
    private testBranding(): void {
        ...
        this.outx("You return her devilish grin with interest.");
    ...
    public brandSelect(slot: number): void {
        ...
        this.outx("What will you draw on her " + this.slotNames[slot] + "?");
    ...
    public jojoBrandSelect(slot: number): void {
        ...
        this.outx("What will you draw on his " + this.slotNames[slot] + "?");
    ...
    private dontTestBranding(): void {
        ...
        this.outx("Maybe later, you say. Whitney looks disappointed.");
    ...
    private noOrgyRoomPlz(): void {
        ...
        this.outx("You tell her it’s a fine idea, but it will have to wait for now.");
    ...
    private orgyRoomSubMassage(): void {
        ...
        if (this.player.buttRating >= 6) this.outx("soft");
        else this.outx("brawny");
        this.outx(
            " rear. After she’s finished making your butt feel red and smooth she dips a heated, greasy hand between your [hips] and"
        );
        if (this.player.hasCock()) this.outx(" grips your [cock]");
        else if (this.player.hasVagina()) this.outx(" traces the entrance of your [vagina]");
        this.outx(
        ...
        if (this.player.isBiped()) {
            ...
            if (
                ...
                if (this.player.hasCock()) this.outx(" cock thicken");
                if (this.player.hasCock() && this.player.hasVagina()) this.outx(" and your");
                if (this.player.hasVagina()) this.outx(" pussy moisten");
                this.outx(".");
        ...
        // Naga:
            ...
            if (this.player.tongueType == TONUGE_SNAKE)
                this.outx(" You grin, flicking your forked tongue out to smell her arousal.");
            this.outx(
    ...
    private subHappyEndingMale(): void {
        ...
        if (hasBiggerCock) this.outx(" [cock biggest]");
        else if (this.player.isBiped()) this.outx(" against your [hips]");
        else this.outx(" around your back");
        this.outx(
