...
export class FarmCorruption extends AbstractFarmContent {
    ...
    public whitneyCorruption(mod: number = 0): number {
        if (mod != 0) {
            ...
            if (
                this.flags[kFLAGS.WHITNEY_CORRUPTION] >
                this.flags[kFLAGS.WHITNEY_CORRUPTION_HIGHEST]
            )
                this.flags[kFLAGS.WHITNEY_CORRUPTION_HIGHEST] = this.flags[
                    kFLAGS.WHITNEY_CORRUPTION
                ];
        }

        // Cap the values into the appropriate range
        if (
            this.flags[kFLAGS.FARM_CORRUPTION_APPROACHED_WHITNEY] == 0 &&
            this.flags[kFLAGS.WHITNEY_CORRUPTION] > 30
        ) {
            this.flags[kFLAGS.WHITNEY_CORRUPTION] = 30;
            trace("Whitney at 30 corruption clamp.");
        } else if (
            this.flags[kFLAGS.WHITNEY_LEAVE_0_60] == 0 &&
            this.flags[kFLAGS.WHITNEY_CORRUPTION] > 60
        ) {
            this.flags[kFLAGS.WHITNEY_CORRUPTION] = 60;
            trace("Whitney at 60 corruption clamp.");
        } else if (
            this.flags[kFLAGS.WHITNEY_LEAVE_61_90] == 0 &&
            this.flags[kFLAGS.WHITNEY_CORRUPTION] > 90
        ) {
            this.flags[kFLAGS.WHITNEY_CORRUPTION] = 90;
            trace("Whitney at 90 corruption clamp.");
        } else if (
            this.flags[kFLAGS.WHITNEY_MENU_91_119] == 0 &&
    ...
    public updateFarmCorruption(): number {
        ...
        if (
            ...
            if (this.flags[kFLAGS.FOLLOWER_AT_FARM_AMILY_GIBS_MILK] == 0)
                this.flags[kFLAGS.FOLLOWER_AT_FARM_AMILY_GIBS_MILK] = 1;
        ...
        if (
            ...
            if (this.flags[kFLAGS.FOLLOWER_AT_FARM_JOJO_GIBS_DRAFT] == 0)
                this.flags[kFLAGS.FOLLOWER_AT_FARM_JOJO_GIBS_DRAFT] = 1;
        ...
        if (
            ...
            if (this.flags[kFLAGS.FOLLOWER_AT_FARM_VAPULA_GIBS_MILK] == 0)
                this.flags[kFLAGS.FOLLOWER_AT_FARM_VAPULA_GIBS_MILK] = 1;
        }

        // Item caps
        if (this.flags[kFLAGS.FARM_SUCCUMILK_STORED] > 5) {
            this.flags[kFLAGS.FARM_CORRUPTION_GEMS_WAITING] +=
                (this.flags[kFLAGS.FARM_SUCCUMILK_STORED] - 5) * 3; // 3 extra gems per succumilk
            this.flags[kFLAGS.FARM_SUCCUMILK_STORED] = 5;
        }
        if (this.flags[kFLAGS.FARM_INCUDRAFT_STORED] > 5) {
            this.flags[kFLAGS.FARM_CORRUPTION_GEMS_WAITING] +=
                (this.flags[kFLAGS.FARM_INCUDRAFT_STORED] - 5) * 5; // 5 extra gems per incudraft (less of them produced etc)
        ...
        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_CERAPH] > 0) {
            ...
            if (this.flags[kFLAGS.FOLLOWER_AT_FARM_CERAPH] > 7)
        ...
        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_HOLLI] > 0) {
            ...
            if (this.flags[kFLAGS.FOLLOWER_AT_FARM_HOLLI] > 20)
        ...
        if (this.flags[kFLAGS.FARM_UPGRADES_CONTRACEPTIVE] == 1) {
            if (this.flags[kFLAGS.FARM_CONTRACEPTIVE_STORED] == 0)
                this.flags[kFLAGS.FARM_CONTRACEPTIVE_STORED] = 1;
        }
    ...
    public collectTheGoodies(): void {
        ...
        if (this.flags[kFLAGS.FARM_CORRUPTION_DAYS_SINCE_LAST_PAYOUT] >= 7) {
            this.outputText(
                "You stroll over to the big rock at the edge of the pepper patch, smiling as you see a small burlap sack shoved underneath a fold in the stone. You scoop it up, open it and count out " +
                    this.flags[kFLAGS.FARM_CORRUPTION_GEMS_WAITING] +
                    " gems.\n\n"
            );
            ...
            if (this.farmValue() < 25)
                this.outputText(
                    " You frown; it seems like a feeble amount for such a large operation. Perhaps you could talk to Whitney about that.\n\n"
                );
        ...
        if (
            this.flags[kFLAGS.FARM_SUCCUMILK_STORED] > 0 ||
            this.flags[kFLAGS.FARM_INCUDRAFT_STORED] > 0 ||
            this.flags[kFLAGS.FARM_EGG_STORED] > 0 ||
            this.flags[kFLAGS.FARM_CONTRACEPTIVE_STORED] > 0
        ) {
            this.outputText(
        ...
        if (this.flags[kFLAGS.FARM_SUCCUMILK_STORED] > 0) {
            ...
            if (this.flags[kFLAGS.FARM_SUCCUMILK_STORED] == 1)
                this.outputText("vial of Succubi milk.");
            else this.outputText("vials of Succubi milk.");
            this.outputText("</b>\n");
            this.addButton(
                0,
                this.getItemObj(kFLAGS.FARM_SUCCUMILK_STORED).shortName,
                this.takeItems,
                kFLAGS.FARM_SUCCUMILK_STORED
            );
        }
        if (this.flags[kFLAGS.FARM_INCUDRAFT_STORED] > 0) {
            this.outputText("<b>" + this.flags[kFLAGS.FARM_INCUDRAFT_STORED] + "x ");
            if (this.flags[kFLAGS.FARM_INCUDRAFT_STORED] == 1)
                this.outputText("vial of Incubi draft.");
            else this.outputText("vials of Incubi draft.");
            this.outputText("</b>\n");
            this.addButton(
                1,
                this.getItemObj(kFLAGS.FARM_INCUDRAFT_STORED).shortName,
                this.takeItems,
                kFLAGS.FARM_INCUDRAFT_STORED
            );
        }
        if (this.flags[kFLAGS.FARM_EGG_STORED] > 0) {
            this.outputText("<b>" + this.flags[kFLAGS.FARM_EGG_STORED] + "x ");
            this.outputText(
                "large " + this.flags[kFLAGS.FOLLOWER_PRODUCTION_SOPHIE_COLORCHOICE] + " egg"
            );
            ...
            this.addButton(
                2,
                this.getItemObj(kFLAGS.FARM_EGG_STORED).shortName,
                this.takeItems,
        ...
        if (this.flags[kFLAGS.FARM_CONTRACEPTIVE_STORED] > 0) {
            ...
            this.addButton(
                3,
                this.getItemObj(kFLAGS.FARM_CONTRACEPTIVE_STORED).shortName,
                this.takeItems,
    ...
    private getItemObj(
        ...
        if (flag == kFLAGS.FARM_EGG_STORED)
            return kGAMECLASS.sophieBimbo.eggTypes[
                kGAMECLASS.sophieBimbo.eggColors.indexOf(
                    this.flags[kFLAGS.FOLLOWER_PRODUCTION_SOPHIE_COLORCHOICE]
                )
            ];
    ...
    private afterTakeItems(): void {
        if (this.collectionAvailable()) this.collectTheGoodies();
        else this.rootScene();
    }
    ...
    public takeoverPrompt(): boolean {
        ...
        if (this.player.cor >= 70 && this.corruptFollowers() >= 2 && this.player.level >= 12) {
            if (this.flags[kFLAGS.FARM_CORRUPT_PROMPT_DISPLAY] == 0) {
                ...
                this.flags[kFLAGS.FARM_CORRUPT_PROMPT_DISPLAY] == 3 ||
    ...
    protected takeoverPromptMerge(firstTime: boolean = false): void {
        ...
        if (firstTime) {
            ...
            this.outputText(
                "Again, you find yourself standing on the bluff overlooking the farm, and you feel yourself filled with unholy rage at the woman below who stands against you and your plans for this piece of property. Do you put your plan into motion now or later?"
            );
        }
    ...
    public takeoverPromptNow(): void {
        ...
        this.outputText(
            "You stride down to the farm and leap over a gate. You move casually, swaggering towards the pepper field with no obvious intent. When Whitney spots you and slowly stands up from her weeding, you raise your hand in friendly greeting"
        );
        if (this.player.weaponName != "fists")
            this.outputText(
                ", and to demonstrate your peacefulness, you theatrically hold up your [weapon] and then discard it with a careless swing of your arm."
            );
        ...
        if (
            ...
            this.outputText(
                " I cannot properly protect the place, so maybe I do need... insurance.</i>” She spits the last word. “<i>Just so long as you stay the fuck away from me, I will do as you say.</i>” You beam."
            );
        } else {
        ...
        if (this.player.findStatusAffect(StatusAffects.NoMoreMarble) < 0)
            this.flags[kFLAGS.FOLLOWER_AT_FARM_MARBLE] = 0; // Don't have to care about recruitment paths -- she'll fuck off based on corruption before the player can corrupt the farm.
    ...
    protected takeoverPromptLater(): void {
        ...
        this.outputText(
            "You stare for a moment longer, then turn and head back to camp. You will show mercy she does not deserve... for now."
        );
    ...
    public rootScene(): void {
        ...
        if (!this.whitneyCorrupt()) {
            this.outputText(
                "You stand on the rise you’ve taken to using to look down on the farm which you are invested in."
            );

            if (this.flags[kFLAGS.FARM_UPGRADES_REFINERY] == 1)
                this.outputText(
                    " A large machine, bulky and rotund with a conical top, has been built into the milking barn. Fat pipes crawl up onto the roof from it like metal ivy, and white smoke billows busily out of its whistle chimney."
                );

            if (this.flags[kFLAGS.FARM_UPGRADES_CONTRACEPTIVE] == 1)
                this.outputText(
                    " Next to the pepper patch another crop has been planted, a field of verdant green shrubs. Their thin stems bob idly in the breeze."
                );
            ...
            if (this.silly()) {
                this.outputText(
                    this.player.mf(
                        "You feel an irresistible hankering for a cigar.",
                        "You feel an irresistible hankering for a cigarette holder."
                    )
                );
            }
            if (this.flags[kFLAGS.FARM_UPGRADES_REFINERY] == 1)
        ...
        if (
            ...
            kGAMECLASS.sophieBimbo.bimboSophie()
        ) {
            this.outputText(
    ...
    public farmMenu(): void {
        ...
        if (
            ...
            if (this.flags[kFLAGS.KELT_BREAK_LEVEL] >= 4)
                ...
                this.flags[kFLAGS.KELT_BREAK_LEVEL] == 0 &&
                this.flags[kFLAGS.KELT_TALKED_FARM_MANAGEMENT] == 0
            )
    ...
    private corruptingTheFarmExplore(): void {
        ...
        if (
            this.flags[kFLAGS.FARM_CORRUPTION_DAYS_SINCE_LAST_PAYOUT] >= 7 ||
            this.flags[kFLAGS.FARM_SUCCUMILK_STORED] > 0 ||
            this.flags[kFLAGS.FARM_INCUDRAFT_STORED] > 0 ||
            this.flags[kFLAGS.FARM_EGG_STORED] > 0 ||
            this.flags[kFLAGS.FARM_CONTRACEPTIVE_STORED] > 0
    ...
    private keltAChangeInManagement(): void {
        ...
        this.outputText(
            "“<i>Hear there’s been a change in management,</i>” says Kelt, clopping to a halt in front of you. You confirm that that is the case. The big centaur looks at you thoughtfully. There’s something different in his dark eyes and rugged scowl than his usual wearied contempt. Grudging admiration?"
        );

        this.outputText(
            "“<i>Find it difficult to believe someone like you could put a bitch in her place,</i>” he says eventually. “<i>Perhaps you’ve got bigger balls than I thought you had."
        );
        if (this.player.balls == 0) this.outputText(" So to speak, anyway.");
        this.outputText(
            "</i>” He snorts, and trots towards the butts. “<i>Just don’t expect me to treat you any different. As long as you’re getting free instruction from me, I’m the master and you’re the whelp. Got that?</i>”"
        );
        ...
        this.outputText(
            "“<i>Do I look like I want or need your sloppy seconds? Godsdamn, I can only imagine what kind of pathetic creatures would have </i>you<i> lording it over them. What a joke! Now, are we going to go watch you fail miserably to hit a target from five yards or what?</i>”"
        );

        this.outputText(
            "It’s better than you were expecting from him in all honesty. You take your bow out and silently follow him to the archery range."
        );
    ...
    private slavesAtFarmMenu(): void {
        ...
        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_AMILY] == 1)
            this.addButton(0, "Amily", kGAMECLASS.amilyScene.amilyFollowerEncounter);

        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_JOJO] == 1)
            this.addButton(1, "Jojo", kGAMECLASS.jojoScene.corruptCampJojo);

        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 1 && kGAMECLASS.sophieBimbo.bimboSophie())
            this.addButton(2, "Sophie", kGAMECLASS.sophieBimbo.approachBimboSophieInCamp);

        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_VAPULA] == 1)
            this.addButton(3, "Vapula", kGAMECLASS.vapula.callSlaveVapula);

        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_LATEXY] == 1)
            this.addButton(4, this.flags[kFLAGS.GOO_NAME], kGAMECLASS.latexGirl.approachLatexy);

        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_BATH_GIRL] == 1)
            this.addButton(5, this.flags[kFLAGS.MILK_NAME], kGAMECLASS.milkWaifu.milkyMenu);
    ...
    private followersAtFarmMenu(): void {
        ...
        if (
            ...
            this.addButton(0, "Sophie", kGAMECLASS.sophieFollowerScene.followerSophieMainScreen);
    ...
    private loversAtFarmMenu(): void {
        ...
        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_IZMA] == 1)
            this.addButton(0, "Izma", kGAMECLASS.izmaScene.izmaFollowerMenu);
        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_IZMA] == 2)
            this.addButton(0, "Izmael", kGAMECLASS.gameOver);

        if (this.flags[kFLAGS.FOLLOWER_AT_FARM_ISABELLA] == 1)
            this.addButton(1, "Isabella", kGAMECLASS.isabellaFollowerScene.callForFollowerIsabella);
    ...
    private dogeNotCorruptYet(): void {
        ...
        if (
            this.whitneyCorruption() < 30 &&
            this.flags[kFLAGS.WHITNEY_CORRUPTION_HIGHEST] > 30 &&
            this.flags[kFLAGS.WHITNEY_CORRUPTION_0_30_DROP_MESSAGE] == 0
        ) {
            this.outputText(
            ...
            if (this.flags[kFLAGS.WHITNEY_LEAVE_0_60] == 0)
        ...
        if (this.whitneyCorruption() >= 31 && this.whitneyCorruption() <= 60) {
            if (this.flags[kFLAGS.WHITNEY_MENU_31_60] == 0) {
                ...
                this.outputText(
                    "Once again you approach Whitney, this time as she is carrying full buckets of milk towards the bottling station. She sees you coming and quickens her step. You notice this time however she doesn’t have her crossbow, and this emboldens you."
                );
                ...
                // Subsequent 31-60:
                this.outputText(
                    "Whitney puts down her work as you stride towards her, resigned unhappiness in her expression."
                );
        ...
        if (this.whitneyCorruption() >= 61 && this.whitneyCorruption() <= 90) {
            if (this.flags[kFLAGS.WHITNEY_MENU_61_90] == 0) {
                ...
                // 61-90 Subsequent:
                this.outputText(
                    "Whitney puts down her work and smiles at you vaguely as you approach her. You again sense that queasy mixture of anxiety, unhappiness and excitement in her jerky, cramped movements and expression."
                );
        ...
        if (this.whitneyCorruption() == 120) {
            if (this.flags[kFLAGS.WHITNEY_CORRUPTION_COMPLETE] == 0) {
                ...
                // 120 Farm Corruption
                this.outputText(
                    "You don’t need to seek out Whitney this time; almost the moment you arrive on the farm a sandy furred figure is hurrying over to you. There’s deep excitement in her face and her breast is heaving with more than just exertion."
                );
    ...
    private dogeNotCorruptLeaveFirstTime(): void {
        ...
        this.outputText(
            "As you turn to leave, you feel something tug on your [armor]. You turn back to look into Whitney’s searching eyes."
        );
    ...
    private dogeNotCorruptYetMenu(): void {
        ...
        if (this.whitneyCorruption() <= 60 && this.flags[kFLAGS.WHITNEY_LEAVE_0_60] == 0)
            this.addButton(9, "Back", this.dogeNotCorruptLeaveFirstTime);
        else if (this.whitneyCorruption() <= 90 && this.flags[kFLAGS.WHITNEY_LEAVE_61_90] == 0)
    ...
    public availableInvestments(): boolean {
        ...
        if (
            ...
            return true;
        if (
            this.flags[kFLAGS.FARM_UPGRADES_REFINERY] == 0 &&
            this.flags[kFLAGS.QUEUE_REFINERY_UPGRADE] == 0
        )
            return true;
        if (
            this.flags[kFLAGS.FARM_UPGRADES_CONTRACEPTIVE] == 0 &&
            this.flags[kFLAGS.QUEUE_CONTRACEPTIVE_UPGRADE] == 0
        )
            return true;
        if (
            this.flags[kFLAGS.FARM_UPGRADES_MILKTANK] == 0 &&
            kGAMECLASS.milkWaifu.milkSlave() &&
            this.flags[kFLAGS.QUEUE_MILKTANK_UPGRADE] == 0
        )
            return true;
        return false;
    ...
    private whitneyAppearanceCorrupt(): void {
        ...
        if (this.whitneyDefurred())
            this.outputText(
                "-girl. Her human transformation has rendered her pretty in a delicate, diffident kind of way."
            );
        else
            this.outputText(
                "-morph. Her muzzle is suggestive of a golden retriever but really she could be any breed."
            );
        if (this.whitneyMaxedOralTraining())
            this.outputText(
                " In sharp contrast to her otherwise fairly thin features, her lips are plump and a depthless black, shining like wet tar. She constantly moves her tongue over them unconsciously."
            );
        this.outputText(
        ...
        if (this.whitneyHasTattoo()) {
            ...
            if (this.flags[kFLAGS.WHITNEY_TATTOO_COLLARBONE] != "")
                this.outputText(this.flags[kFLAGS.WHITNEY_TATTOO_COLLARBONE] + "\n");
            if (this.flags[kFLAGS.WHITNEY_TATTOO_SHOULDERS] != "")
                this.outputText(this.flags[kFLAGS.WHITNEY_TATTOO_SHOULDERS] + "\n");
            if (this.flags[kFLAGS.WHITNEY_TATTOO_LOWERBACK] != "")
                this.outputText(this.flags[kFLAGS.WHITNEY_TATTOO_LOWERBACK] + "\n");
            if (this.flags[kFLAGS.WHITNEY_TATTOO_BUTT] != "")
                this.outputText(this.flags[kFLAGS.WHITNEY_TATTOO_BUTT] + "\n");
        }
    ...
    private prosperityGoNotCorrupt(): void {
        ...
        if (lowValue && lowProtection) {
            ...
            if (this.numFollowersAtFarm() + this.numSlavesAtFarm() + this.numLoversAtFarm() == 0)
                this.outputText(
                    " Send me any kind of decent body - someone, anyone - and I can start trying to make more-a this place."
                );
            else
                this.outputText(
                    " I need more hands to make the best of the place. More suitable hands at least."
                );
            this.outputText("</i>”");
        }
    ...
    private investmentBreastMilker(): void {
        ...
        if (!this.whitneyCorrupt()) {
            this.outputText(
                "You say you’d like a breast milker installed, one that you could make use of. Whitney frowns, but doesn’t seem as thrown by this idea as you expected."
            );
            ...
            this.outputText(
                "You say you’d like a breast milker installed, one that you could make use of. Whitney lets her gaze sink down to your [chest]."
            );
    ...
    private investmentCockMilker(): void {
        ...
        if (!this.whitneyCorrupt()) {
            ...
            this.outputText(
                "You say you’d like a semen extractor built, one that you could make use of. Whitney bites her lip at the implication."
            );
    ...
    private investmentRefinery(): void {
        ...
        if (!this.whitneyCorrupt()) {
            this.outputText(
                "You say you want a machine built that could concentrate the fluids your followers produce into actual transformatives. Whitney shudders, but is in no position to argue."
            );
            ...
            this.outputText(
                "You say you want a machine built that could concentrate the fluids your followers produce into actual transformatives."
            );
    ...
    private investmentContraceptive(): void {
        ...
        if (!this.whitneyCorrupt()) {
            this.outputText(
                "You ask Whitney if she knows of any natural contraceptive that grows in Mareth."
            );
    ...
    private investmentMilktank(): void {
        ...
        if (!this.whitneyCorrupt()) {
            ...
            // If Bathgirl boobed and at camp:
                ...
                this.outputText(
                    "You tell Whitney you want her to build a swimming tank at the farm, then come to your camp, take away your expensively acquired milk slave and install her in it. The dog woman slowly absorbs this."
                );
    ...
    private doMilktankInvestment(): void {
        ...
        if (!this.whitneyCorrupt())
            this.outputText(
                "You press the gems into your taskmaster’s hand, turn and leave without another word. Your thoughts turn to huge, delightfully plush brown boobs and luxurious milky baths; it will be well worth it. "
            );
        else
            this.outputText(
                "You press the gems into your taskmaster’s hand, turn and leave without another word. Your thoughts turn to huge, delightfully plush, brown boobs, of luxurious milky baths; it will be well worth the cost. "
            );
    ...
    private deFurDoge(): void {
        ...
        this.outputText(
            "You put away the gem and move into Whitney, holding her gaze as you gently place your finger and thumb along her jaw line. She doesn’t pull away and lets out a shuddering sigh as you touch her."
        );
    ...
    private dontDeFurDoge(): void {
        ...
        this.outputText(
            " her firm ass and she moans, her breath starting to come in shallow gulps, her heart beating furiously against your skin. Although you keep hold of her you don’t have to do anything to make the hatchet rise again."
        );
    ...
    private makeDogeSubby(): void {
        ...
        this.outputText(
            "You again retrieve your gem, and once more begin to rhythmically turn it; this time, however, you walk steadily towards Whitney, your voice getting louder in her ears and the shining light in her unfocused eyes getting brighter as you go on."
        );
    ...
    private makeDogeDommy(): void {
        ...
        this.outputText(
            "You again retrieve your gem, and once more begin to rhythmically turn it. This time, however, you walk steadily towards Whitney, your voice getting louder in her ears, the shining light in her unfocused eyes getting brighter as you go on."
        );
        ...
        this.outputText(
            "\n\n“<i>Good,</i>” you say quietly. “<i>Because the most hardworking of " +
                this.player.mf("masters", "mistresses") +
                " need some R and R from time to time. A bit of private alone time, with a very trusted slave. A slave who would know not to betray the confidence placed in them, because of all the examples surrounding her of how far she could fall if she did. You following me?</i>”"
        );
    ...
    private dogeCorruptedMissionComplete(output: boolean = true): void {
        ...
        if (this.whitneyDom() && output) {
            ...
            this.outputText(
                "Whitney is knelt in front of you before you’ve finished calling her name. Her tail wags as her soulful brown eyes look up at you, lit up with depthless lust."
            );
    ...
    private firstOralTraining(): void {
        ...
        this.outputText(
            "\n\n“<i>I - I want to do that, [master],</i>” she replies tensely. She’s having problems knowing what to look at, her eyes flitting between your gaze and the demanding sight of your " +
                (this.player.hasCock() ? "[cock biggest]" : "lush cunt") +
                ", eventually settling on the first. “<i>I want to serve you best I can, but I - don’t know if - it’s just, I’ve never really - I mean, once or twice, but I’ve never been very...</i>” Your growing urge makes you feel impatient and you think about stifling her meek babbling with a good face fucking... but no. There are much better ways of getting the best out of inexperienced slaves."
        );
        ...
        this.outputText(
            "\n\n“<i>Yes, [master]. I will tr- I will.</i>” She takes a long breath and transfers her gaze to " +
                (this.player.hasCock() ? "[eachCock]" : "[vagina]") +
                ", looking for all the world like she’s about to embark on a marathon."
        );

        this.outputText(
            "\n\n“<i>First,</i>” you say, settling yourself down, “<i>Put one hand in your knickers. Find that nice, wet pussy of yours.</i>” You watch her, a smile twitching the corners of your mouth as, blushing furiously, she shifts around in front of you. “<i>You know how to do that, right? All those lonely nights on the farm... good. Nice and easy. Eyes down.</i>” You say the last part adamantly, opening your [hips] wider as you do. Whitney swallows a bit as she strokes at her tiny button whilst staring at your " +
                (this.player.hasCock() ? "[eachCock]" : "[vagina]") +
                ", already " +
                (this.player.hasCock() ? "semi-turgid" : "moist") +
                " from the display put on by your fresh, nervous slave. “<i>Good,</i>” you murmur. “<i>Now... reach forward, and begin to lick.</i>”"
        );
    }
    ...
    private firstCockOralTraining(): void {
        ...
        this.outputText(
            "\n\nShe doesn’t put her delightful tongue to use and she sometimes stops frigging herself, lost in taking more and more of your cock" +
                (this.player.hasVagina()
                    ? "; further, your [vagina] is beading in frustration at being left out of the oral pleasure. But that’s all right. It’ll all come in time"
                    : ", but that’s all right; it’ll come in time") +
                ". For now, there is her soft mouth and the delicious pleasure inundating your prick, her warm hand grasped around you as your urge grips you closer, and as you touch the front of her throat she is beginning to moan around your flesh, louder and louder as she-"
        );
    ...
    private cockOralTrainingStageOne(): void {
        ...
        if (this.player.biggestCockLength() > 12)
            this.outputText(
                " She still struggles a bit with her gag reflex but it only takes her a few tries to swallow your thick prick, allowing you to pump into the delightful tightness of her throat without issue."
            );
    ...
    private firstCockOralTrainingStageTwo(): void {
        ...
        if (this.player.hasVagina() && this.player.balls > 0) {
            ...
            this.outputText(
                "\n\nEventually you cannot hold your lust back. You grab her by the head and begin to thrust deep into her " +
                    (this.player.biggestCockLength() < 8 ? "mouth" : "throat") +
                    ". Her breath hisses through her nose as she lets you use her mouth, struggling to keep her fingers schlicking away; you coo as your own hard movements force her to move her hands fast and erratically, skittering across your urgently bulging button and making you pump into her wet, milking warmth all the more frenetically."
            );

            this.outputText(
                "\n\n“<i>Cum, bitch.</i>” you grit as you surge to your own high. Whitney’s muffled moans are what you hear as your cock-slit dilates and pumps jizz down her throat; you crow with delight as your [vagina] quivers and then clenches in orgasm in ecstatic sympathy with your male sex, " +
                    (this.player.wetness() <= 2
                        ? "wetting your slave’s hand"
                        : "absolutely soaking your slave’s arm") +
                    " with femjizz as it does. She shudders around you and her eyes roll as she finds her own high rooting in her pussy; you are extremely gratified to note that, despite being on a plane of submissive pleasure far away, she still manages to swallow every drop of cum you eject"
            );
            if (this.player.cumQ() >= 1500)
                this.outputText(
                    " which is no mean feat, given it feels like you’ve fucked what feels like a gallon of it down her gullet. Once you’re almost done, as ever you spurt the last few creamy ropes across her face and clothes"
                );
            this.outputText(".");
        ...
        //Herm without balls
            ...
            this.outputText(
                "\n\nEventually you cannot hold your lust back. You grab her by the head and begin to thrust deep into her " +
                    (this.player.biggestCockLength() < 8 ? "mouth" : "throat") +
                    ". Her breath hisses through her nose as she lets you use her mouth, struggling to keep her fingers schlicking away; you coo as your own hard movements force her to move her hands faster and more erratically, skittering across your urgently bulging button and making you pump into her wet, milking warmth all the more frenetically."
            );
        ...
        //Male w/ balls:
            ...
            if (this.player.cocks.length == 1) {
                ...
                this.outputText(
                    "\n\nEventually you cannot hold your lust back. You grab her by the head and begin to thrust deep into her " +
                        (this.player.biggestCockLength() < 8 ? "mouth" : "throat") +
                        ". Her breath hisses through her nose as she lets you use her mouth, struggling to keep her fingers schlicking away; you coo as your own hard movements force her to push slightly into your ass, making you pump into her wet, milking warmth all the more frenetically."
                );
        ...
        if (!this.player.hasVagina()) {
            ...
            this.outputText(
                ". There’s an eagerness on display here which you don’t think was there before as she laps at your cock [headplural], and you think she even stifles a disappointed whine when she’s finished. Smiling softly, you get up, dress and send her on her way."
            );
        }
    ...
    private cockOralTrainingStageTwo(): void {
        ...
        if (!this.player.hasVagina()) {
            ...
            if (this.player.cocks.length > 1)
                this.outputText(
                    "She wraps her hand around your [cock biggest2] when she’s ready, giving it an experimental pump before beginning to softly and slowly work it, remembering exactly how to grip and bend its girth as she prepares for the main course."
                );
            ...
            if (this.player.cocks.length > 1)
                this.outputText(
                    "she occasionally forgets the length bulging in her hand so eager is she to push her lips further down your [cock biggest] and work at her own clit, and you need to murmur to get her to concentrate."
                );
            else
                this.outputText(
                    "she still occasionally forgets the length buried in her mouth, so eager is she to work keenly at her own clit, and you need to murmur to get her to concentrate."
                );
            this.outputText(
            ...
            if (this.player.cocks.length == 1)
                this.outputText(
                    "Whitney cleans your [cock biggest] with her flat tongue, humming as she laps your oozing head clean, deliciously soothing your aching cock."
                );
            else
                this.outputText(
                    "Whitney cleans first your [cock biggest2] and then your [cock biggest] with her flat tongue, humming as she laps each of your oozing heads clean, deliciously soothing your aching cock."
                );
    ...
    private firstCockOralTrainingStageThree(): void {
        ...
        if (!this.player.hasVagina()) {
            ...
            if (this.player.cocks.length > 2) {
                ...
                if (this.player.cocks.length > 1)
                    this.outputText(
                        " jerking both your cocks with her smooth, exacting grasp in tandem"
                    );
                this.outputText(".");
            }
            ...
            this.outputText(
                ". Though it would be so easy to lose yourself entirely to her expert movements you keep abreast it for now, holding a close eye on the dog woman kneeling in front of you, now entirely devoted to pleasuring you."
            );
            ...
            this.outputText(
                "\n\nThe sight and sound of her inundates your senses with the same drowning intensity of the pleasure enveloping your maleness and you pump upwards to an irresistible high, grasping her head and beginning to thrust deep into the tight suction of her" +
                    (this.player.biggestCockLength() < 8 ? " mouth" : " throat") +
                    ". She moans deeply as you begin to use her like this, and even when you’re face fucking her she does exactly the right things, hollowing her cheeks as you pull outwards to suck deliciously at your receding shaft then softening her mouth completely to give you the best access possible to the beautiful, tight warmth of " +
                    (this.player.biggestCockLength() < 8 ? "the back of her mouth" : "her gullet") +
                    " as you spear decisively inwards. "
            );
            ...
            if (this.player.cocks.length > 1) {
                ...
                this.outputText(
                    " out cum just as eagerly as the first, delirium seizing you as you are clenched by your"
                );
            ...
            if (this.player.cumQ() >= 1500) {
                this.outputText(
                    "Once you’re almost done, as ever you pull out and spurt the last few creamy ropes across her face and clothes. Red with her own huge high, the dog woman does her level best to catch them in her mouth."
                );
            }
            ...
            this.outputText(
                "\n\nOnce you have tensed your last you sigh beatifically and float high and formless on your post-blowjob haze. You close your eyes as, without any bidding, " +
                    (this.player.cocks.length == 1
                        ? "Whitney cleans your [cock biggest] with her flat tongue, lapping your oozing head clean, deliciously soothing your aching cock"
                        : "Whitney cleans all of your pricks with her flat tongue, lapping each of your oozing heads clean, deliciously soothing your aching cock") +
        ...
        //Herm
            ...
            this.outputText(
                "\n\n“<i>Now get back to your main task.</i>” You hum with deep approval as once again your [cock biggest] is swaddled in mouth flesh, her tongue sliding up and down your shaft in the same masterful, alternating oscillation all the while your [vagina] " +
                    (this.player.cocks.length >= 2
                        ? "and [cock biggest2] thrum and vibrate"
                        : "thrums and vibrates") +
                    " with pleasure from her teasing hands. Though it would be so easy to lose yourself entirely to her expert movements you keep abreast it for now, keeping a close eye on the dog woman kneeling in front of you, entirely devoted now to pleasuring you."
            );
            ...
            this.outputText(
                "\n\nThe sight and sound of her inundates your senses with the same drowning intensity of the pleasure enveloping your extensive sex and you pump upwards to an irresistible high, grasping her head and beginning to thrust deep into the tight suction of her " +
                    (this.player.biggestCockLength() < 8 ? "mouth" : "throat") +
                    ". She moans deeply as you begin to use her like this, and even when you’re face fucking her she does exactly the right things, hollowing her cheeks as you pull outwards to suck deliciously at your receding shaft then softening her mouth completely to give you the best access possible to the beautiful, tight warmth of "
            );
            ...
            if (this.player.cocks.length > 1)
                this.outputText(
                    " She doesn’t forget the cock trapped in her grasp for a moment either; she milks it as hard as you’re fucking her mouth, and it flexes out cum just as eagerly as the first, delirium seizing you as you are clenched by your triple high as it paints her skirt with its generous discharge."
                );
            if (this.player.cumQ() >= 1500)
                this.outputText(
                    " Once you’re almost done, as ever you pull out and spurt the last few creamy ropes across her face and clothes. Red with her own huge high, the dog woman does her level best to catch them in her mouth."
            ...
            if (this.player.cocks.length == 1)
                this.outputText(
                    "Whitney first cleans your [vagina] and then your [cock biggest] with her flat tongue, polishing your dripping pussy and thighs to a shine before lapping your oozing head clean, deliciously soothing your aching cock."
                );
            else
                this.outputText(
                    "Whitney uses her flat tongue to clean first your [vagina], polishing your dripping pussy and thighs to a shine, and then each of your pricks, lapping the oozing heads clean, deliciously soothing your aching cocks."
                );
            this.outputText(
    ...
    private cockOralTrainingStageThree(): void {
        ...
        if (!this.player.hasVagina()) {
            ...
            if (this.player.cocks.length > 2)
                this.outputText(
                    "Finally, she snakes her other hand around your [cock biggest3], rolling her wrist as she gently wrings it with the same sliding thoroughness.} You open your mouth to the shifting delectation inundating your overgrowth of cocks."
                );
            ...
            this.outputText(
                "\n\nYou grab hold of those thoughts, filling them with a black power as the drowning intensity of the pleasure inundating your maleness increases and you begin to pump upwards to an irresistible high, grasping her head and beginning to thrust deep into the tight suck of her " +
                    (this.player.biggestCockLength() < 8 ? "mouth" : "throat") +
                    ". With some effort you stay afloat and consider the dog woman as she whimpers in delight to you hammering into her juicy mouth"
            );
            if (this.player.balls > 0)
            ...
            this.outputText(
                "\n\nEven when you’re face fucking her Whitney does exactly the right things, hollowing her cheeks as you pull outwards to suck deliciously at your receding shaft then softening her mouth completely to give you the best access possible to the beautiful, tight warmth of " +
                    (this.player.biggestCockLength() < 8 ? "the back of her mouth" : "her gullet") +
                    " as you spear decisively inwards. You can’t find the words as you fly into your golden, ecstatic high; you throw your head back as you bury as much of your cock into her as you can, sweat standing out on your brow as you bark wordlessly with each bucket of jizz you fountain down her throat. "
            );
            ...
            this.outputText(
                "She suddenly gasps in shock, and you quickly look down. Her lips look swollen, and they seem to be darkening."
            );
            ...
            this.outputText(
                ", first kissing your head deep and then lapping you close; she moans like a whore. She thrusts her ass in the air, sending her tongue pushing all around her new cock pillows with the taste of your cum, gently pumping your spent prick"
            );
            if (this.player.cocks.length > 1) this.outputText("s");
        ...
        //Herm
            ...
            this.outputText(
                " You close your eyes as the pleasure inundating both your male and female sex twist around each other, a slow but brilliant chemical reaction consuming you from within."
            );
            ...
            this.outputText(
                " as you spear decisively inwards. You can’t find the words as you fly into your golden, ecstatic high; you throw your head back as you bury as much of your cock into her as you can, sweat standing out on your brow as you bark and howl with each bucket of jizz you fountain down her throat. "
            );
            ...
            if (this.player.cocks.length > 1) {
                this.outputText(
                    " She doesn’t forget the cock trapped in her grasp for a moment; she milks it as hard as you’re fucking her mouth, and it flexes out cum just as eagerly as the first, delirium seizing you as you are clenched by your "
                );
    ...
    private cockOralTrainingMaxed(): void {
        ...
        if (!this.player.hasVagina()) {
            ...
            if (this.player.cocks.length > 2)
                this.outputText(
                    " Finally, she snakes her other hand around your [cock biggest3], rolling her wrist as she gently wrings it with the same sliding thoroughness."
                );
            this.outputText(
                " You open your mouth to the shifting delectation inundating [eachCock]."
            );
            ...
            if (this.player.cocks.length > 1)
                this.outputText(
                    " so that each of your fiercely erect pricks has time to enjoy the tight, sucking embrace of her mouth."
                );

            this.outputText(
                "\n\nPushing her all the way down to the base of your [cock biggest] so that the heavy breath through her nose warms your crotch and holding her there for a time, you enjoy the glorious closeness of the back of her " +
                    (this.player.biggestCockLength() < 8 ? "mouth" : "throat")
            );
            if (this.player.balls > 0)
            ...
            this.outputText(
                " pulling and kneading you now with real need. The drowning intensity of the pleasure inundating your maleness increases and you begin to pump upwards to an irresistible high, grasping her head and beginning to thrust deep into the tight suction of her " +
                    (this.player.biggestCockLength() < 8 ? "mouth" : "throat") +
                    "."
            );

            this.outputText(
                "\n\nAs always when you’re face fucking her Whitney does exactly the right things, hollowing her cheeks as you pull outwards to suck deliciously at your receding shaft then softening her mouth completely to give you the best access possible to the beautiful, tight warmth of " +
                    (this.player.biggestCockLength() < 8 ? "the back of her mouth" : "her gullet") +
                    " as you spear decisively inwards, her lush cock pillows providing... not resistance but a wonderful squeezing lushness moving up and down your urgently bulging length."
            );
            ...
            this.outputText(
                " Eventually you can give her no more and withdrawing you stumble back, stars swimming in your eyes from the force of it."
            );
        ...
        //Herm
            ...
            this.outputText(
                " You open your mouth to the shifting delectation inundating both your male and female sex, her teasing digits moving with innate expertise to send twin pleasure twisting through you, a slow but brilliant chemical reaction consuming you from within."
            );
            ...
            this.outputText(
                " as if they never left them, pulling, kneading and curling into you now with real need. The drowning intensity of the pleasure inundating your sex increases and you begin to pump upwards to an irresistible high, grasping her head and beginning to thrust deep into the tight suction of her " +
                    (this.player.biggestCockLength() < 8 ? "mouth" : "throat") +
                    "."
            );
            ...
            if (this.player.cocks.length > 1)
                this.outputText(
                    " She doesn’t forget the [cock biggest2] trapped in her grasp for a moment; she milks it as hard as you’re fucking her mouth, and it flexes out cum just as eagerly as the first, delirium seizing you as you are clenched by your triple high; it paints her skirt with its generous discharge."
                );
            this.outputText(
                " Eventually you can give her no more and withdraw, stars swimming in your eyes from the force of your orgasm."
            );
    ...
    private vaginaOralTrainingStageOne(): void {
        ...
        if (this.player.wetness() >= 5)
            ...
            this.outputText(
                " The dog woman coughs and splutters around the lubricant you dribble into her, some of it dripping out of her nose even as you continue to push yourself into her. This doesn’t stop her from furiously moving her hand in her knickers, flicking her clit for all she is worth as she attempts to cope with the pressing demand of your snatch. On the edge already it doesn’t take her long, and her eyes roll as she tenses and shudders."
            );
    ...
    private firstVaginaOralTrainingStageTwo(): void {
        ...
        this.outputText(
            " from the arousal you already feel. “<i>A good slut knows her mistress’s breasts need to be attended to, her nipples and skin shining with a slave’s worship for all the world to see, before she’s deserving of drinking from her pussy. Let’s see how you do.</i>” "
        );
        ...
        this.outputText(
            ", kneading them gently and bathing them in saliva. Given her initial awkwardness at cunnilingus it’s remarkable how good she is at this. “<i>Lick every inch... that’s good. Suckle on them a bit... very good!</i>” You gasp a bit as she envelopes one of your nipples and"
        );
        ...
        if (this.player.lactationQ() > 0) {
            this.outputText(
                " The gentle kneading is easily enough to make your fecund teats dribble milk into her mouth, and after being slightly startled by it Whitney evidently enjoys the taste of it, because she begins to pull at your plump breast for more. You allow her another mouthful before gently pulling her away."
            );
        ...
        this.outputText(
            " with femjizz as it does. She shudders around you and her eyes roll as she finds her own high rooting in her pussy; you are extremely gratified to note that, despite being on a plane of submissive pleasure far above you, she still manages to swallow every drop of cum that showers into her mouth"
        );
        if (this.player.wetness() >= 5)
            this.outputText(
                " which is no mean feat, given it feels like you gutter what feels like a gallon down her gullet. Once you’re almost done, as ever you get up and spurt the last of it on her hair and clothes"
            );
        this.outputText(".");
    ...
    private vaginaOralTrainingStageTwo(): void {
        ...
        if (this.player.lactationQ() > 0)
            this.outputText(
                " and it quickly makes the liquid warmth in your breasts rise to a point, beading milk freely from your teats. Whitney laps and sucks it down eagerly, but gratifyingly she remembers your order and stops reluctantly after only taking a single pull"
            );
    ...
    private firstVaginaOralTrainingStageThree(): void {
        ...
        if (!this.player.hasFuckableNipples())
            this.outputText(
                " she takes each of your [nipples] into her mouth to bathe them in close, sucking attention"
            );
        else
            this.outputText(
                " she sends her tongue lapping into each of your cunt nipples, curling at their sensitive pink until they are wet with need"
            );
        this.outputText(
            ". It’s a process which is beautifully sensuous, made all the more gratifying by the soft, lustful moans she makes as she polishes your softness."
        );
        if (this.player.lactationQ() > 0)
            this.outputText(
                " It quickly makes the liquid warmth in your breasts rise to a point, beading milk freely from your teats. Whitney laps and sucks it down eagerly, but gratifyingly she remembers your order and stops reluctantly after only taking a single pull."
            );
        ...
        if (this.player.clitLength >= 4)
            this.outputText(
                " She uses her new anchorage to take your bulging fem-dick entirely into her mouth, sucking on it avidly; she hums as she does it, sending ecstatic pleasure thrumming through you."
            );
        ...
        if (this.player.wetness() >= 5)
            this.outputText(
                ", soaking her mouth and face again and again with warm, female approval"
            );
        this.outputText(
            ". There’s a series of shrill, strangled squeals below you, her body shakes around you and you know without needing to see Whitney is cumming too, purely from the slavering joy of swallowing every last drop of the musky fruit guttered into her by her mistress."
        );
        if (this.player.wetness() >= 5)
            this.outputText(
                " It is in a state of ecstatic momentum that you rise away from her mouth and spurt the last of it onto her hair and clothes. Red with her own huge high, the dog woman does her level best to catch your spotting fluids in her mouth."
            );
    ...
    private vaginaOralTrainingMaxed(): void {
        ...
        if (!this.player.hasFuckableNipples())
            this.outputText(
                " she envelopes each of your [nipples] with her lips, kissing them with their sumptuous sponginess before bathing them in close, sucking attention"
            );
        else
            this.outputText(
                " she pushes her lips against your cunt nipples before sending her tongue gently into each of them, curling at their sensitive pink until they are oozing wetness in delight"
            );
        this.outputText(
            ". It’s a process which is beautifully sensuous, made all the better by the soft, lustful moans she makes as she polishes your bust."
        );
        if (this.player.lactationQ() > 0)
            this.outputText(
        ...
        this.outputText(
            " Having left your [chest] gleaming with warm, oily saliva and your nipples"
        );
        if (!this.player.hasFuckableNipples()) this.outputText(" rock-hard and");
        ...
        this.outputText(
            ", oiling it to a sheen. She makes little gasping, stifled breaths as she goes about it, and a grin comes to your lips."
        );
    ...
    private firstWhitneyDomPleasure(): void {
        this.outputText(
            "You are slightly apprehensive about this, but you’ve gone to the trouble of crafting Whitney into a fairly unique slave, and it seems churlish not to test just how deep the dominating streak you’ve brought out in her goes. You tell her you could do with a bit of relaxation."
        );
    ...
    private whitneyDomBondageOral(): void {
        ...
        this.outputText(
            "Whitney climbs on top of your supine form, her hands pressing into your [chest], firm hips clenching around your abdomen as she considers you."
        );
        ...
        this.outputText(
            "\n\n“<i>S’it,</i>” comes her voice. Whitney sounds like she’s on a plain of pleasure far above you. Her grip on your arms tightens. “<i>S’it! Now up. Up!</i>” You can guess what that means. You recover enough to sink your tongue deep into her beading pussy, and she immediately clenches around it, trapping it up there before beginning to use it for all she’s worth. The bed creaks briskly as you lick her tight tunnel, your universe becoming a stifling world of tight flesh, brown " +
                (this.whitneyDefurred() ? "skin" : "fur") +
                " and the smell and taste of female excitement. Whitney makes a breathless sound as her pussy contracts around your tongue, her stomach batting into your forehead, and you’re treated to another small, warm trickle of her fluids running down your chin. "
        );

        this.outputText(
            "\n\nHer thighs relax and rise a bit, allowing you to join her in panting for breath and recover a bit. In a disconnected daze you watch her " +
                (this.whitneyDefurred() ? "smooth" : "furry") +
                " calves shift around you until she is facing the other way, but it is only when you feel her place her hands on your own [hips] that you fully realize that she’s not done with you yet."
        );
        ...
        if (this.player.hasCock() && !this.player.hasVagina()) {
            ...
            if (this.player.totalCocks() > 1)
                this.outputText(
                    " “<i>So many things to play with tucked away in here!</i>” comes her merry voice again, as you feel her grasp your [cock smallest] at the same time; you groan into the confines of her flesh as she gives it a soft, teasing pump. It’s obvious your main member has really caught her attention though, and both her hands soon return to it."
                );
        ...
        this.outputText(
            ", and only after relaxing for a long, heavy moment on your face does she finally slide off you. You heave and pant for breath, still cuffed to the bed, rivulets of femcum trickling down your face, your tongue and "
        );
        if (this.player.hasCock()) this.outputText("[cock biggest]");
        if (this.player.hasCock() && this.player.hasVagina()) this.outputText(" and ");
        if (this.player.hasVagina()) this.outputText("[vagina]");
        this.outputText(
            " aching, oozing. In a deep, post-coital haze you feel someone take a towel to your body before curling into you, throwing a dense thigh over you, holding and running her hands over you possessively as you recover. "
        );
    ...
    private whitneyDomStraponDoggy(): void {
        ...
        if (this.player.isBiped() || this.player.isTaur())
            this.outputText(
                " Next, she pushes your ankles apart, threads a leather strap around each and then pulls them tight with a sharp yank; you carefully test them and find with a cold thrill that there is a metal bar attached between them, forcing you to stay in this position."
            );
        else if (this.player.isDrider())
            this.outputText(
                " You don’t struggle as she then forces your spindly legs beneath the bed, looping a leather strap attached to the frame around them all, trapping them there."
            );
        else if (this.player.isNaga())
            this.outputText(
                " She then ties your reptilian coils around the bedposts, securing them with leather straps fitted for the purpose."
            );
        ...
        this.outputText(
            "\n\nOnce she’s done you discover she’s got one last surprise for you. She kneels down, almost level with your face, one hand between your [hips] whilst the other searches around on the floor. You close your eyes, unable to stop her gently stroking " +
                (this.player.hasCock()
                    ? "your semi-erect [cock]"
                    : "the inner lips of your [vagina]") +
                " even if you wanted to, opening your mouth to sigh as she sends shivers of pleasure through your core."
        );
        ...
        if (capacity >= 36) {
            ...
            this.outputText(
                " eagerly swallowing it up until her hard hips are pressed against your [butt]."
            );
            ...
            this.outputText(
                ", pushing the other end of the dildo into her. An even louder moan is forced out of your throat by the intensity of your tunnel being packed full of cock, albeit an imitation."
            );
        ...
        this.outputText(
            "\n\nThe panties in your mouth are dense with the taste and smell of the dog woman’s excitement; stuck high in your nose and throat, the rich musk makes you feel impossibly turned on, and there’s no getting away from it. Although your intention was to take your ‘relaxation’ in a stoical silence befitting of your position, you can’t stop yourself whining and moaning around the soiled cotton, welcoming each hard slap to your [butt] as it heralds another firm stroke from the delightfully thick and bumpy cock" +
                (this.player.hasCock()
                    ? " bumping delightfully against your prostate, making [eachCock] thrum and bulge urgently in pleasure"
                    : "") +
                "."
        );

        this.outputText(
            "\n\nYou convulse fruitlessly against your bonds as you are pushed relentlessly up to your high, " +
                (this.player.hasVagina()
                    ? "your pussy quivering and then clenching ardently around the dildo"
                    : "your [cockplural] pulsing, opening wide and then forced to unload, your back passage tightening eagerly around the thick dildo as you spurt cum deliriously") +
                ", blood rushing to the surface of your behind - only to meet the paddle’s hard blow. Whitney continues to thrust into you indifferent to your orgasm and you groan into your musky gag as the warm, prosthetic dick bends " +
                (this.player.hasVagina() ? "mercilessly" : "") +
                " into your sensitive walls " +
                (this.player.hasCock()
                    ? "continuing to milk you mercilessly, keeping your cock achingly hard"
                    : "") +
                "."
        );
        ...
        this.outputText(
            "\n\nA " +
                (this.whitneyDefurred() ? "hand" : "paw") +
                " reaches around and clutches your [chest] for anchorage as she finally begins to pound into your tenderized hole with all she’s got. She catches a [nipple] between her fingers and you find yourself being forced towards orgasm again, your ears full of her harsh breathing, your nose full of her heavy scent. She’s no longer thrusting into you for your pleasure though, if she ever was; the hard, feral thrusting of the strap-on into your " +
                (this.player.hasVagina() ? "oozing cunt" : "ass") +
                " is all about her, all about working the smaller, teasing end in her own pussy as hard as she can. You are simply a vehicle for her own lusts, and when you come again with a juddering cry into her panties, " +
                (this.player.hasVagina()
                    ? "wetting the bed this time with the jackhammer force of it"
                    : "") +
                " she keeps going, hammering into your hapless " +
                (this.player.hasVagina() ? "[vagina]" : "butt") +
                "."
        );
        ...
        if (this.player.hasVagina() && !this.player.hasCock() && kGAMECLASS.vapula.vapulaSlave())
            this.outputText(
                " You feel the end of the dildo tense deep within you before releasing, filling you full of warm demon spunk until it pools out onto the bed. The feeling is horribly, disgustingly satisfying, and for a moment you can see exactly how Vapula views the world."
            );
    ...
    public whitneyDomRide(): void {
        ...
        if (this.player.isBiped())
            this.outputText(
                " She does the same with your ankles, leaving you helplessly spread-eagled across the bed."
            );
        else if (this.player.isDrider())
            this.outputText(
                " She has long, leather straps attached to the underside of the bed; these are wrapped around the joining of your spindly legs to your heavy abdomen, leaving your chitinous feet pointing helplessly at the ceiling."
            );
        else if (this.player.isGoo())
            this.outputText(
                " “<i>I can’t secure you properly,</i>” she breathes, squeezing your gooey form, sinking her fingers into it. “<i>Owing to this nonsense you call a body. So I will jus’ say it again. Lie. Still.</i>”"
            );
        else if (this.player.isNaga())
            this.outputText(
                " Your long, heavy tail is wrapped around the bedsteads at the foot of the bed and secured with more leather straps, leaving you helplessly spread-eagled across the bed."
            );
        ...
        this.outputText(
            "\n\n“<i>Stop fussing now, sweetheart,</i>” Whitney croons, adjusting the black, elastic blindfold so it is firmly secured over your eyes." +
                (this.player.eyeType == EYES_FOUR_SPIDER_EYES
                    ? " Once she’s finished with that she places another blindfold over your second pair of eyes. You can only groan with laughter at the sheer level of preparation the dog woman is capable of."
                    : "") +
                " “<i>Wouldn’t want you to see what’s coming, would we? That’d ruin half the fun.</i>” "
        );

        this.outputText(
            "\n\nShe crawls down to your lower body, taking her time now as she slides her hands across your abdomen and [hips] and sits herself down in front of [eachCock]" +
                (this.player.balls > 0
                    ? ", making you twitch as she momentarily cups your [balls]"
                    : "") +
                ". She teases you with slow, deliberate movements of her smooth digits, fully aware that all you can do now in your black space is lie there, feeling and listening to what she’s doing to you."
        );
        ...
        // Medium - cock area is within 33% of Whitneys cap without going over.
            ...
            this.outputText(
                "\n\nYour mouth opens as she begins to revolve her supple hips, sliding her wet opening up and down your [cock " +
                    cockI +
                    "]. Your cock is forcibly hardened and sensitized to the point that you can feel her lips parted around your huge girth, her tiny clit pushing up and down every vein and bulge it encounters. You can’t help but try and thrust your way into that tantalizingly warm, wet hole; you groan as with a laugh she pulls away from your crown, shifts herself around, and rubs at the top side of your cock instead. She seems intent on masturbating herself on every inch of your [cock " +
                    cockI +
                    "], frosting every inch with her femjizz... and she has a fair amount of ground to cover."
            );
            ...
            this.outputText(
                "\n\n“<i>Massive centaur cock, lil’ sissy dick, that’d be about you, that’d be a statement about the kinda [guy] you are,</i>” she goes on in a low growl, warming to her theme as she screws you, slowly, rhythmically and surely, the candle she’s clutching somewhere above you. “<i>But you’re weak, ain’t ya? You got no self-control when it comes to pussy. You jus want to be used by anyone and anything. So - get - used!</i>” More liquid wax splashes down, this time on a " +
                    (this.player.isLactating() ? "moistened" : "taut") +
                    " [nipple] and you can’t help but cringe again, your involuntary movements again making Whitney cry out in pleasure, her tight, succulent sex wringing your [cock " +
                    cockI +
                    "] gleefully."
            );
            ...
            this.outputText(
                "\n\nFinally, after enough of her own orgasms that you’ve lost count, Whitney takes pity. She rests herself on you after a particularly hard minute of thrusting, your [cock " +
                    cockI +
                    "] aching with it, toying with the hardened pools of wax which cover your front as the hard clasp around your base is finally released. She begins to pump you again, her hands clenched on your shoulders as she works herself up, letting her sweat drip down onto you and her hard breath echo in your ear."
            );
        ...
        // It's like hoofin' a cream cake whole wivout it touchin da sides!
            ...
            this.outputText(
                "\n\nYour mouth opens as she begins to revolve her supple hips, sliding her wet opening onto your [cock " +
                    cockI +
    ...
    private brandingMenu(): void {
        ...
        if (this.flags[kFLAGS.FARM_CORRUPTION_BRANDING_MENU_UNLOCKED] == 0) {
            ...
            this.outputText(
                "Your thoughts turn to the ingenious magic of your tattooing gear, stashed away in the barn. Grinning, you consider who you will summon to brand."
            );
            ...
            if (this.player.gems >= 50) {
                ...
                if (
                    this.flags[kFLAGS.FOLLOWER_AT_FARM_AMILY] == 1 &&
                    this.hasFreeTattooSlot("amily")
                )
                    this.addButton(1, "Amily", this.brandAmily);
                if (this.flags[kFLAGS.FOLLOWER_AT_FARM_JOJO] == 1 && this.hasFreeTattooSlot("jojo"))
                    this.addButton(2, "Jojo", this.brandJojo);
                if (
                    this.flags[kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 1 &&
                    kGAMECLASS.sophieBimbo.bimboSophie() &&
                    this.hasFreeTattooSlot("sophie")
                )
                    this.addButton(3, "Sophie", this.brandBimboSophie);
                if (
                    this.flags[kFLAGS.FOLLOWER_AT_FARM_VAPULA] == 1 &&
                    this.hasFreeTattooSlot("vapula")
                )
                    this.addButton(4, "Vapula", this.brandVapula);
                if (this.flags[kFLAGS.KELT_BREAK_LEVEL] >= 4 && this.hasFreeTattooSlot("kelly"))
                    this.addButton(5, "Kelly", this.brandKelly);
                if (
                    this.flags[kFLAGS.FOLLOWER_AT_FARM_BATH_GIRL] == 1 &&
                    this.flags[kFLAGS.MILK_SIZE] > 0 &&
                    this.hasFreeTattooSlot("milky")
                )
                    this.addButton(6, this.flags[kFLAGS.MILK_NAME], this.brandSmallMilky);
                if (
                    this.flags[kFLAGS.FOLLOWER_AT_FARM_BATH_GIRL] == 1 &&
                    this.flags[kFLAGS.MILK_SIZE] == 0 &&
                    this.hasFreeTattooSlot("milky")
                )
                    this.addButton(6, this.flags[kFLAGS.MILK_NAME], this.brandBigMilky);
            }
    ...
    private brandWhitney(): void {
        ...
        this.outputText(
            "Whitney knows exactly what it means when you head off to the barn where she stashed your “branding” equipment; the dog girl is already eagerly stripped down by the time you’ve returned. You hold the pots of ink and consider where, and what, to put on her."
        );
    ...
    public brandAmily(): void {
        ...
        this.outputText(
            "You retrieve the pots of ink and paper from the barn and, smiling, tell your pet mouse you’re going to give her a treat."
        );
        ...
        this.outputText(
            ", [master]? That’s my favorite type of treat.</i>” You consider where, and what, to put on her."
        );
    ...
    private brandJojo(): void {
        ...
        this.outputText(
            "You retrieve the pots of ink and paper from the barn and, smiling brightly, tell your pet mouse you’re going to give him a special treat. Jojo knows all too well the nature of your treats. He closes his eyes and waits for the worst as you consider where and what to put on him."
        );
    ...
    private brandBimboSophie(): void {
        ...
        this.outputText(
            "You retrieve the pots of ink and paper from the barn and, smiling, tell your pet harpy you’re going to give her a treat."
        );
    ...
    private brandVapula(): void {
        this.outputText(
            "You retrieve the pots of ink and paper from the barn and, smiling, tell your succubus you’re going to give her a treat."
        );
    ...
    private brandKelly(): void {
        this.outputText(
            "You retrieve the pots of ink and paper from the barn and smilingly tell your centaur cumslut you’re going to give her a treat."
        );
    ...
    private brandSmallMilky(): void {
        this.outputText(
            "You retrieve the pots of ink and paper from the barn and, smiling kindly, tell your ex Sand Witch slave you’re going to give her a treat. "
        );
    ...
    private getBrandingStuff(): void {
        ...
        this.outputText(
            "You stroke at her tiny, bulging button relentlessly until she releases a wordless bark of ecstasy, soaking your hand with a gratifyingly large gush of femcum. As she pants into your chest you wipe one hand clean on her clothes and press the money into her " +
                (this.whitneyDefurred() ? "hands" : "paws") +
                " with the other."
        );
    ...
    private dontGetBrandingStuff(): void {
        ...
        this.outputText(
            "You stroke at her tiny bulging button until you adjudge she’s on the edge, before withdrawing your hand completely. Maybe some other time, you say airily."
        );
    ...
    private brandingAvailableTalk(): void {
        ...
        this.outputText(
            "“<i>[Master]! [Master], I’ve done as you asked,</i>” says Whitney, her tail wagging frantically as you approach. Her eyes are lit with glee and she’s got a cow with her on tether. You settle down and watch as she produces unassuming pots of black and red ink, and a sheaf of what looks like blotting paper."
        );
        ...
        this.outputText(
            " into the pot, withdraws it and then, dripping black fluid, presses it against the cow’s ample backside. The animal moos and swishes its tail in mild protest, but it doesn’t seem in any grievous amount of pain as Whitney’s digit moves, artfully tracing a large number 12 with the ink."
        );
    ...
    public kellySlotSelect(): void {
        this.menu();
        if (this.flags[kFLAGS.KELLY_TATTOO_COLLARBONE] == "")
            this.addButton(0, "Collarbone", this.kellyBrandSelect, 0);
        if (this.flags[kFLAGS.KELLY_TATTOO_SHOULDERS] == "")
            this.addButton(1, "Shoulders", this.kellyBrandSelect, 1);
        if (this.flags[kFLAGS.KELLY_TATTOO_LOWERBACK] == "")
            this.addButton(2, "Lower Back", this.kellyBrandSelect, 2);
        if (this.flags[kFLAGS.KELLY_TATTOO_BUTT] == "")
    ...
    private collarboneIntro(): void {
        this.outputText(
            "You command her to kneel in front of you and be still. Your lithe, naked dog girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper."
        );
    }

    private amilyCollarboneIntro(): void {
        this.outputText(
            "You command her to kneel in front of you and be still. The succubus mouse does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. "
        );
    }

    private jojoCollarboneIntro(): void {
        this.outputText(
            "You command him to kneel in front of you and be still. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on him, and then seal it on with the paper. "
        );
    ...
    private bimboSophieCollarboneIntro(): void {
        this.outputText(
            "You command her to kneel in front of you and be still. It’s difficult to get her to stay still, but she goes into a trance-like state when you finally lay your ink-soaked finger on her, mesmerized by its movement until you lay the paper over the design you’ve drawn and seal the ink."
        );
    }

    private vapulaCollarboneIntro(): void {
        this.outputText(
            "You command her to kneel in front of you and be still. The succubus does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. "
        );
    }

    private kellyCollarboneIntro(): void {
        this.outputText(
            "You command her to kneel in front of you and be still. The centaur does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. "
        );
    }

    private smallMilkyCollarboneIntro(): void {
        this.outputText(
            "You command her to take her clothes off, kneel in front of you and be still. The dusky girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her and then seal it on with the paper."
        );
    }
    ...
    private shouldersIntro(): void {
        this.outputText(
            "You command her to kneel facing away from you and be still. Your lithe, naked dog girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. “<i>What did you draw, [master]?</i>” she says eagerly."
        );
    ...
    private jojoShouldersIntro(): void {
        this.outputText(
            "You command him to kneel facing away from you and be still. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on him, and then seal it on with the paper. "
        );
    ...
    private amilyShouldersIntro(): void {
        this.outputText(
            "You command her to kneel facing away from you and be still. Your succubus mouse does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her and then seal it on with the paper. "
        );
    ...
    private vapulaShouldersIntro(): void {
        this.outputText(
            "You command her to kneel facing away from you and be still. Your succubus does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. "
        );
    ...
    private kellyShouldersIntro(): void {
        this.outputText(
            "You command her to kneel facing away from you and be still. The centaur does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her shoulder blades, and then seal it on with the paper. "
        );
    ...
    private smallMilkyShouldersIntro(): void {
        this.outputText(
            "You command her to kneel facing away from you and be still. The dusky girl does so, keeping her back straight and still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. "
        );
    }

    private bigMilkyShouldersIntro(): void {
        this.outputText(
            "You set yourself down behind [bathgirlName] before dipping your finger into the ink, carefully draw your design on her, and then seal it on with the paper. She barely seems to notice."
        );
    ...
    private jojoLowerbackIntro(): void {
        this.outputText(
            "You command him to set himself face down across your [legs], as if he were about to receive a spanking. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on him and then seal it on with the paper. "
        );
    ...
    private vapulaLowerBackIntro(): void {
        this.outputText(
            "You command her to set herself face down across your [legs], as if she were about to receive a spanking. Your succubus does so, her put-upon sigh turning to a sharp coo as you dip your finger into the ink and carefully draw your design on her, before sealing it on with the paper. "
        );
    ...
    private kellyLowerBackIntro(): void {
        this.outputText(
            "You command her to stand perfectly still.  She can’t quite stop clopping her hooves fretfully as you dip your finger into the ink and carefully draw your design on her human lower back before sealing it on with the paper. "
        );
    ...
    private smallMilkyLowerBackIntro(): void {
        this.outputText(
            "You command her to set herself down across your [legs]. The dusky girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper."
        );
    }
    ...
    private jojoButtIntro(): void {
        this.outputText(
            "You command him to set himself face down across your [legs], as if he were about to receive a spanking. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design onto the softest part of his body and then seal it on with the paper. "
        );
    ...
    private kellyButtIntro(): void {
        this.outputText(
            "You command her to stand perfectly still.  She can’t quite stop clopping her hooves fretfully as you dip your finger into the ink and carefully draw your design on her smooth, brawny horse ass before sealing it on with the paper. "
        );
    ...
    private smallMilkyButtIntro(): void {
        this.outputText(
            "You command her to set herself down across your [legs]. The dusky girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her fine, round ass, and then seal it on with the paper."
        );
    }

    private bigMilkyButtIntro(): void {
        this.outputText(
            "You set yourself down behind [bathgirlName] before dipping your finger into the ink, carefully draw your design on her fine, round ass, and then seal it on with the paper. She barely seems to notice."
        );
    ...
    private kellyTribalTattoo(slot: number): void {
        ...
        if (slot == 0) {
            ...
            this.outputText(
                "“<i>That’s- that’s actually really pretty, [master]!</i>” Kelly says when you’re done, looking down with delight. “<i>Thank you!</i>”"
            );
            tText += "collarbone.";
    ...
    private smallMilkyTribalTattoo(slot: number): void {
        ...
        if (slot == 0) {
            ...
            this.outputText(
                "“<i>Oh hey, that’s quite pretty.</i>” [bathgirlName] smiles down at what you’ve drawn as you withdraw the pen. “<i>Thanks, [name]!</i>” You kiss her fondly on the forehead and send her on her way."
            );
            tText += "collarbone.";
    ...
    private smallMilkyPropertyOfTattoo(slot: number): void {
        ...
        if (slot == 0) {
            this.smallMilkyCollarboneIntro();
            this.outputText(
                "“<i>[name],</i>” [bathgirlName] groans with laughter, deep embarrassment coloring her tan cheeks as she looks down at what you’ve written. “<i>Everyone can see that!</i>” That’s the whole point you reply, with a rakish grin. She sighs in exasperation as you kiss her fondly on the forehead and take your leave."
            );
            tText += "collarbone.";
            this.flags[kFLAGS.MILKY_TATTOO_COLLARBONE] = tText;
        } else if (slot == 1) {
    ...
    private wantOrgyRoom(): void {
        ...
        this.outputText(
            "\n\n“<i>...I could convert my front room into a relaxation room for you,</i>” the dog woman goes on doggedly. “<i>It would have everything I need to properly take care of you. Like a hot tub. And I would pack it with all the sorts of things...</i>“ she sighs dreamily again “<i>all the sorts of things a big, strong " +
                this.player.mf("lord", "lady") +
                " of the land might want. For when [he] is taking care of [his] servants. Like lots of ‘em. At the same time.</i>”"
        );
    ...
    private getOrgyRoom(): void {
        ...
        this.outputText(
            "It’s a heavy investment, but her description of what she intends has definitely piqued your interest. Slowly you turn and, with a flick of the head, indicate the rock where she leaves the farm’s profit each week. Whitney breaks out onto a wide grin, her hands scrunching up on her skirt."
        );
    ...
    private orgyRoomTalk(): void {
        ...
        this.outputText(
            "You can hear Whitney humming to herself happily as you approach her outside the milking shed, and when she sees you she rushes over to clutch at your arm excitedly."
        );
        ...
        if (this.whitneyDom())
            this.outputText(
                "The sight sends a shuddering thrill down your spine. “<i>You didn’t think I’d forget those, did you [master]? We both know how important they are for properly relaxing you,</i>” Whitney murmurs, pushing her hot suppleness into your side. "
            );
        else
            this.outputText(
                "You raise an eyebrow at these and Whitney giggles and blushes. “<i>Just in case you’re feeling adventurous, [master]. Or, um, want help.</i>”"
            );
        this.outputText(
        ...
        if (!this.whitneyDom())
            this.outputText(
                "“<i>It’s exactly what a harem owner needs, [master] - with this you could take care of me and your other sluts all night, every night!</i>”"
            );
        else
            this.outputText(
                "“<i>I could do so many things to you [master], if you were on this stuff. And for so long. Just imagine it!</i>”"
            );
        this.outputText(
            " You don’t feel woozy or spaced out at all - if anything, you feel slightly more aware and in control of your surroundings, it’s just that your skin feels like it’s coated with something vaguely fuzzy. "
        );
    ...
    private orgyRoomSubMassage(): void {
        ...
        this.outputText(
            "You say in a grand, wearied tone that you’ve arrived from another hard day of bringing Mareth to its knees, and that you require the services of your pet masseuse. "
        );
        ...
        if (this.player.isBiped())
            this.outputText(
                " you clamber onto the heated slab, placing your chin on your hands on the cushion at the end"
            );
        else if (this.player.isDrider())
            this.outputText(
                " you tick-tack over and sink your spider underbelly onto the heated marble, before resting your human half down as well. Whitney was foresighted enough to make the slab quite long, and you complete the action in comfort"
            );
        else if (this.player.isNaga())
            this.outputText(
                " you slither over and slide onto the heated slab, placing your chin on your hands on the cushion at the end. You allow your long, heavy tail to pool onto the floor below"
            );
        this.outputText(".");

        this.outputText(
            "\n\nThere’s the sound of cloth falling onto the floor behind you, which you realize is Whitney taking her garments off when a moment later you feel her " +
                (this.whitneyDefurred() ? "smooth" : "fluffy") +
                " thighs brush into your side, sitting herself down gently at the bottom of your back. You are not exactly sure how you’re going to relax with her moist pussy pushing into your rise of your [butt], but you give her the benefit of the doubt for now."
        );
        ...
        this.outputText(
            " rear. After she’s finished making your butt feel red and smooth she dips a heated, greasy hand between your [hips] and"
        );
        ...
        this.outputText(
            " for a moment... before sliding out with a throaty giggle, moving on down to your hips."
        );
        ...
        if (this.player.isBiped()) {
            ...
            if (
                !(
                    ...
                    this.player.lowerBody == LOWER_BODY_TYPE_PONY
                )
            ) {
                this.outputText(
                    " Your mouth opens as a twinge of pure pleasure veins up your [leg] as she massages the soft arch of the sole, making your"
                );
                ...
                this.outputText(
                    " There must be a direct nerve link leading right from the bottom of your body up to your groin because my word, that really shouldn’t feel as good as it does. She swirls her thumbs across the rougher pads of your feet, dipping her warm fingers in and around the valleys of your"
                );
                if (
                    this.player.lowerBody == LOWER_BODY_TYPE_DEMONIC_CLAWS ||
                ...
                this.outputText(
                    ", before returning deliberately to stroke at your arch, indulging that nervous link until you are deep in the unexpected bliss of it... before slowly releasing, leaving you to wallow delightfully in the knowledge that that same slow, delicious attention is about to be lavished on your other [foot]."
                );
            } else {
                this.outputText(
        ...
        // Naga:
            ...
            this.outputText(
                " “<i>I imagine watching your [master] move around is almost a masochistic experience for you. Something so alien and unnerving now linked forever with pleasure and obedience. Is that how it is? You can’t stop staring at my beautiful, deadly form because it’s almost like a slutty punishment for you?</i>”"
            );
        ...
        if (this.player.lust >= 33)
            this.outputText(
                " The hot tub bubbles quietly behind her and it is not just oil which is making your skin glow. This would be the moment to pursue a happy ending if you so wished."
            );
        else
            this.outputText(
                " You play with the idea of ‘rewarding’ her but... damn. She’s actually managed to relax you <i>too</i> much. You thank her regally, redress, and head out the door, enjoying the lightness of step and self-control which thrums through you."
            );
        ...
        if (
            this.player.lust >= 33 &&
            ((this.player.hasCock() &&
                this.player.cockThatFits(this.whitneyVagCapacity() * 1.33) != -1) ||
                this.player.hasVagina())
        ) {
    ...
    private orgyRoomSubMassageHappyEnding(): void {
        ...
        if (this.player.tallness >= 67) {
            this.outputText(
                " With a single movement you swing her hot, compact weight over your shoulder. You growl into her ear that she’s still got plenty to do if she’s to finish her job of thoroughly relaxing every part of you."
            );
            ...
            this.outputText(
                " You tighten your grip on her pert behind and growl that she’s still got plenty to do if she’s to finish her job of thoroughly relaxing every part of you."
            );
        ...
        if (
            ...
            this.outputText(
                " You take a long moment to consider which of your sexes you will satisfy yourself with."
            );
        }
    ...
    private subHappyEndingMale(): void {
        ...
        this.outputText(
            "You drift across and envelope her in your body, your [chest] pushing into the soft suppleness of her small breasts. Feeling your urge but not overcome by it in your relaxed state you instead take time to enjoy the give and take of your slave’s body, her flat stomach planing over yours, the feeling of her hard nipples against your chest, her long, " +
                (this.whitneyDefurred() ? "smooth" : "downy") +
                " legs tangling with yours in the slow motion of the water.  Her breath catches in her chest, panting and trembling there as you push your hand between her thighs, sinking your fingers into her tight, welcoming hole. "
        );

        this.outputText(
            "\n\nYou slide your [cock " +
                cockThatFits +
                "] up and down her abdomen and then between her lips, hardening it as you tease at her wetness with it."
        );
        if (hasBiggerCock)
            this.outputText(
                " Your [cock biggest], so used to getting preferential treatment, bulges in agitation and the lizard impulse to fuck her wide and silly with it saturates the back of your mind; but you know it makes much more sense to keep her nice and tight rather than turn her into another blown out whore in a single bull-in-a-china-shop fuckfest. And anyway... as you test her with your [cock " +
                    cockThatFits +
                    "], you slide your [cock biggest] up her abdomen, enjoying the smoothness of her flesh on one side and the sloshing hot foam on the other. Whitney hums with pleasure and clasps the thick cock pointing towards her breasts in her hands, slowly rubbing it up and down as you prepare to penetrate her.}"
            );

        // First time:
        if (this.flags[kFLAGS.MASSAGE_HAPPY_ENDINGS] == 0) {
            this.outputText(
                "\n\n“<i>Been a while, I take it?</i>” you say softly, as you line your [cock " +
                    cockThatFits +
                    "] up to her pink slit, sighing at its soft, delicious resistance."
            );

            this.outputText(
                "\n\n“<i>Seems like- like forever, [master]. I don’t know why I- ooh...</i>” the thought is lost as you sink into her, pushing deep into her depths, exhaling at how her moist walls push into your prick from every direction. You go slow, stopping and withdrawing almost all the way out when her breath catches in her throat, before gently spearing your way into that delicious tightness again, each time dipping a little further in. Her body remembers the rhythm of it quickly - no doubt aided by the corruption you’ve mired her in - and in no time her hips are gripping into yours, willing the return strokes of your [cock " +
                    cockThatFits +
                    "]."
            );
        }
        // Subsequent:
            ...
            this.outputText(
                "\n\nShe gasps as you push open her lips and spear into her depths with one thrust. Her pussy is used to your [cock " +
                    cockThatFits +
                    "] now, still deliciously tight and clenching but welcoming as well, perfectly designed to holster and squeeze every inch of your modestly sized prick with wet pleasure. Within a few moments your hips are touching hers, taking your cock down to the hilt. Her thighs tighten around your frame and you begin to lose yourself in the soft, slow rhythm."
            );
        }
        ...
        this.outputText(
            " momentarily. You grin, and begin to pump into her a little harder, using the full breadth of movement afforded to you by your oiled, [hips] to do so. It has the effect you anticipated. After a few more moments gamely keeping time with your own heavy exhalations the dog girl you’re buried into gasps, unable to contain herself. You winch her legs up by the knees and go at her faster again, still using the full movement of your pelvis to withdraw and sink every inch of your [cock " +
                cockThatFits +
                "], pushing into her pink tightness vigorously enough for the water around to splash briskly, buried into her even deeper. "
        );
        ...
        this.outputText(
            "\n\nYou hold her tight and join in her groans as you holster every inch of your [cock " +
                cockThatFits +
                "] into her and unload, clenching and pulsing your seed into her. If she didn’t manage it before the dog girl certainly does now; her back arches and her eyes roll as you fill her womb full of your hot spunk, her pussy squeezing around you almost unbearably close, almost sucking the cum out of you."
        );
        if (this.player.cumQ() >= 1500)
            this.outputText(
                " Her small capacity is almost immediately filled and jizz spurts out with every rich thrust you make, polluting the water around you with your massive load."
            );
        if (hasBiggerCock)
            this.outputText(
    ...
    private subHappyEndingFemale(): void {
        ...
        this.outputText(
            "You drift across and envelope her in your body, your [chest] pushing into the soft suppleness of her small breasts. Feeling your urge but not overcome by it in your relaxed state you instead take time to enjoy the give and take of your slave’s body, her flat stomach planing over yours, the feeling of her hard nipples against your chest, her long, " +
                (this.whitneyDefurred() ? "smooth" : "downy") +
                " legs tangling with yours in the slow motion of the water.  Her breath catches in her chest, panting and trembling there as you push your hand between her thighs, brushing through the neat thatch of her public hair to sink your fingers into her tight, welcoming hole.  You winch one of your [legs] over hers, pushing your [vagina] against hers, sighing as your lips touch and rub over each other. "
        );
        ...
        if (this.player.wetness() >= 5)
            this.outputText(
                " Your pussy spurts excitement gleefully with each thrust, utterly drowning her own in your juices, polluting the water around you with your musk."
            );
        if (this.player.hasCock())
            this.outputText(
                " Whitney has stroked and tantalized your [cock biggest] with her hot hands and smooth belly intermittently this whole time, and as your orgasm builds and overwhelms you she gets her just reward for it; you jet cum from [eachCock], pasting first her face and then her tight breasts with your thick cream as you ride her hard."
