...
export class Kelly extends AbstractFarmContent implements TimeAwareInterface {
    ...
    public constructor() {
        ...
        this.pregnancy = new PregnancyStore(
            kFLAGS.KELLY_PREGNANCY_TYPE,
            kFLAGS.KELLY_INCUBATION,
            0,
            0
        );
        this.pregnancy.addPregnancyEventSet(PregnancyStore.PREGNANCY_PLAYER, 280, 200, 100);
    ...
    public timeChange(): boolean {
        ...
        if (this.model.time.hours > 23) {
            if (this.flags[kFLAGS.KELLY_REWARD_COOLDOWN] > 0 && this.model.time.days % 3 == 0)
                this.flags[kFLAGS.KELLY_REWARD_COOLDOWN] = 0;
            if (this.flags[kFLAGS.KELT_BREAK_LEVEL] >= 4)
                this.flags[kFLAGS.KELLY_DISOBEYING_COUNTER]++;
        }
    ...
    public breakingKeltOptions(): void {
        ...
        if (
            (!this.player.hasCock() && this.flags[kFLAGS.KELT_BREAK_LEVEL] == 0) ||
            ...
            this.farm.keltScene.keltEncounter();
            return;
        }
        if (this.flags[kFLAGS.KELT_BREAK_LEVEL] > 0) {
            if (!this.player.hasCock()) {
                this.outputText(
                    "You can't keep trying to break Kelt without the proper tool to do it with."
                );
                this.menu();
        ...
        this.outputText(
            "Having met Kelt, you know he's liable to subject you to plenty of abuse in exchange for training.  Are you going to endure it, resist, or never resist?"
        );
        this.menu();
    ...
    private resistKeltsBSBreakHimIntro(): void {
        ...
        if (this.flags[kFLAGS.KELT_BREAK_LEVEL] == 0) {
            this.outputText(
                "You are more and more annoyed by Kelt's rudeness and dick-waving.  The centaur may be imposing at first and his archery skills are impressive, but you're sure that behind his false display of virility, there's nothing an experienced champion like you can't deal with.  With your superior strength and speed, you could probably take him by surprise and teach him a good lesson.  Of course, you won't ever be able to learn archery from him after that."
            );
            // [if (PC doesn't have items)
            if (
                !(
                    this.player.hasItem(this.consumables.SUCMILK, 15) ||
                    (this.player.hasItem(this.consumables.SUCMILK, 10) && this.hasPinkEgg()) ||
                    (this.player.hasItem(this.consumables.P_S_MLK, 10) && this.hasPinkEgg()) ||
                    this.player.hasItem(this.consumables.P_S_MLK, 15)
                )
            ) {
                this.outputText(
            ...
            this.outputText(
                "You set out to go get Kelt, eager to teach this slut another lesson of your own.  You explore the farm for a bit before spotting the centaur behind the barn.  However, Kelt seems to have changed since last time: he somehow changed back his gender.  That rebellious little bitch!  Although he doesn't look as aggressively masculine as before, and his chest still bears some man-tits, he has gotten back his stern, rude face and you can clearly see a fat prick hanging from his backside.  It doesn't seem to be as big as it was before, though.  He must have grown it in a hurry."
            );
            // back to farm]
            // [if you don't have the items:
            if (
                !(
                    this.player.hasItem(this.consumables.SUCMILK, 10) ||
                    this.player.hasItem(this.consumables.P_S_MLK, 10) ||
                    (this.player.hasItem(this.consumables.SUCMILK, 5) && this.hasPinkEgg()) ||
                    (this.player.hasItem(this.consumables.P_S_MLK, 5) && this.hasPinkEgg())
                )
            ) {
                this.outputText(
        ...
        // Third encounter
            ...
            // [Start Combat]
            this.startCombat(new Kelt());
            this.spriteSelect(35);
        } else if (this.flags[kFLAGS.KELT_BREAK_LEVEL] == 3) {
            this.spriteSelect(-1);
    ...
    private neverBreakKeltIntoKelly(): void {
        ...
        this.flags[kFLAGS.NEVER_RESIST_KELT] = 1;
        this.outputText(
            "You decide that trying to break Kelt is something you'd never want to do.  Besides, he's teaching you a useful skill, and there's just something charming about that bastard..."
        );
        this.menu();
    ...
    private breakKeltGo(): void {
        ...
        this.spriteSelect(35);
        this.outputText(
            "You approach the uppity centaur with glinting eyes, determined to take him down.  Kelt mistakes your anger for desire and sneers."
        );

        this.outputText(
            '\n\n"<i>What do you want, you little ' +
                this.player.mf("sissy", "bitch") +
                "?  I'm done with you.  I'm already doing you a favor by teaching you a skill sluts like you will never use nor master.</i>\""
        );
        ...
        this.outputText("\n\nWHAM!  ");
        if (this.player.tallness < 70) this.outputText("You jump up, and y");
        else this.outputText("Y");
        this.outputText(
            "our [weapon] hits Kelt's forehead, knocking him back.  He didn't even dodge or defend himself; the hit brought him down immediately."
        );
        ...
        if (this.hasPinkEgg()) {
            this.outputText(", as well as the egg");
        }
        this.outputText(
            ".  You grab a nearby keg and pour down vial after vial until it's half-full.  The creamy substance exudes strong female scents that arouse both of you."
        );

        if (this.hasPinkEgg()) {
            this.outputText(
                "  You then throw the egg into the keg before stirring the whole mixture, grinning as you prepare Kelt a whole new meal."
            );
        }
        ...
        if (!this.player.isTaur())
            this.outputText(
                "pulling [eachCock] out of your [armor] and stroking yourself with your free hand"
            );
        else {
            this.outputText("slapping your hardening dick");
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" against your belly in anticipation");
        }
        this.outputText(".  You might as well add some flavor to the meal.");
        ...
        this.outputText(
            " small droplets of pre-cum begin dripping out of your " +
                this.multiCockDescriptLight() +
                " before being swallowed by the potent, feminine mixture down below.  The white spots are drowning in that milky goo, but you're confident that Kelt will be able to recognize the taste."
        );
        ...
        this.outputText(" to use later.  You lift the keg and walk up to Kelt.");
        ...
        if (!this.player.isTaur())
            this.outputText(
                "fully whip out your [cock biggest] and shove it between her busty tits and slowly start grinding"
            );
        else
            this.outputText(
                "step over her, shoving your [cock biggest] between her busty tits, grinding it through that smooth valley"
            );
        this.outputText(".");
        ...
        if (this.player.isTaur()) this.outputText("dance your hindlegs about in order to ");
        this.outputText("cockslap her.");
        ...
        if (this.player.isTaur())
            this.outputText(
                "step over her, moving your hips back and forth to thrust through her more-than-ample cleavage."
            );
        else
            this.outputText(
                "grab her nipples and begin to thrust your pecker against her boob valley."
            );
        this.outputText(
            "  She occasionally gives your tip a wet kiss, trying to make up for her mistakes.  You ignore her and thrust harder, her round melons squeezing your shaft rhythmically."
        );
        ...
        if (this.hasPinkEgg()) {
            ...
            if (this.player.hasItem(this.consumables.SUCMILK, 10))
                this.player.consumeItem(this.consumables.SUCMILK, 10);
            else this.player.consumeItem(this.consumables.P_S_MLK, 10);
        } else {
            if (this.player.hasItem(this.consumables.SUCMILK, 15))
                this.player.consumeItem(this.consumables.SUCMILK, 15);
            else this.player.consumeItem(this.consumables.P_S_MLK, 15);
        }
    ...
    public defeatKellyNDBREAKHIM(): void {
        ...
        if (this.monster.lust > 99)
            this.outputText(
                "Kelt moans, mauling at his mantits in his lust before he realizes what's going on"
            );
        else
            this.outputText(
                "Kelt groans, slumping slightly from all the damage you've done to him"
            );
        this.outputText(
            '.  You close in, saying, "<i>Easy now, okay?  You know what I can do with my [weapon].  Now if you just calm down, I promise I\'ll be much nicer this time.</i>"'
        );
        ...
        if (
            this.silly() &&
            kGAMECLASS.amilyScene.amilyFollower() &&
        ...
        if (this.player.isTaur()) this.outputText("push her underneath you towards");
        else this.outputText("pull her close to");
        this.outputText(" your erect " + this.multiCockDescriptLight() + ".");
        ...
        if (this.player.balls > 0) this.outputText(" and fondling your [balls] with great care");
        this.outputText(
            ".  Her lips regularly wrap around your [cock biggest] in near-perfect sucking motions.  She's getting better at this."
        );
        ...
        if (this.hasPinkEgg()) {
            ...
            if (this.player.hasItem(this.consumables.SUCMILK, 5))
                this.player.consumeItem(this.consumables.SUCMILK, 5);
            else this.player.consumeItem(this.consumables.P_S_MLK, 5);
        } else {
            if (this.player.hasItem(this.consumables.SUCMILK, 10))
                this.player.consumeItem(this.consumables.SUCMILK, 10);
            else this.player.consumeItem(this.consumables.P_S_MLK, 10);
        ...
        this.player.orgasm();
        this.dynStats("cor", 5);
        this.flags[kFLAGS.KELT_BREAK_LEVEL] = 2;
    ...
    public breakingKeltNumeroThree(): void {
        this.clearOutput();
        if (this.monster.HP < 1) this.outputText("Slumping down, ");
        else this.outputText("Moaning, ");
        this.outputText(
            "he doesn't attempt to escape or attack you.  Before he can do anything, you're already on him. His reactions appear to be a lot slower since he began discovering his new craving for your dick.  He just stares at you nervously, waiting for your next move."
        );
        ...
        if (!this.player.isTaur()) this.outputText(", sometimes with your [cock] -");
        this.outputText(' and yell: "<i>What\'s your name?</i>"');
        ...
        if (this.player.isTaur()) this.outputText("push from behind");
        else this.outputText("pull");
        this.outputText(
            ", you pin her head against your groin and shove your wang down her throat.  This time, the centauress doesn't seem to be hindered or about to choke.  She takes the entirety of your length and sucks you up like the good little whore she is.  Your entrapped cock is squeezed so tightly that you feel like it's about to explode; not willing to reach your climax so soon, you swiftly pull out of her mouth."
        );
        ...
        this.outputText("\n\nYou briskly reach ");
        if (this.player.isTaur()) this.outputText("down, pushing her");
        else this.outputText("forward to grab one of her tits and grope it");
        this.outputText(" convulsively as you feel your lust rise.  ");
        if (!this.player.isTaur())
            this.outputText(
                "Soon one breast isn't enough to contain your lust-driven energy and you reach for the other one with your free hand.  Your constant nipple-teasing has an effect on"
            );
        else
            this.outputText(
        ...
        this.outputText(
            " Kelly at last: you can hear her moan and sigh, and her hands move erratically on your " +
                this.multiCockDescriptLight() +
                ", sometimes violently yanking it as she loses control.  This brings all kinds of painful yet pleasurable tingles to your body, and only entices you to feel her up even more."
        );

        this.outputText("\n\nA familiar warmth builds in your loins ");
        if (this.player.balls > 0) this.outputText("and your [balls] churn ");
        this.outputText("as you feel your climax coming.  ");
        if (!this.player.isTaur())
            this.outputText("You squeeze Kelly's boobs so harshly she screams in pain, and y");
        else this.outputText("Y");
        this.outputText(
            "ou release a loud groan yourself.  You cum hard, your quivering [cock biggest] spraying spooge in steady jets directly into the keg.  You maintain your grip on the centauress"
        );
        if (!this.player.isTaur()) this.outputText("' breasts");
        this.outputText(
            ", heedless of her pain and only caring about your own orgasm.  You feel her soft hands squeezing your junk there and there in order to milk the last drop of cum and making sure none of it remains stuck in your urethra.  When you're done riding out your orgasm, you walk up to the keg and pour down the two bottles of Succubi Milk you have left.  The copious amount of baby-batter mixes with the alright-alabaster fluid to form a bubbling ivory mixture that you bring close to Kelly's lips."
        );
        ...
        this.player.orgasm();
        this.dynStats("cor", 5);
        this.flags[kFLAGS.KELT_BREAK_LEVEL] = 3;
        this.cleanupAfterCombat();
    }
    ...
    private finalKeltBreaking(): void {
        this.clearOutput();
        this.outputText(
            "You resolutely walk up to the centaur slut for her final lesson.  This time you don't even need to find her: she rushes to you on her own, her eyes glinting with need."
        );
        this.outputText(
        ...
        this.outputText(
            "\n\nYou laugh triumphantly as you whip your " +
                this.multiCockDescriptLight() +
                " out of your [armor]; the slut is more than ready!"
        );
        ...
        if (this.player.isTaur()) this.outputText("kneels down");
        else this.outputText("bends over");
        this.outputText(
            " to reach for your [cock biggest].  She sucks with eagerness and passion; you don't even need to pull her head as it moves on its own around your length.  "
        );
        if (this.player.balls > 0)
            this.outputText(
                "Her free hands moves down on your groin and caresses your [balls] with expert care and precision; obviously her previous experience in groping has had an effect on her current skills.  "
            );
        this.outputText(
            "Her hunger for your meaty junk seems to be insatiable, for after moments of dick kissing and licking, she decides to take the entirety of your length.  Her eyes are voracious as her fat lips swallow inch after inch of dick-flesh."
        );
        ...
        if (this.player.isTaur()) this.outputText("hindleg haunches");
        else this.outputText("[butt]");
        this.outputText(
            ", always pulling your groin closer to her avid mouth as she relentlessly throatfucks herself on you.  Your [cock biggest] is being squeezed and massaged in the most divine way as it knocks against her warm esophagus, and you're tempted to cum in her right now, right here. But you need to finish the 'lesson'; with great regret, you softly "
        );
        if (this.player.isTaur()) this.outputText("back away");
        else this.outputText("push the centaur girl away");
        this.outputText(
            " and pull out of her mouth. Wailing with displeasure, the cock-slut decides to give your meat a couple of sad licks, disappointed to see her phallic prize withdrawing from her.  She quickly regains her enthusiasm, however."
        );
        ...
        if (!this.player.isTaur())
            this.outputText(
                "You grope her bountiful tits and pull them closer to you as you fuck them.  "
            );
        this.outputText(
        ...
        if (this.silly()) this.outputText("  CUM CANNON!");
        this.outputText(
            '</i>"  A familiar power gathers inside you, and you decide to tap into it.  You pull out of her tits and cum really, really hard.'
        );
        ...
        this.outputText(
            "\n\nThe cum-flow eventually starts to ebb; less and less goo pours from your " +
                this.multiCockDescriptLight() +
                " and your orgasm gradually fades out.  When your euphoric pleasure wears off, you finally get a good look at the creature standing before you."
        );
    ...
    private keltFucksShitUpII(): void {
        ...
        this.flags[kFLAGS.KELT_BREAK_LEVEL]--;
        if (this.flags[kFLAGS.KELT_BREAK_LEVEL] < 1) this.flags[kFLAGS.KELT_BREAK_LEVEL] = 1;
        this.cleanupAfterCombat();
    }
    ...
    private kellyAppearance(): void {
        this.clearOutput();
        this.outputText(
            "Kelly is a 6 foot 3 inch tall centauress with a svelte body and generous curves.  Her feminine face is pretty human in appearance, and her lovely traits would be adorably innocent if it weren't for her emerald eyes shining with lusty need whenever she looks at you.  Plump lips that seem to have been made for cock-sucking adorn her hungry mouth.  A long, single " +
                this.flags[kFLAGS.KELLY_HAIR_COLOR]
        );
        // [chestnut brown/sable black/garish purple/bright pink/slutty blonde)
        this.outputText(
            " braid hangs between her shoulders, giving you easy leverage when you have your way with her.  Her torso is likewise human-looking, only stopping below her navel where her equine part starts growing.  She stands on four horse hooves, her lower body looking almost like a horse's- aside from the pointed " +
                this.flags[kFLAGS.KELLY_HAIR_COLOR] +
                " demon's tail which sprouts where her horse tail should, and her cute, pink, human-like asshole."
        );
        // [chestnut brown/sable black/garish purple/bright pink/slutty blonde]
        ...
        if (this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0)
            this.outputText(
                "  Beneath those, she has a second row of jiggly tits, just aching to be squeezed."
            );
        if (this.pregnancy.isPregnant)
            this.outputText(
                "  Drops of milk often dribble from her tits, betraying her potent lactation."
            );
        // [enter vagina text]
        this.outputText("\n\nKelly has a ");
        // [virgin]
        if (this.flags[kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT] == 0) this.outputText("virgin, ");
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 0) this.outputText("pink pussy");
        else this.outputText("puffy, black mare-cunt");
        this.outputText(
            " placed below her hindquarters.  It is almost constantly dripping rivulets of moisture when you're around.  Its shining openness seems to welcome you in her warmth."
        );
        if (this.flags[kFLAGS.KELLY_HEAT_TIME] > 0 && !this.pregnancy.isPregnant)
            this.outputText(
                "<b>  There is so much leaking from her that you think she might be in heat, rendering her more receptive to impregnation.</b>"
            );
        this.outputText(
        ...
        if (this.farm.farmCorruption.hasTattoo("kelly")) {
            this.outputText("\n\n");
            if (this.farm.farmCorruption.kellyFullTribalTats()) {
                this.outputText(
                ...
                if (this.farm.farmCorruption.numTattoos("kelly") > 1)
                ...
                if (this.flags[kFLAGS.KELLY_TATTOO_COLLARBONE] != "")
                    this.outputText(this.flags[kFLAGS.KELLY_TATTOO_COLLARBONE] + "\n");
                if (this.flags[kFLAGS.KELLY_TATTOO_SHOULDERS] != "")
                    this.outputText(this.flags[kFLAGS.KELLY_TATTOO_SHOULDERS] + "\n");
                if (this.flags[kFLAGS.KELLY_TATTOO_LOWERBACK] != "")
                    this.outputText(this.flags[kFLAGS.KELLY_TATTOO_LOWERBACK] + "\n");
                if (this.flags[kFLAGS.KELLY_TATTOO_BUTT] != "")
                    this.outputText(this.flags[kFLAGS.KELLY_TATTOO_BUTT] + "\n");
                this.outputText("\n");
            }
        }

        // Kids flavour text
        if (this.flags[kFLAGS.KELLY_KIDS] > 0) {
            if (this.flags[kFLAGS.KELLY_KIDS] == 1) {
                this.outputText("\nKelly's ");
                if (this.flags[kFLAGS.KELLY_FIRST_KID_GENDER] == 1) this.outputText("son");
                else this.outputText("daughter");
                this.outputText(" is off in a separate field; still very young, you can see ");
                if (this.flags[kFLAGS.KELLY_FIRST_KID_GENDER] == 1)
                    this.outputText("him playing in the distance, lost in his own little world.");
                else this.outputText("her playing in the distance, lost in her own little world.");
            } else if (this.flags[kFLAGS.KELLY_KIDS] == 2)
                this.outputText(
                    "\n\nThe " +
                        Kelly.num2Text(this.flags[kFLAGS.KELLY_KIDS]) +
                        " children you have had with Kelly are off in a separate field; the sound of their play drifts over the grasslands to your ears.  Kelly evidently prefers to keep her brood away from what you do with her, a remarkably sensible attitude coming from a centauress cumslut.  Maybe motherhood genuinely suits her?"
                );
            else
                this.outputText(
                    "\n\nThe " +
                        Kelly.num2Text(this.flags[kFLAGS.KELLY_KIDS]) +
                        " children you have had with Kelly are as ever off in a separate field, the distance sounds of their acting out the wars and drama of childhood drifting out over the grasslands to your ears."
                );
            this.outputText("\n");
        }
        this.menu();
    ...
    private approachKelly(): void {
        this.clearOutput();
        // Fix hair color!
        if (this.flags[kFLAGS.KELLY_HAIR_COLOR] == "")
            this.flags[kFLAGS.KELLY_HAIR_COLOR] = "chestnut brown";
        // PUNISH SCENES IF APPROPRIATE
        if (
            this.flags[kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT] > 0 &&
            this.flags[kFLAGS.TIMES_PUNISHED_KELLY] == 0 &&
            Kelly.rand(3) == 0 &&
            this.player.hasCock()
        ) {
        ...
        if (this.flags[kFLAGS.FARM_CORRUPTION_STARTED] == 0)
            this.outputText(
                "You aren't welcome on the farm proper, but you can go visit Kelly's field."
            );

        // 09:00-11:00, 2 or more children:
        if (
            this.model.time.hours >= 9 &&
            this.model.time.hours <= 11 &&
            this.flags[kFLAGS.KELLY_KIDS] >= 2
        ) {
            this.outputText(
                "\n\nKelly is standing in the shadow of her barn, an expression of blissful contentment on her face as she nurses your "
            );
            if (this.flags[kFLAGS.KELLY_KIDS] > 2) this.outputText("two youngest ");
            this.outputText("children with ");
            if (this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0) this.outputText("the top row of ");
            this.outputText(
                "her milk-laden tits.  When she dreamily opens her eyes and sees you standing there, she nudges them off gently."
            );
            this.outputText(
        ...
        // 15:00-16:00, 4 or more children:
            ...
            this.flags[kFLAGS.KELLY_KIDS] >= 4
        ) {
            this.outputText(
        ...
        if (this.player.hasItem(this.consumables.CANINEP)) {
            ...
            if (this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] == 0)
                this.outputText(", but who knows how it will change her");
            this.outputText(".");
            this.addButton(6, "Give CanineP", this.giveKellyAPepper);
        }
        if (
            this.flags[kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT] > 0 &&
            this.flags[kFLAGS.KELLY_DISOBEYING_COUNTER] >= 3 &&
            this.player.hasCock()
        ) {
            this.outputText(
    ...
    private kellySexMenu(): void {
        ...
        if (this.player.hasCock() && this.player.lust >= 33) {
            if (this.player.cockThatFits(300) >= 0 || this.flags[kFLAGS.KELLY_CUNT_TYPE] == 1) {
                ...
                if (this.flags[kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT] == 0)
                    this.addButton(0, "VirginFuck", this.takeKellysVirginity);
                if (this.player.tentacleCocks() >= 2)
                    this.addButton(1, "TentaFuck", this.tentaFuckKelly);
            } else this.outputText("\n<b>You're too big to fuck her vagina.</b>");
            if (
                this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] == 0 &&
                this.player.cockThatFits(18, "length") < 0 &&
                !this.player.isTaur()
            ) {
                this.outputText(
    ...
    private fuckKellysCunt(): void {
        ...
        if (this.player.tallness < 72) {
            this.outputText("You turn around to get a stool, since your ");
            if (this.player.tallness < 52) this.outputText("diminutive ");
            this.outputText("height makes reaching her pussy a difficult task.  ");
        }
        this.outputText(
            "Holding your " +
                this.cockDescript(x) +
                " in one hand, you press your " +
                this.player.cockHead(x) +
                " against her entrance.   The steamy cunt pulses wetly around your girth, slowly spreading its thick lips to accept your rigid endowment."
        );
        if (this.player.cockTotal() > 1) {
            this.outputText("  Your other erection");
            if (this.player.cockTotal() > 2) this.outputText("s hang");
            else this.outputText(" hangs");
            this.outputText(" down below, collecting her drippings and smearing across her belly.");
        }
        this.outputText(
            "  You slowly slide inside the tight tunnel, feeling Kelly's powerful muscles squeeze delightfully around you, massaging your " +
                this.cockDescript(x) +
                " with slow undulations."
        );
        ...
        if (this.player.cockArea(x) >= 300) this.outputText("bottom out inside her");
        else this.outputText("slide as far into her as she can handle");
        this.outputText(
            " and smack her ass for good measure.  She's so fucking warm!  You sit there for a moment, just to revel in the hot, slippery heat.  Then, you draw back, exposing yourself to the cool air - but only for a moment.  You slam your hips back into the tight centaur-twat without hesitation, the force of the impact jolting the larger woman's body forward."
        );
        this.outputText(
            '\n\n"<i>Yessss,</i>" Kelly moans as she\'s impaled, her breasts jiggling as she paws at them.  "<i>Ple-ooohhhh... please don\'t stop, [Master]!</i>"  She begins to push her body against you, the silken tunnel she calls a cunt twitching rhythmically around your ' +
                this.cockDescript(x) +
                " each time you hit the apex of your strokes.  You squeeze her haunches as you 'ride' her.  She loves every moment of it, even when you slap her butt for good measure, spurring her to bounce herself atop your rod faster and faster."
        );
        ...
        if (this.player.balls > 0) this.outputText(" and roiling balls");
        this.outputText(
            " leaves no doubt that climax is fast approaching.  Kelly cums first, splattering your [hips] with her "
        );
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] > 0) this.outputText("fragrant ");
        this.outputText(
            "centaur-cum, soaking your [legs] immediately.  Her pussy goes wild, the once-ordered spasms going wild, wringing your " +
                this.cockDescript(x) +
                " with uncoordinated motions.  A moment later, all those wild contractions sync up into intense, dick-massaging waves.  The power of her equine lower half becomes obvious when her twat seems to suck you inside, squeezing you off to orgasm."
        );
        ...
        if (this.player.cumQ() >= 500)
            this.outputText(
                "  Her pussy seems like a soggy, cum-soaked sex-toy before you're even halfway done."
            );
        if (this.player.cumQ() >= 1200) {
            this.outputText(
                "  The sheer amount of spunk exploding into her womb actually rounds her belly a little"
            );
            if (this.player.cumQ() >= 4000)
                this.outputText(", until she's so pregnant with spooge that she can barely stand");
            this.outputText(".  ");
        }
        this.outputText(
            "You lay immobile on her back, panting while her wonderful cunt drains you of every drop."
        );
        ...
        if (!this.pregnancy.isPregnant)
            this.outputText(" so the cum can turn you into a proper broodmare");
        else
            this.outputText(
                ", maybe knit some for the kids you're going to be pumping out for me non-stop"
            );
        this.outputText('.</i>"');
    ...
    private taurOnTaurSexKelly(): void {
        ...
        this.outputText(
            ", pressing it into her face, letting your sweat and the scent of your groin smother as effectively as your presence.  Her tongue extends, knowing what you want even before you have to ask.  She licks you, tentatively and then with increasing levels of confidence, smearing saliva all over your flesh as she licks up every drop of sweat, orally lubricating you with hot, wet tongue."
        );
        if (this.player.balls > 0)
            this.outputText(
                "  Your [balls] tingle pleasantly from the attention, and you groan when she sucks one into her mouth, worshipping it with her lips."
            );
        this.outputText(
        ...
        if (this.player.balls > 0) this.outputText("[sack]");
        else this.outputText("hindlegs");
        this.outputText(", splattering out in fresh waves from Kelly's ");
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] > 0) this.outputText("musky ");
        this.outputText(
            "womanhood.  With her body firmly under your own, where it belongs, you firmly assert your control, grabbing her hair in one hand and yanking.  You tug her head back as you bottom out, your body filled with the pleasure of mating like the beasts that you are."
        );

        this.outputText(
            '\n\nKelly groans through her pain, "<i>Ooohh, yes, give me your foal, [Master]!  My pussy needs it!</i>"  True to her words, her walls begin to tug at your ' +
                this.cockDescript(x) +
                " with familiar, milking contractions, squeezing you from base to " +
                this.player.cockHead(x) +
                " again and again.  Her fluids gush out everywhere, turning the ground underneath her to mud as she climaxes.  You pinch her nipples as the heat builds within you, and when you can take it no more, you reward your cum-slut with the liquid orgasm she so craved.  Jism basts her inner walls when you explode.  Again and again, your muscles clench with ecstatic blast, ejaculating thick flows of your lust straight into the cum-dumpster's spasming cunny.  "
        );
        if (this.player.cumQ() >= 1000) {
            this.outputText("  Her belly grows round with the liquid weight of your spunk");
            if (this.player.cumQ() >= 4000)
                this.outputText(
                    ", and when she grows too full to hold any more, waves of alabaster spooge roll out of her abused nether-lips, adding to the messy sex-puddle below"
                );
            this.outputText(".  ");
        }
        this.outputText(
            "Thoroughly creamed, the centaur cum-dump sighs in satisfaction while you dismount her."
        );
        ...
        if (this.player.cor < 50)
            this.outputText(
                "  You feel a little bad for her and help her up - she did just milk your dick in the way that only a centaur can."
            );
    ...
    private tentaFuckKelly(): void {
        this.clearOutput();
        this.outputText(
            "With a mischievous grin, you remove your [armor], fully revealing your " +
                this.multiCockDescriptLight() +
        ...
        this.outputText(
            "\n\nSLAM!  You profit from the slut's babbling to shove your " +
                this.cockDescript(one) +
                " right into her gaping mouth, forcefully filling her throat with dick-flesh.  Her lips instinctively cling to your shaft, sucking it like a popsicle.  Drops of pre-cum are quickly swallowed and ingested by the hungry whore as they escape your urethra.  You begin thrusting in and out of her warm mouth, but her lips squeeze your rod so tight that you have to fight for every inch.  As you stuff her full of your " +
                this.cockDescript(one) +
                ", you can hear her endless muffled moans; the slut is obviously getting off to the taste of your meaty junk.  Completely driven with lust, the green tentacle prick is vibrating on its own as it fucks Kelly's throat, sending you soft, prickling sensations.  You can't help but release a grunt as the centaur slut fellates you so expertly."
        );
        this.outputText(
            "\n\nKelly is doing an incredible job with her mouth, teasing you into oblivion.  Your " +
                this.cockDescript(two) +
                " is convulsing recklessly in frustration, begging to be stuffed into some warm hole.  Therefore, you naturally direct it toward the centauress' wet snatch; it is easily spottable due to the regular streams of juices that ooze from it.  Moreover, the slut is incredibly turned on from sucking you off, and the fem-spunk trails are even thicker than usual.  It doesn't take long for your secondary tentacle dong to reach the entrance of her moist love-tunnel.  You grind the tip of your " +
                this.cockDescript(two) +
                " against it, using her genitals as a masturbation aid.  When it is hard as bark and ready to go, you ram it through Kelly's fuck-hole, utterly piercing her from behind."
        );

        this.outputText(
            "\n\nYou ream the centaur slut from both sides, making her whinny and thrash violently.  She tramples the floor with her hooves, arches her back and screams in ecstasy through the inches of dick-flesh blocking her throat; she is completely heedless of the world beside the two hard vegetal poles fully impaling her on either end.  You pump away in rhythm, synchronizing each thrust in both holes.  Her twat is almost inhumanly hot, and gloriously tight.  However, the slut tries her best to wrap her lips even tighter around your main flexible pecker, and her tongue is teasing your " +
                this.cockDescript(one) +
                " in the most excruciating way.  You stuff the mare slut full of your green appendages, treating her body like a bipolar cocksleeve."
        );

        // [if (cocks > 2)
        if (three >= 0) {
            this.outputText(
                "\n\nThe display of Kelly trembling in pleasure as you spit her like a pig on your duo of plant-like pricks is enticing, and your " +
                    this.cockDescript(three) +
                    " is aching with need.  It almost moves on its own volition toward the woman's perky tits, ready for a good boobjob.  The supple green wang lodges itself between the busty melons; the slut instantly begins to squeeze her heavy globes around the rod of dick-flesh, fully entrapping it in her bosom.  Her tits are so tender and soft you feel like your tentacle pecker is about to melt.  Groaning in pleasure, you thrust your " +
                    this.cockDescript(three) +
                    " up and down as the titty-fucked whore accompanies your motion.  You grind in rhythm so the slut doesn't forget your other tentacle dongs.  Fortunately, Kelly quickly picks up your intention and soon you can't tell which member is providing you with the most pleasure; her mouth, vagina and soft tits are all working in conjunction, and you are fully lost in a never-ending spiral of ecstasy."
            );
        }
        // if (cocks > 3)
        if (four >= 0) {
            this.outputText(
                "\n\nYour " +
                    this.cockDescript(four) +
                    " trembles furiously, unable to find some body part that isn't taken by its colleagues.  You grin wickedly as an idea comes to your mind.  The protruding appendage writhes as it threads its way toward Kelly's right hand; the slut is still focusing on your " +
                    this.cockDescript(three) +
                    ", squeezing her tits as tightly as she can.  Needless to say, she is surprised when another tentacle shoves itself in the way, right under her palm.  She doesn't lose her composure, though; using her forearm to press on her chest, her hand quickly grabs hold of your tree-like pecker and begins stroking your length.  Although her handjob doesn't feel as warm and tight as the wet depths of her love-tunnel or her throat, or even the squelching contact of her tender boob-flesh, she teases you efficiently with her fingers.  Her hand massages your " +
                    this.cockDescript(four) +
                    " and clutches it like a vice, milking some drops of pre-cum out of your shaft.  She takes care of the most sensitive points and often makes you moan when she squeezes the towering rod."
            );
        }
        // [if (cocks > 4)
        if (five >= 0) {
            this.outputText(
                "\n\nKelly still has a free hand, and your " +
                    this.cockDescript(five) +
                    " is left alone, flustered.  The squirming tentacle quickly finds a comfortable spot near her boob, but this time you don't need to do anything; the eager slut catches the vegetal rod and begins to stroke it furiously.  Her hands pump along your lengths in turn; both pricks are so hard that you don't know which one will cum first.  Her fingers move across the surface of your meaty green dongs with expert care, teasing you more and more.  You enjoy the double handjob, your duo of plant-like dongs ready to explode in a mess of cum."
            );
        }
        // [if (cocks > 5)
        if (this.player.tentacleCocks() > 5) {
            this.outputText(
        ...
        this.outputText(
            "\n\nEventually the slutty mare's holes and flesh are starting to drain your stamina; a pressure builds in your crotch as the imminent release arrives. With a raging grunt, you pump harder and faster, not caring in the least about the fuck-toy within your tentacle embrace.  [EachCock] jiggles in extreme arousal as they have their way with the quivering lump of horny flesh that you call Kelly.  At last the pressure is too much to bear, and you blast her with everything you have.  Torrents of spunk boil as they find their way up your urethras and utterly fill the centauress' holes.  Her lips contract lewdly around your " +
                this.cockDescript(one) +
                ", ready to swallow everything it squirts.  At the same time, her tight twat seems to be crunching your " +
                this.cockDescript(two) +
                " like a vice; you can't help but pump more and more ropes of jism into the slut's waiting womb."
        );
        if (three >= 0) {
            this.outputText("  The remainding tentacle");
            if (four >= 0) this.outputText("s erupt");
            else this.outputText(" erupts");
            this.outputText(
                " in an unholy fountain of seed, splattering the slut's horny body with white goo. Kelly seems to thoroughly enjoy her cum bath, as she lets out deadened screams of ecstasy.  She clearly gets off on being covered with your spooge; indeed, you can feel her hot pussy squirting load after load of juice, and the drops of spunk with your own to create a puddle of filth on the farm's floor.  You shoot your load on the eager cumdumpster, utterly drenching her until she is sopping wet; not a square inch of skin is spared from this almighty geyser."
            );
        }
        this.outputText(
        ...
        if (this.player.cor < 33)
            this.outputText("but also a bit disgusted to watch such shameless, wanton behavior, ");
        this.outputText("you walk away, letting the slut enjoy herself.");
        this.kellyPreggers();
        this.player.orgasm();
        this.dynStats("sen", -3);
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private giveKellyEquinum(): void {
        this.clearOutput();
        this.outputText(
            "Taking the long, flared vial in your hand, you get a wicked idea - what if you gave your personal mare-slave a cunt that was better suited to her depraved, animalistic shape?  What if you turned that pretty, pink pussy into a slobbering, black mare-cunt?"
        );
        ...
        this.flags[kFLAGS.KELLY_CUNT_TYPE] = 1;
    ...
    private giveKellySuccubiMilk(): void {
        this.clearOutput();
        this.outputText(
            'You produce a vial of succubi milk and dangle it before Kelly, the ivory demon-juice sloshing audibly inside.  Kelly licks her lips immediately, running her hands across her perky nipples without meaning to.  She asks, "<i>[Master], is that what I think it is?</i>"'
        );
        ...
        this.flags[kFLAGS.KELLY_CUNT_TYPE] = 0;
    ...
    private punishKelly(): void {
        ...
        this.menu();
        if (
            this.flags[kFLAGS.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT] > 0 &&
            this.player.statusAffectv1(StatusAffects.TelAdre) < 1
        ) {
            this.outputText(
                "You'd like to take Kelly for a ride, but you don't have any good ideas for public places to humiliate her."
            );
    ...
    private getARimjobFromKelly(): void {
        ...
        this.outputText(
            '"<i>You aren\'t worthy of my dick,</i>" you say, as you slowly peel off your [armor]; you do it facing away from Kelly so that she can take in your [butt] as you slowly wriggle free of your underclothing.  "<i>But I still need servicing.  So...</i>"'
        );
        ...
        // [Centaur:]
            ...
            this.outputText(
                '\n\nYou gesture at the ground.  "<i>Lie down,</i>" you command.  Kelly carefully folds her body up to do so, until her horse half is prostrate and only her human half is propped up.  You lead yourself back until your rear end is near to her face; grinning to yourself, you slowly brush your semi-erect ' +
                    this.cockDescript(x) +
                    " against her soft face, teasing her with the idea that you've changed your mind; you cannot see her but from the small bitten off grunts and moans you know she's struggling with the urge to wrap her lips around it.  Finally, you carefully lean downwards, so that instead of your dick she's faced with your [butt]."
            );
        // [Biped/Other:
        else
            this.outputText(
                '\n\nYou gesture at the ground.  "<i>Lie down,</i>" you command.  Carefully Kelly folds her body up to do so, until her horse half is prostrate and only her human half is propped up.  You step forwards and for a few moments slowly brush your semi-erect ' +
                    this.cockDescript(x) +
                    " against her soft face, teasing her with the idea that you've changed your mind; she struggles with the urge to wrap her lips around it, emitting small bitten off grunts and moans to your ministrations.  Finally, with a grin you pull away and turn around, so that her mouth is now facing your [butt]."
            );
        ...
        if (this.player.isNaga())
            this.outputText(
                "With reptilian litheness, you slowly lean backwards and press your hands onto the back of her head, pushing her face further between your cheeks.  "
            );
        else if (!this.player.isTaur())
            this.outputText(
                "You lean backwards and press your hands onto the back of her head, pushing her face further between your cheeks.  "
            );
        this.outputText(
            "You laugh at the sensation of her tongue as it pushes into your anal passage, slathering it with worshipful attention, perhaps hoping the sooner she gets you off the sooner this can end."
        );
        // [Not Centaur:
        if (!this.player.isTaur())
            this.outputText(
                "  You smirk and grip her hair, moving her head in rhythm with your own movements."
            );
        else
            this.outputText(
                "  You gyrate your [butt] this way and that, moving her head in rhythm with your own movements."
            );
        ...
        this.outputText(
            "\n\nHer tongue probes deeper and deeper into you, her plump lips pressing into your [asshole] until she touches something sensitive.  Your " +
                this.cockDescript(x) +
                " immediately reacts, twitching upwards restlessly."
        );
        ...
        if (this.player.cockTotal() > 1) this.outputText("s harden");
        ...
        if (this.player.isNaga())
            this.outputText(
                "  You clench her almost bone crushingly tight in your coils as rut overtakes you."
            );
        ...
        if (this.player.hasVagina()) this.outputText(" and pussy");
        this.outputText(
            "?  I can't say it's something you don't deserve for being such a shameless slut, and I don't doubt you'd enjoy every minute of it.</i>\""
        );
        ...
        if (this.player.hasVagina())
            this.outputText(
                "; she slides as many fingers as she can into your [vagina] and frigs you as best she can"
            );
        this.outputText(
            ".  Grunting, you reach your peak.  Your " +
                this.cockDescript(x) +
                " opens wide and you ejaculate streams of cum, splattering into the dust in front of you, your whole body clenching and seizing around the warm, wet muscle wedged in your [butt]."
        );
        // [Pussy:]
        if (this.player.hasVagina())
            this.outputText(
                "  Your female sex orgasms in tandem, your wet flesh seizing up around Kelly's fingers and spattering her arm and chest with girl juices."
            );
        ...
        if (this.flags[kFLAGS.TIMES_RIM_JOBBED_BY_KELLY] == 1) {
            ...
            if (this.player.cumQ() >= 700)
                this.outputText(
                    "You, as ever, have produced a veritable oozing lake of the stuff.  "
                );
            this.outputText(
                '"<i>That is your lesson.  You need your jizz and I don\'t want the camp to be untidy.  Off you go.</i>"  Kelly pauses for a moment as she stares at the off-white mess, and then slowly gets up, trots over to you, gets down again and begins to lick up your carelessly spent seed from the dirt.  You stand over for a moment until she looks up; you see nothing but total devotion in her eyes as she happily swallows one glob of the most delicious, most satisfying substance in the world to her and then starts on the next.  You rub her behind the ear and then leave her to her meal.'
            );
            // [High cum:
            if (this.player.cumQ() >= 1000)
                this.outputText("  She is, after all, going to be here for a while.");
        }
        // [Repeat:
        else {
            this.outputText(
                '\n\n"<i>Th-thank you for the lesson, [Master],</i>" she says.  She knows the drill by now; she quickly gets to her feet and then trots over to the off-white slimy mess you have created.  What a good girl.  Before she can get started you present your ' +
                    this.cockDescript(x) +
                    "; she murmurs thanks for the gift and licks your oozing head spotless first before getting on with the main meal.  You rub her behind the ear as she licks away at the spent seed at your feet and then leave her to it."
            );
            if (this.player.cumQ() >= 1000)
                this.outputText("  She is, after all, going to be here for a while.");
        }
    ...
    private rideKellyForPunishment(): void {
        ...
        if (this.flags[kFLAGS.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT] == 1) {
            this.outputText(
                "You stroke Kelly's side thoughtfully.  What would be a good punishment for a centaur? Several ideas immediately occur, but all require... equipment.  You tap your chin as a plan of action falls into place."
            );
            ...
            if (this.player.tallness < 78 && !this.player.isTaur()) {
                ...
                if (this.player.isNaga())
                    this.outputText(
                        "  Your reptilian half is hardly ideal for riding a horse but eventually you reach a happy compromise; you perch upon her with your long tail wrapped around her barrel-like lower body."
                    );
                // [Drider:]
                else if (this.player.isDrider())
                    this.outputText(
                        "  Your spider half is hardly ideal for riding a horse but eventually you reach a happy compromise; you perch upon her with your long, chitinous legs wrapped carefully around her barrel-like lower body.  You must look utterly bizarre but feel reasonably comfortable."
                    );
                this.outputText(
                    "  You lean in close to her human half and wrap your arms around her waist, drinking in the sweet scent of her pale skin; you know your own smell and power is pressing upon her senses and she whimpers softly as you slide your hands up her stomach until they are clutching her "
                );
                if (this.flags[kFLAGS.KELLY_BONUS_TIT_ROWS] > 0) this.outputText("top row of ");
                ...
                if (this.flags[kFLAGS.KELLY_LACTATING] > 0)
                    this.outputText(" hard enough to produce thin arcs of milk");
                this.outputText(
                    '.  The centauress gasps, her breath already ragged. "<i>...I\'ve got to hold onto something.  Now, giddy up!</i>" Kelly jolts into action, stumbles slightly at the extra weight, before righting and trotting in the direction of the farm; you keep yourself steady by maintaining a firm grip upon her breasts.'
                );
                // [PC is riding:
                this.outputText(
            ...
            // [PC is 6'6</i>\" or more/centaur:
                ...
                if (this.flags[kFLAGS.KELLY_LACTATING] > 0) {
                    if (this.flags[kFLAGS.KELLY_BONUS_TIT_ROWS] > 0)
                        this.outputText("All four of h");
                    else this.outputText("H");
                    this.outputText(
                        "er swollen teats immediately begin to dribble milk, and she moans.  "
                    );
                }
                this.outputText(
                    "\"<i>So we will have to find some other way you can serve me.  We're going to go across to the farm.  You remember where that is, don't you?  It's where I taught you who you really are.  We're going to learn some more lessons there.  Won't that be fun?</i>\" You let go and set off at a "
                );
                if (!this.player.isTaur()) this.outputText("march");
                else this.outputText("canter");
                this.outputText(
                    " and after a pause she follows; deliberately led towards your destination."
                );
            ...
            // [PC not rider:
                ...
                if (!this.player.isTaur()) {
                    ...
                    this.outputText(
                        "\n\nNeither of you are in any condition to keep this up for long, and after five minutes of fevered fucking, you groan as you clutch Kelly's ass firmly and pour yourself into her, your " +
                            this.cockDescript(x) +
                            " surging line after line of cum into her.  She moans breathily and happily to the heavenly sensation of being filled with your seed, her vagina milking you for every drop it can get.  You don't even know how many times she orgasmed; her pussy dribbled and gushed the entire time you were inside her."
                    );
                }
                // Centaur:
                else {
                    this.outputText(
                        "\n\nEventually you arrive back at camp, and not a moment too soon.  Your nostrils are full of the smell of Kelly, the sight of her hot, moist skin and you are practically champing at the bit yourself; even her rippling horse body speaks directly to your own, urging you irresistibly to mount her.  You bring her to a shuddering halt, rip off your [armor], and then without any further ado rear onto her back and sink your straining " +
                            this.cockDescript(x) +
        ...
        // First repeat:
            ...
            this.outputText(
                "Without another word, you stride over to the stones underneath which you secreted the riding gear.  Kelly watches you with deep apprehension, and then bursts into protests as you return, carrying the heap of clinking leather and metal."
            );
            ...
            if (this.flags[kFLAGS.KELLY_BONUS_TIT_ROWS] > 0)
                this.outputText("  Just as well there were four of them, eh?");
            this.outputText(
                "</i>\" You step back to admire the effect.  Kelly stares back at you behind her leather straps and ball gag, her tasselled boobs forced outwards by her arms bound behind her back.  You laugh and stroke her face; she closes her eyes and bends into it, enjoying the simple motion of her [Master]'s hand."
            );
            ...
            if (this.player.tallness < 78 && !this.player.isTaur()) {
                ...
                this.outputText(
                    "\n\nYou lead her down a side alley - giving a hard look to the onlookers which makes most of them remember they have business elsewhere - and then, braced against her formidable weight, fuck her hard.  She mums and hums and whinnies around her gag, her tassels twirling merrily as you jerk her body furiously, lost in her mass and her wet, clenching tunnel.  It's a secluded area but you can still hear giggles and gasps at the fringes of your conscience; they are meaningless to you but you suspect to Kelly they are as loud as voices in her ear.  Her pussy spasms around your " +
                        this.cockDescript(x) +
                        " and absolutely soaks your [hips] with girl juice; in response you grab her flanks and cum, sighing raggedly as you shoot your load deep into her, orgasm clenching your body.  You withdraw slowly, noting with satisfaction that her pussy is now drooling your ejaculate."
                );
            ...
            // PC not rider:
                ...
                this.outputText(
                    'You grab hold of the reigns and stride off; after a short jerk Kelly follows behind you.  "<i>We\'re heading to the desert,</i>" you announce.  "<i>I think you can maybe guess where.  Remember; flick those legs high, prance a little, make those tassels whirl.  You represent your [Master], and you don\'t want ' +
                        this.player.mf("him", "her") +
                        " to look bad, do you?</i>\"  There's a muffled whimper in response."
                );
                this.outputText(
                ...
                this.outputText(
                    "\n\nYou lead her down a side alley- giving a hard look to the onlookers which makes most of them remember they have business elsewhere - and then, braced against her formidable weight, fuck her hard.  She mums and hums and whinnies around her gag, her tassels twirling merrily as you jerk her body furiously, lost in her mass and her wet, clenching tunnel.  It's a secluded area but you can still hear giggles and gasps at the fringes of your conscience; they are meaningless to you but you suspect to Kelly they are as loud as voices in her ear.  Her pussy spasms around your " +
                        this.cockDescript(x) +
                        " and absolutely soaks your [hips] with girl juice; in response you grab her flanks and cum, sighing raggedly as you shoot your load deep into her, orgasm clenching your body.  You withdraw slowly, noting with satisfaction that her pussy is now drooling with your ejaculate."
                );
                this.outputText(
                    '\n\n"<i>Good girl,</i>" you say at last.  "<i>Have a present.</i>"  You withdraw your box of ribbons and tie one around her demonic tail. "<i>When we leave I want you to hold your tail up high.  So everyone can see the present your [master] gave you.</i>"  You take her ragged moan to mean she understands exactly your intent.'
                );
            ...
            if (!this.player.isTaur())
                this.outputText(
                    "   You sigh and enjoy the sight of her pretty head bobbing over your groin, your " +
                        this.cockDescript(x) +
                        " encapsulated in soft shifting blankets of wet mouth flesh, your ears filled with her slurps and muffled sighs.  You are quickly pushed towards a new high by the worshipful treatment; you give her what she wants and cum in her mouth, letting her savor your texture and flavor; she closes her eyes and swallows, orgasm shuddering through her as it hits her stomach.  You smile and hold her face as she basks in an afterglow earned from pure debasement."
                );
            else
                this.outputText(
                    "  You sigh and enjoy your " +
                        this.cockDescript(x) +
        ...
        // Second+ repeat:
            ...
            if (this.player.tallness < 78 && !this.player.isTaur()) {
                ...
                this.outputText(
                    "\n\nUpon the close streets though everyone stares; even for as liberal a place as Tel'Adre the sight of a " +
                        this.player.race() +
                        " riding a practically naked bound and gagged centauress draws a slight hush and open mouths, even among the ones who have already seen this display.  The centaur you canter past in particular look absolutely gobsmacked; by turns unbelieving, disgusted, or shocked into laughter.  Nobody attempts to stop you though and you affect to be completely unaware of the attention; you after all are a champion upon an important errand.  But you know the attention and pure humiliation are soaking into Kelly when she makes a sobbing, muffled moan."
                );
                ...
                this.outputText(
                    "\n\nYou lead her down a side alley - giving a hard look to the onlookers which makes most of them remember they have business elsewhere- and then, braced against her formidable weight, slowly dip your " +
                        this.cockDescript(x) +
                        " into her cunt until it is completely slathered in girl slime.  She sighs to the agonisingly gentle treatment and then gives out a muffled cry out of shock as you withdraw completely and, using the lubrication she provided, push into her tight asshole."
                );
            ...
            // PC not rider:
                ...
                this.outputText(
                    "\n\nUpon the close streets though everyone stares; even for as liberal a place as Tel'Adre the sight of a " +
                        this.player.race() +
                        " leading a practically naked bound and gagged centauress around like a show horse draws a slight hush and open mouths, even among the ones who have already seen this display.  The centaur you canter past in particular look absolutely gobsmacked; by turns unbelieving, disgusted, or shocked into laughter.  Nobody attempts to stop you though and you affect to be completely unaware of the attention; you after all are a champion upon an important errand.  But you know the attention and pure humiliation are soaking into Kelly when she makes a sobbing, muffled moan."
                );
                ...
                this.outputText(
                    "\n\nYou lead her down a side alley - giving a hard look to the onlookers which makes most of them remember they have business elsewhere - and then, braced against her formidable weight, slowly dip your " +
                        this.cockDescript(x) +
                        " into her cunt until it is completely slathered in girl slime.  She sighs to the agonizing treatment and then gives out a muffled cry out in shock as you withdraw completely and, using the lubrication she provided, push into her tight asshole."
                );
    ...
    private takeKellysVirginity(): void {
        ...
        this.outputText(
            "You tell Kelly that you intend to come claim the prize you broke her for - her virgin "
        );
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 1) this.outputText("horse-");
        ...
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 1)
            this.outputText("lust-swollen, black-lipped fuck-hole");
        else this.outputText("blooming, pink-tinged pussy");
        this.outputText(' to your roving eyes.  She asks, "<i>Is th-th-this good, [Master]?</i>"');
        ...
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 1) this.outputText(", equine");
        this.outputText(
            " cunt until her hymen is easily visible.  You rub every sensitive fold that you can get to"
        );

        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 1)
            this.outputText(
                ", taking time to squeeze her plush, onyx vulva teasingly.  Kelly whinnies in response, overtaken by her potent equine instincts."
            );
        else
            this.outputText(
                ", taking time to fondle her slick labia.  Kelly moans in response, overtaken by the sensations you're forcing through her."
            );
        ...
        if (!this.player.isTaur())
            this.outputText(
                "get down behind her and line your " +
                    this.cockDescript(x) +
                    " with her dribbling lips."
            );
        else
            this.outputText(
                "lie down behind her, sliding your hindlegs behind hers in order to properly align your " +
                    this.cockDescript(x) +
                    " with her dribbling lips."
            );
        this.outputText(
            "  The first contact of " +
                this.player.cockHead(x) +
                " on her feminine mound sends an electric current of pleasure through your member, one that has you immediately and heedlessly pushing forward, sliding your full, sensitive phallus as deeply into that slick opening as you can.  That turns out not to be very far, as you almost immediately hit her virginal hymen.  It blocks off the rest of that hot, dripping hole almost spitefully."
        );

        this.outputText("\n\nYou squeeze Kelly's ");
        if (this.player.isTaur())
            this.outputText("breast as you snuggle up behind her, centaur to centaur,");
        else this.outputText("ass");
        this.outputText(
            ' and laugh, "<i>Here it comes, you eager whore!</i>"  Then, you spear through her entrance with one powerful thrust.  In that second, her pussy somehow gets even hotter and warmer around your girth, and you sink yourself as deeply as you can'
        );
        if (this.player.cockArea(x) <= 300) {
            this.outputText(", nestling your [sheath] up against her ");
            if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 1) this.outputText("plump, equine cunt-lips");
            else this.outputText("slippery, pink cunt-lips");
        } else
            this.outputText(
                ", pressing your " +
                    this.player.cockHead(x) +
                    " up against the barrier her cervix makes"
            );
        this.outputText(
            ".  A pinkish froth oozes out around you, tinted by the few drops of blood that claiming her generated.  Kelly made a pained face as you took her, but now, she's back to panting and moaning like a whore."
        );

        this.outputText(
            '\n\nYou pull on her tail as you begin to slide in and out, asking, "<i>Did you like that, slut?  Does your cunt like being broken in by a real ' +
                this.player.mf("man", "breeder") +
                "'s cock?</i>\""
        );

        this.outputText(
            "\n\nKelly moans, \"<i>Y-yes!  My... pussy...  My pussy feels so good!  It's so good to be yours, [Master]!</i>\"  Her eyes cross slightly as her pussy begins to squeeze down around you, driven by instinctual desires the lust-crazed centauress barely understands.  She's been so conditioned to obey that when her body tells her to do something (like milk your " +
                this.cockDescript(x) +
                "), she doesn't question - she simply, deliciously complies, her pussy growing ever-wetter from her submissiveness."
        );
        ...
        if (this.player.cumQ() >= 500) {
            this.outputText(
                "  You even have enough jism to make sure that some is squirting into her womb and drizzling out of her entrance, mixing with her clear fluids to make a runny, off-wet mess down her rump."
            );
            if (this.player.cumQ() >= 1500)
                this.outputText(
                    "  In no time flat, her belly has begun to round slightly, puffed up with spunk."
                );
            if (this.player.cumQ() >= 3500)
                this.outputText(
                    "  That doesn't stop you from seeding it even further, pumping her poor horse-gut until it jiggles and jostles with your spermy cargo.  There's no way she'll forget this."
                );
        }

        this.outputText("\n\nYou pull out with a self-satisfied sigh, admiring ");
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 0)
            this.outputText("the redness of her well-used cunt.");
        else
            this.outputText(
                "the shining juices that drip from her oh-so-equine entrance, gilding the smooth onyx lips with a slimey sheen."
            );
        this.outputText(
            "  Kelly has passed out in a puddle of her own making, and you leave her like that, getting dressed without a backwards glance."
        );
        this.kellyPreggers();
        this.player.orgasm();
        this.dynStats("sen", -3, "cor", 0.5);
        this.flags[kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT]++;
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private giveKellyAPepper(): void {
        ...
        if (this.flags[kFLAGS.KELLY_TIMES_PEPPERED] == 0) {
            ...
            this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] = 1;
            this.flags[kFLAGS.KELLY_HEAT_TIME] = 48;
        }
        // Repeat:
        else {
            this.outputText(
                "You grin and dangle the pepper in front of Kelly's face wordlessly.  The centauress knows what's coming and color spreads across her cheeks; however, she still opens wide and accepts the \"<i>gift</i>\", chewing slowly and swallowing."
            );
            // If no second row:
            if (this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] == 0) {
                this.outputText(
    ...
    private kellyTitJob(): void {
        ...
        else x = this.player.biggestCockIndex();
        ...
        // Dick >17 inches, Kelly has four breasts:
            ...
            this.outputText(
                '\n\n"<i>So that\'s why you made me grow four of them!</i>" Of course, you say; your slaves have to be suitably shaped to be able to properly service a [Master] as mighty as you.  Now, you say as you hold her by the shoulders and begin to move your ' +
                    this.cockDescript(x) +
                    " up and down her long, twin valley, hush and properly attend to your cumslut duties."
            );
            this.outputText(
                "\n\nYou sigh as Kelly obediently clasps her top breasts and squashes her softness into your length, encapsulating it in her warm, yielding flesh.  You clasp her bottom boobs and do the same; whilst not as big as her first row, there is still more than enough plush fatness there to wrap your girth in warmth.  Pre leaks from your tip to the shifting, pillowy pleasure inundating your hard cock, slicking Kelly's tender skin with your scent; you slowly pull your " +
                    this.cockDescript(x) +
                    " all the way down and then up again, ensuring the full valley is given the lubrication you need to pick up the pace.  The centauress coos as you grip her harder and begin to fuck her pillows, her eyes closed as she is swallowed by your presence and feral smell, each second you spend using her like this making her more and more sensitive and pliant to your touch."
            );
            this.outputText(
            ...
            this.outputText(
                "  Her expression is one of deep concentration and as you quicken the pace and thrust further upwards she bends her chin to lick at your head as it presents itself between her pressed together tits."
            );
            this.outputText(
    ...
    private kellyPreggers(): void {
        ...
        if (Kelly.rand(100) + 1 <= 80) {
            this.pregnancy.knockUpForce(
                ...
                PregnancyStore.INCUBATION_CENTAUR - 84
            );
    ...
    private kellyPregSex(): void {
        ...
        this.outputText(
            "\n\nYou remove your [armor] and watch your " +
                this.multiCockDescriptLight() +
                " grow into a rock-hard erect state under the aphrodisiac scent; you're ready to stuff the breeding mare before you.  Driven mad with lust, you jump the centaur's behind and slap her angrily, making her moan and snort in submissive pleasure.  You can't take it anymore and with feverish excitement, you grab hold of [oneCock] and plunge it deep into Kelly's dark recesses."
        );
    ...
    public kellyPopsOutARunt(): void {
        ...
        if (this.flags[kFLAGS.KELLY_KIDS] == 0) this.flags[kFLAGS.KELLY_FIRST_KID_GENDER] = gender;
        this.flags[kFLAGS.KELLY_KIDS]++;
        if (gender == 1) this.flags[kFLAGS.KELLY_KIDS_MALE]++;
    }
    ...
    private talkNHandToKelly(): void {
        ...
        if (this.flags[kFLAGS.KELLY_TALK_N_HAND_TIMES] == 0) {
            this.outputText(
                '"<i>Talk?  Oh, that\'s the least interesting thing I can do with my mouth, [Master],</i>" Kelly purrs.  That may be, you say, but she can amuse you with her hands whilst she amuses you with her voice.  The centaur gets the picture and grins.  '
            );
            // Not Centaur:
            if (!this.player.isTaur()) {
                this.outputText(
                    "She helps you take off the lower half of your [armor] as you set yourself down and then wraps her warm hand around "
                );
                if (this.player.cockTotal() == 1)
                    this.outputText(
                        "[oneCock], gently tugging it.  It quickly hardens with the pleasing friction she coils around it."
                    );
                else
                    this.outputText(
                        "first your [cock], then your [cock 2], gently tugging until they are both hard from the pleasing friction she coils around them."
                    );
            }
            // Centaur:
            else {
                this.outputText(
                    "You leisurely clop yourself around so your back end is facing her and sigh as "
                );
                if (this.player.cockTotal() == 1)
                    this.outputText(
                        "a warm hands wraps itself around your [cock] and then begins to gently tug, quickly hardening it with pleasing coils of friction."
                    );
                else
                    this.outputText(
                        "a warm hand wraps around first your [cock] and then your [cock 2] before beginning to gently tug, both quickly hardening from the pleasing coils of friction."
                    );
            }
        }
        // Repeat:
            ...
            if (!this.player.isTaur()) {
                this.outputText(
                    "slides off the lower half of your [armor] as you set yourself down and then grasps your cock"
                );
                if (this.player.cockTotal() > 1) this.outputText("s");
                this.outputText(
                    " with her soft hands.  You sigh as she begins to gently pump, making "
                );
                if (this.player.cockTotal() > 1) this.outputText("them");
                else this.outputText("it");
                this.outputText(" harden quickly.");
            } else {
                this.outputText("trots around behind you.  You sigh as ");
                if (this.player.cockTotal() == 1)
                    this.outputText(
                        "a warm hands wraps itself around your [cock] and then begins to gently tug, quickly hardening it with pleasing coils of friction."
                    );
        ...
        if (temp == 0) {
            ...
            if (!this.player.hasVagina()) {
                // Male:
                this.outputText(
                    "  Now I </i>do<i> work for a man, and I spend most days polishing his [cock biggest]!"
                );
            }
            // Futa:
            else
                this.outputText(
                    "  Now I am a woman, I work for another woman, and I spend most days polishing her [cock biggest]!"
                );
            this.outputText(
            ...
            if (this.player.cockTotal() > 1)
                this.outputText(
                    "imagining thrusting every single one of your cocks into a wet, willing hole, "
                );
            // vagina:
            ...
            this.outputText(
                "imagining the symphony of feminine squeals and moans as you cum....  Kelly coos as you bark wordlessly, jizz surging powerfully out of your " +
                    this.multiCockDescriptLight() +
                    ".  She keeps masturbating you, pumping you with gentle, insistent pressure until you are spent.  Once you're done, she bends in and licks you clean, humming happily as she laps at your [cockHead] with her soothing, seeking tongue."
            );
            ...
            if (this.player.cor < 70)
                this.outputText(
                    "  Plus, the thought of making Kelt's victims pay the price for his own crimes makes you feel uncomfortable."
                );
            this.outputText(
                "  You tell Kelly you appreciate the thought as you pick yourself up and leave, but you think you need to save your energy and cum for the really special case that she is.  The centaur shivers with glee."
            );
        ...
        // 2.
            ...
            if (this.player.cockTotal() > 1) this.outputText(" and [cock 2]");
            this.outputText(
                ".  \"<i>Of course I can never repay you for what you've done for me.  I wasn't thinking.</i>\""
            );
        ...
        // 3.
            ...
            if (!this.player.isTaur()) this.outputText("into the air");
            else this.outputText("onto the ground");
            this.outputText(
                ".  Kelly nuzzles your [cocks] when you're done, slurping obscenely as she polishes your nobhead"
            );
            if (this.player.cockTotal() > 1) this.outputText("s");
            this.outputText(" to a shine.  You thank her with a slap on the ass and leave.");
        }
        // 4.
        else if (temp == 3) {
            this.outputText(
            ...
            if (this.player.balls == 0)
                this.outputText("suckles and laps at the very base of your [cock] for a time");
            else this.outputText("suckles and laps at your [balls] for a time");
            this.outputText(
                ".  It's a beautiful tactic - the sound and sensation is wonderful but it also cools your cock down just a bit."
            );
            ...
            if (this.flags[kFLAGS.KELLY_KIDS] > 0)
                this.outputText(" and bearing and raising your children");
            this.outputText(
                ", I'm a hundred times happier.  I just used a demon's curse to get my way - you did it all on your own.  You showed me what true strength and dominance is, [Master]!</i>\""
            );
        ...
        // 5.
            ...
            if (!this.farm.farmCorruption.whitneyCorrupt()) {
                this.outputText(
                ...
                this.outputText(
                    ". The smooth woggle of flesh around your [cock] coils you expertly through your exultant orgasm, wringing out every last drop before plump, wet lips come to rest on your [cockHead biggest], kissing and licking it quite clean. Kelly looks extremely pleased with herself, glancing up at you once she’s done."
                );
    ...
    private rewardKelly(): void {
        ...
        if (this.flags[kFLAGS.KELLY_TIMES_REWARDED] == 0) {
            this.outputText(
                "There seems to be an added bounce to Kelly's canter today.  She prances a bit playfully in front of you, grinning, whipping her demonic tail so that the high, sweet smell of her gushing pussy is in the air.  You realize she is calling your attention to her backside, which is unmarked."
            );
            this.outputText(
        ...
        // Repeat:
            ...
            this.outputText(
                "Kelly holds her head up proudly as you inspect her, running your hand slowly over her backside.   It's nice and smooth.  You smile at her benevolently and tell her that since she's been such a good cumslut, you're going to reward her.  She claps excitedly."
            );
            this.outputText('  "<i>Hurray!</i>"');
        }
        this.flags[kFLAGS.KELLY_TIMES_REWARDED]++;
        ...
        // [chestnut brown/sable black/garish purple/bright pink/slutty blonde)
        if (this.player.cockThatFits(300) >= 0 && this.player.hasCock())
            this.addButton(0, "Applesauce", this.giveKellyAppleSauce);
        if (
            this.player.hasItem(this.consumables.BLACK_D) &&
            this.flags[kFLAGS.KELLY_HAIR_COLOR] != "sable black"
        )
            this.addButton(1, "Black Dye", this.dyeKellysBitchAssHair, this.consumables.BLACK_D);
        if (
            this.player.hasItem(this.consumables.BLOND_D) &&
            this.flags[kFLAGS.KELLY_HAIR_COLOR] != "slutty blonde"
        )
            this.addButton(2, "Blond Dye", this.dyeKellysBitchAssHair, this.consumables.BLOND_D);
        if (
            this.player.hasItem(this.consumables.PURPDYE) &&
            this.flags[kFLAGS.KELLY_HAIR_COLOR] != "garish purple"
        )
            this.addButton(3, "Purple Dye", this.dyeKellysBitchAssHair, this.consumables.PURPDYE);
        if (
            this.player.hasItem(this.consumables.PINKDYE) &&
            this.flags[kFLAGS.KELLY_HAIR_COLOR] != "bright pink"
        )
            this.addButton(4, "Pink Dye", this.dyeKellysBitchAssHair, this.consumables.PINKDYE);
        if (
            this.player.hasItem(this.consumables.BROWN_D) &&
            this.flags[kFLAGS.KELLY_HAIR_COLOR] != "chestnut brown"
        )
            this.addButton(5, "Brown Dye", this.dyeKellysBitchAssHair, this.consumables.BROWN_D);
    ...
    private dyeKellysBitchAssHair(color: ItemType): void {
        this.clearOutput();
        this.outputText(
            "You tell her you've brought her a gift as you rummage around in your pockets.  Kelly looks apprehensive but pleasant surprise forms on her face when she catches the small vial of dye you throw at her."
        );
        this.outputText("\n\n\"<i>Oh wow, thanks [Master]! It's been ages since I did my hair.");
        if (this.flags[kFLAGS.KELLY_TIMES_DIED_HAIR] == 0) {
            this.outputText(
                "</i>\"\n\nShe stops and thinks.  \"<i>In fact, I don't think I've ever done my hair.  "
            );
        }
        this.outputText(
            "This'll be so much fun!</i>\"  You walk over to the barn with her and pour some water into a wide bucket.  She lets down her braid and you spend a pleasant quarter of an hour or so helping her work the sharp-smelling substance into her long, luscious hair.  When you're done, you step back to admire the effect.  Amazingly the color is not only sinking into her hair but also into her tail, her demon spade slowly bleaching with the hue you chose."
        );
        this.flags[kFLAGS.KELLY_TIMES_DIED_HAIR]++;
        // Black dye:
        if (color == this.consumables.BLACK_D) {
            this.outputText(
        ...
        // Pink dye:
        else if (color == this.consumables.PINKDYE) {
            this.outputText(
        ...
        // Brown dye: Kelly smiles as she examines the regained chestnut brown color of her hair and tail.
        else if (color == this.consumables.BROWN_D) {
            this.outputText(
            ...
            this.flags[kFLAGS.KELLY_HAIR_COLOR] = "chestnut brown";
            this.player.consumeItem(this.consumables.BROWN_D);
        } else
            this.outputText(
                "\n\nYO dog, " +
                    color +
                    " is definitely not working right. Please report this to fenoxo using the report a bug link on the site."
            );
        this.menu();
        this.addButton(0, "Next", this.approachKelly);
    }
    ...
    private giveKellyAppleSauce(): void {
        this.clearOutput();
        // First time:
        if (this.flags[kFLAGS.KELLY_TIMES_APPLESAUCED] == 0) {
            this.outputText(
                "You tap your chin idly and ask Kelly what she likes eating.  Aside from dick, you add, rolling your eyes as she opens her mouth eagerly."
            );
            this.outputText(
            ...
            if (!this.farm.farmCorruption.whitneyCorrupt())
                this.outputText(
                    " \"<i>I'd like to go and check on it, but... I don't think Whitney likes me much anymore.  I'd hate to cause more trouble than I already have.</i>\""
                );
            else
                this.outputText(
                    "“<i>I'd like to go and check on it, but... I’d hate to get into Mistress Whitney’s bad books.  I’ve caused enough trouble already.</i>”"
                );
            this.outputText(
                " You 'pfft' and wave your hand airily to show what YOU think of Whitney.  You tell her to stay put - as her treat, you'll go check on the orchard and bring back some apples for her, if there are any."
            );
            this.outputText(
            ...
            if (!this.player.isTaur()) {
                this.outputText(
                    "You remove the bottom half of your [armor] and grip your [cock].  You close your eyes, begin to stroke yourself and sigh as you think of Kelly- her fine, bountiful curves, her cute, dimpling face, how she unconsciously licks her cock-sucking lips when she sees you coming, how she begs for it, how sweetly she moans when you thrust deep into her tight, wet holes... your body clenches as you orgasm, spurting streamer after streamer of spunk into the apple mash."
                );
                if (this.player.hasVagina())
                    this.outputText(
            ...
            // [Centaur:]
                ...
                if (this.player.cumQ() >= 750)
                    this.outputText(
                        "  Your [cock] torrents out cum, and eventually you have to clop away, grunting out the last jets of filth onto the ground to avoid overflowing the bowl."
                    );
            }
        ...
        // Repeat:
            ...
            if (this.flags[kFLAGS.KELLY_KIDS] > 1)
                this.outputText(
                    "  Somebody has even cleared an oblong patch of earth alongside the trees- a piece of card stuck into it is scrawled with a childish hand which declares it to be “CAROTS”.  You marvel at it all.  Who would have imagined your lust for horse pussy would have turned a pointless asshole into a loving mother who gardens with her children?  Really, you deserve a medal for your efforts."
                );
            ...
            if (!this.player.isTaur()) {
                this.outputText(
                    "grasp your semi-turgid cock and drift into a fond reverie of Kelly- the way her boobs bounce when she canters towards you, the way her green eyes burn when they fall upon your [eachCock], the way she gasps when you slap her ass, how sweetly she moans when you thrust deep into her tight, wet holes, the galaxy of filthy things you still have left to do to her....  Your body clenches as you orgasm, spurting streamer after streamer of spunk into the apple mash."
                );
                if (this.player.hasVagina())
                    this.outputText(
                        "  Your [vagina] quivers and clenches, and once again, gasping with the dual orgasm which is clutching your body, you stand over the bowl and let some of your femcum drip into it."
                    );
                // [High cum:
                if (this.player.cumQ() >= 750)
                    this.outputText(
            ...
            if (this.silly()) this.outputText("  Parsley, sage, rosemary and c...");
            this.outputText(
                '  Ooh!</i>"  You slap her ass and grab her around her supple, human waist as you pass her.  Laughing, you walk into the barn together.'
            );
        }
        // [merge]
        ...
        if (!this.player.isTaur()) {
            ...
            this.outputText(
                '\n\n"<i>No.  Put them here.</i>"  You set each one on either side of the bowl so she is clasping it.  "<i>Don\'t lift it until you have to.  That\'s it...</i>"  You watch, pulling off piece after piece of your [armor], as she dips her head into the bowl, scoops up a long lap of the green mash with her tongue and guides it into her wet mouth.  Her throat works and she closes her eyes.  Behind her, the intermittent dripping of her femcum on the straw turns into a steady trickle and you shake off the last of your underclothes in a hurry, stride over to her hindquarters and push your ' +
                    this.cockDescript(x) +
                    " against her sopping pussy gently, gripping her " +
                    this.flags[kFLAGS.KELLY_HAIR_COLOR] +
                    " tail to her side so she doesn't inadvertently flick you with it."
            );
            this.outputText(
                "\n\nShe is radiating heat and her wet depths suck at your " +
                    this.player.cockHead(x) +
                    " deliciously.  Still, you hold back on your pulsing need to bury your cock into her, pressing at her entrance softly until you see her head go down again, and the sloppy sound of a centaur trying to draw as much apple sauce into her mouth as she can reaches your ears.  With a contented sigh, you slide your " +
                    this.cockDescript(x) +
                    " into her, exulting in the hot slickness which envelops your sex bit by bit."
            );
            if (this.player.cocks[x].cockThickness >= 4)
                this.outputText(
                    "  Your girth spreads her fuck tunnel wide and you grunt at the delicious tightness of it as you pack her full of cock."
                );
            ...
            this.outputText(
                ".  Did she cum already?  It's fortunate you've already taken the edge off, because you're not sure how long you would otherwise be able to last against her impossibly turned on, sucking, clinching pussy.  As it is... you grip her huge, muscled backside and pull yourself almost all the way out of her fleshy pocket then spear your way in again, steadily in and then out, working your way into a slow, sensual rhythm.  Ahead of you Kelly's head sinks and bobs, and your ears are full of her wet, muffled chews, gulps and moans as she gorges herself on your sweet, sticky sex whilst you gently fuck her."
            );

            // 1 < cock:
            if (y >= 0) {
                this.outputText(
                    "\n\nYour eyes fasten upon her tight, puckered asshole as lust grips you closer, a tiny puddle of human pink buried in her heaving brown horse flesh.  Your breath coming heavily now you withdraw your " +
                        this.cockDescript(x) +
                        " from her wet softness, dripping with her lubrication.  Quickly you push it against her puckered anus whilst lining up your " +
                        this.cockDescript(y) +
                        " with her gaping vagina."
                );
                this.outputText(
                    "\n\nYou wait for Kelly's head to descend towards the bowl again and then thrust forward, penetrating both her holes at the same time.  She cries out from the intense sensation and then bucks back into you, helping you sink your " +
                        this.cockDescript(x) +
                        " deeper and deeper into her ass, spreading her deliciously tight anal passage whilst your " +
                        this.cockDescript(y) +
                        " slides effortlessly into the fleshy folds of her cunt.  You slap her ass exultantly, making her squeak again, as you find your limit before resuming the same rhythm, fucking both her sopping vagina and tight, hot ass now with deep, slow strokes."
                );
            }
            this.outputText(
            ...
            this.outputText(
                "\n\nWith her head thrown back it's easy for you to grip her " +
                    this.flags[kFLAGS.KELLY_HAIR_COLOR] +
                    " braid and use it for leverage as you fuck into her with everything you've got, bucking into her tight, hot flesh "
            );
            if (this.player.balls > 0)
                this.outputText(", your [balls] slapping into her thighs demandingly ");
            this.outputText(
                "as you push towards your reward.  Panting, Kelly thrusts back into you as best she can, resisting your frenetic tugs to her hair so that the big, final slather of apple sauce can slide out of the bowl and into her mouth.  She screams around the wet, gooey mouthful and her vagina quivers and seizes your bulging " +
                    this.cockDescript(x) +
                    " in milking ripples"
            );
            if (y >= 0)
                this.outputText(" as her anus clenches around your " + this.cockDescript(x));
            this.outputText(
                ".  With a wordless shout, you tense up and orgasm in tandem, surging line after line of glorious into her wet, churning depths, lost in the ageless sensation of filling a breeding slut's holes with thick seed for what seems like oceans of blissful time."
            );
        }
        // Centaur:
        else {
            ...
            this.outputText(
                "\n\nYou tut mockingly and pull it away until she lowers her hands, then bring it in close to her face.  Her hands fall on her erect nipples as she dips her head into the bowl, scoops up a long lap of the green mash with her tongue and guides it into her wet mouth.  Her throat works and she closes her eyes.  The intermittent dripping of her femcum on the straw behind you turns into a steady trickle and your own arousal urgent now, you push your " +
                    this.cockDescript(x) +
                    " against her sopping pussy gently.  She is radiating heat and her wet depths suck at your " +
                    this.player.cockHead(x) +
                    " deliciously."
            );
            this.outputText(
            ...
            this.outputText(
                '\n\n"<i>Oh [Master]...</i>" Kelly groans, arching her head back from her feed so it spoons into your neck.  A series of clenches grip your ' +
                    this.cockDescript(x) +
                    " and a sudden gush of fluid warms your "
            );
            if (this.player.balls > 0) this.outputText("[balls]");
            else this.outputText("thighs");
            this.outputText(
            ...
            if (y >= 0) {
                this.outputText(
                    "\n\nYou think about her tight, puckered asshole beneath you as lust grips you closer, a tiny puddle of human pink buried in her heaving brown horse flesh.  Your breath coming heavily now you withdraw your " +
                        this.cockDescript(x) +
                        " from her wet softness, dripping with her lubrication.  Quickly you push it against her puckered anus whilst lining up your " +
                        this.cockDescript(y) +
                        " with her gaping vagina.  You wait for Kelly's head to descend towards the bowl again and then thrust forward, penetrating both her holes at the same time.  She cries out from the intense sensation and then bucks back into you, helping you sink your " +
                        this.cockDescript(x) +
                        " deeper and deeper into her ass, spreading her deliciously tight anal passage whilst your " +
                        this.cockDescript(y) +
                        " slides effortlessly into the fleshy folds of her cunt.  You grab one of her soft tits and squeeze exultantly, making her squeak again, as you find your limit before resuming the same rhythm, fucking both her sopping vagina and tight, hot ass now with deep, slow strokes."
                );
            }
            ...
            this.outputText(
                "\n\nYou grip her " +
                    this.flags[kFLAGS.KELLY_HAIR_COLOR] +
                    " braid and force her head to arch back before pushing the bowl against her lips, tipping the last of the green sweet down her gullet whilst you begin to fuck into her with everything you've got, bucking into her tight, hot flesh"
            );
            if (this.player.balls > 0)
                this.outputText(", your [balls] slapping into her thighs demandingly");
            this.outputText(" as you push towards your reward.");
            this.outputText(
                "\n\nPanting, Kelly thrusts back into you as best she can, resisting your frenetic tugs to her hair so that the big, final slather of apple sauce can slide out of the bowl and into her mouth.  She screams around the wet, gooey mouthful and her vagina quivers and seizes your bulging " +
                    this.cockDescript(x) +
                    " in milking ripples"
            );
            if (y >= 0)
                this.outputText(" as her anus clenches around your " + this.cockDescript(y));
            this.outputText(
                ".  With a wordless shout, you tense up and orgasm in tandem, surging line after line of glorious into her wet, churning depths, lost to the ageless sensation of filling a breeding mare's holes with thick seed for what seems like blissful oceans of time."
            );
        }
        // [merge]

        this.outputText("\n\nYou pool onto the floor when you are finished, ");
        if (this.player.isBiped()) this.outputText("giving at the knees, ");
        this.outputText(
            "your aching cock still weakly clenching.  In a beatific daze you listen to the sound of a tongue eagerly exploring every inch of a metal surface, before a bowl hits the ground.  A hand is offered to you and woozily you take it.  As soon as you are up Kelly pulls you into a fervent, passionate kiss, her soft lips pushing into yours.  The smell of apples envelops you.  You tense for a moment but decide to allow it.  It's her treat, after all."
        );
        this.outputText(
        ...
        if (this.player.cor < 60)
            this.outputText(
                "The taste of cum glazing her apple breath is off-putting but what did you really expect?"
            );
        else
            this.outputText(
                "You don't like to admit it but you do taste pretty good, even to yourself.  You push your tongue further into Kelly's mouth hungrily, working your jaw as you savage her mouth with your lips and tongue in search of that fruity, horny flavour, making her 'mmm' with delight and respond in kind."
            );
    ...
    private kellyBJsAhoy(): void {
        ...
        if (!this.player.isTaur()) {
            ...
            if (this.player.hasVagina())
                this.outputText(
                    "  You're in no hurry, and with a slight roll of your [hips] you direct her to start at the back and work her way up."
                );
            ...
            if (this.player.balls > 0 && this.player.hasVagina()) {
                ...
                if (this.player.ballSize <= 8) {
                    ...
                    if (this.player.balls > 2) this.outputText(", then the third, then the fourth");
                    this.outputText(
                    ...
                    if (this.pregnancy.isPregnant) this.outputText("milk-laden ");
                    this.outputText(
                        "breasts whilst slavishly polishing the [balls] of the " +
                            this.player.mf("man", "woman") +
                            " who made her into, well, a ball-licking bitch.  Whatever the cause the result is the same: pleasure thrums through your groin and up your [cock biggest], and you close your eyes, lost to the sensations of her skillful tongue."
                    );
                }
                // [Huge balls:
                else {
                    ...
                    if (this.player.balls > 2) this.outputText(", then the third, then the fourth");
                    this.outputText(
                        ", then back to the first one, a slow and sensual repetition.  The warm air is punctuated with desperate 'ahh, ahn, ahh's as she surrenders herself to the deep, shameful lust of the act, supporting her soft"
                    );
                    if (this.pregnancy.isPregnant) this.outputText(", milk laden");
                    this.outputText(
                        " breasts whilst slavishly polishing the [balls] of the " +
                            this.player.mf("man", "woman") +
                            " who made her into, well, a ball-licking bitch."
                    );
                    // [Dominika dreams:
                    if (
                        ...
                        this.outputText(
                            "  You are gripped by a sudden but thrilling velvet-edged sense of déjà vu.  Has this scene not repeated somewhere else?"
                        );
                }
            }
            // Vagina:
            ...
            // Balls:
                ...
                if (this.player.ballSize <= 8) {
                    ...
                    if (this.player.balls >= 4)
                        this.outputText(", then the third, then the fourth");
                    this.outputText(
                    ...
                    this.outputText(
                        "breasts whilst slavishly polishing the [balls] of the " +
                            this.player.mf("man", "woman") +
                            " who made her into, well, a ball-licking bitch, fills her with deep, shameful lust.  Whatever the cause, the result is the same: pleasure thrums through your groin and up your [cock biggest], and you close your eyes, lost to the sensations of her skillful tongue."
                    );
                }
                // Huge balls:
                else {
            ...
            if (this.player.biggestCockLength() > 15)
                this.outputText(
                    "It's a long way up and the effect is like a lift slowly rising, turning on a glow of lights on each level as it goes.  "
                );
            this.outputText(
            ...
            this.outputText("  Finally you are spent.");
        }
        // Centaur:
        else {
            this.outputText(
            ...
            this.outputText(
                "  Finally, after about a minute of this tender torture, you hear her groan from deep within her throat."
            );

            this.outputText(
                '"<i>Please [Master], let me swallow you, let me taste your strength, let me feel like a slut should,</i>" she begs. "<i>I\'ll make it so good for you you\'ll never want anyone else, just like I will never want anyone else.  Just... let me drink your cum!</i>"'
            );
            ...
            if (this.player.cockTotal() > 1 || this.player.hasVagina())
                this.outputText(
                    "  You're in no hurry, and with a slight roll of your [hips] you direct her to start at the front and work her way down."
                );
            ...
            if (this.player.hasVagina() && this.player.balls > 0) {
                ...
                if (this.player.ballSize <= 8) {
                    ...
                    if (this.pregnancy.isPregnant) this.outputText(", milk-laden");
                    this.outputText(
                        " breasts whilst slavishly polishing the [balls] of the centaur who made her into, well, a ball-licking bitch.  Whatever the cause the result is the same.  Pleasure thrums through your groin and up your [cock biggest] and you close your eyes, lost to the sensations of her skillful tongue."
                    );
                }
                // [Huge balls:
                else {
                    ...
                    if (this.pregnancy.isPregnant) this.outputText(", milk laden");
                    this.outputText(
                        " breasts whilst slavishly polishing the [balls] of the centaur who made her into, well, a ball-licking bitch."
                    );
                    if (
                        this.flags[kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] > 0 &&
                        this.flags[kFLAGS.UNKNOWN_FLAG_NUMBER_00150] > 0
            ...
            if (this.player.biggestCockLength() > 15) {
                this.outputText(
                    "  It's a long way down and the effect is like a lift slowly descending, turning on a glow of lights on each level as it goes."
                );
            }
            this.outputText(
                "  Finally she reaches your [cockHead biggest], and after resting her lips on your crown for a short time, moving them ever-so-gently to tantalize the most sensitive part of your bulging erection, she opens wide and envelops you, gripping the end of your dick in a soft, wet cave of shifting pleasure.  She slowly impales herself on it, her plump lips encapsulating more and more of your dick in sucking mouth flesh... and then it recedes, eventually even retreating from the crown as she goes back to licking and kissing the length."
            ...
            // [Cock <12:
                ...
                this.outputText(
                    "  Her mouth is a good fit for your dick and you soon find your limit, touching the back of her throat with each gentle thrust.  You manage to hold back on your urge to simply face fuck her as hard as you can, instead moving your haunches back and forth as sensually as you can, drawing your dick back to the entrance of her mouth so she can worship your [cockHead biggest] with her tongue and lips, eliciting a moaned “mmm” from her each time before thrusting deep into her maw again."
                );
            }
            this.outputText(
            ...
            if (this.player.balls > 0) this.outputText(", as you feel your [balls] clench");
            this.outputText(
                ", you pull out and point your [cock biggest] downwards.  She 'aww's in deep disappointment as the dick is torn away from her, but you shush her."
            );
            ...
            if (this.player.hasVagina()) this.outputText("pussy-licking, ");
            if (this.player.balls > 0) this.outputText("ball-sucking ");
            this.outputText(
                'cock addict, you will have to do a good job of catching it on those whore pillows of yours.</i>"  With that, you thrust your hindquarters forward.  Her breathy groan is what you hear as orgasm clenches you.'
            );
            this.outputText("\n\nYour cock slit dilates and you spurt out rope after rope of jizz");
            if (this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0)
                this.outputText(" onto all four of her tits");
            this.outputText(
                ".  The sensation of deep release is ecstatic, the sound of your cock cream spattering onto your slave's softness delicious."
            );
            // [Vagina:
            if (this.player.hasVagina())
                this.outputText(
            ...
            if (this.player.cumQ() < 750)
                this.outputText(
                    "  Kelly has done a sterling job of catching your load; you've frosted her boobs with long strokes quite convincingly."
                );
            else {
                this.outputText(
                    "  As ever, your virility has gotten the better of you.  Kelly looks like she's in an ecstatic trance.  You've completely pasted not just "
                );
                if (this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0) this.outputText("all four of ");
                this.outputText(
                    "her boobs with alabaster ooze, but her stomach, face and hair.  She's holding a reservoir of the stuff in her cleavage."
                );
            }
        }
        // [merge]
        ...
        if (!this.player.isTaur())
            this.outputText(", still clutching your pleasantly aching prick");
        this.outputText(
            ", saying you know she is, but it's a lot more pleasing to you to see her get her fix this way.  Quickly cottoning on, the centaur stares at you with her lustful green eyes as she lifts a cum-spattered boob to her mouth."
        );
        ...
        this.outputText(
            "  She leaves a trail of cum leaking down a nipple until at last, closing her eyes, she tenses and orgasms with a muffled sigh as her wet tongue pushes over her erect nub and guides the last of your fix into her mouth."
        );
