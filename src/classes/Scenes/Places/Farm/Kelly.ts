...
export class Kelly extends AbstractFarmContent implements TimeAwareInterface {
    ...
    private breakKeltGo(): void {
        ...
        this.outx("\n\nWHAM!  ");
        if (this.player.tallness < 70) this.outx("You jump up, and y");
        else this.outx("Y");
        this.outx(
        ...
        if (!this.player.isTaur())
            ...
            this.outx("slapping your hardening dick");
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(" against your belly in anticipation");
        }
        this.outx(".  You might as well add some flavor to the meal.");
        ...
        this.outx(" to use later.  You lift the keg and walk up to Kelt.");
        ...
        this.outx("down ");
        if (this.player.isTaur()) this.outx("under you ");
        this.outx(
        ...
        if (this.player.isTaur()) this.outx("dance your hindlegs about in order to ");
        this.outx("cockslap her.");
        ...
        else this.outx("grab her nipples and begin to thrust your pecker against her boob valley.");
        this.outx(
    ...
    public defeatKellyNDBREAKHIM(): void {
        ...
        else this.outx("Kelt groans, slumping slightly from all the damage you've done to him");
        this.outx(
        ...
        if (this.player.balls > 0) this.outx(" and fondling your [balls] with great care");
        this.outx(
        ...
        if (!this.player.isTaur()) this.outx("cock-");
        this.outx(
        ...
        if (this.player.isTaur()) this.outx("your genitals and equine body back ");
        this.outx(
        ...
        this.outx("\n\nA ");
        if (this.player.isTaur()) this.outx("quick step and ");
        this.outx("heavy thrust");
        if (this.player.isTaur()) this.outx(" later");
        this.outx(
    ...
    public breakingKeltNumeroThree(): void {
        this.clearOutput();
        if (this.monster.HP < 1) this.outx("Slumping down, ");
        else this.outx("Moaning, ");
        this.outx(
        ...
        if (!this.player.isTaur()) this.outx(", sometimes with your [cock] -");
        this.outx(' and yell: "<i>What\'s your name?</i>"');
        ...
        if (this.player.isTaur()) this.outx("push from behind");
        else this.outx("pull");
        this.outx(
        ...
        this.outx("\n\nYou briskly reach ");
        if (this.player.isTaur()) this.outx("down, pushing her");
        else this.outx("forward to grab one of her tits and grope it");
        this.outx(" convulsively as you feel your lust rise.  ");
        if (!this.player.isTaur())
            this.outx(
        ...
        this.outx("as you feel your climax coming.  ");
        if (!this.player.isTaur())
            this.outx("You squeeze Kelly's boobs so harshly she screams in pain, and y");
        else this.outx("Y");
        this.outx(
        ...
        if (!this.player.isTaur()) this.outx("' breasts");
        this.outx(
    ...
    private finalKeltBreaking(): void {
        ...
        if (this.player.isTaur()) this.outx("kneels down");
        else this.outx("bends over");
        this.outx(
        ...
        if (this.player.isTaur()) this.outx("hindleg haunches");
        else this.outx("[butt]");
        this.outx(
        ...
        if (this.player.isTaur()) this.outx("back away");
        else this.outx("push the centaur girl away");
        this.outx(
        ...
        if (this.silly()) this.outx("  CUM CANNON!");
        this.outx(
    ...
    private kellyAppearance(): void {
        ...
        this.outx("\n\nKelly has a ");
        // [virgin]
        if (this.flags[kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT] == 0) this.outx("virgin, ");
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 0) this.outx("pink pussy");
        else this.outx("puffy, black mare-cunt");
        this.outx(
        ...
        if (this.farm.farmCorruption.hasTattoo("kelly")) {
            ...
            if (this.farm.farmCorruption.kellyFullTribalTats()) {
                ...
                if (this.flags[kFLAGS.KELLY_TATTOO_COLLARBONE] != "")
                    this.outx(this.flags[kFLAGS.KELLY_TATTOO_COLLARBONE] + "\n");
                if (this.flags[kFLAGS.KELLY_TATTOO_SHOULDERS] != "")
                    this.outx(this.flags[kFLAGS.KELLY_TATTOO_SHOULDERS] + "\n");
                if (this.flags[kFLAGS.KELLY_TATTOO_LOWERBACK] != "")
                    this.outx(this.flags[kFLAGS.KELLY_TATTOO_LOWERBACK] + "\n");
                if (this.flags[kFLAGS.KELLY_TATTOO_BUTT] != "")
                    this.outx(this.flags[kFLAGS.KELLY_TATTOO_BUTT] + "\n");
                this.outx("\n");
            }
        }
        ...
        if (this.flags[kFLAGS.KELLY_KIDS] > 0) {
            if (this.flags[kFLAGS.KELLY_KIDS] == 1) {
                this.outx("\nKelly's ");
                if (this.flags[kFLAGS.KELLY_FIRST_KID_GENDER] == 1) this.outx("son");
                else this.outx("daughter");
                this.outx(" is off in a separate field; still very young, you can see ");
                if (this.flags[kFLAGS.KELLY_FIRST_KID_GENDER] == 1)
                    this.outx("him playing in the distance, lost in his own little world.");
                else this.outx("her playing in the distance, lost in her own little world.");
    ...
    private approachKelly(): void {
        ...
        if (this.flags[kFLAGS.FARM_CORRUPTION_STARTED] == 0)
            this.outx("You aren't welcome on the farm proper, but you can go visit Kelly's field.");
        ...
        if (
            ...
            if (this.flags[kFLAGS.KELLY_KIDS] > 2) this.outx("two youngest ");
            this.outx("children with ");
            if (this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0) this.outx("the top row of ");
            this.outx(
        ...
        if (this.player.hasItem(this.consumables.CANINEP)) {
            ...
            if (this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] == 0)
                this.outx(", but who knows how it will change her");
            this.outx(".");
    ...
    private fuckKellysCunt(): void {
        ...
        if (this.player.tallness < 72) {
            this.outx("You turn around to get a stool, since your ");
            if (this.player.tallness < 52) this.outx("diminutive ");
            this.outx("height makes reaching her pussy a difficult task.  ");
        }
        this.outx(
            "Holding your " +
                this.cockDescript(x) +
        ...
        if (this.player.cockTotal() > 1) {
            ...
            if (this.player.cockTotal() > 2) this.outx("s hang");
            else this.outx(" hangs");
            this.outx(" down below, collecting her drippings and smearing across her belly.");
        }
        this.outx(
        ...
        if (this.player.cockArea(x) >= 300) this.outx("bottom out inside her");
        else this.outx("slide as far into her as she can handle");
        this.outx(
        ...
        if (this.player.balls > 0) this.outx(" and roiling balls");
        this.outx(
            " leaves no doubt that climax is fast approaching.  Kelly cums first, splattering your [hips] with her "
        );
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] > 0) this.outx("fragrant ");
        this.outx(
        ...
        if (this.player.cumQ() >= 1200) {
            ...
            if (this.player.cumQ() >= 4000)
                this.outx(", until she's so pregnant with spooge that she can barely stand");
            this.outx(".  ");
        }
        this.outx(
        ...
        if (!this.pregnancy.isPregnant)
            this.outx(" so the cum can turn you into a proper broodmare");
        else
            this.outx(
    ...
    private taurOnTaurSexKelly(): void {
        ...
        if (this.player.cockTotal() > 1) this.outx("s");
        this.outx(".  You gesture for her to rise and turn around, which she does");
        if (this.player.tallness < 60)
            this.outx(
                " before sitting back down (she's too tall to take standing up) and lifting her tail"
            );
        else this.outx(" before lifting her tail");
        this.outx(
        ...
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 0) this.outx("pink pussy");
        else this.outx("black horse-cunt");
        this.outx(
        ...
        if (this.player.balls > 0) this.outx("[sack]");
        else this.outx("hindlegs");
        this.outx(", splattering out in fresh waves from Kelly's ");
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] > 0) this.outx("musky ");
        this.outx(
        ...
        if (this.player.cumQ() >= 1000) {
            this.outx("  Her belly grows round with the liquid weight of your spunk");
            if (this.player.cumQ() >= 4000)
                this.outx(
        ...
        else this.outx("  You snicker and walk away - she's already served her purpose.");
        this.kellyPreggers();
        this.player.orgasm();
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private tentaFuckKelly(): void {
        ...
        if (three >= 0) {
            this.outx("  The remainding tentacle");
            if (four >= 0) this.outx("s erupt");
        ...
        if (this.player.cor < 33)
            this.outx("but also a bit disgusted to watch such shameless, wanton behavior, ");
        this.outx("you walk away, letting the slut enjoy herself.");
        this.kellyPreggers();
        this.player.orgasm();
        this.dynStats("sen", -3);
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private getARimjobFromKelly(): void {
        ...
        if (this.player.hasVagina()) this.outx(" and pussy");
        this.outx(
        ...
        if (this.flags[kFLAGS.TIMES_RIM_JOBBED_BY_KELLY] == 1) {
            ...
            if (this.player.cumQ() >= 700)
                this.outx("You, as ever, have produced a veritable oozing lake of the stuff.  ");
            this.outx(
            ...
            // [High cum:
            if (this.player.cumQ() >= 1000)
                this.outx("  She is, after all, going to be here for a while.");
        }
        // [Repeat:
        else {
            this.outx(
    ...
    private rideKellyForPunishment(): void {
        ...
        if (this.flags[kFLAGS.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT] == 1) {
            ...
            if (this.player.tallness < 78 && !this.player.isTaur()) {
                ...
                if (this.flags[kFLAGS.KELLY_BONUS_TIT_ROWS] > 0) this.outx("top row of ");
                this.outx("breasts.");
                ...
                if (this.flags[kFLAGS.KELLY_LACTATING] > 0)
                    this.outx(" hard enough to produce thin arcs of milk");
                this.outx(
            ...
            // [PC is 6'6</i>\" or more/centaur:
                ...
                if (this.flags[kFLAGS.KELLY_LACTATING] > 0) {
                    if (this.flags[kFLAGS.KELLY_BONUS_TIT_ROWS] > 0) this.outx("All four of h");
                    else this.outx("H");
                    this.outx(
                ...
                if (!this.player.isTaur()) this.outx("march");
                else this.outx("canter");
                this.outx(
        ...
        // First repeat:
            ...
            if (this.flags[kFLAGS.KELLY_BONUS_TIT_ROWS] > 0)
                this.outx("  Just as well there were four of them, eh?");
            this.outx(
    ...
    private takeKellysVirginity(): void {
        ...
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 1) this.outx("horse-");
        this.outx("cunt.");
        ...
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 1)
            this.outx("lust-swollen, black-lipped fuck-hole");
        else this.outx("blooming, pink-tinged pussy");
        this.outx(' to your roving eyes.  She asks, "<i>Is th-th-this good, [Master]?</i>"');
        ...
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 1) this.outx(", equine");
        this.outx(
        ...
        this.outx("\n\nYou squeeze Kelly's ");
        if (this.player.isTaur())
            this.outx("breast as you snuggle up behind her, centaur to centaur,");
        else this.outx("ass");
        this.outx(
        ...
        if (this.player.cockArea(x) <= 300) {
            this.outx(", nestling your [sheath] up against her ");
            if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 1) this.outx("plump, equine cunt-lips");
            else this.outx("slippery, pink cunt-lips");
        } else
            this.outx(
                ", pressing your " +
                    this.player.cockHead(x) +
        ...
        if (this.flags[kFLAGS.KELLY_CUNT_TYPE] == 0)
            this.outx("the redness of her well-used cunt.");
        else
            this.outx(
    ...
    private kellyTitJob(): void {
        ...
        // [Lactation:
        if (this.pregnancy.isPregnant)
            this.outx(", glittering beads of milk flicking here and there as she advances");
        this.outx(
    ...
    public kellyPopsOutARunt(): void {
        ...
        if (gender == 2) this.outx("her");
        else this.outx("his");
        this.outx(" mother's milk.");
    ...
    private talkNHandToKelly(): void {
        ...
        // Repeat:
            ...
            this.outx("You tell her you'd like to... talk.");
            ...
            if (!this.player.isTaur()) {
                ...
                if (this.player.cockTotal() > 1) this.outx("s");
                this.outx(" with her soft hands.  You sigh as she begins to gently pump, making ");
                if (this.player.cockTotal() > 1) this.outx("them");
                else this.outx("it");
                this.outx(" harden quickly.");
            } else {
                this.outx("trots around behind you.  You sigh as ");
                if (this.player.cockTotal() == 1)
                    this.outx(
                        "a warm hands wraps itself around your [cock] and then begins to gently tug, quickly hardening it with pleasing coils of friction."
                    );
        ...
        // 2.
            ...
            if (this.player.cockTotal() > 1) this.outx(" and [cock 2]");
            this.outx(
        ...
        // 3.
            ...
            if (!this.player.isTaur()) this.outx("into the air");
            else this.outx("onto the ground");
            this.outx(
                ".  Kelly nuzzles your [cocks] when you're done, slurping obscenely as she polishes your nobhead"
            );
            if (this.player.cockTotal() > 1) this.outx("s");
            this.outx(" to a shine.  You thank her with a slap on the ass and leave.");
        }
        // 4.
        else if (temp == 3) {
            this.outx(
            ...
            if (this.player.balls == 0)
                this.outx("suckles and laps at the very base of your [cock] for a time");
            else this.outx("suckles and laps at your [balls] for a time");
            this.outx(
            ...
            if (this.flags[kFLAGS.KELLY_KIDS] > 0)
                this.outx(" and bearing and raising your children");
            this.outx(
    ...
    private giveKellyAppleSauce(): void {
        ...
        // Repeat:
            ...
            if (this.silly()) this.outx("  Parsley, sage, rosemary and c...");
            this.outx(
        ...
        if (!this.player.isTaur()) {
            ...
            if (this.player.balls > 0)
                this.outx(", your [balls] slapping into her thighs demandingly ");
            this.outx(
            ...
            if (y >= 0) this.outx(" as her anus clenches around your " + this.cockDescript(x));
            this.outx(
        ...
        // Centaur:
            ...
            if (this.player.balls > 0)
                this.outx(", your [balls] slapping into her thighs demandingly");
            this.outx(" as you push towards your reward.");
            this.outx(
            ...
            if (y >= 0) this.outx(" as her anus clenches around your " + this.cockDescript(y));
            this.outx(
        ...
        if (this.player.isBiped()) this.outx("giving at the knees, ");
        this.outx(
    ...
    private kellyBJsAhoy(): void {
        ...
        if (!this.player.isTaur()) {
            ...
            if (this.player.balls > 0 && this.player.hasVagina()) {
                ...
                if (this.player.ballSize <= 8) {
                    ...
                    if (this.player.balls > 2) this.outx(", then the third, then the fourth");
                    this.outx(
                    ...
                    if (this.pregnancy.isPregnant) this.outx("milk-laden ");
                    this.outx(
            ...
            // Balls:
                ...
                if (this.player.ballSize <= 8) {
                    ...
                    if (this.player.balls >= 4) this.outx(", then the third, then the fourth");
                    this.outx(
            ...
            if (this.player.balls > 0) this.outx(", as you feel your [balls] clench");
            this.outx(
            ...
            if (this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0)
                this.outx(" onto all four of her tits");
            this.outx(
            ...
            this.outx("  Finally you are spent.");
        }
        // Centaur:
        else {
            this.outx(
            ...
            if (this.player.hasVagina()) this.outx("pussy-licking, ");
            if (this.player.balls > 0) this.outx("ball-sucking ");
            this.outx(
            ...
            if (this.player.cumQ() < 750)
                ...
                if (this.flags[kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0) this.outx("all four of ");
                this.outx(
        ...
        if (!this.player.isTaur()) this.outx(", still clutching your pleasantly aching prick");
        this.outx(
