...
"KeltOff" - Turns off Kelt */
    ...
    private continueAfterBJ(): void {
        this.spriteSelect(35);
        this.outputText(
            "After a brief rest, you manage to get back to practicing archery.  ",
            true
        );
        this.keltMainEncounter3();
    }
    ...
    private keltCentaurBadEnd(): void {
        ...
        if (this.player.gender >= 2) {
            ...
            if (this.player.gender == 3) {
                ...
                this.outputText(
                    '"<i>Well, no matter.  This here is what I came for.</i>"\r\r',
                    false
                );
            }
            //(Both)
    ...
    private fuckKeltsShitUp(): void {
        ...
        //Standard anti-kelt scene
            ...
            if (this.player.gender == 0) {
                ...
                if (this.player.cocks[0].cockLength < 10)
                    this.outputText(
                        "taking the entire thing easily as his tongue licks you to ",
                        false
                    );
