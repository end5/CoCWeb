...
"KeltOff" - Turns off Kelt */
    ...
    public keltEncounter(): void {
        ...
        // Repeated encounter
            ...
            if (
                ...
                if (
                    this.player.inte > KeltScene.rand(40) &&
                    this.player.statusAffectv2(StatusAffects.Kelt) < 130 &&
                    this.player.findStatusAffect(StatusAffects.KeltBadEndWarning) < 0
                ) {
    ...
    private keltFirstTime(): void {
        ...
        this.outx(
            "\"<i>Don't be stupid.  You'd never even get close to me.  If I wanted to kill you, you would have been dead a long time ago.  My name is Kelt.</i>\"\r\r",
            false
        );
        this.outx(
        ...
        this.outx(
            "\"<i>Like my bow?  As well you should.  This is a real warrior's weapon!  If you want to learn someday, visit me again.  Maybe if you're not too stupid, you will be able to learn something.  I won't cross my fingers.</i>\"\r\r",
            false
        );
        this.outx(
            "He laughs again derisively, and trots off.  You bristle slightly... he is irritatingly arrogant.  But if he can teach you to use a weapon like that, it may be worth putting up with his company...",
            false
        );
        this.doNext(this.camp.returnToCampUseOneHour);
    }
    ...
    private keltRequiresNakedness(): void {
        ...
        this.outx(
            '"<i>I can\'t teach you like this,</i>" he sneers.  "<i>Your balance is all fucked up.  I know colts who can shoot better than you.  You really want to learn the skill?  Then you\'re gonna have to practice like a centaur.  You\'d never see me wearing armor!</i>"\r\r',
            false
        );
        this.outx(
            "He slaps a hand on his bare chest proudly, and you realize that he means for you to strip down naked.  When you protest, his eyes narrow with irritation, and his sneer becomes more cruel.\r\r",
            false
        );
        this.outx(
        ...
        this.outx("Do you obey his demand?");
        if (
            this.player.cor > 70 &&
            this.player.inte > 40 &&
            this.player.lowerBody != LOWER_BODY_TYPE_CENTAUR
    ...
    private keltEagerlyGetNaked(): void {
        ...
        this.outx("", true);
        this.outx(
            "You have no problem stripping down naked in front of Kelt, even enjoying the process a little bit.  Judging by his leer, Kelt is enjoying it too.  He seems aroused by his power over you more than anything else... and you find yourself admitting that you're a little aroused by it as well.\r\r",
            false
        );
        this.outx(
        ...
        if (this.player.gender == 1 && this.player.biggestTitSize() < 1)
            this.outx(
                '"<i>What are you, a girl?  Get on with it so I can see what I\'m dealing with.</i>"\r\r',
                false
            );
        else {
        ...
        this.outx(
            "He looks you over one last time, and sneers condescendingly.  \"<i>Well, it ain't much as far as heroes go.  But it's better than nothing.  Fine, I'll teach ya some more.  But I don't want to see those damn clothes again.  You'll learn the way I tell you to learn, got it?</i>\"\r\r",
            false
        );
        this.outx(
    ...
    private keltReluctantlyGetNaked(): void {
        ...
        this.outx("", true);
        this.outx(
            "You are uncomfortable with the idea of being naked in front of this crude, cruel taskmaster.  But he is good at what he does, and if this is the only way to convince him to teach you, then you'll just have to get it over with.  You agree to his terms reluctantly, and begin to strip off your clothes.\r\r",
            false
        );
        this.outx(
        ...
        this.outx(
            "He looks you over one last time, and sneers condescendingly.  \"<i>Well, it ain't much as far as heroes go.  But it's better than nothing.  Fine, I'll teach ya some more.  But when I tell you to strip, you do it a little faster next time... or I might not be so generous.</i>\"\r\r",
            false
        );
        this.outx(
    ...
    private keltRequiresBlowjobs(): void {
        ...
        this.outx(
            "Crossing the field of Whitney's farm, your heart begins to beat a little bit faster as you spy Kelt the centaur off in the distance.  You can't help but admire his powerful flanks and his proud stature as he runs freely.  Perhaps a little pleased with yourself, you also take a good look at his dangling equipment, sheathed yet sizable.  The sight is entrancing.\r\r",
            false
        );
        this.outx(
            "A grin crosses your face, despite yourself.  Kelt can be insufferable sometimes.  Most times.  Okay, at all times.  But there is something about him that makes you feel... right, somehow.  Sure he insults you... but he is so strong, so powerful.  So masculine, for lack of a better word.  Infuriating, arrogant, and utterly in control.  Somehow, the combination makes you feel weak at the knees.\r\r",
            false
        );
        this.outx('"<i>Enjoying the sights, are we?</i>"\r\r', false);
        this.outx(
            "You blink, startled.  While you were thinking, Kelt approached you, and you were staring directly at his crotch.  He leers down at you with an arrogant grin.  Flushed, you stammer out that you're here for more archery lessons.  He snorts, clearly amused.\r\r",
            false
        );
        this.outx(
            "\"<i>Yeah, I'll bet.  When they talk about firing shafts, whore, they're talking about arrows.  Bet you would prefer the other kind though, huh?</i>\"\r\r",
            false
        );
        this.outx(
            "He paces around you, in an almost predatory fashion.  His thick flanks brush up against you, and the smell of him is so potent you feel a little dizzy.  Heady and musky, the scent is like a keen aphrodisiac, cutting straight to your core.  You whimper a little, and Kelt raises an eyebrow.  Is it you, or does he almost look satisfied?\r\r",
            false
        );
        this.outx(
            "\"<i>Well, I think you've had enough freebies.  Maybe I don't wanna teach you anymore.  After all... what do I get from it?  I spend all day teaching a moron how not to shoot [him]self in the foot, and I got nothing to show for it.  I think it's about time you put down a little payment.</i>\"\r\r",
            false
        );
        this.outx(
            "You nod automatically, fumbling for the pouch you store gems in.  Kelt casually backhands you as you do so, knocking you to the ground.  Your cheek burns hotly, and your head has cleared a little from the pain.  Kelt is sneering down at you, but there is something darkly pleased in his expression.\r\r",
            false
        );
        this.outx(
            "\"<i>I don't want your fucking money.  What am I gonna buy... hentai comics and scholar tea?  Fuck off.  You want to learn more about archery?  Then it's about time you showed some gratitude.</i>\"\r\r",
            false
        );
        this.outx(
            "He pushes you over with ease, toppling you facedown into the mud.  Sputtering, you try to rise, only to find that Kelt has moved so that he stands above you, hooves on either side of your head.  Wiping slime from your face, you realize why.  Beneath the barrel of his stomach, his massive cock is slowly dropping from his sheath, growing larger by the second.\r\r",
            false
        );
        this.outx(
            "You can't help but stare at the engorged head, flaring out from the tip of the mottled shaft.  Above you, Kelt snorts, sounding more like an impatient horse than a person, and moves forward slightly; his half-erect member presses against your cheek.  You let out a startled yelp as the hot, damp flare presses against your face, staining your cheek with a thick dollop of precum.  Kelt grunts again, more urgently.\r\r",
            false
        );
        this.outx(
            '"<i>You know the price, slut. You want archery lessons, and I want to blow my load in that throat of yours. Everyone wins. Now get started.</i>"\r\r',
            false
        );
        this.outx(
            "You swallow hard.  You don't have to take this!  Kelt is an arrogant, abusive, well-hung, enticing, delicious... you shake your head, thoughts clouded.  The cock grows larger and thicker by the second, and the musk of it delights your senses.  Part of you reasons that one little blowjob won't hurt... right?",
            false
        );
        this.outx("\r\rDo you submit?", false);
        ...
        if (this.player.cor + this.player.lib + this.player.lust >= 200 && this.player.inte < 60) {
            this.outx("  Of course you do, slut that you are.");
    ...
    private keltBlowjobRequirementNever(newl = true): void {
        ...
        this.outx(
            "You struggle, trying to hold onto your fragmented thoughts. Something about Kelt's scent, or presence, is overwhelming.  The temptation to give in is almost overpowering, but you set your teeth, close your eyes, and furiously try to ignore your hammering heart.\r\r",
            false
        );
        this.outx(
            "Kelt's feet move almost uncertainly, hooves pawing at the ground and resetting themselves.  He almost seems confused for a moment, hips bucking forward experimentally.  When there is no further sensation, his confusion begins to be replaced by anger.\r\r",
            false
        );
        this.outx(
            "He spends a few moments cursing you, swollen cock still sometimes pumping forward as though expecting you to latch on at any moment. The centaur is obviously unused to rejection.  The temptation bites harder than ever as his cruel words shame you.  Wouldn't it be easier to just give in?  To give this powerful male what he wants, so he'll like you again?  The cock hovers teasingly within reach, just waiting to give you a glorious taste... but you fight the alien urge, and keep your mouth shut.\r\r",
            false
        );
        this.outx(
            "You have just a moment to react, as the tone suddenly shifts.  Kelt, who has been stomping and cussing angrily, has decided on a new target.  Training remembered, you roll to the side just as Kelt rears and brings his front two hooves down where your head was moments earlier.\r\r",
            false
        );
        this.outx(
            "Kelt moves towards you, eyes blazing, and you drop into a crouched stance automatically.  Even so, you are overwhelmed by another blow to the face as Kelt furiously lashes out at you.  You scramble to defend yourself, but the attack, such as it was, is over as soon as it began.  The abusive centaur is already moving away, frustration clear with every step.\r\r",
            false
        );
        this.outx(
            '"<i>Stupid slut.  Refuse me, huh?  ME?  Well FUCK you and the [legs] you walked in on!  You wanna shoot arrows, go learn how to do it yourself!  Better idea... go to the fucking desert, find a demon, and fucking BEG him to make you his ass slave.  Go on!  Fuck off, slut!</i>"\r\r',
            false
        );
        this.outx(
    ...
    private keltBlowjobRequirementShamefully(newl = true): void {
        ...
        this.outx(this.images.showImage("kelt-farm-shamefulbj"));
        this.outx(
            "The thought of going through with it is appalling.  The thought of not wrapping your lips around that glorious member is equally unthinkable.\r\r",
            false
        );
        this.outx(
            "Face flushed with lust and shame, you reach up hesitently to wrap your hand around the growing member, feeling its wondrous heat.  Kelt lets out a satisfied groan, his hips bucking forward involuntarily.  The flared head of his massive cock drools precum lewdly, and you hesitate once more, torn.  But with the warmth of his cock beneath your hand, there is no going back.\r\r",
            false
        );
        this.outx(
            "Leaning forward, you lap meekly at the head, tasting his precum on the tip of your tongue.  The salty, gooey ooze sets your senses on fire with need... have you ever tasted something so wonderful?  A second taste begets a third, and a fourth, and soon enough, you have stretched your lips wide to suck in that swollen head, intent on slurping every little drop you can.\r\r",
            false
        );
        this.outx(
            "The head of the massive cock barely fits between your lips, but the creaking of your jaws is worth it as your mouth is filled with the taste of Kelt's seed.  You nurse at it, almost hungrily, and wince as you feel a splurt of it plaster your throat.  The crude thought of what you are doing is painful, but you cannot help taking pleasure in the hot taste of centaur cum.  It is like a reward for giving up every ounce of pride you had.\r\r",
            false
        );
        this.outx(
            "Kelt does not give you long to mourn your loss.  One of his hooves paws restlessly at the ground, animalistic, as he pushes his hips forward once again.  You gag slightly as the flared head rams into the back of your throat insistently.  Hoping to give some relief to your impatient abuser, you begin masturbating the length of his cock with your hands, even while suckling on the tip.  His underside shivers a little with pleasure, and you feel a shaming little burst of pleasure for pleasing him.\r\r",
            false
        );
        this.outx(
            '"<i>Mmm...I knew it from the moment I saw you.  Quite the talented little cocksucker you are.  Deeper, bitch.  I want you to choke on my spunk.</i>"\r\r',
            false
        );
        this.outx(
    ...
    private keltBlowjobRequirementEagerly(newl = true): void {
        ...
        if (newl) this.outx("", true);
        this.player.slimeFeed();
        this.outx(this.images.showImage("kelt-farm-eagerbj"));
        this.outx(
            "It is like someone answered your prayers.  You eagerly agree, babbling your thanks to Kelt as you are faced with the massive cock, growing harder and harder.  He snorts scornfully.\r\r",
            false
        );
        this.outx(
            '"<i>I didn\'t ask for your thanks, slut,</i>" he says cruelly.  "<i>I asked for you to suck my cock.  Now open wide and choke it down, or I\'m aiming for your ass.</i>"\r\r',
            false
        );
        this.outx(
            "That thought sends another quiver of pleasure through you, but you leap to obey Kelt's orders, even so.  Maybe if you do a good enough job, he'll fuck your ass too...?  Face flushed with excitement, you reach up to wrap your hand around the growing member, feeling its wondrous heat.  Kelt lets out a satisfied groan, his hips bucking forward involuntarily.  The flared head of his massive cock drools precum lewdly, and you immediately lean forward, lapping hungrily.  No sense in letting even a single drop go to waste!\r\r",
            false
        );
        this.outx(
            "The salty, gooey ooze sets your senses on fire with need... have you ever tasted something so wonderful?  A second taste begets a third, and a fourth, and soon enough, you have stretched your lips wide to suck in that swollen head, intent on slurping every little drop you can.  The head of the massive cock barely fits between your lips, but the creaking of your jaws is worth it as your mouth is filled with the taste of Kelt's seed.\r\r",
            false
        );
        this.outx(
            "You nurse at it, almost hungrily, and almost melt with pleasure as you feel a splurt of it plaster your throat.  It feels so right, to be here for Kelt's use.  That he would choose you to unload his heavenly cum upon... it is all you could ever want out of life.  If you spent the rest of your days swallowing his spare spunk, you could be happy.\r\r",
            false
        );
        this.outx(
            "Kelt does not give you long to savor your fulfillment.  One of his hooves paws restlessly at the ground, animalistic, as he pushes his hips forward once again.  You gag slightly as the flared head rams into the back of your throat insistently.  Understanding that his needs must come first, you begin masturbating the length of his cock with your hands, even while trying to slurp more of it into your mouth.  His underside shivers a little with pleasure, and you feel a little burst of pride... he's enjoying it!\r\r",
            false
        );
        this.outx(
            '"<i>Mmm... I knew it from the moment I saw you.  Quite the talented little cocksucker you are.  Deeper, bitch.  I want you to choke on my spunk.</i>"\r\r',
    ...
    private keltMainEncounter(): void {
        ...
        // (Submissive 70-100:
        else this.outx("You nod enthusiastically, almost begging him to teach you.  ");
                ...
                if (
                    ...
                    if (
                        (this.player.cor + this.player.lib + this.player.lust >= 220 &&
                            this.player.inte < 40) ||
                        this.player.statusAffectv2(StatusAffects.Kelt) >= 70
                    ) {
                        this.outx(
                            "  <b>With a lusty smile, you decide to ALWAYS get naked before practicing.</b>",
                            false
                        );
                        this.player.createStatusAffect(StatusAffects.NakedOn, 0, 0, 0, 0);
                    }
            ...
            // (Otherwise:
                ...
                if (
                    ...
                    if (
                        (this.player.cor + this.player.lib + this.player.lust >= 220 &&
                            this.player.inte < 40) ||
                        this.player.statusAffectv2(StatusAffects.Kelt) >= 75
                    ) {
                        this.outx(
                            "  <b>You cast a seductive smile Kelt's way and decide you should always strip before practice</b>.",
                            false
                        );
                        this.player.createStatusAffect(StatusAffects.NakedOn, 0, 0, 0, 0);
                    }
    ...
    private keltMainEncounter2(): void {
        ...
        if (this.player.hasKeyItem("Bow") < 0) {
            ...
            this.outx(
                "Despite his mocking description, the bow he gives you really is a decent weapon.  You take it up and start towards the practice field, Kelt following behind.\r\r",
                false
            );
        ...
        // (Bow equipped)
            ...
            this.outx("Together, the two of you head off to the practice field.\r\r", false);
        }
    ...
    private keltMainEncounter3(): void {
        ...
        // NAKERS
            ...
            if (this.player.inHeat && this.player.gender > 1) {
                this.outx(this.images.showImage("kelt-farm-female-inheat"));
                this.outx(
                ...
                this.outx('"<i>Alright, slut... here comes your baby!</i>"\r\r', false);
                this.outx(
                ...
                this.outx(
                    "\"<i>That's a good look for you.  Come back tomorrow if it doesn't take, slut.  I'll be glad to do the job again.</i>\"\r\r",
                    false
                );
                this.player.slimeFeed();
                this.player.orgasm();
                this.outx("He leaves you without another word.");
                // (+5 Submissive)
            ...
            if (temporary == 3) {
                ...
                this.outx(
                    '"<i>Isn\'t it obvious?</i>" he asks, grinning down at you in sardonic amusment. "<i>You were way off balance.  Of course, I would be too, if I had a couple of extra pounds of fat hanging off my chest.</i>"\r\r',
                    false
                );
                this.outx(
                    "Indignantly, you cover your breasts with your hands, telling him to be serious.  He laughs again, more cruelly this time.\r\r",
                    false
                );
                this.outx(
                    "\"<i>I am being serious.  Women aren't warriors.  And those with tits do not become warriors.  I just think it's funny. You, begging me to teach you, while you have those udders hanging off your chest!</i>\"\r\r",
                    false
                );
                this.outx(
                ...
                if (this.player.biggestLactation() > 1) {
                    ...
                    this.outx(
                        '"<i>Oh, boy!  Mommy here brought snacks for everyone!  Don\'t mind if I do!</i>"\r\r',
                        false
                    );
                    this.outx(
                    ...
                    this.outx(
                        '"<i>Not bad, for a cow.  You certainly seemed to enjoy it too.</i>"\r\r',
                        false
                    );
                    this.outx(
                ...
                this.outx(
                    "\"<i>Take it from me, bitch.  Know your place.  Breasts are for women, and women are for fucking until their bellies are full of foals.  'Teach me archery, Kelt!'  Ha!  Now that's a joke.</i>\"\r\r",
                    false
                );
                this.outx(
                    "Flicking your erect teats painfully one last time, Kelt walks away, laughing loudly to himself.",
                    false
                );
                this.doNext(this.camp.returnToCampUseOneHour);
                // (+5 Submissive)
            ...
            if (temporary == 4) {
                ...
                this.outx(
                    "\"<i>Okay.  Now that our little bitch is getting an assfuck, maybe she'll be satisfied enough to hit the fucking target.  Now shoot... and don't you dare fuck this up again.</i>\"\r\r",
                    false
                );
                this.outx(
                ...
                this.outx(
                    "With a snort, Kelt shoves you to the ground, removing his fingers as he does so.  Wincing, you sit up with the centaur staring down at you snidely.\r\r",
                    false
                );
                this.outx(
                    "\"<i>Lesson's over for now.  Next time it's my cock, slut.</i>\"\r\r",
                    false
                );
                this.outx(
    ...
    private keltMainEncounterPostBlowjob(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.BlowjobOn) >= 0) {
            ...
            if (
                ...
                this.outx(this.images.showImage("kelt-farm-smallbarn"));
                this.outx(
                ...
                this.outx(
                    '"<i>Bitch!  I said get in there.  Do I need to repeat myself, you stupid whore?"</i>\r\r',
                    false
                );
                this.outx(
                ...
                if (this.player.tallness < 112) this.outx("smaller ");
                this.outx("body with no concern for your well being.");
                ...
                this.outx(
                    "\"<i>Now stay there for a while, bitch.  Let it get good and stuck up there.  Come back tomorrow, and maybe, if you're lucky, I'll fuck you again.  You do, after all, make a pretty good cumdump.</i>\"\r\r",
                    false
                );
                this.outx(
                ...
                this.player.slimeFeed();
                // (+10 Submissiveness)
                if (this.player.buttChange(70, true)) this.outx("\r\r", false);
                this.player.addStatusValue(StatusAffects.Kelt, 2, 10);
                this.player.orgasm();
                this.dynStats("cor", 1);
                return;
            ...
            // (Otherwise)
                ...
                this.outx('"<i>Alright, bitch.  Swallow my cock.</i>"\r\r', false);
                this.outx(
                ...
                this.outx(
                    '"<i>Pretty good, slut.  I knew there was a reason I kept you around.  I\'ve indulged you enough, though.  Get over there and shoot some arrows, before I get bored with you.</i>"\r\r',
                    false
                );
                this.outx(
        ...
        // (Blowjob Requirement Off, 40% Chance)
            ...
            this.outx(
                "Once at the field, you move to draw an arrow and begin practice, when Kelt roughly pushes you down to your knees.\r\r",
                false
            );
            this.outx(
                "\"<i>Not today, bitch.  I think it's time you gave a little back.  So be a good little whore, and get to work on my cock.  I'm gonna bust a nut in that pretty little mouth before I do any more teaching.</i>\"\r\r",
                false
            );
            this.outx(
    ...
    private keltResistGivingBJ(): void {
        ...
        this.outx(
            "To your surprise, however, Kelt does not seem particularly bothered.  In fact, he laughs as you leave.\r\r",
            false
        );
        this.outx(
    ...
    private keltSubmitGivingBJ(): void {
        ...
        this.outx("", true);
        this.outx(
            "\"<i>There we go.  Who's a good little whore?  Who's a hungry little slut?  Okay, bitch... time to fill that belly of yours.  Open wide.</i>\"\r\r",
            false
        );
        this.outx(
            "Reluctantly, with shame burning in your cheeks and desire ravaging your mind, you lower yourself before him and do just that.\r\r",
            false
        );
    ...
    private continueAfterBJ(): void {
        this.spriteSelect(35);
        this.outx("After a brief rest, you manage to get back to practicing archery.  ", true);
        this.keltMainEncounter3();
    }
    // (Reluctant Blowjob)
    private keltReluctantGivingBJ(): void {
        ...
        this.player.slimeFeed();
        this.outx("", true);
        this.outx(this.images.showImage("kelt-farm-reluctantbj"));
        this.outx(
    ...
    private keltCentaurBadEnd(): void {
        ...
        if (this.player.gender == 1) {
            ...
            this.outx(
                "Roughly he seizes hold of your crotch, making you whinny slightly.  Whether from pain or pleasure, however, is harder to tell.  You feel strange, conflicting emotions... primarily a need to be with Kelt, to pleasure Kelt, to fuck Kelt... the urgency surprises you.  Even more surprising is the fact that your cock is entirely flaccid.\r\r",
                false
            );
            this.outx(
                '"<i>Well, I\'ve got no use for males, slut.  Fortunately, you still have something I can use in the meantime.</i>"\r\r',
                false
            );
            this.outx(
                "His legs rear suddenly, wrapping around the barrel of your body. You let out a startled protestation, but do not move... your body won't let you.  In fact, if anything, you push back against him, eager and ready.  Part of you is joyous, in fact.  What you wanted wasn't to fuck Kelt!  ",
                false
            );
            this.outx("<b>... It was for him to fuck you!</b>\r\r", false);
            this.outx(
        ...
        if (this.player.gender == 0) {
            ...
            this.outx(
                "Roughly he shoves a couple of fingers into your asshole, making you whinny slightly.  Whether from pain or pleasure, however, is harder to tell.  You feel strange, conflicting emotions... primarily a need to be with Kelt, to pleasure Kelt, to fuck Kelt... the urgency surprises you.  But how... and with what?\r\r",
                false
            );
            this.outx(
                "\"<i>Well, man or woman, it doesn't matter to me.  You're still only good for one thing.  Time to give you a purpose, slut.</i>\"\r\r",
                false
            );
            this.outx(
                "His legs rear suddenly, wrapping around the barrel of your body.  You let out a startled protestation, but do not move... your body won't let you.  In fact, if anything, you push back against him, eager and ready.  Part of you is joyous, in fact.  What you wanted wasn't to fuck Kelt!  ",
        ...
        if (this.player.gender >= 2) {
            ...
            if (this.player.gender == 3) {
                this.outx("", true);
                this.outx(
                    '"<i>Ooh, the slut is packing is she?  Tell me, how\'s that cock working out for you?</i>"\r\r',
                    false
                );
                this.outx(
                    "It isn't, of course.  Not at all... you are entirely flaccid, and Kelt knows it.  He grasps the base of your cock roughly, giving it a few experimental tugs, laughing derisively as he does so.  There is no reaction... save that your cunt gets a little wetter.\r\r",
                    false
                );
                this.outx('"<i>Well, no matter.  This here is what I came for.</i>"\r\r', false);
            }
            // (Both)
            this.outx(
            ...
            this.outx(
                "\"<i>Aww... we sure got a pretty little filly here, don't we?  Still, a filly isn't really happy unless she's being fucked.  Unless her stomach is full of foals for her master.  And since you've gone to the trouble of preparing yourself for me, bitch... I guess I'll just have to do the job.</i>\"\r\r",
                false
            );
            this.outx(
                "His legs rear suddenly, wrapping around the barrel of your body.  You let out a startled protestation, but do not move... your body won't let you.  In fact, if anything, you push back against him, eager and ready.  Your vagina drools anxiously, ready for him, ready to be seeded with his foals.  Part of you is joyous, in fact.  What you wanted wasn't to fuck Kelt!",
                false
            );
            this.outx("<b>... It was for him to fuck you!</b>\r\r", false);
            this.outx(
    ...
    private keltSubmissiveBadEnd(): void {
        ...
        this.outx(
            "His face clouds over darkly.  That's all the warning you get before he strikes you hard across the face, sending you spinning to the ground with a grunt.  The pain fills you with happiness, and urgently you raise your ass needfully into the air, hoping he will take you then and there.  Kelt snarls at you, and you tremble slightly, but keep your ass high.\r\r",
            false
        );
        this.outx(
            "\"<i>Archery?  I've had enough of this game, bitch.  I've decided that I won't be teaching you archery anymore.</i>\"\r\r",
            false
        );
        this.outx(
            "A sense of dread fills you.  No more lessons?  No more... Kelt?  Then, another shock of pain as he roughly grabs you by the hair, drags you over to a nearby bale of hay, and throws you onto it facedown.  Moments later, his heavy weight rests on top of you, swollen cock pressing into your back.\r\r",
            false
        );
        this.outx(
            '"<i>No, no more archery.  Time for your real education, bitch.  Lesson one... you are a slut, only here for my pleasure.  No more adventuring, no more exploring.  From now on, you are nothing but a hole for me to bust a nut into.  Got it?</i>"\r\r',
            false
        );
        this.outx(
            "You whimper with joy, thanking him over and over again.  A great weight has been lifted, your true purpose revealed.  How could you have not known it before?  Kelt is your master, and you are nothing but his needy slut!  The revelation fills you with ecstasy.  Eagerly you thrust back up against him, eager to be filled, desperate for satisfaction.  He grinds into you, grinning wickedly all the time.  Then, mercifully, he pulls back enough to line up his shot, and fills your ass with his cock.\r\r",
            false
        );
        this.outx(
            "\"<i>Ungh!  There's a good bitch.  From now on, you're mine, and mine only.  If you dare to fuck another creature, I will kill you.  Be a good slut, though, and maybe I'll give you a few foals to fill that belly.  Now moan for me, bitch.  I wanna hear you scream as I make you mine.</i>\"\r\r",
            false
        );
        this.outx(
            "Scream you do, but with pleasure, as his cock erupts deep within your bowels.  This is what you wanted... this is what you always wanted.  Kelt grunts with contented release, then begins thrusting again, cock still hard as he prepares to dump a second load into his newest harem member.  Again and again, you beg him for more, embracing your new life without regret.",
            false
        );
        this.doNext(this.keltBadEndEpilogue);
    }
    ...
    private keltBadEndEpilogue(): void {
        ...
        this.outx("", true);
        this.outx(
            "The next year, after a few suggested mutations from your master...\r\rThe heroine hesitatingly moved forward, crossing the field with the sort of practiced caution that had so far kept her safe in this strange land.  The farm should be somewhere nearby, if she had figured things correctly.  Of course, who could tell with this ever-shifting landscape?\r\r",
            false
        );
        this.outx(
            "A sudden sound caught her attention.  A lewd, squishing noise, the sound of horses crying out.  A monster?  Whatever it was, it was coming from behind the barn.  Readying her sword, the heroine moved forward cautiously, ready to confront danger.\r\r",
            false
        );
        this.outx(
        ...
        this.outx(
            "In time, the male obliged, pulling cruelly on the centauress' hair as he let out a low roar and came forcefully.  The heroine stared in wonder as his massive balls convulsed again and again, pumping his mare full of seed.  If she listened, she could actually hear the lewd squish of every blast of semen as it filled her, pumping steady gouts of babycream into her womb.\r\r",
            false
        );
        this.outx(
            "The centaur dismounted as soon as he was satisfied, ignoring the abused mare after his needs were met.  He was obviously the dominant one, and his mate looked after him with hungry eyes, wanting more.  Two more centaurs... young females, by the look of it, emerged from the barn, hurrying over towards their mother and happily latching onto her breasts.  The mother cooed happily, letting them nurse from her full breasts, even while looking after their retreating father hopefully.  The heroine could see, looking closely, how distended the mare's stomach was... she was probably pregnant with yet another foal.  Somehow, the image seemed terribly erotic to the heroine, who bit her lip anxiously.\r\r",
            false
        );
        this.outx(
            '"<i>Enjoying the show, fucker?  She\'s not bad, for a quick fuck now and then.  A little clingy, but makes for a good cumdump.  What... you jealous?</i>"\r\r',
            false
        );
        this.outx(
            "The heroine paled, and turned around to face the male, berating herself for letting him sneak up on her.  Brandishing her sword, she tried to step backwards, wary of an attack.  The centaur eyed her sword amusedly, then broke out into a nasty laugh, ",
            false
        );
        this.outx(
            '"<i>Ha!  Little bitch human, who thinks she knows how to use a sword.  You use that little stick to ward off the big bad monsters when they come for your little pussy?  Give me a break.  This is a real man\'s weapon.</i>"\r\r',
            false
        );
        this.outx(
            "He touched the bow strung across his broad chest arrogantly.  The heroine hesitated, looking at the weapon.  They had bows like that in her home town, but she didn't have one.  It could be a useful tool... and the centaur seemed to know what he was doing with it.  He didn't seem threatening... maybe a little arrogant, and more than a little rude.  Maybe...\r\r",
            false
        );
        this.outx(
            'The centaur noticed her looking, and grinned.  "<i>You like what you see?  Maybe I could teach you a few things.  If you\'re not as stupid as that slut, of course.</i>"\r\r',
            false
        );
        this.outx(
            "He waved confidently at the mare, still nursing her young with a rapturous look on her face.  Cum slowly oozed out of her pussy, pooling on the ground beneath her, and the heroine felt a little envious for a moment.  Most horses had harems, the virile male satisfying many women at once.  How many times a day was this mare fucked?\r\r",
            false
        );
        this.outx(
            'The centaur grinned, knowingly.  His musk was heavy on the air, a thick, animalistic scent of masculinity.  "<i>Well, I could do with a little distraction anyway.  Stupid whore may be a good fuck, but a man needs to... spread out a little.  Come back tomorrow, and maybe I can knock some fucking sense into that empty head of yours.  My name\'s Kelt.</i>"\r\r',
            false
        );
    ...
    private keltResistance(): void {
        this.spriteSelect(35);
        this.outx("You close your eyes, ", true);
        if (this.player.faceType == FACE_HORSE || this.player.faceType == FACE_DOG)
            this.outx("a low growl building in the back of your throat");
        else this.outx("fighting anger-fueled muscle-spasms");
        this.outx(
            " as Kelt's insults go too far.  You've had just about enough of his disingenuous assertions!\r\r",
            false
        );
        this.outx(
            "An idea on how to put him in his place slowly forms in the back of your mind, though you're sure pulling it off would humiliate the puffed-up centaur into never his showing his face around the farm again.  Do you do it?",
            false
        );
    ...
    private fuckKeltsShitUp(): void {
        ...
        if (
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cocks[0].cockLength <= 10) {
                    if (this.player.balls > 0)
                        ...
                        this.outx(
                            "Your genital slit bumps into his chin as your cock finds the back of his throat. ",
                            false
                        );
                    this.outx(
                        "He is now entirely engaged with your length, moving his head back and forth as his tongue slathers it with attention, perhaps in the hope that the sooner he gets you off the sooner this nightmare will end.  You smirk and grip his hair, moving his head in rhythm with your own movements.\r\r",
                        false
                    );
            ...
            // If Female:
                ...
                this.outx(
                    "You feel a mighty groan and Kelt's cock begin to pulse urgently against your tail.  Quickly and expertly, you wrap the end around the centaur's penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your cunt.\r\r",
                    false
                );
            ...
            // If Genderless:
                ...
                this.outx(
                    "You feel a mighty groan reverberate through you and Kelt's cock begin to pulse urgently against your tail.  Quickly and expertly, you wrap the end around the centaur's penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your ass.\r\r",
                    false
                );
        ...
        // Standard anti-kelt scene
            ...
            this.outx(this.images.showImage("kelt-farm-subkelt"));
            this.outx(
                "Feigning a coy smile, you drop to your knees and beckon Kelt towards you.  The foolish stud trots over saying, \"<i>That's more like it, slut.  Maybe when I'm done with your mouth, I'll let you have my dick in your ass too.</i>\"  His sheath ripples and swells as his thick member begins to slowly droop out from the folded skin, hanging towards the ground.  It continues growing as he comes closer and closer, until it finally begins to grow rigid and arc up to point at your face.  You breathe in your master's wonderful scent an — No!  You won't cave in to him this time!\r\r",
                false
            );
            this.outx(
                "You grip his dick just below the flare and yank it down hard, stepping up and back until you're behind the beast.  His flexible horse-dick seems to be handling the angle well, so you pull it back further until Kelt dances about uncomfortably, trying to relax the pressure on his exposed member.  He barks, \"<i>You really have no fucking clue what you're doing, do you, bitch?</i>\"\r\r",
                false
            );
            this.outx(
                'Your cheeks color, but your anger drives away the urge to submit.  A quick jerk on his flared dong makes Kelt whinny painfully, and he lashes out with a vicious kick from his hind legs.  You anticipate such a move, and dodge, bending his length further just as his backside starts lifting up.  The pain robs his kick of any strength, and you\'re able to sidestep one leg and force the other aside with a block before it can connect.  He lands hard, wobbling and whinnying uncomfortably, even starting to cry, "<i>Ah, oww... please, just stop hurting me!</i>"\r\r',
                false
            );
            if (this.player.tallness < 50 || this.player.totalCocks() == 0) {
                if (this.player.tallness < 50)
                    this.outx(
                        "Realizing you're too short to dominate him properly, you come up with another plan.  ",
                        false
                    );
                this.outx(
                    'You give his ass a hard smack before you ball up your hand into a fist.  "<i>Who\'s the bitch now?!</i>" you taunt, punching forwards into his asshole.  He cries out at the sudden discomfort, but you feel his dick thicken perceptibly in your hand.  You open your hand when you bump into an apple sized knot inside him, and give it a small, experimental squeeze.  Kelt whinnies and squirts like a garden-hose, splattering a generous helping of clear pre-cum into the grass.  You grin wolfishly and constrict your fingers around the organ.  His horse-cock twitches and flares in your hand, unloading a massive squirt of cum from the stimulation.\r\r',
                    false
                );
            } else {
                this.outx(
            ...
            if (this.player.gender == 0) {
                ...
                if (this.player.cocks[0].cockLength < 10)
                    ...
                    this.outx(
                        "taking as much as he can deep into his throat.  Even though his entire neck is distorted by your massive member, his throat simply isn't long enough to take any more.  You writhe as the throat-fucking brings you to ",
                        false
                    );
                this.outx(
                    "an explosive orgasm.  You deposit your cream directly into his belly, making him burp when you pull out, dripping on the centaur's abused lips.\r\r",
                    false
                );
            }
            this.outx(
                'Taking pity on him, you turn and release the rope, shoving his exhausted body over.  He hits the ground hard and his tightly bound cock bounces in the dirt underneath him.  You gingerly untie the bulging centaur-shaft, noting how massively bloated it is with pent up arousal.  As each layer of rope is peeled off, cum starts to leak from him in greater and greater quantities.  With the release of the last knot, he begins spurting helplessly.  You pat his flank and say, "<i>Good bitch.  Now why don\'t you go find some succubus milk so you can look the part?</i>"\r\r',
                false
            );
            this.outx(
                "You redress before the comatose centaur gets a chance to come to his senses, and wonder if he'll recover enough of his pride to face you again.",
                false
            );
        }
        this.player.orgasm();
