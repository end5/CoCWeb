        ...
        if (this.player.cocks.length == 1)
            ...
            this.outputText(
                "  With all of your " +
                    ...
                    Exploration.num2Text(this.player.cockTotal()) +
        ...
        if (!this.player.isTaur()) {
            this.outputText(
                "The impending erection can't seem to be stopped.  Your sexual frustration forces stiffness into your " +
                    ...
                    this.hipDescript() +
                    " to hold them aloft.  Instead you feel your body forcibly pivoting at the hips until your torso is compelled to rest face down on top of your obscene " +
                    this.multiCockDescriptLight() +
                    ".",
                false
            );
            ...
            if (this.player.balls > 0)
                this.outputText(
                    "  Your " +
                        ...
                        this.buttDescript() +
                        ".  The fiery warmth of the desert caresses it, causing your " +
                        this.ballsDescriptLight() +
                        " to pulse with the need to release their sperm through your " +
                        this.multiCockDescriptLight() +
                        ".",
                    false
                );
        ...
        // FOR CENTAURS
            ...
            this.outputText(
                "The impending erection can't seem to be stopped.  Your sexual frustration forces stiffness into your " +
                    ...
                    this.hipDescript() +
                    " to hold them aloft.  Instead, you feel your body being forcibly pulled down at your hindquarters until you rest atop your " +
                    this.multiCockDescriptLight() +
                    ".",
                false
            );
            ...
            if (this.player.balls > 0)
                this.outputText(
                    "  Your " +
                        ...
                        " rests beneath your raised " +
                        this.buttDescript() +
                        ".  The airy warmth of the desert teases it, causing your " +
                        this.ballsDescriptLight() +
        ...
        // SCENE END = FOR ALL OTHER CHARACTERS
            ...
            this.outputText(
                "  You struggle and push with your " +
                    ...
                    this.multiCockDescriptLight() +
                    " with as much vigor as you can muster.  Eventually your body tenses and a light load of jizz erupts from your body, but the orgasm is truly mild compared to what you need.  You're simply too weary from struggling to give yourself the masturbation you truly need, but you continue to try.  Nearly an hour later " +
                    this.sMultiCockDesc() +
                    " softens enough to allow you to stand again, and you make your way back to camp, still dragging your genitals across the warm sand.",
                false
            );
