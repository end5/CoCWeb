...
export class Masturbation extends BaseContent {
    ...
    public masturbateGo(): void {
        ...
        if (this.player.cor < 15)
            ...
            this.outputText("You make sure you are alone and strip naked.\n\n");
        ...
        if (this.player.cocks.length > 0) {
            if (this.player.cocks.length == 1) {
                ...
                if (this.player.lib < 45)
                    this.outputText(
                        " eagerly, quickly bringing yourself to a full, throbbing state.  "
                    );
        ...
        if (this.player.vaginas.length > 0) {
            if (this.player.vaginas.length == 1) {
                ...
                switch (this.player.vaginas[0].vaginalWetness) {
                    case VAGINA_WETNESS_DRY:
                        this.outputText("expertly arousing your female parts.  ");
                        break;
                    case VAGINA_WETNESS_NORMAL:
                        this.outputText("sighing as it quickly becomes moist.  ");
                        break;
                    case VAGINA_WETNESS_WET:
                        this.outputText("giggling as your fingers get a little wet.  ");
                        break;
                    case VAGINA_WETNESS_SLICK:
                        this.outputText(
                            "smiling as your fingers become coated in your slick fluids.  "
                        );
                        break;
            ...
            if (this.player.vaginas.length > 1) {
                ...
                else if (this.player.lib < 70) this.outputText("You slap your pussies softly, ");
                else
                    this.outputText(
                ...
                switch (this.player.vaginas[0].vaginalWetness) {
                    case VAGINA_WETNESS_DRY:
                        ...
                        break;
                    case VAGINA_WETNESS_NORMAL:
                        this.outputText("sighing as they quickly becomes moist.  ");
                        break;
                    case VAGINA_WETNESS_WET:
                        this.outputText("giggling as your fingers get a little wet.  ");
                        break;
        ...
        if (this.player.cocks.length == 1) {
            ...
            if (this.player.cocks[0].cockThickness < 1.8)
                ...
                else if (this.player.hasKnot()) this.outputText("bulbous beast");
        ...
        if (this.player.cocks.length > 0) {
            //Single Cock
            if (this.player.cocks.length == 1) {
                if (this.player.lib < 30) this.outputText("You quickly fall asleep, spent. ");
        ...
        //No cock ending
            ...
            if (this.player.vaginas.length > 0)
                this.outputText("You sigh softly and drift off into a quick nap, smelling of sex.");
            //Girl ending
    ...
    private genderlessMasturbate(): void {
        ...
        if (this.player.ass.analWetness < 2) {
            ...
            if (this.player.ass.analLooseness <= 2) this.outputText("middle finger");
            else if (this.player.ass.analLooseness == 3) this.outputText("first two fingers");
        ...
        //If BioLube or continuing from no biolube -
            ...
            this.outputText(
                "The lubrication you have created allows you to easily sink your finger"
            );
            ...
            else if (this.player.ass.analLooseness == 4) this.outputText("your three knuckles");
        ...
        if (this.player.ass.analLooseness <= 2) this.outputText("digit");
        else if (this.player.ass.analLooseness < 5) this.outputText("digits");
        else this.outputText("hand");
        this.outputText(" as your toes curl and an orgasm wracks your body.");
        //If BioLube perk -
        if (this.player.ass.analWetness >= 2) {
            this.outputText("  You withdraw your ");
            if (this.player.ass.analLooseness <= 2) this.outputText("finger");
            else if (this.player.ass.analLooseness < 5) this.outputText("fingers");
            else this.outputText("hand");
            this.outputText(
        ...
        //No BioLube perk -
            ...
            if (this.player.ass.analLooseness <= 2) this.outputText("it");
            else if (this.player.ass.analLooseness < 5) this.outputText("them");
    ...
    private titForeplay(): void {
        ...
        if (this.player.hasFuckableNipples() && this.player.biggestTitSize() > 3) {
            ...
            if (this.player.breastRows.length >= 1)
                this.outputText(" as you move your attention to your nipples");
            ...
            else if (this.player.averageNipplesPerBreast() > 1) this.outputText("many ");
            else this.outputText("swollen, cunt-like lips that top each breast. ");
            //Different noise based on sensitivity
            if (this.player.sens < 45) this.outputText("You sigh contentedly as ");
            else if (this.player.sens < 70) this.outputText("You moan lewdly as ");
    ...
    private titFuckSingle(): void {
        ...
        if (this.player.lib < 45)
            ...
            this.outputText(
                "tip of your " + this.player.cockDescript() + " against the opening of "
            );
            /* Old method
        ...
        //More than one row?
        if (this.player.breastRows.length > 1) this.outputText("one of the ");
        ...
        if (this.player.averageLactation() == 0) {
            if (this.player.averageVaginalWetness() < 2) this.outputText("Y");
            else if (this.player.averageVaginalWetness() < 4) {
        ...
        if (Math.round(this.player.cockArea(0)) < this.player.vaginalCapacity()) {
            //Different noises based on sensitivity
            if (this.player.sens < 45) this.outputText("ou sigh with pleasure");
            else if (this.player.sens < 70) this.outputText("ou moan with pleasure");
    ...
    private multiTitFuck(): boolean {
        var holeTotal: number = this.player.totalNipples();
        var fittableCocks: number = this.player.cocks.length;
        var doubleUp: boolean = false;
        //randomize what kind of dick to start with
        var randomCock: number = Masturbation.rand(fittableCocks);
        ...
        if (holeTotal >= fittableCocks) {
            ...
            //How many nips?
            if (holeTotal == 2) this.outputText("your other nipple. ");
            else if (fittableCocks <= 2) this.outputText("one of your other nipples. ");
        }
        ...
        if (fittableCocks > 2 && holeTotal < fittableCocks) {
            ...
            if (this.player.vaginalCapacity() >= 2 * this.player.cockArea(randomCock)) {
                ...
                this.outputText(
                    "Accepting that you can't do anything about it, you start pushing. "
                );
        }
        //How wet/milky is this procedure?
        if (this.player.averageLactation() == 0) {
        ...
        if (Math.round(this.player.cockArea(randomCock)) >= this.player.vaginalCapacity()) {
            ...
            if (this.player.averageVaginalLooseness() < 2)
                ...
                this.outputText(
                    "the engorged and distended openings of your fat, swollen nipples. "
                );
    ...
    private multiNippleFuckPrep(randomCock: number): void {
        ...
        //different based on libido
        if (this.player.lib < 70) this.outputText("Shivering with anticipation, you place the ");
        ...
        if (this.player.lib < 70) this.outputText("against the opening of ");
        else this.outputText("into ");
        //More than one row?
        if (this.player.breastRows.length > 1) {
            if (this.player.averageNipplesPerBreast() > 1) this.outputText("one of the ");
        ...
        if (this.player.breastRows.length > 1) this.outputText(" on one of your lower breasts");
        else if (this.player.averageNipplesPerBreast() > 1) this.outputText("s");
        this.outputText(". ");
    }
    ...
    private orgazmo(selfSucking: boolean, nippleFuck: boolean): void {
        ...
        if (this.player.cocks.length > 0) {
            if (this.player.cocks.length == 1) {
                ...
                if (nippleFuck) this.outputText("deep inside your unnatural breast. ");
                else if (!selfSucking) this.outputText("in the air.  ");
                if (selfSucking) {
    ...
    private titCum(cumQuantity: number = 3): void {
        ...
        if (this.player.averageLactation() >= 2 && !this.player.hasFuckableNipples()) {
            ...
            if (this.player.averageLactation() <= 2.6)
                this.outputText("thin streams of milk spray out of your ");
            if (this.player.averageLactation() > 2.6 && this.player.averageLactation() < 3)
                this.outputText("thick gouts of milk spurt out of your ");
            if (this.player.averageLactation() >= 3)
                this.outputText("huge torrents of milk blast out of your ");
            //different description based on size of nips
            ...
            if (this.player.averageLactation() <= 2.6)
                this.outputText("spattering milk everywhere. ");
            if (this.player.averageLactation() > 2.6 && this.player.averageLactation() < 3)
                this.outputText("covering everything nearby. ");
        ...
        if (this.player.hasFuckableNipples()) {
            ...
            if (this.player.sens < 70)
                this.outputText("moan with ecstacy as your freakishly swollen nipples ");
            if (this.player.sens >= 70)
                this.outputText("scream with ecstacy as your freakishly swollen nipples ");
            //Different description based on wetness
    ...
    private deluxeDildo(): void {
        ...
        if (this.player.hasVagina()) {
            ...
            if (this.player.clitLength < 0.5) this.outputText(" becomes hard and sensitive");
            else if (this.player.clitLength < 3) this.outputText(" peeks through your folds");
    ...
    private onaholeMulticockContinuation(): void {
        ...
        if (this.player.balls > 0) this.outputText("you pass out with aching, empty balls.");
        else
            this.outputText(
    ...
    private onaholeFutaContinuation(): void {
        ...
        this.outputText(
            " As your orgasms fade, you find yourself a well-fucked mess, and pass out."
        );
        this.dynStats("sen", -1);
        this.player.orgasm();
        this.doNext(this.camp.returnToCampUseOneHour);
    ...
    private stimBeltUse(): void {
        ...
        if (this.player.hasKeyItem("Self-Stimulation Belt") >= 0) {
            ...
            if (this.player.findStatusAffect(StatusAffects.used_self_dash_stim) < 0) {
                this.player.createStatusAffect(StatusAffects.used_self_dash_stim, 0, 0, 0, 0);
                this.outputText(
    ...
    private catAutoLick(): void {
        ...
        if (this.flags[kFLAGS.TIMES_AUTOFELLATIO_DUE_TO_CAT_FLEXABILITY] == 0) {
            ...
            if (
                ...
                var gems: number = this.midasCockJackingGemsRoll();
                ...
                if (this.player.cumQ() < 25) this.outputText("sprinkle of");
                else if (this.player.cumQ() < 250) this.outputText("rain of");
        ...
        //[Repeatable]
            ...
            if (
                ...
                var gemsCreated: number = this.midasCockJackingGemsRoll(); //Changed as gems caused a duplicate var warning
    ...
    private dualBeltMasturbation(): void {
        ...
        if (this.player.tailType > TAIL_TYPE_NONE) this.outputText("covering up your tail, ");
        this.outputText(
    ...
    private centaurMasturbation(): boolean {
        this.clearOutput();
        var canMasturbateHugeCock: boolean =
            this.player.hasCock() &&
            this.player.tallness * (5 / 6) <
                this.player.cocks[this.player.longestCock()].cockLength;
        if (this.player.hasFuckableNipples()) {
    ...
    private centaurNippleCunt(): void {
        ...
        this.outputText(
            "  The openings are soft, sensitive, and slick as you ease a fingertip into "
        );
        ...
        if (this.player.hasCock()) {
            if (this.player.cumQ() < 50)
                this.outputText("A small puddle of semen has formed under you, ");
            else if (this.player.cumQ() < 200)
                this.outputText("A decent sized puddle of white seed has formed under you, ");
        ...
        if (this.player.cor > 66) this.outputText("You can't wait to do it again.");
        else if (this.player.cor > 33)
            this.outputText("You're a bit confused by how much you enjoyed the perverse activity.");
        else
            this.outputText(
                "You're horrified at what you're doing to deal with your inner perversions."
            );
        //DONE!
        this.player.orgasm();
        this.dynStats("sen", -0.5);
    ...
    private centaurHugeCock(): void {
        ...
        var primary: number = this.player.longestCock();
        var plural: boolean = this.player.cocks.length > 1;
        this.outputText(
        ...
        if (this.player.cor < 33) this.outputText("Sighing in disappointment and shame, ");
        else if (this.player.cor < 66) this.outputText("Sighing in resignation, ");
        ...
        if (this.player.tallness * 1.5 >= this.player.cocks[this.player.longestCock()].cockLength) {
            ...
            this.outputText(
                ".  It feels so good that you close your eyes and whinny with delight.\n\n"
            );
        ...
        if (this.player.cumQ() < 50) this.outputText("as you finish unloading against it.");
        else if (this.player.cumQ() < 200)
        ...
        if (!plural) this.outputText("member");
        else this.outputText("members");
        if (this.player.hasSheath()) {
            if (plural) this.outputText(" slowly grow limp and slide back inside your sheath.");
            ...
            if (plural) this.outputText(" slowly grow limp, shrinking.");
        ...
        if (this.player.hasVagina()) {
            ...
            if (this.player.hasFuckableNipples()) {
                if (this.player.totalNipples() > 2) this.outputText("All");
                ...
                if (this.player.biggestLactation() < 1) this.outputText("clear");
    ...
    private centaurCantMasturbate(): void {
        if (this.flags[kFLAGS.UNABLE_TO_MASTURBATE_BECAUSE_CENTAUR] == 0) {
            this.outputText(
                "No matter how you twist and turn, you can't reach anywhere close to your "
            );
            if (this.player.hasCock() || this.player.hasVagina()) this.outputText("genitalia");
    ...
    private centaurDudesGetHorseAids(): void {
        ...
        if (this.player.cockArea(x) >= 30) this.outputText("horsecunt");
        ...
        if (
            ...
            if (this.player.cor < 33) {
                ...
                if (this.camp.hasCompanions())
                    this.outputText(", hoping one of your companions sees");
            } else if (this.player.cor < 66)
            ...
            if (this.getGame().shouldraFollower.followerShouldra())
                this.outputText(", with Shouldra's assistance,");
            this.outputText(
            ...
            this.outputText("\n\nYou struggle, ");
            if (this.getGame().shouldraFollower.followerShouldra())
                this.outputText("ghost-assisted ");
            this.outputText(
            ...
            if (this.player.cor < 33) this.outputText("into your bedroll");
            else if (this.player.cor < 66) this.outputText("off behind a rock");
            ...
            if (this.player.cor >= 75) this.outputText("corrupted ");
            ...
            if (!this.player.isTaur()) {
                ...
                if (this.player.balls == 0) this.outputText("swollen belly");
    ...
    public birthBeeEggsOutYourWang(): void {
        ...
        if (this.player.isTaur()) this.outputText("y");
            ...
            if (this.player.balls > 0) this.outputText("them");
            else this.outputText("it");
        ...
        if (this.player.balls == 0) this.outputText("stomach");
        ...
        if (this.player.cor < 50) this.outputText("amused");
    ...
    private layEggsInYerTits(): void {
        ...
        if (
            ...
            if (this.player.hasVagina()) {
                if (this.player.balls > 0) this.outputText("  Behind your [balls], y");
    ...
    private tentacleSelfFuck(): void {
        ...
        if (this.player.wetness() <= 2) this.outputText("moist");
        else if (this.player.wetness() <= 3) this.outputText("wet");
        else if (this.player.wetness() <= 4) this.outputText("sloppy and wet");
        else this.outputText("beyond soaked");
        this.outputText(
            ".  The slick slit is slowly parting as you reach to wrangle the wiggly cock"
        );
        if (this.player.cocks.length > 1) {
            this.outputText(", brushing your hand against your other ");
            if (this.player.lust <= 70) this.outputText("half-hard");
        ...
        if (this.player.balls > 0) this.outputText("  You lift you [balls] out of the way and");
        ...
        if (this.player.hasFuckableNipples())
            this.outputText(", even stuffing a finger inside a sloppy, dripping nipplecunt");
        this.outputText(".");
        ...
        if (this.player.tentacleCocks() >= 3) {
            ...
            if (this.player.tentacleCocks() < this.player.cocks.length)
                this.outputText(" and the open air");
            this.outputText(".");
        ...
        if (this.player.tentacleCocks() >= 3) this.outputText("gurgle");
        ...
        if (this.player.tentacleCocks() >= 3) this.outputText("r multitude of penises");
        this.outputText(
            " thrust deep inside yourself, a volcano of pleasure erupts, pumping thick flows of white goo straight into your snatch"
        );
        if (this.player.tentacleCocks() == 2) this.outputText(" and ass");
        else if (this.player.tentacleCocks() > 2) this.outputText(", ass, and mouth");
        this.outputText(".");
        if (this.player.tentacleCocks() >= 3) {
            this.outputText("  You gulp the salty flow down as best you are able");
            if (this.player.cumQ() >= 500) {
                this.outputText(
                    ".  That doesn't really count for much with how heavy your load is, "
                );
                if (this.player.cumQ() < 1000)
        ...
        if (this.player.tentacleCocks() >= 2)
            this.outputText(", while your [ass]'s interior is painted bright white");
        this.outputText(".");
        if (this.player.tentacleCocks() == 2) {
            this.outputText("  Your untended " + this.cockDescript(y) + " blows spunk over you ");
            if (this.player.cumQ() < 50) this.outputText("in small spurts");
            else if (this.player.cumQ() < 200) this.outputText("in thick ropes");
            else if (this.player.cumQ() < 500) this.outputText("in huge blobs");
            else this.outputText("like a virile sprinkler");
            this.outputText(".");
            if (this.player.cocks.length > 2) {
                this.outputText("  The other one");
                if (this.player.cocks.length > 3) this.outputText("s match");
                else this.outputText(" matches");
                this.outputText(
                    " it in output, even though you haven't done anything to stimulate "
                );
                if (this.player.cocks.length == 3) this.outputText("it");
            ...
            if (this.player.tentacleCocks() == 4) this.outputText("s swell");
            else this.outputText(" swells");
            this.outputText(" in your armpit");
            if (this.player.tentacleCocks() >= 5) this.outputText("s");
            this.outputText(
    ...
    private tentacleGoesUpYerPooperNewsAtEleven(): void {
        ...
        for (var x: number = tentacle + 1; x < this.player.cocks.length; x++) {
        ...
        if (this.player.cumQ() >= 500)
            this.outputText(
                "  Your belly swells a bit from all the semen being packed inside you."
            );
        //[if cum production is massive]
    ...
    private gildedCockTurbate(): void {
        ...
        for (var x: number = gildedCock + 1; x < this.player.cocks.length; x++) {
        ...
        if (this.player.cumQ() < 25) this.outputText("a sprinkle of");
        else if (this.player.cumQ() < 250) this.outputText("a rain of");
    ...
    private dildoButts(): void {
        ...
        if (this.silly())
            this.outputText(", the alliteration of the experience further arousing you");
        this.outputText(
        ...
        if (this.player.hasCock() && this.player.hasVagina())
            ...
            if (this.player.wetness() >= 4) this.outputText("squirt");
    ...
    private midasCockJackingGemsRoll(): number {
        var cockSocks: number = this.player.countCockSocks("gilded");
        var gems: number = 10 + Masturbation.rand(20);
    ...
    private onaholeRepeatUse(corrupted: boolean): void {
        ...
        if (corrupted) {
            ...
            if (gemsCreated > 0) {
                this.outputText(
                    ". You pop the toy from your rod and let your reflexes hump the sky."
                );
                ...
                if (this.player.cumQ() < 25) this.outputText("sprinkle");
                else if (this.player.cumQ() < 250) this.outputText("rain");
