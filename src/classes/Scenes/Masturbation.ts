...
import { TAIL_TYPE_NONE, VAGINA_WETNESS_DROOLING, VAGINA_WETNESS_DRY, VAGINA_WETNESS_NORMAL, VAGINA_WETNESS_SLAVERING, VAGINA_WETNESS_SLICK, VAGINA_WETNESS_WET } from "../../includes/appearanceDefs";
...
export class Masturbation extends BaseContent {
    ...
    public masturbateGo(): void {
        ...
        if (this.player.findStatusAffect(StatusAffects.Exgartuan) >= 0 && this.player.statusAffectv2(StatusAffects.Exgartuan) == 0) {
            if (this.player.isNaga() && Masturbation.rand(2) == 0 && this.player.statusAffectv1(StatusAffects.Exgartuan) == 1)
        ...
        else this.outputText("You strip naked, fondling your naughty bits as you do so and casting seductive looks around, hoping someone or something is nearby to fuck you.\n\n");
        //Tit foreplay
        this.titForeplay();
                ...
                if (this.player.hasFuckableNipples()) {
                    ...
                    if (this.player.dogCocks() > 0) {
                        ...
                        if (this.player.hasFuckableNipples()) {
                            ...
                            nippleFuck = true;
                            autofellatio = true;
                            if (this.player.normalCocks() > 0 || this.player.horseCocks() > 0) this.titFuckSingle();
                        }  //if you only have dogcocks that are too big, no nipple fuck! Otherwise, run normal multiTitFuck
                    }
                    else {
                        nippleFuck = true;
                ...
                if (this.player.hasFuckableNipples()) {
                    ...
                    if (this.player.dogCocks() > 0) {
                        ...
                        if (this.player.hasFuckableNipples()) {
                            ...
                            nippleFuck = true;
                            autofellatio = true;
                            if ((this.player.normalCocks() > 0 || this.player.horseCocks() > 0) && this.player.cocks.length - this.player.dogCocks() == 1) this.titFuckSingle();
    ...
    private genderlessMasturbate(): void {
        ...
        if (this.player.cor < 15)
            ...
            else this.outputText("You strip naked, casting seductive looks around, hoping someone or something is nearby to fuck you.\n\n");
        }
        //Tit foreplay
        this.titForeplay();
        if (this.player.findStatusAffect(StatusAffects.FappedGenderless) < 0) { //first time as a genderless person
    ...
    private orgazmo(selfSucking: boolean, nippleFuck: boolean): void {
        ...
        if (this.player.vaginas.length > 0) {
            ...
            if (this.player.vaginas.length == 1) {
                ...
                //Wet orgasms
                if (this.player.vaginas[0].vaginalWetness == VAGINA_WETNESS_SLAVERING) this.outputText("A veritable gush of fluid explodes from your nethers, pulsing in time with the ripples of your " + this.player.vaginaDescript() + ".  ");
            }
    ...
    private titCum(cumQuantity: number = 3): void {
        ...
        if (this.player.hasFuckableNipples()) {
            ...
            //Different noise based on sensitivity
            if (this.player.sens < 70) this.outputText("moan with ecstacy as your freakishly swollen nipples ");
            if (this.player.sens >= 70) this.outputText("scream with ecstacy as your freakishly swollen nipples ");
            //Different description based on wetness
    ...
    private catAutoLick(): void { //Male cat masturbation
        ...
        //[Repeatable]
            ...
            if (this.player.countCockSocks("gilded") > 0 && this.flags[kFLAGS.GILDED_JERKED] < this.player.countCockSocks("gilded")) {
                ...
                if (this.flags[kFLAGS.TIMES_AUTOFELLATIO_DUE_TO_CAT_FLEXABILITY] > 10 && this.player.balls > 1 && Masturbation.rand(5) == 0) {
    ...
    private dualBeltMasturbation(): void {
        ...
        if (this.player.lib < 30) this.dynStats("lib", .5);
        if (this.player.lib < 50) this.dynStats("lib", .5);
        if (this.player.lib < 60) this.dynStats("lib", .5);
    ...
    private centaurMasturbation(): boolean {
        this.clearOutput();
        var canMasturbateHugeCock: boolean = this.player.hasCock() && (this.player.tallness * (5 / 6) < this.player.cocks[this.player.longestCock()].cockLength);
        if (this.player.hasFuckableNipples()) {
    ...
    private getHugeEggsInCawk(): void {
        ...
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 1 && this.player.statusAffectv2(StatusAffects.Exgartuan) == 0 && this.flags[kFLAGS.TIMES_EGGED_IN_COCK] == 0) {
    ...
    private layEggsInYerTits(): void {
        this.clearOutput();
        if (this.player.statusAffectv1(StatusAffects.Exgartuan) == 2 && this.player.statusAffectv2(StatusAffects.Exgartuan) == 0) {
        ...
        if (this.player.findStatusAffect(StatusAffects.Eggchest) < 0) {
            this.player.createStatusAffect(StatusAffects.Eggchest, 3 + Masturbation.rand(10), 1 + Masturbation.rand(4), 0, 0);
    ...
    private tentacleSelfFuck(): void {
        ...
        else if (this.player.cor < 30) this.outputText("You make sure you are alone and strip naked.\n\n");
        else if (this.player.cor < 60) this.outputText("You happily remove your " + this.player.armorName + ", eager to pleasure yourself.\n\n");
        else if (this.player.cor < 80) this.outputText("You strip naked in an exaggerated fashion, hoping someone might be watching.\n\n");
        else this.outputText("You strip naked, fondling your naughty bits as you do so and casting seductive looks around, hoping someone or something is nearby to fuck you.\n\n");
        ...
        if (y >= 0) this.outputText("  It loops around your " + this.cockDescript(y) + " while you fight with it, strangling the other phallus in tight coils of squeezing, floral friction.");
        ...
        if (this.player.tentacleCocks() >= 3) {
            ...
            if (this.player.tentacleCocks() < this.player.cocks.length) this.outputText(" and the open air");
            this.outputText(".");
        ...
        if (this.player.tentacleCocks() >= 6) {
            ...
            if (this.player.tentacleCocks() >= 7) this.outputText("  They pile in there, really squirming against each other as much as you, frotting against your sweat-slick flesh.  ");
        ...
        if (this.player.tentacleCocks() >= 2) this.outputText(", while your [ass]'s interior is painted bright white");
        this.outputText(".");
        if (this.player.tentacleCocks() == 2) {
    ...
    private tentacleGoesUpYerPooperNewsAtEleven(): void {
        ...
        for (var x: number = tentacle + 1; x < this.player.cocks.length; x++) { //Find the biggest tentacle cock you've got
    ...
    private gildedCockTurbate(): void {
        ...
        for (var x: number = gildedCock + 1; x < this.player.cocks.length; x++) { //Find the biggest gilded cock you've got
