...
export class PerkLib {
    ...
    public static Brawler: PerkType = PerkLib.mk(
        "Brawler",
        "Brawler",
    ...
    */
    ...
    public static Fast: PerkType = PerkLib.mk("Fast", "Fast", "Gains speed 25% faster.");
    public static Lusty: PerkType = PerkLib.mk("Lusty", "Lusty", "Gains lust 25% faster.");
    public static Sensitive: PerkType = PerkLib.mk(
        "Sensitive",
        "Sensitive",
        "Gains sensitivity 25% faster."
    );
    public static Smart: PerkType = PerkLib.mk("Smart", "Smart", "Gains intelligence 25% faster.");
    public static Strong: PerkType = PerkLib.mk("Strong", "Strong", "Gains strength 25% faster.");
    public static Tough: PerkType = PerkLib.mk("Tough", "Tough", "Gains toughness 25% faster.");
    // Female creation perks
    public static BigClit: PerkType = PerkLib.mk(
        "Big Clit",
        "Big Clit",
        "Allows your clit to grow larger more easily and faster."
    );
    public static BigTits: PerkType = PerkLib.mk(
        "Big Tits",
        "Big Tits",
        "Makes your tits grow larger more easily."
    );
    public static Fertile: PerkType = PerkLib.mk(
        "Fertile",
        "Fertile",
        "Makes you 15% more likely to become pregnant."
    );
    public static WetPussy: PerkType = PerkLib.mk(
        "Wet Pussy",
        "Wet Pussy",
        "Keeps your pussy wet and provides a bonus to capacity."
    );
    // Male creation perks
    public static BigCock: PerkType = PerkLib.mk(
        "Big Cock",
        "Big Cock",
        "Gains cock size 25% faster and with less limitations."
    );
    public static MessyOrgasms: PerkType = PerkLib.mk(
        "Messy Orgasms",
        "Messy Orgasms",
    ...
    public static Archmage: PerkType = PerkLib.mk(
        "Archmage",
        "Archmage",
        "[if (player.inte>=75)" +
    ...
    public static ArousingAura: PerkType = PerkLib.mk(
        "Arousing Aura",
        "Arousing Aura",
    ...
    public static Berzerker: PerkType = PerkLib.mk(
        "Berzerker",
        "Berzerker",
        "[if(player.str>=75)" +
    ...
    public static BrutalBlows: PerkType = PerkLib.mk(
        "Brutal Blows",
        "Brutal Blows",
        "[if(player.str>=75)" +
    ...
    public static Channeling: PerkType = PerkLib.mk(
        "Channeling",
        "Channeling",
        "Increases base spell strength by 50%.",
        "You choose the 'Channeling' perk, boosting the strength of your spellcasting!"
    );
    public static CorruptedLibido: PerkType = PerkLib.mk(
        "Corrupted Libido",
        "Corrupted Libido",
    ...
    public static DoubleAttack: PerkType = PerkLib.mk(
        "Double Attack",
        "Double Attack",
        "[if (player.spe<50)" +
    ...
    public static HotBlooded: PerkType = PerkLib.mk(
        "Hot Blooded",
        "Hot Blooded",
    ...
    public static ImmovableObject: PerkType = PerkLib.mk(
        "Immovable Object",
        "Immovable Object",
        "[if(player.tou>=75)" +
    ...
    public static IronMan: PerkType = PerkLib.mk(
        "Iron Man",
        "Iron Man",
    ...
    public static LightningStrikes: PerkType = PerkLib.mk(
        "Lightning Strikes",
        "Lightning Strikes",
        "[if(player.spe>=60)" +
    ...
    public static LungingAttacks: PerkType = PerkLib.mk(
        "Lunging Attacks",
        "Lunging Attacks",
        "[if(player.spe>=75)" +
    ...
    public static Mage: PerkType = PerkLib.mk(
        "Mage",
        "Mage",
        "Increases base spell strength by 50%.",
    ...
    public static Masochist: PerkType = PerkLib.mk(
        "Masochist",
        "Masochist",
    ...
    public static Medicine: PerkType = PerkLib.mk(
        "Medicine",
        "Medicine",
    ...
    public static Nymphomania: PerkType = PerkLib.mk(
        "Nymphomania",
        "Nymphomania",
    ...
    public static Precision: PerkType = PerkLib.mk(
        "Precision",
        "Precision",
    ...
    public static Regeneration: PerkType = PerkLib.mk(
        "Regeneration",
        "Regeneration",
    ...
    public static Regeneration2: PerkType = PerkLib.mk(
        "Regeneration 2",
        "Regeneration 2",
    ...
    public static Resistance: PerkType = PerkLib.mk(
        "Resistance",
        "Resistance",
        "Reduces lust gain by 10%.",
        "You choose the 'Resistance' perk, reducing the rate at which your lust increases by 10%."
    );
    public static Resolute: PerkType = PerkLib.mk(
        "Resolute",
        "Resolute",
        "[if(player.tou>=75)" +
    ...
    public static Runner: PerkType = PerkLib.mk(
        "Runner",
        "Runner",
    ...
    public static Sadist: PerkType = PerkLib.mk(
        "Sadist",
        "Sadist",
    ...
    public static Seduction: PerkType = PerkLib.mk(
        "Seduction",
        "Seduction",
    ...
    public static StrongBack: PerkType = PerkLib.mk(
        "Strong Back",
        "Strong Back",
        "Enables fourth item slot.",
        "You choose the 'Strong Back' perk, enabling a fourth item slot."
    );
    public static StrongBack2: PerkType = PerkLib.mk(
    ...
    public static Tactician: PerkType = PerkLib.mk(
        "Tactician",
        "Tactician",
        "[if(player.inte>=50)" +
    ...
    public static WeaponMastery: PerkType = PerkLib.mk(
        "Weapon Mastery",
        "Weapon Mastery",
        "[if(player.str>60)" +
    ...
    public static WellAdjusted: PerkType = PerkLib.mk(
        "Well Adjusted",
        "Well Adjusted",
    ...
    // Needlework perks
    public static ChiReflowAttack: PerkType = PerkLib.mk(
        "Chi Reflow - Attack",
        "Chi Reflow - Attack",
        "Regular attacks boosted, but damage resistance decreased."
    );
    public static ChiReflowDefense: PerkType = PerkLib.mk(
        "Chi Reflow - Defense",
        "Chi Reflow - Defense",
        "Passive damage resistance, but caps speed"
    );
    public static ChiReflowLust: PerkType = PerkLib.mk(
        "Chi Reflow - Lust",
        "Chi Reflow - Lust",
        "Lust resistance and Tease are enhanced, but Libido and Sensitivity gains increased."
    );
    public static ChiReflowMagic: PerkType = PerkLib.mk(
        "Chi Reflow - Magic",
        "Chi Reflow - Magic",
        "Magic attacks boosted, but regular attacks are weaker."
    );
    public static ChiReflowSpeed: PerkType = PerkLib.mk(
        "Chi Reflow - Speed",
        "Chi Reflow - Speed",
    ...
    public static PiercedFurrite: PerkType = PerkLib.mk(
        "Pierced: Furrite",
        "Pierced: Furrite",
        "Increases chances of encountering 'furry' foes."
    );
    public static PiercedLethite: PerkType = PerkLib.mk(
        "Pierced: Lethite",
        "Pierced: Lethite",
    ...
    // Armor perks
    public static BloodMage: PerkType = PerkLib.mk(
        "Blood Mage",
        "Blood Mage",
    ...
    // Achievement perks
    public static BroodMother: PerkType = PerkLib.mk(
        "Brood Mother",
        "Brood Mother",
    ...
    public static BimboBrains: PerkType = PerkLib.mk(
        "Bimbo Brains",
        "Bimbo Brains",
    ...
    public static BroBody: PerkType = PerkLib.mk(
        "Bro Body",
        "Bro Body",
        "Grants an ubermasculine body that's sure to impress."
    );
    public static BroBrains: PerkType = PerkLib.mk(
        "Bro Brains",
        "Bro Brains",
        "Makes thou... thin... fuck, that shit's for nerds."
    );
    public static BunnyEggs: PerkType = PerkLib.mk(
        "Bunny Eggs",
        "Bunny Eggs",
        "Laying eggs has become a normal part of your bunny-body's routine."
    );
    public static CorruptedNinetails: PerkType = PerkLib.mk(
    ...
    public static Diapause: PerkType = PerkLib.mk(
        "Diapause",
        "Diapause",
        "Pregnancy does not advance normally, but develops quickly after taking in fluids."
    );
    public static Dragonfire: PerkType = PerkLib.mk(
        "Dragonfire",
        "Dragonfire",
        "Allows access to a dragon breath attack."
    );
    public static EnlightenedNinetails: PerkType = PerkLib.mk(
