define(["require", "exports", "./internals/Utils", "./CoC", "./Appearance", "../console"], function (require, exports, Utils_1, CoC_1, Appearance_1, console_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class BreastStore extends Utils_1.Utils {
        constructor(breastFlag) {
            super();
            this._cupSize = 0;
            ...
            if (this._breastFlag < 1 || this._breastFlag > BreastStore.MAX_FLAG_VALUE)
                console_1.trace("Error: BreastStore created with invalid flag value. BreastStore(" + breastFlag + ")");
        }
        //Implementation of SaveAwareInterface
        updateAfterLoad(game) {
            if (this._breastFlag < 1 || this._breastFlag > BreastStore.MAX_FLAG_VALUE)
                return;
            var flagData = String(game.flags[this._breastFlag]).split("^");
        ...
        static breastDescript(size, lactation = 0) {
            if (size < 1)
                return "flat breasts";
            var descript = (BreastStore.rand(2) == 0 ? Appearance_1.Appearance.breastSize(size) : ""); //Add a description of the breast size 50% of the time
        ...
        get cupSize() { return this._cupSize; }
        set cupSize(value) {
            if (value < CoC_1.CoC.BREAST_CUP_FLAT)
                value = CoC_1.CoC.BREAST_CUP_FLAT;
            if (value > CoC_1.CoC.BREAST_CUP_ZZZ_LARGE)
                value = CoC_1.CoC.BREAST_CUP_ZZZ_LARGE;
            this._cupSize = value;
        }
        get lactationLevel() { return this._lactation; }
        set lactationLevel(value) {
        ...
        adj() {
            switch (this._cupSize) {
                case CoC_1.CoC.BREAST_CUP_FLAT: return "non-existent";
                case CoC_1.CoC.BREAST_CUP_A: return "small";
                case CoC_1.CoC.BREAST_CUP_B:
                case CoC_1.CoC.BREAST_CUP_C: return "palmable";
                case CoC_1.CoC.BREAST_CUP_D:
                case CoC_1.CoC.BREAST_CUP_DD:
                case CoC_1.CoC.BREAST_CUP_DD_BIG: return "sizeable";
                case CoC_1.CoC.BREAST_CUP_E:
                case CoC_1.CoC.BREAST_CUP_E_BIG:
                case CoC_1.CoC.BREAST_CUP_EE:
                case CoC_1.CoC.BREAST_CUP_EE_BIG:
                case CoC_1.CoC.BREAST_CUP_F:
                case CoC_1.CoC.BREAST_CUP_F_BIG:
                case CoC_1.CoC.BREAST_CUP_FF:
                case CoC_1.CoC.BREAST_CUP_FF_BIG: return "huge";
                case CoC_1.CoC.BREAST_CUP_G:
                case CoC_1.CoC.BREAST_CUP_G_BIG:
                case CoC_1.CoC.BREAST_CUP_GG:
                case CoC_1.CoC.BREAST_CUP_GG_BIG:
                case CoC_1.CoC.BREAST_CUP_H:
                case CoC_1.CoC.BREAST_CUP_H_BIG:
                case CoC_1.CoC.BREAST_CUP_HH:
                case CoC_1.CoC.BREAST_CUP_HH_BIG:
                case CoC_1.CoC.BREAST_CUP_I:
                case CoC_1.CoC.BREAST_CUP_I_BIG:
                case CoC_1.CoC.BREAST_CUP_II:
                case CoC_1.CoC.BREAST_CUP_II_BIG: return "gigantic";
                case CoC_1.CoC.BREAST_CUP_J:
                case CoC_1.CoC.BREAST_CUP_J_BIG:
                case CoC_1.CoC.BREAST_CUP_JJ:
                case CoC_1.CoC.BREAST_CUP_JJ_BIG:
                case CoC_1.CoC.BREAST_CUP_K:
                case CoC_1.CoC.BREAST_CUP_K_BIG:
                case CoC_1.CoC.BREAST_CUP_KK:
                case CoC_1.CoC.BREAST_CUP_KK_BIG:
                case CoC_1.CoC.BREAST_CUP_L:
                case CoC_1.CoC.BREAST_CUP_L_BIG:
                case CoC_1.CoC.BREAST_CUP_LL:
                case CoC_1.CoC.BREAST_CUP_LL_BIG:
                case CoC_1.CoC.BREAST_CUP_M:
                case CoC_1.CoC.BREAST_CUP_M_BIG:
                case CoC_1.CoC.BREAST_CUP_MM:
                case CoC_1.CoC.BREAST_CUP_MM_BIG:
                case CoC_1.CoC.BREAST_CUP_MMM:
                case CoC_1.CoC.BREAST_CUP_MMM_LARGE: return "mammoth";
                default:
            }
            return ("titanic");
        }
        canTitFuck() { return this._cupSize >= CoC_1.CoC.BREAST_CUP_C; }
        cup() { return Appearance_1.Appearance.breastCup(this._cupSize); } //The cup size alone
        description(useAdj = false, isMale = false) {
            if (this._cupSize == CoC_1.CoC.BREAST_CUP_FLAT)
        ...
        hasBreasts() { return this._cupSize != CoC_1.CoC.BREAST_CUP_FLAT; }
        lactating() { return this._lactation >= BreastStore.LACTATION_LIGHT; }
        milked() {
            this._fullness = 0;
            this._timesMilked++;
        ...
        milkIsFull() { return (this._lactation <= BreastStore.LACTATION_NONE ? false : this._fullness >= 50); }
        milkIsOverflowing() {
        ...
        nippleDescript(tiny = "tiny", small = "prominent", large = "large", huge = "elongated", massive = "massive") {
        ...
        get nippleLength() { return this._nippleLength; }
        set nippleLength(value) {
            if (value < 0)
                value = 0;
    ...
    BreastStore.MAX_FLAG_VALUE = 2999;
    BreastStore.BREAST_STORE_VERSION_1 = "1";
    BreastStore.LACTATION_BOOST = [0, 0, 2, 3, 6, 9, 17]; //Disabled, None, Light, Moderate, Strong, Heavy, Epic
    ...
    exports.BreastStore = BreastStore;
});
//# sourceMappingURL=BreastStore.js.map