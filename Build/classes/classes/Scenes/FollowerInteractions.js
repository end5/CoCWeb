define(["require", "exports", "./NPCs/NPCAwareContent", "../GlobalFlags/kFLAGS", "../StatusAffects", "../Items/WeaponLib", "../GlobalFlags/kGAMECLASS", "../PerkLib"], function (require, exports, NPCAwareContent_1, kFLAGS_1, StatusAffects_1, WeaponLib_1, kGAMECLASS_1, PerkLib_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class FollowerInteractions extends NPCAwareContent_1.NPCAwareContent {
        //[Amily meets pure Jojo - ]
        amilyMeetsPureJojo() {
            //set flag for amily met pure jojo
            this.flags[kFLAGS_1.kFLAGS.AMILY_MET_PURE_JOJO]++;
        ...
        pureJojoAndAmilySpar() {
            this.outputText("", true);
            this.flags[kFLAGS_1.kFLAGS.AMILY_SPAR_WITH_PURE_JOJO]++;
        ...
        amilyIsPissedAtYouForRuiningJojo() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.AMILY_PISSED_PC_CORRUPED_JOJO]++;
            ...
            //[Fix him] [Fuck off]
            this.simpleChoices("Fix Him", this.agreeToHelpAmilyFixJojo, "Fuck Off", this.tellAmilyToFuckOffRuinedJojo, "", undefined, "", undefined, "", undefined);
        }
        ...
        agreeToHelpAmilyFixJojo() {
            ...
            if (this.player.cor < 33)
                this.outputText("feeling genuinely sorry for what you've done.");
            else if (this.player.cor < 66)
                this.outputText("unsure if you're making the right choice.");
            else
                this.outputText("wondering if this will wind up as an empty promise to placate the angry mouse-cunt.");
            ...
            this.flags[kFLAGS_1.kFLAGS.AMILY_WAIT_FOR_PC_FIX_JOJO] = 1;
            this.doNext(this.playerMenu);
        }
        ...
        fixJojoOOOOHYEEEEAHSNAPINTOASLIMJIM() {
            ...
            if (this.player.cor > 66)
                this.outputText("already regretting your choice", false);
            else if (this.player.cor > 33)
                this.outputText("a little confused by the whole situation", false);
            else
                this.outputText("glad the damage you did to Jojo wasn't permanent", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.AMILY_BLOCK_COUNTDOWN_BECAUSE_CORRUPTED_JOJO] = 4;
            //Amily fuckable again
            this.flags[kFLAGS_1.kFLAGS.AMILY_WAIT_FOR_PC_FIX_JOJO] = 0;
            //Jojo 'fixed'
            this.flags[kFLAGS_1.kFLAGS.JOJO_FIXED_STATUS] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[Find note from jojo @ followers menu after pufying him]
        findJojosNote() {
            this.flags[kFLAGS_1.kFLAGS.JOJO_FIXED_STATUS] = 2;
            this.outputText("", true);
        ...
        amilyDiscoversJojoWithTentaclesAndShitOhBoy() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.AMILY_DISCOVERED_TENTATLE_JOJO]++;
            ...
            if (this.player.cor > 66) {
                ...
                //Follower off
                this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] = 0;
                this.outputText("No doubt she ran back to the ruins.  Perhaps you could gather some appropriate drugs to teach her a lesson?", false);
                if (this.player.inte >= 45)
            ...
            //Else: 
                ...
                //[Corrupt/Choose Jojo]
                this.simpleChoices("Explain", this.aerisDies, "Flip Bird", this.AmilyLeavesBirdJojoTentacles, "", undefined, "", undefined, "", undefined);
            }
        }
        ...
        aerisDies() {
            ...
            //[Stop Her] [Let Her]
            this.simpleChoices("Stop Her!", this.stopJojoDeathInTheNameOfLove, "Let Her", this.whyWouldDoThis, "", undefined, "", undefined, "", undefined);
        }
        ...
        AmilyIntroducesSelfToRathazul() {
            this.outputText("", true);
            this.flags[kFLAGS_1.kFLAGS.AMILY_MET_RATHAZUL]++;
            ...
            //(+5 lust!)/
            this.dynStats("lus", 5);
            this.doNext(kGAMECLASS_1.kGAMECLASS.rathazul.returnToRathazulMenu);
        }
        ...
        amilyIngredientDelivery() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_NOT_FURRY] == 1)
                ...
                this.outputText("blur of fur whizzes past you", false);
        ...
        amilyAsksAboutRathazulsVillage() {
            ...
            this.outputText("Amily nods solemnly and says her farewells.  She looks a little bleary-eyed as you pass her, and you give her a comforting squeeze on the shoulder.   The mouse gives you a tight smile and continues away, leaving you alone with the rat.", false);
            this.doNext(kGAMECLASS_1.kGAMECLASS.rathazul.returnToRathazulMenu);
        }
        //[Rathazul and Corrupt/Tentacle Jojo] – Occurs instead of camp
        rathazulFreaksOverJojo() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.RATHAZUL_CORRUPT_JOJO_FREAKOUT]++;
            ...
            this.simpleChoices("Mine", this.tellRathazulYouOwnJojo, "Handle It", this.tellRathazulYouCanHandleIt, "Harmless", this.TellRathazulJojoIsHarmless, "", undefined, "", undefined);
        }
        //	[Jojo is yours]
        ...
        jojoOffersRathazulMeditation() {
            this.outputText("", true);
            this.flags[kFLAGS_1.kFLAGS.JOJO_RATHAZUL_INTERACTION_COUNTER]++;
        ...
        catchRathazulNapping() {
            ...
            this.outputText("The mouse quietly rises and walks a fair distance away from the sleeping rat, letting his elder rest.  He motions for you to follow and leave Rathazul in peace.", false);
            //[NEXT – to normal jojo]
            this.doNext(this.jojoScene.jojoCamp);
        }
        marbleVsAmilyFreakout() {
            this.outputText("", true);
            this.flags[kFLAGS_1.kFLAGS.AMILY_NOT_FREAKED_OUT]++;
            //Marble is in camp first
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_OR_AMILY_FIRST_FOR_FREAKOUT] <= 1)
                this.outputText("As you bring Amily into your camp, you see Marble look towards you with a smile for a moment, before that smile turns into a frown.  You realize that this might not have been such a good idea...\n\n", false);
            ////Amily is in camp first
            else
                this.outputText("As you bring Marble back to your camp, you see Amily sitting there as Marble asks while frowning, \"<i>Sweetie, who is that?</i>\"  Uh-oh, this could get bad.\n\n", false);
            //After either
            ...
            this.simpleChoices("StaySilent", this.marbleIsPissyAndYourTooDumbToTalk, "Pimp", this.beAPimpMarbleLovesIt, "Explain", this.LucyYouGotSomeSplainingToDo, "", undefined, "", undefined);
        }
        ...
        marbleIsPissyAndYourTooDumbToTalk() {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] > 0) {
        ...
        beAPimpMarbleLovesIt() {
            this.outputText("", true);
            //Pimp (B1)
            this.outputText("You look at both of them in the eyes in turn before replying, \"<i>Come on girls, there is plenty of me to go around!</i>\"  ", false);
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0) {
                ...
                this.simpleChoices("StaySilent", this.marbleIsPissyAndYourTooDumbToTalk, "Explain", this.LucyYouGotSomeSplainingToDo, "", undefined, "", undefined, "", undefined);
            }
            //Pimp -> PC is not addicted (B3)
                ...
                this.simpleChoices("Serious", this.srslyPimpinGuyz, "Joking", this.jokeAboutPimpularness, "", undefined, "", undefined, "", undefined);
            }
        }
        ...
        srslyPimpinGuyz() {
            ...
            this.outputText("You wake up several hours later to find that neither of the two girls are still around, your camp is in shambles, and most of your equipment is gone.  After looking around camp, you realize that all of your expendable items, gems, and even your weapons and armor have been taken.  All that is left is a suit of comfortable clothes that you put on.  You also find a note in a rough script that says: <i>This is what you get for being an asshole.</i>  Those damn bitches.", false);
            this.player.gems = 0;
        ...
        jokeAboutPimpularness() {
            this.outputText("", true);
            this.outputText("You assure them that you thought a joke might help them calm down.  The two of them seem to disagree with you on that sentiment, but wait for you to say something else.", false);
            //Player chooses stay silent (A1) or explain (C1)
            this.simpleChoices("StaySilent", this.marbleIsPissyAndYourTooDumbToTalk, "Explain", this.LucyYouGotSomeSplainingToDo, "", undefined, "", undefined, "", undefined);
        }
        LucyYouGotSomeSplainingToDo() {
            this.outputText("", true);
            //Explain (C1)
            this.outputText("You spend some time trying to explain to the two of them why you never told either of them about each other.  ", false);
            ...
            //Explain -> fail (C3)
                ...
                if (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0) {
                    this.outputText("Since you need Marble's milk to live, there's no way you can blame her.  It would be tantamount to suicide.", false);
                    blameMarble = undefined;
                }
                //Player chooses stay silent (A1), blame Marble (C4), blame Amily (C5)
                this.simpleChoices("StaySilent", this.marbleIsPissyAndYourTooDumbToTalk, "BlameMarble", blameMarble, "BlameAmily", this.blameAmilysDumbMouseCunt, "", undefined, "", undefined);
                return;
            }
        }
        ...
        BlameMarblezSweetVagoozle() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] == 1)
                this.outputText("and child", false);
            else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] > 1)
                this.outputText("and her children", false);
        ...
        amilyUrtaReaction() {
            ...
            this.outputText("Amily bounds out of camp before you can react, sniffling as she disappears into the distance. She's lost to sight almost immediately thanks to the properties of this accursed landscape.", false);
            this.flags[kFLAGS_1.kFLAGS.AMILY_VISITING_URTA] = 1;
            this.flags[kFLAGS_1.kFLAGS.AMILY_NEED_TO_FREAK_ABOUT_URTA] = 0;
            this.doNext(this.playerMenu);
        ...
        askAboutAmily() {
            ...
            if (this.model.time.hours > 14) {
                ...
                this.doNext(kGAMECLASS_1.kGAMECLASS.telAdre.barTelAdre);
                return;
            }
            //before Urta goes on duty at 1400:
            else {
                this.outputText("You ask the assembled bar patrons if anybody has seen either a strange mouse-woman or Urta around. The sparse morning crowd points, virtually as one, toward the back rooms. As you aproach, you hear a thumping, banging commotion coming from one of the rooms...\n\n", false);
                ...
                this.outputText("Curious, you ease open the door.  Inside, you see Urta and Amily, both naked, sitting on one of the cushioned couches along the wall.  Well, Urta is sitting there; Amily is perched in her lap, Urta's girthy prick visibly stuffed into her folds, with", false);
                if (this.flags[kFLAGS_1.kFLAGS.AMILY_WANG_LENGTH] > 0)
                    this.outputText(" her " + this.amilyScene.amilyCock() + " half-erect and drooling pre and", false);
                this.outputText(" her stomach swollen from the fox-morph's prodigious cum output to the point she looks ", false);
                if (this.amilyScene.pregnancy.event >= 3)
                    this.outputText("almost twice as ", false);
                ...
                this.outputText("Do you leave them to get acquainted (and possibly be up for threesomes in the future), or do you barge in and stop these cheating sluts?", false);
                //[Leave Them (finishes as normal] [Interrupt]
                this.simpleChoices("Leave Them", this.askAboutAmilyPt2, "Interrupt", this.cheatingSloots, "", undefined, "", undefined, "", undefined);
            }
        }
        askAboutAmilyPt2() {
            this.outputText("", true);
            ...
            this.outputText("With a soft sigh, you shut the door and leave them to sleep it off.  While you can't predict that they will be quite so magnanimous about all this when they wake up, right now, it looks like neither of them is inclined to declare war over you.", false);
            this.dynStats("lus", 75);
            this.doNext(this.camp.returnToCampUseOneHour);
            //Progress to next stage!
            this.flags[kFLAGS_1.kFLAGS.AMILY_VISITING_URTA] = 2;
            //Tag that Urta needs to freak out!
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00350] = 1;
        }
        cheatingSloots() {
            this.outputText("", true);
            ...
            this.outputText("Well, the mouse may have a point.  You could let them get to know each other and perhaps turn this into a threesome down the road, or you could put a firm end to it right now.  There's a pretty good chance putting your boot down on this might piss off one of them.", false);
            //[Let Them Be] [End It]
            this.simpleChoices("Let It Be", this.letTheSlootsFuck, "End It", this.endThisMadness, "", undefined, "", undefined, "", undefined);
        }
        letTheSlootsFuck() {
            this.outputText("", true);
            this.outputText("You chuckle and tell them you understand, though they had better include you in the future.  Drunken relief spreads across their faces when you give them a wink and step out.  Soon you hear the sloppy sounds of sex and giggles about how great their lover is.", false);
            this.dynStats("lus", 75);
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        amilyUrtaMorningAfter() {
            ...
            this.simpleChoices("Be Nice", this.smileAndNodToAmilyXUrta, "Be A Dick", this.beADickToAmily, "", undefined, "", undefined, "", undefined);
        }
        //[Be totally a dick]
        beADickToAmily() {
            this.outputText("", true);
            ...
            this.outputText("With that, Amily grabs her gear closest to hand and pushes past you with the best flounce she can manage, heading toward the desert.", false);
        ...
        amilyUrtaSex() {
            ...
            if (this.player.cor > 50 && this.flags[kFLAGS_1.kFLAGS.AMILY_WANG_LENGTH] > 0)
                this.outputText("  Privately, you note that it's bullshit; she's nothing <b>but</b> self-pity.", false);
            this.outputText("\n\n", false);
            this.outputText("With a gesture, the two of you set off.  As soon as you pass through the gates, you head towards the Wet Bitch.  Sure enough, Urta is at her usual table, and she smiles in delight to see you.  \"<i>" + this.player.short + ", Amily, hello!</i>\"  You take seats at the same table, as she ", false);
            if (!this.urtaLove())
                this.outputText("blushes softly at the clunk of her erection against the table", false);
            else
                this.outputText("turns sideways to let her dress tent without banging into the table", false);
            this.outputText(".\n\n", false);
            ...
            this.outputText("Once the three of you are in a empty room, you lock the door behind you as Urta and Amily both strip down, eyeing each other and you with equal attention.  \"<i>So... are you going to partake?  Or just watch?</i>\" Amily asks, hesitantly.", false);
            //Watch (only game in town for now, so suppress the choice buttons and route right to this)
            var dick = undefined;
            var vag = undefined;
            if (this.player.hasVagina())
                vag = this.amilyScene.urtaXAmilyCuntPussyVagSQUICK;
            if (this.player.hasCock())
                dick = this.amilyScene.threesomeAmilUrtaCAWKS;
            this.simpleChoices("Use Dick", dick, "Use Vag", vag, "", undefined, "", undefined, "Watch", this.amilyUrtaSexWatch);
        }
        amilyUrtaSexWatch() {
            this.outputText("", true);
            ...
            this.outputText("Urta groans, unable to resist groping Amily's " + this.amilyScene.amilyTits() + ".  \"<i>Let me sit down, first, squeaky; I've never been one for sex while standing up</i>\".  She slowly lowers herself to the ground and then pulls Amily down into her lap, idly grinding her mare-cock against Amily's torso", false);
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_WANG_LENGTH] > 0)
                this.outputText(", up the underside of her penis,", false);
            this.outputText(" and between her " + this.amilyScene.amilyTits() + ".\n\n", false);
            this.outputText("Amily slides her cleavage down Urta's length to gently give her flared tip a small lick, before rising", false);
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_WANG_LENGTH] > 0)
                this.outputText(", a bead of pre-cum stretching into a line connecting their two members", false);
            ...
            this.outputText("By this point, you are feeling very turned on indeed, but you can't bring yourself to disturb them.  Instead, you simply grin again and leave them to recover.", false);
            this.dynStats("lus", 50);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
    }
    exports.FollowerInteractions = FollowerInteractions;
});
//# sourceMappingURL=FollowerInteractions.js.map