define(["require", "exports", "./NPCAwareContent", "../../GlobalFlags/kFLAGS", "./Holli", "../../PerkLib", "../../StatusAffects", "../../../console", "../../PregnancyStore", "../../CockTypesEnum", "../../../../includes/appearanceDefs"], function (require, exports, NPCAwareContent_1, kFLAGS_1, Holli_1, PerkLib_1, StatusAffects_1, console_1, PregnancyStore_1, CockTypesEnum_1, appearanceDefs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class HolliScene extends NPCAwareContent_1.NPCAwareContent {
        //VARS
        ...
        /*Plant Sprout Notes:
            ...
            */
        fightHolli() {
            this.flags[kFLAGS_1.kFLAGS.FOUGHT_HOLLI] = 1;
            this.startCombat(new Holli_1.Holli());
        }
        treeMenu(output = true) {
            if (output)
                this.clearOutput();
            var ride = undefined;
            var fuck = undefined;
            var burnIt = undefined;
            if (this.flags[kFLAGS_1.kFLAGS.FOUGHT_HOLLI] > 0) {
                //If You Fight, Run, and Come Back To Her in the Menu -Z
                this.outputText("The demon tree is still here, and the face peeking from it still stares daggers at you even from a distance.  It looks like forgiveness won't be forthcoming.");
                ...
                if (output) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.HOLLI_SUBMISSIVE] == 1) {
                        this.outputText("\n\n\"<i>Welcome back, [name].  ");
                        if (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_FLOWER] > 0 && HolliScene.rand(3) == 0)
                            this.outputText("Did you want to fertilize me again?  My flower is ready and waiting...");
                        else if (this.flags[kFLAGS_1.kFLAGS.TIMES_RIDDEN_FLOWER] > 0 && HolliScene.rand(3) == 0)
                            this.outputText("Did you want to use my tentacles again?  They've been restless without you...");
                        else if (HolliScene.rand(2) == 0)
                            this.outputText("Did you come for a drink?  I've built up lots of nectar for you.  Surely, a sip would be refreshing for you...");
                        else
                            this.outputText("How may I serve you?  Come, give me a command so that I can fulfill it for you.");
                        this.outputText("</i>\"");
                    }
                    else {
                        this.outputText("\n\n\"<i>Welcome back, [name].  ");
                        if (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_FLOWER] > 0 && HolliScene.rand(3) == 0)
                            this.outputText("Did you want to fertilize me again?  Gardening is such exhausting work, but so rewarding...");
                        else if (this.flags[kFLAGS_1.kFLAGS.TIMES_RIDDEN_FLOWER] > 0 && HolliScene.rand(2) == 0)
                            this.outputText("Did you come back to play again?  My tentacles are so restless.");
                        else if (HolliScene.rand(2) == 0)
                            this.outputText("Did you come for a drink?  I've built up lots of nectar for you.  Surely a hungry adventurer like yourself needs a sip, right?");
                        else
                            this.outputText("Do you want to play?  Come on, taste Mother Marae's finest creation.");
                        this.outputText("</i>\"");
                    }
                    //Extra line on description:  
                    if (this.flags[kFLAGS_1.kFLAGS.HOLLI_FRUIT] > 0) {
                        if (this.flags[kFLAGS_1.kFLAGS.HOLLI_FRUIT] == 1)
                            this.outputText("\n\nA large, purple fruit hangs from Holli's branches, twisting softly in the breeze.  It looks succulent and ripe.");
                        else
                            this.outputText("\n\n" + HolliScene.Num2Text(this.flags[kFLAGS_1.kFLAGS.HOLLI_FRUIT]) + " large, purple fruits hang from Holli's branches, twisting softly in the breeze.  They look succulent and ripe.");
                        //Optional Addition: 
                        if (this.flags[kFLAGS_1.kFLAGS.HOLLI_FRUIT_EXPLAINED] > 0)
                            this.outputText("  A very small, strange part of you actually feels proud to have made something like that with the tree-woman.");
                    }
                }
                if (this.flags[kFLAGS_1.kFLAGS.HOLLI_SUBMISSIVE] == 0) {
                    var eat = undefined;
                    if (this.flags[kFLAGS_1.kFLAGS.HOLLI_FRUIT] > 0)
                        eat = this.eatHolliFruit;
                    if (this.player.hasCock() && this.player.lust >= 33)
                        fuck = this.fuckHolliInZeFlowerPuss;
                    if (this.player.hasVagina() && this.player.lust >= 33)
                        ride = this.level4RideHollisTentacruels;
                    var guardT = "";
                    if (this.flags[kFLAGS_1.kFLAGS.HOLLI_DEFENSE_ON] == 1)
                        guardT = "Stop Guarding";
                    else
                        guardT = "Guard Camp";
                    burnIt = this.askHolliToWatch;
                    //[Fuck Her] [Drink] [Tentacle Ride] {Guard Camp} {Threaten} [Leave]
                    this.choices("Fuck Holli", fuck, "Drink Sap", this.haveAMapleSyrupSnack, "Ride Tentacles", ride, guardT, burnIt, "Eat A Fruit", eat, "", undefined, "", undefined, "", undefined, "", undefined, "Leave", this.inventory.inventoryMenu);
                }
                else {
                    this.menu();
                    if (this.player.hasCock() && this.player.lust >= 33)
                        this.addButton(0, "Fuck Holli", this.holliGetsDickDommed);
                    if (this.player.tentacleCocks() >= 10 && this.player.lust >= 33)
                        this.addButton(1, "TentacleBone", this.fullOnTentacleTasticGangBangForHolli);
                    if (this.player.hasVagina() && this.player.lust >= 33)
                        this.addButton(2, "Ride Holli", this.vaginalDomHollisTentacruels);
                    this.addButton(3, "Drink Sap", this.haveAMapleSyrupSnack);
                    if (this.flags[kFLAGS_1.kFLAGS.HOLLI_FRUIT] > 0)
                        this.addButton(4, "Eat A Fruit", this.eatHolliFruit);
                    this.addButton(5, "Guarding", this.askBrokenHolliToGuard);
                    this.addButton(9, "Leave", this.inventory.inventoryMenu);
                }
                if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_HOLLI] == 0 && this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_STARTED] == 1)
                    this.addButton(6, "Farm Help", this.helpWithFarm);
            }
        }
        helpWithFarm() {
            this.clearOutput();
            this.outputText("You ask if a plant goddess might not be able to help the farm you recently acquired.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HOLLI_FUCKED_TODAY] == 0) {
        ...
        noPlzDontFuckWithFarm() {
            this.clearOutput();
            this.outputText("“<i>Such a fickle mortal,</i>” she sighs. “<i>But I am a kind goddess. Ask me for it anytime, assuming you’ve... performed the rites.</i>”");
            this.treeMenu(false);
        }
        fertilizeHolli(cock = true) {
            ...
            if (cock && this.player.hasCock()) {
                ...
                if (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftStud) >= 0)
                    odds += 10;
                if (this.player.findPerk(PerkLib_1.PerkLib.FerasBoonAlpha) >= 0)
                    odds += 10;
                if (this.player.findPerk(PerkLib_1.PerkLib.ElvenBounty) >= 0)
                    odds += 2;
            }
            if (!cock && this.player.hasVagina()) {
                odds += this.player.totalFertility() / 5;
                if (odds > 40)
                    odds = 40;
                if (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftFertility) >= 0)
                    odds += 10;
                if (this.player.findPerk(PerkLib_1.PerkLib.FerasBoonBreedingBitch) >= 0)
                    odds += 10;
                if (this.player.findPerk(PerkLib_1.PerkLib.ElvenBounty) >= 0)
                    odds += 2;
            }
            if (odds >= HolliScene.rand(101)) {
                this.flags[kFLAGS_1.kFLAGS.HOLLI_FRUIT] += 1 + HolliScene.rand(Math.floor(odds / 10));
                console_1.trace("Holli pregged!");
            }
        }
        //Sprout Phase: (edited)
        getASprout() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.CORRUPT_MARAE_FOLLOWUP_ENCOUNTER_STATE] == 2)
                this.outputText("  She even promised to plant a tree in your camp...");
            this.outputText("  You look closer and see purple veins on the undersides of the leaves, throbbing with what can only be the tainted liquids that suffuse much of this planet.  Fully grown, it might spread its corruption to your camp.\n\n<b>Do you destroy it?</b>");
            this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_LEVEL] = 1;
            this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] = 0;
            //[Yes] [No]
        ...
        destroyDatFukkinTree() {
            ...
            //(-5 corruption)
            this.dynStats("cor", -5);
            this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_KILLED] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[No] (edited)
        ...
        fuckPlantGrowsToLevel2() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_LEVEL] = 2;
            this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] = 0;
            this.outputText("The sound of creaking, snapping vines draws your attention to the corner of your camp, where the small plant had grown.  You rush in that direction without delay, raising your [weapon] in case you need to fight.  The violent noises die away before you can round the last large stone in the intervening distance, leaving you to wonder just what transpired.  Well, you don't have to wait long - you come around the obstruction at top speed, skidding to a stop at the view before you.");
            ...
            if (this.player.gender == 0)
                this.outputText("  Sucks to be it!  You don't waste time with stupid shit, like genitals.");
            this.outputText("  Is this Marae's idea of a gift?");
            if (this.player.gender > 0)
                this.outputText("  Well, you could give it a whirl... just being around it seems to slowly turn you on.");
            this.outputText("  Of course, destroying it would be the safest option.");
        ...
        fuckFuckingFuckFlowerP2() {
            ...
            this.outputText(" and form a sticky puddle.  Now moaning, you grab the stem and start to pump the sheath up and down, using the plant like the cock-toy it was meant to be.  Lewd, wet squishes ring out through the air,");
            if (this.player.cor < 33)
                this.outputText(" and you timidly look around, hoping you haven't attracted an audience.");
            else if (this.player.cor < 66)
                this.outputText(" and you worriedly glance around, hoping yet terrified that someone will walk in on it.");
            else
                this.outputText(" and you glance around, hoping someone will walk in on the sexy show you're making.");
            this.outputText("\n\nNow panting with unbearable lust and undeniable levels of pleasure, you give up all sense of propriety and resort to fucking wildly, [hips] jumping inches into the air.  The flower's interior is a slick, silky heaven for your " + this.cockDescript(x) + ", a sucking, squeezing hole of seemingly infinite pleasure.  Inside its gluttonous gullet, the numerous tentacles twist around, the longest ones circling the base of your shaft");
            if (this.player.hasSheath())
                this.outputText(" inside your violated sheath");
            this.outputText(".  With so much blood trapped in your " + this.cockDescript(x) + ", it's bigger and harder than ever, twitching valiantly against its restraints with every beat of your heart.");
            this.outputText("\n\nOne of the tentacles circles your " + this.player.cockHead(x) + " for a moment, and without much warning or pause, it lances forward to bury itself into your vulnerable cum-slit.  Your preconceptions are turned on their heads when there's a complete lack of pain from the abrupt penetration.  If anything, it actually feels kind of good... like there's a warm, slippery finger caressing your penis from the inside out.  It slithers in and out of you, pumping you inside, burrowing pleasure into your center even while stroking you from without.  Your body, burning from the exertion of fucking the flower's pod and the constantly-rising tidal wave of lust, begins to twitch spasmodically.");
            this.outputText("\n\nThe internal suction spikes as your dick bloats larger, and with a roar of bestial pleasure, you arch your back, hands pushing your " + this.cockDescript(x) + " as deep into the plant's gullet as possible.  ");
            if (this.player.balls > 0)
                this.outputText("Your [balls] gurgle, a surprisingly happy sound, and cling tight to your loins.  ");
            this.outputText("Inside you, you can feel the liquid heat of your spurting release exploding out, melting everything before it with liquid, orgasmic bliss.  A low moan bursts from your lips when the sounding tentacle pulls out of your sloppy cock-slot, and the rushing tide of bubbling cum follows it, bursting into the sweet, suckling nectar-pot.");
            if (this.player.cumQ() > 500)
                this.outputText("  You pour forth your prodigious essence without pause or fail, and the plant immediately begins to drink it down, the stem bulging with rounded balls of sperm that it carries underground.");
            if (this.player.cumQ() > 1500)
                this.outputText("  Soon, the meager stem cannot swallow it all.  Spunk froths and squirts out around the base of your tool for a moment, and then a veritable tide of the stuff gushes out to soak  you.");
            ...
            this.player.orgasm();
            this.dynStats("cor", 1);
            this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_FLOWER] = 1;
            if (this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] < 1000)
                this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] += 4;
            this.fatigue(5);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        rideDatFuckingFukkFlowerP2() {
            ...
            if (this.player.clitLength > 4)
                this.outputText("  Your heavy buzzer is so big that the flexible plant-cock has plenty of room to curl around it, and if you could see it, your clit would look almost like a candy-cane (if one set of stripes was jerking off the cane beneath).");
            if (this.player.cockTotal() > 0)
                this.outputText("  [EachCock] soon has its own partner twisting around it, a pussy-slicked vine to jerk and twine about its girth.");
            ...
            if (this.player.bRows() > 1)
                this.outputText("lowest row of tits, cupping them before groping to your top row of breasts");
            else
                this.outputText("[chest]");
            this.outputText(", caressing the");
            if (this.player.biggestTitSize() > 1)
                this.outputText("ir");
            this.outputText(" swell as you search for the lust-tightened skin of your [nipples].  They seem almost as sensitive as little clits, and as soon as you find them, you immediately set to circling them slowly, occasionally tugging and twisting when a particularly powerful sensation works through your pleasure-wracked body.");
            if (this.player.lactationQ() > 50) {
                this.outputText("  One after the other, they begin to ");
                if (this.player.lactationQ() < 150)
                    this.outputText("trickle");
                else if (this.player.lactationQ() < 500)
                    this.outputText("leak");
                else
                    this.outputText("spray torrents of");
                this.outputText(" milk.");
            }
            this.outputText("  You moan in unabashed delight, your mouth hanging open in a mindless, blissful 'o' in between vocalizations.  If your friends back home could see you now, writhing in the dirt, face open in simple, animal pleasure, and perhaps worst of all, fucking a plant, you'd die of ");
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] == 0 && this.player.cor + this.player.lib < 150)
                this.outputText("embarrassment");
            else
                this.outputText("lust");
            this.outputText(".");
            ...
            if (this.player.hasCock())
                this.outputText("  [EachCock] explodes in release, pumping heavy flows of seed into the petals, even as y");
            else
                this.outputText("Y");
            this.outputText("our quivering pussy, already sopping wet, releases the last of your juices in a soaked ");
            if (this.player.cumQ() < 50)
                this.outputText("drizzle");
            ...
            this.outputText(".  The tentacles inside you curl in on themselves and slowly pull back from the well-creamed quim, scraping out as much fluid as possible from your oversensitive honey-pot.  The binding on your [clit] releases, which of course sets off a whole new wave of rippling pleasure-contractions in your cunt.");
            ...
            this.dynStats("cor", 1);
            this.fatigue(5);
            this.flags[kFLAGS_1.kFLAGS.TIMES_RIDDEN_FLOWER] = 1;
            if (this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] < 1000)
                this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] += 4;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        flowerGrowsToP3() {
            this.clearOutput();
            this.outputText("Again, you hear odd noises coming from a corner of your camp - the corner where you let that tainted shrubbery grow.");
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_FLOWER] + this.flags[kFLAGS_1.kFLAGS.TIMES_RIDDEN_FLOWER] > 0)
                this.outputText("  The fucking probably only helped it to grow faster.");
            this.outputText("  The distinct sound of wood bowing and creaking under new weight catches your ears, and well before you can get to the plant, you can see a leafy canopy stretching towards the sky.  <b>It's grown into a small tree, with bark, leaves, and everything!</b>  Warily, you round one of the ancient standing stones to get a better look.");
            ...
            var burnIt = undefined;
            if (this.player.findPerk(PerkLib_1.PerkLib.Dragonfire) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.FireLord) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.Hellfire) >= 0 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.KnowsWhitefire) >= 0) {
                this.outputText(", though you suppose you could burn it down with magical fire if you set your mind to it");
                burnIt = this.torchP3Tree;
            }
            this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_LEVEL] = 3;
            this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] = 0;
            this.outputText(".\n\n<b>What do you do?</b>");
            var fuck = undefined;
            var ride = undefined;
        ...
        fuckTheFlower() {
            ...
            if (this.player.hasVagina())
                this.outputText("  Wetness builds in your [vagina] as well, but you're focusing on your maleness just now.  Your neglected twat will have to wait its turn.");
            this.outputText("  A feverish sweat breaks out on your brow, though whether from your own arousal, the plant's heat, or some chemical in its juices, you cannot tell.");
            ...
            this.outputText("\n\nRacking your brain for ideas, you momentarily slump into a temporary acceptance of your position, sagging heavily into the strong, fibrous tentacles.  Perhaps that's what the unnatural creature wants, for as soon as you let it have control, the tendrils swing you closer, close enough for [oneCock] to kiss the warm, wet hole.  Momentum carries you away from the promise of greater pleasure, your " + this.cockDescript(x) + "'s tip nicely moistened by lubricants and its own heavy bead of liquid pleasure.  When you swing back, a few inches are lucky enough to nestle inside, and you find yourself moaning without meaning to.");
            this.outputText("\n\nYou're swung to and fro, held aloft by a shrubbery harness seemingly intent on teasing you.  First, you get a taste of heaven, but only on your " + this.player.cockHead(x) + ".  Then, you're left to flutter in the breeze, the only sexual sensation available the cool wind fluttering across your whetted tip.  Over and over, the plant teases you until you lose track of time.  The closest thing to a watch you have is the gentle throb in your [balls] and its gradually strengthening intensity.  Oh, how it aches!  You feel taut and stretched like a harp string being tuned, only the musician just keeps cranking away, ratcheting up the pressure until you feel about to snap.  Your one comfort is the momentary bliss of the flower's sweet kiss, an exciting pleasure that's slowly being turned into an aching hell.");
            this.outputText("\n\nDuring a particularly shameless moan, you realize that you're dipping a little deeper with each pendulous stream.  Luckily, the corrupt tree's arboreal lust must be rising like your own, and after a few slow swings, your " + this.cockDescript(x) + " is slipping three quarters of the way in");
            if (this.player.cockArea(x) >= 150)
                this.outputText(", sliding down the trunk as easily if the entire inside was a giant pussy just waiting to get fucked");
            this.outputText(".");
            if (this.player.cockTotal() > 1) {
                this.outputText("  Your other penis");
                if (this.player.cockTotal() > 2)
                    this.outputText("es rub");
                else
                    this.outputText(" rubs");
                this.outputText(" sensually across the moist outer blossom, drooling their clear pre-cum over the petals.");
            }
            this.outputText("  Schliiick.  You slide out.  Slorp-pop.  You slide in, this time to the ");
            if (this.player.hasSheath())
                this.outputText("sheath");
            else
                this.outputText("base");
            if (this.player.balls > 0)
                this.outputText(" with your gurgling balls slapping against the flower's edge");
            this.outputText(", accompanied by a small squirt of sweet lubricants.");
            this.outputText("\n\nYou've been kept on edge for so long that even this brief taste of liquid-soft snugness has your body clenching and warm bliss mounting inside of you.  You wrap as much of your [legs] around the trunk below as possible and give into your pleasure, thrusting your " + this.cockDescript(x) + " against the petalled muff each time the vines draw you away.  You rut like a demon's pet, half-mad with pleasure and desire so powerful it obviates rational thought.  The ecstasy rises like an all consuming tide, tinting your vision pink as your eyes roll back and [eachCock] thickens.");
            this.outputText("\n\nJizz blasts out of your " + this.multiCockDescriptLight() + " with uncommon force, painting the flower's interior with white");
            if (this.player.cockTotal() > 1)
                this.outputText(", as your multiple endowments allow you to drizzle the purple bloom's exterior with alabaster cream");
            this.outputText(".");
            if (this.player.cumQ() > 500)
                this.outputText("  Pearly ropes big enough to fill a flask lurch out from your cum-slit, propelled by your quivering orgasmic muscles deep into the trunk, and you swear you can hear the pitch of your sexual pumping rising in tone, changed by the flooded vessel.");
            if (this.player.cumQ() > 1500)
                this.outputText("  A wave of your thick gunk rolls out from under your pumping cock - you've filled the tree beyond even its capacity, and the thick puddle forming beneath your [feet] is all the proof you need of your virility.");
            if (this.player.hasVagina()) {
                this.outputText("  Your hungry cunt, long denied in this exchange, trembles as it ");
                if (this.player.wetness() < 4)
                    this.outputText("leaks");
                else
                    this.outputText("sprays");
                this.outputText(" your own female fluids in sympathy.");
            }
            this.outputText("  After what feels like forever, the spurting seed no longer flows from your long-abused dick, and as your member softens, the tentacles swing you away, setting you down softly.");
            ...
            this.fatigue(5);
            if (this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] < 1000)
                this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] += 5;
            this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_FLOWER]++;
            this.flags[kFLAGS_1.kFLAGS.HOLLI_FUCKED_TODAY] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Drink Sap (edited)
        drinkThePlantGirlsSap() {
            ...
            if (this.silly())
                this.outputText(", tree hugger that you are");
        ...
        rideTheWalrusP3() {
            ...
            this.outputText("You eye the tentacles hiding amongst the leafy branches above, writhing obscenely around each other as they snake through the foilage.  You shed your [armor] into a worthless pile and bare your body, cupping your [chest] enticingly as you whistle up at the tree.  Your calls seem to fall on deaf ears; the whirling vines stay put up in their perch.  They're ignoring your delicious, feminine flesh!  Irritated, you stomp up to the trunk's flower and plunge your fist inside it.  Fresh fluid gushes out over your armor, releasing a spray of sweet, musky lubricants.  You blindly feel around inside the pliant plant-pussy with your fingers, giggling to yourself whenever the soft cavity clenches tightly to your arm.  Whatever this is, it can feel pleasure.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] < 1000)
                this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] += 5;
            this.flags[kFLAGS_1.kFLAGS.TIMES_RIDDEN_FLOWER]++;
            ;
            this.flags[kFLAGS_1.kFLAGS.HOLLI_FUCKED_TODAY] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        torchP3Tree() {
            ...
            this.outputText("This has gone on long enough!  This thing cannot continue to grow in your camp any longer, and you have just the means to remove it: fire.  ");
            //[(nerdfire)
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.KnowsWhitefire) >= 0)
                this.outputText("Closing your eyes to focus, you gather your energies, and unleash your white, supernatural flames upon the thing.");
            //(bromancefire)
            else if (this.player.findPerk(PerkLib_1.PerkLib.FireLord) >= 0)
                this.outputText("Sucking in your breath, you inflate your chest and stir the embers of the jaguar demon's gift.  Dredging up an enormous pine-green fireball, you exhale and launch it at the tree.");
            else
                this.outputText("Sucking in your breath, you inflate your chest and stir the embers of your fiery gift.  Dredging up an enormous fireball, you exhale and launch it at the tree.");
            this.outputText("  It goes up by the torch, though the fire starts to fade sooner than you would expect.  You huff, but repeat the action, layering a new blaze atop the previous one; you put all your concentration into this new conflagration, stoking the inferno with every ounce of your ");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.KnowsWhitefire) >= 0)
                this.outputText("magical will");
            else
                this.outputText("breath");
            this.outputText(".");
        ...
        treePhaseFourGo() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_FLOWER] + this.flags[kFLAGS_1.kFLAGS.TIMES_RIDDEN_FLOWER] > 0)
                this.outputText("Did you enjoy feeding me?  You should have seen the expression on your face when you were cumming in me.  Your eyes were rolling back and your mouth was just hanging open.  Do you know what it made me want to do?");
            else
                this.outputText("Did you enjoy watching me grow?  You should have fed me.  It was so much harder to grow without proper nutrients.  Do you know what I thought about during all the time I spent waiting?  Do you know what it made me want to do?");
            this.outputText("</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_LEVEL] = 4;
            this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] = 0;
        ...
        JojoTransformAndRollOut() {
            ...
            this.outputText("\"<i>[name], come here please.</i>\"");
            ...
            if (this.player.cor < 25)
                this.outputText("Not willing to lie to your friend, you also admit that she seems to have changed after your actions in the factory - that, though you were trying to render the tanks permanently inoperable, the spillage you created pushed the cthonic spirit over the edge.");
            else
                this.outputText("Though, you do leave out the precise, needless details of what caused the change.");
            this.outputText("  The monk's eyes widen in surprise and surmise.");
            this.outputText("\n\n\"<i>Unbelievable...</i>\" he blurts.  \"<i>");
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_FLOWER] + this.flags[kFLAGS_1.kFLAGS.TIMES_RIDDEN_FLOWER] == 0)
                this.outputText("To think that I must now consider Marae herself my enemy.  Forgive me, but this place is not safe for us anymore if it has attracted the attention of such a creature.  For now, I will return to the forest.  I know that you believe your mission keeps you here, but I urge you to stay away from that thing and watch the portal from an adequate distance.");
            //(totally deflowered that flower)
            else
                this.outputText("And even knowing that this could be the case, you still chose to fornicate with it?  [name]... I cannot say that I am not disappointed.  This place is not safe for me anymore.  For now, I will return to the forest.");
            this.outputText("</i>\"");
            this.outputText("Jojo looks at you sadly; any argument you try to make is met with a resigned shake of his head.  \"<i>If the creature truly is the demonic offspring of a corrupted earth spirit, doubtless it will be powerful and the wrath of its parent severe.");
            if (this.player.level < 20)
                this.outputText("  Nonetheless, if you find yourself in a position where you must confront this demon or perish, call upon me.  I will render what aid I can, though I prefer it not be in vain.");
            else
                this.outputText("  Though, a mortal of your stature and resources may be able to destroy her and escape the reprisal.  I would counsel against direct confrontation until you are sure of victory, but if you must fight, then call upon me and you will have what aid I can give.");
            this.outputText("</i>\"  So saying, he presses a small talisman into your hand.");
            this.outputText("\"<i>Until then, you will find me in the forest if you need my assistance.</i>\"  Jojo makes a polite bow and departs.");
            this.outputText("(<b>Jojo is no longer a companion!</b>)");
        ...
        amilyHatesTreeFucking() {
            this.clearOutput();
            this.outputText("Your mousey cohabitant tramps up to you, irritation plain on her expression.");
        ...
        stayQuietWhileAmilyBitchesAboutFuckingArborday() {
            this.clearOutput();
            this.outputText("Amily berates you for some while longer, then eyeballs you.  Just as you begin to speak, she cuts you off again.");
            ...
            this.flags[kFLAGS_1.kFLAGS.AMILY_TREE_FLIPOUT] = 1;
        ...
        slapAmilysWhoreFace() {
            this.clearOutput();
            this.outputText("You slap Amily across the ");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_NOT_FURRY] == 0)
                this.outputText("mouse-");
            this.outputText("girl says, eyes wet with tears, \"<i>but I don't.  Goodbye.</i>\"");
        ...
        fuckHolliInZeFlowerPuss() {
            ...
            if (this.player.cockTotal() > 1) {
                if (this.player.cockTotal() == 2)
                    this.outputText("  Your other penis splays");
                else
                    this.outputText("The rest of your penises splay");
                this.outputText(" to the side, smearing furrows of the stuff around as they slide over the butter-smooth skin.");
            }
            this.outputText(" The demon dryad's hand reaches below to ");
            if (this.player.balls > 0)
                this.outputText("cradle your [balls], gently massaging your sack");
            else {
                this.outputText("gently caress your ");
                if (this.player.hasSheath())
                    this.outputText("sheath");
                else
                    this.outputText("loins");
            }
            this.outputText(" encouragingly.  You respond by edging your [hips] upward, more effectively presenting your shaft to be pleasured.");
            this.outputText("\n\nSighing happily, the immobile beauty ");
            if (this.player.cockArea(x) < 100)
                this.outputText("leans down and kisses the tip, opening her glossy green puckers to slurp it down, sucking just hard enough to make your " + this.player.cockHead(x) + " tingle with erotic warmth.");
            else
                this.outputText("kisses up and down your huge, towering shaft, slobbering her glossy green puckers all over your urethral bulge, making it even more of a wet mess.");
            this.outputText("  You grab hold of the edges of her tits and squeeze, smushing them tight around yourself and sliding them up and down.  The plant-woman's twinkling golden eyes meet your own while she pleasures your " + this.cockDescript(x) + ", and her hands come to rest over top of your own, assisting you with the quick tit-fuck.");
            ...
            this.outputText(", slapping wetly against you.  Soon, the slick texture of her soft melons has you throbbing eagerly and dribbling hot trails of pre-cum.  You're going to blow any second now, and the hot bloom of pleasure within you is spreading further and further.  Those gold and black eyes look up imploringly while the pale green cheeks hollow hungrily, and you release ecstatically, arching your back as you pound the heavy tits down your length.");
            this.outputText("\n\nA geyser of spunk rockets out into ");
            if (this.player.cockArea(x) >= 100)
                this.outputText("the air, where it hangs for a moment before splattering down atop the plant-girl's leaf-colored hair and face, forming a gossamer shroud.");
            else
                this.outputText("her mouth, which works noisily to swallow the hot load even as you inject it into her.  After a few swallows, she leans back and lets you shoot it up into the air, so that it can fall down over her face and hair, into a gossamer shroud.");
            //highish cum:  
            if (this.player.cumQ() >= 500)
                this.outputText("  You keep blasting heavy ropes of seed until her body and trunk are painted with goo, and then you cum some more, smattering spunk until she looks more like a gooey waterfall than a fey creature.");
            if (this.player.cumQ() >= 1500)
                this.outputText("  Before you know it, there's a lake around the two of you and a small river running downhill away from camp.");
            ...
            if (this.player.tallness < 60)
                this.outputText("tits");
            else
                this.outputText("arms");
            this.outputText(".  [EachCock], instead of slamming into the bark painfully, slots into something warm and wet, pulsating and pliant.  A clingy, tight hold that ripples gently around your member");
            if (this.player.cockTotal() > 1)
                this.outputText("s, massaging the bundle of cocks with uncommon ferver");
            else
                this.outputText(", massing your tool with uncommon fervor");
            this.outputText(".  Your grunt of irritation vanishes as soon as your tender sex is forced into the heavenly hole, and with the soft breasts pressing into ");
            if (this.player.biggestTitSize() >= 2)
                this.outputText("your own");
            else
                this.outputText("your [chest]");
            this.outputText(", you give up and kiss the dryad full on the lips, biting the lower one roughly in irritation.");
        ...
        haveAMapleSyrupSnack() {
            this.clearOutput();
            this.outputText("You approach Holli with a hungry smile plastered across your [face], licking your chops as you eye the arboreal slut with unrestrained desire.  Of course, your gaze fixes on her heavy chest, with its distended, dripping nipples.  They leak sweet sap as you stare; the demon seems eager to feel your mouth on her slick, almond-colored buds.  Looking at you ");
            if (this.flags[kFLAGS_1.kFLAGS.HOLLI_SUBMISSIVE] == 0)
                this.outputText("knowingly, Holli asks, \"<i>Come for a little pick-me-up?  Well, go on; drink deeply of my nectar, </i>champion.\"  The last word is inundated with malicious, mocking tones.");
            else
                this.outputText("eagerly, Holli asks, \"<i>Care for a little pick-me-up?  They're getting very engorged, and I'm sure it would be a refreshing snack for you.</i>\"");
        ...
        level4RideHollisTentacruels() {
            ...
            if (this.silly())
                this.outputText("  She proceeds to sing about Jack Sparrow's awesome adventures for a solid ten minutes, then goes on as if nothing had happened.");
            ...
            if (this.player.lactationQ() == 0)
                this.outputText("droplets of milk dripping from your nipples.  When did you start lactating?");
            else
                this.outputText("steady streams of milk erupting from your nipples.  When did you start lactating this hard?");
            ...
            if (!this.player.isBiped())
                this.outputText("you'd be walking bowlegged for a week, if you had legs.");
            else
                this.outputText("you'll be walking bowlegged for a week!");
            //empty lust, boost corruption, slimefeed(), +1 cor, -3 sens, +.5 libido
            this.player.orgasm();
            this.dynStats("lib", .5, "sen", 2, "cor", 1);
        ...
        eatHolliFruit() {
            this.clearOutput();
            this.outputText("You reach up into Holli's branches and pluck ");
            if (this.flags[kFLAGS_1.kFLAGS.HOLLI_FRUIT] == 1)
                this.outputText("the fruit");
            else
                this.outputText("one of the fruits");
            this.outputText(".  ");
            if (this.flags[kFLAGS_1.kFLAGS.HOLLI_FRUIT_EXPLAINED] == 0) {
                this.outputText("Holli smiles over at you and asks, \"<i>Enjoying the fruits of our union?</i>\"");
                ...
                this.flags[kFLAGS_1.kFLAGS.HOLLI_FRUIT_EXPLAINED]++;
            }
            this.outputText("Biting into it, sweet juices seem to explode from the flesh, dribbling down your chin.  It tastes like a dessert and you chow down, happily munching away.  In no time flat, you're down to just a core.  You toss it and wipe your [face] clean, then burp.  Damn, that was good!");
            //TF CHANCES
            if (HolliScene.rand(2) == 0 && this.player.cockTotal() > this.player.tentacleCocks()) {
                ...
                this.outputText("\n\nYour " + HolliScene.num2Text2(this.temp + 1) + " penis itches, and you idly scratch at it.  As you do, it begins to grow longer and longer, all the way to the ground before you realize something is wrong.  You pull open your [armor] and look down, discovering your " + this.cockDescript(this.temp) + " has become a tentacle!  As you watch, it shortens back up; it's colored green except for a purplish head, and evidence seems to suggest you can make it stretch out at will.  <b>You now have a");
                if (this.player.tentacleCocks() > 0)
                    this.outputText("nother");
                this.outputText(" tentacle-cock!</b>");
                this.player.cocks[this.temp].cockType = CockTypesEnum_1.CockTypesEnum.TENTACLE;
                this.player.cocks[this.temp].knotMultiplier = 1.3;
                this.dynStats("sen", 3, "lus", 10);
            }
            this.flags[kFLAGS_1.kFLAGS.HOLLI_FRUIT]--;
            this.dynStats("cor", 1);
        ...
        askHolliToWatch() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.HOLLI_DEFENSE_ON] == 0) {
                this.outputText("You ask Holli if she would mind using her tentacles to help guard the camp at night.  She rolls her eyes and taunts, \"<i>I don't know; maybe if you get down on your knees and beg me.  ...And I mean </i>really<i> beg, with plenty of whimpering.  Lick my roots too.  After all, I should get something out of this.</i>\"");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.THREATENED_HOLLI] > 0)
                    this.outputText("<b>  You could always just slap the cunt.</b>");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.THREATENED_HOLLI] == 0)
                    this.addButton(1, "Threaten", this.threatenHolli);
                else
                    this.addButton(1, "Slap Her", this.slapDatHo);
            ...
            //Stop Guarding (edited)(C)
                ...
                this.flags[kFLAGS_1.kFLAGS.HOLLI_DEFENSE_ON] = 0;
        ...
        begHolli4Watches() {
            this.clearOutput();
            this.outputText("You swallow your pride and drop down prostrate on the ground.  Sighing, you grudgingly say, \"<i>Please, Holli, guard my camp at night.  I don't want to be raped by monsters.</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.HOLLI_DEFENSE_ON] = 1;
            this.doNext(this.treeMenu);
        }
        ...
        domUpSomeHolli() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.HOLLI_FUCKED_TODAY] = 1;
            this.outputText("You swagger up to the tree and put your hand on the bark beside Holli.  Glancing over, she quips, \"<i>Is that supposed to be intimidating?</i>\"  The dryad smirks ingratiatingly.  \"<i>I'm the offshoot of a demon goddess.  I don't think you thought this through.</i>\"");
            ...
            var domPowah = this.player.level;
            ...
            //[Next] - Holli's Menu
            this.flags[kFLAGS_1.kFLAGS.HOLLI_SUBMISSIVE] = 1;
            this.treeMenu(false);
        }
        //Guard Camp
        askBrokenHolliToGuard() {
            this.clearOutput();
            this.outputText("Holli bows her head when you mention her guarding camp.  She asks, \"<i>Shall I keep watch for foes to drain or let them into camp for you to have the pleasure of dealing with, [name]?  <b>I've been ");
            if (this.flags[kFLAGS_1.kFLAGS.HOLLI_DEFENSE_ON] == 1)
                this.outputText("keeping watch");
            else
                this.outputText("sleeping, instead");
            this.outputText(".</i>\"");
            //[Guard] [Don't Guard] [Back]
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.HOLLI_DEFENSE_ON] == 1)
                this.addButton(1, "Don't Guard", this.toggleBrokenHolliGuard);
            else
                this.addButton(0, "Guard", this.toggleBrokenHolliGuard);
            this.addButton(4, "Back", this.treeMenu);
        }
        //Guard On
        toggleBrokenHolliGuard() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.HOLLI_DEFENSE_ON] == 0) {
                this.outputText("\"<i>All right, I'll get to have some fun then,</i>\" Holli quips while rubbing her palms together in anticipation.");
                this.outputText("\n\nYou suppose you can sleep better with your pet demoness taking on the lesser whelps of this land.");
                this.flags[kFLAGS_1.kFLAGS.HOLLI_DEFENSE_ON] = 1;
            }
            //Guard Off
            else {
                this.outputText("\"<i>All right, they're yours to smite or play with,</i>\" Holli says with a wink.  You give her a glare, to which she responds with a shrug.  \"<i>What?  I know how it is!  You mortals can't fight worth a damn when you're sleeping.</i>\"");
        ...
        holliGetsDickDommed() {
            this.clearOutput();
            this.outputText("Tossing your [armor] aside, you expose your " + this.multiCockDescriptLight() + ".  Holli's eyes fixate on [oneCock], her attention rapturously contained by a single phallus.  You grip your maleness in hand and bounce it up and down into your other palm.  The solid slaps of genital impacts echo off the surrounding rocks, each sending a pleasant tingle of pleasure through the root of your manhood.  Before long, you're completely erect and throbbingly hard, bouncing unbidden with each and every thrum of your heart.");
            ...
            if (this.player.biggestCockArea() > 80)
                this.outputText(", jaw stretching obscenely");
            this.outputText(".");
            ...
            if (this.player.biggestCockArea() <= 80) {
                this.outputText(", swallowed to the ");
                if (this.player.balls > 0)
                    this.outputText("[balls]");
                else
                    this.outputText("[sheath]");
                ...
                this.outputText(", swallowed as deep as Holli's distended neck can handle.");
            this.outputText("  Gurgling, the demonic dryad flutters her lengthy eyelashes and looks up at your eyes, twinkling with happiness at her servitude.  You wiggle your crotch around, and it twists your [cock biggest] around her mouth and throat.  The tainted tree's tongue massages the underside of your length, embracing you with subtle moisture and frictionless pressure.");
            this.outputText("\n\nBubbling sexual pleasure begins to build up inside you, making your ");
            if (this.player.balls > 0)
                this.outputText("[sack] feel taut and ready to burst");
            else
                this.outputText("body feel strung tight like an over-tuned guitar");
            this.outputText(".  Holli pulls back, inciting a snarl of displeasure to vibrate from you, but as soon as she's withdrawn, her hands clasp onto the slick shaft and begin to pump it with vigorous strokes.  Her mouth settles back into place around your [cockHead biggest], circling it with her tongue while she bobs up and down on it, snaring your most sensitive place with overwhelming sensations.");
            ...
            if (this.player.biggestCockArea() > 80)
                this.outputText("  It bends slightly as the immense girth is forced inside her, aiming down, deep inside the trunk.");
            this.outputText("  Holli flops into your [chest], twitching weakly and breathing heavily.  \"<i>Fffuck, so good!</i>\" she pants, nuzzling her cheek into your collarbone while her hands play across your shoulders.  You ruthlessly mount her flowery mound with fast motions.  Juices squirt out around your member at the apex of every stroke, raining down over the surrounding ground.  You grab Holli's deep green hair and pull her back.  Her face is wrecked by bliss, her mouth and eyes moving in uncoordinated twitches.");
            ...
            if (this.player.cockTotal() > 1) {
                this.outputText("  Excess jism spurts onto Holli's jiggling udders from below, spotting the viridian mounds with white.");
                if (this.player.cumQ() >= 500)
                    this.outputText("  The constant sprays turn them white in little time, dripping from the peaks of her nipples along with her sticky sap.");
            }
            if (this.player.cumQ() > 1000)
                this.outputText("  A trickle of sperm washes out of the demoness's entrance, somehow escaping the heavy suction.");
            if (this.player.cumQ() > 2000)
                this.outputText("  A moment later, that trickle turns into a river.");
            if (this.player.cumQ() > 3000)
                this.outputText("  You swear that her trunk must be absolutely stuffed with spunk.");
            if (this.player.cumQ() > 5000)
                this.outputText("  A spooge-spout sprays out as the pressure goes through the roof, confirming your suspicions in the messiest way possible.");
            this.outputText("  Holli's tentacles cum with her, spraying her seed through her canopy in aimless ropes.  Most of it sticks to her branches and leaves, but small amounts of it trickle down to spatter the ground.  One of them lands on the back of your hand.  You frown and push it up against the tree-woman's mouth.  She licks you clean without question, still dazed from her orgasm.");
        ...
        fullOnTentacleTasticGangBangForHolli() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.HOLLI_FUCKED_TODAY] = 1;
            this.outputText("You remove your [armor] and expose your writhing mass of wriggling tendrils to the tree-tart.  She places a hand over her mouth and exhales, \"<i>Oh my, Mother Marae sure knows how to pick them, doesn't she?</i>\"");
            ...
            if (this.silly())
                this.outputText(", inflatable-arm, flailing tube-cocks");
            this.outputText(".  Below the orgy of arboreal affection, Holli's slick petals have spread wide.  You can actually see her interior twitching voraciously.  It opens and closes with pulsing hunger, vibrantly engorged.  As you watch, the fourth of your members lances forward of its own volition, spearing straight for that welcoming hole with no guidance from you.  It hits like a missile.  Two feet of that cock is gone in a moment, swallowed deep in the cunt-flower's bottomless depths.  A gush of girl-cum spurts out around the intruding member, and you can feel the muffled moan vibrate through the mouth-bound cock as she gives in to the four-way fucking.");
            ...
            if (this.player.balls > 0)
                this.outputText("  Your [balls] draw up tight to your groin and squeeze, rhythmically discharging their heavy loads.");
            ...
            this.player.orgasm();
            this.dynStats("lib", .4, "sen", -3, "cor", 1);
            this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_FLOWER]++;
            this.flags[kFLAGS_1.kFLAGS.HOLLI_FUCKED_TODAY] = 1;
            this.fertilizeHolli();
            this.fertilizeHolli();
        ...
        vaginalDomHollisTentacruels() {
            ...
            if (!this.player.hasFuckableNipples() && this.player.lactationQ() < 50)
                this.outputText(" and pay special attention to your [nipples], tugging them in time with every sluggish thrust in your slit.");
            else if (this.player.lactationQ() >= 50) {
                this.outputText(" and sigh at the ");
                if (this.player.lactationQ() < 150)
                    this.outputText("squirts");
                else if (this.player.lactationQ() < 800)
                    this.outputText("sprays");
                else if (this.player.lactationQ() < 2000)
                    this.outputText("outpouring");
                else
                    this.outputText("thick fountains");
                this.outputText(" of milk that escape with every tug, timed to match the sluggish thrusts at your slit.");
            }
            else
                this.outputText(" and sink your fingers into your [nipples], fucking them to the sluggish tempo of the thrusting tentacle.");
            this.outputText("  A loud groan escapes your mouth, and you rock your [hips] against the undulating tendril.  Your body's eagerness for more pleasure is unparalleled, but you control yourself as efficiently as you control the dryad.");
            ...
            if (this.player.clitLength >= 3.5)
                this.outputText(" for a moment before wrapping around and jerking on it");
            this.outputText(".");
        ...
        threatenHolli() {
            this.clearOutput();
            this.outputText("You snarl and threaten to burn the barked bitch to the ground if she won't make herself useful after you ask politely.");
            ...
            if (this.player.level < 30)
                this.outputText("Mighty as you are, Marae is likely still beyond your power.  Perhaps you should just ignore this demon for the time being.");
            else
                this.outputText("Marae is likely beyond your power yet, but... you feel like she might not pressure you too hard if you can make a suitably credible threat.");
            ...
            if ((this.player.gender > 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.JojoNightWatch) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.PureCampJojo) >= 0) || this.flags[kFLAGS_1.kFLAGS.ANEMONE_WATCH] > 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.THREATENED_HOLLI] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        cutHerDown() {
            this.clearOutput();
            this.outputText("\"<i>Are you serious?  You really want to be broken that badly, my little toy?</i>\"  The demon folds her arms over her hefty chest, her earlier, suggestive posture completely absent now.  \"<i>You know my bark is as strong as any armor, right?  That Marae herself - the land itself - bolsters me?  Take that back right now, and I'll let you return to my good graces... if you put your face in the dirt and plead for the duty to pleasure me whenever I want.</i>\"");
            //(if PC weapon = Large Axe)
            if (this.player.weaponName == "large axe") {
        ...
        callDatJojo() {
            ...
            this.flags[kFLAGS_1.kFLAGS.FOUGHT_HOLLI] = 1;
            this.startCombat(new Holli_1.Holli());
            this.monster.createStatusAffect(StatusAffects_1.StatusAffects.JojoIsAssisting, 0, 0, 0, 0);
        }
        defeatHolli() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_KILLED] = 1;
            //Win without Jojo -Z
            if (this.monster.findStatusAffect(StatusAffects_1.StatusAffects.JojoIsAssisting) < 0) {
                this.outputText("Weary, the succubus godling folds into her tree, unwilling to allow you the sight of her defeat.  With her energy suppressed, you're free to ");
                if (this.player.weaponName != "large axe")
                    this.outputText("fetch an axe and ");
                this.outputText("hack at her trunk, laboriously peeling bark and making wedge-shaped cuts in it as you try to fell the abomination.  It takes nearly eight hours, but eventually the gnarled tree topples.  No sooner does it fall than it shrivels and turns to ash.");
                this.temp = 7;
                while (this.temp > 0) {
                    this.temp--;
            ...
            //Win with Jojo -Z
                ...
                this.outputText("The fire-blackened mouse cheers at you as the succubus groans and retreats completely into her bark.  \"<i>Well done, [name]!  Help me carry tinder and we can burn this abomination to the ground!</i>\"");
            ...
            this.player.createKeyItem("Holli's Ashes", 0, 0, 0, 0);
            this.cleanupAfterCombat();
        }
        //[yes gimme monk pls]
        recruitJojoToCamp() {
            this.clearOutput();
            this.outputText("Jojo nods eagerly at you when you invite him to share your camp.  \"<i>Excellent idea.  If you'll excuse me, I wish to attempt to purify the spot where the creature grew, and then I will fetch my things.</i>\"");
        ...
        //[no want]
        dontRecruitJojoToCamp() {
            this.clearOutput();
            this.outputText("You hold your tongue, allowing Jojo to make his way back to the forest.");
            this.outputText("\n\n(Key Item Gained: Holli's Ashes)");
            this.player.createKeyItem("Holli's Ashes", 0, 0, 0, 0);
            this.cleanupAfterCombat();
        }
        ...
        enjoyYourBadEndBIYAAAATCH() {
            ...
            if (this.player.gender == 1 || (HolliScene.rand(2) == 0 && this.player.hasCock())) {
                ...
                if (this.player.cocks[this.player.biggestCockIndex()].cockThickness > 6)
                    this.outputText(", stretching her jaw wide open in a way that makes you wince,");
                this.outputText(" engulfs you.  Holli's tongue plays over your slit and she looks up at you for just a moment to be sure you're watching.");
                ...
                if (this.player.biggestCockLength() > 24)
                    this.outputText("her neck ripples and extends grotesquely, and her head begins to migrate down all " + HolliScene.num2Text(Math.round(this.player.biggestCockLength())) + " of your prick with alarming speed, pushing the stem inside along with it.  ");
                else
                    this.outputText("she sinks her head down to the base of your prick in one quick thrust, bringing the stem with it.  ");
                this.outputText("The sensation of having your entire [cock biggest] penetrated and sucked into her hot, wet, clinging throat pushes you back toward the edge and over, and it literally becomes a race for Holli to reach bottom before your nerves fire.  Her wet lips impact your crotch with a lewd splatter, but her tongue keeps going deep into your body, stopping only once it reaches your prostate.  A small bulge fires down the thin stem, forcing through your slit and into the shaft to lodge in your gland.  Holli's mouth and tongue withdraw once it is in place, and she grabs your cock in her hand, masturbating you vigorously.");
                this.outputText("\n\nIt's too much; your climax comes in a flood");
                if (this.player.balls > 0)
                    this.outputText(", and your [balls] draw close to your body to unload");
                this.outputText(".  Your eyes roll as you flex and flex, but nothing comes out.  As you conclude your dry orgasm, you begin to feel a pressure on your prostate.");
                ...
                if (this.player.balls > 0)
                    this.outputText("migrating the other direction into your [balls], entangling and infiltrating them, filling them with the same warmth, then pressing out against your sack.  ");
                else
                    this.outputText("exploring the depths of your body and curling back against the surface of your " + this.player.skin() + ".  ");
                this.outputText("Your stomach turns as the sprouts push their way through, crawling from your crotch down the outside of your [legs] to root in the dry earth.  The shoots thicken into fibrous roots, forming a trunk that supports you and pushes you closer to Holli and lower to the ground, until your writhing, tentacle-tipped prick is lined up with her pussy flower and within her easy reach.");
            ...
            //branch of vagina-having
                ...
                if (this.player.isTaur())
                    this.outputText(" and turning you around");
                this.outputText(", the demon buries her face in your [vagina], penetrating it with her wet, flexible tongue.");
                ...
                if (this.player.hasCock())
                    this.outputText("  [OneCock] drools precum down its length and onto the flower, triggering another spasm and another gush from your prick.  Holli laughs as you continue to self-stimulate with your uncontrollable fluids.");
                ...
                if (this.player.biggestTitSize() > 1)
                    this.outputText("wrapping around and under your breasts to keep them permanently jutting out in a lurid display");
                else
                    this.outputText("tracing a lattice of slender, criss-crossing ivy over your chest that hangs just far enough over your [nipples] that a stiff breeze will drag it into them");
                this.outputText(", then continuing over your back and up your neck.  The tendrils thicken and multiply, occluding your forearms and lower [legs] in a casing of young bark and leaf buds, and Holli's own release you as yours take over the duty of holding you in place to receive whatever pleasure she forces upon you.  You're left in a salacious pose when the growth subsides, suspended several feet off the ground with your arms held over your head, your back arched in a memorial of your incredible orgasm, ");
                if (this.player.biggestTitSize() > 1)
                    this.outputText("your breasts cupped and pressed together by vines, ");
                if (!this.player.isNaga() && !this.player.isGoo())
                    this.outputText("your thighs spread wide open, ");
                this.outputText("and your nectar-drooling flower-sex exposed with your [clit]");
                if (this.player.hasCock())
                    this.outputText(" and [eachCock]");
                this.outputText(" bobbing in a state of permanent semi-arousal.");
                ...
                if (this.player.ass.analWetness > 0)
                    this.outputText("Betraying your depravity, the slick crack opens wide and your greedy, wet asshole practically welcomes the demon's entire hand, sucking it up and making you shiver with repressed delight.  \"<i>Oh, mother!  It seems as though this is not a new lesson to you, is it?  My little whore, will you beg and moan as I fill you?</i>\"");
                else if (this.player.analCapacity() < 30)
                    this.outputText("With some difficulty, she forces it into your pucker.  \"<i>I think we'll just use this as our inroads, instead.  It may be slow going, but the journey is half the fun.</i>\"");
                else
                    this.outputText("Despite your clenching, your loose hole proves no impediment to the demon's exploration.  \"<i>Ah, how roomy you are!  I think I'll move right in.</i>\"");
                ...
                //[(iff buttslut)
                if (this.player.ass.analWetness > 0)
                    this.outputText("Try as you might, you can't see far enough down your back to determine what the demon has done.  The question answers itself, though, when she presses a shaft almost as thick as her leg into your [butt], nosing it into your wet, receptive asshole.  Despite yourself, you shiver in anticipation at being filled so completely.  ");
                else if (this.player.analCapacity() < 30)
                    this.outputText("Your jaw hits your collarbone as Holli angles the florid head of a long, narrow penis into your field of view.  Judging by how far it comes up her chest, it's almost a foot and half long, and it's drooling sticky sap all over your back.  With a twisted smile, the demon pushes it along your spine until it reaches your [butt], then shoves it toward the hole.  ");
                else
                    this.outputText("The demon presses up to your back, brushing her nipples against your skin and shoving her new growth between your thighs.  Looking down, you can see a fat, green shaft sticking from your crotch, glistening and dripping with sticky slime.  With another moan, Holli pulls it back from between your legs, then pushes apart your asscheeks and plunges it into your [asshole].  ");
                this.outputText("The sap oozing from her member coats your passage, ");
                if (this.player.ass.analWetness > 0)
                    this.outputText("mingling with your own lubrication and ]easing her thrusts.  Holli's tempo picks up quickly, and soon you can feel her twitch inside you as she nears her climax.");
                ...
                //[(buttslut or loose)
                if (this.player.ass.analWetness > 0 || this.player.analCapacity() > 30)
                    this.outputText("spilling a wave of her deposited fluids down your [legs].  ");
                else
                    this.outputText("and your once-tight pucker reflexively squeezes shut as best it can, trapping all but a few trickles of Holli's deposit inside you.  ");
                this.outputText("The freshly-grown shaft between Holli's legs begins to shrivel, withering and browning like a cut flower.  With an expression of mild disdain, she pulls it from her body and casts it aside, where it crumbles to pieces.");
                this.outputText("\n\nThe fluids in your gut begin to mingle, sending a disquieting pinprick sensation through the skin");
                if (this.player.skinType == appearanceDefs_1.SKIN_TYPE_FUR || this.player.skinType == appearanceDefs_1.SKIN_TYPE_SCALES)
                    this.outputText(" under your " + this.player.skinFurScales());
                this.outputText(".  Panic intensifies as the sensation quickly focuses on your crotch, and when the tendrils holding you push you away from the demon's tree, your curiosity gets the better of you.  You look over your shoulder again, trying to see what's happening.  As you strain to watch, you feel hundreds of tiny, sharp pinches and small vines begin to creep from your body, just below your ass.  The vines merge and thread into thick trunks as they get closer to the ground, pushing deep into the dirt and mooring you to the spot.  Arousal builds in you as they join the web of roots linking the demon Marae and Holli, as does a swelling at your crotch.  Another cluster of thin vines push free from your groin, growing upward in a lattice and lashing your arms into place, ");
                if (this.player.biggestTitSize() < 1)
                    this.outputText("folded atop your chest");
                else
                    this.outputText("crooked at your sides with your hands resting atop your [chest]");
                this.outputText(".  They continue past your face, reaching over your head to form a canopy similar to Holli's own.  Struggle as you may, when they're done growing you're left unable to budge and locked in a rather artful pose, head turned over your shoulder with your [ass] thrust out");
                if (this.player.biggestTitSize() >= 1)
                    this.outputText(", your breasts exposed from the sides,");
                this.outputText(" and your [legs] concealed below your buttcheeks by a thick tree trunk.");
        ...
        holliPlaysWithPenisesBadEnd() {
            ...
            if (this.player.biggestTitSize() < 1)
                this.outputText("masculine shape, it bears");
            else
                this.outputText("feminine shape, it nonetheless bears");
            this.outputText(this.multiCockDescript() + ", standing erect and hard as iron; the brown-haired girl blushes and looks away.");
            ...
            this.outputText("\n\nBy the time the girl reaches her third orgasm, her partners are tense and near the breaking point; with an shudder and a stilling of the shaking branches, the silent one opens " + this.player.mf("his", "her") + " mouth in mute ecstasy and ejaculates, ");
            if (this.player.cocks.length > 1)
                this.outputText("spraying the girl's stomach and tits with waste seed from " + this.player.mf("his", "her") + " unused manhood and ");
            this.outputText(" filling the Champion's pussy with so much semen it cascades from her stretched hole as Holli continues to pump.");
            this.outputText("\n\nThe dryad herself soon gives a cry and pushes her tits into the brown-haired girl's back as her climax comes.  A bulge ascends the green shaft, disappearing into the beat-up cunt of the Champion, and a trickle of golden sap leaks back down Holli's cock.  Pulling free, the dryad wipes her member off and folds it back into its bud; it shrinks and dwindles until nothing is left but her clitoris.  The silent one's branches lower the girl to the ground, " + this.player.mf("his", "her") + " always-erect prick");
            if (this.player.cockTotal() > 1)
                this.outputText("s");
            this.outputText(" drooling aftershocks onto her breasts.");
        ...
        girlsGetANiceManToBadEnd() {
            ...
            //[(if tits)
            if (this.player.biggestTitSize() > 1)
                this.outputText("[chest] cupped by vines and held out toward the young man, ");
            else
                this.outputText("chest crisscrossed with a mesh of fine vines, ");
            this.outputText("its legs elevated and spread apart to display a ");
            if (this.player.balls > 0 && this.player.ballSize > 10 && this.player.gender == 3)
                this.outputText(this.multiCockDescriptLight() + " with [balls] swinging below.");
            //(if H and ballsize < 10)
            else if (this.player.balls > 0 && this.player.ballSize <= 10 && this.player.gender == 3)
                this.outputText(this.multiCockDescriptLight() + " and [balls] that hang slightly over a [vagina].");
            //(if H and noballs)
            else if (this.player.gender == 3)
                this.outputText(this.multiCockDescriptLight() + " and a [vagina].");
            else
                this.outputText("a wet, drooling cunt that practically begs to be filled.");
            this.outputText("  Though its eyes are covered, the figure's mouth works constantly, biting and licking its lips as if beset by otherworldly amounts of lust.  Holli beckons the youth toward this tree.");
            ...
            if (this.player.ballSize > 10 && this.player.balls > 0)
                this.outputText("lifting the hefty testicles to reveal a wet, eager pussy.");
            else
                this.outputText("spreading the labia and exposing the eager, clenching hole inside.");
            ...
            if (this.player.biggestTitSize() >= 1) {
                this.outputText("reaches up and grabs two handfuls of breast, passing his thumb over a nipple and watching the ");
                if (this.player.gender == 2)
                    this.outputText("woman");
                else
                    this.outputText("hermaphrodite");
                this.outputText("'s mouth open and close in bliss.  ");
            }
            else
                this.outputText("leans down and kisses the [woman/hermaphrodite]'s smooth chest, causing her to arch her back in pleasure.  ");
            if (this.player.hasCock())
                this.outputText("With a nervous glance downward, he slides one hand to her [cock smallest].  \"<i>It's not gay if it's a chick's,</i>\" he mumbles to himself, and then begins to stroke haltingly, playing his finger along the urethra and drawing a squirt of precum from his shivering partner.  ");
            else {
                this.outputText("His hand slides to the [clit] above her wet fuck-hole; collecting some of the frothing lube from their wet sex, ");
                if (this.player.clitLength < 6)
                    this.outputText("he smears it over the little button and then begins to trace up and down the underside with a finger.  ");
                else
                    this.outputText("he coats the swollen organ with it and begins to jerk it off valiantly, like a cock.  ");
                this.outputText("\"<i>Does that feel good?</i>\" he asks, upping the pace of his thrusts.  ");
            }
            this.outputText("As if in reply, the ");
            if (this.player.gender == 2)
                this.outputText("woman");
            else
                this.outputText("hermaphrodite");
            this.outputText(" in the tree arches her back and her [vagina] clamps down on his tool");
            if (this.player.hasCock()) {
                this.outputText("; ");
                if (this.player.balls > 0)
                    this.outputText("her balls draw closer to her body and ");
                this.outputText("her trembling dick");
                if (this.player.cockTotal() == 1)
                    this.outputText(" throbs");
                else
                    this.outputText("s throb");
                this.outputText(" as she nears climax");
            }
            this.outputText(".");
            //[(cock)]
            if (this.player.hasCock()) {
                ...
                if (this.player.cockTotal() > 1)
                    this.outputText("s");
                this.outputText(" toward her face; ");
                if (this.player.biggestCockArea() < 20) {
                    this.outputText("semen spurts and dribbles down her [chest], pooling in the combined laps and mingling with the sticky lube ringing her vagina.  ");
                    if (this.player.cumQ() >= 500)
                        this.outputText("So much so that by the time she finishes her climax, both her partner's legs and her trunk are covered in a sheen of milky white seed.  ");
                }
                else if (this.player.biggestCockArea() < 80) {
                    this.outputText("her mouth is now full of cockhead, and she gulps as eagerly as she spurts, drooling lines of white from the corners of her lips.  ");
                    //[(big skeet)]
                    if (this.player.cumQ() >= 500)
                        this.outputText("The waves of seed don't stop coming, pouring into her and swelling her belly out until its round bulge pushes the cock away from her mouth and the remaining squirts fall on her [chest].  ");
                }
                //else cock biggest > 80)
                else {
                    this.outputText("her body is easily dwarfed by her male sex's massive size, and globs of sperm shoot into her canopy to splatter among her leaves and branches.  ");
                    if (this.player.cumQ() >= 1000)
                        this.outputText("The overproductive hermaphrodite's body pushes out so much seed that the entire canopy soon turns white and drips constantly as though it were in a tropical rainforest.  ");
                }
            }
            //(vagina and no cock)
            else {
                ...
                if (this.player.wetness() < 3)
                    ...
                    this.outputText("rush");
                else
                    this.outputText("torrent");
                this.outputText(" of female orgasm pours from her pussy, and her mouth opens wide in pleasure.  The tree branches surrounding the young man seem to close in, pushing him toward her.  Getting the message, he leans in and kisses his lover; her tongue probes his mouth with abandon as her body shakes out its fit and her [vagina] wrings his prick.  ");
            }
            this.outputText("Pushed past his limit by her lewd display, the young man groans, shudders, and begins to unload his pent-up cargo.  Falling on top of his partner's slick ");
            if (this.player.cockTotal() == 1)
                ...
                this.outputText("chest");
            this.outputText(", he goes limp and slack-jawed as his dick squirts, filling her vagina.");
            ...
            if (this.player.gender == 2)
                ...
                this.outputText("hermaphrodite");
            this.outputText("'s stomach.  \"<i>In fact, she seems to have enjoyed it so much that she would have me bestow a blessing on you.</i>\"");
        ...
        holliAndGenderlessSittingInATree() {
            ...
            if (this.player.skinType != appearanceDefs_1.SKIN_TYPE_FUR && this.player.skinType != appearanceDefs_1.SKIN_TYPE_SCALES)
                this.outputText(this.player.skinTone + "-colored");
            else
                this.outputText("covered in " + this.player.skinFurScales());
            this.outputText(" and wrapping its body around the tree in a way that makes determining its sex impossible.  No... it's not wrapping around the tree, but embedded in it up to the hips!");
            ...
            if (this.player.skinType == appearanceDefs_1.SKIN_TYPE_SCALES)
                this.outputText("a quiver of arousal shakes its scales");
            else if (this.player.skinType == appearanceDefs_1.SKIN_TYPE_FUR)
                this.outputText("its fur begins to prick up with arousal");
            else
                this.outputText("a blush of lust colors its " + this.player.skinFurScales());
            this.outputText("...");
        ...
        amilyComesBack() {
            this.clearOutput();
            this.outputText("Amily arrives with her belongings over her shoulder and a smile on her face.  \"<i>I knew you'd do the right thing, [name].  I'll get my nest set back up.</i>\"\n\n(<b>Amily has moved back in!  She can be found in the lovers tab.</b>)");
    ...
    exports.HolliScene = HolliScene;
});
//# sourceMappingURL=HolliScene.js.map