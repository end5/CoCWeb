define(["require", "exports", "./NPCAwareContent", "../../GlobalFlags/kFLAGS", "../../../console", "../../StatusAffects", "./Hel", "../../../../includes/appearanceDefs", "../../PerkLib", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, kFLAGS_1, console_1, StatusAffects_1, Hel_1, appearanceDefs_1, PerkLib_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class HelFollower extends NPCAwareContent_1.NPCAwareContent {
        ...
        helAnalCapacity() {
            var anal = 85;
            if (this.flags[kFLAGS_1.kFLAGS.HELIA_ANAL_TRAINING] >= 1)
                anal += 100;
            if (this.flags[kFLAGS_1.kFLAGS.HELIA_ANAL_TRAINING] >= 2)
                anal += 300;
            return anal;
        }
        heliaCapacity() {
            return this.helCapacity();
        }
        heliaAnalCapacity() {
            return this.helAnalCapacity();
        }
        helAffection(diff = 0) {
            if (this.flags[kFLAGS_1.kFLAGS.HEL_AFFECTION_FOLLOWER] > 70 && this.flags[kFLAGS_1.kFLAGS.HEL_HARPY_QUEEN_DEFEATED] == 0)
                this.flags[kFLAGS_1.kFLAGS.HEL_AFFECTION_FOLLOWER] = 70;
            if (this.flags[kFLAGS_1.kFLAGS.HEL_AFFECTION_FOLLOWER] < 100 || (this.flags[kFLAGS_1.kFLAGS.HEL_BONUS_POINTS] == 0 && diff < 0)) {
                this.flags[kFLAGS_1.kFLAGS.HEL_AFFECTION_FOLLOWER] += diff;
                if (this.flags[kFLAGS_1.kFLAGS.HEL_AFFECTION_FOLLOWER] >= 100)
                    this.flags[kFLAGS_1.kFLAGS.HEL_AFFECTION_FOLLOWER] = 100;
                if (this.flags[kFLAGS_1.kFLAGS.HEL_AFFECTION_FOLLOWER] < 0)
                    this.flags[kFLAGS_1.kFLAGS.HEL_AFFECTION_FOLLOWER] = 0;
            }
            else if (this.followerHel()) {
                this.flags[kFLAGS_1.kFLAGS.HEL_AFFECTION_FOLLOWER] = 100;
                this.flags[kFLAGS_1.kFLAGS.HEL_BONUS_POINTS] += diff * 3;
                if (diff > 0)
                    if (this.flags[kFLAGS_1.kFLAGS.HEL_BONUS_POINTS] > 150)
                        this.flags[kFLAGS_1.kFLAGS.HEL_BONUS_POINTS] = 150;
                    else if (diff < 0)
                        if (this.flags[kFLAGS_1.kFLAGS.HEL_BONUS_POINTS] < 0)
                            this.flags[kFLAGS_1.kFLAGS.HEL_BONUS_POINTS] = 0;
            }
            return this.flags[kFLAGS_1.kFLAGS.HEL_AFFECTION_FOLLOWER];
            console_1.trace("HEL AFFECTION" + this.flags[kFLAGS_1.kFLAGS.HEL_AFFECTION_FOLLOWER]);
        }
        isHeliaBirthday() {
        ...
        heliaFollowerIntro() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HARPY_QUEEN_EXECUTED] > 0)
                this.outputText("kill");
            else
                this.outputText("bring down");
            this.outputText(" the Harpy Queen... and getting my sister out of that shithole.  For giving me a chance to meet my dad.  For everything.</i>\"  You start to tell her that you're happy to help, but Hel cuts you off, speaking quickly: <i>\"Kiri, Dad, and I have been trying to make it work, living out on the plains - we really have - but Dad's not in any shape to fight and Kiri's no good at it; the plains are just too dangerous for them and Dad's been having nightmares about mom, and...\"</i> she pauses to take a gasping breath, unaccustomed to talking so quickly.");
        ...
        //[I Can't] -The Girt
        iCantLetFireButtsRapeMyCampsButt() {
            this.clearOutput();
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HEL_FOXY_FOURSOME_WARNED] > 0 || this.flags[kFLAGS_1.kFLAGS.HEL_EDRYN_OFFER] > 0)
                this.outputText("like usual");
            this.outputText(", and maybe you and I can spend some quality time together.  Alright?\"</i>");
            this.outputText("\n\nYou nod and tell your fiery lover you'll be sure to do just that.");
            this.flags[kFLAGS_1.kFLAGS.HELIA_FOLLOWER_DISABLED] = 1;
            this.doNext(this.playerMenu);
        }
        //[Come2Camp] -Dirty
        comeToCampHeliaIWantTailInButt() {
            this.clearOutput();
        ...
        afterMoveInBoningAnalFireTail() {
            this.clearOutput();
            this.outputText("<b>An hour later...</b>");
            ...
            this.flags[kFLAGS_1.kFLAGS.HEL_FOLLOWER_LEVEL] = 2;
            this.doNext(this.playerMenu);
        }
        //[Just Friends] -Dirt
        justFriendsWithAnalTailWaifu() {
            this.clearOutput();
            this.outputText("Awkwardly, you spend the next few minutes saying that, while you appreciate the offer and her affections, you're more interested in just being friends with Hel, as you have been for some time.");
            ...
            this.outputText(" to give you a little peck on the cheek.  <i>\"Well, that's that, then.  I guess.  Well, see you around, [name].\"</i>");
            this.outputText("\n\n<i>\"Sure will.\"</i>");
            this.outputText("\n\nYou wave as Hel retreats back toward her own home.");
            this.flags[kFLAGS_1.kFLAGS.HELIA_FOLLOWER_DISABLED] = .5;
        ...
        helFollowersIntro() {
            ...
            if (this.followerKiha() && this.flags[kFLAGS_1.kFLAGS.HEL_INTROS_LEVEL] < 1) {
                this.flags[kFLAGS_1.kFLAGS.HEL_INTROS_LEVEL] = 1;
                this.outputText("You pace around camp, awaiting the return of your new companion.  After several minutes, you notice Kiha sitting behind you, eyeing you with an eyebrow cocked.  Suddenly self-conscious, you stop and face the dragon-girl.");
            ...
            //If Isabella 
            else if (this.isabellaFollower() && this.flags[kFLAGS_1.kFLAGS.HEL_INTROS_LEVEL] < 2) {
                this.flags[kFLAGS_1.kFLAGS.HEL_INTROS_LEVEL] = 2;
                //is at Camp (She and Hel are cool)
                if (this.flags[kFLAGS_1.kFLAGS.HEL_ISABELLA_THREESOME_ENABLED] > 0) {
                    this.outputText("Showing Hel around, you eventually come to the part of your camp inhabited by the towering cowgirl Isabella.  When you arrive, you find Isabella reclining in her armchair, humming a sweet melody as she cleans her tower shield.");
                ...
                //If Isabella is at Camp (And she and Hel are NOT cool)
                    ...
                    //(corruption = high enough to call bitches out when they're hypocrites)
                        ...
                        this.outputText("glower balefully at them, as if to challenge either to invite your opinion of their own sexual 'résumé' with an ill-considered comment.");
                    if (this.isabellaAccent())
                    ...
                    if (this.isabellaAccent())
                        this.outputText("<i>\"You are... velcome,\"</i> Isabella says before collecting some of the scattered belongings from the ground.  You continue your tour, now that the girls are...  not going to murder each other in the middle of the night, at least.");
                    else
                        this.outputText("<i>\"You're... welcome,\"</i> Isabella says before collecting some of the scattered belongings from the ground.  You continue your tour, now that the girls are...  not going to murder each other in the middle of the night, at least.");
                    this.flags[kFLAGS_1.kFLAGS.HEL_ISABELLA_THREESOME_ENABLED] = 1;
                }
            }
            //If Rath is in Camp
            else if (this.flags[kFLAGS_1.kFLAGS.HEL_INTROS_LEVEL] < 3 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0) {
                this.flags[kFLAGS_1.kFLAGS.HEL_INTROS_LEVEL] = 3;
                this.outputText("You take Hel over to the small section of camp Rathazul has cordoned off for his 'laboratory,' surrounding himself with glass tubes and beakers and other, stranger instruments.  You poke through the array of equipment to find old Rath sitting in front of some experiment or another, furiously scribbling notes.  With a light cough, you alert him to your presence.");
            ...
            //If Bimbo Sophie is at Camp:
            else if (this.flags[kFLAGS_1.kFLAGS.HEL_INTROS_LEVEL] < 4 && this.bimboSophie() && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 0) {
                this.flags[kFLAGS_1.kFLAGS.HEL_INTROS_LEVEL] = 4;
                this.outputText("As you help Hel string up her hammock between a few of the rocks inside your perimeter, you hear the tell-tale flapping of useless wings and a clattering of claws on the hard-packed dirt.  You brace for impact as your bimbo harpy prances up to you, planting a big, wet kiss on your cheek");
                //{PC lust goes up if not immunized to luststick}
                this.outputText(".");
                this.outputText("\n\n<i>\"Yay!  My special little cutie is back!</i>\"  Sophie exclaims, giggling as she wraps her feathered arms around you.  \"<i>Is my " + this.player.mf("hunk", "babe") + " interested in like, some 'fun'?\"</i>");
                ...
                if (this.player.inte >= 40 || this.player.inte / 5 + HelFollower.rand(20) + 1 > 10) {
                ...
                this.flags[kFLAGS_1.kFLAGS.HEL_INTROS_LEVEL] = 9001;
                this.playerMenu();
                return;
            }
            this.menu();
        ...
        //[Boot Sophie]
        bimboSophieGetsBooted4Firebutt() {
            this.clearOutput();
            this.outputText("You sigh and pick Sophie up, slinging the harpy over your shoulders.  <i>\"Yaaaay~\"</i> she cheers.  </i>\"I'm going for a ride!\"</i>");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00326] >= 3) {
                ...
                this.flags[kFLAGS_1.kFLAGS.MINO_SONS_HAVE_SOPHIE] = 1;
            }
        ...
        //[Boot Hel]
        bootHelOutForBimboSophie() {
            this.clearOutput();
            this.outputText("<i>\"Nope, you get out,\"</i> you answer, scowling at the salamander.");
        ...
        //[Work it Out]
        workItOutWithSophieAndFireTits() {
            this.clearOutput();
            this.outputText("You cross your arms and tell Hel to deal with it, remarking that you won't just dump Sophie out in the wilderness - she can't take care of herself - but you still want Hel around.");
            ...
            this.flags[kFLAGS_1.kFLAGS.KEEP_HELIA_AND_SOPHIE] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //If Hel is at Camp and Isabella Arrives, neither are cool
        angryHelAndIzzyCampHelHereFirst() {
            this.clearOutput();
            this.outputText("Showing Isabella around, you eventually come to the chaotic, cluttered part of camp inhabited by Hel the salamander, who's currently sitting on her hammock sharpening her scimitar.");
            this.outputText("\n\nYou only have a moment to remember Hel's disdain for the cowgirl before...");
            ...
            if (this.isabellaAccent())
                ...
                this.outputText("W");
            this.outputText("hat are YOU doing here?!\"</i>");
            this.outputText("\n\nBefore the two of them can come to further violence, you leap between them and try to hold them apart.  You suffer the brunt of their aggression for a few moments, but manage to hold them off for the moment until they come down off their combat high.");
            //(Continued Below)
        ...
        heliaFollowerMenu(display = true) {
            if (display) {
                this.clearOutput();
                this.spriteSelect(68);
            }
            if (this.flags[kFLAGS_1.kFLAGS.HEL_FOLLOWER_LEVEL] == 2) {
                if (this.flags[kFLAGS_1.kFLAGS.HELIA_ANAL_TRAINING_OFFERED] == 0 && display && this.player.biggestCockArea() > this.heliaAnalCapacity()) {
                    this.heliaAnalTrainingPrompt();
                    return;
                }
                if (display)
                    this.outputText("You call your salamander lover over, and in a few moments Hel walks your way, hips and tail swaying gaily as she moves.  She wraps an arm around your shoulders, pressing her soft, warm body against yours, and grins.  <i>\"Heyya, lover mine.  You need anything?\"</i>");
                this.menu();
                ...
                if (!kGAMECLASS_1.kGAMECLASS.helScene.pregnancy.isPregnant)
                    this.addButton(5, "Spar", this.sparWithHeliaFirebuttsAreHot);
                else
                    this.outputText("\n\n<b>Helia will not spar or box while pregnant.</b>");
                if (!kGAMECLASS_1.kGAMECLASS.helScene.pregnancy.isPregnant)
                    this.addButton(6, "Box", this.boxWithInCampHel);
                if (this.flags[kFLAGS_1.kFLAGS.HEL_LOVE] == 1 || this.flags[kFLAGS_1.kFLAGS.HEL_LOVE] == -1) {
                    if (this.player.hasCock() && this.player.cockThatFits(this.heliaCapacity()) >= 0 && this.player.lust >= 33 &&
                        !this.helPregnant() && this.flags[kFLAGS_1.kFLAGS.HELSPAWN_AGE] == 0)
                        this.addButton(7, "Have A Kid", this.helSpawnScene.haveAKid);
                }
                this.addButton(9, "Back", this.camp.campLoversMenu);
            }
            else if (this.flags[kFLAGS_1.kFLAGS.HEL_FOLLOWER_LEVEL] == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.HEL_HARPY_QUEEN_DEFEATED] == 1) {
                    if (display)
                        this.outputText("(You've reached the culmination of Helia's current storyline.  Stay tuned for more!)");
                }
                else {
                    if (display)
                        this.outputText("You approach Hel as she's pacing around camp.  She's clad in her normal field attire: a simple scale bikini top and leather thong which supports her scimitar's scabbard.  Her cloak is loosely thrown over her shoulders, giving her a slight measure of protection from the mountain's harsh environs.");
                    if (display)
                        this.outputText("\n\n\"<i>Heya, [name]! Ready to hit the road?</i>\"");
                    //(Display Options: [Dungeon] [Not Yet])
                    this.simpleChoices("Dungeon", kGAMECLASS_1.kGAMECLASS.goToHeliaDungeon, "", undefined, "", undefined, "", undefined, "Not Yet", kGAMECLASS_1.kGAMECLASS.notYet);
                }
            }
        }
        heliaOptions() {
            if (kGAMECLASS_1.kGAMECLASS.helScene.pregnancy.event >= 3 && this.flags[kFLAGS_1.kFLAGS.HELIA_TALK_SEVEN] == 0) {
                this.helSpawnScene.heliaTalkSeven();
                return;
            }
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_AGE] == 1 && this.flags[kFLAGS_1.kFLAGS.HEL_TALK_EIGHT] == 0) {
                this.helSpawnScene.heliaTalkEight();
                return;
            }
            this.menu();
            this.addButton(0, "Discuss", this.talkToHel);
            if (this.model.time.hours >= 21)
                this.addButton(1, "Cuddle", this.hugASmokeyTail);
            else
                this.addButton(2, "Hug", this.hugASmokeyTail);
            if (this.flags[kFLAGS_1.kFLAGS.HELIA_ANAL_TRAINING_OFFERED] > 0 && this.flags[kFLAGS_1.kFLAGS.HELIA_ANAL_TRAINING] < 2 && this.player.biggestCockArea() > this.heliaAnalCapacity() && this.player.hasItem(this.consumables.GOB_ALE, 1))
                this.addButton(3, "Anal Train", this.heliaGapeSceneChoices);
            this.addButton(5, "Bathe", this.takeABath);
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_AGE] == 1)
                this.addButton(7, this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME], this.helSpawnScene.playWithYourKid);
            if (this.flags[kFLAGS_1.kFLAGS.HEL_GUARDING] == 0)
                this.addButton(8, "GuardCamp", this.helGuardToggle);
            else
                this.addButton(8, "NoGuarding", this.helGuardToggle);
        ...
        sparWithHeliaFirebuttsAreHot() {
            this.clearOutput();
            this.outputText("Giving Hel a playful punch on the shoulder, you ask the salamander-girl if she'd be up for a little battle practice.");
            ...
            this.monster.createStatusAffect(StatusAffects_1.StatusAffects.Sparring, 0, 0, 0, 0);
            //No gems.
            this.monster.XP = 1;
            this.monster.gems = 0;
        }
        //Hel Whips [name]'s Ass
        loseToSparringHeliaLikeAButtRapedChump() {
            this.clearOutput();
            //If HP loss) 
            if (this.player.HP < 1)
                this.outputText("You collapse on the ground, overwhelmed by pain and exhaustion caused by the berserker's onslaught.");
            else
                this.outputText("Your arousal is too great, and your mind can no longer focus on anything but a desperate need for release.  Lust robs you of your will, and with buckling knees you collapse.");
        ...
        //PC Whips Hel's Ass
        PCBeatsUpSalamanderSparring() {
            this.clearOutput();
            //(If HP loss) 
            if (this.monster.HP < 1)
                this.outputText("Unable to withstand your onslaught, the salamander collapses to a knee, barely supporting her weight on her sword.");
            else
                this.outputText("Panting heavily, knees snaking, she collapses, heavily leaning upon her sword.");
            this.outputText("\n\n<i>\"Come on, [name],\"</i> Hel groans, swaying unsteadily.  ");
            if (this.monster.HP < 1)
                this.outputText("<i>\"Kick my ass a little harder, why don't you?\"</i>");
            else
                this.outputText("<i>\"Turn me on till I can't think straight, why don't you?\"</i>");
        ...
        talkToHel() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_HEL_TALKS] == 0) {
                this.outputText("You run a hand through Hel's hair and ask the recent addition to your camp if she'd like to talk.");
                this.outputText("\n\n<i>\"Sounds good to me, " + this.player.mf("bud", "babe") + ",\"</i> Hel grins, leading you by the arm to a rock near her hammock.  The two of you sit yourselves down, with Hel locking her fingers through yours in her lap.  <i>\"So what's on your mind, lover mine?\"</i>");
                ...
                if (this.player.tou < 50)
                    this.outputText("You cough and gag, eyes misting as the pure-grain booze burns your throat worse than hot coals.  Hel laughs riotously, slapping you on the back hard enough to cause booze to snort out through your nose.");
                else
                    this.outputText("You knock back the stein easily, your super-human endurance keeping you from choking on the powerful brew.  Impressed, Hel gives you a high-five and throws her head back in a laugh.");
            ...
            //Hel Talk 2
            else if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_HEL_TALKS] == 1) {
                this.outputText("Sitting Hel down, you ask if she's got any stories she'd like to share.  After all, she's been adventuring for years - surely she's got some fun tales to tell.");
            ...
            //Hel Talk 5(C)
            else if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_HEL_TALKS] == 4) {
                this.outputText("<i>\"Hey, [name],\"</i> Hel says, slipping out of your grasp with a come-hither wag of her finger, <i>\"wanna have a drink with me?\"</i>");
                this.outputText("\n\n<i>\"Sure,\"</i> you say, following Hel over to her still.");
                this.outputText("\n\nShe pours out two tankards of ");
                if (this.helSpawnScene.helPregnant())
                    this.outputText("beer ");
                else
                    this.outputText("fizzy, non-alcoholic beer ");
                this.outputText("and, swinging onto your lap, clinks her glass against yours.  <i>\"To loving friends and an awesome new home,\"</i> she says, raising her tankard high before knocking it back.  Before you can finish yours, Hel belches loudly and violently shakes her head");
                if (!this.helSpawnScene.helPregnant())
                    this.outputText(", her eyes crossing a little.  Looks like she was dipping in before you got here...");
                else
                    this.outputText(".");
                this.outputText("\n\nHel laughs ");
                if (!this.helSpawnScene.helPregnant())
                ...
                if (!this.helSpawnScene.helPregnant()) {
                    ...
                    if (this.kihaFollower.followerKiha())
                        this.outputText("further pissing off Kiha, who throws a rock at Hel, and ");
                    this.outputText("shooting up like a beacon over the wasteland.");
                }
                else {
                    this.outputText(" and launches into a series of debauched jokes. You answer her, lewd jest for jest.");
                }
                ...
                if (this.player.tallness < 60)
                    ...
                    this.outputText("down ");
                this.outputText("into a hug, mashing your face into her warm, soft bosom.  You struggle for air, finally bursting out of her tight cleavage.  Hel chuckles, running her hand through your [hair] as her fiery tail wags gaily behind her.");
            ...
            //Hel Talk 6 (Needs Isabella and Kiha at camp; at least 1 gem)(C)
            else if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_HEL_TALKS] == 5 && this.player.gems >= 1 && this.isabellaFollower() && this.kihaFollower.followerKiha()) {
                var gems = 0;
                this.outputText("<i>\"Hey, [name],\"</i> Hel says with a sly grin.  <i>\"Me, Izzy, and spitfire were just playing a little game.  Wanna deal in?\"</i>");
                ...
                if (!this.isabellaAccent())
                    this.outputText(", obviously only somewhat interested");
                this.outputText(".");
                if (this.isabellaAccent())
                ...
                //{Make an INT check}
                if (HelFollower.rand(20) + 1 + this.player.inte / 5 >= 15) {
                    //[Successful]
                    ...
                    gems = 40 + HelFollower.rand(40);
                }
                //[Fail 1]
                else if (HelFollower.rand(3) == 0) {
                    ...
                    gems = -5 - HelFollower.rand(10);
                }
                //[Fail 2]
                else if (HelFollower.rand(2) == 0) {
                    if (this.isabellaAccent()) {
                ...
                this.flags[kFLAGS_1.kFLAGS.FOLLOWER_HEL_TALKS] = 1;
                this.talkToHel();
                return;
            }
            this.flags[kFLAGS_1.kFLAGS.FOLLOWER_HEL_TALKS]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Shut up, slut
        shutUpHelTalks() {
            this.clearOutput();
            this.outputText("Quickly you interject before Helia can continue with the story; you've heard quite enough.  <i>\"Whaaaat?  We were just getting to the good part...\"</i>  Hel whines, rolling her eyes.  <i>\"Hey, you're the one who asked!\"</i>");
        ...
        hugASmokeyTail() {
            ...
            if (this.model.time.hours >= 21) {
                ...
                if (this.player.tailType > appearanceDefs_1.TAIL_TYPE_NONE)
                    this.outputText("s");
                this.outputText(" intertwined.  <i>\"Oh, this is nice,\"</i> Hel laughs, running her long, scaled fingers through your hair.  <i>\"So, you wanna stay with me tonight, lover mine?  I'd appreciate the company....\"</i>");
        ...
        //Rough Sex
        //Into Text
        heliaRoughSex(output = true) {
            if (output) {
                this.clearOutput();
                this.outputText("<i>\"Mmm, need to blow off some steam, lover?\"</i>  Hel grins, reaching around to undo the straps of her scale bikini.  <i>\"Well, I'm all for that!\"</i>");
            }
            var buttons = 0;
            //(Display Options: 
            ...
            if (this.player.lust >= 33 && this.player.findPerk(PerkLib_1.PerkLib.Incorporeality) >= 0 && this.izmaFollower() && this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0 && buttons < 9) {
        ...
        heliaCampPossession() {
            this.clearOutput();
            this.outputText("With a coy grin, you let your ghostly attributes go transparent, and ask Hel if she'd mind taking an extra passenger for a little bit.");
        ...
        inCampHelNagaLuv() {
            this.clearOutput();
            var x = this.player.cockThatFits(this.heliaCapacity());
            if (x < 0)
                x = this.player.smallestCockIndex();
            this.outputText("You slither over to the salamander and circle around her, your serpentine lower body trailing around her legs as you sweep Helia into a tight embrace.  She grins wolfishly, pressing her lips to yours; you let her tongue enter your mouth, entwining with your tongue, letting her distract herself as you coil more and more of your snake-body around the salamander.  By the time Hel realizes what you're up to, there isn't much she can do about it - you grab her arms and press them to her sides as you bind her up past the waist, wrapping your lover in your lengthy, serpentine form.");
            ...
            this.outputText("\n\nUnable to move much in your serpentine embrace, Hel begins to rapidly contract her vaginal and anal muscles, squeezing and grinding against your " + this.cockDescript(x) + " and tip.  Content to close your eyes and bask in the pleasures of your lover, ready to lose yourself in pleasure.  You relax, leaning back on yourself as you buck your hips into your lover's sweet hot box, flick your tail inside her ass, and play your tongue around her mouth, tasting her warm saliva and the aftertaste of beer.");
            this.outputText("\n\nYou cum easily, only a small grunt escaping your lips as Hel's delicious cunt brings you over, pulling your " + this.cockDescript(x) + " deep into her and tightening your hold around her.  The sudden squeeze is the last hurrah as you empty your ");
            if (this.player.balls > 0)
                this.outputText("[balls]");
            else
                this.outputText("load");
            this.outputText(" well into her womb.  Your tail spasms as you cum, running wild inside Hel's rectum until she cums too, yelping into your open mouth as she climaxes a moment after you, girlcum squirting out of her twat until your [hips] are thoroughly soaked.");
        ...
        centaurMountsCampHel() {
            ...
            if (this.player.cockArea(x) > this.heliaCapacity())
                this.outputText("she can cram in, the rest of your length twitching between her legs");
            else
                this.outputText("you have to offer her");
            this.outputText(".  Finally, though, you manage to settle down, your breath coming ragged as Hel's vaginal muscles clamp and release, gently massaging your shaft with expert movements, always keeping you on edge until...");
            this.outputText("\n\nTHWACK!");
            this.outputText("\n\nYou start forward as a rough tail-slap lands on your flank.  You reflexively step forward, your equine muscles acting on instinct...  which only serves to rock Hel off and down again on your " + this.cockDescript(x) + ", her impromptu harness moving her like a swing. You arch your back as the movement hammers Hel down on your cock like a free-swinging onahole, but the moment of pleasure lurches out of control when she gives you another hard tail-swat, and another; your insticts carry you forward until you reach a full canter. Shudders and twitches wrack your body as your own motions rock Hel on and off your [cock], slamming her back down on your shaft again and again.");
        ...
        heliaFollowerTentafuck() {
            this.clearOutput();
            this.outputText("With a flourish you pull your [armor] off, exposing your writhing mass of tentacle-cocks for Hel`s enjoyment.  \"<i>Wow, think you got enough of th--urf!</i>\" the salamander starts to say before you shut her up with one of your tentacle pricks, lashing forward and plugging her mouth.  Hel staggers back, flailing around before grabbing the cock you've shoved down her throat and giving it a rough tug.  Just as she nearly succeeds in pulling it out, your other wriggling members wrap around her thick thighs; you pull her in toward you, grabbing her shoulders as your pricks peel off her bikini bottom to reveal the smooth face of Helia's crotch.");
            ...
            if (this.player.balls > 0)
                ...
                this.outputText("wriggling tentacles");
            this.outputText(" feel painfully empty and white slush pours from all her holes, painting the ground white beneath her dangling feet.");
        ...
        boxWithInCampHel() {
            ...
            if (this.player.inte / 20 + 1 + HelFollower.rand(20) >= 13) {
            ...
            //If PC fails the Check:  
                ...
                if (this.player.lust >= 33 && this.player.hasCock()) {
                    if (this.player.cockThatFits(this.helCapacity()) >= 0) {
                        this.muddyLizardFeet();
                        return;
                    }
                }
                this.heliaRoughSex(false);
        ...
        muddyLizardFeet() {
            ...
            if (this.player.balls > 0)
                this.outputText("her heel coming to caress your taut sack");
            else if (this.player.hasVagina())
                this.outputText("her heel brushing against the nub of your [clit]");
            else
                this.outputText("her heel going so low as to brush your taint, making your [asshole] clench in surprise before she moves back up your length");
            this.outputText(".  You groan lustily as her toes and soft sole jerk you off, gently urging the tight knot of pleasure in your gut to fruition.  Cupping one of her hefty tits, Hel licks her lips as the first thick smears of pre leak from your cock's [cockHead biggest], smearing onto her long-clawed toes.");
            ...
            if (this.player.biggestCockArea() > this.heliaCapacity())
                this.outputText("you feel your [cockHead biggest] against the lips of her cervix, as fully into her as you can go");
            else
                this.outputText("your groin meets Helia's, your [cock] wholly enveloped within her");
            this.outputText(".  Before you can think to withdraw, Hel tightens her hold on you, whispering huskily, \"<i>Just leave it... just for a second, [name].  Oh, God,</i>\" she moans, her eyes closing as she savors the feeling of you buried so deep inside her, your slick prick twitching as her walls massage it, milking it of the precum that freely flows from your tip.");
        ...
        takeABath() {
            ...
            //{Repeat Intro (If you taught Hel to swin; else, play 1st Time)}
                ...
                this.clearOutput();
                this.outputText("You ruffle Hel's hair and ask if the fiery salamander's up for a dip.");
                ...
                if (this.player.armorName == "goo armor" && this.player.lust >= 33 && false) {
        ...
        teachHelToSwim() {
            this.clearOutput();
            this.outputText("Putting a hand on Hel's shoulder, you offer to teach her how to swim.");
            ...
            this.flags[kFLAGS_1.kFLAGS.HEL_CAN_SWIM] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Threesomes
        heliaThreesomes() {
            this.clearOutput();
            this.outputText("You slip an arm around Hel's waist and ask if she's up for some... group activities?");
            ...
            if ((this.player.armorName == "goo armor" || this.flags[kFLAGS_1.kFLAGS.VALARIA_AT_CAMP] == 1) && this.player.lust >= 33 && this.player.hasVagina()) {
        ...
        heliaAndVapula() {
            this.clearOutput();
            var x = this.player.cockThatFits(this.heliaCapacity());
            var y = this.player.cockThatFits2(this.heliaCapacity());
            this.outputText("You gab Hel and start for the edge of camp, where a certain succubus dwells....");
            ...
            this.outputText("\n\nYou feel hands wandering across your body, Hel slowly, sensuously, pulling off your [armor].  Soon, the two of you are bare, clothes and weapons discarded all around the succubus.  You push Hel over, grinding your hard " + this.cockDescript(x) + " between her legs.  As you grope the salamander girl's body, you gesture at Vapula and tell her to come closer so that you can stroke her, too.  You begin caressing each other, spending a few moments in languid pleasure until your " + this.cockDescript(x) + " looks ready to explode.");
            //Combine, Body
            ...
            this.outputText("\n\nThis libertine orgy cannot last indefinitely, and even your girls are trembling convulsively, ready to reach their climax. You manage to slide your " + this.cockDescript(x) + " up the reptile girl's twat a few more times before blasting her with your spooge.  You fill Hel's interior, pouring cum like a torrent into her womb");
            //[IF cum production massive: 
            if (this.player.cumQ() >= 750)
                this.outputText(" until her belly swells and starts spurting ropes of jism back out of her love-tunnel");
            this.outputText(".  Your junk palpitates and bulges as globs push their way out of your shaft before being absorbed by her needy pussy, and her skin and scales seem to literally boil with consumed lust.  At the peak of your orgasm, you stare at your girls' faces: Hel's is nothing but complete, insensate bliss, while Vapula is literally crying in ecstasy, tears of joy streaming down her cheeks.");
            this.outputText("\n\nSeeing how much pleasure you're giving them is quite touching, and you give each of them a long, ardent kiss, letting each girl know how the other tastes like.  At last, when your " + this.cockDescript(x) + " has unloaded its last rope of jism, you pull out and break the kiss.  Hel pants and sighs, utterly drained; you see her tail popping out of Vapula's ass, and the released succubus just falls on her back, cunt exposed and mouth open in blissful exhaustion.");
            ...
            if (!this.followerHel()) {
                this.outputText("  You kiss her and ask if she'll be able to find her way back to her home.");
        ...
        campHelAndKihaThreeSome() {
            ...
            if (this.player.gender == 1)
                this.addButton(0, "Next", this.dudeHeliaAndKihaThreeSome);
            else if (this.player.gender == 2)
                this.addButton(0, "Next", this.girlsThreesomeHelAndKiha);
            else {
        ...
        girlsThreesomeHelAndKiha() {
            ...
            if (this.player.lactationQ() >= 50)
                this.outputText("  A shudder rocks you as the first trickles of milk seep from your teats, a small stream soon flowing out of you into the twin lizards' mouths.  Their cheeks bulge between swallows, but both coo happily as they suckle, their forked tongues lapping up every drop you have to offer.");
            //{If PC has a dick:}
            if (this.player.hasCock())
                this.outputText("  Even as the girls worship your [chest], you feel a sudden pressure on [oneCock].  Hel's tail deviates from your cunt for a moment, instead wrapping lovingly around your prick.  A groan escapes your lips as her hot leathery tail coils around your manhood before looping back to tease your clitty, ensuring that your dick won't be left out of the fun.  You smile and stroke her hair, eager to get to the main course.");
        ...
        helXValeriaFemalePC() {
            this.clearOutput();
            this.outputText("In the blink of an eye, Valeria slithers around Hel's body, almost completely encasing her in thick blue goo, leaving only her head and her resplendent reptilian rack bare.  Hel grins at you, putting a hand to her crotch and taking a handful of goo between her fingers.  With a bit of effort, she shapes a pair of thick blue pricks out of her groin, each shimmering in the sunlight as Hel strokes Valeria's new appendages, coaxing out a drop of slimey pre from both tips.  Valeria's face reappears on Hel's flat belly a moment after she's done, looking down to her groin with glee as she further shapes the erect pillars of slime, morphing them into a thick knotty doggy-dick on top, and a huge-flared horsecock on bottom.  You lick your lips as the dog-dick's knot inflates enticingly.");
        ...
        helGuardToggle() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HEL_GUARDING] == 0) {
                this.outputText("You ask Hel if she wouldn't mind watching the perimeter for a few hours during the night.");
                this.outputText("\n\n\"<i>Sure thing, [name]!  I've got your back!</i>\" she says, her tail reaching around to give you a pop on the [butt].");
                this.flags[kFLAGS_1.kFLAGS.HEL_GUARDING] = 1;
            }
            //[If Hel IS guarding Camp]
            else {
                this.outputText("You tell Hel she doesn't need to keep watch at night anymore.");
                this.outputText("\n\n\"<i>Is that a fact?  Well, I guess that gives us more time to party at night!</i>\"");
                this.flags[kFLAGS_1.kFLAGS.HEL_GUARDING] = 0;
            }
            this.menu();
        ...
        heliaAnalTrainingPrompt() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.HELIA_ANAL_TRAINING_OFFERED] = 1;
            this.outputText("“<i>Hey there, lover mine. Got a minute?</i>” Helia asks with dangerous glint in her eyes.");
            ...
            if (this.player.tallness < 60)
                this.outputText("her bosom towering over you");
            else if (this.player.tallness < 72)
                this.outputText("towering over you");
            else if (this.player.tallness < 90)
                this.outputText("meeting you eye to eye");
            else
                this.outputText("looking up at you confidently");
            this.outputText(" as she boldly reaches into your [armor] to squeeze your ");
            if (this.player.cockTotal() > 1)
                this.outputText("biggest ");
            ...
            //Helia menu
            this.heliaFollowerMenu(false);
        }
        //Give Her Ale
        giveHeliaAnalTraining() {
            this.clearOutput();
            this.outputText("You hand Helia a bottle of goblin ale and question if she’s sure this won’t make her loose.");
            ...
            if (this.player.balls > 0)
                this.outputText("She tilts forward to press her chin into your [sack] and begins to lather your [balls] with frothy, warm, salamander spit. One hand hefts a weighty nut as she works, caressing it as if it would somehow coax the cum out of it. ");
            this.outputText("Helia slides her palms along either side of your urethra, letting her fingers handle the central, sensitive bit on the underside, following in the path of slick saliva she left for them to follow. She rubs her nose into the sensitive area just below your [cockHead biggest]. You grunt as pre-cum begins to pour in response, your bloated boner flexing atop Helia’s head as you feel a dangerously powerful orgasm welling up within you.");
            ...
            if (this.player.balls > 0)
                this.outputText(", hard enough to lift your nuts in their [sack]");
            this.outputText(", and you erupt, cumming a steamy hot load of spunk straight onto Helia’s face, head, and back.");
            if (this.player.cumQ() < 250)
                this.outputText(" You run out before long, but it’s still enough to make her a white painted mess. She licks the excess from her upper lip and shudders happily.");
            else if (this.player.cumQ() < 2000)
                this.outputText(" You spurt rope after rope onto her, actually drenching her hair with alabaster moisture. Her back and face look equally smothered with spooge when you finish. She’s happy to wipe the goop out of her eyes and shovel it into her mouth, swallowing it down with a satisfied smile.");
            else {
                this.outputText(" You pour ivory waves of spooge across her body, soaking her from head to toe with the fruit of your loins, liberally basting her with baby-batter. She groans as the excess washes out around her knees");
                if (this.player.cumQ() >= 3000)
                    this.outputText(", but you keep cumming, cascading fresh waves onto her until there’s not a single part of her that isn’t stained and dripping with your salty outflow");
                this.outputText(". Helia licks her hands clean, wipes her eyes and devours that as well, and then gives you a dripping-wet, sensuous smile.");
            }
            ...
            this.flags[kFLAGS_1.kFLAGS.HELIA_ANAL_TRAINING] = 1;
            if (this.player.biggestCockArea() < this.helAnalCapacity()) {
                this.outputText("then maybe I can handle you, my hung " + this.player.mf("stud", "breeder") + ".");
            }
            else {
                this.outputText("then maybe we can see about trying something bigger.");
            }
            this.outputText("</i>”");
        ...
        heliaGapeSceneChoices() {
            if (this.flags[kFLAGS_1.kFLAGS.HELIA_ANAL_TRAINING] == 0)
                this.giveHeliaAnalTraining();
            else if (this.flags[kFLAGS_1.kFLAGS.HELIA_ANAL_TRAINING] == 1)
                this.heliaAnalTrainingPartTwo();
        }
        //Anal Training #2
        heliaAnalTrainingPartTwo() {
            this.player.consumeItem(this.consumables.GOB_ALE, 1);
            this.clearOutput();
            this.outputText("Pulling out another bottle of ale you dangle it before the slutty salamander, saying, “<i>A present for my favorite buttslut.</i>”");
        ...
        yesMakeHeliaAGapeSlut() {
            ...
            if (this.player.cumQ() < 1000)
                this.outputText(", ignoring the way your sheer volume of spunk leaks from the corners of her mouth and nose, her belly gradually rounding with cum in addition to thick dildo");
            this.outputText(". The slutty salamander eventually pulls it off and ");
            if (this.player.cumQ() < 2000)
                this.outputText("squeezes a last few dollops onto her face, letting them stain her with your scent.");
            else
                this.outputText("allows you to hose her down with your ongoing waves of salty jism, soaking her in your sexual scent.");
        ...
        helPartyMenu() {
            this.menu();
            //heliaDrinks
            if (this.flags[kFLAGS_1.kFLAGS.HELIA_BDAY_DRINKS] == 0)
                this.addButton(0, "Drinks", this.heliaDrinks);
            //heliaHakonAndKiri
            if (this.flags[kFLAGS_1.kFLAGS.HELIA_BDAY_HAKON_AND_KIRI] == 0)
                this.addButton(1, "Hakon 'n Kiri", this.heliaHakonAndKiri);
            //heliaPhoenixes
            if (this.flags[kFLAGS_1.kFLAGS.HELIA_BDAY_PHOENIXES] == 0)
                this.addButton(2, "Phoenixes", this.heliaPhoenixes);
            //heliaAndFoxTwins
            if (this.flags[kFLAGS_1.kFLAGS.HELIA_BDAY_FOX_TWINS] == 0)
                this.addButton(3, "Fox Twins", this.heliaAndFoxTwins);
            //leaveWithoutSex
            this.addButton(4, "Leave", this.leaveWithoutSex);
            //leaveWithGirls
            if (this.flags[kFLAGS_1.kFLAGS.HELIA_BDAY_FOX_TWINS] > 0)
                this.addButton(5, "Leave w/Girls", this.leaveWithGirls);
        }
        //Go with Her
        goWithHelia() {
            this.clearOutput();
            this.outputText("\"<i>Sounds like fun.  Let's go,</i>\" you say, offering your arm to Hel.  She grins and takes it, holding herself close as she takes the lead, steady paces quickly drawing you out into the vast deserts of Mareth beside your lover.");
            //{If Kiha, Isabella, and/or Valeria are at camp:}
            if (this.isabellaFollower() || this.followerKiha() || this.flags[kFLAGS_1.kFLAGS.VALARIA_AT_CAMP] == 1) {
                this.outputText("  Looking over your shoulder as you depart, though, you notice that camp looks particularly... empty. Perhaps your other camp-mate");
                if (this.camp.companionsCount() > 1)
                    this.outputText("s are");
                else
                    this.outputText(" is");
                this.outputText(" out, too? You shrug. You and Hel aren't the only ones with lives, you suppose.");
            }
            ...
            //if less than 7' PC: 
            if (this.player.tallness < 84)
                this.outputText("sweeping you off your feet");
            else
                this.outputText("hanging off you");
            this.outputText(" as you approach the great gates.  The only one on gate duty today is Urta, the grey-coated fox curled up under a small awning beside the gate with a huge canteen resting beside you.  Her centauress partner is noticeably missing, but Urta still gives you a wave and a grin you can't quite read.");
            this.outputText("\n\n\"<i>Hey, cutie,</i>\" she says with a wink, pushing open the door for you.");
            //If PC did UrtaQuest: 
            this.outputText("\n\n");
            if (this.flags[kFLAGS_1.kFLAGS.URTA_MET_HEL] == 1)
                this.outputText("From the quick look she and the salamander exchange, you get the feeling they've met before. Weird. Still, ");
            this.outputText("Urta gives you a small nod as Hel leads you into town, past the half-empty guard post and into the bustling main street.  The market way's particularly busy in the late afternoon, bustling with activity as merchants hawk their wares and the first of the street-walkers start to come out, standing in seductive poses in the shade of the alleys.  More than a few send catcalls your way, a few even offering discounts for couples.");
            ...
            if (this.player.tallness <= 72)
                this.outputText(", her head resting on your shoulder");
            this.outputText(".  \"<i>Hey, thanks for coming, [name],</i>\" she says quietly, squeezing your arm, \"<i>Kiri's done nothing but talk about you since the tower.  I think someone has a crush...</i>\"");
            ...
            this.outputText(HelFollower.formatStringArray(list) + ". You turn to Helia and cock a grin as you see the surprise etched on her face, followed by the growing smile.  \"<i>Happy birthday, Helia!</i>\" they all shout out at once, raising mugs frothing over with beer.");
            /*
                addToList("Edryn");
            ...
            */
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HARPY_QUEEN_EXECUTED] > 0)
                this.outputText("who forgave us for the queen's death");
            else
                this.outputText("who wanted to be friends still, even after the Tower");
            this.outputText(" and... it sort of became a thing.  Hope you don't mind!</i>\"");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HARPY_QUEEN_EXECUTED] > 0)
                this.outputText("finally killing that bitch of a queen");
            else
                this.outputText("setting the queen right, but leaving her alive for when it's finally time to bring the fight to Lethice");
            this.outputText(".  You nod at his thanks, and his hand is soon replaced by Helia's as she grabs you on her way toward the gigantic cake.  The towering white confectionary seems more than big enough to feed everyone in the group, a huge extravagance on the part of her family.  You hear a quiet whisper about ");
            if (this.flags[kFLAGS_1.kFLAGS.FREED_VALA] == 1)
                this.outputText("a certain waitress fairy having... supplied the icing herself");
            else
                this.outputText("a certain minotaur chef having supplied the icing himself");
            this.outputText(" as Hel is handed an oversized knife and urged to blow out the candles atop it, arranged into a perfect 23.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HEL_FOXY_FOURSOME_WARNED] == 1)
                this.outputText("a pair of lovely fox-eared herms");
            else
                this.outputText("Miko and Mai");
            this.outputText(" burst out, their big breasts covered in nothing but tiny pink pasties and an all-too-small thong sheathing their red pricks.  Arm in arm with tail wagging furiously, they cry out \"<i>Happy birthday, Hel!</i>\" before hopping out and slipping into the salamander's arms.  \"<i>Ladies,</i>\" Hel says, grinning like an idiot, a moment before she's pushed into a waiting chair behind her.  One of the girl's busts is quickly shoved into her face as the rest of the group laughs and starts passing out another round of drinks.");
        ...
        heliaDrinks() {
            this.clearOutput();
            //Drinks
            this.outputText("You saunter up to the bar, where the staff have laid out more than enough beers for the entire party.  Edryn and a handful of phoenixes are milling around, exchanging tips for swordsmanship: Edryn advocating charging in with a greatweapon swinging, as the phoenixes try and explain their shield-wall tactics.  You knock back a drink and listen in, watching with interest as the phoenix girls get progressively more and more flustered");
            //if PC is male:
            if (this.player.hasCock() && this.player.hasVagina())
                this.outputText(" just as you do");
            this.outputText(" in the presence of the steadily mounting pheromone cloud around the lusty centauress.  Before you've finished your drink, all the half-harpies are sporting sizable tents in their britches and are subtly sniffing around, trying to figure out what's happening to them... just before Edryn grabs the lead phoenix by the arm and leads her off into one of the back rooms, shooting the others a wink and a flicking tail over her drooling horse-sex.  The others are quick to follow.");
            this.flags[kFLAGS_1.kFLAGS.HELIA_BDAY_DRINKS] = 1;
            this.helPartyMenu();
        }
        //Hakon & Kiri
        heliaHakonAndKiri() {
            this.clearOutput();
            this.outputText("You meander over to the veteran salamander and his half-harpy daughter, and quickly find yourself surrounded by fluttering red feathers as Kiri practically jumps on you, hugging you.  \"<i>Hey, [name], long time no see,</i>\" she says, smiling demurely as she leads you back to where she and her father were standing, removed from the real bustle of the party.");
            this.outputText("\n\n\"<i>How're you holding up, " + this.player.mf("son", "kid") + "?</i>\" Hakon says, clapping you on the shoulder and passing you another beer.  \"<i>Hel tells me you're quite a handful.  Treating my girl right, I hope?</i>\"");
            this.outputText("\n\nYou falter at that, not quite sure how to address your lover's father in that regard, but the old salamander just laughs and gives you another rough shoulder-clap.  \"<i>Just teasing, " + this.player.mf("boy", "girl"));
            this.outputText(".  We salamanders are a bit more open about that sort of thing, though, if you haven't noticed.  Helia's regaled us with more than a few of her 'stories,' let me tell you. Isn't that right, sweetheart?</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.HELIA_BDAY_HAKON_AND_KIRI] = 1;
            this.helPartyMenu();
        }
        //Phoenixes
        heliaPhoenixes() {
            this.clearOutput();
            this.outputText("You approach the small squad of phoenixes milling around the cake, mostly talking amongst themselves.  They nod as you approach, a bit wary of the person who recently kicked their asses inside out.  Still, they nod respectfully as you approach.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HARPY_QUEEN_EXECUTED] > 0)
                this.outputText("dead");
            else
                this.outputText("deposed");
            this.outputText(", he thought it would be good to try and at least... know each other.  I'm not complaining.  Things like this party... never would have seen anything like this under Queen Calais.  It's nice to see new things, meet new people.</i>\"");
            this.outputText("\n\nYou see a few glances going toward Edryn and the fox twins");
            if (this.followerKiha() && this.isabellaFollower())
                this.outputText(", then to the fiery dragoness and the ultra-busty cowgirl talking in the corner");
            this.outputText(", and you figure you know what they mean.");
            this.flags[kFLAGS_1.kFLAGS.HELIA_BDAY_PHOENIXES] = 1;
            this.helPartyMenu();
        }
        //Hel & Fox Twins
        heliaAndFoxTwins() {
            this.clearOutput();
            this.outputText("You approach the foxy strippers, still well into giving Helia a dual lap-dance, their red puppy peckers poking well out of their tiny thongs.  They grin as you approach, and Hel pulls you into her lap, and you quickly find yourself with a pair of big, soft breasts to rest your head on, courtesy of ");
            if (this.flags[kFLAGS_1.kFLAGS.HEL_FOXY_FOURSOME_WARNED] == 1)
                this.outputText("Mai");
            else
                this.outputText("one of the foxes");
            this.outputText(".  Hel plants a deep, serpent-tongue filled kiss on your lips, nuzzling her cheek on your [chest].");
            ...
            this.flags[kFLAGS_1.kFLAGS.HELIA_BDAY_FOX_TWINS] = 1;
            this.helPartyMenu();
        }
        //Leave {Or: Joke's on you, no (special) birthday sex!}
        leaveWithoutSex() {
            this.clearOutput();
            this.outputText("You decide you've had about enough of the party for now. You slip over to Hel and tell her you're ready to head out when she is.");
        ...
        leaveWithGirls() {
            ...
            if (this.player.gender == 3) {
                ...
                this.doNext(this.helScene.foxyFluffGirlsFuckSex);
            else
                this.doNext(this.helScene.foxyFluffsFoursomeAsMale);
        }
        helAndSluttyHarpy() {
            if (!this.player.hasCock() && !this.player.hasVagina()) {
                this.helAndSluttyHarpyGenderless();
                return;
            }
            else if (this.player.hasCock() && !this.player.hasVagina()) {
                this.helAndSluttyHarpyMale();
                return;
            }
            else if (!this.player.hasCock() && this.player.hasVagina()) {
                this.helAndSluttyHarpyFemale();
                return;
            }
            // Choice
            this.menu();
        ...
        helAndSluttyHarpyMale() {
            this.clearOutput();
            this.outputText("You take Helia’s hand and lead her through the camp in an attempt to find someone to include in your threesome. After some searching you see Sophie sitting on a rock and get a wonderful idea. You ask Hel if she would be ok with a threesome with the busty harpy. Her smile turns to a serious frown for a moment.");
            ...
            if (this.player.biggestCockLength() >= 8)
                this.outputText(" no longer be hilted inside");
            else
                this.outputText(" slip out of");
            this.outputText(" her sodden cunt, and hear Hel gasp for air. Before the birdslut can comment on the matter, you spin her around and push her down onto Helia, leaving them face to face.");
            ...
            if (this.player.cocks.length == 1) {
                ...
                this.outputText(" to boil over. White jissom blasts from your [cock], coating Helia and Sophie’s stomachs, as well as the underside of the pair’s tits.");
                if (this.player.vaginas.length > 0)
                    this.outputText(" Your unused [vagina] cums with your cock in a show of sympathetic orgasm, coating your thighs with femcum.");
            }
            // 2-3 cocks
                ...
                if (this.player.cumQ() < 500)
                    this.outputText(" with your cum");
                else {
                    this.outputText(" full of cum");
                    if (this.player.cumQ() <= 1000) {
                        this.outputText(" until it overflows");
                        if (this.player.cumQ() >= 5000)
                            this.outputText(", pooling around your knees");
                    }
                }
                this.outputText(".");
                if (this.player.cocks.length == 3)
                    this.outputText(" Your unused cock splatters the two with hot, white jizz.");
                if (this.player.vaginas.length > 0)
                    this.outputText(" Your unused [vagina] cums with your cocks in a show of sympathetic orgasm, coating your thighs with femcum.");
            }
            // > 4 cocks
            else {
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.HELIA_ANAL_TRAINING] >= 2)
                    this.outputText(" gaped");
                this.outputText(" asshole. She gasps at the sudden double penetration, and you reciprocate because of the furnace-like heat of both her holes. Your [cock biggest3] lines up with Sophie’s slutty pussy and drives home while your [cock smallest] does the same to her ass."); // Haha look at me being a lazy shit.
                ...
                if (this.player.balls > 0)
                    ...
                    this.outputText(" groin");
                this.outputText(". The two girls seem to share your problem, their teeth clenched and clinging tightly to each other trying to resist. Seeing their clearly shared pleasure in the moment puts you over the edge, and you let loose the torrent of liquid lust from [eachCock]. Sophie cums as the tsunami of jizz floods her levies, the copious amount spilling back out of her holes and pooling around your knees.");
                if (this.player.cocks.length > 4)
                    this.outputText(" Your extra cocks spray pearly cum all over the nearby ground.");
                if (this.player.vaginas.length > 0)
                    this.outputText(" Your unused [vagina] cums with your cocks in sympathetic orgasm, coating your thighs with femcum.");
            }
            // Merge
        ...
        helAndSluttyHarpyFemale() {
            ...
            if (this.player.cocks.length >= 1) {
                this.outputText("The blasts spatter against the underside of Sophie’s gigantic melons and slide off Hel’s sides like an overfull cream pastry.");
            }
            // Continue
        ...
        helAndSluttyHarpyGenderless() {
            this.clearOutput();
            this.outputText("You walk up to Helia and ask if she would be up for fucking you with that wondrous tail of hers. She smiles slyly and wraps her arms around you. You take her response as an unspoken yes, hugging her back and pulling her off to find a better place for your loving.");
    ...
    exports.HelFollower = HelFollower;
});
//# sourceMappingURL=HelFollower.js.map