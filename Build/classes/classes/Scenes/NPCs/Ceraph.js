define(["require", "exports", "../../Monster", "../../StatusAffects", "../../GlobalFlags/kFLAGS", "../../PerkLib", "../../../console", "../../CockTypesEnum", "../../../../includes/appearanceDefs", "../../Appearance"], function (require, exports, Monster_1, StatusAffects_1, kFLAGS_1, PerkLib_1, console_1, CockTypesEnum_1, appearanceDefs_1, Appearance_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Ceraph extends Monster_1.Monster {
        //[IN COMBAT SPECIALS]
        ...
        ceraphSpecial1() {
            ...
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Uber) < 0) {
                ...
                //(Next Round)
                if (this.statusAffectv1(StatusAffects_1.StatusAffects.Uber) == 0) {
                    this.addStatusValue(StatusAffects_1.StatusAffects.Uber, 1, 1);
                    if (Ceraph.rand(2) == 0)
                        this.outputText("The demonic hermaphrodite begins forging demonic symbols in the air before her, each glowing brilliant pink before they blur away in a haze.", false);
                    else
                        this.outputText("The demonette makes obscene motions with her hands, as if masturbating an imaginary cock or vagina while her hands are wreathed in pink flames.", false);
                    this.outputText("  <b>She's about to unleash something huge!</b>", false);
                    if (this.player.inte > 50)
                        this.outputText("  You should probably wait so you'll have a chance to avoid whatever's coming.", false);
                }
                //FIRE!
                else {
        ...
        ceraphSpecial2() {
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Bound) < 0) {
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Bound, 2 + Ceraph.rand(5), 0, 0, 0);
            }
            //[SPECIAL WHILE PC RESTRAINED]
                ...
                //[SPECIAL 2 WHILE PC RESTRAINED]
                    ...
                    if (this.player.lust < 33)
                        ...
                        this.outputText("It gets inside you and turns you on, stoking the flames of your desire.", false);
                    else if (this.player.lust < 80)
                        this.outputText("It makes you very horny, and you begin to wonder if it's worth resisting.", false);
                    else
                        this.outputText("It makes you ache and tremble with need, practically begging for another touch.", false);
        ...
        ceraphBindingStruggle() {
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Bound) - 1 <= 0) {
                ...
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Bound);
                this.combatRoundOver();
                return;
            }
            else {
                ...
                this.player.addStatusValue(StatusAffects_1.StatusAffects.Bound, 1, -1);
        ...
        ceraphSpecial3() {
            ...
            //Blind dodge change
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Blind) >= 0 && Ceraph.rand(10) != 9) {
            ...
            //Determine if evaded
            else if (this.player.findPerk(PerkLib_1.PerkLib.Evade) >= 0 && Ceraph.rand(100) < 10) {
                this.outputText("Using your skills at evading attacks, you anticipate and sidestep " + this.a + this.short + "'s attack.", false);
            }
            else if (this.player.findPerk(PerkLib_1.PerkLib.Misdirection) >= 0 && Ceraph.rand(100) < 15 && this.player.armorName == "red, high-society bodysuit") {
        ...
        constructor() {
            super();
            console_1.trace("Ceraph Constructor!");
            this.a = "";
            this.short = "Ceraph";
            ...
            // this.plural = false;
            this.createCock(10, 2, CockTypesEnum_1.CockTypesEnum.DEMON);
            ...
            this.createStatusAffect(StatusAffects_1.StatusAffects.BonusACapacity, 15, 0, 0, 0);
    ...
    exports.Ceraph = Ceraph;
});
//# sourceMappingURL=Ceraph.js.map