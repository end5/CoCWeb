define(["require", "exports", "./NPCAwareContent", "../../CoC", "../../StatusAffects", "../../GlobalFlags/kFLAGS", "./GooArmor", "../../PregnancyStore", "../../../../includes/appearanceDefs"], function (require, exports, NPCAwareContent_1, CoC_1, StatusAffects_1, kFLAGS_1, GooArmor_1, PregnancyStore_1, appearanceDefs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Valeria extends NPCAwareContent_1.NPCAwareContent {
        constructor() {
            super();
        ...
        timeChange() {
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.GooStuffed) > 0) {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.GooStuffed, 1, -1);
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.GooStuffed) <= 0) {
        ...
        valeriaFollower() {
            ...
            this.clearOutput();
            this.outputText("You walk over to Valeria.  Seeing you approach, the armor-goo turns a slightly brighter shade of blue beneath her plates and grins.");
        ...
        valeriaSpar() {
            this.clearOutput();
            this.spriteSelect(79);
            this.outputText("You ask Valeria if she would be up for a bit of battle practice.");
            ...
            this.startCombat(new GooArmor_1.GooArmor());
        ...
        pcWinsValeriaSpar() {
            this.clearOutput();
            this.spriteSelect(79);
            this.outputText("\"<i>Oof!</i>\" Valeria grunts, nearly losing her human shape as she tumbles to the hard-packed dirt.  \"<i>All right, all right, you win!  Take it easy, partner,</i>\" she laughs, letting her greatsword dissipate back into her body.");
        ...
        pcWinsValeriaSparDefeat() {
            ...
            if (this.player.HP < 1)
                this.outputText("in too much pain");
            else
                this.outputText("too turned on");
            this.outputText(" to fight any longer.  Valeria's on you in a heartbeat, her gooey greatsword pressed to your throat.");
        ...
        followersValeriaSex(display = true) {
            this.spriteSelect(79);
            if (display) {
                this.clearOutput();
                this.outputText("With a lusty grin, you ask your gooey friend if ");
                if (this.player.gender > 0)
                    this.outputText("she's interested in a little fluid exchange");
                else
                    this.outputText("she wouldn't mind helping you get some release, despite your genderlessness");
                this.outputText(".");
            ...
            this.choices("PenetrateHer", penetrate, "Get Fucked", getFucked, "Gooflation", gooFlation, "GetDominated", dominated, dickText, dickToggle, "", undefined, "", undefined, "", undefined, "", undefined, "Back", this.valeriaFollower);
        }
        ...
        valeriaDickToggle() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.VELARIA_FUTA] == 1) {
                ...
                this.flags[kFLAGS_1.kFLAGS.VELARIA_FUTA] = 0;
            }
            //[If Valeria doesn't have a dick:] 
            else {
                this.flags[kFLAGS_1.kFLAGS.VELARIA_FUTA] = 1;
        ...
        valeriaGetFucked() {
            this.spriteSelect(79);
            this.clearOutput();
            this.outputText("You disrobe and, ");
            if (this.player.hasVagina())
                this.outputText("stroking the slick lips of your [vagina], ask Valeria to fuck you.");
            else
                this.outputText("posing seductively, ask Valeria to fuck you.");
            ...
            if (this.player.isBiped())
                this.outputText("and spreading your legs ");
            this.outputText("as Valeria ");
            if (this.flags[kFLAGS_1.kFLAGS.VELARIA_FUTA] == 0)
                this.outputText("forms a thick, gooey cock");
            else
                this.outputText("grabs her thick, gooey cock");
            this.outputText(" and looms over you.");
            ...
            if (this.player.biggestTitSize() > 3)
                this.outputText("bumping over your [chest] and stopping for a brief moment to tickle your sensitive tits with her goopy bottom before ");
            this.outputText("coming to a stop over your crotch.  She pours herself into your lap, ");
            //[if PC has cock: \"<i>
            if (this.player.hasCock())
                this.outputText("her gooey ass devouring your " + this.cockDescript(0) + " as she slides down your belly");
            if (this.player.hasCock() && this.player.hasVagina())
                this.outputText(" and ");
            if (this.player.hasVagina())
                this.outputText(" letting bits of her goo-body slither into your wet, waiting [vagina], ever so slightly peeling your walls apart");
            //If PC has no gender 
            if (this.player.gender == 0)
                this.outputText("poking the shaft of her cock gingerly, teasingly against your [asshole]");
            this.outputText(".");
            ...
            if (this.player.hasCock())
                this.outputText(", as she rhythmically flexes her ass cheeks, shifting her fluidity around your shaft within her with a feeling like lotion-covered hands gently stroking you");
            this.outputText(".");
            //(If Female)
            if (!this.player.hasCock() && this.player.hasVagina()) {
                ...
                if (this.player.hasFuckableNipples())
                    this.outputText("s");
                this.outputText(" deeper inside you than ever before.  You feel streaks of goo pouring into you as she cums, pouring her essence into your womb ");
                if (this.player.hasFuckableNipples())
                    this.outputText("and [chest] ");
                this.outputText("until slime overflows from inside you, pooling under her hips.  Filled beyond your capacity, you scream your pleasure and cum, clamping down on Valeria's cock");
                if (this.player.hasFuckableNipples())
                    this.outputText("s");
                this.outputText(" until they literally pop inside you, flowing back out in goopy streaks.");
            }
            //(If Male/Herm)
                ...
                this.outputText("\n\nResigned, you let the goo-girl have her way.  You try your best to relax as her goo-cock slithers between your ass-cheeks, her prick remaining just hard enough for her to hotdog herself between your cheeks.  But rather than penetrate, she instead seems content for the moment to rock her hips in your lap, riding your " + this.cockDescript(0) + " and fucking your butt-cheeks with her own rod.  As she rides you, Valeria slips a little more foot into your mouth, pouring her leg into you until you get the hint and start to suckle her dainty toes, easily slipping your tongue into her soft body to taste her insides.");
                this.outputText("\n\nJust as you're getting into the rhythm of things, you feel a sudden pressure against your [asshole].  Oh, shit.  You squirm and try to relax yourself, but surprisingly, you don't feel the hard pinch of a cock's insertion.  Instead, Valeria pours a tiny trickle of herself into your anus, slowly but surely stretching you out as her cock inflates half-way inside you.  You groan in pleasure as she stretches you out and redoubles her pace on your " + this.cockDescript(0));
                //(if Herm: [
                if (this.player.hasVagina()) {
                    this.player.cuntChange(10, true, true, false);
                    this.outputText(", the double-attack's pleasure is so great that you barely even notice her creating a second cock above the first and pouring it into your unused [vagina], filling your last hole up with a firm, gooey cock");
                }
                this.outputText(".");
                ...
                if (this.player.hasVagina())
                    this.outputText("s");
                this.outputText(" and fucking your " + this.cockDescript(0) + " with one fluid, passionate motion.  You're both moaning openly now, nearly overwhelmed by a multitude of pleasures.  You can feel your impending orgasm rising, and by the heightening pitch of Valeria's moans, she seems to be just as close to the edge.");
                ...
                if (this.player.hasVagina())
                    this.outputText("s");
                this.outputText(" literally popping as she climaxes, filling your stretched ass ");
                if (this.player.hasVagina())
                    this.outputText("and vag ");
            ...
            if (this.player.gender > 0)
                this.outputText("patting her belly full of your juices, ");
            this.outputText("and looms over you.  \"<i>That was fun, partner,</i>\" she says, leaning down to give you a wet peck on the cheek. \"<i>Let's do that again soon, all right?</i>\"");
            this.player.orgasm();
            this.dynStats("sen", -1);
            this.HPChange(25, false);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        gooFlation(clearText = true) {
            this.spriteSelect(79);
            if (clearText) {
                this.clearOutput();
                this.outputText("\"<i>Just relax, partner,</i>\" she grins, reaching up to run a hand through your [hair].  \"<i>Just let ol' Valeria take care of everything...</i>\"");
            ...
            if (!this.player.hasVagina())
                this.outputText("one lonely ");
            this.outputText("hole.  You gulp as the tentacle-fuck begins, her long tendrils pouring one by one into your [asshole], each so small and soft it easily slips inside you.  One piles onto another, tickling and teasing your anal walls as more and more of her slithers into you.");
            ...
            if (clearText) {
                ...
                if (this.player.gender > 0)
                    this.outputText("patting her belly full of your juices, ");
                this.outputText("and looms over you.  \"<i>That was fun, partner,</i>\" she says, leaning down to give you a wet peck on the cheek. \"<i>Let's do that again soon, alright?</i>\"");
                this.player.orgasm();
                this.dynStats("sen", 1);
                this.HPChange(25, false);
                this.doNext(this.camp.returnToCampUseOneHour);
        ...
        penetrateValeria() {
            this.spriteSelect(79);
            this.clearOutput();
            this.outputText("\"<i>Mmm, that's a tasty-looking cock,</i>\" Valeria says as you disrobe, letting your " + this.cockDescript(0) + " flop free.  \"<i>I just might have to get a sample,</i>\" she chuckles, squatting down before you and taking your shaft in hand.  Rather than giving you a simple handy, however, the goo-girl places her palm against the head of your cock and presses forward.");
            this.outputText("\n\nYou gasp as her gooey skin parts, letting your " + this.cockDescript(0) + " slip inside her.  Her palm and forearms act like a snug, wet cocksleeve, shifting and molding to perfectly fit around your prick as you slide into her up to the hilt.  She grins up at you as she gives you a handy the likes of which only a goo-girl could manage, using her penetrable palm like a cunt.  You groan as she moves her arm, slowly stroking your cock inside of her, occasionally varying her motions, making wide circles around you or moving side to side.");
            this.outputText("\n\nBefore you can get too comfortable, however, Valeria sidles forward and moves your " + this.cockDescript(0) + " from her arm to her breast with a wet POP.  She squeezes her palmable C-cups together and leans in, letting your cock slip in between them and into her gooey flesh.  You moan as the pleasurable wetness and warmth of her interior returns when the goo-girl begins to titty-fuck you, slipping her wet breasts along the length of your shaft as the head bobs in and out of her cunt-like interior.");
            this.outputText("\n\nYou sink your fingers into the goo's shoulders and start to guide her speed, moving her back and forth along your cock at your own pace like a particularly lush onahole.  The normally-dominant Valeria makes a surprised, happy squeal as you seize control.  She redoubles her efforts of tit-fucking your " + this.cockDescript(0) + " as you use her as your own personal sex-toy, roughly ramming her back and forth on your shaft until you feel an orgasm bubbling up inside you.");
        ...
        valeriaSexDominated() {
            this.spriteSelect(79);
            this.clearOutput();
            this.outputText("Making a show of playing hesitant and nervous, you tell Valeria you'd like her to take charge.  A wide grin quickly spreads across her girlish features.  \"<i>Mmm, feeling subby today, partner?  Good, good... You just let Valeria take good care of you, " + this.player.mf("handsome", "cutie") + ".</i>\"");
            ...
            if (this.player.hasVagina() && (!this.player.hasCock() || Valeria.rand(2) == 0)) {
                ...
                if (this.player.biggestTitSize() > 1) {
                    ...
                    if (this.player.lactationQ() > 0)
                        this.outputText("  To her delight, a spray of warm milk jets out of your sore nipples, milky white mixing into blue goo like oil in water.  \"<i>Mmm, tasty!</i>\" she teases, massaging more and more from you.");
                }
                ...
                this.outputText(this.player.mf("boy", "girl") + " ready to cum?</i>\" she withdraws herself from you, leaving you feeling suddenly very, very empty.  \"<i>I didn't say you could cum yet, slut! I'm not done with you yet.</i>\"");
                ...
                if (this.player.vaginalCapacity() > 80 || this.player.analCapacity() > 80)
                    this.outputText(" and your own receptibility");
                this.outputText(".  Hugging your back, the goo-girl grabs at your [chest], squeezing your tits and pinching at your nipples.  \"<i>Moan for me, bitch,</i>\" Valeria growls into your ear, giving your [nipples] a particularly violent tug.  You let out a lewd, whorish moan.  The goo-girl grins, her tongue lashing out to lick your ear as she rewards you with a single long thrust into your depths, filling and stretching your [vagina] and [asshole] completely before withdrawing.");
                ...
                if (this.player.lactationQ() > 0)
                    this.outputText("and milk ");
                this.outputText("swirling around inside her.  \"<i>We'll do this again sometime,</i>\" she adds, walking off to another part of camp with a wink.");
            }
            //(PC has Dick)
            else {
                ...
                this.outputText("\n\nYou gasp with pleasure as she starts to stroke [eachCock], jerking you off as she looms over you, grinning wickedly.  \"<i>Oh, you like that do you?</i>\" the armor-goo asks.  \"<i>Well then, I might just let you get off, too... If you're a good " + this.player.mf("boy", "girl") + "</i>\"  She starts to increase her tempo, making you squirm and writhe as she wanks your " + this.multiCockDescriptLight() + ", licking her lips as little bubbles of pre start to form.");
                ...
                if (this.player.tallness > 60)
                    ...
                    this.outputText("little");
                this.outputText(" " + this.player.mf("boy", "girl") + " ready to cum? Well, go on then - we've got time for more.</i>\"");
                this.outputText("\n\nYou cum, ropes of thick, white jizz shooting out of your cock and into the goo's waiting body.  Laughing, the goo-girl absorbs your cum, growing larger and larger as you feed her until she towers over you, her expanding breasts and belly now hanging over you.  \"<i>Oh, that's good. Good, " + this.player.mf("boy", "girl") + ", good.  Yes, let it all out, just like that... just like that,</i>\" she coos, soaking your cum up until your orgasm finally passes.");
                ...
                this.outputText("\n\n\"<i>Oh, that's good... good, " + this.player.mf("boy", "girl") + ", good.  Yes, let it all out, just like that... just like that,</i>\" she moans, soaking your juices up until your orgasm finally passes.  Sated, she withdraws around your foot, leaving you a quivering mess on the ground.");
        ...
        talkWithValeria() {
            this.spriteSelect(79);
            this.clearOutput();
            this.outputText("You ask Valeria if she wouldn't mind just talking for a little bit.");
            ...
            if (this.player.race() != "human")
                this.outputText(" were");
            this.outputText(".  I just, I dunno, changed, I guess.</i>\"");
            this.outputText("\n\nChanged?");
            ...
            if (this.player.gender > 0)
                this.simpleChoices("Flirt", this.flirtWithValeria, "Accept", this.acceptValeriasNeeds, "Gross", this.declineValeriasNeeds, "", undefined, "", undefined);
            else
                this.simpleChoices("", undefined, "Accept", this.acceptValeriasNeeds, "Gross", this.declineValeriasNeeds, "", undefined, "", undefined);
        }
        //[Flirt]
        flirtWithValeria() {
            this.spriteSelect(79);
            this.clearOutput();
            this.outputText("You slip an arm around Valeria's slender shoulders and pull her close.  Patting your crotch, you tell her you're practically a gourmet chef for a girl like her.  She giggles and slips a hand easily into your [armor], ");
            if (this.player.hasCock())
                this.outputText("brushing along the length of your rapidly-hardening cock");
            else
                this.outputText("brushing a wet, warm knuckle across your [clit]");
            this.outputText(".");
        ...
        acceptValeriasNeeds() {
            this.spriteSelect(79);
            this.clearOutput();
            this.outputText("You smile and tell Valeria that you're perfectly all right with her special needs");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.SlimeCraving) >= 0)
                this.outputText(" after all, you have the same ones");
        ...
        takeValeria() {
            ...
            if (item == undefined)
                ...
                this.inventory.takeItem(item, this.playerMenu);
        }
        valeriaAndGooThreeStuff() {
            this.clearOutput();
            this.outputText("You cautiously approach with Valeria's voice egging you on, \"<i>We gonna fuck her? We're gonna fuck her, ain't we, [name]?</i>\" She affectionately fondles your ");
            var list = ["[hips]"];
            ...
            list.push("[asshole]");
            list.push("[nipples]");
            this.outputText(Valeria.formatStringArray(list) + " with liquid-soft caresses, almost ephemeral and yet still so perfectly all-consuming, filling every tiny imperfection in your [skin] with blue, gooey goodness and teasing whatever entrances she can get at. ");
            /*
                clearList();
                addToList("[hips]");
            ...
            */
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_VALERIA_GOO_THREESOMED] == 0)
            ...
            this.outputText("  She surprises you by contorting your body with pressure from an unexpected angle, tipping you head over heels, right toward the wide-eyed goo-girl you just managed to defeat!");
            this.outputText("\n\nYou splash " + this.player.face() + "-first into a cushiony mass of forgiving slime, but the momentum only carries you partway into the humanoid puddle. A semi-solid lump bumps off your cheek as you come to rest, floating inside a " + this.monster.gooColor() + " prison. Shaking your head to clear your vision, you try to determine what you hit, but all you can see is a filmy blur, and you can't breathe either. Your cheeks puff out while you struggle to surface. As always, Valeria has your back. Her unsubtle drawl vibrates, \"<i>I gotcha, partner,</i>\" wetly against your eardrums as you are bodily rotated, slowly pushing your head through the " + this.monster.gooColor4() + " surface while your body is thoroughly ensconced in slime.");
            ...
            this.outputText("\n\nThe bluish");
            if (this.monster.skinTone != "blue")
                this.outputText(" " + this.monster.gooColor6());
            this.outputText(" juices slowly meld together until you cannot tell one from the other, and they firm up into a semi-translucent, flat-bottomed sphere, trapping you there. Your debauched and hopelessly aroused state is visible to any who would wander by, stroked by dark-colored currents that wrap around your ");
            if (this.player.hasCock() || this.player.hasVagina())
                this.outputText("genitals");
            else
                this.outputText("[asshole]");
            this.outputText(" with sinful tightness. An involuntary shiver of excitement traverses up your spine, though your body is held almost completely stock-still in its sloshing vice.");
            ...
            this.outputText("\n\nYou ");
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_VALERIA_GOO_THREESOMED] == 0)
                this.outputText("demand that she release you");
            else
                this.outputText("playfully comment that she really ought to release you");
            this.outputText(", but the troublesome, liquid armor shakes her head negatively.");
        ...
        valeriaGooRapeII() {
            this.clearOutput();
            this.outputText("The lump that bumped you earlier smacks off ");
            if (this.player.biggestTitSize() >= 3)
                this.outputText("the valley of your cleavage");
            else
                this.outputText("your chest");
            this.outputText(" once more, and this time you catch a glimpse of it out of the corner of your eye. It's the goo-girl's core, clasped in a fist of deep-blue. It pulses faintly as it's held there, just before you, while subtle vibrations and temperature fluctuations alert you to some kind of secret communications between the two women. Just what are they planning?");
            this.outputText("\n\nYou get your answer in the form of a sudden");
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_VALERIA_GOO_THREESOMED] == 0)
                this.outputText(", unexpected");
            else
                this.outputText(" but expected");
            this.outputText(" pressure at your [asshole]. It's so... so slick that you have to wonder how they can manage to push with such authority at your rearmost orifice, but they manage it all the same. You clench to deny them entrance, squeezing your sphincter shut tighter than locked door. Valeria's giggling voice coos from somewhere below, \"<i>Oh, don't be a spoilsport. Come on, it'll be fun.</i>\"");
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_VALERIA_GOO_THREESOMED] == 0)
                ...
                this.outputText("You hold tight, keeping up your faux resistance until she yanks your cheeks open and twists her gooey reaming-tool into a sphincter-penetrating drill bit.");
            this.outputText(" Spinning faster and faster, the intruding, cylindrical slime dilates your [asshole] to its maximum gape in four or five seconds, hardening its exterior into an butt-stuffing goo-pipe. You can feel it snaking around through your bowels, plumbing deeper inside you than you would have thought possible before stopping what feels like halfway through your large intestine.");
            //{Butt-change: full anal size}
            this.player.buttChange(this.player.analCapacity() * .75, true, true, false);
            ...
            if (!this.player.isPregnant() && this.player.hasVagina()) {
                ...
                //{cuntChange: MAXIMUM}
                this.player.cuntChange(this.player.vaginalCapacity() * .75, true, true, false);
            ...
            if (this.player.hasFuckableNipples() && this.player.biggestTitSize() >= 5) {
                ...
                if (this.player.hasVagina())
                    this.outputText(" as your snatch");
                else
                    this.outputText(" as the randiest slut's snatch");
                this.outputText(". Valeria takes this as an invitation, and " + Valeria.num2Text(this.player.totalNipples()) + " phallic objects greedily push at your cunt-nipples, eagerly sliding themselves inside your welcome chest-pussies. Looking down, you can see the navy-blue outlines of the phallic tendrils waving and writhing as they push their way deep, embedding themselves tit-deep in blissful warmth.");
            }
            //Dick
            if (this.player.hasCock()) {
                this.outputText("\n\nValeria's voice calls out once more, \"<i>You didn't think I'd forget ");
                if (this.player.cockTotal() == 1)
                    this.outputText("this little guy");
                else
                    this.outputText("these little guys");
                this.outputText(", did you? ");
                if (this.player.biggestCockArea() >= 50)
                    this.outputText("...Maybe big guy is a bit more appropriate. Whatever. ");
                this.outputText("I was just saving the best for last. Hold on tight, tiger.</i>\"");
                ...
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText(" in place, and something even warmer than the slippery container");
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText(" pushes at your head");
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText(", circling your urethra");
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText(". You inadvertantly clench your muscles in a way that makes your " + this.multiCockDescriptLight() + " so very swollen, in turn making it that much easier for the gelatinous fiend to have her way with your cumslit");
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText(". You feel that warm, wet fluid slowly peel it open and push inside. It doesn't hurt at all, but it is a little weird having your " + this.multiCockDescriptLight() + " slowly stuffed in such a way. The warmth travels the whole way down your dick");
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText(" to your middle, where you can feel it travel a bit further before it finally stops at your [balls].");
            }
            //Merge
            this.outputText("\n\nGiggling, the sapphire slut does something that makes the body-wrapping sphere jiggle and contract slightly. ");
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_VALERIA_GOO_THREESOMED] > 0)
                this.outputText("You grin in eager anticipation, waiting to feel the flood of fluid that you know is coming. It won't take long.... You feel it in your butt first.");
            else
                this.outputText("At first, you don't realize what it is. You're floating in a bit of a sexual daze by now and barely cogent of what's going on, but it does feel quite nice, whatever it is. The spreading heat in your posterior is what finally clues you in to what's happening.");
            this.outputText(" Pumping deep into your bowels, the hardened protrusion is no longer simply stuffing you. It's pumping something slick and wet and oh so gooey straight into your [asshole], filling you up so strangely that you aren't sure what to make of beyond how... well, good it feels to be stuffed like this.");
            //{Vagina!}
            if (this.player.hasVagina()) {
                ...
                this.outputText(" your girlcum in feverish releases of ecstasy, repeatedly getting off on this perverse, doubled slime-flation.");
            }
            //{titties}
            if (this.player.hasFuckableNipples() && this.player.biggestTitSize() >= 5) {
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText(" in [eachCock] ");
                if (this.player.totalCocks() > 1)
                    this.outputText("do not");
                else
                    this.outputText("does not");
                this.outputText(" differ greatly from Valeria's other liquid attentions. ");
                if (this.player.totalCocks() > 1)
                    this.outputText("They start");
                else
                    this.outputText("It starts");
                this.outputText(" by thickening, stretching your cumvein");
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText(" as wide as ");
                if (this.player.totalCocks() > 1)
                    this.outputText("they");
                else
                    this.outputText("it");
                this.outputText("'ll go without pain and then rolling thick pulses of gelatinous matter into your urethra");
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText("s");
                this.outputText(". The sleeve");
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText(" squeeze");
                if (this.player.totalCocks() == 1)
                    this.outputText("s");
                this.outputText(" down on your length");
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText(" harder, starting to slide around in ways that would be impossible for a vagina, and you find yourself helplessly blowing your load straight into the dick-plug");
                if (this.player.totalCocks() > 1)
                    this.outputText("s");
                this.outputText(", spurting bliss that can't even hope to escape from your loins. You feel ");
                if (this.player.balls == 0)
                    this.outputText("something expanding as you cum, filling up with spunk or slime or some mixture of the two");
                else
                    this.outputText("your [balls] expanding as you cum, filling up with spunk or slime or some mixture of the two, weighing down your sack with ever-increasing heaviness. Tender licks of tongue roll across the surface as you fill beyond completely");
                this.outputText(".");
            }
            //Butt fillinggasm
            ...
            if (this.player.biggestTitSize() >= 5 && this.player.hasFuckableNipples())
                this.outputText(", pausing to handle your hefty, swelling tits");
            this.outputText(", moaning and groaning as Valeria's shape gradually coalesces back around you. The goo-girl's core vanishes from view and reappears down south, pressing against your [asshole] as the \"pipe\" that filled you so full melts into slime. You scream in anal ecstasy as it slips past your ring, lodging firmly in your butt while the jellied mass inside convulses, rubbing against your walls in all the right ways, almost like it's experiencing an orgasm all its own.");
            ...
            if (this.player.biggestTitSize() >= 5 && this.player.hasFuckableNipples()) {
                for (var x = 0; x < this.player.bRows(); x++) {
                    this.player.breastRows[x].breastRating += 3 + Valeria.rand(3);
                }
                this.outputText(" Your tits have grown much larger, " + this.player.breastCup(0) + "-cups at least.");
            }
            if (this.player.hasCock() && this.player.balls > 0) {
                this.player.ballSize += 3 + Valeria.rand(2);
                this.outputText(" Your balls look positively swollen with libidinous juices.");
            }
            this.outputText(" Your belly is stuffed into a parody of a pregnant woman's");
            if (this.player.hasVagina())
                this.outputText(", so gravid from both holes that a real mother would be shamed by your obscene \"pregnancy.\"");
            else
                this.outputText(".");
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_VALERIA_GOO_THREESOMED]++;
            this.player.orgasm();
            //v1 = time till birth.
            //v2 = cock fill = 1, balls fill = 2
            //v3 = cunt fill?
            //v4 = tit fill?
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.GooStuffed, 10 + Valeria.rand(300), 0, 0, 0);
            this.player.buttKnockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_GOO_STUFFED, 500); //Blocks other pregnancies - Way higher than GooStuffed status can last. Cleared when GooStuffed removed
            if (this.player.hasVagina()) {
                this.player.changeStatusValue(StatusAffects_1.StatusAffects.GooStuffed, 3, 1);
                this.player.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_GOO_STUFFED, 500); //Blocks other pregnancies - Way higher than GooStuffed status can last. Cleared when GooStuffed removed
            }
            if (this.player.hasCock()) {
                if (this.player.balls > 0)
                    this.player.changeStatusValue(StatusAffects_1.StatusAffects.GooStuffed, 2, 2);
                else
                    this.player.changeStatusValue(StatusAffects_1.StatusAffects.GooStuffed, 2, 1);
            }
            if (this.player.biggestTitSize() >= 5 && this.player.hasFuckableNipples())
                this.player.changeStatusValue(StatusAffects_1.StatusAffects.GooStuffed, 4, 1);
            this.cleanupAfterCombat();
        }
        ...
        birthOutDatGooSlut() {
            ...
            if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.GooStuffed) > 0)
                this.outputText(" Your tits are even wobbling around wildly, shaking and jiggling obscenely inside your [armor] in a way that makes you your [nipples] more than a little leaky.");
            ...
            this.outputText("bitch in heat. Gods, there's so much!");
            if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.GooStuffed) > 0) {
                this.outputText("\n\n");
                if (!this.player.hasFuckableNipples())
                    this.outputText("Stiffening up");
                else
                    this.outputText("Opening up");
                this.outputText(", your [nipples], suddenly disgorge rivers of gelatinous slime, adding to growing puddle below with, odd-colored obscene lactation. You grab one with one hand and squeeze, shooting out huge streamers of milky-goo until your tit is sore and aching. You repeat on the other side");
                if (this.player.bRows() > 1)
                    this.outputText(" and the next row down");
                if (this.player.bRows() > 2)
                    this.outputText(", and so on");
                this.outputText(", working out every drop of thick, body-filling slime while your ass is still busy draining. Even after they empty, they don't seem to lose a single bit of the size they've gained....");
            }
            if (this.player.hasCock() && this.player.statusAffectv2(StatusAffects_1.StatusAffects.GooStuffed) > 0) {
                ...
                if (this.player.balls > 0)
                    this.outputText("ball-clenching");
                else
                    this.outputText("body-clenching");
                this.outputText(" quivers of beatific enjoyment. It's so thick, and there's so much that your blissful explosions soon turn into a constantly flowing river of ejaculatory ecstasy. You grab hold with one hand and squeeze to milk out every last drop, throbbing long after you empty. A few trickles of white ooze out after, but that's all the proper spunk you see.");
                if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.GooStuffed) >= 2)
                    this.outputText("  Your balls keep their enhanced sized. Odd.");
            }
            if (this.player.hasVagina() && this.player.statusAffectv3(StatusAffects_1.StatusAffects.GooStuffed) > 0) {
