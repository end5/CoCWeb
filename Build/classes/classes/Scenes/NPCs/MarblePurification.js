define(["require", "exports", "./NPCAwareContent", "../../GlobalFlags/kFLAGS", "../../StatusAffects", "./Clara", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, kFLAGS_1, StatusAffects_1, Clara_1, kGAMECLASS_1) {
    "use strict";
    ...
    */
    class MarblePurification extends NPCAwareContent_1.NPCAwareContent {
        /*Purifying Marble
        ...
        BLUHBLUH() {
            this.clearOutput();
            this.outputText("When you return to camp, you find Marble seated at the campfire, staring gloomily into the ashes. Curious, you approach your bovine lover and ask her what the matter is. She looks up at you, her ");
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] <= 1)
                this.outputText("human");
            else
                this.outputText("bovine");
            this.outputText(" head still in her hands, and sighs loudly. <i>\"I’m sorry, sweetie, I just... I’ve tried to ignore it, but I just don’t feel comfortable here.\"</i>");
            this.outputText("\n\nYou ask her what’s wrong; doesn’t she like being with you?");
            if (this.amilyScene.amilyFollower() && !this.amilyScene.amilyCorrupt() || this.followerKiha() || this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00238] == 1) {
                ...
                else if (this.followerKiha())
                    this.outputText("Kiha");
                else
            ...
            if (this.player.hasItem(this.consumables.PURHONY))
                this.outputText("  You then recall that bottle of honey the bee-girl gave you, and ask if maybe it might work?");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.PureCampJojo) >= 0)
                this.outputText("  You remember how Jojo helped you become pure, and suggest maybe his meditations could assist Marble?");
            ...
            this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] = 1;
        ...
        giveMarblePureQuestLabova() {
            this.clearOutput();
            this.player.consumeItem(this.consumables.P_LBOVA);
            this.outputText("You tell Marble that you managed to get some LaBova alchemically purified, and you want her to drink some.");
            //First time
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_GIVEN_MARBLE_PURE_LABOVA] == 0) {
                //Marble’s corruption is reduced by 4
                this.player.addStatusValue(StatusAffects_1.StatusAffects.Marble, 4, -4);
            ...
            //Play this scene automatically when PC gives Marble the first Labova after reaching her "quota"
            else if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.MarbleSpecials) <= 30) {
                ...
                this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] = 2;
            }
            //Every other time
            else {
                //Marble’s corruption is reduced by 4
                ...
                this.outputText(" breasts to dangle freely. Stoically she bears the pain as her stomach loudly rumbles and groans, holding her breasts up proudly as her ");
                if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.MarbleSpecials) == 4)
                    this.outputText("eight");
                else
                    this.outputText("two");
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_GIVEN_MARBLE_PURE_LABOVA]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        visitRathazulToPurifyMarbleAfterLaBovaStopsWorkin() {
            this.clearOutput();
            ...
            this.outputText("As you approach the rodentine alchemist, you remember Marble’s problems and resolve to ask him if he can possibly help you. Once he finishes greeting you, you politely return the greeting and ask if he would be willing to lend his opinion on a problem you have.");
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) < 0) {
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.CampRathazul, 0, 0, 0, 0);
            }
            //{Next}
            this.menu();
            this.addButton(0, "Next", this.pageTwoOfVisitingTheRatForMurblesPurification);
        }
        pageTwoOfVisitingTheRatForMurblesPurification() {
            this.clearOutput();
            this.outputText("Fortunately, Marble is at your camp rather than off at Whitney’s, and your bovine lover looks up at you hopefully as you approach. \"<i>Did he say he could help?</i>\" she asks, excitedly.");
            ...
            this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] = 3;
            this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_1] = 24;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Rathazul’s Report
        //This scene occurs automatically the first morning after Rathazul receives Marble’s milk
        rathazulsMurbelReport() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_1] = 0;
            this.outputText("When you wake and join Marble ");
            if (kGAMECLASS_1.kGAMECLASS.camp.companionsCount() > 2)
                this.outputText("and your other followers ");
            this.outputText("for breakfast this morning, you find a bleary-eyed Rathazul waiting at the campfire. Marble clucks her tongue and gives him a mug of something strong, which he accepts gratefully, noisily slurping down a mouthful. He takes a seat, staring into his mug, and then sighs softly.");
        ...
        //[=Stay=]
        stayHereAndDontGoGetYerSisterShesABitch() {
            this.clearOutput();
            this.outputText("You shake your head and tell Marble that you still need her at the camp; you’ll tell her when you can spare her.");
        ...
        murbleShouldGoRunAlongAndGetHerCuntySisterSoTheyCanBeCuntsTogether() {
            this.clearOutput();
            this.outputText("You tell Marble that if she needs some time off to go and see her family for this matter, it’s okay with you.");
            ...
            this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] = 4;
            this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_2] = 240;
        ...
        claraShowsUpInCampBECAUSESHESACUNT() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_2] = 0;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] <= 1)
                this.outputText("your mate has");
            else
                this.outputText("what your mate use to have");
            this.outputText("; cow legs, ears, horns, and large breasts.  However, she doesn’t have Marble’s brown fur, instead having black and white blotched fur across her legs and ears and a mane of white hair atop her head.  She is wearing a one piece thick cloth dress, with a great deal of fancy embroidery decorating it.  You also guess that she’s a bit smaller than Marble, in both the chest and height departments.");
            ...
            if (this.player.inte >= 60)
                this.outputText(" with a odd smile on her face");
            ...
            if (this.player.inte >= 60)
                this.outputText(" somewhat unconvincingly");
            this.outputText(".");
            ...
            this.outputText("\n\nAt this point Rathazul suddenly interjects. \"<i>If " + this.player.short + " gets the milk by suckling on your breasts, " + this.player.mf("he", "she") + " would probably contaminate it with " + this.player.mf("his", "her") + " saliva and make it useless. I need it to be as pure as possible; hand-milking would be preferable, if you can do that, but if you must use the milkers at Whitney’s farm, that will suffice.</i>\"");
        ...
        partTwoOfClaraShowingUpAndBeingACunt() {
            this.clearOutput();
            this.outputText("You turn back to the camp and continue going about your morning routine.  By the time you’re ready to head out, the girls have come back from the farm, bearing a bottle of Clara’s milk.  The spotted bovine’s foul mood seems to have improved as well.");
            ...
            var teaDrinkers = 0;
            if (kGAMECLASS_1.kGAMECLASS.camp.companionsCount() >= 3) {
                ...
                if (this.isabellaFollower()) {
                    ...
                    if (this.isabellaAccent()) {
                        this.outputText("  Isabella jumps from her chair, “<i>Tea?  Ooh, ja!  I hear tea und milk iz sehr gut combination, ja?</i>”  Well, she seems rather enthusiastic if nothing else.");
                    }
                    else {
                        this.outputText("  Isabella jumps from her chair, “<i>Tea? Ooh, yes!  I hear tea and milk is a really good combination, yes? I've never had the opportunity to try it though...</i>”  Well, she seems rather enthusiastic if nothing else.");
                    }
                    teaDrinkers++;
                }
                //if (Izma is in camp)
            ...
            this.flags[kFLAGS_1.kFLAGS.MURBLE_TEA_DRINKER_COUNT] = teaDrinkers;
        ...
        dumbshitCowCuntsTryToDrugYouBecauseTheyreCunts(teaDrinkers) {
            this.clearOutput();
            this.outputText("Upon returning to the center of activity, you find a rather annoyed looking Marble sitting off to the side while Clara busies herself with a large number of cups from her pack.  Curious over what happened, you sit down next to Marble while watching Clara check the temperature of the pot.  After a moment, you ask your bovine lover why she is just watching.  \"<i>After I got the fire started, Clara insisted that I’d get in the way and ruin the tea if I tried to help,</i>\" she grumbles in annoyance.");
            ...
            if (this.player.inte >= 60)
                ...
                this.addButton(0, "Next", this.lowIntelligenceGetsDruggedByCowSluts);
        }
        ...
        lowIntelligenceGetsDruggedByCowSluts() {
            this.clearOutput();
            this.outputText("Once everyone has a cup, Clara smiles at all of you and holds her own cup up to her mouth and says, \"<i>To Marble’s purification and meeting new friends.</i>\"");
        ...
        partTwoOfLowIntelligencePCsFallingForTheIncrediblyObviousCowCuntsTrap() {
            ...
            this.outputText(", you try to figure out what the heck is going on.  You remember meeting Marble’s sister, then getting tea, and then...  What did Clara say to Marble?  You groan slightly, your body feeling an odd old craving.");
            ...
            if (this.player.weaponName != "fists")
                this.outputText("your [weapon] is nearby, and ");
        ...
        //Chose fight
        fightCowCuntAfterBeingTotesMcGoatsDrugged() {
            this.clearOutput();
            this.outputText("You steel yourself, ");
            if (this.player.weaponName == "fists")
                this.outputText("raise your fists");
            else
                this.outputText("grab your " + this.player.weaponName);
            this.outputText(" and get ready to fight to free yourself from this mad milkmaid’s mammaries.  Realizing your intentions, Clara’s face turns from a crazed grin to an angry glare.  With barely contained fury, she screams at you, \"<i>Oh don’t you worry darling, I will <b>make</b> you love drinking my milk!</i>\" before standing up, hefting a nasty looking heavy mace, and charging at you.");
            //go to Clara’s fight
            this.startCombatWithMarbleSister(false);
        }
        startCombatWithMarbleSister(inCamp = true) {
            this.startCombat(new Clara_1.Clara());
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.NoFlee, 0, 0, 0, 0);
            if (inCamp && this.player.findStatusAffect(StatusAffects_1.StatusAffects.ClaraFoughtInCamp) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.ClaraFoughtInCamp, 0, 0, 0, 0);
        }
        //Chose submit
        voluntarilyChooseCowCuntBadEndYouBad() {
            this.clearOutput();
        ...
        mediumIntelligenceReactsToDrugging() {
            this.clearOutput();
            this.outputText("While Clara is handing out the cups, you can’t help but think how strange everything about this feels.  You can’t put your finger on what exactly is wrong, but neither can you put the unsettling feeling out of your mind.");
        ...
        mediumIntelligenceDoesntDrinkCowCuntsTea() {
            this.clearOutput();
            this.outputText("You can’t shake the feeling that there is something wrong with this tea, and just consider it for a few moments.  \"<i>Uh, aren’t you going to drink your tea, charmer?  It is really goood,</i>\" your server says slowly, looking over at you with a nervous expression on her face.  You start to say something, but are interrupted when you hear Marble suddenly gasp and cry out, \"<i>Clara, what the hell did you put in this stuff?</i>\" before gasping for breath a few more times and falling over.");
            if (kGAMECLASS_1.kGAMECLASS.camp.companionsCount())
                this.outputText("\n\nYou rush over to your fallen companion");
            else
                this.outputText("\n\nYou rush over to one of your fallen companions");
            this.outputText(" to see what has happened, only to find that she has passed out.  Noticing the tea cup again, you turn around to face the person who prepared it.  Clara stands behind you with a disturbing smile on her face.  You demand to know what was in the tea, like Marble did before.");
            this.outputText("\n\n\"<i>You really are a smart " + this.player.mf("boy", "girl") + ",</i>\" the girl speaks, ignoring your question, \"<i>I shoould have known you wouldn’t be so easy to trick.</i>\"  You make your demand of her once more.  \"<i>Don’t worry about them, my darling.  They’ll be awake in an hour or so, but by that time we’ll be long goone.</i>\"");
        ...
        //Fight
        mediumIntelligencesFightCowCunts() {
            this.clearOutput();
            this.outputText("You ready yourself for battle as Clara pulls an angry looking heavy mace out and says, \"<i>Fine, we’ll doo this the hard way.</i>\"");
            //start battle with Clara
            this.startCombatWithMarbleSister(true);
        }
        //Submit
        mediumIntelligencesSubmitCowCunts() {
            this.clearOutput();
        ...
        loseToClara(combat = true) {
            this.clearOutput();
            //PC loses via health	
            if (combat) {
                if (this.player.HP < 1)
                    this.outputText("Your body gives out from the strain, and you fall to the ground.  The last thing you hear before you pass out, is Clara’s triumphant laughter.");
                //proceed to loss scene
                //PC loses via lust
                else
                    this.outputText("You just can’t fight it anymore, and desperately start to masturbate in front of Clara.  Laughing triumphantly, Clara walks up to you and forces a pill down your throat.  A moment later, you pass out.");
                this.outputText("\n\n");
            }
            //proceed to loss scene
            ...
            this.outputText("You dream of odd things, distorted images that you called out for help to.  Then you were dragged away.  You kept seeing more shapes that felt familiar and important somehow, but you couldn’t focus on them.  You’d call again and again, only to be dragged away by something else again.  Eventually your cries for help become weaker and halfhearted; you know what’s going to happen next, so why bother?  Suddenly you realize that it is a cow-girl that is dragging you away; her face looks like Marble’s at first, then it splits into a huge, wicked smile, and you panic.");
            ...
            if (this.player.tallness < 70)
                this.outputText("much too big for you.");
            else if (this.player.tallness <= 82)
                this.outputText("just your size.");
            else
                this.outputText("way too small for your stature.");
            this.outputText("  You also find that you aren’t wearing your " + this.player.armorName + ", and your " + this.player.weaponName + " is nowhere to be seen.  ");
            ...
            if ((this.player.hasCock() && this.player.smallestCockArea() <= 40) && this.player.biggestTitSize() <= 25 && !this.player.isTaur() && !this.player.isNaga() && !this.player.isGoo() && !this.player.isDrider())
                this.outputText("Instead a plain but rather slim form fitting two piece garb adorns your body.  Whoever dressed you in that definitely wanted your bodily assets to be fully visible to anyone looking at you.");
            else
                this.outputText("You’re completely naked.");
            //new page
            this.menu();
            this.addButton(0, "Next", this.losingToCowCuntsPageII);
        }
        losingToCowCuntsPageII() {
            this.clearOutput();
            this.outputText("It is then that you realize with a shock that a familiar urge is welling up inside you.  No, it is much stronger than you remember it being before.  You want breastmilk.  You <i>need</i> breastmilk, and if you don’t get it, you’ll die.  To make matters worse, you know whose breastmilk it is too.  Clara, Marble’s younger sister, has fatally addicted you to her milk.");
            ...
            if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) == 1) {
                this.outputText("\"<i>Oh?  Wondering how I know about that?  Marble told me when she was explaining about you breaking free of the addiction.  Unlike her, I’m going to make sure you behave yourself.</i>\"  ");
            }
            else {
                this.outputText("\"<i>Confused?  That was one of the things Marble found out when she was researching the nature of her addiction.  She said she didn’t want to trouble you with that knowledge, but I don’t see why.</i>\"  ");
            }
            this.outputText("This woman is nothing like her sister, she loves the power she has over you, and loves to show you just how much she has.");
        ...
        cowCuntBadEndPartIII() {
            ...
            if (this.player.hairLength > 0)
                this.outputText("through your " + this.hairDescript());
            else
                this.outputText("across your scalp");
            this.outputText(", then they suddenly grip down tight.  \"<i>Let’s see if you can pick up the pace.  Drink faster, my love slave!</i>\"  You do as the voice asks, and loud moans of pleasure follow.");
        ...
        cowCuntBadEndPartIV() {
            ...
            if (this.player.hasCock() && !this.player.hasVagina()) {
                this.outputText("At this point your " + this.multiCockDescriptLight() + " is rock hard, and Clara gives it a few strokes.  She does seem to lose interest surprisingly quick though.");
            }
            else if (this.player.hasVagina() && !this.player.hasCock()) {
                this.outputText("You’ve become quite wet at this point, and Clara gives your " + this.vaginaDescript() + " a few rubs, before tugging on your " + this.clitDescript() + " once.");
            }
            else if (this.player.hasCock() && this.player.hasVagina()) {
                this.outputText("Your arousal at this point is quite apparent on the whole of your genitals.  Clara gives you a few touches and caresses, but doesn’t seem all that interested.");
            }
            else {
                this.outputText("Or rather, your lack of thereof.  Clara doesn’t seem to mind too much; Marble must have told her about this part of you too.");
            }
            ...
            if (!this.player.hasCock())
                ...
                this.addButton(0, "Next", this.badEndDickThatFitsClara);
        }
        ...
        badEndDickThatFitsClara() {
            ...
            if ((this.player.hasCock() && this.player.smallestCockArea() <= 40) && this.player.biggestTitSize() <= 25 && !this.player.isTaur() && !this.player.isNaga() && !this.player.isGoo() && !this.player.isDrider()) {
                this.outputText("In seconds she’s freed you of the form fitting garment that you woke up in.  ");
            }
            this.outputText("You’re still erect from the arousal that nursing from Clara gave you.  The young cow-girl straddles your calves and gives your " + this.cockDescript(x) + " a slight flick with her finger and continues to smile broadly at you.  \"<i>One thing that I was really worried about was that you woouldn’t have a penis that I could actually fit inside me.  Thankfully, that isn’t the case, and that pretty pecker is just my size!</i>\"  She pulls apart the lips of her womanhood before continuing, \"<i>This will be my first time ever putting anything in here, take note just how special of a slave you are to me!</i>\"");
            this.outputText("\n\nWell, she certainly isn’t wasting any time, as the very next instant she has lowered her opened labia onto the tip of your " + this.cockDescript(x) + ".  The passage is already wet and slick, thanks to her previous orgasm.  Immediately, an expression of both pain and pleasure crosses over the bovine woman’s face and she starts to pant.  You lift up your hands, bClara issues a sharp command that you aren’t to do anything at all while she has the sex she wants.  You can’t do much else but just lie back and take it.");
        ...
        cockTooBigForCowCuntageBadEndage() {
            this.clearOutput();
            ...
            if (this.player.cockTotal() > 1) {
                ...
                this.outputText("Your penis is");
            this.outputText(" too big for a virgin like me to fit!  How the hell am I suppose to get that inside me?</i>\"  Clara stands up and starts stomping around the room.  ");
            ...
            if (this.player.cockThatFits(this.marbleScene.marbleCuntCapacity()) >= 0) {
                this.outputText("\"<i>‘It’s not a flaw, it’s a feature,’ she said, ‘This is why we train ourselves to take big endowments,’ she said!  Fuck you Marble!  I’m not sticking that stupid big thing inside me.</i>\"  ");
            }
            else {
            ...
            this.outputText("She continues ranting for several minutes before turning to you.  \"<i>YOOU!  Didn’t you ever stop to consider the needs of dainty girls like me before you started abusing transformatives?</i>\"  She sighs, apparently running out of steam.  \"<i>Who knew this plan would be so hard?");
        ...
        cocklessPCsGetAbusedByCowCunts() {
            this.clearOutput();
            this.outputText("Clara straddles your head with her legs and looks down at you.  \"<i>Now you’re going to lick me until I’m satisfied.  Also, don’t you dare doo anything unless I tell you to, got it?</i>\"  She doesn’t wait for a response.  \"<i>Goood, now let's get started.</i>\"  The cow-girl promptly drops her snatch onto your face.");
            ...
            if (this.player.tongueType > 0) {
                ...
                this.outputText("\n\nClara finally releases your head from her death grip, and lets you move around again.  \"<i>Wow, " + this.player.mf("lover-boy", "lover-girl") + ".  I never imagined you’d be able to do that!  I guess the slave I got had an unexpected feature.  I’m still going to be changing you up to give me anoother kind of pleasure, but damn!  Look at what you made me doo!</i>\"  She indicates the large pool of vaginal fluids covering the floor.  The bedroll you woke up on is completely ruined.");
        ...
        defeatClaraCuntInAFight(cheated = false) {
            if (cheated)
                ...
                else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.ClaraFoughtInCamp) < 0) {
                    this.outputText("Worried about the others, you head out of the cellar and drag Clara and her things with you.  Thanks to the strange way that travel works in this world, it doesn't take you long to find your way back to camp.  You catch your followers there just before they head out to go looking for you and dump your would be kidnaper before them.  Marble steps up next to you and looks down at her sister.");
            ...
            this.outputText("\"<i>Clara, what the hell were you trying to pull there?</i>\" Marble demands of her sister, her hands shaking in rage.");
            this.outputText("\n\n\"<i>Getting a mate, what doo you think?  I was going to take " + this.player.mf("lover-boy", "lover-girl") + " here away to live with me,</i>\" comes the incredulous reply.");
            this.outputText("\n\n\"<i>Getting a... out of my sweetie?!  We're already mates, where do you go off thinking you can just come in here and steal " + this.player.mf("him", "her") + "?</i>\"");
            this.outputText("\n\n\"<i>No sis, you had your chance.  " + this.player.short + " isn't addicted to you, that means that " + this.player.mf("he", "she") + "'s up for grabs.  That's how things work for our race.</i>\"");
            ...
            this.outputText("\n\n\"<i>Admit it, you don't feel like '" + this.player.mf("lover-boy", "lover-girl") + "' here actually cares for you.  How could they if they won't drink your milk?  You're a Lacta Bovine, giving your milk is the most important thing in the world to you.  This isn't love.  Without " + this.player.mf("him", "her") + " actually being addicted to you, it's just a one sided infatuation.  I was doing you a favor by taking " + this.player.mf("him", "her") + " away from you.</i>\"");
            this.outputText("\n\nYour cow-girl companion continues to shake in anger, but also fear and frustration.  \"<i>I, I, YES!  I want to addict " + this.player.short + " to my milk!  I want to so much!  I'm so afraid that " + this.player.mf("he", "she") + " won't stay by my side, but I also feel so bottled up.  "); //no new paragraph
            //if (PC has another lover in camp)
            if (kGAMECLASS_1.kGAMECLASS.camp.loversCount() > 1) {
                this.outputText("I'm not even " + this.player.short + "'s only mate.  " + this.player.mf("He", "She") + " can satisfy their needs, but can't satisfy mine?  "); //no new paragraph
            }
            this.outputText("The frustration of not being able to nurse, someone, anyone, but especially my mate is tearing me apart!</i>\"  Marble stops screaming and her head drops.  All that's coming out of her now is heavy breathing.");
            this.outputText("\n\n\"<i>There, you see?  Now I'm sure you understand why me and " + this.player.short + " here belong toogether.  I won't deny the proper order of things, and I'll make sure that " + this.player.mf("he", "she") + " leads a fulfilling life as my milk slave.  " + this.player.mf("He", "She") + "'ll even by my first husband!</i>\"");
            ...
            this.outputText("\n\nThe younger cow-girl scoffs, \"<i>Haven't you been listening to me sis?  " + this.player.mf("He", "She") + "'ll be addicted to me.  That.  Is.  Love.  How else can you show just how much you care?</i>\"");
            ...
            this.outputText("\n\n\"<i>Really?  Didn't you say that the reason you were purifying yourself was so that " + this.player.mf("he", "she") + " would nurse from you again?  Sounds pretty selfish to me after what you were saying about doing things for who you 'love'.</i>\"");
            ...
            this.outputText("\n\n\"<i>Then if " + this.player.short + " loves you so much, why can't " + this.player.mf("he", "she") + " change for your sake?  Why can't they become addicted to show just how much they love you?</i>\"");
            this.outputText("\n\nMarble swallows before saying, \"<i>Do you have any idea of what " + this.player.short + " is trying to do?  " + this.player.mf("He", "She") + " is trying to defeat the demons!  To stop the corruption for good!</i>\"");
            ...
            if ((this.player.hasCock() && this.player.cockThatFits(20) >= 0) || this.player.hasVagina())
                this.outputText("use Marble's unstable state of mind to get her into a forceful threesome with Clara, ");
            //(if PC either has a cock that will fit Marble, or has a vagina)
            if ((this.player.hasCock() && this.player.cockThatFits(this.marbleScene.marbleCuntCapacity()) >= 0) || this.player.hasVagina())
            ...
            this.outputText(" or try to calm Marble down so that she doesn't do anything to her sister.");
            this.menu();
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0)
                this.addButton(3, "Marble Cock", this.futaMarbleIsAHugeCowToCowCuntAndStuffsCowCuntsCuntFullOfCowCock);
        ...
        murbleSpanksCowCunt() {
            this.clearOutput();
            this.outputText("Marble seems to have a good idea on how to punish Clara already, so you just sit back and watch.");
        ...
        pcAndMurbleDoubleTeamCowButt() {
            this.clearOutput();
            var x = this.player.cockThatFits(20);
            this.outputText("You step forward and suggest to Marble that the two of you should work together to punish Clara.  She nods and asks what you have in mind.  Well, you were thinking that a sexual punishment from the two of you would be appropriate.");
            ...
            if ((this.player.hasCock() && x >= 0) && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0) {
                //n is the index of the PC's biggest cock under 20 area.
                this.outputText("Eventually you pull her up and sandwich her between your bodies.  Marble expresses an aversion to anal, so you take the backside while she takes the front.  \"<i>Hey, you can't do this to me!  I don't want to lose my virginity to my sister!</i>\" Clara cries out indignantly.");
                ...
                this.outputText("\n\nMarble looks to the side of her sister's head, and gives you a solemn nod.  You take that as an invitation to begin the violation and grab a good grip of Clara's expansive rear.  Then you prod your " + this.cockDescript(x) + " at the entrance to her anus, prompting a gasp and plea from the woman you're about to penetrate to stop.  Her sister doesn't heed her begging, and neither do you.");
            ...
            else if ((this.player.hasCock() && x >= 0) && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] == 0) {
                //n is the index of the PC's biggest cock under 20 area.
                ...
                this.outputText("\n\n\"<i>You will if you don't want me to twist your ears,</i>\" comes the response.  You prod your " + this.cockDescript(x) + " up against her tight asshole and suggest that you might be taking a different entrance if she doesn't cooperate for her punishment.  \"<i>Of course, if you're sorry for what you tried to do to " + this.player.short + "...</i>\" Marble suggests.");
        ...
        NTRIsClearlyTheWorstFetishWhyWouldYouWriteThisOMG() {
            ...
            var x = this.player.cockThatFits(this.marbleScene.marbleCuntCapacity());
            if (this.player.hasCock() && x >= 0) {
                this.outputText("she drops herself onto your " + this.cockDescript(x) + ".  Since your bovine mate isn't in the habit of wearing any form of undergarments, her skirt doesn't really do much to get in the way of penetration.  A shriek of dismay accompanies this act.");
            ...
            else if (this.player.hasVagina() && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0) {
                this.outputText("she drops herself onto the ground next to you.  Abruptly, she lifts you up and drops your womanhood onto the member you gave her.  Since your bovine mate isn't in the habit of wearing any form of undergarments, her skirt doesn't really do much to get in the way of penetration.  A shriek of dismay accompanies this act.");
            ...
            //else if (PC has a vagina and Marble does not have a cock)
                ...
                this.outputText("she drops herself onto your legs, and grabs one of them.  Instantly, your two womanhoods are being grinded against one another with great force and urgency.  Since your bovine mate isn't in the habit of wearing any form of undergarments, her skirt doesn't really do much to get in the way of tribadism.  A shriek of dismay accompanies this act.");
        ...
        futaMarbleIsAHugeCowToCowCuntAndStuffsCowCuntsCuntFullOfCowCock() {
            this.clearOutput();
            this.outputText("You call out to Marble and suggest that she should use her new \"appendage\" to punish Clara.  She hesitates for a moment, then nods.  You doubt that you could have ever gotten her to do something like that if she wasn't as worked up as she is.");
        ...
        calmMurblesFatAssDown() {
            this.clearOutput();
            this.outputText("That's enough.  You put your hand on Marble's shoulder and she turns to you in surprise.  Her body is still shaking with barely controlled rage, eyes filled with pain and anger mixed together, the flood of tears is just barely kept at bay.  You tell her to calm down and take a deep breath while wrapping your arms tightly around her body.  Instantly her body freezes in place for several moments, then she bursts into tears and ");
            //if ((PC taller than 6'8" and Marble not cow-morph) or (PC taller than 7'2" and Marble cow-morph))
            if ((this.player.tallness >= 80 && this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] < 2) || (this.player.tallness >= 86 && this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] >= 2)) {
                this.outputText("tightly hugs herself against your body.  Gently stroking her hair, you're happy to be a shoulder for her to cry on, given both your affection for the gentle girl and the awareness that you're able to help her feel better.");
            }
            //else if (PC taller than 5 feet)
            else if (this.player.tallness >= 60) {
                this.outputText("returns the hug.  Rocking back and forth against one another, you're happy to be here for her, given both your affection for the lovely lady and the warm feeling of being so close to one you care so much for.");
            }
            else {
                this.outputText("scoops you up, hugging you tightly into her chest.  Sandwiched between her massive mammaries, you're happy to serve as her temporary comfort doll, given both your affection for the big bovine and the pleasant accommodation of her bountiful breasts.");
            }
        ...
        theFormulaIsDone() {
            this.clearOutput();
            this.outputText("Rathazul tells you that the formula is ready, so you head over to Marble to let her know.");
        ...
        //Marble is purified
        purifyMarbleComplete() {
            this.clearOutput();
            this.outputText("The two of you arrive at Rathazul's workspace, and find the owner awaiting you, holding a bottle of whitish fluid with gold streaks running throughout.  \"<i>So is that the formula?</i>\"  Marble asks looking at the bottle.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] > 0) {
                ...
                this.outputText(" a two drop dose,</i>\" the alchemist instructs you and hands over the bottle of his formula.");
        ...
        dealingWithCowCuntPostPurification() {
            this.clearOutput();
            this.outputText("Now there is only one more loose end in this whole effort to purify Marble: her sister.");
        ...
        purifyMurblesSister() {
            this.clearOutput();
            this.outputText("You ask Marble for the bottle of Rathazul's formula.  She nods, hands it to you and says, \"<i>Yeah, I think that's the best choice too.</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.CLARA_PURIFIED] = 1;
        ...
        cageDatCowCunt() {
            this.clearOutput();
            this.outputText("You say that you're going to be keeping Clara a prisoner in the camp.  She deserves to be imprisoned so she'll no longer be a threat to anyone anymore.  Marble looks uncertain at you and asks if you're sure she needs to be locked up now that she's been purified.  You say you're certain, and your mate nods to you and says that she trusts your judgment on this matter.");
            ...
            this.flags[kFLAGS_1.kFLAGS.CLARA_IMPRISONED] = 1;
        ...
        //Let go
        letGoOfMarblesCowCuntSister() {
            this.clearOutput();
            this.outputText("You say that now that Clara is no danger to anyone any more, she is free to go, so long as she promises to never bother you or your followers again.  Marble nods at this and says she agrees with your decision.");
        ...
        dontPurifyClara() {
            this.clearOutput();
            this.outputText("No, you'll offer her the mercy of letting her keep her precious corruption.  Marble tells you she will respect your decision on that matter.  Now the question is what to do with her.");
            this.outputText("\n\nYou guess you could also build a cage in the camp if you really want to keep an eye on her yourself.  That will make her another mouth to feed, and you'll have to hear her ranting every day.  Still, the saying does go, \"keep your enemies closer.\"");
            this.outputText("\n\nIf you're feeling especially generous, you could just let her go, with not more than a promise to never come back or try to kidnap you again.");
            //PC makes their choice: Tel'Adre, camp cage, let go."
            this.menu();
        ...
        //Camp Cage
        stickUnpurifiedClaraInACage() {
            this.clearOutput();
            this.outputText("You say that you're going to be keeping Clara a prisoner in the camp.  She deserves to be imprisoned so she'll be no threat to anyone anymore.  Marble nods to you and says that she trusts your judgment on this matter.");
        ...
        purificationQuestFinal() {
            this.clearOutput();
            this.outputText("\"<i>It has been quite the morning, hasn't it sweetie?</i>\"  It certainly has been, but at least now, your lover is finally free of her corruption once and for all.");
            this.outputText("\n\nYou've gained 500 exp for helping Marble attain purity.");
            //increase exp by x
            this.player.XP += 500;
            //Marble corruption is set to 10
            this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] = 5;
            this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFIED] = 1;
            this.player.changeStatusValue(StatusAffects_1.StatusAffects.Marble, 4, 10);
        ...
        purifiedSuccubusMilkForPureMarbles() {
            this.clearOutput();
        ...
        //if yes
        actuallyGrowPureMarblesTittiesForFunzies() {
            this.clearOutput();
            this.outputText("You offer Marble a bottle of purified succubus milk and tell her that you'd like her to make her bust bigger.");
            //if (Marble's breast size < 3)
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BREAST_SIZE] < 3) {
                this.outputText("\n\n\"<i>Alright, if you say so.</i>\"  Marble lifts the bottle to her mouth, and drinks the substance down.  She lets out a soft sigh and starts massaging her bouncy tit flesh as it expands outwards.  Through her shirt, you can see her " + kGAMECLASS_1.kGAMECLASS.marbleScene.marbleBreastSize() + " breasts balloon into ");
                //increase Marble's breast size by 1
                this.flags[kFLAGS_1.kFLAGS.MARBLE_BREAST_SIZE]++;
                this.outputText(kGAMECLASS_1.kGAMECLASS.marbleScene.marbleBreastSize() + " melons!");
                //if (Marble's breast size == 1)
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BREAST_SIZE] == 1) {
        ...
        //if yes
        pureMurblePCChoosesYesToShrinkeyTits() {
            this.clearOutput();
            this.outputText("You offer Marble a jar of reducto and tell her you'd like her to reduce her bust's size a bit.");
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BREAST_SIZE] > 0) {
                this.outputText("\n\n\"<i>Alright, if you say so.</i>\"  Marble opens the jar of reducto, lifts up her top, and slathers the green gel onto her breasts.  She lets out a soft sigh as the substance takes effect, and her tremendous " + kGAMECLASS_1.kGAMECLASS.marbleScene.marbleBreastSize() + " tits slowly shrink in size, becoming a pair of more modest ");
                //decrease Marble's breast size by 1
                this.flags[kFLAGS_1.kFLAGS.MARBLE_BREAST_SIZE]--;
                this.outputText(kGAMECLASS_1.kGAMECLASS.marbleScene.marbleBreastSize() + " sized breasts.");
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BREAST_SIZE] == 0) {
        ...
        nursingFromPureMarble() {
            this.clearOutput();
            //if(time since last nursing is < 4 hours)
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] < 4) {
                ...
                this.outputText("\n\nOnce you arrive, your lover teases you a bit by grabbing her " + kGAMECLASS_1.kGAMECLASS.marbleScene.marbleBreastSize() + " breasts through her top and playing around with them for a moment.  The bouncy flesh rolls around her hands in a very pleasant manner, and you feel your mouth water in anticipation of the delicious milk hidden within.");
                ...
                if (this.player.tallness < 65) {
                    this.outputText("The tall cow-lady takes a seat on the rocks and you jump onto her lap, ");
                }
                ...
                this.outputText("in seconds your lips are wrapped around her teats, and her wonderful milk is flowing forth.");
                ...
                this.fatigue(-30);
                //increase lust by 15
                kGAMECLASS_1.kGAMECLASS.stats(0, 0, 0, 0, 0, 0, 15, 0);
        ...
        marbleWarnsPCAboutCorruption() {
            this.clearOutput();
            this.outputText("Marble comes up to you with a worried look on her face.  \"<i>Uh, sweetie?  I'm getting worried about you.  You're trying to put so much effort into freeing me of corruption, but you seem to be slipping away yourself...</i>\"  She looks at the ground, rubs her hands a few times desperately trying to spit the words out.  \"<i>I don't think I'll be able to stay by your side if you keep falling like that.  Please find a way to clear yourself of the corruption that's gripping you!</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.MARBLE_WARNED_ABOUT_CORRUPTION] = 1;
            //end event
            this.doNext(this.playerMenu);
        }
        //Leaving from corruption
        //PC's corruption is now too high.
        marbleLeavesThePCOverCorruption() {
            this.clearOutput();
            this.outputText("Marble approaches you with a somber expression on her face, her things strapped to a pack on her back");
            //if (PC has more than one child with Marble)
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] > 1)
                this.outputText(" , and with her children in tow");
            ...
            this.outputText(".  \"<i>I'm sorry sweetie.  I tried to warn you, but-</i>\" she stops for a moment and takes a deep breath to steady herself.  ");
            //if (PC has at least one child with Marble)
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] > 0) {
                this.outputText("\"<i>Mommy, what's wrong?</i>\"  The young one holding Marble's hand asks nervously.\"<i>Hush now, little one.  We have to go away for awhile,</i>\" the bovine mother responds and turns back to you.  ");
            }
            this.outputText("\"<i>You've gotten too corrupted, and I can't stay here with you anymore.  Please find a way to free yourself from the taint within you so that I can come back.  Goodbye.</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.MARBLE_LEFT_OVER_CORRUPTION] = 1;
        ...
        pureMarbleDecidesToBeLessOfABitch() {
            ...
            //if (PC has at least one child with Marble)
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] > 0)
                this.outputText(" and that of your child");
            ...
            this.flags[kFLAGS_1.kFLAGS.MARBLE_LEFT_OVER_CORRUPTION] = 0;
        ...
        claraCampAddition() {
            this.outputText("  Nearby the portal sits a large wooden cage for keeping Marble's sister Clara prisoner.  It is tall enough for her to stand in and long enough for her to lie down completely.  ");
            //if (Clara was purified)
            if (this.flags[kFLAGS_1.kFLAGS.CLARA_PURIFIED] > 0) {
                if (MarblePurification.rand(10) == 0)
                    this.outputText("You catch Clara staring at you for a moment, then her gaze once again returns to some distant mountain top.  She has not taken her purification well.");
                else
                    this.outputText("As always, Clara sits within, staring off into the distance.  She has not taken her purification well.");
            }
            else {
                //if (time of day <= 7 OR >= 20)
                if (kGAMECLASS_1.kGAMECLASS.time.hours <= 7 || kGAMECLASS_1.kGAMECLASS.time.hours >= 20)
                    this.outputText("Clara is laying sprawled out on the ground of her cage, snoring loudly.");
                else {
                    this.temp = MarblePurification.rand(4);
                    switch (this.temp) {
                        case 0:
                            this.outputText("Clara is currently fidgeting with her clothing, it looks like she's doing some repairs or embroidery.  It's one of the few grateful moments of quiet you get from her.");
                            break;
                        case 1:
                            this.outputText("Clara is heckling and throwing insults at your followers right now.  It's very annoying, but everyone ignores her.");
                            break;
                        case 2:
                            this.outputText("Clara is currently engaged in trying to tempt you into letting her out of her cage and becoming addicted to her.  It's much the same as all of her previous attempts....");
                            break;
                        case 3:
                            this.outputText("Clara is currently loudly whining about the conditions of her confinement to anyone who is willing to listen, which is no one.");
                            break;
                    }
                }
            }
    ...
    exports.MarblePurification = MarblePurification;
});
//# sourceMappingURL=MarblePurification.js.map