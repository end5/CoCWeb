define(["require", "exports", "./NPCAwareContent", "../../PregnancyStore", "../../GlobalFlags/kFLAGS", "../../CoC", "../../../console", "../../StatusAffects", "../../PerkLib", "./Marble", "../../../../includes/appearanceDefs", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, StatusAffects_1, PerkLib_1, Marble_1, appearanceDefs_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class MarbleScene extends NPCAwareContent_1.NPCAwareContent {
        constructor() {
            super();
            this.checkedMarbleMilk = 0; //Make sure we test each of these events just once in timeChangeLarge
            this.pregnancy = new PregnancyStore_1.PregnancyStore(kFLAGS_1.kFLAGS.MARBLE_PREGNANCY_TYPE, kFLAGS_1.kFLAGS.MARBLE_PREGNANCY_INCUBATION, 0, 0);
            this.pregnancy.addPregnancyEventSet(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, 648, 528, 432, 288, 144);
        ...
        timeChange() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampMarble) >= 0) {
                //Marble stuff pt I
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_1] > 0) {
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_1]--;
                    //Stick it at 1 so I can trigger it off the camp screen.
                    if (this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_1] <= 1)
                        this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_1] = 1;
                }
                //Counting down to purity!
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] == 0) {
                    if (this.flags[kFLAGS_1.kFLAGS.MARBLE_COUNTUP_TO_PURIFYING] < 200)
                        this.flags[kFLAGS_1.kFLAGS.MARBLE_COUNTUP_TO_PURIFYING]++;
                }
                //Counter 2!
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_2] > 0) {
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_2]--;
                    //Stick it at 1 so I can trigger it off the camp screen.
                    if (this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_2] <= 1)
                        this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_2] = 1;
                }
                //Post purification nursitude
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] >= 5) {
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS]++;
                    if (this.flags[kFLAGS_1.kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] > 1000)
                        this.flags[kFLAGS_1.kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] = 1000;
                }
                //Reset Marble corruption warning
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_WARNED_ABOUT_CORRUPTION] == 1 && this.player.cor < 50)
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_WARNED_ABOUT_CORRUPTION] = 0;
                //Lactation whoopie!
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] < 100)
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS]++;
                //Increment Marble's Lust
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] < -100)
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] = -100;
                if (MarbleScene.rand(2) == 0)
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] += 1;
                if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) > 50)
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] += .3;
                if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) > 70)
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] += .3;
                //If bitch-bin is in construction
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_NURSERY_CONSTRUCTION] > 0 && this.flags[kFLAGS_1.kFLAGS.MARBLE_NURSERY_CONSTRUCTION] < 100 && this.marbleScene.marbleAtCamp()) {
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_NURSERY_CONSTRUCTION]++;
                    if (this.flags[kFLAGS_1.kFLAGS.MARBLE_NURSERY_CONSTRUCTION] >= 100) {
                        ...
                        needNext = true;
                        this.flags[kFLAGS_1.kFLAGS.MARBLE_NURSERY_CONSTRUCTION] = 100;
                    }
                }
                //Marble find items check
                else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleHasItem) < 0 && this.marbleScene.marbleAtCamp()) {
                    // Off cooldown
                    if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleItemCooldown) < 0) {
                        if (MarbleScene.rand(10) == 0) {
                            this.spriteSelect(41);
                            this.outputText("\n<b>You find a note from Marble back at camp, letting you know that she has an item for you!</b>\n", false);
                            this.player.createStatusAffect(StatusAffects_1.StatusAffects.MarbleItemCooldown, (24 + MarbleScene.rand(24)), 0, 0, 0);
                            this.player.createStatusAffect(StatusAffects_1.StatusAffects.MarbleHasItem, MarbleScene.rand(10), 0, 0, 0);
                            needNext = true;
                        }
                    }
                }
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleItemCooldown) >= 0) {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.MarbleItemCooldown, 1, -1);
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.MarbleItemCooldown) < 1)
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.MarbleItemCooldown);
            }
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) < 0)
                this.flags[kFLAGS_1.kFLAGS.MARBLE_GROSSED_OUT_BECAUSE_WORM_INFESTATION] = 0;
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarblesMilk) >= 0 && this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) < 0) {
                //Decrement time remaining by 1		
                this.player.addStatusValue(StatusAffects_1.StatusAffects.MarblesMilk, 1, -1);
                //Remove the status and stat boosts when time runs out on the milk
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.MarblesMilk) <= 0) {
                    needNext = true;
                    this.dynStats("str", (-1 * this.player.statusAffectv2(StatusAffects_1.StatusAffects.MarblesMilk)), "tou", (-1 * this.player.statusAffectv3(StatusAffects_1.StatusAffects.MarblesMilk)));
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.MarblesMilk);
                    //Text for when Marble's Milk effect wears off:
                    //[addiction is 10 or less] 
                    if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) <= 10)
                    ...
                    //[addiction is 11-30]
                    else if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) <= 30)
                    ...
                    else if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) <= 50)
                        this.outputText("\nYou shiver slightly as the euphoria from Marble's milk fades.  You really feel like suckling her breasts again.\n", false);
                    //IF ADDICTED
                    if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) > 0) {
                        //If player is under bottled milk effects
                        if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BottledMilk) >= 0) {
                            ...
                            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) <= 90)
                            ...
                            this.player.createStatusAffect(StatusAffects_1.StatusAffects.MarbleWithdrawl, 0, 0, 0, 0);
            ...
            if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) > 0 && this.player.findPerk(PerkLib_1.PerkLib.MarbleResistant) < 0 && this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) < 0 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) > 25) {
                //If player does not have marble's milk or bottled milk, go into withdrawl
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarblesMilk) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.BottledMilk) < 0) {
                    //If player is not yet in withdrawl
                    if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleWithdrawl) < 0) {
            ...
            if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) <= 0) {
                if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) > 60)
                    this.player.changeStatusValue(StatusAffects_1.StatusAffects.Marble, 2, 60);
            }
            //Withdrawl removal if you get unaddicted.
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleWithdrawl) >= 0) {
                if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) <= 25) {
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.MarbleWithdrawl);
                    this.dynStats("tou", 5, "int", 5);
                    this.outputText("\nYou no longer feel the symptoms of withdrawal.\n", false);
                    needNext = true;
                }
                //Remove withdrawl if you have bottled milk affect
                else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BottledMilk) >= 0) {
                    this.outputText("\nYou no longer feel the symptoms of withdrawal.\n", false);
                    needNext = true;
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.MarbleWithdrawl);
                    this.dynStats("tou", 5, "int", 5);
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BottledMilk) >= 0) {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.BottledMilk, 1, -1);
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.BottledMilk) <= 0)
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.BottledMilk);
            }
            if (this.model.time.hours > 23) {
                this.flags[kFLAGS_1.kFLAGS.MARBLE_PLAYED_WITH_KIDS_TODAY] = 0;
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Marble) >= 0 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) > 0)
        ...
        timeChangeLarge() {
            ...
            if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) > 0 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) < 25 && this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) < 0 && this.player.findPerk(PerkLib_1.PerkLib.MarbleResistant) < 0 && this.model.time.hours == 6) {
                this.spriteSelect(41);
                ...
                this.outputText("You find Marble in her room.  When you come in she looks up at you and starts.  \"<i>What happened?</i>\" she asks, \"<i>Something about you is completely different from before...</i>\"  You explain to her that you've gotten over your addiction and no longer crave her milk.\n", false);
                //(reduce corr by 5)
                this.dynStats("cor", -5);
                ...
                this.player.createPerk(PerkLib_1.PerkLib.MarbleResistant, 0, 0, 0, 0);
                //After player ends Addiction:
                //Marble liked you addicted
                if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) == 1) {
                    //Affection 0-29, version 1
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) < 30) {
                        ...
                        this.player.createStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble, 0, 0, 0, 0);
                    }
                    //Affection 30-89, version 1
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) >= 30 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) < 90) {
                    ...
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) >= 90) {
                        ...
                        this.player.createStatusAffect(StatusAffects_1.StatusAffects.CampMarble, 0, 0, 0, 0);
                        this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_MARBLE] = 0;
                        if (kGAMECLASS_1.kGAMECLASS.isabellaFollowerScene.isabellaFollower() && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_ISABELLA] == 0)
                            this.flags[kFLAGS_1.kFLAGS.ISABELLA_MURBLE_BLEH] = 1;
                        //if amily is there, tag it for freakout
                        if (this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] > 0 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_AMILY] == 0) {
                        ...
                        if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00238] == 1 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] == 0) {
                            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00237] = 1;
                        }
                        this.player.createStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble, 0, 0, 0, 0);
                    }
                }
                //Ashamed Marble
                    ...
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) >= 30 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) < 70) {
                    ...
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) >= 70) {
            ...
            if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) > 0 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) >= 100 && this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) < 0 && this.player.findPerk(PerkLib_1.PerkLib.MarbleResistant) < 0 && this.model.time.hours == 6) {
                this.spriteSelect(41);
                ...
                this.outputText("You find Marble in her room.  When you come in she looks up at you and smiles deeply.  \"<i>What happened?</i>\" she asks, \"<i>Something about you feels so wonderful and right.</i>\"  You explain to her that you've finally become entirely dependent on her milk.\n", false);
                ...
                this.player.createPerk(PerkLib_1.PerkLib.MarblesMilk, 0, 0, 0, 0);
                //Clear withdrawl
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleWithdrawl) >= 0) {
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.MarbleWithdrawl);
                    this.dynStats("tou", 5, "int", 5);
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarblesMilk) >= 0) {
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.MarblesMilk);
                }
                ...
                if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) == 1) {
                    ...
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) < 49) {
                    ...
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) >= 50 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) < 79) {
                    ...
                    //High affection
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) >= 80) {
            ...
            if (this.checkedMarbleMilk++ == 0 && this.model.time.hours == 6 && this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0) {
                //Marble is at camp
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampMarble) >= 0) {
                ...
                //Marble isn't at camp
                    ...
                    if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble) < 0) {
                        this.postAddictionFarmMornings();
                        kGAMECLASS_1.kGAMECLASS.timeQ++; //We can get rid of this: threshhold--;
                    }
                }
                this.doNext(this.playerMenu);
                return true;
        ...
        marbleFollower() {
            return this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampMarble) >= 0;
        }
        marbleAtCamp() {
        ...
        marbleBreastSize() {
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFIED] > 0) {
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BREAST_SIZE] == 0)
                    return "DD cup";
                else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BREAST_SIZE] == 1)
                    return "G cup";
                else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BREAST_SIZE] == 2)
                    return "HH cup";
                else
                    return "J cup";
            }
            else {
                if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) > 30)
                    return "HH cup";
                else
                    return "G cup";
            }
        ...
        turnOffMarbleForever() {
            ...
            this.flags[kFLAGS_1.kFLAGS.MARBLE_WARNING] = 1;
        ...
        leaveNonFriendsMarble4EVERRRR() {
            ...
            this.spriteSelect(41);
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble, 0, 0, 0, 0);
            this.flags[kFLAGS_1.kFLAGS.MARBLE_WARNING] = 2;
        ...
        apologizetoWalkingTitsIMEANMARBLE() {
            ...
            if (this.player.inte < 15)
                this.outputText("Eventually you find Marble stopped, looking towards you with her hands in the air saying, \"<i>You caught me!  Come here.</i>\"  She beckons you towards her chest, and you don't make her wait.");
            ...
            this.flags[kFLAGS_1.kFLAGS.MARBLE_WARNING] = 0;
            //(apply the stat effect 'Marble's Milk' to the player)
            this.applyMarblesMilk();
            this.dynStats("lib", .2, "lus", (5 + this.player.lib / 10));
        ...
        stayForFights() {
            this.clearOutput();
            this.spriteSelect(41);
            this.outputText("You fold your arms over your chest and scowl as Marble trudges back over the fields carrying a huge hammer.  Part of you feels terribly juvenile to be solving an argument with violence - but the other part is cheering at the opportunity to put the bossy cow in her place.");
            //go to battle
            this.startCombat(new Marble_1.Marble(), true);
        }
        //[Fuck That]
        getOutOfDodge() {
            this.clearOutput();
            ...
            this.flags[kFLAGS_1.kFLAGS.MARBLE_WARNING] = 3;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        marbleFightWin() {
            ...
            if (this.monster.HP < 1)
                this.outputText("Marble falls to the ground defeated; she looks up at you helplessly, wondering what you're going to do next.  ", false);
            //win by lust
            else
                this.outputText("Marble collapses and looks at you longingly, pulling up her skirt with a look of desperation in her eyes.  ", false);
            //after the lust+HP defeat scenes if the player wins
            this.outputText("You've gathered a bit of a crowd around you now, thanks to the noise of this cow clunking around with her huge hooves and hammer.  It might not be a terribly good idea to rape Marble...  you'd have to drag her up to her room just to avoid interruption and Whitney would likely find out and be upset.  What do you do?");
            //Options, rape in room, milk (Spy's submission - not included yet) and, don't rape.
            var feed = undefined;
            if (this.player.findPerk(PerkLib_1.PerkLib.Feeder) >= 0 || this.player.lactationQ() > 200)
        ...
        marbleFightLose() {
            ...
            //lose by hp
            if (this.player.HP < 1)
                this.outputText("After a few too many blows to the head, you topple over to the ground.  ", false);
            //lose by lust
            else
                this.outputText("Overcome by desire, you fall to your knees, and start masturbating furiously.  Disgusted with you, Marble hits you upside the head once more, knocking you over.  ", false);
            this.outputText("She leans in close to your head and whispers \"<i>Don't ever come near me again, or I will crush your head with this hammer.</i>\"  She stands up and walks away from you as you pass out from your head injuries.  ", false);
        ...
        rapeMarbleInHerRoom() {
            this.clearOutput();
            this.spriteSelect(41);
            this.outputText("You aren't going to give up on this opportunity, but you don't want to have an audience either.  So you drag Marble and her hammer back to her room, and throw Marble onto her bed, grabbing and twisting her nipples, causing her to cry out in pain and pleasure.");
            //continue onto original rape
            this.spriteSelect(41);
            this.outputText("  You suddenly grab at her breasts and squeeze them roughly, at which point she screams and ", false);
            this.outputText("tries to slap you.  You easily duck under her hand and start twisting her nipples.  She squeals and begins to go limp under your painful ministrations.  You move her around and force her to kneel, pushing her face down into her bed.  Keeping one of your hands on her nipple, you pull down her skirt and expose her beautiful womanhood and asshole.\n\n", false);
            //dicked players
            if (this.player.cocks.length > 0) {
                this.outputText("Chuckling to yourself, you free your " + this.multiCockDescriptLight() + " from your " + this.player.armorName + ".  You spend a moment to ask the helpless cow-girl if she is ready, her only response being a whimper, before ", false);
                ...
                if (this.player.cocks[0].cockThickness < 3) {
                    ...
                    if (this.player.cocks[0].cockLength <= 8) {
                        this.outputText("forcing your " + this.cockDescript(0) + " in as far as it will go.  ", false);
                    }
                    else {
                        this.outputText("forcing your " + this.cockDescript(0) + " in to the hilt.  ", false);
                    }
                    //the raping proper
                    this.outputText("With a grunt of pleasure, you start to push in and out while simultaneously manhandling her sensitive breasts.  Her pained cries and squeals only make you hornier and the experience all the more enjoyable for you.  You laugh from the pleasure you're getting at the expense of her pain.  Slapping her ass and marvelling at how it jiggles, you quicken the pace of your thrusts inside her.  Marble gasps at the increased rate, alternating between tones of pleasure and pain.\n\n", false);
                    //is the player corrupt enough to get the fantasy?
                    if (this.player.cor >= 33)
                        this.marbleRapeCorruptFantasy();
                    this.outputText("You taunt her one more time before feeling your body get racked by an orgasm and you blow your load inside her.  ", false);
                    //set player's lust to 0
                    this.player.orgasm();
                }
                //now if the player doesn't fit
                else {
                    this.outputText("attempting to push your " + this.cockDescript(0) + " inside her.  Of course, the girth of your " + this.cockDescript(0) + " makes this a rather difficult operation, and it becomes clear after a few moments that it just isn't going to fit.  Instead, you contend yourself by rubbing yourself between her ample ass cheeks, occasionally stroking your " + this.multiCockDescriptLight() + " in pride.\n\n", false);
                    //is the player corrupt enough to get the fantasy?
                    if (this.player.cor >= 33)
                        this.marbleRapeCorruptFantasy();
                    this.outputText("You taunt her one more time before feeling your body get racked by an orgasm and you blow your load onto her ass.  ", false);
                    //set player's lust to 0
                    this.player.orgasm();
                }
            }
            ...
            this.flags[kFLAGS_1.kFLAGS.FARM_DISABLED] = 1;
            //End event
            this.cleanupAfterCombat();
        }
        //Force-feed (by Spy) (Z)
        forceFeedMarble() {
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.Feeder) >= 0)
                this.outputText("You bet this cow-girl loves to get milked and nursed on just like you, but how often does she get to taste the creamy sweetness of milk?  Having her suck on your own leaky tits would be doing her a favor, right?  You approach the defeated cow-girl; her eyes are still locked onto you, wondering what you're going to do next.  Well, not that you can do much with this crowd watching you...\n\n");
            this.outputText("You never really noticed how many people live on this farm until now.  They're all probably expecting you to rape her - and not all of them are reconciled to the idea, judging by the looks you're getting.  What the hell, you might as well continue your business with these on-lookers around anyway... you're like 99% sure you won't be in trouble for feeding a cow.");
            ...
            this.outputText(", but she keeps them tightly closed, refusing to drink your sweet milk.");
            ...
            this.player.addStatusValue(StatusAffects_1.StatusAffects.Feeder, 1, 1);
            this.player.changeStatusValue(StatusAffects_1.StatusAffects.Feeder, 2, 0);
            this.cleanupAfterCombat();
        }
        resistMarbleInitially() {
            ...
            //(player chose resist)
            this.outputText("", true);
            this.outputText("Surprised by your resistance, she pulls back and apologizes for being presumptuous.  ", false);
        ...
        encounterMarbleExploring() {
            this.spriteSelect(41);
            this.outputText("", true);
            this.outputText("While wandering around the farm, you meet the cow-girl Marble heading towards the barn.  ", false);
            //[player height < 5 feet]
            if (this.player.tallness < 60)
                this.outputText("Marble gives her customary greeting of hugging you to her breast before telling you that she is off to get milked at the barn.  ", false);
            //[player hight >= 5 feet]
            else
                this.outputText("You exchange a quick greeting before Marble tells you that she is off to get milked at the barn.  ", false);
            //[affection <30]
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) < 30) {
            ...
            //[affection >=30]
                ...
                if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) < 40) {
        ...
        drinkMarbleMilk() {
            ...
            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) >= 50) {
        ...
        encounterMarbleExploring2() {
            this.spriteSelect(41);
            this.outputText("", true);
            this.outputText("You decide to pay Marble a visit at her room.  ", false);
            //[player height <5]
            if (this.player.tallness < 60)
                this.outputText("As you step into her room, she eagerly rushes over and hugs you to her breast. \"<i>You're as cute as ever, sweetie!</i>\"  ", false);
            this.outputText("She is happy to see you and treats you to a small meal while you have a pleasant chat.  ");
            if (this.flags[kFLAGS_1.kFLAGS.MURBLE_FARM_TALK_LEVELS] < 7) {
                this.extendedMurbelFarmTalkz();
                this.doNext(this.camp.returnToCampUseOneHour);
                return;
            }
            else
                this.outputText("While you talk mostly about unimportant things, there is some discussion about the world and the dangers within.");
            //[addiction >30]
            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) > 30) {
            ...
            //[affection <60]
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) < 60) {
                ...
                if (this.player.inte < 30)
                    ...
                    this.dynStats("int", 2);
                else if (this.player.inte < 60)
                    this.dynStats("int", 1);
                this.doNext(this.camp.returnToCampUseOneHour);
            }
            else {
                //[affection >=60, player has not had sex with Marble]
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FuckedMarble) < 0) {
        ...
        turnDownMarbleSexRepeat() {
            this.spriteSelect(41);
            this.outputText("", true);
            this.outputText("She looks disappointed at your refusal but quickly brightens up and says, \"<i>Ok sweetie, next time then.</i>\" On that note, you bid farewell to the pretty cow-girl and return to your camp.", false);
        ...
        AcceptMarblesSexualAdvances() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FuckedMarble) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.FuckedMarble, 0, 0, 0, 0);
        ...
        helpMarble1() {
            ...
            if (this.player.str < 20)
                this.outputText("Unfortunately, the crates are quite heavy and you end up having to stick with small ones to keep up with Marble's pace.  She doesn't appear to mind, just enjoying having someone to talk to while she works, even if it doesn't save her many trips.\n\n", false);
            //[player str >=20, <50]
            if (this.player.str >= 20 && this.player.str < 50)
                this.outputText("You try your best, but for every crate you carry, Marble caries three. She doesn't mind though, since you'll end up saving her a quarter of the trips she would have had to make.\n\n", false);
            //[player str >=50, <80]
            if (this.player.str >= 50 && this.player.str < 80)
                this.outputText("You put your back into the job and manage to match Marble in her efforts.  She is really impressed with your strength, and together you can cut the number of trips needed in half.\n\n", false);
            //[player str >=80]
            if (this.player.str >= 80)
                this.outputText("Marble may be strong, but you are stronger.  She is amazed as you manage to take even more crates at a time than she can, only held back by the number you can balance.  Thanks to your efforts, the chore only takes a third of the number of trips it normally would have taken.\n\n", false);
            this.outputText("After a little while, you notice that Marble is walking with an almost mesmerizing sway in her hips as she carries the crates; it is rather hard to take your eyes off her.  ", false);
            if (this.afterMarbleHelp())
                return;
            this.outputText("When the two of you finish and you start to leave, Marble calls out to you, \"<i>Wait, let me give you something!</i>\" You turn and look back at her as she rushes up to you.  Smiling brilliantly, the cow-girl hands you a bottle full of warm milk, \"<i>My gift to you for your help, fresh from the source.</i>\" she says, patting her sizable chest.\n\n", false);
            //(increase player str)
            this.dynStats("str", 1);
        ...
        helpMarble2() {
            ...
            if (this.player.spe < 20)
                this.outputText("Even though Marble often stops to munch on a weed, she is still able to get more weeds then you do.  Despite her size, she can move surprisingly fast.  Regardless, she enjoys simply having you there while she works, and you get to enjoy the view.\n\n", false);
            //[player spd >=20, <50]
            if (this.player.spe >= 20 && this.player.spe < 50)
                this.outputText("You put in a good effort at cleaning out the weeds, and Marble often gives you a good look at her rear when she finds a tasty looking weed.\n\n", false);
            //[player spd >=50, <80]
            if (this.player.spe >= 50 && this.player.spe < 80)
                this.outputText("Moving quickly through the fields, you surprise Marble with your speed so much that she jokingly pouts that you're getting to all the tasty weeds before she has a chance to eat them.  You still end up getting a few good views of her ass.\n\n", false);
            //[player spd >=80] 
            if (this.player.spe >= 80)
                this.outputText("Weeding the field is a breeze for you, going fast enough that you're able to bring weeds to Marble faster than she can eat them.  In the end, you do almost all the work yourself.  She does reward you with a good view for your efforts.\n\n", false);
            //(increase player spd)
        ...
        afterMarbleHelp() {
            ...
            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Marble) >= 40) {
                ...
                if (this.player.inte < 40 && MarbleScene.rand(2) == 0) {
                    this.outputText("You find that the more time you spend being around Marble, the thirstier you grow for her milk.  Finally, as the two of you are finishing, you are unable to take it any longer and beg Marble to let you drink her milk.  After a moment, your words sink in and she blushes deeply.  \"<i>Ok sweetie, since you helped me out and all, let's go back to my room.</i>\"  You enter into her pleasant room once again.  She invites you onto her lap and lets you start sucking at one of her nipples.  The moment that wonderful taste meets your tongue, you start gulping down the milk without abandon. She sighs in pleasure in response.  From time to time, Marble gets you to switch nipples, all the while gently stroking your head and occasionally scratching behind your ears.\n\n", false);
                    this.outputText("Once you've had your fill, you pull back and the two of you smile at each other.  \"<i>It's really nice for you isn't it sweetie?  Nice for me too to have someone like you that can give a good suck on my sensitive nipples.</i>\"\n\n", false);
        ...
        */
        addictedEncounterHappy(clearS = true) {
            this.spriteSelect(41);
            if (clearS)
                this.outputText("", true);
            //First visit post addiction:
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MalonVisitedPostAddiction) < 0) {
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.MalonVisitedPostAddiction, 0, 0, 0, 0);
            }
            //Return visits
            else {
        ...
        playerAgreesToDrinkMarbleMilkBottled() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BottledMilk) >= 0) {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.BottledMilk, 1, (3 + MarbleScene.rand(6)));
            }
            else
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.BottledMilk, 8, 0, 0, 0);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        playerRefusesToDrinkBottledMilk() {
            ...
            //If the player is addicted, this item negates the withdrawal effects for a few hours (suggest 6), there will need to be a check here to make sure the withdrawal effect doesn't reactivate while the player is under the effect of 'Marble's Milk'.
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BottledMilk) >= 0) {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.BottledMilk, 1, (1 + MarbleScene.rand(6)));
            }
            else
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.BottledMilk, 3, 0, 0, 0);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        marbleChoreRefusal() {
            this.spriteSelect(41);
            this.outputText("", true);
            this.outputText("You angrily tell her that you aren't going to work for her milk and turn away, leaving her visibly upset.  Your body seems to be upset at your refusal too, feeling painful all over.  Fortunately, you also feel a temporary reprieve from the symptoms of your withdrawal.", false);
        ...
        encounterMarbleAshamedAddiction(clearS = true) {
            if (clearS)
                this.outputText("", true);
            this.spriteSelect(41);
            //First visit post addiction:
        ...
        AshamedAddictionComfort() {
            this.spriteSelect(41);
            this.outputText("", true);
            this.outputText("You walk straight up to her and wrap your arms around her.  She just stands there idly for a moment before embracing you back.  ", false);
            //[player height less than 5 feet]
            if (this.player.tallness < 60)
                this.outputText("She pulls you into her chest and you feel relieved to see the Marble you know is still in there.  You feel warm drops of water fall on your head and look up to find Marble crying fresh tears, but this time with a big smile on her face.\n\n", false);
            //[player height greater than or equal to 5 feet]
            else
                this.outputText("You hear her breath start to come in short breaths and look at her face to find Marble crying fresh tears, but this time with a big smile on her face.\n\n", false);
            this.outputText("\"<i>Thank you, sweetie.</i>\" She whispers so softly that you almost don't hear it.  Unfortunately, being so close to her starts to remind you of what you so desperately need. The moment feels somewhat ruined as you unsuccessfully try to hold back your shaking.  She pulls back and looks you straight in the eye.  \"<i>Don't worry sweetie, we'll find a way to make this better together,</i>\" she says, holding you tightly in her arms.  You can tell she's putting on a brave face and you don't think she actually has any idea of what to do.  \"<i>Come back when you start to feel a need for my milk again,</i>\"' she tells you as you leave, little hiccups accompanying her words, \"<i>We will get through this.</i>\"", false);
            //(increase affection by 10)
            this.marbleStatusChange(10, 0);
            //(delay withdrawal effect)
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        refuseMarblesMilkAddiction() {
            this.spriteSelect(41);
            this.outputText("", true);
            this.outputText("You look at Marble and refuse to do as she says.  She looks at you in surprise and asks why. You tell her you can't bear to talk about her like that, and that if you have to make her feel bad to get over this need, it's not worth it.  After a moment to let your words sink in, she rushes over to you and ", false);
            if (this.player.tallness < 60)
                this.outputText("hugs you to her chest, ", false);
            else
                this.outputText("gives you a big hug, ", false);
            this.outputText("all the while saying how wonderful you are.  The bottle ends up getting dumped on the ground during the embrace anyway, but neither of you care to notice until afterwards. But then, it doesn't matter anyway; you'll be fine for at least a little while. Right now, you just want to enjoy Marble's warm form wrapped around you.", false);
            //(increase affection by 5)
            this.marbleStatusChange(5, 0);
            //(delay withdrawal for a few hours)
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BottledMilk) >= 0) {
        ...
        ashamedAddictionBegForIt() {
            this.spriteSelect(41);
            this.outputText("", true);
            this.outputText("You look at her in horror at the suggestion of wasting her delicious milk in such a way. You snatch the milk bottle and hold it tightly to your chest.  You beg her not to talk about it like that and not to throw her milk away so easily.  She seems to be even more upset by your declaration and grabs hold of your hands.  Marble looks into your eyes for a moment and tells you that there is always hope to change before she runs off.  You are left with the milk bottle, but you think that you can wait until later to drink it.  It just felt right to make that bold declaration and it seems to have made you feel better, if only for now.", false);
            //(player gets a bottle of Marble's Milk)
            this.inventory.takeItem(this.consumables.M__MILK, this.camp.returnToCampUseOneHour);
            //(delay withdrawal for a few hours)
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BottledMilk) >= 0) {
        ...
        //Exploration event while addicted (event triggered while addicted, but not suffering withdrawal):
        marbleEncounterAddictedNonWithdrawlAshamed() {
            this.spriteSelect(41);
            this.outputText("", true);
            this.outputText("You decide to pay Marble a visit, as it would be nice to spend some time with her while you aren't in withdrawal.  You find her in her room and she looks at you ", false);
            //[affection >= 30]
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) >= 30)
            ...
            //[affection >= 30] 
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) >= 30)
                this.outputText("\"<i>Sweetie, w", false);
            else
                this.outputText("\"<i>W", false);
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) >= 80) {
                this.outputText("While you're eating, Marble looks into your eyes deeply for a moment and you think she is going to say something, but she shakes her head and seems more reserved for the rest of your time together.\n\n", false);
            }
        ...
        postAddictionFarmMornings() {
            ...
            this.outputText("", true);
            this.outputText("You hurry over to the farm to get your daily dose of Marble's milk.  It takes an hour of your day, but your body is satisfied.", false);
        ...
        postAddictionFarmExplorings() {
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.MarbleResistant) >= 0)
        ...
        extendedMurbelFarmTalkz() {
            //--- First Conversation ---
            switch (this.flags[kFLAGS_1.kFLAGS.MURBLE_FARM_TALK_LEVELS]) {
                case 0:
                    ...
                    if (this.player.race() == "human") {
                        ...
                        if (this.player.tallness < 60)
                            this.outputText("  Her eyes light up. \"<i>Are they all as cute as you?</i>\"");
                        //[if PC is taller then 6'6" feet] 
                        else if (this.player.tallness > 78)
                            this.outputText("  \"<i>Are most of you this tall?</i>\"");
                    }
                    ...
                    //[if PC is a dogmorph] 
                        ...
                        this.outputText("  \"<i>I've seen lots of dog-morphs before, are you from Barkersvile?</i>\"");
                    //[if PC is a centaur]
                    else if (this.player.isTaur())
                        this.outputText("  \"<i>I've seen a few centaurs before, but they don't seem to have regular homes.  They're nomads, wandering the plains.  Are you the same?</i>\"");
                    //[if PC is not human, cow-girl/cowboi, dogmorph, or centaur] 
                    else
                        this.outputText("  \"<i>It's very rare that we get a " + this.player.race() + " here.  Are you from around these parts?</i>\"");
                ...
                case 1:
                    ...
                    if (this.player.cor < 33)
                        ...
                        this.outputText("You chuckle and say that you hardly think of them with all the other fun things to think about.  Then you pause and say that it is in the moments that you do think about them that keep you from forgetting who you once were.");
                ...
                case 3:
                    //why she left
                    this.outputText("Marble looks over you a moment before saying, \"<i>You've mentioned this 'mission' a few times now; I guess that's why you left home?</i>\"  You nod.  \"<i>Fulfilling a duty, huh?  My story isn't quite the same as yours, and certainly not so noble!</i>\"  She laughs at this.");
                    //[if PC is under 5 feet tall]
                    if (this.player.tallness < 60)
                        this.outputText("  \"<i>Sorry, sorry, it's just that you're so cute!  I can't picture you as some great hero leaving behind home and family for a mission.</i>\"  She wipes a few tears from her face.");
                    //[if PC is over 7 feet tall]
                    else if (this.player.tallness > 84)
                        this.outputText("  \"<i>I'm sure a giant like you was the perfect choice for this mission.</i>\"");
                    ...
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Marble) >= 60)
                        this.outputText("  \"<i>Even though the start of the trip didn't turn out all that well, I think I found what I was looking for.</i>\"");
                ...
                case 4:
                    ...
                    if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) == 2 || this.player.findPerk(PerkLib_1.PerkLib.MarbleResistant) >= 0)
                    ...
                    else if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) == 1 || this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0)
                ...
                case 5:
                    ...
                    this.outputText("This time it's you who spends a fair bit talking about your own love life back home - or lack thereof, as it seemed to you sometimes.  After you finish, you notice that Marble is looking off to the side.  She turns back to you and thanks you for sharing.  You ask her if she doesn't mind continuing where you left off last time.  \"<i>");
                    if (this.player.findPerk(PerkLib_1.PerkLib.HistorySlut) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.HistoryWhore) >= 0)
                        this.outputText("Well, you certainly gave an arousing description.  I think I can share something in return.");
                    else if (this.player.cor < 33)
                        this.outputText("Sweetie, after you told me such a nice story, of course I will.");
                    else if (this.player.cor < 66)
                        this.outputText("Sweetie, I can tell that you care a great deal about what happened, even if you try to hide it. Of course I'll share.");
                    else
                        this.outputText("Well, you certainly gave an arousing description.  I think I can share something in return.");
                    this.outputText("  After my falling out with Ansgar, I noticed that I really missed nursing him more than anything else.</i>\"  She stops for a moment, shaking her head.  \"<i>That's not quite right.  It's more that I needed to keep nursing; it just felt like everything was wrong with me if I wasn't nursing something.</i>\"");
                    ...
                    if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.ImpGangBang) >= 0)
                ...
                default:
                    ...
                    if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampMarble) < 0)
                        this.outputText(", except that mission of yours that's so important to you");
                    this.outputText(".</i>\"");
                    ...
                    if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampMarble) < 0) {
                        ...
                        if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) == 2)
                            this.outputText("  I really just wanted someone who loved me and loved nursing from my breast.  I had no idea what that would do to you.");
                        //[if addiction quest is active, and Marble is happy with her milk]
                        else if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) == 1)
                            this.outputText("  But I think that I've found the one who will change that.  Right sweetie?");
                        //[if addiction quest has not yet triggered]
                        else
                            this.outputText("  Though, I'm not giving up hope yet.");
                        this.outputText("</i>\"");
                    }
                    else
                        this.outputText("  Until I met you, I was actually really lonely on the inside.</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.MURBLE_FARM_TALK_LEVELS]++;
        }
        //(work with Marble when helping)
        postAddictionFarmHelpings() {
            this.spriteSelect(41);
            this.outputText("", true);
            this.outputText("Smiling, Whitney suggests that you go help Marble out with her chores.  You readily agree and go out to meet with her.  Afterwards, Marble offers you a bottle of her milk.  ", false);
            //[if player is no longer addicted]
            if (this.player.findPerk(PerkLib_1.PerkLib.MarbleResistant) >= 0)
                this.outputText("She assures you that you can't get addicted to it again if you don't drink her milk directly from her breasts.", false);
        ...
        postAddictionCampMornings(extra = true) {
            this.spriteSelect(41);
            //(if player is completely addicted, do this event at the start of every day)
            ...
            if (!this.player.hasItem(this.consumables.M__MILK, 5)) {
                ...
                if (this.player.findPerk(PerkLib_1.PerkLib.MarbleResistant) >= 0)
                    this.outputText("She assures you that you'll be fine as long as you don't drink directly from her breasts.", false);
        ...
        standardSex(newpage = true) {
            ...
            if (this.player.gender > 0) {
                ...
                if (this.player.armorName == "bondage patient clothes" ||
                    ...
                    this.outputText("You smirk at her and demonstrate just how easy it is to get at your genitals while wearing this outfit.  But you decide to not disappoint her, making a show of removing your " + this.player.armorName + " and pretending to have some modestly when you show off your ", false);
                    ...
                    this.outputText(".  You also make sure that there is no lingering clothing on your body for her, just as she did for you.\n\n", false);
                }
                //(player is not wearing fetish gear)
                else {
                    this.outputText("You smile in return and begin removing your " + this.player.armorName + " from your body.  You start by slowly slipping off your top to reveal your " + this.allBreastsDescript() + ", ", false);
                    //[player's breasts are at least B cup]
                    if (this.player.biggestTitSize() >= 2)
                        this.outputText("running one of your hands down them before continuing.", false);
                    //[player has small or no breasts]
                    else
                        this.outputText("running one of your hands over them before continuing on.", false);
                    this.outputText("  You slip open the lower half of your clothes, revealing your ", false);
                    if (this.player.totalCocks() > 0) {
                        this.outputText(this.multiCockDescriptLight(), false);
                        //player has at least one dick and a vagina]
                        if (this.player.vaginas.length > 0)
                    ...
                    if (this.player.vaginas.length > 0)
                        this.outputText(this.vaginaDescript(0), false);
                    this.outputText(".  You then remove any other clothing, leaving your body bare.\n\n", false);
                }
                //(player is a herm)
        ...
        marbleSex2Continued(genders) {
            ...
            //(player is male)
            if (genders == 1) {
                this.outputText("Marble leans back and invites you to come.  With a coy grin, you slowly crawl towards her, each movement bringing the two of you closer until you are on top of her body. She puts her hands around you and lies back completely.  You carefully line up your " + this.cockDescript(0) + " and thrust into her warm snatch.  ", false);
                //[player is less than 8 inches in length]
                if (this.player.cocks[0].cockLength < 8)
                    this.outputText("You easily slide all the way into her depths before beginning your hungry thrusts.  ", false);
                //[player is more than 8 inches in length]
                else
                    this.outputText("She is unable to take all of you, but you're hardly discouraged as you begin your hungry thrusts.  ", false);
                ...
                //[player is not between 4 and 5 feet in height] 
                    ...
                    this.outputText("keeping your body tightly locked against her.  ", false);
                ...
                this.outputText(".  Deep within her, your " + this.cockDescript(0) + " explodes.  Within moments, Marble feels her orgasm too, her grip intensifying immensely.  You hear her give a sigh that sounds almost like a moo and her grip relents.  The two of you lay there panting, your " + this.cockDescript(0) + " still inside her.\n\n", false);
            }
            //(player is female, I hope I did this right, I'm not familiar with the exact mechanics of female/female toys)
            else {
                this.outputText("Marble grins at you and reaches into the drawers of the mini-dresser next to her bed, pulling out a long, double-ended dildo. She slips one half into her own hole and invites you over to her.  With a coy grin, you slowly crawl towards her, each movement bringing the two of you closer until you slip your " + this.vaginaDescript(0) + " onto the other end of the dildo.  Sighing, Marble lies down underneath you and begins to rock back and forth.  You bring your own ministrations to the mix in response. Soon, the two of you are panting and moaning against each other with the dildo sliding around between you.  Suddenly, she locks her arms around you tightly and ", false);
                //[player is between 4 and 5 feet in height]
                if (this.player.tallness < 60 && this.player.tallness >= 48)
                    this.outputText("squeezes your head into her breasts.  ", false);
                //[player is not between 4 and 5 feet in height]
                else
                    this.outputText("pulls you securely against her.  ", false);
                this.outputText("Marble shudders with pleasure and redoubles her efforts at moving the dildo, quickly pushing you over the edge as well", false);
                //[player has at least one dick]
                if (this.player.totalCocks() > 0)
                    this.outputText(".  Your " + this.multiCockDescriptLight() + " erupts while clamped between your bodies", false);
                this.outputText(".  Her grip soon relents and the two of you lay there panting, the dildo still connecting you.  You can hear Marble say under her breath \"<i>That was way better than on my own...</i>\"\n\n", false);
                //(remove vaginal virginity?  "Your hymen is torn...")
                this.player.cuntChange(8, true);
            }
            //(first time sex)
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FuckedMarble) < 0) {
                this.outputText("After a few minutes pass, Marble breaks the silence. \"<i>Sweetie, that was wonderful. You're really special to me, yah know?  Please remember that.</i>\"  You know that your relationship is special too; you won't forget Marble anytime soon.", false);
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.FuckedMarble, 0, 0, 0, 0);
            }
            //(repeat sex)
            else {
                this.outputText("Marble sighs and gives you a big smile. \"<i>Sweetie, you're just as wonderful to be with as ever.  I'm always looking forward to our times together,</i>\" she tells you.  You would be inclined to agree with her.", false);
            }
            this.player.orgasm();
            //– return to trigger
        }
        ...
        marbleMilkSex(newpage = true) {
            ...
            this.outputText("Drinking her milk has filled you with an intense need, and you can see that need in Marble's eyes too.  You have no choice; you are going to have sex with her.\n\n", false);
            //[player is wearing fetish gear]
            if (this.player.armorName == "bondage patient clothes" ||
                this.player.armorName == "crotch-revealing clothes" || this.player.armorName == "cute servant's clothes" ||
                this.player.armorName == "maid's clothes" || this.player.armorName == "servant's clothes") {
            ...
            //[player is not wearing fetish gear]
                ...
                this.outputText("She moves first and pulls open your " + this.player.armorName + " to get a view of your equipment.  ", false);
            }
            //(player is male, or a herm)
            if (this.player.cockTotal() > 0) {
                //[player has only human or animal dicks]
                if (this.player.cockTotal() == this.player.horseCocks() + this.player.dogCocks() + this.player.normalCocks()) {
                    this.outputText("Marble seems pleased at the sight of your " + this.multiCockDescriptLight() + " and she pushes you back onto her bed.  She removes her own skirt and stops for a moment at her tail.  Giggling slightly, she uses her ribbon-tied tail to brush at your " + this.multiCockDescriptLight() + " before climbing on top of you and slipping her legs to your sides.\n\n", false);
                }
                //[player has at least one of a different kind of dick]
                    ...
                    while (this.temp > 0) {
                        ...
                        if (this.player.cocks[this.temp].cockType.Index > 2) {
                            this.outputText(this.cockDescript(this.temp), false);
                            this.temp = -1;
                        }
                    }
                    this.outputText(".  \"<i>Sweetie, what the heck is that?</i>\" she asks in an unsure tone. You smile at her and tell her that she should touch it.  After a moment, Marble reaches out and seems to visibly relax after feeling its texture and stiffness.  She pushes you back onto her bed before slipping free of her own garments and climbing on top of you.  She gives you a sly smile as she puts her legs on your sides.\n\n", false);
                }
                //[after either]
                //[player has more than one dick]
                if (this.player.cockTotal() > 1)
                    this.outputText("\"<i>So, which one is your favorite?</i>\"  Marble asks you while taking measure of your " + this.multiCockDescriptLight() + ".  Before you have a chance to answer, Marble grabs a hold of your central " + this.cockDescript(0) + " and says \"<i>I'll bet it's this one.</i>\"  ", false);
                this.outputText("Without much hesitation, Marble lifts herself up, and impales her moist lips upon your " + this.cockDescript(0) + ".  The two of you gasp as you sink into her interior.  You feel each inch slowly flow inside her until ", false);
                //[dick(0) is less than 8 inches long]
                if (this.player.cocks[0].cockLength < 8)
                    this.outputText("every bit of your " + this.cockDescript(0) + " is deep inside.  ", false);
                // //[dick(0) is more than 8 inches long]
                else
                    this.outputText("Marble bottoms out at eight inches and you can go no further.  ", false);
                this.outputText("With a delighted shiver, Marble starts to push herself up and down on you, her movements growing more and more frantic over time.  You try to slow her down but she seems to be beyond the capability of listening to you now, giving only louder and more frantic moans of pleasure.  Sooner than you would have preferred, you explode inside her. At that moment, Marble gives a final moan that sounds almost exactly like a moo.  She slows down, seeming to have already reached her peak.\n\n", false);
                this.outputText("You can see that Marble is quite pleased and satisfied after that milking and sex combo session.  She rolls off you onto her bed and is soon asleep.  It takes you a few moments to get cleaned up, still in a slight daze after that frantic lovemaking.  As you depart, you give a final glance to Marble and see her still dozed off on her bed in a slightly lopsided position.", false);
            }
            //(player is female)
            else if (this.player.vaginas.length > 0) {
                //[player has sizable breast, C or bigger]
                if (this.player.biggestTitSize() > 2) {
                    this.outputText("Marble runs her fingers along your " + this.vaginaDescript(0) + " for a moment before slipping a hand onto your " + this.biggestBreastSizeDescript() + ".  She smiles at you and says \"<i>I think that maybe we should play up here. You did enjoy mine, so I think I'll enjoy yours.</i>\"  She helps you slips off your garments and lies you down on her bed, quickly taking her place on top of you.  She sticks her tongue out before putting her mouth to one of your " + this.nippleDescript(0) + "s and giving it a series of gentle licks.  Taking a moment to lick her lips, Marble starts to rub, caress and lick each of your " + this.allBreastsDescript() + " in turn with her hands and face, always gently and always lovingly.  Marble seems to be quite familiar with these techniques; she has probably practiced on herself many times before.\n\n", false);
                }
                //[player has smaller then C breasts]
                else {
                    this.outputText("She teases your " + this.vaginaDescript(0) + " with her fingers for a moment before putting her hand on one of your " + this.biggestBreastSizeDescript() + ".  \"<i>I'm not sure what to do with teats this small, but I'll do my best. Though I feel kinda sorry for you, sweetie.</i>\"  You open your mouth to make an indignant response, but Marble puts a figure on your lips to shush you. She gives you an intense stare and tells you in no uncertain terms that since you enjoyed her breasts so much, it's only fair that she gets to experience your " + this.allBreastsDescript() + ".  She then sticks out her tongue at you before giving your " + this.nippleDescript(0) + " a lick and rub down, which she extends to the ", false);
                    if (this.player.totalNipples() > 2)
                        this.outputText("other", false);
                    else
                        this.outputText("rest", false);
                    this.outputText(".\n\n", false);
                }
                //[after either]
                ...
                if (this.player.totalBreasts() > 2)
                    ...
                    this.outputText(" with each of your " + this.breastDescript(0), false);
                this.outputText(", Marble looks up at you and sticks her tongue out again.  \"<i>Now it's time for the main course!</i>\" she whispers before lowering her head down to one of your " + this.nippleDescript(0) + "s and closing her mouth around it. She soon begins to suckle your nipple.\n\n", false);
                //[if player has nipplecunts]
                if (this.player.hasFuckableNipples()) {
                    this.outputText("As Marble's tongue rubs against your " + this.nippleDescript(0) + " it slips inside, much to her surprise.  She pulls back for a moment and gives you a confused look.  You tell her it isn't a problem; it only makes you happier. Understanding, Marble quickly resumes her efforts.  Her talented tongue fucks your " + this.nippleDescript(0) + " in earnest.", false);
                    //[player is lactating]
                    if (this.player.biggestLactation() > 1)
                        this.outputText("  The whole while, Marble continues to gulp down your milk.", false);
                }
                //[if player is lactating]
                else if (this.player.biggestLactation() > 1)
                    this.outputText("Her suckling soon brings a stream of milk to her lips that she gulps down eagerly.  You give a contented sigh, but are soon brought out of your revelry as her sucking becomes more stimulating and intense.", false);
                //[player is neither lactating or has nipplecunts]
                if (this.player.biggestLactation() <= 1 && !this.player.hasFuckableNipples())
                    this.outputText("Of course, since you aren't lactating, nothing but your " + this.nippleDescript(0) + " reaches her lips.  Marble doesn't seem to be put off by this and still gives you a thoroughly enjoyable experience.", false);
                this.outputText("\n\n", false);
                this.outputText("After a while, Marble pulls back from your " + this.nippleDescript(0) + " and tells you, \"<i>Sweetie, I know how annoying it is to only have one of your nipples serviced, so I will be sure to finish the job.</i>\"  She dives right into your ", false);
                if (this.player.totalNipples() > 2)
                    this.outputText("next", false);
                else
                    this.outputText("other", false);
                this.outputText(" " + this.nippleDescript(0) + " and starts the experience all over again.  By the end, her efforts have successfully rung an orgasm from you. After cleaning up a bit, Marble sends you off in high spirits.", false);
            }
            this.player.orgasm();
        }
        //(after addiction sex, standing sex)
        //(this whole section simply doesn't work if the player has a taur body)
        marbleAddictionSex(newpage = true) {
            this.spriteSelect(41);
            if (newpage) {
                this.outputText("", true);
                this.doNext(this.camp.returnToCampUseOneHour);
            ...
            this.outputText("You rock against each other, your hands working to remove Marble's clothes while her hands work at yours.  As your respective clothing falls to the floor, ", false);
            //[player is under 5.5 feet in height]
            if (this.player.tallness < 66)
                this.outputText("Marble bends over and kisses you deeply on the lips, a kiss that you eagerly return.  She lifts you up into the air, her lips still locked on yours, and holds you tightly against her body. A full minute passes before she lowers you down so your bodies can be joined.\n\n", false);
            //[player is between 5.5 feet and 6.5 feet in height]
            else if (this.player.tallness < 78)
                this.outputText("Marble lowers her head and locks her lips with yours, a show of passion that you eagerly return.  The two of you stay like that for a while, time seeming to standing still.  Then Marble breaks the kiss and looks deeply into your eyes as a sly grin spreads across her face.\n\n", false);
            //[player is over 6.5 feet in height]
            else
                this.outputText("Marble grabs a hold of your head and pulls your mouth to hers for a passionate kiss.  You are only too eager to comply and join in.  Even without her vice grip on your head, it feels like you couldn't possibly leave her wonderful mouth. But you eventually push back and look into her eyes intensely.\n\n", false);
            //[player has at least one dick]
            if (this.player.totalCocks() > 0) {
                this.outputText("The feeling of need is almost palpable within the two of you, and when the time comes, neither of you hesitate. You and Marble push yourselves together, forcing your " + this.cockDescript(0) + " deep into the soft folds of Marble's sex.  The two of you shudder and bask for a moment in the wonderful feeling of being connected, before gently starting to rock against one another.  Little else matters to you right now other than the warm, loving body that your arms are wrapped tightly around", false);
        ...
        applyMarblesMilk() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarblesMilk) < 0) {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.MarblesMilk, 12, 0, 0, 0);
                ...
                this.player.changeStatusValue(StatusAffects_1.StatusAffects.MarblesMilk, 2, str);
                this.player.changeStatusValue(StatusAffects_1.StatusAffects.MarblesMilk, 3, tou);
            }
            else {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.MarblesMilk, 1, 12);
            }
            //Prevent duration from going to high.
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.MarblesMilk) > 36)
                this.player.changeStatusValue(StatusAffects_1.StatusAffects.MarblesMilk, 1, 36);
        ...
        */
        ...
        interactWithMarbleAtCamp() {
            ...
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] != 2)
                this.outputText("How will you interact with Marble?");
            ...
            if (this.player.itemCount(this.consumables.M__MILK) < 5)
                milkEvent = this.gotMilk;
            //Determine if marble has an item for the player
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleHasItem) >= 0)
                gatherEvent = this.marbleGathered;
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] > 0)
                playtime = this.marbleKidsPlaytime;
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] == 3 && this.flags[kFLAGS_1.kFLAGS.MARBLE_RATHAZUL_COUNTER_1] == 0) {
                marbleGoEvent = this.marblePurification.murbleShouldGoRunAlongAndGetHerCuntySisterSoTheyCanBeCuntsTogether;
                goEventString = "Go";
            }
            else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] >= 5) {
            ...
            this.choices("Appearance", this.marbleAppearance, "Talk", this.marbleTalkOverhaul, "Present", gatherEvent, "Give Item", (this.canGiveItem() ? this.giveItem : undefined), "Get Milk", milkEvent, "Release", sexEvent, "Playtime", playtime, "Break Up", this.breakUpWithMarble, goEventString, marbleGoEvent, "Back", this.camp.campLoversMenu);
        }
        marbleTalkOverhaul() {
            this.clearOutput();
            ...
            if ((this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] < 5 && this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] >= 20) || (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] >= 5 && this.flags[kFLAGS_1.kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] >= 4)) {
            ...
            if (this.player.cor < 50 && this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) < 60)
                this.addButton(1, "Just Talk", this.talkWithMarbleAtCamp);
            this.addButton(9, "Back", this.interactWithMarbleAtCamp);
            if (this.flags[kFLAGS_1.kFLAGS.SLEEP_WITH] != "Marble")
                this.addButton(4, "Sleep With", this.marbleSleepToggle);
            else
                this.addButton(4, "Sleep Alone", this.marbleSleepToggle);
        }
        marbleSleepToggle() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.SLEEP_WITH] != "Marble") {
                this.outputText("Marble says, \"<i>That sounds lovely, Sweetie.</i>\"");
                this.flags[kFLAGS_1.kFLAGS.SLEEP_WITH] = "Marble";
            }
            else {
                this.outputText("Marble folds her arms across her bountiful bosom and sighs, \"<i>If you say so, Sweetie.</i>\"");
                this.flags[kFLAGS_1.kFLAGS.SLEEP_WITH] = "";
            }
            this.menu();
            this.addButton(0, "Next", this.marbleTalkOverhaul);
        }
        sleepWith(arg = "") {
            this.flags[kFLAGS_1.kFLAGS.SLEEP_WITH] = arg;
        }
        //Kid playtime
        marbleKidsPlaytime() {
            this.clearOutput();
            ...
            var select = choices[MarbleScene.rand(choices.length)];
            if (this.flags[kFLAGS_1.kFLAGS.KID_SITTER] == 2 && this.flags[kFLAGS_1.kFLAGS.ANEMONE_KID] > 0)
                select = 6;
            //Bovine Saviour (Z)
            ...
            if (select == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] == 1 && this.flags[kFLAGS_1.kFLAGS.MARBLE_BOYS] == 1) {
                    ...
                    this.outputText("Your daughter immediately clops up to you and jumps into your arms.  \"<i>" + this.player.mf("Daddy, daddy", "Mommy, mommy") + "!  Play with me!</i>\"  You laugh at the girl in your arms, so young and yet full of energy.  She proceeds to rope you into a grand adventure, where you play the parts of the one who searches for a hero to save their camp, and the monster that has to be stopped, and also the monster's hostage that needs to be saved, while she is the great bovine saviour that carries out this grand quest.");
                    this.outputText("\n\nThe game finally ends with the bovine saviour victorious over the horde of ravenous monsters  - somewhere along the line it was decided that hostages were no fun and single combat wasn't impressive enough, and you exhausted your theatrical skills to provide a bevy of satisfyingly scary faces and growls - and the people of the land (you) rejoicing.  You're left a bit tired afterwards, but you certainly don't regret having played with your child.");
                }
            ...
            if (select == 2) {
                ...
                if (this.player.cor < 66)
                    this.outputText("  You do make sure to skip over the items of a more explicit nature throughout.");
            ...
            //requires at least 2 kids
            if (select == 4) {
                this.outputText("You notice Marble is sitting on some wood logs with your children.  Curious, you decide to check what exactly is going on.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] == 2)
                    this.outputText("both");
                else
                    this.outputText("about half of your children");
                this.outputText(" have at least some knack for it.");
            ...
            if (select == 5) {
                this.outputText("Marble looks up when you approach and gives you a weary smile.  \"<i>Hello, sweetie.</i>\"");
                ...
                this.outputText("\n\nYour kids are just a little bit tired from all the work and it doesn't seem they'll pester Marble much more today.  One of them even grabs you, complaining, \"<i>" + this.player.mf("Daddy", "Mommy") + ", I'm sleepy!</i>\"  You pat her head and smile, telling her that you'll be home soon enough.");
                ...
                //[Height below 5 feet]
                if (this.player.tallness < 60)
                    this.outputText("grabs you and immediately lifts you up to her chest, giving you a big hug.");
                //[Height above 5 feet]
                else
                    this.outputText("embraces you strongly, pressing her warm body against yours.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PLAYED_WITH_KIDS_TODAY] > 0)
                this.dynStats("lus", -10);
            else
                this.dynStats("lib", -1, "lus", -10, "cor", -1);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        definitelyBreakUpWithWithMarble() {
            this.spriteSelect(41);
            this.clearOutput();
            this.outputText("You approach Marble and tell her that you need a bit of space and some time away from her.  She freezes at your words, and asks you to repeat yourself.  You do so and she nods, her face almost impassive.  \"<i>I guess I'll go back to the farm.  ");
            if (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0)
                this.outputText("I'll see you there when you need my milk, alright?");
            else
                this.outputText("I'll see you later then.");
            this.outputText("</i>\"  Marble collects her things");
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] == 1)
                this.outputText(" and her child");
            else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] > 1)
                this.outputText(" and her children");
            this.outputText(", and leaves the camp behind.");
            this.doNext(this.playerMenu);
            this.flags[kFLAGS_1.kFLAGS.BROKE_UP_WITH_MARBLE] = 1;
            this.player.removeStatusAffect(StatusAffects_1.StatusAffects.CampMarble);
            this.player.removeStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble);
        }
        ...
        talkWithMarbleAtCamp() {
            this.spriteSelect(41);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleSpecials) < 0) {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.MarbleSpecials, 0, 0, 0, 0);
            }
            this.doNext(this.playerMenu);
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetMarae) >= 0 && this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] < 1) {
                this.outputText("You tell Marble about your visit with the Goddess Marae.  Marble is very interested in the story and listens closely to your every word.  \"<i>To think that there is still a pure Goddess in this world...</i>\" she says in wonder afterward, \"<i>But what's happening to her is so sad.  We should definitely help her if we can.</i>\"", false);
                //Level up!
                this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] = 1;
            }
            //The player has discovered the factory
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FoundFactory) >= 0 && this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] < 2) {
                this.outputText("You tell Marble you found a demonic factory and relate everything you know about it.  \"<i>Be careful in there,</i>\" Marble tells you, \"<i>I'm certain that place will consume you if you're unprepared.</i>\"", false);
                this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] = 2;
            }
            //The player has cleared the factory and shut it down
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) >= 0 && this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] < 3) {
                this.outputText("You tell Marble about what you found inside the factory.  She is horrified at what was being done to the other champions and assures you that no one should ever <i>belong</i> in a place like that. You continue and tell of the overseer and her fate. Marble reacts with surprise, ", false);
                if (this.player.findPerk(PerkLib_1.PerkLib.OmnibusGift) >= 0)
                    this.outputText("and hopes that you've learned your lesson about accepting <i>gifts</i> from demons.  ", false);
                else
                    this.outputText("but concludes that what you did was probably for the best.  At least you didn't fall for her trick.  ", false);
                this.outputText("Finally, you tell her how you shut down the factory and what happened to the captured champions.  Marble is shocked that some stayed, but says she doesn't think there is much the two of you could do to help them if they're already addicted. \"<i>You should probably just leave them be, for now.</i>\"", false);
                this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] = 3;
            }
            //The player has met Marae after doing a shutdown of the factory and smashing the controls
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MaraeComplete) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) < 0 && this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] < 4) {
                this.outputText("Marble is very happy to hear you helped Marae.  With the factory taken care of and Marae's corruption postponed for some time, the both of you will probably sleep a little easier tonight. ", false);
                this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] = 4;
            }
            //The player has met the corrupted Marae after blowing the storage tanks
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MaraeComplete) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) >= 0 && this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] < 4) {
                this.outputText("Your story about what had happened to Marae seems to have shaken up Marble a little.  Though, you notice that she seems to be getting more and more aroused as you relate your story.  ", false);
                if (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftFertility) >= 0)
                    this.outputText("You continue and tell her how your attempt to get Marae's Lithicite turned out.  Marble can't believe you tried that, but when she hears what happened next, her eyes go wide and she actually starts masturbating in front of you.  At the end of your tale, however, Marble looks more concerned than aroused.  She hopes you won't have too much trouble with pregnancies. That seemed to have killed the mood for her, too.", false);
                ...
                else if (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftStud) >= 0)
                ...
                if (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftFertility) < 0 &&
                    this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftStud) < 0) {
                    this.outputText("You finish your tale by recounting how you ran away.  She isn't really sure how to respond to your decision, but Marble does thank you for not leaving her behind and joining Marae.", false);
                }
                this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] = 4;
            }
            //(story) Talk about Zetaz's unexplored lair(Z)
            else if (this.flags[kFLAGS_1.kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ] > 0 && this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] < 5) {
                this.outputText("You tell Marble about the cave you found deep in the forest.  For some reason, this seems to bother Marble, but when you ask her what is wrong, she claims it's just a feeling and tells you not to worry about it.  Maybe you should make sure you're ready before you go back there?");
                this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] = 5;
            }
            //story) Talk about Tel'Adre(Z)
            else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.TelAdre) >= 1 && this.flags[kFLAGS_1.kFLAGS.MARBLE_TELADRE_STORY] == 0) {
                this.outputText("This time you've got quite a tale to tell Marble: the last free city in the world, Tel'Adre.  She is quite enthralled by the tale of the many buildings and people who live in its confines, managing to hide away from the demons thanks to the mages in the great tower, but is somewhat saddened when you tell her about how empty much of the city was, and oddly confused about the guards you met at the entrance.  In the end, she seems to decide to check it out on her own, although she doesn't say so openly.");
                this.flags[kFLAGS_1.kFLAGS.MARBLE_TELADRE_STORY] = 1;
            }
            //(story) Talk about defeating Zetaz(Z)
            else if (this.flags[kFLAGS_1.kFLAGS.DEFEATED_ZETAZ] > 0 && this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] < 6) {
                this.outputText("You tell Marble about your run-in with an old foe in the forest cave.  She tenses up at first, but the obvious fact that you've made it out of there alright relaxes her.  Marble admits that for some reason she felt like you were in great danger, but couldn't figure out why she felt that.  \"<i>Anyway, I'm glad that you managed to take care of your old nemesis... that map sounds interesting, too.  Think it really leads to the demon lord's lair?  It is a bit overwhelming, sweetie, to think that you might actually defeat the demon lord!  Part of me wants to beg you not to go, but I know how driven you are, and I won't stop you from going to fulfill your mission.  Just promise me that you'll make absolutely sure you're ready before you follow that map, okay?</i>\"");
                this.flags[kFLAGS_1.kFLAGS.MARBLE_CAMPTALK_LEVEL] = 6;
            }
            //If talked about nothing!
            else
                this.outputText("You have no new stories to share with Marble, so you chat for a bit about inconsequential things.", false);
            ...
            this.outputText("The topic of conversation turns to your mission and you ask Marble what she thinks you should be doing next.  ", false);
            //If (player has not yet met Marae)
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetMarae) < 0) {
                this.outputText("\"<i>Well sweetie, I guess you should start with getting to know the place a little better.  Why don't you look some more around the lake outside the farm?  I think that's the safest place to start.</i>\"", false);
            }
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetMarae) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.FoundFactory) < 0) {
                //check if the player is far too weak to go to the factory
                if (this.player.level < 3)
                    this.outputText("\"<i>I think we should help out Marae and shut down that factory she mentioned was in the mountains, but I don't think you're ready to go into the Mountains yet. They can be brutal - get a little more practice, and make sure you've got a good weapon.</i>\"", false);
                else
                    this.outputText("\"<i> I think we should help out Marae and shut down that factory she mentioned was in the mountains. I have no idea what will happen in there, though, so make sure you're as ready as you can be before you go.</i>\"\n\n", false);
            }
            //Player has found factory but not shut it down.
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FoundFactory) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) < 0)
                this.outputText("\"<i>You still haven't shut down the factory yet, have you?</i>\"  You shake your head.  \"<i>Well then go do it!</i>\"", false);
            //(player has completed the factory but has not returned to Marae)
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.MaraeComplete) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetCorruptMarae) < 0)
                this.outputText("\"<i>You haven't gone back to Marae yet have you?</i>\"  You shake your head.  \"<i>Well then go see her!  I'm sure she really wants to thank you.</i>\"", false);
            //If PC has not yet discovered Zetaz's lair or Tel'Adre (Z)
            else if (this.flags[kFLAGS_1.kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ] == 0 || this.player.statusAffectv1(StatusAffects_1.StatusAffects.TelAdre) == 0)
                this.outputText("\"<i>Well sweetie, maybe you should explore the world more?  From what I've heard from the centaurs who stop by the farm, I'm sure you could find something interesting in the deep forest, or maybe the desert,</i>\" she suggests.");
            //(suggestion) If PC has found Tel'Adre, but not Zetaz's lair(Z)
            else if (this.flags[kFLAGS_1.kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ] == 0 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.TelAdre) >= 1)
                this.outputText("\"<i>I was thinking that the deep woods probably still hide secrets from you, sweetie... a few times I've been there, I've noticed large numbers of imps carrying supplies.  Think there could be something to that?</i>\" she asks.");
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.DISCOVERED_DUNGEON_2_ZETAZ] > 0 && this.flags[kFLAGS_1.kFLAGS.DEFEATED_ZETAZ] == 0)
                this.outputText("\"<i>Well, you haven't finished exploring that cave in the woods yet, have you?  Why don't you go there?</i>\" she offers.  She still seems to be a bit bothered by something, but doesn't voice it.");
            //Nothing to advise!
            else
                this.outputText("\"<i>Well sweetie, this is it. Your mission has been to stop the demons, Lethice is their leader. Once you're ready, you need to go to their high mountain lair and take them down. Make sure you've finished everything else you want to do before you face Lethice, you won't get a second chance.</i>\"");
        ...
        marbleGathered() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] != 1 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.MarbleHasItem) <= 4)
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] != 1 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.MarbleHasItem) <= 7)
            ...
            //LaBova, cow girl transformation item (if you'll let me put it here, I'd like to use it as part of the purification quest, the player can still get it if they are addicted)
                ...
                this.inventory.takeItem(this.consumables.LABOVA_, this.camp.returnToCampUseOneHour);
            this.player.removeStatusAffect(StatusAffects_1.StatusAffects.MarbleHasItem);
        }
        //Gives general info on how Marble works, and what she can do for the player
        marbleInfo() {
            this.spriteSelect(41);
            this.outputText("Marble is a loyal friend and lover who has decided to help you with your quest.  She can be interacted with while she is at camp.  ", true);
            this.outputText("She can share some of her thoughts and give advice on your current situation, or supply you with bottles of her milk and other useful items that she has found while scavenging.  You can also get Marble to consume some of the items you find.\n\n", false);
            //explain morning drinking sessions if the player is an addict
            if (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0) {
                this.outputText("She will nurse you every morning automatically to satisfy your addiction.  ", false);
                //otherwise tell the player that drinking bottles of her milk is safe
            }
            else {
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFIED] == 0)
                    this.outputText("So long as you don't drink milk from Marble's breasts again, you don't have to worry about getting addicted.  ", false);
                else
                    this.outputText("Now that she's been purified, you can drink as much of her milk as you like without fear.  ");
            }
        ...
        canGiveItem() {
            if (this.player.hasItem(this.consumables.OVIELIX, 1))
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] == 0)
                if (this.player.hasItem(this.consumables.P_DRAFT, 1))
                    return true;
                else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0) {
                    if (this.player.hasItem(this.consumables.PINKEGG, 1))
                        return true;
                    if (this.player.hasItem(this.consumables.L_PNKEG, 1))
                        return true;
                }
            if (this.player.hasItem(this.consumables.PROBOVA, 1) && this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] < 2)
                return true;
            if (this.player.hasItem(this.consumables.P_LBOVA, 1) && this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] == 1)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] >= 5) {
        ...
        giveItem() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] >= 5) {
                if (this.player.hasItem(this.consumables.P_S_MLK, 1))
                    this.addButton(7, "P.SuccMilk", this.marblePurification.purifiedSuccubusMilkForPureMarbles);
                if (this.player.hasItem(this.consumables.REDUCTO, 1))
        ...
        giveMarbleLactaid() {
            ...
            this.outputText("You show Marble the bottle of Lactaid that you found and ask her if she could drink it.  She gives you a knowing smile. \"<i>So you want a special treat?  Ok sweetie, give it here.</i>\"  She takes the bottle from you and easily drinks the liquid.  Within moments, she gasps and ", true);
            if (this.player.tallness < 60)
                this.outputText("lifts you up to her chest before saying breathlessly saying \"<i>Drink now!</i>\"  You waste no time obliging her.\n\n", false);
            else if (this.player.tallness > 72)
                this.outputText("breathlessly says\"<i>Drink now!</i>\"  You waste no time and descend upon her breasts.\n\n", false);
            else
                this.outputText("breathlessly says, \"<i>Drink now!</i>\"  You quickly move forward to get a drink.\n\n", false);
        ...
        */
        marbleCampSexNew() {
            this.spriteSelect(41);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) >= 0) {
                this.outputText("  You call Marble over and ask her if she can give you some release.  She smiles at you and gently grips your " + this.cockDescript(0) + " in one of her hands before recoiling in horror.  \"<i>Uh, why don't you take care of that problem of yours in your cock first, sweetie?  Then I'll help you get release.</i>\"  It looks like Marble isn't willing to help you get release while you have worms infecting your cock.");
                return;
            }
            //Marble isn't willing to pleasure the PC if her lust is lower than 0
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] < 0) {
                this.outputText("  You call Marble over to see if she can help you get some release.  She looks at you sourly before saying, \"<i>I'm not in the mood right now, but feel free to use the toy in my bag on yourself.</i>\"  Well, that's generous... er, wait, did she just tell you to go fuck yourself?");
                //end event
                return;
            }
            this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] = 0;
            //Non nagas && nontaurs
            if (!this.player.isNaga()) {
                //Feeding
                if (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0 && this.player.gender > 0 && MarbleScene.rand(2) == 0) {
                    ...
                    this.clearOutput();
                    this.outputText("You tell Marble you're a little bit horny and you're wondering if she'd be willing to do something special for you in private.  Hearing you whisper your idea, she giggles and strokes your [face].");
                    ...
                    if (this.player.tallness < 66)
                        this.outputText("right breast.");
                    //[height above 5' 7''] 
                    else
                        this.outputText("left breast.");
                    //[+ if height above 8' 6'']
                    if (this.player.tallness > 90)
                        this.outputText("  You do need to bend over in order to access her breast as well as allow her access to your groin, but while slightly uncomfortable, your plan is worth the effort.");
                    ...
                    if (this.player.hasCock()) {
                        ...
                        if (this.player.wetness() < 2)
                            this.outputText("\"<i>Oh, sweetie, this just won't do!  It's like you're not looking forward to this at all!</i>\"");
                        //[Vaginal wetness 2-3] 
                        else if (this.player.wetness() < 4)
                            this.outputText("\"<i>It seems you're quite in need of something down here, sweetie...</i>\"");
                        //[Vaginal wetness 4]
                        else if (this.player.wetness() < 5)
                            this.outputText("\"<i>My, my, sweetie; this is so wet... are you sure we should stimulate it more?</i>\"");
                        //[Vaginal Wetness 5] 
                        else
                            this.outputText("\"<i>Oh my, sweetie; it seems like you need to be toweled off...</i>\"");
                    }
                    ...
                    if (this.player.hasCock()) {
                        ...
                        this.outputText("\n\nYou gently moan into her breast in response, causing her to giggle as she plays with the tip of your " + this.cockDescript(0) + ".  She returns to the pumping motion and increases the pace just as you decide you need something to grab onto - and the most pleasant things at hand are her breasts.  Marble gasps in surprise and moans as you rub her breasts while suckling, and starts jerking you off even faster in response.");
                        //( [Female Marble]
                        if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] == 0)
                            this.outputText("  Her thighs seem to be rubbing together, and the place you're lying on feels a tiny bit wet, so you assume it isn't only you who's getting more and more excited by this.");
                        else
                            this.outputText("  Her thighs are gently rubbing beneath you, and you feel something hard poking you in the back.  You smile around the nipple you have in your mouth.");
                        //[If balls] : A
                        if (this.player.balls > 0)
                            this.outputText("  As her hand reaches the base of your cock, she stops stroking it to take a moment and gently roll your " + this.ballsDescriptLight() + " with her fingers.  \"<i>Are these ready to shoot out for me soon, sweetie?</i>\"");
                        //([If pussy] : 
                        if (this.player.hasVagina())
                            this.outputText("  From the base of your cock, her hand moves even lower, gently rubbing your " + this.clitDescript() + ".  \"<i>This seems to also require some attention...  Maybe later, sweetie, if you do a good job nursing from me.  But right now, I want to see you shoot off,</i>\" she says, as her hand moves back to your " + this.multiCockDescriptLight() + ".");
                        ...
                        if (this.player.cumQ() < 500)
                            this.outputText("  You cover her hand as she keeps jerking you off, squeezing out tiny little droplets once you're done ejaculating.");
                        else if (this.player.cumQ() < 1000)
                            this.outputText("  Your load is as large as always, and ropes of cum fly into the air, covering her arm and your abdomen... and you swear one string even lands of her right breast along the way.  \"<i>That's it, sweetie, shoot all you have.</i>\"");
                        else
                            this.outputText("  You pretty much cover yourself, Marble, and the surrounding ground with your enormous white load of cum.  She seems numbed from the sheer output you're capable of.  \"<i>Uh... sweetie...</i>\"");
                        this.outputText("\n\n\"<i>Well... that was fun.</i>\"  Marble slowly pulls you away from her breast");
                        if (this.player.cumQ() >= 1000)
                            this.outputText(", then wipes the nipple clean on the other");
                    ...
                    //[Female] 
                        ...
                        if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] == 0)
                            ...
                            this.outputText("  Her thighs are gently rubbing beneath you, and you feel something hard poking you in the back.  You smile around the nipple you have in your mouth.");
                        this.outputText("\n\nYou're at the edge already, and the fingering of your " + this.vaginaDescript(0) + " as well as the rubbing motion against your [clit] soon send you over it.  Thrashing in Marble's embrace, you release your feminine juices all over her hand.");
                        if (this.player.wetness() >= 4)
                            this.outputText("  Messy as it is, Marble never stops, wanting to make the orgasm as intense as possible.");
                        //([Squirter]
                        if (this.player.wetness() > 4)
                            this.outputText("  Soon, you're shooting your femcum all over her arm, and she giggles at the intensity and visibility of your orgasm.");
                    ...
                    this.player.slimeFeed();
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] += 20;
                }
                //ORAL
                    ...
                    this.outputText("You walk up to your big-breasted lover, a feverish look in your eyes.  \"<i>Hmm... looks like you need to release some tension, don't you sweetie?</i>\"  You nod in approbation, ");
                    if (this.player.hasCock())
                        this.outputText("a tent growing in your " + this.player.armorName);
                    else if (this.player.hasVagina())
                        this.outputText("a moistness growing under your " + this.player.armorName);
                    this.outputText(" as you keep staring at her tender eyes; you instinctively know she's going to handle your junk with care.");
                    ...
                    if (this.player.hasVagina() && !this.player.hasCock())
                        this.outputText("probing her tongue in your " + this.vaginaDescript(0) + ", licking you in the most appropriate places");
                    else
                        this.outputText("wrapping her tongue around your rod of dickflesh, squeezing and pumping beads of pre-cum up your shaft");
                    this.outputText(".  She's doing an amazing job, and you thrash wildly under her smothering tongue assaults.");
                    //([vag only/has a cock]
                    this.outputText("  Marble keeps ");
                    if (this.player.hasVagina() && !this.player.hasCock())
                        this.outputText("poking your cunt");
                    else
                        this.outputText("suckling the juices out of your urethra and literally absorbing the drops of pre-cum as they spurt out of the tip of your junk.");
                    //[if multicock]
                    if (this.player.cockTotal() > 1)
                        this.outputText("  She alternatively sucks and jerks every cock you have, making sure there isn't a single meat-tower that isn't being taken care of.");
                    if (this.player.balls > 0)
                        this.outputText("  Her hands softly rub your [balls], making them churn and swell in pure arousal.");
                    ...
                    if (this.player.gender == 2)
                        this.outputText("tongue-fuck");
                    else
                        this.outputText("deepthroat");
                    ...
                    if (this.player.hasCock()) {
                        ...
                        if (this.player.cockTotal() > 1)
                            this.outputText(" while she strokes another");
                        this.outputText(", acting as an organic cock-ring.  She looks up to you as you watch her lips undulating under the repeated pulsations of your spooge-pumping " + this.cockDescript(0) + ".  These cocksuckers are teasing you in the most infuriating way, and you savagely shove more of your prick down her throat, stretching her jaw and making her moan in delight, although her cries of pleasure are muffled by the pecker stuffing her mouth.");
                    }
                    //[if vagina]
                    else
                        this.outputText("  Her flexible, yet firm tongue really feels like a dong and it keeps provoking you with its prolonged digging. With a mighty thrust, you shove her against your " + this.vaginaDescript() + ", forcing the entirety of her oral muscle inside.");
                    ...
                    if (this.player.hasCock()) {
                        ...
                        if (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0)
                            this.outputText("usually");
                        else
                            this.outputText("used to");
                        this.outputText(" suckle her tits.");
                        //[if high cum production] 
                        if (this.player.cumQ() >= 500)
                            this.outputText("  Your " + this.cockDescript(0) + " keeps spouting more seed inside her, efficiently distending her belly");
                        //[if cum production is massive]until she looks ready to give birth.[/]
                        if (this.player.cumQ() > 1500)
                            this.outputText(" until she looks ready to give birth.");
                        this.outputText("  Her lips cling to your cum-tube as if her life depended on it; she sucks viciously, milking your junk of every drop of its baby-batter.");
                    }
                    //[if vagina]
                    else
                        this.outputText("\n\nYour " + this.vaginaDescript(0) + " quivers and vibrates before releasing a vigorous discharge of fem-spunk, splattering Marble's lips and mouth; she drinks all your juices with an insatiable cum-thirst.  Her tongue explores your insides as if to make sure there's no girlcum left to absorb.");
                    ...
                    this.outputText("\"<i>You feeling antsy, sweetie?</i>\" Marble asks as you walk up to her.  \"<i>Don't worry; I'm ready and able to help.</i>\"  ", true);
                    //Select one option based on the sum of the player's and Marble's Corr, similar to the one in regular masterbation
                    if (this.player.cor + this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) < 66) {
                        this.outputText("The two of you find a secluded place in the camp and slip off your clothes.\n\n", false);
                    }
                    else if (this.player.cor + this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) < 132) {
                        this.outputText("The two of you strip down right there in the middle of camp.\n\n", false);
                    }
                    else {
                        this.outputText("You both look around for another member to join in. No one jumps at the offer, so the two of you strip down.\n\n", false);
                    }
                    //all the foreplay here
                    this.outputText("Marble smiles at you and playfully pushes her sizable breasts together a few times before ", false);
                    //Marble titfucks the players upper body, two variations, boobs and no
                    if (this.player.biggestTitSize() > 3) {
                        this.outputText("pressing them against your own " + this.biggestBreastSizeDescript() + ".  She giggles slightly as she puts one of them between her mounds and rubs them up and down around it, teasing your " + this.nippleDescript(0) + " with her own " + this.marbleNips() + ", a trickle of milk leaking out onto your locked chests.", false);
                    }
                    else {
                        this.outputText("pressing them against your chest.  She rubs them up and down against you as she moves around, making sure she has rubbed each part of your upper body at least three times over.  She is especially happy with moving your head around between her breasts.", false);
                    }
                    //If Player has at least one dick, Marble titfucks that
                    if (this.player.cocks.length > 0) {
                        this.outputText("\n\nShe moves down to your crotch and slips your " + this.cockDescript(0) + " between her breasts.  She smiles at you and says, \"<i>This is what you were hoping for, right?</i>\" before squeezing them together tightly and pushing your " + this.cockDescript(0) + " in and out.  You sigh in pleasure and smile down at Marble as she pumps you between her breasts.  But it seems Marble is unsatisfied with only that; she quickens her pace and starts moving each of her breasts up and down opposite each other.", false);
                        //Multiple dick side note
                        if (this.player.cocks.length > 1) {
                            this.outputText("  Yet still unsatisfied, Marble engulfs and rub the rest of your " + this.multiCockDescriptLight() + " within her ample mounds.  ", false);
                        }
                    }
                    //If Player has a vagina, Marble titfucks that
                    if (this.player.vaginas.length > 0) {
                        this.outputText("\n\nShe slides down your body to rub and caress your " + this.vaginaDescript(0) + " with her breasts, sometimes pushing one of her " + this.marbleNips() + " inside your " + this.vaginaDescript(0) + " and pulling a small gasp from you.  ", false);
                        //If clit is too small to be titfucked...
                        if (this.player.clitLength < 2) {
                            this.outputText("  Marble runs down each of your legs once with her breasts before unexpectedly plunging two of her fingers inside your " + this.vaginaDescript(0) + ".", false);
                        }
                        else {
                            this.outputText("  Marble then pulls your " + this.clitDescript() + " between her breasts and does her best to pump and stimulate it as though it were a cock.", false);
                        }
                    }
                    //If Player is genderless, Marble improvises
                    if (this.player.gender == 0) {
                        this.outputText("  She then says, \"<i>I think I've found a way to make you cum, sweetie,</i>\" with a sly expression.  She moves down from your upper body and starts rubbing and caressing your lower body too. It is extremely arousing, but it doesn't seem to be enough to push you over the edge.  Marble stands up, kisses you and rubs a single finger against the smooth skin of your groin.  You are so close to going over the edge.  Then one of her fingers pushes up against your " + this.assholeDescript() + ", causing you to go rigid from the new stimulation.", false);
                    }
                    //Sweet release
                    ...
                    if (this.player.cocks.length > 0) {
                        ...
                        if (this.player.cumQ() < 25)
                            this.outputText("  In moments, a small amount of your cum is covering Marble's breasts.", false);
                        else if (this.player.cumQ() < 250)
                            this.outputText("  After a few moments, a fair amount of your cum is covering Marble's breasts and face.", false);
                        else if (this.player.cumQ() < 500)
                            this.outputText("  You keep cumming and cumming, until eventually Marble is completely drenched in your cum.", false);
                        else
                            this.outputText("  Your seemingly endless orgasm eventually results in the two of you becoming completely drenched in your cum, as well as a large part of the ground around you.", false);
                    }
                    ...
                    if (this.player.vaginas.length > 0) {
                        ...
                        if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_WET)
                            this.outputText("  As you recover, you see that a small amount of your girly fluids has leaked onto Marble's breasts.", false);
                        else if (this.player.vaginas[0].vaginalWetness <= appearanceDefs_1.VAGINA_WETNESS_SLICK)
                            this.outputText("  As you recover, you see that Marble has been covered fairly liberally with your girly fluids.", false);
                        else if (this.player.vaginas[0].vaginalWetness < 5)
                            this.outputText("  As you recover, you see that Marble is decently drenched in your girly fluids.", false);
                        else
                            this.outputText("  It takes you a minute to recover, but upon doing so, you blush and realize just how soaked with fluid you've become.", false);
                    }
                    //finally some philosophy on what an orgasm would feel like for someone who is genderless
                    if (this.player.gender == 0)
                        this.outputText("  It's not quite the same as when you had genitals, but it is undeniably an orgasm.  While it is essentially a pointless orgasm, it's also almost pure in a way.  There is not a feeling inside you but the explosion of pleasure.", false);
                    //wrapping things up
            ...
            //NAGAS
                ...
                if (this.player.lib >= 50)
                    this.outputText("  Quietly, you reach down and hook your fingers into the hem of her clothing, allowing her to pull it half off with her next shift and expose her pussy");
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] > 0)
                    this.outputText(" and " + this.marbleCock());
                this.outputText(".  \"<i>Why, you shameless " + this.player.mf("pervert", "hussy") + "!</i>\" the cow-girl says in mock-offense, winking at you.");
                ...
                if (this.player.gender > 0) {
                    ...
                    if (this.player.hasVagina())
                        this.outputText(this.vaginaDescript());
                    this.outputText(".  \"<i>Well, sweetie, looks like I don't have to go digging for treasure; it's already right here for me,</i>\" she whispers to you.  With one hand she ");
                    if (this.player.hasCock())
                        this.outputText("grabs your shaft");
                    else
                        this.outputText("penetrates your pussy");
                    this.outputText(", while using her long tongue to lick the ");
                    if (this.player.hasCock())
                        this.outputText("tip");
                    else
                        this.outputText("clit");
                    this.outputText(".  You cry out in pleasure, and start to wrap your long tail about Marble's shapely body.  You can't hold back for long, and soon reach orgasmic bliss, all while tightly clinging to your cow-girl lover.");
                    if (this.player.hasCock())
                        this.outputText("  [EachCock] unleashes a load of semen right into her mouth, which she swallows with pink-faced, wanton gusto.");
                    if (this.player.hasVagina())
                        this.outputText("  Your [pussy] runs and squirts as you moan, drooling your juices into the little valley where Marble's breasts press against your scales.");
                }
                else {
        ...
        marbleNips() {
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleSpecials) < 0) {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.MarbleSpecials, 0, 1, 0, 0);
            }
            //Set nipples to 1 if uninitialized
            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.MarbleSpecials) == 0)
                this.player.changeStatusValue(StatusAffects_1.StatusAffects.MarbleSpecials, 2, 1);
            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.MarbleSpecials) == 1)
                return "nipples";
            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.MarbleSpecials) == 4)
                return "quad-nipples";
        ...
        marbleCock() {
            ...
            if (Math.floor(Math.random() * 3) == 0) {
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] < 3)
                    descript = "squat ";
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] >= 3 && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] < 5)
                    descript = "short ";
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] >= 5 && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] < 7)
                    descript = "average ";
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] >= 7 && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] < 9)
                    descript = "long ";
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] >= 10 && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] < 13)
                    descript = "huge ";
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] >= 13 && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] < 18)
                    descript = "massive ";
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] >= 18 && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] < 30)
                    descript = "enormous ";
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] >= 30)
                    descript = "towering ";
            }
            //Discuss girth one in 3 times.
            if (Math.floor(Math.random() * 3) == 0) {
                //narrow, thin, ample, broad, distended, voluminous
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS] <= .75)
                    descript += "narrow ";
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS] > 1 && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS] <= 1.4)
                    descript += "ample ";
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS] > 1.4 && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS] <= 2)
                    descript += "broad ";
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS] > 2 && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS] <= 3.5)
                    descript += "fat ";
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS] > 3.5)
                    descript += "distended ";
            }
        ...
        rapeDAHMARBLEZ() {
            ...
            if (raped) {
                ...
                //wrapping things up
                this.outputText("You close your eyes and revel in the moment before feeling Marble roll over and grab one of your hands.  You open your eyes just in time to see a big hammer-head flying towards your face...  ", false);
            ...
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.MarbleRapeAttempted, 0, 0, 0, 0);
        }
        ...
        marbleRapeCorruptFantasy() {
            this.spriteSelect(41);
            this.outputText("Marble is helpless before your onslaught with your superior position, and you find it immensely enjoyable to have someone trapped under you like this.  You start to fantasize just what it would be like if everyone were like this to you, just from being in your presence.  You imagine a sea of asses and pussies all stuck up in the air for you to rape at your leisure, and none of the owners able to do a damn thing about it.\n\n", false);
            //do they really want to have this fantasy?  How far are they gone?
            if (this.player.cor >= 66) {
                this.outputText("You shake your head, clearing the bizarre fantasy from your mind and returning to the more immediate enjoyment.\n\n", false);
            }
            else {
                this.outputText("You smile to yourself and think, \"<i>One day,</i>\" before returning to the more immediate enjoyment.\n\n", false);
            }
        }
        //Follow up fight
        ...
        marbleAfterRapeStartFight() {
            this.spriteSelect(41);
            this.outputText("You drop into your own combat stance; it's time to get even with her for last time.  ", true);
        ...
        marbleBadEndFollowup() {
            ...
            if (this.player.mutantScore() >= 5)
                morph = "corrupted mutant";
            if (this.player.minoScore() >= 4)
            ...
            if (this.player.beeScore() >= 4)
                morph = "bee-morph";
            if (this.player.goblinScore() >= 5)
                morph = "goblin";
            ...
            var approxHeight = "";
            if (this.player.tallness < 54)
                approxHeight = "very short";
            else if (this.player.tallness < 66)
                approxHeight = "short";
            else if (this.player.tallness < 72)
            ...
            //BEGIN BAD-ENDNESS
            this.outputText("Over time, the two of you learn to get along and accept the way things have gone.  Before long, the two of you become close friends, then even lovers.  At the same time, you learn the ways of life on the farm and adjust to your new life successfully.  As the months pass, things remain much the same from day to day. Until nearly a year later...\n\n\n", false);
            //SHIFT ABOVE TO END OF RELEVANT BAD ENDS
            this.outputText("The young champion moved quickly towards the barn; he was really looking forward to seeing this 'person he might know' as that dog-girl had described.  Maybe it was another one of the champions!  He thought as he hurried over.\n\n", false);
            ...
            if (morph == "human") {
                ...
                if (approxHeight != "average height")
                    this.outputText(approxHeight + " ", false);
                this.outputText(this.player.maleFemale() + " human leaning against one of the barn doors in a farm hand outfit.  It looks like " + this.player.heShe() + "'s taking a break from something.  With a big smile on his face, the young champion strides up to " + this.player.himHer() + " and says, \"<i>Hello there, it's rare to see a human in this world.</i>\"  The other looks up at him for a few moments before smiling in recognition and saying \"<i>So they picked you to go after me, huh?</i>\"  The young champion stared at the " + this.player.manWoman() + " for a few moments, unable to answer, this was better than he could have ever hoped for!  He was looking at last year's champion, " + this.player.short + "!\n\n", false);
                this.outputText("\"<i>I'm so glad to have found a friend like you in this world, " + this.player.short + ". ", false);
            }
            //that's no human!
            else {
                this.outputText("However, he is rather surprised to see a " + this.player.maleFemale() + " " + morph + " leaning against the barn wall next to the entrance.  The young champion approaches the " + morph + " with a little trepidation and calls out to them <i>\"Hello there, uh, Whitney said I might know you.</i>\"  The " + morph + " looks up at him for a few moments before smiling in recognition and saying \"<i>So they picked you next, huh?</i>\"  The young champion starts at this declaration.  \"<i>How do you know who I am?</i>\" he demands indignantly, \"<i>What do you know about my home?</i>\" the other chuckles and says, \"<i>I'm " + this.player.short + ", despite my form, I'm still the same person.  Being able to change is one of the joys of this messed up world.</i>\"  The young champion looks uncertainly at them for a few moments before realizing that the " + morph + " is telling the truth!\n\n", false);
                this.outputText("\"<i>You really are " + this.player.short + "!  I can't believe you left your humanity behind, but I'm glad to have found a friend in this world.  ", false);
            }
            //does he comment on the player's height?
            if (approxHeight == "very short" || approxHeight == "short") {
                this.outputText("Though I see you've gotten a little shorter then I saw you last.  ", false);
            }
            else if (approxHeight == "tall" || approxHeight == "very tall") {
                this.outputText("You've gotten bigger since I saw you last.  ", false);
            }
            this.outputText("Could you join me at my camp?  </i>\" the younger champion asks, \"<i>Your experience would help me out a great deal, and I'd be glad to have another fighter on my side.</i>\"  The older champion shakes " + this.player.hisHer() + " head and replies, \"<i>I'm sorry, but I abandoned my quest some time ago.  There is simply something here that is more important to me than that.</i>\"  The younger champion looks at " + this.player.himHer() + " in alarm and asks \"<i>What could be more important than our mission?</i>\"\n\n", false);
            this.outputText("At that moment, an earthly female voice calls out from inside the barn.  \"<i>Sweetie, is that someone you know?</i>\"  The older champion smiles and replies to the voice, \"<i>Yes Marble, it is.  You should come out and meet him.</i>\"  <i>\"Alright,</i>\" the voice calls back.  ", false);
            //could the player get Marble pregnant?
            if (this.player.gender == 1 || this.player.gender == 3) {
                this.outputText("A tall female cow-girl then steps out of the barn entrance.  The young champion notes just how pretty she is, if a bit imposing, but he also quickly notices that she is quite clearly pregnant.  \n\n", false);
                this.outputText("<i>\"Marble,</i>\" the older champion says to her, \"<i>this is a friend, he's actually from my village.  This is Marble, she is the reason I left my mission.  I care about her too much, and she is carrying my child.</i>\"  ", false);
                //mysterious baby?
                if (this.player.gender == 3 && this.player.biggestTitSize() >= 2 && this.player.biggestCockArea() < 15) {
                    this.outputText("\"<i>Wait, your child?!  How?</i>\" the younger champion stammers. The older one grins at him and says, \"<i>So I'm the first you've met?  Well then...</i>\" before dropping her pants and revealing her " + this.multiCockDescriptLight() + " and her " + this.vaginaDescript(0) + " to him.  The younger champion's jaw drops and he simply stares at her for a time, during which she giggles at him and says, \"<i>They're fully functional too.  Would you like to see them in action?</i>\"  The younger champion finds he is only able to stammer out an incoherent answer to this.  \"<i>I think I'll take that as a 'yes'. Don't worry, it'll be fun.</i>\" the older champion says, leading the young one along with Marble back inside the barn.  \"<i>Afterwards, maybe I can give you some advice on dealing with this world.</i>\"  ", false);
                }
            ...
            if (this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFIED] > 0 && MarbleScene.rand(2) == 0) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOYS] == 0) {
                        ...
                        this.outputText("You ask her why she hesitated like that.  \"<i>Oh?</i>\" she starts, looking up at you, \"<i>Sorry sweetie, it's just that I never thought I would give birth to a boy.  It just never occurred to me.</i>\"  Then her expression changes.", false);
                    }
                    else {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_BOYS]++; //again, n is the flag for the number of male kids Marble has had
                }
                else {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0)
                        this.outputText(", but you notice that she does not have a cock of any kind. It seems that trait isn't passed on", false);
                    this.outputText(".  The little girl's face is a really pretty one; you're sure that she'll grow up to be like her mom.  You hand Marble the child and she puts the crying child to her chest. The little girl stops crying at once and starts eagerly gobbling down Marble's milk.\n\n", false);
                    //If (PC is addicted to Marble)
                    if (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0) {
                        this.outputText("\"<i>Don't worry sweetie,</i>\" Marble tells you, \"<i>somehow I know that she won't get addicted.\"</i>  ", false);
                    }
                    else {
                        this.outputText("\"<i>Oh my,\"</i> Marble says to you, \"<i>It's just as wonderful as when you suckled me when my milk was addictive; I'd forgotten the feeling.\"</i>  ", false);
                    }
                    this.outputText("Marble looks at her other breast a moment before looking at you and saying \"<i>Still, I think I could use you on the other side.</i>\" You oblige her by suckling her other breast.\n\n", false);
                    //since the PC must either be addicted, or have removed Marble's addictive trait in order to father a child with her, there is no need for a check for addiction here!
                    this.outputText("Once the two of you have had your fill, Marble puts the child inside the nursery.  The little girl is already starting to look like she is a few years old, and is already trotting around on her little hoofs.  Marble turns to look at you and asks \"<i>Ok, I'll name her ", false);
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] == 0) {
                        ...
                        this.outputText("...hmm, well Sweetie, I can't think of a good name right now, I'll figure one out tomorrow.</i>\"", false);
                    }
                }
                //cow-girl child is added to the nursery, her name is set to \"<i>childName</i>\"
                this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS]++;
                this.doNext(this.playerMenu);
            }
            //Eggs
            else if (this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS) {
                //Birthing eggs
        ...
        marbleNightSleepFlavor() {
            ...
            switch (this.pregnancy.eventTriggered()) {
                ...
                case 4:
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.MARBLE_NURSERY_CONSTRUCTION] == 0 && this.pregnancy.type != PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS) {
                        this.flags[kFLAGS_1.kFLAGS.MARBLE_NURSERY_CONSTRUCTION]++;
                        this.outputText("  She lets you know that she'll be busy working on a nursery for her child for a while.", false);
                    }
                    this.outputText("</b>\n\n", false);
                    break;
                case 5:
                    this.outputText("<b>Marble's pregnancy has advanced further still, though the structure of her body keeps it from slowing her down.</b>\n\n", false); //18 days in
                    break;
                case 6: this.outputText("<b>Marble is probably getting close to giving birth, as her belly has gotten very large.</b>\n\n", false); //24 days in
                default:
            }
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) >= 0) {
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_GROSSED_OUT_BECAUSE_WORM_INFESTATION] != 1) {
                    this.outputText("As you go to lie down for the night, you find that Marble has gotten there before you.  You lie down next to her, but you can't help wishing that the two of you could have sex.  Suddenly, you feel Marble's hand grab ahold of your " + this.cockDescript(0) + ".  She gives a bit of a squeal as one of the worms starts to move around inside the shaft.  She pulls open the blankets and looks closely at your dick for a few moments before picking up her bedroll and moving to a different part of the camp saying, \"<i>" + this.player.short + ", you get rid of those or I'm not going to sleep next to you or with you.</i>\"\n\n", false);
                    this.flags[kFLAGS_1.kFLAGS.MARBLE_GROSSED_OUT_BECAUSE_WORM_INFESTATION] = 1;
                }
                return false;
            }
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] < 50 || this.player.gender == 0) {
                this.outputText("As you go to lie down for the night, you find that Marble has gotten there before you.  ");
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] < 0)
                    this.outputText("She makes a point of turning to face away from you when you climb into your bedroll.  Looks like she's still annoyed at you.");
                else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] < 20)
                    this.outputText("She lies next to you contentedly when you climb into your bedroll.");
                else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] < 30)
                    this.outputText("Marble gives a soft sigh when you climb into your bedroll.");
                else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] < 40)
                    this.outputText("Marble fidgets around a bit when you climb into your bedroll.");
                else
                    this.outputText("Marble seems rather worked up when you climb into your bedroll.");
                if (this.player.lust < 33 && this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] < 20)
                    this.outputText("  After a few moments of getting comfortable, you drift off to sleep.");
                else if (this.player.lust < 33) {
                    this.outputText("  You wonder for a moment if Marble is maybe looking for something more from you.");
                    //(50% chance of this happening)
                    if (MarbleScene.rand(2) == 0) {
                        this.marbleCuddlin();
                    }
                    else
                        this.outputText("  However, you're not aroused enough to consider sex.");
                }
                else {
            ...
            //Replaces laying down texts when Marble is at or over 50 lust
                ...
                this.outputText("You lie down and notice that Marble hasn't gone to bed yet.  You decide not worry about it too much until you hear Marble come clopping up outside.  \"<i>Sweetie?</i>\" she calls out to you as she crawls in next to you.  \"<i>Sweetie, I'm feeling really horny ");
                //if (PC's lust is under minimum to request sex)
                if (this.player.lust < 33) {
                    this.outputText("and I know you really aren't in the mood, but could you please help me out?</i>\"  You sit up and ask her what it is.  She looks at you slightly embarrassed before asking you, \"<i>Could you please ", false);
                    //If (Marble is a herm)
                    if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0)
                        this.outputText("suck my " + this.marbleCock() + "?  I really, really need it.</i>\"", false);
                    else
                        this.outputText("lick my womanhood?  I really want to feel your tongue bring me to release...</i>\"", false);
                    ...
                    if (this.player.isNaga() && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] > 0)
        ...
        pcPregWithMarblesKids() {
            return this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_MARBLE && this.player.pregnancyIncubation <= 280;
        }
        marblePregWithPCKids() {
            return this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER && this.pregnancy.incubation <= 280;
        }
        marbleCuddlin() {
            ...
            if (!this.pcPregWithMarblesKids() && !this.marblePregWithPCKids()) {
                ...
                if (this.player.tallness <= 78)
                    this.outputText("pulls your head on top of her chest.  She idly strokes your " + this.hairDescript() + " and says, \"<i>Sweetie, how about I be your pillow for the night?</i>\"  You happily agree, and soon you drift off to the sound of her steady breathing while you lay between her sizable breasts.", false);
                else
                    this.outputText("wraps her arms around you, gently pulling you against her.  \"<i>Sweetie, do you mind if we stay like this for a while?</i>\"  There is no way you could refuse, and before long, the two of you drift off to sleep in each other's arms.", false);
            }
            //Preg-cuddles
            else {
                //if (only Marble is heavily pregnant)
                if (this.marblePregWithPCKids() && !this.pcPregWithMarblesKids())
                    this.outputText("gently pulls your head to her swollen belly.  \"<i>Listen, sweetie,</i>\" she whispers, \"<i>you can hear our child's heartbeat when it's quiet like this...</i>\"  You hear a gentle thump accompanying Marble's own powerful heartbeat, along with your child's occasional squirms inside Marble.  You sigh and snuggle up against Marble's chest, rubbing her belly with your hand before drifting off to sleep.");
                //PC be preggers only
                else if (this.pcPregWithMarblesKids())
                    this.outputText("gently pets your swollen belly.  \"<i>Sweetie,</i>\" she whispers, \"<i>I can feel our child.</i>\"  She puts her furry ears to your growing belly, gently rubbing it all the while.  After a few moments she snuggles up against your body and the two of you drift off to sleep.");
                else
                    this.outputText("pulls your hand to her belly, and puts her own onto yours.  \"<i>The miracle of two lovers carrying each other's child,</i>\" she says.  It certainly isn't something you ever expected to happen, but that doesn't make it any less wonderful.  The two of you drift off to sleep together, hands on each other.");
            }
        }
        //Ask for sex
        atNightAskMarbleForSomeSexMaybe() {
            this.clearOutput();
            this.outputText("You turn to face Marble, and ");
            //if (Marble's lust is negative)
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] < 0) {
                this.outputText("see the annoyed back of her head.  Oh right, she's probably not in the mood for this.  You'll have to find another way of satisfying your needs tomorrow.");
            }
            else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] < 20) {
                this.outputText("gently ask her if she wants to fool around.  After a moment you hear her breathe out and she says, \"<i>Sorry sweetie, I'm not feeling up to it right now.</i>\"");
                //Marble cuddles the PC
                this.marbleCuddlin();
            }
            else {
                this.outputText("gently ask her if she wants to fool around.  After a moment you hear her breathe out and, with a lewd voice, she says, \"<i>I was worried you'd never ask, sweetie...</i>\"");
                //trigger Marble sex
        ...
        //SEKCS
        marbleNightSexIntro(clear = true) {
            if (clear)
                this.clearOutput();
            else
                this.outputText("\n\n");
            ...
            var x = this.player.cockThatFits(this.marbleCuntCapacity());
            if (x < 0)
                x = 0;
            ...
            //If (PC is under 5 feet tall) {
            if (this.player.tallness < 60) {
                this.outputText("Marble rolls you onto your back and pulls your head up onto her ample cleavage.  \"<i>I want it too. Just relax and let me take care of this.</i>\"  Marble keeps your head locked in her cleavage as she uses her other hand to slowly free the two of you of your garments.\n\n", false);
                this.outputText("Your head rests comfortably between Marble's breasts the entire time, her warm breath blowing softly on your hair.  You feel almost completely relaxed, yet incredibly turned on at the same time.  For some reason, it just feels right to lay there and breathe in her scent, enjoying the wonderful love pillows she is forcing you to relax between.  She runs her hand down your " + this.biggestBreastSizeDescript() + ", gently cooing to you.  Her hand slips down to your ", false);
                //If (PC has dick) {
                if (this.player.cockTotal() > 0) {
                    this.outputText(this.multiCockDescriptLight(), false);
                ...
                this.outputText("She reaches over and puts her hand onto your waist, gently slipping her hand inside your undergarments to touch your ", false);
                //If (PC has dick) {
                if (this.player.cockTotal() > 0) {
                    this.outputText(this.multiCockDescriptLight(), false);
                    //If (PC both dick and vag) 
                ...
                //If (Marble is a herm) {
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0) {
                    this.outputText("gently rub her " + this.marbleCock() + ".  After a moment, you move your hand down lower and ", false);
                }
                this.outputText(" run your fingers down her moist womanhood.  The two of you quiver under each other's ministrations.  Both of you work to quickly free yourselves from your clothing, growing increasingly excited at where things are going.  Free of your garments, you move overtop of Marble.\n\n", false);
            }
            ...
            if (this.player.gender == 3) {
                ...
                //DUDEZ
                if (this.player.gender == 1)
                    this.doNext(this.marbleNightSexDudes);
                //CHICKZ
                else
                    this.doNext(this.marbleNightSexChicks);
            }
        ...
        marbleNightSexDudes() {
            ...
            //otherwise, Marble doesn't mind, she'll hold all of them instead
                ...
                this.outputText("Nothing will stop your advance; your cock will be fully enveloped inside Marble's body.  \"<i>That's right sweetie... Ah, let me fully envelop you.</i>\"  With a sigh of satisfaction, your bodies come completely together.\n\n", false);
            }
            this.outputText("You look Marble in the eye and the two of you relish the moment; you are two lovers, connected in the most enjoyable of ways.  ", false);
            //Is Marble going to take the initiative here?
            if (this.player.cor + this.player.lib < this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) + 10) {
                this.outputText("You get so caught up in the moment that Marble takes the initiative. \"<i>Now, now, it's not nice to keep me waiting, sweetie,</i>\" she says before lifting up your hips and repeatedly inserting you inside her at a fair pace.  You're caught off guard and fall forward, ", false);
                //Do you fall into the boobies?
                if (this.player.tallness < 66) {
                    this.outputText("straight back into her ample bosom.  Marble giggles at your predicament, but doesn't stop moving your hips.  Rather than do anything more about it, you decide to just let Marble have her fun. After all, it's not like you aren't enjoying the situation.  You can already feel yourself getting close to release, and from the sound of Marble's breathing, she is too.\n\n", false);
                }
                //nah, but if you have boobies, maybe they hit hers?
                else if (this.player.tallness < 84) {
                    this.outputText("your " + this.biggestBreastSizeDescript() + " pressing against her own lovely pillows.  Marble giggles slightly before giving you a kiss on the lips.  She continues moving your hips the whole time.  Of course, as you start to near your peak, you get your control back and start thrusting into her of your own accord.  You can hear Marble beginning to breathe faster as she moves her hands onto your back.  She holds you tightly and gives you another kiss.\n\n", false);
                }
                //Fun, the PC's breasts fall onto Marble's Face!  If they have them, anyway...
                else {
                    if (this.player.biggestTitSize() >= 4) {
                        this.outputText("landing your " + this.biggestBreastSizeDescript() + " into Marble's face!  You hear a slight muffled cry underneath you as Marble takes her hands off your hips and lifts you up off of her.  ", false);
                    }
                    else {
                        this.outputText("crashing down on Marble and doing a good job of flattening her breasts under your size.  \"<i>Hey!</i>\" she cries out, letting go of your hips to lift your body off of her.  ", false);
                    }
                }
                this.outputText("You look down at her annoyed expression, before grinning at her and beginning to impale her moist and wonderful snatch yourself.  In a moment, her expression changes from a pouty face to one of ecstasy.  The two of you are nearing your peaks now.\n\n", false);
            }
            //nope the PC is the one
            else {
                this.outputText("It isn't enough to hold you back for more than a moment, though, and soon you're thrusting deep inside her at a comfortable rhythm for the two of you.  You smile at her and she smiles back as you start fondling and playing with Marble's lovely pillows.  She starts to run her fingers onto her love button, crying out in pleasure as you continue to thrust your " + this.cockDescript(x) + " inside her.\n\n", false);
                //If (PC's breasts are B cups or bigger)
                if (this.player.biggestTitSize() >= 2)
                    this.outputText("You pull your hands back up and begin to run them over your " + this.biggestBreastSizeDescript() + ", toying and teasing your nipples as your " + this.cockDescript(x) + " continues to pound away at Marble's confines.  Marble soon has her hands on the breasts you vacated, clearly enjoying teasing herself just as much as you are.  The two of you cry out in pleasure from the stimulation; you can feel your orgasm fast approaching.\n\n", false);
                else
                    this.outputText("The sensations are quickly becoming too much for you, and you're unable to do anything but focus on the feeling of your " + this.cockDescript(x) + " inside her wonderful confines.  Marble grins at your difficulties and teases, \"<i>Am I just too much for you, sweetie?  Ah!</i>\" She gasps; it seems that you're becoming too much for her too.\n\n", false);
            }
            //ORGASMO
            this.outputText("You gasp as you feel your insides churning and the walls of Marble's sex collapsing tightly down on you.  Once again, you've brought each other to the point of blissful orgasm around the same time.  ", false);
            //let's talk about the PC's cum production
            if (this.player.cumQ() < 250) {
                this.outputText("Marble cries out in joy as your " + this.cockDescript(x) + " unleashes its load within her insides.  ", false);
            }
            else {
                this.outputText("Marble gasps in both pleasure and pain as you fill up her insides to almost bursting, and large amounts of your jizz spill out around her slit.  ", false);
            }
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0) {
                this.outputText("Trapped between your bodies, Marble's " + this.marbleCock() + " spasms and sprays the two of you.", false);
            }
        ...
        marbleNightSexChicks() {
            ...
            this.outputText("", true);
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] == 0) {
                this.outputText("You gently lift yourself up as Marble produces her double dildo and slips it inside her womanhood.  Smiling at her, you slowly lower your body and impale your " + this.vaginaDescript(0) + " onto the artificial rod.  ", false);
                ...
                if (this.player.cor + this.player.lib < this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) + 10) {
                    ...
                    this.outputText("\"<i>Sweetie!</i>\" Marble gasps as you start to play with her breasts.  ", false);
                    //Does Marble help out, or does she go for the PC's breasts?
                    if (this.player.biggestTitSize() >= 4) {
                        this.outputText("She reaches her hands up and starts to play with your " + this.biggestBreastSizeDescript() + ", flicking and toying with them at the same pace that you play with hers.  The two of you start a friendly little contest to see who can stimulate the other's chest better; all the while, you continue to rise and fall above her.\n\n", false);
                    }
                    else {
                        this.outputText("Marble reaches her hands up and grabs onto yours, pulling them down tightly against her chest.  She gets you to play with each of her " + this.marbleNips() + " in turn, making sure that you flick them and tease them in just the right way to get her to cry out in ecstasy again and again.\n\n", false);
                    }
                    this.outputText("Within moments, your rapid pistoning on the dildo is pushing the two of you closer and closer to the edge.  ", false);
                }
                this.outputText("The two of you cry out in orgasm as your " + this.vaginaDescript(0) + " clamps down on one end of her dildo and her womanhood clamps down on the other end.  ", false);
                //Does this PC have a cock too?
                //If (PC has at least 1 cock)
                if (this.player.totalCocks() > 0) {
                    this.outputText("At the same time, your " + this.multiCockDescriptLight() + " sprays its own load onto Marble's chest and stomach.  ", false);
                }
                this.outputText("The two of you give one more shudder from the wonderful stimulation, before collapsing on top of one another.  ", false);
            }
            //PC is female, Marble is a herm
            else {
                this.player.slimeFeed();
                this.outputText("You gently lift yourself up into the air and guide your " + this.vaginaDescript(0) + " to the tip of her waiting " + this.marbleCock() + ".  You slowly lower your " + this.vaginaDescript(0) + " onto her quivering " + this.marbleCock() + ", gaining inch by inch ", false);
                //is she satisfied?
                //If (player can fit all of her cock and PC is not a virgin) {
                if (this.player.vaginalCapacity() > this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] * this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS]) {
                    this.outputText("until she is fully within you.  The two of you shudder in pleasure, and Marble says, \"<i>Oh sweetie, you got it all in there.  Being inside another woman like this is something I'll never really get used to, but I can't deny how good it feels.</i>\"\n\n", false);
                }
                //Marble seems to think you can take more than maybe you should be able to take
                else {
                    this.outputText("until you bottom out and can take no more of her.  \"<i>No more?</i>\" Marble asks you a little sadly, \"<i>You sure you can't take a little more?</i>\" she adds as she starts pushing you down onto her " + this.marbleCock() + ". You are forced to stretch to accommodate more of her and you shudder slightly from the strain.  ", false);
                    //(Message about vagina becoming looser)
                    this.outputText("Marble grins at you and says, \"<i>See?  I knew you that you could fit a little more.</i>\"\n\n", false);
                }
                this.outputText("After adjusting to the feeling of her inside you, you can't deny what a wonderful feeling it is to be connected like this.  ", false);
                //Does Marble take the initiative?
                if (this.player.cor + this.player.lib < this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) + 10) {
                    this.outputText("Marble gives you a grin and starts lifting your hips up and down, while simultaneously bouncing her own hips.  The combination results in your " + this.vaginaDescript(0) + " being pistoned by her " + this.marbleCock() + ".  The two of you start moaning in unison from the overwhelming feelings, leaving you unable to do anything but let her buckle and bounce you around like a rough wagon, and you love every second of it.\n\n", false);
                    this.outputText("\"<i>Oh sweetie, am I going too fast for you?  Here, let me give you a chance to catch your breath.</i>\"  She offers as she slows down her rapid movement, letting your mind settle back into place.  ", false);
                    if (this.player.biggestTitSize() >= 4) {
                        this.outputText("Marble takes her hands off your hips and lets you start to rise and fall on her in your own time.  She still rises up to meet you as you descend and lowers herself down each time you rise, matching your timing, but her hands have a much more pressing concern: your " + this.biggestBreastSizeDescript() + ".  Marble starts working her hands expertly to tease and play with your " + this.biggestBreastSizeDescript() + ". She seems to know all the right ways to move her fingers, clearly having a lot of experience with her own, and you can't help but moan at the attention.  She giggles and pants in pleasure herself; it seems she may be enjoying this play just as much as you!\n\n", false);
                    }
                    else {
                ...
                //no, no, the PC is much hornier than she is
                    ...
                    this.outputText("Within moments, your rapid pistoning on her " + this.marbleCock() + " is pushing the two of you closer and closer to the edge.  ", false);
                }
                this.outputText("The two of you cry out in orgasm as your " + this.vaginaDescript(0) + " clamps down on her " + this.marbleCock() + " as it fills you with its seed.  ", false);
                //Does this PC have a cock too?
                if (this.player.totalCocks() > 0) {
                    this.outputText("At the same time, ", false);
                    if (this.player.totalCocks() > 1)
                        this.outputText("each of ", false);
                    this.outputText("your " + this.multiCockDescriptLight() + " sprays its own load onto Marble's chest and stomach.  ", false);
                }
                this.outputText("The two of you give one more shudder from the wonderful stimulation, before collapsing on top of one another.  ", false);
                //Pregnancy chance for PC, ¼ their fertility
                this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_MARBLE, PregnancyStore_1.PregnancyStore.INCUBATION_MARBLE, 150);
                this.player.cuntChange(this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS] * this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH], true);
            }
            this.marbleSexFinish();
        }
        marblePreggoChance(preggerMult) {
            //pregger odds - 20% max
            //5% base + 1% per 25mLz
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.FertilityPlus) >= 0)
                preggerOdds += 5;
            ...
            //GET HER PREGNANT
            console_1.trace("MARBLE PREGGO ODDS: " + preggerOdds);
            if (MarbleScene.rand(100) < preggerOdds && (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0 || this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] >= 5)) {
                //SHUT UP SHES ALREADY PREGNANT
                if (!this.pregnancy.isPregnant) {
                    console_1.trace("Marble got PREGNANT!");
                    //SHE IS NAU!
                    this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, 720);
                }
            }
            else {
                console_1.trace("Knockup failed");
            }
        }
        marbleSexFinish() {
            this.spriteSelect(41);
        ...
        MarbleDigsDraftsYo() {
            ...
            if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) > 60) {
                this.outputText("giving you a smile and saying, \"<i>So you want me to partake in corruption, and to have a nice cock to stick my sweet with?</i>\"  You tell her that the bottle has been purified, so it won't give corruption, but otherwise, you're hoping it gives her the <i>additional</i> effect.  She grins at you and downs the bottle.\n\n", false);
            }
            else {
                this.outputText("looking at you uncertainly and saying, \"<i>Uh, sweetie, I'm not going to drink this demon stuff.  It'll warp my body, and I think this will give me a cock...</i>\"  You assure her that the draft has been purified, so it won't warp her body or corrupt her... aside from that last effect she mentioned, but that's what you want her to get.  She sighs before yielding, and says, \"<i>Ok sweetie, if you really want me to have one, I'll take it for you.</i>\"  She takes a deep breath before drinking the bottle, and grimaces at the taste.\n\n", false);
            }
            this.outputText("Marble drops the potion and grabs at her crotch.  Turning away from you, she gives an excited cry that is a mix between a moo and a moan as her body convulses slightly.  After a moment, she turns back to you and shows her new 7\" long and 2\" wide human cock.  She gives you a ", false);
            if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) > 50)
                this.outputText("big ", false);
            else
                this.outputText("nervous ", false);
            this.outputText("smile.  <b>Marble is now a hermaphrodite.</b>  ", false);
            this.doNext(this.camp.returnToCampUseOneHour);
            this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] = 1;
            this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] = 7;
            this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS] = 2;
        }
        ...
        MarblePEggEffects() {
            ...
            this.outputText("You hand Marble the pink egg.  She looks at it thoughtfully for a moment before her eyes light up in recognition.  \"<i>This is one of those magic eggs made from those egg elixirs.  If I remember right, this one removes the male traits of those who eat them.  ", false);
            if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) > 50) {
                this.outputText("So my sweet, tired of my cock?  Well, what if I like it?  Do you really want me to get rid of it?</i>\"  You assure her that yes, you do want her to get rid of it.  She frowns at you in annoyance, but ultimately agrees to take the egg.  \"<i>Eventually you'll want it back, I'm sure of it,</i>\" she says just before eating the egg.\n\n", false);
            }
            else {
                this.outputText("So does this mean you don't want me to have a cock anymore, sweetie?</i>\"  You assure her that yes, you don't want her to have it anymore.  She seems relieved by this and admits, \"<i>Thank you sweetie, I don't think I really liked having it,</i>\" before eating the egg.\n\n", false);
            }
            this.outputText("She lifts up her skirt and the two of you watch as her " + this.marbleCock() + " is absorbed back into her body.  <b>Marble is now purely female.</b>  ", false);
            this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] = 0;
            this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] = 0;
            this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS] = 0;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Ovi-elixir
        marbleOvulatesLikeMadDawg() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_NURSERY_CONSTRUCTION] < 100 && this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER) {
                ...
                this.outputText("After taking the elixir, Marble's belly rumbles slightly.  You can both tell that her pregnancy has advanced.  ", false);
                var newIncubation = this.pregnancy.incubation - (40 + MarbleScene.rand(30));
                if (newIncubation <= 0)
                    newIncubation = 1;
                this.pregnancy.knockUpForce(this.pregnancy.type, newIncubation);
            }
            else {
                this.outputText("After taking the elixir, Marble tells you that her belly feels full.  It sounds like she'll be laying eggs soon.  ", false);
                this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS, PregnancyStore_1.PregnancyStore.INCUBATION_OVIELIXIR_EGGS + 46);
            }
        ...
        */
        marbleCuntCapacity() {
            var size = 36;
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] >= 1) {
                size += 10;
            }
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] >= 2)
                size += 20;
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] > 0)
                size += 14;
            return size;
        ...
        giveMurbleProBova() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] == 0) {
        ...
        giveMarbleTheProBovas4Sho() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] == 0) {
                this.outputText("Marble nods and downs the contents.  Nothing happens for a moment... then she gasps and grabs at her chest, stumbling forward slightly.  The cow-girl straightens up and releases her grip, then pulls open her top to look at her breasts.  <b>Each is now decorated with sets of four nipples, like the teats of a cow.  She has also gained about 4 inches in height, judging against the backdrop of the camp.</b>  Marble takes a few minutes to test her new nipples, squeezing them gently and sighing as dribbles of milk decorate her areolae in fours instead of one, then looks at you and says, \"<i>This isn't really so bad.  Actually, it feels nice.  If you find another dose, I'm willing to drink it - just to see what happens, of course.</i>\"");
                ...
                this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] = 1;
            ...
            //end event
                ...
                this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] = 2;
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        marbleNip() {
        ...
        marbleAppearance() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] == 0)
                this.outputText("6 foot 4 ");
            else if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] == 1)
                this.outputText("6 foot 8 ");
            else
                this.outputText("7 foot 4 ");
            this.outputText("inch tall cow-girl, and while she isn't very fast, she has very strong muscles; though they are difficult to spot under her skin's layer of fat. <b>She is currently wearing farm-hand clothes and using a large two-handed hammer as a weapon.</b>  ");
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] <= 1)
                this.outputText("She has a fairly normal soft human face, with light-colored skin.  ");
            else
                this.outputText("She has a soft face that is a mix of bovine and human features, with thick brown fur covering her body.  ");
            this.outputText("Her shoulder-length brown hair is parted by a pair of rounded cow-ears that stick out sideways from her head.  ");
            if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) <= 20)
                this.outputText("Two small horns grow from her forehead, similar in size and appearance to those on a young female bovine.  ", false);
            else if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) <= 50)
                this.outputText("Two medium sized horns grow from her forehead, similar in size and appearance to those on a female bovine.  ", false);
            else
                this.outputText("Two fairly large horns grow from her forehead, similar in appearance to those on a female bovine.  ", false);
            this.outputText("She has wide womanly thighs that draw the attention of those around her, and her large butt fills out her clothing nicely.  A long cow-tail with a puffy tip swishes back and forth between her legs, as if swatting at flies. A pretty bow has been tied to her tail.  Two legs grow down from her waist");
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] <= 1)
                this.outputText(", human until about half-way down her thigh.  The lower portion of her legs is covered in thick dark brown fur and ends in a pair of bestial hooves.\n\n", false);
            else
                this.outputText(" that are oddly jointed and end in a pair of bestial hooves.\n\n", false);
            if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) <= 15)
                this.outputText("She has two pillowy breasts, each supporting a 0.4-inch lactating " + this.marbleNip() + ".  She could easily fill a " + this.marbleBreastSize() + " bra.\n\n", false);
            else if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) <= 25)
                this.outputText("She has two large breasts, each supporting a 0.6-inch lactating " + this.marbleNip() + ".  She could easily fill a " + this.marbleBreastSize() + ".\n\n", false);
            else if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) <= 35)
                this.outputText("She has two basketball-sized breasts, each supporting a 0.8-inch milk-seeping " + this.marbleNip() + ".  She could easily fill a " + this.marbleBreastSize() + " bra.\n\n", false);
            else
                this.outputText("She has two basketball-sized breasts, each supporting a 1-inch milk-seeping " + this.marbleNip() + ".  She could easily fill an " + this.marbleBreastSize() + " bra.\n\n", false);
            ...
            switch (this.pregnancy.event) {
                case 2:
                    this.outputText("It looks like she's put on some weight since coming to your camp.\n\n", false); //3 to 8 days in
                    break;
                case 3:
                    this.outputText("Her belly has swollen a bit; she may be pregnant.\n\n", false); //8 to 12 days in
                    break;
                case 4:
                    this.outputText("Her belly is obviously swollen; she is almost certainly pregnant.\n\n", false); //12 to 18 days in
                    break;
                case 5:
                    this.outputText("Her belly is very swollen; she is very pregnant.\n\n", false); //18 to 24 days in
                    break;
                case 6: this.outputText("Her belly is extremely swollen and occasionally quivers when whatever she is pregnant with moves around.\n\n", false); //24+ days in
                default:
            }
            if ((this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] < 5 && this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] >= 20) || (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] >= 5 && this.flags[kFLAGS_1.kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] >= 4)) {
                this.outputText("<b>Marble is fidgeting around uncomfortably, perhaps she needs to be milked?</b>\n\n");
            }
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0)
                this.outputText("She has grown a " + this.marbleCock() + " since you brought her to camp. It is " + MarbleScene.num2Text(Math.floor(this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH])) + " inches long and " + MarbleScene.num2Text(Math.floor(this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS])) + " inches thick.\n\n", false);
            if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) <= 50)
                this.outputText("She has a pussy, with a 0.5 inch clit.\n\n", false);
            else if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) <= 75)
                this.outputText("She has a cunt, with a 0.6 inch clit.  You can see moisture gleaming from it.\n\n", false);
            else
                this.outputText("She has a fuck-hole, with a 0.7 inch clit.  Moisture gleams in her cunt, its lips slightly parted.\n\n", false);
            //since I assume Marble may become ass fucked in the future, Boolean Marble.analVirgin:
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.MarbleSpecials) == 0)
                this.outputText("She has one virgin bum-hole, placed between her squeezable butt-cheeks where, you presume, it belongs.", false);
            else
                this.outputText("She has one bum-hole, placed between her squeezable butt-cheeks where, you presume, it belongs.", false);
            this.doNext(this.interactWithMarbleAtCamp);
        }
        //Requirements:
        //- PC is a naga
        ...
        giveMarbleTailjobRelease() {
            this.clearOutput();
            this.outputText("You tell Marble that while you're not in a mood to suck her off today, you're not just going to leave her alone with it, either, and ask for her permission to do an exotic alternative.  Slowly, she nods, apparently not so sure about what you mean or whether she should agree.");
            ...
            if (this.player.cor > 70) {
                ...
                if (this.player.tongueType == appearanceDefs_1.TONUGE_SNAKE || this.player.tongueType == appearanceDefs_1.TONUGE_DEMONIC)
                    this.outputText("  Your tongue runs along the length of the end of your tail, tasting both Marble's feminine secretions and her semen.  She gives you a smoldering gaze as you lick her juices up.  You grin at her.");
                //(Demon Tongue) 
                if (this.player.tongueType == appearanceDefs_1.TONUGE_DEMONIC)
                    this.outputText("  You decide to put on a show for Marble, moving your tail as you drop out a large piece of your inhumanly long tongue, licking up her secretions sensuously while staring at her.  She quickly blushes under your gaze.");
        ...
        milkMarble() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_MILKED_BEFORE] < 1) {
                this.outputText("With an unusually bright look in her eye, Marble comes up to you and asks, \"<i>Hey sweetie, I was just about to go get milked when I realized that you've never actually been with me for it.  How would you feel about getting a tour of the setup that Whitney has for me?</i>\"  Then a mischievous look crosses her face, \"<i>Maybe we could even do something a little... intimate too?</i>\"");
                this.outputText("[pg]There is no harm in checking out her stall, at least.  You agree to go with her.");
                this.outputText("[pg]The two of you hold hands and quickly warp over to Whitney's farm and, with a wave to the proprietor, Marble escorts you to the barn.  The smells of the place are as familiar as ever, but this particular trip has an unusual feel to it since you're going to visit a room you've never been in before.");
                this.outputText("[pg]Your lover shows you the stall with her name on it and ushers you inside.  The room is a pretty cozy affair, with a large padded chair and small table in the center, a waist high railing on one side, and a long bench in on the other.  The milking machine hangs from the ceiling on a rail, allowing it be used in any part of the room.");
                this.outputText("[pg]Your amorous guide gives an animated rundown of the uses of her pieces of furniture, the chair is what she usually sits in while reading, the bar if she's got stiff legs, and the bench if she's really worn out.  Once finished, you do notice there is a book sitting on the table right now and ask Marble what she's reading.  She uncharacteristically bites her thumb a bit nervously and says in a low voice that it's the book she was reading while doing research when you were addicted to her.");
                this.outputText("[pg]Now very curious, you ask her how it is, and how close she is to finishing it.  \"<i>It's a bit embarrassing sweetie, but I've actually barely started it.  Unlike my younger sister, I never started reading until I needed something to do while being milked, and I'm terrible at it.  It can take me months to get through just one book, even if I'm spending several hours reading every day...</i>\"");
                this.outputText("[pg]You apologize for bringing it up and suggest that maybe you should get down to the milking?");
                this.outputText("[pg]She perks up instantly and pulls down ");
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] < 1)
                    this.outputText("two");
                else
                    this.outputText("eight");
                this.outputText(" suction cups off of the milker machine and carefully attaches them to her nipples, then flips a switch, causing it to come to life.  In an instant, milk starts flowing out of her " + this.marbleNips() + " into the cups and then up the clear tubes into the machine.  She lets out a relaxed sigh, then turns her gaze back to you.");
                this.outputText("[pg]\"<i>Well sweetie, is there something you've got in mind you'd like to do?</i>\"");
                this.flags[kFLAGS_1.kFLAGS.MARBLE_MILKED_BEFORE] = 1;
            }
            else {
                this.outputText("Sensing that Marble looks like she is going to get milked soon, you offer to escort her to her stall personally.");
                this.outputText("[pg]As usual, Marble is pleased at the prospect and agrees instantly, and the two of you head over to her small homely space in Whitney's operation.");
                this.outputText("[pg]Once Marble has herself settled in and hooked up, she turns to you and asks if you've got something in mind.");
            }
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] >= 5)
                this.flags[kFLAGS_1.kFLAGS.MARBLE_TIME_SINCE_NURSED_IN_HOURS] = 0;
            this.menu();
            this.addButton(0, "Cunnilingus", this.milkMarbleCunnilingling);
            if (this.player.cockThatFits(this.marbleCuntCapacity()) >= 0 && (this.player.isBiped() || this.player.isNaga() || this.player.isGoo()))
                this.addButton(1, "Fuck Her", this.milkMarbleFuckDatCowPussy);
            if (this.player.hasVagina() && this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0 && (this.player.isBiped() || this.player.isGoo()))
        ...
        milkMarbleCunnilingling() {
            this.clearOutput();
            this.outputText("You suggest that maybe she'd like it if you licked her vagina while being milked.");
            this.outputText("[pg]A huge smile spreads across her face, \"<i>Oh sweetie, that sounds like it would be wonderful!  You're the best; you know that?</i>\"");
            this.outputText("[pg]She takes a seat on the edge of the chair in the middle of the room and spreads her legs wide.  Her skirt slips up her ");
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_BOVA_LEVEL] < 1)
                this.outputText("semi-human");
            else
                this.outputText("inhuman");
            this.outputText(" legs, giving you a clear look at her waiting womanhood.  With a coy sideways glance, she wiggles her fingers in invitation for you to go down on her.");
            this.outputText("[pg]In order to get the show on the road, you ");
            if (this.player.isBiped())
                this.outputText("get down on your knees, and slowly crawl forward");
            else
                this.outputText("lower your body close to the ground, and slowly inch forward");
            this.outputText(" like an animal who's found something they want.  When you get close to her, your lover runs a finger up the inside of her thigh as her tail sneaks its way up around her waist and drapes itself over your prize.");
            this.outputText("[pg]Arriving at a hard brown hoof, you wrap your arm about her coarsely furred leg and rest your head against the bestial appendage.  You stroke and run your fingers through her fur to a soft giggle above you while the machine continues to pump and whirl.  You tease her a bit more before raising yourself up, bit by bit, until you're at eye level with her tail-covered opening. A small tuft of hair decorated with a pink bow is all that hides your goal.  No, it's a present, gift wrapped for you.");
            this.outputText("[pg]You take hold of two strands of the bow and tell Marble she shouldn't have given you such a gift.");
            this.outputText("[pg]\"<i>Oh, not at all sweetie.  You deserve it!</i>\"");
            this.outputText("[pg]You slip the bow open, unwrapping your present, and pull her tail aside to reveal her moist and inviting opening and exclaim that it was what you always wanted!");
            this.outputText("[pg]\"<i>Oh, I'm so glad you like it.  Why don't you try it out right now?</i>\"");
            this.outputText("[pg]She doesn't have to give you the suggestion twice.  You dive in at once, sticking your [tongue] deep into her recesses, and tasting her cow-girl nectar.  Her folds accept you easily, and an eager moan slips out of the woman above you.  Her fingers run over your [hair] while you withdraw from your initial sortie to scout out the entrance more.");
            this.outputText("[pg]In response to your tugging and toying with her outer folds, Marble's hips jerk forward slightly, and you see her love button pulse and engorge itself.  There is a happy moan, and her tail manages to find itself flicking your face.  You swat the pesky wrappings away and continue your efforts at bringing your mate to the height of pleasure.  The next target: her clit.");
            this.outputText("[pg]There is a long drawn out cry of joy when you bring your [tongue] to the source of her womanly pleasure.  ");
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0)
                this.outputText("With the first flick across its pink flesh, Marble grabs ahold of her " + this.marbleCock() + ", and tightly squeezes it, slowly pushing her hand down it.");
            else
                this.outputText("With the first flick across its pink flesh, Marble grabs onto an arm of her chair, gripping it tightly.");
            this.outputText("  You can't help but laugh and ask her if your treatment is too much, suggesting that maybe you should save playing more for later.");
            this.outputText("[pg]\"<i>No more teasing me, [name], bite me now!</i>\"");
            this.outputText("[pg]How can you refuse such a request?");
            this.outputText("[pg]\"<i>Ahhhhooooo!</i>\"  The wonderful bovine women gives a grateful cry of pleasure as your teeth nip into her nub of engorged skin and a burst of liquid sprays out onto your chin.  ");
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0)
                this.outputText("Of course, there is also a spurt of white which sprays out over her lap and your head.  ");
            this.outputText("Obviously, while the milkers don't normally get her aroused, they can seriously amplify the effects of any pleasure she gets.");
            this.outputText("[pg]You ask your lover if that was good.");
            this.outputText("[pg]\"<i>Lovely. Thanks for giving me the best start to being milked sweetie.</i>\"  She notices that you're all wet, \"<i>Oh, here, let me get that for you.</i>\" and she wipes the fluid off your [face] with a grin.");
            this.outputText("[pg]You then tie her bow back up on her tail and say you'll save the rest for later.");
            this.outputText("[pg]\"<i>Oh, I'll be looking forward to it.  See you later sweetie!</i>\"  She gives you a slightly awkward peck on the cheek around the milking tubes, that sends you into a blissful state.");
            this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] = 10;
            var pLust = Math.floor(20 + ((this.player.lib + this.player.cor) / 10));
            this.dynStats("lus", pLust);
            this.dynStats("sen", 1);
            this.doNext(this.camp.returnToCampUseTwoHours);
        }
        milkMarbleFuckDatCowPussy() {
            var x = this.player.cockThatFits(this.marbleCuntCapacity());
            this.clearOutput();
            this.outputText("You wonder aloud if maybe she'd be interested in a little intercourse action. You'd be perfectly prepared to provide for her.");
            this.outputText("[pg]\"<i>Hmm, well, your offer is tempting, but I'm going to have to see what's available before I make a final decision.</i>\"");
            this.outputText("[pg]With a flourish, you remove your [armor] and do a little sweep over your " + this.cockDescript(x) + ", asking her if everything is to her needs.");
            if ((this.player.findPerk(PerkLib_1.PerkLib.BulgeArmor) >= 0 || this.player.modArmorName == "backless female teacher's clothes" || this.player.modArmorName == "bridle bit and saddle set" || this.player.modArmorName == "headdress, necklaces, and many body-chains" || this.player.modArmorName == "bondage patient clothes" || this.player.modArmorName == "crotch-revealing clothes" || this.player.modArmorName == "cute servant's clothes" || this.player.modArmorName == "maid's clothes" || this.player.modArmorName == "servant's clothes") && this.player.hasCock()) {
                this.outputText("[pg]\"<i>I appreciate the little show, but I could already see you just fine.  Come closer so I can get a better idea.</i>\"");
            }
            else
                this.outputText("[pg]\"<i>Hmm, yes, I think that will work.  Come closer so I can make a more thorough inspection.</i>\"");
            this.outputText("[pg]You step forward and allow your lover to get \"acquainted\" with your goods.");
            this.outputText("[pg]She squats down and makes a show of looking you over carefully, humming to herself along the way.  Her breath tickling your skin slightly and quickly bringing you to full hardness.  With one finger, she taps your tip a few times, then runs it along your glans.  Finally she finishes her examination of your manhood by gripping it in her hand and giving it a few experimental pumps.");
            this.outputText("[pg]She stands back up and looks at you with a serious expression on her face.  \"<i>Your penis has met my expectations, and I do believe that I will be taking it into my vagina.  Please lay down on the bench over there and we can begi-hahahahaha!</i>\"  Her face finally cracks and she bursts out laughing over the little game the two of you have been playing.");
            if (this.player.tallness < 68) {
                this.outputText("[pg]\"<i>Oh sweetie.</i>\"  She pulls you into a deep hug against her chest.  \"<i>It's too much!  Hah, hahahahaha!  No more joking around.  I need you inside me now.</i>\"  She carefully carries you over to the bench and lays you down on your back, then straddles the bench above your " + this.cockDescript(x) + ".  \"<i>Are you ready for me?</i>\" she calls out in a deep husky voice, breasts heaving, tail swishing, and all the while the milker machine continues to hum above her.");
            }
            else {
                this.outputText("[pg]You pull her into a deep hug as she continues to her hysterics and gently caress her hair.  You assure her that if the games are too much, you can skip straight to the action.");
                this.outputText("[pg]After a moment she settles down and returns the embrace.  \"<i>Hmmhmm, yes.  No more joking around.  I need you inside me now.</i>\"");
                this.outputText("[pg]You break away from her and casually walk over to the bench and lay down on top of it.  Marble follows immediately behind you, and before you've even finished laying down, she's already standing above with a hungry look on her face, breasts heaving, and tail swishing.");
                this.outputText("[pg]\"<i>Are you ready for me?</i>\" she asks in a deep husky voice.");
            }
            this.outputText("[pg]With a grin, you tell her you're always ready for her.");
            this.outputText("[pg]The words have barely left your mouth before Marble drops her waist and engulfs your " + this.cockDescript(x) + ", swallowing it up to the base in a single motion.  \"<i>Ohhhhhh, yes!</i>\"  Marble happily rubs her belly with one hand, while another cubs her breast.  She shakes her hips from side to side a couple times, savoring the feeling of your cock rubbing back and forth across her insides.");
            this.outputText("[pg]Then both hands come down and push down on your stomach, and she begins a rapid forward and backward rocking motion on your member, keeping every bit of your length deep inside her, putting it into a spinning trip around her passage while she starts giving low happy moans of pleasure.  You look up at your lover and get a good view of the expression of bliss upon her face, but also get a chance to see the milk draining from her chest.");
            this.outputText("[pg]With each push and pull on your member, there is a rapid spurt of milk that the machine is only just able to keep up with.  After a moment, you realize that it isn't actually able to keep up, her milk is coming out too fast for the milker!  You try to warn your bovine lover, but it's too late.  With a pop, the suction cups fly off of Marble's breasts, spraying milk everywhere, and there is a bang from the machine as it shuts down.");
            this.outputText("[pg]\"<i>Oh no!  Damn it, now what?</i>\" Marble stops moving and looks around worried.");
            if (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0) {
                this.outputText("[pg]You quickly sit up and take it upon yourself to continue the efforts of the milking machine, bringing with your actions a surprised gasp, followed by a contented sigh, and Marble resuming the movements of her hips.  The ambrosia from her breasts increases in quantity once more, and it actually feels like it's being pumped into your mouth.  You're happy to rise to the challenge of drinking it all while Marble continues to ride your body.");
                this.outputText("[pg]Where the machine failed to handle Marble's increased production, you succeed in draining everything.  Heck, the feel of yourself bouncing around Marble's passage while she pushes against you and bounces back and forth only edges you on further than normal.  With one hand on her shoulder for leverage, you use the other to massage her bosom and coax even more milk out of her, greedily devouring as much of your favorite drug as possible.");
                this.outputText("[pg]Almost an hour later, the flow from both of Marble's breasts has slowed to a trickle, and both of you have cum at least three times in a haze of both sexual and chemical pleasure.  Marble gives a contented sigh and informs you that she thinks she'll be taking a nap now, wondering whether or not she should make a habit of breaking the milker, given what happens afterwards.");
                this.player.orgasm();
                this.player.orgasm();
                this.player.orgasm();
                this.dynStats("lus", 20);
                this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] = 15;
                this.dynStats("lib", .3);
                if (this.player.cor < this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble))
                    this.dynStats("cor", 1);
                this.dynStats("tou", .1);
                this.dynStats("str", .1);
                this.dynStats("sen", -2);
            ...
            else if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.Marble) > 30) {
                this.outputText("[pg]The haze given off by Marble's tainted fluids alights a familiar craving at the back of your mind, but you push it back and reach your hands up to her breasts and pinch her nipples.  Marble tenses for a moment, and looks down at you confused.  You tell her that you'll try to keep her entertained while you wait for Whitney to fix things.");
                this.outputText("[pg]She begins speaking once more, then goes quiet when you pull on her nipples and try your best to milk her by hand, much the same way that the cows were milked back home.  While nothing actually comes out of her breasts from your touch, she gives an appreciative moan and resumes her rocking against your crotch.");
                this.outputText("[pg]After rubbing against you for a bit, the stimulation on your length just isn't enough for you anymore, and try to start thrusting up into your lover's passage.  Marble seems to be in agreement in what she wants, and her motions switch from a gentle rocking into meeting each of your thrusts with a pumping of her own, trying to drain your manhood while you try to drain her breasts.");
                this.outputText("[pg]Finally the two of you cry out together in orgasmic pleasure, and you spray out your seed into her passage, mixing with a rush of her own fluids into a slurry of sex juices sloshing around your " + this.cockDescript(x) + ".  The two of you settle down, with Marble laying down on you contentedly for a moment.");
                this.outputText("[pg]Suddenly a voice with a southern drawl call out from above you, \"<i>You kids havin a lots of fun down there?</i>\"");
                this.outputText("[pg]The two of you stare at each other in surprise and tense up.");
                this.outputText("[pg]\"<i>Next time, please try to be a bit gentler on the equipment, if ya don't mind.  I'd rather not have to do fix it every time you two get frisky.</i>\"  There is a slam of metal on metal as Whitney finishes working on the broken milker and it whirls back to life.");
                this.outputText("[pg]You and Marble each look each other in the eye and burst out laughing.  You then help her reattach the cups and excuse yourself.  Just as you're leaving, Marble blows you a kiss and says, \"<i>We should definitely do this again sometime.  Let's just give Whitney a break first.</i>\"");
                this.player.orgasm();
                this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] = 5;
                this.dynStats("sen", -2);
            }
            else {
                this.outputText("[pg]You assure Marble that it will be fine and grab a bucket that was sitting under the bench and offer to continue her milking by hand.  She looks like she is going to object for a moment before nodding.  You help her turn herself around while keeping your manhood firmly embedded within her.  She puts the bucket down at the end of the bench, and you reach your hands around her to grip her massive mammaries.");
                this.outputText("[pg]You roll the soft pliable flesh around in your hands for a few moments, garnering appreciative moans from their owner.  Then you start pinching and pulling on her " + this.marbleNips() + ", sending a jolt through her body that makes her tail shoot straight up.  Almost instantly after that, she resumes rubbing herself against your manhood, sending it sweeping through her insides once more while her delightfully shaped rear-end slides around against your waist.");
                this.outputText("[pg]You give a gasp of pleasure of your own and try your best to properly milk her nipples in the same way that cows back home were milked, in spite of how roughly your milkee is fucking right now.  If anything, being milked has made her more aggressive, and her tail is swishing around madly.");
                this.outputText("[pg]It takes a few minutes of effort, but when you find yourself finally closing with the peak of an orgasm, there is a spray followed by a ping. You finally manage to get some milk flowing from Marble's breasts, just in time for her to scream in pleasure and drive herself back into you more forcefully than before.  Her tail shoots straight up again, twitches twice, and you're thrown over the edge as well.");
                this.outputText("[pg]The two of you cum together at least three times over the next hour or so, and while your hand milking certainly isn't as efficient as Whitney's machine, it manages well enough in satisfying your bovine lover.  When you go to tell the farmer what happened to her device, she is rather surprised at just how nonchalant and pleasant the two of you were about it.  As she put it, \"<i>Most folks generally feel bad when they go round breaking other people's things.</i>\"  Though, you're certain she knew what you'd been up to.");
                this.player.orgasm();
                this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] = 10;
                this.dynStats("sen", -2);
                this.marblePreggoChance(1);
        ...
        milkMarbleTakeHerDick() {
            this.clearOutput();
            this.outputText("You ask her if maybe she wants to penetrate you while she is using that milking machine.");
            this.outputText("[pg]She looks thoughtful for a moment, tapping her finger against her lips while her tail swishes back and forth.  With the tubes coming off of her nipples, it actually looks rather comical.");
            this.outputText("[pg]Spotting your look, she frowns at you, \"<i>Oh, you think this is silly do you, [name]?  I'll have you know that I'm seriously trying to figure out how to make this work.</i>\"  She indicates her rather physical attachment to the room, and the furnishings it has available to it.");
            this.outputText("[pg]You give it a little thought, then suggest that you could lean up against that railing while she fucks you from behind.");
            this.outputText("[pg]\"<i>Take you from behind, huh?  I'd really rather look into your eyes while I'm having sex, but there aren't many options here, are there?</i>\"");
            this.outputText("[pg]To silence her complaining, you quickly strip");
            if (this.player.tallness < 56)
                this.outputText(", grab a box,");
            this.outputText(" and lean against the railing, then shake your [ass] in her direction with your vagina on full display, wet with arousal.  You look back at her to see if you're having the desired effect.");
            this.outputText("[pg]Marble is licking her lips with a nervous look on her face while holding her tail in her hand and running her fingers through it's brush.  \"<i>You make a very persuasive argument, sweetie.  Plus, if you're looking at me like that, I guess I really don't have anything to complain about, do I?</i>\"");
            this.outputText("[pg]She strips off her short skirt and takes up a position behind you, hands on your hips and erect cock pressed against your entrance.  You look down between your legs and catch sight of her tail hanging down between her legs, the barest hint of movement to it.  \"<i>Well sweetie, are you ready for me?</i>\"");
            this.outputText("[pg]You retort that if you weren't, you wouldn't have suggested this in the first place.");
            this.outputText("[pg]\"<i>Heh, good point.  Alright, here I go...</i>\"  She slowly works her way inside you, inch by inch.  ");
            if (this.player.vaginalCapacity() < this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH] * this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_THICKNESS])
                this.outputText("With each new bit of length inserted, she waits a few moments for you to adjust to her size, letting you fill out to accommodate her.  ");
            this.outputText("With the final bit of her inserted into you, her tail suddenly shoots straight up out of your sight, and she lets out a long exaggerated sigh of pleasure as the milking machine continues to whirl above her.");
            this.player.cuntChange(8, true, true, false);
            this.outputText("[pg]\"<i>Oh sweetie, you feel so wonderful.  I actually feel a bit strange right now, like I want to....</i>\"  She starts thrusting into your entrance with great gusto, eliciting a surprised gasp from you; Marble isn't normally this energetic when it comes to sex!  Being milked is probably making her more aggressive than usual, though given how good she is making you feel, you can't really complain.");
            this.outputText("[pg]She starts playing with your backside with her hand, massaging your ");
            if (this.player.buttRating <= 4 && !this.player.isGoo())
                this.outputText("taut");
            else
                this.outputText("jiggling");
            this.outputText(" flesh while her " + MarbleScene.num2Text(Math.round(this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH])) + " inch length continues to push and pull into your womanhood.  Egged on by her enthusiasm, you start putting in some effort into the sex yourself by pushing your backside tight against her with each push forward and shaking it back and forth with each pull out of your interior.");
            this.outputText("[pg]The stimulation sends Marble wild, and in short order she is flooding you with her hermaphroditic seed.  However, she doesn't slow down at all and simply continues to lovingly abuse your backside and mound of pleasure.  You look down between your legs once more to see her tail has started swinging lengthwise with her body, every last inch of her body and mind are fixed on breeding with you, triggering a triumphant laugh from you as you cum yourself.");
            this.outputText("[pg]Nearly an hour later, Marble finally calms down and looks down at what she has managed to do to you.  \"<i>Oh my!  Sweetie, I'm sorry, I'm not sure what came over me...</i>\" she freezes when she sees your happy expression, and you inform her that you rather liked seeing that side of her. The two of you will have to do this again some time.");
            this.player.orgasm();
            this.player.orgasm();
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] = 10;
        ...
        milkMarbleOnTheBar() {
            this.clearOutput();
            this.outputText("You suggest that you'd be interested in playing with her while she's draped over the bar on the one side of the room.");
            this.outputText("[pg]She narrows her eyes at you, considering the proposition.  \"<i>I don't know sweetie, doesn't really sound like something I'd like that much.  I'd like to be in a position where I can do more than just take it...</i>\"");
            this.outputText("[pg]You assure her that you'll make it good enough that it will be worth while to let you have complete control.");
            this.outputText("[pg]After a few more moments of thought, Marble gives you a very serious look, \"<i>You don't get complete control, I'll be giving the instructions here, oh, and you'd better do a good job.</i>\"  Suddenly she smiles, \"<i>Otherwise, I'll just have to turn things around!</i>\"");
            this.outputText("[pg]You wonder if maybe you want her to turn things around while she rests her hands on the bar, then drapes herself over it with her breasts swinging underneath.  She turns her head towards you and swings her ribbon decorated tail back and forth a few times.  You'd best not keep her waiting when she actually took you up on your request, so you strip down and step up behind her.");
            this.outputText("[pg]\"<i>Alright sweetie, time to get me ready.  Let's see how you do.</i>\"  She turns her head back, and simply waits for you to start while the milking machine continues to hum above her.");
            this.outputText("[pg]You start by lifting up her skirt to expose her round ass to the air and the lips of her womanhood below it.  Of course, there is also the base of her tail just above it which continues to swish back and forth somewhat indignantly overtop of her openings.  Next, you take a handful of her generous asscheeks, rolling them around in your hands and kneading the soft bouncy flesh.  Though not as expansive as her bust by any means, Marble undeniably has quite the pleasant backside.");
            this.outputText("[pg]\"<i>Hmm,</i>\" comes a pleased moan from the cowgirl in front of you, and her tail lifts up ever so slightly as the first signs of moisture and arousal form around her womanhood.");
            this.outputText("[pg]Next, you run a finger across her entrance, teasing her ever so slightly.  A small jolt flies through her body, and her tail shoots straight up.");
            this.outputText("[pg]\"<i>Ah, that's a good start sweetie, now, put a finger inside me.</i>\"");
            this.outputText("[pg]The words are barely out of her mouth, when you push your index finger into her lower lips.  There is a low squelch while it slips inside, which starts again when you stir your finger around in a few circles.  This causes Marble's tail to curl around your hand and try to pull your finger out.  Once a little ways out, her tail tries to force your hand back into her waiting snatch.");
            this.outputText("[pg]\"<i>Maybe you need my help after all.  Want to let my tail do the talking sweetie?  Let me show you how I like being penetrated.  Then again, your tongue might be nice to feel next too...\"</i>");
            if (this.player.cockThatFits(this.marbleCuntCapacity()) > 0)
                this.outputText("[pg]You idly consider grabbing and pulling on her tail, so you could have a chance to take charge, though Marble would probably try and take control in that case for sure...");
            this.menu();
        ...
        milkMarbleBarFollowTail() {
            var x = this.player.cockThatFits(this.marbleCuntCapacity());
            var y = this.player.cockThatFits2(this.marbleCuntCapacity());
            this.clearOutput();
            this.outputText("You ask Marble where her tail will lead you.");
            this.outputText("[pg]She gives a low chuckle, \"<i>Why don't you wait and find out?</i>\"");
            if (x >= 0) {
                this.outputText("[pg]Her ribbon adorned, bovine appendage slowly unwraps from your wrist and instead searches around your crotch for something else.  Eventually the tuff comes into contact with your " + this.cockDescript(x) + ", and runs its fur across your length lovingly for a few times, then curls around your base and pulls you in towards Marble's waiting womanhood.");
                this.outputText("[pg]\"<i>Mhehehe, found it!</i>\"");
                this.outputText("[pg]It was obvious that you couldn't hide from her for long.");
                this.outputText("[pg]\"<i>Oh I know sweetie, but it's always so much fun looking.</i>\"");
                this.outputText("[pg]Sliding into her interior is a slow but enjoyable process.  Each inch you pass in makes you want to just slam yourself home in an instant, but you wait to let Marble's tail guide the way.  Finally you're fully inside her, and she lets out a long soft moan of pleasure, followed by shaking her hips side to side a few times.");
                if (y >= 0)
                    this.outputText("  You find your " + this.cockDescript(y) + " slides up comfortably in between her cheeks, and squeeze them together a bit to give it a nice tight valley of soft flesh to run through.");
                this.outputText("[pg]Your guide string tightens up a bit in time with the end of your lover's cry of pleasure.  \"<i>Hmmm, mine, all mine.</i>\" You barely catch Marble whisper under her breath, then her tail relaxes a bit and pushes back against your waist.  Understanding the direction, you pull your cock back out of its \"owner's\" home.  Though you haven't gone far before she tightens on you once more, and you realize that you were suppose to switch directions again. You focus your attention once more on the fluff that's showing you the way.");
                this.outputText("[pg]Everything centers onto three things: the feel of aroused cunt surrounding your shaft, rippling and squelching with each slow plunge and retreat from its depths, the soft springy ass and hip curves under your hands that runs oh so pleasantly under your hands, and of course, Marble's tail curled around the base of your " + this.cockDescript(x) + ".  The sensation of her thin appendage, soaked and sweat yet still soft with fur, constantly quivering and twitching in time with the movements of your two bodies, draws your entire focus.");
            }
            else {
                ...
                this.outputText("[pg]You ask Marble if there is any chance you've found what she wanted?");
                this.outputText("[pg]\"<i>Why yes sweetie.  What gave it away?</i>\"");
                this.outputText("[pg]It was just a hunch.");
                this.outputText("[pg]You adjust your grip on her personal toy and press one end against her waiting womanhood.  Just as you're about to ask her if she's ready for it, her tail suddenly jerks forward, sliding the tool inside her.  She gasps while the false cock quickly slides up to its centerpiece into her depths, then giggles when you try to pull it back out. Unfortunately, you find she's clapped down on it hard.");
                this.outputText("[pg]\"<i>What's wrong sweetie?  You haven't managed to get stuck have you?  Here, let me give you a hand....</i>\"");
                this.outputText("[pg]Abruptly, her tail reverses it's pressure and allows you to extract her toy from its sheath - at least a little ways.  Then, you flip directions yourself and push it back in to the hilt.  There is a sharp intake of breath from your lovely lover, and you give her rear a small smack.  In response she tightens around your wrist, and it sounds like she might be about to get mad at you.  Instead she chuckles a bit.");
                this.outputText("[pg]\"<i>Alright, no more teasing.  You're more than just a plaything after all.  I've got to let you do something.</i>\"");
                this.outputText("[pg]Finally, she allows you to freely build her pleasure and tease her body.  You can focus on bringing her to blissful sexual release by playing with her wonderful plump rump, twisting and pumping her with her dildo to the sound of lewd squelching that can just be heard over the hum of the milker and Marble's moans of pleasure, and lastly, the quivering of her tail.  The tail that serves as a subtle guide to the ways of your lover's tunnel.");
            }
            this.outputText("[pg]You're so engaged into the activity, that you barely register a long low call of ecstasy come out of cow-girl mate.  That same cry that is something between a moo and a long sigh that you've come to know very well.  At the same time, she manages to knock the hoses off her breasts, and there is a splash as her milk hits the floor of the stall, which steadily slows to a trickle, then only a few drops.");
            if (x > 0) {
                this.outputText("[pg]Finally, the grip on your root relaxes, and you're finally able to explode inside her. Her tail slowly slips off of you and falls limp next to the connection between your bodies.  Several gasps and groans come out of your lips, and you ask Marble if she was satisfied.");
            }
            else {
                this.outputText("[pg]The hold on your hand tightens to a death grip, and you have no choice but to let go of her dildo and desperately struggle to free your constricted limb from her tail.  When you finally do manage to free yourself, you start rubbing your tingling fingers and ask Marble if putting your hand to sleep was a sign that she was satisfied.");
            }
            this.outputText("[pg]Your lover girl straightens up and turns around to face you.  She fixes you with a stern look for a few moments before pulling you into a deep french kiss.  \"<i>Well, if you're always that good at following directions, I'm not sure how I wouldn't be.</i>\"");
            this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] = 10;
            if (x >= 0) {
                this.player.orgasm();
                this.marblePreggoChance(1);
                ...
                var pLust = Math.floor(10 + this.player.lib / 10);
                this.dynStats("lus", pLust);
            }
            this.doNext(this.camp.returnToCampUseTwoHours);
        }
        milkMarbleBarCunnilingling() {
            this.clearOutput();
            this.outputText("You ask Marble to release your wrist so you can get into a better position for taking care of her.  You're feeling an ache to harvest her other womanly fluid.");
            this.outputText("[pg]\"<i>Of course sweetie, I'm feeling very wet down there.  I definitely think I'm going to need you to take care of that.</i>\"");
            this.outputText("[pg]She released you, and allows you to kneel down behind her and get a good whiff of her rich womanly scent.  It throws your mind into a haze for a few moments, and you're brought back out with a swish of wind as her tail swings side to side over her entrance, the base lifted up eagerly.  You rest your head to the side of her entrance, and lean against the part of her body where ass meets thigh while letting one hand play across the other leg.");
            this.outputText("[pg]After a moment's climb, you find your fingers curling around the root of her bottom's bestial extension.  An idea strikes you, and you comment on how you need to brush her off before you start harvesting.");
            this.outputText("[pg]\"<i>Oh?  What do you mean by that?</i>\" comes a somewhat bemused response.");
            this.outputText("[pg]You don't reply, instead you make a small ring with your thumb and finger and slide her tail through the hole as it flicks and swings around.  When you reach the thick hair at the end, you tighten your grip and direct the brush to the entrance of her womanhood.");
            this.outputText("[pg]\"<i>Oh!  Ohhhhhhh...</i>\"");
            this.outputText("[pg]A careful dab here, a deeper scope there, and you think she's ready to be harvested.  You get a drop of her fluids of off your brush and give it a taste test.  A quick word of approval to Marble of the quality of her fluids, and you dive into her snatch.  Her deep earthy aroma fills your head as you drink deeply of her fluids, licking around her folds and tasting everything she has to offer.  You hear soft moans of pleasure in approval of your efforts, just barely audible over the hum of the milking machine above you.");
            this.outputText("[pg]Now free to do as it wills, you find that Marble's tail has curled around the back of your head, and is trying its hardest to push you deeper into her rear as possible.  At the same time, your lover's hips are rocking side to side, dragging your face across her gash and spreading her fluids all over your [face].  Trying to steady yourself, you grab two big handfuls of her expansive touch, and lower your head slightly.  This act brings her love-button in line with your mouth, and her passage in line with your nose.  Once again you're overwhelmed by the olfactory sensations, and mindlessly lap away at her fluids and engorged clitoris.");
            this.outputText("[pg]\"<i>Oh yes, yes!  That's so wonderfuuuuuuul!</i>\"  Marble cries out several more times, as she rides out the orgasm you've brought her to through your efforts to harvest her.  Your reward is to be absolutely drenched in the sweet nectar you've been harvesting all this time, and every drop you catch in your mouth and on your [tongue] is swallowed in an instant.  In the end, you're actually a bit disappointed when her fluids run out.");
            this.outputText("[pg]You nuzzle in against her soft bum once more, and bat at her tail playfully for a few moments.");
            this.outputText("[pg]\"<i>Hmm, I'd say that you've made standing like this worth the while, [name].  I think I might be willing to go like this again, if you're able to keep up this level of performance.</i>\"");
            this.outputText("[pg]You laugh and assure Marble that when it comes to her, you'll always be giving it your all.  Just before you leave, an impish thought passes through your head for a moment, and you slip her tail's brush to Marble's entrance and push it inside a short ways.  Marble starts from the unexpected sensation, and you explain that you're only cleaning up some stray drops of fluid that might still be hiding away.");
            this.outputText("[pg]After a moment, her tail flicks back out of her passage and she shakes her head at you.  \"<i>Thank you for the thought, sweetie, but please don't get me worked up again now, unless you're going to take care of me again.</i>\"");
        ...
        milkMarbleBarPullTail() {
            var x = this.player.cockThatFits(this.marbleCuntCapacity());
            this.clearOutput();
            this.outputText("Probably against your better judgment, you decide to take charge and grab onto Marble's tail, roughly untwisting it off of you and yanking it upwards.");
            this.outputText("[pg]\"<i>Ow!  What the hell sweetie?!</i>\"");
            this.outputText("[pg]You ignore her protests and smack her ass once, then roughly penetrate her with your " + this.cockDescript(x) + " while yelling at her to take it.");
            this.outputText("[pg]There is a loud clop as Marble stomps her hoof on the ground angrily.  With a huff, she lifts herself up on the bar and kicks back with both her legs, sending you flying onto your back and knocking the wind from your lungs.  You gasp for breath a few times, then look up to see Marble looming over you with a wicked smile on her face.");
            this.outputText("[pg]\"<i>I warned you that I'd be taking charge if you couldn't behave yourself, didn't I [name]?</i>\"  She sits down on your stomach, and presses her hand against your [chest], squeezing you somewhat painfully.  \"<i>Now you're going to be punished!</i>\"  Given her expression, you get the impression that maybe she actually wanted you to misbehave!");
            this.outputText("[pg]Your aggressive mate moves forward and straddles your face, shaking her snatch back and forth a few times just above your head.  A few drops of her lubricant drip down onto you, followed by a flick across the nose, delivered by the tail you just grabbed.  At the same time, you're bathed in the deep scent of her aroused sex.");
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] > 0)
                this.outputText("  She grabs her erect member, and rubs it against your cheek a few times, spreading around some of her pre-cum.");
            this.outputText("[pg]\"<i>You like it when I take charge, don't you?  Hmmhmm, yes...</i>\"");
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_TYPE] == 0) {
                this.outputText("[pg]She drops her hips and roughly forces her womanhood down onto your face, cutting off your ability to breathe.  You sputter and gasp underneath her at the sudden suffocation, though it lasts only a few seconds before she releases you.");
                this.outputText("[pg]\"<i>Aww, was that too rough?  Don't worry.  I'll be a bit more gentle.</i>\"");
                this.outputText("[pg]Marble then settles herself down a bit more gently, this time giving you plenty of room to breathe while also keeping your mouth tightly locked against her slick passage.");
                this.outputText("[pg]\"<i>Alright, let's put that rude tongue of yours to a much better job.  Lick me.</i>\"");
                this.outputText("[pg]You do as you're bid and get an approving smile in response.  Digging deeper inside her, you feel under her folds and plunge into her depths.  ");
                if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                    this.outputText("You take full advantage of your inhumanly long tongue to fill her up, running across her passage all the way to the entrance to her womb and then back to her lower lips.");
                else
                    this.outputText("You send your tongue as far into her passage as it will go and wriggle around her lower lips, trying to please your aggressive bovine lover to the best of your abilities.");
            }
            else {
                this.outputText("[pg]She forces your mouth open and pushes her hips forward, roughly shoving her " + MarbleScene.num2Text(Math.round(this.flags[kFLAGS_1.kFLAGS.MARBLE_DICK_LENGTH])) + "-inch cock into your hapless mouth and down your throat.  You choke and sputter in surprise at the sudden suffocation, but it only lasts a few seconds before she pulls back out.");
                this.outputText("[pg]\"<i>Aww, was that too rough?  Don't worry, I'll be a bit more gentle.</i>\"");
                this.outputText("[pg]Marble then thrusts forward much more gently, giving you plenty of time to get use to the sensation of her member inside your mouth.  She also is sure to keep herself well outside of your throat.");
                this.outputText("[pg]\"<i>Alright, let's put that rude mouth of yours to a much better job.  Suck me.</i>\"");
                this.outputText("[pg]You do as you're bid, and get an approving smile in response.  You wrap tightly around her with your lips and slide your tongue up and down the bottom of her shaft while also playing across the urethra.  She pumps herself into you a few times, and you get a taste of some of her pre-cum.");
            }
            this.outputText("[pg]Marble lifts her hips back up after a few moments, with a curt nod.  \"<i>Now, you've got to take care of my tail.  It stings after you pulled on it like that, I want you to apologize to it and kiss it better.</i>\"  She then turns around and gives you a good view of that very tail, which seems to be swinging back and forth rather half-heartedly.");
            this.outputText("[pg]There, there, you tell the part of your mate's body you hurt before, gently stroking the short furred appendage.  Then you lean forward and repeatedly kiss it, running from the thick tuff on the tip, all the way up to the base where her spine meets the round cheeks of her ass.  When you reach the root, a quiver shoots through Marble's body, and she suddenly grabs you and forces her tail into your mouth.  You gasp in surprise and look up at your lover inquisitively.");
            this.outputText("[pg]\"<i>Hmm, sorry sweetie, I just thought I'd try something.  It didn't feel the way I expect, but I really like the way you look with my tail in your mouth like that.  If you suck on it for a bit, I might be able to forgive you for yanking it before.</i>\"");
            this.outputText("[pg]You run your tongue around the sweaty fur and get an approving look from your bovine lover.  Then you shake your jaw back and forth a few times and slowly let her bush slide out of your mouth.  As the last of the hair slips out, you give a small kiss to the tip.");
            this.outputText("[pg]\"<i>Did you like that sweetie?");
            if (this.silly())
                this.outputText("  Want to brush your teeth with my tail next time?");
            this.outputText("</i>\"  She nods and considers you for a moment.  \"<i>Well, I think I'm feeling a lot better now.  I think I can forgive you for what you did.  In fact, you did such a good job that I think I'll give you a reward!</i>\"");
            this.outputText("[pg]With a smile, you ask her what she's got planned for you.");
            this.outputText("[pg]She repositions herself overtop of your waist and eyes your male member.  \"<i>Obviously this thing here is in need of some treatment, since you were so eager to try and take charge with it before.</i>\"  She drops down and brings the flaps of her womanhood into contact with the front of your shaft and runs them over it a couple of times.  \"<i>Look how hard you are.  You really want me to take you inside me, don't you?  You want so much to give complete control of your long, hard, dick, to me to use as I see fit.</i>\"");
            this.outputText("[pg]She doesn't let you respond.  She's already decided what is going to happen, and that's for you to go inside her and be used by her as she sees fit.  She strokes your " + this.cockDescript(x) + " with one finger, then pushes it into her waiting cunt.  You slip easily into her very well lubricated passage and groan as it clamps down on you.  Every part of your shaft is being tightly wrapped in the ring of her vaginal muscles, and you can't help but groan in pleasure.");
            this.outputText("[pg]She shakes her hips side to side a few times, spinning your shaft around her interior, then stops and considers you.  \"<i>You know, I was thinking that maybe I'm giving you too much of a reward, or maybe not enough of one?</i>\"  The same wicked look when she first knocked you over crosses her eyes once more.  \"<i>Let's try something new...</i>\"  She turns away from you and puts her hand somewhere behind her, outside of your view.");
            this.outputText("[pg]After a moment, you suddenly feel something pushing up against the entrance to your [vagOrAss]!  You try to ask what Marble has planned, but the pressure forces something bushy into your hole.  She just stuck her tail into your [vagOrAss]!");
            this.outputText("[pg]\"<i>Well sweetie, what do you think?</i>\"  It quivers a few times as Marble resumes the rocking of her wide womanly hips.  \"<i>Never mind, if you don't like it, well you can just try and end this as soon as possible.  If you do like it, then I guess...</i>\"  She leans forward as she switches from a swinging movement to a bounce on your " + this.cockDescript(x) + ", and her furry tufft of a backend appendage starts to push its way in deeper sliding easily thanks to your saliva on it.  \"<i>You'll just have to bear it as long as you can!</i>\"");
            this.outputText("[pg]You've never seen Marble this aggressive before, but the cause is rather obvious: the whirring milking machine that's currently attached to her breasts.  Obviously giving milk is triggering some kind of dominance instinct, and it's incredibly sexy!");
            this.outputText("[pg]Your lover laughs uproariously as she continues to ride you hard and fast, bringing up the pleasure in your lower body just as hard and fast.  Whether or not you want it, you can feel an orgasm rapidly building up within you, easily detectable to your rider from the increased rate of your gasps and cries of pleasure.  For her part, Marble is rapidly approaching her peak as well, and with a practiced rhythm, the two of you cum in unison as your lover's tail pops out of your [vagOrAss].");
            this.outputText("[pg]The bovine woman gasps a few times above you in exhaustion, her great breasts heaving with each breath.  She then reaches down and pulls your head up and cradles it to her chest, smiling very happily.  \"<i>Well sweetie, if you ever want me to play rough again, you know what to do.  I'm looking forward to any other adventures the two of us have in the bedroom, are you?</i>\"");
            this.outputText("[pg]You snuggle up to her bosom, thinking something very similar.  Things certainly haven't been dull while you've been in Marble's milking stall, that's for certain.");
            this.player.orgasm();
            this.dynStats("lus", 20);
            this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] = 15;
            this.dynStats("sen", -2);
        ...
        milkMarbleLeaveAfterBar() {
            this.clearOutput();
            this.outputText("You don't answer Marble and instead continue to finger her womanhood until she cries out in orgasm.  You tell her you'd be happy to help her out again whenever she'd like someone to accompany her to get milked.");
            this.outputText("[pg]She is a bit disappointed that you didn't go further after getting her on the bar, but doesn't have a problem with you leaving.  She does tell you that she's looking forward to having you in her milker again some time.");
            var pLust = Math.floor(5 + this.player.lib / 20);
            this.dynStats("lus", pLust);
            this.flags[kFLAGS_1.kFLAGS.MARBLE_LUST] += 5;
            this.doNext(this.camp.returnToCampUseTwoHours);
        }
        milkMarbleNoMilking() {
            this.clearOutput();
            this.outputText("You shake your head and say that you think you'll be fine.");
    ...
    exports.MarbleScene = MarbleScene;
});
