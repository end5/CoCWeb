define(["require", "exports", "./NPCAwareContent", "../../CoC", "../../GlobalFlags/kFLAGS", "../../StatusAffects", "../../../../includes/appearanceDefs", "../../PerkLib"], function (require, exports, NPCAwareContent_1, CoC_1, kFLAGS_1, StatusAffects_1, appearanceDefs_1, PerkLib_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Raphael extends NPCAwareContent_1.NPCAwareContent {
        //The event itself:
        ...
        timeChange() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DRESS_TIMER] > 1 && this.player.gems >= 5)
                this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DRESS_TIMER]--;
            if (this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] > 1 && this.player.gems >= 5)
                this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER]--;
            //Fix 'hangs' - PC is at the bottom of the dress countdown
            if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DRESS_TIMER] == 1 && this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == 0 && this.RaphaelLikes())
                this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DRESS_TIMER] = 4;
            return false;
        }
        timeChangeLarge() {
            if (this.checkedRussetRogue++ == 0 && this.model.time.hours == 6 && this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] >= 0 && this.player.hasKeyItem("Camp - Chest") >= 0 && this.player.gems >= 5 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.TelAdre) >= 1) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == 0) { //Countdown to finale not currently engaged!
                    //If the PC meets his criteria!
                    if (this.RaphaelLikes()) { //Not yet met!  MEETING TIEM!
                        if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_MET] == 0) {
                            this.outputText("<b>\nSomething unusual happens that morning...</b>\n");
                            this.doNext(this.meetRaphael);
                            return true;
                        }
                        else { //Already met!
                            if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DRESS_TIMER] == 0 && this.flags[kFLAGS_1.kFLAGS.RAPHAEL_SECOND_DATE] == 0) { //Not given dress yet
                                this.outputText("<b>\nSomething unusual happens that morning...</b>\n");
                                this.doNext(this.RaphaelDress);
                                return true;
                            }
                            //Dress followup - Call picnic date prologue!
                            if (this.player.armor == this.armors.R_BDYST && (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DRESS_TIMER] > 1 && this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DRESS_TIMER] <= 4)) {
                                this.outputText("<b>\nSomething unusual happens that morning...</b>\n");
                        ...
                        //Finale!
                        if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DRESS_TIMER] == 1) {
                            this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DRESS_TIMER] = -1;
                            this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] = 7;
                        }
                        //PC get ready for the 2nd encounter and hasn't been
                        //shot down yet?
                        if (this.player.armor == this.armors.R_BDYST && this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DISGUSTED_BY_PC_APPEARANCE] == 0) {
                            this.outputText("<b>\nSomething unusual happens that morning...</b>\n");
                            this.doNext(this.RaphaelEncounterIIDressFollowup);
                            return true;
                        }
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == 1) { //FINALE
                    this.outputText("<b>\nSomething unusual happens that morning...</b>\n");
        ...
        RaphaelLikes() {
            if (this.flags[kFLAGS_1.kFLAGS.LOW_STANDARDS_FOR_ALL]) {
                if (this.player.gender == 2 || this.player.gender == 3) // you at least need a vagoo for raphael to fuck you. Otherwise the sex scenes will be rather broken.
                    return true;
            }
            ...
            if (this.player.balls > 0 || this.player.cockTotal() > 0)
                return false;
            //(For now: 
        ...
        meetRaphael() {
            ...
            this.outputText("You stir in your sleep, bothered by a noise. It's the familiar creaking of your camp's storage chest, as if you've just opened it up to fill it with freshly found loot. Groaning, you hog your blankets and twist. Nothing to worry about then. You soon drift back into a pleasant dream about all the spoils you've accumulated over the time here. Life is good.\n\n", false);
            this.outputText("Suddenly, you sit up straight and something occurs to you. If you're sleeping, then who's opening the chest?\n\n", false);
            this.outputText("You rush out of bed and into camp, concerned for your stash.\n\n", false);
            this.outputText("\"<i>Hey!</i>\" you call out sleepy as, indeed, a strange red being is rummaging through your belongings. It has its front body in your storage chest, throwing junk about in search of valuables while its bright red tail wags in the air. The moment it notices you, it jumps up and runs off so fast it turns into a red blur. Only at the outskirts of your camp, on top of a small crumbled wall, does it take the time to introduce itself.\n\n", false);
            this.outputText("\"<i>Ha-hah!</i>\" it exclaims boastfully with a sharp, young, dashing voice while standing tall and proud on top of its perch. \"<i>Another daring caper committed by...</i>\"  The being takes the time to strike a pose. \"<i>...the Russet Rogue!</i>\"\n\n", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.RAPHAEL_MET] = 1;
            this.doNext(this.meetRaphaelPtII);
        }
        //~~~ Next Page ~~~
        meetRaphaelPtII() {
            this.outputText("", true);
            this.outputText("Suddenly, Raphael's features grow soft and surprised as he looks down upon you. You get the feeling he's eyeing you up and catching a peek at your cleavage, but you can't be sure.\n\n", false);
            this.outputText("\"<i>Marae must have cursed me for my audacity, for I am growing blind even at my young age.</i>\" The fox puts his hand to his forehead and pretends to faint. He rights himself just before he hits the ground, however and lands in a kneel before your feet.\n\n", false);
            this.outputText("You can't help but smile a little at the amount of theatrical flourish.\n\n", false);
            this.outputText("\"<i>Here I thought I had searched the entire camp, found every treasure, pilfered every gem...</i>\" He states while sauntering towards you in a disarming, wide stride. \"<i>... but it seems I've overlooked the greatest jewel of all!</i>\" Raphael kneels before you, taking you by the hand and planting a kiss upon it. \"<i>Can you ever forgive me for my blindness, my fair lady?</i>\" He takes your hand in both his paws, while looking deeply into your eyes. His own are a deep emerald green, contrasting sharply with his bright red coat. They are set below a sturdy brow that gives him playful maturity and a rough regal elegance.\n\n", false);
        ...
        RaphaelFirstMeetingSLAP() {
            this.outputText("", true);
            this.outputText("With an offended scowl you throw a flat palm across his face. You make sure to catch his nose and sharp snout, sending him a clear message.\n\n", false);
            this.outputText("It takes Raphael completely by surprise. The fox keeps his head in the wake of the blow for a good five seconds in disbelief, but tries once more when he recovers.\n\n", false);
            this.outputText("\"<i>I can assure you señorita, that I had no intention of tainting your honor.</i>\" He pats your hand.\n\n", false);
            this.outputText("This time you wrestle your hand from Raphael's hold and throw him the heavier back of your hand, sending him to fall on his back. You're actually getting angry at him. How dare he sneak into your camp, try to rob you and then seduce you! By the time it occurs to you to actually apprehend him, Raphael has already beaten a hasty retreat by hopping back up on the wall.\n\n", false);
            ...
            this.outputText("Raphael curtsies and tips his hat before making his escape. \"<i>You have my condolences.</i>\"\n\n", false);
            this.outputText("You resolve to wash your hand. You're sure you've not seen the last of the russet rogue, but it will be time in coming before that happens with the severity of your rejection.", false);
            //{Game Removal}
            //No more meetings + endgame in 21 days
            this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] = 0;
            this.flags[kFLAGS_1.kFLAGS.REJECTED_RAPHAEL] = 1;
            this.doNext(this.playerMenu);
        }
        //{When player chooses swoon after the first encounter}
        RaphaelFirstMeetingSWOON() {
            this.outputText("", true);
            this.outputText("You snicker softly, shift your weight on one leg and blush a little. He's quite the charmer; almost good enough to forgive him for robbing you. The attention he showers you with doesn't leave you cold either.\n\n", false);
            this.outputText("\"<i>Normally I rob opulent merchants and criminals. I have no idea what drew me into your camp. Perhaps destiny willed this fateful meeting?</i>\" He looks up and burrs with a suave accent. \"<i>Then again, I am attracted to extraordinary splendor.</i>\" He gazes at you with an emerald shimmer in his rich green eyes.\n\n", false);
            this.outputText("Curious, you finally ask him who he really is.\n\n", false);
            this.outputText("\"<i>Why I am Raphael!</i>\" He lisps affectionately and rises slowly. \"<i>Adventurer extraordinaire, redistributors of misplaced wealth and connoisseur of all things fine in life.</i>\" He strides into camp with the kind of respectful confidence that makes the place his own. He pops open the tightly locked trunk with the mere kick of the boot and places his ill-gotten gains back into your belongings. \"<i>The orphanage will have to wait. Tonight, I will regale the small ones with tales of exceptional beauty instead.</i>\"\n\n", false);
            this.outputText("A faint, nondescript sound is heard and you instantly pull away from the surreality of your little meeting, to realize others might not be so smitten by the apparently world famous thief. What if others discover him? Your mind races to come up with excuses for your illicit rendezvous, but clearly, you're more worried about Raphael's presence than he is. He merely smiles at the noise, keeps his cool and takes you by the hand. One more time he plants a kiss on top of it by bending through crossed knees.\n\n", false);
            this.outputText("\"<i>For now, do not worry yourself my shining jewel. The russet rogue never forgets a mark. I will answer all your questions in good stead, but for now, patience. I can already tell a woman like you is deserving of delicacy and finesse, like the blooming rose needs nurturing and time to reveal her innermost beauty.</i>\"\n\n", false);
            this.outputText("In a blink of an eye, the red fox jumps back up the wall. \"<i>We will meet again!</i>\" He exclaims in a hushed tone, while slinking over to the other side of the wall.\n\n", false);
        ...
        RaphaelFirstMeetingTALK() {
            this.outputText("", true);
            this.outputText("You squint your eyes at him, pulling on your arm to wrestle it from his hold. When you remark he stole from you and ask him to return your goods, Raphael simply throws you a vulpine smirk.\n\n", false);
            this.outputText("\"<i>Mere souvenirs fair blossom, to remind me of your beauty!</i>\" He schmoozes and strides into camp with the kind of confidence that makes him own the place. He pops open the tightly locked trunk with the mere kick of a boot and places his ill-gotten gains back into your belongings. From within the large sack, he pinches a small pouch of your gems and quickly spirits it away. With his lightning quick fingers, you see him place it between his shoulders.\n\n", false);
            this.outputText("You insist he return all of it, but the Russet Rogue merely smiles as he walks back towards you. \"<i>My, whatever do you mean, pretty señorita? Are you accusing me of being less than forthright?</i>\" He raises his shoulders.\n\n", false);
            this.outputText("Tiring of his charades, you reach behind his neck to retrieve the pilfered pouch, but when you do, there is none to be found. It's the only place he could have put it, but it's gone and he isn't using his arms! You frown. It's clear that the fox is as good as his reputation. He's hiding the pouch with the skill of a pickpocket. You begin to consider how he does it, but before you do, the fox comments on your body posture.\n\n", false);
            this.outputText("\"<i>My, aren't we frisky. What happened to foreplay? Shouldn't you be buying me dinner before you ravish me? Breakfast perhaps?</i>\" Raphael clucks. You jump away as you realize you've had your hands all over his body.\n\n", false);
            this.outputText("\"<i>No, my lady. If you ever want to inspect these particular goods, we will have to meet again!</i>\"  Raphael hops up the same wall, spinning about on one leg. \"<i>Do not worry yourself, my fair flower. The russet rogue never leaves a lady wanting. For now, patience. I can already tell a woman like you is deserving of delicacy and finesse, like the blooming rose needs nurturing and time to present her full glory.</i>\"\n\n", false);
            this.outputText("In a blink of an eye, the red fox jumps back up the wall. \"<i>We will meet again!</i>\" He exclaims in a hushed tone, while slinking over the wall to land on the other side.\n\n", false);
        ...
        RaphaelDress() {
            this.outputText("", true);
            this.outputText("A small pebble hits the ground near you, waking you up. When a second one hits, you're sure someone is trying to draw your attention.\n\n", false);
            this.outputText("Rubbing your eyes, you pull yourself out of bed, wondering what's going on. Sticking your head through the front wall of your tent, you take a curious peek outside, but find no one around.\n\n", false);
            this.outputText("The first thing you do is open your storage chest, to see if the Russet Rogue has robbed you again. This doesn't appear to be the case, and instantly, your eye is drawn to an addition instead of a subtraction from its contents. You seem to have gained a new outfit! Upon a carefully folded fabric of rose red color, a note is left below a gorgeous ruby pendant upon a golden setting and carried by a filigree chain. Curiously, you open the note and read it.\n\n", false);
            this.outputText("\"<i>I happened across this beautiful ensemble and was instantly reminded of the one thing in Mareth that makes its splendor pale in comparison. Fair trappings, to fit around a beautiful body.\n\n", false);
            this.outputText("Yours faithfully,\n  - The Russet Rogue\n\n", false);
            this.outputText("P.S. The clothes are my gift to you. I would delight to see you wear it whenever you desire to meet. Ownership of the ruby however, remains to be seen.</i>\"\n\n", false);
            this.outputText("You hold the ruby pendant to the light. It must be priceless. Its crimson shimmer is enough to make you forget to ask yourself where Raphael could have gotten it from. You wonder what he means by ownership. It very clearly is in your possession now.\n\n", false);
        ...
        RaphaelEncounterIIDressFollowup() {
            ...
            if (this.RaphaelLikes()) {
                ...
                this.outputText("When you inspect the rest of his body, it's clear that Raphael is still the sly fox. Your ruby pendant hangs from his belt. He has once again stolen it from you after gifting it earlier, like it was some game. When he notices your interest, he flicks his tail over it, causing the necklace to disappear.\n\n", false);
                this.outputText("\"<i>The temporary price of admission for a moment of wonder.</i>\" He assures you. \"<i>Trust me that it'll be worth it. Join me, and I might even teach you the tricks of the trade. That is, unless you're cunning enough to frisk me for it.</i>\" He smiles playfully.\n\n", false);
                this.outputText("What do you do?", false);
                this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DISGUSTED_BY_PC_APPEARANCE] = 0;
                //[Reject] [Frisk] [Date]
            ...
            //({If player does not meet the first encounter requirements:}
                ...
                this.outputText("When he catches sight of you, he spurts out the sip.\n\n", false);
                this.outputText("\"<i>Mon Dieu!</i>\" he states in shock and stands up on top of his wall.\n\n", false);
                this.outputText("\"<i>What terrible tragedy! The land has taken its toll on the once so beautiful.</i>\" He looks down on you.\n\n", false);
                //({If player has no legs, or a centaur body.}
                if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_NAGA || this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR || this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_GOO || this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_PONY)
                    this.outputText("\"<i>You're missing half your body!</i>\" He refers to your morphed legs.\n\n", false);
                //({If player has above E cup breasts} 
                if (this.player.biggestTitSize() >= 7)
                    this.outputText("\"<i>Your female curves... replaced with such... udders!</i>\" He looks at your bosom. \"<i>No woman could be elegant with such monstrosities up front!</i>\"\n\n", false);
                //({If player has below C cup breasts} 
                if (this.player.biggestTitSize() < 3)
                    this.outputText("\"<i>Your female curves... gone!</i>\" He looks at your bosom. \"<i>It's hard to tell you apart from a little girl!</i>\"\n\n", false);
                //({If player has grown less than girly hips}
                if (this.player.hipRating < 6)
                    this.outputText("\"<i>What happened to that fine hourglass shaped figure? Those comely hips?</i>\"\n\n", false);
                //({If player has gotten a massive butt} 
                if (this.player.buttRating >= 13)
                    this.outputText("\"<i>Oh... my... Marae! " + this.player.short + ", look at your butt. It is so big! You look one of those cat guy's girlfriends. Who understands those cat guys? You look like a total prostitute. I mean, your butt. It's just so big. I can't believe it's just so round and so out there! Gross!</i>\"  The fox shakes his head and breaks it down. \"<i>I hate big butts! So vulgar.</i>\"\n\n", false);
                //({If female player has gotten bigger than 6 feet}
                if (this.player.tallness > 72)
                    this.outputText("Raphael rolls his eyes across your giant body and looks intimidated. \"<i>I can forget about remaining unseen when I take someone of your size somewhere!</i>\"\n\n", false);
                //({If female player has gotten smaller than 4 feet}
                if (this.player.tallness < 48)
                    this.outputText("Raphael squints like he has trouble seeing you from there, because of your dimunitive size. \"<i>I've dated goblins once... didn't work out.</i>\"\n\n", false);
                //({If player has grown ANY cock and balls}
                if (this.player.balls > 0 || this.player.cockTotal() > 0)
                    this.outputText("\"<i>What is that bulge below the tight outfit I gave you?</i>\" The fox inspects your groin. \"<i>No, never mind. I don't want to know.</i>\"\n\n", false);
                //(For now: 
                //({If player has lost all gender}
                if (this.player.gender == 0)
                    this.outputText("\"<i>There's... something different about you today. Your smell, it has changed.</i>\"\n\n", false);
                this.outputText("The fox looks dissapointed. \"<i>Beauty is in the eye of the beholder, but it certainly isn't gracing mine right now.  señorita... or what remains of you, please clean yourself up. Meanwhile, I just remembered: I have a sick mother to take care of. I hope you'll excuse me!</i>\" he mentions before hopping back of the wall and making a hasty retreat.\n\n", false);
                ...
                this.doNext(this.playerMenu);
                this.flags[kFLAGS_1.kFLAGS.RAPHAEL_DISGUSTED_BY_PC_APPEARANCE] = 1;
        ...
        RaphaelSelectDate() {
            this.outputText("", true);
            this.outputText("You smile bashfully, not expecting this sort of gesture from anyone in Mareth. You hardly care about the pendant and you nod at him.\n\n", false);
            this.outputText("\"<i>Ha-ha!</i>\" Raphael hops to his feet on top the wall and gloats at you. \"<i>You're sure you're ready for this journey? Because I'm going to show you the time of your life!</i>\" He kneels down on top his wall and extends you his hand on approach.\n\n", false);
        ...
        RaphaelChooseReject() {
            this.outputText("", true);
            this.outputText("You sigh at the fox and shake your head. You're not interested in him or his advances.\n\n", false);
            this.outputText("He flicks his tail past his body again and within the blink of an aye, the glass of wine is exchanged for the stolen pendant.\n\n", false);
            this.outputText("\"<i>The Russet Rogue is no thief, señora.</i>\" He states seriously and tosses the bauble back at your feet. You drop your frown.\n\n", false);
            this.outputText("\"<i>Such a pity though... the flower who refused to bloom.</i>\" He stands atop his crumbled wall. \"<i>Take my advice fair lady. Life is too short and this world too fleeting, for missed opportunities. Let your hair drop, loosen your guard and enjoy the finer things in life.</i>\" He nods and winks at you. \"<i>You might discover it might not be so bad.</i>\"\n\n", false);
            this.outputText("In the two seconds it takes for you to pick up the pouch, you find that the fox has vanished as though he were never there. Amazed, you climb onto the wall and try to figure out where he'd gone that fast. Peeking over the wall confirms your suspicions of him simply letting himself fall off the wall to make an elegant exit. A single shattered glass can be found on the other side, but no trace of the fox.", false);
            //{Game Removal.}
            this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] = 14;
            this.flags[kFLAGS_1.kFLAGS.REJECTED_RAPHAEL] = 1;
            this.doNext(this.playerMenu);
        }
        //{When player chooses [Frisk] after second encounter}
        RaphaelChooseFrisk() {
            this.flags[kFLAGS_1.kFLAGS.FUCK_YOU_GOT_MINE_RAPHAEL] = 0;
            this.outputText("", true);
            this.outputText("You flash a playful smile and express the desire to get your jewelry back.\n\n", false);
            this.outputText("Challenged, Raphael hops from his perch and leans against the wall like a misbehaved rascal at your approach. With his back towards the boulders, he has his hands behind his head and one foot up against the stacked cobblestone; braving his body like he's eager for your touch. \"<i>My, whatever are you talking about, señorita? Know something I don't?</i>\"\n\n", false);
            ...
            //({Int or Spe between 24-36 and Cor is not higher than that}
                ...
                if (this.player.cor <= 15)
                    this.outputText("You have the stronge urge to grab hold of the oddly enlarged bulge between his legs and retrieve the necklace from within his pants, but the lewdness of the gesture keeps you from it.\n\n", false);
                //{If player corruption is at or higher than 15} 
                else
                    this.outputText("With no intention to relent, you grab him by the oddly enlarged bulge in his tight leather pants and squeeze softly, discovering how several of his jewels are harder than others. He hid your gem amongst his own!\n\n", false);
            ...
            //{If player's corruption is higher than 19 and higher than Intelligence.}
                ...
                this.outputText("\"<i>My, such an eager little thing.</i>\" He comments, pleased.\n\n", false);
                this.outputText("You ask yourself the age old question if he's just happy to see you, but you suspect differently when you reach out for the firm lump and cup it.\n\n", false);
                this.outputText("What do you do?", false);
                //[Squeeze] [Fondle]
        ...
        //[Accept]
        friskAcceptChoice() {
            this.flags[kFLAGS_1.kFLAGS.FUCK_OFF_THEIVING_RAPHAEL] = 1;
            this.outputText("", true);
            this.outputText("\"<i>Come on then!</i>\" He proclaims before shooting up the wall, extending you his paw. \"<i>Join me! Together we shall paint the forest russet red!</i>\"\n\n", false);
        ...
        friskRejectChoice() {
            this.outputText("", true);
            this.outputText("You scoff, cross your arms and reject the offer by telling Raph your answer from across your shoulder, with your back still turned to him aloofly. Pleased with yourself, you add that he's nothing more than a carnie with an accent and that you won't be needing his help.\n\n", false);
            this.outputText("\"<i>As you say, my desert rose. It is clear that I have no more to teach you then.</i>\"\n\n", false);
            this.outputText("You startle when you hear the fox bang against your chest. When you turn around, he's once again stealing from you!\n\n", false);
            this.outputText("\"<i>There's no teaching those of lesser stock a sense of grace and refinement. Those are still decidedly my domain!</i>\" He guffaws with a bag of goods across his back and runs off.\n\n", false);
            this.outputText("\"<i>Even without a belt on?</i>\" You ask him, holding up the leather strap he wore across his waist a mere minute ago. You took the time to swipe it along with the pendant.\n\n", false);
            this.outputText("As Raphael bolts, he has a look of surprise on his face. He doesn't last long before his pants drop to his ankles and he falls flat on his face.\n\n", false);
            this.outputText("He yelps when he loses hold of the bag, which drops to the ground. The fox uses both hands to protect his modesty by holding up his pantaloons, slipping over the spilt gems a few good times and flailing about, before finally making it to the wall with nothing to show for it.\n\n", false);
            this.outputText("\"<i>I will regain my honor!</i>\" He exclaims while waving his hands in a theatrical flourish, causing his pants to drop once more.\n\n", false);
            this.outputText("You laugh as he blushes, beating a sound retreat. You're sure this won't be the last you'll see of him however.", false);
            //{Game removal}
            this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] = 14;
            this.flags[kFLAGS_1.kFLAGS.REJECTED_RAPHAEL] = 1;
            this.doNext(this.playerMenu);
        ...
        friskFondleChoice() {
            this.outputText("", true);
            this.outputText("You gently massage the leathery package. It increases in size until a distinct shape of some length forms above it. When Raphael moves his hips forward appreciatively, you look up, throw him a smile and slip your hand into his pants. He's not wearing any underwear, you notice as you rummage about. Struggling to restrain yourself, you slip past the throbbing meat of his naked cock and dig around his jewels instead, removing the ruby from behind them.\n\n", false);
            this.outputText("\"<i>Such a good girl you are.</i>\" He smirks lewdly. \"<i>You have a lot of talent in those fingers. A distinct gift. There's a lot I could show a feisty little minx such as you.</i>\"\n\n", false);
            this.outputText("You deftly remove the sweat stained, fogged up stones and tug them away between your breasts.\n\n", false);
            this.outputText("\"<i>And I in turn, will have to retrieve those.</i>\" He growls low.\n\n", false);
        ...
        friskSqueezeChoice() {
            this.outputText("", true);
            this.outputText("Vicious and eager to teach him some humility, you dig into the tender package and squeeze hard enough to drive the sharp edges of your pendant into Raphael's jewels. The fox immediately grabs you by the wrist, but this is one trap he isn't wriggling out of. You drive him to his knees while he lets out a high pitched, muffled squeal replete with a blank, agonized expression on his face.\n\n", false);
            this.outputText("\"<i>You have some balls stealing from me fox.</i>\" You comment and grin. \"<i>Just checking. Is that too soft or should I squeeze harder?</i>\"\n\n", false);
            this.outputText("Raphael shakes his head while a tear wells up in his eyes. When you roll his privates into the sharp edges, he finally lets out a cry loud enough to hear from miles away.\n\n", false);
            this.outputText("You chuckle and look around you to see if anyone heard. When you look back to see him squirming between your fingers however, all you're holding onto is the ruby pendant. Raphael has pulled off an amazing switching trick and has escaped. Instead, he stands on top the wall panting and defiant.\n\n", false);
            this.outputText("\"<i>I'll be sure to repay the favor.</i>\" He warns you with a high pitched voice while clasping his poor genitals. \"<i>Nobody touches my goods like that and gets away with it.</i>\"\n\n", false);
            this.outputText("He raises just a single finger to the air and groans painfully. \"<i>We will meet again!</i>\"\n\n", false);
            //{Game removal}
            this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] = 14;
            this.flags[kFLAGS_1.kFLAGS.REJECTED_RAPHAEL] = 1;
            this.doNext(this.playerMenu);
        ...
        RaphaelPicnicII() {
            this.outputText("", true);
            this.outputText("You clear your throat and look at the fox knowingly. A look only returned to him by a coy smile of innocence, while he pours you another glass. You'll indulge him for now...\n\n", false);
        ...
        RaphaelPicnicEnd() {
            this.outputText("", true);
            this.outputText("The fox is a thief of more than just gems. The concept of time vanishes around him and before you know it, his antics have entertained you for nearly the entire early morning. Raphael is an amazing time sink. You notice how late it is by way of more light peeking in over the forest's treeline. You should return to the portal. It's not difficult to part with the fox however. Only now do you notice how much more anxious and guarded he has become with the increase in light, frequently looking over his shoulder. When you tell him you should be going, the young man smiles, relieved.\n\n", false);
            this.outputText("\"<i>Are you sure, señorita? In your presence, I would gladly spend an eternity.</i>\"\n\n", false);
            this.outputText("You know he's just keeping up appearances and making you feel welcome, however. When you smile and assure him that you must be getting back, Raphael declares his regret one more time before literally scrambling to get away from the meadow, hastily cleaning up the picnic. He doesn't even bother to put things back in the basket. He just takes the four corners of the blanket and folds it into a bag slung over the shoulder. A bit perturbed, you look after him as he slips into the treeline.\n\n", false);
            this.outputText("However, just before he vanishes, the fox gives you a wink and a bow. \"<i>My Lady, it has been a true delight, and it would be to my great fortune if you'd allow me to see you again.</i>\"\n\n", false);
            this.outputText("He seems so hasty that you'd begin to question it, but your doubt is taken away as the fox takes the time to stare patiently at you from the forest's edge. \"<i>How could I resist, when you're dressed and made so gorgeously?</i>\" He smiles, referring to your elegant red suit.\n\n", false);
            if (this.flags[kFLAGS_1.kFLAGS.FUCK_OFF_THEIVING_RAPHAEL] == 0) {
                this.outputText("A minute of silence follows and just when it has been long enough to reassure you, he throws you something and slips away and vanishes.\n\n", false);
                this.outputText("You catch the object: he has returned the priceless ruby pendant. You recollect yourself and head back to camp.", false);
            }
            else {
                this.flags[kFLAGS_1.kFLAGS.FUCK_OFF_THEIVING_RAPHAEL] = 0;
                this.outputText("A minute of silence follows and just when it has been long enough to reassure you, he makes his excuses and sets about heading back to... whatever it is the sly fox spends his days doing.\n\n", false);
        ...
        fenceOfferChangeToDiscuss() {
            this.outputText("You blush, intimidated, and change the subject.\n\n", true);
        ...
        fenceRaphaelSexilyPtII() {
            this.outputText("", true);
            this.outputText("You're a little embarrassed at how easily the fox outdid you.  When you look up and stare him in the eyes however, Raphael is possessing of fantastic sportsmanship.\n\n", false);
            this.outputText("<i>\"My lady,\"</i> the fox states delicately, <i>\"that was truly magnificent.  You are a natural, I can tell.\"</i>\n\n", false);
            this.outputText("You stammer and are not so sure of that yourself, but the confidence carried in his voice quiets all self-doubt.  Maybe you were good.  Perhaps you could have beaten him in any other way, but just not yet with his weapon of choice.\n\n", false);
            this.outputText("<i>\"If your opponent had been any other person than me, then surely they would have succumbed to the sheer ferocity and fidelity of your offence.\"</i>  He nods reassuringly and smiles at you.  <i>\"In fact, I think this might be the last of our lessons; you are now good enough to develop your style without me.  There are no more I can think of...\"</i> He pauses, then the fox turns the leather tip towards you and brushes up against you.  <i>\"...with the exception of perhaps one.\"</i>\n\n", false);
            this.outputText("You ask him anxiously what that lesson could be.\n\n", false);
            this.outputText("<i>\"Well, it just so happens that your opponent was indeed none other than I.  And faced with such unfair odds...\"</i> the fox growls, <i>\"... this would be the perfect opportunity to show you what losing is like against such opposition.\"</i>\n\n", false);
            this.outputText("You look up and ask him what he means, but the fox's friendly smile is ever-present as he taps you with his sheathed sword.  You fall silent when first he gently nudges it into your ribcage like scoring another few hits.  When he brushes it in circles across your left breast however, it sends a shiver down your spine.  From there he drags it slowly down your body, from rib to rib, past your stomach, until he does no less than slide the sheath all the way between your legs.  Raphael has touched you many times before, but now his predatory smile does not change when he lifts the length into the folds of your " + this.vaginaDescript(0) + ".  As he stares you down, you realize this has been the most unambiguous gesture yet.  Looking into his deep, emerald eyes sparkling with crafty cunning, you feel how your very essence is held aloft upon his desires.  The ground moves out from under your feet as the sheath digs deeply into your labia.\n\n", false);
            //{If PC has also reached the intelligence Apex}
            if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 4) {
                this.outputText("By now, you've grown wise enough to know of his ways.  You spent enough time sitting with him around the picnic blanket to resist his wiles... when you want to.  You hold your breath as the rogue closes in on you, putting his face close to yours.  He growls softly at you and you moan back at him, but only after allowing yourself to do so.\n\n", false);
            ...
            if (this.player.inte > 49) {
                ...
                this.outputText("<i>\"I have never met a woman with your skills in the rapier,\"</i> he sighs at you.  <i>\"My lady, I must have you.  It would only be right.\"</i>\n\n", false);
                this.outputText("<i>\"Oh my, are you soliciting me, mister fox?  Right here in the wilds, crudely upon the moss?\"</i> you tease coyly.  <i>\"Wouldn't that mean I lose the game?\"</i>\n\n", false);
                this.outputText("<i>\"Some games are meant to be lost.\"</i>  He nuzzles you, putting his snout to your ear.  <i>\"It will be... exquisite. Lose yourself, in my capable hands.\"</i>", false);
        ...
        postRaphaelCoitus() {
            this.outputText("", true);
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00149] = 1;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_RAPIER_TRANING] == 4) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 4) {
                ...
                this.player.createPerk(PerkLib_1.PerkLib.Misdirection, 0, 0, 0, 0);
            }
            this.outputText("You return to camp, having cleaned up the picnic and taking the rations that were left with you.  You can't help but wonder if you'll ever see him again though.\n\n", false);
        ...
        declinePuttingOutForRogues() {
            this.outputText("", true);
            this.outputText("<i>\"No.\"</i> You shake your head, dropping the atonal monosyllable as if it were the last note in a musical play.\n\n", false);
            this.outputText("The horny fox frowns.  It's like raising an invincible shield between you.  He reaches out towards your face and body, but he cannot touch anymore.\n\n", false);
            this.outputText("Some of the magic of the moment is still there in the fine young man leaning over your aroused body.  He could still take you right there and right now and you know you'd probably enjoy it too.  However, it would be unseemly.  It would be to rape an equal and to Raphael, that would deprive him too of the dignity he tries so hard to maintain.  You can tell it from his face; the agonized quandary.\n\n", false);
            this.outputText("When he gets off your body, you've won.  You've caught Raphael in his own game.  You've led him around.  He'd probably do anything for it, but cannot obtain it.\n\n", false);
            this.outputText("<i>\"Fine,\"</i> he mumbles.  He rolls off and sits sulking a few paces away from you.  It's the first time the young man fails to keep a cheerful attitude.\n\n", false);
            this.outputText("You smile, a bit sorry for the way you broke him, but you try to convince him that he shouldn't mope.  The two of you had fun.  It's getting late and you occupy yourself with cleaning up the picnic.\n\n", false);
            this.outputText("After a small while, the fox finally speaks.  <i>\"It seems like there isn't anything more I can teach you,\"</i> the fox claims.  <i>\"... I'm proud of you, my greatest student.\"</i>\n\n", false);
            this.outputText("You turn around to smile at him.  However, Raphael has vanished.\n\n", false);
            //({When player had reached the SPE fencing apex}
            if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_RAPIER_TRANING] == 4) {
                this.outputText("The only thing left behind is his rapier, sticking out of the moss. He's bound it with his red sash around the length like a ribbon, like he has now gifted it to you. Perhaps it is his way of congratulating you.\n\n", false);
                //[Weapon: Rapier. Speed, instead of strength, influences the damage rating. Never as strong as the heavier weapons or sword, but works great with speed & evasion, encouraged by the rapier.])
                this.inventory.takeItem(this.weapons.RRAPIER, this.playerMenu);
            }
            //({When player has reached the INT Conversation apex}
            if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 4) {
                this.outputText("You realize he's left you with more than just pleasant memories of sitting with him around the picnic, though. Realizing how skillfully you declined him and how deftly you led him around, you realize you may have mastered his art of keeping another's attention and leading them around with cunning and acting. This misdirection could have great applications in battle.\n\n", false);
                //[Optional Perk: Misdirection. Intelligence adds to the chance to evade. Turns you into a true rogue together with the bodysuit.])
                this.player.createPerk(PerkLib_1.PerkLib.Misdirection, 0, 0, 0, 0);
            }
            this.outputText("You return to camp, having cleaned up the picnic and taking the rations that were left with you.  You can't help but wonder if you'll ever see him again.\n\n", false);
            //[Removes Raph from the game. 7 days later, the Quicksilver scene plays out.]
            this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] = 7;
            this.flags[kFLAGS_1.kFLAGS.REJECTED_RAPHAEL] = 1;
        ...
        RaphaelPicnicChooseThieving(newl = true) {
            ...
            if (this.player.inte < 30 || this.flags[kFLAGS_1.kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 0) {
        ...
        thieveryEnding() {
            ...
            this.outputText("A brooch that can only be described as priceless decorates the soft silk sash.  ", false);
            //({When player has not reached the apex of fencing lessons/Optional: and also has less than 60 speed}
            if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_RAPIER_TRANING] != 4)
                this.outputText("You try to reach for the magnificent ornament hanging off his hips, but as the fox continues to move, you lack the nimbleness to remove it.\n\n", false);
            //({When player has also reached the apex of fencing lessons
            else
                this.outputText("You reach and fondle the magnificent ornament hanging off his hips. With a few nimble flicks of your fingers, you manage to get it off.\n\n", false);
            this.outputText("Realizing you've allowed yourself to be distracted, you refocus.  Raphael has his paws on your breasts and is about to kiss the top of them.  Throwing him off, you sigh, brush his hands away while raising your own towards your head.  Like this, you stretch out your upper body across the moss, and cross your hands to signify helplessness.  It presents your " + this.breastDescript(0) + " even more invitingly, but you've elegantly dispersed his efforts.  To touch them again on such short notice would be to flaw his otherwise refined lovemaking.  Instead, the fox crawls in over you completely on hands and knees and looks you in the eyes.  He realizes you're still very much in the game and to take you roughly on the moss instead of sweeping you off your feet would be a thing unbecoming of the refined fox.  He needs your consent to win the game.\n\n", false);
            this.outputText("You're enjoying yourself and so is Raphael, for as long as you keep the illusion up he might manage to woo his way into your pants.  He's so fragile right now.  You're almost literally holding the horny fox's desires and pride in the palm of your hand.  You are in complete control.\n\n", false);
            this.outputText("<i>\"I have never before met a woman of your breathtaking insight.  Of such deep beauty.\"</i>  He sighs at you.  <i>\"My lady, I must have you,\"</i> he burrs.\n\n", false);
            this.outputText("<i>\"Oh my, are you soliciting me, mister fox? Right here in the wilds, crudely upon the moss?\"</i> you answer coyly.  <i>\"Wouldn't that mean I lose the game?\"</i>\n\n", false);
        ...
        RaphaelThieverySmex() {
            this.outputText("", true);
            this.outputText("You need no words.  You place your hand on the back of Raphael's neck and pull his lisping tongue closer to your ears.  After that, you lose yourself to the weight of a man atop you as the fox starts tending to your quivering body.\n\n", false);
            this.outputText("Finally the fragile tension between you breaks.  Raphael undoes your zipper and roughly pulls your bodysuit down, revealing your " + this.allBreastsDescript() + ". You're stunned; the fine, abrasive texture of his nimble fingers' pads run in eager circles across your sensitive neck, from whence moans have begun to flow. His soft fur brushes across your body as the fox moves downwards.  Gingerly, he puts his maw down on your right breast and suckles once, but in the span of an agonizingly long time.  The " + this.nippleDescript(0) + " is sucked into his toothy mouth, which he puts down on the nub carefully.  The little points scrape by sensually, before your nipple slips through them.\n\n", false);
            this.outputText("You gasp when he spreads your legs by placing his in between and parting them. When he fondles you down there, fingers rubbing into your flushed  " + this.vaginaDescript(0) + ", you suddenly feel the wind passing through the hot bare inners of your parted folds.  Raphael has opened the silken opening of your suit. It shouldn't come as a shock.  He gifted them after all, perhaps planning for it all along.  Another surprise follows as you can feel something hot and rigid standing off his body and lying on top of yours. Raphael's vulpine cock is resting in the hollow of your bellybutton, through the fly of his pants.  The bright red, smooth tip rides up your tummy admiringly.  It lacks the mushroom shaped dome that human men have and instead, his cock is pointed and tapered, much like the weapons he prefers.  You can also feel a subtle, but noticeable canine bulb at the base, throbbing against your sensitive loins.\n\n", false);
            this.outputText("When he finally lowers himself, positioning himself in front of your opening, you've already welcomed it.  In the time it took him, the wind's soft breeze has passed through and licked by your exposed cunt for long enough.  By now you long to get penetrated by something more substantial and indeed your wish is granted.  When you feel the tip of Raphael's foxy cock trail down your furrow, it hits the spot and he takes your moist opening in a single inward incursion.  ", false);
            this.player.cuntChange(12, true);
            this.outputText("After that he slowly begins to oscillate into you.  You're turned into a wreck as you hold on for dear life, feeling the russet rogue enter you repeatedly.  His paws grope your tits and pester the " + this.nippleDescript(0) + "s by twirling his abrasive hands around them.  With a knowing look upwards, he has also begun to nibble down on your shoulders with his sharp teeth, giving you little lovebites across your neck that make you gasp.  Your body has long since buckled under his luscious fur thanks to the repeated bumps against your g-spot.  Raphael does not have an impressive girth, but he uses it well in rapid plunges into your yielding loins. He often changes his angle, until not an inch of your loosening walls have been deprived of a pleasurable inner indentation, as he brushes into your walls with deep lunges.\n\n", false);
            this.outputText("Finally, you can bear it no more.  Your body convulses limply below him, the fox still jamming himself in with consistent rhythm.  You raise your legs and clamp him around his hips as Raphael keeps up the motion, rocking into you like a voracious predator.  Only after you howl and pump your hips to the involuntary rhythm of orgasm does Raphael allow you a breather by sitting up, but his penis is still locked into your " + this.vaginaDescript(0) + ". Little do you guess that it does not end there.\n\n", false);
            this.outputText("With a victorious glint, the fox takes the sash from his hips and, tying either end around your knees, brings your legs towards your chest. He holds them there without any effort on the part of either of you, by putting his chest down on the cloth tied between them and mounting you again, lying on top of you. More deep thrusts follow, this time deep enough for the tip to titilate even your cervix, while the slender knot at his base parts the sensitive entrance a little wider with every bottoming bump into you.\n\n", false);
        ...
        RaphaelThieverySmexPtII() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RAPHAEL_INTELLIGENCE_TRAINING] == 4) {
                ...
                //[Optional Perk: Misdirection. Intelligence adds to the chance to evade. Turns you into a true rogue together with the bodysuit.])
                this.player.createPerk(PerkLib_1.PerkLib.Misdirection, 0, 0, 0, 0);
                this.outputText("(Gained Perk: Misdirection!)\n\n");
            }
            this.outputText("You return to camp, having cleaned up the picnic and taking the rations that were left with you. You can't help but wonder if you'll ever see him again though.", false);
        ...
        quiksilverFawkesEndGame() {
            this.outputText("", true);
            this.outputText("You wake up to the sound of an ominous cry in the distance, like that of a howling wolf.  It can only mean trouble and you jump out of bed.\n\n", false);
            this.outputText("It is an eerily misty morning outside, with banks of fog covering your campsite.  It only makes the second howl more haunting as the danger appears to draw closer to camp.  You stand still and prepare yourself to face this menace, peering into the fog.  When a shadow creeps closer, you prime for combat.  However, its posture suggests it is weary and tired, slumping against a tree. When it struggles forward, it almost comes falling out of the curtaining mist.  It is only then that you notice the redness of its fur and the fineness of its clothes.  It is the fox and russet rogue, Raphael!\n\n", false);
            this.outputText("<i>\"Please, you must help me!\"</i> he begs of you.  <i>\"They're trying to frame me!  I'm innocent!\"</i>\n\n", false);
            //({If player rejected him earlier}
            if (this.flags[kFLAGS_1.kFLAGS.REJECTED_RAPHAEL] == 1) {
                this.outputText("You're immediately confused and you ask him what's going on, but the fox is out of breath.  What's more, a similar howl now calls out from the opposite direction too!  Whatever these sounds are or this fog is, they have the camp surrounded!\n\n", false);
            }
            //({If player had an INT or SPE ending with him earlier}
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00149] == 1) {
                this.outputText("You're a bit miffed at the fox.  You haven't heard from him for more than a week after he slept with you, and now he only shows up because he's looking for help.  The fox however, is out of breath.  What's more; a similar howl now calls out from the opposite direction too!  Whatever these sounds are or this fog is, they have the camp surrounded!\n\n", false);
            }
            this.outputText("<i>\"They hound me night and day!  I can't outrun them any longer!\"</i> he wheezes.  <i>\"Please!  You don't know what they'll do to me when they catch me!\"</i>\n\n", false);
            this.outputText("You don't have the chance to respond before the sounds of snapping branches and rustling leaves near camp.  Raphael jumps up and dives into the barrel you keep in camp for the storage of water, hiding himself and leaving you to face the oncoming threats by yourself.\n\n", false);
            this.outputText("In the hazy distance, you spot a massive shadow rushing through the mist and it dissapears before you get a good look.  An eerie silence follows and you sharpen your eyes and hearing to the danger.  When you look up, your heart sinks as the massive shape has jumped up and now descends on you from above.  It happens so fast that you barely realize what's going on.  Before you know it, you're sent sliding across the floor with the dark shape on top of you, pinning you down to the ground with its weight.\n\n", false);
            this.outputText("<i>\"Smelled of elderberries, huh?\"</i> it snarls.  <i>\"And what was that about my mother?\"</i> When you open your eyes again, you're greeted by a row of razor-sharp white teeth, set in a pitch-black face. Above them, two smoldering yellow eyes stare down on you, infuriated.\n\n", false);
            this.outputText("<i>\"Hati!\"</i> an identical voice calls out from elsewhere.\n\n", false);
            this.outputText("Suddenly, the teeth above you vanish and the eyes grow soft and surprised.  <i>\"Oh!\"</i> the shadow exclaims, its expression apologetic and startled.\n\n", false);
        ...
        QuiksilverFawkesPtII() {
            ...
            this.outputText("You jump up when one of them nudges his nose into your ass and sniffs you.\n\n", false);
            this.outputText("<i>\"Hati,\"</i> the other one comments again.  <i>\"Manners.\"</i> Standing upright with arms crossed instead of his nose to the ground, the wolf strikes an imposing figure.  They're actually quite tall, with their rippling chests proudly presented above toned abs and narrow hips that run smoothly through to their legs.  Despite that, they also have a reliable, trustworthy quality to their predatory features.  Their furs look warm and regal.  The one now looking down on you seems very patient and polite for such a wild creature.\n\n", false);
            this.outputText("<i>\"Tel'Adre law enforcement, ma'am.  Special Division.  Outer wall Task Force,\"</i> he announces while the other wolf circles camp.  <i>\"I am Frank 'Skoll' Holmes and this is my partner, Joe 'Hati' Watson.  We're the 'Quicksilver' brothers, also known as the 'Boys from Baskerville' by the locals.\"</i>  Skoll achieves this introduction with a soft voice that barks and growls itself through the words. You nod, still a bit taken aback.\n\n", false);
            this.outputText("<i>\"We're tracking down a fugitive, a red fox.  Urta's orders,\"</i> he explains.  <i>\"Goes by the name of Raphael. Raphael Fagin Soleil. Don't suppose you've seen him?\"</i>  He stares at you with inquisitive yellow eyes beneath broad brows that give him a permanent serious frown.\n\n", false);
            this.outputText("When you ask him what crimes Raphael has committed, the wolf shakes his head.  <i>\"Debauchery.\"</i>  You raise one eyebrow, surprised that debauchery could be a crime in a place like Mareth.\n\n", false);
            this.outputText("<i>\"Must have gone on a real romp, that one,\"</i> you quip.\n\n", false);
            this.outputText("Skoll responds, amused.  <i>\"We need to set standards for ourselves and he crossed them.  It's how we separate ourselves from the demons.  Petty theft, highway robbery, and breaking and entering are counted amongst his other crimes.  Not that their severity should matter to the course of our investigation.\"</i>\n\n", false);
            //({If player removed him earlier}
            if (this.flags[kFLAGS_1.kFLAGS.REJECTED_RAPHAEL] == 1)
                this.outputText("<i>\"I can smell traces of him,\"</i> Hati states, nearing the waterbarrel, <i>\"but it's hard to tell.  There're too many other scents here.\"</i>\n\n", false);
            //Played around/special ending
            else
                this.outputText("Hati breaks into the conversation.  <i>\"She must know.  The entire camp reeks of him. She has his scent on her.  I can smell strong trails leading towards a nearby meadow.  A bit stale.  Might have been a while ago.\"</i>  He nears the water barrel.  <i>\"...but it's hard to tell. There's too many other scents here.\"</i>\n\n", false);
            this.outputText("Your heart jumps as Hati manages to discover a pile of Raphael's clothes, near the barrel.  It's irrefutable proof.  Raphael must have put them there to throw the wolves off.  Hati gives you a look of dissapointment.  <i>\"He's nude. They must have slept together.\"</i>", false);
            //({If player is wearing red bodysuit}
            if (this.player.armorName == "red, high-society bodysuit")
                this.outputText("  Suddenly, his eyes and ears perk.  <i>\"Isn't that the stolen clothing of the widow Camembert that she's wearing? You know, before she mysteriously dropped the charges after a nightly visit from the fox? Should we confiscate it anyway?\"</i>", false);
            this.outputText("\n\n", false);
            this.outputText("<i>\"Come now, Hati. No need to concern ourselves with that,\"</i> Skoll reproves.  <i>\"I'm sure we can rely on our upstanding citizens not to actively harbor a criminal.\"</i>  He looms in over you.\n\n", false);
            this.outputText("The knowledge that you're not technically a citizen does nothing to alleviate the most intimidating sensation of the large wolf standing in so close to you.  He smells of the night.  However, when you look him in his eyes, intimidation does not seem to be Skoll's intent.  Instead, he has a compassionate look in his eyes, enriched with years of wisdom.  He's trying to appeal to your moral sense.  <i>\"We know of the fox's ways.  We'd understand if he might have appeared dashing and handsome at first.\"</i>  He leers deeply into your soul.  <i>\"Now, I must ask again. Have you seen him?\"</i>\n\n", false);
            this.outputText("You glance at your waterbarrel.  Hati is keeping an obsessive watch over the water's surface, like he's already closed in on the fox.\n\n", false);
        ...
        coverForRaphael() {
            this.outputText("", true);
            this.outputText("You stare back into the wolf's yellow eyes, keep a stiff back and answer him.  <i>\"I'm not seeing him right now.\"</i>\n\n", false);
            //({Player corruption below 30}
            if (this.player.cor < 30)
                this.outputText("You instantly feel bad for lying to the wolf. More so because he doesn't get troubled, disappointed or vexed.  He seems to instantly believe you... or at least, he wants to believe you, even though being a detective probably keeps him cynical.  You'll only be adding to that cynicism if he discovers your lie.\n\n", false);
            this.outputText("<i>\"Cute answer,\"</i> his partner remarks, taking a break from staring at the water barrel.\n\n", false);
            this.outputText("Your hair stands upright when he leans back in over the barrel and appears to look down into the water, but you struggle not to slake a sigh of relief when he merely starts drinking from it instead.  A few long laps with his tongue and the wolf is sent cringing and shaking his head at the taste.  <i>\"Even the water tastes of him.\"</i>\n\n", false);
            this.outputText("<i>\"Hati, enough!\"</i> The wolf in front of you turns his head, throws back his cuneate ears and snarls at his partner.  <i>\"We're not in the habit of throwing around accusations without material proof.\"</i>  His anger starts to decrease. <i>\"Don't help Raphael turn us into the bad guys.\"</i>  Skoll turns back to you with just as much friendly patience as ever.  <i>\"I'm sure she would have told us if she knew anything about that.\"</i>", false);
            //({If cor is below 30}
            if (this.player.cor < 30)
                this.outputText("  You slowly shake your head, tortured by the trusting twinkle in the wolf's soft yellow eyes.", false);
            this.outputText("\n\n", false);
            this.outputText("<i>\"The trail is strongest over towards the meadows.  He might have gone there.\"</i> Hati remarks after circling your camp one more time.\n\n", false);
            this.outputText("<i>\"I hope you will let us know when you see him again...\"</i>  Skoll nods at you, his feral features pulling away from you.\n\n", false);
        ...
        coverForRaphaelII() {
            this.outputText("", true);
            this.outputText("It doesn't take more than a minute for Raphael to make use of the wolves' departure.  Not even bothering to climb out with dignity, he tips the barrel over as he rushes out of the water.  Like a drowned cat, he climbs out coughing and gasping for air on all fours.\n\n", false);
            this.outputText("He hasn't lost his ways however.  The first words out of him are as suave and composed as ever.\n\n", false);
            this.outputText("<i>\"Merci, mademoiselle,\"</i> he wheezes softly.  <i>\"You have whisked me away from the snatches of great injustice, as well as a fair share of humiliation.  Normally I am capable of outrunning them myself, but it seems that faith has blessed me with a guardian angel on the day I find myself less capable.\"</i>\n\n", false);
            this.outputText("You're upset towards him for asking you to lie to law enforcement, but Raphael's current state keeps you from being too furious.  He's not so bushy anymore.  His soaked hair falls flat against his body and causes him to lose quite a bit of his imposing physique. Strands of it run across his face. You spend a little time yelling at him, though.\n\n", false);
            this.outputText("<i>\"No.  It is nothing like that,\"</i> he splutters, in response to one of your rants.  <i>\"We go way back.  The wolves and Urta, they carry out a personal vendatta against me that has no bearing on the law.\"</i>\n\n", false);
            this.outputText("You spend some time considering the dubiosity of this revelation.\n\n", false);
            this.outputText("<i>\"Please, señorita.\"</i>  He manages to rise to one knee.  <i>\"Is this the face of a hardened criminal?\"</i>  He looks up and into your eyes with his own brilliant green ones.  He's still a mess, hair disheveled and his features weather-beaten, but he'll dry up again eventually, to be dashing once again.  <i>\"Since when have I treated you anything less than courteously?  A handful of gems, certainly, yes, but do I deserve such police brutality because of that?  Do I deserve to be hunted down in the forests and carried through the streets in chains?  Just because my antics leave the world with a smile?\"</i>\n\n", false);
            this.outputText("Before you manage to answer him, Raphael rushes back to his usual spot on the small crumbled wall on the outskirts of the camp proper.  Not as quick as previously, tired and weary perhaps, but still quite fast.  He doesn't seem so intimidating without his clothes on.  Knowing shame, unlike the wolves, the young man even covers his privates with a leg bent sideways.\n\n", false);
            this.outputText("<i>\"Mademoiselle, this day, I owe you a great boon.  The russet rogue never forgets a debt.  Visit Tel'Adre after things die down and look for the orphanage.  You will be welcomed like a queen! Ah-ha!\"</i> he exclaims, before hopping down the wall.\n\n", false);
            ...
            //Concludify things
            this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] = -2;
            this.doNext(this.playerMenu);
        }
        //{PC chooses to betray Raphael}
        betrayRaphael() {
            this.outputText("", true);
            this.outputText("<i>\"The barrel,\"</i> you admit, the answer slipping from your lips in face of the wolf.\n\n", false);
            this.outputText("Skoll, careful not to bare teeth, curls the corners of his lips and smiles at you.  <i>\"Thank you.\"</i>  He whispers a low growl and his eyes sparkle at you.  <i>\"I realize that might have been hard to do, but we will remember.\"</i>  Leaving you with that promise, he joins the other wolf in staring at the waterbarrel.  You feel guilty, but it's compensated by the feeling you might have gained two allies.\n\n", false);
            this.outputText("The two twins look at each other, then grin playfully.  One of them leans in over the barrel and puts his head directly over the water's surface, peering down.\n\n", false);
            this.outputText("Suddenly, Raphael bursts from the water, no doubt in an effort to escape.  The wolves will have none of it.  One of them puts his paw on the head of the resurfaced fox and pushes him back into the water with just as much force.  Meanwhile, the other wolf fetches the lid and slides it onto the drum. Just before they close the barrel shut, they tip it over to discard the water. By now, Raphael is already banging on the wall from the inside, but his cries are muffled and weary.\n\n", false);
            this.outputText("<i>\"Tell it to Urta and the judge,\"</i> one of the wolves announces loudly, causing the other to chuckle.  <i>\"You have the right to remain silent. Anything you say will make us hold something against you, not necessarily in the court of law.\"</i> Sullenly, Raphael quiets down inside the sealed barrel.\n\n", false);
            this.outputText("Effortlessly, one of the wolves lifts the barrel up onto his shoulder.  Before he carries it off, he throws one more look backwards and beams at you. <i>\"Check in with Urta.  She will reimburse you for the barrel, along with rewarding you with the outstanding bounty on our foxy friend.  Visit even later than that and you might even be allowed to enjoy his sentence.\"</i>\n\n", false);
            this.outputText("The other spends a little longer regarding you, wagging his tail playfully and smiling a friendly smile at you.  He then looks back and sees his brother heading in the wrong way.  <i>\"We're not heading back to Tel'Adre right away?\"</i>  His voice is almost as low as his brother's.\n\n", false);
            this.outputText("<i>\"We caught him in record time,\"</i> Skoll remarks.  <i>\"I'm sure Urta won't mind it if we keep him for ourselves for just a day.  You know... collect evidence... interrogate the culprit...\"</i>  His voice is carried off by the mist.\n\n", false);
            this.outputText("Hati throws you one more amicable glance before turning, getting on all fours, and running off.\n\n", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] = -1;
            //1k gems?
            this.doNext(this.playerMenu);
        }
        //Intro
        orphanageIntro() {
            ...
            if (this.RaphaelLikes()) {
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_ORPHANAGED_WITH_RAPHAEL] == 0) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.TIMES_ORPHANAGED_WITH_RAPHAEL]++;
                }
        ...
        raphaelIntroPageTwo() {
            this.clearOutput();
            this.outputText("\"<i>This place isn't really an orphanage, is it?</i>\" you ascertain sagely, still waiting for a reply.");
        ...
        cunnilingusWithRaphael() {
            ...
            this.outputText("\n\nWith his paws, Raphael raises up your butt and crotch just a few inches into the air, as if elevating it for a special occasion.  It encourages you to bend your knees and spread your legs, opening yourself up and presenting your womanhood fully.  Lacking all shame and still looking you into the eyes, the fox then does the lewdest thing.  Maintaining eye contact and without blinking, he rolls out his long red tongue and brushes it against your " + this.vaginaDescript(0) + ".  The sensation of the bawdy rough thing lapping up your sensitive gash's gathered dew takes you completely by surprise and you let your head fall back and moan.  It feels like he's worshipping you by lapping through the trembling fruit.  At the very zenith of his lashes, he takes extra time to twirl around your " + this.clitDescript() + " in a vortex of swirling tastebuds.");
            ...
            if (this.player.wetness() < 3)
                this.outputText("your cunt fluttering");
            //({Medium wetness multiplier}
            else if (this.player.wetness() < 4)
                this.outputText("sending out a small spurt of femcum landing on your belly");
            //({High wetness multiplier}
            else
                this.outputText("gushing a torrent of femcum into the air");
        ...
        girlOnTopOfRedFoxesOhMy() {
            ...
            this.outputText("\n\nYou swipe the condom out of the fox's hand and waste no time applying it.  In fact, you manage to do a good job of giving it a sensual part within your lovemaking, which makes you feel all smart.  Between spread legs and right in front of your " + this.vaginaDescript(0) + ", you lay it in within your hand and slowly roll your fist across his cock; giving him a taste of what is to come.  Raphael gasps softly at the sight as you do it. The condom fogs up instantly around his muzzled red bone.");
