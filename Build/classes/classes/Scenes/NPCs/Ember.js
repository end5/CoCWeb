define(["require", "exports", "../../Monster", "../../StatusAffects", "../../PerkLib", "../../GlobalFlags/kFLAGS", "../../CockTypesEnum", "../../../../includes/appearanceDefs", "../../Appearance"], function (require, exports, Monster_1, StatusAffects_1, PerkLib_1, kFLAGS_1, CockTypesEnum_1, appearanceDefs_1, Appearance_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Ember extends Monster_1.Monster {
        emberMF(male, female) {
        ...
        emberAttack() {
            ...
            //Blind dodge change
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Blind) >= 0 && Ember.rand(2) == 0) {
            ...
            //Miss/dodge
                ...
                this.outputText("You dodge aside at the last second and Ember's claws whistle past you.");
            else {
                var damage = Math.floor((this.str + this.weaponAttack) - Ember.rand(this.player.tou) - this.player.armorDef);
                if (damage <= 0)
        ...
        embersSupahSpecialDragonBreath() {
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Blind) >= 0 && Ember.rand(2) == 0) {
                //Blind Ember: 
                ...
                if (this.combatMiss() || this.combatEvade() || this.combatFlexibility() || this.combatMisdirect())
                    this.outputText("  It's a narrow thing, but you manage to throw yourself aside at the last moment.  Fortunately, the energy whirling around and tearing up the soil blinds Ember to your escape until you have recovered and are ready to keep fighting.");
                else {
        ...
        emberTailSlap() {
            ...
            if (this.combatMiss() || this.combatEvade() || this.combatFlexibility() || this.combatMisdirect() || Ember.rand(2) == 0) {
                this.outputText("  You ");
                if (Ember.rand(2) == 0)
                    this.outputText("duck under");
                else
                    this.outputText("leap over");
                ...
                var damage = Math.floor((this.str + this.weaponAttack + 100) - Ember.rand(this.player.tou) - this.player.armorDef);
        ...
        dragonFarce() {
            ...
            this.createStatusAffect(StatusAffects_1.StatusAffects.StunCooldown, 4, 0, 0, 0);
            var damage = 10 + Ember.rand(10);
            damage = this.player.takeDamage(damage);
            this.outputText(" (" + damage + ")");
            this.combatRoundOver();
        }
        performCombatAction() {
            ...
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.StunCooldown) >= 0) {
                this.addStatusValue(StatusAffects_1.StatusAffects.StunCooldown, 1, -1);
                if (this.statusAffectv1(StatusAffects_1.StatusAffects.StunCooldown) <= 0)
                    this.removeStatusAffect(StatusAffects_1.StatusAffects.StunCooldown);
            }
        ...
        defeated(hpVictory) {
            ...
            if (hpVictory)
                this.game.emberScene.beatEmberSpar();
            else
                this.emberReactsToLustiness();
        }
        ...
        constructor() {
            ...
            // this.plural = false;
            var gender = this.game.flags[kFLAGS_1.kFLAGS.EMBER_GENDER];
            if (gender == 0) {
                this.pronoun1 = "she";
                this.pronoun2 = "her";
                this.pronoun3 = "her";
            ...
            if (gender == 1 || gender == 3) {
                this.createCock(16, 2, CockTypesEnum_1.CockTypesEnum.DRAGON);
                this.balls = 2;
                this.ballSize = 4;
            ...
            if (gender >= 2) {
                this.createVagina(this.game.flags[kFLAGS_1.kFLAGS.EMBER_PUSSY_FUCK_COUNT] == 0, appearanceDefs_1.VAGINA_WETNESS_SLAVERING, appearanceDefs_1.VAGINA_LOOSENESS_LOOSE);
                this.createBreastRow(Appearance_1.Appearance.breastCupInverse("F"));
            }
            else {
                this.createBreastRow(Appearance_1.Appearance.breastCupInverse("flat"));
            }
            ...
            this.initLibSensCor(50, 35, this.game.flags[kFLAGS_1.kFLAGS.EMBER_COR]);
            ...
            this.level = 15;
            this.gems = 0;
            this.hornType = appearanceDefs_1.HORNS_DRACONIC_X4_12_INCH_LONG;
            this.horns = 4;
            this.tailType = appearanceDefs_1.TAIL_TYPE_DRACONIC;
