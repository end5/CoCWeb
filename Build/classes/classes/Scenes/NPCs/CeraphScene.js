define(["require", "exports", "./NPCAwareContent", "../../GlobalFlags/kFLAGS", "../../../../includes/appearanceDefs", "../../StatusAffects", "../../PregnancyStore", "./Ceraph", "../../CockTypesEnum"], function (require, exports, NPCAwareContent_1, kFLAGS_1, appearanceDefs_1, StatusAffects_1, PregnancyStore_1, Ceraph_1, CockTypesEnum_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 03.01.14.
     */
    class CeraphScene extends NPCAwareContent_1.NPCAwareContent {
        //VARS
        ...
        maleFuckCeraphsPussy() {
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00291]++;
            this.spriteSelect(7);
            this.outputText("", true);
            //UBER-Fullbodypenetration
            if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR && this.player.biggestCockArea() > 500 && (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1 || this.monk >= 5)) {
            ...
            if (this.player.cockArea(0) <= this.monster.vaginalCapacity()) {
                ...
                if (this.monster.lust > 99) {
                    this.outputText("Ignoring her squeals of pleasure, you force Ceraph onto her back, oogling her perky breasts, indecent cock, and soaked cunt.  She looks up at you hungrily, and you have the feeling that on some level you're still giving her what she wants.  Mindful of her demonic wiles, you pull her hands together and use a few tattered strips of cloth to bind them over her head.  Moaning with helpless desire, the demon grinds her crotch against your " + this.player.leg() + ", spreading her thighs apart into a near split and giving you a world-class view of her juicy purple cunt.\n\n", false);
                }
                //[hp]
                else {
                    this.outputText("Ignoring her grunts of pain, you force Ceraph onto her back, oogling her perky breasts, limp cock, and hairless cunt.  She looks up at you with disdain, growling at you from the back of her throat.  Wary of the demon's abilities, you tie up her hands with a few tattered strips of cloth.  She seems to like it, judging by her tenting erection and now-glistening gash.  The slut even goes so far as to begin grinding her crotch against you, spreading her thighs wider and wider as she gets off on being restrained.  You're given a perfect view of her enticing purple cunt.\n\n", false);
                }
                this.outputText("Ceraph licks her lips and gazes up at you, begging with a voice that drips with seductive intent, \"<i>Please don't rape me, champion!  Don't tie me down and rape me like a helpless village-girl!</i>\"\n\n", false);
                if (this.player.cor < 33)
                    this.outputText("Her words shame you.  Have you really sunk this low?  You wonder just how much this world has already corrupted you as you ready yourself to rape a sex-demon.", false);
                else if (this.player.cor < 66)
                    this.outputText("Her words confuse you.  You never would've done this when you first came here, but you're horny and you know demons don't really mind.", false);
                else
                    this.outputText("Her dishonest words anger you, and you slap her in the face.  Both of you know that she wants this almost as much as she wanted to rape you, and any pretense at disliking this act is a deceitful sham.", false);
                this.outputText("  It's too late for her to have any hope of swaying you anyway.  You strip off your " + this.player.armorName + " ", false);
                ...
                this.outputText("your stiff " + this.multiCockDescriptLight() + ", preparing to penetrate her.\n\n", false);
                this.outputText("Ceraph squirms in the dirt as you bring your " + this.cockDescript(0) + " closer and closer to her female hole, her cock twitching with need like some kind of perverse, mutant clit.  Her hips twitch at you, as if eager to devour your maleness.  You don't keep her waiting, ", false);
                if (this.player.cockArea(0) < 40) {
                    this.outputText("and with a forceful thrust, you sheath yourself inside the demon's unholy pussy", false);
                }
                else
                    this.outputText("and with a mighty effort, you force your over-sized cock inside her.  For a moment all you can do is stare in awe as it distorts her body – the fact that such a thing is possible puzzles you", false);
                this.outputText(".  Her interior is inhumanly hot and covered with thousands of slippery protrusions, each rubbing against your dick's flesh.  The orgy of sensation is incredible, and you immediately begin fucking your bound, demonic captive as the need to orgasm rises within you.\n\n", false);
                this.outputText("The defeated omnibus mewls in mock protest, \"<i>Oh, don't cum in my demonic twat, dear champion!  If you do, you'll never want any other pussy ever again!</i>\"\n\n", false);
                this.outputText("You grunt, pounding her harder and faster than before, knowing you couldn't pull out of her vise-like pleasure-hole if you wanted to.  It feels too good to hold out or resist, and you drop down, adjusting your angle as you rape the beautiful omnibus.  You're grunting like an animal, humping her as fast as your body will let you, but she lies under you with a serene and enticing expression, as if she's greatly enjoying the situation and awaiting your orgasm.  You pinch her nipple roughly, irritated by her superior air, but it only makes her wriggling pussy get even wetter.  It clamps down on you, wringing your " + this.cockDescript(0) + " dry as it erupts in a powerful orgasm.\n\n", false);
                this.outputText("Ceraph squeals happily, her sultry visage fracturing into an uninhibited expression of pleasure as she cries, \"<i>Fill me with your seed, champion!  Dominate the demon with your mighty spear!</i>\"\n\n", false);
                this.outputText("Her purple-hued pussy spasms around you, its oddly textured interior rippling and sucking in time with your ejaculations, drinking down your cum.  Ceraph squirms happily while her body absorbs your jizz with her impossibly pleasurable hole.", false);
                if (this.player.cumQ() >= 500 && this.player.cumQ() < 1000)
                    this.outputText("  Her belly begins to rise with the volume of cum she's absorbed, and you finish your orgasm with a mildly pregnant demon underneath you.", false);
                else if (this.player.cumQ() >= 1000)
                    this.outputText("  Her belly rises quickly from the volume of cum you're pumping into her, swelling up until she looks ready to give birth, but her taut purple body seems to handle the strain quite well, save for her belly-button turning into an outtie with an abrupt 'pop'.", false);
                this.outputText("  The omnibus' nubby shaft twitches happily and squirts out tiny dribbles of demon-semen, too left out by the sex to achieve a truly enjoyable orgasm, but more than willing to leak cum.\n\n", false);
                this.outputText("Ceraph exhales with exhaustion and rubs her hands over her belly, cooing, \"<i>So, you really did give up all your semen to me.  I guess I'll have to name the first imp I birth from this after you, won't I?</i>\"\n\n", false);
                if (this.player.cor < 33)
                    this.outputText("You groan, just wishing she would stop reminding you of the consequences of this little tryst.  In a hurry to leave the demon behind, you get dressed and take off for camp.\n\n", false);
                else if (this.player.cor < 66)
                    this.outputText("You groan, wondering why she just won't get over her little act.  Even though this wasn't your best idea, it isn't nearly as bad as she makes it out to be.  You get dressed and leave, eager to be rid of her.\n\n", false);
                else
                    this.outputText("You bend over, rub her belly softly and whisper into her ear, \"<i>I'll be sure to spit him on my cock first chance I get, dear.</i>\"\n\n", false);
                this.outputText("As you leave, you don't bother to spare a glance at the confused omnibus.  She isn't worth your time.", false);
            }
            else {
                ...
                if (this.player.cockTotal() > 1)
                    this.outputText("each of ", false);
                this.outputText("your stiff " + this.multiCockDescriptLight() + ", preparing to penetrate her.\n\n", false);
                this.outputText("The " + this.player.cockHead() + " of your " + this.cockDescript(0) + " squishes flat against her twat, too big for her prodigious demon-cunt to swallow.  Spurred by frustrated desires, you lift her legs and wrap her girlcum-slicked thighs about your ", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("primary ", false);
                this.outputText(this.cockDescript(0) + ". Ceraph's smooth skin and soft thigh-flesh form a comfortably tight masturbation tube.  Starting slowly, you begin rocking back and forth, sawing your prodigious cock-flesh over her body.  The demoness swivels her hips underneath your " + this.cockDescript(0) + ", her slippery gash and near-crushed member feverishly rubbing into you.  Though you didn't get to truly violate her, her thighs and unblemished skin are more than good enough to bring you to the brink of orgasm.\n\n", false);
                this.outputText("The defeated omnibus wraps her arms around your " + this.cockDescript(0) + " and whines lustily, \"<i>No, please!  You'll cover me in seed and despoil my face!  Please don't glaze me in that awful stuff!</i>\"\n\n", false);
                this.outputText("You grunt, hold the captive by her ankles, and use her like a disposable sex-toy.  The slap of your " + this.hipDescript() + " slapping into her thighs echoes loudly, nearly drowning out the wet squishing of your " + this.cockDescript(0) + " with each violent brush against her cuntlips.  ", false);
                if (this.player.cocks[0].cockLength < 18)
                    this.outputText("Your " + this.player.cockHead() + " crests between her breasts with every stroke, bumping against her chin.  It grows larger as the pleasure of the act intensifies to orgasmic levels.\n\n", false);
                else if (this.player.cocks[0].cockLength < 24)
                    this.outputText("Your " + this.player.cockHead() + " slides over her cheek with every stroke, leaving a trail of pre-cum on her face.  The smudges of glistening pre grow larger and larger as the pleasure of the act nears orgasmic levels.\n\n", false);
                else
                    this.outputText("Your " + this.cockDescript(0) + " slides over her face with every stroke, smearing the demon's hair with your thick pre-seed before you pull back and dribble it on her face.  The pleasure of the act is incredible, and you feel yourself getting harder as the sensation nears orgasmic levels.\n\n", false);
                this.outputText("Ceraph squeals and blubbers incoherently for a moment as she cums, eventually managing to scream out, \"<i>Yes, splatter me with seed!  Punish this lowly demon with your powerful spunk.  Dominaaaaate meeee~</i>\"\n\n", false);
                this.outputText("Underneath your own mammoth erection, you can feel Ceraph's smaller cock twisting and squirming, unloading its own hot fluids onto her sweat-slicked belly.  She wriggles and twitches under you, her thigh muscles clenching and releasing in time with her spurts as they push you beyond your limit.  You watch your " + this.cockDescript(0) + " as it strains and squirts, dumping your thick load into the demon's ", false);
                if (this.player.cocks[0].cockLength < 18)
                    this.outputText("tits", false);
                else if (this.player.cocks[0].cockLength < 24)
                    this.outputText("face", false);
                else
                    this.outputText("long hair", false);
                this.outputText(".  The orgasming demonette continues to squirt underneath you, drenching and smearing herself with even more cum and her entire mid-section looks glazed in thick whitish goo.", false);
                if (this.player.cumQ() >= 1000)
                    this.outputText("  Your prodigious fertility quickly forms a puddle around her, leaving the deceptive seductress practically submerged in cum.", false);
                this.outputText("\n\n", false);
                this.outputText("You sigh, feeling immense relief, and remove your softening bulk from atop her form.  Ceraph exhales in exhaustion and smears the mixture of cum over her belly, cooing, \"<i>So you really did give me a huge load.  I'll be sure to scoop a few batches of it into my womb so we can have lots of imps together.</i>\"\n\n", false);
                if (this.player.cor < 33)
                    this.outputText("You groan, just wishing she would stop reminding you of the consequences of this little tryst.  In a hurry to leave the demon behind, you get dressed and take off for camp.\n\n", false);
                else if (this.player.cor < 66)
                    this.outputText("You groan, wondering why she just won't get over her little act.  Even though this wasn't your best idea, it isn't nearly as bad as she makes it out to be.  You get dressed and leave, eager to be rid of her.\n\n", false);
                else
                    this.outputText("You bend over, rub her belly softly and whisper into her ear, \"<i>I'll be sure to spit them on my cock first chance I get, dear.</i>\"\n\n", false);
                this.outputText("As you leave, you don't bother to spare a glance at the confused omnibus; she isn't worth your time.", false);
            }
            this.player.orgasm();
        ...
        rideCeraphsCockLikeaBAWSSexclamation11eleven() {
            ...
            this.outputText("Ceraph licks her lips and gazes up at you, begging with a voice that drips with seductive intent, \"<i>Please don't rape me!  I took a vow of chastity!</i>\"\n\n", false);
            if (this.player.cor < 33)
                this.outputText("Her words shame you.  Have you really sunk this low?  You wonder just how much this world has already corrupted you as you ready yourself to get off on a sex-demon's tool.", false);
            else if (this.player.cor < 66)
                this.outputText("Her words confuse you.  You never would've done this when you first came here, but you're horny and you know demons don't really mind.", false);
            else
                this.outputText("Her dishonest words anger you, and you slap her in the face.  Both of you know that she wants this almost as much as she wanted to rape you, and any pretense at disliking this act is a deceitful sham.", false);
            this.outputText("\n\nIt's too late for her to have any hope of swaying you anyway.  You strip off your " + this.player.armorName + " ", false);
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] >= 1)
                this.outputText("getting an exhibitionist thrill ", false);
            this.outputText("and begin touching your " + this.vaginaDescript(0) + ", getting yourself ready for what is to come.\n\n", false);
            this.outputText("You sink down, feeling yourself part around the hot demon-tool, its ring of crown-nubs stroking your walls as you slide down, and the bumpy texture of its shaft makes your " + this.player.legs() + " feel weak.  You drop the rest of the way down in one smooth, wet slide, ");
            if (this.player.vaginalCapacity() < 12)
                this.outputText("unable to take the entire exquisite cock inside you.  The nubs squirm and wiggle, practically vibrating and massaging your internal muscles, and you're unable to stop yourself from bouncing on top of her, spearing yourself repeatedly upon the thick rod.\n\n", false);
            else
                this.outputText("able to take the entire exquisite cock inside you.  The nubs squirm and wiggle, practically vibrating and massaging your internal muscles, and you're unable to stop yourself from bouncing on top of her, spearing yourself repeatedly upon the thick rod.\n\n", false);
            this.outputText("Ceraph cries in mock protest, \"<i>No, don't make me cum inside you!  Please Champion, I swore not to spill my seed, lest I father a bastard child!</i>\"\n\n", false);
            this.outputText("The sensations of her vibrating nodules ensure you don't have the will or the strength to pull off of her, and what little power your " + this.player.legs() + " have is used to keep bouncing and grinding on top of her, filling the air with wet squelches and slippery squishes.  You fall forwards, barely catching yourself before you slam into the sultry demoness.  Your ", false);
            if (this.player.biggestTitSize() < 1)
                this.outputText("chest ", false);
            else
                this.outputText("tits ", false);
            this.outputText("squish against hers, squeezing a gout of milk from her nipples.  Both pairs of ", false);
            if (this.player.biggestTitSize() < 1)
                this.outputText("nipples", false);
            else
                this.outputText("jiggling mounds", false);
            this.outputText(" feel wonderful as they're pressed between you, sliding back and forth in time with your body's urgent grinding.\n\n", false);
            this.outputText("The omnibus' facade of feigned innocence drops under the force of the hot, wet fuck.  Her mouth opens into an 'o' of pleasure, and you feel her rod thicken as it begins pumping the proof of her ecstasy inside you.  The nodules that cover Ceraph's demonic erection wildly vibrate as she orgasms, throwing you over the edge and into the midst of a body-shaking orgasm.  Demon-seed floods your womb, squeezed inside it by your body's orgasmic contractions.  You shudder with the demon as you both begin calming down.\n\n", false);
            this.outputText("She groans, \"<i>Ooooh... Champion why did you make me despoil your womb?  ", false);
            if (this.player.pregnancyIncubation == 0)
                this.outputText("You're only feeding the swarms of imps that are despoiling this land.", false);
            else
                this.outputText("I'm sure whatever baby you have in there won't enjoy being so soaked in corruption.", false);
            this.outputText("</i>\"\n\n", false);
            if (this.player.cor < 33)
                this.outputText("You groan, just wishing she would stop reminding you of the consequences of this little tryst.  In a hurry to leave the demon behind, you get dressed and take off for camp.\n\n", false);
            else if (this.player.cor < 66)
                ...
                this.outputText("You bend over and rub your belly while whispering in her ear, \"<i>Like mother, like child.</i>\"\n\n", false);
            this.outputText("As you leave, you don't bother to spare a glance at the confused omnibus; she isn't worth your time.\n\n", false);
        ...
        loseToCeraphAndGetPiercingsInEarsOrSomethingSomehow() {
            ...
            if (this.player.HP < 1)
                this.outputText("prone ", false);
            else
                this.outputText("lust-consumed ", false);
            this.outputText("form, whispering calmly as she pulls a pair of gleaming, green piercings from a pouch, \"<i>Oh, don't worry baby, you're going to love this so much.  These piercings are special, and they'll help you learn to enjoy the things I'm going to teach you.</i>\"\n\n", false);
            if (this.player.earsPierced > 0)
                this.outputText("With a dismissive gesture, Ceraph murmurs words of dark magic and the piercings in your ears drop to the ground, leaving behind smooth, unbroken flesh.  ", false);
            //(BUSINESS AS USUAL GENTLEMEN)
            this.outputText("The demon places a hand on your forehead and rubs your temples.  Strength drains from your body with every touch, until you're left helpless and paralyzed.  She snaps an earring into your left ear, and dizziness washes over you.  A moment later she's piercing the other side, and the now-familiar vertigo that accompanies it seems to come and go quicker than before.  You hope she doesn't take your " + this.player.armorName + " while you're paralyzed, leaving you to roam the realm totally exposed.  Confusion and waves of new desire battle in your mind as you try to come to grips with the odd thought.\n\n", false);
            ...
            this.outputText(" as the new thoughts and desires settle themselves inside you.  She gives you a gentle pat and explains, \"<i>It's ok baby, you're an exhibitionist now.  The moment I put those cursed earrings in your cute little ears, they slid their magic deep inside you, teaching you how to be a good " + this.player.mf("boy", "girl") + " and get turned on by exposing yourself.</i>\"\n\n", false);
            this.outputText("Judging by how hot the idea is getting you, Ceraph is right – <b>whether you like it or not, you're an exhibitionist now.</b>", false);
        ...
        loseToCeraphAnGetPierced2() {
            this.outputText("", true);
            this.spriteSelect(7);
            this.outputText("Ceraph giggles as she closes in on you once again.  Unable to fight back, you lie there as she once again massages your temples, using her magic to paralyze your body.  She's all too happy to build up the suspense as she pulls out a pair of shining black studs, \"<i>Oh, did you want to know what these are going to teach you?  Well, how about I slide them into your ", false);
            if (this.player.hasFuckableNipples())
                this.outputText("slut", false);
            else if (this.player.nippleLength < 1)
                this.outputText("cute", false);
            else
                this.outputText("tight", false);
            this.outputText("-nipples and you tell me all about your fetishes and which one makes you the hottest.  OK?</i>\"\n\n", false);
            //If already pierced
            if (this.player.nipplesPierced > 0)
                this.outputText("With a dismissive gesture, Ceraph murmurs words of dark magic, and the piercings in your nipples drop to the ground, leaving behind smooth, unbroken flesh.  ", false);
            //Business as usual!
            this.outputText("The demon doesn't give you a chance to reply, instead she focuses on aligning the business ends of the piercings with your sensitive nipple-flesh.  Your right " + this.nippleDescript(0) + " is pierced in one smooth motion, nearly making you scream in pain.  As she fastens it on, you feel goosebumps spread over your body in a wave.  The second piercing doesn't seem to hurt as bad, but the sensation of spreading goosebumps is far more noticeable.  Your eyes dart wildly, afraid at what new kind of fetish Ceraph has forced upon you.\n\n", false);
            this.outputText("She smiles down at you and teases, \"<i>Still haven't figured it out?  I'll give you a hint:  Isn't being paralyzed nearly the same as being tied down?</i>\"\n\n", false);
            this.outputText("Your body goes beet-red as it suddenly tries to struggle against her invisible restraints.  It really is!  You nearly cry as the restraint turns you on more and more.  Ceraph's cursed piercings have given you a fetish for being restrained.  You nearly faint when you think of the tentacle monsters, and you know you have no hope of resisting if they ever bind you up.  <b>Somehow you'll have to get used to being a bondage fetishist...</b>", false);
            this.dynStats("lus", 25, "cor", 5);
        ...
        getPiercedByCeraphLoss3() {
            ...
            this.outputText("You tremble in impotent fury at the violation as the demoness flounces away.  You'd pursue her, but between her ideas and exposing your crotch to the entire area, you need to cum more than anything.  You scurry back to camp, too horny to think straight and your new piercing aching just enough to keep you from forgetting about it.", false);
            this.dynStats("lus", 25, "cor", 5);
            this.cleanupAfterCombat();
        }
        ...
        finalCeraphEncounterStartFight() {
            ...
            if (this.player.cor <= 50)
                this.outputText("you'll stop her devilish scheme", false);
            else
                this.outputText("you'll be HER " + this.player.mf("master", "mistress"), false);
            this.outputText(".  She snarls and drops the harness, preparing to defend herself.  It looks like you've got a fight!", false);
            this.startCombat(new Ceraph_1.Ceraph());
        }
        //[Yes] TO BAD END
        ...
        agreeToBecomeCeraphsFuckpetBondageToyBitchSlut() {
            this.outputText("", true);
            this.spriteSelect(7);
            this.outputText("At this point, you know she's right.  The desires Ceraph has awakened inside you will never go away.  In spite of the hassle they've caused, you've come to love being so uncontrollably aroused by such humiliating treatment.", false);
            if (this.player.hasVagina())
                this.outputText("  Your " + this.vaginaDescript(0) + " tingles as you wonder how many piercings and fetishes she could fit into your labia.", false);
            else if (this.player.cockTotal() > 0)
                this.outputText("  Your " + this.cockDescript(0) + " grows rock hard as you wonder if she'll give you a Jacob's ladder full of new fetishes and thoughts.", false);
            else
                this.outputText("  Your body hums with arousal as you wonder if she'll give you a cock and cunt, pierce them both, and fill you with new fetishes and sexy submissive thoughts.", false);
            ...
            this.outputText("She spends a few moments undressing you, then gives your " + this.buttDescript() + " a few smacks to suitably redden it.  Horrified at the treatment but more turned on than ever, you endure the humiliation, crawling after your mistress as she leads you to a new, sexy life on an impromptu leash.  You lose track of time, just focusing on putting one hand in front of the other.  Multiple times you catch glimpses of demons and monsters from the fringe of your vision, but none of them seem keen on approaching your mistress or her new slave, you.  Every time you feel their eyes on your naked " + this.player.skinDesc + ", you're rocked with sexual pleasure.\n\n", false);
            this.outputText("Absorbed in your own thoughts, you barely notice the light dim or the solid thunk of a door closing behind you.  Happy moans bring you out of your dazed state.  You've arrived at Ceraph's lair.  The demon is barely paying attention to you, holding on to your leash as she walks around greeting her other pets.  She ruffles the hair of a tiny boy wearing naught but doggie-ears and an inventive looking butt-plug that gives him the appearance of having a tail.  Ceraph tickles the crotch of a girl with more than a few demonic features.  She's tied to the wall, with two vibrators strapped hilt-deep in her abused nipple-cunts.  Her original sex is drooling but totally unfilled as she squirms in her straps while Ceraph touches her.\n\n", false);
            this.outputText("There are many more slaves just like those two throughout Ceraph's home.  Some are little more than furniture, some she treats like artwork, and others she uses for her sexual enjoyment.  She announces, \"<i>Pets, meet your new " + this.player.mf("brother", "sister") + ".  I think I'll just call " + this.player.mf("him", "her") + " 'pet'.  " + this.player.mf("He", "She") + " needs to learn her place and we're going to be teaching and piercing " + this.player.mf("him", "her") + " all week.</i>\"\n\n", false);
            this.outputText("The whip is uncurled from around your neck, and you look up, unsure of what to do.  Ceraph coos, \"<i>Good pet.  Just stay like that and pout for me.</i>\"\n\n", false);
            this.outputText("Not seeing the harm and seeking to endear yourself to your mistress, you thrust your lower lip out.  Your obediance is rewarded by a sharp snap of dazzling pain.  Licking experimentally, you feel the smooth band that loops over the center of your lip. ", false);
            //if pierced there
            if (this.player.lipPierced > 0)
                this.outputText("The previous piercing has vanished!  ", false);
            this.outputText("Mistress is so kind to give you such a pretty piercing!  The ease you find yourself calling her mistress shocks you, but that's what she is, isn't she?  She's your mistress and owner, and you are her pet.  You catch her looking at you expectantly and you realize she's waiting for something.\n\n", false);
            this.outputText("You lick your new lip-ring nervously and say, \"<i>Thank you mistress, pet is so happy to be pierced again!</i>\"\n\n", false);
            this.outputText("What the hell?  Did you just call yourself pet?  You struggle internally, thinking, \"<i>When did pet start thinking of " + this.player.mf("him", "her") + "self as pet?</i>\"  A tingle of new arousal shivers through you – Mistress Ceraph has made it impossible for you to think or call yourself anything other than pet!  What else is she going to do to you?\n\n", false);
            this.outputText("\"<i>Oh it's so cute watching my pets and toys truly learn their new names.  Now come here pet, a good pet wears a collar so everyone knows who " + this.player.mf("he", "she") + " belongs to,</i>\" says Mistress as she pulls a thick black collar off a hook on the wall.  Compliant, you allow her to fasten it around your neck, waggling your ", false);
            if (this.player.tailType == appearanceDefs_1.TAIL_TYPE_NONE)
                this.outputText("backside", false);
            else
                this.outputText("tail", false);
        ...
        agreeToBeABitchPt2() {
            this.outputText("", true);
            this.spriteSelect(7);
            this.outputText("Months pass in pure bliss.  Since adoption into Mistress Ceraph's harem, pet gained over a dozen piercings and nearly twice as many fetishes.  Pet learned to love spanking, and developed the ability to cum just from having " + this.player.mf("his", "her") + " nipples pinched or being paddled.  Ceraph enjoyed that for a while, but she did eventually tire, and pet was given a fetish for orgasm denial", false);
            if (this.player.cockTotal() > 0)
                this.outputText(" along with a magical cock-ring", false);
            this.outputText(".  Two weeks of drug and bondage induced edging nearly broke pet's mind, but Mistress was nice and let " + this.player.mf("him", "her") + " cum over and over after getting a new piercing and worshiping her feet for a few hours.\n\n", false);
            this.outputText("The champion that left Ingnam so long ago is totally unrecognizable, body and soul.  The spirit that once burned bright with the desire to save the innocents of the village has been warped and twisted beyond repair.  The once-champion known only as 'pet', not even worthy of a proper name, spends all " + this.player.mf("his", "her") + " time lusting after Mistress Ceraph, taking part in her depraved orgies and willingly submitting to any kinks or debaucheries that are presented to " + this.player.mf("him", "her") + ".  Pet's life of individuality and choice is over, all that remains is pleasure and pain.", false);
            this.getGame().gameOver();
        }
        //[Initial Meeting Text]
        ceraphFirstTime() {
            this.outputText("", true);
            this.spriteSelect(88);
            this.outputText("A cute goblin steps out of the bushes, holding a pair of green earrings up to the light.  She politely asks, \"<i>Hey cutey!  I've got some spare earrings I made the other day.  I was wondering if you want them?  As you can see, my ears are already full, and my daughters are a bunch of ungrateful cunts.</i>\"\n\n", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.PC_MET_CERAPH] = 1;
        ...
        ceraphFirstTimeDecline() {
            this.outputText("", true);
            this.spriteSelect(7);
            this.outputText("You decline, informing the petite girl you have no interest in her earrings.  She shrugs and laughs, her form distorting as it grows taller, twisting as her skin lightens, her breasts bulge, and a pair of cute horns breaks out of the skin of her forehead.  She pockets the earrings and stretches, revealing a glistening demon-snatch capped with a modest cock growing from where her clit should be.\n\n", false);
            this.outputText("The demon introduces herself, \"<i>Well if you want to do this the hard way, that's fine by me.  The ones that fight the hardest break down into the most submissive slaves.  Just remember that this is the beginning of your life as Ceraph the Omnibus' slave-" + this.player.mf("boy", "girl") + ".</i>\"\n\n", false);
            this.outputText("Ceraph adopts a suggestive pose and tweaks her nipple, clearly more intent on turning you on than physically harming you.", false);
            //FIGHTO
            this.startCombat(new Ceraph_1.Ceraph());
        }
        //[Yes]
        ...
        ceraphFirstTimeRepeat() {
            this.outputText("", true);
            this.spriteSelect(7);
            this.outputText("Ceraph saunters out of the bushes and gives you a disapproving look, \"<i>I tried this the easy way.  Now we're doing it the hard way.</i>\"\n\n", false);
            this.outputText("She uncurls a whip that lights aflame and says, \"<i>Time for your spanking!</i>\"\n\n", false);
            this.startCombat(new Ceraph_1.Ceraph());
        }
        ...
        level3CeraphOfferNo() {
            this.outputText("", true);
            this.spriteSelect(7);
            this.outputText("You let Ceraph know that you refuse to let her violate your body and mind in such a way.  She shrugs nonchalantly and tugs on the crop, stretching it into a whip that bursts into flames.\n\n", false);
            this.outputText("\"<i>Mortals always want to do things the hard way,</i>\" she sighs.\n\n", false);
        ...
        yesOHGODYESPIERCELEVEL3() {
            this.outputText("", true);
            this.spriteSelect(7);
            this.outputText("You nod, biting your lip anxiously and undoing your armor to give her better access to your body.  The demoness pulls out a diamond-studded piercing and closes in on you, her cock hard, her pussy moist, and her hips swaying seductively as she advances.  Ceraph gives you a serious look and warns you, \"<i>You know how close you are to being my pet, don't you?  You just need this piercing and a little time to get used to it.  Then if you're good I'll strip you naked, tie you down, and let you lick me out.  We can even let the imps watch!</i>\"\n\n", false);
            this.outputText("The idea turns you on immensely, and you pant and gasp as ", false);
            if (this.player.totalCocks() > 0) {
                this.outputText("pre-cum oozes from ", false);
                if (this.player.totalCocks() > 1)
            ...
            if (this.player.cockTotal() > 0) {
                ...
                if (this.player.cocks[0].pierced > 0)
                    this.outputText(", the old piercing clattering to the ground as it slides out of your flesh,", false);
                this.outputText(" and snaps the diamond stud through your sensitive flesh, making your vision haze red in pain.", false);
                this.player.cocks[0].pierced = 1;
                this.player.cocks[0].pShortDesc = "seamless, diamond cock-stud";
                this.player.cocks[0].pLongDesc = "Seamless, diamond cock-stud";
            }
            //[cunts]
            else if (this.player.hasVagina()) {
                this.outputText("spreads your lips", false);
                if (this.player.vaginas[0].clitPierced > 0)
                    this.outputText(", the old piercing clattering to the ground as it slides out of your flesh,", false);
                this.outputText(" and gets ahold of the flesh around the base of your " + this.clitDescript() + ".  With practiced ease, she snaps the piercing closed, attaching the diamond stud to you while the pain fuzzes your vision red.", false);
                this.player.vaginas[0].clitPierced = 1;
                this.player.vaginas[0].clitPShort = "seamless, diamond clit-stud";
                this.player.vaginas[0].clitPLong = "seamless, diamond clit-stud";
            }
            else {
                this.outputText("gives you a mildly annoyed look before she snaps the diamond stud into your eye-brow, piercing it.  ", false);
                if (this.player.eyebrowPierced > 0) {
        ...
        encounterCeraph() {
            ...
            this.doNext(this.camp.returnToCampUseOneHour);
            //If havent met her
            if (this.flags[kFLAGS_1.kFLAGS.PC_MET_CERAPH] == 0) {
                this.spriteSelect(7);
            ...
            //If fetished level 1
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] == 1) {
                this.outputText("Though you spend an hour exploring, you don't find anything of note.", true);
                return;
            }
            //fetished level 2
        ...
        winRapeChoices() {
            ...
            if (!this.getGame().inCombat) {
                ...
                this.startCombat(new Ceraph_1.Ceraph());
                leave = this.ceraphFollowerScene.ceraphFollowerAppearance;
                //Exit combat
                this.getGame().inCombat = false;
                this.monster.lust = 100;
                this.monster.HP = 2;
                if (this.player.lust < 34)
                    this.player.lust = 34;
            }
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00291] >= 4) {
                this.ceraphFollowerScene.submissiveCeraphOffer();
                return;
            }
            //Normal stuff here
            this.spriteSelect(7);
            ...
            if (this.monster.HP < 1)
                ...
                this.outputText("Ceraph masturbates futilely, too driven by desire to fight.", false);
            if (this.player.lust >= 33 && this.player.gender > 0) {
                this.outputText("  Do you have your way with her? (And if so, which of your body parts do you do it with?)", false);
                ...
                if (this.player.hasVagina() && this.player.biggestTitSize() >= 4 && this.player.armorName == "lusty maiden's armor")
                    bikiniTits = this.createCallBackFunction2(this.player.armor.lustyMaidenPaizuri, this.player, this.monster);
                ...
                if (this.getGame().inCombat)
                    ...
                    this.doNext(this.ceraphFollowerScene.ceraphFollowerAppearance);
            }
        }
        loseFUCKME() {
            //Reset rape count if lost
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00291] = 0;
            this.spriteSelect(7);
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] == 0)
        ...
        ceraphRapesYouBADDAWGYODIGGITY() {
            ...
            this.spriteSelect(7);
            this.outputText("", true);
            if ((!this.getGame().inCombat) && this.flags[kFLAGS_1.kFLAGS.PC_FETISH] < 3)
                this.outputText("The demoness touches your forehead, and suddenly your mind is awash with fetishes!  Judging by the playful look she has, it's temporary, and you play along.  ", false);
            this.outputText("Ceraph throws her head back and laughs as you ", false);
            if (this.player.HP < 1)
                this.outputText("slump down, defeated", false);
            else
                this.outputText("give up and start masturbating", false);
            this.outputText(", \"<i>Really?  Is that it?  After being under my magic for so long, you try to make a stand and fail, like this?!  Pathetic.</i>\"\n\n", false);
        ...
        hugeCorruptionForceFuckCeraph() {
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00291] += 2;
            this.outputText("", true);
            this.spriteSelect(7);
            var x = this.player.biggestCockIndex();
            this.outputText("You laugh at Ceraph's ", false);
            if (this.monster.HP < 1)
                this.outputText("beaten, prone", false);
            else
                this.outputText("prone, masturbating", false);
            this.outputText(" form, \"<i>You fucking demons are all the same.  That smug superiority complex makes you forget that being a demon doesn't come with an invincibility clause.</i>\"\n\n", false);
            this.outputText("The hermaphrodite dominatrix frigs her dripping slit, getting off on the dominance in your words, but she still manages to snarl defiantly, \"<i>F-uuuck off.  Just... rape me or whatever and get it over with.</i>\"\n\n", false);
            this.outputText("She's quite the sore loser!  You drop your " + this.player.armorName + " on the ground and stroke your ", false);
            if (this.player.cockTotal() > 1)
                this.outputText("largest ", false);
            this.outputText(this.cockDescript(x) + ", feeling the blood pump into it.  The thick, penile flesh inflates to the ludicrous size it adopts every time you get hard.  Ceraph's eyes widen into dinner plate-sized saucers of shock as she beholds the behemoth that sprouts from your loins.  She actually tries to scrabble away in the dirt, but she fails miserably.  ", false);
            if (this.monster.HP < 1)
                this.outputText("Her hands are too busy starting to pump away at her nodule-covered demon-dick to help her crawl away.", false);
            else
                this.outputText("Both her hands are too busy at her groin to help her escape.", false);
            this.outputText("\n\n", false);
            this.outputText("You drop the swollen mass of dick-flesh on top her, pinning her under the weight of your lust.  Ceraph gasps in shock and pain, but her hard nipples are pressing tightly into your " + this.cockDescript(x) + "'s underside.  The slut is loving it – could she secretly be a submissive?  It doesn't matter one way or the other; this demon is going to pay.  You shimmy back, dragging the elephantine fuck-stick over the defeated demon's body until the bloated tip is resting on her purplish demon-snatch.  She screams, \"<i>OH FUCK NO!  That would kill me!  Please, don't!</i>\"\n\n", false);
            ...
            if (this.player.cocks[x].cockLength > 84)
                ...
                this.outputText(" against her slippery, split slit, before you pull back and start fucking her like a plus-sized, organic onahole.  ", false);
            }
            this.outputText("The once-formidable demon sighs happily each time you pull back out of her throat, and the obscene 'schlick' her cunt makes as you penetrate it is auditory heaven.  You slap her tits and watch them jiggle, but the absurd eroticism of it all overwhelms even your perverse standards.  Ceraph slides down, bottoming out on you while her full-body cunt convulses with orgasm.  ", false);
            if (this.player.cumQ() < 100)
                this.outputText("You squirt your load into the dirt, but some rolls back along the underside of your urethra, catches on Ceraph's upper lip, and drips up her cheek into her tangled hair.", false);
            else if (this.player.cumQ() < 1000)
                this.outputText("You squirt your copious cum everywhere, splattering the dirt and dripping white goo onto Ceraph's face, forehead, and hair.  By the time you finish she's got a nice glaze going on.", false);
            else
                this.outputText("You expel huge waves of seed in what can only be described as eruptions.  They splatter into the dirt, forming thick puddles that are joined together with each successful splash of goo.  In between blasts, a steady stream leaks from the tip, travels down the underside, and catches on Ceraph's lip.  The spunk-flow is pulled over her face and into her hair by gravity.  She's glazed white and dripping into a puddle by the time you finish.", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.cockTotal() == 2)
                ...
                this.outputText(" and marvel at the cum your other cocks dumped into the puddle", false);
            this.outputText(".  Ceraph's pussy gapes at least " + CeraphScene.num2Text(Math.floor(this.player.cocks[x].cockThickness + 1)) + " inches wide, pushing her hips so far apart as to make it difficult to walk.  She shudders, drooling spit, pussy-juice, and sperm as her mouth, neck, and chest tighten up.  Her lower body doesn't change one iota; your magics are still overpowering her natural abilities below the waist.  The abused dom twitches a few more times before her eyes reappear and she pulls her tongue back into her mouth.\n\n", false);
            this.outputText("Ceraph gasps, \"<i>Ohhhhkay.  That felt goooooooood.</i>\"  She gathers some of your sperm from her space and swallows it with a smile before she offers, \"<i>You've shown me a good time, mortal.", false);
            if (!this.getGame().inCombat) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0)
                this.outputText("I'll remove some of my magic from you if you want, and I'll even let you keep the piercing.  Would you like that?", false);
            else
                this.outputText("I'd be willing to give you a few extra gems to keep you motivated to do something like this again.  I LIKE surprises. How about it?", false);
            this.outputText("</i>\"\n\n", false);
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1) {
                this.outputText("Exgartuan mumbles, \"<i>Yeah I love me too.  Now while you two bitches kiss and make up, I'm gonna take a nap.</i>\"\n\n", false);
                //Put Exgartuan to bed.  Awww he's so cute!
                this.player.addStatusValue(StatusAffects_1.StatusAffects.Exgartuan, 2, 5);
            }
        ...
        ceraphsNiceOffer() {
            ...
            this.spriteSelect(7);
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0) {
                this.outputText("Ceraph touches your forehead, and it feels like her claws are raking through your brain, plowing through the surface of your thoughts.  She pulls away, leaving you feeling a little dazed.  You blink and mentally go over your fetishes - ", false);
                if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] == 1)
                    this.outputText("your exhibitionism is gone!", false);
                else if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] == 2)
                    this.outputText("your bondage fetish is gone!", false);
                else
                    this.outputText("your pacifism is gone!", false);
                this.flags[kFLAGS_1.kFLAGS.PC_FETISH]--;
            }
            else {
                this.outputText("Ceraph shakes some of the jism out of her hair and reaches under the tangled mass.  Her hand comes out with a small pouch of gems, and she tosses them to you.  You open it up and are surprised to find 10 gems inside.", false);
                this.player.gems += 10;
            }
        ...
        friendlyNeighborhoodSpiderManCeraph() {
            this.outputText("", true);
            this.spriteSelect(7);
            this.outputText("While exploring, a sudden compulsion to strip naked runs through your body, ", false);
            if (this.player.cor > 66)
                this.outputText("and without a second thought you disrobe, tossing your " + this.player.armorName + " to the side.  It thumps heavily in the dry mountain dust.", false);
            else if (this.player.cor > 33)
                this.outputText("and you squirm and writhe within your " + this.player.armorName + ", the material itching on your skin.  Ultimately, you manage to resist.", false);
            else
                this.outputText("and you stifle a laugh at the ridiculous thought, ignoring your fingers while they scratch at the itch under your gear.", false);
            this.outputText("  Your ", false);
            if (this.player.skinType <= appearanceDefs_1.SKIN_TYPE_FUR)
                this.outputText("skin burns", false);
            else if (this.player.skinType == appearanceDefs_1.SKIN_TYPE_SCALES)
                this.outputText("scales burn", false);
            else
                this.outputText(this.player.skinDesc + " burns", false);
            this.outputText(" hot, raging from fetish-enhanced lust and daydreams, but you shake your head in time to see a pair of inky black orbs rising from behind a nearby boulder.\n\n", false);
            this.outputText("You wrench your gaze from the treacherous, alien eyes and glance lower, but it doesn't help.  There's nothing but flawless, sweat-moistened demon-skin, jutting purple breasts, and a crotch that combines the finest attributes of both genders.  It's the demon, Ceraph!\n\n", false);
            this.outputText("\"<i>Oh my, does someone like what they see?  ", false);
            if (this.player.cor > 66)
                this.outputText("I can see just how hot I'm making you, I'm so glad you gave in and got undressed for me", false);
            else
                this.outputText("You can't take your eyes off me.  It's a shame you didn't get undressed.  Didn't anyone tell you this mountain has a dress code?  Or should I say, an undress code", false);
            this.outputText(",</i>\" she says.\n\n", false);
            this.outputText("You ready your " + this.player.weaponName + ", but Ceraph just throws her head back and laughs in your face.  \"<i>", false);
            if (this.player.cor > 66)
                this.outputText("Are you going to try to fight me in the buff?  If you're going to do that then you can go ahead and get dressed, I wouldn't want to accidentally leave a scar in the wrong place.", false);
            else
                this.outputText("Are you going to try to fight me?  If you're going to do that, I suppose we can.  You do seem to need some practice at indulging your fetishes.", false);
            this.outputText("</i>\"\n\n", false);
        ...
        runFromCeraphsNiceDeal() {
            ...
            if (this.player.cor > 66)
                this.outputText("grab your equipment and ", false);
            ...
            this.dynStats("lus", (10 + this.flags[kFLAGS_1.kFLAGS.PC_FETISH] * 10));
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[Trade] 
        tradeCeraphSomething() {
            ...
            var armor = undefined;
            this.outputText("Ceraph looks you up and down like an appraiser examining an antique, never stopping her languid masturbation.  You stand there, hands on your hips, waiting for her to finish while you try not to stare too long at her beading pre-cum or dripping twat-juice.\n\n", false);
            //(BIMBO LIQUER) 
            if (this.player.hasItem(this.consumables.BIMBOLQ)) {
                this.outputText("She finishes and smiles widely.  \"<i>Is that bimbo liqueur?  That stuff is so hard to find, even for a demon like me.  I tell you what, I'll release you from ", false);
                if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 1)
                    this.outputText("all the fetishes", false);
                else
                    this.outputText("the fetish", false);
                this.outputText(" I've placed upon you if you'll trade me that stuff.  There's a naughty boy in my harem whose quick wit I've begun to tire of.", false);
                if (this.player.gender > 0 || this.player.biggestTitSize() > 2)
                    this.outputText("  Or if you'd rather keep it, I could take one of your endowments for my own use and remove a single fetish.  It's always fun giving one of my old pets a new part to play with.", false);
                this.outputText("  Maybe you just need some better equipment though?  I have this sexy armor I'd love to loan you, pet.</i>\"\n\n", false);
                liqueur = this.tradeCeraphBimboLiqueur;
                if (this.player.gender > 0 || this.player.biggestTitSize() > 2)
                    endowment = this.tradeCeraphCrotchityBits;
            }
            //(No Bimbo Liquer) 
            else if (this.player.gender > 0 || this.player.biggestTitSize() > 2) {
                this.outputText("She finishes and perks up, leering lewdly at you.  \"<i>I tell you what.  Let me take one of your endowments to use on my pets and I'll get rid of ", false);
                if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] == 1)
                    this.outputText("your fetish for you.</i>\"\n\n", false);
                else
                    this.outputText("one of your fetishes for you.</i>\"\n\n", false);
                endowment = this.tradeCeraphCrotchityBits;
            }
            //(NO TRADE)
            else {
                this.outputText("She finishes and frowns.  \"<i>I don't think you've got a single thing worth trading.", false);
                if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] < 2) {
                    armor = this.getCeraphsArmor;
                    this.outputText("Don't fret your " + this.player.mf("pretty little head", "charming little head") + ", Mistress Ceraph is nothing if not generous to her pets.  I can give you some beautiful armor to entice your foes with, wouldn't that be lovely?", false);
                }
                this.outputText("</i>\"\n\n", false);
            }
        ...
        tradeCeraphCrotchityBits() {
            ...
            while (this.temp > 0) {
                ...
                if (this.player.breastRows[this.temp].breastRating > 2)
                    choices[choices.length] = 3;
            }
            //Think about it...
            this.outputText("Ceraph grins lecherously and pulls her tail from her drooling snatch.  \"<i>Really?  Well this should be fun.  Let me just figure out what I want...</i>\"  Her gaze is quite piercing.\n\n", false);
            //Pick a winner!
            choice = choices[CeraphScene.rand(choices.length)];
            if (choice == 0)
                this.outputText("FUCK AN ERROR HAPPENED GET FENOXO ON THE HORN!", false);
            //(DICKS)
            else if (choice == 1) {
                temp2 = CeraphScene.rand(this.player.cockTotal());
                this.outputText("She pipes up, \"<i>", false);
                if (this.player.cocks[temp2].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                    this.outputText("Oooh, is that a horse-cock?  Those are quite nice.  I love the feel of a flare inside me, or even better, plunging one deep into a slut's poor, abused asshole.", false);
                else if (this.player.cocks[temp2].cockType == CockTypesEnum_1.CockTypesEnum.DOG)
                    this.outputText("Oooh, is that a dog-cock?  Those are quite nice.  It's oh-so-fun to enhance the knots on those and then watch them puff up enough to distend some poor slave's gut.", false);
                else if (this.player.cocks[temp2].cockType == CockTypesEnum_1.CockTypesEnum.DEMON)
                    this.outputText("Oooh, is that a demon-cock?  As you can see I'm QUITE familiar with those, but it might be fun to replace one of my girl's tongues with it.", false);
                else if (this.player.cocks[temp2].cockType == CockTypesEnum_1.CockTypesEnum.CAT)
                    this.outputText("Oooh, is that a kitty-dick?  The spines on those feel so good while they rub down all your walls or catch your prostate.  Meow.", false);
                else if (this.player.cocks[temp2].cockType == CockTypesEnum_1.CockTypesEnum.LIZARD)
                    this.outputText("Wow, you've got a snake-dick?  I haven't seen one of those in a while.  I love the bulbous, knot-like texture.  Maybe I'll graft it onto a chair and make one of my boys sit on it for a few days.", false);
                else if (this.player.cocks[temp2].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE)
                    this.outputText("Oooh, a tentacle cock?  How lucky to find one of those on you!  I've been meaning to add another poor tentacle-slave.", false);
                else if (this.player.cocks[temp2].cockType == CockTypesEnum_1.CockTypesEnum.ANEMONE)
                    this.outputText("Oooh, an anemone-cock?  Simply marvelous!  I might have to crank up the strength of the venom and use it myself!", false);
                else
                    this.outputText("Oooh, a normal, uncorrupted cock.  How utterly droll!  You'd think these would be more common, but it's quite a treat to come across one.", false);
                if (this.player.cockTotal() > 1) {
                    this.outputText("  Of course that's not the only prick you're packing, hrmmm?  Maybe I should take ", false);
                    if (this.player.cockTotal() == 2)
                        this.outputText("the other one", false);
                    else
                        this.outputText("one of the others", false);
                }
            ...
            //(Cunts) 
                ...
                this.outputText("The demon's gaze drops down between your " + this.player.legs() + ", and she remarks, \"<i>", false);
                if (this.player.wetness() >= 5)
                    this.outputText("My my, what a juicy box you have there.  Tell me, doesn't it bother you to be soaking in your own lubricants all the time?  Perhaps I'll put it on one of my slaves and mount her on the wall.  Then I can simply slip in and lube up before giving one of my other pets a proper lesson.", false);
                else if (this.player.wetness() >= 3)
                    this.outputText("My my, what a nice wet pussy you have there.  I really feel that you have a perfect blend of moisture and practicality down there.  I might have to snatch that snatch and give it to one of my drier pets.", false);
                else if (this.player.vaginalCapacity() >= 150)
                    this.outputText("My my, what a terrifically gaped hole you have there.  Do minotaurs even feel anything while they rail you?  Perhaps I could use that when I'm playing with Shenandoah.  She's had a few too many incubi drafts and can be a little difficult to handle.", false);
                else
                    this.outputText("My my, such a pretty pussy.  I bet it would be fun to replace one of my noisier pet's mouth with.  She never did learn not to bite.", false);
                this.outputText("</i>\"\n\n", false);
            }
            //(Tits) 
            else {
                this.outputText("Ceraph's hands reach up to cup the swell of your " + this.biggestBreastSizeDescript() + " as she asks, \"<i>", false);
                if (this.player.biggestTitSize() > 14)
                    this.outputText("Oh wow... just wow.  How do you walk?  With melons like this you could tit-fuck three or four people at once!  Absolutely exquisite.", false);
                else if (this.player.biggestTitSize() > 6)
                    this.outputText("Tell me dear, are they real?  I mean, were they always this size, or did you have to get a little bit of work done?", false);
                else
                    this.outputText("Well, these are a bit small.  Have you ever considered trying some Gro Plus?  I hear it's all the rage with Lethice's lackeys nowadays.", false);
                this.outputText("</i>\"\n\n", false);
            }
            this.outputText("A long, silent moment passes before Ceraph makes up her mind.  She points at your ", false);
            if (choice == 1) {
        ...
        giveUpYourBallsOrWhateverForLessFetishes() {
            ...
            this.spriteSelect(7);
            var x = 0;
            this.outputText("You hold still, dreading this moment but knowing all-too well that you'd have to give something up to get her touch out of your mind.  ", false);
            //(Cock)
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00217] == 1) {
                //Pick a dick at random!
                x = CeraphScene.rand(this.player.cockTotal());
                this.outputText("Ceraph's fingers feel unexpectedly hot as they brush your " + this.cockDescript(x) + ", as if she had just come out of a heated tub.  You don't have long to ponder that little detail as they pinch into a tight ring", false);
                ...
                this.outputText(" in her hand!  At the base there's smooth flesh and an arcane mark, somehow keeping the disembodied dick alive to pulse and squirm in her grasp.  The place on your groin is left completely smooth and featureless, as if it had never been there at all.\n\n", false);
                this.outputText("Ceraph runs a finger up and down the length, setting off fireworks in your brain – you can still feel it!  The demoness laughs and says, \"<i>Don't worry, you won't feel the sensations constantly once I bond it elsewhere, though you may get a hint of feeling when unconscious.  For now, enjoy the pleasure!  Oh, I packed that tasty fetish into the cock for later.  Ta-ta, my pet!  Now go find me some more delicious dicks!</i>\"\n\n", false);
                this.outputText("She pirouettes away, practically dancing through the mountains while she strokes and teases the cock you just lost.  Thankfully she was true to her word – your mind feels significantly clearer, at least when a burning hot demon-tongue isn't enveloping Ceraph's new toy.", false);
                //PYOING!
            ...
            //(Tits) 
                ...
                this.outputText("Ceraph turns and prances off through the rocks, tweaking your nipples HARD every time you start to make a move to follow her.  It's no use.  She vanishes before long, leaving you to deal with the slowly dwindling sensation of her cock in your tits.\n\n", false);
        ...
        ceraphBodyPartDreams() {
            ...
            var subChoice = 0;
            //dicks
            this.temp = this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00218];
            while (this.temp > 0) {
                this.temp--;
                choices[choices.length] = 1;
            }
            //pussies
            this.temp = this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00219];
            while (this.temp > 0) {
                this.temp--;
                choices[choices.length] = 2;
            }
            this.temp = this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00220];
            while (this.temp > 0) {
                this.temp--;
                choices[choices.length] = 3;
            }
            ...
            if (choice == 2) {
                ...
                //PUSSY FLESHLIGHT
                    ...
                    //Vagina Wall-Cubby
                    this.outputText("MMMmmm, something is filling you just - ahhhh... right.  You shift position in your blankets, but it doesn't seem to move the insistent hardness lodged up your twat.  Gods, it feels so good to be so full.  It's like having three or four hard dicks inside you all at once, keeping you stretched and open, the cunt-honey dripping toward the floor.  The only time they move is when a wave of contractions pulses through your female flesh, squeezing about the invaders.  Languidly, you work your muscles faster, wanting to feel greater pleasures.  You secretly wish that whatever it is would fuck you.");
                ...
                //Tit Volleyball
                    ...
                    this.outputText("You see Ceraph, the conniving omnibus, standing in a hazy pink void, dressed in a tiny purple bikini.  She smiles to herself as she holds out a fleshy orb.  It looks soft, jiggly... and alarmingly familiar.  As you spy a rounded areola, you realize the demon is holding one of your old breasts! She tosses the plump tit ponderously for a moment, before raising it to her mouth and... blowing?");
                    ...
                    if (this.silly())
                        this.outputText("horsecocks ");
                    else
                        this.outputText("demonic cocks ");
                    this.outputText("rise from the sand, forming makeshift poles for the twisted volleyball net.");
                    ...
                    if (this.silly())
                        this.outputText(" and what possible ramifications it has for your mental health");
                    this.outputText(", until you dismiss it as corruption and toss over, entering a peaceful, dreamless sleep.");
                    this.dynStats("lus", 5 + this.player.lib / 5);
                }
            }
            //COCKUUUU
            else {
                subChoice = CeraphScene.rand(10);
                //WAX DRIPPU
                if (subChoice <= 2) {
                ...
                //Cock Sandwich
                    ...
                    this.dynStats("lus", 5 + this.player.lib / 5, "cor", .5);
        ...
        buttRapeCeraph() {
            ...
            if (x < 0)
                x = 0;
            this.outputText("", true);
            this.outputText("Completely defeated, the haughty demoness lies face down in the dirt, ", false);
            if (this.monster.HP < 1)
                this.outputText("her tail hanging limp between her legs.  She spits a wad of bloody saliva and says, \"<i>What's the matter?  Beat a girl senseless and lose your nerve?  I thought you were going to rape me.</i>\"", false);
            else
                this.outputText("her rump up in the air while her tail plunges violently into her cunt over and over again.  She moans up to you, \"<i>What's the matter?  Are you nervous about putting it inside me?  Come on... rape me already!  Punish my gushing-wet cunt with your divine rod!</i>\"", false);
            this.outputText("\n\nYou reach down and slap her ass hard, ", false);
            if (this.player.str < 75)
                this.outputText("making her whole body jiggle", false);
            else
                this.outputText("making her jiggle and slide a few inches in the dirt", false);
            this.outputText(" and shutting her up while you tear off your " + this.player.armorName + ".\n\n", false);
            this.outputText("Now naked, you waste no time in grabbing her by her toned thighs and lifting her up, rubbing her face in the dirt while you get a nice look at her tightly-clenched asshole and ", false);
            if (this.monster.HP < 1)
                this.outputText("wet ", false);
            else
                this.outputText("achingly wet ", false);
            this.outputText("demon-twat.  Her vulva flares out, massively engorging and unfolding like a flower, practically begging you to plunge into the dripping tunnel.\n\n", false);
            this.outputText("\"<i>Nooooo... don't stick it in my pussy!  You'll get me pregnant!  Or is that what you're after?  Are you gonna keep cumming in my naughty hole until I'm too pregnant to move?  Is that your plan, champion? Are you going to keep all the demons too pregnant to resist you?  Look at how wet you've made my pussy... I'm a high class demon, y-you can't make me pregnant!  Nooooo,</i>\" groans Ceraph while her tail wraps around your " + this.cockDescript(x) + ", clearly trying to entice you, but you've got a surprise in store for her.\n\n", false);
            this.outputText("You rub your " + this.player.cockHead(x) + " against the demonic juice-fountain, letting Ceraph slather you with corrupted lubricants while you tease her whorishly-ready fuck-lips.  In seconds you're soaked from tip to hips, and before Ceraph can con you into filling her full of demonic children, you drop her low and ram your " + this.hipDescript() + " forward.  Her pucker, though tight, yields before your onslaught, gradually dilating to accept your " + this.player.cockHead(x) + " and the first few inches of your " + this.cockDescript(x) + ".", false);
            if (this.player.cockTotal() == 2)
                this.outputText("  The other " + this.cockDescript(x) + " rubs against her butt-cheeks, sliding through them with ease thanks to her copious secretions.", false);
            else if (this.player.cockTotal() > 2)
                this.outputText("  The rest of your male genitals slide between the demoness' pert butt-cheeks in one huge, femcum-slicked bundle.", false);
            this.outputText("  Ceraph squeaks in distress, taken completely by surprise and for once, completely lacking a witty retort.\n\n", false);
            this.outputText("The demon grunts like a wounded animal underneath you, her long, demonic tongue hanging out to flop in the dirt while you rock her half-comatose form closer to your crotch.  Inside, your " + this.player.cockHead(x) + " squeezes past the tightness of her anal ring to the unusual warmth of a demon's innermost depths.  More and more of your " + this.cockDescript(x) + " slips into the wonderfully tight, hot little hole, the penetration growing ever easier as the defeated demon relaxes into her role as a cum-dump unworthy of your children.", false);
            if (this.monster.HP < 1)
                this.outputText("  Cunt-juice splatters over your " + this.player.legs() + " as Ceraph's now-energetic tail plunges into her sodden box, pumping into it in time with the penetration of her asshole.", false);
            else
                this.outputText("  Cunt-juice dribbles over your " + this.player.legs() + " as Ceraph's tail slowly and purposefully plows her box, mimicking the penetration of her asshole.", false);
            this.outputText("\n\n", false);
            this.outputText("Ceraph whimpers and begs, \"<i>Noooo... you're raping my ass... g-get it out of there!  Aren't you supposed to be p-pure?  Untainted?  You're – unf – fucking a demon's butt like some kind of pervy animal!  Please... f-fuck my pussy.  I don't even mind if you don't wash it off... just stick it in my cunt.</i>\"\n\n", false);
            this.outputText("Like hell!  You pull harder, splitting her asscheeks until they're squished into your body, her cock-gaped asshole ", false);
            if (!this.player.hasSheath())
                this.outputText("barely touching your groin", false);
            else
                this.outputText("rubbing your sheath", false);
            this.outputText(".  The demon's ass is warm enough to make you feel you could melt like an icicle in an oven, the blissful sensations spurring you to play with her supple ass-cheeks while you enjoy the complete penetration of a demon's backdoor.  You give those cheeks a hard slap and pull back, enjoying the feel of her gloriously tight ring as it slides over the pussy-slicked length of your " + this.cockDescript(x) + ".\n\n", false);
            this.outputText("Without waiting, you slam it back home, burying it in the swelteringly hot backside.  Ceraph grunts, her tail locked in time with you and clearly bringing her great pleasure.  You take the time to reach down and pull it out – if she's going to cum, she's going to cum to the feel of you packing her bowels full of wasted seed.  She cries in distress, \"<i>Noooooo... fuck you!  Please... at least let me cum from this.  You're fucking me so dominantly... so hard... by Lethice it's making me so soaking wet.  Please!  Let me cum, let me cum... letmecumletmecumletmecum!</i>\"\n\n", false);
            ...
            this.outputText("Ropes of jism splatter into the demon's rectum, and while it turns her tight back-door into a drooling wet fuck-hole, it actually lowers the temperature to a saner threshold.  ", false);
            if (this.player.cumQ() >= 500 && this.player.cumQ() < 1500)
                this.outputText("Her belly bulges slightly from the cummy deposit, marking her even more obviously as a cum-bucket for your cock.  ", false);
            else if (this.player.cumQ() >= 1500)
                this.outputText("Her belly burbles and swells, bulging out to look positively pregnant, though you know she's packed from the other end.  ", false);
            this.outputText("You pull out, and Ceraph's ", false);
            if (this.player.cocks[x].cockThickness < 3)
                this.outputText("slightly-gaped", false);
            else if (this.player.cocks[x].cockThickness < 5)
                this.outputText("gaped", false);
            else
                this.outputText("gaping-wide", false);
            this.outputText(" asshole leaks spunk everywhere. Disgusted with her", false);
            if (this.player.cor < 33)
                this.outputText(" and a little bit by yourself", false);
            this.outputText(", you drop her like a discarded rag.  She moans and begins masturbating, half-insensate from the rough treatment.  You ignore her, get dressed, and get out of there before the mountain's beasts show up.  Ceraph is in for a wild night!", false);
            this.player.orgasm();
            if (this.getGame().inCombat)
                this.cleanupAfterCombat();
            else
    ...
    exports.CeraphScene = CeraphScene;
});
//# sourceMappingURL=CeraphScene.js.map