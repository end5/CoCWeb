define(["require", "exports", "./NPCAwareContent", "../../GlobalFlags/kFLAGS", "./Kiha", "../../../../includes/appearanceDefs", "../../CockTypesEnum", "../../Appearance", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, kFLAGS_1, Kiha_1, appearanceDefs_1, CockTypesEnum_1, Appearance_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class KihaScene extends NPCAwareContent_1.NPCAwareContent {
        /*FLAGS STUFF*/
        ...
        encounterKiha() {
            ...
            if (this.kihaFollower.followerKiha() && this.flags[kFLAGS_1.kFLAGS.KIHA_NEEDS_TO_REACT_TO_HORSECOCKING] == 1) {
                this.kihaFollower.kihaReactsToHorseDicking();
                return;
            }
            //kihaBitchesOutCorruptPCs()
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION_LEVEL] > 0 && this.player.cor >= 66 && this.flags[kFLAGS_1.kFLAGS.KIHA_CORRUPTION_BITCH] != 1) {
                this.kihaFollower.kihaBitchesOutCorruptPCs();
                return;
            }
            //kihaUnBitchesOutCorruptPCs()
            if (this.player.cor < 66 && this.flags[kFLAGS_1.kFLAGS.KIHA_CORRUPTION_BITCH] == 1) {
                this.kihaFollower.kihaUnbitchesUncorruptedFolks();
                return;
            }
            //Friendly+ meeting
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION_LEVEL] >= 1 && this.flags[kFLAGS_1.kFLAGS.KIHA_CORRUPTION_BITCH] != 1) {
                if (this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION_LEVEL] == 2 && this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION] >= 100 && this.flags[kFLAGS_1.kFLAGS.KIHA_MOVE_IN_OFFER] == 0) {
            ...
            //*Repeat Encounter - PC WAS VICTORIOUS LAST FIGHT 
            else if (this.flags[kFLAGS_1.kFLAGS.PC_WIN_LAST_KIHA_FIGHT] == 1) {
                ...
                this.outputText("As she screams out in defiance, she charges you, giving you barely enough time to ready yourself for combat!", false);
                //Clear 'won last fight' toggle
                this.flags[kFLAGS_1.kFLAGS.PC_WIN_LAST_KIHA_FIGHT] = 0;
                this.startCombat(new Kiha_1.Kiha());
            }
            //Tribute Offer (1st Time) - Req's Kiha not be mad and PC suggested it at some point. 
            else if (this.flags[kFLAGS_1.kFLAGS.KIHA_TOLL] == 1 && KihaScene.rand(2) == 0) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.KIHA_TOLL] > 1 &&
                (this.flags[kFLAGS_1.kFLAGS.KIHA_TOLL_DURATION] == 1 ||
                    (this.flags[kFLAGS_1.kFLAGS.KIHA_TOLL_DURATION] == 0 && KihaScene.rand(2) == 0))) {
                this.outputText("Kiha steps out from behind a tree with her axe on her back and her arms folded across her sizable chest.  \"<i>If you want to explore my territory again, you'll need to pay the fee,</i>\" she flatly states.  This is absurd - she wants more gems already?  You'll go broke like this, AND it was your idea to begin with!  What do you do?", false);
                temp = this.payKihaTribute;
                if (this.player.gems < 200) {
            ...
            //Generic Repeat Encounter 
                ...
                this.outputText("\"<i>Don't even start,</i>\" she commands, advancing on you as she continues, \"<i>I told you to avoid my domain and yet you ignored my imperative and returned.  You may be a fucking masochist or a retard, but trust me, you won't enjoy this.</i>\"\n\n", false);
                if (this.flags[kFLAGS_1.kFLAGS.KIHA_TOLL] == 0) {
        ...
        offerToBuyPassageFromKiha() {
            this.outputText("", true);
            this.spriteSelect(72);
            this.outputText("You jingle your gem pouch and ask if you could pay her to allow you passage.  Kiha shoulders her axe and scratches at one of her horns, mulling the idea over.  She stops and abruptly shakes her head.  \"<i>Not today.  Now scram, before I change my mind!</i>\"\n\n", false);
            //(Unlocks toll option next encounter)
            this.flags[kFLAGS_1.kFLAGS.KIHA_TOLL] = 1;
        ...
        meetKihaAndFight() {
            this.outputText("", true);
            this.spriteSelect(72);
            this.outputText("You step closer and proclaim that you go where you please.  Kiha snorts and says, \"<i>Cute.  Sadly, misplaced confidence will only make this hurt that much more.</i>\"", false);
            //(START COMBAT)
            this.startCombat(new Kiha_1.Kiha());
        }
        //[Ask Why]
        ...
        payKihaTribute() {
            this.outputText("", true);
            this.spriteSelect(72);
            this.outputText("You sigh and pay her 200 gems.  She doesn't even mention that it was originally your idea, but still, you're getting what you want - the ability to explore her territory unhindered.  Of course, you have no idea how long this 200 gems will last.\n\n", false);
            //(gems -= 200;)
            this.player.gems -= 200;
            this.flags[kFLAGS_1.kFLAGS.KIHA_TOLL_DURATION] = 3 + KihaScene.rand(4);
            //Count times paid
            this.flags[kFLAGS_1.kFLAGS.KIHA_TOLL]++;
        ...
        kihaExplore(clearScreen = true) {
            if (clearScreen)
                this.outputText("", true);
            //spriteSelect(72);
            this.flags[kFLAGS_1.kFLAGS.KIHA_TOLL_DURATION]--;
            var event = KihaScene.rand(10);
            var itype;
            //Grabbin' Inquisitor Armor
            if (event == 0 && this.flags[kFLAGS_1.kFLAGS.GOTTEN_INQUISITOR_ARMOR] == 0) {
                kGAMECLASS_1.kGAMECLASS.inquisitorRobesDiscovery();
                return;
            }
            if (event < 5) {
            ...
            //Reducto
                ...
                itype = this.consumables.REDUCTO;
            else if (event < 8)
                itype = this.consumables.GROPLUS;
            else if (event < 9)
                itype = this.consumables.COAL___;
            else if (event < 10)
                itype = this.useables.T_SSILK;
        ...
        tellKihaTributeWasYourIdea() {
            this.outputText("", true);
            this.spriteSelect(72);
            this.outputText("You ask why she changed her mind about your idea.  Kiha's face screws up for a moment, her chocolate-hued visage distorting into an irritated grimace.  This may have been a mistake.  She screams, \"<i>As if someone like you would have an idea worthy of being adopted by me!  I forgot about your insignificant offer as soon as I was away from you.  This tribute was devised solely with my own sizable wit and cunning!</i>\"\n\n", false);
            this.outputText("The dragon-girl yanks her axe from her back and twists her hands, making the edge glow orange in the murky swamp air.  \"<i>You should've kept your mouth shut, worm.  The offer is off the table now!  The only thing I'll trade you is pain!</i>\"", false);
            this.startCombat(new Kiha_1.Kiha());
        }
        //*Generic PC Victory Introduction: 
        kihaVictoryIntroduction() {
            this.flags[kFLAGS_1.kFLAGS.PC_WIN_LAST_KIHA_FIGHT] = 1;
            this.outputText("", true);
            this.spriteSelect(72);
            this.outputText("Kiha sways back and forth for a moment, then drops her axe with numb hands.  As soon as she does, the hot glow of the weapon's cutting edge fades to silver, and the weapon lands with a heavy 'thunk' ", false);
            if (this.silly())
                this.outputText("(like Urta's cock!) ", false);
            this.outputText("in the dirt.  The dragoness drops to her knees and slumps back against a tree, her limbs trembling ", false);
            if (this.monster.lust > 99)
                this.outputText("with lust", false);
            else
                this.outputText("weakly", false);
            this.outputText(" as she tries to rise.\n\n", false);
            //(Lust) 
            if (this.monster.lust > 99)
                this.outputText("\"<i>You... can't make me like it!,</i>\" she shouts, struggling with all her might to keep her hands away from her genitals.  Somehow, she seems to be managing.", false);
            //(HP) 
            else
                this.outputText("\"<i>You... you... haven't... beaten me,</i>\" she mutters, even though it's quite clear that you have.", false);
            //(no new PG) 
            ...
            if (this.player.hasCock()) {
                if (this.player.cockThatFits(this.monster.vaginalCapacity()) != -1 && this.player.lust >= 33) {
                    ...
                    if (this.player.cockThatFits2(this.monster.vaginalCapacity()) != -1 && this.player.cockTotal() > 1)
            ...
            this.choices("Masturbate", forceMasturbate, "Use Tail", useHerTail, "FuckHerPussy", fuckHer, "FuckHerAss", buttFuck, "Talk", wordRape, "", undefined, "", undefined, "", undefined, "", undefined, "Leave", this.cleanupAfterCombat);
        }
        ...
        kihaLossIntro() {
            ...
            if (this.player.lust > 99)
                this.outputText("You give up on fighting, too horny to keep fighting.  Kiha strikes the ground with her axe and snorts out a puff of smoke.  \"<i>What a shameless slut!  You're lusting after me even in the heat of battle, like a common imp!  You aren't worthy to lick between my foot-claws!</i>\"\n\n", false);
            //(HP)
            else
                this.outputText("You collapse, too wounded to keep fighting.  Kiha strikes the ground with her axe and snorts out a puff of smoke.  \"<i>What a wimp!  I've barely started fighting and you're already beaten!</i>\"\n\n", false);
            //33% of tit-milk humiliation if applicable.
            if (this.player.biggestLactation() >= 2)
                this.kihaMilkTitHumiliation();
            //Rape texts if horny
            else if (this.monster.lust >= 50) {
                this.outputText("The dragoness sighs and glances around.  \"<i>Since you weren't able to satisfy me in battle, let's see if you have anything else to offer...</i>\"\n\n", false);
                this.outputText("Leaving her axe to rest a few feet away, stuck on the ground, Kiha strips off your " + this.player.armorName + " revealing your ", false);
                if (this.player.hasCock())
                ...
                //*Herm - Adj
                    ...
                    this.kihaRapesLittleGirlsISawItOnTheNews();
            }
            //If not horny, get a beating!
            else {
                this.outputText("Kiha pulls her axe back in a two handed grip, and you're sure the moment of your death is upon you.  A moment later, the flat of the blade slams into your head, knocking you unconscious.", false);
        ...
        kihaMilkTitHumiliation() {
            ...
            this.spriteSelect(72);
            if (this.player.lust > 99)
                this.outputText("You slide to the ground, too turned on to fight and openly touching yourself.", false);
            else
                this.outputText("You slide to the ground, too defeated to continue to fight.", false);
            this.outputText("  Kiha snorts, expelling a tiny burst of flame and smoke from a nostril as she towers over your prone body.\n\n", false);
            this.outputText("\"<i>This is it?</i>\" the dragoness asks, looking down at you.  \"<i>Are you sure you shouldn't be hanging around the lake with the other lumps of goo?  I think it would be more your speed.  I even hear there's a farm there.  Maybe they'd appreciate your ridiculous, milky fun-bags there.  They could even give you a stall with your name on it, 'Tit-cow'.  I bet you'd like that.</i>\"  She calmly peels the top half of your top away to reveal your milk-dripping nipples.\n\n", false);
            this.outputText("Kiha recoils at the drops of white beading atop your " + this.nippleDescript(0) + " and asks, \"<i>Do you really think that's hot?  It's disgusting.  A perversion of the body only a sick... MAMMAL would enjoy.</i>\"\n\n", false);
            this.outputText("The scaly woman leans down to tug on your " + this.nippleDescript(0) + "s in turn, laughing every time a spurt of milk erupts from one of your tits.  Each rough squeeze sends shivers of erotic sensation through your body, and you quickly grow aroused from the rough treatment.  Kiha keeps going, ", false);
            if (this.player.hasCock())
                ...
                this.outputText("not noticing the flush of your skin", false);
            this.outputText(" as she callowly milks your breasts.  She isn't even blushing; if anything, her expression reminds you of a child playing with a new toy.  Kiha isn't aroused by this at all!\n\n", false);
            this.outputText("An even harder tug releases a thick squirt of milk that makes you moan.  The dragoness recoils at the sound of your pleasure, asking, \"<i>Are you getting off on this?  Oh... by Lethice, YOU ARE!  You may as well moo while you're at it, you fucking dairy-cow.</i>\"  Kiha grows rougher with your nipples, stretching and pinching them just hard enough to make you feel even better.  You squirm beneath her none-too-gentle tugs, wincing each time she yanks too hard.\n\n", false);
            this.outputText("*SMACK*\n\n", false);
            this.outputText("Her hand cracks across your face, leaving a red print where it hits you.  \"<i>I said you should moo, cow.</i>\"\n\n", false);
            this.outputText("You blink away the tears that well up and nod, making a quiet, barely audible 'moo'.\n\n", false);
            this.outputText("\"<i>What's that?  Speak up, or I might milk you hard enough to rip one of these udders off,</i>\" threatens Kiha with a sadistic smile.  You immediately moo, louder this time.  She rewards you with a quick pump on your udders, squirting more milk into the air.  You shiver, growing more and more turned on with every splatter of creamy white that's forced from your body.\n\n", false);
            this.outputText("Kiha keeps at it, milking your nipples until they're almost dry and making you moo so loud that surely someone else can hear.  You feel utterly defeated and humiliated.  You feel like a cow.  Yet, you're so horny and your sore nipples are so sensitive that you feel like you're about to cum.  The dragoness must recognize the look in your eyes, because she stops and wipes her hands off in your hair.\n\n", false);
            this.outputText("Kiha declares, \"<i>All done, cow.  Now let me take a few gems for my trouble and send you back to your farm.</i>\"  She rifles through your gem pouch, but you can't stop her.  You're too weak and horny.  The bag lands on your belly as Kiha delivers one last tweak to your abused mammaries, pulling out a weak drip and matching 'moo' from your lips.  She laughs uproariously at that and departs.\n\n", false);
            this.outputText("You trudge back to camp, replaying the erotic torture over and over in your over-sexed mind.  You just can't shake it, and once you get safe, you wind up spending hours masturbating, mooing over and over while you play with your body and further abuse your milky tits.  ", false);
            if (this.player.cor < 33)
                this.outputText("How far you've fallen.", false);
            else if (this.player.cor < 66)
                this.outputText("How confusing this all is.  Why can't things be simple like they were back home?", false);
            else
                this.outputText("Damn, that was hot.", false);
            this.player.orgasm();
        ...
        kihaGenderlessBeating() {
            this.spriteSelect(72);
            this.outputText("\"<i>What a pussy!</i>\" she yells at you, noticing your lack of any gender upon denuding you.  \"<i>What's the problem, runt? Too scared that evil imps and goblins will abuse you?</i>\"  She hits the ground with her tail in frustration and grabs her axe. \"<i>What a waste of time. You're useless both in battle and out of it.</i>\"  She begins kicking you, eventually hitting you hard enough to knock you unconscious.", false);
            this.player.takeDamage(1000);
            this.cleanupAfterCombat();
        }
        //*Male - Adj
        kihaRapesMen() {
            ...
            if (x < 0)
                x = 0;
            this.outputText("You try to rise, but the dragon girl whips around, her long, thick tail delivering a subduing crack against the side of your head, dropping you back onto your " + this.buttDescript() + ".  Triumphantly standing over you, the scaled woman eyes you with a panting breathlessness that betrays the coldness in her gaze.  She squints, arcing an imperious eyebrow as she looks you up and down, drawing her hands back to shoulder level and barely brushing against her breasts.  Her tail lashes back and forth between her legs, wrapping around her calves as she lifts a clawed foot and rests it lightly upon your stiffening groin.  Apparently, your fight left her wanting more than just your gems.  Her flexible toes squeeze your " + this.multiCockDescriptLight() + " through your " + this.player.armorName + ", and she snorts in derision.  \"<i>This is it, huh?  Pathetic.  I'm going to have to do all the work if I have any hope of you satisfying me.</i>\"\n\n", false);
            this.outputText("With a swift kick to your collarbone, Kiha knocks you on your back and stands over you, her vulva swollen with excitement despite her frosty insults.  She opens your " + this.player.armorName + " with her long, clenching talons just enough to expose " + this.sMultiCockDesc() + ".  The dragoness curls her tail between her legs, the warm, scaled surface of the dexterous limb rubbing your tender flesh impatiently, tip flicking " + this.oMultiCockDesc() + " before coiling around the crest of your cockhead.  The narrow point of her backside pokes at your urethra, parting the narrow slit and tickling the sensitive, silken interior to draw a weak gasp from you.  \"<i>Yeah, I bet you'd love to get penetrated,</i>\" she scoffs, wrapping her hands around the thick girth of tail poking between her thighs like a massive, scale-textured cock.  She strokes the fat plates and thumbs the ridge-like nobs lining its underside with a hip-swaying motion that sends her chest wobbling.  \"<i>But,</i>\" she continues, her tail lifting off of your " + this.multiCockDescriptLight() + " and curling upwards, \"<i>this isn't about what you want.</i>\"\n\n", false);
            this.outputText("Kiha's haunches clench, and the wriggling rudder between her legs snakes upward, pressing firmly against her inflamed nethers - the plush, dusky lips of her pussy pliant to the touch of her scarlet extremity.  The tip that teased your cock a moment ago instead wraps itself around her clitoral hood, pulling her foreskin-like sheath back to expose the button-stiff joybuzzer.  In tightening circles, the dragon girl stimulates herself over you, her lips curled into a crooked grin as she rests her hands on her hips.  ", false);
            if (this.player.isNaga() || this.player.tailType == appearanceDefs_1.TAIL_TYPE_LIZARD)
                this.outputText("\"<i>Heh, if you had half as much dexterity as you do impudence, I'd let you do this for me.  Fat chance of that,</i>\" she remarks off-handedly.  ", false);
            this.outputText("Before long, her cunny practically drools, but you're not sure what she's getting off on more, the tail teasing her clit or your dick stiffening uncontrollably at her feet.  She grins, more to show her teeth than in pleasure, and begins to feed her tail into her snatch, the girl's folds parting eagerly to the rough limb, her honeypot polishing her scales to a liquid gleam almost immediately.  As she pumps long, slow thrusts inside herself, Kiha shifts to one leg, bringing her adept foot to your " + this.cockDescript(x) + " once more", false);
            if (this.player.balls > 0)
                this.outputText(", resting the heel of her foot against the swell of your " + this.ballsDescriptLight() + " and applying just enough pressure to feel the cum churning within", false);
            this.outputText(".  \"<i>Ah! J- just stay ri- ri- right there!</i>\" she commands, as her tail picks up the pace.  \"<i>I'll attend to y-y-you in a m-m... Aaah! Minute,</i>\" she coos, pumping herself to the verge of climax.  Clenching her eyes and balling her hands into fists, the dragoness impales herself on the pistoning appendage, and chokes back a shuddering moan as she bottoms out and creams a crystal polish of girl cum across it, which wicks down and coats her scaled posterior with a shimmering veneer. \"<i>Ahhhaaa...</i>\" she shudders.  \"<i>Now then, at least I'll have cum once today if you prove to be as worthless at fucking as you were at fighting.</i>\"\n\n", false);
            this.outputText("The dragon girl's little show has already brought you to full mast and the pad-like scales of her foot rubbing up and down your length has you rock hard, helplessly twitching under her heel.  She hooks her long toes around your pulsing tip and pulls your " + this.cockDescript(x) + " into the air, straining shaft rising in obedience to her demands.  Reluctantly withdrawing the tail from her slavering slit, Kiha crouches down until your flesh spear is parallel with her belly. She inches forward, your crown just a hair's breadth from her pussy and she makes a \"<i>tut</i>\" sound in the back of her throat.  \"<i>Considering the shitty battle you gave me, you certainly don't deserve this hole, nor any chance at fathering children.</i>\"  Despite her contempt, her lower lips splatter your " + this.cockDescript(x) + " with the warm, liquid bounty of the dragon girl's vigorous masturbation.  You shudder at the heat showering your groin, unsure how much more teasing you can take.  Sliding forward a bit more, the victorious woman guides her narrow pucker over your throbbing meat.  \"<i>This should be more your speed, little fairy,</i>\" she taunts, before plunging herself onto your manhood.\n\n", false);
            ...
            //[Lizard/naga tail: 
            if (this.player.isNaga() || this.player.tailType == appearanceDefs_1.TAIL_TYPE_LIZARD)
                this.outputText(" while your tail curls around to find your own asshole.  The grip of the dragon's nethers so intense, you barely feel the pressure of your own tail, pushing in easily to soothingly stroke your overtaxed prostate", false);
            ...
            if (this.player.balls > 0)
                this.outputText(", your " + this.ballsDescriptLight() + " practically leaping in over-burdened joy as their heavy load rushes through your flesh", false);
            this.outputText(".  A geyser of hot spunk sprays from your " + this.cockDescript(x) + ", flooding her innards with the excruciatingly hefty torrent of seed all her teasing and abuse built within you.", false);
            if (this.player.cockTotal() > 1) {
                if (this.player.cockTotal() > 2)
                    this.outputText("  Your unoccupied shafts spray ropey strands of cum all around you, jerking and straining under the weight of the dragoness.", false);
                else
                    this.outputText("  Your unoccupied shaft sprays ropey strands of cum all around you, jerking and straining under the weight of the dragoness.", false);
            }
            this.outputText("  She pulls her sphincter tight to keep the fountaining jizz inside her and jams her tail half way down your throat until the thick flesh can't fit past your jaw anymore.  She wriggles the limb within you and pants sadistically as the bulge in your neck slides another inch deeper.  You begin to choke.\n\n", false);
            this.flags[kFLAGS_1.kFLAGS.KIHA_CHOKED_OUT_PC] = 1;
            this.outputText("\"<i>Fill my ass with that cum,</i>\" she purrs, forgetting her hostile attitude for a moment.  \"<i>I want to feel it in my belly.</i>\"  You can't help but comply, your suffocation-induced panic lending strength to your orgasm until her abdomen distends under the weight of your seed.  Before you black out, you can see her hooking four long, clawed fingers up into her pussy, while her thumb frantically jills her dusky clit.  Then, only darkness.\n\n", false);
            this.outputText("When you come to, your throat feels raw, the taste of her pussy still on your lips.  Surprisingly, your groin is wet, but not sticky, without a trace of semen anywhere.  She must've licked " + this.sMultiCockDesc() + " clean after you passed out.  Your " + this.hipDescript() + " are still sore from the wild woman's ride, so it takes you longer than usual to limp your way back to camp.", false);
            this.player.orgasm();
            this.cleanupAfterCombat();
        }
        //*Herm - Adj
        kihaRapesHerms() {
            ...
            //LEGS: 
                ...
                this.outputText("Hooking a leg under one of yours", false);
        ...
        tsundereMasturbationChristmasCarol() {
            this.outputText("", true);
            this.spriteSelect(72);
            this.outputText("You walk towards the draconic woman, removing your " + this.player.armorName + " as you observe her firm, ", false);
            if (this.player.lust > 99)
                this.outputText("wanton", false);
            else
                this.outputText("but dispirited", false);
            this.outputText(" figure slumping against the weathered bark behind her.  She eyes you carefully, trying to comprehend the situation before catching note of your ", false);
            if (this.player.gender > 0)
                this.outputText("aroused genitals", false);
            else
                this.outputText("distinct lack of genitals", false);
            this.outputText(".\n\n", false);
            //If Multi/Herm
            if (this.player.cockTotal() > 1 || this.player.gender == 3)
                this.outputText("\"<i>W-what are you going to do, you freak of nature?  If you make me play with those, I swear... I swear I'll hit you!</i>\"", false);
            //If Cock
            else if (this.player.hasCock())
                this.outputText("\"<i>G-get that away from me!  As if I'd want anything to do with your hard, juicy cock!  Idiot!</i>\"", false);
            //If Vagina
            else if (this.player.hasVagina())
                this.outputText("\"<i>What do you think you're going to do with that pathetic, dripping pussy, huh?  I swear, if you make me l-lick that thing...</i>\"", false);
            //If Genderless
            else
                this.outputText("\"<i>H-huh?  Why the hell are you coming closer?  How can you possibly do anything when you're as smooth as a board down there, you loser!</i>\"", false);
            this.outputText("  Today, however, you don't have any plans to fuck her directly", false);
            if (this.player.gender == 0)
                this.outputText(", and seeing as you don't have anything to fuck her with, it's not like you could", false);
            this.outputText(".  Without saying a word, you walk behind her, slouching in between the tree and her warm figure as you scoot yourself closer.  She desperately tries to turn around to look behind her, but she appears to be too weak to even move her neck.  In only moments, you've managed to lay against the tree, with the feeble dragon-girl sitting down comfortably on your lap ", false);
            if (this.player.tallness < 72)
                this.outputText("- though you're hidden behind her tallness", false);
            else
                this.outputText("- though you're much taller than her", false);
            this.outputText(".  The dragoness attempts to struggle against you, but she's far too enervated to move.  \"<i>What are you doing?  I don't fucking understand you!  What are yo-</i>\" before she can continue to berate you, you cut her off by moving her head towards your own and kissing her firmly on the lips.  Her eyes widen in surprise, but soon lower as she begins to reciprocate the notion.  You lock lips for what seems like ages, long enough that when you part, a single rope of saliva remains, connecting the two of you together.\n\n", false);
            this.outputText("The girl tries to speak, but you reach down towards her nether region, placing two fingers along the smooth of her belly and slowly creeping lower and lower, eliciting a small gasp from your victim as you reach her moist entrance.  She manages to reach out and grasp your hand, tensing as you begin to stroke her wetness, already lubricated by her juices.  You chuckle, announcing that she must've been turned on by the kiss - if she wasn't wet already, she sure as hell is now.  \"<i>N-no!  You're... you're wrong...</i>\" the dragon-girl stammers, though she finds herself unable to continue while you increase the speed of your heavy petting.  The draconic woman is a slave to your nimble fingers, with any attempt to stifle her moans ultimately failing as an odd yelp or gasp escapes her pouting lips.  With a gentle push you enter inside her, your panting toy clamping her legs shut against your probing fingers.\n\n", false);
            this.outputText("You notice the dragon-girl's warm breath pervade the air as you feel the warmth of her insides, her slick tongue beginning to drool out of her mouth from the sensation of her moist lips being invaded by your stern hand.  The aroused state of her nipples poking up into the humid air give you an idea, as you take your free hand and begin to grope and massage the breasts in between your fingers.  The teats perk to your ministrations while you roughly squeeze her heaving bosom, almost as if to milk her like a cow.  A grunt escapes your lips as you rub your ", false);
            if (this.player.hasCock()) {
                this.outputText(this.multiCockDescriptLight() + " against her soft flesh, ", false);
                if (this.player.cockTotal() == 1)
                    this.outputText("a small bead of pre-cum forming from the tip and slathering her back with your juices.", false);
                else
                    this.outputText("small beads of pre-cum forming from the tips and slathering her back with your juices.", false);
            }
            else
                this.outputText(this.nippleDescript(0) + "s against the hard ridges of her back, your tongue softly licking her smooth skin.", false);
            this.outputText("  You increase the pace of your movements, plunging your fingers in and out of her dripping pussy while your free hand tweaks and rubs the hardened button of one of her cushiony breasts.  The dragoness squirms and convulses underneath your touch, biting her lip while she becomes a slave to your manipulations.  \"<i>I... I'm not enjoying this... n-not with someone like you!</i>\" she manages to growl, her admirable resistance only giving you the desire to plunge her further into a world of pleasure.  You fit a third finger into her tight hole, the heat of her walls clenching against you like a velvet furnace.  You reach down and kiss her a second time, deciding to go about it more passionately as you probe your tongue inside, wrapping it around her own.\n\n", false);
            this.outputText("There's nothing your hot and bothered slave can do outside of melting underneath the heat of your own body, the irony of the dragon-girl losing in a game of passions lost in the rough, commanding movements of your hands and the taste of her plush lips against your own.  You're intertwined as a single being of pure lust under the shade of the tree, which ends as soon as it began when the draconic beast-girl shudders in pleasure, signalling her release.\n\n", false);
            this.outputText("Her moist juices flush from beneath her, drenching your fingers in her essence.  She slowly removes her lips from yours, moving closer towards you", false);
            if (this.player.hasCock()) {
                this.outputText(" and accidentally brushing against your trembling genitals, pushing you hard enough to cause you to ejaculate against her backside", false);
                this.player.orgasm();
            }
            this.outputText(".  The girl sighs in relief, tuckered out more from the sensual experience than the battle itself.  You slowly remove yourself, leaving the tired girl underneath the tree to rest.\n\n", false);
            this.outputText("\"<i>I... hate you... </i>\" she whispers, before turning in for a deep slumber.  You watch her soft face as she snores, graceful as a pig, before walking back to camp.", false);
            if (!this.player.hasCock())
                this.dynStats("lus", 120);
            this.cleanupAfterCombat();
        }
        ...
        kihaVictoryPomfTail() {
            ...
            if (this.monster.lust > 99)
                ...
                this.outputText("wounded ", false);
            this.outputText("dragoness full of wicked ideas.  For her part, she looks up at you with a defiant gaze, as if it would somehow dissuade you from the sexual thoughts now guiding your body.  You circle to the side and reach down, grabbing her wriggling tail with both hands.  Kiha tries to pull it out of your hands, but in her weakened state, all it does is weakly flop like a caught fish.  Laughing, you smack her in the face with her own scaly hind-bits before you drop it.  You know just how you'll put that rudder to use, but first you've got to shuck your " + this.player.armorName + ".\n\n", false);
            this.outputText("The gear lands behind you in a bed of moss", false);
            if (this.silly())
                this.outputText(" with a pomf =3", false);
            else
                this.outputText(".", false);
            this.outputText("  Now nude, you sway your " + this.hipDescript() + " back and forth sensually, forcing Kiha to watch your body before you use her.  ", false);
            if (this.player.biggestTitSize() <= 4)
                this.outputText("She looks away and blushes as she says, \"<i>It's not like I'd find such tiny breasts attractive!</i>\"  Her mannerisms seem to indicate that she does.", false);
            else if (this.player.biggestTitSize() <= 12)
                this.outputText("She sighs and says, \"<i>As if I'd be impressed by udders like those!</i>\"", false);
            else
                this.outputText("She laughs and taunts, \"<i>How do you even walk with ridiculous hooters like those?  Go on, moo, cow!</i>\"", false);
            this.outputText("  You tire of her constant insults and inability to face facts.  A-ha!  You grab your underwear and ball it up, noting the pungent smell of your sweat and sex.  The scaly slut recoils, but you close in and stuff the musky undergarments in her mouth, ignoring her struggles as you grab some vines and bind her arms.  Perfect!\n\n", false);
            this.outputText("Kiha's eyes well up with tears while her eyebrows stay locked in a perpetually angry glare.  At the same time, you begin to hear fluids dripping down to the ground.  You surreptitiously glance below and confirm that your initial thought was correct - she's gotten much wetter after having to suck on your pussy-", false);
            if (this.player.hasCock())
                this.outputText(", cum-,", false);
            this.outputText(" and sweat-soaked underwear.  The black, crimson-embedded slits of her eyes narrow in barely suppressed rage, but as she is now, she's no threat to you.\n\n", false);
            this.outputText("You reach back down and once again take hold of the rebellious dragon's tail.  \"<i>I'm going to get myself off.  Perhaps if you had been more agreeable I might have considered helping you out too.  Now, if you don't mind, I think this nice, ribbed tail-dildo should work just fine.</i>\"  You twist her squirming appendage about and rub the thicker bottom scales over your lower lips, your body shivering from the pleasure.  As you slide the hot, scaled pretend-penis along your femininity, it ", false);
            if (this.player.wetness() <= 3)
                this.outputText("grows wet", false);
            else if (this.player.wetness() <= 4)
                this.outputText("quickly grows slimy", false);
            else
                this.outputText("immediately becomes soaked from your constant drippings", false);
            this.outputText(".\n\n", false);
            this.outputText("Satisfied that it is sufficiently lubricated, you squeeze the now-slippery tail and point its nubby tip at your entrance.  It bumps your " + this.clitDescript() + " as you wrangle with the struggling hind-limb, only turning you on all the more.  Feeling the tip circling your tunnel's opening, you push it up and seat the tentacle-like tail deep inside yourself.  ", false);
            this.player.cuntChange(1, true, false, true);
            this.outputText("Gods she's so... warm, and the ridges, they're stroking every inch of your interior, even your g-spot!  Your " + this.player.legs() + " wobble unsteadily, but spurred by lust, you keep an iron grip on your new-found toy.  Kiha doesn't stop resisting either.\n\n", false);
            this.outputText("Leaning back against the tree the dragon previously occupied, you slide down, letting your " + this.player.legs() + " go completely nerveless.  Kiha's struggles unintentionally add to your pleasure, turning her tail into the world's warmest, most powerful vibrator.  Your hands begin to push more of her girthy thickness inside, stretching your poor puss further and further.  ", false);
            this.player.cuntChange(35, true, false, true);
            this.outputText("Moaning, you look at her and meet her gaze.  She still looks mad, but her face also carries a hint of confusion.  Peeking down, you see she's dripping even faster, as evidenced by a massive puddle of lady-spunk that pools between her muscular, tightly-clenched thighs.  She must be turned on beyond belief, but she's still resisting!\n\n", false);
            this.outputText("Well, that's her loss.  You keep fucking yourself on her ridged posterior, enjoying the rapid twitches, hard wiggles, and other constant movements.  It almost feels like it's attacking your pussy, battering your womanhood with pleasurable strikes.  Your " + this.hipDescript() + " push back against the welcome intrusion, stuffing another inch or two inside yourself as you move closer and closer to the release you oh-so-desperately crave.  It feels so good!  You scream out in bliss and undulate your entire body, pumping, thrusting, and squirming yourself to the absolute highest peak of pleasure, the summit of sensation.  ", false);
            if (this.player.wetness() < 3)
                this.outputText("Dripping", false);
            else if (this.player.wetness() < 4)
                this.outputText("Leaking", false);
            else if (this.player.wetness() < 5)
                this.outputText("Gushing", false);
            else
                this.outputText("Spraying", false);
            this.outputText(" girl-cum, your " + this.vaginaDescript() + " cums hard.  It squeezes down with clenching, rippling action that finally stop the tail's frantic struggles, immobilizing it in your womanhood.\n\n", false);
            this.outputText("Kiha's moaning stirs you from your orgasmic haze, and you see her pussy actually streaming a steady drizzle of lube, but she still hasn't gotten off.  Perfect!  You watch her while your heart-rate slows to near normal, and eventually, you pull the cum-soaked tail from your nethers with a satisfied sigh.  It feels... cold and empty without the heat of her huge tail inside you, but you think you'll manage, somehow.\n\n", false);
            this.outputText("The draconic woman snaps when you pull your soiled undies from her maw.  \"<i>Bitch!  I'll get you for t-this!</i>\"\n\n", false);
            this.outputText("Your only response is to get dressed, enjoying the pleasant tingle of her bubbling saliva on your girl-parts.  Kiha glares at you, futilely shaking her hips as if that would somehow quell the tide of lust washing through her body.  Maybe another of the swamp's denizens will keep her company in your absence?", false);
            this.player.orgasm();
            this.cleanupAfterCombat();
        }
        ...
        victoryDickKiha() {
            this.spriteSelect(72);
            var x = this.player.cockThatFits(this.monster.vaginalCapacity());
            var y = this.player.cockThatFits2(this.monster.vaginalCapacity());
            this.outputText("", true);
            this.outputText("You walk up and push the dragoness off the tree and onto her side to get a better look at her sopping vagina and tight rump.  Initially she doesn't react, though when she realizes what you're about to do, she cries, \"<i>How very much like my old masters you are.  As soon as you've won a fight, you think of nothing but sex.  ", false);
            if (this.monster.lust > 99)
                this.outputText("Just because you've aroused my body doesn't mean I'll enjoy this!", false);
            else
                this.outputText("Don't think I'll enjoy this!", false);
            this.outputText("</i>\"\n\n", false);
            this.outputText("Kiha certainly has a mouth on her, but then again, you aren't interested in that particular orifice at the moment.  You lift her leg, but she curls her tail up to obscure her pussy from your view", false);
            if (this.monster.lust > 99)
                this.outputText(", rubbing it back and forth against her folds without thinking about it", false);
            this.outputText(".  Annoyed, you twist the rebellious appendage out of your way but struggle to hold it back.  The dragon isn't making it easy for you for in the slightest.  Still, you get a nice long look at her soaked sex, and the sight ", false);
            if (this.player.lust > 60)
                this.outputText("only makes " + this.sMultiCockDesc() + " harder.", false);
            else
                this.outputText("quickly makes " + this.sMultiCockDesc() + " hard", false);
            this.outputText(".  Her rear-most extremity yanks out of your grip to cover her femininity once more and you let it, for now.\n\n", false);
            this.outputText("Pausing for a moment, you set to removing your " + this.player.armorName + " and unleashing " + this.sMultiCockDesc() + " ", false);
            if (this.player.hasVagina())
                this.outputText("and " + this.vaginaDescript() + " ", false);
            this.outputText("to the humid air.  Kiha's eyes widen slightly at the sight of your exposed body, but she gives no other reaction.  She seems utterly resigned and yet composed at the same time.  From her expression, you'd have to wager she anticipates violation from any losses.  Well, she's going to get exactly what she expects.\n\n", false);
            this.outputText("You advance on her helpless form and repeat your actions, raising her leg and shoving her tail aside.  She resists, but not as fiercely as before.  Her tail is easily kept at bay while you lower yourself to align your " + this.hipDescript() + " with the Kiha's moist cunt.  The heat rolling out of her loins is unreal.  Her pussy seems to fog the air with its combination of warmth and wetness, and as you press your " + this.cockDescript(x) + " closer, it feels almost like a woman is about to give you head, with her hot breath washing over your genitals.\n\n", false);
            //(DOUBLE DICKING VARIANT)
            if (y != -1 && this.player.cockTotal() > 1) {
                this.outputText("That perfect, dripping entrance beckons for your " + this.cockDescript(x) + ", but your other penis", false);
                if (this.player.cockTotal() == 2)
                    this.outputText(" is", false);
                else
                    this.outputText("es are", false);
                this.outputText(" aching so much that you may as well try to double your pleasure and fun.  Without hesitation, you slide two cocks inside your unsuspecting partner.  The top one smoothly sheaths itself inside Kiha's velvety tunnel.  Her tightly-clenched pucker proves more resistant to your " + this.cockDescript(y) + "'s sudden intrusion, pushing back with near painful force as inch after inch penetrates her delicious rear passage.  One last, glorious push completely buries both your bones in their draconic sockets, much to the delight of your captive, if her moans are to be believed.\n\n", false);
                this.outputText("\"<i>That's -ooooh- all you gah-got?  I... uhh... barely felt it!</i>\" Kiha protests, trying to retain her aloof demeanor even while she's moaning and squirming from the feel of your two spears inside her.  Sensing that her body is dancing wholly to your tune, you release her leg and tail to make yourself more comfortable.  You hold yourself up with one hand in the dirt and rest your other on the supple, lightly-scaled flesh of Kiha's breast.  She exhales, a high-pitched sound of enjoyment and pleasure slipping from her lips.  Taking her nipple between your fingers, you lightly twist it while you allow yourself to become accustomed to the pleasure her twin-tunnels provide for your dual members.\n\n", false);
                this.outputText("Kiha writhes and pants, her normally flawless skin gaining a blush of rouge that's visible even through her dusky complexion.  You move your hand to trace a circle around her other nipple, feeling it stiffen and engorge at your touches.  Soon it's rock hard, but you keep going, stroking and tugging the tender nub until the dragoness begins to twist and grind beneath you, pumping her trapped hips futilely while she pants, \"<i>A-are you broken or something?  D-do you even know h-how to fuck, you... oooh... freak?</i>\"\n\n", false);
                this.outputText("You sigh and slap her face, informing her that she should shut her trap and consider herself lucky you're spending the time to pleasure her body while you sate yourself.  Kiha barks, \"<i>Yeah right!  As if I would enjoy something like th-</i>\"\n\n", false);
                this.outputText("You cut her snobby ranting off by pulling back and thrusting hard, her tirade turning from well-spoked complaints to inarticulate moans.  She squeals in forced pleasure with each pump of your double dicks while you work her over.  There's no way you're going to slow down or give her a chance to start bitching again.  Dribbles of fem-spunk burst from her thighs with each body-shaking impact to spatter the ground and your lower member, turning her tight, resistant asshole into a butt-pussy nearly as wet as her cunny.\n\n", false);
                this.outputText("Seemingly from nowhere, her tail presses up your back and twists around your neck.  It squeezes your wind-pipe with strangling strength.  You glance down at Kiha, and she's smiling in between her moans, watching her attempts to suffocate you with heavy, lidded eyes.  That bitch!  You fuck her faster, battering at her holes with every ounce of strength you can muster.  The fucking is hard, fast, and desperate, but somehow she manages to keep her pressure up with her tail.  Frustrated, you take to slapping her face, twisting her nipples, and even choking her with one of your hands.  In spite of the incredibly rough sex, she still manages to hold tight.  Her body is twitching and shaking, her mouth spreading into a wordless 'o' of pleasure, but you still can't breathe!\n\n", false);
                this.flags[kFLAGS_1.kFLAGS.KIHA_CHOKED_OUT_PC] = 1;
                ...
                while (this.temp > 0) {
                    this.temp--;
                    if (this.player.cocks[this.temp].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE && this.temp != x && this.temp != y) {
                        z = this.temp;
                        break;
                    }
                }
                if (this.player.isNaga() || this.player.tailType == appearanceDefs_1.TAIL_TYPE_LIZARD || z >= 0) {
                    this.outputText("Spitefully, your ", false);
                    if (z == -1)
                        this.outputText("tail", false);
                    else
                        this.outputText("idle tentacle", false);
                    this.outputText(" responds in kind, bending up to squeeze Kiha's own neck and even inserting the tip into her mouth when next she opens it to let out an aroused gasp, forcing itself down her gullet.  A cross look flashes across her visage for only a second as she realizes she's become subject to your own draconic retribution, but the next few desperate thrusts into her wanton holes do much to dissipate it.  For every thrust she squeezes your windpipe a bit tighter, and you respond in kind", false);
                    if (z >= 0)
                        this.outputText(", plunging the head of your cock in and out of her throat.", false);
                    this.outputText("\n\n", false);
                }
                this.outputText("Dully, you realize " + this.sMultiCockDesc() + " are twitching, her powerful clenching holes combining with your frenzied strokes too much for you to endure.  Heat boils out from your " + this.ballsDescriptLight() + " as your orgasm approaches, threatening to burst from your loins even as blackness eats at the edges of your vision.  Screw it - if she's choking you out, you're at least going to get to cum first.  You grab both her nipples as you hilt yourself and twist, HARD.  Jizm spurts from your cocks, glazing Kiha's hot, juicy puss,", false);
                if (this.player.isNaga() || this.player.tailType == appearanceDefs_1.TAIL_TYPE_LIZARD || z >= 0)
                    this.outputText(" gasping mouth,", false);
                this.outputText(" and tight anus with waves of white.", false);
                if (this.player.cumQ() >= 500)
                    this.outputText("  Her belly distends before long, stuffed by the heavy loads of cream you push out.", false);
                if (this.player.cockTotal() > 2) {
                    this.outputText("  You even coat her belly and tits with seed thanks to your extra penis", false);
                    if (this.player.cockTotal() > 3)
                        this.outputText("es", false);
                    this.outputText(".", false);
                }
                this.outputText("\n\n", false);
                this.outputText("Slumping against her, your shafts continue to pump cum inside the dragon's super-warm holes.  When suddenly, you're able to breathe!  You shake the clouds from your head and look down at Kiha, noticing that she's shaking uncontrollably.  Looking over your shoulder, you see her tail thrashing wildly behind you, any vestiges of control blown away by an explosive orgasm.  Now that you can catch your breath, you're able to enjoy watching your muscular foe succumb to her body's directive.  She undulates beautifully beneath you, her body milking every last drop from your two cocks.\n\n", false);
                this.outputText("You sigh and pull back, noting that Kiha's orgasm still seems to be ongoing.  She doesn't even react to the sudden vacancies in her pussy and asshole.  Maybe this will teach her a lesson about underestimating her opponents, but you doubt it.  You get dressed and leave, smiling at the sound of lurid orgasmic panting behind you.", false);
            }
            //(SINGLE DICKING VARIANT)
            else {
                this.outputText("That perfect, dripping entrance beckons for your " + this.cockDescript(x) + ", and without hesitation, you slide inside.  Kiha growls, \"<i>That's it?  How artless.</i>\"  In spite of her disappointed tone, her slippery passage squeezes down on your member with miraculous tightness, embracing your " + this.cockDescript(x) + " in its firm, velvet grip.  You sigh happily and enjoy the dragon-pussy's pressure for a few moments, tuning out Kiha's griping to focus on the heavenly feelings her body is giving you.\n\n", false);
                this.outputText("Eventually, you become accustomed to the feel of the reptilian tunnel's simmering juices, and eager for more stimulation, you begin to saw your " + this.cockDescript(x) + " in and out of sodden box.  The draconic woman beneath you lets out whimpers and moans of pleasure mixed with discontent, unable to resist you and unable to allow herself to enjoy it.  She squirms and wriggles beneath your forced affections, growing ", false);
                if (this.monster.lust > 99)
                    this.outputText("more aroused despite her feigned indifference", false);
                else
                    this.outputText("very aroused in spite of her desire to fight you", false);
                this.outputText(".  For your part, you pick up the pace, pushing yourself faster and faster towards an eventual climax.  Kiha places her scaled fingers on her chest to stop it from jiggling in response, but you push them away, wanting her breasts to bounce freely for your amusement.\n\n", false);
                this.outputText("All too soon you find your " + this.cockDescript(x) + " giving in to the pleasure of Kiha's sizzling snatch, warmth building beneath your penis as it nears climax.  You let go of her tail as you increase your tempo and push your body towards release.  The dragon's scaled appendage immediately sets to work on your back, battering you with heavy slaps that could seriously damage you if her full strength were behind them.  As it is, they may leave a few bruises.  You tweak one of Kiha's nipples and smile as she moans in sudden pleasure, the lurid vocalization being just what you need to hear to cum inside her.\n\n", false);
                this.outputText("You push yourself in all the way to the hilt and unload, firing jet after jet of thick cream into the dragon's dribbling pussy, only making it leak even more.  ", false);
                if (this.player.cumQ() >= 500)
                    this.outputText("A chubby bulge appears on her taut, defined belly, the only visible sign of your copious cum production.  ", false);
                if (this.player.cumQ() >= 1000)
                    this.outputText("Even after that, thick gouts of the stuff spray out through her cock-stuffed lips, forming a puddle beneath your foe.  ", false);
                this.outputText("You pull out", false);
                if (this.player.cor < 33)
                    this.outputText(", clean up, and get dressed, leaving Kiha behind to consider the effects of her arrogance.", false);
                else if (this.player.cor < 66)
                    this.outputText(", wipe your cock off on her face, and get dressed, leaving Kiha to consider being a little more humble.", false);
                else
                    this.outputText(", smear your dribbling cock all over her face, make her lick it clean, and then, get dressed.  Maybe the bitch will consider a little humility when addressing the real owner of this territory - you.", false);
                this.outputText("  Somehow, you doubt she'll learn anything from the encounter.", false);
            }
            this.player.orgasm();
            this.cleanupAfterCombat();
        }
        ...
        rapeKihaWithWORDS() {
            this.outputText("", true);
            this.spriteSelect(72);
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE] == 0) {
                this.outputText("Kneeling down, you meet the defeated dragoness' gaze and ask her why she's so violent and territorial.  Kiha looks up at you in confusion and asks, \"<i>Wait... you defeated me, and you want to... talk?</i>\"\n\n", false);
                ...
                this.outputText("Kiha recoils at the passion in your voice and shakes her head like a child trying to find the courage not to fear the dark, \"<i>No.  You sound like someone from the before times, from long, long ago, but it can't be that simple.  If it was, the demons would not rule this world.</i>\"  While you chew that over, Kiha suddenly grabs her weapon and springs to her feet.  Her wings unfurl and she flies away.  Even if she denied you, you feel like you might have gotten through to her.", false);
            }
            //Conversation Level 2 (40- Corruption! PUREBABIES ONLY!) (Zed)
            else if (this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE] == 1) {
                this.outputText("Once again, you crouch down and begin talking with your foe.  Kiha immediately sighs and says, \"<i>This again? I thought I told you - you're wrong.</i>\"\n\n", false);
                ...
                this.outputText("Once you finish she comes out of it and mutters, \"<i>So you had it hard?  It doesn't matter.  I had it harder.</i>\"  She launches into the air and flies away before you can answer.", false);
                if (this.silly() && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00281] > 0 && this.telAdre.lottie.lottieMorale() <= 33)
                    this.outputText("  Is that what it feels like to be Lottie?", false);
            }
            //Conversation Level 3 (40- Corruption! PUREBABIES ONLY!) (Zed)
            else if (this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE] == 2) {
                this.outputText("Even though you've taken the dragoness down again, you settle down for another chat instead of anything more carnal.  Kiha smiles at that, relaxing a little as she asks, \"<i>Still sticking to your morals, huh?</i>\"\n\n", false);
                this.outputText("You nod and ask her if perhaps she'd like to tell her story since you shared yours the last time.  The dragoness laughs so hard that tiny spurts of flame flare in the air while small puffs of smoke burst from her nostrils.  She clutches at her stomach and doubles over, gasping for air.  Only after she manages to recover from her mirth does she breathlessly respond, saying, \"<i>You're serious about that?</i>\"\n\n", false);
                this.outputText("You nod again to which she replies, \"<i>Not even if pigs could fly!  And before you suggest it, pig-nosed imps don't count.</i>\"  You fold your arms across your chest expectantly and remind her that you're the victor here.\n\n", false);
                this.outputText("Kiha raves, \"<i>You won because... I LET you win.  I just wanted to see how much information you'd give up.</i>\"\n\n", false);
                this.outputText("You sigh, which surprisingly gets a response.  \"<i>I... don't remember okay?  The first thing I remember is waking up like this in Lethice's base.  There were a few of us, and the demons taught us, schooled us to be like them... I guess they planned for us to be the next level of demons.  A few of us broke out and went our separate ways.</i>\"\n\n", false);
                this.outputText("The draconic woman looks very much like a young, nervous girl in that moment.  Her cheeks blush and she leaps up, flying away before you can ask her any more.", false);
            }
            //Conversation Level 4: Requires Low Corruption, Repeating for now (Zed)
            else {
                this.outputText("You sit down next to Kiha and start to talk again.  While she initially gives the barest hint of a smile, she soon begins to sulk.  No matter what you say or do you can't seem to bring her out of it.  Perhaps for now, there's simply no more to discuss with her.", false);
            }
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE] < 3)
                this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE]++;
            this.cleanupAfterCombat();
        }
        ...
        */
        ...
        analRapuzulaKiha() {
            ...
            this.outputText("You watch the dragoness slump against the tree, her tail barely covering her soaked snatch.  You lick your lips hungrily at the prospect of ravishing the haughty dragon-girl's cunny, but decide she deserves something a bit more special.  You want that tight ass of hers, and you want it now.\n\n", false);
            this.outputText("You tell her to turn around but, still defiant, she refuses.  Glowering, you use your most commanding voice and bellow the command at her.  She still refuses.\n\n", false);
            if (this.player.cockArea(x) <= 20)
                this.outputText("You quickly shed your " + this.player.armorName + ", letting your " + this.multiCockDescriptLight() + " out to breathe in the warm, swampy air.  Her red eyes widen slightly, but she quickly regains her composure, suddenly all confidence despite her obvious loss.  \"<i>Oh? What do you think you're gonna do with THAT, huh?  Just ravish me like some kind of sex-crazed demon? Is that your genius plan?</i>\"\n\n", false);
            else
            ...
            this.outputText("Her words sting, and you resolve to make sure she enjoys what you're about to do.  You approach the defensive dragon and take her arms in your hands and turn her around.  Surprisingly, she resists your movements very little, only struggling when you aggressively push her face into the tree.\n\n", false);
            this.outputText("With the arrogant dragon now facing the tree, you take a better look at her taut ass.  Sensing your lustful gaze, she suddenly wraps her tail around her nethers, hiding her womanhood behind the scaly belt.  You laugh at her ignorance.  You tell her that it's not her dripping sex that you desire, it's her squeezable derriere.\n\n", false);
            this.outputText("\"<i>Oh, so you're not just a sex crazed freak, you're into weird stuff as well.  You know things aren't supposed to go in there, right?</i>\"  Ignoring the dragon-bitch's mocking, you yank her tail out of the way, raising it above her buttcheeks so you can have a better look.  Surprisingly, she doesn't resist, allowing the entirety of her ass to be revealed.  You grin and spread her chocolate-colored cheeks, placing your " + this.cockDescript(x) + " between them.  The dragon's face twists into a hateful scowl, but her determination falters as you begin to hotdog your member up and down, pausing only to tease the draconic woman's pucker with the tip of your rod.\n\n", false);
            this.outputText("You begin to feel the temperature around your cockhead rise.  The intense heat from her drooling cunt gets your blood flowing, getting " + this.sMultiCockDesc() + " to grow to its full size.  You stop your cheek-sawing and place your member against her slick labia, thrusting against her taint for additional lubrication in preparation for your backdoor adventure.\n\n", false);
            this.outputText("\"<i>Look,</i>\" you smile devilishly, \"<i>your own juices are lubing me up to take you.  Here I thought you were turned off by the thought of your ass getting pounded.</i>\"  She visibly clenches her muscles at your insult and pulls her rump away from your grip.  You grab her hips once again and thrust your ready cock into her virginally-tight asshole as punishment.\n\n", false);
            this.outputText("As soon as your fingers touch her skin, her tail whips around your " + this.multiCockDescriptLight() + ", wrapping up your groin", false);
            if (this.player.balls > 0)
                this.outputText(" and threatening to crush your " + this.ballsDescriptLight(), false);
            this.outputText(".  \"<i>Ooh, you're a feisty one, aren't you,</i>\" you goad. \"<i>You can dish out the snappy insults just fine, but taking them... Your temper is horrible.</i>\"  You wince in pain, as the scaly tail wrapped around your genitals tightens in response.\n\n", false);
            this.outputText("You need to come up with a quick way to get out of this painful situation.  A thought forms in your mind.  She may act like a high and mighty puritan, but you still had a visible effect on her, and her cunt was definitely soaking from your touch just a few moments ago.  It seems she's not as high and mighty as she'd like to be.  A devious grin spreads across your face and you reach around and grope the dragon-girl's breasts.\n\n", false);
            this.outputText("She breaks her silence with a gasp.  You continue to massage her tits, your fingers sinking into her tanned flesh as you continue your ministrations.  She begins to pant softly as you twist your fingers around her nipples, but her tail muscles clench again, increasing the pressure on your groin.  You need to find a way to get her tail off your crotch... maybe you have a way to do that.\n\n", false);
            if (this.player.cor < 33)
                this.outputText("You move your hands from her two mounds and down her sides, resting just above her hips. Hoping that this will work, you begin to tickle the stubborn girl.  ", false);
            else if (this.player.cor < 66)
                this.outputText("Since she seems to be concentrating on your hands, you frantically try to think of a solution that doesn't involve them.  An idea forms and, deciding it's now or never, you lean forward and nibble on the tip of her ear.  ", false);
            else
                this.outputText("Since she seems to be concentrating on your hands at the moment, your mind races trying to find a solution that doesn't involve them.  An idea forms and, deciding it's now or never, you lean forward and slowly slide your tongue across her cheek.  ", false);
            this.outputText("She shrieks in shock from your sudden treatment. Having the desired effect, your distraction gives you the split second you need to slip your genitals out of her tail's grasp. You quickly place your " + this.cockDescript(x) + " at her tight pucker, and forcefully slide forward.  Your head breaks through the tight ring and pushes its way inside.  Your surprise teasing seems to have shocked her enough to stop clenching her ass, and the additional lube helps in letting you sheath half your length inside.  The dragoness moans in what you assume is pleasure, finally breaking the cold facade that she's been so desperately trying to maintain.\n\n", false);
            this.outputText("The heat that now encircles your " + Appearance_1.Appearance.cockNoun(this.player.cocks[x].cockType) + " is tremendous; her tightness, incredible.  You're nearly overwhelmed by the urge to slam your whole length home and just cum your brains out.  But you want her to enjoy this, too.  You slowly slide back out of her rectum, stopping when just the tip of the head is barely inside. You lean forward, resting your chest against the warm skin of her back, and thrust your " + this.cockDescript(x) + " back into the crushing heat of her asshole.\n\n", false);
            this.outputText("She squirms from the sudden penetration of her ass.  You revel in the sensation of your member crawling into her dark depths, and by the way the dragon-slut is starting to move her hips, you're pretty sure she is, too.  Grinning, you grab her hips and give a hard thrust, completely hilting yourself inside her butt.  You hear a grunt of pain from your unwilling partner, but the feeling of her hot, crushing bum is all you can think about right now as your cock begins an all-out assault on her anus.\n\n", false);
            this.outputText("Her moans of pain become more and more frequent, slowly changing in pitch and fervor until you realize that they've become moans of pleasure.  \"<i>Well, well, well,</i>\" you jeer. \"<i>You're quite the wanton slut, after all.</i>\"  She forces herself to stop her incessant moaning, and the sound is replaced with the wet slap of your thighs clapping against her own.\n\n", false);
            ...
            if (y >= 0) {
                ...
                if (this.player.cockTotal() == 2)
                    ...
                    this.outputText(" another of your dicks", false);
                this.outputText(", and line it up to the entrance of her now-stretched hole, ramming them both in on your next thrust, expanding her tight passage far beyond its normal limits.  The dragon breaks her silence with a shriek as your two cocks ravage her bunghole, her walls nearly crushing your members as she clenches her muscles in shock.  The extreme tightness and the unbelievable heat enveloping your dicks becomes too much, and you feel the point of no return approaching quickly.\n\n", false);
                this.outputText("You manage a few more thrusts into the draconic woman before your incoming orgasm arrives, each pounding movement making her moan in a mixture of pleasure and pain from the forced double penetration.  You feel your urethras dilate and blast a wave of pre, filling her rectum and slathering your shafts with a fresh coating of lubricant, readying them for one final push into the girl's abused hole.\n\n", false);
                this.outputText("You pull out one final time, placing them at her gaping ring.  Knowing what you're about to do, the dragon visibly relaxes in an attempt to make it as painless as possible.  Getting a good grip on her hips, you thrust your dongs forward and pull her back onto your cocks simultaneously.  Your " + this.cockDescript(y) + " slips from the exposed hole and slides itself between her buttcheeks, while your remaining " + this.cockDescript(x) + " hits home.\n\n", false);
                this.outputText("Kiha shudders in her own climax, soaking her thighs as you finally release your seed into her ravaged ass.  Your other " + Appearance_1.Appearance.cockNoun(this.player.cocks[y].cockType) + " follows its brother, painting her leather-colored skin with alabaster cream", false);
                if (this.player.cockTotal() >= 3) {
                    if (this.player.cockTotal() == 3)
                        this.outputText("; your remaining cock tarnishes the ground with your cum", false);
                    else
                        this.outputText("; your remaining cocks tarnish the ground with your cum", false);
                }
                else if (this.player.hasVagina())
                    this.outputText("; your " + this.vaginaDescript() + " pulses with pleasure, soaking your thighs with girl-cum as your cocks unload", false);
                this.outputText(".\n\n", false);
                this.outputText("The dragoness slumps and falls to the ground, drawing your spent shaft from her ass's depths.  It appears that she has fainted from overwhelming pain, pleasure, and exhaustion. Deciding that you're done here, you retrieve your " + this.player.armorName + " and leave the girl in a mixed puddle of your cum and hers.  Perhaps now she'll treat you with a little more respect.  You return to camp.", false);
            }
            else {
                if (this.player.cockArea(x) <= 20)
                    this.outputText("You move your hands to her breasts, feeling the lightly scaled flesh and begin tweaking her nipples in time to your continued thrusting.  She breaks her self-imposed silence with a long, pleasured sigh, but cuts it short when you laugh at her body's betrayal of her emotions.  \"<i>H-how can anyone even l-like this anyway?</i>\" she pants with barely contained pleasure.  \"<i>All you're doing is sticking your pathetic dick inside something that it isn-isn't designed for.  I-I can barely feel your ti-tiny little cock... uhh... stretching my ass, filling it with s-such force.  Its head tickling my walls with your... ohhh... pathetic attempts to get yourself o-off...</i>\"\n\n", false);
                else
                ...
                this.outputText("Her moans become louder as you continue the butt-fuck, her hole becoming as wet as her pussy as your intruding member slides in and out of her dilated sphincter.  Her involuntary signs of enjoyment spur you on and pre flows freely from your member, allowing you to ignore her crushing tightness and enjoy the hot pleasure that envelops your " + this.cockDescript(x) + ".  You doubt that even her pussy's depths would give you this kind of feeling.\n\n", false);
                this.outputText("You give her nipples one more rub, not realizing that she was fighting off her own orgasm.  Her spasming walls clench hard against your cock, eagerly milking you while her thick girl-cum soaks her thighs.\n\n", false);
                this.outputText("Grunting, you thrust one last time and spill your seed into her, filling her rectum with sticky cum.  ", false);
                if (this.player.hasVagina())
                    this.outputText("Your " + this.vaginaDescript() + " pulses with pleasure, but it's an empty orgasm, leaving you wishing you had something to fill that aching void.  Still, you cannot help but marvel at the superior feeling of cumming with a multitude of sexual organs.  ", false);
                this.outputText("With a contented sigh, you pull out of the dragon and thank her for the good time.  She sits back against the tree and glares at you angrily, though you can easily tell she's been utterly sated.\n\n", false);
                this.outputText("Deciding that you are done here, you retrieve your " + this.player.armorName + " and leave the girl. Perhaps now she'll treat you with a little more respect. You return to camp.", false);
            }
            this.player.orgasm();
            this.cleanupAfterCombat();
        }
    }
    exports.KihaScene = KihaScene;
});
//# sourceMappingURL=KihaScene.js.map