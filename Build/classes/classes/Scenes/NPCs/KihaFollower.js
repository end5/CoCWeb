define(["require", "exports", "./NPCAwareContent", "../../GlobalFlags/kFLAGS", "./Kiha", "../../StatusAffects", "../Areas/Swamp/SpiderMorphMob", "../../PerkLib", "../../CockTypesEnum", "../../../../includes/appearanceDefs"], function (require, exports, NPCAwareContent_1, kFLAGS_1, Kiha_1, StatusAffects_1, SpiderMorphMob_1, PerkLib_1, CockTypesEnum_1, appearanceDefs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class KihaFollower extends NPCAwareContent_1.NPCAwareContent {
        //Requirements:
        ...
        followerKiha() {
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_CORRUPTION_BITCH] == 1)
                return false;
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_FOLLOWER] > 0)
                return true;
            return false;
        }
        kihaAffection(changes = 0) {
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION_LEVEL] == 2)
                this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION] += changes;
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION] > 100)
                this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION] = 100;
            return !!this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION];
        }
        //Introduction
        kihaSpiderEventIntro() {
            ...
            if (this.player.cor < 66)
                this.outputText("You try to calm the dragoness down, explaining that you aren't one of Lethice's minions, that what you told her the first time around was true - that you're here to end the demon threat.  Kiha doesn't seem to be buying it, though...\n\n", false);
            else
                this.outputText("Irate, you stare her down, and with a dangerous gentleness, remind her that you're here to crush the demons.  Your fist tightens as, not unexpectedly, the erratic woman appears to hear none of it.\n\n", false);
            ...
            this.monster.createStatusAffect(StatusAffects_1.StatusAffects.spiderfight, 0, 0, 0, 0);
        }
        ...
        warnKihaOfHerImpendingDemise() {
            ...
            this.startCombat(new SpiderMorphMob_1.SpiderMorphMob());
            //(Proceed to Spider Horde Combat)
            //Set first round cover
            this.monster.createStatusAffect(StatusAffects_1.StatusAffects.MissFirstRound, 0, 0, 0, 0);
        ...
        letTheSpidersHaveTheirWayWithKiha() {
            this.outputText("", true);
            this.spriteSelect(72);
            this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION_LEVEL] = -1;
        ...
        helpKihaAgainstSpoidahs() {
            ...
            if (this.player.cor >= 66)
                this.outputText("beat", false);
            else
                this.outputText("talk", false);
        ...
        beatSpiderMob() {
            ...
            if (this.silly())
                this.outputText("B-baka", false);
            else
                this.outputText("Dumbass", false);
            ...
            if (this.player.cor < 50)
                this.outputText("squeeze her shoulder and ", false);
        ...
        kihaFriendlyGreeting(output = true) {
            if (output)
                this.clearOutput();
            this.spriteSelect(72);
            if (output && this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION_LEVEL] == 1 && this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE] >= 7) {
            ...
            if (output && this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE] == 6 && this.player.cor <= 50) {
                ...
                if (this.model.time.hours < 20)
                    this.outputText("clouds", false);
                else
                    this.outputText("stars", false);
                ...
                if (this.flags[kFLAGS_1.kFLAGS.KIHA_NEED_SPIDER_TEXT] == 1) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.KIHA_NEED_SPIDER_TEXT] = 0;
                }
            ...
            var talk = undefined;
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE] < 6)
        ...
        sparWithKiha() {
            ...
            this.startCombat(new Kiha_1.Kiha());
            this.spriteSelect(72);
            this.monster.createStatusAffect(StatusAffects_1.StatusAffects.Spar, 0, 0, 0, 0);
        }
        ...
        talkToFriendlyKiha() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE] <= 3) {
                this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE] = 3;
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE] == 4) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.KIHA_TALK_STAGE] == 5) {
        ...
        GTFO() {
            this.clearOutput();
            this.spriteSelect(72);
            this.flags[kFLAGS_1.kFLAGS.KIHA_AND_HEL_WHOOPIE] = -1;
        ...
        lieThere() {
            ...
            if (!this.player.isGoo())
                this.outputText("meatsack", false);
            else
                this.outputText("goosack", false);
        ...
        jumpDaBitches() {
            ...
            if (this.player.isBiped())
                this.outputText("stride over");
            else if (this.player.isNaga())
                this.outputText("slither over");
            else
                this.outputText("move toward her");
            ...
            if (this.player.cocks[0].cockLength >= 8)
                this.outputText("bends down her throat");
            else if (this.player.cocks[0].cockLength > 6)
                this.outputText("hits the back of her throat", false);
            else
                this.outputText("rests right on the tip of her tongue", false);
            ...
            if (this.player.cockArea(0) < 36)
                this.outputText("up to the hilt", false);
            else
                this.outputText("until she simply can't take any more of you, her anus already stretched beyond its capacity", false);
            ...
            if (this.player.cumQ() >= 1000)
                this.outputText(" filling her so utterly that your cum squirts back out her asshole around your cock", false);
        ...
        kihaAdmitsSheLikesYourWang() {
            this.clearOutput();
            this.spriteSelect(72);
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_ADMITTED_WARM_FEELINZ] == 0) {
                this.flags[kFLAGS_1.kFLAGS.KIHA_ADMITTED_WARM_FEELINZ] = 1;
        ...
        lovinHugKiha() {
            this.clearOutput();
            this.spriteSelect(72);
            this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION_LEVEL] = 2;
            this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION] = 0;
            ...
            if (this.player.tallness >= 95)
                this.outputText("pulling it down", false);
            else if (this.player.tallness <= 60)
                this.outputText("tilting it up", false);
            else
                this.outputText("tilting it slightly", false);
            ...
            if (this.player.hasCock())
                this.outputText("[pg][EachCock] springs free, smacking into Kiha's thigh as it fully engorges.  She gives it a gentle pump before commenting, \"<i>Acceptable, I suppose.</i>\"", false);
            else if (this.player.hasVagina())
                this.outputText("[pg]Your [vag] tingles as it's exposed to the air.  The lusty dragon-maid dips a digit inside your depths before commenting, \"<i>Not bad, I guess.</i>\"", false);
            else
                this.outputText("[pg]Your smooth groin and [asshole] tingle as they're exposed to the open air.  Kiha gently caresses your smooth skin all the way down your taint before commenting, \"<i>Not ideal, but I can make do.</i>\"", false);
            ...
            if (this.player.tallness >= 95)
                this.outputText("lean down");
            else if (this.player.tallness <= 60)
                this.outputText("reach up");
            else
                this.outputText("reach");
            ...
            if (this.player.canFly())
                this.outputText("You could fly yourself, but you hang on for now, enjoying the embrace.", false);
            else
                this.outputText("You've no choice but to hang on to her for dear life as she lifts off.", false);
            ...
            if (this.player.hasCock())
                this.doNext(this.lovingHugDickings);
            else if (this.player.hasVagina())
                this.doNext(this.lovingHugsGirlFuckSex);
            else
                this.doNext(this.lovingHugsForRetards);
        }
        ...
        lovingHugDickings() {
            ...
            if (this.player.biggestCockArea() > 100)
                this.outputText("How do you walk with this thing swinging around everywhere, bludgeoning into everyone you meet?", false);
            else if (this.player.biggestCockArea() > 9)
                this.outputText("How do you walk with this thing sticking out all the time, or was that just for me?");
            else
                this.outputText("How can you enjoy sex with something that small?  I don't know if I'll even feel it.");
            ...
            if (this.player.biggestCockArea() <= 9)
            ...
            if (this.player.cocks[this.player.biggestCockIndex()].cockLength >= 36)
                this.outputText(", even though you bump her repeatedly in the nose with your moist tip");
            ...
            this.outputText("[pg]");
            if (this.player.horseScore() > 4 || this.player.dogScore() > 4 || this.player.catScore() > 4)
                this.outputText("Growling");
            else
                this.outputText("Grunting");
            ...
            if (this.player.cockTotal() > 1) {
                ...
                if (this.player.cockTotal() == 2)
                    ...
                    this.outputText("the rest of your");
            ...
            if (this.player.cockArea(x) < 50)
                this.outputText("hilted inside her soaked love-tunnel,");
            else
                this.outputText("as far in as your prodigious size with allow,");
            ...
            if (this.player.cockTotal() > 1) {
                ...
                if (this.player.cockTotal() == 2)
                    this.outputText("dual ");
                else
                    this.outputText("multiple ");
                this.outputText("manhoods, the twitching woman's front gets coated just as well as her insides.");
            }
            if (this.player.cumQ() >= 500)
                this.outputText("  Jet after jet of your creamy batter soaks the reptilian womb in spunk, the proof of your virility.");
            if (this.player.cumQ() >= 1000) {
                ...
                if (this.player.cumQ() <= 2000)
                    this.outputText("fill Kiha's bed");
                else
                    this.outputText("turn Kiha's abode into your spermy swimming pool");
                this.outputText(".");
            }
        ...
        lovingHugsForRetards() {
            ...
            if (this.player.analCapacity() < 30)
                this.outputText("in mixed pain and pleasure");
            else
                this.outputText("in pleasure");
            ...
            if (this.player.ass.analLooseness < 4)
                ...
                this.outputText("you're sure you'll gape even wider for a little bit after this");
        ...
        warmLoverKihaIntro(output = true) {
            var campo = undefined;
            ...
            if (output) {
                ...
                if (this.followerKiha()) {
                    if (this.flags[kFLAGS_1.kFLAGS.KIHA_NEEDS_TO_REACT_TO_HORSECOCKING] == 1) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.KIHA_CAMP_WATCH] > 0)
                        this.addButton(8, "Stop Guard", this.guardMyCampKiha);
                    else
                        this.addButton(8, "Guard Camp", this.guardMyCampKiha);
            ...
            if (!this.followerKiha() && this.flags[kFLAGS_1.kFLAGS.KIHA_MOVE_IN_OFFER] == 1)
            ...
            //-[Leave])
            this.choices("Hang Out", this.hangOutWithKiha, "Hug", this.hugFriendWarmKiha, "InviteCamp", campo, "Sex", this.kihaSexMenu, "Spar", this.sparWithKiha, "", undefined, "", undefined, "", undefined, "", undefined, "Leave", leave);
        }
        ...
        hangOutWithKiha() {
            ...
            this.spriteSelect(72);
            //Hang Out 1
            var select = KihaFollower.rand(3);
            if (select == 0) {
                ...
                if (!this.followerKiha())
                    this.outputText("through the dense overgrowth of the swamp");
                else
                    this.outputText("back to her old haunt in the swamp");
                this.outputText(".");
                ...
                if (!this.followerKiha())
                    this.outputText("you're back at Kiha's little islet, waving to the dragoness as she flies back home and you head to camp");
                else
                    this.outputText("you're walking arm in arm again, heading home");
                this.outputText(".");
            }
            //Hang Out 2
            else if (select == 1) {
                ...
                if (!this.player.canFly())
                    this.outputText("  She slips her arms around you and takes off, flying through the roof-entrance to her lair");
                else
                    this.outputText("  Extending a hand to you, the two of you fly up to and through the roof entrance to her lair", false);
                this.outputText(".");
            ...
            //Hang Out 3
                ...
                if (!this.followerKiha()) {
                    ...
                    if (this.model.time.hours < 21)
                        this.outputText("particularly cloudy day above you, with great pink and purple clouds drifting across the demonically-tainted horizon");
                    else
                        this.outputText("stars are out, a thousand little pin-pricks in the heavens", false);
                    this.outputText(".");
                }
                else {
                    this.outputText("Looking up from your dragoness lover, you note the particularly clear ");
                    if (this.model.time.hours < 21)
                        this.outputText("day around your camp - thick pink and purple clouds are rolling lazily over the wasteland, shimmering behind the great maw of the portal");
                    else
                        this.outputText("night in the wastelands.  The stars are out, as they always are at night in your part of Mareth, a thousand thousand little pin-pricks in the heavens");
                    this.outputText(".");
                }
                ...
                if (this.model.time.hours < 21)
                    this.outputText("clouds");
                else
                    this.outputText("stars");
        ...
        blechKihaYourCooking() {
            ...
            if (this.player.canFly())
                this.outputText("fly off.  Scowling, Kiha takes to the air too, landing behind you outside");
            else
                this.outputText("demand to be taken outside.  Grudgingly, Kiha walks over, grabs you by the waist, and hauls you outside");
        ...
        kihaSexMenu(display = true, allowBack = true) {
            this.spriteSelect(72);
            var gro = undefined;
            var incu = undefined;
            var tent = undefined;
            ...
            if (this.followerKiha()) {
                ...
                //Req: Cock
                if (this.player.hasCock()) {
                    if (this.player.cockThatFits(67) >= 0)
            ...
            if (this.player.hasCock()) {
                //savinTheAnalForKiha()
                if (this.player.cockThatFits(94) >= 0)
        ...
        boneTheShitOutofKihaHolesWithHorsecock() {
            ...
            if (this.player.horseCocks() > 0) {
                ...
                while (this.temp > 0) {
                    this.temp--;
                    if (this.player.cocks[this.temp].cockType == CockTypesEnum_1.CockTypesEnum.HORSE && this.player.cockArea(this.temp) >= 40) {
                        x = this.temp;
                        y = x + 1;
                        break;
                    }
            ...
            if (this.player.isTaur())
                this.outputText(" beneath your equine body");
            ...
            if (this.player.isTaur())
                this.outputText(", crawling under your horse body");
            ...
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                this.outputText("flare's mesa");
            else
                this.outputText(this.player.cockHead(x));
            this.outputText(" as she opens wide.  ");
            if (this.player.hasSheath())
                this.outputText("She pumps you just above the sheath");
            else
                this.outputText("She pumps your shaft");
            this.outputText(" with one hand, using slow, even strokes that tickle every sensitive area.  ");
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                this.outputText("Her other caresses the skin of your sheath, fingers slipping in between the folded outer skin and your dick's concealed, untouched flesh.  ");
            else if (this.player.balls > 0)
                this.outputText("Her other fondles your [balls], steadily increasing your desire for release.  ");
            else
                this.outputText("Her other fondles your taint, steadily increasing your desire for release.  ");
            ...
            if (this.player.inte < 20) {
                ...
                if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                    ...
                    this.outputText("groan ");
                this.outputText("of pleasure bursts from your lips, ");
                if (this.player.isTaur())
                    this.outputText("hooves stamping as ");
                ...
                if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                    ...
                    this.outputText("well");
                this.outputText("-endowed form.");
            }
            else
                this.outputText("  A ");
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE || this.player.isTaur())
            ...
            if (horse)
                this.outputText("you catch yourself before you start braying like an animal");
            else
                this.outputText("you catch yourself before it manages to escape your lips");
            ...
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                this.outputText("beast-");
            this.outputText("prick.  The ");
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                this.outputText("thick flare");
            else
                this.outputText(this.player.cockHead(x));
            ...
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                this.outputText("her free hand eagerly caressing you inside your own sheath with inhuman warmth");
            else {
                if (this.player.balls > 0)
                    this.outputText("her tongue working as much of your shaft as possible with inhuman warmth.");
                else
                    this.outputText("her free hand eagerly caressing your [balls] with inhuman warmth.");
            }
            ...
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                ...
                this.outputText("[cock " + y + "].");
            if (this.player.balls > 0)
                this.outputText("  Your [balls] smear and shudder against her chin, so tight, hot, and ready to explode.");
            this.outputText("[pg]Kiha ");
            if (this.player.balls > 0)
                this.outputText("squeezes your [sack]");
            else if (this.player.hasVagina())
                this.outputText("fondles your [vag]");
            else
                this.outputText("gives her tongue an encouraging twist");
            ...
            if (c <= 250)
                ...
                this.outputText("Her eyes water, and trickles of cum run from her nose, but she still manages to gulp most of it down.");
            else {
            ...
            if (horse) {
                if (this.player.isTaur())
                    this.outputText("clambers out from beneath you, pulling herself onto a nearby rock, putting herself into position for your horse-body to mount her. She spreads her legs wide, her slick vagina releasing a tantalizing musk that begs for a cock to fill it");
            }
            else
                this.outputText("leans back against a rock and spreads her legs, exposing you to a tantalizing, cock-filling scent");
            ...
            if (this.player.cocks[x].cockType.Index > 0) {
                if (this.player.isTaur())
                    ...
                    this.outputText("fondling your bestial tool with one hand");
            }
            else {
            ...
            if (horse)
                this.outputText("\"<i>Fuck, am I... rutting?!</i>\"  ");
            else
                this.outputText("\"<i>Fuck, why am I... ?!</i>\"  ");
            ...
            if (this.player.isTaur())
                this.outputText("punches your underside");
            else
                this.outputText("tries to push you back");
            ...
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                ...
                this.outputText(this.player.cockHead(x) + " of your " + this.cockDescript(x));
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_CERVIXGINITY_TAKEN] == 0) {
                this.outputText(" to steal her womb cherry");
                this.flags[kFLAGS_1.kFLAGS.KIHA_CERVIXGINITY_TAKEN]++;
            }
            else
                this.outputText(" to plow your favorite dragon-hole");
            ...
            if (this.player.balls)
                this.outputText("  You slap your [balls] into in her ass hard as you thrust, smearing them all over her sweaty ass and tail.");
            else
                this.outputText("  You slap into her hard as you thrust, feeling her tail thrashing beneath your [butt].");
            ...
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                this.outputText("flaring ");
            else
                this.outputText("engorging ");
            ...
            if (c <= 250)
                this.outputText(", stuffed up with hot cum");
            else if (c <= 1500)
                this.outputText(", her belly inflating to pregnant proportions");
            else if (c <= 3000)
                this.outputText(", her belly inflating to pregnant equine proportions");
            else
                this.outputText(", her belly distending hugely, grossly even, utterly filled with cum until it's squirting from her pussy in a river of white");
            this.outputText(".");
            ...
            if (this.player.isTaur())
                this.outputText(" until the shaft bumps your belly");
            this.outputText(".  You've just started to breed this bitch!");
            this.outputText("[pg]Kiha's ");
            if (c > 250)
                this.outputText("cum-gravid ");
            else
                this.outputText("spunk-stuffed ");
            ...
            if (this.player.isTaur())
                this.outputText("you push her onto her hands and knees atop the rock and re-mount her, and ");
            ...
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                this.outputText("The unique shape of your cockhead makes such penetration difficult, but with animalistic stubbornness, you keep at it.");
            else
                this.outputText("The sheer size of your cockhead makes such penetration difficult, but with animalistic stubbornness, you keep at it.");
            ...
            if (this.player.isTaur())
                ...
                this.outputText("[pg]The dragon's limp tail provides ");
            ...
            if (!this.player.isTaur())
                this.outputText("You run a hand over her rump, stopping only to give it familiar slaps as y");
            else
                this.outputText("Y");
            ...
            if (this.player.hasSheath())
                this.outputText("to your sensitive sheath");
            else
                this.outputText("to your sensitive loins");
            ...
            if (horse)
                this.outputText("the unquestionable authority of a herd alpha.");
            else
                this.outputText("an unquestionable air of authority.");
            ...
            if (c >= 3000)
                this.outputText("[pg]A torrent of cum runs from her overfilled butthole and cunt.  It seems there just isn't enough room inside her to hold it all, and with two plus-sized loads in her bottom holes, most of it has to escape.  Even with that, she still looks heavily pregnant, a perfect tribute to your unholy virility.");
            else if (c >= 1000)
                this.outputText("[pg]A wash of cum runs from her overfilled butthole and cunt.  Even with that, she still looks heavily pregnant, a perfect tribute to your potent virility.");
            else
                this.outputText("[pg]Trickles of cum run from her butthole and well-ravished cunt, a potent reminder of your virility and the dominance you have over your females.");
            ...
            //(FIRST TIME ONLY:  
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_HORSECOCK_FUCKED] == 0) {
                ...
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1)
                    this.outputText("  Exgartuan suggests, \"<i>She probably loved it if she had as much fun as I did.</i>\"");
                this.flags[kFLAGS_1.kFLAGS.KIHA_NEEDS_TO_REACT_TO_HORSECOCKING] = 1;
            }
            //(REPEAT:  
            else
                this.outputText("[pg]It happened again!  You shudder and stroke yourself, the unmistakable desire to do it again already cementing itself in your brain.  Well, at least Kiha doesn't mind too much.");
            if (this.player.minLust() < 50 && this.player.lib < 80) {
                this.outputText("[pg]<b>(You used up one lust draft!)</b>");
            }
            this.flags[kFLAGS_1.kFLAGS.KIHA_HORSECOCK_FUCKED]++;
            this.player.orgasm();
        ...
        kihaReactsToHorseDicking() {
            ...
            this.flags[kFLAGS_1.kFLAGS.KIHA_NEEDS_TO_REACT_TO_HORSECOCKING] = 2;
            //{MENU HERE}
        ...
        kihaPlaysWithBigassCocksFemDomAhoy() {
            ...
            if (this.player.cocks[x].cockLength > 48)
                this.outputText(" for a moment before climbing higher.  It quickly blocks your view of your lover.");
            else
                this.outputText(" for a moment before thickening and twitching against her.");
            ...
            if (this.player.cocks[x].cockLength > 48)
                this.outputText("bigger than");
            else
                this.outputText("the size of");
            ...
            if (this.followerKiha())
                this.outputText("rock");
            else
                this.outputText("tree");
            ...
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HUMAN)
                this.outputText(", particularly your medial ring and the sensitive edge of your flare.");
                ...
                this.outputText(", particularly the groups of aphrodisiac laced tentacles under your crown.");
                ...
                this.outputText(", particularly the hundreds of rubbery spines covering your feline maleness.");
            else
                this.outputText(".");
            ...
            if (this.player.cocks[x].cockLength > 48)
                this.outputText("pulls your cockhead down and ");
            ...
            if (this.player.hasKnot(x))
                this.outputText("beneath your knot ");
            else {
                this.outputText("around your base");
                if (this.player.hasSheath())
                    this.outputText(", just above the sheath, ");
                else
                    this.outputText(" ");
            }
            ...
            if (this.player.balls > 0)
                this.outputText("Your balls clench and relax in time with the waves of pleasure, and y");
            else
                this.outputText("Y");
            ...
            if (this.player.cumQ() >= 2000)
                this.outputText("Wave after wave of spunk rains down over you, forming a gratuitous puddle and utterly, completely sliming you both.  ");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) {
                if (this.player.cor < 50)
                    this.outputText("  You hope she doesn't get jumped upby your tiger-shark children.");
                else
                    this.outputText("  You wonder what would happen if she got jumped by your tiger-shark children.");
            }
            ...
            if (this.monk >= 5 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.NoJojo) < 0 && this.flags[kFLAGS_1.kFLAGS.JOJO_DEAD_OR_GONE] == 0) {
                if (!this.jojoScene.tentacleJojo())
                    this.outputText(", ignoring the sounds of Jojo feverishly masturbating in the woods");
                else
                    this.outputText(", ignoring the sound of Jojo vigorously fucking himself with all his tentacles in the trees");
            }
            this.outputText(".");
            if (this.sophieBimbo.bimboSophie())
                this.outputText("  Sophie greets you when you return, though she seems crestfallen once she smells the sex on you and realizes how thoroughly you've been sated.");
            if (this.amilyScene.amilyCorrupt())
                this.outputText("  Amily begs, \"<i>May I help to service you next time, " + this.player.mf("master", "mistress") + "?</i>\"");
            this.player.orgasm();
            this.dynStats("sen", -1);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        kihaGirlGirlSex() {
            ...
            if (this.player.wetness() < 4)
                this.outputText("Trickles");
            else
                this.outputText("Small rivers");
            ...
            if (this.player.clitLength >= 10)
                ...
                this.outputText(", humming happily when it stiffens against her.");
            ...
            if (this.player.wetness() < 3)
                ...
                this.outputText("small gush");
            else if (this.player.wetness() <= 4)
                this.outputText("river");
            else
                this.outputText("explosion");
        ...
        savinTheAnalForKiha() {
            this.clearOutput();
            this.spriteSelect(72);
            var x = this.player.cockThatFits(94);
            if (x < 0)
                x = 0;
            ...
            if (this.player.tallness >= 60)
                this.outputText("her shoulders ");
            else
                this.outputText("the small of her back ");
            ...
            if (this.player.cocks[x].cockLength < 3)
                this.outputText("; you pull her cheeks apart just long enough to slip your prick between them, letting Kiha hotdog you");
            ...
            if (this.player.hasVagina())
                this.outputText(", just as yours are");
            this.outputText(".");
            ...
            if (this.player.isNaga())
                this.outputText("along your long naga tail");
            else
            ...
            if (this.player.cocks[x].cockLength >= 40)
                this.outputText("bottoms out on your cock");
            else
                this.outputText("rests her cheeks on your crotch");
            this.outputText(".  Both of you are gasping and panting from the slow descent, Kiha ");
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_KIHA_ANALED] >= 5)
                this.outputText("growing pleased by");
            else
                this.outputText("unused to anal penetration");
            ...
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.TIMES_KIHA_ANALED]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        fuckKihasVagInCamp() {
            ...
            if (this.silly())
                this.outputText("She asks in a high-pitched whine, \"<i>Did I do thaaat?</i>\"  Steve Urkel has nothing on her!");
            else
                this.outputText("She nervously stutters, \"<i>Is that... because of me?</i>\"");
            ...
            if (this.player.skinType != appearanceDefs_1.SKIN_TYPE_SCALES)
                ...
                this.outputText("dislodge the occasional old scale from your hide.");
            ...
            if (this.player.cumQ() >= 500)
                this.outputText("  Such a meager display is only the start.  You fire rope after rope of cum, enough to slightly distend the dragoness's belly with your seed.");
            if (this.player.cumQ() >= 1500)
                this.outputText("  Jizz pumps and pumps, squirting from her filled pussy almost as fast as you inject, yet you still manage to make her look nearly pregnant by the time you finish.");
            if (this.player.cumQ() >= 1000)
        ...
        giveKihaIncubusDraft() {
            ...
            if (this.silly())
                this.outputText("  This is your game, you remind her: you control the horizontal and the vertical.");
        ...
        fuckKihaWithATentacle() {
            ...
            if (this.silly())
                this.outputText("  You whisper slowly, \"<i>Shhhh... no tears now.  Only dreams... and tentacles.</i>\"");
            ...
            if (this.player.tentacleCocks() > 1)
                this.outputText("those monstrous things");
            else
                this.outputText("that monstrous thing");
            ...
            if (this.player.balls > 0)
                this.outputText("churn and quiver");
            else
                this.outputText("churns and quivers");
        ...
        kihaOffersToMoveIn() {
            ...
            this.flags[kFLAGS_1.kFLAGS.KIHA_MOVE_IN_OFFER] = 1;
            this.warmLoverKihaIntro(false);
        }
        //Invite Kiha to Camp
        inviteKihaForDickings() {
            ...
            this.flags[kFLAGS_1.kFLAGS.KIHA_FOLLOWER] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        kihaBitchesOutCorruptPCs() {
            ...
            if (!this.followerKiha()) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.KIHA_AFFECTION_LEVEL] == 1)
            ...
            this.flags[kFLAGS_1.kFLAGS.KIHA_CORRUPTION_BITCH] = 1;
        ...
        kihaUnbitchesUncorruptedFolks() {
            ...
            this.flags[kFLAGS_1.kFLAGS.KIHA_CORRUPTION_BITCH] = 2;
        ...
        fightForDominanceWithDragonCunnies() {
            ...
            //[Leads to a fight]
            this.startCombat(new Kiha_1.Kiha());
            this.monster.createStatusAffect(StatusAffects_1.StatusAffects.DomFight, 0, 0, 0, 0);
        }
        //[PC loses the fight]
        pcLosesDomFight() {
            this.clearOutput();
        ...
        pcWinsDomFight() {
            this.clearOutput();
            this.spriteSelect(72);
            var x = this.player.cockThatFits(67);
            if (x < 0)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_CHOKED_OUT_PC] > 0)
                this.outputText("  Not again!");
            ...
            if (this.player.hasCock())
                this.outputText(this.hipDescript());
            else
            ...
            var select = choices[KihaFollower.rand(choices.length)];
            ...
            if (select == 0 || !this.player.hasVagina()) {
                ...
                if (KihaFollower.rand(2) == 0)
                    this.outputText("[pg]\"<i>Ha!  The Champion still has some fight in " + this.player.mf("him", "her") + "!  Keep me here if you can, wimp!  I WILL pin you down and cum all over your face!  You'll lap it all up like a good little " + this.player.mf("boy", "girl") + " to bo- UGH!</i>\"");
                //Kiha response one (requires cock): 
                else
                    this.outputText("[pg]\"<i>Ha!  The Champion still has some fight in " + this.player.mf("him", "her") + "!  Keep me here if you can, wimp!  I WILL pin you down and make you beg to plant your seed in my womb!  Just wa-OOhhOhhh...</i>\"");
            }
            ...
            if (this.player.gender != 2 && this.player.balls == 0)
                this.outputText("[pg]You're not sure if that's an insult or a challenge to step it up.");
            ...
            if (select == 0 || !this.player.hasVagina())
                this.outputText(" tug along her lengths and pull her head back towards you, soliciting a pained scream from Kiha as her roots convey the agony of the act to her.  \"<i>Is that all you've GOT?! Give me a break!</i>\"");
            //PC is fucking Kiha via scissoring: 
            else
                this.outputText(" twist of your fingers along her clitoral hood, causing Kiha to screech in surprised pain and pleasure.  \"<i>Is that all you've GOT?! Give me a break!</i>\"");
            ...
            //Kiha traps the player in a submissive 69 (universal): 
                ...
                if (!this.player.hasCock())
                    this.outputText("lapping viciously at your cunt.");
                else
                    this.outputText("ramming your cock down her craw.");
            }
            ...
            if (select <= 1)
                this.outputText("not have your neck's flesh ripped up in the process");
            else
                this.outputText("not have a mishap with your genitalia");
            ...
            //Random event two of three: Footjobs and missionary, oh my!
                ...
                if (this.player.tongueType == appearanceDefs_1.TONUGE_SNAKE || this.player.tongueType == appearanceDefs_1.TONUGE_DEMONIC) {
                    ...
                    if (this.player.tongueType == appearanceDefs_1.TONUGE_DEMONIC)
                        this.outputText("taking to her pointed mammary like a boa to prey as you lather up each teat separately.  The hot-tempered dragon girl squirms, completely at your mercy while you have your fun.");
                    //Snake: 
                    else
                        this.outputText("stimulating the soft, nubby flesh with your forked tongue, hissing for effect as you do it.  Imagine the look on her face if you worked that little bugger over her clit; she'd go berserk!  But she hasn't earned that yet; what you want to hear is her begging for a good dicking first.");
                }
        ...
        guardMyCampKiha() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.KIHA_CAMP_WATCH] > 0) {
                this.flags[kFLAGS_1.kFLAGS.KIHA_CAMP_WATCH] = 0;
                ...
                this.flags[kFLAGS_1.kFLAGS.KIHA_CAMP_WATCH] = 1;
            }
            this.menu();
            this.addButton(0, "Next", this.warmLoverKihaIntro);
        }
    }
    exports.KihaFollower = KihaFollower;
});
//# sourceMappingURL=KihaFollower.js.map