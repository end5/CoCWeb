define(["require", "exports", "./NPCAwareContent", "../../PregnancyStore", "../../GlobalFlags/kFLAGS", "../../CoC", "../../../console", "../../StatusAffects", "./Izma", "../../Appearance", "../../CockTypesEnum", "../../PerkLib", "../../../../includes/appearanceDefs", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, StatusAffects_1, Izma_1, Appearance_1, CockTypesEnum_1, PerkLib_1, appearanceDefs_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class IzmaScene extends NPCAwareContent_1.NPCAwareContent {
        constructor() {
            super();
            this.checkedIzmaLatexy = 0; //Make sure we test each of these events just once in timeChangeLarge
            this.checkedIzmaSophie = 0;
            this.pregnancy = new PregnancyStore_1.PregnancyStore(kFLAGS_1.kFLAGS.IZMA_PREGNANCY_TYPE, kFLAGS_1.kFLAGS.IZMA_INCUBATION, 0, 0);
            this.pregnancy.addPregnancyEventSet(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, 250, 200, 150, 100, 50);
        ...
        timeChange() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIME_TILL_NEW_BOOK_AVAILABLE] > 0)
                this.flags[kFLAGS_1.kFLAGS.IZMA_TIME_TILL_NEW_BOOK_AVAILABLE]--; //BOOKURYUUUU COUNTAH For IZMA
            if (this.izmaFollower() && this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0 && this.flags[kFLAGS_1.kFLAGS.TIMES_IZMA_DOMMED_LATEXY] > 0 && this.latexGirl.latexGooFollower() && this.flags[kFLAGS_1.kFLAGS.IZMA_X_LATEXY_DISABLED] == 0) {
                this.flags[kFLAGS_1.kFLAGS.GOO_FLUID_AMOUNT] = 100;
            }
            if (this.model.time.hours > 23 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00246] > 0)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00246] = 0;
            return false;
        }
        timeChangeLarge() {
            if (this.checkedIzmaSophie++ == 0 && this.sophieBimbo.bimboSophie() && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 0 && this.izmaFollower() && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] == 0 && this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0 && ((this.flags[kFLAGS_1.kFLAGS.TIMES_SOPHIE_AND_IZMA_FUCKED] == 0 && IzmaScene.rand(10) == 0) || this.flags[kFLAGS_1.kFLAGS.TOLD_SOPHIE_TO_IZMA] == 1)) {
                this.flags[kFLAGS_1.kFLAGS.TOLD_SOPHIE_TO_IZMA] = 0;
                this.sophieBimbo.sophieAndIzmaPlay();
                return true;
            }
            if (this.checkedIzmaLatexy++ == 0 && this.izmaFollower() && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] == 0 && this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0 && this.latexGirl.latexGooFollower() && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_LATEXY] == 0 && this.flags[kFLAGS_1.kFLAGS.TIMES_IZMA_DOMMED_LATEXY] == 0 && (this.debug || IzmaScene.rand(10) == 0)) {
                this.izmaDomsLatexy();
                return true;
            }
            return false;
        ...
        izmaFollower() {
            return this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00238] == 1;
        }
        izmaSprite() {
        ...
        meetIzmaAtLake() {
            ...
            //(Izmacounter= 1)
                ...
                //(Izmacounter +1)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00230]++;
                this.doNext(this.camp.returnToCampUseOneHour);
            }
            //[Next 2 encounters with Izma] (Izmacounter = 2 or 3)
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00230] < 4) {
                this.outputText("Your exploration of the lakeshore has brought you back to Izma's campsite.  The tigershark is happy to see you, but you can't help but feel she's a little distracted with something; she's constantly playing around with her skirt and grinding her fangs.\n\n", false);
            ...
            //(after 4+ encounters) (Izmacounter >= 5)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00238] == -1) {
                    this.outputText("As you stroll along the lake, you find yourself coming across a familiar looking sea-chest.  It looks like you've stumbled into the path of your tigershark lover, Izma, and sure enough, she promptly emerges dripping from the waters of the lake.  She smiles in delighted surprise at seeing you.\n\n", false);
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= 6 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00238] == 0) {
                    this.outputText("You walk the lakeshore, hoping to encounter the slutty shark Izma again, and you set your sights on her makeshift camp soon enough.  From what you can see, the girl is looking out from the lakeshore as if in deep thought.  As you draw closer, you see that her hands are constantly fidgeting on her lap, a telltale sign of her nerves.  Now, just what could be on her mind that has her so riled up?\n\n", false);
                    this.outputText("You step on a brittle shell as you advance and it crunches loudly beneath your feet, drawing Izma's attention.  She looks at you and her mood seems to instantly brighten, though her hands are still fidgeting nervously.  Smirking, you hold up a hand as a greeting and ask what's up.\n\n", false);
        ...
        tradeWithFuckingSharkBitches() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00238] <= 0)
                this.simpleChoices("C.Manual", this.readSharkCuntManual, "E.Guide", this.sharkEdgingGuideLOL, "Porn", this.sharkgirlPronz, "", undefined, "Back", this.meetIzmaAtLake);
            else
                this.simpleChoices("C.Manual", this.readSharkCuntManual, "E.Guide", this.sharkEdgingGuideLOL, "Porn", this.sharkgirlPronz, "", undefined, "Back", this.izmaFollowerMenu);
        }
        //[C.Manual]
        readSharkCuntManual() {
            this.spriteSelect(32);
            ...
            //[Yes/No]
                ...
                this.doYesNo(this.readSharkCuntManual2, this.tradeWithFuckingSharkBitches);
        }
        readSharkCuntManual2() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("Handing Izma the gems she asked for, you pick up one of the many issues of 'Combat Manual'. Izma takes a moment to count and store the gems you've given her, while you move over to a nearby rock to have a quick read of the volume.\n\n", false);
            this.player.gems -= 20;
            this.statScreenRefresh();
            //(One of the following random effects happens)
            var choice = IzmaScene.rand(3);
            if (choice == 0) {
                this.outputText("You learn a few new guarding stances that seem rather promising.", false);
                //(+2 Toughness)
                this.dynStats("tou", 2);
            }
            else if (choice == 1) {
                this.outputText("After a quick skim you reach the end of the book. You don't learn any new fighting moves, but the refresher on the overall mechanics and flow of combat and strategy helped.", false);
                //(+2 Intelligence)
                this.dynStats("int", 2);
            }
            else {
                this.outputText("Your read-through of the manual has given you insight into how to put more of your weight behind your strikes without leaving yourself open.  Very useful.", false);
                //(+2 Strength)
                this.dynStats("str", 2);
            }
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00238] != 1)
                this.outputText("head back to your camp.", false);
            else
                this.outputText("leave the shark-girl to her books.", false);
            //(Izmacounter +1)
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00230]++;
            this.doNext(this.camp.returnToCampUseOneHour);
            return;
        ...
        sharkEdgingGuideLOL() {
            ...
            //[Yes/No]
                ...
                this.doYesNo(this.readSharkEdgingGuideLOL, this.tradeWithFuckingSharkBitches);
        }
        readSharkEdgingGuideLOL() {
            ...
            this.statScreenRefresh();
            this.outputText("", true);
            this.outputText("You hand Izma the gems she asked for and then pick up a copy.  Izma takes a moment to count the gems, while you sit down near her.\n\n", false);
            this.outputText("You peruse the strange book in an attempt to refine your manners, though you're almost offended by the stereotypes depicted within.  Still, the book has some good ideas on how to maintain chastity and decorum in the face of lewd advances.\n\n", false);
            //(-2 Libido, -2 Corruption)
            this.dynStats("lib", -2, "cor", -2);
            this.outputText("After reading through the frilly book you give it back to Izma who delicately places it back in the trunk.  You say your goodbyes and then ", false);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00238] != 1)
                this.outputText("head back to your camp.", false);
            else
                this.outputText("leave the shark-girl to her books.", false);
        ...
        sharkgirlPronz() {
            ...
            //[Yes/No]
                ...
                this.doYesNo(this.readSharkgirlPornzYouFuckingPervertAsshole, this.tradeWithFuckingSharkBitches);
        }
        ...
        talkToASharkCoochie() {
            ...
            this.outputText("", true);
            //(first chat)
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00232] == 0) {
                this.outputText("You sit down on the rocks beside Izma, and the two of you exchange bits of gossip and information. Izma then tells you a strange tale of a mysterious island she's seen on the horizon of the lake, along with a strange smoke-belching shape she's seen on the nearby mountain in the past.  ", false);
                //(If player hasn't done the Demon Factory quest) 
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) < 0)
                    this.outputText("You scratch your chin in thought, feeling that this matter warrants further investigation.", false);
                //(If the player has done the Demon Factory)
                else
                    this.outputText("You smile, and detail just what that factory is and what you went on to do in this factory.", false);
            }
            //(repeat: factory not cleared)
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) < 0) {
                this.outputText("You sit with Izma and chat a bit more; naturally enough your conversation turns toward the billowy pink smoke from the mountain.  According to her, the smoke's been increasing suspiciously in volume the past few days.  She bemoans her inability to explore it further because of her aquatic nature; you commiserate as best you're able before taking your leave.", false);
            }
            //(repeat: factory cleared)
            else {
                this.outputText("With the factory on the mountain shut down and no longer belching conspicuous pink smog, the conversation turns to more esoteric subject matter.  The two of you discuss some of the ramifications of the demon outbreak and speculate on what the future might hold.  She argues her points cogently and without backing down or getting sidetracked, and you're given a bit of a mental workout as you formulate and present your own arguments.", false);
                this.dynStats("int", 1);
            }
        ...
        fightSharkCunt() {
            ...
            //(Izmacounter +1)
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00230]++;
            this.outputText("Izma smiles widely and retrieves a pair of hooked metal gauntlets from her chest, donning them and clenching her fist a few times.  ", false);
            //(If Izmafight = 0) 
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] == 0)
                this.outputText("\"<i>All right, show me just what a Champion can do!</i>\" she says, entering a fighting stance.", false);
            //(If Izmafight = 1-2) 
            else if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] > 0 && this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= 2)
                this.outputText("Izma's eyes narrow at you, and she assumes a fighting stance.  \"<i>You won't get so lucky this time.</i>\"", false);
            //(If Izmafight = 3+)
            else if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] > 2)
                this.outputText("Izma seems uncertain with herself as she prepares for battle. \"<i>Go a little easier on me this time... please?</i>\"", false);
            //(If Izmafight = -1 or -2 )
            else if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] < 0 && this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -2)
                this.outputText("\"<i>Hm, really?  Well, maybe you'll get lucky this time,</i>\" she mocks, gesturing at you to strike first.", false);
            //(If Izmafight = -3 to -4)
            else
                this.outputText("Izma laughs slightly and shakes her head.  \"<i>If you insist.  At least TRY this time, will ya?</i>\"", false);
            this.startCombat(new Izma_1.Izma());
            this.spriteSelect(32);
        }
        //[Victory dialogue]
        defeatIzma() {
            ...
            //(Izmafight = 0) 
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= 0) {
                this.outputText("Izma falls back into the sand, her ", false);
                if (this.monster.HP < 1)
                    this.outputText("injuries", false);
                else
                    this.outputText("lust", false);
                this.outputText(" preventing her from fighting on.  She growls at you in annoyance, \"<i>Fine.  You win... this time.</i>\"\n\n", false);
            }
            else if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] > 0) {
                //(Izmafight = 1 or 2) 
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] < 3) {
                    this.outputText("Having incapacitated Izma through ", false);
                    if (this.monster.HP < 1)
                        this.outputText("physical", false);
                    else
                        this.outputText("sexual", false);
                    this.outputText(" prowess, you stand over the defeated tigershark.  \"<i>Okay, okay!  You win!  Geez... let's get on with it, I feel like I'm gonna go crazy.</i>\"  She begins removing her clothing.\n\n", false);
                }
                //(Izmafight = 3+) 
                else
                    this.outputText("Izma falls into the sand in an exaggerated fashion.  \"<i>Oh no!  I seem to have lost!  Please don't ravish me again!</i>\" she proclaims loudly as she undresses, her bad acting almost making you laugh your ass off.\n\n", false);
            }
        ...
        IzmaWins() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) >= 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00233] = 1;
                this.player.orgasm();
            ...
            //(without worms)
                ...
                //(Izmafight =0)
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= 0)
                    this.outputText("Izma chuckles slightly as she prowls around your defeated form.  \"<i>Well, as far as things around here stand, you made for a decent fight.  Still no match for me, though.</i>\"", false);
                //(Izmafight = -1 or -2) 
                else if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -2)
                    this.outputText("\"<i>Ya know, just because we're friends doesn't mean you need to hold back... you were holding back, right?</i>\" Izma asks, placing her hands on her hips.", false);
                //(Izmafight = -3 or -4) 
                else
                    this.outputText("Izma sighs and shakes her head at you, letting a foot rest on your stomach  \"<i>You're doing this on purpose, aren't you?  Hm, fine.  If you love my cock so much, I think you'd make for a decent mate...</i>\"", false);
                //TO THE SECKS!
        ...
        loseToIzma() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= -5) {
            ...
            if (this.player.gender <= 2) {
                ...
                if (this.player.HP < 1) {
                    this.outputText("One of Izma's metal-clad fists cracks hard against your stomach, sending you crashing onto the sandy earth - you aren't seriously hurt, but you're too weak to continue fighting, and Izma knows it.\n\n", false);
                    this.outputText("She grins at you, a rather fierce expression given she's still got her shark-teeth out, but her tone is gentle enough.  \"<i>Hah! Looks like I win this round, kid!  Now, I believe there's something you owe me, and I intend to have it...</i>\"\n\n", false);
                }
                //(If player is raised to 100 Lust:) 
                else {
                    this.outputText("Your legs buckle, and your mind fogs with arousal; you are too turned on to continue fighting and collapse bonelessly into a shivering heap.\n\n", false);
                    this.outputText("Izma shakes her head, grinning wryly.  \"<i>Looks like somebody needs to get more discipline before they try a sex-off.</i>\"\n\n", false);
                }
                this.outputText("\"<i>All right; time to hold up your end,</i>\" she notes.  The double entendre is lost on your fuddled mind.  Her tone is conversational, but her grin is wicked, and she is slipping out of her grass skirt as hastily as she can, given the care she needs to take it off without damaging it.  After all, skirts that can so easily conceal the iron-hard foot-and-a-quarter-long erection she is sporting require considerable skill to make, especially if they must also conceal two pairs of baseball-sized nuts, so swollen and heavy with cum that you think you can hear them slosh softly from where you have fallen.  \"<i>We agreed to do it shark style; you lost, so that means I'm in charge.  Get undressed and show me that cute little ", false);
                if (this.player.hasVagina())
                    this.outputText("cunt", false);
                else
                    this.outputText("pucker", false);
                this.outputText(" of yours!</i>\"  ", false);
                //[(If Izmafight is -1 or -2)
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -2)
                    this.outputText("With some reluctance, but driven by your promise, you remove pieces of your " + this.player.armorName + " until you stand naked before the hungrily ogling tigershark.", false);
                //(If Izmafight is -3 or less)
                else
                    this.outputText("You are already undressed before Izma has finished speaking.  The tigershark is clearly surprised, and, to be honest, a part of you is surprised too... but it's drowned out by the need to give yourself over to Izma's lusts.", false);
                this.outputText("\n\n", false);
                this.outputText("Your 'cute little ", false);
                if (this.player.hasVagina())
                    this.outputText("cunt", false);
                else
                    this.outputText("pucker", false);
                this.outputText("' clenches tight in ", false);
                if (this.player.HP < 1)
                    this.outputText("fear", false);
                else
                    this.outputText("anticipation", false);
                this.outputText(" at the thought of something that huge forcing its way into it... but you did make a promise and you are ", false);
                if (this.player.HP < 1)
                    this.outputText("too weak to resist", false);
                else
                    this.outputText("feeling very horny", false);
                this.outputText(", so you comply.  You remove the last bits of your " + this.player.armorName + ", and position yourself on the ground, your " + this.buttDescript() + " facing towards Izma.  You can hear her stalking across the sand toward you, but it still sends tingles up your spine when her hands - now free of her metal gauntlets - fall onto your " + this.assDescript() + ".\n\n", false);
                this.outputText("\"<i>Ooh, looking good from this angle.  I'm going to enjoy taking you like this... after all, if you want to be on top, then you gotta fight for it.</i>\"\n\n", false);
                this.outputText("You feel a sudden, hot liquid sensation in between your buttocks, and you squeak in shock - it's almost like somebody has tipped hot lava onto your backside.  When you look over your shoulder, though, your limited span of vision confirms what the sensation of something large with a rounded, narrow tip pressing against your pucker suggests; there's nothing there but Izma's huge, pre-cum dripping cock.\n\n", false);
            }
            //Male/Unsexed loss:
            if (this.player.gender <= 1) {
                //[(If player has tight butthole:)
                if (this.player.analCapacity() < 26) {
                    this.outputText("You can't help but yell in pain at the sudden sensation of something so huge forcing its way into your " + this.assholeDescript() + ".", false);
                    ...
                    //(If Izmafight <= -4)
                    if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= -4)
                        this.outputText("  You find yourself pushing back to speed up the process, desperate for Izma to fill you again.", false);
                ...
                //(If player has middling anus:) 
                    ...
                    this.outputText("You can feel every inch of her cock as it sinks steadily into your anus, swelling into your guts as inexorably as the flood tide.\n\n", false);
                    this.outputText("\"<i>Ahhhh... now that's a nice little hole!  Did you lose on purpose?</i>\" she asks, and you can hear the grin in her voice.", false);
                    //(If the player has lost 4+ times)  
                    if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= -4)
                        this.outputText("  You find yourself wondering that as well...", false);
                    this.player.buttChange(this.monster.cockArea(0), true, true, false);
                }
                //(If player has a loosey goosey:)
                else {
                    this.outputText("Izma's cock may be fairly impressive, but you've taken bigger in your time, and it shows; Izma's first experimental thrust sees her sink up to the hilt into your bowels, and you moan with the pleasure of being filled again even as her four balls slap against your " + this.buttDescript() + ".\n\n", false);
                    this.outputText("\"<i>The heck!?  What kind of monsters have you been running into?</i>\" she wonders aloud.", false);
                }
                ...
                this.outputText("Harder and faster she thrusts, building up a rhythm that grows in pace, her balls slapping audibly against your " + this.buttDescript() + " as she bucks back and forth.  You can feel her huge male organ in your depths, rubbing against your prostrate, stretching your inner walls, her boiling erection against your burning heat.  You moan in pleasure; you can't help but enjoy this", false);
                if (this.player.hasCock())
                    this.outputText(", and your own male organ is hard and throbbing from the stimulation", false);
                this.outputText(".\n\n", false);
                this.outputText("\"<i>Oh, somebody likes it, eh?  Well, don't worry, you wanted to test your luck, so I'm not going to hold back!  You're getting the whole experience, sweetheart!</i>\" Izma growls.  Her hands suddenly shift from squeezing your buttocks to holding onto your back, and you howl in a mixture of pain and pleasure as Izma suddenly bites you - hard enough that you can feel it, but not hard enough to draw blood, especially given her shark teeth are retracted.  Her other teeth fix themselves in your side as she ruts with you, and you can't help but thrust yourself back against her.", false);
                //(If Izmafight = -4)  
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= -4)
                    this.outputText("  If this is how the sharks do it, you could really get used to it...", false);
                this.outputText("\n\n", false);
                this.outputText("\"<i>That's it, weakling, moan for me; make this sweeter!  I'd be moaning if you had won, so the least you can do is give me the same courtesy - fair's fair!</i>\" she mumbles.  \"<i>Oh, yes, yes, yes!  Good little fuck, good!  I... I'm... here... it... comes!</i>\"  She roars, releasing her grip on your shoulder to bellow her exultation to the sky, the climax that has been churning and thrashing her mighty balls finally erupting from within her.\n\n", false);
                this.outputText("You groan as well, ", false);
                //[(male)
                if (this.player.hasCock()) {
                    this.outputText(this.sMultiCockDesc() + " disgorging ", false);
                    if (this.player.cumQ() < 25)
                        this.outputText("a trickle", false);
                    else if (this.player.cumQ() <= 150)
                        this.outputText("several squirts", false);
                    else
                        this.outputText("a steady stream", false);
                    this.outputText(" of semen onto the sandy earth below you, but it pales in comparison to the tide flooding into your guts.  Hot and slick, it surges and flows into you, pumping and pumping into your depths.", false);
                }
                //(unsex)
                else
                    this.outputText("your own muscles spasming from the immense pleasure.", false);
                this.outputText("  Your belly grows as the great wave of tigershark cum reaches your stomach and fills it to the brim, and then it begins to stretch further.  Your limbs fail you and you fall face-first onto the sand in your pleasure, too consumed by sensation to even notice your stomach puffing out firm and hard against the earth.\n\n", false);
                this.outputText("Finally, Izma stops, panting hard for breath as her cock softens and is pulled free from your stretched anus, a steady trickle of hot cum pouring out in its wake.  As she recovers, so too do you, rolling over so that you can see her, your midriff swollen into a small but undeniable gut from all the cum she has poured into you.  She looks at you, undeniably pleased by what she sees.\n\n", false);
                this.outputText("\"<i>That's how shark people have sex,</i>\" she tells you.  \"<i>Of course, it's different if you're the one who won... but you'll need to come back again and beat me if you want to see what that's like.</i>\"  She gathers her clothing and drops the tooth into your lap, then leans down and gives you a small peck on the lips before diving back into the water, most likely to clean herself off.\n\n", false);
                this.outputText("You remain where you are, waiting for the strength to flow into your limbs and for some of the abundance of sexual fluids to vacate your stuffed entrails before you dress yourself and leave.  You had no idea that Izma could take charge in such a fierce manner... but, at the same time, you find yourself actually liking it.  A part of you wonders if you could see her that way again...", false);
                //(Izmafight - 1)
                this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON]--;
            }
            //Female Loss:
            else if (this.player.gender == 2) {
                //[(If player has tight cunt:) 
                if (this.player.vaginalCapacity() < 26) {
                    this.outputText("You can't help but yell in pain at the sudden sensation of something so huge forcing its way into your " + this.vaginaDescript(0) + ".\n\n", false);
                    this.outputText("\"<i>Whoah-!  ", false);
                    if (this.player.vaginas[0].virgin)
                        this.outputText("First time, huh?", false);
                    else
                        this.outputText("That's tight!", false);
                ...
                //(If player has ordinary, everyday cunt:)
                    ...
                    this.outputText("You can feel every inch of her cock as it sinks steadily into your " + this.vaginaDescript(0) + ", filling your moist folds as inexorably as the rising tide.\n\n", false);
                    this.outputText("\"<i>Ahhhh~  Now that's a nice little hole!  Did you lose on purpose?</i>\" she asks, and you can hear the grin in her voice.", false);
                    //(If the player has lost 4+ times)  
                    if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= -4)
                        this.outputText("  You find yourself wondering that as well...", false);
                ...
                //(If player is loose:)
                    ...
                    this.outputText("Izma's cock may be fairly impressive, but you've taken bigger in your time, and it shows; Izma's first experimental thrust sees her sink up to the hilt into your crotch, and you moan with the pleasure of being filled again even as her four balls slap against your taint.\n\n", false);
                    this.outputText("\"<i>The heck!?  What kind of monsters have you been running into?</i>\" she wonders aloud.", false);
                }
                ...
                this.outputText("\"<i>Oh, somebody likes it, eh?  Well, don't worry, you wanted to test your luck, so I'm not going to hold back!  You're getting the whole experience, sweetheart!</i>\" Izma growls.  Her hands suddenly shift from your buttocks to holding onto your " + this.chestDesc() + ", and you howl in a mixture of pain and pleasure as Izma suddenly gives your " + this.nippleDescript(0) + "s a good hard tug.  \"<i>Stiff nipples?  You so wanted this...</i>\" Izma teases, licking at your neck and causing you to moan in pleasure.", false);
                //(If the player has lost 4+ times) 
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= -4)
                    this.outputText("  If this is how the sharks do it, you could really get used to it...", false);
                this.outputText("\n\n", false);
                ...
                this.outputText("You groan as well, your own orgasm coating the sands beneath you with girly fluids as Izma's cum boils into your womb.  Hot and slick, it surges and flows into you, pumping and pumping into your depths. Your belly grows as the great wave of tigershark cum reaches your stomach and fills it to the brim, and then it begins to stretch further.  Your limbs fail you and you fall face-first onto the sand in your pleasure, too consumed by sensation to even notice your stomach puffing out firm and hard against the earth.\n\n", false);
                this.outputText("Finally, Izma stops, panting hard for breath as her cock softens and is pulled free from your ravaged cunt, a steady trickle of hot cum pouring out in its wake.  As she recovers, so too do you, rolling over so that you can see her, your midriff swollen into a small but undeniable gut from all the cum she has poured into you.  She looks at you, undeniably pleased by what she sees.\n\n", false);
                ...
                if (this.player.pregnancyIncubation == 0 || this.player.pregnancyIncubation > 180)
                    this.outputText("  From her oak chest she fetches an odd leaf, which she pushes past your lips.  \"<i>Birth control herbs.  No way I'm giving kids to someone who's not my mate,</i>\" Izma says, making sure you swallow the plant before diving into the water, most likely to clean herself off.\n\n", false);
                this.outputText("You remain where you are, waiting for the strength to flow into your limbs and for some of the abundance of sexual fluids to vacate your " + this.vaginaDescript(0) + " before you dress yourself and leave.  You had no idea that Izma could take charge in such a fierce manner... but, at the same time, you find yourself actually liking it.  A part of you wonders if you could see her that way again...", false);
                //(Izmafight minus 1)
                this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON]--;
            }
            //Loss Scene- Herm 
                ...
                //(If player is raised to 100 Lust:) 
                    ...
                    this.outputText("Your legs buckle, and your mind fogs with arousal; you are too turned on to continue fighting and collapse bonelessly into an aroused heap.\n\n", false);
                    this.outputText("Izma shakes her head, grinning wryly.  \"<i>Looks like somebody needs to get more discipline before they try a sex-off.</i>\"\n\n", false);
                }
                this.outputText("As you collapse in defeat, you're aware of the pretty tigershark stalking around you and removing her clothing.  She grabs hard on your " + this.player.armorName + " and undresses you with minimal effort, revealing your ", false);
                if (this.player.lust < 40)
                    this.outputText("limp cock and barely-engorged cunt", false);
                else if (this.player.lust < 70)
                    this.outputText("turgid erection and moist cunt", false);
                else
                    this.outputText("throbbing erection and slavering cunt.", false);
                this.outputText("\n\n", false);
                this.outputText("\"<i>Dirty little minx, ain't ya?  You wanted this, didn't you...</i>\" Izma teases, shoving two fingers into your moist nether-lips, to test the waters.  The peneration of your needy cunt does serve to make you whimper softly, almost begging to just be filled.  ", false);
                //(Tight/Virgin vagina)
                if (this.player.vaginalCapacity() < 26) {
                    this.outputText("\"<i>My oh my, quite a tight little slit you got back here. Not for long...</i>\" Izma says, her fingers roaming around within your cunt.", false);
                }
                //(If player has ordinary, everyday cunt:)
                else if (this.player.vaginalCapacity() < 60) {
                    this.outputText("Izma giggles slightly from just how easy it is to move around your moist folds.  \"<i>Well, this'll make things slightly easier for you I suppose.</i>\"", false);
                }
                else {
                    this.outputText("Izma's eyes widen as her entire hand seems to slip into your cavernous vagina. \"<i>Holy shit... what's been up here?</i>\" she mumbles, laughing nervously in amazement.", false);
                }
                this.outputText("\n\n", false);
                this.outputText("Pulling her fingers free, Izma quickly flips your nude body over, leaving you on your back and staring up at her.  Izma's hands are resting on her hips and she seems to be puffing her large chest out proudly. Her foot-long cock is fully erect, hot beads of pre-cum occasionally dripping onto the sands.  She takes the time to examine your own cock, grinning with her fangs bared.  \"<i>Let's see what you've got, weakling.</i>\"  ", false);
                var x = this.player.biggestCockIndex();
                //(1-10 inch penis)
                if (this.player.cocks[x].cockLength <= 10)
                    this.outputText("Izma manages to supress a snort of laughter at the sight of your cock.  \"<i>Um... wow?  It's simply... heh, huge...</i>\"", false);
                //(10-19 inches)
                else if (this.player.cocks[x].cockLength <= 19)
                    this.outputText("\"<i>Not bad, I'm actually impressed,</i>\" Izma says, nodding slightly in approval.", false);
                //(20+ inches)
                else
                    this.outputText("Izma gives a low whistle at the sight of your " + this.cockDescript(x) + ".  \"<i>Now THAT'S a cock.  Looks like you've got a third leg down there!</i>\"", false);
                ...
                this.player.cuntChange(this.monster.cockArea(0), true, true, false);
                this.outputText("\n\n", false);
                this.outputText("She starts thrusting in and out of you, gradually increasing the speed and force, her hot pre-cum and your feminine juices acting like a lubricant to make things easier.  \"<i>Ahh~  You're a lovely cock-sleeve... you like being treated like this, don't ya, weakling?</i>\" Izma taunts, slamming in and out of your " + this.vaginaDescript(0) + ".", false);
                //(If Izmafight <= -4) 
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= -4)
                    this.outputText("  You're not even really ashamed to admit that such is the case anymore.", false);
                this.outputText("\n\n", false);
                this.outputText("Every thrust pushes you deeper into the sands, and eventually you find yourself pumping your hips upward against Izma's own, eager to pleasure her and yourself.  Izma seems to notice this and laughs loudly.  \"<i>Oh?  You really like being dominated?  Ha, I thought as much.</i>\"  She continues to taunt you as she pounds into you, her balls smacking against you every time.  Your mind is too clouded with lust to hear even half of what she says.  Right now all you care about is getting off.\n\n", false);
                this.outputText("Within minutes, Izma gives one final, powerful thrust and roars loudly, cum pumping into your womb and spraying out onto the sands.  " + this.SMultiCockDesc() + " twitches and pulses, ready to blow.  Izma quickly takes hold and points ", false);
                if (this.player.cockTotal() == 1)
                    this.outputText("it", false);
                else
                    this.outputText("them", false);
                this.outputText(" toward your face, stroking you to your own climax.  Jets of your own cum splatter across your face and body as you writhe, protesting. \"<i>Tch, you really thought I'd let you cum on ME?  Maybe if you actually managed to beat me I'd give you the honor,</i>\" Izma says, pulling free with a loud *SCHLICK* sound.  She releases your " + this.player.feet() + ", allowing your " + this.buttDescript() + " to hit the sand with a plop, and gets to work redressing while you lie still.");
                if (this.player.pregnancyIncubation == 0 || this.player.pregnancyIncubation > 150) {
                    this.outputText("  Moving over to her oak chest, she returns with a strange leaf in her hands, which she pushes past your lips.\n\n", false);
                    this.outputText("\"<i>Anti-pregnancy herb.  Can't have someone bearing my litter if they're not my mate, can I?</i>\"  Izma explains, moving over to the shoreline.  ");
                }
                else
                    this.outputText("\n\n");
                this.outputText("She gives you a wink and tosses the promised tooth at your feet before diving into the water, presumably to clean herself off.  Several minutes later, you wash up as well and stagger back to camp, sore from the ordeal.  Izma sure can be rough when she wants.  A part of you wonders if you could see her that way again...", false);
                //(Izmafight minus 1
                this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON]--;
            }
            this.player.orgasm();
            ...
            //zmafight -1: 
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -1)
                this.outputText("  You realize what you're thinking and shudder, forcing the submission-tinged desires down. Where did they come from, anyway?", false);
            //Izmafight -2: 
            else if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -2)
                this.outputText("  Though you manage to force them away, the dreams of submitting to Izma are starting to haunt you, their power and seductive allure growing. But, still, you can control them.", false);
            //Izmafight -3: 
            else if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -3)
                this.outputText("  You hum idly to yourself and enjoy the mental visions for a while, then, with some reluctance, you push them aside. Still, you're sure you can bring them out again when you want to enjoy them.", false);
            //Izmafight -4: 
            else if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= -4)
                this.outputText("  You have only the vaguest thought that maybe you shouldn't be thinking about Izma in that way, but it's so tempting to just immerse yourself in the sexiness of having a hot herm shark-girl dominate you so thoroughly. After all, it's not as if there's any harm in doing so, is there?", false);
            //Izmafight -5: 
            else
                this.outputText("  You embrace the dreams fully, desperate to cling to them as long as you can. It's getting so hard to care about your former mission anymore; why fight the demons when you can just give it up and surrender yourself to Izma? Yes... such a strong, powerful, worthy alpha she is; Izma is all you need. Let her take control of your life, why don't you?", false);
            this.flags[kFLAGS_1.kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.consumables.TSTOOTH.id;
        ...
        finalIzmaSubmission() {
            this.outputText("", true);
            this.outputText("You collapse onto your hands and knees, defeated by Izma once again.  You feel you may not have fought as hard as you could have though, out of a deep-rooted desire for Izma to dominate you again.\n\n", false);
            this.outputText("Izma sniggers as she advances on you, happy to oblige your desire, casually undoing your " + this.player.armorName + " after scattering her own clothing to the rocks.  \"<i>Aw, was that all? Honestly...</i>\" she mocks, walking behind you, \"<i>you're quite the little bitch, aren't ya?  You just love submitting to Izma, don'tcha?</i>\"  You whimper slightly and nod your head in response.  As Izma leans into your back, her rock-hard nipples and cock press into your ", false);
            if (!this.player.isTaur())
                this.outputText("spine", false);
            else
                this.outputText("flank", false);
            this.outputText(".\n\n", false);
            this.outputText("Some of Izma's hot pre-cum dribbles out onto your back and runs down to your " + this.assDescript() + ".  It causes your eyes to roll back in your head; you can only imagine the taste of her salty pre running down your throat.  Izma snickers, aware of her hold over you, before tightening her grip.", false);
            if (this.player.hasCock() || this.player.hasVagina()) {
                this.outputText("  The tight embrace makes ", false);
                if (this.player.hasCock()) {
                    this.outputText(this.sMultiCockDesc() + " stiffen", false);
                    if (this.player.hasVagina())
                        this.outputText(" and ", false);
                }
                if (this.player.hasVagina())
                    this.outputText("your " + this.vaginaDescript(0) + " moisten considerably", false);
            }
            this.outputText(".\n\n", false);
            this.outputText("\"<i>Beg,</i>\" she orders, licking your neck and collarbone, giving off a few growls and purrs as she goes.  \"<i>Wh-what?</i>\" you manage to reply, lost in your anticipation.  \"<i>You heard me,</i>\" she replies sternly, grinding her throbbing cock, now erect and well over sixteen inches, against your back.  It seems like giving free rein to her dominating instincts is making her harder than you've ever felt.  You moan loudly from the sensation.  \"<i>Please fuck me!  Please, Izma, mistress, I need your cock!</i>\" you cry, not caring if anything is nearby to hear you.  Izma chuckles in response before pulling you in and roughly kissing you, her long tongue curling around your own.  She continues to tongue-fuck you until you nearly run out of breath, and you feel like Izma could make you orgasm from this alone.\n\n", false);
            this.outputText("She keeps you held in place as she positions the tip of her cock against your " + this.assholeDescript() + ".  With no warning, she forces her meat-pole into you, making you squeal in delight from the familiar heat of her cock.  ", false);
            this.player.buttChange(this.monster.cockArea(0), true, false, true);
            this.outputText("She keeps forcing her way in your backdoor, inch after inch, and you only feel weaker against Izma the further in she goes.  Eventually she manages to bury her entire dick into your pucker, sighing in delight as her meaty quads press against your " + this.buttDescript() + ".\n\n", false);
            this.outputText("She pulls back out, and for a moment you feel a bit of trepidation at the absence of her cock, before crying out as she again goes balls-deep into your backside.  She continues to thrust and grind into you, giving a few animalistic snarls of pleasure.  You manage to glance back, only to notice how completely the bookworm has turned into some sort of proud wild woman.  It suits her; she's proven that she's so much stronger than you, after all.  So strong, so in control, so powerful... it feels right to be like this, underneath Izma as she asserts her position over you.\n\n", false);
            this.outputText("As if sensing your complete submission, Izma's hands trail down toward your " + this.breastDescript(0) + ", mauling and groping at them, tweaking your " + this.nippleDescript(0) + "s in an almost-painful fashion.  It only manages to turn you on further though, groaning and squirming from intense pleasure.  Izma makes you orgasm first, your muscles twitching and spasming as you briefly lose control over yourself", false);
            if (this.player.hasVagina() || this.player.hasCock()) {
                this.outputText("; ", false);
                if (this.player.hasCock()) {
                    this.outputText(this.sMultiCockDesc() + " begins spurting jizz all over the sandy shore", false);
                    if (this.player.hasVagina())
                        this.outputText(" and ", false);
                }
                if (this.player.hasVagina())
                    this.outputText("your " + this.vaginaDescript(0) + " starts squirting fluids liberally", false);
            }
            this.outputText(".\n\n", false);
            this.outputText("However, you're filled with desire to be laden with her seed again, perfect specimen that she is, and you start pushing your backside vigorously against Izma's cock again.  \"<i>Ah, there's a good bitch!  Make me cum, and you'll earn my favor!</i>\" Izma hisses, brutally stretching your anus from her thrusting.  It doesn't take much longer for Izma to climax, and she gives an animalistic roar as she ejaculates inside you, blasting your innards with her thick load of semen.  She looses her grip on you and lets you fall onto the sand as she starts catching her breath, sweat dripping off her body.  Her cock eventually slides free, and you can feel her hot and potent cum flowing out.\n\n", false);
            this.outputText("The two of you stay unmoving for a few moments.  She gets to her feet first, throwing a tigershark tooth at you.  \"<i>Here's your reward, slut... though, a bitch you should be happy enough with my seed alone.</i>\"  You get to your knees and follow her as she walks away to redress.  \"<i>You can go now, you know,</i>\" Izma says bluntly, making you gasp slightly in response.  You explain that you don't want to leave the beautiful tigershark, feeling so safe with such a mighty specimen watching over you.  You beg and plead with her to let you stay, saying that you'll do anything to remain by her side.  Izma blinks a few times in surprise before smiling softly and cupping the side of your face.  \"<i>Anything, hm? Well... I suppose I could be your alpha, if you like.</i>\"  You nod vigorously at the idea; no matter what that means, if it'll keep Izma with you, you're for it.  \"<i>You do make for a pretty good fuck after all,</i>\" she continues.", false);
            //[(if PC isn't shark/tigershark)
            if (this.player.race() != "shark-morph")
                this.outputText("  \"<i>But we'll have to make some changes to your body, of course...</i>\"", false);
            this.outputText("\n\n", false);
            this.player.slimeFeed();
            this.player.orgasm();
        ...
        victoryPenisIzma() {
            this.outputText("", true);
            var cockIndex = this.player.cockThatFits(this.monster.vaginalCapacity());
            if (cockIndex < 0)
                cockIndex = 0;
            this.outputText("You watch the defeated tigershark closely and a grin forms on your face.  You touch a hand to her forehead and push her onto her back with minimal effort, slipping her clothing off.  She hardly lacks the strength to stop you, but she knows full well what the terms of the battle were, so she's not going to go back on her word.  You remove your " + this.player.armorName + " and spread Izma's legs wide, " + this.sMultiCockDesc() + " almost painfully erect as you lift her quartet of balls up to look at her glistening womanhood.\n\n", false);
            this.outputText("Not wanting to waste any time on foreplay, you push your " + this.cockDescript(cockIndex) + " into Izma's slit as far as you can manage, making Izma gasp sharply and writhe against you.  You snicker and start thrusting into her, the odd little tendrils inside her cunt teasing and massaging your cock.  The walls themselves are so tight and smooth that her pussy conforms to you like a glove.  It almost feels like Izma's snatch was made just for you.", false);
            //[(If Izmafight = 3+)
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] >= 3)
                this.outputText("  Hell, maybe it was made for you, given just how eager Izma seems to be whenever she sees you.  It's like she loses to you on purpose.", false);
            this.outputText("\n\n", false);
            ...
            this.outputText("Deciding that it'd be rude not to, and because you want to see just how loud you can make Izma moan, you grab hold of her raging erection and start jerking her off while you pound into her.  The move seems to surprise Izma, and she starts moaning and screaming in pleasure.  The double stimulation you're pulling off pushes Izma past her limit very quickly, and she starts shooting thick jets of spunk into the air, which begin to rain down on her face and breasts.  Her vaginal walls clamp down on your " + Appearance_1.Appearance.cockNoun(this.player.cocks[cockIndex].cockType) + " almost painfully as the orgasm wracks her female genitalia too.\n\n", false);
            this.outputText("Izma starts panting and gasping for breath after the intense release, but immediately starts groaning when she realizes you are not done.  You giggle and release her softening erection, placing both hands on her thighs as you start to redouble your efforts at fucking her.  You push Izma deeper and deeper into the sands with each thrust, and despite her exhaustion Izma gives a few soft pleasured moans.\n\n", false);
            //[(Male)
            if (this.player.gender == 1) {
                this.outputText("After a lengthy fuck, you grunt loudly as your " + this.cockDescript(cockIndex) + " swells, blasting streamers of jizz into Izma's womb", false);
                //[(multi) 
                if (this.player.cockTotal() > 1)
                    this.outputText(" and onto her groin", false);
                this.outputText(", causing Izma to cry out loudly.", false);
                //[(big skeet)
                if (this.player.cumQ() >= 500) {
                    this.outputText("  Her belly swells as you empty your impressive load into her", false);
                    if (this.player.cumQ() >= 1500)
                        this.outputText(".  Eventually it can swell no more and each new squirt forces cum out from her stuffed pussy, trickling past her asshole", false);
                    this.outputText(".", false);
                }
                this.outputText("  You sigh happily and push back from her, weakly getting back on your " + this.player.feet() + " and redressing. Izma scrambles to her chest and takes out some sort of leaf, then eats it.\n\n", false);
            }
            //(Herm)
            else {
                this.outputText("After a lengthy fuck, you grunt loudly as your " + this.cockDescript(cockIndex) + " swells, blasting streamers of jizz into Izma's womb", false);
                ...
                this.outputText("  You sigh happily and push back from her, weakly getting to your " + this.player.feet() + ".  You're not done yet though, not fully.\n\n", false);
                this.outputText("Izma gasps again as you plant your " + this.vaginaDescript(0) + " onto her face, grinding against the angular features and moaning loudly as her obliging tongue darts past your lips.  You could really get used to this feeling.  You ride her face for another few minutes before an orgasm rocks your female parts, splattering girlcum onto Izma's face.  You sigh happily and weakly get to your feet, redressing.  You see Izma fishing something from her storage chest - a plant of some sort - and munching it down.\n\n", false);
            }
            this.player.orgasm();
            //[(if Izmafight <=4)
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= 4 || this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00235] > 0) {
                this.outputText("You say your goodbyes to the pretty tigershark and leave once she hands you your tooth-shaped reward.", false);
                this.flags[kFLAGS_1.kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.consumables.TSTOOTH.id;
                this.cleanupAfterCombat();
            }
        ...
        useVagooOnIzmaWin() {
            ...
            this.outputText("Deciding you've had enough foreplay, you mount her and slide down her cock.", false);
            this.player.cuntChange(this.monster.cockArea(0), true, true, false);
            this.outputText("  You start grinding and gyrating atop her, ", false);
            //[(taur)
            if (this.player.isTaur())
                this.outputText("your weight pinning her to the sand and preventing her from taking control.", false);
            //(non-taur and height > 4') 
            else if (this.player.tallness > 48)
                this.outputText("and pin her hands above her head to stop her from trying to change the position. Her heaving breasts rub against your " + this.allBreastsDescript() + " as you ride her in this posture.  She needs to know who's in charge here, after all.", false);
            //(non-taur and height <= 4')
            else
                this.outputText("but small as you are, you can't stop her as she reaches up and grabs onto your " + this.buttDescript() + ", then begins bouncing you like a goblin cocksleeve.", false);
            this.outputText("\n\n", false);
            this.outputText("Izma seems to do her best, moving and jerking her cock up as much as she can, earning gasps of pleasure from you.", false);
            //[(no-taur)
            if (!this.player.isTaur())
                this.outputText("  To reward your eager partner for her efforts you reach back with one free hand to massage and grope at her testes.  Izma bites her lip and starts growling loudly, pushing her hips up as far as possible, eager to cum for you.  You decide to return the favor, mashing your pussy down with increasing speed.", false);
            this.outputText("\n\n", false);
            this.outputText("After a few more minutes of vigorous fucking, Izma grunts and roars in an animalistic fashion as she orgasms, jets of hot musky spunk pumping into your depths.  You cry out in pleasure, your inner walls clamping down on her cock and milking every available drop of jizz she has.  After a while you manage to recover and stumble onto your feet.  \"<i>Hey, wait a sec,</i>\" Izma says weakly as you start to leave.  She goes to her storage chest and retrieves a crumpled leaf, then holds it out to you with a smile.  \"<i>Here, take this.  It's an anti-pregnancy herb.</i>\" Do you take it?", false);
            this.player.slimeFeed();
            this.player.orgasm();
            //[yes/no]
        ...
        eatIzmasLeafAfterRapinHer() {
            this.outputText("", true);
            this.outputText("You accept the leaf gingerly and eat it.  Izma smiles.", false);
            //Set loot
            this.flags[kFLAGS_1.kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.consumables.TSTOOTH.id;
            //[(if Izmafight <=4) 
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= 4 || this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00235] > 0) {
        ...
        dontEatIzamsLeafAfterRape() {
            this.outputText("", true);
            this.outputText("You rankle at the offered herb and give her a haughty glare.  \"<i>You're going to tell ME what to do? Me, your proven superior?</i>\"\n\n", false);
            this.outputText("Izma cringes.  \"<i>Sorry!  I just don't want to go fathering children with someone who's not my mate!  Please, please take it!</i>\"\n\n", false);
            this.outputText("You slap the leaf out of her hand.  \"<i>Try getting stronger before you impose your decisions on others!</i>\" you bark.  \"<i>Whether I decide to have your kids or not is none of your business; you should be grateful at the chance to father them with someone tougher than you!</i>\"  She shivers and nods meekly, and you turn about and pick your way back to camp.\n\n", false);
            this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_IZMA, PregnancyStore_1.PregnancyStore.INCUBATION_IZMA);
            this.cleanupAfterCombat();
            //(Izmafight +1)
            this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON]++;
        }
        ...
        takeItInZeButtVictoryLikeFromIzma() {
            this.outputText("", true);
            this.player.slimeFeed();
            this.outputText("You smirk as Izma slumps down, unable to fight against you anymore.\n\n", false);
            this.outputText("You push her onto her back and see her inhuman dong flop free from her skirt.  Seems the combat turned the little shark on.  Well, 'little' is hardly the right word to describe any aspect of her, especially when she has a 15-inch rock-hard erection waving over her.  It actually brings a dopey grin to your face.  Well, you earned a reward, so you might as well take it.\n\n", false);
            this.outputText("You lean down and start licking and suckling the tip of her monster dick, slurping up her hot pre and lubricating the tip of her raging boner.  She moans and jerks at your touch, writhing around and loving the sensation of submissiveness.  The feeling of having her under your power manages to bring a smile to your own face.\n\n", false);
            this.outputText("Gradually you start to suck more and more of her cock, inch after inch moving down your throat.  You gag lightly as you finally reach the base of her cock, before pulling it out.  She whines weakly and looks at you pitifully, wondering why you're teasing her.  You remove your " + this.player.armorName + " before turning to show her your " + this.buttDescript() + ", and a small smile spreads over her angular face as she realizes what you have planned.  You plant your hands on your backside and pull your cheeks wide, before starting to slide onto her well-lubed pecker.\n\n", false);
            this.outputText("She grunts and huffs as you slide down, and you too feel a strain from her iron-hard dick despite the various fluids lubricating it.  But gradually pain turns to pleasure and you're both moaning loudly and calling each other's names as you ride her.", false);
            this.player.buttChange(this.monster.cockArea(0), true, true, false);
            this.outputText("\n\n", false);
            this.outputText("The shark grits her teeth and gives a roar as she cums, blowing a massive, hot load straight up your " + this.assholeDescript() + ", bloating you slightly as she empties her quads inside you.  Your muscles twitch and contract, and you can swear you see stars as she ejaculates.  It takes you a while to catch your breath as you slide off her slowly softening meat pole and crawl onto the sand.\n\n", false);
            this.player.orgasm();
            //[(if Izmafight <=4)
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_TIMES_FOUGHT_AND_WON] <= 4 || this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00235] > 0) {
                this.outputText("You say your goodbyes to the pretty tigershark and leave once she hands you your tooth-shaped reward.", false);
        ...
        chooseIzmaTooth() {
            this.outputText("", true);
            this.outputText("You accept the tooth from her with a polite word of thanks.", false);
            //(gain 1 t-shark toof)
            this.flags[kFLAGS_1.kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.consumables.TSTOOTH.id;
            this.cleanupAfterCombat();
        }
        ...
        chooseIzmaGloves() {
            this.outputText("", true);
            this.outputText("You look her dead in the eye and say, in a flat monotone, \"<i>I want your gloves.</i>\"\n\n", false);
            this.outputText("\"<i>W-what?</i>\" she asks, dazed.  You point at the hooked gauntlets, currently laying discarded on the beach after the sex.  \"<i>But that's my weapon!  I need it to-</i>\"\n\n", false);
            this.outputText("You cut her off with an airy wave of your hand.  \"<i>S'cuse me, but who's the boss here?  Pick up those gloves and give them to me graciously, little girl.</i>\"  She should be taking it as a compliment that someone above her would deign to use her weapon, a thought which you manage to convey to her by means of your no-nonsense stare.\n\n", false);
            this.outputText("Meekly, she picks up the gloves and hands them to you.", false);
            //(gain 1 Hooked gauntlets) 
            this.flags[kFLAGS_1.kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.weapons.H_GAUNT.id;
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00235]++;
            this.cleanupAfterCombat();
        }
        ...
        nonFightIzmaSmexPAINUS() {
            ...
            if (this.player.cockTotal() == 1 && this.player.cocks[0].cockType.Index < 9) {
                ...
                if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.HUMAN)
                    this.outputText("Izma seems surprised to see your genitalia is similar to hers.  \"<i>Huh. Thought that every land-dweller usually bumbled into a dick transformation around here.</i>\"", false);
                //[Horse cock in slot 0] 
                else if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                    this.outputText("Seeing your " + this.cockDescript(0) + " causes Izma to lick her lips slowly. \"<i>Well... Equinum is pretty popular, isn't it?</i>\"", false);
                //[Dog cock]
                else if (this.player.hasKnot(0))
                    this.outputText("Izma stares intently at your " + this.cockDescript(0) + ", as if trying to make up her mind about it. \"<i>Well, it is a rather cute look. Just be careful with the knot, will ya?</i>\"", false);
                //[Tentacle] 
                else if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE)
                    this.outputText("A puzzled look plays across Izma's face as she stares at your " + this.cockDescript(0) + ".  \"<i>Wow... I've read a lot about the corrupt plants.  Didn't think people could wind up like that.</i>\"", false);
                //[Demon Dick] 
                else if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.DEMON)
                    this.outputText("Izma looks shocked as she lays eyes on your perverted pecker, having never seen anything quite like it before. \"<i>Um... that looks... awkward. Like having a truncheon between your legs.</i>\"", false);
                //[cat dork] 
                else if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.CAT)
                    this.outputText("She glances at your barbed pecker and winces.  \"<i>You ate the fruit around here, didn't you?  One of my friends did that, too.</i>\"", false);
                //[lizardick]
                else if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.LIZARD)
                    this.outputText("Her eyes goggle as you reveal a bulbous purple pecker.  \"<i>Oh wow.  Do you have a green one too?</i>\"", false);
                //[Captain Nemo] 
                else if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.ANEMONE)
                    this.outputText("She grimaces as you unveil a " + this.cockDescript(0) + ".  \"<i>God, not one of those.  You wind up hornier after cumming than you were before you started touching it.</i>\"", false);
                //[Kangaroo Jack] 
                else if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.KANGAROO)
                    this.outputText("She looks on blankly as you reveal your sheath, then gives a start as your " + this.cockDescript(0) + " slides out of it after a few strokes.  \"<i>Woah... it's so... thin and pointy.</i>\"", false);
            }
            //Multi or weird new shit.
            else
                this.outputText("Her eyes bug out as you reveal " + this.sMultiCockDesc() + ".  \"<i>Woah, jeez, look at that one... oh man, and that one's... daaamn.</i>\"", false);
            this.outputText("\n\n", false);
            //[If the player is masculine but has B-cups or larger]
            if (this.player.mf("m", "f") == "m" && this.player.biggestTitSize() >= 2) {
                this.outputText("The fact that you have breasts seems to confuse Izma quite a bit as well, causing her to tilt her head.  \"<i>You're a guy... with boobs.  Did you honestly think they were necessary, or did you just want something to play with?</i>\"", false);
                //[If player is lactating] 
                if (this.player.biggestLactation() >= 2)
                    this.outputText("  Catching sight of some milk oozing from your nipples makes Izma step back slightly.  \"<i>You're lactating too?!  Man, there are way too many things that are weird about this...</i>\"  Still, you doubt Izma is as turned off as she acts, what with the raging erection between her legs.", false);
                this.outputText("\n\n", false);
            }
            this.outputText("Once you're done appraising each other, you ask Izma just how she wants to do this.  Izma scratches the back of her neck in thought, before bringing up an idea.  \"<i>What if you lie on your back, and I blow you while you blow me?</i>\"  You're a little uncomfortable with the prospect, causing Izma to fold her arms.  \"<i>Fair's fair. I'm not gonna cum with you just staring at it, and we certainly can't assfuck each other at the same time.</i>\"\n\n", false);
            //[(If tentacle in slot 0)
            if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE)
                this.outputText("\"<i>Well, actually...</i>\" you begin, flexing your cock-tentacle.  She cuts you off with a glare.  ", false);
            //(other slot 0)
            else
                this.outputText("You go to protest further, but stop when she gives you a glare.  ", false);
            this.outputText("You're already too horny to back out now, though.  Sighing in annoyance, you flop back onto the sands and motion at Izma to join you.  Izma nods and smiles, making her way over to you and swinging her hips from side to side as if to tease you further, before positioning her head at your groin and rubbing her own groin against your head.  \"<i>Alright, let's do this,</i>\" Izma says bluntly, wasting no time gorging herself on your " + Appearance_1.Appearance.cockNoun(this.player.cocks[0].cockType) + ", wrapping her tongue around it and fellating like a pro.  You gasp slightly at the expert treatment, and decide your previous protests were pointless if you're gonna get this kind of pleasure from the deal.\n\n", false);
            this.outputText("You wrap your lips around Izma's own massive erection, sucking and gagging on her more-than-footlong cock as she jerks and twists her hips around.  Her muffled moans seem to assure you that you're doing a great job, and Izma responds by increasing the speed of her head-bobbing.  Your vision is a little obscured by Izma's quartet of balls repeatedly bumping against your forehead and the bridge of your nose, but if anything this serves to arouse you further.\n\n", false);
            this.outputText("In an effort to further pleasure your tigershark partner, you occasionally reach up to fondle her swollen sack and finger her tight, damp cunt.  Izma gasps sharply and shudders from the pleasure you're giving her.  As if to reward you for your efforts, Izma picks up more speed with her sucking, drenching every inch of your " + this.cockDescript(0) + " with her saliva, and as you're so eager for her magic tongue you start thrusting your hips up to reach as far into her mouth as you can.\n\n", false);
            this.outputText("Eventually, the two of you manage to bring each other to a powerful simultaneous orgasm, Izma's hot cum shoots down your eager throat, and you yourself fire loads into Izma's cheeks", false);
            if (this.player.cockTotal() > 1)
                this.outputText(" and hair", false);
            this.outputText(".  ", false);
            //[(big/mega skeet)
            if (this.player.cumQ() >= 500)
                this.outputText("You continue to shoot off stroke after stroke long after her mouth has filled up and she's pulled away.  \"<i>For the love of Marae, " + this.player.short + ", I can't swallow all that!</i>\"  ", false);
            this.outputText("The two of you roll away from each other, and while you catch your breath you're surprised at the strong taste of Izma's cum.  You don't think you'd mind getting another load of that wonderful spunk in your stomach...\n\n", false);
        ...
        nonFightIzmaSmexASS() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("Once you strip down and reveal your nude form to Izma, she purses her lips in thought.  \"<i>Well, this is a problem....</i>\"  You raise an eyebrow as she stalks around you.  \"<i>How, uh... how are we gonna do this?  I mean... I'm NOT putting my mouth there, you can get those thoughts out of your head!</i>\" she says indignantly; you frown slightly, feeling dejected because of your odd condition.\n\n", false);
            this.outputText("Izma sighs and places a hand on your shoulder.  \"<i>I'm sorry... I came off as harsh there.  Look, it's... this isn't gonna work out unless one of us is on top.  Just... I dunno... go gulp some incubus drafts or succubi milk and come back.  Or challenge me.</i>\"  You nod and redress, deciding to take your leave.\n\n", false);
            //(If Int is 50+) 
            if (this.player.inte >= 50) {
                this.outputText("You stop a moment as a realization occurs to you.  \"<i>Wouldn't you be getting just as much pleasure if I was on top?</i>\" you ask.\n\n", false);
        ...
        nonFightIzmaSmexCUNTPUSSYSNATCHQUIM() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("Izma grins in response, and her hands move behind her back, undoing the strings on her black bikini top.  She flings the garment to the rocks, exposing her large, juicy breasts.  As if deciding to tease you, she turns around and grabs the hem of her skirt, pulling it down slowly and letting you get a good view of her firm ass.  She slowly faces you again, her massive 15-inch cock and balls swinging around with her.  You don't even realize that you've been unconsciously touching yourself throughout the whole thing, earning an uncharacteristic giggle from Izma.\n\n", false);
            this.outputText("\"<i>Your turn now.  Fair's fair,</i>\" she says, watching you with seductively-lidded eyes.\n\n", false);
            this.outputText("You nod and remove your " + this.player.armorName + ", not doing it with quite as much showmanship as Izma herself.  You expose your " + this.allBreastsDescript() + " to the air; your " + this.nippleDescript(0) + "s grow stiff from the breeze.  The bottom half of your clothing comes off, exposing your " + this.vaginaDescript(0), false);
            if (this.player.hasCock())
                this.outputText(" and " + this.multiCockDescriptLight(), false);
            this.outputText(" to the happy tigershark.  \"<i>Not bad, if you don't mind me saying so,</i>\" Izma remarks, moving toward you and placing a hand on your shoulder.  \"<i>Okay, so here's how we're gonna do this...</i>\" she begins, her hot erection poking you eagerly in the crotch.  \"<i>We won't be mating in the conventional sense, just working to get each other off, with our mouths,</i>\" she explains, showing you that her fangs are retracted just to reassure you.\n\n", false);
            this.outputText("You nod in agreement and watch Izma move onto the sands, before positioning your crotch over her face and putting your mouth just over her stiff cock.  Izma wastes no time, moving her face up and burying it into your cunt, her tongue probing your depths.  The sudden intrusion makes you gasp loudly, but 'fair's fair' as Izma says, and you respond by taking the head of her cock into your mouth.\n\n", false);
            this.outputText("You get to work licking and sucking the tip, strands of saliva linking your mouth to the hot organ every time you come up for air.  Izma doubles her licking speed and clamps her hands on your " + this.buttDescript() + ", earning a gasp from you.  It seems Izma wants to up the ante a little.\n\n", false);
            this.outputText("You decide to oblige her and start deepthroating her cock, all 15 inches sliding down your throat and stretching it out, earning some muffled moans from Izma.  You also start to rub and massage her meaty quad of balls, almost begging for her cum.  If the flavor of her salty pre from earlier was any indication, you're in for quite a taste when Izma finally blows her load.  Izma decides to match your efforts, rubbing and pinching at your clit with skilled hands.  Izma's no stranger to female lovers it would seem, but that's not surprising given what the normal shark girls are like.\n\n", false);
            this.outputText("Izma gives a muffled groan of pleasure, her cum blasting down your throat and filling your cheeks as you pull your mouth up.  It's not too long after that when you cry out in orgasm, your girlcum spattering onto the tigershark's face", false);
            if (this.player.hasCock())
                this.outputText(" and " + this.sMultiCockDesc() + " shooting a weak load across her chest", false);
            this.outputText(".  You roll off her and try to catch your breath, swallowing residual cum.  The taste is incredible, you have to admit... it's hard to define just what it is that makes it so good.  Something in the water Izma swims in?\n\n", false);
            this.player.slimeFeed();
        ...
        acceptIzmaAsYourBitch() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00236] == 0 && this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] == 1) {
                this.outputText("You smile warmly and place your hands on her shoulders, before pulling her in and kissing her deeply.  Practically melting at your touch and moaning into your mouth, she wraps her arms and tail around your waist.\n\n", false);
                this.outputText("By the time you pull away from the kiss, both of you are gasping for breath.  Strands of saliva still link the two of you.  You brush her silver hair behind her ears and tell her you'd be more than happy to have her in your camp.  She makes a gleeful noise and hugs you tight, before rushing for her meager supplies and packing them up.\n\n", false);
                this.outputText("You can't help but laugh at how eager she is to live with you as you guide her to your camp, and she never seems to shut up talking about how fun it'll be and how much the two of you will be able to fuck.  However, she stops talking entirely and tilts her head to the side as she spots Amily scurrying around your camp.\n\n", false);
                this.outputText("The mouse-morph is currently eating something from your supplies when you arrive, and guiltily spins around and hides it behind her back when she realizes you've returned.  \"<i>Ah, " + this.player.short + ", I'm glad to see you back!</i>\" she squeaks hurriedly; she's sincere, but obviously also a little embarrassed. Then she realizes you're not alone.  \"<i>Ah... you do know you have a shark-girl of some sort following you, don't you?</i>\"  She looks wary; ready to fight or flee if the situation warrants.\n\n", false);
                this.outputText("Izma tilts her head to the side and adjusts her spectacles to get a better look at Amily.  \"<i>Well, I'm a tigershark actually,</i>\" she says flatly.  \"<i>I'm also " + this.player.short + "'s beta.  Who're you?  Oh!  You're one of those mouse people, right?</i>\"\n\n", false);
                this.outputText("Amily just looks at her quizzically.  \"<i>Yes, I am a mouse.</i>\"  Her voice is ringing with a tone that just screams 'isn't it obvious?'.  \"<i>I'm sorry, I've seen some striped shark-girls before, but I didn't know your kind had a specific term... wait, what was that about being " + this.player.short + "'s beta?  What's a beta?</i>\"\n\n", false);
                this.outputText("Izma gives a frown and scuffs the ground with her bare feet.  You give a nervous chuckle and try your best to explain the events of how you met Izma, your various sparring matches and how she eventually submitted fully to you after several victories, declaring you as her alpha.\n\n", false);
                this.outputText("After that you turn to Izma and explain your past with Amily, the tales of her ruined village, how you grew to love her, and how you fathered many children with her to kickstart the population of untainted mouse-morphs.  Izma takes a breath and looks enthralled by your story.  \"<i>That's incredible; amazingly noble, both of you.</i>\"\n\n", false);
                this.outputText("\"<i>I - you really think so?</i>\" Amily asks, looking stunned and pleased all at once, blushing with embarrassment at the compliment.  Then she shakes her head.  \"<i>Ah, well... I suppose this isn't unexpected. At least she seems to actually have a brain in her head, not like some goblin or cum-drinking fairy... still, you could have at least asked me before you went fooling around with another woman, you know?</i>\" she complains.\n\n", false);
                this.outputText("Then she looks thoughtful.  \"<i>Hey, come to think of it, if you're a shark-girl - sorry, tigershark, then how are you going to survive out here?  Don't you need to spend about two-thirds of the day underwater to live?</i>\" Amily asks, puzzled.\n\n", false);
                this.outputText("\"<i>Ah, well... the lake isn't too far from here. And I think I saw a stream as we trekked over,</i>\" she explains.  \"<i>So long as I get some water on my body routinely, I'll be golden.  Plus it'll be nice to get access to some cleaner water.</i>\"  She grumbles and adjusts the chest in her arms again.  \"<i>Sorry, this thing is getting on my nerves, I gotta put it down.</i>\"  She walks past to place her trunk down, but flashes a sincere grin as she does. \"<i>It's been a pleasure to meet you, Amily; I do hope we get to know each other better,</i>\" she says.\n\n", false);
                this.outputText("Amily watches as the tigershark goes to explore the camp, then, quick as lightning, zips over to you and hisses into your ear.  \"<i>Don't think I'm not pissed that you didn't talk about this with me beforehand!  I'm just not stupid enough to challenge something that dangerous - I've seen shark-girls take down and EAT minotaurs coming to the lake for a drink!</i>\"  She pinches you sharply, to express her displeasure.\n\n", false);
                this.outputText("You apologize, but tell her that you won't just throw Izma out now.  She's here to stay, and the mouse-morph had better make her peace with that - fighting wouldn't work out well for anyone.\n\n", false);
                this.outputText("\"<i>I'll be polite to her, don't worry about that...  but are you absolutely sure we can trust her?  I'd be very hesitant to accept anything or anyone coming out of that lake,</i>\" Amily asks you, watching Izma as she curiously starts poking around at your mutual belongings.\n\n", false);
                this.outputText("You quietly point out that you met Amily in a ruined village by the lake, and ask her what she used to bathe in.  She glares at you, but you stand your ground and say that you trust Izma, pointing out that she's different from most of the creatures that have been tainted by the demons.  She could have attacked you and tried to rape you on sight - instead, she's been nothing but polite, conversational and self-controlled.  Even when the matter of sex came up, she talked with you about it first and made it clear that it was your choice and there would be no repercussions to refusing.  How many other beings in this world wouldn't have just raped first and asked questions never?\n\n", false);
                ...
                this.outputText("Marble nods and seems to force a smile.  \"<i>Just give us a moment,</i>\" she tells Izma, before taking you by the hand and pulling you to another part of camp rather forcefully. Oh great, it's going to be one of those talks.\n\n", false);
                this.outputText("\"<i>Sweetie, what the hell?!</i>\" she hisses once the two of you are out of earshot from Izma. \"<i>You could have at the very least consulted me on all this, instead of bringing some stranger into the camp! And she's one of those... corrupt monsters from the lake to boot!</i>\" she says.  She looks far angrier than you've seen her in the past, that's for sure.  You give a sigh and try to explain yourself, telling her that despite her appearance Izma is far nicer than any other creature that's come from that lake. She's been kind, considerate, and most importantly she always gave you a choice when it came to sex. That's far more than you could expect from some 'corrupt monster.'\n\n", false);
                this.outputText("Marble grits her teeth and shake her head. \"<i>I don't like it, sweetie.  I don't like it and I certainly don't support it.  Just keep her under control and away from me, and then we'll see,</i>\" the cow-girl says, before clopping off in a huff.\n\n", false);
                this.outputText("Izma looks to you curiously once you return to her.  \"<i>So what's your story with her?</i>\" she asks.  You give a sigh and tell Izma how you met Marble at Whitney's farm and how a relationship formed between you over time.  Then you go on about how, sadly, you became addicted to her milk without even realizing its corrupt nature.  ", false);
                //(If the player is fatally addicted) 
                if (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0)
                    this.outputText("You couldn't break your addiction, and now you'll die without a steady supply of her milk.", false);
                //(If the player broke their addiction) 
                else
                    this.outputText("Thankfully, though you were able to break her milk's hold, and you realized you love Marble despite all that transpired between you, letting her move in with you.", false);
                this.outputText("\n\n", false);
                this.outputText("Izma grits her teeth and sucks air through them as you finish your story.  \"<i>That... damn cow...</i>\" she growls, making you gulp at her barely contained rage.  \"<i>She took you, my perfect alpha, and ", false);
                //(Fatally addicted)
                if (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0)
                    this.outputText("turned you into some weak drug-addict", false);
                //(Broke addiction)
                else
                    this.outputText("drugged you into some twisted relationship", false);
        ...
        newAmilyMeetsIzma() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("You and Amily seem to talk non-stop on the way back, both excited at the prospect of living together.  Then she realizes you're not alone, once she sees Izma seated on her trunk, and looks puzzled. \"<i>" + this.player.short + "... there's a shark-girl in your camp!</i>\" she hisses, looking ready to fight or flee if the situation warrants.\n\n", false);
            this.outputText("Upon seeing you, Izma gives a toothy grin and approaches, not remotely bothered by Amily's presence.  Though she does tilt her head to the side and adjusts her spectacles to get a better look at Amily.  \"<i>Welcome home, dear,</i>\" she greets. Turning to Amily, she introduces herself.  \"<i>I'm Izma, " + this.player.short + "'s beta.  Who're you?  Oh!  You're one of those mouse people, right?</i>\" she asks.\n\n", false);
            this.outputText("Amily just looks at her quizzically.  \"<i>Yes, I am a mouse.</i>\"  Her voice is ringing with a tone that just screams 'isn't it obvious?'.  \"<i>What was that about being " + this.player.short + "'s beta?  What's a beta?</i>\"  You give a nervous chuckle and try your best to explain the past between you and Izma; what she is, your various sparring matches, and how she eventually submitted fully to you after several victories, declaring you as her alpha.\n\n", false);
            this.outputText("After that you turn to Izma and explain your past with Amily, the tales of her ruined village, how you grew to love her, and how you fathered many children with her to kickstart the population of untainted mouse-morphs.  Izma takes a breath and looks enthralled by your story.  \"<i>That's incredible; amazingly noble, both of you.</i>\"\n\n", false);
            ...
            this.outputText("\"<i>Ah, well, the lake isn't too far from here,</i>\" Izma counters.  \"<i>And there is a stream up here.  So long as I get some water on my body routinely, I'm golden.  Plus it's nice to get access to some cleaner water!  Well, I've got some reading to catch up on, so I'll leave you be,</i>\" the pretty tigershark says.\n\n", false);
            this.outputText("Amily watches as the tigershark returns to her bedroll, then, quick as lightning, zips over to you and hisses into your ear. \"<i>Don't think I'm not pissed that you didn't think to talk about this with me beforehand! I'm just not stupid enough to challenge off something that dangerous - I've seen shark-girls take down and EAT minotaurs coming to the lake for a drink!</i>\"  She pinches you sharply, to express her displeasure.\n\n", false);
            this.outputText("You apologize, but tell her that you won't just throw Izma out now.  She's here to stay, and the mouse-morph had better make her peace with that - fighting wouldn't work out well for anyone.\n\n", false);
            this.outputText("\"<i>I'll be polite to her, don't worry about that... but are you absolutely sure we can trust her?  I'd be very hesitant to accept anything or anyone coming out of that lake,</i>\" Amily asks you, watching Izma as she curiously starts poking around at your mutual belongings.\n\n", false);
            this.outputText("You quietly point out that you met Amily in a ruined village by the lake, and ask her what she used to bathe in.  She glares at you, but you stand your ground and say that you trust Izma, pointing out that she's different from most of the creatures that have been tainted by the demons.  She could have attacked you and tried to rape you on sight - instead, she's been nothing but polite, conversational and self-controlled.  Even when the matter of sex came up, she talked with you about it first and made it clear that it was your choice and there would be no repercussions to refusing.  How many other beings in this world wouldn't have just raped first and asked questions never?\n\n", false);
        ...
        newMarbleMeetsIzma() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("You and Marble are deep in conversation all the way to your camp, mainly inconsequential things to pass the time.  Marble enjoys the talk all the same, but she comes to a halt once she sees Izma sitting around your camp.  \"<i>Ah... who's that, sweetie?</i>\" she asks.\n\n", false);
            this.outputText("Izma smiles warmly and extends her hand out.  \"<i>Hey dear, hello stranger.  I'm Izma, " + this.player.short + "'s beta.  Pleased to meet you,</i>\" she says happily.  Seems she has no problems with you having another lover, though you're not sure Marble will share those feelings.  \"<i>Beta?</i>\" the cow-girl asks, curious despite the look of disdain still on her face.\n\n", false);
            this.outputText("You give a sigh and explain how you met Izma, your previous conversations and your eventual sparring matches.  After several defeats at your hands, Izma declared you as her alpha, stating that she'd do anything for you.  Figuring that it would be good to have another skilled fighter and a scholar at the camp, you allowed her to move in.\n\n", false);
            this.outputText("Marble nods and seems to force a smile.  \"<i>Just give us a moment,</i>\" she tells Izma, before taking you by the hand and pulling you to another part of camp rather forcefully.\n\n", false);
            this.outputText("\"<i>Sweetie, what the hell?!</i>\" she hisses once the two of you are out of earshot from Izma.  \"<i>You could have at the very least warned me about all this, instead of bringing me home to some stranger into the camp! And she's one of those... corrupt monsters from the lake to boot!</i>\" she says.  She looks far angrier than you've seen her in the past, that's for sure.  You give a sigh and try to explain yourself, telling her that despite her appearance Izma is far nicer than any other creature that's come from that lake.  She's been kind, considerate, and most importantly she always gave you a choice when it came to sex.  That's far more than you could expect from some 'corrupt monster.'\n\n", false);
            this.outputText("Marble grits her teeth and shakes her head.  \"<i>I don't like it, sweetie.  I don't like it and I certainly don't support it.  Just keep her under control and away from me, and then we'll see,</i>\" the cow-girl says, before clopping off in a huff.\n\n", false);
            this.outputText("Izma looks to you curiously once you return to her.  \"<i>So what's your story with her?</i>\" she asks.  You give a sigh and tell Izma how you met Marble at Whitney's farm and how a relationship formed between you over time.  Then you go on about how, sadly, you became addicted to her milk without even realizing its corrupt nature.  ", false);
            //(If the player is fatally addicted) 
            if (this.player.findPerk(PerkLib_1.PerkLib.MarblesMilk) >= 0)
                this.outputText("You couldn't break your addiction, and now you'll die without a steady supply of her milk.", false);
        ...
        */
        ...
        izmaLakeTurnedDownCampSex() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("You give Izma a smirk and tell her that, if she's in the mood, you could use a little 'relief'.\n\n", false);
        ...
        izmaLakeSexAsEquals() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("You tell Izma that you would like to have sex as equals; you and she.  She smiles and asks you what part you'd like to use.\n\n", false);
        ...
        izmaLakeDominate() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("Izma blushes fiercely and a lewd smile comes over her face at the suggestion.  \"<i>O-okay,</i>\" she says, stripping off her bikini top and gently removing her grass skirt, allowing her breasts and monster cock to pop free.  She sits down and smiles at you.  \"<i>After you...</i>\"\n\n", false);
            var x = this.player.cockThatFits(65);
            if (x < 0)
                x = 0;
            //[Male/Herm]
            if (this.player.hasCock() && (this.player.gender == 1 || IzmaScene.rand(2) == 0)) {
                this.outputText("You remove your " + this.player.armorName + " and spread Izma's legs wide, " + this.sMultiCockDesc() + " almost painfully erect as you lift her quartet of balls up to look at her glistening womanhood.\n\n", false);
                this.outputText("Not wanting to waste any time on foreplay, you push your " + this.cockDescript(x) + " into Izma's slit as far as you can manage, making Izma gasp sharply and writhe against you.  You snicker and start thrusting into her, the odd little tendrils inside her cunt teasing and massaging your cock.  The walls themselves are so tight and smooth that her pussy conforms to you like a glove.  It almost feels like Izma's snatch was made just for you.\n\n", false);
                this.outputText("You start to pick up speed as you mash your hips against Izma's own, earning moans from the pretty tigershark which only seem to get louder with every subsequent thrust.  Izma quickly starts to return the gesture, moving her hips up to meet your own thrusts every time.  It's while she's doing this that you notice her throbbingly erect cock wobbling around.\n\n", false);
                //NEW RADAR STUFF, GAO
            ...
            //[Female]
                ...
                this.outputText("You strip off your " + this.player.armorName + " and spread Izma's legs wide, licking your lips at the sight of her throbbing erection and meaty quads.  You give Izma's massive cock a few test strokes, earning some pleasured groans from the tiger shark.\n\n", false);
                this.outputText("Deciding you've had enough foreplay, you mount her and slide down her cock.", false);
                ...
                ///(non-taur and height > 4')
                    ...
                    this.outputText("and pin her hands above her head to stop her from trying to change the position. Her heaving breasts rub against your " + this.chestDesc() + " as you ride her in this posture.  She needs to know who's in charge here, after all.", false);
                //(non-taur and height <= 4')
                else
                    this.outputText("but small as you are, you can't stop her as she reaches up and grabs onto your " + this.buttDescript() + ", then begins bouncing you like a goblin cocksleeve.", false);
                this.outputText("\n\n", false);
                ...
                this.outputText("\"<i>What about a goodbye kiss?</i>\" she asks, trying to sound plaintive, but really sounding eager.  Happily, you allow her to embrace you, but in the midst of your passionate kiss, she suddenly pokes something from her mouth into yours, using her tongue to shove it down your throat and make you swallow.  You break away from her, coughing, and ask what that was.\n\n", false);
                this.outputText("\"<i>Birth control,</i>\" she explains. You give her a half-hearted slap across the face and tell her not to be so audacious, but you can see by her smiling expression that she's pleased to have stolen a march on you.", false);
                this.player.slimeFeed();
            }
            //[Genderless]
            else {
                this.outputText("You push her onto her back and see her inhuman dong flop free from her skirt.  Seems the idea of domination turned the little shark on.  Well, 'little' is hardly the right word to describe any aspect of her, especially when she has a 15-inch rock-hard erection waving over her.  It actually brings a dopey grin to your face.  Well, you earned a reward, so you might as well take it.\n\n", false);
                this.outputText("You lean down and start licking and suckling the tip of her monster dick, slurping up her hot pre and lubricating the tip of her raging boner.  She moans and jerks at your touch, writhing around and loving the sensation of submissiveness.  The feeling of having her under your power manages to bring a smile to your own face.\n\n", false);
                this.outputText("Gradually you start to suck more and more of her cock, inch after inch moving down your throat.  You gag lightly as you finally reach the base of her cock, before pulling it out.  She whines weakly and looks at you pitifully, wondering why you're teasing her.  You remove your " + this.player.armorName + " before turning to show her your " + this.buttDescript() + ", and a small smile spreads over her angular face as she realizes what you have planned.  You plant your hands on your backside and pull your cheeks wide, before starting to slide onto her well-lubed pecker.\n\n", false);
                this.outputText("She grunts and huffs as you slide down, and you too feel a strain from her iron-hard dick despite the various fluids lubricating it.  But gradually pain turns to pleasure and you're both moaning loudly and calling each others' names as you ride her.", false);
                ...
                this.outputText("The two of you get dress after awhile, have some small talk, and then you make your way back to camp.", false);
                this.player.slimeFeed();
            }
            this.player.orgasm();
            this.dynStats("sen", -1);
        ...
        izmaLakeDominateContinueVanilla(vanilla = true) {
            this.spriteSelect(32);
            var cockIndex = this.player.cockThatFits(65);
            if (cockIndex < 0)
                cockIndex = 0;
            if (vanilla) {
                this.outputText("", true);
            ...
            if (this.player.gender == 1) {
                ...
                if (this.player.cumQ() >= 1500)
                    this.outputText("  Eventually it can swell no more and each new squirt forces cum out from her stuffed pussy, trickling past her asshole.", false);
                this.outputText("  You sigh happily and push back from her, weakly getting to your " + this.player.feet() + " and redressing. Izma scrambles to her chest and takes out some sort of leaf, then eats it.", false);
            }
            //(Herm)
            else {
                this.outputText("After a lengthy fuck, you grunt loudly as your " + this.cockDescript(cockIndex) + " swells, blasting streamers of jizz into Izma's womb", false);
        ...
        letIzmaWankLikeABitch() {
            ...
            this.outputText("Grinning at her sudden need for penile release, you dart in for an intimate kiss and further inflame her passion, soliciting a series of sated moans as she reciprocates while increasing the speed of her stroking.\n\n");
        ...
        submitToLakeIzma() {
            ...
            this.outputText("", true);
            //(starter -all sexes)
            this.outputText("You give Izma a smile and begin to slowly, sensuously remove your " + this.player.armorName + ", littering the sand around you.  As the tigershark watches, you strike a few poses, and then sink onto your hands and knees with your rear facing towards her.  You twist around to look at her over your shoulder, ", false);
            if (this.player.hasLongTail())
                this.outputText("your tail waving enticingly, ", false);
            this.outputText("before you give your " + this.assDescript() + " a seductive wiggle.  You tell her that you think it's her turn to play.\n\n", false);
            this.outputText("Izma's breath visibly catches in her throat, her cock painfully erect and pulsing with lust.  She doesn't even bother to remove her bikini, instead stalking towards you, her intention obvious with every movement.  Within seconds she is behind you, her hands firmly gripping your " + this.buttDescript() + ".  You feel a sudden hot liquid sensation in between your buttocks, and you squeak in shock - it's almost like somebody has tipped hot lava onto your ass. Izma's cum is so hot you're surprised you don't see steam wafting back over you.\n\n", false);
            //(male/Unsexed)
            if (this.player.gender <= 1) {
                ///[(If player has tight butthole:)
                if (this.player.analCapacity() < 26) {
                    ...
                    this.player.buttChange(30, true, true, false);
                    this.outputText("\n\n", false);
                    this.outputText("\"<i>Holy-!  Think I better take it easy on this...</i>\" you hear Izma proclaim.  \"<i>For my own safety moreso than anything else!</i>\"  Her efforts become more gentle.  She still forces her way into you, inch by painstaking inch, but she does so at a slower, steady pace, allowing your pucker time to adjust to the fierce stretching she is subjecting it to and using her hot pre-cum like lubricant.\n\n", false);
                }
                //(If player has middling anus:) 
                else if (this.player.analCapacity() < 26) {
                    this.outputText("You can feel every inch of her cock as it sinks steadily into your anus, swelling into your guts as inexorably as the flood tide.\n\n", false);
                    this.outputText("\"<i>Ahhhh... now that's a nice little hole!  Did you lose on purpose?</i>\" she asks, and you can hear the grin in her voice.\n\n", false);
                }
                //(If player has a loosey goosey:)
                else {
                    this.outputText("Izma's cock may be fairly impressive, but you've taken bigger in your time, and it shows; Izma's first experimental thrust sees her sink up to the hilt into your bowels, and you moan with the pleasure of being filled again even as her four balls slap against your " + this.buttDescript() + ".\n\n", false);
                    this.outputText("\"<i>The heck!?  What kind of monsters have you been running into?</i>\" she wonders aloud.\n\n", false);
                }
                this.outputText("Fully buried, she tightly grips your " + this.assDescript() + "  and then pulls out partway, before thrusting herself back in fiercely.  \"<i>Thought you were clever, eh?  Wanted to try doing it like shark people do, did you?  Well, among the sharks, there're only two sorts - the strong and the weak.  And this is what the weak get.</i>\"  She growls fiercely.\n\n", false);
                this.outputText("Harder and faster she thrusts, building up a rhythm that grows in pace, her balls slapping audibly against your " + this.buttDescript() + " as she bucks back and forth.  You can feel her huge male organ in your depths, rubbing against your prostrate, stretching your inner walls, her boiling erection against your burning heat.  You moan in pleasure; you can't help but enjoy this", false);
                if (this.player.hasCock())
                    this.outputText(", and your own male organ is hard and throbbing from the stimulation", false);
                this.outputText(".\n\n", false);
            ...
            //(female)
                ...
                //(If player has ordinary, everyday cunt:)
                    ...
                    this.outputText("You can feel every inch of her cock as it sinks steadily into your " + this.vaginaDescript(0) + ", filling your moist folds as inexorably as the rising tide.\n\n", false);
                    this.outputText("\"<i>Ahhhh~  Now that's a nice little hole!  Did you lose on purpose?</i>\" she asks, and you can hear the grin in her voice.  You find yourself wondering that as well...", false);
                }
                //(If player is loose:)
                else {
                    this.outputText("Izma's cock may be fairly impressive, but you've taken bigger in your time, and it shows; Izma's first experimental thrust sees her sink up to the hilt into your crotch, and you moan with the pleasure of being filled again even as her four balls slap against your taint.\n\n", false);
                ...
                this.player.cuntChange(30, true, true, false);
                this.outputText("\n\n", false);
                this.outputText("Fully buried, she tightly grips your " + this.buttDescript() + " and then starts to pull out, before thrusting herself back in fiercely.  \"<i>Thought you were clever, eh?  Wanted to try doing it like shark people do, did you?  Well, among the sharks, there're only two sorts - the strong and the weak.  And this is what the weak get.</i>\"  She growls fiercely.\n\n", false);
                this.outputText("Harder and faster she thrusts, building up a rhythm that grows in pace, her balls slapping audibly against your butt as she bucks back and forth.  You can feel her huge male organ in your depths, rubbing against your womb's walls and stretching you out, her boiling erection pressed against your burning insides.  You moan; you can't help but enjoy this, your cunt drooling from the intense pleasure.\n\n", false);
                this.outputText("\"<i>Oh, somebody likes it, eh?  Well, don't worry, you wanted to test your luck, so I'm not going to hold back!  You're getting the whole experience, sweetheart!</i>\" Izma growls.  Her hands suddenly shift from your buttocks to holding onto your " + this.chestDesc() + ", and you howl in a mixture of pain and pleasure as Izma suddenly gives your " + this.nippleDescript(0) + "s a good hard tug.  \"<i>Stiff nipples?  You so wanted this...</i>\" Izma teases, licking at your neck and causing you to moan in pleasure.\n\n", false);
                this.outputText("\"<i>That's it, weakling, moan for me; make this sweeter!  I'd be moaning if you had won, so the least you can do is give me the same courtesy - fair's fair!</i>\" she mutters.  \"<i>Oh, yes, yes, yes! Good little fuck, good!  I... I'm... here... it... comes!</i>\"  She roars, releasing her grip on your tormented breasts to bellow her exultation to the sky, the climax that has been churning and thrashing her mighty balls finally erupting from within her.\n\n", false);
                this.outputText("You groan as well, your own orgasm coating the sands beneath you with girly fluids as Izma's cum boils into your womb.  Hot and slick, it surges and flows into you, pumping and pumping into your depths. Your belly grows as the great wave of tigershark cum reaches your stomach and fills it to the brim, and then it begins to stretch further.  Your limbs fail you and you fall face-first onto the sand in your pleasure, too consumed by sensation to even notice your stomach puffing out firm and hard against the earth.\n\n", false);
                ...
                if (this.player.pregnancyIncubation == 0)
                    this.outputText("Hauling out a plant, she gingerly removes a leaf and offers it to you.  \"<i>Could you take this please?  It's an anti-pregnancy herb.  I'd be happy to have babies with you someday... but I want to earn your acknowledgment as a mate first.</i>\"  Smiling a bit at how old-fashioned she seems, you take the leaf out of her hands and eat it.", false);
            }
            //(herm)
            else {
                this.outputText("\"<i>Dirty little minx, ain't ya?  You wanted this, didn't you...</i>\" Izma teases, shoving two fingers into your moist nether-lips, to test the waters.  The peneration of your needy cunt does serve to make you whimper softly, almost begging to just be filled.  ", false);
                ...
                //(20+ inches)
                    ...
                    this.outputText("Izma gives a low whistle at the sight of your " + this.cockDescript(0) + ".  \"<i>Now THAT'S a cock.  Looks like you've got a third leg down there!</i>", false);
                this.outputText("\n\n", false);
                this.outputText("Seemingly done appraising you, Izma roughly grabs your " + this.player.feet() + " and pulls your rear upwards, forcing your weight onto your spine and making you cry out from the uncomfortable position.  She doesn't waste time on foreplay, simply deciding to bury her cock into you slowly, inch by painstaking inch until she's pushing against the entrance to your womb.", false);
                this.player.cuntChange(30, true, true, false);
                this.outputText("\n\n", false);
                this.outputText("She starts thrusting in and out of you, gradually increasing the speed and force, her hot pre-cum and your feminine juices acting like a lubricant to make things easier.  \"<i>Ahh~  You're a lovely cock-sleeve... you like being treated like this, don't ya, weakling?</i>\" Izma taunts, slamming in and out of your " + this.vaginaDescript(0) + ".  You're not even really ashamed to admit that such is the case anymore.\n\n", false);
                this.outputText("Every thrust pushes you deeper into the sands, and eventually you find yourself pumping your hips upward against Izma's own, eager to pleasure her and yourself.  Izma seems to notice this and laughs loudly.  \"<i>Oh?  You really like being dominated?  Ha, I thought as much.</i>\"  She continues to taunt you as she pounds into you, her balls smacking against you every time.  Your mind is too clouded with lust to hear even half of what she says.  Right now all you care about is getting off.\n\n", false);
                this.outputText("Within minutes, Izma gives one final, powerful thrust and roars loudly, cum pumping into your womb and spraying out onto the sands.  " + this.SMultiCockDesc() + " twitches and pulses, ready to blow.  Izma quickly takes hold and points ", false);
                if (this.player.cockTotal() == 1)
                    this.outputText("it", false);
                    ...
                    this.outputText("them", false);
                this.outputText(" toward your face, stroking you to your own climax.  Jets of your own cum splatter across your face and body as you writhe, protesting. \"<i>Tch, you really thought I'd let you cum on ME?  Maybe if you actually managed to beat me I'd give you the honor,</i>\" Izma says, pulling free with a loud *SCHLICK* sound.  She ", false);
                if (this.player.pregnancyIncubation == 0) {
                    this.outputText("releases your " + this.player.feet() + ", allowing your " + this.buttDescript() + " to hit the sand with a plop, and gets to work redressing while you lie still.  She returns with an anti-pregnancy herb in her hands, and then flips a leaf into her mouth. Before you can wonder why she did that, she bends down and kisses you fiercely, her tongue pushing it past your lips and down your throat.", false);
                    this.outputText("\"<i>I'd be happy to make some babies with you... but <b>after</b> you accept me as a mate.\"</i>  She smirks, giving you a second, decidedly unchaste kiss before she helps you up.  You dress yourself and head back to camp feeling very sated.", false);
                }
                else
                    this.outputText("gives you a decidedly unchaste kiss before she helps you up.  You dress yourself and head back to camp feeling very sated.", false);
            }
            this.player.orgasm();
            this.dynStats("sen", 2);
            this.player.slimeFeed();
        ...
        izmaFollowerMenu() {
            this.spriteSelect(32);
            this.outputText("", true);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] == 0) {
                //Izma pops 'em out!
                ...
                this.outputText("You call for Izma and she approaches, asking, \"<i>What can I do for my Alpha?</i>\"\n\n", false);
                //Izma Pregnancy Stages:
                switch (this.pregnancy.event) {
                    case 2:
                        this.outputText("You can't help noticing that Izma seems very nauseous this morning; she's literally green around the gills.  When you investigate, though, she waves you off, insisting that she's fine; she just has a bit of a stomach bug.", false);
                        break;
                    case 3:
                        this.outputText("Izma comes up to you, looking concerned.  \"<i>" + this.player.short + ", do you think I've gained weight?</i>\" she asks.  Looking at her, particularly at the stomach she's holding her hands over, you have to confess that it is starting to bulge out in a noticeable paunch.  At her crestfallen look, you suggest that maybe she's pregnant.  At that, she looks delighted.  \"<i>You really think so?</i>\" she asks, hopefully.  You assure her that you're certain of it; after all, she's very good at watching her weight.  Pleased, she kisses you and then heads off for a swim.", false);
                        break;
                    case 4:
                        this.outputText("There is no doubt about it now; Izma's pregnant.  She's grown gravid more rapidly than any of the expecting mothers you remember seeing back in your village, but she seems to be having all of the same aches and pains.  She's grown lethargic and irritable, and complains about not being able to fit into her old clothes.  Still, despite that, she seems happy; she's always rubbing her belly with unmistakable pride.  You also think you've noticed her casting you \"<i>come hither</i>\" looks more frequently than before.", false);
                        break;
                    case 5:
                        this.outputText("Izma's started to go around completely naked now.  She insists that she's grown too big to fit into her clothes, but you're kind of skeptical about that; she's as big as the women in your village got when they were near the end, but they managed to fit into their clothes, and theirs were a lot more restrictive than a bikini and grass skirt combo.  Still, you're not objecting to the view it provides, and she definitely seems to enjoy that; you never knew a shark tail could be wiggled in an enticing manner over shapely buttocks until you came to this world...", false);
                        break;
                    case 6:
                        this.outputText("Izma's certain the baby will come soon.  You're inclined to believe her; she's huge now.  She still wears no clothing, but there's definitely a practical reason for it");
                        if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                            this.outputText("- you don't think her skirt would be able to cope with how often she gets erect now, her huge cock rubbing along");
                        else
                            this.outputText(", her juices staining");
                        this.outputText(" the underside of her swollen belly...  Izma spends much of her time in the water, now; she says it's to soothe her skin.  Given you've seen her explosively cum all over herself from ");
                        if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                            this.outputText("the friction of her cock against her bulge, you think it has more to do with avoiding being splattered in sexual juices all day long.", false);
                        else
                            this.outputText("the friction of her thighs as she moves, you think it has more to do with avoiding being splattered in sexual juices all day long.", false);
                        break;
                    default:
                }
            }
            else {
                this.outputText("Izma smiles and puts away her book at your approach.");
            ...
            var kids = undefined;
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_SHARKGIRLS] + this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0)
            ...
            this.choices("Appearance", this.izmaPearance, "Books", this.IzmaCampBooks, "Children", kids, "Sex", sex, "Talk", this.talkWivIzma, "Tooth", this.gatASharkTooth, "", undefined, "", undefined, deDickT, deDickB, "Back", this.camp.campLoversMenu);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] == 1)
                this.addButton(1, "", undefined);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] == 1)
                this.addButton(2, "", undefined);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] == 0 && this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_STARTED] == 1 && !this.pregnancy.isPregnant)
        ...
        sendToFarm() {
            this.clearOutput();
            this.izmaSprite();
            this.outputText("You tell your beta that she is to head towards the lake, find a farm, present herself to the lady who works there and do as she says. Izma’s brow furrows as she takes this in.");
            ...
            this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        backToCamp() {
            this.clearOutput();
            this.izmaSprite();
            this.outputText("You tell her to head back to camp; she will be more use to her alpha there.");
            ...
            this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] = 0;
        ...
        gatASharkTooth() {
            this.spriteSelect(32);
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00246] > 1) {
                ...
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00246]++;
        ...
        izmaSexMenu() {
            ...
            //Vagoo - req Cock
            if (this.player.hasCock()) {
                if (this.player.cockThatFits(65) >= 0)
            ...
            if (this.player.hasVagina() && this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_IZMA_DOMMED_LATEXY] > 0 && this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0 && this.latexGirl.latexGooFollower())
                this.addButton(8, this.flags[kFLAGS_1.kFLAGS.GOO_NAME], this.izmaLatexySubmenu);
            this.addButton(9, "Back", this.izmaFollowerMenu);
        }
        //[Izma mounts the PC]
        followerIzmaMountsPC(lastHalf = false) {
            this.spriteSelect(32);
            this.outputText("", true);
            var x = this.player.cockThatFits(65);
            if (x < 0)
            ...
            if (!lastHalf) {
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                    this.player.slimeFeed();
                this.outputText("With a smirk, you make a show of removing your " + this.player.armorName + " and settling yourself down on your back, " + this.sMultiCockDesc() + " pointing into the air excitedly.  You give Izma a coy look and tell her that you're thinking of letting her have control this time... if she thinks she can dominate with her pussy");
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                    this.outputText(" instead of her cock");
                this.outputText(".  Izma watches you eagerly and licks her lips.  \"<i>I think that can be arranged,</i>\" she purrs, straddling you and then slowly sliding down onto your erect member.  The tiny tendrils inside her cunt tickle and massage your cock all the while.\n\n", false);
                this.outputText("You groan, lie yourself back down, and give yourself over to your aquatic girlfriend's ministrations; you don't know why she has naughty little tentacles inside her pussy, but you're certainly not going to complain about them.  You can feel them caress and stroke your " + this.cockDescript(x) + ", eagerly pulling it deeper and deeper into her warm, wet, inviting depths.\n\n", false);
                this.outputText("Once you're fully inside her pussy she looks at you and smirks, a low, animalistic growl escaping her lips.  As her hips start to gain speed she leans down and bites your collar bone, thankfully with her human teeth.  You yelp in shock and cast a startled glance at her.  She hums in your ear as her hips start to twist and gyrate even faster.\n\n", false);
                this.outputText("It does feel pretty good, and so you settle back down, one hand cautiously lifting up to caress the mark of your lover's bite.  \"<i>Hehe, don't worry; you're not bleeding or anything.  Just marking you as mine,</i>\" she whispers, before giving a loud moan.  ");
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                    this.outputText("  Your stomach starts to feel wet, and as you look down you realize her pre is starting to soak into your " + this.player.skinFurScales() + ".\n\n", false);
                else
                    this.outputText("  Your stomach starts to feel wet, and as you look down you realize her feminine lubricant is starting to soak into your " + this.player.skinFurScales() + ".\n\n", false);
                this.outputText("You wonder if you should be more actively moving your hips to her thrusts, but then, this is supposed to be about letting her be in charge.");
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0) {
                    ...
                    this.simpleChoices("Jerk It", this.createCallBackFunction(this.followerIzmaMountsPC, true), "Nope", this.RadarIzmaLeaveHerWangUnWingWanged, "", undefined, "", undefined, "", undefined);
                    return;
            ...
            this.outputText("Even if you hadn't found Izma's impromptu cum bath a bit kinky, your ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("own ");
            this.outputText("cock has been just as teased and tormented - and as her inner walls grip down, her tentacles squeezing as hard as they can, it's too much. You let out a cry of your own as you flood her interior with your spooge", false);
            //[(if vagina)
            if (this.player.hasVagina()) {
                this.outputText(", your cunt ", false);
                if (this.player.vaginas[0].vaginalWetness <= appearanceDefs_1.VAGINA_WETNESS_SLICK)
                    ...
                    this.outputText("gushing", false);
                else
                    this.outputText("cascading", false);
                this.outputText(" feminine fluids onto the sticky ground beneath you both", false);
            }
            this.outputText("; you were just as eager to release as she was.\n\n", false);
            this.izmaPreg();
            //(Standard cum protozoan) 
            if (this.player.cumQ() < 500)
                this.outputText("You can feel Izma's womb fill with your cum, and she shudders from the sheer pleasure.", false);
            //(High cum production) 
            else
                this.outputText("Izma squeals loudly as you cum inside her, almost having a second orgasm as her belly is bloated and distended by your inhuman amount of cum.", false);
            this.outputText("  Once you've finished, Izma rolls off you and continues breathing heavily.  \"<i>That was amazing... my Alpha.</i>\"\n\n", false);
        ...
        izmaPreg() {
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] == 1)
                return;
            //PREGGO CHANCES
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00249] == 1 && !this.pregnancy.isPregnant && IzmaScene.rand(100) < (10 + Math.round(this.player.cumQ() / 100))) {
                this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, PregnancyStore_1.PregnancyStore.INCUBATION_IZMA);
            }
        }
        ...
        followerIzmaTakesItInPooper() {
            ...
            this.player.slimeFeed();
            this.outputText("", true);
            this.outputText("When you tell Izma you want her to screw you this time, she exclaims, \"<i>Ooh! It's my turn to be alpha!</i>\"  Her look of deviant joy fades into a blush of fondness for a moment, and she holds you and whispers into your ear, \"<i>It's really nice that you let me take charge, too.  Thanks for thinking of it.</i>\"\n\n", false);
            this.outputText("You're about to reply when she grabs your wrists and, holding them behind your back, ", false);
            //[[if [player height>6' or player is centaur] 
            if (this.player.tallness > 72 || this.player.isTaur()) {
                this.outputText("pulls you down to kiss you fiercely", false);
            }
            //[else if player<4.5'] 
            else if (this.player.tallness < 54)
                this.outputText("pulls you up off the ground in a bear hug to kiss you fiercely", false);
            //[else] 
            else
                this.outputText("pulls you in to her body and kisses you fiercely", false);
            this.outputText(". She lets her shark teeth graze your lips, and you taste blood.\n\n", false);
            this.outputText("You start to kiss her back, but she's still in charge, and seems intent on screwing your mouth with her tongue. You feel her stiffening tool ", false);
            //[[if player has legs] 
            if (this.player.isBiped() || this.player.isTaur())
                this.outputText("between your legs", false);
            //[else] 
            else
                this.outputText("against your lower body", false);
            this.outputText(", and give up on fighting. Each time her tongue thrusts into your mouth, you try to suck it a little, or flick it with your own tongue.\n\n", false);
            this.outputText("Izma gives a happy moan as she feels you relax into her large breasts, and a satisfied chuckle when you start fellating her tongue.  Pulling back from your panting mouth, she pushes you down to the ground and presents you with her cock.\n\n", false);
            this.outputText("\"<i>Get it nice and slippery, then, if you're so eager.</i>\"\n\n", false);
            this.outputText("You start kissing along her fifteen-inch length, but Izma's in more of a hurry than that, because she grabs your " + this.hairDescript() + " and pulls you back to the tip.  With her smooth glans resting at your lips, you look up at her. She grins, showing all her teeth, and starts pushing your head down.\n\n", false);
            this.outputText("As her cock slides past your lips and down your throat, it takes a lot of effort not to gag, but you feel proud and happy when she's the first one to look away, tilting her head back and grunting in pleasure as she bottoms out in your mouth, her balls tapping against your chin.\n\n", false);
            this.outputText("It's only a few seconds, but when she finally pulls out of your throat you splutter and cough.  \"<i>Too much to swallow?</i>\" she asks, half-mockingly, half-lovingly, then pulls your head back and fucks your throat in earnest, giving you at least a dozen thrusts without a chance to breathe.  When she's done she lets you fall onto your back, gasping, and Izma lowers herself onto you.\n\n", false);
            //[(if player has penis)
            if (this.player.hasCock()) {
                this.outputText("You expect to feel her penetrate you when she thrusts forward, but instead she runs her cock along the surface of your asshole", false);
                //[(if player has balls)
                if (this.player.balls > 0)
                    this.outputText(" and " + this.sackDescript(), false);
                this.outputText(" until her dark-red cock is lined up with your " + this.multiCockDescriptLight() + ".\n\n", false);
                this.outputText("She takes your " + this.cockDescript(0) + " and presses it against her own, holding both of them together in one hand and rubbing slightly.  Her other hand reaches down below, to rub her double set of balls", false);
                //[(if player has balls)
                if (this.player.balls > 0)
                    this.outputText(" against your own " + this.ballsDescriptLight(), false);
                //(if no balls and vag)
                else if (this.player.hasVagina())
                    this.outputText(" against your already-dripping " + this.vaginaDescript(0), false);
                //(else)
                else
                    this.outputText(" against your perineum", false);
                this.outputText(", humiliating you more than she stimulates you.\n\n", false);
                //[if dick0 is <14\"] 
                if (this.player.cocks[0].cockLength < 14)
                    this.outputText("\"<i>Hmm...</i>\" she sighs, as she looks at her glans sticking out past the tip of your dick.  \"<i>It's nice to know who's in charge.</i>\"", false);
                //[dick0 >14 but <16] 
                else if (this.player.cocks[0].cockLength < 16)
                    this.outputText("\"<i>It's nice that we keep things fair around here,</i>\" murmurs Izma, smiling at your similarly-sized cocks.", false);
                //[If dick0 >16]
                else
                    this.outputText("\"<i>Oh fuck,</i>\" she says, her eyes filling with lust as she sees your cock extending well past her own.  She tilts forward and rubs the base of her cock hard against the base of your " + Appearance_1.Appearance.cockNoun(this.player.cocks[0].cockType) + ", jerking the both of you off together.  You moan helplessly when she stops, and she sighs, \"<i>It feels so good to be alpha over a powerful cock like yours.</i>\"", false);
                this.outputText("\n\n", false);
            }
            this.outputText("She slowly moves her hips away and lifts your ass up off the ground, letting her head trail along your body until it drops into place at your anus.  ", false);
            //[[if player is anal virgin]
            if (this.player.ass.analLooseness == 0) {
                this.outputText("You gasp in pain as she starts pushing her giant cock against your tightly-puckered ass, whimper as your sphincter gives way and, with a pop, her cock head is resting inside of you.  Izma looks at you with a confused face, and then seems to realize what just happened.\n\n", false);
                this.outputText("\"<i>You... let me be the first to take you? You're sweeter than I thought!</i>\"  She strokes your body with surprising gentleness as she eases herself the rest of the way into you.  Each inch is easier than the last, and by the fifteenth inch you're squirming and ready for more.", false);
            }
            //[else if player has tight anus]
            else if (this.player.analCapacity() <= 26) {
                this.outputText("You moan as Izma's cockhead pushes past your tight sphincter.  \"<i>That's it, you beta slut,</i>\" she says as she slides the rest of her cock into you.  \"<i>Moan for your alpha.</i>\"", false);
            }
            //[else if player has loose anus]
            else {
                this.outputText("Izma starts to push and, meeting no resistance from your well-trained ass, slams her hips against yours with a groan of satisfaction.\n\n", false);
            }
            this.player.buttChange(30, true, true, false);
            this.outputText("\n\n", false);
            this.outputText("With her hips securely pressed against yours, she leans over you to grab your wrists and hold them to the ground, her elbows hooked");
            if (this.player.isBiped())
                this.outputText(" behind your knees to immobilize you");
            else
                this.outputText(" around your [legs] to immobilize you");
            this.outputText(" with your ass in the air.  Her cock feels warm inside of you, and you could swear she's making it throb deliberately, just to feel you twitch in response.\n\n", false);
            this.outputText("She starts to screw you deliberately, pulling out just short of all the way before thrusting back in with practiced expertise.  You're lost in the pleasure of being used so roughly, and can't remotely keep track of how long she screws you.", false);
            //[if player has penis: 
            if (this.player.hasCock())
                this.outputText("  You try to reach for your cock and get off, but her hands keep your wrists securely pinned to the ground.", false);
            this.outputText("\n\n", false);
            this.outputText("Her thrusts become shorter, faster, and wilder, and you see her panting and focusing.  Reaching forward with your mouth, you take one of her dangling nipples in your mouth and start suckling and nibbling.  Her half-closed eyes flash open and she slams into you with a shocked expression.\n\n", false);
            this.outputText("She yells as you bite down on her nipple, and you're rewarded with hot spurts of cum that fill your belly as Izma's quad balls empty into you.  ", false);
            //[if player has no penis)
            if (!this.player.hasCock())
                this.outputText("The feeling of her cock throbbing finally puts you over the edge and you orgasm, your tight pucker helping milk the last of her cum into you.\n\n", false);
            //(if player has penis)
            else {
                this.outputText("She collapses onto you, spent, and you close your eyes and relish the feeling of her hot cock pulsing in your ass and her warm belly lying against your " + this.cockDescript(0) + ".  When she sits back up, she gives you a stern look as she lets go of your wrists, making it clear that they should stay right where they are.  You look at her pleadingly as she trails her fingers along your " + Appearance_1.Appearance.cockNoun(this.player.cocks[0].cockType) + ".\n\n", false);
                //[(if penis 0 length <14 inches)
                if (this.player.cocks[0].cockLength < 14) {
                    this.outputText("Izma grabs your " + this.cockDescript(0), false);
                    if (this.player.cockTotal() > 1)
                        this.outputText(" first, then your other " + this.cockDescript(1) + ", synchronizing her movements", false);
                    this.outputText(", and starts jerking you off.  It feels incredible, and when she says, \"<i>You've been a good beta for me, but now I want to see you come,</i>\" you can't help but obey; you orgasm messily onto your own " + this.chestDesc(), false);
                    //(huge cum)
                    if (this.player.cumQ() >= 1500)
                        this.outputText(" over and over again until you're a sticky mess lying in a pool of your own semen.", false);
                    //[(big cum)
                    else if (this.player.cumQ() >= 500)
                        this.outputText(" until cum pours off of your body and pools on the ground.", false);
                    else
                        this.outputText(".", false);
                    this.outputText("\n\n", false);
                }
                //(else if penis 0 length <16 inches)
                    ...
                    this.outputText("When Izma guides " + this.sMultiCockDesc() + " between her breasts, you're not sure what you're feeling at first; smooth in one direction, rough in the other direction.  Pushing her breasts tight around your " + this.multiCockDescriptLight() + ", she starts to move up and down.  The contrast quickly brings you over the edge and you cum all over her face and breasts, ", false);
                    //[(normal cum)
                    if (this.player.cumQ() < 300)
                        this.outputText("leaving her looking spattered but pleased", false);
                    else if (this.player.cumQ() < 500)
                        this.outputText("leaving her looking wet but impressed", false);
                    else
                        this.outputText("showering her in so much cum that she leans down to lick it off of her breasts", false);
                    this.outputText(".\n\n", false);
                }
                //[(else if penis 0 length >15 inches)
                else {
                    this.outputText("Your sigh of relief soon becomes a moan of pleasure when you feel Izma take the head of your " + Appearance_1.Appearance.cockNoun(this.player.cocks[0].cockType) + " into her mouth.  Despite the hidden presence of her ring of sharp teeth, you feel nothing but bliss as she sucks, her own cock still buried deep inside of you.  She nestles the shaft of your " + this.cockDescript(0) + " between her breasts and starts moving her upper body up and down against your cock.  You're startled to feel that her breasts are smooth in one direction and rough in the other, and the alternating sensations soon overwhelm you.  You manage a shuddering yell to warn Izma before you start pumping cum into her mouth", false);
                    if (this.player.cockTotal() > 1)
                        this.outputText(" and onto your combined bodies", false);
                    this.outputText(".\n\n", false);
                    //<1 L] 
                    if (this.player.cumQ() < 1000)
                        this.outputText("She swallows dutifully and, when your cock has stopped throbbing between her breasts, takes her mouth off of you, licks her lips, and smiles, showing so many teeth that your cock shrinks a little bit faster than normal.\n\n", false);
                    //[<5 L] 
                    else if (this.player.cumQ() < 3000)
                        this.outputText("She swallows dutifully at first, and when you keep pumping her with cum, gives up on swallowing. Instead, she grabs you by the hips and, by leaning down and pulling you up, gets your cock down her throat so you can deliver your seed directly.  It looks difficult but feels amazing, and when you're done and she pulls her head back, she looks very proud of herself.\n\n", false);
                    //[>5 L] 
                    else
            ...
            if (!this.player.hasCock())
                this.outputText("After a few minutes, she pulls her shrinking cock out of you and gives you a deep kiss. \"<i>Thanks for that,</i>\" she says, \"<i>...my Alpha.</i>\"  She jogs off to the river to clean off.  After a minute you follow her, with her cum dripping out of your well-used anus.", false);
            this.player.orgasm();
            this.dynStats("sen", -1);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        followerIzmaTakesItInVagoo() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.player.slimeFeed();
            this.outputText("", true);
            this.outputText("Admiring the view of the tigershark's ornamented crotch, you lower the bottoms of your " + this.player.armorName + " and reveal the base of your " + this.multiCockDescriptLight() + ", something that instantly draws Izma's eyes.  You ask how she'd like her alpha to tend to her oft-neglected pussy.  Izma smiles eagerly and spreads her legs");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText(", gently lifting her meaty quads up so");
            else
                this.outputText(", gently parting her muscled thighs so");
            this.outputText(" you can better see her damp nether-lips.  \"<i>Okay lover... if anyone knows how to make me feel good down there, it's you.</i>\"\n\n", false);
            this.outputText("You give her a lecherous grin back and stalk towards her, watching as she slowly seats herself on her bedroll and lies back for you; one hand playing with her breasts, ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("the other holding her maleness out of the way, teasing her cock with her thumb and flexing her fingers to roll her four balls around in the palm of her hand.");
            else
                this.outputText("the other slowly spreading the folds of her vulva, teasing her clit with her thumb and flexing her interior muscles to make the pink opening wink at you.");
            this.outputText("  You shed your own " + this.player.armorName + " and strike a pose for her. Izma watches you closely for a few moments, before growling, \"<i>Oh stop toying around and fuck me already!</i>\" She gives a gasp and covers her mouth. \"<i>O-oh, sorry... I was out of line talking to my Alpha like that!</i>\"\n\n", false);
            this.outputText("Sauntering over, you settle yourself on your elbows and knees before her.  Reaching out with one hand, you start to stroke her pussy, feeling its intense heat and letting her juices squelch and ooze between your fingers.  Casually, nonchalantly, you tell Izma that she was out of line for talking to you like that, and suggest that maybe you shouldn't put anything into her, if that's the mood she's in.\n\n", false);
            this.outputText("Izma moans and writhes slightly as you rub her cunt.  \"<i>N-noooo,</i>\" she whines, looking at you with puppy-dog eyes.  \"<i>Please, I need you...</i>\"  You enjoy her struggles for a little while, then give her your wickedest grin.  Well, if that's the way she feels about it...  You surge forward, rising up between her legs until your pelvises are positioned properly.  You position your " + this.cockDescript(0) + " against her labia and then slide it home, enveloping it in her hot, wet depths.  She moans loudly and goes limp, gasping and panting from the pleasure.  The strange tendrils in her cunt waste no time massaging and teasing your cock");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText(", while Izma herself reaches around to jerk herself off.\n\n", false);
            else
                this.outputText(", while Izma herself reaches up to massage her heavy breasts.\n\n");
            this.outputText("You wonder for a second if maybe it would be more dominant to stop her from pleasuring herself");
            //RADAR XPACK FORK
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0) {
                this.outputText(".");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText(", and gains speed as she jerks her meat pole");
            this.outputText(".\n\n", false);
            this.outputText("Seeing that she is speeding up, you accelerate your ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("own ");
            this.outputText("thrusts, trying to match her pace.  The tendrils inside her vagina writhe and flex, an experience unlike anything you've had before - you don't think any creature other than a succubus could give you this sort of pleasure!\n\n", false);
            this.outputText("Izma continues to moan and groan loudly, and starts to mash her own hips against yours, trying to work in as many inches of your " + Appearance_1.Appearance.cockNoun(this.player.cocks[0].cockType) + " as she can.  ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
            ...
            this.outputText("This sends a shudder through Izma's whole body.  She cries loudly as she orgasms");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText(", a hot jet of spunk going straight into your mouth, and several subsequent shots hitting you in the lips and face.  ");
            else
                this.outputText(", a small explosion of fem-cum splattering your belly, and several subsequent squirts dripping down your thighs.  ");
            this.outputText("Her vagina clamps down on your " + this.cockDescript(0) + ", making you grunt as the feelers in her pussy milk you for all you've got. You groan deep in your throat, the scent of Izma's hot ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 1)
                this.outputText("girl-");
            this.outputText("cum filling your nostrils and the feeling of her milking, hungry feelers is too much.  You cum, blasting everything you have deep into Izma's cunt.  ", false);
            //[(Normal cum production)
            if (this.player.cumQ() < 750)
                this.outputText("You pump straight into her womb, enough to make a trickle of your baby batter dribble from her freshly used cunt when you pull out.", false);
            //(High cum production)
            else
                this.outputText("Your load is so vast that it bloats and distends her belly, almost giving her a second orgasm from the sensations.", false);
            this.outputText("\n\n", false);
            this.outputText("The two of you roll apart, panting and gasping for breath.  \"<i>Mmm, that was amazing,</i>\" Izma says, giving you a long drawn-out kiss and ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("licking some of her seed off of your face.  \"<i>Come fill me whenever you need to.</i>\"  You grin at Izma and order her to eat up every drop.\n\n", false);
            else
                this.outputText("licking you face affectionately.  \"<i>Come fill me whenever you need to.</i>\"  You grin back at Izma knowingly.\n\n", false);
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("She giggles and runs her tongue over the mess she's made; her tongue lingers on your lips for a few moments before she gives you another long kiss and lets you go.", false);
            else
                this.outputText("She giggles and runs her tongue over your lips, her tongue lingering for a few moments before she gives you another long kiss and lets you go.", false);
            //PREGGO CHANCES
            this.izmaPreg();
            this.player.orgasm();
            this.dynStats("sen", -2);
        ...
        radarIzmaXPackLetHer() {
            this.clearOutput();
            this.spriteSelect(32);
            this.outputText("You reach up to caress and fondle her breasts, gently tugging and rubbing her stiff nipples and giving them the occasional soft pinch.  The pretty tigershark responds well to your movements, moaning and gasping from pleasure.  She bites her lip, thankfully with her human teeth, and gains speed as she jerks her meat pole.\n\n", false);
            this.outputText("Seeing that she is speeding up, you accelerate your own thrusts, trying to match her pace.  The tendrils inside her vagina writhe and flex, an experience unlike anything you've had before - you don't think any creature other than a succubus could give you this sort of pleasure!", false);
            //(leads to Where's it going?)
            this.wheresItGoing();
        }
        wheresItGoing(denied = false) {
            this.spriteSelect(32);
            this.outputText("\n\nIzma continues to moan and groan loudly, and starts to mash her own hips against yours, trying to work in as many inches of your " + Appearance_1.Appearance.cockNoun(this.player.cocks[0].cockType) + " as she can.  As she ");
            if (!denied)
                this.outputText("jerks off ");
            else
                this.outputText("moans fiercely ");
        ...
        RadarIzmaCumInYourChest() {
            this.spriteSelect(32);
            this.clearOutput();
            this.outputText("Taking a firm hold of her, you angle her lengthy member towards your chest and close your eyes in anticipation for her orgasmic release.  She doesn't disappoint as the smell of sweet, salty sperm rushes into your nostrils, signaling your body to receive her hot cum. Before you can truly relish inhaling your lover's scent, her load slaps forcefully ");
            if (this.player.biggestTitSize() >= 1)
                this.outputText("in between your " + this.chestDesc() + " and coats ");
            this.outputText("against your chest");
            if (this.player.biggestTitSize() < 1)
                this.outputText(", coating it");
            this.outputText(" liberally.  The aroma of your lover's spunk is too much, and with a great howl of undiminished, fulfilled satisfaction, you thrust one final time and plow deep into her, intent on burying your cock  firmly into her womb, unconsciously giving your seed the fighting chance it needs to fertilize your submissive partner.  With tremendous force, your spunk erupts forth and rushes deep inside of her pussy, ");
            //[(Normal cum production)
            if (this.player.cumQ() < 750)
                this.outputText("liberally lubricating her fuckhole with steamy cum and causing your beta to cry out in blissful pleasure.", false);
            //(High cum production)
            else
                this.outputText("flooding her love canal with so much sperm that a slew of wet, sloppy noises ring out from her pussy.  Izma's expression betrays a sense of utter disbelief as you stuff her full of your spooge; which begins to flow out of her at a steady rate as each contraction of your dick's muscles fires more and more into her.");
        ...
        IzmaSelfFacialWheeRadar() {
            this.spriteSelect(32);
            this.clearOutput();
            this.outputText("Opting to direct her impending orgasm away from you entirely, you slap Izma's hands away, grabbing her dick and angling it towards her face.  With one last savage thrust, you bore your dick deep into her love canal and unleash a vicious flood of semen into her womb, which causes the tigershark to scream out in her own orgasm.  Fierce ropes of her cum soar out into the open air and speedily land on her blissed out face; some of it lands in her mouth between passionate groans and cries of euphoria.");
            this.outputText("\n\nYour own seed ");
            //[(Normal cum production)
            if (this.player.cumQ() < 750)
                this.outputText("liberally lubricates her fuckhole with steamy cum and causes your luscious beta to cry out in blissful pleasure.", false);
            //(High cum production)
            else
                this.outputText("floods her love canal with so much sperm that a slew of wet, sloppy noises ring out from her pussy.  Izma's expression betrays a sense of utter disbelief as you stuff her full of your spunk, some of which begins to flow out of her at a steady rate, each contraction of your dick's muscles firing more and more into her.");
            ...
            this.outputText("When she concludes with cleaning her Alpha, she takes a few moments to show you her appreciation for mating with her, kissing your chest and working her way up to your neck.");
            //PREGGO CHANCES
            this.izmaPreg();
            this.player.orgasm();
            this.dynStats("sen", -2);
        ...
        followerIzmaTakesIt69() {
            ...
            this.player.slimeFeed();
            this.outputText("", true);
            this.outputText("Izma smiles and nods, swinging her hips from side to side as she makes her way over to you, as if to tease you further. She positions her head at your groin, rubbing her own crotch against your head.  \"<i>Alright, let's do this,</i>\" Izma says happily, and wastes no time ", false);
            //[(Male/herm)
            if (this.player.hasCock()) {
                this.outputText("gorging herself on your " + this.cockDescript(0) + ", her tongue wrapping around it and caressing it like jewelry", false);
                //[(if herm)
                if (this.player.hasVagina())
                    this.outputText(" while pushing two fingers into your " + this.vaginaDescript(0), false);
            }
            //(Female)
            else if (this.player.hasVagina()) {
                this.outputText("licking and eating you out, paying special attention to your " + this.clitDescript(), false);
            }
            this.outputText(".\n\n", false);
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("You wrap your lips around Izma's own massive erection, sucking and gagging on her almost-two-foot cock as she jerks and twists her hips around.  Her muffled moans seem to assure you that you're doing a great job, and Izma responds by increasing the speed of her head-bobbing.  Your vision is a little obscured by Izma's quartet of balls repeatedly bumping against your forehead and the bridge of your nose, but if anything this serves to arouse you further.\n\n", false);
            else
                this.outputText("You wrap your lips around Izma's puffy, inhuman lower lips, sucking and swallowing her fragrant fem-juices as she jerks and twists her hips around.  Her muffled moans seem to assure you that you're doing a great job, and Izma responds by increasing the speed of her head-bobbing.  Your vision is a little obscured by Izma's sinuous tail, but if anything this serves to arouse you further.\n\n", false);
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
            ...
            this.outputText(" with her saliva, and as you're so eager for her magic tongue you start thrusting your hips up ", false);
            if (this.player.hasCock())
                this.outputText("to reach ", false);
            else
                this.outputText("to push your " + this.clitDescript(), false);
            this.outputText(" as far into her mouth as you can.\n\n", false);
            if (this.player.hasCock())
                this.outputText("Eventually, the two of you manage to bring each other to a powerful simultaneous orgasm, Izma's hot cum shoots down your eager throat, and you ", false);
            else
                this.outputText("Eventually, the two of you manage to bring each other to a powerful simultaneous orgasm, Izma's slippery cum drenching your face, and you ");
            if (this.player.hasCock()) {
                this.outputText(" fire loads into Izma's cheeks", false);
                //[(multi)
                ...
                this.outputText("drool a sticky mess over Izma's cheeks.", false);
            this.outputText("  The two of you roll away from each other, and while you catch your breath you're surprised at the strong taste of Izma's cum.  You don't think you'd mind getting another load of that wonderful ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 1)
                this.outputText("lady-");
            this.outputText("spunk in your stomach...\n\n", false);
        ...
        talkWivIzma() {
            ...
            //[Talk option 2]
                ...
                this.outputText("Curious, you ask if Izma has any personal encounters with either race.\n\n", false);
                this.outputText("She seems to blush slightly. \"<i>Ah... I was with an anemone once.  I just sorta swam across her, the first one I saw, without knowing what she was.  I was kind of horny already, and when she started caressing me... well, let's just say I emptied my quad... I ended up beating her down.  Her tentacles wrapped around me, and then instincts took over and, uh, I tried to fight back and dominate her...</i>\"\n\n", false);
                this.outputText("You try to picture it in your head... the image is surprisingly arousing. Shaking it away, you ask if there's actually anything normal still in the lake.  She frowns.  \"<i>There are some normal fish, their meat has kind of a weird tang to it, but they're edible.  Sorry, it's a big lake and even I haven't explored everywhere. Who knows what else could be hiding out around there?</i>\"\n\n", false);
                this.outputText("You thank Izma for being willing to talk to you, then you politely excuse yourself and leave her to her thoughts.", false);
                //(Slight lust gain)
                this.dynStats("lus", 5);
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00239]++;
                this.doNext(this.camp.returnToCampUseOneHour);
            ...
            //[Talk topic 4.]
                ...
                this.outputText("You thank her for telling you such personal things.  As you get ready to walk away, though, you stop and turn back to her. She mentioned wanting kids with 'someone special'.  Out of curiosity, you ask what sort of family she wants for herself.\n\n", false);
                this.outputText("\"<i>Guess it depends what giving birth is like,</i>\" she replies, winking.  \"<i>Though I certainly don't plan on being some goblin breeder.</i>\" Whereupon she sticks her tongue out at you.  You laugh, asking if she's saying she's not opposed to being the one to get pregnant.  She cocks her head as if the idea hadn't occurred to her to find anything strange about it.  You clarify that you were asking if Izma objects to having to carry children herself, since ");
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 1)
                    this.outputText("she used to have a ");
                else
                    this.outputText("she's got a ");
                this.outputText("perfectly functional set of male genitalia.\n\n", false);
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                    this.outputText("\"<i>Oh, nah.  Pfft, as if that's a challenge,</i>\" she says.  It's interesting to see how Izma, as a hermaphrodite, thinks of herself when it comes to the most basic of gender roles.  She scratches her chin in thought.  \"<i>Well, sexually, I'm more accustomed to my penis, since it's a bit easier to dominate with and the lake life seems to fixate on it.  But for you, I'll use whichever you want.</i>\"\n\n", false);
                else
                ...
                this.outputText("You could just leave it at this, or you could try flirting with Izma - you might get more than you bargained for if you did that, though.  Which will you do?", false);
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00239]++;
                //[Leave] [Flirt]
            ...
            //[Talk Option 6]
                ...
                this.outputText("You tell Izma you're curious; you've seen shark-girls before, but you've never seen one quite like her before. Are there a lot other shark herms like her?\n\n", false);
                this.outputText("Izma tilts her head to the side, \"<i>Oh, no... all shark herms are called tigersharks,</i>\" she says.  \"<i>A nickname on account of the stripes... though, from the way some of the locals giggle, I think there's an innuendo in the name somewhere.  We're a little sub-species among the sharks, a whole group of herms.  The ones who were closest to the chemical bloom when the pollution started underwent a change, just like I did.</i>\"  Inquisitively, you ask if the change was in response to them originally being boys and men?  Or was it just a matter of sheer concentrated chemicals and so there were women who grew cocks as well as men who became half-women?\n\n", false);
                this.outputText("\"<i>Um...</i>\" Izma says, rubbing her temples as she tries to remember exactly what happened.  \"<i>When I was there... yeah, there were some men and some women who underwent the change.  We were all shocked but... well, the endowments were certainly pleasing.</i>\"\n\n", false);
                this.outputText("So, both genders became herms.  The obvious question fills the space between you.  Was Izma originally a boy?  Or a girl?\n\n", false);
                this.outputText("She gives you a giggle and leans over.  \"<i>Why?  Would it bother you either way?</i>\"  You swat her on the nose lightly by way of response.  Still, you can't resist commenting how odd it is that only those men who were struck directly by the concentrated poisons kept something of their masculinity, with all the others turning completely into girls.  One would have thought it made more sense for the concentrated stuff to fully gender-bend them and the diluted stuff to only partially feminize them, leaving them as herms.\n\n", false);
                this.outputText("\"<i>I'm not all that sure on the nature of the chemicals, but I think they're designed expressly to make people into herms,</i>\" she replies.  \"<i>The more dilute chemicals just affected peoples' minds and genitalia.</i>\"\n\n", false);
                this.outputText("Puzzled, you ask her; then why do herms seem to be so rare?  You haven't seen any hermaphroditic sharks other than Izma herself; all of the other shark people you've met have been girls.  Doesn't that mean that most of the men were turned into shark-girls?\n\n", false);
                this.outputText("Izma bites her lip.  \"<i>The males are mostly... chained up,</i>\" she explains.  \"<i>Nobody's sure why, but, when the taint hit, all the males became not only a lot bigger and stronger, but VERY aggressive, and consumed by a state of constant rut.  They're ultra-fertile, but they're certainly rough when they get going... they make the female sharks you've met look like goblins with tummy-aches.</i>\"\n\n", false);
                this.outputText("You shake your head in disbelief; she sighs and her voice cracks a little as she continues.  \"<i>But... the worst thing is that all of the sharks are so far gone that none of them seem to really know who they're chaining up or who's chaining them... who those people USED to be.</i>\"  She gives a sigh and removes her glasses, wiping at her eyes with the back of her hand.\n\n", false);
                this.outputText("A grim thought takes shape and you ask if Izma and her people are forced to chain up their male children alongside the former men of their village.  \"<i>Shark-men don't seem to occur naturally,</i>\" she replies, \"<i>there hasn't been a boy shark born to a shark-girl or a tigershark ever since we were all transformed.  There are special shark tablets that can make people into shark-men but... well, it's a fate I wouldn't wish on anyone.</i>\"\n\n", false);
                this.outputText("Hesitantly, you ask if tigersharks like Izma can breed - and if they can, is their condition inheritable? Or can they only sire or bear more shark-girls?  She nods.  \"<i>Yeah, we can breed - both in the sense of bearing and siring offspring, and in the sense you're talking about.  We're not ultra-fertile like the shark-men, but we can - and do - get the job done, and we do both father and give birth to more tigersharks.  Honestly, there're more second and third generation tigersharks than there are first generation.  They're born less frequently than the normal girls are, but not exceptionally so - maybe about 4 in 10, not something like 1 in 10 or 1 in 100.</i>\"\n\n", false);
                ...
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00239] = 0;
                this.doNext(this.camp.returnToCampUseOneHour);
                return;
            }
        }
        ...
        chooseToFlirtWithIzma() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("You smile at Izma and tell her you appreciate the offer and that you think she'll be beautiful whether she becomes a mommy or a daddy.  In fact, the mental image of her heavily pregnant, ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("her huge cock barely able to poke past her baby-filled belly, ");
            this.outputText("her DD-cups full of milk, watching as she waddles around the camp, is a very attractive one.  She smirks at you .  \"<i> You're such a perv.</i>\"");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("  But she glances between her legs and sees her massive cock poking out of her skirt.");
            else
                this.outputText("  But she glances down to behold her rock-hard nipples jutting out.");
            this.outputText("  \"<i>Though, you do paint a rather vivid image with words...</i>\"\n\n", false);
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0) {
                this.outputText("Smiling back, you ask about her mental image of you being pregnant with her babies.  \"<i>Um...</i>\"  She trails off.", false);
                ...
                ///(Female/herm)
                    ...
                    this.outputText("  \"<i>Oh... you'd be so big and curvy, so sexy,</i>\" she purrs.  You advance towards her.  Leaning in, you mention you're willing to try and make a baby, right here and now.  \"<i>I... oh, wow.  We could certainly try,</i>\" she replies, grabbing your neck and pulling you in for a kiss.", false);
            }
            this.izmaSexMenu();
        }
        ...
        childToggle() {
            ...
            this.outputText("", true);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00248] == 0) {
                this.outputText("You ask Izma if she's ever thought about the two of you having children together.\n\n", false);
                this.outputText("Izma looks a little sheepish, but then her expression settles into a determined one.  \"<i>Yes, I have.  I'd like us to start a family, but if you don't think you're ready yet, I'll keep taking my herbs.</i>\"\n\n", false);
                ...
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00248]++;
                return;
            }
            //Turn it off
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00249] == 1) {
                //Sex Menu Button: No Kids
                this.outputText("You tell Izma that you've been thinking, and that the two of you should put making children together on hold, at least for a while.  Izma looks a little upset, but she nods her head.  \"<i>By your command, alpha,</i>\"  she tells you.  She ambles slowly away from you, her hips and ass swaying side to side in a very enticing manner; you think maybe she's trying to tempt you into changing your mind.  When you don't speak up, though, she reaches into and rummages through her chest for one of her contraceptive herbs, turning towards you and making sure you can see her taking it.\n\n", false);
                ///Return to Sex Menu options/
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00249] = 0;
            }
            //[=Yes=] (TURN ON KID-MODE
            else {
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00249] = 1;
                //Make kids and has said yes before.
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_SHARKGIRLS] + this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) {
                    this.outputText("You tell Izma that you're ready to start trying for children again.  She grins with delight and suddenly pounces at you, giving you a kiss that leaves you breathless.  Then, while you're recovering from that, she races off and drinks down a slug of that potion - you figure it must be some kind of 'antidote' to the contraceptives already in her system.  From the gleam in her eye as she stalks back towards you, it looks like she intends to start making babies right now...\n\n", false);
                }
                else {
                    this.outputText("You give Izma a knowing look and tell her that you're ready to start having children - if she is.\n\n", false);
        ...
        IzmaPoopsBabies() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("You hear the sounds of splashing and cursing coming from the part of the stream where Izma, by neccessity, keeps her private mini-camp, and immediately you set off running. When you come tearing to a halt there, you find Izma, wading in the stream well up to her waist, and cursing as she holds her gravid belly, her tail angrily flailing through the water behind her. She still manages to smile when she sees it's you who's come to see her. No words are neccessary; you plunge into the water and head to her side.\n\n", false);
            this.outputText("\"<i>Here we go, huh?</i>\"  She tries to laugh.  That's Izma for you; always trying to be brave.\n\n", false);
            this.outputText("You take a stand behind and slightly beside her. Looking to comfort her however it's possible, you start to massage her taut midriff; you can feel the muscles contracting as they work to expel the baby into the world outside, the child inside wriggling and thrashing like a fish on a hook... all right, bad simile.\n\n", false);
            this.outputText("\"<i>Fondle me,</i>\" Izma suddenly says.  As you look at her in surprise, she nods vaguely in the direction of her crotch. \"<i>Please, start ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("jerking me off or ");
            this.outputText("playing with my cunt; we learned it helps with the pain of birth a long time ago.</i>\"\n\n", false);
            this.outputText("Nodding your head, you reach around with one hand.  ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("Divvying your time between her raging erection, quartet of sizable balls and dilating cunt while she strains under you is an awkward experience, but you persevere; when Izma stops hissing and gasping in pain and starts instead moaning lightly, it seems more worthwhile.\n\n", false);
            else
                this.outputText("Divvying your time between her dilating cunt and engorged clit while she strains under you is an awkward experience, but you persevere.  When Izma stops hissing and gasping in pain and starts instead moaning lightly, it seems more worthwhile.\n\n", false);
            this.outputText("You're not sure how long you are there, working with her, before she lets out a particularly loud gasp and the water is clouded with blood and amniotic fluid.  As the current disperses it, you can see the webbed hands and exploratory head of your daughter protruding from her mother.  It's a shocking sight to see; grisly village midwife stories run through your head.  You manage to smile at Izma with what you think is reassurance, hoping quietly that it won't be long now.\n\n", false);
            this.outputText("Izma then screws her face up, pointing it skywards as she screams from the back of her throat, the sound clawing its way past grit teeth and her stoicism.  At last, the baby's lower torso is pushed free of her and, once loose, instincts kick in.  It swims for the surface, popping up above the water and taking its first breath of real air.\n\n", false);
            this.outputText("Quickly you take hold of its hand, then help Izma take it up into her arms once she's regained her strength.  You are now the proud parents of a baby ", false);
            if (IzmaScene.rand(100) <= 59) {
                this.outputText("shark-girl", false);
                this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_SHARKGIRLS]++;
            }
            else {
                this.outputText("tigershark", false);
                this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS]++;
            }
        ...
        pcPopsOutASharkTot() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00238] != 1) {
                if (this.player.vaginas.length == 0) {
                    this.outputText("You feel a terrible pressure in your groin... then an incredible pain accompanied by the rending of flesh.  You look down and behold a vagina.  ", false);
                    this.player.createVagina();
                    this.player.genderCheck();
                }
                this.outputText("You crumple suddenly; strong pains and pressures pulverize the nerves in your gut.  As your eyes shoot wide open, you look down to see your belly absurdly full and distended.  You can feel movement underneath the skin, and watch as its bulges and shifts reflect another living being moving independently inside you.  Instinctively, you spread your legs as you feel the creature press outward, parting your cervix and allowing a gush of water to spill forth - far more water than you thought you were holding.\n\n", false);
                this.outputText("You cry out as the first wrenching labor pain begins in earnest, unthinkingly hoping for somebody to come and help you.  Much to your despair, no one does, leaving you alone to deliver the baby.  You double your focus, set on pushing in time with its own frantic attempts to escape.  Squeezing over and over, you try to force out the child before the pain robs you of consciousness; luckily it seems to oblige, sliding out of you legs-first after a few more pushes.  The shark-skin rasps your inflamed pussy, drawing gasps of shock from you as she squeezes past your lips in fits and starts.", false);
                this.player.cuntChange(100, true, true, false);
                this.outputText("\n\n", false);
                this.outputText("Finally, she's out; you quiver weakly as she crawls over to you and it takes all your effort to lift your " + this.player.armorName + " and expose your " + this.nippleDescript(0) + "s to her.  As she sucks greedily at them, the haze begins to clear from your vision.  For the first time, you can actually make out distinct features on your new daughter; she's a ", false);
                if (IzmaScene.rand(100) <= 59) {
                    this.outputText("shark-girl", false);
                    this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00412]++;
                }
                else
                    this.outputText("tigershark", false);
                this.outputText(", quickly growing and filling out as she takes in milk.  She finishes up, looking rather like a pre-teen already, and glances around nervously.  The amniotic fluid is evaporating rapidly, and she's scratching idly at her gills as more and more of her skin is exposed directly to the dry air.\n\n", false);
                ...
                this.outputText("After making a quiet wish for your child, you slip into a doze.\n", false);
                ...
                this.outputText("You wake up suddenly to strong pains and pressures in your gut.  As your eyes shoot wide open, you look down to see your belly absurdly full and distended.  ", false);
                if (this.player.vaginas.length == 0) {
                    this.outputText("You feel a terrible pressure in your groin... then an incredible pain accompanied by the rending of flesh.  You look down and behold a vagina.  ", false);
                    this.player.createVagina();
                    this.player.genderCheck();
                }
                this.outputText("You can feel movement underneath the skin, and watch as it bulges and shifts as another living being moves independently inside you.  Instinctively, you spread your legs as you feel the creature press outward, parting your cervix and allowing a gush of water to spill forth - far more water than you thought you were holding.\n\n", false);
                this.outputText("You cry out as the first wrenching labor pain begins in earnest, unthinkingly hoping for somebody to come and help you.  To your relief, Izma comes running over to you from out of the gloom.  \"<i>" + this.player.short + "!  You've gone into labor?</i>\" she asks; something of a stupid question, but she's evidently as off-guard as you are.\n\n", false);
                this.outputText("\"<i>Do you think you can walk?  Make it to the stream?</i>\" she asks.\n\n", false);
                this.outputText("You throw her a dirty look, and make it quite emphatically clear that with how strong these contractions are, you don't think you could stand, never mind walk that way.\n\n", false);
                this.outputText("\"<i>Right, sorry.</i>\" She has the courtesy to look chagrined, at least.\n\n", false);
                this.outputText("She unhesitatingly steps up and kneels before you, one hand reaching out to stroke your swollen orb of a belly, the other trailing around the edges of your " + this.vaginaDescript(0) + " in a manner at once sensual and professional. \"<i>Don't worry, " + this.player.short + "; I'm going to help you get through this.</i>\" The tigershark promises you.\n\n", false);
                this.outputText("You point out it's the least she can do, seeing as how she's the one who put this thing in you in the first place, then turn your attention back fully to the task of bringing your offspring into the world.\n\n", false);
                this.outputText("Time slips away; you're too overwhelmed by the pain of your womb contracting and the pleasure as Izma ministers to your " + this.vaginaDescript(), false);
                if (this.player.hasCock())
                    this.outputText(" and " + this.multiCockDescriptLight(), false);
                this.outputText(", which makes the birth pangs become less painful and more orgasmic. You lose yourself in the haze to the point you're barely aware when the birth finally comes to an end; you feel a great pressure welling up inside you, an overwhelming urge to push, and then, the next thing you know, relief washes over you as your stomach deflates.", false);
                this.player.cuntChange(100, true, true, false);
                this.outputText("\n\n");
                this.outputText("\"<i>We've got her, " + this.player.short + "! Whoa- hold still, you slippery little girl! Stop wriggling so much, you're out now, it's me, your daddy!</i>\" Izma cries out. As you regain your strength and your vision clears, you are presented with the sight of Izma trying desperately to wrangle a squirming baby shark-morph; from her ", false);
                var type = 0;
                if (IzmaScene.rand(100) <= 59) {
                    ...
                    this.outputText("black-striped orange", false);
                    type = 1;
                    this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS]++;
                }
                this.outputText(" skin, it's obvious she's a baby ", false);
                if (type == 0)
                    this.outputText("shark-girl", false);
                else
                    this.outputText("tigershark", false);
                this.outputText(". Finally, she calms down in her \"<i>daddy's</i>\" arms, looking around with surprising aclarity for a newborn. She sees you and holds her arms out, making strange babbling noises; she has no teeth at all, from what you can see. Izma walks over to you, smiling proudly, and lets you hold your new baby girl, who nuzzles against you and then immediately turns her attention towards your milky breasts.\n\n", false);
                this.outputText("She latches onto the " + this.nippleDescript(0) + " and starts to suckle for all she's worth, waves of pleasure both sexual and maternal filling you, overwhelming you with bliss. Oblivious to everything else, you hold her against your breast, allowing her to sate her incredible appetite. She drinks your breast dry, and then immediately latches onto the next one.", false);
                if (this.player.breastRows.length > 1)
                    this.outputText("  She then starts on your third breast, and while she slows down at the fourth breast, she still finishes it off.", false);
                //(If player has six breasts: 
                if (this.player.breastRows.length > 2)
                    this.outputText("  She seems to almost be struggling to finish off your third pair, but she manages to suck all six of your breasts dry.", false);
                this.outputText("  Once she is done, she lets go with a wet popping sound, then starts to gasp for breath before letting out a surprisingly loud, deep belch for such a little thing.\n\n", false);
                this.outputText("...Okay, maybe not so little. Before, she was the size of a human baby. Now, you're holding a fairly grown young ", false);
                if (type == 0)
                    this.outputText("shark-girl", false);
                else
                    this.outputText("tigershark", false);
                this.outputText("; physically, you'd have to say she was anywhere from ten to thirteen years old. She grins at you, displaying both rows of teeth, and then kisses you on the lips. \"<i>Mama.</i>\" She states, clearly and contendly, then visibly relaxes, nuzzling into your arms and closing her eyes, clearly intent on drifting off to sleep.\n\n", false);
                this.outputText("You look up at the tigershark who fathered her for support, but she just smiles and flops down beside you as well. With a soft sigh, you simply lay back and enjoy your strange new family being there with you. When you wake in the morning, Izma will have taken your daughter to stay at the stream with her; it's important for young shark-folk to be moist, constantly.\n", false);
                this.player.orgasm();
                this.dynStats("lib", 1, "sen", 1);
            }
            this.player.boostLactation(.01);
        }
        ...
        izmaKidsPlaytime() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) {
                //NEITHER GOOD
                //choices[choices.length] = 1;
                //choices[choices.length] = 2;
            }
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] + this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_SHARKGIRLS] >= 2)
            ...
            var choice = choices[IzmaScene.rand(choices.length)];
            if (this.model.time.hours < 10 && this.flags[kFLAGS_1.kFLAGS.ANEMONE_KID] > 0 && IzmaScene.rand(2) == 0) {
                this.anemoneScene.kidAWatchesSharks();
                return;
            }
            this.outputText("Izma shows you to an isolated bend in the stream; this is where your children have chosen to settle themselves.  Though they have the physiques and minds of pre-teens already, it will still be several years before they are fully grown and ready to leave you and Izma.  ", false);
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_SHARKGIRLS] + this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] == 1)
                this.outputText("There is ", false);
            else
                this.outputText("There are ", false);
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_SHARKGIRLS] > 0) {
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_SHARKGIRLS] == 1)
                    this.outputText("one shark-girl", false);
                else
                    this.outputText(IzmaScene.num2Text(this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_SHARKGIRLS]) + " shark-girls", false);
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0)
                    this.outputText(" and ", false);
            }
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0) {
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] == 1)
                    this.outputText("one tigershark", false);
                else
                    this.outputText(IzmaScene.num2Text(this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS]) + " tigersharks", false);
            }
            ...
            if (choice == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] == 1)
                    this.outputText("Your lone tigershark daughter is off by herself, experimentally stroking and fondling her already-impressive cock.  It doesn't look like it'll be long before she cums; her face is already screwed up in an expression of curious pleasure, gasping softly at the sensations.", false);
                //(Requires 2-3 Tigersharks: 
                else if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] < 4 && this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0)
                    this.outputText("Your tigershark daughters are seated together, each experimentally stroking and fondling her sizable erection.  It looks like they're competing to see who will cum first.", false);
                //(Requires 4+ Tigersharks:
                else if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0)
                    this.outputText("Your tigershark daughters are seated together, each experimentally jerking off either her own cock or one of her sisters.  Some look to be competing to see who can jerk themselves off first, others are evidently seeing who's better at handjobs.", false);
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0)
                    this.outputText("  Izma blushes and explains that your children have strong libidos, so it's natural for them to experiment like this.  She assures you that they won't do any real sexual penetration with a family member.\n\n", false);
            }
            //#2: (Requires at least 1 Tigershark)
            //NOPE
            else if (choice == 2) {
                this.outputText("You see your daughter has caught a goblin who managed to find her way to this nook.  It doesn't look like either of them mind, though; she's roughly but eagerly stuffing herself into the squealing green-skinned slut's pussy, much to the goblin's pleasure.  She sees you and gives you a lewd wink.  \"<i>You've got a fine-ass daughter here; don't worry, I'll give you plenty of grandkids,</i>\" she jeers, then gives a lusty moan as your daughter finally reaches her limit and cums inside her, bloating the goblin's belly with spunk.", false);
                //Other children:
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] + this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_SHARKGIRLS] > 2)
                    this.outputText("  Your other kids are gathered around, watching with amusement and a little envy as one of your tigershark offspring plows an excited goblin.  \"<i>Oh, yeah, baby, now you folks know how to live!</i>\" she cheers.", false);
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 2)
                    this.outputText("  \"<i>Don't worry; you'll get a chance to use a beautiful big cock on me, too - just wait your turn!</i>\" she laughs looking around the circle.  Your other daughters look like they can't wait.", false);
            ...
            if (choice == 5) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] + this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_SHARKGIRLS] == 1)
                    this.outputText("child perks up to see Izma and comes running over to her, throwing herself into her arms", false);
                else
                    this.outputText("children perk up to see Izma and come running over to her, throwing themselves into her arms", false);
                this.outputText(".  She laughs in delight and sits down on the bank, reaching for a book she has in a bag at her side.  Your offspring ", false);
                if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] + this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_SHARKGIRLS] == 1)
                    this.outputText("cries out in joy at the prospect of storytime and eagerly seats herself in front of her, listening as she starts to read.", false);
                else
                    this.outputText("cry out in joy at the prospect of storytime and eagerly seat themselves in front of her, listening as she starts to read.", false);
                this.outputText("  You remain there for a while, listening, but eventually you think of your duties as champion and you have to take your leave of them.", false);
            }
        ...
        inCampRideIzmasDickDongTheWitchIsDead() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("You direct a flushed look at Izma and rub your ", false);
            if (this.player.wetness() > 3)
                this.outputText("dripping ", false);
            this.outputText("fuckhole meaningfully, telling her to lie down and let you give her fifteen inches and four balls a run.\n\n", false);
            this.outputText("Izma gives a happy squeal in response, before blushing and clearing her throat.  \"<i>Ah ha... of course, my Alpha,</i>\" she replies curtly.  She lies down on the ground and her giant dong stands straight to attention, waiting for your " + this.vaginaDescript() + ".\n\n", false);
            this.outputText("Slowly and sensuously you remove your " + this.player.armorName + ", exulting in the way Izma hungrily drinks in every inch of exposed " + this.player.skinFurScales() + ".  Her eyes devour your " + this.allBreastsDescript() + ", then slide eagerly down to your crotch to feast upon", false);
            if (this.player.hasCock()) {
                this.outputText(" " + this.sMultiCockDesc(), false);
                if (this.player.balls > 0)
                    this.outputText(" and " + this.ballsDescript(), false);
                this.outputText(" before going to the main attraction:", false);
            }
            this.outputText(" your pussy.  You sashay over to the prone tigershark, your " + this.hipDescript() + " swaying in a fashion that has her hypnotised.  By the time you reach her, her cock is visibly bubbling pre from the slit and drooling it down onto her four swollen balls, which sit in a steadily-growing puddle of feminine juices. Smiling hungrily, you gently stroke her long, crimson-hued cock, playfully asking what such a little girl is doing with such a big, hard thing.\n\n", false);
            this.outputText("Izma pants and giggles in response, licking her lips at the little show you're putting on for her.  \"<i>Big?  Me?  Haha...</i>\"  She gasps and moans as you rub at her head.  \"<i>There are much bigger fish in those lake waters...</i>\" she pants, winking at you.  You don't know if she's joking or not.\n\n", false);
            this.outputText("You purse your lips thoughtfully, and feign entertaining the idea that maybe you should throw this small fry back... then you shake your head and grin.  No, you declare, this is plenty big enough for you.\n\n", false);
            this.outputText("\"<i>Oh, thank you... I feel like I'll go crazy if I have to wait much longer,</i>\" Izma purrs, placing her hands behind her head and thrusting her chest out at you to entice you.\n\n", false);
            this.outputText("You smile and bend over, hungrily kissing and suckling at her impressive breasts, squeezing them firmly to squeals of delight from the tigershark.", false);
            if (this.player.hasCock()) {
                this.outputText("  Your " + Appearance_1.Appearance.cockNoun(this.player.cocks[0].cockType) + " rubs against her shaft, sending delicious sparks surging through you.", false);
            }
            this.outputText("  Tiring of the foreplay, you slither up her body and position yourself over her, slipping down onto her shark-sausage just enough that the head is poking teasingly into your " + this.vaginaDescript(0) + ", but not enough to really penetrate you.", false);
            if (this.player.wetness() >= 5)
                this.outputText("  Not that this stops your nether-lips from drooling your lubricant all over Izma's crotch.", false);
            this.outputText("\n\n", false);
            this.outputText("Izma seems to tense beneath you, her breath caught in her throat from anticipation.  She bites her lip as she awaits for you to slide onto her cock, but she doesn't dare move without your permission.\n\n", false);
            this.outputText("Finally deciding that ", false);
            if (this.player.cor < 66)
                this.outputText("you've teased her enough", false);
            else
                this.outputText("you've delayed your pleasure long enough", false);
            this.outputText(", you sink down onto her, stifling a yelp as she fills your depths.", false);
            //(Tight/Virgin vagina)
            if (this.player.vaginalCapacity() < 20 || this.player.vaginas[0].virgin)
                this.outputText("  Holy shit, that hurts like a motherfucker! It's as if you're trying to stuff a baguette into your vag!", false);
            //(Loose)
            else if (this.player.vaginalCapacity() < 50)
                this.outputText("  You groan and shudder slightly as you slide down the generous 15 inches of dick, the slight pain being drowned out by the sensation of being filled as full as you could possibly hold.", false);
            //(Gaping)
            else
                this.outputText("  You shudder and lick your lips. Izma may be big but you've had bigger, and you fit her cock like a glove.", false);
            this.player.cuntChange(30, true, true, false);
            this.outputText("  Once you have made it to the very base of Izma's cock you pause for a moment to help yourself adjust, then, clenching your vaginal muscles, you start to rock back and forth; your body is sliding up and then slamming down, picking up speed and force as you continue to thrust.  Your hands reach out to maul Izma's tits", false);
            if (this.player.hasCock()) {
                this.outputText(", your erect cock", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("s", false);
                this.outputText(" bouncing against her belly with audible slaps", false);
            }
            this.outputText(".\n\n", false);
            this.outputText("Izma moans and shivers beneath you, giving a few growls as well as you continue to molest her tits. She grins and starts to rotate her hips in a clockwise fashion to try and please you further.  Your mouth hangs open with delight, and you breathily order her to pick up the pace, riding with renewed vigor to exert your dominance over the tigershark under you.\n\n", false);
            this.outputText("Izma's cock twitches and she places her hands on your hips.  \"<i>Ah... I'm gonna...</i>\"  She grunts and bites her lip, trying to hang onto the moment.\n\n", false);
            this.outputText("You laugh in delight, complimenting Izma on what a good beta she is; the alpha gets to cum first, after all.  ", false);
            if (this.player.cor < 33)
                this.outputText("Feeling merciful, you tell her that you're almost there... just a little more.  ", false);
            this.outputText("Finally, the orgasm that's been hanging just out of reach, tantalizing you, flows free and you cry out in pleasure as femcum ", false);
            if (this.player.wetness() < 4)
                this.outputText("spatters", false);
            else if (this.player.wetness() < 5)
                this.outputText("gushes", false);
            else
                this.outputText("fountains", false);
            this.outputText(" onto the tigershark under you", false);
            if (this.player.hasCock()) {
                this.outputText("; " + this.sMultiCockDesc() + " spraying all over her belly, breasts and face", false);
            }
            this.outputText(".  Izma, feeling the twitching of your " + this.vaginaDescript(0) + ", finally gives a loud roar as she climaxes inside you, filling your womb up with sharky spunk to the point where it makes your stomach bloat out from the sheer volume of her deposit.\n\n", false);
            this.outputText("You sit there on top of Izma for a few minutes, basking in the afterglow, feeling her still semi-hard phallus inside you, patting your cum-inflated belly with one hand.  You compliment Izma on her load... then, giving a wicked grin, you playfully wonder aloud why she's still so hard inside you.  Is she really still horny?  Well, you're a good alpha, so you'll keep going until you've milked her dry...\n\n", false);
            this.outputText("Izma moans weakly from beneath you, trying hard to keep her eyes open.  \"<i>If, ah... if that's what you want.</i>\"\n\n", false);
            this.outputText("You simply give her your wickedest grin, already starting to get into the rhythm of rising and falling...\n\n", false);
            this.player.orgasm();
            this.dynStats("sen", -2);
            this.outputText("<b>Some time later...</b>\n", false);
            this.outputText("Finally, you are tired and sexually sated enough that you tell Izma you're fulfilled. The tigershark merely groans and you have to help her get into the stream to restore her strength. Still, seven orgasms in only an hour is pretty impressive, and you give her a pat on her shapely derierre before you leave, calling over her shoulder that you'll be back again sometime.\n\n", false);
            this.outputText("Izma waves at you and smirks as you go to leave, and you have to wonder if Izma was only acting helpless in order to get off...", false);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00249] > 0) {
                this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_IZMA, PregnancyStore_1.PregnancyStore.INCUBATION_IZMA);
            }
            this.player.slimeFeed();
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        stephenHawkingPorn() {
            this.spriteSelect(32);
            this.outputText("", true);
            this.outputText("A wicked smirk crosses your face and you point to the small bundle of porn that Izma has in her trunk. Izma looks nervous and pulls out one stack of the illustrations. \"<i>Ah-hah... really?</i>\" she asks, her face a rictus of embarrassment.  You nod in response and sit down on a rock, gesturing for Izma to join you.  She has some color on her face, though whether it be more or less than usual you can't decide, not knowing enough about her biology yet, and she sits down and starts to examine the porn with you, bumping your legs with hers as she adjusts her posture ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("continuously to keep the beast in her skirt pinned down.\n\n", false);
            else
                this.outputText("nervously in an effort to keep from moistening it.\n\n", false);
            this.flags[kFLAGS_1.kFLAGS.IZMA_TIME_TILL_NEW_BOOK_AVAILABLE] = 11;
            this.outputText("By the time you're done reading, Izma certainly seems turned on.  She tries to hide it and sit primly - ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("but that's not exactly possible for someone who just had over a foot of dick slip from between her thighs and stick into the air.  You laugh openly and give Izma's silver hair a soft tug, before getting up and telling her you have business elsewhere.  Izma simply nods in taciturn response but keeps her gaze fixed on the lewd images before her.  Another laugh escapes your lips as soon as you think you're out of earshot.", false);
            else
                this.outputText("but that's not exactly possible for someone who keeps squirming, creating lewd squishes from below the waist.  You laugh openly and give Izma's silver hair a soft tug, before getting up and telling her you have business elsewhere.  Izma simply nods in taciturn response but keeps her gaze fixed on the lewd images before her.  Another laugh escapes your lips as soon as you think you're out of earshot.", false);
        ...
        findLostIzmaKidsII() {
            this.outputText("", true);
            this.outputText("You embrace your daughter, both of you half-laughing half-crying into each other's shoulders.  After a few moments of this, you pull away a little and blurt out a few urgent questions about her well-being and mental health.  She in turn inquires about you and her \"father.\"\n\n", false);
        ...
        removeIzmasPenis() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ASKED_IZMA_ABOUT_WANG_REMOVAL] == 0) {
                ...
                this.outputText("You bring up the idea of removing her dick again, and Izma just sighs \"<i>Why?  Why can't you just... be happy with me like I am?  I don't want to be just another shark-girl!</i>\"");
        ...
        izmaDickToggle() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] = 1;
                var count = 0;
                ...
                this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] = 0;
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        fuckIzmasPussyDominate() {
            ...
            this.outputText("like a moth to an open flame, you saunter over towards her, sporting a ridiculous grin as thoughts of impaling yourself in her tight pussy takes hold of your mind, driving you into a frenzied lust.  With her skirt now thrown indifferently to the ground, her bare sex");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("es");
            this.outputText(" now stand");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 1)
                this.outputText("s");
            this.outputText(" exposed to the cool air, drooling ");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText("their sexual lubricants");
            else
                this.outputText("its sexual lubricant");
            this.outputText(" in eager presentiment.  \"<i>So, [name], how does my Alpha want to fuck me today?</i>\"  Izma coos, attempting to bewitch you with the enticement of dominance over her; something that right now, is pitching a huge tent in your pants.  \"<i>You read my mind, lover,</i>\" you reply back, narrowing in on her moist clit as [eachCock] bobs with the need to fuck that love button of hers.  The tree trunk behind Izma catches your eye; the thought of slumping Izma over it and making her beg to be bred triggers a rush of giddiness throughout your body as you decide this is how you'll dominate Izma.");
            ...
            if (this.player.isNaga() || this.player.isTaur() || this.player.isGoo())
                this.outputText("With her tail now against your shoulder blade and jutting up in the air, your path to her fuckhole is now clear.  ");
            //(If human or Harpy legs are present: 
            else
                this.outputText("Lifting your right leg over her rump, you give yourself the superior position needed to ravage her cunt.  ");
            //(if Single cocked (multicocked x2, suitable size(s) to fuck Izma, if possible)):
            this.outputText("With a hearty roar, you plunge ruthlessly into Izma's love canal, giving the feelers inside of her pussy little time to brace for impact as you savagely brush them aside.  The brutal straining of her pussy causes Izma to yell out in pained shock at the sudden intrusion in her pussy.  \"<i>A little too rough for you?  I thought that's how shark-girls liked it,</i>\" you say to Izma, taunting her as she wriggles weakly under you.  Grabbing at her shoulders, you brace yourself against her body, readying your pelvis to mash against her rump.  Drawing out of her slowly, you allow her the opportunity to adapt to your " + this.cockDescript(x) + "; something the feelers in her cunt appreciate as she moans approvingly.");
            ...
            if (this.player.tentacleCocks() > 1 || (this.player.tentacleCocks() == 1 && this.player.cocks[x].cockType != CockTypesEnum_1.CockTypesEnum.TENTACLE))
            ...
            //(If PC has goo body: 
            if (this.player.isGoo() && this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0) {
        ...
        gooJob() {
            this.clearOutput();
            this.outputText("Concentrating on moving your mass forward, you manage to envelop Izma's entire back side.  Slowly but surely, you are able to harden your goo around Izma's rock hard cock, and begin to pump her penile member with gusto. Now that she's been jerked off, and the fact that she's ");
            this.radarIzmaSpanking(false);
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.Goojob, 0, 0, 0, 0);
        }
        //[Spanking and orgasm]
        radarIzmaSpanking(newSentence = true) {
            if (newSentence) {
                this.clearOutput();
                this.outputText("Now ");
            }
            this.outputText("being subjected to double penetration and powerful bucks, ");
            this.radarIzmaGasm();
        }
        radarIzmaGasm() {
            this.outputText("Izma loses herself in the moment, clawing and grasping at the trunk as she releases a passionate series of wails.  Grunting your approval, you give her luscious ass a hard slap, the thunderous thwack of palm against rump drowning out her cries of content euphoria.  Soon you feel your orgasm coming, but you don't want to cum until you hear Izma beg for your seed.");
            ...
            if (this.player.cumQ() <= 750)
                this.outputText("shooting your hot load into Izma's fuckhole, enveloping the walls of her pussy with your seed.");
            //(Cum production High: 
            else
                this.outputText("unleashing a cascade of steamy jizz into Izma's well fucked hole.  Your volume is so large that it causes a back draft of semen to rush out of her within mere seconds.");
            //(If PC gave Izma a "goo job":
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Goojob) >= 0) {
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Goojob);
                this.outputText("  The sensation of being injected with her lover's seed is all the encouragement Izma's cock needs to finally erupt, shooting thick streams of steamy cum into your central mass; something your gooey form appreciates as it unconsciously works her load into your see through gut.");
            }
            this.outputText("\n\nYour exhausted partner swoons as she cradles her ");
            if (this.player.cumQ() > 750)
                this.outputText("bloated ");
            this.outputText("belly, clamping her legs shut in ");
            if (this.player.cumQ() <= 750)
                this.outputText("a ");
            else
                this.outputText("an ultimately ");
            this.outputText("vain attempt to contain all of your baby batter inside of her.  With a final sigh, you pull loose from her and dart past her shoulder for a sensual kiss on the lips.  Izma weakly kisses back, stopping after a few moments to whisper to you, \"<i>Gods... that was... something else.  I didn't think I could... cum that hard.</i>\"  With a small giggle, you tell Izma that your Beta will always cum hard if she fulfills her Alpha's desires, and that she should clean herself up.  Moaning in appreciation, she mutters something about maybe pleasuring her");
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                this.outputText(" cock");
            else
                this.outputText("self");
            this.outputText(" down at the river... but judging by how tired she looks, you doubt that will happen anytime soon.");
            this.player.orgasm();
            this.dynStats("sen", -1);
            this.izmaPreg();
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        radarIzmaAnalDominant() {
            ...
            if (this.player.analCapacity() < 35)
                this.outputText("painfully rending the tight shape of your anus on it, causing both of you to moan in pain as you envelop more and more of her dick inside of you.  Izma slams into you forcefully as she unleashes a huge gasp, face utterly flooded with ecstasy as she stares into the sky behind closed eyes.");
            //(If loose to gaping: 
            else
                this.outputText("slipping past the fleshy \"gates\" of your anus, requiring little stretching or working of your " + this.assholeDescript() + ".  You're worried that this might not work the way you want it to, given how easy it was to take Izma; a series of wild, erratic thrashings against your ass as the penile intruder tunnels deeper seems to dispel that notion.");
            ...
            this.outputText(" increases in ferocity as you slam your " + this.buttDescript() + " against her lap, her quadrate of testicles slapping against your ");
            //(if PC is fingering their pussy: 
            if (this.player.hasVagina())
                this.outputText("feverish hands as you fingerfuck your " + this.vaginaDescript() + ".");
            //(If PC has balls: 
            else if (this.player.balls > 0)
                this.outputText("swinging [balls] with each gyration of your hips.");
            //(If PC is genderless: 
            else
                this.outputText("thighs, thoroughly \"tenderizing\" them with every thunderous impact.");
        ...
        radarIzmaAnalDomResultTuckIn() {
            ...
            if (this.player.str < 70) {
                this.outputText("Despite your good intentions, you can't lift Izma off the ground for long before needing to set her back down.  Imza quietly remarks that you should just let her rest; causing you to tell her not to talk back.  Alternating between dragging her through the grass and \"carrying\" her over some rocks, ");
                if (this.player.fatigue < 70) {
                    this.outputText("you eventually get her back to her bedroll.  She smiles sheepishly as you lay her on the bedding to sleep off your passionate throes.  She's comfortable, but the effort is exhausting.");
                    this.dynStats("cor", -2);
                    this.fatigue(30);
                }
                else
                    this.outputText("you try and get her to her bedroll, but you are simply too exhausted.  Izma tells you not to worry about her and go get some rest; that she'll be okay in the grass.  You groggily agree as you set her down, telling her she better be ready for more sex if you want it; something she approves of as she hums and drifts off to sleep.");
            }
            else {
        ...
        radarFucksIzmasAss() {
            ...
            if (this.player.cocks[x].cockType != CockTypesEnum_1.CockTypesEnum.TENTACLE) {
                ...
                if (y == -1)
                    this.outputText("her anus");
                else
                    this.outputText("both of her holes");
                this.outputText(".  The sound of Izma's pained cry of agony rises as her head does, guided by your arm as you drag her so far back that she ends up howling up into the sky.  Like a tongue reaching down into a candy wrapper to lick up delicious chocolate, you twist and grind the end of your ");
                if (y >= 0)
                    this.outputText("cocks against the unyielding ends of her anus and pussy, unleashing a weak whimper of bliss from under you.");
                else
                    this.outputText("cock against the unyielding end of her anus, unleashing a weak whimper of bliss from under you.");
                //[Cumming]
            ...
            //!Tentacle dick scenes!
                ...
                if (this.player.tentacleCocks() >= 4) {
                    ...
                    if (this.player.tentacleCocks() == 4)
                        this.outputText("a cock that needs");
                    else
                        this.outputText("cocks that need");
        ...
        */
        ...
        internalIzmaAnalCumShot() {
            this.clearOutput();
            this.outputText("With a series of labored breaths, you excitedly tell your lover that you are going to cum inside her, and that she'd better love every second of it.  The rushing warmth that resonates through your cock fills you with a relaxed euphoria as you groan and bottom out once more, releasing your seed deep into her eager depths.");
            //(If PC fucked her vaginally: 
            if (this.player.cockThatFits2(65) >= 0)
                this.outputText("  The feelers in her pussy glide along the glans of your " + this.cockDescript(this.player.cockThatFits2(65)) + ", driving your dick's unconscious efforts to inseminate her into overdrive as you feel each subsequent stream of semen increase in velocity.");
        }
        //[External, Non-TD scenes]
        backJizzShot() {
            this.clearOutput();
            this.outputText("Pulling out of Izma, you begin to stroke [eachCock] furiously, bobbing your shaky hands up and down ");
            if (this.player.cockTotal() == 1)
                this.outputText("your shaft ");
            else if (this.player.cockTotal() == 2)
                this.outputText("two shafts ");
            else
                this.outputText("three shafts");
            this.outputText(" as you struggle to cum.  Rolling over onto her thoroughly abused ass, the feminine tigershark twists her head back to get her hair out of her face, and opens up wide to receive your load.  Arcing like lightning in the sky, your orgasm flows forcefully out of your " + this.multiCockDescriptLight() + ", ");
            //(Cum volume normal: 
            if (this.player.cumQ() < 500)
                this.outputText("firing thin streams of semen from [eachCock], lathering Izma's luscious red body and making it glisten in the sun.");
            //(Cum volume high:
            else if (this.player.cumQ() <= 1000)
                this.outputText("streaming forth like fierce rain down a tree, repeatedly striking Izma across the face and breasts as your orgasm continues unabated for several moments.");
            //(Cum volume very high: 
            else {
                this.outputText("creating a earthquake like seizure in [eachCock] as you painfully ejaculate a torrent of sperm all over Izma, drowning that bright red body out with a thick layer of clear white goop.  Your abundant release is so large that you, quite literally, cover Izma head to toe with sticky, sloppy cum.");
        ...
        izmaDomsLatexy() {
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_IZMA_DOMMED_LATEXY] == 0) {
                //{First time}
                this.outputText("\nFamiliar, lusty pants can be heard coming from the edge of the camp, and you begrudgingly head over to investigate.  The heavy breathing is accompanied by a few groans of pleasure, each higher pitched than the last, and as you round a rock, you're treated to the sight of Izma nude, holding a rope that's currently lashed around " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + ".  The goo-girl has one hand stuffed into her slick quim, busily fisting herself for the shark-girl's pleasure.");
                //[Stop] [Watch]
                this.menu();
            ...
            //{Repeat}
                ...
                this.outputText("\n\n\"<i>Go on, you need to make me want to use you!</i>\" Izma says while slowly caressing her penis.  She's openly leering down at the reflective, ebon-skinned slut, and the poor, collared woman reluctantly parts her glossy folds, slowly feeding her fist into her capacitive nethers, one knuckle at a time.  Once her wrist disappears, it's only a short moment before she pulls it back out, gasping from unexpected pleasure.  Strings of inky lubricant dangle precariously between her digits and stretched snatch, just about to break until " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + "'s hand is plunged back into the inky honeypot.");
        ...
        izmaDomsLatexyPartI() {
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_IZMA_DOMMED_LATEXY] == 0)
                ...
                this.outputText("\n\n");
            this.outputText("Izma growls while she pumps away at her erection, saying, \"<i>Yeah, you like that, don't ya ink-slut?</i>\"");
            this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " bites her lower lip and ");
            if (this.latexGirl.gooObedience() > 50)
                this.outputText("eagerly");
            else
                this.outputText("sheepishly");
            this.outputText(" nods, gushing a few fresh dribbles of moisture around her wrist at the admission.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.GOO_DICK_LENGTH] > 0)
                this.outputText("cock");
            else
                this.outputText("clit");
            this.outputText(" with a toe, drawing a pleasured gasp from the submissive.");
            this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " shudders as she pushes her hand in and out of herself.  Her whole forearm is dripping with onyx moisture, and the noisy squelches are easy to hear from where you're watching.  \"<i>Yes... I'm a slutty, submissive girl...  Can I have your cum, mistress Izma?  Please?  I'm putting on such a good show!</i>\"");
            if (this.latexGirl.gooObedience() < 50)
                this.outputText("  A look of annoyance flashes across her face as soon as she says it, like she didn't really want to say that so openly.");
            else if (this.latexGirl.gooObedience() <= 80)
                this.outputText("  A conflicted look flashes across her face as soon as the words slip out, but there's no taking them back.");
            else
                this.outputText("  A hungry look flashes in her eyes as soon as the words leave her mouth, and she licks her lips hungrily.");
            this.outputText("  A particularly powerful thrust inside herself has " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " whining, her eyelids fluttering closed as she cries, \"<i>Oh, [name]!</i>\"");
            this.outputText("\n\nYou smile in satisfaction as your beta and your submissive, former slime tend to their needs together, proud that in the face of fifteen inches of stripe-cock, " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " still fantasizes about you.");
            this.outputText("\n\n\"<i>Good enough, slut,</i>\" Izma croons in between heavy pants.  She slaps her swollen shark-cock across the black-skinned woman's hungry face.  Gasping in surprise, " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + "'s' shocked expression tells you all you need to know, right up until the red boner plunges into her unresisting lips.  Liquid, " + this.flags[kFLAGS_1.kFLAGS.GOO_EYES] + " eyes look up in surprise before fluttering contently closed.  Izma's hand caresses a lock of slippery, latex hair and forces herself deeper into the wet, former goo's throat.  Droplets of inky moisture roll out around the edges of the shaft, painting her four-balled nutsack black before they cool and harden around it.");
            this.outputText("\n\nHands reaching out towards the slippery, sheathed quartette, " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " hums around the throat-stretching bulge as she does her best to milk it, gently squeezing each cum factory in turn.  Izma hooks a leg over " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + "'s shoulder and begins to roughly fuck the onyx beauty.  She hammers her cock home with crude thrusts that pound all fifteen inches straight into the goo-girl's core, the only sounds half-strangled hums of pleasure and the heated squelches Izma's groin makes when it bottoms out on her partner's greedy lips.");
            this.outputText("\n\n\"<i>Oooh, fuck, quit sucking so hard,</i>\" Izma tries to command, but it winds up sounding more like begging.  ");
            //OBEDIENCE FAIL
            if (this.latexGirl.gooObedience() / 5 + this.latexGirl.gooFluid() / 5 + IzmaScene.rand(20) < 10) {
                this.outputText("" + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " grows and sucks harder, cheeks hollowed with suckling hunger.  You can see them stretch and go even more concave with rhythmic pulsations, vacuum-tight around the orange shaft.  Izma moans and tries to pull out, but she barely manages to extract an inch before her whole length is noisily pulled back in.  The shark-girl tries to pry the slutty, hungry little goo off of herself again and again, but each time, all she winds up doing is getting sensuously devoured again and again.  " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " gives her four balls another appreciative squeeze, and Izma's eyes suddenly roll back, helpless again the hungry sluts impressive oral talents.");
                this.outputText("\n\n\"<i>C-c-cumming!  Ohhhh by the gods, yes!  Ungh!</i>\" Izma cries as her hips begin to weakly thrust against their onyx prison, smushing " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + "'s lips into her toned middle.  The smooth, latex sheath around her sack trembles, wrinkling as Izma's balls pull tight against her, and then, " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " is gurgling noisily, massaging all four of those cum factories as they pour their cargo straight into her throat, feeding her the warm, soupy cum she craves.  They stay locked like that for upwards of a minute, Izma occassionally trying to talk but usually just babbling contently while she's milked for every drop.");
                this.outputText("\n\nAbruptly, the striped hermaphrodite slumps back against a rock, her drained dong sliding out of the constricting tightness of " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + "'s throat with a wet pop.  The crimson dick is encased in a hardening shell of latex, and you must admit, it's a good look on her.  Izma sighs, \"<i>You disobedient slut...</i>\" and staggers back up onto her feet.  Gesturing down at her glossy, black dick, she comments, \"<i>I guess it is a nice look on me.</i>\"");
                this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " grins happily and lays back, sunning herself as she starts to digest her 'meal'.");
            }
            //OBEDIENCE SUCCESS
            else {
                this.outputText("" + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " obediently relaxes, allowing the herm to take more effective control of the situation.  \"<i>Atta girl,</i>\" Izma comments as she extracts herself from the hungry, sucking mouth-hole, her dick shining with a fresh, wet, latex sheath.  \"<i>Ass up, slut.  You're getting fed via suppository today!</i>\"");
                this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " assumes the position in a second and begins to wag her bottom back and forth.  The way the light reflects on those onyx orbs, you can understand why Izma immediately pistons herself straight into the latex rosebud - it's an entrancing, cock hypnotizing sight to be sure.  She grunts as soon as she bottoms out, and then straining, she yanks herself back out of the vacuum-tight, anal seal, gasping for breath.  \"<i>You can suck there too?!</i>\" Izma growls in wonder, but not before pushing herself back inside.  \"<i>Suck it while I fuck you.  I'm gonna blow a huge load in your ass before long, cock-slave.</i>\"");
                this.outputText("\n\nAgain and again, Izma slaps her hips against " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + "'s tight backdoor.  Every time she pulls out, she's coated in even more liquid latex, some of it splattered on her hips and molded on her cock.  Even the inky wetness that girds her balls thickens into a more substantial coating.  Soon, she's grunting each time she bottoms out, and from the way her tongue is hanging out of her pleasure-opened mouth, the sensations her member is experiencing must be beyond imagining.  Izma suddenly gurgles and hilts herself, gasping, \"<i>Ungh, here... here it comes!  TAKE IT!  TAKE IT, SLUT!</i>\"");
                this.outputText("\n\nThe sheath around her balls wrinkles slightly as it contracts, pumping what can only be a deluge of salty shark-seed straight into the goo-gal's roomy backside.  Both girls moan in ecstatic bliss.  You belatedly realize that the whole time she's been ass up, " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " has had her arm elbow-deep inside her snatch, getting herself off and potentially handing out a handjob inside of herself.  Obsidian drool runs unchecked down her elbow and onto the ground as the black woman cums.  Meanwhile, Izma keeps herself tight on her succulent asscheeks, eyes half-rolled back in their sockets as she gives herself completely over to the blissful ecstasy that's polishing her pole.");
                this.outputText("\n\nAbruptly, the striped hermaphrodite slumps back against a rock, her drained dong sliding out of the constricting tightness of " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + "'s ass with a wet pop.  The striped dick is encased in a hardening shell of latex, and you must admit, it's a good look on her.  Izma sighs, \"<i>Good girl...</i>\" and staggers back up onto her feet.  Gesturing down at her glossy, black dick, she comments, \"<i>I guess it is a nice look on me.</i>\"");
                this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " grins happily and lays back, sunning herself as she starts to digest her 'meal'.");
            }
            this.flags[kFLAGS_1.kFLAGS.TIMES_IZMA_DOMMED_LATEXY]++;
            this.flags[kFLAGS_1.kFLAGS.GOO_FLUID_AMOUNT] = 100;
        ...
        stopIzmaLatexy() {
            this.clearOutput();
            this.outputText("You step into the middle of it before it can progress any farther.  " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " is yours, and Izma is not to play at being a mistress to YOUR pet.");
            ...
            this.flags[kFLAGS_1.kFLAGS.IZMA_X_LATEXY_DISABLED] = 1;
            this.flags[kFLAGS_1.kFLAGS.TIMES_IZMA_DOMMED_LATEXY]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        izmaLatexySubmenu() {
            ...
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_X_LATEXY_DISABLED] == 1)
        ...
        izmaLatexyToggle() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_X_LATEXY_DISABLED] == 0) {
                this.outputText("You tell Izma you don't want her feeding " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " any more.");
                ...
                this.outputText("You tell Izma that you've changed your mind, and she can keep " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " fluid topped off.  The shark-girl hugs you with a predatory grin splitting her face.  \"<i>I can't wait.</i>\"");
                this.flags[kFLAGS_1.kFLAGS.IZMA_X_LATEXY_DISABLED] = 0;
            }
            this.menu();
            this.addButton(4, "Back", this.izmaLatexySubmenu);
        }
    }
    exports.IzmaScene = IzmaScene;
});
//# sourceMappingURL=IzmaScene.js.map