define(["require", "exports", "./NPCAwareContent", "../../PregnancyStore", "../../GlobalFlags/kFLAGS", "../../CoC", "../../../console", "./Sheila", "../../StatusAffects", "../../CockTypesEnum", "../../Appearance", "../../CoC_Settings", "../../PerkLib", "../../../../includes/appearanceDefs"], function (require, exports, NPCAwareContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, Sheila_1, StatusAffects_1, CockTypesEnum_1, Appearance_1, CoC_Settings_1, PerkLib_1, appearanceDefs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class SheilaScene extends NPCAwareContent_1.NPCAwareContent {
        constructor() {
            super();
            this.pregnancy = new PregnancyStore_1.PregnancyStore(kFLAGS_1.kFLAGS.SHEILA_PREGNANCY_TYPE, kFLAGS_1.kFLAGS.SHEILA_PREGNANCY_INCUBATION, 0, 0);
        ...
        timeChange() {
            ...
            if (this.model.time.hours > 23) {
                if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CLOCK] < 0)
                    this.flags[kFLAGS_1.kFLAGS.SHEILA_CLOCK]++;
            }
        ...
        sheilaPreg(reducedChance = false) {
            ...
            if (SheilaScene.rand(100) <= chance)
                this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, PregnancyStore_1.PregnancyStore.INCUBATION_SHIELA);
        }
        sheilaCorruption(arg = 0) {
            /*if(flags[kFLAGS.SHEILA_CORRUPTION] + arg > 100) flags[kFLAGS.SHEILA_CORRUPTION] = 100;
            else*/ if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] + arg < 0)
                this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] = 0;
            else
                this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] += arg;
            return this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION];
        }
        //Sheila's cup function!
        sheilaCup() {
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 10)
                return "tiny, almost-absent";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 20)
                return "A-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 30)
                return "B-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 40)
                return "C-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 50)
                return "D-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 60)
                return "DD-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 70)
                return "E-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 80)
                return "EE-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 90)
                return "front-running";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 100)
                return "FF-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 110)
                return "G-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 120)
                return "GG-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 130)
                return "H-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 140)
                return "HH-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 150)
                return "'Holy Honkin' Hooters!'-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 160)
                return "I 'want to squeeze them'-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 170)
                return "II-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 180)
                return "Jiggle-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 190)
                return "JJ-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 200)
                return "K-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 210)
                return "KK-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 220)
                return "L-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 230)
                return "'Ladylove'-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 240)
                return "M-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 250)
                return "'Mega Milk'-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 260)
                return "N-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 270)
                return "NN-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 280)
                return "O-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 290)
                return "'so big it makes you say' OO-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 300)
                return "P-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 310 && this.player.cocks.length > 0)
                return "'would feel great around your' PP-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 310 && this.player.cocks.length == 0)
                return "PP-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 320)
                return "Q-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 330)
                return "QQ-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 340)
                return "R-u-serious?-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 350)
                return "RR-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 360)
                return "S-rank";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 370)
                return "'Shooting Star'-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 380)
                return "T-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 390)
                return "'damn, those are some big' TT-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 400)
                return "'bigger than' U-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 410)
                return "UU-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 420)
                return "V-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 430)
                return "'Va-Va-Voom'-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 440)
                return "'War Head'-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 450)
                return "World-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 460)
                return "X-Buster-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 470)
                return "XXXX-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 480)
                return "'Yay'-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 490)
                return "YY-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 500)
                return "Z-Saber-cup";
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 510)
                return "ZZ-cup";
            else
                return "fuckin' magic";
        }
        sheilaEncounterRouter() {
            console_1.trace("Sheila Encounter:");
            console_1.trace("Sheila Corruption: " + Math.round(this.sheilaCorruption() * 10) / 10 + " Sheila Preg: " + this.flags[kFLAGS_1.kFLAGS.SHEILA_PREGNANCY_INCUBATION] + " Sheila XP: " + this.flags[kFLAGS_1.kFLAGS.SHEILA_XP]);
            //UNFUCK FLAGS
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CLOCK] > 0)
                this.flags[kFLAGS_1.kFLAGS.SHEILA_CLOCK] = 0;
            if (this.sheilaCorruption() >= 100 && this.flags[kFLAGS_1.kFLAGS.SHEILA_DEMON] == 0)
                this.flags[kFLAGS_1.kFLAGS.SHEILA_DEMON] = 1;
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_DEMON] == 1)
                this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] = 4;
            //ACTUALLY PICK ENCOUNTER!
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_DEMON] == 0) {
                //PREG SHIT
                if (this.pregnancy.isPregnant && this.pregnancy.incubation == 0 && this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] >= -2) {
                    if (this.flags[kFLAGS_1.kFLAGS.SHEILA_JOEYS] == 0)
                        this.normalSheilaPregNotifNumberOne();
                    else
                        this.normalSheilaPregNotifREPEATEDED();
                    return;
                }
                if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == 0)
                    this.sheilaFirstEncounter();
                else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == -1)
                    this.sheilaApology();
                //XP-2 Sheila's apology (sheila xp = -2 and demon sheila = 0):
                else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == -2)
                    this.sheilaIsSorrySheRapedYou();
                //XP-3 or XP-4 She-mad (Sheila XP <= -3 and demon sheila = 0):
                else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == -3 || this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == -4)
                    this.sheilaReallyMad();
                //XP1: Reconciliation encounter (sheila xp = 1 and demon sheila = 0):
                else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == 1)
                    this.sheilaReconcile();
                //XP2: Familiarizing (Sheila XP = 2; or Sheila XP = 3 AND time =/= 20:00 and demon sheila = 0):
                else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == 2 || (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == 3 && this.model.time.hours != 20))
                    this.sheilaGettingFamiliar();
                //XP3: Sexy Time (sheila xp = 3 AND time = 20:00 and demon sheila = 0):
                else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == 3 && this.model.time.hours == 20)
                    this.sheilaXPThreeSexyTime();
                //XP4: Fancy meeting you here (sheila xp >= 4 and demon sheila = 0):
                else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == 4)
                    this.fuckBuddySheilaMeeting();
                else {
                    this.outputText("A BUG HAPPENED.  YOUR SHEILA_XP: " + this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] + ". <b>Value should be between -3 to 4.</b>");
        ...
        sheilaFirstEncounter() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] = 30;
        ...
        sheila1ndEncLookCloserPtII() {
            ...
            if (this.player.weaponName == "Scarred Blade")
                this.outputText("As the blade feels her gaze, it vibrates eagerly toward her, sliding partway out of the oiled scabbard; she stares into the exposed metal transfixed, as if looking into the diary of a past life.  Abruptly, she shakes her head and turns away, and the saber calms down.  ");
            ...
            if (this.player.lib >= 50)
                this.outputText("  Noting you still checking out her body, she smirks and says, \"<i>Enjoying your lookie, then?  Up here, cobber,</i>\" causing you to snap your head up sheepishly.");
            this.outputText("  You nod at the strange woman and introduce yourself.");
            if (this.player.short != "Sheila")
                this.outputText("  \"<i>" + this.player.short + ", eh?  My mates just call me Sheila.  Bunch of jokers, the bastards.</i>\"");
            else
                this.outputText("  \"<i>You too, eh?  Sheila's what my mates call me for a nickname.  Don't suppose you got yours from a bunch of adolescent-minded wankers, though.</i>\"");
            ...
            //[(high demon score)
            if (this.player.demonScore() >= 4)
                this.outputText("  I mean, take a squizz at yourself.  It's like you're not even trying to hide it; I've seen imps that look more like normal people.");
        ...
        sheila1ndEncLookCloserPtIITalkLeave() {
            this.clearOutput();
        ...
        // go to fight
        sheila1ndEncLookCloserPtIITalkFight() {
            this.clearOutput();
            this.startCombat(new Sheila_1.Sheila());
            this.playerMenu();
        }
        ...
        apologyAvoidSheila() {
            ...
            //set sheilapreg = -1
            this.flags[kFLAGS_1.kFLAGS.SHEILA_DISABLED] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[XP-1 - Apologize]
        apologySheilaApology() {
            this.clearOutput();
        ...
        apologySheilaSlapSult() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] = -3;
            this.startCombat(new Sheila_1.Sheila());
        }
        //[XP-1 - Nothing]
        apologySheilaSayNothing() {
            this.clearOutput();
        ...
        sheilaIsSorrySheRapedYou() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.KnowsArouse) >= 0)
                this.addButton(2, "CastArouse", this.sheilaPologyCastArouse);
            this.addButton(3, "LemmeAlone", this.sheilaIsSorryButLeaveMeAlone);
        }
        //[XP-2 - Leave Me Alone]
        sheilaIsSorryButLeaveMeAlone() {
            this.clearOutput();
        ...
        castArouseAndLeaveSheila() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] = 100;
            this.flags[kFLAGS_1.kFLAGS.SHEILA_DEMON] = 1;
            this.flags[kFLAGS_1.kFLAGS.SHEILA_CITE] = -1;
            this.dynStats("cor", 10);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        sheilaReallyMad() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] >= 90)
                this.outputText("It's so hard to remember myself anymore, and the taint you've put in my body goes crazy when you touch me.  Do you want me to get on my hands and knees?</i>\"  The woman lowers herself to the ground.  \"<i>I beg you.  ");
            this.outputText("Please, please leave me alone.");
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == -3)
                this.outputText("  I know you... you're not as bad as the rest of the monsters out here, so... please.");
            this.outputText("</i>\"");
            //[Stand][Leave]
            this.menu();
        ...
        sheilaReconcileKay2() {
            ...
            if (this.player.lib < 50)
                this.outputText("the beckoning hunks of meat");
            else
                this.outputText("her rising and falling breasts under the pretext of watching her work");
            ...
            //[(pc is kangaroo)
            if (this.player.race() == "kangaroo-morph")
                this.outputText(" - except you, I suppose");
            ...
            //[(lib >50)]
            if (this.player.lib >= 50)
                this.outputText(" like yourself - I saw you perving -");
            ...
            //set sheila xp to 2
            this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] = 2;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //XP2: Familiarizing (Sheila XP = 2; or Sheila XP = 3 AND time =/= 20:00 and demon sheila = 0):
        ...
        sheilaFriendlyHerPeoples() {
            ...
            if (this.player.femininity < 35)
                this.outputText("  She looks absently at your crotch.");
            ...
            //(lib >=50)
                ...
                if (this.player.hasCock())
                    this.outputText(", and you raise the kids at home?  Or put them with a nanny");
                this.outputText("?</i>\"");
                this.outputText("\n\n\"<i>Yeah, I suppose that'll work");
                if (this.player.hasCock())
                    this.outputText(", and I'll turn the kids over to");
                this.outputText(" - no, I mean, ");
                if (!this.player.hasCock())
                    this.outputText("if I decide");
                else
                    this.outputText("I'm not ready for");
        ...
        sheilaXPThreeSexyTimePostSexLetHerBe() {
            this.clearOutput();
        ...
        shielaXPThreeSexyTimePostSexStay() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] = 4;
        ...
        //fork
        shielaXPThreeSexyTimePostSexStayII() {
            this.clearOutput();
            //(has cockfit 32)
            if (this.player.hasCock() && this.player.cockThatFits(32) >= 0) {
                ...
                //[(not horse)]
                if (!this.player.isTaur())
                    this.outputText(" just above one " + this.nippleDescript(0));
                else
                    this.outputText(" on the thigh");
                ...
                //[(not horse)]
                if (!this.player.isTaur())
                    this.outputText("Your hands squeeze her hips almost of their own volition, helping her slam down with force, and her head rolls back on her neck.  ");
                this.outputText("Her ");
                //[(sheila corruption < 30)]
                if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] < 30)
                    this.outputText("little breasts rise and fall with increasing frequency atop her ribcage as her pace picks up and her breaths come short and shallow.");
                else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] > 60)
                    this.outputText("huge tits jiggle magnificently as she rocks, nearly slapping her in the face as she plunges down and then falling back into place with waves of rippling flesh.");
                else
                    this.outputText("breasts quiver invitingly as she pumps your cock, but before you can think of grabbing one yourself, both of her hands are squeezing and caressing them, drawing sighs from the woman as she toys with her erect nipples.");
                ...
                if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION]) {
                ...
                else if (this.player.cor < this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION])
                    this.outputText("  Her pussy clamps down around you, the rippling muscles so tight that she wouldn't even be able to pump if it weren't for the hot river of juice you feel around your tool.  \"<i>A-ah,</i>\" Sheila groans, \"<i>you thrust too!  Rail me silly!</i>\"  She tries to push against you with her hands, to return herself to an upright position, but can barely pull her chest apart from you - her nipples just narrowly recede from the surface of your " + this.player.skinFurScales() + " as her efforts peak.");
                //(else if magically equal but < 90)
                else
                    this.outputText("  Her pussy squirts and sucks alternately, trying to find purchase on your cock even as her pumping hips deny it; the sensation drives you wild.  \"<i>[name], your old fella is amazing...</i>\"");
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText("your dick twitches inside her");
                //(multicox)
                else
                    this.outputText("she spies the first bead of pearly semen exiting");
                if (this.player.cockTotal() == 2)
                    this.outputText(" your lonely, unused prick");
                if (this.player.cockTotal() > 2)
                    this.outputText(" each of your lonely, unused pricks");
                this.outputText(".");
                ...
                //[(multi)]
                if (this.player.cockTotal() > 1)
                    this.outputText(", to be joined shortly by a messy external eruption that covers her thighs and belly in blotches of gooey white");
                this.outputText(".");
                //[(big skeet)
                if (this.player.cumQ() >= 1000)
                    this.outputText("  It rolls out of you in waves, packing Sheila's cunt until she fills to capacity and the excess is forced out, sliming your own crotch.");
            ...
            //(if no cockFit 32 and yes vag)
                ...
                //[(horse)]
                if (this.player.isTaur())
                    this.outputText("You turn around and straddle a leg, squatting to bring your [vagina] atop her crotch.  \"<i>Push up,</i>\" you order, and Sheila obeys eagerly, twisting her body to connect her excited pussy with yours.");
                //(else if naga)
                else if (this.player.isNaga())
                    this.outputText("You slide it under her and lift gently; Sheila plays along with a disquieted expression, rolling over and raising her pussy into the air, and you press your own against her butt as your tail slides between her legs.  \"<i>See, you just need to be more... flexible,</i>\" you quip.");
                //(else if not horse and not naga)
                else
                    this.outputText("You straddle her legs with your own, pressing her pussy into yours; Sheila gasps as the hot flesh connects and you tentatively rock your hips, dragging your lower lips across.");
                ...
                //(sheila corruption > 30)
                if (this.sheilaCorruption() < 30)
                    this.outputText(" even though they're small and humble");
                //(else sheila corruption > 60)
                else if (this.sheilaCorruption() > 60)
                    this.outputText("; I worry that they're getting too mountainous");
                ...
                //[(naga) 
                if (this.player.isNaga())
                    this.outputText(" tail, drawing it up the hot opening and coiling it so you can return the warm, lube-slicked length for another pass even as you hump her butt.");
                else
                    this.outputText(" cunt, grinding her like a sex toy in search of your own climax.");
                ...
                if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption()) {
                    ...
                    if (this.player.isNaga())
                        this.outputText("scales");
                    else
                        this.outputText("pussy");
                    this.outputText(" until you can take no more of the heat and come as well.");
                    //[(naga)]
                    if (this.player.isNaga())
                        this.outputText("  Her breasts swell in your hands as she sucks in her breath sharply, feeling your pussy drool its juice onto her ass.");
                }
                //(else if PC corr < sheila corruption)
                    ...
                    if (this.player.isNaga())
                        this.outputText("; it feels like her breasts are pulling away from you as she tries to push her ass further into your quivering quim");
                    this.outputText(".");
                }
                else {
                ...
                if (this.player.hasCock()) {
                    ...
                    if (this.player.cockTotal() == 1)
                        this.outputText("prick quakes and spurts");
                    else
                        this.outputText("pricks quake and spurt");
            ...
            //(else if no cockFit 32 and no vag)
                ...
                if (this.player.hasCock())
                    this.outputText(", stroking your oversized tool despite her dismissal");
                ...
                if (this.player.hasCock()) {
                    ...
                    //(mans)
                    if (!this.player.isTaur())
                        this.outputText("falls into your lap");
                    //(horse)
                    else
                        this.outputText("drifts between your legs");
                ...
                //[(pc corr >= 90 or > sheila corruption)]
                if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption())
                    this.outputText("  Her vagina heats up, squeezing your fingers so hard that you nearly can't pull out to rub her again, and you have a clear view of her breasts swelling up - arguable proof of your prowess, considering what she told you earlier.  Her people must be terrible at faking orgasm.");
                //(pc corr < sheila corruption)
                else if (this.player.cor < this.sheilaCorruption())
                    this.outputText("  Her vagina gushes with clear fluid, filling the bowl made by your hand with warmth, and you think you can see her breasts tightening up slightly as her back arches, though it's hard to be sure with how she's shaking.");
                else
                    this.outputText("  Her pussy quivers around you, and you draw the fingers out and pop them into Sheila's mouth.  The woman sucks on them greedily, and you raise an eyebrow at her.  She blushes again, but it's evidently not the first time she's done the same thing!");
                ...
                if (this.player.hasCock()) {
                    ...
                    //[(big skeet)
                    if (this.player.cumQ() > 1000)
                        this.outputText("  Her mouth fills quickly, and she writhes in your grip, managing to turn her head.  \"<i>Oh god, no way!</i>\" she coughs, spitting up enough semen to coat her chin as your ongoing orgasm spatters against her cheek.");
                    //[(mega skeet)
                    if (this.player.cumQ() >= 2000)
                        this.outputText("  Not satisfied with that alone, you turn her head the other way for your finish, ejaculating on the rest of her face and completing her gooey, white beard as she squirms.");
                    //[(multicock)
                    if (this.player.cockTotal() > 1)
                        this.outputText("  The other strokes not coming from this cock do their part to decorate your lover as well, turning her hair into a slimy mess.");
                ...
                //(cock.length > 0)
                if (this.player.hasCock())
                    this.outputText(", her face still covered in globby white smears");
                this.outputText(".  \"<i>Fuck...</i>\" she groans.  \"<i>You're a jerk, [name].");
                //[(cock.length > 0)
                if (this.player.hasCock())
                    this.outputText("  I can't believe you called me a goblin, you arsehole.");
                this.outputText("</i>\"");
                this.outputText("\n\nYou ");
                //[(cock.length > 0)
                if (this.player.hasCock())
                    this.outputText("can't believe how much she acts like one sometimes... but you ");
                ...
                //[(cock.length > 0)
                if (this.player.hasCock())
                    this.outputText(", even after Sheila finishes wiping her face clean and stares at you");
                ...
                if (this.player.hasCock()) {
                    ...
                    this.dynStats("lus", this.player.lib / 4);
                this.sheilaCorruptionUpdate();
                /*
                if(player.cor > sheilaCorruption()) {
                    dynStats("cor", -5);
        ...
        //[XP3 - Guard Duty]
        sheilaXPThreeSexyTimeGuardDuty() {
            this.clearOutput();
            ...
            if (this.player.level >= 8)
                this.outputText(" - which, you suppose, must include imps even though they're so far beneath you they might as well be underground");
            ...
            //(else lib >= 40)
                ...
                //[(cock.length > 0)
                if (this.player.hasCock())
                    this.outputText("shift your pelvis forward");
                //(cock.length == 0)
                else
                    this.outputText("stick out your tongue playfully");
        ...
        fuckBuddySheilaMeetingMaybeLater() {
            this.clearOutput();
        ...
        //[XP4 - Just Hang]
        fuckBuddySheilaMeetingJustHangOut() {
            this.clearOutput();
            this.outputText("In answer, you reach down to pinch her butt and then ");
            //[(not horse or drider)
            if (!this.player.isTaur() && !this.player.isDrider())
                this.outputText("scoot your own forward");
            else
                this.outputText("fold your legs under you");
        ...
        fuckBuddySheilaMeetingChat() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_JOEYS] > 0)
                this.addButton(4, "Kids", this.fuckBuddySheilaMeetingChatKids);
        }
        //[XP4 - Chat - Family&Friends]
        fuckBuddySheilaMeetingChatFamilyAndFriends() {
            this.clearOutput();
        ...
        //[XP4 - Chat - Old Loves]
        fuckBuddySheilaMeetingChatOldLoves() {
            this.clearOutput();
            ...
            //(else lib >=50)
                ...
                if (this.player.cor >= 60)
                    this.outputText(" - though it's probably meant to be a defensive gesture, all it does is push her tits together under her white shirt and frame them in light-brown skin");
                ...
                //[(corr < 30)
                if (this.player.cor < 30)
                    this.outputText("; you lay a hand on her shoulder reassuringly");
        ...
        //[XP4 - Chat - Why Hide?]
        fuckBuddySheilaMeetingChatWhyHide() {
            this.clearOutput();
        ...
        fuckBuddySheilaMeetingChatLiveWithMe() {
            this.clearOutput();
        ...
        fuckBuddySheilaMeetingChatKids() {
            this.clearOutput();
            //if joeycount = 1
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_JOEYS] == 1) {
            ...
            //if 1 < joeycount < 10
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_JOEYS] < 10) {
                ...
                if (this.player.lib > 50)
                    this.outputText(" and tight, hot cunt");
        ...
        fuckBuddySheilaMeetingChatKidsRest4Now() {
            this.clearOutput();
        ...
        sheilaXP4Sex(display = false) {
            ...
            if (this.player.gender > 0) {
                if (this.player.hasCock())
                    this.addButton(0, "69WithWang", this.consensualSheila69, true);
                if (this.player.hasVagina())
                    this.addButton(1, "69WithCooch", this.consensualSheila69, false);
            }
            //[Consensual - Vaginal Sex] (req. cock <= 32 area):
            if (this.player.hasCock() && this.player.cockThatFits(32) >= 0)
                this.addButton(2, "Fuck Her", this.consentacleVagSexForKangarooSlutBitches);
            //da scene
            this.addButton(3, "Masturbation", this.sheilaMutualMasturbation);
        }
        //Consensual scenes (normal Sheila's vaginal capacity is 32, for reference):
        //[Consensual - Either 69] - Fenoxo beware, omnibus scene!(req. vag or dix; both buttons direct here but decide the focus)
        consensualSheila69(cock = true) {
            this.clearOutput();
            ...
            //(vag)
                ...
                if (this.player.clitLength > 8)
                    this.outputText(" and bring your " + this.clitDescript() + " to its erect state.  \"<i>... And quite a stem,</i>\" your lover concludes.  \"<i>You sure that's not a dick?</i>\"");
                else
                    this.outputText(", producing a slight sigh and a wet finger.  \"<i>And I'm the eager one, right?</i>\" your lover asks, wryly - though her finger is just as wet.");
            }
            ...
            if (cock && this.player.cockThatFits(32) < 0)
                this.outputText("  \"<i>[name], I'm telling you it won't fit!</i>\"");
            else
                this.outputText("  \"<i>Not talking, then?  Please yourself.</i>\"");
            this.outputText("  Her commentary cuts off as you ");
            if (!this.player.isTaur())
                this.outputText("turn around and hang your ");
            else
                this.outputText("straddle her and squat down to dangle your ");
            if (cock)
                this.outputText("pre-seeping shaft");
            else
                this.outputText("wet pussy");
            ...
            if (cock) {
                ...
                //(big) 
                if (this.player.cockThatFits(32) < 0)
                    this.outputText(" and guiding it to bend comfortably against her chest, drooling a trail of pre-cum as she slides it into position");
                this.outputText(".");
            }
            //(vag)
            else
                this.outputText("returning the favor and plunging into your " + this.vaginaDescript(0) + " with her hand.");
            this.outputText("  She pumps you once, eliciting a trickle of fluid, and then speaks once more.  \"<i>Bring it lower...</i>\"");
            this.outputText("\n\nYou oblige, ");
            if (!this.player.isTaur())
                this.outputText("flattening your back");
            else
                this.outputText("squatting lower");
            this.outputText(" so your ");
            if (cock) {
                this.outputText("cock sinks down");
                //[(small cock) 
                if (this.player.cockThatFits(32) >= 0)
                    this.outputText(" into her warm, waiting mouth");
                else
                    this.outputText("; she lets go of it to grab her breasts instead, trying to push them around the sensitive shaft as she runs her tongue up the underside");
                this.outputText(".");
            }
            else {
                this.outputText("pussy dangles just over her face; she ");
                if (this.player.clitLength > 8)
                    this.outputText("nips and sucks at the tip of your clit, rolling it with her tongue");
                else
                    this.outputText("parts your labia with her tongue, stroking them gently and tickling your little clitoris");
                this.outputText(".");
            }
            this.outputText("  Not to be outdone in creativity, technique, or audacity, you ");
            if (!this.player.isTaur())
                this.outputText("lean down and bury your own tongue all the way inside Sheila, forcing her labia open with your mouth");
            else
                this.outputText("reach as far as you can to bring both hands into play, stroking and pulling Sheila's labia apart with one as you tease her exposed clitoris or slip inside her vagina with the other");
            ...
            if (!cock) {
                ...
                //[(bigclit)
                if (this.player.clitLength > 8)
                    this.outputText(" and stroking your " + this.clitDescript() + " rapidly with one hand");
                this.outputText(".");
            }
            //(smallcox)
            else if (this.player.cockThatFits(32) >= 0)
                this.outputText("taking you into her mouth once again and licking away a neglected drop of pre-cum.");
            else
                this.outputText("stroking your cock with one hand as she pushes an erect nipple against its side to trace a line.");
            //[(no horse)
            if (!this.player.isTaur()) {
                ...
                if (cock && this.player.cockThatFits(32) < 0)
                    this.outputText("shaking, teasing nipples and heaving chest");
                else
                    this.outputText("mouth, humming in delight");
                this.outputText(".");
            }
            //(horse)
            else {
                ...
                if (cock && this.player.cockThatFits(32) < 0)
                    this.outputText("hard nipples");
                else
                    this.outputText("throat");
                this.outputText(".");
            }
            ...
            //(PC corr < sheila corruption)
                ...
                if (!this.player.isTaur())
                    this.outputText("mouth, filling you with her taste.");
                else
                    this.outputText("hands, completely soaking them in her orgasm.");
            ...
            else if (this.player.cor == this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] && this.player.cor < 90) {
            ...
            //[(big cox)
            if (cock && this.player.cockThatFits(32) < 0)
                this.outputText("pressing her lips and tongue to the base of your shaft as she masturbates it vigorously.");
            ///(small cox)
            else if (cock)
                this.outputText("sinking your [cockHeadFit 32] into the warm recesses of her throat where her muscles caress and coax it.");
            else
                this.outputText("penetrating you deeply with her tongue as her hands reach up to stroke your clit furiously.");
            ...
            if (cock) {
                ...
                if (this.player.cockThatFits(32) >= 0) {
                    ...
                    if (this.player.cumQ() < 250)
                        this.outputText("; you withdraw from her, allowing her throat to force your ejaculate back up and over her lips and cheeks with a splutter.");
                    //(big cum)
                    else if (this.player.cumQ() < 2000)
                        this.outputText(", but your relentless orgasm forces it down again, dumping more jism into her throat.  You can feel her hands clawing at your [butt] as you relieve your buildup.");
                    //[(mega cum)
                    else
                        this.outputText(".  Soon, her visibly-rounding stomach fills and the tip of your dick is once again washed in backflow; the next spurts force the cum all the way up, and she begins drooling the slimy semen-saliva blend from her mouth and nose, hands all the more frantic in her alarm.");
                }
                //(else doesn't fit)
                else {
                    ...
                    //(big skeet)
                    if (this.player.cumQ() > 1000)
                        this.outputText("  A wellspring of seed, your body continues producing until the fuzz on her thighs and tail is completely matted down with the whiteness drooling between you.");
                    //(multicocks)
                    if (this.player.cockTotal() > 1) {
                        this.outputText("  Your other cock");
                        if (this.player.cockTotal() == 2)
                            this.outputText(" spasms");
                        else
                            this.outputText("s spasm");
            ...
            //(else if vag-focus)
                ...
                if (this.player.wetness() <= 2)
                    this.outputText("trickle out, and are quickly sucked up by her greedy mouth");
                else if (this.player.wetness() <= 4)
                    this.outputText("gush freely, leaving her face slick");
                else
                    this.outputText("overflow, soaking her hair even as she shuts her eyes tight against the cataract");
            ...
            //[(smallcox)
            if (cock && this.player.cockThatFits(32) >= 0)
                this.outputText(", pulling free of her throat.  She immediately turns over as well and forces herself to her hands and knees, then gags and coughs up a large amount of your jism.  When she's dumped enough to clear her passageway, she collapses forward, smearing the mess onto her chest as she spends a few minutes to catch her breath.  Once she's got it, she turns back over and sits up, strands of your slime linking her breasts to the grass.");
            //(else not smallcox)
            else
                this.outputText(".  She sits up, wiping sweat and stray fluids away from her eyes.");
            ...
            else if ((this.player.cor > 90 || this.player.cor > this.sheilaCorruption()) && this.sheilaCorruption() >= 80 && this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] != 3) {
                this.sheilaCorruptionUpdate();
            ...
            if (cock && this.player.balls > 0) {
                ...
                if (this.player.balls == 2)
                    this.outputText("infinity");
                else
                    this.outputText("double infinity");
            ...
            //(else if sheila xp =/= 3)
                ...
                if (cock && this.player.cockThatFits(32) >= 0)
                    this.outputText(", smearing your dangling hand into the mess on her tits");
        ...
        //[Consensual - Vaginal Sex] (req. cock <= 32 area):
        consentacleVagSexForKangarooSlutBitches() {
            this.clearOutput();
            var x = this.player.cockThatFits(48);
            if (x < 0)
            ...
            if (this.sheilaCorruption() <= 30)
                this.outputText("pert");
            else
                this.outputText("jiggly");
            ...
            if (!this.player.hasFuckableNipples())
                this.outputText("squeezing and fondling");
            else
                this.outputText("plunging two fingers into");
            ...
            //[(if wangaroo)
            if (this.player.cocks[this.player.cockThatFits(32)].cockType == CockTypesEnum_1.CockTypesEnum.KANGAROO)
                this.outputText("tapered, fleshy penis.  \"<i>Wow... you never see those.</i>\"");
            else
            ...
            //[(no centaur)
            if (!this.player.isTaur())
                this.outputText("Taking hold of your " + this.cockDescript(x));
            //(centard)
            else
                this.outputText("Attempting to maneuver your " + this.cockDescript(x) + " into position");
            this.outputText(", you rub the head along her dripping snatch, smearing her fluid over it.  ");
            //[(non-cent)
            if (!this.player.isTaur())
                this.outputText("Gripping her fuzzy thighs next, you lift her bottom and line");
            //(hoers)
            else
                this.outputText("She lifts her bottom and lines");
            ...
            if (this.sheilaCorruption() <= 30)
                this.outputText("her perky breasts rock back and forth");
            else
                this.outputText("her jiggling breasts flatten into perfect domes and undulate on her chest");
            ...
            if (!this.player.isTaur()) {
                ...
                if (this.sheilaCorruption() <= 30)
                    this.outputText("firm");
                else
                    this.outputText("pillowy");
            ...
            if (this.player.balls > 0 || this.player.hasVagina()) {
                ...
                //(if vag)
                if (this.player.balls == 0 && this.player.hasVagina())
                    this.outputText("Your cunt twitches and drools a bit of fluid on the furry intruder.  ");
            }
            this.outputText("You fuck harder, stuffing Sheila with such force that her ");
            if (this.sheilaCorruption() < 30)
                this.outputText("perky, erect nipples trace long arcs against your skin");
            else
                this.outputText("jiggly tits nearly slap into her face");
            ...
            if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION]) {
                ...
                if (this.player.cockTotal() > 1) {
                    ...
                    if (this.player.cockTotal() == 2)
                        this.outputText("dick erupts");
                    else
                        this.outputText("dicks erupt");
            ...
            //(else if equal but below 90)
                ...
                if (this.player.cockTotal() > 1)
                    this.outputText(" or onto her thighs and belly");
                this.outputText(".");
            }
            this.outputText("\n\n\"<i>Oh god!</i>\" she yells.  \"<i>Pull out, before you get me pregnant!</i>\"  ");
            //[(non-dog cock)
            if (!this.player.hasKnot(x)) {
                this.outputText("You oblige shakingly, pulling your " + Appearance_1.Appearance.cockNoun(this.player.cocks[x].cockType) + " out of her clenching pussy with a wet, sucking noise.  A trickle of semen drools from between her lips as you unburden yourself of the rest of your load, squirting it onto her groin");
                //[(big skeet)
                if (this.player.cumQ() > 500)
                    this.outputText(", breasts, and face");
                this.outputText(".");
                //[(Huge skeet)
                if (this.player.cumQ() >= 1500)
                    this.outputText("  More and more globs of semen shoot from the end of " + this.sMultiCockDesc() + ", pasting Sheila to the dry grass as you paint her body white.");
            }
            //(dog cock)
            else {
                ...
                if (this.player.cumQ() >= 1000) {
                    ...
                    if (this.player.cumQ() >= 3000)
                        this.outputText(", until it's stretched as far as possible and each successive jet forces out squirts of frothy jism from the tight seal her pussy makes around the knot");
                    this.outputText(". ");
                }
                //[(multi)
                if (this.player.cockTotal() > 2)
                    this.outputText("Your other cocks erupt as well, soaking her crotch and matting down the fur on her thighs with whiteness. ");
            }
            this.outputText("Both of your orgasms finish up");
            //(dog-c) 
            if (this.player.hasKnot(x))
                this.outputText(" and you finally manage to pull out of her");
            ...
            //(else sheila xp =/= 3)
                ...
                //[(norm skeet)
                if (this.player.cumQ() < 500)
                    this.outputText("as she strokes the " + this.player.skinFurScales() + " of your chest");
                else
                    this.outputText("as she wipes off as much jizz as she can");
        ...
        //da scene
        sheilaMutualMasturbation() {
            this.clearOutput();
            var target = "";
            var choices = new Array();
            if (this.player.hasCock()) {
                if ((this.player.isTaur() && this.player.tallness * (5 / 6) < this.player.cocks[this.player.longestCock()].cockLength) || this.player.hasCock())
                    choices[choices.length] = "cock";
            }
            if (this.player.hasVagina() && !this.player.isTaur())
                choices[choices.length] = "vagina";
            if (this.player.hasFuckableNipples())
                choices[choices.length] = "nipplecunt";
            if (this.player.gender == 0 || choices.length == 0)
                choices[choices.length] = "ass";
            if (choices.length == 0) {
            ...
            //[(horse)
            if (this.player.isTaur())
                this.outputText(", folding your legs under you,");
            ...
            //(non-horse vag)
                ...
                this.outputText(" sliding your hand to your [vagina], parting your lips with two fingers");
            //(gross-ass nipcunts)
            else if (target == "nipplecunt")
                this.outputText("plunging your fingers into one of your awkward, distended nipples");
            //(Unsexed non-centaur only)
            else if (target == "ass" && !this.player.isTaur())
                this.outputText("licking a finger and teasing your asshole with shallow strokes, gently circling the ring");
            //(centaur who hasn't got shit)
            else
                this.outputText("sucking a single digit salaciously, fingerfucking your mouth and coating it with saliva");
            ...
            if (target == "cock")
                this.outputText("begin stroking your shaft, drooling pre-cum onto her skin and ");
            //(non-horse vag)
            else if (target == "cunt")
                this.outputText("demonstrate by slipping your fingers into your own [vagina] and ");
            ...
            if (target == "cock")
                this.outputText("You return your hand to your [cock], pumping vigorously to catch up to your lover, spurred onward by the smooth skin she presses into your lips.");
            //(else if nonhorse vag)
            else if (target == "cunt")
                this.outputText("You slide your hand between your [legs] again, intent on recovering the march Sheila's stolen on you, and begin rubbing your [clit] vigorously while sighing into her breast.");
            //(else if RNG disgusting nipplecunts)
            else if (target == "nipplecunt")
                this.outputText("Your hand returns to your chest, slipping inside the sensitive flesh of your nipple, and you groan into Sheila's as a trickle of moisture falls from your chest.");
            //(else if non-centaur asshole)
            else if (!this.player.isTaur())
                this.outputText("Your hand reaches back to your [asshole], neglected for too long, and a finger spears your pucker, stroking the nerves inside as you hurry to bring your arousal in line with Sheila's.");
            ///(else if fucking nothing)
                ...
                if (this.silly())
                    this.outputText(", even just a paperclip");
                this.outputText(".");
            }
            ...
            //[(if fucking nothing)
            if (target != "cock" && target != "cunt" && target != "nipplecunt")
                this.outputText(", and yours joins her, slipping into her entrance alongside");
            this.outputText(".  \"<i>Just... say I'm always yours!</i>\"  She turns you toward her face again, locking you in a kiss, and your ");
            //[(if cock)
            if (target == "cock") {
                if (this.player.cockTotal() == 1)
                    this.outputText("prick begins");
                else
                    this.outputText("pricks begin");
            ...
            //(jack shit)
                ...
                this.outputText("fingers are pulled into her vagina by her muscles as her orgasm begins.");
            //[( pc corr >= 90 or > sheila corruption) 
            if (this.player.cor >= 90 || this.player.cor > this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION]) {
            ...
            //(else if equal corr but under 90)
                ...
                //[(not jack shit)
                if (target == "cunt" || target == "cock" || target == "nipplecunt")
                    this.outputText("  Emptying your reserves, you allow yourself to fall into her arms, resting your head on her chest.");
            }
            ...
            //(else no corruption warning triggered)
                ...
                if (target == "cock")
                    this.outputText("there, staring at the load you left in her bellybutton");
                else
                    this.outputText("together");
                this.outputText(".  \"<i>Oh, I had so much fun, mate.");
                //[(if sex =U and sillymode)
                if (this.player.gender == 0 && this.silly())
                    this.outputText("  I love you, my Ken doll.");
                this.outputText("</i>\"");
                //[(if sheila xp = 3)
                if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] == 3) {
        ...
        sheilaCorruptionWarningsChooseFondle() {
            this.clearOutput();
            ...
            if (this.player.hasCock())
                this.outputText("erect");
            else if (this.player.hasVagina())
                this.outputText("wet");
            else
                this.outputText("aching");
            ...
            this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] = -3;
            this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] = 90;
            this.dynStats("cor", -10);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[Any Corruption Warning - Listen to Her]
        sheilaCorruptionWarningListenToHer() {
            this.clearOutput();
            ...
            this.flags[kFLAGS_1.kFLAGS.SHEILA_CLOCK] = -4;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        sheilaGotWhomped() {
            ...
            if (this.monster.HP < 1)
                this.outputText("completely spread-eagled from her injuries");
            ///(lust)
            else
                this.outputText("rubbing her thighs together and smearing around the moisture from her pussy");
            ...
            //[(sheila xp > -4)
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] > -4)
                this.outputText("  I'll forgive you for everything else, but please, not this!");
            this.outputText("</i>\" she implores.");
            //[(sheila corruption >= 90)
            if (this.sheilaCorruption() >= 90)
                this.outputText("  \"<i>I-if you touch me again... god, I can't even think straight anymore!  Don't do this!</i>\"");
            //(lust >= 30)
            ...
            if (this.player.lust >= 33) {
                if (this.player.hasCock() && this.player.cockThatFits(48) >= 0)
                    this.addButton(0, "Fuck Pussy", this.rapeSheilasCooter);
                if (this.player.hasCock()) {
                ...
                if (this.player.hasVagina())
                    this.addButton(2, "Forced Lick", this.forcedSheilaOral, false);
            }
        ...
        rapeSheilasCooter() {
            ...
            //[(horse)
            if (this.player.isTaur())
                this.outputText(" by planting your forehooves just above her hips");
            this.outputText(".  Reaching down, you take the neck of her shirt in your hand, then rip it open, exposing her ");
            //[(sheila corruption < 30)
            if (this.sheilaCorruption() < 30)
                this.outputText("tiny ");
            //sheila corruption > 60)
            else if (this.sheilaCorruption() > 60)
                this.outputText("huge, soft ");
            ...
            //[(monster HP < 1)
            if (this.monster.HP < 1)
                this.outputText("sliding it between her labia and producing a damp spot, then ");
            ...
            if (this.player.cor < 50) {
                ...
                if (this.player.isTaur())
                    this.outputText(" with your belly");
                ...
                //[(big skeet)
                if (this.player.cumQ() >= 500)
                    this.outputText("  Soon you've filled her as fully as the shallow penetration will allow, and the panties begin to press back against your cock, oozing onto you whatever semen the porous dam can't contain.");
                //(mega skeet)
                else if (this.player.cumQ() >= 1500)
                    this.outputText("  It sags and bows around the tip of your spear, pulsing with each new stroke as the hemlines leak jizz onto her legs and butt.");
                ...
                //[(big skeet)
                if (this.player.cumQ() >= 500)
                    this.outputText("So much cum fills her pussy that it slips out, once again restoring the opacity, though not the dryness, of her panties.  ");
                ...
                if (this.player.cockArea(x) > 32)
                    this.outputText(" and the pain of taking a cock slightly too large for her");
                ...
                if (this.sheilaCorruption() > 10)
                    this.outputText(" jiggles her breasts and");
                ...
                //[(not centaur)
                if (!this.player.isTaur())
                    this.outputText(", leaning down to kiss her long neck and collarbone");
                ...
                //[(nothors)
                if (!this.player.isTaur())
                    this.outputText(", transferring yours to her breast while brushing her torn shirt to the side");
                this.outputText("; without struggling further, she slowly lowers it");
                //[(nothors)
                if (!this.player.isTaur())
                    this.outputText(" to rest atop your own");
                this.outputText(", confirming your suspicion.  Her eyes close and her chin raises resignedly");
                //[(nothors)
                if (!this.player.isTaur())
                    this.outputText(" as you triumphantly squeeze the flesh in your hand and kiss her under the jaw");
                this.outputText(".");
                ...
                //[(mans)
                if (!this.player.isTaur())
                    this.outputText("place a hand along her face, tuning it toward you, and kiss her on the lips.");
                else
                    this.outputText("bend down, lowering your torso until you can caress her cheek.");
                ...
                //[(nonhors)
                if (!this.player.isTaur())
                    this.outputText(" and squeeze her breast");
                ...
                //[(nonhors) 
                if (!this.player.isTaur())
                    this.outputText(" and she presses your hand uncomfortably");
                ...
                if (this.player.cor >= 90 || this.sheilaCorruption() < this.player.cor) {
                    ...
                    //[(nonhors)
                    if (!this.player.isTaur())
                        this.outputText("; you can almost feel her breast heating up and swelling with blood under your hand, as the nipple pokes into your palm");
                    this.outputText(".");
                }
                //(PC corr < sheila corruption)
                else if (this.player.cor < this.sheilaCorruption()) {
                    ...
                    //[(nonhors)
                    if (!this.player.isTaur())
                        this.outputText("  She squeezes your hand so hard that you swear you can feel her breast compressing under it as she screams her pleasure.");
                }
                //(else equal but < 90)
                else {
                ...
                //[(big skeet)
                if (this.player.cumQ() >= 500)
                    this.outputText("  Overabundant as always, your semen quickly fills her to capacity and begins to squirt out around your shaft, staining her thighs.");
                //[(multicock)
                if (this.player.cockTotal() > 1) {
                    this.outputText("  Your other ");
                    if (this.player.cockTotal() == 2)
                        this.outputText("dick spits");
                    else
                        this.outputText("dicks spit");
        ...
        forcedSheilaOral(dick = true) {
            ...
            if (this.sheilaCorruption() >= 50)
                this.outputText("soft, pillowy");
            else
                this.outputText("small, perky");
            ...
            if (this.sheilaCorruption() < 20)
                this.outputText("little round things that trace gentle curves under her loose shirt.");
            //(else sheila corruption < 50)
            else if (this.sheilaCorruption() < 50)
                this.outputText("healthy mounds that fill out her shirt.");
            else
                this.outputText("swollen globes that bulge over her v-neck and strain at the seams of her shirt.");
            ...
            //[(cock.length > 0)
            if (dick)
                this.outputText(this.SMultiCockDesc() + " flops free, half-erect and swelling steadily with blood as you appraise the woman's body.");
            //(vag present)
            else
                this.outputText("Your [vagina] drools slightly, labia parting and [clit] poking up; you imagine what you want to do with it.");
            ...
            if (dick) {
                ...
                if (this.player.cocks[this.player.shortestCockIndex()].cockLength <= 8) {
                    ...
                    if (this.player.balls > 0)
                        this.outputText("your [sack]");
                    else
                        this.outputText("the base of your shaft");
                    ...
                    if (this.player.balls > 0)
                        this.outputText(" and your [balls] tighten up");
                ...
                //(else dick length > 8)
                    ...
                    if (this.player.cocks[this.player.shortestCockIndex()].cockThickness <= 6) {
                        ...
                        if (this.player.balls > 0)
                            this.outputText(" and your [balls] begin to rise");
                    ...
                    ///(else width > 6)
                        ...
                        if (this.player.balls > 0)
                            this.outputText(" and your [balls] draw closer to your body");
                ...
                if (this.player.cor >= 70 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.Infested) == 5) {
                    this.outputText("\n\nA wicked idea flits through your head, brought on by the squirming annoyances ");
                    if (this.player.balls > 0)
                        this.outputText("packing your [balls] and driving up your lust in their zeal to multiply");
                    else
                        this.outputText("deep inside your body, trailing sensation along the nerves in your most intimate places and ramping up your production");
                    ...
                    if (this.player.cumQ() >= 2500)
                        this.outputText("  The volume of semen and slimy worms you pack her with is so great that it strains her stomach; you can actually see dozens of the annelids slithering around in a tight ball under the taut skin of her swollen midriff.");
                    this.outputText("  Eventually you finish and pull out, after pushing up every worm you can.  Your ");
                    if (this.player.balls > 0)
                        this.outputText("[sack]");
                    else
                ...
                //(else if corr < 70 or PC cannot use Infest at will)
                    ...
                    //[(big skeet)
                    if (this.player.cumQ() >= 1000)
                        this.outputText(", and soon you can feel it lapping at the end of your shaft");
                    this.outputText(".");
                    //[(mega skeet)
                    if (this.player.cumQ() >= 3000)
                        this.outputText("  Your body's not done with that, though, and keeps pushing out cum until it spurts around your prick and out Sheila's nose in little squirts.");
                    ...
                    //[(big+ skeet)
                    if (this.player.cumQ() >= 1000)
                        this.outputText(", though it's so wet with seed now that you can see them almost as well through it");
                ...
                //[(sheila corruption >= 30)
                if (this.sheilaCorruption() >= 30)
                    this.outputText("; her breasts jiggle pleasingly as they settle on her chest, filling you with the urge to play with them");
                this.outputText(".  Straddling her, you lower your [vagOrAss] to her face.  \"<i>Lick,</i>\" you order, rubbing your [butt] on Sheila's nose");
                //[(not horse)
                if (!this.player.isTaur())
                    this.outputText(" as you fondle her tits");
                this.outputText(".");
                ...
                if ((this.player.hasVagina() && this.player.vaginalCapacity() >= 100) || (!this.player.hasVagina() && this.player.analCapacity() >= 100))
                    this.outputText("  She keeps hitting the same spot again, too - she's not even bothering to adjust her angle and touch the rest of your stretched opening.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00141] > 0)
                    this.outputText("  I know a nice boy in the mountains who keeps dogs, and I'm sure he'd love to have a womb like yours for their seed.  By this time tomorrow, you could have a cock in both holes, filling you with hellhound babies since you can't please a person.");
                this.outputText("</i>\"");
                this.outputText("\n\nYou can feel her face heating up under your [butt] as she flushes with shame; seems like you struck a nerve.  You ");
                //[(no horse)
                if (!this.player.isTaur())
                    this.outputText("pinch her nipple for emphasis, then grind your hips across her face, mauling her nose with your ass.  \"<i>I could fuck a tree and it wouldn't be as wooden as you in the sack");
                //[(PC has found corrupt glade)
                if (this.player.exploredForest >= 40)
                    this.outputText(" - in fact, there are quite a few I've seen who look like better lovers than you.  Maybe I should carry you to the forest and tie you to a nice pussy-shaped giant flower to give you lessons");
                this.outputText(".  ");
                //[(minotaur addiction score =/= 0%)
                if (this.flags[kFLAGS_1.kFLAGS.MINOTAUR_CUM_ADDICTION_TRACKER] > 0 || this.player.findPerk(PerkLib_1.PerkLib.MinotaurCumAddict) >= 0) {
                ...
                if (this.izmaFollower() && this.flags[kFLAGS_1.kFLAGS.IZMA_NO_COCK] == 0)
                    this.outputText("; I personally know fifteen inches of fat, orange dick and four heavy balls that'd love to get in at your other end while I ride your face");
                this.outputText(".</i>\"");
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.HairdresserMeeting) >= 0 || this.flags[kFLAGS_1.kFLAGS.LUMI_MET] > 0) {
                ...
                //[(no horse)
                if (!this.player.isTaur())
                    this.outputText("  Even squeezing her breasts viciously can't compel her to reinsert it, though you amuse yourself trying.");
        ...
        sheilaGetsRapedWithADildont() {
            ...
            //(else if magically equal but < 90)
                ...
                this.outputText("The kiss is wet and indecent as she shudders through her anal orgasm; her lips don't stay in one place, instead tracking drool all over your face.");
            ...
            //(cock)
            if (this.player.hasCock())
                this.outputText("  \"<i>Perhaps next time you'd like to try a real cock in there?</i>\"  Even exhausted and messed up on goblin drugs, she has the presence of mind to shake her head at that.  You laugh.");
        ...
        getBeatUpBySheila() {
            ...
            if (this.monster.lust < 75) {
                ...
                if (this.player.HP < 1)
                    this.outputText("colorful spots");
                else
                    this.outputText("fantasies of her, stark naked but for her hat and waiting with her legs open");
                this.outputText(".");
        ...
        sheilaLossRapeRouter() {
            ...
            if ((!this.player.hasCock() || SheilaScene.rand(3) == 0))
                this.sheilaForcedOralGeneric();
        ...
        sheilaCowgirlRapesYou() {
            ...
            if (this.player.isTaur())
                this.outputText("; your hooves stick awkwardly out to one side");
            ...
            if (this.sheilaCorruption() < 30)
                this.outputText("petit ");
            else if (this.sheilaCorruption() > 70)
                this.outputText("massive ");
            ...
            if (this.player.isTaur())
                this.outputText("pulls your legs apart");
            else
                this.outputText("unfastens and strips off your [armor]");
            ...
            if (this.player.cockThatFits(32) < 0) {
                ...
                //[(horse)
                if (this.player.isTaur())
                    this.outputText(", or at least as flat as you can get it");
                this.outputText(", then sits on your stomach");
                if (this.player.isTaur())
                    this.outputText(", sliding her long legs between yours");
                ...
                if (this.player.isTaur())
                    this.outputText("forelegs fold over her torso affectionately");
                else
                    this.outputText("hands search out her breasts, caressing and squeezing");
                ...
                if (!this.player.isTaur())
                    this.outputText("and suck on your fingers");
                ...
                if (this.player.cor >= 90 || this.sheilaCorruption() < this.player.cor) {
                    ...
                    this.outputText("Her orgasm wets your prick, coating it with fluid as she comes.  Sheila wraps herself tighter in your limbs, squeezing her breasts against her chest, and you think you can feel them get a little smaller as your head fuzzes over with her excess emotion.");
                else
                    this.outputText("Her hips lock up when she comes, leaving you to try and finish yourself as she heats up around your shaft.");
                //[(sens >=50)
                if (this.player.sens >= 50) {
                    ...
                    //[(mega skeet)
                    if (this.player.cumQ() >= 2000)
                        this.outputText("  The giggles and the strokes stop long before your orgasm, though; eventually Sheila just lies there, dumbfounded, as you deposit layer after layer of white lattice on her skin.  \"<i>Bloody hell,</i>\" she mumbles vaguely, either stone-sober or drunk from the sight of it.");
            ...
            //(else if cock fit 32)
                ...
                //[(multicock)]
                if (this.player.cockTotal() > 1)
                    this.outputText("separating out and ");
                ...
                //(else lib >= 25)
                    ...
                    if (this.player.isTaur())
                        this.outputText(", pushing your legs apart");
                    ...
                    if (!this.player.isTaur())
                        this.outputText(", and your hands go to her waist, fairly pushing her up and slamming her back down in your eagerness");
                    ...
                    //(PC corr >= 90 or > sheila corruption)
                    if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption())
                        this.outputText("You can feel her cum-slick inner walls pulling at you as she begins to orgasm, and your mind clears as you blow your load inside her, wondering when she'll likewise return to sense.");
                    //(else PC corr < sheila corruption)
                    else if (this.player.cor < this.sheilaCorruption())
                        this.outputText("Her pussy gushes with her orgasm, pushing out your semen and soaking her inner lips even as she continues riding your cock, and your mind clouds as you think of little except sneaking as much of your cum inside her as possible.");
                    //else equal but < 90)
                    else
                        this.outputText("Even as she comes mindlessly something makes you hold in your own moans, wondering how long it will take her to notice her pussy being filled with your egg-hunting sperm.");
                    //[(small cum)]
                    if (this.player.cumQ() <= 250) {
        ...
        sheilaForcedOralGeneric() {
            ...
            if (this.player.hasCock())
                this.outputText("her hand slips around your [cock]");
            else if (this.player.hasVagina())
                this.outputText("her fingers slip between your labia");
            else
                this.outputText("she rubs your bare crotch for a few seconds");
            ...
            if (this.player.str < 61)
                this.outputText("; her weight bears you slowly to the ground");
            ...
            if (this.player.hairType == 4)
                this.outputText(" and flushing as your stingers release their payloads into her palm");
            this.outputText(".  You obediently stick out your tongue");
            if (this.player.cor > 60)
                this.outputText(", motivated more by whimsy than the meager, almost playful pain,");
            ...
            if (this.player.cor >= 90 || this.player.cor > this.sheilaCorruption()) {
                ...
                //[(demon/dragon tongue)
                if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                    this.outputText("  As tired as you are, you simply go along with it, allowing her rippling walls to slowly draw your tip deeper inside until it bumps against her cervix; she shivers and kisses the top of your head as you groggily run your tongue over the entrance to her womb.");
                else
                    this.outputText("  However, it doesn't get very far; you lazily flop it around inside her as she works through her arousal.");
            ...
            //(else PC corr < sheila corruption)
                ...
                if (this.player.hasCock())
                    this.outputText("face-fucking her and blowing a load into her mouth, then holding her jaw shut until she swallows it unhappily.");
                else if (this.player.hasVagina())
                    this.outputText("smearing your gash on her face until you come and drown her in your squirting girl-jizz.");
                else
                    this.outputText("forcing her to tongue your asshole until you come, writhing and pressing her head into the grass with your [butt].");
            }
            else
                this.outputText("and she pets your head affectionately as her walls squeeze your tongue.  \"<i>Oh, mate...</i>\" she whispers lovingly, completely forgetting the struggle that led to your tryst.");
            ...
            //[(str < 61)
            if (this.player.str < 61)
                this.outputText("climbing off and kneeling next to you.");
            else
                this.outputText("letting herself down your body until she can put her long legs on the ground once more.");
        ...
        normalSheilaPregNotifNumberOne() {
            ...
            if (this.player.cor < 50)
                this.outputText("  A hand placed around her shoulder seems to steady her a bit.");
        ...
        normalSheilaPregNotifNumberOneYepIssue() {
            this.clearOutput();
            ...
            this.flags[kFLAGS_1.kFLAGS.SHEILA_DISABLED] = 2;
            this.flags[kFLAGS_1.kFLAGS.SHEILA_JOEYS]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[Normal Preg Notif #1 - Nah]
        normalSheilaPregNotifNumberOneCoolDeal() {
            this.clearOutput();
        ...
        normalSheilaPregNotifREPEATEDED() {
            ...
            if (SheilaScene.rand(10) < 7)
                this.outputText("healthy.  It's eating a lot... frankly, it's a little hellraiser with a strong grip, and it cries well, too.</i>\"");
            else
                this.outputText("weak... we thought we were going to lose it for a bit.  It wouldn't drink from the nurse unless I was there, so I had to stay up with it all night myself.  Feeling a bit stuffed.</i>\"");
            this.outputText("  She looks over at you, giving you the benefit of her fatigue-lined eyes.");
            this.outputText("\n\nSheila slips her hand into yours");
            if (this.player.cor < 40)
                this.outputText(", and you give it a squeeze");
            ...
            if (this.sheilaCorruption() > 80)
                this.flags[kFLAGS_1.kFLAGS.SHEILA_CORRUPTION] = 80;
            this.menu();
            //[Help(requires >80 speed, centaur >= 5', naga, or big wings and archery)][Walk With Her][Let Her Go]
            if ((this.player.spe > 80 && this.player.findPerk(PerkLib_1.PerkLib.Runner) >= 0) || (this.player.isTaur()) || this.player.isNaga() || (this.player.canFly && this.player.hasKeyItem("Bow") >= 0))
        ...
        normalSheilaPregNotifREPEATEDEDLetHerGo() {
            this.clearOutput();
            ...
            if (this.player.cor < 40)
                this.outputText(", imploring her to eat the rest and keep up her strength");
        ...
        normalSheilaPregNotifREPEATEDEDWalkWithHer() {
            this.clearOutput();
            ...
            if (!this.player.isNaga())
                this.outputText("walk");
            else
                this.outputText("slither");
        ...
        normalSheilaPregNotifREPEATEDEDHelpABitchOut() {
            this.clearOutput();
            ...
            //(else spd >= 80 and Runner perk)
            else if (this.player.spe >= 80 && this.player.findPerk(PerkLib_1.PerkLib.Runner) >= 0) {
                ...
                if (this.player.lib < 50)
                    this.outputText("you pinch her ear, provoking an annoyed flick from it.");
                else
                    this.outputText("you slap her on the ass, grabbing a handful and taking her mind off her own misery.");
            ...
            if (this.model.time.hours + 4 < 21)
                ...
                if (!(this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_LEVEL] >= 4 && this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_KILLED] == 0) && !this.vapulaSlave())
        ...
        normalSheilaPregNotifREPEATEDEDHelpABitchOutANDWELP() {
            this.clearOutput();
            this.outputText("\"<i>Welp,</i>\" you say softly.");
            //[(corr <50)
            if (this.player.cor < 50)
                this.outputText("  You set a hand on Sheila's shoulder to steady her a bit as the tears start to fall.");
        ...
        normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE() {
            this.clearOutput();
            ...
            if (this.player.isNaga())
                this.outputText("coil");
            else
                this.outputText("seat");
            ...
            if (this.player.isGoo()) {
                ...
                if (this.player.lib >= 40)
                    this.outputText("  The leer you display is so prurient that she seems on the verge of reconsidering, but you compose yourself and");
                else
                    this.outputText("  You");
            ...
            //(naga)
                ...
                if (this.player.lib >= 40)
                    this.outputText(" - but tighten the one sliding across her breasts just slightly.  Sheila's neck turns red and her ears twitch as you rub her nipples, and you plant a kiss on her nape");
                this.outputText(".  \"<i>Ahh,</i>\" she sighs, shifting in your coils.  \"<i>Hold it right there...</i>\"");
                //(apply libido-based lust damage if lib >= 40)
                if (this.player.lib >= 40)
                    this.dynStats("lus", this.player.lib / 4, "resisted", false);
            }
            //(horse and >=5ft)
                ...
                if (this.player.sens >= 40)
                    this.outputText("... or would be, if you weren't distracted by the nipples poking into you and the thighs squeezing your flank");
                this.outputText(".");
                //(apply sens-based lust damage if sens >=40)
                if (this.player.sens >= 40)
                    this.dynStats("lus", this.player.sens / 4, "resisted", false);
            }
            //(harpy - minimum score for birdlegs at least)
            else if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_HARPY && this.player.tailType == appearanceDefs_1.TAIL_TYPE_HARPY) {
            ...
            //(bees with boots)
            else if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_BEE) {
            ...
            if (!this.player.isTaur())
                this.outputText("  She grudgingly repositions, allowing you to rest against her.");
            this.model.time.days++;
        ...
        normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDERE2() {
            this.clearOutput();
            ...
            if (this.player.isGoo())
                this.outputText("; she's already dressed and appears to have just been outside");
            this.outputText(".");
            ...
            if (this.player.lust < 30)
                this.outputText("  You give her a hand, then help her load up.  She gives you a peck on the cheek before she departs.  \"<i>Thanks, love.</i>\"");
            if (this.player.lust >= 30) {
        ...
        normalSheilaPregNotifREPEATEDEDHelpABitchOutANDSTAYDEREBUTLEAVEHERBE() {
            this.clearOutput();
        ...
        normalSheilaPregNotifREPEATEDEDHelpABitchOutTOCAMP() {
            this.clearOutput();
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DefenseCanopy) >= 0)
            ...
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.JojoNightWatch) >= 0 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.PureCampJojo) >= 0) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_WATCH] > 0)
            ...
            if (this.player.inte >= 60)
                this.outputText("\"<i>The baby will be fine,</i>\" you venture, hazarding a guess.  \"<i>It's what the nurses are there for.</i>\"");
            else
                this.outputText("You slip an arm around her, and ask if she's okay.");
            this.outputText("  She nods mutely and pulls the food out of the fire.");
            //[(if Jojo present)
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.JojoNightWatch) >= 0 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.PureCampJojo) >= 0)
                this.outputText("  She extends one bird to you and another to Jojo.  He raises his hand and shakes his head, but politely.");
            else if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_WATCH] > 0)
                this.outputText("  Sheila offers you one of the birds, then extends another to your odd tenant.  The anemone's mouth tightens and she shakes her head vigorously, blushing a deep blue.");
            ...
            //[(if no watch)
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.JojoNightWatch) < 0 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.PureCampJojo) < 0 || this.flags[kFLAGS_1.kFLAGS.ANEMONE_WATCH] == 0)
        ...
        sheilaGoesDemon() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_XP] < -2)
                this.outputText("always so bloody eager to fuck me!");
            else
                this.outputText("me best mate!");
            ...
            if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                this.outputText("extending your oral muscle until it's all the way to the back of her pussy.  ");
            else
                this.outputText("but only manage to scrape her entrance; she shudders and seems satisfied with that, judging by what she says next.  ");
        ...
        demonSheilaEncounter() {
            ...
            if (this.player.lust >= 33)
                this.addButton(1, "LetHerFuck", this.sheilaLetHerFuckYou);
        ...
        demonSheilaResist() {
            ...
            //[(sheila corruption < 30)
            if (this.sheilaCorruption() < 30)
                this.outputText(" thrusts her black spade forward and smears some of the constantly-oozing fluid from its tip down the length with her hand");
            else
                this.outputText(" kneads her breasts seductively, pinching her nipples");
            this.outputText(".  Your posture softens a bit as she reaches out to you");
            if (this.sheilaCorruption() < 30)
                this.outputText(", tilting her palm to dribble a handful of strong-scented dark oils");
        ...
        demonSheilaTalk() {
            ...
            //[(not horse)
            if (!this.player.isTaur())
                this.outputText("takes your arm in hers, then slips the other hand into your armor");
            //[(horse)
            else
                this.outputText("between your legs");
            ...
            if (this.player.hasCock())
                ...
                this.outputText("smooth skin");
            //[(lib <20)
            if (this.player.lib < 20)
                this.outputText(", giggling as your expression petrifies");
        ...
        askDemonSheilaAboutDahChange() {
            this.clearOutput();
            //[(if sheilacite >= 1)]
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CITE] >= 1) {
                ...
                if (this.player.hasCock())
                    this.outputText(", and you feel a monument of your own being erected");
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.SHEILA_CITE] <= -1) {
        ...
        askDemonSheilaAboutHerColony() {
            ...
            if (this.player.cor >= 75)
                this.outputText("harvested that day, you sigh wistfully");
            else
                this.outputText("stolen that day, you wince");
            ...
            //[(cock)
            if (this.player.hasCock())
                this.outputText("she ties you down and rides you until she's so full of your spunk that she can push it back out just by pressing on her stomach");
            else
                this.outputText("she binds your hands and sits on you, teasing your helpless body with her oozing, throbbing spade until she comes all over you, spraying dark slimy fluid from it");
            this.outputText(".  You ");
            if (this.player.cor < 50)
                this.outputText("break eye contact, blushing");
            else
                this.outputText("stare into her shining eyes, getting hotter and hotter as the vision plays out to the very end");
            this.outputText(".");
        ...
        talkToDemonSheilaAboutWhatNow() {
            ...
            if (this.player.cor < 50) {
                ...
                if (this.player.hasCock())
                    this.outputText("my pussy");
                else
                    this.outputText("the dick I grow for you");
            ...
            if (this.player.hasCock())
                this.outputText("give them to me");
            else
                this.outputText("have them for me");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_OFFER_ACCEPTED] > 0)
                this.outputText(" save one.  Actually, the two are a bit reminiscent of each other..");
            ...
            if (this.player.cor < 50)
                this.outputText("; even though you hide it, I've seen it lurking");
        ...
        demonSheilaTalkAnotherQuestion() {
            this.clearOutput();
            //(if lust <=99)
            if (this.player.lust <= 99) {
                ...
                //(cock)
                if (this.player.hasCock())
                    this.outputText("slipping more of her finger and thumb around your penis");
                else if (this.player.hasVagina())
                    this.outputText("parting your lips more");
                else
                    this.outputText("rubbing your bare groin");
        ...
        demonImpChildren() {
            ...
            if (this.sheilaCorruption() < 40)
                this.outputText("her perky nipples rubbing into your arm as she snuggles up");
            else
                this.outputText("her enormous, pendulous breasts practically parting around you to wrap you up alongside her arms");
            this.outputText(".");
            ...
            //(if no cock)
            if (!this.player.hasCock())
                this.outputText("  Or, had...</i>\" she finishes with a frown as she reaches your bare groin.  \"<i>Where'd you leave that magnificent old fella?  I was lookin' forward to another go.</i>\"  She pulls her hand out, then leans toward you with a pout.  \"<i>I'm so horny, too...</i>\"");
            //(if cock)
            else {
                ...
                if (this.sheilaCorruption() <= 80)
                    this.outputText("with her fingers to make sure the invitation is all the way open");
                //(else)
                else
                    this.outputText("with her split tail while she cradles her massive tits to make sure you see the open invitation");
            ...
            this.pregnancy.knockUpForce(); //Clear Pregnancy
            this.flags[kFLAGS_1.kFLAGS.SHEILA_IMPS]++;
        ...
        pregDemonSheilaOtherSex() {
            ...
            if (this.player.hasCock()) {
                ...
                if (this.sheilaCorruption() >= 80)
                    this.outputText("heaves onto her feet, heavy breasts swaying");
                else
                    this.outputText("nimbly hops to her clawed feet");
        ...
        pregDemonSheilaKnockUp() {
            ...
            this.menu();
            if (this.player.cockThatFits(56) >= 0)
                this.addButton(0, "Next", this.missionaryForThePurposesOfCreatingImpsWithSheila);
            else
                this.addButton(0, "Next", this.bigDickAndThighs);
        }
        ...
        //Loss - normal cocks get rode (for cockarea <= 56)
        loseToNormalSheilaAndGetRidden() {
            this.clearOutput();
            // var x: number = this.player.cockThatFits(56);
            this.outputText("Sheila pushes you onto the ground");
            if (this.player.isTaur())
                this.outputText(" and you're forced to put your forelegs down for support as you come to rest on your haunches");
            else
                this.outputText(", spreading your legs.  The demon unfastens your [armor] and strips it from your bottoms easily");
            this.outputText(", exposing your " + this.multiCockDescriptLight() + ".");
            this.outputText("\n\n");
            //[(multi)
            if (this.player.cockTotal() > 1)
                this.outputText("\"<i>All of these look ripper, but... I want this one today,</i>\" she says, selecting your [cockFit 56].  ");
            ...
            if (this.player.isTaur())
                this.outputText(", draping your forelegs over her shoulders,");
            this.outputText(" presses her " + this.sheilaCup() + " breasts");
            if (this.sheilaCorruption() < 100)
                this.outputText(" against you, dragging her nipples against yours.  ");
            else
                this.outputText(" against you so forcefully that they part around your chest.  ");
            ...
            //[(multi)
            if (this.player.hasCock())
                this.outputText(" and slipping the unused remainder of your manhood between her thighs");
            ...
            if (this.player.balls > 0) {
                ...
                //(not horse)
                if (!this.player.isTaur())
                    this.outputText("  Sheila takes your face in her hands and presses it into her breasts as she reassures you.");
                ...
                if (this.player.isTaur())
                    this.outputText("forelegs");
                else
                    this.outputText("hands");
                ...
                //(normal skeet)
                if (this.player.cumQ() < 250)
                    this.outputText("ten minutes and two");
                //(big skeet)
                else if (this.player.cumQ() < 1000)
                    this.outputText("thirty minutes and four");
                else
                    this.outputText("fifty minutes and eight");
            ...
            //(else if no balls)
                ...
                if (this.player.isTaur())
                    this.outputText("You force her downward with your forelegs to");
                else
                    this.outputText("You grab her hips and");
                ...
                //[(big skeet)
                if (this.player.cumQ() >= 1000)
                    this.outputText("; she quickly reaches capacity and pulls off, jerking your messy, slimy [cockFit 56] and letting you squirt the last of your strokes all over her face and chest");
                if (this.player.cumQ() >= 6000)
                    this.outputText(".  So much is left that she's practically underwater by the time you're finished; she giggles and bubbles form in the oozing liquid covering her lips");
                this.outputText(".");
        ...
        //Loss - tail-spade sounding for fuckhueg cock (for cockarea > 56)
        tailSpadeSoundingForFuckHugeDongsWithDemonSheila() {
            this.clearOutput();
            ...
            if (this.player.cockTotal() > 1)
                this.outputText("; unguided, the ");
            if (this.player.cockTotal() == 2)
                this.outputText("other twitches and sprays");
            else if (this.player.cockTotal() > 2)
                this.outputText("others twitch and spray");
            if (this.player.cockTotal() > 1)
                this.outputText(" all over, coating her back, you, the grass, and anything ");
            if (this.player.cockTotal() > 2)
                this.outputText("else they happen to point at");
            if (this.player.cockTotal() == 2)
                this.outputText("else it happens to point at");
        ...
        //Loss - clit-swelling and clit-sounding or clit-anal
        clitSwellingDemonSheilaClitSoundingAnal() {
            this.clearOutput();
            //(no horse)
            if (!this.player.isTaur())
                this.outputText("Sheila places her hand in the small of your back and leans in, drawing closer to your face even as she pulls your waist inward.");
            else
                this.outputText("Sheila sets her hand atop your withers, pressing down gently as she looks into your eyes.");
            ...
            //[(not horse)
            if (!this.player.isTaur())
                this.outputText("turns around, then straddles your groin and looks over her shoulder.");
            //(Equus ferus caballus)
            else
                this.outputText("circles you until she reaches your rump, then turns around and kneels down herself, looking at you over her shoulder.");
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.balls > 0)
                    ...
                    this.outputText("the underside of your [cock biggest], before");
            }
            ...
            if (this.player.clitLength <= 6)
                this.outputText("lewd little");
            else
                this.outputText("grotesque");
            ...
            if (this.player.clitLength > 6)
                this.outputText(", taking it several inches deep");
            ...
            if (this.player.clitLength <= 6)
                ...
                this.outputText("Though you're by now accustomed to the sight of your clitoris, more like a cock than a dainty feminine bump, this is something else altogether!  The huge thing poking into her tail is almost twice the thickness of the slim growth you remember and bulges with blood vessels; as you watch it, transfixed, a trickle of Sheila's oily, dark secretion slides down it, then is absorbed into some flesh near your groin, adding another layer of width with a pulse!");
            ...
            if (this.player.clitLength <= 6) {
                ...
                if (!this.player.isTaur())
                    this.outputText("Taking your face into her hand, she closes your jaw and then leans in to plant a kiss on your chin.");
                else
                    this.outputText("Her eyes glitter with mirth.");
                ...
                //[(horse)
                if (this.player.isTaur())
                    this.outputText(" through the grass");
                else if (this.player.biggestTitSize() >= 1)
                    this.outputText(" between your " + this.allBreastsDescript());
                else
                    this.outputText(" along your flat chest");
                this.outputText(".  \"<i>Ffuck, even your girl parts are amazing.</i>\"  Sheila plants kiss after kiss on your ");
                if (!this.player.isTaur())
                    this.outputText("[chest]");
                else
                    this.outputText(this.buttDescript());
                ...
                if (this.player.cor < 50) {
                    ...
                    if (this.player.wetness() >= 4)
                        this.outputText("demon's legs");
                    else
                        this.outputText("grass");
                ...
                //(else PC corr>=50)
                    ...
                    if (this.player.wetness() >= 4)
                        ...
                        this.outputText("copiously soaking");
            ...
            //(else if clit >6" initially)
                ...
                //[(horse)
                if (this.player.isTaur())
                    this.outputText(" and rolls onto her back");
                ...
                if (this.player.clitLength <= 12)
                    this.outputText("all of it is in her bowels and her hot cunt rests against yours");
                else
                    this.outputText("she's taken as much as she can");
                ...
                if (this.player.clitLength <= 12)
                    this.outputText("Her hips shift, dragging her lips across yours and stirring your clit through her asshole even as it squeezes you; your pussy twitches at the stimulation.");
                else {
                    ...
                    if (this.player.hasVirginVagina())
                        this.outputText("  \"<i>What's this?</i>\" Sheila teases.  \"<i>Why, your virtue is still intact, little girl!  I wouldn't want anything to happen to it!</i>\"  She pulls her tails out a bit, contenting herself with simply teasing your lips and driving you mad for penetration.");
                ...
                //(not naga)
                if (!this.player.isNaga())
                    this.outputText("your thighs, spreading your [legs] wide and then hooking them over top to touch ");
                ...
                //[(clit>12")
                if (this.player.clitLength > 12)
                    this.outputText("pulls her black tail free, dripping with your juice, then ");
                ...
                if (this.player.clitLength <= 12)
                    this.outputText("pussy; her smooth, small labia greedily lap at the fluid when they touch, brushing against yours and drawing further twitches and squirts.");
                else
                    this.outputText("teasing tails; they shift from stroking your labia to holding them open, allowing your pussy to squirt as it pleases.");
                ...
                if (this.player.clitLength <= 12) {
                    ...
                    if (this.player.hasVirginVagina())
                        this.outputText("  <b>You've lost your virginity!</b>");
                ...
                if (!this.player.isTaur())
                    this.outputText("her tits are covered by grass stains from her frenetic pumping.");
                else
                    this.outputText("craning around shows her that her asscheeks are completely green and wet with torn grass from slamming into you so violently and repeatedly.");
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.BigClit) >= 0)
                this.player.clitLength += .5;
            if (this.player.cor < 50) {
                this.dynStats("cor", 10);
                this.sheilaCorruption(-10);
            }
        ...
        beatUpDemonSheila(output = true) {
            if (output) {
                this.clearOutput();
                this.outputText("\"<i>Ahh, you win, mate.  I give up.</i>\"  Sheila slumps to the ground, ");
                if (this.monster.HP < 1)
                    this.outputText("and her wounds begin to close with a soft lilac glow.  \"<i>So fuckin' strong.  I don't suppose you've got any sperm for me, do you?  I'd love to have some of your kids...</i>\"  She looks at you beseechingly, gently fingering herself.");
                //(lust)
                else
                    this.outputText("frigging herself vigorously.  \"<i>Do with me what you will, lover; those were the terms.  Won't you take my body to satisfy yourself, you brute?</i>\"  The audacious woman sticks her tongue out, as if to goad you into treating her roughly.");
            }
            //[(lust < 30)]
            ...
            if (this.player.hasCock() && this.player.cockThatFits(56) >= 0)
                this.addButton(0, "Missionary", this.missionaryForThePurposesOfCreatingImpsWithSheila);
            ...
            if (this.player.hasCock() && this.player.cockThatFits(56) >= 0)
                this.addButton(1, "AnalHateFuck", this.analHateFuck);
            //Win - [Big Dick+Thighs] (usable for dicks with cockarea > 56) (all 10 of them)
            //penis envy, go!
            if (this.player.hasCock() && this.player.biggestCockArea() > 56)
                this.addButton(2, "UseHerThighs", this.bigDickAndThighs);
            //Win - [Penetration, in Spades] - for self-loathing vaginas
            if (this.player.hasVagina())
                this.addButton(3, "Clit-Fuck", this.winAgainstDemoNSheilaForVaginas);
        }
        //Win - [Missionary] - for the purpose of procreation
        //requires a cockarea <= 56
        missionaryForThePurposesOfCreatingImpsWithSheila() {
            this.clearOutput();
            ...
            if (this.player.cor < 40)
                this.outputText("Your ardor subsides a bit at her performance, but seeing your look of contrition, ");
            else
                this.outputText("Your scowl hardens at her shameless playacting, and ");
            ...
            if (!this.player.isTaur())
                this.outputText("shoulders");
            else
                this.outputText("flanks");
            ...
            //(sheila corruption >=40)
            if (this.sheilaCorruption() >= 40)
                this.outputText("and her soft breasts jiggle ");
            ...
            //[(silly)
            if (this.silly())
                this.outputText("  \"<i>Make me feel like I'm fifteen years old again and playin' with the dog-morphs in the field!</i>\"  Heavens to Betsy!");
            else
                this.outputText("  \"<i>This is what you're here for!  Don't spill a single drop!</i>\"");
            ...
            if (this.sheilaCorruption() < 40)
                ...
                this.outputText("soft");
            this.outputText(" chest against you");
            if (this.player.isTaur())
                this.outputText(" as you slump forward");
            this.outputText(".  Your cock ");
            if (this.player.cockTotal() > 1) {
                this.outputText(" and its ");
                if (this.player.cockTotal() == 2)
                    this.outputText("brother");
                else
                    this.outputText("brethren");
                this.outputText(" swell and squirt");
            }
            else
                this.outputText("swells and squirts");
            this.outputText(", pouring your semen into Sheila's ravenous pussy");
            if (this.player.cockTotal() > 1)
                this.outputText(" and coating her crotch with a glaze of white");
            this.outputText("; her eyes glow and it briefly feels as though her body is sucking the ejaculate right out of you");
            if (this.player.cumQ() >= 500)
                this.outputText(", until she fills up and the rest of your orgasm is drooled out at its own lazy pace");
            this.outputText(".  She kisses you");
            if (this.player.isTaur())
                this.outputText("r forelegs");
            this.outputText(" lovingly and deeply");
            if (this.player.cockTotal() > 1 || this.player.cumQ() >= 500)
                this.outputText(" as the spare seed dribbles from her crotch");
            this.outputText(", then breaks away and looks up into your face.");
            this.outputText("\n\n\"<i>[name], you ");
            if (this.player.cumQ() >= 500 || this.player.cockTotal() > 1)
                this.outputText("spilled some.  I can't have your baby if you're fucking the grass.  And you ");
            ...
            //(else if RNG doesn't end scene)
                ...
                //(if vag)
                if (this.player.hasVagina())
                    this.outputText(" as her imp spawn take turns doing the same to you from behind");
                else
                    this.outputText(" as her imp spawn gather around, stroking themselves and occasionally squirting their hot, tainted cum on her body or yours as orgasm takes them");
                this.outputText(".  ");
                if (this.player.lib < 40)
                    this.outputText("Shocked");
                else
                    this.outputText("Flushing hotly");
                ...
                this.outputText("\n\nIt's too much.  ");
                if (!this.player.isTaur())
                    this.outputText("You kiss Sheila on the lips, pushing your tongue through to play with hers, as your arms push your spent body into position to thrust again.");
                else
                    this.outputText("You reach down with a hand and place it alongside Sheila's face; her ear twitches as she looks at you brightly, and for a moment you recapture your earlier impression of her as a sweet, devoted lover.  Your legs struggle to push your equine bulk upwards as you return to a thrusting position, dragging her groin into the air by your erect cock.");
                ...
                if (this.player.cumQ() >= 500)
                    this.outputText("; you nearly manage to fit it all into her this time, with your production still flagging from the last session");
                this.outputText(".  Muscles weakening again, you lower yourself onto her once more and allow her to stroke your ");
                if (!this.player.isTaur())
                    this.outputText("back");
                else
                    this.outputText("sides");
        ...
        analHateFuck() {
            ...
            if (this.jojoScene.campCorruptJojo())
                this.addButton(1, "Call Jojo", this.analHateFucksWithJojo);
        }
        //[Demon Victory Sex - Anal Hate-fuck - Tear Her Up]
        //with own cock version - for surprise buttsex
        sheilaAnalHateFuckAGoGo() {
            this.clearOutput();
            ...
            if (!this.player.isTaur())
                this.outputText("Slipping one hand around your [cockFit 32]");
            else
                this.outputText("Straddling her");
            ...
            //(not centaur)
            if (!this.player.isTaur())
                this.outputText("grab her thrashing legs, using them for leverage as you ");
            ...
            if (this.sheilaCorruption() >= 90)
                this.outputText("; her enormous, cushiony breasts spread under her as your prick forces her weight heavily onto them");
            ...
            if (this.player.cor >= 80 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) >= 0) {
                this.menu();
        ...
        sheilaAnalHateFuckAGoGoNO() {
            ...
            if (this.player.cumQ() >= 500)
                this.outputText("  Your overproduction floods her insides, and Sheila groans as it begins to leak back out, drooling over her pussy.  \"<i>Hey, you got your wish,</i>\" you tease.  The wanton woman tries to tilt her ass higher, to tip more of your overflow into her cunt, but you laugh and slap her hard on the hip, sending her to one knee again.");
            ...
            if (this.player.cumQ() < 250)
                this.outputText("trickle");
            else if (this.player.cumQ() < 1000)
                this.outputText("stream");
            else
                this.outputText("waterfall");
        ...
        sheilaAnalHateFuckAGoGoGETYOUSOMEWORMS() {
            this.clearOutput();
            this.outputText("\"<i>Mmm...</i>\" you answer, noncommittally.  Your ");
            if (this.player.balls > 0)
                this.outputText("[balls]");
            else
                this.outputText("insides");
            ...
            this.flags[kFLAGS_1.kFLAGS.SHEILA_DISABLED] = 3;
            if (this.getGame().inCombat)
                this.cleanupAfterCombat();
            else
                this.doNext(this.camp.returnToCampUseOneHour);
        ...
        analHateFucksWithJojo() {
            ...
            if (this.sheilaCorruption() < 40)
                this.outputText("\"<i>What's with these tiny titties?  Could any man possibly be aroused by your bug bites?  I've seen bigger breasts on incubi!</i>\"");
            else
                this.outputText("\"<i>These disgusting sacks of fat on your chest... are you under the impression that men like giant stretch marks and nipples that hang to your knees?  Why don't you get in shape, you messy bitch?</i>\"");
        ...
        jojoRuinsTheAnalHateFuck(clear = true) {
            if (clear)
                this.clearOutput();
            else
                this.outputText("\n\n");
            ...
            if (this.sheilaCorruption() >= 90)
                this.outputText(", mashing her tits together as they thicken");
            ...
            if (this.sheilaCorruption() >= 40)
                this.outputText("Her breasts tighten up, shedding cup sizes rapidly; t");
            else
                this.outputText("T");
            ...
            this.flags[kFLAGS_1.kFLAGS.SHEILA_DISABLED] = 4;
            this.flags[kFLAGS_1.kFLAGS.JOJO_DEAD_OR_GONE] = 1;
            if (this.getGame().inCombat)
                this.cleanupAfterCombat();
            else
                this.doNext(this.camp.returnToCampUseOneHour);
        ...
        bigDickAndThighs() {
            ...
            if (!this.player.isTaur()) {
                ...
                if (this.player.cockTotal() > 2)
                    this.outputText(" one at a time, practically stacking them atop each other");
                this.outputText(".");
            }
            //(horse)
            else {
            ...
            if (this.player.cor < 40) {
                ...
                if (!this.player.isTaur() && this.player.tallness >= 60)
                    this.outputText("She unbends and kisses you on the cheek, and your face feels a bit fuzzy where her lips touch.  ");
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText("your dick with both");
                else
                    this.outputText("a prick in each");
            ...
            //(else corr >= 40)
                ...
                if (this.player.cockTotal() > 1) {
                    ...
                    if (this.player.cockTotal() == 2)
                        this.outputText(", you slide it through her legs between your first cock and her cunt, plowing through her entrance like a furrow; she quakes and you can feel it contracting against your skin.  ");
                    else
                        this.outputText("s, you push them through the woman's legs one by one, smearing warm precum on her thighs as you do; her pussy squeezes against the top of your [cock biggest] as you coat her skin with your fluids.  ");
                }
                else
                    this.outputText("\n\n");
            ...
            if (this.player.cockTotal() > 2)
                this.outputText("relinquish your other pricks and ");
            if (this.player.cockTotal() == 2)
                this.outputText("relinquish your other prick and ");
            ...
            //[(sheila corruption < 50)
            if (this.sheilaCorruption() < 50)
                this.outputText("  Though her modest breasts can't even begin to encompass your girth, Sheila rubs her cleavage along your skin with gusto while she works your tip with her tongue.");
            else if (this.sheilaCorruption() < 150)
                this.outputText("  Her large " + this.sheilaCup() + " breasts encompass your girth easily, and she pushes the soft, flushed skin together as she slides it up and down your cock.");
            else {
                ...
                if (this.player.cockTotal() > 1)
                    this.outputText(" built for " + SheilaScene.num2Text(this.player.cockTotal()) + " pricks");
                this.outputText(".");
            }
            ...
            if (!this.player.hasVagina())
                this.outputText("to grow a nice pussy for me so that ");
        ...
        //Win - [Penetration, in Spades] - for self-loathing vaginas
        winAgainstDemoNSheilaForVaginas() {
            this.clearOutput();
            this.outputText("You drop onto the woman's lap without hesitation, ");
            if (!this.player.isTaur())
                this.outputText("mauling her tits roughly with your hands, ");
            this.outputText("and grind your pussy desperately against her midriff.  She slips two fingers into you obligingly, but you ");
            if (!this.player.isTaur())
                this.outputText("grab her face, plunging one thumb into the corner of her mouth in your haste, and");
            else
                this.outputText("turn your head and");
            ...
            if (!this.player.isTaur()) {
                ...
                //[(tail or naga)
                if (this.player.tailType > appearanceDefs_1.TAIL_TYPE_NONE && this.player.isNaga())
                    this.outputText(" and raise your tail");
            }
            else
                this.outputText("clamber to your hooves and bend your forelegs");
            ...
            if (this.sheilaCorruption() > 0)
                this.outputText(", squashing her tits into you");
            ...
            if (!this.player.isTaur())
                this.outputText("neck");
            else
                this.outputText("withers");
            ...
            //[(lib <20)
            if (this.player.lib < 20)
                this.outputText("even as proud as you are, ");
            ...
            if (this.player.cor < 50) {
                ...
                if (this.sheilaCorruption() > 0)
                    this.outputText("; her tits wobble violently as she thrusts, and then still as she arches her back and jams her spade all the way in");
    ...
    exports.SheilaScene = SheilaScene;
});
//# sourceMappingURL=SheilaScene.js.map