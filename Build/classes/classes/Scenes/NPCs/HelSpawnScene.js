define(["require", "exports", "./NPCAwareContent", "../../GlobalFlags/kFLAGS", "../../PregnancyStore", "../../StatusAffects", "../../../../includes/appearanceDefs", "./Helspawn", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, kFLAGS_1, PregnancyStore_1, StatusAffects_1, appearanceDefs_1, Helspawn_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class HelSpawnScene extends NPCAwareContent_1.NPCAwareContent {
        ...
        championRef() {
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                return this.player.mf("Daddy", "Mom");
            else
                return this.player.short;
        }
        helspawnFollower() {
            return this.flags[kFLAGS_1.kFLAGS.HELSPAWN_AGE] == 3;
        }
        helPregnant() {
            return (kGAMECLASS_1.kGAMECLASS.helScene.pregnancy.isPregnant);
        }
        //Hel’s New Appearance Screen: Taking Things Into Account
        heliasAppearanceScreen() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("Hel the salamander stands seven feet tall, with pale skin and thick, bright-red scales covering her arms and legs, though she has a normal human torso and face.  A fiery tail swishes gaily behind her, blazing with a ");
            if (this.flags[kFLAGS_1.kFLAGS.HEL_BONUS_POINTS] < 150)
                this.outputText("bright orange glow");
            else
                this.outputText("bright white glow");
            ...
            //if Isabella is cool: 
            if (this.flags[kFLAGS_1.kFLAGS.HEL_ISABELLA_THREESOME_ENABLED] >= 1)
                this.outputText("; she’s got her blue bandanna wrapped around her head, mostly obscured by her fiery hair");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] != '') {
                this.outputText("  A dark trio of scars run down Hel’s thighs, left by " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "’s youthful claws.");
            }
            else {
                switch (kGAMECLASS_1.kGAMECLASS.helScene.pregnancy.event) {
                    ...
                    case 2:
                        ...
                        break;
                    case 3:
                        this.outputText("  Hel’s belly is starting to look fairly bloated, swelling with her child.");
                        break;
                    case 4:
                        this.outputText("  Hel’s belly is positively gravid, full of a little salamander child.");
                        break;
                    default: //She's not pregnant, check if she's ready for it
                        if (this.flags[kFLAGS_1.kFLAGS.HEL_BONUS_POINTS] >= 150)
                            this.outputText("  Hel’s long, reptilian tail is currently burning white-hot, signaling her body’s ready for motherhood.");
                }
            }
        ...
        helSpawnsAppearanceScreen() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("Your ");
            else
                this.outputText("Hel’s ");
            this.outputText("salamander daughter, " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ", stands about six-foot-six tall, with pale skin and thick, ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 1)
                this.outputText("chitin-black");
            else
                this.outputText("bright-red");
            this.outputText(" scales covering her arms and legs, though she has a normal human face and torso.  A long leathery tail swishes happily behind her, surrounded by a dim fiery aura that emits a pleasant heat, though thankfully it isn’t hot to the touch, seemingly incapable of harming you.  " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " is wearing ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] >= 50)
                this.outputText("a scale bikini, just like her mother’s");
            else
                this.outputText("a short skirt, thigh-high boots, and a sky-blue blouse, in stark contrast to her mother’s sluttier attire");
            if (this.flags[kFLAGS_1.kFLAGS.HEL_ISABELLA_THREESOME_ENABLED] >= 1)
                this.outputText(", with a brightly-colored scarf wrapped around her neck");
            this.outputText(". She has a human face, with ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("golden");
            else if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 2)
                this.outputText("bright green");
            else
                this.outputText("crimson");
            this.outputText(" eyes, girlish features, and a smattering of pale red scales on her cheeks, like freckles.  Her short, dark-red hair cuts off just below her ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 2)
                this.outputText("puppy-dog");
            else
                this.outputText("reptilian");
            this.outputText(" ears, and it’s adorned with a pretty pink bow.  She has surprisingly large hips, and a big, squishy butt behind her.  Her reptilian legs are covered with thick, dark scales, ending in short claws atop soft, leathery soles.");
            this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " has a pair of perky, palmable C-cup breasts, each with a sensitive half-inch nipple at its tip.");
        ...
        heliaBonusPointsAward() {
            this.flags[kFLAGS_1.kFLAGS.HELIA_KIDS_CHAT] = 1;
            this.spriteSelect(68);
            this.outputText("\n<b>That night...</b>\n");
            ...
            if (this.camp.companionsCount() == 1)
                this.outputText("You cock an eyebrow, saying that you're already alone, but she shakes her head, saying she needs somewhere private, away from prying eyes.  ");
            ...
            if (this.player.hasVagina() && this.player.hasCock())
                this.outputText(" and your [chest] and your [vagina]");
            if (!this.player.hasCock() && this.player.hasVagina())
                this.outputText(" [vagina] and [chest]");
            this.outputText(" and everything else about you.  But... but that doesn't mean anything.  It doesn't.  I say I love minotaur dicks, and centaurs, and those two fox pricks at the bar filling both my holes, and I love beer and fighting and ramming my tail up peoples' assholes.  But that's not real love, right?  Love is - oh, god, I'm making a mess of this.  Again. I keep doing this; it always works out so much better in my head.</i>\"");
        ...
        //No
        noYouDontLoveHeliaYouMonster() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("As much as you enjoy the sex, as much as you like Hel, you can't say you feel that way towards her.  You grasp her shoulders, telling her as gently as possible how you feel.  She nods slowly as you speak, rubbing at her eyes by the time you're finished.");
            ...
            //[HelLove to NO]
            this.flags[kFLAGS_1.kFLAGS.HEL_LOVE] = -1;
            this.heliaLoveFollowup();
        }
        //Yes
        yesHeliaILoveYourButtHoleReaming() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("Smiling, you tell her yes.  The salamander cries out with joy, jumping into your arms and kissing you, squeezing you so tightly that you feel like you're about to black out by the time she breaks the kiss, stepping back with chest heaving.");
        ...
        heliaLoveFollowup() {
            ...
            //If HelLove = No:
            if (this.flags[kFLAGS_1.kFLAGS.HEL_LOVE] == -1)
                this.outputText("Even if you don't love me, you'd love our child, right?  You can fuck me full of kids, or even... even get someone else to, I don't care.  I just </i>need<i> it, [name].  More than anything else in the whole wide world.");
            else {
                this.outputText("I love you, [name].  I love you so much.  I want to share this with you.  ");
                if (this.player.hasCock())
                    this.outputText("You'll fuck me full of kids, right?  Please?  Give me your seed, [name].  Give it all to me until I'm fucking gravid with your salamander babies.");
                else
                    this.outputText("Even if you can't fuck me full of babies... you could grow a dick!  There's plenty of things in this god-forsaken world that do that. O-or if you don't want to, I bet I can get one of the fox-girls, or a minotaur, or something.  You know I can find a dick somewhere, just say the word.");
            }
            this.outputText("  So what do you say, [name]?  Let's have a kid!</i>\"");
            this.menu();
            if (this.player.hasCock() && this.player.cockThatFits(this.helFollower.heliaCapacity()) >= 0)
                this.addButton(0, "Have A Kid", this.haveAKid);
            else if (this.player.hasCock())
                this.outputText("  <b>Unfortunately, you're too big to squeeze inside Helia to do the business yourself.  You might need to shrink down some.</b>");
        ...
        haveAKid() {
            this.clearOutput();
            this.spriteSelect(68);
            kGAMECLASS_1.kGAMECLASS.helScene.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, PregnancyStore_1.PregnancyStore.INCUBATION_SALAMANDER);
            this.outputText("You tell Hel that you're in this with her, that you want to give her that child she seems so desperate for.  She beams at you, smiling from eye to eye before leaping into your arms, pressing her lips hard to yours.  You kiss her back, wrapping your arms around her hips to support her as her powerful legs wrap around your waist; you push her up against the ruined wall, hands searching across her taut, hot flesh until you toss her bikini top aside, letting her hefty tits free.  \"<i>Oh god yes,</i>\" she moans as you trail kisses from her lips, down her neck to her stiffening nipple.  \"<i>I want this so much, more than anything.  Give it to me, [name].  Don't hold back!</i>\"  Your fingers sink into her pliant flesh as you suckle on her exposed teat, groping her other tit and soft ass as she moans and squirms in your arms.  Clumsily, Hel's claws brush down your body, peeling off your [armor] until your " + this.cockDescript(0) + " flops into her lap.  She locks her scaled fingers around your manhood, roughly stroking you until you're stiff as diamonds in her grasp.");
            this.outputText("\n\nYou shudder as her fingers work your " + this.cockDescript(0) + ", but don't let up on your end for a second.  You brush and knead Hel's nipple between your teeth, letting your hands drift down to her wide hips and gropable ass, slowly stripping her of her scale bottom and pulling it off her legs.  With your lover bare and naked, you slip down between her legs, letting her hook them over your shoulder to give you a good view of her dripping cunt.  Your tongue laps across her labia, drawing a long, lewd moan from Hel.  She runs her fingers through your [hair], urging you onward; at her lusty moans, you dig in, sucking on her prominent clit and drilling your tongue between her inner folds.  You gasp into her when Hel's lengthy tail wraps around your shoulders, the pale flame soothingly warm on your " + this.player.skinFurScales() + " as her leathery appendage works its way down to the " + this.cockDescript(0) + " dangling between your [legs].  You groan with sudden need as the tip of her tail brushes your most sensitive flesh, tickling ");
            if (this.player.balls > 0)
                this.outputText("your [balls]");
            else
                this.outputText("the base of your prick");
            this.outputText(" before coiling around the shaft with serpentine dexterity.  Her tail contracts and squeezes, undulating across your " + this.cockDescript(0) + " until it finally massages a thick blob of pre from your " + this.player.cockHead() + ", dribbling out to stain the wasteland ground.");
            this.outputText("\n\nSuddenly, Helia grabs your shoulders and shoves you down.  You flop onto your back, tail-encased prick standing straight up like a flagpole as Hel straddles your [hips], vigorously fingering herself as her tail lines your cock up with her drooling womanhood.  Your breath catches as your " + this.player.cockHead() + " brushes her boiling juices, slickening your entry as she slides down your pole.  You grab Hel's flared hips, guiding her in as she envelopes your " + this.cockDescript(0) + " in the roiling inferno inside her.  Her tail unravels from around your throbbing shaft as she descends, tantalizingly slowly; she takes the better part of a minute before her groin is cozily joined to yours, her hungry maw kissing the very base of your lusty prick.");
            ...
            if (this.player.biggestTitSize() <= 2)
                this.outputText("supports her, pressing down on your [chest]");
            else
                this.outputText("gropes one of your tits, kneading your tender breasts under you squirm underneath her, unable to hold in your pleasured little gasps");
            this.outputText(".  Slowly, your salamander lover starts to grind her hips on your " + this.cockDescript(0) + ", her muscles contracting and squeezing the rigid shaft inside her with every shift of her hips.  You both moan aloud, half-lost in a miasm of pleasure.  \"<i>God, I wish I could stay like this forever,</i>\"  Hel whispers, just on the edge of hearing.  \"<i>There's no one I'd rather be with, [name].  No one I'd rather have give me the child my body craves.</i>\"");
        ...
        HaveAHellKidPartII() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HEL_LOVE] == 1)
                this.outputText(", and I'm so very, very glad you love me back.");
            else
                this.outputText(", even if you can't say the same.  And that's alright; it doesn't change my heart, and it never will. I love you");
            this.outputText(".</i>\"");
        ...
        getAnotherDad() {
            ...
            if (!this.player.hasCock()) {
                this.outputText("You tell Helia you'd love to a share a child with her, but you're not... properly equipped for the endeavor.  \"<i>That's fine!  I can... I can wait, a little.  I-if you want to go grow one, I mean.  If not, then we can find someone with a cock.  ");
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.TelAdre) >= 1)
                    this.outputText("There's Miko and Mai from the bar.  Mai's said she wanted a kid, but can't take care of one... she'd probably be willing to fuck one into me!  If that's not alright, then... lemme think.  ");
                this.outputText("Uh, maybe not a minotaur... they always plug more minotaurs, and I don't want a bull coming out of my twat.  Uh, maybe I could track down one of the spider boys from the swamp and jump on </i>his<i> dick.  They're pretty cute, right?  Dunno how that'd affect a child, though.  Maybe he'd end up with like, extra eyes, or chitin?  Still, better than an imp or some shit.  So what do you think?  Wanna grow a dick, or leave the knocking-up to someone else?</i>\"");
                //{Options in next section}
            }
            //[Another Dad] (PC has a dick)
            else {
                this.outputText("\"<i>W-wha?</i>\" Hel says, cocking an eyebrow.  \"<i>You sure, [name]?  I-if you don't want to be the dad, I guess I understand.  But why?  Am I not... no, nevermind.  I don't want to know.  Okay, uh, we can find someone with a cock.  ");
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.TelAdre) >= 1)
                    this.outputText("There's Miko and Mai from the bar.  Mai's said she wanted a kid, but can't take care of one... she'd probably be willing to fuck one into me!  If that's not alright, then... lemme think.  ");
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.TelAdre) >= 1)
                this.addButton(0, "Mai", this.maiWouldBeTheBestInseminator);
            //[Spiderboy]
            this.addButton(1, "Spiderboy", this.spiderboyWouldBeBestDad);
            //[I will] (If PC has a dick)
            if (this.player.hasCock() && this.player.cockThatFits(this.helFollower.heliaCapacity()) >= 0)
                this.addButton(2, "I Will", this.haveAKid);
            else if (!this.player.hasCock())
                this.addButton(2, "I Will", this.growingDicks4Hel);
            this.addButton(3, "No Or Later", this.noKidsHel);
        }
        //Mai
        maiWouldBeTheBestInseminator() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("You tell Hel that you think Mai would make a lovely father.  Helia nods her agreement, saying, \"<i>Yeah, I agree.  She's a beauty, and I'm sure our child will be stunning... you wouldn't mind if she visited, right?  I mean, you and I will be raising our kid - and he'll be ours for sure - but I'm sure Mai will want to at least visit her kid.</i>\"");
            ...
            kGAMECLASS_1.kGAMECLASS.helScene.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, PregnancyStore_1.PregnancyStore.INCUBATION_SALAMANDER); //Yes, it's Mai's baby, but that's already tracked separately
            this.flags[kFLAGS_1.kFLAGS.HEL_NTR_TRACKER] = 1;
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] = 2;
            this.doNext(this.playerMenu);
        }
        //Spiderboy
        spiderboyWouldBeBestDad() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("You tell Helia to go find a spider boy to jump.  She beams at you, and skips off toward the swamp calling, \"<i>Thank you, thank you thank you, [name]!</i>\" over her shoulder as she goes.  You suppose the next time you see her, Hel's probably going to be pregnant with the child you'll be helping to raise.");
            kGAMECLASS_1.kGAMECLASS.helScene.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, PregnancyStore_1.PregnancyStore.INCUBATION_SALAMANDER); //Yes, it's the spider's baby, but that's already tracked separately
            this.flags[kFLAGS_1.kFLAGS.HEL_NTR_TRACKER] = 1;
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] = 1;
            this.doNext(this.playerMenu);
        }
        ...
        growingDicks4Hel() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("You tell Hel to give you a little while, that you'll go find something to grow a cock for her.");
        ...
        noKidsHel() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("You shake you head and say no, you don't want to have children.  Not right now, anyway.  ");
            if (this.player.hasCock() && this.player.cockThatFits(this.helFollower.heliaCapacity()) >= 0)
                this.outputText("You couldn't if you wanted to anyway - you're too big to fit.  ");
            this.outputText("As the words leave your lips, you can see Hel's shoulders slump, a crestfallen look spreading across her face.  \"<i>A-are you sure?  Please, [name], I really, really want a child.  For </i>us<i> to have one.</i>\"");
        ...
        helGotKnockedUp() {
            this.spriteSelect(68);
            this.flags[kFLAGS_1.kFLAGS.HEL_NTR_TRACKER] = 2;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 2)
                this.outputText("warm ");
            else
                this.outputText("wan ");
            this.outputText("smile as you approach, scooting over to allow you to sit beside her.  She almost seems distant, though she's quick to wrap her tail around your waist, hugging you close against her.");
        ...
        //Nah // Combine
        dontTellMeAboutSpiderboy() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("\"<i>So, let's just say I came away from that encounter carrying enough cute spiderboy cum to fill a bucket.  If I'm not carrying his child now, then I'm hopeless.  But... you know, I think I can feel it, [name].  I shouldn't be able to, but I can.  Oh, god,</i>\" Hel says, looking pointedly away from you, staring wide-eyed into the morning sky.");
            this.outputText("\n\n\"<i>What's wrong?</i>\"");
        ...
        dontTellMeAboutMai() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("\"<i>So, let's just say I came away from that encounter carrying enough foxy herm cum to fill a bucket.  If I'm not carrying her child now, then I'm hopeless.  But... you know, I think I can feel it, [name].  I shouldn't be able to, but I can.  Oh, god,</i>\" Hel says, looking pointedly away from you, staring wide-eyed into the morning sky.");
            this.outputText("\n\n\"<i>What's wrong?</i>\"");
            ...
            this.outputText("\n\nYou put an arm around the mother-to-be's shoulder, saying, \"<i>I thought this was what you wanted, Hel.  You were-</i>\"");
            this.outputText("\n\n\"<i>Yeah, I know.  Forget about it, I'm fine.  Really.  It's just that this happened all so suddenly, you know?  This isn't exactly where I saw myself a year ago.  Not that I'm complaining,</i>\" she adds, turning back to you with a kiss, squeezing you with her tail.  \"<i>I just hope I'm ready, I guess.  Until the Pale Flame took, I'd never really thought about being a mother.  Never really wanted it.  But last night, it was like I was possessed, like I couldn't control myself.  I just... needed you.  Well, maybe not your sperm - not literally, I mean - but it was like my body screaming 'You've found " + this.player.mf("him", "her") + ", " + this.player.mf("he", "she") + "'s the one, this is a keeper!  Time to propagate!'  I-I can't help but feel like this wasn't entirely my choice, you know? Like I was acting on instinct, like an animal, not a person.  But at the same time, if I've made a mistake, then I have you here with me, to help me like you always do.  I love you with all my heart, [name]");
            //if HelLove is Yes:
            if (this.flags[kFLAGS_1.kFLAGS.HEL_LOVE] == 1)
                this.outputText(", and I'm so very, very glad you love me back.");
            else
        ...
        heliaSwollenNotice() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("You note that Hel's wandering aimlessly around camp, one hand over her belly as she mumbles to herself.  You could swear she was cursing her now quite swollen belly, but suddenly she gives a girlishly happy cry and waves you over.\n");
        ...
        youWantABoy() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("\"<i>Is that so? Yeah, I can see it.  ");
            if (this.player.hasCock() && !this.player.hasVagina())
                this.outputText("If I were a guy, I'd want a big strong son to hang out with, too.  Take him fishing, teach him how to fight the way you do... you'll make a great dad, my love.  I'm sure you will.");
            else
                this.outputText("Would be nice to have a man around here, you know?  I miss hanging around the boys back home, watching 'em strut like peacocks for every passing girl.");
        ...
        youWantAGirl() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("\"<i>Yeah, a girl would be pretty great.  ");
            //if PC is male:
            if (this.player.hasCock() && !this.player.hasVagina()) {
                this.outputText("I dunno if you had any sisters growing up, [name], but let me warn you: a little girl, especially a little salamandress, is going to be a hell of a handful.  But I can just see you when she's all grown up, packing a big old sword and threatening every boy that wants a piece of her: 'Treat her right or you'll have the CHAMPION to deal with.  Rawr.'");
            }
            else
                this.outputText("We're going to be a gaggle of tittering girls before you know it, though.  Salamanders grow up so fast, [name]...  I just hope she doesn't turn out like me, you know?  I don't know if I could stomach seeing my little girl becoming a wanton slut like her mom.  I might get jealous, after all...");
        ...
        encouragePregalia() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("You squeeze Hel's shoulder and tell her that she's going to be a great mother, and that her child would do well to learn from a beautiful, powerful warrior like dear old mom.  ");
            if (this.flags[kFLAGS_1.kFLAGS.HEL_LOVE] == 1)
                this.outputText("You love Hel");
            else
                this.outputText("Hel's your friend");
        ...
        helsLifestyle() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("Being very serious for a moment, you tell Hel that if she's worried about her terrible choices rubbing off on her kid, maybe she ought to reconsider some of the things she's done: be less of a slut, drink less, be less of a bloodthirsty maniac in battle.  Slowly, Hel nods to the rhythm of your words.  \"<i>Yeah, maybe... maybe I should.  I don't know if I can change though, [name].  I'm not as young as I was - or at least, I don't feel it - and I've been living the way I have been for years.  I don't know if I could just give up the shit I do: the partying and the drinking, the fighting and the fucking.  It's part of who I am, ");
            if (this.flags[kFLAGS_1.kFLAGS.HEL_LOVE] == 1)
                this.outputText("and I hope that's part of why you love me");
            else
                this.outputText("even though I know that's probably part of why you can't love me back");
        ...
        nameDatHelspawn() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("You and Helia share a laugh, looking down at ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("your ");
            else
                this.outputText("her ");
        ...
        applyHelspawnName(input) {
            ...
            if (input.value == ""
                ...
                else if (input.value == "Kid")
                    this.outputText("\"<i>Wow, what are you, five?</i>\"");
                else if (input.value == "Phoenix")
                    this.outputText("\"<i>Oh hell no.  You're not naming my little girl after one of those... things!  Sorry Kiri, but still!</i>\"");
                else if (input.value == "Savin")
                    this.outputText("\"<i>That's a boy's name, dumbass.</i>\"");
                else if (input.value == "Helia")
                    this.outputText("\"<i>My favorite name!  Except it's kinda taken, love.  Don't want things to get too confusing around here, do you?</i>\"");
                else if (input.value == "Mini-doofus")
                    this.outputText("\"<i>Oh yeah, Kiha'll get a laugh out of that.  You ass.</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] = input.value;
            //[Name Field]
            //Easter Egg Names:
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] == "Helspawn")
                this.outputText("\"<i>That's what I was gonna call her!  Except not at all.  God dammit, seriously, [name]?</i>\"\n\n");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] == "Jayne")
                this.outputText("\"<i>That sounds like a hero's name... I like it.  A name that demands respect!</i>\"\n\n");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] == "Hesper")
                this.outputText("\"<i>Ah, the Evening Star.  She'll be the star of my life, alright...</i>\"\n\n");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] == "Kiri")
                this.outputText("\"<i>Aw, that's great, lover.  Sis'll shit her pants when she hears her niece is named after her!  Gonna get confusing, though...</i>\"\n\n");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] == "Mai")
                this.outputText("\"<i>Aw, that's great, lover.  Mai'll be honored, I know it.  And it is a great name...</i>\"\n\n");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] == "Tanis")
                this.outputText("\<i>I don't... I don't know if I want her to have that name, lover.  It's got a lot of baggage, but... but it does my mother an honor.  More than I could ever give her.</i>\"\n\n");
            //Syn: 
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] == "Syn")
                this.outputText("\"Awesome.  I was hoping you'd choose that one, lover mine.</i>\"\n\n");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] == "Chara")
                this.outputText("\"<i>Awesome.  You liked my ideas, after all!</i>\"\n\n");
            this.outputText("\"<i>So... " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " it is.  That's a good name, my love.  A strong name.  ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("Our");
            else
                this.outputText("my");
            this.outputText(" little girl's going to grow up big and strong with a name like that... and with you around to guide her,</i>\" Hel says, kissing your cheek.  \"<i>Why don't you give me a minute to catch my breath and get the little one situated, and let's talk.  Alright?</i>\"");
            this.outputText("\n\nYou nod and help Helia to her feet, still holding " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " to her breast.  Your lover gives you a wink before walking bow-legged back toward her part of camp, and the little crib she's built beside her hammock.");
            this.helSpawnsSetup();
        ...
        helSpawnsSetup() {
            ...
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] = 50;
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 2)
                this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] += 10;
            ...
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_AGE] = 1;
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_GROWUP_COUNTER] = 1;
            kGAMECLASS_1.kGAMECLASS.helScene.pregnancy.knockUpForce(); //Clear Pregnancy
            //>If the two scores tie at the end somehow, Sluttymandergirl prevails!
        }
        //Hel Talk 8 (Only while HelSpawn is still a baby)
        heliaTalkEight() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.HEL_TALK_EIGHT] = 1;
            this.spriteSelect(68);
            this.outputText("Watching your little daughter crawl around, you and Hel sit down together arm in arm, smiling as the little salamander girl plays with bits and pieces of Hel's gear.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("parental ");
            else
                this.outputText("care giver's ");
            this.outputText("pride, either.  She really is growing up faster, many times faster than a human girl.  And, by the sound of things, many times faster than a salamander ought to.  You ask Hel if that's right, and she nods gravely.");
            ...
            //If Amily is at camp: 
            if (this.amilyScene.amilyFollower())
            ...
            this.outputText("\n\nYou nod to your lover, and the both of you walk over to spend some quality time playing with " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ".");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        playWithYourKid() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("Picking " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " up off the ground, you spin the giggling little girl around, laughing as your ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] != 0)
                this.outputText("ward ");
            else
                this.outputText("daughter ");
            this.outputText("cries out in surprise and glee.  Soon, you're bouncing her, then down on the ground crawling around with her, playing peek-a-boo and a dozen other games as you and " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " laugh and hug.  Helia herself slips down with you before you know it, holding her daughter close as she tries to communicate, teaching the ever-growing girl a few words at a time.");
            this.outputText("\n\n\"<i>Mommy!</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " eventually cries, bopping her mother on the nose. Hel laughs, but it turns into a sigh as her daughter reaches down and fiddles with her top, obviously hungry.");
            this.outputText("\n\n\"<i>We've got to wean this one before she bites my tits off,</i>\" Hel groans as " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " latches on, starting to suckle.  \"<i>Those teeth came in fast...</i>\"");
            this.outputText("\n\nLaughing, you rustle " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s fiery hair and leave mother and daughter to finish the meal.");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        helSpawnGraduation() {
            ...
            this.spriteSelect(68);
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_GROWUP_COUNTER] = 1;
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_AGE]++;
            this.outputText("You wake up to a scream, high-pitched and terrified.  You bolt up out of bed, tangling up in your bedroll for a minute before stumbling over to Hel and... " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "?");
            this.outputText("\n\nYou do a double take as you lay eyes on the ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 1)
                this.outputText("black");
            else
                this.outputText("red");
            this.outputText("-scaled figure curled up next to Helia; Hel herself is looking wide-eyed down at the drowsy figure on her breast, just barely opening her eyes.  \"<i>Y-you're... you're huge!</i>\" Hel manages to gasp out, pushing herself back and away from her daughter.");
            ...
            this.outputText("\n\n\"<i>Ugh, what's wrong?</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " groans, looking up at Hel, then to you.  \"<i>" + this.championRef() + ", why's mom screaming?</i>\"");
            ...
            this.outputText("\n\nYou have to admit, the change is sudden and drastic... but the girl's scales, her eyes, they're certainly " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s.  ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 2)
                this.outputText("And the puppy ears, now more wolf-like, are a dead giveaway.  Utterly unique to her.  ");
            this.outputText("You sit down beside the obviously confused girl and stroke her hair, telling her it's all right, her mother's just startled, that's all.");
            this.outputText("\n\n\"<i>It's just me, mom,</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " says, sliding over to sit beside her mother, who's still wide-eyed with shock.  Your girl tries for a few moments to talk to Hel, but seeing that venture prove fruitless - Hel seems utterly insensate, paralyzed by shock - she instead curls back up beside her mother, head rested on Helia's shoulder.  Eventually, warily, Hel reaches out a trembling hand to brush her daughter's cheek.");
        ...
        helspawnDiscoversBooze() {
            this.clearOutput();
            this.spriteSelect(68);
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DISCOVER_BOOZE] = 1;
            ...
            if (this.player.race() != "cat-boy" && this.player.race() != "cat-girl")
                this.outputText("a cat");
            else
                this.outputText("the cat you are");
            this.outputText(", and poke your head around the iron body of the still.");
            this.outputText("\n\nFlopped down on the ground with her mouth right under the spigot is " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ", using her tail to keep the tap open and flowing into her waiting maw as she lazes beneath it.  When you loudly clear your throat, she flails around a moment, letting the tap go as she scrambles to her feet - only to fall drunkenly on her ass.  \"<i>Uh...</i>\" she groans, wiping the booze off her cheeks as she hiccups drunkenly.  \"<i>Hi there, " + this.championRef() + ".</i>\"");
            this.menu();
        ...
        scoldHelSpawn() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("You cross your arms over your chest and ask your little salamander exactly what she thinks she's doing.");
            ...
            this.outputText("\n\n\"<i>Alright, " + this.championRef() + ",</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " says, curling up beside you, head resting on your [chest].");
            //{HelspawnChaste +10}
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] -= 10;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        encourageHelspawn() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("\"<i>Move over, you,</i>\" you say, sliding down beside your little salamander as you pop the tap open again.  \"<i>Gotta pace yourself, see,</i>\" you add, taking a long draught before closing it off again, savoring the potent taste of Hel's mighty brew.");
            this.outputText("\n\n\"<i>Wha...?</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " starts to say, before catching on as you drink, inviting her to join you.");
            ...
            this.outputText("\n\n\"<i>Uh...</i>\" you groan, slumping over onto your [ass].  " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s right behind you, collapsing on top of you in a pile of ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] != 1)
                this.outputText("red ");
            else
                this.outputText("black ");
            this.outputText("scales and the smell of a burning brewery.");
            ...
            this.outputText("\n\n\"<i>I saved some for ya, mom,</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " groans, retching.");
        ...
        helSpawnChoosesAFightingStyle() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("As you make your way back to camp, you begin to hear the sounds of fighting from ahead.  Readying your [weapon], you pick up the pace until your campsite comes into view.  You relax, seeing that it's only " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " and her mother.  Helia's standing near the center of camp, ");
            if (this.camp.companionsCount() > 3)
                this.outputText("apparently having cleared out most of your other followers for the moment, ");
            this.outputText("her sword held at a guard pose between herself and a training dummy. " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " stands a few feet behind her mother, watching intently as Hel paces around the dummy, breathing hard.");
        ...
        snipermanders() {
            this.clearOutput();
            this.spriteSelect(68);
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_WEAPON] = "bow";
            this.outputText("You tell Hel to take a break: you've got this handled. Grabbing your bow and quiver from over your shoulder, you hand them over to ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("your");
            else
                this.outputText("Hel's");
            this.outputText(" eager daughter. " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " takes them up with surprising reverence, holding them as gingerly as glass.  Grinning, you clasp her shoulder and tell her how to put the quiver on, and get her stance right for shooting.  It takes her a moment to get set up: her scaled, reptilian legs don't naturally stand in the shooting pose you've adopted");
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_LIZARD)
                this.outputText(", even with your own lizard legs");
            this.outputText(", and you find yourself having to correct her grip on the haft several times.  But, finally, you get her ready to shoot.");
            this.outputText("\n\nYou slip behind " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ", putting your arms on hers as you guide her through nocking an arrow, head resting on her fist, a lone finger outstretched toward the dessicated dummy.");
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0)
                this.outputText("  You hear your old alchemist friend suddenly putting up a ruckus as the sounds of breaking glass echo throughout camp.  " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " looks up at you nervously, but you ruffle her fiery hair and tell her to try again. Rath is probably just fine.");
            //else if Valeria/Latexy is at camp: 
            else if (this.flags[kFLAGS_1.kFLAGS.VALARIA_AT_CAMP] == 1)
                this.outputText("  You hear a sudden yelp of pain from across camp. Valeria slithers up to you with an irritated look on her gooey face, pointing an accusing finger at an arrow sticking out of her tit.  \"<i>Dammit, [name], I'm a googirl, not a pin cushion!</i>\"  You wave her off, and tell " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " to try again.");
            else if (this.latexGooFollower())
                this.outputText("  You hear a sudden yelp of pain from across camp.  " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " slithers up to you with an irritated look on her gooey face, pointing an accusing finger at an arrow sticking out of her tit.  \"<i>Dammit, [name], I'm a googirl, not a pin cushion!</i>\"  You wave her off, and tell " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " to try again.");
            this.outputText("\n\n\"<i>I-I dunno, " + this.championRef() + ",</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " whines, biting her lip as she traces the arrow's path with her eyes.  \"<i>Maybe mom was right. I should just stick to a sword. That's easy....</i>\"");
            this.outputText("\n\nYou sigh and tell her to try again.  She can't expect to be perfect on the first try, after all.  It takes a little convincing, but soon you've got " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " back into form and nocking an arrow.  You put your hands on hers, helping the young salamander take aim, drawing down on her straw-stuffed target.  Barely audible over " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s nervous breathing, you whisper, \"<i>Take it easy.  Relax.... Good.  Take aim... now breathe out.  Exhale and loose.</i>\"");
            this.outputText("\n\nAgain, " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " lets an arrow fly - and this one strikes true.  You watch the missile streak across camp, slamming into the training dummy's crotch with deadly force.  It sways, buckles, and falls to pieces.");
            this.outputText("\n\n\"<i>Ouch,</i>\" Hel laughs, sipping on her flask behind you.  \"<i>What'd that poor dummy ever do to you?</i>\"");
            this.outputText("\n\n\"<i>I did it!</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " shouts, pumping her fist in the air. Her mother reaches over to ruffle her fiery hair, and you both shower her with congratulations.");
            this.outputText("\n\nBefore she can get cocky, though, you push the bow back into her hands.  \"<i>Lesson 2, kiddo: one shot is never enough.</i>\"");
            this.outputText("\n\nBy the time " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " has her shooting stance back, her mother's already set the dummy back up, ready for round two.  It's several hours long before the three of you quit: time spent drilling " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " on stance and aim, even going a round with her and a pair of daggers to remind her that enemies will eventually close in if she's not careful.  She learns quickly, though, and soon she hardly needs your help to plant an arrow in the target's chest.");
        ...
        swordAndBoardmander() {
            this.clearOutput();
            this.spriteSelect(68);
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_WEAPON] = "scimitar and shield";
            this.outputText("You tell Hel to take a break: you've got this handled.  You grab some kindling and string from your supplies, and a few minutes later you've got a pair of small, vaguely sword-like practice weapons pieces together.  Tossing one to the young salamander, you tell her to come get some.");
            this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " gives the blade a few practice swings before grabbing the wooden blade in both hands and charging at you.  You put your guard up, catching her first overhand blow and turning it aside, nearly toppling the girl over.  She rolls with it, spinning out of your guard and trying a strike from the side.  You parry it, catch an opening, and give her a nice wallop on the shoulder.  A real blade would have nearly cut her arm off, but " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " merely stumbles back, yelping in pain.");
            ...
            this.outputText("\n\nYou sigh.  \"<i>Again.</i>\"");
            this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " picks herself up and grips her blade.  This time she's a little more cautious, approaching slowly, pausing just out of reach.  You hide a grin and bring your own sword up, the tips of your blades nearly touching.  \"<i>Good.  No need to be reckless, kiddo.  Don't just charge in at the first opportunity; you'll get yourself killed.</i>\"");
            this.outputText("\n\n\"<i>Get " + this.player.mf("him", "her") + ", " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "!</i>\" Hel calls from the sidelines, sipping on a mug.  \"<i>Show " + this.player.mf("him", "her") + " what a salamander can do!</i>\"");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("\n\nYour");
            else
                this.outputText("\n\nHer");
            this.outputText(" daughter braces herself, drawing a breath just a second before she launches her attack, giving herself away.  You parry three quick blows, stepping back as " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " leaps into another overhand strike.  You dodge, spinning out of the attack and slicing her right across her bare belly.");
            this.outputText("\n\n\"<i>Gah!</i>\" she cries, stumbling to her knees.  \"<i>I-I can't...</i>\"");
            this.outputText("\n\nYou pull " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " to her feet and ruffle her hair.  \"<i>C'mon kiddo, don't give up.  Here,</i>\" you say, grabbing a dinner plate and some leather straps from your kit.  In a moment, you've got a rudimentary shield cobbled together.  You fit it over the young salamander's free arm and give her a few pointers on stance.  Nervously, she brings her makeshift shield to bear against you, fidgeting under the heft of it as you make a few slow, easy to parry swings for her to get used to it.  Steadily you pick up the pace, swinging your training sword faster and harder, forcing " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " to parry and block, retreating against your onslaught.  You keep it up for a full minute before relenting, letting the kid seize the initiative.  She swings at you, rolling with each parry you make, cleaving into another swing, turning your ripostes aside with her shield and forcing you back.");
            this.outputText("\n\nYou wince in pain as " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " manages to nick you, turning one of your blows aside with her shield and striking through the opening left in your guard.  \"<i>Alright, alright,</i>\" you laugh, rubbing your shoulder.  \"<i>Good job, " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ". You're getting the hang of that shield!</i>\"");
            this.outputText("\n\n\"<i>Thanks, " + this.championRef() + "!</i>\" the little salamander grins, hugging you.");
            this.outputText("\n\n\"<i>Alright, alright,</i>\" Hel says, grabbing the dummy sword from your hand.  \"<i>Now it's time to fight a REAL warrior, " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ". Come get some!</i>\"");
            this.outputText("\n\nIt's several hours long before the three of you quit: time spent drilling " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " on stance and parrying, trading off with Helia every few rounds to keep ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] != 0)
                this.outputText("her");
            else
                this.outputText("your");
            this.outputText(" daughter on her toes.  She learns quickly, though, and soon she hardly needs reminding to keep her shield up and stance braced against Helia's overwhelming assaults.");
            this.outputText("\n\nA few hours like this every night, and ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("your ");
            else
        ...
        dasBarbarimander() {
            this.clearOutput();
            this.spriteSelect(68);
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_WEAPON] = "scimitar";
            if (this.player.gems >= 200) {
                this.outputText("You sigh and dig out a handful of gems.  Helia beams at you, planting a quick kiss on your cheek before grabbing " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " and the loot.  \"<i>Thanks for the loan, lover mine.  C'mon, sweetie, we're going for a trip to town.</i>\"");
        ...
        helspawnIsASlut() {
            this.spriteSelect(68);
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_FUCK_INTERRUPTUS] = 1;
            ...
            if (this.player.weaponName != "fists")
                this.outputText("clutch your [weapon]");
            else
                this.outputText("ball your fists");
            this.outputText(" as the intruder passes by, ready to defend yourself and your loved ones.  The moment they're out of reach, you roll onto your [feet], looking around for signs of a massed demon attack.  Instead, you see the outline of " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " in the dying embers of the fire light, leading what looks like a spider girl by the hand toward her bed.");
            this.outputText("\n\nYou creep closer, trying to get a closer look at what your ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("daughter ");
            else
                this.outputText("ward ");
            this.outputText("is doing.  Well, it doesn't take a genius to figure that out, really, but still, you have to be sure.  You slide right up to them, just out of their lines of sight, as " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " turns around, letting the spider-kin unclasp her bra and grab her tits, squeezing the small mounds as " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " suppresses a moan, reaching back to slip a hand into the spider's crotch, grabbing her - his dick.");
            this.outputText("\n\nWell then. You suppose you ought to go stop " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " from making a whore of herself... but then again, she's old enough to make her own mistakes by now.");
            if (this.player.cor >= 50)
                this.outputText("  And by mistake you clearly mean old enough to get her ass fucked in by a cute little spider trap... you contemplate jumping in on it, but with a sigh figure it's " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s catch.  Let her enjoy it.");
            this.menu();
        ...
        helspawnDoNothing() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("You turn around and head back to your bed.  As soon as you're under your blanket, your ears are assaulted with the quiet moans and grunts of pleasure coming from " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s bed as she and her first little boyfriend get it on.  You can practically hear the tail-pegging from here.  How cute!");
            //{HelspawnSlutty +10}
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] += 10;
            this.doNext(this.playerMenu);
        }
        ...
        helSpawnStopFucking() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("You sigh and step out of the shadows, grabbing the feminine little spider boy by the shoulder and yanking him away from " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ".  \"<i>And just what the hell do you two think you're doing?</i>\" you yell, scowling ");
            if (this.player.tallness >= 90)
                this.outputText("up ");
            else if (this.player.tallness <= 72)
                this.outputText("down ");
            this.outputText("at your ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("daughter ");
            else
                this.outputText("ward ");
            this.outputText(". " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " gives a shrill cry of surprise and tumbles away from you, trying to cover herself as best she can; the spider trap squirms in your unrelenting grasp, one set of arms covering his rapidly-wilting erection as the other flails around, trying to get you off of him.  Not happening.");
            this.outputText("\n\n\"<i>You!</i>\" you say, pointing an accusing finger at " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ".  \"<i>What the hell, kid?  Who the fuck is this?</i>\"");
            this.outputText("\n\n\"<i>That's, uh.... Alex, meet ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("my dad");
            else
                this.outputText("[name]");
            this.outputText(". " + this.championRef() + ", Alex.</i>\"");
            ...
            this.outputText("\n\n\"<i>B-but I...</i>\"");
            this.outputText("\n\n\"<i>" + this.championRef() + "...</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " groans as you grab the spider boy and toss him out of camp, watching with hawk-like eyes as he slinks back to his jungle.  When he's gone, you sigh and walk over to " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ", wiping a tear from her cheek.  Putting an arm around her shoulder, you give her a long, long talk about not being a whore.");
            this.outputText("\n\n\"<i>B-but mom...</i>\"");
            this.outputText("\n\n\"<i>That's why you </i>shouldn't<i> be bringing men home.  Or women.  Or anything else, kiddo.");
            //If No Hel Love:
            if (this.flags[kFLAGS_1.kFLAGS.HEL_LOVE] != 0)
                this.outputText("  You don't want to be a whore like your mother, do you?  The girl that everyone's had a ride with.");
            //if HelLove:
            if (this.flags[kFLAGS_1.kFLAGS.HEL_LOVE] == 1)
                this.outputText("  I'm not going to a raise a whore, " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ".  Your mother's made mistakes, sure, but...</i>\" you sigh.  \"<i>");
            this.outputText("  You don't have to be that person, " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ".  Don't just give yourself out to the first person that asks, you know?  Save it for someone you really care about.  Trust me, it'll be worth it.</i>\"");
        ...
        helspawnAllGrownUp() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("You wake up the next morning, and soon find your eyes drawn to where " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " lies, barely an arm's reach from her mother's hammock, still snoring peacefully.  You sigh wistfully as you get up and get dressed, still thinking of the night before and your girl's little misadventure with the spider.  God, she's grown up fast.  Faster than you could have imagined - or her mother, for that matter.  Helia, too, is still reeling from her daughter's rapid, mutagenic growth.  But there's nothing to be done about that, now, and it seems she's reached what passes for adulthood in this strange world.  She's had the body of a woman for some time now, and it seems the mind and desires of one as well.");
            this.outputText("\n\nA part of you is sad to see her all grown up, and now you know it's time to treat your ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("daughter ");
            else
                this.outputText("ward ");
            this.outputText("like a woman.  The time to raise her, to shape her development, is over.  You can only hope you've done a good enough job to keep her safe in this hellish world; to give her sound judgment and the abilities she'll need to protect herself in the years and adventures to come.");
            this.outputText("\n\n<b>" + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " has been added to the Followers menu!</b>");
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_AGE] = 3;
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_GROWUP_COUNTER] = 0;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Helspawn’s Main Menu @ Camp [Followers Tab]
        helspawnsMainMenu() {
            this.clearOutput();
            this.outputText("You call " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " over to you and she comes running, ");
            if (this.player.tallness <= 72)
                this.outputText("grabbing you off your [feet] and clutching you in a tight hug");
            else
                this.outputText("throwing her arms around you and hugging you tightly");
            this.outputText(".  Laughing despite yourself, you ruffle her fiery hair and ask her if she’s got a minute.");
        ...
        hugHelspawn() {
            ...
            if (this.player.tallness <= 72) {
                this.outputText("You reach up and pull " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " down to your level, wrapping your arms tight around her slender shoulders.  Grinning from ear to ear, the towering girl squeezes you right back, her powerful muscles just about crushing your smaller body.  Her tail slips around your [hips], the warm leather binding you to your beloved ");
                if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                    this.outputText("daughter ");
                else
                    this.outputText("ward ");
                this.outputText("as she nuzzles up against you.");
            ...
            //{If PC is 6' or taller:}
                ...
                this.outputText("You grab " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " and pull her into a tight hug.  She lets out a girlish giggle as she falls into your arms and squeezes you right back.  Her powerful arms threaten to crush your bigger body, smothering you in affection.  Her tail slips around your [leg], the warm leather binding you to your beloved ");
                if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                    this.outputText("daughter ");
                else
                    this.outputText("ward ");
                this.outputText(" as she nuzzles into your [chest].");
                this.outputText("\n\n\"<i>Love you too, " + this.championRef() + ",</i>\" she laughs, planting a quick kiss on your cheek before letting you go.");
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        talkToHelspawn() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HAD_FIRST_HELSPAWN_TALK] == 0) {
                ...
                //{if Sluttymander:
                if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] >= 50)
                    this.outputText("  Even if she wants to be just like mom, she shouldn't be bringing monsters home.  Some of them may be dangerous, and she's not a warrior quite like you and Helia yet.");
                else
                    this.outputText("  She should know better than to bring monsters back.  She's not her mother; lust doesn't have to dominate her life like that.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                    this.outputText("Of course, as her father, you could always say it's your duty to keep her happy...");
                else
                    this.outputText("Of course, as her adoptive father, you could always say that you love her in a different, more intimate way.");
            ...
            //{Kiha must be at camp}
                ...
                this.outputText("\"<i>Oh hey, " + this.championRef() + "!  You gotta come see what I was making!</i>\"");
                ...
                this.outputText("\n\n\"<i>C'mon, " + this.championRef() + ", try it!</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " adds happily.  \"<i>It's aunt Kiha's favorite recipe.</i>\"");
            ...
            //Talk 3
            //{Needs Rath at camp]
            else if (temp <= 1 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0) {
                this.outputText("\"<i>" + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "!</i>\" you hear a ragged old voice call, \"<i>Get back here this instant!  I'm not done with you yet!</i>\"");
                this.outputText("\n\n\"<i>Coming!</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " calls back as Rathazul shuffles into view, waving around what looks like a tiny hammer.  Whispering, " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " says, \"<i>Could you come with me, " + this.championRef() + "? Rathazul weirds me out.</i>\"");
                this.outputText("\n\nChuckling, you nod and follow " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " as she returns to Rath's makeshift laboratory and seats herself on one of his tables.  Grumbling about kids, the old rat proceeds to rap his little hammer on her knee - nearly getting kicked in the face for his trouble - before asking her to hold her breath as he listens to her heartbeat.  She's nearly blue in the face before he nods approvingly and tells her she can go. " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " goes running, happy to get away as Rath turns to you, shaking his head.");
                ...
                if ((this.amilyScene.amilyFollower() && !this.amilyScene.amilyCorrupt()))
                    this.outputText("Little Amily's solution was makeshift at best, and the children are beyond my reach to study.  Still.  ");
            ...
            else if (temp <= 2 && this.milkSlave() && this.flags[kFLAGS_1.kFLAGS.MILK_SIZE] > 0) {
                this.outputText("\"<i>Hey, have you seen " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + " around anywhere, " + this.championRef() + "?</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " asks, looking around the camp.  \"<i>Mom asked me to milk her, but I haven't seen her around.  She wouldn't have run off, would she?</i>\"");
                if (this.flags[kFLAGS_1.kFLAGS.MILK_SIZE] == 1)
                    this.outputText("\n\nYou tell her it'd be more of a wobble, but");
                else
                    this.outputText("\n\nYou doubt she would have; " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + " seems to have a fancy for you, but");
                this.outputText(" it wouldn't hurt to check around.  She does tend to wander into the traps around camp from time to time.  Offering " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " your hand, you start searching the camp for your missing milk maid.  The two of you make a circuit around camp, checking the traps and behind various rocks and hollows, to no avail.  Finally, as you're starting to get worried about the dusky maid, you happen to look into the steel pool in her part of camp.  Sure enough, you spy " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + " curled up at the bottom of the pool, cuddled up with a ragged blanket to catch a quick nap.");
                this.outputText("\n\n\"<i>Aww,</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " grins, looking down at the napping " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + ".  \"<i>Guess I can milk her later, then.</i>\"");
                this.menu();
            ...
            //{Isabella must be at camp}
                ...
                if (this.player.race() != "human")
                    this.outputText(" and you yourself have suffered as well");
                this.outputText(".  You smile as Isabella seats herself beside " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ", joining their voices together for the final chorus that leaves them both shaking as " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " strums the last, desperate notes, nearly clawing through the strings in her passion.");
                this.outputText("\"<i>");
                if (!this.isabellaAccent())
                    this.outputText("Sehr gut");
                else
                    this.outputText("Very good");
                this.outputText(" little " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ",</i>\" Isabella says, pulling the young 'mander into a great big hug that threatens to smother her betwixt the cowgirl's massive bosoms.  Grinning, you congratulate " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " on her performance, showering your girl in praise before you depart, leaving her to Isabella's instruction.  As you walk away, you can't help but notice Helia standing a short ways off, rubbing her eyes.");
                this.outputText("\n\nWhen you approach, your lover smiles at you, saying, \"<i>I always wanted to be a bard when I was a little girl.  I'm... I'm glad " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s getting the chance, at least.</i>\"");
                this.doNext(this.camp.returnToCampUseOneHour);
            }
            else {
        ...
        dontFuckAlex() {
            this.clearOutput();
            this.outputText("Stroking " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s hair, you try to tell her that there's a better way, that she doesn't have to just fuck everything she comes across.  Her mother's that way, sure, but she could do so much better, so much more with herself than giving in to constant lust.");
            //{If Sluttymander:}
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] >= 50) {
                this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " scoffs, shaking her head.  \"<i>But I </i>like<i> mom's way.  I love jilling off, the feeling of my cunt getting stretched and my ass being torn apart by the big toys I buy in town.  That's who I am, " + this.championRef() + ".  I'm like mom, and I don't think... no, I know I don't want to change.  I love sex, even if you stopped me and Alex from it.  I want to feel a gang of minotaurs raping me, I want to jump on a drider's cock and ride him down.  I want to do the things I heard mom doing, and that's just what I'm going to do. I'm sorry.</i>\"");
                this.outputText("\n\nYou try to say something, but " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " steps away, calling back, \"<i>I love you, " + this.championRef() + ", but I can't be what you want me to be.  I'm going to be a slut like mom, and there's nothing you can do to stop me!  It's who I was born and raised to be.</i>\"");
                this.outputText("\n\nYou may have made a horrible mistake.");
            }
            //{If Chastemander:}
            else {
                this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " nods slowly, taking in your words.  \"<i>I... I know, " + this.championRef() + ".  I'm sorry I brought Alex home last night.  It won't happen again.  I don't... I love mother, but I don't want to be like her.  A whore.  She's a great woman, but the things she does... they disgust me.</i>\"");
        ...
        incestWithHelspawn() {
            ...
            this.flags[kFLAGS_1.kFLAGS.HELSPAWN_INCEST] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[Oh God EW]
        ohGodEwKihaAndHelspawnSuckAtCooking() {
            this.clearOutput();
            this.outputText("You spew the stew onto the ground and grab a nearby waterskin, trying to flush the taste from your mouth.  Kiha and " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " look on with horror as you wipe your mouth and begin to try and coherently explain just how god awful whatever that... STUFF... you just put in your mouth was.  Shock turns to anger before you’re halfway through admonishing the pair of scaly redheads.  Kiha scowls at you and snatches the ladle from you.");
            this.outputText("\n\n\"<i>Oh, what the fuck do you know anyway, you big ass!  It's perfectly fine, isn't it " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "?</i>\" she growls, spooning up a mouthful of the stuff before you can stop her.  A heartbeat after she swallows, Kiha goes completely stiff; her eyes growing as wide as saucers as they water.  She collapses backwards, falling onto her back with a muted <i>THUD</i>.");
            this.outputText("\n\n\"<i>K-Kiha?</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " yelps, watching the dragoness collapse into a pile of limp scales and leather.  \"<i>Are you okay?  Is she okay, " + this.championRef() + "?</i>\"");
            ...
            this.outputText("\n\nYou and " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " are soon working away, stirring up your own special blend of your rations and the spices she and Kiha gathered for the first attempt.  Once you've got the basics in, you step back and hand the ladle over, telling the young 'mander to go wild.  Grinning like a kid, she goes to work, mixing in a wild combination of ingredients.  The cauldron's full to bursting by the time she's done, and no sooner does she ladle out the first bowel of it than Kiha sits up, groaning.");
            this.outputText("\n\n\"<i>The fuck happened?</i>\" the dragoness hisses, rubbing her temple.  \"<i>Feel like I got hit with a hammer.</i>\"");
            this.outputText("\n\n\"<i>You, uh, fell off the edge, aunt Kiha.  And spilled all the stew.  Here, we remade it for you!</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " lies, presenting \"aunt Kiha\" with a bowl full of an aromatic brown goop, full of carrots and spices floating atop it like boats on a placid lake.  At least it smells better.");
            ...
            this.outputText("\n\nYou just shake your head and grab a bowl, sitting down with the scaly ladies as you enjoy your lunch, trying to ignore the little shit-eating grin " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s sporting all the while.");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        umYum() {
            this.clearOutput();
            this.outputText("Um, yum?");
            this.outputText("\n\nCringing, you set the offered bowl back down, squeaking out that it's delicious, thank you very much, but you have something to take care of right now; maybe you can have more later.  Kiha rolls her eyes and shoos you off before she and " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " spoon out their lunch.");
        ...
        helSpawnMilkHerNow() {
            this.clearOutput();
            this.outputText("\"<i>Oh, no.  You're not getting out of your chores that easy, kiddo.  In you go,</i>\" you say, giving her a little push toward the edge of the pool.");
            this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " gives a rebellious huff as she clambers down, slipping down to the bottom and giving " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + " a gentle nudge.  \"<i>C'mon, cutey, wake up.  Time to relieve some pressure.</i>\"");
            this.outputText("\n\nYawning powerfully, " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + " rises to her knees and rubs the sleep from her eyes");
            if (this.flags[kFLAGS_1.kFLAGS.MILK_SIZE] == 2)
                this.outputText(", already working to unfasten her shift");
            this.outputText(".  \"<i>Suckle?</i>\" she asks, turning her full teats toward " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ".");
            //If Sluttymander:
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] >= 50)
                this.outputText("\n\n\"<i>Wouldn't have it any other way!</i>\" the salamander answers with an eager grin, easing herself into " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + "'s arms and wrapping her lips around one of her prominent teats. " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + " gives a pleasured little shudder as " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " starts to suckle like a babe, drinking down the dusky maid's seemingly endless supply of milk.");
            //If Chastemander:
            else
                this.outputText("\n\n\"<i>Sorry, " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + ", you know I'm not really into that.  Just turn around and sit back, alright?</i>\"  With a sigh, " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + " does as she's asked, leaning back into " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s arms as the young salamander goes to work, clawed fingers gently caressing her prominent nubs until a white flow springs fort, splashing her knees as the dusky maid gives a little gasp of pleasure.");
            this.outputText("\n\n<i>They seem to get on all right</i>, you think as you watch the pair of them.  It's nice to have someone else around to help keep " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + "'s production under control.  Poor thing just never stops lactating.");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Spar
        sparHelspawn() {
            this.clearOutput();
            this.outputText("You ask " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " if she's up for some battle practice, and she answers with an eager nod as she grabs her weapon.");
            //If Sluttymander: 
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] >= 50)
            ...
            this.startCombat(new Helspawn_1.Helspawn());
        }
        ...
        loseSparringToDaughter() {
            //if Sluttymander:
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] >= 50) {
                this.outputText("As you stumble back, ");
                if (this.player.lust > 99)
                    this.outputText("succumbing to your own lusts");
                else
                    this.outputText("unable to withstand her unending hail of attacks");
                this.outputText(", " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " quickly sweeps your [legs] out from under you, dropping you right on your ass.  You collapse with a grunt, ");
                if (this.player.weaponName != "fists")
                    this.outputText("weapon tumbling out of hand");
                else
                    this.outputText("unable to even clench your fists anymore");
                this.outputText(", and a moment later " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s on you, straddling you with her powerful legs, pushing you down into the dirt.");
            ...
            //Else If Chastemander:
                ...
                if (this.player.lust > 99)
                    ...
                    this.outputText("unable to withstand her unending hail of attacks");
                this.outputText(", " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " grabs your arm, catching you before you can fall.  \"<i>Easy there, " + this.championRef() + ", I got you,</i>\" she says, pulling you into a quick hug.");
                ...
                if (this.player.HP < 1)
                    this.outputText("recover from that ass kicking");
                else
                    this.outputText("dunk your head");
                this.outputText(".");
            }
        ...
        beatUpYourDaughter() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] >= 50 && this.monster.lust > 99) {
                ...
                //If No Incest: 
                if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_INCEST] == 0)
                    this.outputText("  You wash your hands of the defeated slut and head back to camp, leaving her to work through her tension herself.");
                else {
                    ...
                    this.outputText("... and that if she's lucky, you might tend to her when you've cooled off.");
                }
            }
            else {
                this.outputText(this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " stumbles back, dropping her weapon and waving her arms, \"<i>I give, I give.</i>\"");
                ...
                if (this.monster.HP < 1)
                    this.outputText(", rubbing her many bruises");
                else
                    this.outputText(", blushing brightly after your slutty display");
                this.outputText(".  You chuckle and ruffle her hair, \"<i>C'mon, kiddo, let's get some food in you.</i>\"");
        ...
        maiVisitsHerKids() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("As you head back into camp, you notice Hel and " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " are sitting around the cook fire in the center of camp, with your foster daughter balanced precariously on the lap of her own father, Mai the fox-girl.");
            ...
            this.outputText("\n\n\"<i>Hi, [name],</i>\" Mai says with a demure smile, arms wrapped around " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + "'s belly, trying to hold the daughter that's near a foot taller than she is.  Finally, laughing, she lets the young salamander go.  " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " drops down to sit beside her mother and father, and quickly has both a smooth and scaly hand stroking her hair.");
            //If Chastemander:
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_PERSONALITY] < 50)
                this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " happily leans her head against Mai's leg, accepting the affection with her tail swishing gaily behind her, foxy ears twitching as Mai brushes them.");
            else
                this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " leans back, pulling out a flask and taking a deep swill before passing it to her father, who takes it with a knowing smile and knocks it back like a champ.");
            ...
            this.outputText("\n\n\"<i>Heeeeeyyyyyy,</i>\" " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " whines, crossing her arms with a huff.");
            ...
            this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " lights up as Mai slips the gold chain around her daughter's neck.  \"<i>Something to remember me by when I'm not around,</i>\" she says with a wink, letting her kid skip off to find a mirror.");
            this.outputText("\n\n\"<i>And you, [name],</i>\" she says, turning to you, \"<i>Thanks for taking care of " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ".  I-I mean, I know I was really making her for you and Hel anyway, but still... she's a good kid, and I love her anyway.  Keep her safe, alright?</i>\"");
            this.outputText("\n\nYou promise that you will, and with a quick nod, Mai runs after " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " to say goodbye for the day.  As she leaves, Helia grins, holding you tight against her.  \"<i>She's a good girl, [name].  Couldn't have picked a better father for our girl.</i>\"");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Spider Bro's Gift
        ...
        spiderBrosGift() {
            this.clearOutput();
            this.spriteSelect(68);
            this.flags[kFLAGS_1.kFLAGS.SPIDER_BRO_GIFT] = 1;
            this.outputText("As you're getting ready to head out for the day, you notice " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " prancing around camp with a long, brightly-colored scarf wrapped around her neck, standing painfully in contrast with her midnight-black scales and pale flesh.");
            ...
            if (this.isabellaFollower())
                this.outputText(", or aunt Isabella might have knitted me a new one, I don't know");
            this.outputText(".</i>\"");
        ...
        hakonAndKiriComeVisit() {
            this.clearOutput();
            this.spriteSelect(68);
            this.flags[kFLAGS_1.kFLAGS.HAKON_AND_KIRI_VISIT] = 1;
            this.outputText("As you're returning to camp, you notice Helia running around like a chicken with her head cut off, fussing about damn near everything in her part of the camp");
            if (this.camp.companionsCount() > 1)
                this.outputText(" and everyone else's too, much to their chagrin");
            this.outputText(". As she's furtively polishing off her giant still, trying to get the dingy old thing to shine, you approach and clear your throat. She gives a sharp yelp and spins around, but seems to relax as she sees it's just you.");
            ...
            this.outputText("\n\nIt hardly matters, as a few minutes later, you hear a cry of unabashed glee from the edge of camp, and turn to see " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " running up to meet a pair of oncoming figures.  You wave as Hel's father swoops his granddaughter up into a great bear hug, hefting the half-breed 'mander off her feet in his powerful arms.  " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " squeals with delight as she's practically carried into camp, until Hakon sets her down and hugs her mother, pulling Hel into a tight hug before she can finish saying hello.");
            this.outputText("\n\n\"<i>Hi, [name],</i>\" Kiri says, fluttering over to plant a peck on your cheek.  \"<i>Long time no see.</i>\"");
            this.outputText("\n\n\"<i>Too right.  Put 'er there, " + this.player.mf("son", "girl") + ",</i>\" Hakon says, extending a hand to you, grinning wide as he lets his daughter and granddaughter go.  You shake the old salamander's hand, nearly wincing as his powerful grip throttles your wrist vigorously, practically walking you back into the heart of the camp.");
            this.outputText("\n\nTurning to " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ", Hakon smiles with pride.  \"<i>Gods and demons, girl, you've grown!  What have you two been feeding her, huh?</i>\"");
            this.outputText("\n\n\"<i>And you should see how strong she is!</i>\" Hel grins.  \"<i>Go on, " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + ", show the old scales what you've got.</i>\"");
            this.outputText("\n\n\"<i>Old scales!?  I'll show you old, you little brat.  Come on, hit me!</i>\" Hakon says, just before " + this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] + " punches him right in the chest, knocking him right on his ass.  He tumbles back with a grunt, shaking his head with a wry laugh.  \"<i>Ha!  Maybe these scales are getting old after all.  This one's gonna be a hell of a fighter, though.  Should take her hunting with us one of these days.  What do you say, kid?</i>\"");
            this.outputText("\n\n\"<i>Sure!  ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_WEAPON] == "scimitar and shield")
                this.outputText(this.championRef() + "'s been teaching me how to fight.");
            else
                this.outputText("Mom's been teaching me how to fight.");
            this.outputText("  I'm not as good as mom and " + this.championRef() + " yet, but I'd love to come along.</i>\"");
            this.outputText("\n\n\"<i>That's the spirit.  Now we just have to convince your aunt Kiri to come along.  And ");
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_DADDY] == 0)
                this.outputText("your old man");
            else
                this.outputText("[name]");
            this.outputText(", too.</i>\"");
        ...
        goHuntingBitches() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("\"<i>Sure,</i>\" you say, quickly earning approving nods from Hakon and Helia.");
        ...
        noHuntingBitches() {
            this.clearOutput();
            this.spriteSelect(68);
            this.outputText("\"<i>I'll pass,</i>\" you say with a laugh, earning a shrug from the salamanders.");
    ...
    exports.HelSpawnScene = HelSpawnScene;
});
//# sourceMappingURL=HelSpawnScene.js.map