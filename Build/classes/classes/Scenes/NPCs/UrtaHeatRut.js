define(["require", "exports", "./NPCAwareContent", "../../GlobalFlags/kFLAGS", "../../../../includes/appearanceDefs", "../../PregnancyStore"], function (require, exports, NPCAwareContent_1, kFLAGS_1, appearanceDefs_1, PregnancyStore_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UrtaHeatRut extends NPCAwareContent_1.NPCAwareContent {
        urtaQuestDone() {
            return (this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] == 1);
        }
        //[Approach Sober Urta]
        approachSoberUrtaHeatRutProc() {
            this.clearOutput();
            ...
            if (this.player.inHeat && this.player.inRut && this.player.hasCock() && this.player.hasVagina())
                this.outputText(" Males, females and herms alike stare at you with a mixture of puzzlement, longing and hostility, as if unsure whether they want to fight with you, fuck you senseless or be fucked senseless by you.");
            else if (this.player.inRut && this.player.hasCock())
                this.outputText(" Males stare at you with a hint of challenge in their eyes, whilst females eye you attentively. Herms don't seem sure whether they want to fight you or fuck you.");
            //(Player in heat
            else if (this.player.inHeat && this.player.hasVagina())
                this.outputText(" Males, and individuals who look like females at first, until you spot the telltale bulge of at least one cock in garments or hanging freely between their legs, stare at you with obvious desire as you go, more than a few erections starting to form in your wake.");
            this.outputText("  You ignore them all, concentrating on Urta.");
            this.outputText("\n\nAs you approach, ");
            if (this.urtaLove())
                this.outputText(" she opens her arms to embrace you, and smiles.");
            else
                this.outputText(" she smiles when she sees you, but then gives the air a sniff and immediately seems to gain more color to the skin under her fur.  \"<i>Uh, I, I see.</i>\"  You sit down next to her, but even though she isn't even suggesting anything yet, you already find it hard to control yourself.");
            if (this.player.inRut && this.player.hasCock())
                this.outputText("  Urta is right next to you, and she has already proven herself a good lay");
            else
                this.outputText("  You keep reminding yourself what Urta is packing between her legs and how much precious semen it can give, and can't help but want to try that now");
            ...
            if (this.player.inHeat && this.player.hasVagina())
                this.outputText("  You... smell good, so I at least hope you're not here to tease me.");
            this.outputText("</i>\"  She leans closer to you, and ");
            if (this.player.inRut && this.player.hasCock())
                this.outputText("your eyes are quickly drawn to her full breasts as she whispers something to you. You're too hypnotized to care.");
            else
                this.outputText("you lose yourself in your imagination about having Urta take you raw and pump you full of sperm.  There's a faint voice you hear, and you realize it's Urta's as you snap back to reality.");
            ...
            if (this.urtaLove())
                this.outputText("your adorable, hot vixen");
            else
                this.outputText("someone you know and trust");
            ...
            if (this.player.inRut && this.player.hasCock())
                this.outputText(" focus is on the hips of the fox-morph");
            else
                this.outputText(" focus on catching a glimpse of that amazing cock, and you keep imagining what she can do with it");
            ...
            if (this.player.inRut && this.player.inHeat && this.player.hasCock() && this.player.hasVagina())
                this.outputText(" put a baby in her, then let her put a baby in you");
            else if (this.player.inRut && this.player.hasCock())
                this.outputText(" put a baby in her so she can push it out of those beautiful hips");
            else
                this.outputText(" put that beautiful big cock into your needy [vagina]");
            //[If Urta's fertility quest wasnât done]
            if (!this.urtaQuestDone())
                this.outputText(", even if something keeps reminding you that's impossible.");
            else
                this.outputText(".");
            this.outputText("\n\n\"<i>You know, [name] I'm glad to see you as always.  ");
            if (this.urtaLove())
                this.outputText("  I'm really thankful you managed to control yourself and see me with this.  You know that if you need me, I'm always ready to help, love.</i>\"");
            else
                this.outputText("  I'm really flattered you thought of me when in such a state!</i>\"");
            ...
            if (this.player.inRut && this.player.inHeat && this.player.hasCock() && this.player.hasVagina())
                this.outputText("mixed genitals");
            else if (this.player.inRut && this.player.hasCock())
            ...
            if (this.player.inRut && this.player.inHeat && this.player.hasCock() && this.player.hasVagina()) {
                ...
                if (this.player.cockThatFits(this.urta.urtaCapacity()) >= 0)
                    ...
                    this.addButton(0, "Cock", this.sateRutWithSoberUrtaButHuegDicked);
            ...
            //Player in rut:
                ...
                if (this.player.hasVagina())
                    this.outputText("  Your " + this.multiCockDescriptLight() + " and [vagina] are filling your clothes with mixed juices");
                else
                    this.outputText("  Your [cock biggest] begins to seep precum into your clothes");
                ...
                if (this.player.hasVagina())
                    this.outputText(" and your pussy dripping and eager");
                this.outputText(".");
                this.menu();
                if (this.player.cockThatFits(this.urta.urtaCapacity()) >= 0)
                    this.addButton(0, "Next", this.sateRutWithSoberUrta);
                else
                    this.addButton(0, "Next", this.sateRutWithSoberUrtaButHuegDicked);
            }
            //Player in heat:
            else {
        ...
        //[=Not interested=]
        notInterestedInUburDrunkUrtaRuts() {
            this.clearOutput();
            this.urta.urtaSprite();
            ...
            if (this.player.faceType == 2)
                this.outputText("Your nose does seem to pick up that Urta was and still is getting unusually aroused behind you.  ");
            if (this.player.inRut && this.player.hasCock())
                this.outputText("[EachCock] twitches in protest at you leaving a willing lay behind.  ");
            //[Medium lust increase] 
            //[If the PC has a snake tongue]
            if (this.player.tongueType == appearanceDefs_1.TONUGE_SNAKE)
                this.outputText("You instinctively taste the air, and Urta suddenly seems utterly delicious. ");
            //Rut: 
            if (this.player.inRut && this.player.hasCock())
                this.outputText("Your " + this.multiCockDescriptLight() + " hardens in your pants as you still force yourself to leave.");
            //[Medium lust increase]
            else
                this.outputText("Your condition does seem kind of protesting against leaving such a willing lay behind, but it isn't time to be indulging it.");
        ...
        interestedInUburDrunkurtaRuts() {
            ...
            if (this.player.inRut && this.player.inHeat && this.player.hasCock() && this.player.hasVagina()) {
                ...
                if (!this.urtaLove())
                    this.outputText("under her skirt");
                else
                    this.outputText("through her quickly-soaked dress");
        ...
        drunkUrtaIntroPartDuex(chosenSex = 1, newl = true) {
            if (newl)
                this.clearOutput();
            else
                this.outputText("\n\n");
            ...
            if (this.player.balls > 0 && chosenSex == 1)
                this.outputText("your [balls], rolling them in her hand and squeezing a bit too roughly.");
            else if (this.player.hasVagina()) {
                this.outputText("your [clit], rubbing it until it's ");
                if (chosenSex == 1)
                    this.outputText("the very same state [eachCock] seems to be in so often recently, ");
                this.outputText("erect and throbbing.");
            }
            else
                this.outputText("your [hips], stroking along them towards [eachCock] in an agonizing display of teasing.");
            ...
            if (chosenSex == 1)
                this.outputText(", and [eachCock] already gets hard in your [armor].");
            else
                this.outputText(", and you feel the inside of your [armor] rapidly slickened by your [vagina]'s excitement.");
            ...
            //Player in both : 
            if (this.player.inRut && this.player.inHeat && this.player.hasCock() && this.player.hasVagina())
                this.outputText("and she proceeds to maul her breasts, pre-cum seeping copiously from her cock and her snatch drooling over her balls and onto the floor.");
            else if (chosenSex == 1)
                this.outputText("but she doesn't seem to mind it for the moment.  Rather, the fur between her thighs appears to be rapidly soaking.");
            else
                this.outputText("which she seems more than intent to push into you, although you do see a bit of female lubricant sliding down her balls.");
            ...
            if (chosenSex == 1) {
                if (this.player.cockThatFits(this.urta.urtaCapacity()) >= 0)
                    ...
                    this.addButton(0, "Next", this.sateRutWithDrunkUrtaWithHugeDick);
            }
            else
                this.addButton(0, "Next", this.drunkenUrtaFucksPCInHeat);
        }
        //[If player is in Heat AND Rut and chooses "Watch"]
        //[Watch Drunken Urta Jerk Off]
        watchDrunkRuturtaJerkoff() {
            this.clearOutput();
            this.urta.urtaSprite();
            ...
            if (!this.urtaLove())
                this.outputText("pulls off her skirt");
            else
                this.outputText("roughly tears away her dress from the waist down");
        ...
        keepTeasingDatHornyFawkes() {
            ...
            if (this.player.balls > 0)
                this.outputText("lewdly cupping and fondling your [balls], ");
            ...
            if (this.player.isGoo() || this.player.isNaga())
                this.outputText("what passes for knees on your [legs]");
            else
                this.outputText("knees.");
            ...
            if (this.player.cor < 50)
                ...
                this.outputText("walk triumphantly");
        ...
        soberUrtaSatingPCHeat() {
            ...
            if (this.player.hasCock()) {
                ...
                this.outputText(" by shoving your [balls] out of the way");
            ...
            if (this.player.vaginalCapacity() >= 100)
                this.outputText("  Your hungry gash eagerly welcomes her, Urta easily sliding herself home.");
            else if (this.player.vaginalCapacity() > 60)
                this.outputText("  You feel it stretch you in the most pleasuring of ways, filling you with warm, throbbing flesh as she pushes it deeper and deeper.");
            else
                this.outputText("  You wince in pain at being stretched so much, but you grow wetter and wetter as Urta slowly pushes herself inside your depths, your [vagina] slowly getting wetter and warmer, accepting the intruder.  Pleasure starts to override pain and you let out a gasp.");
            ...
            if (this.player.vaginalCapacity() >= 60)
                this.outputText("Urta's erection seems completely at home in your depths, completely embraced by the wet walls of your throbbing [vagina].");
            else
                this.outputText("You moan again, feeling Urta's member stretch, harden and throb, blood running through it.  You feel complete, and your heat is ignited further by the sensation of something so wonderful and big filling you.");
            ...
            if (this.player.hasCock())
                ...
                if (this.player.clitLength < 2.5)
                    this.outputText("rubbing the hard, stimulated sensitive spot between her fingers");
                else
                    this.outputText("running her fingers over your entire big clit before stroking it like she'd do with a cock");
            }
            ...
            if (this.player.hasCock())
                this.outputText(" Cum rushes out of [eachCock] and onto the soft fur of Urta's abdomen, then starts leaking out slowly in time with her thrusts.");
            this.outputText(" Your cunt clamps down tighter onto Urta as you orgasm,");
            if (this.player.wetness() >= 4)
                this.outputText(" pussy juice shooting out around her member, coating Urta's fur and soaking her balls and the base of her cock.");
            else
                this.outputText(" love juices flowing liberally out of you, giving the skin of Urta's cock a visible shine and spreading onto her balls.");
            ...
            if (this.player.wetness() >= 4)
                this.outputText("shooting out all over the place");
            else
                this.outputText("running down her member and the crack of your [butt], coating the two of you in the proof of your passion");
            this.outputText(".");
            ...
            if (this.player.hasCock())
                this.outputText("your own member responding alike to Urta's, shooting out semen, ");
            this.outputText("your [vagina] ");
            if (this.player.wetness() >= 4)
                this.outputText("once again setting off to coat Urta in your juices.");
            else
                this.outputText("squeezing on her, trying to milk her of her seed.");
            ...
            this.outputText("\n\n\"<i>What?  ");
            if (!this.urtaLove())
                this.outputText("You're still not satisfied?</i>\"");
            else
                this.outputText("You want to keep going, darling?  I want to make you satisfied, so I'll spare all the time I can!</i>\"");
            ...
            if (this.player.hasCock())
                this.outputText("and " + this.multiCockDescriptLight() + " ");
            ...
            //[Hermaphrodite]
            if (this.player.hasCock())
                this.outputText("[eachCock] shoots its seed onto the floor of the alley, helplessly");
            else
                this.outputText("your [vagina] squeezes and tugs on her shooting member, leaking its own juices all over her member, the intensity of the orgasm shaking you right into your core");
            this.outputText(".");
            ...
            this.outputText("\n\n\"<i>That felt amazing!  ");
            if (!this.urtaLove())
                this.outputText("If only I had you by hand every time I need to blow a load.");
            else
                this.outputText("Your pussy is absolutely amazing, sweetheart: I hope I've helped you settle down?  Is your heat sated for the moment?");
            this.outputText("</i>\"");
            ...
            //([Regular Urta]
            if (!this.urtaLove())
                this.outputText("Sure thing, I'm here to help,</i>\" she responds with a wink.");
            else
                this.outputText("I'm here if you need me, love.  Whatever makes you happy.  You've helped me with my own problems so much already, so I owe you at least one.  Not to mention, making love to you feels absolutely amazing!</i>\"");
            ...
            this.dynStats("lust=", 0);
            this.dynStats("lust=", 0);
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] += 6;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Quote:[=Sate Rut with Sober Urta: Cock Too Big=]
        sateRutWithSoberUrtaButHuegDicked() {
            this.clearOutput();
            this.urta.urtaSprite();
            ...
            if (!this.urtaLove()) {
                ...
                if (this.player.cumQ() <= 50)
                    this.outputText("spattering spooge onto Urta's face");
                else if (this.player.cumQ() <= 250)
                    this.outputText("splashing her face and tits with your cum");
                else
                    this.outputText("soaking the shocked fox-morph in your jism");
                this.outputText("; though you still feel the urge to breed fertile females, your lust is momentarily sated.  Urta wipes ");
                if (this.player.cumQ() >= 500)
                    this.outputText("halfheartedly ");
            ...
            //Lover Urta Path/
                ...
                if (this.player.cumQ() <= 50)
                    this.outputText("She swallows it all without complaint, licking her lips clean of any stray droplets once you remove it from her mouth.");
                else if (this.player.cumQ() <= 250)
                    this.outputText("Her cheeks bulge at the amount you pump into her, but she's able to swallow with an admirable amount of control, gasping for breath.");
                else
                    this.outputText("Rivulets of cum burst from between her lips, but she stubbornly sucks and swallows as much as she can, her stomach starting to bulge from the sudden influx of spooge.  When you stop, she is drooling cum and gasping for breath, but she meets your eyes with pride, even as she gives a wet belch.");
        ...
        sateRutWithSoberUrta() {
            ...
            if (this.urtaLove())
                this.outputText("  \"<i>You're the only one who has ever accepted every part of me,</i>\" she tells you, one hand brushing affectionately against your cheek.");
            ...
            if (this.player.hasVagina())
                this.outputText(", trigging a mutual explosion from your [vagina]");
            ...
            if (this.urtaLove())
                this.outputText("blows you a kiss with a flirty wink of her eye and then ");
            ...
            if (this.urtaLove())
                this.outputText("  Her hips deliberately sway in a mesmerizing fashion, tail flicking from side to side to give you a tantalizing grip of her still-dripping snatch and the now-flaccid prick underneath.");
            ...
            if (this.urtaQuestDone()) {
                ...
                if (!this.urtaLove())
                    this.outputText("\"<i>And you had better learn to control yourself, " + this.player.mf("mister", "missy") + ".");
                else
                    this.outputText("\"<i>But you should learn to control yourself lover-" + this.player.mf("boy", "girl") + ".");
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_RUT_FUCKED_URTAS_CUNT]++;
            this.dynStats("lib+", 1, "sen-", 2, "lust=", 0);
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] += 6;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        drunkenUrtaFucksPCInHeat() {
            ...
            if (!this.urtaQuestDone())
                this.outputText("  You know that she can't give you babies... but, honestly, at this moment, you couldn't care less. Her wonderful stallion cock is there and ready and it's all for you.");
            else
                this.outputText("  You dimly recall that Urta could be virile, but she's right there, her huge mare-cock just dripping to plunge into your ripe [vagina] and knock you up.  You don't care anymore; you want her babies!");
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.balls > 0)
                    this.outputText(" and your [balls]");
            ...
            if (this.player.clitLength < 2.5)
                this.outputText("playing with your [clit]");
            else
                this.outputText("lapping around your huge pleasure-button, slurping it into her mouth where she suckles from it");
            this.outputText(", and making you thrash and scream until you think you're going to cum from the pussy-eating alone.  ");
            if (this.player.wetness() >= 4)
                this.outputText("As if to emphasize this, your squelching, slurping pussy suddenly sprays fem-cum all over Urta's face, making her pull herself free with a shocked shake of her head.");
            else
                this.outputText("As if sensing your impending orgasm, Urta removes her head from your [vagina], giving you a cocky grin and shaking her head.");
            ...
            if (this.player.hasCock())
                this.outputText("nor even your " + this.multiCockDescriptLight());
            ...
            this.dynStats("lust=", 0);
            this.dynStats("lust=", 0);
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] += 24;
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY]++;
            this.urtaLove(1);
            this.doNext(this.camp.returnToCampUseFourHours);
        }
        //[Sate Rut with Drunken Urta â Cock too big]
        sateRutWithDrunkUrtaWithHugeDick() {
            this.clearOutput();
            this.urta.urtaSprite();
            ...
            if (this.player.balls > 0)
                this.outputText("against your own [balls]");
            else if (this.player.hasVagina())
                this.outputText("against your [clit]");
            ...
            if (this.player.biggestCockArea() < 150)
                this.outputText("compete with minotaurs or something?");
            else
                this.outputText("set a world record or something?");
            this.outputText("</i>\"\n\n");
            ...
            if (this.player.cumQ() <= 50)
                this.outputText("You cum all over your [chest] as Urta blows thick ropes of vixen-spunk all over your cock and upper body, a single shot landing on your lips.");
        ...
        drunkUrtaRidesARutPCsCock() {
            ...
            if (this.player.balls > 0)
                this.outputText("feel your balls churning");
            else
                this.outputText("recognize the tingling sensation from your " + this.cockDescript(x) + " to your spine");
            ...
            if (this.player.cumQ() <= 50)
                this.outputText("you unload your thick spunk into her pussy");
            else if (this.player.cumQ() <= 250)
                this.outputText("you erupt inside her, filling her with wave after wave of warm, thick semen");
            else
                this.outputText("you blow massive surges of spunk inside her continuously.  The fox's stomach expands, rivulets of semen running down onto the table as she continues her ride on top of you");
            ...
            if (this.player.hasKnot(x))
                this.outputText("You slowly feel the blood flow to your erect penis, and the knot at the base of it seems to start to expand");
            else
                this.outputText("You don't mind staying like this for much, much longer, and the hermaphrodite on top of you seems to share that point of view");
            ...
            if (this.player.hasKnot(x))
                this.outputText("knot surge with more blood and your erection twitch, ensuring that you're completely trapped inside her until you're empty.");
            else
                this.outputText("tip expand as you're getting ready to blow another load.");
            ...
            if (this.player.cumQ() >= 500 && this.player.cumQ() <= 1500)
                ...
                if (this.player.balls > 0)
                    ...
                    this.outputText("cock-like clit");
                else if (this.player.hasVagina())
                    this.outputText("pussy lips");
                else
                    this.outputText("inside of your thighs");
            ...
            if (this.player.balls > 0)
                this.outputText("  Your [balls] don't seem to be completely empty yet");
            else
                this.outputText("  It doesn't appear to be the end of what your body can produce");
            ...
            if (!this.player.hasVagina() && this.player.balls == 0)
                this.outputText(" the inside of your thighs");
            else if (this.player.balls > 0)
            ...
            if (!this.urtaLove())
                this.outputText("intense, unadultered lust");
            else
                this.outputText("possessiveness and a hungry, but somehow warm expression");
            this.outputText(".");
            this.outputText("\n\nI should make you do this every day!</i>\"");
            if (this.urtaLove())
                this.outputText("  She suddenly seems a bit shy and surprised, before saying, \"<i>Make sure to remind me I said that later....</i>\"");
            ...
            if (!this.urtaLove())
                this.outputText("Show me you're " + this.player.mf("the man", "the breeder") + " here!");
            else
                this.outputText("You don't want to make me feel like I'm abusing you, do you?  I know you want this, so pound me!</i>\"");
            ...
            if (this.player.balls > 0)
                ...
                this.outputText("[vagina] and [clit]");
            else
            ...
            if (this.urtaLove())
                this.outputText("  You can rest later!  I'll even give you a massage, so keep giving it to me!");
            this.outputText("</i>\"");
            ...
            if (this.player.cumQ() <= 200)
                this.outputText("  The table already seems like it'll be stained white by Urta's efforts alone, and your own fluid doesn't help the situation.");
            else if (this.player.cumQ() < 1000)
                this.outputText("  The two of you are already fucking in a small pool of your mixed semen sauce, making naughty sounds heard all over the bar, and her vagina, dripping with your fluids, only makes the pool seem bigger.");
            else if (this.player.cumQ() >= 2000)
                this.outputText("  Your mixed sperm is covering the table and the floor, and woe to anyone who will have to clean this place up.  Despite the ridiculous amount of fluids around, she seems set on the idea that the two of you are barely mid-way through the act.");
            ...
            if (this.player.cumQ() >= 1000)
                this.outputText("  Well, maybe you can, but let's make some twins!");
            ...
            if (this.player.tallness <= 93)
                this.outputText("making you lick, kiss and suck on her flared, wide tip");
            else
                this.outputText("staring deep into your eyes as her erection smacks you against your [chest]");
            this.outputText(".");
            if (!this.urtaLove())
                this.outputText("  She grins at your lack of resistance.");
            else
                this.outputText("  \"<i>You're mine, right?  Right now, you're mine and mine alone.  My wonderful virile breeder, all " + this.player.mf("his", "her") + " seed just for me.</i>\"");
            ...
            if (this.urtaLove())
                this.outputText("  Just a few more loads, okay?  You don't mind, lover?  I'm practically addicted, so let me just fucking overdose!");
            this.outputText("</i>\"");
            ...
            if (this.player.balls > 0)
                this.outputText(", your [balls] frantically gathering any cum that is left in them to prepare for another surge of shots into the hermaphrodite's eager nethers");
            ...
            if (this.player.cor > 35 || this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0)
                this.outputText("You tell her it was actually a great experience to have such passionate sex publicly.  She blushes at that suggestion.");
            //[If Urta is infertile]
            if (!this.urtaQuestDone()) {
                this.outputText("\n\n\"<i>Well, I guess it was nice, if painful afterwards, to be of use to someone who was so ready and willing to breed.");
                if (this.urtaLove())
                    this.outputText("  If only I could... uh, I guess I should just enjoy what I can.");
                this.outputText("</i>\"");
            }
            //[If Urta is fertile]
            else {
            ...
            this.outputText("\n\nShe ");
            if (!this.urtaLove())
                this.outputText("winks at you as you get ready to leave.  I hope I'll get to play with you again soon.</i>\"");
            else {
    ...
    exports.UrtaHeatRut = UrtaHeatRut;
});
//# sourceMappingURL=UrtaHeatRut.js.map