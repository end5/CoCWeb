define(["require", "exports", "./NPCAwareContent", "../../PregnancyStore", "../../GlobalFlags/kFLAGS", "../../CoC", "../../../console", "../../StatusAffects", "../../Appearance", "../../CockTypesEnum", "../../../../includes/appearanceDefs", "../../PerkLib", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, StatusAffects_1, Appearance_1, CockTypesEnum_1, appearanceDefs_1, PerkLib_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class JojoScene extends NPCAwareContent_1.NPCAwareContent {
        constructor() {
            super();
            // Some hacky shit to be able to control the text clearing mechanics of the doEvent system... OH GOD WHY. //Gone, gone forever
            this.doClear = true;
            this.pregnancy = new PregnancyStore_1.PregnancyStore(0, 0, kFLAGS_1.kFLAGS.JOJO_BUTT_PREGNANCY_TYPE, kFLAGS_1.kFLAGS.JOJO_EGGCUBATE_COUNT);
        ...
        timeChange() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.JOJO_COCK_MILKING_COOLDOWN] > 0)
                this.flags[kFLAGS_1.kFLAGS.JOJO_COCK_MILKING_COOLDOWN]--;
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.NoJojo) >= 0)
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.NoJojo);
            if (this.model.time.hours > 23 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.Meditated) > 0) {
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Meditated);
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00102] == 0) {
                    this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00102]++;
                    while (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Meditated) >= 0) {
                        this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Meditated);
                    }
                }
            }
        ...
        set monk(value) {
            kGAMECLASS_1.kGAMECLASS.monk = value;
        }
        ...
        jojoSprite() {
            if (this.tentacleJojo())
                this.spriteSelect(81);
            else
                this.spriteSelect(34);
        }
        assholeOrDP() {
        ...
        vaginaOrDicksOrCrotch() {
            if (this.player.gender == 0)
                return "crotch";
            if (this.player.gender == 1)
                return this.multiCockDescriptLight();
            if (this.player.gender == 2)
                return this.vaginaDescript(0);
        ...
        tentacleJojo() {
            return this.player.findStatusAffect(StatusAffects_1.StatusAffects.TentacleJojo) >= 0;
        }
        campCorruptJojo() {
            return this.monk >= 5 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.NoJojo) < 0 && this.flags[kFLAGS_1.kFLAGS.JOJO_DEAD_OR_GONE] == 0;
        }
        jojoMutationOffer() {
            this.jojoSprite();
        ...
        corruptCampJojo() {
            this.clearOutput();
            this.jojoSprite();
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] == 0) {
                //Corrupt Amily and Jojo sexings
                if (this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] == 2 && this.amilyScene.amilyFollower() && this.campCorruptJojo() && this.flags[kFLAGS_1.kFLAGS.AMILY_X_JOJO_COOLDOWN] <= 0 && JojoScene.rand(5) == 0 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_AMILY] == 0) {
                    this.flags[kFLAGS_1.kFLAGS.AMILY_X_JOJO_COOLDOWN] = 7;
                    this.hideMenus();
                    this.amilyTeachingJojoBJ();
                    return;
                }
                //Oh shit goes down! (Wiv Tentacles)
                if (this.amilyScene.amilyFollower && this.flags[kFLAGS_1.kFLAGS.AMILY_DISCOVERED_TENTATLE_JOJO] == 0 && JojoScene.rand(10) <= 1 && this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] == 1 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.TentacleJojo) >= 0) {
                    this.finter.amilyDiscoversJojoWithTentaclesAndShitOhBoy();
                    return;
                }
                //Oh shit goes down! (No tentacles)
                else if (this.flags[kFLAGS_1.kFLAGS.AMILY_PISSED_PC_CORRUPED_JOJO] == 0 && JojoScene.rand(10) <= 1 && this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] == 1 && this.amilyScene.amilyFollower() && this.player.findStatusAffect(StatusAffects_1.StatusAffects.TentacleJojo) < 0) {
                    this.finter.amilyIsPissedAtYouForRuiningJojo();
                    return;
                }
                //Offer lethicite jojo tf if the player is ready
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.JojoTFOffer) < 0 && this.player.hasKeyItem("Marae's Lethicite") >= 0 && this.player.keyItemv2("Marae's Lethicite") < 3 && this.player.cor >= 75) {
                    this.jojoMutationOffer();
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.JojoTFOffer, 0, 0, 0, 0);
                    return;
                }
                this.outputText("Before you call for your corrupted pet, how do you want to use him?", true);
            }
            else {
                this.outputText("Jojo slinks out of a barn when you call his name, hating and loving every step he takes towards you. He looks dusty and worn out but his dick still strains at the sight of you.");
                ...
                if (this.tentacleJojo())
                    this.outputText(" A number of tentacles vaugley resembling cocks have sprouted from his back and groin. They sway restlessly around him, oozing thick, fragrant pre from their tips.");
                if (kGAMECLASS_1.kGAMECLASS.farm.farmCorruption.hasTattoo("jojo")) {
                    this.outputText("\n\n");
                    if (kGAMECLASS_1.kGAMECLASS.farm.farmCorruption.jojoFullTribalTats()) {
                        this.outputText("He is covered from head to tail in tribal tattoos, erotic lines snaking all over his naked frame, giving him the look of a barely tamed savage.");
                    }
                    else {
                        if (kGAMECLASS_1.kGAMECLASS.farm.farmCorruption.numTattoos("jojo") > 1)
                            this.outputText("He has the following tattoos emblazoned across his body:\n");
                        else
                            this.outputText("He has ");
                        if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_COLLARBONE] != '')
                            this.outputText(this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_COLLARBONE] + "\n");
                        if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_SHOULDERS] != '')
                            this.outputText(this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_SHOULDERS] + "\n");
                        if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_LOWERBACK] != '')
                            this.outputText(this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_LOWERBACK] + "\n");
                        if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_BUTT] != '')
                            this.outputText(this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_BUTT] + "\n");
                        this.outputText("\n");
                    }
                }
                if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO_GIBS_DRAFT] == 1) {
                    this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO_GIBS_DRAFT] = 2;
            ...
            var tent = undefined;
            if (this.tentacleJojo() && this.player.lust >= 33)
            ...
            if (this.player.hasKeyItem("Cock Milker - Installed At Whitney's Farm") >= 0) {
                ...
                //First time:
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00331] != 0) {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.HairdresserMeeting) >= 0)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_STARTED] == 1 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] == 0)
                this.addButton(6, "Farm Work", this.sendToFarm);
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_STARTED] == 1 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] == 1)
                this.addButton(6, "Go Camp", this.backToCamp);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] == 1 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_PRODUCTION_JOJO] == 0)
                this.addButton(7, "Harvest Draft", this.harvestJojoDraft);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] == 1 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_PRODUCTION_JOJO] == 1)
                this.addButton(7, "Stop Harvest", this.stopHarvestJojoDraft);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] == 1)
                this.addButton(9, "Back", kGAMECLASS_1.kGAMECLASS.farm.farmCorruption.rootScene);
        }
        harvestJojoDraft() {
            this.clearOutput();
            this.jojoSprite();
            this.outputText("You tell Jojo that you want him hooked up to a cock milker whenever possible; you need his fluids.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_REFINERY] == 1)
                this.flags[kFLAGS_1.kFLAGS.FOLLOWER_PRODUCTION_JOJO] = 1;
            this.doNext(kGAMECLASS_1.kGAMECLASS.farm.farmCorruption.rootScene);
        }
        stopHarvestJojoDraft() {
            this.clearOutput();
            this.jojoSprite();
            this.outputText("You tell Jojo to stop producing incubus draft; you’re practically drowning in the stuff. Jojo closes his eyes, and you grin as you envisage the image you’ve just planted in his mind.");
            ...
            this.flags[kFLAGS_1.kFLAGS.FOLLOWER_PRODUCTION_JOJO] = 0;
            this.doNext(kGAMECLASS_1.kGAMECLASS.farm.farmCorruption.rootScene);
        }
        sendToFarm() {
            this.clearOutput();
            this.jojoSprite();
            this.outputText("You tell your pet mouse");
            if (this.tentacleJojo())
                this.outputText("-come-tentacle-beast");
            this.outputText(" that he is to head towards the lake, find a farm, present himself to the lady who works there and do as she says.");
            ...
            this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        backToCamp() {
            this.clearOutput();
            this.jojoSprite();
            this.outputText("You tell him to head back to camp; there are things you need to do to him you can’t do whilst he’s here. Repeatedly. Jojo trembles, manages a bow, and then slowly trails off towards camp.");
            this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] = 0;
            this.doNext(kGAMECLASS_1.kGAMECLASS.farm.farmCorruption.rootScene);
        }
        jojoMutationOfferYes() {
            this.jojoSprite();
            this.player.addKeyValue("Marae's Lethicite", 2, 1);
            this.outputText("There's no question about it, this is a great idea.  It might be coming from the corruption in your blood, but why bother to fight it?  You take Marae's lethicite and grab one of the larger crystalline protrusions.  With a hard yank, you break it off from the main cluster, sending tiny crystalline shards over the campsite.  They vanish into the ground before you have a chance to gather them.\n\n", true);
            this.outputText("Whether by luck or some unconscious demonic magic, the smaller piece of lethicite is rather phallic. If it weren't for the sharp corners and hard edges, it would look like a large dildo with a pair of balls at the base.  You put away the larger piece, focusing this tool and your plans for your pet.\n\n", false);
            this.outputText("You lick the sharp crystalline dildo, slathering it with spit.  You aren't sure, but you seem unable to stop.  It's as if some demonic force guides you.  It's difficult to focus on much beyond your own arousal and the tingling feeling that spreads through your body as you taste this piece of a goddess' essence.  Your mind drifts off into a perverted fantasy, unable to cope with total loss of control and oral debauchery.\n==========================================\n<i>", false);
            //[Male]
            if (this.player.gender <= 1) {
                this.outputText("In your fantasy you're fucking Jojo again, bottoming out against his cute girlish ass over and over.  His dick spurts mouse-milk with each thrust, feeding a dozen growing puddles underneath him as they slowly merge together.  He writhes and squirms, a pair of crystalline balls against his chin while he deep-throats a massive dildo.  You blast another wave into his overloaded spunk-dumpster, forcing a thick jet out of him and into the cum-puddles underneath you.\n\n", false);
                this.outputText("Tired of the foreplay, you pull out of him, watching a river of your cum escape from the uncorked opening.  You pull him up, watching the crystal cock slide out of his mouth, the bulge along his throat slowly disappearing as each inch escapes.  He staggers, completely exhausted, but still hard and horny judging by the look in his eye.\n\n", false);
                this.outputText("You shove him over a log and grab his spit-slick toy, dragging it through the puddled cum until it's white and dripping.  Jojo whimpers, his disproportional member stuck between his legs and twitching with anticipation.  The dildo slides into his well-stretched hole with ease, sealing the rest of your tainted seed deep inside his bowels as your magic begins to change him...</i>\n==========================================\n", false);
                this.outputText("You snap out of the fantasy with a start.  The crystal shard is sitting on the ground in front of you, but it is no longer a shard – it's the dildo from your fantasy, complete with a thick covering of your cum.  You manage to pry your hand away from your softening member");
                if (this.player.cockTotal() > 1)
                    this.outputText("s");
                this.outputText(" and take the tainted artifact, now ready to be used.</i>\n", false);
            }
            //[Female] 
            else {
                this.outputText("In your fantasy, you're riding Jojo hard, milking his swollen dick with your pussy", false);
                if (this.player.biggestLactation() < 2)
                    this.outputText(" while your tits cover his head, nearly suffocating him", false);
                else
                    this.outputText(" while he suckles one of your breasts hungrily, sucking down your milk", false);
                this.outputText(". A crystalline dildo is buried hilt-deep in his ass, held in place by a harness of your own design that twists it around every time he moves.  You cum again, relishing the desperate and needy look the poor mouse is giving.  Your spasming pussy is immediately filled with even more warmth, and you feel the thick spunk forcing its way into your core until you feel bloated.\n\n", false);
                this.outputText("You calm your trembling body and stand up off of him, soaking him with his own escaping fluids.  Jojo moans and starts pumping his dick, wriggling his hips while his orgasm is dragged on by the dildo squeezing his prostate.  You curl up alongside his ear and begin whispering into his mind, watching as your words soak in and begin to change him with the aid of the crystalline cock's magic.</i>\n==========================================\n", false);
                this.outputText("You snap out of your fantasy with a start.  The crystal shard is sitting on the ground in front of you, but it's no longer a shard – it's the dildo from your fantasy, now slick with pussy juices.  You touch your sore cunt and gasp when you realize where it went.  ", false);
        ...
        mutateJojo() {
            ...
            if (this.player.hasVagina())
                this.outputText("caressing your aching twat ", false);
            ...
            this.outputText("The dildo is gone, leaving only a hot pink tinge on the fur around his pucker.  Whatever dark magic you managed to imbue it with was used up by the transformation.  Jojo is still out cold, probably unable to cope with the force of his altered orgasm, but his body is doing an admirable job of adjusting.  You even see his three tails curling together until they look like one larger tail.  Only close inspection would reveal the difference.\n\n", false);
            this.outputText("You turn back to your tent, turned on beyond all measure, and needing to masturbate NOW.  You wonder what Jojo's new additions will feel like on your body when he wakes up, but for now you'll have to get off another way.", false);
            this.dynStats("lus", 300, "cor", 10);
            //(LIMITED MASTURBATE MENU – No Jojo)
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.NoJojo, 0, 0, 0, 0);
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.TentacleJojo, 0, 0, 0, 0);
        ...
        useTentacleJojo() {
            ...
            this.outputText("Desperation hangs thick about him in the air as his newfound additions react to your summons.  Somehow he knows you wanted to use them, but he's trying to hold himself back like a good bitch.  You egg him on a bit, taunting, \"<i>Awww, look at the cute little tentacles begging to come out and play,</i>\" while you begin to brush your fingertips along underside of his writhing cock.  Jojo's eye cross from the pleasure, his member growing longer and longer under your touches until it's swaying in the air, snake-like, with its flared purple tip lying in the palm of your hand.\n\n", false);
            this.outputText("You drop it, letting it smack into the floor with a wet-sound 'SPLAT' that creates a puddle of pre-cum on the ground.  With your hands free, it is easy to quickly remove your " + this.player.armorName + " and toss it back towards your tent.  By the time you turn back around, his snake-like member is curling up your thigh, towards your " + this.assholeOrPussy() + ".  ", false);
            if (this.player.hasVagina())
                this.outputText("You feel it split in half, dividing in order to take you from both ends.  ", false);
            this.outputText("You marvel at just how hard it is to dominate someone who can fuck you from a few feet away and wrap you up with a half-dozen appendages before you just give in and decide to enjoy it.\n\n", false);
            this.outputText("You put your arms on your hips and say, \"<i>Go ahead and ravage me then, but if I don't love every second of it you'll regret it.</i>\"\n\n", false);
            this.outputText("Looking very much like a starving man looking at a steak, Jojo smiles serenely and lashes out with his shoulder-tentacles, grabbing your arms and pinning them to your waist.  They wrap about your middle and lift you off the ground with ease.  Suspended in front of him, you're effortlessly rotated in place until your " + this.assholeDescript() + " is in the air and your legs splayed apart, with the mutant-mouse's primary tentacle getting ever closer to your " + this.assholeDescript(), false);
            if (this.player.hasVagina())
                this.outputText(" and " + this.vaginaDescript(0), false);
            this.outputText(".\n\n", false);
            //REAL SECKS STARTS HERE
            if (this.player.totalCocks() > 0) {
                this.outputText("Upside down, you're forced to watch as his tail-tentacles curl out from between his legs, and extend towards your vulnerable " + this.multiCockDescriptLight() + ".  All three of them pause a few inches away for what seems an eternity, revealing circular dripping orifices filled with slimy wriggling cilia.\n\n", false);
                if (this.player.cockTotal() == 1) {
                    //(1dick+balls = 
                    if (this.player.balls > 0) {
                        ...
                        else if (this.player.cockArea(0) >= 20)
                            this.outputText("engulfing", false);
                        else
                            this.outputText("easily swallowing", false);
                        this.outputText(" your " + this.cockDescript(0) + " in a tight vise of pleasure.  The other two tentacles slide under, each taking a " + this.ballDescript() + " partially inside their 'mouths' and massaging them softly.", false);
                        this.outputText("\n\n", false);
                    }
                    //(1 dick no balls = 
                    else {
                        ...
                        if (this.player.cockArea(0) > 60)
                            ...
                            this.outputText("easily swallowing", false);
                        this.outputText(" your " + this.cockDescript(0) + " in a tight vise of pleasure.  The other two tentacles slide under, ", false);
                        if (!this.player.hasVagina())
                            this.outputText("rubbing back and forth along your taint and smearing you with their slime.", false);
                        else {
                            this.outputText("rubbing against your thighs and smearing them with lubricant while one of them easily sucks your " + this.clitDescript() + " inside.", false);
                            //(If big clit – 
                            if (this.player.clitLength >= 4)
                                this.outputText("  You nearly cum on the spot from the clitoral stimulation; it's like you have a super-sensitive cock being licked by a thousand tongues.", false);
                        }
                        this.outputText("\n\n", false);
                    }
                }
                ...
                if (this.player.cockTotal() == 2) {
                    ...
                    if (this.player.balls > 0) {
                        ...
                        if (this.player.cockArea(0) > 60)
                            ...
                            this.outputText("easily swallowing", false);
                        this.outputText(" your " + this.multiCockDescriptLight() + " in tight vises of pleasure.  The remaining tentacle slides underneath, alternatively taking each of your " + this.ballsDescript() + " partway into its 'mouth' and massaging them with its thousands of wriggling stimulators.\n\n", false);
                    }
                    //(2 dicks no balls) 
                    else {
                        this.outputText("Two of them lash forward, ", false);
                        if (this.player.cockArea(0) > 60)
                            ...
                            this.outputText("easily swallowing", false);
                        this.outputText(" your " + this.multiCockDescriptLight() + " in tight vises of pleasure.  The remaining tentacle slides underneath, seeking ", false);
                        if (this.player.hasVagina()) {
                            this.outputText("out your " + this.clitDescript() + " and sucking it inside.", false);
                            //(If big clit – 
                            if (this.player.clitLength >= 4)
                                this.outputText("  You nearly cum on the spot from the clitoral stimulation; it's like you have a super-sensitive cock being licked by a thousand tongues.", false);
                        }
                        else
                            this.outputText("to rub itself along your taint, massaging the sensitive skin with its slimy lubricants.", false);
                        this.outputText("\n\n", false);
                    }
                }
                //(3 dicks) 
                if (this.player.cockTotal() >= 3) {
                    ...
                    if (this.player.cockArea(0) > 60)
                        ...
                        this.outputText("easily swallowing", false);
                    this.outputText(" your " + this.multiCockDescriptLight() + " in tight vises of pleasure.  The sensation is overwhelmingly pleasurable, like having three cocks being licked and sucked by a thousand tongues.", false);
                    //(if extra: 
                    if (this.player.cockTotal() > 3)
                        this.outputText("  The remaining " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + "'s pulse and throb with jealous desire, until one of the tentacles slips off and captures it.  They take turns, slipping off and capturing each of your offerings until you wish they'd just keep sucking forever.", false);
                    this.outputText("\n\n", false);
                }
            }
            //(0 dicks but clit)
            if (this.player.totalCocks() == 0 && this.player.hasVagina()) {
                this.outputText("One of Jojo's tail-tentacles slides underneath his body, shooting forwards to seek out your " + this.clitDescript() + ".  It pauses an inch or two away and opens up a horrific orifice full of wriggling tentacles and slick fluids.  The next moment it lunges forwards and sucks it inside.", false);
                //(If big clit – 
                if (this.player.clitLength >= 4)
                    this.outputText("  You nearly cum on the spot from the clitoral stimulation; it's like you have a super-sensitive cock being licked by a thousand tongues.", false);
                else
                    this.outputText("  The sensation was unreal, and you find yourself wishing your clit was bigger so you could feel even more of the tendrils pleasure-hole.", false);
                this.outputText("\n\n", false);
            }
            //GET BUTT/VAGOO PENETRATED
            this.outputText("The ", false);
            if (this.player.hasVagina())
                this.outputText("pair of tentacles ", false);
            else
                this.outputText("tentacle ", false);
            ...
            //not virgin taking
                ...
                //With cunt
                if (this.player.hasVagina()) {
                    if (this.player.vaginas[0].vaginalLooseness >= appearanceDefs_1.VAGINA_LOOSENESS_GAPING_WIDE)
                        this.outputText(" practically falling into your oversized cum-receptacles", false);
                    else {
                        if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_SLICK)
                            this.outputText(" sliding inside easily thanks to your copious lubrication", false);
                        else
                            this.outputText("forcing their way inside your " + this.vaginaDescript(0) + " and " + this.assholeDescript(), false);
                    }
                }
                //Just butt
                else {
                    if (this.player.ass.analLooseness >= 4)
                        this.outputText(" practically falling into your oversized cum-receptacle", false);
                    else {
                        if (this.player.ass.analWetness >= 3)
                            this.outputText(" sliding inside easily thanks to your copious lubrication", false);
                        else
                            this.outputText("forcing its way inside your " + this.assholeDescript(), false);
                    }
                }
            }
            //ON WITH THE PENETRATION
            this.outputText(".  Your " + this.mouthMuzzle() + " opens with a wordless cry of surprise ", false);
            if (this.player.hasVagina())
                this.outputText("and pleasure ", false);
            this.outputText("as Jojo's tentacle", false);
            if (this.player.hasVagina())
                this.outputText("s begin", false);
            else
                this.outputText(" begins", false);
            this.outputText(" thoroughly violating you, pistoning in and out relentlessly.", false);
            if (this.player.totalCocks() > 0) {
                this.outputText("  You feel a strange pleasure every time it plunges deep into your ass, smacking into your prostate.  ", false);
                if (this.player.cockTotal() == 1)
                    this.outputText("  The tentacle on your " + this.multiCockDescriptLight() + " seems appreciative, and begins sucking to swallow down all your pre.", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("  The tentacles on your " + this.multiCockDescriptLight() + " seem appreciative, and begin sucking to swallow down all your pre.", false);
            }
            if (this.player.hasVagina())
                this.outputText("  Your " + this.vaginaDescript(0) + " spasms around the invader, clenching uncontrollably as it's plowed by the thick vine-prick.", false);
            this.outputText("\n\n", false);
            this.outputText("You feel the bindings around your waist sliding and twisting to free up some of their length.  The pair of tentacle-cocks rear up before your " + this.allBreastsDescript() + " like hungry snakes eyeing a mouse.\n\n", false);
            //(Large tits &/or multitits with no lactation)
            if ((this.player.biggestTitSize() >= 4 || (this.player.biggestTitSize() >= 4 && this.player.breastRows.length > 1)) && this.player.biggestLactation() < 2) {
                titFucking = true;
                this.outputText("The twin tentacles erupt like kinked up garden-hoses that have suddenly become free, splattering your chest with thick white goop.  They spurt until all of your " + this.breastDescript(0) + " are painted white with warm dripping goop.  One of the purple-headed monsters slides into the mess, while the other ties itself around your " + this.breastDescript(0) + ", squeezing its brother tightly between the walls of cum-slickened titflesh.  The swollen purple head bumps your chin, smearing you with its cum as it begins to fuck your tits.  Glob after glob of mouse-cum spatters up from your chest into your chin and mouth, eventually soaking your " + this.faceMuzzle() + " and neck.\n\n", false);
            }
            //(Lactating highly)
            if (this.player.biggestLactation() >= 2) {
                nippleSucking = true;
                this.outputText("The heads split apart, dividing into quarters as they reveal wet openings with pink, tongue-like appendages.  Milk begins to leak from your nipples as their intent becomes clear, and you inwardly scold yourself for ", false);
                if (this.player.cor < 80)
                    this.outputText("being such a wanton slut", false);
                else
                    this.outputText("giving it up too easily", false);
                this.outputText(".  Jojo's dick-mouths latch on and suck hard, pulling your " + this.nippleDescript(0) + "s deep into their internal reservoir and stimulating your breasts to release a torrent of milk.  ", false);
                if (this.player.cowScore() >= 5)
                    this.outputText("You find yourself mooing in contentment as your fuck-slave works to milk you.  ", false);
                this.outputText("You watch with a happy smile, enjoying the sensations as the tentacles bulge and move milk-distended knots down their lengths towards Jojo.  They are so full that the sloshing whiteness actually becomes visible through the 'skin' of his tendrils.", false);
                if (this.player.breastRows.length > 1) {
                    //(NewPG if multirow)
                    this.outputText("\n\nThere is nothing to do but enjoy the sensations until your " + this.breastDescript(0) + " are emptied, but before that can happen, they detach, soaking your chest with excess milk, and move down to the next row.  It becomes clear they will keep milking you, moving from row to row to give each a chance to recover, so that they can feed indefinitely...", false);
                }
                this.outputText("\n\n", false);
            }
            //(NEITHER - JUST NIPS) 
            ...
            if (this.player.hasVagina()) {
                ...
                if (this.player.cockTotal() <= 2 && this.player.balls == 0) {
                    this.outputText("The tentacle locked around your " + this.clitDescript() + " bulges out a bit as your clit throbs from the orgasm, before it sucks harder, making your clitty even larger.  You squeal from the raw sensation until the tentacle pops off, satisfied, leaving your clit looking like an angry red cock.  ", false);
                    this.player.clitLength += .25;
                }
                this.outputText("Both tentacles pull out, still dripping whiteness that puddles in your holes.", false);
            }
            else {
                this.outputText("tentacle in your " + this.assholeDescript() + " thickens perceptibly.  Bulges of cum work their way down the main tentacle, spreading your " + this.assholeDescript() + " wide before stuffing you full of mouse cream.  You can feel your bowels filling, expanding you until you look mildly pregnant.  Your body spasms around them, locked in the throes of orgasm.  The tentacle pulls out, still dripping whiteness that puddles in your well-used hole.", false);
            }
            //Dick milkings ahoy!
            if (this.player.cockTotal() > 0) {
                if (this.player.cockTotal() == 1) {
                    this.outputText("The tentacle working over your " + this.multiCockDescript() + " clamps down and wriggles deliciously around you.  You can't help but cum from the assault, feeding the tentacle your hot spoogy load.  It drinks it down eagerly", false);
                    if (this.player.cumQ() >= 100) {
                        this.outputText(", but after a few moments it begins to struggle with the sheer output.", false);
                        if (this.player.cumQ() >= 300) {
                            this.outputText("  When you finally finish, it's bloated and dripping your cum all over your crotch.", false);
                            if (this.player.cumQ() >= 600) {
                                this.outputText("  You pump the tentacle so full it turns pinkish-white and bloats obscenely, before suddenly releasing a backflow that soaks you in spunk from the waist down. It drops to the ground limp and spent", false);
                                if (this.player.cumQ() >= 800)
                                    this.outputText(" but you don't stop cumming until it lies in a deep puddle of jizz", false);
                                this.outputText(".", false);
                                cumPuddle = true;
                            }
                        }
                ...
                if (this.player.cockTotal() > 1) {
                    this.outputText("The tentacles working over your " + this.multiCockDescript() + " clamp down and wriggle deliciously around you.  You can't help but cum from the assault, feeding the tentacles your hot spoogy load.  They drink it down eagerly", false);
                    if (this.player.cumQ() >= 100) {
                        this.outputText(", but after a few moments they begin to struggle with the sheer output.", false);
                        if (this.player.cumQ() >= 300) {
                            this.outputText("  When you finally finish, they're bloated and dripping your cum all over your crotch.", false);
                            if (this.player.cumQ() >= 600) {
                                this.outputText("  You pump the tentacles so full they turn pinkish-white and bloat obscenely, before suddenly releasing a backflow that soaks you in spunk from the waist down. They drop to the ground limp and spent", false);
                                if (this.player.cumQ() >= 800)
                                    this.outputText(" but you don't stop cumming until they lie in a deep puddle of jizz", false);
                                this.outputText(".", false);
                                cumPuddle = true;
                            }
                        }
            ...
            if (this.player.biggestLactation() >= 2 && nippleSucking) {
                this.outputText("Your " + this.breastDescript(0) + " squirt milk even harder, pushing the tentacles clear off you with the force of your lactation.  Your " + this.nippleDescript(0) + "s look like ", false);
                if (this.player.nippleLength >= 2)
                    this.outputText("even larger", false);
                else
                    this.outputText("obscene", false);
                this.outputText(" cow-teats from all the suction, fountaining milk everywhere as it puddles on the ground.  The milk flow tapers off after a few seconds, leaving you stretched and sore.", false);
                if (this.player.nippleLength < 4 && this.player.breastRows[0].breastRating >= 1) {
                    this.outputText("  Somehow you know they won't shrink the whole way back down to normal.", false);
                    this.player.nippleLength += .25;
                }
                else
                    this.outputText("  Somehow you know they won't get any bigger from his rough treatment.", false);
                this.outputText("  Your " + this.allBreastsDescript() + " finally feel emptied; it's a relief.\n\n", false);
                milkPuddle = true;
            }
            //Titfucking breastgasm
            if (titFucking) {
                this.outputText("The titfucking tentacles squeeze tighter against your " + this.allBreastsDescript() + " before they cum again, much harder than before.  Each time it pops free of your flesh, a wave of spunk flows out with it, rolling off your chest to drip into your already soaked face and mouth.  ", false);
                if (this.player.cor >= 80 && this.player.lib >= 70)
                    this.outputText("You lick your lips and swallow as much of it as possible, wallowing in the mouse-cream.  ", false);
                if (this.player.hairLength > 0)
                    this.outputText("He keeps unloading it until you feel it in your " + this.hairDescript(), false);
                else
                    this.outputText("He keeps unloading it until you feel it on your head", false);
                this.outputText(", then both tentacles abruptly release, going flaccid.\n\n", false);
            }
            if (mouthFucking) {
                this.outputText("A wide bulge forces your jaw apart, distends your throat, and finally empties into your gut, filling you with warmth.  The action repeats until you feel bloated and full, far worse than before as you're now filled from BOTH ends.  You look more like ", false);
                if (this.player.pregnancyIncubation == 0 && this.player.buttPregnancyIncubation == 0)
                    ...
                    this.outputText("a brood-mother immobilized by her growing offspring", false);
                this.outputText(" than your old self at this point, and Jojo wastes no time in pulling out to paint your " + this.faceMuzzle() + " with his baby batter.\n\n", false);
                cumPuddle = true;
                this.dynStats("cor", .5);
            }
            this.outputText("All of Jojo's tentacles seem to lose their strength, and he gently sets your violated body down ", false);
            if (cumPuddle) {
                if (milkPuddle)
                    this.outputText("in the puddle of cum and milk", false);
                else
                    this.outputText("in the puddle of spunk", false);
            }
            else {
                if (milkPuddle)
                    this.outputText("in the puddle of milk", false);
                else
                    this.outputText("on the ground", false);
            }
            this.outputText(".  You moan in frustration, feeling the fluid soak into your skin, secretly wishing he could've fucked you into unconsciousness.  ", false);
            this.outputText("The mouse kneels over you and begins licking your body, cleaning you with his tongue.  The tentacles join in, noisily slurping up every ounce of fluid from your form until you're clean and sated.  Sighing dreamily from the attention, you close your eyes and murmer, \"<i>Good boy.</i>\" When you open them, he's trotting away towards the forest, his tentacles well-hidden again...\n\n", false);
        ...
        //Jojo milk payments
        jojoMilkPay(tentacle = false) {
            this.jojoSprite();
            this.flags[kFLAGS_1.kFLAGS.JOJO_COCK_MILKING_COOLDOWN] = 4;
        ...
        milkJojoFirst() {
            ...
            //(Vagoozle!)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00333] > 0)
                    ...
                    this.outputText("You figure the machine will probably pump him for quite a while before it allows release", false);
                this.outputText(", and you're getting quite turned on from the show.  You shuck your " + this.player.armorName + " and reveal your " + this.vaginaDescript() + ", feeling your " + this.clitDescript() + " grow firm and hard.  For his part, Jojo doesn't even notice.  He just moans, squirms, and twitches any time he's brought particularly close to orgasm.  Seating yourself down below him, you let your fingers play across your now-wet folds, caressing your labia before you slide a few digits inside.  You brush your thumb against your clitoral hood and shudder from pleasure, enjoying watching your pet get milked as much as he's enjoying the milking.  ", false);
                if (this.player.clitLength > 3)
                    this.outputText("Your other hand grabs your penis-sized 'button' and begins to jack it, the action sending tremors of sensation through your " + this.hipDescript() + ".  ", false);
                this.outputText("Feeling naughty, you sit up straight and lick at Jojo's twitching balls, observing his shame as he squirms on your nose.\n\n", false);
                this.player.orgasm();
            }
            //(NEITHER!)
            else {
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00333] > 0)
                    ...
                    this.outputText("You figure the machine will probably pump him for quite a while before it allows release", false);
                this.outputText(", and while you're getting quite turned on from the show, you lack the equipment to take care of your lusts in a satisfactory way.  Meanwhile, Jojo is just moaning, squirming, and twitching each time he's brought close to orgasm.  You sit down and watch the machinery take your mouse-toy to task, wishing you had similar endowments you could be taking care of right now.\n\n", false);
                this.dynStats("lus", 50);
            }
            this.outputText("At long last, the appointed time has come, and Jojo lets out the most lewd-sounding squeak you've ever heard come from his mouth.  His ass-cheeks and legs clench and flex against their restraints", false);
            if (this.player.hasCock())
                this.outputText(", squeezing your " + this.cockDescript(x) + " with agonizingly pleasurable pressure", false);
            this.outputText(".  His back arches in ecstasy.  Most noticeably, the tube slurping on his cock is suddenly distorting as thick, round globules of mousey seed are sucked towards the wall.  The bulges are quickly smoothed out into one long, hose-dilating river of rodent-spooge.", false);
            if (!this.player.hasCock() && this.player.hasVagina())
                this.outputText("  His balls tremble and shrink in your mouth, pumping his prodigious semen out, wasting it in exchange for a pittance of gems.", false);
            this.outputText("\n\n", false);
            if (this.player.hasCock()) {
                //(Too big dick: 
                if (this.player.cockThatFits(40) < 0)
                    this.outputText("You release your cum all over Jojo's back, matting his white fur with cum.  Each successive splatter of spunk makes the mouse look even more like a semen-drenched whore.  It's a good look for him.", false);
                else
                    this.outputText("You pull out and release your cum all over Jojo's back, matting his white fur with cum.  Each successive splatter of spunk makes the mouse look even more like a semen-drenched whore.  It's a good look for him.", false);
            }
            else if (this.player.hasVagina())
                this.outputText("You climax and clamp down on your fingers, squeezing your hand as your own cries of pleasure mix with your cock-toy's milked-out moans.", false);
            else
                this.outputText("You sigh wistfully as Jojo ejaculates his load, wishing you could feel such exquisite sensations.  Maybe you can find something to give you some proper sexual organs soon?", false);
            this.outputText("  Though he cums for minutes on end, the machinery doesn't seem to have much problem keeping up.  Eventually the hose pops off and drags back towards the wall, leaking a small trail of mouse-spunk on the floor.\n\n", false);
            this.outputText("Jojo is lowered to the ground and released.  He immediately nuzzles against you, still trembling from the force of his orgasm and clearly thankful for the treat.  ", false);
        ...
        repeatMilkJojo(tentacle = false) {
            this.jojoSprite();
            this.outputText("", true);
            //Jojo Repeat Milking - Non Tentacle (edited)
            if (!tentacle || !this.tentacleJojo()) {
                this.outputText("You call for your corruption-filled mouse-pet, and Jojo immediately bounds out of the woods on all fours, his bloated dick practically dragging the ground as it dribbles behind him. He looks up at you with eyes full of hope, still remembering the pleasure of his last trip to the farm.  You sigh and say, \"<i>Yes, I'm going to take you for another milking.  Are your balls nice and full?  I expect you to earn me a few gems, my little cum-cow.</i>\"\n\n", false);
                this.outputText("Jojo nods his head eagerly and sits up on his haunches, his hand darting down to fondle his dick for you and show you just how much it dribbles now.  He seems to be more than ready for another session.  You start leading him to the farm, listening to him moan and pant behind you.  Drops of pre-cum splatter into the ground with every movement, and you realize he seems to be leaking a little more heavily than the last time the two of you embarked on this journey.  Somehow either the milkers or what you did originally must be slowly increasing his 'productivity' the more he empties out.  Perfect!\n\n", false);
                this.outputText("In no time, the two of you are back inside the barn.  Jojo practically leaps into the stall, helping you strap him into the harness in record time.  His dick ", false);
                if (this.jojoCumQ() < 1000)
                    this.outputText("has already dripped everywhere, making a mess of the floor.", false);
                else if (this.jojoCumQ() < 4000)
                    this.outputText("is drizzling a steady flow of man-slime, puddling on the floor.", false);
                else
                    this.outputText("is already pouring out a river of pre-cum, turning the floor into a slippery morass.", false);
                this.outputText("  The mouse is quickly immobilized and left to hang there, waiting on you to finish strapping him into his place.  You tune out his frantic whines and admire your handiwork.  Jojo is utterly restrained and hanging in the air.  His dick is throbbing and dripping in anticipation.  Even his balls are twitching and shuddering, aching to release their heavy cream.  You give his weighty orbs a squeeze and pull the last strap into place, activating the machinery.\n\n", false);
                this.outputText("Your white-furred slut is hauled up into the air, kept up high enough that he can't get any kind of traction.  He can barely move at all!  Well, most of him can barely move - the way his dick is bobbing around makes it clear that no matter how you tie him down, Jojo will find a way to squirm like a bitch.  Once again, the wall pops open and releases a thick tube.  Just looking at the pulsating purple opening, you can tell it will be a near-perfect fit for your fuckpet's throbbing erection.  The faint sounds of suction mix with wet squishes as the hose rises up, homing in on Jojo's bouncing shaft.\n\n", false);
                this.outputText("Lunging forward, the tube's opening slips around your mouse's cock-head, slurping it up as the sound of mechanized suction whines higher.  Jojo's own voice rises as well, matching the machine pitch for pitch as he moans in bliss.  Lurid slurps fill the barn as the tube greedily devours the mouse's boner, eventually coming to rest snugly against his groin and bouncing, squirming gonads.  Now that his member has been completely encapsulated by the machinery, Jojo sighs blissfully.  His hips are rocking gently against the restraints, as if it would somehow increase the pleasure coursing through his penis.  You know better - he gets to hang there on the edge for most of the next hour.\n\n", false);
                this.outputText("Giving your furry slut's clenching ass a smack, you walk around in front of him, nearly tripping over the bouncing tube as you change position.  Jojo's panting with his eyes nearly rolled back into his head.  Every fifteen seconds or so his body will clench, only to have the cock-sucker's motions slow torturously.  He squeals and squeaks each time as if it was the first time.  You scratch him behind his large, dish-shaped ears as words bubble up from within you.  \"<i>Good pet.  You love being milked.  Your balls get so full and heavy... so full of spunk.  They ache, don't they?  Yes... they hurt you so bad.  You get so much cum pent up in there, and you can't let it out, not without being sucked like this.  Shhh... shhh... it's okay.  Just enjoy how perfectly swollen your balls are getting.  You can let it out eventually.</i>\"\n\n", false);
                this.outputText("Jojo's eyes roll the whole way back for a moment, and his mouth begins to froth as he utterly caves in to his animal, pleasure-seeking instincts.  You lean back against a smooth part of the wall and shed your clothes, beginning to masturbate directly in front of your stall.  In time, your own pleasured moans draw your pet from his pleasure-induced stupor, and he watches with wide, bloodshot eyes as you bring yourself off to climax after climax", false);
                if (!this.player.hasCock() && !this.player.hasVagina())
                    this.outputText(", even though to do so you're forced to stimulate your " + this.assholeDescript(), false);
                this.outputText(".  His twitching rodent-nose sniffs at the air wildly as he pants, inhaling your scent between long, forlorn sounding moans.\n\n", false);
                this.outputText("Jojo's muscles seize, and you can tell his orgasm has arrived.  You smirk and lean closer, tugging an ear close to your mouth for another dose of 'encouragement'.  \"<i>Cum for me, pet.  Let all that spunk clogging up your balls boil out into the milker.  Give it all up for me.  Just let out every... thick... pent-up... liter of your seed.  Empty it all!  Cum and squirt until your balls are as empty as your virtue!</i>\"\n\n", false);
                //(\"<i>Normal</i>\" Jojo cum) 
                if (this.jojoCumQ() < 1000) {
                    this.outputText("Your poor semen-slave does not disappoint.  His balls, looking far more swollen than when you arrived, tremble beneath him in time with his bouncing cock, convulsing as they begin to obey your commands.  Big spheres of cum suddenly distend the hose, stretching it with their liquid weight as they're pumped away toward the wall.  Jojo happily squeaks with each fresh burst he releases, though he rapidly devolves into just constantly screeching and moaning as his dick begins to continually twitch, unloading the rest of his spermy cargo in one thick deluge.  He hangs over the slightly dilated, whirring hose as it slurps down all of his cum.  Eventually, the mouse is totally drained, and his body goes limp in the harness.\n\n", false);
                    this.outputText("The hose slides off Jojo's softening member and heads back to the wall, trailing mouse-slime as it goes.  At the same time, Jojo is lowered down to the floor.  He stands up on wobbling feet and stumbles down to kneel beneath you.  Looking up, he pants, \"<i>Did I cum enough?</i>\"\n\n", false);
                    this.outputText("You pat his head and answer, \"<i>Yes, for now.  I expect your swollen balls can do better next time though, can't they?</i>\"\n\n", false);
                }
                //(\"<i>Big</i>\" Jojo Cum)
                else if (this.jojoCumQ() < 4000) {
                    ...
                    this.outputText("Finished, the hose slides off Jojo's hard, cum-drooling cock and retracts towards the wall, leaving a messy trail of mouse-spunk in its wake.  At the same time, Jojo is lowered down to the floor.  He finds his bearings, waking up to stumble over to kneel before you.  Looking up, he pants, \"<i>Was... was that enough?</i>\"\n\n", false);
                    this.outputText("You pet him affectionately and answer, \"<i>Not too bad, pet.  I still think those balls of yours can do more.  Maybe someday you'll put out so much that the machine can't take it.  Only then will you be cumming enough for me.</i>\"\n\n", false);
                }
                //(\"<i>Victory</i>\" Jojo Cum)
                    ...
                    this.outputText("Finally finished, you release the tube and let it slither towards its home in the wall.  It burps out a wave of cum that stains the floor as it goes.  Meanwhile, Jojo's dick is still rock-hard and dumping his alabaster slime.  Once lowered to the ground, he rouses from his state and drops to his knees, right in the middle of his spunk-puddle.  With heavy-lidded eyes, he asks, \"<i>Did I cum enough?</i>\"\n\n", false);
                    this.outputText("You pet him affectionately and reply, \"<i>Yes you did.  You're such a good cum-slave.</i>\"\n\n", false);
                }
                this.jojoMilkPay();
                this.outputText("o on your way, dragging an exhausted mouse behind you as you head back towards camp.", false);
            }
        ...
        jojoPaysForPerms() {
            this.jojoSprite();
            this.outputText("", true);
            this.outputText("Lynnette the goblin answers the door and lets you in, waving you deeper into her shop.  Her shining black dress barely contains her fertile-hips and jiggling chest as she greets you, \"<i>Welcome back honey!  Who's the cutie?</i>\"\n\n", false);
            this.outputText("You answer that your pet mouse, Jojo will be taking care of payment for you today.  Lynnette looks doubtful, but she quickly drops to her knees in front of the mouse, determined to get her payment one way or another.  Jojo's forearm-length erection immediately makes itself apparent.  The goblin matron coos at the sight, humming happily once she sees the rivulets of pre-cum streaming down your slut's cock.  In one smooth motion, she devours the heavy mouse-shaft, sliding her lips down all the way to the base.\n\n", false);
            this.outputText("Jojo moans and reaches for Lynnette's hair, but you stop him with a sharp command.  He's paying for your services today, not getting a reward.  Big, lusty eyes look up at him from his loins, and he shudders, his heavy balls clenching and relaxing from the goblin's perfect throat-fuck.  She reaches up to caress them, ", false);
            if (this.jojoCumQ() >= 4000)
                this.outputText("and releases a surprised gurgle when she feels just how heavy and full they've gotten.  All that time at the milker has clearly done Jojo's body good, and Lynette is likely to leave with a mouse-milk mustache.", false);
            else if (this.jojoCumQ() >= 1000)
                this.outputText("and releases a surprised gurgle when she discovers their size.  Clearly all the trips to the milker have given Jojo an impressive set of testes.", false);
            else
                this.outputText("and rolls them back and forth in her fingers, expertly pleasuring Jojo.", false);
            this.outputText("  In no time flat he's reached the edge of his endurance.\n\n", false);
            this.outputText("Lynnette, for her part, has two wet stains on her blouse, but she ignores them as she gives the mouse's nuts a gentle squeeze.  He cums easily and hard from that little bit of extra stimulation.  The goblin's throat works to devour it all", false);
            if (this.jojoCumQ() < 1000)
                this.outputText(", readily swallowing most of it.  After a short time, she pulls back and lets him finish by filling her mouth.  In turn, she spits the sticky mess into a funnel that leads to who-knows-where.", false);
            else if (this.jojoCumQ() < 4000)
                this.outputText(", swallowing as much as she can.  Still, Jojo is pumping out enough that Lynette's belly quickly grows even more gravid, and the semen froths at the edges of her lips.  Eventually she just gives up and pulls off, aiming him at a funnel.  She keeps stroking his spit-slicked shaft as he's drained off that way, the goblin's grin growing a touch manic at the sight of that much seed being collected.", false);
            else
                this.outputText(", but there's no way she can keep up with Jojo's ridiculous cum-production.  Two jets of seed leave her belly stretched to its limit, and the goblin matron quickly pulls back with a panicked look in her eyes, barely aiming Jojo's spunk-sprayer at the funnel in time for it to be filled by the next blast.  Watching with rapt attention, the green-skinned girl smiles wider and wider when she realizes just how much your pet can produce.  It's quite some time before his flow tapers off, but Lynnette doesn't seem to mind at all.", false);
            this.outputText("  Perhaps one of her daughters has the other end of that pipe jammed into her pussy?\n\n", false);
            ...
            kGAMECLASS_1.kGAMECLASS.mountain.salon.salonPurchaseMenu();
        }
        //Scene 1: Amily Teaches Jojo How To Give Blowjobs. (Z)
        amilyTeachingJojoBJ() {
            this.clearOutput();
            //First time version	
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_AMILY_AND_JOJO_PLAYED_TIMES] == 0) {
                this.outputText("Your pet mice make an appearance as you're plotting your next move, Amily practically dragging Jojo behind her, ignoring the thick ropes of spunk he drizzles on the ground in his path.  He pants and whines, \"<i>-don't wanna suck cocks!  Fucking is totally better.</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_AMILY_AND_JOJO_PLAYED_TIMES]++;
            //Universal Outro
            this.outputText("  She seems visibly distracted by the mouse's boner, and will likely wind up fucking him soon.");
            if (this.player.hasCock())
                this.outputText(" Do you surprise them both by allowing Amily to demonstrate on you?");
            else
                this.outputText(" Do you want to watch them fuck?");
            this.menu();
            if (this.player.hasCock())
                this.addButton(0, "Demonstrate", this.BJRidesGETYOUONE);
        ...
        BJRidesGETYOUONE() {
            ...
            if (this.player.biggestCockArea() > 50)
                this.outputText("as much of your [cock biggest] as possible");
            else
                this.outputText("your entire [cock biggest]");
            this.outputText(" into her mouth and throat.  The tight warmth of your pet's puffy, corruption-engorged cock-sucker shoots tingling thrills of delight through your maleness, and as she's careful to guide the sensitive underside along her tongue as she swallows, [eachCock] soon stiffens to a full, throbbing erection.  You cannot help but groan at the skillful sucking, and when Amily pops off a moment later, she looks quite pleased with herself.");
            ...
            this.outputText("almost too great to resist.  Amily seems to sense this, obediently offering their bodies for your release. \"<i>[Master], would you like to fill your cum-slut's pussy or mouth?  Or maybe you want to give your bitch-boy a taste?</i>\"");
            ...
            this.simpleChoices("Amily's Mouth", this.fillAmilysMouth, "Amily's Pussy", puss, "Jojo's Mouth", this.fillJojosMouthWithHotStickyCum, "", undefined, "", undefined);
        }
        //Fill Amily's Mouth (Z)
        fillAmilysMouth() {
            this.amilyScene.amilySprite();
            this.clearOutput();
            this.outputText("You tell Amily to open wide, and she gleefully yanks your [cock biggest] away from Jojo.  He whines pathetically but, servile as he is, the mouse-boy");
            if (this.player.balls > 0)
                this.outputText(" leans down to desperately suckle at your [sack], subserviently worshipping your bloated testes and their liquid bliss one after another; tonguing, sucking, and moaning into the spunk - bloated mass of your ambrosial scrotum.");
            else
                this.outputText(" leans down to slurp needily at the bottom of your cock, licking it with languid tongue-strokes each time Amily gives him an opening.");
            this.outputText(" Amily looks up at you, her cute, succubi - like horns glinting in the light as she purrs, \"<i>Please, [master], give slut a throat-thick load to swallow.  Fill your nympho's mouth-pussy with sticky baby batter and splatter her whorish face with oozing leftovers.</i>\"");
        ...
        stuffAmilysMouthWithPostBJCUM() {
            ...
            this.outputText("on your rigid fuck-tool");
            this.outputText(".  She squeaks in surprise, her yelp turning into a high-pitched moan as your [cockHead biggest] widens in preparation for your looming orgasm.  Spunk forces your cum-slit open and sprays into Amily's clenching uterus, gorging her lascivious cunt with the virile seed it craves.  You hold her, impaled and squirming, as you continue to spray, inseminating her moist twat with squirt after squirt of oozing cock-nectar.[if (cumQuantity > 500)   Her belly rounds out delightfully from the extra stuffing.  You run a palm across it and smile when you feel your sperm churning under her stretched skin.][if (cumQuantity >= 1000) \"  Rivulets of spooge run from her overflowing pussy in thick cascades of pearl goo.  Jojo does his best to keep up, but even his growing lust for swallowing your cum can't match the volume of the salty surf foaming from the spasming girl's flush pussy.\"][if (cumQuantity >= 2000) \"  Amily's eyes roll back in complete pleasure as the pressure of your cum begins to cause the ejaculate to spout from her spunk-laden twat.  Jojo gives up on swallowing it all and leans back, opening wide to catch as much as possible as your second-hand seed showers the fallen monk, an ivory rain of hot slime splattering from your freshly stuffed slut's cream-sated cunny.\"]");
        ...
        amilyAndJojoFuck() {
            ...
            if (this.player.hasVagina())
                this.outputText(" It isn't until you notice how wet your crotch is that you come to the realization that you've masturbated yourself through a few orgasms as well.");
            else
                this.outputText(" It isn't until you notice how clearheaded you are that you come to the relaization that you've masturbated while watching the pair.");
            this.outputText(" Maybe you'll get to catch them in the act again?");
            this.player.orgasm();
            //{DONT FORGET PREGNANCY CHECK}
            //amilyPreggoChance();
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        jojoFollowerMeditate() {
            this.jojoSprite();
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Meditated) > 0) {
                this.outputText("Jojo smiles and meditates with you.  The experience is calming, but it's so soon after your last session that you don't get much benefit from it.", this.doClear);
                if (this.player.lust > 40)
                    this.dynStats("lus", -10);
            }
            else {
                this.outputText("The mouse monk leads you to a quiet spot away from the portal and the two of you sit down, him cross-legged and you mimicking to the best of your ability, back to back.  You close your eyes and meditate for half-an hour, centering your body and mind.  Afterwards, he guides you through stretches and exercises to help keep your bodies fit and healthy.\n\nWhen you are done, Jojo nods to you, and climbs back onto his rock, still thinking.", this.doClear);
                //Reduces lust
                ...
                if (this.player.str < 45)
                    this.dynStats("str", 1); //Str boost to 45
                if (this.player.tou < 45)
                    this.dynStats("tou", 1); //Tou boost to 45
                if (this.player.spe < 75)
                    this.dynStats("spe", 1); //Speed boost to 75
                if (this.player.inte < 80)
                    this.dynStats("int", 1); //Int boost to 80
                if (this.player.lib > 15)
                    this.dynStats("lib", -1); //Libido lower to 15
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Meditated, 1, 0, 0, 0);
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        jojoDefenseToggle() {
            this.jojoSprite();
            this.clearOutput();
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.JojoNightWatch) >= 0) {
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.JojoNightWatch);
                this.outputText("You tell Jojo that you no longer need him to watch the camp at night.  He nods, then speaks.  \"<i>Alright.  Please let me know if you require my help again.</i>\"");
            }
            else {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.JojoNightWatch, 0, 0, 0, 0);
        ...
        jojoAtCampRape() {
            this.jojoSprite();
            this.player.removeStatusAffect(StatusAffects_1.StatusAffects.JojoNightWatch);
            this.player.removeStatusAffect(StatusAffects_1.StatusAffects.PureCampJojo);
            this.clearOutput();
        ...
        postCombatRape() {
            this.jojoSprite();
            this.outputText("  You disrobe and prepare to ");
            if (this.monk == 5)
                this.outputText("fuck your violent little slut senseless.  ");
            else
                this.outputText("teach the uppity monk a lesson...\n\n");
            this.menu();
            this.addButton(0, "Next", this.jojoRape, true);
        }
        jojoRape(postCombat = false) {
            console_1.trace("jojoRape called");
            this.jojoSprite();
            this.player.slimeFeed();
            //Track Jojo rapeage
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.EverRapedJojo) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.EverRapedJojo, 1, 0, 0, 0);
            else
                this.player.addStatusValue(StatusAffects_1.StatusAffects.EverRapedJojo, 1, 1);
            switch (this.monk) {
                case 1:
                    this.jojosFirstRape();
                    break;
            ...
            this.doNext(this.camp.returnToCampUseOneHour);
            if (postCombat)
                this.getGame().cleanupAfterCombat();
        }
        jojosFirstRape() {
            this.clearOutput();
            this.outputText("You pretend to agree, and follow Jojo into the woods.  You bide your time, waiting for him to relax.  Eventually the mouse stumbles, and you have your chance!\n\n");
            if (this.player.gender == 1) {
                this.outputText("You push him hard, following through to pin his small frame.  He struggles but you twist his arm expertly and hold him down with your larger bodyweight.  He squirms as you tear off the bottom of his outfit, protesting mightily as you force him into the dirt and expose his toned bottom.\n\n");
                if (this.player.cockTotal() == 1) {
                    this.outputText("You grin and press your " + this.cockDescript(0) + " against him, making him squeal in protest.  You press on, eager to violate his puckered asshole, reveling in the crushing tightness.  His muscles quiver nervelessly as you pound him raw, his muted protests getting weaker as you notice a rapidly swelling bulge under him.  You reach around and begin jerking him off as you fuck him, fantasizing about pouring him full of corruptive demon power, making him your slave.  The dirty thoughts make your balls feel full; a pulsing, squeezing tightness builds in your nethers as your " + this.cockDescript(0) + " flexes and bulges inside your prey.  You cum hard, pressing his muzzle into the dirt as you pump glob after glob of cum up his ass, violating him to his core.\n\n");
                    this.outputText("With a satisfied sigh, you pull your " + this.cockDescript(0) + " out with an audible 'pop'.  Your cum begins leaking out, pooling under him and mixing with his own.  The little guy must have cum hard; he seems fairly comatose.  As you leave your senseless victim, you realize  you feel more satisfied than you have in a while, almost like you've cum so hard it took some of your libido with it.");
                    this.player.orgasm();
                    this.dynStats("lib", -10, "cor", 4);
                    this.monk += 1;
                }
                else {
                    this.outputText("You grin and press your " + this.multiCockDescriptLight() + " against him, making him squeal in protest.  You press on, eager to violate his tight asshole, reveling in the crushing tightness.  His muscles quiver nervelessly as you pound him raw, his muted protests getting weaker as you notice a rapidly swelling bulge under him.  You reach around and begin jerking him off as you fuck him, fantasizing about pouring him full of corruptive demon power, making him your slave.  The dirty thoughts make your balls feel full, a pulsing squeezing tightness building in your nethers as your " + this.cockDescript(0) + " flexes and bulges inside your prey.  You cum hard, pressing his muzzle into the dirt as you pump glob after glob of cum up his ass, violating him to his core.  Cum sprays over his ass, the rest of your equipment soaking him as it cums as hard as the one you sank up into the mouse-hole.\n\n");
                    this.outputText("With a satisfied sigh, you pull your " + this.cockDescript(0) + " out with an audible 'pop'.  Your cum begins leaking out, pooling under him and mixing with his own.  The little guy must have cum hard, he seems fairly comatose.  As you leave your senseless victim, you realize  you feel more satisfied than you have in a while, almost like you've cum so hard it took some of your libido with it.");
                    this.player.orgasm();
                    this.dynStats("lib", -10, "cor", 4);
                    this.monk += 1;
                ...
                this.outputText("You smack the back of his head hard, dazing him.  You spin him around as you take his feet out from under him, one hand pulling his pants while the other slashes his belt.  He literally 'falls out of his pants' and onto the soft earth of the forest.  You pounce on the stunned monk, shedding your own clothes and pinning him to the ground.  He begins to resist, squirming under you, ");
                if (this.player.wetness() < 2) {
                    this.outputText("but the sensation of you grinding your folds against him momemtarily breaks his will.  ");
                }
                else {
                    this.outputText("but the feeling of your " + this.vaginaDescript(0) + " grinding against his hardening cock robs him of any will.  ");
                }
                this.outputText("You smile when you realize how large he is for his frame, and mount him, taking care to keep him pinned hard to the ground.");
                this.player.cuntChange(12, true, true, false);
                this.outputText("\n\n");
                this.outputText("He lets out little grunts and whines of protest as you ride him hard, but quickly cums.  The flood of warmth inside your canal only serves to spur you on, slamming your " + this.vaginaDescript(0) + " down on him with brutal force.  You envision yourself raping others, corrupting all those you come across with your needy pussy.  You imagine what it must be like to be a succubus, fucking poor monks like this, your magics making your victim's manhood ever larger.  The thought breaks over you like a wave and you cum, hard; your " + this.vaginaDescript(0) + " clamps down hard on Jojo's cock as he finds himself cumming again, eyes rolling back in his head.  You shudder and moan, cum squirting out of your fuck-hole with each bounce on the poor mouse.");
                if (this.player.biggestLactation() >= 1 && this.player.biggestLactation() < 2) {
                    this.outputText("  Milk squirts from  your nipples, spraying him down with small droplets of your creamy tit-treat.");
                }
                if (this.player.biggestLactation() >= 2 && this.player.biggestLactation() < 3) {
                    this.outputText("  Streams of milk spray from your nipples in time with your pussy contractions, hosing the poor mouse down and puddling on his fur.");
                }
                if (this.player.biggestLactation() >= 3) {
                    this.outputText("  Gouts of milk erupt from your nipples, spraying continually as you cum.  The poor mouse is soaked from head to toe, your cream utterly drenching the monk.");
                }
                ...
                this.monk += 1;
                //Preggers chance!
                this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_JOJO, PregnancyStore_1.PregnancyStore.INCUBATION_MOUSE + 82); //Jojo's kids take longer for some reason
            }
            else if (this.player.gender == 3) {
                console_1.trace("gender3");
                this.outputText("You push him hard, following through to pin his small frame.  He struggles but you twist his arm expertly and hold him down with your larger bodyweight.  He squirms as you tear off the bottom of his outfit, protesting mightily as you force him into the dirt and expose his toned bottom.\n\n");
                if (this.player.cockTotal() == 1) {
                    ...
                    this.outputText("\n\nWith a satisfied sigh, you pull your " + this.cockDescript(0) + " out with an audible 'pop'.  Your cum begins leaking out, pooling under him and mixing with his own.  The little guy must have cum hard, he seems fairly comatose.  As you leave your senseless victim, you realize  you feel more satisfied than you have in a while, almost like you've cum so hard it took some of your libido with it.");
                    this.player.orgasm();
                    this.dynStats("lib", -10, "cor", 4);
                    this.monk += 1;
                }
        ...
        jojosSecondRape() {
            this.clearOutput();
            this.outputText("The poor mouse is already hard... his cock is throbbing eagerly as it protrudes through the opening in his robe, looking nearly eight inches long.  You're pretty sure it wasn't that big last time.\n\n");
            this.monk += 1;
            this.player.orgasm();
            this.dynStats("lib", -10, "cor", 4);
            if (this.player.gender == 1) {
                this.outputText("You force Jojo over a log, running your hands through his fur and slapping his ass.  He grunts, but it's impossible to tell if it's in frustration, anger, or arousal.  You quickly force yourself back into his ass, finding it noticably stretched from your last incursion.  ");
                if (this.player.averageCockThickness() >= 3)
                    this.outputText("It makes little difference to your " + this.cockDescript(0) + ", he still feels tight as a virgin's cunt to you.  ");
                this.outputText("You grab him by the waist and fuck him powerfully, slamming your " + this.cockDescript(0) + " in brutally hard and fast.  You notice his hands are in his crotch, feverishly masturbating his disproportionately large cock like a slut.  You start leaking pre-cum like a sieve, realizing you're doing it, really doing it - making this virtuous mouse into a wanton slut!  You squeeze him tightly as you cum into his bowels, his belly distending slightly as your orgasm goes on and on.  Trails of cum run down his fur as it becomes more than his ass can handle.");
                if (this.player.cockTotal() > 1)
                    this.outputText("  Your remaining equipment showers him with jizz, more than you ever thought you could produce.");
                this.outputText("  The mouse moans and cums himself, with loud moans and messy splurts coating the ground every time your hips meet.\n\n");
                this.outputText("Eventually it ends, and you drop him into the puddled spooge like a used condom.  He lays there, idly stroking himself in a daze, his prick still swollen with need and dripping fluids.  You can't wait to corrupt him some more.");
            }
            if (this.player.gender == 2 || this.player.gender == 3) {
                this.outputText("You throw him on the soft soil of the forest and mount him, skillfully guiding his member towards your now dripping wet hole.  As you slide down you marvel at how he feels larger and thicker than before, deliciously so.  Your " + this.vaginaDescript(0) + " throbs in the most pleasant way as you rape his small form.  You play with your clit, watching Jojo's face flit between rapture and disgust.  You lick your lips and smile as the disgust vanishes, his hot jets of cum painting your cunt-walls.  You giggle and keep fucking him, hoping that somehow your corruption and lust are influencing him, turning him into your personal fucktoy.  The thought brings you over the edge.  You clamp down, your " + this.vaginaDescript(0) + " milking, squeezing every last drop from him as his prick erupts inside you.  ");
                ...
                if (this.player.averageVaginalWetness() == 5)
                    this.outputText("Your " + this.vaginaDescript(0) + " drenches him with your squirting girl-cum, mixed with his own seed.");
                if (this.player.cockTotal() == 1)
                    this.outputText("Jizz sprays onto his chest from your " + this.cockDescript(0) + ".  ");
                if (this.player.cockTotal() == 2)
                    this.outputText("A hail of jizz splatters over Jojo from your " + this.multiCockDescriptLight() + ".  ");
                if (this.player.cockTotal() == 3)
                    this.outputText("A multitude of thick cum-streams splatter over Jojo from head to waist as your " + this.multiCockDescriptLight() + " hose him down.  ");
        ...
        jojosThirdRape() {
            this.clearOutput();
            console_1.trace("Monk(3) rape");
            this.outputText("It's no wonder the monk's body has betrayed him so thoroughly, his " + this.monster.cockDescriptShort(0) + " is nearly ten inches long, pulsing with hot need.\n\n");
            if (this.player.gender == 1) {
                this.outputText("You yank Jojo up from the ground and onto his knees, ");
                if (this.player.cockTotal() == 1) {
                    this.outputText("presenting your " + this.cockDescript(0) + " to him.  ");
                }
                else
                    this.outputText("presenting your " + this.multiCockDescriptLight() + " to him.  ");
                this.outputText("The monk betrays his violated state of mind, licking his lips demurely and opening wide.  The invitation is all you need ");
                if (this.player.cockTotal() == 1)
                    this.outputText("to ram your " + this.cockDescript(0) + " deep into his maw.  You roughly grab his ears, facefucking him hard, his tongue working hard to please.  ");
                if (this.player.cockTotal() > 1)
                    this.outputText("to cram two cocks deep into his maw, making his jaw stretch obscenely.  You roughly grab his ears, facefucking him hard, his tongue working hard to please you.  ");
                this.outputText("One of Jojo's paws is buried in his groin, stroking his " + this.monster.cockDescriptShort(0) + " with feverish intensity.  The hornier he gets, the more his throat seems to relax, allowing you to push deeper.  The glazed, lust-addled look on his face is so hot, you can't hold back any longer.  ");
                if (this.player.cockTotal() == 1)
                    this.outputText("Your " + this.cockDescript(0) + " clenches tightly, erupting ");
                if (this.player.cockTotal() > 1)
                    this.outputText("Your twin dicks clench tightly, erupting ");
                this.outputText("hot seed into the now meek and subdued bitch-boy.  His throat squeezes around you as he presses his nose tightly against your crotch, pulling as much of you in as he can.  Mouse-spunk spatters your legs as he cums with you.\n\n");
                if (this.player.lib > 60 && this.player.cor > 40) {
                    this.outputText("You flip him onto his back, both of you still hard and ready for more.  He gets up on all fours and wiggles his bum tantalizingly.  You press on, ");
                    if (this.player.cockTotal() == 1)
                        this.outputText("violating his loosened sphincter, and begin to fuck him hard.  He whimpers with a mixture of pain and pleasure, your spit-lubed " + this.cockDescript(0) + " pounding his prostate mercilessly.  Thick ropes of mousey-cum drool with each anus-stretching thrust of your cock, pooling below you.  You wickedly smile, slapping his ass, imagining him stretched further, his ass gaping, his cock huge and dripping with cum.  The strange thoughts filling your mind seem to travel straight to your balls and distill into pools of cum.  Like a long dormant volcano, you erupt, hot liquid spraying into Jojo, pumping his ass full and leaking down his legs.  He cums again, harder than before, his pulsing prick seeming to grow larger throughout his orgasm.\n\n");
                    else
                ...
                this.outputText("You leave the exhausted mousey behind you, wondering how you'll take him next time.  ");
                this.player.orgasm();
                if (this.player.lib > 60 && this.player.cor > 40) {
                    this.outputText("You smile as you hear him begin masturbating in the background.  There can be no doubt, you are tainting him more and more...");
                    this.monk += 1;
                    this.dynStats("lib", -10, "cor", 4);
                }
                else {
            ...
            if (this.player.gender == 2) {
                if (this.player.isBiped())
                    this.outputText("You spread your legs and crook your finger");
                else
                    this.outputText("You crook your finger");
                this.outputText(", beckoning him towards your " + this.vaginaDescript(0) + ".  He looks disheartened, but obediently kneels before you, his whiskers tickling your " + this.vaginaDescript(0) + ", his wet nose bumping your clit, his tongue taking long licks between your lips.  ");
                if (this.player.biggestTitSize() >= 2) {
                    this.outputText("You sigh and knead your breasts in pleasure.  ");
                }
                if (this.player.biggestLactation() >= 1.5 && this.player.biggestTitSize() > 2 && this.player.mostBreastsPerRow() >= 2 && this.player.breastRows.length >= 1)
                    this.outputText("Every sensual peak within you is mirrored with small spurts of milk from your nipples.  It eventually trickles down to Jojo's tongue, spurring his efforts on.  ");
                this.outputText("The mousey gets more and more in to eating your box, making it harder and harder to stave off an orgasm.  You wrap ");
                if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_NAGA)
                    this.outputText("your coils ");
                else if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_GOO)
                    this.outputText("your jiggling goo ");
                else
                    this.outputText("your thighs ");
                this.outputText("around his head and quiver with passion, ");
                if (this.player.averageVaginalWetness() <= 1)
                    this.outputText("squeezing him tightly into your " + this.vaginaDescript(0) + ".");
                if (this.player.averageVaginalWetness() > 1 && this.player.averageVaginalWetness() <= 3)
                    this.outputText("creaming his tongue liberally with girlcum.");
                if (this.player.averageVaginalWetness() == 4)
                    this.outputText("creaming all over him with your slobbering pussy.");
                if (this.player.averageVaginalWetness() == 5)
                    this.outputText("splattering him with girlcum from your " + this.vaginaDescript(0) + ".");
                this.outputText("\n\nYou pull the cunt-dazed mouse away reluctantly, and bend over,");
                if (this.player.isBiped())
                    this.outputText(" spreading your legs and");
                this.outputText(" shaking your rump.  ");
                if (this.player.hasLongTail())
                    this.outputText("Your tail swishes back and forth teasingly.  ");
                this.outputText("Your tantalizing backside is too much for him.  He pounces your ass in a second, penetrating your " + this.vaginaDescript(0) + " forcefully.  The knowledge that your demonic influence is responsible for his state nearly makes you cream all over his cock.  You fantasize about your cunt making his cock grow longer and fatter as it corrupts him further, transforming his morals and values into cock and cum.  Jojo thrashes against you, brutally pounding your " + this.vaginaDescript(0) + " as he orgasms.  His " + this.monster.cockDescriptShort(0) + " erupts inside you, the feeling of being filled with mouse-spunk drives you over the edge with him.  More and more of his cum sprays inside you, unnatural amounts for a creature his size.  Thick streams of the stuff escape down your thighs as your belly distends.  ");
                this.player.cuntChange(2, true);
                this.outputText("\n\n");
                this.outputText("You let the drained mouse pop free, reveling in the sensation of cum pouring from");
                if (this.player.isBiped())
                    this.outputText(" between your thighs");
                else
                    this.outputText(" your cunt");
                this.outputText(".  Jojo has already passed out behind you.  ");
                this.player.orgasm();
                if (this.player.lib > 60 && this.player.cor > 50) {
                    this.outputText("You lean down and whisper strange un-words as you stroke his cock.  It spasms and grows, cum pumping from it slowly but constantly.  You walk away, leaving him in a growing puddle of what was once his morals.  You don't know where the words came from, but you do know you're getting better at tempting and corrupting.");
                    this.monk += 1;
                    this.dynStats("lib", -10, "cor", 4);
                }
                else {
            ...
            if (this.player.gender == 3) {
                if (this.player.isBiped())
                    ...
                    this.outputText("You crook your finger");
                this.outputText(", beckoning him towards your " + this.vaginaDescript(0) + ".  He looks disheartened, but obediently kneels before you, his whiskers tickling, his wet nose bumping your clit, his tongue taking long licks between your lips.  ");
                if (this.player.cockTotal() == 1)
                    this.outputText("You sigh as your " + this.cockDescript(0) + " droops over his head.  ");
                if (this.player.cockTotal() > 1)
                    this.outputText("You sigh as your " + this.multiCockDescriptLight() + " pile atop his head.  ");
                if (this.player.biggestTitSize() >= 2) {
                    this.outputText("You kneed your breasts, excited and filled with pleasure.  ");
                }
                if (this.player.biggestLactation() >= 1.5 && this.player.biggestTitSize() > 2 && this.player.mostBreastsPerRow() >= 2 && this.player.breastRows.length >= 1)
                    this.outputText("Every sensual peak within you is mirrored with small spurts of milk from your nipples.  It eventually trickles down to Jojo's tongue, spurring his efforts on.  ");
                this.outputText("The mousey gets more and more into eating your box, making it harder and harder to stave off an orgasm.  You wrap your thighs around his head and quiver with passion, ");
                if (this.player.averageVaginalWetness() <= 1)
                    this.outputText("squeezing him tightly into your " + this.vaginaDescript(0) + ".");
                ...
                if (this.player.averageVaginalWetness() == 4)
                    this.outputText("creaming all over him with your slobbering pussy.");
                if (this.player.averageVaginalWetness() >= 5)
                    this.outputText("splattering him with you girlcum from your " + this.vaginaDescript(0) + ".");
                if (this.player.cockTotal() > 0)
                    this.outputText("  Thick runners of your pre dribble down his neck, sticking to his fur.  ");
                this.outputText("\n\nYou pull the cunt-dazed mouse away reluctantly, and bend over,");
                if (this.player.isBiped())
                    this.outputText(" spreading your legs and");
                this.outputText(" shaking your rump.  ");
                ...
                this.player.cuntChange(2, true);
                if (this.player.cockTotal() == 1)
                    this.outputText("Your " + this.cockDescript(0) + " trembles in orgasm, squirting your load into the thick forest loam.  ");
                if (this.player.cockTotal() > 1)
                    this.outputText("Your " + this.multiCockDescriptLight() + " tremble in orgasm, squirting their hot loads all over the thick forest loam.  ");
                this.outputText("\n\n");
                this.outputText("You let the drained mouse pop free, reveling in the sensation of cum pouring from ");
                if (this.player.isBiped())
                    this.outputText("between your thighs");
        ...
        jojosFourthRape() {
            this.clearOutput();
            this.outputText("Jojo flops down, eyes filled with anticipation.  His self-control has really slipped away.  The corrupted and horny mouse on display here is anathema to the studious monk you met before.  His cock is close to a foot long and over two inches thick, veiny with arousal.\n\n");
            //Male Version
            if (this.player.gender == 1) {
                this.outputText("The mousy former-monk kneels as you disrobe, his will nearly broken by desire.  ");
                if (this.player.cockTotal() == 1)
                    this.outputText("You touch his head softly and guide him to your " + this.cockDescript(0) + ", smiling as he licks his lips with anticipation.  You gasp at the feeling of his soft lips and wet tongue as he pleasures you, your knees going weak from his efforts.  Jojo cups your balls and slips a fuzzy finger into your ass.  He labors to take as much of you as possible into his mouth, panting warmly and wetly around your " + this.cockDescript(0) + ".  You twitch in pleasure as he alternates pressure on your prostate with smooth strokes of his slick tongue.  ");
                else
                    this.outputText("You touch his head softly and guide him to your " + this.multiCockDescriptLight() + ", smiling as he licks his lips in anticipation.  You gasp at the feelings of his soft lips and wet tongue on your heads as he pleasures you, your knees going weak from his efforts.  Jojo cups your balls and slips a fuzzy finger into your ass.  He labors to take in two shafts, struggling to swallow them as deep as possible, panting wetly around you.  You twitch with pleasure as he alternates pressure on your prostate with smooth strokes of his slick tongue.  ");
                //Too thick for him
                if (this.player.averageCockThickness() > 3 || (this.player.dogCocks() > 0 && this.player.averageCockThickness() > 3))
                    this.outputText("Jojo is forced to back off of your " + this.cockDescript(0) + " from time to time to come up for air, barely opening his jaw wide enough to take your girth back inside his mouth.  ");
                //Too long for him
                if (this.player.averageCockLength() > 10 || (this.player.horseCocks() > 0 && this.player.averageCockLength() > 10))
                    this.outputText("He struggles not to gag on your " + this.cockDescript(0) + "'s length, opening his throat as far as he can.  ");
                this.outputText("You rock back and forth on his face as he expertly keeps you on the edge of orgasm.  ");
                if (this.player.cumQ() > 25)
                    this.outputText("Your constant stream of heavy pre practically chokes the poor mouse as he edges you mercilessly, his own equipment drizzling in sympathetic lust.  ");
                this.outputText("Jojo presses his paw hard into your ass, squeezing your prostate tightly as his hot muzzle dives deeply over your cock.  You feel the building tightness of your orgasm and pull him tightly against you as the pressure builds.  ");
                if (this.player.cumQ() < 25)
                    this.outputText("You buck against him as you orgasm, your small squirts of cum eagerly devoured by the slutty mouse.");
                if (this.player.cumQ() >= 25 && this.player.cumQ() < 250)
                    this.outputText("You buck against him as you orgasm, the slutty mouse's throat squeezing against you as he works to swallow your seed.");
                if (this.player.cumQ() >= 250 && this.player.cumQ() < 500)
                    this.outputText("You spasm against him as you orgasm, the pleasure erupting into the slut-mouse's throat as he tries to swallow it all.  Excess cum dribbles from the corners of his mouth as you fully spend yourself.");
                if (this.player.cumQ() >= 500)
                    this.outputText("You buck against him as you orgasm, the slutty mouse's cheeks bulging in surprise as your cum explodes into his mouth.  Thick streams escape from the corners of his muzzle, your seed pouring into him faster than he can swallow.  Eventually you finish, and see the mouse dripping with your spunk nearly to the waist, a small bulge in his belly.");
                this.outputText("  Jojo leans back, panting for breath, a dull smile on his face.  He spits a load of your cum into his paw and begins jerking himself off with it, lewdly putting on a show for you.\n\n");
                if (this.player.lib > 50 && this.player.cor > 80) {
                    this.outputText("<b>You feel a familiar power growing within you and decide to unleash it.</b>  You grab the prayer beads from his outfit and spit on them, making them slick and wet.  Holding them below your flagging cock, you focus on the demonic visions in your mind, slowly but constantly milking larger and larger dollops of cum onto the once holy beads.  Jojo moans as he comes to understand your intent, and turns around, shaking his lithe mouse-bum at you.  You lean over him, whispering into his ear, \"<i>Each defiled bead I push into you is going to make you more of a willing slut.  More of a willing receptacle for demon cum.  More of a fountain of desire waiting to be tapped by Succubi.  More my toy.</i>\"\n\n");
                    this.outputText("He whimpers as you slide the first bead in, his eyes growing foggy and his bum wiggling more eagerly.  You push the second bead inside him, and feel his asshole stretch and loosen, welcoming the corruption.  The third bead slips right in, and he moans, \"<i>sluuuut</i>,\" His cock grows longer and thicker throughout the moan, stopping at over a foot long and 3 inches thick, dribbling cum.  You whisper, \"<i>Cum, my Toy,</i>\" and push the remaining beads inside him.  His eyes roll back as his paws frantically milk his " + this.monster.cockDescriptShort(0) + ", cum spraying from him like a fountain.  Jojo trembles, losing complete control and falling away from you.  You still hold the end of his beads, and smile as they pop out, stained almost as dark as the poor mouse's soul.\n\n");
                    this.outputText("You walk away, leaving your new pet to explore his outlook on life, and to test your awakened powers.  ");
                    this.monk += 1;
                    this.player.orgasm();
                    this.dynStats("lib", -10, "cor", 10);
                }
                else {
                    this.outputText("Jojo eventually cums violently, collapsing into a puddle of spent jizz.  You smile and walk away, hoping to encounter him again.  ");
                    this.player.orgasm();
                    this.dynStats("lib", 2, "cor", 1);
                }
            }
            ...
            if (this.player.gender == 2 || this.player.gender == 3) {
                //Oral
                this.outputText("The mousy once-monk kneels as you disrobe, his will nearly broken by desire.  ");
                this.outputText("You touch his head softly, guiding him to your " + this.vaginaDescript(0) + ", lips breaking into a grin as he licks his mouth with desire.  You gasp at the feeling of his wet nose as it bumps against your groin, shooting thunderbolts of pleasure from your " + this.clitDescript() + ".  He attacks with his tongue, thrusting strikes practically attacking your " + this.vaginaDescript(0) + " with his long, practically serpentine, tongue.  You shudder, knowing a visible sign of corruption when you see it, moisture slicking the mouse's face.\n\n");
                this.outputText("Jojo moans into your folds as his " + this.monster.cockDescriptShort(0));
                if (this.player.isBiped())
                    this.outputText(" brushes against your calf");
                else
                    this.outputText(" brushes against your [leg]");
                this.outputText(".  You get a devilish idea, ");
                if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_GOO)
                    this.outputText("and push his " + this.monster.cockDescriptShort(0) + " in between folds of slime, sandwiching it in a mass of slippery, gooey tightness.  Holding his shoulder for balance, you slowly squeeze him, gently milking out small dribbles of pre.  He redoubles his efforts, burying his nose into your " + this.vaginaDescript(0) + ", tongue swirling over your folds and around your " + this.clitDescript() + ".  For every effort on his part you step up your own, squeezing and stroking him with your goo, doing your best to impart a fetish for being masturbated with someone's lower body on his slowly warping mind.  You feel a hot wetness in your slime, and it grows slicker and wetter every second. Jojo's cum drips out of you, glazing your jello-like form white.  ");
                else
                    this.outputText("and push his " + this.monster.cockDescriptShort(0) + " with your " + this.player.foot() + ", sandwiching it under one " + this.player.foot() + " and on top of the other.  Holding his shoulder for balance, you slowly squeeze him, gently milking out small dribbles of pre.  He redoubles his efforts, burying his nose into your " + this.vaginaDescript(0) + ", tongue swirling over your folds and around your " + this.clitDescript() + ".  For every effort on his part you step up your own, squeezing and stroking him with your " + this.player.feet() + ", doing your best to impart a " + this.player.foot() + " fetish on his slowly warping mind.  You feel a hot wetness on your " + this.player.feet() + ", and they grow slicker and wetter every second. Jojo's cum drips out from between them, glazing them white.  ");
                if (this.player.averageVaginalWetness() <= 1)
                    this.outputText("You clamp down on his muzzle as you writhe in orgasm.  ");
                if (this.player.averageVaginalWetness() > 1 && this.player.averageVaginalWetness() <= 3)
                    this.outputText("Your legs trap his muzzle in your " + this.vaginaDescript(0) + " as orgasm wracks your body.  ");
                if (this.player.averageVaginalWetness() == 4)
                    this.outputText("Your legs trap his muzzle in your " + this.vaginaDescript(0) + ", slicking his muzzle with girlcum as you spasm with bliss.  ");
                if (this.player.averageVaginalWetness() == 5)
                    this.outputText("Your legs squeeze him against your " + this.vaginaDescript(0) + ", girlcum erupting over his face and soaking him as you bliss out with orgasm  ");
                if (this.player.cockTotal() == 1)
                    this.outputText("Your " + this.cockDescript(0) + " drizzles cum in his hair, some dripping off by his ear.  ");
                if (this.player.cockTotal() > 1)
                    this.outputText("Your " + this.cockDescript(0) + "s drizzle him with cum, covering his head with thick white streams of your jizz.  ");
                this.outputText("Twitching weakly with pleasure, you fall back.\n\n");
                //Fux!
                this.outputText("The pleasure was magnificent... but you want MORE.  You push yourself up, feeling pleased as you spy Jojo stroking his cum-slick " + this.monster.cockDescriptShort(0) + ", thick streams of cum leaking from the tip.  You pounce on him, pushing him down on the ground, and position your " + this.vaginaDescript(0) + " over him, allowing him to scent your sex.  With a triumphant smile, you sink down onto him, impaling yourself on his " + this.monster.cockDescriptShort(0) + ".  ");
                if (this.player.averageVaginalLooseness() == 0)
                    this.outputText("He is painfully large, so much so that you feel more pain than pleasure.  ");
                if (this.player.averageVaginalLooseness() == 1)
                    this.outputText("He stretches you around him like a latex glove, pulling your " + this.vaginaDescript(0) + " taught with his " + this.monster.cockDescriptShort(0) + ", the sensation riding a razor's edge between pleasure and pain.  ");
                if (this.player.averageVaginalLooseness() == 2)
                    this.outputText("His " + this.monster.cockDescriptShort(0) + " stuffs you completely, filling your " + this.vaginaDescript(0) + " to capacity.  ");
                if (this.player.averageVaginalLooseness() == 3)
                    this.outputText("His " + this.monster.cockDescriptShort(0) + " fits you perfectly, burying deep inside your folds.  ");
                if (this.player.averageVaginalLooseness() == 4)
                    this.outputText("You easily accomadate his member into your " + this.vaginaDescript(0) + ".  ");
                if (this.player.averageVaginalLooseness() == 5)
                    this.outputText("His " + this.monster.cockDescriptShort(0) + " slips inside your " + this.vaginaDescript(0) + " with little resistance, easily sinking in to the hilt.  You muse to yourself, \"<i>If only he were thicker...</i>\"  ");
                this.outputText("You ride him slowly, gyrating your hips in tiny grinding circles while you run your hands through his fur.  His hips bounce you gently with tiny twitching thrusts, cum pooling out of your " + this.vaginaDescript(0) + " as it continues to drip from him.  ");
                this.outputText("He gradually ups the tempo, and you are forced to go along for the ride as you begin to bounce on his " + this.monster.cockDescriptShort(0) + ".  You grab fistfuls of his fur and hang on as he begins pounding your " + this.vaginaDescript(0) + ", his huge balls slapping against you.  Cum squirts from your pussy with each of his violent thrusts, more pouring deep inside you continually.  Jojo squeals with glee and slams his hips into yours a final time, triggering an eruption of seed in your channel.  You feel it pouring into your womb, slowly distending your belly with every shuddering pump of cum.  You orgasm helplessly, fingering your " + this.clitDescript() + " the whole time.  ");
                //Futacawk here
                if (this.player.cockTotal() > 0) {
                    //Single Cock
                    if (this.player.cockTotal() == 1) {
                        ...
                        if (this.player.horseCocks() == 1)
                            this.outputText("Your " + this.cockDescript(0) + " feels a building pressure, the whole thing pulsating wildly with each of your heartbeats, most noticably the tip, which flares out wildly.  Powerful contractions wrack your sheath and " + this.cockDescript(0) + " as pre practically fountains from it.  ");
                        //DogFun!
                        if (this.player.dogCocks() == 1)
                            this.outputText("Your " + this.cockDescript(0) + " feels an intense pressure, and begins bulging out obscenely above your sheath.  The knot thickens gratuitiously, filling as it pulses with need.  Cum drips from your pointed tip as it continues to bulge wider, filling you with unbearable pressure.  ");
                        //Else
                        if (this.player.normalCocks() == 1)
                            this.outputText("Your " + this.cockDescript(0) + " twitches, muscle contractions slowly working their way up from the base.  ");
                        //CUMSPLOISION
                        if (this.player.cumQ() < 25)
                            this.outputText("Your body tenses and cums, spraying spurts of jizz over the mouse.  ");
                        if (this.player.cumQ() >= 25 && this.player.cumQ() < 250) {
                            if (this.player.horseCocks() == 1)
                                this.outputText(" Your " + this.cockDescript(0) + " flares wildly as musky horse-cum erupts from it, splattering over Jojo.  ");
                            if (this.player.dogCocks() == 1)
                                this.outputText("The terrible pressure in your " + this.cockDescript(0) + " finally relents, in the form of a fountain of doggie-cum, spraying out from your " + this.cockDescript(0) + " in a steady stream that seems to last and last.  ");
                            if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.HUMAN || this.player.cocks[0].cockType.Index > 2)
                                this.outputText("Your body tenses and cums a thick eruption far beyond what a normal human could produce.  Jojo is splattered with the stuff.  ");
                        }
                        if (this.player.cumQ() >= 250) {
                            if (this.player.horseCocks() == 1)
                                this.outputText("Your " + this.cockDescript(0) + " ripples and bulges with animalistic vigor, horse-cum splattering everywhere with each contraction.  The musky animal-jizz never seems to stop pouring from your equine organ, soaking the mouse from the waist up.  ");
                            if (this.player.dogCocks() == 1)
                                this.outputText("Your " + this.cockDescript(0) + " suddenly releases the pressure, a constant stream of doggie-cum spouting from your " + this.cockDescript(0) + " like some kind of cum-hose.  It seems to go on endlessly, covering the mouse from the waist up with thick ribbons of doggie-spooge as your knot slowly shrinks to normal.  ");
                            if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.HUMAN || this.player.cocks[0].cockType.Index > 2)
                                this.outputText("Your body tenses and cums a thick eruption far beyond what a normal human could produce.  Jojo is splattered with the stuff.  ");
                        }
                    }
                    ...
                    if (this.player.cockTotal() > 1) {
                        this.outputText("Your cocks feel a building pressure at their base. It only seems to get stronger and stronger, until at last it explodes out from you, jizz covering the poor mouse from the waist up.  ");
                    }
                }
                //Milk here
                if (this.player.biggestLactation() >= 1 && this.player.biggestTitSize() > 3) {
                    if (this.player.biggestTitSize() * this.player.biggestLactation() * this.player.breastRows.length < 8)
                        this.outputText("Milk sprays from your " + this.breastDescript(0) + " in tiny streams, triggered by your orgasms.");
                    if (this.player.biggestTitSize() * this.player.biggestLactation() * this.player.breastRows.length < 20 &&
                        this.player.biggestTitSize() * this.player.biggestLactation() * this.player.breastRows.length >= 8)
                        this.outputText("Milk erupts from your " + this.breastDescript(0) + ", spraying out over the mouse, squirting out the contractions of each shuddering orgasm.");
                    if (this.player.biggestTitSize() * this.player.biggestLactation() * this.player.breastRows.length < 35 &&
                        this.player.biggestTitSize() * this.player.biggestLactation() * this.player.breastRows.length >= 20)
                        this.outputText("Milk erupts from your " + this.breastDescript(0) + ", spraying in pulsing blasts, soaking the mouse.  Each nerve-wracking orgasm seems to wring more and more milk from you, until it puddles around.");
                    if (this.player.biggestTitSize() * this.player.biggestLactation() * this.player.breastRows.length >= 35)
                        this.outputText("Milk fountains from your " + this.breastDescript(0) + ", soaking the mouse with a continuous river of cream.  For every blob of cum you feel pushing into your over-filled uterus, another torrent of milk sprays out.  As your mind-bending orgasms drag on, a small lake of milk forms around you.");
                }
        ...
        jojosFifthRape() {
            this.clearOutput();
            this.outputText("Jojo smiles serenely, pleased at the outcome, a foot of tumescent mouse-meat bobbing at attention.\n\n");
            //Placeholder till I'm less lazy
            this.outputText("You fuck your mousey slut for what feels like hours, orgasming until both of you are tired and worn out.  ");
            this.player.orgasm();
            this.fatigue(-20);
            if (this.player.lib > 40) {
                this.outputText("When you're done you feel more clear-headed, but Jojo looks hornier than ever.");
                this.dynStats("lib", -4);
            }
        }
        loseToJojo() {
            ...
            if (this.monk == 2 || this.monk == 3) {
                ...
                this.outputText("Jojo grins wickedly as he senses your defeat, " + this.monster.cockDescriptShort(0) + " throbbing hard.  ");
                if (this.player.lust >= 100) {
                    if (this.player.gender == 1) {
                        this.outputText("Too aroused to think, you just bend over, displaying your bum and letting your " + this.player.multiCockDescriptLight() + " dangle freely.  The mouse doesn't hesitate, and he thrusts his " + this.monster.cockDescriptShort(0) + " with painful force.  You stagger from the size and struggle to stay conscious as he fucks you like a mad beast, hammering your ass with incredible force.  ");
                        if (this.player.cockTotal() == 1)
                            this.outputText("Pre and cum drip from your " + this.player.cockDescript(0) + ", forced out of your prostate by the rough beating it's taking.  You feel a flash of warm wetness inside you, and realize Jojo is cumming.  A sense of relief washes over you as the last burst of cum squirts out from your cheeks, only to be replaced with a dawning sense of horror as he continues fucking you harder than ever.\n\nYou black out after a few dozen of his orgasms and one or two of your own, your gut painfully distended with semen.");
                        if (this.player.cockTotal() > 1)
                            this.outputText("Pre and cum drip from your " + this.player.cockDescript(0) + "s, forced out of your prostate by the rough beating it's taking.  You feel a flash of warm wetness inside you, and realize Jojo is cumming.  A sense of relief washes over you as the last burst of cum squirts out from your cheeks, only to be replaced with a dawning sense of horror as he continues fucking you harder than ever.\n\nYou black out after a few dozen of his orgasms and one or two of your own, your gut painfully distended with semen.");
                        this.player.buttChange(this.monster.cockArea(0), true);
                    }
                    if (this.player.gender >= 2) {
                        this.outputText("Too aroused to think, you bend over, displaying your bum and " + this.vaginaDescript(0) + " to Jojo as open targets.  The mouse obliges, plunging himself into you, hard.  He fucks you with abandon, pounding your wanton little pussy with no regard for your pleasure.  Despite yourself, you enjoy the rough treatment.  A spasm of warmth erupts inside you as Jojo cums.  You worry he might stop, but as the mouse's orgasm ends he resumes fucking with even greater energy. You cum powerfully, his jizz seeping down your thighs as you begin lose track of yourself.  ");
                        if (this.player.cockTotal() > 1)
                            this.outputText("Your " + this.player.cockDescript(0) + " splatters the ground with cum repeatedly, until both your genders are raw and sore.  ");
                        else
                            this.outputText("Your " + this.vaginaDescript(0) + " cums on him many more times it until it is sore and tender, dripping with spunk.  ");
                        this.outputText("You black out as Jojo cums AGAIN, forcing a river of spunk from your already over-filled uterus.");
                        this.player.cuntChange(this.monster.cocks[0].cockThickness, true);
                        //Preggers chance!
                        this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_MOUSE, PregnancyStore_1.PregnancyStore.INCUBATION_MOUSE + 82, 101); //Jojo's kids take longer for some reason
                    }
                    if (this.player.gender == 0) {
                        this.outputText("Too aroused to think, you just bend over, displaying your bum and wiggling enticingly.  The mouse doesn't hesitate, and he thrusts his " + this.monster.cockDescriptShort(0) + " with painful force.  You stagger from the size and struggle to stay conscious as he fucks you like a mad beast, hammering your ass with incredible force.  ");
                        this.outputText("You feel a flash of warm wetness inside you, and realize Jojo is cumming.  A sense of relief washes over you as the last burst of cum squirts out from your cheeks, only to be replaced with a dawning sense of horror as he continues fucking you harder than ever.\n\nYou black out after a few dozen of his orgasms and one or two of your own, your gut painfully distended with semen.");
                    }
                    this.player.slimeFeed();
                    this.hideUpDown();
                    this.player.orgasm();
                ...
                //HP Defeat
                    ...
                    this.outputText("You black out from the pain of your injuries.\n\n");
                    this.statScreenRefresh();
                }
            }
        ...
        corruptJojoSexMenu() {
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.findPerk(PerkLib_1.PerkLib.Whispered) >= 0)
                    this.addButton(8, "Whisper", this.whisperJojobait);
                else
                    this.addButton(8, "Cruel Anal", this.corruptJojoAnalCruel); //Overrides Anal Smother - Herms don't smother, they fuck
            }
            this.addButton(1, "Give BJ", this.corruptJojoCunnilingus);
            if (this.player.biggestTitSize() >= 2)
                this.addButton(6, (this.player.biggestLactation() > 1 ? "Suckle" : "Breasts"), this.corruptJojoBreasts); //All ya need is bewbs
        ...
        corruptJojoBJCruel() {
            ...
            this.outputText("You yell out into the jungle, \"<i>Slut!</i>\" Minutes later Jojo slips into your camp from the jungle's shadows, dropping to his knees with a timid look of fear in his eyes. You step forward and grip the fur between his shell-like ears firmly, hissing angrily, \"<i>When I call for you, you need to be here. Do I need to teach you your place again?</i>\"  ");
            this.outputText("He shakes his head as you say this, trying to marshal up the strength to resist you. You draw your teeth back in a snarl of anger at this resistance and punch the mouse in the gut, dropping him to his knees gasping for breath.  ");
            if (this.player.cocks[x].cArea() < 10)
                this.outputText("You grip the fur on his head tightly in one hand and pull his mouth over your " + this.player.cockDescript(x) + ", thrusting into his muzzle with little concern for letting him catch his breath. You shove your length down his throat and start sawing away, making the mouse's eyes roll back from breathlessness. You can feel the muscles of his throat grip and spasm around your cock flesh as he chokes on the length, his thin lips trembling around your.  ");
            else if (this.player.cocks[x].cArea() < 36)
                this.outputText("You grip the fur on his head tightly in one hand and pull his mouth over your " + this.cockDescript(x) + ", thrusting into his muzzle with little concern for letting him catch his breath. The girth of your " + this.player.cockDescript(x) + " nearly dislocates his jaw. You can feel his throat stretching around you, like a hot, wet, tight sleeve, trembling with the pulse of his racing heart as you grind in and out of his mouth.  ");
            else
                this.outputText("You grip the fur on his head tightly in one hand and pull his mouth over your " + this.player.cockDescript(x) + ", thrusting against his muzzle with your " + this.player.cockDescript(x) + ". You can feel his buck teeth scratching against the top and bottom of your " + this.player.cockDescript(x) + "'s crown, but it does nothing to prevent what is to come. He lifts his hands to try to push your huge erection away, and since you can't fit your girth in his mouth, you decide to use that; grabbing hold of his hands and using them to stroke your length.  ");
            this.outputText("His eyes turn to you in fear and his body shudders for lack of breath, but it does nothing more than stoke the fires of your lust. You groan in pleasure as your balls draw up tight, churning with your corrupted seed, and in a rush you feed it to him, your orgasm overtaking you as surge after hot surge of cum flares through your flesh and into his throat.  " + (this.player.hasVagina() ? "A sympathetic orgasm hits your pussy, causing a surge of feminine juices to splash against his chest and dribble down your thighs lewdly.  " : ""));
            this.outputText("Your orgasm seems to last forever, filling his belly with your corrupted essence, causing his stomach to bulge slightly with the sheer volume of it. You pull away at last, letting him gasp for breath and fall to the ground, curling around his bloated belly.  ");
        ...
        corruptJojoBJGentle() {
            ...
            this.outputText("  He whimpers as you say this, feeling the corruption flowing off of your body like an alluring musk, drawing him deeper into your service.  ");
            if (this.player.cocks[x].cArea() < 10)
                this.outputText("He opens his mouth to protest, but you never give him the chance, sliding your " + this.player.cockDescript(x) + " between his lips and down his throat. You can feel the muscles of his throat grip and spasm around your " + this.player.cockDescript(x) + " as he chokes on the length, his thin lips trembling around your girth as his tongue slides across your vein-lined underside.  " + (this.player.biggestTitSize() >= 2 ? "Your hands lift to massage your breasts and tug at your nipples, and you can see him watching transfixed as you fuck his throat.  " : ""));
            else if (this.player.cocks[x].cArea() < 36)
                this.outputText("He opens his mouth to protest, but you never give him the chance, forcing your " + this.player.cockDescript(x) + " between his lips and nearly dislocating his jaw with the girth of it. You can feel his throat stretching around you, like a hot, wet, tight sleeve, trembling with the pulse of his racing heart as you grind in and out of his mouth.  " + (this.player.biggestTitSize() >= 2 ? "Your hands lift to massage your breasts and tug at your nipples, and you can see him watching transfixed as you fuck his throat.  " : ""));
            else
                this.outputText("He opens his mouth to protest, only to have your " + this.player.cockDescript(x) + " mute him. You can feel his buck teeth scratching against the top and bottom of your " + this.player.cockDescript(x) + "'s crown, but it does nothing to prevent what is to come. He lifts his hands to try to push your huge erection away, and since you can't fit your girth in his mouth, you decide to use that; grabbing hold of his hands and using them to stroke your length.  " + (this.player.biggestTitSize() >= 2 ? "His eyes move from your massive member to your bouncing breasts above with a look of wanton desire that makes you laugh softly.  " : ""));
            this.outputText("His eyes turn to you in fear and awe, pleading for release, and a slip of your foot to his own straining erection lets you know how in need of an orgasm he is, but this time is yours. You groan in pleasure as your balls draw up tight, churning with your corrupted seed, and in a rush you feed it to him, your orgasm overtaking you as surge after hot surge of cum flares through your flesh and into his throat.  " + (this.player.hasVagina() ? "A sympathetic orgasm hits your pussy, causing a surge of feminine juices to splash against his chest and dribble down your thighs lewdly.  " : ""));
            this.outputText("Your orgasm seems to last forever, filling his belly with your corrupted essence, causing his stomach to bulge slightly with the sheer volume of it. You pull away at last, letting him gasp for breath and fall to the ground, curling around his bloated belly.  ");
            if (this.player.biggestTitSize() >= 2)
                this.outputText("You draw him to your bosom and kiss his forehead and then stand and go about your duties, leaving him to recover from the intense encounter and then retreat back into the jungle.  ");
            else
                this.outputText("You give him one last fond caress, running your fingers through his fur in an almost patronizing petting motion, then turn without another word and leave him to retreat back into the jungle.  ");
            this.player.orgasm();
            this.dynStats("cor", 0.5);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        corruptJojoCunnilingus() {
            this.jojoSprite();
            this.clearOutput();
            this.outputText("You decide to finally reward your slut for all his service to you, summoning him to your camp for pleasure. He meekly appears at your bidding and you direct him to lie down on the ground before you. He does as you ask and you gently spread his legs, settling down between them.  ");
            this.outputText("He looks at you in confusion that turns to bliss as you start to lick and caress his sheath and balls, urging the male to a full erection.  ");
            switch (JojoScene.rand(3)) {
                case 0:
                    this.outputText("You take the tip of his member into your mouth, suckling at it as your tongue curls at the crown and teases at the tiny slit at the tip. You take your time with him, letting your hands rub up and down his length, masturbating him slowly and giving his needy balls the occasional caress.  ");
                    break;
                case 1:
                    this.outputText("You take the tip of his member into your mouth and slowly start to bob your head, one hand squeezing at his balls tenderly as your other hand strokes the length of his cock that your lips don't reach. You let your pace quicken over time, mimicking a vigorous fucking.  ");
                    break;
                default:
                    this.outputText("You take the tip of his member into your mouth, and then take a deep breath through your nose, before dropping your head down, listening to him gasp as his cock slides all the way into your mouth and down your throat, until your nose presses against his musky sheath.  Your hands tease and squeeze at his balls, urging him to cum as your throat rhythmically swallows at his length in a milking motion.  ");
            }
        ...
        corruptJojoVaginalGentle() {
            this.jojoSprite();
            this.clearOutput();
            this.outputText("Feeling the urge to be filled, you summon your mouse slut to you and smile as he quickly responds, moving to kneel before you reverently. You let your hand caress the side of his head, then order him to lay back.  ");
            this.outputText("He swallows and nods, nervously obeying, stretching himself out on his back on the ground. He watches as you crawl slowly up his body and press a firm kiss to his muzzle, which he returns with the impossible lust you have planted within him. You can feel his member stirring between your legs, rising up firm against your " + (this.player.hasCock() ? "own endowments" : "crotch") + " as you grind your dripping slit along it.  ");
            if (this.player.vaginalCapacity() < 10) {
                this.outputText("You lower your hand to take hold of his cock, lining it up with your entrance, and then with a soft grunt, you start to lower your weight atop him.\n");
                ...
                this.outputText("You lower your hand to take hold of his cock, lining it up with your entrance, and then with a moan of pleasure, you lower your weight atop him. His cock slides into your pussy like a hand into a glove, fitting perfectly, as though he were made for you.\n");
                this.player.cuntChange(36.4, true);
                ...
                this.outputText("You shift forward, and then tilt your hips and drive back, taking his length into your wide stretched body.\n");
                this.player.cuntChange(36.4, true);
            ...
            this.outputText("You cry out in pleasure as your orgasm floods through your body, causing your juices to splash out around your mouse slut's cock" + (this.player.hasCock() ? ", and your own " + this.player.multiCockDescriptLight() + " to explode with thick splashes of your hot cum across his chest and belly" : "") + ". You stay seated on his hips until your orgasm fades, then with a sigh of pleasure you stand off of him and dismiss him with a wave of your hand.  ");
            //Preggers chance!
            this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_JOJO, PregnancyStore_1.PregnancyStore.INCUBATION_MOUSE + 82); //Jojo's kids take longer for some reason
            this.player.orgasm();
            this.dynStats("cor", 0.5);
        ...
        corruptJojoVaginalSmother() {
            this.jojoSprite();
            this.clearOutput();
            this.outputText("You feel the need to gain a little sexual relief and a mischievous idea comes to your mind, making you grin wickedly. You slip off into the jungle to seek out your monk mouse fuck toy, and when you find him, you practically pounce atop him, pinning him to his back. He struggles in surprise until he realizes that it is you, at which point he blushes and tries to look away, unable to help the erection that you are sitting against as you straddle him.  ");
            this.outputText("You crawl further up his body and grin down at him as you press your already dripping pussy to his mouth and command sharply, \"<i>Start licking if you want to breathe.</i>\" His eyes go wide, but you can feel his tongue already starting to work at your lusty slit.  ");
            if (this.player.vaginas[0].wetness > 4)
                this.outputText("You moan as he works, your juices flowing liberally across his muzzle and into his mouth and nose, making him struggle not to drown in your pleasure as he focuses on giving you even more so.  ");
            else if (JojoScene.rand(2) == 0)
                this.outputText("You grind your slit against him as he eats you out, moaning with pleasure and writhing above him. You lift off of his face every so often, giving him just enough of a break to catch his breath before cutting it off with your pussy once again.  ");
            else
                this.outputText("You settle the full of your weight against his face and laugh as you feel him struggling to pleasure you, his nose and mouth trapped tight against your slit so that every attempt to breathe is halted, making him tremble breathlessly beneath you.  ");
            this.outputText("His tongue digs deep into your body, finally bringing you to an explosive climax that leaves you shuddering thoughtlessly above him. You actually forget you are sitting on his face for a moment, feeling him go still as he nearly passes out from lack of breath before you stand up.  ");
        ...
        corruptJojoAnalCruel() {
            this.jojoSprite();
            this.clearOutput();
            var x = this.player.biggestCockIndex();
            this.outputText("You decided that it is time to seek out your pet monk slut, and stalk into the jungle after the mouse. It doesn't take long to find him, so you move silently to avoid his notice. You move with a predator's grace as you sneak up behind him, your hand reaching down to grab hold of his tail firmly as you shove him against a nearby tree.  ");
            this.outputText("You press your body up behind him" + (this.player.biggestTitSize() >= 2 ? ", mashing your breasts against his back" : "") + " and hiss into his ear, \"<i>Hello slut...</i>\" You keep hold of the base of his tail, hiking it up to lift his ass enough that he has to go to his toes to stay standing. You listen to him whimper softly as he feels your stirring loins press against the cleft of his oh-so-fuckable ass.  ");
            if (this.player.cocks[x].cArea() < 10)
                this.outputText("You saw your swelling erection between his ass cheeks a few times, and then with little warning, you shove yourself deep into his body, making the mouse gasp out as you fill his well used rear. You groan in pleasure as you feel his anal ring grip in flutters along your " + this.player.cockDescript(x) + " as you spear in and out of him, fucking your slut toy with wild abandon.  ");
            else if (this.player.cocks[x].cArea() < 36)
                this.outputText("You press the mouse hard against the tree, inhaling his scent and sliding your " + this.cockDescript(x) + " between his firm cheeks.  There is little in the way of tenderness as you thrust deep into his body. You can hear him groan as your " + this.player.cockDescript(x) + " forces his intestines to shift to accommodate you.  ");
            else
                this.outputText("You grin as your mouse slut cries out with your " + this.player.cockDescript(x) + " spearing into his bowels. You can feel the weight of the tree against your " + this.player.cockDescript(x) + " as you force his belly to bulge out vulgarly to accommodate the enormous girth.  ");
            this.outputText("You thrust away at your squirming and mewling mouse, taking out your pleasure on him with little concern for his own enjoyment, not that this is really a problem, as before you manage to cum, you feel him tense as he 'fertilizes' the tree you have him pressed against. The feel of his orgasm milks you to your own explosion within his belly, emptying your balls with a low groan of relief.  ");
        ...
        corruptJojoAnalGentle() {
            this.jojoSprite();
            this.clearOutput();
            var x = this.player.biggestCockIndex();
            this.outputText("You watch as Jojo slinks into your camp from the dense jungle, moving timidly with his eyes focused on your feet. The sight of such a once pious monk reduced to your submissive fuck toy stirs your loins and brings a smile to your lips.  ");
            this.outputText("You pull him against your body in a firm and possessive hug, and press your lips to his in a forceful kiss, laughing as you break the kiss to the sight of his discomfort. You pay it little mind as you gently force him back onto the ground and spread his legs. You can see in his eyes that he knows what is coming, and you can see that he is as eager for it as he is humiliated by that eagerness.  ");
            if (this.player.cocks[x].cArea() < 10)
                this.outputText("You lift the mouse's balls out of the way and spit down onto the crinkled star of his anus, then lever your tip to the well used hole. There is little ceremony or foreplay, but his cock is already straining erect, and a blush colors his cheeks as you push into his ass, inch by inch. You set a slow and tender pace at first, but as your orgasm nears, your thrusts become more animal and needy.  ");
            else if (this.player.biggestCockArea() < 36)
                this.outputText("You slide your thick and drooling cockhead beneath the mouse's balls, working the musky drool of your pre-cum against the well used crinkle of his ass before forcing the thick vein-lined length of your " + this.player.cockDescript(x) + " into him. You watch as inch after thick, vulgar inch disappears into his body, grinning as his face contorts in a mix of pain and pleasure from it, and then start to fuck him in earnest, watching as his belly bulges with each thrust of your massive prick.  ");
            else
                this.outputText("You force your " + this.player.cockDescript(x) + " against the mouse's ass and watch as he shakes his head, silently begging you not to do it. You smile and grip his hips, then press forward hard, forcing his body to adapt to your girth, stretching his ass and belly dangerously. You can barely get more than a foot of your " + this.player.cockDescript(x) + " into him before bottoming out against his diaphragm, so you just fuck him with what you can, churning his insides with each thrust.  ");
            this.outputText("You pound away at the mouse's tight body for as long as you can, then feel your orgasm hit you hard, your balls drawing up tight as your seed churns and pulses through you and into the mouse's ass, filling his belly with your lust and corruption. You watch his belly swell with the seed in a beautifully vulgar display.  ");
            this.outputText("His eyes glaze over from the intensity of the act, his teeth tightly grit, and then you can hear a keening groan from him as he falls over the edge into his own orgasm, his untouched mouse cock bouncing and jerking on his belly as his thick seed is sprayed across his chest and face lewdly. He blushes deep at the visible proof that he enjoyed what you did to him and trembles beneath you.  ");
        ...
        corruptJojoAnalSmother() {
            this.jojoSprite();
            this.clearOutput();
            this.outputText("You feel the need to gain a little sexual relief and a mischievous idea comes to your mind, making you grin wickedly. You slip off into the jungle to seek out your monk mouse fuck toy, and when you find him, you practically pounce atop him, pinning him to his back. He struggles in surprise until he realizes that it is you, at which point he blushes and tries to look away, unable to help the erection that you are sitting against as you straddle him.  ");
            this.outputText("You crawl further up his body and grin down at him as he stares at your exposed pussy. You suddenly spin, sitting down the other way, so that your ass cheeks envelope his muzzle, trapping his nose and mouth against your tight pucker. \"<i>Get that tongue up in there slut.</i>\"  ");
            switch (JojoScene.rand(3)) {
                case 0:
                    this.outputText("You grind your ass against him as he eats you out, moaning with pleasure and writhing above him. You lift off of his face every so often, giving him just enough of a break to catch his breath before cutting it off with your ass once again.  ");
                    break;
                case 1:
                    this.outputText("You settle the full of your weight against his face and laugh as you feel him struggling to pleasure you, his nose and mouth trapped tight against your ass so that every attempt to breathe is halted, making him tremble breathlessly beneath you.  ");
                    break;
                default:
                    this.outputText("You moan as he takes you at your word, spearing his tongue deep into your anus and thrusting it in and out as though it were a sleek muscled shaft, making your body tremble in pleasure. It makes you wonder where he learned such a trick in his life as a pious monk.  ");
            }
            this.outputText("His tongue continues to work at your ass, finally bringing you to an explosive climax that leaves you shuddering thoughtlessly above him. You actually forget you are sitting on his face for a moment, feeling him go still as he nearly passes out from lack of breath before you stand up.  ");
            this.outputText("He gasps for breath and coughs a few times, and once you are sure that he is safe, you laugh softly and walk back to your camp.");
            this.player.orgasm();
            this.dynStats("cor", 0.5);
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        corruptJojoBreasts() {
            this.jojoSprite();
            this.clearOutput();
            this.outputText("You lay yourself out for a quiet moment of self pleasure, your hands moving to your breasts and fondling them gently, when the sound of a snapping twig brings your attention to the edge of camp. Jojo stands timidly, half hidden within the shadows just outside your encampment, watching you with a look of submissive desire. You smile and lift your hand, beckoning him towards you with a crook of your finger.  ");
            this.outputText("Your mouse slut obediently slips from the darkness and into your camp, approaching you and kneeling at your side. You can see the lust in his eyes as he looks at your breasts, longing and love reflecting wonderfully. You nod your approval and let him worship your bosom.  ");
            if (this.player.biggestLactation() > 1) { //For suckling the scene is the same regardless of player's gender
                this.outputText("He leans in and starts to kiss along your nipples before taking one into his mouth. He gives a firm suckle at the engorged teat, and you can see his eyes open wider in surprise at the sudden surge of milk that fills his muzzle. He shivers and starts to suckle in earnest, drinking from first one breast, then the other, ");
                if (this.player.breastRows.length > 1)
                    this.outputText("and then all the others, "); //Extra boob coverage
                this.outputText("partaking of your blessing until his belly is full.  ");
                this.player.milked();
            }
            else if (this.player.biggestTitSize() <= 5) {
                this.outputText("He leans in to nuzzle and kiss at your breasts, his hands moving to caress the soft and full orbs in gentle worship. His kissing and licking slowly circles in on your nipples, bringing them to firm points that send jolts of warm pleasure through your body when he at last takes them into his mouth. You reach down between your legs, " + (this.player.hasCock() ? "taking hold of your shaft and masturbating it lazily as he works.  " : "slipping your fingers into your slit as you lazily masturbate with the pleasure he brings.  "));
            }
            else {
                this.outputText("He leans in close and presses a kiss to first one nipple, then the other, starting to worship your breasts lovingly. You have other plans, however, and one hand grabs the fur at the back of his neck as the other slips beneath your breasts to pull them together to either side of his face as you press him in tight against the curves of your cleavage, forcing the mouse to fight for every breath.  ");
            }
            this.outputText("You can hear Jojo's breath quickening, then his body shudders as he climaxes spontaneously, splashing his seed across your hip and belly. You can't help the laugh that rises from within you at his submissive gesture, watching as shame washes across his face and his ears lay back.  ");
        ...
        whisperJojobait() {
            ...
            var x = this.player.biggestCockIndex();
            this.outputText("You close your eyes and begin to think of Jojo.  You can feel the former monk's presence far away in the forest, futilely trying to meditate and rid himself of the corruption you so generously bestowed upon him.  He is sitting with one paw on his knee, and the other on his rigid tool.\n\n");
            this.outputText("He flinches as a chorus of voices begin whispering in his ear.  He looks around, wondering if he truly heard something or if he's just imagining the many beings saying such lewd things about him.  As you begin to visualize his body being dominated and forcibly made to submit to your every twisted whim, he begins to squirm as a stream of clear mouse-pre starts leaking down his ridged shaft.  After a moment's hesitation, he starts to head in your direction.\n\n");
            this.outputText("You turn up the pressure with a wicked smile, and watch the mousey begin to walk in wide strides as his orbs slowly swell.  He is soon so devastatingly aroused that he falls to his knees with a cry.  Through your mind's eye, you see him wrapping his fists around his shaft. He tries to masturbate in a desperate bid to relieve himself, but it is to no avail.  Your spell numbs his member every time he reaches for it, teasing and frustrating the mouse as he becomes increasingly aware that only you can relieve him of his steadily growing lust.  Unable to walk straight anymore, he crawls towards your camp on his hands and knees, his mouth snapped shut to stop himself from calling out and attracting the attention of any demon or creature that is not his master.\n\n");
            this.outputText("Jojo enters the edge of your camp with a wail, his once proud voice breaking as he begs you to come have your way with him.  You concentrate harder on the spell, sitting down as Jojo howls his woe for all the world to hear.  He is clawing the ground, dragging his belly through the dirt.  His balls are swollen to a massive size, stopping all but the tips of his toes from touching the ground.  His large swollen phallus drags behind him, leaving a river of spunky pre in its wake.\n\n");
            this.outputText("When he does finally reach you, with a labored breath he presents himself to you as best he can.");
            this.outputText("\n\n");
            this.outputText("You bend down to pat Jojo's obscenely swollen sac; you're determined to empty them of the liquid you hear sloshing around inside.  Jojo yelps as you do, your spell having made his body overtly sensitive to your touch.  ");
            //[Tentacle Penis]
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE) {
                this.outputText("His rodent tail wraps around your waist as you get into position, causing your " + this.player.cockDescript(x) + " to writhe even harder, searching for the hole Jojo's tail is pulling you towards.  As soon as you're close enough, your " + this.player.cockDescript(x) + " pushes into Jojo, twisting around to widen the mouse's hole even further.  Jojo squirms as you brutally stretch him out, stiffening once his hole is stretched to the max.  After admiring the now obscenely gaping hole of your mouse slut, you begin to grind your member around, causing Jojo to scream in ectasy as your " + this.player.cockDescript(x) + " goes ballistic inside of his hungry bowels.\n\n");
            }
            //[Small penis (7 inches or less)]
            else if (this.player.cockArea(x) < 13) {
                this.outputText("His hole flexes constantly, as if hungry for your " + this.player.cockDescript(x) + ". Jojo's tail wraps around your waist as you get into position, and you sink your " + this.player.cockDescript(x) + " into his hungry mouse hole.  The sensation of Jojo's hole quivering around your " + this.player.cockDescript(x) + "makes you smile as you begin thrusting in and out of him.  Jojo groans beneath you like a whore in heat, his ass moving in time to meet your thrusts.  The sound of your bodies clapping together is an applause as you fuck the little mousey without reservation.\n\n");
            }
            //[Medium penis (8-12 inches)]
            else if (this.player.cockArea(x) < 25) {
                this.outputText("His tail possessively wraps itself around your waist as you tease him with your " + this.player.cockDescript(x) + ", smearing your leaking pre all over his stretched tail hole.  You slide yourself into him with a sigh, feeling his hole quiver around your invading sex organ.  Jojo wails like a whore in heat beneath you, grunting as you begin to piston pump your swollen sex organ in and out of his greedy mousey hole.\n\n");
            }
            //[Large penis (13 inches and up)]
            else {
                this.outputText("Jojo's tail wraps around your waist as you get into position behind him, tightening possessively and trying to bring you closer.  You oblige the slut, sliding your " + this.player.cockDescript(x) + ", up the mouse's spread cheeks, teasing his ass with the underside.  When you slip your oversized sex organ into his hungry hole, you feel a cringe ripple through his entire body.  You can soon feel the earth beneath Jojo's stomach as the slow invasion of your " + this.player.cockDescript(x) + " is halted by the mouse's diaphragm; you're unable to fit more than a foot of its length into Jojo's overstuffed tail hole.  You withdraw slowly before suddenly shoving your hips forward, knocking the wind out of the little mousey.  Despite being stretched and filled beyond his limits, the mouse releases a pleased groan and begs for more.\n\n");
            }
            this.outputText("You feel the pressure building as you saw your " + this.player.cockDescript(x) + " in and out of Jojo's tail hole, brutally fucking the mouse.  Jojo moans in both ecstasy and pain, releasing a shrill squeak with every thrust.  He claws at the ground, both hungry for more and desperate for release.  The tip of his tail unwraps from your rapidly thrusting hips and slides down your " + this.buttDescript() + ", spurring you to jackhammer his insides faster. The tip slips into your " + this.assholeDescript() + ", working your prostate as you abuse the mouse's.\n\n");
            //[With Fertility/Lots of Jizz Perk]
            if (this.player.cumQ() >= 1500) {
                this.outputText("You let out a roar as you cum together with Jojo.  Your hips work through your orgasm, fucking your seed deeper into the ex-monk even as you pump gallons of your sperm into him.  His bowels and stomach are filled in no time at all, causing your every thrust to squirt spunk out of his over-filled body.\n\n");
                this.outputText("Jojo howls like a whore in heat, squirming around your still-pumping " + this.player.cockDescript(x) + " as his fuzzy sac shrinks, your rough thrusts forcing his body flat against the ground once his sex organs have returned to normal size.\n\nAfter your orgasms have subsided, Jojo smiles up at you and thanks you over and over for 'saving' him.  You pull out, an ocean of creamy white spilling down his already cum-splattered fur, framing his tail hole with leaking gobs of milky liquid.\n\n");
            ...
            //Without Fertility/Lots of Jizz Perk]
                ...
                this.outputText("You grit your teeth as you cum together with Jojo.  With one last great thrust, you slam your trunk into his mousey tail hole and unload into his tightly clenched bowels.\n\n");
                this.outputText("Jojo's balls begin to shrink as he shoots his own seed, your weight forcing his body flat against the ground once his sac has shrunk to normal.  His tail still slides around inside your " + this.buttDescript() + ", spurring you to reward him with a few post-orgasm thrusts.  His bowels are hot and wet from your load, and you grind your " + this.player.cockDescript(x) + " around with a look of supreme bliss on your face.  Jojo groans as you pull out, releasing a stream of creamy white that slides down to his now normal sized balls. Well... normal for Jojo.\n\n");
        ...
        */
        ...
        beeEggsInCorruptJojo() {
            ...
            if (!this.player.hasCock()) {
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_EGGED_JOJO] == 0)
                    this.outputText("Jojo looks confused at this; he knows you don't have a cock!  ");
                else
                    this.outputText("Jojo looks confused at first, and then nods in understanding, remembering the last time you laid in him.  ");
            }
            this.outputText("He bends over, obedient slut that he is, lifting his ");
            if (this.tentacleJojo())
                this.outputText("tentacle-");
            this.outputText("tail for you in an inviting motion.  His butt looks nice and cushy, a soft heart-shape just beckoning to be impaled on your rigid egg-tool.  You give the mouse-tush a hearty swat and smile at his squeak of surprise and winking anus.");
            this.outputText("\n\nMoving forward, you ");
            if (this.player.isNaga())
                this.outputText("slither around him");
            else if (this.player.isGoo())
                this.outputText("ooze over him");
            else if (this.player.isTaur())
                this.outputText("straddle him");
            else
                this.outputText("climb atop him");
            this.outputText(".  Jojo looks up over his shoulder trustingly, swaying a bit from trying to hold up your body weight.  He starts to reach for his corruption-fueled boner, but of course, he has to drop his arm to hold himself upright.  The rodent whines plaintively, begging you to take him, stroke him... ANYTHING!  You gently shush him and sink your stinger into his backside, rewarding his obedience with a flash of pain and injection of fresh, unnatural lust.  His arms begin to shake, his butt begins to wiggle, and he starts to drool all over the ground, panting in a way that reminds you more of a canine than a mouse.");
            ...
            if (this.player.gender > 0) {
                ...
                if (this.player.gender == 3)
                    this.outputText(" and [eachCock] ");
                if (this.player.gender == 1)
                    this.outputText(this.multiCockDescriptLight() + " ");
                if (this.player.gender == 3 || this.player.cockTotal() > 1)
                    this.outputText("are");
                else
                    this.outputText("is");
                this.outputText(" gushing all over Jojo's back, but you don't feel particularly inclined to deal with your regular genitals.  ");
            }
            this.outputText("You're utterly focused on the silky feel of those smooth spheres rolling out of you, being implanted into a host, willing or not.  Thankfully, Jojo is willing, creaming the ground, sputtering strings of spunk with each new egg that you force inside his once-tight anus.  Orb after orb slides inside him, drawing shivers of ecstasy from your alien-looking egg-cock.  With an explosive clench, you cum and force the remainder of your eggs into the mouse-bitch's butt-cunt.");
            if (this.player.eggs() > 30)
                this.outputText("  His belly is slightly rounded by the time you finish, with small, egg-shaped bumps visible through his fur.");
            ...
            if (this.player.fertilizedEggs() > 0 && !this.pregnancy.isButtPregnant) {
                this.pregnancy.buttKnockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_BEE_EGGS, 80);
            }
            this.flags[kFLAGS_1.kFLAGS.TIMES_EGGED_JOJO]++;
        ...
        lowCorruptionJojoEncounter() {
            this.clearOutput();
            this.jojoSprite();
            this.outputText("Tired of exploring the forest for the moment, you decide to head back to camp.  Not feeling like taking the scenic route, you move to step through some bushes, but immediately your mind registers a yelp.  The instant you move to look at the source of the noise, a white blur smacks you right on your head.");
            if (this.player.tou >= 50 && this.player.isBiped() == true) {
                this.outputText("  You take a few steps back, momentarily dazed.  Shaking it off, you ready your [weapon] and assume a fighting stance.\n\n");
            }
            else if (this.player.tou < 50 && this.player.isBiped() == false) {
                this.outputText("The force of the blow knocks you flat on your [ass].  Shaking it off, you immediately climb to your feet and take on a fighting stance.\n\n");
            }
            else if (this.player.isTaur()) {
                this.outputText("The blow does little more than leave you momentarily dazed but isn’t enough to knock you over.  You shake it off and ready your [weapon] as you assume a fighting stance.\n\n");
            }
            else // Was originally isNaga() only, but this will also cover Drider just as well
             {
                this.outputText("You recoil as you are struck, but the force of the blow does little more than leave you momentarily dazed. You assume a fighting stance, ready to defend yourself.\n\n");
            }
            this.outputText("To your surprise you are greeted with the visage of a rather surprised mouse.\n\n");
            this.outputText("“<i>Oh... erm... I’m sorry.  You spooked me,</i>” he says apologetically, rubbing the back of his neck in embarrassment.\n\n");
        ...
        acceptJojosApology() {
            this.clearOutput();
            this.jojoSprite();
            this.outputText("You forgive him for hitting you and apologize for spooking him yourself, prompting a relieved sigh.\n\n");
            this.outputText("“<i>Thanks, it’s a relief to meet a friendly face,</i>” he says, his mouth breaking into a smile. “<i>Oh, where are my manners!</i>”\n\n");
        ...
        refuseJojosApology() {
            this.clearOutput();
            this.jojoSprite();
            this.outputText("With a smile you curl up a fist and knock the unsuspecting mouse morph upside the head, causing him drop his staff and rub the spot where you slugged him.  As he looks up at you you give his angry expression a shrug, telling him that now the two of you are even.\n\n");
            this.outputText("“<i>O-Kay</i>” The mouse says slowly, suddenly watching your movements very closely with those quick little eyes of his, “<i>But I guess it’s fair, no harm done right?</i>”\n\n");
            this.outputText("It’s all water under the bridge to you now; after all you did slug him real good. The two of you agree to start over.\n\n");
            this.lowCorruptionIntro();
        }
        //Intro
        lowCorruptionIntro() {
            this.outputText("He extends a hand, which you gladly shake. “<i>My name is Jojo, pleased to meet you.</i>” You introduce yourself in kind.\n\n");
            this.outputText("Now that you have the opportunity to take a good look at him, you notice that he is dressed in simple garbs reminiscent of a monk. A light-blue robe covers his flat chest, tied with a simple sash around his waist. His pants, similar to his robes, fit him snugly as well.\n\n");
            this.outputText("His build is lithe, though you detect he isn’t weak by any means. His handshake is firm and transmits confidence; it’s clear that this mouse has trained well, though you can’t see any hint of muscles with his robes covering him. His hair is short and as white as his fur, you’d guess he’s an albino if not for his brown eyes. Surprisingly, he doesn’t seem to be carrying anything on his person, save for a necklace made of beads.\n\n"); // Can't really presume that they're holy without knowing much more about him, rite?
            this.outputText("He smiles knowingly, “<i>Yes I am a monk, and yes this is a strange place for one such as I... this world was not always this way.  Long ago this world was home to many villages, including my own.  But then the demons came.  I'm not sure if they were summoned, created, or simply a perversion of magic or breeding, but they came swarming out of the mountains to destroy everything in their path.</i>”\n\n");
            this.outputText("Jojo sighs sadly, “<i>Enough of my woes.  Though I ");
            if (this.player.cor <= 5)
        ...
        meditateInForest() {
            this.jojoSprite();
            this.clearOutput();
            this.outputText("Jojo smiles and leads you off the path to a small peaceful clearing.  There is a stump in the center, polished smooth and curved in a way to be comfortable.  He gestures for you to sit, and instructs you to meditate.\n\nAn indeterminate amount of time passes, but you feel more in control of yourself.  Jojo congratulates you, but offers a warning as well.  \"<i>Be ever mindful of your current state, and seek me out before you lose yourself to the taints of this world.  Perhaps someday this tainted world can be made right again.</i>\"");
            this.dynStats("str", .5, "tou", .5, "int", .5, "lib", -1, "lus", -5, "cor", (-1 - this.player.countCockSocks("alabaster")));
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.JojoMeditationCount) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.JojoMeditationCount, 1, 0, 0, 0);
            else
                this.player.addStatusValue(StatusAffects_1.StatusAffects.JojoMeditationCount, 1, 1);
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.JojoMeditationCount) >= 5) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_LEVEL] >= 4 && this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_KILLED] == 0 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.JojoMeditationCount) % 5 == 0) {
                    ...
                    if (this.player.hasKeyItem("Jojo's Talisman") >= 0) { //[(if PC has Small Talisman)
                        this.outputText("Jojo smiles at you.  \"<i>[name], well done.  Your talent at focusing is undiminished.  Regarding the other issue... you still have the item I gave you?</i>\"");
                        ...
                        this.outputText("Jojo nods at you respectfully.  \"<i>Well done today; your dedication is impressive.  We could meditate together more often.</i>\"");
                    ...
                    this.outputText("\"<i>It seems you have quite a talent for this.  We should meditate together more often.</i>\"", false);
            }
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.JojoMeditationCount) % 5 == 0) {
        ...
        acceptJojoIntoYourCamp() {
            this.jojoSprite();
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.EverRapedJojo) >= 0 || this.flags[kFLAGS_1.kFLAGS.JOJO_MOVE_IN_DISABLED] == 1) {
                this.outputText("You offer Jojo the chance to stay at your camp, but before you can finish your sentence he shakes his head 'no' and stalks off into the woods, remembering.");
            }
            else {
                this.clearOutput();
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.PureCampJojo, 0, 0, 0, 0);
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Jojo In Camp
        ...
        acceptOfferOfHelp() {
            this.clearOutput();
            this.jojoSprite();
            this.outputText("<i>“Thank Marae.  You’re much stronger than I, my friend... to hold so much corruption and still retain your will.  But let us not tempt fate,”</i> he says before the two of you get to it.\n\n");
            this.doClear = false;
        ...
        refuseOfferOfHelp() {
            this.clearOutput();
            this.jojoSprite();
            this.outputText("You assure Jojo you're fine, and that you'll consider his offer.  “<i>But... I... we...</i>” he stammers. “<i>Alright, but please do not let the corruption get the better of you.  You’re my friend and I couldn't bear to lose you to its vile influence.</i>”  He recomposes himself and asks, “<i>So... is there anything I can assist you with?</i>”\n\n");
            this.jojoCampMenu();
        }
        jojoCamp() {
            this.clearOutput();
            this.jojoSprite();
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_MET_PURE_JOJO] == 0 && this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] == 1 && this.amilyScene.amilyFollower()) {
                this.getGame().followerInteractions.amilyMeetsPureJojo();
                return;
            }
            if (this.flags[kFLAGS_1.kFLAGS.JOJO_RATHAZUL_INTERACTION_COUNTER] == 1 && JojoScene.rand(2) == 0) {
                this.getGame().followerInteractions.catchRathazulNapping();
                return;
            }
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) >= 0) { // Worms overrides everything else
                this.outputText("As you approach the serene monk, you see his nose twitch.\n\n");
            ...
            if (this.player.cor > 10) { //New "offer of help" menu
                if (this.player.cor >= 40) {
                    this.outputText("You walk toward the boulder where Jojo usually sits, and as soon as you're close Jojo approaches you with urgency.  \"<i>By Marae! [name], we must do something! I feel the corruption surrounding you like a dense fog.  We need to meditate or I’m going to lose you!</i>\" Jojo pleads.\n\n");
                }
                else {
                ...
                switch (JojoScene.rand(3)) {
                    case 0:
                        this.outputText("You walk toward the boulder where Jojo usually sits, and see him cross legged with his eyes closed.  At first he seems to be deep in meditation, but when you approach his mouth curls into a smile; he gets up and opens his eyes regarding you with a welcoming expression.  “<i>Greetings [name], is there anything I can assist you with?</i>”\n\n");
                        break;
                    case 1:
                        this.outputText("You walk up to the boulder where Jojo usually sits and find him a few paces behind it. He is standing and practicing his form, gracefully moving from one pose to the next. As you approach him you see his ears visibly perk and he turns his head towards you without breaking his stance, saying, “<i>Greetings [name], is there anything I can assist you with?</i>”\n\n");
                        break;
                    default: this.outputText("You find Jojo sitting cross-legged on a flat rock with his staff leaning against his shoulder, thinking.  He looks to you and nods, \"<i>Greetings, " + this.player.short + ".  Is there something I could do to assist you?</i>\"\n\n");
                }
                this.jojoCampMenu();
            }
        }
        jojoCampMenu() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNLOCKED_JOJO_TRAINING] == 1)
        ...
        jojoAppearance() {
            this.clearOutput();
            this.jojoSprite();
            this.outputText("Jojo is a white furred mouse-morph with dish-like ears and a small muzzle below a sometimes twitchy nose. He watches you with striking blue eyes.\n\n");
            this.outputText("He's wearing pale blue monk robes that are form fitting yet loose enough to allow him to move freely if the need arises. He also wears prayer beads, a cloth sash that holds his robe close and baggy pants cover his legs all the way to his mouse-like footpaws; on the back of his pants a small hole is cut to allow his ropy pink tail freedom.\n\n");
            this.outputText("It's hard to estimate due to his clothing, but you can tell he is pretty lean and doesn't have much in the way of muscle; which makes sense since his martials arts rely more on speed than strength anyways.\n\n");
        ...
        talkMenu() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_TALKED_WITH_JOJO] >= 4)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SAND_WITCHES_COWED] == 1 || this.flags[kFLAGS_1.kFLAGS.SAND_WITCHES_FRIENDLY] == 1 || this.flags[kFLAGS_1.kFLAGS.SAND_MOTHER_DEFEATED] == 1)
                this.addButton(6, "SandCave", this.jojoTalkSandCave);
            if (this.flags[kFLAGS_1.kFLAGS.UNLOCKED_JOJO_TRAINING] == 0 && this.flags[kFLAGS_1.kFLAGS.TIMES_TALKED_WITH_JOJO] >= 4)
        ...
        jojoTalkVillage() {
            this.clearOutput();
            this.jojoSprite();
            this.flags[kFLAGS_1.kFLAGS.TIMES_TALKED_WITH_JOJO]++;
            this.outputText("You decide to ask Jojo about his village.\n\n");
            this.outputText("He speaks softly with a smile on his face and in his voice, “<i>It was a small village near a large beautiful lake. We were peaceful people who laughed and trusted one another, just good simple folk you know?”\n\n");
            this.outputText("“Most of the people of Belridge were either fishers or farmers with huge families that stayed near the village. There were a few hunters and a few craftsmen. We made enemies of no one and sought to do no harm to others,</i>” Jojo says, his smile fading.\n\n");
            this.outputText("Before you can muster a reaction to his sadness, his fuzzy cheeks spread again as he looks up at you with bright eyes.\n\n");
            this.outputText("“<i>My father was a fisherman.  He was this calm, strong man with a lot of silver whiskers that always smelled like fish.  I remember I used to go out on the boat with him and a few of my brothers and he’d always make sure to pick me up and put me on his shoulders... that is until I got too big. He always made everything look so easy, like the world was just there to shake his hand and make him smile. No one could cook seafood like he did, no one.</i>”\n\n");
            this.outputText("“<i>Then there was my mother who was a little high strung, but no one could hug you more fiercely or love you more dearly.  She was a small woman with a big soul who loved her family more than anything.  She was a seamstress before she met my dad and was always the brightest one in the room, which is hard when you have seventeen loud children clamoring for your attention.</i>”\n\n");
            this.outputText("“<i>Even with 19 people living under one roof my family wasn’t the biggest family in town, but there was always plenty work and plenty food.  It was a nice simple existence and I am thankful for the time I had with everyone in that village,</i>” he finishes with a serene smile.\n\n");
            if (this.player.cor < 40) {
                this.outputText("Looks like Jojo's childhood wasn't so bad... you thank the mouse morph monk for sharing his treasured memories with you now that the conversation is over.\n\n");
            }
            else {
                this.outputText("Looks like Jojo’s childhood wasn’t so bad. A little sickly sweet and void of wet pussies and drooling dicks but not bad. You tell him you’re happy to have him near you and he smiles for ear to ear, ignorant of your thoughts.\n\n");
            }
            this.menu();
        ...
        jojoTalkYourOrigin() {
            ...
            this.outputText("“<i>That portal?</i>” Jojo asks, pointing to the very portal you stumbled through. You nod and he asks, “<i>So... what were you like in Ingnam?</i>”\n\n");
            if (this.player.findPerk(PerkLib_1.PerkLib.HistoryAlchemist) >= 0) {
                this.outputText("You tell Jojo that you were the assistant to Riku, an alchemist residing in your village.  He asks questions about your time with the alchemist and how you family felt about you taking up alchemy.  You tell him that you were just about to go into advanced studies when it was announced that you were the next champion and all you really learned was how to increase the potency of certain types of items.\n\n");
            }
            else if (this.player.findPerk(PerkLib_1.PerkLib.HistoryFighter) >= 0) {
                this.outputText("You tell Jojo about how, growing up, you got into fights a lot.  You name names and tell him why and how each of those little brats had got what was coming to them. You tell him how you had planned to join the village guard, but that became a pipe dream when it was announced that you were the next champion.\n\n");
            }
            else if (this.player.findPerk(PerkLib_1.PerkLib.HistoryHealer) >= 0) {
                this.outputText("You tell Jojo about how you spent a lot of your time at the side of Dende, the village healer. You talk about why you wanted to spend time with the older man as he looked after the sick and infirm and the skills you learned there. You let him know how you had just decided to train to become an official healer when you were announced to be the next champion.\n\n");
            }
            else if (this.player.findPerk(PerkLib_1.PerkLib.HistoryReligious) >= 0) {
                this.outputText("You tell Jojo about how you spent most of your time in the temple. He seems to really like hearing about the differences in religious practices between the Celestial Lotus and your village. You tell him about the various clergy of your hometown and how Sister Esther took time to teach you about meditation.\n\n");
            }
            else if (this.player.findPerk(PerkLib_1.PerkLib.HistoryScholar) >= 0) {
                this.outputText("You tell Jojo about your insatiable thirst for knowledge and how you spent a lot of time in school. You tell him the story about how you ‘convinced’ Mr. ");
                if (kGAMECLASS_1.kGAMECLASS.silly())
                    this.outputText("Savin");
                else
                    this.outputText("Sellet");
                this.outputText(" to let you read some of the rare books in his collection, skipping over how much begging and pleading was actually involved.\n\n");
            }
            else if (this.player.findPerk(PerkLib_1.PerkLib.HistorySlut) >= 0) {
                this.outputText("You tell Jojo about how you spent time... making friends.  Jojo looks at you weirdly and when you tell him you had a lot of friends....\n\n");
                this.outputText("“<i>That’s nice I guess [name] but didn’t you have aspirations beyond being, erm... popular?</i>” he questions.\n\n");
                this.outputText("You laugh and tell him that you were just really good and making friends, instead of the truth about how much of a slut you actually were.\n\n");
            }
            else if (this.player.findPerk(PerkLib_1.PerkLib.HistorySlacker) >= 0) {
                this.outputText("You tell Jojo about how you spent your time basically relaxing with your fiends.  You gloss over how big of a lazy bum you were with stories of the times you generally made a nuisance of yourself.  You don’t tell him that you’re pretty sure you were chosen as the next champion in order to be gotten rid of.\n\n");
            }
            else if (this.player.findPerk(PerkLib_1.PerkLib.HistorySmith) >= 0) {
                this.outputText("You tell Jojo about how you spent your time training to become a blacksmith.  Not knowing much about smithing he asks questions about the things you learned and you answer them to the best of your ability.  To finish you describe the process of fitting armor in great detail and how you were going to start learning advanced techniques but were announced to be the next champion.\n\n");
            }
            else if (this.player.findPerk(PerkLib_1.PerkLib.HistoryWhore) >= 0) {
                this.outputText("You tell Jojo about how you spent a lot of your time... making money.  When the naive little monk asks how, you just smile as you fondly remember the older whore, Poison, showing you the ropes and teaching the tricks of the trade.  Regardless of how it made people think of you, it was certainly good money.  In an attempt to hide some of the messier details of your past from the monk, you explain how you accepted... odd jobs for people, important work that not many others in the village would be willing to accept.  He seems confused but shrugs it off.\n\n");
            }
            else {
                this.outputText("Somehow, you don’t seem to have a defined history perk... <b>Please report a bug!</b>\n\n");
            }
        ...
        jojoTalkSandCave() {
            ...
            this.jojoSprite();
            this.flags[kFLAGS_1.kFLAGS.TIMES_TALKED_WITH_JOJO]++;
            this.outputText("You tell Jojo about your discovery of a cave that served as a base for the sand witches of the desert. You tell him about the whole ordeal, and he listens with wide eyes and jaw agape. When you tell him about meeting the Sand Mother Jojo gasps.\n\n");
            this.outputText("“<i>Wait... so you mean to tell me that these sand witches a-are... allies of Marae?  But they’re s-so... sexual.</i>”  He seems genuinely confused, but you tell him that sex is part of nature after all, and that there is nothing wrong or shameful about it.  He agrees with you, but decries the way the sand witches use their power.\n\n");
            //if PC raped Sand Mother
            if (this.flags[kFLAGS_1.kFLAGS.SAND_WITCHES_COWED] == 1) {
                this.outputText("You describe your battle with the Sand Mother in an animated blow by blow and when you get to the end where you raped the Sand Mother you look at Jojo and... lie.  You completely gloss over the fact that you sexually assaulted the Sand Mother because despite his interest he is a little naive and offended by the world of sexual conquest.  He appraises your actions, ignorant of what actually occurred.\n\n");
            }
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.SAND_WITCHES_FRIENDLY] == 1 && this.flags[kFLAGS_1.kFLAGS.SAND_MOTHER_DEFEATED] == 1) {
                this.outputText("You describe your battle with the Sand Mother in an animated blow by blow. When you get to the end you tell him about how reasonable the Sand Mother actually was after you beat her.\n\n");
                this.outputText("Jojo’s head tils to the side as he says, “<i>Maybe the whole thing didn’t need to come to an altercation in the first place, a little diplomacy on both sides....</i>”  He gives you a pointed look, “<i>Might have gone a long way.</i>”\n\n");
            }
            //if PC just spoke to the Sand Mother
            else if (this.flags[kFLAGS_1.kFLAGS.SAND_WITCHES_FRIENDLY] == 1 && this.flags[kFLAGS_1.kFLAGS.SAND_MOTHER_DEFEATED] == 0) {
                this.outputText("You tell Jojo about how the Sand Mother spoke with you once you had battled your way to her.  You tell him she was reasonable and how the whole thing was, in the end, a simple misunderstanding.\n\n");
                this.outputText("He marvels at the way you handled the situation, “<i>Many would have expected her trying to talk to them to be a trap [name] and hurried to attack her but not you... that is... wow [name], you are truly a great individual.</i>”\n\n");
            }
            //[if {PC met bath slut} 
            if (this.flags[kFLAGS_1.kFLAGS.MET_MILK_SLAVE] == 1) {
                this.outputText("You tell Jojo about the poor mind addled thing you found sitting in a tub of milk acting as a slave to the sand witch coven.\n\n");
                this.outputText("He shudders like a child being told a scary story and asks, “<i>What did you do?</i>”\n\n");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.MILK_NAME] === '') {
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.MILK_NAME] !== '') {
                    this.outputText("As the question leaves his lips you give Jojo a confused look and, with a glance, direct his gaze toward " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + ".\n\n");
                    this.outputText("He slaps his own forehead and says, “<i>Oh... yeah... right.</i>” Obviously embarrassed by not putting two and two together. He smiles good naturedly though, “<i>I don’t know I guess I just assumed you found some poor mind addled soul and decided to save her.</i>” Jojo says as he looks over at " + this.flags[kFLAGS_1.kFLAGS.MILK_NAME] + ".\n\n");
                    //[if (bathSlutStage1 - unaltered)
                    if (this.flags[kFLAGS_1.kFLAGS.MILK_SIZE] == 0) {
                        this.outputText("“<i>She’ll fare much better in our care than in the coven’s,</i>” he states with conviction.\n\n");
                    }
                    //[if (bathSlutStage2 - HHH) 
                    else if (this.flags[kFLAGS_1.kFLAGS.MILK_SIZE] == 1) {
                        this.outputText("“<i>She’s already much better than she was when she got here,</i>” he says with a grin.\n\n");
                    }
                    //[if (bathSlutStage3 - DD) 
                    else {
                        this.outputText("“<i>The coven wouldn’t have done what you’ve done for her.  You’ve given her a much, much better life and even aided in fixing her condition, you truly are a champion, [name],</i>” he says, giving you a fond smile and a pat on the back.\n\n");
                    }
                }
            }
            ...
            //[if {PC met Cum Witch} 
            if (this.flags[kFLAGS_1.kFLAGS.CUM_WITCH_DEFEATED] == 1 || this.flags[kFLAGS_1.kFLAGS.BEEN_BLESSED_BY_CUM_WITCH] == 1) {
                this.outputText("You tell Jojo about the cum witch, the herm witch responsible for inseminating the witches there, acting as a father to the others.  When you do he scratches his ear, “<i>Like I said, I don’t get why sex is so overly important to these creatures but whatever, continue.</i>”\n\n");
                //[if {PC allowed Cum Witches to increase their numbers}
                if (this.flags[kFLAGS_1.kFLAGS.MORE_CUM_WITCHES] == 1) {
                    this.outputText("You tell him how you tried to remedy the current cum witch’s situation by asking the Sand Mother to make more cum witches.\n\n");
                    this.outputText("He whistles low, “<i>That’s a bold move [name].  It seems like they would want that though, it’d allow them to, er, you know... more often, and make more sand witches in the long run wouldn’t it?</i>” As the question sound rhetorical you plow on ahead.\n\n");
                }
                //[if {PC allowed Cum Witches to rome}
                else if (this.flags[kFLAGS_1.kFLAGS.CUM_WITCHES_FIGHTABLE] == 1) {
                    this.outputText("You describe to him how you convinced the Sand Mother to allow her cum witches to rome the desert along with the sand witches and he looks at you with astonishment, “<i>You are a generous spirit [name] and this Sand Mother doesn’t seem entirely unreasonable.</i>”\n\n");
                }
                //[if {PC did nothing to help Cum Witch} 
                else {
                    this.outputText("“You tell Jojo that you’re actually done. He says, “<i>Oh... well that’s weird.</i>” and after an awkward silence, the two of you burst out laughing.\n\n");
                }
            }
        ...
        apparantlyJojoDOESlift() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNLOCKED_JOJO_TRAINING] == 0) {
                ...
                if (this.player.cor >= 25) {
                    ...
                    this.outputText("Jojo smiles, “<i>I am not a master, therefore I am unworthy of taking you on as a disciple... but as a friend I can teach you all I know.  Whenever you are ready, just ask.</i>.”\n\n");
            ...
            // {Repeatable Generic Training Session Stuffs}
                ...
                if (this.player.fatigue >= 40) {
                    this.outputText("You ask the monk to continue your training; but he shakes his head.\n\n");
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_TRAINED_WITH_JOJO]++;
            console_1.trace(this.flags[kFLAGS_1.kFLAGS.TIMES_TRAINED_WITH_JOJO]);
            // {If everything is cool}
            if (this.player.findPerk(PerkLib_1.PerkLib.ControlledBreath) < 0 && this.player.findPerk(PerkLib_1.PerkLib.CleansingPalm) < 0 && this.player.findPerk(PerkLib_1.PerkLib.Enlightened) < 0) {
                this.outputText("Jojo gives you a bright cheerful smile, “<i>Alright [name]... let’s begin.</i>”\n\n");
                this.outputText("Jojo’s teaching style periodically switches between lecture and sparring.  When he explains a concept or a strike, he guides you through it before asking you to try it on him. He is patient but firm.  He doesn’t punish you when you make a mistake, instead, corrects you and asks you to try again.  He doesn’t allow you to give up, and his teaching style stops you from feeling frustrated.\n\n");
                this.outputText("The entire session is intense, and each brief lecture or demonstration serves as a quick break to stop your body from giving out, and help you build endurance.\n\n");
                this.outputText("By the end of the training session you are covered in sweat, your lungs heaving for breath.\n\n");
                this.outputText("As you bow to Jojo he bows back and says, “<i>Go get some rest [name], you’ve earned it.</i>”\n\n");
                this.fatigue(60);
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_TRAINED_WITH_JOJO] == 5) {
                    console_1.trace("ADDING FIRST PERK");
                    this.outputText("“<i>Breathing is key.</i>”\n\n");
                    this.outputText("Jojo’s constantly repeated words resonate within you as you realize you’ve learned to control your breathing. It takes you less time to rest than normal and you feel as though you are bursting with energy because of it.  Your [fullChest]");
                    if (this.player.biggestTitSize() == 0)
                        this.outputText(" rises and falls");
                    else
                        this.outputText(" rise and fall");
                    this.outputText(" smoothly even in the heat of battle.  From now on you know you’ll recover more quickly.\n\n");
                    this.outputText("<b>(Perk Gained: Controlled Breath -</b> Increases rate of fatigue regeneration by 10%<b>)</b>");
                    this.player.createPerk(PerkLib_1.PerkLib.ControlledBreath, 0, 0, 0, 0);
                }
            }
            //{after the PC has gained the controlled breath perk}
            else if (this.player.findPerk(PerkLib_1.PerkLib.ControlledBreath) >= 0 && this.player.findPerk(PerkLib_1.PerkLib.CleansingPalm) < 0 && this.player.findPerk(PerkLib_1.PerkLib.Enlightened) < 0) {
                this.outputText("Jojo gives you a big toothy grin, “<i>Alright [name]... let’s begin.</i>”\n\n");
                this.outputText("Jojo switches up the way he is instructing you.  Largely due to your increased endurance, the two of you spend more time moving through forms together and practicing strikes and maneuvers.  When it comes time for a brief lecture, he breaks out one of the few scrolls he has from his order and tells you what he knows about the contents.\n\n");
                this.outputText("Before too long, the two of you are up again and practicing forms and mock strikes, even sparring briefly from time to time.  By the end of the intense training session you are covered in sweat... but so is Jojo, and neither of you are out of breath. As you bow to Jojo he returns the gesture and says, “<i>Go get some rest [name], you’ve earned it.</i>”\n\n");
                this.fatigue(60);
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_TRAINED_WITH_JOJO] == 10) {
                    console_1.trace("ADDING SECOND PERK");
                    this.outputText("The repeated movements are slowly starting to sink in, your muscles becoming accustomed to Jojo’s training.\n\n");
                    this.outputText("By the end of the training session with the mouse, you think that you may have picked up something that might help against the denizens of this world.\n\n");
                    this.outputText("<b>(Ability Gained: Cleansing Palm -</b> A ranged fighting technique of Jojo’s order, allows you to blast your enemies with waves of pure spiritual energy, weakening them and hurting the corrupt.<b>)</b>");
                    this.player.createPerk(PerkLib_1.PerkLib.CleansingPalm, 0, 0, 0, 0);
                }
            }
            //{after the PC has gained the Cleansing Palm attack}
            else if (this.player.findPerk(PerkLib_1.PerkLib.ControlledBreath) >= 0 && this.player.findPerk(PerkLib_1.PerkLib.CleansingPalm) >= 0 && this.player.findPerk(PerkLib_1.PerkLib.Enlightened) < 0) {
                this.outputText("Jojo gives you a big smile brimming with pride, “<i>Alright [Name]... let’s begin.</i>”\n\n");
                this.outputText("Largely due to your increased endurance and improved technique the two of you spend more time sparring and dancing through the forms Jojo knows.  When it comes time for a brief lecture, Jojo pants as he sits with you, taking a minute to regain his breath.  Jojo’s lectures, instead of dealing with how to strike and defend oneself, deal with the nature of the soul.  You learn much about individuality, willpower and determination and after the lecture the two of you meditate on what you’ve learned for a few silent moments.\n\n");
                this.outputText("Then the two of you are back up, sweeping gracefully through forms and striking invisible enemies with fierce blows.  By the end of the intense training session both you and Jojo are tired, having trained to both of your limits.\n\n");
                this.outputText("As the two of you give each other decidedly shaky bows, Jojo says, “<i>Great effort [name], you are... wow... I need a rest. I’ve earned it.</i>”  The two of you share a laugh and end you training.\n\n");
                this.fatigue(60);
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_TRAINED_WITH_JOJO] >= 16 && this.player.inte >= 70) {
                    console_1.trace("ADDING THIRD PERK");
                    //{text shows after generic 16th technique training session}
                    this.outputText("As you finish training you decide to meditate alone; returning to your bedroll, you close your eyes and begin to breathe.  Then the world around you begins to sing.\n\n");
                    this.outputText("The camp is alive with the sounds of voices on the wind, of the ominous sizzling of the great scar between worlds that is the portal that brought you here.  You feel open to the universe as if it were a lady in a dress sitting next to you, that you could easily reach out and touch.  You feel liberated and free despite the fact that you are not moving a muscle.  You are ready for anything but expecting nothing.  You are neither thinking nor dreaming, you simply are.\n\n");
                    this.outputText("<b>(Perk Gained: Enlightened -</b> White magic threshold reduced. Meditation restores health. Grants the ability to meditate alone.<b>)</b>");
                    this.player.createPerk(PerkLib_1.PerkLib.Enlightened, 0, 0, 0, 0);
                }
            }
            //{after PC has gained the Enlightened Perk}
            else {
                this.outputText("Jojo smiles, “<i>In all honesty [name], I should be asking you to teach me, but I’ll do my best.</i>”\n\n");
                this.outputText("There are no lectures.  Neither you nor Jojo are masters, but as of right now, the two of you have exhausted the small store of knowledge available to you from the Celestial Lotus.  You and Jojo instead practice to exhaustion, heaving and panting for breath, whilst still finding time to enjoy each others company.\n\n");
                this.fatigue(60);
                //{each scene only shows if the follower is there}
                var enlightenedBlurbs = new Array();
                ...
                if (kGAMECLASS_1.kGAMECLASS.emberScene.followerEmber())
                    enlightenedBlurbs.push("You can hear Ember cleaning" + this.emberScene.emberMF("his", "her") + "scales.");
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0)
                ...
                this.outputText(enlightenedBlurbs[JojoScene.rand(enlightenedBlurbs.length)] + "\n\n");
            }
            this.menu();
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        wormRemoval() {
            this.jojoSprite();
            this.clearOutput();
            this.outputText("\"<i>Excellent, young one,</i>\" Jojo continues. \"<i>Your dedication to purification is admirable. Relax and know that the parasites will leave you soon.</i>\"\n\n");
            this.outputText("Jojo gets up and walks over to a backpack hidden in the bushes. He removes a lacquered box. He removes and combines a rather noxious combination of herbs, oils and other concoctions into a mortar and grinds it with a pestle. After a few minutes, he ignites the mixture and uses a feathered fan to blow the fumes over you. The smell of the mix is nauseating and repugnant. Your stomach turns and you fight the urge to vomit. Eventually, you are no longer able to resist and you purge yourself onto the ground. Cramping from your vomiting fits, you wrack with discomfort, which slowly builds to genuine pain. As the pain sets in, you feel a stirring deep in your crotch. The worms inside you are stirring and thus are compelling another unwanted orgasm. Unable to control your body, your cock explodes, launching cum and worms everywhere. Jojo begins fanning faster as he sees the worms leave your body.\n\n");
            this.outputText("\"<i>Further endurance is needed, young one,</i>\" Jojo says. \"<i>The root of your problem must leave before you may pursue further purification. Healing is always twice as uncomfortable as the illness requiring attention.</i>\"\n\n");
            this.outputText("Your body cramps up as you feel the fat worm struggle. You feel it pushing up your urethra, fighting to escape your fumigated body. The worm rapidly peeks from the end of your penis. With expedience, Jojo quickly grabs the worm and pulls it out of you, triggering one last orgasm. The monk casts the fat worm to the ground and strikes it dead with his staff.\n\n");
            this.outputText("\"<i>The culprit has been exorcised and will no longer trouble you. Rest here for a while and join me in some meditation to heal your exhausted body and soul.</i>\"\n\n");
            this.outputText("Being too tired for anything else, you join Jojo in meditation, which does much to relive you of your former woes.");
            ...
            if (this.player.HP > Math.floor(this.player.maxHP() * .5))
                this.player.HP = Math.floor(this.player.maxHP() * .5);
            this.player.sens = 11;
            this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Infested);
            this.dynStats("sen", -1, "lus", -99, "cor", -15);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
    }
    exports.JojoScene = JojoScene;
});
//# sourceMappingURL=JojoScene.js.map