define(["require", "exports", "./NPCAwareContent", "../../PregnancyStore", "../../GlobalFlags/kFLAGS", "../../CoC", "../../../console", "../Places/TelAdre/Scylla", "../../CoC_Settings", "../../../../includes/appearanceDefs", "../../Appearance", "../../StatusAffects", "../../CockTypesEnum", "../Places/TelAdre/Katherine", "../../PerkLib", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, Scylla_1, CoC_Settings_1, appearanceDefs_1, Appearance_1, StatusAffects_1, CockTypesEnum_1, Katherine_1, PerkLib_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Urta extends NPCAwareContent_1.NPCAwareContent {
        constructor() {
            super();
            this.drainedByKath = false;
            this.pregnancy = new PregnancyStore_1.PregnancyStore(kFLAGS_1.kFLAGS.URTA_PREGNANCY_TYPE, kFLAGS_1.kFLAGS.URTA_INCUBATION, 0, 0);
            this.pregnancy.addPregnancyEventSet(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, 330, 334, 288, 240, 192, 144, 96, 48);
        ...
        timeChange() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.NEED_URTA_LETTER] == 1 && this.model.time.hours == 6)
                this.urtaPregs.getUrtaLetter(); //Urta Letters
            if (this.pregnancy.incubation == 0 && (this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_BEE_EGGS || PregnancyStore_1.PregnancyStore.PREGNANCY_DRIDER_EGGS)) {
                this.pregnancy.knockUpForce(); //Silently clear Urta's egg pregnancy
                this.flags[kFLAGS_1.kFLAGS.URTA_EGGS] = 0;
                this.flags[kFLAGS_1.kFLAGS.URTA_FERTILE_EGGS] = 0;
            }
            if (this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] > 0)
                this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME]--; //Count down timer for urta's lust
            if (this.flags[kFLAGS_1.kFLAGS.URTA_EGG_FORCE_EVENT] > 0)
                this.flags[kFLAGS_1.kFLAGS.URTA_EGG_FORCE_EVENT]--; //Countdown to urta freakout
            //Urta egg freak out
            if (this.flags[kFLAGS_1.kFLAGS.URTA_EGG_FORCE_EVENT] > 0 && this.model.time.hours > 6 && this.model.time.hours < 18 && this.flags[kFLAGS_1.kFLAGS.URTA_EGG_FORCE_EVENT] < 12) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_ANGRY_AT_PC_COUNTDOWN] > 1) {
                this.flags[kFLAGS_1.kFLAGS.URTA_ANGRY_AT_PC_COUNTDOWN]--;
                if (this.flags[kFLAGS_1.kFLAGS.URTA_ANGRY_AT_PC_COUNTDOWN] < 1)
                    this.flags[kFLAGS_1.kFLAGS.URTA_ANGRY_AT_PC_COUNTDOWN] = 1;
            }
            if (this.model.time.hours > 23) {
                if (this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] == 0)
                    this.flags[kFLAGS_1.kFLAGS.URTA_CUM_NO_CUM_DAYS]++;
                else
                    this.flags[kFLAGS_1.kFLAGS.URTA_CUM_NO_CUM_DAYS] = 0;
                if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_AFFECTION_COUNTER] > 0) {
                    this.flags[kFLAGS_1.kFLAGS.URTA_PC_AFFECTION_COUNTER] -= .5;
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_AFFECTION_COUNTER] < 0)
                        this.flags[kFLAGS_1.kFLAGS.URTA_PC_AFFECTION_COUNTER] = 0;
                }
            }
            return needNext;
        }
        ...
        urtaSprite() {
            if (this.urtaDrunk())
                this.spriteSelect(84);
            else
                this.spriteSelect(1);
        }
        urtaCapacity() {
            var bonus = this.flags[kFLAGS_1.kFLAGS.TIMES_RUT_FUCKED_URTAS_CUNT] * 5;
            if (bonus > 40)
                bonus = 40;
            if (this.flags[kFLAGS_1.kFLAGS.URTA_TENTACLE_GAPED] > 0)
                return 500;
            return 60 + bonus;
        }
        urtaLove(love = 0) {
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == -1)
                return false;
            if (love == 0) {
                return this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 1;
            }
            if (love > 0) {
                this.flags[kFLAGS_1.kFLAGS.URTA_PC_AFFECTION_COUNTER] += love;
            }
            if (love < 0) {
                this.flags[kFLAGS_1.kFLAGS.URTA_PC_AFFECTION_COUNTER] -= love;
            }
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 1) {
                ...
                if (love > 0 && this.flags[kFLAGS_1.kFLAGS.AMILY_VISITING_URTA] == 0 && this.amilyScene.amilyFollower() && this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] == 1)
                    this.flags[kFLAGS_1.kFLAGS.AMILY_NEED_TO_FREAK_ABOUT_URTA] = 1;
                return true;
            }
            else
                return false;
        }
        urtaAvailableForSex() { return this.urtaFuckbuddy() && this.telAdre.scylla.action != Scylla_1.Scylla.SCYLLA_ACTION_FUCKING_URTA && this.flags[kFLAGS_1.kFLAGS.URTA_ANGRY_AT_PC_COUNTDOWN] == 0; }
        urtaFuckbuddy() {
            if (kGAMECLASS_1.kGAMECLASS.urtaQuest.urtaBusy() || this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] == -1)
                return false;
            if (this.urtaJustFriends())
                return false;
            return (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_URTA] > 0);
        }
        urtaJustFriends() { return this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] == 0 && this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == -1; }
        urtaAtBar() {
            return (!kGAMECLASS_1.kGAMECLASS.urtaQuest.urtaBusy() && this.flags[kFLAGS_1.kFLAGS.AMILY_VISITING_URTA] != 1 && this.model.time.hours < 15 && this.flags[kFLAGS_1.kFLAGS.KATHERINE_UNLOCKED] != 3);
        }
        urtaDrunk() {
            //Preg = no drinking!
            if (this.pregnancy.isPregnant)
                return false;
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00146] == -1)
                return false;
            if (this.model.time.hours > 12 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00146] < 1)
                return true;
            if (this.model.time.hours > 8 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00146] >= 1)
                return true;
            else
                return false;
        }
        urtaOpenAboutEdryn() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00145] > 0)
                return true;
            //Did it come out from marble?
            if (this.flags[kFLAGS_1.kFLAGS.URTA_KNOWS_PC_HAS_MARBLE_FOLLOWER] > 0)
                return true;
            //Did it come out from discussions?
            if (this.flags[kFLAGS_1.kFLAGS.URTA_OPEN_ABOUT_EDRYN] > 0)
                return true;
            return false;
        }
        knockUpUrtaChance() {
            ...
            if (this.pregnancy.isPregnant)
                return;
            //GTFO IF NOT FERTILE
            if (this.flags[kFLAGS_1.kFLAGS.URTA_FERTILE] != 1)
                return;
            ...
            if (chance > Urta.rand(100)) {
                this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, 384);
                this.flags[kFLAGS_1.kFLAGS.URTA_PREGNANT_DELIVERY_SCENE] = 0;
            }
        }
        urtaBarDescript() {
            this.outputText("\n\n", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_ANGRY_AT_PC_COUNTDOWN] == 1) {
                ...
                this.flags[kFLAGS_1.kFLAGS.URTA_ANGRY_AT_PC_COUNTDOWN] = 0;
                return true;
            }
            //Raphael betrayed reward
            if (this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == -1 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00148] == 0) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00350] == 1) {
            ...
            //[URTA ASHAMED]
            if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] == -1) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00145] == 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00143] > 0) {
            ...
            //PREGNANT URTA
            if (this.pregnancy.isPregnant) {
                if (this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER) {
                    ...
                    //Egg Level 1:
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_EGGS] < 20)
                        this.outputText("Urta is sitting quietly at her usual seat, sipping a mug of some non-alcoholic beer.  Though her clothes are still in place, you can just make out the bulging midriff stretching them taut, a consequence of all the eggs in her womb.");
                    else if (this.flags[kFLAGS_1.kFLAGS.URTA_EGGS] < 40)
                        this.outputText("Urta is sitting rather uncomfortably at her usual seat.  Her swollen stomach is so large it keeps her from wearing her usual outfit, instead forcing her into a mini-shirt and a skirt bottom, allowing her midriff to be bare.  She occasionally runs a hand over the expanse, as if she can't believe it's actually there.");
                    //Egg Level 3:
                    else
                        this.outputText("Urta's bloated belly forces her to sit side-saddle at her usual table, the lumpy, egg-stuffed mass ballooning out in front of her.  Forced into a midriff-baring ensemble, she frequently touches it, occasionally seeming to trace an egg through the taut skin.");
                }
                return true;
            }
            //Eggs Laid:
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_TIMES_EGG_PREGGED] > 0 && !this.pregnancy.isPregnant && this.flags[kFLAGS_1.kFLAGS.URTA_FLATBELLY_NOTICE] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.URTA_FLATBELLY_NOTICE] = 1;
                return true;
            }
            //[Love Urta Bar Appearance]
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00146] == -1 || !this.urtaDrunk())
                    this.outputText("Urta is sitting at her usual table, sipping a glass of wine and wearing a form-fitting evening gown of shimmering black.  She looks up at you, happiness filling her eyes when she notices you entering the bar.", false);
                //(DRUNK)
                else
                    this.outputText("Urta is sitting at her usual table wearing a shimmering black dress.  She's pretty clearly sloshed judging by her bleary gaze as she looks up at you.  The front of her dress visibly tents, and she waves you over with a lecherous grin.", false);
                return true;
            }
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_URTA] == 0 && this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] > -1) {
            ...
            //[URTA FUCKBUDDIED]
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_URTA] > 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] < 11)
                    this.outputText("Thankfully she still has her other addition trapped under her tail, for now.", false);
                else
                    this.outputText("Her half-hard horse-cock is plainly visible to anyone who spares her a glance, barely contained by a pair of tightly woven fishnet stockings.  She's looking at you and wiggling a finger your way...", false);
                return true;
            }
            CoC_Settings_1.CoC_Settings.error("");
            console_1.trace("URTA Error: Bar descript encountered unexpected scenario.");
            return false;
        }
        urtaBarApproach() {
            this.urtaSprite();
            ...
            var temp = undefined;
            var spank = undefined;
            if ((this.player.hasCock() && this.player.cockThatFits(this.urtaCapacity()) >= 0) || this.player.hasKeyItem("Deluxe Dildo") >= 0)
                spank = this.spankTheShitOutOfUrtaAndMakeHerCreamHerselfFromProstateStimulationAloneLikeTheHornyDrunkenSlutSheReallyIs;
            this.clearOutput();
            //Raphael Reward
            if (this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == -1 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00148] == 0) {
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00148] = 1;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00145] == 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00143] > 0) {
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00145] = 1;
            ...
            //HERE WE GOEZ!
            if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] >= 5 && ((this.player.inRut && this.player.hasCock()) || (this.player.inHeat && this.player.hasVagina()))) {
                if (this.urtaDrunk())
                    this.urtaHeatRut.approachDrunkenUrta();
                else
                    this.urtaHeatRut.approachSoberUrtaHeatRutProc();
                return;
            }
            //[URTA FRIEND FUCKBUDDY BUT UNHORNY]
            if (this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] > 0 && !this.urtaDrunk()) {
                this.outputText(this.images.showImage("urta-bar"), false);
                //Cockblock marble convo
                if (this.marbleScene.marbleAtCamp() && this.flags[kFLAGS_1.kFLAGS.URTA_KNOWS_PC_HAS_MARBLE_FOLLOWER] == 0) {
                    this.flags[kFLAGS_1.kFLAGS.URTA_KNOWS_PC_HAS_MARBLE_FOLLOWER] = 1;
                    this.marbleCockuBlockuUrta();
                    return;
                }
                //Twu wuv talk
                if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_AFFECTION_COUNTER] >= 30 && this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 0) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 1) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00146] == -1 || !this.urtaDrunk()) {
                    ...
                    if (this.player.canOviposit()) {
                        if (this.flags[kFLAGS_1.kFLAGS.URTA_TIMES_EGG_PREGGED] == 0)
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_CUM_NO_CUM_DAYS] >= 5)
                        this.addButton(1, "Suck Off", this.slurpFawkesCocksForFunAndInflation);
                    else
                        this.addButton(1, "Suck Off", this.blowUrtaUnderTheTableLuv);
                ...
                //[Horny Urta Talk – Drunk]
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == -2 && this.RaphaelLikes() && this.flags[kFLAGS_1.kFLAGS.URTA_X_RAPHAEL_HAPPENED] == 0) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] == 0 && this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] > -1) {
                this.outputText(this.images.showImage("urta-bar-drunk"), false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] >= 11 && Urta.rand(2) == 0) {
                this.outputText(this.images.showImage("urta-bar"), false);
                ...
                if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] < 11)
                    this.outputText("moments before you hear her horse-cock thump into the bottom of the table.  ", false);
                else
                    this.outputText("and pets her already-growing horse-cock through her fishnet stockings.  ", false);
                if (Urta.rand(2) == 0) {
                    ...
                    this.outputText("She asks, \"<i>Would you like to go back to my place and help me play with my 'little' friend again?  Or maybe you could climb under the table and give me some relief?</i>\"", false);
            }
            if (this.player.canOviposit()) {
                if (this.flags[kFLAGS_1.kFLAGS.URTA_TIMES_EGG_PREGGED] == 0)
                    this.outputText("\n\nYou contemplate asking Urta to help you take a load off your abdomen, but decide against it; Urta's probably too shy and pent up to let you fill her with your eggs. Maybe when she's gotten herself drunk and is more pliable, though...");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_CUM_NO_CUM_DAYS] >= 5)
                ...
                this.addButton(0, "Hidden BJ", this.blowUrtaUnderTable);
        ...
        drinkUrtasBoozePtTwo() {
            ...
            if (this.player.hasVagina() && this.player.totalCocks() == 0)
                this.outputText("squat down and ", false);
        ...
        drinkUrtasBoozeRun() {
            ...
            this.doNext(this.camp.returnToCampUseOneHour);
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] = -1;
        }
        drinkUrtasBoozeLetHer() {
            this.urtaSprite();
            this.player.slimeFeed();
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY]++;
            this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_URTA]++;
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 5;
            this.hideUpDown();
            this.player.orgasm();
            this.dynStats("sen", -2);
            //[LET HER]
            ...
            if (this.player.balls > 0)
                ...
                this.outputText(this.biggestBreastSizeDescript(), false);
            else
            ...
            if (this.player.biggestTitSize() > 1)
                this.outputText("tits", false);
            else
                this.outputText("belly", false);
            ...
            if (this.player.cockTotal() > 0)
                this.outputText(" and " + this.multiCockDescript(), false);
            ...
            if (this.player.hasVagina())
                ...
                this.outputText("suitably lubricated and leaking pre", false);
            else
                this.outputText("suitably lubricated", false);
            this.outputText(".\n\n", false);
            ...
            if (this.player.hasVagina())
                this.outputText("against your cervix as the tip presses firmly against it", false);
            else
                this.outputText("into your rectum", false);
            this.outputText(", unloading a thick batch of cream directly into your ", false);
            if (this.player.hasVagina())
                this.outputText("waiting womb", false);
            else
                this.outputText("abused asshole", false);
            this.outputText(".", false);
            if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 250)
                this.outputText("  Whatever's growing inside you is probably bathing in the stuff now.", false);
            else if (this.player.hasVagina())
                this.outputText("  You briefly wonder if she's capable of knocking you up, and what the baby would look like.", false);
            else
                this.outputText("  Your backside fills with warmth as her spunk seeps deep inside you.", false);
            ...
            if (this.player.totalCocks() > 0) {
                ...
                if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 100)
                    this.outputText("pregnancy swollen ", false);
                this.outputText("belly, making you squish with each brutal thrust of your oversized lover's rod.", false);
            }
            else {
                if (this.player.hasVagina())
                    this.outputText("Your pussy dribbles and clenches, leaking Urta's whiteness as she claims it for her own.", false);
                else
                    this.outputText("Your " + this.assholeDescript() + " clamps down tightly, spasming in pleasure around the invader.", false);
            }
            if (this.player.totalCocks() > 0)
                this.outputText("  As you cum, more and more whiteness dribbles out until a puddle forms underneath you, showing Urta just how much you enjoyed the rough, drunken fuck.\n\n", false);
            else
                this.outputText("\n\n", false);
            ...
            if (this.player.cockTotal() > 0)
                this.outputText("stick it in me", false);
            else
                this.outputText("come back for an even bigger load", false);
            this.outputText(".</i>\"\n\n", false);
            ...
            if (this.player.hasVagina())
                ...
                this.player.buttChange(60, true);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[BACKDOOR]
        urtaFollowedOutBack() {
        ...
        dualUrtaMasturbation() {
            ...
            if (this.player.cor < 60)
                this.outputText("You blush furiously at exposing yourself in such a way", false);
            else
                this.outputText("Smiling seductively, you revel in exposing yourself so suddenly", false);
            ...
            if (this.player.totalCocks() > 0) {
                ...
                this.outputText("bare groin and " + this.assholeDescript(), false);
            this.outputText(".  ", false);
            if (this.player.totalCocks() > 0) {
                this.outputText("The situation gives you all the spark you need to rise to your full size, ", false);
                if (this.player.cockArea(0) < 40)
                    this.outputText("even if Urta's member dwarfs you.", false);
                else if (this.player.cockArea(0) < 70)
                    this.outputText("showing Urta you're just as big.", false);
                else
                    this.outputText("proving to Urta just who has the bigger burden.", false);
                this.outputText("  ", false);
            }
            if (this.player.hasVagina()) {
                if (this.player.vaginas[0].vaginalWetness > appearanceDefs_1.VAGINA_WETNESS_SLICK)
                    this.outputText("A trickle of wetness escapes your nether-lips, starting to puddle underneath you.", false);
                else
                    this.outputText("Quickly engorging, your lower lips begin to part around your " + this.clitDescript() + ".", false);
                this.outputText("  ", false);
            }
            ...
            if (this.player.totalCocks() == 1)
                this.outputText("Your hands caress your " + this.cockDescript(0) + " feverishly, tweaking every ounce of pleasure from the bloated rod.  ", false);
            if (this.player.totalCocks() > 1)
                this.outputText("Your hands caress your " + this.multiCockDescript() + " in turn, dancing back and forth from rod to rod as you attempt to play with every available pleasure outlet.  ", false);
            if (this.player.hasVagina())
                this.outputText("Delving deeply between your legs, you press forward into the source of your feminine pleasures, touching and rubbing, caressing your swollen button as you get closer and closer to orgasm.\n\n", false);
            if (this.player.gender == 0)
                this.outputText("Delving down between your legs, rubbing along your taint before you slowly penetrate your " + this.assholeDescript() + ", pleasuring yourself in the only way possible.\n\n", false);
            ...
            if (this.player.totalCocks() > 0) {
                if (this.player.cumQ() < 250) {
                    ...
                    this.outputText("Jism pours out onto the alley floor as your body releases the copious amount of cum it can produce.  It puddles before you, running off the stone into the grass.  ", false);
            ...
            if (this.player.hasVagina()) {
                ...
                if (this.player.vaginas[0].vaginalWetness == appearanceDefs_1.VAGINA_WETNESS_SLAVERING)
                    this.outputText(" and gushing everywhere", false);
                this.outputText(".  ", false);
            }
            else
                this.outputText("Your sphincter clenches down tightly around your invading digit as you get off, and the rapt attention of your audience certainly helps.  ", false);
            ...
            if (this.player.cumQ() >= 1000)
                this.outputText("adding to the massive pool on the ground after ", false);
            ...
            if (this.player.cumQ() >= 1000)
                this.outputText("tip-toes through the spunk", false);
            else
                this.outputText("gets her balance and heads for the bar's backdoor", false);
        ...
        //[FUCK HER]
        urtaFuckHer(afterBefriending = false) {
            this.urtaSprite();
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY]++;
            this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_URTA]++;
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 5;
            var cocks = this.player.cockTotal();
            if (!afterBefriending)
                this.clearOutput();
            ...
            if (this.player.totalCocks() == 0) {
                ...
                if (this.player.cor < 50)
                    this.outputText("You blush furiously at exposing yourself in such a way");
                else
                    this.outputText("Smiling seductively; you revel in exposing yourself so suddenly");
                this.outputText(".  Urta looks up at you in shock, blinking tears from her eyes and stammering, \"<i>B-b-b-ut I have th-thish hideoush thing... Aren't you scared of it?</i>\"\n\n", false);
                ...
                if (this.player.tailType == appearanceDefs_1.TAIL_TYPE_HORSE || this.player.tailType == appearanceDefs_1.TAIL_TYPE_DOG)
                    this.outputText("swishing your tail across her taut nipples", false);
                else
                    this.outputText("making her wait", false);
                ...
                var x = this.player.cockThatFits(this.urtaCapacity());
                var y = this.player.cockThatFits2(this.urtaCapacity());
                if (x < 0)
                    x = 0;
                ...
                if (this.player.cockTotal() > 0) {
                    if (this.player.cockTotal() > 2)
                        this.outputText("a pair of your " + this.multiCockDescriptLight() + " against her pussy and asshole.  ", false);
                    else if (this.player.cockTotal() == 2)
                        this.outputText("your " + this.multiCockDescriptLight() + " against her pussy and asshole.  ", false);
                    else if (this.player.cockTotal() == 1)
                        this.outputText("your " + this.multiCockDescriptLight() + " against her pussy.  ", false);
                }
                //DOES IT FITZ
                if (this.player.cockArea(x) < this.urtaCapacity()) {
                    ...
                    if (this.player.cockTotal() >= 2)
                        this.outputText("Her backdoor was rougher going – the tightly muscled entrance held you back for a moment until Urta relaxed completely, but now the tighter hole is nearly as easy to penetrate as her pussy.  ", false);
                    ...
                    if (this.player.cockTotal() == 1)
                        this.outputText("hole", false);
                    else
                        this.outputText("holes", false);
                    this.outputText(".\n\n", false);
                    ...
                    if (cocks == 1)
                        this.outputText("fuck", false);
                    else
                        this.outputText("double-penetrate", false);
                    this.outputText(" her.\n\n", false);
                    ...
                    if (cocks > 1 && y >= 0)
                        this.outputText(", " + this.cockDescript(x) + ", and " + this.cockDescript(y) + ".", false);
                    else
                        this.outputText(" and " + this.cockDescript(x) + ".", false);
                    ...
                    if (cocks > 1 && y >= 0)
                        this.outputText("  Your " + this.cockDescript(y) + " feels like it's about to explode inside her asshole when her sphincter clamps down tightly, acting like the world's tightest cock-ring.", false);
                    this.outputText("\n\n", false);
                    ...
                    if (cocks > 1 && y >= 0)
                        this.outputText("and tightly clenched ass seem", false);
                    else
                        this.outputText("seems", false);
                    ...
                    if (this.player.cumQ() < 250) {
                        ...
                        if (cocks > 1 && y >= 0)
                            this.outputText("and belly are ", false);
                        else
                        ...
                        if (cocks > 1 && y >= 0)
                            this.outputText("both her holes.", false);
                        else
                            this.outputText("her abused hole.", false);
                    }
                ...
                //(TOO BIG)
                    ...
                    if (cocks == 1) {
                        ...
                        if (this.player.cumQ() < 250)
                            this.outputText("You join in, though your own contribution seems meager by comparison.", false);
                        else if (this.player.cumQ() < 500)
                            this.outputText("You join in, and manage to match her spurt for spurt, until she's lying in a thick puddle of the stuff.", false);
                        else
                            this.outputText("You join in, and make her orgasm look like a trickle compared to the flood of spunk you unleash onto her.  By the time the pair of you finish, she's soaked from head to toe, and lying in a nicely sized puddle of the stuff.", false);
        ...
        blowUrtaUnderTable() {
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY]++;
            this.urtaLove(1);
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 2 + Urta.rand(4);
            this.outputText("", true);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] >= 11)
                this.outputText(" and pulling down her fishnet to release the monster trapped inside it.  It snaps up immediately, bobbing before your face as it fills with Urta's booze-fueled lust.", false);
            else
                this.outputText(" and pushing up her tight leather skirt, smiling at the sight of her trembling balls and juicy pussy.  Her tail unfurls around the equine member and it snaps up immediately, hanging before your face.", false);
            ...
            if (this.player.cor < 70)
                this.outputText("do your best to suppress your gag reflex and shove forwards, ramming her cock as deeply into your throat as you can.", false);
            else
                this.outputText("shove forwards, ramming her massive cock so far down your throat you can feel it dribbling pre-cum into your belly.", false);
            ...
            if (this.player.biggestTitSize() >= 2)
                this.outputText("dragging between your " + this.allBreastsDescript(), false);
            else
                this.outputText("dragging across your chest", false);
        ...
        takeUrtaInTheButtPublically() {
            ...
            this.outputText("", true);
            var tooBig = false;
            if (this.player.cor < 30 && this.flags[kFLAGS_1.kFLAGS.PC_FETISH] == 0) {
            ...
            if (this.player.cor < 60 && this.flags[kFLAGS_1.kFLAGS.PC_FETISH] == 0)
                this.outputText("You can't believe you're doing it, but you undo the lower half of your " + this.player.armorName + ".  ", false);
            else
                this.outputText("You happily remove the lower half of your " + this.player.armorName + ", more than a little excited at the prospect of putting on a show for the crowd.  ", false);
            this.outputText("Urta casually flips up her skirt and ", false);
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_URTA] < 11)
                this.outputText("unwinds her tail from around the beast", false);
            else
                this.outputText("fishes the beast out of her fishnets", false);
            ...
            //[DOESN'T FIT]
                ...
                //(STRETCH TEXT HERE)
                if (!this.player.buttChange(60, true))
                    this.outputText("  ", false);
            ...
            if (this.player.hasVagina()) {
                ...
                if (this.player.clitLength < 2)
                    this.outputText("peep out", false);
                else
                    this.outputText("grow to its full size", false);
                this.outputText(".  ", false);
                if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_SLICK)
                    this.outputText("Moisture beads on your lips, signaling just how turned on this total violation is making you.", false);
                else if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_SLAVERING)
                    this.outputText("Moisture begins dripping onto Urta's thighs, signaling just how turned on this total violation is making you.", false);
                else
                    this.outputText("Moisture puddles on the seat under Urta as your juices flood her thighs, revealing just how turned on this violation is making you.", false);
                this.outputText("  ", false);
            }
            //(NIPPLES:
            ...
            if (this.player.hasFuckableNipples() && this.player.biggestLactation() >= 1)
                this.outputText(", leaking milky lubricants and aching to be penetrated.", false);
            else if (this.player.hasFuckableNipples())
                this.outputText(", aching to be penetrated.", false);
            else if (this.player.biggestLactation() >= 1.5 && this.player.biggestLactation() < 2.5)
                this.outputText(", leaking thin streams of milk that rapidly become visible to everyone around you.", false);
            else if (this.player.biggestLactation() >= 2.5)
                this.outputText(", spurting thick streams of milk that soak your " + this.player.armorName + " and are visible to everyone in the bar.", false);
            else
                this.outputText(".", false);
            this.outputText("\n\n", false);
            ...
            if (tooBig)
                this.outputText("you find yourself giggling drunkenly, barely feeling any pain and arching your back like a slut for the crowd.", false);
            else if (this.player.cor < 50 && this.flags[kFLAGS_1.kFLAGS.PC_FETISH] == 0)
                this.outputText("you find yourself whimpering, regretting the decision to climb on top of her, but aroused in spite of it.", false);
            else
                this.outputText("you find yourself sliding your hands under your " + this.player.armorName + " and pinching your " + this.nippleDescript(0) + "s, putting on a show for the crowd.", false);
            ...
            if (this.player.biggestTitSize() >= 1) {
                ...
                if (this.player.hasFuckableNipples())
                    this.outputText("dripping lubricants", false);
                else if (this.player.biggestLactation() > 1)
                    this.outputText("spurting milk", false);
                else
                    this.outputText("rubbing your tight nipples against your " + this.player.armorName, false);
                this.outputText(".", false);
            }
            if (this.player.cockTotal() > 0) {
                if (this.player.cockTotal() > 1) {
        ...
        getAPublicFacialFromUrta() {
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY]++;
            this.urtaLove(2);
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 3 + Urta.rand(3);
            this.outputText("", true);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] < 11)
                this.outputText("skirt ", false);
            else
                this.outputText("stockings ", false);
            ...
            if (this.player.cor < 33)
                this.outputText("and it makes you blush crimson", false);
            else if (this.player.cor < 66)
                this.outputText("and it makes you uncomfortable but horny", false);
            else
                this.outputText("and it makes you randy as hell", false);
            this.outputText(".\n\n", false);
            ...
            if (this.player.cor < 75)
                this.outputText("doing your best to play your part in the scene.", false);
            else
                this.outputText("hoping to encourage her to absolutely soak you with cum.", false);
            this.outputText("\n\nUrta looks down with a surprisingly shy expression and asks, \"<i>Could you... lick the tip please?  For me?</i>\"\n\n", false);
            if (this.player.cor < 50)
                this.outputText("Hesitantly, you extend your tongue and lick the underside of her flat-tip.  ", false);
            else
                this.outputText("Eagerly, you lick around the outside edge of her flared tip, sticking your tongue out as far as you can to lick the underside once you finish.  ", false);
            ...
            if (this.player.cor > 50)
                this.outputText("You hope the show will be arousing enough to get them off on you as well, and with renewed determination you turn back to Urta and give her balls a squeeze.", false);
            else
                this.outputText("You shudder in shame, and hope that the crowd will disperse. It's humiliating enough waiting to have Urta soak you with cum.", false);
            ...
            if (this.player.biggestTitSize() < 1)
                ...
                this.outputText("cleavage.  ", false);
            ...
            if (this.player.cor > 60)
                this.outputText(", being sure to lick your fingers clean afterwards", false);
            this.outputText(".\n\n", false);
            if (this.player.cor > 50) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] >= 11)
                    this.outputText("stuffs herself back into her fishnet", false);
                else
                    this.outputText("curls her tail back around her member, concealing it from view", false);
                this.outputText(".", false);
        ...
        optionalUrtaBukkake() {
            this.urtaSprite();
            this.player.slimeFeed();
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] -= 2;
            this.urtaLove(-1);
            this.outputText("", true);
        ...
        goBackToUrtasForLuvinz() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 1) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.URTA_PETPLAY_DONE] == 0 && this.urtaLove())
                    this.outputText("  <b>A new, shiny leather collar lies half-concealed under a cushion, as though its owner haphazardly tried to bury it in a rush.</b>");
                ...
                if (this.player.totalCocks() > 0)
                    this.outputText("In her hand is another sheath, ready to gird your own equipment in a fashion similar to her own.  ", false);
            ...
            if (this.player.lib > 50 || this.player.cor > 50)
                this.outputText(" and are actually turned on by the thought of walking through the city with such a 'big' lover hanging off your arm", false);
        ...
        goBackToUrtasForLuvinzII() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_SEEN_URTA_SEX_TOYS] == 0) {
                this.outputText("  The last group is the most numerous of those three.", false);
                if (kGAMECLASS_1.kGAMECLASS.giacomo > 0)
                    this.outputText("  You recognize some of the toys as Giacomo's wares, though there are a fair number that seem to be custom made, and others that are clearly living creatures.", false);
            ...
            if (this.player.hasVagina() && this.player.totalCocks() > 0)
                this.outputText("hard and wet as you've ever been", false);
            else if (this.player.totalCocks() > 0)
                this.outputText("hard as you've ever been", false);
            else if (this.player.hasVagina())
                this.outputText("wet as you've ever been", false);
            else
                this.outputText("ready as you've ever been to take such a monster", false);
            this.outputText(".\n\n", false);
            ...
            if (this.player.totalCocks() > 0)
                vaginal = this.dudeFuckingUrtasCooch;
            if (this.player.hasVagina())
            ...
            if (this.player.isGoo() && this.player.skinType == appearanceDefs_1.SKIN_TYPE_GOO)
                this.addButton(4, "Goo (Weird)", this.urtaGooTesticleVoreRuinedOrgasms);
        }
        rideUrtaTenderFemale() {
            this.urtaSprite();
            this.flags[kFLAGS_1.kFLAGS.PC_SEEN_URTA_SEX_TOYS]++;
            this.urtaLove(1.5);
            this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_URTA]++;
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY]++;
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 3 + Urta.rand(2);
            this.outputText("", true);
            ...
            if (this.player.cor < 50 || this.player.lib < 50)
                this.outputText("sheepishly ", false);
            else
                this.outputText("eagerly ", false);
            ...
            if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_WET)
                this.outputText("growing moistness in your loins", false);
            else if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                this.outputText("sopping wetness in your loins", false);
            else
                this.outputText("flood of moisture leaking from your crotch", false);
            this.outputText(" signals your readiness to take her.", false);
            if (this.player.totalCocks() > 0) {
                if (this.player.totalCocks() == 1)
                    this.outputText("  Your " + this.multiCockDescriptLight() + " is raging hard and trembling, but ignored for now.", false);
                else
                    this.outputText("  Each of your " + this.multiCockDescriptLight() + " is raging hard and trembling, but ignored for now.", false);
            }
            ...
            if (this.player.vaginalCapacity() < 60)
                this.outputText("and you bottom out there, unable to take in any more of her equine shaft.", false);
            else
                this.outputText("and you keep going, sliding down along the marvelous member until your cunt-lips are rubbing her sheath against your [clit].", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.biggestTitSize() >= 5) {
                ...
                if (!this.player.hasFuckableNipples())
                    this.outputText("rubbing over her black-skinned buds.", false);
                else
                    this.outputText("parting as her prominent black nipples slip inside your own.", false);
                ...
                if (this.player.totalCocks() > 0) {
                    if (this.player.cocks[0].cockLength > 15) {
                        if (this.player.totalCocks() == 1)
                            this.outputText("  Your " + this.multiCockDescriptLight() + " pushes up between the jiggling breasts, slicking them with your pre-cum as it begins to get tit-fucked by both of your trembling forms.", false);
                        else
                            this.outputText("  Each of your " + this.multiCockDescriptLight() + " pushes up between the jiggling breasts, slicking them with your pre-cum as they begin to get tit-fucked by both of your trembling forms.", false);
                    }
                }
                this.outputText("\n\n", false);
            }
            ...
            if (this.player.totalCocks() > 0) {
                if (this.player.cockTotal() == 1) {
                    ...
                    if (this.player.cocks[0].cockLength > 15 && this.player.biggestTitSize() >= 5)
                        this.outputText("jiggling tits", false);
                    else
                        this.outputText("bellies", false);
            ...
            if (this.player.totalCocks() > 0) {
                ...
                if (this.player.totalCocks() == 1)
                    this.outputText("has", false);
                else
                    this.outputText("have", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_URTA] <= 10 || this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] < 11)
                ...
                this.outputText("</i>\"<i>You're so good to me " + this.player.short + ".  I wish my little pony here was fertile enough for me to put a bun in your oven, if you wanted of course.</i>\"", false);
        ...
        dudeFuckingUrtasCooch() {
            ...
            if (cocks > 1 && y >= 0)
                this.outputText("Your secondary " + this.cockDescript(y) + " wobbles directly behind her back-door and Urta's eyes widen a bit when she realizes you're going to double-penetrate her.  ", false);
            if (cocks > 2)
                this.outputText("The remainder of your " + this.multiCockDescriptLight() + " fan out, ready to rub themselves against her butt-cheeks once you push inside.  ", false);
            ...
            if (cocks > 1 && y >= 0)
                this.outputText("Your second " + Appearance_1.Appearance.cockNoun(this.player.cocks[y].cockType) + " soon bumps against her pucker and strains against it, pushing ever-so-slowly into her tight hole as she gradually relaxes before you.  ", false);
            ...
            if (this.player.balls > 0)
                this.outputText("Your balls loudly smack into her squelching-wet cunt and the soaked backside of HER balls", false);
            else
                this.outputText("Your crotch slaps loudly against her squelching-wet cunt and backside", false);
            ...
            if (cocks > 1 && y >= 0)
                this.outputText("The intensity and pressure in her back-door is even worse, and your " + this.cockDescript(y) + " is nearly in pain from her asshole's tight, pulsating grip.  ", false);
            ...
            if (cocks > 1 && y >= 0)
                this.outputText("The " + this.cockDescript(y) + " you've crammed in her ass does not disappoint either, matching its brother squirt for squirt as it spends your seed with reckless abandon.  ", false);
            if (cocks > 2)
                this.outputText("Her butt and tail are covered with the stuff as each of your remaining " + this.multiCockDescriptLight() + " splatters her with spooge, covering her fur in white sludge.  ", false);
            ...
            if (this.player.cumQ() >= 750)
                this.outputText("  Her body is quickly bloated thanks to your body's incredible fertility, but she seems able to take it just fine.", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.biggestTitSize() >= 1)
                this.outputText("your own " + this.breastDescript(0), false);
            else
                this.outputText("your chest", false);
        ...
        fuckItAndLeave() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] < 1)
                this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] = 1;
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 36;
            this.urtaLove(-5);
            this.outputText("", true);
        ...
        tenderTakeItUpTheAssFromUrta() {
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_URTA]++;
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY]++;
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 2 + Urta.rand(3);
            var cocks = this.player.totalCocks();
            ...
            if (this.player.analCapacity() >= 60)
                this.outputText("You sigh and begin sliding down it, your previously-stretched backdoor easily accepting the gigantic intruder as it fills you.", false);
            else {
                ...
                if (this.player.ass.analLooseness < 5) {
                    if (this.player.ass.analLooseness == 0)
                        this.outputText("<b>  Urta has taken your anal virginity.</b>", false);
                    else
                        this.outputText("<b>  Your ass is stretched.</b>", false);
                    this.player.ass.analLooseness++;
                }
            }
            //Butt Stretched used to determine how long since last enlargement
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.ButtStretched) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.ButtStretched, 0, 0, 0, 0);
            //Reset the timer on it to 0 when restretched.
            else
                this.player.changeStatusValue(StatusAffects_1.StatusAffects.ButtStretched, 1, 0);
            if (this.player.totalCocks() > 0) {
            ...
            if (cocks > 0) {
                ...
                if (this.player.cocks[0].cockLength >= 15) {
                    ...
                    if (this.player.cocks[0].cockLength >= 20 && this.player.cocks[0].cockLength <= 28)
                        this.outputText(", even taking time to lick and suck on the head", false);
                    this.outputText(".", false);
            ...
            if (cocks == 0)
                this.outputText("Strange pleasure spreads from your sensitive opening, and you know that somehow you're going to cum from this.  ", false);
            else
                this.outputText("Powerful pleasure spreads through you as it bumps and rubs your prostate. You know you'll cum from this, and soon.  ", false);
            ...
            if (cocks > 0) {
                if (this.player.cocks[0].cockLength < 15)
                    this.outputText("Your orgasm erupts out onto her belly, splattering her fur with your sticky cum.  ", false);
                else if (this.player.cocks[0].cockLength < 20)
                    this.outputText("Your orgasm erupts all over her tits, slicking them with your sticky white cum.  ", false);
                else
                    this.outputText("Your orgasm erupts into her muzzle, filling her mouth with your sticky, white cum.  ", false);
                this.outputText("  Urta groans underneath you and begins caressing and squeezing you, milking you of every drop.", false);
                if (this.player.cumQ() >= 500)
                    this.outputText("  Urta gulps down as much as she can but it begins leaking around her muzzle, and she eventually lets it pop free, giving up on swallowing it entirely.", false);
                if (this.player.cumQ() >= 1000 && this.player.cumQ() < 1500)
                    this.outputText("  Your output easily soaks her, and she gathers it up and slops it over her nipples, pinching and pulling on them.", false);
                if (this.player.cumQ() >= 1500)
                    this.outputText("  Your output soaks her and the bed with seed, leaving the two of you in a warm gooey puddle in the very center of the bed.", false);
                this.outputText("\n\n", false);
            }
            ...
            if (this.player.cumQ() > 750)
                this.outputText("  You really are a messy, " + this.player.mf("boy", "girl") + " aren't you?", false);
            this.outputText("</i>\"\n\n", false);
        ...
        marbleCockuBlockuUrta() {
            ...
            //if nursery
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_NURSERY_CONSTRUCTION] == 100)
                this.outputText(" and a nursery", false);
            this.outputText(".", false);
            //(Not wuv'ed yet)
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 0) {
        ...
        TellUrtaDAHTRUUUUF() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 1)
                this.outputText("I love you for it", false);
            else
                this.outputText("I respect you for it", false);
            this.outputText(".");
            if (!this.urtaOpenAboutEdryn()) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 1)
                    this.outputText("been together", false);
                else
                    this.outputText("gotten intimate", false);
        ...
        comfortUrtaAfterTellinTruuf() {
            ...
            if (((this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR && this.player.totalCocks() > 0) ||
                this.player.horseCocks() > 0 ||
                (this.player.totalCocks() > 0 && this.player.cor > 50)) &&
                this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) >= 4)
        ...
        toughenUpUrtaAfterTellingTruuf() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 1)
                this.outputText("heartbroken", false);
            else
                this.outputText("saddened", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 1) {
                ...
                this.flags[kFLAGS_1.kFLAGS.URTA_PC_AFFECTION_COUNTER] = 0;
                this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] = -1;
            }
            else {
        ...
        lietoUrtaAboutMarble() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] == 1)
                this.outputText(" and saw the kid", false);
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_NURSERY_CONSTRUCTION] > 1)
                this.outputText(" and saw the kids", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] = -1;
            this.flags[kFLAGS_1.kFLAGS.URTA_PC_AFFECTION_COUNTER] = 0;
            this.flags[kFLAGS_1.kFLAGS.URTA_ANGRY_AT_PC_COUNTDOWN] = 48;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[TWU WUV TALK]
        UrtaTwuWuvOffer() {
        ...
        stayFuckbuddiesAfterShootingDown() {
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 0;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[no]
        ...
        eatUrtaOutNomNomPussy() {
            this.urtaSprite();
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 3;
            this.urtaLove(1);
            this.outputText("", true);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] >= 1)
                this.outputText("secretly hoping you were noticed", false);
            else
                this.outputText("hoping no one saw you disappear", false);
        ...
        giveUrtaCumGlass() {
            this.urtaSprite();
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 1;
            this.urtaLove(-.5);
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY]++;
            this.outputText("", true);
        ...
        blowUrtaUnderTheTableLuv() {
            ...
            if (this.player.cor < 50)
                ...
                this.outputText("shove forwards, ramming her massive cock so far down your throat that you can feel it dribbling pre-cum into your belly.", false);
            this.outputText("  Urta grunts, doing her best to muffle the noise as it escapes her lips, but you can feel her twitch and thicken inside you, beginning to drip with proof of her complete and total submission to your mouth.\n\n", false);
            this.outputText("You can hear chuckles from the bar's other occupants as they realize what's going on, and you blush, ", false);
            if (this.player.cor < 50 && this.flags[kFLAGS_1.kFLAGS.PC_FETISH] <= 0)
                this.outputText("wishing there was a tablecloth to hide your activities from prying eyes", false);
            else
                this.outputText("wishing you had even more eyes watching your show", false);
        ...
        rideUrtasCoochLoveyDovey() {
            this.urtaSprite();
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 2 + Urta.rand(2);
            this.urtaLove(1);
            this.outputText("", true);
            //(TOO SMALL)
            ...
            if (this.player.cockTotal() > 0) {
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText("a latex sheath", false);
                else
                    this.outputText("some latex sheaths", false);
            ...
            if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_WET)
                this.outputText("growing moist", false);
            else if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                this.outputText("growing wetter and wetter as you lubricate the tip of her condom", false);
            else
                this.outputText("soaking her condom-covered cock with your copious cunt-secretions", false);
            ...
            if (this.player.vaginalCapacity() < 80)
                this.outputText("until there is no more room for cum and it's squirting out around the base of her cock, soaking Urta and the bed with fragrant horse-cum.", false);
            else
                this.outputText("filling your body with a large bubble of hot horse-cum.", false);
            ...
            if (this.player.cockTotal() > 0) {
                ...
                if (this.player.cockTotal() == 1) {
                    ...
                    if (this.player.cumQ() >= 250) {
                        if (this.player.cumQ() < 500)
                            this.outputText("  The balloon inflates slightly, drooping down as your maleness empties its reserves.  ", false);
                        else if (this.player.cumQ() < 1000)
                            this.outputText("  The balloon swells larger and larger as you pump it full, eventually wobbling around on Urta's belly as you finish filling it.", false);
                        else {
                            ...
                            if (this.player.cumQ() > 1500)
                                this.outputText("  Your potent seed pops the condom, splattering Urta with your seed as it explosively fails.", false);
                        }
                    }
                }
                else {
                    ...
                    if (this.player.cumQ() >= 250) {
                        if (this.player.cumQ() < 500)
                            this.outputText("  The balloons inflate slightly, drooping down as your malenesses empty their reserves.  ", false);
                        else if (this.player.cumQ() < 1000)
                            this.outputText("  The balloons swell larger and larger as you pump them full, eventually wobbling around on Urta's belly as you finish filling them.", false);
                        else {
                            ...
                            if (this.player.cumQ() > 1500)
                                this.outputText("  Your potent seed pops the condoms, splattering Urta with your seed as they explosively fail.", false);
                        }
                    }
                }
            }
        ...
        rideUrtaInButtAtHomeLove() {
            ...
            if (this.player.totalCocks() > 0) {
                ...
                if (this.player.totalCocks() == 1)
                    this.outputText("a condom", false);
                else
                    this.outputText("some condoms", false);
            ...
            if (this.player.analCapacity() < 60)
                ...
                this.outputText("welcoming", false);
            ...
            if (this.player.hasFuckableNipples())
                this.outputText("even slipping a finger inside their slippery depths, ", false);
            ...
            if (this.player.totalCocks() > 0) {
                ...
                if (this.player.balls > 0)
                    ...
                    this.outputText("prostate", false);
            ...
            //(EVERYBODY ELSE)
                ...
                if (this.player.hasVagina()) {
                    ...
                    if (this.player.vaginas[0].vaginalWetness > appearanceDefs_1.VAGINA_WETNESS_WET && this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_SLAVERING)
                        this.outputText("  Fluids soak Urta's crotch with lust with feminine drool, though the fox barely seems to notice.", false);
                    else if (this.player.vaginas[0].vaginalWetness == appearanceDefs_1.VAGINA_WETNESS_SLAVERING)
                        this.outputText("  An explosion of feminine fluids spatters Urta's crotch and bed, completely soaking her groin in your need, but the distracted fox barely notices.", false);
                }
                if (this.player.totalCocks() > 0) {
                    ...
                    if (this.player.cumQ() >= 750 && this.player.cumQ() < 1250)
                        this.outputText("  By the time you're done the balloon is the size of a basketball and looking dangerously close to bursting.", false);
                        ...
                        if (this.player.cumQ() >= 1700)
                            this.outputText("  You fill it fuller and fuller, until it's bigger than you thought possible.  All at once the material gives out, soaking Urta from the tits down in cum, while your " + this.cockDescript(0) + " continues to pump even more onto her.  So much for not making a mess!", false);
                    }
                }
                this.outputText("\n\n", false);
            }
            ...
            if (this.player.cumQ() >= 1700)
                this.outputText("Urta sighs at the mess and laughs, \"<i>I guess we got a mess anyways, huh?</i>\"", false);
            else
                this.outputText("Urta sighs contentedly and laughs, \"<i>I guess I don't have much of a mess to clean for once!</i>\"", false);
        ...
        oralFiestyUberExplosionUrta() {
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 2 + Urta.rand(2);
            this.outputText("", true);
            var x = this.player.cockThatFits(100);
            if (x < 0)
                x = 0;
            //(TOO BIG)
            ...
            if (this.player.gender == 2 || (this.player.gender == 3 && Urta.rand(2) == 0)) {
                ...
                if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                    this.outputText("equally wet", false);
                else
                    this.outputText("sopping wet", false);
                ...
                if (this.player.cor > 50) {
                    ...
                    this.outputText("grab hold of her cock and begin jerking her off into your mouth.  An immediate and copious gush of pre drips onto your tongue, showing you just how much the hermaphroditic fox loves the feeling.\n\n", false);
                ...
                if (this.player.cor <= 50)
                    this.outputText("mouth", false);
                else
                    this.outputText("throat", false);
                this.outputText(", clamping your " + this.player.legs() + " onto Urta's head as you orgasm.  ", false);
                if (this.player.vaginas[0].vaginalWetness > appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                    this.outputText("Fluids rush from your folds, splattering her face with sex fluid.  The fox opens wide, gulping it down like someone in a desert who has just found an oasis.", false);
                else
                    this.outputText("Wetness slowly coats her muzzle as your canal squeezes and wriggles with involuntary pleasure-spasms.  Urta never lets up, sucking and licking your " + this.clitDescript() + " in a rhythm that matches your own orgasmic contractions.", false);
                if (this.player.totalCocks() > 0) {
                    this.outputText("  ", false);
                    if (this.player.cockTotal() > 1)
                        this.outputText("Each of y", false);
                    ...
                    if (this.player.cumQ() < 50)
                        this.outputText("sputtering spunk onto Urta's neck.", false);
                    else if (this.player.cumQ() < 250)
                        this.outputText("soaking Urta's neck and chest with your spooge.", false);
                    else if (this.player.cumQ() < 700)
                        this.outputText("showering Urta's neck and body with spooge until her breasts are painted white and the bed has a small puddle soaking into it.", false);
                    else if (this.player.cumQ() < 1500)
                        this.outputText("soaking Urta with a torrent of seed that drenches her from the neck down and totally soaks the bed.", false);
                    else {
                        ...
                        if (this.player.cumQ() > 10000)
                            this.outputText("  The puddle thickens as you cum until it's nearly a foot deep.", false);
                    }
                }
                this.outputText("\n\n", false);
                ...
                if (this.player.cor > 50)
                    this.outputText("pours down your throat, bulging it into an obscene imprint of the horse-cock that's lodged inside.  Your eyes cross from pleasure and you slump down a bit, shoving your nose into Urta's sheath and allowing her to dump her sperm directly into your belly.  Gurgling noisily, your belly slowly expands outwards by about two inches, making you feel bloated and full.", false);
                else
                    this.outputText("erupts into your mouth, instantly filling it with thick fox-cream.  You convulsively swallow in an attempt to keep up with it, but are quickly overwhelmed by the backed up semen-flood.  It drips from your mouth and forces open your throat, flowing directly into your belly.  Some even begins dripping out from your nose as you sway with a mixture of discomfort and pleasure atop your partner.  A few trembling squirts later you feel and look a little bloated, and your " + this.player.face() + " is thoroughly covered in foxy-horse-jizz.", false);
                this.outputText("\n\n", false);
            ...
            if (this.player.balls > 0)
                this.outputText(this.ballsDescript() + ".  Slithering over and around them, she bathes your sack in her spit before moving up to your " + this.cockDescript(x) + ".", false);
            else
                this.outputText(this.cockDescript(x) + ".", false);
            ...
            if (this.player.cumQ() >= 500) {
                ...
                if (this.player.cumQ() >= 1000)
                    this.outputText("It begins dripping from her nostrils as your explosive load overwhelms her ability to swallow spunk.  ", false);
            }
            if (this.player.cumQ() >= 750 && this.player.cumQ() < 1500)
                this.outputText("Her belly rounds out a little from all the cum as your orgasm begins to wind down.  ", false);
            if (this.player.cumQ() >= 1500)
                this.outputText("Her belly rounds out a little before she pulls back and you spurt all over her, soaking her face and head with more spooge than she could ever handle.  ", false);
            ...
            if (this.player.cor < 60)
                this.outputText("in your mouth, forcing you to compulsively swallow if you don't want to drown in it.", false);
            else
                this.outputText("down your throat, directly injecting it into your belly.", false);
        ...
        urtaHomeLuvLuvinsMenu() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PETPLAY_DONE] >= 0 && this.player.gender > 0)
                this.addButton(7, "Collar", this.urtaPetPlayDeletedForeverBecauseThirdProovedMeWrongAboutDice);
        }
        urtasCoochiNeedsFuckedLove() {
            ...
            if (this.player.hasSheath())
                this.outputText("sensitive skin of your sheath rubbing her exterior pussy-lips", false);
            else
                this.outputText("wetness of her pussy rubbing against your groin", false);
            ...
            if (this.player.hasKnot(x)) {
                ...
                if (this.player.cumQ() < 250) { }
                    ...
                    this.outputText("Her belly puffs up slightly by the time you finish, thanks to your body's copious cum production.  ", false);
                else if (this.player.cumQ() < 1000)
                    this.outputText("Her belly swells larger and larger as you continue to pump your seemingly endless seed into her.  Urta groans, looking a few months pregnant by the time your overproductive " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " stops spewing inside her.  ", false);
                else {
                    ...
                    if (this.player.cumQ() < 3000)
                        this.outputText("By the time you finish, she looks VERY pregnant and is moaning with a mixture of pleasure and discomfort.  ", false);
                    else {
                        ...
                        if (this.player.cumQ() > 5000)
                            this.outputText("Not content with such an easy release, your " + this.cockDescript(x) + " unloads the last of its cream until the bed and floor are both covered under inches of your canine cum.  ", false);
                    }
                }
                this.outputText("You finally feel your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + "'s knot shrinking and pull free with a loud and messy pop.  ", false);
                if (this.player.cumQ() >= 2000)
                    this.outputText("Spunk rushes out in a torrent, splattering everywhere.  ", false);
            ...
            //[HORSE]
            else if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE) {
                this.outputText("You feel your flare filling with blood as it ", false);
                if (this.player.cocks[x].cockLength >= 10)
                    this.outputText("prods against Urta's cervix.", false);
                else
                    this.outputText("seats itself deep inside Urta's passage.", false);
                ...
                if (this.player.cumQ() < 250) { }
                    ...
                    this.outputText("Her belly slowly rises as more and more cum slides into her womb, filling it.  Runners of the stuff leak down her thighs as it escapes around your bestial cock.  ", false);
                else if (this.player.cumQ() < 1000)
                    this.outputText("Her belly swells larger and larger as you continue to pump your seemingly endless seed into her.  Urta groans, looking a few months pregnant by the time your over-productive " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " has finished spewing your seed inside her.  ", false);
                else {
                    ...
                    if (this.player.cumQ() < 3000)
                        this.outputText("By the time you've finished, she looks heavily pregnant and cum soaks the bed.  ", false);
                    else
                        this.outputText("Your seemingly endless orgasm pumps more and more into her until she looks ready to give birth, and  you just keep going.  She moans in pleasure and discomfort as each blast of your horse-cum forces thick runners to squirt from between her thighs.  ", false);
                    if (this.player.cumQ() > 5000)
                        this.outputText("Not content with such an easy release, your " + this.cockDescript(x) + " unloads the last of its cream until the bed and floor are covered in several inches of thick equine cum.  ", false);
                }
            ...
            //[Everybody Else]
                ...
                if (this.player.cumQ() < 250) { }
                    ...
                    if (this.player.cumQ() < 3000)
                        ...
                        this.outputText("Your seemingly never-ending orgasm pumps her up until she looks on the verge of giving birth, and you just keep going.  Jism sprays out from her dripping cunt as you release a torrent of semen, splattering you, her, and the bed.  ", false);
                    if (this.player.cumQ() > 5000)
                        this.outputText("Not content with such an easy release, your " + this.cockDescript(0) + " unloads the last of its cream until the bed and floor are both covered under inches of your gooey cum.  ", false);
                }
                this.outputText("You finally feel your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " deflating, and you pull free with a messy slurp.  ", false);
                if (this.player.cumQ() >= 2000)
                    this.outputText("Spunk rushes out in a torrent, splattering everywhere.  ", false);
                this.outputText("Urta's glazed pussy-lips clench reflexively at their sudden emptiness and you hear a very satisfied sigh from the far end of the bed.\n\n", false);
            }
            //[RESUME]
            this.outputText("Urta calms down at last, though her member is still throbbing weakly as she peels her condom off.  The bloated cum-bubble at the tip is the size of a basketball, and she struggles to get it tied off and disposed of.  The fox tosses it into a waste-basket already full of the things and gives you a toothy smile, \"<i>I think somebody's " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " loves my pussy almost as much as I love you!</i>\"\n\n", false);
        ...
        scyllaAndUrtaSittingInATree() {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00143]++;
            if (!this.urtaDrunk()) {
                this.urtaAndScyllaBoningLikeBitchesSober();
                return;
            }
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00147] == 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00145] > 0) {
                ...
                // Butans
                if (this.player.cockThatFits(this.urtaCapacity()) != -1 && this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR) {
                ...
                if (!this.urtaLove())
                    this.outputText("Urta", false);
                else
                    this.outputText("your love", false);
                ...
                if (this.player.cor < 40)
                    this.outputText("corrupted ruffians", false);
                else
                    this.outputText("demon agents", false);
                ...
                if (this.urtaLove())
                    this.outputText("weakly protesting", false);
                else if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] >= 11)
                    this.outputText("giving you a lewd look", false);
                else
                    this.outputText("blushing hard", false);
                this.outputText(" as she cradles Scylla's head in her hands and pushes down.  She slurs, \"<i>", false);
                if (this.urtaLove())
                    this.outputText("I'm... ahhhh... s-sorry love, but we both know she's been suuuu - oh yeah, keep licking - sucking you off before, and the hungry slut just couldn't take her eyes off my cock.  Why didn't you tell me ho - OH YES!  RIGHT THERE! - h-how good she was?", false);
                else if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] >= 11)
                    this.outputText("Ohhh, you showed up a little late... mmmhmm yes, now lick... Oh, why didn't you tell me ho - OH YES!  RIGHT THERE! - h-how good of a cock-sucker this lewd-bodied bitch was?", false);
                else
                    this.outputText("H-hi " + this.player.short + "... I didn't think I'd get to see you to- Oh yeah, like that!  Mmmm... OH!  I guess since we've been intimate before you can watch...", false);
                this.outputText("</i>\"\n\n", false);
        ...
        urtaAndScyllaBoningLikeBitchesSober() {
            ...
            if (this.silly())
                this.outputText("For some reason, it makes you think of mythical balloonicorns.  ");
        ...
        fuckUrtaWhileScyllaSucksSober() {
            ...
            if (this.player.cockArea(x) >= 40)
                this.outputText(", clearly bulging her stomach with your sizeable cock");
            ...
            if (this.player.balls > 0)
                this.outputText("the front of your [sack]");
            else
                this.outputText("your [legs]");
            ...
            if (this.silly())
                this.outputText("a cock and a sharp place.");
            else
                this.outputText("your lusty bodies.");
            ...
            if (this.player.cockTotal() > 1)
                this.outputText("  The unbound portion of your package bobs in the air before coming to rest in Urta's ass-crack.  A second later, the vulpine butt is coated with sticky white icing.");
            if (this.player.lactationQ() > 50)
                this.outputText("  Your sensitive nipples let down, releasing their own heady flows to compliment your climactic pleasure, spraying into the gray fur relentlessly.");
            ...
            if (this.player.cumQ() >= 500) {
                ...
                if (this.player.cumQ() >= 2000)
                    this.outputText(", rounding more and more, a taut cum-tank that jiggles with your thick seed.");
                else if (this.player.cumQ() >= 1200)
                    this.outputText(", rounding out into a swollen cum-bank that jiggles under the weight of your seed.");
                else if (this.player.cumQ() >= 750)
                    this.outputText(", rounding out into a gravid bump that jiggles with liquid weight.");
                else
                    this.outputText(", rounding out into a nicely-sized bump.");
            ...
            if (this.player.tallness >= 78)
                this.outputText("head");
            else if (this.player.tallness >= 48)
                this.outputText("narrow middle");
            else
                this.outputText("curvy hips");
            ...
            if (this.urtaLove())
                this.outputText("  You give your lover a wet kiss and a fondle before you go, snickering when it makes her even longer.");
            else
                this.outputText("  You give her a quick hug and depart, smiling when you realize the brief touch made her even longer.");
            this.knockUpUrtaChance();
            //-2 sens, -100 lust
            this.player.orgasm();
            this.dynStats("sen", -2);
        ...
        dockWithUrtaUnderScyllasSoberSupervision() {
            ...
            if (this.player.hasVagina())
                this.outputText("half's ");
            this.outputText("musk fills the air.");
            if (this.player.balls > 0)
                this.outputText("  Your [sack] swings free, bouncing off the back of [oneCock] when it thickens precipitously.");
            ...
            if (!this.player.isBiped() && !this.player.isDrider())
                this.outputText("slips along");
            else
                this.outputText("slides through");
            ...
            if (this.silly())
                this.outputText(".  She even mentions something about how you can be her big daddy");
            ...
            if (this.player.balls > 0)
                this.outputText("  Your [sack] stretches tight, totally  filled by the burgeoning testes concealed within.");
            ...
            if (this.player.balls > 0)
                this.outputText("  You shift to let your bloated ball-sack breathe a little better as well.");
            this.outputText("\n\nUrta has the sense to stop and step back in alarm.  ");
            if (this.flags[kFLAGS_1.kFLAGS.URTA_SCYLLA_BIG_DICK_TIMES_DONE] > 0)
                this.outputText("Just like last time, she adopts a panicked expression and lunges for the door, but she moves slowly and a gooey drop of pre-cum hangs from her flare as she moves.");
            else
                this.outputText("With a panicked expression on her face, she lunges for the door, her hard cock flopping awkwardly.");
            ...
            if (this.player.balls > 0)
                this.outputText("  Your [balls] quiver a little when the rushing seed reaches them, and you swear you hear them slosh with the horse-spunk pouring into their own reservoirs.");
            else
                this.outputText("  Your innards gurgle slightly as the rushing seed travels through them, and you swear you can feel your prostate stretching to accommodate being suddenly stuffed with horse-spunk.");
            ...
            if (this.player.balls > 0)
                this.outputText(" while your enormous balls gurgle and begin to empty");
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_SCYLLA_BIG_DICK_TIMES_DONE]++;
        ...
        dockWithUrtaUnderScyllasSoberSupervision2() {
            ...
            if (!this.urtaLove())
                this.outputText("waves ");
            else
                this.outputText("kisses you ");
            ...
            if (this.player.balls > 0)
                this.outputText("  Your balls definitely got a little bigger...");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[Never See]
        ...
        flipUrtaTheBird() {
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] -= 2;
            if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] < 0)
                this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] = 0;
        ...
        watchTwoHotBitchesAndJerkIt() {
            ...
            if (this.player.hasVagina())
                this.outputText(" and exposing your " + this.vaginaDescript(0), false);
            ...
            if (this.player.hasVagina())
                this.outputText(" and touch your " + this.vaginaDescript(0), false);
            ...
            if (this.player.cumQ() >= 250)
                this.outputText("A particularly coherent blast of seed splatters over Urta's tits, glazing her gray fur and black nipples with a thick layer of dripping spunk.  ", false);
            if (this.player.cumQ() >= 450)
                this.outputText("Another huge gout takes Scylla straight in the face, completely soaking her with yet more salty mess that drools onto the curve of her pendulous, black-clad tits.  ", false);
            if (this.player.cumQ() >= 700)
                this.outputText("A few more big blasts of the stuff fire off, spotting the pair with fat, sticky blotches.  ", false);
            if (this.player.cumQ() >= 1000) {
                ...
                if (this.player.cumQ() >= 2000)
                    this.outputText("n inches-deep", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00143] == 1)
                this.outputText("\"<i>We need to do thish again!</i>\"", false);
            else
                this.outputText("\"<i>You're the besht " + this.player.mf("man", "woman") + " a girl could ashk for.</i>\"", false);
            ...
            if (this.urtaLove())
                this.outputText("  You give your lover's back a wistful grin and muse over how good her taste in women is as you leave.", false);
            this.player.orgasm();
            //+luv
            this.urtaLove(2);
            //+comfort
        ...
        makeUrtaSitOnYourLapWithScylla() {
            ...
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_NAGA)
                this.outputText(", snaking your tail around her legs", false);
            else if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_GOO)
                this.outputText(", enveloping her legs with your goo", false);
            else
                this.outputText(", straddling your " + this.player.legs() + " around her hips", false);
            ...
            if (y > -1)
                this.outputText("Your " + this.cockDescript(y) + " even manages to get in line with her drooling, black-lipped pussy.  ", false);
            if ((this.player.cockTotal() > 1 && y == -1) || this.player.cockTotal() > 2)
                this.outputText("You allow your remaining, unused dickflesh to flop against her back, leaking pre-cum into her fur.  ", false);
            ...
            if (y != -1)
                this.outputText(" and squeezing you tightly with her sopping cunt", false);
            this.outputText(".\n\n", false);
            this.outputText("She grunts, \"<i>", false);
            if (x != -1 && y != -1)
                this.outputText("Oooh, and in both holes?  You naughty " + this.player.mf("boy", "girl") + ", you!", false);
            else if (this.urtaLove())
                this.outputText("Oooh yeah, fill me love!", false);
            else if (Urta.rand(2) == 0)
                this.outputText("Oooh, you know how to treat a lady!", false);
            else
                this.outputText("MMmm, that's nice!", false);
            ...
            if (this.urtaLove() || this.player.cor <= 40)
                this.outputText("kiss her full on the mouth", false);
            else
                this.outputText("bite her neck", false);
            ...
            if (y != -1)
                this.outputText("and twat ", false);
            ...
            if (y != -1)
                this.outputText("double penetration", false);
            else
                this.outputText("anal fuck", false);
            ...
            if (y != -1)
                this.outputText(" and pussy", false);
            ...
            if (y > -1)
                this.outputText("  Meanwhile, your other " + Appearance_1.Appearance.cockNoun(this.player.cocks[y].cockType) + " utterly fills her womb, stuffing it so completely that the fox's belly rounds out.", false);
            if ((this.player.cockTotal() > 1 && y == -1) || this.player.cockTotal() > 2)
                this.outputText("  A wave of the stuff splatters her back, glazing her from the shoulder-blades to the crack of her ass and nearly catching you in the chin. Maybe there is such a thing as too many cocks?", false);
            ...
            if (this.urtaLove())
                this.outputText("a contended smile on her face, and gives you a long, slow kiss that practically radiates her love for you.", false);
            else if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] < 11)
                this.outputText("a nervous smile on her face, but gives you a quick peck all the same.", false);
            else
                this.outputText("a satisfied smile on her face, and crushes her lips against yours in a passionate kiss.", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00143] <= 1)
                this.outputText("pay for the door and ", false);
            ...
            this.urtaLove(3);
            //+comfort
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] += 3;
            this.player.cumMultiplier += 2;
            this.player.ballSize += 1;
            if (y >= 0)
                this.knockUpUrtaChance();
        ...
        tellUrtaNoMoreScylla() {
            this.urtaSprite();
            this.outputText("", true);
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00147] = 1;
            ...
            if (this.urtaLove())
                this.outputText("Just please, don't doubt my love for you.  ", false);
        ...
        tellUrtaMoreScyllaIsFine() {
            ...
            if (this.urtaLove())
                this.outputText("Just remember that YOU'RE the one I love, not her.  ", false);
            else
                this.outputText("Me and her, we've been partners in the guard for a long time, but the sex is just mechanical, to sate us.  You don't have to worry about her stealing me away.  ", false);
        ...
        tellUrtaToBeADrunkenHussy() {
            ...
            if (this.player.cor < 33)
                this.outputText("blush a little bit", false);
            else if (this.player.cor < 66)
                this.outputText("smile nervously", false);
            else
                this.outputText("grin widely", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00146] = 1;
            this.dynStats("lus", 5);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[Drink Less]
        ...
        tellUrtaToStayTheSame() {
            ...
            if (this.urtaLove())
                this.outputText("love", false);
            else
                this.outputText("like", false);
        ...
        amilyXUrtaUrtaFallout() {
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00350] = 2;
            this.urtaSprite();
            this.outputText("", true);
            this.outputText("You ", false);
            if (!this.player.isTaur())
                this.outputText("pull up a chair", false);
            else
                this.outputText("sit down", false);
        ...
        chastityBeltFun(cameFromSexMenu = true) {
        ...
        QBsTalkExpack() {
            ...
            //(Lover Urta)
            if (this.urtaLove())
                this.outputText("When you approach Urta, she smiles to see you.  However, there is no rapid swivelling in her seat to avoid banging her horse-cock against the table; evidently she's not in the mood for some sex right now.  You sit down beside her, and she happily loops her arm around you, planting a tender kiss on your lips, before almost apologetically stating, \"<i>Hey there, lover.  Want to talk for a change?</i>\" with a twinkle of good-natured mirth in her eyes.");
            else
                this.outputText("When you approach Urta, you are almost surprised at the lack of an audible 'thump'.  Seeing your confusion, the herm fox quips, \"<i>What's with the look?</i>\" while raising an eyebrow.  When you indicate that you had expected to hear her demonstrating her excitement to see you, she blushes and looks embarrassed.  \"<i>Well... you do a pretty good job of letting my little pony blow off some steam, ya know, [name]?</i>\"");
        ...
        urtaDialogueMenu() {
            ...
            if (!this.urtaJustFriends())
                this.addButton(3, "Alcoholism", this.urtaDiscussesAlcholism);
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.FIRST_TIME_AT_URTA_HOUSE] > 0)
        ...
        urtaDiscussesSelf() {
            ...
            if (!this.urtaLove())
                ...
                this.outputText("“<i>Well, I don't think there's that much to tell,</i>” she says with a smile.  She idly blows a bang out of her face and exhales, “<i>Well, lover, I'm an open book for you, what do you want to know?</i>”");
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] == .5)
                this.simpleChoices("Infertility", kGAMECLASS_1.kGAMECLASS.urtaQuest.infertilityQuestions, "Romance&Sex", this.urtaDiscussesSexAndRomance, "Employment", this.urtaDiscussesEmployment, "Prejudice", this.urtaDiscussesPrejudice, "Back", this.urtaDialogueMenu);
            else if (this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] == 1)
                this.simpleChoices("Fertility", this.urtaFertilityDiscussion, "Romance&Sex", this.urtaDiscussesSexAndRomance, "Employment", this.urtaDiscussesEmployment, "Prejudice", this.urtaDiscussesPrejudice, "Back", this.urtaDialogueMenu);
            else
                this.simpleChoices("Family", this.urtaDiscussesFamily, "Romance&Sex", this.urtaDiscussesSexAndRomance, "Employment", this.urtaDiscussesEmployment, "Prejudice", this.urtaDiscussesPrejudice, "Back", this.urtaDialogueMenu);
        }
        flirtWithUrta() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == -1) { //In friends mode
            ...
            this.outputText("You’re pretty sure most of the bar noticed, but you don’t care.  You keep rubbing and feel a thump as something large smacks against the underside of the table.  Urta drains the last of her drink and whispers, “<i>" + (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == -1 ? "What about Kath?  I... I wouldn't..." : "Please - it’s so hard...") + "</i>”\n\n");
            ...
            this.outputText("You ease up so she has a chance of understanding what you’re saying.  “<i>" + (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == -1 ? "I'll explain everything to Kath.  You want this as much as I do, right?" : "Yes, some chicks, with their big dicks, just do it for me.") + "</i>”  You slide " + (this.player.isNaga() ? "the tip of your tail" : "your toes") + " a little lower and start moving it in little circles against her balls.\n\n");
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] = 0; //urtaFuckHer will raise it to 1
            this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] = 0; //Reset both flags to put Urta back to her 'never met you before' state, ready for her first fuck
        ...
        urtaFertilityDiscussion() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_FERTILE] == 1)
                this.outputText("  Should I stay fertile?");
            else
                this.outputText("  How about I cut loose and go fertile?  Can you imagine me with a nice, round pregnant belly and a cock virile enough to get you pregnant just from looking at it?");
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PREG_EVERYBODY] == 1)
                this.outputText("  Or did you come to ask me not to be fertile and virile around anyone else?");
            else {
                this.outputText("  Would you mind me being able to put a bun in Edryn's oven?  Imagine all the lil foxtaurs running around!");
                if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] > 0)
                    this.outputText("  After all, you already had a turn!  Fair's fair!");
            }
        ...
        urtaFertilityToggle() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_FERTILE] == 1) {
                ...
                this.flags[kFLAGS_1.kFLAGS.URTA_FERTILE] = 0;
            }
            else {
                ...
                this.flags[kFLAGS_1.kFLAGS.URTA_FERTILE] = 1;
            }
            this.menu();
            this.addButton(0, "Back", this.urtaFertilityDiscussion);
        }
        urtaPregOthersToggle() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PREG_EVERYBODY] == 1) {
                ...
                this.flags[kFLAGS_1.kFLAGS.URTA_PREG_EVERYBODY] = 0;
            }
            else {
                ...
                this.flags[kFLAGS_1.kFLAGS.URTA_PREG_EVERYBODY] = 1;
            }
            this.menu();
            this.addButton(0, "Back", this.urtaFertilityDiscussion);
        }
        ...
        urtaDiscussesTheWatch() {
            ...
            this.choices("Membership", this.urtaDiscussesWatchMembership, "Role", this.urtaDiscussesWatchRole, "Crime", this.urtaDiscussesCrimeAndPunishment, "Reach", this.urtaDiscussesTheWatchsReach, "", undefined, "", undefined, "", undefined, "", undefined, "", undefined, "Back", this.urtaDialogueMenu);
        }
        //[=Alcoholism=]
        ...
        urtaDiscussesAlcholism() {
            this.clearOutput();
            this.urtaSprite();
            if (this.flags[kFLAGS_1.kFLAGS.DISCUSSED_URTA_ALCOHOLISM] == 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00145] == 0) {
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00146] == 0)
        ...
        urtaDiscussAlcoholDrinkMore() {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00146] = 1;
            this.flags[kFLAGS_1.kFLAGS.DISCUSSED_URTA_ALCOHOLISM] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[=Drink Less=]
        ...
        urtaDiscussAlcoholNoChange() {
            ...
            //{bonus wuv points}
            if (this.flags[kFLAGS_1.kFLAGS.DISCUSSED_URTA_ALCOHOLISM] == 0)
                this.urtaLove(1);
            this.flags[kFLAGS_1.kFLAGS.DISCUSSED_URTA_ALCOHOLISM] = 1;
            //{No new tags flagged}
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00146] = 0;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[=Break Up=]
        ...
        urtaDiscussesFamily() {
            ...
            if (!this.urtaLove()) {
                ...
                //(Regular
                if (!this.urtaLove()) {
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_FAMILY_TALK_ATTEMPTS] == 0)
                ...
                kGAMECLASS_1.kGAMECLASS.urtaQuest.talkWithUrtaAboutFamFam();
            }
        }
        //[=Sex/Romance=]
        ...
        urtaDiscussionTeaseAfterRomance() {
            ...
            if (!this.urtaLove())
                ...
                if (this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER)
                    ...
                    this.simpleChoices("Her Place", this.goBackToUrtasForLuvinz, "Suck Off", this.blowUrtaUnderTheTableLuv, "Eat Out", this.eatUrtaOutNomNomPussy, "", undefined, "", undefined);
            }
        ...
        urtaDiscussesEdrynRomance() {
            ...
            if (!this.urtaLove()) {
                if (!this.urtaOpenAboutEdryn()) {
                    this.flags[kFLAGS_1.kFLAGS.URTA_OPEN_ABOUT_EDRYN] = 1;
                    ...
                    if (this.player.hasVagina())
                        this.outputText("Until you, she was the only woman who didn't freak out and insist it was handjobs or nothing when she saw how big I was.  ");
                ...
                //Subsequent Regular Variant:
                    ...
                    if (this.player.cor < 66)
                        this.outputText("her manner is playful");
                    else
                        this.outputText("her expression sobers when you make no response");
                    this.outputText(".");
                    //(If player can now sleep with Edryn for free:
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) >= 5) {
            ...
            //Lover
                ...
                if (!this.urtaOpenAboutEdryn()) {
                    ...
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) >= 5)
                        this.outputText("  \"<i>Though I have to admit I was still a little jealous when Edryn told me you were having sex with her too.  Still, I guess that's just another thing we have in common, yeah?  A mutual taste in sexy ladies.</i>\"  She laughs, and mockingly shapes her hands through the air as if caressing Edryn's sizable boobs.");
                    //(If Edryn has had at least one baby:
                    if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] > 0) {
                        if (this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] == 1) {
                            if (this.urtaPregs.urtaKids() == 0)
                                this.outputText("  \"<i>...I still can't believe that you actually get her pregnant, though.  It's just not fair that Edryn's got little hooves running around, and after everything I went through, I don't have kits of my own... yet.</i>\" She gives you a slightly predatory smile along with the last word.");
                            else
                                this.outputText("  \"<i>...I still can't believe that you actually got her pregnant, though.  I guess I'll have to keep you busy in the sack if we're going to keep up, huh?</i>\" She gives you a slightly predatory smile along with the last word.");
                        }
                        else
                            this.outputText("  \"<i>...I still can't believe that you actually got her pregnant, though. It's just not fair that Edryn's got little hooves running around, and you and I can't have any.</i>\"  Urta sighs.");
                    }
        ...
        urtaDiscussesEdrynLoveTolerate() {
            ...
            this.flags[kFLAGS_1.kFLAGS.PC_DISLIKES_URTA_AND_EDRYN_TOGETHER] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[=Breakup=]
        ...
        spankTheShitOutOfUrtaAndMakeHerCreamHerselfFromProstateStimulationAloneLikeTheHornyDrunkenSlutSheReallyIs() {
            ...
            if (this.player.cockThatFits(this.urtaCapacity()) >= 0) {
                var y = this.player.cockThatFits(this.urtaCapacity()) + 1;
                ...
                if (this.player.cumQ() < 250)
                    this.outputText("you've spent your load");
                else if (this.player.cumQ() < 1000)
                    this.outputText("filled her utterly");
                else
                    this.outputText("streams of cum leak out of her ass, pooling at your [feet]");
        ...
        urtaDiscussessKatherine() {
            this.clearOutput();
            var affection = this.flags[kFLAGS_1.kFLAGS.KATHERINE_URTA_AFFECTION];
        ...
        urtaKathSexDont() {
            ...
            this.flags[kFLAGS_1.kFLAGS.KATHERINE_URTA_DATE] = Katherine_1.Katherine.KDATE_LITTLE;
        ...
        urtaKathSexWhenever() {
            ...
            this.flags[kFLAGS_1.kFLAGS.KATHERINE_URTA_DATE] = Katherine_1.Katherine.KDATE_WHENEVER;
            this.doNext(this.urtaDialogueMenu);
        }
        urtaKathSexEncourage() {
            ...
            this.flags[kFLAGS_1.kFLAGS.KATHERINE_URTA_DATE] = Katherine_1.Katherine.KDATE_LOTS;
            this.doNext(this.urtaDialogueMenu);
        }
        ...
        giveTheFoxSomeEggs() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0)
                this.outputText("as much fun as it might be, ");
            ...
            if (this.player.isTaur())
                this.outputText("positioning your centaur, ");
            else if (this.player.isDrider())
                this.outputText("drider body over the bulk of her back, ");
            this.outputText("and release your ovipositor from its usual hiding slit, already dripping with ");
            if (this.player.findPerk(PerkLib_1.PerkLib.SpiderOvipositor) >= 0)
                this.outputText("green slime");
            else
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.BeeOvipositor) >= 0)
                this.outputText("honey");
            else
                this.outputText("spider-goo");
            ...
            var wetness = 0;
            if (this.player.hasVagina())
                wetness += this.player.wetness() * 100;
            if (this.player.hasCock())
                wetness += this.player.cumQ();
            if (wetness < 300)
                this.outputText("splattering");
            else if (wetness < 500)
                this.outputText("matting");
            else if (wetness < 1000)
                this.outputText("soaking");
            else
                this.outputText("flooding");
            this.outputText(" the fox with your gushing ");
            if (this.player.gender == 1)
                this.outputText("cum");
            else if (this.player.gender == 2)
                this.outputText("femcum");
            else
                this.outputText("mixed sexual fluids");
            this.outputText(".");
            ...
            if (this.player.gender > 0)
                this.outputText(" just as her back is from your own release");
            this.outputText(".");
            //[Egg Level 1:
            if (this.player.eggs() < 20)
                this.outputText("  Urta's stomach starts to swell as your clutch of eggs fills her once-empty womb, stretching into a noticeable bulge, though not one that she couldn't hide if she wanted.");
            //[Egg Level 2:
            else if (this.player.eggs() < 40)
                this.outputText("  As the eggs keep on coming, Urta's womb swells and bulges, crammed full of goo and eggs, growing larger and larger until Urta could easily pass for an expectant mother, ready to give birth any day now.");
            //[Egg Level 3:
            else
                this.outputText("  You stuff Urta with eggs until you're wondering how many either of you can hold. Her belly just keeps getting rounder and rounder even as your eggs keep coming; soon, not only does she look like a woman pregnant with multiples, her skin is visibly stretched over the eggs, giving it a distinctively lumpy look rather than the round, smooth bulge she might have if your load was smaller.");
            ...
            if (this.player.cor < 50) {
                ...
                if (this.player.fertilizedEggs() == 0)
                    this.outputText("even if your eggs weren't fertile, ");
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_EGGS] = this.player.eggs();
            this.flags[kFLAGS_1.kFLAGS.URTA_FERTILE_EGGS] = this.player.fertilizedEggs();
            this.flags[kFLAGS_1.kFLAGS.URTA_TIMES_EGG_PREGGED]++;
            if (this.player.findPerk(PerkLib_1.PerkLib.BeeOvipositor) >= 0)
                this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_BEE_EGGS, 72);
            else
                this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_DRIDER_EGGS, 72);
            this.flags[kFLAGS_1.kFLAGS.URTA_FLATBELLY_NOTICE] = 0;
            //First time, tag for triggering freakout!
            if (this.flags[kFLAGS_1.kFLAGS.URTA_EGG_FORCE_EVENT] == 0)
                this.flags[kFLAGS_1.kFLAGS.URTA_EGG_FORCE_EVENT] = 48;
        ...
        urtaChewsOutPC(newScreen = true) {
            ...
            if (this.player.cor > 50)
                this.outputText(", especially given this may be the closest she'll ever get to experiencing pregnancy");
            this.outputText("?");
            ...
            //[Unfertilised Eggs:
            if (this.flags[kFLAGS_1.kFLAGS.URTA_FERTILE_EGGS] == 0) {
            ...
            //[Giant Bee:
            else if (this.player.findPerk(PerkLib_1.PerkLib.BeeOvipositor) >= 0)
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.SpiderOvipositor) >= 0)
                this.outputText("spider");
            else
                this.outputText("little bee");
            this.outputText("...</i>\"\n");
            //(Technically finished, now, but waiting Fen's okay before adding repeatable version)
            this.flags[kFLAGS_1.kFLAGS.URTA_EGG_FORCE_EVENT] = -1;
            if (newScreen)
                this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        repeatUrtaEgging() {
            ...
            if (!this.urtaLove())
                this.outputText("blatantly hanging out of her stockings and drooling pre-cum everywhere");
            else
                this.outputText("vulgarly bulging her dress and rendering it sopping wet from her arousal");
        ...
        condomlessUrtaInHouseSmex() {
            ...
            if (this.player.hasVagina())
                this.addButton(1, "Fill Me Up", this.fillMeUpPleaseUrta);
        ...
        pegUrtasAssMessy() {
            ...
            if (this.urtaDrunk())
                this.outputText("giggles drunkenly, \"<i>You're sho dirty!</i>\" while spreading those fishnet-clad legs further.");
            else if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] < 11)
                this.outputText("softly begs, \"<i>Be gentle, please,</i>\" while spreading those fishnet-clad legs a little further apart.");
            else
                this.outputText("eagerly coos, \"<i>Feeling a little dirty, eh, lover?  Go on baby, you can fuck my ass anytime.</i>\"  She spreads her fishnet-clad legs so wide they almost form an unbroken, horizontal line from padded toe to padded toe, tying her soft, poofy tail around a leg to keep it out of the way.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] > 15)
                this.outputText("casually");
            else if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] > 11)
                this.outputText("confidently");
            else if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] > 4)
                this.outputText("a little nervously");
            else
                this.outputText("with a shaky hand");
            ...
            if (this.player.cockArea(x) > this.urtaCapacity())
                this.outputText("The aching pressure around your " + this.cockDescript(x) + " doubles, and you realize she simply can't take any more.  Her anus is stretched wide, dilated to the extreme to accommodate this much of you.  There's little to do but plow her with what you can until she's fountaining white.");
            else if (this.player.hasKnot(x))
                this.outputText("The pleasure seems to double when your knot butts up against her furry rump, but her asshole isn't ready for that just yet.  This bitch needs a little more loving before you knot her.");
            else {
            ...
            if (this.player.cockArea(x) > this.urtaCapacity())
                this.outputText("most of you ");
            else
                this.outputText("your entire length ");
            ...
            if (this.player.balls > 0)
                this.outputText(" while your [balls] slap against her fuzzy buttcheeks.");
            else
                this.outputText(" while you slap your groin against her fuzzy buttcheeks.");
            ...
            if (this.player.hasKnot(x) && this.player.cockArea(x) < this.urtaCapacity())
                this.outputText("  You barely notice when your knot pops through the ebony ring, locking you inside her.  All you know is that while your strokes have gotten shorter, the pleasure has gotten even greater.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] < 0)
                this.outputText("not-so-fertile ");
            ...
            if (this.player.hasKnot(x) && this.player.cockArea(x) < this.urtaCapacity())
                this.outputText(" with a lewd pop, freeing your knot");
            ...
            if (this.urtaDrunk())
                this.outputText(" and of course, alcohol");
            ...
            if (this.player.cumQ() < 250)
                this.outputText(", swallowing with a smile and a wink.");
            else {
                this.outputText(", but she's forced to close it when her cheeks are puffed beyond reason.");
                if (this.player.cumQ() > 750)
                    this.outputText("  You go on to wash her face with your own white sauce.");
                if (this.player.cumQ() >= 1200)
                    this.outputText("  Your orgasm goes on and on, coating just about everything that Urta came on with yet another layer.");
                if (this.player.cumQ() > 3000) {
                    this.outputText("  She gasps in surprise when you flood the ");
                    if (this.player.cumQ() > 10000)
                        this.outputText("first few feet of the ");
            ...
            if (this.urtaLove())
                this.outputText("and nuzzles against your cheek, just holding you for a few moments, lover to lover.");
            else
                this.outputText("and sheepishly pulls back.");
            ...
            if (this.player.cor < 50)
                this.outputText("blushing");
            else
                this.outputText("smiling devilishly");
            this.outputText(".");
        ...
        UrtaGetsPeggedCleanUp() {
            this.clearOutput();
            if (this.player.cor >= 50)
                this.outputText("You start to duck out, but the disapproving glare the fox gives you makes it clear that you won't be getting any more messy fun unless you stick around to clean it up this time.  Damnit.  ");
        ...
        fillMeUpPleaseUrta() {
            ...
            if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                this.outputText("prodigious ");
            ...
            if (this.player.wetness() > 3)
                this.outputText("  You're so utterly soaked thanks to this place that a steady stream of vaginal lubricant drizzles over the meaty tool below.");
            if (this.player.hasCock())
                this.outputText("  Hard and erect, [eachCock] stands tall and proud, but ignored.  You have other plans.");
            ...
            if (this.player.wetness() > 3)
                this.outputText(", though it's a drop in the bucket next to your copious moisture.  Hell, even now, rivers of your girl-goo are sliding down that spasming length, wreathing it in lady-spunk");
            else
                this.outputText(", deliciously staining your slit");
            this.outputText(".");
            //{Virgin PCs}
            if (this.player.vaginas[0].virgin) {
                ...
                if (this.player.hasCock())
                    this.outputText("  Drool begins to leak from [eachCock], slicking the underside with pre-cum as the pleasure affects your maleness.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0)
                this.outputText("  An exhibitionist thrill runs through you at that, making you even wetter.");
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cockTotal() > 1)
                    this.outputText(", followed in short order by the untouched portion of your " + this.multiCockDescriptLight());
                ...
                if (this.player.cumQ() > 400) {
                    ...
                    if (this.player.cumQ() > 1000) {
                        if (this.player.cumQ() < 2000)
                            this.outputText(" and her bed");
                        else
                            this.outputText(", her bed, and damn near everything else");
                    }
            ...
            if (this.player.thickness < 50 && (this.player.pregnancyIncubation == 0 || this.player.pregnancyIncubation > 200))
                this.outputText(" but the outline on your abdomen as well");
            else
                this.outputText(" but your [vagina] as well");
            ...
            if (this.player.biggestTitSize() >= 4)
                this.outputText(" and your [chest] rest heavily upon your cum-stuffed form");
            this.outputText(".");
            if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150)
                this.outputText("  You may have been pregnant before, but you're beyond pregnant now... with cum AND child.");
            //{Goo:
            if (this.player.isGoo() && this.player.vaginalCapacity() > 9000)
                this.outputText("  Successive eruptions make you bigger, but your flexible cunt soon grows so bloated that the onrushing injections mostly squirt back out, painting Urta, the bed, and your [legs] white with cum.");
            else
                this.outputText("  Successive eruptions do little to bloat you further - your body is stretched to capacity, so the onrushing injections only squirt back out through your entrance, painting Urta, the bed, and your [legs] white with cum.");
            ...
            if (this.player.cor < 33)
                ...
                this.outputText("grinning");
            else
                this.outputText("openly leering");
            this.outputText(".");
            ...
            this.player.slimeFeed();
            if (this.flags[kFLAGS_1.kFLAGS.URTA_FERTILE] == 1)
                this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_URTA, PregnancyStore_1.PregnancyStore.INCUBATION_URTA, 25);
            this.player.orgasm();
            this.dynStats("lib", .2, "sen", -3);
        }
        cleanUpAfterUrtaCreamInjectsYou() {
            this.clearOutput();
            if (this.player.cor >= 50)
                this.outputText("You start to duck out, but the disapproving glare the fox gives you makes it clear that you won't be getting any more messy fun unless you stick around to clean it up this time.  Damnit.  ");
        ...
        lippleBondUrtaScylla() {
            ...
            //[if (cocks > 1)
            if (this.player.cockTotal() > 1)
                this.outputText("  Without much warning, you suddenly feel Urta's hand move away from your own palm, the sensation of your [cock smallest] being wrapped by her fingers also assaulting you as she squeezes and tugs at your second cock affectionately.");
            //[if (cocks > 2)
            if (this.player.cockTotal() > 2)
                this.outputText("  The barrage of sensations is intensified when Scylla also gets a bit greedy, grabbing another tool and starting to jerk it off as well.");
            ...
            if (this.player.cockTotal() > 1)
                this.outputText(" or more delicately and less hungrily with a feminine hand");
            this.outputText(".");
            ...
            if (this.player.sens < 29)
                this.outputText("  You can only tell so from her expression and from Scylla moaning and gasping sharply, but it appears Urta's cock is really just about ready to shoot off cum.");
            //if (sensitivity > 29)
            else
                this.outputText("  Scylla's titflesh slightly shifts from what is apparently the expansion of Urta's cock flare and the twitching of her massive shaft.  You're sensitive enough to notice.");
            //[if (sensitivity > 44)
            if (this.player.sens >= 44)
                this.outputText("  In fact, you can clearly feel the pressure inside Scylla's chest increasing as Urta's huge cock expands and twitches inside her next to your own, each such twitch sending a shiver of pleasure through both you and the nun.");
            ...
            if (this.player.cockTotal() > 1)
                this.outputText("as well as the hands of both of them working your cocks ");
            ...
            if (this.player.hasKnot(this.player.biggestCockIndex()))
                this.outputText("  You're not making the problem any easier, in fact, your knot is halfway stuck inside her breast, surged and filled to full size right after your orgasm.");
            ...
            if (this.player.hasKnot(this.player.biggestCockIndex()))
                this.outputText(", your knot sufficiently deflated now");
        ...
        nagaOnUrtaMess() {
            ...
            //[if (cocks = 0)
            if (this.player.cockTotal() == 0)
                this.outputText("  Urta runs her fingers over and gently pushes into your now revealed female slit. \"<i>My lover's sweet, sweet pussy. The best in the whole world.</i>\"");
            //if (cocks = 1)
            else if (this.player.cockTotal() == 1)
                this.outputText("  \"<i>And here is my favorite cock in the whole world... Probably including mine,</i>\" she giggles and winks at you.");
            //if (cocks = 2)
            else if (this.player.cockTotal() == 2)
                this.outputText("  \"<i>Two delicious cocks, rather than just one...  You're trying to tell me you're the man here, aren't you, lover?</i>\" she giggles and winks at you.");
            else if (this.player.cockTotal() == 3)
                this.outputText("  \"<i>You want to have a spare one just in case or something?</i>\" she giggles and winks at you.");
            //[if (cocks >= 4)]
            else
                this.outputText("  \"<i>Interesting.  It looks like a bouquet.  A beautiful bouquet of cocks just for me,</i>\" she giggles and winks at you.");
            ...
            if (this.player.hasVagina()) {
                ...
                if (this.player.wetness() >= 4)
                    this.outputText("  After a few convulsions, your femcum starts to shoot out of your pussy quite violently, adding to the mess your lover is making.");
            }
            //if (cocks > 0)
            if (this.player.cockTotal() > 0) {
                ...
                if (this.player.cumQ() >= 1000 && this.player.cumQ() < 2500)
                    this.outputText("  Her eagerness does end up giving her a swollen tummy, but she's loving and hungry for you until the end, swallowing as much as she can, as quickly as she can.");
                //(if [cumExtreme = True]
                else if (this.player.cumQ() >= 2500)
                    this.outputText("  Of course, your excessive load proves too much for the poor vixen to handle, and soon she is not only inflated, but painted in your cum as well, the mess the two of you are making definitely nothing to be scoffed at.");
            }
        ...
        lickOutUrtaAtHome() {
            ...
            if (this.urtaDrunk())
                this.outputText("slurs, \"<i>You want to whaaat?");
            else
                this.outputText("asks, \"<i>You want to do what?!");
            ...
            if (this.player.cockArea(x) >= this.urtaCapacity() / 2)
                this.outputText("It fits you like a lubricated, stretchy little glove, ensuring every movement will caress her folds.");
            else
                this.outputText("It's nice and roomy, allowing you full control over how you want to press on her inner folds.");
            ...
            if (this.player.cockArea(x) >= 200)
                this.outputText("   Stretching ludicrously, her cunt dilates with surprising ease.  The elastic lips of her pussy cling oh-so-tightly to your girth as they're spread beyond reason.  Her hips even spread with only a modest bit of pressure and resistance as her passage is distorted, the shape of your " + this.cockDescript(x) + " visible through her stretched belly as it pushes towards her tits.  You can even make out some of the larger veins.");
            ...
            if (this.player.cor < 66)
                this.outputText("You're wonderful");
            else
                this.outputText("You're the most amazing fuck");
            this.outputText("</i>\"");
            ...
            if (this.player.cumQ() >= 500)
                this.outputText("  Spermy juices run out of her pussy in alabaster streams thick enough to obscure the black-lips they're travelling over.");
            if (this.player.cumQ() >= 1500)
                this.outputText("  The fox gives a surprised grin when her belly rounds slightly, though she seems concerned at how it makes her cum-filled prize wobble.");
            if (this.player.cumQ() >= 3000)
                this.outputText("  Your virile pecker just won't stop, and by the time you finish ejaculating, Urta is pregnant with sperm, her belly round with its belly-button protruding.");
            ...
            if (this.player.hasKnot(x))
                this.outputText("knotted");
            else
                this.outputText("resting");
            ...
            if (this.player.hasKnot(x))
                this.outputText(" in an attempt to withdraw.  Her entrance dilates slowly as your full, dog-like knot is pressed against her from inside, the pulsating, reddish flesh glistening with the mixed sexual lubricants.  You tug and tug, rocking your [hips] slowly to loosen her up, and eventually, you manage to pop out, drawing a moan of mixed anguish and pleasure from Urta's maw.");
            else
                this.outputText(" and withdraw.");
            if (this.player.cumQ() >= 1500)
                this.outputText("   Cum runs out of her packed womb in a wave, spreading all over the sheets down to her knees.  She shakes slightly as the cum runs out of her, rubbing her full middle protectively.");
            else
                this.outputText("  Cum drools out of her still-gaping slit in steady trickles, puddling on the sheets below.  She groans happily.  Clearly the fox is proud to have such a productive lover.");
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] += 12;
            ...
            if (this.player.lib > 50)
                this.dynStats("lib", -1);
            if (this.player.lib > 90)
                this.dynStats("lib", -1);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        slurpFawkesCocksForFunAndInflation() {
            this.clearOutput();
            ...
            if (this.player.pregnancyIncubation < 100 && this.player.pregnancyIncubation > 0)
                this.outputText(" than it already was");
        ...
        urtaAndRaphaelSurprise() {
            ...
            if (this.player.hasCock())
                this.outputText(" and [eachCock] experience a twinge of excitement");
        ...
        raphaelAndUrtaPartTwo() {
            ...
            if (this.player.tallness >= 60)
                this.outputText(", grinding through your [butt]'s ass-cleavage without an ounce of hesitation");
            this.outputText(".");
            ...
            if (this.player.tailType > appearanceDefs_1.TAIL_TYPE_NONE)
                this.outputText("lift your tails and ");
            ...
            if (this.player.analCapacity() < 30)
                this.outputText(", slowly stretching your tight sphincter with constant pressure.  You're not really loose enough back there for this to be entirely comfortable, but the incredible fullness her length provides has a way of muting the pain of stretching.");
            else if (this.player.analCapacity() < 60)
                this.outputText(", slowly sliding into your sphincter.  You groan into your other lover's mouth as your anus is claimed by the thick horse-pole, and you do your best to relax around the butthole-stretching shaft.");
            else
                this.outputText(", easily slipping inside your well-practiced anus.  You groan into your other lover's mouth as the thick cock claims your ready asshole, and you're glad your butthole was so well prepared to handle having a hot meat pole injected into it.");
            this.player.buttChange(60, true, true, false);
            ...
            this.player.orgasm();
            this.dynStats("sen", -3);
            this.flags[kFLAGS_1.kFLAGS.URTA_X_RAPHAEL_HAPPENED]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        urtaGooTesticleVoreRuinedOrgasms() {
            this.clearOutput();
            ...
            if (!this.silly())
                this.outputText("a steel rod");
            else
                this.outputText("Marethian algebra");
            this.outputText(".");
        ...
        urtasRuinedOrgasmsFromGooPartII() {
            this.clearOutput();
            ...
            var edrynAvailable = !kGAMECLASS_1.kGAMECLASS.telAdre.edryn.pregnancy.isPregnant;
            if (edrynAvailable)
                this.outputText("set of hoofsteps");
            else
                this.outputText("pair of footsteps");
            ...
            if (edrynAvailable)
                this.outputText("recognize as Edryn's");
            else {
                if (this.flags[kFLAGS_1.kFLAGS.MET_OLIVIA] == 0)
                    this.outputText("recognize as Olivia's");
                else
                    this.outputText("don't recognize");
            }
            ...
            if (edrynAvailable)
                ...
                this.outputText("Olivia");
            this.outputText(", I'm going to need your help with this particular problem.</i>\"");
            this.outputText("\n\nThere's a moment of silence, and then, \"<i>");
            if (edrynAvailable)
                this.outputText("All right, but I'm still charging you for this one");
            else
                this.outputText("Uhm, yes Captain, whatever you need");
            ...
            if (edrynAvailable)
                this.outputText("Edryn moan in pleasure");
            else
                this.outputText("Olivia shout with surprise");
            ...
            if (edrynAvailable)
                this.outputText("All you need to do is push, right?");
            else
                this.outputText("Let's just sit you back, and then all you need to do is push.");
            this.outputText("</i>\"  Your new host grunts in discomfort");
            if (edrynAvailable)
                this.outputText(", but obliges, sitting back on something, perhaps a bed.  You feel yourself sloshing around oddly as she lies on her back");
            ...
            if (edrynAvailable)
                this.outputText("Edryn clutching Urta's hand");
            else
                this.outputText("Olivia lying back on the bed, clutching Urta's hand");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MET_OLIVIA] == 0 && !edrynAvailable) {
                ...
                this.flags[kFLAGS_1.kFLAGS.MET_OLIVIA]++;
            }
            //(Goo skin not white?)
            ...
            if (edrynAvailable)
                ...
                this.outputText("a newly dressed Olivia");
        ...
        urtaPetPlayDeletedForeverBecauseThirdProovedMeWrongAboutDice() {
            this.clearOutput();
            //First Time
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PETPLAY_DONE] > 0) {
                this.wearZeCollar();
                return;
            }
        ...
        ignoreUrtasCollar() {
            this.flags[kFLAGS_1.kFLAGS.URTA_PETPLAY_DONE] = -1;
            this.clearOutput();
            if (this.urtaLove())
                this.urtaHomeLuvLuvinsMenu();
            else
                this.goBackToUrtasForLuvinzII();
        }
        wearZeCollar() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_PETPLAY_DONE] == 0) {
                ...
                if (this.player.hasCock())
                    this.outputText("harder");
                if (this.player.gender == 3)
                    this.outputText(" and ");
                if (this.player.hasVagina())
                    this.outputText("wetter");
            ...
            //Second Time
            else if (this.flags[kFLAGS_1.kFLAGS.URTA_PETPLAY_DONE] == 1) {
            ...
            if (this.player.tailType == appearanceDefs_1.TAIL_TYPE_NONE) {
                ...
                if (this.player.tailType == appearanceDefs_1.TAIL_TYPE_NONE && this.player.ass.analWetness > 0)
                    this.outputText("  Despite your embarrassment, or perhaps because of it, you find your asshole getting wet with desire, practically salivating in anticipation of that thick plug.");
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_PETPLAY_DONE]++;
        ...
        doggyStyle() {
            ...
            if (this.player.hasCock())
                this.outputText("Her thumb rubs against the sensitive underside of your cock");
            else
                this.outputText("One finger slips into you, all the way down to the knuckle, and swivels around to caress your g-spot with expert accuracy");
            ...
            if (this.player.hasCock())
                this.outputText("[cock biggest] does the same");
            else
                this.outputText("[vagina] grows slicker");
            ...
            if (this.player.hasCock())
                this.outputText("She wraps her fingers around your shaft, slowly pumping up and down, taking a moment to tease your [cockHead biggest] every few strokes.");
            else
                this.outputText("She buries two fingers deep inside your cunt, followed by a third, each one twisting around to rub at your g-spot softly.");
            ...
            if (this.player.hasCock())
                this.outputText("jerks you off");
            else
                this.outputText("rubs you from the inside out");
            ...
            if (this.player.hasCock())
                this.outputText("pre-cum dribbles from your dick like a leaky faucet");
            else
                this.outputText("your folds grow even more damp, constantly drizzling fluids that run down your ass crack, pooling on the floor like a lewd lake");
            if (this.player.hasCock())
                this.outputText(", and to top it all off, you find your [leg] inexplicably kicking in mid-air");
            this.outputText(".");
            ...
            if (this.player.tailType == appearanceDefs_1.TAIL_TYPE_NONE)
                this.outputText(", while she grasps the plug in your ass firmly and pulls. It comes out easily with a wet <b>pop</b>, making your ass feel suddenly empty.  You guess it won't be empty for long, however");
            ...
            if (this.player.biggestTitSize() <= 5)
                this.outputText("resting on your folded arms");
            else
                this.outputText("resting on your enormous boobs");
            ...
            if (this.player.balls > 0)
                ...
                this.outputText("painfully erect member");
            else
                this.outputText("slit");
            ...
            if (this.player.hasCock())
                this.outputText("[cock] slaps against your belly roughly with every passing second, smearing thick globules of precum which drip down your belly, tickling your flesh like little balls of distilled pleasure");
            if (this.player.gender == 0)
                this.outputText(", while your");
            if (this.player.hasVagina())
                this.outputText(" unused pussy aches to be filled or touched, its lips puffy and red, sensitive to every hard slap of your foxy lover's balls");
            this.outputText(".");
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cumQ() >= 500)
                    this.outputText("  It continues to jerk on its own, unloading its massive load until you're laying in a puddle of your own semen.");
                if (this.player.hasVagina())
                    this.outputText("  It then travels along to your ");
            }
            if (this.player.hasVagina())
                this.outputText("[vagina], which, despite being devoid of cock, clamps down anyway, gushing with femcum, drenching your Owner's balls and legs in sticky, clear fluids.");
            ...
            this.player.orgasm();
            this.dynStats("sen", 2);
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] += 4;
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] += 2;
            this.menu();
            this.addButton(0, "Next", this.partTwoOfDoggieStyle);
        }
        partTwoOfDoggieStyle() {
            this.clearOutput();
        ...
        getAPetReward() {
            ...
            if (this.silly())
                this.outputText("  In her other hand is what looks to be a jar of peanut butter.  What use could that have?");
            ...
            if (this.silly())
                this.outputText(", though you wonder if perhaps that's what the peanut butter is for");
            ...
            if (this.player.biggestTitSize() < 1)
                this.outputText("onto your chest");
            else
                this.outputText("between your breasts");
            this.outputText(".  She takes a moment to encircle one of your nipples, which stiffens to attention along with ");
            if (this.player.totalNipples() == 2)
                this.outputText("its twin");
            else
                this.outputText("the others");
            ...
            if (this.player.hasCock())
                this.outputText("rapidly hardening shaft.");
            else
                this.outputText("moistening slit.");
            this.outputText("\n\nUrta keeps this up for a minute, lovingly stroking your ");
            if (this.player.hasCock())
                this.outputText("dick");
            else if (this.player.hasVagina())
                this.outputText("cunt lips");
            ...
            //silly:
            if (this.silly())
                this.outputText(", while she opens the jar of peanut butter and smears a dollop across the flat head.  Is... is that supposed to be enticement?  She really is treating you like a real dog");
            ...
            if (this.silly())
                this.outputText(", licking all of the peanut butter off the tip");
            ...
            if (this.silly())
                this.outputText("  Your owner uses her fingers to smear another large dollop of peanut butter along her own shaft, giving you an almost sadistic smirk.");
            ...
            if (this.silly())
                this.outputText(", the peanut butter now long forgotten");
            this.outputText(", stretching your jaw wide.  ");
            if (this.player.hasCock())
                this.outputText("Your own cock remains almost painfully rock hard, bobbing awkwardly beneath you, dripping precum onto the floor and bowl.");
            if (this.player.hasVagina()) {
                if (this.player.gender == 3)
                    this.outputText("  Not to mention");
                else if (this.player.hasVagina())
                    this.outputText("  Meanwhile");
            ...
            if (this.player.tongueType == appearanceDefs_1.TONUGE_SNAKE)
                this.outputText("serpentine ");
            else if (this.player.tongueType == appearanceDefs_1.TONUGE_DEMONIC)
                this.outputText("demonic ");
            else if (this.player.tongueType == appearanceDefs_1.TONUGE_DRACONIC)
                this.outputText("draconic ");
            ...
            if (this.player.hasCock())
                this.outputText("jerking off your cock between two toes");
            else
                this.outputText("rubbing your little love button like mad with one soft toe");
            ...
            if (this.player.hasCock())
                this.outputText("The cock between your legs, meanwhile, stiffens, briefly becoming harder than you've ever felt before, before blasting the floor with jet after jet of silky white cum.");
            else
                this.outputText("Meanwhile, your vagina clamps on nothing, achingly, painfully empty.  Juices spray out onto Urta's foot and down your thighs, soaking the floor beneath you in yet more slippery femcum.");
        ...
        urtaTakesPCOnWalkies() {
            ...
            if (this.player.hasCock())
                this.outputText("[eachCock] grows hard beneath you");
            if (this.player.gender == 3)
                this.outputText(" and ");
            if (this.player.hasVagina())
                this.outputText("your [vagina] moistens, ready to be on display");
            this.outputText(".");
            ...
            if (this.player.biggestTitSize() >= 5)
                this.outputText("the breasts hanging from your chest and ");
            this.outputText("your openly displayed rear end.  ");
            if (this.player.hasCock())
                this.outputText("Pre-cum drizzles from the end of your painfully erect cock");
            else
                this.outputText("Sweet juices flow from your cunt, drizzling down onto the ground");
            ...
            this.dynStats("lus", 15);
            this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] = 0;
            this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] += 5;
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0) {
