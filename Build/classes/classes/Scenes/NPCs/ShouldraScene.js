define(["require", "exports", "./NPCAwareContent", "../../CoC", "../../GlobalFlags/kFLAGS", "../../StatusAffects", "../../../../includes/appearanceDefs", "./Shouldra", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, CoC_1, kFLAGS_1, StatusAffects_1, appearanceDefs_1, Shouldra_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ShouldraScene extends NPCAwareContent_1.NPCAwareContent {
        ...
        timeChange() {
            var needNext = false;
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_MAGIC_COOLDOWN] >= 1)
                this.flags[kFLAGS_1.kFLAGS.SHOULDRA_MAGIC_COOLDOWN]--;
            if (this.shouldraFollower.followerShouldra()) {
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1 && this.player.hasCock() && ShouldraScene.rand(10) == 0) {
                    if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUDRAMA] == 1) {
                        this.shouldraFollower.exgartumonAndShouldraFightPartII();
                        needNext = true;
                    }
                    else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUDRAMA] == 2) {
                        this.shouldraFollower.exgartumonAndShouldraFightPartIII();
                        needNext = true;
                    }
                }
                this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER]--;
                if (this.shouldraFollower.shouldersWarnings())
                    needNext = true;
                if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] == 0 || (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] < 0 && this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] % 16 == 0)) {
                    this.shouldraFollower.shouldraWakesUpOrPokesPCsForShitsAndGigglesIdunnoHowLongCanIMakeThisFunctionNameQuestionMark();
                    needNext = true;
                }
                if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_COUNTDOWN] > 0 && this.getGame().model.time.hours == 3)
                    this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_COUNTDOWN]--;
            }
            return needNext;
        }
        timeChangeLarge() {
            if (this.shouldraFollower.followerShouldra() && this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_COUNTDOWN] == 0 && this.getGame().model.time.hours == 3) {
                this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_COUNTDOWN] = -1;
                this.shouldraFollower.shouldraDream1();
                return true;
            }
            //Ghostgirl recruitment priority
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_FOLLOWER_STATE] == .5 && this.model.time.hours == 6) {
                this.getGame().shouldraFollower.morningShouldraAlert();
                return true;
            }
            //Ghostgirl pissed off dreams
            if (this.shouldraFollower.followerShouldra() && this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] <= -236 && this.model.time.hours == 3 && this.player.gender > 0) {
                this.getGame().shouldraFollower.nightTimeShouldraRapesThePC();
                return true;
            }
            //Ghostgirl madness
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00365] > 0) {
                if (this.player.cockTotal() > 1 || this.player.faceType != appearanceDefs_1.FACE_HUMAN || this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_HUMAN || this.player.tailType > appearanceDefs_1.TAIL_TYPE_NONE || this.player.horns > 0 || this.player.cor > 15 || this.player.longestCockLength() > 10 || this.player.tallness < 65 || this.player.tallness > 78 || this.player.hasVagina())
                    this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00365] = 0;
                else {
                    this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00365]--;
                    if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00365] == 0) {
        ...
        shouldraGreeting() {
            ...
            if (this.silly() && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00366] == 0) {
                //NO MUTANTS ALLOWED
                if (this.player.cockTotal() > 1 || this.player.faceType != appearanceDefs_1.FACE_HUMAN || this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_HUMAN || this.player.tailType > appearanceDefs_1.TAIL_TYPE_NONE || this.player.horns > 0 || this.player.cor > 15 || this.player.longestCockLength() > 10 || this.player.tallness < 65 || this.player.tallness > 78 || this.player.hasVagina()) { }
                else {
            ...
            //First 3 encounters
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_MET_SHOULDRA] < 3) {
                ...
                //([if first time] 
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_MET_SHOULDRA] == 0)
                    this.outputText("\"<i>You're the asshole that took my racks, aren't you?  I was hoard-...er, I was keeping an eye on those!</i>\" she accuses, eyes narrowing angrily.  ", false);
                ...
                //fight
                this.startCombat(new Shouldra_1.Shouldra());
            }
            //(after three encounters with her)
            else {
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_BEATEN_SHOULDRA] >= 3 && this.flags[kFLAGS_1.kFLAGS.TIMES_MET_SHOULDRA] % 10 == 0) {
                    kGAMECLASS_1.kGAMECLASS.shouldraFollower.initialShouldersRecruitment();
                    this.flags[kFLAGS_1.kFLAGS.TIMES_MET_SHOULDRA]++;
                    return;
                }
                ...
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_BEATEN_SHOULDRA] >= 3) {
                    ...
                    //([if first time] 
                    if (this.flags[kFLAGS_1.kFLAGS.TIMES_BEATEN_SHOULDRA] == 3)
                        this.outputText("You can't say you saw that coming.  It seems she has offered to forego the fight in lieu of sexings.  ", false);
        ...
        defeatDannyPhantom() {
            ...
            if (this.monster.HP < 1) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_POSSESSED_BY_SHOULDRA] >= 1)
            ...
            //(defeat by lust)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_POSSESSED_BY_SHOULDRA] < 1)
                    ...
                    this.outputText("Of course, the motion has no effect on her libido, due to her ghostly state.", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_BEATEN_SHOULDRA]++;
        }
        //(deny entry)
        noSlimingSlimer() {
            this.spriteSelect(67);
            ...
            //([if first time] 
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_POSSESSED_BY_SHOULDRA] == 0)
                this.outputText("not feeling up to heed the strange girl's whims.", false);
            else
                this.outputText("mystified at the thought of letting a ghost possess your body.", false);
        ...
        littlePigLittlePigLetMeIn() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_POSSESSED_BY_SHOULDRA] == 0)
                this.outputText("you can afford being a little adventurous with the obviously desperate girl", false);
            else
                this.outputText("having a spiritual tag-along might be a bit of fun", false);
            ...
            if (this.player.tallness < 84)
                this.outputText(" into your arms for a tight hug", false);
            else
                this.outputText(" up into your arms for a tight hug", false);
            ...
            //([if first time] 
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_POSSESSED_BY_SHOULDRA] == 0)
                this.outputText("Wait... WHAT!?  Did you just let some sort of... g-... g-... g-... G-... G-... GHOOOOOST possess you?", false);
            ...
            //CHOICES HURRAH
            var lake = undefined;
            if (this.player.gender > 0 && ((this.player.findStatusAffect(StatusAffects_1.StatusAffects.BoatDiscovery) >= 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00230] > 0) || this.flags[kFLAGS_1.kFLAGS.TIMES_MET_OOZE] > 0)) {
            ...
            if (this.player.gender == 0)
                gender = this.genderlessGhostBuster;
            else if (this.player.gender == 1)
                gender = this.penisLossThatIsntALoss;
            else if (this.player.gender == 2)
                gender = this.ghostGinaWinSexings;
            else if (this.player.gender == 3)
                gender = this.hermaphroditeGhostsCumEctoplasm;
            this.flags[kFLAGS_1.kFLAGS.TIMES_POSSESSED_BY_SHOULDRA]++;
        ...
        nowOnVickiLake() {
            ...
            var shark = undefined;
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BoatDiscovery) >= 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00230] > 0)
                shark = this.sharkbustersVictory;
            var ooze = undefined;
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_MET_OOZE] > 0)
                ooze = this.ghostGooGurlzDuckfaces;
        ...
        sharkbustersVictory() {
            ...
            if (this.player.biggestTitSize() >= 1)
                this.outputText(", " + this.allBreastsDescript() + " squishing and squashing against her own barely-clad bosom", false);
            ...
            if (this.player.hasCock() && this.player.hasVagina()) {
                ...
                this.doNext(this.sharkyEctoginas);
            else if (this.player.hasCock())
                this.doNext(this.ghostIzmaPenis);
        }
        ...
        sharkyEctoginas() {
            ...
            //[if repeat]
            if (this.flags[kFLAGS_1.kFLAGS.TIMED_SHARKGINAS] > 0)
                this.outputText(" again...", false);
            this.outputText("</i>\" she pants, brow suddenly furrowed with worry.  ", false);
            if (this.flags[kFLAGS_1.kFLAGS.TIMED_SHARKGINAS] == 0)
                this.outputText("You begin to ask what she's talking about, but the words die in your mouth when", false);
            else
                this.outputText("You can only shake your head resignedly as", false);
            ...
            if (this.player.hasKeyItem("Deluxe Dildo") >= 0)
                this.outputText(" by the biggest object you've experienced since Tamani's deluxe dildo", false);
            ...
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.TIMED_SHARKGINAS]++;
            this.cleanupAfterCombat();
        }
        ...
        ghostIzmaPenis() {
            ...
            if (this.player.balls > 0)
                this.outputText(" and cradling your " + this.ballsDescriptLight() + " with almost reverent gentleness, running her coarse shark-skinned fingers across your sack as gently as she can manage", false);
            this.outputText(".\n\n", false);
            ...
            //[if first time]
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_SHARKPENISED] == 0)
                this.outputText("whose expression reveals she's as clueless as you are.", false);
            else
                this.outputText("who only smiles as she realizes her 'mistake' in her spellcasting once again.", false);
            this.outputText("  \"<i>That wasn't nearly what the spell should have been,</i>\" the girl muses, licking her lips ", false);
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_SHARKPENISED] == 0)
                this.outputText("absently as she contemplates what could have caused the lengthening of your loins", false);
            else
                this.outputText("in anticipation for the experience you both are about to undergo, yet again", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_SHARKPENISED] == 0)
                this.outputText("as she deduces the nature of the spell. \"<i>I think... oh my... my host's saliva may have expansive qualities on... sexual aspects of the body,</i>\" she explains. \"<i>So, if I were to do this...</i>\"", false);
            else
                this.outputText("\"<i>Would you look at that, my magic spittle still works! How about I just...</i>\"", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.balls > 0)
                this.outputText(" and softly churning sack", false);
            ...
            if (this.player.balls > 0)
                this.outputText("  Your enchanted testes give an audible groan as you reach climax.", false);
            else
                this.outputText("  You feel something stirring in your groin, and you squirm as the tingling intensifies.", false);
            ...
            this.outputText("With that settled, you and your temporary ghostly companion decide to part ways here. Pushing out of your stomach, the ghost girl flows out of you and reforms, giving you a quick hug and a reassurance of the good time she had. As she begins her trek back to the ruined city, she warns that if you expect her to follow along with your wishes, you'd best be ready to put up a fight.", false);
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.TIMES_SHARKPENISED]++;
            this.cleanupAfterCombat();
        }
        ...
        ghostGooGurlzDuckfaces() {
            ...
            //([if penis present] 
            if (this.player.hasCock() && !this.player.hasVagina())
                this.outputText(" presenting your " + this.multiCockDescriptLight() + " to the spectral slime.", false);
            else if (this.player.hasVagina())
                this.outputText(" slipping a hand down to your " + this.clitDescript() + " eagerly.", false);
            //[if herm] 
            else
                this.outputText(" both of your sexes throbbing in excitement.", false);
            ...
            if (this.player.gender == 3) {
                if (this.flags[kFLAGS_1.kFLAGS.SLIMEGINAED] > 0 && this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLIME_PENOR_TIMES] > 0)
                    this.slimeGhostGalForHerms(false);
                else if (ShouldraScene.rand(2) == 0)
                    this.slimeyPenorsAhoy();
                else
                    this.slimeGinaFlation();
            }
            else if (this.player.hasCock())
                this.slimeyPenorsAhoy();
            else
        ...
        slimeGinaFlation() {
            ...
            if (this.player.isNaga())
                this.outputText("your tail is thrust to one side to make way for the penetration", false);
            else if (this.player.isGoo())
                this.outputText("your gooey mass smooshes into the green slime, a near-mirror of jiggling substances", false);
            else
                this.outputText("your legs are forced to do the splits as you sink down", false);
            ...
            if (this.player.cor < 50)
                ...
                this.outputText("you feel the constant stimulation of your carnal canal weakening your resolve until you're almost encouraging her.", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.biggestTitSize() < 1)
                ...
                this.outputText("Your frame is jostled about as the slime under you shrinks, your goo-filled gut pushing your " + this.allBreastsDescript() + " up into your overburdened jaw.", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MeetWanderer) >= 0)
                ...
                this.outputText("a wheelbarrow!", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.isNaga())
                this.outputText("snake-like lower body", false);
            else if (this.player.isGoo())
                this.outputText("undulating, gooey mass", false);
            else if (this.player.tailType == appearanceDefs_1.TAIL_TYPE_NONE)
                this.outputText("arms and " + this.player.legs(), false);
            else
                this.outputText("arms, " + this.player.legs() + ", and tail", false);
            ...
            if (this.player.biggestTitSize() < 1)
                this.outputText("see your " + this.nippleDescript(0) + " wiggling sporadically.", false);
            else
                this.outputText("see your " + this.allBreastsDescript() + " trembling, " + this.nippleDescript(0) + " twitching eagerly.", false);
            ...
            if (this.getGame().inCombat) {
                this.flags[kFLAGS_1.kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.consumables.ECTOPLS.id;
                this.cleanupAfterCombat();
            }
            else {
                this.outputText("\n\n", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.SLIMEGINAED]++;
        }
        ...
        slimeyPenorsAhoy() {
            ...
            //([if boobs present] 
            if (this.player.biggestTitSize() < 1)
                this.outputText(" while squishing her small boobs into your own " + this.allBreastsDescript(), false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLIME_PENOR_TIMES] > 0)
                this.outputText("You can't shake the feeling that she's used this particular spell before. What an unoriginal ghost.  ", false);
            ...
            if (this.player.balls > 0)
                this.outputText("and teasing your quaking testes ", false);
            ...
            if (this.player.isNaga())
                this.outputText("slapping against your tail", false);
            else if (this.player.isGoo())
                this.outputText("smooshing against your goo", false);
            else
                this.outputText("swiftly bruising your thighs", false);
            ...
            if (this.player.balls > 0)
                this.outputText("  The near-vacant-minded girl rewards you with two slime-tentacles to fondle your scrotum.  You hiss in a sharp breath at the sudden stimulation, but swiftly come to welcome it.", false);
            ...
            if (this.player.balls > 0)
                this.outputText("the heat spreads to your testicles, promptly puffing them up with arcane virility", false);
            else
                this.outputText("you feel a discomfort beginning in your prostate, as if the organ is beginning to grow with arcane virility", false);
            ...
            if (this.player.balls > 0)
                this.outputText("Your " + this.player.legs() + " are forced apart by your burgeoning cum-sack", false);
            else
                this.outputText("You nearly go insane with the pressure upon your sex", false);
            ...
            if (this.player.balls > 0)
                this.outputText("balls to churn", false);
            else
                this.outputText("body to prepare itself for release", false);
            ...
            if (this.player.balls > 0)
                this.outputText("waddle over to where the mewling ghost girl is twitching on the ground; your now-shrinking testicles hindering your gait.", false);
            else
                this.outputText("limp over to where the mewling ghost girl is twitching on the ground; your now-shrinking prostate hinders your gait.", false);
            ...
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLIME_PENOR_TIMES]++;
            if (this.getGame().inCombat) {
                this.flags[kFLAGS_1.kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.consumables.ECTOPLS.id;
                this.cleanupAfterCombat();
            }
        ...
        genderlessGhostBuster() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0)
                this.outputText("You raise an eyebrow, genuinely curious as to how she'll figure out how to relieve her desire.  ", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0)
                this.outputText("Curious as to its contents, you glance inside—it's a chest of dildos, of every shape and size. Before you can ask why the hell a ghost would carry a CHEST of dildos, ", false);
            else
                this.outputText("You recall distinctly the contents of that chest, and are not surprised ", false);
            ...
            if (this.player.biggestTitSize() < 1)
                ...
                this.outputText("your " + this.allBreastsDescript() + " begin to bounce all around.", false);
            else
                this.outputText("your " + this.allBreastsDescript() + " swell slightly to make room for a sudden increase in milk production.", false);
            ...
            if (this.player.biggestTitSize() <= 8)
                ...
                this.outputText("the lactation continues, and the ghost girl moves back to the table and settles down a bit", false);
            ...
            if (this.player.biggestTitSize() < 1)
                this.outputText("your tits, along with the elongated nipples, receding back into a flat chest.", false);
            else if (this.player.biggestTitSize() <= 8)
                this.outputText("your boobflesh shrinking back down into its normal size, nipples included.", false);
            else
                this.outputText("the nipples shortening once again, and the lactation finally stabilizing.", false);
        ...
        penisLossThatIsntALoss() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PENIS_DEFEAT_TIMES] == 0)
                this.outputText("She abruptly gasps in excitement and begins moving your hands towards your groin, though you swiftly reclaim control. \"<i>You have a penis,</i>\" she telepathically pulses to you with an anxious and excited edge to her voice. \"<i>My hosts... they rarely... they...</i>\"", false);
            else
                this.outputText("She chuckles softly as she recalls the times you've shared, and she hungrily goes for your maleness once more, though you throw her off of it.", false);
            ...
            if (this.player.inte < 50)
                this.outputText("It's not very hard for her to break down your fortifications, and you soon feel yourself being pushed aside by her vast mental capacity.", false);
            else if (this.player.inte < 90 || this.player.cockThatFits(80) == -1)
                this.outputText("You begin to gain an edge, but the ghost girl is craftier than you expected. She begins to pulse mental intrusions at you, scrambling your thoughts just long enough for her to overtake you and push you to the side.  \"<i>You are one hundred years too early to challenge me,</i>\" she chides. \"<i>My intellect has long surpassed most any living creature on this plane.</i>\"", false);
            else {
                ...
                if (this.player.cockTotal() > 1) {
                    ...
                    if (this.player.cockTotal() == 2)
                        ...
                        this.outputText("the rest of " + this.multiCockDescriptLight(), false);
                    ...
                    if (this.player.cockTotal() == 2)
                        ...
                        this.outputText("two other shafts and pumps them vigorously.", false);
                }
                this.outputText("\n\n", false);
                ...
                if (this.player.balls > 0)
                    ...
                    this.outputText("near the base of your shaft", false);
                this.outputText(".  ", false);
                if (this.player.balls == 0)
                    this.outputText("The first effects of the spell make themselves known in a big way when an overladen cumsack forms and drops between your legs.  ", false);
                ...
                if (this.player.ballSize >= 9)
                    this.outputText("gargantuan");
                else
                    this.outputText("basketball");
            ...
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PENIS_DEFEAT_TIMES]++;
            if (this.getGame().inCombat) {
                this.flags[kFLAGS_1.kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.consumables.ECTOPLS.id;
                this.cleanupAfterCombat();
            }
        ...
        ghostBJFinisher(inside) {
            this.spriteSelect(67);
            var x = this.player.cockThatFits(80);
            ...
            if (inside)
                this.outputText("excitedly convulsing", false);
            else
                this.outputText("practically lust-paralyzed", false);
        ...
        dewormYourGhost() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_WORM_SCENE_COUNTER]++;
        }
        ...
        penisGartuanGhostSmexVictory() {
            ...
            if (this.player.hasVagina())
                this.outputText(" like this bitch here", false);
            this.outputText("?</i>\"\n\n", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUAN_SPIRIT_SEX_COUNT] > 0)
            ...
            if (this.silly())
                this.outputText("  In the middle of your ejaculatory adventure, a flap of wings alerts you to a presence above. Although unable to move your head in your current situation, you're made very well-aware of the nature of the intruder when a bird-like voice shrieks, \"<i>SLUUUUUUUUUUUUT,</i>\" at the top of her lungs. With a final caw, she flies away without a trace.", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUAN_SPIRIT_SEX_COUNT] == 0)
                this.outputText("\"<i>Spirit sex... I can't say I've ever tried that,</i>\" she admits. \"<i>Damn if it isn't good.</i>\"\n\n", false);
            else
                this.outputText("\"<i>Damn,</i>\" she sighs, \"<i>that is still a great ride, I'd say...</i>\"\n\n", false);
            ...
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUAN_SPIRIT_SEX_COUNT]++;
            if (this.getGame().inCombat)
                this.cleanupAfterCombat();
            else
                this.doNext(this.camp.returnToCampUseOneHour);
        ...
        //Vagina Scene
        ghostGinaWinSexings() {
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 2 && ShouldraScene.rand(2) == 0) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_VAGINAL_POSSESSIONS] == 0)
                this.outputText("She 'hmm's several times inside your head, but you can feel a surge of elation as she apparently reaches a solution. \"<i>Of course!</i>\" she cries excitedly.  \"<i>I actually have never done this before!</i>\"\n\n", false);
            else
                this.outputText("\"<i>Oh well, I suppose we can always just do that again,</i>\" she muses. \"<i>It worked well enough the first time.</i>\"\n\n", false);
            ...
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_VAGINAL_POSSESSIONS]++;
            if (this.getGame().inCombat)
                this.cleanupAfterCombat();
            else
                this.doNext(this.camp.returnToCampUseOneHour);
        ...
        hermaphroditeGhostsCumEctoplasm() {
            ...
            var x = this.player.biggestCockIndex();
            this.outputText("", true);
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_HERMSEX_COUNT] == 0)
            ...
            //[if repeated] 
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_HERMSEX_COUNT] > 0)
                this.outputText("She chuckles softly as she recalls the times you've shared, and she hungrily goes for your maleness once more, though you mentally throw her off of it.  ", false);
            this.outputText("The communication suddenly breaks as the ghost-girl's will surges against yours, all thoughts of submissiveness vanishing from her mind.  ", false);
            if (this.player.inte < 50)
                this.outputText("It's not very hard for her to break down your fortifications, and you soon feel yourself being pushed aside by her vast mental capacity.", false);
            else if (this.player.inte < 90 || this.player.cockThatFits(80) == -1)
                this.outputText("You begin to gain an edge, but the ghost girl is craftier than you expected, and she begins to pulse mental intrusions at you, scrambling your thoughts for just long enough for her to overtake you and push you to the side.  \"<i>You are one hundred years too early to challenge me,</i>\" she chides. \"<i>My intellect has long surpassed most any living creature on this plane.</i>\"", false);
            else {
                x = this.player.cockThatFits(80);
                this.outputText("The ghost girl puts up a good fight, but you're more than prepared for her mental assault. You feel her panic well as her intrusions are overwhelmed, and though she attempts to disengage the mental link, you easily stop her. She screams mental protests at you, but your ringing ears only strengthen your psychological dominance over the poor spirit. Before long, she's reduced to a whimpering wreck. \"<i>Out,</i>\" you command, tired of the troublesome specter's meddlings. Of course, she won't even try to rebel now, resignedly accumulating her essence and beginning her exit. Within moments the ghost girl flows out of your body and resolidifies before you.\n\n", false);
            ...
            if (this.player.balls > 0)
                this.outputText("Stopping her double-handed stroke technique, she slips your hand under your obtrusive " + this.ballsDescriptLight() + " and gently pushes them aside to get a better look at your previously unnoticed female sex.  ", false);
            ...
            this.outputText("Her pleasure dealt with, the ghost girl appears head-first from your belly, flowing out and reconstituting herself into the normal, brown-eyed girl you first encountered.  Almost as an afterthought, she smiles, moving to her clothing and swiftly dressing, then gives you a little wave before wandering away, rounding a corner and disappearing from sight. You resolve to find her again- her magic was pretty fun!", false);
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_HERMSEX_COUNT]++;
            if (this.getGame().inCombat)
                this.cleanupAfterCombat();
            else
                this.doNext(this.camp.returnToCampUseOneHour);
        ...
        loseToShouldra() {
            ...
            if (this.player.hasCock())
                this.outputText("Each pulse pushes her a bit further onto your hardening manhood", false);
            else if (this.player.hasVagina())
                this.outputText("You can't deny the heat slowly welling up in your loins, your love-tunnel getting more lubricated by the moment", false);
            else
                this.outputText("You can't deny the heat slowly starting to gather in your bare loins");
            ...
            if (this.player.hasCock())
                this.outputText("quivering member", false);
            else if (this.player.hasVagina())
                this.outputText("sopping gash", false);
            else
                this.outputText("sensitive crotch-flesh");
            ...
            if (this.player.gender == 1) {
                ...
                else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1)
                    this.ghostGartuanLossSceneOrSomeShit();
                else if (this.player.biggestCockArea() >= 200)
                    this.shouldraGiantCockLoss();
                else
                    this.ourDadTaughtUsNotToBeAshamedOfOurDicks();
            }
            else if (this.player.gender == 2)
                this.ghostGinaLosses();
            else if (this.player.gender == 3) {
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1)
                    this.ghostGartuanLossSceneOrSomeShit();
                else if (this.player.biggestCockArea() >= 200)
                    ...
                    this.loseToShouldraAsHerm();
            }
            else
                this.genderlessShouldrasLossRapes();
        }
        //Loss Scenes
        //Penis Scene
        //[If you have a penis] 
        ourDadTaughtUsNotToBeAshamedOfOurDicks() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PENIS_DEFEAT_TIMES] == 0)
                ...
                this.outputText("She 'ooo's softly as she recalls your anatomy, ", false);
        ...
        ghostGinaLosses() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_VAGINAL_POSSESSIONS] == 0)
                this.outputText("She 'hmm's several times, raising your hand and tapping your finger against your chin. She snaps your fingers as a revelation washes over her.  \"<i>Of course!</i>\" she cries excitedly.  \"<i>I actually have never done this before!</i>\"", false);
            else
                this.outputText("\"<i>Oh well, I suppose I can always just do that again,</i>\" she muses. \"<i>It worked well enough the first time.</i>\"", false);
            this.outputText("\n\n", false);
        ...
        loseToShouldraAsHerm() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_HERMSEX_COUNT] == 0)
                ...
                this.outputText("She coos softly as she recalls your anatomy, ", false);
        ...
        shouldraGiantCockLoss() {
            ...
            //[if first time]
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
                this.outputText("bemused ", false);
            else
                this.outputText("excited ", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
                this.outputText("searches her body for any signs of change, and when she finds none, begins pouting.", false);
            else
                this.outputText("resists the urge to smash her tits together, waiting with as much patience as she can muster.", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
                ...
                this.outputText("and, to the green girl's obvious delight, ", false);
            this.outputText("reaches over and kneads the goblin's ", false);
            //([if first time]
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
                this.outputText("small, firm B-cups", false);
            else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 1)
                this.outputText("perky, sizeable C-cups", false);
            else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 2)
                this.outputText("well-formed, jiggly D-cups", false);
            else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 3)
                this.outputText("big and squishy E-cups", false);
            else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 4)
                this.outputText("oversized, heaving F-cups", false);
            else
                this.outputText("gigantic and openly-bared G-cups", false);
            this.outputText(". The goblin ", false);
            //[if first time] 
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
                this.outputText("instantly stops her protests, suddenly too stimulated by the massage to worry about any magical favoritism, ", false);
            else
                this.outputText("cries out in ecstasy at the still-incredible sensation, ", false);
            //[if first time]
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
                this.outputText("although that doesn't stop the second goblin to begin voicing her own dissent", false);
            else
                this.outputText("and you can't help but notice the excited blush running across the second goblin's face", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
                ...
                this.outputText("despite seeing the magic before, always enthralled by the process", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
                ...
                this.outputText("can't restrain her urges any longer, ", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
                ...
                this.outputText("titanic melons", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] == 0)
                ...
                this.outputText("II-cup (and H-cup, on the other side)", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT] <= 4)
                this.outputText("they have kept at least a cup size of flesh from their experience", false);
            else
                this.outputText("their breasts seem to have reached their crescendo, keeping the same (admittedly incredibly stacked) measurements", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_USES_YOUR_GIANT_COCK_COUNT]++;
            if (this.getGame().inCombat) {
                this.flags[kFLAGS_1.kFLAGS.BONUS_ITEM_AFTER_COMBAT_ID] = this.consumables.ECTOPLS.id;
                this.cleanupAfterCombat();
            }
        ...
        genderlessShouldrasLossRapes() {
            ...
            if (this.player.biggestTitSize() < 1)
                ...
                this.outputText("your " + this.allBreastsDescript() + " swells slightly to make room for a sudden increase in milk production.", false);
            this.outputText("  As the ghost continues darting around the room, ", false);
            if (this.player.biggestTitSize() <= 8)
                this.outputText("your new EE-cup breasts settle", false);
            else
                this.outputText("the lactation continues", false);
            ...
            if (this.player.isNaga())
                this.outputText("against your naga-crotch", false);
            else if (this.player.isGoo())
                this.outputText("into your cushiony goo", false);
            else
        ...
        ghostGartuanLossSceneOrSomeShit() {
            ...
            this.outputText("When the proverbial dust settles, you stir groggily. Blinking the sleep out of your eyes, you do a double take at the sheer amount of semen flooding the street. You feel a sensation building in your finally flaccid member, and you glance down. A pale, transparent smoke flows gently from your urethra, reforming into a very tired, moderately sore, but incredibly satisfied ghost girl.  ", false);
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUAN_SPIRIT_SEX_COUNT] == 0)
                this.outputText("\"<i>Spirit sex... I can't say I've ever tried that,</i>\" she admits. \"<i>Damn if it isn't good.</i>\"", false);
            else
                this.outputText("\"<i>Damn,</i>\" she sighs, \"<i>that is still a great ride, I'd say...</i>\"", false);
            this.outputText("\n\n", false);
        ...
        superCoolPaladinSexStuffDudeGasmJizzMonkies() {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00366]++;
        ...
        courtCrazyGirlsDotCom() {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00365] = 48;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //(two days later)
        paladinModeFollowup() {
            ...
            if (this.model.time.hours < 6 || this.model.time.hours >= 23)
        ...
        slimeGhostGalForHerms(clearOut = false) {
            if (clearOut)
                this.clearOutput();
            ...
            //{event occurrence == 0}
            if (this.flags[kFLAGS_1.kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] == 0)
                this.outputText("I've got this thing all figured out.");
            //event occurrence =1
            else if (this.flags[kFLAGS_1.kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] == 1)
                this.outputText("I've got this thing all figured out.  For real this time.");
            //event occurrence >=2
            else if (this.flags[kFLAGS_1.kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] == 2)
                this.outputText("I've got this thing all figured out.  For real this time.  Promise.");
            //event occurrence >=3
            else
                this.outputText("Well... don't worry TOO much.");
            this.outputText("</i>\"");
            ...
            //event occurrence == 0
            if (this.flags[kFLAGS_1.kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] <= 2)
                this.outputText("Maybe she really does have a firm grip on the reigns of this beast.");
            //event occurrence >=3
            else
                this.outputText("Regardless, you've been through this dog and pony show enough times to know that something is bound to go wrong anyway.");
            ...
            //vaginalLooseness == 0
            if (this.player.looseness() == 0)
                this.outputText("tight");
            //vaginalLooseness == 1
            else if (this.player.looseness() == 1)
                this.outputText("forgiving");
            else if (this.player.looseness() == 2)
                this.outputText("loose");
            else if (this.player.looseness() == 3)
                this.outputText("gaping");
            else
                this.outputText("cavernous");
            this.outputText(", velvety scabbard.  Hands too busy latched onto one another's hips, ");
            if (this.player.biggestTitSize() > 0)
                this.outputText("both you and the spooky slime press your tits together, your swaying thrusts only enhancing the mammary meltdown.");
            else
                this.outputText("the spooky slime presses her tits hard into your flat chest, your gyrations teasing them to no end.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] == 0)
                this.outputText("You couldn't spank it even to save your life, as we've learned today.</i>\"");
            else
                this.outputText("Evidently, you haven't put in any meaningful practice since last time,</i>\" the specter chides you while making an exaggerated jerking-off motion.");
            if (this.flags[kFLAGS_1.kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] == 1)
                this.outputText("  \"<i>I was afraid you'd have... given up the ghost.</i>\"");
            else if (this.flags[kFLAGS_1.kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER] > 1)
                this.outputText("  \"<i>But I'm more than willing to do it again next time with a conclusion like that!</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.GHOST_GIRL_SLIME_X_SHOULDRA_COUNTER]++;
        }
    }
    exports.ShouldraScene = ShouldraScene;
});
//# sourceMappingURL=ShouldraScene.js.map