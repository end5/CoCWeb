define(["require", "exports", "./NPCAwareContent", "../../PregnancyStore", "../../GlobalFlags/kFLAGS", "../../../../includes/appearanceDefs", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, PregnancyStore_1, kFLAGS_1, appearanceDefs_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class UrtaPregs extends NPCAwareContent_1.NPCAwareContent {
        ...
        */
        get pregnancy() { return kGAMECLASS_1.kGAMECLASS.urta.pregnancy; }
        //Urta Pregnancy Stages
        //Urta takes 2 days to progress from one pregnancy stage to the next
        //In Bar Menu
        urtaKids() {
            return this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_MALES] + this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_FEMALES] + this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_HERMS];
        }
        urtaSexMenu() {
            var spank = undefined;
            if ((this.player.hasCock() && this.player.cockThatFits(this.urta.urtaCapacity()) >= 0) || this.player.hasKeyItem("Deluxe Dildo") >= 0)
                spank = this.urta.spankTheShitOutOfUrtaAndMakeHerCreamHerselfFromProstateStimulationAloneLikeTheHornyDrunkenSlutSheReallyIs;
            //NOT Drunk
            if (!this.urta.urtaDrunk()) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] == 1) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_CUM_NO_CUM_DAYS] >= 5)
                        this.addButton(1, "Suck Off", this.urta.slurpFawkesCocksForFunAndInflation);
                    else
                        this.addButton(1, "Suck Off", this.urta.blowUrtaUnderTheTableLuv);
                ...
                //FRIEND
                    ...
                    this.menu();
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_CUM_NO_CUM_DAYS] >= 5)
                        this.addButton(0, "Hidden BJ", this.urta.slurpFawkesCocksForFunAndInflation);
                    else
                        this.addButton(0, "Hidden BJ", this.urta.blowUrtaUnderTable);
            ...
            //DRUNK
                ...
                if (this.urtaLove()) {
                    ...
                    if (this.player.canOviposit())
                        this.addButton(2, "Lay Eggs", this.urta.giveTheFoxSomeEggs);
        ...
        urtaPregAppearance() {
            switch (this.pregnancy.event) {
                case 1:
                case 2:
                    this.outputText("Urta is sitting at her usual table, looking more clear-eyed and sober than usual.  She looks extremely happy, tail wagging gently behind her, and she gives you a thrilled look when she sees you, smiling blissfully and patting her belly in a meaningful gesture.");
                    break;
                case 3:
                case 4:
                case 5:
                case 6:
                case 7:
                    this.outputText("Urta has moved from her usual table to a more private stall, apparently for the comfort of its padded seats.  Her bulging belly makes it obvious she's pregnant - and the wide grin that seems fixed to her face makes it obvious she's ecstatic about it.");
                    break;
                case 8:
        ...
        preggoUrtaGivingBirth() {
            ...
            this.flags[kFLAGS_1.kFLAGS.NEW_BABY_ANNOUNCED] = 0;
        ...
        IAintGotTimeForUrtaBirfs() {
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_TIMES_BIRTHED]++;
            this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] = UrtaPregs.rand(3) + 1;
            if (this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] == 1)
                this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_MALES]++;
            else if (this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] == 2)
                this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_FEMALES]++;
            else
                this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_HERMS]++;
            if (this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] == 3 || this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] == 1) {
                if (UrtaPregs.rand(2) == 0)
                    this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_COCKTYPE] = 2;
                else
                    this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_COCKTYPE] = 1;
            }
            //If firstborn, set as current.
            if (this.urtaKids() == 1) {
                this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_GENDER] = this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER];
                this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_COCKTYPE] = this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_COCKTYPE];
            }
            this.flags[kFLAGS_1.kFLAGS.NEED_URTA_LETTER] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        getUrtaLetter() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] == 1)
                ...
                this.outputText("hermaphrodite daughter");
            this.outputText(", though.\n");
            this.flags[kFLAGS_1.kFLAGS.NEED_URTA_LETTER] = 0;
        }
        //[=Go=]
        goVisitUrtaBirfs(withUrta = false) {
            this.clearOutput();
            this.pregnancy.knockUpForce(); //Clear Pregnancy
            this.flags[kFLAGS_1.kFLAGS.URTA_PREGNANT_DELIVERY_SCENE] = 0;
            this.flags[kFLAGS_1.kFLAGS.NEW_BABY_ANNOUNCED] = 0;
            if (!withUrta)
                this.outputText("The trip to the clinic where Urta is giving birth to your child is a blur; all that matters is getting there as fast as possible.  The centaur abandons you at the hospital doors, and you make your own way inside, approaching the counter inside.");
            //[1st time:
            if (this.flags[kFLAGS_1.kFLAGS.URTA_TIMES_BIRTHED] == 0) {
            ...
            if (gender == 2)
                ...
                this.outputText("boy...?  Well... isn't that unusual, looks like you actually gave birth to a healthy herm!");
            this.outputText("</i>\"");
            ...
            if (gender == 1 || gender == 3) {
                ...
                //[Horse Dick:
                    ...
                    if (gender == 1)
                        this.outputText("boy when he grows up.");
                    else
                        this.outputText("girl when she grows up.");
                    this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_COCKTYPE] = 1;
                }
            }
            ...
            //[she's]
            if (gender >= 2)
                this.outputText("she's");
            else
                this.outputText("he's");
            this.outputText(" really here; our beautiful, beautiful little baby...</i>\" She sobs, ");
            if (this.urtaKids() == 0)
                this.outputText("overwhelmed by the fact she's a mother at long last");
            else
                this.outputText("still as delighted as ever to have a new addition to your growing brood");
            this.outputText(".");
            ...
            //set all appropriate birth variables here.
            this.flags[kFLAGS_1.kFLAGS.URTA_TIMES_BIRTHED]++;
            this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] = gender;
            if (gender == 1)
                this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_MALES]++;
            else if (gender == 2)
                this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_FEMALES]++;
        ...
        wakeUpWithUrtaAfterStaying() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_MALES] == 1)
                this.outputText("son");
            else
                this.outputText("daughter");
            ...
            if (this.player.cor < 50)
                this.outputText("gently,");
            else
                this.outputText("tightly,");
            this.outputText(" earning a ");
            if (this.player.cor < 50)
                this.outputText("whimpering moan");
            else
                this.outputText("gasping shudder");
            ...
            //1st time: 
            if (this.flags[kFLAGS_1.kFLAGS.URTA_TIMES_BIRTHED] == 1)
                this.outputText("You look at her questioningly; she's breast-feeding, so she shouldn't be drinking alcohol.  \"<i>Oh, don't worry; even I don't drink booze in the morning.  It's a little pick-me-up of my own invention; totally non-alcoholic.  It's mostly fruit juice with a few spices thrown in.</i>\"  Urta laughs.  ");
            ...
            if (this.urtaKids() == 1)
                this.outputText("a child");
            else
                this.outputText("children");
            ...
            this.outputText(".");
            if (this.urtaKids() == 2)
                this.outputText("  The other kid is staying at Edryn's, so there's no risk of you two needing to answer... complicated questions.");
            if (this.urtaKids() > 2)
                this.outputText("  The other kids are staying at Edryn's, so there's no risk of you two needing to answer... complicated questions.");
        ...
        urtaPregooUpdates() {
            ...
            //4: 
                ...
                if (this.pregnancy.type != PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER)
                    this.outputText("sounding somewhat jealous that it's you carrying and not her.");
                else
                    this.outputText("sounding a little smug as she caresses her own gravid tummy.");
                ...
                this.flags[kFLAGS_1.kFLAGS.EVENT_PARSER_ESCAPE] = 1;
                return true;
            }
            //5
                ...
                if (this.urtaKids() == 0)
                    this.outputText(" Oh, [name], we really are going to be parents...");
        ...
        //[=Decline=]
        declineUrtaLevelSixPreggoHelps() {
            this.clearOutput();
        ...
        PCGivesBirf() {
            ...
            //1st Time:
            if (this.flags[kFLAGS_1.kFLAGS.URTA_TIMES_PC_BIRTHED] == 0) {
            ...
            if (gender == 1) {
                ...
                this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_MALES]++;
                this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] = 1;
            }
            //Girl:
            else if (gender == 2) {
                ...
                this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_FEMALES]++;
                this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] = 2;
            }
            //Herm:
            else {
                ...
                this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_HERMS]++;
                this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] = 3;
            }
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_TIMES_PC_BIRTHED]++;
            //If firstborn, set as current.
            if (this.urtaKids() == 1) {
                this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_GENDER] = this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER];
                this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_COCKTYPE] = this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_COCKTYPE];
        ...
        urtaIsHappyAboutPregnancyAtTheBar() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.URTA_INCUBATION_CELEBRATION] = 1;
        ...
        urtaIsAPregnantCopScene() {
            ...
            if (kGAMECLASS_1.kGAMECLASS.telAdre.edryn.pregnancy.isPregnant)
                this.outputText("  Edryn's pregnant belly isn't helping her, either.");
        ...
        urtaSpecialDeliveries() {
            ...
            if (kGAMECLASS_1.kGAMECLASS.telAdre.edryn.pregnancy.isPregnant)
                this.outputText(" and her pregnant belly jiggling from the motions");
            ...
            if (kGAMECLASS_1.kGAMECLASS.telAdre.edryn.pregnancy.isPregnant)
                this.outputText("as quickly as a pregnant mare can, anyway,");
            ...
            if (this.pregnancy.event >= 7)
                this.outputText("heavily ");
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_PREGNANT_DELIVERY_SCENE] = 1;
            //(Return to TA menu.)
            this.menu();
        ...
        talkToUrtaAboutHerHouse() {
            ...
            if (this.player.cor < 50)
                this.outputText(" despite it having some emotional value to you.");
        ...
        yesUrtaHouseSex() {
            ...
            if (this.player.lib > 50)
                this.outputText("  Sometimes you almost give up on waiting to get to her apartment and instead strip and do her right then and there... but it wouldn't bode well for the Watch captain to get a fine for public indecency.");
            ...
            if (!this.urtaLove())
                this.urta.goBackToUrtasForLuvinzII();
            else {
                this.outputText("\n\n");
        ...
        talkAboutLiana() {
            ...
            //{Had sex with Lianna:
            if (this.flags[kFLAGS_1.kFLAGS.LIANNA_HAVESTED_LADIES] > 0 || this.flags[kFLAGS_1.kFLAGS.LIANNA_HAVESTED_MALES] > 0) {
        ...
        preggoUrtaSmexOrSomething() {
            ...
            switch (this.pregnancy.event) {
                case 7:
                    this.outputText("dripping wetly onto the floor");
                    break;
                case 8:
                case 9:
                    this.outputText("slopping into the filling bucket");
                    break;
        ...
        massagePregnantUrtasBelly() {
            ...
            //1st Time:
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_MASSAGED_URTA_BELLY] == 0) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_MASSAGED_URTA_BELLY] == 0)
                this.outputText("  She looks at you and her newly cream-adorned belly contemplatively.  \"<i>I never knew my sweet tooth would bring me to this...</i>\"");
            ...
            if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                this.outputText(", a task that is made far easier due to your tongue's ability to stretch to a surprising length");
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_MASSAGED_URTA_BELLY]++;
            //[RubDick] [RubPussy]
            this.menu();
        ...
        urtaMassageClimax() {
            ...
            //Low Cor:
            if (this.player.cor < 33)
                this.outputText("  You walk up to her and carefully remove her condom, tying it up with a knot to prevent any of her seed from escaping, then dispose of it.");
            //Medium Cor:
            else if (this.player.cor < 66)
                this.outputText("Well, whatever, she's probably too sleepy to do anything about it either way.");
            //High Cor:
            else
                this.outputText("You walk up to her with a smirk and remove her condom, then pour down its contents over her belly, chuckling to yourself.  Now that's a great cream topping for your lovely fox-herm.");
        ...
        urtaBoobWorshipScene() {
            ...
            //1st Time:
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_URTA_BOOB_WORSHIPPED] == 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_URTA_BOOB_WORSHIPPED]++;
            ...
            if (this.player.faceType == appearanceDefs_1.FACE_SHARK_TEETH || this.player.faceType == appearanceDefs_1.FACE_SNAKE_FANGS || this.player.faceType == appearanceDefs_1.FACE_SPIDER_FANGS)
                this.outputText(", always minding your sharp teeth");
            ...
            if (this.player.hasCock())
                this.outputText(", tasting a bit of yourself,");
        ...
        nurseFromMommaUrtasBooBees() {
            ...
            //1st Time:
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_NURSED_FROM_URTA] == 0) {
            ...
            if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                this.outputText("  Every few licks you coil your tongue around one of her nipples and gently pull at it, milking a thin strand of white goodness straight on your tongue, much to the fox-herm's delight.");
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_NURSED_FROM_URTA]++;
            //[Stroke][Ignore]
            this.menu();
        ...
        milkPregnantUrta() {
            ...
            if (this.player.hasCock())
                this.outputText("Urta promptly stops stroking your dick, though whether it's because she wants to be helpful or because she's annoyed you've stopped is anyone's guess.  ");
        ...
        urtaPregCravings() {
            ...
            if (this.player.lactationQ() >= 200)
                this.outputText(", which automatically causes milk to trickle forth");
            this.outputText(".  \"<i>Nope, not it either...");
            if (this.player.lactationQ() >= 200)
                this.outputText(" sweet, though.");
            ...
            if (this.player.balls > 0)
                this.outputText(" with your [balls]");
            ...
            if (this.player.cockTotal() > 2)
                this.outputText("The rest of your " + this.multiCockDescriptLight() + " are as erect as your [cock biggest] dribbling pre along their lengths as they slap Urta during her frenzied bobs.  ");
            ...
            if (this.player.balls > 0 || this.player.hasVagina()) {
                ...
                if (this.player.balls > 0) {
                    ...
                    if (this.player.hasVagina())
                        this.outputText(" and another with ");
                }
                if (this.player.hasVagina())
                    this.outputText("your pussy");
            }
        ...
        getBlownByPregnantUrta() {
            ...
            if (this.player.balls > 0)
                this.outputText("your balls churn and ");
            ...
            if (this.player.cockTotal() > 1) {
                ...
                if (this.player.cockTotal() > 2)
                    this.outputText("s as they join");
                else
                    this.outputText(" as it joins");
        ...
        //[=Hold On=]
        holdOnYouAintGettingYerCumYetYouNaughtyFox() {
            this.clearOutput();
            ...
            if (this.player.cockTotal() > 1) {
                ...
                if (this.player.cockTotal() > 2)
                    this.outputText("s bulging ominously as they too prepare to deposit their loads on the willing fox-herm.");
                else
                    this.outputText(" bulging ominously as it too prepares to deposit its load on the willing fox-herm.");
            }
            ...
            if (this.player.cumQ() < 250) {
                ...
                if (this.player.cockTotal() > 1) {
                    ...
                    if (this.player.cockTotal() == 2)
                        this.outputText(" convulses");
                    else
                        this.outputText("s convulse");
            ...
            //(Medium Cum Amount)
                ...
                if (this.player.cockTotal() > 1) {
                    this.outputText("Your other cock");
                    if (this.player.cockTotal() == 2)
                        this.outputText(" contributes");
                    else
                        this.outputText("s contribute");
                    this.outputText(" by making a complete mess of her as ");
                    if (this.player.cockTotal() > 2)
                        this.outputText("they randomly spatter");
                    else
                        this.outputText("it randomly spatters");
            ...
            //(High Cum Amount)
                ...
                if (this.player.cockTotal() > 1) {
                    this.outputText("  Your other cock");
                    if (this.player.cockTotal() > 2)
                        this.outputText("s shoot their loads");
                    else
                        this.outputText(" shoots its load");
                ...
                if (this.player.hasKnot(this.player.biggestCockIndex()))
                    this.outputText(", just above your knot,");
            ...
            if (this.player.cumQ() >= 500)
                this.outputText(", audibly gurgling");
        ...
        weirdUrtaCravingsConclusion() {
            ...
            if (this.player.cumQ() < 1000)
                this.outputText("completely clean.");
            else
                this.outputText("lacking the extra bit of paunch you gave her earlier.");
        ...
        urtaRaepsJoo() {
            ...
            if (this.player.hasCock())
                this.outputText("Every time her swollen tip rubs against your prostate you feel droplets of pre escape your dilating cum-hole.  ");
            if (this.player.hasVagina())
                this.outputText("Each slap of her balls against your [vagina] sends electric waves of pleasure that expand throughout your body.  ");
            ...
            if (this.player.cockTotal() > 0) {
                if (this.player.cockTotal() > 1)
                    this.outputText("  [EachCock] tenses in unison");
                else
                    this.outputText("  [EachCock] throbs, tensing in preparation");
                //(Low Cum Amount)
                if (this.player.cumQ() < 250)
                    this.outputText(" and you unload on the floor, spilling rope after rope of cum, forming a small puddle where you stand.  An undeniable testament to your enjoyment of the kinkiness of the act, however small.");
                //(Medium Cum Amount)
                else if (this.player.cumQ() < 1000)
                    this.outputText(" and you deliver your payload right there on the floor.  Jet after jet splash against it, and you have no choice but to continue moaning and spilling your cum as Urta remains firmly lodged in your depths, no longer able to move now that you're squeezing her shaft so deliciously tight.  By the time you're done, the puddle you've formed is big enough that you can see your own face on the reflection, enraptured in pleasure and enjoyment of Urta's equine meatstick.");
                //(High Cum Amount)
                else {
                    this.outputText(" and you let your prodigious load escape the confines of your ");
                    if (this.player.balls > 0)
                        this.outputText("churning balls");
                    else
                        this.outputText("being");
            ...
            if (this.player.hasVagina()) {
                ...
                if (this.player.wetness() >= 4)
                    this.outputText(" to join your previous discharge on");
                else
                    this.outputText(" and down towards");
            ...
            if (this.player.gender == 0) {
                ...
                if (this.player.ass.analWetness > 0)
                    this.outputText(" It even secretes its own wetness to slide lovingly down the fox-herm's balls and drip on the floor, an undeniable proof of your enjoyment.");
            }
            ...
            if (puddle > 0) {
                if (puddle == 1)
                    ...
                    this.outputText("reasonable");
                else
                    this.outputText("enormous");
                this.outputText(" puddle of cum you created");
            }
            else
                this.outputText("floor");
        ...
        partTwoOfUrtaBoning() {
            ...
            if (this.player.cockTotal() > 1) {
                ...
                if (!this.player.isTaur())
                    this.outputText("  So close that you can almost feel its heat against your [cockHead].");
        ...
        acceptUrtaRimJobbies() {
            ...
            if (this.player.cockTotal() > 1)
                this.outputText("  Especially not if your " + this.multiCockDescriptLight() + " have anything to say about it, throbbing at the mere feeling of Urta's wet tongue.");
            else if (this.player.cockTotal() == 1)
                this.outputText("  Especially not if your [cock] has anything to say about it, throbbing at the mere feeling of Urta's wet tongue.");
            else if (this.player.hasVagina())
                this.outputText("  Especially not if your [pussy] has any say in the matter, winking at Urta, hoping for a licking of its own.");
        ...
        visitKidsFirstTime() {
            ...
            this.outputText("\n\n\"<i>You want to see ");
            if (this.urtaKids() == 1)
                this.outputText("our child");
            else
                this.outputText("our babies");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_TIME_SINCE_LAST_CAME] == 0)
                this.outputText(", erection already diminishing as she forgets about her horniness in her parental pride");
        ...
        pickKidSceneHere() {
            ...
            //ANNOUNCE BEHBIES
            //Once per pregnancy?
            if ((this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER || (this.player.pregnancyIncubation < 300 && this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_URTA)) && this.flags[kFLAGS_1.kFLAGS.NEW_BABY_ANNOUNCED] == 0) {
                this.newBabyComing();
            }
            ...
            else if (UrtaPregs.rand(2) == 0)
                this.takeTheKidsForWalk();
            //Bathtime
        ...
        newBabyComing() {
            ...
            if (this.urtaKids() == 1)
                ...
                this.outputText(UrtaPregs.num2Text(this.urtaKids()) + " kids");
            this.outputText(" that you and Urta have something important to tell them.");
            //If UrtaKids <8:
            if (this.urtaKids() < 8) {
                this.outputText("\n\nAs ");
                if (this.urtaKids() == 1) {
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_GENDER] >= 2)
                        this.outputText("she");
                    else
                        this.outputText("he");
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_GENDER] >= 2)
                    this.outputText("her");
                else
                    this.outputText("him");
                this.outputText(" a loving smile.");
                //Both Preg:
                if (this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER && this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_URTA) {
                ...
                //One person preg:
                else if (this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER || (this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_URTA)) {
                ...
                this.outputText("\n\nYour child");
                if (this.urtaKids() > 1)
                    this.outputText("ren are");
                else
                    this.outputText(" is");
                this.outputText(" silent for a moment, digesting this information.  Then ");
                if (this.urtaKids() == 1)
                    this.outputText("a small fluffy bundle is");
                else
                    this.outputText("several small fluffy bundles are");
            ...
            this.flags[kFLAGS_1.kFLAGS.NEW_BABY_ANNOUNCED] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        stayToPlay() {
            ...
            //1st time:
            if (this.flags[kFLAGS_1.kFLAGS.URTA_LUNCH_PLAY] == 0) {
                this.flags[kFLAGS_1.kFLAGS.URTA_LUNCH_PLAY]++;
        ...
        urtaKidsText(male = "", female = "", plural = "") {
            if (this.urtaKids() == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_GENDER] == 1)
                    return male;
                else
                    return female;
            }
        ...
        giveTheKidsABath() {
            ...
            if (this.urtaKids() == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_GENDER] == 1)
                    this.outputText("your son");
                else
                    this.outputText("your daughter");
            }
            else
                this.outputText("the kids");
            ...
            else if (this.urtaKids() < 8)
                this.outputText("kids");
            else
                this.outputText("army of kids");
            this.outputText(".  \"<i>All right, ");
            if (this.urtaKids() > 1)
                this.outputText("everyone ");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_MALES] > 0) {
                this.outputText("\n\nYou have " + UrtaPregs.num2Text(this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_MALES]) + " vulpine son");
                if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_MALES] > 1)
                    this.outputText("s");
                this.outputText(".");
                if (this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_GENDER] == 1) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_MALES] == 1)
                        this.outputText("the only one,");
                    else
                        this.outputText("among them,");
                    this.outputText(" sporting a");
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_COCKTYPE] == 2)
                        this.outputText(" vulpine penis");
                    else
                        this.outputText("n equine phallus, similar to what Urta has");
                    this.outputText(".");
                }
                if (this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] == 1 && this.urtaKids() > 1) {
                    this.outputText("  Your newest is ");
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] == 1)
                        this.outputText("also ");
                    this.outputText("a boy, with a");
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_COCKTYPE] == 2)
                        this.outputText(" vulpine penis");
                    else
                        this.outputText("n equine phallus, just like his mom's");
                    this.outputText(".");
                }
                ...
                if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_MALES] > 1)
                    this.outputText("they hit");
                else
                    this.outputText("he hits");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_MALES] > 1)
                    this.outputText("strong fighters like she is.");
                else
                    this.outputText("a strong fighter like she is.");
            }
            //If any UrtaKids=Herm:
            if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_HERMS] > 0) {
                this.outputText("\n\nYou have " + UrtaPregs.num2Text(this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_HERMS]) + " vulpine, hermaphroditic daughter");
                if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_HERMS] > 1)
                    this.outputText("s");
                this.outputText(".");
                if (this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_GENDER] == 3) {
                    this.outputText("  Your firstborn is a hermaphrodite, sporting a");
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_COCKTYPE] == 2)
                        this.outputText(" vulpine penis");
                    else
                        this.outputText("n equine phallus, a peculiarity she inherited from her mother");
                    this.outputText(".");
                }
                if (this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] == 3 && this.urtaKids() > 1) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_COCKTYPE] == 2)
                        ...
                        this.outputText("n equine phallus.  No doubt such a characteristic was passed from her mother");
                    this.outputText(".");
                }
                this.outputText("  You have a feeling ");
                if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_HERMS] > 1)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_FEMALES] > 0) {
                this.outputText("\n\nYou have " + UrtaPregs.num2Text(this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_FEMALES]) + " vulpine daughter");
                if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_FEMALES] > 1)
                    this.outputText("s");
                this.outputText(".");
                if (this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_GENDER] == 2) {
                    this.outputText("  Your firstborn is a girl.");
                }
                if (this.flags[kFLAGS_1.kFLAGS.URTA_LATESTBORN_GENDER] == 2 && this.urtaKids() > 1) {
                    this.outputText("  Your latest addition is ");
                    if (this.flags[kFLAGS_1.kFLAGS.URTA_FIRSTBORN_GENDER] == 2)
                        this.outputText("also ");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.URTA_KIDS_FEMALES] > 1)
                    this.outputText("they will");
                else
                    this.outputText("she will");
            ...
            if (this.urtaKids() == 1) {
                ...
                if (this.urtaKids() > 2)
                    this.outputText("One of your other children");
                else
                    this.outputText("Your other child");
        ...
        takeTheKidsForWalk() {
            ...
            if (this.urtaKids() > 1)
                this.outputText("  \"<i>Yeah, can we " + this.player.mf("daddy", "mommy") + "?!</i>\"");
            this.outputText("  Your child");
            if (this.urtaKids() > 1)
                this.outputText("ren plead");
            else
                this.outputText(" pleads");
            ...
            if (this.urtaKids() > 1)
                this.outputText("a chorus of excited cheers sounds out.");
            else
                this.outputText("an excited cheer sounds out.");
            this.outputText("  It's hard not to want to live up to that title with such ");
            if (this.urtaKids() == 1)
                this.outputText("a happy face");
            else
                this.outputText("happy faces");
            ...
            if (this.urtaKids() > 1)
                this.outputText("they fan out and curiously inspect");
            else
                this.outputText(this.urtaKidsText("he", "she", "") + " runs off to curiously inspect");
            ...
            if (this.urtaKids() == 1)
                this.outputText("buried in cone");
            else
                this.outputText("s buried in their cones");
        ...
        visitTheHouse() {
            ...
            //1st time only:
            if (this.flags[kFLAGS_1.kFLAGS.FIRST_TIME_AT_URTA_HOUSE] == 0) {
                this.flags[kFLAGS_1.kFLAGS.FIRST_TIME_AT_URTA_HOUSE]++;
        ...
        talkToLiana(output = true) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.LIANNA_HAVESTED_MALES] + this.flags[kFLAGS_1.kFLAGS.LIANNA_HAVESTED_LADIES] > 0)
                this.addButton(2, "Her Spray", this.talkAboutLiannasLubeSpray);
            if (this.flags[kFLAGS_1.kFLAGS.DISCUSSED_LUBE_SPRAY] > 0)
                this.addButton(3, "Side Effect", this.lubeSpraySideEffects);
            this.addButton(9, "Back", this.visitTheHouse);
        }
        //Her Job
        talkToLianaAboutHerJob() {
            this.clearOutput();
        ...
        talkToLianaAboutHerResearch() {
            ...
            if (this.player.cor >= 50)
                this.outputText("however half-heartedly it may be, ");
        ...
        talkAboutLiannasLubeSpray() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.DISCUSSED_LUBE_SPRAY] = 1;
        ...
        lubeSpraySideEffects() {
            ...
            if (this.player.cor < 33)
                this.outputText("mild");
            else if (this.player.cor < 66)
                this.outputText("some");
            else
                this.outputText("great");
        ...
        sexWithLianna() {
            ...
            if (this.player.cockTotal() > 1)
                this.outputText("  Your lower garments suddenly feel much tighter.");
            ...
            if (this.player.hasVagina()) {
                if (this.player.pregnancyIncubation == 0)
                    this.addButton(0, "HarvestGirly", this.getEggsHarvested);
                else
                    this.outputText("\n\n<b>She's not willing to have sex with you until your womb is unfilled.</b>");
            }
            if (this.player.hasCock())
                this.addButton(1, "HarvestManly", this.liannaHandjobbies);
            this.addButton(4, "Back", this.visitTheHouse);
        }
        //[=Refuse=]
        refuseGenderlessInjection() {
            this.clearOutput();
        ...
        acceptARandomGenderFromASkunk() {
            ...
            //{if Centaur: 
            if (this.player.isTaur())
                this.outputText("  Or at least hold on to something, this might sting a little and I don't need you kicking down anything in here.");
            this.outputText("</i>\"");
        ...
        getEggsHarvested() {
            ...
            //1st time:
            if (this.flags[kFLAGS_1.kFLAGS.LIANNA_HAVESTED_LADIES] == 0) {
                this.outputText("confusion, wondering what she's playing at");
                this.flags[kFLAGS_1.kFLAGS.LIANNA_HAVESTED_LADIES]++;
            }
            else
                this.outputText("remembrance, knowing what's coming next");
            ...
            if (this.player.vaginalCapacity() >= 50)
                this.outputText("  \"<i>Hmm, I might not have had to lube it up after all...</i>\"  The skunkette remarks.");
            ...
            if (this.player.looseness() >= 4)
                this.outputText("; your loose pussy doesn't hurt, either");
        ...
        liannaHandjobbies() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.LIANNA_HAVESTED_MALES]++;
            ...
            if (this.player.cockTotal() > 1)
                this.outputText("  \"<i>However I think milking just one is good enough.</i>\"");
            ...
            if (this.player.balls > 0)
                this.outputText("occasionally stopping to caress your [balls], ");
    ...
    exports.UrtaPregs = UrtaPregs;
});
//# sourceMappingURL=UrtaPregs.js.map