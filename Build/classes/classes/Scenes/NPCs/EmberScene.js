define(["require", "exports", "./NPCAwareContent", "../../PregnancyStore", "../../GlobalFlags/kFLAGS", "../../CoC", "../../../console", "../../StatusAffects", "../../PerkLib", "../../CockTypesEnum", "../../../../includes/appearanceDefs", "./Ember", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, StatusAffects_1, PerkLib_1, CockTypesEnum_1, appearanceDefs_1, Ember_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 04.01.14.
     */
    class EmberScene extends NPCAwareContent_1.NPCAwareContent {
        constructor() {
            super();
            this.pregnancy = new PregnancyStore_1.PregnancyStore(kFLAGS_1.kFLAGS.EMBER_PREGNANCY_TYPE, kFLAGS_1.kFLAGS.EMBER_INCUBATION, 0, 0);
            this.pregnancy.addPregnancyEventSet(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, 330, 270, 200, 180, 100, 75, 48, 15);
        ...
        timeChange() {
            ...
            //Ember fuck cooldown
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.EmberFuckCooldown) > 0) {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.EmberFuckCooldown, 1, -1);
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.EmberFuckCooldown) < 1)
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.EmberFuckCooldown);
            }
            //Ember napping
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.EmberNapping) >= 0) {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.EmberNapping, 1, -1);
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.EmberNapping) <= 0)
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.EmberNapping);
            }
            if (this.followerEmber() && this.player.findStatusAffect(StatusAffects_1.StatusAffects.EmberNapping) < 0) {
                //Mino cum freakout - PC partly addicted!
                if (this.flags[kFLAGS_1.kFLAGS.MINOTAUR_CUM_ADDICTION_STATE] == 1 && this.player.findPerk(PerkLib_1.PerkLib.MinotaurCumAddict) < 0 && this.flags[kFLAGS_1.kFLAGS.EMBER_CURRENTLY_FREAKING_ABOUT_MINOCUM] == 0) {
                    this.minotaurJizzFreakout();
                    needNext = true;
                }
                //Ember is freaking out about addiction, but PC no longer addicted!
                else if (this.flags[kFLAGS_1.kFLAGS.MINOTAUR_CUM_ADDICTION_STATE] == 0 && this.flags[kFLAGS_1.kFLAGS.EMBER_CURRENTLY_FREAKING_ABOUT_MINOCUM] == 1) {
                ...
                if (this.player.lust >= 100 && this.player.gender > 0) {
                    this.flags[kFLAGS_1.kFLAGS.EMBER_LUST_BITCHING_COUNTER]++;
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_LUST_BITCHING_COUNTER] >= 10) {
                ...
                //Reset lust counter if not max lust'ed
                    ...
                    this.flags[kFLAGS_1.kFLAGS.EMBER_LUST_BITCHING_COUNTER] = 0;
            }
            if (this.model.time.hours > 23) {
                if (!this.player.isPregnant())
                    this.flags[kFLAGS_1.kFLAGS.EMBER_BITCHES_ABOUT_PREGNANT_PC] = 0;
                this.flags[kFLAGS_1.kFLAGS.DRANK_EMBER_BLOOD_TODAY] = 0;
            }
            return needNext;
        }
        timeChangeLarge() {
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.EmberNapping) < 0 && this.followerEmber() && this.player.findStatusAffect(StatusAffects_1.StatusAffects.EmberFuckCooldown) < 0) {
                //Ember get's a whiff of fuckscent and knocks up PC!
                if (this.player.hasVagina() && this.player.inHeat && this.player.pregnancyIncubation == 0 && EmberScene.rand(10) == 0 && (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)) {
                    this.emberRapesYourHeatness();
                    return true;
                }
                else if (this.player.hasCock() && this.player.inRut && !this.pregnancy.isPregnant && EmberScene.rand(10) == 0 && this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2) {
                    this.emberRapesYourHeatness();
                    return true;
                }
            }
        ...
        emberAffection(changes = 0) {
            this.flags[kFLAGS_1.kFLAGS.EMBER_AFFECTION] += changes;
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_AFFECTION] > 100)
                this.flags[kFLAGS_1.kFLAGS.EMBER_AFFECTION] = 100;
            else if (this.flags[kFLAGS_1.kFLAGS.EMBER_AFFECTION] < 0)
                this.flags[kFLAGS_1.kFLAGS.EMBER_AFFECTION] = 0;
            return this.flags[kFLAGS_1.kFLAGS.EMBER_AFFECTION];
        }
        emberCorruption(changes = 0) {
            this.flags[kFLAGS_1.kFLAGS.EMBER_COR] += changes;
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_COR] > 100)
                this.flags[kFLAGS_1.kFLAGS.EMBER_COR] = 100;
            else if (this.flags[kFLAGS_1.kFLAGS.EMBER_COR] < 0)
                this.flags[kFLAGS_1.kFLAGS.EMBER_COR] = 0;
            return this.flags[kFLAGS_1.kFLAGS.EMBER_COR];
        }
        followerEmber() {
            return this.flags[kFLAGS_1.kFLAGS.EMBER_HATCHED] > 0;
        }
        emberMF(man, woman) {
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1)
                return man;
            else
                return woman;
        }
        emberVaginalCapacity() {
            return 60;
        }
        emberAnalCapacity() {
            return 60;
        ...
        emberHasCock() {
            return (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3);
        }
        emberChildren() {
            return (this.flags[kFLAGS_1.kFLAGS.EMBER_CHILDREN_MALES] + this.flags[kFLAGS_1.kFLAGS.EMBER_CHILDREN_FEMALES] + this.flags[kFLAGS_1.kFLAGS.EMBER_CHILDREN_HERMS]);
        }
        emberInternalDick() {
            return (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] > 0);
        }
        //Approaching Ember (Z)
        emberCampMenu() {
            this.clearOutput();
            ...
            if (this.emberAffection() <= 25)
                this.outputText("Ember sighs as you approach, and doesn't even look you in the eye before speaking.  \"<i>What do you want?</i>\"");
            //Moderate Affection:
            else if (this.emberAffection() <= 75)
                this.outputText("Ember fidgets as " + this.emberMF("his", "her") + " tail starts to sway from side to side, " + this.emberMF("he", "she") + " looks at you and asks, \"<i>What is it?</i>\"");
            else
                this.outputText("Ember's eyes light up as you close in on " + this.emberMF("him", "her") + ", and " + this.emberMF("he", "she") + " smiles nervously.  \"<i>Y-Yes?</i>\"");
            //OPTIONS HERE
            //[APPEARANCE]
            ...
            var egg = undefined;
            var milk = undefined;
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] > 0 && this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2 && !this.pregnancy.isPregnant)
                egg = this.emberIsAnEggFactory;
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0)
                milk = this.getMilkFromEmber;
            this.choices("Appearance", this.embersAppearance, "Talk", this.talkToEmber, "DrinkBlood", this.bloodForTheBloodGod, "Drink Milk", milk, "Get Egg", egg, "Sex", this.emberSexMenu, "Spar", this.decideToSparEmbra, "", undefined, "", undefined, "Back", this.camp.campFollowers);
        }
        //Approach for sex - initial output when selecting [Sex] menu (Z)
        emberSexMenu(output = true) {
            if (output) {
                this.clearOutput();
                ...
                this.outputText("  ");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3) {
                    this.outputText(this.emberMF("His", "Her") + " cock ");
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0)
                        this.outputText("is poking out of " + this.emberMF("his", "her") + " slit");
                    else
                        this.outputText("is starting to swell with blood");
                    this.outputText(".  ");
                }
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                    this.outputText("You can see tiny rivulets of moisture starting to run down Ember's inner thighs as they rub together, barely hiding her precious treasure from your hungry eyes.  ");
        ...
        findEmbersEgg() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_FOUND_EMBERS_EGG] == 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_FOUND_EMBERS_EGG]++;
        ...
        destroyBabyEmberYouMonster() {
            ...
            this.flags[kFLAGS_1.kFLAGS.EGG_BROKEN] = 1;
            //[Eat][Leave]
        ...
        takeEmbersEggHomeInADoggieBag() {
            ...
            if (this.player.tallness < 84)
                this.outputText("  Lifting it isn't as much of a problem as you thought; it's surprisingly light.  It is, however, very big and very awkward to carry.");
            else
                this.outputText("  Between the egg's surprising lightness, and your own size and wide arms, you can easily carry the egg.");
            ...
            this.flags[kFLAGS_1.kFLAGS.TOOK_EMBER_EGG] = 1;
            this.flags[kFLAGS_1.kFLAGS.EMBER_COR] = 50;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Modified Camp Description (Z)
        emberCampDesc() {
            //Iz Ember an egg?
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_HATCHED] == 0)
                this.outputText("\nThat mysterious egg that you brought back to the camp is sitting in the crude nest you made.\n");
            //NOT AN EGG! HAHA!
            else {
                var choice = EmberScene.rand(3);
                if (choice == 0)
                    this.outputText("Ember is lying in front of " + this.emberMF("his", "her") + " excavated den, watching the camp and resting.  Every once in a while " + this.emberMF("his", "her") + " eyes dart in your direction, before " + this.emberMF("he", "she") + " quickly looks away.\n\n");
                else if (choice == 1)
                    this.outputText("Ember doesn't seem to be around " + this.emberMF("his", "her") + " excavated den... it doesn't take long before Ember lands in front of it and then takes off again, apparently occupied with darting around in the sky for fun.\n\n");
                else
                    this.outputText("Ember appears to be fighting to stay awake; sometimes " + this.emberMF("he", "she") + " falls into a doze, but quickly snaps back to consciousness.\n\n");
            }
        }
        ...
        emberEggInteraction() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_COR] <= 25) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.EMBER_COR] <= 75) {
            ...
            //(If the egg Corruption level is 75-100, aka \"<i>Corrupt</i>\")
                ...
                if (this.player.gender == 0)
                    this.outputText("cum, if you had any... ");
                else {
                    if (this.player.hasCock())
                        this.outputText("white ");
                    else
                        this.outputText("glistening girl-");
                    this.outputText("cum... ");
                }
            ...
            if (this.player.lust >= 33 && (this.flags[kFLAGS_1.kFLAGS.EMBER_EGG_FLUID_COUNT] < 5 || this.flags[kFLAGS_1.kFLAGS.EMBER_JACKED_ON] == 0)) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_EGG_FLUID_COUNT] == 4) {
            ...
            var hair = undefined;
            if (this.player.hasItem(this.consumables.EXTSERM))
            ...
            var hatch = undefined;
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_EGG_FLUID_COUNT] >= 5 && this.flags[kFLAGS_1.kFLAGS.EMBER_JACKED_ON] > 0 && this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] > 0) {
                hatch = this.hatchZeMuzzles;
                this.outputText("\n\n<b>The egg is ready to be hatched - if you're just as ready.</b>");
            }
            if (hatch != undefined)
                this.choices("Hatch", hatch, "Blood", this.giveEmberBludSausages, "IncubiDraft", draft, "Pure Draft", pDraft, "Succubi Milk", milk, "Pure Milk", pMilk, "Hair Serum", hair, "Ovi Elixir", ovi, "Lactaid", lactaid, "Back", this.leaveWithoutUsingAnEmberItem);
            else if (fap != undefined)
                this.choices("Masturbate", fap, "Blood", this.giveEmberBludSausages, "IncubiDraft", draft, "Pure Draft", pDraft, "Succubi Milk", milk, "Pure Milk", pMilk, "Hair Serum", hair, "Ovi Elixir", ovi, "Lactaid", lactaid, "Back", this.leaveWithoutUsingAnEmberItem);
            else
                this.choices("Hatch", hatch, "Blood", this.giveEmberBludSausages, "IncubiDraft", draft, "Pure Draft", pDraft, "Succubi Milk", milk, "Pure Milk", pMilk, "Hair Serum", hair, "Ovi Elixir", ovi, "Lactaid", lactaid, "Back", this.leaveWithoutUsingAnEmberItem);
        }
        //[= No =]
        ...
        useIncubusDraftOnEmber(purified = false) {
            this.clearOutput();
            if (purified) {
                this.player.consumeItem(this.consumables.P_DRAFT);
                this.flags[kFLAGS_1.kFLAGS.EMBER_COR] -= 10;
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_COR] < 0)
                    this.flags[kFLAGS_1.kFLAGS.EMBER_COR] = 0;
            }
            else {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 0) {
                this.outputText("  The egg's shell slowly changes to a soft, pastel blue.");
                this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] = 1;
            }
            else if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 2) {
                this.outputText("   The egg's shell slowly changes to a lavender hue.");
                this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] = 3;
            }
            this.flags[kFLAGS_1.kFLAGS.EMBER_EGG_FLUID_COUNT]++;
            this.doNext(this.playerMenu);
        }
        //Succubi Milk/Purified Succubi Milk (Z)
        useSuccubiMilkOnEmber(purified = false) {
            this.clearOutput();
            if (purified) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] = 2;
            }
            //If Male:
            else if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1) {
                this.outputText("  The egg's shell slowly changes to a lavender hue.");
                this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] = 3;
            }
            this.flags[kFLAGS_1.kFLAGS.EMBER_EGG_FLUID_COUNT]++;
        ...
        useOviElixerOnEmber() {
            ...
            this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] = 1;
            this.flags[kFLAGS_1.kFLAGS.EMBER_EGG_FLUID_COUNT]++;
            this.doNext(this.playerMenu);
        }
        //Lactaid (Z)
        useLactaidOnEmber() {
            ...
            this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] = 1;
            this.flags[kFLAGS_1.kFLAGS.EMBER_EGG_FLUID_COUNT]++;
            this.doNext(this.playerMenu);
        }
        ...
        hairExtensionSerum() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_HAIR] == 0) {
                this.outputText("a narrow tiger-stripe pattern suddenly develop");
                this.flags[kFLAGS_1.kFLAGS.EMBER_HAIR] = 1;
            }
            else {
                this.outputText("the tiger-stripes multiply");
                this.flags[kFLAGS_1.kFLAGS.EMBER_HAIR] = 2;
            }
        ...
        giveEmberBludSausages() {
            ...
            //[(0 prior),
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0) {
                this.outputText(" but the egg just glows its excitement, as if it wanted still more.");
                this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] = 1;
            }
            else {
                this.outputText(", but nothing does.  How disappointing.");
                this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] = 0;
            }
            this.player.takeDamage(1);
            this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] = 1;
        ...
        masturbateOntoAnEgg() {
            ...
            if (this.player.gender == 1) {
                ...
                if (this.player.cockTotal() <= 2)
                    this.outputText("pumping vigorously.");
                else
                    this.outputText("wrangling all your shafts together into one awkward bouquet of male organs and furiously stroking and squeezing them as best you can manage");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 0) {
            ...
            //Female Version (Z)
                ...
                if (this.player.cockTotal() == 1)
                    ...
                    this.outputText("as many of your cocks as you can manage to grab without falling off");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_EGG_FLUID_COUNT] < 5) {
            ...
            this.flags[kFLAGS_1.kFLAGS.EMBER_JACKED_ON] = 1;
        ...
        hatchZeMuzzles() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 0)
                ...
                this.outputText("blue ");
            else if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 2)
                this.outputText("pink ");
            else
                this.outputText("purple ");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0)
                        this.outputText(", drooling nipples notwithstanding");
                    this.outputText(".");
                }
                //Female Anthro (Z)
                else if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 2) {
            ...
            //Boring version
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_HAIR] > 0)
                        this.outputText(", complete with ");
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_HAIR] > 0)
                        this.outputText("long, feminine locks of hair");
                    this.outputText(", but his maleness is undeniable.  Especially when you spot ");
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] > 0)
                        this.outputText("the slit in his pelvis that disgorges a foot and a half-long inhuman penis");
                    else
                        this.outputText("a foot and a half long human penis that sways between his legs");
                ...
                //Herm Monstergirl (Z)
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] == 0)
                        this.outputText("huge, human prick");
                    else
                        this.outputText("huge inhuman cock hanging from some kind of internal sheath");
        ...
        meetEmberAftermath() {
            ...
            this.flags[kFLAGS_1.kFLAGS.EMBER_HATCHED] = 1;
        ...
        embersAppearance() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1)
                    this.outputText(" not overly muscled.");
                else
                    this.outputText(" feminine.");
                //(Male)
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0)
                        this.outputText(" dribbling breasts,");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_HAIR] == 1) {
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1)
                        this.outputText("  Short ");
                    else
                        this.outputText("  Shoulder-length ");
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.EMBER_HAIR] == 2) {
                ...
                switch (this.pregnancy.event) {
                    case 2:
                        this.outputText("  At the moment there's a slight pudgyness to her golden belly.");
                        break;
                    case 3:
                        this.outputText("  Her golden belly is a little larger and firmer than usual.");
                        break;
                    case 4:
                    case 5:
                        this.outputText("  Her golden belly has grown quite a bit.  Ember often rests her hand on it, especially when she sees you looking at it.");
                        break;
                    case 6:
                        this.outputText("  Her large pregnant belly has forced Ember to change her posture.  It looks like she has a big golden bullseye painted on her stomach.  Ember looks tired but happy.");
                        break;
                    case 7:
                        this.outputText("  Her swollen belly is as large as that of any pregnant woman you can remember from Ingnam and you " + (this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] > 0 ? "can easily make out the egg's outline under her golden skin" : "occasionally see movement as the baby shifts in Ember's womb") + ".");
                        break;
                    case 8:
                    case 9:
                        this.outputText("  Ember's golden belly is stretched taut by the large " + (this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] > 0 ? "egg" : "baby") + " in her womb.  You're sure she'll give birth very soon, there just isn't room for the " + (this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] > 0 ? "egg" : "baby") + " to grow any larger.");
                        break;
                    default:
                }
                //(Ember breast check)
                this.outputText("\n\nSituated upon " + this.emberMF("his", "her") + " chest are a pair of ");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                    this.outputText("F-cup soft, pillowy breasts");
                else
                    this.outputText("flat manly pecs");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                    this.outputText("generous mounds");
                else
                    this.outputText("masculine pectorals");
                this.outputText(".");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 2 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
            ...
            //Dragon-girl Appearance (By Radar) (Z)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1)
                    this.outputText("male");
                else if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 2)
                    this.outputText("female");
                else
                ...
                //Short:
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_HAIR] < 1)
                    this.outputText("is quite short, giving " + this.emberMF("him", "her") + " that definitive " + this.emberMF("masculine", "tomboy") + " look.");
                else
                    this.outputText("drops down to " + this.emberMF("his", "her") + " shoulders, giving " + this.emberMF("him", "her") + " the look of the " + this.emberMF("handsome", "beautiful") + " warriors from your village legends.");
                this.outputText("\n\n" + this.emberMF("His", "Her") + " chest is also human in appearance and houses a pair of ");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                    this.outputText("F-cup breasts that support 0.5 inch nipples and hang heavily; you idly wonder if " + this.emberMF("he", "she") + "'ll develop lower back problems as she spends more time in Mareth");
                else
                    this.outputText("manly pectorals with 0.5 inch nipples");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3) {
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] == 0)
                        this.outputText("  " + this.emberMF("He", "She") + " sports a flaccid penis and a pair of apple-sized balls that sit dangerously exposed to the elements, let alone to naked blades or a heavy blow.  Yet " + this.emberMF("he", "she") + " doesn't seem concerned about that in the least, almost daring anyone to focus on them.  While " + this.emberMF("he", "she") + " isn't aroused right now, Ember's penis can reach a length of approximately 16 inches, and it looks to be about 2 inches thick.");
                    else
                        this.outputText("  " + this.emberMF("He", "She") + " sports what looks like a protective slit of some sort, protecting " + this.emberMF("his", "her") + " dick from the elements as well as stray blows.  You can't see it right now; but you remember it to be about 16 inches long and 2 inches thick.");
                }
                //Ember has a pussy:
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                    this.outputText("  The inviting lips of a human-looking pussy purse between her legs; some moisture seems to have gathered on her labia, giving it a slick look that just begs for attention.");
        ...
        talkToEmber() {
            ...
            if (this.player.isPregnant()) { //Extra check might protect against inappropriate Ember complaints
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_OVI_BITCHED_YET] == 0 && this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS) {
                    this.emberBitchesAboutPCBeingFullOfEggs();
                    this.doNext(this.camp.returnToCampUseOneHour);
                    return;
                }
                if (this.player.pregnancyIncubation < 200 && this.player.pregnancyType != PregnancyStore_1.PregnancyStore.PREGNANCY_EMBER && this.flags[kFLAGS_1.kFLAGS.EMBER_BITCHES_ABOUT_PREGNANT_PC] == 0) {
                    this.manEmberBitchesAboutPCPregnancy();
                    this.doNext(this.camp.returnToCampUseOneHour);
                    return;
                }
                if (this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_EMBER && this.player.pregnancyType < 300 && this.flags[kFLAGS_1.kFLAGS.EMBER_TALKS_TO_PC_ABOUT_PC_MOTHERING_DRAGONS] == 0) {
                    this.emberTalksToPCAboutPCDragoNPregnancy();
                    this.doNext(this.camp.returnToCampUseOneHour);
                    return;
                }
            }
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_PREGNANT_TALK] == 0 && this.pregnancy.event > 1) {
        ...
        talkToEmberAboutDragonzzz() {
            ...
            if (choice == 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 1)
                    this.outputText(", a blush creeping onto " + this.emberMF("his", "her") + " cheeks");
                this.outputText(".");
        ...
        discussExplorationWithEmber() {
            ...
            if (choice == 0) {
                ...
                if (subChoice == 0)
                    this.outputText("imps. Only a few imps, and they seemed very nervous. I'm guessing that whatever naturally lives there is something that they really don't want to get involved with.");
                else if (subChoice == 1)
                    this.outputText("two goblins in the foothills, arguing with each other. One was saying that the other shouldn't go up into the hills, as apparently the minotaurs that live there are too much for an untrained girl like her to take without being split open. The second goblin just laughed at her, called her a 'wimp' and told her that she's going to get herself 'some juicy bull-cock and tasty mino-spooge'. Ugh, disgusting little creatures.");
                else if (subChoice == 2)
                    this.outputText("a pair of muscle-bound bull-men beating on each other with their bare fists. They spent over an hour smashing each other into a bloody pulp, and then the winner promptly started fucking the loser up the ass.  I had seen more than enough by that point, so I left.");
                else if (subChoice == 3)
                    this.outputText("this... creature... that looked kind of like a human woman, but with a big dick where her clit should be.  She was walking around stark naked, 'cept for a bunch of piercings, and leading this bull-man along like a pet by a chain attached to a ring anchored into his cockhead.");
                else if (subChoice == 4)
                    this.outputText("a couple of goblins sharpening scissors on some rocks outside of a cave with a door on it. Weird. Wonder what they could be doing in there?");
                else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.WormsOff) < 0 && EmberScene.rand(2) == 0)
                    this.outputText("a horrible swarm of slimy white worms, clumped together into a mockery of a human form and squelching along.  It managed to latch onto this two-headed dog-creature and... ugh!  The worms started forcing their way into both of its cocks!  I've never seen anything so disgusting!");
                else if (subChoice == 5)
                    this.outputText("this two-headed dog-morph loping around; it spotted an imp, dropped to all fours, then gave chase. Managed to catch the ugly little demon, whereupon it ass-raped it, then ate it.");
            }
            else if (choice == 1) {
                ...
                if (subChoice == 0)
                    this.outputText("a whole tribe of imps, just lounging around in a glade, jerking themselves off or squabbling over food.  Nasty little things, but easily dispatched.");
                else if (subChoice == 1)
                    this.outputText("a  goblin with a huge pregnant belly, laughing to herself and swilling down that ale they brew, slopping it all over herself.  Little hedonists.");
                else if (subChoice == 2)
                    this.outputText("this strange bee-woman creature... she made this, this music that started messing with my head.  I spat a tongue of flames at her and she flew away in fright, luckily.");
                //(If player has impregnated Tamani)
                else if (subChoice == 3 && this.flags[kFLAGS_1.kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] > 0) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                        this.outputText("  You should have more pride than to let some brainless cunt like that have her way with you!");
                }
                //(If player has not yet impregnated Tamani)
                else if (subChoice == 3 && !kGAMECLASS_1.kGAMECLASS.forest.tamaniScene.pregnancy.isPregnant)
                    this.outputText("one goblin being teased by a bunch of pregnant goblins for not being pregnant yet.  She just spat back that she wanted a 'better catch' to be her baby-maker than a mere imp and wandered off.");
                //(If Jojo isn't in the camp & not corrupt)
                else if (EmberScene.rand(2) == 0 && this.monk <= 1 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.PureCampJojo) < 0)
                    this.outputText("this mouse-morph monk, sitting in a glade and meditating. A goblin tried to proposition him; he just gave her a lecture and sent her running away in tears.  When an imp tried to attack him, he crushed its skull with a staff he had.  Not bad moves for such a weedy little thing...");
                else
                    this.outputText("one glade I touched down in to catch myself a nice brace of plump coneys, when all of a sudden this... this thing made out of flailing vines and fruit attacks me.  It went up in a puff of smoke once I torched it, of course.");
            }
            else if (choice == 2) {
                ...
                if (subChoice == 0) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                        this.outputText(" like me");
                    this.outputText(". They were on the beach, fucking each other's brains out.");
                }
                else {
                    //(If Whitney's Farm is not yet in the Places menu)
                    if (EmberScene.rand(3) == 0 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.MetWhitney) <= 1)
                        this.outputText(" a big farm on the shoreline.  I saw some sort of cow-woman tending to fields of peppers, and a dog-woman herding cattle. They looked pretty fat and tasty, too... What?  I meant the cattle, stupid!  And I wouldn't have taken them - it's no fun snatching up livestock.  I prefer to chase down a deer or a wild auroch or something like that.");
                    //(if Fetish Cult is encounterable)
                    else if (EmberScene.rand(3) == 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.FetishOn) >= 0)
                        this.outputText("a pair of humans, arguing about sex.  They both wanted it, but the guy said he wanted to do the 'naughty schoolboy and female teacher' routine, while the girl wanted to do the 'noblewoman and love-servant' routine.  Weird; their clothes kept changing back and forth as they argued.");
                    //(If Beautiful Sword has not been acquired)
                    else if (EmberScene.rand(3) == 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.TookBlessedSword) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.BSwordBroken) < 0)
                        this.outputText("a sword jammed into a tree.  Weird; what kind of idiot would stick a weapon there like that?  And what kind of weakling wouldn't be able to take it out?");
                    else if (EmberScene.rand(3) == 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) < 0)
                        this.outputText("a smelly rat-man moping around while some weird equipment bubbled and boiled.  I think maybe he was an alchemist.");
                    else
                        this.outputText("a great blob of green goo, sliding along and minding its own business.  I could swear it looked up at me once, and grew a penis... that can't be right, though.");
                }
            }
            else if (choice == 3) {
                ...
                if (subChoice == 0)
                    this.outputText("a woman with four big breasts, squeezing milk out of her tits and into the sand.  I didn't know breasts could hold that much milk!");
                else if (subChoice == 1)
                    this.outputText("a whole tribe of demons, lounging around an oasis.  Would have been too much bother to kick the crap out of them, so I left them alone - well, alright, I did buzz them to make them scatter like scared sheep for fun.");
                //(if player hasn't solved Marcus & Lucia's argument)
                else if (EmberScene.rand(2) == 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.WandererDemon) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.WandererHuman) < 0)
                    this.outputText("a human with balls so big he had to carry them in a wheelbarrow, trundling through the wasteland with a succubus.  They were arguing about whether or not he should become an incubus.");
                else {
                    ...
                    if (this.player.isNaga())
                        this.outputText("She looked a lot like you.");
                    else
                        this.outputText("I've never seen anything like her before.");
                }
            }
            this.outputText("</i>\"");
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        talkToEmberAboutYourself() {
            ...
            if (this.player.str < 50)
                this.outputText("  \"<i>You could use more training; you look pretty weak...</i>\" Ember says, critically.");
            //(If PC Str < 90)
            else if (this.player.str < 90) {
            ...
            //(If PC Tou < 50)
            if (this.player.tou < 50)
                this.outputText("\"<i>I don't know how you could hope to survive out there.  You look like the wind could blow you away.</i>\"");
            //(If PC Tou < 90)
            ...
            //(If PC Int < 50)
            if (this.player.inte < 50)
                this.outputText("\"<i>You're still very naive... anyone or anything could trick you at any time...</i>\"  Ember frowns.");
            //(If PC Int < 90)
            ...
            if (this.player.spe < 50)
                this.outputText("You try to block the pebble, but you're not quick enough.  It hits your belly, not hard enough to hurt.  \"<i>You need to work on your reactions; anything could surprise you out there and you'd be helpless.</i>\"");
            //(If PC Spd < 90)
        ...
        manEmberBitchesAboutPCPregnancy() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.EMBER_BITCHES_ABOUT_PREGNANT_PC] = 1;
            //(Low Affection)
            if (this.emberAffection() <= 25)
                this.outputText("The two of you talk about nothing in particular.  It's light, airy and pointless.  When you finish up, though, you realize something odd; Ember was doing " + this.emberMF("his", "her") + " best all throughout the conversation to avoid looking at your pregnant belly - almost as if " + this.emberMF("he", "she") + " were upset by it?");
            //(Moderate Affection)
            else if (this.emberAffection() < 75)
                this.outputText("Ember stares coldly at your gravid midriff as icebreaker after icebreaker from you falls flat.  You ask what's wrong.  \"<i>Nothing.  Nothing is wrong,</i>\" Ember states, flatly.");
            //(High Affection)
            else
                this.outputText("The expression Ember gives you is very cold.  \"<i>What is the meaning of this!?</i>\" " + this.emberMF("he", "she") + " says, motioning towards your bloated belly.  \"<i>You're supposed to help <b>me</b> breed more dragons; not slut around with trash!</i>\"  Ember blows out an indignant puff of smoke and walks away.");
        }
        //Scene appears when selecting [Talk]
        ...
        emberTalksToPCAboutPCDragoNPregnancy() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.EMBER_TALKS_TO_PC_ABOUT_PC_MOTHERING_DRAGONS] = 1;
            ...
            if (this.player.lib < 40)
                this.outputText("start at this revelation, then ");
        ...
        emberIsPregnantFirstTimeTalkScene() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.EMBER_PREGNANT_TALK] = 1;
            ...
            if (this.player.cor >= 66)
                this.outputText("  You almost choke on those cheesy words; still, she'll never put out for you if you don't butter her up.");
            ...
            if (this.player.cor >= 66)
                this.outputText("  Is she seriously buying this nonsense?  Your smile would be miles wide if you let your lip curl even a bit, so you keep a straight face with due dilligence.");
            ...
            if (this.player.cor < 30)
                this.outputText("  Given her attitude and nature, you know how lucky you are to have someone like her want to be your mate.");
        ...
        emberBitchesAboutPCBeingFullOfEggs() {
            ...
            this.flags[kFLAGS_1.kFLAGS.EMBER_OVI_BITCHED_YET] = 1;
        }
        ...
        emberBitchesAtYouAboutLustiness() {
            ...
            if (this.player.hasVagina())
                this.outputText("your " + this.vaginaDescript() + " slick and wet with moisture, ready to fuck");
        ...
        minotaurJizzFreakout() {
            ...
            this.flags[kFLAGS_1.kFLAGS.EMBER_CURRENTLY_FREAKING_ABOUT_MINOCUM] = 1;
            this.outputText("\n");
        }
        //Scene
        ...
        emberGetOverFreakingOutAboutMinoJizz() {
            this.flags[kFLAGS_1.kFLAGS.EMBER_CURRENTLY_FREAKING_ABOUT_MINOCUM] = 0;
            ...
            //(High Affection)
                ...
                //(Male/HermEmber:
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(", especially for sucking cock,");
        ...
        bloodForTheBloodGod() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.DRANK_EMBER_BLOOD_TODAY] == 1 && !this.debug) {
            ...
            //(Medium Affection)
                ...
                if (this.player.cor < 50)
                    this.outputText(", expressing your gratitude; gently, you kiss " + this.emberMF("his", "her") + " fingers, then the cut, letting its cool, iron-tinted tang roll across your lips and tongue.  You carefully lick, trying to avoid causing pain as you drink that which " + this.emberMF("he", "she") + " has so generously offered you.");
                else
                    this.outputText(", quickly drawing it to your mouth and forming a seal around the cut with your lips, anxious to let not a drop escape.");
            ...
            this.flags[kFLAGS_1.kFLAGS.DRANK_EMBER_BLOOD_TODAY] = 1;
            //Medium/high get stat boosts!
            var stat = EmberScene.rand(4);
            if (stat == 0)
                this.dynStats("str", 1);
            else if (stat == 1)
                this.dynStats("tou", 1);
        ...
        emberTFs() {
            ...
            if (changes < changeLimit && this.player.dragonCocks() < this.player.totalCocks() && EmberScene.rand(3) == 0) {
                ...
                while (this.temp > 0) {
                    this.temp--;
                    if (this.player.cocks[this.temp].cockType != CockTypesEnum_1.CockTypesEnum.DRAGON)
                ...
                if (this.player.sens >= 50)
                    this.outputText("however, it's not until you press on your new, sensitive knot that you manage to blow your load and enjoy the last few spasms of pleasure as it finally finishes changing.");
                else
                    this.outputText("but you sternly rein in your hands and tuck them into your armpits as the arousing changes run their course.");
                this.outputText("  <b>You now have a dragon penis.</b>");
                //lose lust if sens>=50, gain lust if else
                this.dynStats("sen", 10, "lus", 10);
                changes++;
                //Apply the TF
                this.player.cocks[select].cockType = CockTypesEnum_1.CockTypesEnum.DRAGON;
                this.player.cocks[select].knotMultiplier = 1.3;
            }
            //Gain Dragon Head
            if (changes < changeLimit && EmberScene.rand(3) == 0 && this.player.faceType != appearanceDefs_1.FACE_DRAGON && this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0) {
                ...
                this.player.faceType = appearanceDefs_1.FACE_DRAGON;
                changes++;
            }
            //-Existing horns become draconic, max of 4, max length of 1'
            if (this.player.hornType != appearanceDefs_1.HORNS_DRACONIC_X4_12_INCH_LONG && changes < changeLimit && EmberScene.rand(5) == 0) {
                //No dragon horns yet.
                if (this.player.hornType != appearanceDefs_1.HORNS_DRACONIC_X2 && this.player.hornType != appearanceDefs_1.HORNS_DRACONIC_X4_12_INCH_LONG) {
                    //Already have horns
                    if (this.player.horns > 0) {
                        //High quantity demon horns
                        if (this.player.hornType == appearanceDefs_1.HORNS_DEMON && this.player.horns > 4) {
                            ...
                            this.player.hornType = appearanceDefs_1.HORNS_DRACONIC_X4_12_INCH_LONG;
                        }
                        else {
                            ...
                            this.player.hornType = appearanceDefs_1.HORNS_DRACONIC_X2;
                ...
                //ALREADY DRAGON
                    ...
                    if (this.player.hornType == appearanceDefs_1.HORNS_DRACONIC_X2) {
            ...
            //Gain Dragon Ears
            if (changes < changeLimit && EmberScene.rand(3) == 0 && this.player.earType != appearanceDefs_1.EARS_DRAGON) {
                this.player.earType = appearanceDefs_1.EARS_DRAGON;
            ...
            //Gain Dragon Tongue
            if (changes < changeLimit && EmberScene.rand(3) == 0 && this.player.tongueType != appearanceDefs_1.TONUGE_DRACONIC) {
                ...
                this.player.tongueType = appearanceDefs_1.TONUGE_DRACONIC;
                changes++;
            ...
            //Gain Dragon Scales
            if (this.player.skinType != appearanceDefs_1.SKIN_TYPE_SCALES && changes < changeLimit && EmberScene.rand(3) == 0) {
                ...
                this.player.skinType = appearanceDefs_1.SKIN_TYPE_SCALES;
                this.player.skinAdj = "";
                this.player.skinDesc = "scales";
                //def bonus of scales
            }
            //Gain Dragon Legs
            if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_DRAGON && changes < changeLimit && EmberScene.rand(3) == 0) {
                //(if drider)
                if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_DRIDER_LOWER_BODY)
                ...
                //(If hoofed legs)
                else if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_HOOFED) {
                ...
                this.player.lowerBody = appearanceDefs_1.LOWER_BODY_TYPE_DRAGON;
                changes++;
            }
            //Gain Dragon Tail
            if (this.player.tailType != appearanceDefs_1.TAIL_TYPE_DRACONIC && changes < changeLimit && EmberScene.rand(3) == 0) {
                //(If no tail)
                ...
                this.player.tailType = appearanceDefs_1.TAIL_TYPE_DRACONIC;
                changes++;
            }
            /*
             ...
             */
            //Grow Dragon Wings
            if (this.player.wingType != appearanceDefs_1.WING_TYPE_DRACONIC_LARGE && changes < changeLimit && EmberScene.rand(3) == 0) {
                if (this.player.wingType == appearanceDefs_1.WING_TYPE_NONE) {
                    ...
                    this.player.wingType = appearanceDefs_1.WING_TYPE_DRACONIC_SMALL;
                    this.player.wingDesc = "small, draconic";
                }
                //(If Small Dragon Wings Present)
                else if (this.player.wingType == appearanceDefs_1.WING_TYPE_DRACONIC_SMALL) {
                    ...
                    this.player.wingType = appearanceDefs_1.WING_TYPE_DRACONIC_LARGE;
                    this.player.wingDesc = "large, draconic";
                }
                else if (this.player.wingType == appearanceDefs_1.WING_TYPE_SHARK_FIN) {
            ...
            if (this.player.dragonScore() >= 4 && changes < changeLimit && this.player.findPerk(PerkLib_1.PerkLib.Dragonfire) < 0) {
                ...
                this.player.createPerk(PerkLib_1.PerkLib.Dragonfire, 0, 0, 0, 0);
                if (this.emberAffection() >= 75)
            ...
            if (this.player.dragonScore() >= 4 && EmberScene.rand(3) == 0 && this.player.gender > 0) {
                ...
                if (this.player.hasCock() && this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2) {
                    this.outputText("filling her womb with your seed and fertilizing her eggs");
                    if (this.player.hasVagina() && this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                        this.outputText(" even while ");
                }
                if (this.player.hasVagina() && (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1))
                    this.outputText("taking that hard, spurting cock inside your own " + this.vaginaDescript(0));
        ...
        emberIsAnEggFactory() {
            ...
            if (this.emberAffection() <= 25) {
                ...
                if (this.player.cor >= 40)
                    this.outputText("or sell it for quick cash ");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] > 0)
                        this.outputText("dragon-dick jutting from its slit,");
                    else
                        this.outputText("veiny, bulbous penis fully");
                ...
                //[(if Ember has a dick)
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(" and her throbbing cock is soft enough to hide");
            ...
            //(Medium Affection)
                ...
                this.outputText("\n\nEmber gasps");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 1)
                    this.outputText(" and her cheeks grow red with embarrassment");
            ...
            //(High Affection)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(", and her cock points you accusingly");
                this.outputText(".");
                ...
                if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                    this.outputText(" and out... and out...");
                this.outputText(" and then lean forward to give her a great, wet, sloppy lick, straight up the center of her pussy");
                //(E.Herm:
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(" not stopping until you have slurped your way to the very tip of her cock");
                ...
                if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                    this.outputText("which is quite far indeed, ");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(" and dribbling down her painfully stiff dick");
                ...
                if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                    this.outputText("  Right at this time, you feel something round and smooth on the tip of your tongue, gently spreading Ember's walls.  Realizing that this can only be her egg, you start trying to worm your long, sinuous tongue between it and her innermost walls, hoping to coax it out of her.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText("  Her cock throbs and pumps out long streams of cum to paint the ground around you two; marking it as your special place.");
                if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
        ...
        dontWatchEmberLayEgg() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(".. it even drips with some kind of off-white fluid.");
        ...
        watchMediumAffectionEmberEggLay() {
            ...
            //(if Ember has a cock:
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(", cock poking straight out");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] > 0)
                this.outputText(" of its hiding place");
            ...
            if (this.player.lib >= 50)
                this.outputText(" she doesn't ask you to, beaming a salacious grin");
            this.outputText(".");
            ...
            if (this.player.gender > 0) {
                ...
                if (this.player.hasVagina())
                    this.outputText("wetness gathering in your own pussy");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(" and caressing her throbbing cock");
            this.outputText(".");
            this.outputText("\n\nWith a deep moan, Ember shakes and orgasms.");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("  Ropes of jism spew out of her cock, arching into the air to hit the ground nearby.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(" and her cock hanging out");
        ...
        getMilkFromEmber() {
            ...
            if (this.emberAffection() <= 25) {
                ...
                //noEmberkids:
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_EGGS] == 0 && this.emberChildren() == 0)
                    this.outputText(this.emberMF("he", "she") + " has no offspring to feed them with");
                //(1+ EmberEggs:
                else if (this.flags[kFLAGS_1.kFLAGS.EMBER_EGGS] > 0)
                    this.outputText(this.emberMF("his", "her") + " children haven't hatched yet");
                else
                    this.outputText(this.emberMF("his", "her") + " children don't drink nearly enough to properly empty " + this.emberMF("him", "her") + "), so is " + this.emberMF("he", "she") + " just going to suffer with " + this.emberMF("his", "her") + " breasts so full and aching?");
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DragonBreathCooldown) >= 0) {
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.DragonBreathCooldown);
                ...
                if (EmberScene.rand(2) == 0 && this.player.dragonScore() >= 4 && this.player.gender > 0 && (this.player.gender != this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] || (this.player.gender == 3 && this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3))) {
            ...
            //(High Affection)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] > 0)
                        this.outputText("emerging");
                    else
                        this.outputText("hardening");
                }
                else
                    this.outputText("small beads of moisture gathering on her honeypot");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] > 0)
                        this.outputText(" strangely ridged, almost scaly");
                    this.outputText(" surface");
                }
                else
                    this.outputText("her gently-dripping cunt, sliding in between the lips to stroke the wet interior");
                this.outputText(".");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText("stroke " + this.emberMF("his", "her") + " shaft");
                else
                    this.outputText("probe gently into her slick depths");
        ...
        decideToSparEmbra() {
            ...
            this.startCombat(new Ember_1.Ember());
        }
        beatEmberSpar() {
            this.clearOutput();
            if (this.emberAffection() <= 25) {
        ...
        catchAnal() {
            ...
            if (this.player.balls > 0) {
                ...
                if (this.player.hasVagina())
                    this.outputText(" while... ");
                else
                    this.outputText(".");
            }
            if (this.player.hasVagina())
                this.outputText(" your " + this.clitDescript() + " drips with every passing moment.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] > 0)
                this.outputText("segmented");
            else
                this.outputText("smooth");
            ...
            if (this.player.ass.analLooseness == 0 || this.player.analCapacity() < 25)
                this.outputText(", leaving both of you wincing as the sensitive head of " + this.emberMF("his", "her") + " cock struggles to make room for its insertion.  \"<i>I can't believe you really want me to put it here... you're so tight it almost hurts,</i>\" " + this.emberMF("he", "she") + " whimpers.");
            //(PC has a loose asshole:)
            if (this.player.analCapacity() < 50) {
                this.outputText(", causing you to gasp as " + this.emberMF("his", "her") + " ");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] == 1)
            ...
            //(PC has prick:
            if (this.player.hasCock())
                this.outputText("  You can feel the dragon's member rubbing against your prostate, making " + this.sMultiCockDesc() + " jump to painful erectness, bubble pre-cum, and drool it down the shaft to pool on the ground.");
            //(PC has cunt:
            if (this.player.hasVagina()) {
                this.outputText("  The stimulus is starting to make you wet as well, your [vagina] drooling feminine lubricant ");
                if (this.player.balls > 0)
                    this.outputText("over your [balls]");
                this.outputText(" to puddle underneath you");
                if (this.player.hasCock())
                    this.outputText(", mingling with your pre to form an ever-growing pool of mixed sexual fluids.");
            }
            ...
            //(if PC has balls:
            if (this.player.balls > 0)
                this.outputText("  " + this.emberMF("His", "Her") + " own balls swing into yours, and every time they connect a shrill wave of pleasure flows through you.");
            ...
            this.outputText("\n\nOkay then; ");
            if (this.silly())
                this.outputText("ASSUMING DIRECT CONTROL.");
            else
                this.outputText("time to take control.");
            ...
            if (this.pregnancy.event > 3) {
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] == 0)
                    this.outputText("swollen ");
                else
                    this.outputText("egg-laden ");
            }
            ...
            if (this.player.gender > 0)
                this.outputText(", ");
            if (this.player.hasVagina())
                this.outputText("your cunt gushing feminine lubricant to glaze Ember's belly");
            if (this.player.hasVagina() && this.player.hasCock())
                this.outputText(" and ");
            if (this.player.hasCock()) {
                this.outputText("your cock ");
                if (this.player.cumQ() < 250)
                    this.outputText("spurting gouts of cum onto Ember's upper torso");
                else if (this.player.cumQ() < 1000)
                    this.outputText("raining spunk across the supine dragon");
                else
                    this.outputText("cascading your man-cream across your blissed-out lover until " + this.emberMF("he", "she") + " is completely glazed in a sperm coating");
            }
            this.outputText(".");
            this.outputText("\n\nEmber hugs you close, enjoying the afterglow");
            if (this.player.gender > 0)
                this.outputText(" and rubbing the results of your own orgasm against you");
        ...
        suckEmberCock() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] == 1)
                    this.outputText("his single genital slit");
                else
                    this.outputText("his genitals");
            }
            else {
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] == 1)
                    this.outputText("her twin genital slits");
                else
                    this.outputText("her genitals");
            }
            ...
            if (this.player.hasCock())
                this.outputText("  [EachCock] hardens, spearing aimlessly into the ground in your arousal.");
            if (this.player.hasVagina())
                this.outputText("  Your [vagina] starts to seep with feminine juices, your [clit] hardening in anticipation as your excitement dribbles down onto the thirsty ground.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0)
                ...
                this.outputText("soft-skinned");
            this.outputText(" lower belly");
            if (this.pregnancy.event > 3)
                this.outputText(", though the gravid orb resists you");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3 && (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] > 0)) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(", your tongue wriggling around in " + this.emberMF("his", "her") + " slit");
            ...
            if (this.player.cor < 80)
                ...
                this.outputText("increasingly leery of " + this.emberMF("his", "her") + " batty behavior");
        ...
        stickDickInKnifeDrawer() {
            ...
            if (!this.player.isNaga())
                this.outputText("seat yourself on a conveniently lichen-covered boulder.");
            else
                this.outputText("coil up on your serpentine tail) and start peeling off the clothes on your lower half, exposing [eachCock] to the air and awaiting Ember's response.");
            ...
            if (this.player.cockTotal() > 1) {
                ...
                this.outputText("  " + this.emberMF("He", "She") + " takes your [cock " + y + "] in hand and begins gently stroking it,");
            this.outputText(" sniffing your musk with obvious delight.");
            //(if Ember chose a dragon cock)
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.DRAGON)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0)
                this.outputText(", the scales on " + this.emberMF("his", "her") + " palms producing an indescribable feeling as they slide across your sensitive flesh,");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("  " + this.emberMF("His", "Her") + " shaft is already hard as rock, and sometimes you can feel it poke your " + this.player.feet() + ", smearing small beads of Ember's barely contained pleasure on your " + this.player.skinFurScales() + ".");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                this.outputText("  Looking behind her, you see a small pool of her feminine juices has formed; pheromones fly through the air and hit you like a wave, spurring you on, making you feed Ember more of your delicious pre.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_HAIR] == 0 && this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0)
                this.outputText("scaly pate");
            else
            ...
            if (this.player.cumQ() < 250) {
                ...
                if (!this.player.isTaur())
                    this.outputText("a finger");
                else
                    this.outputText("the thumb of her wing");
            ...
            if (this.player.cor < 75)
                this.outputText(" and chuckle; you know " + this.emberMF("he", "she") + " loves you, really.");
            else
                this.outputText(", folding your arms; " + this.emberMF("his", "her") + " dementia is getting worse...");
        ...
        stickItInEmbersButt() {
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_BUTTFUCKED_EMBER]++;
            ...
            var x = this.player.cockThatFits(this.emberAnalCapacity());
            if (x < 0)
            ...
            //First Time
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_BUTTFUCKED_EMBER] == 1) {
            ...
            this.outputText("\n\nYou ");
            if (this.player.cor < 50)
                this.outputText("promise the dragon you understand, and insist you wouldn't dream of doing otherwise; you want this to be good for " + this.emberMF("him", "her") + ", not to cause " + this.emberMF("him", "her") + " pain.");
            else
                this.outputText("nod.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0)
                this.outputText(", panting with lust");
            else
                this.outputText(", a blush adorning " + this.emberMF("his", "her") + " face");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("Droplets of pre slide along " + this.emberMF("his", "her") + " own shaft and down " + this.emberMF("his", "her") + " balls to gather at your belly.  ");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                this.outputText("Her slick pussy drips rhythmically, wetting your lower body with slick dragon juice.  ");
            ...
            if (this.player.balls > 0)
                ...
                this.outputText("the base of your spine");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(", jet upon jet of spunk arcing over " + this.emberMF("his", "her") + " head to paint the ground below");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                this.outputText("; a veritable gush of juices spews forth from her forgotten love-hole to splash against your lower body and over herself");
        ...
        slurpDraggieCunnies() {
            ...
            if (this.emberAffection() <= 25) {
                ...
                if (!this.silly())
                    this.outputText("with me");
                else
                    this.outputText("on my affection meter");
            ...
            //(Medium Affection)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(" and slowly hardening shaft");
                this.outputText(".");
            }
            //(High Affection)
            else {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("  With Ember's cock jutting out above your head, you can't resist sliding your tongue along the underside of her shaft, just for an extra teasing motion.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] > 0)
                this.outputText("blushing all the while and ");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("  You think droplets of pre are starting to slide down her girl-cock and drip onto your head... but that's part and parcel of loving a herm, so you pay it no attention.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(", heedless of the steady rain of pre dribbling into your " + this.hairDescript() + ".  You're confident she'll crack soon...");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("  Her throbbing shaft, not intending to be left out of the fun, records the event by marking the tree bark with white dragon spooge.");
            ...
            if (this.silly())
                this.outputText("  My meter's not that full!");
            this.outputText("</i>\"");
            ...
            if (this.player.hasCock())
                this.outputText("stiffened shaft");
            if (this.player.gender == 3)
                this.outputText(" and ");
            if (this.player.hasVagina())
                this.outputText("moist cunt");
            if (this.player.gender == 0)
                this.outputText("empty crotch");
        ...
        getEatenOutByEmbra() {
            ...
            if (!this.player.isNaga())
                this.outputText(" with your [legs] spread wide");
            ...
            if (this.player.hasCock())
                this.outputText(", as well as the musk emanating from your drooling cock");
            ...
            if (this.player.hasCock())
                this.outputText(", and pre-cum beginning to bubble out of " + this.sMultiCockDesc());
            ...
            if (this.player.wetness() >= 4)
                this.outputText("spattering");
            else
                this.outputText("drenching");
            this.outputText(" Ember's face with your feminine honey");
            if (this.player.hasCock())
                this.outputText(" even as " + this.sMultiCockDesc() + " belches cum all over the preoccupied dragon");
            this.outputText(".");
            ...
            if (this.player.wetness() >= 4)
                this.outputText("  However, your squirting spatters make this an impossible task.  Ember doesn't seem to care, even as " + this.emberMF("his", "her") + " face is completely covered in femcum.");
        ...
        penetrateEmbrah() {
            ...
            //(High Affection)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3) {
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] == 1)
                        this.outputText(" and her cock peek out of its protective slit");
                    else
                        this.outputText(" and her cock begin hardening");
                }
                this.outputText(" in anticipation.  \"<i>Yeah... maybe... why do you ask?</i>\"");
            }
            //(First Time)
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_PUSSY_FUCK_COUNT] == 0) {
                ...
                if (this.player.cor > 75)
                    this.outputText("  As if bitches like her could qualify as maidens in any but the most literal sense.");
                ...
                if (this.player.cor <= 75)
                    this.outputText("cute... but very troublesome");
                else
                    this.outputText("irritating as hell");
            ...
            this.outputText("\n\nYou ");
            if (this.player.cor < 50)
                this.outputText("hasten to undress yourself for the impatient dragoness, quickly pulling");
            else
                this.outputText("languidly denude yourself, making sure to exaggerate every movement as you pull");
            ...
            if (this.player.cockThatFits(this.emberVaginalCapacity()) == -1) {
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText("It doesn't ");
                else
                    this.outputText("None of them ");
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText("that... that... monster inside me,");
                else
                    this.outputText("any of those... those... monsters inside me,");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("; her own erect cock spurts a small jet of pre");
            this.outputText(".");
            ...
            if (this.player.cumQ() < 250)
                this.outputText("dribble");
            else if (this.player.cumQ() < 1000)
                this.outputText("flow");
            else
                this.outputText("gush");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(", and her cock, while engorged and swollen, hasn't poured forth yet");
            this.outputText(".");
            ...
            if (this.player.cor >= 66) {
                ...
                this.emberAffection(-5);
                this.doNext(this.camp.returnToCampUseOneHour);
                this.flags[kFLAGS_1.kFLAGS.EMBER_PUSSY_FUCK_COUNT]++;
                return;
            }
            //else
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("; her cock jumps and unloads on the ground below, marking this as the spot of your lovemaking");
        ...
        getPenetratedByEmberLastSexSceneWoooo() {
            ...
            //(High Affection)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] > 0 && this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] == 0)
                    this.outputText("to attention");
                else
                    this.outputText("out of its protective slit");
            ...
            if (this.player.tongueType == appearanceDefs_1.TONUGE_HUMAN)
                ...
                this.outputText("your own inhumanly sinuous muscle ");
            ...
            if (this.player.hasCock())
                this.outputText("  As if " + this.emberMF("his", "her") + " hands caressing your cock weren't evidence of that.");
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cumQ() < 250)
                    this.outputText("spatter");
                else if (this.player.cumQ() < 1000)
                    this.outputText("drench");
                else if (this.player.cumQ() < 2000)
                    this.outputText("completely cover");
                else
                    this.outputText("utterly soak");
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.HistoryWhore) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.HistorySlut) >= 0)
                this.outputText("  Using the skills you've honed, you make the muscles in your vagina ripple and wrinkle, teasing the cock caught inside you in a way few women can.");
        ...
        getPenetratedByEmberLastSexSceneWooooPartII() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 || this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] == 1)
                this.outputText("protective slit");
            else
                this.outputText("limp cock and balls");
            ...
            if (this.emberAffection() < 75)
                this.outputText(this.emberMF("his", "her") + " cock was unlike anything else in this world?");
            else
                this.outputText(this.emberMF("he", "she") + " could handle two or even three of you at the same time?");
        ...
        emberRapesYourHeatness() {
            ...
            if (this.player.hasVagina() && this.player.inHeat && (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3))
                this.outputText("your [vagina] aching to be filled and your womb put to its proper purpose");
            else
                this.outputText("[eachCock] burning to be seeding ripe, ready wombs");
            this.outputText(".");
            this.outputText("\n\nEmber responds by ");
            if (this.player.hasVagina() && this.player.inHeat && (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3))
                this.outputText("humping against you, smearing your thigh with dragon pre.");
            else
                this.outputText("tightly pressing her drooling, puffy netherlips on your thighs.");
        ...
        fuckOffEmberIWantANap() {
            ...
            if (this.player.gender == 1 || this.player.gender == 2)
                this.outputText("s");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("protruding prick");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(" and ");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                this.outputText("creaming wet vagina");
            ...
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.EmberFuckCooldown, 12, 0, 0, 0);
            this.doNext(this.playerMenu);
        }
        //[=Accept=]
        timeToPuffTheMagicDragon() {
            ...
            if (this.player.pregnancyIncubation == 0 && !this.pregnancy.isPregnant && this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3 && this.player.gender == 3) {
            ...
            //Female Breeding Scene:
            //PC not pregnant, Ember has dick, PC is in heat.
            else if (this.player.pregnancyIncubation == 0 && (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3) && this.player.inHeat) {
        ...
        getKnockedUpByEmbrahBroBaby() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 && this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] == 0)
                this.outputText("his flat, muscular chest");
            else
                this.outputText(this.emberMF("his", "her") + " soft, squeezable boobs");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] == 0)
                this.outputText("little dragons");
            else
                this.outputText("dragon eggs");
            ...
            if (this.player.hasCock())
                this.outputText(", your neglected [cock] drooling pre-cum that is being smeared all across your belly and " + this.emberMF("his", "hers") + " with every move you make");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] == 0)
                this.outputText("baby dragon");
            else
                this.outputText("dragon egg");
            this.outputText(".  Yawning, you curl up to the dragon for a quick nap of your own.");
            this.player.orgasm();
            this.dynStats("sen", -2);
            //Preg shit goez hurdur
            this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_EMBER, PregnancyStore_1.PregnancyStore.INCUBATION_EMBER, 0); //Will always impregnate unless contraceptives are in use
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.EmberFuckCooldown, 36, 0, 0, 0);
        ...
        breedEmberPregnantAsIfThereWasAnyOtherKindOfBreeding() {
            ...
            this.flags[kFLAGS_1.kFLAGS.EMBER_PUSSY_FUCK_COUNT]++;
            var x = this.player.cockThatFits(this.emberVaginalCapacity());
            if (x < 0)
                x = this.player.smallestCockIndex();
            ...
            if (this.player.balls > 0)
                this.outputText("  She then reaches down lower to rub at your cum filled orbs.");
            if (this.player.hasVagina())
                this.outputText("  The tip of her tail gently teases your slick [vagina] with tiny strokes.");
            ...
            if (this.emberHasCock())
                this.outputText(", her own cock springing up and throbbing with the electric contact.");
            else
                this.outputText(".");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0)
                this.outputText("scale-covered ");
            this.outputText("orbs gently squish ");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0)
                this.outputText("and leak milk ");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0)
                this.outputText("the slowly trickling rivulets of milk along with ");
            ...
            if (this.emberHasCock())
                this.outputText("her cock spurts a few jets of cum onto your [chest]; ");
            ...
            //(If Ember has a dick)
            if (this.emberHasCock())
                this.outputText("  Ember's cock wets the side of the tent with continuous jets of cum, only adding to the already overpowering smell of sex as she empties herself on top of you.");
            ...
            if (this.emberHasCock())
                this.outputText("her spent cock throb; ");
            ...
            if (this.emberHasCock())
                this.outputText("  Little gobs of cum spill from her cock to slide down her shaft and gather on your belly button.");
            ...
            if (this.player.hasVagina())
                this.outputText("your neglected cunt splashing fluid down your [legs] and ");
            ...
            //(Low Cum Amount)
            if (this.player.cumQ() < 250)
                this.outputText("  Though you usually don't cum that much, Ember's contracting walls literally suck the cum out of you; forcing you to give up more than you usually would... something you're quite glad to do!");
            //(Medium Cum Amount)
            else if (this.player.cumQ() < 1000)
                this.outputText("  Your generous helping of cum works its way towards her awaiting womb.  In fact, due to the delicious massage your shaft is receiving from Ember's contracting, almost sucking vaginal walls, you find yourself pumping out even more cum that you would usually have, quickly filling her to the brim and beyond.  It's not until Ember's belly is slightly distended that you stop.");
            //(High Cum Amount)
            else
                this.outputText("  You dump a huge load of jism into Ember's awaiting belly, but her contracting walls seem to milk you for ever more!  Ember is filled to the brim, her belly already slightly distended, but you still continue to fill her with your seed.  Ember's tightly sealed pussy lips means the cum has nowhere to go, so instead it gathers in her womb, distending her belly until she looks at least a few months pregnant; and by the look of pleasure on Ember's panting face, you don't think she minds it.");
            this.outputText("\n\nWith a gasp and a sigh of utter relief, you slump into Ember's arms, collapsing onto her ");
            if (this.emberHasCock())
                this.outputText("cum-slick ");
            this.outputText("belly and laying there to regain your strength, ");
            if (this.emberHasCock())
                this.outputText("dismissive of the spent cock lying sandwiched between you as you start ");
            ...
            this.pregnancy.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, PregnancyStore_1.PregnancyStore.INCUBATION_EMBER);
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.EmberFuckCooldown, 36, 0, 0, 0);
            this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Rut);
            this.player.orgasm();
            this.dynStats("sen", -2);
        ...
        emberBreedingAfterMathWatchOutForRadioactiveFallout(emberPregged = true) {
            this.clearOutput();
            var x = this.player.cockThatFits(this.emberVaginalCapacity());
            if (x < 0)
                x = this.player.smallestCockIndex();
            ...
            this.outputText("\n\nEmber's cheeks ");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0)
                this.outputText(" are probably blushing under " + this.emberMF("his", "her") + " scales.");
            else
            ...
            if (!emberPregged)
                this.outputText("touch your belly");
            else
                this.outputText("point at Ember's belly");
            ...
            if (emberPregged)
                this.outputText("pumped into me...");
            else
                this.outputText("had me pump into you...");
            ...
            this.outputText("\n\nEmber ");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 1)
                this.outputText("blushes");
            else
                this.outputText("frowns");
            ...
            //(if PC now pregnant:
            if (!emberPregged)
                this.outputText("  You touch your belly with a smirk.  Very certain they took indeed...");
            this.doNext(this.playerMenu);
        }
        emberPregUpdate() {
            ...
            switch (this.pregnancy.eventTriggered()) {
                ...
                case 4:
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] > 0) {
                        ...
                        this.outputText("Ember catches you looking" + (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 1 ? " and blushes" : "") + ".  \"<i>W-what is it?</i>\"  You reply merely that she carries a baby bump very well; she looks good pregnant.  \"<i>Oh, uh...  Thanks I guess?</i>\" she replies, looking away and flicking her tongue out nervously.\n");
                    }
                    return true;
                case 5:
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] > 0) {
        ...
        emberGivesBirth() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] == 0) {
                ...
                if (this.emberHasCock()) {
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0 && this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] == 0)
                        this.outputText("  Her human-like cock dangles heavily in front of her pussy, partially erect from the muscular spasms.");
                    else
                        this.outputText("  Her draconic cock has been pushed from its internal sheathe by the pressure, but it's too painful for her to be erect.");
                }
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] > 0)
                    this.outputText("head crowning");
                else
                    this.outputText("tip of the muzzle jutting out");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0)
                    this.outputText("n anthro dragon");
                else
                    this.outputText(" hybrid of human and dragon");
                this.outputText(".  It's a beautiful strong, healthy little ");
                var roll = EmberScene.rand(100);
                if (roll < 40)
                    this.outputText("boy");
                else if (roll < 80)
                    this.outputText("girl");
                else
                    this.outputText("herm");
                this.outputText(".");
                this.outputText("\n\nYou cradle ");
                if (roll < 40)
                    this.outputText("him");
                ...
                if (this.emberChildren() > 1)
                    this.outputText("  Your other draconic offspring quietly peek into the lair, having vacated the place when Ember went into labor.  They smile at the sight of their new sibling, gently slipping in to curl up beside the mother and new child.");
                this.outputText("  With a contented expression on your face, you leave Ember and your ");
                if (this.emberChildren() <= 1)
                    this.outputText("new child");
                else
                    this.outputText("newly expanded draconic brood");
                this.outputText(" to get some rest, leaving the den.\n");
                if (roll < 40)
                    this.flags[kFLAGS_1.kFLAGS.EMBER_CHILDREN_MALES]++;
                else if (roll < 80)
                    this.flags[kFLAGS_1.kFLAGS.EMBER_CHILDREN_FEMALES]++;
                else
                    this.flags[kFLAGS_1.kFLAGS.EMBER_CHILDREN_HERMS]++;
            }
            //Ember Lays Egg
            else {
                ...
                if (this.emberHasCock()) {
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] > 0 && this.flags[kFLAGS_1.kFLAGS.EMBER_INTERNAL_DICK] == 0)
                        this.outputText("  Her human cock dangles heavily in front of her pussy, partially erect from the muscular spasms.");
                    else
                        this.outputText("  Her draconic cock has been pushed from its internal sheathe by the pressure, but it's too painful for her to be erect.");
                }
                this.outputText("\n\nMind racing, you bend your head in close and stick out your tongue, sliding it back in and out of your mouth to get it nice and wet before delivering a long, sloppy lick to her inner walls.  You can taste her, and the strange salty-blood taste of amniotic fluid mingles with her natural lubricants.  It's an unusual taste but not unbearable, and you begin to lick with greater fervor and purpose.  Your intention is to try and drown the pain of her contractions with pleasurable stimulus.  It's a crazy idea, but it makes sense in a place like Mareth.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_EGGS] > 0) {
                    this.outputText(", along with the ");
                    if (this.flags[kFLAGS_1.kFLAGS.EMBER_EGGS] == 1)
                        this.outputText("other");
                    else
                        this.outputText(EmberScene.num2Text(this.flags[kFLAGS_1.kFLAGS.EMBER_EGGS]) + " others");
                }
                ...
                this.flags[kFLAGS_1.kFLAGS.EMBER_EGGS]++;
            }
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.EmberNapping, 12, 0, 0, 0);
        }
        giveBirthToEmberKids() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_OVIPOSITION] == 0) {
                ...
                if (this.player.balls > 0)
                    this.outputText("slowly pushing your [balls]");
                else if (this.player.hasCock())
                    this.outputText("slowly pushing your " + this.multiCockDescriptLight());
                if (this.player.balls > 0 || this.player.hasCock())
                    this.outputText(" out of " + this.emberMF("his", "her") + " way, ");
                ...
                if (this.player.findPerk(PerkLib_1.PerkLib.Masochist) >= 0)
                    this.outputText("deliciously ");
            ...
            //PC Lays Egg
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_EGGS] > 0)
                    this.outputText("s hatch");
                else
                    this.outputText(" hatches");
                this.outputText(", anyway.  The dragon ");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] > 0)
                    this.outputText("blushes and then ");
                this.outputText("scurries away, even as you pull yourself upright and get ready to go about your business.\n");
                this.flags[kFLAGS_1.kFLAGS.EMBER_EGGS]++;
            }
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.EmberNapping, 5, 0, 0, 0);
        ...
        highAffectionEmberLustFuck() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3) {
                ...
                if (this.emberInternalDick())
                    this.outputText("poking out of " + this.emberMF("his", "her") + " protective slit");
                else
                    this.outputText("growing erect");
            }
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(" and");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                this.outputText(" her pussy beginning to drip in excitement");
            this.outputText(".");
            this.outputText("\n\n\"<i>Mmm... now that's a view and a half; just look at you... what a gorgeous " + this.player.mf("man", "girl") + ", with such ");
            if (this.player.cockTotal() == 1)
                this.outputText("a wonderful " + this.cockDescript(0));
            else
                this.outputText(" wonderful cocks");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("stiffness of " + this.emberMF("his", "her") + " cock");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(" and ");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                this.outputText("the slickness of her pussy");
            ...
            //1st time:
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_EMBER_LUSTY_FUCKED] == 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_EMBER_LUSTY_FUCKED]++;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1) {
                ...
                this.outputText("\n\nYour ");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0)
                    this.outputText("she-dragon");
                else
                    this.outputText("dragon-girl");
            ...
            //else if Ember has a pussy and the PC more than one cock:
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(", not to mention the stiffness of her dick");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(", cock dribbling precum onto her belly");
                this.outputText(".");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2 && this.player.cockTotal() > 1)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2) {
                ...
                if (this.player.cockTotal() > 1)
                    this.outputText(" and tight ass");
            }
            else
                this.outputText(" tight ass");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 1 && this.player.cockTotal() > 1)
                this.outputText("s");
            this.outputText(".  The dragon lets out an exultant cry as " + this.emberMF("his", "her") + " cum-slimed ");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1)
                this.outputText("ass squeezes");
            else if (this.player.cockTotal() == 1)
                this.outputText("pussy squeezes");
            else
                this.outputText("holes squeeze");
            this.outputText(" you, milking your ");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1)
                this.outputText("shaft as his cock spurts dragon-seed onto the leaves below him, filling the air with the scent of spunk and matting them into a steaming morass.");
            //{twin shafts} as {her cunt spasms wetly, drenching your lap with fresh femcum} {and/or} {[her] cock spurts dragon-seed onto the leaves below {her}, filling the air with the scent of spunk and matting them into a steaming morass}
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText("shaft as her cunt spasms wetly, drenching your lap with fresh femcum");
                else
                    this.outputText("twin shafts as her cunt spasms wetly, drenching your lap with fresh femcum");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(" and her cock spurts dragon seed onto the leaves below her, filling the air with the scent of spunk and matting them into a steaming morass");
                this.outputText(".");
            }
            ...
            if (this.player.lib >= 50 || this.player.minLust() >= 40) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                    this.outputText("her cunt starting to drip");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(" and ");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(this.emberMF("his", "her") + " cock growing hard again");
            ...
            //Else:
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                    this.outputText("her cunt starts to drip with moisture");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                    this.outputText(" and ");
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1)
                    this.outputText(this.emberMF("his", "her") + " cock begins to grow erect again");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1)
                this.outputText("depths");
            else
                this.outputText("nethers");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2 && this.player.cockTotal() > 1)
                this.outputText(" and depths");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2 && this.player.cockTotal() > 1)
                this.outputText("both of your dicks");
            else
                this.outputText("your dick");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                this.outputText(", moisture drenching the cock buried in her cunt as it slobbers greedily across your burning flesh.");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("  " + this.emberMF("His", "Her") + " cock throbs and pulsates, ripples of arousal giving way to cumvein-bulging jets that shoot from " + this.emberMF("his", "her") + " prick to splatter wetly against the wall.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText(" and ");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                this.outputText("her cunt gushing female ejaculate, almost soaking you with the cascade of feminine fluids and puddling wetly against your [feet]");
            this.outputText(".");
        ...
        noStayingForCuddlesPostLustFuck() {
            this.clearOutput();
            ...
            if (this.player.cor < 50)
                this.outputText("thank her for being so understanding");
            else
                this.outputText("grunt an acknowledgement");
            this.outputText(" and then gather your things before heading off to wash yourself down.");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[=Yes=]
        stayWithEmberAfterLustFuck() {
            this.clearOutput();
            var x = this.player.cockThatFits(this.emberVaginalCapacity());
            if (x < 0)
                x = this.player.smallestCockIndex();
        ...
        frottingWithEmber(clear = true) {
            ...
            if (this.player.gender == 1 && this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] > 0)
                this.outputText(this.emberMF("-boy", "-girl"));
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                this.outputText("  Her moist dragon pussy is not helping the mess in the least.  You can smell her femcum pooling along with her pre.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] >= 2)
                this.outputText("  Her other hand frigs her pussy as she comes down from her orgasm, gushing female juices and leaking some of the cum you've pumped into her earlier.");
            this.outputText("\n\nThe dragon");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] > 0)
                this.outputText(this.emberMF("-boy", "-girl"));
        ...
        penetrateWithEmber(clear = true) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0)
                this.outputText(", milk seeping across your fingers,");
            ...
            if (this.player.tailType > appearanceDefs_1.TAIL_TYPE_NONE)
                this.outputText("the base of your tail, tugging lightly on it and stroking it for a moment, then her hands move on to ");
            ...
            if (this.player.wingType > appearanceDefs_1.WING_TYPE_NONE)
                this.outputText("stopping momentarily to stroke along your " + this.player.wingDesc + " wings before continuing up and ");
            this.outputText("stopping at the back of your head.");
            this.outputText("\n\nSlowly she guides you towards one of her erect nipples.  \"<i>");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0)
                this.outputText("Drink my milk, I've been saving it up specially for you,");
            else
                this.outputText("I may not have any milk in my breasts right now, but maybe if you keep suckling I'll be able to make you some,");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0)
                this.outputText("  You savor the resultant gush of sweet dragon's milk as it squirts obediently down your throat.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("  A small dollop of pre escapes Ember's dragon-dick at the pleasure of the movement.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0)
                this.outputText("allowing milk to spill into your mouth and gulp down sweet load after load, ");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_MILK] > 0)
                this.outputText(", not even caring that she's tasting her own milk as you finish gulping it down");
            ...
            this.outputText(".");
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3)
                this.outputText("  Her draconic cock throbs all the way through your orgasm, shooting blanks a few times before spurting a couple ropes of pre onto her belly.");
        ...
        emberJizzbangbangEnding() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 1 || this.flags[kFLAGS_1.kFLAGS.EMBER_GENDER] == 3) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EMBER_ROUNDFACE] == 0)
                    this.outputText("anthro");
                else
                    this.outputText("monster-" + this.emberMF("boy", "girl"));
    ...
    exports.EmberScene = EmberScene;
});
//# sourceMappingURL=EmberScene.js.map