define(["require", "exports", "../../BaseContent", "../../CoC", "../../GlobalFlags/kFLAGS", "../../StatusAffects", "../../PregnancyStore", "./Anemone", "../../Items/Armors/LustyMaidensArmor", "../../PerkLib", "../../Appearance", "../../CockTypesEnum", "../../../../includes/appearanceDefs", "../../ItemType", "../../Items/Weapon", "../../GlobalFlags/kGAMECLASS"], function (require, exports, BaseContent_1, CoC_1, kFLAGS_1, StatusAffects_1, PregnancyStore_1, Anemone_1, LustyMaidensArmor_1, PerkLib_1, Appearance_1, CockTypesEnum_1, appearanceDefs_1, ItemType_1, Weapon_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 02.01.14.
     */
    class AnemoneScene extends BaseContent_1.BaseContent {
        ...
        timeChange() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_KID] > 0) {
                if (this.flags[kFLAGS_1.kFLAGS.KID_ITEM_FIND_HOURS] < 20)
                    this.flags[kFLAGS_1.kFLAGS.KID_ITEM_FIND_HOURS]++;
                if (this.flags[kFLAGS_1.kFLAGS.KID_SITTER] == 0 && this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] >= 5 && this.model.time.hours > 10 && this.model.time.hours < 18 && AnemoneScene.rand(4) == 0) {
                    this.kidABabysitsCows();
                    needNext = true;
                }
                if (this.flags[kFLAGS_1.kFLAGS.KID_SITTER] == 1 && this.model.time.hours > 10 && this.model.time.hours < 18 && AnemoneScene.rand(4) == 0) {
                    this.flags[kFLAGS_1.kFLAGS.KID_SITTER] = 2;
                }
                else if (this.flags[kFLAGS_1.kFLAGS.KID_SITTER] == 2)
                    this.flags[kFLAGS_1.kFLAGS.KID_SITTER] = 1;
            }
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.AnemoneArousal) >= 0) {
                if (this.player.pregnancyIncubation > 1) {
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.AnemoneArousal);
        ...
        mortalAnemoneeeeee() {
            ...
            var anemone = new Anemone_1.Anemone();
        ...
        defeatAnemone() {
            ...
            if (this.monster.HP < 1)
                this.outputText("The anemone's knees buckle and she collapses, planting her hands behind her with a splash.  You stand over her, victorious.\n\n", false);
            //win by lust:
            else
                this.outputText("The anemone slumps down and begins masturbating, stroking her cock furiously.  You think you can detect something like desperation in her opaque eyes.  It doesn't look like she'll trouble you anymore.\n\n", false);
            if (this.player.lust >= 33) {
                this.outputText("You could always have your way with her.  If you do, which parts do you use to do the deed?", false);
                ...
                if (this.player.hasVagina() && this.player.biggestTitSize() >= 4 && this.player.armor instanceof LustyMaidensArmor_1.LustyMaidensArmor)
                    bikiniTits = this.player.armor.lustyMaidenPaizuri;
                this.choices("Your Ass", this.victoryButtholeRape, "Your Cock", cockRape, "Your Vagina", vaginaRape, "Her Butt", anal, "Lay Egg", eggs, "", undefined, "", undefined, "", undefined, "B.Titfuck", bikiniTits, "Leave", this.cleanupAfterCombat);
            }
            else
        ...
        victoryButtholeRape() {
            this.spriteSelect(4);
            this.outputText("", true);
            this.outputText(this.images.showImage("anemone-getanal"), false);
            this.outputText("You look over the anemone in front of you.  Your attention focuses on her blue shaft; those smaller tentacles should have plenty of pleasing venom in them as well.  Stripping off your " + this.player.armorName + ", you approach her and push her backwards.  Her gills slide off her breasts and float at her sides. revealing a pair of cute nipples.  You take the opportunity to stroke the shaft of her penis and rub her vagina a bit, soaking up some venom and making your hands tingle.\n\n", false);
            this.outputText("Quite soon you can hardly stand your own arousal and your lover's cock is nice and hard.  Straddling the anemone, you position your " + this.assholeDescript() + " over her colorful shaft and gradually lower yourself towards it.  The florid crown slips into your hole, delivering the expected shock, and a gasp from behind you is accompanied by the anemone's hands moving to your hips.", false);
            //[butt hymen removal]
            if (!this.player.buttChange(this.monster.cockArea(0), true))
                this.outputText("  ", false);
            this.outputText("Despite your anticipatory stiffening you find yourself trembling and your muscles weakening, but by a superb effort you manage to concentrate and lower yourself gently, savoring the slow crawl of the warmth up your " + this.assholeDescript() + ".  You reach the base of the anemone's short shaft soon, and pause for a minute; looking over your shoulder at the anemone, you notice her biting her lower lip impatiently.  Making a mental note of her cute expression to fuel your imagination, you turn forward and, putting your hands down for support, you begin to rise and fall on her erect penis.\n\n", false);
            this.outputText("With your " + this.assholeDescript() + " heated up from the aphrodisiac already, the friction is enough to warm it to fever pitch.  Over and over you impale yourself on the girl's rod, dragging trails of venom and heat up and down your rectum.", false);
            if (this.player.cockTotal() > 0) {
                this.outputText("  One hand involuntarily moves to your " + this.cockDescript(0) + " and begins stroking, smearing the copious pre-cum forced out by the prostate stimulation over " + this.sMultiCockDesc() + ".", false);
            }
            //[(if vag and nococks)
            else if (this.player.hasVagina()) {
                this.outputText("  You lift one hand up to your " + this.vaginaDescript(0) + " and begin jilling yourself off.  This works to satisfy you for a while, but eventually you want more and grab a brace of tentacles floating in the water beside you, shoving them into your greedy pussy and smearing them around. This provokes a lusty moan from you and a giggle from your lover.", false);
            }
            this.outputText("  As you work your " + this.assholeDescript() + " on the tool, something happens to push your peak closer at a startling pace...\n\n", false);
            this.outputText("Your blue lover, restless now and uncontent to simply lie there anymore, begins to use her own hands and hips to pump in time with you, doubling the pace of the fuck.  The fervid intensity of her strokes doesn't leave any time for the venom to disperse before the next thrust arrives, making it feel as though your " + this.assholeDescript() + " is filled with one huge, hot cock that nevertheless slides in and out even as it remains motionless.  The sensation pushes you to orgasm quickly, your " + this.assholeDescript() + " clamping down on the anemone's penis", false);
            if (this.player.cockTotal() > 0) {
                this.outputText(" as " + this.sMultiCockDesc() + " twitches and ejaculates in a ", false);
                if (this.player.cumQ() < 50)
                    this.outputText("squirt", false);
                else if (this.player.cumQ() < 250)
                    this.outputText("spray", false);
                else
                    this.outputText("torrent", false);
                this.outputText(" of semen", false);
                //[(if vag and cox)
                if (this.player.hasVagina())
                    this.outputText(" and your pussy spasms", false);
            }
            else if (this.player.hasVagina()) {
                this.outputText(" and your " + this.vaginaDescript(0) + " spasms around the tentacles and your fingers", false);
            }
            this.outputText(".  The anemone must have been right on the edge with you, because after a few more thrusts in your hungry asshole she achieves her own climax and shoots several strings of cool, thick semen into you.  You collapse backward against your partner and she idly caresses your " + this.nippleDescript(0) + ".  After several minutes of relaxing in the warm water, you sit up and push yourself off of the anemone's limp penis, which drags a string of semen out of your " + this.assholeDescript() + " and prompts ", false);
            //[(dix)
            if (this.player.totalCocks() > 0 || this.player.gender == 0)
                this.outputText("a ", false);
            else if (this.player.hasVagina())
                this.outputText("another ", false);
            this.outputText(" giggle from the blue girl.  Standing up, you gather your gear and blow her a kiss before you leave.  She darkens in color, her camouflage reflex causing her to 'blush' in discomfort at this display of affection.", false);
        ...
        rapeAnemoneWithDick() {
            ...
            if (this.player.cockThatFits(36) >= 0) {
                ...
                this.outputText("Rubbing yourself through your " + this.player.armorName + ", you look over the anemone; your attention wanders down her torso to the blue slit between her legs", false);
                //[(lust victory)
                if (this.monster.lust > 99)
                    this.outputText(", which she's currently diddling with the hand she's not using to stroke her cock", false);
                this.outputText(".  Unfastening your garments, you stroke " + this.sMultiCockDesc() + " to full hardness and approach her.  The anemone looks up at you, still somewhat befogged; then, as you stand over her, she leans forward and opens her mouth invitingly.\n\n", false);
                this.outputText("You smile at how eager she is for you, but shake your head.  The anemone closes her mouth and looks at you quizzically.  <i>\"No?\"</i> she asks.  Only then does she follow your gaze down to her pussy.  The skin on her face darkens a bit as she realizes your intention... which turns out to be a blush, by the looks of the shy glance she gives you next!  <i>\"Umm.\"</i>  The anemone's fingers", false);
                //[(HP defeat)
                if (this.monster.HP < 1)
                    this.outputText(" move to the lips of her vagina and", false);
                this.outputText(" pull apart her feathery labia, showing a velvety interior.  <i>\"Ok...\"</i> she says haltingly.  You accept the invitation in a hurry, kneeling down and holding onto her hips, then guiding your " + this.cockDescript(x) + " into her.\n\n", false);
                this.outputText("After a moment of savoring the sensation, you push all of the way in, provoking a moan and a widening of the eyes from your partner.  ", false);
                //[(multicox)
                if (this.player.cockTotal() > 1) {
                    ...
                    this.outputText(" rub", false);
                    if (this.player.cockTotal() == 2)
                        this.outputText("s", false);
                    this.outputText(" up against the feelers lining her pussy.  Unexpectedly, they also contain the venomous nematocysts of her tentacles and in that single stroke " + this.sMultiCockDesc() + " is throbbing hard and squeezing pre-cum all over her groin.  She reaches down and plays with it", false);
                    if (this.player.cockTotal() > 2)
                        this.outputText(", and them,", false);
                    this.outputText(" as you start pumping.  ", false);
                }
                this.outputText("The fuck begins in earnest as you demonstrate all the techniques you know or can imagine; the anemone seems to be more impressed as you go on, cooing and moaning to goad you further while wrapping her hands and hair around your hips for chemical encouragement.  Her small tits bounce a little", false);
                //[(if PC boobs > A)
                if (this.player.biggestTitSize() >= 1)
                    this.outputText(" in time with your own", false);
                this.outputText("; here and there one of the bounces brush her gills away, giving you a tantalizing view of nipple.", false);
                //[(if balls)
                if (this.player.balls > 0)
                    this.outputText("  As your thrusts get faster your " + this.sackDescript() + " starts to slap into the tickly and quite-venomous feelers fringing her pussy, getting hotter and hotter as the aphrodisiac builds in your " + this.ballsDescriptLight() + ".  Your body answers with swelling, causing your sack to feel bigger and tighter with every slap.", false);
                //[(if noballs and clit > 6")
                else if (this.player.clitLength >= 6)
                    this.outputText("  As your thrusts into the blue girl arouse you, your " + this.clitDescript() + " begins to swell with blood.  Pretty soon it's so erect that a particularly violent thrust mashes it into the feelers at the base of her labia, delivering a shock that almost makes you collapse.  The anemone, her reverie interrupted as you temporarily stop pumping, looks down.  Noticing the massive girl-cock sticking out of your " + this.vaginaDescript(0) + ", she reaches between her legs and gives the tip a flick, grinning with sadistic playfulness.  Your eyes cross at that, sending her into a spasm of giggling.  Irritated but aroused by the abuse of your " + this.clitDescript() + ", you move your thumb over her own tiny blue button and begin flicking it in revenge as you renew your pumping.", false);
                this.outputText("\n\n", false);
                this.outputText("The anemone's eyes roll back in her head as she reaches her climax first, hips shaking and penis squirting a glob of semen that drools down the side.  ", false);
                //[(Flexibility cat perk)
                if (this.player.findPerk(PerkLib_1.PerkLib.Flexibility) >= 0)
                    this.outputText("You lean down and take the anemone's cock in your own mouth as she continues orgasming, swallowing the cool, slippery jism -- it tastes not salty and fishy as you'd hoped but somewhat faintly like algae.  The anemone, recovering her wits a bit, looks at you blankly, as though she can't fathom why anyone would want to drink <i>her</i> ejaculate instead of the other way around.  Your eyes twinkle mirthfully in response as you suck and swallow the last of her jizz.  ", false);
                this.outputText("Your own orgasm takes a bit longer, but the convulsing walls of her pussy do their best to help you arrive and the feelers along her labia writhe against your " + this.multiCockDescriptLight() + " in the same tempo, injecting the last of their venom.  With a deep, final thrust, " + this.sMultiCockDesc() + " erupts in her pussy.  ", false);
                //[(big skeet)
                if (this.player.cumQ() > 500) {
                    this.outputText("You continue to pour into her even after her convulsions stop, stretching her belly", false);
                    //[(super skeet)
                    if (this.player.cumQ() > 2000)
                        this.outputText(" to enormous dimensions.  <i>\"Ohh...\"</i> she moans, as her waist distends to over four times its former slender diameter", false);
                    this.outputText(".  She looks ", false);
                    if (this.player.cumQ() < 2000)
                        this.outputText("thoroughly", false);
                    else
                        this.outputText("monstrously", false);
                    this.outputText(" pregnant when you've finished, her little blue dick poking out below a swollen stomach... not a bad look, actually.  You get a little turned on at the idea.  ", false);
                }
                this.outputText("After the last of your cum has been squeezed out, you pull your " + this.cockDescript(0) + " out and rinse it off in the lakewater.  You gather your gear while the anemone holds her belly and smiles placidly, staring into the sky.", false);
            ...
            //Too-big male: -requires cockarea > 36
                ...
                if (this.player.lust > 99)
                    this.outputText(", which she's currently diddling with the hand she's not using to stroke her cock", false);
                this.outputText(".  Unfastening your garments, you stroke " + this.sMultiCockDesc() + " to full hardness and approach her.  The anemone looks up at you, still somewhat befogged; then, as you stand ", false);
                if (this.player.tallness > 48)
                    this.outputText("over", false);
                else
                    this.outputText("before", false);
                this.outputText(" her, her eyes widen as she beholds the sheer amount of cock you have.\n\n", false);
                this.outputText("You smile at how stunned she is by you, and waggle your erect " + this.multiCockDescriptLight() + " from side-to-side.  The anemone obediently watches it swing, like a hypnotist's pendulum; her mouth reflexively opens as all her conscious thought is temporarily sidetracked.  You push on the shaft with one hand and move the tip down relative to her body, watching bemused as the girl tries to keep her mouth in line with it until it goes too low for her neck and snaps her out of her daze.  She closes her mouth and looks at you quizzically.  <i>\"No?\"</i> she asks.  You answer by pushing forward slightly, bumping the head of your " + this.cockDescript(0) + " against her <i>mons pubis</i>.  The skin on her face darkens a bit as she realizes your intention... which turns out to be a blush, by the looks of the shy glance she gives you next!  <i>\"Umm.\"</i>  She gives it a moment of concerned study before her natural instincts take over and the anemone's fingers", false);
                //[(HP defeat)
                if (this.monster.HP < 1)
                    this.outputText(" move to the lips of her vagina and", false);
                this.outputText(" pull apart her feathery labia, showing a velvety interior.  <i>\"Ok...\"</i> she says, clearly unsure of the wisdom of this.  You motion for her to lay back and lift her pussy as high as possible to reduce the angle, then attempt to guide your " + this.cockDescript(0) + " into her.", false);
                //[(PC height > 7' and non-centaur)
                if (this.player.tallness > 84)
                    this.outputText("  Finally, after having gone so far as to kneel down to bring yourself in line, you begin pushing your way in.", false);
                this.outputText("\n\n", false);
                this.outputText("The first few inches are slow going, as you try to stretch the blue girl's roughly human-sized pussy around your superhuman girth.  She sports a worried expression as you struggle to push the crown of your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " in without bending your shaft.  The girl's body proves more elastic than you'd expected, though; with each shove her cunt takes more width without suffering any obvious ill effect.  Eventually you get the head of your " + this.cockDescript(0) + " into her, and you give an experimental thrust to test her depths. You slide surprisingly far into her, your huge " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " making a bump in her pelvis; the anemone has abandoned her worry and is blissfully tweaking her nipples.  Taking the anemone's legs under your arms, you begin pumping at her, savoring the sensation of having at least part of your unwieldy tool inside someone.  Your blue partner gives out cute moans as you fuck her, prompting a grin from you, but most of your attention is focused on maintaining the angle of your " + this.cockDescript(0) + ".  As you focus on the thrusts, you gradually notice the bump sliding further up her pelvis on each push... it's nearly up to her stomach now!  You quickly make up your mind to test her unusual biology, choking up on your grip of her legs and pushing hard with each thrust in.  The anemone is now tracking the progress of the bump representing your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " as intently as you are; as your head pushes up her chest between her breasts she presses them together against the ridge, massaging them against the shaft through her skin.", false);
                //[(cocklength > 60")
                if (this.player.cocks[0].cockLength > 60)
                    this.outputText("  The imagery and the stimulation inspire you to increase your efforts, and you push even harder into her until your " + this.cockDescript(0) + " slides its way into her throat, expanding her slender neck to twice the normal width.  The anemone's mouth gapes open reflexively as if to gag as the pressure forces her head back, but she doesn't stop moaning or rubbing herself against you.  This seems to be as deep as you can get; the tip of your cock is now right up against the base of her chin.", false);
                this.outputText("\n\n", false);
                this.outputText("Inordinately pleased at having gotten your " + this.cockDescript(0) + " so far in, you begin thrusting grandly, alternating huge back-and-forth pumps with hip gyrations that press you against the sides of your partner.  The anemone", false);
                //[(dick > 60")
                if (this.player.cocks[0].cockLength > 60)
                    this.outputText(", despite being unable to look anywhere except over her head thanks to the giant ridge running up the front of her body,", false);
                this.outputText(" has clearly been enjoying the treatment; soon she begins twitching in orgasm and her pussy spasms against the base of your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + ", flicking its venomous feelers into it, as she kneads her breasts in her hands.  Her body attempts to convulse, bending your " + this.cockDescript(0) + " slightly, while her neglected dick gives a little squirt of pearly semen which lands on the raised line in the center of her body and makes a little trail as it rolls down.  The pressure of her twisting and the sensation of her pussy lapping at your shaft with aphrodisiac is enough to send you over the edge as well.  Your " + this.cockDescript(0) + " twitches as you unload into your blue partner", false);
                //[(big skeet)
                if (this.player.cumQ() > 500)
                    this.outputText(" until it puffs out her cheeks", false);
                this.outputText(".", false);
                //[(mega skeet)
                if (this.player.cumQ() > 1500)
                    this.outputText("  Eventually she can't hold in the sheer volume of your ejaculate, and it erupts from her mouth in a white spray.  Spurt after spurt goes into and then out of her, dribbling out of her slack mouth and down her face until her hair is covered with seed.", false);
                this.outputText("  She takes the opportunity to squeeze along the length of your cock, pushing out as much semen as you have to offer as she moans in orgiastic delight at the fluid injection.", false);
                this.outputText("\n\n", false);
                this.outputText("Eventually both you and she are spent and limp, and you draw your " + this.cockDescript(0) + " out of her, making an extended, wet sucking noise.  As you pull up your gear and make your way up the beach, ", false);
                //[(normal/big skeet)
                if (this.player.cumQ() < 500)
                    this.outputText("her hands are still dazedly playing with the space between her breasts where your cock used to rest.", false);
                //[(mega skeet)
                else
                    this.outputText("she continues to sputter and cough up bubbles of your spunk.", false);
                //(pass 1 hour, reset lust to min or min+10 if big or greater skeet)
                this.player.orgasm();
                this.cleanupAfterCombat();
            }
        ...
        rapeAnemoneWithPussy() {
            ...
            this.outputText("As you review your handiwork, the stirrings in your feminine side focus your attention on the anemone's penis.  Those smaller tentacles on it should have plenty of pleasing venom in them as well.  You make up your mind to put them to use for you.\n\n", false);
            this.outputText("The anemone looks vacantly up at you as you approach.  Reaching forward, you take her cock in your hand", false);
            //[(lust victory)
            if (this.monster.lust > 99)
                this.outputText(" after brushing hers aside", false);
            this.outputText(" and begin to fondle the crown, with its slippery tentacles.  As expected, her venom flows into your hand, imparting a sensation of heat that slides up your arm and diffuses into a gentle warmth.  After a few rubs, you lean down and carefully take her penis into your mouth.  It tastes of the lakewater and heats your mouth as it did your hand; ", false);
            //[(HP victory)
            if (this.monster.HP < 1)
                this.outputText("you can feel it harden as ", false);
            this.outputText("you caress it with your tongue before pulling it out and giving it a squeeze.  The blue girl shivers as a drop of pre-cum is forced out.\n\n", false);
            this.outputText("Next, you take the time to strip off your " + this.player.armorName + ", making sure to give a good show; the anemone entertains herself by stroking her erect prick and smearing around the pre-cum, grinning as she watches you.", false);
            //[(breastrow0>C-cup)
            if (this.player.biggestTitSize() > 2)
                this.outputText("  You give special attention to the presentation of your " + this.breastDescript(0) + ", removing your top with tantalizing slowness, letting each breast slip out and hang between you like fruit ripe to be taken, then making sure to rub them seductively to arouse the both of you further.", false);
            //(hipsize=girly or better)
            if (this.player.hipRating > 6)
                this.outputText("  You make good use of your " + this.hipDescript() + ", too, giving a little shimmy to show off your pronounced curves.", false);
            this.outputText("  By the time you're finished, the anemone's crotch glistens with fluid from both her sexes; it's probably as wet as it was when she was underwater.  You lean into the anemone and give her a deep kiss, ", false);
            //[(breast0>C)
            if (this.player.biggestTitSize() > 2)
                this.outputText("making sure to let your " + this.player.allBreastsDescript() + " rub up against hers, ", false);
            this.outputText("then pull apart from her and ", false);
            //[(goddamn centaur)
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                this.outputText("turn away, kneeling down to display your animalistic, musky pussy readily.", false);
            else
                this.outputText("recline back on your " + this.player.legs() + ". Spreading your thighs, you reach down with two fingers and pull apart your " + this.vaginaDescript(0) + " welcomingly; it's the last act in your sexual performance.", false);
            this.outputText("\n\n", false);
            this.outputText("The anemone wastes no time in assessing your intention and crawls forward onto you, returning your kiss with equal passion.  ", false);
            //[(no centaur)
            if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                this.outputText("You take her by the upper arms and pull her on top of you as you lie back in the sun-warmed shallows.  ", false);
            this.outputText("Her hair drapes over you as she lines her penis up with your " + this.vaginaDescript(0) + ", delivering heat to your body, but this is dwarfed by the sensation of her entry as she pushes her cock in for the first time.  ", false);
            this.player.cuntChange(this.monster.cockArea(0), true);
            this.outputText("The penetration combines with the aphrodisiac being injected straight into your hungry pussy to produce a feeling like euphoria.  Unable to focus your thoughts any longer, you allow the anemone to take the lead as she begins pumping into you, coating your labia with a mixture of her pre-cum and your own secretion.  Soon you're moaning lustily with complete disregard for anything except the pleasure between you as your lover ups the pace; ", false);
            //[(biped)
            if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR) {
                this.outputText("as she thrusts hard and fast, her hair whips back and forth over your ", false);
                //[(breasts>manly)
                if (this.player.biggestTitSize() >= 1)
            ...
            //(centaur)
                ...
                this.outputText("as she pushes deeply into your cunt, her hair flies forward past your upper body, brushing along your skin.  On one pass you grab some and use it as a pleasure tool, rubbing it vigorously on your ", false);
                //[(breasts>manly)
                if (this.player.biggestTitSize() >= 1)
                    this.outputText(this.breastDescript(0) + " and ", false);
                this.outputText(this.nippleDescript(0) + "s,", false);
            }
            this.outputText(" spreading heat along your chest to nearly match your vagina's.\n\n", false);
            this.outputText("The overwhelming sensations drive you over the edge and your " + this.vaginaDescript(0) + " contracts hungrily around the heat radiating from the anemone's cock.  As your orgasming pussy ", false);
            //(squirter)
            ...
            this.outputText("wrings her penis, the blue shaft responds enthusiastically; she pushes deeply into you as it begins spasming and squirting its load.  Your partner's mouth hangs open as you squeeze the cum out of her; with all her muscle control taken away, her head hangs limply", false);
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
            ...
            //[(notits)
                ...
                this.outputText(" between your breasts", false);
            ...
            this.outputText("Having scratched your itch, you give her another kiss, catching her by surprise.  She smiles shyly at you as you gather up your clothes, then slips into the water as you start to dress again.", false);
            this.anemonePreg();
        ...
        loseToAnemone() {
            ...
            if (this.player.gender == 0) {
                this.outputText("Shivering, you slump before the anemone and begin trying to remove your " + this.player.armorName + ".  She claps and peals happily, splashing over to you.  Pushing your trembling hands out of the way, she unfastens your garments and pulls them free of you... and then stops.  You look the girl in the face uncomprehendingly and she answers your gaze with a look of equal confusion.  Your head turns to follow her as she looks you up and down and even makes a circle around you, inspecting every inch and chewing her lip anxiously.", false);
                //[(lactating)
                if (this.player.biggestLactation() > 1)
                    this.outputText("  For a moment the examination stops at the dribble of milk leaking from your " + this.nippleDescript(0) + "s.  With one finger she collects a bit and tastes it, only to grimace and stick her tongue out.", false);
                this.outputText("  Back at the front, the anemone motions questioningly toward your ornament-free groin with open palms.  You follow her gesture down to your spartan nethers, then look back up.  Her bottom lip is quivering and -- yes, it looks like water is beginning to well up in her eyes.\n\n", false);
                this.outputText("Hurriedly you begin to compose an explanation for your anatomy, and you get as far as telling her that you have no genitalia thanks to events since your arrival before she bursts into tears.  ", false);
                //[(low cor)
                if (this.player.cor < 33)
                    this.outputText("You reach out instinctively to comfort her, but ", false);
                //(high cor)
                else
                    this.outputText("You smirk, amused by the turnabout, until ", false);
                this.outputText("the anemone lashes out with a slap that knocks the expression off your face and makes your eardrums sing.  <i>\"Dumb!\"</i> she shouts, turning sharply; her tentacles lash past you as she about-faces.  She dives down below the surface and kicks water into your face spitefully as she swims away.  You sputter and rub your jaw a bit, then stand up and walk dizzily back to camp.", false);
            ...
            if (this.player.cockTotal() > 0) {
                this.outputText(this.images.showImage("anemone-male-fuck"), false);
                if (this.player.cockThatFits(36) >= 0) {
                    this.outputText("Shivering, you slump before the anemone and begin trying to remove your " + this.player.armorName + ".  She claps and peals happily, splashing over to you.  Pushing your trembling hands out of the way, she unfastens your garments and pulls them free of you, taking the opportunity to run a hand up your " + this.cockDescript(x) + ".  ", false);
                    if (this.player.cumQ() < 50)
                        this.outputText("A droplet", false);
                    else if (this.player.cumQ() < 250)
                        this.outputText("A squirt", false);
                    else
                        this.outputText("A steady flow", false);
                    this.outputText(" of pre-cum follows up the inside in the wake of her stroke.  She touches her finger to the tip of your sensitive urethra and draws it away, stretching a string of your fluid through the air.  Putting the finger in her mouth, she savors the taste of you; the string manages to transfer to her bottom lip before she breaks it with a flick of her tongue.\n\n", false);
                    this.outputText("She pushes you back on your haunches and leans over your groin.  Her hair-tentacles slither forward over her shoulders and drop", false);
                    //[(normal)
                    if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                        this.outputText(" into your lap,", false);
                    //(shitty taur)
                    else
                        this.outputText(" downwards, onto your hams,", false);
                    this.outputText(" delivering lances of venom into your lower body.  The tingle warms your groin and more pre-cum leaks out of " + this.sMultiCockDesc() + ".  Her eyes lock onto a glistening dollop and she drops down quickly, enfolding the head of your " + this.cockDescript(x) + " in her cool mouth.  Her tongue dances around the crown of your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + ", relieving it of the sticky pre.  Looking ", false);
                    if (this.player.tallness > 48)
                        this.outputText("up", false);
                    else
                        this.outputText("down", false);
                    this.outputText(" at you, you can see a smile in the lines around her eyes even though her mouth is locked around your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + ".  ", false);
                    //[(if dual/multi-cox)
                    if (this.player.cockTotal() > 1) {
                        //[(cock2 doesn't exist)
                        if (this.player.cockTotal() == 2)
                        ...
                        //(cock2 exists)
                            ...
                            this.outputText("The rest of your " + this.multiCockDescriptLight() + " rub", false);
                        this.outputText(" against her cheek, smearing slick wetness on her blue face.", false);
                    }
                    this.outputText("\n\n", false);
                    this.outputText("Her hands come up from the water and push two sheaves of her long, dangling hair into your " + this.multiCockDescriptLight() + ".  Wrapping these bundles of tentacles around your " + this.cockDescript(x) + ", she clasps them in place with one hand and begins sliding them up and down your length.  Your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " begins feeling hotter and hotter from the injections and the friction of her hair, secreting more pre-cum into her obliging mouth.", false);
                    //[(if vag)
                    if (this.player.hasVagina()) {
                        this.outputText("  Her other hand slips", false);
                        if (this.player.vaginalCapacity() < 15)
                            this.outputText(" a few fingers", false);
                        else if (this.player.vaginalCapacity() < 30)
                            this.outputText(" partway", false);
                        else
                            this.outputText(" all the way", false);
                        this.outputText(" into your " + this.vaginaDescript(0) + ", sending a tingle through your lower lips and exposing your clitoris.", false);
                        //[(if clit > 5")
                        if (this.player.clitLength > 5)
                            this.outputText("  Having achieved this, she pulls her hand out and wraps another bundle of tentacles around your " + this.clitDescript() + ", then begins jerking it off in time to her efforts on your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + ".  Your eyes roll back in your head and your mouth gapes involuntarily at the rough stimulation of your swollen chick-stick.", false);
                    }
                    this.outputText("\n\n", false);
                    this.outputText("The heat rubbing on your cock", false);
                    if (this.player.hasVagina())
                        this.outputText(" and clit", false);
                    this.outputText(" quickly gets to you, and the first orgasm begins to work its way up your " + this.multiCockDescriptLight() + ".  Your " + this.cockDescript(x) + " lets fly into the anemone girl's mouth", false);
                    //[(big skeet)
                    if (this.player.cumQ() > 500)
                        this.outputText(", bowing out her cheeks", false);
                    //[(cray-cray skeet)
                    if (this.player.cumQ() > 2000)
                    ...
                    if (this.player.totalCocks() > 1) {
                        ...
                        if (this.player.totalCocks() == 2)
                            this.outputText("your cocks shoot", false);
                        else
                            this.outputText("the rest of your " + this.multiCockDescriptLight() + " shoot", false);
                        this.outputText(" all over her face and hair, ", false);
                        //[(small skeet)
                        if (this.player.cumQ() < 500)
                            this.outputText("drawing a pattern like a musical score on her blue skin", false);
                        //(big skeet)
                        else if (this.player.cumQ() < 2000)
                            this.outputText("painting her skin white as she flinches and shuts her eyes tightly", false);
                        //(cray-cray skeet)
                        else
                            this.outputText("whitewashing her entire upper body and running off until a fan of milky color spreads through the water around you", false);
                    }
                    this.outputText(".  The anemone swallows greedily as she pumps each stroke into her mouth", false);
                    //[(big or > skeet)
                    if (this.player.cumQ() >= 500)
                        this.outputText(", her taut blue belly distending as it fills", false);
                    this.outputText(".\n\n", false);
                    this.outputText("After a grateful moment of rest as the anemone swallows your issue, her hands begin pumping once again.  Oh god!  Your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " quickly returns to erectness under the renewed siege of aphrodisiac", false);
                    //[(multi)
                    if (this.player.cockTotal() > 1) {
                        if (this.player.cockTotal() == 2)
                            this.outputText(" and your other " + this.cockDescript(1) + " follows suit", false);
                        else
                            this.outputText(" and your other pricks follow suit", false);
                    }
                    this.outputText(".  The blue girl continues to stroke your privates with her tentacle hair, flicking your urethra with her tongue, until you've come twice more.  Nor does she display any intention of stopping there, but mercifully you black out and collapse into the water.  Half-frowning, the anemone shrugs and pushes your insensible form up onto the sandy shore.", false);
                ...
                //loss, too-big male (cock > 5" width or > 48" length):
                    ...
                    this.outputText("Shivering, you slump before the anemone and begin trying to remove your " + this.player.armorName + ".  She claps and peals happily, splashing over to you.  Pushing your trembling hands out of the way, she unfastens your garments and begins to pull them free of you, but your " + this.multiCockDescriptLight() + " flops out and bops her in the nose!  As you fumble the rest of the fastenings and finish removing your gear, the blue girl watches mesmerized at the bobbing flesh in front of her, slick pre-cum leaking from the tip", false);
                    //[(big skeet)
                    if (this.player.cumQ() > 500)
                        this.outputText(" in a steady stream", false);
                    this.outputText(".\n\n", false);
                    this.outputText("Almost reverently, she caresses the shaft of your " + this.cockDescript(0) + ", stroking lightly up its enormous length.  She pulls it down to her eye level, inspecting the head from several angles.  Tentatively, she opens her mouth and pulls your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " into it, trying to fit your expansive dickflesh into a hole that even to your lust-crazed mind looks much too small.  Despite her best efforts, she can't get more than the crown past her lips, though the reflexive motions of her tongue poking around and inside the opening make you shiver and push out more pre-cum.  The anemone eventually pops your " + this.cockDescript(0) + " out of her mouth and frowns in frustration.  After a few seconds, she seems to reach a decision.  Moving your shaft out of the way, she walks around behind you.  She places one hand on your ", false);
                    if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                    ...
                    this.outputText(".  As she draws you backwards, you're forced to put your own ", false);
                    if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                        this.outputText("hands ", false);
                    else
                        this.outputText("forelegs knee-", false);
                    this.outputText("down in front of you to keep from falling face-first.  ", false);
                    //[(if non-centaur)
                    if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                        this.outputText("The head of your " + this.cockDescript(0) + " dips into the lukewarm lakewater, sending a tingle down the shaft.  ", false);
                    this.outputText("Behind you, the anemone has taken her blue, tentacled penis into her hand and is stroking it and fondling the tip, forcing her own pre-cum out and smearing it along her length.  Satisfied with its slipperiness, she edges forward until her cock is resting on your " + this.buttDescript() + ".  Drawing her hips back, she lines it up with your " + this.assholeDescript() + ", then thrusts forward while pulling back on your waist.  The wriggly feelers slip past your butthole and light up your insides with her potent venom.", false);
                    this.player.buttChange(this.monster.cockArea(0), true);
                    this.outputText("\n\n", false);
                    this.outputText("Taking a moment to transfer her now-free hand to your other hip, the anemone girl then begins to pump her stiff pecker into your " + this.assholeDescript() + ", pausing after every few strokes to gyrate her hips a bit, massaging your prostate with her feelers and smearing venom into it.  The stimulation brings you to your limit in minutes; your dick twitches spastically", false);
                    //[(if balls)
                    if (this.player.balls > 0)
                        this.outputText(" and your " + this.sackDescript() + " tightens up", false);
                    this.outputText(".  This doesn't escape your blue lover's notice, and she quickly stops pumping.  Left at the edge of orgasm, you panic and look over your shoulder at her.  Judging by her grinning demeanour, she seems to be up to something diabolical.  You stare at her confusedly until you feel a new heat at the base of your " + this.multiCockDescriptLight() + ". Glancing down, you see that her tentacle-hair has wrapped around " + this.sMultiCockDesc() + " and is squeezing tightly!  Pleased with the arrangement, the anemone begins pumping and rubbing your prostate again, spreading new warmth through your " + this.assholeDescript() + ".  Your delayed climax finally arrives, but the <i>de facto</i> cockring", false);
                    if (this.player.cockTotal() > 1)
                        this.outputText("s", false);
                    this.outputText(" prevent");
                    if (this.player.cockTotal() == 1)
                        this.outputText("s");
                    this.outputText(" any semen from escaping!  The sensations swell and fade as your orgasm passes fruitlessly, your blue partner fucking away as merrily as ever.\n\n", false);
                    this.outputText("For nearly an hour the anemone continues her performance, even going so far as to caress your swollen " + this.multiCockDescriptLight() + " with her unoccupied tentacles.  Several more orgasms arrive and desert you without bringing any relief from the pressure on your ", false);
                    //[(if balls)
                    if (this.player.balls > 0)
                        this.outputText(this.ballsDescriptLight() + " and ", false);
                    this.outputText(this.multiCockDescriptLight() + ".  Eventually you get to the point where you can't take it anymore, and when you feel the next orgasm drawing close you straighten up and begin ", false);
                    //[(man)
                    if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                        this.outputText("clawing at your tormentor's tentacles, trying to pry them from " + this.sMultiCockDesc() + " by main force.", false);
                    //(horse)
                    else
                        this.outputText("bucking and stamping the ground, wanting to shake the tentacles loose but unable to reach them with your hands.", false);
                    this.outputText("  Looking a bit irritated that you want to bring her fun to an end, the anemone nevertheless relents and releases her visegrip on your " + this.multiCockDescriptLight() + ".  As the joy of seeing the way to your release cleared overtakes you, the anemone avails herself of your distraction to grab your arms and pull you toward her while pushing your " + this.player.legs() + " out from under you.  The two of you fall backward into the shallow water as " + this.sMultiCockDesc() + " begins unloading its immense backup of semen in a high arc.  The ", false);
                    //[(skeet amount)
                    if (this.player.cumQ() < 500)
                        this.outputText("strings", false);
                    else if (this.player.cumQ() < 2000)
                        this.outputText("streams", false);
                    else
                        this.outputText("gouts", false);
                    this.outputText(" of jism ", false);
                    //[(height <4' and non-horse)
                    if (this.player.tallness < 48 && this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                        this.outputText("fly over your head, and turning behind you, you see the anemone trying to catch them with an open mouth and her tongue out.", false);
                    else if (this.player.tallness < 84 && this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                        this.outputText("catch the air and rain down on both your faces, splashing quietly where they hit water.", false);
                    else {
                        this.outputText(" land right on your", false);
                        //[(if breasts)
                        if (this.player.biggestTitSize() >= 1)
                            this.outputText(" breasts and", false);
                        this.outputText(" face.  You hear the anemone giggling as you flinch from the white shower.", false);
                    }
                    this.outputText("  After several minutes of climax with you shooting more jism than you thought possible and the anemone banging out an accompaniment on your " + this.assholeDescript() + ", you finally begin to wind down.  The anemone, clearly turned on by the impressive amount of ejaculate, unloads her own blue cock into your asshole.  Her semen, lower in temperature than yours, forms a little pocket of cool inside your " + this.buttDescript() + ".  She idly swishes her tentacles in the", false);
                    //[(big skeet)
                    if (this.player.cumQ() >= 500)
                        this.outputText(" semen-colored", false);
                    this.outputText(" water around her as you push out your last load and slip into a doze.\n\n", false);
                    this.outputText("Pushing your inert form off of her dick, she slips out from under you and sits up beside.  ", false);
                    //[(height <4' non-centaur)
                    if (this.player.tallness < 48 && this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                        this.outputText("She looks you over, then bends down and drinks up as much of the semen floating in the water as she can find nearby.", false);
                    else
                        this.outputText("She leans over you and begins licking the semen off your body, not stopping until you're clean (if slightly sticky).", false);
                    this.outputText("  Having fed, she grins mischievously and grabs your " + this.cockDescript(0) + ", then tows your floating body to the shoreline with it.  She rolls you onto the sand and then swims for deep water, vanishing.", false);
            ...
            //loss rape, vaginal (only full females):
                ...
                this.outputText(this.images.showImage("anemone-female-fuck"), false);
                this.outputText("Shivering, you fall to your knees before the anemone and begin trying to remove your " + this.player.armorName + ".  She claps and peals happily, splashing over to you.  Pushing your trembling hands out of the way, she unfastens your garments and pulls them free of you, but her bright expression dims a bit when she sees only your " + this.vaginaDescript(0) + ".", false);
                //[(lactation)
                if (this.player.biggestLactation() > 1)
                    this.outputText("  For a moment it brightens again when she notices the dribble of milk leaking from your " + this.nippleDescript(0) + "s. With one finger she collects a bit and tastes it, only to grimace and stick her tongue out.", false);
                this.outputText("  <i>\"No food...\"</i> she muses, disappointment playing smally over her face.  You look up at her, frowning sympathetically.  She thinks for a minute, staring at your crotch, and then assumes a rakish smile", false);
                if (this.player.tallness < 48)
                    this.outputText(", pulling you upright", false);
                this.outputText(".\n\n", false);
                this.outputText("Sitting down in the shallow water with her face toward yours, she takes your hand and pulls you forward until you're over her lap.  Her long tentacles settle into neat, straight rows and drape down her back and over one eye, giving her a sly, debonair look.  She rolls her gaze down your torso, and her free hand follows in short order as she caresses your", false);
                //[(if breasts)
                if (this.player.biggestTitSize() > 1)
                    this.outputText(" " + this.breastDescript(0) + " and", false);
                this.outputText(" " + this.nippleDescript(0) + "s and drifts down past your navel.  It makes a stop at your vulva, tickling your most sensitive area and causing your " + this.clitDescript() + " to swell with proof of your pleasure.  The hand begins its return trip, delivering one upward stroke to your now-engorged button and shooting a spark up your spine.  It comes to rest on your hip, and the anemone presses you downward, slowly but insistently, until your " + this.vaginaDescript(0) + " comes to rest above her hard, blue shaft.  Two of her longer tentacles reach up from the water and touch themselves to your lower lips, pulling them apart and delivering jolts of aphrodisiac that make your " + this.vaginaDescript(0) + " clench and release convulsively.  Her hand resumes downward pressure, guiding your twitching pussy toward her erect blue shaft; its small tentacles bend upward in the manner of a flower turning to face the sun.  In a breathless moment the head and then the shaft push past the boundary of your open lips, the first intrusion sending home its own venom and tipping you over the teetering precipice of your control.  ", false);
                //[hymen removal]
                this.player.cuntChange(this.monster.cockArea(0), true);
                this.outputText("<i>\"O-oh!\"</i> the anemone exclaims as the intensifying contractions in your orgasming vagina cause the walls to lap at her penis.\n\n", false);
                this.outputText("The anemone releases your hand and transfers hers to your other hip just as the last of your willpower evaporates; you begin bucking your hips up and down her twitching blue shaft, painting the walls of your pussy with her venom like a mad virtuoso.  As the spasms in your " + this.vaginaDescript(0) + " ebb and flow with each new orgasm, the anemone's cool affectation changes to a mask of faltering determination, matching her attempt to hold out as long as possible while your demented pussy does its best to wring her dry.  From the looks on your faces it's unclear now who was intending to ravish whom!  Eventually the poor girl can take no more of it and her pulsing dick, swollen almost an inch more than when it went in with frenzied tentacles whipping this way and that, twitches and unleashes the first jet of her semen.  Her ejaculate is actually colder than your venom-teased cunt by a significant amount, creating a sharply-felt contrast as she shoots several more strings against the walls of your " + this.vaginaDescript(0) + " and the mouth of your womb.  The dichotomy couples with the satisfaction of finally getting what your pussy wanted to trigger the biggest orgasm yet and the gobsmacked anemone's jaw practically falls off her face as your " + this.vaginaDescript(0) + " squeezes faster than ever on her sensitive dick right after her own climax.\n\n", false);
                this.outputText("After several minutes of this final orgasm you fall backwards into the shallow water with a splash and pass out with a look of bliss, floating on a surface made choppy by your hectic ride.  The poor anemone takes a while longer to collect herself, then slowly pulls her limp dick out of your " + this.vaginaDescript(0) + " and tugs you up the beach past the tideline so you won't roll facedown in the water while you're unconscious.  She bends down and kisses you, tracing your " + this.nippleDescript(0) + "; too spent to hold up her hair, it drapes over your prone form as she leans and releases a last shot of her drug to ensure that your dreams will be of her.", false);
                this.anemonePreg();
        ...
        minoCumForAnemonieeeeez() {
            this.spriteSelect(4);
            this.outputText("The initial surprise subsides to wooly-headedness and a feeling of mild arousal as the stingers in her tentacles find exposed flesh.  In panic of drowning you pull free of the ropy mass and backpaddle away from the girl until your " + this.player.feet() + " reassuringly touch the shallows of the lakebed.  As you shake your head to clear the haze, you notice a few of your items have fallen out of your pouches and are floating in the water.  The anemone has picked one in particular up and is examining it; a bottle of minotaur cum.  Her eyes light up in recognition as the fluid sloshes back and forth and she looks beseechingly at you, cradling it next to her cheek.  \"<i>Gimme?</i>\" she asks, trying to look as sweet as possible.\n\n", false);
            //[(PC not addicted)
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.MINOTAUR_CUM_ADDICTION_STATE] == 1) {
                this.outputText("You're still riding high from your last dose; do you want to share your buzz with the girl? It might lead to something fun...", false);
            }
            //(PC addicted but in withdrawal)
            else {
                this.outputText("Oh hell no, you're not going to give that bottle away when you haven't even gotten your own fix yet! You raise your " + this.player.weaponName + " and advance on the girl with a wild look in your eyes. She shivers a bit at your expression and drops the bottle with a splash, then recovers her composure and backs up a few steps. You grab the floating bottle, and the rest of your stuff, quickly.", false);
        ...
        giveMino() {
            ...
            this.outputText("You nod at the girl and she smiles and responds with a very quiet \"<i>Yay.</i>\"  As you pick up the rest of your stuff, she takes the top off of the bottle and chugs it like a champ, without even stopping to breathe.  Her eyes widen a bit as the drug hits her system, then narrow into a heavy-lidded stare.  Dropping the bottle with a splash, she falls to her knees with another.  She looks at you and licks her lips as she begins playing with her nipples. Obviously, she's feelin' good.  ", false);
            //[(lust<30)
            if (this.player.lust < 30) {
                this.outputText("Watching as her fondling devolves into outright masturbation, your own ", false);
                if (this.player.cockTotal() > 0)
                    this.outputText(this.cockDescript(0) + " becomes a little erect", false);
                else if (this.player.hasVagina())
                    this.outputText(this.vaginaDescript(0) + " aches a bit with need", false);
                else
                    this.outputText(this.assholeDescript() + " begins to tingle with want", false);
                this.outputText(".  You shake off the feeling and head back to camp, leaving her to her fun.", false);
            }
            //(lust>30)
            else {
                ...
                this.outputText("As her fondling devolves into genuine masturbation you realize this would be a good opportunity to take care of your own lusts.  If you do, how will you do it?", false);
                var cockRape = undefined;
                var vaginaRape = undefined;
                //Normal male: -requires dick of area < 36
                if (this.player.cockTotal() > 0)
        ...
        anemoneButtPlugginz() {
            ...
            //victory sex choice for males with cock fit 48 or females with clit >7": "her anus"
            //(change "If you do, which of your parts" to "If you do, which part" in pre-sex choice menu)
            this.outputText("Imagining your climax already, you look over the anemone.  Your gaze lingers on her breasts; she sticks them out enticingly, trying to catch your interest");
            if (this.monster.lust > 99)
                this.outputText(" as she plays with herself");
            this.outputText(".  Nice, but not what you're looking for...  ");
            if (!this.player.isTaur()) {
                this.outputText("Opening your [armor] a bit, you stroke ");
                if (this.player.hasCock())
                    this.outputText("[oneCock]");
                else
                    this.outputText("your " + this.vaginaDescript(0));
                this.outputText(" as y");
            }
            else
                this.outputText("Y");
            this.outputText("ou circle around behind her.  The anemone looks over her shoulder at you as you size her up.  There... that's what you wanted to see.  Tilting the girl forward with a hand on her shoulder, you lower yourself to get a better look at her backside.");
            ...
            if (this.player.hasCock() && this.player.cockThatFits(48) >= 0) {
                if (!this.player.isTaur())
                    this.outputText("you fish your [cockFit 48] out of your garments and rub it");
                else
                    this.outputText("you rub your [cockFit 48]");
                this.outputText(" between the smooth blue curves");
            }
            else {
                if (!this.player.isTaur())
                    this.outputText("you finger your pussy");
                else
                    this.outputText("you imagine the tightness of her hole");
                this.outputText(" until your " + this.clitDescript() + " starts to fill with blood and peeks from its hood");
            }
            this.outputText(", prompting a giggle from her");
            if (this.player.hasCock() && this.player.cockThatFits(48) >= 0)
                this.outputText(" as you smear a dribble of pre-cum into the crack of her ass");
            this.outputText(".  Putting her hands down, she tries to angle her rear up to bring you in line with her pussy; you give her a harder smack and force her back down, much to her confusion.  The blue profile appears over her shoulder again, this time with a worried expression.  Squeezing her ass once with open palms, you lean down and plant a kiss on it. A nervous titter issues from the blue girl as you pull open her cheeks.");
            ...
            this.outputText(" already drooping indolently toward the water.  She turns and looks at you out of the corner of her eye, her face a rictus of suspense.");
            this.outputText("\n\n\"<i>Where's the hole?</i>\" you demand, pointing at your own " + this.buttDescript() + " for an example.");
        ...
        anemoneQuoteUnquoteAnal() {
            this.clearOutput();
            var dick = (this.player.cockThatFits(48) >= 0 && this.player.hasCock());
            var x = 0;
            this.outputText(this.images.showImage("anemone-bj"), false);
            if (dick)
                x = this.player.cockThatFits(48);
            this.outputText("You're in the mood for anal and anal you shall have.  ");
            if (!this.player.isTaur()) {
                this.outputText("Ever a purist, you stroke your ");
                if (dick)
                    this.outputText(this.cockDescript(x));
                else
                    this.outputText(this.clitDescript());
                this.outputText(" until it protrudes from the hole in your " + this.player.armorName + ", returned to full erectness.  ");
            }
            this.outputText("The anemone regards you intently as you approach her and ");
            if (!this.player.isTaur())
                this.outputText("seize her head");
            else {
                this.outputText("mount her head");
                if (!dick)
                    this.outputText(", angling your clit forward along your stomach by pinning it against the anemone's forehead");
            }
            this.outputText("; her hair delivers tingles of venom where it brushes your skin even as her own hands dawdle playfully along your " + this.player.skin() + ".  Without another word, you force her head into your groin as you ram your distended ");
            if (!dick)
                this.outputText("chick-");
            this.outputText("prick into her eager face.");
            this.outputText("\n\nHer moist mouth welcomes the rapid advent your ");
            if (dick)
                this.outputText("dick");
            else
                this.outputText("clit");
            this.outputText(" first with surprise, then with relish.  As you slide past her lips, your ");
            if (dick)
                this.outputText("[cockHead " + (x + 1) + "]");
            else
                this.outputText("tip");
            this.outputText(" is embraced by the rippling walls of her throat, already trying to milk you for spunk");
            if (!dick)
                this.outputText(" that won't come");
            this.outputText(".  The tightness seems to adjust to the ");
            if (dick)
                this.outputText("girth of your prick");
            else
                this.outputText("girl-th of your swollen button");
            this.outputText("; the anemone looks up at you with ");
            if (this.player.isTaur())
                this.outputText("unseen ");
            this.outputText("eyes a-twinkle");
            if (this.player.balls > 0) {
                this.outputText(", and her hair reaches forward to caress your [sack], delivering lancets of venom through the thin skin that send your arousal, and your production, into overdrive");
                if (!this.player.hasCock())
                    this.outputText(".  As your [balls] swell with blood and seed, you can't help but groan; there'll be nowhere for the largess to go, and it will be with you until your body reabsorbs it - or you make an outlet");
            }
            this.outputText(".  Your hips take over, thrusting into her brutally and knocking her head back and forth.  Her tentacles fly wildly, brushing all along your stomach and hips as you pound her mouth, leaving little stripes of heat on your " + this.player.skin() + " that seep into your body and only make you want to come even more.");
            ...
            if (dick)
                ...
                this.outputText("clit");
            this.outputText(" suddenly, stroking vigorously even as it smears a burning wave of arousal along your length.  \"<i>F-fuck,</i>\" you moan, pushed beyond your control by the coup.");
            if (dick) {
                this.outputText("  Your [cockFit 48] begins to ejaculate, filling the blue girl's mouth with your seed; she sucks it down greedily, swallowing every drop.");
                if (this.player.cumQ() >= 1000)
                    this.outputText("  You push so much cum into her that her belly actually rounds from the volume, transforming from a sleek, flat midriff into a barely-contained ball of sloshing liquid");
                if (this.player.cumQ() >= 2000)
                    this.outputText("; even when her stomach skin can stretch no further, your body won't stop filling her, and the bulge expands up her esophagus, pushing out her chest and throat until she's full to the brim and rather reminiscent of a big, blue pear");
                if (this.player.cumQ() >= 1000)
                    this.outputText(".");
                ...
                if (this.player.cumQ() >= 1000)
                    this.outputText("bobbing roundly in the water as she tries to make her way from the shallows, ");
                this.outputText("and head back to camp.");
            }
            else {
                this.outputText("  Your clit, packed with nerves, shivers and sets off your orgasm as she strokes, and you bury it into her throat as your head rolls back.  The anemone flinches, unnoticed by you, as your vagina ");
                if (this.player.wetness() < 4)
                    this.outputText("drools its lube along your length.  ");
                else
                    this.outputText("squirts obscenely, coating your length and her face with your female orgasm.  ");
                this.outputText("Your body shivers as near-painful sensations wrack you, engulfed in the anemone's questing passage");
                if (this.player.balls > 0)
                    this.outputText(".  Your lover, hopeful, watches and waits for your testicles to rise into your groin and unload their cargo");
                if (this.player.cockTotal() == 0)
                    this.outputText("; she even tries to push them up herself with her hands, as if that would make your clit produce the semen inside them");
                this.outputText(".");
                if (this.player.hasCock())
                    this.outputText("  Your clit remains unproductive; your male orgasm squirts out uselessly around her head, mingling with the lake water.  The girl's expression upon seeing this is pained, and she tries but fails to get free to follow the arcing white ropes, sending further spasms of pleasure through your sensitive distaff staff.");
                this.outputText("  Eventually your body calms enough to respond to your impulses, and you carefully draw your [clit] out of your lover's throat.");
                this.outputText("\n\n\"<i>No food,</i>\" she whines, pouting.  Negligent and uncaring, you shake your head");
                if (this.player.hasCock())
                    this.outputText(", pointing to the squiggles of your seed floating lazily in the lakewater,");
                this.outputText(" and leave her.");
            }
            //end scene, reset hours since cum and lust, reduce libido and sens a little
            this.player.orgasm();
            this.dynStats("lib", -.5, "sen", -.5);
            this.cleanupAfterCombat();
        }
        //[Hotdog!]
        hotdogTheAnemone() {
            ...
            this.outputText("Well... it's the spirit of the thing that counts, right?  That blue butt still does look pretty tempting.  You force the anemone forward again and squeeze them together; she giggles and tries once more to push her vagina toward you, but you push it down again and jam your ");
            if (dick)
                this.outputText("[cockFit 48]");
            else
                this.outputText("[clit]");
            this.outputText(" between her small, round cheeks, seizing one in each hand and forcing them to sleeve as much of your length as possible.  The girl looks back at you, her face a picture of confusion, but you do not even care.  Her cool ass feels otherworldly as you thrust through it, poking your tip out of the crack and then pulling back again; ");
            if (dick)
                this.outputText("pre-cum");
            else
                this.outputText("your juice");
            this.outputText(" drools onto her at one end of your motion, filling your little canyon of fun with a river of hot lubrication that you smear liberally throughout.");
            this.outputText("\n\n\"<i>Hey,</i>\" you call, \"<i>you could be helping.  Use your tentacles or something.</i>\"");
            this.outputText("\n\nThe anemone, ");
            if (dick)
                this.outputText("excited by the feel and sight of your pre-cum");
            else
                this.outputText("looking almost bored");
            this.outputText(", obliges and snakes several toward you; they stop just inside the range of your furthest stroke, flitting tantalizingly as if begging you to push into them.  Wary at first, you do so and they gently caress ");
            if (dick)
                this.outputText("your [cockHead " + (x + 1) + "]");
            else
                this.outputText("the nerve-packed end of your [clit]");
            this.outputText(", responding almost autonomously to wrap around it.  The grip is not enough to keep you from pulling back out, though, and they relinquish your shaft, leaving the tip covered in a warm lattice of venom that soaks through you.  A shudder wracks you, and you eagerly push in again, sliding first into her cheeks, then down the slick passageway made by your lube, and finally into the body-heating embrace of her tentacles.  As your ");
            if (dick)
                this.outputText("now-throbbing prick");
            else
                this.outputText("swollen, red clit");
            this.outputText(" wicks more of her venom into you, your hips begin to disobey your will, thrusting faster with each dose and pushing the anemone's face into the lakebed; elbows crooked and fingers splayed, she still can't raise her head against the vigor of your onslaught.");
            this.outputText("\n\nBefore you can rub the very skin off your ");
            if (dick)
                this.outputText("cock");
            else
                this.outputText("clit");
            this.outputText(", you come.  Your body shakes and you nearly fall atop your lover; ");
            if (dick) {
                this.outputText("your swollen, painfully hard prick fountains with cum, coating the anemone's back and hair in white.  The venom in your system draws out your orgasm to incredible lengths, and " + this.sMultiCockDesc() + " ejaculates over and over until you feel lightheaded and woozy.");
                if (this.player.cumQ() >= 500)
                    this.outputText("  When you've finished, not a single place on the anemone's backside is still blue; the giddy girl is shoving your semen into her mouth with her tentacles and hands, swallowing almost as much lakewater as jizz.");
            }
            else {
                this.outputText("your pussy clamps down, trying and failing to find something to squeeze and ");
                if (this.player.wetness() < 4)
                    this.outputText("drooling its lube down your thighs.");
                else
                    this.outputText("squirting cum behind you to rain onto your partner's calves and the surface of the lake.");
                this.outputText("  The anemone sighs impatiently as you twitch atop her, waiting for you to finish.");
            }
            ...
            if (dick)
                this.outputText("dares not move from her knees, balancing your freshly-shot load on her back as she tries to push it toward her face with her tentacles.");
            else
                this.outputText("looks indolently at you as you go.");
        ...
        fuckingAssholelessAnemoneeeez() {
            this.clearOutput();
            this.outputText("Dammit all.  Your fun is completely ruined and you're limp as toast in milk now.  You abruptly pull yourself upright, tucking away your goodies.");
        ...
        anemoneGetsLayedByBeePositor() {
            ...
            this.outputText("The tentacles on this girl sing a siren song and beg you to sample their venomous, greedy caresses as you plunge your egg-layer into her... even the small, blue feelers around the ");
            if (this.monster.HP < 1)
                this.outputText("reclining");
            else
                this.outputText("vigorously masturbating");
            this.outputText(" girl's pussy call to you.  Your insectile abdomen pulses as eggs shift, lining up for deposition, and your long, black ovipositor slides out, pulsing in time with your heartbeat.  The idea of having those feelers stroke your strange organ while you unload your pent-up eggs sounds so good that a drop of honey oozes out, filling the air with a sweet scent that makes your");
            if (this.player.antennae > appearanceDefs_1.ANTENNAE_NONE)
                this.outputText(" antennae");
            else
                this.outputText("nose");
            this.outputText(" tingle.  The anemone's eyes light up as your black shaft drools, and she leans forward, catching the nectar on a finger and raising it to her lips.");
            ...
            if (this.silly())
                this.outputText("duck ");
            this.outputText("face,</i>\" you reply.");
            ...
            if (this.player.sens >= 50 || this.player.isTaur()) {
                ...
                if (this.player.hasCock()) {
                    ...
                    if (this.player.totalCocks() == 1)
                        this.outputText("male part erupts");
                    else
                        this.outputText("male parts erupt");
                    this.outputText(" in sympathy, lancing semen over your partner.  Surprisingly, the anemone doesn't even notice, so absorbed is she in experimenting with your modified stinger.");
                }
                //[(Lev3 eggs)
                if (this.player.eggs() > 40) {
                    this.outputText("  Eventually there are so many eggs ");
                    if (this.player.hasCock() && this.player.cumQ() > 1000)
                        this.outputText("and so much cum ");
                    this.outputText("that they begin to collect around her, clumping and layering around her midriff like white, slimy algae on a pier post.");
                }
                this.outputText("  As the last rolls from you, the anemone raises your wilting ovipositor to her lips once again, eagerly drinking the final sweet secretions that fall out in long, slimy strings.");
                this.outputText("\n\n\"<i>Weird,</i>\" she repeats, tugging at the shriveling organ as it tries to recede into your slit.");
                this.outputText("\"<i>Ugh...</i>\" you respond, weak in the [legs].  With a jerk, you pull your abdomen away from her grasp, flinching as her skin rubs your sensitive slit, then turn to leave.  She catches your hand, looking almost concerned.");
                ...
                if (this.player.eggs() < 20)
                    this.outputText("It doesn't take long before you finish, pushing your cargo down her passageway in a neat, orderly line.");
                else {
                    this.outputText("So many come that you can see them under her skin, a myriad of tiny bumps");
                    if (this.player.eggs() >= 40)
                        this.outputText("; these same bumps multiply upward as your long-suffering abdomen pushes out line upon line of eggs, and soon you can feel them pressing back against the tip of your ovipositor.  You squeeze the girl's head in your hands, holding her against the base, and concentrate; slowly, the deposited eggs give way to their siblings, stretching her elastic stomach and chest wide");
                    this.outputText(".");
                }
                ...
                if (this.silly() && this.player.fertilizedEggs() > 1)
                    this.outputText("  You briefly amuse yourself imagining her carrying your eggs to term and having them hatch in her mouth, so that when she talks, she shoots bees.  Nicholas Cage would be proud.");
                this.outputText("  Gathering your things, you " + this.player.mf("laugh", "giggle") + " at her and depart.");
            }
        ...
        spiderOvipositAnAnemone() {
            this.clearOutput();
            this.outputText(this.images.showImage("anemone-egg"), false);
            this.outputText("As the girl's resistance ebbs, ");
            if (this.player.HP < 1)
                this.outputText("eyes unfocused with fatigue");
            else
                this.outputText("two fingers plunging eagerly into her pussy");
            this.outputText(", you advance on her.  Your abdomen bends forward and your egg-laying organ slides out, dripping slime into the water with little 'plit' noises; the girl, fascinated despite the strangeness of it, sits up and creeps forward to touch it.");
            ...
            if (this.player.hasCock())
                ...
                this.outputText(", and the inside of your [armor] dampens with the lube your [vagina] leaves as it clenches around empty air");
            this.outputText("; you have to push yourself to finish working before you can lose yourself to it.  Completing your restraints, you release her tentacles.  They bob behind her in one mass like a long, cute ponytail, and only the ends are free to wiggle.  When she realizes this, her behavior changes dramatically.");
            ...
            if (this.player.cor < 60)
                this.outputText(", even though her adorable and slightly surreal puppy dog eyes implore you otherwise");
            this.outputText(".  \"<i>Let me just finish what I need to do first.</i>\"");
            ...
            if (this.player.gender > 0) {
                ...
                this.outputText("leave");
            this.outputText(" you holding the bag... of eggs, as it were.  Your steel your resolve and stride atop her, pinning the loose, wiggling end of her ponytail harmlessly against your chitinous underside and forcing her hands underneath her by lowering some of your weight onto her back.");
            ...
            this.outputText("\"<i>there is definitely more.</i>\"  The next two eggs slip into her as you speak, sending convulsions through her body.  Her pussy spasms again and enfolds your ovipositor even more tightly; you're ready for the sensation this time, and allow it to resonate through you, forcing out your own wet orgasm.  You hold her face as you unburden yourself");
            if (this.player.hasCock()) {
                this.outputText(" and cover her hair with yet more white strings from your twitching manhood");
                if (this.player.cockTotal() > 1)
                    this.outputText("s");
            }
            //(egg level 3)
            if (this.player.eggs() >= 40)
                this.outputText("; so many eggs pump into her that she gives a little start when her distended belly touches the lukewarm water below");
            this.outputText("... finally you let her go when you're completely empty, pulling your stalk from her with a lewd sucking noise.  A little bit of green goo drools from her pussy as she slumps over on her side, and you make ready to leave her there - bloated and pregnant, with a squiggle of her semen floating in the water next to her.");
        ...
        anemoneKidBirthPtII() {
            ...
            this.outputText("You awake and look skyward to the sun for a hint at the time.  What greets you is more of an eclipse; a shape impedes your view.  As your eyes adjust to the light, it resolves into an upside-down blue-eyed, blue-skinned face wreathed with snubby, shoulder-length tentacles of purple and green hue.  The silence continues as you stare into it, until you move to push yourself off the hard ground.  At the first sign of activity, the head disappears into the water barrel with a sloshing sound.  You push yourself to your " + this.player.feet() + " and look back toward it; the eyes, now right side-up, peek over the rim bashfully atop a set of blue fingers.");
            ...
            if (this.player.tallness > 48)
                this.outputText(" even as the face angles up to maintain eye contact");
            this.outputText(".  Peering into the barrel, you can make out a little, though most of her décolletage is obscured by a pair of gangly knees.  The previously-noted head sits atop a pair of narrow, thin shoulders bearing equally wiry-looking arms.  She raises one hand and gives you a little finger wave.");
        ...
        getRidOfAnemone() {
            ...
            //(set Kidswag to -1)
            this.flags[kFLAGS_1.kFLAGS.ANEMONE_KID] = -1;
        ...
        keepAnemoneKid() {
            this.clearOutput();
            this.spriteSelect(71);
            this.outputText("You frown as you stare into the opaque eyes.  You can't think of any way to get her out of the barrel, short of manhandling her into the wilderness where she'll flourish or expire depending on fate, and you haven't the heart for such endeavors.  Ah... she looks so happy sitting there with her head resting on her hands, too.  Well, worse things could happen - but probably not stranger.");
        ...
        anemoneBarrelDescription() {
            if (this.model.time.hours < 6) //(morning)
                this.outputText("Kid A is sleeping in her barrel right now.");
            else if (this.model.time.hours <= 10)
                this.outputText("Kid A stands next to her barrel, refilling it from one of your waterskins.  A second full skin is slung over her shoulder.  She gives you a grin.\n\n");
            else if (this.flags[kFLAGS_1.kFLAGS.KID_SITTER] > 1)
                this.outputText("Kid A is absent from her barrel right now, dragooned into babysitting again.\n\n");
            else if (this.model.time.hours < 16) //(midday)
                this.outputText("Kid A is deep in her barrel with the lid on top, hiding from the midday sun.\n\n");
            else if (this.model.time.hours < 22) //(night hours)
                this.outputText("Kid A is peeking out of her barrel.  Whenever you make eye contact she breaks into a smile; otherwise she just stares off into the distance, relaxing.\n\n");
            else
                this.outputText("Kid A is here, seated demurely on the rim of her barrel and looking somewhat more purple under the red moon.  She glances slyly at you from time to time.\n\n");
        }
        ...
        approachAnemoneBarrel() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KID_ITEM_FIND_HOURS] >= 16) {
                this.outputText("An item sits next to it, left there by the anemone as a present to you.  Or 'rent', if you choose to think of it that way.  ");
                item = this.getAnemoneItem;
            }
            //[(if Kid A has been given a weapon)
            if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID] != '') {
                this.outputText("She has " + ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID]).longName + " sitting next to it.  ");
                //outputText("Kid A pokes her head out and smiles at you.  What do you need from her?");
                weaponT = "Take Weapon";
                weaponB = this.takeOutOfAnemone;
            }
            //(if babysitting)
            if (this.flags[kFLAGS_1.kFLAGS.KID_SITTER] > 1)
                this.outputText("Kid A is away right now, helping season some of Marble's children.  If you wanted to leave or take an item, she would discover it when she got back.  ");
            else if (this.kidAXP() < 25)
                this.outputText("Kid A sinks below the rim, peering nervously at you.  ");
            else if (this.kidAXP() < 75)
                this.outputText("Kid A pokes her head out and smiles at you.  ");
            else
                this.outputText("Kid A leans her head and shoulders out of the barrel and puts her elbows on the rim, staring unabashedly at you as she rests her chin on her hands.  ");
            this.outputText("What do you need from her?");
            //[(if N.Watch is toggled on)
            if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_WATCH] > 0)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KID_SITTER] <= 1) {
                if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID] != '' && this.player.fatigue <= 90)
                    this.addButton(3, "Tutor", this.tutorAnemoneKid);
                else if (this.player.fatigue > 90)
                    this.outputText("\n\nYou're too tired to tutor Kid A.");
                this.addButton(4, "Watch", this.anemoneWatchToggle);
                this.addButton(8, "Evict", this.evictANemone);
                var sex = false;
                if (this.flags[kFLAGS_1.kFLAGS.HAD_KID_A_DREAM] > 0 && this.flags[kFLAGS_1.kFLAGS.ANEMONE_KID] >= 2) {
                    if (this.kidAXP() >= 40) {
                        if (this.player.lust >= 33) {
                            if (this.player.hasCock()) {
                                if (this.player.cockThatFits(60) >= 0)
                                    sex = true;
                                else
                            ...
                            if (this.player.hasVagina())
                                sex = true;
                            if (sex == true)
                                this.addButton(2, "Sex", this.kidASex, false);
                        }
                        else
        ...
        getAnemoneItem() {
            ...
            if (this.kidAXP() == 0)
                itype = this.consumables.DRYTENT;
                ...
                if (choice == 0)
                    ...
                    itype = this.consumables.IMPFOOD;
                else if (choice == 3)
                    itype = this.consumables.GOB_ALE;
                else if (choice == 4)
                    itype = this.consumables.WETCLTH;
                else if (choice == 5)
                    itype = this.consumables.L_DRAFT;
                else if (choice == 6)
                    itype = this.consumables.W_FRUIT;
                else
                    itype = this.consumables.EQUINUM;
            }
            else if (this.kidAXP() < 75) {
                ...
                if (choice == 0)
                    itype = this.consumables.W__BOOK;
                else if (choice == 1)
                    itype = this.consumables.BEEHONY;
                else if (choice == 2)
                    itype = this.consumables.OVIELIX;
                else if (choice == 3)
                    itype = this.consumables.SHARK_T;
                else if (choice == 4)
                    itype = this.armors.S_SWMWR;
                else if (choice == 5)
                    itype = this.consumables.L_DRAFT;
                if (AnemoneScene.rand(100) == 0)
                    itype = this.consumables.BIMBOLQ;
            }
                ...
                if (choice == 0)
                    itype = this.consumables.MINOBLO;
                else if (choice == 1)
                    itype = this.weapons.L__AXE;
                else if (choice == 2)
                    itype = this.armors.C_CLOTH;
                else if (choice == 3)
                    itype = this.consumables.L_DRAFT;
                else if (choice == 4)
                    itype = this.weapons.L_DAGGR;
                if (AnemoneScene.rand(100) == 0)
                    itype = this.consumables.BROBREW;
            }
            else {
                //T.Shark Tooth/Pink Gossamer/Black Gossamer/Reptilum
                choice = AnemoneScene.rand(4);
                if (choice == 0)
                    itype = this.consumables.TSTOOTH;
                else if (choice == 1)
                    itype = this.consumables.S_GOSSR;
                else if (choice == 2)
                    itype = this.consumables.B_GOSSR;
                else if (choice == 3)
                    itype = this.consumables.REPTLUM;
                if (AnemoneScene.rand(100) == 0)
                    itype = this.consumables.BROBREW;
                if (AnemoneScene.rand(100) == 0)
                    itype = this.consumables.BIMBOLQ;
            ...
            this.flags[kFLAGS_1.kFLAGS.KID_ITEM_FIND_HOURS] = 0;
        }
        //[Give Weapon]
        giveAnemoneWeapon() {
            this.clearOutput();
            ...
            const giveableToAnemone = (item) => {
                return item == this.consumables.W__BOOK || item == this.consumables.B__BOOK || item == this.consumables.W_STICK || item instanceof Weapon_1.Weapon;
            };
            this.menu();
        ...
        placeInAnemone(slot) {
            ...
            this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID] = this.player.itemSlots[slot].itype.id;
        ...
        takeOutOfAnemone() {
            ...
            var itype = ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID]);
            if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_WATCH] > 0) {
                this.outputText("Your anemone daughter will not be able to guard you at night without a weapon.  If you want her to guard, you'll need to give her a new weapon and tell her to watch at night again.  ");
                this.flags[kFLAGS_1.kFLAGS.ANEMONE_WATCH] = 0;
            }
            this.inventory.takeItem(itype, this.playerMenu);
            //(add weapon to inventory, then revert Kidweapon to empty)
            this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID] = '';
        }
        //[N.Watch]
        anemoneWatchToggle() {
            this.clearOutput();
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_WATCH] > 0) {
                this.outputText("You tell Kid A not to worry about guarding at night.  She nods in your direction.");
                this.flags[kFLAGS_1.kFLAGS.ANEMONE_WATCH] = 0;
            }
            else {
                if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID] == '') {
                    ...
                    this.outputText("Kid A smiles and cheers, \"<i>Guard!</i>\"");
                    this.flags[kFLAGS_1.kFLAGS.ANEMONE_WATCH] = 1;
                }
            }
            this.doNext(this.approachAnemoneBarrel);
        }
        ...
        tutorAnemoneKid() {
            ...
            const weaponID = this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID];
            this.outputText("The anemone obediently climbs out of her barrel, ");
            //[(KidXP < 33)]
            if (this.kidAXP() < 33) {
                this.outputText("holding " + ItemType_1.ItemType.lookupItem(weaponID).longName + " protectively across her chest.");
            }
            else
                this.outputText("taking up an attentive stance with " + ItemType_1.ItemType.lookupItem(weaponID).longName + " in her hands.");
            ...
            if (weaponID == this.weapons.PIPE.id ||
                ...
                if (weaponID == this.weapons.PIPE.id)
                    this.outputText("pipe");
                else
                    this.outputText("stick");
            ...
            //[Riding Crop]
                ...
                if (this.player.lib < 50)
                    ...
                    this.outputText("isn't");
                this.outputText(" enough to keep you from thinking dirty thoughts about grabbing her naughty, teasing face and mashing it into your crotch.");
            ...
            //[Whip] or [Succubi's Whip]
                ...
                if (weaponID == this.weapons.SUCWHIP.id)
                    this.outputText("  The demonic enchantment chooses then to activate, and her color deepens as her lust peaks, as does your own.");
            ...
            //[Black Book]
                ...
                if (this.player.hasCock())
                    this.outputText("tighten");
                else if (this.player.hasVagina())
                    this.outputText("dampen");
                else
                    this.outputText("become a hindrance");
            ...
            //[Scarred Blade](NYI)
                ...
                if (this.player.cor <= 70)
                    this.outputText("  The blade's edge flashes toward you as well, when you try to pick it up.  After a few frustrated attempts, it becomes clear that you'll have to abandon it for now.");
            ...
            //[Any new weapon added without text written for it, or any custom item name set by a save editor]
                ...
                this.outputText("\n\nFor the life of her, Kid A can't seem to grasp how to use the " + ItemType_1.ItemType.lookupItem(weaponID).longName + " you've provided her with.  You have to interrupt the practice for explanations so many times that you don't actually get to do any sparring.");
            ...
            if (this.player.HP < 1) {
                ...
                if (weaponID != this.weapons.S_GAUNT.id &&
                    weaponID != this.weapons.H_GAUNT.id)
                    this.outputText("the thump of something hitting the ground and ");
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.PostAnemoneBeatdown, 0, 0, 0, 0);
                return;
            }
            //Sex scenes, post dream
            if (this.flags[kFLAGS_1.kFLAGS.HAD_KID_A_DREAM] > 0 && this.kidAXP() >= 40 && this.player.lust > 99) {
                if (this.kidASex())
                    return;
                //nothing fits
                //if KidXP >= 40 and lust > 99 after tutor and PC has only huge dicks of area >= 60 or hasn't got shit
                    ...
                    if (this.player.hasCock())
                        this.outputText("something too enormous");
                    else
                        this.outputText("nothing useful");
                    this.outputText(" to relieve your burden with, then resumes the search with a hint of desperation.  Finally and after exhaustive prodding, she withdraws her hand and chews her lip in consternation.");
        ...
        kidASex(cont = true) {
            if (!cont) {
                this.clearOutput();
                this.outputText("Smiling lustily at Kid A, you run your hand through her hair, inhaling deep breaths as you allow her venom to affect you more and more.  She blushes, but watches eagerly.  Soon, the tingling lust has you overwhelmed...");
            }
            var x;
            var y;
            //pseudo-virgin vaginal, one time only
            //if KidXP >= 40 and lust > 99 after tutor and PC has wang of area <36 and Kidswag = 2
            if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_KID] == 2 && this.player.hasCock() && this.player.cockThatFits(36) >= 0) {
                x = this.player.cockThatFits(36);
                this.outputText("\n\n");
                this.outputText(this.images.showImage("anemone-kid-male-vagfuck"), false);
                this.outputText("You collapse onto your back, panting your arousal into the dry air.  Shyly at first but with increasing confidence as you fail to react, your daughter slips a hand into your clothes and down to your crotch.  She bites her lip and blushes as her hand reaches the neck of your " + Appearance_1.Appearance.cockNoun(this.player.cocks[x].cockType) + ", then her resolve appears to crystallize as she yanks it free from your " + this.player.armorName + ". At first, nothing happens and your erect cock just bobs through the empty air, but then you feel soft fingertips guiding it and a warm, tight squeeze at the end of your dick.  Raising your head in surprise, you see the anemone has mounted you!  She blushes and looks away at the eye contact, but her mouth opens in a sly grin as she begins to shift her hips, sliding your " + this.cockDescript(x) + " deeper into herself.");
                ...
                //[(big skeet)]
                if (this.player.cumQ() >= 1000)
                    this.outputText("  As you pour into her, the sensation of being stuffed with semen sets off a second orgasm in the quivering girl, and her own prick drools weakly onto your stomach");
                if (this.player.cumQ() >= 2000)
                    this.outputText("; even a second orgasm from your daughter isn't enough to match one of yours in length.  Your magnificently productive " + Appearance_1.Appearance.cockNoun(this.player.cocks[x].cockType) + " fills her until her belly is inflated so far that she can't contain more, and it begins to breach the seal her pussy makes around you, even as tight as it is, to squirt out in lazy globs as you deposit the last of your spunk");
                if (this.player.cumQ() >= 1000)
                    this.outputText(".");
                //[(multi)]
                if (this.player.cockTotal() > 1) {
                    ...
                    if (this.player.cockTotal() > 2)
                        this.outputText("s");
                    this.outputText(" ooze down your [legs], directed there by her weight.");
                }
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_KID] < 3)
                    this.flags[kFLAGS_1.kFLAGS.ANEMONE_KID] = 3;
            ...
            //if KidXP >= 40 and lust > 99 after tutor and PC has wang of area <60, set that cock to x variable, also set biggest cock not yet used to y variable if multicocked
                ...
                if (y >= 0 || this.player.balls > 0 || this.player.hasVagina()) {
                    ...
                    this.outputText(".  Her dextrous digits are emboldened as your head lolls in the dirt, staring skyward, and quickly begin to caress their find.");
                    //[(cock)
                    if (y >= 0) {
                        this.outputText("  Another hand quickly joins the first, stroking the length of your second shaft as it ");
                        if (this.player.cocks[y].cockLength >= 36)
                            this.outputText("towers over her head");
                        else
                            this.outputText("quivers and twitches into her venomous locks");
                        this.outputText(".  Every time it brushes her hair, another jolt shoots to the base of your spine and both of your cocks force out another glob of precum which is quickly slurped up.");
                    }
                    //[(sac)
                    else if (this.player.balls > 0)
                        this.outputText("  One hand cups below your " + this.ballsDescript() + " and lifts them up to her chin, where the other, formerly tracing gentle circles along your shaft, grabs a tentacle from her head and begins to tickle.");
                    //[(vag)
                    else if (this.player.hasVagina()) {
                        this.outputText("  Her fingers part your labia and reveal your " + this.clitDescript() + ", ");
                        if (this.player.clitLength >= 6)
                            this.outputText("working it free as well and allowing her to tease and stroke it, cock-like, with her hands and hair.");
                        else
                            this.outputText("in order to give the sensitive button their attention.");
                        this.outputText("  Her other hand slips into your garments after the first, following it down to your groin and slipping into your pussy to pump back and forth gently.");
                    }
                }
                this.outputText("\n\nHer attentions on your groin reach a peak as ");
                if (this.player.balls > 0)
                    this.outputText("your balls tighten up");
                else
                    this.outputText("your body tenses");
                this.outputText("; seeing this, she dives down onto your shaft, forcing the head past the ginger care of lips and tongue into her welcoming throat.  Her hair drapes all around your groin, touching exposed flesh as she shakes her head and undulates her throat to coax out your climax.  Your body reacts before you can, and your hips thrust up into her face as your ejaculate erupts.");
                //[(if multicock or sac)]
                if (this.player.balls > 0 || y >= 0) {
                    ...
                    if (y >= 0)
                        ...
                        this.outputText(this.sackDescript());
                    this.outputText(" renew their efforts, squeezing out squirts of semen with measured strokes and squeezes.");
                }
                //[(vag)
                else if (this.player.hasVagina()) {
                    this.outputText("  As her eyes twinkle, a hand plunges all the way into your pussy, and your lonely muscles clamp down reflexively on the invader, attempting to wring her fingers.");
                }
                this.outputText("  She swallows greedily as you unload into her throat");
                if (y >= 0)
                    this.outputText(" and onto her hair");
                this.outputText(", the oral contractions squeezing the head of your penis and setting your body to shivering.");
                //[(big cum)
                if (this.player.cumQ() >= 500) {
                    this.outputText("  Squirt after huge squirt disappears into the starveling's esophagus, sliding without fail down into her belly, until ");
                    if (this.player.cumQ() < 1000)
                        this.outputText("your climax is spent.");
                    //(mega skeet)
                    else
                        this.outputText("she can hold no more and it begins to drool from her mouth; still she tries her best to swallow more and more, despite the limits of her body.  Obligingly, you grab her head and hold it to you, venom tingling in your fingertips, as the last half of your orgasm empties into her.  With her face mashed into your crotch and escape cut off, the semen has nowhere to go except down the throat, expanding her taut stomach and pushing her skinny butt into the air as she balloons against your legs.  Her eyes widen and look up at you as the pressure increases, and a hum travels down your prick as she attempts to protest.");
                }
                ...
                if (this.player.cumQ() < 1000)
                    this.outputText("then gets to her feet and returns to her barrel to digest the meal.");
                else
                    this.outputText("but can barely move from the spot thanks to the incredible distension of her belly.  She manages to drag herself over to the barrel with a great shuffling of arms and legs but cannot by any means get into it, and settles for slumping beside it to occasionally sprinkle water on herself while she deflates.");
                ...
                this.player.orgasm();
                if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_KID] == 1)
                    this.flags[kFLAGS_1.kFLAGS.ANEMONE_KID] = 2;
                this.doNext(this.camp.returnToCampUseTwoHours);
                return true;
            }
            //femsex
            //if KidXP >= 40 and lust > 99 after tutor and PC has vag and no cox
                ...
                this.outputText("You collapse onto your back, panting your arousal into the dry air.  Shyly at first but with increasing confidence as you fail to react, your daughter slips a hand into your clothes and down to your crotch.  She stops, vexed, as her fingers find nothing but your " + this.vaginaDescript(0) + ", then appears to reach a decision and pulls down the bottoms of your " + this.player.armorName + ".  Gently, she caresses the labia, eliciting a soft moan from you, then looks up nervously at the sound to check your response.  When you continue staring into the empty sky, she pulls away and you feel hands pushing your legs apart.  Even this isn't enough to stir you from your lust-induced haze, nor is the feeling of having your backside lifted by those same hands.  However, when you feel a persistent, wriggling pressure at the entrance to your inflamed pussy, you begin to return to reality.  Lifting your head to look at the anemone, you see her holding your thighs in the air as she attempts to orient herself to you, utmost concentration lining her features.  She succeeds and slides into you, then looks up to check your face again... and drops your body into her lap as she pulls her hands in front of herself defensively at the sudden scrutiny.");
                this.outputText("\n\nLaughable as her reaction is, the venom now coursing through your " + this.vaginaDescript(0) + " ensures not a giggle escapes you; your hips begin writhing in her lap, trying to find purchase on the blue girl to better pump her shaft for its seed.");
                //[(if pc is loose)
                if (this.player.vaginas[0].vaginalLooseness >= appearanceDefs_1.VAGINA_LOOSENESS_GAPING)
                    this.outputText("  You can barely feel her little shaft in your stretched cunt, but the chemical stimulation from the tentacles stroking your insides goes a long way toward making up for that.");
                this.outputText("  Emboldened, she picks up your legs haltingly, then begins to work herself in and out of your depths.");
                this.outputText("\n\nWith all the grace of a first-timer, the girl clumsily leans down to kiss you, but falls short and can only plant a smooch on your still-clad [chest].  Still, she continues pumping enthusiastically, worry and shame evaporating from her brow as you moan lustily instead of rebuking her temerity.  Pausing to support you with one hand as she spreads your lips wider with her fingers, she exposes your " + this.clitDescript() + " to the air.");
                //[(clitsize<6)]
                if (this.player.clitLength < 6)
                    this.outputText("  The little button gets rubbed by her probing hand even as she resumes thrusting, accelerating your imminent peaking.");
                else if (this.player.clitLength < 36)
                    this.outputText("  The monstrous chick-stick bobs in the air as she pounds you harder; the breeze alone would be enough to arouse you further, but the anemone grabs it and begins jacking the nerve-laden stalk off like a dick, which sends your back into spasms.");
                else
                    this.outputText("  The incredible length of your clitoris is such that the pace of the fuck slows to a crawl as the anemone puzzles out what to do with it; finally falling back on her racial instinct, she pops it into her mouth and begins to caress the tip gently with her teeth and tongue as her short hair reaches around to tickle the shaft.  Your body flops weakly, too wracked by the sensation from your clit to allow conscious control.");
        ...
        reallyEvictDaAnemone() {
            this.clearOutput();
            this.spriteSelect(71);
            this.outputText("Time to reclaim your barrel.  Gesturing to get her attention, you grab the anemone by her upper arm and lift her to her feet.  She looks at you in confusion, but you set your face and drag her along with you as you make your way to the lake.");
            ...
            this.outputText("\"<i>Um... hi!</i>\" your anemone returns, enthusiastically this time, as she answers the physical contact by tugging one of the newcomer's tentacles.");
        ...
        kidADreams() {
            ...
            if (this.player.hasCock() && (!this.player.hasVagina() || this.player.femininity < 50)) {
                ...
                if (this.player.isTaur())
                    this.outputText("thigh");
                else
                    this.outputText("cheek");
                this.outputText(", she leans in to kiss you, softly whispering your name over and over.  \"<i>[name]... [name]...</i>\"");
                this.outputText("\n\nYour eyes snap open suddenly to see the ubiquitous red moon overhead.  A ");
                if (!this.player.isTaur())
                    this.outputText("soft hand strokes your face and a ");
                this.outputText("slight weight rests against your crotch; as you look down, your anemone is there with her pussy pressed to the erection bulging under your gear, frozen in mid-rub and blushing to the point that you can barely make her out.");
            ...
            //if female:
                ...
                if (this.player.cor >= 66)
                    this.outputText(" and, with a sigh, you grab her head and force it down to the mess, compelling her to lick it up.");
                else
                    this.outputText(" and neither of you says a word as she backs away slowly on her knees.");
        ...
        repeatCowSitting() {
            this.outputText("Marble looks up from her work and regards you warmly.  \"<i>I appreciate the offer, [name].  I've already got someone on it, but if you want to go help, I'm sure there's something you could do.</i>\"  She gestures in a direction over your shoulder.");
            ...
            this.outputText("\n\n\"<i>Yes, mummy,</i>\" your daughter answers.  \"<i>I let " + this.player.mf("him", "her") + " eat me right up.</i>\"  Laughing, Marble leads the little girl off and you make your way back.  Kid A is dragging herself to her water barrel, looking at the ground in a frazzle.  As you pass by, she makes unblinking eye contact for a long time, then eventually acknowledges you with a curt nod.");
            this.outputText("\n\n\"<i>...Sweetie.</i>\"");
        }
        ...
        kidAWatchesSharks() {
            ...
            if (this.kidAXP() < 40 || this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID] == '')
            ...
            //(else KidXP < 75 and Kidweapon = White Book or Black Book)
            else if (this.kidAXP() < 40 && (this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID] == this.consumables.B__BOOK.id || this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID] == this.consumables.W__BOOK.id)) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID] == this.consumables.W__BOOK.id)
                    this.outputText("blinds them with a sudden flash of white light");
                else
                    this.outputText("turns deep blue as the various shark-girls clap their thighs together and look away from one another in embarrassment");
                this.outputText(".  Before any of them can react, she dives into the water and fills the waterskins, then hightails it away.");
            }
            //(else KidXP < 75)
            else if (this.kidAXP() < 75) {
                this.outputText("\n\nThe sharks look up from their play, baring teeth at the anemone.  She steels herself, then holds her " + ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID]).longName + " menacingly in front of her as best she can while she steps into the stream and fills her waterskins.  Occasionally one of the shark-girls will feint at the anemone, who accordingly turns the weapon toward the aggressor until she retreats.  Once the skins are filled, Kid A hangs them over her shoulders and backs away, still facing the sharks with her weapon out.");
            }
            //(else)
            else
        ...
        goblinNightAnemone() {
            ...
            this.outputText("\n\nThough you can't see Kid A's expression from behind, she's probably steeling her face into as stern a mask as she's capable of, judging by the way she assumes an aggressive stance - albeit one that's still trying to protect her body as much as possible with " + ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID]).longName + ".  As the anemone takes a step forward, the goblins all take a step back, except for the leader.  The two are now staring at each other; one looking up, the other down.");
    ...
    exports.AnemoneScene = AnemoneScene;
});
//# sourceMappingURL=AnemoneScene.js.map