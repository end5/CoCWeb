define(["require", "exports", "./NPCAwareContent", "../../GlobalFlags/kFLAGS", "../../StatusAffects", "../../../../includes/appearanceDefs", "../../PerkLib", "../../../console", "../../CockTypesEnum", "../../GlobalFlags/kGAMECLASS"], function (require, exports, NPCAwareContent_1, kFLAGS_1, StatusAffects_1, appearanceDefs_1, PerkLib_1, console_1, CockTypesEnum_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class ShouldraFollower extends NPCAwareContent_1.NPCAwareContent {
        ...
        followerShouldra() {
            return this.flags[kFLAGS_1.kFLAGS.SHOULDRA_FOLLOWER_STATE] == 1;
        }
        shouldraSleeping(changes = 0, reset = false) {
            //Adjust sleep timer
            if (reset) {
                this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] = changes;
            }
            else
                this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] += changes;
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] < 0)
                this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] = 0;
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] > 48)
                this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] = 48;
            //Is she sleeping?
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] > 0)
                return true;
            return false;
        ...
        noFollowerShoulders() {
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("Somewhat bluntly, you inform her of your lack of interest regarding having a ghostly tagalong.  Though she looks a bit disappointed, she nods, scuffing her shoes against the ground and huffing a little sigh.  \"<i>At least I'll see you later, hey?</i>\"");
        ...
        recruitShouldraForCampSexyTimes() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_FOLLOWER_STATE] = .5;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        morningShouldraAlert() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_FOLLOWER_STATE] = 1;
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_COUNTDOWN] = 7;
        ...
        shouldraAndValaGetBigger() {
            this.clearOutput();
            this.spriteSelect(67);
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_MET_VALA] < 1)
                this.flags[kFLAGS_1.kFLAGS.SHOULDRA_MET_VALA] = 1;
            this.outputText("You decide to make your way down to the Wet Bitch to introduce Vala to her.  A few minutes into your stay, you see the fairy serving a few tables while holding a tray filled with drinks and empty glasses.  Pointing her out, Shouldra gives a delighted squeal.");
            ...
            this.menu();
            this.addButton(0, "Next", this.pureMacroValaCont);
            this.addButton(1, "Be A Toy", this.pureValaAndShouldraMacroMax);
        }
        pureMacroValaCont() {
            this.clearOutput();
            this.spriteSelect(67);
            ...
            //Female:
                ...
                this.outputText("Her finger starts pressing firmly against your chest.  You try to push it away, but the size difference makes the effort futile.  The ghost girl starts grinding against your chest with her fingertip, the friction against your breasts causing a small gasp to escape your lips, and your nips to become slightly firmer.  She runs her pinky up your leg, stopping at your vagina, and you reflexively clench your legs together. Unfazed, Shouldra forces them back open with her fingers, exposing you to the open air.  A small breeze blows through, tickling your cunt and causing you to bite your lip.");
            ...
            this.shouldraSleeping(10 + ShouldraFollower.rand(15), true);
            this.player.orgasm();
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        pureValaAndShouldraMacroMax() {
            this.spriteSelect(67);
            this.clearOutput();
            this.player.slimeFeed();
            this.outputText("Before she can do anything, you shout out a rather unusual suggestion, though to you it sounds quite exciting.  Vala or Shouldra, whoever she is, smiles wickedly and nods, lifting you up towards the glittering gash between her legs.");
            ...
            if (this.player.gender > 0) {
                this.outputText("  Inspired by this, your own body has long since responded");
                if (this.player.hasCock())
                    this.outputText(", becoming firmly erect.  You happily piston your hips to grind your " + this.multiCockDescriptLight() + " along the pink-glossed walls, oozing your fluids in delight.");
                else
                    this.outputText(", growing wet, though in this slick fluid, your contribution is a mere drop in the ocean.");
            }
            this.outputText("  The warm fleshy dream is abruptly ended as Shouldra yanks you out by your [feet].  \"<i>I'm gonna put you the whole way in.  Do me a solid and get me off a few times, will ya?</i>\"");
            ...
            this.outputText(" against the slick walls.  You push your way towards the pinkish slit in the distance begin to slide your [legs] over the inner edges of her lips, pressing your arms up above you for stability.");
            ...
            if (this.player.hasCock()) {
                this.outputText("  [EachCock] is quickly brought to orgasm by the exotic situation, and you fire off your own load into the deluge of sex-juice.");
                if (this.player.cumQ() >= 1000)
                    this.outputText("  Somehow, you pour out almost as much spunk as Vala's orgasm, turning the inside of her honeypot into an off-white mess.");
            }
            else if (this.player.hasVagina()) {
                this.outputText("  Your [vagina] can scarcely resist the allure of the sweet, female flesh pressing against it, and with an explosion of hot bliss, you climax");
                if (this.player.wetness() >= 4)
                    this.outputText(", squirting with joy");
                this.outputText(".");
            }
            ...
            if (this.player.gender == 0)
                this.outputText(" somehow");
            this.outputText(", but she vanishes with a high-pitched giggle.");
        ...
        shouldraMeetsCorruptVala() {
            ...
            if (this.player.hasCock())
                this.outputText("  Your cock slips past the folds, pressed up against your stomach as the underside is massaged with the gentle tightness within.");
            this.outputText("  Once you're up to your chest, Vala stops, instead grasping your shoulders between her thumb and forefingers as she begins to gently slide you in and out of her.");
        ...
        sandWitchGetsGhostly() {
            this.spriteSelect(67);
            this.clearOutput();
            if (this.player.hasCock() && (!this.player.hasVagina() || ShouldraFollower.rand(2) == 0)) {
                ...
                this.outputText("Shouldra pokes her head out from your torso, rubbing her hands together menacingly.  \"<i>So, we're going to have some fun with this little gal, aren't we, Champ?</i>\"  The sand witch is paralyzed with fright, able only to gaze at the bizarre spectacle before her.  Looking down at the shade sticking out of you, you see her hands now poised against your chest.  The ghost girl is ready to fly out at a moment's notice.  You decide not to keep her waiting and give her the go ahead; the force of her excited exit about throws you to the sandy ground.  The eager spirit quickly hammers into the witch, digging her sitting body into the sand.  There's a little struggling, but it isn't long until the ghost subdues her prey.");
                ...
                if (!this.player.hasFuckableNipples())
                    this.outputText("\"<i>You know, maybe I should give you a couple of those chest-mounted treats.  They're pretty fun,</i>\" Shouldra teases, tweaking your [nipples].  ");
                this.outputText("With a very telling exasperated sigh, you snatch up your [armor] and march back to camp.");
            }
        ...
        shouldraFappinTimes() {
            this.spriteSelect(67);
            if (this.player.hasCock() && this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) >= 0) {
                this.shouldraAndWormsYoureGonnaHaveABadTime();
            }
            else if (this.player.gender == 0)
                this.genderlessShouldraMasturbation();
            else if (this.player.hasCock() && (!this.player.hasVagina() || ShouldraFollower.rand(2) == 0))
                this.maleMasturbationProper();
            else {
                if (ShouldraFollower.rand(2) == 0)
                    this.girlyMasturbationWithGhosts();
                else
                    this.shouldraTongueLicksPCs();
            }
        }
        //Notes:
        ...
        genderlessShouldraMasturbation() {
            ...
            if (this.player.femininity < 50)
                this.outputText("masculine ");
            else if (this.player.femininity > 50)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0 && this.flags[kFLAGS_1.kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] == 0) {
            ...
            //if SHOULDRA_GENDERLESS_FUCK_COUNT > 0 & event occurrence = 0
            else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] > 0 && this.flags[kFLAGS_1.kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] == 0) {
            ...
            //if event occurrence > 0
                ...
                if (this.player.cor < 50)
                    this.outputText("There isn't an answer or outcome to that question that you're in favor of, honestly.");
                else
                    this.outputText("You sure as hell wouldn't have bothered asking if you weren't.");
            }
            this.outputText("  The ghost girl promptly discards your [armor] before hurrying your naked body along into the wilderness away from camp.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0 && this.flags[kFLAGS_1.kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] == 0)
                this.outputText("Within lies a rather rustic yet well-built chest.");
            else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] > 0 && this.flags[kFLAGS_1.kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] == 0)
                this.outputText("The moment the light reveals what lies within, your [butthole] instinctively clenches shut.  \"<i>You didn't think I'd leave my most treasured possessions behind for some goblin to run into, did you?</i>\" It's the ghost girl's chest of dildos, as well-kept as the last time you laid worried eyes on it.");
            else
                this.outputText("Inside rests the ghost's familiar treasure trove of dildos and other toys you have yet to discover.");
            this.outputText("  She has you pull the container out from its hiding place, removing the clear tarp she used to protect it from the elements.  Despite the fact that you have yet to control your body once through this entire ordeal, an intrinsic urge to open the container has you bending over to pry into the contents within.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] > 0)
                this.outputText("  Just what else did she pack in there since last you peered at its contents back at the ruins?");
            ...
            if (this.player.ass.analLooseness < 3) {
                this.outputText("Your nerves screech out in pain as your rear revenant stretches out her puckered little \"jaw\" to something more fitting for what she has in store.  A few seconds later and the sensations begin to only register as pleasure.");
                //[if (corruption < 50)
                if (this.player.cor < 50)
                    this.outputText("..  This only worries you further.");
                this.outputText("  It doesn't take her long to <b>prepare your anus for any insidious ploy she's thought up.</b>");
            }
            //if analLooseness >= 3
            else {
                this.outputText("\"<i>Looks as though you already get plenty of action back here, chief,</i>\" she jests.  Nevertheless, the rear revenant massages her \"jaw\" even more lax than you already are.  Even stranger, each gyration provides more and more pleasurable feedback");
                if (this.player.cor < 50)
                    this.outputText(", which only serves to confuse you");
                this.outputText(".");
            }
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ZETSUKO_MET] > 0)
                this.outputText("\"<i>Your run-in with a particular kitsune inspired me,</i>\" Shouldra teases");
            else
                this.outputText("Shouldra is too caught up in her machination to give you any hint as to what is going on, leaving you confused");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] > 0 || this.flags[kFLAGS_1.kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] > 0)
                this.outputText("You recognize it instantly as she pulls it free from her chest: the nearly foot-long floppy horse cock she impaled you on before.");
            //{if SHOULDRA_GENDERLESS_FUCK_COUNT = 0}
            else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0)
                this.outputText("She holds her catch up clear for you to see; to your horror, you have clutched onto an enormous horse cock replica.  All 13 inches flop restlessly in your grip, seemingly taunting you with the foreboding future that lays before you.");
            this.outputText("  Shouldra smacks the dildo of doom onto a nearby boulder as she wearily rises you to your [feet].  The inferior, forgotten playthings slide out uselessly from the ghoul's gasping craw as she slowly clambers over top the wiggling horsey wang.");
        ...
        nongenderlessAnalShouldraMasturbation() {
            ...
            //if SHOULDRA_GENDERLESS_FUCK_COUNT > 0 OR event occurrence > 0
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] > 0 || this.flags[kFLAGS_1.kFLAGS.GENDERLESS_MASTURBATION_WITH_GHOST_COUNT] > 0)
                this.outputText("You recognize it instantly as she pulls it free from her chest: the nearly 2-foot floppy horse cock she impaled you on before.");
            //if SHOULDRA_GENDERLESS_FUCK_COUNT = 0
            else
                this.outputText("She holds her catch up clear for you to see; to your horror, you have clutched onto an enormous horse cock replica.  All 13 inches flop restlessly in your grip, seemingly taunting you with the foreboding future that lays before you.");
            this.outputText("  Shouldra smacks the dildo of doom onto a nearby boulder as she wearily rises you to your [feet].  The inferior, forgotten playthings slide out uselessly from the ghoul's gasping craw as she slowly clambers over top the wiggling horsey wang.");
        ...
        maleMasturbationProper() {
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("You are nearly overwhelmed by Shouldra's delight when you allow her to focus on your [cock].  She instantly takes the lead, steering you behind a good-sized boulder and flinging your [armor] piece-by-piece as you go.");
            ...
            //if cocksize <200: 
            if (this.player.cockArea(0) < 200)
                this.outputText("  You stagger a bit at the unaccustomed heft of your junk altering your center of gravity, but you know that will wear off soon enough.");
        ...
        girlyMasturbationWithGhosts() {
            ...
            this.outputText("\"<i>Tsk!  Saying those kinds of things aloud!  Still... if you want to let it out so badly, I might let you if you beg a little more...</i>\"");
        ...
        shouldraTongueLicksPCs() {
            ...
            //if SHOULDRA_GENDERLESS_FUCK_COUNT > 0 || event occurrence > 0
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] > 0 || this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TONGUE_LICKS_TIMES] == 0)
                this.outputText("  The consistency of your forgetfulness while traveling this path leads you to believe that your ethereal inhabitant would rather you not come back here on your own.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] == 0 && this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TONGUE_LICKS_TIMES] == 0)
                this.outputText("  Within lies a rather rustic yet well-built chest.");
            else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_GENDERLESS_FUCK_COUNT] > 0 && this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TONGUE_LICKS_TIMES] == 0)
                this.outputText("  \"<i>You didn't think I'd leave my most treasured possessions behind for some goblin to run into, did you?</i>\"  It's the ghost girl's chest of dildos, as well-kept as the last time you laid worried eyes on it.");
            else
                this.outputText("  Inside rests the ghost's familiar treasure trove of dildos and other toys you have yet to discover.");
            this.outputText("  She has you pull the container out from its hiding place, removing the clear tarp she used to protect it from the elements.  Despite the fact that you have yet to control your body once through this entire ordeal, an intrinsic urge to open the container has you bending over to pry into the contents within.");
            ...
            //if event occurrence == 0
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TONGUE_LICKS_TIMES] == 0) {
                ...
                if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                    this.outputText("some of ");
                this.outputText("your tongue out, examining it.  Already, you think you've got a pretty good idea of where she's going to take this.");
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.Flexibility) >= 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TONGUE_LICKS_TIMES] == 0) {
                    ...
                    this.outputText("\n\nShe sits you down and lets her dildos fall to the ground, forgotten for the moment.  \"<i>How's this one go?</i>\" she asks, leaning down in an awkward attempt to get your face in your " + this.vaginaDescript(0) + ".  You start to explain the proper 'technique' to what she's trying to do, but before you can even finish your thought she's stuck a leg up in the air and has your mouth to your own snatch.  You doubt you'll ever get used to having her inside your thoughts.");
                }
                ...
                if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TONGUE_LICKS_TIMES] == 0) {
                    this.outputText("  Almost shocked enough to wrest control away from your companion, you begin to babble dissent and try to reel your lengthening tongue back in to no avail.  Shouldra stops for a moment, quite frustrated by the interruption.  Sitting straight up, she consoles you, \"<i>Relax, Champ, it'll stop feeling weird in a minute and you know it's all temporary.</i>\"");
                ...
                this.outputText(" sliding fingers along the wet appendage, humming a little tune over your tongue until more than a foot of it droops from your mouth.  \"<i>Now we're getting somewhere,</i>\" you hear her thinking as she works her magic.  There doesn't seem to be a limit to how much she can pull out of your mouth, and soon she has more than three feet of pure tongue coiled in your lap.  Furrowing your brow in concentration, she tries to move your tongue about, but can't manage to wiggle more than the tip.  \"<i>Too thin,</i>\" she mutters, \"<i>much too weak. Doesn't feel right...</i>\"");
            ...
            //if demon tongue
                ...
                if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TONGUE_LICKS_TIMES] == 0)
                    ...
                    this.outputText("\n\n She happily continues ");
                this.outputText("sliding fingers along the wet appendage, humming a little tune over your tongue until more than an additional foot of it droops from your mouth.  \"<i>Now we're getting somewhere,</i>\" you hear her thinking as she works her magic.  There doesn't seem to be a limit to how much she can pull out of your mouth, and soon she has more than three feet of pure tongue coiled in your lap.  Furrowing your brow in concentration, she tries to move your tongue about, but can't manage to wiggle more than the tip.  \"<i>Too thin,</i>\" she mutters, \"<i>much too weak. Doesn't feel right...</i>\"");
                this.outputText("\n\nTaking the midsection of your tongue in your hand, she slowly starts to rub her hand along some of its length.  It feels... odd, somehow, but not entirely unpleasant.  Though you shudder at the first rub, they start to feel more natural as she pushes you on.  Actually, it feels sort of good.  Her strokes remain constant, though some part of you wishes she'd go faster.  It doesn't even register as odd in your addled mind that your tongue is swelling in your hand with every stroke.  Shouldra starts to make wider movements along your smooth stretch of muscle.  Its girth plumps up to fill your palm nicely wherever she brings your hand, and the strange sensations of your flesh on its nerves wrack your body with shudders of pleasure even through Shouldra's grip.");
        ...
        shouldraDream1() {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_LEVEL] == 1) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_LEVEL] == 2) {
                //Dream 3 - "Recent" Goblin Possession
                //triggers one week after Dream/Talk 2
                this.outputText("Few things more relaxing than heading home after a day of work.  But as you approach the dilapidated hut, some strange noises from within catch you off guard.  If it's that fucking mouse again...");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_LEVEL] == 3) {
                //Dream 4 - Backstory
            ...
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_LEVEL]++;
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TALK_NEEDED] = 1;
            this.doNext(this.playerMenu);
        }
        ...
        shouldraYappin() {
            this.clearOutput();
            //Plot dreams!
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TALK_NEEDED] == 1) {
                //unlocked with Dream 1
                if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_LEVEL] == 1) {
                    //Clear out that talk happened and start a countdown till next dream sequence.
                    this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TALK_NEEDED] = 0;
                    this.spriteSelect(67);
                    if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_LEVEL] < 4)
                        this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_COUNTDOWN] = 7;
                    ...
                    this.outputText("You decide not to beat around the bush and ask about the strange dream you had the other night.  The spirit puts on a surprised reaction, your shoulder returning to normal as she casually walks outside of your body.");
                    ...
                    if (this.player.findPerk(PerkLib_1.PerkLib.Incorporeality) >= 0)
                        this.outputText("  Shouldra bumps you to the side a little as she makes her next point, \"<i>Even with your hoaky quasi-possession power, you don't really know what it's like to actually possess someone.</i>\" You look at her funny, unaware that you weren't really getting the full effect.  Not that you care!");
                    ...
                    this.outputText(".  \"<i>No matter what treasure trove of knowledge I dig up from you, there's always something I'm more interested in.</i>\"  Your hand lifts back up, and you watch as Shouldra's hand splits off from your own, meeting below the wrist.  She holds your hand with her own ghostly appendage, resting her head on your shoulder.  The ghost girl sits there for a moment, silent, leaving you to wonder if maybe, just maybe, you're starting to mean a little more to her than just a sex toy.");
                ...
                //Talk 2 - First Transformation Discussion
                    ...
                    if (this.player.gender > 0) {
                        this.outputText("  Your [if (hasCock = true) [cock]][if (isHerm = true)  and ][if (hasVagina = true) [vagina]] start to swell up; looking up at the ghost, you realize that she hasn't uttered a single word!");
                    }
                    else
                        this.outputText("  A fleshy, penis-shaped bulge begins to swell out of your loins; looking up at the ghost, you realized she hasn't uttered a single word!");
                    ...
                    this.outputText(" [if (isHerm = false) continues its][if (isHerm = true) continue their] march of magnification while your fingers vigorously explore their new frontiers.");
                    ...
                    if (this.player.gender == 0)
                        this.outputText("burgeoning dickflesh");
                    this.outputText(".  It takes some gumption for you to work through the arousal and contribute to the conversation, but you manage to point out how you're pretty sure there are other people in Mareth with the same sort of power, to some degree at least.");
                ...
                //Talk 3 - "Recent" Goblin Possession Discussion
                else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_LEVEL] == 3) {
                    //Clear out that talk happened and start a countdown till next dream sequence.
                    this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TALK_NEEDED] = 0;
                    this.spriteSelect(67);
                    if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_LEVEL] < 4)
                    ...
                    this.outputText("You stare at Shouldra.  \"<i>Oh, <b>what</b>?</i>\"  You stare at Shouldra.  \"<i>She fucking pissed on my floor!</i>\"  You stare at Shouldra.  The ghost shakes her head, sinking it back inside your skin. The ghost girl quickly flies out of your chest.  \"<i>You don't fuck with my stuff!</i>\"");
                    ...
                    if (this.player.hasCock())
                        this.outputText("</i>\"  Shouldra eyes your [cock] gingerly, acting as if she can stare right through your outfit at it.  \"<i>");
                    else
                        this.outputText("  ");
                    this.outputText("The half-millenium or so of scarcity has really shaped my interests.  I'm at the point now where I just lose it whenever I get these ghostly mitts on a slab of meat.  And the big ones?  ");
                    if (this.player.biggestCockArea() >= 200)
                        this.outputText("Ones like yours?  ");
                    this.outputText("Then I'm just in heaven.</i>\"  Hold on.  She can turn any dick into a towering monument.  What's so special about ones that come pre-packaged, you ask?  \"<i>I kinda break the one rule I had at that point, but when I find someone with a big boner, it just... feels so good to me.  There's just something about an all-natural magnum opus that just lights my fire.</i>\"");
                    ...
                    this.outputText("\"<i>Oh,</i>\" she says, stepping out of you and sitting herself across from you.  \"<i>You saw that.</i>\"");
            ...
            //Generic Oni Discussion!
                ...
                this.outputText("On a whim, you decide to have a chat with your spectral companion, who obligingly pops free of your torso to spare you the awkward sensation of conversing with one of your own body parts.");
        ...
        shouldraFollowerScreen() {
            this.spriteSelect(67);
            this.clearOutput();
            if (!this.shouldraSleeping())
                this.outputText("You pulse a desire for interaction with Shouldra, summoning her head to form from your shoulder. \"<i>What's on your mind, Champ? I could've found out on my own, but I was... preoccupied.</i>\"");
            //Follower Screen Quick Text - Shouldra asleep
            else {
                this.outputText("You try and contact Shouldra, but the ghost is still sound asleep within you.  Or whatever ghosts consider sleep after an arousing round of debauchery. Either way, you garner no response.  Best to try again later.");
                this.doNext(this.playerMenu);
                return;
            }
            var sex = undefined;
            ...
            this.simpleChoices("Talk", this.shouldraTalkMenu, "Sex", sex, "", undefined, "Go Away", this.kickFollowerShouldraOut, "Back", this.camp.campFollowers);
        }
        shouldraSexMenu() {
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("Shouldra stirs from somewhere deep inside you, excitement evident in the swiftness of her reaction.  \"<i>Is it time for some fun, Champ?</i>\" she asks happily, her increased lust affecting you just a bit.  Do you oblige her?");
            var vala = undefined;
            if (this.flags[kFLAGS_1.kFLAGS.FREED_VALA] != 0 && (this.model.time.hours >= 12 && this.model.time.hours <= 21)) {
            ...
            this.simpleChoices("GhostMasturbate", this.shouldraFappinTimes, "Anal Masturb", anal, "Visit Vala", vala, "", undefined, "Back", this.shouldraFollowerScreen);
        }
        //Talk Options
        shouldraTalkMenu() {
            this.spriteSelect(67);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_LEVEL] >= 2 && this.flags[kFLAGS_1.kFLAGS.SHOULDRA_MAGIC_COOLDOWN] <= 0) {
            ...
            this.simpleChoices("Normal Talk", this.shouldraYappin, "Grow Something", blowShitUp, "Shrink Something", shrinkShit, "", undefined, "Back", this.shouldraFollowerScreen);
        }
        //Grow Bodypart
        ...
        shouldraGroPlus() {
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("You decide to take up Shouldra's offer on natural body enhancement.  Before you tell her as much, the eager spectre quickly assumes control of your body.  \"<i>Alright, Champ, now we're in business.  So, what did you have in mind?</i>\"");
            ...
            this.choices("Balls", balls, "Breasts", breast, "Clit", clit, "Cock", cock, "Nipples", nipples, "Butt", butt, "", undefined, "", undefined, "", undefined, "Back", this.shouldraTalkMenu);
        }
        //Balls
        groBallsBiggaGHOSTYSTYLE() {
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_MAGIC_COOLDOWN] = 72;
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("\"<i>Interested in a bigger ballsack, huh?  Not only will it help pronounce your package, but a big ol' swinging sack of nuts feels great when you're really pounding.</i>\" Shouldra grasps your [balls] with both your hands and begins reciting the appropriate spell.");
            ...
            if (this.player.ballSize > 10)
                this.outputText("  You second guess your decision when your swinging cum barrels seem to impede walking.  Shouldra reassures you that the enhanced libido and baby batter supply is worth the wider gait.");
        ...
        shouldraGrowsYoTits() {
            ...
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("\"<i>I'll give you a rack that could hypnotize anyone into a faithful tit slave,</i>\" Shouldra boasts, stretching your shoulders in preparation.  Your hands grope your [fullChest] as the spirit slips into the arcane language you've come to grow so familiar with.\n\n");
            //same growtits() as Gro+
            if (this.player.breastRows.length == 1)
                this.player.growTits((1 + ShouldraFollower.rand(5)), 1, true, 1);
            else
                this.player.growTits(1 + ShouldraFollower.rand(2), this.player.breastRows.length, true, 1);
            this.dynStats("lus", 10);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Clit
        shouldraGrowsYoClit() {
            ...
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("\"<i>Looking to give your joy buzzer a little jumpstart?</i>\" Shouldra teases, your hands sliding down to your inviting [cunt].  Your fingers tease your [clit] while the ghost girl spouts her arcane tongue from your mouth.  ");
            //clitLength + 1
            this.player.clitLength += 1;
            this.outputText("She welcomes the new inch with a quick flick.  The sensitive [clit] twitches happily in response, confirming the success of the spell.");
        ...
        shouldraGivesYaSomeFukkinTeats() {
            ...
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("Shouldra rubs your hands together in anticipation, \"<i>A beautiful blossoming pair of nipples is what you need to really compliment a nice set of tits.</i>\"  Your hands gleefully tweak your [nipples] as the spirit's incantation gets underway.");
        ...
        shouldrasButtBigginator() {
            ...
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("Shouldra's haunting laugh works its way out from your mouth.  \"<i>Looking for a little more jiggle in your step, Champ?  I can get BEHIND that.</i>\"  This damnable ghost won't let you roll your eyes!  Is there no end to her torment?  After a quick crack of your knuckles, Shouldra directs your hands back onto your derriere as she transitions into spellcasting.");
        ...
        shouldraReductoMenu() {
            ...
            if (this.player.hasCock() && this.player.longestCockLength() > 4)
                cock = this.shouldraMakesCocksDisappear;
            if (this.player.hasVagina() && this.player.clitLength > .25)
                clit = this.clittyVanishingActShouldra;
            this.choices("Balls", balls, "Breasts", breasts, "Clit", clit, "Cock", cock, "Nipples", nipples, "Butt", butt, "", undefined, "", undefined, "", undefined, "Back", this.shouldraTalkMenu);
        }
        //Balls
        shouldraReductosYourBallsUpInsideYa() {
            ...
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("\"<i>Why would you want to shrivel these delicious cumquats?</i>\"  Shouldra's arsenal of puns doesn't affect your request in the slightest.  The ghost girl moves into a quick spell, savoring your testicles before finishing.");
            //this.player.ballSize = this.player.ballSize - (2 + this.rand(4));
            this.player.ballSize -= (2 + ShouldraFollower.rand(4));
            if (this.player.ballSize < 1)
        ...
        shouldraReductosYourTits() {
            ...
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("Your arms clasp themselves around your [fullChest].  \"<i>Not the gals!  What monster would want to deflate their knockers?</i>\"  This monster, evidently.  Shouldra sighs, holding your hands in a weak casting stance as she gets the heinous act over with.");
        ...
        clittyVanishingActShouldra() {
            ...
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("\"<i>Aw, really, Champ?  The best part of your snatch?</i>\"  A nod of your head reasserts your desire.  The depressed phantom hastily works through the spell, the notion of shrinking your [clit] not sitting well with her.");
        ...
        shouldraMakesCocksDisappear() {
            ...
            if (this.player.cocks.length == 1) {
                ...
                var choice = ShouldraFollower.rand(10);
                if (choice == 0)
                    this.outputText("murderer");
                else if (choice == 1)
                    this.outputText("bastard");
                else if (choice == 2)
                    this.outputText("jerk");
                else if (choice == 3)
                    this.outputText("monster");
                else if (choice == 4)
                    this.outputText("cretin");
                else if (choice == 5)
                    this.outputText("fiend");
                else if (choice == 6)
                    this.outputText("asshole");
                else if (choice == 7)
                    this.outputText("villain");
                else
                    this.outputText("dick");
                this.outputText("!</i>\" it shouts.  The tiny voice fades away as your [cock] goes still, resting at two thirds of its original size.  A single tear rolls down your cheek; you suspect the melodramatic spirit is at fault here.");
            ...
            //MULTI
                ...
                for (var ii = 0; ii < this.player.cocks.length; ii++) {
        ...
        shrinkDemNipplzForYoGhost() {
            ...
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("\"<i>Are you kidding me, Champ?  Nipples are the most important-</i>\"  You cut the ghost girl's argument there, not wanting to leave your decision up for debate.  She instead leaves you with a deep sigh of disapproval before quickly casting the appropriate spell.");
            //Shrink
            if (this.player.nippleLength / 2 < .25) {
        ...
        shrinkDatBootyForYoGhost() {
            ...
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("Your hands quickly grasp at your bare [butt].  \"<i>You... you're desecrating a national treasure here!</i>\"  The rather odd declaration gets a chuckle from you, but you remain firm in your request to dull your derriere.  The ghost girl furthers her attempts to change your mind, but without literally changing your mind, you remain steadfast.  Defeated, your hands take one last trip around your posterior before the poltergeist recites her incantation.");
            if (this.player.buttRating >= 15) {
                this.player.buttRating -= 3 + Math.floor(this.player.buttRating / 3);
            ...
            else if (this.player.buttRating >= 10) {
                ...
                this.player.buttRating -= 1 + ShouldraFollower.rand(3);
                if (this.player.buttRating < 1)
                    this.player.buttRating = 1;
        ...
        kickFollowerShouldraOut() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_PLOT_LEVEL] < 4 || this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TALK_NEEDED] > 0) {
                this.outputText("\"<i>Ah, you're booting me out, hey?</i>\"  Shouldra asks innocently, tumbling out of your body and corporealizing. \"<i>Wouldn't be the first, and won't be the last.  I do realize I have certain 'needs' that got cloying to many of my former hosts.</i>\"");
                ...
                this.flags[kFLAGS_1.kFLAGS.SHOULDRA_FOLLOWER_STATE] = 0;
                this.doNext(this.camp.returnToCampUseOneHour);
            }
            //She Fucking Explodes
            else {
                this.outputText("Are you sure you want to ask her to leave after she opened herself up to you?  It's just a hunch, but she might not take this very well.");
                this.doYesNo(this.definitelyKickOutCrazyGhosts, this.shouldraTalkMenu);
            }
        }
        //if yes
        ...
        shouldersWarnings() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] == -96) {
                this.spriteSelect(67);
                ...
                else if (ShouldraFollower.rand(2) == 0)
            ...
            //7 days (168 hours) since last Shouldra scene
            else if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_SLEEP_TIMER] == -168) {
                this.spriteSelect(67);
                console_1.trace("LEVEL 2 LUST INCREASE HAPPEN");
                ...
                if (ShouldraFollower.rand(3) == 0) {
                    ...
                    if (this.player.gender == 0)
                        this.outputText("libido seems to be going haywire");
                    this.outputText(".  Shouldra's unfulfilled sexual needs are starting to blend into your own.  Nothing you do will satisfy your urging until she's seen to her own.\n\n<b>Minimum lust raised by 20.</b>\n");
                }
                else if (ShouldraFollower.rand(2) == 0) {
        ...
        nightTimeShouldraRapesThePC() {
            ...
            //event occurance = 0
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TIMES_NIGHT_RAPED_PC] == 0) {
            ...
            if (this.player.biggestTitSize() >= 1)
                this.outputText(", circling their entire lengths around your [fullChest]");
            this.outputText(".  It's quite amazing how ecstatic the tour feels, each pre-smeared exploration smothering you in sensual vibes.  Just moving the stiff little devils - particularly at your joints - sends shivers up your arm.");
            ...
            this.outputText(", softening the ");
            if (this.player.hasCock())
                this.outputText("magically enlarged member");
            else
                this.outputText("magically gaped snatch");
            ...
            if (this.player.hasCock())
                this.outputText("flailing cock");
            else
                this.outputText("moist vagina");
            this.outputText(".");
            //if cock
            if (this.player.hasCock()) {
        ...
        edwardShouldraDickHandsPartII() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_TIMES_NIGHT_RAPED_PC]++;
            this.doNext(this.playerMenu);
        }
        ...
        shouldraWakesUpOrPokesPCsForShitsAndGigglesIdunnoHowLongCanIMakeThisFunctionNameQuestionMark() {
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1 && 9999 == 9999) {
            ...
            //11 (is butt pregnant)
            if (this.player.buttPregnancyIncubation > 0)
            ...
            if (kGAMECLASS_1.kGAMECLASS.amilyScene.amilyFollower())
                choices[choices.length] = 14;
            //15 (Pure Jojo is a follower)
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.PureCampJojo) >= 0)
                choices[choices.length] = 15;
            //16 (has any of Marae's gift perks)
            if (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftStud) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftFertility) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftProfractory) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftButtslut) >= 0)
            ...
            switch (select) {
                ...
                case 5:
                    ...
                    if (subSelect == 0)
                        ...
                        this.outputText("You almost don't realize your hand creeping its way into your [armor], trying to sneak a quick fingering. Looks like Shouldra is getting antsy.");
                    else if (subSelect == 3)
                        this.outputText("What the... ?  Your [vagina] has started gushing fluids everywhere, absolutely soaking your [legs]!  \"<i>Don't mind me, Champ.  I'm just testing to see how far I can push this. Part of something I have in mind for later...</i>\"  No good can come of this...");
                    else
                        this.outputText("You can sense Shouldra laughing to herself over something.  Though its usually a poor idea, you decide to ask and see what's on her mind.  \"<i>I was just scheming.  Would you get too upset if I spooked your next fuck?</i>\"  As she asks, you feel your [vagina] clenching hard, giving you a clear idea of what the trickster has in mind.  There's no way that-  On second thought, maybe it could be kind of fun?");
                    break;
                ...
                case 6:
                    ...
                    if (subSelect == 0)
                        this.outputText("While minding your business, you realize faint whispering is coming from your [cock].  Shouldra and Exgartuan are scheming something, probably something you wouldn't be a fan of.  Every so often your wang lets out a chuckle.  Maybe getting these two together wasn't in your best interest.");
                    else if (subSelect == 1)
                        this.outputText("Your [cock] is wiggling around inside your [armor], making you incredibly uncomfortable.  You go to undo your outfit when the demonic dong plows its way out anyway, scaring you half to death.  Shouldra and Exgartuan just laugh, too content with one another to pay you much mind.  You never expected them to get along THIS well.");
                    else if (subSelect == 2)
                        this.outputText("\"<i>So what other sorts of things can you concoct?</i>\" Exgartuan asks, shuffling around in your armor.  You're incredibly confused by the sudden question.\n\n\"<i>Honestly, that put me in the mood to make all of mother nature our bitch,</i>\" you respond... Shouldra responds.  The spirit is gabbing through your mouth to your possessed pecker.  The two prattle on like this for some time.");
                    else if (subSelect == 3)
                        this.outputText("Your hands slip inside your [armor], exploring your [cock].  Your fingers caress each little nub and nodule they come across.  \"<i>That's the ticket,</i>\" Exgartuan gleefully responds, getting rigid in the tight confines of your outfit.  Looks like your ghostly partner is out to make everyone happy.");
                    else if (subSelect == 4)
                        this.outputText("\"<i>Why don't you help out during battles, babe?</i>\" Exgartuan asks rather bluntly.\n\n\"<i>Hey, I've offered to help out with Champ's more seductive poses like you do...</i>\"\n\nIt isn't like you have much choice in the matter as far as Exgartuan is concerned!  The two continue their discussion, belittling your apparently meager combat performance.  Maybe your possessors could actually help deal some real damage for a change!");
                    else
                        this.outputText("Your [armor] has vanished!  You're butt naked!  It's pretty obvious who's at fau-\n\n\"<i>Really, [name], you don't even need it,</i>\" Exgartuan says, surprising you.\n\nShouldra laughs, \"<i>Right, Champ?  Two sexually-charged tyrants dwelling within you and you insist on sneaking around like common rabble?  Why not let it all hang out?</i>\"\n\nYour hands caress your [cock], exciting the demonic member into attention.  You remind the couple that your outfit isn't <b>just</b> for protection, citing many other-  Oh, your [armor] is back.  Guess they don't want to hear you prattle.");
                    break;
                //General flavor text
                case 7:
                    subSelect = ShouldraFollower.rand(6);
                    if (subSelect == 0)
                        this.outputText("\"<i>Yoooo, Champ, are we gonna fuck something, or am I just gonna stagnate here?</i>\" Shouldra moans, managing to steal control of an arm long enough to give your [butt] a honk.  You sigh.");
                    else if (subSelect == 1)
                        this.outputText("Out of nowhere, a colossal yawn bursts forth from your craw.  \"<i>Come on, Champ. I'm dying to try out some new stuff I've cooked up.</i>\" What is this sense of dread consuming your being?");
                    else if (subSelect == 2)
                        this.outputText("It's been pretty quiet recently.  No doubt Shouldra is up to something -- she always is.  Honestly, you've forgotten what it's like to not having your body passing for a bloated something or other.");
                    else if (subSelect == 3)
                        this.outputText("As you are going about your business, you swear you make out muttering emanating from somewhere on your person. It sounds like the ghost girl is reciting some magic, but you don't feel any different. This only worries you even more.");
                    else if (subSelect == 4)
                        this.outputText("\"<i>Do foot fetishes still apply if it's your own foot?</i>\" Shouldra asks.  For a moment you wonder how such a feat would even be possible.  But only for a brief, forgetful moment...");
                    else if (subSelect == 5)
                        this.outputText("A familiar voice works its way from the back of your mind, \"<i>Hey, Champ.  You think there's any way to make armpits sexy?  What about knees or noses?</i>\"  This line of questioning could lead to some very troubling consequences...");
                    else
                        this.outputText("\"<i>I like what you did with those racks,</i>\" Shouldra says unexpectedly, her voice losing its mischievous edge for a moment.  \"<i>I'm glad you kept them.</i>\"  You both sit in silence for several moments as you consider her mood shift to tenderness, but the moment passes.  Shouldra chuckles softly.  \"<i>Just thought I'd mention.</i>\"");
                    break;
                //Special Flavor Texts (misc. prereqs)
                //(Tel'Adre unlocked)
                case 8:
                    this.outputText("Somehow, someway, you can feel Shouldra sifting through your memories.  \"<i>I'd love to visit the bakery in that desert town.  It's been at least a century since I tasted a decent sweet of some sort.</i>\"");
                    break;
                //Preggo
                case 9:
                    this.outputText("Your hands circle your bulging belly unbidden.  Shouldra seems to be enjoying your pregnancy.  \"<i>A good deal of the goblins I got a hold of were pregnant, but they don't really treat the event with anything other than their usual 'decorum.'</i>\"  The ghost girl lets out a deep sigh.  \"<i>There isn't anything wrong with enjoying it while you can, is there?</i>\"  Do the dead normally have this much interest in the birth of the living?");
                    break;
                //(is preggers2)
                case 10:
                    this.outputText("\"<i>Looks like the thing you're pregnant with is doing all right there, Champ,</i>\" Shouldra comments, your belly wiggling around a bit.  You ask that the ghost not go messing around with pregnancy, fearful of the consequences.  \"<i>Oh, please.  I wouldn't do anything crazy like that...</i>\" You can't see her, but you can picture the expression the ghost made as she trailed off.  And it worries you.");
                    break;
                //(is butt pregnant)
                case 11:
                    this.outputText("\"<i>I must admit, Champ, haven't run into too many instances of rear-ended pregnancies!</i>\"  Shouldra laughs, smacking your hand on your [butt].  \"<i>Just make sure that doesn't have to contend with all the other things that go in and out of your ass!</i>\"  You try not to dignify the crass remark with any sort of response.");
                    break;
                //(can fly)
                case 12:
                    this.outputText("You're taken by surprise when your wings act all on their own, lifting you off the ground with strong flaps.  \"<i>I'm trying to think of ways to use your own flight in some kinky shit, Champ,</i>\" Shouldra comments, \"<i>Nothing's coming to mind that's any better than me just floating your carcass instead.</i>\"  Well, we aren't all \"blessed\" enough to be deceased spirits!");
                    break;
                //(is Naga)
                case 13:
                    this.outputText("Your tail wiggles around on its own suddenly.  Catching on to how it appears to be sneaking to play around with something on your body, you calmly ask its spiritual captor to knock it off.  An otherworldly snicker emanates from it before it goes limp.");
                    break;
                //(Amily is a follower)
                case 14:
                    this.outputText("Your fingers move around a little, signaling Shouldra's stirring.  \"<i>It would seem that that mouse follows me everywhere I go,</i>\" she complains.  You figure she's talking about Amily.  You ask what her beef is.  \"<i>Too much baggage.  Don't want to deal with it.  I scared her a few times back at the town, but it wasn't all that satisfying.</i>\"  Looks as though Shouldra wasn't always the warmest of neighbors.");
                    break;
                //(Pure Jojo is a follower)
                case 15:
                    this.outputText("The silence bothers you a bit, so you decide to see if Shouldra is awake and ask her what she thinks about Jojo.  \"<i>You're talking about that holy mouse morph back at camp, right?  Not a fan,</i>\" she replies, shrugging your shoulders.  \"<i>Other than just not really being into people that remind me of rodents, I don't think he'd get along well with 'a spirit that has yet to abandon these mortal bonds.'</i>\"  she mocks.");
                    break;
                //(has any of Marae's gift perks)
                case 16:
                    this.outputText("\"<i>Man, Marae really did a number on you, Champ,</i>\" Shouldra comments, referring to your corrupted blessings.  \"<i>I'll have to hand it to you; you really get around.  Much more than I would have been willing to give you credit for.  Not everyone gets to fuck around with a goddess.</i>\"  You aren't sure if this is a compliment.");
                    break;
        ...
        shouldraAndWormsYoureGonnaHaveABadTime() {
            ...
            this.outputText("air.  Your hands clue the eidolon in to further activity, introducing her to your urethra all the way down to your [balls], every square wriggling inch chock-full of the little buggers, exploring their extended living quarters.");
        ...
        kickOutShouldra4YoWormyBuddies() {
            ...
            if (this.player.cocks[0].cockLength < 48)
                this.outputText("  With that little ordeal dealt with, you now are left to decide how best to manage the time until your cock returns to its normal size.");
            this.outputText("  Oddly enough, you hope the little buggers appreciate you sticking up for them.");
        ...
        shouldraAndExgartumonFightGottaCatchEmAll() {
            ...
            if (this.player.cor < 50)
                this.outputText("work");
            else
                this.outputText("fucking");
            this.outputText(".  Just when you're [armor] and about to tuck in for the night, however, your [cock] goes fully erect!  The throbbing demonic mass is flailing about, knocking into your shit and making a mess.  You clutch onto the bucking bronco in an attempt to prevent any further damage when Exgartuan begins to shout, \"<i>Don't FUCKING touch me, you goddamn cunt!</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUDRAMA] = 1;
            this.doNext(this.playerMenu);
        }
        ...
        exgartumonAndShouldraFightPartII() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUDRAMA] = 2;
        }
        ...
        exgartumonAndShouldraFightPartIII() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUDRAMA] = 3;
        }
        ...
        exgartuMonAndShouldraShowdown() {
            ...
            if (this.silly())
                this.outputText("  It's a man's right to choose what's done with his body.  Not anyone else's!");
            this.outputText("  You shout loud enough to get the two to at least shut up and notice you're there.  It's time to end this little battle once and for all, starting with your first - and hopefully last - involvement.");
            //[Keep Exgartuan]	[Keep Shouldra]	[Keep Both!]
            this.simpleChoices("Keep Exgartuan", this.keepExgartuanInsteadOfShouldra, "Keep Shouldra", this.keepShouldraAndKickOutExgartuan, "Keep Both", this.keepAllTheGhosts, "", undefined, "", undefined);
        }
        //Keep Exgartuan
        keepExgartuanInsteadOfShouldra() {
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("In no uncertain terms, you announce to your former paranormal partner that you're siding with the demon on this one.  [if (corruption > 75) \"He's just a better teammate to have when it comes to hot dickings.  \"]You place your hand around your [cock] as Exgartuan as he rubs up against you, approving of your decision.  Shouldra looks on in just complete disgust and confusion.");
        ...
        keepShouldraAndKickOutExgartuan() {
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("You decide to jump to Shouldra's side on this one, explaining to your demonic cock your desire to go your separate ways.  Exgartuan heartily laughs at you, your [cock] wiggling in the air with each mighty heave.");
            ...
            //PC has human dick
            this.player.cocks[0].cockType = CockTypesEnum_1.CockTypesEnum.HUMAN;
            //Exgartuan departs
            this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Exgartuan);
            //unlocks one more scene for later that night
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUDRAMA] = -0.5;
            this.doNext(this.playerMenu);
        }
        ...
        keepShouldraPartIIExgartumonsUndeatH() {
            ...
            this.outputText("While slipping into your bedroll to enjoy a peaceful night's sleep, a chill runs down your spine.  You look around to-");
            ...
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUDRAMA] = 0;
            //[next page]
        ...
        keepAllTheGhosts() {
            ...
            if (this.player.cumQ() >= 1000)
                this.outputText(", trails of your cum pouring out from them");
            this.outputText(".");
            ...
            this.player.changeStatusValue(StatusAffects_1.StatusAffects.Exgartuan, 2, (12 + ShouldraFollower.rand(7)));
            //unlocks follower dialog
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_EXGARTUDRAMA] = 4;
            this.doNext(this.playerMenu);
        }
        //Intro
        shouldraBakeryIntro() {
            ...
            //first time: 
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_BAKERY_TIMES] == 0)
                this.outputText("You smirk, wondering how exactly a ghost manages to work up a hunger.  Your skepticism is met by an intense stabbing pain in your stomach, forcing you to buckle slightly from the cramping.  It lasts only a moment before it vanishes, however.  \"<i>You feel that, smartass?</i>\" The ghost girl sneers, \"<i>That's what decades of fasting will do to you.");
            else
                this.outputText("You point out that she's already had something at the bakery.  \"<i>Yeah, I did.  And now I'm hungry again.  Deal with it.");
            this.outputText("  Now, how about a snack?  Or two?</i>\" Her enthusiasm is clear...  and slightly worrying.");
            this.simpleChoices("Continue", this.feedShouldraACake, "Bail Out", this.bailOut, "", undefined, "", undefined, "", undefined);
        }
        //Bail out (you pussy)
        bailOut() {
            this.clearOutput();
            this.spriteSelect(67);
            this.outputText("You quickly turn around and head back the way you came.  There's a moan of disappointment from Shouldra, before she settles down and goes back to doing whatever she usually does.  You try not to think about it as you leave the city and return to camp.");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //nter
        feedShouldraACake() {
        ...
        shouldraAndMaddieSittingInATree() {
            ...
            if (this.player.tone >= 60)
                this.outputText("well-toned");
            else if (this.player.thickness < 50)
                this.outputText("trim");
            else
                this.outputText("curvaceous");
            this.outputText(" figure...");
            //[Go along with it] [Resist]
            this.simpleChoices("Go Along", this.goAlongWIthShouldrasEatingSpree, "Resist", this.resistBeingAFatass, "", undefined, "", undefined, "", undefined);
        }
        //Go along with it
        goAlongWIthShouldrasEatingSpree() {
            ...
            //if repeat scene: 
            if (this.flags[kFLAGS_1.kFLAGS.SHOULDRA_BAKERY_TIMES] > 0)
                this.outputText("\"Man, you're not sure you want that kind of impact on your figure again...  \"");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0)
                this.outputText(", though not completely unwelcome");
            this.outputText(".  You blush furiously and back into the corner of the (now rather cold) booth");
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0) {
                this.outputText(" as your heart races and blood rushes down towards your ");
                if (this.player.hasCock()) {
                    this.outputText("drowsy member");
                    if (this.player.hasVagina())
                        this.outputText(" and ");
                }
                if (this.player.hasVagina())
                    this.outputText("trembling nether-lips");
                if (this.player.gender == 0)
                    this.outputText("groin");
            }
            this.outputText(", before you realize that nobody seems to notice your predicament.  Shouldra reads your thoughts and responds, \"<i>Thought you might appreciate some privacy");
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0)
                this.outputText(", even with that kink of yours");
            this.outputText(", Champ.  Here's something extra anyway, just in case.</i>\" One ghostly incantation later, and ");
            if (this.player.femininity <= 50)
                this.outputText("a buttoned shirt and pair of belted jeans");
            else
                this.outputText("a tight-fitting tank top and skirt");
            this.outputText(" adorn your person.");
            if (this.player.hasCock()) {
                ...
                if (this.player.cocks[0].cockLength < 8 || this.player.cocks[0].cockLength > 25)
                    this.outputText("\"<i>First though, let's change it to something more manageable.</i>\" Arcane sounds float up towards you, causing your shaft to shift and morph until your throbbing rod is around 2 feet long and dripping pre.  \"<i>Mmm, much better!</i>\"  ");
                this.outputText("Her eyes close as those sumptuous icing-white lips wrap around the [cockHead] of your aching dick, the cherry tongue canvassing your cockflesh like an artist, until she slowly, oh-so-slowly gulps down inch after gradual inch of your girth.  Her enormous chocolate rump is visible on the other side of the booth, lulling back and forth in contented bliss.");
            ...
            this.flags[kFLAGS_1.kFLAGS.SHOULDRA_BAKERY_TIMES]++;
            this.player.slimeFeed();
        }
        //Resist
        resistBeingAFatass() {
    ...
    exports.ShouldraFollower = ShouldraFollower;
});
//# sourceMappingURL=ShouldraFollower.js.map