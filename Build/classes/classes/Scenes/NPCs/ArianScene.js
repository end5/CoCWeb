define(["require", "exports", "./NPCAwareContent", "../../CoC", "../../GlobalFlags/kFLAGS", "../../StatusAffects", "../../../../includes/appearanceDefs"], function (require, exports, NPCAwareContent_1, CoC_1, kFLAGS_1, StatusAffects_1, appearanceDefs_1) {
    "use strict";
    ...
    */
    class ArianScene extends NPCAwareContent_1.NPCAwareContent {
        constructor() {
            super();
        ...
        timeChange() {
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COUNTER] > 0)
                this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COUNTER]++;
            if (this.model.time.hours > 23) {
                if (this.arianScene.arianFollower() && this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                    this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_EVENT]++;
                this.flags[kFLAGS_1.kFLAGS.ARIAN_LESSONS] = 0;
                this.flags[kFLAGS_1.kFLAGS.ARIAN_TREATMENT] = 0;
            }
            return false;
        }
        timeChangeLarge() {
        ...
        arianCockSize() {
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] < 0 || this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 3)
                return 0;
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 1)
                return 9;
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 2)
                return 16;
            else
                return 36;
        }
        arianFollower() {
            return this.flags[kFLAGS_1.kFLAGS.ARIAN_FOLLOWER] > 0;
        }
        arianMF(boy, girl) {
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                    return girl;
                else
                    return boy;
            }
        ...
        arianHealth(arg = 0) {
            if (arg != 0) {
                this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] += arg;
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] > 100)
                    this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] = 100;
                else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] < 0)
                    this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] = 0;
            }
            return this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH];
        }
        arianChestAdjective() {
            var buffer = "";
            var temp = ArianScene.rand(10);
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 0)
                return "";
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 1) {
                if (temp <= 4)
                    buffer += "small";
                else if (temp <= 6)
                    buffer += "petite";
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 2) {
                if (temp <= 3)
                    buffer += "generous";
                else if (temp <= 5)
                    buffer += "hand-filling";
        ...
        arianChest() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 0)
                return "chest";
            //Tits ahoy!
            if (ArianScene.rand(2) == 0)
                buffer += this.arianChestAdjective() + " ";
            //Name 'dose titays
            var temp = ArianScene.rand(10);
            if (temp <= 2)
                buffer += "tits";
        ...
        //[=Don't Help=]
        dontHelpArianWhenYouMeetHim(never = false) {
            this.clearOutput();
            ...
            if (never) {
                this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK] = -1;
            }
            else {
                this.flags[kFLAGS_1.kFLAGS.NOT_HELPED_ARIAN_TODAY] = 1;
            }
        ...
        //[=Help=]
        helpArianWhenYouMeetHim() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK] = 1;
            this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] = 1;
            this.flags[kFLAGS_1.kFLAGS.ARIAN_CAPACITY] = 50;
        ...
        visitThePark() {
            ...
            //Visit 1
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK] == 1) {
                this.outputText("\n\nFeeling ");
                if (this.player.cor < 50)
                    this.outputText("curious");
                else
                    this.outputText("bored");
            ...
            //Visit 2
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK] == 2) {
            ...
            //Visit 3
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK] == 3) {
                ...
                if (this.player.cor > 66)
                    this.outputText(", whilst privately thinking to yourself how useless that looks - no wonder they can't fight the demons if this is the best they're capable of");
                this.outputText(".");
                ...
                if (this.player.cor >= 66)
                    this.outputText(", keeping your real reasons for bothering with him to yourself");
                this.outputText(".");
            ...
            this.arianHealth(1);
            this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //First Visit
        visitAriansHouse() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] < 29 || this.flags[kFLAGS_1.kFLAGS.ARIAN_VIRGIN] == 1)
                this.arianHealth(1);
            if (this.arianFollower()) {
                ...
                if (temp == 0) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                        if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                            ...
                            this.outputText("jizz");
                    }
                    else
                        this.outputText("femjizz");
                    this.outputText(" and, indeed, still hovering over [Arian eir] ");
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                        if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                            this.outputText("twin sexual slits");
                        else {
                            this.outputText("cock");
                            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                                this.outputText("s");
                        }
                    }
                    else
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK] == 4) {
                    this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK]++;
                    ...
                    if (this.player.cor < 33)
                        this.outputText("curiously");
                    else if (this.player.cor < 66)
                        this.outputText("casually");
                    else
                        this.outputText("indifferently");
                    ...
                    if (!this.player.isTaur())
                        this.outputText("pull up a chair");
                    else
                        this.outputText("seat your tauric body on the floor");
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_HERM_CHAT] == 1) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HERM_CHAT] == 1) {
                        ...
                        //ArianGirlHermChat++;
                        this.flags[kFLAGS_1.kFLAGS.ARIAN_HERM_CHAT]++;
                    }
                    //0-9 health:
                    else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] < 10) {
                    ...
                    //10-19 health:
                    else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] < 20) {
                    ...
                    //20-29 health:
                    else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] < 30) {
                        //Repeat this until the PC decides to sex Arian up somehow.
                        if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VIRGIN] == 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] == 2) {
                    ...
                    //30-49 health:
                    else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] < 50) {
                    ...
                    //50-74 health
                    else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] < 75) {
                        ...
                        if (!this.player.isTaur())
                            this.outputText("take the offered chair");
                        else
                            this.outputText("the offered chair");
                        this.outputText(".");
                    ...
                    //75-100 health:
                        ...
                        if (!this.player.isTaur())
                            this.outputText(" and offers you the chair nearby");
        ...
        arianHomeMenu() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] == 0 && this.arianHealth() >= 10)
                this.addButton(0, "Next", this.arianStoryDialogue1);
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] == 1 && this.arianHealth() >= 20)
                this.addButton(0, "Next", this.arianStoryDialogue2);
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] == 2 && this.arianHealth() >= 30)
                this.addButton(0, "Next", this.arianDialogue3);
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] == 3 && this.arianHealth() >= 50)
                this.addButton(0, "Next", this.arianImbue);
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] == 4 && this.arianHealth() >= 75)
                this.addButton(0, "Next", this.arianPlot4);
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] == 5 && this.arianHealth() >= 100)
                this.addButton(0, "Next", this.arianPlot5);
            //If no story dialogue
            else {
                this.addButton(0, "Talk", this.talkToArianChoices);
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] >= 2)
                    this.addButton(1, "Sex", this.arianSexMenu);
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] >= 1)
                    this.addButton(3, "Give Item", this.giveArianAnItem);
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] >= 5)
                    this.addButton(4, "Treat Corr.", this.treatCorruption);
                if (this.model.time.hours >= 17 && this.arianFollower())
                    this.addButton(8, "Sleep With", this.sleepWithArian, true);
                if (this.flags[kFLAGS_1.kFLAGS.SLEEP_WITH] == "Arian")
                    this.addButton(8, "NoSleepWith", this.dontSleepWithArian);
                if (!this.arianFollower())
        ...
        peepOnArian() {
            ...
            if (this.player.lizardCocks() > 0)
                this.outputText(" just like yours");
        ...
        hermsLikeFemaleArian() {
            ...
            this.flags[kFLAGS_1.kFLAGS.ARIAN_HERM_CHAT] = 1;
            this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] = 1;
            this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] = 0;
            this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] = 1;
            this.menu();
            this.addButton(0, "Next", this.penetrateArian);
        }
        //[=Don't mind=]
        youDontMindBeingGayForArian() {
            this.clearOutput();
        ...
        //[=Like Girls=]
        youLikeGirlsNotSickLizardDudes() {
            this.clearOutput();
        ...
        arianStoryDialogue1() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetMarae) >= 0)
                ...
                this.outputText("you'd guess a long while ago given the general mess they seem to have made of the world.");
            ...
            //ArianSDialogue++;
            this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE]++;
        ...
        arianStoryPry() {
            ...
            if (this.player.cor < 40)
                this.outputText("; he'll sleep better with the burden off [Arian eir] conscience");
            this.outputText(".");
        ...
        arianPlot5() {
            ...
            if (this.camp.companionsCount() > 1)
                this.outputText("  There are other people living with you already, so what's one more?  Right?");
            this.outputText("</i>\"");
        ...
        talkToArianChoices() {
            ...
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VIRGIN] > 0)
                this.addButton(0, "Sexy Talk", this.arianSexingTalk);
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] >= 3)
                this.addButton(1, "Teach Magic", this.arianMagicLessons);
            if (!this.arianFollower() && this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] >= 6)
                this.addButton(4, "Invite2Camp", this.inviteArianToCamp);
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VIRGIN] == 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] < 3)
        ...
        arianMagicLessons() {
            ...
            //(if ArianMLesson >= 4)
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_LESSONS] >= 4) {
            ...
            if (this.player.inte < 25) {
                ...
                if (!this.arianFollower())
                    this.outputText("make your way back to your camp.");
                else
                    this.outputText("return to your duties.");
            }
            //(else if PC int < 50 //Teach Charge Weapon if PC doesn't know.
                ...
                if (!this.arianFollower())
                    this.outputText(", making your way back to camp.");
                else
                    this.outputText(", exiting [Arian eir] tent and going about your business.");
                //(if PC doesn't know Charge Weapon)
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.KnowsCharge) < 0) {
                    this.outputText("\n\nAs you ");
                    ...
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.KnowsCharge, 0, 0, 0, 0);
                }
            }
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.KnowsBlind) < 0) {
                    ...
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.KnowsBlind, 0, 0, 0, 0);
                    //Return to camp.
                }
                else {
                ...
                if (!this.arianFollower())
                    this.outputText("begin the trek home.");
                else
                    this.outputText("exit [Arian eir] tent.");
                //(if PC doesn't know Whitefire)
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.KnowsWhitefire) < 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.ARIAN_LESSONS]++;
            this.dynStats("int", 1);
            if (this.player.inte < 75)
                this.dynStats("int", 1);
        ...
        arianSexingTalk() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] != 0) {
                ...
                //Regular Cock.
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 1) {
                ...
                //Huge Cock.
                else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 3) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] < 33) {
                //No preference... yet.
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] < 66) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] <= 100) {
        ...
        takeYerLizardHomePartII() {
            ...
            if (this.camp.followersCount() > 1)
                this.outputText(" and your other companions");
            this.outputText(".");
        ...
        arianSexMenu(output = true) {
            if (output) {
                ...
                //(if ArianHealth < 100)
                else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] < 100) {
            ...
            if (this.player.hasCock()) {
                ...
                //PC must have a cock that fits (cock area 50 or less)
                if (this.player.cockThatFits(this.flags[kFLAGS_1.kFLAGS.ARIAN_CAPACITY]) >= 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                ...
                if (this.player.cockThatFits(50) >= 0 && this.player.cockThatFits2(50) >= 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                ...
                if (this.player.smallestCockArea() <= 30 && this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] < 3 && this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0)
            ...
            if (this.player.hasVagina()) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0 && (this.player.hasKeyItem("Dildo") >= 0 || this.player.hasKeyItem("Deluxe Dildo") >= 0)) {
        ...
        giveArianAnal() {
            ...
            this.clearOutput();
            this.arianHealth(3);
            this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] += 10;
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] >= 100)
                this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] = 100;
            this.flags[kFLAGS_1.kFLAGS.ARIAN_VIRGIN] += 1;
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] < 33) {
                ...
                //(if ArianVagina < 1)
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] < 1) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                        this.outputText("pair of reptilian pricks");
                    else
                        this.outputText("reptilian prick");
                }
                ...
                if (this.player.balls == 0)
                    this.outputText("the base of your cock");
                else
                    this.outputText("the bottom of your balls");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0)
                    this.outputText("spewing forth large gobs of cum of [Arian eir] own");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                    this.outputText(" and ");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                    this.outputText("wetting both your and her legs with a healthy serving of lizan pussy juice");
            ...
            //Loose, sensitive enough to make Arian scream in pleasure. (It's like a tight vagina, feels like one too, minor pain)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] < 1) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 1)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                    this.outputText(" a");
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                        this.outputText(" pair of dripping cocks");
                    else
                        this.outputText(" dripping cock");
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                        this.outputText(" and");
                }
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                    this.outputText(" a sopping wet pussy");
                this.outputText(" greet");
                if ((this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] == 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] == 0) || (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] == 1 && this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 0))
                    this.outputText("s");
                ...
                if (this.arianFollower())
                    this.outputText("tent");
                else
                    this.outputText("bedchamber");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] == 0)
                        this.outputText("cock spews its load");
                    else
                        this.outputText("twin cocks spew their loads");
                    this.outputText(" on the bedsheets");
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                        this.outputText(" and [Arian eir] ");
                }
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                    this.outputText(" contracting pussy paints your lower body with lizan femcum");
                ...
                if (this.player.balls == 0)
                    this.outputText("base of your spine");
                else
                    this.outputText("depths of your balls");
            ...
            //Very Loose, sensitive enough to make Arian cum just from insertion. (Feels better than anything else. Yep, Arian really becomes a buttslut at this point)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                    this.outputText("wet gash is positively leaking lizan juices");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0)
                    this.outputText(" and [Arian eir] ");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0)
                    this.outputText("erect cock is already leaking pre like a sieve");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                    this.outputText("her pussy clenches, spilling a flood of juices; ");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0)
                    this.outputText(" and ");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0)
                    this.outputText("his cock throbs and shoots rope after rope of cum onto the bedsheets");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                        this.outputText("cocks are still rock hard, and surprisingly, still leaking ropes of cum");
                    else
                        this.outputText("cock is still rock hard, and surprisingly, still leaking ropes of cum");
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                        this.outputText(", and her");
                }
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                    this.outputText(" pussy squirting juices against your [legs] with each shuddering impact of your [hips]");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0)
                    this.outputText("  [Arian Eir] throbbing cock flexes and shoots one last rope of lizan-cum against your belly.");
                ...
                //(ArianAssChat == 0)
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ASS_CHAT] == 0) {
                    ...
                    if (9999 == 9999)
                        this.outputText(" as hypocritical as that may be");
                    ...
                    if (!this.arianFollower())
                        this.outputText("back to Tel'Adre's streets, and from there back to camp.");
                    else
                        this.outputText("out of [Arian eir] tent.");
                    this.flags[kFLAGS_1.kFLAGS.ARIAN_ASS_CHAT]++;
                }
                else {
        ...
        getBlownByArian() {
            ...
            //(if ArianHasBlown == 0)
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HAS_BLOWN] == 0) {
                this.outputText("\n\nThe lizan averts [Arian eir] eyes, snapping out of [Arian eir] reverie.");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 3)
                    this.outputText("  You notice Arian's exposed shaft slowly hardening at your invitation.");
            ...
            if (this.player.cumQ() >= 1500)
                this.outputText(", in fact, you're amazed [Arian ey] didn't pop with how much [Arian ey] drank");
            ...
            if (this.player.cumQ() >= 1000)
                this.outputText(" which, considering the fact [Arian ey] looks like a mother ready to birth a toddler from the size of [Arian eir] belly, isn't as easy as you'd think");
            ...
            if (this.player.cumQ() >= 250)
                this.outputText(", [Arian eir] gut audibly sloshing as the cum inside is churned by the impact");
            this.outputText(".");
            ...
            if (!this.arianFollower())
                this.outputText(" back to camp, stopping only to notify Laika and Boon that Arian is sleeping.");
            else
                this.outputText(" out of Arian's tent.");
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.ARIAN_HAS_BLOWN]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Penetrate:
        //Arian must be herm/female.
        ...
        penetrateArian() {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                this.outputText(", her bulbous cock");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("s peeking out of their");
                else
                    this.outputText(" peeking out of its");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("s twitch as they spurt ");
                else
                    this.outputText(" twitches as it spurts ");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("twin cocks throb");
                else
                    this.outputText("cock throbs");
            ...
            if (this.player.hasVagina())
                this.outputText(" A wash of fluids spills down your body from your cunt as it spasms in release and y");
            else
                this.outputText("Y");
            ...
            if (this.player.cumQ() < 250)
                this.outputText("lean");
            else if (this.player.cumQ() < 1000)
                this.outputText("full");
            else
                this.outputText("overfilled");
        ...
        getButtWreckedByArian() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] >= 3) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("s peek out of their");
                else
                    this.outputText(" peeks out of its");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outputText("stroking [Arian eir] other cock and sliding it between your ass cheeks, ");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] > 66)
                this.outputText("eager ");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outputText("pair of lizan-cocks practically jump");
            else
                this.outputText("lizan-cock practically jump");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outputText("sliding [Arian eir] neglected prick through your ass-cheeks, ");
            ...
            if (this.player.hasVagina())
                this.outputText("cunt dripping with arousal");
            if (this.player.hasCock() && this.player.hasVagina())
                this.outputText(" and ");
            if (this.player.hasCock()) {
                this.outputText("cock");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outputText("s twitch");
            else
                this.outputText(" twitches");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outputText(", as well as your butt");
            this.outputText(", as Arian climaxes");
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                this.outputText(", her own pussy clenching and drizzling juices on the matted sheets beneath the two of you.");
            else
                this.outputText(".");
            ...
            if (this.player.hasCock())
                this.outputText("  [EachCock] spasms and shoots rope after rope of cum, painting Arian's [arian chest] white, as well as the groaning lizan's face.");
            if (this.player.hasVagina())
                this.outputText("  Your [pussy], though unattended, joins in the perverted display, leaking copious amount of fluids on top of the prone lizan.");
            ...
            //(if AnalXP <= 100)
                ...
                if (this.player.hasCock()) {
                    ...
                    if (this.player.cockThatFits(50) >= 0 && this.player.hasCock())
                        ...
                        this.outputText(".  You're too big to fit inside Arian's ass, though.");
        ...
        suckAriansDick() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 3) {
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("exposed cocks hardening to full mast");
                else
                    this.outputText("exposed cock hardening to full mast");
            }
            else {
                this.outputText("cock");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("s emerging from their");
                else
                    this.outputText(" emerging from its");
            ...
            this.outputText("shaft");
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outputText("s tremble");
            else
                this.outputText(" trembles");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outputText(", oblivious to the second cock spewing cum all over your [chest] in your eagerness");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                this.outputText(" and tickle her cunt with a finger");
        ...
        //PC must have a vagina.
        //Arian must have a cock.
        getPenetratedByArianAndHisHitlerMustache() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.ARIAN_VIRGIN] += 1;
            this.arianHealth(3);
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] < 3)
                this.outputText("slit, and think of what it's hiding in there");
            else {
                this.outputText("exposed cock");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("s");
            ...
            if (this.player.isBiped())
                this.outputText("spread your [legs] and ");
            this.outputText("expose your [vagina] to [Arian eir] viewing pleasure.  The reaction is almost instantaneous; Arian's ");
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] >= 3)
                this.outputText("exposed");
            else
                this.outputText("hidden");
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outputText(" twin shafts immediately fill");
            else
                this.outputText(" shaft immediately fills");
            ...
            if (this.player.hasLongTail())
                this.outputText(", looping your tail around [Arian eir] waist");
            this.outputText(".");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0) {
                ...
                if (this.player.hasLongTail())
                    this.outputText(", further encouraging [Arian em] to do so, by looping your tail around [Arian eir] waist");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outputText("twin bulbous shafts feel");
            else
                this.outputText("bulbous shaft feels");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] == 0)
                this.outputText("[Arian ey] himself ");
            else
                this.outputText("she ");
            this.outputText("is being overwhelmed by, spraying your ");
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] == 0)
                this.outputText("cavity");
            else
                this.outputText("cavities");
        ...
        //PC must have at least 2 cocks that fit. That means two cocks with a cock area of <= 50.
        //This isn't meant to give AnalXP, but given the fact that Arian's ass will get pen'd it would also be justified. Up to you Fen!
        doublePenetrateArian() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.ARIAN_VIRGIN] += 1;
            this.arianHealth(3);
            this.outputText(this.images.showImage("arianfemale-home-doublepenetrate"));
            var x = this.player.cockThatFits(this.flags[kFLAGS_1.kFLAGS.ARIAN_CAPACITY]);
            var y = this.player.cockThatFits2(this.flags[kFLAGS_1.kFLAGS.ARIAN_CAPACITY]);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_PENETRATION_CHAT] == 0) {
        ...
        arianDocking() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] == 0)
                this.outputText(" brushing up against [Arian eir] own lizan pecker");
            else
                this.outputText("sandwiched between [Arian eir] two lizard dicks");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                this.outputText("pair of cummy masts emerge");
            else
                this.outputText("cummy mast emerges");
        ...
        giveArianAnItem() {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] < 20) { //May only give Vitality T.
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_S_DIALOGUE] == 0 && this.arianHealth() >= 10)
                ...
                if (this.player.hasItem(this.consumables.VITAL_T))
                    this.addButton(0, "Vital Tinct", this.arianVitalityTincture);
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_HEALTH] >= 20) {
                    if (this.player.hasItem(this.consumables.P_DRAFT))
                        this.addButton(1, "P. Incubi D", this.giveIncubusDraftToArian);
                    if (this.player.hasItem(this.consumables.P_S_MLK))
                        this.addButton(2, "P. Suc.Milk", this.succubiMilkForArian);
                    if (this.player.hasItem(this.consumables.LACTAID))
                        this.addButton(3, "Lactaid", this.giveArianLactaid);
                    if (this.player.hasItem(this.consumables.REDUCTO))
                        this.addButton(4, "Reducto", this.giveArianReducto);
                    if (this.player.hasItem(this.consumables.REPTLUM))
                        this.addButton(5, "Reptilum", this.giveArianReptilum);
                }
                this.addButton(9, "Back", this.arianHomeMenu);
            }
        }
        ...
        giveIncubusDraftToArian() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0)
                this.outputText("if [Arian ey] would like to make [Arian eir] cock bigger");
            else
                this.outputText("if she'd like to have a touch of her old malehood back");
            this.outputText(".");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 0) {
                this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE]++;
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] == 0)
                    this.outputText("shaft emerges from its hiding place.  It throbs and grows, settling in its");
                else
                    this.outputText("pair of shafts emerge from their hiding place.  They throb and grow, settling in their");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("s back into their");
                else
                    this.outputText(" back into its");
                this.outputText(" slit.");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 2) {
                    this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE]++;
                    this.dynStats("lus", 10 + this.player.lib / 20);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] > 1 && (!this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
                this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS]--;
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 1 && (!this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) { //Now you are male again.
                ...
                this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] = 0;
                this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] = 0;
        ...
        succubiMilkForArian() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] == 0) {
                this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA]++;
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 0)
                    this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS]++;
                ...
                //if ArianCockSize >= 3:
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 3)
                    this.outputText(" as far as it'll go");
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] < 3) {
                this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS]++;
                ...
                //(if ArianBreasts == 2)
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 2) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] >= 3)
                        this.outputText(" and her exposed shaft begins to grow hard");
                    this.outputText(".");
                }
                else {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 3)
                        this.outputText(" and you see her exposed shaft slowly rising to point at you");
                    this.outputText(".");
            ...
            //(else If ArianCockSize > 1) //Dick shrinkage.
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 1 && (!this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 1 && this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] >= 1 && (!this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
                ...
                this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] = 0;
            }
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 1 && (!this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
                this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] = 0;
        ...
        giveArianLactaid() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 3)
                    this.outputText(", her exposed cock growing hard as she flushes with arousal");
                this.outputText(".  Her hands grip the sheets and you watch her ");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 1)
                    this.outputText("perky");
                else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 2)
                    this.outputText("luscious");
                else
                    this.outputText("pillowy");
                ...
                //(if ArianBreasts < 3)
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] < 3) {
                    this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS]++;
        ...
        giveArianReducto() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0)
                this.addButton(1, "Cock", this.useReductoOnArianCocks);
            this.addButton(2, "Asshole", this.useReductoOnAriansAsshole);
        }
        //Breasts:
        //Cannot go flat
        useReductoOnAriansBreasts() {
            this.clearOutput();
        ...
        useReductoOnArianCocks() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] == 3) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("pair of exposed lizard cocks");
                else
                    this.outputText("exposed lizard cock");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("s from their tight hiding place");
                else
                    this.outputText(" from its tight hiding place");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("s return to their");
                else
                    this.outputText(" returns to its");
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0) {
        ...
        useReductoOnAriansAsshole() {
            ...
            //(if AnalXP == 1)
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] <= 1) {
            ...
            //(else if AnalXP < 33)
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] < 33) {
                ...
                this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] = 1;
            }
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] < 66) {
                this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] -= 33;
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                        this.outputText("s suddenly jolting from their sheathe");
                    else
                        this.outputText(" suddenly jolting from its sheathe");
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                        this.outputText(" and ");
                }
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0) {
        ...
        giveArianReptilum() {
            ...
            //(if ArianFirstRept == 1)
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_FIRST_REPTILUM] == 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.ARIAN_FIRST_REPTILUM]++;
            //(if ArianFirstRept == 1)
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_FIRST_REPTILUM] == 1)
            ...
            if (!this.player.hasVagina() && !this.player.hasCock())
                this.outputText("genderless crotch");
            this.outputText(".  \"<i>Hmm, that looks much tastier than candy actually.</i>\"  [Arian Ey] licks your ");
            if (this.player.hasCock())
                this.outputText("cock from base to tip");
            else if (this.player.hasVagina())
                this.outputText("pussy all the way from the back to the tip of your [clit]");
            else
                this.outputText("your sweaty crotch");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                this.outputText("slavering vagina");
            this.outputText(".");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 0)
                    ...
                    this.outputText("perky little breasts");
                else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_BREASTS] == 2)
                    this.outputText("soft breasts");
                else
                    this.outputText("pillowy breasts");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                    this.outputText(" while ");
            }
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                this.outputText("her vagina doing its best to soak her bed with lizan femcum");
            this.outputText(".");
            ...
            if (ArianScene.rand(2) == 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] == 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
            ...
            if (tfed) {
                ...
                this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] = 1;
            }
            else {
        ...
        treatCorruption() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_TREATMENT] == 1) {
                ...
                this.dynStats("cor", -1);
                this.fatigue(20);
                if (this.player.cor == 0)
                    this.outputText(" - in fact, you're quite sure that Arian has purified you entirely");
                ...
                this.flags[kFLAGS_1.kFLAGS.ARIAN_TREATMENT]++;
                this.doNext(this.camp.returnToCampUseOneHour);
            }
        }
        //Imbue Talisman
        ...
        imbueTalisman() {
            ...
            if (this.player.hasKeyItem("Arian's Talisman") >= 0)
                this.outputText("place a spell in the enchanted talisman [Arian ey] created for you");
            else
                this.outputText("change the spell in the talisman [Arian ey] created for you");
            ...
            */
            ...
            this.menu();
            if (this.player.hasItem(this.useables.B_CHITN, 2) && this.player.hasItem(this.useables.T_SSILK))
                this.addButton(0, "Shielding", this.arianSpellPlace, "Shielding Spell");
            if (this.player.hasItem(this.consumables.GOB_ALE, 2) && this.player.hasItem(this.consumables.S_GOSSR))
                this.addButton(1, "Immolation", this.arianSpellPlace, "Immolation Spell");
            this.addButton(9, "Back", this.arianHomeMenu);
        }
        arianSpellPlace(spell) {
            this.clearOutput();
            ...
            if (spell == "Shielding Spell") {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.ShieldingSpell, 0, 0, 0, 0);
                //Shielding Spell: 2x Black Chitin and 1x Tough Silk. - Increases defense for the duration of the battle.
                this.player.consumeItem(this.useables.B_CHITN, 2);
                this.player.consumeItem(this.useables.T_SSILK);
            }
            if (spell == "Immolation Spell") {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.ImmolationSpell, 0, 0, 0, 0);
                //Immolation Spell: 2x Goblin Ale and 1x Sweet Gossamer. - Deals damage over time.
        ...
        clearCharges() {
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.ShieldingSpell) >= 0)
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.ShieldingSpell);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.ImmolationSpell) >= 0)
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.ImmolationSpell);
        }
        clearTalisman() {
        ...
        */
        //Approach Arian
        //Sleep With Arian
        sleepWithArian(newl = false) {
            if (newl)
                this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.SLEEP_WITH] = "Arian";
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                this.outputText("You can tell that [Arian ey] is aroused by the little show, despite [Arian eir] body doing a good job of hiding it.  ");
        ...
        //[=Listen=]
        listenToLowAnalXPArian() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.ARIAN_MORNING] = 1;
        ...
        listenToMediumAnalXPArian() {
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cor >= 66)
                    this.outputText(", despite the silly lizan being deserving of it");
        ...
        wakeUpAfterArianSleep() {
            ...
            if (this.player.hasCock()) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] < 33) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0) {
                        ...
                        this.outputText(this.arianMF("his", "her") + " ");
                        if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                            this.outputText("twin shafts are");
                        else
                            this.outputText("shaft is");
                    ...
                    if (!this.player.hasVagina())
                        this.outputText("Did [Arian ey] always know [Arian ey] wanted a man to top [Arian em], or is this development new to [Arian em]?");
                    else
                        this.outputText("Does [Arian ey] really get off on having a girl with a dick all her own fuck [Arian em] like a girl, hmm?");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_ANAL_XP] < 33) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                        ...
                        if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                            this.outputText("s begin");
                        else
                            this.outputText(" begins");
                        this.outputText(" sporting an erection");
                        if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] < 3) {
                            this.outputText(", poking ");
                            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] == 1)
                                this.outputText("its tip");
                            else
                                this.outputText("their tips");
                            this.outputText(" out of Arian's genital slit");
                        }
                        this.outputText(".");
                    }
                    else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_VAGINA] > 0)
                        this.outputText("and her moist pussy, begins forming a stream of juices that gently run its course through the inside of Arian's thighs, evaporating before hitting the floor due to the lizan's currently elevated body heat.");
            ...
            this.flags[kFLAGS_1.kFLAGS.ARIAN_MORNING] = 0;
        ...
        arianEggingEvent() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_EVENT] = 1;
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_CHAT] == 0) {
                this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_CHAT]++;
        ...
        //Pick a color
        pickAnEggArian(color = "pink") {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COLOR] = color;
            ...
            this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COUNTER] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Leave
        leaveEggs() {
        ...
        arianLaysEggs() {
            this.clearOutput();
            var color = this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COLOR];
            this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COUNTER] = 0;
            ...
            var itype;
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COLOR] == "brown")
                itype = this.consumables.L_BRNEG;
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COLOR] == "purple")
                itype = this.consumables.L_PRPEG;
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COLOR] == "blue")
                itype = this.consumables.L_BLUEG;
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COLOR] == "pink")
                itype = this.consumables.L_PNKEG;
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COLOR] == "white")
                itype = this.consumables.L_WHTEG;
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_EGG_COLOR] == "rubbery black")
        ...
        arianDildoFun() {
            ...
            this.clearOutput();
            //1st time:
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_ARIAN_DILDOED] == 0) {
                ...
                if (this.player.hasKeyItem("Dildo") >= 0)
                    this.outputText("bought from Giacomo");
                else
                    this.outputText("got from Tamani");
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_ARIAN_DILDOED]++;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_COCK_SIZE] > 0) {
                this.outputText("Her cock");
                if (this.flags[kFLAGS_1.kFLAGS.ARIAN_DOUBLE_COCK] > 0)
                    this.outputText("s throb");
                else
                    this.outputText("throbs");
    ...
    exports.ArianScene = ArianScene;
});
//# sourceMappingURL=ArianScene.js.map