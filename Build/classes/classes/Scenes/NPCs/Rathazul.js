define(["require", "exports", "./NPCAwareContent", "../../CoC", "../../GlobalFlags/kFLAGS", "../../StatusAffects", "../../PerkLib", "../../../console", "../../../../includes/appearanceDefs"], function (require, exports, NPCAwareContent_1, CoC_1, kFLAGS_1, StatusAffects_1, PerkLib_1, console_1, appearanceDefs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Rathazul extends NPCAwareContent_1.NPCAwareContent {
        ...
        timeChange() {
            if (this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] > 1) {
                this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN]--;
                if (this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] < 1)
                    this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] = 1;
                if (this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] > 300)
                    this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] = 24;
            }
            if (this.flags[kFLAGS_1.kFLAGS.RATHAZUL_CAMP_INTERACTION_COUNTDOWN] > 0) {
                this.flags[kFLAGS_1.kFLAGS.RATHAZUL_CAMP_INTERACTION_COUNTDOWN]--;
                if (this.flags[kFLAGS_1.kFLAGS.RATHAZUL_CAMP_INTERACTION_COUNTDOWN] < 0)
                    this.flags[kFLAGS_1.kFLAGS.RATHAZUL_CAMP_INTERACTION_COUNTDOWN] = 0;
            }
            return false;
        }
        timeChangeLarge() {
        ...
        encounterRathazul() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_PURIFICATION_STAGE] == 2 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetRathazul) >= 0) {
            ...
            //Introduction
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetRathazul) >= 0) {
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0)
                    this.outputText("You walk over to Rathazul's corner of the camp.  He seems as busy as usual, with his nose buried deep in some tome or alchemical creation, but he turns to face you as soon as you walk within a few paces of him.\n\n", true);
                else
                    this.outputText("You spy the familiar sight of the alchemist Rathazul's camp along the lake.  The elderly rat seems to be oblivious to your presence as he scurries between his equipment, but you know him well enough to bet that he is entirely aware of your presence.\n\n", true);
            }
            else {
                this.outputText("You encounter a hunched figure working as you come around a large bush.  Clothed in tattered robes that obscure most his figure, you can nontheless see a rat-like muzzle protruding from the shadowy hood that conceals most of his form.  A simple glance behind him confirms your suspicions - this is some kind of rat-person.  He seems oblivious to your presence as he stirs a cauldron of viscous fluid with one hand; a neat stack of beakers and phials sit in the dirt to his left.  You see a smile break across his aged visage, and he says, \"<i>Come closer child.  I will not bite.</i>\"\n\nApprehensive of the dangers of this unknown land, you cautiously approach.\n\n\"<i>I am Rathazul the Alchemist.  Once I was famed for my miracle cures.  Now I idle by this lake, helpless to do anything but measure the increasing amounts of corruption that taint its waters,</i>\" he says as he pulls back his hood, revealing the entirety of his very bald and wrinkled head.\n\n", true);
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.MetRathazul, 0, 0, 0, 0);
            }
            //Camp offer!
            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.MetRathazul) >= 3 && this.player.statusAffectv3(StatusAffects_1.StatusAffects.MetRathazul) != 1 && this.player.cor < 75) {
                this.outputText("\"<i>You know, I think I might be able to do this worn-out world a lot more good from your camp than by wandering around this lake.  What do you say?</i>\" asks the rat.\n\n(Move Rathazul into your camp?)", false);
                ...
                this.player.changeStatusValue(StatusAffects_1.StatusAffects.MetRathazul, 3, 1);
                return;
            }
            offered = this.rathazulWorkOffer();
            if (!offered) {
                this.outputText("He sighs dejectedly, \"<i>I am not sure what I can do for you, youngling.  This world is fraught with unimaginable dangers, and you're just scratching the surface of them.</i>\"\n\nYou nod and move on, leaving the depressed alchemist to his sadness.", false);
                this.doNext(this.camp.returnToCampUseOneHour);
            }
        }
        rathazulMoveToCamp() {
            this.clearOutput();
            this.outputText("Rathazul smiles happily back at you and begins packing up his equipment.  He mutters over his shoulder, \"<i>It will take me a while to get my equipment moved over, but you head on back and I'll see you within the hour.  Oh my, yes.</i>\"\n\nHe has the look of someone experiencing hope for the first time in a long time.");
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.CampRathazul, 0, 0, 0, 0);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        rathazulMoveDecline() {
            this.clearOutput();
            this.outputText("Rathazul wheezes out a sigh, and nods.\n\n\"<i>Perhaps I'll still be of some use out here after all,</i>\" he mutters as he packs up his camp and prepares to head to another spot along the lake.");
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        campRathazul() {
            this.spriteSelect(49);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] == 1 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00275] > 0) {
                this.collectRathazulArmor();
                return;
            }
            //Special rathazul/follower scenes scenes.
            if (Rathazul.rand(6) == 0 && this.flags[kFLAGS_1.kFLAGS.RATHAZUL_CAMP_INTERACTION_COUNTDOWN] == 0) {
                this.flags[kFLAGS_1.kFLAGS.RATHAZUL_CAMP_INTERACTION_COUNTDOWN] = 3;
                //Pure jojo
                if (this.flags[kFLAGS_1.kFLAGS.JOJO_RATHAZUL_INTERACTION_COUNTER] == 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.PureCampJojo) >= 0 && this.flags[kFLAGS_1.kFLAGS.JOJO_DEAD_OR_GONE] == 0) {
                    this.finter.jojoOffersRathazulMeditation();
                    return;
                }
                if (this.flags[kFLAGS_1.kFLAGS.AMILY_MET_RATHAZUL] == 0 && this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] == 1 && this.amilyScene.amilyFollower()) {
                    this.finter.AmilyIntroducesSelfToRathazul();
                    return;
                }
                if (this.flags[kFLAGS_1.kFLAGS.AMILY_MET_RATHAZUL] == 1 && this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] == 1 && this.amilyScene.amilyFollower()) {
                    this.finter.amilyIngredientDelivery();
                    return;
                }
                if (this.flags[kFLAGS_1.kFLAGS.AMILY_MET_RATHAZUL] == 2 && this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] == 1 && this.amilyScene.amilyFollower()) {
            ...
            if (this.player.lust > 90)
                this.dynStats("lus", -5);
            //Introduction
            this.outputText("Rathazul looks up from his equipment and gives you an uncertain smile.\n\n\"<i>Oh, don't mind me,</i>\" he says, \"<i>I'm just running some tests here.  Was there something you needed, " + this.player.short + "?</i>\"\n\n", true);
            //player.createStatusAffect(StatusAffects.metRathazul,0,0,0,0);
            offered = this.rathazulWorkOffer();
            if (!offered) {
                this.outputText("He sighs dejectedly, \"<i>I don't think there is.  Why don't you leave me be for a time, and I will see if I can find something to aid you.</i>\"", false);
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0)
        ...
        rathazulWorkOffer() {
            ...
            var dyes = undefined;
            if (this.player.hasItem(this.consumables.BLACKEG) || this.player.hasItem(this.consumables.L_BLKEG)) {
                this.flags[kFLAGS_1.kFLAGS.PC_KNOWS_ABOUT_BLACK_EGGS] = 1;
                spoken = true;
                this.outputText("He eyes the onyx egg in your inventory and offers a little advice.  \"<i>Be careful with black eggs.  They can turn your skin to living latex or rubber.  The smaller ones are usually safer, but everyone reacts differently.  I'd get rid of them, if you want my opinion.</i>\"\n\n");
            }
            //Item crafting offer
            if (this.player.hasItem(this.useables.GREENGL, 2)) {
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.RathazulArmor) < 0)
                    this.outputText("He pipes up with a bit of hope in his voice, \"<i>I can smell the essence of the tainted lake-slimes you've defeated, and if you'd let me, I could turn it into something a bit more useful to you.  You see, the slimes are filled with the tainted essence of the world-mother herself, and once the taint is burned away, the remaining substance remains very flexible but becomes nearly impossible to cut through.  With the gel of five defeated slimes I could craft you a durable suit of armor.</i>\"\n\n", false);
                else
                    this.outputText("He pipes up with a bit of excitement in his voice, \"<i>With just five pieces of slime-gel I could make another suit of armor...</i>\"\n\n", false);
                spoken = true;
            ...
            if (this.player.hasItem(this.useables.B_CHITN)) {
                this.outputText("The elderly rat looks at you intently and offers, \"<i>I see you've gathered a piece of chitin from the giant bees of the forests.  If you bring me five pieces I could probably craft it into some tough armor.</i>\"\n\n", false);
                spoken = true;
                if (this.player.hasItem(this.useables.B_CHITN, 5)) {
                    ...
                    this.outputText("(You need five pieces of chitin for Rathazul to make you the chitinous armor.)\n\n", false);
                }
            }
            var pCounter = 0;
            ...
            //Single Offer
            if (pCounter == 1) {
                this.outputText("The rat mentions, \"<i>I see you have at least one tainted item on you... for 20 gems I could remove most of the taint, making it a good deal safer to use.  Of course, who knows what kind of freakish transformations it would cause...</i>\"\n\n", false);
                spoken = true;
                totalOffers++;
            }
            if (pCounter > 1) {
                this.outputText("The rat mentions, \"<i>I see you have a number of demonic items on your person.  For 20 gems I could attempt to remove the taint from one of them, rendering it a good deal safer for consumption.  Of course it would not remove most of the transformative properties of the item...</i>\"\n\n", false);
                spoken = true;
                totalOffers += 2;
            }
            //Offer dyes if offering something else.
            if (this.player.gems >= 50) {
                this.outputText("Rathazul offers, \"<i>Since you have enough gems to cover the cost of materials for my dyes as well, you could buy one of my dyes for your hair.  I will need 50 gems up-front.</i>\"\n\n", false);
                spoken = true;
                totalOffers++;
                dyes = this.buyDyes;
            }
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.MetRathazul) >= 4) {
                this.outputText("The rat hurries over to his supplies and produces a container of paste, looking rather proud of himself, \"<i>Good news everyone!  I've developed a paste you could use to shrink down any, ah, oversized body parts.  The materials are expensive though, so I'll need ");
                if (this.flags[kFLAGS_1.kFLAGS.AMILY_MET_RATHAZUL] >= 2)
                    this.outputText("50");
                else
                    this.outputText("100");
                this.outputText(" gems for each jar of ointment you want.</i>\"\n\n");
                totalOffers++;
                spoken = true;
                reductos = this.buyReducto;
            }
            //SPOIDAH
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0 && this.player.hasItem(this.useables.T_SSILK) && this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00275] == 0) {
                showArmorMenu = true;
                spoken = true;
                totalOffers++;
                this.outputText("\"<i>Oooh, is that some webbing from a giant spider or spider-morph?  Most excellent!  With a little bit of alchemical treatment, it is possible I could loosen the fibers enough to weave them into something truly magnificent - armor, or even a marvelous robe,</i>\" offers Rathazul.\n\n", false);
            }
            //Vines
            if (this.player.hasKeyItem("Marae's Lethicite") >= 0 && this.player.keyItemv2("Marae's Lethicite") < 3 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.DefenseCanopy) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0) {
                this.outputText("His eyes widen in something approaching shock when he sees the Lethicite crystal you took from Marae.  Rathazul stammers, \"<i>By the goddess... that's the largest piece of lethicite I've ever seen.  I don't know how you got it, but there is immense power in those crystals.  If you like, I know a way we could use its power to grow a canopy of thorny vines that would hide the camp and keep away imps.  Growing such a defense would use a third of that lethicite's power.</i>\"\n\n");
                totalOffers++;
                spoken = true;
                lethiciteDefense = this.growLethiciteDefense;
            }
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0) {
                if (this.flags[kFLAGS_1.kFLAGS.RATHAZUL_DEBIMBO_OFFERED] == 0 && (this.sophieBimbo.bimboSophie() || this.player.findPerk(PerkLib_1.PerkLib.BimboBrains) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.FutaFaculties) >= 0)) {
                    this.rathazulDebimboOffer();
                    return true;
                }
                else if (this.flags[kFLAGS_1.kFLAGS.RATHAZUL_DEBIMBO_OFFERED] > 0) {
                    this.outputText("You recall that Rathazul is willing to make something to cure bimbo liqueur for 250 gems and five Scholar's Teas.");
                    if (this.player.hasItem(this.consumables.SMART_T, 5) && this.player.gems >= 250) {
                        ...
                        this.outputText("  You should probably find some if you want that...");
                    else
                        this.outputText("  You need more gems to afford that, though.");
                    this.outputText("\n\n");
                }
            }
            ...
            if (totalOffers > 0) {
                ...
                this.menu();
                if (showArmorMenu)
                    this.addButton(0, "Armor", this.rathazulArmorMenu);
                if (debimbo > 0)
                    this.addButton(1, "Debimbo", this.makeADeBimboDraft);
                this.addButton(2, "Buy Dye", dyes);
                if (lethiciteDefense != undefined)
                    this.addButton(3, "Lethicite", lethiciteDefense);
                this.addButton(4, "Purify", purify);
                if (reductos != undefined)
                    this.addButton(8, "Reducto", reductos);
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0)
        ...
        rathazulPurifyIncubiDraft() {
            this.clearOutput();
            if (this.player.gems < 20) {
                this.outputText("Rathazul says, \"<i>You do not have enough gems for that service.</i>\"");
            ...
            this.player.addStatusValue(StatusAffects_1.StatusAffects.MetRathazul, 2, 1);
        }
        rathazulPurifySuccubiMilk() {
            this.clearOutput();
            if (this.player.gems < 20) {
                this.outputText("Rathazul says, \"<i>You do not have enough gems for that service.</i>\"");
                this.doNext(this.returnToRathazulMenu);
        ...
        rathazulDebimboOffer() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RATHAZUL_DEBIMBO_OFFERED] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.RATHAZUL_DEBIMBO_OFFERED]++;
            }
            //Rath menu
            this.menu();
        ...
        rathazulArmorMenu() {
            this.spriteSelect(49);
            this.clearOutput();
            var beeArmor = (this.player.hasItem(this.useables.B_CHITN, 5) ? this.craftCarapace : undefined);
            var gelArmor = (this.player.hasItem(this.useables.GREENGL, 5) ? this.craftOozeArmor : undefined);
            var silk = undefined;
            this.outputText("Which armor project would you like to pursue with Rathazul?");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampRathazul) >= 0 && this.player.hasItem(this.useables.T_SSILK) && this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00275] == 0) {
                silk = this.craftSilkArmor;
            }
            this.simpleChoices("BeeArmor", beeArmor, "GelArmor", gelArmor, "SpiderSilk", silk, "", undefined, "Back", this.returnToRathazulMenu);
        }
        craftSilkArmor() {
            this.spriteSelect(49);
            ...
            this.outputText("The rat limps over to his equipment, spider-silk in hand.  With efficient, practiced motions, he runs a few tests.  As he finishes, he sighs and explains, \"<i>This will be harder than I thought.  The webbing is highly resistant to most of my alchemic reagents.  To even begin to work with such material I will need a number of rare, expensive elements.  I would need 500 gems to even start such a project.</i>\"\n\n", false);
            this.outputText("You can't help but sigh when he names such a sizable figure.  Do you give him the 500 gems and spider-silk in order for him to create you a garment?", false);
        ...
        commissionSilkArmorForReal() {
            this.spriteSelect(49);
            this.outputText("", true);
            this.outputText("You sort 500 gems into a pouch and toss them to Rathazul, along with the rest of the webbing.  The wizened alchemist snaps the items out of the air with lightning-fast movements and goes to work immediately.  He bustles about with enormous energy, invigorated by the challenging task before him.  It seems Rathazul has completely forgotten about you, but as you turn to leave, he calls out, \"<i>What did you want me to make?  A mage's robe or some nigh-impenetrable armor?</i>\"\n\n", false);
        ...
        declineSilkArmorCommish() {
            this.spriteSelect(49);
            this.outputText("", true);
            this.outputText("You take the silk back from Rathazul and let him know that you can't spend 500 gems on a project like that right now.  He sighs, giving you a crestfallen look and a slight nod of his hooded muzzle.", false);
            this.doNext(this.returnToRathazulMenu);
        }
        chooseArmorOrRobes(robeType) {
            this.spriteSelect(49);
            this.outputText("Rathazul grunts in response and goes back to work.  You turn back to the center of your camp, wondering if the old rodent will actually deliver the wondrous item that he's promised you.", true);
            this.doNext(this.camp.returnToCampUseOneHour);
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00275] = robeType;
            this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] = 24;
            console_1.trace("274: " + this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN]);
        }
        collectRathazulArmor() {
            this.spriteSelect(49);
            this.outputText("", true);
            this.outputText("Rathazul beams and ejaculates, \"<i>Good news everyone!  Your ", false);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00275] == 1)
                this.outputText("armor", false);
            else
                this.outputText("robe", false);
            this.outputText(" is finished!</i>\"\n\n", false);
            //Robe
            var itype;
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00275] == 2) {
                this.outputText("Hanging from a small rack is a long, flowing robe.  It glitters brightly in the light, the pearl-white threads seeming to shimmer and shine with every ripple the breeze blows through the soft fabric.  You run your fingers over the silken garment, feeling the soft material give at your touch.  There's a hood with a golden border embroidered around the edge.  For now, it hangs limply down the back, but it would be easy to pull up in order to shield the wearer's eyes from harsh sunlight or rainy drizzle.  The sleeves match the cowl, circled with intricate threads laid out in arcane patterns.\n\n", false);
                this.outputText("Rathazul gingerly takes down the garment and hands it to you.  \"<i>Don't let the softness of the material fool you.  This robe is tougher than many armors, and the spider-silk's properties may even help you in your spell-casting as well.</i>\"\n\n", false);
                itype = this.armors.SS_ROBE;
            }
            //(Armor)
            else {
                this.outputText("A glittering white suit of armor sits atop a crude armor rack, reflecting the light that plays across its surface beautifully.  You definitely didn't expect anything like this!  It looks nearly identical to a set of light platemail, though instead of having a cold metal surface, the armor feels slightly spongy, with just a little bit of give in it.\n\n", false);
                this.outputText("While you marvel at the strange equipment, Rathazul explains, \"<i>When you said you wanted armor, I realized I could skip a few of the alchemical processes used to soften material.  The savings let me acquire a cheap metal set of armor to use as a base, and I molded half the armor around each piece, then removed it and created the outer, defensive layers with the rest of the webbing.  Unfortunately, I didn't have enough silk for a solid codpiece, but I did manage to make a you thin loincloth from the leftover scraps  - for modesty.</i>\"\n\n", false);
                itype = this.armors.SSARMOR;
            }
            //Reset counters
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00275] = 0;
            this.flags[kFLAGS_1.kFLAGS.RATHAZUL_SILK_ARMOR_COUNTDOWN] = 0;
            this.inventory.takeItem(itype, this.returnToRathazulMenu);
        }
        craftOozeArmor() {
            this.spriteSelect(49);
            this.player.destroyItems(this.useables.GREENGL, 5);
            this.outputText("Rathazul takes the green gel from you and drops it into an empty cauldron.  With speed well beyond what you'd expect from such an elderly creature, he nimbly unstops a number of vials and pours them into the cauldron.  He lets the mixture come to a boil, readying a simple humanoid-shaped mold from what you had thought was piles of junk material.  In no time at all, he has cast the boiling liquid into the mold, and after a few more minutes he cracks it open, revealing a suit of glistening armor.\n\n", true);
            this.player.addStatusValue(StatusAffects_1.StatusAffects.MetRathazul, 2, 1);
            this.inventory.takeItem(this.armors.GELARMR, this.returnToRathazulMenu);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.RathazulArmor) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.RathazulArmor, 0, 0, 0, 0);
        }
        buyDyes() {
            this.spriteSelect(49);
            this.clearOutput();
            this.outputText("Rathazul smiles and pulls forth several vials of colored fluids.  Which type of dye would you like?");
            this.outputText("\n\n<b>(-50 Gems)</b>");
            this.player.gems -= 50;
            this.statScreenRefresh();
            this.menu();
        ...
        buyDyeNevermind() {
            this.spriteSelect(49);
            this.clearOutput();
            this.outputText("You change your mind about the dye, and Rathazul returns your gems.\n\n(<b>+50 Gems</b>)");
            this.player.gems += 50;
            this.statScreenRefresh();
            this.doNext(this.returnToRathazulMenu);
        }
        buyReducto() {
            this.spriteSelect(49);
            this.clearOutput();
            var cost = (this.flags[kFLAGS_1.kFLAGS.AMILY_MET_RATHAZUL] >= 2 ? 50 : 100);
            if (this.player.gems >= cost) {
                this.outputText("Rathazul hands you the Reducto with a nod before returning to his work.\n\n");
    ...
    exports.Rathazul = Rathazul;
});
//# sourceMappingURL=Rathazul.js.map