define(["require", "exports", "../../BaseContent", "../../GlobalFlags/kFLAGS", "../../StatusAffects", "../../GlobalFlags/kGAMECLASS"], function (require, exports, BaseContent_1, kFLAGS_1, StatusAffects_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Gargoyle extends BaseContent_1.BaseContent {
        ...
        gargoyleConfidence(arg = 0) {
            if (arg != 0) {
                this.flags[kFLAGS_1.kFLAGS.GAR_CONFIDENCE] += arg;
                if (this.flags[kFLAGS_1.kFLAGS.GAR_CONFIDENCE] > 100)
                    this.flags[kFLAGS_1.kFLAGS.GAR_CONFIDENCE] = 100;
                else if (this.flags[kFLAGS_1.kFLAGS.GAR_CONFIDENCE] < 0)
                    this.flags[kFLAGS_1.kFLAGS.GAR_CONFIDENCE] = 0;
            }
            return this.flags[kFLAGS_1.kFLAGS.GAR_CONFIDENCE];
        }
        //[b]Introduction, 1st Time:[/b]
        gargoylesTheShowNowOnWBNetwork() {
            this.clearOutput();
            //(When using the “Explore” option; perhaps a 15-25% chance of discovery per go)
            this.outputText("You set off in search of new horizons, setting off from camp in a completely new direction than you've ever tried before.  Away from the parts of Mareth you have thus far discovered, much of the world seems to be a barren wasteland");
            ...
            this.outputText(".  Your trip soon begins to seem unproductive, having found no new areas of Mareth or any contact with its inhabitants.  You sigh and turn back towards camp.");
            ...
            this.outputText("or (even) some demon enclave that needs destroying.  With a quick check of your [weapon], you begin the long trek towards the shimmer in the distance.");
            //[Next]
            this.menu();
        ...
        gargoyleMeeting2() {
            ...
            if (this.player.lib >= 40)
                this.outputText("  Maybe you could take this with you as a life-sized sex toy?");
            ...
            this.flags[kFLAGS_1.kFLAGS.FOUND_CATHEDRAL] = 1;
        ...
        dontBreakThatShit() {
            this.clearOutput();
            this.outputText("Oh, no.  Nope.  Nuh-uh.  Not going to happen.  You're not falling for that trick!  No, siree.  As soon as you chop those chains, it'll probably just come to life and try to kill - or rape - you.  Feeling rather smart, you turn on a heel and exit the cathedral – there's nothing else to see right now.");
        ...
        breakZeChains() {
            ...
            this.outputText("\n\n\"<i>I am your humble servant, Master.  Your tool.  Your plaything.  Your toy.  Ask, and I shall obey.</i>\"  She seems to pause for a moment, and adds in an emotionless whisper, \"<i>this one would be honored to pleasure Master, if " + this.player.mf("he", "she") + " desires.</i>\"");
        ...
        nameZeGargoyle(input) {
            ...
            this.flags[kFLAGS_1.kFLAGS.GAR_NAME] = input.value;
            this.clearOutput();
            this.outputText("\"<i>" + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + ",</i>\" she purrs, \"<i>" + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + ", " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + ".  Master has interesting taste.</i>\"");
        ...
        //[b]Funny Order[/b]
        giveGargoyleAFunnyOrder() {
            this.clearOutput();
            this.outputText("If she's so intent on playing the servant, you suppose you can play along.  Summoning up your most commanding voice, you snap, \"<i>ROLL OVER!</i>\"");
            this.outputText("\n\nTo her credit, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " hesitates only for a moment before dropping to the floor and rolling belly-up, limbs upraised like a puppy in training.  Stifling a chuckle, you lean down and do just that, giving her a quick belly rub.  Her skin is cool to the touch, and impeccably smooth, as you might expect from a marble statue.  Seemingly pleased, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " scrambles back to a low crouch before you, awaiting your next command.");
            this.gargoyleStarterMenu();
        }
        //[b]Carnal Order[/b]
        carnalOrder() {
            this.clearOutput();
            this.outputText("Well, well. " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " seems willing to follow any order you give, no matter how carnal, and you could not help but notice her rather <i>arousing</i> attributes earlier.  Smirking wickedly, you command your new gargoyle to finger herself.");
            ...
            if (this.player.cor < 40)
                this.outputText("flustered");
            else
                this.outputText("excited");
            this.outputText(" heartbeat.  The way she watches you, unblinking, as she fingers herself is rather unnerving, and you soon command her to stop.  She does so immediately, though with what you think might have been a sigh, and assumes a low crouch to await your next command.");
            this.gargoyleStarterMenu();
        }
        //[b]Talk (First Time)[/b]
        firstGargoyleTalk() {
            this.clearOutput();
            this.outputText("You decide against giving " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " an order for now.  Instead, you right a nearby toppled pew and seat yourself across from the crouching gargoyle, returning her intense stare with one of your own.");
            ...
            this.outputText("\n\nSuddenly, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " breaks the stare and looks away, as if in shame.  \"<i>The demons' doom that even now blights Mareth took its toll here, too.  The people of a town no longer here believed they were safe under Marae's roof.  Protected.  Their faith was. . . Misplaced.</i>\"");
            this.outputText("\n\nIt seems the events that led to the cathedral's destruction weigh heavily on " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s heart.  What do you do?");
        ...
        berateTheGargoyle() {
            ...
            this.outputText("A pillar of rage boils up inside you.  You are [name], Champion of Ingnam, you tell her, rising to your feet, fists clenched.  Your duty is the same as hers was, to protect your home.  And she failed.  She let all those people down.  You tell her that she's worthless, disgusting, a failure.");
            this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " recoils, flinching from you in expectation of assault. Instead, you spit on the ground and start for the exit.  You shout over your shoulder for her to stay here and wallow in her failure until you deign to use her.");
        ...
        reassureTheGargoyle() {
            ...
            this.outputText("\n\nYou rustle " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s hair and assure her you will before you take your leave and return to camp.");
        ...
        returnToCathedral(woken = false) {
            this.flags[kFLAGS_1.kFLAGS.FOUND_CATHEDRAL] = 1;
            if (!woken) {
                this.clearOutput();
                if (Gargoyle.rand(3) == 0)
                    this.outputText("You make your way back to the ruined Cathedral in the wastelands.  You notice some of the debris has been cleared away from the courtyard, and some of the windows have been boarded up.  " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s obviously been working since you last left, trying to make the building more habitable.  With your path less obstructed than before, you enter.");
                //[b]Player Returns to the Cathedral B[/b]
                else if (Gargoyle.rand(2) == 0)
                    this.outputText("You spot the Cathedral in the distance, and see plumes of smoke rising. Alarmed, you ready your [weaponName] and rush over.  To your relief, however, you discover the burning objects are just a few dead imps that were looking for easy pillage, but found the Cathedral's newly-awoken protector instead.  Stepping around their charred corpses, you enter.");
                //[b]Player Returns to the Cathedral C[/b]
                else
                    this.outputText("You wander into the Cathedral grounds, and are rather alarmed to see a pair of little green goblin sluts poking around outside, trying to cart off some of the stone tombstones for their nefarious schemes.  They see you approaching, however, and quickly flee – more interested in salvage than fighting or fucking today.  Chuckling to yourself, you enter.");
            }
            this.menu();
            ...
            if (this.model.time.hours <= 9 || this.model.time.hours >= 18 || woken) {
                if (!woken) {
                    this.outputText("\n\nIn the dim ");
                    if (this.model.time.hours <= 9)
                        this.outputText("early morning");
                    else
                        this.outputText("late evening");
                    this.outputText(" light streaming in from the broken windows, you see " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " poking around some of the rubble, slowly but surely making efforts to repair the damage done to the Cathedral.  Seeing you, however, she immediately drops what she was doing and ");
                    if (this.gargoyleConfidence() < 70)
                        this.outputText("kneels before you, head bowed low.");
                    else if (this.gargoyleConfidence() < 99)
                        this.outputText("bows low before you, a small smile on her stone lips.");
                    else
                        this.outputText("with a sexy sway of her hips, approaches you and lays a small but tender kiss upon your cheek before bowing her head to you.");
                    this.outputText("\n\n\"<i>Master has returned,</i>\" " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " says ");
                    if (this.gargoyleConfidence() > 50)
                        this.outputText("happily.");
                    else
                        this.outputText("solemnly.");
                ...
                if (this.player.lust >= 33)
                    this.addButton(0, "Sex", this.gargoyleSexMenu);
                this.addButton(1, "Rituals", this.ritualGargoyle);
                if (this.flags[kFLAGS_1.kFLAGS.GAR_HISTORY] < 3 || this.flags[kFLAGS_1.kFLAGS.GAR_CATHEDRAL] < 3 || this.flags[kFLAGS_1.kFLAGS.GAR_NAME_TALKS] < 3)
                    this.addButton(2, "Talk", this.talkToGargoyle);
                this.addButton(3, "Appearance", this.gargoyleAppearance);
                if (this.gargoyleConfidence() >= 70 && this.flags[kFLAGS_1.kFLAGS.RITUAL_INTRO] > 0)
                    this.addButton(4, "Kinky Rituals", this.gargoyleKinkyRituals);
            }
            //[b]Cathedral Interior: 10:00 –> 17:00[/b]
            else {
                if (!woken) {
                    this.outputText("\n\nWithin the ruins, you can see " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " perched atop her pedestal in a low, predatory crouch, much as you found her.  Waving a hand in front of her eyes, you confirm she's in some sort of dormant mode.  A simple touch from her Master could revive her");
                    if (this.player.lust >= 33)
                        this.outputText(", or you could use her to satisfy your own urges, not unlike a life-size sex toy");
                    this.outputText(".");
                }
                ...
                if (this.player.lust >= 33) {
                    if (this.player.hasCock())
                        this.addButton(1, "Use Her", this.useGargoyleMaleHerm);
                    else if (this.player.hasVagina())
                        this.addButton(1, "Use Her", this.useHerGargoyleFemale);
                }
                this.addButton(3, "Appearance", this.gargoyleAppearance);
            }
        ...
        gargoyleSexMenu() {
            this.clearOutput();
            this.outputText("You approach " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " and tell her you have some... pressure that needs relieving.");
            //(if Confidence =< 69:
            if (this.gargoyleConfidence() <= 69)
                this.outputText("  The gargoyle bows low before you, her face expressionless.  \"<i>By your command, Master.  How would you have me?</i>\"");
            else
                this.outputText("  Her ruby-red eyes lock with yours and a sultry grin plays across her gray marble features.  She slides an arm around your waist and presses her sizable, surprisingly soft breasts against your chest.  \"<i>How would Master have me?</i>\"");
            this.menu();
            ...
            if (this.player.gender == 1) {
                ...
                this.addButton(2, "Titfuck", this.titFuckTheGargoyle);
        ...
        gargoyleAnal() {
            this.clearOutput();
            this.outputText("You tell her to get on all fours as you shed your [armor], unleashing your already-hardening cock.  Nervously, the gargoyle does as you command, quickly finding a clear bit of floor and getting on her hands and knees.  You kneel down behind her, peeling her taut ass-cheeks apart to reveal her tight slit and the marble ring of her tiny asshole.  Grinning, you slather up your forefinger with your tongue, lubing it up as best you can before pressing it to her backdoor.");
            this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " makes a sharp little gasp as you push your finger into her.  You slide into her with surprising ease, reveling in how <i>cold</i> her interior is.  She's like ice inside!  You start thrusting your finger faster, trying to get her warmed up a little as your prepare her anus.  " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " squirms and moans softly as you finger-fuck her bum, slowly changing from moans of discomfort to little gasps of pleasure.");
            ...
            if (this.player.cocks[this.player.biggestCockIndex()].cockLength >= 50) {
                this.outputText("\n\nKnowing full well the living statue doesn't have much in the way of anatomy, you continue to push more and more of monstrous manhood into " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s asshole, watching with glee as her stomach begins to distend with the massive size of your prick.  Then her chest bulges, making her gasp in pain and clutch at her breast; that doesn't stop you, though.  With one mighty, massive thrust, you slam yourself up to the hilt in " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s ass, and watch with glee as the head bursts out of her mouth, squirting pre and drool all over the floor.  The poor gargoyle makes a muffled scream and starts flailing around helplessly, trying to do <i>something</i> about the massive member now protruding from her mouth.");
                this.outputText("\n\nWith gusto, you start hammering away at your living cock-sleeve, using her entire body as one great big ona-hole to take your gargantuan girth.  Resigned to her fate, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " slumps forward and grasps the head of your [cock biggest], giving you a handy through her mouth as her innards milk the rest of your shaft.");
        ...
        //[b]Vaginal[/b]
        //no limits
        gargoyleCoochiiGetsPlowed() {
            this.clearOutput();
            var x = this.player.cockThatFits(60);
            if (x < 0)
                x = this.player.smallestCockIndex();
            this.outputText("You gently push " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " onto her back and spread her long, marble legs, giving you a clear view of her tight little pussy.  You brush your hand along her thighs, making her gasp with the sensation as your knuckles run along her smooth, cool flesh.  Your fingers come to her small clit, and you caress her tiny pleasure buzzer, eliciting a tiny moan from the gargoyle.  Grinning, you give it another flick; " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " squirms, trying to either enhance or end the sensation, you can't be sure.  You start to finger her clitty harder, creating little circles around it as you slip another finger into her tight passage.");
            this.outputText("\n\nYou're rewarded for your efforts by " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " bucking her hips into your hands, moaning, \"<i>M-Master... please...</i>\"  Not done teasing her yet, you put your other hand on her flat belly and start to crawl it up, tickling her as you make your way toward her sizable breasts.  You glomp onto one of them, giving it a rough squeeze as you drive your finger into her a little further than before.  \"<i>Masterrrrr...</i>\" " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " whines, reaching up to stroke your cheek.  Deciding you've teased the poor girl enough, you prepare for the main course.");
            this.outputText("\n\nYou pull your " + this.cockDescript(x) + " from your [armor], letting it flop down atop her crotch.  Embarrassed, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " looks away as you rub the underside of your cock across her mons, spitting on it for a bit of extra lubricant.  You lean back, lining the tip of your cockhead with the gargoyle's tight slit, and press forward.  She lets out a sharp gasp as your cock presses against her, pushing it past her lips and finally slipping into her depths.");
            ...
            if (this.player.cockArea(x) > 60)
                this.outputText("as far as she can take you.");
            else
                this.outputText("up to the hilt inside her.");
            this.outputText("  Now that you're so deep in the gargoyle, you can see her visibly trembling, panting with pleasure.  Leaning down, you cup her cheek and plant a kiss on her thin lips.  She returns it eagerly, letting your probing tongue in to play with hers.  Mid-kiss, she wraps her arms and legs around you, holding you close against her heaving chest.");
            this.outputText("\n\nYou start to thrust against her, making short, fast strokes in and out of her cool passage.  Soon, you're both moaning with pleasure as you change the tempo, switching to long and hard pumps that make the Cathedral echo with the sound of your hips slapping into " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s raised asscheeks.  She can only hold on to you tighter, biting her lower lip, eyes closed, as you start to well and truly pound her.");
            this.outputText("\n\nTo your dismay, you feel the tell-tale clenching in your gut, signaling your impending orgasm.  You clutch at " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s shoulders as you slam into her one last time, as far as you'll go, and shoot out the first of your load.  The sensation of your thick, hot jizz exploding into her sets the gargoyle off as well: she rolls her head back and lets out a soft scream, crunching down on your cock until you're afraid it's going to burst.  You bury your face in her neck and let her milk your cock for all it's worth, until your spooge threatens to overflow and pool on the ground.");
            this.outputText("\n\nThe two of you lay there for a while after, until your " + this.cockDescript(x) + " has deflated and you've both stopped panting from exertion and pleasure.  Giving her another kiss, you pull out of her cold depths – now significantly warmer thanks to your passion – and stuff your dick back into your armor.");
            if (this.gargoyleConfidence() >= 70)
                this.outputText("  Before you can stand, though, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " hugs her arms tightly around you pulling you down on top of her and mashing your face between her soft tits.");
        ...
        titFuckTheGargoyle() {
            this.clearOutput();
            this.outputText("You situate yourself on a pew and spread your legs.  You pat your thighs, telling " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " to sit between your legs as you fish out your [cock biggest].  She approaches, hesitantly placing herself on the floor between your legs as you recline and stroke your shaft to full hardness.  You let the gargoyle sit there, watching you wide-eyed as you continue to masturbate.  Though you're only preparing for the main act, you can't help but enjoy the sensation of such a basic sexual act, made all the more pleasurable by the creature at your feet, her face barely an inch from your cock's head as you stroke yourself.");
            this.outputText("\n\nOnce you're satisfied at your cock's rigid hardness, you tell " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " to put those big, soft tits of hers to work.  \"<i>M-Master?</i>\" she gasps, making a cute little “o” with her mouth just an inch from your shaft.  You repeat the order, and giver her a thump on the nose with your cock for emphasis.  Shyly, she cups her D-cups and leans into you, squeezing your [cock biggest] between them.");
            this.outputText("\n\nWith a little encouragement, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " starts to rise and fall on her knees, dragging your shaft through her soft, cool mounds.  With a pleasured sigh, you reach down and stroke her hair, petting the girl as she begins to slowly but steadily titfuck you.  Still mumbling encouragements, you sit back and let the pleasure run over you, reveling in the incredible softness of her sizable chest massaging your cock, making steady progress toward stroking the cum out of you.");
            this.outputText("\n\nSuddenly, you feel an overwhelming wetness on your cock.  You look down, expecting to see pre flowing freely from you, but are instead greeted with the sight of " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " sliding the tip of your cock into her mouth, starting to fellate you on top of the tittyfuck.  You give her a few more words of encouragement and press her head down further onto your shaft, forcing her to take all that's left over from her breasts.  Despite her marble nature, her mouth is moist and surprisingly warm, and her long tongue is quick to wrap around your [cock biggest], wringing it in time with her chest-thrusts.");
            ...
            this.outputText("\n\nYou grab " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " and push her down hard, slamming your cock down her throat as you cum.  A human would surely have choked with this maneuver – instead, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " squirms and flails, but you can see and feel her swallow your cum as it pours into her mouth, her throat massaging your flaring head, milking it harder than any tit-job ever could have.  Once her face has been ground into your pubes, you buck your hips sharply, thrusting into her throat as the last of your jizz spurts out and down her gizzard.");
            this.outputText("\n\nBy the time you're done, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s face is an utter mess, with white lines trickling down her cheeks.  You drag your [cock biggest] out of her with a wet POP, unleashing a dam of jizz that quickly leaks out of her agape mouth to stain her breasts and belly.  You chuckle at the sight");
            if (this.gargoyleConfidence() >= 70)
                this.outputText(", and to your surprise, so does " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "");
            this.outputText(".");
        ...
        strapOnGargoyle() {
            this.clearOutput();
            this.outputText("Giving a quick look around the ruins, you tell " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " to go find something that can bring you two a little <i>closer</i>.");
            this.outputText("\n\n\"<i>Closer?</i>\" she asks, confused.  You roll your eyes and tell her to grab the holy rod sitting on the altar and put it through a leather strap.  She hesitates for a moment, but dutifully does as you ask, returning a moment later with the smooth, silver cylinder and a leather thong.  With a bit of work, you've created a simple strap-on out of the holy rod, and instruct " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " to put it on.  Now she's getting it!  The gargoyle slips into the leather, giving a cute little shiver as one end of the rod slips inside her.  Before she has a chance to recompose herself, you grab her rod-cock in one hand and give her a gentle push with the other.");
            this.outputText("\n\nShe lays down with you atop her, straddling her waist as you stroke her rod, rewarded with sharp pleasure-gasps from the statue-girl.  You're hardly stimulating her pussy with these actions – she must be able to feel <i>through</i> the rod, as if it were a real cock.  Amused, you start to jerk the rod off, sliding it through your clenched fist with slow, measured strokes.  " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " squirms under the pleasurable attention, and is soon groping her big breasts and bucking her hips into your fists, shoving more of her rod-cock into your hand with each of your jerks.");
            this.outputText("\n\n\"<i>Well, someone's enjoying herself,</i>\" you tease, and immediately " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " freezes, her mouth agape with embarrassment.  With a little laugh, you give her a pat on the thigh and start to strip out of your [armor].  But you can't just leave " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " without SOME stimulation: ");
            //(If Human Legs/Feet [ie, needs toes], as new paragraph): 
            if (!this.player.isTaur() && !this.player.isGoo() && !this.player.isDrider() && !this.player.isNaga())
                this.outputText("you reveal your leg first, moving slowly and sensually, giving her a tantalizing look at your nethers before hiding them again.  With a wide grin, you creep your foot up to her thighs and gently run your heel along her smooth, tender flesh.  You come to the base of her rod, standing stark straight in the air like a flag-pole.  As you strip, you grasp her cock between your big and second toe, sliding them up the smooth shaft to the tip.  " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " moans, rolling her head back as you start to foot-fuck her cock, slowly putting more and more pressure on the steel member until it's pressed against her belly.  Your heel takes over, running quickly along the underside of her cock as you finally rid yourself of your [armor].");
            //Else, continued from above paragraph:
            else
                this.outputText("you giver her a good show, putting on a brief striptease for the gargoyle.  You strip your [armor] slowly, sensually, showing only the barest hints of your privates until the last moment, when the last piece of your clothing falls to the floor.");
            //(From Both, if has Vagina:) 
            if (this.player.hasVagina()) {
                this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " is panting with lust by the time you're done teasing and stripping for her. Now nude, you drop back to your knees over her holy rod-cock, straddling her hips and lining her up with your [vagina]. You lower yourself until the tip of the rod is pressing against your lower lips – you're pleasantly surprised by the warm tingling sensation that quickly spreads out around the point of contact, and your cunny responds immediately by letting loose a little trickle of moisture that beads down on the gargoyle's shaft.");
                this.outputText("\n\nWithout further ado, you drop down on the strap-on, lowering yourself onto the tingling metal rod until your groin is pressed against " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s.  She, all the while, is biting her lower lip and whimpering with pleasure as your [vagina] swallows her length. Once you've taken all she has to offer, you begin grinding your hips against her, rocking back and forth atop the gargoyle.  To your surprise, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " grabs you, squeezing her long fingers into your [hips] and pulling you up, almost off her rod. You decide to go with it; you grab her tits for support and start to bounce on her cock.");
                this.player.cuntChange(15, true, true, false);
                this.outputText("\n\nSoon, you're both moaning with pleasure, bucking and thrusting your hips to meet each other as you continue to ride " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s strap-on.  However, you can feel the clenching sensation of a coming orgasm building in your gut, and if the strained panting of your partner is any indication, she isn't far behind.  You start bouncing faster, increasing to a wild pace as your cunt contracts on the metal rod inside it, trying to milk the fake cock as waves of pleasure roll over you.  You don't let up throughout the orgasm, quite literally riding it out until " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " lets out a high-pitched shriek and grabs your back, smashing your face into her tits and holding you tight as she, too cums.  Suddenly she's the one pounding you, thrusting her hips into your [vagina].");
                this.outputText("\n\nBy the time she's done, both your hips and thighs are spattered with your sweat and girlcum. Still panting from the ordeal, you slowly drag yourself off of " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s cock and roll onto your back, exhausted. By the time you've recovered enough to stumble to your feet, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " is fast asleep beside you, snoring cutely, her metal cock still standing straight up in the air.  You give her a gentle pat on the thigh and get dressed, leaving the gargoyle snoozing peacefully as you head back to camp.");
            }
            //(ELSE, PC has no vagina:)
            else {
                this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " is panting with lust by the time you're done teasing and stripping for her. Now nude, you drop back to your knees over her holy rod-cock, straddling her hips and lining her up with your [asshole].  You lower yourself until the tip of the rod is pressing against your clenched backdoor – and you're pleasantly surprised by the warm tingling sensation that quickly spreads out around the point of contact. Your anus responds immediately by utterly relaxing, letting just the tip of " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s strap-on slide inside you.");
                this.outputText("\n\nWithout further ado, you drop down on the strap-on, lowering yourself onto the tingling metal rod until your ass is pressed against " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s thighs.  She, all the while, is biting her lower lip and whimpering with pleasure as your ass swallows her length.  Once you've taken all she has to offer, you begin grinding your hips against her, rocking back and forth atop the gargoyle.  To your surprise, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " grabs you, squeezing her long fingers into your [hips] and pulling you up, almost off her rod.  You decide to go with it; you grab her tits for support and start to bounce on her cock.");
                this.player.buttChange(15, true, true, false);
                this.outputText("\n\nSoon, you're both moaning with pleasure, bucking and thrusting your hips to meet each other as you continue to ride " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s strap-on.  However, you can feel the clenching sensation of a coming anal orgasm building in your gut, and if the strained panting of your partner is any indication, she isn't far behind.  You start bouncing faster, increasing to a wild pace as your hole contracts on the metal rod inside it, instinctively trying to force out the intruder, but only serving to let waves of pleasure roll over you.  You don't let up throughout the orgasm, quite literally riding it out until " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " lets out a high-pitched shriek and grabs your back, smashing your face into her tits and holding you tight as she, too cums.  Suddenly she's the one pounding you, thrusting her hips into your [asshole] until you've both cum, hard, clutching each other as orgasmic pleasure slams through you.");
                this.outputText("\n\nStill panting from the ordeal, you slowly drag yourself off of " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s cock and roll onto your back, exhausted. By the time you've recovered enough to stumble to your feet, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " is fast asleep beside you, snoring cutely, her metal cock still standing straight up in the air.  You give her a gentle pat on the thigh and get dressed, leaving the gargoyle snoozing peacefully as you head back to camp.");
            }
            this.player.orgasm();
            this.dynStats("sen", -1);
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        tailFuckGargoyleScene() {
            ...
            this.player.cuntChange(15, true, true, true);
            this.outputText("You shudder as you finally bottom out on her tail, taking it until your cunt is almost painfully stretched by her ever - thickening tail and you can feel the tip pressing against the entrance to your womb.");
            this.outputText("\n\nNow firmly inside your depths, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " begins to wiggle her tail inside you, slithering a few inches in and out of your [vagina].  Encouraging her, you grasp her shoulders for support and push your cunt a little closer to her face.  Taking the hint, she snakes out her long tongue and gives your clitty a little flick, eliciting an immediate gasp of pleasure from you.  She's soon engaging in a double-assault on you, suckling on your [clit] one moment, and ramming her tail into your [vagina] the next.");
            ...
            this.outputText("\n\nBefore you can get used to the anal intruder, your eyes have rolled back in your head with pleasure.  Girlcum spurts from your cunt, splattering " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s face with your juices as you cum.  Your holes squeeze down on her appendages, trapping them inside you as your ride out the orgasm, bouncing on her rigid, rapidly-moistening tail until your body settles down.");
            this.outputText("\n\nWhen you've finished, you carefully extricate yourself from the gargoyle's tail and, a bit bow-legged, gather up your [armor].  By the time you're dressed, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s cleaned herself off and is eagerly awaiting some token of your approval.");
            this.outputText("\n\n\"<i>Was Master satisfied?</i>\" she asks");
            if (this.gargoyleConfidence() > 70)
                this.outputText(" with just a hint of a smile");
            this.outputText(".");
        ...
        useGargoyleMaleHerm() {
            this.clearOutput();
            this.outputText("You approach the motionless statue with a lustful look in your eye. Quickly, you strip out of your [armor] and circle around the frozen girl.  With some effort, you're able to lift her heavy, spiked tail out of the way, revealing the tight cunt hidden between her legs.  You drop to your knees behind the gargoyle and bury your face in her crack, slurping at her vag, getting it nice and moist in preparation for your cock.");
            ...
            this.outputText("\n\nBut you aren't quite satisfied just pounding an insensate hole.  Knowing that you have the power to \"revive\" " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " through touch, you decide to put this to rather devious use.  You reach around her body and grab one of her breasts, giving it a few hard squeezes until you hear the faintest gasp from the little gargoyle.  You release it immediately.  Your hand switches down to her taut ass and gives it a loud swat.  You repeat the action twice, and finally feel her cunt contract – just a bit – around your shaft.  You switch your attentions down to her thighs, gently running your hands along both expanses of gray skin beneath your thrusting [cock biggest].  You feel her shudder, ever so slightly, but just as she's on the verge of reviving, you pull back your hands.");
            this.outputText("\n\nYou return to thrusting into her, going fast and furious as your pleasure climbs steadily towards climax.  Only when you're bursting over the threshold of orgasm do you lay your hands on " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " again, grabbing her ass and giving one last massive thrust into her, shoving your [cock biggest] in to the hilt.  You cum inside her just as she awakens, moaning lustily into her ear as spunk drizzles out around your member.");
            this.outputText("\n\n\"<i>M-Master?</i>\" " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " gasps, giving a full-body shudder as you slowly pull out from inside her.  Your cum drools out of her snatch and pools beneath her.  Playfully, you jam your fingers up between her legs, damming your sperm inside her.  To your glee, this simple act sends " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " right over the edge: convulsing, she collapses on the floor with a heavy THUNK!");
        ...
        ritualGargoyle() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.RITUAL_INTRO] == 0) {
                this.flags[kFLAGS_1.kFLAGS.RITUAL_INTRO] = 1;
                this.outputText("You note that the sanctuary's altar has been cleared of rubble, and a number of candles have been lit upon it. Resting atop the flat stone surface is a simple iron bowl filled with what appears to be water. Curious, you ask " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " what she's been up to.");
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) >= 0 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                this.addButton(2, "Banish", this.banishmentGargoyleRitual);
            this.addButton(4, "Leave", this.returnToCathedral);
        }
        //[b]Body[/b]
        ...
        //[b]Nothing[/b]
        noReactionToBodyRitual() {
            this.clearOutput();
            this.outputText("You simply lie still and try to recover from " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s \"gentle ministrations.\"  After a few minutes, you've caught your breath and, gathering your possessions, make your way out of the Cathedral without another word.  Damn, you're sore.");
            this.doNext(this.camp.returnToCampUseOneHour);
            //(Return PC to camp, advance time 1 hour)
        }
        //[b]Revenge[/b]
        //(Confidence -5)
        gargoyleRevengeAfterBodyRitual() {
            this.clearOutput();
            this.outputText("Seeing " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " just standing over you, gloating, causes you to sneer and lash out.  You strike her dead-center in the chest, throwing her back against the tree-idol at the church's head.  She slumps to the floor, looking meekly away from you.  While she's stunned, you gather your [armor] and stagger out of the Cathedral.");
            //(Return PC to camp, advance time 1 hour)
        ...
        mindGargoyleRitual() {
            this.clearOutput();
            this.outputText("You tell " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " that you've been plagued with dirty thoughts, and would like to undo some of the corruption that's spread to your mind.  " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " nods respectfully and tells you to kneel before the altar. You do so, assuming a low, supplicating stance before the tree-idol at the Cathedral's head as the gargoyle picks up the bowl of water and raises it on high.");
            this.outputText("\n\n\"<i>Blessed is " + this.player.mf("he", "she") + " who seeks purity,</i>\" she says, closing her eyes and bowing her head, \"<i>Blessed is " + this.player.mf("he", "she") + " who seeks wisdom; and blessed is " + this.player.mf("he", "she") + " who lusts after holiness and virtue before pleasures of the flesh.</i>\"");
            this.outputText("  " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " brings the invocation to a quiet close, and rests the bowl back upon the altar. \"<i>Drink of this, Master,</i>\" she says, offering you the bowl, \"<i>and be healed of mind.</i>\"");
            this.outputText("\n\nYou do so, taking a long draught of the holy water.  By the time you've set the bowl down, you feel light-headed, as if a fog has receded from your mind.  You gasp happily, able to think more clearly than you have in days.  You thank " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + ", give her a pat on the head, and head back to camp with a skip in your step.");
            this.dynStats("lus", -10, "cor", -.5);
        ...
        banishmentGargoyleRitual() {
            this.clearOutput();
            this.outputText("Talking about " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s rituals, you explain that you seem to have picked up ");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                this.outputText("a hitchhiker");
            else
                this.outputText("some hitchhikerss");
            this.outputText(" in your travels, and would like to rid yourself of them.  She tells you to strip and brace yourself against the altar.  \"<i>Unfortunately, as you have been invaded, so too is this a very... invasive ritual.</i>\"  You nod your assent – you really want to get ");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                this.outputText("this bastard");
            else
                this.outputText("these bastards");
            this.outputText(" out of your system.");
            this.outputText("\n\nFrom beneath the altar, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " withdraws what looks like a perfectly cylindrical dildo, covered with dozens of dark, dimly-glowing blue runes.  Slowly, she makes her way around you and kneels behind your [butt].  \"<i>Take a deep breath, Master, and relax yourself.  It will be better this way.</i>\"");
            ...
            this.outputText("\n\n\"<i>Do not worry, Master,</i>\" " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " says");
            if (this.gargoyleConfidence() >= 50)
                this.outputText(" soothingly, using her free hand to stroke your thighs");
            this.outputText(".  \"<i>The pain is necessary.  Everything will be all right.</i>\"");
            ...
            //with Exgartuan:
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                this.outputText("  Booming from within you, you hear the demon's voice: \"<i>Hey!  What the shit is this!?  What're you doing? Fucking stop, you ingrate!</i>\"");
            //with Worms: 
            else
                this.outputText("  Gratifyingly, however, you can feel the infestation within you squirming and writhing, desperately seeking escape.");
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                this.outputText("creature within you has");
            else
                this.outputText("creatures within you have");
            this.outputText(" been absorbed and purged by the rod, which " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " proceeds to chuck out a window.  Hopefully she has more, in case you ever get ");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                this.outputText("possessed");
            else
                this.outputText("infested");
            this.outputText(" again.");
            this.outputText("\n\nStill panting and gasping from your ordeal, you notice " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " looming over you, smiling.  You could be a dick for all that pain she caused you, or thank her for helping you.");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
        ...
        //(While Confidence 70+)
        gargoyleKinkyRituals() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.KINKY_RITUALS_SPOKEN] == 0) {
                this.outputText("You broach the subject of rituals to your gargoyle and are met with a surprisingly coy smile from her.  You ask her what's on her mind, to which " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " chuckles and says, \"<i>I've been thinking, Master. If you so desire, it may be possible to... enhance... the rituals that I've been using.</i>\"");
            ...
            //(While Confidence 70+)
                ...
                this.outputText("You walk to the church's alter, shortly followed by " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + ".  You tell her you need one of her holy rituals, but that you'd prefer to have some fun as well.  Grinning, she says, \"<i>It would be my pleasure, my Master. What shall we do?</i>\"");
            }
            //(Display Options: [Body] [Mind] [Banish (only with Exgartuan or Worms)] and [Leave])
            this.menu();
            this.addButton(0, "Body", this.kinkyBodyRitual);
            this.addButton(1, "Mind", this.mindRitualPervy);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) >= 0)
                this.addButton(2, "Banish", this.banishPervRitual);
            this.addButton(4, "Leave", this.returnToCathedral);
        }
        //[b]Body[/b]
        kinkyBodyRitual() {
            ...
            //(Confidence +2)
            //(PC decreases Libido and Sensitivity. Suffers 20% Max HP damage, to a minimum of 1 pt. remaining)
            this.outputText("You tell " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " that you could stand to reverse some of the corruption that has affected your body.  With an eager nod, she strips you down, takes you to a side alcove near the altar and instructs you to spread your arms and legs.  Putting your trust in your little gargoyle, you do so, allowing her to bind you spread-eagle with long leather straps.");
            ...
            if (this.player.biggestTitSize() >= 1)
                this.outputText(", cupping your [chest] in her cold stone hands");
            this.outputText(".  Your [nipples] go rock hard from her cold touch, and you shudder as she gently nips your ear and drags the length of the crop along your thighs.");
            this.outputText("\n\n\"<i>You've been a very naughty " + this.player.mf("boy", "girl") + ", to have a body so warped,</i>\" she says, again running the crop along your incredibly sensitive inner thighs, making you tremble with the sensation.  You're acutely aware of her large, soft breasts pressing into your sweat-slicked back.  Huskily, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " whispers, \"<i>Don't worry, Master. I'll take good care of you...</i>\"  CRACK!  She lays on with the crop, a short, stinging stoke across your thigh.  You gasp, as much in pleasure as in pain, still reveling in the sensation of her embrace.");
            ...
            if (this.player.hasCock())
                ...
                this.outputText("barren crotch");
            this.outputText(".  She breaks the kiss and steps back, laying on one last time – CRACK! with the crop, stinging you again with an intense mix of pain and pleasure.  Gasping and panting from stimulation, you nearly collapse when " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " unbinds you, though she's quick to catch you before you fall.");
            this.outputText("\n\nShe guides you over to the altar and helps you lie atop it to rest.  Once you're comfortably situated, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " slips up beside you, resting her cheek ");
            if (this.player.biggestTitSize() < 1)
                this.outputText("on your chest");
            else
                this.outputText("between your [chest]");
            this.outputText(".  Already, you feel more thick-skinned and less lusty, and so give an appreciative grin to your cute little gargoyle.  In response, she nuzzles against you and wraps her bat-like wings protectively around the two of you.");
            this.outputText("\n\nYou spend a few minutes cuddling with " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + ", but sadly, you know you can't leave your camp unattended for too long.  Giving her a pat on the head and a kiss on the brow, you gather up your clothes and head on back to camp.");
            this.dynStats("tou", .5, "lib", -.5, "sen", -2);
        ...
        mindRitualPervy() {
            this.clearOutput();
            this.gargoyleConfidence(2);
            this.outputText("You tell " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " that you've been plagued with dirty thoughts, and would like to undo some of the corruption that's spread to your mind.  With a deep nod conveying both a respect for your choice and an eagerness to engage in the ritual, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " tells you to kneel before the altar.  You do so, assuming a low, supplicating stance before the tree-idol at the Cathedral's head as the gargoyle clears off the altar save for the humble bowl of water.");
            this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " lifts herself to perch atop the alter with a single beat of her wings, coming to rest cross-legged before you.  Grinning a sexy grin, she picks up the small waterbasin and lifts it up to her lips, taking a small drink of it.  \"<i>Blessed is " + this.player.mf("he", "she") + " who seeks the pure,</i>\" she begins to chant, lowering the bowl from her thin lips. As she does so, she slowly raises her left leg, resting her toes upon your chin.  Locking eyes with you, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " lowers the basin to her thigh and begins to pour, letting the water trickle sensually down her stone-smooth leg.  \"<i>Blessed is " + this.player.mf("he", "she") + " who seeks wisdom,</i>\" she purrs as you instinctively open your mouth, allowing the holy water to trickle in from her foot.");
            this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " quickly slips her small toes into your mouth, letting you suckle the holy water from them like an infant.  She lets you remain like that for nearly a minute, nursing from the rivulets that come your way, before pulling her leg back and taking your head with it.  She leans backwards as you approach, balancing upon her bat-like wings as she finishes the chant: \"<i>And blessed is " + this.player.mf("he", "she") + " who lusts after holiness and virtue before pleasures of the flesh.</i>\"  She pours from the basin once again, releasing the holy water directly onto the large, shapely mounds of her breasts.  The water runs down her chest and belly, creating a tiny waterfall over the nub of her clitoris to which she guides you.");
            this.outputText("\n\nYou do as she so obviously wishes, and spread her legs to get a good look at her now-sopping wet slit. Her vagina seems small, but an experimental touch proves it to be quite malleable – and your single touch causes " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " to arch her back, gasping with the sudden pleasure.  Smiling at the adorable, enraptured look on her face, you start lapping with a vengeance, grasping her thighs and burying your face between her legs.  You flick your tongue into her smooth, cool slit, lapping up a few drops of water with each flick of your dexterous tongue, and eliciting a gasp or moan each time.");
            this.outputText("\n\nSoon, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " is clutching at her breasts and quickly fingering her cherry-nub clit as you lick her out, trying her best to keep an even rhythm with you, even as the waterfall comes to an end and you begin to feel light-headed, as if a fog has lifted from your mind.  By way of thanks, you redouble your efforts to pleasure her, ramming your tongue into her depths and fucking her mercilessly.  Quickly, she begins to tense, stopping her own actions to grasp at your " + this.hairDescript() + " and shove your face further into her crotch, locking her legs and tail around your back as she approaches orgasm.");
            this.outputText("\n\nScreaming, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " arches her back and thrusts out her bat-wings to their full expanse, clamping down on your tongue as she cums.  You slow your pace, giving her a last few licks as she pants, gasps, and moans, slowly coming down from an orgasmic high.  She collapses backwards, clutching her chest and staring into the rafters.  Chuckling, you stand and give her a pleased pat on the inner thigh, letting her know she did a good job for you.  You leave her smiling atop the altar, slowly getting her breath under control.");
            //(Return PC to camp, advance time 1 hour)
            this.dynStats("int", .5, "lus", -10, "cor", -.5);
            this.fatigue(50);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[b]Banish[/b]
        ...
        banishPervRitual() {
            this.clearOutput();
            //(PC is cleared of Worms and/or Exgartuan)
            this.outputText("You explain to " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " that you seem to have picked up ");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                this.outputText("a hitchhiker");
            else
                this.outputText("some hitchhikers");
            this.outputText(" in your travels, and you're tired of ");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                this.outputText("it");
            else
                this.outputText("them");
            this.outputText(".  She gives you an understanding nod and tells you to strip.  As you do so, she dips beneath the altar, reappearing with a silver, blue-rune covered rod nestled into what looks like a leather thong.  " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " slips the thong on, letting a slight gasp escape her lips as the inner end of the rod enters her.");
            this.outputText("\n\nShe gives the shaft of the strap-on a few experimental strokes and, satisfied, says, \"<i>I've turned down the power of the runes, so it will not hurt you so much... though it will take longer than normal.  I suggest you lubricate it, Master.</i>\"  Smiling, she sits herself atop the alter and presents her silver “cock” to you.  You kneel and slip your face between her spread legs, giving the rod a quick lick.  It's incredibly smooth and quite cold, much like its wearer, but your tongue comes away with a warm tingle spreading through it – not pain, but more like numbness.  You take the rod into your mouth, running your tongue across its length and thrusting your face against it, blowing it like a cock while getting it sopping wet with your saliva.  You've only been at it for a minute when you notice " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " is bucking her hips slightly and moaning quietly, obviously getting more than a little enjoyment from the sensation.  Perhaps she can feel through it, like a real dick?  Grinning, you redouble your efforts to suck her off.");
            this.outputText("\n\n\"<i>Enough, Master,</i>\" she gasps, pushing you back.  Breathing heavily, she takes you by the hand and gets you to brace yourself against the altar.  Your entire mouth is numb now, tingling from the strange sensation given off by the holy rod-cock.  " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " slips behind you, putting a cool, soft hand on your [hips] as she lines up for penetration.  You grip down hard on the edge of the altar, and try your best to relax your sphincter as you begin to feel a tingling pressure against your back door.");
            if (this.player.ass.analWetness > 0)
                this.outputText("  She slips in easily, sliding her tingling holy rod into you until her hips are pressed against your [butt]");
            else
                this.outputText("  She slowly but surely coaxes the holy rod into your asshole, making long and slow thrusts into you until she finally bottoms out");
            this.outputText(".");
            this.outputText("\n\nWith her rod firmly inside you, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " puts her hands on your [hips] for leverage and begins to pull out again, leaving a hot, intense tingling sensation in your rectum.  She thrusts in, this time much more quickly than you were expecting, making you gasp and moan as her hips slam into yours.");
            //If PC has Worms: 
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) < 0)
                this.outputText("  You can feel her cock ram against your prostate, and shudder as the writhing mass of worms begin to panic as her cock pushes against them, obviously causing the creatures great pain.");
            this.outputText("  " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " begins to fuck you in earnest, hammering your [asshole] with the strap-on until you're both panting and gasping, nearly overwhelmed by sensation.");
            //(If PC has Exgartuan: 
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                this.outputText("  You can hear the demonic voice of Exgartuan inside your mind, yelling and cursing as he is rapidly drained from your body and sealed into the holy rod within you.");
            //(If PC has a cock:
            if (this.player.hasCock()) {
                this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " suddenly releases your hips and, pressing her soft breasts into your sweat-slicked back, grabs your [cock biggest] in her cold hand.  You let out a little gasp as she begins to jerk you off, rapidly pistoning your cock as she continues to pound your ass.  Between the dual stimulation, you feel a pressure begin to swell up inside your abused prostate, a tell-tale sign of orgasm.  She gives you a few last thrusts before you cum, splattering the altar with thick ropes of cum as you both yell in ecstasy.");
            }
            else {
                this.outputText("\n\n" + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " reaches the peak of her speed, utterly reaming you as ");
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                    this.outputText("Exgartuan is");
                else
                    this.outputText("the worms are");
                this.outputText(" sucked from your body. Suddenly, she leans in and presses her lips to yours, thrusting her tongue against yours, letting you feel her begin to convulse and shake with release. Cupping her cheek, you return the kiss with gusto, willing yourself toward an anal orgasm. Within moments, the incredible tingling and the rapid ass-fucking combine toward your own climax, and you squeeze down hard upon the rod inside you as you cum, shaking and shuddering in the gargoyle's grasp.");
            }
            this.outputText("\n\nSuddenly, the holy rod jammed up your [asshole] makes a loud hissing sound, and withdraws. Panting, you collapse to the ground, gripping your gut.  It's over, and though a part of you feels suddenly very empty, it's soon forgotten as " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " slips down beside you, having already tossed the holy rod out the window.  The creature");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                this.outputText(" within you has");
            else
                this.outputText("s within you have");
            this.outputText(" been absorbed and purged by the rod; and you can't help but hope she has more... just in case.");
            this.outputText("\n\nStill panting and gasping from your ordeal, you slip an arm around " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s shoulders, bringing her into a tight embrace.  Smiling cutely, she nuzzles her cheek against your chest, and winds her large bat-wings around the two of you, wrapping you together.  You give her a long, tender kiss on the brow, and let her remain like that for a good long while, basking in each others' presence.");
            this.outputText("\n\nEventually, though, you know you need to get back to camp.  You try to tell " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + ", but to your surprise, she's fast asleep, snoring softly.  With a grin, you untangle yourself from her embrace and find something to cover her with before giving her another kiss and making your way home.");
            //(Return PC to camp, advance time 1 hour)
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0)
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Exgartuan);
            else
        ...
        //[b]Talk[/b]
        talkToGargoyle(output = true) {
            if (output) {
                this.clearOutput();
                this.outputText("You take a seat on one of the sanctuary's pews, motioning for " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " to join you.");
                //If Confidence <50:
                if (this.gargoyleConfidence() < 50)
                    this.outputText("  She meekly approaches her Master and kneels before you, head bowed submissively.");
                //if Confidence = 51-69: 
                else if (this.gargoyleConfidence() < 70)
                    this.outputText("  She nearly skips to follow you, assuming her low crouch at your feet and looking up at your expectantly.");
                else
                    this.outputText("  Happily, she takes a seat beside you and slips an arm around your shoulders, locking you in companionable closeness.");
            ...
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.GAR_HISTORY] < 3)
                this.addButton(0, "History", this.historyGo);
            if (this.flags[kFLAGS_1.kFLAGS.GAR_CATHEDRAL] < 3)
                this.addButton(1, "Cathedral", this.cathedralTalks);
            if (this.flags[kFLAGS_1.kFLAGS.GAR_NAME_TALKS] < 3)
                this.addButton(2, "Her", this.talkAboutGarName);
            this.addButton(4, "Back", this.returnToCathedral);
        }
        historyGo() {
            if (this.flags[kFLAGS_1.kFLAGS.GAR_HISTORY] == 0) {
                this.flags[kFLAGS_1.kFLAGS.GAR_HISTORY] = 1;
                this.talkToGargoyleHistoryA();
            }
            else if (this.flags[kFLAGS_1.kFLAGS.GAR_HISTORY] == 1) {
                this.historyOfGargoylesB();
                this.flags[kFLAGS_1.kFLAGS.GAR_HISTORY] = 2;
            }
            else {
                this.flags[kFLAGS_1.kFLAGS.GAR_HISTORY] = 3;
                this.gargoyleHistoryC();
            }
        }
        //[b]History A[/b]
        talkToGargoyleHistoryA() {
            this.clearOutput();
            this.outputText("You ask " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " what she can tell you about the history of Mareth.  She shrugs lightly.  \"<i>I can't tell you much, Master.  I've spent my entire life on these grounds.  Most of what I know was doctrine taught by the church. Is that acceptable?</i>\"");
        ...
        historyOfGargoylesB() {
            this.clearOutput();
            this.outputText("You ask " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " to tell you a little bit about the demons coming to Mareth");
            if (this.gargoyleConfidence() >= 70)
                this.outputText(" if she's up to it");
            this.outputText(".  ");
        ...
        gargoyleHistoryC() {
            ...
            if (kGAMECLASS_1.kGAMECLASS.izmaScene.izmaFollower() && kGAMECLASS_1.kGAMECLASS.isabellaFollowerScene.isabellaFollower()) {
                this.outputText("You ask " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " to tell you a little bit about the world of Mareth.  Giving it a few moments of quiet thought, she answers: \"<i>I do not have any experience outside of the church grounds, Master, but I remember the words of the last Master, and the parishioners before her.  There are... the world has a vast expanse of plains and woodlands, broken up by a mountain range and lake.  Those last two are populated by savage beasts, minotaurs, cow-girls, anemone, and shark-people, both of whom will rend your flesh or rape you half to death.</i>\"");
                this.outputText("\n\nWhoa, there. You stop " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " and explain to her that some of your lovers – mates, even – are just such beasts.  You tell her a little bit about Izma and Isabella, enforcing the fact that they're both not only quite friendly, but sweet as well.  They're just regular people");
                if (this.gargoyleConfidence() > 50)
                    this.outputText(" just like her");
                this.outputText(".  If she could, you're sure " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " would be blushing bright crimson as you educate her on a little inter-special tolerance and understanding.  Chastened, she nods her comprehension when you're finished and, after a long pause, asks, \"<i>I-If Master really has many... girlfriends... does... no, it's silly, of course not...</i>\"");
            ...
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CampMarble) >= 0) {
                this.outputText("You ask " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " to tell you a little bit about the world of Mareth.  Giving it a few moments of quiet thought, she answers: \"<i>I do not have any experience outside of the church grounds, Master, but I remember the words of the last Master, and the parishioners before her.  I believe there is a lake not far from here.  Beyond that, the world has a vast expanse of plains and woodlands, broken up by a great mountain range – strange monsters live there, but worst of all are savage bull-like beasts called Minotaurs.  And the cow-girls... Lacta-Bovines, I think they're called, who're just as nasty.</i>\"");
                this.outputText("\n\nYou cut " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " off right there, and explain that one of those 'savage beasts' is your lover, Marble, who's really quite sweet.  The gargoyle makes a horrified gasp and covers her mouth.  \"<i>I'm so sorry, Master! I didn't know...  All I'd heard were stories, years ago.  I didn't mean... but...  I-I didn't know Master had a girlfriend,</i>\" she whines pitifully.  Obviously, knowing that she's not your only lady-friend has upset the poor thing.");
                this.outputText("\n\nWell.  What do you say to that: that you're not exclusive with Marble, or that " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " doesn't count, being a statue and all?");
        ...
        //MARBLE
        //[b]Not Exclusive[/b]
        marbleAintExclusiveBiatch() {
            this.clearOutput();
            this.outputText("You run a hand through " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + "'s hair and reassure her that being with Marble won't affect the way you interact with her – you're more than able to be fond of many girls at once.  This doesn't seem to entirely please her, but neither does she throw a tantrum, so you suppose that's good enough.");
            this.returnToCathedral(true);
        }
        //[b]Doesn't Count[/b]
        //(Confidence -5)
        gargoyleDoesntCountAsAWaifu() {
            this.clearOutput();
            this.outputText("You scoff and tell her not to worry – it's not like you're cheating on Marble by being around her, after all.  She's just a statue – a toy, really. Her head sinks low, and the little gargoyle lets out a shudder that might just have been a sob.  You shake your head and change the subject.");
        ...
        //IZMA
        //[b]Not Exclusive[/b]
        sharkgirlsArentExclusiveBiatch() {
            this.clearOutput();
        ...
        //[b]Doesn't Count[/b]
        gargoylesDontCountAsSharkWaifus() {
            this.clearOutput();
            //(Confidence -5)
            this.gargoyleConfidence(-5);
            this.outputText("You scoff and tell her not to worry – it's not like you're cheating on Izma by being around her, after all.  She's just a statue – a toy, really.  Her head sinks low, and the little gargoyle lets out a shudder that might just have been a sob.  You shake your head and change the subject.");
            //(Return PC to " + flags[kFLAGS.GAR_NAME] + "'s main menu)
            this.returnToCathedral(true);
        }
        //IZMA & ISABELLA
        //[b]Dodge[/b]
        izmaAndIsabellaDodge() {
            this.clearOutput();
            //(Confidence -5)
            this.gargoyleConfidence(-5);
            this.outputText("You make a shitty joke and laugh awkwardly, trying to avoid the topic altogether.  " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " makes a pitiful little sniffle, but takes the hint and falls silent, allowing you to change the subject.");
            //(Return PC to Talk menu)
            this.returnToCathedral(true);
        }
        //[b]Slave[/b]
        //(Confidence -15)
        gargoylesAreSlavesYo() {
            this.clearOutput();
            this.gargoyleConfidence(-15);
            this.outputText("Well, really, what is she but a slave?  She's just a toy when you want sexual release, a servant to perform rituals at your demand, and a bit of eye-candy besides.  She's not even a real person – not really.  You tell her that, quite bluntly.  She makes no response, verbally at least, but she does give off a sob-like shudder and curls up into a little ball where she sits, hiding her face from you.");
            this.outputText("\n\nSince you've temporarily broken the gargoyle, you mosey on back to camp.");
            //(Return PC to camp, advance time 1 hour)
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[b]Girlfriend[/b]
        gargoylesAreGirlfriends() {
            //(Confidence +15)
            this.clearOutput();
            this.gargoyleConfidence(15);
            this.outputText("You smile at " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " and tussle her hair.  Warmly, you tell her that, if she wants, she can be your girlfriend too.  Polyamory is just your thing, you suppose.  With a happy gasp, the little gargoyle leaps into your lap and wraps her arms around you, hugging you so tight you almost can't breathe.  She gives you a flurry of little kisses all along your neck and cheek before planting a long, deep one on your lips.  You kiss her back, soon laughing amicably as you return her embrace.  Once she's calmed down, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " settles into your lap, resting her cheek against your chest and wrapping her tail and wings lovingly around you.  You give her a little peck on the forehead and nuzzle your chin into her hair, content to stay like this forever.");
            this.outputText("\n\nYet, you're soon surprised when " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " withdraws slightly from you, though her arms are still hooked about your neck.  \"<i>Master... if you want me to be your girlfriend, then... we should – if you want, Master, of course – maybe...  Master, will you make love to me?</i>\" she blurts, suddenly taken aback by her own forwardness.");
        ...
        //[b]Encourage[/b]
        //(Confidence +2)
        encourageGargoyleWaifuToDoSomething() {
            this.clearOutput();
            this.gargoyleConfidence(10);
            this.outputText("You give " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " a pat on the head and tell her it's a wonderful idea.  She makes a happy squeak and immediately flutters over to a pile of debris and starts cleaning it up.  Before you know it, the little gargoyle's on a roll, whistling a jaunty tune as she starts repairing some of the more obvious damage.  Seeing her so engrossed, you can't help but smile.  You wander over and start to give her a hand.");
            this.outputText("\n\nWithin the hour, the two of you have made a sizable dent in the debris of the Cathedral, and " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " has even managed to hang one of the candelabras back up in the rafters.  Exhausted, you say goodbye to the happy little gargoyle and head on back to camp.");
        ...
        cathedralC() {
            this.clearOutput();
            this.outputText("As you sit down with " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " to talk, you remember her words when you first met indicating that she could not – or would not – leave the Cathedral, even if you asked her to.   You ask her about that.");
            this.outputText("\n\n\"<i>Master,</i>\" " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " says, now looking you straight in the eye, \"<i>the Cathedral is my home, the only home I've ever known.  Even if I could leave, I would not want to");
            if (this.gargoyleConfidence() > 69)
                this.outputText(" unless it were to be with you, that is");
            this.outputText(".  But I am bound to this place, Master. I could not leave even if I wanted to.  My makers were wary of their creation, and chose to bind me here; they thought that if I ever rebelled, I would not do much harm if contained within the Cathedral.</i>\"");
        ...
        comfortGargoyle() {
            ...
            this.outputText("\n\nTo your surprise, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " follows you, running to catch up with you.  She takes your hand in hers and wraps one of her wings around you as you walk, holding you close as you make your way out the doors and onto the grounds.  Soon, though, you see " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " slowing and grimacing – approaching the edge of her boundary.  The two of you stop at the wrought-iron fence surrounding the Cathedral, and face each other.");
        ...
        //[b]Berate[/b]
        //(Confidence -10)
        berateDatGargoyle4SomeSavin() {
            this.clearOutput();
            this.outputText("Right.  Because becoming a living footstool for you was TOTALLY worth everyone she ever knew being raped out of their minds.  You give " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " a hard swat and remind her exactly how moronic she's being.  She recoils, shying away from you as you stand up and head for the door.  Over your shoulder, you tell her you're glad she's bound here – that way she can't fuck up and get you killed, too.");
            //(Return PC to camp, advance time 1 hour)
            this.gargoyleConfidence(-10);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        talkAboutGarName() {
            if (this.flags[kFLAGS_1.kFLAGS.GAR_NAME_TALKS] == 0) {
                this.flags[kFLAGS_1.kFLAGS.GAR_NAME_TALKS] = 1;
                this.garNameA();
            }
            else if (this.flags[kFLAGS_1.kFLAGS.GAR_NAME_TALKS] == 1) {
                this.flags[kFLAGS_1.kFLAGS.GAR_NAME_TALKS] = 2;
                this.garNameB();
            }
            else {
                this.flags[kFLAGS_1.kFLAGS.GAR_NAME_TALKS] = 3;
                this.garNameC();
            }
        }
        ...
        garNameA() {
            this.clearOutput();
            this.outputText("Curious about your gargoyle, you ask " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " to tell you a little bit about her life before you arrived.  She makes a nervous chuckle at the request, and shyly says, \"<i>Master is too kind...  I am no one special...</i>\"");
            ...
            if (this.player.race() == "human")
                ...
                this.outputText("once were");
            this.outputText(", Master, and more.  We were to be their guardians, protectors – their perfect servants.</i>\"");
            ...
            if (this.gargoyleConfidence() > 69)
                this.outputText("  She continues, \"<i>though even were I not compelled to, I would still serve you,</i>\" she says with a playful wink.");
            ...
            if (this.gargoyleConfidence() <= 69)
                ...
                this.outputText("After what she did to me, I never thought I'd enjoy sex again.</i>\"  With a loving smile, " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " takes your hand in hers and brushes it against her cheek.  \"<i>But for you, Master, I think I could make an exception.</i>\"");
            ...
            //If Confidence =<69:
            if (this.gargoyleConfidence() <= 69)
                this.outputText("  \"<i>I'm sorry, Master, I can't... it hurts too much to think about it.</i>\"");
            else
                this.outputText("  \"<i>Sorry, Master. I just....Don't want to talk about it right now.  Ask me again some time.</i>\"");
        ...
        garNameB() {
            ...
            this.outputText("\n\nYou don't need to prompt " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " this time.  \"<i>She left, perhaps ten years ago.  One day I was following orders to Master's pleasure, and the next I was bound to my pedestal, wearing the chains that Master broke to set me free.</i>\"");
        ...
        comfortGarNameC() {
            this.clearOutput();
            this.outputText("You pull " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " onto your lap and run your hand through her hair.  You tell her that she's wrong – dead wrong.  She is a person, and she is not helpless.  She's anything but.");
            ...
            this.outputText("\n\nShe smiles weakly, and rests her head on your chest.  \"<i>As you command, Master,</i>\" she says, and falls silent.  You sit there for a long while, stroking the gargoyle's soft hair and hoping you have made an impression on her.  But, eventually, you know you have to part.  You give " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " a little kiss on the forehead and tell her to do whatever she wants while you're gone.");
            ...
            this.outputText("\n\nSighing, you pat " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " on the head and tell her you'd be happy to stay for a while longer.  Beaming, she asks you what you'd like to do.");
        ...
        gargoyleAppearance() {
            this.clearOutput();
            this.outputText("" + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " is a gray marble statue that, through magics you can't quite grasp, has been animated.");
            ...
            if (this.gargoyleConfidence() < 70)
                this.outputText("glow timidly, reflecting a submissive and servile nature in the gargoyle.");
            else
                this.outputText("have a cool fire in them, showing her steadily-growing confidence and warmth toward you.");
            this.outputText("  Her skin is cold and smooth to the touch, a consequence of her marble material, yet she is quite soft, almost squishy.  " + this.flags[kFLAGS_1.kFLAGS.GAR_NAME] + " has a pair of cute little horns upon her brow, and has bat-like wings sprouting from her back which give a gentle flap every few seconds, an unconscious gesture on her part as you stare at her.  She has a long, spiked tail that curls ");
            if (this.gargoyleConfidence() < 70)
                this.outputText("timidly");
            else
                this.outputText("playfully");
            this.outputText(" about her thighs.  She has two normal human legs sculpted to end in normal human feet.");
    ...
    exports.Gargoyle = Gargoyle;
});
//# sourceMappingURL=Gargoyle.js.map