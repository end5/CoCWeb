define(["require", "exports", "../../BaseContent", "../../GlobalFlags/kFLAGS", "../../ItemType", "../../../console"], function (require, exports, BaseContent_1, kFLAGS_1, ItemType_1, console_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Lumi extends BaseContent_1.BaseContent {
        lumiEncounter() {
            this.outputText("", true);
            //1st time lumi meeting
            if (this.flags[kFLAGS_1.kFLAGS.LUMI_MET] == 0) {
        ...
        lumiLabChoices() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.LUMI_MET] == 0) {
                //Set Lumi met flag 
                this.flags[kFLAGS_1.kFLAGS.LUMI_MET]++;
        ...
        lumiShop() {
            ...
            this.simpleChoices(this.consumables.L_DRAFT.shortName, this.lumiLustDraftPitch, this.consumables.GOB_ALE.shortName, this.lumiPitchGobboAle, this.consumables.OVIELIX.shortName, this.lumiPitchOviElixer, "", undefined, "Leave", this.lumiLabChoices);
        }
        //Lust Draft
        lumiLustDraftPitch() {
            this.spriteSelect(37);
        ...
        lumiEnhance(justCheck = false) {
            ...
            if (justCheck) {
                return fox != undefined || kanga != undefined || seed != undefined || laBova != undefined || succuDelight != undefined || oviElix != undefined || lustDraft != undefined || kitsune != undefined;
            }
            this.outputText("", true);
            ...
            if (this.player.gems < 100) {
                ...
                this.choices(this.consumables.FOXBERY.shortName, fox, this.consumables.FOXJEWL.shortName, kitsune, this.consumables.GLDSEED.shortName, seed, this.consumables.KANGAFT.shortName, kanga, this.consumables.L_DRAFT.shortName, lustDraft, this.consumables.LABOVA_.shortName, laBova, this.consumables.OVIELIX.shortName, oviElix, this.consumables.SDELITE.shortName, succuDelight, "", undefined, "Back", this.lumiLabChoices);
                return true;
            }
        }
        lumiEnhanceLaBova() {
        ...
        lumiEnhanceGo(itype) {
            this.spriteSelect(37);
            console_1.trace("LUMI ENHANCE");
            var nextItem = ItemType_1.ItemType.NOTHING;
