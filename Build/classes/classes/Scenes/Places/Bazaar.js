define(["require", "exports", "../../BaseContent", "./Bazaar/Benoit", "./Bazaar/Cinnabar", "./Bazaar/FapArena", "./Bazaar/Lilium", "./Bazaar/Roxanne", "../../GlobalFlags/kFLAGS", "../../PerkLib", "../../../../includes/appearanceDefs"], function (require, exports, BaseContent_1, Benoit_1, Cinnabar_1, FapArena_1, Lilium_1, Roxanne_1, kFLAGS_1, PerkLib_1, appearanceDefs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Bazaar extends BaseContent_1.BaseContent {
        constructor() {
        ...
        approachBazaarGuard() {
            this.outputText("", true);
            this.outputText("You step from concealment and walk up to the strange man, calling out in greeting.  He folds his arms across his chest and looks you up and down, peering at you with intense, black eyes.  They aren't solid onyx, but his irises are just as dark as the seemingly bottomless depths of his pupils.  His appraising gaze watches you, unblinking as second after second ticks by.  Just when you start to wonder if he speaks your language, he interrupts you by saying, \"<i>", false);
            if (this.player.cor < 33)
                this.outputText("Leave at once.  You are not yet ready for the wonders of the Bazaar.", false);
            else
                this.outputText("Welcome to the Bizarre Bazaar.  Enter, but be mindful of your actions within.", false);
            this.outputText("</i>\"", false);
            if (this.player.cor < 33)
                this.simpleChoices("", undefined, "", undefined, "", undefined, "", undefined, "Leave", this.camp.returnToCampUseOneHour);
            else
                this.simpleChoices("Enter", this.enterTheBazaar, "", undefined, "", undefined, "", undefined, "Leave", this.camp.returnToCampUseOneHour);
        }
        enterTheBazaar() {
            if (this.model.time.hours == 19 || this.model.time.hours == 20) {
                this.flags[kFLAGS_1.kFLAGS.COUNTDOWN_TO_NIGHT_RAPE]++;
                if (this.flags[kFLAGS_1.kFLAGS.COUNTDOWN_TO_NIGHT_RAPE] % 4 == 0 && this.player.gender == 1) {
                    this.nightBazaarButtfuck();
                    return;
                }
            }
        ...
        enterTheBazaarAndMenu(demons = true) {
            ...
            var benoitT = "MarketStall";
            if (this.model.time.hours >= 9 && this.model.time.hours <= 17) {
                if ((this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT_DONE] == 1 && this.getGame().model.time.days >= this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT]) || this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT_DONE] != 1) {
                    if (this.flags[kFLAGS_1.kFLAGS.TIMES_IN_BENOITS] == 0) {
                        ...
                        this.outputText("\n\n" + this.benoit.benoitMF("Benoit", "Benoite") + " the basilisk's stall looks open for business.  You could go see what's on offer.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00221] > 0)
                roxanneT = "Roxanne";
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00267] > 0)
                lilium2 = "Lilium";
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00292] == 0 && Bazaar.rand(4) == 0 && demons) {
                this.overHearDemonsAboutSyrena();
                return;
            }
            if ((this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00292] == 1 || this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00292] == 2) && demons && Bazaar.rand(10) == 0) {
                //[Repeat Variant]
            ...
            var niamh = undefined;
            if (this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] > 0 && this.flags[kFLAGS_1.kFLAGS.NIAMH_MOVED_OUT_COUNTER] == -1) {
                if (this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] == 2)
            ...
            if (this.lilium.LiliumText(false) != undefined)
                this.addButton(4, lilium2, this.lilium.LiliumText(false));
        ...
        theSlipperySqueeze() {
            ...
            //(First time desc:
            if (this.flags[kFLAGS_1.kFLAGS.BAZAAR_SLIPPERY_SQUEEZE_VISITED] == 0) {
                this.flags[kFLAGS_1.kFLAGS.BAZAAR_SLIPPERY_SQUEEZE_VISITED]++;
            ...
            //Cock Milker
            else if (this.player.hasKeyItem("Cock Milker") < 0 && this.flags[kFLAGS_1.kFLAGS.JOEY_OFFERED_MILKER] == 0 && this.player.hasKeyItem("Cock Milker - Installed At Whitney's Farm") < 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.JOEY_OFFERED_MILKER] = 1;
            }
            //(Repeat visit: 
            else {
                ...
                if (this.player.findPerk(PerkLib_1.PerkLib.Androgyny) < 0) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.JOEY_OFFERED_MILKER] > 0 && this.player.hasKeyItem("Cock Milker") < 0 && this.player.hasKeyItem("Cock Milker - Installed At Whitney's Farm") < 0)
            ...
            if (this.isEaster()) {
                ...
                if (this.player.gems < 20)
                    this.outputText("  You can't afford it.");
                else
                    this.addButton(3, "SweetMassage", this.joeySweetMassage);
            }
        ...
        joeyAndrogyny() {
            ...
            this.statScreenRefresh();
            this.outputText("Joey takes your hand in his and insistently pulls towards the back rooms.  \"<i>Once we have this all done ", false);
            if (this.player.gender == 1)
                this.outputText("you'll be able to be as cute as me!", false);
            else if (this.player.gender == 2)
                this.outputText("you'll be able to be as masculine as you want!", false);
            else
                this.outputText("you'll be able to be as cute as me or as masculine as you want!", false);
            ...
            this.player.createPerk(PerkLib_1.PerkLib.Androgyny, 0, 0, 0, 0);
            this.dynStats("lus", 5);
        ...
        joeyMassage() {
            ...
            if (this.player.hasCock()) {
                ...
                this.doNext(this.joeysMassageWifNoExtraJizz);
        }
        joeysMassageWifNoExtraJizz() {
            this.outputText("", true);
            //(Continue as NoWang)
            this.outputText("The rabbit-eared fem-boy climbs back onto the table and strokes himself a few times over your " + this.assDescript() + "; the first drops of his 'special oil' feel hot as they land on the curves of your butt cheeks.  He climbs over you, touching himself just enough to stay hard while his cum-drooling cock stops dripping and starts genuinely leaking.  A long trail of bunny-spunk is dripped onto your " + this.assDescript() + " until you're glazed with thick ropes of it.  You spot his discarded thong on the floor and giggle as you feel him flip around to put his cute bunny-butt on your shoulders.  His spunk immediately runs down your spine, even as his hands smear it all over your " + this.player.skinDesc + ".\n\n", false);
            this.outputText("The massage heads back towards your " + this.buttDescript() + "; Joey's hands fill with your flesh as he fondles and strokes, spreading the jism into every nook and cranny, even your " + this.assholeDescript(), false);
            ...
            this.outputText("Joey stands and turns, his cum drooling into your " + this.hairDescript() + " as he asks, \"<i>Would you roll over for me?</i>\"  Eager for more of his skilled massage and impelled by your own growing arousal, you roll over, letting his jism drip onto your face.  He sits down gently, resting his barely-felt weight atop your bellybutton, and in no time, his fingers are smearing more of his fragrant, constantly-leaking goo over your " + this.chestDesc() + ".  The long-eared fem-boy rubs around your " + this.nippleDescript(0) + "s, trailing delicate circles that make the perky, pink flesh harden and glisten.\n\n", false);
            this.outputText("A soft, slippery hand takes your own and guides it to one of your " + this.nippleDescript(0) + "s, bidding you to play with it.  You do enthusiastically, even while Joey's same hand gathers more of the salty white lotion to smear over the front of your shoulders and arms, working it into your pores as effectively as he works the tension from you.  Unable to deny your growing need, you lift your head to watch with perverse fascination.  Joey is blushing hard, but he holds himself immobile while the whitish goop continually pours from him.  While his dick would've been considered average back home, here, in this place, he's tiny.  He really does remind you of a lotion dispenser, pumping out globs of sticky whiteness to be rubbed into one's skin.\n\n", false);
            this.outputText("You catch a view of your hand as it ", false);
            if (!this.player.hasFuckableNipples())
                this.outputText("tweaks and teases", false);
            else
                this.outputText("sinks a finger deep inside", false);
            this.outputText(" your " + this.nippleDescript(0) + ", and you raise your other to match it.  Joey smiles and pants, \"<i>Yes, we need to get out allll your tension, even that... uh... naughty... ah... sexual tension.  Mmmmm, now just lie your head back.  I'm almost done, and we always give our clients a facial treatment while we ease their worries.</i>\"\n\n", false);
            this.outputText("The bed cradles you as you close your eyes and lie back, noting the slight change in darkness beyond your eyelids from Joey's new position.  Spunk begins to rain over your " + this.player.face() + ", puddling seed around your eyes and forehead before it drips down your cheeks and bubbles on your lips.  You're quickly distracted from the salty, cummy facial when your personal leporid lotion-dispenser ", false);
            //(fork to male or genderless, no new PG)
            //(MALE)
            if (this.player.hasCock()) {
                this.outputText("slides his warm, ruby lips over your " + this.cockDescript(0) + ", licking and slurping the " + this.player.cockHead() + " like a treasured candy.  That hot, breathy embrace hugs tight to your urethral bulge, slobbering up the cock-tip.  The flexible, thin rabbit tongue swirls over your cum-slit to lap at the bubbling pre-cum, even as his quaking balls continue to bury your face in bunny-semen.", false);
                if (this.player.totalCocks() > 1) {
                    this.outputText("  He takes your " + this.cockDescript(1) + " with his free hand and pulls it over, giving it an affectionate, loving smooch.", false);
                    if (this.player.totalCocks() > 2) {
                        this.outputText("  The process is repeated", false);
                        if (this.player.totalCocks() > 3)
                            this.outputText(" as necessary until " + this.sMultiCockDesc() + " is coated with dick-drenching bunny spit.", false);
                        else
                            this.outputText(", coating your " + this.cockDescript(2) + " with dick-drenching bunny spit.", false);
                    }
                }
                this.outputText("  A moment later, ", false);
                if (this.player.balls > 0)
                    this.outputText("his hand firmly rubs your " + this.sackDescript() + ", and ", false);
            ...
            //(FEM/GENDERLESS) 
                ...
                if (this.player.hasVagina())
                    this.outputText("presses his ruby lips into the glistening delta of your mons", false);
                else
                    this.outputText("presses a finger against the semen-soaked ring of your " + this.assholeDescript(), false);
            ...
            if (!this.player.hasCock()) {
                ...
                if (this.player.gender == 0)
                    this.outputText("Though his single finger makes you burn with passion, Joey's second slides effortlessly after it, filling your " + this.assholeDescript() + " with another of his cum-soaked digits.  His warm jism slides down the crack between the fingers, slowly pooling in your backdoor.  Once you've adjusted, he continues to the massage, stroking and bumping your interior with the confident, practiced strokes of a professional. You pull hard on your tortured " + this.nippleDescript(0) + "s, egging up the gradual upwelling of pleasure while you lick the bunny-cream from your lips.  A moment later, the no-longer-offending digits press hard on a sensitive spot, and you're arching your back, screaming with pleasure.\n\n", false);
                //(Female orgasm)
                else {
                    this.outputText("Though his spit and cum-lubed tongue is quite skilled, deftly tasting your labia and channel, the bunny adds a pair of fingers to the mix, pulling the musky tunnel wide and letting more of his slippery seed inside you.  He uses it like lube, sliding his digits around while he sucks your " + this.clitDescript() + " ", false);
                    if (this.player.clitLength >= 4)
                        this.outputText("like a practiced whore fellating a john.", false);
                    else
                        this.outputText("like a professional pussy-licker.", false);
                    this.outputText("  You give your " + this.nippleDescript(0) + "s a hard tweak, torturing them as the building pleasure grows.  Aware of this, Joey curls a finger to press directly on a sensitive spot, deep inside you, and then you're arching your back and howling with unleashed release.\n\n", false);
                }
                //(continuing)
            ...
            //(Dickgasms
                ...
                this.outputText("Though Joey's mouth is making you burn with passion, it's the feeling of a single, intruding fingertip against your " + this.assholeDescript() + " that puts you on edge.  His warm jism slides down his finger, dripping into your violated backside with each slow pump.  Once you've adjusted, he continues the rectal massage, gently caressing the sides of your prostate while his mouth stays busy with your " + this.cockDescript(0) + ".  The bunny's tongue thrashes, twisting like a slippery eel over your length, his cheeks hollowing from the suction he's applying.  A moment later, Joey curls the digit inside you to press firmly against your prostate, squeezing the sensitive organ tightly enough to make your hips pump into the air.\n\n", false);
                ...
                if (this.player.cumQ() >= 700) {
                    this.outputText("  A smile widens your " + this.player.face() + " when you see the ", false);
                    if (this.player.cumQ() >= 2000)
                        this.outputText("massive, jiggling belly you've given him.", false);
                    else
                        this.outputText("little paunch on his belly jiggle.", false);
        ...
        joeysMassageWithEXTRASpooge() {
            ...
            if (this.player.balls == 0)
                this.outputText("inside you", false);
            else
            ...
            if (this.player.balls > 0)
                this.outputText("Your balls pull and relax and pull tight, bouncing below you over and over, all while working hard to produce more juice for you to gush.  ", false);
            ...
            this.outputText("Joey giggles, turning about to put his lotion-dispenser on the small of your back, and you feel the hot bunny-spoo pour onto you in a wave.   It's gathered up and pushed up your back.  Globs of it roll down your side, sliding over the semi-waterproofed sheets to mix with your growing spunk-lake.  With the slippery-seed aiding Joey's massage, he somehow manages to work out even more of your tension.  By this point your muscles feel like jello melting in the afternoon sun.  You feel like you could melt into your cum, and you sigh in bliss", false);
            if (this.player.cumQ() >= 1500)
                this.outputText(".  The sound of your rivers of spooge splattering against the floor barely registers, but a part of you is proud to be so incredibly fertile", false);
            this.outputText(".\n\n", false);
            ...
            if (this.player.cumQ() >= 1500)
                this.outputText("  Joey's jaw drops from the unexpectedly large volume you're producing, and he watches in awe as each huge globule of cum rolls off you towards the floor.", false);
            this.outputText("\n\n", false);
            this.outputText("The bunny-boy springs back atop you, landing hard just below your hips.  His dripping seed washes over " + this.sMultiCockDesc() + ", and the sudden onslaught of fresh, liquid warmth on your groin sets off a small explosion of jism that splatters into your chin, leaving a long trail of slime behind like a snail.  The long-eared girly-boy smiles and shifts to rub his small cock against your " + this.cockDescript(0) + ", frotting you aggressively while you both spray cum like faucets with the knobs torn off.  You don't mind that he seems to have forgotten the massage, and you run your hands up and down your " + this.chestDesc() + " to smear the heavy loads ", false);
            if (this.player.skinType != appearanceDefs_1.SKIN_TYPE_FUR)
                this.outputText("over your " + this.player.skinDesc, false);
            else
                this.outputText("through your fur", false);
            this.outputText(".\n\n", false);
            this.outputText("The special potion makes it so your orgasm is long and languid, oozing out for minutes instead of seconds, and the small chamber is filled with breathy, exultant cries of passion.  Joey leans forward and grabs hold of your " + this.nippleDescript(0) + "s, ", false);
            if (!this.player.hasFuckableNipples())
                this.outputText("squeezing and tugging on them", false);
            else
                this.outputText("sliding cum-coated fingers into their slippery depths", false);
            this.outputText(" while he grinds and cums on your " + this.cockDescript(0) + ".  \"<i>Ungg... yes... gotta... squeeze... allofitooooouuuuut!</i>\" he pants.  He lets go of one tender nipple to reach underneath you, and before you can react, his cum-soaked finger is inside your " + this.assholeDescript() + ", pressing on your prostate.\n\n", false);
            ...
            if (this.player.cumQ() >= 1500)
                this.outputText("  You really flooded the room though, so you'd best walk on your tip-toes until we can get a succubi or a goblin in here to clean up.", false);
        ...
        joeyBigBalls() {
            this.outputText("", true);
            //(FIRST TIME) 
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00348] == 0) {
                ...
                this.outputText("Why is it that no one ever desperately requires your assistance with a mundane task?  Sighing, you judge", false);
                ...
                if (this.player.cor > 70)
                    this.outputText("; you won't get to watch him fountaining all that pearly spunk like a perverted statue", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00348]++;
        }
        //Masturbate It Out (work it out on the floor)
        joeyWanksItOut() {
            this.outputText("", true);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00349] == 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00349]++;
        }
        ...
        suckOffJoeysGardenHose() {
            ...
            this.outputText("Joey's rouged lips silently mouth, \"<i>Oh gods,</i>\" as he delivers the next, even bigger rope to your eager maw, stuffing your mouth so quickly that his jism squirts from the corners before you can react.  You shiver from the semen overload", false);
            if (this.player.minotaurAddicted())
                this.outputText(" and find yourself wishing you had one of these potions to use on a minotaur.  It would be divine!", false);
            else
                this.outputText(" and keep at it.  The knowledge that you're helping a friend is almost as filling as his delicious cum.", false);
            ...
            if (this.player.cor < 33)
                this.outputText("all for a good cause, right?", false);
        ...
        overHearDemonsAboutSyrena() {
            this.outputText("", true);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00292] == 0) {
                this.outputText("A whisper of conversation catches your ear while you're wandering the bazaar, and overcome by curiosity, you veer towards it.\n\n", false);
                this.outputText("As you're closing in on the voices, the dialogue grows clear enough to understand.\n\n", false);
                this.outputText("\"<i>-old him if he doesn't finish this week's experiments, she's going to drop him into a submission tank instead of the champion!</i>\" exclaims the first voice, sounding quite feminine.\n\n", false);
                this.outputText("A baritone response rings out, \"<i>You're shitting me!  Syrena's off her fucking rocker if she thinks Lethice will let her turn another of our researchers into a gibbering slut.  We've got enough of those.</i>\"\n\n", false);
                ...
                this.outputText("The male laughs and says, \"<i>You belong underneath a fat dick, bitch.  Look at you, you've got strings of lube trailing on the ground behind you.  You're too busy slutting it up to accomplish anything.  I'm thinking I had better head back to the lab, though.  I don't want to wind up looking like one of the escaped factory rejects - gotta keep this perfect bod, ya know?</i>\"\n\n", false);
                this.outputText("You get a good look at the two when the crowd parts, and wow, that incubus is right.  He's a curly-haired, chiseled Adonis of a man, with a bulge as over-the-top of the rest of him straining at his fashionable pants.  The demon fiddles with his collar, popping it up, and he turns to leave.  The other commiserating devil is a busty succubus in a lab coat... nothing else.  She's even wetter than her companion's words would indicate, painting a thick trail of slippery girl-slime in her wake as she moves.  The succubus' nipples are like two hard bullets, soaking two glorious wet patches into her coat as she argues back.\n\n", false);
                this.outputText("\"<i>S-shut up.  That cunt tested some of her prototype compounds on me, remember?  That stuff turned my pussy into an insatiable furnace.  If I can get some free time... I'll... I'll... oh screw it, let's go rent a room and fuck a few times before we go back.  I'll want to be thinking clearly when I face her.  Syrena won't get to gloat about me jumping on her fat... juicy... mmm... cock... this time!</i>\"  The succubus takes the incubus' hand and drags him away in a hurry.\n\n", false);
                this.outputText("Well, that explains a lot.  The demons seem to have an active research department, though the one called Syrena does not seem to please her underlings very much.  Then again, you doubt any demonic servants are pleased with their bosses.  You can't wait to put a stop to their labors, but for now, there's nothing to do but use the bazaar or go home.\n\n", false);
            }
            //[Listen in repeat]
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00292] == 1) {
                this.outputText("Just as before, you spot the collar-popping incubus and his lab coat-clad lover complaining about their boss.\n\n", false);
                this.outputText("\"<i>-still sore!  I can't believe she did that to me!</i>\" groans the male.\n\n", false);
                this.outputText("Smiling cruelly, the slick-pussied succubus says, \"<i>You deserved it.  Honestly, you turned in cum-stained reports to your boss, and you're surprised that she took your ass for a ride as punishment?  If you ask me, you planned all this.  Who do you think had to clean up the huge mess you left on the floor?</i>\"\n\n", false);
                this.outputText("For once, the incubus seems speechless.  He mutters, \"<i>Well, I didn't plan it.  I-I was just having fun with one of the new slaves - for inspiration - while I finished up the paperwork.</i>\"  He looks over and punches the leering female's arm.  \"<i>Besides, I thought you liked cleaning up my cum?  I've never seen you complain before.</i>\"\n\n", false);
            ...
            //[Listen in Repeat 2]  
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00292] >= 2) {
                ...
                this.outputText("His pregnant companion growls and tugs at her undersized labcoat, failing to conceal the blueberry-colored bulge of her belly from him as she retorts, \"<i>You didn't have to get all these fucked into you, now did you?  Hell, she even shot me up with fertility-plus first!  It feels like there's two dozen of the little bastards packed in there!  I figure in another day or two I won't even be able to walk.</i>\"\n\n", false);
                this.outputText("\"<i>So does that mean you won't mind if I stop by whilst you're laid up?  I mean you can't get any more pregnant with imps, and it might pass the time,</i>\" suggests the well-muscled male.\n\n", false);
                this.outputText("Smirking, the demoness retorts, \"<i>Sure, but next time you fuck up, I'm loaning Syrena some of my girly stuff to make you suffer just like this.</i>\"  Her hands both point at the imp-engorged skin of her midsection for emphasis.\n\n", false);
                this.outputText("The incubus rises and taunts, \"<i>If I fucked up as often as you did, I'd be feeding the furnace in a factory somewhere or fed to the hellhounds.  Come on, let's get you home before I have to roll you back.</i>\"\n\n", false);
            ...
            this.doNext(this.enterTheBazaar);
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00292]++;
        }
        //"Greta's Garments" - Interior
        gretasGarments() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.FOUND_SOCKS] == 1 && this.flags[kFLAGS_1.kFLAGS.SOCK_COUNTER] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.FOUND_SOCKS] = 2;
                return;
            }
            if (this.flags[kFLAGS_1.kFLAGS.FOUND_SOCKS] < 2) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.OWN_MAIDEN_BIKINI] == 0)
                    this.outputText(", except maybe a super-skimpy chain bikini that's chased with white and gold highlights");
            }
            else {
            ...
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.FOUND_SOCKS] == 0)
                this.addButton(4, "Low Stock", this.askGretaAboutInventory);
            else {
                if (this.flags[kFLAGS_1.kFLAGS.FOUND_SOCKS] == 2 && this.player.cocks.length > 0 && this.player.hasSockRoom())
                    this.addButton(1, "Browse Socks", this.browseDemSocksSon);
                if (this.player.hasSock())
                    this.addButton(2, "Remove Sock", this.takeOffDatSock);
            }
            if (this.flags[kFLAGS_1.kFLAGS.OWN_MAIDEN_BIKINI] == 0)
        ...
        askGretaAboutInventory() {
            ...
            //[Back]
            if (this.flags[kFLAGS_1.kFLAGS.FOUND_SOCKS] == 0)
                this.flags[kFLAGS_1.kFLAGS.FOUND_SOCKS] = 1;
        ...
        askGretaAboutZeBikini() {
            ...
            if (this.player.gems < 500)
                ...
                this.addButton(0, "Buy Bikini", this.buyGretasBikini);
            this.addButton(4, "Back", this.gretasGarments);
        }
        //Buy Bikini
        buyGretasBikini() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.OWN_MAIDEN_BIKINI] = 1;
            this.player.gems -= 500;
            this.statScreenRefresh();
        ...
        scarletCockSocK() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] = "scarlet";
            this.cockSelectionMenu();
        }
        //Cobalt Cock-sock
        cobaltCockSock() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] = "cobalt";
            this.cockSelectionMenu();
        }
        //Gilded Cock-sock
        gildedCockSock() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] = "gilded";
            this.cockSelectionMenu();
        }
        //Amaranthine
        amaranthineCockSock() {
            ...
            this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] = "amaranthine";
            this.cockSelectionMenu();
        }
        cockSelectionMenu() {
            this.menu();
            if ((this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "amaranthine" && this.player.gems >= 1000) || (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "gilded" && this.player.gems >= 3000) || (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "cobalt" && this.player.gems >= 250) || (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "scarlet" && this.player.gems >= 250) || (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "viridian" && this.player.gems >= 1000) || (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "cockring" && this.player.gems >= 100) || (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "alabaster" && this.player.gems >= 25) || (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "wool" && this.player.gems >= 10))
                this.addButton(0, "Buy", this.pickACockForSock);
            else
            ...
            if (this.player.cockTotal() == 1) {
                ...
                while (button < this.player.cockTotal()) {
                    if (this.player.cocks[button].sock == "")
                        this.addButton(button, String(button + 1), this.cockSockTarget, button);
                    button++;
                }
            }
        }
        cockSockTarget(target) {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.SOCKS_BOUGHT]++;
            //Putting it On - First Time
            if (this.flags[kFLAGS_1.kFLAGS.SOCKS_BOUGHT] == 1) {
        ...
        //Yes
        yesPutDatSockOnMe(target) {
            this.clearOutput();
            var conflict = false;
            if (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "amaranthine")
                this.player.gems -= 1000;
            if (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "gilded")
                this.player.gems -= 3000;
            if (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "cobalt") {
                this.player.gems -= 250;
                // if(player.findPerk(PerkLib.PhallicRestraint) < 0) player.createPerk(PerkLib.PhallicRestraint,0,0,0,0);
            }
            if (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "scarlet") {
                //if(player.findPerk(PerkLib.PhallicPotential) < 0) player.createPerk(PerkLib.PhallicPotential,0,0,0,0);
                this.player.gems -= 250;
            }
            if (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "viridian") {
                if (this.player.findPerk(PerkLib_1.PerkLib.LustyRegeneration) < 0) {
                    this.player.createPerk(PerkLib_1.PerkLib.LustyRegeneration, 0, 0, 0, 0);
                    this.player.gems -= 1000;
                }
                else {
                    conflict = true;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "cockring") {
                this.player.gems -= 100;
                if (this.player.findPerk(PerkLib_1.PerkLib.PentUp) < 0)
                    this.player.createPerk(PerkLib_1.PerkLib.PentUp, 10, 0, 0, 0);
                else
                    this.player.addPerkValue(PerkLib_1.PerkLib.PentUp, 1, 5);
            }
            if (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "alabaster")
                this.player.gems -= 25;
            if (this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] == "wool")
                this.player.gems -= 10;
            this.outputText("You nod to the busty succubus and strip off your [armor], revealing your naked body.  Greta's eyes light up as she looks over your body with barely-contained lust.  Finally her eyes settle onto your " + this.cockDescript(target) + ", and she licks her lips.  ");
            if (!conflict) { // There's no conflict. DO IT!!!
                this.player.cocks[target].sock = this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING];
                this.statScreenRefresh();
        ...
        noCockSock() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.SOCK_HOLDING] = '';
        ...
        takeOffDatSock() {
            ...
            while (button < this.player.cockTotal()) {
                if (this.player.cocks[button].sock != "")
                    this.addButton(button, String(button + 1), this.removeTargettedSock, button);
                button++;
            }
        }
        removeTargettedSock(index) {
            this.clearOutput();
            //Select-A-Cock!
            ...
            this.outputText("\n\n\"<i>Ah, all right then,</i>\" she says smoothly, setting aside her knitting needles.  \"<i>Making room for a new sock, or just looking to get rid of this one?  No matter, it's a simple counterspell.</i>\"  Greta stands up from her chair, though she's only on her feet for a moment before she kneels down in front of you, placing one hand under your " + this.cockDescript(index) + ".  With her free hand, she runs a little circle around your " + this.player.cockHead(index) + ", muttering something under her breath.");
            this.outputText("\n\nSuddenly your cock feels white-hot, burning with passionate arousal.  It jumps to attention immediately");
            if (this.player.cockArea(index) >= 100)
                this.outputText(", almost knocking Greta over in the process");
            ...
            var storage = this.player.cocks[index].sock;
            var extra = false;
            ...
            if (extra && storage == "cockring") {
                if (this.player.perkv1(PerkLib_1.PerkLib.PentUp) >= 10)
                    this.player.addPerkValue(PerkLib_1.PerkLib.PentUp, 1, -5);
                else
                    this.player.setPerkValue(PerkLib_1.PerkLib.PentUp, 1, 10);
            }
            else {
                if (storage == "gilded") {
                    this.player.removePerk(PerkLib_1.PerkLib.MidasCock);
                }
                if (storage == "cobalt") {
                    this.player.removePerk(PerkLib_1.PerkLib.PhallicRestraint);
                }
                if (storage == "scarlet") {
                    this.player.removePerk(PerkLib_1.PerkLib.PhallicPotential);
                }
                if (storage == "viridian") {
                    this.player.removePerk(PerkLib_1.PerkLib.LustyRegeneration);
                }
                if (storage == "cockring") {
                    this.player.removePerk(PerkLib_1.PerkLib.PentUp);
                }
            }
        ...
        */
        ...
        eggsInButt(eggButt = false) {
            ...
            if (this.player.hasCock())
                ...
                this.outputText("pitifully empty mound");
            ...
            if (!this.player.hasCock())
                this.outputText(", in and out");
            this.outputText(", removing all that pent up tension from inside you.  ");
            if (this.player.hasCock())
                this.outputText("[EachCock] begins leaking pre-cum, mixing with Joey's on your belly to create what looks like a chocolate-white chocolate marbled confection.");
            else if (this.player.hasVagina())
                this.outputText("Your cunt grows ever wetter, and not just because of the new chocolate coating.  Despite Joey's femboy appearance, you've got to hand it to him, he does know his way around a pussy.");
            else
                this.outputText("Your asshole winks and clenches, aching for release that Joey is kind, and skilled, enough to give.");
            ...
            if (this.player.hasCock())
                this.outputText("takes hold of [oneCock] and strokes gently, rubbing his thumb against the head");
            else if (this.player.hasVagina())
                this.outputText("reaches between his legs, slipping two fingers inside you while his thumb gently rubs your clit");
            else
                this.outputText("reaches between his legs, slipping two fingers inside your ass while his thumb rubs against your perineum");
            ...
            if (this.player.hasCock())
                this.outputText("[eachCock] pulses and spasms, loosing rope after rope of white jizz through the air, splattering against the wall and floor messily");
            else if (this.player.hasVagina())
                this.outputText("your pussy tightens around his fingers, suddenly releasing a flood of femcum that splatters messily against the table");
            else
                this.outputText("your asshole twitches and spasms, unable to do much more than grant you a vague half-orgasm");
            ...
            if (this.player.hasCock()) {
                if (this.player.biggestCockArea() >= 30)
                    this.outputText(", especially compared to you.");
                else if (this.player.smallestCockArea() < 6)
                    this.outputText(", of course, if he's considered tiny, what does that make you?");
            }
            else
                this.outputText(".");
        ...
        assaultYoRapistYo() {
            ...
            //[(If strength is 50 or more)
                ...
                if (this.player.cor >= 66)
                    this.addButton(0, "Abuse Ass", this.abuseHisAss);
            }
        }
        //<Option 1 Leave>
        assaultWinAndLeave() {
        ...
        abuseHisAss() {
            ...
            //[(If multicock)
            if (this.player.cockTotal() > 1)
                this.outputText("  Your hand strokes along your " + this.multiCockDescriptLight() + " and press them to the warm cheeks exposed before you.");
            else
                this.outputText("  You pump your " + this.multiCockDescriptLight() + " and milk a pearl of pre-cum out to drip onto the enticing ass before you.");
            this.outputText("  \"<i>O-OI!</i>\"  The tiger man shouts out, his head turning to try to see behind him.  With a grin on your lips you grip the hilt of [oneCock] and slap its length over the tiger's rump.  You can see the tint to the tiger man's cheek as he hears and feels your dick smacking his exposed ass.  Pre-cum drips down [oneCock] as you line yourself up, jamming it between the tiger's lovely mounds. He gives a surprised shout as your cockhead presses to his tiny, puckered hole.");
            //Cocksize check
            ...
            if (this.player.smallestCockLength() >= 16) {
                ...
                if (this.player.totalCocks() == 1)
                    this.outputText("  You squeeze your " + this.multiCockDescriptLight() + " between his warm ass cheeks, stroking yourself with his exposed bottom.  The tiger whimpers meekly under you.");
                else
                    this.outputText("  Your fattest cock grinds between the tiger man's rear, dripping spunk over his back and clothing while your other cocks make a sloppy mess of his ass.");
                this.outputText("  The tiger man's muscled butt is soon glazed with your pre-cum.  Wet, slapping noises echo out into the alley as you grind your hips into his rear.  You can't help but think in the back of your head that the noise is stirring people inside the tent he came out of.");
            }
            //[[(If largest cock is smaller than 16)
                ...
                //[(If multicock)
                if (this.player.cockTotal() > 1)
                    this.outputText("  One of your cocks slips into his hot, constricting confines, the remaining lengths pressed fast to the tiger man's rear and leaving glistening trails of eager fluids like markings on a bitch's ass.");
                else
                    this.outputText("  Your " + this.multiCockDescriptLight() + " pushes in, your pre-cum-slicked length sliding in with a wet noise.");
                this.outputText("  The burly man under you whimpers in protest as you begin to rock against his fine ass.  His firm rear dimples and twitches under your hips, each slam");
                if (this.player.balls > 0)
                    this.outputText(" swatting your " + this.ballsDescriptLight() + " against him,");
                this.outputText(" making him shout out in discomfort.  Your " + this.multiCockDescriptLight() + " stretching him out");
                if (this.player.cockTotal() > 1)
                    this.outputText(" while beating his rear");
                this.outputText(".  All his shouting stirs whoever resides in the tent he came out of.");
            }
        ...
        collectSomeButtSmex() {
            this.clearOutput();
            this.outputText("Your body crashes into a wooden table and you choke, feeling the wind knocked out of you.  You struggle to lift your head and catch your breath, only to find yourself laying in... poker chips?");
            ...
            this.outputText("  Without warning the hand is gone");
            if (this.player.cockTotal() > 1)
                this.outputText(" and your " + this.multiCockDescriptLight() + " wetly slaps your stomach with need");
            this.outputText(".  A whimper escapes your lips.  \"<i>This should be fine...</i>\"  The cool, collected voice of the satyr murmurs.");
            ...
            if (this.player.lib < 50)
                this.outputText("fear");
            else
                this.outputText("excitement");
            this.outputText(".");
            ...
            if (this.player.isBiped())
                this.outputText("  The bear shifts where he stands, grabbing your ankles and spreading your limbs almost painfully wide.  You wince from the sting of the strain on your leg muscles.");
            this.outputText("  You hear the clopping of hooves on the floor as the satyr moves over to your " + this.buttDescript() + ".  His hands grip over your " + this.hipDescript() + " and drags you closer to the edge of the table so that your " + this.buttDescript() + " hangs over the side of the table.  You raise your head to watch with a ");
            if (this.player.lib < 50)
                this.outputText("horrified");
            else
                this.outputText("excited");
            this.outputText(" expression as the satyr's hand strokes over his hard length.  It looks at least eight inches long, smooth like a human's cock and protruding from a forest of curly, brown fur.  The satyr lines himself up and rubs his stiff cockhead over your " + this.assholeDescript() + ".");
            ...
            if (this.player.hasCock())
                this.outputText(" while [eachCock] twitches and leaks generously over your " + this.player.skinFurScales());
            this.outputText(".");
        ...
        finalGayFinallee(road = 0) {
            ...
            if (road == 0) {
                ...
                if (this.player.hasCock())
                    this.outputText("His hand dips down to play with your " + this.multiCockDescriptLight() + ", stroking you off as he gives a few more brutal pounds of his hips.  ");
                else if (this.player.hasVagina())
                    this.outputText("Fingers ram into your " + this.vaginaDescript(0) + ", thrusting into you as he fucks your other hole.  ");
                this.outputText("His face near yours, he licks your cheek and plants a brief kiss on your lips. You give him a confused look at the affection and he meets it with a wide grin.  \"<i>You're cute for a cocksucker.  Knew I had it made when I found you.</i>\" he snickers, causing you to blush.");
                if (this.player.gender > 0)
                    this.outputText("  Your lips part as you moan, feeling your climax building before coating the tiger's hand and your lower body in your sex.  The tiger man just brings his hand up to his lips to taste your juices before hilting into you one last time.");
                this.outputText("  A third wave  of warmth floods you, the pressure growing even higher as you resemble an overstuffed, breeding bitch.  Exhaustion catches up with you and you begin to feel your eyes grow heavy.  The last thing you see is the feline's face contorted in pleasurable orgasm before you nod off.");
            ...
            //((Ending 2 , suck bear, //crazy steel jaw))
                ...
                if (this.player.hasCock())
                    ...
                    this.outputText("Fingers ram into your " + this.vaginaDescript(0) + ", thrusting into you as he fucks your other hole.");
                this.outputText("  His face near yours, he licks your cheek and plants a brief kiss on your lips.  You give him a confused look at the affection and he meets it with a wide grin.  \"<i>You're cute for a cocksucker.  Loved the way you went right for my dick.</i>\"  He snickers, causing you to blush.");
                if (this.player.gender > 0)
                    this.outputText("  Your lips part as you moan, feeling your climax building before coating the bear's hand and your lower body in your sex.  The bear just brings his hand up to his lips to taste your honey before hilting into you one last time.");
                this.outputText("  A third wave of warmth floods you, the pressure growing even higher as you resemble an overstuffed, breeding bitch.  Exhaustion catches up with you and you begin to feel your eyes grow heavy.  The last thing you see is the bear's face contorted in pleasurable orgasm before you nod off.");
                this.outputText("\n\nYou wake up with a start, the sound of morning birds echoing in the abandoned tent is all that greets you.  You try to get up quickly but immediately regret it.  Your body is sore from all the abuse you took last night.  You slide off the table and look around for your gear.  Shockingly enough, you find it folded up in a neat bundle");
                if (this.player.gems > 1) {
                    this.outputText(" with only a few gems missing");
                    this.player.gems -= 3 + Bazaar.rand(4);
            ...
            //((Ending 3 , suck none, //No furry plx))
                ...
                if (this.player.hasCock())
                    this.outputText("  His hand drips down to clumsily play with your " + this.multiCockDescriptLight() + ", stroking you off as he gives you a few more brutal pounds of his hips.");
                else if (this.player.hasVagina())
                    this.outputText("  Fingers dip into your " + this.vaginaDescript(0) + ", ramming into you as he fucks your other hole.");
                if (this.player.gender > 0)
                    this.outputText("  Your lips part as you feel your climax building, and soon you coat the orc's hand and your lower body in your lust.  The orc just brings his hand up to taste your juices before hilting into you one last time.");
                this.outputText("  A third wave of warmth floods you and the pressure grows even higher as you resemble an overstuffed breeding bitch.  Exhaustion catches up with you and your eyes begin to grow heavy.  The last thing you see is the orc's face twisted in orgasmic pleasure before you pass out.");
