define(["require", "exports", "./AbstractFarmContent", "../../../StatusAffects", "../../../../../includes/appearanceDefs", "../../../CockTypesEnum", "../../../PregnancyStore", "../../../../console"], function (require, exports, AbstractFarmContent_1, StatusAffects_1, appearanceDefs_1, CockTypesEnum_1, PregnancyStore_1, console_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class KeltScene extends AbstractFarmContent_1.AbstractFarmContent {
    ...
    "KeltOff" - Turns off Kelt */
        bowSkill(diff) {
            this.player.addStatusValue(StatusAffects_1.StatusAffects.Kelt, 1, diff);
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Kelt) >= 100)
                this.player.changeStatusValue(StatusAffects_1.StatusAffects.Kelt, 1, 100);
            return this.player.statusAffectv1(StatusAffects_1.StatusAffects.Kelt);
        }
        ...
        keltEncounter() {
            ...
            this.player.addStatusValue(StatusAffects_1.StatusAffects.Kelt, 3, 1);
            //If First Encounter
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Kelt) < 0) {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Kelt, 0, 0, 1, 0);
                this.keltFirstTime();
            }
            //Repeated encounter
            else {
                //Second/Third Events - Normal
                if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Kelt) <= 3) {
                    this.keltMainEncounter();
                    return;
                }
                //Bad Ends
                if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 130) {
                    this.keltSubmissiveBadEnd();
                    return;
                }
                //Centaur bad end
                if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 100 && this.player.gender > 1) {
                    if (this.player.inte > KeltScene.rand(40) && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) < 130 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.KeltBadEndWarning) < 0) {
                        this.player.createStatusAffect(StatusAffects_1.StatusAffects.KeltBadEndWarning, 0, 0, 0, 0);
                ...
                if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Kelt) == 4 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.NakedOn) < 0) {
                    this.keltRequiresNakedness();
                    return;
                }
                //60+ Submissiveness—First Time Blowjob Requirement
                if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 40 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.KeltBJ) < 0) {
                    this.keltRequiresBlowjobs();
                    return;
                }
                //75+ Submissiveness, 60+ Lust—Lust Encounter
                //Remaining events
                if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Kelt) > 4) {
                    this.keltMainEncounter();
                }
            }
        }
        ...
        keltFirstTime() {
            ...
            this.outputText("As you get closer, however, the figure comes into view.  The rider is not Whitney, but rather a muscular man.  And the horse has no head... where its head should be is... with a start, you realize that this is no horse and rider.  The figure is a large, male centaur!\r\r", false);
            this.outputText("Wariness growing, you slow down.  But it is too late... the centaur has seen you.  With a snort, he gallops closer, imposingly tall.  You drop into a fighting stance, ready if he should attack you, and the centaur draws to a halt a few feet away.\r\rHe looks scornfully at you, and laughs, ", false);
            this.outputText("\"<i>Don't be stupid.  You'd never even get close to me.  If I wanted to kill you, you would have been dead a long time ago.  My name is Kelt.</i>\"\r\r", false);
        ...
        keltRequiresNakedness() {
            this.outputText("Once more, you encounter Kelt the centaur at Whitney's farm.  You approach him to ask for another archery lesson, but Kelt is already scowling at you as you draw near.\r\r", false);
            this.outputText("\"<i>I can't teach you like this,</i>\" he sneers.  \"<i>Your balance is all fucked up.  I know colts who can shoot better than you.  You really want to learn the skill?  Then you're gonna have to practice like a centaur.  You'd never see me wearing armor!</i>\"\r\r", false);
            this.outputText("He slaps a hand on his bare chest proudly, and you realize that he means for you to strip down naked.  When you protest, his eyes narrow with irritation, and his sneer becomes more cruel.\r\r", false);
            this.outputText("\"<i>Didn't know you were a coward, too.  That's fine... go fuck off, then.  You can't handle it, then go back to your camp and braid your hair, or something.  If you wait long enough, I'm sure a nice minotaur will come along to make you his bitch.  'Bout all you're good for, right?</i>\"\r\r", false);
            this.outputText("Do you obey his demand?", false);
            if (this.player.cor > 70 && this.player.inte > 40 && this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR) {
                ...
                this.simpleChoices("Reluctantly", this.keltReluctantlyGetNaked, "Eagerly", this.keltEagerlyGetNaked, "", undefined, "", undefined, "Never", this.keltRefuseNakedness);
        ...
        keltRefuseNakedness() {
            ...
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.KeltOff, 0, 0, 0, 0);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        keltEagerlyGetNaked() {
            ...
            this.outputText("You remove your top first, slowly revealing your " + this.allBreastsDescript() + ".  Kelt is pacing around you, eyes locked on your chest hungrily.  As you let your top fall to the ground, he laughs mockingly, though, ", false);
            if (this.player.gender == 1 && this.player.biggestTitSize() < 1)
                this.outputText("\"<i>What are you, a girl?  Get on with it so I can see what I'm dealing with.</i>\"\r\r", false);
            else {
                if (this.player.biggestTitSize() == 0)
                    this.outputText("\"<i>Oops!  Could have sworn I'd find a pair of tits on you.  That's okay... I'm sure you'll hit puberty some day!</i>\"\r\r", false);
                //(Too small, A to DD: 
                else if (this.player.biggestTitSize() <= 5)
                    this.outputText("\"<i>Ha! No wonder you cover up like a sniveling human!  Any centaur maiden would be ashamed to go out in public with " + KeltScene.num2Text(this.player.totalBreasts()) + " mosquito bites like that!  What do they call you back home... 'Tiny Tits'?  Or maybe they all just assume you're a guy!</i>\"\r\r", false);
                //(Medium, E to HHH:
                else if (this.player.biggestTitSize() <= 11)
                    this.outputText("\"<i>Uh oh, boys... look out!  Miss Melons here has been putting on a little weight!  How did someone like you become an adventurer?  From the waist up, you're good for whoring and not much else!</i>\"\r\r", false);
                //(Big, Watermelon and beyond:
                else
                    this.outputText("\"<i>Oooh, doesn't that look yummy?  Be honest... you wanna learn to shoot?  You'll be slapping yourself in the tits with every shot!  Heh... I bet that's the way you like it too!  Time to change your profession, slut.  Wet nurse and milk cow... they're just about all you're suited for!</i>\"\r\r", false);
            }
            this.outputText("Despite his harsh comments, you can see the lust in Kelt's eyes, and are more than a little turned on by his derisive laughter.  His critique only becomes more lewd when you continue.  As you remove the lower half of your clothes, stripping completely naked, he eyes your ass and lets out a crude hoot of scornful delight, ", false);
            //(Too small, Firm to Shapely:
            if (this.player.buttRating < 6)
                this.outputText("\"<i>Well, someone works out!  Got a nice, tight little ass there! Probably a little too tight, huh?  Don't worry, you can tell me... do the mean old monsters hurt when they fuck that poor little ass of yours? HA!</i>\"\r\r", false);
            //(Medium, Large to Heavy:
            else if (this.player.buttRating < 13)
                this.outputText("\"<i>Hey, nice little cushion you got back here!  Do you get that from sitting around all day?  Nah, can't be that.  I'm sure you get more than a workout on this baby... of course, cock is no substitute for a little exercise, you know!</i>\"\r\r", false);
            //(Big, Voluminous and beyond:
            else
                this.outputText("\"<i>Now there's a rear end I could get behind!  For someone who claims to be a hero, you sure are built like a fucktoy!  With an ass like that, you remind me of my last lay... of course, she was a horse!</i>\"\r\r", false);
            this.outputText("He slaps your ass with his open palm, getting in a good grope while he's at it.  His animalistic musk is in your nostrils, making you feel dizzy and more than a little aroused.  He grins widely, then walks around to your front, ", false);
            //(No Cock:
            if (this.player.totalCocks() == 0)
                this.outputText("\"<i>Well, aren't you a pretty little thing, all together.  You and I will get along real nice, that's for sure!</i>\"\r\r", false);
            else {
                //(Any Cock: 
                this.outputText("and almost inevitably, his eyes drop down to your " + this.cockDescript(0) + ".  He snorts, ", false);
                //(Human Cock:
                if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.HUMAN)
                    this.outputText("\"<i>Heh.  Just sporting the normal model, huh?  You know there's a phrase around here... hung like a human!  Trust me... it's not a compliment.  ", false);
                //(Dog Cock:
                if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.DOG)
                    this.outputText("\"<i>Oh, lookie here!  We got ourselves a little doggie dong!  Well, cock or not, you'll always be a bitch to me, mutt.  ", false);
                //(Horse Cock: 
                if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                    this.outputText("\"<i>Now that's just sad.  Getting a little envious of me, huh?  Had to go out and get a nice horsecock all your own?  Should have asked.  I'd have given you a taste of mine!  ", false);
                //(Tentacle Cock or other weirdness
                if (this.player.cocks[0].cockType.Index >= 3)
                    this.outputText("\"<i>Hah!  I'll bite... what the fuck are you supposed to be?  That a cock, or just an ugly, misplaced tail?  HA!  ", false);
                //(Small Size, ?-10 inches:
                if (this.player.cocks[0].cockLength <= 10)
                    this.outputText("\"So, when you poke a woman with that, does she notice?  Or do you have to tell her when to start faking her orgasm?</i>\"\r\r", false);
                //(Medium Size, 11-20 inches: 
                else if (this.player.cocks[0].cockLength <= 20)
                    this.outputText("\"Still, at least you've got a decent sized cock.  You know, for a colt.  Maybe you'll get lucky, and the real women will take pity on you!</i>\"\r\r", false);
                //(Big Size, 21 inches and beyond:
                else
                    this.outputText("\"Now if only they could find a way to get you to stop stepping on your own cock every other step, maybe you'd be a real man!  Can you even get it up, at this point?  Or would that tip you over?  Ha!</i>\"\r\r", false);
            }
            this.outputText("He looks you over one last time, and sneers condescendingly.  \"<i>Well, it ain't much as far as heroes go.  But it's better than nothing.  Fine, I'll teach ya some more.  But I don't want to see those damn clothes again.  You'll learn the way I tell you to learn, got it?</i>\"\r\r", false);
            this.outputText("You nod, almost grateful for the excuse to go naked.  From the way Kelt is eyeing your ass, you think he'll enjoy it too.\r\r", false);
            //(Naked on. Every visit, player will automatically strip.)
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.NakedOn, 0, 0, 0, 0);
            //(+10 Submissive)
            this.player.addStatusValue(StatusAffects_1.StatusAffects.Kelt, 2, 10);
        ...
        keltReluctantlyGetNaked() {
            ...
            this.outputText("You remove your top first, slowly revealing your " + this.allBreastsDescript() + ".  Kelt is pacing around you, eyes locked on your chest hungrily.  As you let your top fall to the ground, he laughs mockingly, ", false);
            if (this.player.gender == 1 && this.player.biggestTitSize() < 1)
                this.outputText("\"<i>What are you, a girl?  Get on with it so I can see what I'm dealing with.</i>\"\r\r", false);
            else {
                if (this.player.biggestTitSize() == 0)
            ...
            this.outputText("He looks you over one last time, and sneers condescendingly.  \"<i>Well, it ain't much as far as heroes go.  But it's better than nothing.  Fine, I'll teach ya some more.  But when I tell you to strip, you do it a little faster next time... or I might not be so generous.</i>\"\r\r", false);
            this.outputText("You nod, a little irritated at his callous nature.  You're not entirely sure you want to be naked in front of this crude centaur... but for now, at least, he'll teach you a little more.  Though the way he eyes your ass does make you feel a little uncomfortable.\r\r", false);
            //(+7 Submissive)
            this.player.addStatusValue(StatusAffects_1.StatusAffects.Kelt, 2, 7);
            this.dynStats("lus", Math.floor(this.player.lib / 10) + 5);
            this.keltMainEncounter2();
        }
        //Blowjob Requirement
        keltRequiresBlowjobs() {
            this.spriteSelect(35);
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.KeltBJ, 0, 0, 0, 0);
            ...
            this.outputText("\"<i>Enjoying the sights, are we?</i>\"\r\r", false);
            this.outputText("You blink, startled.  While you were thinking, Kelt approached you, and you were staring directly at his crotch.  He leers down at you with an arrogant grin.  Flushed, you stammer out that you're here for more archery lessons.  He snorts, clearly amused.\r\r", false);
            this.outputText("\"<i>Yeah, I'll bet.  When they talk about firing shafts, whore, they're talking about arrows.  Bet you would prefer the other kind though, huh?</i>\"\r\r", false);
            ...
            this.outputText("\"<i>Well, I think you've had enough freebies.  Maybe I don't wanna teach you anymore.  After all... what do I get from it?  I spend all day teaching a moron how not to shoot [him]self in the foot, and I got nothing to show for it.  I think it's about time you put down a little payment.</i>\"\r\r", false);
            ...
            this.outputText("\"<i>I don't want your fucking money.  What am I gonna buy... hentai comics and scholar tea?  Fuck off.  You want to learn more about archery?  Then it's about time you showed some gratitude.</i>\"\r\r", false);
            ...
            this.outputText("\"<i>You know the price, slut. You want archery lessons, and I want to blow my load in that throat of yours. Everyone wins. Now get started.</i>\"\r\r", false);
            ...
            if (this.player.inte > 40 && this.player.cor > 70 && this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR) {
                this.outputText("\n\n<b>If you fight back and take him down a peg, you might never see him again...</b>");
                ...
                this.simpleChoices("Shamefully", this.keltBlowjobRequirementShamefully, "Eagerly", this.keltBlowjobRequirementEagerly, "Resist", undefined, "", undefined, "Never!", this.keltBlowjobRequirementNever);
        }
        //Blowjob Requirement, Never
        keltBlowjobRequirementNever(newl = true) {
            this.spriteSelect(35);
            if (newl)
                this.outputText("", true);
            this.outputText("You struggle, trying to hold onto your fragmented thoughts. Something about Kelt's scent, or presence, is overwhelming.  The temptation to give in is almost overpowering, but you set your teeth, close your eyes, and furiously try to ignore your hammering heart.\r\r", false);
            this.outputText("Kelt's feet move almost uncertainly, hooves pawing at the ground and resetting themselves.  He almost seems confused for a moment, hips bucking forward experimentally.  When there is no further sensation, his confusion begins to be replaced by anger.\r\r", false);
            ...
            this.outputText("You have just a moment to react, as the tone suddenly shifts.  Kelt, who has been stomping and cussing angrily, has decided on a new target.  Training remembered, you roll to the side just as Kelt rears and brings his front two hooves down where your head was moments earlier.\r\r", false);
            ...
            this.outputText("\"<i>Stupid slut.  Refuse me, huh?  ME?  Well FUCK you and the [legs] you walked in on!  You wanna shoot arrows, go learn how to do it yourself!  Better idea... go to the fucking desert, find a demon, and fucking BEG him to make you his ass slave.  Go on!  Fuck off, slut!</i>\"\r\r", false);
        ...
        keltBlowjobRequirementShamefully(newl = true) {
            this.spriteSelect(35);
            if (newl)
                this.outputText("", true);
            this.player.slimeFeed();
            this.outputText(this.images.showImage("kelt-farm-shamefulbj"));
            this.outputText("The thought of going through with it is appalling.  The thought of not wrapping your lips around that glorious member is equally unthinkable.\r\r", false);
            this.outputText("Face flushed with lust and shame, you reach up hesitently to wrap your hand around the growing member, feeling its wondrous heat.  Kelt lets out a satisfied groan, his hips bucking forward involuntarily.  The flared head of his massive cock drools precum lewdly, and you hesitate once more, torn.  But with the warmth of his cock beneath your hand, there is no going back.\r\r", false);
            ...
            this.outputText("\"<i>Mmm...I knew it from the moment I saw you.  Quite the talented little cocksucker you are.  Deeper, bitch.  I want you to choke on my spunk.</i>\"\r\r", false);
            ...
            this.outputText("\"<i>Ahhh, yeah... fuck, bitch, you sure feel pretty good.  I could get used to this.  How about you, huh?  You like the taste of my cock, little whore?</i>\"\r\r", false);
            ...
            this.outputText("Kelt moves aside, looking down at you with a smug look of satisfaction.  You weakly wave him off, embarrassed by what you just did, and he laughs nastily.\r\r", false);
            this.outputText("\"<i>Get used to it, bitch.  Gotta say, you took that pretty well.  Barely a drop lost.  Good.  Because if you tried to spit up my cum, I'd have to make sure to deposit a second load.</i>\"\r\r", false);
            this.outputText("\"<i>Here's the rule.  You want archery lessons?  Fine.  I'll keep teaching you, stupid bitch that you are.  But when I say so, you kneel and take your turn.  If I have to teach an ugly slut like you, the least you can do is choke one down.  Lesson's over.  See you tomorrow, bitch.</i>\"\r\r", false);
            ...
            this.outputText("It may be unhealthy, to keep going back to him.  Of course, you could always say no, right?  He is a good teacher.  And... and would it be so bad to suck him off a few more times?  That wouldn't be so bad... would it?\r\r", false);
        ...
        keltBlowjobRequirementEagerly(newl = true) {
            this.spriteSelect(35);
            ...
            this.outputText("It is like someone answered your prayers.  You eagerly agree, babbling your thanks to Kelt as you are faced with the massive cock, growing harder and harder.  He snorts scornfully.\r\r", false);
            this.outputText("\"<i>I didn't ask for your thanks, slut,</i>\" he says cruelly.  \"<i>I asked for you to suck my cock.  Now open wide and choke it down, or I'm aiming for your ass.</i>\"\r\r", false);
            ...
            //(Blowjob On.)
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.BlowjobOn, 0, 0, 0, 0);
            //(+15 Submissiveness)
            this.player.addStatusValue(StatusAffects_1.StatusAffects.Kelt, 2, 15);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Normal Encounter
        keltMainEncounter() {
            this.spriteSelect(35);
            this.outputText("Once more, you encounter Kelt the centaur at Whitney's farm.  He smirks at you, and asks if the fool has come once more to learn from the master.\r\r", false);
            //(Submissive 0-30: 
            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) <= 30)
                this.outputText("You grind your teeth in irritation, but swallow your pride enough to ask him for help.  ", false);
            //(Submissive 30-70:
            else if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) <= 70)
                this.outputText("You nod reluctantly, and Kelt grins.  He may be arrogant, but he is rather good.  ", false);
            //(Submissive 70-100: 
            else
                this.outputText("You nod enthusiastically, almost begging him to teach you.  ", false);
            //(Before Naked Requirement)
            if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Kelt) <= 3) {
                this.outputText("Kelt seems to find the idea of training a human almost comical, but suggests that if you want to follow him around for a while, he has no problem with it.  Though his attitude is annoying, you resolve to learn what you can.\r\r", false);
            }
        ...
        keltMainEncounterAfterNakedReq() {
            ...
            //(Naked On)
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.NakedOn) >= 0) {
                this.outputText("He nods, smirking slightly, and gestures at your clothes impatiently.  With some pleasure, you strip down before him, discarding your clothes with a little flair.  Kelt is grinning by the end, openly admiring your body, and you feel a little more aroused for obeying his dominant command.\r\r", false);
                //(+5 Submissive)
                this.player.addStatusValue(StatusAffects_1.StatusAffects.Kelt, 2, 3);
            }
            //(Naked Off)
            else {
                //(40% Chance:
                if (KeltScene.rand(10) <= 5) {
                    this.outputText("Kelt looks down your body scornfully, and claims he is unwilling to teach you unless you are willing to learn naked again.  ", false);
                    //(Corruption 60+, or Submissive 60+: 
                    if ((this.player.cor + this.player.lib + this.player.lust >= 180 && this.player.inte < 30) || this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 60) {
                        ...
                        if ((this.player.cor + this.player.lib + this.player.lust >= 220 && this.player.inte < 40) || this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 70) {
                            this.outputText("  <b>With a lusty smile, you decide to ALWAYS get naked before practicing.</b>", false);
                            this.player.createStatusAffect(StatusAffects_1.StatusAffects.NakedOn, 0, 0, 0, 0);
                        }
                    ...
                    //(Otherwise:
                        ...
                        this.outputText("\r\rYou're not certain you want to practice naked again... particularly with the way Kelt is looking at you, his arrogant smirk plastered on his face.  Do you agree to his terms?", false);
                        ...
                        if (this.player.inte > 40 && this.player.cor > 70 && this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR) {
                            ...
                            this.doYesNo(this.keltReluctantlyGetNaked, this.keltRefuseNakedness);
                        return;
                    }
                }
                //(Otherwise: 
                else {
                    this.outputText("Kelt looks at your clothes sourly once more, and mocks you for what he calls 'human sensitivity'.  He does not, however, directly tell you to take them off.\r\r", false);
                    //(Corruption 60+, or Submissive 60+:
                    if ((this.player.cor + this.player.lib + this.player.lust >= 180 && this.player.inte < 40) || this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 60) {
                        ...
                        if ((this.player.cor + this.player.lib + this.player.lust >= 220 && this.player.inte < 40) || this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 75) {
                            this.outputText("  <b>You cast a seductive smile Kelt's way and decide you should always strip before practice</b>.", false);
                            this.player.createStatusAffect(StatusAffects_1.StatusAffects.NakedOn, 0, 0, 0, 0);
                        }
                        this.outputText("\r\r", false);
                        this.dynStats("lus", Math.floor(this.player.lib / 10) + 5);
                    ...
                    //(Otherwise: 
                        ...
                        this.outputText("You ignore his barbed comments as best as you can, and soon enough, he leaves the matter alone, instead critiquing your archery skills.\r\r", false);
                }
            }
            this.keltMainEncounter2();
        }
        ...
        keltMainEncounter2() {
            ...
            if (this.player.hasKeyItem("Bow") < 0) {
                ...
                this.outputText("Despite his mocking description, the bow he gives you really is a decent weapon.  You take it up and start towards the practice field, Kelt following behind.\r\r", false);
                if (this.player.hasKeyItem("Bow") < 0)
                    this.player.createKeyItem("Bow", 0, 0, 0, 0);
            }
            //(Bow equipped)
            else {
                this.outputText("Kelt sneers as he looks at your bow, \"<i>You're still using that rotten old thing?  Well, it will do.  We'll just have to shoot for the close targets.</i>\"\r\r", false);
            ...
            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 60 && KeltScene.rand(4) == 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.KeltBJ) >= 0) {
        ...
        keltMainEncounter3() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.NakedOn) < 0) {
                ...
                //(25% Chance: 
                if (this.temp == 0)
                    this.outputText("\"<i>Oh, yes.  Looks like you're shaping up to be a pretty accurate archer.  Just make sure you only fight blind giants.  You know, massive targets that have no chance to dodge.  You'll do fine.</i>\"\r\r", false);
                //(25% Chance: 
                if (this.temp == 1)
                    this.outputText("\"<i>Ha!  You want to become an archer?  Here's a hint... stop thinking about sucking cock for two seconds and AIM.</i>\"\r\r", false);
                //(25% Chance: 
                if (this.temp == 2)
                    this.outputText("\"<i>See the red dot, in the middle of the target?  Imagine that's your ass, and the arrow is a big, fat, minotaur cock.  That should help you hit the target.</i>\"\r\r", false);
                //(25% Chance: 
                if (this.temp == 3) {
                    if (this.player.race() != "centaur")
                        this.outputText("\"<i>If you were a centaur, I'd recommend suicide.  Since you're a " + this.player.race() + ", I'd say your best option is to fuck off.</i>\"\r\r", false);
                    else
                        this.outputText("\"<i>As a centaur, I'd recommend suicide.  Really, it's that or man the fuck up.</i>\"\r\r", false);
                }
            ...
            //NAKERS
                ...
                if (this.player.inHeat && this.player.gender > 1) {
                    ...
                    this.outputText("You lean over to pluck the arrow from the haystack, and feel a sharp blow to the back of your head, knocking you over and sending your consciousness spinning.  Dizzily, you realize Kelt is standing over you, tossing aside the bow he just used to crack you in the head.  Between his horse legs, a massive manhood is dropping from his sheath, flanked by testes the size of softballs.  A lewd grin is on his face.\r\r", false);
                    this.outputText("\"<i>Did you think I wouldn't notice, slut?  You reek like a mare in heat.  I could smell it on you the moment you arrived.  Fortunately, I know just what to do with a fertile bitch.  Let's put a baby centaur in that tight pussy of yours.</i>\"\r\r", false);
                    this.outputText("Kelt's forelegs rear up just enough to plant them around your shoulders, his massive weight bearing down on you.  The bale of hay lifts you just high enough to line up with his fat erection, which presses between your asscheeks even now.\r\r", false);
                    //(Submissive, 0-30: 
                    if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) <= 30)
                        this.outputText("You struggle as best as you can, but Kelt weighs a good deal more than you do.  As his thrusting hips anxiously press his cock to your nether-lips, you realize this is going to happen, whether you want it to or not.  The thought fills you with an undeniable shiver of pleasure.\r\r", false);
                    //(Submissive, 30-70: 
                    else if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) <= 70)
                    ...
                    this.outputText("The centaur's cock has truly equine proportions, being easily two and a half feet long and over three inches thick.  ", false);
                    //(Vagina, Small: 
                    ...
                    this.outputText("\n\n");
                    this.outputText("From then on, the ride only becomes rougher.  Kelt begins pumping his hips steadily, deep and hard, intent on burying as much of his manhood as possible with each thrust.  He gives little thought to your pleasure, but it hardly matters.  With a cock that size, you cannot help but moan with each buck of his hips.\r\r", false);
                    this.outputText("\"<i>Not too bad, not too bad!  You make for a pretty decent fuck!  Maybe after you bear a couple of my foals, I'll add you to my harem.  You'd like that, wouldn't you?  You just can't wait to get a bellyful of centaurs, can you?</i>\"\r\r", false);
                    //(Submissive, 0-30: 
                    if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) <= 30)
                        this.outputText("You shiver and groan, unable to help yourself.  It is clear that Kelt has every intention of breeding you, and you are helpless to stop the urges of your body.  Terrifying images of being raped daily by this cruel beast fill your head... of your belly swelling with his young again and again.  You let out a moaning cry, and orgasm helplessly even as Kelt laughs.\r\r", false);
                    //(Submissive, 30-70: 
                    else if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) <= 70)
                    ...
                    this.outputText("Some time later, Kelt's enormous cock softens enough to slip out of your abused cunt, a virtual torrent of cum flowing out afterwards.  You lay on the bale of hay, panting tiredly, hands pressed to your full belly.  Kelt looks down at you, and snorts.\r\r", false);
                    this.outputText("\"<i>That's a good look for you.  Come back tomorrow if it doesn't take, slut.  I'll be glad to do the job again.</i>\"\r\r", false);
                    this.player.slimeFeed();
                    this.player.orgasm();
                    this.outputText("He leaves you without another word.", false);
                    //(+5 Submissive)
                    this.player.addStatusValue(StatusAffects_1.StatusAffects.Kelt, 2, 5);
                    //(Pregnancy Chance)
                    this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_KELT, PregnancyStore_1.PregnancyStore.INCUBATION_CENTAUR, 50);
                    ...
                    if (this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_KELT)
                        console_1.trace("PLAYER GOT KNOCKED UP BY KELT");
                    this.doNext(this.camp.returnToCampUseOneHour);
                    return;
                }
                ...
                if (this.player.biggestTitSize() == 0 && temporary == 3)
                    temporary = 4;
                //(Naked, 20% Chance)
                if (temporary == 3) {
                    ...
                    this.outputText("\"<i>Isn't it obvious?</i>\" he asks, grinning down at you in sardonic amusment. \"<i>You were way off balance.  Of course, I would be too, if I had a couple of extra pounds of fat hanging off my chest.</i>\"\r\r", false);
                    this.outputText("Indignantly, you cover your breasts with your hands, telling him to be serious.  He laughs again, more cruelly this time.\r\r", false);
                    this.outputText("\"<i>I am being serious.  Women aren't warriors.  And those with tits do not become warriors.  I just think it's funny. You, begging me to teach you, while you have those udders hanging off your chest!</i>\"\r\r", false);
                    this.outputText("To your surprise, he suddenly leans forward, fist moving towards your head.  You raise your arms to deflect the blow, but he changes tactics suddenly and grabs one of your " + this.breastDescript(0) + " instead.  You stiffen, but before you can react further, he squeezes them brutally, mauling your breasts roughly with his hands.\r\r", false);
                    //(Small Size, A-DD: 
                    if (this.player.biggestTitSize() <= 5)
                        this.outputText("\"<i>Ha!  Even with your itty-bitty-titty, you have to admit to a certain... weakness, is it?  Awfully sensitive, aren't they?  Ooh, am I making the little girl wet?  Naughty slut!</i>\"\r\r", false);
                    //(Medium Size, E-HHH:
                    else if (this.player.biggestTitSize() <= 11)
                        this.outputText("\"<i>Just look at these mommy melons!  You want to be an archer?  I'm amazed you don't slap yourself in the tits with every shot!  Easy target to grab onto.  But hey, I bet you like it that way.  Like it when people grope these fat titties of yours?</i>\"\r\r", false);
                    //(Big Size, Watermelon and beyond:
                    else
                        this.outputText("\"<i>Look at you! You're a miracle of science, you are... any other creature would break their back, trying to haul these milk bags around!  Tell the truth, now... which one of your parents was actually a cow?</i>\"\r\r", false);
                    this.outputText("Despite his cruel words, you can't help but groan a little bit as he brutalizes your sensitive chest.  Kelt seems to take a good deal of pleasure in how helpless you are, pinching and flicking your " + this.nippleDescript(0) + "s.\r\r", false);
                    //(Milk)
                    if (this.player.biggestLactation() > 1) {
                        this.outputText("Inevitably, beads of milk appear on the tips of your breasts, and Kelt lets out a hoot of laughter.\r\r", false);
                        this.outputText("\"<i>Oh, boy!  Mommy here brought snacks for everyone!  Don't mind if I do!</i>\"\r\r", false);
                        ...
                        this.outputText("\"<i>Not bad, for a cow.  You certainly seemed to enjoy it too.</i>\"\r\r", false);
                        this.outputText("Even released, your teat continues to drizzle slightly, spilling your milk shamefully on the ground as Kelt continues to squeeze your breasts.\r\r", false);
                ...
                if (temporary == 4) {
                    ...
                    this.outputText("\"<i>THERE.  Is that what you fucking wanted, whore?  Something nice to fill that ass of yours?  Bet it feels good, huh? Bet you were fucking DREAMING of a nice, fat cock up your ass.  Well, here you go!  Feel better now that you're being fucked, slut?</i>\"\r\r", false);
                    ...
                    this.outputText("\"<i>Okay.  Now that our little bitch is getting an assfuck, maybe she'll be satisfied enough to hit the fucking target.  Now shoot... and don't you dare fuck this up again.</i>\"\r\r", false);
                    this.outputText("Groaning, distracted and unnerved, you hurriedly line up the shot as best as you can.  Kelt's fingers flex, forcing you to stand up straighter.  Your arm shakes as you take aim, and you can feel Kelt's hot breath on your hair, and then the arrow is flying!  Ten meters... five... bullseye!\r\r", false);
                    this.outputText("With a snort, Kelt shoves you to the ground, removing his fingers as he does so.  Wincing, you sit up with the centaur staring down at you snidely.\r\r", false);
                    this.outputText("\"<i>Lesson's over for now.  Next time it's my cock, slut.</i>\"\r\r", false);
                    this.outputText("He walks away without another word, taking some of your dignity with him.", false);
                    //(+5 Submissive)
        ...
        keltMainEncounterPostBlowjob() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BlowjobOn) >= 0) {
                //(Submissiveness 75+, Lust 60+)
                if (this.player.lust >= 75 || this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 90 && KeltScene.rand(2) == 0) {
                    this.outputText(this.images.showImage("kelt-farm-smallbarn"));
                    ...
                    this.outputText("To your surprise, Kelt leads you not towards the practice field, but towards a small barn, near the edge of the field.  When you meekly ask why he's taken you here, his brow clouds and he lashes out, striking you with casual violence.  ", false);
                    this.outputText("\"<i>Bitch!  I said get in there.  Do I need to repeat myself, you stupid whore?\"</i>\r\r", false);
                    this.outputText("Scrambling to your feet and babbling apologies, you hastily open the door to the barn, entering immediately.  Before you is a thin, upraised table, with straps in it, like saddle stirrups.  Your heart leaps excitedly, and Kelt laughs a little to himself as he tells you to get on, facedown.  You hasten to comply.\r\r", false);
                    this.outputText("Lying on the rough table with your feet in the stirrups, your ass is suspended at just the right height.  Kelt moves with obvious hunger, running his finger along your nethers.", false);
                    //(Penis:
                    if (this.player.totalCocks() > 0)
                        this.outputText("  Your " + this.cockDescript(0) + " is rock hard, but he ignores it almost contemptuously.  You almost feel ashamed of it, compared to the slowly-growing manhood between his legs.", false);
                    //(Vagina:
                    ...
                    this.outputText("\r\r\"<i>Oh?  Like that, do you?  Well, we're not here for what you like.  You're here to satisfy me, slut.  And I know what I'm after.</i>\"\r\r", false);
                    ...
                    this.outputText("\r\r", false);
                    this.outputText("You can't help it... at the thought of being used as his worthless fucktoy, you suffer a mild orgasm of your own, crying out your submission to this powerful creature.", false);
                    //(Penis: 
                    if (this.player.totalCocks() > 0)
                        this.outputText("  Beneath you, pressed firmly into the harsh wood of the mounting board, your " + this.cockDescript(0) + " erupts, splattering your stomach with your own cum.  As the thick semen slides down towards your face, you begin slipping on your own warm seed, rocking back and forth with each harsh pounding Kelt delivers to your backside.", false);
                    //(Vagina:
                    if (this.player.hasVagina())
                        this.outputText("  Your poor, neglected pussy quivers with delight, convulsing without even being touched.  Thick juices run freely down your leg, dripping off to splatter the hay below you as you moan like a bitch in heat.", false);
                    //(Genderless: 
                    if (this.player.gender == 0)
                        this.outputText("  Never before has a complete lack of genitalia been so frustrating... or pleasurable.  Not being able to physically cum, the explosions of climax simply rack up within your body... waves of cascading pleasure with no release and no mercy.", false);
                    ...
                    if (this.player.looseness(false) < 3)
                        this.outputText("\"<i>Fuck!  About time!  Sure got a tight little ass back here, but don't worry, slut.  We'll stretch it out in no time. I promise you this... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\r\r", false);
                    else if (this.player.looseness(false) < 5)
                        this.outputText("\"<i>Fuck!  About time!  Sure got a nice ass back here, but don't worry, slut.  We'll turn it into a real gaper soon.  It's a good thing you've been practicing... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\n\n");
                    else
                        this.outputText("\"<i>Fuck!  About time!  Sure got a nice, stretched out little pucker back here, but don't worry, slut.  I'll train into to squeeze down just right in no time.  I promise you this... you'll be getting a lot more of my cock from now on, so you'd better be ready!</i>\"\n\n");
                    ...
                    this.player.slimeFeed();
                    //(+10 Submissiveness)
                    if (this.player.buttChange(70, true))
                        this.outputText("\r\r", false);
                    this.player.addStatusValue(StatusAffects_1.StatusAffects.Kelt, 2, 10);
                    this.player.orgasm();
                    this.dynStats("cor", 1);
                ...
                //(Otherwise)
                    ...
                    this.outputText("\"<i>Alright, bitch.  Swallow my cock.</i>\"\r\r", false);
                    ...
                    this.outputText("\"<i>Pretty good, slut.  I knew there was a reason I kept you around.  I've indulged you enough, though.  Get over there and shoot some arrows, before I get bored with you.</i>\"\r\r", false);
                    this.outputText("You hardly remember the rest of the training.  You're far too distracted by the fullness of your belly, and the thought of maybe getting a little more.  Kelt seems almost bored by the end, despite your attempts to entice him during the lesson, and leaves soon afterwards, to your chagrin.", false);
                    this.player.slimeFeed();
                    //(+5 Submissiveness)
                    this.player.addStatusValue(StatusAffects_1.StatusAffects.Kelt, 2, 5);
            ...
            //(Blowjob Requirement Off, 40% Chance)
                ...
                this.outputText("You move towards the practice field, trying to ignore the way Kelt openly and hungrily eyes your naked body.  He has become more and more open about his lust for you.  Despite yourself, you can't help but enjoy his attentions.\r\r", false);
                this.outputText("Once at the field, you move to draw an arrow and begin practice, when Kelt roughly pushes you down to your knees.\r\r", false);
                this.outputText("\"<i>Not today, bitch.  I think it's time you gave a little back.  So be a good little whore, and get to work on my cock.  I'm gonna bust a nut in that pretty little mouth before I do any more teaching.</i>\"\r\r", false);
                this.outputText("A shiver of desire and a tremor of fear run through you.  You had hoped to avoid this requirement.  A hunger lies within you... the thought of once more slurping down centaur cum is all but irresistible.  But you fear that with each time, you are losing yourself more and more...\r\r", false);
                //(Submissiveness +80, or Corruption +80)
                if (this.player.cor + this.player.lib + this.player.lust >= 220 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 80) {
        ...
        keltResistGivingBJ() {
            this.spriteSelect(35);
            this.outputText("", true);
            this.outputText("Summoning what remains of your fragmented willpower, you resist the need, apologizing to Kelt and turning to walk away.  It hurts to do so, aching within your chest with an almost physical need to go back; to apologize and kneel before him worshipfully.\r\r", false);
            this.outputText("To your surprise, however, Kelt does not seem particularly bothered.  In fact, he laughs as you leave.\r\r", false);
            this.outputText("\"<i>Keep fooling yourself, bitch.  I'll be waiting when you get hungry.</i>\"  \r\rKelt leaves, refusing to teach you now.", false);
            //(-5 Submissiveness)
            this.player.addStatusValue(StatusAffects_1.StatusAffects.Kelt, 2, -5);
            this.dynStats("lus", 5);
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        keltSubmitGivingBJ() {
            ...
            this.player.slimeFeed();
            this.outputText("", true);
            this.outputText("\"<i>There we go.  Who's a good little whore?  Who's a hungry little slut?  Okay, bitch... time to fill that belly of yours.  Open wide.</i>\"\r\r", false);
            this.outputText("Reluctantly, with shame burning in your cheeks and desire ravaging your mind, you lower yourself before him and do just that.\r\r", false);
            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 90) {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.BlowjobOn, 0, 0, 0, 0);
            }
        ...
        continueAfterBJ() {
            this.spriteSelect(35);
            this.outputText("After a brief rest, you manage to get back to practicing archery.  ", true);
            this.keltMainEncounter3();
        }
        //(Reluctant Blowjob)
        keltReluctantGivingBJ() {
            ...
            this.player.slimeFeed();
            this.outputText("", true);
            this.outputText(this.images.showImage("kelt-farm-reluctantbj"));
            ...
            this.outputText("\"<i>Pretty good, slut.  I knew there was a reason I kept you around.  Come back next time, and maybe I'll actually teach you something.  Or, who knows?  Maybe I'll just give you another snack, huh?  Ha!</i>\"\r\r", false);
        ...
        keltCentaurBadEnd() {
            ...
            this.outputText("\"<i>So... just had to get a taste of what it is like, huh?  Good for you... I like you this way.  Yes... I can work with this.</i>\"\r\r", false);
            this.outputText("He paces around you, and you stand at attention, quivering with pleasure at his compliments.  Involuntarily, you feel your horselike tail raise high into the air, as if to show off your nethers as well.  Kelt takes a moment to inspect them, obviously enjoying himself.\r\r", false);
            //(Male)
            if (this.player.gender == 1) {
                this.outputText("\"<i>Hmph.  Still technically male, huh?  What, you call this a cock?</i>\"\r\r", false);
                ...
                this.outputText("\"<i>Well, I've got no use for males, slut.  Fortunately, you still have something I can use in the meantime.</i>\"\r\r", false);
                this.outputText("His legs rear suddenly, wrapping around the barrel of your body. You let out a startled protestation, but do not move... your body won't let you.  In fact, if anything, you push back against him, eager and ready.  Part of you is joyous, in fact.  What you wanted wasn't to fuck Kelt!  ", false);
                this.outputText("<b>... It was for him to fuck you!</b>\r\r", false);
            ...
            //(Genderless)
            if (this.player.gender == 0) {
                this.outputText("\"<i>Ha!  What the fuck are you supposed to be?  No cock, no cunt?  Well, no matter, bitch.  You've still got what I want.</i>\"\r\r", false);
                ...
                this.outputText("\"<i>Well, man or woman, it doesn't matter to me.  You're still only good for one thing.  Time to give you a purpose, slut.</i>\"\r\r", false);
                this.outputText("His legs rear suddenly, wrapping around the barrel of your body.  You let out a startled protestation, but do not move... your body won't let you.  In fact, if anything, you push back against him, eager and ready.  Part of you is joyous, in fact.  What you wanted wasn't to fuck Kelt!  ", false);
                this.outputText("<b>... It was for him to fuck you!</b>\r\r", false);
                this.outputText("Kelt does not hesitate in aserting his dominance, and immediately pushes his shaft towards your ass, inserting it with ease.  You let out an almost feral cry of pleasure, and Kelt laughs nastily as he gets a better grip and sinks his erection in deeper, humping away at your hindquarters needfully.  His human hands wrap around you, taking hold of your chin and forcing you to turn enough to face him as he savors your wincing moans.\r\r", false);
                this.outputText("\"<i>As I thought,</i>\" he sneers, thrusting particularly hard and making you whimper with need.  \"<i>You're no stud.  Just another gelding, wishing to be a real woman.  Well, I could use another cumdump, slut.  So consider this your initiation.  You're mine now, to use whenever I feel like it.  Hope you like the feeling of my cock, bitch.  It's gonna be the only thing you feel for a long time.</i>\"\r\r", false);
            ...
            if (this.player.gender >= 2) {
                ...
                if (this.player.gender == 3) {
                    this.outputText("", true);
                    this.outputText("\"<i>Ooh, the slut is packing is she?  Tell me, how's that cock working out for you?</i>\"\r\r", false);
                    this.outputText("It isn't, of course.  Not at all... you are entirely flaccid, and Kelt knows it.  He grasps the base of your cock roughly, giving it a few experimental tugs, laughing derisively as he does so.  There is no reaction... save that your cunt gets a little wetter.\r\r", false);
                    this.outputText("\"<i>Well, no matter.  This here is what I came for.</i>\"\r\r", false);
                }
                //(Both)
                ...
                this.outputText("\"<i>Aww... we sure got a pretty little filly here, don't we?  Still, a filly isn't really happy unless she's being fucked.  Unless her stomach is full of foals for her master.  And since you've gone to the trouble of preparing yourself for me, bitch... I guess I'll just have to do the job.</i>\"\r\r", false);
        ...
        keltSubmissiveBadEnd() {
            ...
            this.outputText("\"<i>Archery?  I've had enough of this game, bitch.  I've decided that I won't be teaching you archery anymore.</i>\"\r\r", false);
            this.outputText("A sense of dread fills you.  No more lessons?  No more... Kelt?  Then, another shock of pain as he roughly grabs you by the hair, drags you over to a nearby bale of hay, and throws you onto it facedown.  Moments later, his heavy weight rests on top of you, swollen cock pressing into your back.\r\r", false);
            this.outputText("\"<i>No, no more archery.  Time for your real education, bitch.  Lesson one... you are a slut, only here for my pleasure.  No more adventuring, no more exploring.  From now on, you are nothing but a hole for me to bust a nut into.  Got it?</i>\"\r\r", false);
        ...
        keltBadEndEpilogue() {
            ...
            this.outputText("A sudden sound caught her attention.  A lewd, squishing noise, the sound of horses crying out.  A monster?  Whatever it was, it was coming from behind the barn.  Readying her sword, the heroine moved forward cautiously, ready to confront danger.\r\r", false);
            ...
            this.outputText("In time, the male obliged, pulling cruelly on the centauress' hair as he let out a low roar and came forcefully.  The heroine stared in wonder as his massive balls convulsed again and again, pumping his mare full of seed.  If she listened, she could actually hear the lewd squish of every blast of semen as it filled her, pumping steady gouts of babycream into her womb.\r\r", false);
            ...
            this.outputText("\"<i>Enjoying the show, fucker?  She's not bad, for a quick fuck now and then.  A little clingy, but makes for a good cumdump.  What... you jealous?</i>\"\r\r", false);
            this.outputText("The heroine paled, and turned around to face the male, berating herself for letting him sneak up on her.  Brandishing her sword, she tried to step backwards, wary of an attack.  The centaur eyed her sword amusedly, then broke out into a nasty laugh, ", false);
            this.outputText("\"<i>Ha!  Little bitch human, who thinks she knows how to use a sword.  You use that little stick to ward off the big bad monsters when they come for your little pussy?  Give me a break.  This is a real man's weapon.</i>\"\r\r", false);
            ...
            this.outputText("The centaur noticed her looking, and grinned.  \"<i>You like what you see?  Maybe I could teach you a few things.  If you're not as stupid as that slut, of course.</i>\"\r\r", false);
            this.outputText("He waved confidently at the mare, still nursing her young with a rapturous look on her face.  Cum slowly oozed out of her pussy, pooling on the ground beneath her, and the heroine felt a little envious for a moment.  Most horses had harems, the virile male satisfying many women at once.  How many times a day was this mare fucked?\r\r", false);
        ...
        keltResistance() {
            ...
            if (this.player.faceType == appearanceDefs_1.FACE_HORSE || this.player.faceType == appearanceDefs_1.FACE_DOG)
                this.outputText("a low growl building in the back of your throat", false);
            else
                this.outputText("fighting anger-fueled muscle-spasms", false);
        ...
        keltResistancePussyOut() {
            ...
            //(+2 submission)
            this.player.addStatusValue(StatusAffects_1.StatusAffects.Kelt, 2, 2);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        fuckKeltsShitUp() {
            this.spriteSelect(35);
            this.outputText("", true);
            //If naga folks
            if (this.player.faceType == appearanceDefs_1.FACE_SNAKE_FANGS && this.player.tongueType == appearanceDefs_1.TONUGE_SNAKE && this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_NAGA) {
                this.outputText(this.images.showImage("kelt-farm-naga-subkelt"));
                ...
                if (this.player.hasCock()) {
                    ...
                    if (this.player.cocks[0].cockLength <= 10) {
                        ...
                        this.outputText("You punctuate these last words with three final thrusts and then, spent, slowly withdraw your " + this.cockDescript(0) + " from his mouth, spit and cum trailing on your captive's lips.  Smirking, you loosen your bonds just a little by withdrawing your tail from his ass.  Kelt doesn't even orgasm; he raggedly moans as cum simply drools out of his abused dick by the bucket load.\r\r", false);
                    }
                    //If >10 inches: 
                    else {
                        this.outputText("Slowly but surely you feed more of your formidable member into his mouth until you feel the back of his throat, with most of your " + this.cockDescript(0) + " still outside his lips.  The centaur is now entirely engaged with your length, moving his head back and forth as his tongue slathers it with attention, perhaps in the hope that the sooner he gets you off the sooner this nightmare will end.  You smirk and grip his hair, moving his head in rhythm with your own movements.\r\r", false);
                        this.outputText("You feel a mighty groan around your " + this.cockDescript(0) + " and your snake tip feels Kelt's cock begin to pulse urgently.  Quickly and expertly, you wrap the end of your tail around the centaur's penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your cock.\r\r", false);
                        this.outputText("\"<i>Ah, ah, ah,</i>\" you hiss.  \"<i>Sluts don't get off before their masters.</i>\"  A wicked idea strikes you.  Whilst still holding onto the centaur's cock with your coils, you begin to wind the tip of your tail towards Kelt's ass.  It isn't easy; you have invested the entirety of your frame into holding onto the centaur, so it is by measures that you constrict him tighter as your tail inches towards his anus.  He is bone-crushingly gripped in your coils by the time you find his sphincter, which you softly but surely sink your tip into.  Kelt struggles with the last of his strength against this final humiliation, but there is nothing he can do; with your venom plaguing his limbs, your coils wrapped hard around his frame, and your cock buried in his face, you have robbed him of everything.  Slowly you begin to feed even more of your " + this.cockDescript(0) + " into his mouth, until you see his throat bulge with your manhood.  The tightness of it is sensational and you groan.  You let him get used to the sensation of deepthroating you before you begin to pick up the pace, ramming the majority of your dick into his mouth until your " + this.ballsDescriptLight() + " begin to slap against his chin.  At your other end you feel your snake tip touch something which pulses, and you gently probe it as you continue to roughly fuck his mouth, beginning to reach your peak.  Kelt only manages a few muffled screams as you milk his prostate while continuing to deny his cock release, before you silence him with a torrent of cum, pouring it directly into his stomach.\r\r", false);
                        this.outputText("\"<i>Oh, you're soooo good at that,</i>\" you sigh, as he silently drinks your seed, his face a rictus of agonised arousal.  \"<i>That's right, take it all down.  Who would've guessed that you're a champion cock sucker?  Maybe if you drop the tough guy act, I'll let you do it some more.  We can find some pink dye for you, maybe some succubus milk, and then you can look like the pretty pony you... really... are!</i>\"\r\r", false);
                ...
                //If Female: 
                    ...
                    this.outputText("\"<i>Pretty pony stepped on a snake.  Now pretty pony has to pay the price,</i>\" you say, sighing as you part your lips and allow your " + this.vaginaDescript(0) + " to open and feel the fresh air. \"<i>You put your bud in my mouth and I will bite it off,</i>\" snarls Kelt. \"<i>Will you?</i>\" you sneer.  \"<i>I will grow one back.  You, on the other hand, will die a slow, agonising death.  Be smart.</i>\"  He stares up at you, and yes, it's fear: pure, animalistic fear of a horse for a viper. You open your mouth and bare your fangs in a wide, triumphant smile at him; venom dribbles down your chin.  He lowers his eyes and opens his mouth in submission. Needing no further invitation, you lower your " + this.vaginaDescript(0) + " onto his tongue, massaging your hands into his hair as you do so.\r\r", false);
                    this.outputText("He is unpracticed at first, unsure; you feel his teeth rub against your " + this.clitDescript() + " and for a moment you wonder if he actually will carry through his threat.  You tease at his horsecock with your tail, circling his head faintly and then, gently, sticking the very tip of it into his urethra.  He moans against your " + this.vaginaDescript(0) + " and his teeth seem to vanish, replaced with a sucking, eager wetness.  You press your abdomen against him tightly, forcing your " + this.clitDescript() + " into his mouth and his tongue into your wet hole.\r\r", false);
                    this.outputText("Girl cum begins to drip down Kelt's chin.  He is now entirely engaged with your " + this.vaginaDescript(0) + ", moving his head back and forth as his tongue slathers your clit with attention, perhaps in the hope that the sooner he gets you off the sooner this nightmare will end.  You smirk and grip his hair, forcing his head this way and that so that no corner of your pink opening goes without attention.\r\r", false);
                    this.outputText("You feel a mighty groan and Kelt's cock begin to pulse urgently against your tail.  Quickly and expertly, you wrap the end around the centaur's penis tightly, denying him release and rewarding yourself with another pained, muffled squeal reverberating through your cunt.\r\r", false);
                    this.outputText("\"<i>Ah, ah, ah,</i>\" you hiss.  \"<i>Sluts don't get off before their masters.</i>\"  A wicked idea strikes you.  Whilst still holding onto the centaur's cock with your coils, you begin to wind the tip of your tail towards Kelt's ass.  It isn't easy; you have invested the entirety of your frame into holding onto the centaur, so it is by measures that you constrict him tighter as your tail inches towards his anus.  He is bone-crushingly gripped in your coils by the time you find his sphincter, which you softly but surely sink your tip into.  Kelt struggles with the last of his strength against this final humiliation, but there is nothing he can do; with your venom plaguing his limbs, your coils wrapped hard around his frame, and his face buried in your genitals, you have robbed him of everything.  His saliva coats your opening as you clench your muscles and trap his tongue in your " + this.vaginaDescript(0) + " before roughly rubbing yourself against him, face-fucking him for all you are worth; the sensation you get from bouncing your clit against his upper lip is immense and you pick up the pace.  At your other end you feel your tip touch something which pulses deep in his anal passage, and you gently probe it as you roughly fuck his mouth, beginning to reach your peak.  Kelt only manages a few muffled screams as you milk his prostate while continuing to deny his cock release, before you silence him with a waterfall of girl cum, which in ecstasy you slather his entire face with.\r\r", false);
            ...
            //Standard anti-kelt scene
                ...
                if (this.player.tallness < 50 || this.player.totalCocks() == 0) {
                    if (this.player.tallness < 50)
                        this.outputText("Realizing you're too short to dominate him properly, you come up with another plan.  ", false);
                ...
                if (this.player.gender == 0) {
                    ...
                    if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_SLICK)
                        ...
                        this.outputText("immediately becoming slick with your fuck-me-juices.  ", false);
                    this.outputText("\"<i>Deeper,</i>\" you sigh, and he complies, no longer capable of resistance.  You make him tonguefuck you until you come to a shuddering, cunt-clenching orgasm.", false);
                    if (this.player.totalCocks() > 0)
                        this.outputText("Your " + this.cockDescript(0) + " splatters cock-cream into his hair, further humiliating him.", false);
                    this.outputText("\r\r", false);
                }
                else {
                    this.outputText("You spread your " + this.player.legs() + " and expose your " + this.cockDescript(0) + ".  \"<i>Lick it, bitch,</i>\" you command.   When he doesn't, you give the rope a pull, and his hooves paw at the dirt in pain.  \"<i>I said LICK!</i>\" you scream, and this time he does.  His slightly rough tongue slides up and down your length, gingerly tasting your prick-skin.  \"<i>Take it deep,</i>\" you sigh, and he complies, no longer capable of any form of resistance.  He opens wide and buries his face into your crotch ", false);
                    if (this.player.cocks[0].cockLength < 10)
                        this.outputText("taking the entire thing easily as his tongue licks you to ", false);
                    else if (this.player.cocks[0].cockLength < 25)
                        this.outputText("taking the entire thing deep into his throat.  Apparently centaurs lack a gag-reflex, and you can see his throat stretched around you as you're brought to ", false);
                    else
                        this.outputText("taking as much as he can deep into his throat.  Even though his entire neck is distorted by your massive member, his throat simply isn't long enough to take any more.  You writhe as the throat-fucking brings you to ", false);
                    this.outputText("an explosive orgasm.  You deposit your cream directly into his belly, making him burp when you pull out, dripping on the centaur's abused lips.\r\r", false);
                }
                ...
                this.outputText("You redress before the comatose centaur gets a chance to come to his senses, and wonder if he'll recover enough of his pride to face you again.", false);
            }
            this.player.orgasm();
    ...
    exports.KeltScene = KeltScene;
});
//# sourceMappingURL=KeltScene.js.map