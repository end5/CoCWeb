define(["require", "exports", "./AbstractFarmContent", "../../../PregnancyStore", "../../../GlobalFlags/kFLAGS", "../../../CoC", "../../../../console", "../../../StatusAffects", "./Kelt", "../../../CockTypesEnum", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, AbstractFarmContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, StatusAffects_1, Kelt_1, CockTypesEnum_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Kelly extends AbstractFarmContent_1.AbstractFarmContent {
        constructor() {
            super();
            this.pregnancy = new PregnancyStore_1.PregnancyStore(kFLAGS_1.kFLAGS.KELLY_PREGNANCY_TYPE, kFLAGS_1.kFLAGS.KELLY_INCUBATION, 0, 0);
            this.pregnancy.addPregnancyEventSet(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, 280, 200, 100);
        ...
        timeChange() {
            ...
            console_1.trace("\nKelly time change: Time is " + this.model.time.hours + ", incubation: " + this.pregnancy.incubation + ", event: " + this.pregnancy.event);
            if (this.model.time.hours > 23) {
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_REWARD_COOLDOWN] > 0 && this.model.time.days % 3 == 0)
                    this.flags[kFLAGS_1.kFLAGS.KELLY_REWARD_COOLDOWN] = 0;
                if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] >= 4)
                    this.flags[kFLAGS_1.kFLAGS.KELLY_DISOBEYING_COUNTER]++;
            }
        ...
        hasPinkEgg() {
            return (this.player.hasItem(this.consumables.PINKEGG) || this.player.hasItem(this.consumables.L_PNKEG));
        }
        //Encounters
        //First encounter
        breakingKeltOptions() {
            ...
            if ((!this.player.hasCock() && this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] == 0) || this.flags[kFLAGS_1.kFLAGS.NEVER_RESIST_KELT] == 1 || this.player.statusAffectv2(StatusAffects_1.StatusAffects.Kelt) >= 40 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.Kelt) < 0) {
                this.farm.keltScene.keltEncounter();
                return;
            }
            if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] > 0) {
        ...
        resistKeltsBSBreakHimIntro() {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] == 1) {
                this.outputText("You set out to go get Kelt, eager to teach this slut another lesson of your own.  You explore the farm for a bit before spotting the centaur behind the barn.  However, Kelt seems to have changed since last time: he somehow changed back his gender.  That rebellious little bitch!  Although he doesn't look as aggressively masculine as before, and his chest still bears some man-tits, he has gotten back his stern, rude face and you can clearly see a fat prick hanging from his backside.  It doesn't seem to be as big as it was before, though.  He must have grown it in a hurry.");
                //back to farm]
                //[if you don't have the items:
                if (!(this.player.hasItem(this.consumables.SUCMILK, 10) || this.player.hasItem(this.consumables.P_S_MLK, 10) || (this.player.hasItem(this.consumables.SUCMILK, 5) && this.hasPinkEgg()) || (this.player.hasItem(this.consumables.P_S_MLK, 5) && this.hasPinkEgg()))) {
            ...
            //Third encounter
                ...
                //[Start Combat]
                this.startCombat(new Kelt_1.Kelt());
                this.spriteSelect(35);
            }
            else if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] == 3) {
                this.spriteSelect(-1);
        ...
        neverBreakKeltIntoKelly() {
            this.clearOutput();
            this.spriteSelect(35);
            this.flags[kFLAGS_1.kFLAGS.NEVER_RESIST_KELT] = 1;
        ...
        breakKeltGo() {
            this.clearOutput();
            this.spriteSelect(35);
            this.outputText("You approach the uppity centaur with glinting eyes, determined to take him down.  Kelt mistakes your anger for desire and sneers.");
            this.outputText("\n\n\"<i>What do you want, you little " + this.player.mf("sissy", "bitch") + "?  I'm done with you.  I'm already doing you a favor by teaching you a skill sluts like you will never use nor master.</i>\"");
            ...
            if (this.player.tallness < 70)
                this.outputText("You jump up, and y");
            else
                this.outputText("Y");
            this.outputText("our [weapon] hits Kelt's forehead, knocking him back.  He didn't even dodge or defend himself; the hit brought him down immediately.");
            ...
            this.outputText(".  You grab a nearby keg and pour down vial after vial until it's half-full.  The creamy substance exudes strong female scents that arouse both of you.");
            if (this.hasPinkEgg()) {
                this.outputText("  You then throw the egg into the keg before stirring the whole mixture, grinning as you prepare Kelt a whole new meal.");
            }
            ...
            if (!this.player.isTaur())
                this.outputText("pulling [eachCock] out of your [armor] and stroking yourself with your free hand");
            else {
            ...
            this.outputText(" small droplets of pre-cum begin dripping out of your " + this.multiCockDescriptLight() + " before being swallowed by the potent, feminine mixture down below.  The white spots are drowning in that milky goo, but you're confident that Kelt will be able to recognize the taste.");
            ...
            if (!this.player.isTaur())
                this.outputText("fully whip out your [cock biggest] and shove it between her busty tits and slowly start grinding");
            else
                this.outputText("step over her, shoving your [cock biggest] between her busty tits, grinding it through that smooth valley");
            this.outputText(".");
            ...
            if (this.player.isTaur())
                this.outputText("dance your hindlegs about in order to ");
            ...
            if (this.player.isTaur())
                this.outputText("step over her, moving your hips back and forth to thrust through her more-than-ample cleavage.");
            else
                this.outputText("grab her nipples and begin to thrust your pecker against her boob valley.");
            this.outputText("  She occasionally gives your tip a wet kiss, trying to make up for her mistakes.  You ignore her and thrust harder, her round melons squeezing your shaft rhythmically.");
            ...
            if (this.hasPinkEgg()) {
                ...
                if (this.player.hasItem(this.consumables.SUCMILK, 10))
                    ...
                    this.player.consumeItem(this.consumables.P_S_MLK, 10);
            }
            else {
                if (this.player.hasItem(this.consumables.SUCMILK, 15))
                    this.player.consumeItem(this.consumables.SUCMILK, 15);
                else
                    this.player.consumeItem(this.consumables.P_S_MLK, 15);
            }
            this.player.orgasm();
            this.dynStats("cor", 5);
            this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] = 1;
        ...
        defeatKellyNDBREAKHIM() {
            ...
            if (this.monster.lust > 99)
                this.outputText("Kelt moans, mauling at his mantits in his lust before he realizes what's going on");
            else
                this.outputText("Kelt groans, slumping slightly from all the damage you've done to him");
            ...
            //(Silly:)
            if (this.silly() && kGAMECLASS_1.kGAMECLASS.amilyScene.amilyFollower() && kGAMECLASS_1.kGAMECLASS.amilyScene.amilyCorrupt())
            ...
            if (this.player.isTaur())
                this.outputText("push her underneath you towards");
            else
                this.outputText("pull her close to");
            ...
            if (this.player.balls > 0)
                this.outputText(" and fondling your [balls] with great care");
            this.outputText(".  Her lips regularly wrap around your [cock biggest] in near-perfect sucking motions.  She's getting better at this.");
            ...
            if (this.hasPinkEgg()) {
                ...
                if (this.player.hasItem(this.consumables.SUCMILK, 5))
                    ...
                    this.player.consumeItem(this.consumables.P_S_MLK, 5);
            }
            else {
                if (this.player.hasItem(this.consumables.SUCMILK, 10))
                    this.player.consumeItem(this.consumables.SUCMILK, 10);
            ...
            this.player.orgasm();
            this.dynStats("cor", 5);
            this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] = 2;
            this.cleanupAfterCombat();
        }
        //Win Second Fight (Third Feminizing Encounter):
        breakingKeltNumeroThree() {
            this.clearOutput();
            if (this.monster.HP < 1)
                this.outputText("Slumping down, ");
            else
                this.outputText("Moaning, ");
            this.outputText("he doesn't attempt to escape or attack you.  Before he can do anything, you're already on him. His reactions appear to be a lot slower since he began discovering his new craving for your dick.  He just stares at you nervously, waiting for your next move.");
            ...
            if (!this.player.isTaur())
                this.outputText(", sometimes with your [cock] -");
            ...
            if (this.player.isTaur())
                this.outputText("push from behind");
            else
                this.outputText("pull");
            this.outputText(", you pin her head against your groin and shove your wang down her throat.  This time, the centauress doesn't seem to be hindered or about to choke.  She takes the entirety of your length and sucks you up like the good little whore she is.  Your entrapped cock is squeezed so tightly that you feel like it's about to explode; not willing to reach your climax so soon, you swiftly pull out of her mouth.");
            ...
            this.outputText("\n\nYou briskly reach ");
            if (this.player.isTaur())
                this.outputText("down, pushing her");
            else
                this.outputText("forward to grab one of her tits and grope it");
            this.outputText(" convulsively as you feel your lust rise.  ");
            if (!this.player.isTaur())
                this.outputText("Soon one breast isn't enough to contain your lust-driven energy and you reach for the other one with your free hand.  Your constant nipple-teasing has an effect on");
            else
                this.outputText("Soon, you cannot contain your lust, and you begin to buck against her hands, whinnying with delight.  The rigid, pulsing dick-flesh in her mouth has an effect on");
            this.outputText(" Kelly at last: you can hear her moan and sigh, and her hands move erratically on your " + this.multiCockDescriptLight() + ", sometimes violently yanking it as she loses control.  This brings all kinds of painful yet pleasurable tingles to your body, and only entices you to feel her up even more.");
            this.outputText("\n\nA familiar warmth builds in your loins ");
            if (this.player.balls > 0)
                this.outputText("and your [balls] churn ");
            ...
            if (!this.player.isTaur())
                ...
                this.outputText("Y");
            this.outputText("ou release a loud groan yourself.  You cum hard, your quivering [cock biggest] spraying spooge in steady jets directly into the keg.  You maintain your grip on the centauress");
            if (!this.player.isTaur())
                this.outputText("' breasts");
            this.outputText(", heedless of her pain and only caring about your own orgasm.  You feel her soft hands squeezing your junk there and there in order to milk the last drop of cum and making sure none of it remains stuck in your urethra.  When you're done riding out your orgasm, you walk up to the keg and pour down the two bottles of Succubi Milk you have left.  The copious amount of baby-batter mixes with the alright-alabaster fluid to form a bubbling ivory mixture that you bring close to Kelly's lips.");
            this.outputText("\n\n\"<i>Drink.</i>\"");
            ...
            this.player.orgasm();
            this.dynStats("cor", 5);
            this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] = 3;
            this.cleanupAfterCombat();
        }
        //Fourth encounter
        ...
        finalKeltBreaking() {
            this.clearOutput();
            this.outputText("You resolutely walk up to the centaur slut for her final lesson.  This time you don't even need to find her: she rushes to you on her own, her eyes glinting with need.");
            ...
            if (this.player.isTaur())
                this.outputText("kneels down");
            else
                this.outputText("bends over");
            this.outputText(" to reach for your [cock biggest].  She sucks with eagerness and passion; you don't even need to pull her head as it moves on its own around your length.  ");
            if (this.player.balls > 0)
                this.outputText("Her free hands moves down on your groin and caresses your [balls] with expert care and precision; obviously her previous experience in groping has had an effect on her current skills.  ");
            this.outputText("Her hunger for your meaty junk seems to be insatiable, for after moments of dick kissing and licking, she decides to take the entirety of your length.  Her eyes are voracious as her fat lips swallow inch after inch of dick-flesh.");
            ...
            if (this.player.isTaur())
                this.outputText("hindleg haunches");
            else
                this.outputText("[butt]");
            this.outputText(", always pulling your groin closer to her avid mouth as she relentlessly throatfucks herself on you.  Your [cock biggest] is being squeezed and massaged in the most divine way as it knocks against her warm esophagus, and you're tempted to cum in her right now, right here. But you need to finish the 'lesson'; with great regret, you softly ");
            if (this.player.isTaur())
                this.outputText("back away");
            else
                this.outputText("push the centaur girl away");
            this.outputText(" and pull out of her mouth. Wailing with displeasure, the cock-slut decides to give your meat a couple of sad licks, disappointed to see her phallic prize withdrawing from her.  She quickly regains her enthusiasm, however.");
            ...
            if (this.silly())
                this.outputText("  CUM CANNON!");
            this.outputText("</i>\"  A familiar power gathers inside you, and you decide to tap into it.  You pull out of her tits and cum really, really hard.");
            ...
            this.player.orgasm();
            this.dynStats("cor", 8);
            this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] = 4;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        keltFucksShitUpII() {
            ...
            this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL]--;
            if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] < 1)
                this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] = 1;
            this.cleanupAfterCombat();
        }
        //Appearance
        kellyAppearance() {
            this.clearOutput();
            this.outputText("Kelly is a 6 foot 3 inch tall centauress with a svelte body and generous curves.  Her feminine face is pretty human in appearance, and her lovely traits would be adorably innocent if it weren't for her emerald eyes shining with lusty need whenever she looks at you.  Plump lips that seem to have been made for cock-sucking adorn her hungry mouth.  A long, single " + this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR]);
            //[chestnut brown/sable black/garish purple/bright pink/slutty blonde) 
            this.outputText(" braid hangs between her shoulders, giving you easy leverage when you have your way with her.  Her torso is likewise human-looking, only stopping below her navel where her equine part starts growing.  She stands on four horse hooves, her lower body looking almost like a horse's- aside from the pointed " + this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] + " demon's tail which sprouts where her horse tail should, and her cute, pink, human-like asshole.");
            //[chestnut brown/sable black/garish purple/bright pink/slutty blonde]
            this.outputText("\n\nShe sports a pair of soft DD-cup breasts.  Each one is ornate with a 0.5 inch nipple, often rock-hard in arousal.");
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0)
                this.outputText("  Beneath those, she has a second row of jiggly tits, just aching to be squeezed.");
            if (this.pregnancy.isPregnant)
                this.outputText("  Drops of milk often dribble from her tits, betraying her potent lactation.");
            //[enter vagina text] 
            this.outputText("\n\nKelly has a ");
            //[virgin]
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT] == 0)
                this.outputText("virgin, ");
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] == 0)
                this.outputText("pink pussy");
            else
                this.outputText("puffy, black mare-cunt");
            this.outputText(" placed below her hindquarters.  It is almost constantly dripping rivulets of moisture when you're around.  Its shining openness seems to welcome you in her warmth.");
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_HEAT_TIME] > 0 && !this.pregnancy.isPregnant)
                this.outputText("<b>  There is so much leaking from her that you think she might be in heat, rendering her more receptive to impregnation.</b>");
            ...
            if (this.farm.farmCorruption.hasTattoo("kelly")) {
                ...
                if (this.farm.farmCorruption.kellyFullTribalTats()) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_COLLARBONE] != '')
                        this.outputText(this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_COLLARBONE] + "\n");
                    if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_SHOULDERS] != '')
                        this.outputText(this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_SHOULDERS] + "\n");
                    if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_LOWERBACK] != '')
                        this.outputText(this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_LOWERBACK] + "\n");
                    if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_BUTT] != '')
                        this.outputText(this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_BUTT] + "\n");
                    this.outputText("\n");
                }
            }
            //Kids flavour text
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS] > 0) {
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS] == 1) {
                    this.outputText("\nKelly's ");
                    if (this.flags[kFLAGS_1.kFLAGS.KELLY_FIRST_KID_GENDER] == 1)
                        this.outputText("son");
                    else
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.KELLY_FIRST_KID_GENDER] == 1)
                        ...
                        this.outputText("her playing in the distance, lost in her own little world.");
                }
                else if (this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS] == 2)
                    this.outputText("\n\nThe " + Kelly.num2Text(this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS]) + " children you have had with Kelly are off in a separate field; the sound of their play drifts over the grasslands to your ears.  Kelly evidently prefers to keep her brood away from what you do with her, a remarkably sensible attitude coming from a centauress cumslut.  Maybe motherhood genuinely suits her?");
                else
                    this.outputText("\n\nThe " + Kelly.num2Text(this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS]) + " children you have had with Kelly are as ever off in a separate field, the distance sounds of their acting out the wars and drama of childhood drifting out over the grasslands to your ears.");
                this.outputText("\n");
            }
            this.menu();
        ...
        approachKelly() {
            this.clearOutput();
            //Fix hair color!
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] == '')
                this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] = "chestnut brown";
            //PUNISH SCENES IF APPROPRIATE
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT] > 0 && this.flags[kFLAGS_1.kFLAGS.TIMES_PUNISHED_KELLY] == 0 && Kelly.rand(3) == 0 && this.player.hasCock()) {
                this.flags[kFLAGS_1.kFLAGS.KELLY_DISOBEYING_COUNTER] = 0;
                this.punishKelly();
                return;
            }
            //Descriptions and Flavour Text
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_STARTED] == 0)
                this.outputText("You aren't welcome on the farm proper, but you can go visit Kelly's field.");
            //09:00-11:00, 2 or more children:
            if (this.model.time.hours >= 9 && this.model.time.hours <= 11 && this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS] >= 2) {
                this.outputText("\n\nKelly is standing in the shadow of her barn, an expression of blissful contentment on her face as she nurses your ");
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS] > 2)
                    this.outputText("two youngest ");
                this.outputText("children with ");
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0)
                    this.outputText("the top row of ");
                this.outputText("her milk-laden tits.  When she dreamily opens her eyes and sees you standing there, she nudges them off gently.");
            ...
            else if (this.model.time.hours >= 15 && this.model.time.hours <= 16 && this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS] >= 4) {
            ...
            if (this.player.lust < 33)
                ...
                this.addButton(1, "Sex", this.kellySexMenu);
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] == 0) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] == 1) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT] > 0 && this.flags[kFLAGS_1.kFLAGS.KELLY_DISOBEYING_COUNTER] >= 3 && this.player.hasCock()) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_PUNISHED_KELLY] > 0 && this.flags[kFLAGS_1.kFLAGS.KELLY_REWARD_COOLDOWN] == 0 && Kelly.rand(3) == 0) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_STARTED] == 0)
                ...
                this.addButton(9, "Back", this.farm.farmCorruption.rootScene);
        }
        kellySexMenu() {
            this.menu();
            if (this.player.hasCock() && this.player.lust >= 33) {
                if (this.player.cockThatFits(300) >= 0 || this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] == 1) {
                    if (this.pregnancy.isPregnant)
                        this.addButton(0, "Preg Fuck", this.kellyPregSex);
                    else if (!this.player.isTaur())
                        this.addButton(0, "Fuck Cunt", this.fuckKellysCunt);
                    else
                        this.addButton(0, "Fuck Cunt", this.taurOnTaurSexKelly);
                    if (this.flags[kFLAGS_1.kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT] == 0)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_BONUS_BOOB_ROWS] == 0 && this.player.cockThatFits(18, "length") < 0 && !this.player.isTaur()) {
                    this.outputText("\n<b>You're too big to fuck her tits.  Maybe if you gave her something to make her grow more...</b>");
                }
                else if (!this.player.isTaur())
                    this.addButton(2, "Titfuck", this.kellyTitJob);
        ...
        fuckKellysCunt() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.KELLY_VAGINALLY_FUCKED_COUNT]++;
            var x = this.player.cockThatFits(300);
            if (x < 0)
                x = this.player.smallestCockIndex();
            this.outputText("You strip out of your [armor] in a hurry, intent on claiming your equine slut from behind.  As soon as [eachCock] flops free, Kelly takes notice, her hand coming in front of her mouth in surprise.");
            ...
            if (this.player.tallness < 72) {
                ...
                if (this.player.tallness < 52)
                    this.outputText("diminutive ");
                this.outputText("height makes reaching her pussy a difficult task.  ");
            }
            this.outputText("Holding your " + this.cockDescript(x) + " in one hand, you press your " + this.player.cockHead(x) + " against her entrance.   The steamy cunt pulses wetly around your girth, slowly spreading its thick lips to accept your rigid endowment.");
            if (this.player.cockTotal() > 1) {
                this.outputText("  Your other erection");
                if (this.player.cockTotal() > 2)
                    this.outputText("s hang");
                else
                    this.outputText(" hangs");
                this.outputText(" down below, collecting her drippings and smearing across her belly.");
            }
            this.outputText("  You slowly slide inside the tight tunnel, feeling Kelly's powerful muscles squeeze delightfully around you, massaging your " + this.cockDescript(x) + " with slow undulations.");
            ...
            if (this.player.balls > 0)
                this.outputText(" and roiling balls");
            this.outputText(" leaves no doubt that climax is fast approaching.  Kelly cums first, splattering your [hips] with her ");
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] > 0)
                this.outputText("fragrant ");
            this.outputText("centaur-cum, soaking your [legs] immediately.  Her pussy goes wild, the once-ordered spasms going wild, wringing your " + this.cockDescript(x) + " with uncoordinated motions.  A moment later, all those wild contractions sync up into intense, dick-massaging waves.  The power of her equine lower half becomes obvious when her twat seems to suck you inside, squeezing you off to orgasm.");
            ...
            if (this.player.cumQ() >= 500)
                this.outputText("  Her pussy seems like a soggy, cum-soaked sex-toy before you're even halfway done.");
            if (this.player.cumQ() >= 1200) {
                this.outputText("  The sheer amount of spunk exploding into her womb actually rounds her belly a little");
                if (this.player.cumQ() >= 4000)
                    this.outputText(", until she's so pregnant with spooge that she can barely stand");
                this.outputText(".  ");
            }
            this.outputText("You lay immobile on her back, panting while her wonderful cunt drains you of every drop.");
            ...
            if (!this.pregnancy.isPregnant)
                ...
                this.outputText(", maybe knit some for the kids you're going to be pumping out for me non-stop");
            this.outputText(".</i>\"");
        ...
        taurOnTaurSexKelly() {
            ...
            this.outputText(", pressing it into her face, letting your sweat and the scent of your groin smother as effectively as your presence.  Her tongue extends, knowing what you want even before you have to ask.  She licks you, tentatively and then with increasing levels of confidence, smearing saliva all over your flesh as she licks up every drop of sweat, orally lubricating you with hot, wet tongue.");
            if (this.player.balls > 0)
                this.outputText("  Your [balls] tingle pleasantly from the attention, and you groan when she sucks one into her mouth, worshipping it with her lips.");
            ...
            if (this.player.balls > 0)
                ...
                this.outputText("hindlegs");
            this.outputText(", splattering out in fresh waves from Kelly's ");
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] > 0)
                this.outputText("musky ");
            this.outputText("womanhood.  With her body firmly under your own, where it belongs, you firmly assert your control, grabbing her hair in one hand and yanking.  You tug her head back as you bottom out, your body filled with the pleasure of mating like the beasts that you are.");
            this.outputText("\n\nKelly groans through her pain, \"<i>Ooohh, yes, give me your foal, [Master]!  My pussy needs it!</i>\"  True to her words, her walls begin to tug at your " + this.cockDescript(x) + " with familiar, milking contractions, squeezing you from base to " + this.player.cockHead(x) + " again and again.  Her fluids gush out everywhere, turning the ground underneath her to mud as she climaxes.  You pinch her nipples as the heat builds within you, and when you can take it no more, you reward your cum-slut with the liquid orgasm she so craved.  Jism basts her inner walls when you explode.  Again and again, your muscles clench with ecstatic blast, ejaculating thick flows of your lust straight into the cum-dumpster's spasming cunny.  ");
            if (this.player.cumQ() >= 1000) {
                this.outputText("  Her belly grows round with the liquid weight of your spunk");
                if (this.player.cumQ() >= 4000)
                    this.outputText(", and when she grows too full to hold any more, waves of alabaster spooge roll out of her abused nether-lips, adding to the messy sex-puddle below");
                this.outputText(".  ");
            }
            this.outputText("Thoroughly creamed, the centaur cum-dump sighs in satisfaction while you dismount her.");
            this.outputText("\n\nKelly starts to move, then immediately slips in the lubed mud below, legs flailing wildly.");
            if (this.player.cor < 50)
                this.outputText("  You feel a little bad for her and help her up - she did just milk your dick in the way that only a centaur can.");
            else
                this.outputText("  You snicker and walk away - she's already served her purpose.");
            this.kellyPreggers();
            this.player.orgasm();
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        tentaFuckKelly() {
            this.clearOutput();
            this.outputText("With a mischievous grin, you remove your [armor], fully revealing your " + this.multiCockDescriptLight() + ".  The plant-like appendages wriggle around the horny centauress, inspecting her body from every angle.  You feel your own lust rising as the tentacle peckers grow harder, their green heads turning pink in arousal.  Kelly stammers, confused: \"<i>W-what are you-</i>\"");
            var one = -1;
            var two = -2;
            var three = -3;
            var four = -4;
            ...
            while (temp < this.player.totalCocks()) {
                if (this.player.cocks[temp].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE) {
                    if (one < 0)
                        one = temp;
                    else if (two < 0)
                        two = temp;
            ...
            this.outputText("\n\nSLAM!  You profit from the slut's babbling to shove your " + this.cockDescript(one) + " right into her gaping mouth, forcefully filling her throat with dick-flesh.  Her lips instinctively cling to your shaft, sucking it like a popsicle.  Drops of pre-cum are quickly swallowed and ingested by the hungry whore as they escape your urethra.  You begin thrusting in and out of her warm mouth, but her lips squeeze your rod so tight that you have to fight for every inch.  As you stuff her full of your " + this.cockDescript(one) + ", you can hear her endless muffled moans; the slut is obviously getting off to the taste of your meaty junk.  Completely driven with lust, the green tentacle prick is vibrating on its own as it fucks Kelly's throat, sending you soft, prickling sensations.  You can't help but release a grunt as the centaur slut fellates you so expertly.");
            this.outputText("\n\nKelly is doing an incredible job with her mouth, teasing you into oblivion.  Your " + this.cockDescript(two) + " is convulsing recklessly in frustration, begging to be stuffed into some warm hole.  Therefore, you naturally direct it toward the centauress' wet snatch; it is easily spottable due to the regular streams of juices that ooze from it.  Moreover, the slut is incredibly turned on from sucking you off, and the fem-spunk trails are even thicker than usual.  It doesn't take long for your secondary tentacle dong to reach the entrance of her moist love-tunnel.  You grind the tip of your " + this.cockDescript(two) + " against it, using her genitals as a masturbation aid.  When it is hard as bark and ready to go, you ram it through Kelly's fuck-hole, utterly piercing her from behind.");
            this.outputText("\n\nYou ream the centaur slut from both sides, making her whinny and thrash violently.  She tramples the floor with her hooves, arches her back and screams in ecstasy through the inches of dick-flesh blocking her throat; she is completely heedless of the world beside the two hard vegetal poles fully impaling her on either end.  You pump away in rhythm, synchronizing each thrust in both holes.  Her twat is almost inhumanly hot, and gloriously tight.  However, the slut tries her best to wrap her lips even tighter around your main flexible pecker, and her tongue is teasing your " + this.cockDescript(one) + " in the most excruciating way.  You stuff the mare slut full of your green appendages, treating her body like a bipolar cocksleeve.");
            //[if (cocks > 2)
            if (three >= 0) {
                this.outputText("\n\nThe display of Kelly trembling in pleasure as you spit her like a pig on your duo of plant-like pricks is enticing, and your " + this.cockDescript(three) + " is aching with need.  It almost moves on its own volition toward the woman's perky tits, ready for a good boobjob.  The supple green wang lodges itself between the busty melons; the slut instantly begins to squeeze her heavy globes around the rod of dick-flesh, fully entrapping it in her bosom.  Her tits are so tender and soft you feel like your tentacle pecker is about to melt.  Groaning in pleasure, you thrust your " + this.cockDescript(three) + " up and down as the titty-fucked whore accompanies your motion.  You grind in rhythm so the slut doesn't forget your other tentacle dongs.  Fortunately, Kelly quickly picks up your intention and soon you can't tell which member is providing you with the most pleasure; her mouth, vagina and soft tits are all working in conjunction, and you are fully lost in a never-ending spiral of ecstasy.");
            }
            //if (cocks > 3)
            if (four >= 0) {
                this.outputText("\n\nYour " + this.cockDescript(four) + " trembles furiously, unable to find some body part that isn't taken by its colleagues.  You grin wickedly as an idea comes to your mind.  The protruding appendage writhes as it threads its way toward Kelly's right hand; the slut is still focusing on your " + this.cockDescript(three) + ", squeezing her tits as tightly as she can.  Needless to say, she is surprised when another tentacle shoves itself in the way, right under her palm.  She doesn't lose her composure, though; using her forearm to press on her chest, her hand quickly grabs hold of your tree-like pecker and begins stroking your length.  Although her handjob doesn't feel as warm and tight as the wet depths of her love-tunnel or her throat, or even the squelching contact of her tender boob-flesh, she teases you efficiently with her fingers.  Her hand massages your " + this.cockDescript(four) + " and clutches it like a vice, milking some drops of pre-cum out of your shaft.  She takes care of the most sensitive points and often makes you moan when she squeezes the towering rod.");
            }
            //[if (cocks > 4)
            if (five >= 0) {
                this.outputText("\n\nKelly still has a free hand, and your " + this.cockDescript(five) + " is left alone, flustered.  The squirming tentacle quickly finds a comfortable spot near her boob, but this time you don't need to do anything; the eager slut catches the vegetal rod and begins to stroke it furiously.  Her hands pump along your lengths in turn; both pricks are so hard that you don't know which one will cum first.  Her fingers move across the surface of your meaty green dongs with expert care, teasing you more and more.  You enjoy the double handjob, your duo of plant-like dongs ready to explode in a mess of cum.");
            }
            //[if (cocks > 5)
        ...
        giveKellyEquinum() {
            this.clearOutput();
            this.outputText("Taking the long, flared vial in your hand, you get a wicked idea - what if you gave your personal mare-slave a cunt that was better suited to her depraved, animalistic shape?  What if you turned that pretty, pink pussy into a slobbering, black mare-cunt?");
            ...
            this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] = 1;
        ...
        giveKellySuccubiMilk() {
            this.clearOutput();
            this.outputText("You produce a vial of succubi milk and dangle it before Kelly, the ivory demon-juice sloshing audibly inside.  Kelly licks her lips immediately, running her hands across her perky nipples without meaning to.  She asks, \"<i>[Master], is that what I think it is?</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] = 0;
        ...
        punishKelly() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.TIMES_PUNISHED_KELLY]++;
            //First time: 
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_PUNISHED_KELLY] == 1) {
            ...
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT] > 0 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.TelAdre) < 1) {
                this.outputText("You'd like to take Kelly for a ride, but you don't have any good ideas for public places to humiliate her.");
            }
            else
                this.addButton(1, "Ride", this.rideKellyForPunishment);
        ...
        getARimjobFromKelly() {
            ...
            if (x < 0)
                x = this.player.smallestCockIndex();
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.TIMES_RIM_JOBBED_BY_KELLY]++;
            ...
            //[Centaur:]
                ...
                this.outputText("\n\nYou gesture at the ground.  \"<i>Lie down,</i>\" you command.  Kelly carefully folds her body up to do so, until her horse half is prostrate and only her human half is propped up.  You lead yourself back until your rear end is near to her face; grinning to yourself, you slowly brush your semi-erect " + this.cockDescript(x) + " against her soft face, teasing her with the idea that you've changed your mind; you cannot see her but from the small bitten off grunts and moans you know she's struggling with the urge to wrap her lips around it.  Finally, you carefully lean downwards, so that instead of your dick she's faced with your [butt].");
            //[Biped/Other:
            else
                this.outputText("\n\nYou gesture at the ground.  \"<i>Lie down,</i>\" you command.  Carefully Kelly folds her body up to do so, until her horse half is prostrate and only her human half is propped up.  You step forwards and for a few moments slowly brush your semi-erect " + this.cockDescript(x) + " against her soft face, teasing her with the idea that you've changed your mind; she struggles with the urge to wrap her lips around it, emitting small bitten off grunts and moans to your ministrations.  Finally, with a grin you pull away and turn around, so that her mouth is now facing your [butt].");
            ...
            if (this.player.isNaga())
                this.outputText("With reptilian litheness, you slowly lean backwards and press your hands onto the back of her head, pushing her face further between your cheeks.  ");
            else if (!this.player.isTaur())
                this.outputText("You lean backwards and press your hands onto the back of her head, pushing her face further between your cheeks.  ");
            ...
            //[Not Centaur: 
            if (!this.player.isTaur())
                this.outputText("  You smirk and grip her hair, moving her head in rhythm with your own movements.");
            else
                this.outputText("  You gyrate your [butt] this way and that, moving her head in rhythm with your own movements.");
            //[Pussy: 
            ...
            this.outputText("?  I can't say it's something you don't deserve for being such a shameless slut, and I don't doubt you'd enjoy every minute of it.</i>\"");
            ...
            if (this.player.hasVagina())
                this.outputText("; she slides as many fingers as she can into your [vagina] and frigs you as best she can");
            this.outputText(".  Grunting, you reach your peak.  Your " + this.cockDescript(x) + " opens wide and you ejaculate streams of cum, splattering into the dust in front of you, your whole body clenching and seizing around the warm, wet muscle wedged in your [butt].");
            //[Pussy:]
            if (this.player.hasVagina())
                this.outputText("  Your female sex orgasms in tandem, your wet flesh seizing up around Kelly's fingers and spattering her arm and chest with girl juices.");
            ...
            //[First time: 
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_RIM_JOBBED_BY_KELLY] == 1) {
        ...
        rideKellyForPunishment() {
            var x = this.player.cockThatFits(300);
            if (x < 0)
                x = this.player.smallestCockIndex();
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT]++;
            //First Time: 
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT] == 1) {
                ...
                if (this.player.tallness < 78 && !this.player.isTaur()) {
                    ...
                    //[Naga:]
                    if (this.player.isNaga())
                        this.outputText("  Your reptilian half is hardly ideal for riding a horse but eventually you reach a happy compromise; you perch upon her with your long tail wrapped around her barrel-like lower body.");
                    //[Drider:]
                    else if (this.player.isDrider())
                        this.outputText("  Your spider half is hardly ideal for riding a horse but eventually you reach a happy compromise; you perch upon her with your long, chitinous legs wrapped carefully around her barrel-like lower body.  You must look utterly bizarre but feel reasonably comfortable.");
                    this.outputText("  You lean in close to her human half and wrap your arms around her waist, drinking in the sweet scent of her pale skin; you know your own smell and power is pressing upon her senses and she whimpers softly as you slide your hands up her stomach until they are clutching her ");
                    if (this.flags[kFLAGS_1.kFLAGS.KELLY_BONUS_TIT_ROWS] > 0)
                        this.outputText("top row of ");
                    this.outputText("breasts.");
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.KELLY_LACTATING] > 0)
                ...
                //[PC is 6'6</i>\" or more/centaur:
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.KELLY_LACTATING] > 0) {
                        if (this.flags[kFLAGS_1.kFLAGS.KELLY_BONUS_TIT_ROWS] > 0)
                            ...
                            this.outputText("H");
                        this.outputText("er swollen teats immediately begin to dribble milk, and she moans.  ");
                    }
                    this.outputText("\"<i>So we will have to find some other way you can serve me.  We're going to go across to the farm.  You remember where that is, don't you?  It's where I taught you who you really are.  We're going to learn some more lessons there.  Won't that be fun?</i>\" You let go and set off at a ");
                    if (!this.player.isTaur())
                        this.outputText("march");
                    else
                        this.outputText("canter");
                    this.outputText(" and after a pause she follows; deliberately led towards your destination.");
                ...
                if (this.player.tallness < 78 && !this.player.isTaur()) {
                    ...
                    this.outputText("\n\nNeither of you are in any condition to keep this up for long, and after five minutes of fevered fucking, you groan as you clutch Kelly's ass hard, clenching and pouring yourself into her, your " + this.cockDescript(x) + " surging line after line of cum into her.  She moans breathily and happily to the heavenly sensation of being filled with your seed, her vagina milking you for every drop it can get.  You don't even know how many times she orgasmed; her pussy dribbled and gushed the entire time you were in her.");
                }
                //[PC not rider:
                else {
            ...
            //First repeat: 
            else if (this.flags[kFLAGS_1.kFLAGS.TIMES_RIDDEN_KELLY_FOR_PUNISHMENT] == 2) {
                ...
                this.outputText("</i>\" You step back to admire the effect.  Kelly stares back at you behind her leather straps and ball gag, her tasselled boobs forced outwards by her arms bound behind her back.  You laugh and stroke her face; she closes her eyes and bends into it, enjoying the simple motion of her [Master]'s hand.");
            ...
            //Second+ repeat: 
                ...
                if (this.player.tallness < 78 && !this.player.isTaur()) {
                    ...
                    this.outputText("\n\nYou lead her down a side alley - giving a hard look to the onlookers which makes most of them remember they have business elsewhere- and then, braced against her formidable weight, slowly dip your " + this.cockDescript(x) + " into her cunt until it is completely slathered in girl slime.  She sighs to the agonisingly gentle treatment and then gives out a muffled cry out of shock as you withdraw completely and, using the lubrication she provided, push into her tight asshole.");
        ...
        takeKellysVirginity() {
            ...
            if (x < 0)
                x = this.player.smallestCockIndex();
            this.outputText("You tell Kelly that you intend to come claim the prize you broke her for - her virgin ");
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] == 1)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] == 1)
                ...
                this.outputText("blooming, pink-tinged pussy");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] == 1)
                this.outputText(", equine");
            this.outputText(" cunt until her hymen is easily visible.  You rub every sensitive fold that you can get to");
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] == 1)
                this.outputText(", taking time to squeeze her plush, onyx vulva teasingly.  Kelly whinnies in response, overtaken by her potent equine instincts.");
            else
                this.outputText(", taking time to fondle her slick labia.  Kelly moans in response, overtaken by the sensations you're forcing through her.");
            ...
            if (!this.player.isTaur())
                this.outputText("get down behind her and line your " + this.cockDescript(x) + " with her dribbling lips.");
            else
                this.outputText("lie down behind her, sliding your hindlegs behind hers in order to properly align your " + this.cockDescript(x) + " with her dribbling lips.");
            this.outputText("  The first contact of " + this.player.cockHead(x) + " on her feminine mound sends an electric current of pleasure through your member, one that has you immediately and heedlessly pushing forward, sliding your full, sensitive phallus as deeply into that slick opening as you can.  That turns out not to be very far, as you almost immediately hit her virginal hymen.  It blocks off the rest of that hot, dripping hole almost spitefully.");
            this.outputText("\n\nYou squeeze Kelly's ");
            if (this.player.isTaur())
                this.outputText("breast as you snuggle up behind her, centaur to centaur,");
            else
                this.outputText("ass");
            this.outputText(" and laugh, \"<i>Here it comes, you eager whore!</i>\"  Then, you spear through her entrance with one powerful thrust.  In that second, her pussy somehow gets even hotter and warmer around your girth, and you sink yourself as deeply as you can");
            if (this.player.cockArea(x) <= 300) {
                this.outputText(", nestling your [sheath] up against her ");
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] == 1)
                    this.outputText("plump, equine cunt-lips");
                else
                    this.outputText("slippery, pink cunt-lips");
            }
            else
                this.outputText(", pressing your " + this.player.cockHead(x) + " up against the barrier her cervix makes");
            this.outputText(".  A pinkish froth oozes out around you, tinted by the few drops of blood that claiming her generated.  Kelly made a pained face as you took her, but now, she's back to panting and moaning like a whore.");
            this.outputText("\n\nYou pull on her tail as you begin to slide in and out, asking, \"<i>Did you like that, slut?  Does your cunt like being broken in by a real " + this.player.mf("man", "breeder") + "'s cock?</i>\"");
            this.outputText("\n\nKelly moans, \"<i>Y-yes!  My... pussy...  My pussy feels so good!  It's so good to be yours, [Master]!</i>\"  Her eyes cross slightly as her pussy begins to squeeze down around you, driven by instinctual desires the lust-crazed centauress barely understands.  She's been so conditioned to obey that when her body tells her to do something (like milk your " + this.cockDescript(x) + "), she doesn't question - she simply, deliciously complies, her pussy growing ever-wetter from her submissiveness.");
            ...
            if (this.player.cumQ() >= 500) {
                this.outputText("  You even have enough jism to make sure that some is squirting into her womb and drizzling out of her entrance, mixing with her clear fluids to make a runny, off-wet mess down her rump.");
                if (this.player.cumQ() >= 1500)
                    this.outputText("  In no time flat, her belly has begun to round slightly, puffed up with spunk.");
                if (this.player.cumQ() >= 3500)
                    this.outputText("  That doesn't stop you from seeding it even further, pumping her poor horse-gut until it jiggles and jostles with your spermy cargo.  There's no way she'll forget this.");
            }
            this.outputText("\n\nYou pull out with a self-satisfied sigh, admiring ");
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_CUNT_TYPE] == 0)
                this.outputText("the redness of her well-used cunt.");
            else
                this.outputText("the shining juices that drip from her oh-so-equine entrance, gilding the smooth onyx lips with a slimey sheen.");
            this.outputText("  Kelly has passed out in a puddle of her own making, and you leave her like that, getting dressed without a backwards glance.");
            this.kellyPreggers();
            this.player.orgasm();
        ...
        giveKellyAPepper() {
            this.clearOutput();
            //First: 
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_TIMES_PEPPERED] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.KELLY_BONUS_BOOB_ROWS] = 1;
                this.flags[kFLAGS_1.kFLAGS.KELLY_HEAT_TIME] = 48;
            }
            //Repeat:
            else {
                this.outputText("You grin and dangle the pepper in front of Kelly's face wordlessly.  The centauress knows what's coming and color spreads across her cheeks; however, she still opens wide and accepts the \"<i>gift</i>\", chewing slowly and swallowing.");
                //If no second row:
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_BONUS_BOOB_ROWS] == 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.KELLY_TIMES_PEPPERED]++;
        ...
        kellyTitJob() {
            ...
            //Dick >17 inches, Kelly has four breasts:
                ...
                this.outputText("  Her expression is one of deep concentration and as you quicken the pace and thrust further upwards she bends her chin to lick at your head as it presents itself between her pressed together tits.");
        ...
        kellyPreggers() {
            if (this.pregnancy.isPregnant)
                return;
            var x = Math.round(this.player.cumQ() / 20);
            if (x > 80)
                x = 80;
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_HEAT_TIME] > 0)
                x += 15;
            if (Kelly.rand(100) + 1 <= 80) {
                this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, PregnancyStore_1.PregnancyStore.INCUBATION_CENTAUR - 84);
                console_1.trace("Kelly knocked up.");
            }
        }
        //Sex scene
        ...
        kellyPopsOutARunt() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS] == 0)
                this.flags[kFLAGS_1.kFLAGS.KELLY_FIRST_KID_GENDER] = gender;
            this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS]++;
            if (gender == 1)
                this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS_MALE]++;
        }
        //Talk n Hand
        talkNHandToKelly() {
            this.clearOutput();
            //First: You tell her you'd just like to talk.
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_TALK_N_HAND_TIMES] == 0) {
                ...
                if (!this.player.isTaur()) {
                    ...
                    if (this.player.cockTotal() == 1)
                        this.outputText("[oneCock], gently tugging it.  It quickly hardens with the pleasing friction she coils around it.");
                    else
                        this.outputText("first your [cock], then your [cock 2], gently tugging until they are both hard from the pleasing friction she coils around them.");
                }
                //Centaur:
                else {
                    this.outputText("You leisurely clop yourself around so your back end is facing her and sigh as ");
                    if (this.player.cockTotal() == 1)
                        this.outputText("a warm hands wraps itself around your [cock] and then begins to gently tug, quickly hardening it with pleasing coils of friction.");
                    else
                        this.outputText("a warm hand wraps around first your [cock] and then your [cock 2] before beginning to gently tug, both quickly hardening from the pleasing coils of friction.");
                }
            }
            //Repeat: 
            else {
                ...
                if (!this.player.isTaur()) {
                    this.outputText("slides off the lower half of your [armor] as you set yourself down and then grasps your cock");
                    if (this.player.cockTotal() > 1)
                        this.outputText("s");
                    this.outputText(" with her soft hands.  You sigh as she begins to gently pump, making ");
                    if (this.player.cockTotal() > 1)
                        this.outputText("them");
                    else
                        this.outputText("it");
            ...
            this.flags[kFLAGS_1.kFLAGS.KELLY_TALK_N_HAND_TIMES]++;
            //(Randomly generated)
            var temp = Kelly.rand(5);
            //1.
            if (temp == 0) {
                ...
                if (this.player.cor < 70)
                    this.outputText("  Plus, the thought of making Kelt's victims pay the price for his own crimes makes you feel uncomfortable.");
                this.outputText("  You tell Kelly you appreciate the thought as you pick yourself up and leave, but you think you need to save your energy and cum for the really special case that she is.  The centaur shivers with glee.");
            ...
            //2. 
                ...
                if (this.player.cockTotal() > 1)
                    this.outputText(" and [cock 2]");
                this.outputText(".  \"<i>Of course I can never repay you for what you've done for me.  I wasn't thinking.</i>\"");
            ...
            //3.
                ...
                if (!this.player.isTaur())
                    this.outputText("into the air");
                else
                    this.outputText("onto the ground");
                this.outputText(".  Kelly nuzzles your [cocks] when you're done, slurping obscenely as she polishes your nobhead");
                if (this.player.cockTotal() > 1)
                    this.outputText("s");
            ...
            //4.
                ...
                if (this.player.balls == 0)
                    ...
                    this.outputText("suckles and laps at your [balls] for a time");
                this.outputText(".  It's a beautiful tactic - the sound and sensation is wonderful but it also cools your cock down just a bit.");
                ...
                this.outputText(", I'm a hundred times happier.  I just used a demon's curse to get my way - you did it all on your own.  You showed me what true strength and dominance is, [Master]!</i>\"");
        ...
        rewardKelly() {
            this.flags[kFLAGS_1.kFLAGS.KELLY_REWARD_COOLDOWN] = 1;
            this.clearOutput();
            //First time: 
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_TIMES_REWARDED] == 0) {
            ...
            //Repeat:
                ...
                this.outputText("Kelly holds her head up proudly as you inspect her, running your hand slowly over her backside.   It's nice and smooth.  You smile at her benevolently and tell her that since she's been such a good cumslut, you're going to reward her.  She claps excitedly.");
                this.outputText("  \"<i>Hurray!</i>\"");
            }
            this.flags[kFLAGS_1.kFLAGS.KELLY_TIMES_REWARDED]++;
            ...
            if (this.player.hasItem(this.consumables.BLACK_D) && this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] != "sable black")
                this.addButton(1, "Black Dye", this.dyeKellysBitchAssHair, this.consumables.BLACK_D);
            if (this.player.hasItem(this.consumables.BLOND_D) && this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] != "slutty blonde")
                this.addButton(2, "Blond Dye", this.dyeKellysBitchAssHair, this.consumables.BLOND_D);
            if (this.player.hasItem(this.consumables.PURPDYE) && this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] != "garish purple")
                this.addButton(3, "Purple Dye", this.dyeKellysBitchAssHair, this.consumables.PURPDYE);
            if (this.player.hasItem(this.consumables.PINKDYE) && this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] != "bright pink")
                this.addButton(4, "Pink Dye", this.dyeKellysBitchAssHair, this.consumables.PINKDYE);
            if (this.player.hasItem(this.consumables.BROWN_D) && this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] != "chestnut brown")
        ...
        dyeKellysBitchAssHair(color) {
            this.clearOutput();
            this.outputText("You tell her you've brought her a gift as you rummage around in your pockets.  Kelly looks apprehensive but pleasant surprise forms on her face when she catches the small vial of dye you throw at her.");
            this.outputText("\n\n\"<i>Oh wow, thanks [Master]! It's been ages since I did my hair.");
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_TIMES_DIED_HAIR] == 0) {
                this.outputText("</i>\"\n\nShe stops and thinks.  \"<i>In fact, I don't think I've ever done my hair.  ");
            }
            this.outputText("This'll be so much fun!</i>\"  You walk over to the barn with her and pour some water into a wide bucket.  She lets down her braid and you spend a pleasant quarter of an hour or so helping her work the sharp-smelling substance into her long, luscious hair.  When you're done, you step back to admire the effect.  Amazingly the color is not only sinking into her hair but also into her tail, her demon spade slowly bleaching with the hue you chose.");
            this.flags[kFLAGS_1.kFLAGS.KELLY_TIMES_DIED_HAIR]++;
            //Black dye:
            if (color == this.consumables.BLACK_D) {
                ...
                this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] = "sable black";
            ...
            //Blonde dye: 
                ...
                this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] = "slutty blonde";
            }
            //Purple dye: 
                ...
                this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] = "garish purple";
            ...
            //Pink dye:
                ...
                this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] = "bright pink";
            }
        ...
        giveKellyAppleSauce() {
            this.clearOutput();
            //First time:
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_TIMES_APPLESAUCED] == 0) {
                this.outputText("You tap your chin idly and ask Kelly what she likes eating.  Aside from dick, you add, rolling your eyes as she opens her mouth eagerly.");
                ...
                if (!this.farm.farmCorruption.whitneyCorrupt())
                    this.outputText(" \"<i>I'd like to go and check on it, but... I don't think Whitney likes me much anymore.  I'd hate to cause more trouble than I already have.</i>\"");
                else
                    this.outputText("“<i>I'd like to go and check on it, but... I’d hate to get into Mistress Whitney’s bad books.  I’ve caused enough trouble already.</i>”");
                this.outputText(" You 'pfft' and wave your hand airily to show what YOU think of Whitney.  You tell her to stay put - as her treat, you'll go check on the orchard and bring back some apples for her, if there are any.");
                ...
                if (!this.player.isTaur()) {
                    this.outputText("You remove the bottom half of your [armor] and grip your [cock].  You close your eyes, begin to stroke yourself and sigh as you think of Kelly- her fine, bountiful curves, her cute, dimpling face, how she unconsciously licks her cock-sucking lips when she sees you coming, how she begs for it, how sweetly she moans when you thrust deep into her tight, wet holes... your body clenches as you orgasm, spurting streamer after streamer of spunk into the apple mash.");
                    if (this.player.hasVagina())
                    ...
                    if (this.player.cumQ() >= 750)
                        this.outputText("  The bowl quickly begins to brim as your [cock] torrents out cum, and eventually you have to turn away, grunting out the last jets of filth into the undergrowth.");
                }
                //[Centaur:]
                else {
                    this.outputText("You position your lower half over the bowl.  Your [cock] is already semi-turgid with the idea of what you're going to do, and it begins to bulge as you close your eyes, sigh and think of Kelly- her fine, bountiful curves, her cute, dimpling face, how she unconsciously licks her cock-sucking lips when she sees you coming, how she begs for it, how sweetly she moans when you thrust deep into her tight, wet holes... your body clenches as you orgasm, spurting streamer after streamer of spunk into the apple mash.");
                    if (this.player.hasVagina())
                        this.outputText("\n\nYour [vagina] quivers and clenches, and gasping with the dual orgasm which is clutching your body you stand over the bowl and let some of your femcum drip into it.  Taste my summer flavor Kelly, you think wildly, and laugh with a slightly manic edge.");
                    //[High cum:
                    if (this.player.cumQ() >= 750)
                        this.outputText("  Your [cock] torrents out cum, and eventually you have to clop away, grunting out the last jets of filth onto the ground to avoid overflowing the bowl.");
                }
            ...
            //Repeat:
                ...
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS] > 1)
                    this.outputText("  Somebody has even cleared an oblong patch of earth alongside the trees- a piece of card stuck into it is scrawled with a childish hand which declares it to be “CAROTS”.  You marvel at it all.  Who would have imagined your lust for horse pussy would have turned a pointless asshole into a loving mother who gardens with her children?  Really, you deserve a medal for your efforts.");
                ...
                if (!this.player.isTaur()) {
                    this.outputText("grasp your semi-turgid cock and drift into a fond reverie of Kelly- the way her boobs bounce when she canters towards you, the way her green eyes burn when they fall upon your [eachCock], the way she gasps when you slap her ass, how sweetly she moans when you thrust deep into her tight, wet holes, the galaxy of filthy things you still have left to do to her....  Your body clenches as you orgasm, spurting streamer after streamer of spunk into the apple mash.");
                    if (this.player.hasVagina())
                        this.outputText("  Your [vagina] quivers and clenches, and once again, gasping with the dual orgasm which is clutching your body, you stand over the bowl and let some of your femcum drip into it.");
                    //[High cum:
                    if (this.player.cumQ() >= 750)
                        this.outputText("  The bowl quickly begins to brim as your [cock] torrents out cum, and eventually you have to turn away, grunting out the last jets of filth into the undergrowth.");
                }
                ...
                if (this.silly())
                    this.outputText("  Parsley, sage, rosemary and c...");
                this.outputText("  Ooh!</i>\"  You slap her ass and grab her around her supple, human waist as you pass her.  Laughing, you walk into the barn together.");
            }
            //[merge]
            var x = this.player.cockThatFits(300);
            var y = this.player.cockThatFits2(300);
            //Not Centaur: 
            if (!this.player.isTaur()) {
                ...
                this.outputText(".  Did she cum already?  It's fortunate you've already taken the edge off, because you're not sure how long you would otherwise be able to last against her impossibly turned on, sucking, clinching pussy.  As it is... you grip her huge, muscled backside and pull yourself almost all the way out of her fleshy pocket then spear your way in again, steadily in and then out, working your way into a slow, sensual rhythm.  Ahead of you Kelly's head sinks and bobs, and your ears are full of her wet, muffled chews, gulps and moans as she gorges herself on your sweet, sticky sex whilst you gently fuck her.");
                //1 < cock:
                if (y >= 0) {
                    this.outputText("\n\nYour eyes fasten upon her tight, puckered asshole as lust grips you closer, a tiny puddle of human pink buried in her heaving brown horse flesh.  Your breath coming heavily now you withdraw your " + this.cockDescript(x) + " from her wet softness, dripping with her lubrication.  Quickly you push it against her puckered anus whilst lining up your " + this.cockDescript(y) + " with her gaping vagina.");
                    this.outputText("\n\nYou wait for Kelly's head to descend towards the bowl again and then thrust forward, penetrating both her holes at the same time.  She cries out from the intense sensation and then bucks back into you, helping you sink your " + this.cockDescript(x) + " deeper and deeper into her ass, spreading her deliciously tight anal passage whilst your " + this.cockDescript(y) + " slides effortlessly into the fleshy folds of her cunt.  You slap her ass exultantly, making her squeak again, as you find your limit before resuming the same rhythm, fucking both her sopping vagina and tight, hot ass now with deep, slow strokes.");
                }
                ...
                this.outputText("\n\nWith her head thrown back it's easy for you to grip her " + this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] + " braid and use it for leverage as you fuck into her with everything you've got, bucking into her tight, hot flesh ");
                if (this.player.balls > 0)
                    this.outputText(", your [balls] slapping into her thighs demandingly ");
                this.outputText("as you push towards your reward.  Panting, Kelly thrusts back into you as best she can, resisting your frenetic tugs to her hair so that the big, final slather of apple sauce can slide out of the bowl and into her mouth.  She screams around the wet, gooey mouthful and her vagina quivers and seizes your bulging " + this.cockDescript(x) + " in milking ripples");
                if (y >= 0)
            ...
            //Centaur: 
                ...
                if (this.player.cocks[x].cockThickness >= 4)
                    this.outputText("  Your girth spreads her fuck tunnel wide and you grunt at the delicious tightness of it as you pack her full of cock.");
                this.outputText("\n\n\"<i>Oh [Master]...</i>\" Kelly groans, arching her head back from her feed so it spoons into your neck.  A series of clenches grip your " + this.cockDescript(x) + " and a sudden gush of fluid warms your ");
                if (this.player.balls > 0)
                    this.outputText("[balls]");
                else
                    this.outputText("thighs");
                this.outputText(".  Did she cum already?  It's fortunate you've already taken the edge off, because you're not sure how long you would otherwise be able to last against her impossibly turned on, sucking, clinching pussy.  As it is, you grip her muscled backside with your own huge hindquarters and pull yourself almost all the way out of her fleshy pocket before spearing your way in again, steadily in and then out, working your way into a slow, sensual rhythm.  Kelly's head sinks and bobs in front of you, and your ears are full of her wet, muffled chews, gulps and moans as she gorges herself on your sweet, sticky sex whilst you gently hump her.");
                //1 < cock:
                if (y >= 0) {
                    this.outputText("\n\nYou think about her tight, puckered asshole beneath you as lust grips you closer, a tiny puddle of human pink buried in her heaving brown horse flesh.  Your breath coming heavily now you withdraw your " + this.cockDescript(x) + " from her wet softness, dripping with her lubrication.  Quickly you push it against her puckered anus whilst lining up your " + this.cockDescript(y) + " with her gaping vagina.  You wait for Kelly's head to descend towards the bowl again and then thrust forward, penetrating both her holes at the same time.  She cries out from the intense sensation and then bucks back into you, helping you sink your " + this.cockDescript(x) + " deeper and deeper into her ass, spreading her deliciously tight anal passage whilst your " + this.cockDescript(y) + " slides effortlessly into the fleshy folds of her cunt.  You grab one of her soft tits and squeeze exultantly, making her squeak again, as you find your limit before resuming the same rhythm, fucking both her sopping vagina and tight, hot ass now with deep, slow strokes.");
                }
                ...
                this.outputText("\n\nYou grip her " + this.flags[kFLAGS_1.kFLAGS.KELLY_HAIR_COLOR] + " braid and force her head to arch back before pushing the bowl against her lips, tipping the last of the green sweet down her gullet whilst you begin to fuck into her with everything you've got, bucking into her tight, hot flesh");
                if (this.player.balls > 0)
                    this.outputText(", your [balls] slapping into her thighs demandingly");
                this.outputText(" as you push towards your reward.");
                this.outputText("\n\nPanting, Kelly thrusts back into you as best she can, resisting your frenetic tugs to her hair so that the big, final slather of apple sauce can slide out of the bowl and into her mouth.  She screams around the wet, gooey mouthful and her vagina quivers and seizes your bulging " + this.cockDescript(x) + " in milking ripples");
                if (y >= 0)
                    this.outputText(" as her anus clenches around your " + this.cockDescript(y));
                this.outputText(".  With a wordless shout, you tense up and orgasm in tandem, surging line after line of glorious into her wet, churning depths, lost to the ageless sensation of filling a breeding mare's holes with thick seed for what seems like blissful oceans of time.");
            }
            //[merge]
            this.outputText("\n\nYou pool onto the floor when you are finished, ");
            if (this.player.isBiped())
                this.outputText("giving at the knees, ");
            this.outputText("your aching cock still weakly clenching.  In a beatific daze you listen to the sound of a tongue eagerly exploring every inch of a metal surface, before a bowl hits the ground.  A hand is offered to you and woozily you take it.  As soon as you are up Kelly pulls you into a fervent, passionate kiss, her soft lips pushing into yours.  The smell of apples envelops you.  You tense for a moment but decide to allow it.  It's her treat, after all.");
            this.outputText("\n\nYou bend your head, sink your fingers into her hair and gently tangle your tongue with hers.  ");
            if (this.player.cor < 60)
                this.outputText("The taste of cum glazing her apple breath is off-putting but what did you really expect?");
            else
                this.outputText("You don't like to admit it but you do taste pretty good, even to yourself.  You push your tongue further into Kelly's mouth hungrily, working your jaw as you savage her mouth with your lips and tongue in search of that fruity, horny flavour, making her 'mmm' with delight and respond in kind.");
            //First:
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_TIMES_APPLESAUCED] == 0) {
                this.outputText("\"<i>That was the best treat ever [Master],</i>\" she murmurs when you break away, gazing into your eyes lovingly.  \"<i>I liked apples but never quite as much as that.  Wow.</i>\"  You hold her face and say she should look after that orchard: who knows, maybe she'll be good enough to deserve a second helping.  Kelly smiles eagerly.");
            ...
            //Repeat:
                ...
                this.outputText("\"<i>That tastes better every time you make it [Master],</i>\" she purrs when you break away, gazing into your eyes lovingly.  \"<i>You should go into business with it.</i>\"  You grin at the idea and say who knows?  Maybe Mareth will eventually behave well enough to appreciate it as much as she does.  \"<i>I long for that day every moment of every day,</i>\" your slave replies fervently, stroking the hand you're holding her face with.");
        ...
        kellyBJsAhoy() {
            ...
            if (!this.player.isTaur()) {
                ...
                if (this.player.hasVagina())
                    this.outputText("  You're in no hurry, and with a slight roll of your [hips] you direct her to start at the back and work her way up.");
                //Vagina and balls: 
                if (this.player.balls > 0 && this.player.hasVagina()) {
                    ...
                    if (this.player.ballSize <= 8) {
                        ...
                        this.outputText(", then back to the first one, a slow and sensual repetition.  She moans intermittently as she does it, and you're not sure if it's intentionally to send delightful shivers of sensation through your scrotum and up the spine of [eachCock], or it's simply because the sheer degradation of the act fills her with deep, shameful lust.  Supporting her soft, ");
                        if (this.pregnancy.isPregnant)
                            this.outputText("milk-laden ");
                        this.outputText("breasts whilst slavishly polishing the [balls] of the " + this.player.mf("man", "woman") + " who made her into, well, a ball-licking bitch.  Whatever the cause the result is the same: pleasure thrums through your groin and up your [cock biggest], and you close your eyes, lost to the sensations of her skillful tongue.");
                    }
                    //[Huge balls:
                    else {
                        ...
                        if (this.player.balls > 2)
                            this.outputText(", then the third, then the fourth");
                        this.outputText(", then back to the first one, a slow and sensual repetition.  The warm air is punctuated with desperate 'ahh, ahn, ahh's as she surrenders herself to the deep, shameful lust of the act, supporting her soft");
                        if (this.pregnancy.isPregnant)
                            this.outputText(", milk laden");
                        this.outputText(" breasts whilst slavishly polishing the [balls] of the " + this.player.mf("man", "woman") + " who made her into, well, a ball-licking bitch.");
                        //[Dominika dreams:
                        if (this.flags[kFLAGS_1.kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] > 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00150] > 0)
                            this.outputText("  You are gripped by a sudden but thrilling velvet-edged sense of déjà vu.  Has this scene not repeated somewhere else?");
                    }
                }
                //Vagina:
                else if (this.player.hasVagina()) {
                ...
                //Balls:
                    ...
                    //[Normal balls:]
                    if (this.player.ballSize <= 8) {
                        this.outputText("After curling her tongue here and there over each sensitive orb, bathing them in saliva, she envelops each one in her mouth, sucking gently first one, then the second");
                        if (this.player.balls >= 4)
                            this.outputText(", then the third, then the fourth");
                        this.outputText(", then back to the first one, a slow and sensual repetition.  She moans intermittently as she does it, and you're not sure if it's intentionally to send delightful shivers of sensation through your scrotum and up the spine of [eachCock], or it's simply because the sheer degradation of the act, supporting her soft, ");
                        if (this.pregnancy.isPregnant)
                            this.outputText("milk-laden ");
                        this.outputText("breasts whilst slavishly polishing the [balls] of the " + this.player.mf("man", "woman") + " who made her into, well, a ball-licking bitch, fills her with deep, shameful lust.  Whatever the cause, the result is the same: pleasure thrums through your groin and up your [cock biggest], and you close your eyes, lost to the sensations of her skillful tongue.");
                    }
                    //Huge balls:
                    else {
                        this.outputText("After curling her tongue here and there over each sensitive orb, bathing them in saliva, she attempts to envelop one in her mouth.  She can't though; your testicles, bulging and tight with arousal, are simply too big.  After a short pause she goes back to licking them, lapping at their surface tenderly, licking all around each one for every trace of salt and musk, wetly caressing first one, then the second");
                        if (this.player.balls >= 4)
                            this.outputText(", then the third, then the fourth");
                        this.outputText(", then back to the first one, a slow and sensual repetition.  The warm air is punctuated with desperate 'ahh, ahn, ahh's as she surrenders herself to the deep, shameful lust of the act, supporting her soft ");
                        if (this.pregnancy.isPregnant)
                ...
                if (this.player.biggestCockLength() > 15)
                    this.outputText("It's a long way up and the effect is like a lift slowly rising, turning on a glow of lights on each level as it goes.  ");
                this.outputText("Finally she reaches your [cockHead biggest], and after resting her lips on your crown for a short time, moving them ever-so-gently to tantalize the most sensitive part of your bulging erection, she opens wide and envelops you, gripping the end of your dick in a soft, wet cave of shifting pleasure.  She slowly impales herself on it, her plump lips encapsulating more and more of your dick in sucking mouth flesh, and then it recedes, eventually even retreating from the crown as she goes back to licking and kissing the length.");
            ...
            //Centaur:
                ...
                this.outputText("  Finally, after about a minute of this tender torture, you hear her groan from deep within her throat.");
                this.outputText("\"<i>Please [Master], let me swallow you, let me taste your strength, let me feel like a slut should,</i>\" she begs. \"<i>I'll make it so good for you you'll never want anyone else, just like I will never want anyone else.  Just... let me drink your cum!</i>\"");
                ...
                if (this.player.cockTotal() > 1 || this.player.hasVagina())
                    this.outputText("  You're in no hurry, and with a slight roll of your [hips] you direct her to start at the front and work her way down.");
                //Vagina and balls:
                if (this.player.hasVagina() && this.player.balls > 0) {
                    ...
                    if (this.player.ballSize <= 8) {
                        ...
                        if (this.pregnancy.isPregnant)
                            this.outputText(", milk-laden");
                        this.outputText(" breasts whilst slavishly polishing the [balls] of the centaur who made her into, well, a ball-licking bitch.  Whatever the cause the result is the same.  Pleasure thrums through your groin and up your [cock biggest] and you close your eyes, lost to the sensations of her skillful tongue.");
                    }
                    //[Huge balls:
                    else {
                        this.outputText("\n\nAfter curling her tongue here and there over each sensitive orb, bathing them in saliva, she attempts to envelop one in her mouth.  She can't though - your testicles, bulging and tight with arousal, are simply too big.  After a short pause she goes back to licking them, lapping at their surface tenderly, licking all around each one for every trace of salt and musk, wetly caressing first one, then the second");
                        ...
                        if (this.pregnancy.isPregnant)
                            this.outputText(", milk laden");
                        this.outputText(" breasts whilst slavishly polishing the [balls] of the centaur who made her into, well, a ball-licking bitch.");
                        if (this.flags[kFLAGS_1.kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] > 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00150] > 0)
                            this.outputText("  You are gripped by a sudden but thrilling, velvet-edged sense of déjà vu.  Has this scene not repeated somewhere else?");
                    }
                }
                ...
                //Balls: 
                    ...
                    if (this.player.ballSize <= 8) {
                        ...
                        if (this.pregnancy.isPregnant)
                            this.outputText(", milk-laden");
                        this.outputText(" breasts whilst slavishly polishing the [balls] of the centaur who made her into, well, a ball-licking bitch, fills her with deep, shameful lust.  Whatever the cause the result is the same; pleasure thrums through your groin and up your [cock biggest] and you close your eyes, lost to the sensations of her skillful tongue.");
                    }
                    //[Huge balls:
                    else {
                        this.outputText("  After curling her tongue here and there over each sensitive orb, bathing them in saliva, she attempts to envelop one in her mouth.  She can't though - your testicles, bulging and tight with arousal, are simply too big.  After a short pause, she goes back to licking them, lapping at their surface tenderly, licking all around each one for every trace of salt and musk, wetly caressing first one, then the second");
                ...
                //[Cock >15 inches:
                if (this.player.biggestCockLength() > 15) {
                    this.outputText("  It's a long way down and the effect is like a lift slowly descending, turning on a glow of lights on each level as it goes.");
                }
                this.outputText("  Finally she reaches your [cockHead biggest], and after resting her lips on your crown for a short time, moving them ever-so-gently to tantalize the most sensitive part of your bulging erection, she opens wide and envelops you, gripping the end of your dick in a soft, wet cave of shifting pleasure.  She slowly impales herself on it, her plump lips encapsulating more and more of your dick in sucking mouth flesh... and then it recedes, eventually even retreating from the crown as she goes back to licking and kissing the length.");
                ...
                if (this.player.balls > 0)
                    this.outputText(", as you feel your [balls] clench");
                this.outputText(", you pull out and point your [cock biggest] downwards.  She 'aww's in deep disappointment as the dick is torn away from her, but you shush her.");
                ...
                if (this.player.hasVagina())
                    this.outputText("pussy-licking, ");
                if (this.player.balls > 0)
                    this.outputText("ball-sucking ");
                this.outputText("cock addict, you will have to do a good job of catching it on those whore pillows of yours.</i>\"  With that, you thrust your hindquarters forward.  Her breathy groan is what you hear as orgasm clenches you.");
                this.outputText("\n\nYour cock slit dilates and you spurt out rope after rope of jizz");
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0)
                    this.outputText(" onto all four of her tits");
                this.outputText(".  The sensation of deep release is ecstatic, the sound of your cock cream spattering onto your slave's softness delicious.");
                //[Vagina:
                if (this.player.hasVagina())
                    this.outputText("  Your female sex clenches and orgasms in sympathy, and you feel fluid dribble down your [hips] as you continue to paint Kelly.  Your only dim regret is that there's no way of soaking her with that, too.");
                this.outputText("\n\nFinally you are spent.  You clop around to admire your handiwork.");
                //Low cum:
                if (this.player.cumQ() < 750)
                    this.outputText("  Kelly has done a sterling job of catching your load; you've frosted her boobs with long strokes quite convincingly.");
                else {
                    this.outputText("  As ever, your virility has gotten the better of you.  Kelly looks like she's in an ecstatic trance.  You've completely pasted not just ");
                    if (this.flags[kFLAGS_1.kFLAGS.KELLY_BONUS_BOOB_ROWS] > 0)
                        this.outputText("all four of ");
                    this.outputText("her boobs with alabaster ooze, but her stomach, face and hair.  She's holding a reservoir of the stuff in her cleavage.");
                }
            }
            //[merge]
            ...
            this.outputText(", saying you know she is, but it's a lot more pleasing to you to see her get her fix this way.  Quickly cottoning on, the centaur stares at you with her lustful green eyes as she lifts a cum-spattered boob to her mouth.");
