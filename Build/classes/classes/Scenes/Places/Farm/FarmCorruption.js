define(["require", "exports", "./AbstractFarmContent", "../../../GlobalFlags/kGAMECLASS", "../../../GlobalFlags/kFLAGS", "../../../../console", "../../../StatusAffects", "../../../../../includes/appearanceDefs"], function (require, exports, AbstractFarmContent_1, kGAMECLASS_1, kFLAGS_1, console_1, StatusAffects_1, appearanceDefs_1) {
    "use strict";
     ...
     * @author Gedan
     */
    class FarmCorruption extends AbstractFarmContent_1.AbstractFarmContent {
        constructor() {
            super(...arguments);
            this.slotNames = [
                "collarbone",
        ...
        whitneySprite() {
            this.farm.whitneySprite();
        }
        corruptFollowers() {
            var count = 0;
            if (kGAMECLASS_1.kGAMECLASS.jojoScene.campCorruptJojo())
                count++;
            if (kGAMECLASS_1.kGAMECLASS.amilyScene.amilyCorrupt())
                count++;
            if (kGAMECLASS_1.kGAMECLASS.izmaScene.izmaFollower())
                count++;
            if (kGAMECLASS_1.kGAMECLASS.sophieBimbo.bimboSophie())
                count++;
            if (kGAMECLASS_1.kGAMECLASS.vapula.vapulaSlave())
                count++;
            if (kGAMECLASS_1.kGAMECLASS.ceraphScene.ceraphIsFollower())
                count++;
            if (kGAMECLASS_1.kGAMECLASS.latexGirl.latexGooFollower())
                count++;
            return count;
        }
        whitneyCorruption(mod = 0) {
            if (mod != 0) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] += mod;
                // Track highest corruption value
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] > this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION_HIGHEST])
                    this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION_HIGHEST] = this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION];
            }
            // Cap the values into the appropriate range
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_APPROACHED_WHITNEY] == 0 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] > 30) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] = 30;
                console_1.trace("Whitney at 30 corruption clamp.");
            }
            else if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_LEAVE_0_60] == 0 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] > 60) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] = 60;
                console_1.trace("Whitney at 60 corruption clamp.");
            }
            else if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_LEAVE_61_90] == 0 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] > 90) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] = 90;
                console_1.trace("Whitney at 90 corruption clamp.");
            }
            else if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_MENU_91_119] == 0 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] > 119) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] = 119;
                console_1.trace("Whitney at 119 corruption clamp");
            }
            // Clamp values to valid min/max
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] < 0)
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] = 0;
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] >= 120) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION] = 120;
            }
            console_1.trace("Whitney corruption changed by " + String(mod));
            console_1.trace("Whitney corruption now at " + String(this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION]));
            return this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION];
        }
        whitneyCorrupt() {
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION_COMPLETE] > 0)
                return true;
            return false;
        }
        whitneyDom() {
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_DOM] == 1)
                return true;
            return false;
        }
        whitneyDefurred() {
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_DEFURRED] == 1)
                return true;
            return false;
        }
        whitneyHasTattoo() {
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_COLLARBONE] != '')
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_SHOULDERS] != '')
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_LOWERBACK] != '')
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_BUTT] != '')
                return true;
            return false;
        }
        whitneyCockArea() {
            console_1.trace("Update cock area with values from Vapulas dildo.");
            return 10 * 2;
        }
        whitneyVagCapacity() {
        ...
        whitneyMaxedOralTraining() {
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_ORAL_TRAINING] == 100)
                return true;
            return false;
        }
        ...
        updateFarmCorruption() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_DISABLED_FOR_DAY] == 1) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_DISABLED_FOR_DAY] = 2;
            }
            // Process queued farm upgrades
            // Breastmilkers
            if (this.flags[kFLAGS_1.kFLAGS.QUEUE_BREASTMILKER_UPGRADE] != 0 && this.player.hasKeyItem("Breast Milker - Installed At Whitney's Farm") < 0) {
                this.flags[kFLAGS_1.kFLAGS.QUEUE_BREASTMILKER_UPGRADE] = 0;
                this.player.createKeyItem("Breast Milker - Installed At Whitney's Farm", 0, 0, 0, 0);
            }
            // Cockmilkers
            if (this.flags[kFLAGS_1.kFLAGS.QUEUE_COCKMILKER_UPGRADE] != 0 && this.player.hasKeyItem("Cock Milker - Installed At Whitney's Farm") < 0) {
                this.flags[kFLAGS_1.kFLAGS.QUEUE_COCKMILKER_UPGRADE] = 0;
                this.player.createKeyItem("Cock Milker - Installed At Whitney's Farm", 0, 0, 0, 0);
            }
            // Contraceptives
            if (this.flags[kFLAGS_1.kFLAGS.QUEUE_CONTRACEPTIVE_UPGRADE] != 0) {
                this.flags[kFLAGS_1.kFLAGS.QUEUE_CONTRACEPTIVE_UPGRADE]++;
                if (this.flags[kFLAGS_1.kFLAGS.QUEUE_CONTRACEPTIVE_UPGRADE] > 7) {
                    this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_CONTRACEPTIVE] = 1;
                    this.flags[kFLAGS_1.kFLAGS.QUEUE_CONTRACEPTIVE_UPGRADE] = 0;
                }
            }
            // Refinery
            if (this.flags[kFLAGS_1.kFLAGS.QUEUE_REFINERY_UPGRADE] != 0) {
                this.flags[kFLAGS_1.kFLAGS.QUEUE_REFINERY_UPGRADE]++;
                if (this.flags[kFLAGS_1.kFLAGS.QUEUE_REFINERY_UPGRADE] > 3) {
                    this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_REFINERY] = 1;
                    this.flags[kFLAGS_1.kFLAGS.QUEUE_REFINERY_UPGRADE] = 0;
                }
            }
            // Milktank
            if (this.flags[kFLAGS_1.kFLAGS.QUEUE_MILKTANK_UPGRADE] != 0) {
                this.flags[kFLAGS_1.kFLAGS.QUEUE_MILKTANK_UPGRADE]++;
                if (this.flags[kFLAGS_1.kFLAGS.QUEUE_MILKTANK_UPGRADE] > 3) {
                    this.flags[kFLAGS_1.kFLAGS.QUEUE_MILKTANK_UPGRADE] = 0;
                    this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_MILKTANK] = 1;
                    this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_BATH_GIRL] = 1;
                    this.flags[kFLAGS_1.kFLAGS.MILK_SIZE] = 0;
                }
            }
            // Branding
            if (this.flags[kFLAGS_1.kFLAGS.QUEUE_BRANDING_UPGRADE] != 0) {
                this.flags[kFLAGS_1.kFLAGS.QUEUE_BRANDING_UPGRADE]++;
                if (this.flags[kFLAGS_1.kFLAGS.QUEUE_BRANDING_UPGRADE] > 2) {
                    this.flags[kFLAGS_1.kFLAGS.QUEUE_BRANDING_UPGRADE] = 0;
                    this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_BRANDING_MENU_UNLOCKED] = 1;
                    this.flags[kFLAGS_1.kFLAGS.QUEUE_BRANDING_AVAILABLE_TALK] = 1;
                }
            }
            // Orgyroom
            if (this.flags[kFLAGS_1.kFLAGS.QUEUE_ORGYROOM_UPGRADE] != 0) {
                this.flags[kFLAGS_1.kFLAGS.QUEUE_ORGYROOM_UPGRADE]++;
                if (this.flags[kFLAGS_1.kFLAGS.QUEUE_ORGYROOM_UPGRADE] > 7) {
                    this.flags[kFLAGS_1.kFLAGS.QUEUE_ORGYROOM_UPGRADE] = 0;
                    this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_ORGYROOM] = 2;
                }
            }
            ...
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] == 1)
                modValue += 2;
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 1 && kGAMECLASS_1.kGAMECLASS.sophieBimbo.bimboSophie())
                modValue += 1;
            // Izmael if (flags[kFLAGS.FOLLOWER_AT_FARM_IZMA] == 1) modValue += 1;
            // Bimbo if (flags[kFLAGS.FOLLOWER_AT_FARM_ISABELLA] == 1) modValue += 2;
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_VAPULA] == 1)
                modValue += 4;
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_LATEXY] == 1)
                modValue += 1;
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_HOLLI] > 0) {
                modValue += 4;
            }
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_KELLY] == 1)
                modValue += 2;
            this.whitneyCorruption(modValue);
            // Now figure out how many gems we're gonna get for the day
            this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_GEMS_WAITING] += this.farmValue();
            // If Amily is producing, stack up some milks to gib
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_AMILY] == 1 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_PRODUCTION_AMILY] == 1 && this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_REFINERY] == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_AMILY_GIBS_MILK] == 0)
                    this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_AMILY_GIBS_MILK] = 1;
                this.flags[kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED]++;
            }
            // If jojo is producing, stack up some drafts to gib
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] == 1 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_PRODUCTION_JOJO] == 1 && this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_REFINERY] == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO_GIBS_DRAFT] == 0)
                    this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO_GIBS_DRAFT] = 1;
                this.flags[kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED]++;
                if (kGAMECLASS_1.kGAMECLASS.jojoScene.tentacleJojo())
                    this.flags[kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED]++;
            }
            // If Sophie is producing, count up time since last egg and gib a new one when ready
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_SOPHIE] > 0 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_PRODUCTION_SOPHIE] == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.FARM_EGG_STORED] == 0) {
                    this.flags[kFLAGS_1.kFLAGS.FARM_EGG_COUNTDOWN]--;
                    if (this.flags[kFLAGS_1.kFLAGS.FARM_EGG_COUNTDOWN] == 0) {
                        this.flags[kFLAGS_1.kFLAGS.FARM_EGG_STORED] = 1;
                        this.flags[kFLAGS_1.kFLAGS.FARM_EGG_COUNTDOWN] = 7;
                    }
                }
            }
            // If Vapula is producing, stack up some milks to gib
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_VAPULA] == 1 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_PRODUCTION_VAPULA] == 1) {
                this.flags[kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED]++;
                if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_REFINERY] == 1)
                    this.flags[kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED]++;
                if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_VAPULA_GIBS_MILK] == 0)
                    this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_VAPULA_GIBS_MILK] = 1;
            }
            // Item caps
            if (this.flags[kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED] > 5) {
                this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_GEMS_WAITING] += (this.flags[kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED] - 5) * 3; // 3 extra gems per succumilk
                this.flags[kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED] = 5;
            }
            if (this.flags[kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED] > 5) {
                this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_GEMS_WAITING] += (this.flags[kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED] - 5) * 5; // 5 extra gems per incudraft (less of them produced etc)
                this.flags[kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED] = 5;
            }
            // If Latexy is at the farm, further modify her status values
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_LATEXY] == 1) {
                kGAMECLASS_1.kGAMECLASS.latexGirl.gooHappiness(-0.5, false);
                kGAMECLASS_1.kGAMECLASS.latexGirl.gooObedience(0.5, false);
            }
            // If Ceraph is doing her thing
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_CERAPH] > 0) {
                this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_CERAPH]++;
                if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_CERAPH] > 7)
                    this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_CERAPH] = -1;
            }
            // If Holli is doing her thing
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_HOLLI] > 0) {
                this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_HOLLI]++;
                if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_HOLLI] > 20)
                    this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_HOLLI] = -1;
            }
            // Contraceptives
            if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_CONTRACEPTIVE] == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.FARM_CONTRACEPTIVE_STORED] == 0)
                    this.flags[kFLAGS_1.kFLAGS.FARM_CONTRACEPTIVE_STORED] = 1;
            }
            // Increment days since last paid out
            this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_DAYS_SINCE_LAST_PAYOUT] += 1;
            return modValue;
        }
        collectTheGoodies() {
            this.clearOutput();
            // Get gems
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_DAYS_SINCE_LAST_PAYOUT] >= 7) {
                this.outputText("You stroll over to the big rock at the edge of the pepper patch, smiling as you see a small burlap sack shoved underneath a fold in the stone. You scoop it up, open it and count out " + this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_GEMS_WAITING] + " gems.\n\n");
                if (this.farmValue() < 25)
                    this.outputText(" You frown; it seems like a feeble amount for such a large operation. Perhaps you could talk to Whitney about that.\n\n");
                this.player.gems += this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_GEMS_WAITING];
                this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_GEMS_WAITING] = 0;
                this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_DAYS_SINCE_LAST_PAYOUT] = 0;
                kGAMECLASS_1.kGAMECLASS.showStats();
            }
            if (this.flags[kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED] > 0 || this.flags[kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED] > 0 || this.flags[kFLAGS_1.kFLAGS.FARM_EGG_STORED] > 0 || this.flags[kFLAGS_1.kFLAGS.FARM_CONTRACEPTIVE_STORED] > 0) {
                this.outputText("Your ‘farmers’ have been busy under the watchful eye of their assigned task mistress. A small bundle of goods have been stashed with the gems just awaiting your arrival.\n\n");
            }
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED] > 0) {
                this.outputText("<b>" + this.flags[kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED] + "x ");
                if (this.flags[kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED] == 1)
                    this.outputText("vial of Succubi milk.");
                else
                    this.outputText("vials of Succubi milk.");
                this.outputText("</b>\n");
                this.addButton(0, this.getItemObj(kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED).shortName, this.takeItems, kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED);
            }
            if (this.flags[kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED] > 0) {
                this.outputText("<b>" + this.flags[kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED] + "x ");
                if (this.flags[kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED] == 1)
                    this.outputText("vial of Incubi draft.");
                else
                    this.outputText("vials of Incubi draft.");
                this.outputText("</b>\n");
                this.addButton(1, this.getItemObj(kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED).shortName, this.takeItems, kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED);
            }
            if (this.flags[kFLAGS_1.kFLAGS.FARM_EGG_STORED] > 0) {
                this.outputText("<b>" + this.flags[kFLAGS_1.kFLAGS.FARM_EGG_STORED] + "x ");
                this.outputText("large " + this.flags[kFLAGS_1.kFLAGS.FOLLOWER_PRODUCTION_SOPHIE_COLORCHOICE] + " egg");
                if (this.flags[kFLAGS_1.kFLAGS.FARM_EGG_STORED] > 1)
                    this.outputText("s");
                this.outputText(".");
                this.outputText("</b>\n");
                this.addButton(2, this.getItemObj(kFLAGS_1.kFLAGS.FARM_EGG_STORED).shortName, this.takeItems, kFLAGS_1.kFLAGS.FARM_EGG_STORED);
            }
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CONTRACEPTIVE_STORED] > 0) {
                this.outputText("<b>" + this.flags[kFLAGS_1.kFLAGS.FARM_CONTRACEPTIVE_STORED] + "x ");
                this.outputText("bundle of Herbal Contraceptive.");
                this.outputText("</b>\n");
                this.addButton(3, this.getItemObj(kFLAGS_1.kFLAGS.FARM_CONTRACEPTIVE_STORED).shortName, this.takeItems, kFLAGS_1.kFLAGS.FARM_CONTRACEPTIVE_STORED);
            }
            this.addButton(9, "Back", this.rootScene);
        }
        getItemObj(flag) {
            if (flag == kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED)
                return this.consumables.SUCMILK;
            if (flag == kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED)
                return this.consumables.INCUBID;
            if (flag == kFLAGS_1.kFLAGS.FARM_EGG_STORED)
                return kGAMECLASS_1.kGAMECLASS.sophieBimbo.eggTypes[kGAMECLASS_1.kGAMECLASS.sophieBimbo.eggColors.indexOf(this.flags[kFLAGS_1.kFLAGS.FOLLOWER_PRODUCTION_SOPHIE_COLORCHOICE])];
            if (flag == kFLAGS_1.kFLAGS.FARM_CONTRACEPTIVE_STORED)
                return this.consumables.HRBCNT;
            console_1.trace("No valid argument given.");
        ...
        takeItems(flag) {
            ...
            if (flag == kFLAGS_1.kFLAGS.FARM_EGG_STORED)
                this.flags[kFLAGS_1.kFLAGS.FARM_EGG_COUNTDOWN] = 7;
            this.flags[flag]--;
            this.inventory.takeItem(item, this.afterTakeItems);
        }
        afterTakeItems() {
        ...
        farmProtection() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] == 1)
                protection += 2;
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 1) {
                if (kGAMECLASS_1.kGAMECLASS.sophieBimbo.bimboSophie())
                    protection += 1;
                else
                    protection += 2;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_ISABELLA] == 1) {
                protection += 3;
                // Bimbo = 2
            }
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_VAPULA] == 1)
                protection += 2;
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_KELLY] == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] >= 4)
                    protection += 1;
                else
                    protection += 2;
            }
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_MARBLE] == 1)
                protection += 2;
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_BATH_GIRL] == 1) {
        ...
        farmValue() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION_COMPLETE] == 1)
                fValue *= 1.25;
            return fValue;
        }
        takeoverPrompt() {
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_DISABLED] == 1)
                return false;
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_STARTED] == 1) {
                this.farmMenu();
                return true; // Hook the corrupt menu here
            }
            if (this.player.cor >= 70 && this.corruptFollowers() >= 2 && this.player.level >= 12) {
                if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPT_PROMPT_DISPLAY] == 0) {
                    this.clearOutput();
                    if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] >= 4) {
                        this.takeoverPromptKelly();
                    }
                    else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleRapeAttempted) >= 0) {
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPT_PROMPT_DISPLAY] == 3 || this.flags[kFLAGS_1.kFLAGS.FARM_DISABLED] == 1) {
                    this.clearOutput();
                    this.takeoverPromptMerge();
                    return true;
                }
                else {
                    this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPT_PROMPT_DISPLAY]++;
                    return false;
                }
            }
            return false;
        ...
        takeoverPromptKelly() {
            ...
            if (kGAMECLASS_1.kGAMECLASS.amilyScene.amilyCorrupt() || kGAMECLASS_1.kGAMECLASS.jojoScene.campCorruptJojo()) {
                this.outputText(" and the rodent slut");
                if (kGAMECLASS_1.kGAMECLASS.amilyScene.amilyCorrupt() && kGAMECLASS_1.kGAMECLASS.jojoScene.campCorruptJojo()) {
                    this.outputText("s");
                }
                this.outputText(" before him");
            }
            this.outputText("?");
        }
        ...
        takeoverPromptMerge(firstTime = false) {
            this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPT_PROMPT_DISPLAY] = 1;
            if (firstTime) {
                ...
                this.outputText("Again, you find yourself standing on the bluff overlooking the farm, and you feel yourself filled with unholy rage at the woman below who stands against you and your plans for this piece of property. Do you put your plan into motion now or later?");
            }
            this.menu();
        ...
        takeoverPromptNow() {
            this.clearOutput();
            this.outputText("You stride down to the farm and leap over a gate. You move casually, swaggering towards the pepper field with no obvious intent. When Whitney spots you and slowly stands up from her weeding, you raise your hand in friendly greeting");
            if (this.player.weaponName != "fists")
                this.outputText(", and to demonstrate your peacefulness, you theatrically hold up your [weapon] and then discard it with a careless swing of your arm.");
            else
                this.outputText(".");
            // if PC has Kelly or PC raped Marble
            if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] >= 4 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleRapeAttempted) >= 0) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] >= 4 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleRapeAttempted) >= 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] >= 4)
                    this.outputText(" Kelt");
                else
                    this.outputText(" Marble");
                this.outputText(" I cannot properly protect the place, so maybe I do need... insurance.</i>” She spits the last word. “<i>Just so long as you stay the fuck away from me, I will do as you say.</i>” You beam.");
            }
            else {
                // if Marble is at the Farm
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleRapeAttempted) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble) < 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_STARTED] = 1;
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble) < 0)
                this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_MARBLE] = 0; // Don't have to care about recruitment paths -- she'll fuck off based on corruption before the player can corrupt the farm.
        ...
        rootScene() {
            ...
            if (!this.whitneyCorrupt()) {
                this.outputText("You stand on the rise you’ve taken to using to look down on the farm which you are invested in.");
                if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_REFINERY] == 1)
                    this.outputText(" A large machine, bulky and rotund with a conical top, has been built into the milking barn. Fat pipes crawl up onto the roof from it like metal ivy, and white smoke billows busily out of its whistle chimney.");
                if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_CONTRACEPTIVE] == 1)
                    this.outputText(" Next to the pepper patch another crop has been planted, a field of verdant green shrubs. Their thin stems bob idly in the breeze.");
                if (this.flags[kFLAGS_1.kFLAGS.QUEUE_ORGYROOM_UPGRADE] > 1) {
                ...
                this.outputText("You stand on your rise and take in your slave farm. ");
                if (this.silly()) {
                    this.outputText(this.player.mf("You feel an irresistible hankering for a cigar.", "You feel an irresistible hankering for a cigarette holder."));
                }
                if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_REFINERY] == 1)
                    this.outputText(" A large machine, bulky and rotund with a conical top, has been built into the milking barn. Fat pipes crawl up onto the roof from it like metal ivy, and white smoke billows busily out of its whistle chimney.");
                if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_CONTRACEPTIVE] == 1)
        ...
        farmMenu() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_DISABLED_FOR_DAY] != 1) {
                if (!this.whitneyCorrupt())
                    this.addButton(0, "Whitney", this.dogeNotCorruptYet);
                else
                    this.addButton(0, "Whitney", this.dogeCorruptedMissionComplete);
            }
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleRapeAttempted) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.Marble) >= 0 && this.flags[kFLAGS_1.kFLAGS.MARBLE_WARNING] == 0)
                this.addButton(1, "Marble", this.farm.meetMarble);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Kelt) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.KeltOff) < 0) {
                if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] >= 4)
                    this.addButton(2, "Kelly", this.farm.kelly.breakingKeltOptions);
                else if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] == 0 && this.flags[kFLAGS_1.kFLAGS.KELT_TALKED_FARM_MANAGEMENT] == 0)
                    this.addButton(2, "Kelt", this.keltAChangeInManagement);
                else
                    this.addButton(2, "Kelt", this.farm.kelly.breakingKeltOptions);
            }
            if (this.player.hasKeyItem("Breast Milker - Installed At Whitney's Farm") >= 0) {
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Milked) >= 0) {
            ...
            if (this.slavesAtFarm())
                this.addButton(6, "Slaves", this.slavesAtFarmMenu);
            if (this.loversAtFarm())
                this.addButton(7, "Lovers", this.loversAtFarmMenu);
            if (this.followersAtFarm())
                this.addButton(8, "Followers", this.followersAtFarmMenu);
            this.addButton(9, "Leave", this.camp.returnToCampUseOneHour);
        }
        corruptingTheFarmExplore() {
            this.menu();
            this.addButton(0, "Explore", this.farm.exploreFarm);
            this.addButton(1, "Work", this.farm.workFarm);
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_DAYS_SINCE_LAST_PAYOUT] >= 7 || this.flags[kFLAGS_1.kFLAGS.FARM_SUCCUMILK_STORED] > 0 || this.flags[kFLAGS_1.kFLAGS.FARM_INCUDRAFT_STORED] > 0 || this.flags[kFLAGS_1.kFLAGS.FARM_EGG_STORED] > 0 || this.flags[kFLAGS_1.kFLAGS.FARM_CONTRACEPTIVE_STORED] > 0)
                this.addButton(2, "Collect", this.collectTheGoodies);
        ...
        keltAChangeInManagement() {
            this.clearOutput();
            this.outputText("“<i>Hear there’s been a change in management,</i>” says Kelt, clopping to a halt in front of you. You confirm that that is the case. The big centaur looks at you thoughtfully. There’s something different in his dark eyes and rugged scowl than his usual wearied contempt. Grudging admiration?");
            this.outputText("“<i>Find it difficult to believe someone like you could put a bitch in her place,</i>” he says eventually. “<i>Perhaps you’ve got bigger balls than I thought you had.");
            if (this.player.balls == 0)
                this.outputText(" So to speak, anyway.");
            this.outputText("</i>” He snorts, and trots towards the butts. “<i>Just don’t expect me to treat you any different. As long as you’re getting free instruction from me, I’m the master and you’re the whelp. Got that?</i>”");
            ...
            this.outputText("“<i>Do I look like I want or need your sloppy seconds? Godsdamn, I can only imagine what kind of pathetic creatures would have </i>you<i> lording it over them. What a joke! Now, are we going to go watch you fail miserably to hit a target from five yards or what?</i>”");
            this.outputText("It’s better than you were expecting from him in all honesty. You take your bow out and silently follow him to the archery range.");
            this.flags[kFLAGS_1.kFLAGS.KELT_TALKED_FARM_MANAGEMENT] = 1;
            this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_KELLY] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        numSlavesAtFarm() {
            var count = 0;
        ...
        slavesAtFarmMenu() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_AMILY] == 1)
                this.addButton(0, "Amily", kGAMECLASS_1.kGAMECLASS.amilyScene.amilyFollowerEncounter);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] == 1)
                this.addButton(1, "Jojo", kGAMECLASS_1.kGAMECLASS.jojoScene.corruptCampJojo);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 1 && kGAMECLASS_1.kGAMECLASS.sophieBimbo.bimboSophie())
                this.addButton(2, "Sophie", kGAMECLASS_1.kGAMECLASS.sophieBimbo.approachBimboSophieInCamp);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_VAPULA] == 1)
                this.addButton(3, "Vapula", kGAMECLASS_1.kGAMECLASS.vapula.callSlaveVapula);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_LATEXY] == 1)
                this.addButton(4, this.flags[kFLAGS_1.kFLAGS.GOO_NAME], kGAMECLASS_1.kGAMECLASS.latexGirl.approachLatexy);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_BATH_GIRL] == 1)
                this.addButton(5, this.flags[kFLAGS_1.kFLAGS.MILK_NAME], kGAMECLASS_1.kGAMECLASS.milkWaifu.milkyMenu);
            this.addButton(9, "Back", this.farmMenu);
        }
        numFollowersAtFarm() {
            var count = 0;
        ...
        followersAtFarmMenu() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 1 && !kGAMECLASS_1.kGAMECLASS.sophieBimbo.bimboSophie())
                this.addButton(0, "Sophie", kGAMECLASS_1.kGAMECLASS.sophieFollowerScene.followerSophieMainScreen);
            this.addButton(9, "Back", this.farmMenu);
        }
        numLoversAtFarm() {
            var count = 0;
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] > 0)
                count++;
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_ISABELLA] > 0)
                count++;
            return count;
        }
        loversAtFarm() {
        ...
        loversAtFarmMenu() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] == 1)
                this.addButton(0, "Izma", kGAMECLASS_1.kGAMECLASS.izmaScene.izmaFollowerMenu);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_IZMA] == 2)
                this.addButton(0, "Izmael", kGAMECLASS_1.kGAMECLASS.gameOver);
            if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_ISABELLA] == 1)
                this.addButton(1, "Isabella", kGAMECLASS_1.kGAMECLASS.isabellaFollowerScene.callForFollowerIsabella);
            this.addButton(9, "Back", this.farmMenu);
        }
        dogeNotCorruptYet() {
            this.clearOutput();
            this.whitneySprite();
            this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_APPROACHED_WHITNEY] = 1;
            // Farm Corruption drops below 30 after being higher: 
            if (this.whitneyCorruption() < 30 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION_HIGHEST] > 30 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION_0_30_DROP_MESSAGE] == 0) {
                this.outputText("You hail Whitney as she hauls a bag of grain towards the storage barn. She entirely ignores you; there’s an expression of cold triumph on her face as she breezes past you, color high in her cheeks. You notice that she’s rediscovered her crossbow and has it strapped to her back. It hurts your eyes slightly to look at her, as if she’s standing directly in front of the sun. You scowl at her retreating back. You’ll have to do something about this.");
                // [Plays once, reverts to standard message]
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION_0_30_DROP_MESSAGE] = 1;
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_LEAVE_0_60] == 0)
                    this.doNext(this.dogeNotCorruptLeaveFirstTime);
                else
                    this.doNext(this.camp.returnToCampUseOneHour);
                return;
            }
            ...
            if (this.whitneyCorruption() <= 30) {
                this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_APPROACHED_WHITNEY] = 1;
                this.outputText("You find Whitney sat in the cow field, hand milking one of her herd; her crossbow is propped up against a bucket. As you approach, she looks up sharply before slowly reaching for the weapon. You stop in your tracks, and she stops in kind, her hand frozen on the grip. You take a step forward and she picks it up, her finger finding the trigger, her expression entirely emotionless. You take several hasty steps back, she puts it down and goes back to milking peacefully.");
            ...
            if (this.whitneyCorruption() >= 31 && this.whitneyCorruption() <= 60) {
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_MENU_31_60] == 0) {
                    this.flags[kFLAGS_1.kFLAGS.WHITNEY_MENU_31_60] = 1;
                    this.outputText("Once again you approach Whitney, this time as she is carrying full buckets of milk towards the bottling station. She sees you coming and quickens her step. You notice this time however she doesn’t have her crossbow, and this emboldens you.");
                    ...
                    // Subsequent 31-60: 
                    this.outputText("Whitney puts down her work as you stride towards her, resigned unhappiness in her expression.");
                    this.outputText("\n\n“<i>What is it?</i>”");
                }
            ...
            if (this.whitneyCorruption() >= 61 && this.whitneyCorruption() <= 90) {
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_MENU_61_90] == 0) {
                    this.flags[kFLAGS_1.kFLAGS.WHITNEY_MENU_61_90] = 1;
                    // 61-90 Farm Corruption
                    this.outputText("You find Whitney on the steps of the porch to her small house, adjoined to the storage barn. There’s a book next to her but she is simply sat drinking in the sun, her eyes closed. When she opens them and sees you standing there she smiles at you wanly; it’s the first time you’ve seen her do that for some time. There is something indefinable in her gaze and the long lines of her face: trepidation perhaps, coated patchily with coyness.");
                    this.outputText("\n\n“<i>Hello [name],</i>” she says softly. “<i>Something on your mind?</i>”");
                }
                else {
                    // 61-90 Subsequent: 
                    this.outputText("Whitney puts down her work and smiles at you vaguely as you approach her. You again sense that queasy mixture of anxiety, unhappiness and excitement in her jerky, cramped movements and expression.");
            ...
            if (this.whitneyCorruption() >= 91 && this.whitneyCorruption() <= 119) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_MENU_91_119] == 0) {
                    ...
                    // Subsequent 91-119: 
                    this.outputText("Whitney lays down her work eagerly as you approach. ");
            ...
            if (this.whitneyCorruption() == 120) {
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION_COMPLETE] == 0) {
                    this.flags[kFLAGS_1.kFLAGS.WHITNEY_CORRUPTION_COMPLETE] = 1;
                    // 120 Farm Corruption 
                    this.outputText("You don’t need to seek out Whitney this time; almost the moment you arrive on the farm a sandy furred figure is hurrying over to you. There’s deep excitement in her face and her breast is heaving with more than just exertion.");
        ...
        dogeNotCorruptLeaveFirstTime() {
            this.clearOutput();
            this.whitneySprite();
            this.flags[kFLAGS_1.kFLAGS.WHITNEY_LEAVE_0_60] = 1;
            // Leave first time: [otherwise defaults to main farm menu] 
            this.outputText("As you turn to leave, you feel something tug on your [armor]. You turn back to look into Whitney’s searching eyes.");
        ...
        dogeNotCorruptYetMenu() {
            ...
            if (this.availableInvestments())
                this.addButton(2, "Investment", this.investmentMenu);
            this.addButton(9, "Back", this.rootScene);
            if (this.whitneyCorruption() <= 60 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_LEAVE_0_60] == 0)
                this.addButton(9, "Back", this.dogeNotCorruptLeaveFirstTime);
            else if (this.whitneyCorruption() <= 90 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_LEAVE_61_90] == 0)
                this.addButton(9, "Back", this.dogeNotCorruptLeave6190);
        }
        availableInvestments() {
            if (this.player.hasKeyItem("Breast Milker - Installed At Whitney's Farm") < 0 && this.flags[kFLAGS_1.kFLAGS.QUEUE_BREASTMILKER_UPGRADE] == 0)
                return true;
            if (this.player.hasKeyItem("Cock Milker - Installed At Whitney's Farm") < 0 && this.flags[kFLAGS_1.kFLAGS.QUEUE_COCKMILKER_UPGRADE] == 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_REFINERY] == 0 && this.flags[kFLAGS_1.kFLAGS.QUEUE_REFINERY_UPGRADE] == 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_CONTRACEPTIVE] == 0 && this.flags[kFLAGS_1.kFLAGS.QUEUE_CONTRACEPTIVE_UPGRADE] == 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_MILKTANK] == 0 && kGAMECLASS_1.kGAMECLASS.milkWaifu.milkSlave() && this.flags[kFLAGS_1.kFLAGS.QUEUE_MILKTANK_UPGRADE] == 0)
                return true;
            return false;
        }
        whitneyAppearanceNotCorrupt() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("Whitney is a 5’8” dog morph, dressed in a modest cotton blouse and faded long skirt, which has a hole cut in it to allow her short, perky tail to poke through. Her muzzle is suggestive of a golden retriever but really she could be any breed. Her fur is sandy, dusking to black at her extremities. Her ears are floppy, her eyes are a dark brown which matches her shoulder-length hair. She is beyond the flush of youth, however it is obvious from looking at her that she has never known childbirth; though hardened from many years of farm work her frame is relatively slim, her hips and ass widened only with muscle, her small breasts pert against her unprepossessing work-clothes. She has one anus, nestled between her tight buttcheeks where it belongs.");
            this.menu();
            this.dogeNotCorruptYetMenu();
        }
        whitneyAppearanceCorrupt() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("Whitney is a 5’8” dog");
            if (this.whitneyDefurred())
                this.outputText("-girl. Her human transformation has rendered her pretty in a delicate, diffident kind of way.");
            else
                this.outputText("-morph. Her muzzle is suggestive of a golden retriever but really she could be any breed.");
            if (this.whitneyMaxedOralTraining())
                this.outputText(" In sharp contrast to her otherwise fairly thin features, her lips are plump and a depthless black, shining like wet tar. She constantly moves her tongue over them unconsciously.");
            this.outputText(" Although she continues to dress in the same modest cotton blouses and long skirts she always has, complete with holes cut in to allow her short, perky tail to poke through, the cut of it and the way she moves and swings herself about, livid with arousal and near-constant sexual frustration, makes the demure outfit more perverse than anything a demon could dream up.\n");
            if (this.whitneyHasTattoo()) {
                if (this.numTattoos("whitney") > 1)
                    ...
                    this.outputText("\nShe has ");
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_COLLARBONE] != '')
                    this.outputText(this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_COLLARBONE] + "\n");
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_SHOULDERS] != '')
                    this.outputText(this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_SHOULDERS] + "\n");
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_LOWERBACK] != '')
                    this.outputText(this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_LOWERBACK] + "\n");
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_BUTT] != '')
                    this.outputText(this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_BUTT] + "\n");
            }
            this.outputText("\n");
            if (!this.whitneyDefurred())
                this.outputText("Her fur is sandy, dusking to black at her extremities");
            else
                this.outputText("Her skin is a sandy color, and she wears black nail varnish");
            this.outputText(". Her ears are floppy, her eyes are a dark brown which matches her shoulder-length hair, flecked now with deep, red desire. Whilst she is beyond the softness of youth, it is obvious from looking at her that she has never known childbirth; though hardened from many years of farm work her frame is relatively slim, her small breasts pert against her unprepossessing work-clothes. She has one anus, between her tight asscheeks where it belongs.");
            this.menu();
            this.dogeCorruptedMissionComplete(false);
        }
        prosperityGoNotCorrupt() {
            this.clearOutput();
            this.whitneySprite();
            ...
            if (lowValue && lowProtection) {
                ...
                if (this.numFollowersAtFarm() + this.numSlavesAtFarm() + this.numLoversAtFarm() == 0)
                    this.outputText(" Send me any kind of decent body - someone, anyone - and I can start trying to make more-a this place.");
                else
                    this.outputText(" I need more hands to make the best of the place. More suitable hands at least.");
                this.outputText("</i>”");
            }
        ...
        investmentMenu() {
            this.menu();
            if (this.player.hasKeyItem("Breast Milker - Installed At Whitney's Farm") < 0 && this.flags[kFLAGS_1.kFLAGS.QUEUE_BREASTMILKER_UPGRADE] == 0)
                this.addButton(0, "Breast Milker", this.investmentBreastMilker);
            if (this.player.hasKeyItem("Cock Milker - Installed At Whitney's Farm") < 0 && this.flags[kFLAGS_1.kFLAGS.QUEUE_COCKMILKER_UPGRADE] == 0)
                this.addButton(1, "Cock Milker", this.investmentCockMilker);
            if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_REFINERY] == 0 && this.flags[kFLAGS_1.kFLAGS.QUEUE_REFINERY_UPGRADE] == 0)
                this.addButton(2, "Refinery", this.investmentRefinery);
            if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_CONTRACEPTIVE] == 0 && this.flags[kFLAGS_1.kFLAGS.QUEUE_CONTRACEPTIVE_UPGRADE] == 0)
                this.addButton(3, "Contraceptive", this.investmentContraceptive);
            if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_MILKTANK] == 0 && kGAMECLASS_1.kGAMECLASS.milkWaifu.milkSlave() && this.flags[kFLAGS_1.kFLAGS.QUEUE_MILKTANK_UPGRADE] == 0)
                this.addButton(4, "MilkTank", this.investmentMilktank);
            if (!this.whitneyCorrupt())
                this.addButton(9, "Back", this.dogeNotCorruptYetMenu);
            else
                this.addButton(9, "Back", this.dogeCorruptedMissionComplete);
        }
        investmentBreastMilker() {
            this.clearOutput();
            this.whitneySprite();
            if (!this.whitneyCorrupt()) {
                this.outputText("You say you’d like a breast milker installed, one that you could make use of. Whitney frowns, but doesn’t seem as thrown by this idea as you expected.");
                ...
                this.outputText("You say you’d like a breast milker installed, one that you could make use of. Whitney lets her gaze sink down to your [chest].");
            ...
            if (this.player.gems >= 1000)
                this.addButton(0, "Do it", this.doBreastMilkerInvestment);
            else
                this.addButton(0, "Do it", this.turnDownInvestment, true);
            this.addButton(1, "No", this.turnDownInvestment);
        }
        doBreastMilkerInvestment() {
            this.clearOutput();
            this.whitneySprite();
            this.player.gems -= 1000;
            this.showStats();
            this.outputText("You silently hand over a hefty bag of gems. Whitney stows it away.");
            this.outputText("\n\n“<i>Should have that ready to go by tomorrow, if y’all come back then.</i>”");
            this.flags[kFLAGS_1.kFLAGS.QUEUE_BREASTMILKER_UPGRADE] = 1;
            this.doNext(this.rootScene);
        }
        investmentCockMilker() {
            this.clearOutput();
            this.whitneySprite();
            if (!this.whitneyCorrupt()) {
                this.outputText("You say you’d like a semen extractor built, one that you could make use of. Whitney frowns, but doesn’t seem as thrown by this idea as you expected.");
                ...
                this.outputText("You say you’d like a semen extractor built, one that you could make use of. Whitney bites her lip at the implication.");
            ...
            this.menu();
            if (this.player.gems >= 1000)
                this.addButton(0, "Do it", this.doCockMilkerInvestment);
            else
                this.addButton(0, "Do it", this.turnDownInvestment, true);
            this.addButton(1, "No", this.turnDownInvestment);
        }
        doCockMilkerInvestment() {
            this.clearOutput();
            this.whitneySprite();
            this.player.gems -= 1000;
            this.showStats();
            ...
            this.flags[kFLAGS_1.kFLAGS.QUEUE_COCKMILKER_UPGRADE] = 1;
            this.doNext(this.rootScene);
        }
        investmentRefinery() {
            this.clearOutput();
            this.whitneySprite();
            if (!this.whitneyCorrupt()) {
                this.outputText("You say you want a machine built that could concentrate the fluids your followers produce into actual transformatives. Whitney shudders, but is in no position to argue.");
                ...
                this.outputText("You say you want a machine built that could concentrate the fluids your followers produce into actual transformatives.");
            ...
            this.menu();
            if (this.player.gems >= 1500)
                this.addButton(0, "Do it", this.doRefineryInvestment);
            else
                this.addButton(0, "Do it", this.turnDownInvestment, true);
            this.addButton(1, "No", this.turnDownInvestment);
        }
        doRefineryInvestment() {
            this.clearOutput();
            this.whitneySprite();
            this.player.gems -= 1500;
            this.showStats();
            this.outputText("You silently hand over a hefty bag of gems. Whitney stows it away.");
            this.outputText("\n\n“<i>I will try and get... that... ready in a few days time, if y’all come back then.</i>”");
            this.flags[kFLAGS_1.kFLAGS.QUEUE_REFINERY_UPGRADE] = 1;
            this.doNext(this.rootScene);
        }
        investmentContraceptive() {
            this.clearOutput();
            this.whitneySprite();
            if (!this.whitneyCorrupt()) {
                this.outputText("You ask Whitney if she knows of any natural contraceptive that grows in Mareth.");
        ...
        doContraceptiveInvestment() {
            this.clearOutput();
            this.whitneySprite();
            this.player.gems -= 750;
            this.showStats();
            if (!this.whitneyCorrupt()) {
                this.outputText("You hand over the dough. Whitney stows it away.");
            ...
            this.flags[kFLAGS_1.kFLAGS.QUEUE_CONTRACEPTIVE_UPGRADE] = 1;
            this.doNext(this.rootScene);
        }
        investmentMilktank() {
            this.clearOutput();
            ...
            if (!this.whitneyCorrupt()) {
                // If Bathgirl normal:
                if (this.flags[kFLAGS_1.kFLAGS.MILK_SIZE] > 0 && this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_BATH_GIRL] == 1) {
                    this.outputText("You tell Whitney you want her to give [bathgirlName] an intensive course of Gro-plus and Lactaid, and to build a small swimming tank to house her.");
                ...
                // If Bathgirl boobed and at camp: 
                    ...
                    this.outputText("You tell Whitney you want her to build a swimming tank at the farm, then come to your camp, take away your expensively acquired milk slave and install her in it. The dog woman slowly absorbs this.");
            ...
            this.menu();
            if (this.player.gems >= 400)
                this.addButton(0, "Do it", this.doMilktankInvestment);
            else
                this.addButton(0, "Do it", this.turnDownInvestment, true);
            this.addButton(1, "No", this.turnDownInvestment);
        }
        doMilktankInvestment() {
            this.clearOutput();
            this.whitneySprite();
            if (!this.whitneyCorrupt())
                this.outputText("You press the gems into your taskmaster’s hand, turn and leave without another word. Your thoughts turn to huge, delightfully plush brown boobs and luxurious milky baths; it will be well worth it. ");
            else
                this.outputText("You press the gems into your taskmaster’s hand, turn and leave without another word. Your thoughts turn to huge, delightfully plush, brown boobs, of luxurious milky baths; it will be well worth the cost. ");
            // In each case Bath girl reverts to her boobed state and is at farm
            this.flags[kFLAGS_1.kFLAGS.QUEUE_MILKTANK_UPGRADE] = 1;
            this.player.gems -= 400;
            this.doNext(this.rootScene);
        }
        turnDownInvestment(money = false) {
            this.clearOutput();
            this.whitneySprite();
            if (!this.whitneyCorrupt()) {
                // Any “No” option:
                this.outputText("Whitney shrugs, nonplussed.");
                if (money)
                ...
                this.outputText("Whitney shrugs with a simper. ");
        ...
        deFurDoge() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("You put away the gem and move into Whitney, holding her gaze as you gently place your finger and thumb along her jaw line. She doesn’t pull away and lets out a shuddering sigh as you touch her.");
        ...
        dontDeFurDoge() {
            ...
            if (this.player.hasCock())
                this.outputText(" crotch into");
            else
                this.outputText(" hips against");
            this.outputText(" her firm ass and she moans, her breath starting to come in shallow gulps, her heart beating furiously against your skin. Although you keep hold of her you don’t have to do anything to make the hatchet rise again.");
        ...
        makeDogeSubby() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("You again retrieve your gem, and once more begin to rhythmically turn it; this time, however, you walk steadily towards Whitney, your voice getting louder in her ears and the shining light in her unfocused eyes getting brighter as you go on.");
        ...
        makeDogeDommy() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("You again retrieve your gem, and once more begin to rhythmically turn it. This time, however, you walk steadily towards Whitney, your voice getting louder in her ears, the shining light in her unfocused eyes getting brighter as you go on.");
            ...
            this.flags[kFLAGS_1.kFLAGS.WHITNEY_DOM] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        dogeCorruptedMissionComplete(output = true) {
            if (this.flags[kFLAGS_1.kFLAGS.QUEUE_BRANDING_AVAILABLE_TALK] == 1 && output) {
                this.brandingAvailableTalk();
                return;
            }
            if (this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_ORGYROOM] == 2 && output) {
                this.orgyRoomTalk();
                this.flags[kFLAGS_1.kFLAGS.FARM_UPGRADES_ORGYROOM] = 1;
                return;
            }
            if (output) {
                this.clearOutput();
            ...
            if (this.whitneyDom() && output) {
                this.outputText("Whitney is in front of you before you’ve finished calling her name.");
                ...
                this.outputText("Whitney is knelt in front of you before you’ve finished calling her name. Her tail wags as her soulful brown eyes look up at you, lit up with depthless lust.");
                this.outputText("\n\n“<i>[Master]?</i>”");
            }
            this.menu();
            this.addButton(0, "Appearance", this.whitneyAppearanceCorrupt);
            if (this.availableInvestments())
                this.addButton(1, "Investment", this.investmentMenu);
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_BRANDING_MENU_UNLOCKED] == 1 || this.flags[kFLAGS_1.kFLAGS.QUEUE_BRANDING_UPGRADE] < 1)
                this.addButton(2, "Branding", this.brandingMenu);
            if (this.whitneyDom())
                this.addButton(3, "Pleasure", this.whitneyDomPleasure);
            else
                this.addButton(3, "Pleasure", this.whitneySubPleasure);
            this.orgyRoomRouter();
            this.addButton(9, "Back", this.rootScene);
        }
        whitneySubPleasure() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_ORAL_TRAINING] == 0) {
                functorOnNext = true;
            ...
            this.flags[kFLAGS_1.kFLAGS.WHITNEY_ORAL_TRAINING]++;
            if (functorOnNext) {
        ...
        cockOralTraining() {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_ORAL_TRAINING] <= 3) {
                return this.cockOralTrainingStageOne;
            }
            else if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_ORAL_TRAINING] == 4) {
                return this.firstCockOralTrainingStageTwo;
            }
            else if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_ORAL_TRAINING] <= 9) {
                return this.cockOralTrainingStageTwo;
            }
            else if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_ORAL_TRAINING] == 10) {
                return this.firstCockOralTrainingStageThree;
            }
            else if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_ORAL_TRAINING] == 11) {
        ...
        firstOralTraining() {
            ...
            if (this.player.hasCock())
                this.outputText(" cocksucker");
            else
                this.outputText(" pussy eater");
        ...
        cockOralTrainingStageOne() {
            ...
            if (this.player.biggestCockLength() > 12)
                this.outputText(" She still struggles a bit with her gag reflex but it only takes her a few tries to swallow your thick prick, allowing you to pump into the delightful tightness of her throat without issue.");
        ...
        firstCockOralTrainingStageTwo() {
            ...
            if (this.player.hasVagina() && this.player.balls > 0) {
                ...
                this.outputText("\n\nEventually you cannot hold your lust back. You grab her by the head and begin to thrust deep into her " + ((this.player.biggestCockLength() < 8) ? "mouth" : "throat") + ". Her breath hisses through her nose as she lets you use her mouth, struggling to keep her fingers schlicking away; you coo as your own hard movements force her to move her hands fast and erratically, skittering across your urgently bulging button and making you pump into her wet, milking warmth all the more frenetically.");
                this.outputText("\n\n“<i>Cum, bitch.</i>” you grit as you surge to your own high. Whitney’s muffled moans are what you hear as your cock-slit dilates and pumps jizz down her throat; you crow with delight as your [vagina] quivers and then clenches in orgasm in ecstatic sympathy with your male sex, " + ((this.player.wetness() <= 2) ? "wetting your slave’s hand" : "absolutely soaking your slave’s arm") + " with femjizz as it does. She shudders around you and her eyes roll as she finds her own high rooting in her pussy; you are extremely gratified to note that, despite being on a plane of submissive pleasure far away, she still manages to swallow every drop of cum you eject");
                if (this.player.cumQ() >= 1500)
                    this.outputText(" which is no mean feat, given it feels like you’ve fucked what feels like a gallon of it down her gullet. Once you’re almost done, as ever you spurt the last few creamy ropes across her face and clothes");
                this.outputText(".");
            ...
            //Herm without balls
                ...
                this.outputText("\n\nOnce again, there are difficulties. You have got your dog girl doing three intense things at once, and she performs the balancing act shakily, usually forgetting either to continue frigging you or herself with her mouth full of cock. You keep an eye on her and whisper instruction and encouragement when she flags, although it becomes increasingly difficult as the heat inundating both your male and female genitals grows. ");
                this.outputText("\n\nEventually you cannot hold your lust back. You grab her by the head and begin to thrust deep into her " + ((this.player.biggestCockLength() < 8) ? "mouth" : "throat") + ". Her breath hisses through her nose as she lets you use her mouth, struggling to keep her fingers schlicking away; you coo as your own hard movements force her to move her hands faster and more erratically, skittering across your urgently bulging button and making you pump into her wet, milking warmth all the more frenetically.");
                this.outputText("\n\n“<i>Cum, bitch,</i>” you grit as you surge to your own high. Whitney’s muffled moans are what you hear as your cock-slit dilates and pumps jizz down her throat; you crow with delight as your [vagina] quivers and then clenches in orgasm in ecstatic sympathy with your male sex, " + ((this.player.wetness() <= 2) ? "wetting your slave’s hand" : "absolutely soaking your slave’s arm") + " with femjizz as it does. She shudders around you and her eyes roll as she finds her own high rooting in her pussy; you are extremely gratified to note that, despite being on a plane of submissive pleasure far away, she still manages to swallow every drop of cum you eject");
                if (this.player.cumQ() >= 1500)
                    this.outputText(" which is no mean feat, given it feels like you’ve fucked what feels like a gallon of it down her gullet. Once you’re almost done, as ever you spurt the last few creamy ropes across her face and clothes");
                this.outputText(".");
            ...
            //Male w/ balls:
                ...
                if (this.player.cocks.length == 1) {
                    ...
                    this.outputText("\n\nEventually you cannot hold your lust back. You grab her by the head and begin to thrust deep into her " + ((this.player.biggestCockLength() < 8) ? "mouth" : "throat") + ". Her breath hisses through her nose as she lets you use her mouth, struggling to keep her fingers schlicking away; you coo as your own hard movements force her to push slightly into your ass, making you pump into her wet, milking warmth all the more frenetically.");
                ...
                this.outputText(".");
                if (this.player.cocks.length > 1)
                    this.outputText(" The second cock trapped in her grasp flexes out cum just as eagerly as the first, sweat standing out on your forehead as you are clenched by your twin high; it paints her skirt with its generous discharge.");
            }
            //Male without balls:
            else if (!this.player.hasVagina() && this.player.balls == 0) {
                //multicock
            ...
            if (!this.player.hasVagina()) {
                ...
                if (this.player.cocks.length > 1)
                    this.outputText(" and [cock biggest2]");
                this.outputText(". There’s an eagerness on display here which you don’t think was there before as she laps at your cock [headplural], and you think she even stifles a disappointed whine when she’s finished. Smiling softly, you get up, dress and send her on her way.");
            }
            this.player.orgasm();
            this.dynStats("sen-", 1);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        cockOralTrainingStageTwo() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("Not saying a word, you undo the bottom half of your [armor], exposing your [cock biggest] with a soft smile. Without any need for instruction Whitney gets to work, her hand delving into her underwear with a contented sigh, her eyes focused on the task in front of her as she steadily stokes the heat in her crotch with tight, urgent jerks of her slim body.");
            //Male
            if (!this.player.hasVagina()) {
                this.outputText("\n\n");
                if (this.player.balls > 0)
                ...
                if (this.player.cocks.length > 1)
                    this.outputText("She wraps her hand around your [cock biggest2] when she’s ready, giving it an experimental pump before beginning to softly and slowly work it, remembering exactly how to grip and bend its girth as she prepares for the main course.");
                ...
                if (this.player.cocks.length > 1)
                    this.outputText("she occasionally forgets the length bulging in her hand so eager is she to push her lips further down your [cock biggest] and work at her own clit, and you need to murmur to get her to concentrate.");
                else
                    this.outputText("she still occasionally forgets the length buried in her mouth, so eager is she to work keenly at her own clit, and you need to murmur to get her to concentrate.");
                this.outputText(" Nonetheless, the worshipful pleasure inundating your groin is close to masterful and you find yourself drifting away on it, closing your eyes and forgetting about instruction, lost entirely in the waves of your bitch’s soft, exact, ecstatic movements, her sighs and slurps filling your ears.");
                ...
                if (this.player.cocks.length == 1)
                    this.outputText("Whitney cleans your [cock biggest] with her flat tongue, humming as she laps your oozing head clean, deliciously soothing your aching cock.");
                else
                    this.outputText("Whitney cleans first your [cock biggest2] and then your [cock biggest] with her flat tongue, humming as she laps each of your oozing heads clean, deliciously soothing your aching cock.");
        ...
        firstCockOralTrainingStageThree() {
            ...
            if (!this.player.hasVagina()) {
                ...
                if (this.player.cocks.length > 2) {
                    ...
                    if (this.player.cocks.length > 1)
                        this.outputText(" jerking both your cocks with her smooth, exacting grasp in tandem");
                    this.outputText(".");
                }
                ...
                if (this.player.cocks.length > 1) {
                    this.outputText(" all the while your [cock biggest2]");
                    if (this.player.cocks.length > 2)
                        this.outputText(" and [cock biggest3]");
                    this.outputText(" bulge and vibrate with pleasure in her pumping hand");
                    if (this.player.cocks.length > 2)
                        this.outputText("s");
                }
                this.outputText(". Though it would be so easy to lose yourself entirely to her expert movements you keep abreast it for now, holding a close eye on the dog woman kneeling in front of you, now entirely devoted to pleasuring you.");
                ...
                this.outputText("\n\nThe sight and sound of her inundates your senses with the same drowning intensity of the pleasure enveloping your maleness and you pump upwards to an irresistible high, grasping her head and beginning to thrust deep into the tight suction of her" + ((this.player.biggestCockLength() < 8) ? " mouth" : " throat") + ". She moans deeply as you begin to use her like this, and even when you’re face fucking her she does exactly the right things, hollowing her cheeks as you pull outwards to suck deliciously at your receding shaft then softening her mouth completely to give you the best access possible to the beautiful, tight warmth of " + ((this.player.biggestCockLength() < 8) ? "the back of her mouth" : "her gullet") + " as you spear decisively inwards. ");
                ...
                if (this.player.cocks.length > 1 || this.player.cumQ() >= 1500)
                    this.outputText("\n\n");
                if (this.player.cocks.length > 1) {
                    this.outputText("She doesn’t forget the cock");
                    if (this.player.cocks.length > 2)
                        this.outputText("s");
                    this.outputText(" trapped in her grasp for a moment; she milks");
                    if (this.player.cocks.length > 2)
                        this.outputText(" them");
                    else
                        this.outputText(" it");
                    this.outputText(" as hard as you’re fucking her mouth, and");
                    if (this.player.cocks.length > 2)
                        this.outputText(" they flex");
                    else
                        this.outputText(" it flexes");
                    this.outputText(" out cum just as eagerly as the first, delirium seizing you as you are clenched by your");
                    if (this.player.cocks.length == 2)
                        this.outputText(" twin");
                    else if (this.player.cocks.length == 3)
                        this.outputText(" triple");
                    else
                        this.outputText(" transcendent");
                    this.outputText(" high;");
                    if (this.player.cocks.length > 2)
                        this.outputText(" they paint");
                    else
                        this.outputText(" it paints");
                    this.outputText(" her skirt with");
                    if (this.player.cocks.length > 2)
                        this.outputText(" their");
                    else
                        this.outputText(" its");
                    this.outputText(" generous discharge. ");
                }
                if (this.player.cumQ() >= 1500) {
                    this.outputText("Once you’re almost done, as ever you pull out and spurt the last few creamy ropes across her face and clothes. Red with her own huge high, the dog woman does her level best to catch them in her mouth.");
                }
                this.outputText("\n\nOnce you have tensed your last you sigh beatifically and float high and formless on your post-blowjob haze. You close your eyes as, without any bidding, " + ((this.player.cocks.length == 1) ? "Whitney cleans your [cock biggest] with her flat tongue, lapping your oozing head clean, deliciously soothing your aching cock" : "Whitney cleans all of your pricks with her flat tongue, lapping each of your oozing heads clean, deliciously soothing your aching cock") + ". She moans the low, blissed-out moan of an addict as she cleans you up, actually gently pumping your spent [prickplural] to make the last of it drool out. Gods... just these sounds and sensations, the gentle licking at your [cock biggest]’s tip and the little gasping exhale as she manages to coax a final drop onto her thirsty tongue, make you want to do it all over again... if only she hadn’t just drained you utterly. You pull her up before she makes your cock ache even more, pressing her firm, petite body into your [chest] and gaze proudly and complacently at your champion cocksucker.");
            ...
            //Herm
                ...
                this.outputText("\n\n“<i>Now get back to your main task.</i>” You hum with deep approval as once again your [cock biggest] is swaddled in mouth flesh, her tongue sliding up and down your shaft in the same masterful, alternating oscillation all the while your [vagina] " + ((this.player.cocks.length >= 2) ? "and [cock biggest2] thrum and vibrate" : "thrums and vibrates") + " with pleasure from her teasing hands. Though it would be so easy to lose yourself entirely to her expert movements you keep abreast it for now, keeping a close eye on the dog woman kneeling in front of you, entirely devoted now to pleasuring you.");
                ...
                this.outputText("\n\nThe sight and sound of her inundates your senses with the same drowning intensity of the pleasure enveloping your extensive sex and you pump upwards to an irresistible high, grasping her head and beginning to thrust deep into the tight suction of her " + ((this.player.biggestCockLength() < 8) ? "mouth" : "throat") + ". She moans deeply as you begin to use her like this, and even when you’re face fucking her she does exactly the right things, hollowing her cheeks as you pull outwards to suck deliciously at your receding shaft then softening her mouth completely to give you the best access possible to the beautiful, tight warmth of ");
                if (this.player.biggestCockLength() < 8)
                    this.outputText("the back of her mouth");
                else
                    this.outputText("her gullet");
                this.outputText(" as you spear decisively inwards.");
                this.outputText("\n\nYou can’t find the words as you fly into your golden, ecstatic high; you throw your head back as you bury as much of your cock into her as you can, sweat standing out on your brow as you bark wordlessly with each bucket of jizz you fountain down her throat. There’s a series of shrill, strangled squeals below you, her body shakes around you and you know without needing to see Whitney is cumming too, purely from the slavering joy of swallowing every last drop of the thick seed thrust into her by her master. ");
                this.outputText("\n\nHer fingers slip and slide around your [vagina] and it quivers and contracts in shared orgasm, ");
                if (this.player.wetness() > 2)
                    this.outputText("soaking her arm as it gutters your juices, ");
                this.outputText("heightening the ecstasy you feel to mind-blowing heights. ");
                if (this.player.cocks.length > 1)
                    this.outputText(" She doesn’t forget the cock trapped in her grasp for a moment either; she milks it as hard as you’re fucking her mouth, and it flexes out cum just as eagerly as the first, delirium seizing you as you are clenched by your triple high as it paints her skirt with its generous discharge.");
                if (this.player.cumQ() >= 1500)
                    this.outputText(" Once you’re almost done, as ever you pull out and spurt the last few creamy ropes across her face and clothes. Red with her own huge high, the dog woman does her level best to catch them in her mouth.");
                this.outputText("\n\nOnce you have tensed your last you sigh beatifically and float high and formless on your post-blowjob haze. You close your eyes as, without any bidding, ");
                if (this.player.cocks.length == 1)
                    this.outputText("Whitney first cleans your [vagina] and then your [cock biggest] with her flat tongue, polishing your dripping pussy and thighs to a shine before lapping your oozing head clean, deliciously soothing your aching cock.");
                else
                    this.outputText("Whitney uses her flat tongue to clean first your [vagina], polishing your dripping pussy and thighs to a shine, and then each of your pricks, lapping the oozing heads clean, deliciously soothing your aching cocks.");
                this.outputText(" She moans the low, blissed-out moan of an addict as she cleans you up, actually gently pumping your spent [prickplural] to make the last of it drool out. Gods... just these sounds and sensations, the gentle licking at your [cock biggest]’s tip and the little gasping exhale as she manages to coax a final drop onto her thirsty tongue, make you want to do it all over again... if only she hadn’t so adroitly drained you utterly. You pull her up before she makes your cock ache even more, pressing her firm, petite body into your [chest] and gaze proudly and complacently at your champion cocksucker.");
                this.outputText("\n\n“<i>Think I’ve got it,</i>” she whispers, grinning back at you woozily, red throbbing deep in the brown pools of her eyes. You rub her behind the ear and tell her she almost has; there’s one last lesson she has to learn. You grip her tight, hot body for a few moments more and then send her on her unsteady way.");
            }
            this.player.orgasm();
            this.dynStats("sen-", 1);
        ...
        cockOralTrainingStageThree() {
            ...
            if (this.player.cocks.length >= 2)
                this.outputText(", allowing your other cock");
            if (this.player.cocks.length > 2)
                this.outputText("s");
            if (this.player.cocks.length >= 2)
                this.outputText(" to unfurl and bob behind it");
            if (this.player.hasVagina() && this.player.cocks.length >= 2)
                this.outputText(" and");
            if (this.player.hasVagina())
                this.outputText(", leisurely exposing your moist [vagina]");
            if (this.player.cocks.length >= 2 && this.player.hasVagina())
                this.outputText(" at the same time");
            this.outputText(", perfuming the air around her with your heavy musk.");
            ...
            if (!this.player.hasVagina()) {
                ...
                if (this.player.cocks.length > 2)
                    this.outputText("Finally, she snakes her other hand around your [cock biggest3], rolling her wrist as she gently wrings it with the same sliding thoroughness.} You open your mouth to the shifting delectation inundating your overgrowth of cocks.");
                this.outputText("\n\nWhen she finally envelopes your jutting head with her mouth, you cannot help but groan with delight. She does it ever so slowly, letting her thin lips slide gradually down your shaft whilst hollowing her cheeks with syncopated suction, blanketing more and more of your [cock biggest] in sucking, liquid warmth. Her head bobs as she immediately finds a sensual rhythm, sending her tongue sliding downwards as her mouth withdraws to your bulbous tip and then back up as she buries your length deep into her mouth, using the alternating movement to send pulses of sheer ecstasy through your groin. ");
                ...
                this.outputText("\n\nYou grab hold of those thoughts, filling them with a black power as the drowning intensity of the pleasure inundating your maleness increases and you begin to pump upwards to an irresistible high, grasping her head and beginning to thrust deep into the tight suck of her " + ((this.player.biggestCockLength() < 8) ? "mouth" : "throat") + ". With some effort you stay afloat and consider the dog woman as she whimpers in delight to you hammering into her juicy mouth");
                if (this.player.balls > 0)
                    this.outputText(", your saliva-glossed [balls] beating against her chin");
                this.outputText(". If there is one deficiency to her right now it is her fairly thin, pale lips. No cocksucking champion has lips like that - they need to be big, bee-stung, constantly wet with the movements of a needy tongue. Luscious whore pillows worthy of having your cock slide between them. You push these succulent, evil thoughts deep into your groin, deep into the heat building inexorably there. ");
                this.outputText("\n\nEven when you’re face fucking her Whitney does exactly the right things, hollowing her cheeks as you pull outwards to suck deliciously at your receding shaft then softening her mouth completely to give you the best access possible to the beautiful, tight warmth of " + ((this.player.biggestCockLength() < 8) ? "the back of her mouth" : "her gullet") + " as you spear decisively inwards. You can’t find the words as you fly into your golden, ecstatic high; you throw your head back as you bury as much of your cock into her as you can, sweat standing out on your brow as you bark wordlessly with each bucket of jizz you fountain down her throat. ");
                ...
                this.outputText("She suddenly gasps in shock, and you quickly look down. Her lips look swollen, and they seem to be darkening.");
                ...
                if (this.player.cocks.length > 1)
                    this.outputText(" all of");
                this.outputText(" your cock");
                if (this.player.cocks.length > 1)
                    this.outputText("s");
                this.outputText(", first kissing your head deep and then lapping you close; she moans like a whore. She thrusts her ass in the air, sending her tongue pushing all around her new cock pillows with the taste of your cum, gently pumping your spent prick");
                if (this.player.cocks.length > 1)
                    this.outputText("s");
                this.outputText(" to make the last of it drool out.");
            ...
            //Herm 
                ...
                if (this.player.cocks.length > 1)
                    this.outputText("As she bathes your [cock biggest] in delicious sensation she wraps her hand around your [cock biggest2], softening and then tightening her grip, sliding up and down its stem until it is every bit as rock-hard as the one she is lapping at. ");
                this.outputText(" You close your eyes as the pleasure inundating both your male and female sex twist around each other, a slow but brilliant chemical reaction consuming you from within.");
                this.outputText("\n\nWhen she finally envelopes your jutting head with her mouth, you cannot help but groan with delight. She does it ever so slowly, letting her thin lips slide gradually down your shaft whilst hollowing her cheeks with syncopated suction, blanketing more and more of your [cock biggest] in sucking, liquid warmth. Her head bobs as she immediately finds a sensual rhythm, sending her tongue sliding downwards as her mouth withdraws to your bulbous tip and then back up as she buries your length deep into her mouth, using the alternating movement to send pulses of sheer ecstasy through your groin. ");
                ...
                this.outputText(". With some effort you stay afloat and consider the dog woman as she whimpers in delight to you hammering into her juicy mouth");
                if (this.player.balls > 0)
                    this.outputText(", your saliva-glossed [balls] beating against her chin");
                this.outputText(". If there is one deficiency to her right now it is her fairly thin, pale lips. No cocksucking champion has lips like that - they need to be big, bee-stung, constantly wet with the movements of a needy tongue. Luscious whore pillows worthy of having your cock slide between them. You push these succulent, evil thoughts deep into your groin, deep into the heat building inexorably there. ");
                ...
                if (this.player.biggestCockLength() < 8)
                    ...
                    this.outputText("her gullet");
                this.outputText(" as you spear decisively inwards. You can’t find the words as you fly into your golden, ecstatic high; you throw your head back as you bury as much of your cock into her as you can, sweat standing out on your brow as you bark and howl with each bucket of jizz you fountain down her throat. ");
                ...
                this.outputText(", heightening the ecstasy you feel to mind-blowing heights.");
                if (this.player.cocks.length > 1) {
                    this.outputText(" She doesn’t forget the cock trapped in her grasp for a moment; she milks it as hard as you’re fucking her mouth, and it flexes out cum just as eagerly as the first, delirium seizing you as you are clenched by your ");
                    if (this.player.cocks.length == 2)
                        this.outputText("triple");
                    else
                        this.outputText("transcendent");
                    this.outputText(" high; it paints her skirt with its generous discharge.");
                }
        ...
        cockOralTrainingMaxed() {
            ...
            if (!this.player.hasVagina()) {
                ...
                if (this.player.balls > 0)
                    this.outputText("You sigh blissfully as her plump lips push into your [balls] before the flat, warm flannel-like tongue spreads itself across them, covering every inch, each sensitive orb first sensuously kissed and then taken into your slave’s mouth to be suckled gently until they are thrumming and bulging with packed heat. The loving attention laved on them is made all the better by the soft, lustful moans turning into outright panting sobs of pleasure drifting up from between your legs as she obsequiously polishes them.");
                this.outputText("\n\nShe rises until her head is level with your semi-erect prick and with long, careful, exquisite licks makes it fiercely erect, running her tongue along its full length and then swirling it around your head, pressing into the sensitive spots she knows will make you dense and tight with need. She grips it steadily at the base as she does so, every so often giving it a tight squeeze to contrast with a particularly soft lap at your bulging head.");
                if (this.player.cocks.length > 1)
                    this.outputText(" As she bathes your [cock biggest] in delicious sensation she wraps her hand around your [cock biggest2], softening and then tightening her grip, sliding up and down its stem until it is every bit as rock-hard as the one she is lapping at.");
                if (this.player.cocks.length > 2)
                    this.outputText(" Finally, she snakes her other hand around your [cock biggest3], rolling her wrist as she gently wrings it with the same sliding thoroughness.");
                this.outputText(" You open your mouth to the shifting delectation inundating [eachCock].");
                ...
                if (this.player.cocks.length > 1)
                    this.outputText("In the long, delicious daze that follows you move her around");
                if (this.player.cocks.length == 2)
                    this.outputText(", switching her attention to your [cock biggest2] for a while");
                else if (this.player.cocks.length >= 3)
                    this.outputText(" switching her attention first to one cock and then the other");
                if (this.player.cocks.length > 1)
                    this.outputText(" so that each of your fiercely erect pricks has time to enjoy the tight, sucking embrace of her mouth.");
                this.outputText("\n\nPushing her all the way down to the base of your [cock biggest] so that the heavy breath through her nose warms your crotch and holding her there for a time, you enjoy the glorious closeness of the back of her " + ((this.player.biggestCockLength() < 8) ? "mouth" : "throat"));
                if (this.player.balls > 0)
                    this.outputText(" and her tongue once again sliding across your [balls], ");
                this.outputText("before wrapping your hand through her silky hair and lifting her carefully but firmly all the way up, above your gleaming cock, at a height where she is just able to reach it with her tongue, telling her to cup her peachy breasts as you do. You enjoy the soft lapping at your beading head and the frustrated moans filling your ears at leisure, reveling in the sight of her, attempting to reconcile the memory of the calm, independent dog woman you once knew with the whimpering bitch dangling from your fist and creaming herself from worshiping your cock now.");
                this.outputText("\n\nYou let her go and she immediately impales herself back onto your length");
                if (this.player.cocks.length > 1)
                    this.outputText(", her hands wrapping back around your other cock");
                if (this.player.cocks.length > 2)
                    this.outputText("s");
                if (this.player.cocks.length > 1)
                    this.outputText(" as if they never left them");
                this.outputText(" pulling and kneading you now with real need. The drowning intensity of the pleasure inundating your maleness increases and you begin to pump upwards to an irresistible high, grasping her head and beginning to thrust deep into the tight suction of her " + ((this.player.biggestCockLength() < 8) ? "mouth" : "throat") + ".");
                this.outputText("\n\nAs always when you’re face fucking her Whitney does exactly the right things, hollowing her cheeks as you pull outwards to suck deliciously at your receding shaft then softening her mouth completely to give you the best access possible to the beautiful, tight warmth of " + ((this.player.biggestCockLength() < 8) ? "the back of her mouth" : "her gullet") + " as you spear decisively inwards, her lush cock pillows providing... not resistance but a wonderful squeezing lushness moving up and down your urgently bulging length.");
                ...
                this.outputText(" Eventually you can give her no more and withdrawing you stumble back, stars swimming in your eyes from the force of it.");
            ...
            //Herm 
                ...
                if (this.player.cocks.length > 1)
                    this.outputText(" As she bathes your [cock biggest] in delicious sensation she wraps her hand around your [cock biggest2], softening and then tightening her grip, sliding up and down its stem until it is every bit as rock-hard as the one she is lapping at.");
                this.outputText(" You open your mouth to the shifting delectation inundating both your male and female sex, her teasing digits moving with innate expertise to send twin pleasure twisting through you, a slow but brilliant chemical reaction consuming you from within.");
                this.outputText("\n\nWhen she finally envelopes your jutting head with her mouth, you cannot help but groan with delight. She does it ever so slowly, letting her full, frictionless lips glissade over your sensitive cock slit before opening wide and sliding gradually down your shaft, hollowing her cheeks with syncopated suction, blanketing more and more of your [cock biggest] in sucking, liquid warmth. Her head bobs as she immediately finds a sensual rhythm, sending her tongue sliding downwards as her mouth withdraws to your bulbous tip and then back up as she buries your length deep into her mouth, using the alternating movement to send sheer ecstasy pulsing through your groin. There is no need for instruction anymore, no need to do anything but to enjoy that plump, wet seal sliding up and down your prick, a tide of warm, shifting pleasure which carries you off into an extended sexual euphoria.");
                ...
                if (this.player.cocks.length >= 3)
                    this.outputText(", switching her first to one cock then another");
                if (this.player.cocks.length > 1)
                    this.outputText(" so that each of your fiercely erect pricks has time to enjoy the tight, sucking embrace of her mouth.");
                this.outputText("\n\nPushing her all the way down to the base of your [cock biggest] so that the heavy breath through her nose warms your crotch and holding her there for a time, you enjoy the glorious closeness of the back of her " + ((this.player.biggestCockLength() < 8) ? "mouth" : "throat"));
                if (this.player.balls > 0)
                    this.outputText(", and her tongue once again sliding across your [balls]");
                this.outputText(" before wrapping your hand through her silky hair and lifting her carefully but firmly all the way up, above your [cock biggest] at a height where she is just able to reach it with her tongue, telling her to cup her peachy breasts as you do. You enjoy the soft lapping at your beading head and the frustrated moans filling your ears at leisure, reveling in the sight of her, attempting to reconcile the memory of the calm, independent dog woman you once knew with the whimpering bitch dangling from your fist and creaming herself from worshiping your cock now.");
                ...
                if (this.player.cocks.length > 1)
                    this.outputText(" and her other hand wrapping back around your [cock biggest2]");
                this.outputText(" as if they never left them, pulling, kneading and curling into you now with real need. The drowning intensity of the pleasure inundating your sex increases and you begin to pump upwards to an irresistible high, grasping her head and beginning to thrust deep into the tight suction of her " + ((this.player.biggestCockLength() < 8) ? "mouth" : "throat") + ".");
                this.outputText("\n\nEven when you’re face fucking her Whitney does exactly the right things, hollowing her cheeks as you pull outwards to suck deliciously at your receding shaft then softening her mouth completely to give you the best access possible to the beautiful, tight warmth of " + ((this.player.biggestCockLength() < 8) ? "the back of her mouth" : "her gullet") + " as you spear decisively inwards. Her lush cock pillows provide no resistance but a wonderful squeezing lushness running up and down your urgently bulging length. You can’t find the words as you fly into your golden, ecstatic high; you throw your head back as you bury as much of your cock into her as you can, sweat standing out on your brow as you bark wordlessly with each bucket of jizz you fountain down her throat. ");
                this.outputText("\n\nThere’s a series of shrill, strangled squeals below you, her body shakes around you and you know without needing to see Whitney is cumming too, purely from the slavering joy of swallowing every last drop of the thick seed thrust into her by her [master]. Her fingers slip and slide around your [vagina] before bending in and pressing at your sweet spot; it quivers and contracts in shared orgasm, ");
                if (this.player.wetness() > 2)
                    this.outputText("soaking her arm as it gutters your juices, ");
                this.outputText("heightening the ecstasy you feel to mind-blowing heights.");
                if (this.player.cocks.length > 1)
                    this.outputText(" She doesn’t forget the [cock biggest2] trapped in her grasp for a moment; she milks it as hard as you’re fucking her mouth, and it flexes out cum just as eagerly as the first, delirium seizing you as you are clenched by your triple high; it paints her skirt with its generous discharge.");
                this.outputText(" Eventually you can give her no more and withdraw, stars swimming in your eyes from the force of your orgasm.");
        ...
        vaginaOralTrainingStageOne() {
            ...
            if (this.player.wetness() >= 5)
                ...
                this.outputText(" The dog woman coughs and splutters around the lubricant you dribble into her, some of it dripping out of her nose even as you continue to push yourself into her. This doesn’t stop her from furiously moving her hand in her knickers, flicking her clit for all she is worth as she attempts to cope with the pressing demand of your snatch. On the edge already it doesn’t take her long, and her eyes roll as she tenses and shudders.");
        ...
        firstVaginaOralTrainingStageTwo() {
            this.clearOutput();
            this.whitneySprite();
            ...
            if (this.player.lactationQ() > 0)
                this.outputText(" dripping slightly");
            else
                this.outputText(" semi-erect");
            this.outputText(" from the arousal you already feel. “<i>A good slut knows her mistress’s breasts need to be attended to, her nipples and skin shining with a slave’s worship for all the world to see, before she’s deserving of drinking from her pussy. Let’s see how you do.</i>” ");
            ...
            if (this.player.hasFuckableNipples())
                this.outputText(" obscene folds");
            else
                this.outputText(" sensitive points");
            this.outputText(", kneading them gently and bathing them in saliva. Given her initial awkwardness at cunnilingus it’s remarkable how good she is at this. “<i>Lick every inch... that’s good. Suckle on them a bit... very good!</i>” You gasp a bit as she envelopes one of your nipples and");
            if (this.player.hasFuckableNipples())
                this.outputText(" sends her tongue questing into its sensitive inside.");
            else
                this.outputText("bites it ever so gently.");
            if (this.player.lactationQ() > 0) {
                this.outputText(" The gentle kneading is easily enough to make your fecund teats dribble milk into her mouth, and after being slightly startled by it Whitney evidently enjoys the taste of it, because she begins to pull at your plump breast for more. You allow her another mouthful before gently pulling her away.");
            ...
            if (this.player.wetness() <= 2)
                this.outputText(" wetting both your slave’s hand and mouth");
            else
                this.outputText(" absolutely soaking your slave’s face and arm");
            this.outputText(" with femjizz as it does. She shudders around you and her eyes roll as she finds her own high rooting in her pussy; you are extremely gratified to note that, despite being on a plane of submissive pleasure far above you, she still manages to swallow every drop of cum that showers into her mouth");
            if (this.player.wetness() >= 5)
                this.outputText(" which is no mean feat, given it feels like you gutter what feels like a gallon down her gullet. Once you’re almost done, as ever you get up and spurt the last of it on her hair and clothes");
            this.outputText(".");
            this.outputText("\n\nYou exhale long and low when you’re finally done, feeling a glow of intense satisfaction. You gaze dozily down at your slave, who is panting hoarsely, her eyes still closed. You can’t help but notice she occasionally and impulsively licks her lips, as if she is searching for the flavor of something delicious.");
        ...
        vaginaOralTrainingStageTwo() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("Not saying a word, you undo your [armor], exposing your whole body with a soft smile. Without any need for instruction Whitney gets to work, her hand delving into her underwear with a contented sigh, her eyes focused on the task in front of her as she steadily stokes the heat in her crotch with tight, urgent jerks of her slim body.");
            ...
            if (this.player.lactationQ() > 0)
                this.outputText(" and it quickly makes the liquid warmth in your breasts rise to a point, beading milk freely from your teats. Whitney laps and sucks it down eagerly, but gratifyingly she remembers your order and stops reluctantly after only taking a single pull");
            this.outputText(", leaving your nipples");
            if (!this.player.hasFuckableNipples())
                this.outputText(" rock-hard and");
            this.outputText(" shining and your [vagina] beading eagerly.");
            ...
            if (this.player.wetness() >= 5)
                this.outputText(", fountaining fem juice down her throat");
            ...
            if (this.player.wetness() >= 5)
                this.outputText(", soaking her again and again with warm, female approval");
            this.outputText(".");
        ...
        firstVaginaOralTrainingStageThree() {
            this.clearOutput();
            this.whitneySprite();
            ...
            if (!this.player.hasFuckableNipples())
                this.outputText(" she takes each of your [nipples] into her mouth to bathe them in close, sucking attention");
            else
                this.outputText(" she sends her tongue lapping into each of your cunt nipples, curling at their sensitive pink until they are wet with need");
            this.outputText(". It’s a process which is beautifully sensuous, made all the more gratifying by the soft, lustful moans she makes as she polishes your softness.");
            if (this.player.lactationQ() > 0)
                this.outputText(" It quickly makes the liquid warmth in your breasts rise to a point, beading milk freely from your teats. Whitney laps and sucks it down eagerly, but gratifyingly she remembers your order and stops reluctantly after only taking a single pull.");
            this.outputText(" She sinks downwards leaving your nipples");
            if (!this.player.hasFuckableNipples())
                this.outputText(" rock-hard and");
            this.outputText(" shining, your [vagina] beading eagerly.");
            ...
            if (this.player.clitLength >= 4)
                this.outputText(" She uses her new anchorage to take your bulging fem-dick entirely into her mouth, sucking on it avidly; she hums as she does it, sending ecstatic pleasure thrumming through you.");
            ...
            if (this.player.wetness() >= 5)
                this.outputText(", soaking her mouth and face again and again with warm, female approval");
            this.outputText(". There’s a series of shrill, strangled squeals below you, her body shakes around you and you know without needing to see Whitney is cumming too, purely from the slavering joy of swallowing every last drop of the musky fruit guttered into her by her mistress.");
            if (this.player.wetness() >= 5)
                this.outputText(" It is in a state of ecstatic momentum that you rise away from her mouth and spurt the last of it onto her hair and clothes. Red with her own huge high, the dog woman does her level best to catch your spotting fluids in her mouth.");
        ...
        vaginaOralTrainingStageThree() {
            ...
            if (!this.player.hasFuckableNipples())
                ...
                this.outputText(" she sends her tongue lapping into each of your cunt nipples, curling at their sensitive pink until they are wet with need");
            this.outputText(". It’s a process which is beautifully sensuous.");
            if (this.player.lactationQ() > 0)
                this.outputText(" It quickly makes the liquid warmth in your breasts rise to a point, beading milk freely from your teats. Whitney laps and sucks it down eagerly, whimpering as she withdraws after taking a single pull. You smile softly, knowing that the small, teasing taste of your sweetness only serves to make her thirstier.");
            this.outputText(" She sinks downwards leaving your nipples");
            if (this.player.hasFuckableNipples())
                this.outputText(" rock-hard and");
            this.outputText(" shining, your [vagina] beading eagerly.");
        ...
        vaginaOralTrainingMaxed() {
            ...
            if (!this.player.hasFuckableNipples())
                this.outputText(" she envelopes each of your [nipples] with her lips, kissing them with their sumptuous sponginess before bathing them in close, sucking attention");
            else
                this.outputText(" she pushes her lips against your cunt nipples before sending her tongue gently into each of them, curling at their sensitive pink until they are oozing wetness in delight");
            this.outputText(". It’s a process which is beautifully sensuous, made all the better by the soft, lustful moans she makes as she polishes your bust.");
            if (this.player.lactationQ() > 0)
            ...
            this.outputText(" Having left your [chest] gleaming with warm, oily saliva and your nipples");
            if (!this.player.hasFuckableNipples())
                this.outputText(" rock-hard and");
            this.outputText(" shining, she sinks down to the next stage.");
            ...
            if (this.player.buttRating < 4)
                this.outputText("firm butt");
            if (this.player.buttRating < 8)
                this.outputText("supple rump");
            else
                this.outputText("soft ass");
            this.outputText(", oiling it to a sheen. She makes little gasping, stifled breaths as she goes about it, and a grin comes to your lips.");
            ...
            this.player.orgasm();
            this.dynStats("sen-", 1);
            if (this.player.wetness() < 5 && FarmCorruption.rand(4) == 0)
        ...
        whitneyDomPleasure() {
            this.clearOutput();
            this.whitneySprite();
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_DOM_FIRST_PLEASURE] == 0) {
                this.firstWhitneyDomPleasure();
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_DOM_FIRST_PLEASURE] = 1;
            }
            else {
        ...
        firstWhitneyDomPleasure() {
            this.outputText("You are slightly apprehensive about this, but you’ve gone to the trouble of crafting Whitney into a fairly unique slave, and it seems churlish not to test just how deep the dominating streak you’ve brought out in her goes. You tell her you could do with a bit of relaxation.");
        ...
        repeatWhitneyDomPleasure() {
            this.outputText("You say you could do with some relaxation.");
        ...
        // TODO : Split this up
        whitneyDomBondageOral() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("Whitney climbs on top of your supine form, her hands pressing into your [chest], firm hips clenching around your abdomen as she considers you.");
            ...
            if (this.player.isBiped()) {
                ...
                console_1.trace("Missing player body-type, welp.");
            }
            ...
            if (this.player.hasCock() && !this.player.hasVagina()) {
                ...
                if (this.player.totalCocks() > 1)
                    this.outputText(" “<i>So many things to play with tucked away in here!</i>” comes her merry voice again, as you feel her grasp your [cock smallest] at the same time; you groan into the confines of her flesh as she gives it a soft, teasing pump. It’s obvious your main member has really caught her attention though, and both her hands soon return to it.");
            ...
            this.outputText(", and only after relaxing for a long, heavy moment on your face does she finally slide off you. You heave and pant for breath, still cuffed to the bed, rivulets of femcum trickling down your face, your tongue and ");
            if (this.player.hasCock())
            ...
            if (this.player.hasVagina())
                this.outputText("[vagina]");
            this.outputText(" aching, oozing. In a deep, post-coital haze you feel someone take a towel to your body before curling into you, throwing a dense thigh over you, holding and running her hands over you possessively as you recover. ");
        ...
        whitneyDomStraponDoggy() {
            ...
            if (this.player.isBiped() || this.player.isTaur())
                this.outputText(" Next, she pushes your ankles apart, threads a leather strap around each and then pulls them tight with a sharp yank; you carefully test them and find with a cold thrill that there is a metal bar attached between them, forcing you to stay in this position.");
            else if (this.player.isDrider())
                this.outputText(" You don’t struggle as she then forces your spindly legs beneath the bed, looping a leather strap attached to the frame around them all, trapping them there.");
            else if (this.player.isNaga())
                this.outputText(" She then ties your reptilian coils around the bedposts, securing them with leather straps fitted for the purpose.");
            else
                console_1.trace("Couldn't determine body type, welp.");
            ...
            if (this.player.hasVagina() && !this.player.hasCock() && kGAMECLASS_1.kGAMECLASS.vapula.vapulaSlave()) {
            ...
            if (capacity >= 36) {
                ...
                if (this.player.hasVagina())
                    this.outputText("sit and spread ‘em for anything going, don’t you?");
                else
                    this.outputText("I bet you get on your knees for anything with a nice, juicy cock, right?");
                this.outputText(" What would your other slaves think of that? My secret little slut.</i>” ");
                ...
                if (this.player.hasVagina())
                    this.outputText("take of your tight cunt");
                else
                    this.outputText("give of your tight ass");
                this.outputText(", pushing the other end of the dildo into her. An even louder moan is forced out of your throat by the intensity of your tunnel being packed full of cock, albeit an imitation.");
                if (this.player.hasVagina()) {
                    this.player.cuntChange(36, true, true, false);
                }
                else {
                ...
                if (this.player.hasVagina())
                    this.outputText("servants, you tight, bossy little bitch");
                else
                    this.outputText("cattle, you tight, bossy little boy-bitch");
                this.outputText(".</i>” ");
            ...
            this.outputText("\n\nA " + ((this.whitneyDefurred()) ? "hand" : "paw") + " reaches around and clutches your [chest] for anchorage as she finally begins to pound into your tenderized hole with all she’s got. She catches a [nipple] between her fingers and you find yourself being forced towards orgasm again, your ears full of her harsh breathing, your nose full of her heavy scent. She’s no longer thrusting into you for your pleasure though, if she ever was; the hard, feral thrusting of the strap-on into your " + ((this.player.hasVagina()) ? "oozing cunt" : "ass") + " is all about her, all about working the smaller, teasing end in her own pussy as hard as she can. You are simply a vehicle for her own lusts, and when you come again with a juddering cry into her panties, " + ((this.player.hasVagina()) ? "wetting the bed this time with the jackhammer force of it" : "") + " she keeps going, hammering into your hapless " + ((this.player.hasVagina()) ? "[vagina]" : "butt") + ".");
            ...
            if (this.player.hasVagina() && !this.player.hasCock() && kGAMECLASS_1.kGAMECLASS.vapula.vapulaSlave())
                this.outputText(" You feel the end of the dildo tense deep within you before releasing, filling you full of warm demon spunk until it pools out onto the bed. The feeling is horribly, disgustingly satisfying, and for a moment you can see exactly how Vapula views the world.");
        ...
        whitneyDomRide() {
            ...
            if (this.player.isBiped())
                this.outputText(" She does the same with your ankles, leaving you helplessly spread-eagled across the bed.");
            else if (this.player.isDrider())
                this.outputText(" She has long, leather straps attached to the underside of the bed; these are wrapped around the joining of your spindly legs to your heavy abdomen, leaving your chitinous feet pointing helplessly at the ceiling.");
            else if (this.player.isGoo())
                this.outputText(" “<i>I can’t secure you properly,</i>” she breathes, squeezing your gooey form, sinking her fingers into it. “<i>Owing to this nonsense you call a body. So I will jus’ say it again. Lie. Still.</i>”");
            else if (this.player.isNaga())
                this.outputText(" Your long, heavy tail is wrapped around the bedsteads at the foot of the bed and secured with more leather straps, leaving you helplessly spread-eagled across the bed.");
            ...
            this.outputText("\n\n“<i>Stop fussing now, sweetheart,</i>” Whitney croons, adjusting the black, elastic blindfold so it is firmly secured over your eyes." + ((this.player.eyeType == appearanceDefs_1.EYES_FOUR_SPIDER_EYES) ? " Once she’s finished with that she places another blindfold over your second pair of eyes. You can only groan with laughter at the sheer level of preparation the dog woman is capable of." : "") + " “<i>Wouldn’t want you to see what’s coming, would we? That’d ruin half the fun.</i>” ");
            this.outputText("\n\nShe crawls down to your lower body, taking her time now as she slides her hands across your abdomen and [hips] and sits herself down in front of [eachCock]" + ((this.player.balls > 0) ? ", making you twitch as she momentarily cups your [balls]" : "") + ". She teases you with slow, deliberate movements of her smooth digits, fully aware that all you can do now in your black space is lie there, feeling and listening to what she’s doing to you.");
            ...
            var cockI = this.player.cockThatFits(this.whitneyVagCapacity() * 1.33) + 1;
            var tooBig = false;
            // Catch a no-cock-fits scenario so we can do things.
            if (cockI == 0) {
                tooBig = true;
                cockI = this.player.smallestCock() + 1;
            }
            if (tooBig) {
            ...
            // Medium - cock area is within 33% of Whitneys cap without going over.
            else if (this.player.cockArea(cockI - 1) > (this.whitneyVagCapacity() * 0.66)) {
                ...
                this.outputText("\n\n“<i>Massive centaur cock, lil’ sissy dick, that’d be about you, that’d be a statement about the kinda [guy] you are,</i>” she goes on in a low growl, warming to her theme as she screws you, slowly, rhythmically and surely, the candle she’s clutching somewhere above you. “<i>But you’re weak, ain’t ya? You got no self-control when it comes to pussy. You jus want to be used by anyone and anything. So - get - used!</i>” More liquid wax splashes down, this time on a " + ((this.player.isLactating()) ? "moistened" : "taut") + " [nipple] and you can’t help but cringe again, your involuntary movements again making Whitney cry out in pleasure, her tight, succulent sex wringing your [cock " + cockI + "] gleefully.");
        ...
        brandingMenu() {
            this.clearOutput();
            this.whitneySprite();
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_BRANDING_MENU_UNLOCKED] == 0) {
                this.outputText("You idly put an arm around Whitney, drawing her into you. You want her in the right frame of mind before you lead her down this path of inquiry. Her breath is hot and heavy against your [chest], her desire-lit eyes unable to tear away from yours as your hand slides down the curve of her back and round around her enjoyably tight ass. You ask her what she knows about branding.");
                ...
                if (this.player.gems >= 500)
                    this.addButton(0, "Do it", this.getBrandingStuff);
                else
                    this.addButton(0, "Do it", this.dontGetBrandingStuff);
                this.addButton(1, "No", this.dontGetBrandingStuff);
            }
            else {
                this.clearOutput();
                this.outputText("Your thoughts turn to the ingenious magic of your tattooing gear, stashed away in the barn. Grinning, you consider who you will summon to brand.");
                ...
                if (this.player.gems >= 50) {
                    if (this.hasFreeTattooSlot("whitney"))
                        this.addButton(0, "Whitney", this.brandWhitney);
                    if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_AMILY] == 1 && this.hasFreeTattooSlot("amily"))
                        this.addButton(1, "Amily", this.brandAmily);
                    if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_JOJO] == 1 && this.hasFreeTattooSlot("jojo"))
                        this.addButton(2, "Jojo", this.brandJojo);
                    if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_SOPHIE] == 1 && kGAMECLASS_1.kGAMECLASS.sophieBimbo.bimboSophie() && this.hasFreeTattooSlot("sophie"))
                        this.addButton(3, "Sophie", this.brandBimboSophie);
                    if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_VAPULA] == 1 && this.hasFreeTattooSlot("vapula"))
                        this.addButton(4, "Vapula", this.brandVapula);
                    if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] >= 4 && this.hasFreeTattooSlot("kelly"))
                        this.addButton(5, "Kelly", this.brandKelly);
                    if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_BATH_GIRL] == 1 && this.flags[kFLAGS_1.kFLAGS.MILK_SIZE] > 0 && this.hasFreeTattooSlot("milky"))
                        this.addButton(6, this.flags[kFLAGS_1.kFLAGS.MILK_NAME], this.brandSmallMilky);
                    if (this.flags[kFLAGS_1.kFLAGS.FOLLOWER_AT_FARM_BATH_GIRL] == 1 && this.flags[kFLAGS_1.kFLAGS.MILK_SIZE] == 0 && this.hasFreeTattooSlot("milky"))
                        this.addButton(6, this.flags[kFLAGS_1.kFLAGS.MILK_NAME], this.brandBigMilky);
                }
                this.addButton(9, "Back", this.dogeCorruptedMissionComplete);
            }
        }
        hasFreeTattooSlot(name) {
            if (name == "whitney") {
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_COLLARBONE] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_LOWERBACK] == '')
                ...
                if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_COLLARBONE] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_LOWERBACK] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_SHOULDERS] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_BUTT] == '')
                    return true;
                return false;
            }
            else if (name == "vapula") {
                if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_COLLARBONE] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_LOWERBACK] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_SHOULDERS] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_BUTT] == '')
                    return true;
                return false;
            }
            else if (name == "kelly") {
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_COLLARBONE] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_LOWERBACK] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_SHOULDERS] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_BUTT] == '')
                    return true;
                return false;
            }
            else if (name == "milky") {
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_COLLARBONE] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_LOWERBACK] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_SHOULDERS] == '')
                    return true;
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_BUTT] == '')
                    return true;
                return false;
            }
            else {
        ...
        brandWhitney() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("Whitney knows exactly what it means when you head off to the barn where she stashed your “branding” equipment; the dog girl is already eagerly stripped down by the time you’ve returned. You hold the pots of ink and consider where, and what, to put on her.");
            this.player.gems -= 50;
            this.showStats();
        ...
        brandAmily() {
            this.clearOutput();
            this.outputText("You retrieve the pots of ink and paper from the barn and, smiling, tell your pet mouse you’re going to give her a treat.");
            ...
            this.outputText(", [master]? That’s my favorite type of treat.</i>” You consider where, and what, to put on her.");
            this.player.gems -= 50;
            this.showStats();
        ...
        brandJojo() {
            this.clearOutput();
            this.outputText("You retrieve the pots of ink and paper from the barn and, smiling brightly, tell your pet mouse you’re going to give him a special treat. Jojo knows all too well the nature of your treats. He closes his eyes and waits for the worst as you consider where and what to put on him.");
            this.player.gems -= 50;
            this.showStats();
        ...
        brandBimboSophie() {
            this.clearOutput();
            this.outputText("You retrieve the pots of ink and paper from the barn and, smiling, tell your pet harpy you’re going to give her a treat.");
        ...
        brandVapula() {
            this.outputText("You retrieve the pots of ink and paper from the barn and, smiling, tell your succubus you’re going to give her a treat.");
        ...
        brandKelly() {
            this.outputText("You retrieve the pots of ink and paper from the barn and smilingly tell your centaur cumslut you’re going to give her a treat.");
        ...
        brandSmallMilky() {
            this.outputText("You retrieve the pots of ink and paper from the barn and, smiling kindly, tell your ex Sand Witch slave you’re going to give her a treat. ");
        ...
        getBrandingStuff() {
            ...
            this.showStats();
            this.outputText("You stroke at her tiny, bulging button relentlessly until she releases a wordless bark of ecstasy, soaking your hand with a gratifyingly large gush of femcum. As she pants into your chest you wipe one hand clean on her clothes and press the money into her " + ((this.whitneyDefurred()) ? "hands" : "paws") + " with the other.");
            this.outputText("\n\n“<i>Make it happen,</i>” you murmur into her floppy ear, before turning and leaving.");
            this.flags[kFLAGS_1.kFLAGS.QUEUE_BRANDING_UPGRADE] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        dontGetBrandingStuff() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("You stroke at her tiny bulging button until you adjudge she’s on the edge, before withdrawing your hand completely. Maybe some other time, you say airily.");
            this.outputText("\n\n“<i>Oh [master],</i>” groans Whitney, in a tone of deepest exasperation, her hands between her thighs.");
            if (this.whitneyDom())
                this.outputText(" “<i>You’ll pay for that later, I swear!</i>”");
            this.outputText(" Grinning, you turn and leave.");
            this.dogeCorruptedMissionComplete();
        }
        brandingAvailableTalk() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("“<i>[Master]! [Master], I’ve done as you asked,</i>” says Whitney, her tail wagging frantically as you approach. Her eyes are lit with glee and she’s got a cow with her on tether. You settle down and watch as she produces unassuming pots of black and red ink, and a sheaf of what looks like blotting paper.");
            ...
            if (this.whitneyDefurred())
                this.outputText(" fingernail");
            else
                this.outputText(" claw");
            this.outputText(" into the pot, withdraws it and then, dripping black fluid, presses it against the cow’s ample backside. The animal moos and swishes its tail in mild protest, but it doesn’t seem in any grievous amount of pain as Whitney’s digit moves, artfully tracing a large number 12 with the ink.");
            ...
            this.flags[kFLAGS_1.kFLAGS.QUEUE_BRANDING_AVAILABLE_TALK] = 0;
            this.menu();
        ...
        testBranding() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("You return her devilish grin with interest.");
        ...
        brandSlotSelect() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_COLLARBONE] == '')
                this.addButton(0, "Collarbone", this.brandSelect, 0);
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_SHOULDERS] == '')
                this.addButton(1, "Shoulders", this.brandSelect, 1);
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_LOWERBACK] == '')
                this.addButton(2, "Lower Back", this.brandSelect, 2);
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_BUTT] == '')
                this.addButton(3, "Butt", this.brandSelect, 3);
        }
        amilyBrandSlotSelect() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_COLLARBONE] == '')
                this.addButton(0, "Collarbone", this.amilyBrandSelect, 0);
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_SHOULDERS] == '')
                this.addButton(1, "Shoulders", this.amilyBrandSelect, 1);
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_LOWERBACK] == '')
                this.addButton(2, "Lower Back", this.amilyBrandSelect, 2);
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_BUTT] == '')
                this.addButton(3, "Butt", this.amilyBrandSelect, 3);
        }
        jojoBrandSlotSelect() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_COLLARBONE] == '')
                this.addButton(0, "Collarbone", this.jojoBrandSelect, 0);
            if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_SHOULDERS] == '')
                this.addButton(1, "Shoulders", this.jojoBrandSelect, 1);
            if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_LOWERBACK] == '')
                this.addButton(2, "Lower Back", this.jojoBrandSelect, 2);
            if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_BUTT] == '')
                this.addButton(3, "Butt", this.jojoBrandSelect, 3);
        }
        bimboSophieSlotSelect() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_COLLARBONE] == '')
                this.addButton(0, "Collarbone", this.bimboSophieBrandSelect, 0);
            if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_SHOULDERS] == '')
                this.addButton(1, "Shoulders", this.bimboSophieBrandSelect, 1);
            if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_LOWERBACK] == '')
                this.addButton(2, "Lower Back", this.bimboSophieBrandSelect, 2);
            if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_BUTT] == '')
                this.addButton(3, "Butt", this.bimboSophieBrandSelect, 3);
        }
        vapulaSlotSelect() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_COLLARBONE] == '')
                this.addButton(0, "Collarbone", this.vapulaBrandSelect, 0);
            if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_SHOULDERS] == '')
                this.addButton(1, "Shoulders", this.vapulaBrandSelect, 1);
            if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_LOWERBACK] == '')
                this.addButton(2, "Lower Back", this.vapulaBrandSelect, 2);
            if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_BUTT] == '')
                this.addButton(3, "Butt", this.vapulaBrandSelect, 3);
        }
        kellySlotSelect() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_COLLARBONE] == '')
                this.addButton(0, "Collarbone", this.kellyBrandSelect, 0);
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_SHOULDERS] == '')
                this.addButton(1, "Shoulders", this.kellyBrandSelect, 1);
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_LOWERBACK] == '')
                this.addButton(2, "Lower Back", this.kellyBrandSelect, 2);
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_BUTT] == '')
                this.addButton(3, "Butt", this.kellyBrandSelect, 3);
        }
        smallMilkySlotSelect() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_COLLARBONE] == '')
                this.addButton(0, "Collarbone", this.smallMilkyBrandSelect, 0);
            if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_SHOULDERS] == '')
                this.addButton(1, "Shoulders", this.smallMilkyBrandSelect, 1);
            if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_LOWERBACK] == '')
                this.addButton(2, "Lower Back", this.smallMilkyBrandSelect, 2);
            if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_BUTT] == '')
                this.addButton(3, "Butt", this.smallMilkyBrandSelect, 3);
        }
        bigMilkySlotSelect() {
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_COLLARBONE] == '')
                this.addButton(0, "Collarbone", this.bigMilkyBrandSelect, 0);
            if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_SHOULDERS] == '')
                this.addButton(1, "Shoulders", this.bigMilkyBrandSelect, 1);
            if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_LOWERBACK] == '')
                this.addButton(2, "Lower Back", this.bigMilkyBrandSelect, 2);
            if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_BUTT] == '')
                this.addButton(3, "Butt", this.bigMilkyBrandSelect, 3);
        }
        brandSelect(slot) {
            this.clearOutput();
            this.whitneySprite();
            ...
            if (this.player.hasCock() && this.whitneyMaxedOralTraining())
                this.addButton(4, "Cocksucker", this.champCocksuckerTattoo, slot);
            if (this.player.hasVagina() && this.whitneyMaxedOralTraining())
                this.addButton(5, "Pussylicker", this.champPussylickerTattoo, slot);
            this.addButton(9, "Back", this.brandSlotSelect);
        }
        amilyBrandSelect(slot) {
            this.clearOutput();
            this.outputText("What will you draw on her " + this.slotNames[slot] + "?");
            this.menu();
            ...
            if (this.player.hasCock() && slot == 2)
                this.addButton(4, "Cock Here", this.amilyCockGoesHereTattoo, slot);
            if (this.player.hasVagina())
                this.addButton(5, "Mommy's Girl", this.amilyMommysGirlTattoo, slot);
            this.addButton(9, "Back", this.amilyBrandSlotSelect);
        }
        jojoBrandSelect(slot) {
            this.clearOutput();
            ...
            if (this.player.hasCock() && slot == 2)
                this.addButton(4, "Cock Here", this.jojoCockGoesHereTattoo, slot);
            if (this.player.hasVagina())
                this.addButton(5, "Mommy's Boy", this.jojoMommysBoyTattoo, slot);
            this.addButton(9, "Back", this.jojoBrandSlotSelect);
        }
        bimboSophieBrandSelect(slot) {
            this.clearOutput();
            this.outputText("What will you draw on her " + this.slotNames[slot] + "?");
            this.menu();
            ...
            if (slot == 3)
                this.addButton(5, "Wide Load", this.bimboSophieWideLoadTattoo, slot);
            if (this.player.hasCock() && slot == 2)
                this.addButton(6, "Cock Goes Here", this.bimboSophieCockGoesHereTattoo, slot);
            this.addButton(9, "Back", this.bimboSophieSlotSelect);
        }
        vapulaBrandSelect(slot) {
            this.clearOutput();
            this.outputText("What will you draw on her " + this.slotNames[slot] + "?");
            this.menu();
            ...
            if (slot == 2 || slot == 3)
                this.addButton(4, "Buttslut", this.vapulaButtslutTattoo, slot);
            if (!this.player.hasCock())
                this.addButton(5, "Dildo Polisher", this.vapulaDildoPolisherTattoo, slot);
            this.addButton(9, "Back", this.vapulaSlotSelect);
        }
        kellyBrandSelect(slot) {
            this.clearOutput();
            this.outputText("What will you draw on her " + this.slotNames[slot] + "?");
            this.menu();
            ...
            if (this.silly())
                this.addButton(4, "Dick Won", this.kellyDickWonTattoo, slot);
            if (slot == 1)
                this.addButton(5, "Horseshoe", this.kellyHorseshoeTattoo, slot);
            this.addButton(9, "Back", this.kellySlotSelect);
        }
        smallMilkyBrandSelect(slot) {
            this.clearOutput();
            this.outputText("What will you draw on her " + this.slotNames[slot] + "?");
            this.menu();
            ...
            if (slot == 0)
                this.addButton(5, "Mega Milk", this.smallMilkyMegaMilkTattoo, slot);
            if (slot == 0 && this.player.hasCock())
                this.addButton(6, "Cock Cozy", this.smallMilkyCockCozyTattoo, slot);
            this.addButton(9, "Back", this.smallMilkySlotSelect);
        }
        bigMilkyBrandSelect(slot) {
            this.clearOutput();
            this.outputText("What will you draw on her " + this.slotNames[slot] + "?");
            this.menu();
            ...
            if (slot == 0)
                this.addButton(4, "Mega Milk", this.bigMilkyMegaMilkTattoo, slot);
            if (slot == 0 && this.player.hasCock())
                this.addButton(5, "Cock Cozy", this.bigMilkyCockCozyTattoo, slot);
            this.addButton(9, "Back", this.bigMilkySlotSelect);
        }
        collarboneIntro() {
            this.outputText("You command her to kneel in front of you and be still. Your lithe, naked dog girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper.");
        }
        amilyCollarboneIntro() {
            this.outputText("You command her to kneel in front of you and be still. The succubus mouse does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. ");
        }
        jojoCollarboneIntro() {
            this.outputText("You command him to kneel in front of you and be still. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on him, and then seal it on with the paper. ");
        ...
        bimboSophieCollarboneIntro() {
            this.outputText("You command her to kneel in front of you and be still. It’s difficult to get her to stay still, but she goes into a trance-like state when you finally lay your ink-soaked finger on her, mesmerized by its movement until you lay the paper over the design you’ve drawn and seal the ink.");
        }
        vapulaCollarboneIntro() {
            this.outputText("You command her to kneel in front of you and be still. The succubus does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. ");
        }
        kellyCollarboneIntro() {
            this.outputText("You command her to kneel in front of you and be still. The centaur does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. ");
        }
        smallMilkyCollarboneIntro() {
            this.outputText("You command her to take her clothes off, kneel in front of you and be still. The dusky girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her and then seal it on with the paper.");
        }
        ...
        shouldersIntro() {
            this.outputText("You command her to kneel facing away from you and be still. Your lithe, naked dog girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. “<i>What did you draw, [master]?</i>” she says eagerly.");
        ...
        jojoShouldersIntro() {
            this.outputText("You command him to kneel facing away from you and be still. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on him, and then seal it on with the paper. ");
        ...
        amilyShouldersIntro() {
            this.outputText("You command her to kneel facing away from you and be still. Your succubus mouse does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her and then seal it on with the paper. ");
        ...
        bimboSophieShouldersIntro() {
            this.outputText("You command her to kneel facing away from you and be still. It’s difficult to get her to stay still, but she goes into a trance-like state when you finally lay your ink-soaked finger between her blonde wings, mesmerized by its movement until you lay the paper over the design you’ve drawn and seal the ink.");
        ...
        vapulaShouldersIntro() {
            this.outputText("You command her to kneel facing away from you and be still. Your succubus does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. ");
        ...
        kellyShouldersIntro() {
            this.outputText("You command her to kneel facing away from you and be still. The centaur does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her shoulder blades, and then seal it on with the paper. ");
        ...
        smallMilkyShouldersIntro() {
            this.outputText("You command her to kneel facing away from you and be still. The dusky girl does so, keeping her back straight and still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper. ");
        }
        bigMilkyShouldersIntro() {
            this.outputText("You set yourself down behind [bathgirlName] before dipping your finger into the ink, carefully draw your design on her, and then seal it on with the paper. She barely seems to notice.");
            this.outputText("\n\n“<i>Bath time?</i>”");
            this.outputText("\n\n“<i>Soon,</i>” you reply soothingly, as you turn to go put your branding equipment back.");
        }
        lowerbackIntro() {
            this.outputText("You command her to set herself down on your [legs], as if she were about to receive a spanking. Your lithe, naked dog girl does so, her laughter at her own compromising permission turning to a sharp coo as you dip your finger into the ink and carefully draw your design on her, before sealing it on with the paper. “<i>What did you draw, [master]?</i>” she says eagerly.");
            this.outputText("\n\nLaughing, you admire it for yourself and then say she’ll have to ask one of your other slaves... and hope they tell the truth. “<i>Aw no, come on, tell me what it is! It’s a rude word, isn’t it? [Master], it better not be somethin’ the slaves are gonna laugh at...</i>”");
        }
        jojoLowerbackIntro() {
            this.outputText("You command him to set himself face down across your [legs], as if he were about to receive a spanking. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on him and then seal it on with the paper. ");
            this.outputText("\n\n“<i>Th-thanks, [master],</i>” he says. He pauses. “<i>I don’t suppose I could know what it-?</i>” You tussle his adorable ears and tell him of course not.");
        }
        amilyLowerBackIntro() {
            this.outputText("You command her to set herself face down across your [legs], as if she were about to receive a spanking. Your succubus mouse does so, her giggles at her own compromising position turning to a sharp coo as you dip your finger into the ink and carefully draw your design on her, before sealing it on with the paper. ");
            this.outputText("\n\n“<i>What did you draw, [master]?</i>” she says eagerly. Laughing, you admire it for yourself and then say she’ll have to ask one of your other slaves... and hope they tell the truth. “<i>Aw [master], you know they’ll just lie and say it’s something like ‘breeding bitch’. C’mon, please tell me!</i>”");
        }
        bimboSophieLowerBackIntro() {
            this.outputText("You command her to set herself face down across your [legs], as if she were about to receive a spanking. It’s difficult to get her to stay still, cooing and shaking with giggles at her compromising position. She finally falls into a trance-like state when you lay your ink-soaked finger on her, mesmerized by its movement until you lay the paper over the design you’ve drawn and seal the ink.");
        ...
        vapulaLowerBackIntro() {
            this.outputText("You command her to set herself face down across your [legs], as if she were about to receive a spanking. Your succubus does so, her put-upon sigh turning to a sharp coo as you dip your finger into the ink and carefully draw your design on her, before sealing it on with the paper. ");
        ...
        kellyLowerBackIntro() {
            this.outputText("You command her to stand perfectly still.  She can’t quite stop clopping her hooves fretfully as you dip your finger into the ink and carefully draw your design on her human lower back before sealing it on with the paper. ");
            this.outputText("\n\n“<i>What did you draw, [master]?</i>” she asks tentatively when you’re done. Trying to keep a straight face, you say a giant spunky horse cock. “<i>That’s funny, [master]. Ha ha. Y-you didn’t really do that, did you?</i>”");
        }
        smallMilkyLowerBackIntro() {
            this.outputText("You command her to set herself down across your [legs]. The dusky girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her, and then seal it on with the paper.");
        }
        ...
        buttIntro() {
            this.outputText("You command her to set herself down on your [legs], as if she were about to receive a spanking. Your lithe, naked dog girl does so, her laughter at her own compromising permission turning to a sharp coo as you dip your finger into the ink and carefully draw your design on the softest part of her anatomy, before sealing it on with the paper.");
        ...
        amilyButtIntro() {
            this.outputText("You command her to set herself face down across your [legs], as if she were about to receive a spanking. Your succubus mouse does so, her laughter at her own compromising position turning to a sharp coo as you dip your finger into the ink and carefully draw your design on the softest part of her anatomy, before sealing it on with the paper. ");
        ...
        jojoButtIntro() {
            this.outputText("You command him to set himself face down across your [legs], as if he were about to receive a spanking. The mouse-demon does so, staying perfectly still as you dip your finger into the ink, carefully draw your design onto the softest part of his body and then seal it on with the paper. ");
        ...
        vapulaButtIntro() {
            this.outputText("You command her to set herself down across your [legs], as if she were about to receive a spanking. Your succubus does so, her put-upon sigh turning to a sharp coo as you dip your finger into the ink and carefully draw your design on the softest part of her anatomy, before sealing it on with the paper. ");
        ...
        kellyButtIntro() {
            this.outputText("You command her to stand perfectly still.  She can’t quite stop clopping her hooves fretfully as you dip your finger into the ink and carefully draw your design on her smooth, brawny horse ass before sealing it on with the paper. ");
        ...
        smallMilkyButtIntro() {
            this.outputText("You command her to set herself down across your [legs]. The dusky girl does so, staying perfectly still as you dip your finger into the ink, carefully draw your design on her fine, round ass, and then seal it on with the paper.");
        }
        bigMilkyButtIntro() {
            this.outputText("You set yourself down behind [bathgirlName] before dipping your finger into the ink, carefully draw your design on her fine, round ass, and then seal it on with the paper. She barely seems to notice.");
            this.outputText("\n\n“<i>Bath time?</i>”");
            this.outputText("\n\n“<i>Soon,</i>” you reply soothingly, as you turn to go put your branding equipment back.");
        }
        tattooMerge() {
        ...
        tribalTattoo(slot) {
            ...
            if (slot == 0) {
                ...
                tText += "collarbone.";
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_COLLARBONE] = tText;
            }
            else if (slot == 1) {
                this.shouldersIntro();
                tText += "shoulders.";
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_SHOULDERS] = tText;
            }
            else if (slot == 2) {
                this.lowerbackIntro();
                tText += "lower back.";
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_LOWERBACK] = tText;
            }
            else if (slot == 3) {
                this.buttIntro();
                tText += "butt.";
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_BUTT] = tText;
            }
            this.tattooMerge();
        }
        amilyTribalTattoo(slot) {
            this.clearOutput();
            var tText = "A tribal tattoo, all snaking, erotic lines, across her ";
            if (slot == 0) {
                ...
                tText += "collarbone.";
                this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_COLLARBONE] = tText;
            }
            else if (slot == 1) {
                this.amilyShouldersIntro();
                tText += "shoulders.";
                this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_SHOULDERS] = tText;
            }
            else if (slot == 2) {
                this.amilyLowerBackIntro();
                tText += "lower back.";
                this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_LOWERBACK] = tText;
            }
            else if (slot == 3) {
                this.amilyButtIntro();
                tText += "butt.";
                this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_BUTT] = tText;
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        jojoTribalTattoo(slot) {
            this.clearOutput();
            var tText = "A tribal tattoo, all snaking, erotic lines, across his ";
            if (slot == 0) {
                this.jojoCollarboneIntro();
                tText += "collarbone.";
                this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_COLLARBONE] = tText;
            }
            else if (slot == 1) {
                this.jojoShouldersIntro();
                tText += "shoulders.";
                this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_SHOULDERS] = tText;
            }
            else if (slot == 2) {
                this.jojoLowerbackIntro();
                tText += "lower back.";
                this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_LOWERBACK] = tText;
            }
            else if (slot == 3) {
                this.jojoButtIntro();
                tText += "butt.";
                this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_BUTT] = tText;
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        bimboSophieTribalTattoo(slot) {
            this.clearOutput();
            var tText = "A tribal tattoo, all snaking, erotic lines, across her ";
            if (slot == 0) {
                ...
                tText += "collarbone.";
                this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_COLLARBONE] = tText;
            }
            else if (slot == 1) {
                this.bimboSophieShouldersIntro();
                tText += "shoulders.";
                this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_SHOULDERS] = tText;
            }
            else if (slot == 2) {
                this.bimboSophieLowerBackIntro();
                tText += "lower back.";
                this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_LOWERBACK] = tText;
            }
            else if (slot == 3) {
                this.bimboSophieButtIntro();
                tText += "butt.";
                this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_BUTT] = tText;
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        vapulaTribalTattoo(slot) {
            this.clearOutput();
            var tText = "A tribal tattoo, all snaking, erotic lines, across her ";
            if (slot == 0) {
                ...
                tText += "collarbone.";
                this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_COLLARBONE] = tText;
            }
            else if (slot == 1) {
                this.vapulaShouldersIntro();
                tText += "shoulders.";
                this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_SHOULDERS] = tText;
            }
            else if (slot == 2) {
                this.vapulaLowerBackIntro();
                tText += "lower back.";
                this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_LOWERBACK] = tText;
            }
            else if (slot == 3) {
                this.vapulaButtIntro();
                tText += "butt.";
                this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_BUTT] = tText;
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        kellyTribalTattoo(slot) {
            this.clearOutput();
            var tText = "A tribal tattoo, all snaking, erotic lines, across her ";
            if (slot == 0) {
                this.kellyCollarboneIntro();
                this.outputText("“<i>That’s- that’s actually really pretty, [master]!</i>” Kelly says when you’re done, looking down with delight. “<i>Thank you!</i>”");
                tText += "collarbone.";
                this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_COLLARBONE] = tText;
            }
            else if (slot == 1) {
                this.kellyShouldersIntro();
                tText += "shoulders.";
                this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_SHOULDERS] = tText;
            }
            else if (slot == 2) {
                this.kellyLowerBackIntro();
                tText += "lower back.";
                this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_LOWERBACK] = tText;
            }
            else if (slot == 3) {
                this.kellyButtIntro();
                tText += "butt.";
                this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_BUTT] = tText;
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        smallMilkyTribalTattoo(slot) {
            this.clearOutput();
            var tText = "A tribal tattoo, all snaking, erotic lines, across her ";
            if (slot == 0) {
                this.smallMilkyCollarboneIntro();
                this.outputText("“<i>Oh hey, that’s quite pretty.</i>” [bathgirlName] smiles down at what you’ve drawn as you withdraw the pen. “<i>Thanks, [name]!</i>” You kiss her fondly on the forehead and send her on her way.");
                tText += "collarbone.";
                this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_COLLARBONE] = tText;
            }
            else if (slot == 1) {
                ...
                tText += "shoulders.";
                this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_SHOULDERS] = tText;
            }
            else if (slot == 2) {
                ...
                this.outputText("\n\n“<i>Yes, but what is it? [name]? Hello?</i>”");
                tText += "lower back.";
                this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_LOWERBACK] = tText;
            }
            else if (slot == 3) {
                ...
                this.outputText("\n\n“<i>Yes, but what is it? [name]? Hello?</i>”");
                tText += "butt.";
                this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_BUTT] = tText;
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        bigMilkyTribalTattoo(slot) {
            this.clearOutput();
            var tText = "A tribal tattoo, all snaking, erotic lines, across her ";
            if (slot == 0) {
        ...
        smallMilkyPropertyOfTattoo(slot) {
            this.clearOutput();
            var tText = "“Property of [Name]” tattooed across her ";
            if (slot == 0) {
                this.smallMilkyCollarboneIntro();
        ...
        numMilkyButterflyTats() {
            var count = 0;
            if (typeof this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_COLLARBONE] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_COLLARBONE].indexOf("A butterfly") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_SHOULDERS] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_SHOULDERS].indexOf("A butterfly") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_LOWERBACK] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_LOWERBACK].indexOf("A butterfly") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_BUTT] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_BUTT].indexOf("A butterfly") >= 0)
                    count++;
            }
            return count;
        }
        smallMilkyButterflyTattoo(slot) {
            this.clearOutput();
        ...
        bimboSophiePropertyOfTattoo(slot) {
            this.clearOutput();
            var tText = "“Property of [Name]” tattooed across her ";
            if (slot == 0) {
                this.bimboSophieCollarboneIntro();
        ...
        vapulaDildoPolisherTattoo(slot) {
            this.clearOutput();
        ...
        bimboSophieBreedingBitchTattoo(slot) {
            this.clearOutput();
        ...
        bimboSophieCockGoesHereTattoo(slot) {
            this.clearOutput();
        ...
        bimboSophieWideLoadTattoo(slot) {
            this.clearOutput();
        ...
        dontTestBranding() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("Maybe later, you say. Whitney looks disappointed.");
        ...
        numAmilyTribalTats() {
            var count = 0;
            if (typeof this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_COLLARBONE] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_COLLARBONE].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_SHOULDERS] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_SHOULDERS].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_LOWERBACK] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_LOWERBACK].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_BUTT] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.AMILY_TATTOO_BUTT].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            return count;
        }
        numWhitneyTribalTats() {
            var count = 0;
            if (typeof this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_COLLARBONE] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_COLLARBONE].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_SHOULDERS] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_SHOULDERS].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_LOWERBACK] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_LOWERBACK].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_BUTT] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TATTOO_BUTT].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            return count;
        }
        whitneyFullTribalTats() {
        ...
        numJojoTribalTats() {
            var count = 0;
            if (typeof this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_COLLARBONE] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_COLLARBONE].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_SHOULDERS] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_SHOULDERS].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_LOWERBACK] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_LOWERBACK].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_BUTT] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.JOJO_TATTOO_BUTT].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            return count;
        }
        ...
        numSophieTribalTats() {
            var count = 0;
            if (typeof this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_COLLARBONE] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_COLLARBONE].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_SHOULDERS] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_SHOULDERS].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_LOWERBACK] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_LOWERBACK].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_BUTT] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_TATTOO_BUTT].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            return count;
        }
        sophieFullTribalTats() {
        ...
        numVapulaTribalTats() {
            var count = 0;
            if (typeof this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_COLLARBONE] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_COLLARBONE].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_SHOULDERS] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_SHOULDERS].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_LOWERBACK] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_LOWERBACK].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_BUTT] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.VAPULA_TATTOO_BUTT].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            return count;
        }
        vapulaFullTribalTats() {
        ...
        numKellyTribalTats() {
            var count = 0;
            if (typeof this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_COLLARBONE] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_COLLARBONE].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_SHOULDERS] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_SHOULDERS].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_LOWERBACK] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_LOWERBACK].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_BUTT] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.KELLY_TATTOO_BUTT].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            return count;
        }
        ...
        numMilkyTribalTats() {
            var count = 0;
            if (typeof this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_COLLARBONE] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_COLLARBONE].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_SHOULDERS] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_SHOULDERS].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_LOWERBACK] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_LOWERBACK].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            if (typeof this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_BUTT] == 'string') {
                if (this.flags[kFLAGS_1.kFLAGS.MILKY_TATTOO_BUTT].indexOf("A tribal tattoo") >= 0)
                    count++;
            }
            return count;
        }
        ...
        getOrgyRoom() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("It’s a heavy investment, but her description of what she intends has definitely piqued your interest. Slowly you turn and, with a flick of the head, indicate the rock where she leaves the farm’s profit each week. Whitney breaks out onto a wide grin, her hands scrunching up on her skirt.");
            this.outputText("\n\n“<i>You won’t regret this [master], I promise!</i>”");
            this.player.gems -= 2200;
            this.showStats();
            this.flags[kFLAGS_1.kFLAGS.QUEUE_ORGYROOM_UPGRADE] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        noOrgyRoomPlz() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("You tell her it’s a fine idea, but it will have to wait for now.");
        ...
        orgyRoomTalk() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("You can hear Whitney humming to herself happily as you approach her outside the milking shed, and when she sees you she rushes over to clutch at your arm excitedly.");
            ...
            if (this.whitneyDom())
                this.outputText("The sight sends a shuddering thrill down your spine. “<i>You didn’t think I’d forget those, did you [master]? We both know how important they are for properly relaxing you,</i>” Whitney murmurs, pushing her hot suppleness into your side. ");
            else
                this.outputText("You raise an eyebrow at these and Whitney giggles and blushes. “<i>Just in case you’re feeling adventurous, [master]. Or, um, want help.</i>”");
            this.outputText("You might be able to recognize those but you have no idea what the final object you can make out in the room’s dusky gloom is, stood against the far wall. It’s at least four foot tall and looks like an ornate stone urn, with a round bottom, a thin body, some sort of square contraption at the top, and a series of long tubes emerging from its stem. There’s a very small brazier next to it, with a few pebbles of charcoal huffing feebly at the bottom.");
            ...
            if (!this.whitneyDom())
                this.outputText("“<i>It’s exactly what a harem owner needs, [master] - with this you could take care of me and your other sluts all night, every night!</i>”");
            else
                this.outputText("“<i>I could do so many things to you [master], if you were on this stuff. And for so long. Just imagine it!</i>”");
            this.outputText(" You don’t feel woozy or spaced out at all - if anything, you feel slightly more aware and in control of your surroundings, it’s just that your skin feels like it’s coated with something vaguely fuzzy. ");
        ...
        orgyRoomSubMassage() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("You say in a grand, wearied tone that you’ve arrived from another hard day of bringing Mareth to its knees, and that you require the services of your pet masseuse. ");
            ...
            if (this.player.isBiped())
                this.outputText(" you clamber onto the heated slab, placing your chin on your hands on the cushion at the end");
            else if (this.player.isDrider())
                this.outputText(" you tick-tack over and sink your spider underbelly onto the heated marble, before resting your human half down as well. Whitney was foresighted enough to make the slab quite long, and you complete the action in comfort");
            else if (this.player.isNaga())
                this.outputText(" you slither over and slide onto the heated slab, placing your chin on your hands on the cushion at the end. You allow your long, heavy tail to pool onto the floor below");
            this.outputText(".");
            ...
            if (this.player.buttRating >= 6)
                ...
                this.outputText("brawny");
            this.outputText(" rear. After she’s finished making your butt feel red and smooth she dips a heated, greasy hand between your [hips] and");
            if (this.player.hasCock())
                this.outputText(" grips your [cock]");
            else if (this.player.hasVagina())
                this.outputText(" traces the entrance of your [vagina]");
            this.outputText(" for a moment... before sliding out with a throaty giggle, moving on down to your hips.");
            ...
            if (this.player.isBiped()) {
                ...
                if (!(this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_HOOFED || this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_NAGA || this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_GOO || this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_PONY)) {
                    this.outputText(" Your mouth opens as a twinge of pure pleasure veins up your [leg] as she massages the soft arch of the sole, making your");
                    if (this.player.hasCock())
                        this.outputText(" cock thicken");
                    if (this.player.hasCock() && this.player.hasVagina())
                        this.outputText(" and your");
                    if (this.player.hasVagina())
                        this.outputText(" pussy moisten");
                    this.outputText(".");
                    this.outputText(" There must be a direct nerve link leading right from the bottom of your body up to your groin because my word, that really shouldn’t feel as good as it does. She swirls her thumbs across the rougher pads of your feet, dipping her warm fingers in and around the valleys of your");
                    if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_DEMONIC_CLAWS || this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_LIZARD || this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_HARPY || this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_DRAGON)
                        this.outputText(" claws");
                    else
                        this.outputText(" toes");
                    this.outputText(", before returning deliberately to stroke at your arch, indulging that nervous link until you are deep in the unexpected bliss of it... before slowly releasing, leaving you to wallow delightfully in the knowledge that that same slow, delicious attention is about to be lavished on your other [foot].");
                }
                else {
            ...
            // Naga: 
                ...
                if (this.player.tongueType == appearanceDefs_1.TONUGE_SNAKE)
                    this.outputText(" You grin, flicking your forked tongue out to smell her arousal.");
                this.outputText(" “<i>I imagine watching your [master] move around is almost a masochistic experience for you. Something so alien and unnerving now linked forever with pleasure and obedience. Is that how it is? You can’t stop staring at my beautiful, deadly form because it’s almost like a slutty punishment for you?</i>”");
            ...
            if (this.player.lust >= 33)
                this.outputText(" The hot tub bubbles quietly behind her and it is not just oil which is making your skin glow. This would be the moment to pursue a happy ending if you so wished.");
            else
                this.outputText(" You play with the idea of ‘rewarding’ her but... damn. She’s actually managed to relax you <i>too</i> much. You thank her regally, redress, and head out the door, enjoying the lightness of step and self-control which thrums through you.");
            this.menu();
        ...
        orgyRoomSubMassageHappyEnding() {
            this.clearOutput();
            this.whitneySprite();
            this.outputText("You silently rise from the slab and put your arm around your masseuse’s tight body. It radiates heat into you as you send a hand sliding down the curve of her back to squeeze at her tight, supple butt.");
            ...
            if (this.player.tallness >= 67) {
                this.outputText(" With a single movement you swing her hot, compact weight over your shoulder. You growl into her ear that she’s still got plenty to do if she’s to finish her job of thoroughly relaxing every part of you.");
                ...
                this.outputText(" You tighten your grip on her pert behind and growl that she’s still got plenty to do if she’s to finish her job of thoroughly relaxing every part of you.");
            ...
            if (this.player.hasCock() && this.player.cockThatFits(this.whitneyVagCapacity() * 1.33) != -1 && this.player.hasVagina()) {
                this.outputText(" You take a long moment to consider which of your sexes you will satisfy yourself with.");
            }
            //[Male][Female]/[Next]
            this.menu();
        ...
        subHappyEndingMale() {
            ...
            // First time:
            if (this.flags[kFLAGS_1.kFLAGS.MASSAGE_HAPPY_ENDINGS] == 0) {
            ...
            if (hasBiggerCock)
                ...
                this.outputText(" against your [hips]");
            else
                this.outputText(" around your back");
            this.outputText(" momentarily. You grin, and begin to pump into her a little harder, using the full breadth of movement afforded to you by your oiled, [hips] to do so. It has the effect you anticipated. After a few more moments gamely keeping time with your own heavy exhalations the dog girl you’re buried into gasps, unable to contain herself. You winch her legs up by the knees and go at her faster again, still using the full movement of your pelvis to withdraw and sink every inch of your [cock " + cockThatFits + "], pushing into her pink tightness vigorously enough for the water around to splash briskly, buried into her even deeper. ");
        ...
        subHappyEndingFemale() {
            ...
            if (this.player.wetness() >= 5)
                this.outputText(" Your pussy spurts excitement gleefully with each thrust, utterly drowning her own in your juices, polluting the water around you with your musk.");
            if (this.player.hasCock())
                this.outputText(" Whitney has stroked and tantalized your [cock biggest] with her hot hands and smooth belly intermittently this whole time, and as your orgasm builds and overwhelms you she gets her just reward for it; you jet cum from [eachCock], pasting first her face and then her tight breasts with your thick cream as you ride her hard.");
            this.happyEndingMerge();
        }
        happyEndingMerge() {
            ...
            this.flags[kFLAGS_1.kFLAGS.MASSAGE_HAPPY_ENDINGS]++;
            this.player.orgasm();
            this.dynStats("sen-", 1);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
    }
    exports.FarmCorruption = FarmCorruption;
});
//# sourceMappingURL=FarmCorruption.js.map