define(["require", "exports", "./TelAdreAbstractContent", "../../../CoC", "../../../GlobalFlags/kFLAGS", "../../../StatusAffects", "../../../PerkLib", "../../../PregnancyStore"], function (require, exports, TelAdreAbstractContent_1, CoC_1, kFLAGS_1, StatusAffects_1, PerkLib_1, PregnancyStore_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Niamh extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        ...
        timeChange() {
            var needNext = false;
            if (this.flags[kFLAGS_1.kFLAGS.NIAMH_SEAN_BREW_BIMBO_LIQUEUR_COUNTER] > 1)
                this.flags[kFLAGS_1.kFLAGS.NIAMH_SEAN_BREW_BIMBO_LIQUEUR_COUNTER]--;
            if (this.flags[kFLAGS_1.kFLAGS.NIAMH_MOVED_OUT_COUNTER] > 1)
                this.flags[kFLAGS_1.kFLAGS.NIAMH_MOVED_OUT_COUNTER]--;
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BimboChampagne) >= 0) {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.BimboChampagne, 1, -1);
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.BimboChampagne) <= 0) {
                    this.removeBimboChampagne();
                    needNext = true;
                }
            }
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.BlackCatBeer) > 0) {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.BlackCatBeer, 1, -1);
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.BlackCatBeer) <= 0) {
        ...
        telAdreNiamh() {
            if (this.flags[kFLAGS_1.kFLAGS.MET_NIAMH] == 0) {
                ...
                if (this.model.time.hours <= 8)
                    this.outputText("massive N-cup breasts, spilling over the table");
                else if (this.model.time.hours <= 9)
                    this.outputText("huge M-cup breasts, taking up much of the table");
                else if (this.model.time.hours <= 10)
                    this.outputText("great L-cup breasts, advancing far onto the table");
                else if (this.model.time.hours <= 11)
                    this.outputText("heavy K-cup breasts, lying on the table for support");
                else if (this.model.time.hours <= 12)
                    this.outputText("hefty J-cup breasts, resting comfortably on the table");
                else if (this.model.time.hours <= 13)
                    this.outputText("weighty I-cup breasts, dangling to lie on the table");
                else if (this.model.time.hours <= 14)
                    this.outputText("squeezable H-cup breasts, settling burdensomely on her chest");
                else
                    this.outputText("moderately manageable G-cups, trembling with every breath she takes");
                this.outputText(".  Smooth, touchable skin covers her chest, face, hands and presumably the rest of her; it seems her animalistic accoutrements stop at kitty ears and tail. She takes a deep swig of her drink, following it up with a cute little burp.");
            }
        ...
        getANiamhBeer() {
            ...
            this.outputText("\"<i>That'll be two gems,</i>\" she replies.  You hand over the payment, which she holds up to the light and scrutinizes thoroughly.  Satisfied, she drops the things into a sack at her waist.  \"<i>Sorry,</i>\" she mutters. \"<i>I do want to get this damned beer out o' me, but this is still my primary livelihood; I canno' afford to be cheated.  Anyway, here's your mug - you can keep that f'r another two gems; I get 'em cheap.  Go ahead and fill it up, but keep in mind what you're tweakin', right?</i>\"");
            //Feeder
            if (this.player.findPerk(PerkLib_1.PerkLib.Feeder) >= 0)
                this.outputText("  You understand exactly what she's going through; the weight of a huge pair of breasts, the sensitivity as they engorge with fluids, the near-maddening sensation of the contents sloshing around underneath your straining skin...");
            //(Player has G-cups or bigger;
            else if (this.player.biggestTitSize() >= 15) {
                if (this.player.lactationQ() == 0)
                    this.outputText("  Not terribly surprising; you know your tits are sensitive, and you don't even make milk in them.");
                else
                    this.outputText("  You can easily imagine just how much trouble she must have, especially given the bulk of her tits are fluid.");
            }
            else if (this.player.lactationQ() > 0)
                this.outputText("  You know just how distracting it is to have your tits full of fluid waiting to get out.");
            //([if first time]
            if (this.flags[kFLAGS_1.kFLAGS.GOT_NIAMH_BEER] == 0)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MET_NIAMH] > 0)
                this.outputText("Niamh ");
            else
                this.outputText("the cat-girl ");
        ...
        drinkNiamhsBeerInTelAdre() {
            ...
            if (this.player.lactationQ() >= 300 && this.player.biggestTitSize() >= 5 && Niamh.rand(2) == 0 && this.flags[kFLAGS_1.kFLAGS.MET_NIAMH] > 0) {
                ...
                // New Years
                if (this.isHolidays() && this.date.date >= 31) {
                    ...
                    if (this.player.hasVagina())
                        this.outputText("pussy to wetten");
                    if (this.player.gender == 3)
                        this.outputText(" and ");
                    if (this.player.hasCock())
                        this.outputText("[eachCock] to stiffen");
                    this.outputText(".  \"<i>Ye know, I got's an idea.  How's about ye stick by me for the next hour.  I'm sure ye must be diein' to drain those big'uns of yours.  We might as well sell your champagne ta the patrons.  Whaddaya say Lassie?</i>\"");
            ...
            if (this.model.time.hours <= 15)
                this.outputText("\n\n\"<i>Thanks for the business, " + this.player.mfn("laddie", "lassie", "customer") + "!  Remember, Niamh sells her Black Cat Beer every day from 8 until 4.</i>\"  You nod your head in thanks and step away from the table.");
            //16:00 ending
            else {
                this.outputText("\n\nThanks to your efforts, ");
                if (this.flags[kFLAGS_1.kFLAGS.MET_NIAMH] == 0)
                    this.outputText("the cat girl's");
                else
                    this.outputText("Niamh's");
            ...
            this.flags[kFLAGS_1.kFLAGS.MET_NIAMH]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[To Go]
        blackCatBeerToGo() {
            this.clearOutput();
            this.outputText("\"<i>That'll be two more gems, then,</i>\" the girl says.  \"<i>Though, if your hands get any more skillful I might have to pay you to take it,</i>\" she flirts.  You pass over two more gems, and she gratefully bags them and beams you a smile.");
            this.player.gems -= 2;
            this.statScreenRefresh();
            //both output
            if (this.model.time.hours <= 15)
        ...
        talkToNiamh() {
            this.clearOutput();
            //(first time only)
            if (this.flags[kFLAGS_1.kFLAGS.TALKED_NIAMH] == 0) {
        ...
        blackCatBeerEffects(player, clearScreen = true, newLine = false) {
            if (clearScreen)
                this.clearOutput();
            if (newLine)
                this.outputText("\n\n");
            this.outputText("Uncapping the mug, you swill the stuff down in a single swig, gasping as it burns a fiery trail into your belly.  It's rich and sweet, and damn, but it's strong stuff!");
            ...
            var lib = 0;
            if (player.findStatusAffect(StatusAffects_1.StatusAffects.BlackCatBeer) >= 0) {
                if (100 - player.lib >= 10)
                    lib = 10;
                else
                    lib = 100 - player.lib;
                player.addStatusValue(StatusAffects_1.StatusAffects.BlackCatBeer, 1, 4);
                player.addStatusValue(StatusAffects_1.StatusAffects.BlackCatBeer, 2, lib);
                this.outputText("\n\nDamn, it's even better with every extra drink!");
                this.dynStats("spe", -1, "int", -1, "lib", lib, "lus", 30 + Niamh.rand(player.lib / 4));
            }
            else {
                if (100 - player.lib >= 10)
                    lib = 10;
                    ...
                    lib = 100 - player.lib;
                player.createStatusAffect(StatusAffects_1.StatusAffects.BlackCatBeer, 8, lib, 0, 0);
                this.dynStats("spe", -5, "int", -5, "lib", lib, "lus", 20 + Niamh.rand(player.lib / 4));
            }
            player.slimeFeed();
        }
        //Black Cat Beer Wears Off: This message is displayed eight hours after the last drink.
        blackCatBeerExpires() {
            this.dynStats("spe", 4.5, "int", 4.5, "lib", (-1 * this.player.statusAffectv2(StatusAffects_1.StatusAffects.BlackCatBeer)));
            this.player.removeStatusAffect(StatusAffects_1.StatusAffects.BlackCatBeer);
        ...
        giveNiamphBimboLiquer() {
            this.taintNiamh(true);
        }
        giveNiamphSuccubiMilk() {
        ...
        corruptOrBimboNiamhIntro() {
            this.clearOutput();
            this.outputText("\"<i>Heya, favored customer,</i>\" the busty kitty greets as you approach.  \"<i>I have a favor to ask!  My drink's empty, and I get bored of me own brew,</i>\" Niamh explains.  \"<i>Would ya mind fetchin' me somethin', or are ye gonna force me to sample me own goods once more?</i>\"");
            ...
            if (this.player.hasItem(this.consumables.BIMBOLQ))
                this.outputText("'bubbly' for her, in the form of the Bimbo Liqueur you got from the imp lord, or ");
            this.outputText("maybe even a Succubus Milk?  You'll have to consider your options.  On the other hand, of course, something that corruptive would probably mutate her booze-filled boobs, most likely forcing her out of Tel'Adre altogether... and may fall back on your own head, to boot.  What do you do?");
            ...
            this.menu();
            if (this.player.hasItem(this.consumables.BIMBOLQ))
                this.addButton(0, "Bimbo", this.giveNiamphBimboLiquer);
        ...
        taintNiamh(bimbo = false) {
            this.clearOutput();
            this.outputText("You grab Niamh's glass and one more and head off, making sure to turn a corner before commandeering an empty table.  Plunking the mugs down in front of you, you mutter to yourself as she moves away.");
            //[if sucmilk]
            if (!bimbo) {
            ...
            //[if bimbo liqueur]
                ...
                this.outputText("\n\nHer expression brightens when she notices your approach, and she giggles when she regards the quarter-full mugs of liqueur.  \"<i>What, that's it?</i>\" she quips curiously.  \"<i>This stuff had better pack some punch, " + this.player.mf("lad", "lass") + ".</i>\"  You assure her that it will knock her socks off.");
                this.outputText("\n\nNiamh reaches for a mug, but you draw it away from her questing hand, instead sinking it into her considerable expanse of cleavage.  A devious grin flits across your features as she subsequently shivers from the cold glass between her fluid-filled bosom.  \"<i>Wh-why you...</i>\" she gasps, quickly snatching the drink and rubbing warmth back into her goosebumped flesh.  \"<i>You scoundrel...</i>\"");
            ...
            if (!bimbo) {
                ...
                this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] = 1;
                this.dynStats("cor", 5);
            }
            //[if bimbo liquor]
            else {
                ...
                this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] = 2;
            }
            this.flags[kFLAGS_1.kFLAGS.NIAMH_MOVED_OUT_COUNTER] = 25;
        ...
        niamhPostTelAdreMoveOut() {
            ...
            this.flags[kFLAGS_1.kFLAGS.NIAMH_MOVED_OUT_COUNTER] = -1;
            this.clearOutput();
            this.outputText("Upon one of your routine searches, you're given pause as a half-coherent mess of a song comes tumbling across the grasses.  You move toward the cacophony of sound, fairly confident in what you will find.  Indeed, stumbling and shambling towards you comes a ");
            if (this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] == 1)
                this.outputText("demonic-looking");
            else
                this.outputText("hourglass-shaped");
            this.outputText(" Niamh, and it's obvious she's completely hammered.  ");
            if (this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] == 1)
                this.outputText("\"<i>W'hey there " + this.player.mf("boyo", "big girl") + ", wanna...g'forrra goooo-gfh...time?</i>\"");
            else
                this.outputText("\"<i>W'heeeey, honey!  I never thought I'd see yaaaagain!</i>\"");
            this.outputText(" she slurs, struggling to stay upright between her impaired motor skills and her absolutely overfilled chest.  \"<i>Aaah've been drinkin' me 'shtash',</i>\" she explains, noticing your gaze.  \"<i>Canno' leddit go'tuh waste!</i>\" You nod your agreement, sneaking a glance behind her to observe the twin trails of ");
            if (this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] == 1)
                this.outputText("dark");
            else
                this.outputText("light");
        ...
        bimboChampagne(player, clearScreen, intro) {
            if (clearScreen)
                this.clearOutput();
            if (intro) {
                if ((player.findPerk(PerkLib_1.PerkLib.FutaFaculties) >= 0 && player.findPerk(PerkLib_1.PerkLib.FutaForm) >= 0) || (player.findPerk(PerkLib_1.PerkLib.BimboBody) >= 0 && player.findPerk(PerkLib_1.PerkLib.BimboBrains) >= 0)) {
                    this.outputText("You could've swore the stuff worked when you saw Niamh do it to others, but for some reason, it had, like, no effect on you. How weird!");
                }
                else if (player.findStatusAffect(StatusAffects_1.StatusAffects.BimboChampagne) < 0)
                    this.outputText("You uncork the bottle and breathe in the fizzy, spicy aroma of the sparkling liquor.  Breathing deeply, you open your mouth and begin pouring the ever-effervescent fluid inside.  It's sweet and slightly gooey, and the feel of it sliding down your throat is intensely... awesome?  Like, totally!");
                else
                    this.outputText("You find yourself falling even further into the dense bimbo mindset.  You do feel, like, super-good and all, though!\n\nMoaning lewdly, you begin to sway your hips from side to side, putting on a show for anyone who might manage to see you.   You just feel so... sexy.  Too sexy to hide it.  Your body aches to show itself and feel the gaze of someone, anyone upon it.  Mmmm, it makes you so wet!  You sink your fingers into your sloppy cunt with a groan of satisfaction.  Somehow, you feel like you could fuck anyone right now!");
            }
            if (player.findStatusAffect(StatusAffects_1.StatusAffects.BimboChampagne) >= 0) {
                player.addStatusValue(StatusAffects_1.StatusAffects.BimboChampagne, 1, 4);
                this.dynStats("spe", -2, "lib", 1, "lus", 10);
            }
            else {
                player.createStatusAffect(StatusAffects_1.StatusAffects.BimboChampagne, 8, 0, 0, 0);
                ...
                if (player.breastRows[0].breastRating < 5) {
                    ...
                    player.changeStatusValue(StatusAffects_1.StatusAffects.BimboChampagne, 2, 5 - player.biggestTitSize());
                ...
                if (!player.hasVagina()) {
                    ...
                    this.outputText("\n\nYou can feel ");
                    if (player.hasCock())
                        this.outputText("the flesh under your cock[if (hasBalls = true)  and behind your [balls]]");
                    else
                        this.outputText("the blank expanse of flesh that is your crotch");
                    this.outputText(" start to tingle and squirm... mmm... that feels nice!  There's a sensation you, like, can't describe, and then your crotch feels all wet... but in a good, sticky sorta way.  Oh, wow!  <b>You've, like, just grown a new virgin pussy!</b>  Awesome!");
                    player.changeStatusValue(StatusAffects_1.StatusAffects.BimboChampagne, 3, 1);
                }
                ...
                if (player.buttRating < 12) {
                    ...
                    player.changeStatusValue(StatusAffects_1.StatusAffects.BimboChampagne, 4, 12 - player.buttRating);
                    player.buttRating = 12;
                    if (player.hipRating < 10)
                        player.hipRating = 10;
                }
                player.genderCheck();
                this.dynStats("spe", -10, "lib", 1, "lus", 25);
            }
        }
        removeBimboChampagne() {
            ...
            this.dynStats("spe", 10, "lib", -1);
            if (this.player.statusAffectv2(StatusAffects_1.StatusAffects.BimboChampagne) > 0) {
                this.player.breastRows[0].breastRating -= this.player.statusAffectv2(StatusAffects_1.StatusAffects.BimboChampagne);
                this.outputText("  As the trecherous brew fades, your [chest] loses some of its... bimboliciousness.  Your back feels so much lighter without the extra weight dragging down on it.");
            }
            if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.BimboChampagne) > 0) {
                this.outputText("  At the same time, your [vagina] slowly seals itself up, disappearing as quickly as it came.  Goodbye womanhood.");
                this.player.removeVagina();
            }
            if (this.player.statusAffectv4(StatusAffects_1.StatusAffects.BimboChampagne) > 0) {
                this.player.buttRating -= this.player.statusAffectv4(StatusAffects_1.StatusAffects.BimboChampagne);
                this.outputText("  Of course, the added junk in your trunk fades too, leaving you back to having a [butt].");
            }
            this.player.removeStatusAffect(StatusAffects_1.StatusAffects.BimboChampagne);
        ...
        bazaarNiamh() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] == 2) {
                ...
                //[Bizarre Bazaar, repeat encounter]
                    ...
                    this.outputText("Surrounded by blonde-haired, horny women, herms and traps, many of them sporting stomachs swollen with Niamh's copious champagne lactation, the bimbo catgirl enthusiastically waves you over.  \"<i>[name]!  Like, what can I do you for?</i>\" she giggles.");
                }
            }
            //Corrupt:
            else {
                //(General notification:
                this.outputText("Given the pile of snoozing bodies, you can probably hazard a guess as to where Niamh decided to set up shop.");
                //(Approach:
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_NIAMH_BAZAAR_MET]++;
        ...
        bazaardNiamhDrink() {
            this.clearOutput();
            this.player.gems -= 2;
            this.outputText("Approaching the fallen-from-grace (yet completely content) catgirl, you toss her a couple gems and request a glass of the house drink.");
            //Bimbo:
            if (this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] == 2) {
        ...
        drinkFromZeTap() {
            this.clearOutput();
            this.outputText("Your eyes lock onto her large, ever-dribbling nipples, the froth of spilt champagne caked on the table supporting her mammoth breasts, and you know you just have to have it from the source.  You push your way forward and seat yourself on a plush cushion that, from its many tears and suspicious-smelling stains, has seen better days, then grasp the huge boob in front of you, making the ditzy catgirl yowl in anticipation of pleasure.");
        ...
        getBimboChampFromNiamh() {
            this.clearOutput();
            this.outputText("You explain your need for a bottle of her champagne; the ditzy kitty takes several moments to register your words, then nods idly.  \"<i>Works fer me!</i>\" she responds, reaching behind her and rummaging in a large burlap bag.  She produces a flask from the sack's depths, unscrewing the cap and attempting to line it up with a nipple.  Try as she might, she just can't quite reach all the way, and with an airy giggle, she passes it to you instead.");
        ...
        bazaarSex() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] == 2) {
                ...
                this.player.orgasm();
                this.dynStats("int", -.5, "sen", -2);
            }
            else if (this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] == 1) // Succubi Milk
             {
        ...
        seanBimboBrewing() {
            this.clearOutput();
            this.outputText("The uncharacteristically gentlemanly incubus raises his eyebrow as you produce an armful of filled flasks and drop them onto his mostly-empty table.  \"<i>I assume you'd like me to do something special with these,</i>\" he quips, somewhat dryly.");
        ...
        yeahSeanLetsBimbooze() {
            ...
            this.player.consumeItem(this.consumables.BIMBOCH);
            this.statScreenRefresh();
            this.flags[kFLAGS_1.kFLAGS.NIAMH_SEAN_BREW_BIMBO_LIQUEUR_COUNTER] = 25;
        }
        //back to camp
        ...
        getBimboozeFromSean() {
            this.clearOutput();
            this.outputText("Sean turns as you enter, managing a thin smile as he regards you.  \"<i>Excellent timing, I have just finished this!</i>\"");
            this.outputText("He scoops a familiar-looking bottle from a tabletop, passing it off to you.  \"<i>Be somewhat careful with this,</i>\" he warns as you take it.  \"<i>The original's deleterious effect on the mind has been duplicated, I assure you.</i>\"\n\n");
            this.outputText("You drop the vial into a pouch on your person.\n\n");
            //bimbo liqueur aqcquired
            this.flags[kFLAGS_1.kFLAGS.NIAMH_SEAN_BREW_BIMBO_LIQUEUR_COUNTER] = 0;
        ...
        sellYourBooze() {
            this.clearOutput();
            this.player.gems += 2;
            this.temp = Math.round(this.player.lactationQ() / 100);
            if (this.temp > 40)
                this.temp = 40 + Niamh.rand(3);
            ...
            if (this.player.bRows() == 1)
                this.outputText("With a chipper giggle Niamh pulls you closer to the bar.  With both hands she helps you heft your tits up and on to the counter.");
            //If player has four or six breasts.
            else
                this.outputText("Niamh giggles as you try to move your breasts closer to the bar to be milked by the patrons, but it's obvious only the top pair of your tits can easily rest on the counter top.  \"<i>Lassie, it might be unconventional, but givin' the circumstance mayhaps it'd be best if ye laid down on the bar.</i>\"");
            ...
            if (this.player.hasVagina())
                this.outputText("  You feel your excitement dripping down the inside of your thighs as your pussy wettens.");
            this.dynStats("lus", 10 + this.player.sens / 5, "resisted", false);
            //[If player has cocks]
            if (this.player.hasCock())
                this.outputText("  You start to feel sympathetic sensations in [eachCock] as the hands and paws of the bar goers milk your nipples.  With their fingers sliding over your sensitive nubs you can easily imagine them sliding up and down your cock");
            ...
            //If lust is high
                ...
                if (this.player.hasVagina())
                    this.outputText("You can feel your labia dripping with need.  ");
                if (this.player.hasCock()) {
        ...
        barBeerOrgyTits() {
            ...
            //If [player has pussy]
            if (this.player.hasVagina())
                this.outputText("The drooling of your [vagina] gets worse as the constant \"tapping of your kegs\" drives your sense of self-restraint to its limits.  The hands of various drunks start moving more aggressively over your breasts, eventually winding their way down between your thighs.");
            ...
            if (this.player.hasCock()) {
                ...
                this.outputText(" discreet but it's impossible.  You try to push ");
                if (this.player.cockTotal() == 1)
                    this.outputText("it");
                else
                    this.outputText("them");
                this.outputText(" down or aside, but other pairs of hands begin stroking you.");
            }
            ...
            if (this.player.buttRating >= 20)
                this.outputText("  She slaps your ass to emphasize her meaning, and the action sends jiggling waves through each immense cheek.");
            ...
            if (this.player.biggestTitSize() >= 20)
                this.outputText("Your giant boobs are large enough to temporarily hang off the sides of your body as you're carried.");
            this.outputText("  Your [butt] hits the table first as the crowd puts you down.  Some patrons begin sucking on your nipples directly.");
            // [IF player has four or more giant tits, but not hugely pregnant]
            if ((this.player.pregnancyIncubation == 0 || this.player.pregnancyIncubation > 100) && this.player.bRows() > 1)
                this.outputText("  You are essentially a pile of " + this.boozeBoobsType() + " filled tits.");
            // [IF player is hugely pregnant with four or more tits]
            else if (this.player.bRows() > 1)
                this.outputText("  You are essentially a giant pregnant belly surrounded by your [chest] on the table, helpless to the sexual advances of the bar goers and you can't get enough of it.");
            //===============
            //Third Paragraph
            //===============
            //IF player has pussy and Urta is in the bar and sex with her is unlocked.
            if (this.model.time.hours < 15 && this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] > 0 && this.player.hasVagina()) {
                ...
                if (this.player.pregnancyIncubation == 0)
                    this.outputText("  Some folks give yelps and cheers when they see the bulge that repeatedly forms in your abdomen each time Urta thrusts herself inside you.");
            ...
            //ELSE IF player has pussy and Urta is not in the bar.
                ...
                if (this.player.vaginalCapacity() < 60)
                    this.outputText("  One is sporting a cock that is obviously too massive for your pussy, and eventually backs down so that the other one, despite still being on the large size, can take the honor of fucking your cunt silly.");
                //ELSE IF [player has a gaping pussy or bigger]
                else
                    this.outputText("  They're both sporting large canine cocks, but one is particularly massive while the other would likely be a loose fit for a pussy as naturally stretched out as yours.  The largest one wins out and positions himself to give your overly wide fuck hole a much needed stretching.");
            ...
            if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 100)
                this.outputText("  \"<i>Oi!  Careful folks, this babe could blow at any time!</i>\"  Niamh pats your belly with chiding affection.");
            ...
            if (this.player.hasFuckableNipples())
                this.outputText("  Eventually some of the randier drunks start whipping out their cocks, and begin pressing the heads against the openings of your nipples.  Within moments you feel your booze bloated breasts being fucked silly by " + Niamh.num2Text(this.player.totalNipples()) + " hard cocks.  Each thrust causes " + this.boozeBoobsType() + " to spill out around their shafts.");
            // ELSE[Character doesn't have fuckable nipples]
            else
                this.outputText("  Some of the hornier customers start shoving cocks of all shapes and sizes into the moist wet cleavages formed by yours and Niamh's breasts.");
            //===============
            //Sixth Paragraph
            //===============
            ...
            if (this.player.hasFuckableNipples())
                this.outputText("  The cocks filling your nipples start pumping hot sperm into your breasts, mixing with your " + this.boozeBoobsType() + " and causing every nerve ending in your nipples to tingle.  Some of them ejaculate so much that it feels as if your breasts are swelling even larger, almost to the point of bursting before the cum spills out.");
            //IF [Player has cocks]
            if (this.player.cockTotal() > 0) {
                this.outputText("  You feel as if your body is exploding everywhere.  Niamh gags momentarily as her mouth fills with your seed, and you realize your cock");
                if (this.player.cockTotal() > 1)
                    this.outputText("s have");
                else
                    this.outputText(" has");
                this.outputText(" begun spurting ");
                if (this.player.cockTotal() == 1)
                    this.outputText("its ");
                else
                    this.outputText("their ");
                this.outputText("jizz.  Niamh swallows it down her throat but not without some of it getting plastered across her face.");
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) >= 5 && this.player.gender == 3 && this.model.time.hours == 14 && this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] > 0) {
                ...
                // IF [player has a single cock]
                if (this.player.cockTotal() == 1)
                    this.outputText("  Edryn moans out loud in ecstasy as your [cock] fills her up.");
                // If [player has multiple cocks]
                else if (this.player.cockTotal() > 1)
                    this.outputText("  The heads of your cocks press in between Edryn's labia causing her to cry out, \"<i>Oh gawd!  How many dicks are y-you f-f-fucking meeee with???</i>\"  Edryn's orgasm cuts her voice off and every muscle in her cunt contracts around your " + this.multiCockDescriptLight() + ".");
                ...
                if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 200)
                    this.outputText("  Your pregnant belly presses up against Edryn's ass as both Urta's cock and Edryn's pussy keeps you pinned in place between them.");
                // IF[player is not pregnant]
                else
                    this.outputText("  Urta's cock and Edryn's pussy pin you in place between them, and as Urta fucks you deeper her cock head forces your belly to bulge outwards until it presses against Edryn's ass.");
                ...
                if (this.player.bRows() == 2)
                    this.outputText("  Your second row of tits get thrust out to either side every time Urta's torso presses your own against Edryn.");
                //IF [player has six giant breasts]
                else if (this.player.bRows() == 3)
                    this.outputText("  Your lowest row of tits slap against all three of your thighs as the love making becomes more brutal.");
                ...
                if (this.player.buttRating >= 22)
                    this.outputText("  The fat of your ass cheeks jiggles and quakes even as Urta practically stuffs her hips into your crack.  \"<i>Damn, you've got a bigger ass than Edryn,</i>\" she chides as she spanks you.  \"<i>Hey!</i>\"  Edryn calls out with a false tone of hurt pride.");
            ...
            // IF [Urta but not Edryn is present in the bar and sex with her is unlocked and character has pussy]
            else if (this.player.hasVagina() && this.model.time.hours < 15 && this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] > 0) {
                ...
                if (this.player.bRows() > 1)
                    this.outputText("  Your rows of breasts shift around as your posture changes, making squelching sounds as they slide around.");
                //If [player not pregnant]
                if (this.player.pregnancyIncubation == 0)
                    this.outputText("  Urta's small ocean of sperm streams out from your pussy like a river down your legs as you try to stand.");
            ...
            //Generic ending if the first two don't trigger
                ...
                // IF [player has pussy]
                if (this.player.hasVagina())
                    this.outputText("  The giant knot of the dog morph finally breaks its way inside causing your pussy to become overstretched.  The pleasurable torture only gets worse as he begins unloading a river of his cum inside you.  It begins squirting out around his cock and soaks both of your thighs in the process.");
                this.player.cuntChange(60, true, true, false);
                this.outputText("  Niamh finally has her fill and dismounts you, but no sooner has her pussy left your face than a determined cock belonging to some sort of cat morph fills your mouth.  Your eyes bug out as it thrusts down your throat.");
                // If [player has pussy]
                if (this.player.hasVagina())
                    this.outputText("  You gag on it at the same time a new cock fills your cunt, ready to renew the thrusting that's been causing your tits to bounce all over the place.");
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText("  The six titted girl smiles at you, patting her belly while your cum runs down the inside of her thighs.  You only now wonder about how fertile she might be.");
                // IF [player has multiple cocks]
                else if (this.player.cockTotal() > 1)
                    this.outputText("  Various girls around the room are patting their bellies and giving you sultry looks while your cum continues to drip from their pussies.  You passively wonder if any of them might indeed be hauling around some larger pregnant bellies in a few days, but you try to push those thoughts from your head.  At the moment they seem happy.");
                // IF [player has pussy]
                if (this.player.hasVagina()) {
                    this.outputText("  You walk slightly bow legged out of the bar.  Cum is still dripping from your snatch and will likely continue to do so for a while.");
                    //IF [player is not pregnant]
                    if (this.player.pregnancyType == 0)
                        this.outputText("  You can't help but wonder how virile those dog morphs might have been as their cum and the cum of other customers sloshes around inside your uterus.");
                    this.temp = Niamh.rand(6);
                    switch (this.temp) {
                        case 0:
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_MOUSE, PregnancyStore_1.PregnancyStore.INCUBATION_MOUSE); //I'm betting this was meant to be dog morph chance
                            break;
                        default:
                            this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_CENTAUR, PregnancyStore_1.PregnancyStore.INCUBATION_CENTAUR);
                            break;
                    }
                }
                this.player.growTits(2, this.player.bRows(), false, 2);
        ...
        boozeBoobsType() {
            ...
            // Christmas
                ...
                return "egg nog";
            // Valentine's
            else if (this.date.date == 14 && this.date.month == 1)
                return "wine";
            // Non-Holiday, Generic
            else
                return "beer";
