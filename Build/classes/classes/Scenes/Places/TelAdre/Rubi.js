define(["require", "exports", "./TelAdreAbstractContent", "../../../GlobalFlags/kFLAGS", "../../../Appearance", "../../../CockTypesEnum", "../../../BreastStore", "../../../PerkLib", "../../../../console", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, TelAdreAbstractContent_1, kFLAGS_1, Appearance_1, CockTypesEnum_1, BreastStore_1, PerkLib_1, console_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Rubi extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        ...
        rubiSprite() {
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_HORNTYPE] > 0)
                this.spriteSelect(102);
            else
                this.spriteSelect(101);
        }
        initializeRubi() {
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BIMBO] == 0) {
                this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] = 0;
                this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] = 5;
                this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] = 1;
            }
            else {
                this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] = 7;
                this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] = 0;
                this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] = 0;
                this.flags[kFLAGS_1.kFLAGS.RUBI_SHE] = 1;
                this.flags[kFLAGS_1.kFLAGS.RUBI_HAIR] = 1;
            }
            this.flags[kFLAGS_1.kFLAGS.RUBI_SETUP] = 1;
        }
        rubiBalls() {
            return "normal";
            return "swollen";
        ...
        rubiBimbo() {
            return (this.flags[kFLAGS_1.kFLAGS.RUBI_BIMBO] > 0);
        }
        rubiIncubus() {
            return (this.flags[kFLAGS_1.kFLAGS.RUBI_INCUBUS_PROGRESS] == 3);
        }
        rubiAffection(delt = 0) {
            if (delt == 0)
                return this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION];
            this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] += delt;
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] > 100)
                this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] = 100;
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] < 0)
                this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] = 0;
            return this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION];
        }
        rubiCock(lust = 50) {
            var cumQ = 300;
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] < 4) {
                cumQ = 10;
            }
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 6) {
                cumQ = 150;
            }
            return Appearance_1.Appearance.cockDescription(this.rubiGetCockType(), this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE], this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] / 6, lust, cumQ);
        }
        rubiGetCockType() {
            return this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_TYPE];
        }
        rubiBreasts() {
            var ret = "pair of ";
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1)
                ret = "chest";
            else {
                ret += Appearance_1.Appearance.breastCup(this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE]);
                ret += " ";
                ret += BreastStore_1.BreastStore.breastDescript(this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE]);
            }
            return ret;
        }
        rubiChest() {
        ...
        rubiCapacity() {
            var bonus = this.flags[kFLAGS_1.kFLAGS.RUBI_TIMES_ANALLY_TRAINED] * 10;
            if (bonus > 76)
                bonus = 76;
        ...
        rubiMF(man, woman) {
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_ADMITTED_GENDER] < 1)
                return woman;
            else {
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_SHE] == 1)
                    return woman;
                else
                    return man;
            }
        ...
        specialRelationship20scene() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("As you're leaving the bakery, you hear the clicking of heels behind you.  Turning back you see Rubi rushing towards you shouting, \"<i>Hey, wait a second!</i>\"  You do, and wait for her to catch up.  Stopping in front of you, she puts her hands on her dainty knees and catches her breath.");
            ...
            this.flags[kFLAGS_1.kFLAGS.RUBI_ADMITTED_GENDER] = 1;
            //(Accept) or (Reject)
        ...
        acceptRubi() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You wrap your arms around and pull him into a hug.  You declare that you like him no matter what sort of genitals he happened to be born with.");
        ...
        rejectRubi() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("With your hands on his shoulders you carefully keep him at arm's length.  Putting it as delicately as you can, you tell him that you're just not interested in him <i>that</i> way, not anymore at least.");
            ...
            this.flags[kFLAGS_1.kFLAGS.RUBI_DISABLED] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Bakery Intro scenes
        rubiIntros() {
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SETUP] == 0) {
                this.initializeRubi();
            }
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_DISABLED] > 0 || this.flags[kFLAGS_1.kFLAGS.RUBI_PROSTITUTION] == -2)
                return undefined;
            this.outputText("\n");
            //(Haven't met yet)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_INTRODUCED] == 0)
                this.outputText("A cute human girl moves from table to table, bussing the empty ones and serving drinks to the occupied.  She's pretty flat-chested, and wears a pink and white frilly waitress uniform with an apron.  When she turns her back to you, you can tell she's not <i>entirely</i> human, what with the long red spaded tail coming out from under her dress.");
            //(Have met, relationship 0-19)
            else if (this.rubiAffection() < 30)
                this.outputText("Rubi is here, moving from table to table efficiently clearing the empty ones and serving new customers.  Her long red tail swishes back and forth, sometimes lifting her dress enough to get a peek at her panties.");
            //(Have met, relationship 40, Bimbo Rubi; cheating scene)
            else if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_PROSTITUTION] == 0 && Rubi.rand(9) == 0) {
                this.outputText("Strangely, even though you know it's time for Rubi's shift, she's not here.\n");
                //(Rubi button still active, goes to \"<i>Cheating Rubi</i>\" scene)
                //(Have met, relationship 40, Bimbo Rubi)
                return this.cheatingRubi;
            }
            else if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0)
                this.outputText("Rubi is here, moving from table to table, not quite as efficiently as [rubi ey] used to, but with a lot more exuberance.  [rubi Eir] long red tail swishes around, seemingly drawn towards the crotch of patrons and co-workers alike.");
            else
                this.outputText("Rubi is here, moving from table to table efficiently clearing the empty ones and serving new customers.  [rubi Eir] long red tail swishes back and forth excitedly.");
            this.outputText("\n");
            return this.approachRubiScenes;
        }
        //Approach Rubi scenes
        approachRubiScenes() {
            this.outputText(this.images.showImage("rubi-at-cafe"), false);
            this.clearOutput();
            this.rubiSprite();
            //(First time)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_INTRODUCED] == 0) {
                this.outputText("You take a seat at a table and within seconds a young girl is at your side.  She hooks a finger around her ear, pulling her short black hair back and wedging a pencil behind the ear.  Smoothing down the front of her pink and white waitress uniform, she gives you a chipper smile.  \"<i>Hey hun, welcome to the Tel'Adre Bakery, I'm Rubi,</i>\" she says, giving a little curtsey.  \"<i>If you want any pastries or anything, just head on up to the counter and they'll take care of you.  If you need anything to drink: milk, tea or coffee, just flag me down and I'd be happy to help.</i>\"");
                ...
                this.flags[kFLAGS_1.kFLAGS.RUBI_INTRODUCED]++;
            }
            //(Approach repeat, relationship 0-19)
            else if (this.rubiAffection() < 30) {
                this.outputText("You take a seat at a table, and within seconds Rubi pulls up a chair next to you.  ");
            }
            //(Approach repeat, relationship 20+.  At this stage, randomly select an outfit from what the PC has given him, plus his waitress outfit.  Variants included for Bimbo /Incubus Rubi.)
                ...
                var choices = [1];
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_SUITCLOTHES] == 1)
                    choices[choices.length] = 2;
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_FETISH_CLOTHES] == 1)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_GREEN_ADVENTURER] == 1)
                    choices[choices.length] = 4;
                //(Tube Top (Normal))
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_TUBE_TOP] == 1)
                    choices[choices.length] = 5;
                //(Bodysuit (Normal))
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_BODYSUIT] == 1)
                    choices[choices.length] = 6;
                //(Long Dress (Normal))
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_LONGDRESS] == 1)
                    choices[choices.length] = 7;
                //(Tight Leather Pants (Normal))
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_TIGHT_PANTS] == 1)
                    choices[choices.length] = 8;
                //(Nurse Clothes (Normal))
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NURSE_CLOTHES] == 1)
                    choices[choices.length] = 9;
                //(Slutty Swimwear (Normal))
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_SWIMWEAR] == 1)
                    choices[choices.length] = 10;
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_BIMBO_MINIDRESS] == 1)
                    choices[choices.length] = 11;
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_BONDAGE_STRAPS] == 1)
                    choices[choices.length] = 12;
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_INQUISITORS_CORSET] == 1)
                    choices[choices.length] = 13;
                //RIsque waitress uniform
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] >= 100)
                    choices[choices.length] = 14;
                var select = choices[Rubi.rand(choices.length)];
                //trace("Rubi outfit selection = ", select);
                //(Random outfit selection: Waitress Outfit (Normal))
                if (select == 1) {
                    //(Waitress Outfit (Bimbo))
                    this.outputText(this.rubiMF("He", "She") + "'s dressed in [rubi eir] usual waitress uniform: a pink blouse and skirt covered by a frilly white apron.");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] >= 4)
                        this.outputText("  Rubi's breasts strain against the tight blouse, threatening to pop a button at any moment.");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] >= 9)
                        this.outputText("  You notice Rubi holds [rubi emself] a little awkwardly, and it's only when [rubi ey] sits down that you spy the slight bulge in [rubi eir] skirt.");
                }
                //(Suit Clothes (Normal))
                else if (select == 2) {
                    //(Suitclothes)
                    this.outputText(this.rubiMF("He", "She") + "'s dressed differently today, having foregone the normal waitress uniform for a professional black and white suit with a loose tie, though [rubi ey] still wears the waitress headband");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_HORNTYPE] > 0)
                        this.outputText("just behind the horns");
                    this.outputText(".  In a sexy sort of way, [rubi ey] looks like a girl dressed in her boyfriend's clothes");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] >= 4)
                        this.outputText(", though with [rubi eir] large bosom, [rubi ey] can't quite button up all the way, giving the appearance of a sexy secretary");
                    this.outputText(".");
                }
                else if (select == 3) {
                    //(Rubber Fetish Outfit (Bimbo))
                    //(Rubber Fetish Clothes)
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for a tight, black, rubber shirt, along with a skirt, and stockings.  The holes cut into the skirt, proudly displaying Rubi's ");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_NIPPLE_TYPE] > 0)
                        this.outputText("black ");
                    this.outputText("nipples, which stand at perky attention in the cool air.  Rubber straps crisscross the outfit in odd places, and the whole ensemble looks like something out of one of Mareth's many fetish dungeons.  The outfit draws attention to [rubi eir]");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] >= 4)
                        this.outputText(" impressive bosom, and sort of makes [rubi em] look like the kind of rubber doll one might buy for those lonely nights.");
                    else
                        this.outputText(" relatively flat chest, though with the rest of [rubi eir] figure, it's hard to imagine [rubi em] as anything but a woman.");
                }
                else if (select == 5) {
                    //(Tube Top)
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for a neon pink tube top and a pair of tiny denim shorts.");
                    //(D breasts or higher)
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] >= 4)
                        this.outputText("  [rubi Eir] breasts strain the fabric of the tube top, any wrong move threatening to have them burst forth.");
                    //(dick 9" or higher)
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] >= 4)
                        this.outputText("  [rubi Eir] rather large bulge can't be concealed, however, and you sometimes catch Rubi holding [rubi eir] notepad down across [rubi eir] crotch when [rubi ey] moves from table to table.");
                    else
                        this.outputText("[rubi Eir] bulge is well concealed at least.  You're sure it would take a skilled eye, or someone who knew what to look for, to notice Rubi's little package.");
                }
                else if (select == 6) {
                    //(Bodysuit)
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for an almost sheer bodysuit covering [rubi em] from the groin up to the neck.  The lacy outfit is covered with flowers and swirling, colorful decorations in strategically placed locations.");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] >= 9)
                        this.outputText("  However, with an outfit this tight, it's almost impossible for [rubi em] to hide [rubi eir] impressive package.  Rubi's cock pokes straight upwards, creating a bulge from [rubi eir] crotch up towards [rubi eir] belly button.");
                    else if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                        this.outputText("  However, with an outfit this tight you can see a slight outline where [rubi eir] small package is tucked away.  You wonder how many other patrons have noticed the same thing.");
                }
                else if (select == 7) {
                    //(Long Dress (Bimbo))
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for an elegant, sequined ballroom gown.");
                    if (this.rubiBimbo())
                        this.outputText("  [rubi Ey]'s even modified the dress with false gems and a slit up the side to show off [rubi eir] leg.");
                    this.outputText("  You are stunned by the breathtaking combination of classy and carnal.  You're sure [rubi ey] would look great at a fancy ball, but here at the bakery [rubi ey] looks out of place, especially as a waitress.");
                    //(Breasts flat or A cup)
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] <= 1)
                        this.outputText("  The dress must have come with a padded bra, because you're surprised to see Rubi with  breasts.  Though small, they help to accentuate [rubi eir] feminine figure.");
                }
                else if (select == 8) {
                    //(Tight Leather Pants (Bimbo))
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for a loose silk white shirt with tight black leather pants.");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] >= 4)
                        this.outputText("  With [rubi eir] large rack, [rubi ey] looks much like a busty piratess.  From the way [rubi eir] breasts strain at the top, you're certain that one wrong breath could send a button flying across the room.");
                    else
                        this.outputText("  With [rubi eir] relatively flat chest, however, you wonder if perhaps it makes [rubi em] look a bit too much like a man.  An effeminate man, but a man nonetheless.");
                    //Cock variants:
                    //(9" or higher)
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] >= 9)
                        this.outputText("  [rubi Eir] generous cock is on display, much to [rubi eir] chagrin, as a bulge running down the length of one pant leg.");
                    else
                        this.outputText("Luckily, given [rubi eir] relatively small package, [rubi eir] bulge is kept nice and secret even with the tightness of the clothing.");
                }
                else if (select == 9) {
                    //(Nurse Clothes (Bimbo))
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for a tight, one-piece white dress with a red cross over the breast pocket, and atop her head is perched a little white hat with the same red cross.  [rubi Ey] looks like the kind of nurse you'd expect to see in your dirty dreams, and you wonder how many bakery customers were thrown by Rubi's odd, albeit sexy, appearance today.");
                    //(D breasts or higher)
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] >= 4)
                        this.outputText("  Rubi's large breasts strain the fabric, drawing the dress further up [rubi eir] body and showing off more of [rubi eir] legs and ass.");
                }
                //(Slutty Swimwear (Normal))
                else if (select == 10) {
                    //(Slutty Swimwear)
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for an impossibly skimpy black bikini.  It's a cute swimsuit, and Rubi looks damn sexy in it, but you can't help but think it's more suited for a day at the beach and not a day working in a bakery.");
                    //(D breasts or higher)
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] >= 4)
                        this.outputText("  Rubi's tremendous cleavage threatens to spill out of the skimpy bikini top with every movement, and from the red faces around the bakery, you wonder if that's already happened.");
                    else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] <= 1)
                        this.outputText("  The top only emphasizes Rubi's relatively flat chest, though with the rest of [rubi eir] figure, [rubi ey] still looks extremely feminine.");
                }
                //(Minidress Outfit (Bimbo))
                else if (select == 11) {
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for an impossibly short strapless pink mini-dress.  The top barely comes up to cover [rubi eir] nipples, and you're sure [rubi ey] has to adjust it constantly to avoid any wardrobe malfunctions.  The bottom is so short [rubi ey]'s certainly giving a show to anyone behind [rubi em] whenever [rubi ey] leans forward.  All in all, Rubi looks like [rubi ey]'s ready for a night on the town and not a day waiting tables.");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                        this.outputText("  [rubi Eir] skirt rides so high you catch glimpses of [rubi eir] unsurprisingly unpantied crotch, and the enticing package held within.  You wonder how many people have gotten a surprise with their drinks today!");
                }
                //(Bondage Straps)
                else if (select == 12) {
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for a series of leather straps and hooks.  A series of leather belts cross [rubi eir] body, covering strategic areas with thicker, more pliable straps.  You wonder how comfortable such an outfit could be, and as you do so you notice Rubi dig out a wedgie when [rubi ey] thinks no one's looking.  How Rubi can continue to work at the bakery wearing this, you'll never know.");
                }
                //(Inquisitor's Corset)
                else if (select == 13) {
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for a tight red and gold corset, connected with garter straps to a pair of sheer black stockings.  The corset really enhances Rubi's naturally feminine figure, though you can't imagine it being too comfortable.  The black, opaque stockings come up to [rubi eir] thighs have an inlaid gold corset pattern on the back, which lead up to a pair of bows that bounce perkily as Rubi walks.");
                }
                //(Risque Waitress Uniform)
                else if (select == 14) {
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for an extremely modified version.  The skirt wrapped around [rubi eir] waist could be confused for a belt, and the apron (the only other thing covering [rubi eir] torso) doesn't extend much further.  Any time Rubi takes a step or bends in any direction, anyone within sight is sure to get a good look at [rubi eir] ");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                        this.outputText(this.rubiCock(33) + ", clad in a cute little frilly pink cocksock");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                        this.outputText(" and ");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0) {
                        this.outputText("feminine mound trapped beneath a pair of pink panties");
                        //(if Bimbo Brain)
                        if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0)
                            this.outputText(" trimmed feminine mons, free and open to the air");
                    }
                    this.outputText(".");
                    //(D breasts or higher)
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] >= 4)
                        this.outputText("  Rubi's breasts, large as they are, show off a decent amount of sideboob and threaten to spill out at any moment.  Judging by the flushed faces of some customers, this may have already happened.");
                    this.outputText("  This outfit, as risque as it is, is clearly something Rubi never would have worn before [rubi ey] met you.  [rubi Ey] must be really comfortable in [rubi eir] body now!");
                }
                this.outputText("\n\n[rubi Ey] hands you the usual menu and says, \"<i>");
                if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0)
                    this.outputText("Like, h");
                else
                    this.outputText("H");
                this.outputText("ere's the menu, babe.  Think about what you want and let me know when you're ready.</i>\"  [rubi Ey] stands and moves to clean off a nearby table, [rubi eir] red spaded tail swishing behind [rubi em] sensually.");
                //(Adventurer's Outfit)
                if (select == 4) {
                    this.outputText("[rubi Ey]'s dressed differently today, having foregone the normal waitress uniform for a large green tunic which looks more like a dress on [rubi em], along with brown tights and a pointed green hat.  At [rubi eir] waist is a wooden sword alongside [rubi eir] normal notepad.  Were Rubi more masculine, you might think [rubi ey] looks like an adventurer of some kind, but in reality [rubi ey] looks like a normal girl in a strange hat.");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] >= 4)
                        this.outputText("  In an odd sort of way, [rubi ey] looks like an adventurer who met the wrong end of a witch's curse.");
                }
                //(Default Waitress Uniform)
                if (select == 1) {
                    this.outputText("\n\nAs [rubi ey] bends over, you get a good look up [rubi eir] skirt, ");
                    if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0) {
                        this.outputText("surprised to see [rubi ey]'s wearing nothing at all underneath, showing off [rubi eir] asshole");
                        if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] == 0)
                            this.outputText(" and wet cunt");
                        else if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] > 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                            this.outputText(" and limp cock");
                        else
                            this.outputText(", wet cunt, and limp cock");
                        this.outputText(" to anyone behind [rubi em]");
                    }
                    else
                        this.outputText("excited to see Rubi's choice of frilly pink panties clinging to [rubi eir] supple ass");
                    this.outputText(".");
                }
                //(Dashing Outfit)
                else if (select == 8)
                ...
                //(Adventurer's Outfit)
                    ...
                    //If Bimbo Body:
                    if (this.rubiBimbo())
                        this.outputText("  You even spy a wet patch in the crotch, with rivulets of moisture running down the legs, which [rubi ey] must have trouble hiding... if [rubi ey] even bothers to try.");
                }
                //(Long Dress)
                else if (select == 7) {
                    this.outputText("\n\nAs [rubi ey] moves to another table, Rubi sways back and forth, as if dancing with an invisible partner.  ");
                    if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0)
                        this.outputText("And then [rubi ey] begins to shake [rubi eir] ass, making spanking motions and effectively ruining the air of sophistication.");
                }
                //(Nurse Uniform)
                else if (select == 9) {
                    this.outputText("\n\nAs [rubi ey] bends over, you get a good look up [rubi eir] skirt, ");
                    if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0) {
                        ...
                        this.outputText("excited to see Rubi's choice of frilly white panties clinging to [rubi eir] supple ass");
                    this.outputText(".");
                }
                //(Rubber Fetish Outfit)
                    ...
                    if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0) {
                        ...
                        this.outputText("excited to see a pair of translucent rubber panties clinging to [rubi eir] supple ass");
                    this.outputText(".");
                }
                //(Suitclothes)
                else if (select == 2) {
                ...
                //(Bimbo Minidress)
                    ...
                    if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0) {
                        ...
                        this.outputText("excited to see a cute, little thong wedged into [rubi eir] supple ass");
                    this.outputText(".");
                }
                //(Bodysuit)
                else if (select == 6) {
                    ...
                    //If Bimbo Body:
                    if (this.rubiBimbo())
                        this.outputText("  You even spy a moist patch in the crotch, which must be impossible to hide... if [rubi ey] even bothers to try.");
                }
                //(Bondage Straps)
                else if (select == 12) {
                ...
                //(Risque Waitress Uniform)
                    ...
                    if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0) {
                        ...
                        this.outputText("excited to see a pair of pink frilly panties clinging to [rubi eir] supple ass");
                    this.outputText(".");
                }
            }
        ...
        buyRubiMilk() {
            ...
            if (this.rubiAffection() >= 30 && this.flags[kFLAGS_1.kFLAGS.RUBI_ADMITTED_GENDER] == 0)
        ...
        getTeaFromRubi() {
            ...
            //(Relationship 0-19)
            if (this.rubiAffection() < 30) {
                this.outputText("You flag Rubi down and tell her you'd like to order a cup of tea.  She nods and soon you've got a piping hot cup of fragrant tea in front of you.  \"<i>It's our relaxing blend, soothes the body and mind,</i>\" she says.  You take a sip and sigh.  It is indeed relaxing.");
            ...
            //(Relationship 20+, normal Rubi)
                ...
                this.outputText("You flag Rubi down and tell [rubi em] you'd like to order a cup of tea.  [rubi Ey] nods and soon you've got a piping hot cup of fragrant tea in front of you.  \"<i>It's our relaxing blend, soothes the body and mind,</i>\" [rubi ey] says.  You take a sip and sigh.  It is indeed relaxing.");
        ...
        chatWithRubi() {
            ...
            if (this.rubiAffection() < 15) {
                this.outputText("You decide not to order anything to drink, instead taking the chance to talk with your waitress, Rubi, whenever [rubi ey]'s available.  You talk of pleasant but inconsequential things.  Rubi talks of growing up in a town far away, an actual human village, which was later raided by demons.  [rubi Ey] lived off the land for a while, drinking down one too many bottles of mysterious milk which gave [rubi em] the tail she now possesses.  [rubi Ey] eventually found Tel'Adre and was taken in by a kindly trio of ferret-morphs.  [rubi Ey] talks wistfully of home, and [rubi eir] green eyes shimmer with a faraway look for a moment before [rubi ey] snaps back to reality.");
            ...
            //(Relationship 40, Bimbo Rubi)
                ...
                this.outputText("You decide not to order anything to drink, instead taking the opportunity to hang out with Rubi whenever [rubi ey] has a free moment.  You talk of pleasant but inconsequential things.  Rubi spends some time discussing the fashion movements of Tel'Adre and how they're nothing like the fashion in [rubi eir] home village, an honest-to-goodness human village.  [rubi Ey] mentions how everyone back 'home' dressed so conservatively, not like the sexy body-baring fashions here.  Rubi even says how glad [rubi ey] is that demons attacked those years ago, so that [rubi ey] could come here and start her new life with hot new clothes and a new body.");
        ...
        rubisFuckingHouseYouPervert() {
            this.outputText(this.images.showImage("rubi-at-house"), false);
            this.clearOutput();
            this.rubiSprite();
            //(Not available to those with a centaur, naga or drider body.)
            //(First Time?)
            if (this.flags[kFLAGS_1.kFLAGS.RUBIS_HOUSE_FIRST_TIME] == 0) {
                this.outputText("Rather than order anything, you stop Rubi as he's going by your table and pull [rubi em] close.  \"<i>How about we get out of here?</i>\" you whisper into [rubi eir] ear.");
                ...
                this.flags[kFLAGS_1.kFLAGS.RUBIS_HOUSE_FIRST_TIME]++;
            }
            //Bimbo Shopping!
            else if (this.rubiBimbo() && (this.player.findPerk(PerkLib_1.PerkLib.BimboBrains) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.FutaFaculties) >= 0) && Rubi.rand(7) == 0) {
                this.flags[kFLAGS_1.kFLAGS.RUBI_BIMBO_MINIDRESS] = 1;
                this.outputText("Rather than order anything, you stop Rubi as she's going by your table and pull her close.  \"<i>How about we get out of here?</i>\"  you whisper into her ear.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_GOT_BIMBO_SKIRT] == 0) {
            ...
            //(Repeat, Bimbo Rubi)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_PROSTITUTION] == 2 && this.flags[kFLAGS_1.kFLAGS.RUBI_PROFIT] > 0) {
                    ...
                    this.player.gems += this.flags[kFLAGS_1.kFLAGS.RUBI_PROFIT];
                    this.flags[kFLAGS_1.kFLAGS.RUBI_PROFIT] = 0;
            ...
            //Repeat unirubi variant
                ...
                this.outputText("Rather than order anything, you stop Rubi as [rubi ey]'s going by your table and pull [rubi em] close.  \"<i>How about we get out of here?</i>\" you whisper into [rubi eir] ear.");
            ...
            if (this.rubiAffection() >= 50 && !this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0 && (!this.rubiBimbo() || this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] > 0)) {
                //First Time:
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_RUBI_MASSAGED] == 0)
            ...
            if (this.player.isNaga() && this.flags[kFLAGS_1.kFLAGS.RUBI_BIMBO] == 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] < this.player.biggestCockLength() && this.player.hasCock() && this.flags[kFLAGS_1.kFLAGS.RUBI_SHE] == 0 && this.player.cor >= 85 && this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] <= 2) {
        ...
        rubiSexMenu() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] > 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_ORGASM_DENIAL] > 0 && !this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.addButton(3, "Release", this.releaseRubi);
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] >= 75 && this.rubiCapacity() < this.player.biggestCockArea() && this.player.hasCock())
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] >= 75 && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] >= 5)
                this.addButton(5, "Get Fucked", this.getFuckedByRubi);
            //Hotdogging
            //PC hotdogs Rubi's ass
            //PC must have a penis
            if (this.player.hasCock())
                this.addButton(6, "Hotdogging", this.rubiHotdogging);
        ...
        rubiIdentity() {
            ...
            this.rubiSprite();
            //Identity
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_DISCUSSED_RUBIS_IDENTITY] == 0) {
                this.outputText("You've noticed Rubi always refers to himself as a \"he\", despite ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 1)
                    this.outputText("his attempts to appear otherwise");
                else
                    this.outputText("his relatively recent transformation to the contrary");
                this.outputText(".  Questioning him about it, he simply blushes.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0)
                    this.outputText("  Though now that I am, I absolutely love it!");
                this.outputText("</i>\" he confides, fidgeting slightly.  \"<i>If you wanted to call me a \"she\", I'd be OK with that, just so you know.</i>\"");
                this.outputText("\n\nWhich type of pronoun would you prefer Rubi to use?");
            }
            //(Repeating?)
            else {
                this.outputText("You talk with Rubi at length about [rubi eir] gender identity again.  All in all, [rubi ey] seems pretty open to being either gender, with no real preference one way or another as long as [rubi ey] gets [rubi eir] pretty dresses.");
                this.outputText("\n\nWhich type of pronoun would you prefer Rubi to use?");
            }
            this.flags[kFLAGS_1.kFLAGS.TIMES_DISCUSSED_RUBIS_IDENTITY]++;
            //[He] [She]
            this.menu();
        ...
        rubiIsAHe() {
            this.clearOutput();
            this.rubiSprite();
            this.flags[kFLAGS_1.kFLAGS.RUBI_SHE] = 0;
        ...
        fuckRubi() {
            ...
            this.rubiSprite();
            //(-100 Arousal)
            this.outputText("You take Rubi by the hand and head into the bedroom, clutching [rubi em] close.  You sit on the edge of the soft fluffy bed and pull the little demon " + this.rubiMF("boy", "girl") + " onto your lap.  The two of you kiss, letting your " + this.tongueDescript() + " explore the depths of your partner's mouth.");
            ...
            if (this.player.hasCock()) {
                if (this.player.cocks[x].cockLength <= 4)
                    size = 0;
                else if (this.player.cockThatFits(this.rubiCapacity()) >= 0)
                    size = 1;
                else
                    size = 2;
            }
                ...
                if (this.player.clitLength <= 4)
                    size = 0;
                else if (this.player.clitLength <= 12 || this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])
                    size = 1;
                else
                    size = 2;
            }
            if (size == 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] <= 5)
                    this.outputText("I guess we're in the same boat.</i>\"");
                else if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0)
                    this.outputText("That's too bad, I was soooo looking forward to a real fucking.</i>\"");
                else
                    this.outputText("That's pretty sad, getting shown up by a dainty little thing like me...</i>\"");
            }
            else if (size == 1)
            ...
            this.outputText(", Rubi slips off your lap and kneels on the floor.  [rubi Ey] pauses a moment, taking in your ");
            if (this.player.hasCock())
                this.outputText(this.cockDescript(x));
            else
                this.outputText("[clit]");
            this.outputText(" with [rubi eir] eyes before leaning in and giving it a tentative lick, which sends a shiver up your spine.  Seeing that, [rubi ey] gives a little smile and licks again, running [rubi eir] smooth tongue all along the length of your ");
            if (this.player.hasCock())
                this.outputText("swollen member");
            else
                this.outputText("impressive love button");
            this.outputText(".  Rubi's mouth dances along its length, at times flicking delicately and at others slurping loudly.  [rubi Eir] tongue ripples along the underside of ");
            if (this.player.hasCock())
                this.outputText("your cockhead");
            else
                this.outputText("the tip of your clit");
            this.outputText(", sending shivers of pleasure up your spine.");
            //(If Cock)
            if (this.player.hasCock())
                this.outputText("  Amazingly, with the expert ministrations of your lover's mouth, you can't hold yourself in much longer, and begin to tense up, but at the last minute you pull yourself away from Rubi's grip and lips, halting yourself before you can cum.");
            ...
            if (size < 2) {
                ...
                if (this.player.hasCock())
                    ...
                    this.outputText("[clit]");
                this.outputText(" at [rubi eir] tight ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] > 0)
                    this.outputText("tailhole");
                else
                    this.outputText("pussy");
                this.outputText(", rubbing the mixture of [rubi eir] saliva and your juices into [rubi eir] cleft to get [rubi em] suitably lubricated before the real fun begins");
                if (this.rubiBimbo())
                    this.outputText(", not that [rubi ey] needs the extra lubrication, as [rubi ey]'s practically dripping like a faucet");
                this.outputText(".");
                this.outputText("  You press forward, sinking your entire length into Rubi's depths, which clench and unclench sensually.  Aided by the additional lubrication, you slip easily in and out, pumping slowly at first.");
            }
            //(These two paragraphs for cocks over 24 area)
                ...
                if (this.player.hasCock())
                    ...
                    this.outputText("[clit]");
                this.outputText(" at the space just below [rubi eir] ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] > 0)
                    this.outputText("balls");
                else
                    this.outputText("cunt");
                this.outputText(", rubbing the mixture of [rubi eir] saliva and your juices into [rubi eir] legs to get [rubi em] suitably lubricated before the real fun begins");
                //(if bimbo)
                if (this.rubiBimbo())
                    this.outputText(", not that [rubi ey] needs the extra lubrication, as she's practically dripping like a faucet, which dribbles down [rubi eir] legs suitably enough");
                this.outputText(".");
                ...
                if (this.player.hasCock())
                    ...
                    this.outputText("[clit]");
                this.outputText(" slipping between Rubi's thighs, which grip you tightly.  You feel [rubi eir] ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                    this.outputText("hard cock");
                else
                    this.outputText("stiff clit");
                this.outputText(" pressing against the top of ");
                if (this.player.hasCock())
                    this.outputText("your dick");
                else
                    this.outputText("your clit");
                this.outputText(", and know that with every thrust you give, [rubi ey]'ll get a good thrill too.");
            }
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_ORGASM_DENIAL] > 0 && !this.rubiBimbo())
                this.outputText("  You give Rubi's ass a hard smack and remind [rubi em] that no matter what happens, [rubi ey] still can't cum yet.  [rubi Eir] eyes flutter open and [rubi ey] actually whimpers a little, but can't form the words to object.");
            //(If Orgasm Denial is NOT activated; male/herm Rubi)
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText("  Rubi’s body shivers and trembles, and almost collapses.  [rubi Ey] grasps at the blankets with wild abandon as ropes of pearly white cum erupt from [rubi eir] cock, splattering against [rubi eir] chest and the blankets.");
            //(Female Rubi)
            else
                this.outputText("  Rubi's body shivers and trembles, and [rubi ey] almost collapses.  [rubi Ey] grasps at the blankets with wild abandon and gives and orgasmic scream as [rubi eir] cunt clenches and unclenches fiercely.  A spray of femjuices erupts outwards from [rubi em], coating your crotch and dripping down both yours and [rubi eir] legs.");
            ...
            if (this.player.hasCock() && this.player.cockArea(x) <= this.rubiCapacity()) {
                this.outputText("Your " + this.cockDescript(x) + " engorges for a second before erupting deep inside your demonic little fucktoy.  ");
                if (this.player.cumQ() < 250)
                    this.outputText("Cum dribbles out from [rubi eir] hole as you give a couple extra thrusts.");
                else if (this.player.cumQ() < 1000)
                    this.outputText("A generous amount of cum trickles from [rubi eir] depths as you give a couple extra thrusts.");
                else if (this.player.cumQ() < 2000) {
                    this.outputText("Cum practically floods from  [rubi eir] abused ");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] > 0)
                        this.outputText("ass");
                    else
                        this.outputText("cunt");
                    this.outputText(" as you give a couple extra thrusts.");
                }
            }
            else if (this.player.hasCock()) {
                this.outputText("Your " + this.cockDescript(x) + " engorges for a second before erupting beneath Rubi, splattering [rubi em] and the blankets ");
                if (this.player.cumQ() < 250)
                    this.outputText("with a fair amount of your seed.");
                else if (this.player.cumQ() < 1000)
                    this.outputText("with a generous amount of your spunk.");
                else
                    this.outputText("with a veritable torrent of potent pearlescent spooge.");
            }
            //(Player has clit?)
            else
                this.outputText("  Your " + this.clitDescript() + " throbs and engorges briefly as your " + this.vaginaDescript(0) + " reflexively contracts and a warm feeling rocks through your entire body.  Femjuices run down your [legs] and relief overtakes you like a powerful wave upon a beach.");
            this.outputText("\n\nYou stumble backwards, pulling your " + this.cockClit(x) + " out of Rubi and collapse on the bed next to [rubi em].  [rubi Ey] cuddles up next to you, in a mixed puddle of spunk, and hugs you close.  \"<i>That was ");
            if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0)
                this.outputText("like, totally ");
            else
                this.outputText("absolutely ");
            this.outputText("fantastic babe,</i>\" [rubi ey] murmurs before drifting off into a sex-filled dreamland.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_ORGASM_DENIAL] > 0)
                this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS]++;
        }
        //Dildo Fuck
        //(If the PC has the Deluxe Dildo) (If Orgasm Denial is activated, adds +2 to Blue Balls (Yay arousal drugs!))
        dildoFuckRubi() {
            this.outputText(this.images.showImage("rubi-dildo-fuck"), false);
            this.clearOutput();
            this.rubiSprite();
            //(If PC has no cock)
            if (!this.player.hasCock())
                this.outputText("You don't have the equipment to give Rubi a good fucking, but there is one thing you do have.");
            //(If PC has cock)
            else
                this.outputText("While you do have the requisite equipment to give Rubi a good fucking, you'd much rather use something else.");
            //(Add)
            this.outputText("  You produce the goblin-made dildo from your pack, and Rubi's eyes immediately go wide.  \"<i>Wow,</i>\" [rubi ey] says, reaching out to touch it.  [rubi Ey] runs [rubi eir] hands along its length, marveling at its color, shape and size.");
            ...
            if (this.player.hasVagina())
                this.outputText("You press the tip into your cunt quickly, giving it a taste of what is to come.  The brief contact is enough to make you shudder slightly with pleasure.  ");
            //(If PC has fuckable nipples)
            if (this.player.hasFuckableNipples())
                this.outputText("You let the dildo meander up your body until it reaches your breasts, and with a bit of a grin you insert the tip right into one nipple, enjoying the feeling of your breasts swell up with arousal.  You do the same with the other nipple, and take a minute going back and forth.  ");
            this.outputText("Finally you bring the dildo up to your mouth, licking the juices off of it, eagerly downing the goblin sex-drug.");
            ...
            //(Normal/Incubus Rubi)
            if (!this.rubiBimbo())
                this.outputText("They part shakily and [rubi eir] tongue reaches out to taste the dildo.  ");
            //(Bimbo Rubi)
            else
                this.outputText("They easily part, and [rubi eir] tongue takes a long slurp, just to taste the dildo.  ");
            this.outputText("[rubi Ey] apparently finds it pleasing, because [rubi ey] immediately wraps [rubi eir] lips around the tip, sucking and bobbing on it like it was a real cock.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 1)
                this.outputText("against [rubi eir] tight ass");
            else
                this.outputText("against [rubi eir] tight pussy");
            this.outputText(", which resists a little at first, but once the drug has a moment to work, it slips right in.  Rubi actually coos a little as it slips inside.");
            ...
            //(If player has pussy)
            if (this.player.hasVagina())
                this.outputText("  Your " + this.clitDescript() + " stiffens, aching for attention.  It peeks from your folds like a shy little lewd faerie.");
            //(If player has a cock)
            if (this.player.hasCock())
                this.outputText("  Meanwhile, [eachCock] stiffens, throbbing as the drug overtakes it.");
            if (this.player.lactationQ() > 0)
                this.outputText("  As the warmth spreads up your body, not even your breasts are left alone.  Your nipples harden and begin leaking milk, which pours down the sides of your body and is soaked up into the cushions beneath you.");
            ...
            //(Orgasm Denial on?)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_ORGASM_DENIAL] > 0)
                this.outputText("\n\nIn a sudden moment of clarity, you raise your head and look straight at Rubi, shouting that [rubi ey]'d better not cum during all this, or else you'll be quite upset.  [rubi Eir] eyes go wide, \"<i>W—What?  I need to cum, " + this.player.mf("sir", "miss") + "!  My body, it's so hot!</i>\"  You growl that it's expressly forbidden, and that [rubi ey]'d better learn to control [rubi em]self, or else.");
            //(Normal/Incubus Rubi, Orgasm Denial off)
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0) {
                this.outputText("\n\n[rubi Eir] body shudders and convulses, and [rubi eir] ");
                if (!this.rubiIncubus())
                    this.outputText("little cock");
                else
                    this.outputText("demonic cock");
                this.outputText(" twitches, launching jets of cum onto [rubi eir] stomach, chest and face.  In [rubi eir] sex-filled stupor, [rubi ey] eagerly swallows down whatever lands in [rubi eir] mouth, and actually uses [rubi eir] fingers to collect the rest , gulping that down as well.");
            }
            //(Bimbo/Female Rubi)
            else {
            ...
            //(PC has cock?)
            if (this.player.hasCock())
                this.outputText("[eachCock], stroking it fervently, in desperate need of release.");
            //(PC doesn't have cock, but has pussy?)
            else if (this.player.hasVagina())
                this.outputText("your " + this.clitDescript() + ", rubbing it frantically, in desperate need of release.");
            //(PC doesn't have either, but breasts above A-cup?)
            else
                this.outputText("your [chest], rubbing your nipples vigorously, in desperate need of release.");
            //(Bonus, fuckable nipples?)
            if (this.player.hasFuckableNipples())
                this.outputText("  Your fingers easily slip inside each nipple, pumping in and out like little cocks.");
            //(No cock, no pussy, no breasts?)
            if (this.player.gender == 0 && this.player.biggestTitSize() == 0)
                this.outputText("  Your hands roam all along your body, from your bare crotch to your nipples, even through your hair, all in search of something to give you the release you so desperately crave.");
            ...
            //(PC has cock?)
            if (this.player.hasCock()) {
                this.outputText("  [EachCock] twitches and shudders, loosing several jets of cum onto your body, ");
                if (this.player.cumQ() < 250)
                    this.outputText("splattering messily");
                else if (this.player.cumQ() < 500)
                    this.outputText("coating you lightly");
                else if (this.player.cumQ() < 1000)
                    this.outputText("covering you in a copious layer of cum");
                else
                    this.outputText("covering you in a thick layer of your potent seed");
                this.outputText(".");
            }
            //(PC has pussy?)
            if (this.player.hasVagina())
                this.outputText("  Your " + this.vaginaDescript(0) + " clenches down on the enormous invader, which at this point feels like an enormous steel rod lodged firmly inside you, and a spray of fem-juices erupts from your nethers, coating the already slick dildo and Rubi.");
            //(PC lactating?)
            if (this.player.lactationQ() > 0)
                this.outputText("  Your breasts shudder and quake as the orgasmic tsunami washes over them, spraying your sweet smelling milk all over yourself, Rubi and the couch.");
            ...
            this.outputText(" with a slight smile on [rubi eir] face, and says, \"<i>Well, that was interesting.</i>\"  You laugh at the understatement of the century, and stand, helping Rubi up off the couch as well.");
            ...
            this.rubiAffection(1);
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_ORGASM_DENIAL] > 0)
                this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] += 2;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Tease
        teaseRubi() {
            this.outputText(this.images.showImage("rubi-tease"), false);
            this.clearOutput();
            this.rubiSprite();
            //(Normal and Incubus Rubi.  Activates Orgasm Denial and adds 1 to Blue Balls.)
            this.flags[kFLAGS_1.kFLAGS.RUBI_ORGASM_DENIAL] = 1;
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0) {
                this.outputText("Having something quite different in mind, you order Rubi to strip down.  With a curious look on [rubi eir] face, [rubi ey] does so, slowly.  Each garment [rubi ey] peels from [rubi eir] soft ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 0)
                    this.outputText("pale");
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 2)
                    this.outputText("fur-covered");
                else
                    this.outputText("red");
                this.outputText(" skin seems to take an eternity, until finally [rubi ey]'s standing in front of you in naught but [rubi eir] panties.");
                this.outputText("  [rubi Eir] [rubi cock] seems to strain at the panties, aching to be let free.  Standing, you move behind Rubi and sensually whisper into [rubi eir] ear, nibbling and kissing [rubi eir] neck between words.  You tell [rubi em] that, until you specify otherwise, [rubi ey] is not to cum under any circumstances.  If [rubi ey] does, [rubi ey]'ll be severely punished.  Rubi visibly gulps and nods [rubi eir] assent.");
                //(Taller than 5')
                ...
                //(Normal Rubi)
                this.outputText("  [rubi Ey] blushes, looking back at you with a curious, yet lustful expression.  [rubi Ey] gulps and lifts [rubi eir] tail, giving you free access to [rubi eir] pantied rump.");
                ...
                this.outputText("\n\n\"<i>Nnng,</i>\" Rubi grunts, gripping the couch cushions.  You make sure to remind [rubi em] [rubi ey] can't cum under any circumstances.  [rubi Ey] nods, and says, \"<i>Y—Yes " + this.player.mf("sir", "miss") + ".</i>\"");
                ...
                this.outputText("\n\n\"<i>Aah, " + this.player.mf("sir", "miss") + ", I can't take much more of this,</i>\" [rubi ey] says, half way between a whisper and a moan.");
            ...
            //Girl Rubi!
                ...
                this.outputText("Having something quite different in mind, you order Rubi to strip down.  With a curious look on [rubi eir] face, [rubi ey] does so, eagerly.  Each garment [rubi ey] peels from [rubi eir] soft ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 0)
                    this.outputText("pale");
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 1)
                    this.outputText("crimson");
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 2)
                    this.outputText("furred");
                else
                    this.outputText("striped");
                this.outputText(" skin seems to take an eternity.  In fact, [rubi ey] seems to take great delight in stripping, giving little twirls and tossing [rubi eir] clothes towards you, until [rubi ey]'s standing in front of you in naught but [rubi eir] birthday suit.");
                ...
                this.outputText("  \"<i>Ooh, YES, right there,</i>\" Rubi gasps.  Your hand pinches [rubi eir] clit tight, eliciting a yelp and a coo of pleasure at the same time.");
        ...
        //Release
        releaseRubi() {
            this.outputText(this.images.showImage("rubi-orgasm-denial-release"), false);
            this.clearOutput();
            this.rubiSprite();
            //Will deactivate Orgasm Denial.  To start Denying again, the PC will have to Tease.
            this.flags[kFLAGS_1.kFLAGS.RUBI_ORGASM_DENIAL] = 0;
            this.outputText("You order Rubi to strip down.  Knowing the drill, [rubi ey] does so slowly.  There's no striptease, no show, [rubi ey] just disrobes as quickly as possible until [rubi ey]'s standing in naught but [rubi eir] panties, ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText("[rubi eir] [rubi cock] straining at the seams, trying to break free.");
            else
                this.outputText("clinging tight to [rubi eir] flat little mound.");
            ...
            //(If Blueballs 1-3)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 3) {
                this.outputText("  Not to mention [rubi eir] tiny balls");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_BALLS_TYPE] == 1)
                    this.outputText(", trapped in their little sissy sack");
                this.outputText(", which you think have swelled somewhat, although you haven't been teasing [rubi em] long.");
            }
            //(if Blueballs 4-9)
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 9)
                this.outputText("  Not to mention [rubi eir] sizeable balls, which seem to have swelled up to twice their normal size, thanks to your relentless teasing.  They even have a slight bluish tinge to them, although it's not immediately visible.");
            else
                this.outputText("  Not to mention [rubi eir] enormous balls, which, thanks to your endless teasing, are seemingly the size of baseballs.  They even have a noticeable blue tinge to them, obviously aching for relief.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 3)
                ...
                this.outputText("slightly blue");
            else
                this.outputText("incredibly swollen blue");
            this.outputText(" balls.  Once it's properly lubed up, you press two fingers inside.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText("P-spot");
            else
                this.outputText("G-spot");
            //else outputText("most sensitive spot");
            this.outputText(".  When Rubi jerks and wiggles involuntarily, you know you've found it.  Pre-cum begins leaking from Rubi's [rubi cock] in copious amounts, running down your hand and arms, and forming a puddle on the coffee table.  Rubi's body trembles and shakes, wriggling on the table like a fish out of water.");
            this.outputText("\n\nFeeling a little more adventurous, you slip a third finger into the little demon " + this.rubiMF("boy", "girl") + "'s ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText("rectum");
            else
                this.outputText("folds");
            this.outputText(".  With all three fingers you press and massage [rubi eir] prostate, increasing the amount of pre-cum flowing from [rubi eir] tip.");
            ...
            //(Blueballs 1-3)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 3)
                this.outputText("  It's quickly followed by another, less forceful jet of pearly white cum, which lands on [rubi eir] face, and several even smaller jets which splatter the area around [rubi em].  [rubi Eir] cock twitches and spasms, then slowly softens.");
            //(Blueballs 4-5)
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 5)
                this.outputText("  It's quickly followed by another, less forceful jet of pearly white cum, then another, and another, each landing closer to [rubi eir] face.  Finally, it gives a few more token jerks, spurting out tiny globules of cum onto the surrounding area.  [rubi Eir] cock twitches and spasms, squirting nothing but air, as if [rubi eir] body is still craving release.");
            //(Blueballs 6-7)
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 7)
                this.outputText("  It's quickly followed by another, more forceful jet of pearly white cum which splatters against the ceiling, dripping down onto the both of you.  Another spurt of cum bursts forth, then another, and another, each one liberally covering Rubi's stomach, chest and face.  [rubi Eir] cock finally gives a few last twitches and spasms, squirting nothing but air, as if [rubi eir] body is still craving release.");
            //(Blueballs 8-9)
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 9)
                this.outputText("  It's quickly followed by another, more forceful jet of pearly white cum, which splatters against the ceiling, dripping down onto the both of you, and then another, and another.  It isn't long before the ceiling has a huge white cum-covered blotch right above you, drizzling down on you like dew dripping from trees.  Rubi's cock doesn't stop there, however, it continues twitching and spurting [rubi eir] seed until [rubi ey] is completely covered in the stuff.  Finally, mercifully, it ends, though [rubi eir] [rubi cock] continues to spasm, squirting nothing but air, as if [rubi eir] body is still craving release.");
            //(Blueballs 10+)
            else
                this.outputText("  It's quickly followed by another, more powerful jet of pearly white cum, which splatters against the ceiling, dripping down onto the both of you, and then another, and another.  It isn't long before the ceiling has a huge white cum-covered blotch right above you, drizzling down on you like dew dripping from the trees.  Rubi's cock doesn't stop there, however, it continues twitching and spurting [rubi eir] seed, liberally covering [rubi em]self, you and the surrounding area until everything appears to be in a white haze.");
            ...
            //(Blueballs 1-5)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 5)
                this.outputText("You clean yourself up, leave Rubi a little \"<i>See you next time</i>\" note, and head out the door, back to camp.");
            //(Blueballs 6-9)
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 9)
                this.outputText("You head into the bathroom and wash the cum off you, taking a short shower.  Afterwards, you dry up, leave Rubi a little \"<i>See you next time</i>\" note, and head out the door, back to camp.");
            //(Blueballs 10+)
            else
                this.outputText("You head into the bathroom and wash the cum off you, no easy feat to be sure.  Afterwards, you dry up, leave Rubi a little \"<i>See you next time</i>\" note, and head out the door, back to camp.  You certainly don't want to be there when [rubi ey] wakes up, lest you have to clean the entire house with [rubi em].");
            this.rubiAffection(this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS]);
            this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] = 0;
            this.flags[kFLAGS_1.kFLAGS.RUBI_ORGASM_DENIAL] = 0;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Cheating Rubi
        cheatingRubi() {
            ...
            this.outputText("You take a seat at a table, expectantly waiting for Rubi to slide into your lap...  but she never does.  You look around the place for her, but again, there's no sight of her.  You flag down Dia, the caninemorph waitress, who looks haggard, and inquire as to the location of her co-worker.");
        ...
        findBimboCheatster() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You let out a disgruntled sigh.  Rubi's seeing someone else?!  Not on your watch!  You leave the bakery and make your way towards her neighborhood.  It doesn't take long, you've gone with her there enough times to memorize the path, even without her leading.");
        ...
        interruptTheNTRsYouCrazyFool() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("No one's sticking their dick in your ");
            if (this.silly())
                this.outputText("waifu");
            else
                this.outputText("slut");
            this.outputText(" if you've got a say in it!  You get out of your hiding place, shout a word of warning and burst inside the vibrant pink house.");
        ...
        waitAndGetNTRedLikeTheBoyBitchYouAre() {
            ...
            if (!this.player.isTaur()) {
                ...
                this.outputText("\n\n");
            this.outputText("The two go on like this for five minutes, then ten, then fifteen.  Each position, you find, is more intriguing than the last.  ");
            if (this.silly())
                this.outputText("They're even doing positions that aren't available in the game!  ");
            this.outputText("Half an hour later, Rubi and the wolfman sit exhausted on the couch, his seed pouring from each of her holes.");
        ...
        NTRbimboBitchResolution() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You look at Rubi and say that you're definitely going to have to talk about what just happened.");
        ...
        noBimboNTR() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("Folding your arms, you shake your head.  You tell her that if this is going to work out, she has to remain faithful to you.  Sex toys and masturbation will have to do to keep her \"<i>urges</i>\" under control.  She looks a little sad, but nods as you speak.");
            ...
            this.flags[kFLAGS_1.kFLAGS.RUBI_PROSTITUTION] = -1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //(Yes)
        yesBimboNTR() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You contemplate it for a moment, and then slowly nod your head.  What's the harm in letting her blow off steam?  You know she'll always come back to you.  You assent to her wishes, to which she squeals and hugs you tightly, tossing the pink cushion aside.");
        ...
        breakUpWithRubi() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You think about it for a long moment and then sigh sadly.  You look Rubi dead in the eyes and explain you can't be with a woman who wants to cheat on her partner.  Tears form in her eyes as she sniffles, but she nods with you.");
            ...
            this.flags[kFLAGS_1.kFLAGS.RUBI_PROSTITUTION] = -2;
            this.flags[kFLAGS_1.kFLAGS.RUBI_DISABLED] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //(Pimp)
        pimpOutRubi() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You think about it for a long while, mulling over all the possibilities.  Then something else occurs to you. She wants help controlling her urges, why not make a little money in the meantime?  You explain that she's free to sleep with whoever she wants, but that she could charge them for her time.  After all, if you're going to do what you love, you may as well get paid for it.");
        ...
        chocoRubiMassage() {
            ...
            if (this.player.cor >= 66)
                this.outputText("start sensually undressing, turning the simple act into a seductive show that causes Rubi's petite boner to jerk unpredictably beneath [rubi eir] clothes.  A small, damp stain appears at the tip by the time you finish your salacious tease.");
            else if (this.player.cor >= 33)
                this.outputText("get undressed without much pause or fanfare.  Rubi makes a show of turning [rubi eir] head, but you can see [rubi em] peeping glimpses out of the corners of [rubi eir] eyes, and [rubi eir] boner seems to be bigger and harder than it was moments before.");
            else {
                this.outputText("make [rubi em] turn around while you undress.  You quickly shuck your clothes and ask [rubi em] what to do next, holding a hand across your [chest] and groin");
                if (this.player.biggestCockArea() >= 40 || this.player.biggestTitSize() >= 8)
                    this.outputText(", not that it does much good");
                this.outputText(".");
            }
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_RUBI_MASSAGED]++;
            //[Release] [Nope]
        ...
        bottleUpRubiMassage() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You bite the strawberry in half and mouth, \"<i>No, not yet.  Just let it build up.</i>\"  [rubi Ey] whines plaintively, but you cock your head to the side and say, \"<i>Come on, do it for me.  Just, don't let any out....  Here, come off of there and come into bed with me.  We can snuggle and let you relax a bit.</i>\"");
        ...
        releaseRubiMassage() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You figure after all the pampering [rubi ey] did, [rubi ey] deserves a treat.");
        ...
        //Closet
        goInRubisClosetSoThatYouCanComeOutOfTheCloset() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You ask to see Rubi's wardrobe.  [rubi Eir] eyes light up and [rubi ey] claps [rubi eir] hands together excitedly.  \"<i>");
            if (this.rubiBimbo() && this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0)
                this.outputText("Oh my god!  ");
            this.outputText("Really?  It's right over here!</i>\"  Rubi clasps your hand and drags you into the bedroom, then through another doorway.");
        ...
        //Appearance
        rubiAppearance() {
            this.outputText(this.images.showImage("rubi-inspect-appearance"), false);
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You look over your naked, demon-morph lover.");
            this.outputText("\n\nRubi is about five feet tall, with a very lithe, feminine body.  [rubi Eir] skin is ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 0)
                this.outputText("pale, almost like porcelain");
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 1)
                this.outputText("an exotic cherry red");
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 2)
                this.outputText("covered with a fine layer of silky-smooth pink fur");
            else
                this.outputText("an exotic cherry red which contrasts well with a grey belly and stripes that run up and down [rubi eir] legs and arms");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                this.outputText(" and completely hairless, except for [rubi eir]");
            else
                this.outputText(", and [rubi ey] sports");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_HAIR_LENGTH] == 0)
                this.outputText(" short");
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_HAIR_LENGTH] == 1)
                this.outputText(" shoulder-length");
            else
                this.outputText(" long");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_HAIR] == 0)
                this.outputText(" black");
            else
                this.outputText(" blonde");
            this.outputText(" hair, which [rubi ey] keeps cut in a cute, feminine style.  Rubi's face is soft and rounded");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_WHISKERS] > 0)
                this.outputText(", with a cute set of whiskers sprouting from [rubi eir] cheeks");
            this.outputText(", [rubi eir] lips painted a ");
            //(normal/furry skin)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 0 || this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 2)
                this.outputText("crimson red");
            //(red/siren skin)
            else
                this.outputText("dusky black");
            this.outputText(", [rubi eir] ");
            //if(flags[kFLAGS.RUBI_EYE_TYPE] == 1) outputText("slitted ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_EYE_TYPE] == 0 || this.rubiBimbo())
                this.outputText("green");
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_EYE_TYPE] == 1)
                this.outputText("solid black");
            //else outputText("black");
            this.outputText(" eyes framed with eyeliner, belying [rubi eir] masculine origins.  ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_HORNTYPE] > 0)
                this.outputText("Two tiny horns extend upwards from [rubi eir] hairline, solid black in color.  ");
            this.outputText("A pair of ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_EAR_TYPE] == 0)
                this.outputText("cute, normal ears protrude from the sides of [rubi eir] head, each one pierced with a small dangling earring");
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_EAR_TYPE] == 1)
                this.outputText("cute, cat-like ears pop up from the top of [rubi eir] head, each one seemingly able to move independently");
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_EAR_TYPE] == 2)
                this.outputText("feathered ears protrude from the sides of [rubi eir] head, each one fluttering cutely from time to time, and each pierced with a small dangling earring");
            this.outputText(".");
            this.outputText("\n\n[rubi Ey] has a ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1)
                this.outputText("flat-chest ");
            else
                this.outputText("[rubi breasts]");
            this.outputText(" supporting two perky ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NIPPLE_TYPE] == 1)
                this.outputText("black ");
            this.outputText("nipples.");
            this.outputText("\n\nBetween [rubi eir] legs is a ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0) {
                this.outputText(this.rubiCock() + ", which starts to perk up under your scrutiny. From experience, you know it can reach a impressive " + this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] + " inches when erect.  ");
                this.outputText("Under [rubi eir] cock swings a set of ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] >= 4 && this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] < 9)
                    this.outputText("cum-swollen ");
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] >= 9)
                    this.outputText("engorged, blue-tinged ");
                this.outputText("testicles");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_BALLS_TYPE] == 1)
                    this.outputText(", which cling tight to [rubi eir] body in a cute spherical pouch");
            }
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0)
                this.outputText(" and a ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0) {
                this.outputText("cute ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_CUNTTYPE] > 0)
                    this.outputText("black ");
                this.outputText("pussy topped off by a little love button");
                this.outputText(".  Though you can't see it, you know Rubi's got a perfect little asshole, between [rubi eir] buttcheeks, right where it belongs.");
            }
            else {
                this.outputText(".");
            }
            this.outputText("\n\nSwaying behind [rubi em] is a red spaded tail, which coils around [rubi eir] leg occasionally.  ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] == 1)
                this.outputText("Finally, Rubi stands on a long black spike that makes [rubi em] walk as though [rubi ey] were wearing high heels.");
        ...
        playDressUp() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You look over Rubi's vast collection of clothes.  What outfit would you like Rubi to put on?\n\n");
            this.menu();
            var closet = [];
            var buttonNames = [];
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SUITCLOTHES] == 1) {
            ...
            if (closet.length > 0) {
                this.outputText("<b>Rubi's Closet Contains:</b>\n");
                this.temp = 0;
                while (this.temp < closet.length) {
                    this.outputText(closet[this.temp] + "\n");
                    this.temp++;
                }
                this.outputText("\n");
            }
            ...
            while (button < 9 && button < buttonNames.length) {
                console_1.trace("BUTTONNAMES: " + buttonNames[button]);
                console_1.trace("CLOSET: " + closet[button]);
                if (button < 8 || closet.length < 9)
                    this.addButton(button, buttonNames[button], this.dressUpRouter, closet[button]);
                else
                    this.addButton(8, "More", this.playDressUp2);
                button++;
            }
        ...
        playDressUp2() {
            ...
            while (button - 7 < 9 && button < buttonNames.length) {
                if (button == 7)
                    this.addButton(0, "Previous", this.playDressUp);
        ...
        putRubiInAWaitressUniform() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the waitress uniform.  \"<i>Hm, well all right, but it's just my work clothes,</i>\" [rubi ey] replies.");
            this.outputText("\n\nRubi starts off with a white bra trimmed with lace");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1)
                this.outputText(", though it's obvious [rubi ey] doesn't need it with [rubi eir] flat-chest");
            this.outputText(".  [rubi Ey] slips [rubi eir] arms through the holes and expertly latches the back.  Next [rubi ey] takes a black garter belt and slips it up [rubi eir] slender ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                this.outputText("hairless");
            else
                this.outputText("furred");
            this.outputText(" legs, until it rests snugly around [rubi eir] waist.  A matching pair of sheer stockings quickly follow, held up by the garter.");
            if (!this.rubiBimbo() || this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] > 0)
            ...
            this.outputText("  Rubi approaches a rack of clothes, searching quietly for a moment before picking two hangars off it: a pink blouse and a matching pink skirt.");
            this.outputText("\n\nThe blouse goes on first, followed by the skirt.  Rubi only buttons the blouse about half way up");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1)
                this.outputText(", showing off some of [rubi eir] flat chest");
            else
                this.outputText(", showing off a generous portion of cleavage");
            this.outputText(", and tucks the hem of the blouse into the skirt.  Finally, Rubi selects a pair of ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] == 1)
                this.outputText("what appears to be flats, with a hole in the heel for [rubi eir] demonic heels");
            else
                this.outputText("short heels");
            this.outputText(" and slips them on.  [rubi Ey] gives a little twirl in the waitress uniform, and bends over several times to show off [rubi eir] ");
            if (!this.rubiBimbo() || this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] > 0)
                this.outputText("girly panties");
            else
                this.outputText("naked nethers");
            this.outputText(".");
        ...
        putOnADashingOutfitYouWhore() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the dashing outfit.  \"<i>Ohh, feeling like plundering a little booty today?</i>\" [rubi ey] asks with a coy smile.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText("  Combined with the sizeable bulge in the crotch, Rubi looks like quite the dashing, if slutty, piratess.");
            this.outputText("\n\nNow that Rubi is dressed up, what do you want to do?");
            //[Date (go to Ice Cream date)] [Back]
            this.menu();
            this.addButton(0, "Date", this.dateIntro, this.iceCreamDate);
        ...
        goOnAnAnalAdventureRubiNotReallyJustAnAdventurersOutfit() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the adventurer's outfit.  \"<i>Ah yes, am I going to be the Champion now?</i>\" Rubi asks, balling up [rubi eir] dainty hands and putting them on [rubi eir] hips.  \"<i>Rubi, Champion of Mareth!  Slayer of demons and ");
            if (this.silly())
                this.outputText("collector of waifus!");
            else
                this.outputText("layer of ladies");
            this.outputText("!  Has a bit of a ring to it doesn't it?</i>\"  [rubi Ey] giggles for a moment and then gathers up the clothes.");
            this.outputText("\n\n[rubi Ey] starts with a simple, only slightly lacy white bra");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1)
                this.outputText(", though it's obvious [rubi ey] doesn't need it with [rubi eir] flat-chest");
            this.outputText(".  [rubi Ey] slips [rubi eir] arms through the holes and expertly latches the back.  Following that is a matching pair of panties that [rubi ey] slips up [rubi eir] long, smooth legs.  [rubi Ey] pulls them up so that they hug [rubi eir] round, cute ass tightly.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_EAR_TYPE] == 1)
                this.outputText(", covering [rubi eir] feline ears");
            this.outputText(".  The boots that go with the outfit are mid-calf length and made of supple, fine leather");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] == 1)
                this.outputText(" with a hole cut out in the heel, apparently for Rubi's demonic heels to fit through");
            this.outputText(".  Once those are on, Rubi completes the look by retrieving a wooden sword from somewhere while you were too distracted by [rubi eir] ass.");
            this.outputText("\n\nNow that Rubi is dressed up, what do you want to do?");
            //[Date (go to Ice Cream date)] [Back]
            this.menu();
            this.addButton(0, "Date", this.dateIntro, this.iceCreamDate);
        ...
        giveRubiALongDressToHideHerHideousBody() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the long dress.  \"<i>Oohh, I just </i>love<i> that one! One second!</i>\" [rubi ey] says as [rubi ey] pulls out the dress and several accessories.");
            this.outputText("\n\nRubi starts with an off-pink strap-less bra");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1)
                this.outputText(", despite the fact that [rubi ey] clearly doesn't need one");
            this.outputText(", which [rubi ey] expertly fastens behind [rubi em]");
            this.outputText(".  Next, [rubi ey] takes a white garter belt and slips it up [rubi eir] slender ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                this.outputText("hairless");
            else
                this.outputText("furred");
            this.outputText(" legs, until it rests snugly around [rubi eir] waist.  A matching pair of white stockings quickly follow, held up by the garter.  The next thing is an off-pink pair of panties that [rubi ey] slides up [rubi eir] legs and pulls up so that they cling tightly to [rubi eir] ample rump.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 1 || this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 3)
                this.outputText(" (or darkens at least)");
            this.outputText(", and [rubi ey] returns to the task at hand.  The dress goes on neatly, and once it's in place you help to pull the strings on the built-in corset, tying them off with a neat little bow in back. To top it all off is a pair of pink pumps");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] == 1)
                this.outputText(" with the heels cut off and a hole for Rubi's demonic heel to fit through");
            this.outputText(", which [rubi ey] slips on quickly.");
        ...
        rubiPutsOnNursesClothesSoSheCanCheckYourTemperature() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the nurse's uniform.  \"<i>Ohh, coming down with a bit of a fever?  Do you need a sponge bath?</i>\" [rubi ey] says coyly, before gathering up the clothing.");
            this.outputText("\n\n[rubi Ey] starts with a simple, only slightly lacy white bra");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1)
                this.outputText(", though it's obvious [rubi ey] doesn't need it with [rubi eir] flat-chest");
            this.outputText(".  [rubi Ey] slips [rubi eir] arms through the holes and expertly latches the back.  Next [rubi ey] takes a white garter belt and slips it up [rubi eir] slender ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 2)
                this.outputText("furred ");
            else
                this.outputText("hairless ");
            this.outputText("legs, until it rests snugly around [rubi eir] waist.  A matching pair of white fishnet stockings quickly follow, held up by the garter.  The next thing is a pair of white cotton panties that [rubi ey] slides up [rubi eir] legs and pulls up so that they cling tightly to [rubi eir] ample rump.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1)
                this.outputText("heart");
            else
                this.outputText("left breast");
            this.outputText(".  [rubi Ey] places the matching hat on [rubi eir] head and adjusts it before putting on a pair of white pumps");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] > 0)
                this.outputText(" with the heels removed and a hole for [rubi eir] demonic heels");
            this.outputText(".");
            this.outputText("\n\nNow that Rubi is dressed up, what do you want to do?");
            //[Date (go to ice cream date)] [Back]
            this.menu();
        ...
        rubiHasARubberFetish() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the rubber fetish outfit.  \"<i>Ohoh,</i>\" [rubi ey] giggles and quirks an eyebrow at you, \"</i>feeling a bit kinky are we?</i>\"");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                ...
                this.outputText("furred body");
            this.outputText(", starting with [rubi eir] legs and moving up to the torso and arms.  Once Rubi's ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                this.outputText("skin ");
            else
                this.outputText("fur ");
            this.outputText("glistens with the oils it's time to put on the actual clothes.  ");
            //(If Not Bimbo)
            if (!this.rubiBimbo() || this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] > 0)
                this.outputText("[rubi Ey] first takes a pair of transparent rubber panties and slides them up [rubi eir] legs until they lovingly cling around [rubi eir] ass.  ");
            this.outputText("Rubi next slides into a transparent latex shirt, long sleeved, with holes cut out to accommodate [rubi eir] nipples.  It takes some work, and you have to help Rubi to put on the difficult garment, but once it's on, it looks fantastic, clinging to [rubi eir] body like a second skin.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 2)
                this.outputText("furred ");
            this.outputText("legs.  You wonder how [rubi ey] does this when you're not around!  Finally, Rubi slips on a pair of heels");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] == 1)
                this.outputText(", the actual heel cut off to make room for [rubi eir] demonic heel,");
            this.outputText(" to complete the look.  All in all, [rubi ey] looks ready for a night in the dungeons.");
            this.outputText("\n\nNow that Rubi is dressed up, what do you want to do?");
        ...
        putOnASuitYouSlut() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the suit.  \"<i>Oh, really?  It looks nice, but you don't think it's too manly?</i>\"");
            this.outputText("\n\nRubi starts with a black, lacy bra");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1)
                this.outputText(", despite the fact that [rubi ey] clearly doesn't need one");
            this.outputText(", which [rubi ey] expertly fastens behind [rubi em].  Next, [rubi ey] takes a black garter belt and slips it up [rubi eir] slender ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                this.outputText("hairless");
            else
                this.outputText("furred");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] == 1)
                this.outputText(", with the actual heel cut off to make room for [rubi eir] demonic heel,");
            this.outputText(" and quickly combs back [rubi eir] hair.  All in all, [rubi ey] looks like a girl dressed in her boyfriend's clothes... which is to say, quite sexy.");
            this.outputText("\n\nNow that Rubi is dressed up, what do you want to do?");
        ...
        putOnATubeTopYouWhore() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] > 2)
                this.outputText(", which strain the flimsy piece of material");
            this.outputText(".  Completing the look is a simple pair of sandals");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] == 1)
                this.outputText(", with a hole cut in the sole to make room for Rubi's demonic heels");
            this.outputText(".");
            this.outputText("\n\nNow that Rubi is dressed up, what do you want to do?");
        ...
        putOnSluttySwimwearYouSkank() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the swimsuit.  \"<i>Oh, but there's no pool or lake nearby.  Or do you just want to see me in a bikini?</i>\"  Rubi giggles a moment.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 3)
                this.outputText(" sit loosely over Rubi's small chest");
            else
                this.outputText("strain thanks to Rubi's ample busom");
            this.outputText(".");
            this.outputText("\n\nTopping it off, your demonic lover slips on a pair of sandals");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] > 0)
                this.outputText(", with a hole in the sole to make room for [rubi eir] demonic heels");
            this.outputText(".");
            this.outputText("\n\nNow that Rubi is dressed up, what do you want to do?");
            //[Date (go to exhibitionist date)] [Back]
            this.menu();
        ...
        putOnADressYouBimbo() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the minidress.  \"<i>Oh that cute little thing we picked up together?  For sure!  It's so cute!</i>\"");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] > 0)
                this.outputText(", with the heels removed to make room for [rubi eir] own demonic heels");
            this.outputText(".");
        ...
        putOnMyBodysuitYouWhore() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the bodysuit.  \"<i>Oh, that thing is pretty cute,</i>\" [rubi ey] says, \"<i>Though there's not much to it.  But I suppose that's the point, huh?</i>\"");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                ...
                this.outputText("furred");
            this.outputText(" legs, then up the rest of [rubi eir] body until [rubi ey] slips [rubi eir] arms into the long, sheer sleeves.  After a few adjustments, making sure ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText("[rubi eir] package is neatly tucked away");
            else
                this.outputText("a red rose is neatly covering up [rubi eir] pubic mound");
            this.outputText(", and the butt of the suit is clinging perfectly to [rubi eir] own, [rubi ey] poses for you.");
            this.outputText("\n\nNow that Rubi is dressed up, what do you want to do?");
            //[Date (go to bar date)] [Back]
            this.menu();
            this.addButton(0, "Date", this.dateIntro, this.barDate);
        ...
        putOnBondageStrapsYouBondageTrap() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the bondage straps.  \"<i>Oh!  That outfit, huh?</i>\"  Rubi blushes brightly");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] > 0)
                this.outputText(", or so you imagine");
            this.outputText(".  \"<i>That one's so embarrassing... but for you, I'll wear it.</i>\"");
        ...
        whyTheFuckIsRubiWearingAnInquisitorsCorset() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the inquisitor's corset.  \"<i>Oh my, I really love that one.  It's so pretty and lacy!</i>\"");
        ...
        putOnAWaitressUniformYouWhore() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You tell Rubi you'd like to see [rubi em] in the risque version of [rubi eir] normal waitress uniform.  \"<i>Oh, you like that outfit, huh?  I thought you might,</i>\" Rubi says with a giggle.");
            this.outputText("\n\nOf course, there's not much to this outfit, which starts off with a skirt so short it could be confused for a belt.  ");
            //(not bimbo)
            if (!this.rubiBimbo() || this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] > 0) {
                this.outputText("Next [rubi ey] slips on a pair of pink frilly panties, sliding them up [rubi eir] slender legs until they come up to cling to [rubi eir] ample ass.  ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                    this.outputText("Oddly enough, these panties only seem to cover Rubi's balls, leaving [rubi eir] cock right out in the open.  ");
            }
            this.outputText("Taking a simple white apron, Rubi throws that on next, looping the halter-like top over [rubi eir] neck and tying off the straps around [rubi eir] waist.");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText("  To top it all off, Rubi takes a pink lacy cocksock and slips it down [rubi eir] [rubi cock], fastening it into place with a pink ribbon that [rubi ey] ties into a bow around the base of [rubi eir] cock.");
            this.outputText("\n\nAfter all that, [rubi ey] simply puts on a pair of black, open-toed heels");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] == 1)
                this.outputText(", with the heels removed to make room for [rubi eir] own demonic heels");
            this.outputText(", and poses for you in the skimpy outfit.");
            this.outputText("\n\nNow that Rubi is dressed up, what do you want to do?");
        ...
        dateIntro(date) {
            ...
            this.rubiSprite();
            //(First Time)
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_RUBI_DATED] == 0) {
                this.outputText("An idea strikes you.  While you have talked with Rubi and gotten to know [rubi em] at work, you haven't really been out with [rubi em] anywhere else.  You wonder, and ask if Rubi would like to go out somewhere, maybe to pick up some food and talk.");
            ...
            //(Repeats)
                ...
                this.outputText("Seeing Rubi all dressed up like this, you figure it might be time to go on another date.  You ask, and Rubi predictably makes a gleeful sound and assents.");
            }
            this.flags[kFLAGS_1.kFLAGS.TIMES_RUBI_DATED]++;
            if (date == this.iceCreamDate) {
                if (this.player.gems < 2) { //Can't Afford It?
        ...
        iceCreamDate() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] >= 100 && this.flags[kFLAGS_1.kFLAGS.RUBI_ICECREAM_CONFESSION] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.RUBI_ICECREAM_CONFESSION]++;
            }
        ...
        fancyDate() {
            ...
            if (this.player.gems >= 10) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] >= 100 && this.flags[kFLAGS_1.kFLAGS.RUBI_FANCY_CONFESSION] == 0) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_FANCY_CONFESSION]++;
                }
                ...
                //(if PC has met Callu)
                if (this.flags[kFLAGS_1.kFLAGS.MET_OTTERGIRL] == 1)
                    this.outputText(" though not as good as Callu's, the ottergirl fisherman you met at the lake.");
                else
                    this.outputText(", which makes you wonder who Rubi is thinking about.  Perhaps one of [rubi eir] parents?");
        ...
        exhibitionistDate() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText(this.rubiCock());
            else
                this.outputText("glistening, wet pussy");
            this.outputText(".");
        ...
        barDate() {
            ...
            //(If Relationship 100, happens once)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] >= 100 && this.flags[kFLAGS_1.kFLAGS.RUBI_BAR_CONFESSION] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.RUBI_BAR_CONFESSION]++;
            }
        ...
        anallyTrainYourBitchBoySlutHowToBeAnalForDCL() {
            this.clearOutput();
            this.rubiSprite();
            this.flags[kFLAGS_1.kFLAGS.RUBI_TIMES_ANALLY_TRAINED]++;
            //First Time
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_TIMES_ANALLY_TRAINED] == 1) {
                this.outputText("You sit down on the couch next to Rubi, making small talk.  After a few minutes the two of you are laughing comfortably as you lounge on the cushions, discussing everything from life in Tel'Adre to your adventuring exploits.  Eventually the topic of conversation circles back to sex, and how you're a bit too much for [rubi em] to handle at the moment.");
                this.outputText("\n\nRubi gulps visibly and nods, \"<i>I can't help it, babe.  That cock of yours looks so ");
                if (this.rubiBimbo() || this.flags[kFLAGS_1.kFLAGS.RUBI_DEBIMBO] == 0)
                    this.outputText("totally ");
                this.outputText("delicious, but I'm afraid it's too big!  I couldn't possibly fit that entire thing inside me... not comfortably at least.</i>\"");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 1 || this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 3)
                    this.outputText(", or redder at least");
                else
                    this.outputText(", what little of it you can see");
                this.outputText(", and [rubi ey] sits knock-kneed behind the chest.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                    this.outputText(", [rubi eir] dick wobbling enticingly");
                this.outputText(".");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NIPPLE_TYPE] == 1)
                    this.outputText("black ");
                this.outputText("nipples, which jut straight up, straining against the sheer fabric of the negligee.  A soft gasp escapes Rubi's soft lips as [rubi ey] pinches one ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NIPPLE_TYPE] == 1)
                    this.outputText("ebon ");
                this.outputText("nipple, while [rubi eir] other hand flutters down between [rubi eir] thighs to stroke [rubi eir] ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                    this.outputText(this.rubiCock());
                else
                    this.outputText("quickly dampening pussy");
                this.outputText(".");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 0 || this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 2)
                    ...
                    this.outputText("dusky black");
                this.outputText(" lips, licking the ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                    this.outputText("pre-cum");
                else
                    this.outputText("juices");
                this.outputText(" off of them with a smile.  [rubi Eir] newly cleaned fingers move to the bottle of lube sitting nearby.  After pumping a handful into [rubi eir] palm, the rich scent of raspberries seems to fill the air, making your nostrils twitch.  Scented lube?");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] == 0)
                    this.outputText("slick vagina");
                else
                    this.outputText("hungry asshole");
                this.outputText(".");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] == 0)
                    ...
                    this.outputText("asshole");
                this.outputText(" clinging so tightly to the toy you imagine it must be like a vice.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                    this.outputText(this.rubiCock() + " is standing at full attention, bobbing up and down as Rubi fucks [rubi emself] on the dildo");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0)
                    this.outputText(", and [rubi eir] ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0)
                    this.outputText("cunt lips are glistening red with arousal, just begging for attention");
                this.outputText(".  Rubi's cries grow louder, [rubi eir] lips parting and [rubi eir] tongue lolling out as [rubi ey] pants for breath.  You can tell [rubi ey]'s building up to something, something powerful at that.");
                this.outputText("\n\n[rubi Eir] hips spin and oscillate, working vigorously to keep [rubi eir] ");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 1)
                    this.outputText("backside");
                else
                    this.outputText("fuck hole");
                this.outputText(" filled with dick, however fake it may be.  The slender, feminine demon's voice is so suffused with lustful fervor that it's virtually palpable in the warm air permeating the area.  Each near-orgasmic tone that worms its ways from [rubi eir] throat just drips with euphoria and writhes its way into your ears, filling your body with a portion of [rubi eir] passion.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                    this.outputText("bare");
                else
                    this.outputText("furred");
                this.outputText(" legs buckle, one jerking like mad, causing [rubi em] to impale [rubi emself] fully onto the imitation shaft of man meat.  Amid the chaos of spasming limbs and newfound modesty, Rubi loses [rubi eir] breath, making small gasping noises when [rubi ey] isn't moaning for more.");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 1)
                    ...
                    this.outputText("cunt");
                this.outputText(", seeking freedom from its sweet, fleshy prison.  A long supine sigh escapes your slender lover's mouth.  [rubi Ey]'s clearly exhausted and happy for this rapturous release.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_EAR_TYPE] == 0)
                    ...
                    this.outputText("feline ear");
                else
                    this.outputText("feathered ear");
                this.outputText(" that [rubi ey] should keep that in for a few hours, just to make sure this training takes hold.  Rubi gives you a small smile in response along with a small peck on the cheek before slipping under the sheets for a quick nap.");
            ...
            //Rubi's capacity won't go larger than 100.
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                    ...
                    this.outputText("sweet pussy");
                this.outputText(" is readily on display, and it's all for you.  Rubi's makeup is less than subtle, with bright red lips and a light dusting of silver eyeshadow, enough to make [rubi eir] eyes pop and not clash with the outfit.  Completing the look is a pair of white fishnet stockings that go up [rubi eir] legs, ending about mid-thigh.");
                ...
                this.outputText("'s mouth, exploring every inch and entwining with Rubi's own.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 0)
                    this.outputText("go bright red");
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 1 || this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 3)
                    this.outputText("go a vivid purple");
                else
                    this.outputText("would be blushing bright red now, were it not for the fine layer of fur");
                this.outputText(", and [rubi ey] snaps back to the present.  \"<i>Eheh... I guess I deserved that.</i>\"");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 1)
                    ...
                    this.outputText("pussy");
                this.outputText(", making sure to cover every inch.  You're certain you even see a few fingers press inside [rubi eir] hole.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                    ...
                    this.outputText("cunt");
                this.outputText(" is stretched nearly to its limits.  Finally [rubi ey] lets out a sigh of relief as the knot pops completely into place.  \"<i>Oh... fuck me it's so big,</i>\" [rubi ey] squeals, [rubi eir] body visibly shaking.  Rubi's tongue lolls out, dripping a bit of spittle down [rubi eir] chin.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 1)
                    ...
                    this.outputText("cunt");
                this.outputText(" just widened slightly.  Rubi's eye go wide as [rubi ey] looks up at you with a mouth full of cock, moaning something you can't understand.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                    this.outputText("You can feel your lover's cock straining against your leg, aching for some release.  You idly press your foot against it, feeling a slick layer of precum coating it from top to bottom already.  ");
                this.outputText("A pleading look enters Rubi's eyes.  You hold up the pump and ask [rubi em] if [rubi ey] wants you to use it again.  [rubi Ey] gives [rubi eir] head a quick nod of assent, and reaffirms this by taking your [cock biggest] even deeper into [rubi eir] mouth.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_EYE_TYPE] == 0 || this.rubiBimbo())
                    ...
                    this.outputText("shiny black");
                this.outputText(" eyes close tight as [rubi ey] succumbs to a brain-melting orgasm.  [rubi Eir] entire body trembles, from [rubi eir] curling toes right up [rubi eir] twitching, painted fingers.");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                    this.outputText("  Even, no, <i>especially</i> [rubi eir] cock twitches and spasms jerking upwards and splattering globules of sticky white goo against the inside of Rubi's babydoll before dripping down onto the floor between [rubi eir] legs, creating a rapidly growing puddle.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] > 0)
                    ...
                    this.outputText("cunt");
                this.outputText(", to make [rubi em] squeal from your actions, and not that of a lifeless dildo.  You imagine the " + this.rubiMF("demon", "demoness") + "'s hot, wet walls clamped around you, milking you for everything you've got.");
        ...
        //Requires 75 Affection
        getFuckedByRubi() {
            this.outputText(this.images.showImage("rubi-fucks-you"), false);
            this.clearOutput();
            this.rubiSprite();
            this.outputText("Rather than wait for you to initiate something, Rubi takes you by the hands and leads you into the bedroom.  [rubi Ey] puts one arm on your shoulder and runs [rubi eir] fingers up through the hair on the back of your head before pulling you into a deep kiss.  Rubi's ");
            //(normal/furry skin)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 0 || this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 2)
                this.outputText("red");
            else
                this.outputText("black");
            this.outputText(" lips feel so delicate against yours, but they quickly part as [rubi eir] tongue slithers between them, exploring the depths of your warm, wet mouth.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_EYE_TYPE] == 0 || this.rubiBimbo())
                ...
                this.outputText("black");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_EYE_TYPE] > 0)
                this.outputText(" slitted");
            this.outputText(" eyes constantly meet yours, looking for approval, before and after every act.  You're certain you're still the one in charge here... but you're simply letting Rubi take the lead.");
            ...
            if (!this.player.hasVagina())
                ...
                this.outputText("cunt");
            this.outputText(" of yours all ready for me.</i>\"  Rubi's head descends between your legs");
            if (this.player.hasCock())
                this.outputText(", ignoring your " + this.multiCockDescriptLight() + " completely,");
            this.outputText(" and presses [rubi eir] face into your [vagOrAss], inhaling deeply.  [rubi Eir] lips pucker as [rubi ey] plants a kiss directly onto your ");
            if (!this.player.hasVagina())
                this.outputText("ass");
            else
                this.outputText("moistening pussy");
            this.outputText(".  You let out a small moan and lean backwards, taking your eyes off the ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_HAIR] == 0)
                this.outputText("black-haired");
            else
                this.outputText("blonde");
            this.outputText(" head betwixt your thighs and taking in the sensations.");
            ...
            if (this.rubiGetCockType() == CockTypesEnum_1.CockTypesEnum.HUMAN)
                this.outputText("pink, mushroom-like tip");
            else if (this.rubiGetCockType() == CockTypesEnum_1.CockTypesEnum.DEMON)
                this.outputText("purple, nodule-laden tip");
            else if (this.rubiGetCockType() == CockTypesEnum_1.CockTypesEnum.HORSE)
                this.outputText("blunted, musky tip");
            else if (this.rubiGetCockType() == CockTypesEnum_1.CockTypesEnum.TENTACLE)
                this.outputText("tentacle-ringed crown");
            else
                this.outputText("<b>ERROR: Rubi Cock Type set invalid. Currently: " + this.rubiGetCockType() + "</b>  ");
            this.outputText(" emerges from the foreskin surrounding it as [rubi eir] cock strains, aching for something, anything to fill.");
            ...
            if (!this.player.hasVagina())
                this.player.buttChange(this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] * this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] / 6, true, true, false);
            else
                this.player.cuntChange(this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] * this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] / 6, true, true, false);
            ...
            if (!this.player.hasVagina())
                ...
                this.outputText("g-spot");
            this.outputText(" briefly, but enough to send a hot shiver up your spine.  Seeing this reaction, Rubi's smile widens into a grin and begins to thrust in and out at a slow pace.  Every thrust brushes past your sensitive ");
            if (!this.player.hasVagina())
                this.outputText("prostate");
            else
                this.outputText("g-spot");
            this.outputText(", and one by one your limbs start to tingle.  In and out, [rubi ey] goes, and you can feel something building inside you.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_EYE_TYPE] > 0)
                this.outputText(" slitted");
            this.outputText(" eyes, \"<i>Can I come inside you?</i>\"");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] < 4) { }
                ...
                this.outputText("There's so much of it that it oozes out from your abused ");
                if (!this.player.hasVagina())
                    this.outputText("ass");
                else
                    this.outputText("cunt");
                this.outputText(", dribbling down your buttcheeks and pooling onto the bed and floor below.  ");
            }
            //(Blueballs 6-9)
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 9) {
                this.outputText("Your insides rumble suddenly as Rubi's impressive load begins to fill you up, [rubi eir] seed slipping into every available nook and cranny.  What doesn't fit slips out of your abused ");
                if (!this.player.hasVagina())
                    this.outputText("ass");
                else
                    this.outputText("cunt");
                this.outputText(" in a small torrent, pooling onto the bed and floor below.  ");
            }
            //(Blueballs 10)
            else
                this.outputText("Your insides rumble dangerously and your stomach actually swells up, gaining a noticeable paunch as Rubi's lavish load coats your insides, filling every available nook and cranny and even creating new ones.  What doesn't fit slips out of your abused hole in a flood, coating the bed and floor beneath you in a slick, white glaze.  ");
            this.outputText("Rubi doesn't stop there, however; [rubi ey] continues to assail your [vagOrAss], bringing you to several more miniature, body-shaking orgasms, until [rubi ey] just can't handle any more, and [rubi ey] pulls out, [rubi eir] cock still rather erect and looking cozy in its jacket-like foreskin.");
        ...
        rubiHotdogging() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 0)
                this.outputText("pale skinned");
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 1 || this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 3)
                this.outputText("red skinned");
            else
                this.outputText("fur-covered");
            this.outputText(" " + this.rubiMF("boy", "girl") + " lays naked on your lap.  Rubi giggles and dips a hand between [rubi eir] thighs ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText("taking hold of [rubi eir] cock");
            else
                this.outputText("rubbing a finger along [rubi eir] clit");
            this.outputText(" while [rubi ey] says, \"<i>So babe, what do you intend to do?  Are you going to hold me down and ravish me?  What will it be?</i>\"");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                this.outputText("tender skin");
            else
                this.outputText("silky fur");
            this.outputText(".  Rubi's back arches and a soft gasp escapes [rubi eir] lips.  [rubi Eir] body reflexively jerks towards your hand, hoping for more than a simple teasing touch, but you pull your hand away and give [rubi eir] round ass a playful smack, chastising [rubi em].");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0)
                this.outputText("cunt moistening");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText(" and ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText("cock hardening");
            this.outputText(".  [rubi Ey] obviously enjoys this light, playful teasing.  You give Rubi's ass another playful smack, watching [rubi eir] ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 0)
                this.outputText("pale skin");
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 1 || this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 3)
                this.outputText("crimson skin");
            else
                this.outputText("fur-covered flesh");
            this.outputText(" jiggle with a smile.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                ...
                this.outputText("coat");
            this.outputText(" against your manhood as you slowly begin to pump in and out of Rubi's ass cheeks.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 1)
                ...
                this.outputText("pussy");
            this.outputText(", while your index and middle fingers rub slowly around [rubi eir] ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0)
                this.outputText("clit");
            else
                this.outputText("perineum");
            this.outputText(".");
        ...
        //Tease
        teaseButtjobs() {
            this.outputText(this.images.showImage("rubi-tease-buttjob"), false);
            this.clearOutput();
            this.rubiSprite();
            this.outputText("Grinning to yourself, you decide to tease the little demon " + this.rubiMF("boy", "girl") + " a little further.  You plunge your thumb further into [rubi eir] ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 1)
                this.outputText("ass");
            else
                this.outputText("pussy");
            this.outputText(", finding [rubi eir] ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 1)
                this.outputText("prostate");
            else
                this.outputText("g-spot");
            this.outputText(" and rubbing circles around it, drawing out a long moan from Rubi's smeared lips.  With every thrust into Rubi's soft ass-pillows you draw another loop around [rubi eir] most sensitive spot with your digit, until you can feel [rubi eir] body start to tense up.");
            ...
            if (this.player.cumQ() <= 50)
                this.outputText("in one go, with a small, proud look on [rubi eir] face");
            else if (this.player.cumQ() <= 150)
                this.outputText("with one, throat-straining swallow, a small, proud smile taking [rubi eir] face when [rubi ey] stops panting for breath");
            else
                this.outputText("as it comes, mouthful after mouthful of cum practically injected straight into [rubi eir] stomach. There's so much of it, [rubi ey] can't help but smile mid-way through, proud to take such a huge load");
            if (this.player.cumQ() >= 1000)
                this.outputText(".  After guzzling down so much, you're certain Rubi's actually sporting a bit of a belly now, almost as if [rubi ey] were several months pregnant");
            this.outputText(".");
        ...
        //Pop
        popButtjobs() {
            this.outputText(this.images.showImage("rubi-pop-buttjob"), false);
            this.clearOutput();
            this.rubiSprite();
            this.outputText("No, you figure Rubi has been so great lately [rubi ey] definitely deserves to cum.  You plunge your thumb further into [rubi eir] ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 1)
                this.outputText("ass");
            else
                this.outputText("pussy");
            ...
            this.outputText("\n\nRubi's ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0)
                this.outputText("cunt clamps down on your thumb and gushes, coating your hand in [rubi eir] slick juices");
            else
                this.outputText("asshole quivers and attempts to suck in more of your thumb before clamping down, leaking slick fluids all over your hand");
            this.outputText(".  [rubi Eir] entire body spasms as the climax wracks it, one sexy leg suddenly jerking back and forth uncontrollably.  Rubi grips at a pillow, biting it and stifling another orgasmic moan.");
            //(If Rubi has Penis)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0)
                this.outputText("  Beneath [rubi em], [rubi eir] cock jerks and twitches, loosing a spray of pearly white cum which splatters against the couch below");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] < 4) { }
            //((blueballs 4-5)
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 5)
                this.outputText(" which is quickly followed by another, more powerful stream of cum, which splashes against [rubi eir] stomach, coating [rubi eir] [rubi breasts] in semen");
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 7)
                this.outputText(" which is quickly followed by another, more powerful stream of cum, and a third, and a fourth.  Before you know it, Rubi's entire torso, including [rubi eir] [rubi breasts] are practically glazed with cum");
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] <= 9)
                this.outputText(" which is followed up by several more, each seemingly more poweful than the one previous.  Rubi's body twitches and shudders with every jet, until [rubi eir] entire torso, and the couch, is covered in the musky jizz");
            else
                this.outputText(" which is followed by a dozen more, each one thicker and more powerful than the last.  Rubi's cock twitches uncontrollably, just like [rubi eir] body, as it coats the entire couch, [rubi eir] entire upper body, and even some of the wall five feet away in the musky stuff");
            this.outputText(".");
            ...
            if (this.player.balls > 1)
                this.outputText("churn");
            else
                this.outputText("churns");
            this.outputText(" pleasurably, your [cock biggest] stiffens suddenly, and you let loose a long, drawn-out sigh as your dick erupts, jetting cum upwards, which immediately splatters against Rubi's tail and back before dripping down [rubi eir] bountiful asscheeks.");
            ...
            this.outputText(".");
            this.outputText("\n\nFinally, with one final spurt of cum that lands on your lover's face, you slip sideways onto the comfortable couch, completely spent.  Rubi, however, seems to have plenty of energy left, and spends the next few minutes dutifully licking over your [cock biggest], cleaning it of your juices until it sits, shiny and pristine, in your lap.");
            this.outputText("You laugh and give the demon-" + this.rubiMF("boy", "girl") + " a kiss, remarking how lucky you are to be with [rubi em].");
            this.outputText("\n\n\"<i>No, babe, I'm lucky to have found you,</i>\" [rubi ey] says, snuggling [rubi eir] naked body up against yours as the two of you drift off into a lazy, sex-induced nap.");
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.RUBI_BLU_BALLS] = 0; //Since he just came so he should be cured of blue balls
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Give Item
        ...
        giveRubiATFItem(itype) {
            this.clearOutput();
            this.rubiSprite();
            //First Time Giving a TF Item
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_TIMES_GIVEN_AN_ITEM] == 0) {
                this.outputText("Rubi looks at the offered item, curiously.  [rubi Ey] turns it over in [rubi eir] hands, carefully examining the liquid within.  Finally [rubi ey] asks apprehensively, \"<i>Is this going to... change my body?</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.RUBI_TIMES_GIVEN_AN_ITEM]++;
            //[go to TF scene]
            //Succubus Milk
            if (itype == this.consumables.SUCMILK || itype == this.consumables.P_S_MLK) {
                if (itype == this.consumables.SUCMILK) {
                    ...
                    this.outputText("You hand over the bottle of milky white fluids to Rubi.  [rubi Ey] takes a moment to read over the pink label before pulling out the cork and downing the whole bottle in one gulp.");
                }
                else {
                    ...
                    this.outputText("You hand over the bottle of purified milky white fluids to Rubi.  [rubi Ey] takes a moment to read over the pink label before pulling out the cork and downing the whole bottle in one gulp.");
                }
                //(If Bust size increases)
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 7 || (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 30 && this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE]++;
                }
                //(If Penis size decreases)
                if ((this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 4) && (!this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE]--;
                    this.outputText(Math.round(this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] * 10) / 10 + "-inch penis.");
                }
                //(If Penis is removed)
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] <= 4 && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 1) {
                        ...
                        this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] = 0;
                        this.flags[kFLAGS_1.kFLAGS.RUBI_SHE] = 1;
                        this.flags[kFLAGS_1.kFLAGS.RUBI_CUNTTYPE] = 0;
                    }
                }
                //(If Rubi randomly gets vagina)
                if (Rubi.rand(3) == 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] > 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] == 0 && Rubi.rand(3) == 0 && itype == this.consumables.SUCMILK) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_FEET] = 1;
                }
                //(If Rubi gets horns)
                if (Rubi.rand(3) == 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_HORNTYPE] == 0 && itype == this.consumables.SUCMILK) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_HORNTYPE] = 1;
                }
                //(If Rubi gets red skin)
                if (Rubi.rand(3) == 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 1 && itype == this.consumables.SUCMILK) {
                    this.outputText("\n\nRubi clutches [rubi eir] stomach suddenly as you notice red spots appearing on [rubi eir] ");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                        this.outputText("skin");
                    else
                        this.outputText("coat of fur");
                    this.outputText(".  The blotches soon spread, rapidly overtaking [rubi eir] body.  ");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 2)
                        this.outputText("Meanwhile the silky soft fur that covered [rubi eir] body seems to be falling out as this red menace takes over.  ");
                    this.outputText("In no time at all, [rubi eir] smooth, hairless skin now appears to be a deep crimson, matching the color of [rubi eir] spade tail that [rubi ey] received long ago.");
                    this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] = 1;
                }
            }
                ...
                if (itype == this.consumables.INCUBID)
                    this.outputText("You hand over the bottle of milky white fluids to Rubi.  [rubi Ey] takes a moment to read over the label before pulling out the cork and downing the whole bottle in one gulp.");
                ...
                if ((this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] > 0) && (!this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE]--;
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 0)
                        this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] = 0;
                }
                //(If Penis size increases)
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0 && ((this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] < 12 || (this.rubiGetCockType() == CockTypesEnum_1.CockTypesEnum.HORSE && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] < 20)) ||
                    (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] < 30 && this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY]))) {
                ...
                //(If Rubi has no penis; instead)
                    ...
                    this.outputText(" protrusion... a brand new cock!  Rubi shudders, [rubi eir] delicate little fingers wrapped around the new, five-inch cock.");
                    this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] = 5;
                }
                //(If Vagina removed)
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0 && Rubi.rand(3) == 0) {
                ...
                //(If Rubi gets red skin)
                if (Rubi.rand(3) == 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 1 && itype == this.consumables.INCUBID) {
                    this.outputText("\n\nRubi clutches [rubi eir] stomach suddenly as you notice red spots appearing on [rubi eir] ");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2)
                        this.outputText("skin");
                    else
                ...
                //(If Rubi gets horns)
                if (Rubi.rand(3) == 0 && this.flags[kFLAGS_1.kFLAGS.RUBI_HORNTYPE] == 0 && itype == this.consumables.INCUBID) {
                    this.outputText("\n\nRubi's hands suddenly dart up, clutching [rubi eir] head as though [rubi ey] has a massive headache.  [rubi Ey] feels around blindly, trying to locate the source of the pain, and then you see it.  Two small bulges appear on [rubi eir] forehead, just at the hairline.  They grow larger and larger until the skin splits cleanly open revealing shiny black bone.  Horns.  They grow up and backwards, forming light ridges.  They don't quite grow completely past [rubi eir] head, however, before the growth stops.  Rubi calms and stands.  [rubi Eir] hands roam over every inch of [rubi eir] new addition as glances in the mirror, marveling at [rubi eir] demonic appearance.");
                    this.flags[kFLAGS_1.kFLAGS.RUBI_HORNTYPE] = 1;
                }
            }
            ...
            //Bimbo Liqueur (Modified for variant genders)
                ...
                this.outputText("You hold out the bottle of Bimbo Liqueur.  Rubi takes it, and looks it over tentatively.  \"<i>Bimbo... liqueur?</i>\" [rubi ey] asks, quirking an eyebrow at you.  \"<i>But what does this do?  There's a huge warning label right here.  Effects are permanent, strong...</i>\" [rubi eir] voice drifts off as [rubi ey] reads.");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_HAIR_LENGTH] == 0)
                    ...
                    this.outputText("long");
                this.outputText(" hair suddenly bursts outwards, long platinum blonde locks flow past [rubi eir] shoulders like a waterfall.  [rubi Eir] already dainty hands grow more feminine, as do [rubi eir] feet.");
                this.flags[kFLAGS_1.kFLAGS.RUBI_HAIR_LENGTH] = 2;
                //(If Rubi has a Penis)
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] == 0)
                        this.outputText("[rubi eir] vagina");
                    else
                        this.outputText("a pristine new vagina");
                    this.outputText(".  It's pretty clear, this former male is now completely female.  Rubi collapses backwards onto the couch, the transformations seemingly done.");
                    this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] = 0;
                    this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] = 0;
                    this.flags[kFLAGS_1.kFLAGS.RUBI_SHE] = 1;
                }
                ...
                //(if boobs <E)
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 7) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_NIPPLE_TYPE] > 0)
                        this.outputText("black ");
                    this.outputText("nipples begins to tremble and then expand.  You swear you hear a whooshing sound, like someone is blowing up a balloon.");
                    //(if flat-chested)
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] == 0)
                        this.outputText("  Within seconds, Rubi has the chest of a pubescent girl, within a minute they're at least a B-cup.");
                    this.outputText("  You both sit with morbid curiosity, watching the flesh grow outwards, bit by bit and cup by cup.  After five minutes the growth stops, and Rubi carefully cradles [rubi eir] new enormous E-cup breasts.");
                    this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] = 7;
                }
                ...
                if (this.player.biggestTitSize() < 1)
                    ...
                    this.outputText("you");
                this.outputText(".  \"<i>Like, thank you so much baby!  You're the freaking best!  Now... you want to break this body in?</i>\"");
                this.outputText("\n\nYou grin and say, \"<i>Of course.</i>\"  After all, you're always happy to help!");
                //(Go to sex menu)
                this.player.consumeItem(this.consumables.BIMBOLQ);
                this.flags[kFLAGS_1.kFLAGS.RUBI_SHE] = 1;
                this.flags[kFLAGS_1.kFLAGS.RUBI_BIMBO] = 1;
                this.flags[kFLAGS_1.kFLAGS.RUBI_HAIR] = 1;
                this.rubiSexMenu();
                this.addButton(9, "Leave", this.camp.returnToCampUseOneHour);
                return;
            ...
            //Grows cock. (As Incubus Draft above)
                ...
                if (this.rubiGetCockType() != CockTypesEnum_1.CockTypesEnum.HORSE) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_TYPE] = CockTypesEnum_1.CockTypesEnum.HORSE;
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BALLS_TYPE] == 1)
                        this.outputText("tight, trappy ");
                    this.outputText("ballsack.  The colors move forward, seemingly stopping at the thick ring that marks the edge of [rubi eir] sheathe... except patches of  dusky gray appear along the next few inches of [rubi eir] length, creating a nice contrast and pattern with the bright pink of [rubi eir] cockflesh.");
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] += 3 + Rubi.rand(5);
                }
            }
            //Trap Oil
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0) {
                    this.outputText("  Rubi's [rubi cock] twitches, already leaking precum from its tip as it attempts to reach the skies above");
                }
                else
                    this.outputText("  Rubi's cunt glistens, soaked through entirely thanks to your ministrations");
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] > 0)
                    this.outputText(", while [rubi eir] [rubi breasts] gently rock up and down with the motions of [rubi eir] breathing");
                this.outputText(".");
                ...
                //(If Bust size decreases)
                if ((this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] > 1) && (!this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
                    this.outputText("\n\nRubi gasps a little and [rubi eir] hands immediately dart to [rubi eir] chest.  Before your eyes, Rubi's breasts begin to dwindle, shrinking down an entire cup size.  Rubi cups [rubi eir] breasts experimentally, getting used to their new, reduced, weight.");
                    this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE]--;
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1)
                        this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] = 1;
                }
                //(If Bust size increases)
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1) {
                    this.outputText("\n\nRubi gasps a little and [rubi eir] hands immediately dart to [rubi eir] chest.  Before your eyes, Rubi's breasts begin to swell, growing an entire cup size.  Rubi cups [rubi eir] breasts experimentally, getting used to their new weight.");
                ...
                //(If Penis size decreases)
                else if ((this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 3) && (!this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
                    this.outputText("\n\nRubi's [rubi cock] swells up suddenly, growing painfully hard.  [rubi Ey] grasps it and moans suddenly as it begins to dwindle in size, shrinking down by at least an inch, leaving [rubi em] with a ");
                    this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE]--;
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] < 3)
                        this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] = 3;
                    this.outputText(Math.round(this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] * 10) / 10 + "-inch penis.");
                }
                //(Trappy ballsack)
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_BALLS_TYPE] > 0) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_BALLS_TYPE] = 1;
                }
                //(Black Nipples)
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_NIPPLE_TYPE] != 1) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_NIPPLE_TYPE] = 1;
                }
                //(Black Eyes)
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_EYE_TYPE] != 1) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_EYE_TYPE] = 1;
                }
                else
            ...
            //Progression of furriness: cat ears, then whiskers and paws, then cat penis, then furry body.
                ...
                this.outputText("You hand over the tiny peach-like fruit to Rubi.  [rubi Ey] turns it over in [rubi eir] hands and remarks, \"<i>How can you like these things?  They're so... furry!  Well, to each their own I suppose.</i>\"  Rubi gulps visibly, preparing [rubi em]self for the whiskery fruit before biting down.  Apparently, it's not as bad as [rubi ey] thought it was, as [rubi ey] makes an appreciative grunt and consumes the fruit down to the pit.");
                //(Gaining Cat Ears)
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_EAR_TYPE] != 1) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_EAR_TYPE] = 1;
                }
                //(Gaining Whiskers and Paws)
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_WHISKERS] != 1 || this.flags[kFLAGS_1.kFLAGS.RUBI_HANDS] != 1) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_WHISKERS] = 1;
                    this.flags[kFLAGS_1.kFLAGS.RUBI_HANDS] = 1;
                }
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_LOWERBODY] != 1) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_LOWERBODY] = 1;
                }
                //(Gaining Cat Penis)
                else if (this.rubiGetCockType() != CockTypesEnum_1.CockTypesEnum.CAT && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_TYPE] = CockTypesEnum_1.CockTypesEnum.CAT;
                }
                //(Gaining Fur)
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 2) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] = 2;
                }
            }
            //Purity Peach
            if (itype == this.consumables.PURPEAC) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 0)
                    ...
                    this.outputText("red skin");
                else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 2)
                    this.outputText("furred skin");
                else
                    this.outputText("striped skin");
                this.outputText(" underneath.  The demon-marked " + this.rubiMF("boy", "girl") + " rubs [rubi eir] stomach appreciatively.  \"<i>Those were some great peaches, babe.</i>\"");
                //(Any changes? Yes)
                if (this.flags[kFLAGS_1.kFLAGS.RUBI_EAR_TYPE] != 2 || this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 3 || (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0 && this.rubiGetCockType() != CockTypesEnum_1.CockTypesEnum.TENTACLE)) {
                    this.outputText("\n\nRubi's eyes suddenly dart open and [rubi ey] clutches [rubi eir] stomach.  \"<i>Oh gods...  My belly feels so warm all of a sudden.</i>\"");
                    //(Feathery ears)
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_EAR_TYPE] != 2) {
                        ...
                        this.outputText(" ears seem to pull into [rubi eir] skull before disappearing, leaving nothing but skin and hair behind.  You wonder if Rubi's lost [rubi eir] ears permanently, but as the thought finishes crossing your mind you notice two small nubs growing where normal ears would be.");
                        ...
                        this.flags[kFLAGS_1.kFLAGS.RUBI_EAR_TYPE] = 2;
                    }
                    //(Shark Skin)
                    else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] != 3) {
                        ...
                        if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 0)
                            this.outputText("its normal paleness replaced with a vibrant cherry red");
                        else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 1)
                            this.outputText("which is barely noticeable on [rubi eir] already cherry red flesh");
                        else if (this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] == 2)
                            this.outputText("the fur rapidly retreating and replaced with bright red flesh underneath");
                        this.outputText(", but it doesn't seem to be even.  The majority of Rubi's body is cherry red, while [rubi eir] belly actually lightens, becoming a sweet, silvery gray.  A number of similarly silver stripes appear, seemingly at random, up and down Rubi's arms and legs, and even down [rubi eir] demonic tail, amazingly enough.");
                        ...
                        this.flags[kFLAGS_1.kFLAGS.RUBI_SKIN] = 3;
                    }
                    //(Anemone Penis, must have a penis)
                    else if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 0 && this.rubiGetCockType() != CockTypesEnum_1.CockTypesEnum.ANEMONE) {
                        ...
                        if (this.rubiGetCockType() != CockTypesEnum_1.CockTypesEnum.HUMAN)
                            this.outputText(", first shifting towards a more human-like appearance");
                        this.outputText(".  Small nodules appear, around the crown of the penis, and around its base.  Rubi's delicate hands run across two of the nodules, and [rubi eir] cock suddenly stiffens, harder than you've ever seen it!  Whatever those things are, they're quite sensitive.");
                    ...
                    this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_TYPE] = CockTypesEnum_1.CockTypesEnum.ANEMONE;
                }
                //(No)
                else {
        ...
        //GRO+/REDUCTO
        rubiGrowPlusBreasts() {
            this.outputText(this.images.showImage("rubi-gro-plus-tits"), false);
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You hand over the vial of blueish liquid.  Rubi takes a moment to look it over, before taking a deep breath and injecting half of the vial into one breast and the rest into [rubi eir] other breast.");
            //(If breast increase)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 7 || (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 30 && this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
                ...
                this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] += 2 + Rubi.rand(2);
                if (this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY]) {
                    // trace("Hyper happy grow");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] > 30)
                        this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] = 30;
                }
                else {
                    // trace("Normal grow");
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] > 7)
        ...
        //(If Penis)
        rubiPenisGroPlus() {
            this.outputText(this.images.showImage("rubi-gro-plus-penis"), false);
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You hand over the vial of greenish liquid.  Rubi takes a moment to look it over, before taking a deep breath and injecting the entire thing into the base of [rubi eir] [rubi cock].");
            //(If Penis increase)
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] < 12 || (this.rubiGetCockType() == CockTypesEnum_1.CockTypesEnum.HORSE && this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] < 20) || (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] < 30 && this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
                ...
                this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] += 2 + Rubi.rand(2);
                if (this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY]) {
                    if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 30) {
                        // trace("Limiting Rubi's Cock-Size");
                        this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] = 30;
                    }
                }
                else {
                    if (this.rubiGetCockType() != CockTypesEnum_1.CockTypesEnum.HORSE) {
                        if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 12)
                            this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] = 12;
                    }
                    else {
                        if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] > 20)
                            this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] = 20;
                    }
                }
            }
            else {
                ...
                if (this.rubiGetCockType() == CockTypesEnum_1.CockTypesEnum.HORSE)
                    this.outputText("sheath-stuffing horse-dick");
                else
                    this.outputText("giant dick.");
            }
            this.player.consumeItem(this.consumables.GROPLUS);
            this.menu();
            this.addButton(0, "Next", this.pickAnItemToFeedRubi);
        ...
        rubiBoobsReducto() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You hand over the jar of paste.  Rubi looks it over and, after giving it a sniff, uses two fingers to scoop up some of the pale substance, smearing it over [rubi eir] breasts.  Before long, the jar is empty and [rubi eir] [rubi breasts] are covered in the stuff.");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] > 0) {
        ...
        rubiPenisReducto() {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You hand over the jar of paste.  Rubi looks it over and, after giving it a sniff, uses two fingers to scoop up some of the pale substance, smearing it over [rubi eir] penis.  Before long, the jar is empty and [rubi eir] [rubi cock] is covered in the stuff.");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_COCK_SIZE] >= 3) {
        ...
        pickAnItemToFeedRubi() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_FETISH_CLOTHES] == 1)
                ...
                if (this.player.hasItem(this.armors.RBBRCLT))
                    this.addButton(button++, "Rubberclothes", this.giveRubiClothes, this.armors.RBBRCLT);
            }
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_GREEN_ADVENTURER] == 1)
                closet[closet.length] = "A Green Adventurer's Outfit";
            else {
                ...
                if (this.player.hasItem(this.armors.ADVCLTH))
                    this.addButton(button++, "Green Clothes", this.giveRubiClothes, this.armors.ADVCLTH);
            }
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_TUBE_TOP] == 1)
                closet[closet.length] = "A Tube Top";
            else {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_TIGHT_PANTS] == 1)
                ...
                if (this.player.hasItem(this.armors.LTHRPNT))
                    this.addButton(button++, "Leather Pants", this.giveRubiClothes, this.armors.LTHRPNT);
            }
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NURSE_CLOTHES] == 1)
                closet[closet.length] = "Nurse's Clothes";
            else {
                ...
                if (this.player.hasItem(this.armors.NURSECL))
                    this.addButton(button++, "Nurse Clothes", this.giveRubiClothes, this.armors.NURSECL);
            }
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_SWIMWEAR] == 1)
                closet[closet.length] = "Slutty Swimwear";
            else {
            ...
            if (closet.length > 0) {
                ...
                for (var x = 0; x < closet.length; x++)
                    this.outputText("\n" + closet[x]);
                this.outputText("\n\n");
            }
            if (gifts.length > 0) {
                this.outputText("After a quick glance around Rubi's things, you bet [rubi ey] could really use... " + gifts[Rubi.rand(gifts.length)] + ".\n\n");
            }
            else {
                this.outputText("You've given Rubi all the clothes [rubi ey] would want to make use of.");
                if (this.silly())
                    this.outputText("  (Achievement Unlocked: Dress-tacular)");
                this.outputText("\n\n");
            }
            ...
            if (this.player.hasItem(this.consumables.INCUBID))
                this.addButton(button++, "Incubi Draft", this.giveRubiATFItem, this.consumables.INCUBID);
        ...
        //(Give Clothes)
        giveRubiClothes(itype) {
            this.clearOutput();
            this.rubiSprite();
            this.outputText("You hand over the spare set of clothes, and Rubi's eyes light up.  \"<i>For me?</i>\"  the little demon practically screams, ecstatic.  \"<i>ThankyouthankyouthankyouTHANKYOU!</i>\"");
            ...
            this.player.consumeItem(itype, 1);
            if (itype == this.armors.CLSSYCL)
                this.flags[kFLAGS_1.kFLAGS.RUBI_SUITCLOTHES] = 1;
            else if (itype == this.armors.RBBRCLT)
                this.flags[kFLAGS_1.kFLAGS.RUBI_FETISH_CLOTHES] = 1;
            else if (itype == this.armors.ADVCLTH)
                this.flags[kFLAGS_1.kFLAGS.RUBI_GREEN_ADVENTURER] = 1;
            else if (itype == this.armors.TUBETOP)
                this.flags[kFLAGS_1.kFLAGS.RUBI_TUBE_TOP] = 1;
            else if (itype == this.armors.T_BSUIT)
                this.flags[kFLAGS_1.kFLAGS.RUBI_BODYSUIT] = 1;
            else if (itype == this.armors.B_DRESS)
                this.flags[kFLAGS_1.kFLAGS.RUBI_LONGDRESS] = 1;
            else if (itype == this.armors.LTHRPNT)
                this.flags[kFLAGS_1.kFLAGS.RUBI_TIGHT_PANTS] = 1;
            else if (itype == this.armors.NURSECL)
                this.flags[kFLAGS_1.kFLAGS.RUBI_NURSE_CLOTHES] = 1;
            else if (itype == this.armors.S_SWMWR)
                this.flags[kFLAGS_1.kFLAGS.RUBI_SWIMWEAR] = 1;
            else if (itype == this.armors.I_CORST)
                this.flags[kFLAGS_1.kFLAGS.RUBI_INQUISITORS_CORSET] = 1;
            else if (itype == this.armors.BONSTRP)
                this.flags[kFLAGS_1.kFLAGS.RUBI_BONDAGE_STRAPS] = 1;
            this.rubiAffection(20);
            this.doNext(this.rubisFuckingHouseYouPervert);
        }
        //Rubi's Bimbofication
        hypnoBimboficationForRubiSloots() {
            this.clearOutput();
            this.outputText("You slither out of your [armor], flicking your tongue hungrily at the air, tasting the petite boy's desire. He is so attracted to you, and yet, he's trying so hard to be classy about it. It's cute in its own way, but you'd rather see him be more... honest about his drives. You want the cute, ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] < 1)
                this.outputText("femmy boy");
            else if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] > 0)
                this.outputText("dick-girl");
            else
                this.outputText("little slut");
            this.outputText(" ready to lust after your cock openly, to cling to you whenever you arrive and grope your bulge in public. He needs to be less worried about propriety and more focused on sexual satiation and appeal... yes.");
            ...
            if (this.player.cockTotal() > 1)
                this.outputText("s");
            this.outputText(" whipped out and swaying with your sinuous movements, and all he has is his comparatively undersized little pecker. You rock your whole body with the snake-like grace given to you by your naga body, swaying rhythmically as you meet his eyes. Knowing full well just what kinds of depravity you'd like to force him into, you feel a ");
            if (kGAMECLASS_1.kGAMECLASS.monk >= 5)
                this.outputText("familiar ");
            else
                this.outputText("strange ");
            this.outputText("dark power welling up within you.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] > 0)
                this.outputText("femboy");
            else
                this.outputText("hermaphrodite");
            this.outputText(". The longer he stares into your power, the slacker his jaw becomes.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] > 0)
                ...
                this.outputText("dickgirl");
            this.outputText(" must have quite the mind on him if it's making him drip THAT fast.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] > 0)
                this.outputText("y-boy");
            this.outputText(" simply gives the slightest of nods as a reply.");
            ...
            this.outputText("\n\n<b>Rubi is now a ");
            if (this.flags[kFLAGS_1.kFLAGS.RUBI_NO_CUNT] > 0)
                this.outputText("shemale ");
            this.outputText("bimbo! She's going to be a lot more lusty and airheaded, but isn't that what you wanted?</b>");
            this.flags[kFLAGS_1.kFLAGS.RUBI_BIMBO] = 1;
            this.flags[kFLAGS_1.kFLAGS.RUBI_SHE] = 1;
            this.flags[kFLAGS_1.kFLAGS.RUBI_BREAST_SIZE] = 5;
            //Sex menu
