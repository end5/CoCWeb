define(["require", "exports", "./TelAdreAbstractContent", "../../../PregnancyStore", "../../../GlobalFlags/kFLAGS", "../../../CoC", "../../../../console", "../../../StatusAffects", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, TelAdreAbstractContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, StatusAffects_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Cotton extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        constructor() {
            super();
            this.pregnancy = new PregnancyStore_1.PregnancyStore(kFLAGS_1.kFLAGS.COTTON_PREGNANCY_TYPE, kFLAGS_1.kFLAGS.COTTON_PREGNANCY_INCUBATION, 0, 0);
            this.pregnancy.addPregnancyEventSet(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, 300, 200, 100, 40);
        ...
        timeChange() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] > 0 && this.model.time.hours == 23)
                this.flags[kFLAGS_1.kFLAGS.COTTON_OLDEST_KID_AGE]++;
            console_1.trace("\nCotton time change: Time is " + this.model.time.hours + ", incubation: " + this.pregnancy.incubation + ", event: " + this.pregnancy.event);
            return false;
        }
        timeChangeLarge() {
            if (this.model.time.hours == 6 && this.flags[kFLAGS_1.kFLAGS.COTTON_BREAKFAST_CLUB] == 1 && this.player.biggestLactation() >= 2) {
                this.flags[kFLAGS_1.kFLAGS.COTTON_BREAKFAST_CLUB] = 0;
        ...
        pregCottonChance(bonusMult = 1) {
            //No preg if already preg!
            if (this.pregnancy.isPregnant)
                return;
            //Okay, we have a chance!  Run the numbers!
            //Herbs off?  Good chances!
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_HERBS_OFF] > 0) {
                if (Cotton.rand(5) == 0 || this.player.cumQ() > Cotton.rand(1000) || this.player.virilityQ() >= 0.5) {
                    this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, PregnancyStore_1.PregnancyStore.INCUBATION_COTTON);
                }
            }
            //HERBS ON - LESS CHANCE
                ...
                if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 0) {
                    if (Cotton.rand(5) == 0 || this.player.cumQ() * this.player.virilityQ() >= Cotton.rand(1000)) {
                        this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, PregnancyStore_1.PregnancyStore.INCUBATION_COTTON);
                    }
                }
        ...
        cottonPregPCChance() {
            //No kids yet - lucky!
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 0 && this.flags[kFLAGS_1.kFLAGS.COTTON_HERBS_OFF] == 0) {
                this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_COTTON, PregnancyStore_1.PregnancyStore.INCUBATION_COTTON, 600);
            }
            else {
                if (this.flags[kFLAGS_1.kFLAGS.COTTON_HERBS_OFF] == 0)
                    this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_COTTON, PregnancyStore_1.PregnancyStore.INCUBATION_COTTON, 1000);
                else
                    this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_COTTON, PregnancyStore_1.PregnancyStore.INCUBATION_COTTON, 100);
            }
        }
        //ToC
        //Cotton Pregnancy
        ...
        cottonsIntro() {
            if (this.model.time.hours >= 12 && this.model.time.hours <= 18) {
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.COTTON_MET_FUCKED] == 1)
        ...
        cottonGreeting() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.LIFETIME_GYM_MEMBER] == 0)
                this.outputText("The centauress sees you starting for the horse-girl and says, \"<i>Go ahead and talk, but if you want to work out with her I'll have to charge you.</i>\"\n\n", false);
            //Greeting (first time):
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_MET_FUCKED] == 0) {
                this.flags[kFLAGS_1.kFLAGS.COTTON_MET_FUCKED] = 1;
                this.outputText("You wander over to the equine on the mat, curious as to what she's doing.  She stretches out on her mat, spine flexed.  Her head cranes backwards to see you approach.  \"<i>Oh, hi there!</i>\" She grins an upside-down grin at you and finishes her stretch before standing up.  ", false);
                //(If PC height is greater than 6'6</i>\"
                if (this.player.tallness > 78)
                    this.outputText("Despite her impressive stature, you still look down on her.", false);
                //(If PC height is in between:
                else if (this.player.tallness >= 76)
                    this.outputText("She's roughly your height, which is rather impressive in itself.", false);
                //(If PC height is under 6'4</i>\":
                else
                    this.outputText("She is truly tall, and you have to look up to her.", false);
        ...
        cottonGreetingCommonEnd() {
            if (this.player.pregnancyIncubation <= 225 && this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_COTTON) {
                //Lamaze Class*
        ...
        cottonMenu() {
            ...
            if (this.pregnancy.isPregnant || this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] >= 1)
        ...
        centaurNagaBodyBookStuff() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_UNUSUAL_YOGA_BOOK_TRACKER] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.COTTON_UNUSUAL_YOGA_BOOK_TRACKER]++;
                this.doNext(this.camp.returnToCampUseOneHour);
            }
            //Come back wtih book first time
            else if (this.flags[kFLAGS_1.kFLAGS.COTTON_UNUSUAL_YOGA_BOOK_TRACKER] == 1 && this.player.hasKeyItem("Yoga Guide") >= 0) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.COTTON_UNUSUAL_YOGA_BOOK_TRACKER] == 1) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.COTTON_UNUSUAL_YOGA_BOOK_TRACKER] == 2) {
        ...
        acceptYoga() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.LIFETIME_GYM_MEMBER] == 0 && this.player.gems < 10) {
            ...
            if (this.player.pregnancyIncubation <= 225 && this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_COTTON) {
                ...
                //CHAT STUFF!
                this.cottonChat();
                this.outputText("Once you're done and about to hit the showers, Cotton pulls you aside and says with a grin, \"<i>Up for some post-workout exercises?</i>\"", false);
            ...
            //First time
            else if (this.flags[kFLAGS_1.kFLAGS.TIMES_HAD_YOGA] == 0) {
                this.outputText("\"<i>Good, good, you won't regret it. First things first, pet, let's get you out of that dreadful clothing.</i>\"  She leads you to the lockers and helps you strip out of your " + this.player.armorName + ".", false);
                if (this.player.gender == 3)
                    this.outputText("  She spies your crotch and smiles, \"<i>Oh, best of both worlds, are we? Well you're in good company then.</i>\"", false);
                //(If PC is male:
                else if (this.player.hasCock())
                    this.outputText("  She cradles your " + this.cockDescript(0) + " and smiles at you, \"<i>Well, we might find a use for that later.</i>\"", false);
                //(If PC is female:
                else if (this.player.hasVagina())
                    this.outputText("  She pats your groin and says, \"<i>Y'know, I know some good exercises that really work the vaginal muscles... perhaps we'll talk about that later.</i>\"", false);
                this.outputText("\n\n", false);
            ...
            //Done yoga > 0 && met type = 1
            else if (this.flags[kFLAGS_1.kFLAGS.COTTON_MET_FUCKED] == 1 && this.flags[kFLAGS_1.kFLAGS.TIMES_HAD_YOGA] > 0) {
                ...
                this.outputText("Once you're done and about to hit the showers, Cotton pulls you aside and says, \"<i>I know you weren't comfortable with our shower before, so I won't join you this time. But if you ever change your mind, just say the word.</i>\"", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_HAD_YOGA]++;
            this.fatigue(20);
        ...
        cottonChat() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] > 0)
                chats[chats.length] = 2;
            //VALA
            if (this.flags[kFLAGS_1.kFLAGS.FREED_VALA] != 0)
                chats[chats.length] = 3;
            //(Jojo chat)
            if (kGAMECLASS_1.kGAMECLASS.monk > 0)
                chats[chats.length] = 4;
            var choice = chats[Cotton.rand(chats.length)];
            //(Urta Chat)
            if (choice == 1) {
                //(If you've rejected Urta's love or left her)
                if (this.flags[kFLAGS_1.kFLAGS.URTA_COMFORTABLE_WITH_OWN_BODY] < 0 || this.flags[kFLAGS_1.kFLAGS.URTA_PC_LOVE_COUNTER] < 0)
                ...
                else if (kGAMECLASS_1.kGAMECLASS.urta.urtaLove())
            ...
            //(Edryn chat)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NEVER_SEE_AGAIN] > 0)
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] > 0)
            ...
            //(Scylla chat)
                ...
                if (this.flags[kFLAGS_1.kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] < 5 && this.flags[kFLAGS_1.kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] > 0)
                    this.outputText("While you're doing your stretches, you find yourself chatting about the folks of Tel'Adre. \"<i>Scylla?</i>\" Cotton says, \"<i>She's the oddly dressed woman at the Wet Bitch, right? Can't say I know much about her. She's so secretive.</i>\"\n\n", false);
                //(if Scylla has formed support group)
                else if (this.flags[kFLAGS_1.kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] >= 5)
                    this.outputText("While you're doing your stretches, you find yourself chatting about the folks of Tel'Adre. \"<i>Scylla?</i>\" Cotton says, \"<i>I hear she formed an addiction support group. Good on her, there's a lot of people in and around town who need help. I'm glad she's stepping up.</i>\"\n\n", false);
            }
            //(Vala chat)
            else if (choice == 4) {
                //(Only if Vala has been freed)
                if (this.flags[kFLAGS_1.kFLAGS.FREED_VALA] != 0)
                    this.outputText("While you're doing your stretches, you find yourself chatting about the folks of Tel'Adre. \"<i>Vala?</i>\" Cotton says, \"<i>That's the new waitress at the Wet Bitch, right? She's cute. A shame what she's gone through. Sometimes I wish we could wipe out every last imp.</i>\"\n\n", false);
            }
            //(Jojo chat)
            else if (choice == 5) {
                ...
                else if (kGAMECLASS_1.kGAMECLASS.monk > 1)
        ...
        cottonFirstTimeFuckHer() {
            this.spriteSelect(12);
            this.flags[kFLAGS_1.kFLAGS.COTTON_MET_FUCKED] = 2;
            this.outputText("", true);
            ...
            this.outputText("Her pussy quivers and trembles around your tongue. You can tell she's so close to orgasm... but that's not what you want right now.  With a small amount of regret, you pull back from her delicious snatch, wipe the water and juices from your face and stand, stroking your " + this.cockDescript(x) + " to full attention and pressing it against her ready hole. Grasping her hips firmly, you whisper dirty words into your horse lover's ear before slowly thrusting in. Cotton gives an ever-so-slight whinny and a gasp, her body moving back into yours.\n\n", false);
        ...
        cottonFucksYou() {
            ...
            if (this.player.gender == 1) {
                ...
                this.outputText("\"<i>Oh now pet, don't be so scared,</i>\" Cotton whispers into your ear, then lifts her cock from your back and places it at your " + this.assholeDescript() + ". She reaches forwards and you hear the squeak of the temperature nozzle being turned. Seconds later, the water pouring down on you gets hotter, causing your whole body to heat up in response. Using this time, Cotton presses forwards, her equine cock invading your " + this.assholeDescript() + " like a charging army. She thrusts in and out slowly, being careful not to hurt you.", false);
                this.player.buttChange(72, true, true, false);
                this.outputText("\n\n", false);
                this.outputText("Before long you find yourself moaning beneath her, your " + this.assholeDescript() + " clenching and unclenching uncontrollably. \"<i>Ooh, my little pet likes it now, hmmm?</i>\" She whispers into your ear and nibbles on it ever-so-slightly. You can't help but give a breathless \"<i>Yes</i>\" in response. Cotton giggles and speeds up her thrusts. You find yourself pushing back into her, urging her to go deeper and deeper. Your own dick is completely limp in the presence of this godly cock, but tingles with pleasure and anticipation.\n\n", false);
                this.outputText("After a few minutes of this, neither of you can take much more. Both of you give a deep moan of orgasmic pleasure as your " + this.assholeDescript() + " clenches and you feel your equine lover's cock twitch and spasm within you, flooding your hole with her hot seed. Your own limp member shudders with orgasm, but instead of spurting, it leaks a small torrent of cum right down onto the floor.", false);
                if (this.player.cumQ() >= 1000)
                    this.outputText("  You nearly clog the drain with all the spooge leaking from your flaccid shaft.", false);
                this.outputText("\n\n", false);
            ...
            //(Get fucked, as Female)
                ...
                this.outputText("You nod your head in assent. Noticing you didn't take the initiative, Cotton smiles and moves behind you, pushing you under your own shower spray. \"<i>Don't worry, my little pet, let Cotton take care of everything...</i>\" She gets a handful of soap and gently rubs your back, massaging the soap in while relaxing your muscles. You lean forward resting your arms and torso against the wall in front of you.\n\n", false);
                this.outputText("Cotton smiles, continuing to massage the soap in until she gets to your rear. There, she gets another handful of soap and presses it into your crevasse, gently soaping you up from " + this.clitDescript() + " to tailbone. Then she carefully inserts one finger into your pussy, then two, three, and before long her entire hand is exploring your most personal depths. She giggles and withdraws her hand, \"<i>My my, such an eager little cunt you have, my pet.</i>\"\n\n", false);
                this.outputText("She reaches between her legs and lifts her cock, letting it rest on the small of your back while she wets it down with water from the shower and strokes it to its full length. You feel it inching across your back, growing hotter and harder. With a glance back, you estimate it must be at least two feet long! You gulp and put your head down, clenching your teeth for the inevitable.\n\n", false);
                this.outputText("\"<i>Oh now pet, don't be so scared,</i>\" Cotton whispers into your ear, then lifts her cock from your back and places it at your " + this.vaginaDescript(0) + ". She reaches forwards and you hear the squeak of the temperature nozzle being turned. Seconds later, the water pouring down on you gets hotter, causing your whole body to heat up in response. Using this time, Cotton presses forwards, her equine cock invading your " + this.vaginaDescript(0) + " like a charging army. She thrusts in and out slowly, being careful not to hurt you.", false);
                ...
                this.outputText("Your 'post-workout stretch' and shower done, the two of you dry off, redress and leave the gym. Cotton takes you by the arm and says, \"<i>That was great, little pet. Come by the gym anytime. I'll be waiting.</i>\"  Then, she heads back home.  With a little grin on your face, you do the same.", false);
                this.player.orgasm();
                this.dynStats("sen", -1);
            ...
            //(Get fucked, as Herm)
                ...
                this.outputText("Cotton smiles, continuing to massage the soap in until she gets to your rear. There, she gets another handful of soap and presses it into your crevasse, gently soaping you up from " + this.clitDescript() + " to tailbone. Then she carefully inserts one finger into your pussy, then two, three, and before long her entire hand is exploring your most personal depths. She giggles and withdraws her hand, \"<i>My my, such an eager little cunt you have, my pet.</i>\"\n\n", false);
                this.outputText("She reaches between her legs and lifts her cock, letting it rest on the small of your back while she wets it down with water from the shower and strokes it to its full length. You feel it inching across your back, growing hotter and harder. With a glance back, you estimate it must be at least two feet long! You gulp and put your head down, clenching your teeth for the inevitable.\n\n", false);
                this.outputText("\"<i>Oh now pet, don't be so scared,</i>\" Cotton whispers into your ear, then lifts her cock from your back and places it at your " + this.vaginaDescript() + ". She reaches forwards and you hear the squeak of the temperature nozzle being turned. Seconds later, the water pouring down on you gets hotter, causing your whole body to heat up in response. Using this time, Cotton presses forwards, her equine cock invading your " + this.vaginaDescript() + " like a charging army. She thrusts in and out slowly, being careful not to hurt you.", false);
                this.player.cuntChange(72, true, true, false);
                this.outputText("\n\n", false);
                this.outputText("Before long you find yourself moaning beneath her, your cunt clenching and unclenching uncontrollably. \"<i>Ooh, my little pet likes it now, hmmm?</i>\" She whispers into your ear and nibbles on it ever-so-slightly. You can't help but give a breathless \"<i>Yes</i>\" in response. Cotton giggles and speeds up her thrusts. You find yourself pushing back into her, urging her to go deeper and deeper. Your " + this.clitDescript() + " twinges with pleasure after every thrust, and your own " + this.cockDescript(0) + " is completely limp in the presence of this godly cock, but still it tingles with pleasure and anticipation.\n\n", false);
            ...
            */
            ...
            if (this.player.isTaur()) {
                ...
                if (this.pregnancy.event > 1)
                    this.outputText("pulling you gently towards her bulging belly, which you can't help but put your hands against as you kiss her. The bulge is firm and solid, almost a drum of solid muscle, and you caress it as you and the mare-morph make out, eliciting soft murmurs of appreciation for your efforts.\n\n");
                else
                    this.outputText("pulling you closer.\n\n", false);
                //(If PC has one cock)
                if (this.player.cockArea(x) >= 100) {
                    if (this.player.cockTotal() == 1)
                        this.outputText("You feel your " + this.cockDescript(x) + " stirring beneath your large body, while Cotton's remains curiously limp.  While her cock dangles, yours strains for attention.", false);
                    //(If PC has multiple cocks)
                    else if (this.player.cockTotal() > 1)
                        this.outputText("You feel your " + this.multiCockDescriptLight() + " stirring beneath your large body, while Cotton's remains curiously limp.  While her cock dangles, your group of cocks strains for attention.", false);
                }
                else {
                    if (this.player.cockTotal() == 1)
                        this.outputText("You feel your " + this.cockDescript(x) + " stirring beneath your large body, while you watch Cotton's do the same. Her cock rubs against your stomach while yours strains for attention.", false);
                    //(If PC has multiple cocks)
                    else if (this.player.cockTotal() > 1)
                        this.outputText("You feel your " + this.multiCockDescriptLight() + " stirring beneath your large body, while you watch Cotton's do the same. Her cock rubs against your stomach while your group of cocks strains for attention.", false);
                }
                //(If PC has a pussy, add the following)
                if (this.player.hasVagina())
                    this.outputText("  Meanwhile, your " + this.vaginaDescript(0) + " behind you moistens both from the steam and from arousal, and your " + this.clitDescript() + " aches, craving attention.", false);
                this.outputText("\n\n", false);
                //(If PC has breasts)
                if (this.player.biggestTitSize() >= 2) {
                    this.outputText("Cotton leans down, groping your " + this.biggestBreastSizeDescript() + ", taking one " + this.nippleDescript(0) + " into her mouth and sucking it greedily.", false);
                    //(and if PC is lactating)
                    if (this.player.biggestLactation() >= 1) {
                        this.outputText("  Her efforts are soon rewarded as milk begins seeping from your " + this.nippleDescript(0) + ". Cotton's eyes turn up to your face in surprise, but she doesn't remove her mouth, instead taking the time to gulp down your tasty milk. It isn't long before she draws back, wipes her mouth and practically tackles your other breast, eager to drain it of its precious cargo. You can't help but moan as a draining sensation overwhelms you. After a moment, Cotton pulls away and smacks her lips. \"<i>That is some tasty, tasty milk, pet, I might have to taste you more often.</i>\"", false);
                        this.flags[kFLAGS_1.kFLAGS.COTTON_BREAKFAST_CLUB] = 1;
                    }
                    //(else is PC is not lactating)
                    else
                        this.outputText("  Cotton soon switches to the other breast, teasing your " + this.nippleDescript(0) + " with her talented tongue.", false);
                    this.outputText("\n\n", false);
                }
                ...
                if (this.player.cockTotal() == 2)
                    this.outputText("  With a slight grin, you begin poking your extra dick at Cotton's other hole. You hear an indignant grunt, followed by a sigh, and feel her hands on your member, guiding it all the way into her hole.", false);
                //(If the player has more cocks, add)
                else if (this.player.cockTotal() > 2)
                    this.outputText("  The rest of your cocks jiggle and bob, rubbing up against her thighs and butt wildly.", false);
                //(If player is too big, add)
                if (this.player.cockArea(x) > 70)
                    this.outputText("  Though you are far too big for her, you make sure to stuff her as much as you can. Her cunt, big as it is, squeezes tightly on your " + this.cockDescript(x) + ". She shivers and quakes, and leans against the bench, gripping your forelegs for support. You thrust your overly large tool inside her over and over, stretching her already not-insignificant cunt even wider. Her tongue actually rolls out of her snout, lolling to the side while her eyes roll up into her head, lost in the pleasure. Her body rocks with an orgasm while you piston away under the spray of water.", false);
                //(if player is too small (under 4</i>\")
                    ...
                    if (this.pregnancy.event > 1)
                        this.outputText("Don't worry pet, it's plenty adequate for me.  And you've got to admit,</i>\" she smirks, rubbing her round belly, \"<i>It gets the job done, doesn't it?");
                    else
                        this.outputText("Don't worry pet, it's plenty adequate for me.");
                    this.outputText("</i>\" Letting a little smile cross your lips, you push your " + this.cockDescript(x) + " fully into her, not a big accomplishment for one of your size, but still enough to make you feel good.", false);
                }
                //(if none of the above, add)
                else
                    this.outputText("  You piston back and forth, and though Cotton's cunt is sizable, it's able to grip you tightly. Your equine lover moans and grasps at your chest, eventually seizing your leg for support, though she leans backwards.", false);
                this.outputText("\n\n", false);
                ...
                if (this.player.cockArea(x) >= 100)
                    this.outputText("Oblivious to you, her own limp cock leaks cum down onto the bench as an orgasm rocks her body.");
                else if (this.pregnancy.event > 1)
                    this.outputText("Oblivious to you, her own cock twitches and spasms, letting loose a spray of cum across her swollen, pregnant belly, breasts and the bench as an orgasm rocks her body.");
                else
                    this.outputText("Oblivious to you, her own cock twitches and spasms, letting loose a spray of cum across her belly, breasts and the bench as an orgasm rocks her body.", false);
                //(If player is too big, add)
                if (this.player.cockArea(x) > 70)
                    this.outputText("  Even with all the pounding you've been doing, you can't fit your entire girth into her, but she doesn't care. Her eyes seem to roll back and forth like it's hard to focus, and her tongue drips water, sweat and saliva onto her body. She's panting for breath and you are able to make out faint, \"<i>Oh gods, oh gods</i>\" over the running water. Were you able to see her toned stomach, you're sure you could see the outline of your " + this.cockDescript(x) + " in it. Her back arches under the shower, her red hair messily draped around her face and bench, and she bites her lip as another orgasm rocks her body.", false);
                this.outputText("\n\n", false);
                this.outputText("Finally you just can't take any more. You give one last thrust into your partner and audibly gasp in relief as an orgasm rolls across your body, hitting your nerves with bolts of ecstatic lightning.", false);
                //(If PC has a pussy)
                if (this.player.hasVagina())
                    this.outputText("  Your " + this.cockDescript(x) + " erupts inside Cotton's warm cunt which clenches you tightly, while your own femme sex twinges and clenches on air, drooling juices down your legs.", false);
                //(else)
                else
                    this.outputText("   Your " + this.cockDescript(x) + " erupts inside Cotton's warm cunt which clenches you tightly.", false);
                //(regardless or above, add)
                this.outputText("  You give a couple more token thrusts and pull out. As you do, ", false);
                if (this.player.cumQ() < 200)
                    ...
                    this.outputText("a massive flood of cum escapes from her cunt", false);
            ...
            //(Repeat fuck her, for nagas)
                ...
                if (this.player.cockArea(x) >= 100) {
                    //(If PC has one cock)
                    if (this.player.cockTotal() == 1)
                        this.outputText("  You feel your " + this.cockDescript(x) + " stirring beneath you, slowly coming to attention, though Cotton's remains curiously limp.  Your " + this.player.cockHead(x) + " rubs against her belly, sending ripples of pleasure up your spine.", false);
                    //(If PC has multiple cocks)
                    else if (this.player.cockTotal() > 1)
                        this.outputText("  You feel your " + this.multiCockDescriptLight() + " stirring beneath you, slowly coming to attention, though Cotton's remains curiously limp.  The group of cocks rubs together as you make out, sending ripples of pleasure up your spine.", false);
                }
                else {
                    //(If PC has one cock)
                    if (this.player.cockTotal() == 1)
                        this.outputText("You feel your " + this.cockDescript(x) + " stirring beneath you, slowly coming to attention alongside Cotton's equine member.  The two rub together as you make out, sending ripples of pleasure up your spine.", false);
                    //(If PC has multiple cocks)
                    else if (this.player.cockTotal() > 1)
                        this.outputText("You feel your " + this.multiCockDescriptLight() + " stirring beneath you, slowly coming to attention alongside Cotton's equine member. The group of cocks rubs together as you make out, sending ripples of pleasure up your spine.", false);
                }
                //(If PC has a pussy, add the following)
                if (this.player.hasVagina())
                    this.outputText("Your " + this.vaginaDescript(0) + " meanwhile moistens both from the water and from arousal, and your " + this.clitDescript() + " aches, craving attention.", false);
                this.outputText("\n\n", false);
                //(If PC has breasts)
                if (this.player.biggestTitSize() >= 2) {
                    this.outputText("Cotton leans down, groping your " + this.biggestBreastSizeDescript() + ", taking one " + this.nippleDescript(0) + " into her mouth and sucking it greedily.", false);
                ...
                this.outputText("Suitably turned on now, you coil your body around Cotton's torso, with your tail spreading her legs apart while you place your " + this.cockDescript(x) + " at her pussy. You slowly push in, and Cotton bites her lip, looking at you in approval.", false);
                //(If player has two cocks, add)
                if (this.player.cockTotal() == 2)
                    this.outputText("  With a slight grin, you position your extra dick at Cotton's other hole. She quirks her eyebrow and a look of panic momentarily crosses her face, but you push forward anyway. Cotton's eyes roll up briefly and her lip quivers.", false);
                //(If the player has more cocks, add)
                else if (this.player.cockTotal() > 2)
                    this.outputText("  The rest of your cocks strain, aching for holes to fill. With none available, they throb as they rub against Cotton's smooth skin.", false);
                //(If player is too big, add)
                if (this.player.cockArea(x) > 70)
                    this.outputText("  Though you are far too big for her, you make sure to stuff her as much as you can. Her cunt, big as it is, squeezes tightly on your " + this.cockDescript(x) + ". She shivers and quakes, and leans against the shower wall, gripping the shower-head for support. You thrust your overly large tool inside her over and over, stretching her already not insignificant cunt even wider. Her tongue actually rolls out of her snout, lolling to the side while her eyes roll up into her head, lost in the pleasure. Her body rocks with an orgasm while you piston away under the spray of water.", false);
                //(if player is too small (under 4</i>\") add)
                    ...
                    if (this.pregnancy.event > 1)
                        ...
                        this.outputText("Don't worry pet, it's plenty adequate for me.");
                    this.outputText("</i>\" Giving her a little smile, you push your " + this.cockDescript(x) + " fully into her, not a big accomplishment for one of your size, but still enough to give you a little smile.", false);
                }
                //(otherwise add)
                else
                    this.outputText("  You piston back and forth, and though Cotton's cunt is sizeable, it's able to grip you tightly. Your equine lover moans and grasps at your chest, eventually seizing your shoulder for support, though she leans backwards.", false);
                this.outputText("\n\n", false);
                ...
                if (this.player.cockArea(x) >= 100)
                    this.outputText("Her own cock, still limp, visibly twitches and begins leaking cum onto her belly as an orgasm rocks her body.");
                else if (this.pregnancy.event > 1)
                    this.outputText("Her own cock twitches and spasms, letting loose a spray of cum across her swollen, pregnant belly, breasts and face as an orgasm rocks her body.");
                else
                    this.outputText("Her own cock twitches and spasms, letting loose a spray of cum across her belly, breasts and face as an orgasm rocks her body.", false);
                //(If player is too big, add)
                if (this.player.cockArea(x) > 70)
                    this.outputText("  Even in this pseudo-missionary position you can't stuff your entire enormous girth into her, but she doesn't care. Her eyes seem to roll back and forth like it's hard to focus, and her tongue drips water, sweat and saliva onto her body. She's panting for breath and you are able to make out faint, \"<i>Oh gods, oh gods</i>\" over the running water. You can even make out the shape of your cock in Cotton's toned stomach, pumping back and forth, which brings a smile to your face. Her back arches under the shower, her hair messily spread out beneath her and she bites her lip as another orgasm rocks her body.", false);
                this.outputText("\n\n", false);
                this.outputText("Finally you just can't take anymore. You give one last thrust into your partner and audibly gasp in relief as an orgasm rolls across your body, hitting your nerves with bolts of ecstatic lightning.", false);
                //(If PC has a pussy)
                if (this.player.hasVagina())
                    this.outputText("  Your " + this.cockDescript(x) + " erupts inside Cotton's warm cunt, which clenches you tightly, while your own femme sex twinges and clenches on air, drooling juices down your legs.", false);
                //(else)
            ...
            //(Repeat Fuck Her, for humanoid bodies)
                ...
                if (this.pregnancy.event > 1)
                    ...
                    this.outputText("pulling you closer.", false);
                if (this.player.cockArea(x) >= 100) {
                    //(If PC has one cock)
                    if (this.player.cockTotal() == 1)
                        this.outputText("  You feel your " + this.cockDescript(x) + " stirring beneath you, slowly coming to attention, though Cotton's remains curiously limp.  Your " + this.player.cockHead(x) + " rubs against her belly, sending ripples of pleasure up your spine.", false);
                ...
                if (this.player.hasVagina())
                    this.outputText("  Your " + this.vaginaDescript(0) + " moistens both from the water and from arousal, and your " + this.clitDescript() + " aches, craving attention.", false);
                this.outputText("\n\n", false);
                //(If PC has breasts)
                if (this.player.biggestTitSize() >= 2) {
                    this.outputText("Cotton leans down, groping your " + this.biggestBreastSizeDescript() + ", taking one " + this.nippleDescript(0) + " into her mouth and sucking it greedily.", false);
                ...
                this.outputText("Suitably turned on now, you reach down and hook your arm under one of Cotton's legs, lifting it up while you position your " + this.cockDescript(x) + " at her pussy. You slowly push in, and Cotton bites her lip, looking at you in approval.", false);
                //(If player has two cocks, add)
                if (this.player.cockTotal() == 2)
                    this.outputText("  With a slight grin, you position your other dick at Cotton's other hole. She quirks her eyebrow and a look of panic momentarily crosses her face, but you push forward anyway. Cotton's eyes roll up briefly and her lip quivers.", false);
                //(If the player has more cocks, add)
                if (this.player.cockTotal() > 2)
                    this.outputText("  The rest of your cocks strain, aching for holes to fill. With none available, they throb as they rub against Cotton's smooth skin.", false);
                //(If player is too big, add)
                ...
                if (this.player.cockArea(x) >= 100)
                    ...
                    this.outputText("Her own cock twitches and spasms, loosing a spray of cum across her swollen, pregnant belly, breasts and face as an orgasm rocks her body.");
                else
                    this.outputText("Her own cock twitches and spasms, letting loose a spray of cum across her belly, breasts and face as an orgasm rocks her body.", false);
                //(If player is too big, add)
                if (this.player.cockArea(x) > 70)
                    this.outputText("  Even in the missionary position you can't stuff your entire enormous girth into her, but she doesn't care. Her eyes seem to roll back and forth like it's hard to focus, and her tongue drips water, sweat and saliva onto her body. She's panting for breath and you are able to make out faint, \"<i>Oh gods, oh gods</i>\" over the running water. You can even make out the shape of your cock in Cotton's toned stomach, pumping back and forth, which brings a smile to your face. Her back arches under the shower, her hair messily spread out beneath her and she bites her lip as another orgasm rocks her body.", false);
                this.outputText("\n\n", false);
                this.outputText("Finally you just can't take any more. You give one last thrust into your partner and audibly gasp in relief as an orgasm rolls across your body, hitting your nerves with bolts of ecstatic lightning.", false);
                //(If PC has a pussy)
                if (this.player.hasVagina())
        ...
        cottonFucksYouInShowerRepeat() {
            ...
            if (this.player.isTaur()) {
                ...
                if (this.player.gender == 1)
                    this.outputText("  Your " + this.cockDescript(0) + " tingles betwixt your legs, but remains limp in the presence of Cotton's impressive member.", false);
                //(If PC has a penis and vagina)
                else if (this.player.gender == 3)
                    this.outputText("  Your " + this.cockDescript(0) + " tingles betwixt your legs, but remains limp in the presence of Cotton's impressive member, while your " + this.vaginaDescript(0) + " moistens almost immediately from the steam and arousal.", false);
                //(If PC has a vagina and no penis)
                else if (this.player.gender == 2)
                    this.outputText("  Your " + this.vaginaDescript(0) + " moistens almost immediately as you make out, both from the steam and your increasing arousal.", false);
                //(If PC is genderless)
                else
                    this.outputText("  A deep aching burns within you, a need your body is ill-equipped to process, but still your nipples harden and you find your " + this.assholeDescript() + " puckering in anticipation.", false);
                this.outputText("\n\n", false);
                //(If PC has breasts)
                if (this.player.biggestTitSize() >= 2) {
                    this.outputText("Cotton's kisses lead down to your " + this.biggestBreastSizeDescript() + ", where she takes one " + this.nippleDescript(0) + " into her mouth, sucking it greedily and teasing it masterfully.", false);
                    //(and if PC is lactating)
                    if (this.player.biggestLactation() >= 1) {
                ...
                this.outputText("She continues kissing down your belly, reaching your centaur body. She makes you turn around so your rear end is in the spray of water with her.", false);
                //(If PC has a large penis, bigger than Cotton's capacity, add)
                if (this.player.hasCock()) {
                    if (this.player.cockArea(0) > 70)
                        this.outputText("  \"<i>Oh my, what's this?</i>\" She puts a hand under your enormous, yet embarrassingly limp cock and lifts it slightly. \"<i>My little pet has such a big dick... Just how I like it. Perhaps next time I'll get to try it out... but not today, hm? This is all about you right now.</i>\"", false);
                    //(If PC has a penis under 4</i>\", add)
                    else if (this.player.longestCockLength() < 4)
                        this.outputText("  \"<i>Awww, what's this?</i>\" She puts a hand under your embarrassingly small and limp cock and lifts it slightly. \"<i>It's so cute and tiny. And it certainly knows its place. Only room for one cock right now, not that this is much of a cock.</i>\" She giggles and plants a kiss on the tip, \"<i>It is cute though. I love it.</i>\"", false);
                    //(If PC has a penis neither large or small, add)
                    else
                        this.outputText("Cotton puts a hand under your embarrassingly limp cock and smiles, \"<i>You know how to show a girl you like her... There's only room for one cock right now.</i>\"", false);
                }
                //(If PC has a vagina)
                if (this.player.hasVagina())
                    this.outputText("  Spying your " + this.vaginaDescript(0) + ", Cotton smiles and flicks your " + this.clitDescript() + " teasingly before slipping two fingers inside your folds and bringing them to her mouth, licking them clean. \"<i>Mmm... I love the taste of your juices, pet...</i>\"", false);
                //(if PC is genderless)
                if (this.player.gender == 0)
                    this.outputText("  She places a hand on your bare crotch and quirks an eyebrow. \"<i>Well this is new... Certainly not bad though.</i>\" She runs a hand along your bare mound, which somehow manages to send ripples of pleasure up your spine.", false);
                this.outputText("\n\n", false);
                this.outputText("Cotton continues the kisses down to your " + this.player.legs() + " and stands, dragging over a bench from the locker room before standing on it and giving your " + this.buttDescript() + " a good smack. You turn back and give her a coy look, which she returns and gives your flank another smack.", false);
                this.outputText("  She takes a moment to get some water from the shower over your rear end before pressing her cock against your " + this.player.assholeOrPussy() + ", slipping it in gently, careful not to go too quick. You moan slightly and blush, whispering back at her, urging her to continue.", false);
            ...
            //(Repeat get fucked for humanoids and nagas)
                ...
                //(If PC has a penis, no vagina)
                if (this.player.gender == 1)
                    this.outputText("  Your " + this.cockDescript(0) + " tingles beneath you, but remains limp in the presence of Cotton's impressive member.", false);
                //(If PC has a penis and vagina)
                else if (this.player.gender == 3)
                    this.outputText("  Your " + this.cockDescript(0) + " tingles beneath you, but remains limp in the presence of Cotton's impressive member while your " + this.vaginaDescript(0) + " moistens almost immediately from the steam and arousal.", false);
                //(If PC has a vagina and no penis)
                else if (this.player.gender == 2)
                    this.outputText("  Your " + this.vaginaDescript(0) + " moistens almost immediately as you make out, both from the steam and your increasing arousal.", false);
                //(If PC is genderless)
                ...
                this.outputText("She continues kissing a trail down your belly and to your crotch.", false);
                if (this.player.hasCock()) {
                    //(If PC has a large penis, bigger than Cotton's capacity, add)
                ...
                if (this.player.isNaga()) {
                    ...
                    if (this.pregnancy.event > 1)
                        this.outputText("Moving quickly, you wrap your arms around Cotton's neck and coil your body around her waist, just below her round, pregnant belly, and down one leg.  You can feel her swollen midriff rubbing against the scales on your serpentine half with each motion you make.");
                    else
                        this.outputText("Moving quickly, you wrap your arms around Cotton's neck and coil your body around her waist and down one leg.", false);
                }
                //(If Humanoid body)
                else {
                    ...
                    if (this.pregnancy.event > 1)
                        this.outputText("Moving quickly, you wrap your arms and legs around Cotton so you don't fall over, carefully avoiding her pregnant belly, which is no mean feat. Her belly is pressed into yours, letting you feel the solid weight of it, gentle kicks from your unborn child within.");
                    else
                        this.outputText("Moving quickly, you wrap your arms and legs around Cotton so you don't fall over.", false);
                }
                this.outputText("  She gives you a quick kiss and moves her cock to your " + this.player.assholeOrPussy() + ", slipping it in gently, careful not to go too quick. You give her a submissive, but encouraging kiss, and whisper in her ear, urging her to continue.", false);
                //(Stretch and appropriate virginity check)
                if (this.player.hasVagina())
                    this.player.cuntChange(72, true, true, false);
                else
        ...
        cottonTantricSex() {
            ...
            this.outputText("\"<i>And our spirits are joined... for now,</i>\" she laughs and runs her hands along her upper torso, and in a weird, sort of detached way, you feel it. You touch your chest, rubbing a " + this.nippleDescript(0) + " experimentally, and you see Cotton visibly shiver and give you an approving nod. Whatever she did... you can feel what she feels, however faintly, and vice-versa!\n\n", false);
            ...
            this.outputText("Gulping slightly, you stand and approach her. Cotton runs a hand along her member, causing you to shiver with the", false);
            if (this.player.hasCock())
                this.outputText(" familiar", false);
            else
                this.outputText(" alien", false);
            ...
            //(for Naga Body, add)
            if (this.player.isNaga())
                this.outputText("  You impale yourself fully, settling down and sitting on her lap, stretching your snake-like body out behind and to one side of her, with your arms propping you up as you lean back.", false);
            //(for Humanoid Body, add)
            else
                this.outputText("  You impale yourself fully, settling down and sitting on her lap, mimicking her pose with your legs stretched out behind her and your arms propping you up as you lean back.", false);
            this.outputText("\n\n", false);
            this.outputText("Though there's no real thrusting or vulgar movements of any kind, the feelings are intense, likely heightened by your tantric link. You can simultaneously feel Cotton's long equine cock pulse within you, as well as feel your own " + this.player.assholeOrPussy() + " clamping down on a cock that is not your own.", false);
            if (this.player.hasVagina())
                this.player.cuntChange(72, true, true, false);
            else
                this.player.buttChange(72, true, true, false);
            ...
            if (this.player.hasCock())
                this.outputText("  Meanwhile, your own " + this.cockDescript(0) + " hangs limply in front of you, tingling with arousal, but unable to harden. Cotton gives it a pat and says, \"<i>Worry not, pet, there's only room for one cock right now, but I'll want it some other time.</i>\"", false);
            this.outputText("\n\n", false);
            this.outputText("\"<i>Now let's move on to the Lotus,</i>\" Cotton says, and sits up.", false);
            //(Naga body, add)
            if (this.player.isNaga())
                this.outputText("  You do the same, curling your arms around your partner while your lower body coils around her midsection. Cotton pulls her legs in as well, and it almost looks like you're both sitting normally, if it weren't for you being on her lap with her dick up inside you.", false);
            //(Humanoid body, add)
            else
                this.outputText("  You do the same and curl your arms and legs around your partner. Cotton pulls her legs in as well, and it almost looks like you're both sitting cross legged if it weren't for you being on her lap with her dick up inside you.", false);
            ...
            //(If PC has a penis)
            if (this.player.hasCock())
                this.outputText("  Your " + this.cockDescript(0) + " twitches and tingles, releasing its pent up seed in a dribbling torrent down your belly and chest, right into your face and pooling around your head.", false);
            //(If PC has a vagina)
            if (this.player.hasVagina())
                this.outputText("  Your " + this.vaginaDescript(0) + " shivers and clamps down hard on the invading cock, pulsing and milking it as it unloads directly into your womb.", false);
            //(If PC doesn't have a vagina)
            else
                this.outputText("  Your " + this.assholeDescript() + " shivers and clamps down hard on the invading cock, pulsing and milking it as it unloads directly into your intestines.", false);
            //(regardless of above, add)
            this.outputText("  Lightning arcs from nerve to nerve, in both of your bodies. You can feel every sensation Cotton feels. In that moment, you feel perfectly as one. You aren't simply getting fucked by Cotton. You are simultaneously Cotton fucking yourself, as is she.", false);
            this.outputText("\n\n", false);
        ...
        nomSomeTitMilkCereal() {
            ...
            this.outputText("Cotton sets the bowl down in your lap and pulls down the front of your " + this.player.armorName + ", exposing your " + this.chestDesc() + " to the cool morning breeze. A shiver runs down your spine and your nipples immediately begin to harden, as if knowing what this equine girl has in mind. Cotton leans down and wraps her lips around one " + this.nippleDescript(0) + ", sucking sensually and flicking the tip with her tongue.\n\n", false);
            this.outputText("You feel the familiar sensation of fluids being drawn from you, and soon Cotton is suckling from your milky tit. She relinquishes her hold on the teat, smacks her lips, and brings the bowl up to your breast. With the other hand, she grabs your " + this.nippleDescript(0) + " and breast firmly, pulling and squeezing it. Delicious white milk begins squirting from the ducts of your breast, dribbling and spraying into the bowl of grains. You can't help but moan, squirming in your seat as your tit is ruthlessly milked.\n\n", false);
            ...
            this.outputText("\"<i>Thanks, pet, that was delicious. I'll be sure to stop by another time so we can share a meal. Feel free to come by the gym too. We can get a little more... personal.</i>\" She kisses you on the cheek, and then departs back towards Tel'Adre.", false);
        ...
        cottonPregnantAlertII() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] > 0 || (this.telAdre.edryn.pregnancy.isPregnant && this.flags[kFLAGS_1.kFLAGS.EDRYN_PREGNANT_AND_NOT_TOLD_PC_YET] != 0))
                this.outputText("  Should have figured as much after you got Edryn pregnant.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NEVER_SEE_AGAIN] == 0)
                ...
                this.outputText("you won't abandon me like you did Edryn, will you?");
            this.outputText("</i>\"");
            //[Leave Her] [Stay]
            this.menu();
        ...
        beABadCottonDad() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NEVER_SEE_AGAIN] == 0)
                this.outputText("and slaps you as hard as she can");
            else
                this.outputText("and punches you as hard as she can");
            ...
            this.flags[kFLAGS_1.kFLAGS.PC_IS_A_DEADBEAT_COTTON_DAD] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //(Stay)*
        beAGoodCottonDad() {
            ...
            this.flags[kFLAGS_1.kFLAGS.PC_IS_A_GOOD_COTTON_DAD] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        cottonPopsOutAKid() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 0) {
                ...
                //{Silly Mode:}
                if (this.silly())
                    this.outputText("As long as the cube shark isn't there.  ");
                this.outputText("Let's go.</i>\"");
                //(Depending on PC height:
                if (this.player.tallness < 60)
                    this.outputText("She wraps an arm around your neck");
                else if (this.player.tallness < 70)
                    this.outputText("She places a hand on your shoulder");
                else if (this.player.tallness < 86)
                    this.outputText("She wraps an arm around your midsection");
                else
                    this.outputText("She wraps an arm around your waist");
                ...
                if (Cotton.rand(3) == 0)
                    kid = 1;
                else if (Cotton.rand(2) == 0)
                    kid = 2;
                else
                    kid = 3;
                this.flags[kFLAGS_1.kFLAGS.COTTON_OLDEST_KID_GENDER] = kid;
                if (kid == 1)
                ...
                if (kid == 3)
                    this.outputText("  I guess it runs in the family.");
                this.outputText("</i>\"");
                ...
                this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT]++;
                if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 1)
                    this.flags[kFLAGS_1.kFLAGS.COTTON_OLDEST_KID_AGE] = 1;
                this.doNext(this.camp.returnToCampUseOneHour);
            }
        ...
        cottonContraceptionToggle() {
            this.clearOutput();
            //REPEATS
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_CONTRACEPTION_TALK] > 0) {
            ...
            //(Cottonpreg:
            if (this.player.gender != 3 || this.pregnancy.isPregnant)
                this.outputText("virile");
            else
                this.outputText("fertile");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] < 3)
                this.outputText("Well that's true,</i>\" she admits.  \"<i>But I leave it up to you, pet.");
            else
                this.outputText("Well, considering the brood we have, they've already proven pretty useless, haven't they?   So, while I'll keep taking them if you want me to, I don't see much point in it.");
            this.outputText("</i>\"");
            this.flags[kFLAGS_1.kFLAGS.COTTON_CONTRACEPTION_TALK] = 1;
        ...
        //[=Stop Taking=]
        tellCottonStopEatingHorsePills() {
            this.clearOutput();
            ...
            this.flags[kFLAGS_1.kFLAGS.COTTON_HERBS_OFF] = 1;
            this.cottonMenu();
        }
        //[=Keep Taking=]
        tellCottonToKeepFiringBlanksAsshole() {
            this.clearOutput();
            ...
            if (!this.silly())
                this.outputText("sorry");
            else
                this.outputText("overrun by a herd of little horsefolk");
            ...
            this.flags[kFLAGS_1.kFLAGS.COTTON_HERBS_OFF] = 0;
            this.cottonMenu();
        }
        //Turn On
        repeatContraceptionToggleCotton() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_HERBS_OFF] == 1) {
        ...
        goTellCottonShesAMomDad() {
            ...
            this.flags[kFLAGS_1.kFLAGS.COTTON_KNOCKED_UP_PC_AND_TALK_HAPPENED] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Birthing*
        birthingCottonsKids() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_IS_A_DEADBEAT_COTTON_DAD] > 0) {
            ...
            //[First Child with Cotton?]
            else if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 0) {
                this.flags[kFLAGS_1.kFLAGS.COTTON_OLDEST_KID_GENDER] = kid;
                ...
                if (kid == 1)
                    this.outputText("He'll");
                else
                    this.outputText("She'll");
        ...
        visitCottonKids() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 1) {
                if (this.flags[kFLAGS_1.kFLAGS.COTTON_OLDEST_KID_GENDER] == 1)
                    this.outputText("him");
                else
                    this.outputText("her");
            }
            ...
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 1) {
                ...
                this.outputText("children are");
            this.outputText(" doing.");
            var scene = Cotton.rand(4);
            //Play randomly chosen scene from list below
            //Peek-a-boo
            if (scene == 0) {
                this.outputText("\n\nYour ");
                if (this.flags[kFLAGS_1.kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2)
                    this.outputText("baby girl is");
                else
                    this.outputText("baby boy is");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 1)
                    this.outputText("baby");
                else
                    this.outputText("babies");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.COTTON_OLDEST_KID_GENDER] == 1)
                    this.outputText("colt");
                else
                    this.outputText("filly");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] > 1) {
                    this.outputText("\n\nYour other ");
                    if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 2)
                        this.outputText("baby is");
                    else
                        this.outputText("babies are");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 1) {
                    if (this.flags[kFLAGS_1.kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2)
                        this.outputText("she grows tired");
                    else
                        this.outputText("he grows tired");
                }
                else
                    this.outputText("they grow tired");
            ...
            //Little Angel
                ...
                if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 1)
                    this.outputText("your baby is");
                else
                    this.outputText("all your children are");
            ...
            //Breastfeeding
                ...
                if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] > 1)
                    this.outputText("  Fortunately, your other kids don't seem to be hungry, so it's just the one who needs feeding.");
                //(If PC lactates:
        ...
        feedYourCottonKids() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] == 1)
                this.outputText(" needs");
            else
                this.outputText("ren need");
        ...
        letCottonFeedKids() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_OLDEST_KID_GENDER] >= 2)
                this.outputText("her down for her nap, hm pet?</i>\"");
            else
                this.outputText("him down for his nap, hm pet?</i>\"");
    ...
    exports.Cotton = Cotton;
});
//# sourceMappingURL=Cotton.js.map