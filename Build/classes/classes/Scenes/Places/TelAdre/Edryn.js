define(["require", "exports", "./TelAdreAbstractContent", "../../../PregnancyStore", "../../../GlobalFlags/kFLAGS", "../../../CoC", "../../../../console", "../../../GlobalFlags/kGAMECLASS", "../../../StatusAffects", "../../../../../includes/appearanceDefs", "../../../CockTypesEnum", "../../../Appearance"], function (require, exports, TelAdreAbstractContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, kGAMECLASS_1, StatusAffects_1, appearanceDefs_1, CockTypesEnum_1, Appearance_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Edryn extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        constructor() {
            super();
            ...
            */
            ...
            this.pregnancy = new PregnancyStore_1.PregnancyStore(kFLAGS_1.kFLAGS.EDRYN_PREGNANCY_TYPE, kFLAGS_1.kFLAGS.EDRYN_PREGNANCY_INCUBATION, 0, 0);
        ...
        timeChange() {
            ...
            if (this.pregnancy.isPregnant && this.flags[kFLAGS_1.kFLAGS.EDRYN_PREGNANT_AND_NOT_TOLD_PC_YET] == 0 && this.pregnancy.type != PregnancyStore_1.PregnancyStore.PREGNANCY_TAOTH) {
                this.flags[kFLAGS_1.kFLAGS.EDRYN_PREGNANCY_INCUBATION]++; //Pregnancy on hold until the PC discovers it
            }
            return false;
        }
        timeChangeLarge() {
            if (this.pregnancy.isPregnant && this.pregnancy.incubation == 0) {
                if (this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_TAOTH) {
                    kGAMECLASS_1.kGAMECLASS.urtaQuest.urtaAndEdrynGodChildEpilogue();
                    ...
                    this.pregnancy.knockUpForce(this.flags[kFLAGS_1.kFLAGS.URTA_FERTILE], this.flags[kFLAGS_1.kFLAGS.URTA_PREG_EVERYBODY]);
                    this.flags[kFLAGS_1.kFLAGS.URTA_FERTILE] = 0;
                    this.flags[kFLAGS_1.kFLAGS.URTA_PREG_EVERYBODY] = 0;
                    return true;
                }
                else if (this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER) {
                    this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS]++; //Add one kid
                    this.flags[kFLAGS_1.kFLAGS.EDRYN_NEEDS_TO_TALK_ABOUT_KID] = 1; //Set 'needs to talk to edryn about da kid
        ...
        edrynBarTalk() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Edryn) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Edryn, 0, 0, 0, 0);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NEEDS_TO_TALK_ABOUT_KID] == 1) {
                var kidGender = Edryn.rand(2);
                if (Edryn.rand(10) < 2)
                    kidGender = 3;
                this.outputText("Edryn cracks into a beautiful smile and gushes, \"<i>We had a ", false);
                if (kidGender == 0)
                    this.outputText("son", false);
                else if (kidGender == 1)
                    this.outputText("daughter", false);
                else
                    this.outputText("herm", false);
                this.outputText("!  You weren't in town, but the birth was easy, so don't worry about it.  Labor only lasted like, an hour tops.  You should've seen your ", false);
                if (kidGender == 0)
                    this.outputText("son", false);
                else
                    this.outputText("daughter", false);
                this.outputText(" trying to stand up for the first time.  It was incredible!  ", false);
                if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] == 1) {
                    this.outputText("I'm going to have to spend less time around here so I can raise ", false);
                    if (kidGender == 0)
                        this.outputText("him", false);
                    else
                        this.outputText("her", false);
                    this.outputText(" right, but I'd be more than happy to 'help' you with your needs if you can catch me during a free moment.", false);
                }
                else {
                    this.outputText("I can't believe we've had " + Edryn.num2Text(this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS]) + " kids together!  You better come see me later on - ", false);
                    if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] < 3)
                        this.outputText("I miss the way you fill me", false);
                    else
                        this.outputText("I want you to make me pregnant again", false);
                }
                this.outputText(".</i>\"\n\n", false);
                ...
                this.cheatTime(1);
                this.flags[kFLAGS_1.kFLAGS.EDRYN_NEEDS_TO_TALK_ABOUT_KID] = 0;
            ...
            //Post kids talk
                ...
                //(Too small)
                    ...
                    this.outputText("She looks down, eyes fixating on your crotch for a moment.  Edryn asks, \"<i>When did you get so small?  We can't fuck like this!  ", false);
                    //(Chance of equinum,gro+(twice only),minotaur blood, or purified incubus draft)
                    var itype;
                    if (this.flags[kFLAGS_1.kFLAGS.EDRYN_GIFT_COUNTER] < 2) {
                        ...
                        this.flags[kFLAGS_1.kFLAGS.EDRYN_GIFT_COUNTER]++;
                    }
                    else if (this.flags[kFLAGS_1.kFLAGS.EDRYN_GIFT_COUNTER] < 5) {
                        this.outputText("Here, take some of this stuff.  We confiscated it off one of the miscreants we kicked out the other day, and I KNOW it'll get you to be big enough for me.  Just don't go too nuts with it, okay?</i>\"\n\n", false);
                        this.flags[kFLAGS_1.kFLAGS.EDRYN_GIFT_COUNTER]++;
                        if (Edryn.rand(2) == 0)
            ...
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                this.outputText("offering you a spot at the table across from her.  You realize your companion isn't on any kind of seat at all, and is instead 'sitting' on her lower half.  You do the same, settling down across from her, thankful this bar was made to accommodate centaurs.", false);
            else
                this.outputText("gesturing to a nearby stool.  You grab the seat and realize that your centaur companion isn't sitting still at all, but is instead 'sitting' on her lower half, which currently lies on the floor.", false);
            ...
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR && this.player.totalCocks() > 0) {
                this.outputText("and the potent female scent works its way into your blood, making you dizzy as your " + this.cockDescript(0) + " ", false);
                if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                    this.outputText("pours out of its sheath", false);
                else
                    this.outputText("fills near instantaneously", false);
                this.outputText(", now rock-hard.  You breathe deeply, your mind subsumed in a sea of equine instincts.  The hard floor squeezes your " + this.cockDescript(0) + " painfully underneath you, forcing you to rise up onto your hooves.  You can feel more than a few curious gazes sliding along your now fully exposed maleness, and it twitches as if it were happy for the attention.\n\n", false);
                this.outputText("Swaying back and forth, alternatively snorting and breathing deeply of the female's scent, your gaze immediately locks onto the returning mare.  Your " + this.cockDescript(0) + " jumps and bounces underneath you, painfully hard and swollen.  A thick dollop of pre beads on your " + this.player.cockHead() + ", as if the bar needed your display to be any more overtly sexual.  Edryn looks you over, walking alongside you she talks, \"<i>My my, someone liked what they saw.  Or was it smelled?  I can never tell what it is that gets you " + this.player.mf("studs", "hotties") + " so worked up about me.</i>\"\n\n", false);
                this.outputText("A soft hand slides under your belly, hefting your " + this.cockDescript(0) + " and smearing the bead of pre over it with long slick strokes.  She coos, \"<i>", false);
                ...
                if (this.player.horseCocks() > 0) {
                    this.outputText("and the potent female scent makes you feel a bit dizzy and dazed.  ", false);
                    if (this.player.cocks[0].cockLength > 16)
                        this.outputText("You barely register the thump of your hardening " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HORSE) + " as it smacks into the underside of the table.\n\n", false);
                    else
                        this.outputText("You squirm uncomfortably, feeling constrained by your " + this.player.armorName + " as you surge to erectness.\n\n", false);
                ...
                //Non horsedick
                    ...
                    if (this.player.cor > 50 || this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) > 0 || this.flags[kFLAGS_1.kFLAGS.LOW_STANDARDS_FOR_ALL]) {
                        this.outputText("  Unbidden, your mind wonders what her juicy horse-snatch would feel like, and your " + this.cockDescript(0) + " responds immediately, thickening with readiness.  You squirm uncomfortably from how constricting your " + this.player.armorName + " feels.\n\n", false);
                        this.outputText("You give the rapidly dissipating scent a sniff and note that it isn't unpleasant, just strong, and once again you find yourself imagining standing ", false);
                        if (this.player.tallness < 60)
                            this.outputText("on a stool ", false);
                        this.outputText("behind her, fucking her like the beast-woman she is.  Lost in your thoughts, you fail to notice Edryn's return.  She coughs noisily, rousing you from the impromptu fantasy as she gives you a knowing smile.  An unexpected caress slides against you groin, rubbing and hefting you carefully.", false);
                        if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE)
                            this.outputText("  She smiles coyly when your " + this.cockDescript(0) + " wriggles, wrapping around her arm.", false);
                        this.outputText("\n\n", false);
        ...
        edrynOffer() {
            this.spriteSelect(14);
            var cost = 0;
            switch (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn)) {
                case 0:
                    cost = 200;
                    break;
                case 1:
            ...
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR && this.player.totalCocks() > 0) {
                ...
                this.outputText("You groan, more turned on than ever by being fondled openly in public.  The centaur whore winks at you and offers, \"<i>So what do you say, is a roll in the hay with me worth ", false);
                if (cost > 0)
                    this.outputText(Edryn.num2Text(cost) + " gems?", false);
                else
                    this.outputText("an hour of your time?", false);
                this.outputText("</i>\"\n\n", false);
                ...
                if (cost > 0)
                    this.outputText("(Do you pay " + Edryn.num2Text(cost) + " gems to fuck her?)", false);
                else
                    this.outputText("(Do you fuck her?)", false);
                ...
                if (this.player.horseCocks() > 0) {
                    ...
                    if (this.player.cockArea(x) >= 24) {
                        ...
                        this.outputText("She doesn't seem irritated, instead she seems quite... turned on.  Edryn explains, \"<i>" + this.player.mf("Mr.", "Miss") + " thick and juicy, I'm more than muscle for hire.  I do a little 'wetwork' on the side, and I've yet to meet a horse-cock that doesn't jump at my scent.  Lucky for you, I think you're cute, and I'm feeling randy.  So, how about ", false);
                        if (cost > 0)
                            this.outputText(Edryn.num2Text(cost) + " gems, ", false);
                        else
                            this.outputText("an hour of your time, ", false);
                        ...
                        if (this.player.balls > 0)
                            this.outputText("balls tight and your ", false);
                ...
                //Normal Wingdangdoodle
                    ...
                    if (this.player.cockArea(x) >= 24) {
                        ...
                        this.outputText("Edryn keeps talking, \"<i>I do ALL kinds of mercenary work, even the sloppy wet kind, and lucky for you, I'm more than wet enough to let you satisfy your " + this.cockDescript(0) + " in me.  ", false);
                        if (cost > 0)
                            this.outputText(Edryn.Num2Text(cost) + " gems ", false);
                        else
                            this.outputText("An hour of your time ", false);
        ...
        edrynSexSelecter() {
            ...
            //Increment sex count
            this.player.addStatusValue(StatusAffects_1.StatusAffects.Edryn, 1, 1);
        }
        fuckEdrynTaur() {
            this.spriteSelect(14);
            this.outputText("", true);
            ...
            if (this.player.cor < 75)
                this.outputText("You recoil for a second, scolding yourself for the strange thoughts, but you don't slow down the fucking in the slightest.", false);
            else
                this.outputText("You smile, realizing you hadn't meant to think of her as a mare and you as her stud, but that's exactly what you are right now.  Your thrusts speed up as you renew your determination to fill this cunt full of fillies.", false);
            ...
            if (this.player.biggestTitSize() <= 1)
                this.outputText("strokes your chest", false);
            else
                this.outputText("caresses a breast", false);
            this.outputText(" while she caresses the side of your " + this.player.face() + " with the other.  Your body pumps away while your tongues entwine, tracing saliva over each other's lips.  She pulls back and moans out again, trailing off into a whinny as she orgasms underneath you.\n\n", false);
            this.outputText("Her cunt locks tightly around you once again, clamping down in a series of rings from the base all the way to your " + this.player.cockHead(x) + ".  At once, they start sliding from the base towards the tip, new ones forming along the bottom of the shaft as her pussy milks your " + this.cockDescript(x) + " hard.  Trapped inside her, all you can do is groan and cum in response to her climax.  You throw back your head as you feel the warmth of your release building in your ", false);
            if (this.player.balls > 0)
                this.outputText(this.ballsDescriptLight(), false);
            else
                this.outputText("loins", false);
            this.outputText(".\n\n", false);
            this.outputText("The rippling and squeezing of Edryn's cunt throws you past the point of no return.  Your eyes roll back as you unload into her musky tunnel, nearly losing your grip as your body gives up wave after wave of seed.  The contractions don't let up", false);
            if (this.player.cumQ() < 100)
                this.outputText(" even after you've finished.", false);
            else {
                this.outputText(", squeezing more and more cum into her horse-sized womb.  ", false);
                if (this.player.cumQ() > 250)
                    this.outputText("Her body gurgles noisily from the massive fluid injection it's just taken, and her belly expands noticeably.  ", false);
                if (this.player.cumQ() > 500)
                    this.outputText("It keeps going as your body spends the last of its massive reserves, bloating her to the point that she'll have trouble walking.  ", false);
                this.outputText("Her cunt keeps milking you even after.", false);
            }
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) <= 1)
            ...
            else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) <= 3)
                this.outputText("\n\nShe sighs happily and looks down at you, \"<i>Ooh " + this.player.short + ", you're the best.  We should do this again soon.  Oh goddess, I can feel my juices starting just thinking about it.</i>\"", false);
            else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) == 4)
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) >= 4)
        ...
        fuckEdrynNonTaur() {
            ...
            if (x < 0)
                x = 0;
            this.outputText("She wiggles her more than ample backside towards you, squelching wetly against your ", false);
            if (this.player.tallness < 48)
                this.outputText("face", false);
            else
                this.outputText("body", false);
            this.outputText(".  She looks over her shoulder and says, \"<i>If you don't want your gear to smell like a horny centaur, you ought to shed it and get me warmed up with your tongue.</i>\"  You hastily remove it", false);
            if (this.player.tallness > 72)
                this.outputText(" and drop down to your knees to better level yourself with her", false);
            this.outputText(", pressing your " + this.player.face() + " into her slick folds and tasting her flavor.  Your nose easily slips into her gash as your tongue explores it, testing and tasting thick, liquid centaur lust.  It's tangy and sweet, surprisingly unlike the scent it gives off.  You easily find her large clit and suckle on it, listening to the wet squelches and whinnies of pleasure.\n\n", false);
            ...
            if (this.player.tallness < 60)
                this.outputText("You grab a stool so you'll be tall enough to fuck her properly and climb onto it.  ", false);
            this.outputText("Supporting your", false);
            if (this.player.cockArea(x) > 200)
                this.outputText(" hefty package with both hands", false);
            else
                this.outputText("self with your hand", false);
            this.outputText(", you guide your " + this.cockDescript(x) + " towards the shining, black horse-cunt in front of you.  It parts easily, like a velvet curtain.  You slowly slide forward into Edryn's welcoming nethers, enjoying not having to fight to get your large " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " in for a change.  She trembles as you pass the halfway point, ", false);
            if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                ...
                this.outputText("squirting a little bit of fluid on the floor.  ", false);
            ...
            this.outputText("She whinnies and pushes back against you, forcing your entire " + this.cockDescript(x) + " to slip up her well-lubed passage.  You slap her ass, watching the furred flanks jiggle slightly.  Edryn looks over her shoulder again to and gives you a sultry look.  Before you can puzzle out what she's trying to tell you, her entire cunt contracts tightly, like a silken vise.  It wrings your " + this.cockDescript(x) + " tightly, immobilizing you inside the powerful centauress and making your " + this.player.legs() + " feel wobbly and weak.\n\n", false);
            ...
            this.outputText("Your eyes roll back as you unload into Edryn's musky tunnel, giving up on breathing as your body gives up wave after wave of seed.  The contractions don't let up, ", false);
            if (this.player.cumQ() < 100)
                this.outputText("even after you've finished.\n\n", false);
            else {
                this.outputText("squeezing more and more cum into her horse-sized womb.  ", false);
                if (this.player.cumQ() >= 250)
                    this.outputText("Her body gurgles noisily from the massive fluid injection it's just taken, and her belly expands noticeably. ", false);
            ...
            if (this.player.hasKnot(x))
                this.outputText("tries to rise, lifting up enough for you to get a few good breaths in, but your knot keeps her locked to you, and the two of you are tied together for another minute or two while it deflates, emptying the very last dregs of your spunk into her.  You pop free, ", false);
            else
                this.outputText("slowly rises up off of you, ", false);
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) <= 1)
                this.outputText("She sighs happily and looks down at you, \"<i>Ohhhh that was nice.  Most of my customers can't get me off like that.  I hope you're ok!  Don't worry about me getting pregnant either, I take some herbs to prevent that sort of thing until I'm ready for it.</i>\"\n\n", false);
            else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) <= 3)
                this.outputText("She sighs happily and looks down at you, \"<i>Ooh " + this.player.short + ", you're the best.  We should do this again soon.  Oh goddess, I can feel my juices starting just thinking about it.</i>\"\n\n", false);
            else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) == 4)
                this.outputText("She sighs happily and says, \"<i>Oh baby, you know what?  I'm never charging you again.  Just keep getting me off like that and we can do it anytime.</i>\"\n\n", false);
            else
                this.outputText("She sighs contentedly and says, \"<i>Mmm, never stop visiting ok?</i>\"\n\n", false);
        ...
        edrynBar() {
            if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NEVER_SEE_AGAIN] == 0 && this.model.time.hours >= 14 && this.model.time.hours <= 19 && (this.model.time.hours < 17 || this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] == 0))
                return true;
            return false;
        }
        edrynHeliaThreesomePossible() {
            ...
            this.edrynHeliaLastThreesomeCheck = this.model.time.totalTime;
            if (this.player.gender == 0 || this.model.time.hours < 14 || this.model.time.hours >= 20 || Edryn.rand(2) == 0 || (this.flags[kFLAGS_1.kFLAGS.HEL_FUCKBUDDY] == 0 && !kGAMECLASS_1.kGAMECLASS.helFollower.followerHel())
                || (this.flags[kFLAGS_1.kFLAGS.HEL_FOLLOWER_LEVEL] == 1 && this.flags[kFLAGS_1.kFLAGS.HEL_HARPY_QUEEN_DEFEATED] == 0)) {
        ...
        helAppearance() {
            this.outputText("\n\nTo your surprise, you see Hel the salamander sitting in a corner table, a pair of foxy fox-morph girls sitting on her lap.  When she sees you enter, the pretty reptile lifts her tankard and shouts, \"<i>Hey! " + this.player.short + "! Over here!</i>\" over the loud noises of the bar.", false);
        ...
        approachHelAtZeBitch() {
            ...
            var edryn = undefined;
            if (this.edrynBar() && this.player.cockThatFits(300) >= 0 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.Edryn) >= 4)
                edryn = this.helEdrynThreeSomeStartYerEngines;
            if (edryn != undefined && this.flags[kFLAGS_1.kFLAGS.HEL_EDRYN_OFFER] == 0) {
                this.outputText("\"<i>Hey there, lover mine,</i>\" Helia says with a coy grin as you take a seat across from her.  The two fox-girls giggle drunkenly, prompting Hel to give them each a playful slap on the ass and send them on their way.  \"<i>Well, fancy meeting you here, ", false);
                if (this.player.femininity < 49)
                    this.outputText("handsome", false);
                else
                    this.outputText("beautiful", false);
                ...
                this.outputText("Sitting with the salamander, you notice across the crowded bar that Edryn is sitting at her table, sipping a little glass of wine.  Catching your eye, the centauress gives you a sultry wink.  An idea forms in your mind: you could easily introduce the two girls.  Do you?", false);
                this.flags[kFLAGS_1.kFLAGS.HEL_EDRYN_OFFER]++;
            }
            else {
                ...
                if (this.player.femininity < 49)
                    ...
                    this.outputText("beautiful", false);
                this.outputText(".  In town for business... or pleasure?</i>\" she purrs with a little wink.\n\n", false);
                this.outputText("You spend a few minutes talking with the salamander, joking and laughing with your inebriated lover.  ", false);
            ...
            this.simpleChoices("Edryn3Some", edryn, "Fox Girls", kGAMECLASS_1.kGAMECLASS.helScene.heliaPlusFoxyFluffs, "", undefined, "", undefined, "Leave", this.leaveHelInZeBitch);
        }
        //First Time - Leave
        leaveHelInZeBitch() {
            this.outputText("", true);
            if (this.flags[kFLAGS_1.kFLAGS.HEL_EDRYN_OFFER] == 1) {
                this.outputText("You decide against trying to set something up between the girls -- you like your lovers separate for now.  You spend the rest of the hour quietly chatting with Helia before giving her a friendly kiss goodbye and stepping away.", false);
            }
            else {
        ...
        helEdrynThreeSomeStartYerEngines() {
            this.outputText("", true);
            if (this.flags[kFLAGS_1.kFLAGS.EDRYN_TIMES_HEL_THREESOMED] == 0) {
                ...
                this.outputText("Hel just about squeals with delight.  She nods her head emphatically, making both you and Edryn laugh.  With a knowing look, Edryn takes you and Hel by the hand and leads you into her private room.", false);
            }
            //Repeat -- Threesome
            else {
        ...
        threesomeEdrynAndHel() {
            ...
            var x = this.player.cockThatFits(300);
            this.flags[kFLAGS_1.kFLAGS.EDRYN_TIMES_HEL_THREESOMED]++;
            ...
            this.outputText("Hel gets to work without further prompting, grabbing Edryn's wide flanks and burying her face into the centauress's horse-cunt. You grab your " + this.cockDescript(x) + ", stroking yourself off to the show unfolding before you.  Edryn whinnies happily, wiggling her hips into Hel's face, crushing the salamander further and further into the wall.\n\n", false);
            ...
            this.outputText("Hel rolls over on her back, using her legs to steady on Edryn's back as you rub your " + this.cockDescript(x) + " against Edryn's gaping horsecunt, making the centauress shudder.  The shudder nearly throws Hel off her back, causing the salamander to dig her claws painfully into Edryn's sides.  She bucks back in surprise, impaling herself right on your " + this.cockDescript(0) + ".\n\n", false);
            ...
            this.player.orgasm();
            kGAMECLASS_1.kGAMECLASS.helFollower.helAffection(5);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Pregdryn:
        ...
        shockedByEdrynsPregnancy() {
            this.spriteSelect(14);
            this.outputText("", true);
            this.outputText("You stammer for an answer, unsure of what to say in light of this startling revelation.  Edryn looks on the verge of tears and all you can do is struggle for words.  She grips the table, her knuckles turning white while her eyes flick from side to side in a panic.", false);
        ...
        beAnAssholeToPregdryn() {
            ...
            this.flags[kFLAGS_1.kFLAGS.EDRYN_NEVER_SEE_AGAIN] = 1;
        ...
        pregdrynOffer(cs = true) {
            ...
            if (this.pregnancy.incubation < 250) {
                ...
                if (this.player.cockTotal() > 1)
                    this.outputText("All of your " + this.multiCockDescriptLight() + " fill in seconds, growing rock hard and actually aching with their need.  ", false);
                else if (this.player.cockTotal() == 1)
                    this.outputText("Your " + this.cockDescript(0) + " fills in seconds, growing rock hard and actually aching with need.  ", false);
                ...
                if (this.player.cor + this.player.lib < 100 || this.player.cockTotal() < 1)
                    this.outputText("you struggle not to reach into your " + this.player.armorName + " to touch yourself.", false);
                else {
                ...
                this.outputText("\n\n", false);
                this.outputText("You wouldn't notice her return if it wasn't for the increase in potent centaur pheromones hitting your nostrils.  It takes a hand slipping under the table to play with your ", false);
                if (this.player.balls > 0)
                    this.outputText(this.ballsDescriptLight(), false);
            ...
            //Mildly pregnant offer
                ...
                this.outputText("As usual, when Edryn pivots to leave, she gives you a perfect view of her unusual vagina.  The glistening black lips of her sex practically ooze moisture, and the scent coming off her seems even more potent than usual, making your head swim.  ", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("All of your " + this.multiCockDescriptLight() + " fill in seconds, growing rock hard and actually aching with their need.  ", false);
                else if (this.player.cockTotal() == 1)
                    this.outputText("Your " + this.cockDescript(0) + " fills in seconds, growing rock hard and actually aching with need.  ", false);
                this.outputText("You're a little bit dazed by the sudden spike in arousal, and ", false);
                if (this.player.cor + this.player.lib < 100 || this.player.cockTotal() < 1)
                    this.outputText("you struggle not to reach into your " + this.player.armorName + " to touch yourself.", false);
                else {
                    this.outputText("you can't stop yourself from grabbing ", false);
                ...
                this.outputText("\n\n", false);
                this.outputText("As usual, you're barely cognizant of her return.  It isn't until a hand sneaks under the table to surreptitiously fondle your ", false);
                if (this.player.balls > 0)
                    this.outputText(this.ballsDescriptLight(), false);
                else if (this.player.hasSheath())
                    this.outputText("sheath", false);
            ...
            if (this.player.cockArea(x) >= 24 && this.player.cockArea(x) < 300) {
                this.outputText("Edryn is smiling radiantly as she continues to caress you under the table.  She asks, \"<i>", false);
                if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] == 0)
                    ...
                    this.outputText("Are you going to cum just from sniffing at my cunt", false);
                ...
                this.outputText("The centaur doesn't wait for a reply, and takes off at a trot towards her quarters.  A few drips have splattered across the floor, leaving a trail for you to follow.  You get up, dazed with arousal and leaking pre-cum, and stagger through the bar to her room, practically lust-drunk.", false);
            ...
            //(PC TOO BIG)
                ...
                this.outputText("Edryn brushes her hand over ALL of your " + this.cockDescript(0) + " then jerks it back, startled.  She sighs, \"<i>Dear, that thing is a BEAST.  I mean, there's no doubt I'd love to get it inside me, but I promise it won't fit me.</i>\"\n\n", false);
        ...
        fuckPregEdryn() {
            ...
            //NONTAUR
            if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR) {
                this.outputText("Edryn lurches forwards as soon as the door closes behind you, slamming her powerful frame into you with enough force to propel you several feet back onto a large pile of pillows in the corner.  The feeling of her massive, milk-drooling teats ", false);
                if (this.player.tallness < 60)
                    this.outputText("bouncing against the top of your head", false);
                else if (this.player.tallness < 84)
                    this.outputText("battering your face", false);
                else
                    this.outputText("crushed against your chest", false);
                ...
                this.outputText("You tear off your " + this.player.armorName + " in a flash, fully exposing your ", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("chosen ", false);
                this.outputText(this.cockDescript(x) + ".  It drips with anticipation, leaking drops of pre-cum with each inhalation of your mate's over-sexualized slit's scent.  Edryn looks over her shoulder to gauge the distance, but when she sees your state her face breaks into a happy smile.  She says, \"<i>Steady now, we wouldn't want you to miss your target, would we?</i>\" as her backside slowly descends, splattering hot sexual fluids over your length.\n\n", false);
                this.outputText("The centaur's gash devours your " + this.cockDescript(x) + " with a long, wet slurping noise.  Her body-heat is much warmer than your own, wrapping slippery heat around every sensitive inch of your fuck-pole.  The flesh around you squeezes and massages instinctively.  It feels so good that it seems as if your " + this.cockDescript(x) + " is going to melt under the onslaught of pleasure.  Edryn moans loudly and begins to pump her hips atop you, \"<i>Oooh yes, thats perfeeeect...</i>\"\n\n", false);
                ...
                this.outputText("Edryn sinks down, her whole body shaking and shuddering while milk fountains from her swollen breasts.  Her hands reach up to grab her nipples and tug on the milk-spouts.  They look longer now than before her pregnancy.  Her bloated milk-spouts are at least an inch or two long!  ", false);
                if (this.player.cumQ() < 100) {
                    this.outputText("Your " + this.cockDescript(x) + " dumps the last of its seed into her hungry cunt and softens slightly.  Her warm cunt's constant milking motions continue, still pleasurable, but they prevent you from going soft until the centaur's orgasm has concluded.", false);
                }
                else if (this.player.cumQ() < 500) {
                    this.outputText("Your " + this.cockDescript(x) + " spurts thick flows of seed into her hungry cunt, flooding her snatch with an abnormally large load of semen.  Her warm cunt's constant milking motions continue, forcing more and more of your spunk inside her until her own orgasm has concluded.", false);
                }
                else {
                    this.outputText("Your " + this.cockDescript(x) + " erupts, pouring a thick wave of seed into the centaur's hungry cunt.  The constant milking motions don't let up while Edryn's orgasm continues, helping you flood her with even more spooge.  Even after your pregnant lover's orgasm has concluded, your " + this.cockDescript(x) + " keeps dumping more cum into her until it's soaking and dripping from her huge, furry ass.", false);
                }
                this.outputText("\n\n", false);
            ...
            //TAURZILLA
                ...
                this.outputText("You break the kiss and suck the bottom of her earlobe into your mouth, straining to keep your mouth steady as you pull your " + this.cockDescript(x) + " into position with her needy sex.  The " + this.player.cockHead(x) + " slips into the hot folds, forcing a gasp from your lips that lets Edryn's earlobe escape its oral prison.  She smirks, then nibbles at your shoulder while you slide the rest of the way into her large, slippery channel.  It's a near perfect fit thanks to your similar body types, and the both of you sigh out whinnies of pleasure.\n\n", false);
                this.outputText("Edryn bites down harder, sending a jolt of pain through your shoulder.  Her hips wiggle against yours, and she begins rhythmically clenching and relaxing her entrance, squeezing you tightly ", false);
                if (!this.player.hasSheath())
                    this.outputText("by the base", false);
                else
                    this.outputText("just above your sheath", false);
                this.outputText(".  The horse half of your body arches, pulling your " + this.cockDescript(x) + " partway out, then lurches back forward to bury it deep inside her.  The impact jiggles her flesh from her ass to her shoulders, and you feel it underneath you as an instinctual, barely thought sign of sexual dominance.\n\n", false);
                ...
                this.outputText("You grunt from the force of your exertions and begin to fuck her a little more roughly.  Your arms squeeze tightly around her midsection with a mixture of affection and need as you fulfill her request.  You pound her swollen, dripping cunt with hard strokes that make your intertwined forms shiver, dislodging a few pillows.  Scrabbling noise fills the air.  Your hooves are scrambling for purchase, but there's no traction.  Lying sideways in the pillows with your pregnant lover prevents you from fucking quite as hard as your body would like.\n\n", false);
                ...
                this.outputText(".  Her twat clutches you so tightly that you're immobilized for fear of hurting yourself, and the tight seal of her entrance acts as a cock-ring, actually bloating your " + this.cockDescript(x) + " inside her.\n\n", false);
                this.outputText("Your " + this.cockDescript(x) + " is milked from ", false);
                if (!this.player.hasSheath())
                    this.outputText("base", false);
                else
                    this.outputText("sheath", false);
                this.outputText(" to " + this.player.cockHead(x) + ", culminating in a tight squeeze at the tip. Then it releases and starts all over again.  Instinctively, you whinny and explode inside the warm, soaking wet tunnel.  The french-kiss turns into a feverish slobber-fest while the two of you mate, lost to orgasm.", false);
                if (this.player.cumQ() < 300) { }
                else if (this.player.cumQ() < 1000)
                    this.outputText("Your prodigious jism output soaks her sloppy tunnel and drips from the entrance with the centauress' girlcum.", false);
                else {
                    this.outputText("Your body's cum-production easily fills her channel to capacity.  Each successive spurt blasts a wave of fluid out from her overstuffed cunt, soaking the pillows, Edryn's ass, and your crotch.", false);
                    if (this.player.cumQ() >= 4000)
                        this.outputText("  By the time you calm down you've soaked all the pillows and spooge is puddling underneath.", false);
                }
                this.outputText("\n\n", false);
                this.outputText("Edryn breaks the kiss with a strand of spit hanging in the middle.  She giggles euphorically, \"<i>Wow.  Ummm, wow!  That was nice!  Now get off me you ", false);
                if (this.player.tallness > 74)
                    this.outputText("big ", false);
                this.outputText("lug!</i>\"  She playfully pushes you back and tries to drag herself out from under you.  You laugh with her and pull back, letting your softening " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " pull free from her cum-glazed twat.  It escapes with a wet squish, releasing a torrent of centaur cum from the unplugged opening.\n\n", false);
        ...
        jizzFromEatingPregdrynOut() {
            ...
            this.outputText("The smell is potent, sexual, and thoroughly inhuman.  You take a step closer and continue taking little sniffs, barely noticing as your ", false);
            if (this.player.cockArea(x) < 24)
                this.outputText("small dick begins to twitch and leak.", false);
            else
                this.outputText("mammoth cock drags the ground, leaking pre-cum.", false);
            ...
            this.outputText("Her words fall on deaf ears.  You push yourself up onto your elbows and lean forward, feeling strands of female lubricant hanging from your face as you inhale deep lungfuls of her scent.  ", false);
            ...
            if (this.player.cumQ() < 100)
                this.outputText("drips pre-cum onto the pillows.", false);
            else if (this.player.cumQ() < 500)
                this.outputText("leaks pre-cum in a steady stream, quickly soaking a few pillows.", false);
            else
                this.outputText("pours out enough pre-cum to soak a pillow, and in no time your overenthusiastic dick is doing its damnedest to dribble over everything.", false);
            ...
            this.outputText("You tremble as you pull away, licking her lust from your lips and gasping for air as you shift to lick at her clit.", false);
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR) {
                this.outputText("  Your hooves twitch weekly on the floor, forgetten about as you focus entirely on your hands, mouth, and pulsating " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN), false);
                if (this.player.cockTotal() > 1)
            ...
            this.outputText("Startled from your sexual fog, you jerk back and gasp.  The smell – it's like sex distilled into orgasm and fired straight into your brain.  Your " + this.hipDescript() + " shake uncontrollably, spasming wildly as your scent-addled mind sets off a full-body orgasm.  ", false);
            if (this.player.hasVagina()) {
                this.outputText("Your " + this.vaginaDescript(0) + " contracts and spasms with the rest of you, ", false);
            ...
            this.outputText("your " + this.multiCockDescriptLight() + " in a steady stream.  Your urethra bulges and flexes, forcing you to waste your seed all over Edryn's pillows.", false);
            if (this.player.cumQ() < 1000) {
                this.outputText("  The flow gets thicker and thicker.  Edryn even remarks, \"<i>Oh my, my baby's daddy is just full of cum!  Let it all out for me dear, you did such a good job on my clit that you deserve release.</i>\" You squirt and dribble, breathing airborne orgasm and squirting ", false);
                if (this.player.cumQ() < 3000)
                    this.outputText("out the last of your liquid pleasure.", false);
                else
                    this.outputText("ever greater amounts of liquid peasure.  Jism drips through the floorboards as you create a puddle a few inches deep.", false);
            }
            this.outputText("\n\n", false);
        ...
        edrynPregChance() {
            ...
            console_1.trace("Edryn Preg Check Virility Score: " + this.temp);
            if (this.player.cumQ() > 250 && this.temp >= Edryn.rand(100)) {
                preg = true;
                console_1.trace("Edryn knocked up!");
            }
            else
                console_1.trace("Edryn not knocked up!");
            if (preg) {
                this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, PregnancyStore_1.PregnancyStore.INCUBATION_CENTAUR + 80);
                this.flags[kFLAGS_1.kFLAGS.EDRYN_PREGNANT_AND_NOT_TOLD_PC_YET] = 0;
            }
        }
        ...
        edrynFucktroduction() {
            ...
            if (!this.player.isTaur()) {
                if (cost > 0)
                    this.outputText("Coins exchange hands and her arm finds its way back inside your " + this.player.armorName + ", pulling you towards a back room.  A round of chuckles chases you through the bar room until they're silenced by the heavy thud of a door closing behind you.  You're pushed against the wall hard enough to make your teeth click.  The stars gradually clear from your view, revealing a massive gash, drooling with clear feminine slime.  The scent assails you, ", false);
                else if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] == 0)
                    this.outputText("Her arm finds its way back inside your " + this.player.armorName + ", pulling you towards a back room.  A round of chuckles chases you through the bar room until they're silenced by the heavy thud of a door closing behind you.  You're pushed against the wall hard enough to make your teeth click.  The stars gradually clear from your view, revealing a massive gash, drooling with clear feminine slime.  The scent assails you, ", false);
                else
                    this.outputText("A round of chuckles chases you through the bar room until they're silenced by the heavy thud of a door closing behind you.  You're pushed against the wall hard enough to make your teeth click.  The stars gradually clear from your view, revealing a massive gash, drooling with clear feminine slime.  The scent assails you, ", false);
                if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                    this.outputText("making your " + this.cockDescript(x) + " twitch and ache.  It floods your body with animalistic desires, overpowering any sense of propriety you might have once had.", false);
                else
                    this.outputText("overpowering you with strange lust.  As turned on as you are, it's difficult not to enjoy this.", false);
            }
            //TAUR
            else {
                if (cost > 0)
                    this.outputText("Coins exchange hands and she grabs you, pulling you back towards a darkened doorway in the rear of the bar.  A round of chuckles chases you through the bar room until they're silenced by the heavy thud of a door closing behind you.  Edryn turns away from you, exposing her massive gash, drooling with clear feminine slime.  The scent assails you, ", false);
                else
            ...
            if (this.player.isTaur())
                this.addButton(0, "Fuck", this.fuckEdrynTaur);
            else
                this.addButton(0, "Fuck", this.fuckEdrynNonTaur);
        }
        //Eat Her Out Till Shit Goes Crazy
        eatEdrynPussyLikeABawss() {
            this.clearOutput();
            ...
            this.outputText("Edryn starts to say something, but you strip out of your [armor] before she gets more than a half-dozen words out, your " + this.multiCockDescriptLight() + " jutting proud and erect, leaking clear streams of pre-cum down ");
            if (this.player.cockTotal() == 1)
                this.outputText("its underside");
            else
                this.outputText("their underside");
            ...
            if (this.pregnancy.isPregnant)
                this.outputText("  You can tell that since she's gotten pregnant her pheromones have become more potent, but that's little more than a dim note on a forgotten chalkboard to your brain.  It's impossible to think about measuring the potency of anything that isn't your own tool in such a swelteringly hot atmosphere.");
            else
                this.outputText("  You note that the smell seems more powerful in an enclosed space, but that's little more than a dim note on a forgotten chalkboard to your brain.  It's nigh-impossible to think about anything but plunging yourself [sheath] deep inside her when exposed to her scent this strongly.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_EATEN_EDRYN_PUSSY_RUT] == 0)
                this.outputText("smile tugging at the corners of her mouth at your bravado");
            else
                this.outputText("lecherous grin spreading across her face as she remembers the last time you did this");
            this.outputText(".");
            ...
            if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                this.outputText("She's not even begun to taste the fruits of your talents, and you let your long, long tongue spool out inside her, pressing hard on her walls and tenderly flicking across each sensitive fold inside her.  ");
            ...
            if (this.player.gender != 1)
                this.outputText(", or close enough to it");
            ...
            if (this.pregnancy.isPregnant)
                this.outputText(" as they drip milk everywhere");
            ...
            if (y >= 0)
                this.outputText(" and clenching tightness is wreathing your other erection");
            ...
            this.outputText("\n\nArching your back, you allow the palpable relief to wash through you, bubbling lust pumping out from your [balls] to flood the poor centaur's slippery, equine slit.  You ejaculate with forceful lurches of your [hips], matching each rope of creamy jism by burying your " + this.cockDescript(x));
            if (y >= 0)
            ...
            if (!this.pregnancy.isPregnant) {
                ...
                if (y >= 0)
                    this.outputText("  Her ass is in a similar state.  It's so pressurized with jizz that it squirts out of her with each contraction.");
            }
            else {
                ...
                if (y >= 0)
                    this.outputText("  Her butthole gets a similar treatment, filled enough that it's squirting your jizz back out with each contraction the centauress makes.");
        ...
        postEdrynEatOutRut() {
            ...
            this.edrynPregChance();
            this.edrynPregChance();
            this.flags[kFLAGS_1.kFLAGS.TIMES_EATEN_EDRYN_PUSSY_RUT]++;
            this.doNext(this.camp.returnToCampUseFourHours);
        }
    }
    exports.Edryn = Edryn;
});
//# sourceMappingURL=Edryn.js.map