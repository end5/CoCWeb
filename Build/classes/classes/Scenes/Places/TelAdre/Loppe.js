define(["require", "exports", "./TelAdreAbstractContent", "../../../GlobalFlags/kFLAGS", "../../../../../includes/appearanceDefs"], function (require, exports, TelAdreAbstractContent_1, kFLAGS_1, appearanceDefs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Loppe extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        ...
        */
        ...
        appearanceOfLoppe() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_FURRY] == 0) {
                this.outputText("Loppe is a 6'2\" bunny-girl with deep brown eyes set in her pretty face.  Shoulder-length black hair and a pair of snow-white rabbit ears adorn the top of her head, tilted and lying backward to conceal the insides.  Curiously, her face is that of a normal human woman.");
        ...
        loppeFirstMeeting() {
            this.clearOutput();
            this.outputText("Wandering towards the bar, you notice an unusual commotion; there are a lot more people hanging around here than is usual for the time of day.  Feeling curious, you go over to investigate, and ask a bystander what all of this is about.");
        ...
        noLoppeInterest() {
            this.clearOutput();
            this.outputText("Dancers aren't really your thing, and you shake your head.");
            //(disable repeat and NPC)
            this.flags[kFLAGS_1.kFLAGS.LOPPE_DISABLED] = 1;
            this.menu();
        ...
        yesToMeetingLoppe() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.LOPPE_MET] = 1;
            this.outputText("There's no harm in staying a while...");
        ...
        yesToLoppeMeetingTwo() {
            this.clearOutput();
            this.outputText(this.images.showImage("loppe-show-at-bar"));
            this.outputText("Suddenly the bar goes silent and the lights dim; a figure clad in a white mantle steps onto the stage; discarding the covering with a swift movement, it reveals the comely visage of a bunny-girl - a literal bunny-girl, in that apart from the obvious bunny ears and the hints of rabbit-like legs, she actually looks otherwise human despite the prevalence of anthropomorphic animals in this city.");
            ...
            if (this.player.cor < 40)
                this.outputText(" as politely as possible. It felt nice to see a display like that here; makes it feel a little less like a wasteland of sex-mad monsters and a little more like home");
            this.outputText(".");
        ...
        //[=Not Really=]
        notReallyInterestedInLoppe() {
            this.clearOutput();
            this.outputText("You decline, and the girl gives you a look of disappointment.");
        ...
        sureBakeryWithLoppe() {
            this.clearOutput();
            this.outputText("You consider the time of day, and the girl offering, and decide that it can't hurt.  Loppe smiles and takes your hand, leading you towards a nearby bakery.");
            ...
            this.outputText("\n\nYou tell her that you aren't, you just didn't expect her to have such an appetite.  With a playful smile, you ask what other not-so-dainty secrets she's hiding; does she burp loudly to show she enjoyed her meal?  Loppe smiles mischievously, \"<i>Oh, my sweet " + this.player.mf("boy", "girl") + "...  When I get my hands on something I like, I eat it up whole...</i>\"  Slowly, you feel a foot gently glide across your [legs].");
            //(Low Libido)
            ...
            if (this.player.gems >= 30) {
                ...
                //[(corr > 40)
                if (this.player.cor > 40)
                    this.outputText("  A small voice inside wonders if she'd eat so extravagantly were she footing her own bill.");
                //remove 30 gems
                this.player.gems -= 30;
        ...
        NoWayLoppe() {
            this.clearOutput();
            this.outputText("Loppe lets out a breath she had obviously been holding in a bitter sigh, the ghost of the words, \"<i>I knew it</i>\" echoing faintly as she does so.  \"<i>Well, I understand.  I just had to give it a try all the same.  It was nice talking to you, [name].  Might see you again, someday.  Sorry for wasting your time...</i>\"");
        ...
        okayLoppeLetsGo() {
            ...
            this.outputText("\n\n\"<i>Hey, [name],</i>\" she says quietly, \"<i>you're really " + this.player.mf("handsome", "beautiful") + ", y'know?  And kind... how about a quick stop at my place, before we say goodbye?</i>\"");
            //[Yes][No]
            this.menu();
        ...
        yesLoppesHouse() {
            this.clearOutput();
            //Loppe can now be found in the Gym
            this.outputText("The dancer smiles mischievously at you.  \"<i>Wonderful.  I'm going to show you just how great my body looks without this dress.  You wouldn't believe how much time I spend in the gym, working out.</i>\"  Loppe grabs her last cookie in one hand and your arm in the other, leading you away - presumably to her house.  Enroute, she giggles constantly, provoking a question from you.");
        ...
        loppeGenericMeetings() {
            this.clearOutput();
            this.outputText("You decide to approach the bunny-girl.  Loppe smiles and wipes the sweat off her brow with the towel.  \"<i>Hey there, [name], nice seeing you around here.  So... do you want to do something?  Talk, maybe?  Or go to my place for a 'workout'?</i>\" she asks with a smirk.");
            //Appearance
            //Talk
            //Sex
        ...
        talkWithLoppe() {
            this.clearOutput();
            this.outputText("That 'workout' is going to have to be postponed; you have some questions.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_TIMES_SEXED] > 0)
                this.addButton(1, "Children", this.askLoppeAboutChildren);
            //Gossip (after sexin' once)
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_TIMES_SEXED] > 0)
                this.addButton(2, "Gossip", this.gossipWithLoppe);
            //Working (after [Loppe]
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_ASKED_LOPPE_ABOUT_LOPPE] > 0)
                this.addButton(3, "Working", this.talkWithLoppeAboutWorking);
            //Her Mom (available after choosing \"<i>Loppe</i>\" at least once)
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_ASKED_LOPPE_ABOUT_LOPPE] > 0)
                this.addButton(4, "Her Mom", this.chatWithLoppeAboutHerMom);
            //Her Village (after [Loppe]
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_ASKED_LOPPE_ABOUT_LOPPE] > 0)
                this.addButton(5, "Her Village", this.chatWithLoppeAboutLoppesVillage);
            //The curse (unfinished; available after choosing \"<i>Loppe</i>\" at least once)
            //Fondle (after "Loppe"; see appropriate section)
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_ASKED_LOPPE_ABOUT_LOPPE] > 0 && this.flags[kFLAGS_1.kFLAGS.LOPPE_TIMES_SEXED] > 0)
                this.addButton(6, "Tease Her", this.fondleAndTease);
            this.addButton(9, "Back", this.loppeGenericMeetings);
        }
        //Loppe (edited) (C)
        talkWithLoppeAboutLoppe() {
            this.clearOutput();
            this.outputText("You tell the laquine that you're curious about her, that you'd like to know more about her: who she is, where she comes from, et cetera.");
            ...
            //set LoppeChat = 1
            this.flags[kFLAGS_1.kFLAGS.TIMES_ASKED_LOPPE_ABOUT_LOPPE] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Children (edited) (C)
        //req LoppeSexed > 0 and LoppeChat > 0
        askLoppeAboutChildren() {
            this.clearOutput();
            this.outputText("You decide to ask Loppe for her thoughts on children.  Has she considered having any?");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] + this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] > 0)
        ...
        noOpinionOnLoppeArt() {
            this.clearOutput();
            this.outputText("You decline to answer, waving the question off.  Loppe raises an eyebrow at that.  \"<i>Haven't thought about it either, huh?</i>\"");
        ...
        loppeIDontReallyWantKidsYouStupidTwat() {
            this.clearOutput();
            this.outputText("You confess you aren't really a 'kids' person; you don't think you could ever envision yourself as a parent, especially in this crazy world.");
        ...
        //[=Soon=]
        loppeIWantKidsSoonOkayCanWeFuck() {
            this.clearOutput();
            this.outputText("With a faint smile, you declare that having children is definitely in your future.  You want to be a parent; all you need is to find somebody who feels similar to you.");
            ...
            this.outputText("\n\nLoppe grins at you.  \"<i>Oh... I don't know.  I'm sure a " + this.player.mf("handsome", "beautiful") + " person like you has already drawn quite a few stares,</i>\" Loppe teases, batting her eyes at you.  \"<i>But, if the time is right, and you ask nicely... I'm pretty sure there's a certain bunny-girl around here who wouldn't mind...</i>\"");
        ...
        gossipWithLoppe() {
            this.clearOutput();
            this.outputText("You ask Loppe if she has any comments on the other residents of Tel'Adre.  The laquine smiles at you.  \"<i>It's not polite to pry into other people's lives, y'know?</i>\"");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] > 0)
                this.addButton(1, "Scylla", this.gossipWithLoppeAboutScylla);
            //Jasun
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00179] > 0)
                this.addButton(2, "Jasun", this.gossipWithLoppeAboutJasun);
            //Heckel
            if (this.flags[kFLAGS_1.kFLAGS.MET_HECKEL] > 0)
                this.addButton(3, "Heckel", this.gossipWithLoppeAboutHeckel);
            //Edryn
            this.addButton(4, "Edryn", this.gossipWithLoppeAboutEdryn);
            //Lottie
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00281] > 0)
                this.addButton(5, "Lottie", this.gossipWithLoppeAboutLottie);
            //Cotton
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_MET_FUCKED] > 0)
                this.addButton(6, "Cotton", this.gossipWithLoppeAboutCotton);
            //Back (spacebar default)
            this.addButton(9, "Back", this.talkWithLoppe);
        }
        //Urta:
        gossipWithLoppeAboutUrta() {
            this.clearOutput();
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.LOPPE_URTA_CHATS] == 0) {
        ...
        //[=It's Me=]
        itsMeFuckingUrtaLoppe() {
            this.clearOutput();
            //set LoppeUrtaKnowledge = 1
            this.flags[kFLAGS_1.kFLAGS.LOPPE_URTA_CHATS] = 1;
        ...
        //[=Play Along=]
        playAlongWivLoppesesUrtaGossip() {
            this.clearOutput();
            this.outputText("And... what would she do if, hypothetically, you <i>did</i> have a fetish for dickgirls ready to give a stallion an inferiority complex?");
        ...
        //[=Admit=]
        admitToLoppeThatYouLoveZeHorsecock() {
            this.clearOutput();
            this.outputText("You look her in the eyes and tell her she's hit the nail on the head; you do have a fetish for chicks with dicks, and having a horsecock makes a dickgirl even sexier to you.");
        ...
        //[=Deny=]
        denyToLoppeThatYouLoveZeHorsecock() {
            this.clearOutput();
            this.outputText("Not in the mood to play along with Loppe's little game, you simply state that your reasons are your own and will stay that way for now.");
        ...
        //Scylla:
        gossipWithLoppeAboutScylla() {
            this.clearOutput();
            this.outputText("\"<i>The nun who likes sucking on dicks?</i>\" Loppe asks you.  \"<i>Yes, I've run into her at the Wet Bitch.  She offered to blow me too.  I was tempted, y'know?  She has those wonderful looking lips... nice big breasts too... but ultimately I wound up refusing.  It's just... not right.</i>\"");
        ...
        gossipWithLoppeAboutHeckel() {
            this.clearOutput();
            this.outputText("You ask if Loppe's ever had a run-in with a herm hyena who's usually running in the track at the gym.");
        ...
        //Lottie:
        gossipWithLoppeAboutLottie() {
            this.clearOutput();
            this.outputText("\"<i>That pig-girl that started hanging around the gym in the evenings?  I heard about her... I believe she wants to get fit,</i>\" Loppe comments conversationally.");
            //(if PC's training Lottie)
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00299] == 1) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00281] > 0) {
        ...
        //Working (edited)
        //req LoppeChat > 0
        talkWithLoppeAboutWorking() {
            this.clearOutput();
            this.outputText("Her curse naturally impacts her social life, but what about work?  How do she and her mother put food on the table?");
            ...
            //set LoppeChat = 2
            this.flags[kFLAGS_1.kFLAGS.TIMES_ASKED_LOPPE_ABOUT_LOPPE] = 2;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Her Mother (edited)
        chatWithLoppeAboutHerMom() {
            this.clearOutput();
            //req LoppeChat > 0
            this.outputText("Loppe rubs her chin, deep in thought.  \"<i>Where do I start?  I guess by saying that my mom is a super mom.  She raised me all on her own, and she's always had time for me, despite having to keep up with her job.  I love her very much.</i>\"");
            ...
            if (this.player.gender == 1)
                this.outputText("  Well, from what Loppe's told you, Uma wouldn't be attracted to you anyway.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_PC_MET_UMA] == 0) {
                ...
                this.outputText("Loppe looks you over, thoughtful.  \"<i>To be honest... I don't think she would mind.  Want me to introduce you to her?  To become my 'official' " + this.player.mf("boy", "girl") + "friend?  I know I certainly wouldn't mind having a 'serious' relationship with a cutie like you.</i>\"  The dancer winks at you. \"<i>How about it Sugar, do you wanna go visit my mom?</i>\"");
            }
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_PC_MET_UMA] == 0) {
        ...
        //Her Village (edited)
        //req LoppeChat > 0
        chatWithLoppeAboutLoppesVillage() {
            this.clearOutput();
            this.outputText("You ask if Loppe would be willing to tell you about her village.");
        ...
        //Sex
        loppeSexChoice(bakery = false) {
            this.clearOutput();
            //First Time Intro (edited)
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_TIMES_SEXED] == 0) {
                //first-time only output, if not coming from bakery date
                if (!bakery) {
                    this.outputText("That 'workout' seems like a nice option right now.");
                    ...
                    //(else)
                        ...
                        if (this.player.lib >= 40)
                            this.outputText(".. it almost sounds exciting.");
                    }
                ...
                this.outputText("It's not very difficult to reach Loppe's place; it happens to be located only a few blocks away from the gym, behind a small shop with the sign \"<i>Kemono's Oriental Clinic</i>\".");
                ...
                //[(corr < 40)]
                if (this.player.cor < 40)
                    this.outputText("  You tell her they're quite nice... though privately you're curious what the interior looks like.");
                else
                    this.outputText("  They don't seem to work very well - after all, <i>you're</i> here.");
                ...
                if (this.player.hasCock()) {
                    if (this.player.smallestCockArea() <= this.loppeCapacity())
                        this.outputText("Pulling her onto your dick would result in some cowgirl fun, though you'd have to deal with her cock pointed right at you when she came.  ");
                    else
                        this.outputText("As good as it would feel to shove your [cock smallest] into her cunt, the nervous looks she's giving it tell you what her response would probably be.  ");
                }
                //[(any cock)
                if (this.player.hasCock())
                    this.outputText("You could just whip it out and ask what she thinks of it, compared to hers - it might lead to some cross words and crossed swords, though.  ");
                if (this.player.hasVagina())
                    this.outputText("You could take her monster length vaginally, but if her libido is what she claims, you'll probably wind up quite stretched.  ");
                //[(boobs >= boobjob req)
                if (this.player.biggestTitSize() >= 5)
                    this.outputText("Her hardening horsecock looks like it would fit between your [chest], an act likely to net you a messy demonstration of her enthusiasm.  ");
                this.outputText("There's always the option to receive her anally, though with her vaunted libido, you'd probably end up so flooded with her cum that it would wash from your mouth.  Or you could be a prick-tease and leave.");
                //Display sex options
                //[Cowgirl][Frot][TakeVaginal][Boobjob][TakeAnal][Bail]
            }
            //Repeat Intro (edited)
            else {
                this.outputText("Loppe's other 'workout' sounds pretty good right now.");
                ...
                this.outputText("There's always the option to receive her anally, though with her vaunted libido, you'd probably end up so flooded with her cum that it would wash from your mouth.  Or you could be a prick-tease and leave.");
                //[(loppesexed)
                this.outputText("  Just jerking that cock and squeezing it so hard her balls swell up when she comes, though, that might be fun.  It'd be interesting to see how big they can get.");
                //Display sex options
            ...
            if (this.player.biggestTitSize() >= 4)
                this.addButton(3, "Boob-job", this.boobjobLoppe);
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_TIMES_SEXED] > 0)
                this.addButton(4, "SqueezeJob", this.loppeSqueezedickWhateverThatIs);
            if (this.player.isTaur() && this.player.lust >= 33)
                this.addButton(5, "TakeAnal", this.getAssFuckedByLoppeAsACentaur);
            else if (this.player.lust >= 33)
                this.addButton(5, "TakeAnal", this.getButtFuckedNonHoarseByLoppe);
        ...
        loppeRidesCocks() {
            this.clearOutput();
            this.outputText(this.images.showImage("loppe-rides-your-cocks"));
            this.outputText("Looking over the hermaphroditic, horse-cocked bunny-girl, you contemplate your options.  You settle yourself ");
            //[(not centaur)]
            if (!this.player.isTaur())
                this.outputText("on her bed, making yourself comfortable, and start suggestively stroking yourself");
            //(centaur)
            else
                this.outputText("cumbersomely on the floor, rolling over and spreading your hindlegs to expose yourself");
            this.outputText(".  Quietly, you ask Loppe how she would feel about indulging her feminine half.");
            this.outputText("\n\n\"<i>I would love to, sugar!</i>\"  Loppe gazes at your " + this.multiCockDescriptLight() + ".");
            //[(2 fit cocks)
            var x = this.player.cockThatFits(this.loppeCapacity());
            var y = this.player.cockThatFits2(this.loppeCapacity());
            if (y >= 0 && this.player.cockTotal() == 2)
                this.outputText("  \"<i>In fact... I could just eat both of those up.</i>\"");
            //(3+ fit cocks)
            else if (y >= 0 && this.player.cockTotal() == 3)
                this.outputText("  \"<i>But I'm afraid I'll only be able to handle two of them.</i>\"");
            ...
            if (y >= 0)
                this.outputText("s");
            this.outputText(", rubbing gently.  \"<i>Just sit back and leave everything in my capable hands, sugar.</i>\"");
            ...
            if (y >= 0)
                this.outputText("s");
            this.outputText(" nice and slick.  You gasp in pleasure and surprise as you feel Loppe's erect cock sidle up to yours, helping lube you with its leaking pre. Raising up your hips, you clumsily try to ");
            if (y < 0)
                this.outputText("slide your shaft against her");
            else
                this.outputText("pinion her shaft between your");
            this.outputText(" own, shivering from the sensation of your sensitive " + this.player.skin() + " against her proud horseflesh, already drooling even though you can plainly feel that it's only half-erect.");
            if (this.player.balls > 0)
                this.outputText("  Your [balls] gently brush and rub against her own swollen cum-factories, and you can't wait to empty your overfilled sac into her waiting womb.");
            this.outputText("\n\n\"<i>Okay, that's enough foreplay!</i>\" Loppe announces suddenly, eyeing your " + this.cockDescript(x) + " with a hunger that you never expected to see on her face.  Loppe quickly straddles you, aligning it with her pussy");
            if (y >= 0)
                this.outputText("; its neighbor is aimed for her tight rosebud");
            this.outputText(".  \"<i>Itadakimasu!</i>\" Loppe says, licking her lips as she finally slides you home.");
            ...
            if (this.player.cockTotal() > 1)
                this.outputText("s");
            this.outputText(", yet squeezing you as tightly as a velvety vise.  In fact, she's gripping you so hard that you can't seem to push yourself any further into her depths; she's squeezing you much too tightly to move in or out, an outright amazing feat, if Loppe gets half as much action as she claims to.");
            ...
            if (y >= 0)
                this.outputText("s");
            this.outputText(" with happy squeals of pleasure and happiness, softly accompanied by the wet sounds of your coupling.  You gasp and cry, savoring every motion as she squeezes and wriggles, her inner walls rippling so deliciously around your cock");
            if (y >= 0)
                this.outputText("s");
            this.outputText(", stroking them in the most delicious way.  You thrust your hips, trying to slip deeper inside her, but still she's holding you at bay.");
            ...
            if (y >= 0)
                this.outputText(" and watertight ass");
            this.outputText(".  The sensation borders on the thin line between pleasure and pain, and you can't help but moan into Loppe's kiss; you wrap your ");
            if (this.player.isDrider())
                this.outputText("spindly legs");
            else if (this.player.isTaur())
                this.outputText("forelegs");
            else
                this.outputText("arms");
            this.outputText(" around the bunny-girl's ");
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_FURRY] == 0)
                this.outputText("silky-smooth");
            else
                this.outputText("softly furred");
            this.outputText(" back and hold her tight against you, her long horse-cock sandwiched between your bellies, smearing both of you with drooling precum, rivers of the stuff flowing out steadily with every thrust and grind the two of you make.");
        ...
        loppeRidesYouSpunksInYourEye() {
            ...
            if (this.player.isDrider())
                ...
                this.outputText("arms");
            this.outputText(" wrapped around your lover, welcoming what's approaching as her horse-prick throbs and her flared tip inflates.  With a rapturous howl the laquine's cumslit opens like a floodgate, spurting jet after jet of cum onto your [chest], [face] and even the wall behind you; her own pillowy breasts and face are splashed with the force of her orgasm.  Her tight pussy contracts, milking your " + this.cockDescript(x) + " for all its worth");
            if (y >= 0)
                this.outputText(", while her anal ring constricts your " + this.cockDescript(y) + " tightly, intent on holding you in place");
            this.outputText(".");
        ...
        loppeRidesPCCockFinal() {
            ...
            if (y >= 0 || this.player.hasVagina()) {
                this.outputText(", while ");
                if (y >= 0)
                    this.outputText("your second " + this.cockDescript(y) + " just as easily pumps her perverted ass full of baby juice");
                if (y >= 0 && this.player.hasVagina())
                    this.outputText(" and ");
                if (this.player.hasVagina()) {
                    this.outputText("your [vagina] ");
                    if (this.player.wetness() < 3)
                        this.outputText("drizzles");
                    else if (this.player.wetness() < 5)
                        this.outputText("spatters");
                    else
                        this.outputText("gushes");
                    this.outputText(" femcum onto the bed below you, forgotten during the act but not unsympathetic to her ministrations");
                }
            }
            this.outputText(".  You cry out as you cum long and hard, arching your back off of the bed in your pleasure before finishing and collapsing, gasping for breath as, above you, the laquine comes to her own climactic end.");
            ...
            if (this.player.lib >= 70 || this.player.minLust() >= 50) {
            ...
            else if (this.player.lib >= 50 || this.player.minLust() >= 35) {
            ...
            this.outputText(this.multiCockDescriptLight() + " and slides down your body, pressing her soft, cum-slickened breasts against you.  You moan as the smooth curves of her chest press against [eachCock]; the cum-slick ");
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_FURRY] == 0)
                this.outputText("skin");
            else
                this.outputText("fur");
            this.outputText(" give you the impression of being wrapped in the moist folds of a woman's sex.  As Loppe slides further down you feel her teasingly licking at the tip");
            if (y >= 0)
                this.outputText("s");
            this.outputText(" of your " + this.multiCockDescriptLight() + ".");
            ...
            if (y < 0)
                this.outputText("s");
            this.outputText(" an involuntary shudder from you; the erotic stimulation sends blood pulsing back into your veins, and your shaft");
            if (y >= 0)
                this.outputText("s rise");
            else
                this.outputText(" rises");
            this.outputText(" to full mast again, so swiftly ");
            if (y < 0)
                this.outputText("it almost smacks");
            else
                this.outputText("they almost smack");
            this.outputText(" the laquine on her nose, leaving you ready to be mounted by her once again.");
            ...
            if (this.player.minLust() <= 30 && this.player.lib <= 50)
                this.outputText("; if I have to stop to tend to you after every coupling, I'll never get these empty");
            this.outputText(".</i>\"  She points with a smirk to her swollen balls.  Er... didn't she just blow her load? Her balls look at least as full as, if not fuller than, when you started, and they nearly slosh with eagerness to be rid of their cargo!");
            ...
            if (y >= 0)
                this.outputText("s");
            this.outputText(" once more.  You moan as once again you follow the lusty dickgirl into the throes of pleasure...");
            ...
            if (this.player.cumQ() >= 500)
                this.outputText(" despite your usually messy orgasms");
            this.outputText(".");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0)
                this.outputText("; it gives you something of a thrill, though nowhere near as much as taking them off for her in the first place did");
            this.outputText(".  Finished, you depart.");
            this.player.orgasm();
            this.dynStats("tou", .5, "lib", .5, "sen", -4);
            this.flags[kFLAGS_1.kFLAGS.LOPPE_TIMES_SEXED]++;
            //3 hours pass.
        ...
        loppeWorshipsDicks() {
            this.clearOutput();
            this.outputText(this.images.showImage("loppe-worships-your-cock"));
            this.outputText("As your eyes sweep over the naked half-breed's form, they focus on her equine masculinity, already standing proud and eager at the prospect of sex.  Distinctly aware of your own male appendage");
            if (this.player.cockTotal() > 1)
                this.outputText("s");
            this.outputText(", you conversationally ask Loppe what she thinks of your [cock biggest], an idea starting to form in your mind.");
            //(if cock area <= 17.5)
            if (this.player.biggestCockArea() <= 17.5) {
            ...
            else if (this.player.biggestCockArea() <= 35) {
                ...
                if (this.player.biggestCockArea() > this.loppeCapacity())
                    this.outputText("even if it does look too big to fit.");
                else
                    this.outputText("or maybe I should get a taste first?");
                this.outputText("</i>\"  She licks her lips.");
            }
            ...
            if (this.player.balls > 0)
                this.outputText(" and balls to balls");
            this.outputText(", the delicious friction pushing you over the edge.");
            ...
            //Low Libido:
            if (this.player.lib < 33 && this.player.minLust() < 30)
                this.outputText("\n\nYou groan from the depths of your throat; Loppe and her libido...");
            //{Moderate Libido:
            else if (this.player.lib < 66 && this.player.minLust() < 50)
        ...
        getFuckedInYerTwatYaCunt() {
            this.clearOutput();
            this.outputText(this.images.showImage("loppe-sticks-it-in-your-vagoo"));
            this.outputText("As you contemplate the delicious possibilities that the herm presents, your eyes are drawn to her admirable piece of horse-meat.  With a half-grin, you settle yourself on her bed, ");
            //[(mans)
            if (!this.player.isTaur())
                this.outputText("spreading your labia in an invitation that needs no words.");
            else
                this.outputText("exposing your rump and spreading your hind legs in your best effort to make her feel welcome.");
            this.outputText("\n\nLoppe smirks at you and winks.  \"<i>Don't worry; I'll treat you like a ");
            //[(femininity <= 40)
            if (this.player.femininity > 50)
                this.outputText("princess.  A sexy, smoking hot princess");
            else
                this.outputText("prince.  A dashing, dandy prince");
            this.outputText(" that I intend to fill up with my laquine love.</i>\"  She wastes no time and pounces on the bed, ready to bury her face between your [legs], licking her lips while taking deep breaths to inhale as much of your pheromones as she can.  You blink at the speed with which she moves, but smile, repositioning yourself to give her better access");
            //[(herm non-horse)
            if (this.player.gender == 3 && !this.player.isTaur()) {
                this.outputText(", though she needs to move aside " + this.sMultiCockDesc() + " ");
                if (this.player.balls > 0)
                    this.outputText("and [balls] ");
                this.outputText("to really get at your cunt");
            }
            this.outputText(".");
            ...
            //[(not horse and herm)
            if (!this.player.isTaur() && this.player.gender == 3) {
                this.outputText(", under your ");
                if (this.player.balls > 0)
            ...
            this.outputText(" to lick and kiss your sensitive labia.  You arch your back and thrust your crotch at her, letting the laquine have your precious pussy to taste and suckle and ravage... she's pretty good with that tongue of hers.  Loppe lifts her head and wipes her face with her arm.  \"<i>I'm even better with this,</i>\" she says, mirroring your thoughts and holding her painfully erect equine-shaft.  You watch as it throbs, every vein bulging visibly, balls engorged as they churn up a load of cum to deposit in your waiting womb.  She ducks to take another lick, tasting you like one tastes a fine wine.");
            if (this.player.vaginas[0].virgin) {
                ...
                if (this.player.cor < 50)
                    this.outputText("  You look coy, for her benefit, and cast your eyes down shyly.");
                else
                    this.outputText("  You do your best to warn her away from the topic with your eyes, eager to get on with the fuck.");
                //(not for horsez)
                if (!this.player.isTaur())
                    this.outputText("\n\nLoppe gasps and persists.  \"<i>Wow... I'll actually get to be your first... are you sure that's okay?</i>\"");
                this.outputText("\n\nYou reach out ");
                if (this.player.cor < 50)
                    this.outputText("and tap her playfully on the nose");
                else
                    this.outputText("in your irritation and squeeze her face imploringly");
                this.outputText(".  Would you be here, with your clothes off in Loppe's bed, if you weren't okay with it?");
            ...
            if (this.player.vaginalCapacity() >= 35)
                this.outputText(" bottoms out, completely hilted inside you");
            //[else:
            else
                this.outputText(" bumps against your cervix");
            this.outputText(". You moan in delight as she sinks into you");
            if (this.player.vaginas[0].virgin)
                this.outputText(", repressing a shiver of pain as she tears through your hymen, taking your virginity");
            else if (this.player.vaginalCapacity() < 35)
                this.outputText(", forcing your entrance wide to accommodate herself");
            this.outputText(".");
            //cuntchange, but suppress standard messages
            this.player.cuntChange(35, true, true, false);
            ...
            //[(not horse)
            if (!this.player.isTaur())
                this.outputText("  You wrap your [legs] around her hips as best you can, thrusting in your efforts to meet her strong rhythm, feeling your cunt rippling around her wonderfully long, thick horsecock.");
            ...
            if (this.player.hasCock())
                this.outputText(", precum begins to drool from your " + this.multiCockDescriptLight());
            this.outputText(".");
            //Not Centaur:
            if (!this.player.isTaur()) {
                ...
                if (this.player.gender >= 3)
                    this.outputText(" and smearing both your bellies with herm-pre");
                this.outputText(".");
            }
            //Centaur:
            else {
            ...
            if (this.player.hasCock()) {
                this.outputText(", neglected cock fountaining cum ");
                if (this.player.cumQ() < 500)
                    this.outputText("between you and painting you both");
                else
                    this.outputText("gushing onto the bedsheets and smearing your belly");
                this.outputText(" with this aspect of your dual-sexed orgasm");
            }
            this.outputText(".");
            ...
            if (!this.player.isTaur() && this.player.hasCock())
                this.outputText(", giving you a quick peck on the cheek and licking a small gob of cum that seems to have stuck to your chin");
            this.outputText(".");
            ...
            //[(low corr)
            if (this.player.cor < 50)
                this.outputText("a pleading look... and if there's maybe a trace of horror dancing in the depths of your eyes, well, that's understandable, isn't it?");
            else
                this.outputText("an incendiary glare, letting her know just what you think of her posturing.");
            this.outputText("  Loppe bursts out laughing.  \"<i>Just kidding, sugar.  If we go another round I think my dick might fall off.</i>\"");
            ...
            if (this.silly())
                this.outputText("  \"<i>Da! Sandvich is kredit to team!</i>\"");
            //(First Time)
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_TIMES_SEXED] == 0) {
            ...
            //[Libido >=50:
            if (this.player.lib >= 50 || this.player.minLust() >= 30)
                this.outputText("  Not that you didn't just titillate yourself thinking of it...");
            this.outputText("  Your lover laughs, \"<i>Okay, you got me there... but, anyway, I have some chores to run for my mom, so I guess I'll see you later?</i>\"");
        ...
        getButtFuckedNonHoarseByLoppe() {
            this.clearOutput();
            this.outputText(this.images.showImage("loppe-sticks-it-in-your-butt"));
            this.outputText("You swallow as your eyes are drawn to the equine sausage jutting out between the bunny-girl's legs, and know you just have to have it.  Slowly, you spread yourself upon Loppe's bed, scooting up toward the head and pillows and kneeling, [butt] in the air, inviting the laquine to do with you as she will.");
            ...
            if (this.player.ass.analLooseness == 0) {
                ...
                this.player.buttChange(35, true, true, false);
            ...
            if (this.player.hasCock()) {
                ...
                this.outputText(", ");
            if (this.player.hasVagina())
                this.outputText(" pussy oozing femlube");
            this.outputText("... you beg her to go faster, to do it harder!");
            this.outputText("\n\nLoppe happily complies, thrusting herself deeper and stronger.  ");
            //[(cock)
            if (this.player.hasCock())
                this.outputText("One of her hands reaches around to grasp your pre-slickned [cock biggest], stroking you in time with her thrusts.  ");
            if (this.player.gender == 2)
                this.outputText("One of her hands reaches around to tease your dripping [vagina] and erect [clit], dipping a finger in every time she bottoms out.  ");
            this.outputText("Wet slapping noises fill the room, and you gasp in pleasure each time her cum-churning balls slap against ");
            if (this.player.balls > 0)
                this.outputText("yours");
            else
                this.outputText("your [butt]");
            this.outputText(".  Loppe lays down on top of you, panting hotly on your neck, moaning in pleasure each time your sphincter contracts.");
            ...
            if (this.player.hasVagina()) {
                this.outputText("  A gush of sexual fluids from your crotch ");
                if (this.player.wetness() < 3)
                    this.outputText("spatters");
                    ...
                    this.outputText("completely soaks");
                this.outputText(" the bed-linen under you.");
            }
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SATYR_KIDS] > 0)
                this.outputText("You laugh softly; hopefully she'll never have to meet the creature that dispelled that same doubt in you.  ");
            this.outputText("\"<i>I think this is time for sleeping, not joking.</i>\"  With a trace of wounded dignity, she lays herself down and curls into your back, one arm wrapped around your gurgling belly.");
            ...
            //(First Time)
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_TIMES_SEXED] == 0) {
                this.outputText("Loppe laughs nervously.  \"<i>Sorry about that.  It's just that I usually can't bag a real cutie like you, and I think I might have gone a bit overboard... is there anyway I can make it up to you?</i>\"");
        ...
        getAssFuckedByLoppeAsACentaur() {
            this.clearOutput();
            this.outputText(this.images.showImage("loppe-sticks-it-in-your-butt-you-centaur"));
            this.outputText("You swallow as your eyes are drawn to the equine sausage jutting out between the bunny-girl's legs, and know you just have to have it.  But is she confident in her ability, even with your shape?");
            ...
            //[ass wet)
            if (this.player.ass.analWetness > 0)
                this.outputText("  She doesn't even have to bother with lube; your ass is wet enough to accommodate her on its own.");
            ...
            if (this.player.balls > 0)
                ...
                this.outputText("r pussy");
            this.outputText(".");
            this.outputText("\n\nYou moan as she gets into her task");
            if (this.player.hasCock())
                this.outputText(", feeling your erect [cock] press against your underbelly, mashed between your centaur half and the soft carpet of Loppe's room.  You hope she doesn't mind a few stains...  ");
            //(else vag)
            else if (this.player.hasVagina())
                this.outputText("; your cunt is sopping, making a small pool of juices one the floor.  ");
            else
                this.outputText(".  ");
            this.outputText("She seems more worked up than usual, perhaps because you have a horse-like lower body?  \"<i>Are your instincts acting up?</i>\" you tease her.  \"<i>Or do you just love ass that much?</i>\"");
            ...
            if (this.player.gender <= 1)
                this.outputText("  Even if you are the wrong sex entirely for that.");
            ...
            //[PC has cock:
            if (this.player.hasCock())
                this.outputText("  The bumps against your prostate send waves of pleasure running through [eachCock] and spreading along your body, until they reach your throat and come out as a ragged groan.  ");
            this.outputText("If she keeps this up for too much longer, you will pop any moment now...");
            ...
            if (this.player.hasCock())
                this.outputText("  [EachCock] spasms and unloads beneath you, smearing you and the carpet below and pooling thickly with fluid forced out by the prostate stimulation.");
            if (this.player.hasVagina())
                this.outputText("  Your vagina contracts, trying to grip at a phantom member as you spill your fluids on the carpet beneath you.");
            ...
            if (this.player.skinType != appearanceDefs_1.SKIN_TYPE_SCALES)
                this.outputText(" have goosebumps all over your body");
            else
                this.outputText("r scales are practically standing on end");
            this.outputText(".");
            this.outputText("\n\n\"<i>Ohhh... you are incredible, [name].  ");
            //[PC has dick that fits)
            if (this.player.cockThatFits(this.loppeCapacity()) >= 0)
                this.outputText("Though I hope you won't mind riding me, sometime,</i>\" she laughs.  \"<i>");
            this.outputText("How about another round, hmm?  Big strong 'taur like you should certainly be able to hold a little more loving inside of you, right?</i>\"  She croons happily, running her hands up and down your ass as if trying to entice you.");
            //(Low Libido)
            if (this.player.lib < 33) {
            ...
            this.outputText("\n\n\"<i>[name]?  [name], are you... oh.</i>\"  Loppe smiles as she sees you've dozed off.  Quietly she slips away to the bed and pulls off her blanket, moving around to carefully seat herself against your bloated stomach, draping her blanket over the both of you and gently resting her head on your distended horse-gut.  \"<i>Sweet dreams, lover-" + this.player.mf("boy", "girl") + ",</i>\" she stage-whispers to you, then closes her eyes, just as eager for some rest, listening to the gurgling of your flooded stomach as she drifts off.");
            this.outputText("\n\n<b>Two hours later...</b>");
            ...
            this.outputText("  Anyway, your clothes are back in my room; sorry to fuck and run, but I've got some errands to run before mom gets home - you'll have to see yourself out, okay?</i>\"");
        ...
        loppeSqueezedickWhateverThatIs() {
            this.clearOutput();
            this.outputText(this.images.showImage("loppe-orgazm-denial"));
            //(if LoppeDenial == 0)
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_DENIAL_COUNTER] == 0) {
                this.outputText("After seeing Loppe's prodigious output, you wonder how she would handle not being able to orgasm.");
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.LOPPE_DENIAL_COUNTER] == 1) {
        ...
        letsLoppeGoCum() {
            this.clearOutput();
            this.outputText(this.images.showImage("loppe-comes-after-orgasm-denial"));
            ...
            this.flags[kFLAGS_1.kFLAGS.LOPPE_DENIAL_COUNTER] = 3;
            this.dynStats("lus", 30 + this.player.lib / 10, "resisted", false);
            this.flags[kFLAGS_1.kFLAGS.LOPPE_TIMES_SEXED]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[=Hold=]
        superLoppeOrgasmDenialGo() {
            this.clearOutput();
            this.outputText(this.images.showImage("loppe-comes-after-moar-orgasm-denial"));
            this.outputText("For fear of not being able to hold her back anymore, you return both hands to tightly gripping her shaft.  Tears escape Loppe's eyes as she's denied yet again.  \"<i>Stop...</i>\" she says meekly.");
            ...
            this.outputText("\n\n\"<i>Bye, sugar!");
            if (this.player.hasCock())
                this.outputText("  Maybe next time I'll be the one to give you a bit of a holdout!");
            this.outputText("</i>\"");
            //leave, set LoppeDenial flag = 7
            this.flags[kFLAGS_1.kFLAGS.LOPPE_DENIAL_COUNTER] = 5;
            //(very high corr)
            if (this.player.cor >= 90) {
                ...
                this.flags[kFLAGS_1.kFLAGS.LOPPE_DENIAL_COUNTER] = 10;
        ...
        boobjobLoppe() {
            this.clearOutput();
            this.outputText(this.images.showImage("loppe-give-her-a-titty-fuck"));
            this.outputText("You contemplate your options, unthinkingly rubbing your breasts.  As you do so, you notice your lover is observing your hands very keenly.  With a grin, you grope your tits and ask if Loppe likes your display.");
            ...
            if ((this.player.str < 50 && !this.player.isTaur()) || (this.player.str < 30 && this.player.isTaur())) {
                this.outputText("  Struggle as you may, you're powerless to stop the drooling laquine as she sends you crashing down on her bed.  The whole piece of furniture shakes ominously with the force of your impact, and for a moment you think it will break apart.");
                ...
                if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                    this.outputText("looping your inhuman tongue around it and stroking for extra stimulus even while ");
                this.outputText("grabbing your breasts and squeezing the horsemeat between them.  The sooner you help her get over this frenzy, the sooner she'll get off of you... hopefully.  \"<i>Ah, sugar!  I knew you liked it rough!</i>\" your suddenly forceful lover shouts, ominously.");
                ...
                if (this.silly())
                    this.outputText(".  You can't help but think of Family Matters");
                this.outputText(".  You simply nod and groan, hands cradling your distended gut.  Loppe snuggles up against you, rubbing your bloated midriff.  \"<i>Sorry about that... hmm, how about we just cuddle and rest?</i>\"");
                ...
                this.outputText("  You hold the laquine's arms and force her onto the floor; she lands with an audible \"<i>oomph</i>\" and you grin as you hold the eager herm down.");
                ...
                if (this.player.cor >= 60)
                    this.outputText("You don't really feel like it, but you figure you had better humor the greedy herm if you want to keep fucking her whenever you like.  ");
                this.outputText("Oh, well... you reach down and heft the surprised hybrid off of the floor and onto her spattered bed, then slide yourself into it as best you can, wrapping your arms around her.  She hugs you back, then yawning widely.  \"<i>Naptime...</i>\"");
            ...
            if ((this.player.str < 50 && !this.player.isTaur()) || (this.player.str < 30 && this.player.isTaur()))
                this.outputText("- while your stomach is still heavily swollen and gurgles in protest, it's not bad enough to impair you - ");
            this.outputText("before going over and dressing yourself.  Loppe waves goodbye to you as you head out once again.");
            this.flags[kFLAGS_1.kFLAGS.LOPPE_TIMES_SEXED]++;
            this.player.slimeFeed();
            this.player.orgasm();
            this.dynStats("tou", .5, "lib", .5, "sen", -4);
        ...
        //Leave (edited)
        beATeaseAndLeaveLoppeAfterSexInvite() {
            this.clearOutput();
            this.outputText(this.images.showImage("loppe-teaze-and-leave"));
            this.outputText("Despite the hybrid beauty standing stark naked before you, you decide that you aren't in the mood after all.");
        ...
        //req LoppeChat > 1
        fondleAndTease(output = true) {
            if (output) {
                this.clearOutput();
                this.outputText("You lean in over the table and tell Loppe you'd like to talk about her.  She looks vaguely confused.  \"<i>Well, I already told you about everything I can think of.  Was there something you wanted to explore in more detail?</i>\"");
        ...
        teaseLoppeNSuck() {
            this.clearOutput();
            this.outputText("You lean over the table and give the laquine a kiss.  Confused, but not displeased, Loppe eagerly returns it, then watches as you break the lip lock and start to slide yourself under the table.  \"<i>Umm... sugar?  What are you doing?</i>\"");
            ...
            if (this.player.tongueType > appearanceDefs_1.TONUGE_HUMAN)
                this.outputText(", inhumanly long tongue looping out to coil wetly around the length");
            this.outputText(".  You suckle gently, letting the salty tang of hot spunk wash over your tastebuds, and then start to gulp and swallow your way down her prick's sizable length.");
