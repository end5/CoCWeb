define(["require", "exports", "./TelAdreAbstractContent", "../../../GlobalFlags/kFLAGS", "../../../../../includes/appearanceDefs"], function (require, exports, TelAdreAbstractContent_1, kFLAGS_1, appearanceDefs_1) {
    ...
    class Ifris extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        //Hours - 15+
        ifrisIntro() {
        ...
        approachIfris() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MET_IFRIS] == 0) {
                this.flags[kFLAGS_1.kFLAGS.MET_IFRIS] = 1;
                this.outputText("The curious, appraising gaze on her pretty face turns into a pleased smile as you walk over, and her clawed toes click gently on the floor as she takes the last few steps to meet you. As you open your mouth to speak she preempts you, those pretty, black-painted lips parting, a voice too husky and smooth to be up to any good greeting you.\n\n", false);
                this.outputText("\"<i>Hello, darling. I'm so glad you decided to join me... You can call me Ifris.</i>\" She tilts her head to the side cutely, gazing up at you through her lashes.\n\n", false);
                this.outputText("You give her your name, mouth suddenly feeling a little too dry for some reason as she gives you that sultry smile and lingering gaze.\n\n", false);
                this.outputText("\"<i>It's nice to meet you. Are you here to use the machines, or were you just hoping to watch the pretty bodies working up a sweat?</i>\" she giggles cutely, two of her clawed fingers covering her mouth demurely.\n\n", false);
            }
            //2a-Repeat approach, no sex-
            else if (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_IFRIS_BLOWJOB] + this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_IFRIS_LICKED] == 0) {
                this.outputText("Ifris grins as you walk over again, the devil girl's dark tongue dabbing at her even darker lips as she all but coos up at you.\n\n", false);
                if (this.flags[kFLAGS_1.kFLAGS.IFRIS_SHOWED_OFF] == 0)
                    this.outputText("\"<i>Hello darling... here to actually give me a show?</i>\"\n\n", false);
                else
                    this.outputText("\"<i>Hello darling... here to give another show? I did so enjoy your last performance.</i>\"\n\n", false);
            }
            //2b-Repeat approach, had oral-
            else {
                this.outputText("Ifris grins as you walk over again, the devil girl's dark tongue dabbing at her even darker lips. A small shudder runs through you as you imagine her remembering your flavor...\n\n", false);
                this.outputText("\"<i>Hello darling... so lovely to see you. Are you here to give me a show this time? Or do you think you want to try to beat your last record?</i>\"\n\n", false);
                this.outputText("A bit confused, you ask her what record she's talking about, only to evoke a small, cute laugh from her.\n\n", false);
                this.outputText("\"<i>How long you can lift that much before my attentions are too distracting, of course.</i>\"\n\n", false);
            }
        ...
        workOutForIfris() {
            ...
            this.outputText("\"<i>Oh, don't mind me, then. Please, by all means.</i>\" She gestures to the bench-press, stepping back and watching you with a smile.\n\n", false);
        ...
        askIfrisToJoinYou() {
            ...
            this.outputText("\"<i>That's sweet of you, darling... but I don't want to get in the way. I'll just wait my turn. Don't worry about me at all.</i>\"\n\n", false);
        ...
        liftWhileIfrisWatches() {
            this.spriteSelect(28);
            this.flags[kFLAGS_1.kFLAGS.IFRIS_SHOWED_OFF]++;
            this.outputText("", true);
        ...
        showOffForIfris() {
            ...
            if (this.player.gender == 0 || (this.player.femininity < 40 && this.player.cor > 75 && this.player.faceType == appearanceDefs_1.FACE_COW_MINOTAUR)) {
                this.outputText("Ifris watches you for a moment as you move down to the bench, but her eyes clearly wander elsewhere now and then. The pleasant smile never leaves her pretty face, but it's clear she's distracted or even disinterested for some reason. Soon enough she turns to leave, a bored little sigh leaving her. Her hips sway with a sexy gait as though it were natural, though nothing about her seems particularly excited at the moment...", false);
                //Stat changes HERE!
                if (this.player.str < 90)
                    this.dynStats("str", .5);
                if (this.player.tou < 40)
            ...
            if (this.player.hasCock()) {
                //Double dickings!
                if (this.player.cockTotal() > 1 && Ifris.rand(2) == 0 && this.player.cockThatFits(70) != -1 && this.player.cockThatFits2(70) != -1) {
                    this.ifrisDP();
                    return;
                }
                //First time
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_IFRIS_BLOWJOB] == 0) {
        ...
        ifrisDP() {
            ...
            this.outputText("After five big pushes, the hands disappear, but only long enough for her light, toned body to climb atop your own, the oiled thighs sliding up your sweat-glazed form towards your groin.  Ifris coos, \"<i>Mmm... keep at it, my darling.  Fitness is its own reward...</i>\"\n\n", false);
            this.outputText("You gasp at the pleasant sensation of her moist swimsuit against " + this.oMultiCockDesc() + " and start to push yourself, straining harder, grunting as you begin to feel the onset of fatigue.  Just before the next lift, Ifris squeezes two of your " + this.multiCockDescriptLight() + ", angling them straight up.  You pause in confusion a moment, until you feel wet lips on one and tight, oiled skin squeezing the other.  Like you've been charged by lightning, energy fills your body, and you push yourself to keep going.  As the bar rises, Ifris' pussy and asshole lower, squeezing the two lucky dicks in her hot, clenching innards.  Holding that position, you struggle to control your muscles and adjust to the exquisite pleasure.  The bar lowers slowly, but Ifris' holes levitate in the same motion, coming just up off your sensitive, hungry shafts.\n\n", false);
            this.outputText("The demonic-looking woman's tortuous orifices keep you hard, battling through the tide of pleasure so that you can keep lifting, and in return receive even more sensation.  Your arms are starting to feel sore, and lifting such enormous quantities of mass is getting harder and harder.  Ifris still seems pleased with your progress, and she murmurs words of encouragement.  \"<i>So... strong... mmmhmmm, go on.  You can do it.</i>\"  Her pussy squeezes and ripples around the main dick while her sphincter clamps tight on the other, massaging you to compensate for the slower speeds.  Droplets of sweat drip onto you, mingling with your own exhausted beads and falling to the floor, both of you soaked with the stink of exercise and sex.\n\n", false);
            this.outputText("Ifris leans down and twines her arms around your shoulders, resting her head in the nape of your neck, her dark tongue licking the salt from you " + this.player.skin() + ".  Your whole body is shaking, trapped between the desire to cave in to the crimson beauty's body and the need to support the machine's tremendous load.  Hot and trembling, your arms feel like they're melting into weak, burning rubber.  Ifris senses this, and she says, \"<i>Set it down and release... release for me, darling.</i>\"\n\n", false);
            this.outputText("You set the machine's bar back in place, letting your worn-out limbs go slack across Ifris's body, your hands coming to rest on her tight, squeezable butt.  The two slick holes start a whole new wave of contractations, and without the distraction of the weights, you're unable to resist.  ", false);
            //(Knotting - req's 2 dogdicks!)
            if (this.player.dogCocks() >= 2) {
                this.outputText("Both your canine cocks bloat with seed, the knot's distending and stretching so wide that Ifris couldn't pull off if she wanted.  A moment later, the twin dog-dicks explode pillars of alabaster cream, painting the truly knotted woman's innards white.  ", false);
                if (this.player.cumQ() >= 1000)
                    this.outputText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ", false);
                this.outputText("Throughout the massive release, you're softly grunting, held immobile by your animalistic body's instincts as your peckers try their damnedest to impregnate your overly fit mate.  You're still cumming, but your knots are starting to deflate at last.  ", false);
            }
            //(Nodule growing, unholy demonocity)
            else if (this.player.demonCocks() >= 2) {
                this.outputText("Both your demonic cocks explode inside Ifris, the nodules along each shaft swelling out, thickening to stroke and caress your oily lover's inner walls.  A moment later, the tainted tips explode out, spurting demon-spunk into both silky tunnels.  ", false);
                if (this.player.cumQ() >= 1000)
                    this.outputText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ", false);
                this.outputText("At the same time, your hands squeeze hard on her butt-cheeks and your hips start to jack-hammer against her, slamming into her as if she was a worthless piece of meat for you to impregnate.  You shiver, feeling not entirely in control of yourself, the demonic influence of your tainted members robbing you of control.  ", false);
            }
            //Flaring - req's 2 horsecocks!)
            else if (this.player.horseCocks() >= 2) {
                this.outputText("Both your equine cocks explode inside Ifris, their tips swelling outward into thick flares that plug her stuffed channels.  A moment later, the swollen tips unleash pillars of alabaster cream, painting everything above the flares white.  ", false);
                if (this.player.cumQ() >= 1000)
                    this.outputText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ", false);
                this.outputText("Your hips begin to rock and thrust, and no matter what you try to do, you cannot seem to still your body, your animal instincts owning your waist as you inseminate your seductive, teasing lover's body.  ", false);
            }
            //(Tentacle pistoning + head-mushrooming)
            else if (this.player.tentacleCocks() >= 2) {
                this.outputText("Both your plant-like pricks explode inside Ifris, the purplish tips swelling up inside her to disproportionate sizes.  A moment later, the vine-dicks explode out twin pillars of ropey seed, painting her inner walls with spunk.  ", false);
                if (this.player.cumQ() >= 1000)
                    this.outputText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ", false);
                this.outputText("At the same time, both tentacle-shafts curl and piston, winding around in other in the space between your bodies, curling and thrusting to rub every inch of your sensitive, prehensile shafts against Ifris' pussy-walls.  You shake and shudder, feeling more like a tentacle beast than a " + this.player.mf("man", "woman") + ".  ", false);
            }
            //(Anemone - stinging funtimes)
            else if (this.player.anemoneCocks() >= 2) {
                this.outputText("Both your unusual, aquatic cocks explode inside Ifris, their shafts thickening as the prepare for release.  A moment later, they explode out twin pillars of alabaster cum, painting her inner walls with gooey spunk.  ", false);
                if (this.player.cumQ() >= 1000)
                    this.outputText("She groans and moans as she's filled, her body distending to deal with the unholy amount of seed your cocks can spew.  ", false);
                this.outputText("At the same time, your stinging cilia go wild, pricking her inside and out, uncontrollably forcing aphrodisiacs into your partner's shuddering, orgasmic body.  The drugs force her to climb to whole new plateaus of pleasure, making her squeal with unrepentant pleasure.  You convulse and get off even more forcefully from using your strange members in such a way.  ", false);
            }
            //(Standard)
            else {
                this.outputText("Both your cocks explode inside Ifris, submitting alabaster pillars to her request for your release.  The red-hued sexpot exhales a happy hum and rocks her hips back and forth, her oily, lubricated holes squeezing your dicks for every drop of delectable seed.  ", false);
                if (this.player.cockTotal() > 2) {
                    this.outputText("The ", false);
                    if (this.player.cockTotal() == 1)
                        this.outputText("one unbound prick remaining paints the muscular woman's lower back with goo, but she doesn't seem to mind.", false);
                    else
                        this.outputText("other, unbound pricks paint the muscular woman's lower back in goo, but she doesn't seem to mind.", false);
            ...
            if (this.player.dogCocks() >= 2)
                this.outputText("noisily pop free", false);
            else
                this.outputText("slide", false);
            this.outputText(" from her sperm-glazed snatch and anus.  Her body's warmth vanishes as she stands, and with a wink, she reattaches her bikini bottom, the tight garment moulding to her soaked camel-toe and holding in all of your leavings.  She walks away without another word, ", false);
            if (this.player.cumQ() >= 1000)
                this.outputText("her body bloated with cum and sloshing audibly with every step", false);
            else if (this.player.cumQ() >= 500)
                this.outputText("her belly bloated and gurgling with every step", false);
            else
                this.outputText("her body double-stuffed with seed", false);
            this.outputText(".  You slump back and breathe heavy, feeling like you've just run a marathon.\n\n", false);
            this.outputText("It is some time until you gain the energy to rise.", false);
            this.fatigue(10);
            //Stat changes HERE!
            if (this.player.str < 90)
                this.dynStats("str", .75);
            if (this.player.tou < 40)
                this.dynStats("tou", .5);
            this.player.orgasm();
            //Body changes here
