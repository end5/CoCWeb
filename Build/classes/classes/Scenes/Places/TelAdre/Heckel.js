define(["require", "exports", "./TelAdreAbstractContent", "../../../GlobalFlags/kFLAGS", "../../../Appearance", "../../../CockTypesEnum"], function (require, exports, TelAdreAbstractContent_1, kFLAGS_1, Appearance_1, CockTypesEnum_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Heckel extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        ...
        */
        ...
        greetHeckel() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MET_HECKEL] == 0) {
                ...
                this.outputText("When she draws up to you, she slows down long enough to have a conversation.  She smiles at you with a grin that manages to show every single fang, and you realize she caught you staring.  \"<i>Fresh meat, huh? I'm Heckel, the alpha dog around here.</i>\"  She extends a large paw toward you as she wipes her face.  You ignore the sweat as you shake hands and introduce yourself.\n\n", false);
                this.outputText("\"<i>So, " + this.player.short + ", what can I do for you?  The person working the desk can give you a tour if that's what you need... or maybe you were looking for a training partner?  If you can keep up with me, of course.</i>\"\n\n", false);
                this.flags[kFLAGS_1.kFLAGS.MET_HECKEL]++;
            }
            //Brooke + Heckel 3some
            ...
            else if (this.telAdre.brooke.brookeAffection() >= 70 && this.flags[kFLAGS_1.kFLAGS.BROOKE_MEDIUM_SCENE] > 0 && this.flags[kFLAGS_1.kFLAGS.MET_HECKEL] > 0 && this.model.time.hours >= 13 && this.model.time.hours <= 15 && (this.player.hasVagina() || this.player.cockThatFits(this.telAdre.brooke.brookeCapacity()) >= 0)) {
        ...
        heckelTraining() {
            ...
            //FOLLOWUP SECKZ
                ...
                this.outputText("You know the drill as you follow Heckel into the locker room. You watch her undress before she walks into the shower room, admiring the way her toned ass moves in counterpoint to her tail. She shoots you a fang-filled grin as she disappears around the corner, and you use the opportunity to shed your own clothes.\n\n", false);
                this.outputText("By the time she comes back into the locker room, you're completely naked. She doesn't bother to cover herself as she towels her fur off, making the coarse hair stand on end in more than a few places. She tosses the towel aside as she passes you, her black cock already bobbing between her legs. She sits down on one of the simple wooden benches and pats the spot next to her, beckoning you over.\n\n", false);
                this.outputText("\"<i>I'm not gonna mince words,</i>\" she says with a snicker. \"<i>I need a good fuck and I need it right now. I promise, this is going to be as much of a workout as hitting the track.</i>\" As you sit down next to her, she runs a paw up your back and along your neck, eventually draping it over your shoulders. \"<i>Now then partner, how are you gonna take this?</i>\"\n\n", false);
                if (this.player.str > 50 && this.player.hasCock()) {
                    this.outputText("You feel pretty strong yourself, and you realize you could probably arm wrestle this hyena-bitch down to size.");
                    dom = this.dominateHeckel;
                }
                //ORAL or LEAVE
        ...
        heckelLovesDaAnal(loss = false) {
            ...
            this.outputText("Heckel's eyes flash as her grin splits her face, and for just a moment you wonder if this might have been a bad idea. Before you can object, however, she's pushing you down onto your stomach, your arms and " + this.player.legs() + " draped over either side of the wooden bench.\n\n", false);
            this.outputText("You half expect her to just shove herself in right there, but she thankfully holds off. Instead, you feel her rough paws grab and knead either side of your " + this.buttDescript() + " as she lets out a low growl.", false);
            //[<IF TONE OVER 80>
            if (this.player.tone >= 80)
                this.outputText("  \"<i>Damn " + this.player.short + ", you've got one hell of an ass. I bet it's gonna feel even better than it looks.</i>\"", false);
            //[<IF TONE BETWEEN 60-79>
            else if (this.player.tone >= 60)
                this.outputText("  \"<i>Mmm, not bad " + this.player.short + ", not perfect, but not bad.</i>\"", false);
            this.outputText("\n\n", false);
            this.outputText("One hand releases your " + this.buttDescript() + " and you can hear the sound of her stroking herself. You start to turn your head around to watch, but she firmly presses you back down against the bench. \"<i>Now now partner, I told you to stay there. When you're the alpha dog around here, then you can make the rules.</i>\" Deciding this treatment isn't so bad anyway, you relax and let her hand continue to knead your " + this.buttDescript() + ".\n\n", false);
            this.outputText("The sound of her stroking stops, and you bite your lower lip. You feel the bench shift beneath you as she changes position, and a moment later she pulls both of your asscheeks apart to expose your " + this.assholeDescript() + ". You tense for the inevitable penetration, but instead of a hard cockhead poking at your backdoor you feel something warm and wet. Heckel is licking you!\n\n", false);
        ...
        heckelLovesAnal2() {
            ...
            this.outputText("\n\n", false);
            this.outputText("Just as the sting begins to fade, she draws herself out to the tip in one motion. You bite your lip in anticipation, but you still moan like a whore when she slams all 15 inches back into you. She draws back before pounding your " + this.assholeDescript() + " again, making your " + this.buttDescript() + " shake with the impact.\n\n", false);
            //[<IF PC HAS PENIS AND VAGOO>
            if (this.player.hasCock() && this.player.hasVagina())
                this.outputText("Although " + this.sMultiCockDesc() + " is trapped beneath you, Heckel's balls slap into your cunt with every one of her quickening thrusts.  Although neither your " + this.multiCockDescriptLight() + " or " + this.vaginaDescript(0) + " are getting much stimulation, your prostate is being milked better than it ever has. One thrust in particular makes you cry out, and Heckel laughs above you as she slams her furry thighs into yours again. \"<i>You moan like a whore, " + this.player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);
            //[<IF PC HAS PENIS AND BALLS> 
            else if (this.player.hasCock() && this.player.balls > 0)
                this.outputText(this.SMultiCockDesc() + " pulses beneath you with every thrust, her duo of fist-sized balls slapping into your " + this.ballsDescriptLight() + ". You gasp in surprise as one of her thrusts rubs against your prostate, and she barks out a single laugh above you. \"<i>You moan like a whore, " + this.player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);
            //[<IF PC HAS VAGOO>
            else if (this.player.hasVagina())
                this.outputText("Heckel's fist-sized balls slap against your ass and grind your snatch with every thrust, driving you crazy with the desperate need to be filled. You moan in anguish, pushing yourself towards her with every thrust, desperate to milk as much stimulation out of her as possible. She laughs above you, but rewards you with harder and faster thrusts. \"<i>You moan like a whore, " + this.player.short + ", a perfect bitch for me to ride.</i>\"\n\n", false);
            ...
            //[<IF PC IS FEMALE>
            if (this.player.gender == 2)
                this.outputText("  \"<i>I'm going to fuck your ass like you wish I'd fuck your cunt,</i>\"", false);
            //[<IF PC IS MALE OR HERM >
            else
                this.outputText("  \"<i>I'm going to ride your ass like you wish you could ride me,</i>\"", false);
            this.outputText(" she whispers into your ear. You can't help but shiver as she adjusts herself before resuming her pounding, drawing small gasps from you with every thrust.\n\n", false);
            this.outputText("Her thrusts become faster and shorter as she leaves more of her cock buried inside of you, jackhammering your hole with her last few inches. Something even bigger begins to press against your " + this.assholeDescript() + " as you hear her breathing become faster, her tongue lolling out of her mouth. You forgot about her knot! She doesn't let up her speed as she pushes it a little further with every thrust, and you don't want to think of how big it must be by now if it grew along with her dick size. She doesn't seem deterred however, and all you can do is grunt in pain as it pushes itself further and further.\n\n", false);
            this.outputText("Heckel suddenly freezes up and bites down on your shoulder, throwing her hips forward. Her knot pushes against your backdoor as she tries to force it in, but your ass just won't expand that much. She growls and pushes again, making you yelp as it spreads you even further. It feels like she's shoving a melon up there! She growls even louder and bites down harder, and you can feel her dick flare inside you as her knot pushes you further and further apart. You cry out as it passes the midway point, your ass sucking the knot up greedily and contracting around the other side.", false);
            //<ASS BECOMES VERY LOOSE>
            this.player.buttChange(45, true, true, false);
            this.outputText("\n\n", false);
            //[<HERM PC>
            if (this.player.gender == 3)
                this.outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your vagina hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + this.vaginaDescript(0) + " spasms and gushes over your soaked " + this.player.legs() + ", your asshole spasming around her cock just as much. Your " + this.multiCockDescriptLight() + " soon follows, shooting your own seed up between your " + this.chestDesc() + " and coating your stomach. Even as your orgasm begins to taper off, you can do little more than lie panting in a pool of your own spunk. Your legs quiver beneath hers as the warmth spreads further up your gut, leading you into a warm and hazy afterglow.\n\n", false);
            //[<MALE PC>
            else if (this.player.hasCock())
                this.outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your " + this.ballsDescriptLight() + " and cock, making it twitch at your impending orgasm. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her.  Your " + this.ballsDescriptLight() + " get tight as your trapped " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " twitches, shooting your cum up between your stomach and chest. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n", false);
            //[<FEMALE PC>
            else if (this.player.hasVagina())
                this.outputText("Heckel wastes no time before going back to her brutal fucking, though her thrusts are limited to short bursts now. She makes up for this in speed as you lie helplessly below her, the pain of taking her knot slowly turning into intense pleasure. The heat and pleasure spreads from your ass to your entire groin, and the knot pushes against the walls of your " + this.vaginaDescript() + " hard enough to make them rub against each other. Heckel cries out above you and slams her hips into you as much as she can, and you immediately feel a burning heat shooting up your gut. She pumps again as she seeds your insides with another spurt, and this time you orgasm along with her. Your " + this.vaginaDescript(0) + " spasms and gushes over your soaked thighs, your asshole spasming around her cock just as much. Your legs quiver beneath hers as the warmth spread further up your gut, leading you into a warm and hazy afterglow.\n\n", false);
            ...
            this.outputText("You lay on the bench for a few moments as Heckel ruffles your hair again. \"<i>Not bad, partner. You're the best fuck I've had in years, you know that? Not to mention the best workout!</i>\"\n\n", false);
        ...
        dominateHeckel() {
            this.clearOutput();
            this.outputText("Smirking, you fold your arms and tell her to bend over - ");
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_DOMMED_HECKEL] == 0)
                this.outputText("there's a new top dog just waiting to claim the town bitch");
            else
                this.outputText("you're back for a taste of your favorite bitch");
            this.outputText(".  Heckel snorts, \"<i>Nice try, fuck-meat, but ");
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_DOMMED_HECKEL] > 0)
                this.outputText("last time was a fluke");
            else
                this.outputText("I'm always on top");
            this.outputText(".  If you want a squealing submissive to ride, the Wet Bitch is that way,</i>\" pointing towards the exit.  Her flaccid dog-dong twitches a little but remains defiantly soft.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_LOST_HECKEL_DOM_CHALLENGE] > 0)
                this.outputText(" again");
            this.outputText("?</i>\"  Her tough finger-tip slams into your solar plexus for emphasis");
            if (this.player.tou < 60)
                this.outputText(", pushing you back a bit");
            this.outputText(".");
        ...
        dominateHeckelConclusion() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0)
                this.outputText("You grin and blush hotly, imagining the whole of the gym watching you fuck this hyena, their watchful eyes exciting you further.");
            else if (this.player.cor < 33)
                this.outputText("You blush a bit at that, uncomfortable at your sex being so public but unwilling to stop.");
            else if (this.player.cor < 66)
                this.outputText("You smirk a little at that while barely acknowledge the worry of being caught nagging at your consciousness.");
            else
                this.outputText("You grin widely at that and secretly hope that the whole gym will come in to see their 'alpha' laid low.");
            this.outputText("  Never stopping their probing motions, your fingertips dance through the hyena's sopping passageway, caressing the underswell of her virile nutsack, and occasionally brush the sensitive fur along her inner thighs.  Heckel is squirming and writhing atop the table, dominated by the mere twitches of your digits, a panting bitch in heat just begging for rough impalement on [oneCock].");
            ...
            if (this.player.cockTotal() > 2)
                this.outputText(", fanning the others across her neck and forehead, burying her in penis.");
            else if (this.player.cockTotal() == 2)
                this.outputText(", dropping your [cock smallest] alongside it over her eyes, burying her in penis.");
            else
                this.outputText(", draping her in hard penis.");
            this.outputText("  She whimpers as you rub your sensitive underside across her nose and pouting lips, looking up at you with what you imagine was supposed to be hatred.  It looks like lust instead.  Slowly stroking yourself while you diddle her, your manhood");
            if (this.player.cockTotal() > 1)
                this.outputText("s throb and thicken");
            else
                this.outputText(" throbs and thickens");
            this.outputText(" further, too turned on to stop even if you wanted to.  You command her to open with a terse word.  She does, and you slide inside.");
            ...
            if (this.player.cumQ() < 250)
                this.outputText("single drop");
            else if (this.player.cumQ() < 1000)
                this.outputText("steady drip");
            else
                this.outputText("never-ending flow");
            this.outputText(" of pre-cum onto the muscle-girl's tongue.  Her body wriggles happily in acceptance, twitching around your knuckles.  A nice, sticky puddle of her own pre has formed on her well-defined abdominals, still connected to its spigot by a web of glittering, translucent love-juice.  Whimpering, Heckel fairly hums with need, the vibrations of her hungry protests bouncing through your [cock biggest] pleasantly.");
            ...
            if (this.player.biggestCockArea() > 40)
                this.outputText("as much of it as possible");
            else
                this.outputText("it");
            this.outputText(" down her throat.  Heckel's eyes bulge in disbelief, wildly looking left and right.  Her teeth come down, just barely pricking the skin of your [cock biggest] in warning.  You twist her nipple in a retaliatory strike, opening her throat up with a moaning shriek.");
            ...
            if (this.player.balls > 0)
                this.outputText(", basting your [balls] with her steaming warmth");
            else if (this.player.hasVagina())
                this.outputText(", basting your [vagina] with her steaming warmth");
            else
                this.outputText(", basting your " + this.player.skin() + " with her steaming warmth");
            this.outputText(".  You give her a knowing smile, " + this.player.mf("man", "'woman'") + " to woman, and rock forward, sliding through her puffy labia and into her silky canal.  Those wet hyena-lips cling to every vein and rigid nook of your " + this.cockDescript(x) + ", slurping your penis down the slick tunnel with hungry undulations.");
            this.outputText("\n\nAs soon as you finish your slow glide into that wondrous passage, you drop forward over your prize to look her in the eyes, admiring the smears of cock-cream you dripped and wiped over her muzzle.  Her pouty black lips are trembling, and inspired by the exquisite sensations migrating through your " + this.cockDescript(x) + ", you kiss her, not as her lover but as her owner.  You ply her mouth with brutal, forceful kisses, raping her lips with your tongue, twining it around her own as you pillage her confused visage with a bruisingly rough french.  Her animal-like ears quickly begin to twitch, and her back arches, pressing her nipples into your [chest] as she sensually writhes beneath you.");
            ...
            this.outputText("\n\nYou pump one last time into the hole, mashing your groin into her mons with a tit-shaking thrust, and cum.  Your " + this.cockDescript(x) + " pulses powerfully, sending jet after jet of your orgasmic bliss deep into your conquest's crotch.  She mewls in ecstatic bliss as you fill her, shaking weakly, her orgasm enhanced by the cream filling.  Watching her eyes roll back slightly until they're half-hidden behind her lids only excites you further, and like a cat with a mouse, you gloat over your prize.");
            if (this.player.cumQ() > 500) {
                this.outputText("  Your potent virility does a superb job of seeding Heckel's womb, stuffing it nice and full while streamers of white escape around your girth.");
                if (this.player.cumQ() >= 1000)
                    this.outputText("  Still, you keep blasting wad after wad of spunk inside her, and her belly rounds nicely, puffed up with virile sperm.");
                if (this.player.cumQ() >= 2000)
                    this.outputText("  Your spooge is seemingly without end, pouring out endlessly long after she's spunk-gravid and nearly immobile.  The rivers that run from her abused cunt-lips quickly turn the table into a puddle.");
                if (this.player.cumQ() >= 3000) {
                    this.outputText("  That puddle then drips to the floor to make an alabaster lake");
                    if (this.player.cumQ() >= 4000) {
                        this.outputText(" at least ");
                        if (this.player.cumQ() < 10000)
                            this.outputText("a foot deep");
                        else if (this.player.cumQ() < 15000)
                            this.outputText("knee high by most measurements");
                        else if (this.player.cumQ() < 20000)
                            this.outputText("waist high");
                        else
                            this.outputText("as high as the table");
                    }
                    this.outputText(".  Thank the gods for drains.");
                }
            }
            if (this.player.cockTotal() > 1) {
                ...
                this.outputText(" as well, turning her hips and thighs into a wonderland of ivory-soaked fur.");
            }
            this.outputText("\n\nOnly once you have fully sated yourself upon the still-climaxing herm's vagina do you pull out.  Her gash gapes in the shape of your maleness as you exit, dribbling sperm and continuing to convulse anew, milking the phantom member she wishes were still inside her.  You plop your " + this.cockDescript(x) + " into her mouth, and she licks it without thought or question, cleaning the mixed love-juices from you until you shine with her glossy spit.");
            ...
            if (this.silly()) {
                this.outputText("  You grab a bacon shake from the shake-cart on your way out");
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00281] > 0)
                    this.outputText(", then give Lottie a high five");
                this.outputText(".  You really love bacon.");
            }
            this.player.orgasm();
            this.dynStats("sen", -2);
            this.doNext(this.camp.returnToCampUseOneHour);
    ...
    exports.Heckel = Heckel;
});
//# sourceMappingURL=Heckel.js.map