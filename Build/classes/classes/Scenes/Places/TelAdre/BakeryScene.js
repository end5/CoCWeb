define(["require", "exports", "./TelAdreAbstractContent", "../../../GlobalFlags/kFLAGS", "../../../GlobalFlags/kGAMECLASS", "../../../PerkLib"], function (require, exports, TelAdreAbstractContent_1, kFLAGS_1, kGAMECLASS_1, PerkLib_1) {
    ...
    class BakeryScene extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        // LAST_EASTER_YEAR: number = 823;
        //[First time approach]
        bakeryuuuuuu() {
            if (this.isEaster() && this.player.hasCock() && (this.flags[kFLAGS_1.kFLAGS.LAST_EASTER_YEAR] < this.date.fullYear || BakeryScene.rand(20) == 0)) {
                this.flags[kFLAGS_1.kFLAGS.LAST_EASTER_YEAR] = this.date.fullYear;
                this.easterBakeSale();
                return;
            }
            if (BakeryScene.rand(10) <= 1 && kGAMECLASS_1.kGAMECLASS.shouldraFollower.followerShouldra() && this.player.gender > 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00242] == 4) {
                kGAMECLASS_1.kGAMECLASS.shouldraFollower.shouldraBakeryIntro();
                return;
            }
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00243]++;
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00243] = Math.round(this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00243]);
            //Chef meetings
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00242] == 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00243] % 8 == 0) {
                this.telAdre.maddie.procMaddieOneIntro();
                return;
            }
            //Maddie Epilogue trigger!
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00242] == 3) {
            ...
            this.menu();
            //First time
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_VISITED_BAKERY] == 0) {
            ...
            //[Repeat approach]
                ...
                //Kanga christmas!
                if (kGAMECLASS_1.kGAMECLASS.nieveHoliday()) {
                    kGAMECLASS_1.kGAMECLASS.encounterKamiTheChristmasRoo();
                    if (this.flags[kFLAGS_1.kFLAGS.KAMI_ENCOUNTER] == 1)
                        this.addButton(3, "Pudding", kGAMECLASS_1.kGAMECLASS.getWinterPudding);
                }
                //Normal repeats!
                else
                    this.outputText("You step into the bakery's domed interior and inhale, treated to a symphony of pleasant smells and the cozy warmth that radiates from the baking ovens.  There are plenty of tables and chairs around for one to eat at, and you find yourself stepping into line while you glance at the menu.\n\n", false);
            }
            //Times visited!
            this.flags[kFLAGS_1.kFLAGS.TIMES_VISITED_BAKERY]++;
        ...
        checkBakeryMenu() {
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.MinotaurCumAddict) >= 0 && this.flags[kFLAGS_1.kFLAGS.MINOTAUR_CUM_ECLAIR_UNLOCKED] == 0) {
                this.flags[kFLAGS_1.kFLAGS.MINOTAUR_CUM_ECLAIR_UNLOCKED]++;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MINOTAUR_CUM_ECLAIR_UNLOCKED] > 0) {
                this.outputText("\'Special\' Eclair - 10 gems.\n", false);
                minoCum = this.createCallBackFunction2(this.nomnomnom, "eclair", 10);
            }
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00242] >= 4) {
            ...
            this.outputText("Mouse Co - 10 gems.\n");
            ...
            this.addButton(3, "Doughnuts", this.createCallBackFunction2(this.nomnomnom, "doughnuts", 5));
            this.addButton(4, "Pound Cake", this.createCallBackFunction2(this.nomnomnom, "pound cake", 4));
        ...
        talkBakeryMenu() {
            ...
            if (rubiB != undefined)
                this.addButton(1, rubiT, rubiB);
            if (kGAMECLASS_1.kGAMECLASS.nieveHoliday()) {
                if (this.flags[kFLAGS_1.kFLAGS.KAMI_ENCOUNTER] > 0) {
                    this.outputText("\nYou could 'burn off some steam' with Kami during her lunch break, since you already know how that'll end up!\n");
                    this.addButton(2, "Kami", kGAMECLASS_1.kGAMECLASS.approachKamiTheChristmasRoo);
                }
                else {
                    this.outputText("\nYou could summon the curvaceous kangaroo waitress you ran into earlier - perhaps you can win her over.\n");
                    this.addButton(2, "Kangaroo", kGAMECLASS_1.kGAMECLASS.approachKamiTheChristmasRoo);
                }
            }
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MET_FROSTY] != 0)
                this.addButton(3, "Frosty", kGAMECLASS_1.kGAMECLASS.telAdre.frosty.approachFrosty);
            else
                this.addButton(3, "PinkGirl", kGAMECLASS_1.kGAMECLASS.telAdre.frosty.approachFrosty);
            this.addButton(9, "Leave", this.bakeryuuuuuu);
        }
        nomnomnom(name, price) {
            this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_NAME] = name;
            this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_PRICE] = price;
            this.outputText("", true);
            if (this.player.gems < this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_PRICE]) {
            ...
            this.player.gems -= this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_PRICE];
            this.statScreenRefresh();
            if (this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_NAME] == "eclair") {
                this.outputText("You hand over 10 gems and ask for the 'special eclair'.  The centaur working the counter smirks ", false);
                ...
                if (this.player.femininity >= 75)
                    this.outputText("males fill their pants", false);
                else if (this.player.femininity <= 25)
                    this.outputText("females squirm", false);
                else
                    this.outputText("other patrons squirm and fill out their pants", false);
                ...
                this.outputText("You hand over " + BakeryScene.num2Text(this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_PRICE]) + " gems and get your " + this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_NAME] + ".  A moment later you're at a table, licking the sugary residue from your fingertips and wondering just how they make the food so damned good.", false);
                if (this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_NAME] == "doughnuts") {
                    this.outputText(this.player.modTone(0, 2), false);
                    this.outputText(this.player.modThickness(100, 1), false);
                    if (BakeryScene.rand(3) == 0 && this.player.buttRating < 15) {
                        this.outputText("\n\nWhen you stand back up your " + this.buttDescript() + " jiggles a little bit more than you'd expect.", false);
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_NAME] == "cookies") {
                    this.outputText(this.player.modTone(0, 1), false);
                    this.outputText(this.player.modThickness(100, 2), false);
                    if (BakeryScene.rand(3) == 0 && this.player.hipRating < 20) {
                        this.outputText("\n\nAfter finishing, you find your gait has changed.  Did your hips widen?", false);
                        this.player.hipRating++;
                    }
                }
                else if (this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_NAME] == "brownies") {
                    this.outputText(this.player.modThickness(100, 4), false);
                    if (BakeryScene.rand(2) == 0 && this.player.hipRating < 30) {
                        this.outputText("\n\nAfter finishing, you find your gait has changed.  Your " + this.hipDescript() + " definitely got wider.", false);
                        this.player.hipRating += 2;
                    }
                }
                else if (this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_NAME] == "cupcakes") {
                    this.outputText(this.player.modTone(0, 4), false);
                    if (BakeryScene.rand(2) == 0 && this.player.buttRating < 30) {
                        this.outputText("\n\nWhen you stand back up your " + this.buttDescript() + " jiggles with a good bit of extra weight.", false);
                        this.player.buttRating += 2;
                    }
                }
                else if (this.flags[kFLAGS_1.kFLAGS.TEMP_STORAGE_PASTRY_NAME] == "pound cake") {
                    this.outputText(this.player.modTone(0, 2), false);
                    this.outputText(this.player.modThickness(100, 2), false);
                    ...
                    if (BakeryScene.rand(3) == 0 && this.player.hipRating < 25) {
                        this.outputText("\n\nAfter finishing, you find your gait has changed.  Did your " + this.hipDescript() + " widen?", false);
                        this.player.hipRating++;
                    }
                }
            }
        ...
        easterBakeSale() {
            ...
            if (this.telAdre.rubi.rubiAffection() >= 40)
                this.outputText("An extremely busy Rubi can only manage a wave in your direction before going back to attending customers.  ");
        ...
        easterBakeSaleHelp() {
            ...
            if (this.player.gender == 1)
                this.outputText("[eachCock] jumps to full hardness.");
            //(if the pc is female)
            else if (this.player.hasVagina())
                this.outputText("your nipples stiffening noticeably, while your [vagina] prepares for what's to come.");
            //(if the pc is a herm)
            else
                this.outputText("[eachCock jumping to full hardness, your nipples and [vagina] not far behind in getting ready for your encounter.");
        ...
        //[Male]
        malesHelpOutWithEaster() {
            this.clearOutput();
            this.outputText("A idea crosses your mind; why not have the molten girl help you with your problem?  As if reading your mind, the girl continues her way to you, making her way with her eyes locked on your [cock biggest].  She is upon you now, flaccid streams drooling off her hand as she makes to grab your cock.  A heated pressure envelopes your shaft");
            if (this.player.balls > 0)
                this.outputText(", sticky drops of chocolate trailing down your [balls]");
            ...
            //[SILLYMODE]
            if (this.silly())
                this.outputText("You regret not bringing your umbrella for this Chocolate Rain, so that you could be like those that stay dry rather than those who feel the pain.  ");
            ...
            //(large cum vol)
                ...
                this.outputText("Your cock spews out a significant amount of seed, filling your partners deepness quickly while a small volume shoots out with some force.  You are happy to see that she seems to have gained a little weight from your baby-batter.");
            //(very large cum vol)
            else if (this.player.cumQ() < 5000)
                this.outputText("Your cock spews into your partner's deepness, filling it almost instantly while a significant volume splatters out.  You are happy to see she seems to have gained a little weight from your baby-batter.");
            else
                this.outputText("Your cock opens like a river, streaming into your partner with such force that her belly distends.  A spew begins to erupt from her vagina, empting the significant amount she could not take on to the floor.  You are happy to see she has gained some weight from your baby-batter.");
    ...
    exports.BakeryScene = BakeryScene;
});
//# sourceMappingURL=BakeryScene.js.map