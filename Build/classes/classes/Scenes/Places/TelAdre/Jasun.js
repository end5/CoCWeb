define(["require", "exports", "./TelAdreAbstractContent", "../../../GlobalFlags/kFLAGS"], function (require, exports, TelAdreAbstractContent_1, kFLAGS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Jasun extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        ...
        meetJasun() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00179] == 0) {
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00179]++;
            ...
            //Met Jasun but not boned!
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00179] > 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00180] == 0) {
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00181] == 0) {
                    this.outputText("While you look around the changing room, one of the gym's other patron asks you if you're looking for Jasun.  Seeing your confusion, they describe the hunky shark guy you met before.  You nod and smile, happy to have learned his name.\n\n", false);
                    this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00181]++;
                }
                //If you're a dude.
                if (this.player.gender <= 1) {
                ...
                if (this.player.tone < 75 || this.player.armorName != "slutty swimwear") {
                    this.outputText("Jasun walks out of a stall, his thick and muscular figure still as glorious as the last time you set eyes upon it. As he turns to greet you, though, you notice that his smirk suddenly turns around to a sense of shock. He's noticed that you're not quite the same as you were before, and you know it. He pauses a moment before turning back toward the mirror and addressing you without eye contact.\n\n", false);
                    this.outputText("\"<i>" + this.player.short + ", you know, I still don't think you're quite ready to swim with me. That's fine, and it's entirely up to you, but I think today I should probably swim alone. You can come and visit me anytime, of course, maybe when you're ", false);
                    if (this.player.tone < 75)
                        this.outputText("fit enough", false);
                    else if (this.player.armorName != "slutty swimwear")
                        this.outputText("properly attired", false);
                    else
                        this.outputText("a little more compatible with me", false);
        ...
        meetJasun2() {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00181] = 1;
            //[Accept] [Turn Away]
