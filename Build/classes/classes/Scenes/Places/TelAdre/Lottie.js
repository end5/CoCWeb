define(["require", "exports", "./TelAdreAbstractContent", "../../../StatusAffects", "../../../GlobalFlags/kFLAGS", "../../../CockTypesEnum", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, TelAdreAbstractContent_1, StatusAffects_1, kFLAGS_1, CockTypesEnum_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Lottie extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        //spriteSelect(36);
        //9999 - PUT IN SPRITES
        //FLAGS
        ...
        lottieAppearance(display = true) {
            ...
            if (this.model.time.hours >= 15 && this.model.time.hours <= 23) {
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00281] == 0) {
                    if (display)
                    ...
                    if (display) {
                        //[RANDOM INTROS]
                        //[Encouragement 0 – 30]
                        if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] < 30 && Lottie.rand(6) == 0) {
                        ...
                        //[Encouragement 0 – 30]
                        else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] < 30 && Lottie.rand(5) == 0) {
                            ...
                            if (this.silly())
                                this.outputText("  What can you say? Her pork buns are the best.", false);
                        }
                        //[REPEAT INTROS]
                        else if (Lottie.rand(2) == 0) {
                            ...
                            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 33)
                                this.outputText("voluptuous", false);
                            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 66)
                                this.outputText("plump", false);
                            else
                                this.outputText("curvy", false);
                            this.outputText(" pig girl jogs on the spot to wake herself up - unintentionally jiggling her " + this.lottieCup() + "-cup breasts and soft ass in the process. She walks over to the nearby cafe and sits down on her ", false);
                            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 33)
        ...
        lottieCup() {
            //(d/e/f/g)
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] >= 75)
                return "D";
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] >= 50)
                return "E";
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] >= 25)
                return "F";
            else
                return "G";
        }
        encounterLottieCharge() { this.encounterLottie(true); }
        encounterLottie(charge = false) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00310] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00311] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00312] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00313] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00314] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00315] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00316] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00317] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00318] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00319] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00320] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00298] > 0 && this.player.lust >= 33)
                sex = this.lottieFuck;
            this.clearOutput();
            this.outputText(this.images.showImage("lottie-encounter"));
            if (charge) {
                if (this.flags[kFLAGS_1.kFLAGS.LIFETIME_GYM_MEMBER] == 0) {
                    this.outputText("The centauress working the door walks up to collect her fee, and you drop 10 gems for an hour at the gym into her hand.\n\n", false);
                    this.player.gems -= 10;
                    this.statScreenRefresh();
                }
            }
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00281]++;
            //[INITIAL ENCOUNTER]
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00281] == 1) {
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] = 50;
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] = 50;
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00300] = 50;
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00308] = 50;
                this.outputText("You approach the pig girl as she tightly wraps a towel around herself, accentuating her plump figure. Eyes darting around and searching for anyone that may have been watching, the girl spots you walking toward her and squeals, clearly embarrassed by her body in front of someone as fit as yourself.  Quickly moving her attention elsewhere, the flustered lady starts walking briskly in the opposite direction only to end up face to face with a wall. She turns around and walks toward you, her cheeks noticeably redder than before.\n\n", false);
                this.outputText("\"<i>Ah! Hello, I didn't quite see you there! Ohoho!</i>\" She blurts out as she awkwardly stretches out her arm for what appears to be a handshake. You mentally congratulate her less-than-subtle attempt to bury the past few seconds into the ground and return the gesture, much to her relief. You're certain she would've died of embarrassment if you hadn't. She sighs deeply and meets your gaze with a smile. You deduce that it's more than likely her first time here, hence the nervousness.  \"<i>I guess you've caught me in the act, huh? I've tried losing weight for years, but I've always lost the motivation.</i>\" The girl explains. \"<i>You know what they say – the first few steps are always the hardest.</i>\"  You nod in agreement as you both walk out of the pool area.\n\n", false);
                this.outputText("The pig girl begins to ramble on about her past attempts at dropping pounds, from eating strange pills to eating primarily eggs - most of them involved eating. You ask if she's ever exercised before. She looks visibly hurt at the sudden inquiry, but continues to talk. \"<i>To tell you the truth, I've never actually gone to a gym - I'd always stop at the front. I used to get away with eating what I liked because of my fast metabolism, but now it's caught up with me. I'm pretty porky now!</i>\"  She chuckles at her own joke, though obviously saddened by the realisation. You tell her she still looks great, for what it's worth.\n\n", false);
            ...
            //[REPEAT ENCOUNTER]
                ...
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] >= 50)
                    this.outputText("relaxing", false);
                else
                    this.outputText("sitting timidly", false);
                this.outputText(" at a table, wearing her low-cut top and booty shorts that accentuate her ", false);
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 50)
                    this.outputText("plump", false);
                else
                    this.outputText("curvy", false);
                this.outputText(" figure.  ", false);
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00297] == 0)
                    this.outputText("Lightly sipping", false);
                else
                    this.outputText("Slurping down", false);
                this.outputText(" what appears to be ", false);
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00297] == 0)
                    this.outputText("some juice", false);
                else
                    this.outputText("a milkshake", false);
                this.outputText(", her eyes wander over the room when she spots you and waves", false);
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] >= 70)
                    this.outputText(" excitedly", false);
                this.outputText(".  You walk over to her and sit down, listening to Lottie update you on her progress.\n\n", false);
                //[Repeat If didn't meet requirements]
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00299] == 0 && (this.player.isNaga() || this.player.isTaur() || this.player.tone < 50)) {
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00299] == 0) {
                    this.outputText("\"<i>Hey, " + this.player.short + "! I was just... I...</i>\"Lottie seems to be at a loss of words, gaping at your new, chiselled physique. You smile and tell her how glad you are that she's doing this, thought it's a shame she hasn't found a personal trainer yet. Lottie responds with a hazy expression and an open mouth. \"<i>Y-yeah... it's a shame...</i>\" She begins, until snapping out of her daze and looking up excitedly at you. \"<i>I- Y'know, I don't know what you've been doing to yourself lately, but... you look a... you're really amazing right now, " + this.player.mf("big guy", "babe") + "!</i>\" She squeals as you flex at her, giggling at your blatant attempts at showing off. You never really took her as one to appreciate muscles, but you figure her obsession towards the perfect body might extend to other people as well. You take one stern look at the chubby porcine in front of you and grin, asking if she wants you to be her personal trainer. She seems shocked at your proposal. </i>\"Are... are you serious?</i>\"\n\n", false);
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00281] == 2 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00298] > 0) {
                    this.outputText("\"<i>Hey, " + this.player.short + "! I...I really enjoyed what we did. God, if that's what it takes to get healthy I wouldn't mind! I think I'm falling in love with you already, haha!</i>\" She forces a giggle at her last sentence, albeit rather nervously. You raise an eyebrow, but decide not to push the issue further.", false);
                }
                //[Second Encounter, If didn't fuck Lottie]
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00281] == 2) {
                    this.outputText("\"<i>Hey, " + this.player.short + "! I...I'm really glad we're doing this, y'know? I really think I can achieve something this time, if I work hard – and if you work hard with me!</i>\" You smile and tell her how glad you are that she's doing this. Lottie responds with a delighted expression as you both return to normal conversation.", false);
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00281] == 4 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00298] == 0) {
                ...
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00301] == 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00300] > 30 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] <= 30) {
                    this.outputText("\"<i>Hey, " + this.player.short + ", I... I really don't know w-what's gotten into you lately. Please, please stop being so m-mean, ba- I mean, " + this.player.mf("sir", "ma'am") + ". P-please don't be like this.</i>\" She forces a smile at her last sentence, though you can tell she's incredibly nervous. You raise an eyebrow, but decide not to push the issue further.", false);
                    this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00301] = 1;
                    this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00300] = this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280];
                }
                //[Encouragement moved from 31 to 30, regular]
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00301] > 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00300] > 30 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] <= 30) {
                    this.outputText("\"<i>H-hi " + this.player.short + "... I noticed that you're... y-you're acting like you do when I do something wrong. Did I do something? P-please, I really don't like seeing you so m-mean. Please don't be like this.</i>\" She forces a smile at her last sentence, though you can tell she's incredibly nervous. You raise an eyebrow, but decide not to push the issue further.", false);
                    this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00300] = this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280];
                }
                //[Encouragement moved from 30 to 31
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00300] <= 30 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] > 30) {
                    this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00300] = this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280];
                    //first time
                    if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00302] == 0) {
                        this.outputText("\"<i>H-hiya, " + this.player.short + "! I'm... I'm really glad you're being nice again. To be honest, when you're angry, it – I get really scared, y'know? But I'm glad even if we're just like this.</i>\" She throws you a genuine smile, she's confident that you won't mistreat her again. You smile back, silently assuring her that you won't, today.", false);
                        this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00302] = 1;
                    }
                ...
                //[Encouragement moved from 79 to 80, first time]
                    ...
                    this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00300] = this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280];
                    //, first time]
                    if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00304] == 0) {
                        this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00304] = 1;
                        this.outputText("Lottie seems a lot more nervous than usual, curling her hair around her finger and fidgeting with the cup of tea in her hand. \"<i>H-hi... hi " + this.player.short + ".</i>\" she squeaks, unable to form sentences under the immense amount of pressure she's put herself under. You place your hand on hers to relieve her own stress, but this seems to make her more nervous. \"<i>Oh! I... gosh, " + this.player.short + ", I don't know what to say!</i>\" Lottie shakes her head several times, muttering a 'pull yourself together, Charlotte!' before starting again. \"<i>I like you! I really, really like you, " + this.player.short + "!</i>\" She squeals at the top of her lungs, jumping up in excitement before immediately clapping her hands over her mouth at the realisation that she's caught the attention of the entire cafe. You silently walk over to her, placing her hands back down before pulling her into a warm embrace. \"<i>I... I...</i>\" Looking down, you brush the hair out of her eyes and place a small kiss on her forehead, calming her down considerably. \"<i>Do you like me too?</i>\" She asks. You smile, and hug her tighter than before, the scent of black cherries and roses lingering in the air. Her voice rings through your head while you embrace the girl.  Do you like me too?\n\n", false);
                        this.outputText("You don't know the answer.", false);
                    }
                    //[Encouragement moved from 79 to 80, regular]
                    else {
                        this.outputText("\"<i>Hey, " + this.player.short + ".Thanks for being... nicer, again. Sometimes I really worry about you, but... well; I'm fine with putting that behind us. I'm glad, y'know?</i>\" She throws you a smile, confident that you won't mistreat her again. You smile back, silently assuring her that you won't, today.", false);
                    }
                }
                //[Normal Encounter, Encouragement 60 - 100]
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] >= 60) {
                    //[Figure 0 – 20]
                    if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 20 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00297] == 0)
                        this.outputText("\"<i>Oh, " + this.player.short + "! Let's do our best today, I really wanna lose those pounds! I know I can do my best when I'm with you!</i>\" Lottie beams, her massive tits pushed against the table. She seems to be excited for what you've got in store today.", false);
                    //[Figure 0 - 20, convinced her to accept body]
                    else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 20)
                        this.outputText("\"<i>Hey, " + this.player.mf("stud", "cutie") + "! You shouldn't keep a big girl like me waiting; unless you wanna get crushed by these!</i>\" Lottie grins and grabs her luscious breasts firmly, giggling when she notices you're at full attention now. She seems to be excited for what you've got in store today.", false);
                    //Figure 20 - 40, haven't convinced her to accept body]
                    else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 40 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00297] == 0)
                        this.outputText("\"<i>Ah, " + this.player.short + "! We should probably get started soon; I'm gonna push myself to the limit today!</i>\" Lottie's arms are folded over her chest, subconsciously trying to hide her nervousness, though squishing her pillowy tits in the process. She seems to be excited for what you've got in store today.", false);
                    //[Figure 20 - 40, convinced her to accept body]
                    else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 40)
                        this.outputText("\"<i>Hey, " + this.player.mf("stud", "cutie") + "! You shouldn't keep me waiting; the only thing I'm losing right now is my patience!</i>\" Lottie grins and punches your arm playfully, squealing when you try to get her back. She seems to be excited for what you've got in store today.", false);
                    //[Figure 40 - 60]
                    else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 60)
                        this.outputText("\"<i>Hey! I was looking for you earlier, y'know? I can't wait to get started.</i>\" She looks happy that you've arrived. Lottie leans over to grab her beverage, giving you an excellent view of her supple mounds. She seems to be excited for what you've got in store today.", false);
                    //[Figure 60 - 80]
                    else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 80)
                        this.outputText("\"<i>Yo, " + this.player.mf("big guy", "babe") + "! I've been waiting for you, so you better be pumped! Ready to get started?</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.", false);
                    //[Figure 80 - 100]
                    else
                        this.outputText("\"<i>Hey, " + this.player.mf("stud", "cutie") + "! You shouldn't keep me waiting, or I'll put you through the burn twice as hard! You ready?</i>\" Lottie winks at you and punches your arm playfully. She seems to be excited for what you've got in store today.", false);
                }
                //[Normal Encounter, Encouragement 30 - 60]
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] >= 30) {
                    //[Figure 0 - 20]
                    if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 20)
                        this.outputText("\"<i>Oh, " + this.player.short + ", hey. I think we should try and get into it today. I don't think I tried hard enough last time, y'know?</i>\" Lottie leans over to grab her beverage, her massive tits pushed against the table. She seems to be intent on trying her best today.", false);
                    //[Figure 20 - 40]
                    else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 40)
                        this.outputText("\"<i>A-ah, " + this.player.short + "! We should probably get started soon; I... I want to push myself to the limit today!</i>\" Lottie's arms are folded over her chest, subconsciously trying to hide her nervousness, though squishing her pillowy tits in the process. She seems curious as to what you both plan to do today.", false);
                    //[Figure 40 - 60]
                    else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 60)
                        this.outputText("\"<i>H-hey! I was looking for you earlier, y'know? I can't wait to get started.</i>\" She looks at ease now that you've arrived. Lottie leans over to grab her beverage, giving you an excellent view of her supple mounds. She seems curious as to what you both plan to do today.", false);
                    //[Figure 60 - 80]
                    else
                        this.outputText("\"<i>Hello " + this.player.short + "! I've... I've been waiting for you, so you better be ready, hey! Don't hold back!</i>\" Lottie leans over, her creamy tits pushed against the table. She seems to be excited for what you've got in store today.", false);
                }
                //[Normal Encounter, Encouragement 0 - 30]
                else {
                    //[Normal Encounter, Figure 0 – 70]
                    if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] <= 70)
                        this.outputText("\"<i>Oh, " + this.player.short + "... I know I haven't been trying the way you want me to. I – I punished myself extra hard last night! Please, let me try again today!</i>\" Lottie leans over and looks at you desperately, her creamy tits pushed against the table. You can see they're redder than before. Has she been trying to slap her fat away? You turn away, not giving her the pleasure of looking at your face. You agree to help her – but don't expect to be looked at by the only person who can stand you if this goes on. Lottie squeals and manages to blurt out a 'th-thank you!' in response.", false);
                    //[Normal Encounter, Figure 70 - 100]
                    else
                        this.outputText("\"<i>" + this.player.short + "! I know you don't like looking at me, but I... I lost some more weight for you today!</i>\" Lottie removes her top and exposes her curvaceous body, plump tits in full view. You stare her down, and she smiles weakly, grateful for your patience. She waits for your response, but you turn away and tell her to cover up her disgusting body. \"<i>But I – oh god, I'm sorry, I'm so sorry, I'll try extra hard today, I'll try so so hard...</i>\" She babbles on while you go to the counter and order some food for yourself.", false);
                }
            }
            //[Appearance][Talk][Exercise][Give Item][Sex][Hug]
            this.choices("Appearance", this.lotteryAppearance, "Talk", this.talkToPigSlut, "Exercise", this.lottieExercise, "Give Item", item, "Sex", sex, "Hug", hug, "", undefined, "", undefined, "", undefined, "Leave", this.telAdre.gymDesc);
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00300] = this.lottieMorale();
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00308] == 0)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00308] = this.lottieTone();
        }
        //[Sex]
        fourthMeetingChooseSexWithLottie() {
            this.spriteSelect(36);
            this.outputText("", true);
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00298]++;
            var x = this.player.cockThatFits(40);
            if (x < 0)
                x = 0;
            this.outputText("You tell her that you're fine with the idea, as long as she's willing to follow your lead. \"<i>W-wow, you really wanna... and with me? Okay, sure, lemme just uh, hang on...</i>\" She fumbles with her clothing, clearly trying to get undressed in public before you decide to stop her – there are far better places for this. Taking her by the hand, you lead her into one of the empty saunas, your erection stirring in your pants as you grow more and more eager to take her. \"<i>" + this.player.short + "... I'm – I really don't know where to start, h-hey.</i>\" She throws an uneasy glance at you, her intent for you to take the lead apparent in her heavy breathing and wanting eyes. Not one to disappoint, you grab her by the hips and lean her against the wall, ripping off her clothes and revealing her velvety skin underneath. Reaching down, you grab a handful of her luxurious ass, squeezing and slapping it lightly. Lottie moans into your shoulder and reaches towards your groin, removing your " + this.player.armorName + ". She begins stroking your " + this.cockDescript(x) + " lightly, picking up the pace as you continue to work on her pert rump. You can't help but lust over her full figure, using one of your hands to firmly grope her pillowy jugs and reaching your other towards her glistening pussy. You move your hand over her cushiony rack before burying your head into her bosom and eagerly sucking on one of her nipples, fondling the other between your thumb and forefinger. Your other hand is already fast at work, fingering her hot cunt. You can feel her legs about to buckle beneath their own weight. Lottie moans in between short, hot breaths, \"<i>Y-you're... really amazing, " + this.player.mf("guy", "lady") + ".</i>\" You give her chubby ass a hard slap in agreement.  Lottie squeals with  glee, jerking your " + this.cockDescript(x) + " as it pokes into her soft stomach. The sensation of your tip rubbing against her velvety skin drives you wild.\n\n", false);
        ...
        declineBeingLottiesGymHamsandwich() {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00278] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[If Accept]
        ...
        gotInShapeAcceptTrainingOffer() {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00299] = 1;
            this.outputText("", true);
            this.outputText("\"<i>A-ah, really? Y'mean it? This isn't some trick or something, right? You ain't about to go ahead and flake out on me, are you?</i>\" You assure her you're serious if she is, though you make a mental note that she's more likely to flake out than you are, given her history. \"<i>Eeee! Thanks, " + this.player.mf("big guy", "babe") + " – I can't wait to get started!</i>\" You chuckle, remarking on her enthusiasm. \"<i>Well " + this.player.short + ", I'm excited because I think the two of us are about to become super close! Do you feel it? Do ya?</i>\" Lottie wiggles in excitement, loosening the already skimpy towel and revealing one of her perky nipples. You definitely feel something, that's for sure. She follows your eyes down to her breasts and reddens as she quickly covers herself up as best as she can - only succeeding in making her pillowy breasts push up against the towel, increasing her cleavage.\n\n", false);
            this.outputText("You take this opportunity to get a good look at Lottie. She stands at around 4'8</i>\", considerably short on average, ", false);
            if (this.player.tallness > 60)
                this.outputText("and shorter than you", false);
            else if (this.player.tallness > 53)
                this.outputText("but you can't judge, being roughly the same height", false);
        ...
        analLottieMilkshake() {
            ...
            if (x < 0)
                x = 0;
            this.outputText("You brush her grip off of " + this.oMultiCockDesc() + ", only to turn her around and fit your girth between her large cheeks", false);
            ...
            if (this.player.cockTotal() > 1) {
                ...
                if (this.player.cockTotal() == 2)
                    ...
                    this.outputText("one of your cocks", false);
                this.outputText(" and push it against her puckered hole. \"<i>H-hey, wait a mome- OHH!</i>\" You ease yourself back into her, with ", false);
                if (this.player.cockTotal() == 2)
                    this.outputText("your two ", false);
                else
                    this.outputText("two of your ", false);
                this.outputText(" throbbing cocks buried deep in her rectum. The pressure against your hot rods is immense, though you continue to slowly push and pull her sweaty ass against you, enjoying the feeling of her meaty fuckpillows as they massage your cock", false);
                if (this.player.cockTotal() > 1)
            ...
            if (this.player.balls > 0)
                ...
                this.outputText("You feel yourself about to explode", false);
            this.outputText(" with the large amount of cum you've prepared to paint her inner walls with.  Your unrelenting fucking picks up the pace as you feel yourself coming to a climax.  Lottie's soft flesh starts to quiver, signaling her second orgasm.  You lift Lottie's plump body up straight and against yours as you groan loudly and thrust hard, the noisy broad ", false);
            if (this.player.cumQ() >= 1000)
                this.outputText("overflowing", false);
            else if (this.player.cumQ() >= 500)
                this.outputText("dripping", false);
            else
                this.outputText("filled", false);
            this.outputText(" with your hot, thick spunk. She squeals again as you bring her to orgasm, ramming herself into you to collect as much of your cum as possible. You continue to pound her bouncy buttocks as you release the rest of your seed inside of her", false);
            //[If large cum production]
            if (this.player.cumQ() >= 500)
                this.outputText(", a heavy amount leaking from her ass", false);
            this.outputText(".  Pulling yourself free, you wipe yourself against her plush butt and give it one final slap before walking out of the sauna.  \"<i>I-I'll see you again, hey?</i>\" Lottie asks, collapsed onto the floor in a mess of sweat and drool. You give her a thumbs up before turning around and heading out of the gym, making sure to grab a ", false);
            if (this.silly())
                this.outputText("bacon ", false);
            this.outputText("shake on the way out.", false);
            //LOTTIE FIGURE +1, MUSCLE TONE +1, DRAINS PC'S LUST.
            this.lottieTone(1);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00307] == 0)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00307] = 1;
        ...
        getSuckedOffByAHamSandwich() {
            ...
            this.outputText("You grab Lottie's shoulders and firmly move her down towards your crotch. She kneels down, face to face with your " + this.cockDescript(x) + ".  Feeling her hot breath against your " + this.player.skinFurScales() + ", you tell her to suck it.\n\n", false);
            //[If player cock is at or below 4']
            if (this.player.cocks[x].cockLength <= 4) {
                this.outputText("She stares at your " + this.cockDescript(x) + " and then up at you. \"<i>I... oh, well I guess this is okay.</i>\" She lazily slurps your member into her mouth, and moans at the taste of your " + this.cockDescript(x) + ". Her agile tongue moves over your entire length, licking gently over your sensitive head and along your shaft. Your " + this.cockDescript(x) + " sits comfortably inside her warm hole, covered in her saliva", false);
                if (this.player.cockTotal() > 1) {
                    this.outputText(" while your other cock", false);
                    if (this.player.cockTotal() == 2)
                        this.outputText(" pokes", false);
                    else
                        this.outputText("s poke", false);
                    this.outputText(" against her chin", false);
                }
                this.outputText(".\n\n", false);
            }
            //[If the player has a cock between 5' – 12']
            else if (this.player.cocks[x].cockLength <= 12) {
                this.outputText("She stares intently at your " + this.cockDescript(x) + " with hunger in her eyes. A small amount of drool escapes her luscious lips as she moves forward, kissing your ", false);
                if (this.player.cockTotal() > 1)
                    this.outputText(" biggest head lightly", false);
                else
                    this.outputText(" head lightly", false);
                this.outputText(".  Her saliva leaks onto your " + this.cockDescript(x) + ", though she is quick to lick it up while she works her tongue around the rest of your shaft", false);
                if (this.player.cockTotal() > 1)
                    this.outputText(", jerking off your " + this.cockDescript(this.player.biggestCockIndex2()) + " with both hands", false);
                this.outputText(".  She places small licks on the tip of your head, and then hungrily devours the rest of your length in one fell swoop.\n\n", false);
            }
            //[If the player has a cock equal to or over 13']
            else {
                this.outputText("She gasps as you lift your " + this.cockDescript(x) + " and slap her face. \"<i>It's... wow, " + this.player.short + "!</i>\" You grin before poking her pudgy cheek with the tip of your ", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("biggest erection", false);
                else
                    this.outputText("erection", false);
                this.outputText(".  A small amount of drool escapes her luscious lips as she moves forward, kissing your head lightly. Her saliva leaks onto your " + this.cockDescript(x) + ", though she is quick to lick it up while she works her tongue around the rest of your lengthy shaft", false);
                if (this.player.cockTotal() > 1)
                    this.outputText(" - using her hands to massage your leftover " + this.cockDescript(this.player.biggestCockIndex2()), false);
                this.outputText(". She places small licks on the tip of your head, and without warning stuffs as much of your thick girth as she can into her mouth, coughing around your " + this.cockDescript(x) + ".\n\n", false);
            }
            this.outputText("She begins fellating your cock at an incredible rate, throatfucking herself on your " + this.cockDescript(x), false);
            if (this.player.balls > 0)
                this.outputText(", your sack slapping against her chin ", false);
            else if (this.player.biggestTitSize() > 2)
                this.outputText(" while you play with your " + this.biggestBreastSizeDescript(), false);
            this.outputText(". You remark on what a hungry little piggy she must be, and the chubby girl moans in response, the vibrations massaging your member. Relishing the feeling of your " + this.cockDescript(x) + " in between her hungry lips, you start to thrust into her warm mouth hole, grabbing onto her head as you pound her face against your groin.", false);
            if (this.player.cockTotal() > 1) {
                if (this.player.cockTotal() == 2)
                    this.outputText("  Your extra cock flails wildly, slapping against her cheeks.", false);
                else if (this.player.cockTotal() > 2)
                    this.outputText("  Your extra cocks flail wildly, slapping against her cheeks.", false);
            }
            this.outputText("  Lottie's slick tongue desperately wraps itself around your length as you drive in and out of her fuckhole relentlessly, drool beginning to leak from her mouth. She", false);
            //[if Multi]
            if (this.player.cockTotal() > 1)
                this.outputText(" stops rubbing your " + this.cockDescript(x) + " to ", false);
            //(Otherwise)
            else
                this.outputText(" reaches down towards her dripping pussy; plunging two fingers into her wetness while using the other hand to ", false);
            //If Balls]
            if (this.player.balls > 0)
                this.outputText("knead your " + this.ballsDescriptLight(), false);
            else
                this.outputText("reach around and squeeze your " + this.buttDescript(), false);
            this.outputText(".  You grab the back of her head and pull her in further, bobbing her head while she slurps and sucks at your meatstick. The stimulation almost causes you to explode right then and there, but her bouncing tits give you an idea.\n\n", false);
            this.outputText("You slowly take your " + this.cockDescript(x) + " out of her hot mouth, a small *pop* breaking the silence as it escapes her plump, puckered lips. Grabbing one of her hefty tits in your hands, you rub your cockhead against her erect nipple, eliciting a small moan from the sweaty slut. You slap your " + this.cockDescript(x) + " against her sweaty chest a few times before burying it in between her cleavage, ", false);
            //[If the player has a cock equal to or over 13']
            if (this.player.cocks[x].cockLength > 12)
                this.outputText("your sensitive tip brushing against her eager mouth", false);
            //Otherwise]
            else
                this.outputText("resting comfortably in between her cushiony fuckpillows", false);
            this.outputText(". Lottie wraps her tits around your length and begins working at pleasuring your every inch.\n\n", false);
            //[If the player has a cock equal to or over 13']
            if (this.player.cocks[x].cockLength > 12)
                this.outputText("Licking at your cockhead, Lottie squishes her breasts against the rest of your member, making sure to lap up the stray beads of pre-cum squirting from your tip. Relishing the taste of your " + this.cockDescript(x) + " in her mouth she begins to suck at your head, flicking her tongue around your urethra and pressing her full lips against it, creating a vacuum of pleasure around your manhood.\n\n", false);
            //[If Multi]
            if (this.player.cockTotal() > 1) {
                ...
                if (this.player.cockTotal() == 2)
                    ...
                    this.outputText("an", false);
                this.outputText(" extra cock as you push it between her pouty lips, her face brushing against it while she tries to titfuck your main member. Looking up at you, Lottie descends on you and begins fellating your " + this.cockDescript(this.player.biggestCockIndex2()) + ", not forgetting to knead her fat tits into your " + this.cockDescript(x) + ".\n\n", false);
            }
            this.outputText("Raising her body up and down, you watch as the pig-slut massages her rack tightly around your rod whilst you plunge between her cleavage, thrusting slightly to match her movements. \"<i>" + this.player.short + ", p-please cum on me, god- I need this!</i>\" she moans, her saliva lubing her chest while she pumps your dick in between her melons", false);
            if (this.player.cockTotal() > 1)
                this.outputText(" and chokes on your meat", false);
            this.outputText(".  You throb against her hot flesh, feeling your spunk bubbling up inside you.  Throwing your head back, you give one final thrust before pulling back and exploding all over your squishy slut, ", false);
            if (this.player.cumQ() < 500)
                this.outputText("thick ropes of cum splattering all over her face and pooling in between her tits", false);
            else
                this.outputText("massive globules of cum splattering all over her face and painting her tits", false);
            this.outputText(".  She continues to move up and down against the thick shaft between her breasts, determined to drain you of your seed. She pulls you out of her bosom and plunges your member back into her mouth, suckling on it for any stray milk left. After a while, you groan as she pops you back out, collecting the ", false);
            if (this.player.cumQ() > 500)
                this.outputText("incredible amounts of ", false);
            this.outputText("cum you've painted on her flesh and gulping it all down. \"<i>Thanks for the load, " + this.player.mf("big guy", "babe") + ",</i>\" she remarks, sucking gently on her fingers. \"<i>I'll... I'll see you again, hey!</i>\" You pat her on the head and begin to make your way out of the gym, making sure to grab a ", false);
            if (this.silly())
                this.outputText("bacon ", false);
            this.outputText("shake on the way out.", false);
            //LOTTIE FIGURE -1, MUSCLE TONE +1, DRAINS PC'S LUST.
            this.lottieTone(-1);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00306] == 0)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00306] = 1;
            this.outputText(this.player.modTone(100, 1), false);
            this.player.orgasm();
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        lotteryAppearance() {
            this.spriteSelect(36);
            this.outputText("", true);
            this.outputText(this.images.showImage("lottie-examine-appearance"));
            //[If Figure between 0 – 20]
            if (this.lottieTone() <= 20) {
                this.outputText("She stands at around 4'8</i>\", considerably short on average, ", false);
                if (this.player.tallness > 60)
                    this.outputText("and shorter than you", false);
                else if (this.player.tallness > 53)
                    this.outputText("but you can't judge, being roughly the same height", false);
        ...
        lottieTone(dif = 0) {
            if (dif == 0)
                return this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279];
            if (this.debug)
                this.outputText("\n<b>(DEBUG: Lottie Tone changed by " + dif + "!)</b>\n", false);
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] += dif;
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] > 100)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] = 100;
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] < 0)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279] = 0;
            //Clear blowjob/anal change talk flags in case tone is getting out of whack.
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00306] == 1)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00306] = 0;
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00307] == 1)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00307] = 0;
            return this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00279];
        }
        lottieMorale(dif = 0) {
            if (dif == 0)
                return this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280];
            if (this.debug)
                this.outputText("\n<b>(DEBUG: Lottie Morale changed by " + dif + "!)</b>\n", false);
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] += dif;
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] > 100)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] = 100;
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] < 0)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280] = 0;
            return this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00280];
        }
        //[Talk]
        talkToPigSlut() {
            ...
            //[If 1st Time Oral]
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00306] == 1) {
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00306] = 2;
            ...
            //[If 1st Time Anal]
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00307] == 1) {
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00307] = 2;
            ...
            else if (this.lottieMorale() <= 30 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00308] - 5 > this.lottieTone()) {
            ...
            else if (this.lottieMorale() <= 70 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00308] - 5 > this.lottieTone()) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00308] - 5 > this.lottieTone() && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00297] == 1) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00308] - 5 > this.lottieTone()) {
            ...
            else if (this.lottieMorale() <= 30 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00308] < this.lottieTone() - 5) {
            ...
            else if (this.lottieMorale() <= 70 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00308] < this.lottieTone() - 5) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00308] < this.lottieTone() - 5 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00297] == 1) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00308] < this.lottieTone() - 5) {
                this.outputText("Her ears perk up at your eagerness to talk; she seems to be pretty excited about something. You ask her what's on her mind.  \"<i>That obvious, huh?</i>\" Lottie looks up at you and grins. \"<i>Y'see babe, since the last time we met, I've actually – I've lost weight!</i>\" She stands up, pumping her fist in the air and wiggling her plump ass. \"<i>I mean, I know it's not a big difference, but it's still a result! This is amazing!</i>\" She's clearly pleased with herself. You place a hand on her shoulder, and she beams at you. Do you encourage her, or break the bad news?\n\n", false);
            ...
            else if (this.lottieMorale() == 100 && this.lottieTone() == 100 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00318] == 0) {
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00318] = 1;
        ...
        lottieMediumMoraleWeightGainEncourage() {
            this.spriteSelect(36);
            this.outputText("", true);
            this.outputText("You tell her it isn't her fault; these things happen all the time for a variety of reasons. Her weight is bound to fluctuate now and then, it's completely natural. She looks up at you, her eyes welling up slightly. \"<i>Is that true? It's completely natural?</i>\" You nod your head. \"<i>I'm glad. I'm so glad.</i>\" She sniffs, wiping away her tears and taking a deep breath. You rub her shoulder as she places her hand upon yours. Lottie continues to talk about her day for a few more minutes before you both decide to hit the track.\n\n", false);
            this.outputText("<b>...</b>\nAfter a good workout, you decide to return back to camp, exhausted.", false);
            //ENCOURAGEMENT +2
            this.lottieMorale(3);
            this.fatigue(10);
        ...
        lottieHighMoraleWeightGainEncourage() {
            this.spriteSelect(36);
            this.outputText("", true);
            this.outputText("You tell her it's never her fault for something like that; and it's perfectly fine to be frustrated – as long as it doesn't detract from her main goal. Her weight is bound to fluctuate now and then, it's completely natural. She looks up at you, beaming at your kind words. \"<i>" + this.player.short + ", you really do know how to make people feel better, y'know?</i>\" You nod your head in agreement – you know. \"<i>I'm glad. I'm so glad.</i>\" She sighs, taking a deep breath. You rub her shoulder as she places her hand upon yours. Lottie continues to talk about her day for a few more minutes before you both decide to hit the track.\n\n", false);
            this.outputText("<b>...</b>\nAfter a good workout, you decide to return back to camp, exhausted.", false);
            //ENCOURAGEMENT +2
            this.lottieMorale(3);
            this.fatigue(10);
        ...
        lottieHighMoraleFatLoveSelfOneTimeEvent() {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00313] = 1;
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00298]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //[You'll get there]
        ...
        ewLottieNo() {
            this.spriteSelect(36);
            this.outputText("", true);
            this.outputText("You begin to talk about your story, about how you came to be in Mareth and how you got to be where you are now. You've encountered nasty things, and you've seen people become nasty things themselves. You also know that you've changed since then. You've become someone you didn't expect yourself to become in a million years – and whether it was for better or for worse was up to you to decide. You know you've been through hard times, but you've never once regretted the decisions you've made – because they led to her. To Lottie. The girl begins to tear up at your confession. \"<i>Oh, " + this.player.short + ", I...</i>\" But then you laugh. You laugh harder than you ever have since you came into this hellhole. In fact, you'd be willing to bet it was the first time you've ever laughed in Mareth. Lottie's face immediately scrunches up as she begins to bawl, but you could give less of a fuck as you stand up and point at the pig-slut as cafe-goers look at you both in curiosity. \"<i>ATTENTION FURRY ASSHOLES</i>\" you yell, much to the disgust of the anthropomorphic animal-people staring in your direction. \"<i>THIS SLUT – \"<i>you point to Lottie. \"<i>- WON'T EAT MY HAM SANDWICHES.</i>\" An audible gasp is heard from the growing crowd. Lottie's buried her head in her hands but your tirade continues. Walking to the counter, you take one look at the fuzzy clerk before he nods and hands you the aforementioned sandwich. Weird, you don't remember him being fuzzy – you really need to find a pair of fucking glasses in this sand pit. Regardless, you stomp over to the pig-girl, pulling her out of her seat and forcefully shoving the meaty meal down her throat. She gags for a second before unwillingly swallowing her own species. You grab her cheeks and pull her face several inches towards yours. \"<i>You disgust me.</i>\" You tell her, before whipping your " + this.cockDescript(0) + " out and fucking her ham and bread-filled mouth. </i>\"Here comes the mayonnaise train!</i>\" You yell, ejaculating straight down her gullet and into her flabby abyss.\n\n", false);
            this.outputText("For hours, people take turns pumping their seed into Lottie while you dance naked around her, chanting obscenities at the blurry people around you.\n\n", false);
        ...
        lottieSuccessOneShot() {
            ...
            //[Otherwise]
                ...
                if (this.silly())
                    this.outputText("  You fucking love bacon shakes.", false);
                //[Unlocks FemDom]
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00319] = 1;
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00298]++;
        ...
        lottieExercise() {
            ...
            if (this.lottieMorale() >= 66)
                this.outputText("with an enthusiastic nod", false);
            else if (this.lottieMorale() >= 33)
                this.outputText("with a nod in agreement", false);
            else
                this.outputText("by slowly looking up at you and nodding her head", false);
        ...
        lottieWeights() {
            ...
            this.outputText("", true);
            var NTR = undefined;
            if (this.lottieMorale() <= 30 && this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_IFRIS_BLOWJOB] > 0 && this.player.str >= 75 && this.player.tone >= 60 && this.player.cumQ() >= 1000)
                NTR = this.ifrisAndLottieGetsNTRedLiftingWeights;
            //[If Figure 0 – 70]
        ...
        boastAtLottie() {
            this.spriteSelect(36);
            this.outputText("", true);
            this.outputText("You laugh as you pick up one of the larger ones and pump mercilessly, looking at her expectantly as if she had been failing out of laziness. She tries harder to pull the heavy object over her head, but eventually she begins to shake and drops it, landing in the sand with a ", false);
            if (this.silly())
                this.outputText("large *pomf =3*", false);
            else
                this.outputText("loud clonk", false);
            this.outputText(". She looks up at you and sniffles, but you just grunt in response, disappointed with her efforts. She sighs and tries her best to do it again.\n\n", false);
            this.outputText("After a few more attempts at the weights, she eventually buckles under the pressure and gives up, walking home by herself. You snort and continue a few more well-earned reps before dropping down and recharging for the night.", false);
            this.fatigue(10);
        ...
        trainWithLottie() {
            ...
            this.outputText("After a few more attempts at the weights, you both decide you've had enough, going your separate ways and waving as you leave the gym.", false);
            this.dynStats("str", .1);
            this.lottieMorale(2);
            this.lottieTone(2);
            this.fatigue(10);
        ...
        sprintAndLeaveLottieBehind() {
            ...
            this.outputText("A few rounds later, you've exhausted yourself so you decide to return home. You notice that Lottie's nowhere in sight, but it's her loss - not yours.", false);
        ...
        jogWithLottie() {
            this.spriteSelect(36);
            this.outputText("", true);
            this.outputText("You decide that sprinting wouldn't really get either of you anywhere, though taking things a little faster wouldn't be any harm. You take the power walking to the next level with a quick jog, before reminding Lottie to take this as leisurely as possible - it isn't a race. Lottie quickly picks up the idea and starts to push herself further, trying her best to keep up with you, whilst maintaining a steady rhythm on the track. You both spend the good part of the evening jogging a fair distance, before deciding to retire for the night. You're both tired, but satisfied with today's efforts.\n\n", false);
        ...
        sprintAndLeaveFitLottieBehind() {
            ...
            this.outputText("A few rounds later and you've exhausted yourself, so you decide to return home. You notice that Lottie's nowhere in sight, but it's her loss - not yours.", false);
            this.dynStats("tou", .2, "spe", .25);
            this.lottieMorale(-3);
            this.fatigue(10);
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        lottieYogaAlone() {
            this.spriteSelect(36);
            this.outputText("", true);
            this.outputText("Taking your mat, you walk over towards the four-armed yoga trainer, sitting down only a meter or two away from her tanned, muscular body. In the corner of your eye, you can see Lottie visibly disheartened as she watches you gazing at the fit, caramel-colored woman in front of you. As you take your position, the intense smell of coffee and desert flowers hits you as the instructor lays on her back and pulls both of her legs up, giving you a clear view of her large thighs and puffy mound. You swear you can see her smiling as the other surrounding members begin to imitate her position. Not wanting to disappoint, you lie on your rear and tilt your head backwards, confronted by another pair of legs lifted into the air. You can see Lottie attempting the same position, only to lean to her right and fall over, earning an annoyed stare from the person next to her.\n\n", false);
            this.outputText("You continue to take on the vaguely sexual positions of the athletic yoga teacher, the class ending before you know it. Your head strangely dizzy from the smell of sweat and pheromones, you walk home by yourself, completely forgetting about Lottie.", false);
            this.outputText(this.player.modThickness(30, 1), false);
        ...
        jumpInPoolBeforeLottieSeesYourWingWang() {
            this.spriteSelect(36);
            this.outputText("", true);
            this.outputText("You can't risk it, so you decide to take a plunge into the water – it's freezing at first, but you quickly warm up. Lottie takes your avoidance to heart and looks visibly discouraged, though you wonder what her reaction would've been if your cockrocket", false);
            if (this.player.cockTotal() > 1)
                this.outputText("s", false);
            this.outputText(" decided to say hello. Needless to say, you decide it'd be better if you swam alone – nothing's wrong with the occasional chubby-assed slut wandering now and then, but it's a pain to not be distracted. Lottie wades at the other end of the pool, doing the occasional stretch before breaking into laps. You take a page from her book and begin to work back and forth from either end, making sure not to stare at Lottie's massive chest as it bounces into the air every so often after a stroke. After a considerable amount of time, you both finish considerably more exhausted than before. She seems to have lightened up since your initial reaction to her body, so you shrug it off and head home.", false);
            //ENCOURAGEMENT -1, FIGURE +2, MUSCLE TONE +2, LUST +9001
            this.outputText(this.player.modTone(100, 2), false);
        ...
        waitAndShowLottieYourPoolBoner() {
            this.spriteSelect(36);
            this.outputText("", true);
            this.outputText("You figure it can't do much harm to let " + this.sMultiCockDesc() + " fly, so you decide to leave it be, even leaning back so as to accentuate the hardening length. It doesn't take long for Lottie to notice, letting out a little gasp as she observes your ", false);
            if (this.player.biggestCockArea() >= 15)
                this.outputText("pride and joy", false);
            else if (this.player.biggestCockArea() < 5)
                this.outputText("secret shame", false);
            else
                this.outputText("painfully average prick", false);
            this.outputText(". You almost experience a tinge of regret from the now incredibly awkward silence, but it's thrown out the window as soon as you feel a soft hand grab your throbbing member. Looking up, Lottie's face has reddened considerably, but her curiosity overrides her shame as she begins to slowly massage you to full mast. \"<i>I... I did this?</i>\" she asks, facing you with large, wondering eyes. You grin and nod, taking her hand and helping her stroke it further, only to be met with a slap on your wrist as she removes her grip. You look up, frowning as Lottie laughs at the situation. \"<i>I'm – it's nice to know that someone likes me.</i>\" She stutters, smiling timidly. \"<i>But, um, we're here to exercise, " + this.player.mf("big guy", "babe") + ". We should do that.</i>\" You groan at the sudden cockblock, but you can't really argue. She takes your hand and leads you into the water, but not before you playfully grab a handful of her plush ass.\n\n", false);
            this.outputText("A while later and you've both finished off several laps of the pool, exhausted from your progress. Lottie flashes you a large smile before you part ways, leaving you still somewhat aroused from the experience.", false);
            this.outputText(this.player.modTone(100, 2), false);
            this.dynStats("lus", 80);
            this.lottieTone(2);
            this.lottieMorale(2);
        ...
        giveLottieAnItem() {
            ...
            if (this.player.hasItem(this.consumables.GROPLUS) && this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) >= 0)
                gro = this.giveLottieGroPlus;
            if (this.player.hasItem(this.consumables.REDUCTO))
                reducto = this.giveLottieReducto;
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00321] == 0) {
        ...
        hamSammitchTimeBIATCH() {
            this.spriteSelect(36);
            this.outputText("", true);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00324] == 0) {
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00324]++;
                this.outputText("You walk over to the cafe, Lottie watching as you order a sandwich from their menu. In a matter of seconds the collie-like clerk pulls one up from the glass display and hands it over to you", false);
                if (this.silly())
                    this.outputText(", mumbling something about lifetime members receiving free pig-related food items", false);
                this.outputText(". You exchange a smile before walking back to the table and handing Lottie the moist meal, explaining that you saw the ham sandwich the other day, figuring she might enjoy it. Lottie throws it on the floor. \"<i>What the heck is wrong with you?</i>\"\n\n", false);
            ...
            //[If Ham Sandwich, Repeat Encounter, High Corruption]
                ...
                this.outputText("You walk over to the cafe, Lottie watching as you order a sandwich from their menu. In a matter of seconds the collie-like clerk pulls one up from the glass display and hands it over to you, mumbling something about giving a pig-girl a ham sandwich being a stupid fucking idea. You exchange a smile before quickly walking out of the cafe and into the currently empty pool area. You hastily remove your " + this.player.armorName + " and take out your " + this.cockDescript(0) + ", jamming it straight into the sandwich and fucking it relentlessly. In moments you cum between the velvety slices of ham, leaving a large puddle inside and leaving the rest of your spunk leaking out the back and pooling onto the floor. You dress yourself before walking back to the table and handing Lottie the incredibly moist meal, explaining that you saw the ham sandwich the other day, figuring she might enjoy it – and that you've taken care into adding your own 'special mayonnaise'. Lottie throws it on the floor. \"<i>Don't cum inside ham sandwiches, asshole!</i>\"\n\n", false);
                this.outputText("You reach for a high five that never comes.", false);
                this.player.orgasm();
            }
            //[If Ham Sandwich, Repeat Encounter]
            else {
                this.outputText("You walk over to the cafe, Lottie watching as you order a sandwich from their menu. In a matter of seconds the collie-like clerk pulls one up from the glass display and hands it over to you, mumbling something about giving a pig-girl a ham sandwich being a stupid fucking idea. You exchange a smile before walking back to the table and handing Lottie the moist meal, explaining that you saw the ham sandwich the other day, figuring she might enjoy it. Lottie throws it on the floor. \"<i>Stop giving me ham sandwiches, asshole!</i>\"\n\n", false);
                this.outputText("You reach for a high five that never comes.", false);
            }
            this.dynStats("cor", 1);
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        lottieFuck() {
            ...
            if (this.silly() && this.player.hasCock())
                thirtyMinute = this.lottiesThirtyMinutePigGasm;
            if (this.player.tentacleCocks() > 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00306] == 2)
            ...
            if (this.lottieMorale() <= 40) {
                this.outputText("You take Lottie's hand in your own, though the girl seems to flinch at your touch. \"<i>D-did I do something?</i>\" she asks, slowly recoiling into her seat. You choose not to answer, though the both of you know what's coming next. Silently, you increase your grip on Lottie, leading her out of her seat and into the pool area, checking for any bystanders before taking her inside one of the empty saunas. Lottie grows more and more anxious as you undress yourself in front of her, taking out " + this.oMultiCockDesc() + " and stroking gently. She seems to shrink when you turn to her and ask her to do the same. \"<i>P-please, " + this.player.short + "... I... I like what we're doing, but,</i>\" she turns away from your wanting gaze before muttering, \"<i>I want to do this with someone special.</i>\" You scowl – it looks like you're going to have to take things into your own hands again. Walking towards the pig-slut, you grab the hem of her top and pull down, ripping it off to reveal her lovepillows which are covered hastily by her arms. \"<i>N-no! I... please, please don't do this...</i>\" Grabbing your " + this.cockDescript(x) + ", you step close enough for her to feel your hot breath against her skin. You rub the tip of your " + this.cockDescript(x) + " against her soft flesh, pre-cum leaking against her stomach as you thrust slowly. Your natural musk fills Lottie's button nose, and her increasingly shorter breaths give you the signal that she's ready to give up against your raging lust. \"<i>But " + this.player.short + ", I... I love...</i>\" A loud slap is heard as you press and play with her bottom, grinding your length in between her creamy thighs. \"<i>I... love...</i>\" Slap!  You wail on her ass and thrust hard between her legs. \"<i>F-fuck! I love you so much!</i>\" the pink whore cries, pulling off her shorts and turning around, grabbing your " + this.cockDescript(x) + " and rubbing it against the entrance to her wetness. You grin at your success, but you're not going to satiate her needs yet. You continue to fuck her thighs, slapping her luscious butt every so often and earning a squeal in response. You lean over and grab one of her heaving breasts, groping it roughly to the sound of your pelvis slapping against her fat legs. The feeling of your " + this.cockDescript(x) + " being squeezed against Lottie's thighs almost sends you to climax, before you get a better idea.\n\n", false);
                this.outputText("You turn Lottie around to face you, telling her you've decided you're going to take her for a vigorous work out. She only pants with anticipation.", false);
                //[Anal][Oral] – [Doggystyle][Walkies][Threesome][Netorare]
                var dog = undefined;
                var walk = undefined;
                var three = undefined;
                var neatrares = undefined;
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00310] > 0)
                    dog = this.lottieRepeatDoggieStyle;
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00311] > 0)
                    walk = this.lottieRepeatWalkies;
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00316] > 0)
                    three = this.lottieRepeatThreesome;
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00317] > 0)
                    neatrares = this.lottieRepeatSUPERNEATORARES;
                this.choices("Anal", this.analLottieMilkshake, "Oral", this.getSuckedOffByAHamSandwich, "Tentacle", tentacle, "", undefined, "", undefined, "Doggystyle", dog, "Walkies", walk, "Threesome", three, "Netorare", neatrares, "30Minute", thirtyMinute);
            }
            //[If Encouragement 30 – 60]
            else if (this.lottieMorale() <= 60) {
                this.outputText("You ask Lottie if she's keen for a little 'extracurricular workout', earning a giggle and a tilt of the head from the pig-girl. \"<i>What do you mean, " + this.player.mf("big guy", "babe") + "?</i>\" she asks. You sigh and stand up, revealing your hardening member", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("s", false);
                this.outputText(". \"<i>I... oh.</i>\" Taking Lottie's hand, you quickly lead her out of the cafe and into the pool area, looking for an empty sauna to sneak into. Considering that the gym's pool is only used by a few semi-aquatic humanoids and the odd ", false);
                if (this.silly())
                    this.outputText("street ", false);
                this.outputText("shark, your search isn't that difficult. Hopping into the toasty room, you quickly undress, Lottie still standing by the doorway. \"<i>H-hey, y'know, I didn't actually agree on this or a-anything...</i>\" she stutters, nervously fiddling with her top. Without missing a beat, you walk towards her and plant a kiss on her full lips, tasting her sweetness as you probe her mouth with your eager tongue. The girl melts underneath your touch, passionately returning your erotic display while you take the chance to slip Lottie out of her top, reaching into her shorts to feel between her creamy hips. She moans as you slowly push two fingers inside her moist wetness, simultaneously pulling out your " + this.cockDescript(x) + " and pushing her back against the wall. Lottie begins to jerk you off slowly, massaging the length of your " + this.cockDescript(x) + " with one hand while the other takes care at gently caressing your tip. You start to thrust into her hands on reflex while you claim her mouth, the feel of her sugary tongue wrapped around yours sending you both into fits of needy lust. You use your hands to reach around and squeeze her chubby derriere, lightly slapping it whilst a stray hand heads towards her source of hot desire. You slick your hand against her wetness, Lottie moaning in your mouth while you work towards bringing her to an early climax. However, the sudden roughness of your hands against her mound only causes a quick jerk to your " + this.cockDescript(x) + ", her soft hands tightening against your shaft. You groan in response, removing yourself from the lips of her mouth and instead placing your own against her erect nipple, sucking forcefully. The pig-slut grabs your head and pushes you towards her heaving chest, relinquishing her grip on your member to hug you closer.\n\n", false);
            ...
            //[If Encouragement 60 – 100]
                ...
                this.outputText("You take Lottie's hand in your own, causing a small blush from her in response. \"<i>" + this.player.short + "?</i>\" she begins, only to be cut off by a small peck to the lips. Lottie reddens, giggling slightly and gazing around for any onlookers. \"<i>What's brought this on, babe?</i>\" She beams, twirling and caressing your fingers among her own. You tell her that you thought she just needed a little more 'special exercise' to help get the blood flowing – making sure to emphasise \"<i>special exercise</i>\" with exaggerated air quotes. She playfully pushes away your idiotic gesture and takes you out of your seat, leading the way into the pool area and into one of the empty saunas. Locking the door behind you, she turns around to face you and your hardening crotch. \"<i>I think you're getting a little over excited, babe,</i>\" she purrs, her confidence getting the better of you as she takes a step closer, but you're the one in charge. Grabbing Lottie by the hips, you twirl her around to face the wall, grinding your hardening length", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("s", false);
                this.outputText(" against her plump asscheeks. \"<i>W-woah! I... well, okay...</i>\" she moans, reaching back to stroke your " + this.cockDescript(x) + " through your clothing while you grab a handful of her rosy ass, slapping and squishing it against your palm. You continue to hump relentlessly against Lottie's tight shorts, occasionally reaching around to feel her hot mound, causing the odd squeal or moan to emanate from her pouting lips. Eventually deciding clothes are the only thing between Lottie's lewd figure and your own " + this.cockDescript(x) + ", you simultaneously remove your outfit while ripping off her sweaty top, causing her breasts to spill out into your eager, groping hand. Despite your sudden stripping, Lottie immediately gets back into position, placing your cock in between her pillow-like asscheeks and moaning while you flick and tease her swollen nipples, rocking back and forth against you.\n\n", false);
                this.outputText("Lottie whimpers in between short, hot breaths, \"<i>You're driving me crazy here, babe...</i>\" You give her chubby ass a hard slap in agreement. Lottie squeals in glee, jerking your " + this.cockDescript(x) + " as it pokes up through her ass. The sensation of your tip rubbing against her velvety skin drives you wild.\n\n", false);
                this.outputText("You turn Lottie around to face you, telling her you've decided you're going to take her for a vigorous work out. \"<i>I'll work you out, babe,</i>\" she moans in response.", false);
                //[Anal][Oral] – [Quickie][Cowgirl][ReverseCowgirl][FemDom]
                var quickie = (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00314] > 0 ? this.lottieRepeatQuickie : undefined);
                var cowgirl = (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00313] > 0 ? this.lottieRepeatCowGirl : undefined);
                var rcowgirl = (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00320] > 0 ? this.lottieRepeatBackwardsAssCowgirl : undefined);
                var femdom = (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00319] > 0 ? this.lottieRepeatFEMDOMFEMFDOM : undefined);
                this.choices("Anal", this.analLottieMilkshake, "Oral", this.getSuckedOffByAHamSandwich, "Tentacle", tentacle, "", undefined, "", undefined, "Quickie", quickie, "Cowgirl", cowgirl, "R.Cowgirl", rcowgirl, "Femdom", femdom, "30Minute", thirtyMinute);
            }
        ...
        lottieRepeatDoggieStyle() {
            ...
            if (x < 0)
                x = 0;
            this.outputText("A few minutes later and you've taken your whore to the washrooms. Mirrors line the sides of the walls to allow members to observe how far they've gone and how far they still need to go. It's entirely empty for the night, though you make sure to lock the door just in case. You turn around to see Lottie cowering in the corner. She knows what you want – and you swear on Mareth's giant tree titties you'll get it. With her naked body on full display, Lottie quietly moves down to the ground, positioning herself on all fours with her butt facing towards you. She looks behind herself to see your erect " + this.cockDescript(x) + " on full display, quickly squealing and looking away. You grin as you stroke yourself into fullness, walking over and placing yourself behind Lottie's full derriere. \"<i>" + this.player.short + "?</i>\" she gently sobs, \"<i>P-please don't do this.</i>\" With that, you grab her ample thighs and thrust forward, driving your " + this.cockDescript(x) + " straight into her tense wetness.\n\n", false);
        ...
        lottieRepeatWalkies() {
            ...
            if (x < 0)
                x = 0;
            this.outputText("A few minutes later and you've taken your whore outside of the gym and around to the back, where an equipment shed lies waiting. You make quick work of the lock, busting it open with a nearby metal pole. The two of you walk slowly inside, Lottie pausing behind you to gaze at the tools and exercise apparatuses littering the walls. Soon, you find what you're looking for. You've never been one to judge a person for their fetishes, but you make a mental note to thank the person who couldn't control theirs. A single leather collar attached to a leash dangles silently upon a hook attached to the walls of the shed. Grinning, you take it down, adjusting the length of the rope before handing it to Lottie. \"<i>W-what's this for, " + this.player.mf("sir", "ma'am") + "?</i>\" she mumbles, but you pay no attention to her questioning as you loosen the collar and push it down on the girl's neck, tightening it before she can protest. \"<i>N-no! What are yo-!</i>\" Slap! You pelt your hand against her soft cheek, causing her to jerk on the rope and fall to the floor, miserable and in pain. Your slut slowly looks up at you with watering eyes, a hand to her face to quell the stinging sensation. \"<i>I... I understand.</i>\" She mutters quietly, picking up the leash and placing it in your hands, before standing on her knees and adopting a begging position in front of you. You grunt as the girl pulls out her small tongue, reluctantly licking at your groin to satisfy the beast behind your clothes. Just like a whore to assume that's what you're here for. You walk away from her attempts to fellate you, pulling on the leash and yanking your girl forward. She gets up and starts walking behind you and out into the sunlight - you want the world to know how well you've trained your fat little piggy.\n\n", false);
            this.outputText("You look back to the shed to see if there's anything you might be missing. Weights, large poles, a whip, some rope, and – ah yes, the steel ring gag. 'Where there's a whip, there's a way', you chuckle to yourself as you take the strap and bring it over to Lottie. Your pig slut is naked and ready, waiting on your command as you pull out the ring-shaped device and stretch the strap over her head, placing the metal ring inside her mouth and forcing the pale slut to make a permanent 'O'-shape with her lips. You tighten the gag, causing Lottie to cough uncomfortably as drool forms at the base of her mouth. Taking the leash, you drag Lottie away from the shed, her large ass jiggling as she tries to catch up to you. You figure you'll take her to the backstreets of Tel'Adre – you want people to see your work of art, but you know only the scum of the city will truly appreciate her for what she is. You pull the leash, leading Lottie through an alleyway and into a smaller, dirtier part of the desert city, an enclosed area with several food stalls littered around.  A majority of the lower-class citizens wander these parts, shuffling about as they haggle, argue and steal – as is usual in the slums. Most people notice your pig-girl trotting behind you, though few offer a second glance. The majority stand and stare as you present your trophy – a few of the more courageous ones openly masturbate to the site, whereas the braver still walk up and slap your pig on the ass, eliciting a squeal or a moan. You decide to up the ante while you walk through the commons, placing a hand between Lottie's pale thighs and thrusting two fingers into her pussy, the heat enveloping your digits as you shamelessly fingerfuck the poor girl.\n\n", false);
        ...
        lottieRepeatCowGirl() {
            ...
            if (x < 0)
                x = 0;
            this.outputText("A few minutes later and you've both gone to the yoga rooms – you've already placed a mat down while you wait for Lottie to change. Your rosy lover bounces into the empty, dim lit room, her ample thighs squishing out of a pair of super tight shorts, while her breasts fill over a sports bra. You're immediately turned on by the incredibly erotic display, Lottie catching scent of your increasingly hardening member and giggling while she crushes her boobs together in front of you. \"<i>I'm guessing you like what you see?</i>\" she purrs, walking over to you and pushing you down upon the gym mat. Lottie makes quick work of your lower clothes, your " + this.cockDescript(x) + " bouncing out and at attention, which she grabs hastily as she begins to jerk you off. The pig-girl presses your member against her moist slit, grinding it back and forth while her moans fill the empty room. You grunt in pleasure, jerking your hips slightly to help the process along, to which she replies by bending down to press her overflowing tits against your chest. You take your hands and slap them upon her ass, groping and squeezing while she moans into you. The girl shudders in bliss as the grinding sends her into an early orgasm. \"<i>I... I've got something better for you, babe...</i>\" she pants as she pulls apart the opening in her shorts to reveal her blushing pussy. Keeping a firm grip on your " + this.cockDescript(x) + ", Lottie lifts herself up and slowly lowers her body upon it, your tip parting her folds and entering her hot insides. You grunt at the sensation of her inner walls squeezing tightly against your member, ", false);
            if (this.player.cockArea(x) <= 40)
                this.outputText("her ample cheeks resting on your groin as you bottom out in her", false);
            else
                this.outputText("though you only reach so far before you've filled her up entirely with your length", false);
            ...
            this.outputText("  You both lay on the mat, panting in ecstasy while your " + this.cockDescript(x) + " continues to ejaculate inside her.\n\n", false);
            this.outputText("A while later, you've both said your goodbyes for the night. Before you leave, you make sure to head out to the cafe to buy yourself a ", false);
            if (this.silly())
                this.outputText("bacon ", false);
            this.outputText("shake.", false);
            if (this.silly())
                this.outputText("  You love bacon shakes.", false);
            this.player.orgasm();
            this.dynStats("sen", -2);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        lottieRepeatQuickie() {
            ...
            if (x < 0)
                x = 0;
            this.outputText("You follow Lottie out into the pool area, waiting as she walks into the dressing room to get changed. When she comes out however, you're surprised to find that she hasn't changed into anything – in fact, she's removed all her clothes entirely!\n\n", false);
            this.outputText("The nude pig-girl stands in front of you, turning red at your hungry gaze. \"<i>Will you f-fuck my pussy, " + this.player.short + "?</i>\"\n\n", false);
            this.outputText("In moments flat you remove your clothes to jump the piggy, whipping out your " + this.cockDescript(x) + " and pushing it against Lottie's wet slit, the pig-girl lying on her back while her legs rest upon your shoulders. With a hearty thrust you drive yourself into her, eliciting a loud moan while you pork her insides with your meat. Her thick thighs slap against you as you bend over to take a lustful grab at her melons, sucking at her nipple and pinching the other, her sweet taste enveloping your mouth. Lottie buries you in her cleavage, yelping as you piledrive her tight pussy into submission – but you've got more in store. Flipping her over, Lottie lies face down with her soft butt jutting up in the air, your persistent fucking driving her wild. You continue gripping onto her tits as you pound her flesh, every thrust accompanied by her pleasured grunts. Back and forth you mount her until the familiar sensation in your loins signal your release. You increase your pace, pounding her pussy until you pull your head back and ejaculate inside her inner walls, slamming in harder every few seconds with each burst.", false);
            if (this.player.cockTotal() > 1) {
                this.outputText("  Your other cock", false);
                if (this.player.cockTotal() == 2)
                    this.outputText(" twitches ", false);
        ...
        lottieRepeatSUPERNEATORARES() {
            ...
            if (x < 0)
                x = 0;
            this.outputText("You both walk to the yoga rooms, to find Elle stretching in the empty area. She spots the both of you, waving hello -  but you all have other, dirtier intentions in mind. Elle strips down, her perky tits letting loose. You chuckle devilishly as you undress in front of your naked and wanting harem – but you only have eyes for one girl. You point at the spider-girl, informing the both of them that you only plan to fuck her. Lottie may have thought she could win you over with another slut, but you feel as if you should teach her a lesson about being too presumptuous about what you want. Elle walks towards you, her child-bearing hips swaying hypnotically as she ", false);
            if (this.player.cockTotal() == 1) {
                this.outputText("begins to caress your " + this.cockDescript(x) + " with two of her hands, while the other sets to work on massaging your ", false);
                if (this.player.balls > 0)
                ...
                this.outputText("uses all four of her hands to handle " + this.sMultiCockDesc() + ", jerking each one with ease", false);
            ...
            this.outputText("  Elle follows suit, groaning in pleasure as she reaches her own peak, her hole tightening around your length and trapping the rest of your spunk inside. The spinnerets upon her shoulder pulse in orgasm, spurting sticky globs of what appears to be thread up into the air and back down onto the pig, spunk pooling around her cleavage. You both relax, letting the spider-girl down off of you to collapse on the floor. You bend down, looking at Lottie before shoving your " + this.cockDescript(x) + " inside of her and letting one final spurt of your seed fill her up. \"<i>Satisfactory.</i>\" You mumble, redressing and heading out the door, making sure to grab a ", false);
            if (this.silly())
                this.outputText("bacon ", false);
            this.outputText("shake on the way out.", false);
            if (this.silly())
        ...
        lottieRepeatBackwardsAssCowgirl() {
            ...
            if (x < 0)
                x = 0;
            this.outputText("You both walk into the yoga area, met with the smell of sweat and flowers pervading the room. Lottie gently asks for you to lie down on your back, to which you comply quite easily. You're comfortable, folding your arms behind your head to give you leverage as you watch your lover walk slowly to you. Lottie turns around, her thick thighs straddling you as she sits down on your groin with her back facing your direction, giving you  a perfect view of her curvy body and plump ass. Your " + this.cockDescript(x) + " nestles gently between her rosy cheeks, pulsing with lustful intent as the girl grabs her hips and begins to pleasure you through her ass. The silence of the room breaks at your fevered pants and grunts as Lottie's skillful assjob sends you through fits of ecstasy, every curve of her bottom jiggling against the heat of your member. Her pace picks up while she bounces upon you, squeezing and squashing her perfect ass until one final lift in the air is met with her plunging your length up into her hot interior. The feeling of your molten cock inside her immediately sends Lottie into fits of orgasmic bliss, the intense heat filling the pig-girl with pleasure. Her attempts to continue are thwarted by your " + this.cockDescript(x) + " scraping against her inner walls, her thick thighs clenched together while she slowly moves up and down upon you. Deciding to take things into your own hands, you thrust upwards, almost pushing the girl off with your strength and causing Lottie to squeal as you begin pounding her irresistible hole. Her lush buttcheeks jiggle with every movement you make, the rising and falling of her body moving in accordance to your own will. You pump in and out, keeping a steady rhythm inside the hot and bothered woman.\n\n", false);
            this.outputText("Inevitably, you can feel your release approaching, and with one final push you grab a hold of the pig-girl's tight ass, slamming against her and pumping your spunk directly into her clenched pussy, your " + this.cockDescript(x) + " twitching as ropes of cum coat her insides. Lottie yelps, collapsing on the floor and full of your hot seed. You wipe your cock along her ass cleavage, leaving her as a sweaty, cum-filled mess on the floor. Walking out, you make sure to grab a ", false);
            if (this.silly())
                this.outputText("bacon ", false);
        ...
        lottieRepeatFEMDOMFEMFDOM() {
            ...
            if (x < 0)
                x = 0;
            this.outputText("You both walk into the yoga area and are met with the smell of sweat and flowers pervading the room. You look around, unable to find your lover until –THUNK! A heavy weight is brought down upon your head, pulling you down to the ground and away from consciousness as everything fades to black.\n\n", false);
        ...
        tentaDickLottieButtFuckbuttFuckButtFUCKBUTTFUCKBUTTFUCK() {
            ...
            while (counter < this.player.cockTotal()) {
                if (this.player.cocks[counter].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE) {
                    if (x == -1)
                        x = counter;
                    else if (y == -1)
                        y = counter;
            ...
            this.outputText("It isn't long before you've taken Lottie out to the shed behind the gym - due to the amount of visitors regularly coming in and out of the gym itself, the equipment seems to have been mostly removed - leaving bare shelves and a large concrete floor covered in spare gym mats.\n\n", false);
            this.outputText("The porcine girl takes the initiative as soon as you enter the room, stripping down and planting her cushiony ass upon the pile of mats in front of you.  \"<i>What're we gonna do in here, babe?</i>\" she asks, turning over onto her soft belly and rolling around, covering herself in an assortment of old, thin mattresses.  \"<i>Heh, I'm a pig in a blanket,</i>\" she squeaks, unaware of you slowly pacing towards her, your hand firmly stroking your " + this.multiCockDescriptLight() + ".  There's a time for games, you think, and a time for unleashing your myriad of undulating vine-beasts upon your curious pink slut.\n\n", false);
            this.outputText("Removing your " + this.player.armorName + ", you let your " + this.multiCockDescriptLight() + " hang loose, a single vine stretching outwards and slapping Lottie upon the ass to remind you of why you're here.  She squeals, trapped underneath the heap of mattresses and doing little to help the situation she's found herself in.  \"<i>H-hey, uh, I've kinda found myself in a little pickle, " + this.player.mf("big guy", "hon") + " - could you give me a hand?</i>\" Lottie chuckles, squirming around in an attempt to loosen herself from the pile, but inevitably failing.  You walk closer towards her, shifting away a few mattresses here and there to free her limbs.  She smiles apologetically as you lift up the last mattress, crawling back out of the pile only to squeak when you bring down the smallest - albeit, heaviest - mat onto her back, preventing her from moving any further and causing her face to be buried against the mattress below her, the girl's plump ass stretched directly up into the air.  The awkward position restricts the movement of anything outside of her forearms and neck, and the majority of the weight upon her back pushes her chest into her knees, disallowing her from stretching outwards.  Lottie turns her head to the side, giving her time to breathe and assess the situation.  She notices you're stark naked, her eyes drawn down to the " + this.multiCockDescriptLight() + " laid before her.", false);
            if (this.lottieMorale() <= 30)
                this.outputText("  She gives you a gloomy stare, before turning her head back down and plunging it into the mattress, already accepting her defeat", false);
            else
                this.outputText("  She raises an eyebrow, though doesn't probe any further", false);
            this.outputText(".\n\n", false);
            this.outputText("You grasp the base of your " + this.cockDescript(x) + " as it stretches forward, gently caressing Lottie's face before exploring the rest of her body, idly stroking the smooth curves of her hips or brushing against her hardening nipples.  The pig-girl moans quietly from the light petting while the feeling of her soft skin excites your hardening length, reminding you of your true intentions.  You walk behind her, obscuring yourself from Lottie's peripheral vision and crouching down to inspect the view of her perfectly rounded ass pointed conveniently into the air.  " + this.SMultiCockDesc() + " twitches in agitation, eager to plow the chubby slut trapped in front of you - and you aren't about to disappoint.\n\n", false);
            ...
            this.outputText("writhing member as it stretches out, snaking towards Lottie's genitals and probing her moistened lips.  The tip of your vine-like length wriggles vertically along her eager hole, vibrating against her hardening clit and causing the sweating pig-whore to oink in pleasure.  She struggles to move her arms towards her aching need, desperate to relieve herself from the thick, stretching snake pushing against her slick cunt.  Without a word of warning, the hardened tentacle presses the side of its slick length firmly against her entrance, before whipping itself backwards and plunging into her heated hole.\n\n", false);
            this.outputText("Lottie groans from pleasure while your thickened, snake-like cock lies pulsing inside her, trapped within the tightening walls of her womb.  You force the bestial length to curl back outwards, before pumping back with incredible force - plowing your girl with fevered abandon as the insatiable vine pushes her face into the mattress soaked with her saliva.\n\n", false);
            //[if extra cock] //this is to be added to the standard text
            if (y >= 0) {
                this.outputText("Seeing that you have extra junk left to be used, and she has some vacant holes, you quickly remedy this problematic situation; guiding your " + this.cockDescript(y) + " toward her moist butthole, you press the tip of your tree-like beast against her plush buttocks, literally stabbing her flesh with your penile flora.  The butt-slut doesn't seem to care: if anything, she squirms all the more, visibly aroused.  Her ass seems to stretch on its own as it braces itself for the imminent butt-devastation.  You welcome Lottie's efforts to comply to your anal needs and with a single thrust, you push ", false);
                if (this.player.cockArea(y) <= 80)
                    this.outputText("the entirety of your " + this.cockDescript(y), false);
                else
                    this.outputText("as many inches of your " + this.cockDescript(y), false);
                ...
                if (z >= 0) {
                    this.outputText("Her constant moaning and screaming reminds you that one of her holes at least isn't being put to use.  Her eyes widen in awe as she sees your " + this.cockDescript(z) + " inexorably moving to her waiting mouth, her lips forming a wide O as if to greet your tentacle pecker.  Without a word, you plunge your beast in her mouth, burying your prick until she's about to choke.  Fortunately she's used to blowjobs, and you have no trouble fitting a decent amount of inches down her throat.  You can see her neck bulge from the obscene intrusion, and the tip of your " + this.cockDescript(z) + " swells until her windpipe looks ready to explode.  She can't say anything, but the way her eyes are staring at you tell you more than anything about how she feels.", false);
                    if (this.lottieMorale() < 40)
                        this.outputText("  This pig slut really loves to be used like that!", false);
                    else
                        this.outputText("  Your pig lover really loves what you're doing to her!", false);
                    this.outputText("  A bunch of tight fuck-holes, each taking care of your tentacle pricks in its own way, all different but all so wonderful!  A horny girl begging to be rammed with cock in her every hole... You almost feel bad for using her like a broken fuck-toy, but she is clearly asking for it.  She keeps twisting in every direction as you savagely triple-penetrate her, her silent moans of pleasure being muffled by the beast lodging in her mouth.\n\n", false);
                    //[if another extra cock]//to be added to standard text
                    if (zz >= 0) {
                        this.outputText("Surely her twat must have some room left for more cock?  Before you even think of it, your free tentacle prick is already squirming its way to the piggy's love-tunnel, trying to fit as its companion ruthlessly rams her fuckhole.  You feel her whole body clench as you press the tip of your " + this.cockDescript(zz) + " between her netherlips, stretching them beyond their normal capacity as you keep pushing forward.  If her mouth wasn't so full of dick, you'd be sure she would scream like a harpy in heat.  Once the tip manages to get through her tight vaginal entrance, the rest easily follows, and you effortlessly slide your dickflesh down her now-gaping cunt.  You synchronize your pricks penetrating her cuntwardly, literally ravaging her pussy as you pork her insides with your genitals.\n\n", false);
                        //[if another extra cock]//to be added to standard text
                        if (zzz >= 0) {
                            this.outputText("Since her dripping twat has been able to take some extra dick, why not try her backside?  Your " + this.cockDescript(zzz) + " wriggles joyfully as it wraps around Lottie's plump rump, ready to test her anal capacity.  Fortunately, its rubbery texture allows it to be compressed as it grinds against your " + this.cockDescript(y) + ", sliding toward the pig-girl's wet anus.  Your plant-like dong bounces back against her entrance numerous times, but you know she is being stretched wider at every attempt.  You don't know how many times you poke her pucker with the erect tip of your " + this.cockDescript(zzz) + ", and you can't imagine how the teasing stimulation feels for the poor prisoner of your tentacle embrace.  At last, with a brutal thrust, your flexible dong somehow manages to clear a path for additional butt-penetration.  Your twin erect pricks are incredibly squeezed against her tight anal walls and her body is about to be torn in half from all the rods impaling her from many directions at once.  That doesn't prevent you from thrusting back and forth very carefully through her colon, never completely pulling out.\n\n", false);
                            //[if another extra cock]//to be added to standard text
                            if (zzzz >= 0) {
                                this.outputText("No matter how hard you try, you can't fit any more cock in her toy-like body. Your " + this.cockDescript(zzzz) + " is quivering in frustration, until you notice her fleshy orbs bouncing up and down repeatedly on her chest as you ruthlessly pound her from every hole.  This might be the right occasion to get a good titfuck: your " + this.cockDescript(zzzz) + " slowly slithers along her sweaty body and slides between her sizable fuckpillows; although the sensation isn't as hot and amazingly rough as the sharp tingles of pleasure received from the dongs pounding her ass, your rod is being subtly tickled and teased by her supple flesh.  Already aroused from the thorough multi-penetration, you start dripping pre-cum all over her torso, smearing her whole body with your sap.  This makes her breasts all the more slick and slippery, and needless to say, the sensation isn't lost on your " + this.cockDescript(zzzz) + "; it seems to grow even bigger and becomes pinkish, the sudden color change betraying its arousal. You keep fucking her boobs until they are literally glistening from all the juices you've spilled on them.\n\n", false);
                                //[if another extra cock]//to be added to standard text
                                if (zzzzz >= 0) {
                                    this.outputText("As you idly pump Lottie's body with all your junk, you mentally count all the extra ways her body could be used, since you have some tentacle dong left.  Mouth, cunt, ass, tits... wait!  Her hands are still free!  By the way they are twitching convulsively, you can clearly tell they are aching for some dick to handle.  You graciously comply to her cocky needs and shove your " + this.cockDescript(zzzzz) + " against her palm, coating it with your pre-cum.  She instinctively clings to your rod of flesh as if her life depended on it and starts jerking you off, ferociously rubbing your dickflesh and using a mix of her sweat and your pre-cum as lube.", false);
                                    //[if another extra cock]
                                    if (zzzzzz >= 0)
                                        this.outputText("  Seeing the effect your junk had on her, you move your " + this.cockDescript(zzzzzz) + " to her remaining hand and she grips it likewise.", false);
                                    this.outputText("  She keeps stroking you in a compulsive way, her hands clearly acting under the effect of her tremendous lust.", false);
                                    this.outputText("\n\n", false);
                                    //[if another extra cock]//to be added to standard text
                                    if (zzzzzzz >= 0) {
                                        this.outputText("With another cock left unsatisfied, you place your thick, tentacled member against the soft flesh of Lottie's ass, driving it to and fro as the sensation of her chubby flesh drives you wild.\n\n", false);
        ...
        lottieAndIfrisNTREpilogue() {
            this.outputText("", true);
            this.outputText("A dry wind across your face rouses you from your peaceful sleep.  It seems you're outside the walls of Tel'Adre.  All your equipment is sitting to the right of you, and when you gather the pile of your gear you find a note underneath.\n\n", false);
            this.outputText("\"<i>Dear " + this.player.short + ",\n\nSleep well?  I hope so, considering I found you snoring on top of two luscious babes.  Don't worry about getting in trouble at the gym.  Most of the staff and customers were too busy getting themselves off to be angry or offended, though I have to admit I'm a bit jealous.  The little piggy and that tight piece of red ass are both safe in their homes.  ", false);
            if (!kGAMECLASS_1.kGAMECLASS.urta.urtaLove()) {
                this.outputText("Of course, I had to fine you for public indecency - you really ought to watch how you behave, lest someone take you for a demon agent.  Next time, try and keep it in your pants.\n\n-Urta, Captain of the Guard", false);
                ...
                this.outputText("I had to make a show of fining you for public indecency, but you'll note your money is all still there.  Pay me back sometime, okay, hun?\n\n-Always up for you, Urta", false);
            this.outputText("</i>\"\n\n", false);
