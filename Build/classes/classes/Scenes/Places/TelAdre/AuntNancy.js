define(["require", "exports", "./TelAdreAbstractContent", "../../../GlobalFlags/kFLAGS", "../../../../../includes/appearanceDefs"], function (require, exports, TelAdreAbstractContent_1, kFLAGS_1, appearanceDefs_1) {
    ...
    //265 - Talk Nancy
    //266 - Times boned
    class AuntNancy extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        //[Introduction Blurb:
        //(appears in the Wet Bitch between 6:00 and 14:00)]
        auntNancy(display = true) {
            if (this.model.time.hours >= 6 && this.model.time.hours <= 14) {
                if (display) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00263] == 0)
                        ...
                        this.outputText("  Aunt Nancy", false);
                    this.outputText(" glances up at you and smiles as you enter", false);
                    //[(if unmet)
                    if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00263] == 0)
                        this.outputText(", and you see that she has additional red eyes spread across her forehead", false);
        ...
        interactWithAuntNancy() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00264] >= 30 && this.model.time.hours == 14 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00266] == 0) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00264] >= 30 && this.model.time.hours >= (14 - (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00264] / 30)) && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00266] > 0) {
            ...
            //If Relationship with Nancy < 30
                ...
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00263] < 1)
                    this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00263] = 1;
                //[Choice: Strong, Light]
        ...
        strongStuff() {
            ...
            if (this.player.tou >= 30) {
                ...
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00264] += 10;
            }
            //[Else]
            else {
                ...
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00264] += 5;
            }
        ...
        lightStuff() {
            ...
            if (this.player.inte >= 20)
                this.outputText("  You realize that what look like almost-shoulder-length gloves over her hands must actually be shell-like portions of this exoskeleton.", false);
            this.outputText("\n\n", false);
            this.outputText("Once she gives you the drink, you take a tentative sip, and find it very sweet and refreshing, without seeming very strong or alcoholic.  It's very good, and you quickly have another.", false);
            //[If FirstTalkNancy = 0]
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00265] == 0) {
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00265]++;
                ...
                */
                ...
                if (this.player.humanScore() >= 4)
                    this.outputText("like you,", false);
                else
                    this.outputText("like poor little Yara at the earring shop,", false);
                ...
                if (AuntNancy.rand(2) == 0)
                    this.dynStats("int", 1 + AuntNancy.rand(2));
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00264] += 20;
            }
            //[Else:]
            else {
                this.outputText("As you sip your drink, you and Nancy swap adventuring stories for a while, enjoying one another's company in the fairly quiet bar.  The older spider-lady is a good conversationalist, and you feel a little closer for having shared some time with her.", false);
        ...
        timeForAuntNancySpiderCooch() {
            ...
            this.outputText("She leads you through the streets of Tel'Adre, weaving through crowds and back alleys, before you finally end up just outside a modest little adobe building tucked away in a side street.  Slowly, she wraps all four of her arms around you, giving you a gentle hug", false);
            if (this.player.biggestTitSize() >= 1)
                this.outputText(" and taking the opportunity to grope your " + this.player.allBreastsDescript() + " right through your " + this.player.armorName, false);
            this.outputText(".\n\n", false);
            ...
            this.outputText("Then, she lets go of you and skitters easily up to her door, opening it and slipping inside.", false);
        ...
        auntNancyPoonPartII() {
            ...
            //[If PillowTalk = 0]
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00266] == 0)
                this.outputText("\"<i>It's... been a long, long time,</i>\" murmurs Aunt Nancy, her throaty voice washing over you, as two of her hands rest on your " + this.chestDesc() + " and the other two wrap carefully around your shoulders and neck, gently rubbing you in the promised massage.  She's crawling along the web, her many feet easily avoiding the sticky parts, and her face is mere inches from yours.  You can smell her sweet, slightly alcohol-scented breath as her many eyes look down at you.  \"<i>I haven't... been with anyone since I lost my husband, and... well... I... I need this.  Will you please be with me, if only for a little while?</i>\"\n\n", false);
            else
                this.outputText("\"<i>Are you ready for me, friend?</i>\" murmurs Aunt Nancy, her throaty voice washing over you, as two of her hands rest on your " + this.chestDesc() + " and the other two wrap carefully around your neck and shoulders, gently rubbing you in the promised massage. She's crawling along the web, her many feet easily avoiding the sticky parts, and her face is mere inches from yours. You can smell her sweet, slightly alcohol-scented breath as her many eyes look down at you.  \"<i>I certainly am, little fly.</i>\"\n\n", false);
            ...
            if (this.player.inte > 40)
                this.outputText("realize that the spit must contain some kind of chemical originally meant to still prey", false);
            else
                this.outputText("question whether or not the spider-lady's kiss is responsible", false);
            this.outputText(".\n\n", false);
            ...
            if (this.player.isNaga())
                this.outputText("Gently, she peels away the fold of skin that disguises your genitals, now moist-and-dripping with anticipation.  ", false);
            ...
            if (this.player.balls > 0) {
                this.outputText("She smiles at the sight of your " + this.ballsDescriptLight() + ", gently raising two of her hands to fondle and squeeze them as her soft lips press against them, ", false);
                //[If BallSize allows]
                if (this.player.ballSize < 15) {
                    if (this.player.ballSize > 5 && this.player.ballSize < 15)
                        this.outputText("taking one", false);
                    else
                        this.outputText("both of them", false);
                    this.outputText(" into her mouth to soak in her saliva as she wraps and caresses ", false);
                    ...
                    this.outputText("kissing and licking at them with those moist, relaxing lips.\n\n", false);
            }
            //[If you have a vagina:]
            if (this.player.hasVagina()) {
                this.outputText("The spider lady ", false);
                if (this.player.balls > 0 && this.player.hasCock())
                    this.outputText("lifts away your other \"<i>equipment</i>\" and ", false);
                this.outputText("examines the folds of your " + this.vaginaDescript(0) + ".  You shiver at the sensation of one of her smooth, cold hands rubbing against your folds, the tips of her fingers sliding into you.  Aunt Nancy smiles up at you, enjoying your reaction.  \"<i>Did you like that?</i>\" she asks with her deliciously throaty voice, and you nod enthusiastically.  \"<i>Good...</i>\" she purrs, before slipping her long, slippery tongue inside of you.  You cry out in sudden surprise at the sudden feeling of it moving inside of you, exploring your shape, before she pulls it out as you squirm.  \"<i>Mmmmmm...</i>\" Aunt Nancy murmurs.  \"<i>You taste goood, friend.</i>\"\n\n", false);
            }
            //[If you have a penis:] 
            if (this.player.hasCock()) {
                this.outputText("Aunt Nancy gently caresses your " + this.multiCockDescriptLight() + " with her smooth black hands, enjoying your moans of delight, before lowering her head to kiss the head of your " + this.cockDescript(0) + ".  Her tongue snakes around it, and the spider-lady sucks a little, drinking up the little stream of pre-cum now leaking out, before raising her head up to look at you, a gentle smile on her face as her many hands continue to rub and explore your " + this.multiCockDescriptLight() + ".  \"<i>Not as good as my husband's,</i>\" she whispers, \"<i>but quite a piece, certainly.</i>\"\n\n", false);
            }
            //[If you have no genitals at all:]
            if (this.player.gender == 0)
                this.outputText("\"<i>Well, well, well,</i>\" murmurs Aunt Nancy, intrigued by what she sees.  \"<i>Very unorthodox, but we'll see what we can do.</i>\"  She pauses to lick the fleshy expanse where your genitals used to be.\n\n", false);
            //[All:] 
            this.outputText("Two of her hands suddenly wrap themselves around the cheeks of your " + this.buttDescript() + ", and squeeze gently.  \"<i>Very nice,</i>\" the spider-lady whispers, and then her long tongue spools out to slide over the surface of your " + this.buttDescript() + ".  The tip of it even slips inside, gently, and you feel her saliva coating the inside of your bum.  It feels sensitive, and much more relaxed now than a minute ago.\n\n", false);
            if (this.player.hasCock())
                this.outputText("Aunt Nancy rises up above you, still smiling with gentle sensuality, and reaches out.  ", false);
            ...
            if (this.player.hasCock()) {
                this.outputText("Gently, she picks " + this.oMultiCockDesc() + ", and brings it up to her pussy. You see its entrance, two parted shell-plates dripping wet fluid, and would almost panic at the unfamiliar sight if you weren't so very relaxed.  With loving guidance, Aunt Nancy slides the full length of your " + this.cockDescript(x) + " deep inside of her.  Both of you moan in delight as your dick rubs and stimulates her in a way she's clearly been missing for a long, long while; her exotic insides, smooth and silky and deep, squeeze and caress your " + this.cockDescript(x) + " like a velvet glove.  Little feelers inside of her begin to massage your cock, and the wet, dripping fluids inside of her are just as relaxing as her saliva.\n\n", false);
                ...
                var titFucked = false;
                var y = this.player.longestCock();
                //[If your longest dick is of at least auto-titfucking size:]
                if (this.player.cockTotal() >= 2) {
                    if (this.player.cocks[y].cockLength >= 22) {
                        titFucked = true;
                        this.outputText("As Aunt Nancy rides you enthusiastically, the spider-lady lifts ", false);
                        if (this.player.totalCocks() > 2)
                            this.outputText("another one of ", false);
                        this.outputText("your ", false);
                        if (this.player.cockTotal() == 2)
                            this.outputText("other cock ", false);
                        else
                        ...
                        this.outputText("Still rising and falling atop your body as she rides you, Aunt Nancy grips her breasts with two of her black-shelled hands and begins to slide them up and down on either side of your tall, dripping " + this.cockDescript(y) + ", ", false);
                        if (this.player.cocks[y].cockLength >= 30)
                            this.outputText("letting its head slip into her mouth, where she sucks and licks at it hungrily, ", false);
                        else
                            this.outputText("letting her long, dexterous tongue dangle down from her mouth to wrap around the head of her dick, occasionally licking at her own impressive bosom as well, ", false);
                        this.outputText("all the while staring down into your eyes.\n\n", false);
                        this.outputText("The sensation, both of her soft, pillowy bosom wrapped around your " + this.cockDescript(y) + " and of her skillful tongue", false);
                        //[If CockDescript (Longest Cock) is long enough for auto-fellatio]
                        if (this.player.cocks[y].cockLength >= 30)
                            this.outputText(" and mouth", false);
                    ...
                    if (this.player.cockTotal() > 2) {
                        if (this.player.cockTotal() == 3)
                            this.outputText("Another of her hands wraps itself around your other cock", false);
                        else
                            this.outputText("Her other hands wrap themselves around more of your cocks", false);
                        this.outputText(", milking and stroking the ", false);
                        this.outputText("pulsating prick", false);
                        if (this.player.cockTotal() > 3)
                            this.outputText("s", false);
                        this.outputText(" for all ", false);
                        if (this.player.cockTotal() == 3)
                ...
                if (!titFucked || (titFucked && this.player.cockTotal() <= 2)) {
                    this.outputText("Her remaining hands gently work their way across your body, alternating between rubbing and squeezing your " + this.buttDescript() + ", even sometimes slipping fingers inside to probe the insides, ", false);
                    //[If the player has balls]
                    if (this.player.balls > 0)
                        this.outputText("gently kneading and caressing your " + this.ballsDescriptLight() + " as the cum inside churns and boils and ", false);
                    //[If the player has a vagina]
                    else if (this.player.hasVagina())
                        this.outputText("exploring the folds and creases of your " + this.vaginaDescript(0) + " and ", false);
                    this.outputText("massaging your " + this.chestDesc() + ".  Occasionally, they stroke through your " + this.hairDescript() + ".\n\n", false);
                }
            }
            //[If player has vagina but no dicks: (Nancy prefers dicks and will always choose them over lesbian sex)]
            else if (this.player.hasVagina()) {
                this.outputText("Gently, Aunt Nancy leans down to stroke your face as two of her other hands reach out and begin caressing your chest, while a fourth explores the outer folds of your " + this.vaginaDescript(0) + ".  \"<i>Such a pretty little fly,</i>\" the spider-lady whispers as she stares at your face, her bright red eyes full of longing.   She presses her face against the side of your head, and you gently turn it to allow her access to your ear, which she quickly slips her tongue into again, enjoying the feeling as you quiver and yelp beneath her.\n\n", false);
                ...
                this.outputText("Such thoughts are interrupted when you suddenly feel Aunt Nancy's fingers on the lower half of your body again, caressing your ", false);
                if (this.player.tailType > appearanceDefs_1.TAIL_TYPE_NONE)
                    this.outputText("tail before rising to your ", false);
                this.outputText(this.vaginaDescript(0) + " and " + this.buttDescript() + ".  Aunt Nancy turns your head to face hers, and rises up onto her legs again as her fingers begin to sink deep into your " + this.vaginaDescript(0) + " and your " + this.assholeDescript() + ".  You moan, loudly and long at the sensation, and Aunt Nancy smiles lewdly, her other hands still exploring and squeezing your " + this.chestDesc() + ", rubbing and kneading them softly and occasionally pinching and pulling at your " + this.nippleDescript(0) + "s.\n\n", false);
                this.outputText("Suddenly, you realize that your left hand is now free, courtesy of one of Aunt Nancy's smooth, gentle arms.  She whispers, quietly, \"<i>A little for me too, please.</i>\"  Realizing exactly what she means, you press the " + this.player.skinFurScales() + " of your hand against her pussy.  Its entrance, two parted shell-plates dripping wet fluid, would almost be scary if you weren't so very relaxed.  Gently, your press your fingers into her body, and hear her moan, loudly, feel her own hands scrabbling inside of your " + this.vaginaDescript(0) + " and " + this.assholeDescript() + ", pawing your chest and " + this.buttDescript() + ", trailing through your " + this.hairDescript() + ".\n\n", false);
            ...
            //[If the PC has no genitals at all:]
                ...
                this.outputText("Gently, Aunt Nancy leans down to stroke your face as two of her other hands reach out and begin stroking your " + this.chestDesc() + " while a fourth explores the smooth, fleshless expanse where your genitals once were.  \"<i>Such a pretty little fly,</i>\" the spider-lady whispers as she stares at your face, her bright red eyes full of longing.  She presses her face against the side of your head, and you gently turn it to allow her access to your ear, which she quickly slips her tongue into again, enjoying the feeling as you quiver and yelp beneath her.\n\n", false);
                this.outputText("With your face turned, you suddenly spot a once-well-made dildo lying on the floor beneath the web.  You see that it has been worn down as smooth as an apple rind and probably much thinner than it was before, and you suddenly wonder just how pent up the widow's sexual desires really are.\n\n", false);
                this.outputText("Such thoughts are interrupted when you suddenly feel Aunt Nancy's fingers on the lower half of your body, caressing your " + this.buttDescript() + " before rising again to your lack of genitals.\n\n", false);
                this.outputText("Smiling at the puzzle before her, Aunt Nancy gently runs her hands over your " + this.nippleDescript(0) + "s and " + this.hairDescript() + " as she thinks over how best to make love to you.  Gently, her white-haired head returns to your " + this.buttDescript() + ", and her long tongue snakes out again, sliding between its lobes.  As you relax, it slips inside of you, just far enough for you to moan at the nigh-sexual pleasure of total relaxation.  The spider-lady removes her tongue from your anus, much to your dissatisfaction, and carefully wipes it off on a nearby bit of cloth before returning it to her mouth, then, smiling up at your petulant expression, slips a few of her fingers into your now-loose and sensitive " + this.assholeDescript() + ".\n\n", false);
                ...
                this.outputText("Suddenly, you realize that your left hand is now free, courtesy of one of Aunt Nancy's smooth, gentle arm.  She whispers, quietly, \"<i>A little for me too, please.</i>\"  Realizing exactly what she means, you press the " + this.player.skinFurScales() + " of your hand against her pussy.  Its entrance, two parted shell-plates dripping wet fluid, would almost be scary if you weren't so very relaxed.  Gently, your press your ingers into her body, and hear her moan, loudly, feel her own hands scrabbling inside of your " + this.assholeDescript() + ", pawing your chest and " + this.buttDescript() + ", trailing through your " + this.hairDescript() + ".\n\n", false);
                this.outputText("It feels wonderful.  You lie back and moan, enjoying the smooth, silky insides of her pussy, feeling tiny feelers occasionally caress and pull at your fingers inside of her.\n\n", false);
                //[If PC is lactating:]
                if (this.player.biggestLactation() >= 1)
                    this.outputText("As milk leaks slowly from your " + this.nippleDescript(0) + "s, the spider-lady notices. She lowers her head and wraps her soft, lovely lips around the tip of one of your " + this.player.allBreastsDescript() + ", sucking gently and frantically flicking her tongue against your " + this.nippleDescript(0) + ".  You moan and lie back into the web, the multitude of sexual pleasures assaulting your senses almost more than you can bear as Aunt Nancy begins swallowing up your milk.\n\n", false);
        ...
        auntNancyPoonPartIII() {
            ...
            if (this.player.hasCock()) {
                var x = this.player.shortestCockIndex();
                var y = this.player.longestCock();
                this.outputText("You can feel it when the spider-lady's pussy begins to quiver in delight. Aunt Nancy soon moans, then cries out in incredible pleasure.  The lower half of her eyes all close, while the others all roll up into her head in ecstasy.  \"<i>Yes!  YEEEEESSSSSSS!</i>\" she hisses with throaty, feminine indulgence.  The tiny feelers in her otherwise silky-smooth vagina suddenly begin to squeeze and pull at your " + this.cockDescript(x) + ", and you let out a bellow of pleasure of your own as you feel your ", false);
                //[If PC has balls]
                if (this.player.balls > 0)
                    this.outputText(this.ballsDescriptLight() + " tense, churning and tightening.", false);
                //Else:]
                else
                    this.outputText("body tensing in preparation for letting out your seed.", false);
                this.outputText("\n\n", false);
                this.outputText("You cum, and cum hard.  Thick wet jets of sticky semen pour into Aunt Nancy's seemingly-bottomless pussy, whose feelers and soft, smooth interior continue to rub at and stroke your " + this.cockDescript(x) + " even as it vents the immense pressure in your " + this.ballsDescriptLight() + ". If anything, the constant powerful surges seem to be extending and intensifying the spider-lady's orgasm.", false);
                //[If PC has cum multiplier of at least 2] 
                if (this.player.cumQ() >= 750)
                    this.outputText("  Sooner or later though, even her marvelous body can simply contain no more of your jizz, and she slips her swollen cunt up off of your organ, letting it continue squirting your thick, plentiful cum all over her as it swings free.", false);
                this.outputText("\n\n", false);
                //[If PC has another dick of at least auto-titfucking size:]
                if (this.player.cocks[y].cockLength >= 22 && this.player.cockTotal() > 1) {
                    this.outputText("Aunt Nancy unwraps her tongue from your " + this.cockDescript(y) + " to cry out in delight, even as her hands let go of her lovely breasts to grab at your trunk.  Nonetheless, her big, pillowy boobs are more than firm enough to keep the shaft of your " + this.cockDescript(y) + " snugly inside as she bucks and shrieks atop you, and they more than contribute to your own sexual pleasure.\n\n", false);
                    this.outputText("It too spasms, spitting gooey ropes of cum all over both of you", false);
                    //[If PC has cum multiplier of at least 2]
                    if (this.player.cumQ() >= 750)
                        this.outputText(", some even reaching to the ceiling to fall into her short, pretty white hair and splattering over her trailing abdomen", false);
                    this.outputText(".\n\n", false);
                }
                //[If there are still dicks left over:]
                if (this.player.cockTotal() > 2) {
                    ...
                    if (this.player.cockTotal() > 1) {
                        ...
                        //[Else] 
                            ...
                            this.outputText("The rest of your " + this.multiCockDescriptLight() + " fire off too, her smooth, shell-covered hands still wrapped around them, and they make even more of a mess, splattering over both of you.\n\n", false);
                    }
                }
                ...
                if (this.player.hasVagina()) {
                    ...
                    if (this.player.balls == 0 && (this.player.cocks[y].cockLength < 22 || (this.player.cocks[y].cockLength >= 22 && this.player.cockTotal() <= 2)))
                        this.outputText("squeezing the fingers on Aunt Nancy's hand still tickling your insides", false);
                    else
                        this.outputText("making you long for something inside of it", false);
                    this.outputText(", as " + this.sMultiCockDesc() + " spasms in ecstacy.\n\n", false);
                }
                //[All w/ penis:]
                this.outputText("Eventually, both your orgasms end.  You feel worn out, like you just ran a long mile, even though Aunt Nancy was doing most of the work.  However, she seems fine, smiling down at you with a big, happy grin.", false);
                //[If the PC has multiple dicks or a cum multiplier of at least 2]
                if (this.player.cockTotal() >= 2 && this.player.cumQ() >= 700)
                    this.outputText("  Her lower body's a mess of smeary dollops of cum, right up to the bottom halves of her impressive boobs, and her face and upper body haven't fared much better. Behind her you can see where stray shots that sprayed over her have painted streaks of her abdomen white.", false);
                this.outputText("\n\n", false);
                //[If the PC has multiple dicks or a cum multiplier of at least 2] 
                if (this.player.cockTotal() >= 2 && this.player.cumQ() >= 700)
                    this.outputText("Aunt Nancy runs one hand up her milky-pale body, digging a wide furrow in the thick layer of gooey cum as it moves up her belly and up the curve of her breast, before she peels it away and lifts it in front of her mouth.", false);
                else
                    this.outputText("Aunt Nancy puts one hand beneath her dripping pussy and squeezes some powerful internal muscle.  A thick dollop of gooey cum falls onto it from inside of her, and she lifts it in front of her mouth.", false);
                this.outputText("  Snaking her long tongue around her fluid-smeared hand, the spider-lady licks up a thick load of the contents of your ", false);
                if (this.player.balls > 0)
            ...
            //[Else:]
                ...
                //[If PC has a vagina:]
                if (this.player.hasVagina())
                    this.outputText(this.vaginaDescript(0) + " and ", false);
                ...
                if (this.player.wetness() >= 5 || this.player.biggestLactation() >= 1)
                    this.outputText("  Her hands are soon drenched in your body's wonderful secretions, just as your", false);
                else
                    this.outputText("  Your", false);
                this.outputText(" fingers are soon soaked in the lovely, sweet-smelling juices of her pussy.\n\n", false);
                this.outputText("Eventually, the sensation subsides, and she gently slides her fingers from your ", false);
                //[If PC has a vagina:] 
                if (this.player.hasVagina())
                    this.outputText(this.vaginaDescript(0) + " and ", false);
                this.outputText(this.assholeDescript() + ".  You feel worn out, like you just ran a long mile, even though Aunt Nancy was doing most of the work, and you let your arm fall back down against the sticky surface of her web.  However, she seems fine, smiling down at you with a big, happy grin.", false);
                //[If PC has a vagina:] 
                if (this.player.hasVagina())
                    this.outputText("  Lifting the smooth, soaked hand that has only just been soaked in the juices of your " + this.vaginaDescript(0) + " in front of her mouth, Aunt Nancy smiles at you.  Snaking her long tongue around her fluid-smeared hand, the spider-lady licks up the fluid with every sign of enjoyment.  \"<i>Mmmmm...</i>\" she purrs.  \"<i>You DO taste good.</i>\"\n\n", false);
            }
            //[All]
            ...
            this.outputText("\"<i>Not a chance on Marae's green earth, friend,</i>\" she purrs, her voice like hoarse velvet as she rubs the surface of her still-needy pussy against your belly.  \"<i>I haven't had a lover in my bed in more than ten years, and you're not going anywhere until I say you can.</i>\"  That last part was punctuated with a wicked squeeze of your " + this.buttDescript() + ", and Aunt Nancy presses her lips to yours again, much less gently and more passionately this time.  You moan into her mouth, feeling her aphrodisiacal bodily fluids seeping in, and, as she soon frees your upper body and presses your head into her soft, silky pussy, you know she's right.\n\n", false);
        ...
        auntNancyPoonPartIV() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00266] == 0) {
                this.outputText("You awaken on Aunt Nancy's \"<i>bed,</i>\" an unbelievably comfortable pile of discarded, non-sticky webbing, your head still resting on her comfortable, pillowy bosom.  Slowly, you manage to sit up, tenderly massaging your aching body, especially your ", false);
                if (this.player.gender > 0)
                    this.outputText("genitals", false);
                else
                    this.outputText("jaw", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00266] += 1;
            this.doNext(this.camp.returnToCampUseTwoHours);
        }
    }
    exports.AuntNancy = AuntNancy;
});
//# sourceMappingURL=AuntNancy.js.map