define(["require", "exports", "./TelAdreAbstractContent", "../../../GlobalFlags/kFLAGS", "../../../PerkLib"], function (require, exports, TelAdreAbstractContent_1, kFLAGS_1, PerkLib_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Maddie extends TelAdreAbstractContent_1.TelAdreAbstractContent {
        //VARS
        ...
        procMaddieOneIntro() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00240] == 0) {
                ...
                if (this.player.tallness < 72)
                    this.outputText("looking down at", false);
                else if (this.player.tallness < 100)
                    this.outputText("staring levelly at", false);
                else
                    this.outputText("glaring up at", false);
                this.outputText(" you. It releases your shoulder and starts walking towards an 'employees only' door.  Do you follow?\n\n", false);
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00240] = 1;
            }
            //(REPEAT) 
            else {
        ...
        followMinotaurIntoBackroom() {
            this.outputText("", true);
            //	(Not yet explained) 
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00241] == 0) {
                ...
                if (this.player.findPerk(PerkLib_1.PerkLib.MinotaurCumAddict) >= 0)
                    this.outputText("You lick your lips when you realize you're meeting the source of the 'special' éclairs.", false);
                else
                    this.outputText("You blush when you realize what he must be using for cream filling.", false);
                //[Give Them] [Leave]
                ...
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00241] = 1;
            }
            //(Explained) 
            else {
                ...
                if (this.player.hasItem(this.consumables.BEEHONY) && this.player.hasItem(this.consumables.L_DRAFT))
                    ...
                    this.simpleChoices("No", this.nopeAintGotNoneODemSpeculIngredimathings, "", undefined, "", undefined, "", undefined, "", undefined);
            }
        }
        //[Not Yet/No]
        nopeAintGotNoneODemSpeculIngredimathings() {
            ...
            if (this.player.cor > 50)
                this.outputText("starting a fight inside Tel'Adre", false);
            else
                this.outputText("overstaying your welcome", false);
        ...
        handOverIngredientsItBeBakingTimeYo() {
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.MinotaurCumAddict) >= 0)
                this.outputText("  You lurch forward involuntarily, craving the rest of his jism, but he pushes you into the wall and grunts, \"<i>No,</i>\" in a tone that brooks no disagreement.  It actually shocks you out of your addicted haze.", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.MinotaurCumAddict) >= 0)
                ...
                this.outputText("You aren't sure you want to.", false);
            this.outputText("\n\n", false);
            if (this.player.findPerk(PerkLib_1.PerkLib.MinotaurCumAddict) >= 0)
                this.doNext(this.waitForSlutCake);
            //[Wait] [Sneak Out]
            else
                this.simpleChoices("Wait", this.waitForSlutCake, "Sneak Out", this.sneakAwayFromMaddie, "", undefined, "", undefined, "", undefined);
        }
        //[Sneak Out]
        sneakAwayFromMaddie() {
            this.outputText("", true);
            ...
            //(No more mino chef)
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00242] = -2;
        ...
        waitForSlutCake() {
            ...
            if (this.player.cor < 33)
                this.outputText("antsy", false);
            else if (this.player.cor < 66)
                this.outputText("nervous about this whole thing", false);
            else
                this.outputText("intrigued by this whole thing", false);
            ...
            if (this.player.cor < 50)
                ...
                this.outputText("you sip on it while you wait", false);
        ...
        runAwayFromMaddiiiieee() {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00242] = -1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        talkToMaddie() {
            ...
            this.outputText("The cock-crazed confection looks down at you and nods, a satisfied smile spreading over glistening, pale blue lips.  She breathlessly exclaims, \"<i>My creat- cr... Dad ", false);
            if (this.player.hasCock())
                this.outputText("is like, all out of icing mix!  So I'm going to borrow a few cups from you, 'kay?", false);
            else
                this.outputText("gave me so much icing mix, and you like, would look soooo much better with some vanil- van... yummy frosting!", false);
            ...
            if (this.player.hasCock()) {
                ...
                if (x < 0)
                    x = 0;
                this.outputText("\"<i>Dad said my name is Madeleine, but that's no fun.  Just call me Maddie.  You've got lots of icing like Dad, right?  I-I... need more icing.  It's in my recipe,</i>\" says Maddie.  The baked broad strips your " + this.player.armorName + " to expose your " + this.multiCockDescriptLight() + ".  Cooing with excitement, she examines your ", false);
                if (this.player.lust >= 75)
                    this.outputText("rock-hard", false);
                else
                ...
                if (this.player.cor < 33)
                    this.outputText("You muster as much authority as you can in such a compromising position and explain to Maddie that what comes out of there is NOT icing.", false);
                else if (this.player.cor < 66)
                    this.outputText("You offhandedly mention that you don't actually make icing.", false);
                else
                    this.outputText("You smirk and mention that what you squirt isn't quite icing.", false);
                this.outputText("  \"<i>Liar!  If that wasn't icing, then why would Daddy have put his in all those eclairs and me?</i>\" retorts the busty cupcake, continuing on to say, \"<i>I know, I can suck it out!</i>\"  She purses her jelly-like lips and plunges forward, slurping all " + Maddie.num2Text(Math.floor(this.player.cocks[x].cockLength)) + " inches into her oven-warmed esophagus.  Your protests are cut off by the tightness squeezing around your " + this.cockDescript(x) + ".  It milks you in rippling motions, buttery-slick and pulsing hungrily.\n\n", false);
                this.outputText("A half-melted tongue ", false);
                if (!this.player.hasSheath())
                    this.outputText("encircles the base", false);
                else
                    this.outputText("pokes and prods into your sheath", false);
                this.outputText(", leaving a syrupy residue trailing over your " + this.cockDescript(x) + ".  You groan, sagging into the sugary suspension.  The strength is completely gone from your limbs, stolen by the pastry's prick-devouring maw.  Her shining eyes look up to gloat once she realizes how completely you've submitted to her ministrations, and in no time, her cake-soft hands catch and squeeze your " + this.cockDescript(x) + " into the gargantuan swell of her spongy breasts.  A smile crosses your face as you get pleasured by the motherly mounds and the familiar, sweet smell that Maddie exudes.\n\n", false);
                this.outputText("Suction starts, hollowing the cupcake-girl's plush cheeks into a concave, cock-slurping form.  The constant squeezing of your " + this.cockDescript(x) + " combines with the sucking to make you swell larger inside Maddie's gullet while she kisses your groin.  The confection's oral charms show no signs of stopping as she noisily slurps away at her treat, and her pillowy breasts are so spongy-soft and calming that you're happy to let her sample your 'icing' if it means you can feel like this.  Your " + this.hipDescript() + " push back into the baby blue lips, pumping and thrusting as your instinct to fuck and breed takes over, working your " + this.cockDescript(x) + " in and out of the pastry's puckered mouth.\n\n", false);
                this.outputText("Maddie pushes further forward, her bosom crushing you against the wall to hold your hips immobile while she sucks harder and harder.  Your cock balloons from the suction, thickening inside her neck and beginning to twitch from the irresistible fellative pleasure. An orgasm grows in your " + this.ballsDescriptLight(), false);
                if (this.player.balls > 0)
                    this.outputText(", the cum-heavy spheres bouncing in your twitching sack as they get ready to explode", false);
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText(", your " + this.cockDescript(x) + " emptying every drop of jizz into the baked cum-tank.", false);
                else {
                    this.outputText(" while her skin absorbs the generous donation of your other member", false);
                    if (this.player.cockTotal() > 2)
                        this.outputText("s", false);
                    this.outputText(".", false);
                }
                this.outputText("  When the jizz-guzzling pastry-girl pulls back at last to free your empty member, it's coated from top to bottom in gooey blue jelly, though it's tinged white in places.  The milked-out member slowly softens", false);
                if (this.player.cockTotal() > 1) {
                    if (this.player.cockTotal() == 2)
                        this.outputText(" along with your other penis", false);
                    else
                        this.outputText(" along with your other dicks", false);
                }
                ...
                this.outputText("Oven-warmed tiles kiss your exposed " + this.buttDescript() + " as you're gently placed on the floor next to your discarded equipment.  Exhausted and satiated as you are, your eyes drift closed, lulling you into slumber.\n\n", false);
            ...
            //(FEMALE/Genderpoots) 
                ...
                this.outputText("\"<i>Shhh, shhh... that's a good " + this.player.mf("boy", "girl") + ".  Isn't my icing the absolute best?</i>\" she verbally gushes, just like the nipple between your teeth.  \"<i>Drink up", false);
                if (this.player.thickness < 60)
                    this.outputText(", you're looking awful thin", false);
                else if (this.player.tone >= 70)
                    this.outputText(", you look like you're carved from stone.  A little softness would do you good", false);
                else
                    this.outputText(", you look like you'd better eat to keep up your gorgeous figure", false);
                ...
                if (this.player.thickness < 60 || this.player.tone >= 50)
                    ...
                    this.outputText("more forward than normal", false);
                ...
                this.outputText("Once the beast-man has finished talking you realize the cupcake-girl, Madeleine, is standing behind him.  Her blue-iced 'clothes' have been remade, shaped into a form-fitting apron that accentuates her massive, otherworldly curves.  The minotaur chef utters, \"<i>We go now.  Get dressed.  Maybe sometime can visit Maddie.</i>\"  Maddie claps her hands, bouncing and jiggling with excitement as the two of them leave you there to get dressed.", false);
                this.outputText(this.player.modThickness(100, 10), false);
                this.outputText(this.player.modTone(0, 10), false);
            }
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00242] = 3;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        bakeryEpilogue() {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00242] = 4;
            this.doNext(this.telAdre.bakeryScene.bakeryuuuuuu);
        }
    }
    exports.Maddie = Maddie;
});
//# sourceMappingURL=Maddie.js.map