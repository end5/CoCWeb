define(["require", "exports", "./AbstractBoatContent", "../../../CoC", "../../../GlobalFlags/kFLAGS", "../../../StatusAffects", "../../../CockTypesEnum", "../../../PerkLib", "../../../Appearance", "../../../../../includes/appearanceDefs"], function (require, exports, AbstractBoatContent_1, CoC_1, kFLAGS_1, StatusAffects_1, CockTypesEnum_1, PerkLib_1, Appearance_1, appearanceDefs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Marae extends AbstractBoatContent_1.AbstractBoatContent {
        constructor() {
            super();
        ...
        timeChange() {
            if (this.model.time.hours > 23) {
                if (this.flags[kFLAGS_1.kFLAGS.CORRUPT_MARAE_FOLLOWUP_ENCOUNTER_STATE] > 0) { //Marae met 2nd time?
                    if (this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_KILLED] == 0) { //If flower hasn't been burned down yet
                        if (this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_LEVEL] < 4 && this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER] < 1000) { //Grow flower if it isn't fully grown.
                            this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_GROWTH_COUNTER]++;
                        }
                    }
                }
                if (this.flags[kFLAGS_1.kFLAGS.HOLLI_FUCKED_TODAY] == 1)
                    this.flags[kFLAGS_1.kFLAGS.HOLLI_FUCKED_TODAY] = 0; //Holli Fuck Tracking
            }
            return false;
        }
        timeChangeLarge() {
        ...
        encounterMarae() {
            ...
            this.outputText(this.images.showImage("marae-first-encounter"));
            this.outputText("Like a hidden emerald jewel, a small island appears in the distance.  You wager that you're somewhere near the center of this lake.  How coincidental.   You row closer, eager to get out of the boat and stretch your " + this.player.legs() + ".  The rowboat grounds itself in the moist earth of the island, coming to a dead stop.   You climb out, noting that this island is little more than a raised mound of earth and grass, with a small tree perched atop its apex.  ", false);
            //Dungeon operational
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) < 0) {
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetMarae) < 0) {
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.MetMarae, 0, 0, 0, 0);
                    this.outputText("You approach the tree and note that its bark is unusually smooth.  Every leaf of the tree is particularly vibrant, bright green with life and color.   You reach out to touch the bark and circle around it, noting a complete lack of knots or discoloration.  As you finish the circle, you are surprised to see the silhouette of a woman growing from the bark.  The transformation stops, exposing the front half a woman from the waist up.   You give a start when she opens her eyes – revealing totally white irises, the only part of her NOT textured with bark.\n\n", false);
                    if (this.player.cor > 66)
                        this.outputText("The woman bellows, \"<i>Begone demon.  You tread on the precipice of damnation.</i>\"  The tree's eyes flash, and you find yourself rowing back to camp.  The compulsion wears off in time, making you wonder just what that tree-woman was!", false);
                    //Explain the dungeon scenario
                    else {
                        this.player.createStatusAffect(StatusAffects_1.StatusAffects.MaraesQuestStart, 0, 0, 0, 0);
                        this.outputText("\"<i>You seem so surprised by me, Champion.   I suppose that is inevitable.  Your origin is not of Mareth, our land, and few save for the demons remember me,</i>\" says the tree.\n\n", false);
                        this.outputText("You take a step back, amazed to find such a creature, apparently uncorrupted.  ", false);
                        if (this.player.lib + this.player.cor > 80)
                            this.outputText("Your eyes can't help but take note of the tree-woman's shapely breasts, and wonder if they feel like tits or wood.  ", false);
                        this.outputText("Feeling a bit confused, you introduce yourself and ask her who she is.\n\n", false);
                        this.outputText("\"<i>Me?</i>\" she asks, \"<i>I am the life-goddess Marae.  I am Mareth, for my roots touch every part of it.   Or I was.  Before THEY came.</i>\"\n\n", false);
                        this.outputText("You suggest, \"<i>The demons?</i>\"\n\n", false);
                        this.outputText("She nods and continues, \"<i>The demons were once a tribe of magic-blessed humans, living in the mountains.  They had everything they could ever want:  peace, love, and the power to change reality.  But they grew dissatisfied, as men often do, and craved more.  They began using their magics to alter their bodies, seeking greater pleasure than ever before.  In time they became obsessed with it.  I let them be, believing their folly to be limited to their own village.   I was wrong.  While I focused on preventing famines and ensuring peace between the other villages, the humans twisted themselves into something else, something demonic.  They gave up their souls, crystallizing it into a magical energy source.    Of course they could not be satisfied with consuming the power of their own souls.  They wanted more.  They always want more.</i>\"\n\n", false);
                        this.outputText("You nod in understanding, paying close attention to the tree-goddess as she explains just how this realm has fallen so far, \"<i>They came pouring out of the mountains in a wave, picking off villages left and right.  I lent many villages my power, but none had the strength to stand alone, and none would band together, resentful of their racial differences as they were.   All were consumed, enslaved, or filled with corruption.   My people were cut off from me, either by their new tainted outlook or by the demons' own machinations.  I was able to hide a few places from the enemy's sight, but I do not know how long it will last.</i>\"\n\n", false);
                        ...
                        this.outputText("She practically begs, \"<i>Please champion, you must help me.  The demons have a factory at the foot of the mountains.  It produces much of the fluid they use to taint me.  If you could find a way to shut it down, I... all of Mareth, might stand a chance.</i>\"\n\n", false);
                ...
                //Second meeting
                    ...
                    if (this.player.cor > 66) {
                        ...
                        if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MaraesQuestStart) >= 0) {
                        ...
                        //If not
                            ...
                            this.outputText("She practically begs, \"<i>Please champion, you must help me.  The demons have a factory at the foot of the mountains.  It produces much of the fluids they use to taint me.  If you could find a way to shut it down, I... all of Mareth, might stand a chance.</i>\"\n\n", false);
                            this.outputText("You nod, understanding.  She commands, \"<i>Now go, there is nothing to be gained by your presence here.  Return if you manage to close that vile place.</i>\"\n\n", false);
                            if (this.player.lib + this.player.cor > 80) {
                                this.outputText("You could leave, but the desire to feel her breast will not go away.  What do you do?", false);
                                this.simpleChoices("Boob", this.grabHerBoob, "", undefined, "", undefined, "", undefined, "Leave", this.camp.returnToCampUseOneHour);
            ...
            //Dungeon inoperable
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) < 0) {
                    this.outputText("Marae smiles broadly at you, and steps free from her tree.  The lithe plant-goddess gives you a warm hug and a kiss on the cheek.\n\n", false);
                    this.outputText("\"<i>Thank you,</i>\" she says, breaking the hug and turning back to her tree, \"<i>The onslaught has lessened, and I feel more myself already.  Let me thank you for your heroic deeds.</i>\"\n\n", false);
                    this.outputText("She plunges a hand inside the tree and pulls out a small pearl.  \"<i>This is a pearl from the very depths of the lake, infused with my purity.  If you eat it, it will grant you my aid in resisting the lust and corruption of this land.</i>\"\n\n", false);
                    this.outputText("Marae pushes the pearl into your hand, and closes your fingers over it gently.  \"<i>Go now, there is still much to be done.  With luck we will not need each other again,</i>\" commands the goddess as she slips back into her tree.  ", false);
                    this.inventory.takeItem(this.consumables.P_PEARL, this.camp.returnToCampUseOneHour);
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.MaraeComplete, 0, 0, 0, 0);
                }
                //Corrupt!
                else {
                    this.outputText("You approach Marae's tree and note that the bark of the tree is smooth, practically wet looking.  The goddess's form is already exposed, as she leans out from the trunk and blows you a kiss.   Her breasts look as if they've filled out quite a bit since your first meeting, jiggling teasingly with every motion she makes.\n\n", true);
                    //First corrupt meeting
                    if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetCorruptMarae) < 0) {
                        this.player.createStatusAffect(StatusAffects_1.StatusAffects.MetCorruptMarae, 0, 0, 0, 0);
                        this.outputText("She smiles lewdly and beckons you to come closer.  \"<i>Do you like the new me?  I don't know why I was resisting this in the first place.   You shut down the factory, I could feel it in the ground, and I was so happy.  Then I realized HOW you shut down the factory.  I could feel it seeping into my roots.  I was so afraid, feeling that corruption flow through the ground back to me.   I promised myself I would kill you when you dared to show your face.   But then that warmth started flowing into me, and it just melted my anger and resolve,</i>\" she explains, pushing forwards a bit further out from the trunk.\n\n", false);
                        this.outputText("You watch as a tiny purple bud blooms below her belly button, just above her junction with the tree.  The petals unfurl into a very familiar shape, looking more like a vagina than a flower.  Marae reaches down and brushes her fingers across the outer petals, cooing in delight.   You glance up at her eyes and she's practically beaming – she knew where you were looking.\n\n", false);
        ...
        maraeStealLethicite() {
            ...
            this.outputText("", true);
            //(SUCCESS)
            if ((this.player.spe > 35 && (Marae.rand(this.player.spe / 3 + 30) > 20)) || (this.player.spe > 35 && this.player.findPerk(PerkLib_1.PerkLib.Evade) >= 0 && Marae.rand(3) < 2)) {
            ...
            //(FAIL)
                ...
                this.outputText("You dart to the side, diving into a roll that brings you up behind the tree.  You try to slip by the gauntlet of grabbing tentacles, but fail, getting tripped and ensnared in them like a fly in a spider's web.  You are pulled up and lifted to the other side of the tree, where you are slammed against it.  The tentacles pull your arms and legs wide, exposing you totally and locking you into a spread-eagle position.  You cringe as Marae strides around, free from the confines of her tree.\n\n", false);
                this.outputText("\"<i>Awwww, what a nasty deceitful little ", false);
                if (this.player.gender <= 1)
                    this.outputText("boy ", false);
                else
                    this.outputText("girl ", false);
                this.outputText("you are.  You turn me into a steaming hot sex-pot, then have the nerve to come here and try to walk off with my lethicite, all WITHOUT fucking me?  Tsk tsk tsk,</i>\" she scolds, \"<i>I appreciate your ambition, but I can't just let a mortal walk all over me like that.  I'll be taking that,</i>\" she says as she grabs the crystal, and lugs it to the tree underneath you.  She strokes the wood surface lovingly, and a knot dilates until it forms a hole large enough to contain the lethicite.  Marae shoves it inside, and strokes the wood like a pet creature, humming while the bark flows closed, totally concealing the crystal.\n\n", false);
                this.outputText("\"<i>Now, that should keep it safe from swift little play-toys like yourself.  What you tried was a bold move, and I respect that; initiative is to be rewarded.   So I'll let you go, just like that,</i>\" she says, snapping her fingers for emphasis.\n\n", false);
                this.outputText("The tentacles lower you to the ground, but do not release you from their tight embrace.\n\n", false);
                this.outputText("Marae steps closer, playing her fingers softly up your thigh, \"<i>BUT, you'll leave with a little something extra.  A gift from the new goddess of fertile unions...</i>\"\n\n", false);
                //DICK
                if (this.player.gender == 1 || (this.player.gender == 3 && Marae.rand(2) == 1)) {
                    this.outputText("She extends a hand expectantly, watching with detached concentration while a tentacle lowers from the tree into her palm.   Hips swaying sexually, she advances, peeling back the tentacle's outer layer.  It opens up to reveal a wet, gummy mouth.  She giggles and bumps the opening against your ", false);
                    if (this.player.cocks.length > 1)
                        this.outputText("largest ", false);
                    this.outputText(this.cockDescript(0), false);
                    this.outputText("'s tip.  Immediately a powerful suction draws your " + this.cockDescript(0) + " inside the tentacle-maw, burying you up to the base in squirming pleasure.   Marae watches the plant go to work, squeezing teasingly until you orgasm.  It takes mere moments for the gifted tentacle to achieve its goal.  Your cum makes a tasty treat for the plant-beast, and it sucks and sucks until your body feels empty and drained.\n\n", false);
                    this.outputText("\"<i>Oh that simply won't do,</i>\" Marae whispers, cupping your ", false);
                    ...
                    this.outputText(", \"<i>You'll be my prized breeder.</i>\"  The sharp point of a fingernail presses against your taint, scratching the skin.  \"<i>Just one tiny change to make,</i>\" exhales the goddess.  Pain explodes at the base of your crotch as it feels like her fingernail impales you, penetrating inches into your flesh.  You thrash in agony as it reaches something sensitive inside you.  You black out from pain and the shock of watching your blood flow down her arm.\n\n", false);
                    this.outputText("You feel warm, enclosed in comfort and pleasure.  Is this heaven?  No, your head is throbbing and your eyes are closed... you open them and discover you're still lying at the base of the tree.  That greedy tentacle is still locked around your " + this.cockDescript(0) + " pinning it in the throes of orgasm.  You watch thick bulges of cum pump up the tentacle, evidence of a truly garguantuan fluid output.  It goes on and on, and you realize the pleasure ought to drive you mad.\n\n", false);
                ...
                //FEM)
                    ...
                    this.player.createPerk(PerkLib_1.PerkLib.MaraesGiftFertility, 0, 0, 0, 0);
                    this.doNext(this.camp.returnToCampUseOneHour);
                }
            }
        }
        level2MaraeEncounter() {
            this.spriteSelect(40);
            this.flags[kFLAGS_1.kFLAGS.CORRUPT_MARAE_FOLLOWUP_ENCOUNTER_STATE] = 1;
            this.outputText("", true);
            ...
            if (this.player.str > 70)
                this.outputText(" with ease", false);
            this.outputText(", a familiar island resolves itself in the center of the lake.  There's a familiar tree perched atop it, though the wriggling tentacles' silhouette against the sky are a cruel reminder that this island will no longer be the peaceful haven it once was.  ", false);
            if (this.player.cor < 33)
                this.outputText("Knowing all too well what kinds of horrors await", false);
            else if (this.player.cor < 66)
                this.outputText("Knowing all too well what kinds of sexual escapades lurk ahead", false);
            else
                this.outputText("Worried about enjoying the pleasures of the island overmuch", false);
            this.outputText(", you dip your oars into the water and yank the boat around.  Something \"thunk\"s off the bottom of the boat, making the wood shiver and spurring you to row with renewed vigor.  You churn the water with your frenzied rowing, but the island never seems to get any further away.   Frustrated by the definitive lack of progress, you fearfully peer over the edge of the old boat's hull.  \"<i>Well, that explains it,</i>\" you muse.\n\n", false);
            this.outputText("Squirming roots are crawling over the boat's underside.  They dig into every crease and crevice, binding the vessel tightly in place.  Just as you start to ponder swimming for the shore, the boat shifts, ", false);
            if (this.player.spe < 50)
                this.outputText("dropping you flat on your ass", false);
            else
                this.outputText("nearly dropping you flat on your ass before you catch yourself and sit down", false);
            this.outputText(".  The old dinghy's cutting through the water with amazing speed, leaving foot-high waves in its wake.  Marae's island grows larger with each passing second, almost taunting you with your inability to get away.   By now the root-like vines have crept over the gunwales, and they wriggle at you, seemingly in warning.  Getting in the water is definitely not a good idea right now.	The bone-chilling scrape of sand on wood grates at your ears.  You've arrived.  There's no point in putting off the inevitable.  You straighten up your " + this.player.armorName, false);
            if (this.player.weaponName != "fists")
                this.outputText(", adjust your " + this.player.weaponName + ",", false);
            this.outputText(" and step out of the boat onto the small, sandy beach that rings the island.  The tentacles that dragged your boat ashore are gone, leaving the well-used vessel in pristine condition, or as close as any such water-craft can be.  Looking up, you behold the monstrous, demonic-tree that sprouts from the island's apex.   It has no leaves, only small, teat-like protrusions that sprout from some of the 'branches', which in truth have more in common with tentacles than plant-life.  The squirming mass of sexual shrubbery stays in constant motion, and its intertwined tentacles occasionally bulge and flex as they spurt thick, jism-like sap over one-another.\n\n", false);
            this.outputText("You advance on the twisted, arboreal orgy with reluctant determination.  Marae wants you here, and there's no way back without dealing with the sex-intoxicated goddess.  Her long, languid moans make it easy to find her.  The delirious deity's arms are entwined through the roots of her trees while a green-patterned tentacle goes diving into the petal-lined entrance of her sloppy sex.  She cranes her neck back at the sound of your footfalls and asks, \"<i>", false);
            //(FORK HERE BETWEEN STOLE LETHICITE AND LAZY ASSHOLEZ)\"
            //(STOLE)
            if (this.player.hasKeyItem("Marae's Lethicite") >= 0) {
                this.outputText("Welcome back, sneak-thief.  What kind of " + this.player.mf("gentleman", "lady") + " is offered sex and then ransacks a god's soul?  Honestly, that right-right theeeeeree-oh yeah right there-is true depravity.</i>", false);
            }
            //(FAIL-STOLE)
            else if (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftStud) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftFertility) >= 0) {
                this.outputText("Hey there " + this.player.short + ".  I didn't think I'd manage to snag you again so soon.  Are you enjoying my gifts?  I've been feeling kind of lonely without anyone around here to play with.</i>", false);
            }
            //(Left Like a Bitch)
            else {
                this.outputText("Well, look who came back!  I thought you were too afraid of a good time to come up here and fuck around with little ol' Marae.   I was actually going to let you row away if you were too scared to come here.  No, don't even glance back now, I've changed my mind.</i>", false);
            }
            this.outputText("\"\n\n", false);
            this.outputText("Featureless white irises glare at you from the goddess' lust-lidded eyes.  She commands you, \"<i>Come here.  It's time for a ", false);
            if (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftFertility) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftStud) >= 0)
        ...
        MaraeIIStageII() {
            ...
            this.flags[kFLAGS_1.kFLAGS.CORRUPT_MARAE_FOLLOWUP_ENCOUNTER_STATE] = 2;
            //[Girls]
            //Marae grows vine-cawks for DP action
            if (this.player.gender == 2) {
                this.outputText("Marae coos with pleasure and allows a nectar-slicked tentacle to slip free of her flower.   Her sweet, corrupted smell filters through the air, like pollen carried on a spring breeze.  The goddess' fingers trace the outline of her budding clit, and you watch, enraptured, as it swells up and turns purple.  A clear ridge forms underneath the tip, delineating the under-side of a newly grown cock-tip.  Marae bats her eyelashes and strokes the newly-formed growth as it fills out, surpassing the length of any mortal man.  The crown is a shiny, almost slick purple color, fading to green the further down the stalk-like shaft it goes.   She climbs to her feet, fingernails tracing the outline of the newly-formed urethral bulge on her shaft as she glides closer to you.\n\n", false);
                this.outputText("Paralyzed by ", false);
                if (this.player.lust > 80)
                    this.outputText("lust", false);
                else if (this.player.cor > 50)
                    this.outputText("indecision", false);
                else
                    this.outputText("worry", false);
                this.outputText(", you don't manage a single backwards step before the warm bulge is rubbing ", false);
                if (this.player.tallness > 48)
                    this.outputText("at your crotch", false);
                else
                    this.outputText("against your belly", false);
                this.outputText(", and her sap-drooling teats are crushed into you.  Unbidden, your own " + this.nippleDescript(0) + "s grow hard under your " + this.player.armorName + ".  Marae glances down knowingly and begins to undo your gear, tossing it aside with almost bored contempt.  The sharp edges of her fingernails trace down your abdomen, circle your belly-button, and then slide wide to caress your " + this.hipDescript() + ".  The unexpected shift makes you gasp and rock against her, trying to get her fingertips between your " + this.player.legs() + ".  The goddess laughs and whispers, \"<i>No dear, that's a dick's job.</i>\"\n\n", false);
                this.outputText("Your heart hammers in your chest, flushing your " + this.player.skinDesc + " with heat from the goddess' presence and perfect, knowing touches.   There's no way you could resist her at this point, even if you wanted to.  Her smooth, flawless hands grab your shoulders and push down with a gentle but firm pressure that brooks no resistance.  Your " + this.player.legs() + " fold underneath Marae's guidance, allowing you to take a proper, worshipful stance.  A confused, half-formed thought claws its way out of the arousal that's swimming through your brain, but you shake your head in irritation and begin to lick your lips while you gawk at Marae's proud new shaft.\n\n", false);
                this.outputText("Marae runs her slender fingers through your " + this.hairDescript() + ", pulling your " + this.player.face() + " closer and closer until you smell the fragrance of her nectar and make out every detail of her impeccably smooth penis.  The goddess commands, \"<i>Worship it as you would worship me.</i>\"  You nod, feeling remarkably obedient as you lean forwards to take her in your mouth.   A bead of moisture rolls down the tip, smearing over your lower lip as you open up to encapsulate the suddenly hermaphroditic goddess' prick.  Her pre is sweet, though it doesn't surprise you considering it's coming from part of a flower.  It reminds you a little of honey, though there is an undercurrent of something else that you can't quite place.\n\n", false);
                this.outputText("Bobbing back and forth, you begin to fellate the goddess of fertility with unthinking, flawless precision.  Marae's hands continue to toy with your " + this.hairDescript() + ", wrenching it painfully once when you accidentally bump her with your teeth.  You whimper submissively and work harder, and your goddess rewards you by sending a tentacle to your groin.  The rounded tip nuzzles against you through your " + this.player.armorName + ", but quickly angles itself to slip inside.  It curls around your body, coating you with slippery fluids as it works its way back towards your " + this.vaginaDescript(0) + ".\n\n", false);
                this.outputText("The tentacle squirts something slippery and warm over your outer lips before arching up to pass inside you.  A half-articulated hum of pleasure escapes through your throat to vibrate Marae's plant-like prick.  She grunts and deposits a fat bead of nectar in your mouth, and trickles of the goddess' vaginal fluids start to slide down her inner thighs.  Marae's hips start to pump into you in time with the tentacle that's worming its way inside your " + this.vaginaDescript(0) + ".", false);
                this.player.cuntChange(12, true, true, false);
                this.outputText("  Both are dripping and giving tiny squirts of sweet pleasure that simultaneously dull the mind and reinforce your worship of this sexually-charged deity.\n\n", false);
                this.outputText("Marae grunts and pulls on ", false);
                if (this.player.horns > 0)
                    this.outputText("your horns", false);
                else
                    this.outputText("your " + this.hairDescript(), false);
                this.outputText(", shoving her thick clit-cock deep inside your throat.  You reflexively swallow down the bulging fuck-meat and ", false);
                if (this.player.cor < 33)
                    this.outputText("struggle to ", false);
                else if (this.player.cor < 66)
                    this.outputText("work to ", false);
                else
                    this.outputText("easily ", false);
                this.outputText("suppress your gag reflex as her cock grows thick in your mouth and begins to dump its cream down your wanton gullet.  The slippery tentacle goes into overdrive while Marae cums, pumping away at your " + this.vaginaDescript(0) + " with incredibly violent fervor.   Your belly bubbles as it's stuffed full of goddess-cum, and your pussy clamps down hard on its invader while it spurts out its own syrupy load into your womb.   Swooning with lust, you orgasm from the twin violations, squirming on Marae's rod while she packs you with nectar.");
            ...
            //Marae uses a tree-tentacle to 'milk' male PC's.  Oral or Vajayjay? Not sure.
                ...
                if (this.player.lust > 80)
                    ...
                    this.outputText("worry", false);
                this.outputText(".  Marae's advance seems like an inexorable march to your eyes, and before you have a chance to react, she's crushed against you in a full-body hug.  Her tongue digs into your mouth, rooting out your tongue and melting your resistance in an overwhelming, lust-powered assault.  You vision swims for a moment when she releases you and pulls back.  It's hard to focus with the busty, nude image of fertility beckoning you.  It makes " + this.sMultiCockDesc() + " strain to reach her, but she dances back with a knowing smile and says, \"<i>Not yet my eager little subject.  Let me undress you, THEN you can worship me.</i>\"\n\n", false);
                this.outputText("Vines whip out, sliding under your " + this.player.armorName + ", undoing clasps, and removing it until you stand naked and exposed to Marae.  She smirks and crooks her finger at you in a 'come hither' gesture.  You lurch forward, as if pulled on an invisible string until you're standing inches away from her, your " + this.cockDescript(0) + " rubbing her belly", false);
                ...
                this.outputText(".  The goddess gives you a cruel smile, as if she knows something you don't, and she commands, \"<i>Worship me with your cum, champion.  Submit to your goddess and spend your fertile seed for her.</i>\"\n\n", false);
                this.outputText("Marae extends her arms, and the twin tentacles crawl forward like snakes as they wriggle down her appendages.  You thrust your crotch forwards, presenting it to the goddess, and only wonder why for a brief second before you toss away the nagging, useless thought.  Why would anything but pleasuring the living goddess before you matter?  Her corruptive aura floats in the air, filling you with the desire to submit to your queen and obey her every whim.  " + this.SMultiCockDesc() + " twitches and starts to drip pre-cum, itching to fulfill your deity's desires.\n\n", false);
                this.outputText("The tentacle on her right arm convulses, then splits open along four joints.  The tip folds open to reveal a pink, wriggling interior that promises pleasures mortal minds weren't meant to comprehend.  Meanwhile, while you're distracted by the eager plant-hole, the other tentacle slips behind you and climbs up your " + this.player.leg() + ", leaving a trail of slime in its wake.   It slides between your cheeks and prods at your " + this.assholeDescript() + ".  You jerk forwards in surprise, but Marae pushes your " + this.hipDescript() + " back, allowing it to work its way inside.", false);
                this.player.buttChange(12, true, true, false);
                this.outputText("  The open plant-hole dives for your groin while you're distracted, hits your " + this.cockDescript(0) + " and devours it with a greedy sluuuuurp.", false);
                if (this.player.cockTotal() == 2)
                    this.outputText("  Another vine that may as well be the first's twin snakes from between the goddess' legs and jumps onto your " + this.cockDescript(1) + ".", false);
                else if (this.player.cockTotal() > 2)
                    this.outputText("  More 'open' vines shimmy forth from between Marae's legs and jump up onto your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + "s.", false);
                this.outputText("You grunt and pump your hips, shameless as you give in to the squeezing, textured tentacle", false);
                if (this.player.cockTotal() > 1)
                ...
                this.outputText(", but it's quickly devoured by Marae's tree-based tentacle-beast without a sound.  ", false);
                if (this.player.cumQ() > 500) {
                    this.outputText("The thick bulges of spooge actually distort the vines", false);
                    if (this.player.cockTotal() > 1)
                        this.outputText("s", false);
                    this.outputText(", letting you get the barest glimpse of white through the over-stretched tentacle-tube", false);
                    if (this.player.cockTotal() > 1)
                        this.outputText("s", false);
                    this.outputText(".  ", false);
                }
                this.outputText("A hot, slippery pressure touches something inside your " + this.assholeDescript() + " and makes you squirt even harder.  Marae's minions have found your prostate!  You grunt and groan, but the orgasm doesn't seem to stop.  The goddess teases, \"<i>What?  You didn't think I'd actually let you cum on me did you?</i>\"\n\n", false);
                this.outputText("It doesn't matter, you're giving her what she wants.  You cum until your " + this.player.legs() + " give out and you're sprawled on your back, " + this.sMultiCockDesc() + " being milked of its seed by the slurping, cunt-tentacles.  Every time you start to come down, the one in your backdoor rubs you just right and forces out another load.  Marae steps over your " + this.player.face() + " and drops down, allowing you to lick the nectar that drips from her sensitive, flower-like folds while you cum.  It's sweet, potent, and refreshing.  It makes it easy to keep cumming but hard to stay awake, and your eyes roll back as you pass out from an overload of pleasure.", false);
            }
            //[Hermz]  Marae grows vinecawks for DP under her flowercunt and sexes.
                ...
                this.outputText("The goddess closes with deliberately slow, hip-swaying steps that make your " + this.cockDescript(0) + " tremble and leave no doubt that she's the goddess of fertility.  Marae giggles and wraps her arms around you, planting a firm, wet kiss on your lips while she undoes your " + this.player.armorName + ".  Your gear hits the ground with a dull thump, and then her taut green nipples are pressed against your own", false);
                if (this.player.hasFuckableNipples())
                    this.outputText(", slipping inside your cunt-like nipples with ease.  You moan into her ear at the unexpected penetration and shiver from the tingling shocks of pleasure in your " + this.breastDescript(0) + ".", false);
                else
                    this.outputText(".", false);
                this.outputText("  Hammering in your chest, your heart beats fast enough to flush your whole body when your " + this.cockDescript(0) + " manages to slip between Marae's legs.  It doesn't penetrate, merely trapping itself between her fluid-lubed thighs", false);
                if (this.player.cockTotal() == 2)
                ...
                this.outputText(".\n\n", false);
                this.outputText("You swoon, your head buzzing with desire for more of this buzzing goddess' embrace.  The urge to kneel before her and worship her cunt rocks you to the core, blasting away the last of your feeble resistance, but before you can do so, Marae grabs you by the chin and commands, \"<i>No my child.  You can serve me better by breeding.</i>\"  Her fingers pull apart the petals of her flowery fuck-hole while she continues, \"<i>Go ahead, put it inside.  I'll show you how to practice the new faith of Marae.</i>\"\n\n", false);
                this.outputText("She's easy to push down into the soft grasses of the island, and her legs part to allow you better access.  Your " + this.cockDescript(0) + " doesn't need to be told what to do, and it slips into her waiting wetness as if it was made for her.  ", false);
                if (this.player.cocks[0].cockThickness > 5 || this.player.cockArea(0) > 100)
                    this.outputText("With how big you are, there's no way it should be able to fit, but her body isn't even distorted by your girth.  Perhaps she changed you to fit her?  You pull back and your thickness seems unchanged.  You shake your head to clear the unwelcome thoughts and ram yourself back into her.  Fucking is what's important.  ", false);
                else
                    this.outputText("She feels perfect.  A velvet vice of hot, slippery wetness clutches tightly around your " + this.cockDescript(0) + ".  It almost feels like it's actually gripping you, cradling your cock in her ambrosia-slicked box.", false);
                if (this.player.cockTotal() > 1) {
                    if (this.player.cockTotal() > 2)
                        this.outputText("  Another ", false);
                    else
                        this.outputText("Your other ", false);
                    this.outputText(Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " prods at her tight pucker, and with a slight adjustment, you're able to line it up.  It's wet!  Inch after inch slides in with incredible ease, violating her slippery butthole until you've completely double-penetrated her.", false);
                }
                this.outputText("\n\n", false);
                if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_WET)
                    ...
                    this.outputText("Trails of viscous feminine fluid leak from your " + this.vaginaDescript(0), false);
                this.outputText(", reminding you of your unused femsex.  Marae grunts underneath you, and while at first you assume it's from the penetration, the prodding of two cock-like protrusions at your lusty holes corrects your misguided assumptions.  You pull back and begin to fuck her in earnest, and with each long rock back, you can see she's grown tentacles from underneath her ass, like two prehensile tails.  They push forwards and spear you, arresting your movement while you try to cope with the sudden stretching of two of your orifices.  Warmth radiates from the twin intruders along with a slippery fullness.  They're pumping something inside you that tingles and makes " + this.sMultiCockDesc() + " bounce and drip.", false);
                this.player.cuntChange(12, true, true, false);
                this.player.buttChange(12, true, true, false);
                this.outputText("\n\n", false);
                this.outputText("Marae laughs and teases, \"<i>If this is how you fuck it's no wonder I haven't met your children yet.  If you're going to be my disciple you need to fuck your partners hard until you're stuffing them with cum.  Then you need to do it again.  Alternatively you should be bouncing on their cock and milking it with your " + this.vaginaDescript(0) + " until your womb is packed so full you can't walk.  Now show me how you'll do it, or I might keep you here until you're properly trained!</i>\"\n\n", false);
                this.outputText("You happily thrust forwards, ramming your " + this.cockDescript(0) + " into her cunt with such force that a wet slap echoes over the lake and her fluids splatter your abdomen.  ", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("Her asshole is squelching and dripping from your " + this.cockDescript(1) + ", actually squirting more lubricant than her pussy from the violent fucking!  ", false);
                this.outputText("In spite of the obscene amount of pleasure " + this.sMultiCockDesc() + " is getting, you focus on obeying your goddess, and you work the muscles in your " + this.vaginaDescript(0) + " and " + this.assholeDescript() + " to pleasure her tentacles.  Muffled sloshes and spurts reach your ears, and you realize just how successful your efforts are.  Marae's pinching her nipples and arching her back, and a moment later a wave of pleasure hits you upside the head with the force of a hammer-blow.\n\n", false);
                this.outputText("Cum boils out of your ", false);
                if (this.player.balls > 0)
                    this.outputText("rapidly contracting balls", false);
                else
                    this.outputText("tentacle-squeezed prostate", false);
                this.outputText(" and erupts into Marae's womb.  Your hips rock forward, grazing her cervix with your " + this.player.cockHead() + " to better fill her uterus.  ", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("The " + this.cockDescript(1) + " in her ass spasms and explodes with its brother, glazing her slippery colon with a coating of syrupy spunk.  ", false);
                if (this.player.cockTotal() > 2) {
                    this.outputText("Neglected but orgasming, ", false);
                    if (this.player.cockTotal() > 3)
                        this.outputText("the remainder of ", false);
                ...
                this.outputText("The goop from inside you never seems to end, and you pump Marae's belly up with it until she looks a little pregnant.  ", false);
                if (this.player.cumQ() < 500)
                    this.outputText("The orgasm is so much more massive than normal, and you wonder if her magic enhanced it.  ", false);
                if (this.player.cumQ() > 1000)
                    this.outputText("She's actually surprised when you keep fountaining more seed into her.  Her nipples start to squirt out the excess seed, but you keep cumming until she's squirted enough to soak herself with your jism.  ", false);
                this.outputText("The goddess' tentacles never let up during it all, and you have a belly that matches Marae's perfectly.\n\n", false);
        ...
        MaraePt2RoundIIIPrizes() {
            ...
            //[Chickzillas]
                ...
                if (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftFertility) >= 0) {
                    ...
                    this.player.createPerk(PerkLib_1.PerkLib.MaraesGiftButtslut, 0, 0, 0, 0);
            ...
            //[HERMS]
                ...
                if (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftFertility) < 0 && this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftStud) < 0) {
                    ...
                    this.outputText("The entire time she was speaking, you were trapped in orgasm, milked by her tree with unthinking intensity.\n\n", false);
                ...
                //(HAZ STUD)
                    ...
                    this.outputText("I can't believe I didn't think of this last time!  I made you such a great stud that I didn't think to make you just as good at popping out your own kids!  Well I went ahead and fixed that while you were sleeping.  Your womb is nice and fertile, and you'll pop out kids a LOT quicker than before.  We'll be repopulating everything in Mareth in no time!  Just be sure to knock up the girls and let the boys fuck your pussy, okay?</i>\"  ", false);
                    this.outputText("The entire time she was speaking, you were trapped in orgasm, milked by her tree with unthinking intensity.\n\n", false);
