define(["require", "exports", "./AbstractBoatContent", "../../../GlobalFlags/kFLAGS", "../../../StatusAffects", "./SharkGirl"], function (require, exports, AbstractBoatContent_1, kFLAGS_1, StatusAffects_1, SharkGirl_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class SharkGirlScene extends AbstractBoatContent_1.AbstractBoatContent {
    ...
    */
        //[Explore Lake]
        sharkGirlEncounter(exploreLoc = 0) {
            //Set 'PC met Sharkgirls' for Izma stuff
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00230] == 0)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00230] = 1;
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.SharkGirl) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.SharkGirl, 0, 0, 0, 0);
            else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.SharkGirl) >= 7 && this.player.totalCocks() > 0) {
            ...
            //Rowboat
            if (exploreLoc == 1) {
                this.outputText("While rowing the boat across the lake you spy a shark fin heading your way.  Worried it might damage the small boat, you hastily row back to shore, jumping out of the boat.  The shark shows no signs of slowing, and the fin disappears just before coming ashore.  ", false);
            }
            //Lake
            else {
                this.outputText("You wander around the sandy shores of the lake before raising your eyebrow at a strange sight: A solitary fin, circling around in the water. You take a step back in surprise when the fin suddenly starts barrelling toward the shore at inhuman speeds.  ", false);
            }
            this.outputText("A grey blur bursts from the water and lands on the ground a few feet away from you.\n\n", false);
            this.outputText("It's a woman – a peculiarly corrupted woman, with shiny grey skin, silver hair, and a fin positioned between her shoulder blades. She's wearing some rather revealing black swimwear. The girl looks up at you and grins widely, showing rows of knife-like teeth. \"<i>Wanna play? Heads up though, I play 'rough'!</i>\"\n\n", false);
            this.outputText("You're fighting a shark girl!", false);
            this.startCombat(new SharkGirl_1.SharkGirl());
            this.spriteSelect(70);
        }
        ...
        sharkWinChoices() {
            ...
            //Lust win
                ...
                this.outputText("The shark-girl begins masturbating, giving up on dominating you.  The sight is truly entrancing.", true);
            ...
            if (this.player.lust >= 33 && this.player.gender > 0) {
                ...
                if (this.player.gender == 1)
                    ...
                    if (this.player.isNaga())
                        ...
                        this.simpleChoices("Use Dick", this.sharkgirlDickFuck, "Pussy w/69", this.sharkgirlSixtyNine, "Dildo Rape", dildo, "", undefined, "Leave", this.cleanupAfterCombat);
                }
            }
            else
        ...
        //Male and Herm: 
        sharkgirlDickFuck() {
            this.player.addStatusValue(StatusAffects_1.StatusAffects.SharkGirl, 1, 1);
            this.outputText("", true);
            this.spriteSelect(70);
            ...
            //Non-nagaz
                ...
                if (this.player.gender == 3)
                    this.outputText("While sucking you off, her hand steadily snakes its way between your legs. Without warning, she shoves three fingers into your " + this.vaginaDescript(0) + ", pushing in and stretching the moist passage out.\n\n", false);
        ...
        sharkgirlSixtyNine() {
            ...
            if (this.player.isNaga()) {
                ...
                if (this.player.gender == 2)
                    this.outputText(", pulling out every few minutes to lick your " + this.clitDescript() + ".", false);
                //[if herm]
                if (this.player.gender == 3)
                    this.outputText(". You remind her not to neglect your " + this.cockDescript(0) + ", and the shark girl responds by thoroughly licking your hard erection and sucking at your " + this.ballsDescriptLight() + ".", false);
                this.outputText("\n\n", false);
                ...
                if (this.player.gender == 2)
                    this.outputText(", juices spraying from your sex and coating the girl's face.", false);
                //[if herm]  
                else
                    this.outputText(" and stand up, gripping your " + this.cockDescript(0) + " and splattering thick jets of cum onto her face.", false);
                this.outputText("  The shark slut licks up your fluids hungrily.\n\n", false);
                this.outputText("Thoroughly satisfied, you leave the shark girl on the ground covered in your fluids and depart for your camp.", false);
            }
            this.cleanupAfterCombat();
            this.player.orgasm();
            this.dynStats("sen", -1);
        ...
        sharkLossRape() {
            ...
            if (this.player.gender == 0) {
                ...
                if (this.player.HP < 1)
                    this.outputText("hurt ", false);
                else
                    this.outputText("horny ", false);
                this.outputText("to fight on.\n\n", false);
                this.outputText("The shark girl does a little victory dance, swaying her hips to and fro before moving over to you. She quickly removes your " + this.player.armorName + ", but her smile fades to a blank expression when she notices you lack any genitalia. \"<i>What the...</i>\" she mumbles, poking you in the groin. Finding you completely useless, she growls in frustration and stomps on your face in anger. The sudden pain makes you pass out.", false);
                this.cleanupAfterCombat();
                this.dynStats("tou", -2);
                return;
            }
            ...
            if (this.player.hasVagina() && (this.player.totalCocks() == 0 || SharkGirlScene.rand(2) == 0)) {
                ...
                if (this.player.HP < 1)
                    ...
                    this.outputText("horny ", false);
                this.outputText("to fight on.\n\n", false);
                this.outputText("The shark girl giggles and moves over to you, tugging at your " + this.player.armorName + "  impatiently. Her tail swishes around and smacks your " + this.assDescript() + ". \"<i>You're gonna make me very happy, you hear? Otherwise...</i>\" she opens her mouth wide and you see her fangs glinting menacingly in the light. You gulp hard and nod, bringing a smile from the shark girl.\n\n", false);
                this.outputText("Wasting no time, she removes her skimpy swimwear and your own gear.  ", false);
                //[if herm]
                if (this.player.gender == 3)
                    this.outputText("Seeing your " + this.cockDescript(0) + " puts a smile on the shark girl's face as she takes a firm grip on your erection. \"<i>Well, you're just full of surprises, aren't you? Maybe I'll give this bad boy a whirl sometime. For now though...</i>\"  ", false);
                this.outputText("Her gaze drifts over to your " + this.vaginaDescript(0) + " and she licks her lips in delight. \"<i>Now that's what I'm looking for! Tell you what dear, you get me wet and I might just give you some pleasure too.</i>\"\n\n", false);
                this.outputText("She roughly grabs you by the hair and pulls your face into her drooling cunt, your tongue instinctively probing into her. \"<i>Mmm... don't you dare stop licking you dumb bitch, if you know what's good for you,</i>\" she orders. You reply by speeding up your tongue work. You're a little ashamed to admit it, but her dominant command makes you feel rather hot and bothered.\n\n", false);
                this.outputText("The shark girl eventually sighs happily and relaxes her grip on your hair, pulling your head away a few inches. \"<i>Not bad bitch, not bad. Now get on your back.</i>\" You obey your mistress's command and flop onto your back. A sense of joy fills you as she positions her crotch in front of your face and moves her own head between your legs. You quickly resume eating her out, and this time she joins in the feast. It's not too long before the two of you orgasm, spraying girl-cum onto each other's faces.\n\n", false);
                this.outputText("The shark girl stands to leave and winks at you before diving back into the water. You eventually pass out from the exertion.", false);
            ...
            //Male:
                ...
                if (this.player.HP < 1)
                    ...
                    this.outputText("horny ", false);
                this.outputText("to fight on.\n\n", false);
                this.outputText("You feel the shark girl's bare foot press against your chest and she roughly pushes you onto your back. \"<i>Oh man, I can't even remember the last time I had an actual man...</i>\" the shark girl says, pulling your pants down to your ankles. Seeing your stiff erection, your opponent smirks and wets her lips before taking your entire " + this.cockDescript(0) + " into her mouth. The feeling is heavenly, her long tongue slithering around your shaft.\n\n", false);
                this.outputText("But before you can begin to really enjoy it, she pulls her head away, visible strands of saliva still linking her mouth and your " + this.cockDescript(0) + ". The shark girl quickly maneuvers herself so that she's straddling your cock and presses herself down, the two of you gasping sharply from the sensation. \"<i>Hmm, good boy... You make me cum first, and I won't bite you. Deal?</i>\" You nod, though given that peculiar feelers inside her cunt are massaging your cock, you don't know how long you can really hold out.\n\n", false);
                this.outputText("The shark girl has no such qualms and rides you like a mechanical bull, hammering up and down your " + this.cockDescript(0) + " with incredible speed. It certainly feels nice, but the rough nature of the ride also certainly hurts. You'll be walking funny for a while after this, that's for sure.\n\n", false);
                this.outputText("Eventually, her vagina clamps down on your cock and she cries out in orgasm. You grunt loudly and cum a few seconds after, pumping your seed into her womb. The shark girl leans over and plants a tiny kiss on your lips. \"<i>Good boy. I'll be sure to see you again</i>\". She gets up again and you watch her re-enter the water before you pass out.", false);
                this.player.orgasm();
                this.dynStats("sen", 1);
                if (this.player.cor < 30)
                    this.dynStats("cor", 1);
    ...
    exports.SharkGirlScene = SharkGirlScene;
});
//# sourceMappingURL=SharkGirlScene.js.map