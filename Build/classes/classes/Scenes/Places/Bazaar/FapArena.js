define(["require", "exports", "./BazaarAbstractContent", "../../../GlobalFlags/kFLAGS", "../../../CockTypesEnum", "../../../Appearance", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, BazaarAbstractContent_1, kFLAGS_1, CockTypesEnum_1, Appearance_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class FapArena extends BazaarAbstractContent_1.BazaarAbstractContent {
        fapAppearance(display = true) {
            if (display) {
                //[Paragraph: Bazaar description, 1st time]
                if (this.flags[kFLAGS_1.kFLAGS.FAP_ARENA_RULES_EXPLAINED] == 0)
        ...
        fapArenaGOOOO() {
            ...
            if (this.player.longestCockLength() < 8) {
                ...
                if (!this.player.hasCock())
                    this.outputText("you have a cock.", false);
                else
                    this.outputText("your cock is sufficiently long.", false);
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.FAP_ARENA_RULES_EXPLAINED] == 0) {
                this.flags[kFLAGS_1.kFLAGS.FAP_ARENA_RULES_EXPLAINED]++;
            ...
            //[if dick size > 8 inches: after first time] 
                ...
                this.outputText("\"<i>Alright.  Welcome everyone; I see no new faces here, so I'll assume everyone knows the rules and we'll directly proceed to the masturbatory game, which I am sure you are all eager to play.  Remember: using alternative methods of stimulation is NOT allowed.  Do you studs understand?</i>\"\n\n", false);
                this.outputText("Everyone nods in agreement, hands and genitalia quivering in excitement.", false);
                //[if Corr >40]
                if (this.player.cor > 66)
        ...
        fapArenaPageII() {
            ...
            var s = this.player.sens;
            //D the number of hours since he last came 
            var d = this.player.hoursSinceCum;
            var c = 0;
        ...
        fapResults(place = 3) {
            ...
            if (place == 3) {
                ...
                this.outputText("Your left partner is very professional.  At the very moment your " + this.cockDescript(x) + " starts shooting its goo, your cock-milker yells in a thundering voice: \"<i>NUMBER " + (num - 1) + " SCORING!</i>\"  For a moment, lost in your pleasure, you pay little attention to the world outside of your " + this.cockDescript(x) + ".  Then you remember the game and shout in a whorish, pleasure-filled voice: \"<i>NUMBER " + num + " CUMMING!</i>\"", false);
                if (this.player.hasVagina()) {
                    this.outputText("  Your thighs tense a few seconds before your " + this.vaginaDescript(0) + " squirts too, forming a ", false);
                    if (this.player.wetness() >= 4)
                        this.outputText("large puddle", false);
                    else if (this.player.wetness() >= 2)
                        this.outputText("puddle", false);
                    else
                        this.outputText("smear", false);
                    this.outputText(" of girl-jizz on the floor.", false);
                }
                //[if player lactates]
                if (this.player.biggestLactation() > 1.5)
                    this.outputText("  Your " + this.allBreastsDescript() + " also release a milky flood of their own, the soft feeling of cream teasing your nipple only prolonging your orgasm.", false);
                this.outputText("\n\n", false);
                this.outputText("The cute referee nods in acknowledgement.  Her eyes seem to be filled with longing for your cum-spilling " + this.multiCockDescriptLight() + ", and you know she'd eagerly finish you off if it weren't for her professionalism.\n\n", false);
                ...
                //[else]
                    ...
                    this.outputText("You remember you still have to make your right partner cum.  Now that you've lost, you don't care about being disqualified and you twist your partner's cock ragingly, fondling, cupping his balls, occasionally giving them a nice squeeze for good measure.  Your partner's cock starts twitching in indignation but it soon releases a milky torrent of semen.  Angry at your own lack of stamina, you yell, \"<i>NUMBER " + num + " SCORING!</i>\", almost immediately followed by \"<i>NUMBER " + (num + 1) + " CUMMING!</i>\"  You keep twisting that pecker until you're absolutely positive that you've milked every drop of seed out of it.  Your hand is drenched in sexual juices, but you don't care.\n\n", false);
                //end of else
                this.outputText("Quite satisfied, your left partner decides to stop torturing himself; he must have had a rough handjob too.  You watch in amazement as his enormous shaft starts shooting globs of sticky goo, aiming at the referee with an expert's precision.  He grins lewdly and yells: \"<i>NUMBER " + (num - 1) + " CUMMING!</i>\"\n\n", false);
                this.outputText("Soon everyone else starts blowing their own loads, shouting their number.  You hear the pleasure-filled moans of a dozen of people giving in to their bodies, only arousing you more and increasing your cum-flow.  The referee records the results and writes them down on a little notepad but she has a hard time keeping it free of white stains because all players seem to be aiming their cumshots at her.  Players are moaning whorishly and louder than ever.  The whole room seems to be detonating as dozens of horny bodies release their powerful orgasms in an apotheosis of lust.  In a few minutes the entire room is filled with trails of cum, everyone being too eager to shoot their load after this fever of orgasm denial.\n\n", false);
            }
            //[else if the player doesn't lose, but doesn't win either - he cums neither first nor last]
            else if (place == 2) {
                this.outputText("For what seems like hours you try to hold on, resisting wave after wave of unbearable pleasure in your crotch.  Nevertheless, you feel your stamina gradually depleting; each orgasm is harder to deny.  You know you won't be able to hold on much longer, but you muster up your courage and count to ten in your head.  Surely someone will cum before you... they better do it now because your mind is about to collapse and you will no longer be able to control your body.  Gods, it feels too good.  That stroking, teasing hand is torturing you in a delicious way, but you keep denying the pleasure.  You have to.  It's so rough, so...\n\n", false);
                this.outputText("Your thoughts are suddenly interrupted.\n\n", false);
                this.outputText("Someone in the circle yells, \"<i>NUMBER " + num + " CUMMING!</i>\", immediately followed by another voice yelling even louder, \"<i>NUMBER " + (num - 1) + " SCORING!</i>\"\n\n", false);
                this.outputText("Indeed, a player's cock has given up the stamina contest and sprays spunk all around in a hot creamy torrent.  That's one mighty cum-shot, you think in admiration.  Almost immediately after that, several players give up too and start shouting while shooting their own goo.\n\n", false);
                this.outputText("Your right partner suddenly shouts in a high-pitched voice, \"<i>NUMBER " + (num + 5) + " CUMMING!</i>\"; you immediately understand and shout \"<i>NUMBER " + (num + 4) + " SCORING!</i>\" in response.  You can feel the pressure releasing in the cock your hand is holding, the fluid being sprayed all around by the perverted pump.\n\n", false);
                this.outputText("A vicious yank on your own " + this.cockDescript(x) + " reminds you that you also need to comply to your own genitals' needs.  Unhindered by the fear of losing, you completely give up to your orgasm and sigh in utter satisfaction and relief as you release one of the most abundant cumshots you've ever had.  Lost in your orgasm, you carelessly ", false);
                if (this.player.cumQ() >= 1000)
                    this.outputText("soak", false);
                else if (this.player.cumQ() >= 500)
                    this.outputText("pollute", false);
                else
                    this.outputText("wet", false);
                this.outputText(" the floor with your sexual juices and yell in a whorish voice, \"<i>NUMBER " + (num + 4) + " CUMMING!</i>\"; you're almost immediately followed by the scoring announcement from your left neighbor.  With a half-closed eye you notice the referee nodding in acknowledgement and you point your " + this.cockDescript(x) + " at her, trying to soak her too.  She hardly dodges it and some lands on her arms, but she doesn't seem to notice.", false);
                if (this.player.hasVagina()) {
                    this.outputText("  Your thighs tense a few seconds before your " + this.vaginaDescript(0) + " squirts too, forming a ", false);
                    if (this.player.wetness() >= 4)
                        this.outputText("large puddle", false);
                ...
                if (this.player.biggestLactation() > 1.5)
                    this.outputText("  Your " + this.allBreastsDescript() + " also release a milky flood of their own, the soft feeling of cream teasing your nipple only prolonging your orgasm.", false);
                this.outputText("\n\n", false);
                this.outputText("Quite satisfied, your left partner decides to stop torturing himself; he must have had a rough handjob too.  You watch in amazement as his cum-tube starts shooting globs of sticky goo, aiming at the referee with an expert's precision. He grins lewdly and yells: \"<i>NUMBER " + (num + 3) + " CUMMING!</i>\"\n\n", false);
            ...
            //[else, the player wins]
                ...
                this.outputText("For what seems hours you try to hold on, resisting wave after wave of unbearable pleasure in your crotch.  Nevertheless, you feel your stamina gradually depleting; each orgasm is harder to deny.  You know you won't be able to hold on much longer, but you muster up your courage and count to ten in your head.  You must win.  All these efforts can't have been in vain.  Surely someone will cum before you... and someone else, and someone else.  They better do it soon though.  You don't know how long you will be able to control your body.  Gods, it feels too good.  That stroking, teasing hand is torturing you in a delicious way, but you keep denying the pleasure.  You have to.  It's so rough, so...\n\n", false);
                this.outputText("Your thoughts are suddenly interrupted.\n\n", false);
                this.outputText("Your right partner shouts in a high-pitched voice: \"<i>NUMBER " + (num + 1) + " CUMMING!</i>\"  You immediately understand and shout \"<i>NUMBER " + num + " SCORING!</i>\" in response.\n\n", false);
                this.outputText("Indeed, you can feel the pressure releasing in the cock your hand is holding, the fluid being sprayed all around in a hot creamy torrent.  That's one mighty cumshot, you think in admiration.  Almost immediately after that, several players give up too and start shouting while shooting their own goo.\n\n", false);
                this.outputText("Someone in the circle yells \"<i>NUMBER " + (num + 7) + " CUMMING!</i>\" immediately followed by another voice yelling even louder \"<i>NUMBER " + (num + 6) + " SCORING!</i>\"\n\n", false);
                this.outputText("A vicious yank on your own " + this.cockDescript(x) + " reminds you that you also need to comply to your genitals' need. In a supreme effort of strength of will, you resist.  You can't allow yourself to give up now that you've an opportunity to win.  You clench your teeth and keep ignoring the treatment your " + this.cockDescript(x) + " is undergoing.\n\n", false);
                this.outputText("Tortured, your left partner decides to stop teasing himself; he must have had a rough handjob too.  You watch in amazement as his cum-tube starts shooting globs of sticky goo, aiming at the referee with an expert's precision.  He grins lewdly and yells: \"<i>NUMBER " + (num - 1) + " CUMMING!</i>\"\n\n", false);
                ...
                if (this.player.cumQ() >= 1000)
                    ...
                    this.outputText("wet", false);
                this.outputText(" the floor with your sexual juices and yell in a whorish voice: \"<i>NUMBER " + num + " CUMMING!</i>\"  With a half-closed eye you notice the referee nodding in acknowledgement and you point your " + this.cockDescript(x) + " at her, trying to soak her too.  She hardly dodges it and some lands on her arms, but she doesn't seem to notice.", false);
                if (this.player.hasVagina()) {
                    this.outputText("  Your thighs tense a few seconds before your " + this.vaginaDescript(0) + " squirts too, forming a ", false);
                    if (this.player.wetness() >= 4)
                        this.outputText("large puddle", false);
                ...
                if (this.player.biggestLactation() > 1.5)
                    this.outputText("  Your " + this.allBreastsDescript() + " also release a milky flood of their own, the soft feeling of cream teasing your nipple only prolonging your orgasm.\n\n", false);
            }
            //Post fap
            this.outputText("You pant and relax, exhausted.  Your right arm is cramped and your " + this.cockDescript(x) + " is sore.  People around you look similarly tired and are slowly recovering from this rough collective dick-stroking session.  Someone gently taps your shoulder.  It is your left neighbor: \"<i>Well played. I didn't expect you would be so... resistant.  Few players last that long with me, because their rods generally don't endure my handjobs.</i>\"  He proceeds to shake hands; both you are smeared with pre-cum and various cock juices, but you don't care.  You smile and thank him for the good game and the orgasm.  It comes as something of a relief that everyone seems to show good sportsmanship.  Everyone is congratulating each other; various comments reach your ears about the game they just had and how well their opponents did.  Your right partner stands before you.  \"<i>Whoa, you sure know how to give a handjob!  That was amazing, and you know what?  I don't care if I haven't won!</i>\"  You tell him that you're glad that he enjoyed your efforts.  Everyone is now laughing and chatting casually, as if their still erect cocks weren't dripping semen and they weren't busy giving furious handjobs a few minutes ago.  ", false);
            //[if first time]
            if (this.flags[kFLAGS_1.kFLAGS.FAP_ARENA_RULES_EXPLAINED] == 1)
                this.outputText("You stand here, a little lost, wondering what will happen next.", false);
            else
                this.outputText("You join them, congratulating some on the strength of their stroke, and commenting on the various aspects of the fapping game you've just had.\n\n", false);
            this.outputText("The referee, who had been busy cleaning herself up from all the spunk in a backroom, suddenly storms out and plants herself at the center of the circle, her nude red body trembling and shivering in arousal.  \"<i>Alright, everybody in a single line!  It's time for your butt-fuck reward.</i>\"\n\n", false);
            this.outputText("You jolt in surprise as everyone stops talking altogether and yells in a single, thundering, thrumming voice, \"<i>BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!</i>\"  It never seems to end.\n\n", false);
            //[if corr < 50]
            if (this.player.cor < 50)
                this.outputText("You find yourself yelling with them, astounded by everyone's enthusiasm and eagerness to be fucked in the ass, even after this rough masturbating session.  You wish you weren't so blindly following others, but they are so hypnotizing, their hard glistening cocks pointing at the air as they keep shouting over and over again, \"<i>BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!</i>\"  ", false);
            //[else, corr >50]
            else
                this.outputText("Your body tenses and " + this.sMultiCockDesc() + " hardens at the perspective of a collective anal orgy.  You yell in lust like a minotaur in rut, \"<i>BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!  BUTT-FUCK!</i>\" along with the others.  ", false);
            //end of global condition about PC's corr, display the following
            this.outputText("As they shout rhythmically, they start forming a straight line, their position in the line reflecting their rating.\n\n", false);
            //[if you won]
            if (place <= 1)
                this.outputText("Since you're the winner, you walk to the tail of the butt-fuck train, enjoying your prize.  ", false);
            //[if you didn't win, didn't lose]
            else if (place <= 2)
                this.outputText("You place yourself between two horny bodies.  The lust and confusion have obscured your senses and all you see is a rock-hard dick and a gaping anus, both waiting for you to play with.  ", false);
            //[if you lost]
            else {
                this.outputText("You meekly place yourself at the end of the butt-fuck wagon, knowing you'll have to endure the thrusts of everyone else.  In your shame and lust, all you can see is a member of enormous size, trembling in arousal, waiting to lodge between your ass-cheeks.  With ", false);
                //([if corr < 50]
                if (this.player.cor < 50)
                    this.outputText("a whorish smile", false);
                else
                    this.outputText("apprehension", false);
                this.outputText(", you place yourself in front of the creature with the large cock.  It grinds against your back in impatience.  ", false);
            }
            this.outputText("You ready yourself up as everyone puts themselves into a proper butt-fucking position, cocks pointing to anuses.\n\n", false);
            this.outputText("The referee shouts, \"<i>LET THE BUTT-FUCK TRAIN BEGIN!</i>\"\n\n", false);
            //[if you won]
            if (place <= 1) {
                this.outputText("You can't believe you will get to fuck a whole train's worth of anuses and cocks.  This seems so unreal...  nevertheless, the tension and the scent of cum prove too much for you, and you give in to your lust.  ", false);
                //[1/2 chance of this]
                if (FapArena.rand(2) == 0) {
                    this.temp = 3;
                    this.outputText("You eagerly grab the luxurious, gelatinous butt cheeks in front of you.  You notice a pussy underneath that fine ass, freely spilling sexual juices.  If the compelling order wasn't resonating deep in your mind, you would easily lose yourself in the herm's glorious depths. Nevertheless, your " + this.cockDescript(x) + " remembers its job and starts pushing its way between these tender orbs, then into the herm's tight anus.\n\n", false);
                }
                else {
                    this.outputText("You eagerly grab the firm, muscular ass cheeks in front of you, probably belonging to some vigorous male.  You grind your " + this.cockDescript(x) + " against his back and it automatically starts spilling pre-cum; as soon as the seminal liquid trickles down his shapely butt, you can feel his body tensing, as if his lust reached a new level.  Nevertheless, your " + this.cockDescript(x) + " remembers its job and starts pushing its way between these gorgeous buttocks, then into the man's tight anus.\n\n", false);
                    this.temp = 1;
                }
                this.outputText("It lodges here comfortably for a few seconds, and then you remember you're the one initiating the butt-fucking train; so you quickly get down to business and give your dong an almighty thrust.  As soon as you start pushing, your sodomite partner grips ", false);
                if (this.temp == 1)
                    this.outputText("his", false);
                else
                    this.outputText("her", false);
                this.outputText(" own partner's butt and thrusts too under the pressure, who does the same to the one following, etc..  The last one is actually pushed face down onto the floor, but her butt bumps against the cum-tube fucking her, making the cock's owner bump in response, and it all propagates back to your own dick; you gasp in pleasure as the ass holding your " + this.cockDescript(x) + " clenches all the more as it bumps against your thighs, and decide to give another thrust, and another, and another.  It is hard, laborious, and slow, but your " + this.cockDescript(x) + " is rewarded beyond imagination: it feels like a gentle tingle every time a butt bumps into someone's ass.  It is like a giant anal wave coming and going through people's cocks, and you're the one riding the wave.  Soon people in the fuck train let out whorish moans, often interrupted when the wave hits them, before moaning all the more loudly afterwards.  Although you are not getting your " + this.assholeDescript() + " pounded like everyone else, you know you won't be able to keep up with such a crazy butt-fucking pace for long.  The ass you're fucking is almost moving on its own, jerking back and forth at each thrust, nearly beyond your control.  You know you're supposed to lead the whole fuck train, but the raw feelings are too much.  Every time you try to ease yourself into fucking that ass in a more comfortable way, it grinds against your thighs, driving your " + this.cockDescript(x) + " crazy and crushing any attempt at coherent thought.  You decide to give up and let your " + this.cockDescript(x) + " do the job itself.  Pleasure rises as you pound this ass relentlessly, making its owner join the chorus of moaning sounds.\n\n", false);
                ...
                if ((this.player.cockTotal() > 2) || (!tent && this.player.cockTotal() > 1)) {
                    ...
                    if ((tent && this.player.cockTotal() == 3) || (this.player.cockTotal() == 2 && !tent))
        ...
        tentacleFapSpecial(place) {
            ...
            while (this.temp > 0) {
                this.temp--;
                if (this.player.cocks[x].cockLength >= 40 && this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE)
                    break;
            }
            if (this.player.cocks[x].cockLength >= 40 && this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE) {
                this.outputText("You suddenly remember your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.TENTACLE) + " isn't getting love. The poor squirming thing is trembling in arousal and you decide it should also take part in the collective butt-fuck; you don't care whether it's cheating or not; after all, the butt-fuck has already begun.  Besides, the referee is too busy touching herself to notice anything.  Fortunately your tentacle dick is long and flexible enough to be guided toward some hole to fuck; you proceed to snake your tentacle dong around, looking for some vagina.  After a few seconds of unsuccessful searching, groping muscled butts with your nodules but finding no hole that's already filled by some ramming cock, your ropy member finally locates a gaping, fluid-dripping vagina.  You've found a herm!  Her slick fuck-hole is oozing due to the unholy embrace of flesh her pucker and her shaft are already getting, and you have no trouble sliding a few inches inside with expert guidance.  The brutal and unexpected secondary intrusion makes her moan instantly.  You welcome this new burst of pleasure and start jamming your tentacle pecker back and forth in the herm's vagina, all the while ", false);
                if (place <= 2)
                    this.outputText("fucking your partner's anus", false);
                if (place == 2)
                    this.outputText(" and", false);
                if (place >= 2)
                    this.outputText(" being fucked from behind", false);
                this.outputText(".\n\n", false);
                //[if you didn't lose or if you won]
                if (place <= 2) {
                    this.outputText("Needless to say, this interference creates a general disruption in the whole butt-fuck wave.  The whole train of peckers and puckers starts moving irregularly, grinding against your " + this.cockDescript(x) + " at the most unexpected moments, and the pleasure you're getting from your extra tentacle cock doesn't help.  Everyone's butt and dick is affected to some extent; everyone's pleasure is increased because of your audacious initiative, and loud, reluctant moans are heard.", false);
                    if (place == 1)
                        this.outputText("  Such raw power, fucking two people at the same time, and one from so far away...  You're basically fucking a wagon of people twice.  The enormity of the act makes you laugh, adding to your pleasure-induced confusion.", false);
                    else
                        this.outputText("  Your resistance is quickly fading because of the triple fuck and the mix of feelings combining to provide the richest, dirtiest orgasm; but you feel consoled in knowing the herm girl you're fucking is completely lost.", false);
                    this.outputText("Receiving cock and pleasure from both holes, the dick-girl's body is wildly thrashing from one side to another, grinding against your tentacled shaft and screaming in ecstasy as she abandons herself to the rough sensations assaulting her mind.  The mental image of her plump rump jiggling so obscenely from behind as well as the slimy sensation of feminine fluids freely spilling from her abused baby-maker make you thrust faster and deeper into her, as if to punish her - or reward her? - for arousing you so much.  She will probably cum soon, and so will you.\n\n", false);
                }
                //[if you lost]
                else {
                    this.outputText("This is such an awkward position, moving your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.TENTACLE) + " backwards and blindly penetrating some herm girl you don't see.  But at least it's fair game; why should you be the only one on the receiving end?  You firmly lodge your sleek intruder inside the girl's love tunnel and start pushing, thrusting harder and deeper every time the butt-fuck wagon hits your " + this.assDescript() + ", as if you wanted to punish her for being part of your own rough penetration, and transmit some of the pure anal-induced energy from thirty people's cock-thrusts to her... you aren't disappointed.  As soon as your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.TENTACLE) + " starts rocking in and out of the herm's moist pussy, she lets out a huge, obscenely whorish scream of pleasure.  She waggles from one side to another and accelerates her butt-fucking and hole-filling pace, unable to control her sensations.  This disrupts the whole butt-fucking train, and everyone's ass and cock is affected to some extent; everyone's pleasure is increased because of your audacious looping retro-fuck initiative, and other loud, reluctant moans are heard.  You can't help but join them in this unholy orgy of hole-penetration.  The herm's repeated, irregular screams are covering everyone else's though, and the abundant flow of girl-squirt and pre-cum leaking out of your connected genitals tells you much about both your states of arousal.  It won't be long before you both come.\n\n", false);
                }
            }
        }
        ...
        tentacleFapCum() {
            ...
            if (this.player.cocks[x].cockLength >= 40 && this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE) {
                this.outputText("  Your tentacle pecker starts vibrating on its own, and soon it also releases a voluminous amount of jizz inside the herm's vagina.  She is also reaching her climax; her pussy is drenching the end of your tentacled shaft with girl-juices.", false);
                return true;
            }
            return false;
        }
    }
    exports.FapArena = FapArena;
});
//# sourceMappingURL=FapArena.js.map