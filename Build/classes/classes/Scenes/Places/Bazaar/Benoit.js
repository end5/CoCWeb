define(["require", "exports", "./BazaarAbstractContent", "../../../GlobalFlags/kFLAGS", "../../../PregnancyStore", "../../../PerkLib", "../../../ItemType", "../../../StatusAffects", "../../../../../includes/appearanceDefs"], function (require, exports, BazaarAbstractContent_1, kFLAGS_1, PregnancyStore_1, PerkLib_1, ItemType_1, StatusAffects_1, appearanceDefs_1) {
    "use strict";
    ...
    class Benoit extends BazaarAbstractContent_1.BazaarAbstractContent {
        ...
        benoitMF(stringM, stringF) {
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 1 || this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 2)
                return stringF;
            return stringM;
        }
        benoitLover() {
            return this.flags[kFLAGS_1.kFLAGS.BENOIT_TIMES_SEXED_FEMPCS] >= 2;
        }
        benoitAffection(changes = 0) {
            if (changes != 0) {
                this.flags[kFLAGS_1.kFLAGS.BENOIT_AFFECTION] += changes;
                if (this.flags[kFLAGS_1.kFLAGS.BENOIT_AFFECTION] > 100)
                    this.flags[kFLAGS_1.kFLAGS.BENOIT_AFFECTION] = 100;
                else if (this.flags[kFLAGS_1.kFLAGS.BENOIT_AFFECTION] < 0)
                    this.flags[kFLAGS_1.kFLAGS.BENOIT_AFFECTION] = 0;
            }
            return this.flags[kFLAGS_1.kFLAGS.BENOIT_AFFECTION];
        }
        benoitKnocksUpPCCheck() {
            //Convert old basi's to real basi's!
            if (this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_BASILISK && this.player.findPerk(PerkLib_1.PerkLib.BasiliskWomb) >= 0)
                this.player.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_BENOIT, this.player.pregnancyIncubation);
            //Knock up chances:
            if ((this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS || this.player.findPerk(PerkLib_1.PerkLib.HarpyWomb) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.Oviposition) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.BasiliskWomb) >= 0) && (this.player.pregnancyIncubation == 0 || this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS)) {
                if (this.player.findPerk(PerkLib_1.PerkLib.BasiliskWomb) >= 0 && this.flags[kFLAGS_1.kFLAGS.BENOIT_TESTED_BASILISK_WOMB] == 1) {
                    if (this.player.pregnancyType != PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS || this.player.pregnancyIncubation == 0) {
                        this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_BENOIT, PregnancyStore_1.PregnancyStore.INCUBATION_BASILISK);
                    }
                    if (this.player.pregnancyIncubation > 0)
                        this.player.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_BENOIT, this.player.pregnancyIncubation);
                }
                else {
                    this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_BASILISK, PregnancyStore_1.PregnancyStore.INCUBATION_BASILISK);
                }
            }
        }
        /**
        ...
        */
        benoitPreggers() {
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 0)
                return false;
            if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] > 0)
                return true;
            return false;
        }
        benoitRegularPreggers() {
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 0)
                return false;
            if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] >= 1 && this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] <= 4)
                return true;
            return false;
        }
        benoitHeavyPreggers() {
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 0)
                return false;
            if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] >= 5 && this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] <= 8)
                return true;
            return false;
        }
        benoitVeryHeavyPreggers() {
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 0)
                return false;
            if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] >= 9 && this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] <= 12)
                return true;
            return false;
        }
        benoitExtremePreggers() {
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 0)
                return false;
            if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] >= 13)
                return true;
            return false;
        }
        benoitInClutch() {
            ...
            var startDay = this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT];
        ...
        */
        benoitKnockUp() {
            ...
            var bounty = (this.player.findPerk(PerkLib_1.PerkLib.ElvenBounty) >= 0) ? true : false;
            var stud = (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftStud) >= 0) ? true : false;
            var alpha = (this.player.findPerk(PerkLib_1.PerkLib.FerasBoonAlpha) >= 0) ? true : false;
            var eggMod = 0;
            if (bounty)
                eggMod += 1;
            if (stud)
            ...
            if (numEggs < minEggs)
                numEggs = minEggs;
            numEggs += eggMod;
            this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] = numEggs;
            this.flags[kFLAGS_1.kFLAGS.FEMOIT_INCUBATION] = 168;
            return true;
        }
        clearBenoitPreggers() {
            if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] != 0) {
                this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS_LAID] += this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS];
                this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] = 0;
                this.flags[kFLAGS_1.kFLAGS.FEMOIT_INCUBATION] = 0;
                this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT] = this.getGame().model.time.days; // Cycle "resets" based off birth day.
            }
        }
        //Introduction Scenes
        benoitIntro() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_IN_BENOITS] == 0) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.BENOIT_SUGGEST_UNLOCKED] == 0 && this.player.hasVagina() && (this.player.inHeat || this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS || this.player.findPerk(PerkLib_1.PerkLib.HarpyWomb) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.Oviposition) >= 0) && (this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS || this.player.pregnancyIncubation == 0) && this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 0) {
                if (this.flags[kFLAGS_1.kFLAGS.BENOIT_SUGGEST_UNLOCKED] == 0)
                    this.benoitAndFemPCTalkAboutEggings();
                suggest = this.eggySuggest;
                suggestText = "Suggest";
            }
            else if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT_DONE] == 1 && this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT] <= this.getGame().model.time.days && this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 0) {
                this.femoitNextDayEvent();
            }
            else if (this.benoitInClutch() && this.flags[kFLAGS_1.kFLAGS.FEMOIT_READY_FOR_EGGS] == 0 && (this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 1 || this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 2)) {
                this.flags[kFLAGS_1.kFLAGS.FEMOIT_READY_FOR_EGGS]++;
            ...
            else if (this.benoitPreggers() && this.flags[kFLAGS_1.kFLAGS.FEMOIT_INCUBATION] < 0) {
                // Missed it by a week
                if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_INCUBATION] < -168) {
                    this.outputText("When you enter the stall, you notice that Benoite's stomach is flat again. She gives you a toothy grin when you enter her stall. \"<i>I have good newz [name]! You are a fazer! " + String(this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS]) + " timez over in fact! Oh I wish zat you could have helped; but I was ztrong, ztrong enough get through it on my own.</i>\" she gushes, speaking at a mile-a-minute. She's clearly pleased with herself; and your virility.");
                    ...
                    this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT] -= 7;
                }
                else {
                    this.femoitBirths();
                    return;
            ...
            else if (!this.benoitInClutch() && !this.benoitPreggers() && (this.getGame().model.time.days - this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT] >= 30) && (this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] > 0)) {
                if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_FIRST_CLUTCH_MISSED] == 0) {
                    this.flags[kFLAGS_1.kFLAGS.FEMOIT_FIRST_CLUTCH_MISSED]++;
                    ...
                    this.outputText("The flat-bellied basilisk is tucking away into a plate laden with a heavy omlette when you arrive.");
                ...
                if (this.benoitAffection() <= 10)
                    this.outputText("Once again, you carefully enter the gloom of Benoit's salvage shop.  The proprietor sniffs the air as you enter, and then looks at you sourly.  \"<i>Well?</i>\" he rasps.");
                //Benoit reacts after fucking the PC.
                else if (this.flags[kFLAGS_1.kFLAGS.BENOIT_TIMES_SEXED_FEMPCS] == 1 && this.flags[kFLAGS_1.kFLAGS.BENOIT_POST_FIRSTFUCK_TALK] == 0)
                    this.firstTimeAfterBoningEncounterBenoit();
                else if (this.benoitAffection() < 35)
                    this.outputText("Once again, you carefully enter the gloom of Benoit's salvage shop.  The proprietor sniffs the air as you enter, and then relaxes in his seat.  \"<i>Allo again, " + this.player.short + ".  What brings you 'ere?</i>\"");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_SUGGEST_UNLOCKED] > 0 && this.player.hasVagina() && this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 0) {
                suggest = this.eggySuggest;
                suggestText = "Suggest";
            }
            if (this.player.hasCock() && this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] > 0 && this.player.lust >= 33) {
                suggest = this.femoitSexIntro;
                suggestText = "Sex";
            }
            this.flags[kFLAGS_1.kFLAGS.TIMES_IN_BENOITS]++;
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_WOMB_TALK_UNLOCKED] == 1 && this.player.findPerk(PerkLib_1.PerkLib.BasiliskWomb) < 0 && this.flags[kFLAGS_1.kFLAGS.BENOIT_TESTED_BASILISK_WOMB] == 0 && this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 0)
                womb = this.tryToConvertToBassyWomb;
            var fem;
            if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_UNLOCKED] == 1 && this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 0) {
                // Only available if the player hasn't since fucked Benoit after unlocking the option.
                if (this.flags[kFLAGS_1.kFLAGS.BENOIT_TIMES_SEXED_FEMPCS] == 0) {
                    fem = this.benoitFeminise;
                }
            }
            this.choices("Buy", this.benoitsBuyMenu, "Sell", this.benoitSellMenu, "Talk", this.talkToBenoit, suggestText, suggest, "Basil. Womb", womb, "Feminize", fem, "", undefined, "", undefined, "", undefined, "Leave", this.bazaar.enterTheBazaar);
        }
        //Buy or Sell First Time, only if prelover/prefem: You ask him what the deal is with his shop.
        buyOrSellExplanationFirstTime() {
            this.flags[kFLAGS_1.kFLAGS.BENOIT_EXPLAINED_SHOP]++;
        ...
        benoitsBuyMenu() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_1] == '')
                this.updateBenoitInventory();
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_EXPLAINED_SHOP] == 0)
                this.buyOrSellExplanationFirstTime();
            var buyMod = 2;
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 1) {
                buyMod = 1.66;
            ...
            this.outputText("\n" + ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.BENOIT_1]).longName + ": " + Math.round(buyMod * ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.BENOIT_1]).value));
            this.outputText("\n" + ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.BENOIT_2]).longName + ": " + Math.round(buyMod * ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.BENOIT_2]).value));
            this.outputText("\n" + ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.BENOIT_3]).longName + ": " + Math.round(buyMod * ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.BENOIT_3]).value));
            this.simpleChoices(this.flags[kFLAGS_1.kFLAGS.BENOIT_1], this.createCallBackFunction(this.benoitTransactBuy, 1), this.flags[kFLAGS_1.kFLAGS.BENOIT_2], this.createCallBackFunction(this.benoitTransactBuy, 2), this.flags[kFLAGS_1.kFLAGS.BENOIT_3], this.createCallBackFunction(this.benoitTransactBuy, 3), "", undefined, "Back", this.benoitIntro);
        }
        benoitSellMenu() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_EXPLAINED_SHOP] == 0)
            ...
            var sellMod = 3;
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_EGGS] > 0 || this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] != 0)
                sellMod = 2;
            ...
            if (totalItems > 1)
                this.addButton(7, "Sell All", this.createCallBackFunction2(this.benoitSellAllTransact, totalItems, sellMod));
            this.addButton(9, "Back", this.benoitIntro);
        }
        benoitTransactBuy(slot = 1) {
            this.clearOutput();
            var itype;
            var buyMod = 2;
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] == 1)
                buyMod = 1.66;
            if (slot == 1)
                itype = ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.BENOIT_1]);
            else if (slot == 2)
                itype = ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.BENOIT_2]);
            else
                itype = ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.BENOIT_3]);
            ...
            this.player.gems -= Math.floor(buyMod * itype.value);
            this.statScreenRefresh();
            this.inventory.takeItem(itype, this.benoitsBuyMenu);
        }
        benoitSellTransact(slot, sellMod) {
            this.clearOutput();
            if (this.benoitLover())
                this.outputText("Benoit" + this.benoitMF("", "e") + " gives your object the briefest of goings-over with " + this.benoitMF("his", "her") + " fingers before stowing it away and handing over your gem reward with a trusting smile.");
            else
                this.outputText("Following a painstaking examination of what you've given him with his hands and nose, Benoit grudgingly accepts it and carefully counts out your reward.");
            this.player.gems += Math.floor(this.player.itemSlots[slot].itype.value / sellMod);
        ...
        benoitSellAllTransact(totalItems, sellMod) {
            this.clearOutput();
            var itemValue = 0;
            for (var slot = 0; slot < 5; slot++) {
                if (this.player.itemSlots[slot].quantity > 0 && Math.floor(this.player.itemSlots[slot].itype.value / sellMod) >= 1) {
                    itemValue += this.player.itemSlots[slot].quantity * Math.floor(this.player.itemSlots[slot].itype.value / sellMod);
            ...
            if (this.benoitLover())
                ...
                this.outputText("Following a painstaking examination of the items you've given him with his hands and nose, Benoit grudgingly accepts them and carefully counts out your " + Benoit.num2Text(itemValue) + " gem reward.");
        ...
        updateBenoitInventory() {
            ...
            if (this.temp == 0)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_1] = this.consumables.INCUBID.id;
            else if (this.temp == 1)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_1] = this.consumables.MINOBLO.id;
            else if (this.temp == 2)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_1] = this.consumables.MINOCUM.id;
            else if (this.temp == 3)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_1] = this.consumables.EQUINUM.id;
            else if (this.temp == 4)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_1] = this.consumables.BLACKPP.id;
            else if (this.temp == 5)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_1] = this.consumables.SMART_T.id;
            else if (this.temp == 6)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_1] = this.consumables.VITAL_T.id;
            else
                this.flags[kFLAGS_1.kFLAGS.BENOIT_1] = this.consumables.DBLPEPP.id;
            ...
            if (Benoit.rand(10) == 0) {
                this.flags[kFLAGS_1.kFLAGS.BENOIT_1] = this.consumables.GODMEAD.id;
            }
            ...
            this.temp = Benoit.rand(7);
            if (this.temp == 0)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.SUCMILK.id;
            else if (this.temp == 1)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.W_FRUIT.id;
            else if (this.temp == 2)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.WETCLTH.id;
            else if (this.temp == 3)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.GLDSEED.id;
            else if (this.temp == 4)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.LABOVA_.id;
            else if (this.temp == 5)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.SNAKOIL.id;
            else if (this.temp == 6)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.S_GOSSR.id;
            else
                this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.B_GOSSR.id;
            ...
            if (Benoit.rand(100) < 4) {
                this.temp = Benoit.rand(5);
                if (this.temp == 0)
                    this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.BIMBOLQ.id;
                else if (this.temp == 1)
                    this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.L_PNKEG.id;
                else if (this.temp == 2)
                    this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.L_BLUEG.id;
                else if (this.temp == 3)
                    this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.BROBREW.id;
                else
                    this.flags[kFLAGS_1.kFLAGS.BENOIT_2] = this.consumables.TSTOOTH.id;
            }
            //Slot 3 Any one of the following: Maid's Clothes, Wizard Robes, Tough Silk, Slutty Swimwear, Goo Chunk, Chitin Plate
            this.temp = Benoit.rand(5);
            if (this.temp == 0)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_3] = this.armors.W_ROBES.id;
            else if (this.temp == 1)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_3] = this.useables.T_SSILK.id;
            else if (this.temp == 2)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_3] = this.armors.S_SWMWR.id;
            else if (this.temp == 3)
                this.flags[kFLAGS_1.kFLAGS.BENOIT_3] = this.useables.GREENGL.id;
            else
                this.flags[kFLAGS_1.kFLAGS.BENOIT_3] = this.useables.B_CHITN.id;
            if (Benoit.rand(10) == 0) {
                //There is a 10% chance the following items will appear in Slot 3: Bondage Straps, Nurse Outfit, Red Party Dress
                this.temp = Benoit.rand(2);
                if (this.temp == 0)
                    this.flags[kFLAGS_1.kFLAGS.BENOIT_3] = this.armors.BONSTRP.id;
                else
                    this.flags[kFLAGS_1.kFLAGS.BENOIT_3] = this.armors.NURSECL.id;
            }
        ...
        talkToBenoit() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_TALKED_TODAY] == 0) {
                this.flags[kFLAGS_1.kFLAGS.BENOIT_TALKED_TODAY] = 1;
                this.benoitAffection(5);
            }
            //Basilisk Womb
            //Requires: Had sex with Benoit at least twice, have vagina, select talk
            if (((this.flags[kFLAGS_1.kFLAGS.BENOIT_TIMES_SEXED_FEMPCS] > 2 && this.player.inte >= 60 && this.flags[kFLAGS_1.kFLAGS.BENOIT_WOMB_TALK_UNLOCKED] == 0) || this.flags[kFLAGS_1.kFLAGS.BENOIT_TIMES_SEXED_FEMPCS] == 2) && this.player.hasVagina()) {
                ...
                if (this.player.inte >= 60) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.BENOIT_WOMB_TALK_UNLOCKED] = 1;
            ...
            //First time Talk: 
            else if (this.flags[kFLAGS_1.kFLAGS.BENOIT_TALKED_TO_PROPERLY] == 0) {
                this.flags[kFLAGS_1.kFLAGS.BENOIT_TALKED_TO_PROPERLY]++;
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_TALKED_TO] == 0 && this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] != 0) {
                this.flags[kFLAGS_1.kFLAGS.FEMOIT_TALKED_TO]++;
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.BENOIT_TALKED_TO_PROPERLY] != 0 && this.benoitAffection() >= 40 && this.flags[kFLAGS_1.kFLAGS.BENOIT_TIMES_SEXED_FEMPCS] == 0 && this.flags[kFLAGS_1.kFLAGS.FEMOIT_UNLOCKED] == 0) {
            ...
            //Subsequent Talk
                ...
                if (choice == 0) {
                    ...
                    //[Deep cave cleared: 
                    if (this.flags[kFLAGS_1.kFLAGS.DEFEATED_ZETAZ] > 0)
                    ...
                    this.outputText("You ask " + this.benoitMF("Benoit", "Benoite") + " what results when basilisks mate with harpies.");
                    ...
                    if (this.benoitMF("he", "she") == "he")
                        this.outputText("  There's a hint of longing jealousy in the basilisk's voice and when he lapses into silence you decide not to push the subject.");
                }
                ...
                //(Randomly generated.  Added to normal talk options after PC has had sex with Benoit two times or more regardless of womb quest.)
                    ...
                    this.outputText("You ask Benoit there is anything useful he can tell you about the demon strongholds.");
                    ...
                    this.outputText("You ask Benoit if he can suggest anything to help you fight his brethren in the high mountains.");
                    ...
                    this.outputText("You ask Benoit if he really, <b>really</b> can tell who you are just by smell.");
                    ...
                    if (this.benoitLover() && this.player.hasCock() && this.player.hasVagina())
        ...
        benoitAndFemPCTalkAboutEggings() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.BENOIT_SUGGEST_UNLOCKED] = 1;
            this.outputText("Benoit seems very on edge today.  He paces up and down, returns your greeting with a stiff nod, and fiddles endlessly with the stock in reach of his counter as you search for a topic.  You ask if there's something wrong.");
        ...
        eggySuggest() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_TESTED_BASILISK_WOMB] == .5) {
                this.suggestSexAfterBasiWombed(true);
                return;
            }
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_TIMES_SEXED_FEMPCS] > 0) {
                if (this.player.isTaur()) {
                    this.outputText("You silently reach across the counter to squeeze his hands again.  Benoit grins with deep affection at you and, hand in hand, the two of you quietly debunk to the store room again.");
                    ...
                    this.outputText("You silently reach across the counter to squeeze his hands again.  Benoit beams at you and, hand in hand and without a word, the two of you depart to the store room again.");
                    this.outputText("\n\nOnce again, you carefully inch your blind charge to a clear cranny and push him against a wooden wall, standing back to slowly peel off your [armor].  You grin as you ostentatiously drop each piece onto the packed earth, allowing him to guess what it is by the sound it makes.  His breathing comes heavier as your undergarments make a feathery sound as they fall.  As you take his hands and lay them upon your naked skin, you think about how you want to go about this.");
                }
            ...
            this.flags[kFLAGS_1.kFLAGS.BENOIT_TIMES_SEXED_FEMPCS]++;
            if (this.player.isTaur()) {
                //Suggest: 
                ...
                if (this.player.gender == 3) {
                    ...
                    if (this.player.longestCockLength() <= 10)
                        this.outputText("  Although this is evidently an uncanny experience for him, he does manage a cocky smile as his hand moves around your male sex. “Mine is bigger,” he teases.  Unable to reward his cheek from where he is, you simply snort and shuffle your hooves, impatient now with need.");
                    //[cock  >10 inches: 
                    else
                        this.outputText("  This is evidently an uncanny experience for him, the alien nature of it deepening as his hands moves around your male sex. “Oly Gods [name], you are a monster,” he says thickly.  You smile and stamp your hooves, impatient now with need.");
                }
                ...
                if (this.player.inHeat)
                    this.outputText("  By now your vagina is practically gushing, your bodies' own deep seated pheromone need stoked to blazing heights by the basilisk's gentle, painstaking exploration of your body.  You cannot stop thrusting yourself against his soaked hand, announcing how badly you want this with heavy moans.");
                ...
                if (this.player.lactationQ() >= 50)
                    this.outputText("  The slow, sensual sex is enough for you to begin to bead milk from your sensitive [nipples]; you moan as the flow intensifies until you are instinctively kneading your [chest], spurting your sweet, warm fluids onto the floor.  Benoit starts in genuine amazement at the sound.  “Mammals are so damn weird,” he mutters, making you giggle.");
                ...
                if (this.player.gender == 3)
                    this.outputText("  [EachCock] thickens and spurts in sympathy to your female high, spattering the floor with white paint.");
            }
            else {
                this.outputText("You reach your fingers across the counter and lightly touch Benoit's hands, saying you don't mind working out a few natural urges, if he's in the mood.");
                ...
                //[Demon: 
                if (this.player.horns > 0 && this.player.hornType == appearanceDefs_1.HORNS_DEMON && this.player.tailType == appearanceDefs_1.TAIL_TYPE_DEMONIC && this.player.demonScore() >= 3)
                ...
                else if (this.player.earType == appearanceDefs_1.EARS_DOG && this.player.tailType == appearanceDefs_1.TAIL_TYPE_DOG && this.player.dogScore() >= 3)
                ...
                else if (this.player.catScore() >= 3 && this.player.tailType == appearanceDefs_1.TAIL_TYPE_CAT && this.player.earType == appearanceDefs_1.EARS_CAT)
                ...
                else if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_HARPY && this.player.wingType == appearanceDefs_1.WING_TYPE_FEATHERED_LARGE)
                ...
                //[Reptile/Naga: 
                else if (this.player.skinType == appearanceDefs_1.SKIN_TYPE_SCALES && (this.player.lizardScore() >= 3 || this.player.nagaScore() >= 3) || this.player.dragonScore() >= 3)
                ...
                //[Bee: 
                else if ((this.player.wingType == appearanceDefs_1.WING_TYPE_BEE_LIKE_SMALL || this.player.wingType == appearanceDefs_1.WING_TYPE_BEE_LIKE_LARGE) && this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_BEE)
                ...
                if (this.player.inHeat)
                    this.outputText(" By now your vagina is practically gushing, your body's own deep-seated pheromone need stoked to blazing heights by the basilisk's gentle, painstaking exploration.  You cannot stop yourself thrusting against his soaked hand, announcing how badly you want this with heavy moans.");
                ...
                if (this.player.lactationQ() > 100) {
                    ...
                    if (!this.player.isTaur())
                        this.outputText("hit him in the face");
                    else
                        this.outputText("trickle over his fingers");
                    this.outputText(".  \"<i>Mammals are so damn weird,</i>\" he mutters, making you giggle.");
                }
                ...
                if (this.player.hasCock()) {
                    if (!this.player.isTaur())
                        this.outputText("  Stuck between your two burning bodies, y");
                    else
                        this.outputText("Y");
                    this.outputText("our " + this.cockDescript(0) + " spurts in sympathy to your female high, soaking ");
                    if (!this.player.isTaur())
                        this.outputText("both of you");
                    else
                        this.outputText("the dry dirt");
            ...
            this.player.orgasm();
            if ((this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS || this.player.findPerk(PerkLib_1.PerkLib.HarpyWomb) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.Oviposition) >= 0) && (this.player.pregnancyIncubation == 0 || this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS)) {
        ...
        firstTimeAfterBoningEncounterBenoit() {
            ...
            this.flags[kFLAGS_1.kFLAGS.BENOIT_POST_FIRSTFUCK_TALK] = 1;
            this.outputText("A strange, faint noise is emanating from the salvage shop.  It's only when you duck cautiously into the stall proper that you realize it's the sound of a basilisk humming.  Benoit stops to sniff the air when you come in, immediately puts down the mug he is polishing, and beckons you inside.");
        ...
        repeatSexWithBenoitLetHim() {
            ...
            if (this.player.isTaur()) {
                ...
                this.outputText("For the moment you don't do anything; you simply stand back and let his hands slowly move across your frame.  One of his hands comes to rest upon your " + this.nippleDescript(0) + "; as he gently teases and kneads the soft, sensitive flesh his other hand drift downwards, across your belly, around over the crack of your [butt] then down to cup your behind.  Although he is familiar with your frame by now, Benoit never seems to stop being enthralled by your body; there is an unconscious frown of concentration on his face as his smooth hands move across your warm skin, as if he were mapping you in his mind's eye.");
                ...
                if (this.player.isBiped())
                    ...
                    this.outputText("lower body");
                this.outputText(".  His hands descend upon your [butt]; grinning, you poke it outwards invitingly, sighing with affected frustration as the blind basilisk painstakingly lines up his next shot with your drooling, sticky sex.");
                this.outputText("\n\nWhen he slides into you he does so with virtually no resistance whatsoever; the two of you have turned your pussy into an inviting, gooey sleeve.  ");
                if (this.player.vaginalCapacity() < 30)
                    this.outputText("You don't mind; your tight sex is a perfect fit for his smooth, thin dick, and you work with him as he thrusts, pulling and pushing your walls in time with his length, your lubrication allowing him to quickly increase the tempo until the two of you are once again bucking against each other gleefully, your fluids spattering against each other.");
                else
        ...
        repeatBenoitFuckTakeCharge() {
            ...
            if (this.player.isTaur()) {
                ...
                //[Small capacity:]
                if (this.player.vaginalCapacity() < 30)
                    this.outputText("You slide back down onto him, cooing this time as you feel him bottom out with several inches of him still outside of you.  His thin, long length could not be more perfect for your tight sex; he rubs your walls up and down as you dreamily thrust in and out of his body, sending waves of pleasure flowing through you.");
                //Large capacity: 
                else
                    this.outputText("You slide back down onto him, cooing this time as your groin meets his muscular thighs with a wet kiss, your sex swallowing his cock whole.  You begin to ride him hard and slow, bending his cock upwards to push at your sensitive walls, waves of pleasure starting to flow through you.");
                this.outputText("\n\nYou keep at this slow ride for what feels like hours, stopping and starting, pulling and pushing deliberately to keep the basilisk you have backed into a corner under your control.  The pace of the fuck is clearly agonising for Benoit; he pants, tenses and gasps to the wet movement of your [vagina], his face and chest red with extreme arousal, but he lets you stay in control, eventually unable to do anything but lie back and let you have your way with him.");
                this.player.cuntChange(14, true, true, false);
                //[Lactation: 
                if (this.player.lactationQ() >= 50)
                ...
                //begin copypasta
                this.outputText("His hands trail further down, moving into your inner thighs, exploring your soft flesh until he touches your lips.  You close your eyes and sigh as he slowly parts them with his smooth fingers and slides into your [vagina].  Although his breath is becoming increasingly heavy he also seems genuinely curious about you; with surprising gentleness his fingers travel over and around your moistening sex, exploring your every fold, working deeper and deeper as he does.  You let him know what pleases you by sighing when he touches a sweet spot, moving deliberately with his finger's motions so he may give them better attention.  He soon finds your [clit], beginning to bulge with need; slowly he circles it and then flicks at it, gently frigging you.");
                if (this.player.inHeat)
                    this.outputText("  By now your vagina is practically gushing, your body's own deep-seated pheromone need stoked to blazing heights by the basilisk's gentle, painstaking exploration.  You cannot stop yourself thrusting against his soaked hand, announcing how badly you want this with heavy moans.");
        ...
        tryToConvertToBassyWomb() {
            ...
            //Ingredients in inventory: 
                ...
                this.outputText("You ferret out the ingredients you have collected and begin to bang them onto the counter in front of Benoit, telling him that you've got what he needs.  Pierre barks excitedly at the noise.");
                ...
                //[No oviposition:
                if (this.player.findPerk(PerkLib_1.PerkLib.Oviposition) < 0)
                    this.outputText("  You feel slightly bloated, but otherwise fine; you sense that you can lay eggs of your own volition now.");
                else
                    this.outputText("You feel slightly bloated, but otherwise fine; you sense that were you to get impregnated by basilisk seed, the eggs you produce would be pure basilisk.");
                ...
                this.flags[kFLAGS_1.kFLAGS.BENOIT_TESTED_BASILISK_WOMB] = .5;
                //[Lust 30 or more: 
                if (this.player.lust >= 33) {
                    ...
                    if (this.player.tallness <= 78 && !this.player.isTaur())
                        this.outputText("  The basilisk is still for a moment, and then with a sudden surge of movement, grabs you by the waist and hoists you over his shoulder.  You squeal in mock terror as he hauls you as fast as he can into the back room, knocking over half his stock as he does.");
                    else
                        this.outputText("  The basilisk is still for a moment, and then with a sudden surge of movement, grabs you by the waist and frenetically attempts to hoist you over his shoulder.  You are far too big for him though; after several valiant attempts, he collapses against a shelf.  Laughing, you pick the stricken, panting reptile up, hoist him over your own shoulder, and navigate a path into the back room.");
                    this.doNext(this.createCallBackFunction(this.suggestSexAfterBasiWombed, false));
                    return;
                }
                else
                    this.outputText("  You grin and say you're not even sure it worked... but you'll be back at some point to try it out, and he'd better be ready for when you do.  You gently pry yourself out of his grip and leave as deliberately as you can, aware of the beguiling, invisible scent you are leaving for the stunned, silent basilisk to simmer in.");
                this.doNext(this.camp.returnToCampUseOneHour);
            }
        }
        suggestSexAfterBasiWombed(later = true) {
            this.clearOutput();
            ...
            if (!this.player.isTaur()) {
                ...
                if (this.player.tallness > 78)
                    ...
                    this.outputText("Benoit staggers into the back room, bumping into several things as he sets you down, thankfully onto a clear space on the ground.  He leans into you, his weight pushing you onto the ground, hands flying over your [armor], fumbling off clasps and belts when he finds them.  Now that your gut has settled you feel imbued with an odd, ripe sensation; your belly bulges ever-so-slightly with unfertilized eggs and you feel red, soft and ready.  You work with him, wriggling out of your clothes and ripping his own trousers off, spreading your [hips] eagerly as his long, smooth prick springs to attention.");
            ...
            this.flags[kFLAGS_1.kFLAGS.BENOIT_TESTED_BASILISK_WOMB] = 1;
            this.benoitKnocksUpPCCheck();
            //(Oviposition perk added)
            this.player.createPerk(PerkLib_1.PerkLib.BasiliskWomb, 0, 0, 0, 0);
            this.outputText("\n\n(<b>Perk Unlocked: Basilisk Womb - You can now give birth to female basilisks.</b>)");
            if (this.player.findPerk(PerkLib_1.PerkLib.Oviposition) < 0) {
                this.player.createPerk(PerkLib_1.PerkLib.Oviposition, 0, 0, 0, 0);
                this.outputText("\n(<b>Perk Unlocked: Oviposition - You will now regularly lay unfertilized eggs.</b>)");
            }
            if (this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_BASILISK)
                this.player.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_BENOIT, this.player.pregnancyIncubation);
            this.doNext(this.camp.returnToCampUseOneHour);
            this.player.orgasm();
            this.dynStats("sen", -2);
        ...
        popOutBenoitEggs() {
            ...
            if (this.player.hasCock())
                this.outputText("and [eachCock] starting to leak pre-cum ");
            ...
            if (this.player.hasCock())
                this.outputText(" and a downpour of semen");
            this.outputText(".");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_EGGS] > 0)
                this.outputText(" once more");
            this.outputText(".  Well, he will be when this ");
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_EGGS] > 0)
                this.outputText("latest ");
            ...
            this.flags[kFLAGS_1.kFLAGS.BENOIT_EGGS] += Math.floor(this.player.totalFertility() / 10);
            //doNext(1);
        }
        //Feminising
        //Opening Talk
        ...
        femoitInitialTalk() {
            this.clearOutput();
            this.outputText("You ask Benoit if he has ever thought about trying to do something to help his people's plight.");
            ...
            if (this.player.inte >= 60) {
                ...
                this.flags[kFLAGS_1.kFLAGS.FEMOIT_UNLOCKED] = 1;
            }
            else {
        ...
        benoitFeminise() {
            ...
            if (!this.player.hasItem(this.consumables.P_S_MLK, 2) || !this.player.hasItem(this.consumables.L_PNKEG) || !this.player.hasItem(this.consumables.OVIELIX) || !this.player.hasItem(this.consumables.REPTLUM)) {
                ...
                this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT] = this.getGame().model.time.days + 1;
                this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT_DONE] = 1;
                this.menu();
                this.doNext(this.camp.returnToCampUseOneHour);
            }
        }
        femoitNextDayEvent() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.BENOIT_STATUS] = 1;
            this.flags[kFLAGS_1.kFLAGS.FEMOIT_NEXTDAY_EVENT_DONE] = 2;
            this.outputText("A strange, faint sound is emanating from the salvage shop.  It's only when you duck cautiously into the stall proper that you realize it's the sound of a basilisk humming.  Benoit stops to sniff the air when you come in, immediately puts down the mug she is polishing, and beckons you inside.");
        ...
        femoitFirstTimeYes() {
            this.flags[kFLAGS_1.kFLAGS.TIMES_FUCKED_FEMOIT]++;
            this.clearOutput();
            ...
            else if (this.player.demonScore() > 4)
            ...
            else if (this.player.dogScore() >= 4 && this.player.earType == 2 && this.player.tailType == 2)
            ...
            else if ((this.player.bunnyScore() >= 4 && this.player.earType == 7 && this.player.tailType == 10) || (this.player.catScore() >= 4 && this.player.earType == 5 && this.player.tailType == 8))
            ...
            else if (this.player.harpyScore() >= 4 && this.player.wingType != 0 && this.player.armType == 1)
            ...
            else if (this.player.beeScore() >= 4 && this.player.wingType != 0 && this.player.lowerBody == 7)
            ...
            else if (this.player.gooScore() >= 4 && this.player.skinType == 3)
            ...
            else if (this.player.skinType == 2)
            ...
            if (this.player.biggestCockLength() <= 10)
                this.outputText("  Although this is evidently an uncanny experience for her, she does manage a cocky smile as her hand moves around your sex.  \"<i>Mine was bigger,</i>\" she teases.  You reward her cheek by doing some feeling yourself, grasping her large, supple behind, making her squeak as you move into her.");
            else
            ...
            if (this.player.biggestCockLength() < 15 && this.player.balls == 0)
                this.outputText("  Eventually you manage to hilt yourself entirely in her depths, your stomach pressing against her own tight belly.");
            else if (this.player.biggestCockLength() < 15 && this.player.balls > 0)
                this.outputText("  Eventually you manage to hilt yourself in her depths, your [balls] pressing into her sex as your stomach bumps into her own tight belly.");
            else if (this.player.biggestCockLength() >= 15 && this.player.balls == 0)
                this.outputText("  Eventually you manage to bottom out, your dick pressed against her cervix.");
            else if (this.player.biggestCockLength() >= 15 && this.player.balls > 0)
                this.outputText("  Eventually you manage to bottom out, your dick pressed against her cervix, your [balls] swinging heavily below your shaft.");
            ...
            if (this.player.isLactating())
                this.outputText(" The pressure and arousal makes your [nipples] dribble milk, spattering fluids across both of your chests.");
        ...
        femoitSexIntro() {
            ...
            if (!this.benoitPreggers()) {
                ...
                if (this.benoitInClutch())
                    this.outputText("  Her stomach bulges with clutch and the air is thick with female musk; the sight and smell of overwhelming ripeness speaks to your body in a way which bypasses your higher cognition entirely, sending you growling on top her, barely even hearing her giggle.");
                ...
                if (this.player.biggestCockLength() < 15)
                    this.outputText("Soon you are hilting yourself in her depths, making her gasp as you slap into her.");
                else
                    this.outputText("Soon you are bottoming out in her, making her gasp as your hulking length spreads her wide.");
                ...
                if (!this.player.isTaur()) {
                    ...
                    if (!this.benoitInClutch())
                        this.outputText(" your stomach beating out a slapping rhythm against her own flat abdomen.  ");
                    else
                        this.outputText(" your stomach beating out a slapping rhythm against her bulging, gravid abdomen.  ");
                }
                ...
                if (this.player.balls > 0)
                    this.outputText(" and [balls].  You tumble over your peak as her cunt suddenly tightens around yours, sending surge after surge of cum into her fertile depths, your body seized in a rictus of pleasure.");
                if (this.player.cumQ() >= 2500)
                    this.outputText("  The quantity of it is such that it quickly dribbles back out around your cock and pools on the floor.");
                ...
                if (this.player.cumQ() >= 2500)
                    this.outputText("  Because her womb is already so jam-packed with eggs, the bulk of your deposit simply oozes messily back out of her, leaving her well and truly creampied.");
                ...
                if (this.player.isTaur()) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_SPOONED] == 0) {
                        this.flags[kFLAGS_1.kFLAGS.FEMOIT_SPOONED]++;
                    ...
                    if (this.player.balls == 0)
                        this.outputText(" with a smile, knowing damn well you don't, literally");
                    this.outputText(".");
        ...
        femoitBirths() {
            ...
            // (First time: 
            if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_HELPED_LAY] == 0) {
                ...
                if (this.benoitVeryHeavyPreggers() || this.benoitExtremePreggers())
                    this.outputText("... which is good, because you can tell there're a lot of them coming");
                ...
                if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_HELPED_LAY] == 1) {
            ...
            this.flags[kFLAGS_1.kFLAGS.FEMOIT_HELPED_LAY]++;
            ...
            if (this.silly())
                this.outputText(".  It's shaped like a complex rhomboidal polygon with 15 sides.");
            else
                this.outputText(", the smoothly curved peak of a jade egg beginning to crest.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] >= 2) {
                ...
                if (this.benoitRegularPreggers()) {
                    this.outputText("\n\nHer labors are over quickly; the clutch isn't that big, and her muscles are already well prepared.  Soon, she's squatting over a pile of" + Benoit.num2Text(this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS]) + " eggs.");
                }
                else if (this.benoitHeavyPreggers()) {
                    this.outputText("\n\nThanks to the shape of her eggs and the fact she's already properly dilated, the rest of the clutch comes relatively quickly.  It's a pretty decent brood of children, you feel; " + Benoit.num2Text(this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS]) + " eggs, all told.");
                }
                else if (this.benoitVeryHeavyPreggers()) {
                    this.outputText("\n\nYou're glad that giving birth is easier for Benoite than it would be for a mammal, as she needs all the help she can get.  Her huge stomach proves that she wasn't merely putting on weight as egg after egg pushes out of her stretched cunt.  By the time she's flat as a board again, you've counted her offspring; " + Benoit.num2Text(this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS]) + " eggs, each with a baby basilisk still growing inside it.");
                }
                else if (this.benoitExtremePreggers()) {
                    this.outputText("\n\nBenoite groans and moans like she's dying, but somehow finds the strength to soldier on as egg after egg after egg slides from her well-stuffed womb.  For a moment you wonder just how many she's got in there, but the cascade finally comes to an end; with a great deal of relief on both your parts.  While Benoite gasps for breath from her labors, you busy yourself counting your brood... " + Benoit.num2Text(this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS]) + " eggs!");
                }
            }
            ...
            if (this.flags[kFLAGS_1.kFLAGS.FEMOIT_EGGS] > 1)
                this.outputText("s");
            ...
            if (this.benoitRegularPreggers())
                this.outputText(" She sighs softly.  \"<i>A small clutch, this is... normal for my people, yes, but not very good for my mission, is it?  Still, a small step to freedom is still a step.</i>\"  She manages to smile.  \"<i>My children will be free, and that is something to celebrate.</i>\"");
            else if (this.benoitHeavyPreggers())
                this.outputText(" \"<i>My, a nice big clutch we had together, didn't we?</i>\" she smiles, proudly.  \"<i>Yes, these will be strong children, I zink.</i>\"");
            else if (this.benoitVeryHeavyPreggers())
                this.outputText(" \"<i>...Wow, you're quite ze stud, aren't you?</i>\" Benoite says, giving a throaty growl of lust.  \"<i>I chose well when I decided to let you fertilize my eggs... so many eggs, too.</i>\"");
            else if (this.benoitExtremePreggers())
                this.outputText(" The basilisk stops after her counting, visibly stunned.  She recounts her eggs again, and then again, shaking her head in amazement.  \"<i>Incredible... simply, incredible.  I didn't think it was possible for one woman to lay zo many eggs!  Zut alors!</i>\"  A sudden look of horrified realization washes over her features.  \"<i>I'm going to be run off my feet with all zese little monsters, aren't I?</i>\" she murmurs to herself.");
    ...
    exports.Benoit = Benoit;
});
//# sourceMappingURL=Benoit.js.map