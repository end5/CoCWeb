define(["require", "exports", "./BazaarAbstractContent", "../../../CoC", "../../../GlobalFlags/kFLAGS", "../../../StatusAffects", "../../../../../includes/appearanceDefs", "../../../PerkLib"], function (require, exports, BazaarAbstractContent_1, CoC_1, kFLAGS_1, StatusAffects_1, appearanceDefs_1, PerkLib_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Roxanne extends BazaarAbstractContent_1.BazaarAbstractContent {
        //Roxanne Poisontail
        //-no hair, 
        ...
        timeChange() {
            ...
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00225]++;
            //Reset if she finds someone to take it (random at high values)
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 300 && this.model.time.hours == 1 && Roxanne.rand(5) == 0)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00225] = 1;
            //hangover status stuff
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Hangover) >= 0) {
                //Countdown
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Hangover) > 0)
                    this.player.addStatusValue(StatusAffects_1.StatusAffects.Hangover, 1, -1);
                else {
                    this.outputText("\n<b>Your head finally clears as your hangover wears off.  Drinking with the shemale lizard was definitely a bad idea.</b>\n", false);
                    //Restore stats
                    this.player.str += this.player.statusAffectv2(StatusAffects_1.StatusAffects.Hangover);
                    this.player.spe += this.player.statusAffectv3(StatusAffects_1.StatusAffects.Hangover);
                    this.player.inte += this.player.statusAffectv4(StatusAffects_1.StatusAffects.Hangover);
                    this.dynStats("cor", 0);
                    //Clear status
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Hangover);
                    return true;
                }
            }
            if (this.model.time.hours > 23 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00227] > 0)
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00227]--; //Reduce drinking contest bonus
            return false;
        }
        timeChangeLarge() {
            return false;
        ...
        RoxanneAppearance() {
            ...
            if (this.model.time.hours > 12 && this.model.time.hours < 19) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00221] == 0)
                    ...
                    return this.RoxanneChooseApproachOrRepeat;
            }
            return undefined;
        }
        ...
        RoxanneChooseApproachOrRepeat() {
            ...
            this.outputText("", true);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00221] == 0) {
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00221]++;
                ...
                this.outputText("She says, \"<i>You don't look like one of them... you don't even smell like one.  ", false);
                if (this.player.cor > 66)
                    this.outputText("Yeah, you've got some corruption in you, but I don't think you're contagious like the demons and their ilk yet.  ", false);
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00222] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00223] <= 0) {
            ...
            //[Approach – lost last contest and she's huge]
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00224] == 2 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 200) {
                ...
                this.outputText("It looks like she wants to engage you in another drinking contest.  If you lose ", false);
                if (this.player.analCapacity() >= 100)
                    this.outputText("she's going to keep you stretched and gaping", false);
                else
                    this.outputText("she's probably going to stretch your ass beyond its normal limits", false);
            ...
            //[Approach Roxanne and won last time – small Roxanne]
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00224] == 1 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00225] < 200) {
                ...
                this.outputText("Roxanne slides an empty mug your way.  Do you try to drink her under the table again?", false);
            }
            //[Approach Roxanne and won last time – HUEG Roxanne]
                ...
                this.outputText("If you're reading this, something broke.", false);
            //Clear the 'are you losing the contest intionally flag'
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00226] = 0;
        ...
        roxanneDrinkingContestLoseDeliberately() {
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00226] = 1;
        ...
        roxanneDrinkingContest() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 200)
                this.outputText("stumbles over her huge manhood, working towards", false);
            else
                this.outputText("saunters over to", false);
            ...
            this.outputText("You take the mug and hand it to the tainted 'taur working the tap.  ", false);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00222] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00223] <= 0 || this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00224] == 2) {
                this.outputText("He smirks at you as he fills it, radiating amusement at your attempt to out-drink Roxanne Poisontail.  It seems the locals don't believe you can win", false);
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00224] == 2)
                    this.outputText(" after your last humiliation.", false);
                else
                    this.outputText(" against such a renowned foe.", false);
            }
            else
                this.outputText("He leers at Roxanne as he fills your mug, remembering her last defeat and likely wishing he could feel her tongue as you did.", false);
            this.outputText("  You ", false);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00222] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00223] < 3)
                this.outputText("hesitantly sniff at the brew, taking in its dark color and heady, hoppy aroma before", false);
            else
                this.outputText("smile and lick your lips, inhaling the hoppy aroma before", false);
            this.outputText(" you slam the dark beer back and swallow.\n\n", false);
            //(FIRST TIME) 
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00222] + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00223] <= 0)
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00222] == 0)
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00222] > 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00223] <= 0)
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00223] > 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00224] == 1)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00226] == 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 200)
                    ...
                    this.outputText("hard-to-hide bulge", false);
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00226] == 0)
                score = (this.player.tallness * ((this.player.thickness + 100) / 200) * (this.player.tou / 100)) + this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00227];
            //If score is less than 30-50 (Strahza is inconsistant!)
            //[Lose!] 
            if (score < (45 + Roxanne.rand(20))) {
                //Increment loss count!
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00223]++;
                //Set who won contast last
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00224] = 2;
                //Gain big bonus
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00227] += 10;
                this.outputText("Giggling and nearly tripping up on your own " + this.player.feet() + ", you stumble up to the corrupted deer-taur.  He looks at your wobbling stance, nearly-vacant eyes, and dopey grin before he shakes his head from side to side and says, \"<i>No.</i>\"  ", false);
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00226] == 0)
                    this.outputText("Nooooo! You're cut off! That means Roxanne won...", false);
                else
                    this.outputText("Yessss!  You finally got so drunk that Roxanne has no excuse not to pack your drunk ass full of lizan-spoo!", false);
                ...
                if (this.player.buttRating > 12 && this.player.tone <= 50 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00223] > 1 && Roxanne.rand(2) == 0)
                    this.doNext(this.bigBootyRoxanneContestLoss);
                //TO huge or regular anal
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00225] >= 200)
            ...
            //[WIN]
                ...
                //Increment win count!
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00222]++;
                //Set who won contest last
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00224] = 1;
                //Gain small bonus
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00227] += 4;
                ...
                this.outputText("The other lizans are looking at you with a watchful eye.  It looks like you'll have to stick by the terms of the contest.  What manner of oral service do you make her provide?", false);
                //[Fellatio] [Cunnilingus] [Rimming]
                var fellatio = undefined;
                var cunnilingus = undefined;
                if (this.player.hasCock())
                    fellatio = this.roxanneGivesABlowjob;
        ...
        roxanneGivesABlowjob() {
            ...
            this.outputText("You open the lower portion of your " + this.player.armorName + " and, pulling it back, hang out your " + this.multiCockDescriptLight() + "; ", false);
            if (this.player.lust < 70)
                this.outputText("it stiffens to a full, erect state.", false);
            else
                this.outputText("the already-hard cock-flesh stands proud and erect.", false);
            ...
            if (this.player.hasKnot(x))
                this.outputText("knot", false);
            else if (this.player.hasSheath())
                this.outputText("sheath", false);
            else
                this.outputText("base", false);
            this.outputText(", squeezing you softly while she steadies herself on your " + this.cockDescript(x) + ".  She titters, letting a few inches of tongue slip through her lips to envelop your sensitive " + this.player.cockHead(x) + ", circling the engorged cock-flesh with drunken slobbers.  ", false);
            if (this.player.balls > 0)
                this.outputText("A set of warm, long-nailed fingers squeeze your " + this.ballsDescriptLight() + ", dragging sharp nail-tips along the underside of your sack to tease the poor, cum-packed orbs.  ", false);
            ...
            this.outputText("You slump back in your chair, sprawling out your " + this.player.legs() + " around you, completely relaxed by the alcohol flowing through your veins and the exquisite oral service.  Roxanne returns her focus to your " + this.cockDescript(x) + ", more tongue spilling from her gaping maw to curl around your lust-engorged shaft.  The drunken lizard's oral organ devours ", false);
            if (this.player.cockArea(x) < 60)
                this.outputText("the entire length of your " + this.cockDescript(x), false);
            else
                this.outputText("as much of your over-sized member as she can encompass", false);
            this.outputText(", constricting, snake-like, to hold you in a slippery, warm embrace.  Suddenly, a pointed nail drags over your taint, pressing just hard enough to hold you still while the shemale pirate works your " + this.cockDescript(x) + " with her tongue", false);
            if (this.player.hasVagina())
                this.outputText(", stopping just short of your female entrance", false);
            this.outputText(".\n\n", false);
            this.outputText("Slurping and pumping, the pulsating tongue drags over your " + this.cockDescript(x) + ", molding into a perfect cock-sleeve.  At first it's a slow, gradual pump that smears your shaft with booze-flavored spit, but when the first dollop of pre-cum rolls onto the flexible fellatio-tool, the pirate goes into over-drive, pumping with wild abandon.  Her tail whips back and forth, passionately slapping the table, chairs, and dirt in her excitement.\n\n", false);
            this.outputText("A few demons start to approach, but the lizan crew interposes themselves between their captain and the interlopers, shooing them off before they can start something.  You barely notice, so focused are you on the feel of saliva running down your " + this.cockDescript(x) + " and the soft, pliant mouth flesh trying to wring the jism from your shaft.   The warmth of orgasm starts to build in your loins, and you begin to pump at the tongue instinctively, hips rising up off the chair in spite of the sharp fingernail's warning.\n\n", false);
            this.outputText("SMACK!  Roxanne's tail slaps into your " + this.buttDescript() + ", stinging the exposed " + this.player.skinDesc + ".  Her eyebrows narrow in irritation while she wraps her arms around your waistline, steadying her off-balance body while she spanks and pumps you in a drunken frenzy.  You hump her face, pressing your " + this.player.cockHead(x) + " against her lips to smear them with a glaze of leaky pre-cum.  Grabbing her horns, you cry out and pleasure and try to pull her down, but she spanks you, HARD.  You yelp in pain, dropping her horns and submitting completely to her tongue and the pleasure it brings.\n\n", false);
            ...
            if (this.player.cumQ() >= 1500)
                this.outputText("huge torrent utterly drenches her face, horns, neck, and tight top", false);
            else if (this.player.cumQ() >= 500)
                this.outputText("a huge spurt soaks her face and horns", false);
            else
                this.outputText("big spurt splatters her face", false);
            this.outputText(" with cum.  Her soft, oral organ squeezes the spit-slick surface, milking the rest of your cum from your " + this.cockDescript(x) + " and " + this.ballsDescriptLight() + ".\n\n", false);
            this.outputText("The pirate pulls back, uncoiling her tongue to slurp the heavy load from her face", false);
            if (this.player.cumQ() >= 1500)
                this.outputText(" and body", false);
            this.outputText(".  \"<i>Jeeze, pent up much?</i>\" she laughs, struggling to stand while giggling at her own supposed cleverness.  Happy with how the contest worked out, you slip " + this.sMultiCockDesc() + " into your " + this.player.armorName + " and wobble off back to camp.", false);
            //(-100 lust, -1 int)
            this.player.orgasm();
            this.dynStats("int", -1);
        ...
        roxanneCunnilingus() {
            this.spriteSelect(78);
            this.outputText("", true);
            this.outputText("You shimmy out of your " + this.player.armorName + " and lean back, exposing your " + this.vaginaDescript() + " to the drunken lizan's maw.  She wobbles back and forth for a moment, clutching at your " + this.player.legs() + " to steady herself before she leans in, brushing her scaled nose against your vulva.  You shudder from the sudden contact with her scales, but she doesn't rush it, instead huffing and sniffing at the moist entrance.  Her alcohol-lidded eyes gaze up at you, the bleary orbs slightly confused as her jaw slowly opens to release her tongue.\n\n", false);
            this.outputText("The pink length of Poisontail's tongue oozes out like a sentient creature, waggling slightly as if sniffing the air before it presses on the ", false);
            if (this.player.wetness() >= 4)
                this.outputText("juice-dribbling ", false);
            else if (this.player.wetness() >= 2)
                this.outputText("juicy ", false);
            ...
            this.outputText("Face blushing red, you groan and hump at the lizan, grabbing her horns so that you can smear her nose into your " + this.clitDescript() + ".  She pulls back, resisting your insistent pulls with inebriated strength, but before you can let go she reverses direction and smashes her forehead into your gut, winding you.  Your fingers release immediately, clutching at your aching middle while the angry lizard snarls, \"<i>You're getting oral, NOT using me as a dildo!  ...but I am sorry I hit you that hard. I just needed to breathe.  Relax and let me make it up to you...</i>\"\n\n", false);
            this.outputText("The drunken lizan puts her soft, lightly scaled fingers around you to squeeze at your " + this.buttDescript() + " and leans in to give your " + this.clitDescript() + " a tender kiss.  Her massive tongue ", false);
            if (this.player.clitLength < 16)
                this.outputText("dwarfs", false);
            else
                this.outputText("envelops", false);
            this.outputText(" the ", false);
            if (this.player.clitLength < 1)
                this.outputText("little pleasure buzzer", false);
            else if (this.player.clitLength < 3)
                this.outputText("swollen love-button", false);
            else
                this.outputText("cock-like lady-part", false);
            this.outputText(", slobbering over it with a lewd tongue-kiss. Her frothy spit completely soaks it ", false);
            if (this.player.clitLength >= 3)
                this.outputText("before she curls tightly around the female member, enveloping it with flexible, gooey tongue.  You catch your breath just in time to exhale the noisy sounds of your pleasure, and groan out loud.  Roxanne takes the auditory encouragement to heart and begins pumping her tongue while she places her lower lips against your " + this.vaginaDescript() + " and hums.  As if that wasn't enough, she begins twisting the curled tongue up and down your " + this.clitDescript() + " rotating it as she pumps you.", false);
            else
                this.outputText("before she lets her spit-sloppy tongue push through the saliva-soaked entrance of your mound.  You catch your breath just in time to exhale noisy sounds of pleasure, groaning out loud while you're speared with flexible, gooey tongue. Roxanne takes the auditory encouragement to heart and begins to pump her tongue deep inside you, at least two feet of constantly-thickening appendage coiling over your entrance before sliding inside to kiss your cervix.  As if that wasn't enough, a moment later she starts to hum, nuzzling at your " + this.clitDescript() + " while she tongue-fucks you.", false);
            this.outputText("\n\n", false);
            //(ORGASM HERE!)
            this.outputText("Helplessly twitching in your place, you fight with your body's desire to copulate, trying not to impale your quivering snatch on the pirate's nose.  ", false);
            if (this.player.hasFuckableNipples()) {
                this.outputText("Roxanne pulls her hands off your ass and reaches up, swaying unsteadily until she catches your " + this.nippleDescript(0) + "s.  A second later she slips her digits inside the welcoming tit-pussies, finger-fucking your breasts as ", false);
                if (this.player.biggestLactation() < 1.5)
                    this.outputText("expertly as the one below", false);
                else
                    this.outputText("they begin to squirt milk around her", false);
                this.outputText(".  ", false);
            }
            this.outputText("Unable to dam the pressure up inside you any longer, you cum with brain-breaking, mouth-babbling intensity.  The lizan doesn't relent in the slightest as you begin to spasm", false);
            if (this.player.wetness() >= 5)
                this.outputText(" and squirt", false);
            this.outputText(" against her.  She tightens her grip and speeds up her tongue's sensual massaging, nearly blacking you out while you writhe in her embrace.  Heat, pure, blissful heat, spreads through you, draining the strength from your uncontrollable twitches and leaving languid warmth in its place.  ", false);
            if (this.player.hasCock())
                this.outputText(this.SMultiCockDesc() + " bounces on her head, between her horns, spilling a trail of sticky seed down her back.  ", false);
            ...
            this.outputText("You smirk back, slowly putting your clothes back on.  Roxanne can do little to prevent you from noting the massive, unmistakable cock-outline in her pre-cum-soaked pants.  She gives you a smoky glare filled with lust and aggression, but she won't be getting her prize this time!", false);
            //(-100 lust, -1 int)
            this.player.orgasm();
            this.dynStats("int", -1);
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        roxanneRimjob() {
            this.spriteSelect(78);
            this.outputText("", true);
            this.outputText("You shimmy out of your " + this.player.armorName + " and smirk, turning around to lean onto the table", false);
            if (this.player.biggestTitSize() >= 2)
                this.outputText(", your breasts cushioning you from the hard wood below", false);
            this.outputText(".  Poisontail eyeballs the ring of your " + this.assholeDescript() + ", salivating as she grabs your " + this.buttDescript() + " in her scaled hands.  With anguished slowness, she pulls the cheeks as wide apart as possible.  You hear her gasp in delight a split-second before you do the same.  Her tongue launched from her mouth and found your " + this.assholeDescript() + " immediately!  Now she's sliding it in circles around the sensitive ring, making the skin of that pucker tighten and wink.\n\n", false);
            this.outputText("Roxanne groans and gives your " + this.buttDescript() + " a raunchy squeeze, making love to your cheeks as her tongue worships your asshole.  She murmers, \"<i>Thish would be sho much better if it was jussht foreplay.  Why don't you lose next time, okay babe?</i>\"  You moan out loud when her tongue returns to its task, arching your back and whimpering from the intense, anal pleasure.  ", false);
            if (this.player.hasCock()) {
                this.outputText(this.SMultiCockDesc() + " ", false);
                if (this.player.lust < 70)
                    this.outputText("hardens", false);
                else
                    this.outputText("pulses with need", false);
                this.outputText(", a bead of pre-cum already hanging from the tip.  ", false);
            }
            if (this.player.hasVagina())
                this.outputText("Meanwhile, your neglected box is getting wetter and wetter, with no sign of stopping.  The lizan's massive, questing tongue ignores it.  ", false);
            ...
            if (this.player.hasCock()) {
                this.outputText("Surprisingly, one of the pirate's hands comes off your " + this.buttDescript() + " to tug on ", false);
            ...
            //(Optional pussy milking if no cock)
                ...
                this.outputText("Surprisingly, one of the pirate's hands comes off your " + this.buttDescript() + " to play with your " + this.vaginaDescript() + ".  Long, sharp nails play over the sensitive skin of your vulva while the supple, scaled thumb presses between them.  Juicy girl-cum quickly coats her fingers, but it doesn't seem to bother her in the least.\n\n", false);
            this.outputText("The long, wondrous tongue pushes forward, wriggling inside you.  At first it's just the tip, but the drunken lizard forces inch after inch inside you with constant intensity.  You can feel her spit frothing around your " + this.assholeDescript() + ", bubbling while she fills your backdoor with ever larger quantities of saliva-covered tongue.  Seeming to go on forever, the penetration robs you of strength, filling you with dozens more inches.  Roxanne hums at your dark hole, vibrating her tongue inside you while it arches to caress the most sensitive spots.\n\n", false);
            this.outputText("Orgasm hits you powerfully, your " + this.assholeDescript() + " doing its best to choke the massive, pink tongue inside it.  You throw back your head and howl with pleasure, bumping your " + this.buttDescript() + " into your lizan lover's nose unconsciously.  She gives you a knowing squeeze while her tongue keeps up the attack, forcing waves of unfiltered, raw pleasure into your cerebellum.", false);
            if (this.player.hasCock()) {
                this.outputText("  You spurt in her hand, letting her squeeze out dollop after dollop of cum.  Somehow you keep your whimpering to a minimum while that long, perfect tongue rubs your prostate and her hand squeezes every last drop into the dirt.", false);
                if (this.player.cumQ() < 500) { }
                else if (this.player.cumQ() < 1000)
                    this.outputText("  It forms a nicely-sized pool before the ground wicks it up.", false);
                else if (this.player.cumQ() < 1500)
                    this.outputText("  It forms a large pool before the ground soaks it up.", false);
                else
                    this.outputText("  It forms a massive pool before the ground soaks it up.", false);
            }
            else if (this.player.hasVagina()) {
                ...
                if (this.player.wetness() >= 4)
                    ...
                    this.outputText("sliming them with copious girl-cum ", false);
                this.outputText("while she teases your " + this.clitDescript() + " with those terribly-slow touches.", false);
            }
            this.outputText("\n\n", false);
        ...
        roxanneReamsYouNormal() {
            ...
            this.outputText("You giggle underneath the lizan, your face mopping up the frothy brew that spilled during the previous bout of binge drinking.  Lapping it up, you forget about your predicament as you adjust to the warm, scaled body overtop you.  Roxanne leaves you to your distractions while she wiggles out of her pants, her tail swaying to counterbalance the now-freed bulk of her member.  The sodden shaft rises to bump your butt, dripping with pre-cum as it wiggles between your cheeks.  It prods your " + this.assholeDescript() + ", rousing you from your drunken stupor and earning a look back, but the pirate begins to tongue the edge of your ear, making you giggle and relax into sexy, alcohol-lubricated acquiescence.\n\n", false);
            ...
            this.player.buttChange(Math.floor(30 + (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00225] / 4)), true, true, false);
            this.outputText("\n\n", false);
            ...
            if (this.player.balls > 0)
                this.outputText("against your own, the " + Roxanne.num2Text(this.player.balls + 2) + " orbs rolling around each other in their sweaty sacks", false);
            else if (this.player.hasVagina())
                this.outputText("against your " + this.vaginaDescript() + ", the sweaty orbs growing slick with the moisture of your growing need", false);
            else
                this.outputText("against your taint, the sweaty skin pressing hard between your bodies", false);
            this.outputText(".\n\n", false);
            ...
            this.outputText("You shake your head no, and are rewarded for your disobedience with a violent, butt-jiggling tail-whip.  Gasping from the pain, your " + this.assholeDescript() + " contracts involuntarily, milking Roxanne's member for a few more drops of pre.  The aggressive lizard really gets into it, her massive, DD-cup tits pinning you to the table while she smacks your cheeks with her flexible lizan tail.   Pounding and slapping you, she abuses you for every dick-milking squeeze you'll give her, ", false);
            if (this.player.findPerk(PerkLib_1.PerkLib.Masochist) < 0)
                this.outputText("until you're voluntarily working your abdominal muscles to avoid the pain.", false);
            else
                this.outputText("until you're moaning with delight from every butt-reddening strike.", false);
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText("It bounces against your belly with your heartbeats, loving the forced anal pressure.  ", false);
                else
                    this.outputText("They bounce against your belly with your heartbeats, loving the anal pressure.  ", false);
                this.outputText("Sticky droplets of pre-cum leak from you, and you can't stifle the pleasured gasps that burst from your maw.", false);
                if (this.player.hasVagina())
                    this.outputText("  To your delight and shame, your pussy is equally aroused by the action, musky and wet from the pirate's lewd anal battering.", false);
                this.outputText("\n\n", false);
            }
            //(JUST CUNTS:  
            else if (this.player.hasVagina()) {
                ...
                if (this.player.wetness() < 2)
                    this.outputText("sliming your ready vulva.", false);
                    ...
                    this.outputText("which leak in a steady stream from your ready vulva.", false);
                this.outputText("\n\n", false);
            }
            if (this.player.tallness <= 50)
                this.outputText("Roxanne shifts forward, placing her tits around your head, letting the smooth scales of her mammoth breasts envelop you in their soft embrace.", false);
            else
                this.outputText("Roxanne shifts forward slightly, heaving the smooth scales of her mammoth breasts a little further up your back.", false);
            ...
            this.outputText("Your insides froth and churn while they're filled with pent-up lizan cum.  The shemale's balls bounce against you, violently relaxing and contracting in time with the bursts of cream filling your intestines.  Wetness fills you completely, but the spurts go on relentlessly.  Suddenly, small squirts of hot cum escape your tender " + this.assholeDescript() + ", running down Roxanne's still-pulsing balls.  The action smears the cummy lather everywhere, and while the discomfort of being so completely filled rises, the pleasure grows in equal measure until you're twitching and moaning with whorish delight.\n\n", false);
            this.outputText("Finishing her obscene orgasm, Roxanne sighs, depositing one last creamy dollop into your anal seed-lake.  She coos in your ear, \"<i>That was nice...  I can see you shaking.  Did you enjoy being a loser that much?</i>\"  You nod meekly, blubbering out your embarassed agreement.  \"<i>How pathetic.  You'll probably be back here tomorrow to lose again, won't you?  Such a shameful butt-slut.</i>\"\n\n", false);
            ...
            if (this.player.hasCock()) {
                this.outputText("  ", false);
                if (this.player.cumQ() >= 1500) {
                    this.outputText("A torrential outpouring of spunk pours from " + this.sMultiCockDesc() + ", leaking in a steady, submissive flow to grow a ", false);
                    if (this.player.cumQ() <= 2500)
                        this.outputText("puddle", false);
                    else
                        this.outputText("lake", false);
                    this.outputText("below the table.", false);
                }
                else
                    this.outputText("An outpouring of spunk drools from " + this.sMultiCockDesc() + ", spurting submissively under the table.", false);
            }
            if (this.player.biggestLactation() >= 2)
                this.outputText("  Bursts of milk erupt from your pinned " + this.nippleDescript(0) + "s, blasting out while you cum to stain the table white.", false);
            this.outputText("  As it winds down, you fall into slumber, snoring happily after your violation.\n\n", false);
            this.outputText("<b>LATER...</b>\n", false);
            this.outputText("You wake in the lizan's bed<b> with a nasty hangover</b>, her arm curled around your gurgling belly.  From how sore your rear feels, she kept 'winning' at least two or three more times.  Your head is pounding, your " + this.player.legs() + " are weak, and you dribble cum with every movement.  It takes some doing to extricate yourself from Roxanne's slumbering form, but you find your equipment and leave, hanging your head in shame under the leering eyes of the caravan-goers.", false);
        ...
        roxanneFucksYourAssOHGODITSHUGE() {
            ...
            else if (this.player.tallness < 50)
            ...
            this.outputText("Oh gods, Roxanne's right.  She finished getting you naked while she was talking, and you're completely exposed.  Her hands grab your arm and pull, rolling you onto your front and letting your " + this.player.legs() + " hang off the side of her bed toward the floor.  It's such a silly pose that you nearly forget how perfect a target it makes your " + this.buttDescript() + "!  The now-confident lizan gives your butt-cheek a slap, giggling when you start in surprise.  ", false);
            if (this.player.tailType > appearanceDefs_1.TAIL_TYPE_NONE)
                this.outputText("She lifts your tail ", false);
            else
                this.outputText("She spreads your cheeks ", false);
            this.outputText("to examine your " + this.assholeDescript() + ", licking the ring before she prods it with a gentle finger-tip.  The excited pirate exclaims, \"<i>", false);
            if (this.player.analCapacity() < 150)
                this.outputText("Oh, poor " + this.player.mf("boy", "girl") + "!  I don't think you can handle me like this.  Let me get the ointment... after all, I want you to come back for more.", false);
            else
                this.outputText("Oh, wow!  It's so... stretchy.  Mmmm, I won't even have to use the ointment with you.  You're probably used to this kind of thing, aren't you?", false);
            this.outputText("</i>\"\n\n", false);
            if (this.player.analCapacity() < 150)
                this.outputText("Cold slime is rubbed around your pucker, making you shiver before a nozzle is forced completely into the anal ring.  Roxanne squeezes, applying a generous coating of the stuff to your internals before she pulls it out and smiles.  \"<i>That should make it nice and stretchy.  I don't know what I would've done if I hadn't met those goblins!</i>\" exclaims the eager shemale.", false);
            else
                this.outputText("You shiver as she runs her fingers and tongue around the ring of your pucker, pulling and stretching on it to make completely sure it'll be able to handle the huge injection she plans to push in.  \"<i>Yeah, you're ready - it's already trying to milk my fingers. I can't wait to feel what it does to my cock!</i>\" exclaims the eager shemale.", false);
            ...
            this.outputText("Suddenly, all traces of her hesitation or restraint evaporate; the lizan pushes forwards, burying the first few inches of her massive cock-head into your clutching, gaped backdoor.  ", false);
            if (this.player.analCapacity() < 150)
                this.outputText("Thanks to the ointment, there's little discomfort from the gut-distending penetration.", false);
            else
                this.outputText("Thanks to your experience with that hole, there's little discomfort from the gut-distending penetration.", false);
            ...
            if (this.player.analCapacity() >= 150)
                this.outputText("spit", false);
            else
                this.outputText("ointment", false);
            this.outputText("-slicked ass to accept ever-greater quantities of cock.  Sharp fingernails drag over your " + this.hipDescript(), false);
            if (this.player.skinType == appearanceDefs_1.SKIN_TYPE_PLAIN)
                this.outputText(", leaving red lines in your unblemished skin", false);
            this.outputText(" while your hips visibly spread, somehow accepting something a normal human body never could.", false);
            this.player.buttChange(Math.floor(30 + (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00225] / 4)), true, true, false);
            this.outputText("\n\n", false);
            this.outputText("Roxanne stops and pants lustily, her two-foot prehensile tongue hanging into her cavernous cleavage while she strokes the exposed half of her member.  She traces one of her fingers over the swell of your left cheek, letting her nail leave behind ", false);
            if (this.player.skinType == appearanceDefs_1.SKIN_TYPE_SCALES)
                this.outputText("a roughly-scratched 'X' on your scales", false);
            else
                this.outputText("an irritated, red 'X' on your skin", false);
            ...
            if (this.player.balls > 0)
                ...
                this.outputText("now-narrow taint", false);
            ...
            if (this.player.hasCock() && this.player.cumQ() >= 1000)
                this.outputText(", drooling spit into the huge puddle of cum you made on her bed", false);
            else if (this.player.hasVagina() && this.player.wetness() >= 4)
                this.outputText(", drooling spit into the sloppy puddy of fem-cum you splattered on the mattress", false);
            this.outputText(".", false);
            this.outputText("  <b>You'll wake and head back to camp with a massive hangover.</b>", false);
            //(-100 lust, -1 int, hangover effect)
            this.player.orgasm();
            this.dynStats("int", -1);
            this.applyHangover();
        ...
        applyHangover() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Hangover) >= 0)
                this.player.changeStatusValue(StatusAffects_1.StatusAffects.Hangover, 1, 8);
            //No hangover yet?  Create and yoink stats
            else {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Hangover, 8, 0, 0, 0);
                //Strength minus 5
                this.temp = 5;
                while (this.temp > 0) {
                    this.temp--;
                    ...
                    if (this.player.str >= 2) {
                        ...
                        // strUp.visible = false;
                        this.player.str--;
                        this.player.addStatusValue(StatusAffects_1.StatusAffects.Hangover, 2, 1);
                    }
                }
                //speed minus 10
                this.temp = 10;
                while (this.temp > 0) {
                    ...
                    if (this.player.spe >= 2) {
                        ...
                        // speUp.visible = false;
                        this.player.spe--;
                        this.player.addStatusValue(StatusAffects_1.StatusAffects.Hangover, 3, 1);
                    }
                }
                //int minus 15
                this.temp = 15;
                while (this.temp > 0) {
                    ...
                    if (this.player.inte >= 2) {
                        ...
                        this.player.inte--;
                        this.player.addStatusValue(StatusAffects_1.StatusAffects.Hangover, 4, 1);
                    }
                }
            }
        ...
        bigBootyRoxanneContestLoss() {
            ...
            if (!this.player.hasVagina())
                this.outputText(" \"<i>Oh, I know you don't have a pussy, but tonight, you're my big-bootied, cum-dumpster bitch!</i>\"");
            else
                this.outputText("\"<i>Oh, you'll make such a great anal cum-dumpster for me.  Your poor pussy will be so cum-starved, but you'll be so stuffed with jizz that you'll look pregnant anyhow!</i>\"");
...
//# sourceMappingURL=Roxanne.js.map