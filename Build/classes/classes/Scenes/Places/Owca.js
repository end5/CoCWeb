define(["require", "exports", "../../BaseContent", "../../GlobalFlags/kFLAGS", "./Owca/LustyDemons", "../../StatusAffects", "../../Items/WeaponLib", "../../PerkLib", "../../../../includes/appearanceDefs", "../../PregnancyStore", "../../GlobalFlags/kGAMECLASS", "./Owca/Farmers"], function (require, exports, BaseContent_1, kFLAGS_1, LustyDemons_1, StatusAffects_1, WeaponLib_1, PerkLib_1, appearanceDefs_1, PregnancyStore_1, kGAMECLASS_1, Farmers_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Owca extends BaseContent_1.BaseContent {
        ...
        gangbangVillageStuff() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.OWCA_UNLOCKED] == 1)
                ...
                this.gangbangVillageFirstGoRound();
        }
        //First encounter (Z)
        gangbangVillageFirstGoRound() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.DECLINED_TO_VISIT_REBECCS_VILLAGE] == 0 && this.flags[kFLAGS_1.kFLAGS.TIMES_REFUSED_REBECCS_OFFER] == 0 && this.flags[kFLAGS_1.kFLAGS.TIMES_IN_DEMON_PIT] == 0) {
                //[Attitude is set to 50]
                this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] = 50;
                this.flags[kFLAGS_1.kFLAGS.VAPULA_SUBMISSIVENESS] = 50;
                this.outputText("You wander for quite a while in an endless field of grass before spotting a commotion in the distance.  A myriad of creatures have gathered in the path ahead, waving to you enthusiastically, some still holding tightly to their farm tools.  It's quite an odd sight, all these happy farmhands extending a warm welcome.  You simply accept it as a gesture of kindness and make your way toward the crowd of smiling faces.");
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.TIMES_IN_DEMON_PIT] == 0) {
            ...
            //Second (and subsequent) encounter; only happens once PC accepted being sacrificed once (Z)
                ...
                if (this.player.cor > 50)
                    this.outputText("  You can't help but smile internally.  Let her think that, if she wants.");
        ...
        agreeToFollowRebecFirstTime() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_REFUSED_REBECCS_OFFER] == 0) {
                ...
                //[if silly mode on]
                if (this.silly())
                    this.outputText("I-I don't think there's a single grown man or woman in our village that still has their anal virginity.");
                //[if silly mode off]
                else
                    this.outputText("Th-they abused us.  They mistreated us.  They would gather in circles and... use us in every possible way.");
                this.outputText("</i>\"");
                //[if Corr < 20]
                if (this.player.cor < 20) {
                    ...
                    //[if silly mode off] 
                        ...
                        this.outputText("she will never be abused again.");
                    this.outputText("  If there's anything that can be done to hold off these evil creatures, you will do it.");
                }
            ...
            //Subsequent pleas upon first refusal (Z)
                ...
                this.outputText("\"<i>So, have you changed your mind yet?  Will you help us?  The demons will want another sacrifice soon, and we are afraid of what might happen if we don't comply!  Please, do accept this time!</i>\"");
                this.outputText("\n\nYou know very well what these people want: some meat to appease the demons.  Will you help them?");
            }
            //Yes/No
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_IN_DEMON_PIT] == 0)
                this.doYesNo(this.createCallBackFunction2(this.acceptRebeccsPlea, true, true), this.declineRebeccsPlea);
            else
        ...
        declineRebeccsPlea() {
            ...
            //[Attitude is set to 50]
            if (this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] > 5)
                this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] -= 5;
            this.flags[kFLAGS_1.kFLAGS.TIMES_REFUSED_REBECCS_OFFER]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Accept plea (Z)
        acceptRebeccsPlea(firstTime = false, sacrificed = false) {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] += 10;
            if (this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] > 100)
                this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] = 100;
            this.outputText("You tell the desperate girl that you're going to do as she asks.  As soon as you finish speaking, everyone cheers and applauds you, praising you as their savior.  Rebecc grabs hold of your shoulders and gives you a soft kiss on your lips; she whispers, \"<i>Thank you, champion.  We all owe you.  I promise that you will be rewarded for the heroic deed you're about to undertake.</i>\"");
            ...
            if (this.player.cor > 70 && this.player.gender > 0) {
                ...
                this.outputText(" already slickening with sexual juices; the sight of these restraints brings all kinds of perverted thoughts to your mind: dozens of ways to be used and deliciously abused like a sex-toy by wretched and well-endowed beings.");
            }
            //[else]
            else
        ...
        intoTheDemonPit(sacrifice = true) {
            this.clearOutput();
            //N is the number of hours left before night
            if (this.model.time.hours < 21) {
                var passed = 21 - this.model.time.hours;
                this.outputText("<b>" + Owca.Num2Text(passed) + " " + (passed > 1 ? "hours pass" : "hour passes") + "...</b>\n");
                this.model.time.hours = 21;
                this.statScreenRefresh();
            }
            this.outputText("You are awakened by a sudden cackling, and open your eyes; you are almost entirely surrounded by darkness, and the dim light provided by the menacing red moon only makes the landscape bleaker.");
            ...
            if (sacrifice)
                this.outputText(", tangled in your restraints");
            this.outputText(".  She leans down and coos, ");
            //[if first time]
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_IN_DEMON_PIT] == 0)
                this.outputText("\"<i>Awww, look at the poor little thing!  So this is what they gave us this time... Look at [him], everyone!  Do you know you'd be a cute pet?  People here call me Vapula, and I don't think you'll forget that name any time soon.</i>\"");
            //[else if Vapula Submissiveness >50]
            else if (this.flags[kFLAGS_1.kFLAGS.VAPULA_SUBMISSIVENESS] > 50)
                this.outputText("\"<i>You again?  By Lethice, you must really enjoy it!  You love being a bitch for Vapula, don't you?  Yes you do!</i>\"");
            //[else]
            else
                this.outputText("\"<i>Fuck, you again?  Tell me it's so!  I've been looking forward to putting you in your place as my newest slut!</i>\"");
            //[(if sacrificed)
            if (sacrifice) {
                //[if str >= 80]
                ...
                this.outputText("  You're once again feeling regret over letting the villagers hold your equipment, but there's nothing for it now.");
            }
            this.flags[kFLAGS_1.kFLAGS.TIMES_IN_DEMON_PIT]++;
            this.flags[kFLAGS_1.kFLAGS.DAYS_SINCE_LAST_DEMON_DEALINGS] = 0;
            if (sacrifice)
                this.simpleChoices("Submit", this.loseOrSubmitToVapula, "Fight", this.createCallBackFunction(this.fightZeDemons, true), "", undefined, "", undefined, "", undefined);
            else
                this.simpleChoices("Submit", this.loseOrSubmitToVapula, "Fight", this.createCallBackFunction(this.fightZeDemons, false), "", undefined, "", undefined, "", undefined);
        }
        //Submit/Fight
        fightZeDemons(sacrifice = true) {
            this.clearOutput();
            ...
            this.startCombat(new LustyDemons_1.LustyDemons());
            if (sacrifice) {
                //Remove weapon
                ...
                this.monster.createStatusAffect(StatusAffects_1.StatusAffects.BowDisabled, 0, 0, 0, 0);
                if (this.player.str < 80 && this.player.spe < 80) {
                    this.monster.createStatusAffect(StatusAffects_1.StatusAffects.AttackDisabled, 0, 0, 0, 0);
                    this.monster.createStatusAffect(StatusAffects_1.StatusAffects.RunDisabled, 0, 0, 0, 0);
                    this.monster.createStatusAffect(StatusAffects_1.StatusAffects.PhysicalDisabled, 0, 0, 0, 0);
                }
                else {
        ...
        loseOrSubmitToVapula() {
            ...
            this.outputText("  The double penetration is brutal, unexpected and painful.  Your insides are protesting vigorously against this rough treatment, even though you feel a tingle of pleasure gently tickling your colon at every thrust.  ");
            //[(no Buttslut)
            if (this.player.findPerk(PerkLib_1.PerkLib.Buttslut) < 0)
                this.outputText("No!  You aren't supposed to enjoy it...  ");
            this.outputText("You try to cry out but as soon as your mouth opens it is filled with another dick, then a second one.  A third tries to push its way between the first two, stretching your cheeks and making you drool.  Seeing that the monstrous dong won't fit in your already double-stuffed mouth, its owner groans in frustration and proceeds to slap your cheek with it.  He is soon joined by other demons who find the idea very entertaining.");
            ...
            if (this.player.hasCock())
                this.outputText("  It wraps around [eachCock] for a while, jerking it for a bit and rubbing its tip against yours.");
            //[if antennae]
            if (this.player.antennae > appearanceDefs_1.ANTENNAE_NONE)
                this.outputText("  Your antennae are being harshly pulled and twisted; some imps, in a crazy show of libertinism, start inserting your sensitive peduncles down their bloated urethrae. The intimate friction and the sudden jolts when the internal walls slather your appendages in slick, hot pre-cum are driving you mad with irregular shots of unbearable pleasure.");
            //[if horns]
            if (this.player.horns > 0)
                this.outputText("  You feel your horns being used as leverage to slap your head with even more rock-hard dick.  The impacts stun you until your whole forehead feels numb and coated with a mixture of ballsweat and pre-cum.");
            //[if vagina
            if (this.player.hasVagina()) {
                this.outputText("\n\nYou suddenly feel a sharp sensation: your womanhood is finally being penetrated.");
                this.player.cuntChange(60, true, true, false);
                this.outputText("  A dick found a way into your " + this.vaginaDescript(0) + " and is pushing further inside.  Wait, what's this?  A second, and then a third!  There's no way these titanic columns of flesh will... this is too much... you fear you will be torn in half, but at the last moment, you feel someone spilling the content of a flask over your nether-lips.  As if you had lost control of your " + this.vaginaDescript(0) + ", it automatically starts leaking girl-cum in prodigious amounts, and you let out a stifled moan as a delicious shiver runs teasingly across your body.  Your fuck-hole widens under the corrupting effect of the weird mixture you were administered.  ");
                //[set vagstretch up a few levels]
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BonusVCapacity) < 0)
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.BonusVCapacity, 0, 0, 0, 0);
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.BonusVCapacity) < 200)
                    this.player.addStatusValue(StatusAffects_1.StatusAffects.BonusVCapacity, 1, 15);
            ...
            //[if cocks]
            if (this.player.hasCock()) {
                this.outputText("\n\nA soft brush against your " + this.cockDescript(0) + " warns you that your crotch is going to get some more love.  At least four hands are caressing it, helping you rise and thicken until it can't grow anymore.  After a while of playful stroking, the hands are suddenly gone, only to be replaced by a fluid-gushing cunt.  It impales itself on your " + this.cockDescript(0) + " at full force, driving a very whorish and high-pitched cry from its owner.");
                //[if more than 1 and less than 4 cocks]
                if (this.player.cockTotal() > 1)
                    this.outputText("  She is soon joined by other horny girls, too eager to wait for a piece of your crotch to play with.  They all comfortably position themselves, positioning their pussy or anus atop each of your cocks before riding you like there's no tomorrow.");
                //[if 4 to 7 cocks]
                if (this.player.cockTotal() >= 4)
                    this.outputText("  Nevertheless, they aren't satisfied with a single insertion and most grab hold of one of your extra cocks before forcefully stuffing it in their other hole, howling and thrashing all the more as they are penetrated a second time.");
                //[if 7 cocks or more]
                if (this.player.cockTotal() >= 7) {
                    this.outputText("  Sadly, surrounded as you are, no one will be able to find extra room to ride your remaining cocks; fortunately, you feel warm, long demonic tongues being pressed against your " + this.cockDescript(6));
                    if (this.player.cockTotal() > 8)
                        this.outputText(" as well as your remaining pricks");
                    this.outputText(".  The tongues expertly lick your meat and wrap themselves around it, and questing lips give it multiple kisses before one pair suddenly loses patience and deepthroats you with voracity; the tightness of these lips makes them feel like a very efficient cock-ring.  However, it is hard to focus on the sweet warmth provided by these avid mouths when all your other cocks are being clamped by powerful, inhuman vaginal muscles.");
                }
                this.outputText("\n\nBetween every thrust, you feel hands working and polishing your shaft");
                if (this.player.cockTotal() > 1)
                    this.outputText("s");
                this.outputText(", as if every inch had to be taken care of at every instant.  As you slide back into the pussy, the hands return to crawling over your body, caressing your groin and staining your belly with pre-cum - yours and others.");
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.balls > 0)
                    this.outputText(", and your balls swell and boil");
                this.outputText("; a gigantic spooge-flow pushes its way up your urethra and spurts outside in the waiting love-tunnels");
                if (this.player.cockTotal() > 7)
                    this.outputText(" and mouths");
                this.outputText(".  The violent cumshot almost instantly produces a shiver of orgasm once again and vaginal walls contract furiously, determined to absorb as much of your baby-batter as possible.");
                //[if cum production is massive]
                if (this.player.cumQ() > 1500)
                    this.outputText("  The effort appears to be vain, as the absurdly high volume you've ejected is enough to completely pack every hole; the remaining jism spills on the tainted ground, soaking it further.");
            }
            ...
            if (this.player.hasVagina())
                this.outputText(" and filling your womb to its maximum capacity");
            this.outputText(".  The remaining cum spurts outside and dribbles onto your [legs].  Your asshole clenches, squeezing the dongs inside you and milking their very last drops of spunk.");
            //[if vagina]
            if (this.player.hasVagina())
                this.outputText("\n\nYour own " + this.vaginaDescript(0) + " clenches too, doing its best to waste as little semen as possible.  Your muscles quiver as they feel the incoming last release.  Then, in climax, you squirt your own girl-cum, splattering the demon dicks with your juice.");
            //[if lactating breasts]
            if (this.player.lactationQ() > 0)
            ...
            this.flags[kFLAGS_1.kFLAGS.VAPULA_SUBMISSIVENESS] += 10;
            if (this.flags[kFLAGS_1.kFLAGS.VAPULA_SUBMISSIVENESS] >= 90 && this.flags[kFLAGS_1.kFLAGS.VAPULA_SUBMISSIVENESS] < 100)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.VAPULA_SUBMISSIVENESS] >= 100)
                this.doNext(this.slaveToVapulaBadEnd);
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.LostVillagerSpecial) >= 0)
                this.doNext(this.morningAfterRape);
            else
                this.doNext(this.wakeUpAfterDemonGangBangs); //WAKE UP
            this.player.orgasm();
            this.dynStats("lib", 1, "sen", 2, "cor", 3);
            this.flags[kFLAGS_1.kFLAGS.REBECCS_LAST_PLEA] = 0;
        }
        wakeUpAfterDemonGangBangs() {
            this.clearOutput();
            this.model.time.hours = 7;
            this.model.time.days++;
            this.outputText("When you wake up, you are alone, and your restraints are broken.  You are sloshing in a pool of stinky juices; your mouth and ears are still full of it.  Your whole body is covered with a thin white layer that must certainly be dried spooge.  Underneath, you're nothing but bruises and every movement seems to hurt.  A few meters away, outside the pit, you notice your items and your gear.  The village itself appears to be empty... your best assumption is that the residents are hiding, either from shame at having sacrificed you or from awkwardness at the prospect of talking to a sloshing, crusty cumdumpster.  Wearily, you head back to your camp.");
        ...
        defeetVapulasHorde() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.REBECCS_LAST_PLEA] = 0;
            if (this.flags[kFLAGS_1.kFLAGS.VAPULA_SUBMISSIVENESS] <= 0) {
                this.subdueVapula();
                return;
            }
            //Sacrificed and bound
            if (this.monster.findStatusAffect(StatusAffects_1.StatusAffects.AttackDisabled) >= 0) {
                if (this.monster.HP < 1)
                    this.outputText("You grin wickedly as the last demons fall, defeated.  Some of the errant blows have broken and mangled the links of your chains, and you find you can get free with a bit of additional effort.");
                //[if won by Lust]
                else
                    this.outputText("You grin wickedly as the demons give up the fight, too turned on to care about you.  One even begins unfastening your bindings, hopeful desperation glinting in her eyes as she attempts to entice you with her long, thick nipples and enormous, dripping gash.");
            }
            //Not
            else {
                if (this.monster.HP < 1)
                ...
                //[if won by Lust]
                    ...
                    this.outputText("You grin wickedly as the demons give up the fight, too turned on to care about you.  One even has hopeful desperation glinting in her eyes as she attempts to entice you with her long, thick nipples and enormous, dripping gash.");
            }
            ...
            if (this.player.cor > 60 && this.player.gender > 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.VAPULA_SUBMISSIVENESS] -= 5;
                this.cleanupAfterCombat();
            }
        }
        noVapulaSex() {
        ...
        rapeZeVapula() {
            ...
            if (this.player.hasCock()) {
                this.clearOutput();
                this.outputText("The demon horde struggles before you.  With a disdainful smile, you fully expose your genitals for everyone to see.  ");
                //[if cocks]
                if (this.player.hasCock())
                    this.outputText("\n\nYou gently stroke your " + this.cockDescript(0) + ", bringing it to full erectness.  ");
                //[if vagina]
                if (this.player.hasVagina())
                    this.outputText("You stick a finger in your own " + this.vaginaDescript() + " in order to lubricate it.  ");
                this.outputText("The defeated horde watches you touch yourself with avid, almost desperate eyes.  You keep teasing yourself, saving your lust for the torrid storm of rape you're about to unleash on the poor creatures who dared attack you.  You walk among the battered bodies, looking for the prey that will best suit you; then you find her.  Vapula is lying here, her purple skin masking ");
                if (this.monster.HP < 1)
                    this.outputText("the many bruises she's received");
                else
                    this.outputText("the constant flushing due to intense arousal");
                this.outputText(".  You harshly grab her hand and grunt, \"<i>On your feet, cunt.</i>\"  She is too stunned to protest and weakly stands up, her leather straps torn to completely reveal her voluptuous body.  You feel the sudden urge to take her right now and fuck her like a ");
                if (this.player.hasVagina())
                    this.outputText("bitch in heat");
                else
                    this.outputText("centaur in rut, abusing and filling her teasing cunt and ass with every protuberance you have");
                this.outputText(".  However, you have better plans for her.");
                ...
                this.outputText("\n\n\"<i>What are you waiting for?</i>\" she moans.  \"<i>Fuck me already, you dirty bastard.  Go ahead, stuff me.  Why don't you get down to business?  Are you afraid that you might last only a minute?  What are you, a poor little sissy with no stamina?  You innocent little " + this.player.mf("manlet", "maiden") + ", I will–</i>\"");
                ...
                this.outputText("\n\nWith lazy nonchalance you grab hold of another demon crawling at your feet, another succubus; although not so tall or big-breasted as Vapula, her provocative curves are a delight to your eyes.  You bend her over and, without ceremony, start working her tight pucker, filling her insides with your " + this.cockDescript(0) + ".");
                if (this.player.cockTotal() > 1)
                    this.outputText("  Seeing that she has extra room left, you grab another of your dongs and put it at the entrance of her dripping cunt before forcing it in.");
                ...
                if (this.player.cockTotal() > 1)
                    this.outputText("s");
                this.outputText(" in front of the once-powerful dominatrix, grunting and panting as you accelerate the pace, until you finally reach your climax and release rope after rope of jism in your fuck-toy, completely packing her backdoor");
                if (this.player.cockTotal() > 1)
                    this.outputText(" and her love-tunnel");
                this.outputText(".");
                //[if massive cum production]
                if (this.player.cumQ() > 1000)
                    this.outputText("  Some of it spurts by little jets outside of her, even as she instinctively contracts her muscles to keep as much spooge as possible and her belly accomodates by bloating out absurdly.");
                this.outputText("  Needless to say, watching this rough ");
                if (this.player.cockTotal() == 1)
                    this.outputText("anal");
                else
                    this.outputText("double-penetration");
                this.outputText(" session has brought Vapula to a new level of arousal; she is struggling to free her arms and finger herself, but her tight restraints only allow her to wriggle uncomfortably.  Her pussy is gushing of its own and she whimpers from time to time, unable to control her lust.");
                this.outputText("\n\nYou throw away your expendable");
                if (this.player.cumQ() > 1000)
                    this.outputText(", expandable");
                this.outputText(" cumdumpster and grab another slut.  This time you feel like you could use a blowjob to clean off the demonic sweat and slime from your cock; you forcefully open her jaw and shove your " + this.cockDescript(0) + " down her throat without any care.  The sudden influx of dickflesh blocking her air-flow makes her choke and cough, but a withdrawal and a good cock-slap reminds her of her place.  \"<i>You fucking bitch!  You goddamn worthless slut!  What good are you if you can't even give proper head?  Lick, you whore!  I want your tongue all over my crotch!  You can breathe when you've properly moistened my ");
                if (this.player.balls > 0)
                    this.outputText("balls");
                else
                    this.outputText(this.player.skin());
                this.outputText("!</i>\"  The poor demoness, cheek stained with semen, mutters an apology and proceeds to lick your " + this.cockDescript(0) + ", suckling the tip, ");
                if (this.player.balls > 0)
                ...
                this.outputText("warming up your dickflesh with her demonic tongue.  You enjoy her ministrations while staring Vapula in the eyes; she has trouble looking back at you as her body trembles and her eyes widen at your sheer display of depravity.  Your semen-dribbling shaft");
                if (this.player.cockTotal() > 1)
                    this.outputText("s harden and thicken ");
                else
                    this.outputText(" hardens and thickens ");
                this.outputText("again as the demoness sucks you off; Vapula can't help but take a quick glance at it, but you pretend not to notice.  After all, she's only teasing herself for you.");
                ...
                if (this.player.cockTotal() > 1)
                    this.outputText("In an unholy sex-frenzy, you want more; you start grabbing creatures by groups and alternatively pump in and out of their asses with your " + this.cockDescript(0) + ", always hungry for more anal.");
            ...
            //Victory rape using vagina/anus [Take Dicks in All Holes](Z)
                ...
                if (this.player.vaginalCapacity() > 80)
                    this.outputText("His cock is lost in your vast cunt and you work him as hard as you can to feel him against your walls, his body convulsing and dazed eyes rolling against the wet, savage rape.  ");
                this.outputText("You keep thrusting back and forth, treating the worthless horned boy like a disposable dildo.  As you pump him, you look at Vapula, warning her, \"<i>Don't turn your head.  If you ever look away or close your eyes you will regret it.</i>\" Overwhelmed by your dominance and subdued by the defeat, Vapula can only nod.");
                ...
                //[if squirter] 
                if (this.player.wetness() >= 5)
                    this.outputText("The sound of spattering fluid fills the air as your cunt spurts its juices around the incubus's cock, coating him in your fragrant slime.  ");
                this.outputText("Against your relentless milking pressure he stands no chance and he moans raggedly as he cums in tandem, still incapable of moving his body as your mixed juices dribble down him.");
        ...
        owcaMainScreenOn() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.REBECCS_LAST_PLEA] == 1 && !kGAMECLASS_1.kGAMECLASS.vapula.vapulaSlave()) {
                this.rebeccsLastPlea();
                return;
            }
            if (this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] <= 5 && this.flags[kFLAGS_1.kFLAGS.OWCA_ANGER_DISABLED] == 0 && this.flags[kFLAGS_1.kFLAGS.OWCA_SACRIFICE_DISABLED] == 0) {
                this.desperateVillages();
                return;
            }
            //Desperate plea
            if (Owca.rand(10) <= 2 && this.flags[kFLAGS_1.kFLAGS.DAYS_SINCE_LAST_DEMON_DEALINGS] >= 7 && this.flags[kFLAGS_1.kFLAGS.OWCA_SACRIFICE_DISABLED] == 0) {
            ...
            //[if attitude > 80]
            if (this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] > 80)
                this.outputText("Villagers greet you as you arrive, praising your courage and your heroism.  People shake your hands or ask you to kiss them, as if they hoped your nobility were somehow contagious.  Once they're done complimenting and flattering you in every way possible, they leave you to your business.");
            //[if 60<=attitude<80]
            else if (this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] > 60)
                this.outputText("Villagers greet you with a friendly smile as you arrive.  Some approach you and thank you for what you've done, before leaving awkwardly.  They're obviously not used to strangers.");
            //[if 40<=attitude<60]
            else if (this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] > 40)
                this.outputText("Villagers seem to accept your presence without comment now; though none go out of their way to greet you, neither do they avoid doing so when you pass by.");
            //[if 20<attitude <= 40]
            else if (this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] > 20)
                this.outputText("Villagers keep looking at you uncomfortably; no one seems to be willing to talk to you apart from Rebecc, your friend.");
            //[if attitude <= 20]
            else
                this.outputText("Villagers here appear to be openly hostile.  You keep hearing muffled whispers as you pass by, and people look at you rancorously.  They don't bother you, though.");
            //end variable display
            this.outputText("  The village is rather small.  A dozen humble thatched cottages are standing here and there, linked by dirt tracks and enclosed with small palisades.  There seems to be very little activity.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.DAYS_SINCE_LAST_DEMON_DEALINGS] == 7 && this.flags[kFLAGS_1.kFLAGS.OWCA_SACRIFICE_DISABLED] == 0)
                this.outputText("  A week");
            else if (this.flags[kFLAGS_1.kFLAGS.DAYS_SINCE_LAST_DEMON_DEALINGS] > 7 && this.flags[kFLAGS_1.kFLAGS.OWCA_SACRIFICE_DISABLED] == 0)
                this.outputText("  More than a week");
            if (this.flags[kFLAGS_1.kFLAGS.DAYS_SINCE_LAST_DEMON_DEALINGS] >= 7 && this.flags[kFLAGS_1.kFLAGS.OWCA_SACRIFICE_DISABLED] == 0)
                this.outputText(" has passed since the last offering to the demons; guarding the pit would certainly help improve your relations with the little town's denizens.");
            //Option: 
            var pit = undefined;
            var herd = undefined;
            var tavern = undefined;
            if (this.model.time.hours >= 16 && this.flags[kFLAGS_1.kFLAGS.OWCA_SACRIFICE_DISABLED] == 0) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] >= 50) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] >= 10) {
        ...
        owcaTavern() {
            ...
            //SheepMk
            var milk = this.createCallBackFunction(this.owcaBuySetup, this.consumables.SHEEPMK);
            this.outputText("\nSheep Milk Bottle: " + (180 - this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE]) + " gems");
            if ((180 - this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE]) > this.player.gems)
                milk = undefined;
            var goblin = this.createCallBackFunction(this.owcaBuySetup, this.consumables.GOB_ALE);
            this.outputText("\nGoblin Ale: " + (60 - Math.round(this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] / 2)) + " gems");
            if ((60 - Math.round(this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] / 2)) > this.player.gems)
                goblin = undefined;
            var brew = this.createCallBackFunction(this.owcaBuySetup, this.consumables.BROBREW);
            if (Owca.rand(10) > this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] / 10) {
                this.outputText("\nBro Brew: 2000 gems");
                if ((2000) > this.player.gems)
                    brew = undefined;
            }
            else
                brew = undefined;
            var cum = this.createCallBackFunction(this.owcaBuySetup, this.consumables.MINOCUM);
            this.outputText("\nMinotaur Cum: " + (300 - this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE]) + " gems");
            if ((300 - this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE]) > this.player.gems)
                cum = undefined;
            this.outputText("</i>");
            this.simpleChoices("Sheep Milk", milk, "Goblin Ale", goblin, "Bro Brew", brew, "MinotaurCum", cum, "Back", this.gangbangVillageStuff);
        }
        owcaBuySetup(item) {
            if (item == this.consumables.SHEEPMK)
                this.buyOwcaShit(item, (180 - this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE]));
            else if (item == this.consumables.GOB_ALE)
                this.buyOwcaShit(item, (60 - Math.round(this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] / 2)));
            else if (item == this.consumables.BROBREW)
                this.buyOwcaShit(item, 2000);
            else
                this.buyOwcaShit(item, (300 - this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE]));
        }
        buyOwcaShit(bleh, price = 0) {
            this.clearOutput();
            this.player.gems -= price;
            this.statScreenRefresh();
            this.outputText("The bartender hands you a bottle and grabs your gems before attending other clients, leaving you to your own business.\n\n");
            this.inventory.takeItem(bleh, this.owcaTavern);
        }
        //Herds (Z)
        herds() {
            this.clearOutput();
            this.outputText("The herders greet you warmly.  \"<i>Welcome, champion!  It is indeed a pleasure to have the honor to talk to such a noble and revered hero.</i>\"  You reply with equal grace and ask in a more formal tone if there's anything you can do to help them out.");
            ...
            this.dynStats("int", 1);
            //[if attitude > 70]
            if (this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] > 70) {
        ...
        rebeccMenu() {
            this.clearOutput();
            this.outputText("You knock and step into the old shack, accustoming yourself to the meager light.  As soon as you close the door behind you, you spot Rebecc stepping out of a little backroom.");
        ...
        rebeccBathScene() {
            this.clearOutput();
            this.outputText("She grabs your hand and leads you to her bathroom, a tiny place almost entirely occupied by an enormous circular container acting as a bathtub, full of hot steaming milk.  You watch her, puzzled.");
            ...
            if (this.player.gender == 0)
                ...
                if (this.player.hasVagina() && this.player.hasCock())
                    ...
                    this.outputText("; ");
                if (this.player.hasVagina())
                    this.outputText("your " + this.vaginaDescript() + " leaks a little trickle of girl-juice");
                this.outputText(".  She doesn't seem to notice the effect she has on you - or so you think.  Suddenly, you feel a hand darting between your legs.");
            }
        ...
        rapeRebecc(outside = false) {
            ...
            if (this.player.hasCock()) {
                ...
                this.outputText("\n\nThe sight of her glorious rear is too tempting a target to resist, and you quickly shove the tip of your " + this.cockDescript(0) + " between her plush cheeks, bracing yourself for torrid anal penetration.  She keeps whining, unable to break free of your iron grasp.  In her constant struggles you notice an opening between her buttocks - you thrust inside with all your might, devastating her backdoor entrance, stretching her holes, tearing her insides and grinding against her rugged anal walls in a extremely rough way.");
                //[if cock is too long, >12 inches]
                if (this.player.cocks[0].cockLength > 12)
                    this.outputText("  You keep burying more of your " + this.cockDescript(0) + " deep inside her rectum until you reach her limit and can't fit more cock in.");
                else
                    this.outputText("  Eventually the entirety of your prick is lodged inside her lush asshole.");
                this.outputText("  She trills and bleats in pain and flounders about in your arms, futilely trying to avoid the incoming butt-rape.  You lock her arms with yours, implacably kneading her tits, and her shivering flesh brings the most exquisite contact to your fingers; you toy with her nipples as well, making her scream savagely in forced pleasure.");
                this.outputText("\n\nAfter a few minutes of resistance, her body tenses up and you ease yourself into effectively butt-fucking her.  You pull her white fuzzy hair, seize her squeezable hips for more leverage and start raping her ass; the thrusts come hard and fast, almost bringing your " + this.cockDescript(0) + " out before jamming it all the way inside again.  This forceful and tigerish motion makes her shriek in excruciating ecstasy; she groans and moans rhythmically at the pace of your regular ass-pounding.  The torment you're inflicting on her poor interior walls is too much to bear and she twists violently to escape the dick-beast dominating her pucker; however, all she can do is wave her appreciable butt, bringing extra sensations to your " + this.cockDescript(0) + " and adding extra spice to your already ardent anal-rape.");
                this.outputText("\n\nThe cadenced wobbling of her rump as well as your constant pumping is bringing you to a higher state of pleasure; the heavenly tingle your " + this.cockDescript(0) + " is receiving is making you heedless of anything else but the burning heat of her insides cooking your meat.  You feel your lust rise as you keep riding the buttslut below you, ignoring her muffled complaints and whining, her tight confines gradually taking over any control you have over your rod.  You pound Rebecc's ass as if your life depended on it, clutching her curvy hips instinctively like an imp in rut.  Your groin impacts her buttocks with a loud SLAP at every thrust");
                //[if balls]
                if (this.player.balls > 0)
                    this.outputText(", and your " + this.ballsDescriptLight() + " almost feel sore from colliding with her dribbling cunt");
                this.outputText(".  Finally, when you think you're about to pass out from exhaustion, you cum in a powerful jet, literally blasting Rebecc's ass with your spooge, globs of  goo being propelled like projectiles into her colon and splattering her backside with huge white smears.");
                if (this.player.cumQ() > 1500)
                    this.outputText("  After completely filling up her rectum, your baby-batter erupts in thick spurts from her anus despite her instinctive ass-clenching efforts to hold as much semen as possible inside.  The sheer might of your cumshot is enough to send Rebecc over the edge, and she releases an absolutely torrential stream of girl-cum, squirting against her will all over your groins and mixing her own fluids with yours in a pathetic show of sluttiness.");
                this.outputText("  She unconsciously milks you of all your spunk, her anal muscles working on their own to massage your meat and extract every drop from your urethra.");
                this.outputText("\n\nWith a last, satisfied sigh, you fall over, " + this.cockDescript(0) + " deeply buried inside Rebecc's butt as you feel her warm, curvy body slowly waggling below you.  ");
                if (outside)
                    this.outputText("Some of the villagers are apathetically watching you, too stunned and bruised to intervene.  ");
                this.outputText("You silently remove your prick from your girl's ass, watch her contentedly as her exposed rectum is literally oozing with spooge and walk back to your camp.");
                this.outputText("\n\nThis is a more-than-appropriate goodbye gift");
                if (outside)
                    this.outputText(" to these miserable people, and even moreso");
                this.outputText(" to the manipulative slut who kept teasing you.  Serves her right, to use her body in the most provocative ways and never let you actually have your way with her.  You're unlikely to ever see her again.");
            ...
            //Rebecc Female Rape Scene (Z)
                ...
                if (this.player.tone > 75)
                    this.outputText("  The sheep girl's plush softness against your own toughened, toned physique manages to both arouse and anger you.  \"<i>This is what you were bred to be, isn't it bitch?</i>\" you hiss, your hands roaming over her inviting curves.  \"<i>Your fat ass hasn't had to work a day in its life.  The town whore, the cock-tease they wheel out when your people need a dupe, that's what you are.  How does it feel to be in the hands of a real woman?</i>\"");
                else
                    this.outputText("  Gods, this girl has a fine ass; you give it a few slaps here and there as it jiggles in the most enticing way.");
                this.outputText("  Rebecc doesn't say anything as you continue to grope her; she simply quivers with her eyes tightly shut, apparently unwilling to believe this is even happening.");
                ...
                if (outside)
                    this.outputText("Some of the villagers are apathetically watching you, too stunned and bruised to intervene.  ");
                this.outputText("You silently pick yourself up and dress, admiring the quivering, crying handiwork at your feet, before walking back to your camp.  This is a more-than-appropriate goodbye gift");
                if (outside)
                    this.outputText(" to these miserable people, and even moreso");
                this.outputText(" to the manipulative slut who kept teasing you.  Serves her right, to use her body in the most provocative ways and never let you actually have your way with her.  You're unlikely to ever see her again.");
                this.outputText("\n\n(<b>Owca removed from the places menu.</b>)");
        ...
        fightZeVillagers() {
            ...
            this.startCombat(new Farmers_1.Farmers());
        ...
        torchOwcaMotherFuckers() {
            ...
            if (this.player.cor >= 60 && this.player.gender > 0 && this.player.lust >= 33) {
                ...
                this.simpleChoices("Abuse Her", this.createCallBackFunction(this.rapeRebecc, true), "", undefined, "", undefined, "", undefined, "Leave", this.torchUpVillagersAndLeave);
            }
            else
                this.doNext(this.torchUpVillagersAndLeave);
        }
        //Fuck off village
        torchUpVillagersAndLeave() {
            this.clearOutput();
            this.outputText("You don't think you're going to see these villagers again, and you don't really want to.");
        ...
        loseToOwca() {
            this.clearOutput();
            this.outputText("You kneel down and then fall, overwhelmed by the villagers' fury and numbers.  Without hesitation, the angry mob jumps on you; you recoil in terror, persuaded that you're going to be beaten to death.  Instead, you are carelessly lifted and completely stripped off; ");
            if (this.player.weaponName != "fists")
                this.outputText("your " + this.player.weaponName + " is taken away and ");
            this.outputText("you are being uncomfortably transported to a destination you can guess easily.  Too dazed to resist or even worry about it; you are promptly brought to the dreaded pit, where the villagers tie you up and rudely shackle you.  Then, before you even realize how desperate your situation is, they're all gone.  Your numerous bruises and fatigue get the better of you and you quickly fall asleep.");
        ...
        morningAfterRape() {
            ...
            this.simpleChoices("Forgive", this.forgiveOwca, "Rape", this.createCallBackFunction(this.rapeRebecc, false), "", undefined, "", undefined, "Leave", this.fuckThisShit);
        }
        //Option: Forgive (Z)
        forgiveOwca() {
            this.clearOutput();
            this.outputText("Swallowing your pride, you tell her that it's all right and that you hold no grudge against her; the villagers were obviously desperate, to have resorted to such extreme measures.  You assure her");
            if (this.player.cor >= 50)
                this.outputText(", lying through your teeth,");
            this.outputText(" that you don't feel any resentment at all; she tried her best to help you, and you're grateful to her.");
            ...
            this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] = 60;
            this.flags[kFLAGS_1.kFLAGS.OWCA_ANGER_DISABLED] = 1;
            //To main owca menu
            if (this.getGame().inCombat)
        ...
        fuckThisShit() {
            this.clearOutput();
            this.outputText("You stare at the wretched, whimpering creature before you for a moment.  There's nothing to say.  Without a word, you head back to your camp, carefully closing Rebecc's door behind you as you leave.");
            this.flags[kFLAGS_1.kFLAGS.REBECCS_LAST_PLEA] = 1;
            if (this.getGame().inCombat)
                this.cleanupAfterCombat();
            else
        ...
        faceDownHordes() {
            this.clearOutput();
            this.outputText("You tell Rebecc to go hide on the plains; you're going to handle the villagers as well as the demon horde on your own.  She cries, \"<i>But " + this.player.short + "!  You stand no chance against this ruthless horde!  Besides, the villagers won't trust you.  They'll think you want to cheat them... they'll tie you up to prevent you from getting away!</i>\"");
        ...
        slaveToVapulaBadEnd() {
            ...
            this.outputText("\n\n\"<i>Enough.  Remove that dick from my pet's mouth, I want to talk to " + this.player.mf("him", "her") + " for a second.</i>\"");
        ...
        subdueVapula() {
            ...
            if (this.monster.HP < 1)
                this.outputText("overwhelmed by your might");
            else
                this.outputText("rendered insensate by his own lust");
            this.outputText(".  As usual, you walk among the forlorn bodies of your enemies.  Vapula is groveling on the floor again, looking up to you with imploring eyes.  Even beaten and broken, the luscious succubus remains the most preeminent figure of the motley rabble.");
        ...
        disbandHorde() {
            ...
            //Attitude set to 100
            this.flags[kFLAGS_1.kFLAGS.OWCAS_ATTITUDE] = 100;
            this.flags[kFLAGS_1.kFLAGS.OWCA_SACRIFICE_DISABLED] = 1;
            this.cleanupAfterCombat();
        }
        ...
        enslaveVapulaWithYourWang() {
            ...
            this.outputText("You speak in a feverish voice.  \"<i>You're such a bitch.  Damn, why did you ever think you were going to make me your slut?  How many times do you need to be shown that I'm not the bottom in our relationship?  You deserve to be turned in to Lethice so she can make you her personal fuck-toy; at least you'll remember your place.</i>\"");
        ...
        enslaveVapulaAsACuntWielder() {
            ...
            this.flags[kFLAGS_1.kFLAGS.VAPULA_FOLLOWER] = .5;
