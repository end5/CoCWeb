define(["require", "exports", "../../BaseContent", "./Farm/KeltScene", "./Farm/Kelly", "../../GlobalFlags/kGAMECLASS", "./Farm/FarmCorruption", "../../GlobalFlags/kFLAGS", "../../StatusAffects", "../../PerkLib", "../../../../includes/appearanceDefs", "../../../console", "../../Appearance", "../../CockTypesEnum"], function (require, exports, BaseContent_1, KeltScene_1, Kelly_1, kGAMECLASS_1, FarmCorruption_1, kFLAGS_1, StatusAffects_1, PerkLib_1, appearanceDefs_1, console_1, Appearance_1, CockTypesEnum_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Farm extends BaseContent_1.BaseContent {
        constructor() {
            super(...arguments);
            this.keltScene = new KeltScene_1.KeltScene();
            this.kelly = new Kelly_1.Kelly();
            this.farmCorruption = new FarmCorruption_1.FarmCorruption();
        }
        get marbleScene() {
            return kGAMECLASS_1.kGAMECLASS.marbleScene;
        }
        ...
        farmExploreEncounter() {
            ...
            if (this.farmCorruption.takeoverPrompt() == true)
                return;
            if (this.flags[kFLAGS_1.kFLAGS.FARM_DISABLED] == 1) {
                this.outputText("Whitney marches up to you as soon as you approach the farm, a stoic expression plastered across her face.");
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.MetWhitney) < 2) {
                this.spriteSelect(62);
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetWhitney) < 0) {
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.MetWhitney, 0, 0, 0, 0);
                    ...
                    this.player.addStatusValue(StatusAffects_1.StatusAffects.MetWhitney, 1, 1);
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.MetWhitney) == 2)
                        this.outputText("<b>You've been to the farm enough to easily find it.  You can return by selecting it from the places menu (and will no longer encounter it during random lake exploration)</b>.\n\n", false);
                }
            ...
            //Repeat Offender
                ...
                this.spriteSelect(62);
                if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] >= 4 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_FLIPPED_OUT_OVER_KELLY] == 0) {
                    this.clearOutput();
                    ...
                    this.flags[kFLAGS_1.kFLAGS.WHITNEY_FLIPPED_OUT_OVER_KELLY] = 1;
                }
                else if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_FLIPPED_OUT_OVER_KELLY] == 1)
                    this.outputText("You aren't welcome on the farm proper, but you can see Kelly cantering about the fields, looking for you.", true);
                else
                    this.outputText("Whitney's farm is remarkably large for such a humble operation.  What do you want to do?", true);
                this.menu();
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Kelt) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.KeltOff) < 0) {
                    if (this.flags[kFLAGS_1.kFLAGS.KELT_BREAK_LEVEL] >= 4)
                        ...
                        this.addButton(1, "Kelt", this.kelly.breakingKeltOptions);
                }
                if (this.player.hasKeyItem("Breast Milker - Installed At Whitney's Farm") >= 0) {
                    ...
                    else if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_FLIPPED_OUT_OVER_KELLY] == 0)
                ...
                if (this.player.hasKeyItem("Cock Milker - Installed At Whitney's Farm") >= 0 && this.player.cockTotal() > 0) {
                    if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_FLIPPED_OUT_OVER_KELLY] == 0)
        ...
        //[YES]
        whitneyMilkerHookup(breast = true) {
            this.spriteSelect(62);
        ...
        talkWhitney() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MURBLE_FARM_TALK_LEVELS] > 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.Kelt) >= 0 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_MURBLE_AND_KELT] == 0) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_MURBLE_AND_KELT] = 1;
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.TelAdre) >= 0 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.TelAdre) >= 1 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_TELADRE] == 0 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_MURBLE_AND_KELT] == 1) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_TELADRE] = 1;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.DISCOVERED_HIGH_MOUNTAIN] > 0 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_HIGH_MOUNTAIN] == 0 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_TELADRE] == 1) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_HIGH_MOUNTAIN] = 1;
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BreastsMilked) >= 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00331] > 0 && this.flags[kFLAGS_1.kFLAGS.ISABELLA_MILKED_YET] != -1) {
                    // Jojo only
                    this.outputText(" At the far end there is a small alabaster cluster labelled ‘Jojo’.");
                }
                else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00331] == 0 && this.flags[kFLAGS_1.kFLAGS.ISABELLA_MILKED_YET] == -1) {
                    // Isabella Only
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CockPumped) >= 0) {
                    if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BreastsMilked) < 0)
                        this.outputText("\n\n");
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) >= 0 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_DUNGEON] == 0 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_HIGH_MOUNTAIN] == 1) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_DUNGEON] = 1;
            ...
            // Subsequent visit
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_DUNGEON_FOLLOWUP] == 0 && this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_DUNGEON] == 1) {
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_TALK_DUNGEON_FOLLOWUP] = 1;
            ...
            if (this.temp == 0)
                this.outputText("It doesn't take long to find the independent farmer-girl.\n\n", false);
            if (this.temp == 1)
                this.outputText("She's patrolling the edges of her farm with a wicked-looking scythe in hand.  She nods to you as you approach and fall in beside her.\n\n", false);
            if (this.temp == 2)
                this.outputText("She's bent over in the pepper fields, pulling weeds left and right.  She stands up straight to wipe sweat from her fur and muzzle, and she gives you a friendly wave, encouraging you to come over and talk while she works.\n\n", false);
            if (this.temp == 3)
                this.outputText("She's behind the barn, working a forge and repairing a few damaged farming tools.  Though her attention is focused on the metal on the anvil and the hammer in her hand, Whitney immediately turns and greets you, in between the blows of her hammer.\n\n", false);
            if (this.temp == 4)
                this.outputText("She's rounding up a small herd of normal-looking cows.  Amazingly she has chosen to do so on foot, but is quick enough to keep up and corral her beasts.  Thankfully she's in the process of closing the gate to their pen when you finally catch up to her.  Whitney gives you a friendly smile as you come up to her and the two of you begin chatting immediately.\n\n", false);
            if (this.temp == 5)
                this.outputText("She's leaning back against a thick tree with a wide-brimmed hat drooped low over her eyes.   You call out to her, thinking the dog-woman has fallen asleep, but her head snaps up and her alert eyes lock on to you immediately.  Maybe she wasn't dozing.  She calls out, \"<i>Come on over and 'ave a sit, I'm starved fer company!</i>\"  You settle in for a chat.\n\n", false);
            //[HAVE MILKER THAT ISN'T PLUGGED IN]
            if (Farm.rand(4) == 0 && this.player.hasKeyItem("Breast Milker - Installed At Whitney's Farm") < 0) {
                if (this.player.hasKeyItem("Breast Milker") >= 0) {
                    ...
                    if (this.player.cor < 33)
                        this.outputText("You blush with shame", false);
                    else if (this.player.cor <= 66)
                        this.outputText("You flush with a touch of exhibitionism", false);
                    else
                        this.outputText("You flush hotly and arch your back, openly displaying your milk to the dog-girl", false);
                    this.outputText(" as her words sink in.   Runners of milk leak down your " + this.allBreastsDescript() + ", released by the stress of being so exposed.   In no time flat you're soaked in milk.\n\n", false);
            ...
            if (Farm.rand(4) == 0 && this.player.hasKeyItem("Cock Milker - Installed At Whitney's Farm") < 0 && this.player.hasKeyItem("Cock Milker") >= 0) {
                this.outputText("Before you can say much of anything, Whitney exclaims, \"<i>My stars! Is that one of them demon's milking machines?</i>\"\n\n", false);
            ...
            this.outputText("and she listens attentively, chiming in with witty quips and comfort when appropriate.  When you finish she tells you ", false);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) < 0)
                ...
                this.outputText("how poorly the farm has been going since the lake became tainted.  She has to work three times as hard to keep her livestock and crops from succumbing to the taint, and the demons and monsters of the forest are many times more bold", false);
            this.outputText(".  It feels good to get a chance to talk with another sane individual, but before long Whitney has to return to work, and you should check back on your camp.", false);
        ...
        workFarm() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleWithdrawl) >= 0) {
                if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) == 1)
                    this.marbleScene.addictedEncounterHappy();
                else
                    this.marbleScene.encounterMarbleAshamedAddiction();
                return;
            }
            //1/3 chance of marblez
            if (Farm.rand(3) == 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.Marble) > 0) {
                //Rapez Override normal
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleRapeAttempted) >= 0 || this.flags[kFLAGS_1.kFLAGS.MARBLE_WARNING] == 3) {
                    this.marbleScene.marbleAfterRapeBattle();
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble, 0, 0, 0, 0);
                    return;
                }
                //Angry meeting
                if (this.flags[kFLAGS_1.kFLAGS.MARBLE_WARNING] == 1) {
                    ...
                    if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) == 0) {
                        ...
                        if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) == 1) {
                            ...
                            //Exploration event while addicted (event triggered while addicted, but not suffering withdrawal):
                                ...
                                this.marbleScene.marbleEncounterAddictedNonWithdrawl();
                            return;
                        }
                        else {
                            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MarbleWithdrawl) >= 0)
                            ...
                            //Exploration event while addicted (event triggered while addicted, but not suffering withdrawal):
                                ...
                                this.marbleScene.marbleEncounterAddictedNonWithdrawlAshamed();
                            return;
                        }
                    }
                }
            ...
            if (Farm.rand(4) == 0) {
                this.spriteSelect(62);
                this.outputText("You find Whitney getting a scythe out of her tool shed. \"<i>Do you know how to muck out a stable?</i>\" she asks when you offer to help. You admit that you did a lot of that while growing up in your village. After passing you a rake, shovel, and pitchfork, she leads you to the milking barn.", true);
                ...
                if (this.player.faceType == appearanceDefs_1.FACE_DOG)
                    this.outputText("sensitive ", false);
            ...
            var pepper = Farm.rand(4);
            var itype;
            if (pepper <= 2)
                itype = this.consumables.CANINEP;
            else {
                this.temp = Farm.rand(5);
                //-Oversized Pepper (+size, thickness)
                if (this.temp == 0)
                    itype = this.consumables.LARGEPP;
                //-Double Pepper (+grows second cock or changes two cocks to dogcocks)
                if (this.temp == 1)
                    itype = this.consumables.DBLPEPP;
                //-Black Pepper (Dark Fur, +corruption/libido)
                if (this.temp == 2)
                    itype = this.consumables.BLACKPP;
                //-Knotty Pepper (+Knot + Cum Multiplier)
                if (this.temp == 3)
                    itype = this.consumables.KNOTTYP;
                //-Bulbous Pepper (+ball size or fresh balls)
                if (this.temp == 4)
                    itype = this.consumables.BULBYPP;
            }
            console_1.trace("FARM SHIT: " + itype.shortName);
        ...
        meetMarble() {
            ...
            if (this.player.statusAffectv3(StatusAffects_1.StatusAffects.Marble) == 0) {
                ...
                //Meet Marble while exploring version 2 (can occur anytime before the player becomes addicted):
                    ...
                    this.marbleScene.encounterMarbleExploring2();
            }
            else {
                if (this.player.findPerk(PerkLib_1.PerkLib.MarbleResistant) >= 0) {
        ...
        exploreFarm() {
            ...
            //FIND CARROT!
            if (kGAMECLASS_1.kGAMECLASS.nieveHoliday() && this.flags[kFLAGS_1.kFLAGS.NIEVE_STAGE] == 3 && this.player.hasKeyItem("Carrot") < 0) {
                kGAMECLASS_1.kGAMECLASS.findACarrot();
                return;
            }
            //Free Isabella Milkings!
            if (this.player.hasCock() && this.flags[kFLAGS_1.kFLAGS.FOUND_ISABELLA_AT_FARM_TODAY] == 0 && this.flags[kFLAGS_1.kFLAGS.ISABELLA_MILKED_YET] < 0 && kGAMECLASS_1.kGAMECLASS.isabellaFollowerScene.isabellaFollower() && this.flags[kFLAGS_1.kFLAGS.ISABELLA_MILK_COOLDOWN] == 0 && Farm.rand(2) == 0) {
                kGAMECLASS_1.kGAMECLASS.isabellaFollowerScene.findIzzyMilking();
                return;
            }
            //Meet Marble First Time
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Marble) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.NoMoreMarble) < 0) {
                this.doNext(this.camp.returnToCampUseOneHour);
                this.marbleScene.encounterMarbleInitially();
                return;
            }
            //Meet kelt 1st time
            if (Farm.rand(2) == 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.Kelt) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.KeltOff) < 0) {
                this.doNext(this.camp.returnToCampUseOneHour);
            ...
            if (explore == 0) {
                this.spriteSelect(62);
                this.outputText("You run around the farm, keeping an eye for any monsters or oddities around Whitney's property.  Eventually the she-dog joins you, and the two of you have a good time pushing your speed to its limits.  ", true);
                //Less than 30 speed (+2 speed)
                if (this.player.spe < 30) {
                    this.dynStats("spe", 2);
                    this.outputText("Whitney easily outpaces you, leaving you so far behind that she laps around the farm twice for each pass you make.", false);
                }
                //Less than 50 speed (+1 speed)
                else if (this.player.spe < 50) {
                    this.dynStats("spe", 1);
                    this.outputText("Whitney is still faster than you, and manages to get far enough ahead of you to disappear from time to time.", false);
                }
                //Less than 70 speed (+.75 speed)
                else if (this.player.spe < 70) {
                    this.dynStats("spe", .75);
                    this.outputText("Whitney and you are evenly matched, and the two of you run together for a while, each pushing yourself harder in an effort to best the other.", false);
                }
                //Else (+.5 speed)
                else {
                    this.dynStats("spe", .5);
            ...
            if (explore == 2) {
                ...
                if (this.player.horseCocks() > 0) {
                    ...
                    if (this.player.cor > 60)
                        this.outputText("It makes you smile.", false);
                    if (this.player.cor < 30)
                        this.outputText("It disgusts you.", false);
                    //[else/mid-corruption] 
        ...
        getMilked() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BreastsMilked) < 0) {
                if (this.player.cor < 50)
                    ...
                    this.outputText("You smile eagerly as you walk inside.", false);
            ...
            //Repeat
                ...
                this.outputText("You walk over to the barn, eagerly anticipating the opportunity to get milked.", false);
                //If ilk withdrawl or high lactation no dicks
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.LactationReduction) >= 0 && this.player.totalCocks() == 0)
                    this.outputText("  Your " + this.nippleDescript(0) + "s are engorged and ready to be taken care of.", false);
                //If cocks
                ...
                //If both
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.LactationReduction) >= 0 && this.player.cockTotal() > 0) {
                    this.outputText("Your " + this.nippleDescript(0) + "s and " + this.multiCockDescriptLight() + " grow", false);
            ...
            //REPEAT
                ...
                this.outputText("You easily attach the harnesses and lift up into position, hearing the machinery activate automatically. ", false);
            }
            var application = Farm.rand(3);
            //Super huge nips scene
            if (this.player.nippleLength == 3 && Farm.rand(2) == 0)
                application = 3;
            //Apply
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BreastsMilked) < 0 || application == 0) {
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BreastsMilked) < 0)
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.BreastsMilked, 0, 0, 0, 0);
                this.outputText("You manage to grab the suction cups in spite of your constrictive bindings and pull them to your " + this.nippleDescript(0) + "s.  They latch on immediately, ", false);
                if (this.player.nippleLength <= 1.5)
                    this.outputText("pulling each of your nipples entirely into the suction-tubes.  ", false);
                else
                    this.outputText("struggling to fit around each of your nipples as they slide into the suction-tubes.  ", false);
                this.outputText("There is a mechanical lurching noise as the suction builds rapidly.  Your nipple swells out to " + Math.floor(this.player.nippleLength * 1.5 * 10) / 10 + " inches of length, turning purplish from the strain.   You can feel something welling up inside your " + this.allBreastsDescript() + ", building as it moves towards your " + this.nippleDescript(0) + "s.\n\n", false);
            }
            //Apply repeat alternate
            else if (application == 1) {
                this.outputText("You stretch down and grab onto the suction cups, pulling them up to your eager nipples.  They latch on, slapping tight against you as the vacuum pressure seals them tightly against your body.  You can feel your " + this.nippleDescript(0) + "s pulling tight, nearly doubling in size from the intense pressure.  ", false);
                if (this.player.nippleLength >= 3)
                    this.outputText("They nearly burst the tubes designed to milk them by virtue of their sheer size.  ", false);
                this.outputText("The sensitive flesh of your " + this.allBreastsDescript() + " fill with a burgeoning pressure that centers around the tubes connected to your nips.\n\n", false);
            }
            //Version 3
            else if (application == 2) {
                this.outputText("Despite the tightness of your harness, you manage to reach down to grab the clear cups of the breast milker.  The cups twitch and move in your hands as you bring them up, ready to milk you.  You begin holding them against your " + this.nippleDescript(0) + "s and with a sudden lurch the suction pulls against you, pressing the breast-milker's cups tightly against your chest, stretching your " + this.nippleDescript(0) + "s to nearly twice their normal length.  You feel a building pressure as the machine sucks you relentlessly, drawing your milk to the surface.\n\n", false);
            }
            //Version 4 huge nips
            if (application == 3) {
            ...
            //< 750 'high' output
            //ELSE milk overload
            var milksplosion = Farm.rand(3);
            //Lightish (+15 lust)
            if (this.player.lactationQ() < 50) {
                this.dynStats("lus", 15);
                if (milksplosion == 0) {
                    this.outputText("A few drops of milk bud on the tips of your " + this.nippleDescript(0) + "s, growing larger as they roll down to the edge of the tube.  It feels as if a ", false);
                    if (this.player.totalBreasts() == 2)
                        this.outputText("pair", false);
                    else if (this.player.totalBreasts() == 4)
                        this.outputText("quartet", false);
                    else
                        this.outputText("group", false);
            ...
            //High Output (+ 40 lust)
                ...
                //High Output2
                if (milksplosion == 1) {
                    this.outputText("Your " + this.nippleDescript(0) + " swell up like tiny balloons for a moment before they unleash a torrent of your milk.  The nipple-cylinders instantly flood to capacity, and the milking machinery chugs loudly as it tries to suck it all down the tubes, barely keeping up with you.  You pant and writhe in the harness, each pulse of milk sending a growing sensation of your warmth to your groin that makes you ", false);
                    if (this.player.totalCocks() == 0) {
                        if (this.player.hasVagina())
                            this.outputText("wet", false);
                        else
            ...
            //CRAZY OUTPUT1 (+60 lust)
                ...
                if (milksplosion == 0) {
                    this.outputText("Your " + this.nippleDescript(0) + "s twitch and pulse for but a moment, then unleash a torrent of milk, totally filling the tubes.  The machinery lurches, struggling to keep up as you flood the tubes.   An alarm starts blaring as milk begins leaking out around the edges – Whitney's machinery just can't keep up!  You can hear footsteps in the barn, and a pair of soft hands hold the cups against your chest.   The machinery is shut down, but another pair of hands begins massaging your " + this.allBreastsDescript() + ", pumping wave after wave of milk through the tubes, unaided by the machinery.  You practically ", false);
                    if (this.player.hasVagina())
                        this.outputText("cream yourself", false);
                    else if (this.player.cockTotal())
                        this.outputText("jizz yourself", false);
                    else
                        this.outputText("orgasm", false);
            ...
            //If already at cap
            if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_GEMS_PAID_THIS_WEEK] >= cap) {
                this.outputText(" and displays a warning that <b>you're producing more than Whitney can pay for</b>", false);
                payout = 0;
            }
            if (payout > 0) {
                //If over cap reduce payout to the difference
                if (payout + this.flags[kFLAGS_1.kFLAGS.WHITNEY_GEMS_PAID_THIS_WEEK] > cap)
                ...
                this.outputText(" and automatically dispenses " + Farm.num2Text(payout) + " gem" + (payout == 1 ? "" : "s") + ".  Whitney really went all out with this setup!", false);
                //Display a warning that you've capped out.
                if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_GEMS_PAID_THIS_WEEK] >= cap)
                    this.outputText("  <b>The machinery warns you that Whitney can't afford any more this week!</b>", false);
            ...
            if (liters > 2) {
                this.outputText("\n\nYou feel woozy and lightheaded from the intense milking, and have difficulty focusing on anything but the residue of fluids coating your " + this.allBreastsDescript() + ".", false);
                ...
                //not a cow, bimbotize me!
                    ...
                    if (liters / 2 > 10)
                        this.dynStats("int", -10);
                    else
                        this.dynStats("int", -liters / 2);
                    if (liters > 30)
                        this.dynStats("int", -2);
                }
                if (this.player.inte < 10) {
                    ...
                    this.outputText("  You stretch and let out a contented moo, long and loud.  How silly!", false);
                else if (this.player.inte < 25)
                    this.outputText("  You quietly moo, then giggle to yourself at how strange you're acting.", false);
            }
            this.outputText("\n\n", false);
            //Not very horny yet
            if (this.player.lust < 75) {
                this.outputText("Feeling sore and VERY hungry, you make yourself decent and stagger back towards camp, ignoring the knowing smile Whitney gives you when you pass by her.", false);
            }
            //Horny
            else {
                this.outputText("Overwhelmed with your desire, you don't even bother to cover up and make yourself decent, you just run out of the barn, " + this.allBreastsDescript() + " jiggling and wet, heading straight for camp.");
                if (this.farmCorruption.whitneyCorruption() < 90)
                    this.outputText(" It isn't until you get back that you remember the disapproving look Whitney gave you, but if anything, it only makes you hornier.", false);
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.LactationEndurance) < 1.5)
                this.player.addStatusValue(StatusAffects_1.StatusAffects.LactationEndurance, 1, .05);
            this.player.addStatusValue(StatusAffects_1.StatusAffects.LactationEndurance, 1, .05);
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.Milked, 8, 0, 0, 0);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        cockPumping() {
            var cumQ = this.player.cumQ() * (Farm.rand(10) + 90) / 100;
            this.outputText("", true);
            //First time barn entrance
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CockPumped) < 0) {
                this.outputText("The barn looms tall ahead of you as you step into its shadow.  ", false);
            ...
            //Repeat
                ...
                this.outputText("You walk over to the barn, eagerly anticipating your session with the 'milker'.  ", false);
                this.outputText("Your " + this.multiCockDescriptLight() + " erect", false);
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.CockPumped) < 0) {
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText("single hose wriggles out from the hole, squirming across the floor.  It stops and lifts up, slowly homing in your horny shaft.\n\n", false);
                else if (this.player.cockTotal() == 2)
                    this.outputText("pair of hoses wriggle out from the hole, squirming across the floor.  They stop and lift up, slowly homing in your horny shafts.\n\n", false);
                else
                    this.outputText("group of hoses wriggle out from the hole, squirming across the floor.  They stop and lift up, slowly homing in your horny shafts.\n\n", false);
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.CockPumped, 1, 0, 0, 0);
            }
            //REPEAT
            else {
                this.outputText("You easily attach the harnesses and lift up into position, hearing the machinery activate automatically.  The hungry ", false);
                if (this.player.cockTotal() == 1)
                    this.outputText("hose wriggles out from the wall, curving up towards your crotch. ", false);
                else
                    this.outputText("hoses wriggle out from the wall, curving up towards your crotch. ", false);
                //Count repeat milkings! Wootles for arbitrary stats
                this.player.addStatusValue(StatusAffects_1.StatusAffects.CockPumped, 1, 1);
            }
            ...
            if (this.player.cockArea(0) < 20) {
                ...
                if (Farm.rand(2) == 0) {
                    if (this.player.cockTotal() == 1)
                        this.outputText("The hose's hole spreads wide as it closes in on your crotch, revealing the organic pinkish interior.   Somehow you doubt it'll be able to take all of your mammoth member, but the artificial pussy seems intent on trying.   It pushes against your " + this.cockDescript(0) + "'s " + this.player.cockHead() + ", stretching wide and struggling to fit.  The feelings of slippery flesh writhing about you overwhelms your body, making you go limp in the harness.   The suction slowly pulls you inside, an inch at a time, while the soft 'flesh' of the device hugs your " + this.cockDescript(0) + " with its many wriggling 'tongues'.\n\n", false);
                    else
                        this.outputText("The hoses' holes spread wide as they close in on your crotch, revealing their organic pinkish interiors.   Somehow you doubt they'll be able to take all of your mammoth members, but the artificial pussies seem intent on trying.   They push against your " + this.multiCockDescriptLight() + "' " + this.player.cockHead() + "s, stretching wide and struggling to fit.  The feelings of slippery flesh writhing about you overwhelms your body, making you go limp in the harness.   The suction slowly pulls you inside, an inch at a time, while the soft 'flesh' of the devices hugs your " + this.multiCockDescript() + " with its many wriggling 'tongues'.\n\n", false);
                }
                //large 2
                else {
                    if (this.player.cockTotal() == 1)
                        this.outputText("The milker's opening dilates wide, struggling to spread enough to accommodate your sheer size.  It closes the gap, waving back and forth like a cobra.  It pauses, brushing its squirming interior against your " + this.player.cockHead() + " experimentally.  You squirm as its lubricants begin coating you, but do your best to hold still for the organic-looking pump mechanism.  It starts pushing against you, almost painfully, as your distended cock resists fitting into the tubular hole.  With a sigh of anguished pleasure you're crammed into the tube, squeezed tight by wiggling tendrils. The ever-increasing suction pulls the tube further and further down your length.  It bottoms out, pressing tightly against your crotch and squeezing the entirety of your " + this.cockDescript(0) + " with inhuman flesh.\n\n", false);
                    else
                        this.outputText("The milkers' openings dilate wide, struggling to spread enough to accommodate your sheer size.  They close the gap, waving back and forth like a cobra.  Pausing, they brush their squirming interiors against your " + this.multiCockDescriptLight() + " experimentally.  You squirm as the lubricants begin coating you, but do your best to hold still for the organic-looking pump mechanisms.  They start pushing against you, almost painfully, as your distended cocks resist fitting into the tubular holes.  With a sigh of anguished pleasure you're crammed into the tubes, squeezed tight by wiggling tendrils.  The ever-increasing suction pulls the tubes further and further down your lengths.  They bottom out, pressing tightly against your crotch and squeezing the entirety of your " + this.multiCockDescriptLight() + " with inhuman flesh.\n\n", false);
                }
            }
            //MILKIN ACTION GO
            if (Farm.rand(2) == 0) {
            ...
            if (this.player.cumQ() >= 50 && this.player.fatigue >= 100 && this.flags[kFLAGS_1.kFLAGS.USED_MILKER_TODAY] > 0) {
                ...
                if (cumQ < 1000) {
                    ...
                    this.outputText("as the machine measures your contribution, but it barely registers in the back of your mind as your " + this.multiCockDescriptLight() + " harden again from the unending, expertly-given stimulation of the animate tubes.  You try to pull the milker off your " + this.multiCockDescriptLight() + ", but with ", false);
                    //[(big dix)
                    ...
                    this.outputText("how tired you are, you can't break the suction.  Every time you get a good grip and start to pull, the suction shoots a shiver of pleasure down " + this.sMultiCockDesc() + " and robs you of your focus and muscle control.  Practically helpless against the tubes, you feel your " + this.multiCockDescriptLight() + " get harder and harder, leaking out more pre-cum.\n\n", false);
                }
                //(big skeet, ordinarily would be helper-assisted)
                    ...
                    if (this.player.cockTotal() > 1)
                        this.outputText("s", false);
                    this.outputText(" wriggling back into place on your " + this.multiCockDescriptLight() + " as the harness lets you down into the puddle you made.  Only when the velvet walls of the demon machine resume their caresses do you take something as amiss with the situation.\n\n", false);
                    this.outputText("A loud 'ding' sounds and a clatter of gems drop into the plate as the machine measures your contribution, but it barely registers in the back of your mind as " + this.sMultiCockDesc() + " hardens again from the unending, expertly-given stimulation of the animate tube", false);
                    if (this.player.cockTotal() > 1)
                        this.outputText("s", false);
                    this.outputText(".  You try to pull the milker off your " + this.multiCockDescriptLight() + ", but the outside of the tubing is slick with your semen", false);
                    //[(big dix)
                    if (this.player.biggestCockArea() > 70) {
            ...
            //Medium Scene – output less than 250 mLs
                ...
                if (this.player.cockTotal() == 1) {
                    this.outputText("An orgasm hits you like a an ocean wave, shutting down any remaining conscious thoughts and replacing them with one overriding emotion: relief.   You spurt helplessly into the tube, wracked with pleasure as your ", false);
                    if (this.player.balls > 0)
                        this.outputText("bloated " + this.ballsDescriptLight() + " are", false);
                    else
                        this.outputText("sensitive " + this.cockDescript(0) + " is", false);
                    this.outputText(" finally relieved of ", false);
                    if (this.player.balls > 0)
                        this.outputText("their ", false);
                    else
                        this.outputText("its ", false);
                    ...
                    if (this.player.balls > 0)
                        ...
                        this.outputText("sensitive " + this.multiCockDescriptLight() + " are", false);
            ...
            //Massive Scene – else
                ...
                if (this.player.cockTotal() == 1) {
                    ...
                    this.outputText("Hurried footsteps enter the barn, and a pair of firm hands grab onto your bouncing " + this.multiCockDescriptLight() + ", pulling the milkers back against your groin and splattering spunk around the seal from the added pressure.  The machine-suction totally cuts off, but you don't even care.  You just keep cumming, pumping the thick white cream down the tubes by the force of your orgasm alone.   Eventually your incredible orgasm winds down, and the hands release you, allowing the tubes to pop off.  They slowly retracts to the wall as your harness is lowered, dropping your exhausted body in a wet heap on the ground.  When you regain your senses, your mysterious helper is gone.\n\n", false);
                }
                //(+40 fatigue)
                this.fatigue(40);
            }
            ...
            if (this.player.cumQ() < 20)
                this.outputText("barely noticeable ", false);
            else
                this.outputText("thick ", false);
            this.outputText("trail of your cum along the floor where the hose dragged itself back into the wall, though the machinery has closed back up and is now chugging noisily, clearly doing something.  A loud 'ding' chimes and a panel displays ", false);
            //Set temp to liter amount produced.
            var payout = 0;
            var cap = 500;
            //Ez mode cap doubles
            ...
            if (cumQ > 100)
                ...
                this.outputText(cumQ + " mLs.  ", false);
            //Calculate payout
            if (cumQ > 100) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.WHITNEY_GEMS_PAID_THIS_WEEK] + payout >= cap) {
                payout = cap - this.flags[kFLAGS_1.kFLAGS.WHITNEY_GEMS_PAID_THIS_WEEK];
            ...
            if (payout > 0) {
                if (this.player.cumQ() < 1000)
                    this.player.modCumMultiplier(1);
                if (payout == 1)
                    this.outputText(Farm.Num2Text(payout) + " gem rolls ", false);
                else
                    this.outputText(Farm.Num2Text(payout) + " gems roll", false);
                this.outputText("out into a collection plate.  Whitney really put a lot of work into this! ", false);
                this.player.gems += payout;
                this.flags[kFLAGS_1.kFLAGS.WHITNEY_GEMS_PAID_THIS_WEEK] += payout;
                this.statScreenRefresh();
            }
            if (this.player.countCockSocks("gilded") > 0) {
                var gems = Farm.rand(2) + this.player.countCockSocks("gilded");
                if (this.player.cumQ() > 1000)
                    gems *= 1.5;
                if (payout > 0) {
                ...
                this.outputText("ou see a few sparkling gems in your trail of cum on the floor. You reach down and pick up all " + gems + " of them</b>, and then you are", false);
        ...
        cowBadEnd2() {
            ...
            this.outputText("You nod happily, determined to find someone or something that can stuff you as full as your bulls did.  Whitney gives a resigned sigh as she turns the machine on, watching your determined stare melt into a dopey painting of relief...", false);
            this.getGame().gameOver();
        }
        milkerBadEnd1() {
            var cumQ = this.player.cumQ();
            this.outputText("", true);
            ...
            this.outputText(".  As before, the machine works you on and off for roughly an hour before the wall light once again turns green and the suction on your " + this.multiCockDescriptLight() + " intensifies.  Your hips take over as you buck against the machine and push out another ", false);
            if (cumQ < 100)
            ...
            //[(big skeet)
            if (cumQ > 1000) {
                this.outputText("  Unlike before, a fleshy valve flap pops open in the rear of the suction cup", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("s", false);
                this.outputText(", and the pressure of your ejaculation forces squirts of cum out of the valve with every spasm, dribbling sticky whiteness back onto your crotch.", false);
            }
            ...
            if (cumQ > 100)
                this.outputText(" and another clatter of gems", false);
            this.outputText(" reaches your ears as your second deposit is massed, but your attention is drawn to the new tube", false);
            ...
            this.outputText(" snaking out of the wall toward you.  Spent as you are, you can only manage a token resistance as ", false);
            if (!tubes)
                this.outputText("it", false);
            else
            ...
            if (this.player.hasVagina()) {
                ...
                if (this.player.clitLength > 3)
                    this.outputText("A smaller suction tube fastens over your " + this.clitDescript() + " as it rouses from the vaginal stimulation.", false);
            }
            //[(lactation, no nipplecunts)
            if (this.player.biggestLactation() >= 1 && !this.player.hasFuckableNipples()) {
                this.outputText("  Some tubes of the cup-type latch onto your " + this.nippleDescript(0) + "s, then begin suction of their own. You feel your breastmilk shift toward the nipples, then begin to dribble into the tubes.", false);
            }
            //[(nipplecunts)
            if (this.player.hasFuckableNipples()) {
                this.outputText("  More tubes snake up to your " + this.biggestBreastSizeDescript() + " and work their way into your " + this.nippleDescript(0) + "s.", false);
            }
            this.outputText("  " + this.SMultiCockDesc() + " becomes enormously hard again in a matter of seconds as you absorb the secretions.  You quickly deduce what it is you're tasting; the demon-designed tubing is feeding your own semen back into you, laced with some kind of chemical!\n\n", false);
            this.outputText("Under the effects of this new drug, " + this.sMultiCockDesc() + " inflates, engorging with blood until it's much larger than usual", false);
            //[(balls)
            if (this.player.balls > 0)
                this.outputText(" and your " + this.sackDescript() + " stretches as your " + this.ballsDescriptLight() + " nearly double in size", false);
            this.outputText(".  Another orgasm passes, this time unhindered as the machine does not slow its efforts in the slightest.  More than twice the previous quantity of semen shoots out of your cock", false);
            if (this.player.cockTotal() > 1)
                this.outputText("s", false);
            ...
            //[(big skeet)
            if (cumQ > 1000)
                this.outputText(", spraying out of the overflow valve and coating your entire lower body", false);
            this.outputText(".", false);
            //[(if vag)
            if (this.player.hasVagina()) {
                this.outputText("  Your cunt spasms around its invader, milking the pseudo-cock and drawing the tainted semen it emits even deeper into your womb", false);
                //[(big clit)
                if (this.player.clitLength > 3)
                    this.outputText(", and your clitoris twitches under the cup, threatening to black you out from the pleasure", false);
                this.outputText(".", false);
            }
            //[(lactation) 
            if (this.player.biggestTitSize() > 1) {
                ...
                //[(nipplecunts)
                if (this.player.hasFuckableNipples())
                    this.outputText(" and rings raise from the bases of the shafts inside your nipples, forming a seal,", false);
                this.outputText(" as suction begins to whisk it away.", false);
            }
            this.outputText("  A minute after your release, the flow in the other direction intensifies, pouring more fluid into you than before", false);
            //[(lactation)
            ...
            this.outputText("For several hours this continues, " + this.sMultiCockDesc() + " swelling to nearly twice its previous size and your orgasms coming one after another without a break as you pump your hips, knowing or caring about nothing except getting off on your machine lover and being fed in turn.  Your load each time is increased rather than decreased, with the cups growing multiple fleshy overflow valves and working overtime to vent the excess pressure every time you ejaculate.  ", false);
            //[(corruption > 90, high demonscore)
            if (this.player.cor > 90) {
                this.outputText("After literally hundreds of orgasms, the machine once again begins carefully regulating its suction, denying your release.  Repeatedly it teases your " + this.multiCockDescriptLight(), false);
                //[(vag)
                if (this.player.hasVagina())
                ...
                if (this.player.cockTotal() > 1)
                    this.outputText("s", false);
                this.outputText(".  This damn demon machine can't stop you from getting off anymore; with a violent shove you bury " + this.sMultiCockDesc() + " into the mouth", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("s", false);
                this.outputText(" as your orgasm lets fly!  A truly miraculous amount of semen erupts from your " + this.multiCockDescriptLight() + ", blowing off the covers of the overflow valves entirely. Jizz shoots across the room as you feel the bulge of pressure slide up your shaft and out of your urethra; a large pink crystal falls out of an open valve-hole and onto the wet floor with a 'plop'.  ", false);
            }
            ...
            //[(corruption > 90, high demonscore)
                ...
                this.outputText("  Still filled with the residual effects of your sudden burst of energy, you pull off the tubes one by one and, taking a moment to snatch up the pink crystal, saunter over to her. Her eyes widen at the simultaneously horrifying and comical sight of you approaching with lust in your eyes and ", false);
                //[(onecox)
                if (this.player.cockTotal() == 1)
                    this.outputText("a gigantic, erect penis bobbing in front of you and throwing off your balance", false);
                //(multi)
                else
                    this.outputText("multiple gigantic, erect penises bobbing in front of you and dragging between your legs, head pinned against the floor", false);
                ...
                if (this.player.totalCocks() == 1)
                    this.outputText("dick", false);
                else
                    this.outputText("set of dicks", false);
        ...
        centaurToysHoooooo() {
            ...
            this.outputText("\"<i>Oh, hey there, " + this.player.short + ",</i>\" Whitney says, leaning heavily on her pitchfork.  \"<i>Not much, just trying to figure out... Hey, now!</i>\" she says, eying up your powerful centaur frame.  ", false);
            if (this.player.cor < 50)
                this.outputText("You shift awkwardly and ask her what's wrong.", false);
            else
                this.outputText("You strut a bit, showing yourself off in a subtly lewd manner.  When you're finished, you ask the dog-girl if she likes what she saw.", false);
            this.outputText("\n\n", false);
