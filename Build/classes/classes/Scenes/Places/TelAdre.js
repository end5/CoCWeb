define(["require", "exports", "../../BaseContent", "./TelAdre/AuntNancy", "./TelAdre/BakeryScene", "./TelAdre/Brooke", "./TelAdre/Cotton", "./TelAdre/Dominika", "./TelAdre/Edryn", "./TelAdre/Frosty", "./TelAdre/Heckel", "./TelAdre/Ifris", "./TelAdre/Jasun", "./TelAdre/Katherine", "./TelAdre/KatherineEmployment", "./TelAdre/KatherineThreesome", "./TelAdre/Library", "./TelAdre/Loppe", "./TelAdre/Lottie", "./TelAdre/Maddie", "./TelAdre/Niamh", "./TelAdre/Rubi", "./TelAdre/Scylla", "./TelAdre/SexMachine", "./TelAdre/UmasShop", "../../StatusAffects", "../../GlobalFlags/kFLAGS", "../../PregnancyStore", "../../../console", "../../GlobalFlags/kGAMECLASS", "../../PerkLib"], function (require, exports, BaseContent_1, AuntNancy_1, BakeryScene_1, Brooke_1, Cotton_1, Dominika_1, Edryn_1, Frosty_1, Heckel_1, Ifris_1, Jasun_1, Katherine_1, KatherineEmployment_1, KatherineThreesome_1, Library_1, Loppe_1, Lottie_1, Maddie_1, Niamh_1, Rubi_1, Scylla_1, SexMachine_1, UmasShop_1, StatusAffects_1, kFLAGS_1, PregnancyStore_1, console_1, kGAMECLASS_1, PerkLib_1) {
    "use strict";
    ...
    * @author:
    */
    class TelAdre extends BaseContent_1.BaseContent {
        constructor() {
            super(...arguments);
            this.auntNancy = new AuntNancy_1.AuntNancy();
            this.bakeryScene = new BakeryScene_1.BakeryScene();
            this.brooke = new Brooke_1.Brooke();
            this.cotton = new Cotton_1.Cotton();
            this.dominika = new Dominika_1.Dominika();
            this.edryn = new Edryn_1.Edryn();
            this.frosty = new Frosty_1.Frosty();
            this.heckel = new Heckel_1.Heckel();
            this.ifris = new Ifris_1.Ifris();
            this.jasun = new Jasun_1.Jasun();
            this.katherine = new Katherine_1.Katherine();
            this.katherineEmployment = new KatherineEmployment_1.KatherineEmployment();
            this.katherineThreesome = new KatherineThreesome_1.KatherineThreesome();
            this.library = new Library_1.Library();
            this.loppe = new Loppe_1.Loppe();
            this.lottie = new Lottie_1.Lottie();
            this.maddie = new Maddie_1.Maddie();
            this.niamh = new Niamh_1.Niamh();
            this.rubi = new Rubi_1.Rubi();
            this.scylla = new Scylla_1.Scylla();
            this.sexMachine = new SexMachine_1.SexMachine();
            this.umasShop = new UmasShop_1.UmasShop();
        ...
        discoverTelAdre() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.TelAdre) < 0) {
        ...
        encounterTelAdre() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.TelAdre) < 0) {
                ...
                this.outputText("She places one hand on your shoulder and holds the crystal in the other.  Her eyes close, but her brow knits as she focuses on something.  ", false);
                this.telAdreCrystal();
            }
            else {
                this.outputText("Once again you find the gray fox, Urta, guarding the gates.  She nods at you and whistles for her companion, Edryn once again.  The centauress advances cautiously, and you submit herself to her inspection as she once again produces her magical amulet.  ", false);
                this.telAdreCrystal();
            }
        }
        ...
        telAdreCrystal() {
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.TelAdre) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.TelAdre, 0, 0, 0, 0);
            //-70+ corruption, or possessed by exgartuan
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0 || this.player.cor >= 70) {
            ...
            else if (this.player.cor >= 50 || kGAMECLASS_1.kGAMECLASS.monk >= 5) {
            ...
            else if (this.player.cor >= 25 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) >= 0) {
                this.outputText("The crystal pendant twirls in place, glowing a dull red.  Edryn takes a small step back and murmers, \"<i>You've seen the darkness of this land first hand, but its hold on you is not deep.  You'll find sanctuary here.  The demons cannot find this place yet, and we promise you safe passage within the walls.</i>\"\n\n", false);
            }
        ...
        telAdreTour() {
            this.player.changeStatusValue(StatusAffects_1.StatusAffects.TelAdre, 1, 1);
            this.outputText("", true);
        ...
        telAdreMenu() {
            if (this.flags[kFLAGS_1.kFLAGS.VALENTINES_EVENT_YEAR] < this.date.fullYear && this.player.balls > 0 && this.player.hasCock() && this.flags[kFLAGS_1.kFLAGS.NUMBER_OF_TIMES_MET_SCYLLA] >= 4 && this.flags[kFLAGS_1.kFLAGS.TIMES_MET_SCYLLA_IN_ADDICTION_GROUP] > 0 && this.isValentine()) {
                kGAMECLASS_1.kGAMECLASS.crazyVDayShenanigansByVenithil();
                return;
            }
            if (!kGAMECLASS_1.kGAMECLASS.urtaQuest.urtaBusy() && this.flags[kFLAGS_1.kFLAGS.PC_SEEN_URTA_BADASS_FIGHT] == 0 && TelAdre.rand(15) == 0 && this.model.time.hours > 15) {
                this.urtaIsABadass();
                return;
            }
            if (!kGAMECLASS_1.kGAMECLASS.urtaQuest.urtaBusy() && kGAMECLASS_1.kGAMECLASS.urta.pregnancy.event > 5 && TelAdre.rand(30) == 0) {
                kGAMECLASS_1.kGAMECLASS.urtaPregs.urtaIsAPregnantCopScene();
                return;
            }
            switch (this.flags[kFLAGS_1.kFLAGS.KATHERINE_UNLOCKED]) {
                case -1:
                case 0: //Still potentially recruitable
                    if (this.flags[kFLAGS_1.kFLAGS.KATHERINE_RANDOM_RECRUITMENT_DISABLED] == 0 && this.player.gems > 34 && TelAdre.rand(25) == 0) {
                        if (this.flags[kFLAGS_1.kFLAGS.KATHERINE_UNLOCKED] == 0)
                            this.katherine.ambushByVagrantKittyKats();
                        else
                            this.katherine.repeatAmbushKatherineRecruitMent();
                        return;
                    }
                ...
                case 3: //You and Urta are training her
                    break;
                case 4: //Employed
                    if (!this.katherine.isAt(Katherine_1.Katherine.KLOC_KATHS_APT) && this.flags[kFLAGS_1.kFLAGS.KATHERINE_TRAINING] >= 100) {
                        this.katherineEmployment.katherineGetsEmployed();
                        return;
                    }
                default: //Has given you a spare key to her apartment
                    if (this.model.time.hours < 10 && TelAdre.rand(12) == 0) { //If employed or housed she can sometimes be encountered while on duty
                        this.katherine.katherineOnDuty();
                        return;
                    }
            }
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK] == 0 && this.player.level >= 4 && TelAdre.rand(10) == 0 && this.flags[kFLAGS_1.kFLAGS.NOT_HELPED_ARIAN_TODAY] == 0) {
                kGAMECLASS_1.kGAMECLASS.arianScene.meetArian();
                return;
            }
            ...
            if (kGAMECLASS_1.kGAMECLASS.urta.pregnancy.event > 2 && TelAdre.rand(4) == 0 && this.flags[kFLAGS_1.kFLAGS.URTA_PREGNANT_DELIVERY_SCENE] == 0 && this.player.hasKeyItem("Spare Key to Urta's House") >= 0) {
                kGAMECLASS_1.kGAMECLASS.urtaPregs.urtaSpecialDeliveries();
                return;
            }
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00242] == -1) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == -2 && !kGAMECLASS_1.kGAMECLASS.raphael.RaphaelLikes()) {
        ...
        telAdreMenuShow() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == -2 && kGAMECLASS_1.kGAMECLASS.raphael.RaphaelLikes())
                ...
                homes = true;
            else if (this.flags[kFLAGS_1.kFLAGS.KATHERINE_UNLOCKED] >= 5)
                homes = true;
            else if (this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK] >= 4 && !kGAMECLASS_1.kGAMECLASS.arianScene.arianFollower())
                homes = true;
            this.menu();
            ...
            if (homes)
                this.addButton(4, "Homes", this.houses);
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK] > 0 && this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK] < 4)
                this.addButton(5, "Park", kGAMECLASS_1.kGAMECLASS.arianScene.visitThePark);
        ...
        armorShops() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_PC_MET_UMA] == 1) {
        ...
        houses() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.RAPHEAL_COUNTDOWN_TIMER] == -2) {
                if (kGAMECLASS_1.kGAMECLASS.raphael.RaphaelLikes()) {
                    orphanage = kGAMECLASS_1.kGAMECLASS.raphael.orphanageIntro;
                }
                else {
                    this.outputText("\n\nYou remember Raphael's offer about the Orphanage, but you might want to see about shaping yourself more to his tastes first.  He is a picky fox, after all, and you doubt he would take well to seeing you in your current state.");
                }
            ...
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.ARIAN_PARK] >= 4 && !kGAMECLASS_1.kGAMECLASS.arianScene.arianFollower())
                this.addButton(0, "Arian's", kGAMECLASS_1.kGAMECLASS.arianScene.visitAriansHouse);
            this.addButton(1, "Orphanage", orphanage);
            if (kGAMECLASS_1.kGAMECLASS.urtaPregs.urtaKids() > 0 && this.player.hasKeyItem("Spare Key to Urta's House") >= 0)
                this.addButton(2, "Urta's House", (this.katherine.isAt(Katherine_1.Katherine.KLOC_URTAS_HOME) ? this.katherine.katherineAtUrtas : kGAMECLASS_1.kGAMECLASS.urtaPregs.visitTheHouse));
            if (this.flags[kFLAGS_1.kFLAGS.KATHERINE_UNLOCKED] >= 5)
        ...
        piercingStudio() {
            ...
            var about = undefined;
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Yara) < 0)
            ...
            if (!this.flags[kFLAGS_1.kFLAGS.LOW_STANDARDS_FOR_ALL])
                ...
                this.choices("Pierce", this.pierceMenu, "Remove", this.piercingRemove, "", null, "AsFemale", this.createCallBackFunction(this.letsDoYaraSex, true), "AsMale", this.createCallBackFunction(this.letsDoYaraSex, false), "About Her", about, "", null, "", null, "", null, "Leave", this.telAdreMenu);
            }
        }
        aboutYara() {
            this.spriteSelect(63);
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.Yara, 0, 0, 0, 0);
            this.outputText("You introduce yourself and ask Yara about her past, noting that ", true);
            if (this.player.humanScore() <= 2)
                this.outputText("you were once a human too.", false);
            else
                this.outputText("you haven't seen many other humans about.", false);
        ...
        dickPierce() {
            this.spriteSelect(63);
            if (this.player.totalCocks() > 0)
                this.outputText("\"<i>Ok, this is gonna hurt a LOT, but I've heard good things about it.  What kind of piercing do you want done?</i>\" Yara asks.", true);
            else {
        ...
        clitPierce() {
            this.spriteSelect(63);
            if (this.player.hasVagina())
                this.outputText("\"<i>Ohhh, that's going to be suckably cute!</i>\" exclaims Yara, blushing more than a little. \"<i>What kind of piercing would you like?</i>", true);
            else {
        ...
        vulvaPierce() {
            ...
            this.piercingLoc = 8;
            if (this.player.hasVagina())
                this.outputText("Yara explains, \"<i>This is gonna hurt a lot, but I think you'll love how it feels after.  I know I do!  Now what kind of jewelry do you want down-town?</i>\"", true);
            else {
        ...
        chooseAdvancedMaterials() {
            this.spriteSelect(63);
            this.outputText("Yara goes back into the back and comes out with a gilded tray full of exotic materials.  She hands you a brochure and asks, \"<i>Ok, now what am I going to be working with?</i>\"", true);
        ...
        normalPierceAssemble() {
            this.spriteSelect(63);
            this.outputText("Yara makes you comfortable and has you look away while she uses her piercing tools.  It hurts, but she's skilled and before you know it, your piercing is done!", true);
            //1. Amethyst (+1 int, +1 lib)
            //2. Diamond (+2 int, -1 cor)
            //3. Gold (+1 int, +1 sens)
            //4. Emerald (+1 spe)
            ...
            switch (this.piercingMat) {
                ...
                case 9:
                    ...
                    if (this.player.findPerk(PerkLib_1.PerkLib.PiercedLethite) < 0)
                        this.player.createPerk(PerkLib_1.PerkLib.PiercedLethite, 0, 0, 0, 0);
                    longP += "Lethite ";
                    break;
                case 10:
                    shortP += "fertite ";
                    if (this.player.findPerk(PerkLib_1.PerkLib.PiercedFertite) < 0)
                        this.player.createPerk(PerkLib_1.PerkLib.PiercedFertite, 5, 0, 0, 0);
                    else
                        this.player.addPerkValue(PerkLib_1.PerkLib.PiercedFertite, 1, 5);
                    longP += "Fertite ";
                    break;
                case 11:
                    shortP += "furrite ";
                    if (this.player.findPerk(PerkLib_1.PerkLib.PiercedFurrite) < 0)
                        this.player.createPerk(PerkLib_1.PerkLib.PiercedFurrite, 0, 0, 0, 0);
                    longP += "Furrite ";
                    break;
                case 12:
                    shortP += "crimstone ";
                    if (this.player.findPerk(PerkLib_1.PerkLib.PiercedCrimstone) < 0)
                        this.player.createPerk(PerkLib_1.PerkLib.PiercedCrimstone, 5, 0, 0, 0);
                    else
                        this.player.addPerkValue(PerkLib_1.PerkLib.PiercedCrimstone, 1, 5);
                    longP += "Crimstone ";
                    break;
            }
            ...
            //Dudes
            else if (this.piercingLoc == 1 && (this.player.cockThatFits(36) >= 0 || this.flags[kFLAGS_1.kFLAGS.HYPER_HAPPY])) {
                this.yaraSex(false);
                return;
            }
        ...
        removeClitPierce() {
            this.spriteSelect(63);
            this.outputText("Yara gives you something to drink and you swiftly black out.  You awake about an hour later, sore and weak, though thankfully not bleeding.", true);
        ...
        oswaldPawn() {
            ...
            this.outputText("", true);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Oswald) < 0) {
                ...
                if (this.player.cor < 75)
                    this.outputText("Who would've thought that seeing someone NOT aroused would ever shock you?", false);
                else
                    this.outputText("What a shame, but maybe you can give him a reason to stand up straight?", false);
                ...
                this.outputText("(You can sell an item here, but Oswald will not let you buy them back, so be sure of your sales.)", false);
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Oswald, 0, 0, 0, 0);
            }
            else {
            ...
            if (this.player.hasKeyItem("Carrot") < 0 && this.flags[kFLAGS_1.kFLAGS.NIEVE_STAGE] == 3) {
        ...
        oswaldPawnMenu() {
            ...
            if (totalItems > 1)
                this.addButton(7, "Sell All", this.oswaldPawnSellAll);
            switch (this.flags[kFLAGS_1.kFLAGS.KATHERINE_UNLOCKED]) {
                case 1:
                case 2:
        ...
        oswaldPawnSell(slot) {
            ...
            if (itemValue == 0)
                ...
                this.outputText("You hand over " + this.player.itemSlots[slot].itype.longName + " to Oswald.  He nervously pulls out " + TelAdre.num2Text(itemValue) + " gems and drops them into your waiting hand.");
        ...
        oswaldPawnSellAll() {
            ...
            for (var slot = 0; slot < 5; slot++) {
                if (this.player.itemSlots[slot].quantity > 0 && this.player.itemSlots[slot].itype.value >= 1) {
                    itemValue += this.player.itemSlots[slot].quantity * Math.floor(this.player.itemSlots[slot].itype.value / 2);
        ...
        anotherButton(button, nam, func, arg = -9000) {
            if (button > 8)
                return 9;
        ...
        enterBarTelAdre() {
            if (this.isThanksgiving())
                kGAMECLASS_1.kGAMECLASS.pigSlutRoastingGreet();
            else
                this.barTelAdre();
        }
        barTelAdre() {
            ...
            var button = 0;
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_DISABLED] == 0 && this.flags[kFLAGS_1.kFLAGS.LOPPE_MET] == 0 && TelAdre.rand(10) == 0) {
            ...
            if (this.player.humanScore() <= 3)
                this.outputText("despite your altered appearance, ");
            ...
            this.menu();
            //AMILY!
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_VISITING_URTA] == 1) {
                button = this.anotherButton(button, "Ask4Amily", kGAMECLASS_1.kGAMECLASS.followerInteractions.askAboutAmily);
            }
            //DOMINIKA
            if (this.model.time.hours > 17 && this.model.time.hours < 20 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00150] != -1) {
                button = this.anotherButton(button, "Dominika", this.dominika.fellatrixBarApproach);
            }
            //EDRYN!
            if (this.edryn.pregnancy.type != PregnancyStore_1.PregnancyStore.PREGNANCY_TAOTH) { //Edryn is unavailable while pregnant with Taoth
                if (this.edryn.edrynBar()) {
                    if (this.edryn.pregnancy.isPregnant) {
                        if (this.flags[kFLAGS_1.kFLAGS.EDRYN_PREGNANT_AND_NOT_TOLD_PC_YET] == 0) {
                            this.flags[kFLAGS_1.kFLAGS.EDRYN_PREGNANT_AND_NOT_TOLD_PC_YET] = 1;
                            if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] == 0) { //Edryn panic appearance! (First time mom)
                                ...
                                this.outputText("\n\nEdryn smiles at you and yells, \"<i>Guess what " + this.player.short + "?  I'm pregnant again!</i>\"  There are some hoots and catcalls but things quickly die down.  You wonder if her scent will be as potent as before?", false);
                            }
                        }
                    ...
                    else if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NEEDS_TO_TALK_ABOUT_KID] == 1) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KATHERINE_LOCATION] == Katherine_1.Katherine.KLOC_BAR) {
                if (this.flags[kFLAGS_1.kFLAGS.KATHERINE_UNLOCKED] == 4) {
                    this.katherine.barFirstEncounter();
                    return;
                }
                if (this.flags[kFLAGS_1.kFLAGS.KATHERINE_URTA_AFFECTION] == 31 && kGAMECLASS_1.kGAMECLASS.urta.urtaAtBar() && !kGAMECLASS_1.kGAMECLASS.urta.urtaDrunk() && this.flags[kFLAGS_1.kFLAGS.URTA_ANGRY_AT_PC_COUNTDOWN] == 0) {
            ...
            if (this.auntNancy.auntNancy(false)) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00263] > 0)
                    button = this.anotherButton(button, "Nancy", this.auntNancy.interactWithAuntNancy);
                else
                    button = this.anotherButton(button, "Barkeep", this.auntNancy.interactWithAuntNancy);
            }
            else
            ...
            if (this.model.time.hours >= 8 && this.model.time.hours <= 16 && this.flags[kFLAGS_1.kFLAGS.NIAMH_STATUS] == 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.MET_NIAMH] == 0)
                    button = this.anotherButton(button, "Beer Cat", this.niamh.approachNiamh);
                else
                    button = this.anotherButton(button, "Niamh", this.niamh.approachNiamh);
            }
            //ROGAR #1
            if (this.flags[kFLAGS_1.kFLAGS.ROGAR_PHASE] == 3 && this.flags[kFLAGS_1.kFLAGS.ROGAR_DISABLED] == 0 && this.flags[kFLAGS_1.kFLAGS.ROGAR_FUCKED_TODAY] == 0) {
                button = this.anotherButton(button, "HoodedFig", kGAMECLASS_1.kGAMECLASS.swamp.rogar.rogarThirdPhase);
            ...
            //ROGAR #2
            else if (this.flags[kFLAGS_1.kFLAGS.ROGAR_PHASE] >= 4 && this.flags[kFLAGS_1.kFLAGS.ROGAR_DISABLED] == 0 && this.flags[kFLAGS_1.kFLAGS.ROGAR_FUCKED_TODAY] == 0) {
                button = this.anotherButton(button, "Rogar", kGAMECLASS_1.kGAMECLASS.swamp.rogar.rogarPhaseFour);
            ...
            switch (this.scylla.action) { //Scylla - requires dungeon shut down
                case Scylla_1.Scylla.SCYLLA_ACTION_FIRST_TALK:
                    ...
                    break;
                case Scylla_1.Scylla.SCYLLA_ACTION_ROUND_TWO:
                    this.scylla.scyllaRoundII();
                    return;
                case Scylla_1.Scylla.SCYLLA_ACTION_ROUND_THREE:
                    this.scylla.scyllaRoundThreeCUM();
                    return;
                case Scylla_1.Scylla.SCYLLA_ACTION_ROUND_FOUR:
                    this.scylla.scyllaRoundIVGo();
                    return;
                case Scylla_1.Scylla.SCYLLA_ACTION_MEET_CATS:
                    ...
                    break;
                case Scylla_1.Scylla.SCYLLA_ACTION_ADICTS_ANON:
                    ...
                    break;
                case Scylla_1.Scylla.SCYLLA_ACTION_FLYING_SOLO:
            ...
            //URTA
            if (kGAMECLASS_1.kGAMECLASS.urta.urtaAtBar()) {
                //Scylla & The Furries Foursome
                if (this.scylla.action == Scylla_1.Scylla.SCYLLA_ACTION_FURRY_FOURSOME) {
                    console_1.trace("SCYLLA ACTION: " + this.scylla.action);
                ...
                if (this.scylla.action == Scylla_1.Scylla.SCYLLA_ACTION_FUCKING_URTA) {
                    if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00143] == 0)
                    ...
                    button = this.anotherButton(button, "Back Room", kGAMECLASS_1.kGAMECLASS.urta.scyllaAndUrtaSittingInATree);
                }
                else if (kGAMECLASS_1.kGAMECLASS.urta.urtaBarDescript()) {
                    if (this.auntNancy.auntNancy(false) && this.flags[kFLAGS_1.kFLAGS.URTA_INCUBATION_CELEBRATION] == 0 && kGAMECLASS_1.kGAMECLASS.urta.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER) {
                        kGAMECLASS_1.kGAMECLASS.urtaPregs.urtaIsHappyAboutPregnancyAtTheBar();
                        return;
                    }
                    button = this.anotherButton(button, "Urta", kGAMECLASS_1.kGAMECLASS.urta.urtaBarApproach);
                }
            }
            //VALA
            if (kGAMECLASS_1.kGAMECLASS.purifiedFaerieBitchBar())
                button = this.anotherButton(button, "Vala", kGAMECLASS_1.kGAMECLASS.chooseValaInBar);
        ...
        */
        tailorShoppe() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Victoria) < 0) {
                this.outputText("You turn around, ", false);
                if (this.player.tallness > 60)
                    this.outputText("looking for the source, eventually looking down and at a short but busty Corgi dog-girl.  ", false);
                else
                    this.outputText("coming face to face with a busty Corgi dog-girl.  ", false);
                ...
                //Flag as meeting her
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Victoria, 0, 0, 0, 0);
            }
            else {
            ...
            this.choices(this.armors.CLSSYCL.shortName, this.createCallBackFunction(this.buyClothes, this.armors.CLSSYCL), this.armors.RBBRCLT.shortName, this.createCallBackFunction(this.buyClothes, this.armors.RBBRCLT), this.armors.ADVCLTH.shortName, this.createCallBackFunction(this.buyClothes, this.armors.ADVCLTH), this.armors.TUBETOP.shortName, this.createCallBackFunction(this.buyClothes, this.armors.TUBETOP), this.armors.OVERALL.shortName, this.createCallBackFunction(this.buyClothes, this.armors.OVERALL), this.armors.B_DRESS.shortName, this.createCallBackFunction(this.buyClothes, this.armors.B_DRESS), this.armors.T_BSUIT.shortName, this.createCallBackFunction(this.buyClothes, this.armors.T_BSUIT), this.armors.M_ROBES.shortName, this.createCallBackFunction(this.buyClothes, this.armors.M_ROBES), this.armors.LTHRPNT.shortName, this.createCallBackFunction(this.buyClothes, this.armors.LTHRPNT), "Leave", this.telAdreMenu);
        }
        buyClothes(itype) {
            this.outputText("", true);
            this.spriteSelect(61);
            this.outputText("Victoria nods and pulls a measuring tape off her shoulder.  She moves around you with practiced ease, taking measurements from every conceivable angle.  Thanks to her small stature, it's quite easy for her to take your inseam measurement, though Vicky manages to ", false);
            if (this.player.biggestCockArea() > 30 || this.player.totalCocks() > 1)
                this.outputText("fondle your bulging package", false);
            else if (this.player.hasVagina())
                this.outputText("rub against your outer lips", false);
            else
                this.outputText("slip a finger along your crotch", false);
            ...
            this.outputText("\"<i>" + itype.value + " gems and it can be yours,</i>\" she says.  ", false);
        ...
        armorShop() {
            ...
            if (this.player.hasKeyItem("Dragon Eggshell") >= 0) {
                ...
                if (this.player.gems < 200) {
                    ...
                    egg = kGAMECLASS_1.kGAMECLASS.emberScene.getSomeStuff;
            }
            this.choices(this.armors.CHBIKNI.shortName, this.createCallBackFunction(this.armorBuy, this.armors.CHBIKNI), this.armors.FULLCHN.shortName, this.createCallBackFunction(this.armorBuy, this.armors.FULLCHN), this.armors.FULLPLT.shortName, this.createCallBackFunction(this.armorBuy, this.armors.FULLPLT), this.armors.INDECST.shortName, this.createCallBackFunction(this.armorBuy, this.armors.INDECST), this.armors.LTHRROB.shortName, this.createCallBackFunction(this.armorBuy, this.armors.LTHRROB), this.armors.SCALEML.shortName, this.createCallBackFunction(this.armorBuy, this.armors.SCALEML), "", null, "Eggshell", egg, "Flirt", this.yvonneFlirt, "Leave", this.telAdreMenu);
        }
        weaponShop() {
            this.outputText("", true);
            ...
            this.choices(this.consumables.W_STICK.shortName, this.createCallBackFunction(this.weaponBuy, this.consumables.W_STICK), this.weapons.CLAYMOR.shortName, this.createCallBackFunction(this.weaponBuy, this.weapons.CLAYMOR), this.weapons.WARHAMR.shortName, this.createCallBackFunction(this.weaponBuy, this.weapons.WARHAMR), this.weapons.KATANA.shortName, this.createCallBackFunction(this.weaponBuy, this.weapons.KATANA), this.weapons.SPEAR.shortName, this.createCallBackFunction(this.weaponBuy, this.weapons.SPEAR), this.weapons.WHIP.shortName, this.createCallBackFunction(this.weaponBuy, this.weapons.WHIP), this.weapons.W_STAFF.shortName, this.createCallBackFunction(this.weaponBuy, this.weapons.W_STAFF), this.weapons.S_GAUNT.shortName, this.createCallBackFunction(this.weaponBuy, this.weapons.S_GAUNT), "", null, "Leave", this.telAdreMenu);
        }
        weaponBuy(itype) {
            this.outputText("", true);
            this.spriteSelect(80);
            this.outputText("The gruff metal-working husky gives you a slight nod and slams the weapon down on the edge of his stand.  He grunts, \"<i>That'll be " + itype.value + " gems.</i>\"", false);
            if (this.player.gems < itype.value) {
        ...
        armorBuy(itype) {
            ...
            this.outputText("She finishes and turns to you, smiling broadly, \"<i>Now, that will be " + itype.value + " gems, unless you want to change your mind?</i>\"", false);
            if (this.player.gems < itype.value) {
                this.outputText("\n\nYou count out your gems and realize it's beyond your price range.", false);
                //Goto shop main menu
        ...
        urtaIsABadass() {
            this.flags[kFLAGS_1.kFLAGS.PC_SEEN_URTA_BADASS_FIGHT] = 1;
            this.outputText("", true);
        ...
        watchUrtaBeABadass() {
            ...
            this.outputText("Now that it's immobile, you get can get a better look at the defeated combatant, and you're ", false);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) >= 0)
                ...
                this.outputText("horrified", false);
            else
                this.outputText("confused", false);
        ...
        gymDesc() {
            //PREGGO ALERT!
            if (this.flags[kFLAGS_1.kFLAGS.PC_IS_A_GOOD_COTTON_DAD] + this.flags[kFLAGS_1.kFLAGS.PC_IS_A_DEADBEAT_COTTON_DAD] == 0 && this.cotton.pregnancy.isPregnant) {
            ...
            if (this.player.cor < 35)
                this.outputText("thankfully ", false);
            else if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0 || this.player.cor > 80)
            ...
            this.outputText("Though the gym sees heavy use by the city guard and various citizens, it's not too busy at present.", false);
            ...
            this.outputText("  There's a centauress in a tank-top just inside the doorway with huge, rounded melons and perky nipples, but she merely coughs to get you to look up and says, \"<i>", false);
            if (this.flags[kFLAGS_1.kFLAGS.LIFETIME_GYM_MEMBER] == 0)
                this.outputText("10 gems an hour to use the facilities here, or 500 for a life-time membership.</i>\"  She has her hands on her hips, and it looks you'll have to pay ten gems to actually get to use any of this stuff.", false);
            else
                this.outputText("Oh, welcome back " + this.player.short + ".  Have a nice workout!</i>\"", false);
            if (this.player.gems < 10 && this.flags[kFLAGS_1.kFLAGS.LIFETIME_GYM_MEMBER] == 0) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_MET] > 0 && this.flags[kFLAGS_1.kFLAGS.LOPPE_DISABLED] == 0) {
            ...
            if (this.model.time.hours > 9 && this.model.time.hours < 14)
                this.heckel.heckelAppearance();
            this.gymMenu();
        }
        gymMenu() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00281] > 0)
                lottieB = "Lottie";
            if (this.ifris.ifrisIntro())
                ifris2 = this.ifris.approachIfris;
            if (this.flags[kFLAGS_1.kFLAGS.MET_IFRIS] > 0)
                ifrisB = "Ifris";
            ...
            if (this.flags[kFLAGS_1.kFLAGS.LIFETIME_GYM_MEMBER] == 0 && this.player.gems >= 500)
                membership = this.buyGymLifeTimeMembership;
            if (this.flags[kFLAGS_1.kFLAGS.PC_IS_A_DEADBEAT_COTTON_DAD] == 0) {
                if (this.cotton.cottonsIntro())
                    cotton2 = this.cotton.cottonGreeting;
            }
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_MET_FUCKED] > 0)
                cottonB = "Cotton";
            if (this.flags[kFLAGS_1.kFLAGS.LOPPE_MET] > 0 && this.flags[kFLAGS_1.kFLAGS.LOPPE_DISABLED] == 0)
                loppe2 = this.loppe.loppeGenericMeetings;
            this.choices("ChangeRoom", this.jasun.changingRoom, cottonB, cotton2, hyenaB, hyena, ifrisB, ifris2, "Jog", this.goJogging, "LiftWeights", this.weightLifting, "Life Member", membership, lottieB, lottie2, "Loppe", loppe2, "Leave", this.telAdreMenu);
        }
        buyGymLifeTimeMembership() {
            this.outputText("", true);
            //[Buy LifeTime Membership]
            this.outputText("You fish into your pouches and pull out 500 gems, dumping them into the centaur's hands.  Her eyes widen as she turns and trots towards a counter in the back.  She leans over as she counts, giving you a generous view down her low-cut top at the cleavage she barely bothers to conceal.", false);
            if (this.player.hasCock()) {
                this.outputText("  It brings a flush to your face that has nothing to do with exercise.  Maybe you'll be able to con her into some alone time later?", false);
                this.dynStats("lus", (10 + this.player.lib / 10));
            }
            this.flags[kFLAGS_1.kFLAGS.LIFETIME_GYM_MEMBER] = 1;
            this.player.gems -= 500;
            this.statScreenRefresh();
            //[Bring up gym menu]
            this.gymMenu();
        ...
        weightLifting() {
            ...
            if (this.player.fatigue > 75) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.LIFETIME_GYM_MEMBER] == 0)
                    this.outputText("It'd be better to save your money and come back after you've rested.", false);
                this.doNext(this.telAdreMenu);
                return;
            }
            ...
            if (this.player.str < 25)
                this.outputText("You have to start out on the smaller weights to the left side of the rack due to your strength, but even so, you manage to work up a good burn and a modest sweat.", false);
            //(< 40 str)
            else if (this.player.str < 40)
                this.outputText("You heft a few of the weights and select some of the ones just to the left of the middle.  It doesn't take you long to work up a sweat, but you push on through a variety of exercises that leave your body feeling sore and exhausted.", false);
            //(< 60 str)
            else if (this.player.str < 60)
                this.outputText("You smile when you grip a few of the heavier weights on the rack and start to do some lifts.  With a start, you realize you're probably stronger now than Ingnam's master blacksmith, Ben.  Wow!  This realization fuels you to push yourself even harder, and you spend nearly an hour doing various strength-building exercises with the weights.", false);
            //(<80 str)
            else if (this.player.str < 80)
                this.outputText("You confidently grab the heaviest dumbbells in the place and heft them.  It doesn't take long for you to work up a lather of sweat and feel the burn thrumming through your slowly tiring form.  The workout takes about an hour, but you feel you made some good progress today.", false);
            //(<90)
            else if (this.player.str < 90)
                this.outputText("You grab the heaviest weights they have and launch into an exercise routine that leaves you panting from exertion.  Setting the weights aside, you flex and marvel at yourself – you could probably arm wrestle a minotaur or two and come out victorious!", false);
            //(else)
            else
                this.outputText("This place barely has anything left to challenge you, but you take the heaviest weights you can get your mitts on and get to it.  By the time an hour has passed, you've worked up a good sweat, but without heavier weights you probably won't get any stronger.", false);
            //Stat changes HERE!
            ...
            if (this.flags[kFLAGS_1.kFLAGS.BROOKE_MET] == 1) {
                this.menu();
                ...
                this.doYesNo(this.sexMachine.exploreShowers, this.camp.returnToCampUseOneHour);
        }
        goJogging() {
            this.outputText("", true);
            //Too tired?  Fuck off.
            ...
            if (this.player.tou < 25)
                this.outputText("but you get so winded you have to stop after a few minutes.  Determined to improve, you force yourself to stay at a fast walk until you can run again.", false);
            //(<40 tou)
            else if (this.player.tou < 40)
                this.outputText("but your performance isn't that great.  You nearly stop jogging a few times but manage to push through until you're completely exhausted.", false);
            //(<60 tou)
            else if (this.player.tou < 60)
                this.outputText("and you do quite well.  You jog around for nearly an hour, working up a healthy lather of sweat.  Even your " + this.player.legs() + " tingle and burn with exhaustion.", false);
            //(<80 tou)
            else if (this.player.tou < 80)
                this.outputText("and it doesn't faze you in the slightest.  You run lap after lap at a decent clip, working yourself until you're soaked with sweat and fairly tired.", false);
            //(<90 tou)
            else if (this.player.tou < 90)
                this.outputText("and you have a terrific time.  You can keep yourself just below your sprinting speed for the entire time, though you work up a huge amount of sweat in the process.", false);
            //else)
            else
                this.outputText("and it barely challenges you.  You run at a sprint half the time and still don't feel like you're improving in the slightest.  Still, you do manage to burn a lot of calories.", false);
            //Stat changes HERE!
            if (this.player.spe < 40)
                this.dynStats("spe", .3);
            if (this.player.tou < 90)
                this.dynStats("tou", .5);
            //If butt is over 15 guaranteed reduction
            if (this.player.buttRating >= 15) {
                this.outputText("\n\nAll that running must have done some good, because your " + this.buttDescript() + " feels a little less bouncy.", false);
                this.player.buttRating--;
            }
            else {
                if (this.player.buttRating >= 10 && TelAdre.rand(3) == 0) {
                    this.outputText("\n\nThe jogging really helped trim up your " + this.buttDescript() + ".", false);
                    this.player.buttRating--;
                }
                else if (this.player.buttRating >= 5 && TelAdre.rand(3) == 0) {
                    this.outputText("\n\nYour " + this.buttDescript() + " seems to have gotten a little bit more compact from the work out.", false);
                    this.player.buttRating--;
                }
            ...
            if (this.player.hipRating >= 15) {
                this.outputText("\n\nIt feels like your " + this.hipDescript() + " have shed some pounds and narrowed.", false);
        ...
        yaraSex(girl = true) {
            this.spriteSelect(63);
            this.outputText("", true);
            this.outputText("Yara makes you comfortable and has you look away while she uses her piercing tools.  It hurts, but she's skilled. Before you know it, your piercing is done!  You move to rise, retaining a bit of modesty", false);
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0)
                this.outputText(" despite the guilty thrill", false);
            this.outputText(".  \"<i>Hold it,</i>\" Yara commands softly, pressing her hand against your " + this.chestDesc() + " and pushing you back in your chair.  \"<i>Do you think I'll let you get away without some... field testing?</i>\"\n\n", false);
            ...
            if (girl)
                ...
                this.simpleChoices("Turn down", this.piercingStudio, "Oh yeah!", this.createCallBackFunction(this.letsDoYaraSex, false), "", null, "", null, "", null);
        }
        letsDoYaraSex(girl = true) {
            this.spriteSelect(63);
            this.outputText("", true);
            ...
            if (this.player.lust < 50)
                this.outputText("protest", false);
            else
                this.outputText("speak", false);
            ...
            this.outputText("Yara's free hand slides down her belly - past the stud in her navel - down to her box.  Using two fingers, she spreads her lips apart, giving you a great view of both her glistening button-piercing and the fleshy recesses past it.  She bites her bottom lip gently", false);
            if (!girl && this.player.hasCock())
                this.outputText(" as your " + this.cockDescript(x) + " rises to attention, her eyes fixed upon the stiffened tool.  You resist the urge to grab her thin-yet-girlish hips and power into her right then and there, curious enough to allow her teasing.", false);
            else
                this.outputText(" as a growing puddle of love stains the cushioned chair.  It takes most of your power to not drag her down and force her face into your box.", false);
            this.outputText("\n\n", false);
            this.outputText("She leans forward, planting you with a wet and lingering kiss.  She moves lower, kissing ", false);
            if (this.player.biggestTitSize() < 1)
                this.outputText("your chest", false);
            else
                this.outputText("your nipples, one at a time", false);
            ...
            if (!girl && this.player.hasCock()) {
                ...
                this.outputText("The powerful motion is all the motivation your body needs.  Before either of you can even consider the ramifications of an internal ejaculation, your bodies seize up, caught in the familiar grasp of orgasmic bliss.  ", false);
                ...
                //heavy
                    ...
                    this.outputText("Yara's belly visibly plumps with the quantity of cum you pour into her, the extra weight bending her over to rest heavily against your " + this.player.leg() + ".  She purrs happily, patting her distended gut even while the tremors of her own orgasm run through her.\n\nYara lifts herself off you, pressing a hand against her tummy as she somewhat ungracefully steps off the chair.", false);
                //special (super-big)
                else
                ...
                if (this.player.cumQ() > 1500)
                    this.outputText(", Yara trying her best to fit her clothes over the bump in her midsection", false);
                this.outputText(".  \"<i>Come back whenever, okay?  I'm sure we can arrange another... appointment!</i>\"", false);
                //ZA ENDO
            }
            //female
            else {
                ...
                this.outputText("Trying to parse out the scene at play here is a fool's errand.  Yara must have done this before as your two sprawled out bodies have stopped in just the right fashion to make both of your fleshy orifices in plain view of one another's faces.  Air escapes your pursed lips as the \"<i>quality testing</i>\" commences on your " + this.vaginaDescript() + ", your kitty comrade going in tongue first towards your silken fringes.  ", false);
                if (this.player.wetness() >= 3)
                    this.outputText("She may as well be licking a melting popsicle with how wet your snatch is.", false);
                else
                    this.outputText("Your relatively dry perimeter makes for an easy target.", false);
        ...
        yvonneFlirt() {
            ...
            else if (this.player.tallness > 65 && !this.flags[kFLAGS_1.kFLAGS.LOW_STANDARDS_FOR_ALL]) {
                this.outputText("Sorry, but you don't look like you'd be much fun.");
                this.outputText("</i>\"");
                this.doNext(this.armorShop);
                return;
            }
            else if (this.player.cockThatFits(75) == -1 && !this.flags[kFLAGS_1.kFLAGS.LOW_STANDARDS_FOR_ALL]) {
                this.outputText("Sorry, but you don't look like you'd be much fun.");
                this.outputText("</i>\"");
                this.doNext(this.armorShop);
                return;
            }
            if (this.flags[kFLAGS_1.kFLAGS.YVONNE_FUCK_COUNTER] == 0)
        ...
        fuckYvonneInZeBlacksmith() {
            ...
            this.player.orgasm();
            this.dynStats("sen", -1);
            this.flags[kFLAGS_1.kFLAGS.YVONNE_FUCK_COUNTER]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //*Typical buy text goes here. Options are now Yes/No/Flirt*
        //[Flirt]
        flirtWithVictoria(itype) {
            this.clearOutput();
            ...
            this.outputText("\n\nYou wrench your dick free of the confines of her pillowy mounds, and grab her around her plush middle.  She gives a surprised yelp as you nearly throw her against the counter and lift her butt up into the air.  <i>\"Ooooh, someone's excited!\"</i>  she nearly cheers, looking over her shoulder and wagging her plush rear up at you as her tail swishes back and forth, showing that she's nearly as consumed with lust as you are.  Flipping her long skirt up over her back, you violently pull her panties aside before you force your " + this.cockDescript(x) + " deep within her gushing folds.");
    ...
    exports.TelAdre = TelAdre;
});
//# sourceMappingURL=TelAdre.js.map