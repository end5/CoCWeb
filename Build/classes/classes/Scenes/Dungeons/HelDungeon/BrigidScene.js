define(["require", "exports", "../../../BaseContent", "../../../GlobalFlags/kFLAGS"], function (require, exports, BaseContent_1, kFLAGS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 03.01.14.
     */
    class BrigidScene extends BaseContent_1.BaseContent {
        ...
        pcDefeatsBrigid() {
            ...
            if (this.monster.lust > 99)
                ...
                this.outputText("too badly beaten");
            this.outputText(" to continue the fight.  You quickly snatch the keys from inside her shield, and hook them onto your own belt.");
            //(New Key Item: Harpy Key A)
            this.player.createKeyItem("Harpy Key A", 0, 0, 0, 0);
            this.cleanupAfterCombat();
            this.flags[kFLAGS_1.kFLAGS.HEL_BRIGID_DEFEATED] = 1;
        }
        ...
        brigitPostQueenDeathBadEndII() {
            ...
            if (this.player.gender <= 1 || this.player.pregnancyIncubation > 0) {
                ...
                if (!this.player.hasCock()) {
                    ...
                    if (this.player.pregnancyIncubation > 0)
                        this.outputText("  Once this disgusting thing you're carrying falls out of you, we'll use you more traditionally, but...</i>\"  She pauses to press uncomfortably on your pregnant belly, then resumes speaking.  \"<i>I have no intention of letting you sit idle for however long that takes.");
                    this.outputText("  For now, I've given you the most obvious modification - I can think of something else later.</i>\"");
                    this.outputText("\n\nShe squeezes Kiri's ass firmly with one hand, and lifts the girl partway out of your lap.  A smooth, hot sensation separates from your crotch and glides along nerves you hadn't noticed until now as Kiri's pussy slides upward, partially revealing the erect, " + this.player.skinTone + " flesh of a brand new cock!  Brigid gloats at your confusion, laughing her delight to the roof of the chamber, then shoves Kiri's ass downward again, spearing her pussy on your new flesh and making the girl wince and grit her teeth.");
                ...
                if (this.player.cockTotal() > 1 || this.player.cumQ() > 1000)
                    this.outputText("  " + this.SMultiCockDesc() + " holds forth for a while, until Kiri's ass, pussy, and tailfeathers are soaked with oozing, white cum.");
                this.outputText("  Next to you, the salamander on the other table climaxes as well, dumping a load into Hel that sizzles when it leaks onto his fiery, iron-bound tail.  Your former lover squirms and shivers as the scalding-hot load fills her cunt, and her own prick twitches weakly, depositing a small string of bubbling jism on the stone table.");
            ...
            //(else if not visibly pregnant F or H)
                ...
                if (this.player.hasCock())
                    this.outputText(" as the phoenix's cunt slides onto your [cock smallest]");
                this.outputText(".  Brigid makes her way up the stairs, leaving you and the others at the mercy of the assorted horde.  The harpy rides your mouth greedily, knocking your head into the hard stone floor, and the last thing you can see around her feathery thighs before you slip into unconsciousness again is Kiri being pulled roughly from her resting place atop Hel by a mean-looking, wide-hipped harpy matron who takes her place, sitting sideways and drawing her talons sadistically across Hel's vulnerable chest to smear Kiri's seed around...");
                //[GAME OVER, MOTHERFUCKER]
                this.getGame().gameOver();
            }
        }
    }
    exports.BrigidScene = BrigidScene;
});
//# sourceMappingURL=BrigidScene.js.map