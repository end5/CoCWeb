define(["require", "exports", "../../../BaseContent", "./Lethice", "../../../StatusAffects", "../../../GlobalFlags/kFLAGS", "../../../Items/WeaponLib"], function (require, exports, BaseContent_1, Lethice_1, StatusAffects_1, kFLAGS_1, WeaponLib_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class LethiceScenes extends BaseContent_1.BaseContent {
        saveExport() {
            this.menu();
            this.addButton(0, "Export", this.exportSaveData);
        }
        exportSaveData() {
            ...
            this.menu();
            this.addButton(0, "Game Over", function () { });
        }
        encounterLethice() {
            if (this.player.cor < 90) {
                ...
                this.menu();
                this.addButton(0, "Fight", this.goFight);
                this.addButton(1, "Consort", this.joinHer);
            }
        }
        goFight() {
            this.outputText("<i>“So be it.”</i> Lethice rises from her throne, pacing pensively back and forth. Wings unfurl from behind her back, casting you into the darkness of her demonic shadow. <i>“You seek a fight with the Queen of Mareth, and you shall have one.”</i> With feline grace, she launches herself dozens of feet into the air, flips forward, and snaps her wings out to catch her midair. <i>“My pets! My lovelies! Watch what this mortal’s foolishness earns " + this.player.mf("him", "her") + "!”</i>");
            ...
            this.outputText("\n\n<b>It’s a fight!</b>");
            var m = new Lethice_1.Lethice();
            if (this.player.wingType != 0) {
                m.createStatusAffect(StatusAffects_1.StatusAffects.PhysicalDisabled, 0, 0, 0, 0);
                m.createStatusAffect(StatusAffects_1.StatusAffects.AttackDisabled, 0, 0, 0, 0);
            }
            if (this.flags[kFLAGS_1.kFLAGS.MINOTAURKINGS_TOUCH] == 1) {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.MinotaurKingsTouch, 0, 0, 0, 0);
            }
            this.startCombat(m);
        }
        defeated(hpVictory) {
            this.clearOutput();
            if (hpVictory) {
                this.outputText("<i>“No,”</i> Lethice cries, dropping onto all fours, barely able to support herself. <i>“How c-can this be...”</i> She shakes her head, tries to stand, and collapses once more. <i>“My reign was to be eternal and unquestioned.”</i> Hatred burns in her eyes. <i>“You ruined it all.”</i> She spits on the ground, then struggles not to collapse into it.");
            }
            else {
                this.outputText("<i>“No,”</i> Lethice cries, shaking her head in denial. <i>“How c-can this be? How can you do this to me.”</i> She shudders, dropping onto all fours, barely keeping a hand out of her cunt by sheer force of will. It dances across the slip of fabric at her crotch, threatening to rebel at any moment. <i>“I’m not some ditsy, succubus slut.”</i> A whole-body shiver wracks her from head to toe. <i>“Gods, am I?”</i>");
            }
            this.outputText("\n\nThe question remains - what to do with her?");
            this.menu();
            if (this.player.hasCock())
                this.addButton(0, "Plow Her", this.plowHer);
            if (this.player.hasVagina())
                this.addButton(1, "Queen Her", this.queenHer);
            this.addButton(2, "Boob Play", this.boobPlay, hpVictory);
            var hasLethicite = (this.player.hasKeyItem("Sheila's Lethicite") > 0) || (this.player.hasKeyItem("Stone Statue Lethicite") > 0);
            if (hasLethicite && this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetMarae) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) < 0) {
                this.addButton(5, "Redemption", this.redemption, hpVictory);
            }
        }
        plowHer() {
            this.clearOutput();
            this.outputText("After all you’ve been through, after everything you’ve fought and every enemy you’ve made... it all has come down to this: Lethice, the so-called Demon Queen, on her knees before you like any corrupted slut, helpless but to be just another sheathe for your cock. The realization fills your heart with a sense of pride and joy. Your quest is over, and now it’s time to reap your rewards.");
            this.outputText("\n\nYou");
            if (!this.player.isNaga())
                this.outputText(" step");
            else
                this.outputText(" slither");
            this.outputText(" forward, looming over the demoness’s defeated body, and grin down at her. She knows how this goes - who knows how many poor, innocent people have been in this same position before her? Now that the tables are turned, the demon just eyes the floor, refusing to meet your eyes until you reach down and grab her chin, forcing her to look at you.");
        ...
        plowHerPussy() {
            ...
            if (this.player.cor >= 66)
                this.outputText(" gleeful");
            else
                this.outputText(" shocked");
            this.outputText(" at what you’ve done, but none dare challenge the Champion in [hisHer] moment of victory.");
            this.outputText("\n\nAnd now, you’ve got a choice to make...");
            this.menu();
            this.addButton(0, "Next", this.theChoiceDunDunDun);
        }
        plowHerButt() {
            this.clearOutput();
            ...
            this.outputText(" at what you’ve done, but none dare challenge the Champion in [hisHer] moment of victory.");
            this.outputText("\n\nAnd now, you’ve got a choice to make...");
            this.theChoiceDunDunDun();
        }
        plowHerDouble() {
            this.clearOutput();
            this.outputText("You smirk down at Lethice’s winged back and reddened ass, letting your multiple cocks tell her what’s in store. Your [cock] presses against the tight, dark ring of her asshole while the");
            if (this.player.cocks.length == 2)
                this.outputText(" other");
            else
                this.outputText(" next");
            this.outputText(" member sloppily nestles between the lips of her pussy, slathering its crown with demonic juices. Lethice can only groan and weakly struggle against your firm, dominant hand when she realizes what you intend.");
            ...
            if (this.player.isBiped())
                this.outputText(" and prop your feet up on the Demon Queen’s prostrate back, smearing her face down in your seed");
            this.outputText(".");
            this.outputText("\n\nAnd now, you’ve got a choice to make...");
            this.theChoiceDunDunDun();
        }
        queenHer() {
            this.clearOutput();
            this.outputText("The Demon Queen is defeated. Some part of you knew this was where it had to end ever since you first heard of Lethice: with one of you on her knees, completely at the mercy of the other. Now, though... She looks almost... normal, in a way. Her default form, such as it is, seems like nothing more than a tall, lanky girl with horns - she doesn’t even sport the huge, drooling cock and tits of most of her slack-jawed minions standing around. If she closed her eyes and furled back her wings, you could almost imagine her as any of the priestesses from Ingnam.");
            ...
            if (!this.player.isNaga())
                ...
                this.outputText(" slither");
            this.outputText(" forward, pulling your [armor] off as you loom over the defeated demoness.");
            ...
            if (this.player.biggestTitSize() >= 2)
                this.outputText(" cupping a tit");
            else
                this.outputText(" pinching one of your nipples");
            this.outputText(" and arching your back as you feel her long, sinuous muscle slithering inside you like a snake - or a tentacle! Her talents as a shapeshifter become readily apparent as her tongue grows thicker and thicker, yet no less dexterous, spreading your pussy-lips and straining your slit with growing girth.");
            ...
            if (this.player.hasCock())
                this.outputText(" and dragging your [cock] across her face, smearing pre all through her hair");
            this.outputText(". She keeps wriggling under you, trying to rest herself free of your pin, but you’re relentless in your determination: she’s not moving from this spot until you cum all over her face!");
            ...
            if (this.player.isBiped())
                this.outputText(" to your feet");
            else
                this.outputText(" off");
            this.outputText(". Lethice is lying stunned on the ground, eyes rolled back in her head and face utterly smeared with your orgasmic juices. That’s a good look for you, you decide. Content in your final victory, you swing yourself into her throne");
            if (this.player.isBiped())
                this.outputText(" and prop your feet up on the Demon Queen’s prostrate back, smearing her face down in your seed");
            this.outputText(".");
            this.outputText("\n\nAnd now, you’ve got a choice to make...");
        ...
        boobPlay(hpVictory) {
            this.clearOutput();
            this.outputText("So this is the great and powerful Demon Queen, brought low");
            if (!hpVictory)
                this.outputText(" by your superior sexual acumen");
            else
                this.outputText(" by the might of your [weapon]");
            this.outputText(". She looks almost... normal, in a way. Her default form, such as it is, seems like nothing more than a tall, lanky girl with horns - she doesn’t even sport the huge, drooling cock and tits of most of her slack-jawed minions standing around. Strange, for a shapeshifter... maybe you can force her to fix that before you reap the fruits of your conquest!");
            this.outputText("\n\nYou grab the defeated demoness’s shoulders and");
            if (this.player.cor >= 66)
                this.outputText(" throw her roughly onto her back");
            else
                this.outputText(" push her onto her back");
            this.outputText(". The way she’s dressed, the way she looks so unsettlingly human... Lethice reminds you of an innocent maiden, locking her legs together and lying unresistant before you - like a girl on her wedding night. You lick your lips and tear away the tainted churchwear she’s clad herself in, revealing in full the pert mounds of her small breasts, and the puffy pink nipples at their peaks.");
            ...
            if (this.player.hasCock())
                this.outputText(" They’re easily big enough to fuck now!");
            ...
            if (this.player.hasCock()) {
                ...
                if (this.player.cor >= 66)
                    this.outputText(" any other corrupted soul of her court");
                else
                    this.outputText(" like you’re some kind of demon yourself");
                this.outputText(" is maddening!");
                ...
                this.outputText(", pumping out of the Demon Queen like cum out of a real cock. It feels... good. <b>Really</b> good! The milk might be cold, but you feel a heat start spreading through your loins, spurring you to start really moving - to start taking all the pleasure that Lethice’s mutable body can give you!");
                this.outputText("\n\n");
                if (this.player.hasVagina()) {
                    this.outputText("One cock’s not enough for you now. Not at the end of your adventure, after everything this bitch and her minions have put you through. You need <b>more</b>! You hike");
                    if (!this.player.isNaga())
                        this.outputText(" a leg");
                    else
                        this.outputText(" your coils");
                    this.outputText(" over Lethice’s body, starting to ride her sideways. The feeling of her nipple-cock twisting around inside you, gushing milk all the harder, but it’s not what you’re looking for. Instead, you reach back and grab the other dick-nipple, angling it towards your [asshole]. Like the first, it’s slicked with plenty of tainted milk, making the entrance as easy as you’d like. You give out a shuddering sigh as you sink down on both of the Demon Queen’s dicks, filling your holes with throbbing, milky meat.\n\n");
                }
                this.outputText("You start to move, grinding against Lethice’s jiggling rack and drawing her dick-nipple");
                if (this.player.hasVagina())
                    this.outputText("s");
                this.outputText(" through you, again and again. The demons around you hoot and holler, driven wild with lust as you rape their queen, and you can’t help but smile.");
                if (this.player.cor >= 66)
                    this.outputText(" You’re finally where you belong!");
                else
                    this.outputText(" Even the demons recognize what you’ve done! Now the only question is what to do with them afterwards...");
                this.outputText(" For now, though, you sate yourself by riding faster, bouncing on Lethice’s plump chest. Faster and faster, you piston your [hips] until you and Lethice both are moaning with pleasure, your bodies quaking with growing ecstasy.");
                ...
                if (this.player.hasVagina())
                    ...
                    this.outputText(" ass");
                this.outputText(" from the Demon Queen’s swollen breast");
                if (this.player.hasVagina())
                    this.outputText("s");
                this.outputText(", gushing their lactic load inside you. You keep pistoning your hips as fast as you can, dragging out every iota of pleasure that you can before the climax passes over you, leaving you panting and gasping and leaking corrupted fluids from your hole");
                if (this.player.hasVagina())
                    this.outputText("s");
                this.outputText(".");
        ...
        redemption(hpVictory) {
            this.clearOutput();
            this.outputText("Looking down at the");
            if (hpVictory)
                this.outputText(" battered and beaten demon, once so full of haughty pride and self-assured in her power, fills you with a sense of pity.");
            else
                this.outputText(" horny, desperate demon before you fills you with a sense of pity.");
            this.outputText(" She’s defenseless now - the greatest of the demons has fallen at your hand, but to what end? What about all the other countless demons swarming the vast palace, and the world outside. Merely killing Lethice accomplishes precious little. Another will rise in her place, won’t they?");
            ...
            this.menu();
            this.addButton(0, "Next", this.redemptionII);
        }
        redemptionII() {
            this.clearOutput();
            this.outputText("<b>A day of travel later...</b>");
            ...
            if (this.player.isBiped())
                this.outputText(" kneeling");
            else
                this.outputText(" leaning");
            this.outputText(" over the fallen demoness. Already, you can see her body changing: her bright pink skin is flushing out, becoming a more human hue, the bone spikes are slowly retreating into her heels, and the black roses interwoven in her now-viridian hair are blooming anew, becoming verdant, brilliant shades of crimson. Slowly but surely, the Demon Queen is beginning to look much less... well, demonic.");
        ...
        redemptionIII() {
            this.clearOutput();
            this.outputText("What name do you give the new woman you and Marae have made?");
            const input = document.createElement('input');
            this.menu();
            this.addButton(0, "Next", () => this.redemptionIIIGoName(input));
            this.mainView.mainText.appendChild(input);
        }
        redemptionIIIGoName(input) {
            if (input.value == "") {
                this.clearOutput();
            ...
            this.flags[kFLAGS_1.kFLAGS.LETHICE_NAME] = input.value;
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.LETHICE_NAME] == "Lethice") {
                this.outputText("You decide to tell her the truth - to give her back the name she bore as the Demon Queen. Trying to hide who and what she was from her - and from the world - will do you no good. The rest of the demons, and those who fight against them, deserve to see that there is hope. That even the Demon Queen could be made whole again.");
            ...
            this.menu();
            this.addButton(0, "Next", this.redemptionIV);
        }
        redemptionIV() {
            this.clearOutput();
            this.outputText("You spend some time there on the beach, comforting " + this.flags[kFLAGS_1.kFLAGS.LETHICE_NAME] + ". Eventually, as the hazy sky begins to darken, you take her hand and board your small boat, pushing off towards land. A new day will soon dawn on Mareth, and with it, you introduce a new hope: a way to fight back against the demons.");
            this.outputText("\n\nIt soon comes to light just why " + this.flags[kFLAGS_1.kFLAGS.LETHICE_NAME] + "’s rebirth was so costly, so tiring, to your patron goddess. Not a week after your victory at the mountain fortress, you and your new companion are ambushed by demons - assassins, bent on exacting vengeance for their queen’s humiliation. Instead, they end up on their knees before you, beaten as all who stood before you always are. This time it’s different, though. This time, rather than the choice of carnal punishment or death, you find yourself given a third option.");
            this.outputText("\n\nThe demons carried a few shards of Lethicite, which " + this.flags[kFLAGS_1.kFLAGS.LETHICE_NAME] + " quickly finds, drawn to the power of it like a moth to flame. Before you have time to realize what she intends, " + this.flags[kFLAGS_1.kFLAGS.LETHICE_NAME] + " grabs the brilliant pink stones and raises one of them aloft. Her arms and hands begin to glow, radiating that same awesome viridian power that Marae had shown you before, and in a flash of light one of the demons crumples to the ground, orgasming and writhing as the seething corruption in his veins is torn from his body in one last demonic ejaculation. The pool of cum he leaves catches flame, burning away to smoke and cinders a moment later. Corruption eradicated, utterly and completely.");
            ...
            this.outputText("\n\nWhen she’s finished, " + this.flags[kFLAGS_1.kFLAGS.LETHICE_NAME] + " collapses to her knees, gasping, chest heaving against her comfortable clothes - she has long since abandoned the twisted habit of her demonic reign. You put a hand on her shoulder, expecting her to be almost ready to collapse as Marae was... but instead, she turns to you with a huge smile. " + this.flags[kFLAGS_1.kFLAGS.LETHICE_NAME] + " throws her arms around you, laughing like a giddy child.");
            ...
            this.outputText("\n\n<b>THE END</b>");
            this.flags[kFLAGS_1.kFLAGS.GAME_END] = LethiceScenes.GAME_END_REDEMPTION;
            this.saveExport();
        }
        joinHer() {
            this.clearOutput();
            this.outputText("Stepping towards the infamous Demon Queen, you");
            if (this.player.weapon == WeaponLib_1.WeaponLib.FISTS)
                this.outputText(" raise your empty hands");
            else
                this.outputText(" set aside your [weapon]");
            this.outputText(" and smile. Lethice cocks a bemused brow, crossing her legs and tracing her slender fingers around the rim of her Lethicite-filled goblet. None of her remaining minions move to stop you, allowing you to approach their queen, right to the foot of her throne.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.DRIDERINCUBUS_KILLED] == 0 || this.flags[kFLAGS_1.kFLAGS.MINOTAURKING_KILLED] == 0)
                this.outputText(" humiliated");
            else
                this.outputText(" slain");
            this.outputText(" by your hand back to back. Compared to you, they were nothing. Pathetic, really. Are they the best the mighty demons have to offer?");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.DRIDERINCUBUS_KILLED] == 1 || this.flags[kFLAGS_1.kFLAGS.MINOTAURKING_KILLED] == 1)
                this.outputText(" Carved a bloody swathe");
            else
                this.outputText(" Fucked your way");
            this.outputText(" through my keep. And all this to... what? Become my new bodyguard?”</i>");
            ...
            this.outputText("\n\nAn explosion of sensation erupts through your [tongue], spreading as a tingling warmth all through your mouth, throat, and beyond. You’ve barely gotten your tongue out of your mouth before the alien feeling has spread through your entire body, infusing you with renewed lust above and beyond anything you’ve felt for the statuesque demoness. Like a " + this.player.mf("man", "woman") + " starving, you dig in with desperate abandon, munching that demonic rug with everything you have.");
            ...
            this.menu();
            this.addButton(0, "Next", this.joinHerII);
        }
        joinHerII() {
            this.clearOutput();
            this.outputText("<b>Time passes in Mareth...</b>");
            ...
            this.outputText("\n\n<b>THE END</b>");
            this.flags[kFLAGS_1.kFLAGS.GAME_END] = LethiceScenes.GAME_END_CONSORT;
            this.saveExport();
        }
        won(hpVictory, pcCameWorms) {
            this.clearOutput();
            this.outputText("You fall.");
            ...
            if (!hpVictory)
                this.outputText(" by your own rampant sexual desires");
            else
                this.outputText(" beneath the demoness’s merciless assault. She’s more powerful than you could have ever imagined, far more so than a wisp of a girl like her has any right to be");
            this.outputText(". Gasping, you slump");
            if (!this.player.isBiped())
                this.outputText(" down");
            else
                this.outputText(" to your knees");
            this.outputText(",");
            if (this.player.weapon != WeaponLib_1.WeaponLib.FISTS)
                this.outputText(" your [weapon] clattering away across the stone");
            else
                this.outputText(" too weak to even ball your fists");
            this.outputText(" as the victorious demon strides towards you.");
            ...
            this.outputText("”</i> She licks her lips, and gives your chin a sharp release. <i>“I think you deserve a special... reward... for your efforts, Champion. Oh, except that’s not what you are anymore, is it? A Champion doesn’t bow down, hoping a pretty little demon doesn’t rip [hisHer] soul out, does [heShe]? No, that’s something I’d expect my dog to do. Is that what you are: a dog?”</i>");
            this.outputText("\n\nYou look away from Lethice, trying");
            if (hpVictory)
                this.outputText(" to hide just how turned on she’s left you... how close you are to orgasm, just in need of her lurid touch");
            else
                this.outputText(" not to let her see how weak you are, how easy it really would be for her to kill you... or worse");
            this.outputText(". The Demon Queen just smiles all the wider as she turns from you, striding towards her throne. She stops after a few long-legged paces, casting a gaze over her shoulder to you. <i>“What are you waiting for, </i>dog<i>? Come along...”</i>");
            this.menu();
            this.addButton(0, "Next", this.woofwoof);
        }
        woofwoof() {
            this.clearOutput();
            this.outputText("<b>Time passes...</b>");
            this.outputText("\n\n<i>“Heel, Champ!”</i>");
            ...
            if (this.player.dogCocks() == 0)
                this.outputText(" newly-grown doggy cock");
            else
                this.outputText(" thick, throbbing dog-member");
            this.outputText(" as your swollen knot is yanked from the dragon-girl’s hole. You tumble across the floor with a pathetic whine, drooling spunk from your twitching member. Your beloved Mistress gives you a disapproving scowl as you recover.");
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) >= 0)
                this.outputText("Your predecessor destroyed our welcoming facility. Otherwise I’m sure a certain imp would have revealed the truth to you long ago, before joining you with our breeding machines.");
            else {
                this.outputText("How did you escape from the factory, I wonder? And so clean and pure, too... you’re belly’s not yet swollen with imps, and your breasts are so small. Did you slip through");
                if (this.flags[kFLAGS_1.kFLAGS.ZETAZ_DEFEATED_AND_KILLED] == 0)
                    this.outputText(" Zetaz");
                else
                    this.outputText(" the new Warden");
                this.outputText("}’s fingers, I wonder? Tsk, more punishments to deal out, I suppose. Isn’t that right, " + this.player.mf("boy", "girl") + "?”</i>");
            }
            this.menu();
            this.addButton(0, "Next", this.woofwoofII);
        }
        woofwoofII() {
            this.clearOutput();
            this.outputText("You bark excitedly, ready to be your loving, forgiving mistress’s means of meeting out punishment. The Champion’s eyes turn to you, and her jaw drops like an anchor.");
            this.outputText("\n\n<i>“No... [name]? [name] is that you?”</i> she gasps, staring wide-eyed. <i>“Oh, gods, no...”</i>");
            this.outputText("\n\nYou cock your head aside, confused. That’s not your name. You’re Champ. You’re Mistress’s favorite puppy-" + this.player.mf("stud", "slut") + ".");
            ...
            this.outputText("\n\nMistress gives your leash a gentle tug, drawing your attention back. <i>“Poor thing. My precious Champ’s starting to get confused. I think we need to shut this pretty little bitch up, don’t we " + this.player.mf("boy", "girl") + "? Or better yet, make her scream.”</i>");
            ...
            this.outputText("\n\n<i>“Good " + this.player.mf("boy", "girl") + ", Champ,”</i> your Mistress murmurs, and as you give a glance over your shoulder, you’re deeply, deeply pleased to see that one of her hands has slipped beneath her priestly garb to pleasure herself. She approves!");
        ...
        postTheChoice() {
            ...
            this.menu();
            this.addButton(0, "Go Home", this.goHome);
            this.addButton(1, "ClaimFort", this.claimFortress);
        }
        goHome() {
            this.clearOutput();
        ...
        goHomeII() {
            ...
            this.menu();
            this.addButton(0, "Vengeance", this.goHomeVeng);
            this.addButton(1, "Justice", this.goHomeJustice);
        }
        goHomeVeng() {
            this.clearOutput();
            this.outputText("<b>Later...\n</b>Tales of the Champion’s return are rarely told, not in the open anyway. " + this.player.mf("He", "She") + " blew into town with all the subtlety of a cyclone, laying waste to the village’s elders and all who dared defend them. Every villager remembers that night, the night that their leadership was put to the torch - literally. Each of them was left to die inside his own burning mans, bathed in the scorching heat until naught remained but ashes and memories.");
            this.outputText("\n\nAfter that night, there wasn’t a rebellious soul left alive to oppose to the Champion’s rule. " + this.player.mf("He", "She") + " became the defacto " + this.player.mf("King", "Queen") + " of the village, the breaker of the old ways and forger of the new.");
            if (this.player.cor <= 33)
                this.outputText(" Despite the fear and terror of " + this.player.mf("his", "her") + " arrival, " + this.player.mf("he", "she") + " proved a fair and wise monarch. The village soon became a town, and that town a city. Prosperity came to those who lived in the valley, guided by the strength of its unshakable ruler.");
            else if (this.player.cor <= 66)
                this.outputText(" Despite the fear and terror of " + this.player.mf("his", "her") + " arrival, " + this.player.mf("he", "she") + " proved a competent, if harsh monarch. The village’s prosperity was marred only by its limited liberties. Still, it was soon a town, and later a city. Most folk were willing to sacrifice their freedoms for the safety " + this.player.mf("he", "she") + " provided.");
            else
                this.outputText(" Despite the fear and terror of " + this.player.mf("his", "her") + " arrival, " + this.player.mf("he", "she") + " proved a capable monarch in spite of " + this.player.mf("his", "her") + " rapacious tastes. The villagers dared not protest when their once-Champion treated their sons and daughters as little more than slaves. They feared to question where the fruits " + this.player.mf("he", "she") + " provided came from, and why they felt so strange after eating them. Of course, these concerns did not stop them from breeding. Soon, nothing could. As the population of the valley swelled, the Champion amassed an army, one large enough to rival the nearby countries that had ignored it for so long.");
            this.saveExport();
        }
        goHomeJustice() {
            this.clearOutput();
            this.outputText("<b>Later...</b>\nTales of the Champions arrival spread far and wide. None expected " + this.player.mf("his", "her") + " return, and yet " + this.player.mf("he", "she") + " arrived all the same, weapon in hand before the council chambers, demanding the corrupt old men who once lead to face justice for their betrayal. At " + this.player.mf("his", "her") + " feet were strange creatures, beings the Champion faced and defeated, brought to Ingnam’s world to testify to just how rotten the village’s core had become. Once they said their piece, " + this.player.mf("he", "she"));
            // 9999 check dis
            if (this.player.cor >= 50)
                this.outputText(" put an end to their rank existence right there.");
            else
                this.outputText(" sent them through a glowing portal of " + this.player.mf("his", "her") + " own creation, never to be seen again.");
            ...
            if (this.player.cor < 50)
                this.outputText(" In " + this.player.mf("his", "her") + " wisdom, " + this.player.mf("he", "she") + " stopped the townsfolk from lynching their traitorous leaders right there. Instead, they were banished, forever expelled from the lands of Ingnam on pain of death.");
            else
                this.outputText(" The townsfolk lynched their traitorous leaders right there and then under the watchful eyes of the Champion. " + this.player.mf("He", "She") + " nodded approvingly when they gave their last twitches, seemingly happy to let small-town justice run its course.");
            this.outputText("\n\nLife continued on. A new council was chosen, but it was Champion [name] that most people followed. " + this.player.mf("He", "She") + " had left on the cusp of adulthood and returned a grizzled");
            // 9999 no idea what this is keyed off
            // {, vivacious}
            this.outputText(" warrior. With a seemingly infallable champion there to defend it");
            if (this.getGame().camp.companionsCount() > 0)
                this.outputText(" to say nothing of " + this.player.mf("his", "her") + " bizarre friends");
            this.outputText(", Ingnam prospered. The tiny village soon grew into a bustling town, and later a city.");
            this.outputText("\n\nWhen age finally claimed the unexpected " + this.player.mf("hero", "heroine") + ", a stone statue of immense proportions was erected so that future generations could forever live under the protection of their greatest hero.");
            this.saveExport();
        }
        claimFortress() {
            this.clearOutput();
            this.outputText("This fortress would be a fitting seat to your power. But the question remains, what would you do from such a fortress? You could gather the pure forces of the land together into one army, and from here purge the demon’s corrupted taint from the land, or you could set yourself up in Lethice’s place. Many demons could be turned to serve you, now that you think about it. Surely you could rule better than she!");
            this.menu();
            this.addButton(0, "Purge", this.purgeShit);
            this.addButton(1, "Conquer", this.conquer);
        }
        HowFuckedIsThePlayerOMeter() {
            var levelOfFuckedness = 0;
            //Marae corrupt +50
            ...
            //Lethice alive +25
            if (this.flags[kFLAGS_1.kFLAGS.LETHICE_KILLED] == 0)
                levelOfFuckedness += 25;
            // Minotaur King alive +10
            if (this.flags[kFLAGS_1.kFLAGS.MINOTAURKING_KILLED] == 0)
                levelOfFuckedness += 10;
            //Drider Incubutt alive +10
            if (this.flags[kFLAGS_1.kFLAGS.DRIDERINCUBUS_KILLED] == 0)
                levelOfFuckedness += 10;
            //Herm centaur demon alive +10
            if (this.flags[kFLAGS_1.kFLAGS.D3_CENTAUR_DEFEATED] != 1)
                levelOfFuckedness += 10;
            //Succubus gardener alive +10
            if (this.flags[kFLAGS_1.kFLAGS.D3_GARDENER_DEFEATED] != 3)
                levelOfFuckedness += 10;
            //Factory Omnibus alive +10
            if (this.flags[kFLAGS_1.kFLAGS.D1_OMNIBUS_KILLED] != 1)
                levelOfFuckedness += 10;
            //Zetaz alive +10
            if (this.flags[kFLAGS_1.kFLAGS.ZETAZ_DEFEATED_AND_KILLED] != 1)
                levelOfFuckedness += 10;
            //Harpy Queen dead? +25 (9999 is this correct? shouldn't it be +25 if she's alive?)
            if (this.flags[kFLAGS_1.kFLAGS.HARPY_QUEEN_EXECUTED] != 1)
                levelOfFuckedness += 25;
            //Jojo corrupt +10
            if (this.getGame().camp.campCorruptJojo())
                levelOfFuckedness += 10;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.FREED_VALA] == 1)
                levelOfFuckedness -= 10;
            //Ceraph tamed -5
            if (this.getGame().camp.ceraphIsFollower())
                levelOfFuckedness -= 5;
            //Owca saved -10
            if (this.flags[kFLAGS_1.kFLAGS.OWCA_SACRIFICE_DISABLED] == 1)
                levelOfFuckedness -= 10;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.SAND_WITCHES_FRIENDLY] == 1)
                levelOfFuckedness -= 10;
            //Urta Quest complete -30
            if (this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] == 1)
                levelOfFuckedness -= 30;
            //Fera release +10
            if (this.flags[kFLAGS_1.kFLAGS.PUMPKIN_FUCK_YEAR_DONE] != 0)
                levelOfFuckedness += 10;
            //Helspawn exists -10
            if (this.flags[kFLAGS_1.kFLAGS.HELSPAWN_NAME] != '')
                levelOfFuckedness -= 10;
            //Farm corrupted + 20
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_FIRST_DATE] != 0)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KID_A_XP] >= 100 && this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID] != '')
                levelOfFuckedness -= 10;
            //Holli fully grown +15
            if (this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_LEVEL] > 3)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] != 0)
                levelOfFuckedness -= 20;
            //Kiha followered -15
            if (this.getGame().camp.followerKiha())
                levelOfFuckedness -= 15;
        ...
        hasChildren() {
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Birthed) > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.AMILY_BIRTH_TOTAL] > 0 || this.flags[kFLAGS_1.kFLAGS.PC_TIMES_BIRTHED_AMILYKIDS] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.BENOIT_EGGS] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.COTTON_KID_COUNT] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.EDRYN_NUMBER_OF_KIDS] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_CHILDREN_MALES] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_CHILDREN_FEMALES] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.EMBER_CHILDREN_HERMS] > 0)
                return true;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.IZMA_CHILDREN_TIGERSHARKS] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS_MALE] > 0 || this.flags[kFLAGS_1.kFLAGS.KELLY_KIDS] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.MARBLE_KIDS] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_DRIDER_BABIES_COUNT] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_JOEYS] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.SHEILA_IMPS] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_ADULT_KID_COUNT] > 0 || this.flags[kFLAGS_1.kFLAGS.SOPHIE_DAUGHTER_MATURITY_COUNTER] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.SOPHIE_EGGS_LAID] > 0)
                return true;
            if (this.flags[kFLAGS_1.kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] > 0)
                return true;
            if (this.getGame().urtaPregs.urtaKids() > 0)
                return true;
            return false;
        }
        purgeShit() {
            this.clearOutput();
            this.outputText("You gather an army of friends, companions");
            if (this.hasChildren())
                this.outputText(", offspring");
            this.outputText(", and the last pure forces in the land. Even those of questionable purity are gathered into the fold. With Lethice deposed, the remaining free peoples of Mareth flock to your leadership. The enchantment binding the pure waters of the world into cloud are broken, and the world has its first real rainfall in years, clearing the air of residual corruption and washing the taint from the soil into recessed cesspits.");
            var levelOfFuckedness = this.HowFuckedIsThePlayerOMeter();
            if (levelOfFuckedness <= 50) {
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) < 0)
                    this.outputText(" Marae reclaimed the full network of her roots and single-handedly purged the last holdouts of corruption from the lands, choking it out of her world like weeds from a garden.");
                else
                    this.outputText(" Marae fought for a time, but even corrupted goddesses cannot hold back your tide of purity. Her fall was the biggest blight on your campaign, a sad footnote on an otherwise successful reclamation.");
                this.outputText("\n\n<b>You ended the demon threat forever and saved Mareth.</b>");
                this.flags[kFLAGS_1.kFLAGS.GAME_END] = LethiceScenes.GAME_END_PURGE_0_50;
            }
                ...
                this.outputText("\n\n");
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) < 0)
                    this.outputText("Marae is a wonderful aid in your quest, always able to manifest in her newly purified roots and offer words of wisdom or encouragement. Her magical might is a rock you can lean upon when times are tough. You aren’t sure how long you could keep this up without her.");
                else
                    this.outputText("Marae is always there, always lending her power to the demons, even when you dig her roots out of the ground with shovels and axes, burning the greasy lumber into nothingness. This task would be so much easier if the goddess was on your side, but still, you persevere.");
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) < 0)
                    this.outputText(" Those few pockets that escaped your armies could not escape Marae’s all-encompassing roots. Mareth is purified once more.");
                else
                    this.outputText(" A few places are tainted still, but it’s impossible to cleanse every cave. Instead, you make instructions to maintain the army. Should evidence of corruption arise anywhere, your forces will swiftly put it to flame.");
                this.outputText(" Peace returns to the land. You did it. You saved this world.");
                ...
                this.flags[kFLAGS_1.kFLAGS.GAME_END] = LethiceScenes.GAME_END_PURGE_50_100;
            }
            else {
                ...
                this.flags[kFLAGS_1.kFLAGS.GAME_END] = LethiceScenes.GAME_END_PURGE_100;
            }
            this.outputText("\n\n<b>THE END</b>");
            this.saveExport();
        }
        conquer() {
            this.clearOutput();
            if (this.player.cor <= 33) {
                this.outputText("You could definitely run this place better than Lethice, and though she had many corrupted lieutenants, surely their worst depredations could be reigned in by your steady hand. You");
                if (this.getGame().camp.companionsCount() > 0) {
                    this.outputText(" gather your follower");
                    if (this.getGame().camp.companionsCount() > 1)
                        this.outputText("s");
                    this.outputText(" in the citadel itself and");
                }
                this.outputText(" familiarize yourself with the place. Rather than driving off the few remaining demons you find, you place them into your service, explaining that so long as they serve you loyally they may yet live.");
                this.outputText("\n\nWord gets out over the coming days about the new " + this.player.mf("King", "Queen") + " of the demons, and little by little, the masterless hordes find their way back.");
                if (this.flags[kFLAGS_1.kFLAGS.LETHICE_KILLED] == 0)
                    this.outputText(" Lethice herself is even brought back, though this time securely leashed and empty-eyed.");
                this.outputText(" You order the worst of their factories shut down and put an end to attempts to locate Tel’Adre. No more will the demons be all-consuming force.");
                ...
                this.outputText("\n\n<b>THE END</b>");
                this.flags[kFLAGS_1.kFLAGS.GAME_END] = LethiceScenes.GAME_END_CONQUER_LOW;
            }
            else if (this.player.cor <= 66) {
                this.outputText("Lethice truly didn’t know what she was doing. She had one of the mightiest armies Mareth had ever seen at her beck and call. Her scientists and magicians worked never-before-seen wonders at her behest. The technology on display in one of her factories alone could advance the civilizations of the realm by decades. Yet she squandered it all on pointless armies and perverse devices with little practical use.");
                ...
                if (this.getGame().camp.companionsCount() > 0)
                    this.outputText("your followers from");
                this.outputText(" your camp away from the old portal and into the fortress. With their organization broken, the demons will hardly be in any position to mount an organized invasion into your world, and once you cow them into submission, they’ll work for you. Luckily, a few hung around after the fight. Either they weren’t close enough to the throne to hear the commotion or they didn’t care.");
                ...
                this.outputText("\n\n<b>You’ve won, but at what cost?</b>");
                this.outputText("\n\n<b>THE END</b>");
                this.flags[kFLAGS_1.kFLAGS.GAME_END] = LethiceScenes.GAME_END_CONQUER_MED;
            }
            else {
                this.outputText("For all her might, Lethice had no idea what she was doing. She subsumed herself in corruption to no effect, washing away her reason in order to consistently and constantly overindulge in pleasure.");
                ...
                if (this.getGame().camp.companionsCount() > 0) {
                    this.outputText(" and follower");
                    if (this.getGame().camp.companionsCount() > 1)
                        this.outputText("s");
                }
                this.outputText(". With Lethice’s rule broken, there’s no danger of a demonic invasion of your homeland, and you’ll have any surviving rogues in hand soon enough.");
                ...
                this.outputText("\n\nAge is your only problem, but your servants devise draughts to keep you young, treatments to keep your flesh as firm and vigorous as the day you stepped through the portal. <b>You rule Mareth as its ageless " + this.player.mf("King", "Queen") + ", a harsh monarch whose word is law and whose whims are made manifest.</b>");
                this.outputText("\n\nGAME OVER!");
                this.flags[kFLAGS_1.kFLAGS.GAME_END] = LethiceScenes.GAME_END_CONQUER_HIGH;
            }
            this.saveExport();
        }
    }
    LethiceScenes.GAME_END_REDEMPTION = 1;
    LethiceScenes.GAME_END_CONSORT = 2;
    LethiceScenes.GAME_END_PURGE_0_50 = 3;
    LethiceScenes.GAME_END_PURGE_50_100 = 4;
    LethiceScenes.GAME_END_PURGE_100 = 5;
    LethiceScenes.GAME_END_CONQUER_LOW = 6;
    LethiceScenes.GAME_END_CONQUER_MED = 7;
    LethiceScenes.GAME_END_CONQUER_HIGH = 8;
    exports.LethiceScenes = LethiceScenes;
});
//# sourceMappingURL=LethiceScenes.js.map