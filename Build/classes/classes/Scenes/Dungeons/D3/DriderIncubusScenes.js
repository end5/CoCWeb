define(["require", "exports", "../../../BaseContent", "./DriderIncubus", "../../../Items/WeaponLib", "../../../StatusAffects", "../../../GlobalFlags/kFLAGS", "../../../../../includes/appearanceDefs", "../../../PerkLib", "../../../PregnancyStore"], function (require, exports, BaseContent_1, DriderIncubus_1, WeaponLib_1, StatusAffects_1, kFLAGS_1, appearanceDefs_1, PerkLib_1, PregnancyStore_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class DriderIncubusScenes extends BaseContent_1.BaseContent {
        encounterDriderIncbutt() {
            ...
            this.startCombat(new DriderIncubus_1.DriderIncubus());
        }
        spooderbuttGetsANewCockSleeve(hpVictory, pcCameWorms) {
            this.clearOutput();
            var m = this.monster;
            ...
            if (hpVictory)
                this.outputText(" wounded");
            else
                this.outputText(" flushed");
            ...
            //Lust Fork (no new PG):
                ...
                if (this.player.weapon != WeaponLib_1.WeaponLib.FISTS)
                    this.outputText(" Your [weapon] clattered dully next to you, forgotten next to your all-consuming need.");
            ...
            if (hpVictory)
                this.outputText(" breath through such a thick covering.");
            else
                this.outputText(" pant needily under such a thick covering.");
            ...
            if (!this.player.isTaur() && !this.player.isDrider())
                this.outputText(" and across the top portion of his spidery back");
            if (m.goblinFree)
                this.outputText(" while his goblin slave remounts his dick");
        ...
        spooderbuttGetsANewCockSleeveII() {
            this.clearOutput();
        ...
        spooderbuttGetsANewCockSleeveIII() {
            this.clearOutput();
            ...
            if (this.player.skinType != 0)
                this.outputText(" through your [skinFurScales]");
            ...
            if (this.player.humanScore() < 5)
                this.outputText(", no matter how mutated");
            ...
            if (this.player.cor >= 50)
                this.outputText(", you’ve let yourself become corrupted");
            else
                this.outputText(", you’ve been sorely tempted by the rampant corruption of these lands");
            this.outputText(".");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) >= 0)
                this.outputText(" You couldn’t even save one of the last pure spirits in this place, Marae.");
            this.outputText(" It’s only a matter of time until Tel’Adre falls,");
            if (this.flags[kFLAGS_1.kFLAGS.FARM_CORRUPTION_STARTED] == 0)
                this.outputText(" Whitney’s farm is consumed");
            else
                this.outputText(" Lethice thanks you for preparing Whitney’s farm");
            this.outputText(", or worse. You go limp, defeated");
            if (this.player.lust >= 90)
                this.outputText(" and horny");
        ...
        spooderbuttGetsANewCockSleeveIV() {
            this.clearOutput();
            this.outputText("Lethice’s will presses on you like a physical thing.");
            if (this.player.cor < 50)
                this.outputText(" No matter how repugnant the idea of eating her out might have seemed a moment ago, you find your thoughts increasingly turning to her pussy.");
            else
                this.outputText(" No matter what objections you might have had to the idea, you’re too horny to make even a token effort at resistance.");
            ...
            if (this.player.vaginas.length > 0) {
                ...
                if (this.silly())
                    this.outputText(" You could probably drown someone in your panties.");
            }
            ...
            if (this.player.vaginas.length > 0) {
                ...
                if (this.player.cocks.length == 0)
                    this.outputText(" drenches your undergarments");
                else
                    this.outputText(" mixes right in with all that waste cum");
                this.outputText(".");
            }
        ...
        spooderbuttGetsANewCockSleeveV() {
            this.clearOutput();
        ...
        spooderbuttGetsANewCockSleeveVI() {
            this.clearOutput();
            ...
            if (this.player.vaginas.length == 0)
                this.outputText(", and after being outfitted with suitable genitalia,");
            else
                this.outputText(" and");
        ...
        beatTheSpooderbutt(hpVictory) {
            this.flags[kFLAGS_1.kFLAGS.DRIDERINCUBUS_DEFEATED] = 1;
            this.clearOutput();
            var m = this.monster;
            //HP
            if (hpVictory) {
            ...
            //Lust
                ...
                if (!m.goblinFree)
                    this.outputText(", but he pushes the goblin off his cock all the same");
                else
                    this.outputText(", but he grabs hold of his cock all the same");
            ...
            this.outputText("\n\n");
            if (!m.goblinFree)
                this.outputText("The goblin slowly separates from her fallen master.");
            else
                this.outputText("The goblin drops to her knees.");
        ...
        driderDefeatMenu() {
            var doneDriderbus = false;
            var doneGoblin = false;
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.DRIDERINCUBUS_KILLED] != 1 && this.flags[kFLAGS_1.kFLAGS.DRIDERINCUBUS_FUCKED] != 1) {
                this.addButton(0, "Kill Drider", this.killDrider);
                if (this.player.vaginas.length > 0)
                    this.addButton(1, "Ride Drider", this.rideDrider);
                if (this.player.cocks.length > 0)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MITZI_RECRUITED] != 1) {
                if (this.flags[kFLAGS_1.kFLAGS.MITZI_FUCKED] != 1) {
                    if (this.player.cocks.length > 0) {
        ...
        killDrider() {
            ...
            if (this.player.lowerBody == 5)
                this.outputText(" heel");
            else
                this.outputText(" [foot]");
            this.outputText(" down on the corrupted drider’s neck until you hear a sickening ‘pop’. He doesn’t move after that.");
            this.flags[kFLAGS_1.kFLAGS.DRIDERINCUBUS_KILLED] = 1;
            this.driderDefeatMenu();
        }
        fuckMitzi() {
            this.flags[kFLAGS_1.kFLAGS.MITZI_FUCKED] = 1;
            this.clearOutput();
            ...
            if (this.silly())
                this.outputText(" and smut writers");
            ...
            if (this.player.biggestCockArea() > 100)
                this.outputText(", her throat bulging with its unholy size");
            ...
            if (this.player.balls > 0)
                this.outputText(" wraps her tail around your [sack], giving eager little tugs.");
            else
                this.outputText(" wraps her tail around your [leg], giving you eager little tugs.");
            ...
            this.outputText("\n\n");
            if (this.player.biggestCockArea() <= 250)
                this.outputText("Bottoming out");
            else
                this.outputText("Filling her with as much as she can take");
            ...
            if (this.player.cor <= 33)
                this.outputText(" You could even try to help her cope with her excessive sexual desires, maybe see what she’s like when she doesn’t want to be plugged with dick.");
            ...
            if (this.player.cumQ() >= 15000)
                this.outputText(" The thought that you produce cum far too fast for that to matter doesn’t even occur to you.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] >= 1)
                this.outputText(" Actually, that thought’s probably just going to make you blow that much harder. Damn you, Ceraph!");
            this.outputText("\n\nWith another victorious slap on Mitzi’s ass, you bottom out.");
            if (this.player.balls > 0)
                this.outputText(" Your [balls] quake, pulling your [sack] taut against your body as they disgorge their creamy relief.");
            ...
            if (this.player.hasKnot())
                this.outputText(" with a wet sounding pop after solid knotting");
            ...
            if (this.player.cumQ() >= 5000)
                this.outputText(" with a cum-pregnant belly");
            if (this.player.cumQ() >= 1000)
                this.outputText(", spooge dripping down her thighs from her overfilled snatch");
        ...
        recruitMitzi() {
            ...
            this.flags[kFLAGS_1.kFLAGS.MITZI_RECRUITED] = 1;
            this.menu();
            this.driderDefeatMenu();
        }
        mitziEatsPussy() {
            ...
            if (this.player.cocks.length > 0)
                this.outputText(" and while you do have one for her to lavish her attention upon");
            else
                this.outputText(" and while you may lack such bulgy organs");
            this.outputText(", that tongue you saw is just too much to pass up. You spread your legs");
            if (this.player.balls > 0)
                this.outputText(" and lift your balls before");
            else
                this.outputText(",");
        ...
        titfuckMitzi() {
            ...
            if (this.player.balls > 0 && this.player.lust >= 75)
                this.outputText(" and too-full feeling balls");
        ...
        titfuckMitziSlow() {
            ...
            if (this.player.biggestCockArea() <= 20)
                this.outputText(", nearly obscuring the whole thing");
            else if (this.player.biggestCockArea() >= 100)
                this.outputText(", barely able to support it");
            this.outputText(".");
            if (this.player.cocks.length > 1) {
            ...
            if (this.player.balls > 0)
                this.outputText(" over your [balls] and");
            ...
            if (this.player.balls > 0 && this.player.ballSize > 5)
                this.outputText(" You dribble yet more pre-cum onto the sweat-shined swells. Big as they are, they can’t quite ensconce your entire length, letting you watch it happen in lurid detail.");
            else
                this.outputText(" You dribble yet more pre-cum into her swampy cleavage. You can feel it getting slicker and slicker but can’t quite see it happen. You’ve nothing to go on but the feel against your [cockHead biggest].");
            ...
            if (this.player.biggestCockArea() >= 100)
                this.outputText(" Sometimes she even plants a few more kisses on your [cockHead biggest] or just below. Other times she licks you like a lollipop - at least the parts not buried in bust.");
            ...
            if (this.player.balls > 0)
                this.outputText(" Your [balls] feel like they’re going to burst, clenching tight beneath your [cocks].");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TAMANI_MET] > 0)
                this.outputText(" since meeting Tamani");
        ...
        titfuckMitziQuick() {
            ...
            if (this.player.balls > 0)
                this.outputText(", her nipples dragging over the skin of your [sack]");
            ...
            if (this.player.cocks.length > 1 || this.player.cumQ() > 500)
                this.outputText(" cummy");
        ...
        rideDrider() {
            ...
            if (this.player.isNaga())
                ...
                this.outputText(" clop");
            else
                this.outputText(" stride");
            ...
            if (this.player.cor <= 33)
                this.outputText(" You feel a little guilty, about to copulate with a demon to better slay another. You’re supposed to be a force of purity, not stuffing a hot, throbbing, demonic dick inside yourself in Lethice’s throneroom, but you can’t see any better way to ensure you’re fully sated before the next confrontation.");
            else if (this.player.cor <= 75)
                this.outputText(" You’ve only got this one chance to get your rocks off before confronting the slut queen. You’ll need to hurry.");
            else
                this.outputText(" This drider and his glorious cock are yours to use and abuse now, no one else’s. Even Lethice can see the truth of it.");
        ...
        rideDriderToGoblin() {
            ...
            if (this.player.vaginas.length > 0)
                this.addButton(7, "Mitzi Licks", this.mitziEatsPussy);
        }
        actuallyRideDriderDick() {
            this.clearOutput();
            this.outputText("<i>“Fat chance,”</i> You hiss in the drider demon’s ear. <i>“");
            if (this.player.cor <= 33)
                this.outputText("You deserve worse than a little humiliation, but I’m so turned on that this’ll have to do.");
            else
                this.outputText("I’m going to work your dick better than that goblin hussy ever could. You’re going to beg like a bitch to the pathetic </i>mortal<i> in front of all your cohorts. They’ll never respect you again.");
            this.outputText("”</i>");
            ...
            if (this.player.clitLength > 3 || this.player.cocks.length > 0) {
                ...
                if (this.player.clitLength > 3)
                    this.outputText(" pump your [clit]");
                else
                    this.outputText(" give you a handjob");
            }
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] < 1 || this.player.hasVirginVagina() || this.player.cor <= 33)
                this.outputText("n unexpectedly");
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.HistorySlut) < 0 && this.player.findPerk(PerkLib_1.PerkLib.HistoryWhore) < 0)
                this.outputText(" chaste");
            else
                this.outputText(" determined");
            ...
            //Orgasm
            //Pass an hour.
            this.flags[kFLAGS_1.kFLAGS.DRIDERINCUBUS_FUCKED] = 1;
        ...
        buttfuckDrider() {
            ...
            if (this.monster.goblinFree)
                this.outputText(" You can see his turgid rod hanging between his legs jump at your touch, spurting a thick, viscous trickle of corrupted spunk across the marble floor.");
            else
                this.outputText(" The goblin slung under his insectile abdomen yelps as the cock buried balls-deep in her gash twitches, blowing a load of corrupted pre into her womb.");
            if (this.player.cor > 75)
                this.outputText(" What a magnificent creature. You look forward to seeing what this... Kinarial can do.");
            ...
            if (this.player.biggestCockArea() >= 1200)
                this.outputText(" You feel like your mammoth member is going to tear him apart at this rate! The drider’s mouth twists into a silent ring of shock, unable to give voice to his reaction as you bury yourself inside him.");
            else if (this.player.biggestCockArea() >= 500)
                this.outputText(" Your animalistically-proportioned prick stretches the virginal passage to its limit, making the drider roar in a mix of surprise and unexpected pleasure.");
            else
                this.outputText(" Your prick sinks deep into the drider’s ass, gliding through his virginal hole.");
            ...
            if (this.player.isDrider())
                this.outputText(" reach down from your bestial position overtop him and");
            ...
            if (this.player.isTaur())
                this.outputText(", which has the added bonus of carrying through from your bestial backside to his, and down to the cock-goblin mounted on Kinarial’s dick.");
            ...
            if (this.player.cumQ() <= 1000)
                this.outputText(" You squirt your load deep into the drider’s asshole, packing his virginal hole with sticky white spooge.");
            else if (this.player.cumQ() <= 5000)
                this.outputText(" You pump a thick, creamy load into the demon-spider’s behind, filling his virginal hole with hot spunk until it’s drooling out around your hammering member.");
            else
                this.outputText(" You flood the drider’s ass with a torrential wave of seed, bloating the demon’s gut with your spunk. Cum spurts out of his ass around your thrusting member, pouring out with every motion.");
            ...
            if (this.player.cor >= 75)
                this.outputText(" You can't wait to see how the Demon Queen feels when she's skewered on your rod!");
            this.getGame().dynStats("cor+", 20);
            this.player.orgasm();
            this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_IMP, PregnancyStore_1.PregnancyStore.INCUBATION_IMP);
            this.driderDefeatMenu();
    ...
    exports.DriderIncubusScenes = DriderIncubusScenes;
});
//# sourceMappingURL=DriderIncubusScenes.js.map