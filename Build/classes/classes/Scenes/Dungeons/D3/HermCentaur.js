define(["require", "exports", "../../../Monster", "../../../Appearance", "../../../CockTypesEnum", "../../../../../includes/appearanceDefs"], function (require, exports, Monster_1, Appearance_1, CockTypesEnum_1, appearanceDefs_1) {
    "use strict";
     ...
     * @author Gedan
     */
    class HermCentaur extends Monster_1.Monster {
        constructor() {
            super();
            ...
            this._usedGottaCum = false;
            this._usedHeal = false;
            this._chargingArouse = false;
            this._lustAtChargeStart = -1;
            this._arouseCooldown = 0;
            this._hypnoCockUses = 0;
            this.a = "the ";
            ...
            this.createCock(36, 5, CockTypesEnum_1.CockTypesEnum.HORSE);
            this.createVagina(false, 4, 5);
            this.balls = 2;
            this.ballSize = 3;
            this.hipRating = appearanceDefs_1.HIP_RATING_FERTILE;
        ...
        performCombatAction() {
            ...
            if (this._chargingArouse)
                ...
                this.healUp();
            else if (HermCentaur.rand(this.lust) >= 40)
                this.hypnoCock();
            else {
                // Selections
        ...
        feminineMusk() {
            ...
            if (this.player.lust <= 50)
                ...
                if (this.player.hasCock())
                    this.outputText(" [eachCock] with the desire to plunge inside that juicy-hot hole.");
                else if (this.player.hasVagina())
                    this.outputText(" your [vagina] with the desire to submit while juices pool between your [legs].");
                else
                    this.outputText(" your anus until it puckers, craving something to fill it - anything.");
            }
        ...
        aphrodisiacSquirt() {
            ...
            if (this.player.lust < 30)
                ...
                if (this.player.hasCock())
                    ...
                    this.outputText(" a wet heat answers in your loins, growing more insistent from moment to moment.");
                else
                    this.outputText(" your [asshole] tingles, craving something to fill it.");
            }
                ...
                if (this.player.hasCock())
                    ...
                    this.outputText(" ignoring the increasing wetness of your inner [armor]");
                ...
                if (this.player.hasCock())
                    this.outputText("  Pre begins to dribble from your hot-and-ready cum-slit, eager to pour out in a deluge of sperm.");
                else if (this.player.hasVagina())
                    this.outputText("  A flood of sopping moisture dribbles down your [legs], the proof of your unholy desire to breed.");
                ...
                this.outputText(" Sinking to your knees, you start trying to tear your way out of your [armor].  You don't care about winning anymore - fucking this woman... this beast... that's all that matters.  You don't care how she takes you, as long as you get to cum all over her!");
        }
        arouseSpellCharge() {
            ...
            if (this.player.inte > 80)
                this.outputText("  A tease attack would likely be the most effective method of attack.");
    ...
    exports.HermCentaur = HermCentaur;
});
//# sourceMappingURL=HermCentaur.js.map