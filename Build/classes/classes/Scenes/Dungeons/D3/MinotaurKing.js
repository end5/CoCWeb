define(["require", "exports", "../../../Monster", "../../../CockTypesEnum", "../../../../../includes/appearanceDefs", "../../../internals/WeightedDrop", "../../../GlobalFlags/kFLAGS", "../../../StatusAffects", "../../../PerkLib"], function (require, exports, Monster_1, CockTypesEnum_1, appearanceDefs_1, WeightedDrop_1, kFLAGS_1, StatusAffects_1, PerkLib_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class MinotaurKing extends Monster_1.Monster {
        constructor() {
            super();
            this._milkDrinks = 0;
            this._orgasms = 0;
            ...
            // this.long = "";
            this.tallness = 12 * 14;
            this.createCock(24, 5, CockTypesEnum_1.CockTypesEnum.HORSE);
            ...
            this.drop = new WeightedDrop_1.WeightedDrop(this.consumables.PROMEAD, 1);
            ...
            this.checkMonster();
            this._lastSpellCastCount = this.flags[kFLAGS_1.kFLAGS.SPELLS_CAST];
        }
        get long() {
            if (this._orgasms == 0) {
        ...
        get orgasms() { return this._orgasms; }
        performCombatAction() {
            ...
            if (this._lastSpellCastCount != this.flags[kFLAGS_1.kFLAGS.SPELLS_CAST]) {
                this._lastSpellCastCount = this.flags[kFLAGS_1.kFLAGS.SPELLS_CAST];
                this.headbutt();
            }
            else {
                var atks = [this.backhand, this.battleaxe, this.minoPheromones];
                atks[MinotaurKing.rand(atks.length)]();
            }
            this.combatRoundOver();
        }
        backhand() {
            this.outputText("Feinting with his axe, the Minotaur King flings a powerful backhand in your direction.");
            var damage = (this.str + this.weaponAttack) - MinotaurKing.rand(this.player.tou);
        ...
        headbutt() {
            this.outputText("<i>“Settle down,”</i> the brute growls, moments before attempting to slam his forehead into your own.");
            var damage = ((this.str + this.weaponAttack) / 2) - MinotaurKing.rand(this.player.tou);
            if (damage <= 0 || this.combatMiss() || this.combatFlexibility()) {
                this.outputText(" Luckily, you dodge aside.");
            }
            else if (this.combatEvade()) {
                ...
                damage = this.player.takeDamage(damage);
                this.outputText(" He impacts with stunning force, leaving you reeling! (" + damage + ")");
        ...
        dickslap() {
            ...
            this.outputText("Before you can completely regain your wits, the brute is on you, easily holding your hand in one hand while he none-too-gently smacks his cock into your face, dragging his musky member back and forth across your cheeks before finally breaking contact.");
            if (this._orgasms > 0) {
                this.outputText(" Strands of his");
                if (this.player.findPerk(PerkLib_1.PerkLib.MinotaurCumAddict) >= 0)
                    this.outputText(" god-like");
                this.outputText(" spunk hang from your nose until your tongue lashes out to collect them.");
                if (this.player.findPerk(PerkLib_1.PerkLib.MinotaurCumAddict) >= 0)
                    this.outputText(" Delicious.");
                else
                    this.outputText(" Why did you do that? And why did it feel so good.");
            }
            this.game.dynStats("lus", 15 + this.player.lib / 20);
        }
        battleaxe() {
            this.outputText("The Minotaur King carries his axe as if it weighed no more than a feather, brandishing it back and forth with such casual movements that you barely register his swing");
            var damage = (this.str + this.weaponAttack) - MinotaurKing.rand(this.player.tou);
