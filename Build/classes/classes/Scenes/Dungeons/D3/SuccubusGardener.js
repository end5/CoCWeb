define(["require", "exports", "../../../Monster", "../../../Appearance", "../../../../../includes/appearanceDefs", "../../../StatusAffects", "../../../GlobalFlags/kFLAGS", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, Monster_1, Appearance_1, appearanceDefs_1, StatusAffects_1, kFLAGS_1, kGAMECLASS_1) {
    "use strict";
     ...
     * @author Gedan
     */
    class SuccubusGardener extends Monster_1.Monster {
        constructor() {
            super();
            this.a = "the ";
            ...
            this.createBreastRow(Appearance_1.Appearance.breastCupInverse("FF"));
            ...
            this.checkMonster();
            this.createStatusAffect(StatusAffects_1.StatusAffects.TentagrappleCooldown, 10, 0, 0, 0);
        }
        cleanupEffects() {
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Tentagrappled))
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Tentagrappled);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.ShowerDotEffect))
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.ShowerDotEffect);
        }
        defeated(hpVictory) {
            this.cleanupEffects();
        ...
        performCombatAction() {
            ...
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.TentagrappleCooldown) >= 0) {
                this.addStatusValue(StatusAffects_1.StatusAffects.TentagrappleCooldown, 1, -1);
                if (this.statusAffectv1(StatusAffects_1.StatusAffects.TentagrappleCooldown) <= 0) {
                    this.removeStatusAffect(StatusAffects_1.StatusAffects.TentagrappleCooldown);
                }
            }
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.ShowerDotEffect) >= 0) {
            ...
            else if (this.findStatusAffect(StatusAffects_1.StatusAffects.TentagrappleCooldown) < 0) {
                this.tentagrapple();
            }
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.GardenerSapSpeed) < 0 && this.findStatusAffect(StatusAffects_1.StatusAffects.VineHealUsed) >= 0) {
                this.sapSpeed();
            }
            else {
        ...
        vineHeal() {
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.VineHealUsed) < 0) {
                this.createStatusAffect(StatusAffects_1.StatusAffects.VineHealUsed, 0, 0, 0, 0);
            }
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Stunned) < 0) {
                ...
                if (this.lustVuln <= 0.3)
                    this.outputText(" Whatever is in that healing nectar must be weakening her self-control.");
            }
            else {
        ...
        tentagrapple() {
            ...
            if (this.combatMiss() || this.combatEvade() || this.combatFlexibility() || this.combatMisdirect()) {
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Tentagrappled, 0, 0, 0, 0);
            }
        }
        grappleStruggle() {
            this.clearOutput();
            var numRounds = this.player.statusAffectv1(StatusAffects_1.StatusAffects.Tentagrappled);
            if (SuccubusGardener.rand(this.player.str) > this.str / (1 + (numRounds / 2))) {
                ...
                this.player.addStatusValue(StatusAffects_1.StatusAffects.Tentagrappled, 1, 1);
        ...
        corruptiveShower() {
            ...
            if (this.combatMiss() || this.combatEvade() || this.combatFlexibility() || this.combatMisdirect()) {
                ...
                //Fail
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.ShowerDotEffect) < 0)
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.ShowerDotEffect, 3, 0, 0, 0);
                else
                    this.player.addStatusValue(StatusAffects_1.StatusAffects.ShowerDotEffect, 1, 3);
        ...
        showerDotEffect() {
            ...
            this.player.addStatusValue(StatusAffects_1.StatusAffects.ShowerDotEffect, 1, -1);
            //Dot effect
            if (this.player.lust < 50)
                this.outputText("The tentacles' sex-juices are still covering you - still slowly arousing you. You've got a good handle on it for now.\n\n");
                ...
                if (this.player.cor < 50)
                    this.outputText(" You're ashamed to admit");
                else
                    this.outputText(" You're a little irritated to admit");
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.ShowerDotEffect) < 0) {
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.ShowerDotEffect);
        ...
        sapSpeed() {
            ...
            // 20%?
            var speedSapped = this.player.spe * 0.2;
            this.player.spe -= speedSapped;
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.GardenerSapSpeed, speedSapped, 0, 0, 0);
            kGAMECLASS_1.kGAMECLASS.mainView.statsView.showStatDown('spe');
        }
        lustAuraCast() {
    ...
    exports.SuccubusGardener = SuccubusGardener;
});
//# sourceMappingURL=SuccubusGardener.js.map