define(["require", "exports", "../../../Monster", "../../../StatusAffects", "../../../CockTypesEnum", "../../../../../includes/appearanceDefs"], function (require, exports, Monster_1, StatusAffects_1, CockTypesEnum_1, appearanceDefs_1) {
     ...
     * @author Gedan
     */
    class JeanClaude extends Monster_1.Monster {
        doubleAttack() {
            this.outputText("The monstrous basilisk suddenly lunges forward, snarling wordlessly as he swings his cutlass at you twice, the blows of a savage yet expert swordsman.\n\n");
            this.createStatusAffect(StatusAffects_1.StatusAffects.Attacks, 2, 0, 0, 0);
            this.eAttack();
        ...
        defeated(hpVictory) {
            this.game.d3.jeanClaude.beatDaFuckhugeBasilisk(hpVictory);
        }
        won(hpVictory, pcCameWorms) {
            this.game.d3.jeanClaude.fuckhugeBasiliskFuckedYouUp(hpVictory);
        }
        handleTease(lustDelta, successful) {
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.RemovedArmor) < 0) {
                ...
                if (!successful) {
                    ...
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.RemovedArmor, 0, 0, 0, 0);
                    if (this.findStatusAffect(StatusAffects_1.StatusAffects.JCLustLevel) < 0) {
                        this.createStatusAffect(StatusAffects_1.StatusAffects.JCLustLevel, 1, 0, 0, 0);
                        this.lustVuln += 0.1;
                    }
                    else {
                        this.addStatusValue(StatusAffects_1.StatusAffects.JCLustLevel, 1, 1);
                    }
        ...
        constructor() {
            ...
            this.plural = false;
            this.createCock(12, 2, CockTypesEnum_1.CockTypesEnum.LIZARD);
            this.balls = 2;
            this.ballSize = 6;
            ...
            this.initStrTouSpeInte(80, 100, 80, 60);
            this.initLibSensCor(40, 40, 80);
            this.faceType = appearanceDefs_1.FACE_LIZARD;
            ...
            this.lust = 5;
            this.level = 20;
            this.gems = 300 + JeanClaude.rand(55);
            this.drop = this.NO_DROP;
            this.checkMonster();
        }
    }
    exports.JeanClaude = JeanClaude;
});
//# sourceMappingURL=JeanClaude.js.map