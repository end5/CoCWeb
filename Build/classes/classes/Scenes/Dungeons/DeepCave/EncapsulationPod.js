define(["require", "exports", "../../../Monster", "../../../StatusAffects", "../../../../../includes/appearanceDefs", "../../../internals/WeightedDrop"], function (require, exports, Monster_1, StatusAffects_1, appearanceDefs_1, WeightedDrop_1) {
    "use strict";
    ...
    class EncapsulationPod extends Monster_1.Monster {
        performCombatAction() {
        ...
        get long() {
            //[Round 1 Description]
            var _long;
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Round) < 0)
                _long = "You're totally trapped inside a pod!  The walls are slimy and oozing moisture that makes the air sickeningly sweet.  It makes you feel a little dizzy.  Tentacles are climbing up your " + this.game.player.legs() + " towards your crotch, doing their best to get under you " + this.game.player.armorName + ".  There's too many to try to pull away.  Your only chance of escape is to create a way out!";
            //[Round 2 Description]
            else if (this.statusAffectv1(StatusAffects_1.StatusAffects.Round) == 2) {
            ...
            //[Round 3 Description]
            else if (this.statusAffectv1(StatusAffects_1.StatusAffects.Round) == 3) {
        ...
        constructor() {
            ...
            this.drop = new WeightedDrop_1.WeightedDrop(this.weapons.JRAPIER, 1);
    ...
    exports.EncapsulationPod = EncapsulationPod;
});
//# sourceMappingURL=EncapsulationPod.js.map