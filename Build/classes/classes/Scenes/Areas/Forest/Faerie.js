define(["require", "exports", "../../../BaseContent", "../../../StatusAffects", "../../../../../includes/appearanceDefs", "../../../Appearance", "../../../CockTypesEnum"], function (require, exports, BaseContent_1, StatusAffects_1, appearanceDefs_1, Appearance_1, CockTypesEnum_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Faerie extends BaseContent_1.BaseContent {
        //faerie Encounter
        encounterFaerie() {
            ...
            if (this.player.cockTotal() > 0 && (!this.player.hasVagina() || Faerie.rand(2) == 0)) {
                this.outputText("She seems to notice you getting hard at the sight of her and looks down. \"<i>Ew, man parts!</i>\" the faerie exclaims, flying away like a frightened bird.", false);
                if (Faerie.rand(this.player.spe / 2) + this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFucked) > 15) {
                    if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFucked) < 5) {
                        ...
                        this.outputText("It would be cute if she wasn't dressed up like such a slut.  You bet you could get her to help pleasure you, but she might not like it.  Or you could be a nice " + this.player.guyGirl() + " and let her go...\n\nDo you force her to pleasure you?", false);
                    }
                    else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFucked) < 10) {
                    ...
                    else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFucked) < 15) {
                ...
                if (this.player.lust >= 90) {
                    ...
                    if (this.player.cockTotal() == 1)
                        this.outputText("your dick", false);
                    else
                        this.outputText("one of your dicks", false);
                    this.outputText(", too large for her tiny frame... the depraved image overwhelms your mind's eye and you find yourself shooting all over the ground furiously.", false);
                    this.player.orgasm();
                }
                else
            ...
            if (this.player.hasVagina())
                this.simpleChoices("Shoo Away", this.faerieShooAway, "Nothing", this.faerieDoNothing, "Rape", this.faerieRAEP, "", undefined, "", undefined);
            else
                this.simpleChoices("Shoo Away", this.faerieShooAway, "Nothing", this.faerieDoNothing, "", undefined, "", undefined, "", undefined);
        }
        faerieRAEP() {
            this.spriteSelect(17);
            //Count secksins
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FaerieFemFuck) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.FaerieFemFuck, 1, 0, 0, 0);
            else
                this.player.addStatusValue(StatusAffects_1.StatusAffects.FaerieFemFuck, 1, 1);
            this.outputText("You let the tiny faerie buzz closer to investigate, then with an explosion of movement, snatch her out of the air.  She squirms in your palm, struggling futilely in your grasp.  You poke between her legs with a finger, noting the flushed redness of the faerie's skin.  ", true);
            //Changes based on times fucked
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFemFuck) == 1)
                this.outputText("She juices herself and screams, \"<i>Let me goooooooo,</i>\" trying to sound outraged instead of turned on, but the tiny girl's body gives away the lie.", false);
            else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFemFuck) <= 5)
                this.outputText("She juices herself and moans, \"<i>Stop teasing meeeeee,</i>\" doing her best to wriggle back against you, as if she could somehow impale herself on your digit.", false);
            else
                this.outputText("She squeals, rocking her hips back against you and moaning, \"<i>Ohhhh I love it when you do that,</i>\" grinding her incredibly small love-button on your digit.", false);
            //Special Taurness
            if (this.player.isTaur()) {
                this.outputText("\n\nYou bop the tiny Faerie on the head to daze her briefly, then place her on a branch. You back yourself up against the tiny creature, lifting your tail so she can see your " + this.vaginaDescript(0) + ". The scent washes toward her and you hear a high pitched giggle; evidently that was more than enough to give her quite the contact high.  You feel a strange sensation in your slit as she slides her legs inside you and wraps her arms around your " + this.clitDescript() + ".\n\n", false);
                //[If cock-like clit:
                if (this.player.clitLength >= 3) {
                    this.outputText("The tiny fae begins jerking your clit like a cock, squeezing her arms tightly around you and sliding in and out of your " + this.vaginaDescript(0) + ". Her motions are frenetic and unpredictable, but incredibly pleasurable.  She starts licking at your " + this.clitDescript() + " as your femcum runs down it, which only serves to make her more excited. She gets so excited that her legs start kicking wildly as she screams \"<i>Swim! Swim! Swim! Swim!</i>\" over and over again.  ", false);
                    //[Small amount of cum:
                    if (this.player.vaginas[0].vaginalWetness <= appearanceDefs_1.VAGINA_WETNESS_WET)
                        this.outputText("The fae giggles more and more as the fluid seeps about her and your " + this.vaginaDescript(0) + " ripples. She hugs your " + this.clitDescript() + " tighter and starts gently gnawing at it, such a peculiar sensation that you cum suddenly, and wetly.  Her giggles quickly become all-out laughter, and she loses her grip on your clit, sprawling to the ground into a small puddle of femcum.\n\n", false);
                    //[Normal amount of cum:
                    else if (this.player.vaginas[0].vaginalWetness <= appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                        this.outputText("The fae giggles more and more as the fluid squirts about her and your " + this.vaginaDescript(0) + " ripples. She hugs your " + this.clitDescript() + " tighter and starts gently gnawing at it, such a peculiar sensation that you cum suddenly, and wetly.  Her giggles quickly become all-out laughter, and she loses her grip on your clit, sprawling to the ground into a puddle of femcum.\n\n", false);
                    //[Huge amount of cum:
                    else
                        this.outputText("The fae giggles more and more as the fluid sprays about her and your " + this.vaginaDescript(0) + " ripples. She hugs your " + this.clitDescript() + " tighter and starts gently gnawing at it, such a peculiar sensation that you cum suddenly, and wetly.  Her giggles quickly become all-out laughter, and she loses her grip on your clit, sprawling to the ground into a huge puddle of femcum, her giggling frame floating on the surface as her legs kick about erratically.\n\n", false);
                }
                //[All other clits:
                else {
                    this.outputText("The tiny fae rubs her hands around your " + this.clitDescript() + " as if entranced by it. Your body responds by pumping out more femcum, which she laps up happily.  She starts laughing maniacally and banging on your clit like a drum, periodically yelling out \"<i>CONGA!</i>\" for some reason. The strange ministrations feel incredible though, and you feel your love canal squeezing down on the faerie's tiny body.  ", false);
                    //[Small amount of cum:
                    if (this.player.vaginas[0].vaginalWetness <= appearanceDefs_1.VAGINA_WETNESS_WET)
                        this.outputText("You cum suddenly, and wetly. The fae giggles more and more as the fluid seeps about her and your " + this.vaginaDescript(0) + " ripples. Her giggles quickly become all-out laughter, and she loses her grip on your innards, sprawling to the ground into a small puddle of femcum.\n\n", false);
                    //[Normal amount of cum:
                    else if (this.player.vaginas[0].vaginalWetness <= appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                        this.outputText("You cum suddenly, and wetly. The fae giggles more and more as the fluid squirts around her and your " + this.vaginaDescript(0) + " ripples. Her giggles quickly become all-out laughter, and she loses her grip on your innards, sprawling to the ground into a puddle of femcum.\n\n", false);
                    //[Huge amount of cum:
                    else
                        this.outputText("You cum suddenly, and wetly. The fae tries desperately to hold on to your " + this.clitDescript() + " but the amount of fluid overwhelms her and she's sent spiralling to the ground into a huge puddle of your fluid, her giggling frame floating on the surface as her legs kick about erratically.\n\n", false);
                }
            }
            //Non-Taurs
            else {
                this.outputText("\n\nYou release the lower portion of your " + this.player.armorName + ", revealing your aroused slit to the faerie.  ", false);
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFemFuck) < 4)
                    this.outputText("Her mood immediately shifts from panic to desire, and she licks her lips hungrily, locking her eyes onto your feminine folds.", false);
                else
                    this.outputText("Her eyes open wide, like a junkie seeing a fix.  She licks her lips hungrily and humps the inside of your hand, ready for action.", false);
                this.outputText("  You release the faerie, letting the pussy-entranced fae buzz down to your sensitive nether-regions.  She lands softly, her tiny feet and hands prancing over your vulva.  You gasp in delight, ", false);
                if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_SLAVERING)
                    this.outputText("releasing a tiny squirt", false);
                else if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                    this.outputText("dribbling juices", false);
                else if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_WET)
                    this.outputText("growing so slippery the faerie nearly loses her footing", false);
                else
                    this.outputText("feeling yourself moistening with need", false);
                ...
                //(medium) <= .1.25\"
                    ...
                    this.outputText("She watches, entranced as your " + this.clitDescript() + " hardens, poking between your lips, flushed with blood like a tiny cock.   The faerie swivels around, planting her dainty butt squarely on your snatch, sinking down a bit into the folds as she wraps her legs around the pulsating 'shaft'.   She hugs it, pressing it between her tiny breasts and licking it up and down, making you moan and squirm from unexpected stimulation of your most sensitive area.\n\n", false);
                    this.outputText("You spread your " + this.player.legs() + ", careful not to dislodge the faerie as she releases the " + this.clitDescript() + " and stands up, placing her dripping gash against the tip.   A quick plunge later and she's bottomed out, pressing her hips into the opening of your " + this.vaginaDescript(0) + " her feet slipping over the outer folds as she tries to maintain her balance.   You start rocking back and forth happily, bouncing the faerie up and down.  She moans, cute and barely audible, but sexy in a way that makes your sopping fuckhole even wetter.\n\n", false);
                    this.outputText("She orgasms on you, squirting copiously, drenching your " + this.clitDescript() + " and " + this.vaginaDescript(0) + " in clear faerie-fluid.  It tingles, wicking into your button and soaking into your snatch, enhancing every sensation.  You can feel the cool forest air as it flows over your vulva, seeming to stroke you, and without any chance of holding yourself back, you plunge your fingers into your " + this.vaginaDescript(0) + ", immediately orgasming from the penetration, not even noticing the exhausted faerie sliding off the large clit and slipping partway into your cunt.\n\n", false);
                }
                //(streeeetch – large) <= 4.5\"
                else if (this.player.clitLength <= 4.5) {
                    this.outputText("Entranced by the growing " + this.clitDescript() + ", the faerie caresses her body, watching your love-button swell up, not stopping until it looks too huge for her tiny frame.  She climbs in a circle around it, awestruck by the size and majesty of your cock-like button.    She looks up at you, aroused but worried, saying, \"<i>You're so... BIG.  Oh goddess, I want to feel it inside me!</i>\"\n\n", false);
                ...
                //(too big) (else – hump dat shit)
                    ...
                    this.outputText("Your " + this.clitDescript() + " jumps, throwing the tiny woman off.  She slips and scrabbles across the surface of your " + this.vaginaDescript(0) + ", sliding into your soaking gash.  She's squeezed tightly, sloshed around in the wetness of your orgasm.   The faerie's eyes cross, as she grows dizzy and battered in the sizzling whirlpool that is your groin.\n\n", false);
                }
            }
            ...
            //[REPEAT LOW]
                ...
                this.outputText("The faerie slowly drags herself out of your " + this.vaginaDescript(0) + ", smiling broadly with her eyes dilated wide.  She slips off you, dropping to the ground and giggling, \"<i>Everything feels so soft.  Mmmm that was fun!</i>\"\n\n", false);
        ...
        faerieDoNothing() {
            ...
            if (this.player.nippleLength >= 1) {
                ...
                if (this.player.biggestLactation() > 1)
                    this.outputText("A squirt of milk shoots inside her, making the faerie moan. She looks up at you with lusty, slitted eyes, squeezing her legs together to draw more from you.\n\n", false);
                this.outputText("Eventually you both find a rhythm and soon she's moaning loudly.  ", false);
                if (this.player.hasVagina())
                    this.outputText("With your other hand you start diddling your " + this.vaginaDescript(0) + ", adding your own soft moans to hers.  ", false);
                this.outputText("A few blissful moments later, she shudders and you feel her uncontrolled spasms around your nipple.  ", false);
                if (this.player.hasVagina())
                    this.outputText("You join her shortly after.  ", false);
                this.outputText("The faerie goes limp and spirals to the ground, crashing gently and still twitching in the afterglow. Stepping back carefully, you leave her.", false);
            ...
            if (this.player.clitLength >= 1.0 && this.player.clitLength <= 4.5 && this.player.hasVagina() && Faerie.rand(2) == 0) {
                ...
                if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                    this.outputText("You drench the poor faerie completely in your female juices, soaking her hair and body. Overwhelmed and spent, you drop her to the ground and catch your breath. She licks up what's around her face, but is too weak to do anything else but lie in the dirt.\n\n", false);
                else
                    this.outputText("Shuddering, you maintain your composure and keep going, trying to ride the high for another. Eventually you look down and you can see the faerie's eyes have glazed over and rolled to the back of her head. Her cunt has started clamping down on you a lot harder, evidence of her state of near-constant orgasm. The random clenching brings you off again very quickly and you have an intense orgasm, joining your fae cohort.\n\n", false);
            ...
            if (this.player.nippleLength > 3 || this.player.biggestTitSize() <= 2) {
                this.outputText("  Thankfully it appears to be temporary.", false);
                this.player.nippleLength -= .25;
            }
        ...
        faerieCaptureHJ() {
            this.spriteSelect(17);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FaerieFucked) >= 0)
                this.player.addStatusValue(StatusAffects_1.StatusAffects.FaerieFucked, 1, 2);
            else
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.FaerieFucked, 2, 0, 0, 0);
            this.outputText("", true);
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFucked) < 15) {
                ...
                this.outputText("She looks up at you and gulps before nodding silently, unwilling or unable to resist your command.   ", false);
            }
            this.outputText("You let her loose and she hovers in place, as if pondering her one last chance to escape.  She sighs and looks back up, blushing fiercely as she lands on your hip and gazes down at the bulge of your groin.  You can't help but laugh as she slips under your " + this.player.armorName + ", crawling across your sensitive thigh towards your " + this.multiCockDescriptLight() + ".\n\n", false);
            //Taurs get a special scene!
            if (this.player.isTaur()) {
                this.outputText("The tiny Faerie climbs on top of your " + this.cockDescript(0), false);
                if (this.player.cockTotal() > 0)
                    this.outputText("largest " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN), false);
                ...
                this.outputText("She smashes onto the end of your " + this.multiCockDescriptLight() + " and grasps at it. Her face crushes into your urethra as her tiny legs wrap themselves around the tip. Your wildly flailing cock starts to grow larger as your orgasm approaches, but the faerie doesn't notice as she happily drinks up your pre.\n\n", false);
                //[No testicles:
                if (this.player.balls == 0)
                    this.outputText("Your tiny globules of semen go straight into her open mouth and she sucks them down gleefully before falling with a splat onto the pre soaked ground.\n\n", false);
                else {
                    //[Small amount of cum:
                    if (this.player.cumQ() < 50)
                        this.outputText("Your semen splashes straight into her face and she's quick to suck it up. She falls with a splat onto the pre soaked ground while your member drips periodic droplets of cum onto her head.\n\n", false);
                    //[Normal amount of cum:
                    else if (this.player.cumQ() < 200)
                        this.outputText("Your semen washes into her face and she loses her grip on your " + this.multiCockDescriptLight() + ". She falls with a splat onto the pre soaked ground and you spray her with periodic spurts of fresh cum.\n\n", false);
                    //[Huge amount of cum:
                    else
                        this.outputText("Your semen collides with her face and she is propelled off of your cock onto the pre soaked ground. Your " + this.ballsDescriptLight() + " continue pumping out cum like a hose until she's almost swimming in it.\n\n", false);
                }
                this.player.orgasm();
                this.dynStats("lib", -.5);
                //Epilogue!
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFucked) < 10)
                    this.outputText("The faerie burps and giggles again before glaring up at you, accusing you with a mildly unfocused glare and asking, \"<i>Did you know we get drunk on cum?  Caushe I TRY SO HARRD not to get meshed up like this.</i>\"\n\n", false);
                else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFucked) < 15)
                    this.outputText("The faerie burps and laughs drunkenly, patting the side of your " + this.player.leg() + " and slurring, \"<i>Oh by Marae's ripe titsh!  I needed that.  Do you thhink you could catsch me again?  I love feeling your cum coating my body.</i>\"\n\n", false);
                else
                    this.outputText("The faerie burps and begins openly masturbating, panting and slurring happily, \"<i>Yush I-gasp-uh feel great!  MMMmmmhm, it makesh my twat so sensitive.  I'm gonna fly home and schtuff it full, then play with my clit till I fall ashleep!</i>\"\n\n", false);
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFucked) < 15)
                    this.outputText("She licks her fingers and rolls around laughing, \"<i>Hehe, who caresh!  I'm happy! WHEEEEE!</i>\"\n\n", false);
                this.outputText("The faerie takes off, still dripping, and flying in something less than a straight line...", false);
            }
            //Non-taurs
            else {
                this.outputText("The faerie reaches your swollen member and ", false);
                if (this.player.hasKnot(0))
                    this.outputText("climbs atop your knot, wrapping her legs around the narrower shaft to hold on.  You can feel her cheeks resting atop the 'bulb' of your canine anatomy, teasing you with feminine features you're far too large to penetrate.  ", false);
                else if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                    this.outputText("climbs atop your " + this.cockDescript(0) + ", hanging onto your ring of prepuce and wrapping her legs as far around your horse-like maleness as she can.  ", false);
                else if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.DEMON)
                    this.outputText("climbs atop your " + this.cockDescript(0) + ", hanging on to the corrupted nubs and nodules as she threads her legs between them, squeezing you tightly as she hangs on.  You can feel her wet gash sitting atop a particularly sensitive bump, teasing you with a tiny cunt you'll never be able to penetrate.  ", false);
                else if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE)
                    this.outputText("climbs onto your squirming " + this.cockDescript(0) + ", wrapping her legs tightly around it as it wiggles and writhes with excitement.  Unbidden, it curls around and rubs its reddish-purple head against her face like an animal.  She gives it a gentle squeeze and licks it.  ", false);
                else
                    this.outputText("climbs on to your hardness, wrapping her legs tightly around it as she secures a perch against you.   You can feel her wet gash rubbing against your sensitive skin, teasing you with a tiny cunt you'll never be able to penetrate.  ", false);
                ...
                if (this.player.cumQ() > 250) {
                    this.outputText("You cum uncontrollably, regretting your fertility as your body paints the inside of your " + this.player.armorName + " with goopy whiteness.  ", false);
                    if (this.player.cumQ() > 500)
                        this.outputText("The proof of your release forms a puddle around you as your legs give out and y", false);
                    else
                        this.outputText("Falling backwards as your legs give out, y", false);
                }
                else
                ...
                this.outputText("She rolls off of you, staggers, and plops down on her cute little ass next to you", false);
                if (this.player.cumQ() > 500)
                    this.outputText(" in the cum", false);
                this.outputText(", giggling drunkenly.  ", false);
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFucked) < 10)
                    this.outputText("The faerie burps and giggles again before glaring up at you, accusing you with a mildly unfocused glare and asking, \"<i>Did you know we get drunk on cum?  Caushe I TRY SO HARRD not to get meshed up like this.</i>\"\n\n", false);
                else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.FaerieFucked) < 15)
                    this.outputText("The faerie burps and laughs drunkenly, patting the side of your " + this.player.leg() + " and slurring, \"<i>Oh by Marae's ripe titsh!  I needed that.  Do you thhink you could catsch me again?  I love feeling your cum coating my body.</i>\"\n\n", false);
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Jizzpants) < 0)
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.Jizzpants, 1, 0, 0, 0);
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
    }
    exports.Faerie = Faerie;
});
