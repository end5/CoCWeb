define(["require", "exports", "../../../BaseContent", "../../../GlobalFlags/kFLAGS", "../../../StatusAffects", "../../../CockTypesEnum", "../../../CoC", "../../../PregnancyStore", "./BeeGirl", "../../../../../includes/appearanceDefs", "../../../Appearance", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, BaseContent_1, kFLAGS_1, StatusAffects_1, CockTypesEnum_1, CoC_1, PregnancyStore_1, BeeGirl_1, appearanceDefs_1, Appearance_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 03.01.14.
     */
    class BeeGirlScene extends BaseContent_1.BaseContent {
        BeeGirlScene() { }
        setTalked() { this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_STATUS] = BeeGirlScene.BEE_GIRL_TALKED; }
        get attitude() { return this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_STATUS] & BeeGirlScene.BEE_GIRL_ATTITUDE; }
        set attitude(value) { this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_STATUS] = (this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_STATUS] & BeeGirlScene.BEE_GIRL_CONVERSATION) + value; }
        get badEndWarning() { return (this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_STATUS] & 0x80000000) != 0; }
        set badEndWarning(value) {
            this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_STATUS] = (this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_STATUS] & (BeeGirlScene.BEE_GIRL_ATTITUDE | BeeGirlScene.BEE_GIRL_CONVERSATION)) + (value ? 0x80000000 : 0);
        }
        get conversation() { return (this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_STATUS] & BeeGirlScene.BEE_GIRL_CONVERSATION) >> 16; }
        set conversation(value) { this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_STATUS] = (this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_STATUS] & BeeGirlScene.BEE_GIRL_ATTITUDE) + (value << 16); }
        //The Queen Bee
        //location: Forest
        ...
        beeEncounter() {
            ...
            //If not smart enough, proceed.
                ...
                this.beeEncounterSelect(false);
        }
        beeEncounterSelect(clearScreen = true) {
            if (clearScreen)
                this.clearOutput();
            this.spriteSelect(6);
            //Bee appears!
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1 && this.player.cockArea(0) > 100 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Exgartuan) == 0) { //Exgartuan messes with things!
                this.beeEncounterWithExgartuan();
                return;
            }
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) >= 0 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.WormPlugged) >= 0) { //Worms now mess with things too!
                this.beeEncounterWithWorms();
                return;
            }
            var isBeeMorph = this.player.race() == "bee-morph";
            if (this.player.hasCock() && (this.player.cockArea(0) >= 50 || this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.BEE || isBeeMorph)) {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_COMBAT_LOSSES] + this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_COMBAT_WINS_WITH_RAPE] + this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_COMBAT_WINS_WITHOUT_RAPE] >= 5) {
                if (this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_COMBAT_LOSSES] > this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_COMBAT_WINS_WITH_RAPE] + this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_COMBAT_WINS_WITHOUT_RAPE])
                    this.beeEncounterSheBeatsYouRegularly();
                else if (this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_COMBAT_WINS_WITHOUT_RAPE] >= this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_COMBAT_WINS_WITH_RAPE])
                    this.beeEncounterSheFearsYou();
                else
                    this.beeEncounterSheDesiresYou();
            }
            else {
        ...
        beeEncounterAsBeeMorphMaleOrGiantCock(isBeeMorph) {
            ...
            if (this.player.longestCockLength() > 50 || this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.BEE)
                this.outputText("Come here boy, let me help that fine member of yourzzz get releazzze");
            else
                this.outputText("Come here little one, I’ll help you become a real bee boy");
        ...
        beeEncounterAsBeeMorphFemale() {
            ...
            if (this.player.cor <= 33)
                ...
                this.outputText("You grin at the thought, it would certainly be fun fucking her, but maybe it would be even more fun to force yourself on her?");
        ...
        beeEncounterAsBeeMorphFemaleLeave() {
            this.spriteSelect(6);
        ...
        beeEncounterAfraidFirstTimeSex() {
            this.clearOutput();
            this.spriteSelect(6);
            ...
            var cockIndex = this.player.cockThatFits(50);
            if (cockIndex >= 0) {
                if (this.player.hasVagina()) {
                    this.outputText("You smile at her as she examines your " + this.multiCockDescriptLight() + " and your " + this.vaginaDescript(0) + " and ask her which of your toys she wants to play with.  She looks up at you and licks her luscious black lips before whispering to you, <i>“Both.”</i> and pushes you onto your back.  In a flash she is hovering over top of you, upside down.  She takes a firm hold of your " + this.multiCockDescriptLight() + " and gives it a few initial strokes while simultaneously using her long flexible tongue to probe and explore your " + this.vaginaDescript(0) + ".  Astounded by the talents of this bee girl, you can do nothing but push yourself up against her, desperate for more of this incredible stimulation.\n\n");
                    this.outputText("The handmaiden seems to think that you need more stimulation too.  She promptly buries her face and tongue as far inside your " + this.vaginaDescript(0) + " as possible, while simultaneously bringing your " + this.cockDescript(0) + " to her exotic breasts and crushing it between them.  You cry out in dismay and grip the petals of the giant flower you’re spread eagle on.  You look up at your bee lover, who is now hovering at about a forty five degree angle above you while kicking her lower legs back and forth in amusement.  Soon she starts to pump her body up and down to stimulate your " + this.cockDescript(0) + " trapped between her love pillows, while also maneuvering her long insectoid tongue around inside your " + this.vaginaDescript(0) + ".\n\n");
                ...
                this.outputText("You rub your abdomen, feeling her ovipositor deep inside you.  You smile, it’s time to pick up the pace and lift up your body, then drop it back down, impaling yourself on the intruder.  You love every second of it, but the sensations aren’t as overwhelming as the handmaiden seems to be finding them.  All she can do at this point is hold onto you as tightly as she can, unable to to do anything else at this point as she pants, moans, and screams from the sensation overload from her ovipositor.  Suddenly there is a sharp stinging feeling in your " + this.nippleDescript(0) + " as the bee girl bites down in orgasm, causing you to be pushed over the edge as well.  " + (this.player.vaginas[0].vaginalWetness >= CoC_1.CoC.VAGINA_WETNESS_WET ? "This leads to you liberally drenching your lower body and hers with" : "This brings out a small spray of") + " girl fluids from your " + this.vaginaDescript(0) + ".  A few minutes later, the bee girl finally recovers.  It seems that she is looking forward to the next meeting between you two as well.  Leaving you with <i>“Next time, we’re putting that to itzzz proper uzzze!”</i> and a happy wave.");
            }
            else {
        ...
        beeEncounterAfraidRepeatSex() {
            ...
            if (this.player.hasCock()) {
                this.outputText("gently running her fingers along your " + this.multiCockDescriptLight() + " bringing " + (this.player.cocks.length > 1 ? "them" : "it") + " to full hardness" + (this.player.hasVagina() ? ", " : " and "));
            }
            if (this.player.hasVagina()) {
                this.outputText("slipping her fingers about your " + this.vaginaDescript(0) + " and your " + this.assholeDescript() + " till you’re wet and ready");
            }
            else
                this.outputText("slipping her fingere inside your " + this.assholeDescript() + "till you’re ready");
            ...
            if (this.player.analCapacity() < 25) {
                ...
                if (this.player.ass.analLooseness == CoC_1.CoC.ANAL_LOOSENESS_VIRGIN)
                    this.outputText("<b>Well, at least you’re losing your anal virginity willingly.  That’s something to be said in this world.</b>");
                else
                    this.outputText("<b>Your " + this.assholeDescript() + " has become looser thanks to the knotted appendage penetrating you.</b>");
                ...
                this.outputText("Your experiance in this world has well prepared your " + this.assholeDescript() + " for the knotted appendage.  Its lubricated surface gives nothing but pleasure to your used rear, and both you and your insectoid lover give nothing but moans of pleasure as each new bump passes into your body.\n\n");
            }
            ...
            if (this.player.tallness <= 50)
                ...
                this.outputText("her small body against yours.  She rubs her head against your chest, and you vaguely hear her whisper something about a strong carrier for strong eggs.");
            ...
            var cockIndex = this.player.cockThatFits(50);
            if (cockIndex >= 0) {
                this.outputText("Left wanting a bit more pleasure, you lift up the bee girl, and gently lower her onto your waiting " + this.cockDescript(cockIndex) + " so that she can mount you in the same way you mounted her.  Well, almost, since you’re quite sure her rough slick interior is very different than the inside of your " + this.assDescript() + ".  While a bit surprised at first, she quickly gets really into bouncing on top of your " + this.cockDescript(cockIndex) + " while her egg layer keeps working its magic.\n\n");
            }
            if (this.player.hasVagina()) {
                this.outputText("Your " + this.vaginaDescript(0) + " is left a bit wanting, so you free up one of your hands to deal with the lack of attention.  No sooner had you started playing with your " + this.clitDescript() + ", you find that the bee girl has brought one of her hands into the fray to deal with the lack of attention herself, all the while grinning at you.  You return her smile and move your hand instead to her honey pot’s little button and start playing with that while she deals with your clit.\n\n");
            }
            ...
            if (!this.player.isButtPregnant())
                this.player.buttKnockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_BEE_EGGS, PregnancyStore_1.PregnancyStore.INCUBATION_BEE);
            this.player.orgasm();
        ...
        beeEncounterSheBeatsYouRegularlyTalk() {
            this.clearOutput();
            this.spriteSelect(6);
        ...
        beeEncounterSheBeatsYouRegularlyDontLetHer() {
            this.clearOutput();
            this.spriteSelect(6);
        ...
        beeEncounterSheBeatsYouRegularlyAndYouLetHerLaysEggs(clearScreen = true) {
            if (clearScreen)
                this.clearOutput();
            else
                this.outputText("\n\n");
            ...
            if (BeeGirlScene.rand(2) == 0)
                this.player.buttKnockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_BEE_EGGS, PregnancyStore_1.PregnancyStore.INCUBATION_BEE, 1, 1); //Anal bee pregnancy!
        ...
        beeEncounterWithExgartuan() {
            ...
            if (BeeGirlScene.rand(2) == 0) {
                ...
                //start combat
                this.startCombat(new BeeGirl_1.BeeGirl());
            }
        }
        beeEncounterWithWorms() {
            ...
            this.outputText("The bee maiden puts her hands on your shoulders.  She draws you gently into a kiss, but as her sweet saliva prepares you for what is to come you feel one of your annelid passengers slither down " + (this.player.findStatusAffect(StatusAffects_1.StatusAffects.WormPlugged) >= 0 ? "from your cervix and poke out of your cunt" : "your urethra and wrap itself around the tip of your cock") + ".  The bee girl pulls back from the kiss, looks down and jumps back, the color draining from her face.\n\n");
        ...
        beeEncounterClassic(clearScreen = true) {
            if (clearScreen)
                this.clearOutput();
            if (this.attitude == BeeGirlScene.BEE_GIRL_TALKED_AND_LEFT || this.attitude == BeeGirlScene.BEE_GIRL_TALKED_AND_LEFT_TWICE)
        ...
        beeEncounterClassicSex(postCombat = true) {
            this.spriteSelect(6);
            //Give into the beeee
            if (this.attitude == BeeGirlScene.BEE_GIRL_TALKED_AND_LEFT || this.attitude == BeeGirlScene.BEE_GIRL_TALKED_AND_LEFT_TWICE)
                this.attitude = BeeGirlScene.BEE_GIRL_TALKED; //Reset your friendly conversation path if autorape or accepted
            ...
            if (this.player.isTaur()) {
                ...
                if (this.player.longestCockLength() >= 100 || this.player.gender == 0) {
                    ...
                    if (this.player.gender == 1) {
                        ...
                        this.outputText("your engorged " + this.multiCockDescriptLight() + " and jerk it off violently, cumming again and again as the bee-girl violates your " + this.assholeDescript() + ".  ", false);
                        //[Without testicles:
                        if (this.player.balls == 0)
                            this.outputText("With your cock quivering and spasming you continue to lap at the honey covered tree until the vibrating bee-girl finishes.  ", false);
                        //[With testicles:
                        else
                            this.outputText("With your cock quivering and spasming semen erupts from the tip.  ", false);
                        //[Little-normal cum amount:
                        if (this.player.cumQ() < 100)
                            this.outputText("You spurt out more cum than you thought your " + this.ballsDescriptLight() + " could hold. White speckles the base of the tree and tiny puddles form underneath you as you groan in satisfaction.\n\n", false);
                        //[Huge cum amount:
                        else
                            this.outputText("Your " + this.ballsDescriptLight() + " goes off like a firehouse, coating the base of the tree along with a number of the ones behind it. Soon you're standing in a massive puddle of your own splooge, the scent threatening to overpower that of the honey. The bee-girl compensates by splashing more onto your back, causing you to release yet another burst of thick white cum.\n\n", false);
                    }
                    //[Herm (bypasses the bucking scene):
                    else if (this.player.gender == 3) {
                        this.outputText("You grasp your engorged " + this.multiCockDescriptLight() + " and jerk it off violently, cumming again and again as the bee-girl violates your " + this.assholeDescript() + " and your " + this.vaginaDescript(0) + " pumps out enough femcum to drench your hind legs.  ", false);
                        //[Without testicles:
                        if (this.player.balls == 0)
                            this.outputText("With your cock quivering and spasming and your untended to " + this.vaginaDescript(0) + " squirting repeatedly, you continue to lap at the honey covered tree until the vibrating bee-girl finishes.  ", false);
                        //[With testicles:
                        else
                            this.outputText("With your cock quivering and spasming semen erupts from the tip.  ", false);
                        //[Little-normal cum amount:
                        ...
                        //[Huge cum amount:
                            ...
                            this.outputText(this.SMultiCockDesc() + " goes off like a firehouse, coating the base of the tree along with a number of the ones behind it. Soon you're standing in a massive puddle of your own splooge, the scent threatening to overpower that of the honey. The bee-girl compensates by splashing more onto your back, causing you to release yet another burst of thick white cum.\n\n", false);
                    }
                ...
                //Route 1 
                    ...
                    //[Male:
                    if (this.player.gender == 1)
                        this.outputText("Your inability to reach your engorged " + this.multiCockDescriptLight() + " quickly becomes a problem as the pleasure from the bee-maiden's scent courses through you. You ache to be tended to, gushing out pre.", false);
                    //[Female:
                    else if (this.player.gender == 2)
                        this.outputText("Your inability to reach your " + this.vaginaDescript(0) + " quickly becomes a problem as the pleasure from the bee maiden's scent courses through you, it starts reflexively rippling, trying to milk the cock it so desperately wants while your " + this.clitDescript() + " quivers.", false);
                    //[Herm:
                    else if (this.player.gender == 3)
                        this.outputText("Your inability to reach your engorged " + this.multiCockDescriptLight() + " quickly becomes a problem as the pleasure from the bee maiden's scent courses through you. It aches to be tended to, gushing out pre. Your " + this.clitDescript() + " quivers, desperate for contact as your vagina starts reflexively rippling, trying to milk the cock it isn't going to get.", false);
                    //[With breasts: 
                    if (this.player.biggestTitSize() > 1) {
                        this.outputText("  You begin pounding away at your " + kGAMECLASS_1.kGAMECLASS.player.allBreastsDescript() + " in an attempt to alleviate the pressure in your inaccessible groin.", false);
                        //[Fuckable breasts:
                        if (this.player.hasFuckableNipples())
                            this.outputText("  Your fingers slip in and out of them, sending femcum flying everywhere. But the effects of the bee's honey appear to prevent you from getting off.", false);
                        //[Other:
                        else
                            this.outputText("  No amount of stimulation seems to get you off though.", false);
                    }
                    this.outputText("\n\n", false);
                    this.outputText("The stimulation grows too painful and you begin to buck wildly. The bee-girl holds on desperately, her stinger still lodged in your " + this.assholeDescript() + " and pumping fluids. She seems to realize the problem though and attempts to solve it.  ", false);
                    //[Male:
                    if (this.player.gender == 1) {
                        this.outputText("Her legs wrap around your body and her 'feet' clasp onto your " + this.multiCockDescriptLight() + ". The strangeness of the sensation doesn't register though as just the contact is enough to send you over the edge.  ", false);
                        //[Without testicles:
                        if (this.player.balls == 0)
                            this.outputText("You cum violently, your " + this.multiCockDescriptLight() + " quivering and spasming.  ", false);
                        //[With testicles:
                        else
                            this.outputText("You cum violently, your " + this.multiCockDescriptLight() + " quivering and spasming while semen erupts from the tip.  ", false);
                        //[Little-normal cum amount:
                        if (this.player.cumQ() < 100)
                            this.outputText("You spurt out more cum than you thought your " + this.ballsDescriptLight() + " could hold. White speckles your underside and tiny puddles form underneath you as you groan in satisfaction.\n\n", false);
                        //[Huge cum amount:
                        else
                            this.outputText("Your " + this.ballsDescriptLight() + " goes off like a firehouse, coating your underside with white and dripping down your front legs. Soon you're standing in a massive puddle of your own splooge, the scent threatening to overpower that of the honey. The bee-girl compensates by splashing more onto your back, causing you to release yet another burst of thick white cum.\n\n", false);
                    }
                    //[Female:
                    else if (this.player.gender == 2) {
                        this.outputText("Her legs curl around your hind legs and her 'feet' begin rubbing your " + this.vaginaDescript(0) + ". The strangeness of the sensation doesn't register though as just the contact is enough to send you over the edge.  ", false);
                        //[Tiny-normal clit:
                        if (this.player.clitLength < 3)
                            this.outputText("Her awkward ministrations to your " + this.clitDescript() + " cause a gush of fluids from your " + this.vaginaDescript(0) + " and you let out a lewd moan of satisfaction.  ", false);
                        //[Cock-like clit:
                        else
                            this.outputText("She quickly finds your " + this.clitDescript() + " and begins to jerk it off like a cock.  The sensation is incredible and you moan lewdly as your " + this.vaginaDescript(0) + " gushes fluid.  ", false);
                    ...
                    //[Herm:
                        ...
                        if (BeeGirlScene.rand(2) == 0) {
                            ...
                            //[Huge cum amount:
                                ...
                                this.outputText("Your " + this.ballsDescriptLight() + " goes off like a firehouse, coating your underside with white and dripping down your front legs. Soon you're standing in a massive puddle of your own splooge, the scent threatening to overpower that of the honey. The bee-girl compensates by splashing more onto your back, causing you to release yet another burst of thick white cum.\n\n", false);
                            this.outputText("Thinking you still not satisfied, she pulls her 'feet' up slightly and she begins to rub your " + this.vaginaDescript(0) + ".  ", false);
                            ...
                            //[Cock-like clit:
                                ...
                                this.outputText("She quickly finds your " + this.clitDescript() + " and begins to jerk it off like a cock.  The sensation is incredible and you moan lewdly as your " + this.vaginaDescript(0) + " gushes fluid.  ", false);
                            this.outputText("Your hind legs are soon coated in the slick girlcum pouring out of you.", false);
                        }
                        //- OR -
                        //[Same as female followed by:]
                            ...
                            //[Cock-like clit:
                                ...
                                this.outputText("She quickly finds your " + this.clitDescript() + " and begins to jerk it off like a cock.  The sensation is incredible and you moan lewdly as your " + this.vaginaDescript(0) + " gushes fluid.  ", false);
                            this.outputText("Your hind legs are soon coated in the slick girlcum pouring out of you.\n\n", false);
                            this.outputText("Thinking you're still not satisfied, she lowers her 'feet' slightly and she begins to rub your " + this.multiCockDescriptLight() + ".  ", false);
                ...
                if (BeeGirlScene.rand(3) == 0)
                    this.player.buttKnockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_BEE_EGGS, PregnancyStore_1.PregnancyStore.INCUBATION_BEE, 1, 1);
                this.player.buttChange(25, true);
            }
            //NON TAURS
            //Dicked version...
                ...
                this.player.slimeFeed();
                //epilogue
                this.outputText("You awaken, your nose full of a honey like scent, some strange fluid on your back, and the feeling of something leaking from you.", false);
                this.player.buttChange(25, true);
                this.player.orgasm();
                this.dynStats("int", -.5);
                //Anal bee pregnancy!
            ...
            //non-dicked version
                ...
                this.outputText("You lay there, a giddy smile on your face, letting the bee-girl straddle and sink something sharp into your thigh.  Lust boils through your veins, ", false);
                ...
                //Coochie talk!
                    ...
                    if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_WET && this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                        this.outputText("growing more potent around your " + this.vaginaDescript(0) + " as it begins to leak with the honey of your desire.  ", false);
                    if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                        this.outputText("inflaming your " + this.vaginaDescript(0) + " with need, and allowing a river of your wetness to gush from between your puffy vulva.  ", false);
                }
                //Boobies!
                if (this.player.biggestTitSize() > 1) {
                    this.outputText("The cool hardness of her hands startles you as she reaches around to massage your ample bosom, tweaking your hard nipples between her fingers", false);
                    //if lactating
                    if (this.player.biggestLactation() > 1)
                        this.outputText(", humming in surprise as a squirt of milk splatters across the flower's petals.  ", false);
                    else
                        this.outputText(".  ", false);
                }
                //Multiboobs!
                if (this.player.breastRows.length > 1) {
                    this.outputText("The cool hardness of her hands startles you as she begins running her hands over your many breasts, tweaking each hard nipple between her fingers, leaning around to lick them with her curving sinuous tongue, and humming softly", false);
                    //Milk bit
                    if (this.player.biggestLactation() > 1)
                        this.outputText(" in surprise as a squirt of milk splashes across the flower's petals.  ", false);
                    else
                        this.outputText(".  ", false);
                }
                //Continue as normal!
                ...
                if (this.player.vaginas.length > 0)
                    ...
                    this.outputText("Your fingers explore every inch of both your bodies as you lap up her honey", false);
                ...
                if (this.player.vaginas.length > 0)
                    this.outputText(", the constant aphrodisiac honey you're mindlessly devouring, and your fingers' instinctual ravaging of your " + this.vaginaDescript(0) + ", ", false);
                else
                    this.outputText(" and the constant aphrodisiac honey you're mindlessly devouring, ", false);
        ...
        beeSexForCocks(clearScreen = true) {
            if (clearScreen)
                this.clearOutput();
            this.spriteSelect(6);
            ...
            var giantCockIndex = -1;
            for (var x = 0; x < this.player.cocks.length; x++) {
            ...
            if (giantCockIndex != -1) {
                ...
                this.outputText("She takes one more longing look at your flesh before going to her bag and rummaging around in it.  She takes out a small bottle and looks back at you for a moment, before slipping the bottle into her dripping honeypot.  She straightens up and looks at you once more, her breath coming in short gasps as she runs a finger over her black luscious lips.  <i>“You’re zzzuch a wonderfully big boy!”</i>  she exclaims, <i>“" + (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.BEE ? "Keep drinking your zzzpezzzial honey and zzzoon you’ll be ready" : "With thizzz zzzpezzzial honey, you’ll zzzoon be even better") + ".”</i>  Given the state of your mind, you can’t do much else other than nod to her.\n\n");
                this.menu();
        ...
        beeSexForCocksPart2(giantCockIndex) {
            this.clearOutput();
            this.spriteSelect(6);
            this.outputText("This is all the encouragement the handmaiden needs, and she leaps forward and wraps her arms around your " + this.player.cockDescript(giantCockIndex) + ".  She eagerly starts rubbing her large chest up and down your length while using her hands to play with the tip, running them all over it.  Panting, she contiues to give your " + this.player.cockDescript(giantCockIndex) + " a full body massage, bringing you incredible stimulation.  " + (this.player.cocks[giantCockIndex].cockLength > 36 ? "Even rubbing her nether lips against the base of your massive member." : "") + "  Her body starts to feel a bit sticky and slick and sometimes catches in places, bringing you to even higher levels of pleasure.\n\n");
            ...
            if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.BEE) {
        ...
        beeDroneBadEnd() {
            ...
            if (this.player.wingType == CoC_1.CoC.WING_TYPE_BEE_LIKE_LARGE) {
                ...
                if (this.player.wingType == CoC_1.CoC.WING_TYPE_NONE) {
                ...
                else if (this.player.wingType == CoC_1.CoC.WING_TYPE_BEE_LIKE_SMALL) {
                    ...
                    this.outputText("Your " + this.player.wingDesc + " feel itchy for a moment before falling off entirely.  You don’t have much time to worry about that though, as almost immediately afterwards you sprout a large pair of bee wings that you use to lift yourself into the air.\n\n");
                }
        ...
        beeTalk() {
            ...
            if (this.attitude < BeeGirlScene.BEE_GIRL_TALKED) { //Replaced beeProgress
                ...
                if (this.player.cor < 33)
                    this.outputText("You are sure no good can come of this, but your body is ready to say yes.");
                if (this.player.cor >= 33 && this.player.cor <= 66)
                    this.outputText("Her offer intrigues you, and the arousing sweetness of her scent makes it difficult to resist.");
                if (this.player.cor > 66)
                    this.outputText("Looking at her through lust-tinted eyes, you're sure she can deliver on her offer.  Getting closer to her scent alone would be worth bearing a few eggs...");
                ...
                //If you get unlucky you just get the choice of getting egg-laid.
                    ...
                    if (this.attitude == BeeGirlScene.BEE_GIRL_TALKED_AND_LEFT)
                        ...
                        this.outputText("She cocks her head and asks, \"<i>You again?  Zzzzurely you've come for more of my honey and eggzzz, no?</i>\"  Lightly caressing her swollen abdomen, you see the dripping knotted appendage begin to drop out next to her stinger.\n\n");
                    if (this.player.cor < 33)
                        this.outputText("You are sure no good can come of this, but your body is urging you to agree.");
                    if (this.player.cor >= 33 && this.player.cor <= 66)
                        this.outputText("Her offer intrigues you, and the arousing sweetness of her scent makes it difficult to resist.");
                    if (this.player.cor > 66)
                        this.outputText("Looking at her through lust-tinted eyes, you're sure she can deliver on her offer.  Getting closer to her scent alone would be worth bearing a few eggs...");
        ...
        beeEncounterRefusedHerEggsAfraid() {
            this.spriteSelect(6);
        ...
        beeEncounterRefusedHerEggsDisgusted() {
            this.spriteSelect(6);
        ...
        beeEncounterRefusedHerEggsDuty() {
            this.spriteSelect(6);
        ...
        beeEncounterRefusedHerEggsLeave() {
            this.spriteSelect(6);
        ...
        */
        beeMaidenPlay() {
            this.clearOutput();
            this.spriteSelect(6);
            this.outputText("You nod to her and walk up to the flower.  She moves a bit to the side and pats the spot next to her.  You first slip out of your " + this.player.armorName + ", then sit your " + this.assDescript() + " next to her.  ");
            if (this.player.cor <= 33)
                ...
                this.outputText("You barely keep yourself from jumping her in your excitement, but you manage to stay where you are so she can make the first move.");
            if (this.player.hasVagina()) {
                this.outputText("  <i>“Repeat after me.”</i>  She intones before giving a soft buzzing giggle and slips one of her hands into her honey pot and liberally covers it in her private sweetness.  You follow suit slipping your fingers to your " + this.vaginaDescript(0) + " and ");
                if (this.player.wetness() <= CoC_1.CoC.VAGINA_WETNESS_NORMAL)
                    this.outputText("barely");
                else if (this.player.wetness() <= CoC_1.CoC.VAGINA_WETNESS_SLICK)
                    this.outputText("easily");
                else
                    this.outputText("liberally");
                this.outputText(" cover them with your own fluids.\n\n");
                this.outputText("She raises her drenched hand, gives it a playful lick, and moves it down to your " + this.vaginaDescript() + " while you do the same to hers.  You gasp as her honey covered lower fingers quickly slip inside your " + this.vaginaDescript(0) + " and start to wriggle around.  You try to focus on matching her stimulations.  While you can hear her gasp in enjoyment from your ministrations, you can barely keep your mind straight let alone match her expert movements.  Keeping your brain from becoming mush becomes especially difficult when she brings her thumb and index finger to your " + this.clitDescript() + ".\n\n");
        ...
        beeMaidenConversation() {
            this.clearOutput();
            this.spriteSelect(6);
            if (this.conversation > 2 && this.player.cor > 20)
                this.conversation = 2;
        ...
        beeMaidenFertileBeeBadEndPart2() {
            this.clearOutput();
            this.spriteSelect(6);
        ...
        beeMaidenFertileBeeBadEndPart3() {
            this.clearOutput();
            this.spriteSelect(6);
            this.outputText("When you enter into the queen’s chamber, your senses are assaulted with a multitude of erotic images, sounds, and scents.  There are dozens of bees all in various states of debauchery and sexual escapades.  The females are all very much like your companion, with voluptuous thin bodies, while the males are built a bit different.  While their main bodies are still fairly thin, and they generally have cute androgynous faces, their main feature would be their massive manhoods, which are all easily three to four feet long, and at least five inches in diameter.\n\n");
            this.outputText("The females outnumber the males at least four to one, but they don’t let that get in the way of having fun.  Most of them are playing with each other in pairs, letting loose all sorts of sexual moans.  Some of the lucky ones have wrapped themselves around a male bee’s large member and are panting in pleasure as they cover those organs with their honey.  For their part, there isn’t a male bee who isn’t giving their own sexual moans of pleasure, either from the attention they’re getting from their handmaiden partner, or more often the queen herself.\n\n");
        ...
        beeMaidenFertileBeeBadEndPart4() {
            this.clearOutput();
            this.spriteSelect(6);
        ...
        beeMaidenFertileBeeBadEndPart5() {
            this.clearOutput();
            this.spriteSelect(6);
        ...
        beeMaidenConversationRejectCandy() {
        ...
        freeHoneyEvent() {
            ...
            this.outputText("She waves and stretches, picking up her pack and buzzing her wings as she takes off.  She blows a kiss over her shoulder and flies away, leaving you to return to your camp...", false);
            this.inventory.takeItem(this.consumables.PURHONY, this.camp.returnToCampUseOneHour);
        }
        seduceBeeGirl() {
            this.spriteSelect(6);
            ...
            if (this.player.gender == 3) {
                ...
                if (this.player.isTaur())
                    this.outputText(" leaning between your knees to reach your bulging member.\n\nShe drops to her own knees, gazing at your " + this.cockDescript(0) + " before", false);
                else
                    this.outputText(" continuing , sliding to the front of your pants to feel your bulging member.\n\nShe falls to her knees, sliding your cock free before", false);
                this.outputText(" running her tongue over the length. She slips her lips over the tip, gently sucking before sliding it entirely into her mouth. You can do little but moan, your hands gripping her head as she sucks and licks. Her hands squeeze the base of your shaft, stroking it", false);
                if (this.player.balls > 0)
                ...
                this.outputText("Pulling back, she releases your " + this.cockDescript(0) + ", now slick with her saliva. She lies on her back, her legs spread wide with he abdomen laying flat against the ground. Her hands urge you forward, and you follow immediately. Her body is soft and accepting, and you quickly slide the head of your " + this.cockDescript(0) + " into her pussy lips, a mutual moan escaping from both of your lips. Pushing further in, the bee-girl wraps her arms around you, holding you against her as you begin to thrust. Each push makes her wetter, the slickness making your cock slide faster and faster. She arches her back and you feel the tip of her stinger against your " + this.vaginaDescript(0) + ". Before you can protest, it pushes in, gently but quickly, until it pierces your cervix.\n\n", false);
                ...
                this.outputText("You can feel a pressure rising from the base of your cock. Thrusting deeply, you let out a howl as you cum, your cock spilling forth its sticky load into her, filling her pussy to the brim with your fluid.  ", false);
        ...
        beeRapesYou() {
            this.spriteSelect(6);
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_COMBAT_LOSSES]++;
            var sexed = false;
            ...
            if (this.player.isTaur()) {
                ...
                if (this.player.HP < 1) {
                    ...
                    this.outputText("With you thoroughly incapacitated, she walks up to your front and smears your " + this.chestDesc() + " with honey. The scent wafts up to your nose and your mind begins to go blank. Your tongue tries to reach for the sweet substance, but can't. You whimper at her, desperate for the taste of the mind altering honey. She obliges you by splashing some onto your face and you quickly begin lapping at it with your tongue.\n\n", false);
                    //Male with testicles:
                    if (this.player.gender == 1 && this.player.balls > 0) {
                        this.outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing " + this.sMultiCockDesc() + " to go rock hard.\n\n", false);
                        ...
                        this.outputText("Chitin covered arms begin stroking and scraping at you as you close your eyes as hard as possible, having exhausted your face of the mind numbing honey. Your pain and lust filled mind comes up with an idea and you quickly act; rubbing your sticky " + this.chestDesc() + " against the tree before swinging your head down violently and gnawing at it.\n\n", false);
                        this.outputText("The sensation proves too much for your massively engorged " + Appearance_1.Appearance.cockNoun(this.player.cocks[0].cockType) + " to take and you begin to shake violently, incapable of touching it as it's trapped underneath you and the weight of the bee-girls preventing you from getting the leverage needed to hump the hard ground.\n\n", false);
                        this.outputText("They seem to understand your problem though and, more out of a desire to not get tossed off than to help you with your needs, begin to kick at your " + this.ballsDescriptLight() + " with their feet.\n\n", false);
                    ...
                    //[Female:
                        ...
                        this.outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing your " + this.vaginaDescript(0) + " to squirt fluid behind you.\n\n", false);
                        ...
                        this.outputText("Your stomach churns as you see four more bee maidens appear out of the undergrowth, stingers exposed and glistening with a clear fluid. The bee on your back stabs with her own stinger and you turn away again, desperately licking at the honey in an attempt to deal with the awful heat in your lower body.\n\n", false);
                        this.outputText("Chitin covered arms begin stroking and scraping at you as you close your eyes as hard as possible, having exhausted your face of the mind numbing honey. Your pain and lust filled mind comes up with an idea and you quickly act; rubbing your sticky " + this.chestDesc() + " against the tree before swinging your head down violently and gnawing at it.\n\n", false);
                        this.outputText("The sensation proves too much for your massively engorged " + this.clitDescript() + " to take and you begin to shake violently, incapable of touching it as it's trapped underneath you and the weight of the bee-girls preventing you from getting the leverage needed to hump the hard ground.\n\n", false);
                    ...
                    //[Herm:
                        ...
                        this.outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing " + this.sMultiCockDesc() + " to go rock hard and your " + this.vaginaDescript(0) + " to squirt fluid behind you.\n\n", false);
                        ...
                        this.outputText("Your stomach churns as you see four more bee maidens appear out of the undergrowth, stingers exposed and glistening with a clear fluid. The bee on your back stabs with her own stinger and you turn away again, desperately licking at the honey in an attempt to deal with the awful heat in your lower body.\n\n", false);
                        this.outputText("Chitin covered arms begin stroking and scraping at you as you close your eyes as hard as possible, having exhausted your face of the mind numbing honey. Your pain and lust filled mind comes up with an idea and you quickly act; rubbing your sticky " + this.chestDesc() + " against the tree before swinging your head down violently and gnawing at it.\n\n", false);
                        this.outputText("The sensations prove too much for your massively engorged " + Appearance_1.Appearance.cockNoun(this.player.cocks[0].cockType) + " and sopping " + this.vaginaDescript(0) + " to take and you begin to shake violently, incapable of touching it as one is trapped underneath you with the weight of the bee-girl preventing you from getting the leverage needed to hump the hard ground and the other is hopelessly out of reach.\n\n", false);
                        this.outputText("They seem to understand your problem though and, more out of a desire to not get tossed off than to help you with your needs, begin to kick and punch at your " + this.vaginaDescript(0), false);
                        if (this.player.balls > 0)
                    ...
                    //[Genderless:
                        ...
                        this.outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing your " + this.assholeDescript() + " to wink.\n\n", false);
                        this.outputText("She can't see your " + this.assholeDescript() + ", of course, and pays no attention to your outbursts, instead busying herself with something on your back. A loud unpleasant buzzing fills the air and you manage to break free of the control of the honey long enough to twist around.\n\n", false);
                        this.outputText("Your stomach churns as you see four more bee maidens appear out of the undergrowth, stingers exposed and glistening with a clear fluid. The bee on your back stabs with her own stinger and you turn away again, desperately licking at the honey in an attempt to deal with the awful heat in your lower body.\n\n", false);
                        this.outputText("Chitin covered arms begin stroking and scraping at you as you close your eyes as hard as possible, having exhausted your face of the mind numbing honey. Your pain and lust filled mind comes up with an idea and you quickly act; rubbing your sticky " + this.chestDesc() + " against the tree before swinging your head down violently and gnawing at it.\n\n", false);
                        ...
                        this.outputText("They seem to understand your problem though and, more out of a desire to not get tossed off than to help you with your needs, begin to kick and punch at your " + this.assDescript() + ". The volley of blows is enough to stop you from shaking, but the pressure doesn't go away.\n\n", false);
                        this.outputText("The malevolent bee-girls continue their ministrations though, delighting in the way your body is reacting. The combination of the lust filled poisons, pain and shame at your utter defeat and humiliation drive you to black out, welcoming the blissful darkness.\n\n", false);
                ...
                //Lust:
                    ...
                    this.outputText("She tests the insides of your ass for a bit before pulling her arm out and your hind legs start to quake as your desires aren't satisfied. You feel her stroke your hindquarters, encouraging you to lie down. You happily do so, using the tree as support.  With you safely down, she walks up to your front and smears your " + this.chestDesc() + " with honey. The scent wafts up to your nose and your mind begins to go blank. Your tongue tries to reach for the sweet substance, but can't. You whimper at her, desperate for the taste of the mind altering honey. She obliges you by holding a handful of the thick elixir to your mouth and you lap at it eagerly. Once you've consumed a fair amount she spreads more onto your face and giggles cutely as you stretch your tongue to lick at it.\n\n", false);
                    //[Male with testicles:
                    if (this.player.gender == 1 && this.player.balls > 0) {
                        this.outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing " + this.sMultiCockDesc() + " to go rock hard.\n\n", false);
                        this.outputText("She can't see that, of course, and busies herself with inserting her ovipositor into your " + this.assholeDescript() + ". Its thick lubrication allows it quick entrance, and soon she's pumping her fluids into your bowels. The sensation proves too much for your massively engorged " + this.multiCockDescriptLight() + " to take and you begin to shake violently, incapable of touching ", false);
                        if (this.player.cockTotal() == 1)
                            this.outputText("it as it's ", false);
                        else
                            this.outputText("them as they're ", false);
                        ...
                        this.outputText("She seems to understand your problem though and, wanting to help you with your needs, begins to massage your " + this.ballsDescriptLight() + " with her 'feet'. As she does this she starts to hum, a sound that obliterates what few thoughts you had left and which causes her entire body to vibrate.\n\n", false);
                        ...
                        //[If huge cum amount:
                        if (this.player.cumQ() >= 1500)
                            this.outputText("Your massive cum amount soon causes you to be lying in a deep puddle of splooge, the scent so strong that it's almost enough to overwhelm that of the honey, despite it coating your face.\n\n", false);
                        this.outputText("She continues pumping into you as you pass out, " + this.sMultiCockDesc() + " and " + this.ballsDescriptLight() + " aching.  The combined scent of cum and honey completely overwhelms you.", false);
                    }
                    //[Male without testicles:
                    else if (this.player.gender == 1) {
                        this.outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing " + this.sMultiCockDesc() + " to go rock hard.\n\n", false);
                        this.outputText("She can't see that, of course, and busies herself with inserting her ovipositor into your " + this.assholeDescript() + ". Its thick lubrication allows it quick entrance, and soon she's pumping her fluids into your bowels. The sensation proves too much for your massively engorged " + Appearance_1.Appearance.cockNoun(this.player.cocks[0].cockType) + " to take and you begin to shake violently, incapable of touching it as it's trapped underneath you, and the weight of the bee-girl prevents you from getting the leverage needed to hump the hard ground.\n\n", false);
                        ...
                        this.outputText("She continues pumping into you as you pass out, " + this.sMultiCockDesc() + " aching and the scent of honey overwhelming you.\n\n", false);
                    }
                    //[Female:
                    else if (this.player.gender == 2) {
                        this.outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing your " + this.vaginaDescript(0) + " to squirt fluid behind you.\n\n", false);
                        this.outputText("She sees the spray and strokes your ass gently, but can do nothing to help as she busies herself with inserting her ovipositor into your " + this.assholeDescript() + ". Its thick lubrication allows it quick entrance, and soon she's pumping her fluids into your bowels. The sensation proves too much for your massively enflamed " + this.vaginaDescript(0) + " and you begin to shake violently, incapable of touching yourself and alleviating the dreadful pressure. Your " + this.clitDescript() + " begins to throb painfully as it swells larger than normal.\n\n", false);
                        this.outputText("She seems to understand your problem though and, wanting to help you with your needs, begins to stroke your " + this.vaginaDescript(0) + " with her 'feet'. As she does this she starts to hum, a sound that obliterates what few thoughts you had left and which causes her entire body to vibrate. This combined with the handful of times her chitin covered appendages slide across your " + this.clitDescript() + " cause you to cum hard, squirting behind you with surprising force.\n\n", false);
                        //[Huge cum amount:
                        if (this.player.wetness() == 5)
                            this.outputText("Your massive cum amount soon causes you to be lying in a deep puddle of femcum, the scent so strong that it's almost enough to overwhelm that of the honey, despite it coating your face.\n\n", false);
                        this.outputText("She continues pumping into you as you pass out, your entire rear aching and the combined scent of cum and honey overwhelming you.", false);
                    }
                    //[Herm:
                    else if (this.player.gender == 3) {
                        this.outputText("She returns to your rear end and assesses it some more. With an almost desperate scrabbling she climbs on top of you, jabbing you repeatedly with her outstretched stinger and causing " + this.sMultiCockDesc() + " to go rock hard and your " + this.vaginaDescript() + " to squirt fluid behind you.\n\n", false);
                        this.outputText("She can't see your cock, of course, and while she sees the spray and strokes your ass gently, can do nothing to help as she busies herself with inserting her ovipositor into your " + this.assholeDescript() + ". Its thick lubrication allows it quick entrance, and soon she's pumping her fluids into your bowels.\n\n", false);
                        this.outputText("The sensation proves too much for your massively engorged " + Appearance_1.Appearance.cockNoun(this.player.cocks[0].cockType) + " and " + this.vaginaDescript(0) + " to take and you begin to shake violently, incapable of touching it as one is trapped underneath you with the weight of the bee-girl preventing you from getting the leverage needed to hump the hard ground and the other is hopelessly out of reach.\n\n", false);
                        this.outputText("She seems to understand your problem though and, wanting to help you with your needs, begins to massage your " + this.vaginaDescript() + " with her 'feet' while periodically stroking the back of your " + this.cockDescript(0) + ".\n\n", false);
                        this.outputText("As she does this she starts to hum, a sound that obliterates what few thoughts you had left and which causes her entire body to vibrate. This combined with the handful of times her chitin covered appendages slide across your " + this.clitDescript() + " cause you to cum hard, squirting behind you with surprising force and splattering your underside with jism.\n\n", false);
                        //[If huge cum amount:
                        if (this.player.cumQ() >= 1500)
                            this.outputText("Your massive cum amount soon causes you to be lying in a deep puddle of splooge and femcum, the scent so strong that it's almost enough to overwhelm that of the honey, despite it coating your face.\n\n", false);
                        this.outputText("She continues pumping into you as you pass out, your entire rear aching and the combined scent of cum and honey overwhelming you.", false);
                    }
                    //[Genderless:
                    else {
                ...
                //Male + venomz
                if ((this.player.findStatusAffect(StatusAffects_1.StatusAffects.ParalyzeVenom) >= 0 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.lustvenom) >= 0) && !sexed && this.player.cockTotal() == 1) {
                ...
                if (this.player.gender == 1) {
                    if (this.player.lust >= 100)
                        this.outputText("Overcome by lust, you throw yourself into her waiting arms.  ", true);
                    else
                        this.outputText("Overcome by your wounds, you are unable to resist as she lifts you into her arms and embraces you.  ", true);
                ...
                if (this.player.gender == 2) {
                    if (this.player.lust < 100)
                        ...
                        this.outputText("Overcome with desire, you look up as the bee approaches.  ", true);
                    ...
                    this.outputText("A sharp pain hits your stomach as the bee-girl's stinger penetrates your flesh. Before you can cry out, a sickening warmth floods from the wound, washing away the pain and oozing through your body. Your " + this.vaginaDescript(0) + " juices flow between your ", false);
                    if (this.player.isTaur())
                        this.outputText("rear legs", false);
                    else
                        this.outputText("legs", false);
                    ...
                    if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR) {
                        this.outputText("She slips further down your chest, grabbing your " + this.player.allBreastsDescript() + " playfully. You feel her knee nudging against your " + this.vaginaDescript(0) + ", grinding roughly against it and sending shivers through your body. You yelp slightly as she bites one of your nipples, the sudden sensation giving way to moans of pleasure as she massages and pinches the other one. Her knee slides against your " + this.vaginaDescript(0) + ", flicking your " + this.clitDescript() + " and coating the bee-girl with your juices. You feel her straddle your legs, her feet deftly pulling your thigh into contact with her pussy, before she starts to rock against you.\n\n", false);
                        this.outputText("Her juices mix with your own as you feel yourself working steadily to climax. Noticing your heavy breathing and sudden vigor, she pulls away.  ", false);
                    }
                    ...
                    if (this.player.isTaur())
                        this.outputText("After a while, her hot and sweet pussy swiftly disappears from your sight, and you feel the bee-girl's weight on your butt, right before her stinger,", false);
                    else
                        this.outputText("You feel the bee-girl's stinger", false);
                    this.outputText(" sliding against your nether-lips, pushing against them and parting the outer folds. Her abdomen shifts, shifting the stinger up and down, keeping your " + this.vaginaDescript(0) + " parted while rubbing your clit.\n\n", false);
                    if (this.player.isTaur())
                        this.outputText("Suddenly, you feel a sharp pain right into your clit, followed by a sexual warmth so intense this time, that it engulfs you and turns you into a sex-craving slut.  Anticipating the effect, she repositions her honeyed pussy over your face.  You begin to lick, suck and kiss it frenetically, burying your tongue into her deepest recesses.  She giggles at first, but soon the only noises you hear from her are moans becoming more and more intense. As her arousal shoots through the roof, you feel her legs twitching, and she suddenly grabs your head and forces your face into her crotch. You continue eating her out voraciously, oblivious to secondary things like breathing.\n\n", false);
                    else
                        this.outputText("Your moans are muffled by the honeyed pussy on your face, and you hear her starting to squeal loudly. Her thighs clamp tightly around your ears, grinding harder into your face as her stinger picks up the pace.  ", false);
        ...
        rapeTheBeeGirl() {
            this.spriteSelect(6);
            this.flags[kFLAGS_1.kFLAGS.BEE_GIRL_COMBAT_WINS_WITH_RAPE]++;
            // var sexed: boolean = false;
            this.outputText("With your mind made up, you approach the ", true);
            if (this.monster.HP <= 0)
                this.outputText("helpless ", false);
            else
                this.outputText("horny ", false);
            this.outputText("bee-girl with a devilish smile painted across your face.\n\nHow will you take her?\n\n", false);
            //OPTIONS HERE!
            var naga = undefined;
            ...
            var eggs = undefined;
            if (this.player.canOvipositSpider() && (this.player.faceType == appearanceDefs_1.FACE_SNAKE_FANGS || this.player.faceType == appearanceDefs_1.FACE_SPIDER_FANGS)) {
            ...
            if (this.player.cockTotal() > 1) {
                this.outputText("(You could use more than one of your " + this.multiCockDescriptLight() + " on her.)\n", false);
                multiCock = this.rapeTheBeeMultiCockStuff;
            }
            if (this.player.hasVagina()) {
                this.outputText("(You could make her get off your " + this.vaginaDescript() + ".)\n", false);
                vagina = this.rapeABeeGirlWithYourVagina;
            }
            if (this.player.gender == 3) {
                this.outputText("(You could try to please both your 'male' and 'female' halves on the bee.)\n", false);
                herm = this.futaRapesBeeGirl;
            }
            if (this.player.isNaga() && this.player.faceType == appearanceDefs_1.FACE_SNAKE_FANGS) {
                this.outputText("(You could focus on your snakelike, 'naga' attributes.)\n", false);
                naga = this.corruptNagaBitchesRapeABee;
            }
            if (this.player.cor >= 75 && this.player.str >= 60 && (this.player.tongueType == appearanceDefs_1.TONUGE_SNAKE || this.player.hasCock() || this.player.hasVagina() || this.player.biggestTitSize() >= 4)) {
            ...
            this.choices("Use Cock", cock, "Use Cocks", multiCock, "Use Vagina", vagina, "Herm Style", herm, "Naga", naga, "Self-Egg", gentleman, "", undefined, "", undefined, "LayYourEggs", eggs, "", undefined);
        }
        rapeTheBeeMultiCockStuff() {
            ...
            if (this.player.cockTotal() >= 5 && this.player.biggestTitSize() > 2
                && this.player.vaginas.length > 0 && BeeGirlScene.rand(2) == 0) {
                this.outputText("As you approach, she starts to edge away, her battered wings flapping in a futile attempt to escape.  Reaching her, you grip her wrists before she can fight back, squeezing tightly as her struggling increases. Forcing her onto her back, you hold her wrists tightly in one hand to allow you to pull off your " + this.player.armorName + ", freeing your " + this.multiCockDescript() + " and " + this.vaginaDescript(0) + ".  She gasps at the alien sight of your multiple 'stingers', while you take a moment to decide what's going to go where.\n\n", false);
                this.outputText("You shift a bit upward, your brace of " + this.multiCockDescriptLight() + " sliding above the bee-girl's slick honey pot.  For a moment she breathes a sigh of relief, then gasps as two of your manhoods press against her front and back doors at once.\n\n", false);
                ...
                this.outputText("Unhindered, you start to fuck her.  Her pussy tightens and convulses around your " + this.cockDescript(0) + ", her ample honey dribbling down onto your lowermost shaft and adding a little more lube on every thrust into the tight heat of her ass.  Her whimpers turn to moans, her scent shifting from fear to lust as the bee-girl discovers the unexpected pleasure of being reamed in both holes at once.  You keep your breathing steady, listening to her moans grow more lustful with every thrust and more needy every time you pull back in preparation for another.  Soon you've fucked all thought of resistance out of her, in favor of squealing with glee every time your mighty cock forces a little deeper into her tight honey pot.\n\n", false);
                this.outputText("Letting go of her arms, you grip the base of her abdomen for leverage and let her arms and legs slide around you as your pace increases.  You show her how to press her breasts together against your " + this.cockDescript(0) + ", and she obliges, rubbing them back and forth as you fuck her.  With your jiggling breasts added to the mix, it becomes even more enjoyable, your " + this.breastDescript(0) + " mashing against hers.  The milk leaking out of your immense jugs runs down your bodies and adds further to the ocean of fluids forming between your hips.\n\n", false);
                this.outputText("The heads of your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " rub back and forth against the bee-girl's lips and face, and finally curiosity leads her to begin tasting, her surprisingly long tongue lassoing and swirling around every tip she can reach in turn, darting from one to another as if tasting flowers to provide an experience almost as unique as her pussy.\n\n", false);
            ...
            if (this.player.cockTotal() == 2 && BeeGirlScene.rand(2) == 0) {
                this.outputText("The bee-girl turns around, scampering across the floor to try to escape. As you close in to your prey you can feel your " + this.multiCockDescriptLight() + " harden and rise up at the sight of her form and you swiftly grab on to her abdomen and hold fast. She screams in futility as you flip her over and greedily look across her body.\n\n", false);
                this.outputText("Forcing her onto her back, you hold her wrists tightly in one hand to allow you to pull off your " + this.player.armorName + ", freeing your " + this.multiCockDescriptLight() + ". The bee-girl opens her eyes for a scant moment and realizes what's about to happen. She tries one more time to plead for you to let her escape as your " + this.multiCockDescriptLight() + " slide up and down against her nectar-drenched pussy lips. Your grin widens as you penetrate her roughly in one savage stroke, taking her with one of them. Screaming and squirming, the bee-girl struggles.  Your right hand braces against her flapping arms to settle them to the ground as you push in once again. Letting her know just how little control she has against your will, you lean forward, planting her hands against the ground and licking her cheek as your " + this.multiCockDescriptLight() + " push up deep inside her. Looking into her eyes, you see a faint glimmer of defiance, and under your body you feel her shifting slightly, muscles growing firm and tense. The realization hits you, and you manage to shift before her stinger comes into contact with you. Moving your knee, you pin her thick ", false);
                ...
                this.outputText("You decide that it's time to bring your other gift into play. Atop the bee-girl you fire in one more stroke of your " + this.cockDescript(0) + " and then you run your free hand from her black lips across her breast and across her abdomen before you rest it on her clit. You tweak her sensitive spot along with the strokes from your intruding member and then when the rush of nectar and cum juices from her pussy seem up to the task you grab hold of your other " + this.cockDescript(1) + " and forcefully ram it into her pussy right below your first entry.\n\n", false);
        ...
        rapeTheBeeGirlWithADick() {
            ...
            if (this.player.isTaur()) {
                ...
                this.outputText("Pulling back, you consider her for a moment. She watches as you slip out of your " + this.player.armorName + ", licking her lips at the sight of your " + this.chestDesc() + ". Once your torso is free you reach down again and pick up the bee maiden. She's surprisingly light and you lift her with ease, feeling her legs wrap around you as you hug and kiss her.\n\n", false);
                ...
                this.outputText("The sweet substance causes your hindquarters to heat up. You feel your " + this.assholeDescript() + " pucker and " + this.sMultiCockDesc() + " grow, dripping pre onto the ground. At the same time, your thoughts start to get fuzzy and you have to fight off the sensation to throw the bee down and fuck her wildly.\n\n", false);
                ...
                if (this.player.cockArea(x) <= this.monster.vaginalCapacity()) {
                    this.outputText("She looks under your arm toward your manhood and seems delighted by the sight of your " + this.cockDescript(x) + ". Her body swings about your torso with the help of her wings and she crawls down your back toward your rear. You lift your tail and allow the bee maiden to examine your " + this.assholeDescript() + ", sliding her fingers around the edge and teasing at it.", false);
                    //Has testicles:
                    if (this.player.balls > 0)
                        this.outputText("  Her other hand slides down and begins to massage your " + this.ballsDescriptLight() + ", squeezing and tugging gently at your scrotum. Her tongue joins them, sliding in and out of your ass before wrapping around your sack. You feel incredible and your " + this.cockDescript(x) + " drips pre, forming a puddle on the ground.", false);
                    //No testicles:\
                    else
                        this.outputText("Her other hand starts pulling it open and soon her tongue joins them, sliding in and out of your ass delicately. Your " + this.cockDescript(x) + " quivers with anticipation and you swish your tail happily.", false);
                    this.outputText("\n\n", false);
                    ...
                    this.outputText("You get your answer as a hot, wet, vice wraps around your " + this.cockDescript(x) + " and whatever is inside your ass pushes slightly further in. It feels good, but you know that even with her surprising strength she wouldn't be able to hold on if you tried driving into her. Thinking this defeats the purpose somewhat you're about to propose that some other arrangement be considered when she starts to buzz.\n\n", false);
                    ...
                    this.outputText("The sensation is incredible; her muscles spasm and milk your " + this.cockDescript(x) + " while the object in your " + this.assholeDescript() + " (which you think is probably her ovipositor) begins pumping fluids into you, all while your genitals are vibrated unceasingly.", false);
                    //Has testicles:
                    if (this.player.balls > 0)
                        this.outputText("  Your " + this.ballsDescriptLight() + " really feel spectacular, the vibrations causing the hot spunk inside to roil about.", false);
                    ...
                    //has testicles: 
                    if (this.player.balls > 0)
                        this.outputText(", and your " + this.ballsDescriptLight() + " constrict", false);
                    this.outputText(".\n\n", false);
                    this.outputText("Your seed is propelled through your pulsating " + Appearance_1.Appearance.cockNoun(this.player.cocks[x].cockType) + " with surprising force.", false);
                    //No testicles: 
                    if (this.player.balls == 0)
                        this.outputText("  It dribbles into the bee-girl as her honey squirts out of her once again. Her body trembles as the extreme exertions take their toll, and she slides off of your member with a damp plop, splashing into a puddle of her own fluids.", false);
                    else {
                        //Normal cum amount: 
                        if (this.player.cumQ() < 500)
                            this.outputText("  It sprays inside the bee-girl as her honey squirts out of her once again. Her body trembles as the extreme exertions take their toll, and she slides off of your member with a damp plop, splashing into a puddle of her own fluids as your spunk dribbles onto her.", false);
                        //Huge cum amount:
                        else
                            this.outputText("  It sprays inside the bee-girl, quickly overfilling her and causing her belly to expand. Her sudden increased girth and the extreme exertion cause her to lose her grip on you, and she is propelled off of you into a puddle of spunk and honey. You can't control yourself as your " + this.ballsDescriptLight() + " continue to pump out more and more fluid, spraying down the exhausted bee and coating her flower with enough gunk to cause it to wilt slightly. Eventually it stops, with only periodic gushes spraying out.", false);
                    }
                    this.outputText("\n\n", false);
                    this.outputText("Once you've come down from your incredible orgasm your attention shifts to the exhausted bee maiden beneath you. You take pity on her and pick up the giant bee as gently as possible. She hums gently in your arms as you carry her over to her flower, sliding her onto it", false);
                    //Huge cum amount:
                    if (this.player.cumQ() >= 500)
                        this.outputText(" and watching as her lower body sinks into your spunk like a thick white bath", false);
                ...
                //Cock too long to penetrate her:
                    ...
                    this.outputText("She looks under your arm toward your manhood but seems disappointed at your " + this.cockDescript(x) + "'s large size. . Her body swings about your torso with the help of her wings and she crawls down your back toward your rear. You lift your tail and allow the bee maiden to examine your " + this.assholeDescript() + ", sliding her fingers around the edge and teasing at it. Her tongue licks at you but you can tell her mind is elsewhere and you wonder what the problem is.\n\n", false);
                    ...
                    this.outputText("She doesn't though, as with a buzz her body swings about beneath you. As she slides sideways, one arm is pulled off for a moment, long enough to catch your " + this.cockDescript(x) + " between her body and your own, before catching onto your other flank. Her abdomen slides up behind your rear legs and you feel something latch onto your " + this.assholeDescript() + ", but are unable to do anything about it or even see what it is.\n\n", false);
                    ...
                    //Has testicles: 
                    if (this.player.balls > 0)
                        this.outputText("  The vibrations do a number on your " + this.ballsDescriptLight() + " too, as the semen stored within starts to shake and dance about inside.", false);
                    ...
                    //Other cocks: 
                        ...
                        this.outputText("  Her tongue wraps around your " + this.cockDescript(x) + " and slides up and down the small area it can reach before flicking about at the tip of your urethra. Her expert licking feels amazing and it's not long before your feel the familiar sensation of orgasm creeping up on you.", false);
                    this.outputText("\n\n", false);
                    this.outputText("With all the combined sensations your " + this.cockDescript(x) + " begins to unload. ", false);
                    ...
                    if (this.player.balls > 0 && this.player.tallness * (5 / 6) < this.player.cocks[this.player.longestCock()].cockLength) {
                        ...
                        if (this.player.cumQ() >= 750)
                            this.outputText("  You don't stop there though, as your firehose of a cock sprays it down until it's sagging with the weight of your seed.", false);
                    }
                    //With testicles, other cocks:
                        ...
                        //Huge cum amount: 
                        if (this.player.cumQ() >= 750)
                            this.outputText("  You don't stop there though, as your firehose of a cock sprays wildly, coating her head and her flower, hosing it down until it's sagging with the weight of your seed.", false);
                    }
                    //Without testicles: 
                    else
                        this.outputText("Your " + this.assholeDescript() + " tightens uncontrollably around its intruder, making the vibrations feel even stronger there. Your member jerks as you orgasm and a few droplets of semen land on the bee maiden.", false);
                ...
                this.outputText("Firmly grasping her thighs at the joining of her smooth carapace and soft skin, you force them open, revealing the source of her irresistible scent.   She buzzes pitifully in protest ", false);
                if (this.player.isTaur())
                    this.outputText("as your " + this.cockDescript(x) + " hardens under your belly.", false);
                else
                    this.outputText("as you disrobe, revealing your " + this.cockDescript(x) + " to her.", false);
                this.outputText("  Wasting no time, you get down to the business of ", false);
                if (this.player.cockTotal() == 1)
                    this.outputText("penetrating her slick snatch, forcing in inch after inch.  ", false);
                if (this.player.cockTotal() == 2)
                    this.outputText("cramming your " + this.multiCockDescript() + " into her, double-stuffing the poor bee-slut with your double dongs.  ", false);
                if (this.player.cockTotal() >= 3)
                    this.outputText("cramming two out of your " + BeeGirlScene.num2Text(this.player.cockTotal()) + " " + this.multiCockDescript() + "s into her, double-stuffing the poor bee-slut with double the dicks.  ", false);
                ...
                //sex
                this.outputText("You begin pounding away at her, splattering honey over her thighs with your enthusiastic fucking.  Her passage is unlike anything you've ever had before.  It's tight, but overly slick and textured with small nubs and bumps that tease and caress in wonderful ways.   Her muscles clamp and squeeze her vaginal entrance tightly, turning it into an organic cock-ring.  You hold still while her cunt begins twitching and slightly rotating back and forth around your " + this.cockDescript(x) + ".    Her head is thrown back in what you assume is an orgasm, her arms mashing her tits together for even more pleasure.  The vacuum seal around your " + this.cockDescript(x) + " only gets tighter as her rippling, squeezing, twisting cunt stimulates your over-engorged " + this.cockDescript(x) + ".\n\n", false);
                //cum
                ...
                if (this.player.gender == 3 && this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                    this.outputText("  You reach down and finger your " + this.vaginaDescript(0) + " roughly, lost in the throes of your orgasm.", false);
                this.outputText("\n\n", false);
                //wind down
                ...
                if (this.player.cumQ() >= 250 && this.player.cumQ() < 500)
                    this.outputText("You smile proudly at the steady stream of your cum that pours from her abused cunt, pooling underneath her.   Her abdomen even looks bloated with your seed.", false);
                if (this.player.cumQ() >= 500 && this.player.cumQ() < 1000)
                    this.outputText("You smile proudly at your handy-work, noting how bloated and distended the bee's abdomen is.  It bulges obscenely, nearly double its previous size.  A sizable river of your spunk drools from between your legs, but amazingly she seems able to keep most of your over-sized orgasm in.", false);
                if (this.player.cumQ() >= 1000)
                    this.outputText("You giggle at your poor victim's state.  She really is a mess.  Her abdomen and belly are both swollen, making her look pregnant in both her bee AND human halves.   A practical river of spunk drools from her glossy pussy-lips, pooling below her.  Even her ovipositor dangles down, dripping with your seed, forced out from her abdomen by the sheer amount of spunk she's carrying.  It twitches, bulges moving along its length, eventually dropping egg after egg on the ground, unable to keep in its cargo.", false);
                this.player.orgasm();
                this.cleanupAfterCombat();
            }
            //Male 2
            else {
                this.outputText("As you approach she starts to edge away, her battered wings flapping in a futile attempt to escape.  Reaching her, you grip her wrists before she can fight back, squeezing tightly as her struggling increases. Forcing her onto her back, you hold her wrists tightly in one hand to allow you to pull off your " + this.player.armorName + ", freeing your erect member.  ", false);
                this.outputText("You begin to push forward, sliding your " + this.cockDescript(x) + " against the soft folds of her pussy, her whimpers shifting gently into moans. Your grin widens as you penetrate her roughly in one strong stroke, the bee-girl's body tensing underneath you as a squeal leaves her lips. Looking into her eyes, you see a faint glimmer of defiance, and under your body you feel her shifting slightly, muscles growing firm and tense. The realization hits you, and you manage to shift before her stinger comes into contact with you. Moving your knee, you pin her thick abdomen down and remove the threat.\n\n", false);
                this.outputText("Unhindered, you start to fuck her. Her pussy tightens and convulses around your cock, becoming slick with her juices and your pre-cum. You can smell the sickly combination of nectar, sweat and love juices hanging thickly in the air. Your breathing becomes heavy while her moans get deeper and lust-filled. Her reluctance evaporates, her struggling shifts into more receptive movements against your body, her hips rocking against yours with each thrust, forcing your " + this.cockDescript(x) + " deeper into her tight honeypot.\n\n", false);
                this.outputText("Letting go of her arms, you grip the base of her abdomen for leverage and let her arms and legs slide around you as your pace increases. You feel her abdomen pressing against your rear as you drive into her, the pressure in your " + this.ballsDescriptLight() + " building as her pussy tightens around you. With a groan you cum, your hot seed gushing inside of her. She clenches you tightly, her pussy milking your " + this.cockDescript(x) + " for every ounce, until the sticky white fluid is pouring from around your " + this.cockDescript(x) + ". Exhausted from the battle and the fuck, she relaxes and collapses on the ground, panting heavily and half-conscious.", false);
                this.player.orgasm();
                this.cleanupAfterCombat();
            }
        }
        ...
        rapeABeeGirlWithYourVagina() {
            ...
            if (this.player.isTaur()) {
                this.outputText("The bee-girl plops onto her flower with her legs splayed out, letting you get a clear look at her dripping honeypot. She watches you nervously as you approach, letting her stinger slide out in a pointless threat. She seems taken aback when you smile down at her, but returns the gesture with a nervous smile of her own.\n\n", false);
                this.outputText("You make your intentions clear by sliding the " + this.player.armorName + " from your torso and stroking your " + this.chestDesc() + ". As you slide your hands around your chest and play with your " + this.nippleDescript(0) + "s, you begin to moan sensually. Your own ministrations cause your " + this.vaginaDescript(0) + " to heat up and you feel small dribbles of femcum slowly slide down your hind legs. Responding to your arousal, your tail starts to wave about on its own to spread your musky scent and your " + this.assholeDescript() + " begins to open and close.\n\n", false);
                ...
                //[Fuckable nipples: 
                if (this.player.hasFuckableNipples())
                    this.outputText("  Not even repeated penetration of your " + this.nippleDescript(0) + "s seems to bring the relief you need.", false);
                this.outputText("\n\n", false);
                ...
                if (this.player.biggestTitSize() > 4)
                    this.outputText("Her legs release your head and she falls back, knocking into your " + this.player.allBreastsDescript() + " and causing them to jiggle lewdly. You grab her before she hits the ground, surprised at how light she is.", false);
                //[Breasts <=C: 
                else
                    this.outputText("Her legs release and she falls back, but you catch her before she hits the ground and are surprised by how light she is.", false);
                ...
                if (this.player.hasLongTail())
                    this.outputText(" and your flailing tail is held firmly in place by her hand", false);
                ...
                if (this.player.ass.analLooseness >= 2)
                    this.outputText("  Not wanting this, she attempts to brace her other hand between your " + this.assDescript() + "'s cheeks, but your " + this.assholeDescript() + " opens and she slides inside. With an immense effort she pulls out of your ass, nearly pushing you over the edge in the process, but the arm stuck on your vagina is stuck tight.", false);
                this.outputText("  It's not long before her hand finds your uterus and begin probing it, pushing you beyond your limit.\n\n", false);
                //[Huge cum amount: 
                if (this.player.wetness() >= 5)
                    this.outputText("Your vagina ripples and squeezes with enough force to hurt most normal cocks. Her exoskeleton protects her from the harmful effects though, and with a massive gush of fluids the bee-girl's arm is propelled out of you.", false);
                //[All other cum amounts: 
                else
                    this.outputText("Your vagina ripples and squeezes with enough force to hurt most normal cocks. Her exoskeleton protects her from the harmful effects though, and she slides her arm out of you as you cum.", false);
                ...
                this.outputText("You trot up to the flower and slide the exhausted creature off of you, then rearrange her to be more comfortable. With a final pat on the head and after collecting your things, you head back to camp on slightly wobbly legs.", false);
            }
            else {
                this.outputText("Firmly grasping her thighs at the joining of her smooth carapace and soft skin, you force them open, revealing the source of her irresistible scent.   She buzzes pitifully in protest as you disrobe, revealing your " + this.vaginaDescript(0), false);
                if (this.player.breastRows.length > 1)
                    this.outputText(" and " + this.player.allBreastsDescript(), false);
                this.outputText(".  You waste no time, pushing her down and draping yourself across her body.  You let your ready sex bump her chin as you push her thighs further apart and drink in the scent of her woman-hood.   Mashing your " + this.vaginaDescript(0) + " against her face, you make it very clear what she is to do, and thankfully, the bee-bitch gets the idea and starts licking.  You coo in pleasure, delighted at the length and texture of her tongue as she goes to work.  ", false);
                if (!this.player.isTaur()) {
                    ...
                    //new PG
                    this.outputText("The taste is sweet and sexy all at once, and you quickly lose track of your reward scheme, simply licking and slurping to get as much of her nectar as possible.  ", false);
                }
                //new PG
                else
                    this.outputText("\n\n", false);
                if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_SLICK)
                    this.outputText("Thankfully her tongue keeps up its assault, curling 'round your clit and probing your depths in equal measure, keeping you slick and writhing in pleasure.  ", false);
                if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_SLICK && this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_SLAVERING)
                    this.outputText("Your hips wiggle and writhe on the length of her tongue as it dives into your slippery depths and curls tightly around your clit, jacking it up and down like a cock.  Your girl-cum soaks her chin, drooling happily as she pleasures you.  ", false);
                if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_SLAVERING)
                    this.outputText("Your hips quiver and grind against her face as her unusually long tongue simultaneously probes your depths and works your clit, wrapping around it and jerking it like a cock.   You squirt and drool constantly from her skilled assault, soaking her face and hair with your girl-cum.  ", false);
                if (this.player.clitLength > 3 && this.player.clitLength < 5)
                    this.outputText("Your hips piston your huge clit into her mouth with no warning, forcing her to give your clit a blowjob.  Her slick black lips wrap around it immediately, sucking and licking, filling your body with lust and pleasure.  ", false);
                ...
                //New PG - orgasm
                if (this.player.isTaur())
                    this.outputText("You orgasm in no time, coating her face with girl-cum the process.  You return the favor and dive into her muff, planting kisses and licks down as a reward for your victim's rather skilled efforts.  The taste is sweet and sexy all at once, and you quickly lose track of your reward scheme, simply licking and slurping to get as much of her nectar as possible until she is satisfied as well.", false);
                else
                    this.outputText("In no time you both orgasm, sweet girl-cum coating both your faces as you work each other's cunt with desperation born of desire.  ", false);
            }
            this.player.orgasm();
            this.cleanupAfterCombat();
        }
        ...
        futaRapesBeeGirl() {
            ...
            this.outputText("Firmly grasping her thighs at the joining of her smooth carapace and soft skin, you force them open, revealing the source of her irresistible scent.   She buzzes pitifully in protest ", false);
            if (this.player.isTaur())
                this.outputText("as you idly fondle your " + this.player.allBreastsDescript() + " as you feel your blood-gorged " + this.multiCockDescriptLight() + " swaying under your belly.  ", false);
            else
                this.outputText("as you disrobe, revealing your " + this.player.allBreastsDescript() + ", " + this.vaginaDescript(0) + ", and " + this.multiCockDescriptLight() + ".  ", false);
            this.outputText("You step forwards, straddling her and rubbing your outer lips in preparation.  ", false);
            if (this.player.vaginas[0].vaginalWetness <= appearanceDefs_1.VAGINA_WETNESS_NORMAL)
                this.outputText("Your " + this.vaginaDescript(0) + " becomes puffy and moist with excitement, ready for what you have planned.", false);
            if (this.player.vaginas[0].vaginalWetness > appearanceDefs_1.VAGINA_WETNESS_NORMAL && this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                this.outputText("Your " + this.vaginaDescript(0) + " squicks wetly from your gentle ministrations as your vulva become sensitive and engorged.", false);
            if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                this.outputText("Your " + this.vaginaDescript(0) + " gushes in response, dripping steadily over your victim's face, covering it with a spattering of girl-cum.", false);
            //New PG
            ...
            if (this.player.balls >= 2) {
                if (this.player.ballSize < 5)
                    this.outputText("Your " + this.ballsDescriptLight() + " droop into her eyes, blinding and humiliating her in equal measure.  ", false);
                else
                    this.outputText("Your " + this.ballsDescriptLight() + " obscure most of her face, making it difficult to see her reactions, but her mouth gives you all the feedback you need.  It doesn't take more than a few moments for her struggles to cease, and soon, her long insectile tongue is worming its way into your " + this.vaginaDescript(0) + ".  ", false);
            }
            this.outputText("Happy with your victim's compliance, you grind harder into her face.  Allowing your hands a bit of freedom, you begin to stroke your already erect " + this.cockDescript(0), false);
            if (this.player.cumQ() < 75)
                this.outputText(", enjoying the chance to cut loose and explore your male half.  ", false);
            if (this.player.cumQ() >= 75 && this.player.cumQ() < 500)
                this.outputText(", smearing your hardness in copious pre-cum and reveling at the marvelous sensation it gives you.  ", false);
            if (this.player.cumQ() >= 500)
                this.outputText(".  A few drops of your pre manage to drip onto her face, mixing with the fluids from your cunt.  ", false);
            this.outputText("You nearly bounce off her in alarm as her tongue probes deep, pressing against and penetrating your cervix in one slippery stroke.  Being licked from the inside out makes you squeal with equal parts surprise and pleasure, and you mash your " + this.vaginaDescript(0) + " harder against her in response.  Your hands masturbate your " + this.multiCockDescriptLight() + " in time with her licks, the speed gradually increasing to keep pace with the fire of your ever-growing lust.  ", false);
            if (this.player.cumQ() >= 100) {
                this.outputText(" More and more pre begins to drip from your " + this.cockDescript(0) + ", soaking your ", false);
                if (this.player.balls >= 2)
            ...
            if (this.player.breastRows.length > 0) {
                if (this.player.biggestTitSize() >= 2)
                    this.outputText("You free a hand to tend to your " + this.player.allBreastsDescript() + " and aching nipples, alternating between squeezing your female flesh and tugging on your erect nipples.  ", false);
            }
            this.outputText("\n\n", false);
            //New PG
            this.outputText("You moan in ecstasy, your " + this.vaginaDescript(0) + " clamping against her tongue and lips like a vice.  She responds by pulling it from your uterus and swirling it around the inside of your " + this.vaginaDescript(0) + " to stimulate the walls of your trembling love-canal.  ", false);
            if (this.player.breastRows.length > 0) {
                if (this.player.biggestTitSize() >= 2) {
                    this.outputText("You pinch a nipple hard", false);
                    //Lactation junction!
                    if (this.player.biggestLactation() > 1 && this.player.biggestLactation() <= 2)
                        this.outputText(", squirting milk all over the bee-girl's midsection.  ", false);
                    if (this.player.biggestLactation() > 2 && this.player.biggestLactation() <= 3)
                        this.outputText(", spraying milk all over your bee-bitch, soaking her completely with your milky-white goodness.  ", false);
                    if (this.player.biggestLactation() > 3)
                        this.outputText(", hosing milk everywhere, soaking the bee-girl completely.  The force of your orgasm seems to echo through your breasts, making them produce far more milk than normal.  ", false);
                    if (this.player.biggestLactation() <= 1)
                        this.outputText(".  ", false);
                }
            }
            if (this.player.balls >= 2)
                this.outputText("The warmth and pleasurable pressure of your male orgasm builds in your " + this.ballsDescriptLight() + ", growing stronger as it migrates up your groin to the base of your pulsing member.  You squeeze your " + this.cockDescript(0) + " tightly, trying to hold on a bit longer, but the squirming tongue inside you is too much.  ", false);
            //Mmmmmmangasm!
            if (this.player.isTaur())
                this.outputText("As you're going to explode, you smile evilly as an idea crosses your mind. You turn around swiftly, leaving her surprised and still in the position of licking your pussy, her slender and squirming tongue out, and her face covered in girl-cum.  ", false);
            if (this.player.cumQ() < 25) {
                this.outputText("You erupt, your " + this.cockDescript(0) + " pulsing and spraying ribbons of cum.  You milk your dick hard, pistoning your hand up and down mercilessly, trying to squeeze out every drop.  You watch each burst splatter into the bee-girl's hair and grin cruelly.  ", false);
                if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                    this.outputText("Spent at last, you rise up off of her, shivering as her tongue retracts from your woman-hood.", false);
            }
            if (this.player.cumQ() >= 25 && this.player.cumQ() < 250) {
                this.outputText("You erupt, your " + this.cockDescript(0) + " pulsing in your hands and spraying out thick ribbons of cum.  You milk your dick hard, pistoning it relentlessly as it spurts more and more jism.  The orgasm drags on and on, your cum soaking your poor victim's hair and forehead with your sticky white juices.   Satisfied at last, ", false);
                if (this.player.balls >= 2)
                    this.outputText("with empty balls, ", false);
                if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                    this.outputText("you rise up off her, shivering as her slender and squirming tongue retracts from your " + this.vaginaDescript(0) + ".", false);
                else
                    this.outputText("you walk away from her smiling, and sated.", false);
            }
            if (this.player.cumQ() >= 250 && this.player.cumQ() < 500) {
                this.outputText("Your " + this.cockDescript(0) + " erupts, writhing in your hands from the force of your orgasm as thick ropes of cum burst from you.   Each pulse of juice seems to drag on and on, each nearly as long as a normal man's orgasm.  Looking down, you see the bee's hair and face totally slimed with your cum, and a puddle forming below her.  ", false);
                if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                    this.outputText("You rise up off of her in mid-orgasm, aiming lower and painting her with each blast of seed.  ", false);
                else
                    this.outputText("You aim right at the oval of her face and paint her with each blast of seed.  ", false);
                this.outputText("Your " + this.cockDescript(0) + " flexes powerfully with each load, until your victim is soaked from the waist up, her breasts and face plastered with goo.  You sigh contentedly and step away, watching the bee scoop up your leavings in both hands, one going to her mouth, the other to her sweet wet snatch.  Giggling to yourself, you walk away, sated.", false);
            }
            if (this.player.cumQ() >= 500) {
                this.outputText("Your " + this.cockDescript(0) + " erupts like a volcano, shooting a constant thick stream of cum that pulses with each clench of your pelvic muscles.  The pressure only seems to increase as your urethra tries to deal with the huge load your body is producing.  ", false);
                if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                    this.outputText("You stand up off your victim, letting her tongue slip free from your soaked folds, and", false);
                else
                    this.outputText("You", false);
                this.outputText(" plunge your " + this.cockDescript(0) + " deep into the bee-girl's mouth and throat, pumping cum directly into her belly.  She writhes underneath you, her oxygen supply cut off as your spunk floods her belly.  The feeling of her inhuman lips wrapped tight around your base only makes it worse, intensifying the eruption of baby-batter that's pumping into her.  Her eyes roll back as cum begins leaking from her nose, her belly beginning to look distended and pregnant with the amount of jism you've pumped in.   Certain she's had enough, you pull free, marveling at how your last spurt made her look nearly nine months pregnant.   You note she's passed out, but your orgasm is far from over, so you resume jacking off, hosing her down from head to toe in thick white goop.  ", false);
                if (this.player.balls >= 2)
                    this.outputText("Your balls eventually empty", false);
                else
                    this.outputText("Your body's cum supply eventually empties", false);
                this.outputText(", and you turn your back on your soaked, cum-bloated conquest and the puddle of spooge that's rapidly wicking into the ground.", false);
            }
            this.player.orgasm();
            this.cleanupAfterCombat();
        }
        ...
        beeGirlRapeForTheDistinguishedGentleman() {
            ...
            if (this.monster.HP < 1)
                this.outputText("The bee-maiden staggers backward against her perch and wheezes.  Quickly, you launch yourself forward and pin her bodily against the giant flora, grabbing her feebly thrashing arms.  In a flash of inspiration, you pull a long supple leaf from the underside of the blossom, twisting it lengthwise and managing to bind her hands to the stem above her head with your makeshift cord before she can focus on what's happening.\n\n", false);
            //(if lust win)
            else
                this.outputText("The bee-girl's knees buckle together and she starts fingering her pussy desperately, too preoccupied to take any offensive posture.  You suavely stroll up to her with a toothy smile and, laying one arm around her waist, gently push her backwards against the giant flower she sat on before.  As she looks at you with interest and confusion displayed equally across her face, you pull a long supple leaf down from the underside of the flower and twist it lengthwise to make a sort of grass rope.  You guide her hands together above her head and tie them to the stem there, quite pleased with your own ingenuity.\n\n", false);
            //---------------------------------
            this.outputText("Momentarily lost in thought as to where you want to go from here, you don't notice the now-bound and irritated bee's last attempt to turn the tables as her stinger slowly slides free and her abdomen lifts into position to employ it.  ", false);
            //[(if spd<50)
            if (this.player.spe < 50)
                this.outputText("Bracing against the stem and lifting her legs, the bee snaps her stinger up and catches you in the arm, injecting a good amount of venom before you can twist your body away from her wickedly-tipped rear end.  With your other arm you grab hold of the thick fuzz on her bloated abdomen.  This bee bitch really doesn't know her place!  Staring down at the hateful stinger, your eyes drift upwards a bit to the soft area concealing her shriveled black ovipositor, and the anger and pain boiling in you mixes with your already-corrupt thoughts to give you an idea for revenge.", false);
            else
                this.outputText("Bracing against the stem and lifting her legs, the bee-maiden flips up her abdomen and the stinger darts towards your side.  Acting quickly, you roll away from it and down, bringing up your arm to hold the bee's abdomen in the air so she can't maneuver it into position for another stab.  What a poor loser this bee-girl is!  Your gaze tracks across the abdomen, taking in the angry little point and the soft spot next to it concealing the bee's ovipositor, and an idea starts to come together in your corrupted, novelty-crazed head.  Grinning even wider, you waggle one finger in reproof at the frightened bee.", false);
            this.outputText("\n\n", false);
            ...
            var select = choices[BeeGirlScene.rand(choices.length)];
            //(if naga tongue)
            if (select == 0) {
                ...
                //[(if penis then)
                if (this.player.hasCock())
                    this.outputText(", spraying the fuzzy side of the bee's abdomen with your sticky come,", false);
            ...
            //(if penis)
                ...
                this.outputText("Seeing the girl's resistance end in an eye-rolling gasp, you decide to get in on the fun too.  With some difficulty you unfasten and shed the bottoms of your " + this.player.armorName + " with your one free hand and maneuver your " + this.cockDescript(0) + " to her now-gushing honeypot.  Considering there's enough foreplay going on with her ovipositor to wet her enough for a minotaur, you unceremoniously slam your " + this.cockDescript(0) + " into her.", false);
                //[(if dicksize>beevagdepth)
                if (this.player.cockArea(0) > this.monster.vaginalCapacity())
                    this.outputText("  The bee-girl barely winces as the head of your shaft bumps up painfully against her cervix, quickly returning to a rictus of ecstasy as you continue jerking her ovipositor off with your now-sticky hand.", false);
            ...
            //[(if dick)
            if (this.player.hasCock())
                this.outputText("stroke your " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN), false);
            else if (this.player.hasVagina())
                this.outputText("rub your " + this.vaginaDescript(0), false);
            else
                this.outputText("tweak your " + this.nippleDescript(0) + "s", false);
            ...
            this.outputText(".\n\n", false);
            this.outputText("Damn, that probably did some ear damage but was it ever worth it!  The bee-girl, having finally redirected every egg she had into her own swollen butthole and ceased climaxing, passes out.  You gather your things and leave her contorted and soaked body behind you as you head back to camp.", false);
        ...
        beeAlternate() {
            ...
            var y = this.player.biggestCockIndex2();
            ...
            if (BeeGirlScene.rand(2) == 0) {
                ...
                if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE)
                    this.outputText("You loosen your " + this.player.armorName + " and unleash your cocks.  The largest cock - a tentacle - strains towards the bee-girl's pussy, clearly eager to sink itself into her warm, sticky confines.  Taking it in hand, you guide the mushroom-like glans against her pouting netherlips.  The bee-girl gasps and squirms, her motions clearly more in eagerness and humiliation than any serious attempt to escape.  You drag the broad head of your tentacle-cock up and down, gathering a thick coating of honey on it before releasing it.  Your cock strains against her folds, then sinks in slowly as you push your hips forward, and you sigh happily as you feel her warmth surround you.  She moans and arches her back even more, her antennae drooping submissively as your agile phallus squirms about inside her, stretching her tight little passage and leaving no nook or cranny unexplored.  ", false);
                if (this.player.hasKnot(x))
                    this.outputText("You loosen your " + this.player.armorName + " and unleash your cocks.  Taking the largest in hand, you stroke its knobby shape until it's sufficiently stiff, then press the pointed end against her clit, teasing the little nub.  The bee-girl gasps and squirms, pushing her now pouting clit back against you.  You drag the tip up, gathering honey as you go until you reach her opening, then thrust with your hips.  Her pussylips part eagerly, and you find her tight but welcoming.  Still, as tempting as it is to rut the girl with abandon, you hold back, never letting your knot sink inside her.  ", false);
                if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                    this.outputText("You loosen your " + this.player.armorName + " and unleash your cocks.  The equine flare of the largest is already drooling pre as you enjoy the sight of the helpless, squirming bee-girl.  Swinging it like a flogger, you spank her ass, making the girl yelp and leaving trails of sticky pre across the globes of her ass.  Grinning, you drag your shaft back and forth across her pussy, slicking it in her honey.  Finally, you press the tip against her opening.  She's a tight fit for you, and she squeals more loudly as your shaft spreads her little cunny inexorably.  ", false);
                //Catchall scenario
                if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.DEMON || this.player.cocks[x].cockType.Index > 4)
                    this.outputText("You loosen your " + this.player.armorName + " and unleash your cocks.  The glans of the largest is already drooling pre as you enjoy the sight of the helpless, squirming bee-girl.  Guiding it forwards, you spank her ass, making the girl yelp and leaving trails of sticky pre across the globes of her ass.  Grinning, you drag your shaft back and forth across her pussy, slicking it in her honey.  Finally, you press the tip against her opening.  She's a tight fit for you, and she squeals more loudly as your shaft spreads her little cunny inexorably.  ", false);
                //CONTINUE
                this.outputText("You enjoy loosening the girl up and exploring the depths of her cunt, taking your time.  Eventually, you draw yourself out of her, your " + this.cockDescript(x) + " escaping with a wet, slurping sound, dragging a thick drool of honey in its wake.  Taking a moment to inspect your handiwork, you see her pussy gapes wantonly, stretched out of shape by your shaft.", false);
                //New PG
                this.outputText("\n\n", false);
                //2nd cock love
                this.outputText("Taking your slightly smaller " + this.cockDescript(y) + " in hand, you slip it in as a replacement.  She's not as tight as she was, poor dear, but just as warm and twice as slick as she was for your first " + this.cockDescript(x) + ".  Your larger " + this.cockDescript(x) + " slides along the side of her ass, painting the black-and-yellow fur there with her honey and matting it down.  But that's less than satisfying, and glancing down, you notice she has a hole back here that's not getting used.  ", false);
                this.outputText("Withdrawing from her once more, you set the tip of your largest " + this.cockDescript(x) + " against the pucker of her ass.  She squeals and bucks as you press against her sphincter, but it's not long before the ring of muscle surrenders and your honey-soaked " + this.cockDescript(x) + " slides into her body.  She whimpers in humiliation, hands clawing at the grass as she shifts her hips to try to get more comfortable around your thickness.  You root around in the exquisite tightness of her ass, enjoying the way she shifts and wriggles under and around you.", false);
                //New PG
                this.outputText("\n\n", false);
                this.outputText("Drawing nearly, but not entirely, out of her, you take up your next largest cock and set it back at the entrance of her pussy again, and then thrust with your hips, sinking your largest deep into her ass while spearing her once more, burying your " + this.cockDescript(y) + " in her pussy.  She squeals loudly, wings flapping wildly a moment, then goes utterly limp with a whimper of surrender.  Grinning broadly, you begin to piston in and out of her, the sweet perfume of her lust wreathing your nostrils.  The plundering of her nether-regions fills the air with wet, slurping sounds, and soon she is moaning in time with every thrust, antennae quivering with need.  ", false);
                ...
                this.outputText("After falling to the ground, the bee-girl looks up in dazed fear as you expose your " + this.multiCockDescriptLight() + ", her eyes watching as you throb with lust at the scared and helpless look on her face.", false);
                //New PG
                this.outputText("\n\n", false);
                this.outputText("Once you're close enough, you grab her by the arms and force yourself down against her, shifting your knees to spread her legs.  Your " + this.multiCockDescriptLight() + " slap down against her slightly slick " + Appearance_1.Appearance.vaginaDescript(this.monster, 0) + ". Her face lights up with a look trapped somewhere between apprehension and interest at the unexpected touch, although the interest doesn't stop her from struggling valiantly to try and get away from you.  Finally, you force her arms against the ground and spread her wide enough to impale her " + Appearance_1.Appearance.vaginaDescript(this.monster, 0) + " on one of your " + this.multiCockDescriptLight() + " while watching her face contort with an alluring mixture of enjoyment and pain.  Her struggles weaken as you start to pound into her, tight abdominal muscles relaxing under you as she throws back her head, releasing a whimper at the rough penetration.  ", false);
                this.outputText("At first, taking her more than satisfies you, but an idea strikes as you watch her face become distracted with each body-shaking thrusts of your hips.  Grabbing your remaining " + this.cockDescript(y) + " you push it against the already-impaled member, and on the next thrust you drive them both in.", false);
                if (this.player.averageCockThickness() > 2)
                    this.outputText("  She stretches against you amazingly, squeezing down on you like a vice.  You theorize it's only because of her strange body and the copious amounts of honey she's leaking against you that you aren't ripping her apart.", false);
                //New PG
                this.outputText("\n\nThe bee-girl shakes violently and screams in equal parts buzz and moan as a thick torrent of honey splashes against your dual members, making the pair of them slide in that much easier.  Her arms move up, the free one grabbing at your shoulder and clutching hard enough to leave bruises while the other squirms under your hand, her body tense under you. Stretched to the brink by the pair of " + this.multiCockDescriptLight() + "s, her hole is like a vice against you and every thrust visibly stretches her. The more you thrust the wetter she gets and her eyes seem to be wildly fluttering underneath you as you take her, her struggles turning to her thrusting her lower body up against you appreciatively. Your " + this.multiCockDescriptLight() + "s slap and pound into her abused " + Appearance_1.Appearance.vaginaDescript(this.monster, 0), false);
                if (this.player.balls > 0)
                    this.outputText(" with your " + this.ballsDescriptLight() + " hitting her abdomen hard enough to make smacking sounds ring out in the forest around you.", false);
                else
                    this.outputText(".", false);
                //New PG
                this.outputText("\n\n", false);
                ...
                if (this.player.cocks.length >= 3) {
                    this.outputText("As you pound into her, you realize that large amounts of her juices are leaking from her " + Appearance_1.Appearance.vaginaDescript(this.monster, 0) + " over her abdomen, against the hole near the base of her stinger.  Reaching down with wicked intent, you grab one of your free " + this.multiCockDescriptLight() + "s and force it against her tight asshole while you pull your hips back.  Her eyes widen as she looks up at you, renewing her struggles as she kicks her legs at you, her wings slapping the ground with fierce determination as she tries to wriggle away.  You hold her tightly, pushing your hips against her to bury your " + this.multiCockDescriptLight() + " inside her.  The flow of honey barely lessens the friction as your " + this.cockDescript(2) + " sinks into her ass inch by inch.  Her " + Appearance_1.Appearance.vaginaDescript(this.monster, 0) + " is stretched even wider and she screams out something that sounds like a humming moan as her asshole begins to gape a bit with each of your thrusts. It takes a minute or two, but finally you hit bottom with all three of your " + this.multiCockDescriptLight() + "s.\n\n", false);
                }
                //Orgasm PG
                this.outputText("After a while of fucking her, her buzzing complaints and wild struggles begin to melt as she cums against you, shuddering and forcing her hips up towards you, plunging your " + this.cockDescript(x) + " into her even deeper.  She begins to climax, her muscles becoming more and more relaxed with each time her stretched holes squeeze down on you.  Surges of pleasure begin to overwhelm you and soon you begin fucking her as hard as you can, honey splattering wetly over her body as she finally seems to collapse under your body's assault. Her eyes dim visibly, the buzzing cries of pleasure echoing faintly from her lips while her body goes completely limp underneath you.  Not to be stopped, you continue to take her, eventually feeling seed swell up inside ", false);
                if (this.player.balls > 0)
                    this.outputText("your " + this.ballsDescriptLight() + " ", false);
                else
                    this.outputText("your prostate ", false);
                this.outputText("as you plunge into her. Your release is very large, splattering her slick walls with thick loads of cum as you plunge as deep as you can thrust inside her.", false);
                //Lots of cocks bonus cum texts
                if (this.player.cocks.length >= 3) {
                    this.outputText("  Her battered " + Appearance_1.Appearance.vaginaDescript(this.monster, 0) + " grips down on your dual " + this.multiCockDescriptLight() + "s tightly, draining you of every drop she can.  Rivers of white begin to leak from her abused holes and mingle with her own release as it trails down her abdomen and drips off it slowly onto the forest floor.", false);
                    if (this.player.cocks.length == 4)
                        this.outputText("  The " + this.cockDescript(3) + " not inside her shakes wildly as you cum; jets of your semen let loose over her abused frame, coating her in white.", false);
                    if (this.player.cocks.length > 4)
                        this.outputText("  The " + this.multiCockDescriptLight() + "s not inside her shake wildly as you cum; jets of your semen let loose over her abused frame, coating her in white.", false);
                }
                //New PG
                this.outputText("\n\n", false);
                this.outputText("The both of you smell like sex as you pull free of her with a groan.  You move to kneel over her and use her unstained lips to dry your " + this.multiCockDescriptLight() + " one by one.  Her lips part slightly on instinct and you can feel her swallow the globs of jism that coat you.  Once she's done you stand up quickly, ", false);
                if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                    this.outputText("stuffing your " + this.multiCockDescriptLight() + " inside your " + this.player.armorName, false);
                else
                    this.outputText("your glorious but spent " + this.multiCockDescriptLight() + " dangling under your belly,", false);
        ...
        nagaRapesPt2TheExtremeContinuationOfAwesome() {
            ...
            if (this.player.gender == 1 || (this.player.gender == 3 && BeeGirlScene.rand(3) == 0)) {
                ...
                if (this.player.cocks.length == 1)
                    ...
                    this.outputText(" are");
                this.outputText(" aching for release, and you tear off your " + this.player.armorName + " just in time as ", false);
                if (this.player.totalCocks() > 1)
                    this.outputText("they free themselves from ", false);
                else
                    this.outputText("it frees itself from ", false);
                this.outputText("the slit between your legs.  Without needing to say a word, the message is transferred across some unknown medium: Suck my cock", false);
                if (this.player.totalCocks() > 1)
                    this.outputText("s", false);
                this.outputText(".\n\n", false);
                ...
                if (this.player.balls > 0)
                    this.outputText("Not while her hands cup your " + this.sackDescript() + " and knead tenderly, infusing you with the craving for release; ", false);
                else
                    this.outputText("not ", false);
                ...
                //[large cum load]
                    ...
                    this.outputText("waves of cum pumping into her belly and visibly bulging it out.", false);
                //[huge cum load] 
                else
                    this.outputText("an unending stream of cum gushing into her belly and stretching it out significantly.", false);
                ...
                this.outputText("You check her unconscious form – now lying on the ground – for signs of life. Relieved that she is breathing, you turn and leave her where she is.", false);
            }
            //[Player is female]
            else if (this.player.gender == 2 || (this.player.gender == 3 && BeeGirlScene.rand(2) == 0)) {
                if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_WET)
                ...
                if (this.player.clitLength > 1)
                    this.outputText("  Emergent from its sheath, she uses the base of her tongue as a bottom lip and begins to suck you off like a cock, unceasing in her lingual assault on the inside of your canal.", false);
                this.outputText("\n\n", false);
                ...
                this.outputText("A feeling like the urge to pee overwhelms you, and lost inside to your pleasure, you give in.  ", false);
                if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_SLICK)
                ...
                this.outputText("You let yourself blink and break the hypnotizing glare, watching as life returns to her features. You pet her head affectionately and thank her, leaving her to piece together what the hell just happened.", false);
            }
            //[Player is herm]
            else if (this.player.gender == 3) {
                ...
                this.outputText("Touching a single index finger to the underside of your captive's chin, you pull with the slightest of forces and watch as she is dutifully drawn to your " + this.multiCockDescriptLight() + ", running her lengthy prehensile tongue up and down ", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("each of your shafts", false);
                else
                    this.outputText("your shaft", false);
                this.outputText(". As the pulsing movement inside your body draws you slowly closer to orgasm, the bee-bitch uses her other hand to draw your " + this.cockDescript(0) + " down to an angle so it slides neatly into her throat", false);
                //[if Player cock => 12\"]
                ...
                if (this.player.totalCocks() > 1) {
                    this.outputText("  Letting go once it is fitted neatly inside, she uses her free hand to stroke your other cock", false);
                    //[three or more]
                    if (this.player.cockTotal() > 2)
                        this.outputText("s, giving each a few pumps before moving on to the next", false);
            ...
            //[Player is neutered]
                ...
                this.outputText("You pull your hand out and futilely try to wipe away the gunk on a nearby bush. The handmaiden is collapsed in a heap, excreting eggs from her dilated organ, mumbling blissfully delirious nonsense.  Gathering your things, you slither away.", false);
            }
        ...
        beeGirlsGetsDildoed() {
            ...
            this.outputText("You release it as she passes out, smiling when you realize she'll probably be leaking eggs with every step from now on.  ", false);
            if (this.player.cor < 50)
                this.outputText("You feel kind of bad for her, but y", false);
            else
                this.outputText("Y", false);
            this.outputText("ou really need to get back to camp and get off after such an intense experience.  Maybe you should give your honey-flavored dildo a shot?", false);
        ...
        milkAndHoneyAreKindaFunny() {
            ...
            this.flags[kFLAGS_1.kFLAGS.FORCE_BEE_TO_PRODUCE_HONEY] = 1;
        ...
        layEggsInABeeSpiderLike() {
            ...
            if (this.player.faceType == appearanceDefs_1.FACE_SNAKE_FANGS || this.player.faceType == appearanceDefs_1.FACE_SPIDER_FANGS)
            ...
            if (this.player.fertilizedEggs() == 0)
                this.outputText("unfertilized");
            else
                this.outputText("fertilized");
    ...
    BeeGirlScene.BEE_GIRL_CONVERSATION = 0x7FFF0000; //Used to track conversations when the player is a female bee morph (Highest bit is for the bad end warning)
    BeeGirlScene.BEE_GIRL_ATTITUDE = 0x0000FFFF;
    BeeGirlScene.BEE_GIRL_TALKED = 1; //Replaces the old bee progress flag
    BeeGirlScene.BEE_GIRL_TALKED_AND_LEFT = 2; //Refusing to take her eggs leads to conversation
    BeeGirlScene.BEE_GIRL_TALKED_AND_LEFT_TWICE = 3;
    BeeGirlScene.BEE_GIRL_PLAYER_AFRAID = 4;
    BeeGirlScene.BEE_GIRL_PLAYER_VOLUNTARY_EGGING = 5; //End of the afraid chain, from now on player gets egged when they meet her
    BeeGirlScene.BEE_GIRL_PLAYER_DISGUSTED = 6;
    BeeGirlScene.BEE_GIRL_PLAYER_DUTY = 7;
    exports.BeeGirlScene = BeeGirlScene;
});
//# sourceMappingURL=BeeGirlScene.js.map