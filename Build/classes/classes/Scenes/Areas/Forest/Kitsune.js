define(["require", "exports", "../../../Monster", "../../../StatusAffects", "../../../PerkLib", "../../../GlobalFlags/kFLAGS", "../../../CockTypesEnum", "../../../../../includes/appearanceDefs", "../../../Appearance", "../../../internals/WeightedDrop"], function (require, exports, Monster_1, StatusAffects_1, PerkLib_1, kFLAGS_1, CockTypesEnum_1, appearanceDefs_1, Appearance_1, WeightedDrop_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Kitsune extends Monster_1.Monster {
        // Combat Abilities:
        ...
        kitsuneEntwine() {
            ...
            this.createStatusAffect(StatusAffects_1.StatusAffects.PCTailTangle, 0, 0, 0, 0);
        ...
        kitsuneStruggle() {
            ...
            //Success
            if (Kitsune.rand(20) + this.player.str / 20 + this.statusAffectv1(StatusAffects_1.StatusAffects.PCTailTangle) >= 12) {
                ...
                this.removeStatusAffect(StatusAffects_1.StatusAffects.PCTailTangle);
                this.doAI();
            }
            //Failure - +5-10 LUST
            else {
                ...
                this.addStatusValue(StatusAffects_1.StatusAffects.PCTailTangle, 1, 3);
                this.combatRoundOver();
            }
        }
        kitsuneWait() {
            ...
            if (this.game.silly())
                this.outputText("  You're so glad you got to touch fluffy tail.");
            this.outputText("\n\nShe licks her lips, running her hands along you wherever she can find exposed flesh.  Her fingertips leave small trails of dazzling blue that make you flush with lust - you must escape her grasp soon or else you will be like putty in her hands!");
            this.game.dynStats("lus", 5 + this.player.sens / 10);
            this.combatRoundOver();
        }
        ...
        illusionKitsuneAttack() {
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.Whispered) >= 0)
                resist += 20;
            if (this.player.findPerk(PerkLib_1.PerkLib.HistoryReligious) >= 0 && this.player.cor < 20)
            ...
            if (Kitsune.rand(100) < resist) {
                ...
                this.createStatusAffect(StatusAffects_1.StatusAffects.Illusion, 0, 0, 0, 0);
                this.spe += 20;
            }
            this.combatRoundOver();
        }
        ...
        kitsuneSealAttack() {
            ...
            if (select == 0) {
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Sealed, 4, 0, 0, 0);
            }
            else if (select == 1) {
                //Tease:
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Sealed, 4, 1, 0, 0);
            }
            //Spells:
            else if (select == 2) {
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Sealed, 4, 2, 0, 0);
            }
            //Items:
            else if (select == 3) {
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Sealed, 4, 3, 0, 0);
            }
            //Run:
            else if (select == 4) {
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Sealed, 4, 4, 0, 0);
            }
            //P.Special:
            else if (select == 5) {
                this.outputText("You jump with surprise as the kitsune appears in front of you, grinning coyly.  As she draws a small circle on your forehead with her fingertip, you find that you suddenly can't remember how to use any of your physical skills!");
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Sealed, 4, 5, 0, 0);
            }
            //M.Special:
            else {
                this.outputText("You jump with surprise as the kitsune appears in front of you, grinning coyly.  As she draws a small circle on your forehead with her fingertip, you find that you suddenly can't remember how to use any of your magical skills!");
                this.outputText("\n\n\"<i>Oh no darling, </i>I'm<i> the one with all the tricks here.</i>\"");
                this.outputText("\n\n<b>The kitsune's spell has sealed your magical skills!</b>  You won't be able to use any of them until the spell wears off.");
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Sealed, 4, 6, 0, 0);
            }
            if (resist >= Kitsune.rand(100)) {
                ...
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Sealed);
            }
            this.combatRoundOver();
        }
        //Tease Texts:
        kitSuneTeases() {
            var select = Kitsune.rand(3);
            if (this.hairColor == "red" && Kitsune.rand(2) == 0)
                select = 3;
            if (select == 0)
                this.outputText("You rub your eyes, suddenly seeing triple as you find yourself in the midst of a crowd of kitsune doppelgangers.  They run their hands all over you, teasing and doting on you as their tails caress every inch of your body.  Taken by surprise, you forget to fight back until they have already dispersed, blending back into a single fox-woman.");
            else if (select == 1)
                this.outputText("Bending forward, the kitsune runs her hands down over her breasts, jiggling them enticingly and squeezing them together.  Hooking a finger in her robes, she slides it down, tugging them aside until her nipples are just barely covered, and with a teasing smirk, pulls them back up, leaving you wanting.");
            else if (select == 2)
                this.outputText("Turning her back to you, the kitsune fans out her tails, peering back as she lifts the hem of her robe to expose her plump hindquarters.  Her tails continually shift and twist, blocking your view, but it only serves to make you want it even <i>more</i>, licking your lips in anticipation.");
            //Redhead only:
            else
                this.outputText("The kitsune sways her hips enticingly as she appears in front of you abruptly, rubbing up against your side.  Her teasing caresses make you shiver with arousal, and you can feel something thick and warm pressing against your [hips].  She gives you a wry grin as she breaks away from you, sporting an obvious tent in her robes.  \"<i>Just you wait...</i>\"");
        ...
        performCombatAction() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Sealed) < 0)
            ...
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Illusion) < 0)
        ...
        constructor(hairColor) {
            super();
            if (Kitsune.rand(3) != 2)
                this.game.flags[kFLAGS_1.kFLAGS.redheadIsFuta] = 1;
            this.a = "a ";
            this.short = "kitsune";
            ...
            // this.plural = false;
            if (hairColor == "red" && this.game.flags[kFLAGS_1.kFLAGS.redheadIsFuta] == 1) {
                this.createCock(Kitsune.rand(13) + 14, 1.5 + Kitsune.rand(20) / 2, CockTypesEnum_1.CockTypesEnum.HUMAN);
                this.balls = 2;
            ...
            this.drop = new WeightedDrop_1.WeightedDrop(this.consumables.FOXJEWL, 1);
            this.tailType = appearanceDefs_1.TAIL_TYPE_FOX;
            this.checkMonster();
        }
    }
