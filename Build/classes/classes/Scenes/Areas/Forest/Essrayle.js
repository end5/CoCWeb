define(["require", "exports", "../../../BaseContent", "../../../GlobalFlags/kFLAGS", "../../../../../includes/appearanceDefs"], function (require, exports, BaseContent_1, kFLAGS_1, appearanceDefs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Essrayle extends BaseContent_1.BaseContent {
        ...
        essrayleMeetingI() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MET_ESSY] == 0) {
                ...
                if (this.player.cor < 33)
                    this.outputText("hastily looking away from her nude body");
                else if (this.player.cor < 66)
                    this.outputText("looking away out of courtesy");
                else
                    this.outputText("letting your eyes roam over her as you search for even more depraved features on her nubile body");
                this.outputText(".");
                ...
                if (this.player.biggestTitSize() >= 10)
                    this.outputText("own");
                else
                    this.outputText("[chest]");
                this.outputText(".  \"<i>You must be one of those adventurers I've been hearing about, am I right?</i>\"");
            ...
            this.flags[kFLAGS_1.kFLAGS.MET_ESSY]++;
            //[Yes] [No]
            this.menu();
        ...
        plantsForMe() {
            ...
            if (this.player.breastRows[0].breastRating >= 1) {
                ...
                if (this.player.bRows() > 1)
                    this.outputText(" of your uppermost pair");
                this.outputText(".  You moan, and this only seems to encourage her, as she takes your nipples between thumb and forefinger, twisting and turning them this way and that.  She giggles at how your moans seem to fluctuate by coincidence, continuing to tease them");
                if (this.player.bRows() > 1)
                    this.outputText(", steadily working over the multitude of fleshy mounds on your body");
                this.outputText(".");
                if (this.player.hasFuckableNipples())
                    this.outputText("  Her fingers play with your nipples and press gently to tease at them.  She seems quite surprised as they sink in with minimal effort.  A grin spreads over her face as she begins to steadily thrust those digits in and out of your nipples, fingers swirling about the interiors all the while.");
        ...
        plantsForMe2(BE = 0) {
            ...
            if (this.player.hasCock() && this.player.hasVagina())
                this.outputText("find the dual sexes there.  Another hand joins the first, one gripping and tugging on your hardening cock as the other cups and squeezes over your pussy.");
            else if (this.player.hasCock()) {
                this.outputText("circle about ");
                if (this.player.cockTotal() > 1)
                    this.outputText("one of ");
                this.outputText("your shaft");
                if (this.player.cockTotal() > 1)
                    this.outputText("s");
                this.outputText(", beginning to squeeze and slide about its length until your nursing is interrupted by moans of your own delight");
            }
            else
                this.outputText("stroke about the puffy, now-inflamed lips of your own flower, taking the lips between two fingers and stroking up and down across their length fully before switching to your moist core.");
            this.outputText("\n\nA firm hand cups your ");
            if (this.player.isTaur())
                this.outputText("back");
            else
                this.outputText("butt");
            this.outputText(" and pulls you close, forcing your [legs] against her bulb.  They sink in slightly as you go down, reluctantly relinquishing her nipple from your mouth.  As it springs free, a thick glob of sap splatters over your lips and nose.  Essy giggles softly as she wipes them off with a hand.");
            ...
            this.outputText("and [legs], ");
            if (!this.player.isTaur())
                this.outputText("lifting you slowly into the air");
            else
                this.outputText("forcing you to rear up");
            this.outputText(".  Her lower hands grasp you, helping to raise you up until you're at the proper height, whence she abruptly plants her lips upon your crotch.");
            //Cock=
            if (this.player.hasCock()) {
                ...
                if (this.player.breastRows[0].breastRating >= 1)
                    this.outputText(" and " + this.player.breastCup(0) + " breasts");
                this.outputText(".  The opaque cups pump and suck, Essy humming to herself as the base of her tongue continues to skillfully tease over every hot spot near the [cockHead biggest] of your [cock biggest], her length slithering about it skillfully.");
            }
            //(Pussy=
            else {
            ...
            if (this.player.biggestTitSize() >= 1) {
                ...
                if (this.player.lactationQ() >= 400)
                    this.outputText("your milk and ");
                this.outputText("your pleasure.  In time, their pumping increases in force and tempo just as her lips and tongue do.");
            }
            ...
            if (this.player.cumQ() >= 500 && this.player.cumQ() < 2000)
                this.outputText("  It takes some time for her to completely drain your virile reserves, humming happily as splurt after splurt bulges her cheeks and forces her throat to work.  By the time you start to go dry, you can swear the bulb that is her base looks a little bit bigger, and perhaps her breasts as well.");
            else if (this.player.cumQ() >= 2000)
                this.outputText("  This is a bit hard, as your virile cum-spout renders her trim belly bloated, and the bulb that forms her base rapidly swells with growth thanks to your fecund deposits.  The seed even trickles out around the corners of her mouth as she greedily attempts to devour it all, sighing around each cheek-stretching ejaculation.");
            ...
            if (BE == 1) {
                ...
                if (this.player.totalNipples() > 2)
                    ...
                    this.outputText(" has");
                this.outputText(" been swallowed up as well.");
                ...
                if (this.player.bRows() > 1)
                    this.outputText("  She eventually dislodges with a wet pop, setting your new breasts to wobbling about as she moves down your body, repeating the gestures upon each set of breasts in return.");
                this.outputText("\n\nWeak from the pleasure, the last thing you see is her smiling face before you fall forward into her embrace.  The next thing you know, you're alone in the glade, staring at the canopy above.  There's a heavy weight on your chest and you struggle to sit up.  " + Essrayle.Num2Text(this.player.bRows() * 2) + " massive breasts jiggle and sway upon your chest, all full and aching to be milked");
                if (this.player.bRows() > 1)
                    this.outputText(", the top pair being largest, descending in size with each subsequent pair");
                this.outputText(".");
            ...
            if (this.player.hasBreasts() && this.player.isLactating()) {
                this.player.milked();
        ...
        feedTrappedEssy() {
            ...
            this.flags[kFLAGS_1.kFLAGS.ESSY_DUNGEON_FUCKED]++;
        ...
        hasCockFeedEssy(newPage = true) {
            ...
            if (this.player.biggestCockLength() < 20)
                this.outputText("her lower pair of wobbling udders");
            else
                this.outputText("both sets of milk-bloated breasts");
            this.outputText(" faster and faster, the hot slapping of her bountiful bosom against your [cock]");
            if (this.player.balls > 0)
                this.outputText(" and your swollen, heavy balls against her fecund belly");
            this.outputText(" setting an inspiring drum beat to your feverish pace.");
        ...
        essyWitchVictory() {
            ...
            this.flags[kFLAGS_1.kFLAGS.ESSRAYLE_ESCAPED_DUNGEON] = 1;
            this.menu();
        ...
        acceptEssyPrizes() {
            ...
            if (this.player.biggestTitSize() <= 1) {
                this.outputText("four bulging tits erupt from your chest");
            ...
            //if two breasts:
                ...
                if (this.player.breastRows[0].breastRating < 4) {
                    this.outputText(" while your top row expands");
                    this.player.breastRows[0].breastRating = 4;
                }
                if (this.player.bRows() == 1)
                    this.player.createBreastRow();
            ...
            this.player.boostLactation(this.player.bRows());
            this.outputText(", filling with warm, fluid weight.  They jiggle and wobble against each other and your belly as they adjust to their brimming plumpness.  You now proudly sport [fullChest].");
        ...
        //[No]
        noGimmeGiantNipplesEssy() {
            this.clearOutput();
            this.outputText("She shrugs her shoulders, giving one bundle of milk-drooling nipples a soft squeeze.  \"<i>Eh, to each their own, I suppose.</i>\"");
            this.essyRewardEpilogueOUTTIES();
        }
        //[Either choice]
        ...
        askMotherToReleaseEssy() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.SAND_WITCHES_COWED] == 0) {
                this.outputText("You point out that the witches have a friend of yours trapped here with magic and you'd like her released.");
                ...
                this.outputText("You command the Sand Mother to release your friend, Essrayle from her magical bondage.  The sorcerous queen looks about to protest, but after a brief pause, she admits, \"<i>Fine, I'll see her released.  You can go pick her up.</i>\"  She practically spits the last sentence.");
                this.outputText("\n\nThat'll do.");
            }
            this.flags[kFLAGS_1.kFLAGS.TOLD_MOTHER_TO_RELEASE_ESSY] = 1;
            this.doNext(this.playerMenu);
        }
    }
    exports.Essrayle = Essrayle;
});
//# sourceMappingURL=Essrayle.js.map