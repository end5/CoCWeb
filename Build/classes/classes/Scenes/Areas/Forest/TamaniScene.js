define(["require", "exports", "../../../BaseContent", "../../../PregnancyStore", "../../../GlobalFlags/kFLAGS", "../../../CoC", "../../../../console", "../../../../../includes/appearanceDefs", "../../../PerkLib", "../../../CockTypesEnum", "../../../Appearance", "./Tamani"], function (require, exports, BaseContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, appearanceDefs_1, PerkLib_1, CockTypesEnum_1, Appearance_1, Tamani_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class TamaniScene extends BaseContent_1.BaseContent {
        constructor() {
            super();
            this.pregnancy = new PregnancyStore_1.PregnancyStore(kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_TYPE, kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_INCUBATION, 0, 0);
            this.pregnancy.addPregnancyEventSet(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, 96, 48);
        ...
        timeChange() {
            ...
            if (this.pregnancy.isPregnant && this.pregnancy.incubation == 0)
                this.tamaniGivesBirth(); //Silently clear Tamani's pregnancy if the player doesn't encounter her in time
            return false;
        }
        timeChangeLarge() {
            return false;
        ...
        tamaniGivesBirth() {
            if (this.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER) { //Don't want drider eggs to add to her daughers
                this.flags[kFLAGS_1.kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] += this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT];
                this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT] = 0;
                this.flags[kFLAGS_1.kFLAGS.TAMANI_TIMES_IMPREGNATED]++;
            }
            this.pregnancy.knockUpForce(); //Clear Pregnancy
        }
        tamaniChest() {
            var descript = "";
            switch (this.flags[kFLAGS_1.kFLAGS.TAMANI_TIMES_IMPREGNATED]) {
                case -1:
                case 0:
        ...
        tamaniFemaleYes() {
            ...
            this.outputText("She pulls out a long pink dick and tosses it to you.  You catch it and it flops around, nearly slapping you in the cheek.  ", false);
            if (this.player.cor < 50)
                this.outputText("Gross.\n\n", false);
            else
                this.outputText("Getting cock-slapped would've been kind of hot...\n\n", false);
        ...
        tamaniFemaleNo() {
            ...
            this.outputText("She flounces off, clearly planning on fucking everything capable of producing sperm on her way home.  ", false);
            if (this.player.cor < 33)
                this.outputText("What a slut.", false);
            else if (this.player.cor < 66)
                this.outputText("How odd.", false);
            else
                this.outputText("You hope she misses a few.", false);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        tamaniMaleFirstEncounter() {
            this.spriteSelect(56);
            this.flags[kFLAGS_1.kFLAGS.TAMANI_MET] = 1; //Indicates you've met her as a male at least once
            this.outputText("", true);
        ...
        tamaniFirstTimeConsentual() {
            ...
            this.outputText("Her hips sway seductively as she approaches with her right hand dipping into the moist honeypot of her sex.  You disrobe, throwing your " + this.player.armorName + " to the side before you reach down and lift her up, pressing her curvy body against your ", false);
            ...
            this.outputText("As if to emphasize her point, she curls her toes around your " + this.cockDescript(0) + ", squeezing as she slides her feet up and down your length, milking out a few large drops of pre-cum.  You groan and kiss her again – too turned on to care if the drug-laced lipstick turns your orgasm into a pregnancy-inducing flood. ", false);
            if (this.player.balls > 0)
                this.outputText("Your " + this.ballsDescriptLight() + " swell with seed, spurring your desire to new heights.", false);
            else
                this.outputText("Something inside you swells up with seed, spurring your desire to new heights.", false);
            this.outputText("  You NEED to fuck her pussy full – NOW.\n\n", false);
            //(FITS)
            if (this.player.cockArea(0) <= 90) {
                this.outputText("Tamani breaks the kiss and gives you a coy smile as she shimmies down your body, dropping her moist cunt onto your " + this.cockDescript(0) + "'s " + this.player.cockHead() + ".  She swings her hips in a little circle, teasing you with her moist entrance as your drug-enhanced pre-cum bubbles and drools around her lips, mixing with her own copious fluids as it flows down your length", false);
                if (this.player.balls > 0)
                    this.outputText(" and drips from your " + this.ballsDescriptLight(), false);
                ...
                this.outputText("All good things eventually end, and with a sigh you pull the insensate goblin slut free of your " + this.cockDescript(0) + ", watching a river of whiteness drain from between her thighs.  You set her down and the escaping jism suddenly stops, the remainder held inside by some kind of reflex.  Tamani giggles and pats her still pregnant-looking belly, \"<i>Wasn't the sample nice?  Come see me when your dick has had a chance to recover and we can do this again, and again, and again.  You're practically hooked already aren't you " + this.player.mf("stud", "hun") + "?</i>\"\n\n", false);
                this.outputText("It takes a moment to put your " + this.player.armorName + " back on and make ready to leave, but somehow you know this isn't the last you've seen of this goblin.", false);
                //[CORRUPT]
                if (this.player.cor > 66)
                    this.outputText("  Your " + this.cockDescript(0) + " twitches at the thought, ready and wanting more.", false);
            }
            //(TOO BIG)
            else {
                this.outputText("Tamani breaks your sloppy kiss and shimmies down your body, clutching tightly to your " + this.cockDescript(0) + " and " + this.player.skinDesc + " as she settles down lower on your groin.  The goblin somehow manages to turn herself around so that is she is hanging upside-down, with her legs and arms clutching tightly to your member while her tongue ", false);
                if (this.player.hasSheath()) {
                    this.outputText("licks the edges of your sheath", false);
                    if (this.player.balls > 0)
                        this.outputText(" and balls", false);
                }
                else {
                    if (this.player.balls > 0)
                        this.outputText("licks all over your balls", false);
                    else if (this.player.hasVagina())
                        this.outputText("sneaks between your folds to tease your now-hardening clit", false);
                    else
                        this.outputText("licks the sensitive " + this.player.skinTone + " " + this.player.skinDesc + " of your inner thighs", false);
                }
                this.outputText("\n\n", false);
                ...
                if (this.player.balls > 0 && this.player.hoursSinceCum > 200)
                    this.outputText(", visibly draining your " + this.ballsDescriptLight() + " down to their normal size", false);
        ...
        tamaniMaleRepeatEncounter() {
            ...
            if (this.pregnancy.isPregnant || this.flags[kFLAGS_1.kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] > 0)
                this.outputText("While exploring, you're startled by the feeling of tiny hands stroking the insides of your thighs.  You look down and find Tamani there, grinning wolfishly,  \"<i>Ready for another fuck, big " + this.player.boyGirl() + "?\"\n\n", false);
            //(ELSE) 
            else
                this.outputText("While exploring, you're startled by the feeling of tiny hands stroking the insides of your thighs.  You look down and find Tamani the goblin there, grinning with desire, \"<i>Ready to stuff me with cum?  I'm not taking no for an answer this time.</i>\"\n\n", false);
            if (this.flags[kFLAGS_1.kFLAGS.TAMANI_TIMES_HYPNOTISED] > 19 && TamaniScene.rand(2) == 0) {
        ...
        tamaniStartFight() {
            this.clearOutput();
            this.outputText("Tamani adopts a fighting pose and says, \"<i>If I have to I'll beat my children out of you!</b>\"");
            this.startCombat(new Tamani_1.Tamani());
        }
        ...
        tamaniSexLetHer() {
            ...
            if (this.getGame().inCombat) {
                ...
                if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR) {
                    if (this.player.HP < 1)
                        this.outputText("You stumble, hooves weaving drunkenly as you try to keep your feet.  ", false);
                    else
                        this.outputText("You stumble, hooves weaving drunkenly as " + this.sMultiCockDesc() + " ache and drool with need.  ", false);
                ...
                //Not taur
                    ...
                    if (this.player.HP < 1)
                        this.outputText("You collapse, unable to fight back any longer.  For her part, Tamani seems disappointed with the outcome, but approaches your prone form in spite of your sorry appearance.", false);
                    else
                        this.outputText("You tear off your clothes in a frenzy of lust and stagger towards Tamani, openly fondling your groin.   She smirks and pushes you hard, throwing you off balance and onto your back.", false);
                    this.outputText("  She wiggles her " + this.tamaniChest() + ", and despite your efforts to control your body, ", false);
                    if (this.player.cockTotal() == 1)
                        this.outputText("an erection emerges", false);
                    else
                        this.outputText("erections sprout up like weeds", false);
            ...
            //Voluntary submission
                ...
                //Taur
                if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR) {
                    this.outputText("You meekly undress and ask Tamani how she would like to take you today.  She titters and slowly walks around you, taking her time, taking in your formidable equine body and your " + this.multiCockDescriptLight() + ". \"<i>All this, for little ol' me,</i>\" she breathes. She sounds more tantalized than daunted. \"<i>Stand still for me, horsie,</i>\" she commands. Unable to see her any more behind your flank, you do as she says. You feel a pair of tiny hands on your back thigh and then a small but dense weight climbing steadily towards your groin. You bite back laughter at the ticklish sensation.\n\n", false);
                }
                else {
                    this.outputText("You meekly undress and ask Tamani how she would like to take you today.  She titters and gives your ", false);
                    ...
                    switch (this.temp) {
                        case 0:
                            ...
                            break;
                        case 1:
                            this.outputText("bellybutton", false);
                            break;
                        case 2:
            ...
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR) {
                ...
                if (this.player.cocks[0].cockLength <= 18) {
                    ...
                    //No balls: 
                    if (this.player.balls == 0)
                        this.outputText("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics.\n\n", false);
                    else
                        this.outputText("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics, before the goblin in question drives all thoughts out of your head by mashing her soft soles into your " + this.ballsDescriptLight() + ".\n\n", false);
                ...
                //If >18 Inches 
                    ...
                    if (this.player.balls == 0)
                        ...
                        this.outputText("You find yourself wondering vaguely where a goblin learns these kinds of gymnastics, before the goblin in question drives all thoughts out of your head by beginning to mash her soft soles into your " + this.ballsDescriptLight() + ".\n\n", false);
                    this.outputText("Tamani has her way with you like this for what seems like hours, crawling up and down your massive cock", false);
                    if (this.player.balls > 0)
                    ...
                    //High cum: 
                        ...
                        this.outputText("When you finally come to your senses, you wearily but with intense satisfaction clop around to take in the lake of jizz you have created. ", false);
                        if (this.player.balls > 0)
                            this.outputText("Your " + this.ballsDescriptLight() + " ache and you feel very thirsty indeed.", false);
                        else
                            this.outputText("You feel very thirsty indeed.", false);
            ...
            //Not-taurs
                ...
                this.outputText("She gets down on all fours, crawling up your legs until her gloss-covered lips reach your " + this.multiCockDescriptLight() + ".   Warm wetness slides along your length as the gobbo-slut gets you slick and wet with her saliva.   It has quite the effect on you, turning your " + this.cockDescript(0) + " into a hard trembling pleasure-center.  You sigh, enjoying the attention but more than ready to release your pent-up sexual need into the willing girl.\n\n", false);
                //(fits)
                if (this.player.cockArea(0) <= 90) {
                    this.outputText("Tamani turns about, dragging her wet gash across you and giving you a nice view of her plump butt-cheeks.  The soft skin of her palms squeezes around you as she lifts you up, positioning your " + this.cockDescript(0) + " against her womanhood.   She grinds against your " + this.player.cockHead() + ", her folds slowly parting to take you.  Slowly, inch after inch of dickflesh sinks into her amazingly elastic yet tight pussy.  ", false);
                    if (this.player.cocks[0].cockLength >= 12)
                        this.outputText("Her body visibly stretches around you, and you silently thank whatever gods or demons adapted goblins to be able to fulfill this role.  ", false);
                    this.outputText("Moaning like a whore, she easily slips the rest of the way down, bottoming out her sopping-wet fuck-tunnel.\n\n", false);
                    this.outputText("You gasp in pain and surprise as Tamani pinches and tugs ", false);
                    if (this.player.totalNipples() == 2)
                        this.outputText("both", false);
                    else
                        this.outputText("all", false);
                    this.outputText(" of your " + this.nippleDescript(0) + "s.  She eases up her grip a bit when she sees how bad it hurts, but she does not release them.  The noisy squelching of her cunt fucking you draws your attention back to your groin.  Your body begins thrusting up to meet her, finally understanding it's on the receiving end of a passionate screw.  ", false);
                    if (this.player.biggestTitSize() >= 2)
                        this.outputText("Your " + this.allBreastsDescript() + " bounce and jiggle obscenely as the goblin twists and pulls, abusing your nipples.", false);
                    else
                        this.outputText("Your " + this.nippleDescript(0) + "s burn with pain as the goblin twists and pulls on them, abusing them.  Pleasure and pain mix together, overwhelming you, reducing your world to little more than the slap of genital against genital and the painful torture happening to your chest.\n\n", false);
                    ...
                    this.outputText("That's all the encouragement you need.  ", false);
                    if (this.player.balls > 0)
                        this.outputText("Your " + this.ballsDescriptLight() + " twitch powerfully, venting their contents, releasing a jet of hot cum into the goblin.", false);
                    else
                        this.outputText("Your body's internal muscles twitch, pushing a jet of hot cum into the goblin.", false);
                    this.outputText("  Tamani wriggles happily, giving your nipples one last tweak before releasing them to play with her own.  Rope after rope of your goopey jism paints the inside of her canal, and the happy slut only begs for more the whole time.", false);
                    if (this.player.cumQ() >= 250)
                        this.outputText("  After a while you can feel the pressure building inside her, starting to give her a bit of a belly.  Tamani rubs it and begs, \"<i>More!</i>\"", false);
                    if (this.player.cumQ() >= 500)
                        this.outputText("  Your body fulfills her requests and more, stuffing her until she's positively pregnant and your spunk is squirting from her entrance with each wave of sticky spooge.", false);
                    else
                        this.outputText("  Sadly, you only manage a few more spurts before your orgasm ends.", false);
                    ...
                    if (this.player.cumQ() < 250)
                        this.outputText(".  I really enjoy our fucks " + this.player.mf("stud", "hun") + ", and I can't wait to 'bump' into you again.", false);
                    else {
                        this.outputText(".  You make sure and let your ", false);
                        if (this.player.balls > 0)
                            this.outputText(this.ballsDescriptLight() + " fill back up with cum, ok?", false);
                        else
                            this.outputText(this.cockDescript(0) + " fills back up with cum, ok?", false);
                    }
                    this.outputText("</i>\"\n\n", false);
                    //Combat end: 
                    if (this.getGame().inCombat) {
                ...
                //(Doesnt fit)
                    ...
                    this.outputText("Tamani turns about, dragging her wet gash across you and giving you a nice view of her plump butt-cheeks.  She looks over her shoulder and sucks on one of her lacquered fingernails, looking equal parts mischievous and sexy.   You rock your hips under her until she gives your ", false);
                    if (this.player.balls > 0)
                    ...
                    this.outputText("You pout, protesting meekly as she ", false);
                    if (this.player.balls > 0)
                        this.outputText("lifts up your " + this.ballsDescriptLight(), false);
                    else
                        this.outputText("leans forwards, looking between your legs", false);
                    this.outputText(", and places the dildo's leaking tip against your " + this.assholeOrPussy() + ".  You feel it stretching you out, reacting with your body's own fluids to swell up inside you like a pervert's balloon as Tamani pushes it further and further inside you.", false);
                    if (this.player.hasVagina()) {
                        this.outputText("  ", false);
                        this.player.cuntChange(this.player.vaginalCapacity() * .95, true);
                        this.outputText("Your walls squeeze tightly around it in an unconscious milking motion as your body reacts to it as if it were a real dick.", false);
                    }
                    else {
                        this.player.buttChange(this.player.analCapacity() * .95, true);
                        this.outputText("Your body clamps down around it, resisting the strange intrusion as it swells up to fill you, pressing tightly against your prostate.", false);
                    }
                    this.outputText("  A burning heat radiates through your body, making your " + this.nippleDescript(0) + " tingle and grow ever more sensitive.\n\n", false);
                    this.outputText("Tamani rocks back and forth, sliding herself against your " + this.cockDescript(0) + ", humping it lewdly as your veins rub her hard little nub of a clit.  She pants, making sure to keep giving you sultry looks over her shoulder, licking her glossy lips as she brutally teases you.  You can feel her getting off over and over as she grinds, sliding faster and faster on your shaft.   For your part, your " + this.cockDescript(0) + " begins making a puddle of pre-cum on your belly as the dildo's drug-like cum affects you, making you feel horny and hot.\n\n", false);
                    this.outputText("The kinky goblin dominatrix on your " + this.cockDescript(0) + " leans even further forwards, angling the dildo in your " + this.assholeOrPussy() + " upwards to squeeze your ", false);
                    if (this.player.hasVagina())
                        this.outputText("cock's base ", false);
                    else
                        this.outputText("prostate ", false);
                    this.outputText(" with delicious intensity.  You quiver underneath her, panting and moaning, totally subservient to the tiny girl giving your body the sexual workout of a life-time.  She slides back, her cunt squishing back and forth against your prick-head, driving you wild.  She coos, \"<i>Go ahead and cum stud,</i>\" while squeezing your ", false);
                    if (this.player.balls > 0)
                    ...
                    this.outputText("Your body immediately and happily complies, squirting a jet of thick white jism onto the goblin's jiggling ass-cheeks.  She slides down, aligning her cunt with your swollen cock-tip, taking the next squirt directly between her lips as she rubs against you.  Tamani slaps the dildo in your " + this.assholeOrPussy() + " gently, squeezing out an incredibly thick gout of semen as she stretches you wider.  ", false);
                    if (this.player.cumQ() >= 250) {
                        this.outputText("You cum harder and harder, pushing her back a bit and splattering her belly with white cream.  She moans, rubbing it into her skin and twat", false);
                        if (this.player.cumQ() >= 500)
                            this.outputText(" as you keep cumming, splattering her tits and face, soaking the little goblin slut", false);
                        this.outputText(".  ", false);
                    }
        ...
        tamaniSexLost() {
            ...
            this.tamaniKnockUp();
            this.outputText("", true);
            this.outputText("Tamani gives you a knowing smile as you ", false);
            if (this.player.HP < 1)
                this.outputText("lie there, unable to fight back.  ", false);
            else
                this.outputText("touch yourself, giving in to the tiny goblin's desire to breed.  ", false);
            this.outputText("She advances, her bare feet padding across the soil as she rummages in a faded leather pouch for something.  Her eyes light up as she finds whatever it is she was looking for.  In her hand is a ribbed silver ring, covered on every surface with numerous carved runes.  You whimper and back up, knowing she intends to fit it over your " + this.cockDescript(0) + ", but Tamani only 'tsks' and shakes her head.\n\n", false);
            this.outputText("\"<i>You were such a naughty boy, teasing me with that juicy dick and then pretending like you didn't want this.  I'll have to punish you for being bad, that's all there is to it,</i>\" she explains, pushing your hands away and fitting the ring around your flare.  ", false);
            if (this.player.cocks[0].cockThickness >= 5)
                this.outputText("Impossibly, despite your titanic girth, the ring somehow expands to squeeze onto you, though it's painfully tight.\n\n", false);
            else
                this.outputText("Somehow the ring fits onto you perfectly, as if it was made exactly for your " + this.cockDescript(0) + ", though it remains painfully tight.\n\n", false);
            ...
            if (this.player.biggestTitSize() >= 6)
                this.outputText("but can't manage to see your bloated prick past the wall of titflesh.\n\n", false);
            else
                this.outputText("at your bloated prick, looking almost overinflated from all the blood that tight ring has forced into it.\n\n", false);
            this.outputText("<b>*SMACK*</b>  Tamani's hand cracks against your " + this.buttDescript() + " making you lurch and bite back a cry of pain.   \"<i>Bad boys get punished!</i>\" she yells as she brings her hand down again, slapping your other cheek.  You're sure there must be two tiny red hand-prints forming already. The kinetic impacts of her blows vibrate through your hips, traveling into your sensitive " + this.cockDescript(0) + " and working with the magic-ring to spread equal measures of pain and pleasure through its length.\n\n", false);
            ...
            this.outputText("Your goblin mistress ", false);
            if (this.player.balls > 0)
                this.outputText("cups your " + this.ballsDescriptLight() + " tightly", false);
            else
                this.outputText("caresses you around the ring", false);
            ...
            this.outputText("You NEED to cum.  Her hands... they keep stroking you, and each time your body begins to orgasm it's held back, trapped within you painfully.  ", false);
            if (this.player.balls > 0)
                this.outputText("Your balls are getting VERY swollen and tender.", false);
            else
                this.outputText("Your body aches inside, feeling bloated and ready to pop.", false);
            if (this.player.cor < 50)
                this.outputText("  You have no choice, you'll say what she wants you to say.\n\n", false);
            else
                this.outputText("  Being denied like this was kind of fun, but you REALLY need to get off now, so you'll say what she wants you to say.\n\n", false);
            this.outputText("\"<i>Mistress Tamani, I'm so sorry!  Milk my cock dry any time you want!  Puhleeeeeaaaaase let me cum!  Please, I'm so fucking horny, I'll do what you want, just give me release!</i>\" you beg, ", false);
            if (this.player.cor > 50)
                this.outputText("blushing hotly and doing your best to look like a submissive toy.\n\n", false);
            else
                this.outputText("blushing in shame and embarrassment, but meaning every word.\n\n", false);
            ...
            if (this.player.cumQ() >= 250)
                this.outputText("  The bottle quickly overflows, but Tamani happily sets it aside and slides her own cunt under you, letting you pump the rest of your seed into her fertile womb.", false);
            if (this.player.cumQ() >= 500)
                this.outputText("  She coos happily when you still manage to pump enough jism into her to bloat her belly, but even with your impressive fertility, the orgasm has to end.", false);
            this.outputText("\n\n", false);
        ...
        tamaniSexWon() {
            this.spriteSelect(56);
            this.tamaniKnockUp();
            var x = this.player.cockThatFits(90);
            if (x == -1)
            ...
            if (this.player.cockArea(x) <= 90) {
                ...
                this.outputText("It's too tempting of a target to resist.  You open your " + this.player.armorName + " and allow your " + this.multiCockDescriptLight() + " to flop free.  You're already hard from the enticing display, and in a moment you're pressing against her lust-slicked pussy", false);
                if (this.player.totalCocks() > 1)
                    this.outputText(" and tight asshole", false);
                this.outputText(".  You don't allow her any say in the matter, pushing forward as you feel the small girl's flesh yield around ", false);
                if (this.player.totalCocks() > 1)
                    this.outputText("each of ", false);
                this.outputText("your girth", false);
                if (this.player.totalCocks() > 1)
                    this.outputText("s", false);
                this.outputText(".  She squeals happily, clearly getting what she desires.  For a moment you feel disappointed in yourself, but the sensations of her tight hole", false);
                if (this.player.totalCocks() > 1)
                    this.outputText("s", false);
                this.outputText(" clenching and squeezing around you quickly washes it away.\n\n", false);
                this.outputText("You rock back and forth methodically, treating Tamani like a tight cock-sleeve.  The goblin slut's hands rub her belly, not even attempting to pull her face out of the mud as she moans and giggles like a whore.  You keep working her cunt like a ", false);
                if (this.player.gender == 1)
                    this.outputText("man", false);
                else
                    this.outputText("herm", false);
                this.outputText(" possessed, sawing in and out with brutal efficiency, the wet squelches of the slut's juices driving you to piston back and forth with even greater force.  She gurgles happily, her ", false);
                if (this.player.totalCocks() == 1)
                    this.outputText("pussy squeezing tightly as she cums hard.\n\n", false);
                else
                    this.outputText("holes squeezing tightly as she cums hard.\n\n", false);
                if (this.player.totalCocks() > 1) {
                    this.outputText("Each of your " + this.multiCockDescriptLight() + " pulsates, spasming inside your goblin-flesh prison, spraying a bit of sticky goo into the happy slut.   You can hear her babbling, pleasure-drunk as she quivers around you, \"<i>Fuck yes! Cu-ah-ahm in me!  Fuck fuckfuckfucKFUCKYEAH!  Oooh, that's it, put me in the dirt and show me who's boss!</i>\"  The words seem to have the desired effect, helping you empty every ounce of cock-cream into the slut's tight holes.", false);
                    if (this.player.cumQ() >= 250)
                        this.outputText("  She pants, turning her head in the mud to watch as her belly visibly inflates, stuffed totally full of cum. ", false);
                    if (this.player.cumQ() >= 500)
                        this.outputText("  In no time at all a river of jism pours from her, pooling below as you overwhelm her body's capacity to store spunk.", false);
                }
                else {
                    this.outputText("Your " + this.multiCockDescriptLight() + " pulsates, spasming inside your goblin-flesh prison, spraying a bit of sticky goo into the happy slut.   You can hear her babbling, pleasure-drunk as she quivers around you, \"<i>Fuck yes! Cu-ah-ahm in me!  Fuck fuckfuckfucKFUCKYEAH!  Oooh, that's it, put me in the dirt and show me who's boss!</i>\"  The words seem to have the desired effect, helping you empty every ounce of cock-cream into the slut's tight hole.", false);
                    if (this.player.cumQ() >= 250)
                        this.outputText("  She pants, turning her head in the mud to watch as her belly visibly inflates, stuffed totally full of cum. ", false);
                    if (this.player.cumQ() >= 500)
                        this.outputText("  In no time at all a river of jism pours from her, pooling below as you overwhelm her body's capacity to store spunk.", false);
                }
                this.outputText("\n\nTamani winks, sucking on her finger as she staggers up.  She coos, \"<i>Mmmm, Tamani loves it when her " + this.player.mf("sexy lover", "stud") + " dominates her.  Do you think your ", false);
                if (this.player.balls > 0)
                    this.outputText("sexy balls have ", false);
                else
                    this.outputText("sweet cock has ", false);
            ...
            //Too big? Jerk off with feet and bukkake
                ...
                this.outputText("You throw Tamani on her back, too drunk on desire to care how it feels for the tiny slut.  There's no way she could ever take ", false);
                if (this.player.totalCocks() > 1)
                    this.outputText("any of your massive members", false);
                else
                    this.outputText("your massive member", false);
                ...
                if (this.player.cumQ() >= 250)
                    this.outputText("  You continue working your " + this.cockDescript(x) + " with her supple feet, watching your dripping spooge froth and bubble as you continue to pump more onto the sassy wench.", false);
                if (this.player.cumQ() >= 500)
                    this.outputText("  She sputters, blowing some of the caked up semen off her face so she can breathe.  The slut gathers up the goopy mess as you continue to paint her, alternatively devouring it with her mouth and shoveling drippy handfuls into her eager cunt.", false);
                this.outputText("\n\n", false);
                this.outputText("Tamani winks, blinking the cum out of an eye as you finish up, releasing her seed-covered form.  She coos, \"<i>Mmmm, Tamani loves it when you dominate her, " + this.player.mf("stud", "sexy") + ".  Do you think your ", false);
                if (this.player.balls > 0)
                    this.outputText("sexy balls have ", false);
                else
                    this.outputText("sweet cock has", false);
                ...
                this.outputText("Tamani wiggles in the sexiest way as she leaves, arousing your body all over again...", false);
                this.player.orgasm();
        ...
        tamaniPregnantFuck() {
            ...
            //(Very large: 
            if (this.flags[kFLAGS_1.kFLAGS.TAMANI_TIMES_IMPREGNATED] > 6)
                this.outputText("  They're almost too big for you to handle; they probably make it hard for the poor girl to walk.", false);
            this.outputText("\n\n", false);
            this.outputText("Tired of the teasing, Tamani yanks her nipples free of your mouth and kisses you fiercely.  Her lips are hot, almost feverish, and taste of sweet cherries.  Fiery warmth races through your body, collecting at your groin as her tongue curls around yours.  She sucks on your lower lip before pulling back and giving you an all-too-knowing smile.  Your " + this.cockDescript(0) + " is just getting harder and harder, so tight it almost hurts.  You whine softly as Tamani wraps her feet around it, stroking it with her bare soles as she pulls herself down.\n\n", false);
            ...
            if (this.player.cockArea(0) <= 50) {
                ...
                if (this.player.balls > 0)
                    ...
                    this.outputText("genitals", false);
            ...
            //(Doesn't Fit)
                ...
                this.outputText("\"<i>Sorry " + this.player.mf("stud", "lover") + ", you're just too big and <b>hard</b> for me.   Don't worry, I'll help you unload everything straight into my sweet cunt,</i>\" she apologizes, ", false);
                if (this.player.balls > 0)
                    this.outputText("massaging your balls with her feet", false);
                else
                    this.outputText("jacking the base of your " + this.cockDescript(0) + " with her feet", false);
                ...
                this.outputText("Tamani grinds on you a bit longer before staggering up and stretching.  She pauses to get a narrow bottle and abruptly jams the end into your urethra.  With one practiced motion, she squeezes your " + this.cockDescript(0) + " from bottom to top, squeezing the last of your spoo into the container.  She pops it free, corks it, and pockets it.  She pats her pockets and explains, \"<i>A few of the girls back home aren't pregnant, and I thought you might like to help contribute to the local slut population.  Don't worry though baby, I'll always own your cock.</i>\"\n\n", false);
                this.flags[kFLAGS_1.kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] += 3;
        ...
        tamaniPoopsOutBabies() {
            this.spriteSelect(56);
            this.outputText("", true);
            this.outputText("You hear orgiastic screams in the distance as you explore.  You turn to investigate, and as you go, they become even louder and higher pitched.  You crest a rise and find Tamani ", false);
            if (this.flags[kFLAGS_1.kFLAGS.TAMANI_NUMBER_OF_DAUGHTERS] > 0)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT] > 2) {
                this.outputText("  Moments later a third appears", false);
                if (this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT] > 3) {
                    this.outputText(", a fourth", false);
                    if (this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT] == 5) {
                        this.outputText(", and a fifth", false);
                    }
                    else
                        this.outputText(", and more than you can count", false);
                }
                this.outputText(".", false);
            }
            this.outputText("\n\n", false);
            if (this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT] == 2) {
                this.outputText("The twins drink deeply, growing taller before your eyes as Tamani comes out of her pregnancy induced orgasms.", false);
            }
            else {
                this.outputText("The goblin children drink deeply, squabbling for a chance at suckling the nipples as their mother recovers from her birthing-induced orgasms.", false);
            }
            this.outputText("  She looks up at you and whispers breathily, \"<i>Come fuck me a little later, I'll give you even more beautiful little girls.  These " + TamaniScene.num2Text(this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT]) + " will be fully grown in a week or two and out man-hunting, but none of them will please you like me, I promise.</i>\"\n\n", false);
        ...
        tamaniKnockUp() {
            if (this.pregnancy.isPregnant)
                return; //Already preggers
            this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_PLAYER, 216); //Nine day long pregnancy
            //Determine how many kids...
            this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT] = 2;
            var cum = this.player.cumQ();
            //Breeder perk is awesome
            if (this.player.findPerk(PerkLib_1.PerkLib.MaraesGiftStud) >= 0)
                this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT] += 3;
            if (cum >= 50 && TamaniScene.rand(2) == 0)
                this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT]++;
            if (cum >= 100 && TamaniScene.rand(2) == 0)
                this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT]++;
            if (cum >= 200 && TamaniScene.rand(2) == 0)
                this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT]++;
            if (cum >= 300 && TamaniScene.rand(2) == 0)
                this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT]++;
            if (cum >= 400 && TamaniScene.rand(2) == 0)
                this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT]++;
            if (cum >= 500 && TamaniScene.rand(2) == 0)
                this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT]++;
            if (cum >= 600 && TamaniScene.rand(2) == 0)
                this.flags[kFLAGS_1.kFLAGS.TAMANI_PREGNANCY_COUNT]++;
        }
        encounterTamani() {
            //Fems:
            ...
            //Dudezillaz:
            else if (this.flags[kFLAGS_1.kFLAGS.TAMANI_MET] == 0) {
        ...
        getRapedByTamaniYouHypnoSlut() {
            ...
            var primary = this.player.cockThatFits(65);
            var secondary = 0;
            ...
            //[FITS]
            if (primary >= 0) {
                this.outputText("Tamani is completely right.  You grab her ass, feeling your fingers sink in to her supple flesh as you pull her back towards your ", false);
                if (cocks > 0)
                    this.outputText("main ", false);
                this.outputText(this.cockDescript(0) + ".  Her warmth spreads over your " + this.player.cockHead(primary) + " slowly, making you twitch and drip inside her, lubricating her already dripping channel with even more slick fluids.  With a mighty heave you push inside her, feeling yourself penetrating deep inside her, directly into her fertile womb.  Tamani rubs your " + this.player.legs() + " with her hands, giving you a massage as you bottom out against her, feeling her juices stain your ", false);
                if (this.player.hasSheath())
                    this.outputText("sheath", false);
                else
                    this.outputText("crotch", false);
                this.outputText("\n\n", false);
                this.outputText("You wait a second, adjusting to the feeling of being completely contained by such a warm, wet hole before you slowly push her away.  The slick walls of her tunnel clench around you as you pull her back, massaging the parts of you still inside her.  ", false);
                if (cocks > 1) {
                    if (primary > 0)
                        secondary = 0;
                    else
                        secondary = 1;
                    this.outputText("She moans and pulls your " + this.cockDescript(secondary) + " into her mouth, running her tongue around the tip and sliding her palm along the underside.", false);
                }
                else
                    this.outputText("She moans and pants, babbling about how good you are to her the whole time.", false);
                this.outputText("  You don't stop until your " + this.player.cockHead(primary) + " is the only thing inside her.\n\n", false);
                this.outputText("  The second thrust is even better than the first.  It's slippery, hot, and passionate, and the idea of slowing down or stopping for any reason is inconceivable.  Tamani pants with each thrust, pawing at her bouncing breasts, grabbing one by the nipple with a free hand and moaning loudly", false);
                if (cocks > 0)
                    this.outputText(" around your " + this.cockDescript(secondary), false);
                this.outputText(". Her tiny form jiggles, ", false);
                if (this.player.tallness > 55)
                    this.outputText("lifting off the ground as you get into it, giving yourself over to her sex.", false);
                else
                    this.outputText("nearly falling over as you give your body over to her sex.", false);
                this.outputText("  She visibly orgasms, shaking and trembling from head to toe as her pussy milks your " + this.cockDescript(primary) + ".  It only lasts a few seconds, though they feel like heaven, before her body goes nerveless.\n\n", false);
                this.outputText("Taking that as an opportunity, you pick up the pace, plunging yourself in and out of her with a renewed, almost vicious vigor.  The wet slaps of your juice-", false);
                if (this.player.skinType == appearanceDefs_1.SKIN_TYPE_FUR)
                    this.outputText("matted", false);
                else
                    this.outputText("slicked", false);
                this.outputText(" " + this.player.skinDesc + " impacting her ass fill the air.  You fuck your wife harder and faster with every stroke, knowing you won't last more than a few more thrusts before you're painting her womb white.  Your wife is too cummed out to care or respond, ", false);
                if (cocks == 1)
                    this.outputText("her tongue hanging out as she pants nonsensical pleasure-noises.", false);
                else
                    this.outputText("and her mouth is too full of " + this.cockDescript(secondary) + " to do anything but gurgle out nonsensical pleasure-noises.", false);
                this.outputText("  Swelling wider inside the wet hole, your " + this.cockDescript(primary) + " tingles and clenches, about to unload.\n\n", false);
                this.outputText("An intense orgasm rolls through you, making your body clench as your piston your " + this.cockDescript(primary) + " forwards, burying it deeply inside the goblin-shaped cum-receptacle.  ", false);
                if (this.player.hasKnot(primary))
                    this.outputText("Your knot balloons inside her, locking her in place", false);
                else if (this.player.cocks[primary].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                    this.outputText("Your flare widens, actually holding itself inside Tamani's womb", false);
                else if (this.player.cocks[primary].cockType == CockTypesEnum_1.CockTypesEnum.DEMON)
                    this.outputText("The corrupted nodules along your " + this.cockDescript(primary) + " pulsate in rippling, wave-like motions, massaging the interior of Tamani's twat", false);
                else if (this.player.cocks[primary].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE)
                    this.outputText("Your tentacle-cock's tip widens, becoming mushroom-like inside Tamani's womb", false);
                else
                    this.outputText("Your sensitive head swells slightly in time with the contractions of your orgasm", false);
                this.outputText(" as you begin to fill your wife's womb with seed.   The orgasm is intense", false);
                if (this.player.cumQ() < 50)
                    this.outputText(", but brief, and after a few moments of spasming pleasure, the flood of cum slows to a trickle.", false);
                else if (this.player.cumQ() < 300)
                    this.outputText(" and voluminous, forcing more and more seed into Tamani's uterus until she sloshes with each new squirt.  After a few long moments of spasming pleasure, the flood of cum slows to a trickle.", false);
                else {
                    this.outputText(" and massive, squirting thick gouts of semen directly into Tamani's waiting womb until each new explosion of spunk makes her slosh.  She moans, her belly bloating slightly until she's unable to take any more.", false);
                    if (this.player.cumQ() < 1000)
                        this.outputText("  Though your orgasm tapers off, the additional seed squirts from between her thighs, trickling down to a slow drip of viscous white goo.", false);
                    else
                        this.outputText("  Trapped inside her and cumming as hard as ever, you raise the pressure inside the goblin until your seed is washing out of her cunt around you, puddling on the ground.", false);
                    if (this.player.cumQ() >= 1000 && this.player.cumQ() < 4000)
                        this.outputText("  It does eventually end, but not until a sizable puddle has formed between the pair of you.", false);
                    else
                        this.outputText("  It lasts seemingly forever, and by the time you're done, the two of you are standing in a puddle inches deep.", false);
                }
                if (cocks > 1) {
                    this.outputText("  During it all Tamani's throat works to swallow every drop", false);
                    if (this.player.cumQ() > 300) {
                        this.outputText(", but before long she's failing, with cum leaking out from the corners of her mouth.", false);
                        if (this.player.cumQ() > 600)
                            this.outputText("  A few seconds later she pulls back coughing, and the perky goblin takes the rest of your load in her face.", false);
                    }
                    else
                        this.outputText(".", false);
                }
                this.outputText("\n\n", false);
                this.outputText("Joined at the hips, the two of you manage to stay upright, each leaning into the other", false);
                if (this.player.tallness > 55)
                    this.outputText(" in spite of the height differential", false);
                this.outputText(".  Tamani regains her senses and pushes you back, waddling slightly after the intense fuck.   White jism and clear feminine fluids drool down her thighs, and your mistress couldn't be happier.  She pets your still-dripping " + this.cockDescript(primary) + " affectionately as she says, \"<i>You're such a wonderful husband.  I can't wait to see how you get along with your new daughters!</i>\"\n\n", false);
                this.outputText("A surge of pride spreads through you at her praise, and you lean down to give your wife a long french kiss before heading back to camp.  On the way back your head slowly clears, and you wonder what came over you back there?!", false);
                this.tamaniKnockUp();
                this.player.orgasm();
            ...
            //[DOESNT FIT]
                ...
                if (cocks > 1)
                    this.outputText("main ", false);
                this.outputText(this.cockDescript(0) + ".  Her warmth spreads over the " + this.player.cockHead() + " of your " + this.cockDescript(0) + ", but will go no further.  You tug harder on her bouncing backside, but you're simply too large to fit inside your wife's beautiful pussy.  She turns around and places a small hand ", false);
                if (this.player.biggestTitSize() < 1)
                    this.outputText("on your chest ", false);
                else
                    this.outputText("between your " + this.breastDescript(0) + " ", false);
                this.outputText(" and commands, \"<i>Stop, you're just too big of a man for Tamani to do it the old fashioned way.</i>\"\n\n", false);
                this.outputText("Disgruntled but obedient, you stop your vaginal assault and release your wife.  It seems she has another way for your aching " + this.cockDescript(0) + " to perform its duties anyway.  Tamani turns around and pulls out some clear tubing, along with a floppy, flexible sheath while she explains, \"<i>I'll just have to get you off and let you pump all your babies into me with this!</i>\"\n\n", false);
                this.outputText("Her small, dextrous fingers wrap the upper half of your ", false);
                if (cocks > 1)
                    this.outputText("primary ", false);
                this.outputText(this.cockDescript(0) + " inside the sheath, constricting it inside the tight, transparent material.  You sigh while you endure the treatment, disappointed you won't get to feel her clenching about you as you pour sperm into her fertile womb. She finishes up, slowly pushing the tube up her gorgeous, feminine hole until you're certain it'll be depositing your precious cargo into her deepest recesses. Tamani claps her hands together excitedly, \"<i>I haven't had a man big enough to use this with until you.  Oh husband, you're going to love this, just lie back for Tamani, okay?</i>\"\n\n", false);
                this.outputText("You do as you are told, like a good husband, and Tamani stays close, bound to you by a flexible, artificial umbilical.  She sits next to you, propping her feet up onto your " + this.cockDescript(0) + ".   The goblin doesn't have any shoes on her green-tinted feet, and in spite of the rough living conditions, they're softer than her hands, and nearly as dextrous.  You look over at her, questioningly at first, though it shifts to confused happiness as she begins stroking her left foot up and down your length.  Your wife shifts her right leg underneath you, and curls her toes around to interlock them with her left.\n\n", false);
                this.outputText("With both her feet locked together, wrapped around most of your sensitive " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + " and sliding along it, your petite wife begins giving you the foot-job of a lifetime.  The awkward position and intense desire make the both of you break out in a sweat, and before long her slippery feet are lubricated enough for her to pick up the tempo.  You rock against her soles, gazing lovingly into her eyes as she fondles her clit and gives you a perverted wink.  Tamani exclaims, \"<i>Oooh, I can feel you twitching under my toes!  Does Tamani's little feet feel good on her ", false);
                if (this.player.tallness > 60)
                    this.outputText("big ", false);
                this.outputText(this.player.mf("strong man's", "sexy lover's") + " " + Appearance_1.Appearance.cockNoun(CockTypesEnum_1.CockTypesEnum.HUMAN) + "?</i>\"\n\n", false);
                this.outputText("You assure her that they do like what she is doing – very much so – and ", false);
                if (this.player.cor < 33)
                    this.outputText("beg", false);
                else if (this.player.cor < 66)
                    this.outputText("ask", false);
                else
                    this.outputText("command", false);
                ...
                if (this.player.cumQ() > 250)
                    this.outputText("  In no time, you've filled her to capacity, and white mixes in with the clear sexual fluids that are dripping from the goblin's cunt.", false);
                if (this.player.cumQ() > 700)
                    this.outputText("  A few more blasts visibly bloat her belly, and Tamani pulls her hands away from her pussy to stroke the slowly rounding dome on her abdomen.", false);
                if (this.player.cumQ() > 1500) {
                    this.outputText("  You just keep cumming, forcing the spooge to squirt out around the tube, puddling on the ground", false);
                    if (this.player.cumQ() > 3000)
                        this.outputText(", and by the time you finish, both of you are in a thick puddle of spunk", false);
                    this.outputText(".", false);
                }
                if (cocks > 1) {
                    if (cocks == 2)
                        this.outputText("  Your other" + this.cockDescript(1), false);
                    else
                        this.outputText("  Each of your other " + this.multiCockDescriptLight(), false);
                    this.outputText(" splatters its own orgasmic juice everywhere, making a thorough mess of things, but neither of you seem to mind.", false);
                }
                this.outputText("\n\n", false);
                this.outputText("Tamani smiles as she pulls the tube out and stands up.  White jism and clear feminine fluids drool down her thighs, and your mistress couldn't be happier.  She peels her device off your still-dripping " + this.cockDescript(0) + ", pats it affectionately, and says, \"<i>You're such a wonderful husband.  I can't wait to see how you get along with your new daughters!</i>\"\n\n", false);
                this.outputText("A surge of pride spreads through you at her praise, and you get up to give your wife a long french kiss before heading back to camp.  On the way back your head slowly clears, and you wonder what came over you back there?!", false);
                this.tamaniKnockUp();
                this.player.orgasm();
                this.dynStats("int", -.5, "sen", -1);
            }
        ...
        tamaniBeaten() {
            ...
            if (this.player.hasCock())
                this.outputText("licks her lips in anticipation, eyes locked on [eachCock]");
            else
                this.outputText("frowns in displeasure, noting your lack of a penis");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_OVIPOSITED_TAMANI] == 0)
                this.outputText("my baby-" + this.player.mf("daddy", "momma"));
            else
                this.outputText("my egg-obsessed arachnophile");
            ...
            this.outputText("\n\nTamani exhales, \"<i>Eyes up here, " + this.player.mf("stud", "breeder") + ".  I want to watch your face while you fuck me,</i>\" in a tone that promises delights beyond imagining.  \"<i>Put it in my pussy and give me your babies.  There's nothing like fucking a woman who'll take your cock straight into her womb and let you bathe her eggs with cum");
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_OVIPOSITED_TAMANI] > 0)
                this.outputText(", or in your case even more eggs");
            ...
            if (this.player.hasCock())
                this.outputText("  White coats the goblin from her shoulders up, the only evidence of your male satisfaction.  You were so focused on the act of impregnation and the unique pleasure that it provides that you barely noticed [eachCock] erupting in sympathetic pleasure.");
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_OVIPOSITED_TAMANI]++;
    ...
    exports.TamaniScene = TamaniScene;
});
//# sourceMappingURL=TamaniScene.js.map