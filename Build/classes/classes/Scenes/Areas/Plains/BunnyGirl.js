define(["require", "exports", "../../../BaseContent", "../../../GlobalFlags/kFLAGS", "../../../../../includes/appearanceDefs", "../../../PregnancyStore"], function (require, exports, BaseContent_1, kFLAGS_1, appearanceDefs_1, PregnancyStore_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class BunnyGirl extends BaseContent_1.BaseContent {
        isItEaster() {
        ...
        bunnbunbunMeet() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MET_BUNBUN] == 0) {
                this.outputText("A ", false);
                if (this.player.tallness > 64)
                    this.outputText("short ", false);
                ...
                if (this.player.lib > 50)
                    this.outputText("and you find yourself wondering what sort of treasures she conceals behind it.", false);
                else if (this.player.cor < 40)
                    this.outputText("and you find yourself thankful for her modesty.", false);
                else
                    this.outputText("and you find yourself considering tearing away the basket so you can see what she's hiding down there.", false);
                this.outputText("\n\n", false);
            ...
            //Met her
                ...
                this.choices("Your Vagina", DickInV, "Her Vagina", Vagina, "69", sixtyNine, "LayYourEggs", eggs, "Your Ass", this.bunbunFucksPCInAss, "", undefined, "", undefined, "", undefined, "", undefined, "Leave", this.camp.returnToCampUseOneHour);
            }
        }
        //[Talk]
        talkToBunnyBunBun() {
            this.spriteSelect(13);
            this.flags[kFLAGS_1.kFLAGS.MET_BUNBUN]++;
            this.outputText("", true);
            ...
            if (this.player.cockThatFits(40) >= 0) {
                ...
                this.outputText("  <b>You're too big to fit inside her...</b>", false);
            if (this.player.gender > 0) {
                sixtyNine = this.bunbun69;
                this.outputText("  Sixty-nine her?", false);
            }
        ...
        bunbunFucksYourVag() {
            ...
            if (this.player.weaponName != "fists")
                this.outputText(" and " + this.player.weaponName, false);
            ...
            if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_DROOLING)
                this.outputText("  Moisture leaks in a steady drizzle, mixing with bunny-pre to totally slick the soon-to-be invading member.", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_SLICK)
                this.outputText(", not that you needed it", false);
            ...
            if (this.player.vaginalCapacity() < 20)
                this.outputText("By the time you're getting close to the bottom you have to work to encompass her length and girth within your velvet folds and grunt with discomfort from each new inch of throbbing fuck-stick, but you take it all.  ", false);
            else if (this.player.vaginalCapacity() < 50)
                this.outputText("By the time you get to the bottom you're panting and moaning, delighting in the feeling of being so perfectly impaled on a rigid fuck-stick.   With her entirely inside you, you're ready to fuck her in earnest.  ", false);
            else
                this.outputText("It doesn't take long to slide down the more-than footlong meat-pole, and to be honest you wish she was a bit bigger.  Your " + this.vaginaDescript(0) + " is so ready for big dicks that this disproportionate member is average at best.  Still, you clench your thigh muscles to wring it a little tighter, and swoon from the feeling of warm maleness filling your loins.  ", false);
            ...
            if (this.player.tallness >= 72) {
                ...
                if (this.player.cor < 33)
                    this.outputText("You'll have to try to slow your descent next time!  ", false);
                else
                    this.outputText("If she's going to fuck you like this, she can handle your weight!  ", false);
            }
            else
                this.outputText("Your bodies clap together with a loud squish of copious sexual fluids, and another thick burble of pre warms your cunny.  ", false);
            ...
            if (this.player.clitLength >= 4)
                this.outputText("  Your " + this.clitDescript() + " bounces on her belly, tingling like mad every time it slaps into her tanned, sweat-slicked skin.", false);
            if (this.player.biggestLactation() >= 1)
                this.outputText("  Milk begins to bead on your " + this.player.allBreastsDescript() + " from the sensation of the bunny's brutal, almost mechanical fucking.", false);
            ...
            if (this.player.clitLength >= 4)
                this.outputText("fondle your " + this.clitDescript() + " a moment before wrapping your hand around it and stroking the girl-cock excitedly.", false);
            else
                this.outputText("caress your " + this.clitDescript() + " a moment before you start to circle it with a finger, teasing it expertly.", false);
            if (this.player.cockTotal() > 0) {
                this.outputText("  " + this.SMultiCockDesc() + " twitches and drools ", false);
                if (this.player.cocks[0].cockLength < 10)
                    this.outputText("on the bunny's belly", false);
                else if (this.player.cocks[0].cockLength < 18)
                    this.outputText("between the bunny's tiny tits", false);
                else if (this.player.cocks[0].cockLength < 28)
                    this.outputText("on the bunny's face", false);
                else
                    this.outputText("past the bunny's head", false);
                this.outputText(", and your free hand wastes no time in tending to your male ");
                if (this.player.cockTotal() == 1)
                    this.outputText("half's needs, slathering it in pre-cum and stroking hard and fast.", false);
                else
                    this.outputText("halfs' needs, slathering them in pre-cum and stroking hard and fast.", false);
            }
            ...
            if (this.player.cockTotal() > 0) {
                ...
                if (this.player.cumQ() > 500)
                    this.outputText("  Not content with that, " + this.sMultiCockDesc() + " continues to pump until the bunny is coated with a generous layer of seed", false);
                if (this.player.cumQ() > 2000)
                    this.outputText(" and the excess is running down the hill in a small river", false);
                if (this.player.cumQ() > 500)
            ...
            if (this.player.bunnyScore() < 4)
                this.outputText("It's so good to finally think straight!  I don't know why I went into heat right now, but it's so much easier to think now that I've gotten rid of those eggs.  Don't worry, you won't be popping out rabbits since you aren't an easter-bun.  Your body will probably absorb them in a few days.  Just don't be surprised if you feel a little bloated or feel a little weird after.</i>\"\n\n", false);
            //Pregnant already
            else if (this.player.pregnancyIncubation > 0)
                this.outputText("It's so good to finally think straight!  I don't know why I went into heat right now, but it really is a shame you're pregnant.  Your body will destroy the little eggs before they can even do anything!  Well, at least I feel sooo much better...</i>\"\n\n", false);
            //Preggers
            else
                this.outputText("It's so good to finally think straight!  I don't know why I went into heat right now, but it feels so good to pour my babies into a nice, ready breeder-mom like yourself.  I bet the kids come out so cute!  Oh, I feel so much better.</i>\"\n\n", false);
            ...
            if (this.player.bunnyScore() < 4) {
                this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_BUNNY, PregnancyStore_1.PregnancyStore.INCUBATION_BUNNY_EGGS);
            }
            else {
                this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_BUNNY, PregnancyStore_1.PregnancyStore.INCUBATION_BUNNY_BABY, 60);
            }
            this.player.orgasm();
        ...
        bunbunFucksPCInAss() {
            ...
            if (this.player.analCapacity() < 20)
                this.outputText("it stretches you dangerously wide as you slide down the thick shaft.  The further down it gets, the more you have to work to relax your muscles and push yourself along.  With enough time, patience, and copious bunny-pre, you manage to take it completely inside you.  It twitches happily while you adjust to the intrusion, but you know you're just getting started.", false);
            else if (this.player.analCapacity() < 40)
                this.outputText("you have to keep pausing as you slide down to let more of her pre-cum bubble out and lubricate the fourteen inch shaft.  It fills you nicely, pressing on your innards in all the right ways as you slowly engulf the bunny-cock with your " + this.assholeDescript() + ".  After bottoming out, your nervous lover's prick pulsates happily inside you, but you're just getting started.", false);
            else {
                ...
                if (this.player.cor < 50)
                    this.outputText("girl", false);
                else
                    this.outputText("bitch", false);
            ...
            if (this.player.totalCocks() > 0)
                this.outputText("Each time she bumps and slides past your prostate a dollop of your pre-cum spurts from " + this.sMultiCockDesc() + " onto the ground, and you have a hard time not using your new lover like an anal toy and masturbating yourself.  ", false);
            ...
            if (this.player.hasVagina()) {
                if (this.player.vaginas[0].vaginalWetness >= appearanceDefs_1.VAGINA_WETNESS_SLICK)
                    this.outputText("Juices begin to run from your " + this.vaginaDescript(0) + ", but you ignore the empty feeling and focus on the throbbing meat inside your backdoor.  ", false);
            }
            ...
            if (!this.player.hasFuckableNipples()) {
                ...
                if (this.player.biggestLactation() >= 1) {
                    ...
                    if (this.player.biggestLactation() >= 4)
                        ...
                        this.outputText("drops", false);
                    this.outputText(" of milk", false);
                }
                this.outputText(".", false);
            }
            else
                this.outputText("sliding inside them, fucking their cunt-like interiors as you start to lose yourself to the pleasure.", false);
            ...
            if (this.player.cockTotal() > 0) {
                ...
                this.outputText(", and your " + this.vaginaDescript(0) + " clenching and dripping on the verge of orgasm", false);
            this.outputText(".", false);
            if (this.player.biggestLactation() >= 1) {
            ...
            if (this.player.cockTotal() > 0) {
                ...
                this.outputText("and your arousal returns in force.", false);
            //(BUTT CHANGE HERE)
            ...
            if (this.player.cockTotal() > 0) {
                ...
                if (this.player.cumQ() > 500)
                    this.outputText("  The splattering of your seed only increases in volume as it makes a rather large puddle", false);
                if (this.player.cumQ() > 2000)
                    this.outputText(", but you just keep going until you create a lazily winding river of cum that flows its way through the grasses", false);
                if (this.player.cumQ() > 500)
                    this.outputText(".", false);
            }
            if (this.player.hasVagina())
                this.outputText("  Your " + this.vaginaDescript(0) + " clenches, empty, drooling, and neglected, wishing it something inside it.", false);
            this.outputText("\n\n", false);
            ...
            this.player.buttKnockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_BUNNY, PregnancyStore_1.PregnancyStore.INCUBATION_BUNNY_EGGS, 1, 1);
            this.player.orgasm();
        ...
        bunbunGetsFucked() {
            ...
            var y = this.player.cockThatFits2(40);
            ...
            if (y != -1)
                this.outputText(", taking care to align your " + this.cockDescript(y) + " with her tightly puckered backdoor as well.", false);
            else
                this.outputText(", barely able to restrain yourself as the time for penetration approaches.", false);
            this.outputText("\n\n", false);
            ...
            if (y != -1)
                this.outputText("She squeaks at the pressure on her tender asshole, but doesn't object as your pre-cum smears over it.  ", false);
            this.outputText("At once, her greedy breeding hole relaxes ", false);
            if (y != -1)
                this.outputText("along with her anus ", false);
            this.outputText("and your " + this.cockDescript(x), false);
            if (y != -1)
                this.outputText(" and " + this.cockDescript(y) + " sink", false);
            else
                this.outputText(" sinks", false);
            ...
            if (this.player.cockArea(x) >= 25)
                this.outputText("Her belly bulges pleasantly, displaying the vaguely cylindrical shape of a cock through her skin in a way that makes you feel utterly dominant over this 'female'.  ", false);
            ...
            if (y != -1)
                this.outputText("Her tight asshole slowly loosens around your " + this.cockDescript(y) + ", and so much lubricant splatters from her cunt with each thrust that the sensations of both your dicks become nigh-identical, save for the tight ring gripping the bottom one.", false);
            else {
                this.outputText("So much lubricant splatters from her cunt that your thighs", false);
                if (this.player.balls > 0)
                    this.outputText(", belly, and balls", false);
                else
            ...
            if (y != -1)
                this.outputText("  Surprisingly, her asshole stays about the same, but it was already a little tighter and you know you'll be pumping it full of goo in a second.", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.balls > 0)
                this.outputText(", slapping your balls against her ass", false);
            ...
            if (y != -1) {
                ...
                if (this.player.cumQ() > 500)
                    this.outputText(", and her stomach gains a bit of pudge from the copious jism deluge you pump into her", false);
                this.outputText(".", false);
            }
            if (this.player.cumQ() > 500)
                this.outputText("  You keep cumming, slamming blast after blast of spooge into her welcoming nethers, delighted that none seems to leak out.", false);
            if (this.player.cumQ() >= 1500)
                this.outputText("  Somehow her womb never seems to fill or bulge, even though you must be pumpings gallons of fertile baby-batter into her cunt.  By the time your orgasm winds down, you feel a little confused by it all, but sated.", false);
            this.outputText("\n\n", false);
            ...
            if (this.player.cumQ() > 100)
                this.outputText("  A few seconds later another rolls in, cramming three into her increasingly obscene looking 'sack'.", false);
            if (this.player.cumQ() > 250)
                this.outputText("  One more follows, giving her quads", false);
            var z = 8 + BunnyGirl.rand(this.player.cumQ() / 100);
            if (z > 50)
                z = 50;
            if (this.player.cumQ() > 700)
                this.outputText(", but she's not done.  Her gut rumbles loudly, and then one after another egg after egg pours into the sack, stretching it out until you're sure she has at least " + z + " in there and will have trouble walking.", false);
            else
                this.outputText(".", false);
            ...
            if (this.player.cockTotal() > 0) {
                ...
                if (this.isEaster()) {
                    ...
                    if (!this.player.hasVagina())
                        ...
                        this.outputText("inner walls", false);
                    ...
                    if (this.player.tailType != appearanceDefs_1.TAIL_TYPE_RABBIT) {
                        //[No Tail: 
                        if (this.player.tailType == appearanceDefs_1.TAIL_TYPE_NONE)
                            this.outputText("  The heat around your lower back clutches at your tail bone and you feel a fluffy explosion swell around your butt cheeks as <b>a fluffy bunny's tail pops out of your back</b>, twitching excitedly!", false);
                        //[Existing tail: 
                        else
                            this.outputText("  Your tail jiggles and shrinks, slowly sucking back into your body until only a tiny nub remains which quickly explodes with fluff into <b>your new cuddly, twitching bunny tail!</b>", false);
                    }
                    if (this.player.earType != appearanceDefs_1.EARS_BUNNY) {
                    ...
                    if (this.player.cumQ() < 250)
                        this.outputText("a slight swell", false);
                    else if (this.player.cumQ() < 1000)
                        this.outputText("a noticeable girth", false);
                    else
                        this.outputText("bloated obscenely", false);
                    ...
                    this.player.tailType = appearanceDefs_1.TAIL_TYPE_RABBIT;
                    this.player.earType = appearanceDefs_1.EARS_BUNNY;
                    this.doNext(this.camp.returnToCampUseOneHour);
                    this.player.orgasm();
                    this.dynStats("lib", 1, "sen", 1);
                }
                //REGULAR SHOW
                    ...
                    if (this.player.tailType != appearanceDefs_1.TAIL_TYPE_RABBIT) {
                        //[No Tail: 
                        if (this.player.tailType == appearanceDefs_1.TAIL_TYPE_NONE)
                            this.outputText("  The heat around your lower back clutches at your tail bone and you feel a fluffy explosion swell around your butt cheeks as a fluffy bunny's tail pops out of your back, twitching excitedly!", false);
                        //Existing tail: 
                        else
                            this.outputText("  Your tail jiggles and shrinks, slowly sucking back into your body until only a tiny nub remains which quickly explodes with fluff into a cuddly, twitching bunny tail!", false);
                    }
                    if (this.player.earType != appearanceDefs_1.EARS_BUNNY) {
                        this.outputText("  The top of your head is next, it seems.", false);
                        //[No antennae:
        ...
        layEggsInBunbuns() {
            ...
            if (this.player.eggs() < 20)
                this.outputText("eager egg-tube slips free, ready to show the rabbit you can play the egg game too.");
            else if (this.player.eggs() < 40)
                this.outputText("distended bug part quivers in anticipation, the ovipositor pushing into view with a drop of honeyed pre on its tip.");
            else
                this.outputText("low-hanging bee abdomen drools honey-like ichor down its carapace from the bulge where the thick black organ shows its need to relieve your burden.");
            ...
            if (this.player.gender == 0)
                this.outputText(" against the empty place of your crotch.");
            else {
                if (this.player.hasCock())
                    this.outputText(" alongside [eachCock]");
                if (this.player.hasVagina())
                    this.outputText(" and her hefty oval balls rubbing the [vagina] tucked between your thighs");
                this.outputText(".");
            }
            ...
            if (this.player.gender > 0) {
                ...
                if (this.player.hasCock())
                    this.outputText("spraying a long, thick load against the bunny's soft tits from your [eachCock]");
                if (this.player.gender == 3)
                    this.outputText(" and ");
                if (this.player.hasVagina())
                    this.outputText("splashing her balls with your girlcum");
                this.outputText(".");
            }
        ...
        ovipositBunnyEaster() {
            ...
            if (this.player.canOvipositBee())
                this.outputText("insect");
            else
                this.outputText("arachnid");
            ...
            //{Lots of Eggs!}
                ...
                if (this.silly())
                    this.outputText("like an energizer bunny");
                else
                    this.outputText("like some kind of endless, pregnancy-inducing fuck-beast");
        ...
        adjathaEggsplosions() {
            ...
            if (!this.isEaster())
                ...
                this.outputText("chocolate");
            this.outputText(" skinned woman.  Atop her ");
            if (!this.isEaster())
                this.outputText("tanned");
            else
                this.outputText("caramel");
            ...
            if (!this.isEaster())
                this.outputText("thin, gushing pre-cum");
            else
                this.outputText("thick, syrupy cream");
            ...
            if (!this.isEaster())
                this.outputText("olive");
            else
                this.outputText("cinnamon");
            ...
            if (!this.isEaster())
                this.outputText("coffee");
            else
                this.outputText("toffee");
        ...
        freeHerOhGodWhyDidYouDoThis() {
            ...
            if (this.isEaster())
                this.outputText("cony ");
            this.outputText("cock jerks in the air with every hyperventilating breath, ");
            if (!this.isEaster())
                this.outputText("bubbling pearls");
            else
                this.outputText("gooey marshmallows");
            ...
            if (!this.isEaster())
                this.outputText("the carnal fruit of her unwelcome, monstrous couplings");
            else
                this.outputText("candied plenty, her saccharine treats swimming amid a warm sea of honeyed spunk");
            ...
            if (!this.isEaster())
                this.outputText("splattering spoo");
            else
                this.outputText("climaxing cream");
            ...
            if (!this.isEaster())
                this.outputText("bright pink eggs");
            else
                this.outputText("candy-coated confections");
            this.outputText(" issue forth amid the ");
            if (!this.isEaster())
                this.outputText("cum");
            else
                this.outputText("icing");
        ...
        fuckTheEggBoundBun() {
            ...
            if (!this.isEaster())
                ...
                this.outputText("caramel-skinned");
            ...
            if (!this.isEaster())
                this.outputText("supple mounds");
            else
                this.outputText("taut dough");
            ...
            if (!this.isEaster())
                this.outputText("yielding flesh");
            else
                this.outputText("semi-spongy hotcakes");
            ...
            if (this.player.cor < 33)
                this.outputText("grimace at the vulgar goo that washes over your flesh");
            else if (this.player.cor < 66)
                this.outputText("swallow a gulp as the lewd spoo squelches around your member");
            else
                this.outputText("revel in the profane stimulation of bestial batter anointing your length in impure, liquid virility");
            this.outputText(".");
            ...
            if (!this.isEaster())
                this.outputText("darkly freckled thighs ivory");
            else
                this.outputText("savory, chocolate thighs with pale cream");
            ...
            if (!this.isEaster())
                this.outputText("flooding her semen-gorged cunt with fresh issue");
            else
                this.outputText("glazing her cream-filled center with your silky spunk");
            this.outputText(".  She bucks helplessly as her gut swells under your load, ");
            if (this.player.cumQ() < 250)
                this.outputText("steady streams of cum seeping from her pussy");
            else if (this.player.cumQ() < 1000)
                this.outputText("bulging enough that her belly button turns outward as the cum oozing from her pussy gushes between the two of you");
            else
                this.outputText("growing larger and larger as cum splatters in thick streams from her saturated pussy. Your seemingly endless gallons of flooding cum wash the remnants of her previous partners away, immersing the caramel woman in the fluid wealth of your liquid possession.");
        ...
        getEggflated() {
            ...
            if (!this.isEaster())
                this.outputText("twitching length");
            else
                this.outputText("succulent delicacy");
            ...
            if (!this.isEaster())
                this.outputText("ring");
            else
                this.outputText("donut");
            ...
            if (!this.isEaster())
                this.outputText("swollen mast");
            else
                this.outputText("bloated baster");
            this.outputText(".  Pressing her backwards, the two of you lean against her ");
            if (!this.isEaster())
                this.outputText("supple");
            else
                this.outputText("marshmallow");
            ...
            if (!this.isEaster())
                this.outputText("well-padded bedding");
            else
                this.outputText("sponge cakes baked for a giant");
            this.outputText(".");
            ...
            if (!this.isEaster())
                this.outputText("gurgling seed");
            else
                this.outputText("saccharine seed");
            ...
            if (!this.isEaster())
                this.outputText("twitching tuft");
            else
                this.outputText("cotton candy poof");
            ...
            if (!this.isEaster())
                this.outputText("swollen dick");
            else
                this.outputText("candied cock");
            ...
            if (!this.isEaster())
                this.outputText("jizz-burbling");
            else
                this.outputText("jelly-bubbling");
            ...
            if (!this.isEaster())
                this.outputText("tingling, liquid passion");
            else
                this.outputText("fattening, cream filling");
            ...
            if (!this.isEaster())
                this.outputText("advanced pregnancy");
            else
                this.outputText("gluttonous excess");
            ...
            if (!this.isEaster())
                this.outputText("egg-loaded");
            else
                this.outputText("candy fattened");
            ...
            //Futa:
            if (this.player.hasCock())
                this.outputText("  The steady movement of the orbs pushing past your prostate drills another, even messier orgasm from your " + this.multiCockDescriptLight() + ", cum arcing into the air to shower down on the two of you in pearl beads.");
            this.outputText("\n\nTime seems to flow from one moment to the next, your consciousness fading in and out as a small deluge of ");
            if (!this.isEaster())
                this.outputText("bunny seed");
            else
                this.outputText("marshmallow and chocolate");
    ...
    exports.BunnyGirl = BunnyGirl;
});
//# sourceMappingURL=BunnyGirl.js.map