define(["require", "exports", "../../../Monster", "../../../PerkLib", "../../../StatusAffects", "../../../../../includes/appearanceDefs", "../../../Appearance", "../../../internals/ChainedDrop"], function (require, exports, Monster_1, PerkLib_1, StatusAffects_1, appearanceDefs_1, Appearance_1, ChainedDrop_1) {
    "use strict";
     ...
     * @author ...
     */
    class Gnoll extends Monster_1.Monster {
        //Gnoll Description
        gnollAttackText() {
            var damage = 0;
            var attack = Gnoll.rand(6);
            //return to combat menu when finished
            this.doNext(this.game.playerMenu);
            //Blind dodge change
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Blind) >= 0 && Gnoll.rand(3) < 2) {
            ...
            //Determine if evaded
            else if (this.player.findPerk(PerkLib_1.PerkLib.Evade) >= 0 && Gnoll.rand(100) < 10) {
                this.outputText("Using your skills at evading attacks, you anticipate and sidestep " + this.a + this.short + "'s attack.\n", false);
            }
            //("Misdirection"
            else if (this.player.findPerk(PerkLib_1.PerkLib.Misdirection) >= 0 && Gnoll.rand(100) < 10 && this.player.armorName == "red, high-society bodysuit") {
                this.outputText("Using Raphael's teachings, you anticipate and sidestep " + this.a + this.short + "' attacks.\n", false);
            }
            //Determine if cat'ed
            else if (this.player.findPerk(PerkLib_1.PerkLib.Flexibility) >= 0 && Gnoll.rand(100) < 6) {
        ...
        gnollTease() {
            ...
            //Gnoll Tease #5
                ...
                this.outputText("\"<i>I love outlanders,</i>\" the gnoll confides in you as she circles.  \"<i>You have such interesting cries when you get fucked in a new way.</i>\"  She laughs, and the sound is far louder than it has any right to be.\n\n", false);
            //Gnoll Tease #6
            else {
        ...
        performCombatAction() {
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Stunned) >= 0) {
                if (this.plural)
                    this.outputText("Your foes are too dazed from your last hit to strike back!", false);
                else
                    this.outputText("Your foe is too dazed from your last hit to strike back!", false);
            ...
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Fear) >= 0) {
                if (this.statusAffectv1(StatusAffects_1.StatusAffects.Fear) == 0) {
                    ...
                    if (this.plural)
                        this.outputText(this.capitalA + this.short + " are too busy shivering with fear to fight.", false);
                    else
                        this.outputText(this.capitalA + this.short + " is too busy shivering with fear to fight.", false);
                }
                this.combatRoundOver();
            }
            // var select: number = 1;
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Exgartuan) == 0 && Gnoll.rand(3) == 0) {
        ...
        constructor() {
            ...
            this.drop = new ChainedDrop_1.ChainedDrop().
