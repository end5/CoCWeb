define(["require", "exports", "../../../Monster", "../../../StatusAffects", "../../../CockTypesEnum", "../../../../../includes/appearanceDefs", "../../../internals/ChainedDrop"], function (require, exports, Monster_1, StatusAffects_1, CockTypesEnum_1, appearanceDefs_1, ChainedDrop_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class SandTrap extends Monster_1.Monster {
        //Wait:
        sandTrapWait() {
            this.clearOutput();
            this.game.spriteSelect(97);
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Climbed) < 0)
                this.createStatusAffect(StatusAffects_1.StatusAffects.Climbed, 0, 0, 0, 0);
        ...
        trapLevel(adjustment = 0) {
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Level) < 0)
                this.createStatusAffect(StatusAffects_1.StatusAffects.Level, 4, 0, 0, 0);
            if (adjustment != 0) {
                this.addStatusValue(StatusAffects_1.StatusAffects.Level, 1, adjustment);
                //Keep in bounds ya lummox
                if (this.statusAffectv1(StatusAffects_1.StatusAffects.Level) < 1)
                    this.changeStatusValue(StatusAffects_1.StatusAffects.Level, 1, 1);
                if (this.statusAffectv1(StatusAffects_1.StatusAffects.Level) > 4)
                    this.changeStatusValue(StatusAffects_1.StatusAffects.Level, 1, 4);
            }
            return this.statusAffectv1(StatusAffects_1.StatusAffects.Level);
        }
        ...
        sandTrapPheremones() {
            ...
            if (this.player.spe / 10 + SandTrap.rand(20) > 10 || this.combatEvade() || this.combatFlexibility()) {
                ...
                var damage = (10 + this.player.lib / 10);
        ...
        nestleQuikSandAttack() {
            ...
            //Quicksand attack success: (Speed and Strength loss, ability to fly free lost)
                ...
                if (this.player.canFly())
                    this.outputText("  You try to wrench yourself free by flapping your wings, but it is hopeless.  You are well and truly snared.");
                this.trapLevel(-1);
                if (this.findStatusAffect(StatusAffects_1.StatusAffects.Climbed) < 0)
                    this.createStatusAffect(StatusAffects_1.StatusAffects.Climbed, 0, 0, 0, 0);
            }
        ...
        performCombatAction() {
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.Level) >= 0) {
                if (this.trapLevel() == 4 && this.findStatusAffect(StatusAffects_1.StatusAffects.Climbed) < 0)
                ...
                if (this.findStatusAffect(StatusAffects_1.StatusAffects.Climbed) < 0) {
                    ...
                    this.removeStatusAffect(StatusAffects_1.StatusAffects.Climbed);
        ...
        constructor() {
            ...
            if (SandTrap.rand(3) == 0)
                this.createStatusAffect(StatusAffects_1.StatusAffects.Fertilized, 0, 0, 0, 0);
            this.a = "the ";
            if (this.game.silly())
            ...
            // this.plural = false;
            this.createCock(10, 2, CockTypesEnum_1.CockTypesEnum.HUMAN);
            this.balls = 2;
            this.ballSize = 4;
            ...
            this.drop = new ChainedDrop_1.ChainedDrop(this.consumables.TRAPOIL).add(this.consumables.OVIELIX, 1 / 3);
            this.tailType = appearanceDefs_1.TAIL_TYPE_DEMONIC;
            this.createStatusAffect(StatusAffects_1.StatusAffects.Level, 4, 0, 0, 0);
            this.checkMonster();
        }
    }
    exports.SandTrap = SandTrap;
});
//# sourceMappingURL=SandTrap.js.map