define(["require", "exports", "../../../BaseContent", "../../../PregnancyStore", "../../../GlobalFlags/kFLAGS", "../../../CoC", "../../../../console", "./DemonPack", "../../../StatusAffects", "../Forest/TentacleBeast", "../Mountain/Minotaur", "../Plains/Gnoll", "../../../../../includes/appearanceDefs", "../../../PerkLib", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, BaseContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, DemonPack_1, StatusAffects_1, TentacleBeast_1, Minotaur_1, Gnoll_1, appearanceDefs_1, PerkLib_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 05.01.14.
     */
    class AntsScene extends BaseContent_1.BaseContent {
        constructor() {
            super();
            this.pregnancy = new PregnancyStore_1.PregnancyStore(kFLAGS_1.kFLAGS.PHYLLA_VAGINAL_PREGNANCY_TYPE, kFLAGS_1.kFLAGS.PHYLLA_DRIDER_INCUBATION, 0, 0);
        ...
        timeChange() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_EGG_LAYING] > 0 && AntsScene.rand(5) == 0 && this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] < 5000)
                this.flags[kFLAGS_1.kFLAGS.ANT_KIDS]++;
            if (this.model.time.hours > 23) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_EGG_LAYING] > 0)
                    this.flags[kFLAGS_1.kFLAGS.DAYS_PHYLLA_HAS_SPENT_BIRTHING]++;
                if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_GEMS_HUNTED_TODAY] > 0)
                    this.flags[kFLAGS_1.kFLAGS.PHYLLA_GEMS_HUNTED_TODAY] = 0;
                if (this.phyllaWaifu())
                    this.flags[kFLAGS_1.kFLAGS.DAYS_PHYLLA_IN_CAMP]++;
            }
            return false;
        }
        timeChangeLarge() {
        ...
        phyllaWaifu() {
            return this.flags[kFLAGS_1.kFLAGS.ANT_WAIFU] > 0;
        }
        antColonyEncounter() {
            //WAIFU GET!
            console_1.trace("ANT WINS: " + this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_WINS] + " ANT LOSSES: " + this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_LOSSES]);
            if (this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_WINS] - this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_LOSSES] >= 2 && this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_WINS] >= 4 && this.player.gender > 0) {
                if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_STAY_HOME] > 0)
                    this.bumpIntoTheAntColonyAfterStayHomePhylla();
                else
                    this.antGirlGoodEnd();
            }
            else if (this.flags[kFLAGS_1.kFLAGS.PC_READY_FOR_ANT_COLONY_CHALLENGE] == 1)
                this.antColonyChallenge();
            else if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_SAVED] == 1)
                this.enterTheColony();
            else
                this.firstAntColonyEncounter();
        }
        phyllaCapacity() {
            return this.flags[kFLAGS_1.kFLAGS.PHYLLA_CAPACITY];
        }
        //First Encounter
        //[Explore Desert]
        ...
        //►[Keep Hidden]
        keepHidden() {
            this.flags[kFLAGS_1.kFLAGS.ANT_COLONY_KEPT_HIDDEN] = 1;
            ...
            this.clearOutput();
            //If Under 40
            if ((this.player.lib < 41 && this.player.lust < 50) || this.player.cor < 66 || this.player.gender == 0) {
            ...
            //►(If Over 41 - Male)
                ...
                this.outputText("\n\nWatching from your hiding spot you start to stroke your " + this.cockDescript(0) + ".");
                //Start Dick Size Check
                var x = this.player.biggestCockIndex();
                //If player can auto-fallatio:
                if (this.player.cocks[x].cockLength >= 20)
                    this.outputText("  Licking the head of your [cock " + (x + 1) + "] in anticipation of what's to come only adds to your growing lust.");
                //If player cock size tiny:
                else if (this.player.cockArea(x) < 6)
                    this.outputText("  Though your cock isn't the most impressive, it's 'got it where it counts' and you intend to make the most of it.  You lovingly tease yourself until you're fully erect; running your fingers down the ridge causes a bead of pre-cum to form on your tip.");
                //If player cock size normal:
                else if (this.player.cockArea(x) < 12)
                    this.outputText("  You hold your cock like the hilt of a sword and start to pump your shaft slowly.  Your breathing becomes heavier and labored, as you stroke yourself with mounting passion.");
                //If player cock size large:
                else if (this.player.cockArea(x) < 30)
                    this.outputText("  The fear of having your cock give away your position quickly passes through your mind, but it's too late now.  The only way out of this is to cum, so you might as well enjoy it.  You firmly grasp your cock and start jacking off, hoping that you'll finish sooner rather than later.");
                //If player cock size MASSIVE:
                else
                    this.outputText("  The towering meat log jutting from your crotch gives away your 'hiding' spot, but the demons don't seem to mind, as they're too busy with their new toy.  You doubt even if they did care that any of them would be able to satisfy you. You wrap your arms around your fully erect cock and start to pump, hoping to release your load soon.");
            ...
            //►If Over 41 - Female
                ...
                if (this.player.lactationQ() > 100)
                    this.outputText("  You feel your warm milk flow out of your hardened arola, as your body begs to release its sweet nectar.");
                //If PC has dick(s):
                if (this.player.hasCock())
                    this.outputText("  Feeling [eachCock] throb between your legs, you run one of your hands down your chest and start to stroke lovingly.");
        ...
        playHero() {
            ...
            this.startCombat(new DemonPack_1.DemonPack());
            this.monster.createStatusAffect(StatusAffects_1.StatusAffects.phyllafight, 0, 0, 0, 0);
        ...
        consolePhylla() {
            ...
            if (this.player.lib >= 50)
                this.outputText("After taking an eyeful of her smooth, enticing pussy, revealed in her current position by the inadequacies of her loincloth, y");
            else
                this.outputText("Y");
            ...
            this.flags[kFLAGS_1.kFLAGS.PHYLLA_SAVED] = 1;
        ...
        enterTheColony() {
            ...
            if (this.player.cor < 40)
                this.outputText("\"<i>'Champion', you've been sent to this land to resist the demons and your efforts thus far, insignificant though they be, have not escaped my gaze.  ");
            else
                this.outputText("\"<i>Despite your obvious taint, you seem to have retained your valor as the 'Champion' you proclaim yourself to be, and not as a rutting beast.  Something to be admired, for sure.  ");
            ...
            this.flags[kFLAGS_1.kFLAGS.PC_READY_FOR_ANT_COLONY_CHALLENGE] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //The Challenges
        antColonyChallenge() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MET_ANT_ARENA] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.MET_ANT_ARENA]++;
            }
        ...
        antColiseumFight() {
            this.clearOutput();
            //►[Fight #1]
            if (this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_WINS] + this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_LOSSES] == 0) {
                ...
                this.monster.createStatusAffect(StatusAffects_1.StatusAffects.NoLoot, 0, 0, 0, 0);
            }
            //►[Fight #2]
            else if (this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_WINS] + this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_LOSSES] == 1) {
                //►(Minotaur - Intro)
                ...
                this.startCombat(new Minotaur_1.Minotaur(true));
                this.monster.createStatusAffect(StatusAffects_1.StatusAffects.NoLoot, 0, 0, 0, 0);
            }
            //►[Fight #3]
            else {
                //(Gnoll - Intro)
                if (this.flags[kFLAGS_1.kFLAGS.MET_ANT_ARENA_GNOLL] == 0)
                    this.outputText("With due ceremony, the manager leads you down to one of the staging areas for the arena.  You watch through the bars as the stadium fills far past capacity.  There must be a thousand ants here... maybe even the whole colony.  Gazing out into the crowd, you pick out the royal seating and in it, Princess Phylla.  The princess is in much finer attire than you're used to seeing - her chest is actually covered by a fine red and blue dress and her hair is combed, framing her face nicely.  Her mother is nowhere to be seen, and you can tell that Phylla is taking full advantage.  She waves and cheers for you just like the crowd is and, perhaps by her orchestration, you hear the crowd pick up a chant in your name.  Seeing Phylla chant with them makes you feel invigorated.  As the gates raise, you charge out into the center of the arena, roaring your finest battle cry; your opponent is taken somewhat aback but finds resolve and braces for your charge.");
                //►(Gnoll - Intro Repeat - for people that lost once)
                else
                    this.outputText("You move through the network of tunnels and caves and come to the colosseum once more.  You are greeted by the event manager and he ushers you down to one of the staging areas for the arena.  The noise intensifies as the colosseum fills to the brim with spectators; Phylla herself is up in her box waving to you.  You look across the arena floor and the gnoll at the other side of the arena seems just as excited to fight as you are.  The gates open and you charge each other!");
                this.outputText("\n\nYou're fighting a gnoll!");
                this.flags[kFLAGS_1.kFLAGS.MET_ANT_ARENA_GNOLL]++;
                this.startCombat(new Gnoll_1.Gnoll());
                this.monster.createStatusAffect(StatusAffects_1.StatusAffects.NoLoot, 0, 0, 0, 0);
            }
            this.monster.createStatusAffect(StatusAffects_1.StatusAffects.PhyllaFight, 0, 0, 0, 0);
            this.doNext(this.playerMenu);
        ...
        phyllaTentacleDefeat() {
            ...
            this.fatigue(10);
            //(+1 Win Score)
            this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_WINS]++;
            this.cleanupAfterCombat();
        }
        ...
        phyllaTentaclePCLoss() {
            ...
            // (+1 Loss Score)
            this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_LOSSES]++;
            if (this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_LOSSES] > 3) {
        ...
        phyllaPCBeatsGnoll() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ANTS_PC_BEAT_GNOLL] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.ANTS_PC_BEAT_GNOLL]++;
            }
            else if (this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_WINS] - this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_LOSSES] >= 2 && this.flags[kFLAGS_1.kFLAGS.ANT_ARENA_WINS] >= 3 && this.player.gender > 0) {
        ...
        phyllaGnollBeatsPC() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ANTS_PC_LOST_TO_GNOLL] == 0) {
                this.flags[kFLAGS_1.kFLAGS.ANTS_PC_LOST_TO_GNOLL]++;
        ...
        antGirlGoodEnd() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.PHYLLA_CAPACITY] = 50;
        ...
        //►Male Continuation
        gigititigitigitigitigityAntGirl() {
            this.clearOutput();
            ...
            var x = this.player.cockThatFits(this.phyllaCapacity());
            if (x < 0)
        ...
        malePhyllaContinuation(x) {
            this.clearOutput();
            this.outputText("Phylla stares down at your " + this.multiCockDescriptLight() + " and starts nervously rubbing her hands together.  \"<i>It's my first time... I mean, I hope it isn't going to be bad for you...</i>\" she says, before trailing off; uncertain of her sexual prowess.");
            ...
            if (this.player.isGoo())
                this.outputText(", leaving traces of your slimy lust along her body for her to wear, allowing your detached bits of mass to ignite her sexual fires");
            this.outputText(".");
            ...
            this.outputText("\n\nSimply dragging your " + this.cockDescript(x) + " along the entrance her of moist pussy causes her to moan and wiggle under you. Parting her pink little lips with the head of your cock, you finally hit the sweet spot for penetration. With ");
            if (this.player.cor < 75)
                this.outputText("a gentle amount of force, ");
            else
                this.outputText("an uncaring, brutish amount of force, ");
            this.outputText("you push past the tight opening of Phylla's folds.  You hear Phylla inhale sharply as she stretches to accommodate your width. In what seems to be a prolonged amount of time, you finally manage to ease the head of your " + this.cockDescript(x) + " into her.  The act takes a loud and pained turn as Phylla moans and shifts in obvious discomfort.  You feel her squeeze her vaginal walls tightly around your cock as her considerable strength almost cuts off blood flow.  After a moment, Phylla realizes how much pressure she's exerting and her body relaxes, realizing the potential for injuring her partner.  Sighing heavily, she moves her hips down to take even more of you in. As you slide further in, her eyes flash with pain as she bites down on her lip, it becomes glaringly clear that something has yielded inside of Phylla.");
        ...
        phyllaFirstTimePureBabiesFuckEnding() {
            ...
            if (this.player.cumQ() >= 100 && this.player.cumQ() < 1000)
                this.outputText("  Truly amazing considering how much your loads usually contain.  You think you see a little bulge in her stomach that wasn't there before.");
            //If cum milliliters over 1000:
            else if (this.player.cumQ() >= 1000)
                this.outputText("  As you look down at her nethers your mind struggles to understand just how she could... then looking up her body, you see.  Her belly is bloated with your sperm, almost to the point of already looking pregnant.");
            ...
            if (this.player.canOvipositSpider()) {
                ...
                if (this.player.inte / 20 + AntsScene.rand(20) + 1 < 16) {
                    ...
                    if (this.pregnancy.isPregnant)
                        this.outputText("  I just can't hold anything else inside me. I'm sorry! Please don't be mad... I mean I will!  Just a-after... this batch...");
                ...
                //Persuasion success:
                {
                    ...
                    if (this.player.cor >= 75)
                        this.outputText("  Little does poor Phylla know, you're going to just use her as a baby maker to ease the tension of your own sacks.");
                    ...
                    if (!this.pregnancy.isPregnant)
                        this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_DRIDER_EGGS, 8 * 24); //Supposed to be eight days, not eight hours
                }
        ...
        phyllaCorruptMascEnding() {
            ...
            if (x < 0)
                x = this.player.smallestCockIndex();
            this.outputText("\n\nWithout letting her finish, you plunge your " + this.cockDescript(x) + " into her, causing her to yell out in sheer surprise and discomfort.  \"<i>This is how <b>I</b> mate!</i>\" you inform her, telling her that she won't EVER forget her first time with you.  Her mouth goes open slightly before your subsequent gyrations put an end to whatever she was going to sputter out.  Smirking like a mad jester at the position you have Phylla in, you begin to work your hips as you dominate her from behind.  You hear your ");
            if (this.player.balls == 0)
            ...
            //PC has Goo Body:
            if (this.player.isGoo())
                this.outputText("  Perhaps the poor dear could use some tender attention, you ponder to yourself.  Reducing the solidity of your body, you work her abdomen deep into your sticky, goopy body, re-solidifying once she's firmly in there and lowering your hands down to her nipples, pinching them hard as you continue your pumping of her rump.");
            ...
            var y = this.player.cockThatFits2(this.phyllaCapacity());
            if (this.player.cockTotal() < 2)
                y = -1;
            if (y >= 0) {
                this.outputText("\n\nIntent on increasing your own pleasures, you decide to work ");
                if (this.player.cockTotal() > 2)
                    this.outputText("one of your free cocks");
                else
                    this.outputText("your free cock");
            ...
            if (y >= 0)
                this.outputText(" and her ass.");
            else
                this.outputText(", and onto the bedspread below.");
        ...
        cuntmuffinLingusPhyllaDickBig() {
            this.clearOutput();
            this.outputText("Sadly, as you gaze down at your " + this.multiCockDescriptLight() + ", you realize that trying to penetrate Phylla with your freakishly large prick");
            if (this.player.cockTotal() > 1)
                this.outputText("s");
            ...
            if (this.player.longestCockLength() < 69) {
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText("it points");
                else
                    this.outputText("they point");
            ...
            if (this.player.cockTotal() == 1)
                this.outputText(" switches and bobs");
            else
                this.outputText("s switch and bob");
            this.outputText(", loudly brushing against the ");
            if (this.player.longestCockLength() < 69)
                this.outputText("ceiling");
            else
                this.outputText("wall in the hallway");
            this.outputText(".");
            ...
            if (this.player.tongueType == appearanceDefs_1.TONUGE_SNAKE)
                this.outputText("  You run the split of your forked mouth muscle from the tip of her clit to the base.  As your textured feeler makes its way down, you wrap around the rest of her long clitorus, like a boa constrictor.  Once your split reaches the hood of her clit you roll and flick the tip of your tongue rapidly.  Pulling at your hair she gasps for breath in between teeth grinding moans.");
            ...
            if (this.player.isGoo())
                this.outputText(", tumbling out of your mass as she tears free");
            ...
            if (this.player.cockTotal() == 1)
                this.outputText("this monster");
            else
                this.outputText("these monsters");
            ...
            this.flags[kFLAGS_1.kFLAGS.DIDNT_FUCK_PHYLLA_ON_RECRUITMENT] = 1;
            //Where the fuck is this going?
            this.menu();
            this.addButton(0, "Next", this.waifuQuestOver);
        }
        //►Female Continuation
        femalePhyllaFirstFuckGooooo() {
            this.clearOutput();
            this.outputText("Eager to get to some good old fashion fun, you direct your thoughts to Phylla, telling her to 'remove her clothing'.  After all of the pieces of her royal attire are removed, she closes in and rubs her naked body against yours.  Her fingers move fluidly as she slowly traces her ever hardening nipples along your chest and along the ridges of your back, sending a sensual chill up and down your spine.  Your " + this.nippleDescript(0) + "s harden in response, and with surprising speed she shifts her body downward and locks her mouth around your nipple, firmly suckling at your hardened areola.");
            //If PC Lactating:
            if (this.player.lactationQ() > 250)
                this.outputText("\n\nYou can feel her suck some of the milk from your breasts, slating her weak thirst in the process as she becomes immensely aroused at the sensation of \"nursing\" from her lover's " + this.breastDescript(0) + ".  Weird... you can taste the nutritious warmth of your nectar as it flows down her throat and into her stomach.  Drinking and tasting one's own breast milk could definitely weird someone out, but the foreignness of the act is an odd turn-on for you, and you let her continue to suckle.");
            ...
            if (!this.player.hasCock())
                this.addButton(0, "Next", this.girlFiller);
            //(If PC has ANY NUMBER of DICK(S)! - Jump to - If PC Herm/Has (a) cock(s))
            else
                this.addButton(0, "Next", this.femalePhyllaFirstTimePlusCock);
        }
        girlFiller() {
            this.clearOutput();
        ...
        femalePhyllaFirstTimePlusCock() {
            ...
            //One dick only:
            if (this.player.cockTotal() == 1)
                this.outputText("your " + this.cockDescript(0) + ".");
            else
                this.outputText("your " + this.cockDescript(0) + " leaving the lucky member to bask in affectionate glory as the rest of your manhood laments being left out.  \"<i>Don't worry, I have four hands...</i>\" Phylla coos as she works your shaft.");
            ...
            if (this.player.smallestCockArea() > this.phyllaCapacity()) {
                ...
                if (this.player.isTaur())
                    this.outputText("Seeing your impending predicament, Phylla quickly scrambles with all four of her arms to collect a bunch of cushions.  She stacks them in a makeshift 'resting place' and helps you into a comfortable position as your cocks precede to grow uncontrollably.");
                //Drider body:
                else if (this.player.isDrider())
                    this.outputText("Phylla immediately realizes this, and flips you over so that you are resting on your head and neck, ducking in past your " + this.multiCockDescriptLight() + " and coming to rest on the border between your spider carapace and soft clit.");
                //Goo body:
                else if (this.player.isGoo())
                    this.outputText("Phylla immediately realizes this, and flips you over so that you are resting on your head and neck, and she works her way through your goopy mass, connecting her clit with yours in little time or effort. \"<i>This is a little weird... but I like it...</i>\" she flirts. Hardening your mass slightly, you snugly secure Phylla against your body, telling her that things \"might\" get rough.");
                //Human/Harpy/Naga legs:
                else
                    this.outputText("Phylla immediately realizes this, and flips you over so that you are resting on your head and neck, and curls your [legs] towards her.");
                this.outputText("  Your " + this.multiCockDescriptLight() + " now resting comfortably out of the open room, Phylla positions herself to scissor your pussy.");
            ...
            //If PC has an appropriately sized dick(s):
                ...
                if (this.player.tentacleCocks() > 0) {
                    ...
                    if (this.player.tentacleCocks() > 1)
                        this.outputText("s and wiggle them ");
                    else
                        this.outputText(" and wiggle it ");
                    ...
                    //one tentacle dick:
                    if (this.player.tentacleCocks() == 1)
                        this.outputText("your cock into her mouth as she continues to rock her hips into yours.");
                    //two:
                    else if (this.player.tentacleCocks() == 2)
                        this.outputText("your cocks into her mouth and between her breasts as she continues to rock her hips into yours.");
                    else
                        this.outputText("your cocks into her mouth, between her breasts, and along her body.  The ones on her body tightly wrap around her insectile joints, using her muscular curves to get you off.");
                    ...
                    if (this.player.cockTotal() == 2 && (this.player.cockArea(this.player.smallestCockIndex2()) + this.player.cockArea(this.player.smallestCockIndex()) <= this.phyllaCapacity()))
                        this.outputText("two of your " + this.multiCockDescriptLight() + ", stroking them apologetically as she scissors you.  You feel her almost insatiable appetite for all parts of your body.  You feel Phylla's mind slowly becoming lost in pleasure.");
                    //TODO: "player.cocks[player.smallestCockIndex()] < 4" changed to cockLength. Not sure if it is the appropriate attribute.
                        ...
                        this.outputText("your " + this.cockDescript(this.player.smallestCockIndex()) + ", stroking it apologetically as she scissors you.  You feel her almost insatiable appetite for all parts of your body.  You feel Phylla's mind slowly becoming lost in pleasure.");
                    //PC only has a dick(s) that('s) (are) more than 4 inches in width:
                    else
                        this.outputText("your " + this.cockDescript(this.player.smallestCockIndex()) + ", but she simply can't fit any number of her hands around the entirety of your glans; instead, she takes to caressing the head of your " + this.cockDescript(this.player.biggestCockIndex()) + ".");
                    //(Leads to - Scissoring Continuation)
                }
            }
            this.scissorContinue(false);
        }
        scissorContinue(clear) {
            if (clear)
                this.clearOutput();
            else
                this.outputText("\n\n");
        ...
        getAntWaifuYoShit() {
            ...
            this.flags[kFLAGS_1.kFLAGS.ANT_WAIFU] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //►[Stay Here]
        tellPhyllaToStayTheFuckAtHomeThatCunt() {
            this.clearOutput();
            ...
            this.flags[kFLAGS_1.kFLAGS.PHYLLA_STAY_HOME] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        introductionToPhyllaFollower() {
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_CAPACITY] < 50)
                this.flags[kFLAGS_1.kFLAGS.PHYLLA_CAPACITY] = 50;
            this.clearOutput();
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_CAMP_VISITS] == 0) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.DIDNT_FUCK_PHYLLA_ON_RECRUITMENT] == 1 && this.player.hasCock()) {
            ...
            //►[Follower > Phylla Intro (Repeat)]
                ...
                //If <10 days in camp:
                if (this.flags[kFLAGS_1.kFLAGS.DAYS_PHYLLA_IN_CAMP] < 10)
                    this.outputText("\n\nSo far the map of the caves doesn't look very impressive.");
                //If <30 days in camp:
                else if (this.flags[kFLAGS_1.kFLAGS.DAYS_PHYLLA_IN_CAMP] < 30)
            ...
            if (this.player.lust >= 33)
                this.addButton(1, "Sex", this.phyllaSexMenu);
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_EGG_LAYING] == 0)
                this.addButton(2, "Lay Eggs", this.phyllaLaysEggsToggle);
            else
                this.addButton(2, "No Eggs", this.phyllaLaysEggsToggle);
            ...
            this.flags[kFLAGS_1.kFLAGS.PHYLLA_CAMP_VISITS]++;
        }
        phyllaSexMenu() {
            this.menu();
            if (this.player.hasCock()) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_EGG_LAYING] > 0 && this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] >= 10)
                    this.addButton(1, "Fuck Her", this.dudesFuckEggLayingBitches);
                if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] > 10 && this.player.cor >= 75)
            ...
            //Sex > [Egg Phylla]
            if (this.player.canOvipositSpider())
                this.addButton(5, "Oviposit", this.eggDatBitch);
        ...
        talkAboutAntHistory() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.TALKED_WITH_PHYLLA_ABOUT_HISTORY] = 1;
        ...
        talkAboutAntMatingAndRituals() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_TIMES_DRIDER_EGG_LAYED] > 0)
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] > 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.PHYLLA_INHERITED_KNOWLEDGE] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //(Phylla's Life Past & Future)
        phyllasLifePastAndFuture() {
            this.clearOutput();
            //(If Izma at Camp)
            if (kGAMECLASS_1.kGAMECLASS.izmaScene.izmaFollower() && this.flags[kFLAGS_1.kFLAGS.PHYLLA_IZMA_TALK] == 0) {
                this.flags[kFLAGS_1.kFLAGS.PHYLLA_IZMA_TALK] = 1;
                ...
                if (this.player.cor < 40) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_INHERITED_KNOWLEDGE] == 1) {
        ...
        phyllaBeeeJays() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.PHYLLA_BLOWJOBS]++;
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_BLOWJOBS] == 1) {
            ...
            if (this.player.cockArea(x) < 60) {
                ...
                //Dick size more than 60 inches (subsequent blowjobs):
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_BLOWJOBS] == 2)
                        this.outputText("last time");
                    else
                        this.outputText("our first time");
                    this.outputText(".  I'll help to free ");
                    if (this.player.cockTotal() == 1)
                        this.outputText("that monster");
                    else
                        this.outputText("those monsters");
                    ...
                    if (this.player.cocks[x].cockLength < 16)
                        this.outputText("base");
                    else
                        this.outputText("middle");
                    this.outputText(" of your shaft against her tongue.  You hear a mix of a giggle and hum as she drags her tongue towards the head of your " + this.cockDescript(x) + ".  Phylla teases your shaft as she reaches the peak and suckles at your urethral opening.  You feel her drawing up as much pre-cum as she can and lapping it up like she's dying of thirst.  She continues this for a bit, until it becomes apparent that she's either not too sure of what else to do, or that she's never heard of how to properly fellate someone.");
                    this.outputText("\n\nWith a chuckle, you pull your " + this.cockDescript(x) + " away from her mouth and ask her to look up at you. Clearly embarrassed at your realization of her skills, she begins to tremor softly.  \"<i>S-sorry! I mean, I've never done this!  This act is uncommon for my people.  Such things are not proper for a queen to be...  taught, or learn.</i>\"  She apologizes, begging your forgiveness with her body language and demeanor.");
                }
            }
            this.menu();
            //(If Corruption less than 75 transitions to - Pure BJ Ending)
            if (this.player.cor < 75)
                this.addButton(0, "Next", this.purePhyllaBJOver);
            //(If Corruption more than 75 transitions to - Corrupt BJ Ending)
            else
                this.addButton(0, "Next", this.corruptPhyllaEndings);
        }
        //Pure BJ:
        purePhyllaBJOver() {
            this.clearOutput();
            ...
            if (this.player.cockTotal() > 1) {
                ...
                if (this.player.cockTotal() == 2)
                    this.outputText("your other dick");
                else
                    this.outputText("the rest of your dicks");
                this.outputText("; if she would be \"<i>so kind.</i>\" With gusto, her four hands shoot up and take your ");
                if (this.player.cockTotal() == 2)
                    this.outputText("cocks into their firm grips");
                else
                    this.outputText("cock into their firm grips");
        ...
        //[Nope]
        nopeNotOnMouthOrWhateverFuckThisNoise() {
            this.clearOutput();
            this.outputText("You pass on her offer, not wanting to know what THAT sensation");
            //If PC can't Autofellatio:
            if (!this.player.canAutoFellate())
                this.outputText(" or anything like it would feel like.");
            else
                this.outputText(" feels like with Phylla's mind linked to your own.");
        ...
        pureBJEnding(linked = true) {
            ...
            if (this.player.cumQ() > 1000)
                this.outputText("  Though she might have a mouthful, you're not finished yet!  You continue to unload the remainder of your hot load on her breasts and stomach.");
            if (this.player.cockTotal() > 1) {
                //If multi cock::
                this.outputText("  Your other cock");
                if (this.player.cockTotal() > 2)
                    this.outputText("s shower");
                else
                    this.outputText(" showers");
                this.outputText(" her hands and body in your white goo as she continues to pump ");
                if (this.player.cockTotal() == 2)
                    this.outputText("on each of ");
            ...
            if (this.player.balls > 0)
                ...
                this.outputText("in the pelvis");
            this.outputText(", you rub Phylla's hair playfully");
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_BLOWJOBS] != 1)
                this.outputText(".");
            //If first time:
            else
                this.outputText(" and congratulate her on her first time.");
        ...
        //Corrupt BJ Ending
        corruptPhyllaEndings() {
            this.clearOutput();
            var x = this.player.smallestCockIndex();
            this.outputText("\"<i>A slut that can't suck a dick... how can this get any worse?</i>\"  You ponder to yourself while rubbing your nasal bridge. You tell the innocent little ant that she'll learn how to suck a mean cock, even if it kills her.  You're knee deep at this point - might as well turn her into something salvageable.  Commanding her attention, you lift her face up and hover your " + this.cockDescript(x) + " close to her lips, smothering her lips with your precum.  She attempts to turn away but you react before she can.  Holding her head in place you comment on how this is what you want from her.");
            ...
            //Every other time:
                ...
                this.outputText("improved since the last time.");
            ...
            this.outputText("\n\nPhylla groans at the rough treatment, not used to being treated so coarsely as your " + this.cockDescript(x) + " lunges back and forth in her mouth, grinding along her cheek and tongue. Your cock seems to have a mind of its own as you somehow manage to wrap her tongue around yourself, knowing full well Phylla lacks the technique required to do it on her own.  The little queen is about to receive a rude awakening about pleasing her master.");
            this.outputText("\n\nMoan after muffled moan escapes from Phylla's mouth as you continue your callous fucking of her delicate little face.  Your little slut is trying her best to keep up with your thrusts but is ultimately failing.  Perhaps she needs a little motivation?  Withdrawing your " + this.cockDescript(x) + ", you tell her she doesn't get to suck your dick anymore unless she fingers her tight little hole. Desperate to fulfill your desires, she quickly darts a hand to her pussy and fingers that little fuckhole like her life depends on it.  Within seconds you see her long clit protruding, begging to be touched.");
            //(If PC has Multidicks Add Section  - Multidick)
            //(If PC likes Anal Add Section - Anal)
            //(If PC has Vagina Add Section - Vagina)
            //(Else Continue to - Continuation)
            ...
            //Continuation:
            this.outputText("\n\nCongratulating her for her hasty heeding of your wishes, you ram your " + this.cockDescript(x) + " back into her mouth and continue the face fucking once more.  Phylla picks up the effort as she starts working her head and tongue in tandem with your hips.  Soon she's driving you perilously close to an orgasm.  With one last directive, you ask Phylla if she's ready to receive your seed.  Though since you continue your brutal fucking of her mouth, she has no opportunity to reply.");
            ...
            if (!this.silly()) {
                this.outputText("\n\nPhylla works your " + this.cockDescript(x) + " the entire time you cum, as if pleading for just a little more to come out.  You grab her hands, signaling you've have just about enough.  Coming down from your climax, you thank your slut for the oral and sit down on the bed and start gathering your scattered clothing.");
        ...
        dickPhylla() {
            ...
            //(NO BJ experience)
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_BLOWJOBS] == 0) {
            ...
            //3-4 times:
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_FUCKS] >= 3)
                this.outputText(" she asks playfully, knowing full well that that's what you came here for.");
            //(First time)
            else if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_FUCKS] == 0)
                this.outputText(" You nod quickly.");
            //(Subsequent fucks)
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_FUCKS] > 0)
            ...
            this.outputText("\n\nHer eyes widen in surprise as your " + this.cockDescript(x) + " fills her.  She howls a blissful scream as she drools forth her girl fluids, coating your cock ");
            if (this.player.balls > 0)
        ...
        lesbianFisting() {
            ...
            if (this.player.hasVirginVagina() || this.player.vaginalCapacity() <= 10)
                this.outputText(" tries to fit itself into you, only managing to insert her fingers into your pussy.  Despite the \"<i>setback,</i>\" Phylla");
        ...
        dudesFuckEggLayingBitches() {
            ...
            if (this.player.cor < 50)
                this.outputText("don't care how she looks right now. Besides, some creatures around here appreciate a little carnal love; it helps with the birthing process.");
            //If Corruption is more than 50:
            else
                this.outputText("could care less for her pathetic attempts at concealing her pregnant form; you're horny, and she's going to put out, regardless of her insecurities.");
            this.outputText("\n\nYou walk over to her and ");
            if (this.player.cor < 50)
                this.outputText("lovingly");
            else
                this.outputText("apathetically");
            ...
            if (this.player.balls > 0)
                ...
                this.outputText(" your knees grind along the edge of her makeshift throne.");
        ...
        //While Giving Birth (Female) - Written
        birfingSexWithAntsForDasLadies() {
            this.clearOutput();
            ...
            if (this.player.cor < 75) {
                ...
                else if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Birthed) > 0)
            ...
            if (this.player.cor <= 50)
                this.outputText("  You probe her mind and are almost taken aback.\"<i>NO!  Just please keep going!</i>\"  You hear her voice ring out in your head.");
            ...
            if (this.player.cockTotal() > 0 && this.player.cockThatFits(42) >= 0) {
                ...
                if (this.player.cockTotal() == 1)
                    ...
                    this.outputText("as many as you can");
            ...
            this.outputText("\n\nYour " + this.clitDescript() + " comes to rest on her lips again as her head starts to bob between her own strong legs.  Returning the sentiment, you dart in-between her legs, tongue first.  You hit that sweet tasting little pussy of hers with force.  Phylla moans, your intentions crystal clear as she bears down on your pussy hard, intently working for your sexual release.  She reaches up with her lower set of arms and gives both your " + this.nippleDescript(0) + "s a firm squeeze, the twist of which is nothing short of exquisite.  Muffled moans of bliss are unintelligible, but in your shared mind-state, you can hear one another screaming words of encouragement and direction.");
            //If PC has (a) Dick(s), that are less than 42 inches:
            if (this.player.cockTotal() > 0 && this.player.cockThatFits(42) >= 0)
            ...
            if (this.player.cockTotal() > 0 && this.player.cockThatFits(42) >= 0) {
                ...
                if (this.player.cockThatFits2(42) >= 0)
                    this.outputText("two of ");
                this.outputText("your " + this.multiCockDescriptLight() + " into her mouth and mashes ");
                if (this.player.cockThatFits2(42) >= 0)
                    this.outputText("them");
                else
                    this.outputText("it");
            ...
            if (this.player.cor < 75) {
                ...
                if (!this.player.findPerk(PerkLib_1.PerkLib.SluttySeduction))
        ...
        orgyWithDatColonyCorruptDudes() {
            this.flags[kFLAGS_1.kFLAGS.TIMES_CORRUPT_MALE_ANT_ORGY]++;
            this.clearOutput();
            this.outputText("You tell Phylla to call in your strongest and most virile children for 'inspection.'");
            //First Time:
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_CORRUPT_MALE_ANT_ORGY] == 1) {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_EGG_LAYING] > 0)
                this.outputText("large, lactating ");
            else
            ...
            if (x < 0)
                x = this.player.smallestCockIndex();
            this.outputText("\n\nWhen you've felt your mind completely sync up with everyone else in the room, it's like being drunk on sexual euphoria.  You almost lose yourself in it for a moment, but focusing your mind, you snap your eyes open. You see Phylla in front of you looking like a drugged slut; she runs all four of her hands over your " + this.cockDescript(x) + " at the entrance of her flooded cunt while her children play with her nipples and suck each other off.  Aggressively, you grab her arms and pin her down while simultaneously shoving your cock into her.");
            ...
            this.outputText("\n\nOne of your brood leans down and starts to feverishly lick the base of Phylla's clit as your cock slides in and out of her. His warm saliva coupled with Phylla's natural lubricant warms your cock and sends even more pleasure throughout your " + this.cockDescript(x) + ".");
        ...
        //Orgy w/ Colony (Female)
        //You tell Phylla you're interested in 'inspecting' your children.
        antColonyOrgy4Ladies() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.TIMES_CORRUPT_FEMALE_ANT_ORGY]++;
            //(First Time)
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_CORRUPT_FEMALE_ANT_ORGY] == 1) {
                ...
                if (this.player.hasCock())
                    this.outputText(" and [eachCock] harden");
            ...
            if (this.player.isBiped())
                this.outputText("  Setting one foot on his shoulder, you present your [vagina] to him.");
            else
                this.outputText(" Now at the perfect height, you present your [vagina] to him.");
            ...
            if (this.player.isBiped())
                this.outputText(" from between your legs.");
            else
                this.outputText(" from your cunt.");
        ...
        phyllaLaysEggsToggle() {
            this.clearOutput();
            //(Lay Eggs)
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_EGG_LAYING] == 0) {
                this.flags[kFLAGS_1.kFLAGS.PHYLLA_EGG_LAYING] = 1;
                ...
                if (this.flags[kFLAGS_1.kFLAGS.TALKED_WITH_PHYLLA_ABOUT_HISTORY] > 0)
                    this.outputText("  You tell her you want a colony like those she spoke of in the times before the corruption.");
            ...
            //(Stop Laying Eggs)
                ...
                this.flags[kFLAGS_1.kFLAGS.PHYLLA_EGG_LAYING] = 0;
        ...
        lickThatAntButt() {
            ...
            //First Time:
            if (this.flags[kFLAGS_1.kFLAGS.ANTS_BIRTHED_FROM_LICKING] == 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.PHYLLA_COOLDOWN] = 12;
            this.flags[kFLAGS_1.kFLAGS.ANTS_BIRTHED_FROM_LICKING]++;
            if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] < 5000)
                this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] += 5;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //DON'T LICK THAT!
        dontLickAntButt() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] > 1)
            ...
            this.flags[kFLAGS_1.kFLAGS.PHYLLA_COOLDOWN] = 6;
            this.flags[kFLAGS_1.kFLAGS.ANT_KIDS]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        phyllaLaysSomeDriderEggs() {
            ...
            if (this.player.cor < 75) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_EGG_LAYING] > 0)
                    ...
                    this.outputText("the egg is just fine on its own");
            ...
            this.flags[kFLAGS_1.kFLAGS.PHYLLA_TIMES_DRIDER_EGG_LAYED]++;
            this.flags[kFLAGS_1.kFLAGS.PHYLLA_DRIDER_BABIES_COUNT] += 5 + AntsScene.rand(4);
        }
        //Mount Phylla:
        driderDoublePhllaMount() {
            this.clearOutput();
        ...
        phyllasKidsChildren() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.DAYS_PHYLLA_HAS_SPENT_BIRTHING] < 10)
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.DAYS_PHYLLA_HAS_SPENT_BIRTHING] < 40)
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_TIMES_DRIDER_EGG_LAYED] > 10)
        ...
        phyllaDigsForGems() {
            this.clearOutput();
            var kidsMod = 0;
            if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] > 10)
                kidsMod++;
            if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] > 50)
                kidsMod++;
            if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] > 150)
                kidsMod++;
            if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] > 300)
                kidsMod++;
            if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] > 600)
                kidsMod++;
            if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] > 1000)
                kidsMod++;
            if (this.flags[kFLAGS_1.kFLAGS.ANT_KIDS] > 2000)
                kidsMod++;
            //Success
            if (this.flags[kFLAGS_1.kFLAGS.PHYLLA_GEMS_HUNTED_TODAY] == 0 && AntsScene.rand(20) + kidsMod > 10) {
                var gems = 0;
            ...
            this.flags[kFLAGS_1.kFLAGS.PHYLLA_GEMS_HUNTED_TODAY] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Drider/Bee impregnation scene for Phylla (universal unless otherwise specified, which will include varied intros and stuff.
        //Sex > [Egg Phylla]
        eggDatBitch() {
            ...
            //First Time:
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_EGG_IMPREGNATING_PHYLLA] == 0) {
            ...
            //Subsequent Times:
                ...
                this.outputText("You give Phylla a knowing look then glance back at your swollen spider abdomen.  Playfully you thrust your ovipositor at her.  Phylla giggles a little, knowing what you want to do to her.");
            ...
            //Persuasion Success
                ...
                if (!this.pregnancy.isPregnant)
                    this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_DRIDER_EGGS, 8 * 24); //Supposed to be eight days, not eight hours
                this.flags[kFLAGS_1.kFLAGS.TIMES_EGG_IMPREGNATING_PHYLLA]++;
                this.player.orgasm();
                this.player.dumpEggs();
            }
            this.doNext(this.camp.returnToCampUseOneHour);
    ...
    exports.AntsScene = AntsScene;
});
//# sourceMappingURL=AntsScene.js.map