define(["require", "exports", "../../../BaseContent", "./DemonPack", "../../../../../includes/appearanceDefs", "../../../StatusAffects", "../../../PregnancyStore", "../../../GlobalFlags/kFLAGS"], function (require, exports, BaseContent_1, DemonPack_1, appearanceDefs_1, StatusAffects_1, PregnancyStore_1, kFLAGS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Oasis extends BaseContent_1.BaseContent {
        oasisEncounter() {
        ...
        oasisTalkAccept() {
            ...
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                this.outputText("your rear legs losing their balance and sending you crashing on your flank.  ", false);
            else
                this.outputText("legs falling open in the process.  ", false);
            this.outputText("Suddenly the silence is broken by a shrill screeching laugh, then a howl and the movement of the demons begins to accelerate. The deep bass laugh of the demon leader breaks over you like a crashing wave and the demons shriek with frenzied lust as they take you on the sand of the oasis.", false);
            //Count voluntary submissions
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.VoluntaryDemonpack) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.VoluntaryDemonpack, 0, 0, 0, 0);
            else {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.VoluntaryDemonpack, 1, 1);
            }
            //TO THE SECKSIN!
        ...
        oasisSexing() {
            ...
            if (this.player.cocks.length > 0) {
                ...
                this.outputText("your " + this.multiCockDescriptLight() + " and begin to slide up and down before another demon pushes them out of the way and you ", false);
                if (this.player.cocks[0].cockLength > 25)
                    this.outputText("feel your " + this.cockDescript(0) + " slide into a hell-girl's sloppy cunt. The demoness moans and pants in pleasure as your " + this.cockDescript(0) + " bottoms out in her gaping pussy and she begins to ride you like the motionless whore you momentarily are, her gigantic breasts threatening to concuss you as she slides the huge distance up and down your cock in her thirst to fill her cavelike cunt.  ", false);
                else {
                    this.outputText("see a smaller and younger demon lowering her very tight pussy onto your " + this.cockDescript(0) + ". It's a tight fit, but her almost-virginal pussy is dripping wet. She bottoms her pussy out ", false);
                    if (this.player.cocks[0].cockLength > 17)
                        ...
                        this.outputText("as her pussy lips touch the base of your " + this.cockDescript(0) + " ", false);
                    ...
                    if (this.player.cocks[0].cockLength > 6) {
                        this.outputText("The realisation that her pussy is slowly stretching over your " + this.cockDescript(0) + " gives you a thrill that can only be described as positively evil.  ", false);
                        this.dynStats("cor", 1);
                    }
                    this.outputText("Soon the slender cock-whore begins to cum and she starts on what is about to be the first of several shuddering orgasms. You smile evilly as she cums around your " + this.cockDescript(0) + " and when her eyes roll back to the front of her head you know that there is more to come.  ", false);
                }
                //Orgasmzzzzzzz
                this.outputText("Soon you're shaking and pumping your seed deep into her pussy as she screams out one of her many orgasms and you cum deep inside her for the first time.  ", false);
                //Multizz
                if (this.player.cocks.length > 1) {
                    ...
                    if (this.player.cocks.length == 2)
                        ...
                        this.outputText("cocks are", false);
                    this.outputText(" taken by other hands and other eager pussies ranging from painfully, childishly tight to freakishly huge!", false);
                }
                //IZ OVER FOR MENZ
                this.outputText("\n\n", false);
            }
            ...
            if (this.player.vaginas.length > 0) {
                ...
                if (this.player.gender == 3)
                    this.outputText("From your cock it is only a tiny trip downward between your legs before the demons discover something new to play with.  ", false);
                //Girlies only!
                else
                    this.outputText("The demons quickly find your " + this.vaginaDescript(0) + " and tussle eagerly for position at your entrance, first with hands and then with a wide range of demonic dicks.  ", false);
                //gaping cunners!
                if (this.player.vaginas[0].vaginalLooseness >= appearanceDefs_1.VAGINA_LOOSENESS_LEVEL_CLOWN_CAR)
                    this.outputText("However all of this fighting for place is in vain, as the leader with the huge cock has already marked you for his own. The broad demon shoves the smaller ones roughly to the side at the sight of your freakishly large pussy and carefully lowers his gigantic dick to the entrance of your gargantuan fuck hole. Without pause or ceremony the leader plunges his enormous phallus into you and although it takes all the muscles in his body he begins to drive it back and forth, filling every possible inch of your " + this.vaginaDescript(0) + ". You feel a curious pain that you've not felt in a long time and realize that your " + this.vaginaDescript(0) + " is stretching around his frankly frightening tool. As he withdraws the walls spring back with a curious elasticity, and it occurs to you that it may not actually be possible to stretch further with any permanence. Before long the huge demon begins to shudder and shake and he cums. His trio of heavy balls pump load after load into your waiting cunt until your belly bulges and spunk begins to spurt back out of your pussy from the sheer amount of cum being loaded into you.", false);
                //Not gaping!
                else {
                    this.outputText("Eventually one of the demons wins out and sets the tip of his hefty dog-cock at the entrance to your pussy. He rams his member into your " + this.vaginaDescript(0) + " with one swift thrust and begins to pump himself in and out of your cunt. However, the other demons will not be denied. You feel a pressure at your lips and without warning a second slightly smaller dick shoves itself into your already-stuffed " + this.vaginaDescript(0) + ".  ", false);
                    //vaginal streeeetch
                    this.player.cuntChange(40, true);
                    this.outputText("The two cocks pump you hard until you feel one of them shooting your " + this.vaginaDescript(0) + " full of hot demon cum. Eventually both the dicks release inside you and slip out one after the other, but each time another takes their place so that your pussy is never empty.", false);
                }
                //Orgasmzzzzz
                this.outputText("\n\nThe feeling of immense fullness gets better and better as the cum surging into your " + this.vaginaDescript(0) + " fills any conceivable crevice not taken up by cock. Far beyond your own control now you come a hair's breadth from passing out as you feel the muscles of your " + this.vaginaDescript(0) + " begin to clamp down again and again on the mass inside you.  Eventually the world begins to solidify again and it is with a sense of immense delight that upon your return from the borders of unconsciousness you find yourself still completely full of demonic dick, heralding many more orgasms of that quality to come.", false);
                //IZ OVER! NEWLINE BITCH
                this.outputText("\n\n", false);
                //Preggers chance!
                this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_IMP, PregnancyStore_1.PregnancyStore.INCUBATION_IMP, 90);
            }
            //Buttbutt buuuuuttt
            if (this.player.gender > 0)
                this.outputText("However, the demons are interested in every part of you, not just your crotch.  ");
            this.outputText("Soon you feel hands and dicks grabbing and jabbing at your " + this.buttDescript() + ", edging inwards bit by bit and jostling for position as a slippery cock positions itself at the opening of your " + this.assholeDescript() + ". It pauses for a second and then dives straight into your waiting asshole.  ", false);
            if (this.player.vaginas.length > 0)
                this.outputText("You feel the cocks in your ass and pussy rubbing into each other as your lower body becomes a temple of friction. The feeling of so much demon stuffing you as full as possible is almost unbearable, and you are inches away from blacking out as you come again.  ", false);
            ...
            //More fucking!
            this.outputText("Around you you see the demons wrapped up in the frenzy of fucking that they've fallen into. No hole is unfilled and not a single cock isn't sunk into some being's flesh. The moans and screams are almost contagious and you feel them clouding your brain making you want more, harder.", false);
            this.dynStats("int", -1, "lib", 1);
            //Titzen!
            if (this.player.breastRows.length > 0) {
                if (this.player.biggestTitSize() > 1) {
                    this.outputText("  Demonic hands grab and squeeze at your " + this.allBreastsDescript() + " and lips fasten around your " + this.nippleDescript(0) + " and begin to lick and suck like there's no tomorrow.", false);
                }
            }
            //Newline for oral!
            ...
            //If you got here by losing combat!
                ...
                //Antmorph stuff
                if (this.monster.findStatusAffect(StatusAffects_1.StatusAffects.phyllafight) >= 0) {
                    ...
                    this.flags[kFLAGS_1.kFLAGS.ANTS_PC_FAILED_PHYLLA] = 1;
                }
                this.outputText("The demons fuck you like animals until you can't come any more. Every one of your orifices is filled and you pump out orgasm after orgasm until you black out from the abuse.", false);
                this.cleanupAfterCombat();
                this.player.orgasm();
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.VoluntaryDemonpack) >= 6 && this.player.hasVagina()) {
        ...
        oasisBadEnd() {
            ...
            //[If female/herm]
            if (this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                this.outputText("Your feet are locked up in shackles, though with a chain long enough to leave you room to move or walk without problems. ", false);
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                this.outputText("Your four legs are locked up in shackles, though with a chain long enough to leave you room to move or walk without problems. ", false);
            ...
            if (this.player.gender >= 2)
                this.outputText("He reaches down to grab a hold of your hair and lifts you to your feet, causing you to yelp out in pain from the sharp pull.  ", false);
