define(["require", "exports", "../../../BaseContent", "../../../PregnancyStore", "../../../GlobalFlags/kFLAGS", "../../../CoC", "../../../../console", "../../../StatusAffects", "./SandWitch", "../../../PerkLib", "../../../../../includes/appearanceDefs", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, BaseContent_1, PregnancyStore_1, kFLAGS_1, CoC_1, console_1, StatusAffects_1, SandWitch_1, PerkLib_1, appearanceDefs_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class SandWitchScene extends BaseContent_1.BaseContent {
        constructor() {
            super();
            this.pregnancy = new PregnancyStore_1.PregnancyStore(kFLAGS_1.kFLAGS.EGG_WITCH_TYPE, kFLAGS_1.kFLAGS.EGG_WITCH_COUNTER, 0, 0);
            this.pregnancy.addPregnancyEventSet(PregnancyStore_1.PregnancyStore.PREGNANCY_BEE_EGGS, 96);
            //Event: 0 (= not pregnant), 1, 2 (< 96)
            this.pregnancy.addPregnancyEventSet(PregnancyStore_1.PregnancyStore.PREGNANCY_DRIDER_EGGS, 96);
            //Event: 0 (= not pregnant), 1, 2 (< 96)
        ...
        timeChange() {
            ...
            console_1.trace("\nSand Witch time change: Time is " + this.model.time.hours + ", incubation: " + this.pregnancy.incubation + ", event: " + this.pregnancy.event);
        ...
        encounter() {
            ...
            this.clearOutput();
            this.outputText("A strange woman seems to appear from the dunes themselves.  She identifies herself as a sand witch, and politely asks if she can cast a spell on you.");
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1 && this.player.cockArea(0) > 100 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Exgartuan) == 0) {
                this.outputText("\n\nThe " + this.player.armorName + " covering your lower half hits the ground, as if yanked down by magic.  Your " + this.cockDescript(0) + " pulsates darkly, growing rigid in seconds as the demon within you takes over.  It barks, \"<i>Fuck, how about I cast my spell on you baby?</i>\"\n\n");
                this.outputText("The sandwitch ");
                if (this.player.cor < 50)
                    this.outputText("and you both turn crimson", false);
                else
                    this.outputText("turns crimson", false);
                this.outputText(" as you yank your " + this.player.armorName + " back into place.  You're in charge here, not some possessed appendage!   Exgartuan yells something snide, but it's muffled too much to understand.  You look up in time to sidestep an attack from the Sand Witch.  It looks like you'll have to fight her!");
                this.startCombat(new SandWitch_1.SandWitch());
            }
            else
                this.doYesNo(this.allowSandWitchMagic, this.refuseSandWitchMagic);
        }
        allowSandWitchMagic() {
            this.spriteSelect(50);
            this.clearOutput();
            if (this.player.hairColor == "sandy blonde") {
                this.outputText("She smiles wickedly and intones, \"<i>Tresed eht retaw llahs klim ruoy.</i>\"\n\n", false);
                ...
                if (this.player.biggestTitSize() >= 1 && this.player.biggestTitSize() <= 2) {
                ...
                if (this.player.breastRows[0].nipplesPerBreast < 1) {
                    this.outputText("Two dark spots appear on your chest, rapidly forming into sensitive nipples.  ", false);
                    this.player.breastRows[0].nipplesPerBreast = 1;
                    this.dynStats("sen", 2, "lus", 1);
                }
                if (this.player.biggestLactation() > 0) {
                    ...
                    if (this.player.biggestLactation() < 2)
                        this.outputText("powerful jets of milk spray from your nipples, spraying thick streams over the desert sands.  You moan at the sensation and squeeze your tits, hosing down the tainted earth with an offering of your milk.  You blush as the milk ends, quite embarassed with your increased milk production.  ", false);
                    if (this.player.biggestLactation() >= 2 && this.player.biggestLactation() <= 2.6)
                ...
                if (this.player.biggestLactation() == 0) {
                    this.outputText("A pleasurable release suddenly erupts from your nipples!  Streams of milk are spraying from your breasts, soaking into the sand immediately.  It stops all too soon, though the witch assures you that you can lactate quite often now.  ", false);
                    this.player.boostLactation(1);
                    this.dynStats("lib", .5, "sen", 1, "lus", 10);
                }
                this.outputText("The sand-witch smiles and thanks you for your offering.  You notice her dress is damp in four spots on the front.  ", false);
                if (this.getGame().sand == 0)
                    this.outputText("You wonder at what her robes conceal as she vanishes into the dunes.", false);
                if (this.getGame().sand == 1) {
                    if (this.player.cor <= 33)
                        this.outputText("You are glad to avoid servicing her again as she vanishes into the dunes.", false);
                    else if (this.player.cor <= 66)
                        this.outputText("You wonder if you should've resisted and tried for some sex as she departs.", false);
                    else
                        this.outputText("You wish you had said no, so you could fuck with her and her magnificent quartet of breasts some more.", false);
                }
            }
            else {
                this.outputText("She smiles wickedly and intones, \"<i>nuf erutuf rof riah ydnas, nus tresed eht sa ydnas.</i>\"\n\nYou feel a tingling in your scalp, and realize your hair has become a sandy blonde!", false);
                this.player.hairColor = "sandy blonde";
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        refuseSandWitchMagic() {
            this.spriteSelect(50);
            this.clearOutput();
            this.outputText("With an inarticulate scream of rage, the Sand Witch attacks!");
            this.startCombat(new SandWitch_1.SandWitch());
        }
        sandwitchRape() {
            this.spriteSelect(50);
                ...
                if (this.player.hairColor.indexOf("sandy blonde") != -1) {
                    ...
                    if (this.player.averageNipplesPerBreast() < 1) {
                        ...
                        while (this.temp > 0) {
                            ...
                            if (this.player.breastRows[0].nipplesPerBreast < 1)
                                this.player.breastRows[0].nippleLength = .2;
                            this.player.breastRows[0].nipplesPerBreast = 1;
                        }
                        this.dynStats("sen", 2, "lus", 1);
                    }
                    ...
                    if (this.player.biggestLactation() == 0) {
                        this.outputText("A pleasurable release suddenly erupts from your nipples!  Twin streams of milk are spraying from your breasts, soaking into the sand immediately.  It stops all too soon, though the witch assures you that you can lactate quite often now.  ", false);
                        this.player.boostLactation(1);
                        this.dynStats("lib", .5, "sen", 1, "lus", 10);
                    }
        ...
        sandwitchRaped() {
            ...
            this.outputText("Even as you rip her sand-colored robes from her body, her eyes hold power and defiance. Her chest holds four large breasts, each leaking milk upon the sands.  ", false);
            //Malllllleeeee (or has penis)
            if (this.player.gender == 1 || this.player.gender == 3) {
                //Not so corrupt
                if (this.player.cor < 50) {
                    this.outputText("You smile at the sand witch, trying to seem enticing. A tiny smile plays across her face even though she supports a worried frown. She reaches up to you, and you allow her to gently pull you down to her. You marvel at her multiple breasts, each perfectly rounded. Each has a nipple approximately two inches long, enough to suck if you wanted to.  ", false);
                    this.outputText("Your attention wanders down to the damp sand underneath her legs, and her musky scent hits your nose. Which do you go after?\n\n", false);
                    this.simpleChoices("Breasts", this.sandwitchBewbs, "Sex", this.sandwitchSex, "", undefined, "", undefined, "", undefined);
                }
                //Really corrupt
                else {
                    //Single cock
                    if (this.player.cockTotal() == 1) {
                        //DOGGIES
                        if (this.player.dogCocks() > 0 && this.player.cocks[0].knotMultiplier > 1.4)
                            this.knotSandwitch();
                        else {
                            this.outputText("You place your " + this.player.foot() + " in the wet sand, pulling her hair and making her look you in the eyes. The sand witch looks shocked at your display of power, only turning you on more. You undo your " + this.player.armorName + " and grope her nethers, only to find a surprise. She has " + SandWitchScene.num2Text(this.player.cocks.length + 1) + " pussies and each seems to be made to fit you exactly. Pushing her to the ground, you bring the seeping head of your " + this.cockDescript(0) + " to one of her nethers, slowly easing into her depths.  ", false);
                            this.outputText("Thrusting deep, you hit bottom, and marvel at the sensations as you feel the head of your " + this.cockDescript(0) + " rub against the end of her slick cunts, only making you lust after her more. As though responding to your will, your " + this.cockDescript(0) + " grows just a tiny bit more in length and thickness.  ", false);
                            this.outputText("With a satisfied growl of lust from yourself, and a screech of pain from the sand witch, you break past her cervix and into her womb. Pulling out, you rub yourself against her wet outer lips, bringing yourself closer and closer to your peak as the sand witch struggles, her eyes turning wide with fright as she starts to understand you hold more power than her.  ", false);
                            this.outputText("With a bestial cry of lust, you shove your shaft deep within one of her vaginas, past her cervix and into her womb where you blast your potent, corrupted, demon-tainted seed.  ", false);
                            this.outputText("\n\nThe sand witch screams in savage denial as you plant your seed deep within her body, your corruption no doubt making it extra potent. You gaze into her eyes, reveling in her expression of horror. Without uttering a word, you continue to fuck her, making sure your seed is well-entrenched within her womb, feeling it splatter and bubble around your " + this.cockDescript(0) + ".  You wonder if she will remember the pleasure her body felt today, and if she will be more likely to drop to her knees before you than to fight... ", false);
                            this.outputText("Finally finished, you pull your " + this.cockDescript(0) + " from one of her well-used slits, your " + this.cockDescript(0) + " drooling cum even now. With a grin, you walk away, happy with your little encounter.  ", false);
                            this.player.orgasm();
                        }
                    }
                    //Multiprick
                    if (this.player.cockTotal() > 1) {
                        this.player.orgasm();
                        if (SandWitchScene.rand(2) == 0) {
                            this.rapeSandwitchMultis();
                            return;
                        }
                        this.outputText("Using the corruption in your blood, you place your " + this.player.foot() + " upon the budding shoots, and wipe them from existence. The sand witch looks shocked at your display of power, only turning you on more. You undo your loin cloth and grope her nethers, only to find a surprise. She has " + SandWitchScene.num2Text(this.player.cocks.length + 1) + " loose wet cunts and each seems to be made to fit you exactly. Pushing her to the ground, you bring the seeping heads of your " + this.multiCockDescriptLight() + " to her nethers, slowly easing into her depths.  ", false);
                        this.outputText("Thrusting deep, you hit bottom, and marvel at the sensations as you feel the heads of your " + this.multiCockDescriptLight() + " rub against the end of her wet pussies, only making your desire to penetrate increase. As though responding to your will, your " + this.multiCockDescriptLight() + " grow just a tiny bit more in length and thickness.  ", false);
                        this.outputText("With a satisfied growl of lust from yourself, and a screech of pain from the sand witch, you break past her cervixes and into her wombs. Pulling the heads of your " + this.multiCockDescriptLight() + " from her wombs, you rub and rut at the outside of her cunts, bringing yourself closer and closer to your peak as the sand witch struggles, her eyes turning wide with fright as she starts to understand you hold more power than her.  ", false);
                        this.outputText("With a bestial cry of lust, you shove your shafts deep within her vaginas, past her cervices and into her womb where you blast your potent, corrupted, demon-tainted seed.  ", false);
                        //A few dicks...
                        this.outputText("\n\nThe sand witch screams in savage denial as you plant your seed deep within her body, your corruption no doubt making it extra potent. You gaze into her eyes, reveling in her expression of horror. Without uttering a word, you continue to fuck her, making sure your seed is well-entrenched within her wombs, feeling it splatter and bubble around your " + this.multiCockDescriptLight() + ".  You wonder if she will remember the pleasure her body felt today, and if she will be more likely to drop to her knees before you than to fight... ", false);
                        this.outputText("Finally finished, you pull your " + this.multiCockDescriptLight() + " from her well used slits, your " + this.multiCockDescriptLight() + " drooling cum even now. With a grin, you walk away, happy with your little encounter.  ", false);
                    }
                    this.cleanupAfterCombat();
                }
            }
            //Femfem
                ...
                this.outputText("You smile at the sand witch, trying to seem enticing. A tiny smile plays across her face even though she supports a worried frown. She reaches up to you, and you allow her to gently pull you down to her. You marvel at her multiple breasts, each perfectly rounded. Each has a nipple approximately two inches long, enough to suck if you wanted to.  ", false);
                this.outputText("Your attention wanders down to the damp sand underneath her legs, and her musky scent hits your nose.\n\n", false);
                this.sandwitchBewbs();
            }
        }
        sandwitchBewbs() {
            this.spriteSelect(50);
            this.outputText("", true);
            this.outputText("You move yourself atop the defeated sand witch, and bring your lips to her breasts.  The moment the first drop of milk touches your tongue, you drink, hungrily, needfully, demandingly. You grope and massage her breasts as she leans back and cries out, her eyes wide in surprise. You guzzle and drink her sweet cream, the small seedlings underneath you appearing to rustle and move as you drink the alabaster flow once intended for the desert sands.  ", false);
            this.outputText("Warmth fills your gluttonous belly, and the sand witch places a hand to your stomach, rubbing it lightly as you drink from her breasts, moving on when the one you're drinking from is drained.  ", false);
            this.outputText("You burp, and flush scarlet, but the sand witch lays a hand against your face, leans close, and kisses your lips sweetly. Her tongue snakes out and dives into your mouth. She pulls your face against hers, grinding her breasts against your chest. You can feel fresh milk dribbling against your " + this.player.skinDesc + " and the scents are driving you wild with lust.  ", false);
            this.outputText("She breaks the kiss and smiles at you, whispering. Your eyes slowly close as you grow drowsy; you realize too late that she's casting a spell. You fall asleep, the sand witch's milk in your stomach churning, gurgling.  ", false);
            this.outputText("You wake up in the desert, immediately grabbing at your body to see if anything's changed...", false);
            this.player.slimeFeed();
        ...
        sandwitchSex() {
            this.spriteSelect(50);
            this.outputText("", true);
            this.outputText("With a charming, disarming smile, you reach between her legs and touch against the slick lips of her pussies. She has ", false);
            if (this.player.cockTotal() > 1)
                this.outputText(SandWitchScene.num2Text(this.player.cockTotal()), false);
            else
                this.outputText("two", false);
            this.outputText(" of them!  The sand witch appears frightened, but as you gently tease her lips with your fingers, she slowly starts to breathe faster, starting to moan as her legs spread themselves against her better judgment. Grinning in satisfaction, you bring your rigid " + this.cockDescript(0) + " against her lips, and push slowly, gently.  ", false);
            this.outputText("The sand witch cries out, her hands grabbing your arms, pressing hard against your " + this.player.skinDesc + " as you slowly and teasingly ease your " + this.cockDescript(0) + " into her tight depths. You almost feel like a virgin, your " + this.cockDescript(0) + " throbbing, the need to cum almost beyond your ability to control.  ", false);
            this.outputText("You rest against her chest, her large breasts squirting milk against your own chest as your weight appears to excite her enough to make her lactate, if what you're doing already wasn't enough.  ", false);
            this.outputText("You kiss the sand witch, getting accustomed to her unbelievable tightness. You hump backwards and forwards, grinning like a fool with his first girlfriend. Not even a succubus would be able to rival her lush depths.  ", false);
            this.outputText("You finally get serious and ease yourself into fucking the sand witch, slowly gaining speed and depth as your groins slap together with such ferocity that a normal person would be bruised upon their next waking. You pound the sand witch, making her scream in ecstasy, her already tight depths turning vice-like as you grunt your lust, cumming and filling her depths. Your ", false);
            if (this.player.balls >= 2)
                this.outputText("balls ache and your ", false);
            this.outputText(this.cockDescript(0) + " throbs with need, even as you empty your lust into the defeated sand witch.", false);
            this.outputText("\n\nWith a satisfied smirk, you lay atop your prize, your " + this.cockDescript(0) + " still twitching within her depths. One of the sand witch's hands rubs at your head, teasing your " + this.player.skinDesc + ". Like a fresh youth, you fall asleep, " + this.cockDescript(0) + " buried deep in the sand witch.  ", false);
            this.outputText("With a start you wake up, only to find the sand witch still passed out beside you.  Almost thinking it was a dream, you touch your groin tenderly and rub softly. There's a faint trace of soreness, and you remember the ferocity with which you mashed your pelvises together.  You get up and get ready.  ", false);
            this.player.orgasm();
            this.cleanupAfterCombat();
        }
        /*
        ...
        sandwitchCentaurBoning() {
            ...
            if (this.monster.HP < 1)
                this.outputText("and torn in many places. ", false);
            //[win via lust]
            else
                this.outputText("and her fingers squeezing her nipples as lust overwhelms her. ", false);
            //[has breasts]
            if (this.player.biggestTitSize() > 3) {
                this.outputText("As you approach, her eyes drift up to your " + this.player.allBreastsDescript() + " and she ", false);
                //[win via HP]
                if (this.monster.HP < 1)
                    this.outputText("is unable to stop herself from slowly licking her lips. ", false);
                //[win via lust]
                else
                    this.outputText("sensually licks her parted lips. ", false);
            }
            //[lactating]
            if (this.player.biggestLactation() > 1) {
                this.outputText("Her eyes widen when she sees the beads of milk already dripping from your " + this.nippleDescript(0) + "s as her hand drops between her legs and she begins to slowly masturbate.", false);
            }
            this.outputText("\n\n", false);
            //[Corruption < 70]
            if (this.player.cor < 70) {
                ...
                if (this.player.totalCocks() > 0 && !this.player.hasVagina())
                    this.outputText(" and your " + this.cockDescript(0) + " hardens.", false);
                //[cunt only]
                if (this.player.hasVagina() && this.player.totalCocks() == 0)
                    this.outputText(" and your " + this.vaginaDescript(0) + " begins to drip with moisture.", false);
                //[cock and cunt]
                if (this.player.hasVagina() && this.player.totalCocks() > 0)
                    this.outputText(" and your " + this.cockDescript(0) + " hardens as your " + this.vaginaDescript(0) + " begins to drip with moisture.", false);
                if (this.player.gender == 0)
                    this.outputText(" her.", false);
                this.outputText(" She seems hesitant at first, but soon approaches and begins to run her hands along your stomach and your " + this.hipDescript(), false);
                //[has breasts]
                if (this.player.biggestTitSize() > 0)
                    this.outputText(", eyes fixed on your " + this.player.allBreastsDescript(), false);
                this.outputText(".\n\n", false);
        ...
        SWCentaurMore(argument) {
            ...
            if (argument == 2) {
                //[% Player has cock(s)]
                if (this.player.cockTotal() > 0 || (this.player.gender == 3 && SandWitchScene.rand(2) == 0)) {
                    this.outputText("Finished with your games, pre-cum starts pooling under your throbbing " + this.cockDescript(0) + ". ", false);
                    //[largest cock is wide]
                    if (this.player.cocks[0].cockThickness >= 3) {
                        if (this.player.hasKnot(0))
                            this.outputText("Seeing its sheer size combined with your swollen knot causes her to gasp in terror and try to run again.  ", false);
                        else
                            this.outputText("Seeing its sheer size causes her to gasp in fear and turn to run again.  ", false);
                    }
                    this.outputText("You grab the witch and knock her down into the sand, quickly lowering your " + this.cockDescript(0) + " to be against her buttocks. ", false);
                    //[1 cock, non-tentacle]
                    if (this.player.cockTotal() == 1 && this.player.tentacleCocks() == 0)
                        this.outputText("With a single thrust, you push deep into one of her cunts, ", false);
                    //[1 cock, tentacle]
                    if (this.player.cockTotal() == 1 && this.player.tentacleCocks() == 1)
                        this.outputText("Your " + this.cockDescript(0) + " caresses her anus teasingly, causing her to whimper in a mixture of arousal and denial.  With a single savage thrust, you push past her clenched muscles, ", false);
                    //[two cocks] 
                    if (this.player.cockTotal() == 2)
                        this.outputText("After aligning your " + this.multiCockDescriptLight() + " to her twin cunts, you push yourself deeply into her, ", false);
                    //[3+ cocks]
                    if (this.player.cockTotal() >= 3)
                        this.outputText("Lining up two of your cocks to her twin cunts and another to her anus, you thrust into her without pre-amble.  Her anal muscles try to keep you out, but they are no match for the strength of your legs.  You tear into her, ", false);
                    ...
                    //[2+ cocks]
                    if (this.player.cockTotal() >= 2) {
                        this.outputText("The feeling of your " + this.multiCockDescriptLight() + " touching each other through the narrow layers of her body causes you to grunt in pleasure, experiencing the sensation anew during every thrust. ", false);
                    }
                    //[largest cock is long, non-tentacle]
                    if (this.player.cocks[0].cockLength >= 12) {
                        if (this.player.cockTotal() == 1)
                            this.outputText("Her body surrenders more and more as your " + this.multiCockDescriptLight() + " presses against her cervix. ", false);
                        else
                            this.outputText("Her body surrenders more and more as your " + this.multiCockDescriptLight() + "  press against her cervixes. ", false);
                    ...
                    this.outputText("It feels like you have been pushing yourself into her for hours", false);
                    //[largest cock is wide and/or long]
                    if (this.player.cocks[0].cockLength >= 12 || this.player.cocks[0].cockThickness >= 3) {
                        this.outputText("; her cries have long since died down to whimpers. ", false);
                    }
                    //[largest cock is not wide and/or long]
                    else
                        this.outputText(", and her cries have long since turned into groans of pleasure. ", false);
                    ...
                    //[regular cum production] 
                        ...
                        this.outputText("pushing your sperm ", false);
                    ...
                    if (this.player.cockTotal() == 1 && this.player.tentacleCocks() == 1)
                        ...
                        if (this.player.cocks[0].cockLength >= 12 || this.player.cocks[0].cockThickness >= 3) {
                            ...
                            //[2+ cocks]
                            if (this.player.cockTotal() >= 2)
                                this.outputText("cunts", false);
                        }
                        //[largest cock is wide and/or long]
                        else {
                            this.outputText("womb", false);
                            if (this.player.cockTotal() >= 3)
                                this.outputText(" and bowels", false);
                        }
                    }
                    this.outputText(".  With a satisfied groan, you pull out and let your " + this.multiCockDescriptLight() + " dribble the last remnants of your cum over the ravished witch. Satisfied, you ride off into the desert.", false);
                }
                //[% no cocks]
                else {
                    ...
                    if (this.player.hasVagina())
                        this.outputText("and your " + this.vaginaDescript(0) + " dripping with desire", false);
                    ...
                    //[has cunt]
                    if (this.player.hasVagina()) {
                        this.outputText(this.vaginaDescript(0) + ", she fingers herself even harder than you had been a moment ago.  Her lips lock unto your " + this.clitDescript() + " and she suckles on it, drawing a pained gasp from you and causing your pussy juices to gush over her face. You feel ", false);
                        //[cunt size is small]
                    ...
                    //[does not has cunt]
                        ...
                        //[anus size is small]
                        if (this.player.analCapacity() < 10)
                            this.outputText("The sensations are intense, and you could almost swear that her tongue is tracing a pattern as her mouth mutters strange sounds. ", false);
                        //[anus size is normal] 
                        else if (this.player.analCapacity() < 20)
                            this.outputText("Unsatisfied with just her buffet, you soon feel her fingers thrust hard into you and hear her muttering what sounds like obscene words of depraved lust. ", false);
                        //[anus size is large]
                        else
                            this.outputText("Unsatisfied with just her buffet, the witch grabs one of her breasts and squirts milk into your massive hole.  You realize she was lubricating it even as you feel her entire hand driving into you.  The sensations are too intense, and your screams of pleasure drown out her lustful muttering. ", false);
                        this.outputText("Her mumbling finishes even as an orgasm overwhelms you.", false);
                        this.outputText("\n\n", false);
                        //[SW_1]
            ...
            if (argument == 3) {
                ...
                //[STR < 50]
                    ...
                    this.outputText("offer her your hand and help her onto your back. ", false);
                this.outputText("Your strong hooves carry you across the clear desert at a light trot.  Without her robes to protect her, you can feel the witch's bare pussies grinding against your back as she presses her quad of breasts against your shoulders.  Her moans intensify more and more as you pick up the pace.", false);
            }
            return false;
        }
        //Knot sand witch
        ...
        beatSandwitch() {
            ...
            if (this.monster.lust > 99)
                this.outputText("You smile in satisfaction as the " + this.monster.short + " drops down on all fours and begins masturbating feverishly.  Sadly you realize your own needs have not been met.  Of course you could always fuck the horny witch...\n\nDo you rape her?", true);
            else
                this.outputText("You smile in satisfaction as the " + this.monster.short + " drops down on all fours and struggles to rise.  Sadly you realize your own needs have not been met.  Of course, you could always fuck the witch...", true);
            this.outputText("  Of course, just taunting, teasing, and humiliating her for her arrogance would be equally amusing, <b>but it would give her plenty of time to turn the tables...</b>");
            var temp2 = undefined;
            var temp3 = undefined;
            if (this.silly())
            ...
            if (kGAMECLASS_1.kGAMECLASS.shouldraFollower.followerShouldra() && this.player.gender > 0)
                shouldra = kGAMECLASS_1.kGAMECLASS.shouldraFollower.sandWitchGetsGhostly;
            //doYesNo(sandwitchRaped, cleanupAfterCombat);
            var ovi = undefined;
            if (this.player.gender > 0 && this.player.canOviposit())
                ovi = this.ovipositSandWitches;
            this.choices("Yes", this.sandwitchRaped, "Dildo Rape", temp2, "Use 3i@-", temp3, "Use Shouldra", shouldra, "Lay Eggs", ovi, "Taunt Her", this.sandwitchSpanking, "", undefined, "", undefined, "", undefined, "Leave", this.cleanupAfterCombat);
        }
        ...
        missingoSex() {
            this.spriteSelect(50);
            this.outputText("", true);
            this.outputText("You stride proudly towards your latest conquest, the prone witch starting at you with a look of pure and delightful helplessness. She backs away on all fours, but a simple \"Stop.\" uttered from your lips is enough to freeze her in place. You look do/n at her, your \" + multiCockDescript(0) + \" throbbing within your clothes. What clothes? Oh, those clothes th$t you happen to be tearing from your body, much to her dismay.\n\n", false);
            this.outputText("Clearly, this bitch needs the dick. And you're just the ^&a*pion to give it to her. You lick your lips and drop to your @nees, taking hold of her le-s and forcibly spreading them apart. Looking down, you see that her body is quite ready for you, her exposed fuckhole pouted and moist. You cannot help but laugh a- the situation, the motions making your \" + multiCockDescript(0) + \" bounce in the open air as you co-vulse with laugh-er. Her res$$tance only serves to arouse you, making you savor that choice ass before you claim it for your own.\n\n", false);
            this.outputText("You want to embarrass her further, complete her humiliation upon the sands she once thought to be her domain. You tear her robes into little shreds, exposing her four generously sized breasts. Your eyes follow her dri-^ling nipples, the pupils bouncing as they do. \"Wh-what are you going to do? Rape me?!\" cries the witch, her tone equal parts terrified and wishful. Her thighs attempt to close, though you're sure it's more t$ grind them together than any atte-pt at preserving her modesty. Leaning down, y-u open up to let your tongue lap at her swollen clit. She arches her back and moans, thrusting her hips towa-ds you as bes- she can.\n\n", false);
            this.outputText("0)w is t$e time. But no, she won't get the dick. She hasn't EAR*ED the dick. She isn't even wor$h your \" + vaginaDescript(0) + \" yet. No n- no, you need -o warm that ho_ cunt up. You whistle to g-t her attention, and as you do, you present your -i%-s ^a_=e* up to*--h-r. Her eyes wi_en, the wo$an's jaw going slack. \"N-no.. not t-e whole thing.\" you nod _n respo-se to her plea. \"The WHO-E THING?!\"\n\n", false);
            this.outputText("Now she begins to panic. She shake- her head rapidly as you draw bac- your %s99=, and thrust them towards her >pen sl1t...", false);
            this.outputText("\n\n<b>Don't report this as a bug, okay dawg?</b>", false);
            this.simpleChoices("N*xt", this.missingoSex2, "", undefined, "", undefined, "", undefined, "", undefined);
        }
        //{Next Page}
        missingoSex2() {
            this.spriteSelect(50);
            this.outputText("", true);
            this.outputText("Naturally, you %i-+. Hon-stly, her hole can't take such a pounding. You can tell t-is by looking at her prone,',, vulnerable body, #ipe for y-ur abuse. Your *i- isn't ev|n enough to do this! Your-i*))s fall short, landing i( the sand, splashing he- bo^y with a wave of the -tuff. She gasps in su!p!i!e, barely a?le to keep it from getting into h_r mouth. Her tits hardly fare as well, being coated genero_sly, ^er milk mi$ing w--h it. The resulting concocti@n sticks to her chest, leaving it quite the mess.\n\n", false);
            this.outputText("\"I can't belie^e you just tried that.\" she says with a )_=f. \"You're goi(g to get and in all s))ts o& uncomfortable places ^& you ke-_p that up.\"\n\n", false);
            this.outputText("\"Still...\" she says, ##ok%7g at you slyly. \"Why don't you (ull b=c( and try that again....\"", false);
            //[N*xt]
            this.simpleChoices("N*xt", this.missingoSex3, "", undefined, "", undefined, "", undefined, "", undefined);
        }
        //{Next Page}
        missingoSex3() {
            this.spriteSelect(50);
            this.outputText("", true);
            this.outputText("_at_r@_ly, you %i-+. Ho@-@@ly, her h_le c_n't take @_ch _ po_ndi_g. Yo_ can t_ll t-is b_ loo_ing _t her pr_ne,',, v@^@erable b@dy, #ipe _or y-ur a_use. Y_ur *i- isn't ev|n en_ug_ to do this! Y_ur-i*))s fall sho_t, la@d@ng i( the sa_d, sp_as_i_g he- bo^y wit@ a @ave @f the -tuff. She gasps in su!2!i!e, ba_el_ a?le to k_ep it fr_m g_tti_g into h_r m_uth. @er @it@ har_ly fa_e as well, bei@g c@_t_d ge_ero_sl_, ^er milk mi$ing w--h it. T_e re_ult_ng co@cocti@n sti-ks to her c_est, l@a_in@ it q_ite t_e m_s_.\n\n", false);
            this.outputText("\"@ @a@'t b@lie^e y_u j@st _rie_ th_t.\" s@e sa_s @?th a )_=f. \"Yo_'re @oi(g to g_t a_d in all s))ts o& u_c_mfo_table pla_es ^& yo_ ke-_p t@at u@.\"\n\n", false);
            this.outputText("\"@_i@_...\" s_e says, ##o@%7g @t yo_ s_@_y. \"W_@ d_n't @o_ (ull b=c( an_ @r_ _h_@ a_@in....\"\n\n", false);
            //[@*xt]
            this.simpleChoices("@*xt", this.missingoSex4, "", undefined, "", undefined, "", undefined, "", undefined);
        }
        //{Next Page}
        missingoSex4() {
            this.spriteSelect(50);
            this.outputText("", true);
            this.outputText("_oo_o@_oo, ooo %o-+. oo@-@@oo, ooo o_oo o_o'o oooo @_oo _ oo_ooo_o. oo_ oo o_oo o-oo o_ ooo_ooo _o ooo oo_o,',, o@^@oooooo o@oo, #ooo _oo o-oo o_ooo. o_oo oo- ooo'o oo|o oo_oo_ oo oo oooo! o_oo-o*))o oooo ooo_o, oo@o@oo o( ooo oo_o, oo_oo_o_o oo- oo^o ooo@ o @ ooo@o ooo -oooo. ooo ooooo oo oo!2!o!o, oo_oo_ o?oo oo o_oo oo oo_o o_ooo_o oooo o_o o_ooo. @oo @oo@ ooo_oo oo_o oo oooo, ooo@o o@_o_o oo_oo_oo_, ^oo oooo oo$ooo o--o oo. o_o oo_ooo_oo oo@ooooo@o ooo-oo oo ooo o_ooo, l@o_oo@ oo o_ooo o_o o_o_.\n\n", false);
            this.outputText("\"@ @o@'o o@ooo^o o_o o@oo _ooo_ oo_o.\" o@o oo_o @?oo o )_=o. \"oo_'oo @oo(o oo o_o o_o oo ooo o))oo o& o_o_ooo_ooooo ooo_oo ^& oo_ oo-_o o@oo o@.\"\n\n", false);
            this.outputText("\"@_o@_...\" o_o oooo, ##o@%7o @o oo_ o_@_o. \"o_@ o_o'o @o_ (ooo o=o( oo_ @o_ _o_@ o_@oo....\"", false);
            //[Fuck this!]
            this.simpleChoices("Fuck This!", this.missingoSex5, "", undefined, "", undefined, "", undefined, "", undefined);
        }
        //{Next Page}
        missingoSex5() {
            this.spriteSelect(50);
            this.outputText("", true);
            this.outputText("Yeah no, fuck this shit. Seriously. You grip your controller with a barely restrained fury, fighting the urge to throw it across the room in a fit. Taking a moment, you collect yourself, and test the game. Yep, totally unresponsive to your buttons now. Damn thing froze AGAIN.\n\n", false);
            this.outputText("You sigh a defeated sigh and cut the power to your Super Fentendo. After removing your Corruption of Champions cartridge and inspecting it for damage, you flip it over and blow into the open end of it a few times. Crisp, clean blowing, from one end to the other. Thorough. Professional. These games should be proud to have you as their owner.\n\n", false);
            this.outputText("You flip up the little plastic fedora on your Imp-head-shaped Fentendo, exposing the cartridge slot and giving it a looksee. No problems there, it seems. Just to be sure, you huff and puff and blow for dust. It's bad enough that this system only supports one game, AND you have to go out to the store and pick up a new copy of it every time the developer makes one or two tiny little changes to the game. But those crashes and terrible dialogue in the last scene? You'd think that some of the writers just weren't trying anymore.\n\n", false);
            this.outputText("The system powers up with the usual blips and boops you'd expect from this 8-bit powerhouse. So far so good. The Corruption of Champions title screen pops up, heralded by a little pixelated imp eagerly waving at the player with both hands and something else that protrudes from his body. The CoC theme kicks up, and you smile to yourself. Goddamn if that theme isn't catchy as all getout. You're going to have it stuck in your head for the rest of the day, you wager, but at least you'll have something to hum while you masterbate.\n\n", false);
            this.outputText("Oh goddammit. You remember that your progress from before was lost, and now you have to start from the beginning. You can't help but roll your eyes and groan, though you're hardly angry enough to put a controller-shaped hole through your TV screen over this. But hey! At least you were smart enough to jot down the Champion Password. Perhaps one day video games will be sophisticated enough to have some internal means of storing progress, but at least with this, you should be able to get all of your old stuff!", false);
            //Restore]
            this.simpleChoices("Restore", this.missingoSex6, "", undefined, "", undefined, "", undefined, "", undefined);
        }
        //{Next Page}
        missingoSex6() {
            this.spriteSelect(50);
            ...
            this.outputText("", true);
            this.outputText("You successfully restore your game. Everything's intact. At least, you thought it was. You must have messed up the password somewhere along the line, but oddly enough, the only difference is the clock being set an hour ahead and a few extra gems and EXP in your pocket.\n\n", false);
        ...
        ovipositSandWitches() {
            ...
            if (this.monster.HP < 1)
                this.outputText("bruised and battered");
            else
                this.outputText("lusty");
            this.outputText(" sand witch, you feel the familiar tug of arousal in your loins.  Yet your current... situation offers quite the opportunity to relieve some tension through the use of your 'other' sexual appendage.  Licking your lips in anticipation, you lower yourself down to the obstinate spell caster, who immediately reacts with ");
            if (this.monster.HP < 1)
                this.outputText("fright as she clamors to get away.");
            else
                this.outputText("an uneasy curiosity to see what exactly you have planned.");
            ...
            if (this.player.hasCock())
                this.outputText("hardened  " + this.multiCockDescriptLight());
            if (this.player.gender == 3)
                this.outputText(" and ");
            if (this.player.hasVagina())
                this.outputText(this.clitDescript());
            this.outputText(" for her viewing consumption.  Making quite the persuasive argument of non-hostility as you do, the sand witch finally relents, removing her cloak and exposing her four-breasted, ");
            if (this.player.totalCocks() > 1)
                this.outputText(SandWitchScene.num2Text(this.player.cockTotal() + 1));
            else
                this.outputText("two");
            this.outputText("-sexed form, allowing the sun to glisten off her bare body.");
            ...
            if (this.player.canOvipositBee())
                this.outputText("bee-morphs");
            else
                this.outputText("driders");
            this.outputText(" can do to their partners and unsure if this is really what she wants.  The poor girl seems to need a little 'encouragement'... of course, you could just skip all that regardless if you really wanted.");
            //[Foreplay 1st]    [Get Fucking]
            this.simpleChoices("Foreplay 1st", this.eggwitchForeplay, "Get Fucking", this.getToFuckingWithZeEggsInWitch, "", undefined, "", undefined, "", undefined);
        }
        //[Foreplay 1st]
        eggwitchForeplay() {
            this.clearOutput();
        ...
        laySomeEggsInThatWitchFinally() {
            this.clearOutput();
            var cunt = (SandWitchScene.rand(2) == 0);
            this.outputText("Before long the intense need to culminate the act grows too lucid to ignore, and with a hum of satisfaction you finally bore your ovipositor through the tight ");
            if (cunt)
                this.outputText("folds of her vulva");
            else
                this.outputText("ring of her anus");
            this.outputText(".  Like something out of a fever dream, the bizarre appendage you wield burrows further and further into her ");
            if (cunt)
                this.outputText("sex");
            else
                this.outputText("ass");
            this.outputText(", the ");
            if (cunt)
                this.outputText("ribbed contours of her pussy");
            else
                this.outputText("tight fit of her innards");
            this.outputText(" enrapturing your egg-tube with every passing inch.  You begin the process of lubricating the antsy witch's ");
            if (cunt)
                this.outputText("love-");
            else
                this.outputText("anal ");
            this.outputText("canal for the delivery of your young; the witch barely contains her moans and utter glee at being filled with such a hot, humid substance.  In perverted delight the sand witch coos between kisses, her moans betraying a curiosity to explore just how pleasant mating this way can truly be.");
            ...
            if (cunt)
                this.outputText("opening of your lover's cervix");
            else
                this.outputText("deepest recesses of her sphincter");
            this.outputText(".  The joining of oviduct to ");
            if (cunt)
                this.outputText("womb");
            else
                this.outputText("anus");
            this.outputText(" now complete, you prepare yourself for the inevitable convulsion of orgasm along your bizarre appendage, grinning down at the sand witch with a smirk that can only convey that the fun's about to begin.  With a sudden, violent quake your ovipositor rumbles with the first of many eggs, squeezing your unborn brood down your shaft and pushing ");
            if (cunt)
                this.outputText("at the waiting lips of the sand witch's vagina");
            else
                this.outputText(" through her rectal walls");
            this.outputText(".  With a meticulous push, the forerunner of your young manages to infiltrate her passage, working its way valiantly into her depths with every convulsion.");
            ...
            if (cunt)
                this.outputText("into her waiting womb");
            else
                this.outputText("as far as you can safely tuck it");
            this.outputText(", nestled and sound until the scramble for life can begin.");
            this.outputText("\n\n\"<i>More... give me more...</i>\" the sand witch whimpers, caressing your ");
            //(Bee, non-horse:
            if (this.player.canOvipositBee() && !this.player.isTaur())
                this.outputText("torso");
            else
                this.outputText("pelvis");
            this.outputText(" to spur you on.  Of course you don't have a problem with fulfilling her wishes; the neglect of your throbbing sex");
            if (this.player.cockTotal() > 1 || this.player.gender > 2)
                this.outputText("es");
            this.outputText(" is the only point of dissatisfaction, a point you make clear when you ");
            if (this.player.hasCock())
                this.outputText("take hold of your " + this.multiCockDescriptLight() + " and bring it");
            else
                this.outputText("bring your " + this.vaginaDescript(0));
            this.outputText(" to her face.  The cute stare of her half-glazed eyes turns to the lunge of lips toward your sex, the sand witch driven like a woman possessed in her efforts to get the next batch going...");
            this.outputText("\n\nFor what feels like an eternity you sit atop the pliant sorceress, having her tend to your sex");
            if (this.player.cockTotal() > 1 || this.player.gender == 3)
                this.outputText("es");
            this.outputText(" while you slowly pump her full of eggs, her girlish little moans resonating through your body as she orally stimulates your ");
            if (this.player.hasCock())
            ...
            this.outputText(".  At long last her enthusiastic efforts bring you to a more 'traditional' release, lathering ");
            var facial = SandWitchScene.rand(2);
            if (facial == 0)
                this.outputText("her facial features with proof of your climax");
            else if (facial == 1)
                this.outputText("the interior of her mouth with sweltering streams of your cum");
            this.outputText(".  Having finally achieved release, and also having run out of eggs, you pull yourself free of the desert woman with a loud pop, the ");
            if (this.player.canOvipositBee())
                this.outputText("honey-like");
            else
                this.outputText("goopy");
            this.outputText(" lubricant drooling out of her in the absence of your intimate plug.  Utterly overwhelmed and exhausted, the sand witch resigns herself to gathering strength in the bright, blistering gaze of the desert sun.  Smiling to yourself, you take to re-donning your discarded [armor], remarking as you leave that you look forward to the next encounter; a sentiment the sorceress must agree with as she weakly waves to you, holding her stomach with her arms and filled with motherly delight at the thought of carrying your brood.");
            //Give her ze eggs!
            if (this.player.fertilizedEggs() > 0) {
                if (this.player.canOvipositBee())
                    this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_BEE_EGGS, 192);
                else
                    this.pregnancy.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_DRIDER_EGGS, 192);
            }
        ...
        sammitchBirthsDriders() {
            ...
            if (this.player.cor < 50)
                this.outputText("Intending to help");
            else
                this.outputText("Curious");
            this.outputText(", you slide down the dune that you are on and come to a stop next to the distressed woman.  However, upon seeing her face you realize that this is the very sand witch that you had a hot and steamy tumble with!");
        ...
        helpZeWithBirfBabies() {
            ...
            if (this.player.isTaur() || this.player.isDrider()) {
                ...
                if (this.player.isDrider())
                    this.outputText("skitter");
                else
                    this.outputText("gallop");
        ...
        sandwitchBirthsYourMonstrosities() {
            ...
            if (this.player.cor < 60)
                this.outputText(", with a quick kiss on the lips");
            this.outputText(", whisper in her ear that you'll see her again...");
            //[(corr >= 60)
            if (this.player.cor >= 60)
        ...
        witchBirfsSomeBees() {
            ...
            if (this.silly())
                this.outputText(", echoing tiny little cries of \"<i>@</i>\"");
            this.outputText("; likely it was just waiting for someone to find their mother before taking off in the general direction of the forest.  The weak voice of the desert vixen fills the air as she speaks to you.  \"<i>That... was the best.  I can't believe I'm a mother!</i>\"  She gives you a look of appreciation for showing her how pleasurable being a host can be.  Seeing she needs her rest, you give a nod and turn to leave... only to feel a hand grasp at your [leg].  \"<i>I would be disappointed if you didn't come around and 'say hello' more often; keep that in mind " + this.player.mf("handsome", "beautiful") + ".</i>\"  She coos, before drifting off to sleep.  She'll be fine in this shady part of the desert while she rests, the dune currently obstructing the sun and keeping her from being burned from the sun's rays.");
        ...
        sandwitchSpanking() {
            this.clearOutput();
            this.outputText("Feeling euphoric after your clear victory, you lazily circle the panting witch and laugh at her.  \"<i>Look at you,</i>\" you taunt, \"<i>A mighty witch of the sands, laid low by a helpless traveller.");
            if (this.monster.HP < 1)
                this.outputText("  You can't even stand up!");
            else
                this.outputText("  You can't even stop masturbating, can you?");
            this.outputText("</i>\"  You kick her hand away, and she tumbles down into a distraught heap, crying softly");
            if (this.monster.lust > 99)
                this.outputText(" but still masturbating");
            this.outputText(".  It's time for some fun!");
            ...
            if (this.player.cor < 33)
                this.outputText("and though you feel kind of bad about using her this way, she likely would have done worse to you.");
            else if (this.player.cor < 66)
                this.outputText("and though you aren't sure you ought to be using her this way, she likely would have done worse to you.");
            else
                this.outputText("and though you used to find things like this distasteful, you don't really give a shit anymore.");
            this.outputText("  You tweak and tease with a goofy smile, laughing as you aim one of the tits up into the witch's face, splattering her with her own alabaster juices.  You're so involved in it that you fail to notice the increasingly angry gaze that settles over your captive's face.  Her tits are just so goddamn fun to tease that you don't really waste any time paying attention to her from the neck up.  That's a mistake.");
            ...
            if (this.player.hasCock())
                this.outputText("Worse still, [eachCock] is now unprotected and pressed against the rough stone by your body-weight.  It's less than pleasant.  ");
            else if (this.player.hasVagina())
                this.outputText("Worse still, your [vagina] is pressed up against the rough stone.  It's less than pleasant.  ");
            this.outputText("You bristle at your helplessness");
            if (this.player.findPerk(PerkLib_1.PerkLib.FireLord) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.Hellfire) >= 0 || this.player.findPerk(PerkLib_1.PerkLib.Dragonfire) >= 0)
                this.outputText(", breathing out a gout of flame in rage, but you can't even direct the blast properly like this.  All it does is melt some of the sand below into glass");
            else
                this.outputText(", but there's nothing you can do");
            this.outputText(".  Fingers tickle the " + this.player.skin() + " of your bottom, and then, without warning, your [butt] is slapped!  The sound of the hit rings out across the desert, hard enough to make moisture bead at the corners of your eyes.");
            ...
            if (this.player.cor < 50)
                this.outputText("She sounds almost fanatical in her dedication to her order.");
            else
                this.outputText("What the hell is she on about?  Does she actually think her little torture session is going change your attitude?");
    ...
    exports.SandWitchScene = SandWitchScene;
});
//# sourceMappingURL=SandWitchScene.js.map