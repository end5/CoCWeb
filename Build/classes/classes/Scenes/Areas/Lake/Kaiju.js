define(["require", "exports", "./AbstractLakeContent", "../../../GlobalFlags/kFLAGS", "../../../StatusAffects", "../../../PerkLib", "../../../../../includes/appearanceDefs", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, AbstractLakeContent_1, kFLAGS_1, StatusAffects_1, PerkLib_1, appearanceDefs_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Kaiju extends AbstractLakeContent_1.AbstractLakeContent {
        ...
        kaijuMeeting() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.KAIJU_MEETINGS] == 0) {
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) >= 0 && !this.kaijuCock())
                    this.kaijuGrowsWangus();
                else if (this.flags[kFLAGS_1.kFLAGS.KAIJU_BAD_END_COUNTER] >= 5)
                    this.kaijuBadEndToyBOOSH();
                else
                    this.repeatKaijuEncounter();
            }
        }
        kaijuCock() {
            return (this.flags[kFLAGS_1.kFLAGS.KAIJU_COCK] == 1);
        }
        //[If no]
        noMeetingKaijus() {
            this.clearOutput();
        ...
        meetDatKaijuYo() {
            ...
            if (this.player.gender > 0)
                this.addButton(1, "Flirt", this.flirtWithKaiju);
            this.addButton(2, "Insult", this.insultTheKaijuFirstMeeting);
        }
        //[If insult]
        insultTheKaijuFirstMeeting() {
            this.clearOutput();
            this.spriteSelect(103);
            if (this.kaijuCock()) {
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.KnowsWhitefire) >= 0 && (this.player.findPerk(PerkLib_1.PerkLib.BloodMage) < 0 && this.player.fatigue + kGAMECLASS_1.kGAMECLASS.spellCost(30) > 100)) {
                ...
                this.flags[kFLAGS_1.kFLAGS.KAIJU_DISABLED] = 1;
                this.doNext(this.camp.returnToCampUseOneHour);
            }
        }
        //[If yes]
        ...
        corruptKaijuInsertion() {
            this.clearOutput();
            this.spriteSelect(103);
            this.outputText("She practically shoves your face into her dark green cock-head, your nose snug against the long slit.  It smells of the sexual corruption of the lake, of demonic jizz and tainted aphrodisiacs.  \"<i>Well go on,</i>\" she says, \"<i>lick it!</i>\"");
        ...
        complimentKaiju() {
            this.clearOutput();
            this.spriteSelect(103);
            this.outputText("You decide to compliment her figure, stating it is proportional and very pleasing.");
        ...
        letKaijuHaveWayWithYou() {
            ...
            if (this.player.hasCock()) {
                ...
                //[if PC has balls]
                if (this.player.balls > 0)
                    this.outputText("  Your [balls] begin to ache as you slowly empty your load onto green flesh.");
                this.player.orgasm();
            }
        ...
        flirtWithKaiju() {
            this.clearOutput();
            this.spriteSelect(103);
            this.outputText("You decide to try and flirt up the giantess.  You tell her that her figure is perfect and statuesque, and that her curves are quite magnificent to behold.  It seems to work if her spreading look of pleasure is any indication.");
            ...
            if (this.player.biggestTitSize() >= 1) {
                this.outputText("  Your [fullChest] slide across the slick yet firm vaginal flesh of her surprisingly dexterous cunt, your [nipples] stiffening from the constant teasing massage.");
            }
            //[If PC has cock]
            if (this.player.hasCock()) {
                ...
                if (this.player.cockTotal() > 1)
                    ...
                    this.outputText("is");
                this.outputText(" throbbing from the sexual stimulants of her aphrodisiac moisture and the pressing walls of her cunt flesh, pre forming at your tip");
                if (this.player.cockTotal() > 1)
                    this.outputText("s");
                this.outputText(".");
            }
            ...
            if (this.player.sens < 50) {
                ...
                //[If PC has cock]
                if (this.player.hasCock())
                    this.outputText("  [EachCock] spasms as you release your load onto her pussy walls, making them just a bit more slick with your contribution.");
                if (this.player.hasVagina())
                    this.outputText("  Your own pussy releases its own feminine juices, soaking your thighs even further in wetness.");
            ...
            if (this.kaijuCock()) {
                ...
                if (this.player.gender > 0) {
                    ...
                    if (this.player.biggestTitSize() >= 1)
                        this.outputText("  You press your [chest] against her cock flesh as well, giving her penis as much a boob job as such a behemoth prick can be given.");
                    if (this.player.lactationQ() >= 200)
                        this.outputText("  Milk spurts and flows from your [nipples], making your breast slick and shiny and helping you slide more easily along the throbbing meat-pole.");
                }
                ...
                if (this.player.gender > 0) {
                    ...
                    this.outputText("  Undeterred, you continue grinding upon the spurting pole until you reach your own smaller, far less impressive orgasm, releasing your own ");
                    if (this.player.hasVagina())
                        this.outputText("feminine juices");
                    if (this.player.gender == 3)
                        this.outputText(" and ");
                    if (this.player.hasCock())
                        this.outputText("thick cum");
                    this.outputText(".  You look out upon the lake to see much of it has taken on a remarkably more milky white color.  Even for a giant that was a prodigious amount of cum she unleashed!");
        ...
        repeatKaijuEncounter() {
            ...
            if (this.kaijuCock())
                this.addButton(3, "UrethraFuck", this.urethraFuckDatGiantCock);
        ...
        kaijuRepeatBoobHug() {
            this.clearOutput();
            this.spriteSelect(103);
            this.outputText("You decide it would be fun to play with her titanic titties for a while.");
        ...
        //[If Fuck] 
        fuckThisGiantYouDumbCunt() {
            this.clearOutput();
            this.spriteSelect(103);
            this.outputText("You decide it’d be fun to fuck the giantess, even if at her size you’re really more of a living dildo than a rutting stud.  She seems pretty happy with the thought if her spreading look of pleasure is any indication.");
            ...
            if (this.player.sens >= 50) {
                ...
                if (this.kaijuCock()) {
                    ...
                    //[If vagina and/or cock is present]
                    if (this.player.gender > 0) {
                        this.outputText("You grind your privates against her member, determined to get yourself off as well.  ");
                    }
                    //[If PC has boobs]
                    if (this.player.biggestTitSize() >= 1)
                        this.outputText("You press your [fullChest] against her cock flesh as well, giving her penis as much a boob job as such a behemoth prick can be given.");
                    if (this.player.lactationQ() >= 200)
                        this.outputText("  Milk spurts and flows from your [nipples], making your breast slick and shiny and helping you slide more easily along the throbbing meat-pole.");
                    this.outputText("\n\n\"<i>By Marae you're good at this!</i>\" the moaning giantess says as her cock begins to bounce in anticipation.  It nearly bucks you off your precarious perch!  \"<i>I'm...I'm going to cum!</i>\" she shouts as you redouble your efforts.  In another moment she makes good her statement, as a titanic load squirts out.");
                    //[If PC has vagina and/or cock]
        ...
        //[If Urethra Fuck]
        urethraFuckDatGiantCock() {
            this.clearOutput();
            this.spriteSelect(103);
            this.outputText("You look at her with an inquisitive stare.  You’re interested in that big green cock of hers, but how can you use such a giant tool?");
            ...
            if (this.player.hasCock())
                this.outputText(" and your " + this.multiCockDescriptLight());
            this.outputText(".  \"<i>Wow, you look absolutely gorgeous in my cock!</i>\" the giantess says with glee, perverse desire in her eyes as she shoves you in further up to your [chest], her trembling, squeezing cock seeming to give you an almost relaxing massage.  You can barely believe it, but this unnatural giantess has as much control over her urethral walls as the most whorish succubus has over her cunt!  Only your arms and head are free of her cock as her unusual member starts squeezing and rippling all along your body.  It seems her dick wants to give you a happy ending.");
            ...
            if (this.player.hasCock())
                this.outputText("  So much jizz fills your ass it can’t help but to press in on your prostate, making [eachCock] stiffen with a seriously growing urge.");
            if (this.player.hasVagina())
                this.outputText("  Your ass isn’t alone in the feeling of being flooded as your [vagina] and womb are packed with the hermaphrodite’s sperm.");
            this.outputText("  You manage to reach your own orgasmic climax right before the pressure finally pops you out of her cock like a cork from a wine bottle.  You black out somewhere above the lake.");
        ...
        talkToKaiju() {
            this.clearOutput();
            this.spriteSelect(103);
            this.flags[kFLAGS_1.kFLAGS.KAIJU_TALK_CYCLE]++;
            this.flags[kFLAGS_1.kFLAGS.KAIJU_BAD_END_COUNTER]--;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.KAIJU_TALK_CYCLE] == 1) {
                //Dialog one: 
            ...
            //Dialog two: 
            else if (this.flags[kFLAGS_1.kFLAGS.KAIJU_TALK_CYCLE] == 2) {
                ...
                //[If the Factory was shut down and Marae corrupted]
                    ...
                    this.outputText("  But the pouring of liquids has been stopped for some reason, but not before there was one final, huge burst of tainted fluids. It was so strong and changed me even further, making me grow this,</i>\" she says as she rises further out of the lake's waters, revealing a large green cock.");
                this.outputText("\n\nYou thank the giantess for her explanation as you row away.");
            }
            else if (this.flags[kFLAGS_1.kFLAGS.KAIJU_TALK_CYCLE] == 3) {
                //Dialog three: 
                ...
                this.flags[kFLAGS_1.kFLAGS.KAIJU_TALK_CYCLE] = 0;
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        peekAtSomePhatAssKaijuButt() {
            ...
            this.outputText(".  She pumps her clenched fist furiously as deep into herself as she can reach, going faster and faster as she quickly reaches orgasm, her pussy juices squirting out around her fist, soaking her forearm in the feminine fluid.  She slowly pulls her hand out with an audible 'Plop' and brings both hands back to her breasts, massaging her giant sized fuck pillows until two thick steady streams of milk begin flowing out her nipples and down her breasts.");
            //[Lust is increased]
        ...
        mockDatTurtleGirl() {
            ...
            if (this.player.balls > 0 && this.player.ballSize >= 6)
                this.outputText("Your [balls] rest on the hermaphrodite's hand, bouncing loudly with each thunderous stroke from the speed and force she is employing to get herself off.  ");
            //[end balls] [If player has cock]
            if (this.player.hasCock())
                this.outputText("You can feel your [armor] getting tighter as [eachCock] begins to stiffen under your clothing from all the constant pressure of the cock squeezing down on your member.  ");
            //[If player has vagina]
            if (this.player.hasVagina())
                this.outputText("You begin to feel a wetness between your legs as your cunt begins leaking as your arousal spikes from the intense rubbing the herm's penis is giving your whole body.  ");
            //[If genderless]
            if (this.player.gender == 0)
                this.outputText("Your cheeks blush in arousal from all this heavy rubbing.  ");
            if (this.player.cor < 33)
                this.outputText("You can't believe that you're being aroused by this.  Aren't you suppose to be a champion?");
            else if (this.player.cor < 66)
                this.outputText("Wow, this is arousing you.  You wonder if you really are a champion.");
            else
                this.outputText("You just want to get off now.");
        ...
        helpNewFutaKaijuGetOff() {
            ...
            //[If PC has cock]
            if (this.player.hasCock())
                this.outputText("  [EachCock] quickly hardens now as it is rubbed up against the giant's massive shaft.");
            if (this.player.hasVagina())
                this.outputText("  The warm heat that radiates off of the titanic member seems to seep into your nether region, making your [vagina] leak out moisture onto the massive prick.");
            this.outputText("  She squirms under your touch, falling on her back and wriggling almost uncontrollably.  You're quite surprised at the power you hold over such a behemoth.");
            ...
            if (this.player.cor < 50 && this.player.lib < 75)
                this.outputText("  You knead the cock head with your hands, massaging it quickly and roughly as you grind up against it, rock back and forth on the giant member.  Some of the pre dribbles down and you begin to use it as sticky massage oil, working it into the cock flesh.  The cooing and lustful moaning coming from the giantess increases in intensity with your every movement.");
            else
        ...
        yesTurnKaijuFuta() {
            this.clearOutput();
            this.spriteSelect(103);
            this.flags[kFLAGS_1.kFLAGS.KAIJU_BAD_END_COUNTER] += 2;
            var counter = 10;
            while (counter > 0) {
                counter--;
            ...
            this.outputText("You wouldn’t have offered if you didn’t want to see a giant green futa-cock dangling between her legs.  Your declaration seems to have deepened her blush to almost beet red, but the lustful look in her eyes betrays her desire.");
        ...
        badEndPartTwo() {
            ...
            if (this.kaijuCock()) {
                ...
                if (this.player.hasCock())
                    this.outputText("  You prostate is pressed down like a button, and there’s just no letting up!");
                if (this.player.hasVagina())
                    this.outputText("  Even if your cunt is empty, there is no free space left there, your cunt walls forced together like glue.");
            ...
            //[If PC has a cock] 
            if (this.player.hasCock())
                this.outputText("[EachCock] stiffens as the tree tendril pushes against your prostate, forcing a thick glob of pre up your shaft.  ");
            if (this.player.hasVagina())
            ...
            if (this.player.biggestTitSize() >= 1)
                this.outputText("  Another tendril snakes its way up your abdomen to nestle between your [chest], slicking your mounds with pre as it slides between your tits, giving itself a titty-fuck with your titties!");
