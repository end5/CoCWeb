define(["require", "exports", "../../../Monster", "../../../../console", "../../../../../includes/appearanceDefs", "../../../StatusAffects", "../../../internals/WeightedDrop"], function (require, exports, Monster_1, console_1, appearanceDefs_1, StatusAffects_1, WeightedDrop_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class FetishZealot extends Monster_1.Monster {
        constructor() {
            super();
            console_1.trace("FetishZealot Constructor!");
            this.a = "the ";
            ...
            this.tallness = 6 * 12;
            this.hipRating = appearanceDefs_1.HIP_RATING_BOYISH + 1;
            ...
            this.drop = new WeightedDrop_1.WeightedDrop().add(this.armors.C_CLOTH, 1)
        ...
        combatRoundUpdate() {
            ...
            //Talk abouts it mang!
            if (changed)
                this.outputText("The fetish zealot's clothing shifts and twists, until he is wearing " + this.armorName + ".\n\n", false);
        ...
        zealotSpecial1() {
            ...
            if (this.armorName == FetishZealot.MILITARY_CLOTHES) {
                ...
                if (this.player.cor > 50)
                    this.outputText("You eagerly cry out \"<i>Yes, sir!</i>\" and show yourself off to the best of your ability.  The whole act is extremely arousing.", false);
                //[player is not corrupt] 
                else
                    this.outputText("You have no idea why, but you promptly display yourself in the most provocative way possible.  After a moment you realize what you're doing and quickly stop, flushed with embarrassment and arousal.", false);
            }
            //Gimp gear;
            if (this.armorName == FetishZealot.LEATHER_CLOTHES) {
    ...
    FetishZealot.RELIGIOUS_CLOTHES = "religious clothes";
    FetishZealot.PIRATE_CLOTHES = "pirate clothes";
    FetishZealot.MILITARY_CLOTHES = "military clothes";
    FetishZealot.LEATHER_CLOTHES = "leather clothes";
    FetishZealot.STUDENTS_CLOTHES = "student's clothes";
    exports.FetishZealot = FetishZealot;
});
//# sourceMappingURL=FetishZealot.js.map