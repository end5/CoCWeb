define(["require", "exports", "../../../BaseContent", "../../../../../includes/appearanceDefs", "../../../GlobalFlags/kFLAGS", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, BaseContent_1, appearanceDefs_1, kFLAGS_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 04.01.14.
     */
    class HarpyScene extends BaseContent_1.BaseContent {
        ...
        harpyVictoryuuuuu() {
            ...
            if (this.player.hasVagina()) {
                if (this.player.isNaga())
                    this.outputText("  If you weren't a naga, you could scissor her.");
                else
                    scissor = this.harpyScissorSurprise;
            }
            if (this.player.cockThatFits(this.monster.vaginalCapacity()) >= 0)
                pussy = this.victoryHarpyGetsHerPussyRaped;
            if (this.player.cockThatFits(this.monster.analCapacity()) >= 0)
                anal = this.winAndRapeHarpyAnally;
            //Rape options
            if (this.player.lust >= 33) {
                this.outputText("  What do you do to her?", false);
                this.choices("Anal", anal, "Oral", this.WinOnHarpyAndOralRape, "Pussy", pussy, "Scissor", scissor, "Lay Eggs", eggs, "Clit Fuck", clitFuck, "", undefined, "", undefined, "", undefined, "Nothing", this.cleanupAfterCombat);
            }
            //Not horny?  Iz over
            else
                this.cleanupAfterCombat();
        ...
        harpyLossLust() {
            ...
            //if long hair
            if (this.player.hairLength > 12)
                this.outputText(" and moves it out of your face", false);
            ...
            if (this.player.hasVagina() && x < 0) {
                ...
                if (this.player.skinType == appearanceDefs_1.SKIN_TYPE_PLAIN)
                    this.outputText(" and quickly alleviating the pain by brushing their wings across your hide", false);
            ...
            //(Reminds me of what my own Succubus does in my novel)
                ...
                if (this.player.balls > 0)
                    this.outputText("You can feel her little tongue rolling across your balls and the base of your ", false);
                else
                    this.outputText("You can feel her little tongue rolling across the base of your ", false);
        ...
        harpyDamageLoss() {
            ...
            if (this.player.hasCock() && x >= 0) {
                ...
                if (!this.player.hasVagina()) {
                    ...
                    if (this.player.balls > 0)
                        this.outputText(", craning their necks to slurp and massage your " + this.ballsDescriptLight() + " eagerly, trying to coax up your cum production as much as they can", false);
                    ...
                    if (this.player.biggestTitSize() >= 1)
                        this.outputText("her petite bosom grinding across your " + this.player.allBreastsDescript() + ", her nipples tickling at your " + this.nippleDescript(0) + ", ", false);
                ...
                //[(Herm)
                    ...
                    //(If balls)
                    if (this.player.balls > 0)
                        this.outputText("their hands moving up to grope and fondle your " + this.ballsDescriptLight() + ", massaging them to boost your cum production as much as they can, ", false);
                    ...
                    if (this.player.biggestTitSize() >= 2)
                        this.outputText(", causing your " + this.player.allBreastsDescript() + " to bounce and sway violently", false);
                    this.outputText(".  She slowly leans down, her eyes locked on yours, her lips glinting a malicious gold", false);
                    //(if breasts)
                    if (this.player.biggestTitSize() >= 2)
                        this.outputText(" her toned chest and pert breasts squishing your " + this.breastDescript(0) + " beneath them", false);
                    this.outputText(".\n\n", false);
                }
                //Apply harpy status.
                kGAMECLASS_1.kGAMECLASS.sophieScene.luststickApplication(8);
            }
            //[(Female) 
            else {
                ...
                if (this.player.biggestTitSize() >= 3)
                    this.outputText(" and causing your " + this.player.allBreastsDescript() + " to jiggle, slapping into one another", false);
                this.outputText(". She leans slowly over you, her gilded lips glistening with saliva as they approached yours", false);
                //{(If breasts)
                if (this.player.biggestTitSize() >= 2)
                    this.outputText(", her petite chest squashing your " + this.breastDescript(0) + " against hers", false);
                this.outputText(".\n\n", false);
            ...
            if (x >= 0 && this.player.cockTotal() == 1) {
                ...
                if (this.player.balls > 0)
                    this.outputText(", her huge feathery bottom coming to rest on your " + this.ballsDescriptLight(), false);
                ...
                if (this.player.balls >= 0) {
                    ...
                    if (this.player.gender == 3)
                        this.outputText(" before swinging back to spanking your " + this.vaginaDescript(0) + " wetly.", false);
                    else
                        this.outputText(".", false);
                }
                else if (this.player.biggestTitSize() >= 2)
                    this.outputText(" while your " + this.player.allBreastsDescript() + " are shaking and jiggling around helplessly.", false);
                else
                    this.outputText(".", false);
            ...
            //[(Female)
                ...
                //{(If breasts)
                if (this.player.biggestTitSize() >= 2)
                    this.outputText("Their hungry feminine mouths creep beneath the body of the harpy atop you and grab hard onto your " + this.breastDescript(0) + ".  They pull them towards their mouths, those gold lips wrapping themselves around your " + this.nippleDescript(0) + "s to suckle gently.  ", false);
                //{(If lactating)
                if (this.player.biggestLactation() >= 1)
                    this.outputText("You hear some subtle slurps around the big feathery earmuffs crushing your head, and feel your " + this.breastDescript(0) + " begin to drain, sending motherly shivers through your whole being.  The monster-girls drink and drink, those stubby tongues circling each nipple while the drugged golden lips make you tingle sensually.  ", false);
                ...
                //{(If breasts)
                if (this.player.biggestTitSize() >= 2)
                    this.outputText("her belly squishing your " + this.player.allBreastsDescript() + " beneath her weight, ", false);
            ...
            if (x >= 0 && this.player.hasCock()) {
                ...
                //{(If herm)
                if (this.player.gender == 3)
                    this.outputText(", and the number of times your " + this.vaginaDescript(0) + " has dripped your sweet feminine cum over your thighs", false);
            ...
            //[(Female)
                ...
                //{(If lactating)
                if (this.player.biggestLactation() >= 1)
                    this.outputText("  Their bellies seem a little pudgier than when they'd started, a result of the endless drinking from your " + this.nippleDescript(0) + "s.  ", false);
        ...
        victoryHarpyGetsHerPussyRaped() {
            ...
            if (this.player.totalCocks() > 1)
                this.outputText("and viciously-clenching ass ", false);
            ...
            //(If balls)
            if (this.player.balls > 0)
                this.outputText("You eventually bottom out, your " + this.ballsDescriptLight() + " coming to rest between her powerful, gelatinous thighs, her soft feathers tickling at your " + this.sackDescript() + " maddeningly.\n\n", false);
            //(If balls-less) 
            else
                this.outputText("Leaning low over her back, you adjust to drive yourself ever deeper, forcing the whole length of your " + this.cockDescript(x) + " into her, the soft down on her gelatinous thighs prickling at your thighs maddeningly.\n\n", false);
            if (this.player.gender == 1) {
                ...
                //[(Male w/ breasts)
                    ...
                    if (this.player.totalCocks() > 1)
                        this.outputText("s massage", false);
                    else
                        this.outputText(" massages", false);
            ...
            //{(If balls)
            if (this.player.balls > 0)
                this.outputText("Your " + this.sackDescript() + " slaps wetly into her immense, wobbling thighs.  ", false);
        ...
        winAndRapeHarpyAnally() {
            ...
            if (this.player.biggestTitSize() >= 2)
                this.outputText(" Her petite bust squishes against your " + this.player.allBreastsDescript() + ". Her downy tits tickle, and grind against your chest maddeningly, tickling and scratching them gently as the lust-fueled bird-girl seems to ache for you.", false);
            this.outputText("\n\n", false);
            ...
            //(if balls)
            if (this.player.balls > 0)
                this.outputText("  Your " + this.ballsDescriptLight() + " come to rest against her thick, wiggly rear.", false);
            this.outputText("\n\n", false);
            ...
            //[(Herms/Shemales) 
                ...
                if (this.player.biggestTitSize() >= 2)
                    this.outputText(", the motions causing your " + this.player.allBreastsDescript() + " to bounce and sway wildly, slapping into one another lewdly, adding to your growing lust", false);
                ...
                if (this.player.gender == 3) {
                    ...
                    //{(If balls)
                    if (this.player.balls > 0)
                        this.outputText("  She even makes your " + this.ballsDescript() + " slap against your " + this.vaginaDescript(0) + ", a hot, moist SPLAT accompanying every tiny motion the harpy makes.", false);
                }
                this.outputText("\n\n", false);
            }
        ...
        WinOnHarpyAndOralRape() {
            ...
            var x = -1;
            if (this.player.hasCock())
                x = this.player.cockThatFits(this.monster.analCapacity());
            var y = x + 1;
            if (y == x && this.player.totalCocks() > 1) {
                //If second cock is out of bounds, choose one in bounds
                if (y >= this.player.cocks.length)
            ...
            //(if boobs)
            if (this.player.biggestTitSize() >= 2)
                this.outputText(", but soon she presses her toned, petite chest against your " + this.player.allBreastsDescript() + ", that stubby tongue tangling around yours lustily.", false);
            else
                this.outputText(", but soon she is pressing against you, rubbing her toned body against yours, driving her tongue back against yours in a haze of lust, turning her head quickly and sharply, birdlike.", false);
            this.outputText("\n\n", false);
            //[(Male, shemale, herm, one cock)
            if (this.player.cockTotal() == 1) {
                ...
                //(if herm)
                if (this.player.gender == 3)
                    this.outputText("  Her expert fingers tease up the sides of your thighs, coming to softly brush across your moist nether lips, her fingers spreading your " + this.vaginaDescript(0) + " wide before plunging into the warmth within, adding another sweet sensation of pleasure to the amazing orchestra of sensations her lips were giving to you.", false);
                //(If balls) 
                if (this.player.balls > 0)
                    this.outputText("  Her hands creep down to softly squeeze and massage your " + this.ballsDescriptLight() + ", the harpy's eager head bobbing back and forth along the sweet tasting shaft of your " + this.cockDescript(0) + ", sending waves of powerful, overwhelming pleasure resonating through your body.", false);
                this.outputText("\n\n", false);
            }
            //[(Male, Shemale, Herm, multicock)
                ...
                if (this.player.biggestTitSize() >= 2) {
                    ...
                    if (this.player.biggestLactation() >= 1)
                        this.outputText("  Milk dribbles out gently onto the areola, trickling sensually between your cleavage.", false);
                }
                else
                    this.outputText(".", false);
            ...
            if (this.player.gender == 2) {
                ...
                //(If breasts)
                if (this.player.biggestTitSize() >= 2)
                    this.outputText("You grasp onto your " + this.player.allBreastsDescript() + " violently, kneading and tweaking your " + this.nippleDescript(0) + " in a horny haze as the harpy's fingers tease around your pussy.  ", false);
            ...
            if (this.player.cockTotal() == 1) {
                ...
                //(if herm)
                if (this.player.gender == 3)
                    this.outputText(", her other hand doing the exact same to your own " + this.vaginaDescript(0) + ", digging those perfect fingers deep into the wet, hyper-sensitive flesh, spreading those lips wide", false);
                ...
                if (this.player.balls > 0 && this.player.cocks[0].cockLength <= 16)
                    this.outputText("She even deep throats you, taking your length into her expertly-controlled mouth, that tongue creeping out to tickle at your " + this.ballsDescriptLight() + ".  ", false);
            ...
            if (this.player.cockTotal() > 1) {
                ...
                //(if balls)
                if (this.player.balls > 0)
                    this.outputText(", dribbling all over your " + this.sackDescript(), false);
                ...
                //(If herm)
                if (this.player.gender == 3)
                    this.outputText("  Her fingers never stop their sweet teasing of your " + this.vaginaDescript(0) + ", using all four fingers on her hand to plumb your velvet depths.", false);
        ...
        harpyScissorSurprise() {
            ...
            if (this.monster.HP < 1)
                this.outputText("her arms tremble from the effort of trying to keep her body from collapsing to the floor.");
            else
                this.outputText("she leans back from her kneeling position, spreading her legs and digging her fingers into her soaking cunt. Her other hand darts up to her ample bosom, giving it a hard squeeze before starting to tease her erect nipple, pinching and flicking as she continues to fingerfuck herself ever more forcefully.");
            ...
            if (this.monster.HP < 1)
                this.outputText("vulnerable");
            else
                this.outputText("lust-mad");
            ...
            if (this.monster.HP < 1)
                this.outputText("worry");
            else
                this.outputText("desire");
        ...
        clitFuckAHarpy() {
            ...
            if (this.monster.lust > 99)
                this.outputText("moan and masturbate, dipping her fingers into her honey-pot with wild abandon.");
            else
                this.outputText("moan and struggle to rise, jiggling in the cutest way each time she slumps down, defeated.");
            ...
            if (this.player.wetness() < 3)
                this.outputText("  Runnels of your lubricant are dripping down your [legs] in streams,");
            else if (this.player.wetness() < 4)
                this.outputText("  Streams of lubricant are soaking down your [legs] in waves,");
            else
                this.outputText("  Squirts of lubricant are gushing down your [legs] to puddle on the floor,");
            ...
            if (this.player.wetness() < 3)
                this.outputText("  A fresh gush of fluid washes out of your pussy at the peak of your pleasure even though you're far from a squirter");
            else if (this.player.wetness() < 4)
                this.outputText("  A fresh spout of girlspunk washes out of your pussy at the peak of your pleasure");
            else
                this.outputText("  A torrential splash of girlspunk shoots out of your pussy in a river at the peak of your pleasure");
    ...
    exports.HarpyScene = HarpyScene;
});
//# sourceMappingURL=HarpyScene.js.map