define(["require", "exports", "../../../BaseContent", "../../../GlobalFlags/kFLAGS", "./Minerva", "../../../../../includes/appearanceDefs", "../../../StatusAffects", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, BaseContent_1, kFLAGS_1, Minerva_1, appearanceDefs_1, StatusAffects_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class MinervaScene extends BaseContent_1.BaseContent {
        ...
        minervaRomanced() {
            return (this.flags[kFLAGS_1.kFLAGS.MINERVA_LOVE] == 1);
        }
        ...
        minervaAppearance() {
            ...
            if (this.player.lust >= 33)
                this.addButton(2, "Sex", this.minervaSexMenu);
        ...
        encounterMinerva() {
            if (this.flags[kFLAGS_1.kFLAGS.MET_MINERVA] > 0)
                this.flags[kFLAGS_1.kFLAGS.MET_MINERVA]++; //Increment counter by 1 if previously met Minerva.
            if (this.flags[kFLAGS_1.kFLAGS.MET_MINERVA] == 0)
                this.firstMinervaEncounter();
            else if (this.flags[kFLAGS_1.kFLAGS.MET_MINERVA] == 3)
                this.minervaThirdPlusEncounter();
            else if (this.flags[kFLAGS_1.kFLAGS.MINERVA_BACKSTORY_LEARNED] > 0 && this.player.gender > 0 && this.flags[kFLAGS_1.kFLAGS.MINERVA_LOVE] == 0 && MinervaScene.rand(2) == 0)
                this.minervaAfterFiveTalksRomancing();
            else {
                if (MinervaScene.rand(2) == 0)
                    this.minervaThirdPlusEncounter();
                else
                    this.repeatEncounterMinerva();
            }
        }
        //Basic intros
        //1-1 First Encounter.
        firstMinervaEncounter() {
            this.clearOutput();
            this.outputText("Returning to the mountains, you begin to climb; the usual search for loot and, perhaps, some harpies driving your upward efforts.  Perhaps you'll run into");
            //If Sophie Bimbo=0:
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00282] == 0 && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00283] == 0 && !kGAMECLASS_1.kGAMECLASS.sophieFollowerScene.sophieFollower())
                ...
                this.outputText(" something interesting");
            ...
            if (this.player.minotaurAddicted())
                this.outputText(".  With any luck, you might even find a hunky minotaur to scratch that burning itch in your mind");
            this.outputText(".  Trudging on, you make your way up and up the mountain, passing the occasional harpy nest as you climb and traverse along the mountain paths.  Just when it looks like you're going to hit the clouds, you catch sight of a trail that you had never really noticed before.");
            //Choice
        ...
        takeMinervasPath() {
            this.clearOutput();
            this.spriteSelect(95);
            this.outputText("Knowing that a new path could lead to great things, you can't help but wonder where this one could lead.");
            ...
            if (this.player.tallness <= 96)
                this.outputText(" one hand");
            else
                this.outputText(" both hands");
            this.outputText(", bodily swinging you out over the abyss, with only her grip keeping you from plunging back down the mountainside.");
            //Low corruption: 
            if (this.player.cor < 50)
                this.outputText("  \"<i>All right, you!  Who are you and what are you doing here?!  I don't get any visitors besides those horny harpies, so what are you after?  Hm?");
            //High corruption:
            else
                this.outputText("  \"<i>All right, you corrupted beast!  Who are you and what are you doing here?  Your presence is not welcome in this sanctuary... answer quickly or I'll drop you to your death!");
            //Demon Score=3>:
            if (this.player.demonScore() >= 3)
                this.outputText("  Filthy demon!  Come to finish your work, have you?!  You won't take me without a fight!  Maybe if you beg for your life I'll give you a chance. Speak!  Convince me to not simply kill you here and now!");
            this.outputText("</i>\" the creature demands, clearly threatening to drop you if you don't answer to her liking.");
            //Goo:
            if (this.player.isGoo()) {
                ...
                if (this.player.cor >= 75)
                    this.outputText("... \"<i>yet</i>\", you think to yourself.");
            ...
            if (this.player.cor > 66)
                this.outputText("  She is wise not to fully trust you.");
            this.outputText("\n\nWith");
            if (this.player.isGoo())
                this.outputText(" your own");
            else
                this.outputText(" a");
            this.outputText(" relieved sigh, you take in the sight of the strange shark... harpy... harpy-shark... sharpy?  What an odd combination!  Looking the woman up and down, you take in her whole appearance.");
            ...
            this.flags[kFLAGS_1.kFLAGS.MET_MINERVA] = 1;
            //[Follow] [Leave]
            this.menu();
        ...
        repeatEncounterMinerva() {
            ...
            if (!this.minervaRomanced())
                ...
                this.outputText("  \"<i>Mmm... my lover has come to see me!  Oh, how I have missed you, my sweet!  Won't you join me for a bath?  Or... is there anything else I can do for you?</i>\"");
            //[Talk] [Sex] [Eat] [Fight] [Leave]
            this.menu();
        ...
        minervaThirdPlusEncounter() {
            ...
            //No romance:
            if (!this.minervaRomanced())
                this.outputText("  \"<i>Welcome back, [name]!  It's good to see you again.  Have you come to give me some company, or would you like to partake in some of the fruit?  Or are you maybe here to sate your thirst?</i>\"");
            else
                this.outputText("  \"<i>Darling!  Coming to visit me all the way out here!  How sweet of you!</i>\"");
            this.outputText("  Minerva says as she strides toward you, her generous hips swaying back and forth, as if to entice you into her arms.");
            this.menu();
            //[Talk] [Sex] [Eat] [Fight] [Leave]
            this.addButton(0, "Appearance", this.minervaAppearance);
            this.addButton(1, "Talk", this.minervaTalkSelect);
        ...
        minervaAfterFiveTalksRomancing() {
            this.clearOutput();
            this.spriteSelect(95);
            this.flags[kFLAGS_1.kFLAGS.MET_MINERVA]++;
        ...
        yeahSureMinervaILikeYouAndShit() {
            ...
            this.flags[kFLAGS_1.kFLAGS.MINERVA_LOVE] = 1;
            this.menu();
            ...
            if (this.player.gender == 1) {
                if (this.player.cockThatFits(this.minervaVCapacity()) >= 0)
                    ...
                    this.addButton(0, "Next", this.letMinervaSuckYouOff);
            }
            else
                this.addButton(0, "Next", this.minervaLapSex);
        }
        //[Reject]
        rejectMinervasLove() {
            this.clearOutput();
            this.spriteSelect(95);
            this.outputText("You stare at Minerva awkwardly as she waits for your response, her electric blue eyes looking at you with hope.  ");
            if (this.player.cor < 45)
                this.outputText("The look in the siren's eyes only makes this harder for you as you look into them; you can't help but feel bad that you really don't feel anything special for her.");
            else
                this.outputText("You can tell she really wants this - the siren is almost desperate for your attention.  Unfortunately for the love starved herm, she won't find the love she craves with you.");
            this.outputText("  You look away from her and pull back a bit before speaking.  You confess to her that, while she is a nice person, you do not feel that sort of bond with her, and you apologize if she was misled by your actions, but that you would like to be friends with her still.");
        ...
        fightMinerva() {
            this.startCombat(new Minerva_1.Minerva(), true);
            this.spriteSelect(95);
            this.playerMenu();
        }
        ...
        minervaTalkSelect(bath = true) {
            var choices = [this.talkingToMinervaAboutBackstory];
            if (this.flags[kFLAGS_1.kFLAGS.MINERVA_BACKSTORY_LEARNED] == 0) {
                //Force first time to talk about her early backstory!
                if (this.flags[kFLAGS_1.kFLAGS.MINERVA_BACKSTORY] == 0) {
            ...
            if (this.minervaRomanced() && this.flags[kFLAGS_1.kFLAGS.MINERVA_BACKSTORY_LEARNED] == 1)
            ...
            if (this.minervaRomanced())
                choices[choices.length] = this.talkToMinervaAboutHerCorruption;
            //3-5 Motherhood
            ...
            if (bath && this.minervaRomanced())
                choices[choices.length] = this.bathTimeTalkWithMinerva;
        ...
        talkingToMinervaAboutBackstory() {
            ...
            //PART 1
            if (this.flags[kFLAGS_1.kFLAGS.MINERVA_BACKSTORY] == 0) {
                this.flags[kFLAGS_1.kFLAGS.MINERVA_BACKSTORY] = 1;
            ...
            //PART 2
            else if (this.flags[kFLAGS_1.kFLAGS.MINERVA_BACKSTORY] == 1) {
                this.flags[kFLAGS_1.kFLAGS.MINERVA_BACKSTORY] = 2;
            ...
            //PART 3
                ...
                this.flags[kFLAGS_1.kFLAGS.MINERVA_BACKSTORY] = 0;
                ...
                //No Romance: 
                if (!this.minervaRomanced())
                    this.outputText("  \"<i>You're a good friend to have, and you know that, [name].</i>\"");
                //Romance:
                else
                    this.outputText("  \"<i>You're a wonderful lover, you know.  I couldn't be happier that you found me.</i>\"");
                // PC returns to camp.
                this.flags[kFLAGS_1.kFLAGS.MINERVA_BACKSTORY_LEARNED] = 1;
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //3-2 Talk Scene 2 - talks about the spring  
        //-repeatable
        talkAboutTheSpringWithMinerva() {
            this.clearOutput();
            this.spriteSelect(95);
        ...
        //3-3 Talking Scene 3 - talks about her shark girl daughter
        talkWithMinervaAboutSharkGirlDaughter() {
            this.clearOutput();
            this.spriteSelect(95);
            //- requires that backstory has been told
            //- if already romanced Minerva shamefully confesses she may have fathered a granddaughter with her first daughter -repeatable
        ...
        //3-4 Talk Scene 4 - talks about her corruption
        //- romance yes only or if you trick her into thinking you love her. - Repeatable until Minerva is purified or corrupted
        talkToMinervaAboutHerCorruption() {
            this.clearOutput();
            this.spriteSelect(95);
            this.outputText("Telling Mineva that you just want to talk brings a smile to her face, the siren eager to speak with you.  Guiding you over to a soft spot of moss by the spring, she sits next to you and looks into the pond, her smile slowly fading as she looks into the clear waters.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.MINERVA_BACKSTORY_LEARNED] == 1)
                this.outputText("  You remember my firstborn, the shark girl I had?  Well... not long after she reached maturity, she... well, she got a bit amorous...  She seduced me and I... I mated with her.  I mated with her over and over that night.  I enjoyed it... it was like I couldn't get enough...  I probably got her pregnant...  So shameful...  I impregnated my own daughter and made her bear my grandchild,");
            this.outputText("</i>\" she declares sourly as she stares into the pure waters of the spring.");
        ...
        minervaMotherhood() {
            ...
            if (this.player.gender == 1)
                this.outputText(" and those goblins");
            //PC vagina: 
            else if (this.player.gender == 2)
                this.outputText(" and that bee-girl");
            //PC herm:
            if (this.player.gender == 3)
                this.outputText(", goblins and that bee-girl");
            this.outputText(", if the stories were real, I'm sure you gave them plenty of children.  I wish to one day have kids... to have a great, loving family to call my own.</i>\"");
            this.outputText("\n\nShaking your head, you grin and shuffle over to Minerva.  Sitting down with her, you");
            //Romance: 
            if (this.minervaRomanced())
                this.outputText(" hug her tightly and kiss her cheek, telling her that she will have children one day, and perhaps you will have to see about helping her with that 'problem.'");
            //No romance:
            else
                this.outputText(" place a hand on her shoulder and give her a comforting smile before telling her that she will have that one day - you're sure of it.");
            this.outputText(" Hearing your words brings a smile to her black glossy lips.  \"<i>Thank you so much; that means a lot to me, really,</i>\" she coos, her hands gingerly stroking yours before pulling away.  \"<i>But... I guess we have been here for a while.  I'm sure you have a great deal of work to do as such a brave champion.</i>\"");
        ...
        minervaSexMenu(display = true) {
            if (display) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_MINERVA_SEXED] == 0) {
                    ...
                    //PC female, add: "
                    if (this.player.hasVagina())
                        this.outputText("  Would you mind how we do it?  You're the one asking, so... would you want me to fuck your ass?  Or... do you want me to try to fit between those sexy hips of yours?");
                    this.outputText("</i>\"");
                }
                //Dick Too Big - PC exceed capacity
                else if (MinervaScene.rand(2) == 0 && this.player.hasCock() && this.player.cockThatFits(this.minervaACapacity()) < 0)
                    this.outputText("Looking at the monstrous mass of your mammoth member, Minerva blushes hard and stares at it with wide eyes.  \"<i>Oh... oh my, that... that's </i>big</i>... I'm sorry, I don't think that's going to fit inside me, how about we try something else?  I'm sure we can come up with something!</i>\"  Minerva says with confidence.");
                //{Repeated/No romance: 
                    ...
                    if (this.player.hasVagina())
                        this.outputText("  Since you don't seem to mind... would you like me to fuck your ass or to squeeze into your cute cunny?");
                    this.outputText("</i>\"");
                }
                //Romanced: 
                else {
                    ...
                    //PC cock, add:
                    if (this.player.hasCock())
                        this.outputText("  Since we're together, I'll even let you have my pussy, I bet you like the sound of that!");
                    //PC female, add:
                    if (this.player.hasVagina())
                        this.outputText("  I'd be happy to pound that cute butt of yours and stuff your hot pussy - which would you rather have, my dear?");
                    this.outputText("</i>\"");
                }
            }
            this.menu();
        ...
        fuckMinervasAsshole() {
            ...
            this.outputText("\n\nYou draw yourself back, dragging your " + this.cockDescript(x) + " inch by inch through her grinding, squeezing walls, then thrust yourself firmly back inside her.  You repeat the process again, and then again, picking up speed as you pull and push.  The siren's lyrical moans slowly start to fill the air, her body rocking with your thrusts, pressing and grinding her pierced nipples against the ground as you pound her slick rear.  The longest of her cock tentacles manage to reach back and grabs hold of your " + this.cockDescript(x) + ", feverishly stroking you as you thrust into her.  The naughty little things sting you hard, oozing their aphrodisiac venom into your " + this.cockDescript(x) + " instinctively.  You cry out, shivering as the potent venom immediately streams through your body, setting your blood aboil with lust, and causing you to piston into her ass with ever-increasing speeds.  More and more toxin floods you, combining with the incredible sensations of her anal walls gripping and squeezing you to turn you into a mindlessly rutting beast.");
            ...
            if (!this.minervaRomanced()) {
                //First time ending:
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_BUTTFUCKED_MINERVA] == 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_BUTTFUCKED_MINERVA]++;
            this.player.orgasm();
            this.dynStats("sen", -1);
        ...
        minervaCowgirlSex() {
            this.clearOutput();
            this.spriteSelect(95);
            var x = this.player.cockThatFits(this.minervaVCapacity());
            if (x < 0)
                x = this.player.smallestCockIndex();
            this.flags[kFLAGS_1.kFLAGS.TIMES_MINERVA_SEXED]++;
            this.outputText("You look the attractive siren up and down and");
            if (this.player.tallness <= 60)
                this.outputText(", with some trepidation, given the difference in size,");
            this.outputText(" ask if Minerva would like to give her female parts some pleasure, promising to allow her control of the pace.");
            //First time:
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_MINERVA_COWGIRLED] == 0) {
                this.outputText("  Minerva looks unsure, the siren biting her lip and looking a little away from you, \"<i>I don't know.  That's... special...  After the things I have been through, I don't want to just do it with anyone.  You... </i>have<i> been really nice to me though... I guess I can trust you.</i>\"");
            }
            //Repeated:
            else
                this.outputText("  Minerva runs a hand through her hair and smiles, \"<i>Well... the last time was quite nice, I think it could be fun.  Sure, let's do it.</i>\"");
            this.outputText("\n\nWith a smile, you gently remove your clothes and put them aside, giving Minerva a chance to see your naked body.  Your " + this.cockDescript(x) + " already starting to stiffen, you lie back down on the ground, patiently waiting for the siren to make the first move.  You don't have to do so for long, as soon, Minerva's tight tube-top and short shorts are pulled off, her firm, pierced DD's bouncing free of their fabric prison.  Clearly excited by the thrill of actually having regular sex, you can see her male endowment quickly growing hard between her legs, the forearm-length appendage ready to go despite the fact it won't be used for the main event.  Looking down at you, Minerva approaches, swaying her hips to and fro.  She kneels down, crawling over you like some predator, one of her hands briefly stroking your " + this.cockDescript(x) + " before sliding up to feel your [chest].  \"<i>I promise not to get too excited,</i>\" she says before grabbing hold of your maleness and stroking it again.  Bringing her own male organ up against yours, her tentacles encircle your " + this.cockDescript(x) + ", stinging it with her potent venom to really get you fired up as she teases you.  \"<i>This stuff is always floating around in me - that's why I get so damn hard so fast...  I hope you like my special venom.</i>\"");
            this.outputText("\n\nYou groan softly, feeling the venom already coursing through you.  Your " + this.cockDescript(x) + " surges erect, the venom-induced lust making you swell larger than usual, ready for her to do with as she pleases, your limbs numb and useless from the lust-inducing toxins coursing through your body.  You are completely helpless and at her mercy...  And part of you seems to like that.");
            this.outputText("\n\nMinerva seems to enjoy seeing you helpless like this, as her dick seems to just get harder and harder while her tentacles caress your member, though they no longer sting; instead, they just tease you with their slick and gentle touch.  \"<i>You like that, don't you?  You're so hard I can feel your need growing more and more.  You want my tight pussy so badly,</i>\" she says with a lecherous grin before rising her body up and pressing against your " + this.cockDescript(x) + " with her surprisingly cool cunt.  Already her lips are soaked, her slick juices running down your dick as she teases you even further.");
            this.outputText("\n\nFinally, she ends your torment and brings your " + this.player.cockHead(x) + " to her refreshingly wet entrance before pushing down, letting you penetrate her with agonizing slowness, her longer tentacles still stroking and caressing your length as she pulls you into the vicelike grip of her snatch.  Inside, you can feel smaller tendrils starting to caress and squeeze you, clearly another trait she was gifted with from the shark girls.");
            ...
            if (this.player.cumQ() >= 500) {
                ...
                if (this.player.balls > 0)
                    this.outputText(" your balls and");
                this.outputText(" the base of your " + this.cockDescript(x) + ", stinging you again and again like an overzealous jellyfish, pumping more of her aphrodisiac venom into your genitals in mind-numbing quantities.");
                if (this.player.hasVagina())
                    this.outputText("  A few even slither down into your [vagina] to sting you there as well, making sure you are, at least temporarily, turned into a sex-hungry beast.");
            }
            ...
            if (this.player.cumQ() < 500)
                this.outputText(", Minerva's belly visibly bloated by the time you are finished");
            this.outputText(".");
            if (this.player.cumQ() < 500) {
            ...
            if (this.player.cumQ() >= 500 && this.player.cumQ() < 4000) {
                ...
                if (this.minervaRomanced())
                    this.outputText(" with your child");
                this.outputText(".");
            }
            //Very High: 
            if (this.player.cumQ() >= 4000) {
                ...
                if (!this.minervaRomanced())
                    this.outputText("  \"<i>Oohhh...I'm so... so big... It's almost like you've gotten me pregnant.</i>\"");
                else
                    this.outputText("  \"<i>Oohhh... I'm so... so big... cumming so much, I didn't know you were so desperate to get me pregnant.</i>\"");
            }
            //Low-to-moderate: 
            if (this.player.cumQ() >= 500)
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_MINERVA_COWGIRLED]++;
            this.player.orgasm();
            this.dynStats("sen", -1);
            if (this.getGame().inCombat)
                this.cleanupAfterCombat();
        ...
        minervaLapSex() {
            ...
            //PC herm: 
            if (this.player.gender == 3)
                this.outputText("  One of her hands trail down to your hard herm " + this.cockDescript(x) + ", stroking you softly.");
            ...
            if (this.player.hasCock()) {
                ...
                //High cum volume:
                    ...
                    this.outputText(" splattering thick splooge all over you and Minerva, caking your torsos in fertile jizz");
                //Very high cum:
                else
                    this.outputText(" exploding out onto your unsuspecting bodies, thick ropes of starkly white sperm gushing over your bodies, quickly dousing both of you in buckets of cum and pooling on the ground");
            }
            this.outputText(".");
            ...
            if (!this.minervaRomanced()) {
                //Default, first time:
                if (this.flags[kFLAGS_1.kFLAGS.TIMES_MINERVA_LAPSEXED] == 0) {
                    this.outputText("\n\nMinerva actually seems a little sad that you're leaving.  \"<i>I guess you are a busy person.  But I'm glad we did this, it was a lot of fun.  And... you know...  I wouldn't mind if we did this again, soon,</i>\" She suggests with a small, hopeful smile on her face.  You promise her that you'll try to come back again soon.");
                }
                //Default, repeated:
                else {
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_MINERVA_LAPSEXED]++;
            this.player.orgasm();
            this.dynStats("sen", -1);
            if (this.getGame().inCombat)
                this.cleanupAfterCombat();
        ...
        goDownOnAHermAndLoveItYouDirtySlutYou() {
            this.clearOutput();
            this.spriteSelect(95);
            this.flags[kFLAGS_1.kFLAGS.TIMES_MINERVA_SEXED]++;
            ...
            if (this.player.tallness < 96)
                this.outputText("your fingers not even able to fit around the herm's hefty girth");
            else
                this.outputText("your fingers barely wrapping around the meaty member, the fat thing throbbing gently");
            this.outputText(" as you stroke it slowly.  Your touches are clearly adding to your partner's pleasure, her thick masculinity pulsating under your grip, her tentacles reacting to your presence, the dexterous things curling around your hands and fingers, touching you gently, but not stinging you.");
            ...
            //Dragon/Demon tongue
            if (this.player.tongueType == appearanceDefs_1.TONUGE_DEMONIC || this.player.tongueType == appearanceDefs_1.TONUGE_DRACONIC)
                this.outputText("Your deliciously long tongue slithers deeper and deeper, reaching sensitive walls and nerves that only the deepest penetrations would reach.  The deep licking makes Minerva shudder and let out a long drawn out moan, \"<i>O-oh!  Your tongue is so... licking me so deep...</i>\"");
            this.outputText("  The intimate vaginal kiss is working wonders for the siren.  Her sweet, slick juices leak over your tongue, giving you plenty of the peachy flavor that you crave.  As you tongue your lover's pussy and tease her clit, your hands work her thick, pulsating cock, pre-cum slowly coating your hands and making it easy for you to squeeze tighter and stroke her faster.");
        ...
        lickMinervasBalls() {
            this.clearOutput();
            this.spriteSelect(95);
            this.outputText("Not even close to being done, you tease her some more.  The tip of your tongue dances along her outer lips before moving down to her smooth, hairless sack to give her male parts some extra attention.  Kissing her swollen, taut scrotum, you slowly lick and tease it as your hands work her rock hard shaft.  Her fat, sperm-filled balls react to your touch, swelling and pulling up as if getting ready to blow.  You can swear you can hear the poor, hefty testicles audibly churning with their thick creamy seed, eager to stuff some poor woman's pussy and impregnate them.  Closing your eyes, you latch on, sucking the tight sack and teasing the sensitive orbs inside.  \"<i>H-hey, careful down there!  Those things are fragile!</i>\"  she squawks in delight as you take your time giving the juicy pair some much-needed attention.");
            this.noBallsMinervaAndContinuation(false);
        }
        // No Balls and continuation
        noBallsMinervaAndContinuation(clear = true) {
            if (clear)
                this.clearOutput();
            else
                this.outputText("\n\n");
            this.spriteSelect(95);
            this.outputText("Your careful ministrations soon have the poor siren shuddering and squirming, looking about ready to pop from your skilled hands and mouth.");
            if (!clear)
                this.outputText("  Retreating from her throbbing balls, you");
            else
                this.outputText("  You");
            this.outputText(" move back up to her now soaking snatch, your tongue eagerly lapping up all the tasty juices from her lips before delving deep into her refreshingly cool cunt, hungrily licking up every slick drop of her succulent sweetness.  The act of worming your tongue back inside her hungry hole again drives Minerva ever closer to the brink of her climax, each slurp and stroke of your tongue and hands pushing the near-climactic herm right to the edge and sending her off into the blissful, pleasure-filled abyss of a mind-blowing double orgasm.");
            ...
            if (this.player.tongueType == appearanceDefs_1.TONUGE_DEMONIC)
                this.outputText(", your perversely prehensile tongue slowly retracting from her quivering quim, rubbing and teasing as it comes out and nearly sending the overly sensitive herm into another climax");
            this.outputText(".");
        ...
        letMinervaSuckYouOff() {
            ...
            if (this.player.isNaga())
                this.outputText(" lounge against the rock, spreading open your protective slit and letting your " + this.cockDescript(x) + " hang free.");
            else
                this.outputText(" sit down, spreading your [legs] and opening up the crotch of your [armor] to the air, letting your " + this.cockDescript(x) + " hang free.");
            this.outputText("\n\nAnxious and ready, Minerva looks down at you before kneeling, placing a hand on your [hips] as she takes hold of your " + this.cockDescript(x) + " and slowly starts to stroke it.  Her eyes looking up at you, she leans in and starts to gently lick your hardening flesh with the tip of her tongue.  Under her careful, deliberate attentions your manhood is quickly brought to full attention.");
            //if cock area 21+:
            ...
            this.outputText("\n\nTaking a relaxing breath, Minerva dives right into it, her long tongue slithering out to lick your hard, sensitive flesh, wrapping around the tip and giving the most sensitive part of your dick a good squeeze.  The heat-quenching chill of her wet tongue feels remarkable on your hard prick, the tight squeeze pulling a gasp from your mouth.  Your hands move over her head and into her dark red hair, and you're suddenly relieved that she can't envenom you this way.  Wanting to show you what she's made of, your siren leans in, dragging her cool wet tongue up your " + this.cockDescript(x) + " from base to tip before planting a kiss right on the " + this.player.cockHead(x) + " of your throbbing, needy dick.");
            //If balls:
            if (this.player.balls > 0)
                this.outputText("  Her hand on your hip moves down between your legs, sliding inwards to gently caress and massage your cum-filled [balls] to increase your pleasure even more, her hands trying their best to get your nuts worked up and prepare a good load for her at the end.");
            ...
            //If balls:
            if (this.player.balls > 0)
                this.outputText(" before licking and teasing your [balls]");
            this.outputText(".");
            this.outputText("\n\nWith your " + this.cockDescript(x) + " firmly captured by her tongue, Minerva leans down, opening her mouth wide and taking you inside its cool, wet confines, even as her tongue squeezes you and slides around your warm, sensitive flesh.  Looking up at you with a playful twinkle in her eyes, she starts to suck and squirm her tongue around on you, the long, prehensile appendage switching between licking over your throbbing cockmeat and squeezing it in a snakelike embrace.");
            ...
            if (this.player.cockArea(x) >= 50)
                this.outputText(", your huge cock deep inside her mouth, and soon far down her throat.  With some difficulty, her slightly angular nose presses down against your crotch, every inch of your " + this.cockDescript(x) + " trapped inside her cool, wet mouth and throat");
            this.outputText(".");
            ...
            if (this.player.balls > 0)
                this.outputText(", while your [balls] lurch and swell, rising up as you reach your climactic explosion");
            this.outputText(".");
            this.outputText("\n\nGripping Minerva's head tightly, you let out a long deep moan, your " + this.cockDescript(x) + " bloating with each ejaculation.  Eager to please, Minerva does her best to drink down every drop you give her, her hands gripping your [hips] and pressing her nose against your crotch, puckering her full black lips around your [sheath].");
            //Low cum: 
            if (this.player.cumQ() < 500)
        ...
        fuckMinervaWithHerHandsBehindHerBack() {
            var x = this.player.cockThatFits(this.minervaVCapacity());
            if (x < 0)
                x = this.player.smallestCockIndex();
            this.clearOutput();
            ...
            this.outputText("\n\nWith her so wet now, it's the perfect time to strike!  Deftly pulling your [armor] from your body, you toss the useless pieces away and expose [eachCock] to the air.  Taking hold of [oneCock], you drag its length across Minerva's thighs and rump just to tease her a little more before giving the horny herm the hard dicking she craves.  Reaching down, you lift and spread her curvy rear before aligning yourself, your " + this.player.cockHead(x) + " pressing and kissing her netherlips for a moment, drawing a lusty whimper from the siren before tensing your hips and plowing your iron-hard breeding meat into her with body-jerking power.");
            this.outputText("\n\nDespite your brutal thrust, you slide in with ease, Minerva's tight walls so slickened with her arousal.  You squeeze into the deliciously tight herm like butter, easily ramming every inch of your " + this.cockDescript(x) + " into her with only a few hard, deep thrusts.  With your hips pressed against Minerva's accepting body, you grind against her, making sure she can feel every inch moving inside her clinging cunt.");
            //If balls: 
            if (this.player.balls > 0)
                this.outputText("  As you continue to pound the siren, your [balls] swing between your legs, the sperm-filled orbs churning with your fertility, preparing to fill the needy siren with every drop you can muster when you let loose your eventual orgasm.");
            ...
            //Holy shit!:
                ...
                if (this.player.balls > 0)
                    this.outputText("  Minerva groans and lets out mindless gurgles as you unload your overproductive balls into her.");
                this.outputText("  To even your amazement, her hungry womb is able to contain much of your sperm before she can take no more, each blast of potent cum now gushing from between your bodies, the floor soon looking like someone dumped a barrel full of raw milk on the ground before you're finally done.");
        ...
        pcGetsEatenOutByMinerva() {
            ...
            if (this.player.hasCock())
                this.outputText(", and, perhaps, your more male parts while she's down there");
            this.outputText(".");
            ...
            if (this.player.balls > 0)
                this.outputText(", one of her hands lifting your [balls] up before giving each of the fertile nuts a kiss");
            this.outputText(" and moving down to your sweet cunt, just waiting for her attentions.");
            ...
            //If dick:
            if (this.player.hasVagina())
                this.outputText("Thanks to her handy stimulation, your musky maleness throbs and dilates along your femininity, the thick cockvein feeding your bloating member as your seed rushes out, splattering up and onto Minerva's back, defiling her smooth skin with your fertility.  ");
            this.outputText("Her mouth is closed over your hot quaking cunt, catching every drop and sucking hard on you as she slowly retracts her perversely prehensile tongue.  Minerva's mind wanders as she muses your unique flavors, her tongue still squirming inside you, making sure to lick up as much of your feminine juices as she can before finally pulling out from your body and letting go of you.");
            ...
            if (!this.minervaRomanced()) {
                //First time ending:
                if (this.flags[kFLAGS_1.kFLAGS.MINERVA_LEZZES_OUT] == 0)
            ...
            this.flags[kFLAGS_1.kFLAGS.MINERVA_LEZZES_OUT]++;
            // PC returns to camp
            this.dynStats("sen", -2);
            this.player.orgasm();
            if (this.getGame().inCombat)
        ...
        eatSomethingYouCunt() {
            ...
            this.spriteSelect(95);
            //Acquiring: 
            this.outputText("You walk over to the fruit trees surrounding the spring, examining the strange treats.  You decide that one ripe fruit, one resembling a peach, is the best choice, and pluck it from the tree.  Thanking Minerva for letting you have it, you stow it away safely and head back to camp.\n\n");
            this.inventory.takeItem(this.consumables.PURPEAC, this.camp.returnToCampUseOneHour);
        }
        /*
        Calming Mint
        ...
        */
        ...
        getADrinkYouBitch() {
            this.clearOutput();
            this.spriteSelect(95);
            this.outputText("You ask Minerva if she's okay with allowing you to drink from her spring.  She replies with a nod, a smile and a casual wave towards the pool.  Making it quite clear that you can drink your fill.");
            //[Bottle] [Drink]
            //[Drink]
    ...
    exports.MinervaScene = MinervaScene;
});
//# sourceMappingURL=MinervaScene.js.map