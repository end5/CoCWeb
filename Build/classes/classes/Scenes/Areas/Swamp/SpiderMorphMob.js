define(["require", "exports", "../../../Monster", "../../../StatusAffects", "../../../CockTypesEnum", "../../../../../includes/appearanceDefs"], function (require, exports, Monster_1, StatusAffects_1, CockTypesEnum_1, appearanceDefs_1) {
    ...
    class SpiderMorphMob extends Monster_1.Monster {
        //==============================
        ...
        spiderStandardAttack() {
            ...
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.MissFirstRound) >= 0 || this.combatMiss() || this.combatEvade() || this.combatFlexibility() || this.combatMisdirect()) {
                this.removeStatusAffect(StatusAffects_1.StatusAffects.MissFirstRound);
            ...
            //SPIDER HORDE ATTACK - Hit
                ...
                var damage = Math.floor((this.str + this.weaponAttack) - SpiderMorphMob.rand(this.player.tou) - this.player.armorDef) + 20;
                if (damage > 0)
                    damage = this.player.takeDamage(damage);
                if (damage <= 0) {
                    damage = 0;
                    if (SpiderMorphMob.rand(this.player.armorDef + this.player.tou) < this.player.armorDef)
        ...
        spoidahHordeWebLaunchahs() {
            ...
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.MissFirstRound) >= 0 || this.combatMiss() || this.combatEvade() || this.combatFlexibility() || this.combatMisdirect()) {
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.UBERWEB, 0, 0, 0, 0);
                this.HP -= 250;
                this.combatRoundOver();
            }
        }
        ...
        performCombatAction() {
            this.game.spriteSelect(72);
            if (SpiderMorphMob.rand(2) == 0 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.UBERWEB) >= 0)
    ...
    exports.SpiderMorphMob = SpiderMorphMob;
});
//# sourceMappingURL=SpiderMorphMob.js.map