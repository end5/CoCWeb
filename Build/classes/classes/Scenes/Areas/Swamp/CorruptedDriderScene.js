define(["require", "exports", "../../../BaseContent", "./CorruptedDrider", "../../../GlobalFlags/kFLAGS", "../../../../../includes/appearanceDefs", "../../../Items/Armors/LustyMaidensArmor", "../../../StatusAffects", "../../../PregnancyStore"], function (require, exports, BaseContent_1, CorruptedDrider_1, kFLAGS_1, appearanceDefs_1, LustyMaidensArmor_1, StatusAffects_1, PregnancyStore_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 03.01.14.
     */
    class CorruptedDriderScene extends BaseContent_1.BaseContent {
        //VARS
        ...
        defeatDriderIntro() {
            this.spriteSelect(77);
            this.outputText("", true);
            this.outputText("All eight of the drider's black and " + this.monster.hairColor + " striped legs collapse under her weight while she struggles ", false);
            if (this.monster.HP < 1)
                this.outputText("to try to continue the fight, her movements slowed by pain and weakness.", false);
            else
                this.outputText("to masturbate her swollen pussy-lips and the thick, juicy demon-cock that's sprouted in place of her clit.  She's so focused on getting off that she utterly gives up on the idea of fighting back, let alone dominating you as she seemed to plan originally.", false);
            ...
            if (this.player.hasCock() && this.player.lust >= 33) {
                if (this.player.cockThatFits(this.monster.vaginalCapacity()) >= 0) {
                    ...
                    if (this.player.tailType == appearanceDefs_1.TAIL_TYPE_SPIDER_ADBOMEN || this.player.hasItem(this.useables.T_SSILK)) {
                ...
                if (this.player.cockThatFits(12) >= 0) {
                    fuckSpinner = this.victoryVSDriderStickDickInSpinneret;
            ...
            if (this.player.lust >= 33) {
                ...
                this.choices("Butt Fuck", buttFuckBUTTFUCKBUTTTFUCKBUTTFUCK, "Fuck Pussy", vagFuck, "Bondage Fuck", careful, "FuckSpinner", fuckSpinner, "Ride Cock", rideCock, "Ride Ovi", rideOvi, "RideOviAnal", rideOviAss, "", undefined, "B.Titfuck", bikiniTits, "Leave", this.cleanupAfterCombat);
            }
            else
        ...
        loseToDrider() {
            ...
            if (this.player.gender == 0 || (this.player.gender > 0 && CorruptedDriderScene.rand(3) == 0))
                select[select.length] = 2;
            //SELECT SCENE HERE
            var choice = select[CorruptedDriderScene.rand(select.length)];
            //*Loss Ride Ovi Anal unsexed - gats (done)
            if (choice == 2)
                this.loseVSDriderGetAnalledOvi();
            //*Loss Vaginal Impregnation and forced BJ - Symphonie (done)
            else if (choice == 1)
                this.loseVSDriderAndVaginallyImpreggleOvi();
            //*Loss Ride & Impregnate Butt (done) MALE
            else
                this.loseVSDriderAndGetFuckedANDAnalImpreggegity();
        }
        ...
        winDriderPCDickInSpiderCunt() {
            ...
            if (this.monster.lust > 99) {
                ...
                this.outputText("at you with her " + this.monster.skinTone + " eyes opened wide and her tongue hanging from her mouth, panting lewdly.  Carapace-clad digits sink into her dripping honey-pot over and over while she watches, deep in her own lusty haze.  She retracts her engorged demon-cock so as to have better access to that feminine hole.", false);
            }
            else {
                this.outputText("she looks ", false);
                if (this.player.tallness > 72)
                    this.outputText("up ", false);
                this.outputText("at you with a look of disgust in her " + this.monster.skinTone + " eyes.  She folds her arms across her many-bosomed, quadratically endowed chest with disdain", false);
                if (this.monster.nipplesPierced > 0)
                    this.outputText(", the chains jingling loudly as she does so", false);
                this.outputText(".  In spite of keeping a stiff upper lip about it, her lower ones visibly quiver while you strip.", false);
            }
            this.outputText("  You saunter over to the limp-legged drider and run your hands down her inhuman, arachnid body, exploring the smooth, shiny carapace.\n\n", false);
            this.outputText("The corrupted monster-girl sighs and shudders at your touches, as if she can somehow feel your finger-tips through the rock-hard exoskeleton.  From the way she's trying to hold in her exhalations, you can only guess that it must feel wonderful, so you keep it up, circling and touching every part of her exotic anatomy.  By the time you've circled around her entire body, she's ", false);
            if (this.monster.HP < 1)
                this.outputText("giving up little, lewd moans", false);
            else
                this.outputText("breathing out lurid moans", false);
            this.outputText(" of pleasure and her ", false);
            if (this.monster.nipplesPierced > 0)
                this.outputText("chain-pierced-", false);
            this.outputText("nipples and clit look as hard as her natural body-armor.  You boldly grope one of her ", false);
            if (this.monster.nipplesPierced > 0)
                this.outputText("pierced ", false);
            this.outputText("breasts, feeling the supple, soft flesh shift while you roughly palm it and rub your thumb down a dark nipple.  You let the sensitive bud go and watch it spring back up, enjoying the drider's gasp of surprised pleasure for the brief moment before she muffles herself.\n\n", false);
            this.outputText("Still fondling one of the four nicely-sized tits, you push the spider-bitch back, admiring the drider's flexibility as she leans back over her inhuman lower body, giving you an even better view of her intoxicatingly sweet-smelling pussy.  You take " + this.oMultiCockDesc() + " in hand and rub the " + this.player.cockHead(x) + " along the slick lips of her pussy, shuddering slightly as her wetness rubs the sensitive glans.  Gasping, you slowly spread her molten-hot pussy around your girth, reveling in the tight embrace of her slick walls.  The drider squirms in your grip with her breasts bouncing deliciously and whole body trembling.  Spreading as easily as her cunt, the drider's venom-glossed lips slowly open into a wordless 'o' of rapturous pleasure.\n\n", false);
            this.outputText("Half an inch at a time, you sink ever-deeper inside the seemingly bottomless pit that is the spider-girl's steamy sex.  Reveling in the taming of the aggressive predator's sticky snatch, you postpone the eventual hilting as long as possible.  For her part, she doesn't seem to mind you having your way with her.  All eight of her spindly legs are scrabbling pitifully in the dirt, doing little more than nervelessly convulsing in uncontrolled pleasure.  The spider-woman's arms close behind your back, the sharp tips of her nails trying to claw deep furrows into your " + this.player.skinFurScales() + ".  At long last, your waist presses against her own to feel the oozing slipperiness of her nethers.  Your " + this.cockDescript(x) + " is totally buried in her tunnel, and now that you're holding still, you can feel the tiny folds inside her vagina slowly moving and gliding along your length, stroking your " + this.cockDescript(x) + " like dozens of tongues.\n\n", false);
            this.outputText("Compelled by your body's instincts, you draw back your " + this.hipDescript() + " to expose the bulk of your pussy-soaked shaft.  The spider-woman moans disappointedly, her voice filled with so much wanton desire that your " + this.player.cockHead(x) + " twitches in response.  You fondle the drider's lower pair of breasts with both hands, circling and squeezing the delectable mounds while you begin to repeatedly impale her squelching pussy, watching the upper row of pale breasts bounce and jiggle above your busy fingers.", false);
            if (this.monster.nipplesPierced > 0)
                this.outputText("  The chains binding her nipples make a delightful clinking noise with each squeeze and stroke.", false);
            this.outputText("\n\n", false);
            this.outputText("Meanwhile, the drider's swollen clit prods at your loins with each penetrating thrust, leaving lines of sticky spider-juice all over your crotch.  ", false);
            if (this.player.cockTotal() > 1) {
                this.outputText("Your extra penis", false);
                if (this.player.cockTotal() > 2)
                    this.outputText("es fan out to the side, forgotten while you give yourself over to the silken caresses of her glorious vagina.", false);
                else
                    this.outputText(" sticks out to the side, forgotten while you give yourself over to the silken caresses of her glorious vagina.", false);
            }
            else
                this.outputText("Your " + this.cockDescript(x) + " seems to bulge inside her, giving itself over to the silken caresses of her glorious vagina.", false);
            this.outputText("  The more you fuck the arachnid hussy's wanton slit, the more animated she becomes, until she finally breaks her wordless silence by crying, \"<i>Yes " + this.player.mf("master", "mistress") + ", dominate me!  I've been such a naughty bitch.  Use me like your cheap whore!  Fuck my holes full of cum, and leave me defiled in a puddle of spunk-laced mud!</i>\"\n\n", false);
            this.outputText("Invigorated by the rising tide of desire inside her, the drider pulls her torso up, crushing her tits into your palms so hard that her flesh bulges out through your fingers.  You smile down at the slutty spider and squeeze them hard enough to give her a taste of pain in response.  She pants, and her four " + this.monster.skinTone + "-hued eyes gaze at you, so full of desire that you have a hard time not cumming on the spot while you lock onto those half-lidded, luminous orbs.  You let go of her breasts and reach back to squeeze the smooth skin of her butt, feeling the joint between her human and arachnid halves just under her curvy derriere.\n\n", false);
            this.outputText("Heaving mightily, you use the submissive spider's ass-cheeks as hand-holds for a fast, hard fuck.  Her four ", false);
            if (this.monster.nipplesPierced > 0)
                this.outputText("pierced", false);
            else
                this.outputText("white-skinned", false);
            this.outputText(" breasts mash against your " + this.allChestDesc() + ", sweaty skin sliding back and forth and drawing gasps from each of you every time one of her nipples brushes one of yours.  She coos, \"<i>Please fuck my slutty drider-cunt harder, " + this.player.mf("master", "mistress") + "!  It was so naughty and cruel when I tried to rape you.  Don't let me cum... deny me over and over until I'm your good little spider-pet that'll do anything for release!</i>\"  She emphasizes every sentence by clamping her quim down on your " + this.cockDescript(x) + ", the dozens of lubricant-soaked folds rolling back and forth, milking you until you cannot help but ejaculate inside her.\n\n", false);
            this.outputText("Your back arches in orgasmic pleasure, fingers squeezing her butt tightly enough that your pale lover's derriere will show your hand-prints for some time.  She shudders slightly as your " + this.cockDescript(x) + " is forced as far inside her lewdly-textured vagina as possible, milking your penis with repeated strokes while your urethra bulges with the first load.  You release what feels like a torrent into her passage; the heavy spurt is quickly swallowed by the drider, disappearing deep inside her as if drawn away on an unseen current.  The sudden suction and increase in the movement of her folds makes your next rope of jizz feel even bigger, but it too disappears into the drider's seemingly-bottomless body.", false);
            if (this.player.cumQ() > 1000)
                this.outputText("  Amazingly, you actually manage to cum enough to fill her massive womb, and after the first few squirts, the cum slowly bubbles out around your shaft with each fresh deposit of jism.", false);
            this.outputText("\n\n", false);
            this.outputText("While you're distracted by the repeated contrast of tension and relief emanating from " + this.sMultiCockDesc() + ", the drider leans up and kisses your neck, humming against your throat as you squirt the last of your orgasmic goop into her vagina.  You slump into her arms, spent by the effort of fucking her so fast and cumming so hard.  As you lie there, her lips sucking hard enough to leave hickeys on your neck with every crushing, passionate kiss, you feel the patterns of glossy fluid tingling on your " + this.player.skin() + ".  A jolt of fear runs up your spine, and you try to push away from her envenomed affections.  It doesn't work!  You can barely lift your arms, let alone pull out of the amorous arachnid's embrace!\n\n", false);
            this.outputText("\"<i>Mmmmm,</i>\" hums the drider into your collarbone, smearing more of her toxic lip-gloss onto you as she goes.  \"<i>Such a good " + this.player.mf("master", "mistress") + "!  You punished me so well!  Now just relax... I've been dripping out a special venom that'll help you teach me the rest of my lesson, and I need to make sure that every... single... drop... slips inside that sexy bloodstream of yours.</i>\"\n\n", false);
            this.outputText("You wiggle futilely, using the last of your strength to try to break free, but it's no use - she's too strong, or the venom has made you too weak.  Dimly, you're aware of your " + this.cockDescript(x) + " pulsating inside her, hard as iron and burning hot with lust, even though you just came.  The spider-woman continues to kiss you, and with every peck of her lips, you feel yourself sagging deeper into her embrace until you lay your head down on her breast, your only movements the slight twitches of your body as it tries to deal with the poison-induced need to copulate.  You feel the warmth of her breath on your neck when she stops, cradling you in her arms.\n\n", false);
            this.outputText("The drider cocks her head to the side so you can see her luminous " + this.monster.skinTone + " eyes boring into you while she whispers, \"<i>Don't try to fight it, dear.  While there's enough of my normal venom in there to keep your " + this.cockDescript(x) + " hard enough to cum a few more times for me, the real magic is in the secondary chemicals my demonic friends were kind enough to teach me how to excrete.  You can feel it relaxing your muscles can't you?  Well, the beauty is that it isn't just your muscles relaxing... your mind is getting nice and relaxed too.  So open and pliable that you'll soon be a horny puddle of putty for me to play with.</i>\"\n\n", false);
            this.outputText("Gods, she's right!  You started to nod while she was talking, automatically agreeing with every sibilant syllable.  Trying to shake your head in denial, you only succeed at bouncing the jiggling tit-flesh beneath you.  You have to resist!  You beat her!  She can't do this!\n\n", false);
            ...
            if (this.player.cor > 80 && this.player.lib > 50)
                this.outputText("Of course it's the truth, the cunt's clearly got a good grasp on the obvious. Unwilling to lose your grip on dominance, however, you try to keep struggling to get the upper hand.\n\n", false);
            else
                this.outputText("No, that's not right.  You're not some rutting beast, you're the champion.  Sure, you've got your " + this.cockDescript(x) + " locked hilt-deep inside her squirming slit, but that doesn't mean you're some kind of " + this.player.mf("stud", "slut") + " who jumps on a cunt without a second thought, does it?  You blink your eyes while you try to think.  She does have a point though, if you hadn't been in such a hurry for some sex, you wouldn't be sagging into her tits and feeling so awfully relaxed.\n\n", false);
            this.outputText("The drider croons, \"<i>Come on, don't delude yourself.  If you weren't such a dominating, rape-hungry beast you wouldn't be nuzzling against my tits and giving me little nods of agreement.  Honestly, how could you ever think of yourself as anything different when your brain just does whatever your dick tells it to?  You just got off and might have even knocked me up, but your penis is even harder than before.</i>\"\n\n", false);
            if (this.player.cor > 80 && this.player.lib > 50)
                this.outputText("You grumble out a denial.  You're not dumb, you just like to take charge and fuck. There's no reason to resist jumping on a nice wet pussy and making it squirt while you pack it full... but you can't quite get your limbs to move.\n\n", false);
            else
                this.outputText("You mumble out a denial.  You're not a beast... you just like to take charge and fuck.  It's just so hard to resist jumping on a nice wet pussy and making it squirt while you pack it full... no!  That's not what...\n\n", false);
            this.outputText("\"<i>Oooh, are you leaking out more pre-cum already?  You're insatiable!  I bet you start thinking about your next fuck before you even finish getting off, don't you?  You can deny it all you want, but I felt your dick puff up a little bit more as soon as I said it.  No matter what you think, your cock is a dumb, happy little tattle-tale that always tells the girls exactly what you're thinking.</i>\"", false);
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1)
                this.outputText("  Exgartuan mumbles telepathicaly, \"<i>Fuck yes I do, but I wanna see how this plays out.</i>\"", false);
            this.outputText("  She adds, \"<i>Face the music - there's nothing you love more than defeating someone and letting your dick tell you what to do.  You dumb... domineering... beast...</i>\"\n\n", false);
            this.outputText("Gods!  It's getting so hard to think with that tight cunt clutching at your cock and the soft, feminine enunciations constantly interrupting your thoughts.  How can she concentrate with the stink of sex hanging so thick in the air?  Your " + this.cockDescript(x) + " is so horny, why aren't you fucking her yet?  You shudder weakly and remember ", false);
            if (this.player.cor > 80 && this.player.lib > 50)
                this.outputText("that it's because of her own venom paralyzing your muscles so effectively.\n\n", false);
            else
                this.outputText("there was something wrong about what she was saying... something important.\n\n", false);
            this.outputText("The drider pauses to gaze into your eyes with all four of hers.  She runs a hand through your hair while making gentle shushing noises at you before she resumes her diatribe.  \"<i>There there, I know how eager you are to fuck me into my place.  I'm just another wanton harlot waiting to be forced on her back and turned into a fresh cock-sleeve for you, aren't I?  You recognize the absolute truth of my words.  Every time I talk you can feel the words bouncing around inside that empty head of yours.</i>\"\n\n", false);
            this.outputText("You nod, actually moving your head against her pillowy breasts as you feel your strength starting to return.  Why is she wasting so much time telling you things you already know?  This bitch's cunt is like a white-hot furnace of lust, and your cock is so tired of having to sit still.  You can't wait to recover from the venom and fuck her so hard she'll black out from the ensuing orgasm.  Then you'll fuck her a few more times until your cock finally gets tired of her sloppy, cream-pied pussy.\n\n", false);
            this.outputText("\"<i>Oooh, that dick is just getting harder and harder isn't it?  I bet it feels like it's about to burst and cum, even though you're not able to punish me like you want to yet.  Maybe you secretly get turned on by being denied?  Oh!  I just felt your dick jump!  So you want to go around, letting your dick tell you to dominate every horny cunt you see, but the thing that turns you on more than anything else is having a woman turn the tables on you, isn't it?</i>\"\n\n", false);
            this.outputText("You moan, \"<i>N-no...</i>\" but a small burst of pre-cum chooses that moment to erupt from your " + this.cockDescript(x) + ", still nestled inside the squirming spider-cunt.  It feels heavenly, and while you try to struggle in your weakened state, the warm embrace of her pussy's many cock-milking folds is turning your penis into a cum-drooling behemoth on the edge of exploding.  Oh gods, is she going to do it?  Damn, you want to put her in her place, but you're so weak right now.  Even worse, her pussy has you so close, so very close.\n\n", false);
            this.outputText("The chitinous, oh-so-right bitch pulls your head up to gaze deeply into her eyes.  \"<i>You have a horny, naughty cock, and you always listen to it.  This rebellious member gets you into so much trouble, but you'll never stop listening to it.  You'll keep chasing every wet pussy you see, because you're just a horny animal.  A rutting, horny animal.  But I know your secret.  Your dick really wants a girl to turn the tables on you, paralyze you, and tease your cock mercilessly.  It feels so good to let me touch your body, stroke it, tease it, and squeeze it.  You won't even fight any more.  My pussy has your cock so close, so very close, and you're going to cum when I tell you.  You'll blow your load on command for me, my servile, secretly submissive mount.</i>\"\n\n", false);
            this.outputText("A plaintive whining, almost exactly like that of an animal, vocalizes subconsciously.  Your " + this.cockDescript(x) + " feels afire, constantly leaking pre-cum while you're held immobile in your spidery mistress' arms; you lick your lips and start to beg, mumbling out your desire to cum for her, anything for her, so long as she lets your dick orgasm again and again.  You want to climax so bad, but you want her to control your cock so much more.  It's always getting you in trouble, and it feels so good to let her use you as her cum-drooling mount.\n\n", false);
            this.outputText("The spider-woman giggles and surprises you by kissing you on the lips, holding you against her while her narrow tongue smears her venom all over your lips and tongue, staining them purple.  You exhale happily through your nose, feeling perfectly, utterly relaxed and yet aroused beyond any reasonable measure.  The squeezing caresses around your dick keep you happily squirting heavy dollops of pre-cum.  You've no doubt it must look like some kind of over-stuffed sausage by this point, bloated beyond reason.\n\n", false);
            this.outputText("When she pulls away, her face is covered in a huge blush, and she's panting out loud and interrupting her words with quiet moans as she talks, \"<i>That's a good " + this.player.mf("boy", "girl") + ".  Even though you're a stupid pussy-slave, bound to let your cock lead you into every hungry snatch you see, you know how to obey a smarter woman's cunt, don't you?  Let me hear you beg like the animal you are.  Whine for mistress while her cunt fucks your dick, show me with every fiber of your being how much you love to submit, to obey, and to beg to be allowed to cum.</i>\"\n\n", false);
            this.outputText("She lets your head hang limply, and all you can do is whine, and try to look up at her with the most pathetic expression in your eyes.  You're beaten - she's so much smarter than you and she's got you by your dick.  Why didn't you think?  ", false);
            if (this.player.cor > 80 && this.player.lib > 50)
                this.outputText("Gods it was a bad idea not to bind her lips... ", false);
            else
                this.outputText("Gods this was a bad idea... ", false);
            this.outputText("still, at least she's controlling your rebellious dick, teaching the little prick a lesson while letting you feel so good.\n\n", false);
            this.outputText("The drider moans louder and responds, \"<i>Yes, oooh, good " + this.player.mf("boy", "girl") + ".  You're so hard, so very hard.  You're oozing out cum even though you're not allowed to fuck me, and you love it.  I bet you don't even mind not getting to orgasm - so long as you're helpless and hilt-deep in a cunt, you're happy, aren't you?  Oohhh, I'm gonna... gonna... cum soon.  Luckily for you, I want you to squirt inside me.  I want that cock creaming my pussy as soon as I... ohhhh... so good... s-soon as I command it...  You'll do that for me, won't you?  You'll obey me completely, utterly, and pump every drop of your jism into my soon-to-be-pregnant pussy, right?</i>\"\n\n", false);
            this.outputText("You mewl out an affirmation, forgetting how to speak with all the venom pumping through you and the mind-crushing levels of arousal pouring out of your " + this.cockDescript(x) + ".\n\n", false);
            this.outputText("The spider-woman shudders from head to all eight of her 'toes', her four eyelids closing while her mouth gasps out, \"<i>Cum for me.</i>\"\n\n", false);
            this.outputText("The first spurt of pent-up seed splatters the spider's womb before you even realize she gave you permission, painting the squirming walls white.  You growl and cum, releasing spurt after spurt of spunk while her pussy seems to drink it all down", false);
            if (this.player.cumQ() > 1000)
                this.outputText(", even though you've packed it full once already", false);
            this.outputText(".  Her legs skitter and tremble, her pussy convulses, and your dick gets the squeezing, sucking orgasm of a lifetime.  It feels like you're pumping out two or three orgasms worth of spooge, each dick-stretching explosion of cream dilating your slit almost painfully wide.", false);
            if (this.player.cumQ() > 1000) {
                this.outputText("  The stuff dribbles out around your tool along with a mix of girl-lube, too much even for her prodigious pussy to contain.", false);
                if (this.player.cumQ() > 2000)
                    this.outputText("  The flow thickens into a river, and soon the puddle of cum looks more like a pond, turning the dirt into a soup of muddy cum.", false);
            }
            this.outputText("\n\n", false);
            this.outputText("While it seems to go on and on, your orgasm eventually ends, leaving you to hang limp while your still-hard dick is massaged by a much wetter spider-cunt.  The " + this.monster.hairColor + "-haired beauty dreamily says, \"<i>Mmmm... good job, pet.  Now, let that nice hard dick do the thinking for you and keep fucking my hot cunt until it goes dry.  Maybe a few hours after you finish, you'll be able to remember that you used to be a " + this.player.mf("man", "woman") + " before you became my livestock.</i>\"\n\n", false);
            this.outputText("The blissful arachnid rolls onto her side with you still locked inside her and falls asleep, her " + this.monster.hairColor + " tresses ", false);
            if (this.player.cumQ() <= 1000)
                this.outputText("splayed across the ground", false);
            else
                this.outputText("soaking in the white puddle of spooge", false);
        ...
        winDriderPCDickInSpiderCunt2() {
            ...
            this.outputText("Pistoning your hips violently, you continue to ravage the unconscious spider, fucking her in a brutal, beast-like manner that centers entirely upon your own pleasure.  You cum, dumping a fresh batch of jizz into her already-stuffed twat, grinning when a few more rivulets of ooze roll over her inflamed pussy-lips to drip into the growing puddle.  Still hard, " + this.sMultiCockDesc() + " continues to twitch, hungry for more, and you don't deny it.  You grab the arachnid bitch and stuff your dick into her mouth, shivering while her venom seeps into your dick, keeping you hard and ready to blow.  Whatever special, immobilizing venom she had earlier, it seems exhausted, and the only response your body has to the onslaught of toxin is to erupt, spouting a huge load of semen into her mouth.\n\n", false);
            this.outputText("A low growl rips through your throat as you pull back and plaster her face white, coating the caked-on residue of a few previous loads with fresh moisture.  You shift position and force your " + this.cockDescript(x) + " between her two pairs of breasts, sandwiching it in there for the titty-fuck of a lifetime.  Pistoning back and forth, humping the glorious orbs relentlessly, you give yourself over completely to your sore dick, letting your world dissolve into the feelings of each of the spider-woman's orifices around your member.\n\n", false);
            this.outputText("<b>Even later...</b>\n", false);
            this.outputText("You collapse into the dirt, not even caring that it stinks of dried cum and girl-jizz.  You've completely emptied out every speck of sperm from your " + this.ballsDescriptLight() + ", and you even kept going for a while after that.  It wasn't until " + this.sMultiCockDesc() + " went soft at last that you found enough peace to lie down.  ", false);
            if (this.player.cor > 80 && this.player.lib > 50)
                this.outputText("The longer you sit there, the more your strength returns to you, and the more the submissiveness placed into you by her venom recedes. Still, you've tired yourself out too much to leave at the moment.", false);
            else
                this.outputText("The longer you sit there, the more you remember of yourself, and the more you forget the animal, the rut-beast that the spider-woman placed inside you.", false);
            this.outputText("  You shiver and wrap your arms around her, snuggling against her while a primal, buried part of your brain insists that she's YOURS.  You fall asleep like that, resting dreamlessly even through your mate's waking and departure.", false);
            this.hideUpDown();
            this.monster.lust = 98;
            this.monster.HP = 2;
            this.player.lust = 100;
            this.flags[kFLAGS_1.kFLAGS.COMBAT_BONUS_XP_VALUE] = this.monster.XP;
            this.cleanupAfterCombat();
            this.player.orgasm();
            this.dynStats("lib", 1, "sen", 1);
        }
        ...
        victoryVSDriderRideOviAnal() {
            ...
            this.outputText("The spider's look of ", false);
            if (this.monster.HP < 1) {
                this.outputText("hate fades slightly when she sees you eyeing her ovipositor, and with a sigh of annoyance, allows the segmented organ to slowly slide out from her body.  It grows to just over two feet in length, swaying sinuously in the air, though you can tell it isn't completely engorged yet.  Still, your " + this.assholeDescript(), false);
                if (this.player.hasCock())
                    this.outputText(" and " + this.sMultiCockDesc() + " twitch", false);
                else
                    this.outputText(" twitches", false);
            ...
            this.outputText("You lean over and grab it in your hands, letting it pulse and squirm in response to your touches.  The copious slime it's covered in lets your fingers easily slide down its length.  Each stroke of the odd, feminine member elicits a pleasured groan from your defeated opponent, and you quickly surmise that she must like this just as much as you do using your own genitals.  Pumping and stroking it, you watch with perverse fascination as the ridges grow firmer, hardening in your hand.  A viscous green slime bubbles out of the wide slot at its tip as the spider-girl's moans reach a crescendo.  It's as lubricated as it's going to get.\n\n", false);
            this.outputText("Climbing over the drider's bulbous body, you bend over to present your " + this.assDescript() + " to the twitching ovipositor, beckoning her to slide inside your twitching " + this.assholeDescript() + " as you stand atop its owner.  The sprawled-out spider looks up past all of her body to watch you, leaving you waiting.  Nothing happens at first.  You're just there, ass in the air and waiting to be violated, encouraging it on your own terms, but she doesn't do anything at all.  She simply watches you.  It isn't until a scowl of irritation makes its way across your face that she acts.\n\n", false);
            this.outputText("The ovipositor lurches over, bending and flexing to reach up to your exposed hole, barely touching you while it explores your cheeks.   You pant and grab your " + this.buttDescript() + ", pulling yourself wide to expose the clenching, dark circle that is your pucker.  It rubs across your hand before finally finding its way into your anal cleavage, ridges sliding between your backside and flopping against your ring while it blindly tries to get adjusted.  The moist, dripping slime it exudes quickly turns your ass into a green-glazed slip-'n-slide.  A sudden shock of sensation alerts you that yes, the ovipositor has finally found your asshole.\n\n", false);
            this.outputText("The tentacle-like tube prods forward, leaking ooze inside you as the first ring contracts to squeeze inside you.  You gasp when it pops into place, barely adjusting before the next ridge slides into the slightly-loosened sphincter.", false);
            this.player.buttChange(30, true, true, false);
            this.outputText("  Each segment somehow feels larger than the one preceding it, though it seems impossible given how widely stretched you feel by the time the fourth is inside you.", false);
            if (this.player.hasCock()) {
                this.outputText("  The warm organ brushes past your prostate, the slippery caress making " + this.sMultiCockDesc() + " dribble a ", false);
                if (this.player.cumQ() < 500)
                    this.outputText("drop", false);
                else
                    this.outputText("stream", false);
            ...
            if (this.player.hasVagina()) {
                ...
                if (this.player.wetness() >= 3)
                    this.outputText(" and drips", false);
                this.outputText(" sympathetically with the sensation, and your " + this.clitDescript() + " peeks from the wet lips.", false);
            }
            this.outputText("  Yet you are not denied the anal pleasure you crave, as the widening bands now filling you are each pushing out harder than the one before.  At the stimulation, her own demonic clit swells as if posessed, nodulates, and hardens into dick form, poking up from her pussy and drooling a slime of pre-cum onto her abdomen.  The second ring rolls over your anal g-spot and you gasp, nearly losing your grip.  The third knocks your " + this.player.legs() + " out from under you, and you collapse atop your partner, squeezing oozing dick", false);
            if (this.player.hasCock())
                this.outputText("s", false);
            this.outputText(" between you", false);
            if (this.player.clitLength >= 4 && this.player.hasVagina())
                this.outputText(", and pressing your monster chick-stick into it; the gooey heat sends a tingle of shock up your spine and your pussy convulses", false);
            this.outputText(".", false);
            this.player.buttChange(50, true, true, false);
            this.outputText("\n\n", false);
            this.outputText("Shivering, you glance back up at the defeated woman; she has a passionate, prideful look plastered on her face, though it seems to waver each time another inch of ovipositor pushes past your stretched-out ring.\n\n", false);
            //([not mans]
            if (!this.player.hasCock())
                this.outputText("\"<i>I never would've thought you were an anal-pregnancy slut,</i>\" hisses the spider in pleasure, flexing her organ harder while it curls through your guts, so deep inside you that you wonder how much further she can go.", false);
            else
                this.outputText("\"<i>Just because I have an exoskeleton doesn't mean I can't feel you dripping on me.  I thought I was the corrupt bitch here, but you... you take the cake.</i>\"", false);
            this.outputText("\n\n", false);
            ...
            if (!this.player.hasCock() && this.player.hasVagina())
                this.outputText("You gasp and dribble a few strands of girl-goo, the contractions of your achingly empty pussy intensifying.  ", false);
            if (this.player.hasCock())
                this.outputText("You gasp and squirt a few weak ropes of cum, having a miniature orgasm on the spot.  ", false);
            this.outputText("Writhing happily, you sigh ", false);
            if (this.player.hasCock())
                this.outputText("while your " + this.multiCockDescriptLight() + " dribbles white, wasted goo onto the black and " + this.monster.hairColor + " striped carapace below", false);
            else if (this.player.hasVagina())
                this.outputText("while your " + this.vaginaDescript(0) + " dribbles fem-slime onto the black and " + this.monster.hairColor + " striped carapace below", false);
            else
                this.outputText("while your fingers tweak your " + this.nippleDescript(0) + "s and your starved sphincter sucks at its slimy, squirming stuffing", false);
            this.outputText(".  Without warning, the ovipositor dilates, pulling your " + this.assholeDescript() + " even wider.  An explosion of warmth goes off in your guts, and you realize that your term as an incubator has begun with a sense of perverse delight.\n\n", false);
            this.outputText("The large, round egg pushes its way up your butt, squeezes past your ring", false);
            if (this.player.hasCock())
                this.outputText(" and your prostate", false);
            this.outputText(", and travels deep inside you, bulging your belly the slightest bit once it's deposited.  With a groan of deep satisfaction, you start humping the fluid-slicked chitin beneath you, barely registering the long, seemingly unending series of eggs that infiltrate your ass", false);
            if (this.player.hasCock())
                this.outputText(" and milk your prostate as they push past", false);
            this.outputText(".\n\n", false);
            this.outputText("The stream of slime only spreads as the stimulation of the sliding spheres slewing into your sphincter sets off", false);
            ...
            this.outputText(" squirts of slippery spooge from her shuddering spunk-stick.  While you shriek, squirm and shiver shamelessly, you see the spider-slut suspended in the same, similarly a slave to the sensation of shoving and slamming her stalk into your straining sacrum and stuffing you with her strange spawn.\n\n", false);
            this.outputText("Gradually, you're lifted off the carapace by your inflating abdomen.  Your belly gurgles, making you burp as you're filled with enough eggs to make you feel uncomfortable and compressed.  The " + this.player.skinFurScales() + " of your stomach is drum-tight by the time you slide off the wilting ovipositor, and the bottom portion of it is soaked in the last of your partner's orgasm.  You look positively pregnant as you stagger upright and make for your garments, trying to ignore the exhausted drider's jibes.\n\n", false);
            this.outputText("By the time you finish getting dressed, she's fallen into a fitful slumber.  What an ordeal!", false);
            //GET KNOCKED UP
            this.player.buttKnockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_DRIDER_EGGS, PregnancyStore_1.PregnancyStore.INCUBATION_DRIDER - 200, 10); //Butt pregnancy goes faster
            this.player.slimeFeed();
            this.player.orgasm();
            this.dynStats("cor", .5);
            this.cleanupAfterCombat();
        ...
        loseVSDriderGetAnalledOvi() {
            ...
            if (this.player.HP < 1)
                this.outputText("abused", false);
            else
                this.outputText("hungry", false);
            this.outputText(" asshole, her eggs squeezing along and filling you up inside.  You yelp as the seemingly endless onslaught of spherical objects force their way inside, the drider effortlessly pumping in and out of you to help the process along.  The arachnid-woman pants and curses while she jerks off her nubbed member, using both of her hands to double the pleasure of being inside of you.  You're pushed and shoved against the ground while your attacker slams against your " + this.assDescript() + " with wild abandon, and with one final push she's sent over the edge, shuddering in orgasmic delight as ropes of cum fly out of her thick length and land ", false);
            if (this.player.tallness < 66)
                this.outputText("in front of you", false);
            else
                this.outputText("on your face", false);
            this.outputText(", her pussy juices squirting alongside them.  As she calms down, the herm-drider's spunk lessens in force, instead drooling out of her softening cock and landing onto your ", false);
            if (this.player.tallness < 66)
                this.outputText(this.player.face() + ", sliding down across your cheeks and along your lips", false);
            else
                this.outputText("chest, trickling between your " + this.nippleDescript(0) + "s", false);
            this.outputText(".  She pulls out her ovipositor slowly, though the bulge in your stomach remains as evidence of her work.", false);
            this.player.buttChange(50, true, true, false);
            this.outputText("  With a giggle, she removes herself from you and walks in front of your defeated form, bending down to kiss you gently on your lips and licking a pearl of semen from your face.  Your skin tingles with the brush of her venomous lips.  \"<i>Thanks for the fuck, pet!  Here's hoping my babies won't keep you for too long,</i>\" the arachnid-woman purrs, before turning around and walking towards the hazy embrace of the fog.  \"<i>Toodle-oo~!</i>\"\n\n", false);
            this.outputText("...\n\n", false);
            this.outputText("A few hours later and you wake up to the sound of loud croaking and the smell of the bog.  You try moving your limbs, finding that your bindings had partially dissolved since the encounter. Painfully removing yourself from the ground, you begin your journey back to camp - carrying a bit more than you were before.", false);
            //GET KNOCKED UP
            this.player.buttKnockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_DRIDER_EGGS, PregnancyStore_1.PregnancyStore.INCUBATION_DRIDER - 200, 10); //Butt pregnancy goes faster
        ...
        loseVSDriderAndGetFuckedANDAnalImpreggegity() {
            ...
            if (this.player.lust > 99)
                this.outputText("Unable to resist the desire coursing through your body, you strip off your " + this.player.armorName + " and start stroking " + this.sMultiCockDesc() + ", displaying it in the hope that it will draw the drider's attention, while at the same time just trying to get yourself off and attain release.", false);
            else {
                this.outputText("You slump down, too beat up to mount an effective defense, let alone stay up on your " + this.player.feet() + ".  The drider skitters over to you and effortlessly peels you out of your " + this.player.armorName + ", exposing your ", false);
                if (this.player.lust < 50)
                    this.outputText("soft", false);
                else
                    this.outputText("hard", false);
                this.outputText("member", false);
                if (this.player.cockTotal() > 1)
                    this.outputText("s", false);
                this.outputText(" to the air.  She squeezes " + this.oMultiCockDesc() + " in her hand and pumps it, smiling while you stiffen and twitch precipitously in her grasp.", false);
            }
            this.outputText("  With a strength beyond what her lithe frame would imply, the spider-woman's shiny, exoskeletal arms slip under your shoulders and lift you up, hugging you into both pairs of breasts", false);
            if (this.monster.nipplesPierced > 0)
                this.outputText(", the crossed chains digging into your " + this.chestDesc(), false);
            this.outputText(".  The warmth of her nodule-covered cock pulsates on your belly, smearing you with a trail of pre-cum while she arranges your entwined bodies.\n\n", false);
            this.outputText("Lines of webbing burst from the arachnid abdomen, snapping into tree limbs before pulling taut.  The drider's eight legs clitter and clack, four of them folding around your back while your world rotates 90 degrees.  The two of you are pulled into the trees by the sticky strands, hanging sideways, almost upside-down, in the leaves.  The four-eyed monster-girl blinks asynchronously and smiles, shifting you slightly to bring " + this.oMultiCockDesc() + " against her moist lips.  You exhale, an intense, animalistic thrill shivering through you from the feeling of having your " + this.cockDescript(x) + " lodged in a woman's entrance.  She leans down and bites into your neck, releasing a surge of toxin into your bloodstream.  It boils like fire, making you twitch and squirm in her many-limbed clutches.  The pain fades quickly, but in its place it leaves behind a molten, liquid lust, filling " + this.sMultiCockDesc() + " to its absolute maximum size, as hard as it can possibly be.\n\n", false);
            this.outputText("The " + this.monster.hairColor + "-haired dominatrix pulls back, a single drop of blood clinging to one of her fangs while she hisses, \"<i>Mmm, fresh meat is always so tasty... not to mention... firm...</i>\"\n\n", false);
            this.outputText("You look at her with fear, but your " + this.hipDescript() + " start to twitch against her, rubbing your " + this.player.cockHead(x) + " up and down the slippery slit.  A slow exhale of pleasure escapes the spider's purple lips while her legs squeeze tighter against you, trying to push your " + this.cockDescript(x) + " home.  The drider gasps when at last, you slip between her juicy outer labia, slurping deep into her cunny with a lurid squelch.  Finally held within her depths, your muscles all slacken, save for those you need to pump your hips against her, futilely trying to fuck her hot quim even though you have zero leverage.\n\n", false);
            this.outputText("\"<i>So eager!  I'm not going to let you fuck me, but I do want your sperm.  After all, I'll need to fertilize some more eggs.</i>\"\n\n", false);
            this.outputText("Wait, eggs?  While you try to chew over the thought, you're battling with your raging, venom-enhanced libido in order to think about something other than how good her pussy feels.  Fuck it!  You go back to grinding against your mistress, nuzzling at her neck while she twists her spider-half around you, holding you tightly in her chitin and bringing her abdomen up behind you.  A weird, wet appendage rubs over your exposed " + this.buttDescript() + ", slapping at your cheeks until it finds the cleft between them.  Sliding deeper, it bumps into your sphincter, spurts something warm, wet, and sticky against it, then pushes through.", false);
            this.player.buttChange(8, true, true, false);
            this.outputText("  You shudder from the anal violation and twist against the legs holding you in place, but with your " + this.cockDescript(x) + " locked inside her, it's a useless endeavor.  It isn't shaped like a dick, and besides, that's currently dripping on your belly.  Oh gods... she mentioned eggs.\n\n", false);
            this.outputText("The strange organ keeps forcing its way deeper, slipping the steadily-widening, rib-like segments of its bulk into your " + this.assholeDescript() + ".  ", false);
            this.outputText("  Once it gets deep enough to push on your prostate, an upsurge of pleasure hits you hard enough to make " + this.sMultiCockDesc() + " dribble.  You moan against the drider's neck, pulsing pathetically inside the spider-woman's slit.  You know you'll soon be giving her exactly what she wants - all of it - and there's nothing you can do about it.\n\n", false);
            this.outputText("Another inch slides inside you, filling you uncomfortably full.  You shiver, clutching at your spidery mistress while she prepares both to deposit and to withdraw from the bank of you.   While you hang there, on the very edge of orgasm, it stops going deeper.  You've been given a reprieve, but it doesn't last long.  The drider kisses your forehead, her venomy lips spiking the sensitivity of your skin once again.  Suddenly, the fat tube in your " + this.assholeDescript() + " is dilating, stretching you wider.  Goo races up it, pumping into your guts, paving the way for the bigger bulk of the coming egg.  It stops at your pucker, battering against your muscles' resistance until it pops inside you, slamming into your prostate so hard that a huge rope of dick-milk erupts into the spider-woman's wet vagina.", false);
            this.player.buttChange(50, true, true, false);
            this.outputText("\n\n", false);
            this.outputText("The egg travels further up your butt, eventually flowing out the end of her stalk-like organ to rest deep in your digestive tract, ensconced in a bubble of slime.  Before you can adjust to this new sensation, another egg slips through your now-widened ring.  It squishes past your anal g-spot, rubbing it just as hard as the first, but before it even finishes traveling up your intestines, a third egg is forced inside you.  " + this.SMultiCockDesc() + " begins to cum wildly, squirting and leaking a torrent of jizz.  The first few ropes blast out with incredible force, hosing down her cunt", false);
            if (this.player.cockTotal() > 1)
                this.outputText(" and belly", false);
            this.outputText(".  Then, the constant application and release of pressure on your prostate utterly destroys the orgasmic timing of your muscles' contractions, making " + this.sMultiCockDesc() + " release a weak, but constant trickle of cum.\n\n", false);
            this.outputText("You quickly lose track of how many of the drider's eggs have gone inside you.  Feeling the numerous bulges in your abdomen, you give up entirely.  Your ass is going to be full of eggs and you've probably cum enough for her to make a whole 'nother batch.  Shuddering while the ovipositor is withdrawn, you sag, exhausted, barely realizing that the drider is hosing down your " + this.chestDesc() + " with her arachnid herm-spunk, the nodules ringing her dick pulsing in time with the blasts of thick spooge.  Some sticks to your chin, but you're so drained from your rough treatment that you barely react.\n\n", false);
            this.outputText("\"<i>Shhh, shhh... it's all right.  You'll be such a good mother for my young, and an even better father for the eggs you just fertilized.  Maybe if we ever meet again you can tell me how they looked when they were born.  For now, rest up.  I want you to take good care of our babies,</i>\" instructs the drider while she lowers herself towards the ground.  She sets you down on a soft spot, giving you a blanket of moss to recover in.  You struggle to stay awake but quickly slump into a deep slumber.", false);
            //(slimefeed)
            this.player.slimeFeed();
            //GET KNOCKED UP
            this.player.buttKnockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_DRIDER_EGGS, PregnancyStore_1.PregnancyStore.INCUBATION_DRIDER - 200, 10); //Butt pregnancy goes faster
        ...
        birthSpiderEggsFromAnusITSBLEEDINGYAYYYYY() {
            ...
            this.outputText("\n\n", false);
            this.outputText("You shift position slightly, if only to get more comfortable, and relax as the eggs work their way through your guts.  With each egg's passage, your sphincter seems to be looser, more pliant, and more sensitive.  You blush and squeeze, hurrying the process to make yourself feel even better, and egg after egg splats wetly into the growing pile, each one slick and soaked in slime.  One after another, the heavy orbs exit your body, until the last one is sliding out of your rectum and you're having a strange anal orgasm that feels as relaxing as it is pleasant.\n\n", false);
            this.outputText("Clenching and relaxing, your slime-dripping asshole slowly narrows, gaping less visibly while you shudder and sigh, so happy and blissful that you don't even care about the crackling egg-shells hatching beneath you.  ", false);
            if (this.player.hasCock())
                this.outputText(this.SMultiCockDesc() + " stays limp, but drools a heavy flow of semen, puddling up a nice thick batch of your pleasure alongside your goo-pile.  ", false);
            if (this.player.hasVagina()) {
                this.outputText("Your pussy clenches and ", false);
                if (this.player.wetness() < 3)
                    this.outputText("drips", false);
                else if (this.player.wetness() < 4)
                    this.outputText("dribbles", false);
                else if (this.player.wetness() < 5)
                    this.outputText("gives a tiny squirt", false);
                else
                    this.outputText("gushes a river of lady-spunk", false);
                this.outputText(" into the dirt, getting off along with your " + this.assholeDescript() + ".  ", false);
            }
            this.outputText("Once you come down from your high, you roll to the side and watch the tiny driders clambering out of their egg shells.\n\n", false);
            this.outputText("Your newborn children glance at you, chittering happily before they scurry off in the direction of the swamp.\n", false);
            this.player.orgasm();
        }
        driderPregVagBirth() {
            this.spriteSelect(77);
            ...
            this.outputText("\n\n", false);
            this.outputText("After what seems like hours, you have lost count of the eggs pushed out.  ", false);
            if (this.player.isNaga())
                this.outputText("At last, when no more eggs seem to be coming, you flop over onto your back, careful not to crush any of your dormant offspring.", false);
            else
                this.outputText("Looking between your legs you can see another slick, green egg slide from your body to join the sizable pile behind you.  At last, when no more seem to be following it, you flop over onto your back, careful not to crush any of your dormant offspring.", false);
            ...
            this.outputText("One egg rolls away from about the middle of the pile and you can see the little drider has almost made her way out of it.  With one last push she completely breaks out of the egg and falls face forward onto the ground.  The drider child seems to be having trouble coordinating all eight of her legs at the same time as she repeatedly picks herself up and stumbles a few steps before falling down again.  Looking back to the pile you can see many more of your drider children breaking out.  Soon enough, there are countless little drider girls, all about the size of your palm, skittering around.\n\n", false);
            //(If breasts)
            if (this.player.biggestTitSize() >= 2) {
                this.outputText("One drider girl cautiously makes her way over to you.  Her legs tickle your stomach as she climbs up to one of your " + this.breastDescript(0) + ".  Grasping the flesh tightly in her tiny hands she begins to suckle at your " + this.nippleDescript(0) + ".", false);
                if (this.player.bRows() > 1)
                    this.outputText("  Following their sister's lead, more little driders take their place at each of your nipples and begin to drink.", false);
                else
                    this.outputText("  Following her sister's lead, another little drider takes her place at your other nipple and begins to drink.", false);
                if (this.player.lactationQ() >= 3000)
                    this.outputText("  One of your offspring seemed to be grasping your breast too tightly and drinking too greedily as suddenly you see one propelled away from you before she lands in a small puddle of milk nearby.  She seems to be struggling to right herself as she writhes around in the milk puddle, and so with a grin you reach over to pluck up the clumsy child and place her back at your waiting teat.", false);
                this.outputText("\n\n", false);
            }
            this.outputText("Around you, your many drider children fervently explore their surroundings.  One climbs up your back and perches atop your head.  She raises one hand to her forehead to block the sun's glare and stretches all four of her jewel-like eyes wide, delighting in the wondrous world she surveys.", false);
            if (this.player.eyeType != appearanceDefs_1.EYES_FOUR_SPIDER_EYES)
                this.outputText("  Suddenly she flops forward, leaning against your eyebrows and causing you to cross your eyes in an attempt to focus on her.  She seems confused by the way your eyes are different to hers.", false);
            if (this.player.isNaga())
                this.outputText("  A few baby driders crawl ponderously across your scaled tail.  You give your tail a little wiggle and suddenly they go wild crawling around it and letting out the faintest, cute little squeals.", false);
            else
                this.outputText("  A few baby driders sit on each of your legs, facing each other.  Some gesture and squeak at each other in wonder while others pull faces.", false);
            this.outputText("\n\n", false);
            this.outputText("Nearby, two more of your little girls are in a stand-off, as each skitters back and forth in front of the other, ready to charge.  Suddenly one leaps forward and grabs the other before attempting to bite her arm.  Of course the attack is completely harmless - they are still much too young to have grown their fangs.  The other then turns the tables on her sister by grappling her sister to the ground, and soon, they're both letting out tiny giggles.\n\n", false);
            this.outputText("You lie back and your exhaustion finally begins to get the better of you when combined with the contentment from seeing your babies enjoying themselves.  Your eyelids begin to droop, and before you know it, you've slipped into unconsciousness.  You awaken later on, a sticky feeling between your legs to go with your wet pussy", false);
            if (this.player.hasCock())
                this.outputText(" and raging hard on", false);
            this.outputText(".  After remembering where you are, the next thing you notice is the absence of your drider children.  Only a pile of empty, broken egg shells and some messy webbing in the trees remain.  As you stand up and prepare to move on, the sun reflecting off something in the corner of your eye catches your attention.\n\n", false);
            this.outputText("Between two nearby trees is a large spider web.  While not out of the ordinary, when the sunlight hits it at a certain angle the gossamer strands spell out a simple message:  \"<i>THANK YOU MOMMY.</i>\"", false);
            this.player.orgasm();
        }
        ...
        buttFuckADriderOhBaby() {
            ...
            this.outputText("Now that she's calmed down, you give her a hard shove, putting her on her drider-belly so you're not nearly thrown off her every other moment.  With that done, you put your hands on her human back, pushing her forward and exposing her human-like bubble-butt, seated just above where woman meets spider. Greedily, you pull her cheeks apart, revealing the tiny star of her puckered asshole.  You pull your " + this.cockDescript(x) + " out of your " + this.player.armorName + ", already hardening from the thought of you pounding her tight little backdoor.\n\n", false);
            this.outputText("\"<i>Oh, you want that hole, do you? How very kinky,</i>\" the drider chides, but you aren't fooled by her tone – you can see her anus relaxing, preparing itself for your arrival.  With a grin, you grab your " + this.cockDescript(x) + " and push it against her tight hole, leaning into the penetration until you feel it slip past her sphincter and into her hot, snug passage.  As you slide more and more of your cockmeat into her, you reach up from her cheeks and grope her breasts, squeezing her pert nipples between your fingers as you finally bottom out.  Since you can go no further up her butt, you start to piston your hips forward, slapping your hips to her ass with short, forceful strokes.\n\n", false);
            ...
            if (this.player.cockTotal() > 1) {
                ...
                if (this.player.cockTotal() == 2)
                    this.outputText(" coats", false);
                else
                    this.outputText("s coat", false);
                this.outputText(" her human back with a thick white layer of spooge", false);
            }
            this.outputText(".\n\n", false);
            this.outputText("Finally done, you pull out of the drider, collapsing on her spider-back with a contented sigh.  Completely insensate after the anal ravaging you just gave her, the drider poses no threat as you leisurely gather " + this.sMultiCockDesc() + " back into your " + this.player.armorName + " and lower yourself off her cum-soaked abdomen.  You give her a final, playful ass slap as you dismount before heading back to camp.", false);
            if (this.silly())
        ...
        driderVagSmartFuck() {
            ...
            var y = x + 1;
            this.outputText("You keep your distance from the downed spidermorph, still wary of her dripping, toxin-coated lips despite her weakened state and your own rising desire to breed her.  Trailing your eyes over her sweaty, splayed body you feel a familiar rush below the belt, your hardening [cock " + y + "] pressing against the inside of your [armor] as her breasts rise and fall seductively with each panting breath.  Desire threatens to overpower your caution as your gaze lingers on the vulnerable woman before you, her netherlips ");
            if (this.monster.HP < 1)
                this.outputText("parted slightly and glistening with beads of sweat from the adrenaline of battle.");
            else
                this.outputText("stuffed with her fingers, femcum streaming down the front of her spider-half as she desperately plays with herself.");
            this.outputText("  The need to bury your aching length inside that puffy snatch is almost unbearable, but you don't want to risk exposing yourself to any of her tricks, especially considering how close you'd be to her mouth as you take her.  Racking your brain for a solution, the mass of webbing that covers the canopy around this area catches your eye.");
            if (this.player.tailType == appearanceDefs_1.TAIL_TYPE_SPIDER_ADBOMEN) {
        ...
        driderTiedUpPartTwo(useItem) {
            ...
            if (!useItem)
                this.outputText("Shifting yourself, you withdraw your hand from her quivering slit, reaching back to collect another handful of stretchy silk.");
            else
                this.outputText("Reaching back into your pack, you grab the remainder of the bundle of silk that you tied the girl's hands with.  Looking over the mass of white-grey strands, you smile as you see that there seems to be more than enough left for what you have in mind.");
            //New Page
        ...
        driderTiedUpPartFour() {
            ...
            //(if (30 =< corruption < 70)
                ...
                this.outputText("You make sure she's comfortable before checking her for anything that could help your quest.  She stirs slightly as your hands caress her, eyes fluttering drunkenly as she tries to focus on you.  Something in the way her eyes bore into you fills you with a sense of shame at having taken advantage of her and you quickly sever her bonds, reasoning that she'll still be too weak to try anything.");
    ...
    exports.CorruptedDriderScene = CorruptedDriderScene;
});
//# sourceMappingURL=CorruptedDriderScene.js.map