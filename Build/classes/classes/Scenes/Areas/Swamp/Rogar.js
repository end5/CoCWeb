define(["require", "exports", "../../../BaseContent", "../../../GlobalFlags/kFLAGS", "../../../../../includes/appearanceDefs", "../../../StatusAffects", "../../../CockTypesEnum", "../../../PerkLib", "../../../GlobalFlags/kGAMECLASS"], function (require, exports, BaseContent_1, kFLAGS_1, appearanceDefs_1, StatusAffects_1, CockTypesEnum_1, PerkLib_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Rogar extends BaseContent_1.BaseContent {
        get telAdre() {
            return kGAMECLASS_1.kGAMECLASS.telAdre;
        }
    ...
    ((Scenario 4, [Frot]))*/
        ...
        encounterRogarSwamp() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.ROGAR_PHASE] == 0) {
            ...
            //((Ro'gar phase = 1)) (edited)
            else if (this.flags[kFLAGS_1.kFLAGS.ROGAR_PHASE] == 1) {
                this.outputText("With map in hand you wander the swamp for some time, squinting at the rough scrawls Ro'gar had scribed for you.  You can't help but stop and scratch your head as you begin to wonder if you are hopelessly lost.\n\n", false);
                ...
                //((androgynous or masculine and breasts <= A-cup, libido less than 50))
                    ...
                    if (this.player.inte < 30)
                        this.outputText("leftovers from that fight in the swamp still linger on his body.", false);
                    else
                        this.outputText("it makes you wonder what Ro'gar was up to.", false);
                    this.outputText("  Ro'gar follows your gaze, then his eyes glint oddly as he snickers.  \"<i>Care ta... return the favor?</i>\"  He slyly winks at you, eyes flicking from you to the bucket and back again.", false);
                    //goto sexy choices
                }
                ...
                //((androgynous or masculine and breasts <= A-cup))
                    ...
                    //(if player has been to Tel'Adre)
                        ...
                        //(if Dirt Mc Girt = 2) 
                            ...
                            this.outputText("As you exit the door you suddenly feel a strong grip on your wrist, making you turn around.", false);
                            //(if player height is shorter than 4 feet) 
                            if (this.player.tallness < 48)
                                this.outputText("  Hands hook under your armpits to lift you up gently.", false);
                            //(if player height is taller than 7 feet)
                            if (this.player.tallness >= 84)
                                this.outputText("  A hand on your shoulder tugs you to lower your head.", false);
                            this.outputText("  Lips press to yours and you taste Ro'gar's long, orcish tongue flicking out, trying to coax its way into your mouth.  With a faint moan you open wide, locking tongues with him as your eyes close in bliss.  You wrap your arms around the orc's neck in embrace, your hands curling around to hold him near.  His own strong hands carefully settle at your " + this.hipDescript() + " roughly clenching down as his fingertips press over your " + this.buttDescript() + ".  The two tongues wrestle in your mouth before Ro'gar slowly pulls away.  \"<i>Thanks fer everythin', " + this.player.short + ".  Y'all take care.  I'll be keepin' my eyes peeled for ya.</i>\"  With his usual toothy grin he waves you off.\n\n", false);
                            this.outputText("You wander toward your camp through the swamp, making it there without any problems beside the heat in your loins.", false);
        ...
        dontWaitForRogar() {
            this.outputText("", true);
            this.spriteSelect(86);
            this.outputText("Time passes with no sign of Ro'gar.  You decide it would be a waste of time to sit and wait for him, and head off in hopes of finding something interesting.\n\n", false);
            this.outputText("Instead, you find only more mud.  You return to camp.", false);
            //<set Crying Game = 1>
            this.flags[kFLAGS_1.kFLAGS.ROGAR_DISABLED] = 1;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //((Yes))
        waitForChunkyOrcLoe() {
            ...
            this.spriteSelect(86);
            if (this.flags[kFLAGS_1.kFLAGS.ROGAR_PHASE] == 0) {
                this.outputText("It feels like several hours pass with no sign of Ro'gar, but you decide to wait and use what little cloth you have to clean yourself off.  Eventually you hear the slow trod of heavy footsteps as Ro'gar comes into view with a smile on his face and a bucket and towel in his hands.  He sets the steaming bucket down as he draws near.  \"<i>Here ya go!</i>\" he says with a grunt, dipping the towel in the bucket.  He rubs your body with the towel to wipe away the mud for you, seeming not to realize - or perhaps, not minding - the intimacy of the gesture.\n\n", false);
                //((If libido is less than 50))
                if (this.player.lib < 50)
                    this.outputText("The hulking orc is surprisingly gentle as he cleans you like a young child.  The warm waters and careful touch soothe your tired muscles.  Your skin becomes textured with goose bumps as the tickles of droplets roll down your body and the filth is washed down to the waters below.  You find yourself sighing in relaxation from the treatment.  A smile curls your lips as you look down at Ro'gar, and he returns the pleased look with a toothy smirk.\n\n", false);
                //((If libido is 50 or more))
                else {
                    this.outputText("  Something about the burly orc rubbing you down with warm water excites you.", false);
                    if (this.player.hasVagina()) {
                        this.outputText("  Your " + this.vaginaDescript(0) + " starts to quiver as the warm water rolls over its lips, moistening in excitement as your skin is rubbed over by strong hands.  Your chest heaves as it relaxes to his touch, your " + this.nippleDescript(0) + "s becoming stiff under his rubbing.", false);
                        this.outputText("  Even your " + this.player.feet() + " and fingers curl as you smell the sweat and musk of Ro'gar's closeness, the animalistic scent arousing you.", false);
                    }
                    else if (this.player.hasCock())
                        this.outputText("  " + this.SMultiCockDesc() + " stirs to life, making it obvious how much you are enjoying the rub down, then begins to drool with lust.  Through lidded eyes you faintly make out Ro'gar's toothy smirk becoming a hungry grin.", false);
                    this.dynStats("lus", 5 + this.player.lib / 20 + this.player.sens / 20);
                    this.outputText("\n\n", false);
                }
                this.outputText("\"<i>Clean as a whistle.</i>\"  Ro'gar chuckles as he drops the towel in the bucket with a splash.  His face beams with pride at his work, chest puffing out as he looks you over.  He eyes you up and down again, and your curious look just makes him snicker.  \"<i>Don't meet too many friendly folk 'round here, but it would be nice to have a " + this.player.mf("feller", "lass") + " to talk with.</i>\"  After a few moments of awkward rummaging through his pocket he pulls out a scrunched up piece of paper and hands it to you.  \"<i>This's so you can find me.</i>\"  Ro'gar grins from ear to pointy ear.  You unfold the paper, and see a crudely drawn map that vaguely explains how to get to Ro'gar's hut.  You wonder if making this map was why he took so long.  \"<i>Y'all take care now, y'hear!</i>\" he hollers, turning summarily and walking away, waving over his shoulder at you as he tromps through his natural habitat.  You wander back to your camp, wondering if you should see him again.\n\n", false);
                this.outputText("<b>You can now find Ro'gar's hut when wandering the swamp occasionally!</b>", false);
                //pass 2 hours, set Ro'gar phase flag = 1
                this.flags[kFLAGS_1.kFLAGS.ROGAR_PHASE] = 1;
                this.doNext(this.camp.returnToCampUseTwoHours);
            }
        }
        //sexy choices
        ...
        noSlowBroIDontWantPokeSex() {
            ...
            this.flags[kFLAGS_1.kFLAGS.ROGAR_DIRT] = 1;
            this.flags[kFLAGS_1.kFLAGS.ROGAR_PHASE] = 2;
            this.doNext(this.camp.returnToCampUseTwoHours);
        }
        //((Ok))
        okayBroLetsHaveAGayCarwash() {
            ...
            if (this.player.gender > 0)
                this.outputText(", drooling", false);
            ...
            this.flags[kFLAGS_1.kFLAGS.ROGAR_DIRT] = 2;
            this.flags[kFLAGS_1.kFLAGS.ROGAR_PHASE] = 2;
            if (this.player.inte < 30)
                this.doNext(this.camp.returnToCampUseTwoHours);
        ...
        rogarThirdPhase() {
            ...
            if ((this.player.biggestTitSize() >= 2)) {
                if (this.flags[kFLAGS_1.kFLAGS.ROGAR_WARNING] == 0) {
                    this.outputText("Judging the patron's figure based on how imposingly filled out the cloak is, he or she is clearly very muscled.  You spy a green hand reach for a can and a spark of recognition hits you.  You're completely unsure how to break the ice, but tug on the hem of the cloak.  The figure turns toward you, and you're greeted with the green, toothy smile of Ro'gar, the orc from the swamp!  \"<i>H'lo, " + this.player.short + "!  I'm s'rprised to see ya here...</i>\"\n\n", false);
                    this.outputText("You greet him warmly, but he seems a bit nervous around you.  \"<i>Well... after all ya tol' me about yer adventures, I, ah, thought I'd hit the road m'self.  An' so ya find me here.  Good ta see ya again, but I'm just finishin' up my drink afore I head on out.</i>\"  With this, he tips back the contents of his can and flashes you his standard grin, then departs.  He seemed a bit uneasy around you.", false);
                    //set Ro'roh Raggy flag to 1
                    this.flags[kFLAGS_1.kFLAGS.ROGAR_WARNING] = 1;
                }
                //(high fem or breasts >=B-cup and Ro'roh Raggy =1)
                else {
                    this.outputText("Ro'gar the orc is here drinking again, but as you catch his eye, a pained expression flashes across his face.  It's clear he doesn't relish the prospect of talking to you right now, but knowing him, he's too polite to say so.  The wind spills from your sails and your icebreaker slips from your mind - answering him with a simple glance of resignation is the most you can manage.  He gives you a weak smile and returns to his drink.\n\n", false);
                }
                //return to bar menu
            ...
            //((androgynous or masculine and breasts <= A-cup))
                ...
                //(else if Dirt Mc Girt = 2)
                    ...
                    this.outputText("Your heart flutters as you realize he is still only wearing the ragged shorts beneath his hooded cloak, and your eyes rake over his musculature as he models.  \"<i>How's about you an' I go visit the baths sometime?</i>\"  Ro'gar asks coyly, relaxing his body as he takes another drink.  \"<i>You been nothin' but good ta me ever since I met ya, " + this.player.short + ".  I do ya one favor and you been a real friend ever since.</i>\"  Ro'gar's tone grows lower and more serious as a calloused finger rubs over his damp can.  You rest your arms against the polished wood of the bar as you listen.  \"<i>Yer special ta me.</i>\" he mutters quietly, just loud enough for you to hear him.  You smile warmly and rest a hand against his arm, coaxing him to turn his head to look at you.  His tongue slides over his lips as he gives you a seductive stare, with his hand reaching between your legs.", false);
                    //[(female or unsexed)
                    if (this.player.gender == 2 || this.player.gender == 0) {
                        this.outputText("  It stops on your bare mons, and Ro'gar's eyes widen.  \"<i>Wh-wha... there's nothin' here!</i>\"  You color and nod.  His mouth hangs open for a long minute, then he masters himself.  \"<i>Well... I, uh, guess it was good t' see ya again...</i>\" he stammers.  \"<i>Hey, I'm sure you've got things to be doin' so I won't hold you up.</i>\"  As you attempt to protest, he chugs his drink and makes a show of slamming the can down, noisily and forcefully, on the bar.  Nodding at you, he pulls the cloak over his head and leaves the bar.  Apparently it was quite a shock to him.  You wonder if he'll avoid you from now on...", false);
                        this.flags[kFLAGS_1.kFLAGS.ROGAR_DISABLED] = 1;
                        this.doNext(this.camp.returnToCampUseOneHour);
                    }
                    else {
                        this.outputText("  " + this.SMultiCockDesc() + " gets a caress from him as he explores, arousing it to mild stiffness.  \"<i>" + this.player.short + ",</i>\" he grunts.  \"<i>Ah hope ah'll be seein' more of ya.</i>\"  Ro'gar breaks the contact and tips back the remains of his drink while you ", false);
                        if (this.player.cor < 50)
                            this.outputText("blush", false);
                        else
                            this.outputText("fantasize about those strong hands touching every part of you", false);
                        this.outputText(".  I drink here whenever I'm not werkin' out or on a job.  I'll be waitin' for you.</i>\"  He lowers his eyelids suggestively at you, then gets up; you smile dumbly as he leaves the bar, watching him go with a blush in your cheeks", false);
                        //[(If player has a tail)
                        if (this.player.hasLongTail() && this.player.isNaga())
                            this.outputText(", and you feel your tail flicking rapidly in excitement", false);
                        this.outputText(".\n\n", false);
        ...
        rogarPhaseFour() {
            ...
            if ((this.player.biggestTitSize() >= 2) && this.flags[kFLAGS_1.kFLAGS.ROGAR_WARNING] == 0) {
                this.outputText("Ro'gar the orc is drinking at the bar again, two crushed cans sitting by his half-empty one.  The bartender is casting irritated glances at them as though she'd like to throw them away, but doesn't dare take them from the enormous, burly orc until he finishes or leaves.  You tug on his cloak as you take a seat next to him, and he turns to you with a toothy smile.  That smile dims to a frown as he looks you over, eyes lingering on the womanly contours of your face", false);
                if (this.player.biggestTitSize() >= 2)
                    this.outputText(" and your " + this.chestDesc(), false);
                this.outputText(".  \"<i>Gee, ya look... different.  Been samplin' some of the local foods, huh?</i>\"  You agree cautiously, and he flags the bartender over and buys you a drink.  \"<i>I'm just bein' polite since we're pals,</i>\" the orc ventures.  \"<i>Ya kin pay me back another time.</i>\"  You nod, sip your drink, and converse reservedly with him for a while, then go on your way.", false);
                //set Ro'roh Raggy = 1
                this.flags[kFLAGS_1.kFLAGS.ROGAR_WARNING] = 1;
                this.doNext(this.camp.returnToCampUseOneHour);
            }
            //(high fem or breasts >=B-cup and Ro'roh Raggy =1)
            else if ((this.player.biggestTitSize() >= 2) && this.flags[kFLAGS_1.kFLAGS.ROGAR_WARNING] == 1) {
                this.outputText("Ro'gar the orc is here drinking again, but as you catch his eye, a pained expression flashes across his face as he looks over your form.  It's clear he doesn't relish the prospect of talking to you right now, but knowing him, he's too polite to say so.  The wind spills from your sails and your icebreaker slips from your mind - answering him with a simple glance of resignation is the most you can manage.  He gives you a weak smile and returns to his drink.", false);
                //return to bar menu
                this.doNext(this.telAdre.barTelAdre);
            }
            //(andro or masculine with tits <= A)
            else {
                this.outputText("Ro'gar is tipping his drink back when he catches sight of you, and waves you over.  \"<i>Ah, good ta see ya, " + this.player.short + "!", false);
                //[(Ro'roh Raggy = 1)
                if (this.flags[kFLAGS_1.kFLAGS.ROGAR_WARNING] == 1) {
                    this.outputText("Yer lookin' much better today; ya been workin' out?</i>\"  You smile at the compliment, and ", false);
                }
                else
                    this.outputText("</i>\"  You ", false);
                this.outputText("wave the bartender over for another round.  \"<i>So,</i>\" he begins once you've finished your drinks and she's out of earshot, \"<i>I was wonderin' if ya would like to hang out at my place later?  It ain't much, but it'd be a lot more... private... than here.</i>\"  He colors slightly and waggles an eyebrow at you, then slides a hand into your groin.", false);
                //[(if F or U)
                if (this.player.gender == 2 || this.player.gender == 0) {
                    this.outputText("  It reaches the center without interruption, and Ro'gar colors deeper.  \"<i>Uh... ferget it,</i>\" he mumbles.  \"<i>Didn't mean ta be indecent with you or anythin', miss.</i>\"  He nods to you and quickly departs before you can recover from the surprise.", false);
                    this.doNext(this.camp.returnToCampUseOneHour);
                }
                else {
                    this.outputText("  " + this.SMultiCockDesc() + " trembles under his strong touch, as he increases the pressure and looks into your eyes meaningfully.  ", false);
                    //[(if Dirt Mc Gurt flag = 1)
                    if (this.flags[kFLAGS_1.kFLAGS.ROGAR_DIRT] == 1)
                        this.outputText("</i>\"I know ya probably ain't ever imagined hangin' out with a feller like me, but... I could really use the company tonight.</i>\"  ", false);
                    this.outputText("He's clearly in the mood for some fun; do you want to head back to his place and do something?", false);
        ...
        rogarFuckMenu() {
            ...
            if (this.player.hasItem(this.consumables.BROBREW))
                brodown = this.brobrobrobro;
            if (this.player.hasCock()) {
                giveAnal = this.fuckRogarsButtPussyBoyCuntManMoundSissySlitQueerQuim;
                getAnal = this.loseButtGinity;
                frot = this.frotWithRogar;
                getTied = this.kinkyWithDaOrc;
                rubdub = this.rubdubWithDaOrcWithoutDucky;
            }
            this.menu();
            this.addButton(0, "GetAnal", getAnal);
            this.addButton(1, "GiveAnal", giveAnal);
            this.addButton(2, "Frot", frot);
            this.addButton(3, "BroDrink", brodown);
            this.addButton(4, "GetTiedAnal", getTied);
            this.addButton(5, "OrcRubDown", rubdub);
        ...
        noTHanksRogarIAintGayDudeIjustLickedThatMudToBeNice() {
            this.outputText("", true);
            this.spriteSelect(86);
            this.outputText("You smile at the orc, but tell him that you're not really in the mood to hang out right now.  He looks crestfallen, but nods at you.  \"<i>Well, I understan'.  I'll be seein' ya later, then.</i>\"", false);
            //Bar menu!
            this.doNext(this.telAdre.barTelAdre);
        }
        //(([Get Anal], Scenario 1a: give up the buttcherry (buttvirgins only)))
        loseButtGinity() {
            this.flags[kFLAGS_1.kFLAGS.ROGAR_FUCKED_TODAY] = 1;
            this.outputText("", true);
            this.spriteSelect(86);
            //BUTTCHERRIES
            if (this.player.ass.analLooseness == 0) {
                this.outputText("You nod eagerly, and the orc rewards you with another caress.  \"<i>Well then... let's head on out,</i>\" he says.  The two of you walk down the desert city's streets until you reach a discrete, out-of-the-way building labeled 'Steel Hogan Apartments'.  \"<i>This here's where I'm stayin',</i>\" Ro'gar says, handing you through the doorway.  He leads you down a hallway to his own lodgings, then pushes open the door for you; you step ", false);
                if (this.player.cor < 33)
                    this.outputText("shyly ", false);
                else if (this.player.cor > 66)
                    this.outputText("eagerly ", false);
                this.outputText("over the threshold, and then look around the apartment.  He points out the small kitchen area and then, rather sheepishly, the bedroom.  You're examining it when something catches your eye...\n\n", false);
                this.outputText("You bend over the bed to grip a small bottle lying in the soft fabric of the sheets.  Turning it over, you tilt your head as you read the label.  It's... a bottle of lubricant.  Suddenly, there is a loud thud behind you and the bottle drops from your hand as your torso is pressed into the cushioned surface of the bed.  Something presses into your back.  \"<i>Gotcha...</i>\" the familiar voice snickers in your ear.  Ro'gar's head leans over your shoulder and a long, orcish tongue licks your cheek.  \"<i>Was waitin' for this...</i>\" he purrs; the resonance of his voice rumbles against your ear.  Ro'gar chuckles and grips around your wrists.  \"<i>Now that yer here, it's time ta break in this here new bed with sumthin' I've been cravin' since I washed ya down in that swamp, boy.</i>\"  Ro'gar's tone suddenly takes a demanding, hissing tone.  His tongue flicks over your ear as he speaks.  Your skin begins to grow goosebumps as shivers crawl down your spine.\n\n", false);
                this.outputText("He yanks your wrists behind your back, ignoring your faint gasps.  With a rustle of cloth, your wrists are bound together behind your back tightly; your fingers feel over the bonds but you struggle against them in vain.  Looking over your shoulder in confusion at Ro'gar, you only see his lust-ridden face dipping down to kiss at your lips.  His tusks press against your cheeks with a demanding snarl and his tongue into your mouth; your " + this.buttDescript() + " receives a smack, forcing you to yelp.  His tongue quickly invades, and his free hand unfastens your " + this.player.armorName + " to strip you forcefully.  Rough, calloused fingers dance over your body and fasten onto your " + this.nippleDescript(0) + "s, coaxing moans from your throat with each pinch.  Your pleased noises are muffled by Ro'gar's mouth, his tongue and lips hushing each whimper and gasp you breathe.  A bare, firm chest presses against your exposed back, and you pant as the heat from his body burns against you, only intensified by the thin layer of oil on his skin.  Ro'gar's blue eyes watch you like a predator as your face flushes.  He breaks the kiss and cups his hands under your chin to hold your face in place.  \"<i>Such a perdy face yer makin', " + this.player.short + ".  Yer lookin' at me like a proper slut, an' it's makin' me hard seein' ya so needy to be bred.</i>\"  He growls in his throat as his mouth nips over your neck, leaving red marks along your skin where his tusks rub against you.  You can feel the oil and sweat smearing over your back, and your senses go wild.  The room is soon filled with your needy whimpers as " + this.sMultiCockDesc() + " oozes and throbs against the sheets, making the fabric damp with your lust.\n\n", false);
                this.outputText("With an abrupt grunt you feel hands gripping your " + this.hipDescript() + " and pulling your rear into the air, making you balance on your face and knees.  Ro'gar begins to play with your " + this.buttDescript() + "; each hand massages a cheek between his fingers, squeezing and kneading them apart.  A finger rubs over your sensitive entrance and you shudder softly.  The orc tests its resistance with his finger, pressing in and threatening to penetrate, rubbing harder around the tight, puckered flesh.  Your virgin hole's taut flesh remains resistant to all the coaxing Ro'gar's finger lavishes on it. \"<i>Tarnation, " + this.player.short + ".  You're so tight...</i>\"  You feel your cheeks blush with bright color and in a low voice you admit you've never had anyone inside you.\n\n", false);
                this.outputText("It's as if time freezes: everything stops, including your erstwhile lover.  The only sound in the room is your own breath for almost half a minute, until Ro'gar rolls you over by your " + this.hipDescript() + ", forcing your body to lay out over your back.  The orc's face comes down close enough that you feel his breath washing over your skin.  \"<i>You serious?</i>\" he asks with eagerness you've never seen before.  Caught off guard, you simply nod your head as his eyes go wide.  With a rip you hear the shorts torn from Ro'gar's body.  You feel his hot, throbbing length grinding over your " + this.buttDescript() + " before you see it, the deep green head towering over your groin menacingly, each vein pulsing as the mammoth cock belches pre-cum to leak down the orcish shaft.  Your skin is soon slick with his spurting pre as he groans out.  \"<i>Oh fuck... a bona-fied virgin ass.  Pure an' untainted, ripe for the pluckin'... or maybe the fuckin'.</i>\"  Ro'gar's breath becomes labored as he pants heavily and eagerly, his green length humping against your virgin rosebud, making you moan out in an excess of sensation.  His hands hold your cheeks apart with a strong grip as you begin to leak your own pre-cum onto your stomach.", false);
                //(if player has balls) 
                if (this.player.balls > 0)
                    this.outputText("  Ro'gar's dark green cockhead rubs over your " + this.ballsDescriptLight() + " and coats the plump sack in his musky goo, like an alpha male marking his territory.", false);
                this.outputText("\n\n", false);
                this.outputText("Deep, guttural hisses echo out from the orc.  \"<i>Easy fella...</i>\" Ro'gar mutters, trying to restrain himself from ripping you apart with his fat cock.  He leans down and kisses you softly before continuing.  \"<i>I'll give ya a proper first time, all gentleman-like.</i>\"  With a playful wink he gets down on his knees, squatting near the foot of the bed.  His hand hoists your " + this.hipDescript() + " up to his mouth.  You can feel him kiss your tight ring, and soon a warm sensation shoots up your spine, causing you to moan.  His hot, slick tongue swirls over your puckered flesh, slathering your hole while his tusks rub along your cheeks.  You're left panting out hot, needy breaths as Ro'gar works over your virgin anus, his tongue gently easing your tight ring of flesh open.  The pleasure makes your legs go limp over his shoulders and your eyes shut in a blissful daze.  Ro'gar's wet slurps and growls make your ears twitch, and you feel him slowly press in with his orcish tongue, beginning to tonguefuck your entrance forcefully.  With patience, your pucker gives in under Ro'gar's touch and his tongue slides into your untouched confines.  You give a sharp gasp, this strange feeling overwhelming you as you flick your eyes open.  Your " + this.buttDescript() + " wriggles in pleasure around his tongue, and the orc gives a pleased grunt as his tongue swirls around your inner walls, sliding out to pull your lime flavor into his mouth before roughly thrusting back in.  Your back arches as you cry out a surprised moan.", false);
                if (this.player.hasLongTail() || this.player.isNaga())
                    this.outputText("  Your tail wraps around Ro'gar's arm for some sort of stability, the tip flicking lazily as it coils and squeezes around a bicep.", false);
                this.outputText("\n\n", false);
                this.outputText("Ro'gar produces harsh snarls, eagerly tonguefucking you, eating you out as his lips work over your ass.  His fingers grip your " + this.hipDescript() + " roughly as he ravages your hole in a manner beyond your wildest dreams.  You hear slapping as Ro'gar's hips smack involuntarily against the side of the bed.  His aching erection drools globs of thick slime over the sheets, barely restraining his desire to fuck you senseless.  \"<i>Relax!</i>\" Ro'gar barks in a commanding tone that shocks you.  You try to comply with a whimper, feeling something pressed against you.  Ro'gar's fat finger prods your spit-slicked pucker, slipping in with a wet shlick.  You shudder as his digit slides into you with some resistance, but the relentless finger rubs over your walls as he begins to pull your rim open, forcing another finger inside and making you bite your lip from the stinging sensation.  Working the pair of fingers together inside of you, he slowly moves them apart and stretches your hole wide.", false);
                this.outputText("  Fingers and " + this.player.feet() + " curl in pleasure as your previously untouched boycunt is forced open by Ro'gar's steady coaxing.", false);
                this.outputText("  You hear the pop of a corked bottle, and soon the cool, slippery lubricant pours over your puckered entrance and taint.  After the twin fingers have worked you loose enough a third slides in, the three digits picking up speed as they push in deeper and open you wide.  The strange feeling drives you wild for reasons you don't understand. It just feels so good and new, and your seed pools on your stomach, drolling down your sides to stain the sheets below.  Ro'gar gets up on the bed, looming over your aroused form as his fingers continue pumping into you.  You glance down through the haze of pleasure to see his massive erection.  It seems bigger than you remember, the head leaking a steady stream of spunk to hint at his production.  \"<i>Ready fer yer cherry poppin', boy?  I got you nice and spread.</i>\"  Blue eyes look over your arousal, and you can only shiver under his gaze.  \"<i>I reckon yer enjoyin' yerself,</i>\" he says with a growl, and continues to drive your body wild with lust and strange, new sensations.  \"<i>I've been bidin' my time now, but I'll take that cherry of yers, an' I'm goin' to savor every last drop until ya burst.</i>\"\n\n", false);
                this.outputText("A groan escapes your lips as his fingers slide from your pucker.  His strong hands lift your backside, raising your lubricated hole to a suitable level; you lay completely exposed before him as he shifts his hips to line himself up with your virgin pucker.  The head of his monstrous cock presses against your loosened boycunt, dripping with need as he steadily forces the tight hole.  Your teeth clench as he stretches you wide around his length, though he continues without hesitation, and finally you cry out with the sting of the bulbous head squeezing into your tiny hole, though it falls on deaf ears as Ro'gar merely groans at your virgin tightness.", false);
                this.player.buttChange(25, true, true, false);
                this.outputText("  Another whimper escapes your lips as you feel the orc's gigantic cock stretch you much farther than his tongue or fingers.  Despite the pain, your body submits under the girthy cock without a choice, and soon your once-virgin hole is large enough for what will ensue.  \"<i>When I'm done with you, you'll be a proper cock sleeve, boy.  Perfect fer me to breed.</i>\"  He chuckles and licks your face with his warm tongue.  With most of his thick length nestled in you, Ro'gar pulls back to his cockhead only to thrust in again, steadily working more and more of himself inside.  Your whimpers begin to die down and the sting fades with them.  The heat and feeling of his dripping spunk, warm against your walls begin to overwhelm you.  Feeling him claim your untouched insides makes you moan out in bliss.\n\n", false);
                this.outputText("Your mind races with Ro'gar's words as they seemed to be coming true.  You can't help but focus on the wonderful feeling of Ro'gar's cock throbbing within you.  Maybe this is where you belong?  With your tight ass impaled on Ro'gar's massive tool?  You moan loudly as Ro'gar picks up the pace, hips ramming into you with enough force to shift your body over the sheets.  He really starts to break in your hole with huffed grunts and groans as he hilts in you; his cockhead prods your prostate with each thrust, causing you to cry out as electric shocks shoot up your spine.  Every nerve in your body lights up like a Christmas tree and make your entire body squirm with pleasure.  You feel spurts of cum begin to leak from your " + this.multiCockDescriptLight() + " and glaze your belly with pre-cum.", false);
                if (this.player.hasLongTail() || this.player.isNaga())
                    this.outputText("  Your tail, still gripping Ro'gar's arm, squeezes tight.", false);
                //(If player has balls) 
                if (this.player.balls > 0)
                    this.outputText("  Your " + this.ballsDescriptLight() + " clench sharply as you feel your climax nearing.  \"<i>Found your button, boy,</i>\" Ro'gar snickers as he rubs his cock over your prostate, the hot meat working over your body in ways you didn't even know about.  You feel completely at the large orc's mercy.  \"<i>Cum for me,</i>\" he growls as his lips press over yours, opening your mouth wide as he invades and thrusts his tongue in fellowship with his dick.  His hips pound against you, ballsack slapping your upturned cheeks with each thrust as he rams your trigger over and over.  You moan into the orc's mouth and coat yourself in your own spunk, your brain hazy from the blissful, oozing orgasm.  Your front is dripping with your cum, as Ro'gar continues to abuse your broken-in boycunt.\n\n", false);
                this.outputText("\"<i>So fuckin' tight...</i>\" Ro'gar snarls as he nears his limit.  \"<i>Time fer yer first proper breedin', boy!</i>\"  His voice makes his chest rumble as he pants hot breath that caresses your face.  The sound of smacking skin rings in your ears, and you briefly note that your " + this.buttDescript() + " feels red and sore from Ro'gar's hips beating against them before closing your eyes to another pleasurable thrust.  With a harsh snarl his jaw bites down on your shoulder possessively as his swollen sack tightens.  Soon your lower body is flooded with a warmth you've never felt before.  Ro'gar's seed fills you completely as the musky load coats and stains your once-pure hole.  A pressure builds within you, the wet spunk spurting from your rim to drip down your upturned ass cheeks.  Ro'gar's huffs exit through his clenched teeth as he rides out his orgasm, pumping into you a few more times until he's deposited every last drop from his heavy balls.\n\n", false);
                this.outputText("With a sigh of exhaustion his jaw unlatches from your shoulder and he lies on the bed next to you.  The pair of you take a moment to catch your breath.  The only sounds you hear are the sounds of labored exhalation until Ro'gar sits up.  You hear a clicking nearby and you raise your head to see Ro'gar drinking from a tin can.  Sitting up yourself causes Ro'gar turn to meet your gaze.  \"<i>You don't hafta say anything.  I tend ta get carried away with these kinds'a things.  Hearing 'bout yer virgin ass...  Hoo-wee!</i>\"  He gives a nervous chuckle as you answer with a tired grin.  He unties your hands and takes another sip of his drink.  \"<i>So uh... did ya-</i>\"  The question is interrupted as you peck an affectionate kiss against his tusk, then his lips.  \"<i>Right,</i>\" he laughs and then rubs the back of his neck with a hand.  \"<i>No need for mushy talk then.  You hafta go.  Don't worry, I understand.</i>\" Ro'gar helps you get up and round up your gear, so hastily scattered in his fervor.  He follows you to the door.  \"<i>Take care now, y'hear?  And, " + this.player.short + "... come see me soon, alright?</i>\"  Ro'gar smiles from the door and waves a hand, watching you leave.  You wander back into the city exhausted.\n\n", false);
                //<Lust sated, slimefeed>
            }
            //(([Get Anal] Scenario 1b: Get fucked (normal)))
            else {
                this.outputText("You nod eagerly, and the orc rewards you with another caress.  \"<i>Well then... let's head on out,</i>\" he says.  The two of you walk down the desert city's streets until you reach a discrete, out-of-the-way building labeled 'Steel Hogan Apartments'.  \"<i>S'about time you came home with me, " + this.player.short + ".</i>\"  He pushes the door open and steps inside, disappearing down a hallway.  \"<i>How's about you come siddown?</i>\" he calls, and you follow the sound of his voice.  One of his large hands rests against his leg, which parts from the other to draw your gaze between them.  The orc is already bereft of his tiny shorts, his nude body nestled in a couch and beckoning you over.  His exposed member hangs limp over his impressive sack.  You press your lips together in thought, feeling warmth grow in your loins.\n\n", false);
                this.outputText("You can't help but feel hesitant as you draw near, but your lusts aren't willing to refuse the offer. You sit astride Ro'gar's leg, with your thighs clasping the mighty muscle that makes up his.  Ro'gar snakes an arm around your waist and tugs you closer, pressing you against his chest.  \"<i>That's a good boy.  Now how's about a kiss?</i>\"  He chuckles as he reaches a hand under your chin, tilting your face to meet his.", false);
                if (this.player.tallness >= 84)
                    this.outputText("  You lean down as Ro'gar tilts up, your lips connecting with his, both mouths open to let tongues wrestle.", false);
                //(If player height is less than 7 feet)
                if (this.player.tallness < 84)
                    this.outputText("  You lean up into Ro'gar's mouth, his hand caressing your cheek.", false);
                this.outputText("  You can feel his demanding tongue pressing into your mouth and coaxing moans from the wanton entrance.  His hand slides down your waist to cup your " + this.buttDescript() + " in his strong grip.  Ro'gar breaks the kiss with a devious grin.  \"<i>Let's get you out of these clothes.</i>\"  His voice rumbles deep in his chest, the resonations vibrating against your skin.  He takes the initiative and pulls off your garments, leaving you completely nude in his lap.  One of the orc's hands wanders over your body, playing with your nipples while the other slides down toward your " + this.multiCockDescriptLight() + ".  Ro'gar's head nestles in the nape of your neck, gently nipping at your skin and reddening it with a slight sting.  Where he nibbles he quickly follows with a tender lap of warm tongue over the abused flesh, bringing slight shudders through your body as his smooth tusks rub over you.\n\n", false);
                this.outputText("You are left panting for breath from Ro'gar's continued teasing, your skin on fire from every touch as his thin oil smears over it.  You spread your legs lewdly on Ro'gar's lap, blood rushing south as you feel yourself stiffen and throb - though you aren't the only one sporting wood, as you soon feel Ro'gar's hot manhood pressed up to your side.  He groans into your shoulder, bucking his hips to hump your flesh.  Pre-cum dribbles from Ro'gar's swollen cockhead and smears you in his need.  \"<i>Come here,</i>\" he whispers directly into your ear.  His hands grip your bottom as he pulls you closer to face him.  Your chest presses to his as you straddle Ro'gar's hips.  Ro'gar's throbbing ten inches of man meat tucks between the cheeks of your " + this.buttDescript() + ". He gives you a playful wink, bucking his hips to bounce you in his lap.  The feeling of his hot, thick length rubbing over your " + this.assholeDescript() + "  and wetting it with copious pre makes you gasp like a bitch in heat.  The dripping orc spooge snakes down in between your cheeks, and you feel your body shudder with anticipation; Ro'gar lets the liquid pour over his own hard-on.  \"<i>My favorite boy ready for the ride of his life?</i>\"  He grins impishly as he grips the head of his thick, uncut orc cock and pushes it against your boy cunt.  A gasp of pleasure escapes your lips and your hands clasp onto Ro'gar's shoulders, wriggling your " + this.buttDescript() + " over the green mile.\n\n", false);
                this.outputText("With a buck of Ro'gar's hips his slick cockhead slips into your " + this.assholeDescript() + ".  Your lips part wide, letting out a sharp gasp as he nestles within you.  \"<i>Git ridin', boy!</i>\" he barks, with a hard smack against your " + this.buttDescript() + ".  You yelp at the rough treatment, easing yourself down slowly to slide Ro'gar's stiff flesh further into you, and feel yourself growing hard as the throbbing manhood stretches you open.  " + this.SMultiCockDesc() + " swells with blood as it brushes against Ro'gar's stomach, and the sensitive urethra picks up a thin layer of his slime from his skin, making you burn with sensitivity.  Your hips shift into Ro'gar's body more, rubbing your " + this.multiCockDescriptLight() + " tightly against him.", false);
                if (this.player.cockTotal() > 1) {
                    this.outputText("Lines of pre-cum are drawn with your erections, adulterating the sweat and oil on Ro'gar's body as you bob your hips along Ro'gar's mast.   ", false);
                }
                this.outputText("Your spunk dribbles over Ro'gar's green skin and collects in his navel as his mouth attacks your neck with an assault of nips and licks, each nibble rubbing his tusks over your sensitized skin.  Hands roughly grip your " + this.buttDescript() + ", spreading your cheeks apart manually and kneading the flesh like dough.  He coaxes you to move faster with demanding nudges of your hips, growling deeply with each thrust of his cock inside you.  Hot fluid sticks to your inner walls, arousal making you buck your hips helplessly as you become more and more sensitive with each thrust.  You're soon bouncing up and down on Ro'gar's prick, and to further your wild ride, Ro'gar begins bucking his hips up to meet your " + this.buttDescript() + ".\n\n", false);
                //[(If player is fat or has very defined muscles)
                if ((this.player.thickness >= 75 && this.player.tone < 33) || this.player.tone >= 75) {
                    this.outputText("Riding Ro'gar's stiff manhood as fast as you can muster, you drive the orc man wild with need.  His thick girth stretches your " + this.assholeDescript() + " wide around it, making you a wonderful sleeve for his orc cock.  He hilts within you, and you cry out in pleasure as his cockhead rams your prostate.  Ro'gar wrests control from you as he hears you cry out like a bitch in heat.  His strong hands at your " + this.hipDescript() + " hold you in place as he pounds your " + this.assholeDescript() + ", ramming against you with brutal force and making you moan loud enough that your voice grows a little hoarse.  " + this.SMultiCockDesc() + " twitches from the abuse to your trigger", false);
                    if (this.player.balls > 0)
                        this.outputText(" and your " + this.ballsDescriptLight() + " clench tight as you feel your limit reached", false);
                    this.outputText(".", false);
                    //[(if player has toes)
                    this.outputText("  You curl your fingers and " + this.player.feet() + " in ecstasy as Ro'gar drives you over the edge.", false);
                    this.outputText("  Your bucks become ragged, and the orc takes over as " + this.sMultiCockDesc() + " jerks and spasms, shooting out countless ropes of sticky spunk onto the glistening green skin, painting the orc white with your lust.  With a low, deep, tone, Ro'gar groans out as you feel his warmth overtake your lower body, flooding you full of his fertile man cream.  Ro'gar continues to fuck you with decreasing vigor, slowing to a stop as his spent cock pops from your drooling pucker.  His spunk floods out of your filled boycunt, the spooge running down Ro'gar's half-hard cock to drip onto the floor lewdly.\n\n", false);
                }
                //(else)
                else {
                    this.outputText("\"<i>Enough horsin' around.</i>\"  Ro'gar snarls as his arms quickly yank back, sneaking under your legs and hoisting you up as he gets to his feet.  You grip Ro'gar's shoulders tight as he lifts you with a strained grunt.  You delight with sharp little moans as he begins to fuck you skyward, bouncing you off of his hips with each slam of his cock into you.  Slowly Ro'gar steps towards a wall, taking his time to be sure not to drop you, and you soon feel the cool surface pressed to your back.  Caught between a cock and a hard place, you stare into Ro'gar's predatory gaze as he holds you hoisted in the air and pinned, making you feel vulnerable.  The orc takes advantage of you and begins to abuse your " + this.assholeDescript() + ", making your head tilt back to moan out helplessly.", false);
                    this.outputText("  " + this.SMultiCockDesc() + " lays out over your chest, dribbling pre-cum on your skin as you make a mess of your torso in lust.", false);
                    //[(if player has tail) 
                    if (this.player.hasLongTail() || this.player.isNaga())
                        this.outputText("  Your tail flicks helplessly below you, urgently wrapping around Ro'gar's thigh and trying to pull him deeper into you.", false);
                    this.outputText("  You cry out as Ro'gar finds your sweet spot.  \"<i>Now I got yer button, boy,</i>\" he snickers, wearing his usual predatory grin, the sharp, jagged teeth on full display as you shudder from the relentless pounding against your " + this.buttDescript() + ".  The sound of flesh smacking flesh is loud in your ears as you squirm from Ro'gar's cock.  Each thrust drives you mad with pleasure, your mind in a lust-induced haze as your prostate is prodded and poked.", false);
                    //[(If player has balls) 
                    if (this.player.balls > 0)
                        this.outputText("  You feel your " + this.ballsDescriptLight() + " pull up tight in your sack as your labored breath comes out in pants.", false);
                    this.outputText("  Ro'gar continues his savage thrusts, impaling you fully on his length; soon you cry out in ecstasy as his urgent pounding brings you to climax, spraying yourself with your own thick spunk.  Your chest is quickly coated in ropes of your own cum, glazing your torso like a delectable treat to be licked off.   Your orgasm spurs him onward, and Ro'gar crushes you between himself and the wall with each powerful thrust.  A maddened hiss sounds as he breathes through his clenched teeth, impaling you with a few sharp smacks of hips against ass, and snarls issue from the orc as you are suddenly flooded with cum.  He seems to ejaculate for an eternity, each urgent thrust pumping another bucket of jizz into your ass. Your stomach distends as cum begins to overflow and run from your ass to drip from the orc's bouncing, fat balls and make a puddle on the floor.  You moan in exhaustion as he plants his seed inside you.\n\n", false);
                }
                //((Paths combine here))
                this.outputText("With exhausted panting the only sound from both Ro'gar and yourself, you take a few moments to catch your breath.  Ro'gar affectionately nuzzles you before letting you get to your feet, holding you until he's sure you can stand easily.  The pair of you share a knowing look and Ro'gar grins at you.  \"<i>You're amazin', " + this.player.short + ".  You're welcome anytime ya like.</i>\"  He gives you a tender embrace as you collect your things and walk on wobbly legs toward the door, still feeling cum running down your legs beneath your garments.  The orc sees you off with a wave and a toothy grin.\n\n", false);
                //<Lust sated, slimefeed>
            }
            this.player.orgasm();
            this.dynStats("sen", 2);
        ...
        fuckRogarsButtPussyBoyCuntManMoundSissySlitQueerQuim() {
            ...
            if (this.player.tallness < 72)
                this.outputText("You reach a hand up to cup his chin, yanking it roughly towards your face as you plant a kiss on his lips.", false);
            //(If player is taller than 7 feet)
            else if (this.player.tallness > 84)
                this.outputText("You reach down and cup Ro'gar's chin, roughly yanking it up to crash his lips against yours.  ", false);
            this.outputText("Your tongue presses against his lips insistently, and the orc man moans and urges you on further as you slide your free hand down to grope his groin, feeling up his bulge shamelessly.  Ro'gar blushes lime green in his cheeks at how direct you are.  \"<i>" + this.player.short + "...</i>\" Ro'gar breaks the kiss to whisper more meekly than you've ever heard him, though you shush him with a finger to his lips.  You slip your hand into Ro'gar's shorts and lewdly grope Ro'gar's cock and balls, feeling the green, monstrous member begin to swell beneath your hand.  Your sights are on something lower though, and as you slide your hand under Ro'gar's heavy sack and between his legs you find his tight little orc hole.  You rub your fingertips over it with a loud growl, your kiss meanwhile becoming rougher.  You bite down on his lower lip as your fingers start to urgently press against the hole; the orc shivers under your touch.  You nudge him slowly into the bedroom and undress each other quickly. \"<i>I ain't ever seen you like this...</i>\" Ro'gar speaks, but you interrupt him with a forceful grunt and shove him onto the bed.\n\n", false);
            this.outputText("Pushing your hands against Ro'gar's body, and feeling the slime under your fingertips burning against your skin, you crawl over the prone orc to sit on his chest and point your groin toward his face.  With a grip on the back of his smooth head, you shove his face between your spread legs and let out a loud and satisfied moan.\n\n", false);
            //[(If player has vagina and over 70 corruption)
            if (this.player.cor > 70 && this.player.hasVagina())
                this.outputText("Ro'gar flicks his tongue toward your " + this.multiCockDescriptLight() + ", but you have a better idea and nudge him lower to guide him to your " + this.vaginaDescript() + ".  His eyes look up at you in confusion.  You can tell he'd rather not have his face buried there by the way he moves his mouth away, but you urge him on; telling him to get licking, you push your hips down over his face.  With his head caught between your legs and the bed his mouth presses to your " + this.vaginaDescript(0) + "without a choice.  His whimpers of displeasure bring a grin to your face as you rub over his mouth with your netherlips.  He reluctantly flicks his tongue out to lap over your mound.  You shiver at the attention, growing moist and slick as you drip over Ro'gar's mouth.  The orc gives a whine of disgust as you rudely force him to pleasure your pussy, and you let out a loud moan as his unwilling licks turn you on; excited, you stroke your " + this.cockDescript(0) + ".  Ro'gar focuses his attention on that instead, watching you grow stiff and swollen, his eyes following your pumping hand.  You generously rub the slick, drooling pre-cum over " + this.sMultiCockDesc() + ", your vaginal walls clenching around his tongue as you pleasure yourself, working the goo over your flesh with your hand.  You look down and grin devilishly at him.\n\n", false);
            //(If player doesn't have vagina but has 70+ corruption)
            else if (this.player.cor > 70)
                this.outputText("Ro'gar flicks his tongue over your " + this.multiCockDescriptLight() + ", but you have a better idea and nudge him lower to guide him to your " + this.assholeDescript() + " .  With a lusty growl Ro'gar attacks your pucker, tongue swirling over the surface and coaxing a pleased moan from your lips.  You grow stiff with arousal, bringing a hand down your shaft to answer your burning lust with a few teasing strokes.  You smear the pre-cum pouring out of your " + this.multiCockDescriptLight() + " into an even coating of spunk as you work your hand.  Ro'gar looks over at the pumping hand and soon becomes distracted from his work, his tongue pressed lazily against your " + this.assholeDescript() + ".  You look down and grin devilishly at him.\n\n", false);
            this.outputText("Pulling back off of Ro'gar's face, you feel your entire body twitch in anticipation.  You press your " + this.hipDescript() + " against his muscled ass, lining your aroused member up against his tight rear while your hands grope over the firm muscled cheeks, spreading them apart eagerly.\n\n", false);
            //[((If biggest cock is less than 4 inches))
            if (this.player.longestCockLength() < 4) {
                this.outputText("\"<i>Yer serious?</i>\" Ro'gar asks with a quirked eyebrow.  You blink as he suddenly gets up to stare you in the eyes.  \"<i>Not to be rude, " + this.player.short + ", but I ain't gonna feel nothin'.</i>\"  You can't help but feel a little offended, saying something about motions of large bodies of water.  Ro'gar doesn't seem convinced as he buries his forehead in a palm.  \"<i>Listen, this ain't a really good time for this.  I'm already losin' my mojo.  You come back another time, okay?</i>\"  With that, you are ushered out as politely as possible.  You can't help but feel a little embarrassed as you walk the city streets like this is some sort of walk of shame.", false);
                this.doNext(this.camp.returnToCampUseOneHour);
                return; //end if too small
            }
            //((else If smallest cock is over 18 inches))
            else if (this.player.shortestCockLength() > 18) {
                this.outputText("\"<i>E-easy there...</i>\" Ro'gar actually stutters, looking at you with concern.  You are impossibly huge for him, and despite your titanic head rubbing pre-cum over Ro'gar's green hole it just won't fit.  You let out an annoyed grumble and begin to rub your length over Ro'gar's body and orc cock.  With lustful grunts Ro'gar bucks his hips into your " + this.multiCockDescriptLight() + ", grinding the stiff masts together as they leak and drool over one another.\n\n", false);
                //[(If multiple cock)
                if (this.player.cockTotal() > 1)
                    this.outputText(this.SMultiCockDesc() + " grinds over every inch of Ro'gar's front, and his dark olive skin soaks in your glistening fluids.  Ro'gar's length is lost in the forest of your meat.  With his green monster assaulted by multiple angles and dwarfed in size he whimpers softly.  \"<i>Ain't never felt nothin' like this.  Almost like fuckin' a dick.</i>\"", false);
                //(else If single cock)
                else
                    this.outputText("Your " + this.multiCockDescriptLight() + " bucks against Ro'gar's orcish pride.  The pair of hard cocks press tightly together as you dwarf Ro'gar in size.  You hump his orc sex with your " + this.multiCockDescriptLight() + " and grunt in strain; your hands reach down to grip the pair of manhoods tightly, jerking them fast with squeezed pumps.", false);
                //(If player has balls) 
                if (this.player.balls > 0)
                    this.outputText("  Ro'gar squirms under you, his chest heaving with labored breath while his musky scrotum presses against your own.", false);
                this.outputText("  He reaches down, sweaty palm wrapping around his meaty length and roughly choking it, then strokes along his orchood hastily as he groans out, spunk spilling over " + this.sMultiCockDesc() + " and leaving it sopping wet with hot seed.  Your own hands rub Ro'gar's strong smelling sperm over yourself, coating your " + this.multiCockDescriptLight() + " in his lust.  The sight of the heaving orc beneath you drives you over the edge,and your pent-up load splatters over Ro'gar's sweaty body and covers the orc in your thick volleys of cum.", false);
                this.outputText("\n\n", false);
            }
            //((If cock is between 18 and 4 inches))
            else {
                this.outputText("\"<i>E-easy there.</i>\"  Ro'gar actually stutters, looking at you with concern. Your lips curl into a devious grin as you roughly press into Ro'gar's puckered hole.  You slide in with an abrupt grunt, ignoring Ro'gar's yelps of pain at the sudden entry and reasoning that it couldn't have hurt too much, judging by how your " + this.cockDescript(0) + " was literally coated in pre-cum.  But still, you find it amusing to push the orc's button and make him squirm for once.  Slipping in further, you bury yourself in Ro'gar's hole until he groans out and prematurely spurts more orc cum onto his stomach.", false);
                //[(If using feline cock)
                if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.CAT)
                    this.outputText("  You grind around in his green pucker, the barbs working over Ro'gar's inner walls.  \"<i>W-what in tarnation?</i>\" Ro'gar grunts as you watch him squirm under you.  You buck your hips, digging deeper into orcflesh with each thrust, his muscled ass tensing with each slam of your hips.", false);
                //(If horse cock)
                else if (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                    this.outputText("  The flared head of your " + this.cockDescript(0) + " nestles in Ro'gar's hole.  His breath quickens as you push in, the girthy, flared head stretching Ro'gar's insides impossibly.  You simply thrust and buck you way deeper within the green pucker to force more of your lengthy shaft past that olive rosebud each time.\n\n", false);
                //(If dog cock)
                else if (this.player.hasKnot(0))
                    this.outputText("  Your pointed tip slips in easily and you begin to plunge into Ro'gar's depths, and the burly orc gives satisfied grunts as his strong hand reaches down to touch himself.  You begin to fill his orc hole, the pre-slicked cock working as a lubing tool as you begin to build a nice rhythm within Ro'gar.  Your knot bulges as your climax approaches and begins to ram into Ro'gar's green pucker, the tight ring unable to allow entry as you swell bigger and bigger.", false);
                //(If other cock)
                else
                    this.outputText("  Breaking Ro'gar's orc hole open, you thrust deep within his hot, tight depths.  The burly orc pants with heated breaths, humid air fluttering out of his tusked mouth.  His musclegut heaves, each breath punctuating the thrusts of your hips.  You plow his ass roughly, pulling out until only the head remains inside him before plunging back in further than before.  Ro'gar grunts low in his chest with each bit of progress made, his strong, calloused hand stroking his drooling cock.  \"<i>Mmmf, " + this.player.short + ",</i>\" he groans as you finally hilt yourself within him.", false);
                //end racialdicks, still inside right fit path
                this.outputText("\n\nYou grip his hips and begin a steady pace, slapping flesh loudly against his muscled ass.  His thick, powerful legs twitch in the air as you pound into his orcish hole, and the orc's toes curl visibly with each brutal thrust you make into him.  You groan as his musk makes your " + this.multiCockDescriptLight() + " throb all the more within him.  To further his humiliation, you whisper in his pointed ear how good he feels wrapped around your length.  He blushes a lime green before you make him groan out your name with a rough smack over his ass.", false);
                if (this.player.cockTotal() > 2)
                    this.outputText("  Your other cocks grind over that firm orc rump, drooling over his skin and making his rear glisten with your sex.", false);
                else if (this.player.cockTotal() > 1)
                    this.outputText("  Your other cock grinds over that firm orc rump, drooling over his skin and making his rear glisten with your sex.", false);
                this.outputText("You decide to see how loud you can make him moan and begin ramming deep within him.  The thrusts slam hard enough to make Ro'gar's back arch, your bulbous cockhead prodding his buried prostate with each hilt.  His big hand beats furiously at his massive orc cock, strained groans bellowing out loudly as his heavy sack clenches tight against the base of his green rod.  Orc spunk flies out over his chest, hitting his chin and splattering over his heaving pecs.  His cum collects between his bulging muscles and splashes over his head.  Ro'gar's anal walls clench down tight around you as you pick up the pace of your brutal fuck; your " + this.cockDescript(0) + " is milked hard as you feel your climax rapidly approaching.  Sweat drips from your body onto Ro'gar's skin, and you finally feel yourself hit the edge.  With a burst of ecstasy you hilt completely within your orc fuck toy.", false);
                //[(If dog cock)
                if (this.player.hasKnot(0))
                    this.outputText("  Your knot forces past Ro'gar's tight, anal ring to pulse inside him, joining the pair of you together.", false);
                //[(if player has balls)
                if (this.player.balls > 0)
                    this.outputText("  With short jerks of your hips, you begin to unload your pent up orbs into the orc's innards.", false);
                this.outputText("  Wave after wave of thick seed spills from your cock into Ro'gar as his head falls back at the blissful sensation.", false);
                //[(if multiple cock)
                if (this.player.cockTotal() > 1)
                    this.outputText("  The other meat rubbing over his olive skin outside adds to the coating of spunk, making a giant mess of Ro'gar's body.  In seconds he resembles a well-paid whore beneath your " + this.multiCockDescriptLight() + ".", false);
                this.outputText("\n\n", false);
            }
            //end right fit path
            //((Combine too big, and right size paths))
            this.outputText("Ro'gar's cum-coated body lies panting under you.  You slowly soften and lay limp against his olive skin, then pull away and clean yourself off.  Ro'gar stirs slowly, only rising to a seated position by the time you are dressed.  \"<i>That was really... something.  I don't really know what got inta ya, " + this.player.short + ", but ya really know how ta surprise a feller.</i>\"  With a sly smirk you intone that he had it coming and finish putting on your clothes, then walk over to smack Ro'gar's cum-covered ass with your hand.  The giant orc looks stunned a moment before giving a playful grin.  \"<i>Frisky, aren't'cha?</i>\"  He snickers low in his rumbling chest, then gets up to wave you off, but you're already out the door and heading back into the city with a spritely skip added to your step.", false);
            //<Lust sated>
            this.player.orgasm();
            this.dynStats("sen", -1);
            this.doNext(this.camp.returnToCampUseOneHour);
        ...
        takeDatBroBrewFromDaBigMeanOlOrc() {
            ...
            if (this.player.findPerk(PerkLib_1.PerkLib.BroBody) < 0) {
                ...
                changed = true;
                this.player.removePerk(PerkLib_1.PerkLib.Feeder);
            }
            ...
            if (changed) {
                ...
                //(if dick grew)
                if (cocked)
                    this.outputText(", and you smile to yourself as your now-larger endowment rubs against garments not suited to it", false);
                this.outputText(".  Who needs book smarts anyway?  Nerds.", false);
                //lose lust, gain bro traits, slimefeed
                this.player.createPerk(PerkLib_1.PerkLib.BroBrains, 0, 0, 0, 0);
                this.player.createPerk(PerkLib_1.PerkLib.BroBody, 0, 0, 0, 0);
        ...
        frotWithRogar() {
            ...
            this.outputText("", true);
            this.spriteSelect(86);
            this.outputText("You allow yourself to be led into Ro'gar's apartment and look around the modestly furnished lounge. Ro'gar seats himself in a cushioned chair.  \"<i>Thanks fer comin'.  I missed ya.</i>\"  He snickers, and you draw closer. His calloused hand reaches down to cup your " + this.buttDescript() + ".  He smirks at you, the frisky orc chuckling deeply and firmly squeezing.  You retaliate with a hard smack against Ro'gar's muscled rump.  He growls low, answering the challenge and crashing his lips into your own.  Muffled grunts and groans issue from both of you as you undress each other.  Soon you are standing in the nude and Ro'gar's hefty cock presses against your " + this.multiCockDescriptLight() + ".\n\n", false);
            //(If multiple cocks)
            if (this.player.cockTotal() > 1) {
                this.outputText("Feeling your lengths stiffen against Ro'gar's hard green monster, you buck against Ro'gar's hard need, enveloping it in your cocks and coaxing a lewd groan from the orc.  Ro'gar growls as he feels his orc length surrounded, his green member being slathered with your pre-cum from multiple directions.  His arms wrap around you as he fucks your " + this.multiCockDescriptLight() + ", grinding his orc cock between all your lengths; he presses his tusks against your neck and suckles, teeth grating the flesh while his tongue passes over the indentations they leave behind.  Ro'gar backs you up and you feel a hard wall behind you.  His oil-coated body rubs over your own, smearing onto your chest, arms, and hips.  Your hands grip tightly to Ro'gar's back as you grind into him with your " + this.multiCockDescriptLight() + ".  Ro'gar reaches his hand down, wrapping his fingers around his length and the nearest cock to it, then strokes them slowly.  Hot breath washes over your face as he stares deep into your eyes, the deep blue pools hazed with lust as you fuck against each other's loins.  Your two bodies mingle with sweat and pre-cum, and soon your groins are sticky and glazed.  You fuck your cocks together, the strong scent of man musk filling your nose and sending a shudder down your spine and a thrill through your groin.  Ro'gar suddenly moans, his orc cock caught between your " + this.multiCockDescriptLight() + " as he unloads over your chest.  His heavy sack clenches tight beneath his cock as he spills his thick seed onto you, coating you in his countless ropes.  The heat warms your skin as you reach your limit; each of your " + this.multiCockDescriptLight() + " twitches, hot and sticky spunk splashing over Ro'gar's olive skin.\n\n", false);
            }
            //(If single cock)
            else {
                this.outputText("Your cock presses tight against Ro'gar's fat orc cock. He growls low as he grinds himself over you, his thick, globbing pre-cum drooling onto your " + this.multiCockDescriptLight() + ".  Muffled groans escape Ro'gar's mouth as you kiss him roughly, tongues locked all the while in writhing combat.  ", false);
                //[(If player has balls)
                if (this.player.balls > 0)
                    this.outputText("Your " + this.ballsDescriptLight() + " slap audibly against Ro'gar's heavy green sack.  ", false);
                this.outputText("Each thrust is slicker and better than the last as your cockheads drip out copious amounts of pre-cum over each other's lengths, the two manhoods slick and bucking toward the other in hard, bestial rut.  Ro'gar backs you up and you feel a hard wall behind you.  His oily body rubs over your own, smearing onto your chest, arms, and hips, and your hands grip tightly to Ro'gar's back as you grind into the orc.  Ro'gar reaches his hand down, wrapping his fingers around his length and yours.  He strokes along them with his rough, calloused hand, and hot breath washes over your face as he stares deep into your eyes.  The deep blue pools are hazed with lust as you fuck against each other's loins.  Your two bodies mingle with sweat and pre-cum, and soon your groins are sticky and glazed.  You fuck your cocks together, the strong scent of man musk filling your nose.  Ro'gar suddenly moans, his orc cock caught against you as he unloads over your chest.  His heavy sack clenches tight beneath his cock as he spills his thick seed, coating you in his countless ropes of jizz.  The heat warms your skin as you reach your limit; your " + this.multiCockDescriptLight() + " twitches and hot and sticky spunk splashes over Ro'gar's olive skin.\n\n", false);
            }
            //(( Paths combine here))
        ...
        kinkyWithDaOrc() {
            ...
            this.outputText("over the threshold, and then look around the apartment.  He points out the small kitchen area and then, rather sheepishly, the bedroom.  You're examining it when something catches your eye...\n\n", false);
            this.outputText("You bend over the bed to grip a small bottle lying in the soft fabric of the sheets.  Turning it over, you tilt your head as you read the label.  It's... a bottle of lubricant.  Suddenly, there is a loud thud behind you and the bottle drops from your hand as your torso is pressed into the cushioned surface of the bed.  Something presses into your back.  \"<i>Gotcha...</i>\" the familiar voice snickers in your ear.  Ro'gar's head leans over your shoulder and a long, orcish tongue licks your cheek.  \"<i>Was waitin' for this...</i>\" he purrs; the resonance of his voice rumbles against your ear.  Ro'gar chuckles and grips around your wrists.  \"<i>Now that yer here, it's time ta break in this here new bed with sumthin' I've been cravin' since I washed ya down in that swamp, boy.</i>\"  Ro'gar's tone suddenly takes a demanding, hissing tone.  His tongue flicks over your ear as he speaks.  Your skin begins to grow goosebumps as shivers crawl down your spine.\n\n", false);
            this.outputText("He yanks your wrists behind your back, ignoring your faint gasps.  With a rustle of cloth, your wrists are bound together behind your back tightly; your fingers feel over the bonds but you struggle against them in vain.  Looking over your shoulder in ", false);
            if (this.player.lib < 33)
                this.outputText("feigned confusion ", false);
            else if (this.player.lib > 66)
                this.outputText("clear lust ", false);
            this.outputText("at Ro'gar, you only see his lust-ridden face dipping down to kiss at your lips.  His tusks press against your cheeks with a demanding snarl and his tongue into your mouth; your " + this.buttDescript() + " receives a smack, forcing you to yelp.  His tongue quickly invades, and his free hand unfastens your " + this.player.armorName + " to strip you forcefully.  Rough, calloused fingers dance over your body and fasten onto your " + this.nippleDescript(0) + "s, coaxing moans from your throat with each pinch.  Your pleased noises are muffled by Ro'gar's mouth, his tongue and lips hushing each whimper and gasp you breathe.  A bare, firm chest presses against your exposed back, and you pant as the heat from his body burns against you, only intensified by the thin layer of oil on his skin.  Ro'gar's blue eyes watch you like a predator as your face flushes.  He breaks the kiss and cups his hands under your chin to hold your face in place.  \"<i>Such a perdy face yer makin', " + this.player.short + ".  Yer lookin' at me like a proper slut, an' it's makin' me hard seein' ya so needy to be bred.</i>\"  He growls in his throat as his mouth nips over your neck, leaving red marks along your skin where his tusks rub against you.  You can feel the oil and sweat smearing over your back, and your senses go wild.  The room is soon filled with your needy whimpers as " + this.sMultiCockDesc() + " oozes and throbs against the sheets, making the fabric damp with your lust.\n\n", false);
            ...
            if (this.player.ass.analLooseness < 3)
                this.outputText("the tight hole.  Your teeth clench as he stretches you wide around his length, though he continues without hesitation, and finally you cry out with the sting of the bulbous head squeezing into your tiny hole, though it falls on deaf ears as Ro'gar merely groans at your tightness.", false);
            else if (this.player.ass.analLooseness < 5)
                this.outputText("your well-used hole. You moan with need as he stretches you wide around his length, continuing without hesitation until he's inside.", false);
            this.player.buttChange(25, true, true, false);
            ...
            this.outputText("You can't help but focus on the wonderful feeling of Ro'gar's cock throbbing within you.  Maybe this is where you belong?  With your ass impaled on Ro'gar's massive tool?  You moan loudly as Ro'gar picks up the pace, hips ramming into you with enough force to shift your body over the sheets.  He really starts to pound your hole with huffed grunts and groans as he hilts in you; his cockhead prods your prostate with each thrust, causing you to cry out as electric shocks shoot up your spine.  Every nerve in your body lights up like a Christmas tree and make your entire body squirm with pleasure.  You feel spurts of cum begin to leak from your " + this.multiCockDescriptLight() + " and glaze your belly with pre-cum.", false);
            if (this.player.hasLongTail() || this.player.isNaga())
                this.outputText("  Your tail, still gripping Ro'gar's arm, squeezes tight.", false);
            //(If player has balls) 
            if (this.player.balls > 0)
        ...
        rubdubWithDaOrcWithoutDucky() {
            this.flags[kFLAGS_1.kFLAGS.ROGAR_FUCKED_TODAY] = 1;
            this.outputText("", true);
            this.spriteSelect(86);
            this.outputText("By the time you reach Ro'gar he has already reached his bedroom, his shorts on the floor. You eye over his olive green skin, all of it laid bare before you including his limp orc cock hanging over his hefty nutsack.\n\n", false);
            this.outputText("\"<i>I purchased these oils to relax my muscles after spending so much time in the gym.</i>\" Your orc lover motions to a few bottle of oils on his night stand. \"<i>How about you give me a hand... or two.</i>\" Ro'gar grins at you, his eyebrows twitching suggestively. You need no further provocation as you strip from your " + this.player.armorName + ", you let it fall into a pile on the floor as you make for the bottle. Ro'gar grins and rolls onto his stomach.\n\n", false);
            this.outputText("The bottles pop open easily and you pour a generous amount over your hand, you spill even more over Ro'gar back. He gasps feeling the cool liquid crawl down the spine of his back. Though it's not long after you warm his skin with your hands. Your fingers spread and smear the oils over his damp skin. You crawl up and straddle Ro'gar's hips, sitting on his muscled ass as you begin to rub the oils in.\n\n", false);
            this.outputText("Ro'gar's skin under your fingertips feels stiff, his muscles resisting your insistent touches. Slowly you can feel them relax, they smooth out and grow warm under your palms. It's not long until Ro'gar is purring loud enough for you to hear. With a pleased growl Ro'gar shifts under your body briefly before letting you continue.\n\n", false);
            this.outputText("\"<i>That's the spot.</i>\" Ro'gar grunts as you work your thumbs over a certain spot near his shoulders. You curve your fingers around his broad shoulder and gently pull the muscles to stretch away from the neck. Ro'gar's mouth bellows a moan as his head falls to the sheets. The oils mixing with the strange liquid secreted from the orc's skin making a curious concoction. You can feel your hands feeling so warm and soothed, the muscles in your hands relaxed and comforted. As you look along Ro'gar glistening back you wonder how it would feel to have such a large area affected by the slurry.\n\n", false);
            this.outputText("You ask Ro'gar to flip over as you get off of his hips to get more oils. By the time you turn around your orc lover has already laid out on his back. Your eyes take in the sight of your muscled lover laid out for you, his muscled limbs bulging in anticipation, his swollen cock growing larger before your eyes. He grins at you as you pour oils over his chest, the cool liquid making him shiver as it drips down along his center. The clear oil crawling in between his pectorals, down his treasure trail and dipping into his navel before filling the gaps in his abdominals.\n\n", false);
            this.outputText("Without any hesitation you straddle the orc's hips again, his engorged orc cock brushing against the bare skin of your " + this.buttDescript() + ". Your hands get to work smearing the relaxing oil over Ro'gar's body. The orc stares at you with a lurid gaze as you massage his bulging pectorals, teasing his darkened nipples with your fingers. You grin feeling Ro'gar's thick cock pressing more against your " + this.buttDescript() + " as his chest rumbles under your hands.\n\n", false);
            this.outputText("\"<i>You're good at this " + this.player.short + ", have you done this before?</i>\" Ro'gar purrs as you work over his abdominals, tracing over every gap with your fingertips, the oils glistening over your lover's body. Ro'gar's hips buck gently, bumping your " + this.buttDescript() + " with his throbbing cock with a chuckle, his mouth curls into a coy smile. You watch as Ro'gar reaches his arms back, resting his head on his hands as he bares his underarm and pits.\n\n", false);
            //[Play with pits][Ignore pits]
            this.simpleChoices("Play with pits", this.sexyOrcPitsAreSexy, "Ignore pits", this.lickSomeMoreOrcButNoPits, "", undefined, "", undefined, "", undefined);
        }
        //[Play with pits]
        sexyOrcPitsAreSexy() {
            this.outputText("", true);
            this.spriteSelect(86);
            this.outputText("You lean forward enticed by Ro'gar's arm pits. The smile on his lips grows broader as your tongue sinks into his musky sweat centers. You can feel his fat orc dick drooling precum as you lap your tongue over the wet olive skin.\n\n", false);
            this.outputText("\"<i>Ohhhh, you ain't afraid to get a little dirty. One of your best qualities.</i>\" Ro'gar leans back and lets you go to town, you wash the arm pits out thoroughly with your mouth. Your lips kissing at the skin and mixing your saliva with the sweat and masculine musk. The strong overpowering scent of your lover's scent drowning your nose, the tang of his masculinity dripping from your mouth as you swirl the taste in your mouth.\n\n", false);
            this.outputText("With a tilt of your head you press your mouth to Ro'gar's. His lips part for yours and your tongue dances with his, his hand stroking your sides as he growls low in need into your mouth. His hot lips and tongue pressing hard to your own. He tries to dominate your mouth, his tongue wrestling with yours to push it where he wills. His teeth catch and nip your bottom lip with a low possessive growl.\n\n", false);
            this.outputText("\"<i>So skilled with your mouth and hands, care to give me a good finish? I'll be sure to tip.</i>\" He winks playfully. With a smile on your face you back up a bit, dragging your " + this.multiCockDescriptLight() + " over his own. Abruptly Ro'gar blurts out a moan, his breath labored as his fat green dick humps your own " + this.multiCockDescriptLight() + ". An idea fresh in your mind as you hump back, driving the orc male wild as he grunts and pants. His slime and oil slick body madly rubbing over your own. A gasping and moaning mess of muscle and orc flesh, he is left writhing under you, his mouth hung open in needy groans desperate for your touch, your warmth, your body.\n\n", false);
            this.outputText("After creating a overflowing pool of orc precum mixed with your own, the slurry dripping from Ro'gar's stomach, you return to moving backwards. Ro'gar's throbbing pillar of orc manhood in front of your face as your hands make it stand tall. Your orc lover pants breathlessly as you pump his fat dick in your hands, they are still slick with oil and slime. The reward waiting for you is copious amount of thick orcish precum dripping down over your fingers and palms. The hot liquid pearling at his darkened cockhead, your lips planting a kiss to the tip of your lover's massive prick. His strong scented seed smeared over your lips, perfect for your tongue to snake out and collect as Ro'gar watches on with lust filled eyes.\n\n", false);
