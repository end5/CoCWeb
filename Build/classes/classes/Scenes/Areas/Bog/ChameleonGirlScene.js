define(["require", "exports", "../../../BaseContent", "./ChameleonGirl", "../../../GlobalFlags/kFLAGS"], function (require, exports, BaseContent_1, ChameleonGirl_1, kFLAGS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 03.01.14.
     */
    class ChameleonGirlScene extends BaseContent_1.BaseContent {
        ...
        encounterChameleon() {
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_MET_CHAMELEON]++;
        ...
        loseToChameleonGirl() {
            ...
            if (this.player.lust > 99) {
                this.outputText("Losing control to your own growing arousal, you fall to your knees and desperately start working to get at your needy body beneath your " + this.player.armorName + ".");
            }
            //Lose by HP
            else
                this.outputText("Too weak to keep fighting, you stagger back and fall to your knees.");
            ...
            else if (this.player.gender == 1 || (this.player.gender == 3 && ChameleonGirlScene.rand(2) == 0))
                this.dudesLoseToChamChams();
            else if (this.player.hasVagina())
                this.loseToChamChamWithPCCunt();
            else {
        ...
        loseToChameleonWithCockAnBallsAnCunt() {
            ...
            this.outputText("\n\nAs you set the last bit of your " + this.player.armorName + " aside in the water, you're suddenly struck in your chest and pushed to the ground.  The chameleon girl's wide foot keeps you pinned down, and she looks at you almost apologetically.  She shakes the worry from her face, and tries to appear stern once again.  \"<i>I'll... I'll show you who's the boss around here!</i>\"  Her tail darts towards you and uncoils at its end.  The tip starts probing around your " + this.vaginaDescript(0) + ", brushing across your " + this.clitDescript() + " as it feels around for your entrance.");
        ...
        dudesLoseToChamChams() {
            var x = ChameleonGirlScene.rand(this.player.totalCocks());
            this.spriteSelect(89);
            ...
            if (this.player.lust > 99)
                this.outputText("overwhelmed by lust");
            else
                this.outputText("battered");
            this.outputText(" to even rip the makeshift binding.");
        ...
        defeatChameleonGirl() {
            ...
            if (this.monster.lust > 99) {
                this.outputText("Unable to control her arousal, the chameleon girl collapses to her knees and begins masturbating underneath her thong, having lost all capacity to fight you; she moans and throws her head back as her hand splashes in and out of the water she's kneeling in.  Her skin returns to its usual " + this.monster.skinTone + " and then keeps going, shifting closer and closer to pink as her moans increase in both volume and volubility.");
                if (this.player.lust >= 33)
                    this.outputText("  Do you help the horny girl to get you both off?  Or maybe you could punish her bad attitude with something from your bag...");
            }
            //-Win by HP
            else {
                this.outputText("Too weak to continue fighting, the chameleon girl drops to her knees, exhausted.  Her skin returns to its usual " + this.monster.skinTone + ", unable to maintain the camouflage.");
                if (this.player.lust >= 33)
                    this.outputText("  Do you use the girl in her weakened state to get yourself off?  Or maybe you could punish her bad attitude with an item from your bags...");
            }
            ...
            if (this.player.hasCock())
                dick = this.manFucksChameleonWithBiggishWang;
            if (this.player.hasVagina())
                pussy = this.femaleHasWinSexWithChamCham;
            if (this.player.gender == 3)
                herm = this.fuckDatChameleonAsACoolGuyGirlHerm;
            //let PC use item
            if ((this.player.hasItem(this.consumables.SUCMILK) || this.player.hasItem(this.consumables.P_S_MLK)) && this.player.hasCock())
                item = this.useAnItemOnTheChamcham;
            else if (this.player.hasItem(this.consumables.SENSDRF) && (this.player.hasItem(this.consumables.L_DRAFT) || this.player.hasItem(this.consumables.F_DRAFT)))
                item = this.useAnItemOnTheChamcham;
        ...
        fuckDatChameleonAsACoolGuyGirlHerm() {
            ...
            if (this.player.cor < 50)
                this.outputText("and guiltily ");
            this.outputText("roll her onto her back and get up to collect your things, rinsing yourself with the water and shaking the mud out before putting your " + this.player.armorName + " back on and heading back to camp.");
            this.player.orgasm();
            this.cleanupAfterCombat();
        }
        //-Male (Z edited)
        ...
        manFucksChameleonWithBiggishWang() {
            ...
            if (this.player.balls > 0)
                this.outputText("your " + this.ballsDescriptLight() + " clench and ");
            this.outputText("the semen erupts from the end of your " + this.cockDescript(x) + " spilling out hot spunk over her folded tongue.  She gasps audibly and arches her back as the thick ropes of your jizz coat her tongue, shoving her long fingers as far as she possibly can into her dripping pussy, and flashes so brightly pink she nearly glows.");
            if (this.player.cumQ() > 750)
                this.outputText("  The torrent of cum bursting from your cock just doesn't stop, and her eyes roll back into her head as your semen coats her face and runs off her tongue, drenching her breasts and belly in white.  Her head falls back and her tongue goes limp as she's sent into ecstasy by the flood.");
            ...
            if (this.player.cumQ() > 750)
                this.outputText("  Even the murky water around her is turned white as the pools of your cum on her body run off into it.");
            this.outputText("  Satisfied, you put your " + this.player.armorName + " back on and head back to camp.");
        ...
        femaleHasWinSexWithChamCham() {
            this.clearOutput();
            this.spriteSelect(89);
            this.outputText("You shed your " + this.player.armorName + " and approach the fallen chameleon girl");
            if (this.monster.lust > 99)
                this.outputText(", her moans of pleasure growing more desperate as you approach");
            this.outputText(".  You look her up and down, following the smooth curves of her thin body with your eyes.  Squatting down beside her, you take her weak body by the shoulders in one arm and trail your fingertips lightly up her torso with the other, feeling the soft skin of her belly.");
            if (this.monster.lust > 99)
                this.outputText("  She coos lustily at the sensation.");
            else
                this.outputText("  Her eyes widen, and she looks from your hand to your face and back again.");
            this.outputText("  When your hand reaches the silk cloth covering her chest, you pull it off with a light tug and cast it off to the side.  You cup her small breast in your palm, and as you squeeze it her skin tone changes perceptibly, flashing to a much brighter shade of the colors it was.");
            this.outputText("\n\nCurious, you take her nipple between your index finger and thumb, pinching and twisting and pulling on it, eliciting a series of sharp gasps and squeals.  She arches her back into your supporting arm and her skin flashes wildly, long stripes of color shifting across her body with your every tweak.  You find her complete inability to hide what she's feeling amusing, but you're much too turned on to just sit there and play with her.  Releasing her breast, you take her arm and guide her hand to your own slick cunt.  She gets the idea and begins to work her fingers lightly in and out of your wet folds.  You squeeze her close and breathe in deep, enjoying the sensation of her long fingers plunging in and out of your " + this.vaginaDescript(0) + ".  It feels so good to have her touching you, and as you bask in the pleasure you lose your balance.  The two of you topple over backwards, landing in the shallow water with a splash.  Unsure what to do, the chameleon girl freezes up and looks almost apologetically into your eyes.  You laugh quietly at her confusion and guide her fingers back into motion with your hand.");
            this.outputText("\n\nNot ");
            if (this.player.cor < 50)
                this.outputText("one to be selfish");
            ...
            if (this.player.cor < 50)
                this.outputText("and somewhat guiltily ");
            this.outputText("roll her onto her back and get up to collect your things, shaking out the mud and water before putting your " + this.player.armorName + " back on and heading to camp.");
            //send player back to camp, reset hours since cum, add gems and time
            this.player.orgasm();
            this.cleanupAfterCombat();
        }
        ...
        useAnItemOnTheChamcham() {
            this.clearOutput();
            this.spriteSelect(89);
            this.outputText("Looking at the poor girl kneeling pathetically before you, you almost feel sorry for her.  But, she did try to rape you and claim that you were on 'her' territory.  You rummage through your bags, trying to find a fun way to punish her.  Fun for you, at least.");
            ...
            if ((this.player.hasItem(this.consumables.SUCMILK) || this.player.hasItem(this.consumables.P_S_MLK)) && this.player.hasCock())
                milk = this.giveTheChameleonASuccubiMilk;
            if (this.player.hasItem(this.consumables.SENSDRF) && (this.player.hasItem(this.consumables.L_DRAFT) || this.player.hasItem(this.consumables.F_DRAFT)))
        ...
        giveTheChameleonASuccubiMilk() {
            this.clearOutput();
            this.spriteSelect(89);
            this.outputText("You find a bottle of Succubi Milk tucked away in a pouch.  A wicked smile comes to your face as you imagine filling her so full of the stuff that her tits grow to the point where she can't even move, but you ultimately decide that just one dose will suffice for now.");
            ...
            if (this.player.hasLongTail())
                this.outputText(" with your tail,");
            else
                this.outputText(" by straddling her,");
            this.outputText(" your cock aimed for her pillowy tits.  She pushes and squirms beneath you, but cannot get enough leverage to move you.  You take her breasts in your hands and shimmy up her torso towards them, squeezing them around your " + this.cockDescript(x) + ".");
        ...
        doseDatChameleonWithLustAndSensitivityDrafts() {
            this.clearOutput();
            this.spriteSelect(89);
            this.outputText("You dig through your bags and come across a particularly tortuous combination of fluids.  With a Lust Draft in one hand and a Sensitivity Draft in the other, you return to the chameleon girl, swirling them and smiling at her menacingly.  She starts to protest, but you cut her off by shoving the opening of the Lust Draft vial into her open mouth.");
            ...
            if (!this.player.hasCock() || this.player.cockArea(this.player.smallestCockIndex()) > this.monster.vaginalCapacity()) {
    ...
    exports.ChameleonGirlScene = ChameleonGirlScene;
});
//# sourceMappingURL=ChameleonGirlScene.js.map