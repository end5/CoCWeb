define(["require", "exports", "../../../BaseContent", "../../../GlobalFlags/kFLAGS", "../../../PregnancyStore", "../../../../../includes/appearanceDefs"], function (require, exports, BaseContent_1, kFLAGS_1, PregnancyStore_1, appearanceDefs_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class FrogGirlScene extends BaseContent_1.BaseContent {
        //const TIMES_ENCOUNTERED_FROG: number = 1017;
        //Intro
        findTheFrogGirl() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_ENCOUNTERED_FROG] == 0) {
            ...
            this.flags[kFLAGS_1.kFLAGS.TIMES_ENCOUNTERED_FROG]++;
        ...
        followDatFrog() {
            ...
            if (this.player.hasCock())
                ...
                this.outputText("your bare but sensitive groin");
        ...
        getFrogButtFilled() {
            ...
            this.dynStats("int", 1);
            this.player.buttKnockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_FROG_GIRL, PregnancyStore_1.PregnancyStore.INCUBATION_FROG_GIRL, 1, 1);
        ...
        carryBeeGirlsEggsVoluntarilyYouButtSlut() {
            this.clearOutput();
        ...
        superBonusFrogEggsInYerCooch() {
            ...
            if (this.player.tailType > appearanceDefs_1.TAIL_TYPE_NONE)
                this.outputText(" hooked over your tail,");
            else
                this.outputText(" clasped against your [ass],");
            ...
            this.player.orgasm();
            this.dynStats("sen", 1);
            this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_FROG_GIRL, PregnancyStore_1.PregnancyStore.INCUBATION_FROG_GIRL, 1, 1);
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Vaginal Egg birth
        layFrogEggs() {
    ...
    exports.FrogGirlScene = FrogGirlScene;
});
//# sourceMappingURL=FrogGirlScene.js.map