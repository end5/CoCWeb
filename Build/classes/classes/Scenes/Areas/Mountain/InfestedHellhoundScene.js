define(["require", "exports", "../../../BaseContent", "../../../../../includes/appearanceDefs", "./InfestedHellhound", "../../../StatusAffects", "../../../GlobalFlags/kFLAGS", "../../../PregnancyStore"], function (require, exports, BaseContent_1, appearanceDefs_1, InfestedHellhound_1, StatusAffects_1, kFLAGS_1, PregnancyStore_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 04.01.14.
     */
    class InfestedHellhoundScene extends BaseContent_1.BaseContent {
        ...
        infestedHellhoundEncounter() {
            ...
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_GOO)
                ...
                this.outputText("rattling your teeth", false);
            this.outputText(".  Peeking fearfully over your shoulder, you see the black-furred form of a hell-hound emerging from behind a rock.  Its eyes narrow as its gaze locks onto your " + this.player.assholeOrPussy() + ", a pair of black, shiny dog-cocks emerge underneath him, dangling freely.  His balls look bloated and distended, the skin around them crawling and wriggling.  A few worms drip from its over-sized peckers, crawling on the ground under the infested beast.\n\n", false);
            this.outputText("Somehow you know this thing isn't going to let you just walk away.", false);
            this.startCombat(new InfestedHellhound_1.InfestedHellhound());
            this.spriteSelect(27);
        }
        infestedHellhoundLossRape() {
            this.outputText("", true);
            //[BOTH INFESTED]
            if (this.player.totalCocks() > 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) >= 0) {
                //(LUST)
                if (this.player.lust > 99) {
                    ...
                    if (this.player.cor < 33)
                        this.outputText("In spite of your revulsion ", false);
                    else if (this.player.cor < 66)
                        this.outputText("In spite of your better sense ", false);
                    else
                        this.outputText("With a perverse sense of anticipation ", false);
                ...
                //(HP) 
                    ...
                    this.outputText("Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-sharp teeth easily sink into your " + this.player.armorName + " before tearing away the offending armor, exposing your " + this.assDescript() + " and " + this.multiCockDescriptLight() + ".  A cold mountain breeze blows across your now-exposed " + this.player.skinDesc + ", reminding you just how utterly vulnerable you are to the alien lusts of this symbiotic monstrosity. With a brutal lunge it knocks you off your " + this.player.feet() + " and onto your back.\n\n", false);
                ...
                this.outputText("Overcome by the worms, both you and the beast begin orgasming, without external stimulation of any kind.  Worms and cum mix together on top of you, slowly building into a large mound that covers the better part of your torso.  Exhausted and drained, you both squirt weakly, emptying the last of your smallest worms into the pile.   Your eyes close as the beast lies down with you, and together the two of you lose consciousness as your newly birthed worm colony squirms away.", false);
                this.player.orgasm();
            ...
            //[PLAYER'S COCKS ARE BIG ENOUGH TO BE INFECTED]
            else if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) < 0 && this.player.biggestCockArea() >= 40 && this.player.hasCock()) {
                //(LUST)
                if (this.player.lust > 99) {
                    this.outputText("No amount of shame from the act of submitting to such a beast can overpower the furnace of lust raging in your loins.  ", false);
                    if (this.player.cor < 33)
                ...
                //(HP)
                    ...
                    this.outputText("Too wounded to stand, you drop down to all fours in order to keep yourself off the ground.   Too late you realize your mistake – the snarling beast is behind you and its razor-shark teeth easily sink into your " + this.player.armorName + " before tearing it off, exposing your " + this.assDescript() + " and " + this.multiCockDescriptLight() + ".  A cold mountain breeze blows across your now exposed " + this.player.skinDesc + ", reminding you just how utterly vulnerable you are to the alien lusts of this symbiotic monstrosity.  With a brutal lunge it knocks you off your " + this.player.feet() + " and onto your back.\n\n", false);
                }
                if (this.player.totalCocks() > 1) {
                    this.outputText("The infested hound repositions itself, blocking out the sun with its dark fur, leaving you with only the pale flames surrounding its fuzzy sack to look at.   The warm wetness of its smooth tongue starts sliding over ", false);
                    this.outputText("each of your " + this.multiCockDescriptLight() + ".  It feels good, better than it has any right to.  ", false);
                    this.outputText("Every single one of your " + this.multiCockDescriptLight() + " hardens under the stimulation, happy to be so well-treated.\n\n", false);
                    this.outputText("Stopping its licking, the beast begins to shuffle forwards, pre-cum coated worms plopping out of its double-dicks onto your belly.  They crawl lamely around as the beast works to line itself up, though you're unsure what it could possibly be aiming for.  Your questions are answered as the slightly pointed tips of its twin members press forwards, bumping against the crowns of your own cocks.   It pushes forward with an intense sort of care, slowly forcing itself into your urethras, dribbling painfully hot cum directly into your cock-passages.\n\n", false);
                    this.outputText("Gods, it's shoving its infected cocks up your urethras!  It's trying to infect you with those worms!  The dog-demon keeps pushing further and further, sliding deep inside you, the outline of its members easily visible through the skin of your " + this.multiCockDescriptLight() + ".  It starts feeling good, the wriggling parasite-infested dicks begin sliding in and out, fucking your urethras in earnest and depositing their wormy cargo deep inside you.\n\n", false);
                    this.outputText("Your ", false);
                    if (this.player.balls > 0)
                        this.outputText(this.ballsDescriptLight() + " shiver as hot doggie-cum and wiggling worms are pumped directly into them.  ", false);
                    else
                        this.outputText("body feels uncomfortably full as hot doggie-cum and wriggling worms are pumped directly into your prostate.  ", false);
                    this.outputText("Despite the strange freakishness of the situation, you find yourself getting off on having so many wriggling forms stuffed inside you.  The thickness of a large obstruction working its way down your urethra prevents your orgasm from taking you anywhere, but you feel the pleasure and pressure all the same.  Your body clenches and writhes under the beast, a helpless slave to the unholy pleasures being forced upon you.\n\n", false);
                    this.outputText("The demonic dog backs away with what looks like a grin on its face after filling you with worms and boiling spooge, your urethras stretched and dripping with white squirming goop.  Pushed beyond your endurance, you start blacking out, your last thought a lamentation on how you'll be a carrier for these parasites, just like this demon-dog.", false);
                }
                else {
                    this.outputText("The infested hound repositions itself, blocking out the sun with its dark fur, leaving you with only the pale flames surrounding its fuzzy sack to look at.   The warm wetness of its smooth tongue starts sliding over ", false);
                    this.outputText("your " + this.multiCockDescriptLight() + ".  It feels good, better than it has any right to.  ", false);
                    this.outputText("Your " + this.multiCockDescriptLight() + " hardens under the stimulation, happy to be so well-treated.\n\n", false);
                    ...
                    this.outputText("Gods, it's shoving its infected cock up your urethra!  It's trying to infect you with those worms!  The dog-demon keeps pushing further and further, sliding deep inside you, the outline of its member easily visible through the skin of your " + this.multiCockDescriptLight() + ".  It starts feeling good, the wriggling parasite-infested dick begins sliding in and out, fucking your urethra in earnest and depositing its wormy cargo deep inside you.\n\n", false);
                    this.outputText("Your ", false);
                    if (this.player.balls > 0)
                        this.outputText(this.ballsDescriptLight() + " shiver as hot doggie-cum and wiggling worms are pumped directly into them.", false);
                    else
                        this.outputText("body feels uncomfortably full as hot doggie-cum and wriggling worms are pumped directly into your prostate.", false);
                    this.outputText("Despite the strange freakishness of the situation, you find yourself getting off on having so many moving forms stuffed inside you.  The thickness of a large obstruction working its way down your urethra prevents your orgasm from taking you anywhere, but you feel the pleasure and pressure all the same.  Your body clenches and writhes under the beast, a helpless slave to the unholy pleasures being forced upon you as the dog-demon's exposed member drops a huge worm into the wet puddle on your crotch.  You're horrified when you realize that a similar worm must be making its way inside you now.\n\n", false);
                    this.outputText("The demonic dog backs away with what looks like a grin on its face after filling you with worms and boiling spooge, your urethra stretched and dripping with white squirming goop.  Pushed beyond your endurance, you start blacking out, your last thought a lamentation on how you'll be a carrier for these parasites, just like this demon-dog.", false);
                }
                //(+infested)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Infested, 0, 0, 0, 0);
                this.player.orgasm();
                this.dynStats("lib", 1, "sen", 1, "cor", 1);
                this.player.cumMultiplier += .2;
                if (this.flags[kFLAGS_1.kFLAGS.EVER_INFESTED] == 0) {
                    this.flags[kFLAGS_1.kFLAGS.EVER_INFESTED] = 1;
            ...
            //[HAS PUSSY AND NO DICK BIG ENOUGH TO BE INFECTED]
            else if (this.player.hasVagina() && this.player.biggestCockArea() < 40 && this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_NAGA) {
                //(LUST) 
                if (this.player.lust > 99) {
                    this.outputText("No amount of shame from the act of submitting to such a beast can overpower the furnace of lust raging in your loins.  ", false);
                    if (this.player.cor < 33)
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.WormPlugged) >= 0)
                    this.player.addStatusValue(StatusAffects_1.StatusAffects.WormPlugged, 1, 1 + InfestedHellhoundScene.rand(5));
                else
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.WormPlugged, 1 + InfestedHellhoundScene.rand(5), 0, 0, 0);
                this.player.knockUpForce(PregnancyStore_1.PregnancyStore.PREGNANCY_WORM_STUFFED, 100 + this.player.statusAffectv1(StatusAffects_1.StatusAffects.WormPlugged)); //Will be cleared when the WormPlugged effect ends
                this.player.orgasm();
    ...
    exports.InfestedHellhoundScene = InfestedHellhoundScene;
});
//# sourceMappingURL=InfestedHellhoundScene.js.map