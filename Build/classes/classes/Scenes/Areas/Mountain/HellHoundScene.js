define(["require", "exports", "../../../BaseContent", "./HellHound", "../../../../../includes/appearanceDefs", "../../../PregnancyStore", "../../../GlobalFlags/kFLAGS", "../../../StatusAffects", "../../../PerkLib", "../../../CockTypesEnum"], function (require, exports, BaseContent_1, HellHound_1, appearanceDefs_1, PregnancyStore_1, kFLAGS_1, StatusAffects_1, PerkLib_1, CockTypesEnum_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 04.01.14.
     */
    class HellHoundScene extends BaseContent_1.BaseContent {
        /*
         Attacks:
         1. Attack (claw);
         ...
         */
        hellhoundEncounter() {
            this.outputText("You hear a fiery howl as a demonic, two-headed beast-man leaps out in front of you!", true);
            this.startCombat(new HellHound_1.HellHound());
            this.spriteSelect(27);
        }
        hellhoundRapesPlayer() {
            //Lust or HP loss texts here
            if (this.player.lust >= 100)
                this.outputText("Overcome by sexual desire, you submit to the hungry hellhound.\n\n", true);
            else
                this.outputText("Too weak to continue fighting, you fall to your knees.\n\n", true);
            this.outputText("The heads of the hellhound grin with desire as he rises onto his hind legs. As the hellhound stands before you, your eyes widen at the sight of its equipment: a pair of eight-inch long black rods, one above the other, with a sack containing a quad of flaming balls underneath. As the hound swaggers closer, you gulp at the thought of what those fiery balls are going to be pumping into you. You are helpless against the hellhound as he pushes you onto your ", false);
            if (this.player.lowerBody == appearanceDefs_1.LOWER_BODY_TYPE_CENTAUR)
                this.outputText("hocks and knees", false);
            else
                this.outputText("hands and knees", false);
            this.outputText(" and positions himself behind you. He grips you with his clawed hands on your shoulders and easily holds you in place. The powerful creature is easily able to get past your " + this.player.armorName + " and you feel one of his rods brush against your " + this.buttDescript() + ".  A shudder shoots through your body as he brings his two heads down to either side of your own, his hot canine breath blowing past your ears. He stays there for a few moments, completely still... before suddenly pulling his heads back and ", false);
            if (this.player.vaginas.length > 0 && this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_NAGA)
                this.outputText("slamming his twin dicks into your " + this.vaginaDescript(0) + " and your " + this.assholeDescript() + ".  ", false);
            else
                this.outputText("slamming his lower dick into your " + this.assholeDescript() + ", while rubbing the other between the cheeks of your " + this.buttDescript() + ".  ", false);
            if (this.player.vaginas.length > 0 && this.player.lowerBody != appearanceDefs_1.LOWER_BODY_TYPE_NAGA) {
                if (this.player.vaginalCapacity() < this.monster.cockArea(0))
                    this.outputText("You feel an intense mixture of sensations in your lower body as your " + this.assholeDescript() + " feels like it is being torn apart, while your " + this.vaginaDescript(0) + " is filled with an intense pleasure at being filled with the creature's large member.  ", false);
                else
                    this.outputText("Your lower body explodes with pain as the hellhound forces himself in too quickly for either your " + this.assholeDescript() + " or your " + this.vaginaDescript(0) + " to handle.  ", false);
                ...
                if (this.player.cuntChange(this.monster.cockArea(0), false))
                    this.outputText("The beast howls as your " + this.vaginaDescript(0) + " is stretched to accommodate the large shaft.  ", false);
                ...
                if (this.player.vaginas[0].vaginalWetness < appearanceDefs_1.VAGINA_WETNESS_WET)
                    this.outputText("The pause gives your " + this.vaginaDescript(0) + " time to moisten, ensuring the next thrust won't be quite as rough.  ", false);
                this.outputText("This time the beast starts pumping in and out more gently, only a short distance at a time as the hellhound continues panting.  As the pain in your " + this.assholeDescript() + " fades, you start feeling pleasure to match the sensations rising from your " + this.vaginaDescript(0) + ". Each thrust of the beast's twin manhoods bring you closer and closer to your peak.\n\n", false);
                //Cum
                this.outputText("As you reach your climax, the beast howls and you feel its incredibly hot seed pour into you.  ", false);
                if (this.player.cor < 40)
                    this.outputText("You moan as your insides begin to heat up. The uncomfortably hot sensation only grows as more and more of its fiery seed is pumped into your body. After what feels like an eternity, the beast pulls out of you. He gives your " + this.vaginaDescript(0) + " and your " + this.assholeDescript() + " a single extended lick with its long dog-like tongue before running off out of sight. The tainted heat inside you proves to be too much and you pass out. After some time passes, you wake up to find the corrupt warmth inside you has thankfully faded away. You're able to stand up again, but the damage is done and the creature's seed has left you feeling rather weak.", false);
                else
                    this.outputText("His flaming seed brings about a pleasure you had not expected; your insides feel like they are burning with passion and power.  It is an incredible and fiery experience, one that you don't think you could have had if it wasn't for the power of corruption that you've gained since you got here. Too soon, the beast pulls out of you.  He gives your " + this.vaginaDescript(0) + " and your " + this.assholeDescript() + " a single extended lick with his long dog-like tongue before he runs off. You quickly look over and manage to catch a glimpse of its tail before it disappears from view, just before your body falls into a deep sleep. When you wake, you can still feel the afterglow of the hot seed inside you.", false);
                //Preggers chance!
                this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_HELL_HOUND, PregnancyStore_1.PregnancyStore.INCUBATION_HELL_HOUND, 101);
            }
            else {
                this.outputText("Your lower body explodes with pain as the hellhound forces himself in too quickly for your " + this.assholeDescript() + " to handle. He pauses and pants for a few seconds, but you barely have enough time to catch your breath before the beast starts thrusting in and out again. However, this time the beast starts pumping in and out more gently, only a short distance at a time as the hellhound continues panting.  As the pain in your " + this.assholeDescript() + " fades, you start feeling strong pleasure from it. Each thrust of the beast's lower manhood, combined with the upper one tickling and teasing your " + this.buttDescript() + " above it brings you closer and closer to your peak.\n\n", false);
                //Cum
                this.outputText("As you reach your climax, the beast howls and you feel its incredibly hot seed pour into you and onto your back.  ", false);
                if (this.player.cor < 40)
                    this.outputText("You moan while trying to break free to get the heat off your back... but the beast keeps a firm grip on you as more and more of its fiery seed is pumped into and onto your body. After what feels like an eternity, the beast pulls out of you. He gives your " + this.assholeDescript() + " a single extended lick with his long dog-like tongue before running off out of sight. You are finally able to roll around and get the heat off of your back, but you can do nothing about the tainted warmth inside you. The heat proves to be too much and you pass out. After some time passes, you wake up to find the fire inside you has thankfully faded away. You're able to stand up again, but the damage is done and the creature's seed has left you feeling rather weak.", false);
                else
        ...
        hellHoundGetsRaped() {
            ...
            if (this.player.gender == 0)
                this.outputText("The two heads stare at your lack of sexual endowments for a few seconds before looking up at you sadly.  With a whine, the hellhound wanders off.  Feeling rather unsatisfied, you think that you should probably fix your lack of sexual 'parts'...", false);
            else
                this.player.orgasm();
            this.cleanupAfterCombat();
        }
        ...
        HellHoundMasterEncounter() {
            ...
            else if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00141] == 1) {
                //Second Encounter (D)
        ...
        giveUpLethicite() {
            ...
            if (this.player.keyItemv2("Marae's Lethicite") == 0)
                this.simpleChoices("Give All", this.giveALLTHELETHICITES, "Give Part", this.giveLethicitePiece, "", undefined, "", undefined, "", undefined);
            else
                this.doNext(this.giveLethicitePiece);
        }
        //Regular Lethicite
        giveLethicitePiece() {
            this.outputText("", true);
            //Give a single piece of Lethicite, get hellfire
            this.outputText("You produce the pink crystal and hand it to the master.  As the crystal touches his hand, he gives a low growl of pleasure and holds the crystal up to his eyes.  \"<i>Ah yes, excellent!  Thank you so much for this tasty treat of power.</i>\"\n\n", false);
            //if (PC gave ⅔ Merae's crystal)
            if (this.player.keyItemv2("Marae's Lethicite") == 1) {
                this.outputText("He looks at the crystal for a moment, before biting off half of it and giving the other half back to you.  \"<i>This is enough for the hellfire, I think.  Go ahead and keep the rest, my favorite fan!</i>\"\n\n", false);
                //Replace ⅔ Merae's Lethicite with regular lethicite.
                this.player.addStatusValue(StatusAffects_1.StatusAffects.MaraesLethicite, 2, 1);
            }
            else {
                //Remove 1 lethicite crystal from the PC
                this.player.addStatusValue(StatusAffects_1.StatusAffects.MaraesLethicite, 2, 1);
            }
            this.outputText("He rolls the crystal around in his mouth for a few moments before swallowing the crystal.  In a moment, white flames rise up around his body, and he gives you a wicked grin.  \"<i>Now, let me give you the gift promised for this tribute.</i>\"\n\n", false);
            this.outputText("He extracts a special cup from his throne, and starts to stroke the two of his large 10 inch pointed members with one hand.  \"<i>Watch closely, I want you to see where this power comes from.</i>\"  He starts to pant as the movements of his hands intensifies.  At the same time the aura concentrates on his pair of cocks and he brings the cup in front of them.  He gives a satisfied groan, and white hot cum sprays around the cup, carrying the same flame.  Clearly he isn't finished yet, and he brings the cup under his equipment, to catch a spray of less masculine fluids, flowing out from the omnibus's other genitals.\n\n", false);
            this.outputText("Afterwards, there is quite the pool of hot fluids on the ground around the omnibus, but he seems to think that enough was collected into the cup and hands it to you with a smile.  \"<i>Drink up my special friend, and partake in my hellfire.</i>\"  You put the cup to your lips and down the hot fluid.  In moments, you feel a rush pass through your body, and your stomach fills with heat and power.  You bring out the rush, and let out a roar of corrupt flames.  The master holds out his arms and grins as the wave of hellfire passes over him.\n\n", false);
            this.outputText("He pants, and waits for a moment to relish the feeling that your flames gave him.  \"<i>Now my young pet, you have the greatest power I've given my hounds.  Relish this gift!</i>\"  he declares before sending you on your way.  Some time later, you find yourself at the base of the mountains, your will once again your own.  You take a few experimental breaths, and can easily feel the fires within you.  It seems that you do indeed now have the power to breathe hellhound flames.\n\n", false);
            this.outputText("After a moment, you notice that something else seems off... the world seems to be slightly tinged red.  Worried that something else might have been done to you, you find some water to look at your reflection.  After a moment of shock, you steady yourself, and slowly tell yourself that you now have visible fires in your eyes and mouth.  This is going to take some getting used to.\n\n", false);
            this.outputText("<b>You now have the power to breath hellfire!</b>  (This power remains available to you so long as you maintain a corruption of at least 50.)", false);
            ...
            this.player.createPerk(PerkLib_1.PerkLib.Hellfire, 0, 0, 0, 0);
            //Hellhounds no longer encounterable.
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00141]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        //Merae's Lethicite
        giveALLTHELETHICITES() {
            ...
            this.outputText("You pull out the giant pink crystal that you stole from Merae.  At the sight of the gem, the demon's eyes go so wide, you almost can't believe that they stay in his head.  \"<i>Is that what I think... yes, YES! This is quite the prize you have brought me, my wonderful imitator!</i>\"  He snatches the crystal out of your hands and cradles it in his hands for a few moments, a crazed hungry look in his eyes.  You remain in his power, and can do nothing but watch as he raves for a few minutes with the jewel in his hands.\n\n", false);
            this.outputText("\"<i>Hum, hum, hum.</i>\"  He chuckles.  \"<i>The crystal of a goddess, this is going to bring changes, oh yes.</i>\"  The crystal flares up as he grips it more tightly.  \"<i>And you, oh you deserve so much more than just hellfire for this gift.  Come!</i>\"  He calls out.  In a moment, the biggest hellhound you've ever seen rushes into the room.\n\n", false);
            //if (PC has two dog dicks)
            if (this.player.dogCocks() >= 2) {
                //the male bad end
                this.outputText("This hound is quite clearly a she, bearing a massive septuplet of breasts, and wide hips.  She is also quite clearly pregnant, and radiates an intense aura of power.  One of her two heads intones towards the crazed omnibus, \"<i>You called me master?</i>\"  \"<i>Yes I did my precious Cremera!  Have sex with this imitation at once!  " + this.player.mf("He", "She") + " is to become your third head!</i>\"\n\n", false);
                this.outputText("Instantly Cremera turns around and presents to you her waiting sloppy twin cunts.  The hellhound master walks behind you and slaps you on the ass.  \"<i>Don't keep her waiting.</i>\"  He says as a shudder passes through you and your " + this.player.armorName + " falls to the ground around you.\n\n", false);
                ...
                if (this.player.totalCocks() > 2 || this.player.cockThatFits(60) < 0) {
                    this.outputText("He then reaches around your waist and takes a hold of your " + this.multiCockDescriptLight() + ".  \"<i>Before we get started, let's make sure you're just right for Cremera.</i>\"  He then reforms your body to have twin doggy pricks of appropriately sized.  \"<i>Now.</i>\"\n\n", false);
                    ...
                    this.player.cocks[1].cockType = CockTypesEnum_1.CockTypesEnum.DOG;
                    this.player.cocks[0].cockThickness = 3;
                    this.player.cocks[1].cockThickness = 3;
                    this.player.cocks[0].cockLength = 14;
                    this.player.cocks[1].cockLength = 14;
                    while (this.player.cocks.length > 2) {
                ...
                //female part
                this.outputText("The hound is quite clearly a he, carrying a pair of 15 inch long black pointed shafts, and a sack containing a quad of cantaloupe sized balls.  He radiates an intense aura of power.  One of his two heads intones towards the crazed omnibus, \"<i>You called me master?</i>\"  \"<i>Yes I did my precious Cimer!  Have sex with this imitation at once!  " + this.player.mf("He", "She") + " is to become your third head!</i>\"\n\n", false);
                this.outputText("Instantly Cimer moves behind you and puts one of his clawed hands on your head and starts to push you down, his twin dog dicks pushing into your back.  The master steps up in front of you and puts his hand under your chin.  \"<i>Don't disappoint my pet.</i>\"  He says and brings his hand down your body, and your " + this.player.armorName + " tumbles to the ground.  Before Cimer has a chance to push you down, you bend over, ready to take his members in your " + this.vaginaDescript(0) + " and your " + this.assholeDescript() + ".  \"<i>Wait, one last preparation...</i>\"\n\n", false);
                this.outputText("He steps around behind you, and you feel something cool and small get put inside your " + this.assholeDescript() + ".  It seems to extend further inside you, and wriggles around.  You get an odd feeling in your gut, like it's being rearranged.  After a moment the object is removed and you notice that your " + this.buttDescript() + " now feels remarkably like your " + this.vaginaDescript(0) + "!  \"<i>How do you like your new second vagina?  It will be perfect for my pet's rods, I even added the knots back to his cocks.  Normally, knots are about the only thing I don't like about regular old doggies, but for this, it's perfect.</i>\"\n\n", false);
                this.outputText("You barely register that he's finished talking when your whole lower body feels like it's being filled in the most wonderful way imaginable!\n\n", false);
                //If (PC's vag can't fit an area of 45)
                if (this.player.vaginalCapacity() < 45) {
                    if (this.player.vaginas[0].virgin) {
                        this.outputText("Relieving both your virgin holes of their virginity in one thrust, y", false);
                    }
                    else
                        this.outputText("Y");
                    //stretch vag to very loose
                    this.player.vaginas[0].vaginalLooseness = appearanceDefs_1.VAGINA_LOOSENESS_GAPING;
                    this.outputText("our two cunts quickly stretch larger to accommodate the intruders.\n\n", false);
                }
                this.outputText("You let out a moan of pleasure from the pleasure of being filled.  The hound doesn't hesitate at all, and just thrusts into you with abandon.  You can't believe the feral feeling of it all, and that your twin womanhoods manage to so easily take the members and flow around them.\n\n", false);
                this.outputText("In moments, you feel Cimer's members explode inside you with their wonderful hot seed, and his new knots swell to tie the two of you together.  Though, something feels wrong, you didn't feel an orgasm yourself!  You give a whimper and try to thrust against Cimer's pair of dog pricks inside you.  Suddenly there is a loud smack, and you feel like Cimer was just propelled inside you even further!  It's an incredible feeling, almost like he is pushing past your " + this.buttDescript() + ", but you still can't cum!  \"<i>This isn't enough!  Further inside, further!</i>\"  You hear the master yell.  Once again you feel Cimer being forced further and further inside you, again accentuated by a loud smacking noise.  Again, you find yourself unable to achieve sweet release, but you hardly have time to register that, as there is another burst and a smack, and another, and another.  It almost feels like your " + this.buttDescript() + " is being smacked...\n\n", false);
                this.outputText("After what feels like hours of painful pleasure without release, you're smacked on your rear one last time, and it feels like Cimer bursts through your body completely.  This finally frees the floodgates, and you feel like you're releasing everything in your body in the most powerful orgasm you've ever felt.  You pant for a moment and look down in front of you.  You can see your " + this.player.allBreastsDescript() + " and your pregnant belly in front of you. You also see a package of demonic dicks sticking out in front of you, with a quad of hot balls resting underneath.  In front of you is a large pool of white steaming fluid, with a pink crystal resting in the middle.\n\n", false);
                this.outputText("<i>Well my new pet, what do you think?</i>\"  A voice calls out in your head.  You look to the side, and see one of Cimer's heads on your right, and the other on your left.  Your hands seem to move on their own, and reach down to touch your " + this.vaginaDescript(0) + ".  Another voice calls out in your mind, <i>They are wonderful master.</i>\"\n\n", false);
            }
            this.outputText("You feel inclined to agree at the wonderful feeling of your new body, and the incredible amount of power you feel rushing through you.  You move one of your hands so that you can play with both your dicks and your cunts, relishing in the feeling of them and the flames that lie within.  You gasp for a moment, and open your mouth as a rush of heat rises up from your chest and a burst of flame emerges from your mouth.\n\n", false);
            this.outputText("A powerful demon steps out in front of you, and picks up the crystal.  You can feel a strong connection with him, and you know this is your master.  \"<i>Well now, I think you need a new name now in commemoration of being the first three headed hellhound, and for being the one who will give me the world.</i>\"  He unceremoniously puts the crystal in his mouth and swallows it.  \"<i>Your new name is Cerberus, and you're my greatest pet.</i>\"  He steps closer and looks into your center head's eyes for a moment.  \"<i>That's much better than being a champion ever was, isn't it?</i>\"  You can't help but eagerly nod in agreement.", false);
            this.getGame().gameOver();
        }
        hellHoundPropahRape() {
            this.outputText("", true);
            if (this.monster.HP < 1)
                this.outputText("The hellhound's flames dim and the heads let out a whine before the creature slumps down, defeated and barely conscious. After all the trouble you had with him, you want to have some fun in exchange. \"<i>Bad boy, roll over!</i>\" you command as if the hellhound was just an ordinary domestic dog. To your surprise the creature actually does as you say. Accepting your victory he rolls onto his back, exposing his human-like abs and throat, signaling submissiveness. Looking down on your foe, your lustful gaze rests upon his privates. You examine the unusual ballsack with its quadruple testes, but the real treasure is yet to be found. Pulling on his sheath you reveal his twin dog members. An obsessive idea comes to your mind and you are determined to put his magnificent tools to a good use.\n\n", false);
            else
                this.outputText("Unable to bear hurting you anymore, the hellhound's flames dim as he stops its attack. The two heads look at you, whining plaintively. After all the trouble you had with him, you want to have some fun in exchange. \"<i>Bad boy, roll over!</i>\" you command as if the hellhound was just an ordinary domestic dog. To your surprise the creature actually does as you say. Accepting your victory he rolls onto his back, exposing his human-like abs and throat, signaling submissiveness. Looking down on your foe, your lustful gaze rests upon his privates. You examine the unusual ballsack with its quadruple testes, but the real treasures are pulsating just above it. Pulling on his sheath, you smile as his twin members twitch in response. An obsessive idea comes to your mind and you are determined to put his magnificent tools to a good use.\n\n", false);
            this.outputText("You start caressing his pair of wonderful canine cocks. Although the hellhound is pretty out of it, his dicks ", false);
            if (this.monster.HP < 1)
                this.outputText("spring to life, extending rapidly from the sheath. Tentatively you give one of them a gentle lick, being rewarded with a drop of pre-cum.\n\n", false);
            else
                this.outputText("still manage to leak plenty of hot, steamy pre-cum all over his belly. Tentatively you give one of them a gentle lick, being rewarded with a dollop of the stuff.\n\n", false);
            //--- IF CORRUPTION < 20 ---
            if (this.player.cor < 20) {
                this.outputText("The corrupt juice burns on your tongue, far worse than the hottest spicy dish you have ever had. You instantly back off from his member, cursing this abomination of nature. Leaving the submissive creature as it is, you head back for your camp.", false);
            ...
            //--- ELSE (CORRUPTION >= 20) ---
                ...
                if (this.player.cor < 40 && this.player.findPerk(PerkLib_1.PerkLib.Masochist) < 0) {
                ...
                //--- ELSE (CORRUPTION >= 40) ---
                this.outputText("His magical natural flames fill your body with fierce warmth, arousing you further. You pick yourself up, letting the hellhound's cocks nearly escape your nethers just to sit down again, taking the duo of dog members to the hilt. Grabbing his hind legs like the handlebars of an exercise machine, you bring yourself into position for a good amount of training. Gradually, you pick up the pace, rocking your hips up and down, enjoying the awesome double penetration.", false);
                if (this.player.biggestTitSize() > 1)
                    this.outputText("  Your " + this.chestDesc() + " jiggle in exquisite ways along with your bumping, grinding motions.", false);
                this.outputText("  Riding the hound for a couple of minutes, you feel the dick in your " + this.assholeDescript() + " extending, giving you a good stretching. Its brother in your " + this.vaginaDescript(0) + " does the same, pushing more and more girl-fluids out of your slippery slit while stimulating your sensitive clit from the inside. You lean forward, running your hands through your fuckpet's dense midnight black fur, feeling his animal body warmth. The hellhound is moaning and panting beneath you, unsure whether to fear you or to enjoy what you are doing to him.\n\n", false);
                //--- IF PC HAS PENIS ---
                if (this.player.hasCock()) {
                    this.outputText("His canine cock in your anus stimulates your prostate perfectly. His exotic black dong applies pressure in parts of your body you wouldn't expect to get such pleasure from.", false);
                    //--- IF ONE PENIS ---
                    if (this.player.totalCocks() == 1)
                        this.outputText("  Soon your own " + this.cockDescript(0) + " reacts, quickly growing into a full throbbing erection. You leave your member alone, and it keeps flapping against the hellhound's belly while you ride him.", false);
                    //--- ELSE ---
                    else
                        this.outputText("  Soon " + this.sMultiCockDesc() + " reacts, quickly growing into a throbbing erection.  You leave your members alone, and they flap against the hellhound's belly while you ride him.", false);
                }
                //--- IF PC HAS BALLS ---
                if (this.player.balls > 0)
                    this.outputText("  Whenever you lower your hips to your mates belly, your " + this.ballsDescriptLight() + " touches his. The magical flames fill your scrotum with unnatural heat but no pain. You literally feel the cum in your balls boiling upwards, building up immense pressure.", false);
                this.outputText("\n\n", false);
                this.outputText("Way too early, the two doggie pricks stuffed inside you start to twitch, unloading four balls worth of spunk into you. In ecstasy, the hellhound's eyes look in four different directions. The dual eruptions in your love-canal and rectum feel amazing as they pulse in and out of sync, dumping cum into your body over and over.  The hellhound's contractions ebb away as he finishes, but you're not done yet. You slowly start tilting your hips back and forth, continuing to fiercely fuck the prime member while the other rests nearly motionless in your ass. Soon the hellhound whines from the unwanted stimulation of his now sensitive pricks, but he is too defeated to put up much of a struggle.\n\n", false);
                this.outputText("Slowly but steadily you bring yourself to the verge of orgasm. The hellhound under you squirms and tries to get free, his hind legs flailing through the air behind your back. You keep riding his magnificent member, grinding it up and down in your moist cave. Finally you feel the familiar rippling of your vaginal walls, milking his cock and intensifying your pleasant sensations. Clamping down on his members, you keep moving your hips in a circling motion, working your clit, vagina and butt in equal measure. The sensations eventually grant you an intense orgasm while the hellhound's still-distended members apply the perfect pressure to all of your sensitive spots and prolong your bliss.", false);
                //--- IF PC HAS PENIS ---
                if (this.player.totalCocks() > 0) {
                    // --- IF ONE PENIS ---
                    if (this.player.cockTotal() == 1)
                        this.outputText("Your " + this.cockDescript(0) + " twitches as it ejects its sticky load.", false);
                    //--- ELSE ---
                    else
                        this.outputText("Your " + this.multiCockDescriptLight() + " twitch as they eject their sticky loads.", false);
                    this.outputText("  Keeping up your motions, you scatter your cum across the hellhound's body and the ground nearby.", false);
    ...
    exports.HellHoundScene = HellHoundScene;
});
//# sourceMappingURL=HellHoundScene.js.map