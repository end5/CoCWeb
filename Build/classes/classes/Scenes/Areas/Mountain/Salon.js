define(["require", "exports", "../../../BaseContent", "../../../CoC", "../../../GlobalFlags/kFLAGS", "../../../StatusAffects", "../../../PerkLib", "../../../PregnancyStore"], function (require, exports, BaseContent_1, CoC_1, kFLAGS_1, StatusAffects_1, PerkLib_1, PregnancyStore_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class Salon extends BaseContent_1.BaseContent {
        constructor() {
            super();
        ...
        timeChange() {
            this.flags[kFLAGS_1.kFLAGS.SALON_PAID] = 0;
            if (this.model.time.hours > 23) {
                if (this.flags[kFLAGS_1.kFLAGS.LYNNETTE_CARRYING_COUNT] == 0 || this.flags[kFLAGS_1.kFLAGS.LYNNETTE_PREGNANCY_CYCLE] != 4) {
                    this.flags[kFLAGS_1.kFLAGS.LYNNETTE_PREGNANCY_CYCLE]++;
                }
                if (this.flags[kFLAGS_1.kFLAGS.LYNNETTE_PREGNANCY_CYCLE] == 7) {
                    this.flags[kFLAGS_1.kFLAGS.LYNNETTE_PREGNANCY_CYCLE] = 0;
                }
            }
            return false;
        }
        ...
        salonGreeting() {
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.HairdresserMeeting) >= 0) {
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.HairdresserMeeting, 0, 0, 0, 0);
        ...
        salonFavoritesPaymentMenu() {
            var blow = undefined;
            if (this.player.hasCock())
                blow = this.goblinHairDresserFacefuck;
            var minoCum = undefined;
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00142] > 0)
                minoCum = this.goblinHairDresserFacefuck;
            this.menu();
            if (this.flags[kFLAGS_1.kFLAGS.LYNNETTE_PREGNANCY_CYCLE] >= 4 && this.player.hasCock())
                this.addButton(5, "Fuck Goblin", this.fuckLynnette);
        ...
        buyMinoCum() {
            if (this.player.gems < 60) {
                ...
                if (this.flags[kFLAGS_1.kFLAGS.SALON_PAID] == 0)
                ...
                this.player.gems -= 60;
                this.outputText("You happily give Lynnette 60 gems and pick up the bottle full of glistening, heavenly cum.  ", true);
                this.statScreenRefresh();
                this.inventory.takeItem(this.consumables.MINOCUM, this.camp.returnToCampUseOneHour);
            }
        }
        salonPurchaseMenu() {
            this.flags[kFLAGS_1.kFLAGS.SALON_PAID] = 1;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00142] > 0)
                minoCum = this.buyMinoCum;
            if (this.player.hairLength > 2)
                cutShort2 = this.cutShort;
            if (this.player.hairLength > 13)
                cutMedium2 = this.cutMedium;
            if (this.player.hairLength >= 26)
                cutLong2 = this.cutLong;
            if (this.player.hairLength < this.player.tallness)
                lengthening = this.hairGrow;
            if (this.player.femininity < 100 && this.player.gender == 2)
                mudFacial2 = this.mudFacial;
            else if (this.player.femininity < 85 && (this.player.gender == 0 || this.player.gender == 3))
                mudFacial2 = this.mudFacial;
            else if (this.player.femininity < 70 && this.player.gender == 1)
                mudFacial2 = this.mudFacial;
            else if (this.player.femininity < 100 && this.player.findPerk(PerkLib_1.PerkLib.Androgyny) >= 0)
                mudFacial2 = this.mudFacial;
            if (this.player.femininity > 0 && this.player.gender == 1)
                sandFacial2 = this.sandFacial;
            else if (this.player.femininity > 30 && this.player.gender == 2)
                sandFacial2 = this.sandFacial;
            else if (this.player.femininity > 20 && (this.player.gender == 0 || this.player.gender == 3))
                sandFacial2 = this.sandFacial;
            else if (this.player.femininity > 0 && this.player.findPerk(PerkLib_1.PerkLib.Androgyny) >= 0)
                sandFacial2 = this.sandFacial;
            this.menu();
        ...
        hairDresserGreeting() {
            ...
            this.outputText("   \"<i>I apologize for my daughters,</i>\" she says as she presses herself against you.  \"<i>They're a bunch of brainless hussies for the most part.  My name is Lynnette, and welcome to my salon!  You want your hair cut or lengthened?  We've got you covered, and we don't ask for much - just a shot of cum.", false);
            if (this.player.cockTotal() == 0) {
                this.outputText("  You look like you don't got any of your own, but we've got glory holes in the back if you need to get some.  Just don't swallow too much, ok?</i>\"\n\nShe shows you to the back of the cave, which is boarded-up.  There are about 20 holes in boards, and most are empty.  While you watch, a few new dicks slide in, and just as quickly the goblin's daughters commence sucking and fucking them.  There are only a few you could take a crack at - do you blow one (and if so which one)?", false);
            }
            else {
                this.outputText("  I'll even do you the favor of letting you blow it in my mouth, I've already got a bun in the oven.  So what do you say?  Want a spooge and a haircut?  Or would you rather go get your payment from one of the gloryholes in the back, you " + this.player.mf("kinky boy", "naughty girl") + "?</i>\"\n\n", false);
                this.outputText("In the very back of the salon you can see a boarded-up wall with holes cut in it, some of which are currently plugged by various monstrous penises.  Do you let the goblin blow you, or do you go suck your payment from one of them?", false);
            }
        ...
        hairDresserRepeatGreeting() {
            ...
            if (Salon.rand(5) == 0 && (this.player.findPerk(PerkLib_1.PerkLib.MinotaurCumAddict) >= 0 || this.flags[kFLAGS_1.kFLAGS.MINOTAUR_CUM_ADDICTION_STATE] > 0)) {
                this.minotaurCumBukkakeInSalon();
                return;
            }
            //Had babies announcement!
            if (this.flags[kFLAGS_1.kFLAGS.LYNNETTE_PREGNANCY_CYCLE] == 4 && this.flags[kFLAGS_1.kFLAGS.LYNNETTE_CARRYING_COUNT] > 0) {
                this.outputText("As soon as you enter the Salon, Lynnette is beaming ");
                if (this.player.tallness >= 48)
                    this.outputText("up ");
                this.outputText("at you. \"<i>Hey there, honey. Come for some more service or to check up on the kids?</i>\" She pats her now-flat midsection. \"<i>I popped them out last night. We had " + Salon.num2Text(this.flags[kFLAGS_1.kFLAGS.LYNNETTE_CARRYING_COUNT]) + " kids... all girls, of course.</i>\" She tucks a lock of beautifully styled hair behind an elfin ear. \"<i>Now you be sure and let me know when you want to contribute to my baby-bank again.</i>\"");
                if (this.flags[kFLAGS_1.kFLAGS.LYNNETTE_BABY_COUNT] > 0)
                ...
                this.flags[kFLAGS_1.kFLAGS.LYNNETTE_BABY_COUNT] += this.flags[kFLAGS_1.kFLAGS.LYNNETTE_CARRYING_COUNT];
                this.flags[kFLAGS_1.kFLAGS.LYNNETTE_CARRYING_COUNT] = 0;
                //If favorite!
                if (this.flags[kFLAGS_1.kFLAGS.LYNNETTE_ANNOUNCED_APPROVAL] == 1) {
            ...
            //Non-Pregnant Greetings:
                ...
                if (this.flags[kFLAGS_1.kFLAGS.LYNNETTE_MET_UNPREGNANT] == 0) {
                    this.flags[kFLAGS_1.kFLAGS.LYNNETTE_MET_UNPREGNANT] = 1;
                    this.outputText("Lynnette's familiar face greets you at the door to her salon once more, and she waves you in with a beatific smile plastered upon her face. Clinging to her like a second skin, the businessgoblin's dress highlights her surprisingly flat midsection; she's not pregnant!");
            ...
            //Standard repeats
                ...
                this.outputText("Lynnette the goblin answers the door and lets you in, waving you deeper into her shop.  Her shining black dress barely contains her fertile-hips and jiggling chest as she greets you, \"<i>Welcome back, honey!  ", true);
                if (this.player.cockTotal() == 0) {
                    this.outputText("I see you still can't make payment for our services on your own.  No worries, the glory holes in the back are pretty popular with the demons and monsters, just go back there and catch some spooge and we'll see about helping with your hair, ok?</i>\"\n\n(There are a number of dicks in the glory hole, which do you want to deal with (if you're willing at all)?", false);
                }
                else {
                    this.outputText("Will you be getting our normal services?  Just one BJ per hair treatment!  Or would you rather get it from the gloryholes in back?</i>\"", false);
                }
            }
            this.salonPaymentMenu();
        }
        ...
        gloryholeDoggie() {
            this.player.slimeFeed();
            this.outputText("", true);
            this.outputText("You sigh and kneel down to bring yourself level with the dog-dick hanging out of the wall.  It's pointed at the tip with a swollen circular bulb at the base.  As a matter of fact, the dog-dick's owner must be pretty excited to be here - it's dripping cum and the knot has swollen so large that it can't fit back through the hole.\n\n", true);
            if (this.player.cor < 33) {
                this.outputText("It's a struggle to force your lips apart and take the strange thing in your mouth.  You feel like a freak, but make yourself get to work servicing the male who'll be covering your hair treatment today.  It tastes salty and sweaty and has a potent musky scent that excites you in spite of your better judgment.  You find yourself starting to get into it as you lick and slurp, humming with pleasure.  You reach up to touch the knot and the dog-cock jumps in your mouth, spurting a wad of thick cum into your throat.  You pull back most of the way and pump the cock, collecting the jism in your mouth.\n\n", false);
                this.dynStats("lus", 15, "cor", .25);
            }
            else if (this.player.cor < 66) {
                this.outputText("You open wide and take as much of the pointed dick as you can into your mouth.  A few times you nearly gag yourself, but you manage to get most of the way down to the thick swollen knot.  You start sliding back and forth, breathing in the musky animalistic scent of your 'client' and become aroused by the situation more and more.  You reach up and caress the knot, squeezing gently and stroking the dick until it unloads a thick wad of cum into your mouth.  You pull back and catch the fruits of your labor in your mouth, milking the dick with your hands until it's finished and the dick pops back through the hole.\n\n", false);
                this.dynStats("lus", 25, "cor", .25);
            }
            else {
                this.outputText("You throw yourself onto the swollen dog-cock and easily engulf the whole thing, spreading your lips wide around the thick knot.  You can feel it bouncing the uvula in your throat around but you manage to supress your gag reflex like a good slut while you work the sweaty dick, giving it a thorough tongue bath.  You wrap your lips around the base of the knot, feeling it start to stretch your jaws apart.  You pull back before it can lock you like that, and squeeze the knot in your hands.  It cums, unloading thick wads of gooey cum into your mouth.\n\n", false);
        ...
        gloryholeMinotaur() {
            this.player.slimeFeed();
            this.outputText("Your eyes are drawn to the huge minotaur cock, and you instinctively kneel down in front of it.\n\n", true);
            this.outputText("It's the largest available member in the room by a considerable margin, and from your position on your knees, it looks even more massive; it's over two feet long, and has three rings of prepuce spaced around its length. You can just barely span your entire hand around its thickness. You open your mouth wide and lean forward, taking the thick, spongy head into your mouth. The taste is incredibly strong, and its musk is as thick as the minotaur's dick itself. You moan in pleasure, and start bobbing your head back and forth, taking more and more of the dick into your mouth. You stroke the rest of the cock in time with your sucking. You can hear muffled grunting and snorting coming from the other side of the wall, obvious sounds of approval from your partner.\n\n", false);
            this.outputText("Driven on by the minotaur's reactions, you take more and more of the minotaur cock into your mouth. As you work your mouth around the first ring, you open up the top section of your " + this.player.armorName + ", freeing up your " + this.allBreastsDescript() + ". With each pass, you're able to take more and more of the bull dick down your throat. You caress your " + this.biggestBreastSizeDescript() + " while moaning around the dick. When you get your mouth around the second ring, the minotaur's cock throbs sharply, and his cum explodes in your mouth. Your eyes bulge in shock, and you pull off the cock as quickly as you can. You swallow the first several shots of thick, rich minotaur cum, while the rest shoots all over your face and tits. You ");
            if (this.player.biggestTitSize() > 1)
                this.outputText("hold up ");
            else
                this.outputText("arch your back to expose ");
            this.outputText("your [chest] as cum rains down upon you. By the time his orgasm stops and his dick goes limp, your face and [chest] are covered in a thick layer of spooge.\n\n", false);
        ...
        goblinHairDresserFacefuck() {
            this.spriteSelect(38);
            this.outputText("Lynnette licks her lips and practically tears her way into your " + this.player.armorName + ", having your crotch exposed in seconds.  Your " + this.cockDescript(0) + " flops out immediately, slapping her on the nose as it grows hard.  She wraps both hands around you and begins pumping with practiced ease, flicking her tongue over your crown and wrapping her lips ", true);
            if (this.player.cocks[0].cockThickness >= 4)
                this.outputText("around as much of you as she can", false);
            else
                this.outputText("around your first few inches", false);
            this.outputText(".  She slips her tongue down your urethra, and arches her back, popping the straps on her dress and letting her oversized tits engulf your shaft.  Milk sputters and dribbles from the lactating goblin, lubricating her breasts and hands as she pleasures every inch of you.\n\n", false);
            this.outputText("It's impossible to hold back while receiving such expertly given stimulation, and you blow your load, bulging her cheeks out like a squirrel's.", false);
            if (this.player.cumQ() >= 250)
                this.outputText(" She can't hold it all and suddenly starts swallowing as runnels of it escape her nose and a wave of it rolls down her lips.", false);
            this.outputText("  In time it ends, and she pops back, spitting most of the cum into a funnel.  It washes down a pipe and you have to wonder if there's some horny goblin girl at the other end with her cunt spread wide.", false);
        ...
        hairDressingMainMenu() {
            this.spriteSelect(38);
            this.outputText("Lynnette offers and explains their options, \"<i>So what'll it be hun?  We could cut it down or give you a lengthening treatment. Or you can get a hair-dye to use on your own.  Just remember to come back in a few days for a touchup.</i>\"", false);
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00142] > 0) {
        ...
        cutShort() {
            ...
            if (this.player.hairType == 4) {
                this.outputText("Lynnette stares at you when you ask for a cut.  \"<i>Nothing doing, hon; that stuff looks alive and I don't want blood all over my nice floor.  Thanks for contributing to the white file, though; maybe we can do something else?</i>\"\n\n", false);
                this.salonPurchaseMenu();
                return;
            }
        ...
        cutLong() {
            ...
            //-trying to get a goblin to cut tentacle hair:
            if (this.player.hairType == 4) {
                this.outputText("Lynnette stares at you when you ask for a cut.  \"<i>Nothing doing, hon; that stuff looks alive and I don't want blood all over my nice floor.  Thanks for the contributing to the white file, though; maybe we can do something else?</i>\"\n\n", false);
                this.salonPurchaseMenu();
                return;
            }
            this.outputText("Lynnette and her daughters crowd around you with razor-sharp scissors, effortlessly paring down your " + this.hairDescript() + ".  When they've finished, you're left with ", true);
        ...
        hairGrow() {
            ...
            if (this.player.hairType == 4) {
                this.outputText("Lynnette looks dubiously at you when you ask for a lengthening treatment.  \"<i>No offense hon, but that stuff is basically like an arm or an organ, not hair.  I'm not a goblin chirurgeon, and I wouldn't try to lengthen it even if one of my disobedient daughters were here to donate some parts.  Sorry to make you shoot and scoot, but I can't help you.  Maybe we could do something else?</i>\"\n\n", false);
                this.salonPurchaseMenu();
                return;
            }
            this.outputText("Lynnette grabs a bottle and squirts a white fluid into your hair.  You really hope it isn't your payment.  But it must not be, as within short order you feel the added weight of ", true);
            this.temp = Salon.rand(3) + 3;
        ...
        minotaurCumBukkakeInSalon() {
            ...
            if (this.player.hasVagina() || this.player.hasCock()) {
                ...
                if (this.player.hasCock()) {
                    if (this.player.cumQ() < 100)
                        ...
                        this.outputText("pre-cum over a foot wide ", false);
                }
                this.outputText("winds over the rough-hewn floor behind you, clearly marking your passage to the overpowering musk.", false);
            }
            this.outputText("\n\n", false);
            ...
            this.outputText("You hear a deep, strangled sigh as more and more delicious pre floods your mouth, lighting your senses up with a fireworks show of pleasure", false);
            if (this.player.gender > 0)
                this.outputText(" and increasing the size of the puddle you're leaving on the floor", false);
            this.outputText(".  In between gulps of the fragrant fluid, you suck the swollen rod deeper and deeper into your mouth, gleefully suppressing your gag reflex as it pushes aside your uvula.  You work your throat, feverishly swallowing to suck it down.  A flare briefly distends your neck as it's taken deeper and deeper inside your form until your lips are puckered through the hole and you're sniffing the minotaur's pheromone-laced crotch.\n\n", false);
            this.outputText("The beast pulls back and starts pounding the hole, letting out deep, rumbling sighs of pleasure with each throat abusing glory-hole fuck.  If it weren't for his constant, bubbling preseed turning your throat to a slippery rut-hole you'd be rubbed raw, but instead you continue to lean forward, sniffing at his matted pubes every time he crushes them against your dick-stretched lips.  The other horny studs grunt with displeasure, but you reach out with your hands and grab hold two eager brutes' throbbing horsecocks.  Three out-of-sync heartbeats hammer through your hands and throat while you do your best to get them all off.\n\n", false);
            this.outputText("You let your eyes drift closed and lash your tongue back and forth across the minotaur's lowest medial ring, feeling his flare bulge larger inside you in response.  The beast-man batters at the wall, grunting in equal measures of passion and pent-up desire as his cock's tip stretches wide and locks itself inside you.  His urethra bulges in rhythmic contractions, stretching your lips around the already swollen shaft and signaling to your musk-addled mind that you're about to get what you desire.  You hum with blissful delight as your belly begins to gurgle, accepting long bursts of sticky minotaur drug.\n\n", false);
            this.outputText("Tied down by the cum-spurting flare locked in your gullet, you pump on the other two dicks with feverish speed and sway on your " + this.player.feet() + " as the narcotic spooge intoxicates your already-addled mind.  You can feel each muscular contraction pulsing through the bestial shaft while it finishes depositing the heavy, sticky load, and your eyes cross from the viscous inebriation that's pooling in your belly.  Drizzles of pre-cum soak into your arms and palms, drawn out from the frenzied pumping of your fists.  They won't come from just a hand though.  They need something... tighter.\n\n", false);
            this.outputText("You start moaning in drug-induced bliss, but your vocalized pleasure is interrupted by the squelching slurp of the softening shaft being pulled from your dick-puckered lips.  It drips a rope of cum over your mouth and chin as it pulls free from the wall, leaving behind one vacancy among the swarm of ready minotaur dicks.  You lick up your stud's leavings and purr in bliss, reaching through the hole to cup the departing minotaur's balls teasingly.  He grunts and walks out of your grip – sated for now.  You curl your fingers into a come-hither gesture, retract your arm through the sweat-lubricated glory-hole, and wait for one of the other minotaurs to come over.\n\n", false);
            this.outputText("The beast who kept your left hand so busy repositions himself at the now-vacant opening, and you decide to reward him for moving so quickly.  You lick the last of the salty cream from your lips and muse that he isn't the only one getting a reward, but the monstrous cow-man doesn't need to know that.", false);
            if (this.player.biggestTitSize() >= 2) {
                this.outputText("  You wrap the pillowy flesh of your " + this.allBreastsDescript() + " around the new member, pleasantly surprised by its girth and wide, already-flared tip.  Maybe you could have gotten him off with your hands after all?  ", false);
                if (this.player.biggestTitSize() < 6)
                    this.outputText("Even so, you can't quite get your breasts the entire way around him, so you make up for it by pressing it harder into you with your busy hands.  ", false);
                this.outputText("Runnels of pre cover the shaft and squish wetly between your tits, turning your body into a slip-n-slide that reeks of hot, sticky minotaur sex.", false);
            }
            else {
                this.outputText("You crush the member tightly against your chest, smearing your torso with the copious pre until you're like a hot, wet slip-n-slide of minotaur sex.  You make up for it by wrapping your arms around his prodigious thickness and squeeze him tightly with your hands, stroking him off with your whole body with enough tightness to make the poor mino' think he's in some poor adventurer's asshole.", false);
            }
            this.outputText("\n\n", false);
            this.outputText("You lower and raise yourself, bouncing up and down on your " + this.player.legs() + " to enhance the ", false);
            if (this.player.biggestTitSize() >= 2)
                this.outputText("tit-fucking ", false);
            else
                this.outputText("full-body handjob ", false);
            this.outputText("you're giving out.  In such a position, you're given the perfect view to watch as your strokes draw forth large bubbles of pre, and before you can lose your high, you latch onto the minotaur's vulnerable urethra and suck, tonguing in wide circles around it since you can't open wide enough to accommodate his flare.  Of course, all the attention just makes him flare wider, not just at the tip, but through the whole shaft.  ", false);
            if (this.player.biggestTitSize() >= 2)
                this.outputText("The sudden girth change sends an enticing ripple through your " + this.allBreastsDescript() + " that's pleasurable enough to make you moan into his steadily-widening urethra.  ", false);
            this.outputText("You pull off and bounce faster, lost to your lust and the haze of sex-musk permeating the air, intent on seeing just how much this huge stud can spray onto you.\n\n", false);
            this.outputText("The minotaur does not disappoint.  His hole dilates from the size of the approaching cum-blast, and you sink down his shaft slowly until it's aimed directly at your face.  You close your eyes and feel the first explosion splatter over your " + this.hairDescript() + " and forehead.  The next takes you full in the face, making it difficult to breathe through the mask of drug-like goo, but a few quick licks gives you a fix and makes it easy to breathe again.  On and on, the minotaur pumps fat ropes of spooge over your body until you're a syrupy, sticky mess that reeks of minotaur pheromones so strongly that dizziness overwhelms you and you fall free of the still-orgasming mino-cock, taking a few final blasts of seed on your " + this.chestDesc() + " and crotch.  Your hands instinctively shovel a few loads into your " + this.assholeOrPussy(), false);
            if (this.player.hasVagina())
                this.outputText(" while the animal part of your brain hopes it makes you pregnant with an equally girthy son", false);
            this.outputText(".\n\n", false);
            //ADD PREG CHECK
            //Preggers chance!
            this.player.knockUp(PregnancyStore_1.PregnancyStore.PREGNANCY_MINOTAUR, PregnancyStore_1.PregnancyStore.INCUBATION_MINOTAUR, 70);
            this.outputText("Giggling, you stagger over to the next cock in line and turn around, possessed with the idea of taking its spooge in the most direct way possible – anally.   You pull your butt-cheeks apart and lean back, surprising one of the horny beasts with the warmth of your " + this.assholeDescript() + " as you slowly relax, spreading over his flare.  He actually squirts ropes of something inside of you, but you've been around minotaurs enough to know that it can't be cum, at least not yet.  The slippery gouts of preseed make it nice and easy to rock back and spear yourself on the first few inches, ", false);
            if (this.player.analCapacity() < 80) {
                this.outputText("delighting in the drug-numbed pain of stretching yourself beyond your normal capacity.", false);
            }
            else if (this.player.analCapacity() < 140)
                this.outputText("delighting in the feeling of perfect fullness.", false);
            else
                this.outputText("delighting in realizing that you could take far larger than even this virile specimen!", false);
            //(buttchange here: 90)
            ...
            if (!this.player.hasCock())
                this.outputText("drags through your body, touching sensitive nerves you didn't even know you had until you cum, shuddering and shaking like a wanton whore.", false);
            else
                this.outputText("presses on your prostate as it squeezes by, making " + this.sMultiCockDesc() + " drip and spurt freely until you can bear it no longer and cum, shaking and shuddering like a wanton whore.  Jizz drips and pours from " + this.sMultiCockDesc() + " in a steady stream that pools on the floor, slowly rolling towards a drain that doubtless empties into a tank or greedy goblin cunt.", false);
            this.outputText("\n\n", false);
            this.outputText("The strength goes completely out of your " + this.player.legs() + ", but you manage to hold yourself up long enough for your stud to flex his cock inside you and fill up your backdoor with more potent addiction.  You slide off, nerveless and still orgasming as jizz rains on your back from the abandoned cock, rolling off you to add to the ever-widening puddle of fluids on the floor.  Smiling vacantly and addled on more minotaur-cum than any one person has reason to handle, you stumble up on all fours and crawl to the next one.  More...", false);
            //[NEXT]
            this.player.orgasm();
        ...
        minotaurSalonFollowUp() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00142] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00142]++;
                //text goez here
                this.outputText("Lynnette slaps your face, waking you from your stupor.  What?  Where are you?  You look around and realize you're strapped into a barber's chair and caked with white goop, but why?\n\n", false);
                this.outputText("The goblin answers before you can vocalize your query, \"<i>Baby, you're so cum-hungry you make my daughters look like chaste virgins!  I haven't seen anyone go to town on minotaurs like that since my mother passed away, Marae guide her soul.  Normally we don't have that much use for the minotaurs outside of a bit of recreational drug-play, but you milked out so much cum that we can start selling it!  Isn't that great!?</i>\"\n\n", false);
                this.outputText("You nod, a little shocked by your behavior, but already licking your lips in anticipation.  Lynnette smiles and says, \"<i>You can buy some for the usual price, plus 60 gems, but for right now, how about some hair service?  It's on the house!</i>\"", false);
            }
            else
                this.outputText("You're woken up with a slap to the face, and still muzzy from your cum-induced glory-hole orgy, you stagger up to your " + this.player.feet() + ".  Lynnette shakes her stinging palm and apologizes, \"<i>Sorry I have to keep doing that, but you're damned hard to wake after you go on these binges!  Anyways, you've earned some hair treatment if you want it.  Of course you could always buy more of your favorite fluid...</i>\"\n\n", false);
            //Menu
            this.outputText("Lynnette offers and explains their options, \"<i>So what'll it be hun?  We could cut it down or give you a lengthening treatment. Or you can get a hair-dye to use on your own.  Just remember to come back in a few days for a touchup.</i>\"", false);
            this.salonPurchaseMenu();
        }
        ...
        */
        ...
        fuckLynnette() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.LYNNETTE_FUCK_COUNTER] == 0) {
                ...
                if (this.player.tallness >= 72)
                    ...
                    this.outputText("side");
                this.outputText(" so that she can slip a manicured hand inside your underclothes. She handles [eachCock] ");
                if (this.player.cockTotal() > 1)
                    this.outputText("in turn ");
                this.outputText("with the skill of a practiced snake-charmer before ");
                if (this.player.balls == 0)
                    this.outputText("pressing down near the [sheath]");
                else
                    this.outputText("curling her petite fingers around your [sack] to heft it");
                this.outputText(".");
                //IF FAIL!
            ...
            //Repeat cum within 24 hours check
                ...
                this.outputText("Lynnette licks her lips at your decision and sashays forward, her immense hips rocking with enough sensuality that her plush ass is practically having a sexquake.  \"<i>You'll understand if we do a quick check then, right, [name]?</i>\" She doesn't wait for an answer, pressing herself against you so that you can get a good feel of her soft, sopping-wet tits conform to the shape of your body, letting the moist heat that seems to radiate from every pore of Lynnette's petite shape soak into your exposed " + this.player.skinFurScales() + ".  Her hand dives right into your underwear without asking, seizing tight around [oneCock] to heft it.");
                this.outputText("\n\nYou give up an appreciative groan, [eachCock] twitching in lewd enjoyment as ");
                if (this.player.lust <= 75)
                    this.outputText("it fills to full size almost immediately");
                else
                    this.outputText("it's fully-erect state makes itself known");
                this.outputText(". Lynnette strokes a few times to make sure you're suitably engorged and then shifts lower, squeezing ");
                if (this.player.balls == 0)
                    this.outputText("around your [sheath] to get a feel for how pent-up you are");
                else
                    this.outputText("gently at your [balls], weighing them in her palm to get a feel for just how pent-up you are");
                this.outputText(".");
                //NOT ENOUGH!
                if (this.player.hoursSinceCum < 24) {
            ...
            this.outputText(" with hunger in her eyes.");
            ...
            if (this.player.cockTotal() > 1)
                this.outputText("es have");
            else
                this.outputText(" has");
            this.outputText(" begun to bead clear droplets of precum. They run down the underside of your distended, eager cumvein");
            if (this.player.cockTotal() > 1)
                this.outputText("s");
            this.outputText(" and race down towards your ");
            if (this.player.balls > 0)
                this.outputText("[balls]");
            else
                this.outputText("[sheath]");
            this.outputText(", leaving a glossy, sexual shine in their wake, and they're only coming on faster and faster the longer you gaze upon Lynnette's emerald twat and inhale her prick-stiffening scent.");
            ...
            if (this.player.balls > 0)
                this.outputText(", making your sack feel tight and your testes bloated and tender.");
            else
                this.outputText(", making your gut clench and spasm with near-orgasmic contractions.");
            this.outputText("  There's a tsunami of sperm building up inside you to the point where holding it in is actually starting to hurt you, but at the same time, your body refuses to give in and climax yet either.");
            ...
            this.outputText("\n\nYour thrusts transform from powerful lunges into a frenzied jackhammering so powerful that the impact ripples along her considerable thighs and ass.  Even her squirting tits shake and jostle with the pussy-plowing impacts as you mount the goblin like a rutting beast, battering your " + this.player.cockHead(x) + " ");
            if (this.player.cockArea(x) > 24)
                this.outputText("up against her slightly-yielding cervix");
            else
                this.outputText("in as close to the cervix as you possibly can");
            this.outputText(", grunting and growling as you lose yourself in the feel of her soaked, velvet tunnel.  Your focus collapses entirely down to the feel of that slick tunnel around you and how far you can push into it, how strongly you can make it climax and squeeze around you.");
            ...
            this.outputText("\n\nYour body has been ready to go off for some time now, and the words act like an irresistible trigger for your climax, causing you to lurch your " + this.cockDescript(x) + " ");
            if (this.player.cockArea(x) <= 90)
                this.outputText("completely inside once more");
            else
                this.outputText("as deeply inside as you can");
            this.outputText(" and hold it there.");
            if (this.player.cockTotal() > 1) {
                this.outputText("  Your other member");
                if (this.player.cockTotal() > 2)
                    this.outputText("s are");
                else
                    this.outputText(" is");
                this.outputText(" spasming ");
                if (this.player.longestCockLength() <= 12)
                    this.outputText("on the greedy green slut's belly");
                else
                    this.outputText("in the milk-stained valley between her tits, absolutely buried in squishy-soft breast");
                this.outputText(", jizzing in wild spurts.  The cum mixes with all the goblin-cream into a sticky-slick morass that paints Lynnette white.");
            }
            this.outputText("  Screaming with relief, you can feel the cum rushing out from your [balls], through your middle, and down the length of your quim-buried tool, distending it as blobs of cum roll through the honeyed folds to explode against the well-endowed goblin's cervix. The touch of cum at the womb's entrance sends your lover back into another body-shaking climax; her eyes roll back, her pussy clamps down, and most importantly, her cervix dilates into a wide-open hole, sucking the cum straight into her womb as fast as you can shoot it.");
            ...
            //Three liter good cumflate
                ...
                this.outputText("\n\nThere's so much cum flowing out of your " + this.player.cockHead(x) + " that Lynnette's once-taut tummy immediately plumps up with spermy weight, filled into a jiggly paunch by your first few blasts.  As you continue to flood her womb with your slurry of baby-making goodness, her belly continues to rise up between you, eventually arcing up into a gravid dome.  Somehow, her body holds it all inside, and only a small trickle of spunk leaks out of her luscious slit as you finish.");
        ...
        lynnetteApproval(arg = 0) {
            if (arg != 0)
                this.flags[kFLAGS_1.kFLAGS.LYNNETTE_APPROVAL] += arg;
            if (this.flags[kFLAGS_1.kFLAGS.LYNNETTE_APPROVAL] < -100)
                this.flags[kFLAGS_1.kFLAGS.LYNNETTE_APPROVAL] = -100;
            else if (this.flags[kFLAGS_1.kFLAGS.LYNNETTE_APPROVAL] > 100)
                this.flags[kFLAGS_1.kFLAGS.LYNNETTE_APPROVAL] = 100;
            return this.flags[kFLAGS_1.kFLAGS.LYNNETTE_APPROVAL];
        }
    }
    exports.Salon = Salon;
});
