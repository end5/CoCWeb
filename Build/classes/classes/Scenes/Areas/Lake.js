define(["require", "exports", "../../BaseContent", "./Lake/FetishCultistScene", "./Lake/FetishZealotScene", "./Lake/GooGirlScene", "./Lake/GreenSlimeScene", "./Lake/Kaiju", "./Lake/SwordInStone", "../../GlobalFlags/kFLAGS", "../../PregnancyStore", "../../StatusAffects", "./Lake/GreenSlime", "../../CockTypesEnum", "../../../../includes/appearanceDefs", "../../GlobalFlags/kGAMECLASS"], function (require, exports, BaseContent_1, FetishCultistScene_1, FetishZealotScene_1, GooGirlScene_1, GreenSlimeScene_1, Kaiju_1, SwordInStone_1, kFLAGS_1, PregnancyStore_1, StatusAffects_1, GreenSlime_1, CockTypesEnum_1, appearanceDefs_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by aimozg on 06.01.14.
     */
    class Lake extends BaseContent_1.BaseContent {
        constructor() {
            super(...arguments);
            this.fetishCultistScene = new FetishCultistScene_1.FetishCultistScene();
            this.fetishZealotScene = new FetishZealotScene_1.FetishZealotScene();
            this.gooGirlScene = new GooGirlScene_1.GooGirlScene();
            this.greenSlimeScene = new GreenSlimeScene_1.GreenSlimeScene();
            this.kaiju = new Kaiju_1.Kaiju();
            this.swordInStone = new SwordInStone_1.SwordInStone();
        }
        Lake() {
        }
        //Explore Lake
        exploreLake() {
            ...
            if (kGAMECLASS_1.kGAMECLASS.poniesYN())
                return;
            //Helia monogamy fucks
            if (this.flags[kFLAGS_1.kFLAGS.PC_PROMISED_HEL_MONOGAMY_FUCKS] == 1 && this.flags[kFLAGS_1.kFLAGS.HEL_RAPED_TODAY] == 0 && Lake.rand(10) == 0 && this.player.gender > 0 && !kGAMECLASS_1.kGAMECLASS.helScene.followerHel()) {
            ...
            //Egg chooser
            if (Lake.rand(100) < 25 && this.player.pregnancyIncubation > 1 && this.player.pregnancyType == PregnancyStore_1.PregnancyStore.PREGNANCY_OVIELIXIR_EGGS) {
                this.clearOutput();
            ...
            //==================================================
            //COMMON EVENTS
            if (this.player.level < 2 || this.player.spe < 50)
                choice[choice.length] = 0;
            choice[choice.length] = 1;
            choice[choice.length] = 2;
            //Fetish cultist not encountered till level 2
            if (this.player.level >= 2 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) >= 0)
                choice[choice.length] = 3;
            //Slimes/Ooze = level >= 2
            if (this.player.level >= 2)
                choice[choice.length] = 4;
            //Izma
            if (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00230] > 0 && (this.player.exploredLake >= 10) && (this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00233] == 0 || this.player.findStatusAffect(StatusAffects_1.StatusAffects.Infested) < 0) && this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00238] <= 0)
            ...
            //UNCOMMON EVENTS
            //Goo finding!
            if (Lake.rand(30) == 0 && this.flags[kFLAGS_1.kFLAGS.GOO_TFED_MEAN] + this.flags[kFLAGS_1.kFLAGS.GOO_TFED_NICE] > 0 && this.flags[kFLAGS_1.kFLAGS.GOO_SLAVE_RECRUITED] == 0) {
                kGAMECLASS_1.kGAMECLASS.latexGirl.encounterLeftBehindGooSlave();
                return;
            }
            ...
            if (this.temp > 0 && this.player.longestCockLength() >= this.player.tallness - 10 && this.player.totalCockThickness() >= 8)
            ...
            //Sword Discovery
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.TookBlessedSword) < 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.BSwordBroken) < 0)
            ...
            if (select == 9) {
                kGAMECLASS_1.kGAMECLASS.amilyScene.discoverAmilyVillage();
            }
            ...
            //Pre-emptive chance of finding the boat
                ...
                kGAMECLASS_1.kGAMECLASS.boat.discoverBoat();
            }
            //Meet Izma every 8 attempts
            else if (select == 5) {
                kGAMECLASS_1.kGAMECLASS.izmaScene.meetIzmaAtLake();
            }
            //Chance of dick-dragging! 10% + 10% per two foot up to 30%
            else if (select == 8) {
                //True sets to use lake scene!
                kGAMECLASS_1.kGAMECLASS.forest.bigJunkForestScene(true);
            }
            else if (select == 4) {
                //Chance of seeing ooze convert goo!
                //More common if factory blew up
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) >= 0 && Lake.rand(10) == 0) {
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) < 0)
                    girlOdds += 25;
                ...
                //OOZE!
                    ...
                    this.flags[kFLAGS_1.kFLAGS.TIMES_MET_OOZE]++;
                    this.spriteSelect(25);
                    //High int starts on even footing.
                    if (this.player.inte >= 25) {
                        this.outputText("A soft shuffling sound catches your attention and you turn around, spotting an amorphous green mass sliding towards you!  Realizing it's been spotted, the ooze's mass surges upwards into a humanoid form with thick arms and wide shoulders.  The beast surges forward to attack!", true);
                        this.startCombat(new GreenSlime_1.GreenSlime());
                        if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) < 0)
                ...
                this.outputText("Your quick walk along the lakeshore feels good.", true);
                ...
                //No boat, no kaiju
                if (this.player.level >= 5 && this.flags[kFLAGS_1.kFLAGS.KAIJU_DISABLED] == 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.BoatDiscovery) >= 0) {
                    this.kaiju.kaijuMeeting();
                    return;
                }
                this.outputText("Your stroll around the lake increasingly bores you, leaving your mind to wander.  ", true);
                if (this.player.cor > 30 || this.player.lust > 60 || this.player.lib > 40)
                    ...
                    this.dynStats("int", 1);
                if ((this.player.cor > 30 && this.player.cor < 60) || (this.player.lust > 60 && this.player.lust < 90) || (this.player.lib > 40 && this.player.lib < 75)) {
                    this.outputText("to thoughts of sex.", false);
                    this.dynStats("lus", (5 + this.player.lib / 10));
                    displayed = true;
                }
                if (((this.player.cor >= 60) || (this.player.lust >= 90) || (this.player.lib >= 75)) && !displayed) {
            ...
            //Find whitney or equinum
                ...
                //Find Whitney
                    ...
                    if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.MetWhitney) >= 0) {
                        ...
                        if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.MetWhitney) > 1) {
                            //If so, find equinum or whisker fruit
                            this.findLakeLoot();
                        }
                        //If you havent met whitney enough to know the farm....
                        else
                            kGAMECLASS_1.kGAMECLASS.farm.farmExploreEncounter();
                    }
                ...
                kGAMECLASS_1.kGAMECLASS.rathazul.encounterRathazul();
            }
            else {
                this.outputText("OH SHIT! LAKE EXPLORE BE BROKED.  SELECT: " + select + ".  You should probably go to fenoxo.com and click the link to report a bug and tell Fen about it.");
            }
        }
        findLakeLoot() {
            this.clearOutput();
            if (Lake.rand(2) == 0) {
                this.outputText("You find a long and oddly flared vial half-buried in the sand.  Written across the middle band of the vial is a single word: 'Equinum'.\n");
                this.inventory.takeItem(this.consumables.EQUINUM, this.camp.returnToCampUseOneHour);
            }
            else {
                this.outputText("You find an odd, fruit-bearing tree growing near the lake shore.  One of the fruits has fallen on the ground in front of you.  You pick it up.\n");
                this.inventory.takeItem(this.consumables.W_FRUIT, this.camp.returnToCampUseOneHour);
            }
        }
        eggChoose(eggType) {
            this.clearOutput();
            this.outputText("You reach out and touch the ");
            switch (eggType) {
                case 0:
            ...
            this.player.statusAffect(this.player.findStatusAffect(StatusAffects_1.StatusAffects.Eggs)).value1 = eggType; //Value 1 is the egg type. If pregnant with OviElixir then StatusAffects.Eggs must exist
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        eggChooseEscape() {
            this.clearOutput();
        ...
        ottahGirl() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.MET_OTTERGIRL]++;
            //First Time
            if (this.flags[kFLAGS_1.kFLAGS.MET_OTTERGIRL] == 1) {
                this.outputText("Your exploration of the lakeside takes you further than you've gone before.  The water here is almost completely still, its waters ");
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FactoryOverload) < 0)
                    this.outputText("crystal clear, giving you a stunning view of the lakebed");
                else
                    this.outputText("only slightly clouded, giving you an obscured view of the lakebed");
                this.outputText(".  Fish dart to and fro within the waters, caring little for your explorations above the waves.");
                ...
                this.outputText("\n\n\"<i>Fish'n'fuck,</i>\" she replies, simply.  \"<i>I fish, you fuck. Ya ain't dense, are you " + this.player.mf("boy", "girl") + "?</i>\"");
                this.outputText("\n\nThat's it?  She doesn't even know you and she's just offering it up like that?");
                //Silly Mode:
                if (this.silly())
                    this.outputText("  No tragic backstory to go through? No annoying combat encounter? Just meet and fuck?  My god, what has this world come to?");
                this.outputText("  You don't even know her name!");
            ...
            //Repeats
                ...
                this.outputText("Your explorations of the lake lead you back to Callu, the otter girl. She sits lazily on the beach; fishing rod in hand, as usual. She gives a friendly wave as you approach, and pats the sandy patch of lakeside next to her.");
            ...
            if (this.player.lust < 33)
                ...
                if (this.player.hasCock()) {
                    if (this.player.shortestCockLength() > 48)
                        ...
                        this.addButton(0, "Fuck Her", this.ottergirlLikesDongs);
                }
        ...
        ottergirlLikesDongs() {
            ...
            this.outputText("  She leisurely stretches out across your stomach and chest, letting her cunt come to rest right in front of your face.");
            this.outputText("\n\nYou feel slender but powerful fingers wrap around your cock, followed shortly after by a pair of lips. They encircle your " + this.player.cockHead(x) + " and suck, creating a delightful tingling sensation that travels down your cock and into your core.");
            this.outputText("\n\n\"<i>Hey darlin', better get to lickin', we want this ");
            //{(lil dicks)
            if (this.player.cocks[x].cockLength < 6)
                this.outputText("little, wanna-be cock");
            else
                this.outputText("bad boy");
            this.outputText(" to slip right in, don't we?</i>\"  Callu murrs back at you.  You most certainly do, so you lean your head forward ever-so-slightly, extending your tongue and lapping at her delicate pussy lips.  In no time at all they become puffy and flushed, blossoming outwards like a perverse flower.  You run your tongue up and down each and every fold, occasionally stopping to flick over her rapidly hardening clitoris.");
            this.outputText("\n\nLikewise, her tongue and lips dance over your " + this.cockDescript(x) + " like a trio of dancers. They spin, twist, hop and tease, ensuring that no inch is left untouched.");
            ...
            //[anemone]
                ...
                this.outputText("to the little wriggling tentacles ringing the head and base of your cock, ");
            else
                this.outputText("to the sensitive little spot on the underside of the head, ");
            this.outputText("lavishing it with attention.  Precum and saliva practically pour down the length of your shaft, tickling your ");
            if (this.player.balls > 0 && this.player.hasVagina())
                this.outputText("balls and cunt");
            ...
            this.outputText("\n\nA sudden, strange high-pitched sound suddenly rings out and your head bolts upright, only to see Callu reeling in a fish.  She looks it over, nods once to herself and tucks it away in an ice chest cleverly buried under the sand right next to the two of you.  Afterwards she stands up, letting your dick fall out of her.  Your " + this.cockDescript(x) + " feels strange, and uncomfortably naked somehow, especially as a cool wind blows over its saliva and femcum-covered skin.");
            ...
            if (this.player.cumQ() >= 250) {
                ...
                if (this.player.cumQ() < 500)
                    this.outputText("some of it begins to dribble down your cock, forming a puddle right under your ass cheeks");
                else if (this.player.cumQ() < 1000)
                    this.outputText("it begins to spray out of the edges of your cock, like water coming out of a blocked faucet");
                else if (this.player.cumQ() < 2000)
                    this.outputText("Callu's stomach begins to visibly inflate, even from your point of view");
                else
                    this.outputText("Callu's stomach inflates to a huge degree. She suddenly looks to be about eight months pregnant, though she doesn't seem bothered by this in the least");
                this.outputText(".");
            }
            this.outputText("  Her womb greedily takes everything it can, until you fall back onto the ground, exhausted.");
            this.outputText("\n\nTo your surprise, Callu simply picks up where she left off");
            if (this.player.cumQ() >= 2000)
                this.outputText(", despite the huge belly she now sports");
            this.outputText(".  Gyrations, thrusts and the constant cadence of her cunt work together to keep you unbearably hard.  Apparently she's not satisfied.");
            ...
            if (this.player.hasKnot(x))
                this.outputText("fails, held fast by the knot tying the two of you together. She looks at you in surprise, but eventually smiles and leans back down. The two of you cuddle for half an hour, until your knot deflates enough to let her *pop* off of it. She stands and ");
            this.outputText("slips her bikini bottoms into a canvas bag.");
        ...
        ottersForGals() {
            ...
            if (this.player.hasVagina())
                ...
                this.outputText("unnatural bare crotch");
            this.outputText(" down to your pucker, she leaves a trail of sloppy smooches.  You mirror her movements, attempting to give her the same experience she's giving you.  A low murr escapes her lips, and she squirms above you slightly as your tongue hits the right spots.");
            ...
            if (this.player.hasFuckableNipples())
                this.outputText("You even slip a finger or two inside, stretching your nipple-cunts out with deliciously pleasurable results.  ");
            this.outputText("Combined with Callu's tender tongue ");
            if (this.player.hasVagina())
                this.outputText("paying lip service to your wet cunt");
            else
                this.outputText("doing a cave dive in your rear");
            this.outputText(", you can't hold out much longer.  All the tingling in your body seems to get forced through your veins, coalescing in a single spot within your groin.  The pressure builds and builds as orgasmic energies begin overflowing.  Your legs and arms tremble, your head wobbles uncertainly, and you can't even guess at what your spine is attempting to do.");
            this.outputText("\n\nThe pleasure within you finally bursts outwards, shooting through every nerve, inflaming every fiber of your being.  ");
            if (this.player.hasVagina())
                this.outputText("Your snatch clenches and clamps down on thin air, flooding Callu's face with your feminine juices in a tasty, refreshing spray.");
            else
                this.outputText("Your asshole clenches and spasms randomly, aching to be filled by something, anything in your quest for release.");
            this.outputText("  The orgasmic bliss makes you collapse forwards, dropping you onto all fours. However, your blonde lover grips your thighs firmly, clearly intent on fully repaying her debt.");
        ...
        getSomeFishYaFatty() {
            this.clearOutput();
            this.outputText("You tell Callu you're a little more interested in the fish than the fuck, at least for today.  She shrugs once before jamming the end of her fishing pole into the sand like a post and turning towards her pack.");
