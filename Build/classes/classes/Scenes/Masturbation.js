define(["require", "exports", "../BaseContent", "../CockTypesEnum", "../StatusAffects", "../GlobalFlags/kFLAGS", "../../../includes/appearanceDefs", "../../console", "../PerkLib"], function (require, exports, BaseContent_1, CockTypesEnum_1, StatusAffects_1, kFLAGS_1, appearanceDefs_1, console_1, PerkLib_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    //	import classes.Scenes.NPCs.*;
    class Masturbation extends BaseContent_1.BaseContent {
        masturbateMenu() {
            this.menu();
            if (this.player.hasCock() && (this.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.BEE)) {
                this.clearOutput();
            ...
            if ((this.player.findPerk(PerkLib_1.PerkLib.HistoryReligious) >= 0 && this.player.cor <= 66) || (this.player.findPerk(PerkLib_1.PerkLib.Enlightened) >= 0 && this.player.cor < 10)) {
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Exgartuan) == 0)
                ...
                this.addButton(button++, "Masturbate", this.masturbateGo);
            //catofellato
            if (this.player.hasCock() && (this.player.findPerk(PerkLib_1.PerkLib.Flexibility) >= 0 || this.flags[kFLAGS_1.kFLAGS.TIMES_AUTOFELLATIO_DUE_TO_CAT_FLEXABILITY] > 0)) {
                this.addButton(button++, "Lick Cock", this.catAutoLick);
            }
            if (this.player.hasVagina() && (this.player.findPerk(PerkLib_1.PerkLib.Flexibility) >= 0 || this.flags[kFLAGS_1.kFLAGS.TIMES_AUTOFELLATIO_DUE_TO_CAT_FLEXABILITY] > 0)) {
        ...
        masturbateGo() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Exgartuan) >= 0 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Exgartuan) == 0) {
                if (this.player.isNaga() && Masturbation.rand(2) == 0 && this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1)
                    this.getGame().exgartuan.exgartuanNagaStoleMyMasturbation();
                else
                    this.getGame().exgartuan.exgartuanMasturbation();
                return;
            }
            if (this.player.countCockSocks("gilded") > 0 && this.flags[kFLAGS_1.kFLAGS.GILDED_JERKED] < this.player.countCockSocks("gilded")) {
            ...
            if (this.player.cor < 15)
                this.outputText("You sheepishly find some rocks to hide in, where you remove your clothes.\n\n");
            else if (this.player.cor < 30)
                this.outputText("You make sure you are alone and strip naked.\n\n");
            else if (this.player.cor < 60)
                this.outputText("You happily remove your " + this.player.armorName + ", eager to pleasure yourself.\n\n");
            else if (this.player.cor < 80)
                this.outputText("You strip naked in an exaggerated fashion, hoping someone might be watching.\n\n");
            else
                this.outputText("You strip naked, fondling your naughty bits as you do so and casting seductive looks around, hoping someone or something is nearby to fuck you.\n\n");
            //Tit foreplay
            this.titForeplay();
            ...
            if (this.player.cocks.length > 0) {
                if (this.player.cocks.length == 1) {
                    ...
                    if (this.player.lib < 45)
                        ...
                        this.outputText(" teasingly, pre-cum running down your length from your constant state of arousal.  ");
                }
                else {
                    this.outputText("You stroke your " + this.player.cockDescript());
                    if (this.player.lib < 45)
                        ...
                        this.outputText(" teasingly, pre-cum running down your cocks from your constant state of arousal, pooling around you.  ");
                }
            }
            if (this.player.vaginas.length > 0) {
                if (this.player.vaginas.length == 1) {
                    ...
                    if (this.player.lib < 45)
                        ...
                        this.outputText("You touch your enflamed and aroused " + this.player.vaginaDescript() + ", ");
                    switch (this.player.vaginas[0].vaginalWetness) {
                        case appearanceDefs_1.VAGINA_WETNESS_DRY:
                        ...
                        case appearanceDefs_1.VAGINA_WETNESS_SLICK:
                            this.outputText("smiling as your fingers become coated in your slick fluids.  ");
                            break;
                        case appearanceDefs_1.VAGINA_WETNESS_DROOLING:
                            this.outputText("slicking your fingers in the juices that constantly dribble from " + this.player.vaginaDescript() + "  ");
                            break;
                        default:
                ...
                if (this.player.vaginas.length > 1) {
                    if (this.player.lib < 45)
                        ...
                        this.outputText("Touch your enflamed and aroused " + this.player.vaginaDescript() + "s, ");
                    switch (this.player.vaginas[0].vaginalWetness) {
                        case appearanceDefs_1.VAGINA_WETNESS_DRY:
                            this.outputText("expertly arousing your female parts.  ");
                            break;
                        ...
                        case appearanceDefs_1.VAGINA_WETNESS_SLICK:
                            ...
                            break;
                        case appearanceDefs_1.VAGINA_WETNESS_DROOLING:
                            this.outputText("slicking your fingers in the juices that constantly dribble from " + this.player.vaginaDescript() + "s  ");
                            break;
                        default:
            ...
            if (this.player.cocks.length == 1) {
                ...
                if (this.player.cocks[0].cockThickness < 1.8)
                    ...
                    this.outputText("You grasp onto your " + this.player.cockDescript() + " with both hands, but fail to encircle it fully as you begin to masturbate.  ");
                //If length > 12 proud
                ...
                if (this.player.cocks[0].cockLength < 12) {
                    ...
                    if (this.player.canTitFuck() && this.player.biggestTitSize() > 3 && !nippleFuck) {
                        ...
                        if (this.player.biggestLactation() > 0)
                            this.outputText("Jets of milk squirt out of your nipples with each thrust of your hips, adding to the already copious amounts of fluids coating your body. ");
                    }
                }
                else {
                    if (this.player.normalCocks() >= 1)
                    ...
                    if (this.player.canTitFuck() && this.player.biggestTitSize() > 3 && !nippleFuck) {
                        this.outputText("Your hands reach up to your pillowy breasts, wrapping them around the shaft of your " + this.player.cockDescript() + ", causing you to let out muffled moans of excitment. ");
                        if (this.player.biggestLactation() > 0)
                            this.outputText("Jets of milk squirt out of your nipples with each thrust of your hips, adding to the already copious amounts of fluids coating your body. ");
                    }
                }
                ...
                if (this.player.averageCockThickness() <= 1.8)
                    ...
                    this.outputText("squeezing as many of your tools as your fingers can encircle.  The feeling of squeezing your thick twin cocks is amazing and overwhelming at the same time.  ");
                //Get into it
                //Play with it if <= 10"
                ...
                //Tittyfuck if D cup+
                    ...
                    if (this.player.canTitFuck() && this.player.mostBreastsPerRow() > 2 && !nippleFuck) {
                        ...
                        if (this.player.biggestLactation() > 0)
                            this.outputText("Jets of milk squirt out of your many nipples with each thrust of your hips, adding to the already copious amounts of fluids coating your body. ");
                    }
                ...
                if (this.player.averageCockThickness() <= 1.8)
                    ...
                    this.outputText("squeezing as many of your tools as your fingers can encircle.  The feeling of rubbing your bundle of cocks together is indescribable.  Your eyes roll back in uncontrollable pleasure.  ");
                //Get into it
                //Play with it if <= 10"
                if (this.player.averageCockLength() <= 10)
                    ...
                    if (this.player.hasFuckableNipples()) {
                        ...
                        if (this.player.dogCocks() > 0) {
                            ...
                            if (this.player.hasFuckableNipples()) {
                                ...
                                nippleFuck = true;
                                autofellatio = true;
                                if ((this.player.normalCocks() > 0 || this.player.horseCocks() > 0) && this.player.cocks.length - this.player.dogCocks() == 1)
                                    this.titFuckSingle();
            ...
            if (this.player.vaginas.length > 0) {
                ...
                if (this.player.vaginas.length == 1) {
                    ...
                    //Big clits
                        ...
                        if (this.player.vaginas[0].vaginalWetness > appearanceDefs_1.VAGINA_WETNESS_DRY)
                    ...
                    switch (this.player.vaginas[0].vaginalWetness) {
                        case appearanceDefs_1.VAGINA_WETNESS_DRY:
                            this.outputText("You have some difficulty with your relatively dry pussy, but you manage to gently and pleasurably masturbate by taking it slowly.  ");
                            break;
                        case appearanceDefs_1.VAGINA_WETNESS_NORMAL:
                            this.outputText("Your horny puss is aching for attention and you oblige it, dipping your fingers into the moist honeypot, and jilling yourself vigorously.  ");
                            break;
                        case appearanceDefs_1.VAGINA_WETNESS_WET:
                            this.outputText("The moistened cleft on your groin demands your full attention, drawing your fingers deep inside to explore the wet passage.  ");
                            break;
                        case appearanceDefs_1.VAGINA_WETNESS_SLICK:
                            this.outputText("The sweltering heat of your slick cunt aches for something to fill it, and you oblige, dipping your fingers into your slippery cunt.  ");
                            break;
                        case appearanceDefs_1.VAGINA_WETNESS_DROOLING:
                            this.outputText("Warm wetness runs down your legs in thick streams, pouring from your " + this.player.vaginaDescript() + ".  You smile sheepishly and stroke up your now slickened legs to your pussy-lips, parting them and letting your fingers dive inside the wet channel.  ");
                            break;
                        default:
                ...
                if (this.player.cocks.length == 1) {
                    if (this.player.lib < 30)
                        ...
                        if (this.player.cor < 50)
                            ...
                            this.outputText("you dream in a depraved kinky fantasia.");
                    }
                    else
                        this.outputText("You groan and drift to sleep, your rigid " + this.player.cockDescript() + " pulsing and throbbing with continual lust.");
                }
                //Multi Cock
                else {
                    if (this.player.lib < 30)
                        ...
                        this.outputText("You groan and drift into a brief catnap, your rigid erections pulsing and throbbing with continual lust.");
                }
            }
            //No cock ending
            else {
                if (this.player.vaginas.length > 0)
                    ...
                    this.outputText("You sigh and drift off to sleep."); //Genderless ending
            }
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        genderlessMasturbate() {
            ...
            if (this.player.cor < 15)
                ...
                if (this.player.hasCock() || this.player.hasVagina())
                    ...
                    this.outputText("You strip naked, casting seductive looks around, hoping someone or something is nearby to fuck you.\n\n");
            }
            //Tit foreplay
            this.titForeplay();
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FappedGenderless) < 0) { //first time as a genderless person
                ...
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.FappedGenderless, 0, 0, 0, 0);
            }
            ...
            //If BioLube or continuing from no biolube - 
                ...
                if (this.player.ass.analLooseness <= 2)
                    ...
                    this.outputText("your four fingers in deep");
            ...
            //No BioLube perk -
                ...
                if (this.player.lib > 75)
                    ...
                    this.outputText("  Satisfied, you roll over and drift off to sleep.");
            }
        }
        titForeplay() {
            ...
            if (this.player.breastRows.length == 1 && this.player.biggestTitSize() > 3) {
                if (this.player.lib < 45)
                    ...
                    this.outputText("You grope your " + this.player.breastDescript(0) + " agressively with both hands");
                else
                    this.outputText("You squeeze your " + this.player.breastDescript(0) + " brutally with both hands");
            }
                ...
                if (this.player.lib < 45)
                    ...
                    this.outputText("You aggressively run your hands across your front, groping each of your " + Masturbation.num2Text(this.player.totalBreasts()) + " breasts in turn. ");
                ...
                if (this.player.cor <= 25)
                    ...
                    this.outputText("The tactile reminder of your abnormal endowments gives you a delicious thrill.  You sigh and mash your tits together");
            }
            ...
            if (this.player.hasFuckableNipples() && this.player.biggestTitSize() > 3) {
                ...
                if (this.player.lib < 60)
                    ...
                    this.outputText(". Eagerly, you begin to roughly stroke the ");
                ...
                //add "many if lots of nips
                    ...
                    this.outputText("swollen, cunt-like lips that top each breast. ");
                ...
                if (this.player.sens < 45)
                    ...
                    this.outputText("You squeal with pleasure as ");
                ...
                if (this.player.averageLactation() > 0 && this.player.averageLactation() < 2)
                    ...
                    this.outputText("Your freakish mammaries constantly drool a steady stream of milky cunt-juice, drenching your " + this.player.legs() + " and crotch in milky goo.");
            }
            //If nipples aren't fuckable.
                ...
                if (this.player.sens < 45)
                    ...
                    this.outputText("squeals of pleasure each time you flick one of your ");
        ...
        titFuckSingle() {
                ...
                */
                ...
                switch (this.player.cocks[0].cockType) { //Different way of choosing cock to use, results in consistent description of cock[0]
                    ...
                    case CockTypesEnum_1.CockTypesEnum.HORSE:
                        ...
                        break;
                    case CockTypesEnum_1.CockTypesEnum.HUMAN:
            ...
            if (this.player.averageVaginalLooseness() < 2)
                ...
                this.outputText("huge, bloated cunt-nipples");
            if (this.player.breastRows.length > 1)
            ...
            if (this.player.averageLactation() == 0) {
                if (this.player.averageVaginalWetness() < 2)
                    ...
                    */
                    ...
                    this.outputText("Slick juices squirt out from around your " + this.player.cockDescript() + " and y");
            }
            else {
            ...
            if (Math.round(this.player.cockArea(0)) >= this.player.vaginalCapacity()) {
                ...
                if (this.player.sens < 45)
                    ...
                    this.outputText("ou scream with a combination of pain and pleasure as you attempt to stuff your " + this.player.cockDescript() + " into ");
                ...
                if (this.player.averageVaginalLooseness() < 2)
                    ...
                    this.outputText("the gaping fuck-mouth of your inhuman nipple-cunt. ");
                ...
                if (Math.round(this.player.cockArea(0)) > this.player.vaginalCapacity()) {
                    if (this.player.averageVaginalLooseness() < 2)
                        this.outputText("Your poor, tortured nipple is woefully insufficient compared to your " + this.player.cockDescript() + ", delerious with arousal, you keep trying anyway. ");
                    else if (this.player.averageVaginalLooseness() < 4)
                ...
                if (this.player.averageVaginalWetness() < 2)
                    ...
                    */
                    ...
                    this.outputText("girl-lube spurts out of your tortured nipple with each thrust of your " + this.player.cockDescript() + ", spattering your arms and face with your secretions. ");
            }
            if (Math.round(this.player.cockArea(0)) < this.player.vaginalCapacity()) {
                //Different noises based on sensitivity
                if (this.player.sens < 45)
                    ...
                    this.outputText("ou scream with delight");
        ...
        multiTitFuck() {
            var holeTotal = this.player.totalNipples();
            var fittableCocks = this.player.cocks.length;
            var doubleUp = false;
            //randomize what kind of dick to start with
            var randomCock = Masturbation.rand(fittableCocks);
            ...
            if (fittableCocks > 2 && holeTotal < fittableCocks) {
                ...
                if (this.player.vaginalCapacity() >= 2 * this.player.cockArea(randomCock)) {
                    ...
                    if (2 * holeTotal >= fittableCocks)
                        ...
                        this.outputText("With a flash of irritation, you realize that even if you stick two cocks in each hole, you still won't be able to fit all " + Masturbation.num2Text(this.player.cocks.length) + " of your dicks into your abused tits. Deciding to make the best of it, you prepare to stuff in as many as you can. ");
                }
                else
                    this.outputText("Accepting that you can't do anything about it, you start pushing. ");
            }
            //How wet/milky is this procedure?
            if (this.player.averageLactation() == 0) {
                if (this.player.averageVaginalWetness() < 2)
                    ...
                    this.outputText("Slick juices squirt out from around your shafts and y");
            }
            else {
                if (this.player.averageLactation() < 2)
                    this.outputText("Rivulets of milky girlcum drizzle down your shafts and y");
                else
                    this.outputText("Milky girlcum squirts out from around your shafts, staining them white. Y");
            }
            //Round and compare cock thickness to vag looseness
            if (Math.round(this.player.cockArea(randomCock)) >= this.player.vaginalCapacity()) {
                ...
                if (this.player.sens < 45)
                    ...
                    this.outputText("ou scream with a combination of pain and pleasure as you attempt to stuff your cocks into ");
                //Different based on looseness
                if (this.player.averageVaginalLooseness() < 2)
                    ...
                    this.outputText("the gaping fuck-mouths of your inhuman nipple-cunts. ");
                //Compare cockthickness and vaglooseness more specifically
                //if it barely fits
                if (Math.round(this.player.cockArea(randomCock)) == this.player.vaginalCapacity()) {
                    if (this.player.averageVaginalLooseness() < 2)
                        ...
                        this.outputText("The swollen lips of your bloated nipples stretch around your throbbing cocks, swallowing them whole. ");
                ...
                if (Math.round(this.player.cockArea(randomCock)) > this.player.vaginalCapacity()) {
                    if (this.player.averageVaginalLooseness() < 2)
                        ...
                        this.outputText("The swollen lips of your bloated nipples gape wide, but the enormous girth of your throbbing members spread them even wider. ");
                ...
                if (this.player.averageVaginalWetness() < 2)
                    ...
                    this.outputText("girl-lube spurts out of your tortured nipples with each thrust of your hips, spattering your arms and face with your secretions. ");
            }
            if (Math.round(this.player.cockArea(randomCock)) < this.player.vaginalCapacity()) {
                if (!doubleUp) {
                    //Different noises based on sensitivity
                    if (this.player.sens < 45)
                        ...
                        this.outputText("ou scream with delight as your stiff cocks slide into ");
                    //Different based on looseness
                    if (this.player.averageVaginalLooseness() < 2)
                        ...
                        this.outputText("the gaping fuck-mouths of your inhuman nipple-cunts. The swollen lips of your bloated nipples engulf your hard rods and begin to slide down their length, swallowing them completely. ");
                    ...
                    if (this.player.averageVaginalWetness() < 2)
                        ...
                        this.outputText("girl-lube pours out of your swollen nipples in a constant deluge of sticky fluid, creating a large puddle beneath you. ");
                }
                else {
                    //Different noises based on sensitivity
                    if (this.player.sens < 45)
                    ...
                    if (4 * Math.round(this.player.averageCockThickness()) < this.player.averageVaginalLooseness()) {
                        if (this.player.averageVaginalLooseness() < 2)
                            this.outputText("the over-stretched openings on your swollen nipples. Though they are reletively small and delicate, you can easily slide two of your tiny cocks into each of their slippery passages.");
                        else if (this.player.averageVaginalLooseness() < 4)
                            ...
                            this.outputText("the gaping fuck-mouths of your inhuman nipple-cunts. The swollen lips of your bloated nipples squish open as they swallow your fat dicks with little difficulty. ");
                        ...
                        if (this.player.averageVaginalLooseness() < 2)
                            ...
                            this.outputText("the gaping fuck-mouths of your inhuman nipple-cunts. The swollen lips of your bloated nipples are stretched to their limits as you push two of your fat dicks into one. ");
        ...
        multiNippleFuckPrep(randomCock) {
            ...
            if (this.player.cocks[randomCock].cockType == CockTypesEnum_1.CockTypesEnum.HUMAN) {
                this.outputText("tip of ");
                //more than one?
                if (this.player.normalCocks() > 1)
                    this.outputText("one of your " + Masturbation.num2Text(this.player.normalCocks()) + " " + this.player.cockDescript(randomCock) + "s ");
                else
                    this.outputText("your " + this.player.cockDescript(randomCock) + " ");
            }
            //Applying randomization - horse cocks
            if (this.player.cocks[randomCock].cockType == CockTypesEnum_1.CockTypesEnum.HORSE) {
                this.outputText("flared tip of ");
                //more than one?
                if (this.player.horseCocks() > 1)
                    this.outputText("one of your " + Masturbation.num2Text(this.player.horseCocks()) + " " + this.player.cockDescript(randomCock) + "s ");
                else
                    this.outputText("your " + this.player.cockDescript(randomCock) + " ");
            }
            //Applying randomization - dog cocks
            if (this.player.cocks[randomCock].cockType == CockTypesEnum_1.CockTypesEnum.DOG) {
                this.outputText("pointed tip of ");
                //more than one?
            ...
            if (this.player.averageVaginalLooseness() < 2)
                ...
                this.outputText("huge, bloated cunt-nipple");
            if (this.player.breastRows.length > 1)
                this.outputText(" on one of your lower breasts");
            else if (this.player.averageNipplesPerBreast() > 1)
                this.outputText("s");
        ...
        //ORGASM COOOOAD
        orgazmo(selfSucking, nippleFuck) {
            this.outputText("\n\n");
            if (this.player.cocks.length > 0) {
                if (this.player.cocks.length == 1) {
                    ...
                    if (this.player.normalCocks() == 1)
                        ...
                        this.outputText("swollen member.  You can feel it tingling and bulging strangly as it begins to contract and pulse.  Pre-cum leaks from your " + this.player.cockDescript() + " in a steady stream as each 'bulb' nearly doubles in size, and then one at a time, they deflate while your urethra dilates wide.  ");
                    else if (this.player.anemoneCocks() == 1)
                    ...
                    if (selfSucking)
                        this.outputText("into your eager mouth.  ");
                    if (nippleFuck)
                    ...
                    if (selfSucking) {
                        if (this.player.cumQ() < 25)
                            ...
                            this.outputText("Your orgasm never seems to end, and your world dissolves into the feelings from your " + this.player.cockDescript() + " as it erupts jet after jet of cum into your mouth.  You nearly gag, cum overflowing to spray out in a river, pooling around you.  ");
                    }
                    else if (nippleFuck) {
                        if (this.player.cumQ() < 25)
                            ...
                            this.outputText("Your orgasm never seems to end, and your world dissolves into the feelings from your " + this.player.cockDescript() + " as it erupts jet after jet of cum into your abused tit.  With a *pop*, your cock is forced free by the pressure. It continues to squirt semen everywhere, while a river of cum pours out of your dialated nipple, pooling around you.  ");
                    }
                    else {
                        if (this.player.cumQ() < 25)
                            ...
                            this.outputText("The orgasm never seems to end, and your world dissolves to little more than the feeling of each jet of cum erupting from your cock.  Your mind dimly processes the feeling of each burst splattering over you, but it only enhances the feeling.  ");
                    }
                }
                //MULTICOCK
                if (this.player.cocks.length > 1) {
                    this.outputText("The sensations prove too much for you, and you feel the tightness building in your loins.  ");
                    if (this.player.dogCocks() > this.player.normalCocks() && this.player.dogCocks() > this.player.horseCocks()) { //Primary Dog
                        var dogIndex;
                        for (dogIndex = 0; dogIndex < this.player.cocks.length; dogIndex++) {
                            if (this.player.cocks[dogIndex].cockType == CockTypesEnum_1.CockTypesEnum.DOG)
                                break;
                        }
                    ...
                    else if (this.player.horseCocks() > this.player.normalCocks()) { //Primary Horse
                        var horseIndex;
                        for (horseIndex = 0; horseIndex < this.player.cocks.length; horseIndex++) {
                            if (this.player.cocks[horseIndex].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                                break;
                        }
                    ...
                    if (selfSucking) {
                        if (this.player.cumQ() < 25)
                            ...
                            this.outputText("Your orgasm never seems to end, and your world dissolves into the feelings from your " + this.player.cockDescript() + " as it erupts jet after jet of cum into your mouth.  You nearly gag, cum overflowing to spray out in a river, pooling around you.  Your other 'equipment' rains jizz upon you the whole while, soaking you in a cum-puddle.");
                    }
                    ...
                    if (this.player.cumQ() < 5)
                        ...
                        this.outputText("The orgasm never seems to end, and your world dissolves to little more than the feeling of multiple cum eruptions spurting from your pricks.  Your mind dimly processes the feeling of each burst splattering over you, but it only enhances the feeling.  ");
                }
            }
            //Vaginal CUMMING
            if (this.player.vaginas.length > 0) {
                ...
                if (this.player.vaginas.length == 1) {
                    ...
                    if (this.player.vaginas[0].vaginalWetness == appearanceDefs_1.VAGINA_WETNESS_SLAVERING)
                        this.outputText("A veritable gush of fluid explodes from your nethers, pulsing in time with the ripples of your " + this.player.vaginaDescript() + ".  ");
                }
        ...
        deluxeDildo() {
            ...
            if (this.player.hasVagina()) {
                ...
                //(lowcor)
                    ...
                    this.outputText("You blush feverishly as you grab your pink dildo.  It flops about lewdly as you run off behind some rocks and strip down to use it.  You feel like such a pervert.");
                this.outputText("\n\n");
                //(low cor)
                if (this.player.cor < 50)
                ...
                //high cor
                    ...
                    this.outputText("You hold the fake dong, squeezing it and giggling at the realistic texture.  You can't wait to try it out.");
                ...
                if (this.player.clitLength < .5)
                    ...
                    this.outputText(" fills with blood, twitching and pulsating like a man's cock");
                this.outputText(".  You ");
                if (this.player.cor > 50)
                ...
                if (this.player.cor < 50)
                    ...
                    this.outputText("ramming it deep inside you, moaning as it rubs your now over-sensitive walls.");
                ...
                if (this.getGame().monk >= 5 && this.flags[kFLAGS_1.kFLAGS.JOJO_DEAD_OR_GONE] == 0) {
                    this.outputText("\n\nAs you stand and try to clean up you manage to spot Jojo off in the woods, ");
                    if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.TentacleJojo) >= 0)
                        this.outputText("his tentacles splattering mouse-jizz everywhere as he gets off from your show.");
                    else
                        this.outputText("splattering himself with mouse-spunk as he finishes enjoying your inadvertent show.  He runs off before you have a chance to react.");
                }
                this.player.orgasm();
                this.doNext(this.camp.returnToCampUseOneHour);
                this.outputText("\n");
        ...
        onaholeUse() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.PlainOnaholeUsed) < 0) {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.PlainOnaholeUsed, 0, 0, 0, 0);
                ...
                if (this.player.cocks.length > 1)
                    ...
                    this.outputText("With your free hand, you slap your cock to 'attention' and ease the onahole over your cock.");
        ...
        deluxeOnaholeUse() {
            this.clearOutput();
            //Flag after first use!
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DeluxeOnaholeUsed) < 0) {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.DeluxeOnaholeUsed, 0, 0, 0, 0);
        ...
        onaholeContinuation() {
            if (this.player.cocks.length > 1) {
                if (this.player.gender == 3 && Masturbation.rand(2) == 0)
                    ...
                    this.doNext(this.onaholeMulticockContinuation);
            }
        ...
        onaholeMulticockContinuation() {
            ...
            if (this.player.balls > 0)
                ...
                this.outputText("you pass out with " + this.player.multiCockDescriptLight() + " sore from exertion.");
            this.dynStats("sen", -1);
            this.player.orgasm();
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        onaholeFutaContinuation() {
        ...
        allNaturalOnaholeUse() {
            this.clearOutput();
            //First use!
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.AllNaturalOnaholeUsed) < 0) {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.AllNaturalOnaholeUsed, 0, 0, 0, 0);
        ...
        stimBeltUse() {
            ...
            if ((this.player.hasKeyItem("Self-Stimulation Belt") >= 0)) {
                ...
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.used_self_dash_stim) < 0) {
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.used_self_dash_stim, 0, 0, 0, 0);
        ...
        allNaturalStimBeltUse() {
            ...
            if (this.player.hasKeyItem("All-Natural Self-Stimulation Belt") >= 0) {
                //First time!
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.UsedNaturalSelfStim) < 0) {
                    //Flag as used!
                    this.player.createStatusAffect(StatusAffects_1.StatusAffects.UsedNaturalSelfStim, 0, 0, 0, 0);
        ...
        allNaturalSelfStimulationBeltContinuation() {
            this.clearOutput();
        ...
        allNaturalSelfStimulationBeltBadEnd() {
        ...
        lickYerGirlParts() {
            ...
            //[1st time doing this]
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_AUTOFELLATIO_DUE_TO_CAT_FLEXABILITY] == 0) {
                this.flags[kFLAGS_1.kFLAGS.TIMES_AUTOFELLATIO_DUE_TO_CAT_FLEXABILITY]++;
        ...
        catAutoLick() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_AUTOFELLATIO_DUE_TO_CAT_FLEXABILITY] == 0) {
                ...
                if (this.player.countCockSocks("gilded") > 0 && this.flags[kFLAGS_1.kFLAGS.GILDED_JERKED] < this.player.countCockSocks("gilded")) {
                    this.flags[kFLAGS_1.kFLAGS.GILDED_JERKED]++;
            ...
            //[Repeatable]
                ...
                if (this.player.countCockSocks("gilded") > 0 && this.flags[kFLAGS_1.kFLAGS.GILDED_JERKED] < this.player.countCockSocks("gilded")) {
                    ...
                    if (this.flags[kFLAGS_1.kFLAGS.TIMES_AUTOFELLATIO_DUE_TO_CAT_FLEXABILITY] > 10 && this.player.balls > 1 && Masturbation.rand(5) == 0) {
        ...
        meditate() {
            this.clearOutput();
            this.outputText("You find a flat, comfortable rock to sit down on and meditate.  As always, meditation brings a sense of peace and calm to you, but it eats up two hours of the day.");
            this.dynStats("lus", -50, "cor", -.3 - 0.3 * this.player.countCockSocks("alabaster"));
            if (this.player.findPerk(PerkLib_1.PerkLib.Enlightened) >= 0 && this.player.cor < 10)
                this.HPChange(50, true);
            this.doNext(this.camp.returnToCampUseTwoHours);
        }
        dualBeltMasturbation() {
            this.clearOutput();
            this.outputText("You look at the thing in front of you and sigh, your " + this.player.multiCockDescriptLight() + " and " + this.player.vaginaDescript() + " dripping with fluids. With a nervous sigh you step into the underwear looking device and slip it up your legs, the cold metal feeling so good on your " + this.player.skinDesc + ", sending a rush of feelings up your body. You slip your " + this.player.cockDescript() + " down and into a hole on the front of the belt, the extra length sticking out on the other side of it. Underneath the hole and right above your pussy is another metal square with what feels like a small nub on the inside rubbing against your clit. Shivering from the feeling of it, you stay there for a moment, waiting in anticipation. Finally, you reach down to the side of the belt and flick the switch to the on position.\n\n");
            ...
            if (this.player.tailType > appearanceDefs_1.TAIL_TYPE_NONE)
                this.outputText("covering up your tail, ");
            ...
            if (this.player.cumQ() >= 1000)
                this.outputText("It grows larger and larger until you are sure it will pop, but it doesn't.  It just sloshes around - a huge bubble, nearly waist high. ");
            ...
            //([If high lactation]
            if (this.player.biggestLactation() >= 2)
                this.outputText("Milk gushes out from your " + this.player.breastDescript(0) + " as you orgasm, filling the inside of the suit with a slick layer of milk and forming milk bubbles that hang lewdly off your chest. ");
            ...
            if (this.player.biggestLactation() >= 2)
                this.outputText("Thin streams of creamy milk flow from your " + this.player.allBreastsDescript() + ", your torso and midsection dripping wet from the stuff. ");
        ...
        centaurMasturbation() {
            this.clearOutput();
            var canMasturbateHugeCock = this.player.hasCock() && (this.player.tallness * (5 / 6) < this.player.cocks[this.player.longestCock()].cockLength);
            if (this.player.hasFuckableNipples()) {
                if (canMasturbateHugeCock && Masturbation.rand(2) == 0) { //50/50 chance of either if you can do both
        ...
        centaurNippleCunt() {
            ...
            if (this.flags[kFLAGS_1.kFLAGS.PC_FETISH] > 0)
                ...
                this.outputText("smiling to yourself as you blatantly oogle your " + this.player.nippleDescript(0) + "s.");
            ...
            if (this.player.biggestTitSize() > 2)
                ...
                this.outputText("  They're shallow enough that you don't get much more than a fingertip inside them, but the flesh is extraordinarily sensitive, shooting arcs of pleasure deep into your body.");
            ...
            this.outputText("Shivering with pleasure, you kneel down to prevent your legs from going out from underneath you.   Your " + this.player.face() + " flushes hotter as you toy with the slippery nipple-cunts, feeling them growing hard and puffy as you turn yourself on more and more.  ");
            if (this.player.biggestLactation() > 1)
                ...
                this.outputText("Slick lubricant squishes around your fingers as you finger-fuck your chest-pussies.");
            ...
            if (this.player.hasVagina() || this.player.hasCock()) {
                ...
                if (this.player.hasCock()) {
                    if (this.player.hasVagina())
                        ...
                        this.outputText(this.player.cockDescript());
                    //Set as plural if multi dick or dick and vag.
                    if (this.player.hasVagina() || this.player.totalCocks() > 1)
                        plural = true;
                }
                else
                    this.outputText(this.player.vaginaDescript());
                if (plural)
                    this.outputText(" leak their own fluid, quivering with ache and need that you can't reach to satisfy.");
                else
                    this.outputText(" leaks its own fluids, quivering with ache and need that you can't reach to satisfy.");
                if (this.player.totalCocks() > 1)
                ...
                if (this.player.balls > 0)
                    this.outputText("  Rocking slightly inside your sack, your " + this.player.ballsDescriptLight() + " repeatedly clench up against your body, ready to release.");
                this.outputText("\n\n");
            }
            //(ORGAZMO)
            ...
            if (this.player.hasCock()) {
                if (this.player.cumQ() < 50)
                    ...
                    this.outputText("A large puddle of white seed has formed underneath you and even splattered your underside, ");
                else if (this.player.cumQ() < 2000)
                    this.outputText("A frothing puddle of thick cum has formed below you, soaking your legs and underbelly, ");
                else
                    this.outputText("A small lake of semen surrounds you, ");
            ...
            if (this.player.hasVagina()) {
                if (this.player.wetness() < 2)
                    ...
                    this.outputText("The air is filled with the thick musk of your bestial horse-pussy.  If the rivulets of moisture dripping down to your hooves are any indication, you might need to get used to the smell.");
            }
            if (this.player.hasCock() || this.player.hasVagina())
                this.outputText("\n\n");
            //Real aftermath
            ...
            if (this.player.cor > 66)
                ...
                this.outputText("You're horrified at what you're doing to deal with your inner perversions.");
            //DONE!
            this.player.orgasm();
            this.dynStats("sen", (-0.5));
        }
        centaurHugeCock() {
            ...
            var primary = this.player.longestCock();
            var plural = (this.player.cocks.length > 1);
            ...
            if (this.player.cor < 33)
                ...
                this.outputText("Smiling with excitement, ");
            ...
            if (!plural)
                this.outputText("it grows full and hard.");
            else
                this.outputText("they grow full and hard.");
            if (plural)
                ...
                if (this.player.cocks[primary].cockType == CockTypesEnum_1.CockTypesEnum.HORSE)
                ...
                else if (this.player.cocks[primary].cockType == CockTypesEnum_1.CockTypesEnum.DOG)
                ...
                else if (this.player.cocks[primary].cockType == CockTypesEnum_1.CockTypesEnum.CAT)
                    this.outputText("spiny head");
                else if (this.player.cocks[primary].cockType == CockTypesEnum_1.CockTypesEnum.LIZARD)
                    this.outputText("pointed, purple tip");
                else if (this.player.cocks[primary].cockType == CockTypesEnum_1.CockTypesEnum.ANEMONE)
                    this.outputText("tentacle-ringed head");
                else
                    this.outputText("dome-like head");
                this.outputText(".");
            }
            ...
            if (this.player.tallness * 1.5 >= this.player.cocks[this.player.longestCock()].cockLength) {
                ...
                if (this.player.cumQ() > 500)
                    ...
                    this.outputText("A tiny dollop of pre-cum slowly builds on your tip as you get into the act.");
                if (this.player.hasVagina())
                    this.outputText("  Your neglected " + this.player.vaginaDescript() + " aches for penetration, but there's no way you'll be able to reach it in your current state.");
                ...
                if (this.player.cor < 40)
                    this.outputText(", but you're also worried that you're falling into the perversion that lurks in this strange world");
            ...
            if (this.player.cumQ() < 50)
                ...
                if (this.player.cumQ() > 3000)
                    this.outputText("  As you finish cumming, the puddle deepens.  It's inches thick and splattering everywhere whenever you take a step.");
            }
            this.outputText("  You slump back, still shuddering from the pleasure as you feel your ");
            if (!plural)
                this.outputText("member");
            else
                this.outputText("members");
            if (this.player.hasSheath()) {
                if (plural)
                    this.outputText(" slowly grow limp and slide back inside your sheath.");
                else
                    this.outputText(" slowly growing limp and sliding back inside your sheath.");
            }
                ...
                if (plural)
                    ...
                    this.outputText(" growing slightly less hard.  As much as you seem to need sex, that doesn't surprise you.");
            }
            else {
                if (plural)
                    this.outputText(" slowly grow limp, shrinking.");
                else
                    this.outputText(" slowly growing limp, shrinking.");
            }
            this.outputText("\n\n");
            //Cunt cums
            if (this.player.hasVagina()) {
                if (this.player.wetness() <= 1)
                    ...
                    this.outputText("Spatters of fluids gush out from between your thighs, coating your upper legs in a thick coat of clear feminine lubricant as you orgasm.  The air is filled from the scent of your liquid centaur lust as more and more drips into a rapidly expanding puddle between your rear legs.");
                if (this.player.hasFuckableNipples()) {
                    if (this.player.totalNipples() > 2)
                        this.outputText("All");
                    else
        ...
        centaurCantMasturbate() {
            if (this.flags[kFLAGS_1.kFLAGS.UNABLE_TO_MASTURBATE_BECAUSE_CENTAUR] == 0) {
                ...
                this.flags[kFLAGS_1.kFLAGS.UNABLE_TO_MASTURBATE_BECAUSE_CENTAUR]++;
            }
            else {
            ...
            if (this.player.hasKeyItem("Cock Milker - Installed At Whitney's Farm") >= 0 && this.player.cocks.length > 0)
                ...
                this.outputText("It looks like you'll have to find a partner to relieve your pent up need, but in your current state you'll probably be on the receiving end of whatever you can get!");
        }
        ...
        centaurDudesGetHorseAids() {
            ...
            if (this.player.keyItemv1("Fake Mare") == 0) {
                ...
                //[If Med-High Corruption:] 
                    ...
                    this.outputText("You decide to play with the mare-shaped cocksleeve Whitney gave you.  You pull it out of your stash and spend a few minutes setting it up in the heart of camp.  Once done, you stand behind a wood-and-iron replica of a mare, adjusted to the perfect height for you.  Looking \"<i>her</i>\" over, your eyes are drawn to the slick black lips of the Onahole between her legs, craftily shaped like a horsecunt, and what looks like a second, smaller one above it simulating an anus.\n\n");
            }
            ...
            if (this.player.cockArea(x) < 30)
                ...
                this.outputText("Your fist slips in easily, and you give the toy a few preparatory thrusts to make sure it's nice and ready for your hefty cock.");
            this.outputText("\n\n");
            ...
            if (this.player.cockArea(x) < 30)
                ...
                this.outputText("lining up with the toy's gaping cunt");
            this.outputText(".  You rear your " + this.hipDescript() + " and slam yourself into the mare's waiting hole.\n\n");
        ...
        centaurGirlsGetHorseAids() {
            ...
            if (this.player.keyItemv1("Centaur Pole") == 0) {
                ...
                //[If Med-High Corruption:]
                    ...
                    this.outputText("Unable to sate your own lusts due to your centaur configuration, you decide to put one of Whitney's centaur toys to use.  You dig the Centaur Pole out of your stash and drag it to the middle of camp.\n\n");
            }
            ...
            console_1.trace("Times Ridden Pole" + this.player.keyItemv1("Centaur Pole"));
        }
        //Self/Exgartuan
        ...
        getHugeEggsInCawk() {
            ...
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 1 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Exgartuan) == 0 && this.flags[kFLAGS_1.kFLAGS.TIMES_EGGED_IN_COCK] == 0) {
                ...
                if (this.player.cor < 33) {
                    ...
                    this.outputText("in the wastes just outside of camp to be out of sight and mind");
                ...
                if (this.player.balls > 0) {
                    ...
                    if (this.player.fertilizedEggs() > 0)
                        this.outputText(", and you know beyond a doubt that they'll be fertilized before much longer and you'll be able to lay your own eggs");
                    this.outputText(".");
                }
                //[If no balls:] 
                else {
                ...
                if (this.player.cor < 33)
                    ...
                    this.outputText("into the trees outside of camp");
                ...
                if (this.player.gender == 3) {
                    ...
                    if (this.player.str > 50)
                        this.outputText("even with your considerable strength, ");
                ...
                if (this.player.balls > 0) {
                    ...
                    if (!this.player.isTaur())
                        this.outputText("More begin to follow, and you massage your quickly-bloating balls as they fill with egg after egg after egg.  ");
                ...
                if (!this.player.isTaur()) {
                    ...
                    if (this.player.balls == 0)
                        ...
                        this.outputText("bulging sack");
                }
                this.outputText(", and you dream of laying your own eggs some time in the future.");
            }
            if (this.player.fertilizedEggs() > 0 && this.flags[kFLAGS_1.kFLAGS.DICK_EGG_INCUBATION] == 0) {
                this.flags[kFLAGS_1.kFLAGS.DICK_EGG_INCUBATION] = 48;
            }
            this.player.dumpEggs();
            this.player.orgasm();
            this.flags[kFLAGS_1.kFLAGS.TIMES_EGGED_IN_COCK]++;
            this.doNext(this.camp.returnToCampUseOneHour);
        }
        ...
        birthBeeEggsOutYourWang() {
            ...
            if (this.player.cor < 50)
                ...
                this.outputText("somewhat annoyed");
            ...
            this.flags[kFLAGS_1.kFLAGS.DICK_EGG_INCUBATION] = 0;
            this.player.orgasm();
        }
        ...
        layEggsInYerTits() {
            this.clearOutput();
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Exgartuan) == 2 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Exgartuan) == 0) {
                //Exgartuan; breasts should be HH or larger, fuckable nipples, only if Exgartuan is awake
                this.outputText("Smiling mischieviously to yourself, you look down to your possessed [chest] and tell Exgartuan that you have something you very much would like to do for her.");
                ...
                //[if (hasVagina = true)]
                if (this.player.hasVagina())
                    this.outputText("  Your [vagina] lets sticky fluids out slowly around your thighs; you are only able to tell by the damp feel of your [legs].  It feels fantastic!");
                ...
                if (this.player.eggs() < 20) {
                    ...
                    if (this.player.hasCock())
                        this.outputText("  Your [chest] and ovipositor meanwhile are slowly being coated in white from your languid pleasure.");
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Eggchest) < 0) {
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Eggchest, 3 + Masturbation.rand(10), 1 + Masturbation.rand(4), 0, 0);
            }
            this.player.orgasm();
            this.dynStats("sen", 1);
            this.player.dumpEggs();
        ...
        tentacleSelfFuck() {
            ...
            while (this.temp < this.player.cocks.length) {
                if (this.temp != x) {
                    if (y < 0)
                        y = this.temp;
                    else if (Masturbation.rand(2) == 0 && this.player.cocks[y].cockType != CockTypesEnum_1.CockTypesEnum.TENTACLE)
                        y = this.temp;
                    else if (this.player.cocks[this.temp].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE)
                        y = this.temp;
                }
                this.temp++;
            }
            ...
            if (this.player.cor < 15)
                ...
                this.outputText("You strip naked, fondling your naughty bits as you do so and casting seductive looks around, hoping someone or something is nearby to fuck you.\n\n");
            this.outputText("Almost immediately, your " + this.cockDescript(x) + " perks up like a pet expecting to be fed, and you have to admit that you plan to give that squirming tentacle exactly what it desires - a hot, slippery slit to nestle inside of.  Already, your [vagina] has grown ");
            if (this.player.wetness() <= 2)
            ...
            if (y >= 0)
                this.outputText("  It loops around your " + this.cockDescript(y) + " while you fight with it, strangling the other phallus in tight coils of squeezing, floral friction.");
            ...
            if (this.player.balls > 0)
                ...
                this.outputText("  You");
            this.outputText(" twist your wrist down.  That change in direction comes far easier than trying to stroke it.  Releasing sets of alien muscles that you had held instinctively, you let your " + this.cockDescript(x) + " do what it was made to do.  It slithers down sinuously, the purplish head pressing heavy and hot against your juicy mound just hard enough to encourage you to press back against it.  It slowly spreads your clinging tunnel around its obscene girth one fold at a time.");
            //Cunt change!
            this.player.cuntChange(this.player.cockArea(x), true, true, false);
            this.outputText("\n\nRipples of delight radiate along your " + this.cockDescript(x) + " as it buries itself as deeply into your velvet tunnel as possible.  The fat, purplish head stretches you out as it goes, just enough that the trailing stalk is comfortably ensconced in twat.  Tugging on the exposed portion, you find yourself pumping wildly on your length, squeezing it while paroxysms of ecstasy render your fine muscle control useless.  The dual sensations of being fucked and dishing out a hot dicking have overlapped into a tangled-up knot inside you.");
            if (y >= 0) {
                this.outputText("  Your " + this.cockDescript(y) + " is getting jacked off by the engorged cock-coil's motions and slowly leaks creamy pre over the jerking length.");
                if (this.player.cocks[y].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE) {
            ...
            if (this.player.biggestTitSize() >= 1)
                this.outputText(", kneading the soft mammary");
            ...
            if (this.player.lactationQ() >= 250)
                this.outputText("  Milk squirts from your engorged teat almost immediately to fall in a moist, creamy rain across your writhing form.");
            ...
            if (this.player.tentacleCocks() >= 3) {
                ...
                if (this.player.biggestTitSize() >= 4)
                    this.outputText("  Laying right between your boobs, it doesn't take long for the shaft to extend far enough to loop around each tit, sliding slowly encircling each curvy mound as it presses them together around itself, getting a titfuck while it plows your unresisting mouth.");
            }
            //No bonus cawks!
            else {
                ...
                if (y >= 0 && this.player.cocks[y].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE && this.player.cocks[y].cockLength >= 20) {
            ...
            if (this.player.tentacleCocks() >= 6) {
                ...
                if (this.player.tentacleCocks() >= 7)
                    this.outputText("  They pile in there, really squirming against each other as much as you, frotting against your sweat-slick flesh.  ");
            ...
            if (this.player.tentacleCocks() >= 3) {
                ...
                if (this.player.cumQ() >= 500) {
                    ...
                    if (this.player.cumQ() < 1000)
                        ...
                        this.outputText("and the cum is soon squirting out the corners of your mouth while your cheeks bulge cartoonishly");
                }
                this.outputText(".");
            }
            ...
            if (this.player.tentacleCocks() == 2) {
                ...
                if (this.player.cumQ() < 50)
                    ...
                    this.outputText("like a virile sprinkler");
                this.outputText(".");
                if (this.player.cocks.length > 2) {
        ...
        tentacleGoesUpYerPooperNewsAtEleven() {
            var tentacle;
            for (tentacle = 0; tentacle < this.player.cocks.length; tentacle++) {
                if (this.player.cocks[tentacle].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE)
                    break;
            }
            for (var x = tentacle + 1; x < this.player.cocks.length; x++) { //Find the biggest tentacle cock you've got
                if (this.player.cocks[x].cockType == CockTypesEnum_1.CockTypesEnum.TENTACLE && this.player.cocks[x].cArea() > this.player.cocks[tentacle].cArea())
                    tentacle = x;
            }
            this.clearOutput();
            ...
            if (this.player.cumQ() >= 1000)
                this.outputText(", making [eachCock] bulge.  The extra feeling sends you over the edge and you quickly reach your climax as you cum and cum");
            this.outputText(".");
            //[if cum production is moderate]
            if (this.player.cumQ() >= 500)
                this.outputText("  Your belly swells a bit from all the semen being packed inside you.");
            //[if cum production is massive] 
            if (this.player.cumQ() >= 1500)
                this.outputText("  Your poor insides cannot handle the enormous cumshot being unloaded in your [asshole] and a significant volume of spunk dribbles outside, carelessly polluting the floor.");
        ...
        gildedCockTurbate() {
            ...
            for (gildedCock = 0; gildedCock < this.player.cocks.length; gildedCock++) {
                if (this.player.cocks[gildedCock].sock == "gilded")
                    break;
            }
            for (var x = gildedCock + 1; x < this.player.cocks.length; x++) { //Find the biggest gilded cock you've got
                if (this.player.cocks[x].sock == "gilded" && this.player.cocks[x].cArea() > this.player.cocks[gildedCock].cArea())
                    gildedCock = x;
            }
            ...
            //[large dicks]
                ...
                this.outputText("  Clamped around your dick, the metal casing looks more like a gigantic cock ring. The golden sheath actually allows you a better grip on your massive member, a ring of coolness around your hot meat.");
            ...
            if (this.player.hasVirginVagina()) { //LOW CORRUPTION DEFLOWER
                if (this.player.cor <= 50) {
                    ...
                    if (this.player.wetness() <= 2)
                        ...
                        this.outputText("The toy slides effortlessly thanks to your copious, almost inhuman lubrication.");
        ...
        dildoButts() {
            ...
            if (this.player.analCapacity() <= 8)
                ...
                this.outputText("Your experienced hole readily accepts your saliva-coated finger.");
        ...
        midasCockJackingGemsRoll() {
            var cockSocks = this.player.countCockSocks("gilded");
            var gems = 10 + Masturbation.rand(20);
            ...
            if (gems > 200 * cockSocks)
                gems = 200 * cockSocks + Masturbation.rand(20);
            return gems;
        }
        onaholeRepeatUse(corrupted) {
            ...
            if (corrupted) {
                ...
                if (gemsCreated > 0) {
                    this.outputText("<b>you relize the puddle is shimmering strangly. Looking closer you see that your man milk is coalescing into gems! You start collecting them, counting them as you go. You end up with " + gemsCreated + " gems and very little cum.</b>");
                }
                else {
...
//# sourceMappingURL=Masturbation.js.map