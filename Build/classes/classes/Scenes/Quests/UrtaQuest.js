define(["require", "exports", "../NPCs/NPCAwareContent", "../../ItemSlotClass", "../../PregnancyStore", "../../GlobalFlags/kFLAGS", "../../../console", "../../Player", "../../../../includes/appearanceDefs", "../../CockTypesEnum", "../../StatusAffects", "../../PerkLib", "../../ItemType", "./UrtaQuest/GoblinBroodmother", "../../GlobalFlags/kGAMECLASS", "./UrtaQuest/Sirius", "../Areas/Plains/GnollSpearThrower", "./UrtaQuest/MinotaurLord", "./UrtaQuest/MilkySuccubus"], function (require, exports, NPCAwareContent_1, ItemSlotClass_1, PregnancyStore_1, kFLAGS_1, console_1, Player_1, appearanceDefs_1, CockTypesEnum_1, StatusAffects_1, PerkLib_1, ItemType_1, GoblinBroodmother_1, kGAMECLASS_1, Sirius_1, GnollSpearThrower_1, MinotaurLord_1, MilkySuccubus_1) {
    ...
    class UrtaQuest extends NPCAwareContent_1.NPCAwareContent {
         ...
         */
            ...
            this.urtaQItems1 = new ItemSlotClass_1.ItemSlotClass();
            this.urtaQItems2 = new ItemSlotClass_1.ItemSlotClass();
            this.urtaQItems3 = new ItemSlotClass_1.ItemSlotClass();
            this.urtaQItems4 = new ItemSlotClass_1.ItemSlotClass();
            this.urtaQItems5 = new ItemSlotClass_1.ItemSlotClass();
        }
        urtaBusy() {
            return (this.telAdre.edryn.pregnancy.type == PregnancyStore_1.PregnancyStore.PREGNANCY_TAOTH || this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] == -1);
        }
        isUrta() {
            if (this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] > 0 && this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] < 1) {
                if (this.player.short == "Urta") {
                    if (this.player.hasCock()) {
                        if (this.player.cocks[0].cockLength == 20 && this.player.cocks[0].cockThickness == 3) {
                            if (this.player.hasVagina()) {
                                if (this.player.breastRows[0].breastRating == 7)
                                    return true;
                            }
                        }
                    }
        ...
        talkWithUrtaAboutFamFam() {
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] = .5;
        ...
        //Comfort Her(C)*
        comfortUrtaAfterFamFamTalk() {
            this.clearOutput();
            this.outputText("You lean over the table and take Urta's hands in your own.  Her downy fur ruffles as you give her a comforting squeeze, the tension oozing from her body at your touch.  Urta sniffles a little and wipes her moistened cheek on her shoulder, muttering, \"<i>Oh, " + this.player.short + ", you're too good for me.</i>\"  She pulls back and gives you a knowing smile.  \"<i>You don't have to worry, really.  You turned this down on her luck lush into a happy woman.</i>\"");
            ...
            if (this.urta.urtaDrunk())
                this.outputText("boozy ");
            this.outputText("kiss on your lips as she hugs you tight - tight enough that you feel every vein through the concealing silk of her outfit.  \"<i>I'm a lucky girl.</i>\"");
        ...
        infertilityQuestions() {
            this.clearOutput();
            this.outputText("You ask her about her infertility - specifically, how someone could be infertile AND unable to use transformative items without adverse effects.  Urta stirs her drink before shrugging noncommittally.");
            ...
            if (this.player.cor < 33)
                this.outputText("you have nothing to complain about there.  Your sexual romps with Urta are always a delight.");
            else if (this.player.cor < 66)
                this.outputText("she's definitely a handful in the sack, you've got to give her that.");
            else
                this.outputText("she's a willing fuck, so no complaints there.  Now if she would just get on with it - if you wanted to flirt, you would've instigated it.");
        ...
        resetToPC() {
            ...
            this.player.itemSlot1 = this.urtaQItems1;
            this.player.itemSlot2 = this.urtaQItems2;
            this.player.itemSlot3 = this.urtaQItems3;
            this.player.itemSlot4 = this.urtaQItems4;
            this.player.itemSlot5 = this.urtaQItems5;
        ...
        startUrtaQuest() {
            this.clearOutput();
            console_1.trace("Cloning PC's items");
            // *SERIALIZE* out the players current Player object + items
            this.urtaQItems1 = this.player.itemSlot1;
            this.urtaQItems2 = this.player.itemSlot2;
            this.urtaQItems3 = this.player.itemSlot3;
            this.urtaQItems4 = this.player.itemSlot4;
            this.urtaQItems5 = this.player.itemSlot5;
            this.player.itemSlot1 = new ItemSlotClass_1.ItemSlotClass();
            this.player.itemSlot2 = new ItemSlotClass_1.ItemSlotClass();
            this.player.itemSlot3 = new ItemSlotClass_1.ItemSlotClass();
            this.player.itemSlot4 = new ItemSlotClass_1.ItemSlotClass();
            this.player.itemSlot5 = new ItemSlotClass_1.ItemSlotClass();
            this.player2 = this.player;
            this.player = new Player_1.Player();
            this.model.player = this.player;
            this.player.short = "Urta";
            this.player.tallness = 71;
            this.player.hairColor = "gray";
            this.player.hairLength = 12;
            this.player.skinType = appearanceDefs_1.SKIN_TYPE_FUR;
            this.player.skinAdj = "silky";
            ...
            this.player.lowerBody = appearanceDefs_1.LOWER_BODY_TYPE_FOX;
            this.player.earType = appearanceDefs_1.EARS_FOX;
            this.player.faceType = appearanceDefs_1.FACE_FOX;
            this.player.tailType = appearanceDefs_1.TAIL_TYPE_FOX;
            this.player.tailVenom = 1;
            this.player.createCock();
            this.player.cocks[0].cockType = CockTypesEnum_1.CockTypesEnum.HORSE;
            this.player.cocks[0].cockLength = 20;
            this.player.cocks[0].cockThickness = 3;
            this.player.balls = 2;
            this.player.ballSize = 4;
            this.player.cumMultiplier = 80;
            ...
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.BonusVCapacity, 58, 0, 0, 0);
            this.player.createVagina();
            this.player.vaginas[0].vaginalWetness = appearanceDefs_1.VAGINA_WETNESS_DROOLING;
            this.player.vaginas[0].vaginalLooseness = appearanceDefs_1.VAGINA_LOOSENESS_NORMAL;
            ...
            this.player.cor = 30;
            this.player.lust = 55;
            this.player.gems = 183;
            this.player.level = 15;
            this.player.teaseLevel = 4;
            this.player.HP = this.player.maxHP();
            this.player.fatigue = 0;
            //PERKS
            this.player.createPerk(PerkLib_1.PerkLib.Resistance, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Agility, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.WeaponMastery, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Acclimation, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Nymphomania, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Precision, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Seduction, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Evade, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Tactician, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.LungingAttacks, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.ImmovableObject, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.BrutalBlows, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Brawler, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Berzerker, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Tank, 0, 0, 0, 0);
            ...
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] = .75;
        ...
        towerOfTheCovanant() {
            this.clearOutput();
            this.outputText("You get up to leave the table, nervously wrapping your tail down your leg, even though " + this.player2.short + " helped you overcome that timid habit long ago.  You tell " + this.player2.mf("him", "her") + " that " + this.player2.mf("he", "she") + " can't follow.  To bring " + this.player2.mf("him", "her") + " into the tower would require countless tests for what should only take a few brief moments if you go alone.  Secretly, you wish " + this.player2.mf("he", "she") + " could come with you and hold you tight, to comfort you through this nerve wracking ordeal.  Lifting your chin, you marshal your courage and walk out, wiggling your bottom in " + this.player2.short + "'s direction to remind " + this.player2.mf("him", "her") + " what " + this.player2.mf("he", "she") + "'ll be claiming tonight if a solution can be found.");
        ...
        towerOfTheCovenantII() {
            ...
            this.outputText("\n\nOh... you'll have to go out, to the outside, and find Taoth's shrine.  \"<i>How would I find his shrine?</i>\" you ask Gul, uncertain as to how to even start.  \"<i>Could my lover, " + this.player2.short + ", come along?  I... I don't want to do this alone.</i>\"  You desperately want " + this.player2.mf("his", "her") + " company and skills at surviving outside the walls for this.");
            ...
            this.outputText("\n\nYou give him a kiss on the nose and head for the door, equal parts excited and terrified by the opportunity you've been given.  Now, before you leave on your search you should visit " + this.player2.short + ".  You could tell " + this.player2.mf("him", "her") + " everything, or you could simply spend an evening with " + this.player2.mf("him", "her") + " without letting " + this.player2.mf("him", "her") + " know the danger you're about to get into.  Though, Gul did urge you to make haste, maybe it would be best for everyone if you embarked sooner and returned to " + this.player2.short + " healthy.");
            ...
            if (this.flags[kFLAGS_1.kFLAGS.HEL_FUCKBUDDY] > 0) {
                this.addButton(0, "Stop4ADrink", this.getHelBangedAsUrta);
            }
        ...
        getHelBangedAsUrta() {
            this.clearOutput();
            this.outputText("Before you head out, you decide to grab some liquid fortitude at your favorite watering hole. You make your way down to the Wet Bitch, squinting as your eyes adjust to the deep shadows of Tel'Adre's seediest - and sexiest - bar. You slip in, grabbing a stool at the bar; when your drink comes, you toss your gear aside like a physical weight off your shoulders, sighing heavily as you bring the hefty stein up to your lips. The cool beer goes down quickly, washing away your worries about the upcoming quest, and the recent revelations you've been given. Your mind wanders to " + this.player2.short + ", wondering if " + this.player2.mf("he", "she") + "'s set you on the right course...");
            ...
            this.outputText("\n\nShe knows " + this.player2.short + "? You quickly nod as your mind quickly reaches its inevitable conclusions. Well, you suppose you can't judge... you haven't exactly been monogamous, either, after all. It isn't fair to expect that from " + this.player2.mf("him", "her") + ", is it?  Still, you shift awkwardly in your seat, nursing your new drink as the scaly warrior girl starts recounting the fights she and " + this.player2.short + " used to have");
            if (this.flags[kFLAGS_1.kFLAGS.HEL_HARPY_QUEEN_DEFEATED] > 0)
                this.outputText(", and even how they worked together to bring down an evil sorceress and save her father. Your heart swells with pride as she recounts " + this.player2.short + " doing so a noble thing, and for a moment you know you made the right pick in a lover..");
            this.outputText(".  You sit and listen for a long few minutes, sipping at the beer until the liquid courage starts to work its wonders, giving you a little tingle... and helping to open you up, too.  Soon, you're drawn into the conversation, joking and teasing with the other girls as if you'd been friends for ages.");
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_MET_HEL] = 1;
        ...
        leaveB4HelFucksUrta() {
            this.clearOutput();
            this.outputText("As quickly as you can, you blather out some excuse and grab your gear, trying to cover your huge erection as you run toward the door, blurting an awkward thanks over your shoulder for the drink...");
            this.outputText("\n\n\"<i>Uh, bye!</i>\" Mai calls out, waving. \"<i>See you again some time?</i>\"");
            //{Continue with UrtaQuest}
            this.outputText("\n\nDo you embark now, visit " + this.player2.short + ", or visit " + this.player2.mf("him", "her") + " and tell everything?");
        ...
        fuckHelAndKitsunesAsUrta() {
            ...
            if (this.player2.hasCock()) {
                ...
                if (this.helFollower.followerHel())
                    this.outputText("at home");
                else
                    this.outputText("at my beck and call");
                this.outputText(", you know...  But we've got that in common, don't we?  Mmm, maybe we can share it some day?  A horny girl like you'd just love that, woudn't you? Getting to worship " + this.player2.mf("his", "her") + " cock beside me while my tail fills your ass so full you scream....</i>");
            }
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_FUCKED_HEL] = 1;
            this.player.orgasm();
        ...
        visitPCPreUrtaQuest(truth) {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.JojoNightWatch) >= 0 && this.player.findStatusAffect(StatusAffects_1.StatusAffects.PureCampJojo) >= 0)
                this.outputText("You easily sneak past a mouse monk.  He's looking towards the sky mostly, perhaps watching for imps.  ");
            if (this.flags[kFLAGS_1.kFLAGS.ANEMONE_WATCH] > 0 && this.flags[kFLAGS_1.kFLAGS.ANEMONE_KID] > 0)
                this.outputText("A confused-looking anemone with a " + ItemType_1.ItemType.lookupItem(this.flags[kFLAGS_1.kFLAGS.ANEMONE_WEAPON_ID]).longName + " nearly sees you, but you duck around a rock and escape her notice.  ");
            if (this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_LEVEL] >= 4 && this.flags[kFLAGS_1.kFLAGS.FUCK_FLOWER_KILLED] == 0 && this.flags[kFLAGS_1.kFLAGS.HOLLI_DEFENSE_ON] > 0)
                this.outputText("A dangling tentacle nearly hits you in the dark.  You roll aside at the last moment, looking up to see dozens of the things idly dangling around.  When did this camp get such a corrupt tree in it?  You suppose it must have its uses in defending against foes from the sky...  ");
            if (this.camp.companionsCount() > 2)
                this.outputText("There are a number of people in the camp, but you avoid them as you head towards " + this.player2.short + "'s bunk.  ");
            this.outputText("The camp looks pretty nice actually.  Living out here must have given " + this.player2.mf("him", "her") + " plenty of time to improve it.");
            this.outputText("\n\n" + this.player2.short + " is slumbering fitfully on " + this.player2.mf("his", "her") + " blanket.  " + this.player2.mf("He", "She") + " looks so cute, sleeping like this.  It's amazing how " + this.player2.mf("he", "she") + " has the courage to stay out here, day after day, month after month, guarding this portal to keep " + this.player2.mf("his", "her") + " village safe");
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) >= 0)
                this.outputText(", no matter why " + this.player2.mf("he", "she") + " was sent here");
            this.outputText(".  You gently press on " + this.player2.mf("his", "her") + " shoulder and shake " + this.player2.mf("him", "her") + " awake, holding your index finger across " + this.player2.mf("his", "her") + " lips to shush " + this.player2.mf("him", "her") + " to silence.  " + this.player2.mf("His", "Her") + " eyes snap open, worried until " + this.player2.mf("he", "she") + " recognizes you.  \"<i>What are you doing here?</i>\" " + this.player2.mf("he", "she") + " asks in a whisper.");
            //{TELL HIM ZE TRUFF}
            if (truth) {
                this.outputText("\n\nYou sit down across from " + this.player2.mf("him", "her") + ", helping " + this.player2.mf("him", "her") + " up to a sitting position as you explain.  " + this.player2.mf("His", "Her") + " eyes widen as " + this.player2.mf("he", "she") + " takes in the news, clearly disbelieving your explanation at first.  " + this.player2.mf("He", "She") + " listens all the same, gradually coming to accept your explanation for truth.  When you tell " + this.player2.mf("him", "her") + " you have to leave, alone, to continue your journey, ");
                if (this.player2.cor < 33)
                    this.outputText(this.player2.mf("he", "she") + " argues that " + this.player2.mf("he", "she") + " should come anyway.  You tell " + this.player2.mf("him", "her") + " no, firmly, even though it breaks your heart.");
                else if (this.player2.cor < 66)
                    this.outputText(this.player2.mf("he", "she") + " nods understandingly, not surprised that you have to handle this quest alone.  The two of you are alike in that way - each with their own burden to bear.");
                else
        ...
        //Put Urta dick in the PC's asshole [Cocked PCs](C)*
        urtaPutsHerDickInPCsWithDicks(truth) {
            this.clearOutput();
            this.outputText("You push " + this.player2.short + " down onto the ground, glad that " + this.player2.mf("he", "she") + "'s not wearing " + this.player2.mf("his", "her") + " gear right now.  Unfortunately, you've still got to get out of yours, an action made all the more difficult by the heat welling up in your groin.  Your rebellious cock is already half-stiff, lifting the hem of your armored skirt away from your thighs.  Fingers scrabbling, you struggle with your chestpiece's bindings.  Your nipples stiffen, scraping against the inside of it while you fight to remove it.  You straddle " + this.player2.short + "'s waist to hold " + this.player2.mf("him", "her") + " down while you work the bothersome, restraining material free, practically grinding your semi-rigid dick against " + this.player2.mf("his", "hers") + " in excitement.  " + this.player2.mf("His", "Her") + " hands begin aiding you in your task, allowing your tightly compressed breasts to finally, happily breathe.   They jiggle as they flop free, and to your delight, " + this.player2.short + "'s eyes lock on them.");
            this.outputText("\n\nGrabbing hold of " + this.player2.mf("his", "her") + " head, you pull " + this.player2.short + "'s lips to one of your puckered nipples.  " + this.player2.mf("He", "She") + " swallows it immediately, grabbing hold of your tits to squeeze and fondle them, openly enjoying the fruits of your womanly shape.  Tingles of electric enjoyment fire from your unrestrained areola when " + this.player2.mf("he", "she") + " squeezes down on the other with " + this.player2.mf("his", "her") + " fingers, expertly twisting the little nub around to give you the maximum pleasure.  In no time flat, you're humping " + this.player2.mf("his", "her") + " " + this.player2.cockDescript(this.player2.biggestCockIndex()) + " openly, letting " + this.player2.mf("him", "her") + " guide your motions with deft, controlling touches to your onyx nipples.  Your pre-cum bubbles out unhindered, the thick gobs swaying and splattering on " + this.player2.mf("his", "her") + " belly and rigid tool, quickly lubricating the phallic embrace into a sticky, hot mess.");
            this.outputText("\n\n" + this.player2.short + " releases your tender tits after a few particularly sloppy thrusts.  You can feel " + this.player2.mf("his", "her") + " " + this.player2.cockDescript(this.player2.biggestCockIndex()) + " releasing some of its own pre-cum onto your cock's thick spooge-vein, and " + this.player2.mf("his", "her") + " hands fall to grab at the blanket below, unintentionally clenching at the waves of pleasure you're giving " + this.player2.mf("him", "her") + ".  You bend now, onto all fours");
            if (this.player2.tallness < 60)
                this.outputText(" and let your tits hang over " + this.player2.mf("his", "her") + " " + this.player2.face());
            else if (this.player2.tallness < 76)
                this.outputText(" and let your tits swing between you");
            else if (this.player2.tallness < 84)
                this.outputText(" and let your tits smash into " + this.player2.mf("his", "her"));
            else
                this.outputText(" and let your tits sway over " + this.player2.mf("his", "her") + " belly");
            this.outputText(", giving " + this.player2.mf("him", "her") + " something to enjoy while you begin to shift position, dragging your dick down " + this.player2.mf("his", "her") + " length");
            if (this.player2.hasVagina())
                this.outputText(", past " + this.player2.mf("his", "her") + " pussy,");
            this.outputText(" and towards the prize you've been wanting since you got here - " + this.player2.mf("his", "her") + " asshole.");
            this.outputText("\n\nYou glance up at " + this.player2.mf("his", "her") + " face when your oozing, fat cock-tip presses into " + this.player2.mf("his", "her") + " sphincter, looking for assent.  " + this.player2.mf("He", "She") + " gives it a moment later, moaning and rubbing " + this.player2.mf("his", "her") + " butt back into you, butthole clenching and relaxing a little more with every contact.");
            if (this.player2.analCapacity() > 70)
                this.outputText("  Thankfully, " + this.player2.mf("he", "she") + "'s nice and stretched from all the butt-fucking " + this.player2.mf("he", "she") + "'s had to take, and you easily pop inside.  It feels so good that your flare grows wider, pulling you deeper into that welcoming, tight anal heat.");
            else if (this.player2.analCapacity() > 50)
                this.outputText("  Thankfully, " + this.player2.mf("he", "she") + "'s got plenty of give in " + this.player2.mf("his", "her") + " back-door, and you pop inside after applying a little more pressure.  It feels so good that your flare grows wider, slowing your descent into that tight, anal heat.");
            else
                this.outputText("  Unfortunately, there's not much give in " + this.player2.mf("his", "her") + " back-door, and you have to sit there smearing pre over it, again and again, each time pushing a little harder.  After what feels like the fiftieth try, you finally pop your fat flare into " + this.player2.mf("his", "her") + " rectum, the tight anal heat causing you to flare from the force of " + this.player2.mf("his", "her") + " pressure.  Slowly, you push inch after throbbing inch of your swollen, stallion-like erection into " + this.player2.mf("his", "her") + " asshole.");
            if (this.player2.ass.analLooseness == 0) {
                this.outputText("  <b>You've taken " + this.player2.mf("his", "her") + " anal virginity!</b>");
                this.player2.ass.analLooseness = 1;
            }
            this.outputText("  " + this.player2.short + " writhes as " + this.player2.mf("he", "she") + " takes you, " + this.player2.mf("his", "her") + " hips lifting slightly off the ground to make sure you grind into " + this.player2.mf("his", "her") + " prostate.  A long strand of clear excitement oozes from " + this.player2.mf("his", "her") + " tip");
            if (this.player2.cockTotal() > 1)
                this.outputText("s");
            this.outputText(", thick, viscous, and clinging to the drying mess you left behind.");
            this.outputText("\n\nGrabbing hold of you by the scruff of your neck, " + this.player2.short + " pulls you down into a kiss.  You passionately french " + this.player2.mf("him", "her") + " and try your hardest to time your thrusts to each plunging slurp your tongue makes into " + this.player2.mf("his", "her") + " oral cavity.  Together, you make love, mouth to mouth and cock to ass.  " + this.player2.mf("His", "Her") + " dark pucker wrings at your horse-cock, the tight muscles at " + this.player2.mf("his", "her") + " entrance seizing every time your sheath tickles up against them.  Groaning into " + this.player2.mf("his", "her") + " mouth, you lose whatever control you had and let your equine dong take over, helpless to resist your overpowering lust.  You pound " + this.player2.mf("his", "her") + " clenching anus hard and fast, breaking the kiss as you moan, forgetting how to do anything but hold your body in position and drive your thighs back and forth, back and forth-and-back-forth, faster and faster.");
            this.outputText("\n\nYour balls begin to tingle with warmth in that familiar way that they do just before you cum, rising slightly involuntarily as your sack starts to pull tight and release.  Your cock flexes inside your lover's asshole hard enough to squeeze a spurt of dick-juice onto " + this.player2.mf("his", "her") + " chest, and with an exultant moan, you declare, \"<i>I'm gonna...  CUUUUUUM!</i>\"  " + this.player2.short + " answers you with a moan of " + this.player2.mf("his", "her") + " own, digging " + this.player2.mf("his", "her") + " hands into your swaying, unrestrained tits as " + this.player2.mf("he", "she") + " releases.");
            this.outputText("\n\nYou ram your turgid mass in until your sheath is smashed flat against your abdominals, almost painfully.  Below, your taut sack expands slightly before shrinking, pumping hot pleasure through your abdomen and down your rapidly dilating urethra.  You can feel it dilate the base of your cock, stopped up for a second by " + this.player2.short + "'s sphincter, and then it pushes through, widening " + this.player2.mf("his", "her") + " butthole in the process.  Your flare feels as wide as one of Aunt Nancy's plates back at the bar, immobilizingly thick and pulsing with every hammering heartbeat that pounds through it.  You release some of your pent-up, achingly hot seed into " + this.player2.mf("his", "her") + " butt with a cry of joy.  Wriggling down against " + this.player2.mf("him", "her") + ", you squeeze " + this.player2.mf("his", "her") + " pulsing erection");
            if (this.player2.cockTotal() > 1)
                this.outputText("s");
            this.outputText(" between your bodies, " + this.player2.mf("his", "her") + " liquid love exploding all over your cock-locked forms.  Each time you cum, a fresh-squeezed spurt of semen splatters into your tits, " + this.player2.mf("his", "her") + " prostate violently being milked by the heady flows of vixen-spunk you force inside " + this.player2.mf("his", "her") + " rectum.");
            if (this.player2.hasVagina())
                this.outputText("  You don't notice the female fluids that drip from her sodden slit - they soak into your big balls, already forgotten.");
            this.outputText("\n\n" + this.player2.short + " kisses you, or at least tries to - " + this.player2.mf("his", "her") + " body wiggles " + this.player2.mf("him", "her") + " away with every blissful spurt that " + this.player2.mf("he", "she") + " makes");
            if (this.player2.cumQ() >= 500) {
                this.outputText(", made worse by the sheer volume of spunk " + this.player2.mf("his", "her") + " cock");
                if (this.player2.cockTotal() > 1)
                    this.outputText("s exude");
                else
                    this.outputText(" exudes");
            }
            this.outputText(".  Wonderfully, " + this.player2.mf("his", "her") + " belly begins to round out from your seemingly endless flow of animal jizz.  Without meaning to, you imagine " + this.player2.mf("him", "her") + " as your uber-pregnant, belly-dragging brood-mare, cum drooling from every packed hole and " + this.player2.mf("his", "her") + " body drenched in excess.  The thought sets off another explosive orgasm, even before the first has finished.  Your climax is so powerful that your balls feel like they're being squeezed in a vice.  " + this.player2.short + "'s asshole fountains cum around the edges of your potent phallus as it's filled beyond capacity.  " + this.player2.mf("His", "Her") + " belly rounds just as you imagined it, and you begin to piston your hips while your eyes roll back, unseeing.  You don't care, you're drooling all over your spunked up broodmare and giving " + this.player2.mf("him", "her") + " another load of kits, even if it is in " + this.player2.mf("his", "her") + " ass!");
            this.outputText("\n\nEven after your orgasm ends and your strength gives out, you keep working your massive, monstrous dong into " + this.player2.short + "'s ass with weak little strokes.  " + this.player2.mf("He", "She") + " makes a pained, plaintive moan, just loud enough for you to hear.  That distressed keen is all it takes to shake you out of your fuck-hungry rut, and you immediately pull out, panting and placing a compassionate hand on " + this.player2.short + "'s face.  " + this.player2.mf("He", "She") + " sighs with relief as a river of your alabaster goo escapes the well-stretched confines of " + this.player2.mf("his", "her") + " over-inseminated anus.  It soaks the blanket utterly");
            if (this.player2.cumQ() >= 500) {
                this.outputText(", mixing with " + this.player2.mf("his", "her") + " own ");
                if (this.player2.cumQ() < 1000)
                    this.outputText("puddly");
                else if (this.player2.cumQ() < 2500)
                    this.outputText("small lake-sized");
                else
                    this.outputText("massive, lake-sized");
                this.outputText(" mess - only now do you realize just how much your lover could produce!  The");
            }
            else
                this.outputText(", but the");
            this.outputText(" semen-inundated fabric quickly begins to dry as the parched, wasteland dirt reclaims the moisture.");
            this.outputText("\n\n" + this.player2.short + " pulls you down for another kiss, and you lose yourself to it, never going completely soft - as if you could in " + this.player2.mf("his", "her") + " presence.  You close your eyes and let sleep claim you, cuddled together, basking in the heady smell of your combined pleasure.");
            this.player.orgasm();
            this.dynStats("sen", -2);
            this.menu();
        ...
        pcBlowsUrtasDong(truth) {
            this.clearOutput();
            this.outputText("You ogle your lover's naked form, admiring " + this.player2.mf("his", "her") + " beauty.  When your eyes fixate upon " + this.player2.mf("his", "her") + " sweet kissing lips... mmm, you'd really like to feel those wrapped around your aching dick...  Mustering your courage, you embrace your partner, and gently but insistently push " + this.player2.mf("him", "her") + " to the ground.  Leaning over to " + this.player2.mf("his", "her") + " ear, you say, in a stage whisper, \"<i>You have such a pretty mouth, and my cock's aching so bad... will you kiss it better?</i>\"  You blush, as much from the corniness of your line as from embarrassment at what you're asking " + this.player2.mf("him", "her") + " to do.");
            this.outputText("\n\n" + this.player2.short + " is surprised at your request, but smiles and nods, gently giving your lips a little peck.  A small promise of what's to come.  Feeling emboldened by " + this.player2.mf("his", "her") + " willingness, you grab " + this.player2.mf("his", "her") + " shoulder and pull " + this.player2.mf("him", "her") + " deeper into a kiss, eager to savor the lips that will soon be wrapping themselves around your dick, tongue flicking through them to brush up against your lover's tongue.  While you're  preoccupied with " + this.player2.mf("his", "her") + " mouth, " + this.player2.short + "'s hands roam your body, seeking the straps holding your leather armor together, peeling off the layers of protection in order to get to your naked body.  You moan appreciatively into the kiss when " + this.player2.mf("he", "she") + " gives your furry breasts an appreciative grope.  \"<i>Mmm, you have wonderful hands, " + this.player2.short + "; I love it when you touch me like this...</i>\" you croon, and then you kiss " + this.player2.mf("him", "her") + " again to show your appreciation.");
            this.outputText("\n\nAs wonderful as this feels, however, this isn't what you had in mind, something you become aware of when you feel your cock pushing against your lover's belly.  Your dick bobs up and down before you, the unflared head slightly expanding and then curling back in as arousal builds.  You break away from your lover and give " + this.player2.mf("him", "her") + " a somewhat sheepish smile.  \"<i>Looks like he's eager for your kiss,</i>\" you giggle nervously, trying to lighten the mood by referring to your penis as if it was its own entity... though the depressing thought occurs to you that, with how often it tends to think for you, there's more than a little truth in that idea.");
            this.outputText("\n\n" + this.player2.short + " smiles mischievously at you and rolls you over, pinning you on your back while " + this.player2.mf("he", "she") + " eyes your equine-prick.  It stands like a perverted mast, throbbing, aching for a little touch.  \"<i>Well?  Go on, he's not going to bite,</i>\" you suggest, rubbing your thighs together in anticipation of what's coming next.  You want this so badly, but it's hard to get over a lifetime of issues when it comes to your dick.");
            this.outputText("\n\n" + this.player2.mf("He", "She") + " finally grasps your rock-hard shaft, pumping it lightly.  You moan appreciatively and buck your hips as " + this.player2.short + " slowly milks you for your pre.  \"<i>W-what are you trying to do?  Stroke me until I blow before you can wrap your lips around it?  Is it - am <b>I</b> -  too big for you to handle, " + this.player2.short + "?</i>\"  You do your best to make your tone light and playful when you say this.  " + this.player2.short + " pinches your flared head and gives it a little twist, stimulating your tip sharply.  You squeal in shock, \"<i>" + this.player2.short + ", not so rough!  I'm not that kinky of a girl!</i>\"  You complain.  " + this.player2.short + " gives you a smug look, pointing at your shaft and the ample proof of your enjoyment of that little act - your cock is leaking pre like an open tap.  You blush and try to mumble that it's not your fault that happens.");
            this.outputText("\n\nDollops of pre gather on your tip, and soon begin to overflow, sliding down along your shaft and your lover's hand.  Seeing this " + this.player2.mf("he", "she") + " licks " + this.player2.mf("his", "her") + " lips and slowly approaches your tip, kissing it and licking the pre gathered there.  You moan appreciatively, and give " + this.player2.mf("him", "her") + " a coy smile.  \"<i>Mmm, you're a nice kisser... but let's see some real kissing, shall we?  Give him a little tongue, " + this.player2.short + ",</i>\" you tease.");
            this.outputText("\n\n" + this.player2.mf("He", "She") + " does as you ask, licking your throbbing pole clean of pre, then finally taking your engorged tip in, sucking on it like a straw. You groan in pleasure and wriggle your hips as your lover's caressing lips and tongue send sparks of pleasure surging through your nervous system, your dick revelling in what " + this.player2.mf("he", "she") + "'s doing to it.  \"<i>More, please, more!</i>\"");
            this.outputText("\n\n" + this.player2.short + " bobs on your shaft, taking it as deep into " + this.player2.mf("his", "her") + " throat as " + this.player2.mf("he", "she") + " can, sucking and slurping obscenely with every move, one hand sliding down to caress your balls, rolling them around in " + this.player2.mf("his", "her") + " palm; " + this.player2.mf("his", "her") + " other moving along your furry belly, reaching for your breasts.  You growl lustily in your throat; your legs twitch with the desire to wrap themselves around " + this.player2.mf("his", "her") + " head and force " + this.player2.mf("him", "her") + " to go all the way down to your balls, but you restrain yourself.  You want to make this special, and that means letting " + this.player2.mf("him", "her") + " have as much control as possible.  \"<i>You have such a sweet mouth, " + this.player2.short + "... but I think the two of us want some more sugar.</i>\"  Almost as if to punctuate your statement, you moan as your balls clench, squeezing a generous dollop of precum into your lover's mouth.");
            this.outputText("\n\n" + this.player2.short + "'s hand leaves your balls and slides behind them, probing your moist honeypot and fingerfucking you slowly. You wriggle and buck in your seat, unconsciously thrusting your dick forward as you react to this unexpected but delightful turn of events.  As if to tease you, " + this.player2.short + " suddenly stops, removing " + this.player2.mf("his", "her") + " fingers from your dripping pussy and " + this.player2.mf("his", "her") + " mouth from your leaking cock.  \"<i>I'm not done yet!</i>\"  You whimper - you're so close to cumming now, you can feel your balls churning as they stretch themselves with a new load, your dick on fire with the need to release.  Your protests are silenced when you're presented with " + this.player2.mf("his", "her") + " slick fingers, covered in fox honey.");
            this.outputText("\n\nOh, so that's how " + this.player2.mf("he", "she") + " wants to play it, eh?  Well, you're not afraid of this game.  With your most flirtatious look, you gently take " + this.player2.mf("his", "her") + " hand and lift it to your mouth, slowly and lovingly licking your sweet juices from your lover's fingers, painstakingly lapping each one up and down before you suck them through your puckered lips.  With a muffled chorus of slutty moans you suck, nibble, and nip at the fingers, staring into " + this.player2.mf("his", "her") + " eyes through your own hooded gaze, making it clear you're enjoying every moment of this.");
            this.outputText("\n\nRemoving " + this.player2.mf("his", "her") + ", now clean, hand from your lips with a <b>POP</b>, " + this.player2.short + " smiles wryly at you as " + this.player2.mf("he", "she") + " grabs your legs and lifts them over your shoulders.  \"<i>Now what are you-</i>\"  You start to say, curious about what your lover has in mind.  " + this.player2.mf("He", "She") + " silences you by shoving " + this.player2.mf("his", "her") + " fingers down your pussy once again. You blink in surprise, but are too pleased at what's happening now to care much, enthusiastically bucking your hips to meet " + this.player2.mf("his", "her") + " probing fingers, then whimpering in disappointment when they are removed again.");
            this.outputText("\n\nYou're presented with " + this.player2.mf("his", "her") + " slick fingers once more.  \"<i>Heh, do you get off on seeing me suck your fingers, " + this.player2.short + "?</i>\"  You're sincerely curious, but eagerly accept them all the same, sucking them clean a second time. You smack your lips as the fingers are extracted from your mouth once more.  You impatiently wriggle and squirm in your seat, \"<i>" + this.player2.short + ", I'm going mad here - let me cum, please?  Pretty please?</i>\"   " + this.player2.short + " traces a finger along your shaft, down your balls, along your slit, and gently moves to prod your tight little rosebud.  \"<i>W-what are you up to now?<i>\"  You ask, at once scared and excited to see what " + this.player2.mf("he", "she") + " has in mind.");
            this.outputText("\n\n" + this.player2.mf("His", "Her") + " only reply is to shove " + this.player2.mf("his", "her") + " slick finger into you, roughly stimulating your prostate.  You vent a throaty howl of equal parts shock, disapproval and ecstasy.  The prostate milking proves to be more than your poor, over-hyped cock can take.  Your balls squeeze themselves up into your crotch as pleasure burns through your stallionhood like hard liquor burns down your gullet, climaxing in a veritable eruption of foxy herm seed that explodes dramatically from your dessert-plate-sized flare, jetting straight at your chest and impacting with enough force to splatter your surroundings.  The bubbling torrent of spunk rains down in a heady, musky, kinky deluge that drenches your face and tits alike.  Unthinkingly, you open your mouth and loll out your tongue, gulping down mouthful after mouthful of your own spooge until finally your balls empty themselves.");
            this.outputText("\n\n" + this.player2.short + " releases you, letting your legs flop on the floor nervelessly.  " + this.player2.mf("He", "She") + " pats your thigh and glances at you questioningly.  \"<i>Did fox enjoy her bath?</i>\"  " + this.player2.mf("He", "She") + " asks with a chuckle, rubbing your belly.");
            this.outputText("\n\n\"<i>I can think of better ways to have a bath,<i>\" you answer primly... then realize your treacherous leg is kicking with pleasure at the belly rub, and you have to concentrate hard to force it to stop.  \"<i>Besides, I thought I was supposed to be giving you a feeding, not myself a bath?</i>\"  You laugh.  " + this.player2.short + " looks pensive for a moment, but ultimately, " + this.player2.mf("he", "she") + " just shrugs and redoubles " + this.player2.mf("his", "her") + " effort, rubbing your belly even harder to get you to kick your leg a bit more.  \"<i>S-stop that!</i>\"  You blurt, trying to keep the fact that this does feel good out of your voice even as you wriggle at the ticklish sensation.  Of course, maybe a belly-rub on top of a decent bellyful of cum isn't such a good idea; you feel queasy for a moment, then can't hold back a loud burp.  This shocks your mischievous lover into loosening " + this.player2.mf("his", "her") + " grip, and you promptly seize advantage of that; you surge forward and swiftly overpower " + this.player2.mf("him", "her") + ", wrestling " + this.player2.mf("him", "her") + " to the floor and then giving " + this.player2.mf("him", "her") + " a wet, sloppy, deep-throating, tongue-filled kiss.  You noisily make out with your lover for a couple of minutes, then let " + this.player2.mf("him", "her") + " go.  \"<i>See what bad " + this.player2.mf("boys", "girl") + " get?<i>\"  You chuckle.  " + this.player2.short + " just grins innocently at you.");
            this.outputText("\n\nYou yawn loudly, feeling tired now.  You promptly make yourself comfortable lying on " + this.player2.short + "'s belly, and kiss " + this.player2.mf("him", "her") + " on the nose.  \"<i>Night, " + this.player2.short + "; sleep well.</i>\"  You say, then close your eyes and allow yourself to drift off to sleep, happily using " + this.player2.mf("him", "her") + " as a full-body pillow.");
            this.player.orgasm();
            this.dynStats("sen", -2);
            this.menu();
            this.addButton(0, "Next", this.morningAfterCampVisitEmbark, truth);
        ...
        putAPCDickInUrtaCoochies(truth) {
            this.clearOutput();
            var x = this.player2.cockThatFits(this.urta.urtaCapacity());
            this.outputText("You push " + this.player2.short + " down onto the ground, glad that " + this.player2.mf("he", "she") + "'s not wearing " + this.player2.mf("his", "her") + " gear right now.  Unfortunately, you've still got to get out of yours, an action made all that more difficult by the heat welling up in your groin.  Your rebellious cock is already half-stiff, lifting the hem of your armored skirt away from your thighs.  Fingers scrabbling, you struggle with your chestpiece's bindings.  Your nipples stiffen, scraping against the inside of it while you fight with to remove it.  You straddle " + this.player2.short + "'s waist to hold " + this.player2.mf("him", "her") + " down while you work the bothersome, restraining material free, practically grinding your semi-rigid dick against " + this.player2.mf("his", "hers") + " in excitement.  " + this.player2.mf("His", "Her") + " hands begin aiding you in your task, allowing your tightly compressed breasts to finally, happily breathe.");
            ...
            if (this.player2.gender == 3)
                this.outputText("...well, close enough... ");
            this.outputText("to ever fuck you like a woman.  Grabbing " + this.player2.mf("his", "her") + " face, you pull " + this.player2.mf("him", "her") + " into a deep, passionate kiss, unthinkingly grinding your dripping cock and steadily-wettening gash into " + this.player2.mf("his", "her") + " belly and rubbing your own pebbly onyx nipples against " + this.player2.mf("his", "her") + " nipples.  " + this.player2.mf("His", "Her") + " own " + this.player2.cockDescript(x) + " begins to drool precum");
            if (this.player2.hasVagina())
                this.outputText(", her cunt dripping wetly onto the ground from the stimulus");
            this.outputText(", the fluid rolling down its length to puddle with yours on " + this.player2.mf("his", "her") + " belly and filling your writhing, passionate embrace with hot, sticky sweetness.");
            ...
            if (this.player2.isTaur() || this.player2.isDrider()) {
                ...
                if (!this.player2.isDrider())
                    this.outputText("quadrapedal");
                else
                    this.outputText("octapedal");
                this.outputText(" partner to mount you - encouragement " + this.player2.mf("he", "she") + " doesn't really need that much of.  Forelegs draping themselves over your shoulders, there is a little awkwardness as the two of you try to position " + this.player2.mf("his", "her") + " cock inside of you, but it doesn't take that much experimentation before it slides inside you.");
                this.outputText("\n\nYou can't resist moaning like a slut as the pleasure of being filled by " + this.player.mf("his", "her") + " dick washes through you like a flood of honey-sweet warmth; while you've tried to fill your empty nights with too many toys to be virgin-tight by any means, being filled by the first cock to ever penetrate you for real is still too overwhelming.  Your toy-trained cunt eagerly clamps down on the intruder, squeezing " + this.player2.mf("his", "her") + " dick until you hear your partner moan with pain-tinted pleasure at being held so tight by your love-tunnel.");
                this.outputText("\n\nYou loosen up the bare minimum, and " + this.player2.mf("he", "she") + " takes that as encouragement to start bucking back and forth, slowly pulling " + this.player2.mf("his", "her") + " cock out of your sopping-wet tunnel and then, just when it's aching to be filled again, forcefully shoving back into you, making your balls and tits bounce and jiggle with each stroke.  Instinctively, your well-trained netherlips ripple and squeeze around the fuckstick currently pistoning in and out of you; knowing that he can't see you in this position, you make no secret of the husky moans and eager whimpers " + this.player2.mf("his", "her") + " machinations are wringing from you.  You feel like such a whore, carrying on on this fashion... but, Marae's sweet tits, it turns you on so!  Your cock bobs up and down from your motions and the weight of your lover slapping into you, its head flaring wider and wider in arousal as precum drips in a steady splat-splat-splat onto the ground.  Awkwardly supporting yourself on just three limbs, you start trying to jerk yourself off whilst your tauric lover fucks you senseless, smearing your own fluids up and down the sensitive skin of your shaft in sloppy wet strokes.  This is certainly a whole new experience compared to fucking Edryn.");
                this.outputText("\n\nAs you and your lover fuck each other, your mind begins to drift down vistas most pleasant.  In your mind's eye, you see yourself with your fertility restored; your breasts swollen to voluptuous orbs heavy with nourishing milk, flowing eagerly into the hungry mouths of suckling kits, your belly swollen into a beautiful gravid roundness with a new litter of children.  You can feel your babies kicking and moving inside of you, wriggling in that way they do, the thought of which has always made you feel all warm and fuzzy inside.  " + this.player2.short + " is there, holding you gently in " + this.player2.mf("his", "her") + " arms, smiling proudly as " + this.player2.mf("he", "she") + " runs " + this.player2.mf("his", "her") + " hands over the fullness of your belly, the two of you already anticipating the next litter " + this.player2.mf("he", "she") + " will be filling you with...");
                ...
                this.outputText("\n\nYour balls begin to tingle with warmth in that familiar way that they do just before you cum, rising slightly involuntarily as your sack starts to pull tight and release.  Your cock flexes, bulging in your fingers as the climax builds up within the cumvein and stretches it out, and with an exultant moan, you declare, \"<i>I'm gonna...  CUUUUUUM!</i>\"  " + this.player2.short + " answers you with a moan of " + this.player2.mf("his", "her") + " own, ramming with increasing speed and force into your cunt.");
                this.outputText("\n\nYour equine cock-head flares wider and wider as that oh-so-familiar feeling of hot pleasure begins pumping its way up from your swaying balls and along your fat dick, your heart hammering inside your chest and your flare seeming to pulse with every beat of your heart.  Thick, hot, salty jizz spurts and sprays in load after load from your cock, gushing onto the earth below you and rapidly saturating it, leaving you kneeling over an ever-growing puddle of sex-scented mud.  As you arch your back and thrust out your dick, your cunt tightens, anchoring " + this.player2.short + " inside of you and giving " + this.player2.mf("him", "her") + " no choice but to cum in turn");
                if (this.player2.hasVagina())
                    this.outputText(", her female jizz spattering unnoticed onto the ground behind the pair of you");
                this.outputText(".");
                //PC Cum=Normal or lower:
                if (this.player2.cumQ() < 500)
                    this.outputText("\n\n" + this.player2.mf("He", "She") + " sprays " + this.player2.mf("his", "her") + " hot jizz into your milking cunt and you greedily swallow it all, netherlips flexing eagerly in an attempt to coax even more from " + this.player2.mf("him", "her") + ".  While you can feel that delicious cum slurping around inside of you, your mind is still fixated on the image of your womb filled full and ripe and so you find yourself distantly disappointed that this is all " + this.player2.mf("he", "she") + " can manage.");
                //PC Cum=High:
                else if (this.player2.cumQ() < 1000)
                    this.outputText("\n\nYou moan and whimper with glee as wave after wave of spooge surges into your burning cunt and is sucked up into your aching womb, stretching it into a blatant little bulge of a belly by the time " + this.player2.mf("he", "she") + " has shot " + this.player2.mf("his", "her") + " load.  Your free hand caresses the filled flesh, feeling it squish and churn, and while the skin is delightfully sensitive, you want <i>more</i>...");
                //(PC Cum=VeryHigh:
                else if (this.player2.cumQ() < 2500)
                    this.outputText("\n\nYou let out a howl of joy as your lover's inhuman load begins inflating your womb like a balloon... bigger, bigger, bigger, you want to be bigger!  Oh, yes, yes - you can feel your belly growing round and full and heavy with the sloshing cum your " + this.player2.short + " is stuffing into your womb; by the time " + this.player2.mf("he", "she") + " has stopped, you look and feel like a full-term mother.  Your belly hangs down barely inches off of the ground, swaying gently to and fro with your motions.");
                //(PC Cum=Extreme:
                else
                    this.outputText("\n\nYou let out a high-pitched scream of pleasure as the veritable fountain of cum you call your " + this.player2.mf("boy", "girl") + "friend stretches your womb to impossible depths with " + this.player2.mf("his", "her") + " inhuman loads of jizz.  Your belly grows and grows and grows, and it seems to show no sign of stopping; the skin is stretched so tight, the fur pulled into a glossy tautness by your distended womb, that even the merest whisper of wind sends sparks of pleasure crashing through your mind.  You grow inexorably tighter, fuller, and heavier, until the pleasure of being stuffed so overwhelmingly full starts to become slightly painful and fear begins to dilute your belly-lust: is " + this.player2.mf("he", "she") + " ever going to <b>stop</b>?  Thankfully, at last, it ends.  Cum spurts noisily out around the impromptu plug of " + this.player2.mf("his", "her") + " dick, but without the added pressure of " + this.player2.mf("his", "her") + " torrential climax adding to it, even that small mercy feels so good that you'd collapse if you weren't already on the ground.  Your womb has grown so distended that you are no longer kneeling but laying atop it, feeling the seething ocean of " + this.player2.short + "'s seed churning inside you as you try to regain some semblance of coherent thought.");
                this.outputText("\n\nYour lover delicately supports " + this.player2.mf("him", "her") + "self atop you for a while longer to catch " + this.player2.mf("his", "her") + " strength back, then carefully extracts " + this.player2.mf("him", "her") + "self from you.  Your muscles are so limp that you find yourself ");
                if (this.player2.cumQ() < 1000)
                    this.outputText("falling face-first into the jizz-mud");
                else
                    this.outputText("not even bothering trying to move your swollen bulk");
                this.outputText(", and you smile dopily up at " + this.player2.mf("him", "her") + ", love shining in your eyes.  Carefully, " + this.player2.mf("he", "she") + " positions " + this.player2.mf("him", "her") + "self beside you and strokes your face before closing " + this.player2.mf("his", "her") + " eyes, making it quite clear " + this.player2.mf("he", "she") + " intends to go to sleep right here.  You see no point in fighting the inevitable and instead give yourself over to slumber - wouldn't be the first time you woke up in dried cum-mud, after all...");
            }
            //Else:
            else {
                this.outputText("\n\nTurning yourself around so that your lover can admire your ass - you croon with enjoyment when " + this.player2.mf("he", "she") + " sneaks this opportunity to give it a lustful squeeze, rolling the firm, well-fleshed muscle of each cheek around in the palm of " + this.player2.mf("his", "her") + " hand - you hold yourself there long enough to playfully brush your tail across " + this.player2.mf("his", "her") + " face before slowly lowering yourself down, painstakingly impaling yourself on " + this.player2.mf("his", "her") + " cock.  You can't resist moaning like a slut as the pleasure of being filled by " + this.player2.mf("his", "her") + " dick washes through you like a flood of honey-sweet warmth; while you've tried to fill your empty nights with too many toys to be virgin-tight by any means, being filled by the first cock to ever penetrate you for real is still too overwhelming.  Your toy-trained cunt eagerly clamps down on the intruder, squeezing " + this.player2.mf("his", "her") + " dick until you hear your partner moan with pain-tinted pleasure at being held so tight by your love-tunnel.");
                this.outputText("\n\nYou throw " + this.player2.mf("him", "her") + " a smile over your shoulder and start to bounce up and down in " + this.player2.mf("his", "her") + " lap, squeezing and rippling your netherlips around the delicious fuck-stick inside of them as you gyrate, making husky moans of lust to further entice and arouse your partner.  You grind your ass into " + this.player2.short + "'s crotch, trying your best to ignore your persistent cock as it slaps wetly into your tits and drools precum all over your nipples - you want to focus on your cunt.  You moan in surprise and pleasure as " + this.player2.short + " suddenly reaches around to your front, " + this.player2.mf("his", "her") + " skilled hands playing with the pebble-like nubs of your black nipples.  Each touch, stroke, and tweak sending sparks of pleasure racing down to your crotch.  " + this.player2.mf("He", "She") + " begins to fondle and stroke your full, furry breasts, and you croon in pleasure at the attention; you've always been rather proud of them, even if they aren't as big as Edryn's.  For all that " + this.player2.mf("he", "she") + " seems not to care about your dick, you still can't help but feel surprised when one hand closes on your shaft, teasingly stroking the increasingly slick and unbearably sensitive horse-meat up and down in time with " + this.player2.mf("his", "her") + " thrusts into your greedy cunt.");
                this.outputText("\n\nAs you and your lover fuck each other, your mind begins to drift down vistas most pleasant.  In your mind's eye, you see yourself with your fertility restored; your breasts swollen to voluptuous orbs heavy with nourishing milk, flowing eagerly into the hungry mouths of suckling kits, your belly swollen into a beautiful gravid roundness with a new litter of children.  You can feel your babies kicking and moving inside of you, wriggling in that way they do, the thought of which has always made you feel all warm and fuzzy inside.  " + this.player2.short + " is there, holding you gently in " + this.player2.mf("his", "her") + " arms, smiling proudly as " + this.player2.mf("he", "she") + " runs " + this.player2.mf("his", "her") + " hands over the fullness of your belly, the two of you already anticipating the next litter " + this.player2.mf("he", "she") + " will be filling you with...");
                this.outputText("\n\nCaught up in your vision, you can't resist calling out to your lover in rapture; \"<i>Fuck me full, " + this.player2.short + "!  Fill me with your kits!</i>\"");
                this.outputText("\n\nYour balls begin to tingle with warmth in that familiar way that they do just before you cum, rising slightly involuntarily as your sack starts to pull tight and release.  Your cock flexes, bulging in " + this.player2.short + "'s fingers as the climax builds up within the cumvein and stretches it out.  With an exultant moan, you declare, \"<i>I'm gonna...  CUUUUUUM!</i>\"  " + this.player2.short + " answers you with a moan of " + this.player2.mf("his", "her") + " own, ramming with increasing speed and force into your cunt.");
                this.outputText("\n\nYour equine cock-head just flares wider and wider as that oh-so-familiar feeling of hot pleasure begins pumping its way up from your swaying balls and along your fat dick, your heart hammering inside your chest and your flare seeming to pulse with every beat.  Thick, hot, salty jizz spurts and sprays in load after load from your cock, rising up into the air and then falling back onto you, completely plastering your tits and belly in your own spunk, smearing your face with it and forcing you to lick it up.  As you arch your back and thrust up your dick, your cunt tightens, anchoring " + this.player2.short + " inside of you and giving " + this.player2.mf("him", "her") + " no choice but to cum in turn");
                if (this.player2.hasVagina())
                    this.outputText(", her female jizz spattering unnoticed onto the ground beneath the pair of you");
                this.outputText(".");
                //(PC Cum=Normal or lower:
                if (this.player2.cumQ() < 500)
                    this.outputText("\n\n" + this.player2.mf("He", "She") + " sprays " + this.player2.mf("his", "her") + " hot jizz into your milking cunt and you greedily swallow it all, netherlips flexing eagerly in an attempt to coax even more from " + this.player2.mf("him", "her") + "; while you can feel that delicious cum slurping around inside of you, your mind is still fixated on the image of your womb filled full and ripe and so you find yourself distantly disappointed that this is all " + this.player2.mf("he", "she") + " can manage.");
                //(PC Cum=High:
                    ...
                    this.outputText("\n\nYou moan and whimper with glee as wave after wave of spooge surges into your burning cunt and is sucked up into your aching womb, stretching it into a blatant little bulge of a belly by the time " + this.player2.mf("he", "she") + " has shot " + this.player2.mf("his", "her") + " load.  Your hands caress the filled flesh, feeling it squish and churn, and while the skin is delightfully sensitive, you want <i>more</i>...");
                //(PC Cum=VeryHigh:)
                else if (this.player2.cumQ() < 2500)
                    this.outputText("\n\nYou let out a howl of joy as your lover's inhuman load begins inflating your womb like a balloon... bigger, bigger, bigger, you want to be bigger!  Oh, yes, yes - you can feel your belly growing round and full and heavy with the sloshing cum your " + this.player2.short + " is stuffing into your womb; by the time " + this.player2.mf("he", "she") + " has stopped, you look and feel like a full-term mother.  Your belly weighs you down with its solid, fluid-filled mass, swaying gently to and fro with your motions.");
                //(PC Cum=Extreme:
                else
                    this.outputText("\n\nYou let out a high-pitched scream of pleasure as the veritable fountain of cum you call your " + this.player2.mf("boyfriend", "girlfriend") + " stretches your womb to impossible depths with " + this.player2.mf("his", "her") + " inhuman loads of jizz.  Your belly grows and grows and grows, and it seems to show no sign of stopping; the skin is stretched so tight, the fur pulled into a glossy tautness by your distended womb, that even the merest whisper of wind sends sparks of pleasure crashing through your mind.  You grow inexorably tighter, fuller, heavier, until the pleasure of being stuffed so overwhelmingly full starts to become slightly painful and fear begins to dilute your belly-lust... is " + this.player2.mf("he", "she") + " ever going to <b>stop</b>?  Thankfully, at last, it ends. Cum spurts noisily out around the impromptu plug of " + this.player2.mf("his", "her") + " dick, but without the added pressure of " + this.player2.mf("his", "her") + " torrential climax adding to it even that small mercy feels so heavenly that your muscles lose what little strength they had left. Unbalanced by the churning mass of spunk in your womb you slowly topple onto your side, some distant part of your mind grateful that " + this.player2.short + " is quick enough to ease your graceless change of position so that you don't bash your head on a rock. You smile in contentment as your hand languidly explores the large expanse of your inflated belly. Your womb is so distended that, if you had a twin sister, she could probably just about fit inside your newly stretched cavern... well, if she curled up like a baby, anyway.");
                this.outputText("\n\nWith a sigh, your " + this.player2.short + " gently ruffles your hair, but makes no attempt at trying to shift you.  You welcome " + this.player2.mf("his", "her") + " lethargic contentment; with how limp your muscles are after a good fucking");
                if (this.player2.cumQ() >= 1000)
                    this.outputText(" not to mention the weight of your overstuffed belly");
                this.outputText(" you don't really feel inclined to move, either.  Instead, you yawn loudly, make yourself comfortable upon your lover's stomach, and allow yourself to drift off to sleep - already, you can hear the quiet breathing of " + this.player2.short + " as " + this.player2.mf("he", "she") + " does the same thing.");
            }
            this.player.orgasm();
            this.dynStats("sen", -2);
            this.menu();
        ...
        putUrtasWangInPCsCunt(truth) {
            this.clearOutput();
            this.outputText("You push " + this.player2.short + " down on her back, a task made all the more difficult by your growing arousal.  Thankfully, she's not wearing her usual " + this.player2.armorName + ".  Instead, her form is bared to your probing fingertips, pliant and exposed.  You cannot help but dip a finger into her moist delta, parting the oozing veil to enjoy the view of her ");
            if (this.player.vaginaType() != 5)
                this.outputText("pink, ");
            this.outputText("pulsing interior.  The sight is exciting in the extreme, immediately sending your heartbeat through the roof.  Your tremendous horse-cock is immediately stiffened by your ardor, along with your coal-black nipples, and your armor-plated skirt begins to rise, as if by magic.");
            ...
            if (this.player2.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150)
                this.outputText("the curve of her pregnant belly");
            else if (this.player2.tone >= 65)
                this.outputText("her toned abdomen");
            else if (this.player2.tone < 30)
                this.outputText("her soft, forgiving middle");
            else
                this.outputText("her belly");
            this.outputText(".  The attentions drive your attempts to dislodge the offending garments from your lusty frame to new levels.  Metal rivets slowly give before finally snapping apart to free your left shoulder.  Your left nipple tingles with pleasant, palpable relief, and you turn to the other side, intent on ripping it off, so that you can be with your lover, skin to skin.");
            ...
            if (this.player2.isTaur()) {
                this.outputText("and climb off the 'taur-woman.  She smirks up at you, until you bid her to rise, telling her that you plan to mount her like the fertile filly she is. Reluctantly, " + this.player2.short + " clatters up onto her hooves.");
                if (this.player2.tailType > appearanceDefs_1.TAIL_TYPE_NONE)
                    this.outputText("  You stroke her tail as you shift it aside");
                else
                    this.outputText("  You stroke her swollen sex as you admire it");
                this.outputText(", making sure you've got the perfect view of her lube-slimed horse-cunt.  Unbidden, your cock thickens, disgorging a potent trail of animal-pre down its underside in anticipation.");
                if (this.player2.wetness() >= 4)
                    this.outputText("  Fuck, she's wetter than Edryn!  Just look at those heavy trails of slick moisture as they run down her rump and hindlegs.");
                else if (this.player2.wetness() >= 2)
                    this.outputText("  Fuck, she's as wet as Edryn!  Beads of moisture are forming on her clit, ready to drop to the ground.");
                else
                    this.outputText("  Fuck, she's almost as wet as Edryn!  Just getting a sniff of her horny horse-snatch has your head swimming!");
                this.outputText("  You give it a lick and shudder, taking in a few deep lungfuls of her scent.");
                if (this.player2.tallness >= 84)
                    this.outputText("  Before you know what you're doing, you've pulled her back to a rock and climbed atop it, bringing your cock level with that heavenly hole.");
                else
                    this.outputText("  Before you know what you're doing, you've raised yourself up to your full height, bringing your cock level with that heavenly hole.");
            }
            //{goo}
            else if (this.player2.isGoo()) {
                this.outputText("and roll the gooey woman so she's face down.  She holds herself up off the dry dirt with her palms, sweet, slimy bottom upraised above her goopy undercarriage.  Amazingly, there's a slight parting in the mass of slime, right between where her legs would be, if she had them.  A narrow, barely visible divide can be spotted inside, capped with the telltale bulge of her ");
                if (this.player2.clitLength < .5)
                    this.outputText("tiny ");
                else if (this.player2.clitLength >= 2.5)
                    this.outputText("massive ");
                this.outputText("button.  You nuzzle up to that slick slime-cunt, sniffing at her super-wet snatch, taking the pheromones as deeply inside yourself as possible.  Her femininity is so strong that it makes your head spin and your dick ache.  Glancing down as you lick the moisture from your muzzle, you see the rigid, over-engorged veins standing out in harsh relief on your equine tool.  Your legs seem to move on their own, lining you up with the moisture-laden slit just inches away.");
            }
            //{nagas}
            else if (this.player2.isNaga()) {
                this.outputText("and roll the snake-woman over so she's prostrate on the ground, barely holding her front half up with her arms.  Her loins are flat on the ground, undulating slightly as she grinds her moist clit against it for sensation.  Your lover's anatomy poses a problem for your choice of positions, but then, inspiration strikes.  You come up under the hind part of her snake-tail, and hoisting it up, you support half over your shoulder.  As expected, she has all the flexibility of the serpent she so resembles, and her tail bends down just far enough for her cunt to hang a mere inch above your rigid tool, right where her body changes from snake to person.");
                if (this.player2.wetness() >= 3)
                    this.outputText("  Her moisture drizzles from that wanton slit, basting you with her fragrant femininity, and you have a hard time not taking her here and now.");
                this.outputText("  The tail you're holding up coils in, sliding around your arm and middle, wrapping you up in snakey snugness.  With impeccable control, she squeezes a little bit, bringing her cunt close enough to breathe foggy moisture on your equine tool.");
            }
            //{biped}
            else {
                this.outputText("and roll her over on her hands and knees, lifting that sweet butt up in the air where you can admire it.  You kneel behind her and, pressing your nose into her fragrant quim, you extend your tongue, letting the smooth oral muscle taste her juices and tease at her engorging clit.  " + this.player2.short + " moans and presses back into you, crying out like a true bitch in heat, one in need of a thorough rutting.  The thought hits your cock like a lightning bolt, and it fills out to painful proportions, every vein and bulge standing out in stark relief, thumping obscenely to the tune of your insatiable lust.  You moan into her lovely-tasting snatch, gulping down ");
                if (this.player2.wetness() < 3)
                    this.outputText("every drop of nectar that she gives up");
                else if (this.player2.wetness() < 4)
                    this.outputText("the copious drops of nectar she gives up");
                else if (this.player2.wetness() < 5)
                    this.outputText("the drizzling moisture that oozes from her twat");
                else
                    this.outputText("the rivers of girl-lube that run unimpeded from her sopping twat");
                this.outputText(".  You sniff in great lungfuls of her, your head swimming with need, and before you know it, you've risen behind her, your oozing flare just inches from that delectable opening.");
            }
            ...
            if (this.player2.pregnancyIncubation > 0 && this.player2.pregnancyIncubation < 150)
                this.outputText(" (more than it already is)");
            this.outputText(" from your prodigious deposit.  The illusion of knocking her up takes hold of you, and your orgasm redoubles, fresh waves of horse-cum pouring out of you unceasingly.  " + this.player2.short + " moans, rubbing her taut");
            if (this.player2.pregnancyIncubation > 0 && this.player2.pregnancyIncubation < 150)
                this.outputText(" pregnant");
            this.outputText(" dome, until at last you finally spend the last of your spunk.");
        ...
        snuggleWithUrta(truth) {
            this.clearOutput();
            this.outputText("You think it over and decide that, for once, you'd like to focus more on love and less on lust.  \"<i>Well... I'd really just like to have a snuggle with you, " + this.player2.short + " - if that's alright?</i>\"  You ask quietly, tail instinctively wagging in an effort to be endearing.  Your lover nods " + this.player2.mf("his", "her") + " head and answers in the positive, opening " + this.player2.mf("his", "her") + " arms for further effect.  You waste no time and eagerly sidle into " + this.player2.mf("his", "her") + " arms.");
            //[If PC Centaur or Drider:
            if (this.player2.isTaur() || this.player2.isDrider()) {
                this.outputText("  It's rather awkward, thanks to " + this.player2.mf("his", "her") + " clunky ");
                if (this.player2.isTaur())
                    this.outputText("centaur");
                else
                    this.outputText("drider");
                this.outputText(" body, but you manage to press up against " + this.player2.mf("his", "her") + " ");
                if (this.player2.isTaur())
                    this.outputText("forehoofs");
                else
                    this.outputText("first two pairs of spidery limbs");
                this.outputText(".");
            }
            //[if PC Naga:]
            else if (this.player2.isNaga())
                this.outputText("  " + this.player2.mf("His", "Her") + " serpentine coils loop snugly around your waist, curling around your legs and holding you gently in place.");
            //[if PC Goo:
            else if (this.player.isGoo())
                this.outputText("  " + this.player2.mf("His", "Her") + " soft, squishy goo-body eagerly accepts you, the gelatinous mass of " + this.player2.mf("his", "her") + " lower torso reaching out to softly envelop you in its cool, wet embrace.");
            //[Else:
            else
                this.outputText("  Knees to knees, it takes you a few moments to figure out how to properly position your legs, but you eventually manage it.");
            this.outputText("\n\nProperly positioned, you tuck your vulpine face into your lover's neck, softly inhaling " + this.player2.mf("his", "her") + " scent, listening to the beating of " + this.player2.mf("his", "her") + " heart, basking in the warmth of " + this.player2.mf("his", "her") + " body and simply savoring being so close to the person you love.  Of course, being here like this, breasts pressed to your lover's chest, is all your traitorous horse-cock needs to show itself, wetly sliding from your sheath and poking eagerly into your lover's side.  You giggle nervously and blush, unable to help the flush of shame that slides through your heart, for all that " + this.player2.short + " has assured you that " + this.player2.mf("he", "she") + " loves you despite your dick.");
            this.outputText("\n\nYour lover simply smiles at you, and gives your cock a ");
            if (this.player2.cor < 33)
                this.outputText("playful pat");
            else if (this.player2.cor < 66)
                this.outputText("gentle stroke");
            else
                this.outputText("lascivious caress");
            this.outputText(" before pulling you tighter into " + this.player2.mf("his", "her") + " embrace.  Eager to forget your embarrassment, you focus on holding " + this.player2.mf("him", "her") + " tight and close.  Your prick slowly slides back into its sheath from the lack of stimulus as you focus on how safe and content you feel to be here, being held like this.");
            this.outputText("\n\nTo your own surprise, you find your eyes growing heavier and heavier.  But you don't want to let your " + this.player2.short + " go yet... besides, may as well start searching from here in the morning, right?  So, you and " + this.player2.short + " carefully lay yourselves back down and quietly drift off to sleep, still holding fast to each other as you do.  The last sounds you hear for the night are your lover breathing, accompanied by the beating of " + this.player2.mf("his", "her") + " heart, and you idly hope that " + this.player2.mf("he", "she") + " can hear the same sounds from you...");
        ...
        morningAfterCampVisitEmbark(truth) {
            ...
            this.outputText("Sadly, morning comes, and your time with " + this.player2.short + " comes to an end.  You push " + this.player2.mf("his", "her") + " shoulder gently to rouse " + this.player2.mf("him", "her") + ", smiling at " + this.player2.mf("him", "her") + " when " + this.player2.mf("he", "she") + " wakes.  You kiss " + this.player2.mf("him", "her") + " on the lips before rolling out from under the blanket.  The two of you eat a quiet breakfast together, simply enjoying each other's company.  ");
            if (truth) {
                this.outputText("" + this.player2.mf("He", "She") + " asks again about coming with you, but you tell " + this.player2.mf("him", "her") + " Gul's instructions were quite specific.  You'll need to tackle this alone.  The rest of breakfast passes in uncomfortable silence, broken when you rise to leave.");
            }
            this.outputText("\n\nYou embrace " + this.player2.short + ", kissing " + this.player2.mf("him", "her") + " on the lips");
            if (truth) {
                this.outputText(" before you promise, \"<i> I'll come back to you, stronger and ready for kids, I promise.</i>\"\n\n");
            }
            else {
                this.outputText(".  ");
            }
        ...
        runIntoAGoblin(camped = false) {
            ...
            this.outputText("\n\n<b>It's a fight!</b>");
            this.startCombat(new GoblinBroodmother_1.GoblinBroodmother()); // TODO extract to Monsters.GoblinBroodMother class
        }
        //Urta Wins(C)*
        winFuckAGoblinBroodmotherAsUrta() {
            this.clearOutput();
            this.outputText("You greedily eye the ");
            if (this.monster.HP < 1)
                this.outputText("submissive");
            else
                this.outputText("feverishly masturbating");
            this.outputText(" form of your opponent and can't resist licking your black lips in anticipation - any guilt about fucking someone besides " + this.player2.short + " that might make it through the haze of lust consuming you is quickly extinguished by your conviction that " + this.player2.mf("he", "she") + " would understand.  Your growing tower of fuck-meat is already lifting the hem of your armored skirt, making it even easier to grab its lower edge and flip it up out of the way as you advance towards your assailant, eager to see what you can do about blowing off some steam...");
        ...
        loseToGoblinsPartIIAsUrta() {
            this.clearOutput();
            this.outputText("<b>Hours, and many orgasms later...</b>");
        ...
        loseToGoblinsPartIIIAsUrta() {
            this.clearOutput();
            this.outputText("<b>Several days later...</b>");
        ...
        loseToGoblinsPartIVAsUrta() {
            this.clearOutput();
            this.outputText("<b>Several hours later...</b>");
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_GOBLIN_SLAVE] = 1;
            this.menu();
            this.addButton(0, "Next", this.urtaGameOver);
        }
        urtaGameOver() {
            this.clearOutput();
            this.outputText("<b>Urta has been lost to her fate...  Meanwhile, back at camp...</b>");
            this.getGame().inCombat = false;
            this.flags[kFLAGS_1.kFLAGS.URTA_QUEST_STATUS] = -1;
            this.model.time.days++;
            this.resetToPC();
        ...
        urtaSpecials() {
            //Gone	menuLoc = 3;
            if (this.getGame().inCombat && this.player.findStatusAffect(StatusAffects_1.StatusAffects.Sealed) >= 0 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Sealed) == 5) {
                this.clearOutput();
            ...
            this.menu();
            this.addButton(0, "Combo", this.urtaComboAttack);
            this.addButton(1, "Vault", this.urtaVaultAttack);
            this.addButton(2, "Sidewinder", this.urtaSidewinder);
            this.addButton(3, "Dirt Kick", this.urtaDirtKick);
            this.addButton(4, "Metabolize", this.urtaMetabolize);
            this.addButton(5, "SecondWind", this.urtaSecondWind);
            this.addButton(9, "Back", this.getGame().combatMenu, false);
        }
        urtaMetabolize() {
            this.clearOutput();
            var damage = this.player.takeDamage(Math.round(this.player.maxHP() / 10));
            this.outputText("You work your body as hard as you can, restoring your fatigue at the cost of health. (" + damage + ")\nRestored 20 fatigue!\n\n");
            this.fatigue(-20);
            kGAMECLASS_1.kGAMECLASS.enemyAI();
        }
        urtaSecondWind() {
            this.clearOutput();
            if (this.monster.findStatusAffect(StatusAffects_1.StatusAffects.UrtaSecondWinded) >= 0) {
                this.outputText("You've already pushed yourself as hard as you can!");
                //Gone		menuLoc = 3;
                //		doNext(getGame().combatMenu);
                this.menu();
                this.addButton(0, "Next", kGAMECLASS_1.kGAMECLASS.combatMenu, false);
                return;
            }
            this.monster.createStatusAffect(StatusAffects_1.StatusAffects.UrtaSecondWinded, 0, 0, 0, 0);
            this.HPChange(Math.round(this.player.maxHP() / 2), false);
            this.fatigue(-50);
            this.dynStats("lus", -50);
            this.outputText("Closing your eyes for a moment, you focus all of your willpower on pushing yourself to your absolute limits, forcing your lusts down and drawing on reserves of energy you didn't know you had!\n\n");
            kGAMECLASS_1.kGAMECLASS.enemyAI();
        }
        //Combo: 3x attack, higher miss chance, guaranteed hit vs blind
        urtaComboAttack() {
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Attacks) < 0) {
                this.clearOutput();
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Attacks) < 0)
                this.player.createStatusAffect(StatusAffects_1.StatusAffects.Attacks, 3, 0, 0, 0);
            else {
                this.player.addStatusValue(StatusAffects_1.StatusAffects.Attacks, 1, -1);
                console_1.trace("DECREMENDED ATTACKS");
                if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.Attacks) <= 1) {
                    console_1.trace("REMOVED ATTACKS");
                    this.player.removeStatusAffect(StatusAffects_1.StatusAffects.Attacks);
                }
            }
            //Blind
            ...
            var damage;
            //Determine if dodged!
            if (this.monster.findStatusAffect(StatusAffects_1.StatusAffects.Blind) < 0 && (UrtaQuest.rand(3) == 0 || (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Blind) >= 0 && UrtaQuest.rand(2) == 0) || (this.monster.spe - this.player.spe > 0 && Math.floor(Math.random() * (((this.monster.spe - this.player.spe) / 4) + 80)) > 80))) {
                if (this.monster.spe - this.player.spe < 8)
                    this.outputText(this.monster.capitalA + this.monster.short + " narrowly avoids your attack!", false);
                if (this.monster.spe - this.player.spe >= 8 && this.monster.spe - this.player.spe < 20)
                    this.outputText(this.monster.capitalA + this.monster.short + " dodges your attack with superior quickness!", false);
                if (this.monster.spe - this.player.spe >= 20)
                    this.outputText(this.monster.capitalA + this.monster.short + " deftly avoids your slow attack.", false);
                this.outputText("\n", false);
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Attacks) >= 0) {
            ...
            var crit = false;
            if (UrtaQuest.rand(100) <= 4 || (this.player.findPerk(PerkLib_1.PerkLib.Tactician) >= 0 && this.player.inte >= 50 && (this.player.inte - 50) / 5 > UrtaQuest.rand(100))) {
                crit = true;
                damage *= 2;
            }
            //Start figuring enemy damage resistance
            var reduction = UrtaQuest.rand(this.monster.tou);
            ...
            //Thunderous Strikes
            if (this.player.findPerk(PerkLib_1.PerkLib.ThunderousStrikes) >= 0 && this.player.str >= 80)
                damage *= 1.2;
            //One final round
            damage = Math.round(damage);
            if (damage > 0) {
                if (this.player.findPerk(PerkLib_1.PerkLib.HistoryFighter) >= 0)
                    damage *= 1.1;
                damage = kGAMECLASS_1.kGAMECLASS.doDamage(damage);
            }
            if (damage <= 0) {
                damage = 0;
                ...
                if (crit)
                    this.outputText(" <b>*CRIT*</b>");
            }
            if (this.player.findPerk(PerkLib_1.PerkLib.BrutalBlows) >= 0 && this.player.str > 75) {
                if (this.monster.armorDef > 0)
                    this.outputText("\nYour hits are so brutal that you damage " + this.monster.a + this.monster.short + "'s defenses!");
                if (this.monster.armorDef - 10 > 0)
                    this.monster.armorDef -= 10;
                else
                    this.monster.armorDef = 0;
            }
            this.outputText("\n", false);
            //Kick back to main if no damage occured!
            if (this.monster.HP >= 1 && this.monster.lust <= 99) {
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Attacks) >= 0) {
                    console_1.trace("MORE ATTACK");
                    this.urtaComboAttack();
                    return;
                }
                console_1.trace("DONE ATTACK");
                this.outputText("\n", false);
                kGAMECLASS_1.kGAMECLASS.enemyAI();
            }
            else {
                if (this.monster.HP <= 0)
                    this.doNext(kGAMECLASS_1.kGAMECLASS.endHpVictory);
                else
                    this.doNext(kGAMECLASS_1.kGAMECLASS.endLustVictory);
            }
        }
        //Dirt Kick
        urtaDirtKick() {
            ...
            //Blind
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Blind) >= 0) {
                this.outputText("You attempt to dirt kick, but as blinded as you are right now, you doubt you'll have much luck!  ", false);
            }
            else
                this.outputText("Spinning about, you drag your footpaw through the dirt, kicking a wave of debris towards " + this.monster.a + this.monster.short + "!  ");
            //Dodged!
            if (UrtaQuest.rand(20) + 1 + this.monster.spe / 20 > 15 + this.player.spe / 20) {
                this.outputText(this.monster.mf("He", "She") + " manages to shield " + this.monster.mf("his", "her") + " eyes.  Damn!\n\n");
                kGAMECLASS_1.kGAMECLASS.enemyAI();
                return;
            }
            else if (this.monster.findStatusAffect(StatusAffects_1.StatusAffects.Blind) >= 0) {
                this.outputText(this.monster.mf("He", "She") + "'s already blinded.  What a waste.\n\n");
            }
            else {
                this.outputText(this.monster.mf("He", "She") + "'s blinded!\n\n");
                this.monster.createStatusAffect(StatusAffects_1.StatusAffects.Blind, 2 + UrtaQuest.rand(3), 0, 0, 0);
            }
            kGAMECLASS_1.kGAMECLASS.enemyAI();
        }
        ...
        urtaSidewinder() {
            ...
            //Blind
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Blind) >= 0) {
                this.outputText("You attempt to hit with a vicious blow to the side, but as blinded as you are right now, you doubt you'll have much luck!  ", false);
            }
            else
                this.outputText("You make a wide swing to the side, hoping to stun your foe!  ");
            var damage;
            //Determine if dodged!
            if ((this.player.findStatusAffect(StatusAffects_1.StatusAffects.Blind) >= 0 && UrtaQuest.rand(2) == 0) || (this.monster.spe - this.player.spe > 0 && Math.floor(Math.random() * (((this.monster.spe - this.player.spe) / 4) + 80)) > 80)) {
                if (this.monster.spe - this.player.spe < 8)
                    this.outputText(this.monster.capitalA + this.monster.short + " narrowly avoids your attack!", false);
                if (this.monster.spe - this.player.spe >= 8 && this.monster.spe - this.player.spe < 20)
                    this.outputText(this.monster.capitalA + this.monster.short + " dodges your attack with superior quickness!", false);
            ...
            if (this.monster.findStatusAffect(StatusAffects_1.StatusAffects.Stunned) < 0 && this.monster.findPerk(PerkLib_1.PerkLib.Resolute) < 0 && damage > 0) {
                if (this.monster.tou / 10 + UrtaQuest.rand(20) + 1 < 20) {
                    this.outputText("\n<b>" + this.monster.capitalA + this.monster.short + " is stunned!</b>");
                    this.monster.createStatusAffect(StatusAffects_1.StatusAffects.Stunned, 1, 0, 0, 0);
                }
            }
            else if (this.monster.findPerk(PerkLib_1.PerkLib.Resolute) >= 0) {
                this.outputText("\nWhile it should have some chance of stunning, your foe seems far too resolute to be affected by such an ailment.");
            }
            this.outputText("\n", false);
            //Kick back to main if no damage occured!
            if (this.monster.HP >= 1 && this.monster.lust <= 99) {
                if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.FirstAttack) >= 0) {
                    kGAMECLASS_1.kGAMECLASS.attack();
                    return;
                }
                this.outputText("\n", false);
                kGAMECLASS_1.kGAMECLASS.enemyAI();
        ...
        urtaVaultAttack() {
            ...
            this.fatigue(20);
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Sealed) >= 0 && this.player.statusAffectv2(StatusAffects_1.StatusAffects.Sealed) == 0) {
                this.outputText("You attempt to attack, but at the last moment your body wrenches away, preventing you from even coming close to landing a blow!  The seals have made normal attack impossible!  Maybe you could try something else?\n\n", false);
                kGAMECLASS_1.kGAMECLASS.enemyAI();
                return;
            }
            //Blind
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.Blind) >= 0) {
                this.outputText("You attempt to make a high, vaulting attack, but as blinded as you are right now, you doubt you'll have much luck!  ", false);
            }
            else
                this.outputText("You leap into the air, intent on slamming your " + this.player.weaponName + " into your foe!  ");
            var damage;
            //Determine if dodged!
            if ((this.player.findStatusAffect(StatusAffects_1.StatusAffects.Blind) >= 0 && UrtaQuest.rand(2) == 0) || (this.monster.spe - this.player.spe > 0 && Math.floor(Math.random() * (((this.monster.spe - this.player.spe) / 4) + 80)) > 80)) {
                if (this.monster.spe - this.player.spe < 8)
            ...
            //Determine if critical hit!
            var crit = false;
            if (this.monster.findStatusAffect(StatusAffects_1.StatusAffects.Stunned) >= 0 || UrtaQuest.rand(100) <= 4 || (this.player.findPerk(PerkLib_1.PerkLib.Tactician) >= 0 && this.player.inte >= 50 && (this.player.inte - 50) / 5 > UrtaQuest.rand(100))) {
                crit = true;
                damage *= 2;
            }
            //Start figuring enemy damage resistance
        ...
        nagaPleaseNagaStoleMyDick() {
            ...
            this.outputText("\n\n<b>It's a fight!</b>");
            kGAMECLASS_1.kGAMECLASS.clearStatuses(false);
            this.startCombat(new Sirius_1.Sirius());
        }
        //Tease*
        //Poison Bite*
        //Poison Spit*
        ...
        leaveSiriusBehind() {
            this.clearOutput();
            this.outputText("You decide that he's just not worth your time and leave to continue your journey.");
            this.menu();
        ...
        fuckSiriusRadioII() {
            this.clearOutput();
            this.outputText("\"<i>Oof... ugh... just... just one more... yeah!</i>\"  You gasp, moan, and shudder as your cock explodes yet again in your lover's mouth.  The snake-man is sprawled on the ground, supporting a belly like a centauress full-term with twins, and doesn't stir as you finally go limp and pull out of his mouth, drooling cum all over his face.");
            ...
            this.outputText("\n\nAs you walk away, following the pendant once again, you hope that " + this.player2.short + " will understand why you fucked a stranger like that... maybe if you promise to give " + this.player2.mf("him", "her") + " oral with as much enthusiasm as that naga gave you, " + this.player2.mf("he", "she") + "'ll be more understanding?  Mmm... you kind of hope " + this.player2.mf("he", "she") + " agrees, actually; you can already taste " + this.player2.mf("him", "her") + " on your tongue...");
            this.player.orgasm();
            this.menu();
            this.addButton(0, "Next", this.gnollAlphaBitchIntro);
        }
        ...
        urtaLosesToSirriusSnakeRadio() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.URTA_BECOMES_SNAKE_SLAVE] = 1;
            //Loss by HP:
            if (this.player.HP < 1)
                this.outputText("You cry out in pain as the bruises and buffets you've taken overwhelm you.  You struggle to stay upright, but to no avail; your injured body has reached its limits and you collapse, helpless and at the mercy of your assailant.");
            //Loss by Lust:
            else
                this.outputText("With a hollow moan of anguish, you cast aside your halberd and fall to your knees, tears stinging your eyes as you desperately jerk and maul at your huge horse-prick.  The cursed thing has betrayed you again, and now you're too addled by lust and need to defend yourself from whatever this naga has in store for you.");
        ...
        siriusSatelliteRadioOwnsYouII() {
            ...
            this.outputText("\n\nStop that, you admonish yourself.  Master is master; he's always in control.  You just need to take your mind off of this matter.  Hmm... While master does forbid it, you could always lay in his bed and relish the scent of him...  The temptation is too strong, and you quickly scurry over and curl up in the sheets, eagerly inhaling his wondrous scent.  As you do so, your mind drifts against your will to less happy thoughts.  The nightmares, always the nightmares... about a town you never knew... though, somehow, the name Tel'Adre keeps coming to you...  Worse than that are the visions of a life you never had as a watch captain, facing hardship after hardship... and that one " + this.player2.mf("guy", "girl") + ", " + this.player2.short + ".  Worst of all about the nightmares is that you can never seem to meet your master in them.  That's why they scare you so; you dread a world where he doesn't exist.  Thankfully he is always willing to help you forget with his hypnotherapy.");
        ...
        gnollAlphaBitchIntro() {
            this.clearOutput();
            //Intro*
            this.outputText("The last two fights were wearying, but you still feel pretty good. Perhaps best of all, as your last defeated challenger fades into the distance, you become aware of the pendant glowing fairly brightly.  You must be headed in the right direction!  Setting off at a trot, you pick up your pace, covering great distance in the blink of an eye, eyes never leaving the rapidly approaching horizon.  Focus is key to travel in the uninhabited sections of Mareth, as you well know, but it also allows you to move with swiftness surpassing the fastest animal.");
        ...
        winRapeHyenaPrincess() {
            this.clearOutput();
            this.outputText("Laughing at the Amazonian princess, you unbuckle your skirt, not even bothering to shed your armor.  Sure, your hard onyx nipples are digging into the inner lining of your leather breastplate, but it's just another pleasant sensation feeding your arousal.  In the back of your mind, you hope " + this.player2.short + " won't mind this indiscretion - you can't afford to go wandering around unsated in a place like this.  If a succubus found you all alone and turned on, you might actually fall for her tricks, resistant as you are.  You pray that " + this.player2.mf("he", "she") + "'ll understand.");
            ...
            if (this.monster.HP < 1)
                this.outputText(".  In spite of her wounded state, she seems to be quite excited by the situation");
            this.outputText(".");
        ...
        useSuccubiMilkOnGnollPrincesses() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.SUCCUBI_MILKED_GNOLL_PRINCESS] = 1;
            ...
            if (this.flags[kFLAGS_1.kFLAGS.URTA_FUCKED_HEL] == 1)
                this.outputText("that salamander slut's cunt");
            else
                this.outputText("a mino-cum addicted whore's sodden cunt");
            this.outputText(".  As you start to pick up the pace, bucking your hips into the thick cushion of her rump, the gnoll princess starts mewling pathetically, panting and moaning like a little slut.");
        ...
        loseToGnollPrincessAndGetGangBanged() {
            this.clearOutput();
            this.flags[kFLAGS_1.kFLAGS.URTA_TAKEN_BY_GNOLLS] = 1;
            if (this.player.lust > 99) {
                this.outputText("Sinking to your knees, utterly overwhelmed by lust, you gaze up the clit-cocked amazon, licking your chops. She responds by disdainfully pushing you down with one of her soft, padded paws.  \"<i>Did you really think you could trespass in my mother's territory and go unpunished?</i>\"");
            ...
            //Lose Via HP✓
                ...
                this.outputText("Flopping down to the ground, you struggle to rise.  You're badly hurt, and your muscles barely move at this point.  With a pain-wracked spasm, you roll onto your back, unable to even rise to your knees.  The gnoll smirks and proclaims, \"<i>You'll probably make a good slave once we've broken you in.</i>\"");
        ...
        //[To Loss Epilogue]'
        loseToGnollAsUrtaEpilogue() {
            this.clearOutput();
            //Loss Epilogue✓
            //[HP]
            if (this.player.HP < 1)
                this.outputText("Ouch... what happened to you?  You blink a few times, ignoring the buzzing throb of pain that rises up like a dormant monster in the back of your head.");
            //[Lust]
            else
                this.outputText("Oh, gods... what happened to you?  You blink a few times, ignoring the gentle throb coming from your well-used member.");
            this.outputText("  There's a constant, loud thrum of many voices talking all at once that makes it hard to think, and when you finally come to focus in the dim lighting, you can see why.  There are dozens, if not hundreds, of gnolls here, assembled in the faint light of some kind of feast hall, most of them male.");
            ...
            if (this.player.HP < 1)
                this.outputText("I hope I wasn't too rough on you");
            else
                this.outputText("I hope you enjoyed the journey here");
            this.outputText(".</i>\"");
            ...
            this.outputText("\n\nYou nod your head.");
            this.outputText("\"<i>Good girl,</i>\" she says encouragingly.  ");
            if (this.player.HP >= 1)
                this.outputText("You shudder at the memory of your meeting, leaking a little more lubricant.  ");
        ...
        loseToGnollAsUrtaEpilogueBAM() {
            this.clearOutput();
            this.outputText("Ouch!  Something smacks your face, and it fucking hurts!  You look up, seeing a strong, spotted paw pulling away, trailing a web of spooge in its wake.");
        ...
        urtaNightSleep() {
            ...
            this.menu();
            this.addButton(0, "SleepNaked", this.urtaSleepsNaked);
        ...
        urtaSleepsArmored() {
            this.clearOutput();
            this.model.time.days++;
            this.outputText("You go to sleep wearing your armor.  It turns out to have been a good idea when you're woken by tentacles probing at your chest-plate, seeking to undo the numerous straps holding it in place.  You roll to the side and easily squeeze out of the slippery tendrils.  Your hand falls on your halberd with practiced ease, hefting its reassuring weight in your hands as you spring up off your paws.");
            ...
            this.HPChange(.5 * this.player.maxHP(), false);
            this.fatigue(-50);
            this.player.orgasm();
            this.menu();
        ...
        urtaFinishesWithBigOrange() {
            ...
            this.outputText("\n\nYou black out from the onslaught of pleasure - it's too much for your mere mortal brain to handle, and your mind shuts down.  It doesn't stop you from dreaming of sex for hours more, or from waking up a dripping wreck in the morning, soaked with vine-sperm and drained dry.  Amazingly, your vagina (and hips) have closed back up.  Guiltily, you press your digits into your vagina.  It hugs them tightly, and you sigh in relief.  You look down to pull them out, and realize you've fisted yourself up to your elbow.  Shit.  This won't be easy to explain to " + this.player2.short + ", but maybe " + this.player2.mf("he", "she") + " will like having someone who can combine tightness and an accommodating capacity.");
            this.flags[kFLAGS_1.kFLAGS.URTA_TENTACLE_GAPED] = 1;
            this.flags[kFLAGS_1.kFLAGS.URTA_TENTACLE_RAPED] = 1;
            this.player.orgasm();
        ...
        urtaFinishesWithTentacles() {
            this.clearOutput();
            this.outputText("Sighing, you pinch your nipples as your ride the dozens of tentacles, letting them completely envelop your body.  The lips that have teased your cock all this time sluggishly shift position, pressing back against your tip and slowly opening.  With sloth-like slowness, those soft lips encircle the fat, flat head of your horse-dick.  As the tight seal drifts down your length, you get your first taste of the mouth's interior.  The whole of the tentacle seems hollow and lubricated with some internal moisture.  Most interestingly of all, the walls are covered with wiggly little cilia, thousands of them.  Your over-aroused member is caressed and tickled from sheath to tip, buttoned up in the moist confines of the tentacle while it's plump and juicy lips are smacking against your balls.");
        ...
        //Mino & Succubi Intro*
        introSuccubiAndMinotaur() {
            this.clearOutput();
            this.outputText("After getting and departing your makeshift camp, the pendant begins to glow again.  It flickers dully, then goes dark.  Damn!  You turn and change direction, and thankfully, the light returns.  You can see forest ahead, and you advance, your path lit by the strengthening glow of Gul's magical amulet.");
            ...
            //{start fight}
            kGAMECLASS_1.kGAMECLASS.clearStatuses(false);
            this.startCombat(new MinotaurLord_1.MinotaurLord());
        }
        //Minotaur Lord(C)*
        //Attacks*
        //Entangle*
        ...
        urtaSubmitsToMinotaurBadEnd() {
            this.clearOutput();
            this.outputText("You mouth opens, drooling with hunger that you know only the sexy beast across from you can sate.");
            if (this.monster.findStatusAffect(StatusAffects_1.StatusAffects.MinotaurEntangled) >= 0)
                this.outputText("   Seeing the fire in your eyes change from a determined glare to a lusty look, the minotaur pulls you over, carefully unwinding the chain from around you, so as not to damage you.");
            this.outputText("  Your once foe removes his loincloth to fully expose the mammoth between his legs, three feet long and nearly twice as girthy as your own.  You're so dazed by his imposing manhood, that you totally miss him flinging his loincloth at you.  It smacks wetly into your face, smothering you in his syrupy spooge.");
        ...
        submissiveMinoUrtaBadEndPtII() {
            this.clearOutput();
            this.outputText("You wake up feeling so blissfully bloated and utterly full.  Memories of your encounter with the minotaur come streaming back.  You submitted to the beast, and it felt... it felt goood.  Your cunny clenches at the memory, and your rigid, oozing pole pulses needily below.  You burp, tasting the salty leavings in the back of your throat for the first time.  That was good!  Gradually, you become aware of a gentle forward and back motion, making your distended gut slosh and your tits sway pendulously.");
        ...
        winRapeAMinoLordAsUrta() {
            ...
            this.flags[kFLAGS_1.kFLAGS.URTA_RAPED_MINO_LORD] = 1;
        ...
        //Post-Encounter*
        beatMinoLordOnToSuccubi() {
            this.clearOutput();
            this.outputText("The succubus claps slowly as she gets up from her perch on a ruined column.  \"<i>I'm impressed.</i>\"  She says, stepping in the light as she walks towards you.  You gasp, this succubus looks like a cow!");
            ...
            //{If Urta raped Fido:}
            if (this.flags[kFLAGS_1.kFLAGS.URTA_RAPED_MINO_LORD] > 0) {
            ...
            this.player.setWeapon(this.weapons.URTAHLB);
            //player.weapon = weapons.URTAHLB;
            this.startCombat(new MilkySuccubus_1.MilkySuccubus(), true);
        }
        //Attacks
        ...
        milkyUrtaTic() {
            ...
            if (this.player.lust < 50)
                this.outputText("Thankfully it hasn't become too distracting yet.");
            else if (this.player.lust < 75)
                this.outputText("You don't know how much longer you'll be able to withstand the effects of the milk.");
            else
                this.outputText("Those orbs full of milky goodness are starting to look more attractive by the minute... if you don't finish this quickly you might end up giving up!");
            this.outputText("\n\n");
            this.player.addStatusValue(StatusAffects_1.StatusAffects.MilkyUrta, 1, -1);
            if (this.player.statusAffectv1(StatusAffects_1.StatusAffects.MilkyUrta) <= 0)
                this.player.removeStatusAffect(StatusAffects_1.StatusAffects.MilkyUrta);
            this.dynStats("lus", 10);
        }
        ...
        urtaBeatsUpCowcubi() {
            ...
            //HP:
            if (this.monster.HP < 1) {
                this.outputText("The succubus trips and falls on her face, dropping her whip at your feet.  You quickly take her whip and use it to bind her hands behind her back.");
            ...
            //Lust:
                ...
                this.outputText("The succubus drops her whip and begins masturbating furiously, jilling her dripping cunt with abandon.  You quickly run towards her, planting your foot on her back and sending her tumbling on her face, then you use her whip to bind her hands behind her back.");
            ...
            this.outputText("\n\nIt's risky, but... surely one fuck can't hurt?  You do want to be faithful to " + this.player2.short + ", you do, but " + this.player2.mf("he", "she") + "'s not here, is " + this.player2.mf("he", "she") + "?  Still, you're sure you can be strong and leave it, you do have the willpower... oh, but the temptation...");
        ...
        fuckTheCowCubi() {
            this.clearOutput();
            this.outputText("\"<i>Come on girl, strip down so I can see what you're hiding under that leather skirt of yours.  Besides, we both know you want me, I can see that tent,</i>\" she laughs, licking her lips seductively.");
        ...
        urtaLosesToCowCubi() {
            ...
            if (this.player.HP < this.player.maxHP())
                this.outputText(" and healing your wounds");
            this.outputText(".  Your own nipples have long since become fully engorged, taut black tit-caps, pebbly and sensitive.  They drag up and down the fat bottoms of the demoness's swollen underbust with every swallow and gasping breath you take.");
        ...
        deadGodsDreaming() {
            this.clearOutput();
            this.outputText("Your eyes spring open and you stare in dumbfounded shock at the statue as it starts to move, joints flexing with the awful sound of stone grating on stone.  Carved eyelids open to reveal flames of myriad colors, ever-shifting before your eyes.  \"<i>Welcome, vessel.  It is time that we spoke.</i>\"");
            ...
            this.outputText("\n\n\"<i>If you try anything to hurt " + this.player2.mf("him", "her") + ", I swear I'll make sure you go to whatever pit awaits dead gods,</i>\" you hiss at him, clenching your fists so tightly you feel your nails bite into your palms.  One of your ears twitches when your better sense reminds you that this deity is still inside you, and you lack even the slightest amount of magical power.");
        ...
        urtaArrivesAtCampForFukks() {
            ...
            if (this.player.gender == 0)
                this.outputText("seeing as how you can't make babies");
            else
                this.outputText("if you'd rather not");
        ...
        knockUpUrtaWithGodChild() {
            ...
            this.outputText(".  The nub of her clit is a diamond-hard button that drags across your sensitive " + this.player.skin() + ", aggressively smashed into your genitals.  Still, somehow, she seems to be holding back, probing you with some last vestige of sanity for your consent.");
            this.outputText("\n\nSighing, you figure you may as well lie back and enjoy it, and you push your tongue back against hers, letting her set the fevered, frenzied pace but along for the ride regardless.  She picks up on the change in your attitude and shifts, a soft-fingered grip snaring [oneCock] and lifting it up, pressing it into the slick wetness between her thighs.  You gasp, muffled by her overwhelmingly intense french-kiss, the fox-girl's puffy black lips smothering your own in warm, wet affection.  Likewise, the onyx opening of her vagina yields against your " + this.cockDescript(x) + ", clinging tightly around your girth as they swallow the first few inches of you.  Already, you can feel her inner walls massaging your tender erection towards orgasm.  They squeeze and tug on your " + this.player.cockHead(x) + " powerfully while small squirts of fox-lube drizzle down to your [sheath].  The fox drives herself the rest of the way down onto you.  Her hips hit yours with a loud smack, splattering her moisture down your [legs].");
            this.outputText("\n\nFinally, Urta breaks the kiss, panting for air as she begins to buck and rock atop you.  Your " + this.cockDescript(x) + " shivers against the squeezing pressures the frenzied fox is forcing upon you, and already you can feel yourself trickling and leaking into her sodden vice.  Both of your bodies have become absolutely drenched in sticky, musky horse-pre");
            if (this.player.cockTotal() > 1)
                this.outputText(", the mess made worse by your multiple-cocked virility.  There's so much that the clear juices roll off you to either side, puddling in your blankets below");
            this.outputText(".  Her nipples dig into yours");
            if (this.player.hasFuckableNipples()) {
                this.outputText(", kissing into the ");
                if (this.player.lactationQ() > 50)
                    this.outputText("milky, ");
                this.outputText("wet holes on your tits, drawing fresh gasps of delight from your overwhelmed brain");
            }
            else
                this.outputText(", shooting tingling excitement through your nubs as you grind against each other");
            this.outputText(".  Urta's artless humping would be cringeworthy if she weren't so incredibly wet or overly tight.");
            this.outputText("\n\nThe confused girl begins to moan, howl even, yipping wildly as she bottoms out again and again, slathering your loins in her honeyed, female syrup.  She shudders, lost to lust, and the clingy, clenching hole gives a tremendous squeeze around your " + this.cockDescript(x) + ".  Urta babbles, \"<i>So good... so good...</i>\" over and over, her eyes rolling wildly.  You grab hold of her cushiony, furry behind like a drowning man holding on to a life raft while the pleasure mounts within you, seeming to bubble out of your very balls.  \"<i>Cumcumcumcum!</i>\" the vixen chants, milking you desperately.  You do just that, squirting out a nice, thick load for the her greedy pussy to drink down.  The runny girl-cum that's oozing over your ");
            if (this.player.balls > 0)
                this.outputText("[sack]");
            else
                this.outputText("taint");
            this.outputText(" tints off-white from your liquid, squirting out of her tunnel faster than ever when she climaxes with you");
            if (this.player.cumQ() > 1000)
                this.outputText(", belly rounded with wobbly, womb-packing spunk");
            this.outputText(".");
        ...
        postFuckUrtaUp() {
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.DungeonShutDown) >= 0)
                this.outputText(" - besides, given you know that you're nothing but a sacrifice the demons are too lazy to collect, it's not like they'll really send an invasion through");
            this.outputText(".  Urta's joyous expression makes it quite clear that you chose the right choice.  The two of you gather your things, dress Urta in her clothes as best you can (adding a blanket for extra protection and modesty), ");
            if (this.camp.followersCount() >= 2)
                this.outputText("leave instructions to your fellow camp-dwellers to look after the place, ");
            this.outputText("and set off into the wasteland in the direction of Tel'Adre.  Urta needs to stop and rest on several occasions, weighed down by her sudden and highly advanced pregnancy, but she soldiers on without complaint, taking whatever support you give to her.  You can feel the strange god-child kicking incessantly inside her belly as you walk together.");
        ...
        preggedUrtaWithGodChildEpilogue() {
            ...
            if (this.player.cor > 66)
                this.outputText(", what do you care, anyway?");
            else
                this.outputText(".");
        ...
        getKnockedUpWithGodChild() {
            this.clearOutput();
            this.outputText("Smiling coyly, you remove your [armor] and crawl into your bed, beckoning for the lust-crazed fox to follow.  You trust her, and you're more than willing to let her put a nice little bun in your");
            if (this.player.isPregnant() && this.player.pregnancyIncubation < 150)
                this.outputText(" already filled");
            this.outputText(" oven.  Her green eyes bulge obscenely at the sight of your naked flesh, locked tight to every curve of your shape.  The vixen takes one shuffling step after another.  It's clear from her crazed panting and trembling fingertips that she's trying to keep herself from jumping you with limited success.  She's like an addict eyeing a cornucopia stuffed with her favorite drugs, knowing that she must take it slow but helpless against her desire to gluttonously gorge.");
            this.outputText("\n\nYou toss a little fuel on the fire by spreading your legs");
            if (this.player.balls > 0)
                this.outputText(" and lifting your balls");
            this.outputText(", exposing your puffy lips, and spreading them wide to expose your ");
            if (this.player.vaginaType() != 5)
                this.outputText("pink, ");
            else
                this.outputText("dusky, ");
            this.outputText("glistening interior.  Urta whines, high pitched and keening, and she doubles over, pumping her cock with both hands, unashamedly masturbating at the sight of your exposed, vulnerable womanhood.  She grunts, swinging her hips lewdly back and forth, actually fucking her hands now, mouth open and panting, \"<i>Gonna... gonna fuck ya!  Fullofbabies!</i>\"");
            ...
            if (this.player.wetness() >= 4)
                this.outputText("wet ");
            this.outputText("squish, she lands nose-deep in your vagina, immediately licking at it and tickling you with her smooth, slippery tongue.  \"<i>Mmmmm,</i>\" she purrs as she suckles your [clit].  Inching upward, the dripping wet fox-girl licks higher and higher, her tongue smearing across the " + this.player.skinFurScales() + " that covers your ");
            if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150)
                this.outputText("rounded ");
            this.outputText("belly.  Urta's rigid onyx nipples tickle your [legs] as they drag upward, each immensely erect and engorged, just a little pebbly in texture.  She reaches your [chest], kissing up the ");
            if (this.player.biggestTitSize() > 1)
                this.outputText("soft curve");
            else
                this.outputText("flat muscles");
            this.outputText(" until she hits your [nipple].  ");
            if (this.player.hasFuckableNipples())
                this.outputText("Her tongue plunges inside, savoring the feminine lubricants");
            else
                this.outputText("Her tongue plays across the surface, the heat of her breath shooting tingles up your spine");
            this.outputText(".  The further she climbs, the further up your [legs] you can feel her stallion-cock rising, a trail of clear pre-cum in its wake.");
            ...
            if (this.player.vaginalCapacity() < 60)
                this.outputText("a little painfully");
            else
                this.outputText("deliciously");
            this.outputText(".  Her hands roam over the rest of your body with unrestrained ardor, groping and squeezing, pulling and tweaking.   Meanwhile, her hips smack against your own, smushing her sheath up against your puffy lips, her steamy sex dripping girl-lube down the back of her balls into a thick puddle on your blanket.  SLAP!  The sweaty nutsack slaps loud enough to be heard all over as Urta crudely fucks you, humping you artlessly, her hips beating out a confused, staccato rhythm.");
            ...
            if (this.player.hasCock()) {
                this.outputText(", your own forgotten length");
                if (this.player.cockTotal() > 1)
                    this.outputText("s");
                this.outputText(" laying on your stomach, bouncing fitfully but ultimately ignored.");
            }
            else
                this.outputText(", the slippery wetness of your [vagina] and the sheer hardness of your [clit] overwhelming.");
            this.outputText("  This feels better than it really ought to, perhaps in part thanks to your partner's copious fluids and supernaturally warm, feverish dick.");
            ...
            var ballWorship = [];
            if ((this.amilyScene.amilyFollower() && this.flags[kFLAGS_1.kFLAGS.AMILY_FOLLOWER] == 2) && this.jojoScene.campCorruptJojo())
            ...
            if (this.flags[kFLAGS_1.kFLAGS.VALARIA_AT_CAMP] == 1)
                ballWorship[ballWorship.length] = 5;
            var choice;
            if (ballWorship.length > 0)
                choice = ballWorship[UrtaQuest.rand(ballWorship.length)];
            else
                choice = -1;
            //{Both mouse pets}
            if (choice == 0) {
            ...
            //{Bimbo Sophie ball worship here}
                ...
                if (this.player.balls > 0)
                    this.outputText("  She does the same to your own [balls], even giving your [asshole] a happy, sloppy kiss before returning to polishing the supple, skin-shrouded spheres just ahead.");
                this.outputText("  Helia seems thrilled to be egging you both on to new heights of pleasure, and when Urta turns back to you with a blissful smile on her face, you realize she's enjoying it too.");
            }
            //{Latexy}
            else if (choice == 4) {
                this.outputText("\n\nUrta gasps when a slithering tongue winds its way around her balls.  Looking back, she sees an inky black visage you'd recognize anywhere - your pet latex-girl, " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + ".  The still-rutting fox-futa seems a little put off by your ebony-skinned slave's dusky visage, but as more and more slippery latex bathes her balls, Urta's confusion softens into pleased acceptance.  Her thick, cum-bloated balls are getting some much-needed TLC, and she's clearly too turned on to care.  " + this.flags[kFLAGS_1.kFLAGS.GOO_NAME] + " smoothly sucks one into her mouth, devouring the messy proof of your lover's virility from every inch of the vulpine gal's ball-shroud.   When Urta's nut pops out, it's solid black, encased in wonderful, constricting latex.  She repeats the action on the other side so as to fully clean the fox, and then she turns to you, applying the same treatment to every messy spot below your waist.  Of course, she keeps returning to the blissful, fuck-crazed fox's balls, thickening the plump latex bindings around them at every turn.");
            }
            //{Valeria}
            else if (choice == 5)
            ...
            if (this.player.tailType > appearanceDefs_1.TAIL_TYPE_NONE)
                this.outputText(", though getting your tail angled right to allow her entrance is a bit of a challenge");
            else if (this.player.isTaur())
                this.outputText(", though getting down on your hands and forelegs is a bit challenging for you");
            else
                this.outputText(", [face] buried in your blankets soaked with Urta's musky fluid");
            this.outputText(".");
            ...
            if (this.player.wetness() >= 5)
                this.outputText("Lady-spunk showers out of your spasming twat, glazing Urta's bouncy ballsack with your lusty liquid.");
            else if (this.player.wetness() >= 3)
                this.outputText("Lady-spunk drools out of your spasming twat in thick streams, glazing Urta's bouncy ballsack with your liquid lust.");
            else if (this.player.wetness() >= 1)
                this.outputText("Lady-spunk drips from your spasming twat in steady trickles, glazing Urta's bouncy ballsack with your liquid lust.");
            this.outputText("  The hungry mouth between her legs wastes no time in cleaning them.");
            this.outputText("  Again and again, muscular contractions wiggle through your canal, wringing Urta's swollen staff of impregnation, milking it for more, even though your womb is STILL slightly distended from her last deposit.");
        ...
        //Post-Sex Epilogue*
        getKnockedUpUrtaEpilogue() {
            this.clearOutput();
            this.outputText("When you wake, you're ");
            if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150)
                this.outputText("much more ");
            this.outputText("pregnant ");
            if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150)
                this.outputText("than before");
            else
                this.outputText("- very pregnant");
            this.outputText(".  Whatever Urta just put inside you, it's developing fast.  Fast enough to give you a wobbling gait and a straining midriff.  You give the snoring fox a prod.  Her only reaction is to swat at your finger with her fluffy tail and roll over snoring, so this time, you jab her hard, in the butt-cheek.  She yelps, sitting upright immediately.");
        ...
        getKnockedUpByUrtaEpilogueII() {
            ...
            if (this.player.pregnancyIncubation > 0 && this.player.pregnancyIncubation < 150)
                this.outputText("  Somehow, you're still just as pregnant with something as you were before.");
            this.outputText("  You're filled with vigor at the touch, the stress of the birth fading immediately.  Even your poor, tortured vagina tingles, the pain fading.  You can feel the pregnant gape receding, as if the birth never happened.");
        ...
        //[Next]
        urtaAndEdrynGodChildEpilogueII() {
            this.clearOutput();
            this.outputText("As the double doors open, you hear a painful moan from the ");
            //{pre-pregnant }
            this.outputText("horse-girl.");
            if (kGAMECLASS_1.kGAMECLASS.telAdre.edryn.pregnancy.isPregnant)
                this.outputText("  Just how did she get pregnant again when she was already knocked up?  ...Magic, maybe.");
            this.outputText("  Urta leads you around a bend, squeezing your hand for comfort.  \"<i>Thank you for everything, " + this.player.short + ", most of all being so understanding.</i>\"  The gray-furred fox pushes past the sixth pair of guards you've seen since entering the tower, just inside to see Edryn splayed on the floor, groaning and heaving, her ");
            if (kGAMECLASS_1.kGAMECLASS.telAdre.edryn.pregnancy.isPregnant)
                this.outputText("massively ");
            this.outputText("pregnant flanks rippling with muscular contractions.   Something is bulging against her nether-lips, stretching the massive horse-cunt wider and wider with each passing moment.");
            ...
            if (kGAMECLASS_1.kGAMECLASS.telAdre.edryn.pregnancy.isPregnant)
                this.outputText("  The centaur guardswoman is still just as pregnant with your offspring as before.  Your child is unharmed by whatever just transpired.");
            this.outputText("  Edryn's eyes immediately close, sinking into a deep, restful sleep.");
    ...
    exports.UrtaQuest = UrtaQuest;
});
//# sourceMappingURL=UrtaQuest.js.map