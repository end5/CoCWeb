define(["require", "exports", "../../Monsters/AbstractSuccubus", "../../../StatusAffects", "../../../GlobalFlags/kGAMECLASS", "../../../../../includes/appearanceDefs", "../../../Appearance"], function (require, exports, AbstractSuccubus_1, StatusAffects_1, kGAMECLASS_1, appearanceDefs_1, Appearance_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    class MilkySuccubus extends AbstractSuccubus_1.AbstractSuccubus {
        performCombatAction() {
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.MilkyUrta) < 0 && MilkySuccubus.rand(3) == 0)
                this.cowCubiMilkSprayAttack();
            else if (this.HP < 400)
                this.drinkMinoCum();
            else if (this.player.HP < 100)
                this.eAttack();
        ...
        cowCubiMilkSprayAttack() {
            ...
            if (MilkySuccubus.rand(20) + 1 + this.player.spe / 20 > 17) {
                ...
                kGAMECLASS_1.kGAMECLASS.dynStats("lus", 6);
            }
            //Hit:
            else {
                ...
                kGAMECLASS_1.kGAMECLASS.dynStats("lus", 15);
                this.createStatusAffect(StatusAffects_1.StatusAffects.MilkyUrta, 3, 0, 0, 0);
            }
        ...
        drinkMinoCum() {
            ...
            //Success:
            if (this.findStatusAffect(StatusAffects_1.StatusAffects.DrankMinoCum) < 0 || this.findStatusAffect(StatusAffects_1.StatusAffects.DrankMinoCum2) < 0) {
                ...
                this.lust += 25;
                this.HP += 400;
                if (this.findStatusAffect(StatusAffects_1.StatusAffects.DrankMinoCum) < 0)
                    this.createStatusAffect(StatusAffects_1.StatusAffects.DrankMinoCum, 0, 0, 0, 0);
                else
                    this.createStatusAffect(StatusAffects_1.StatusAffects.DrankMinoCum2, 0, 0, 0, 0);
            }
            //Failure:
            else {
        ...
        succubusTease() {
            if (MilkySuccubus.rand(4) == 0)
                this.outputText("Turning around, the succubus begins to bounce her rather round derriere in your direction, the cheeks lewdly clapping together with each change in direction, exposing her dark anal star and juicy snatch, literally gushing forth a stream of lubricants.  Her eyes glow with faint, purple light as she whispers, \"<i>Don't you just want to... slide on in?</i>\"");
            else if (MilkySuccubus.rand(3) == 0)
                this.outputText("The succubus squeezes her spotted, sweat-oiled breasts together, squirting out trickles of fresh, creamy, succubi milk.  Bending down, she laps at her own bounty, taking to meet your eyes, her own glowing violet.  You can feel her next words as much as hear them, reaching into your brain and stirring a familiar heat in your loins.  \"<i>Giving in would mean pleasure unending, my dear vixen.</i>\"");
            else if (MilkySuccubus.rand(2) == 0)
                this.outputText("The succubus turns slightly and slowly bends over, sliding her hands down the sides of her milk laden jugs. \"<i>Mmm, would you help a poor girl relax? These things need some attention,</i>\" she says with a lust filled moan as her hands reach her multitude of nipples.");
            else
                this.outputText("The succubus leans forwards holding her tits, while wrapping her fingers around her nipples.  \"<i>My boobs are soo full.  Would you like to help me drain them?</i>\" she says with a husky voice.");
            kGAMECLASS_1.kGAMECLASS.dynStats("lus", 20);
            this.combatRoundOver();
        }
        defeated(hpVictory) {
        ...
        constructor() {
            ...
            this.createStatusAffect(StatusAffects_1.StatusAffects.BonusVCapacity, 300, 0, 0, 0);
            this.createBreastRow(Appearance_1.Appearance.breastCupInverse("G"));
    ...
    exports.MilkySuccubus = MilkySuccubus;
});
//# sourceMappingURL=MilkySuccubus.js.map