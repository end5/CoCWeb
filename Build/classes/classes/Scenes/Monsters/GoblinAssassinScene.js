define(["require", "exports", "../../BaseContent", "../../GlobalFlags/kFLAGS", "./GoblinAssassin", "../../StatusAffects", "../../../../includes/appearanceDefs", "../../../console", "../../Appearance", "../../CockTypesEnum", "../../GlobalFlags/kGAMECLASS"], function (require, exports, BaseContent_1, kFLAGS_1, GoblinAssassin_1, StatusAffects_1, appearanceDefs_1, console_1, Appearance_1, CockTypesEnum_1, kGAMECLASS_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by Fenoxo on Jan 18th 2014
     */
    class GoblinAssassinScene extends BaseContent_1.BaseContent {
        /*Goblins
         Gender: Female
         Height: 2-4 feet
        ...
        goblinAssassinEncounter() {
            this.clearOutput();
            //First Time Intro
            if (this.flags[kFLAGS_1.kFLAGS.TIMES_ENCOUNTERED_GOBLIN_ASSASSIN] == 0) {
                this.outputText("A needle whizzes through the air and lands next to your foot. The fine craftsmanship along the side of the glass tube only brings you to one conclusion - it's owner has access to precision machinery and manufacturing capabilities uncommon in this land.");
            ...
            //Repeat Intro - Cell Chambers
                ...
                this.outputText("A familiar sight catches your attention as a shadowy blur lands in front of you - another goblin assassin appears to be lurking around these parts. You ready your [weapon] as she straps on a belt loaded with various types of needles and assumes a combat stance.");
                //[Initiate combat encounter – goblin assassin]
            }
            this.flags[kFLAGS_1.kFLAGS.TIMES_ENCOUNTERED_GOBLIN_ASSASSIN]++;
            this.startCombat(new GoblinAssassin_1.GoblinAssassin());
        }
        //[LOSS SEXAHNZ]
        gobboAssassinBeatYaUp() {
            ...
            if (this.player.cockThatFits(this.monster.vaginalCapacity()) >= 0 && this.player.hasCock() && (!this.player.hasVagina() || GoblinAssassinScene.rand(2) == 0)) {
                ...
                if (this.player.cockTotal() == 1)
                    this.outputText("that thing");
                else
                    this.outputText("those things");
                this.outputText(" look mighty tasty.  You don’t mind if I sample just a little bit of your seed do you?</i>\"  The sapphire-maned beauty kneels down next to you and lets her tiny, delicate digits dance across the underside of [oneCock], drawing a lurid moan from your lips as she wonders out loud, “I don’t hear a no, " + this.player.mf("stud", "sexy") + ".  That’s good... I’m just going to take a little bit of cum... just a few squirts.  Surely a ");
                if (this.player.tallness >= 60)
                    this.outputText("big, ");
                this.outputText(this.player.mf("strapping young man", "sexy breeder") + " will have enough jizz to pay for " + this.player.mf("his", "her") + " trespass?</i>\"");
                this.outputText("  Those delightful, dancing fingers pirouette down to your ");
                if (this.player.balls > 0)
                    this.outputText("[sack], giving it a gentle caress before vanishing.");
                else if (this.player.hasVagina())
                    this.outputText(this.vaginaDescript() + ", the tips giving your soaked mound only the barest ghost of a touch.");
                else
                    this.outputText("taint, the tips giving your sensitive skin only the barest ghost of a touch.");
                ...
                if (this.player.cocks.length > 1)
                    this.outputText("s");
                this.outputText(" wild with need.  Thankfully, as soon as you submit to her puffy mound and give it a lick, a pair of soft, wrinkled feet wrap around your " + this.cockDescript(x) + ", drawing out a thick flood of your pre-cum.");
                this.outputText("\n\nToes smear your precum around your " + this.player.cockHead(x) + " before the warm soles drag them down the " + GoblinAssassinScene.num2Text(Math.round(this.player.cocks[x].cockLength)) + " inches of your length, basting your " + this.cockDescript(x) + " in a mixture of goblin sweat and your personal juices.  You moan in delight, your sounds of rapture muted by the puffy, soaked lips that obscure your mouth, your cock spurting helpless trails of white submissively onto her feet.  Every brush of your lips is rewarded with caresses from the goblin’s tiny toes.  Every lick sends those squeezing, cum-lubed feet sliding up and down.  Every suck on her clit causes her pace to increase.  With encouragement like that, you cannot stop yourself from attending to the goblin’s syrupy box, worshipping her womanhood like a slave before an altar of a glorious god.");
                this.outputText("\n\nThe short, stacked woman moves her legs to lay your cock on her left foot while the entirety of her right foot presses down on your " + this.cockDescript(x) + "’s underside, squeezing a thick flow of your pent-up jism from the cum-slit at its tip.  Her sole rocks up and down your length, milking dollop after dollop of jizz onto the goblin’s toes.  After a while, she switches her legs to let her now-soaked foot do the rest of the squeezing.  You happily squirt and squirm, dripping like a sieve but not yet achieving true release.  The goblin, having no such problem, cums noisily atop you, numerous times.  Each successive squirt of girl-fluid soaks your face more than the one before, and by the time she’s done, your " + this.hairDescript() + " is sticky with it, half-buried in a puddle of goblin-lust.  You’re so close.  So very close.  Just a little bit more... a few more strokes.");
                this.outputText("\n\n\"<i>");
                if (this.silly())
                    this.outputText("Stop right there, criminal scum.");
                else
                    this.outputText("Hold your horses.");
                this.outputText("</i>\"  The emerald assassin glances over her shoulder at you and urges, \"<i>Come on now.  Fill me up.  Let out all that spunk I’ve been making build up ");
                if (this.player.balls > 0)
                    this.outputText("in your balls");
                else
                    this.outputText("inside you");
                this.outputText(".  Pay your ‘fine’, and I might let you go.</i>\"");
                if (this.player.balls > 0)
                    this.outputText("  A hand squeezes your [sack] encouragingly");
                else
                    this.outputText("  Hands squeeze your [butt] encouragingly");
                ...
                if (this.player.cumQ() >= 750) {
                    this.outputText("  Even her near-supernatural fertility can’t keep up with your fantastic virility, and soon the goblin is sporting a small bump on her belly.");
                    if (this.player.cumQ() >= 2000)
                        this.outputText("  It swells to a rounded, pregnant dome by the time you finish.");
                }
                this.outputText("  All of your passion spends itself in the glorious climax, leaving you feeling like an empty, wasted husk.");
            ...
            //ii. Lust Loss - Male - No Fit
            else if (this.player.biggestCockArea() > this.monster.vaginalCapacity() && this.player.hasCock() && (!this.player.hasVagina() || GoblinAssassinScene.rand(2) == 0)) {
                x = this.player.biggestCockIndex();
                this.outputText("You tear through your [armor] in a rush, anything to release [eachCock] from its hellish confinement.  You’re so aroused, so horny.  Any passing thoughts of modesty are immediately discarded and forgotten, washed away under the wave of your all-consuming lust as your fingers slide home around [oneCock] and begin to play with the turgid tool.  You immediately buck from the sensation of incredible, pent-up need, nearly cumming on the spot.  Looking up, you meet the emerald-skinned woman’s eyes pleadingly.");
                ...
                if (this.player.biggestCockLength() < this.player.tallness / 2)
                    this.outputText("sitting on your face, the " + this.player.cockHead(x) + " of your maleness jutting against her drooling lips.");
                else
                    this.outputText("sitting on the ground ‘above’ you, your " + this.player.cockHead(x) + " reaching all the way up to spear her moist box, judging by what you’re feeling anyway.");
                this.outputText("\n\nHer soft feet clasp your dick from each side, displaying a level of flexibility you would not have expected from the girl.  The supple soles slide and caress your length.  Her toes curl around to stroke the sensitive sides of your urethral bulge.  Even the hard knobs of her heels cradle your " + this.cockDescript(x) + " underside as she masturbates you with her feet.");
                ...
                if (this.player.cumQ() >= 1000)
                    this.outputText("You spurt huge dollops of pre-cum into her waiting twat thanks to your prodigious virility, though it is only a hint of things to come.  ");
                else if (this.player.cumQ() >= 250)
                    this.outputText("You drool a steady flow of pre-cum into her waiting twat, though it’s only a hint of things to come.  ");
                this.outputText("  \"<i>It won’t be long now.  Yeah, I’m an assassin, but I take care of myself too.  I keep these puppies nice and moisturized, just in case I need to use them on a freak-cock like yours.</i>\"");
                this.outputText("\n\nYou try to grunt in protest, but it’s muffled by your ");
                if (this.player.biggestCockLength() >= this.player.tallness / 2)
                    this.outputText("pulsating, iron-hard cock");
                else
                    this.outputText("captor’s pillowy asscheeks");
                this.outputText(".  The goblin pulls hard with her feet, and her sloppy, stretched cunt just barely slurps in your entire " + this.player.cockHead(x) + ".  You shiver in delight from the tight, vise-like grip constricting your maleness, and nearly erupt from sensation when the little green minx manages to pull another inch inside herself.  She trembles and shudders, her feet suddenly going wild along your length.  The goblin’s cushy soles smear along your " + this.cockDescript(x) + " with the wild abandon of one lost to pleasure, her juices squirting out from her slit as she climaxes.  The onslaught of touches is too much for your straining member, and with a tight, hot clench, you feel your imminent release has arrived.  A fat bulge appears at the base of your shaft, coupled with an explosion of warm pleasure from within you.  It travels from your base all the way towards the tip, before disappearing into the goblin with a cunt-stretching squirt.  She moans out loud, clearly enjoying the sensation of being stuffed with cream, and the two of you sigh together while your dick finishes pumping ");
                if (this.player.cumQ() <= 10)
                    this.outputText("dribbles");
                else if (this.player.cumQ() <= 100)
                    this.outputText("squirts");
                else if (this.player.cumQ() <= 250)
                    this.outputText("thick wads");
                else if (this.player.cumQ() <= 1750)
                    this.outputText("waves of gooey spooge");
                else
                    this.outputText("rivers of cum");
                this.outputText(" into the goblin’s box.");
                if (this.player.cumQ() >= 2500)
                    this.outputText(" Her belly rounds up nicely under your voluminous attentions.");
                this.outputText("\n\nThe green girl gives your " + this.cockDescript(x) + " a few last affectionate squeezes before she disentangles herself from you.  You slump down, still feeling a little turned on, and return to masturbating.  The goblin laughs, \"<i>A few more performances like that and I just might have to keep you.</i>\"  You play with yourself until you fall asleep, and even then, you dream of the feel of that silken pussy back on top of your dick.");
            }
            //iii. Lust Loss - Female
            else {
                this.outputText("Defeated by your own needs, your fingers dart to your [armor], rapidly disassembling it in your hurry to expose your aching, tender puss to the goblin’s eyes.  The assassin watches you with an unimpressed, bemused expression, though she remains rooted in place, her gaze locked onto you as you succumb to your lusts.  Knowing that you have an audience, you twist and contort your body to present your [chest] and [vagina] to the petite greenskin.  Glistening moisture forms on your exposed nether-lips, tempting you to slide your fingers into their slick warmth.  As if you could resist.");
                ...
                if (this.player.hasFuckableNipples())
                    this.outputText("piston in and out of your [nipple], masturbating it just as hard as the real thing.");
                else
                    this.outputText("squeeze around a taut nipple, twisting and pulling on it unthinkingly.");
                this.outputText("  Your masturbatory reverie is interrupted sudden impacts against both your wrists.");
        ...
        gobboAssassinRapeIntro() {
            ...
            if (this.player.lust >= 33 && this.player.gender > 0 && (fitsFuck != undefined || cuntFuck != undefined || tooBig != undefined ||
                ...
                console_1.trace("falling through gobboAssassinRapeIntro");
                this.cleanupAfterCombat();
            }
        }
    ...
    exports.GoblinAssassinScene = GoblinAssassinScene;
});
//# sourceMappingURL=GoblinAssassinScene.js.map