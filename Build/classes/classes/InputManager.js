define(["require", "exports", "./BoundControlMethod", "./display/BindingPane", "../ClassBinder"], function (require, exports, BoundControlMethod_1, BindingPane_1, ClassBinder_1) {
    "use strict";
    ...
    class InputManager {
        ...
        constructor(mainView) {
            ...
            this._defaultControlMethods = new Object();
            this._defaultAvailableControlMethods = 0;
            this._defaultKeysToControlMethods = new Object();
            // Basically, an associative list of Names -> Control Methods
            this._controlMethods = new Object();
            this._availableControlMethods = 0;
            // A list of cheat control methods that we can throw incoming keycodes against at will
            this._cheatControlMethods = new Array();
            ...
            this._bindingPane = new BindingPane_1.BindingPane(this);
        }
        /**
         ...
         */
        ListenForNewBind(funcName, isPrimary = true) {
            // if (this._debug) {
            //     var slot: string = "";
            //     if (isPrimary) {
            //         slot = "Primary";
         ...
         */
        AddBindableControl(name, desc, func, isCheat = false) {
            if (isCheat) {
                this._cheatControlMethods.push(new BoundControlMethod_1.BoundControlMethod(func, name, desc, this._availableCheatControlMethods++));
            }
            else {
                this._controlMethods[name] = new BoundControlMethod_1.BoundControlMethod(func, name, desc, this._availableControlMethods++);
            }
        }
        /**
         ...
         */
        BindKeyToControl(keyCode, funcName, isPrimary = true) {
        ...
        ExecuteKeyCode(keyCode) {
            ...
            for (var i = 0; i < this._cheatControlMethods.length; i++) {
        ...
        RegisterDefaults() {
            for (var key of Object.keys(this._controlMethods)) {
                this._defaultControlMethods[key] = new BoundControlMethod_1.BoundControlMethod(this._controlMethods[key].Func, this._controlMethods[key].Name, this._controlMethods[key].Description, this._controlMethods[key].Index, this._controlMethods[key].PrimaryKey, this._controlMethods[key].SecondaryKey);
            }
        ...
        ResetToDefaults() {
            for (var key of Object.keys(this._controlMethods)) {
                this._controlMethods[key] = new BoundControlMethod_1.BoundControlMethod(this._defaultControlMethods[key].Func, this._defaultControlMethods[key].Name, this._defaultControlMethods[key].Description, this._defaultControlMethods[key].Index, this._defaultControlMethods[key].PrimaryKey, this._defaultControlMethods[key].SecondaryKey);
            }
            // Elbullshito mode -- 126 is the maximum keycode in as3 we're likely to see
            for (var i = 0; i <= 126; i++) {
        ...
        GetControlMethods() {
            ...
            for (var key of Object.keys(this._keysToControlMethods)) {
                buttons.push(key);
            }
            return buttons;
        }
         ...
         */
        LoadBindsFromObj(source) {
            this.ClearAllBinds();
            for (var key of Object.keys(source)) {
                var pKeyCode = source[key].PrimaryKey;
                var sKeyCode = source[key].SecondaryKey;
