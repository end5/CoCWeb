define(["require", "exports", "../InputManager", "./BindDisplay"], function (require, exports, InputManager_1, BindDisplay_1) {
    "use strict";
    ...
    class BindingPane {
        ...
        InitContentObjects() {
            ...
            for (var i = 0; i < this._functions.length; i++) {
                // this._contentChildren++;
                var newLabel = new BindDisplay_1.BindDisplay();
                ...
                var genPrimaryCallback = function (funcName, inMan) {
                    return () => {
                        inMan.ListenForNewBind(funcName, InputManager_1.InputManager.PRIMARYKEY);
                        // _stage.focus = _stage;
                    };
                };
                var genSecondaryCallback = function (funcName, inMan) {
                    return () => {
                        inMan.ListenForNewBind(funcName, InputManager_1.InputManager.SECONDARYKEY);
                        // _stage.focus = _stage;
                    };
                };
                // ... Warned you.
    ...
    exports.BindingPane = BindingPane;
});
//# sourceMappingURL=BindingPane.js.map