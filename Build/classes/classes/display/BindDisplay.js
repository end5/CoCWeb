define(["require", "exports", "../../../lib/src/coc/view/CoCButton"], function (require, exports, CoCButton_1) {
    "use strict";
    ...
    class BindDisplay {
        ...
        constructor() {
            ...
            this._buttons = [new CoCButton_1.CoCButton(button1), new CoCButton_1.CoCButton(button2)];
        ...
        set button1Callback(callback) {
            this._buttons[0].callback = callback;
        }
        set button2Callback(callback) {
            this._buttons[1].callback = callback;
        }
    }
    exports.BindDisplay = BindDisplay;
});
//# sourceMappingURL=BindDisplay.js.map