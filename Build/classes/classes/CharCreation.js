define(["require", "exports", "./BaseContent", "./GlobalFlags/kFLAGS", "./Player", "../../includes/appearanceDefs", "./Items/Armors/GooArmor", "./Items/WeaponLib", "../console", "./CockTypesEnum", "./StatusAffects", "./GlobalFlags/kGAMECLASS", "./PerkLib", "../../lib/src/coc/view/MainView", "./FlagTypeOverrides"], function (require, exports, BaseContent_1, kFLAGS_1, Player_1, appearanceDefs_1, GooArmor_1, WeaponLib_1, console_1, CockTypesEnum_1, StatusAffects_1, kGAMECLASS_1, PerkLib_1, MainView_1, FlagTypeOverrides_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    //	import flash.events.MouseEvent;
    class CharCreation extends BaseContent_1.BaseContent {
        newGamePlus() {
            this.flags[kFLAGS_1.kFLAGS.NEW_GAME_PLUS_BONUS_STORED_XP] = this.player.XP;
            if (this.flags[kFLAGS_1.kFLAGS.NEW_GAME_PLUS_BONUS_STORED_XP] == 0)
                this.flags[kFLAGS_1.kFLAGS.NEW_GAME_PLUS_BONUS_STORED_XP] = 1;
            while (this.player.level > 1) {
                this.flags[kFLAGS_1.kFLAGS.NEW_GAME_PLUS_BONUS_STORED_XP] += this.player.level * 100;
                this.player.level--;
            }
            this.flags[kFLAGS_1.kFLAGS.NEW_GAME_PLUS_BONUS_STORED_ITEMS] = this.player.gems;
            this.newGameGo();
        }
        newGameGo() {
            this.funcs = [];
            ...
            this.mainView.hideMenuButton(MainView_1.MainView.MENU_NEW_MAIN);
            ...
            var silly = !!this.flags[kFLAGS_1.kFLAGS.SILLY_MODE_ENABLE_FLAG];
            var easy = !!this.flags[kFLAGS_1.kFLAGS.EASY_MODE_ENABLE_FLAG];
            var sprite = !!this.flags[kFLAGS_1.kFLAGS.SHOW_SPRITES_FLAG];
            ...
            kGAMECLASS_1.kGAMECLASS.dungeonLoc = 0;
            kGAMECLASS_1.kGAMECLASS.inRoomedDungeon = false;
            kGAMECLASS_1.kGAMECLASS.inRoomedDungeonResume = undefined;
            ...
            this.player.cor = 0;
            this.player.lust = 15;
            kGAMECLASS_1.kGAMECLASS.notes = "No Notes Available.";
            this.player.XP = this.flags[kFLAGS_1.kFLAGS.NEW_GAME_PLUS_BONUS_STORED_XP];
            this.player.level = 1;
            this.player.HP = this.player.maxHP();
            this.player.gems = this.flags[kFLAGS_1.kFLAGS.NEW_GAME_PLUS_BONUS_STORED_ITEMS];
            this.player.skinType = appearanceDefs_1.SKIN_TYPE_PLAIN;
            this.player.faceType = appearanceDefs_1.FACE_HUMAN;
            this.player.tailType = appearanceDefs_1.TAIL_TYPE_NONE;
            this.player.tongueType = appearanceDefs_1.TONUGE_HUMAN;
            ...
            this.player.ass.analLooseness = appearanceDefs_1.ANAL_LOOSENESS_VIRGIN;
            this.player.ass.analWetness = appearanceDefs_1.ANAL_WETNESS_DRY;
            this.player.ass.fullness = 0;
            this.player.fatigue = 0;
            this.player.horns = 0;
            this.player.tailVenom = 0;
            this.player.tailRecharge = 0;
            this.player.wingType = appearanceDefs_1.WING_TYPE_NONE;
            ...
            //PLOTZ
            kGAMECLASS_1.kGAMECLASS.monk = 0;
            kGAMECLASS_1.kGAMECLASS.whitney = 0;
            kGAMECLASS_1.kGAMECLASS.sand = 0;
            //Replaced by flag	kGAMECLASS.beeProgress = 0;
            kGAMECLASS_1.kGAMECLASS.giacomo = 0;
            //Lets get this bitch started
            kGAMECLASS_1.kGAMECLASS.inCombat = false;
            //NG+ Clothes reset
            if (this.flags[kFLAGS_1.kFLAGS.NEW_GAME_PLUS_BONUS_STORED_ITEMS] != 0) {
                //Clear Raphael's training variable so it does not effect
                //Weapon strength post-newgame.
                this.flags[kFLAGS_1.kFLAGS.RAPHAEL_RAPIER_TRANING] = 0;
                if (!(oldPlayer.armor instanceof GooArmor_1.GooArmor)) {
            ...
            this.flags = FlagTypeOverrides_1.createFlags();
            //Remember silly/sprite/etc
            if (sprite)
                this.flags[kFLAGS_1.kFLAGS.SHOW_SPRITES_FLAG] = true;
            if (easy)
                this.flags[kFLAGS_1.kFLAGS.EASY_MODE_ENABLE_FLAG] = 1;
            if (silly)
                this.flags[kFLAGS_1.kFLAGS.SILLY_MODE_ENABLE_FLAG] = true;
            //Set that jojo debug doesn't need to run
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_00102] = 1;
            this.flags[kFLAGS_1.kFLAGS.UNKNOWN_FLAG_NUMBER_02999] = 3;
            //Time reset
        ...
        customName(arg) {
            switch (arg) {
                case "Aria": return this.customAria;
                case "Betram": return this.customBetram;
                case "Charaun": return this.customCharaun;
                case "Cody": return this.customCody;
                case "Galatea": return this.customGalatea;
                case "Gundam": return this.customGundam;
                case "Hikari": return this.customHikari;
                case "Katti": return this.customKatti;
                case "Lucina": return this.customLucina;
                case "Navorn": return this.customNavorn;
                case "Rope": return this.customRope;
                case "Sora": return this.customSora;
                default:
            }
        ...
        specialName(arg) {
            switch (arg) {
                case "Annetta": return this.customAnnetta;
                case "Ceveo": return this.customCeveo;
                case "Charlie": return this.customCharlie;
                case "Isaac": return this.customIsaac;
                case "Leah": return this.customLeah;
                case "Lukaz": return this.customLukaz;
                case "Mara": return this.customMara;
                case "Mihari": return this.customMihari;
                case "Mirvanna": return this.customMirvanna;
                case "Nami": return this.customNami;
                case "Nixi": return this.customNixi;
                case "Prismere": return this.customPrismere;
                case "Rann Rayla": return this.customRannRayla;
                case "Sera": return this.customSera;
                case "Siveen": return this.customSiveen;
                case "TestChar": return this.customTestChar;
                case "Tyriana": return this.customTyriana;
                case "Vahdunbrii": return this.customVahdunbrii;
                default:
            }
            return undefined;
        }
        isAMan() {
            ...
            this.player.gender = appearanceDefs_1.GENDER_MALE;
            this.clearOutput();
        ...
        isAWoman() {
            ...
            this.player.gender = appearanceDefs_1.GENDER_FEMALE;
            this.clearOutput();
        ...
        buildLeanMale() {
            ...
            this.player.tone += 5;
            this.player.breastRows[0].breastRating = appearanceDefs_1.BREAST_CUP_FLAT;
            this.player.buttRating = appearanceDefs_1.BUTT_RATING_TIGHT;
            this.player.hipRating = appearanceDefs_1.HIP_RATING_SLENDER;
        ...
        buildSlenderFemale() {
            ...
            this.player.thickness = 30;
            this.player.tone += 5;
            this.player.breastRows[0].breastRating = appearanceDefs_1.BREAST_CUP_B;
            this.player.buttRating = appearanceDefs_1.BUTT_RATING_TIGHT;
            this.player.hipRating = appearanceDefs_1.HIP_RATING_AMPLE;
            this.chooseComplexion();
        }
        buildAverageMale() {
            ...
            this.player.breastRows[0].breastRating = appearanceDefs_1.BREAST_CUP_FLAT;
            this.player.buttRating = appearanceDefs_1.BUTT_RATING_AVERAGE;
            this.player.hipRating = appearanceDefs_1.HIP_RATING_AVERAGE;
            this.chooseComplexion();
        }
        buildAverageFemale() {
            this.player.femininity = 70;
            this.player.thickness = 50;
            this.player.breastRows[0].breastRating = appearanceDefs_1.BREAST_CUP_C;
            this.player.buttRating = appearanceDefs_1.BUTT_RATING_NOTICEABLE;
            this.player.hipRating = appearanceDefs_1.HIP_RATING_AMPLE;
            this.chooseComplexion();
        }
        buildThickMale() {
        ...
        buildCurvyFemale() {
            ...
            this.player.thickness = 70;
            this.player.breastRows[0].breastRating = appearanceDefs_1.BREAST_CUP_D;
            this.player.buttRating = appearanceDefs_1.BUTT_RATING_LARGE;
            this.player.hipRating = appearanceDefs_1.HIP_RATING_CURVY;
            this.chooseComplexion();
        }
        buildGirlyMale() {
            this.player.str -= 2;
            ...
            this.player.thickness = 50;
            this.player.tone = 26;
            this.player.breastRows[0].breastRating = appearanceDefs_1.BREAST_CUP_A;
            this.player.buttRating = appearanceDefs_1.BUTT_RATING_NOTICEABLE;
            this.player.hipRating = appearanceDefs_1.HIP_RATING_SLENDER;
            this.chooseComplexion();
        }
        ...
        setHair(choice) {
            ...
            this.clearOutput();
            this.outputText("You have " + this.hairDescript() + ".");
            this.chooseEndowment(false);
        }
        chooseEndowment(clear) {
            if (clear)
                this.clearOutput();
        ...
        setEndowmentStrength() {
            this.player.str += 5;
            this.player.tone += 7;
            this.player.thickness += 3;
            //Add bonus +25% strength gain
            this.player.createPerk(PerkLib_1.PerkLib.Strong, 0.25, 0, 0, 0);
            this.chooseHistory();
        }
        setEndowmentToughness() {
            this.player.tou += 5;
            this.player.tone += 5;
            this.player.thickness += 5;
            this.player.createPerk(PerkLib_1.PerkLib.Tough, 0.25, 0, 0, 0);
            this.player.HP = kGAMECLASS_1.kGAMECLASS.maxHP();
            this.chooseHistory();
        }
        setEndowmentSpeed() {
            this.player.spe += 5;
            this.player.tone += 10;
            this.player.createPerk(PerkLib_1.PerkLib.Fast, 0.25, 0, 0, 0);
            this.chooseHistory();
        }
        setEndowmentSmarts() {
            this.player.inte += 5;
            this.player.thickness -= 5;
            this.player.createPerk(PerkLib_1.PerkLib.Smart, 0.25, 0, 0, 0);
            this.chooseHistory();
        }
        setEndowmentLibido() {
            this.player.lib += 5;
            this.player.createPerk(PerkLib_1.PerkLib.Lusty, 0.25, 0, 0, 0);
            this.chooseHistory();
        }
        setEndowmentTouch() {
            this.player.sens += 5;
            this.player.createPerk(PerkLib_1.PerkLib.Sensitive, 0.25, 0, 0, 0);
            this.chooseHistory();
        }
        setEndowmentBigCock() {
            ...
            console_1.trace("Creation - cock modded to 8inches");
            this.player.createPerk(PerkLib_1.PerkLib.BigCock, 1.25, 0, 0, 0);
            this.chooseHistory();
        }
        setEndowmentMessyOrgasms() {
            this.player.femininity -= 2;
            this.player.cumMultiplier = 1.5;
            this.player.createPerk(PerkLib_1.PerkLib.MessyOrgasms, 1.25, 0, 0, 0);
            this.chooseHistory();
        }
        setEndowmentBigBreasts() {
            this.player.femininity += 5;
            this.player.breastRows[0].breastRating += 2;
            this.player.createPerk(PerkLib_1.PerkLib.BigTits, 1.5, 0, 0, 0);
            this.chooseHistory();
        }
        setEndowmentBigClit() {
            this.player.femininity -= 5;
            this.player.clitLength = 1;
            this.player.createPerk(PerkLib_1.PerkLib.BigClit, 1.25, 0, 0, 0);
            this.chooseHistory();
        }
        setEndowmentFertile() {
            this.player.femininity += 5;
            ...
            this.player.createPerk(PerkLib_1.PerkLib.Fertile, 1.5, 0, 0, 0);
            this.chooseHistory();
        }
        setEndowmentWetVagina() {
            this.player.femininity += 7;
            this.player.vaginas[0].vaginalWetness = appearanceDefs_1.VAGINA_WETNESS_WET;
            this.player.createPerk(PerkLib_1.PerkLib.WetPussy, 2, 0, 0, 0);
            this.chooseHistory();
        }
        chooseHistory() {
            this.clearOutput();
            if (this.flags[kFLAGS_1.kFLAGS.HISTORY_PERK_SELECTED] != 0) { //This flag can only be non-zero if chooseHistory is called from camp.as
                this.outputText("<b>New history perks are available during creation.  Since this character was created before they were available, you may choose one now!</b>\n\n");
            }
            this.outputText("Before you became a champion, you had other plans for your life.  What were you doing before?");
            this.menu();
            this.addButton(0, "Alchemy", this.confirmHistory, PerkLib_1.PerkLib.HistoryAlchemist);
            this.addButton(1, "Fighting", this.confirmHistory, PerkLib_1.PerkLib.HistoryFighter);
            this.addButton(2, "Healing", this.confirmHistory, PerkLib_1.PerkLib.HistoryHealer);
            this.addButton(3, "Religion", this.confirmHistory, PerkLib_1.PerkLib.HistoryReligious);
            this.addButton(4, "Schooling", this.confirmHistory, PerkLib_1.PerkLib.HistoryScholar);
            this.addButton(5, "Slacking", this.confirmHistory, PerkLib_1.PerkLib.HistorySlacker);
            this.addButton(6, "Slutting", this.confirmHistory, PerkLib_1.PerkLib.HistorySlut);
            this.addButton(7, "Smithing", this.confirmHistory, PerkLib_1.PerkLib.HistorySmith);
            this.addButton(8, "Whoring", this.confirmHistory, PerkLib_1.PerkLib.HistoryWhore);
        }
        confirmHistory(choice) {
            this.clearOutput();
            switch (choice) {
                case PerkLib_1.PerkLib.HistoryAlchemist:
                    this.outputText("You spent some time as an alchemist's assistant, and alchemical items always seem to be more reactive in your hands.  Is this your history?");
                    break;
                case PerkLib_1.PerkLib.HistoryFighter:
                    this.outputText("You spent much of your time fighting other children, and you had plans to find work as a guard when you grew up.  You do 10% more damage with physical attacks.  Is this your history?");
                    break;
                case PerkLib_1.PerkLib.HistoryHealer:
                    this.outputText("You often spent your free time with the village healer, learning how to tend to wounds.  Healing items and effects are 20% more effective.  Is this your history?");
                    break;
                case PerkLib_1.PerkLib.HistoryReligious:
                    this.outputText("You spent a lot of time at the village temple, and learned how to meditate.  The 'masturbation' option is replaced with 'meditate' when corruption is at or below 66.  Is this your history?");
                    break;
                case PerkLib_1.PerkLib.HistoryScholar:
                    this.outputText("You spent much of your time in school, and even begged the richest man in town, Mr. Savin, to let you read some of his books.  You are much better at focusing, and spellcasting uses 20% less fatigue.  Is this your history?");
                    break;
                case PerkLib_1.PerkLib.HistorySlacker:
                    this.outputText("You spent a lot of time slacking, avoiding work, and otherwise making a nuisance of yourself.  Your efforts at slacking have made you quite adept at resting, and your fatigue comes back 20% faster.  Is this your history?");
                    break;
                case PerkLib_1.PerkLib.HistorySlut:
                    this.outputText("You managed to spend most of your time having sex.  Quite simply, when it came to sex, you were the village bicycle - everyone got a ride.  Because of this, your body is a bit more resistant to penetrative stretching, and has a higher upper limit on what exactly can be inserted.  Is this your history?");
                    break;
                case PerkLib_1.PerkLib.HistorySmith:
                    this.outputText("You managed to get an apprenticeship with the local blacksmith.  Because of your time spent at the blacksmith's side, you've learned how to fit armor for maximum protection.  Is this your history?");
                    break;
                default:
        ...
        setHistory(choice) {
            ...
            if (choice == PerkLib_1.PerkLib.HistorySlut || choice == PerkLib_1.PerkLib.HistoryWhore) {
                if (this.player.hasVagina()) {
                    this.player.vaginas[0].virgin = false;
                    this.player.vaginas[0].vaginalLooseness = appearanceDefs_1.VAGINA_LOOSENESS_LOOSE;
                }
        ...
        customAnnetta() {
            this.outputText("You're a rather well-endowed hermaphrodite that sports a thick, dog-knotted cock, an unused pussy, and a nice, stretchy butt-hole.  You've also got horns and demonic high-heels on your feet.  It makes you wonder why you would ever get chosen to be champion!");
            ...
            this.player.earType = appearanceDefs_1.EARS_ELFIN;
            this.player.horns = 4;
            this.player.hornType = appearanceDefs_1.HORNS_DEMON;
            ...
            this.player.tailType = appearanceDefs_1.TAIL_TYPE_DEMONIC;
            this.player.lowerBody = appearanceDefs_1.LOWER_BODY_TYPE_DEMONIC_HIGH_HEELS;
        ...
        customAria() {
            ...
            if (this.player.femininity < 80)
                this.player.femininity = 80;
            this.player.createPerk(PerkLib_1.PerkLib.BimboBody, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.BimboBrains, 0, 0, 0, 0);
            this.player.tailType = appearanceDefs_1.TAIL_TYPE_FOX;
            this.player.tailVenom = 9;
            this.player.createPerk(PerkLib_1.PerkLib.EnlightenedNinetails, 0, 0, 0, 0);
            ...
            this.player.createPerk(PerkLib_1.PerkLib.ElvenBounty, 0, 15, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.PureAndLoving, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.SensualLover, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.OneTrackMind, 0, 0, 0, 0);
        ...
        customBetram() {
            ...
            if (!this.player.hasCock()) {
                this.player.createCock();
                this.player.cocks[0].cockType = CockTypesEnum_1.CockTypesEnum.DOG;
                this.player.cocks[0].cockLength = 8;
                this.player.cocks[0].cockThickness = 1;
            ...
            this.player.gender = 3;
            this.outputText("You're quite the foxy herm, and as different as you were compared to the rest of Ingnam, it's no suprise you were sent through first.");
        }
        customCeveo() {
            ...
            this.player.createPerk(PerkLib_1.PerkLib.Incorporeality, 0, 0, 0, 0);
            this.player.setArmor(this.armors.I_CORST);
            this.player.level = 5;
            this.player.setWeapon(this.weapons.W_STAFF);
            this.player.createPerk(PerkLib_1.PerkLib.Regeneration, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Smart, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Channeling, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Mage, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.HistoryHealer, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Tank, 0, 0, 0, 0);
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.KnowsArouse, 0, 0, 0, 0);
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.KnowsHeal, 0, 0, 0, 0);
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.KnowsMight, 0, 0, 0, 0);
        ...
        customCharaun() {
            this.outputText("As a gifted fox with a juicy, thick knot, a wet cunt, and magical powers, you have no problems with being chosen as champion.");
            ...
            this.player.vaginas[0].vaginalWetness = appearanceDefs_1.VAGINA_WETNESS_SLAVERING;
            this.player.clitLength = 0.5;
            ...
            this.player.tongueType = appearanceDefs_1.TONUGE_DEMONIC;
        ...
        customCharlie() {
            this.outputText("You're strong, smart, fast, and tough.  It also helps that you've got four dongs well beyond what others have lurking in their trousers.  With your wings, bow, weapon, and tough armor, you're a natural for protecting the town.");
            this.player.gender = 1;
            this.player.tou += 2;
            this.player.str += 3;
            this.player.fertility = 5;
            ...
            this.player.wingType = appearanceDefs_1.WING_TYPE_FEATHERED_LARGE;
            ...
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.Kelt, 100, 0, 0, 0);
            ...
            this.player.cocks[1].cockType = CockTypesEnum_1.CockTypesEnum.DRAGON;
            this.player.cocks[2].cockLength = 12;
            this.player.cocks[2].cockThickness = 2;
            this.player.cocks[2].cockType = CockTypesEnum_1.CockTypesEnum.DOG;
            this.player.cocks[3].cockLength = 12;
            this.player.cocks[3].cockThickness = 2;
            this.player.cocks[3].cockType = CockTypesEnum_1.CockTypesEnum.CAT;
        ...
        customCody() {
            this.outputText("Your orange and black tiger stripes make you cut a more imposing visage than normal, and with your great strength, armor, and claymore, you're a natural pick for champion.");
        ...
        customGalatea() {
            ...
            if (!this.player.hasVagina()) {
                this.player.createVagina();
                if (this.player.clitLength == 0)
                    this.player.clitLength = 0.25;
            }
            kGAMECLASS_1.kGAMECLASS.genderCheck();
            ...
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.Feeder, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Feeder, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.StrongBack, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.StrongBack2, 0, 0, 0, 0);
            //Equipment: 
            //Weapon: Warhammer
            ...
            this.outputText("You've got large breasts prone to lactation.  You aren't sure WHY you got chosen as a champion, but with your considerable strength, you're sure you'll do a good job protecting Ingnam.");
        }
        customGundam() {
            this.outputText("You're fabulously rich, thanks to a rather well-placed bet on who would be the champion.  Hopefully you can buy yourself out of any trouble you might get in.");
        ...
        customHikari() {
            ...
            this.outputText("As a herm with a super-thick cat-cock, D-cup breasts, and out-of-this-world armor, you're a natural pick for champion.");
            if (!this.player.hasCock())
                this.player.createCock();
            this.player.cocks[0].cockType = CockTypesEnum_1.CockTypesEnum.CAT;
        ...
        customIsaac() {
            this.outputText("Born of a disgraced priestess, Isaac was raised alone until she was taken by illness.  He worked a number of odd jobs until he was eventually chosen as champion.");
            //- gift: fast
            this.player.spe += 5;
            this.player.tone += 10;
            this.player.createPerk(PerkLib_1.PerkLib.Fast, 0.25, 0, 0, 0);
            //- history: religion 
            this.player.createPerk(PerkLib_1.PerkLib.HistoryReligious, 0, 0, 0, 0);
            //(and if possible)
            //- history: fighter
            this.player.createPerk(PerkLib_1.PerkLib.HistoryFighter, 0, 0, 0, 0);
            //- history: smith
            this.player.createPerk(PerkLib_1.PerkLib.HistorySmith, 0, 0, 0, 0);
            ...
            this.player.cocks[1].cockType = CockTypesEnum_1.CockTypesEnum.TENTACLE;
        ...
        customKatti() {
            this.outputText("You have big breasts with big, fuckable nipples on them, and no matter what, your vagina always seems to be there to keep you company.");
            //Gender: Female	
            if (!this.player.hasVagina()) {
                this.player.createVagina();
                kGAMECLASS_1.kGAMECLASS.genderCheck();
        ...
        customLucina() {
            ...
            this.outputText("You're a blond, fair-skinned lass with a well-made bow and the skills to use it.  You have D-cup breasts and a very moist cunt that's seen a little action.  You're fit and trim, but not too thin, nor too well-muscled.  All in all, you're a good fit for championing your village's cause.");
            if (!this.player.hasVagina())
                this.player.createVagina();
            this.player.vaginas[0].vaginalWetness = appearanceDefs_1.VAGINA_WETNESS_SLICK;
            this.player.vaginas[0].vaginalLooseness = appearanceDefs_1.VAGINA_LOOSENESS_LOOSE;
            this.player.vaginas[0].virgin = false;
            if (this.player.femininity < 80)
                this.player.femininity = 80;
        ...
        customLukaz() {
            ...
            this.player.faceType = appearanceDefs_1.FACE_DOG;
            this.player.earType = appearanceDefs_1.EARS_DOG;
        ...
        customMara() {
            ...
            this.outputText("You're a bunny-girl with bimbo-tier curves, jiggly and soft, a curvy, wet girl with a bit of a flirty past.");
            this.player.gender = 2;
            this.player.spe += 3;
            this.player.inte += 2;
            this.player.clitLength = .5;
            ...
            this.player.createPerk(PerkLib_1.PerkLib.HistorySlut, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.BimboBody, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.BimboBrains, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.BigTits, 1.5, 0, 0, 0);
            this.player.earType = appearanceDefs_1.EARS_BUNNY;
        ...
        customMihari() {
            ...
            this.outputText("The portal is not something you fear, not with your imposing armor and inscribed spellblade.  You're much faster and stronger than every champion that came before you, but will it be enough?");
            //Core Stats:
            this.player.str = 40;
            this.player.tou = 20;
            this.player.spe = 100;
            ...
            this.player.createVagina();
            this.player.vaginas[0].vaginalLooseness = appearanceDefs_1.VAGINA_LOOSENESS_TIGHT;
            this.player.vaginas[0].vaginalWetness = appearanceDefs_1.VAGINA_WETNESS_SLAVERING;
            this.player.vaginas[0].virgin = true;
            this.player.clitLength = 0.2;
            this.player.earType = appearanceDefs_1.EARS_CAT;
            this.player.faceType = appearanceDefs_1.FACE_CAT;
            this.player.femininity = 100;
            ...
            this.player.hipRating = 6;
            this.player.lowerBody = appearanceDefs_1.LOWER_BODY_TYPE_CAT;
            ...
            this.player.createPerk(PerkLib_1.PerkLib.Runner, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Fast, 0.25, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Fertile, 1.5, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Flexibility, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.HistoryScholar, 0, 0, 0, 0);
            this.player.skinDesc = "fur";
            this.player.skinTone = "ashen";
            this.player.skinType = appearanceDefs_1.SKIN_TYPE_FUR;
            this.player.tailType = appearanceDefs_1.TAIL_TYPE_CAT;
        ...
        customMirvanna() {
            ...
            this.outputText("You're an equine dragon-herm with a rather well-proportioned body.  Ingnam is certainly going to miss having you whoring yourself out around town.  You don't think they'll miss cleaning up all the messy sex, though.");
            this.player.gender = 3;
            this.player.spe += 3;
            this.player.inte += 2;
            this.player.str += 3;
            ...
            //Gender = Herm
            //Ears = Horse
            this.player.earType = appearanceDefs_1.EARS_HORSE;
            //Horns = Dragon
            this.player.hornType = appearanceDefs_1.HORNS_DRACONIC_X4_12_INCH_LONG;
            this.player.horns = 12;
            //Face = Horse
            this.player.faceType = appearanceDefs_1.FACE_HORSE;
            //Skin type = Black Fur
            ...
            this.player.lowerBody = appearanceDefs_1.LOWER_BODY_TYPE_HOOFED;
            //Wing type = Dragon
            ...
            this.player.createPerk(PerkLib_1.PerkLib.MessyOrgasms, 1.25, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.HistoryWhore, 0, 0, 0, 0);
        }
        customNami() {
            ...
            this.player.earType = appearanceDefs_1.EARS_DOG;
            //Tail- Canine
            this.player.tailType = appearanceDefs_1.TAIL_TYPE_DOG;
            //Lower body- Canine
            this.player.lowerBody = appearanceDefs_1.LOWER_BODY_TYPE_DOG;
            ...
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.BlackNipples, 0, 0, 0, 0);
            //Hair Length- Long
            ...
            this.player.tou = 15;
            this.clearOutput();
            this.outputText("Your exotic appearance caused you some trouble growing up, but you buried your nose in books until it came time to go through the portal.");
        }
        customNavorn() {
            this.outputText("There's been something special about you since day one, whether it's your numerous sexual endowments or your supernatural abilities.  You're a natural pick for champion.");
            ...
            this.player.cocks[0].cockThickness = 3;
            this.player.cocks[1].cockType = CockTypesEnum_1.CockTypesEnum.HORSE;
            ...
            this.player.cocks[3].cockType = CockTypesEnum_1.CockTypesEnum.DOG;
            this.player.cocks[3].cockLength = 15;
            this.player.cocks[3].cockThickness = 3;
            this.player.cocks[3].knotMultiplier = 2;
            this.player.cocks[4].cockType = CockTypesEnum_1.CockTypesEnum.DRAGON;
            this.player.cocks[4].cockLength = 15;
            this.player.cocks[4].cockThickness = 3;
            this.player.cocks[5].cockType = CockTypesEnum_1.CockTypesEnum.DRAGON;
            ...
            if (!this.player.hasVagina())
                this.player.createVagina();
            this.player.vaginas[0].vaginalWetness = appearanceDefs_1.VAGINA_WETNESS_SLAVERING;
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.BonusVCapacity, 132, 0, 0, 0);
        ...
        customNixi() {
            ...
            //full chain
            this.player.setArmor(this.armors.FULLCHN);
            this.outputText("As a German-Shepherd morph, the rest of the village never really knew what to do with you... until they sent you through the portal to face whatever's on the other side...");
        }
        customPrismere() {
            ...
            this.player.spe += 20;
            this.outputText("You're more of a scout than a fighter, but you still feel confident you can handle your responsibilities as champion.  After all, what's to worry about when you can outrun everything you encounter?  You have olive skin, deep red hair, and a demonic tail and wings to blend in with the locals.");
            ...
            this.player.wingType = appearanceDefs_1.WING_TYPE_BAT_LIKE_LARGE;
        ...
        customRannRayla() {
            ...
            this.outputText("You're a young, fiery redhead who\'s utterly feminine.  You've got C-cup breasts and long red hair.  Being a champion can\'t be that bad, right?");
            this.player.createVagina();
            this.player.clitLength = 0.25;
            this.player.createBreastRow();
            this.player.breastRows[0].breastRating = 3;
        ...
        customRope() {
            ...
            this.outputText("Despite outward appearances, you're actually something of a neuter, with shark-like teeth, an androgynous face, and a complete lack of genitalia.");
            if (this.player.hasCock())
                this.player.removeCock(0, 1);
            if (this.player.hasVagina())
            ...
            this.player.femininity = 50;
            this.player.faceType = appearanceDefs_1.FACE_SHARK_TEETH;
        }
        customSera() {
            this.outputText("You're something of a shemale - three rows of C-cup breasts matched with three, plump, juicy cocks.  Some decent sized balls, bat wings, and cat-like ears round out the package.");
            this.player.gender = 1;
            this.player.tou += 2;
            this.player.str += 3;
            this.player.fertility = 5;
        ...
        customSiveen() {
            ...
            this.player.wingType = appearanceDefs_1.WING_TYPE_HARPY;
            //Halo (Flaming)
            //D-cups
            this.player.createBreastRow();
            this.player.breastRows[0].breastRating = 4;
            ...
            this.flags[kFLAGS_1.kFLAGS.HISTORY_PERK_SELECTED] = 0;
            this.player.str = 25;
            this.player.tou = 25;
            this.player.inte = 25;
            this.player.spe = 25;
            this.outputText("You are a literal angel from beyond, and you take the place of a vilage's champion for your own reasons...");
        }
        customSora() {
            //Character Creation	Female,virgin	A kitsune with a snake-like tongue	Sora
            if (this.player.hasVagina())
                this.player.vaginas[0].virgin = true;
            this.player.tongueType = appearanceDefs_1.TONUGE_SNAKE;
            this.player.earType = appearanceDefs_1.EARS_FOX;
            this.player.tailType = appearanceDefs_1.TAIL_TYPE_FOX;
            ...
            if (this.player.findStatusAffect(StatusAffects_1.StatusAffects.BonusVCapacity) < 0)
                ...
                this.player.addStatusValue(StatusAffects_1.StatusAffects.BonusVCapacity, 1, 5 + CharCreation.rand(10));
            this.outputText("As a Kitsune, you always got weird looks, but none could doubt your affinity for magic...");
        }
        customTestChar() {
            ...
            this.player.lib = 30;
            this.player.cor = 71;
            kGAMECLASS_1.kGAMECLASS.notes = "Cheater!";
            this.player.HP = kGAMECLASS_1.kGAMECLASS.maxHP();
            this.player.hairLength = 10;
            this.player.skinType = appearanceDefs_1.SKIN_TYPE_PLAIN;
            this.player.faceType = appearanceDefs_1.FACE_HUMAN;
            ...
            this.player.fatigue = 0;
            this.player.horns = 0;
            this.player.hornType = appearanceDefs_1.HORNS_NONE;
            this.player.tallness = 109;
            this.player.tailVenom = 0;
            this.player.tailRecharge = 0;
            this.player.wingType = appearanceDefs_1.WING_TYPE_DRACONIC_LARGE;
            this.player.wingDesc = "non-existant";
            this.player.earType = appearanceDefs_1.EARS_HUMAN;
            this.player.lowerBody = appearanceDefs_1.LOWER_BODY_TYPE_HUMAN;
            this.player.armType = appearanceDefs_1.ARM_TYPE_HUMAN;
            ...
            this.player.createPerk(PerkLib_1.PerkLib.DoubleAttack, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.ImmovableObject, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.LightningStrikes, 0, 0, 0, 0);
            ...
            this.player.createPerk(PerkLib_1.PerkLib.Regeneration, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Regeneration2, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Resistance, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Resolute, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.SpeedyRecovery, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Tactician, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Tank, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Tank2, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.ThunderousStrikes, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.WeaponMastery, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.WellAdjusted, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.SensualLover, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.SensualLover, 0, 0, 0, 0);
            this.flags[kFLAGS_1.kFLAGS.VALARIA_AT_CAMP] = 1;
            this.player.gems += 30000;
            this.outputText("You're something of a powerhouse, and you wager that between your odd mutations, power strong enough to threaten the village order, and talents, you're the natural choice to send through the portal.");
            this.player.itemSlot4.unlocked = true;
            this.player.itemSlot5.unlocked = true;
            ...
            this.player.createStatusAffect(StatusAffects_1.StatusAffects.TelAdre, 1, 0, 0, 0);
            ...
            // Jojo
            kGAMECLASS_1.kGAMECLASS.monk = 5;
            // Bimbo Sophie
            ...
            this.flags[kFLAGS_1.kFLAGS.GOO_NAME] = "Latexy";
            ...
            // Milky
            this.flags[kFLAGS_1.kFLAGS.MILK_NAME] = "Milky";
            this.flags[kFLAGS_1.kFLAGS.MILK_SIZE] = 2;
            // Rubi Testing
            ...
            this.flags[kFLAGS_1.kFLAGS.RUBI_AFFECTION] = 75;
            this.flags[kFLAGS_1.kFLAGS.RUBI_INTRODUCED] = 1;
            // Bazaar
            this.flags[kFLAGS_1.kFLAGS.BAZAAR_ENTERED] = 1;
        }
        customTyriana() {
            this.outputText("Your many, posh tits, incredible fertility, and well-used cunt made you more popular than the village bicycle.  With your cat-like ears, paws, and tail, you certainly had a feline appeal.  It's time to see how you fare in the next chapter of your life.");
            //"Gender: Female
            this.player.gender = 2;
            ...
            this.player.vaginas[0].vaginalLooseness = appearanceDefs_1.VAGINA_LOOSENESS_LEVEL_CLOWN_CAR;
            this.player.vaginas[0].virgin = false;
            this.player.fertility = 50;
            //Butt: Just as loose
        ...
        customVahdunbrii() {
            ...
            this.player.createPerk(PerkLib_1.PerkLib.Incorporeality, 0, 0, 0, 0);
            this.player.wingType = appearanceDefs_1.WING_TYPE_FEATHERED_LARGE;
            this.player.armType = appearanceDefs_1.ARM_TYPE_HARPY;
            this.player.hornType = appearanceDefs_1.HORNS_DRACONIC_X2;
            this.player.horns = 4;
            this.player.faceType = appearanceDefs_1.FACE_SPIDER_FANGS;
            this.player.hairLength = 69.2;
            ...
            this.player.createPerk(PerkLib_1.PerkLib.HistoryReligious, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Dragonfire, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.BroodMother, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Fertile, 1.5, 0, 0, 0);
            this.player.vaginas[0].vaginalWetness = appearanceDefs_1.VAGINA_WETNESS_WET;
            this.player.createPerk(PerkLib_1.PerkLib.WetPussy, 2, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.Tough, 0.25, 0, 0, 0);
            ...
            this.player.itemSlot5.unlocked = true;
            this.player.createPerk(PerkLib_1.PerkLib.StrongBack2, 0, 0, 0, 0);
            this.player.createPerk(PerkLib_1.PerkLib.HistorySlacker, 0, 0, 0, 0);
            this.player.str += 4;
            this.player.tou += 4;
            this.player.inte += 2;
            this.player.spe += 2;
    ...
    exports.CharCreation = CharCreation;
});
//# sourceMappingURL=CharCreation.js.map