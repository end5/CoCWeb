define(["require", "exports", "../Armor", "../../PerkLib"], function (require, exports, Armor_1, PerkLib_1) {
    "use strict";
    ...
    class InquisitorsCorset extends Armor_1.Armor {
        ...
        playerEquip() {
            while (this.game.player.findPerk(PerkLib_1.PerkLib.BloodMage) >= 0)
                this.game.player.removePerk(PerkLib_1.PerkLib.BloodMage);
            ...
            this.game.player.createPerk(PerkLib_1.PerkLib.BloodMage, 0, 0, 0, 0);
            this.game.player.createPerk(PerkLib_1.PerkLib.SluttySeduction, 10, 0, 0, 0);
