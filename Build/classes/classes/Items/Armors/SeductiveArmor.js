define(["require", "exports", "../Armor", "../../GlobalFlags/kFLAGS", "../ArmorLib"], function (require, exports, Armor_1, kFLAGS_1, ArmorLib_1) {
    "use strict";
    ...
    class SeductiveArmor extends Armor_1.Armor {
        ...
        useText() {
            if (!this.game.ceraphFollowerScene.ceraphIsFollower()) {
                ...
                this.game.flags[kFLAGS_1.kFLAGS.PC_FETISH] = 2;
            }
            else {
        ...
        playerEquip() {
            super.playerEquip();
            return ArmorLib_1.ArmorLib.COMFORTABLE_UNDERCLOTHES; //After seductive armor magic the player is left in their underclothes
        }
    }
