define(["require", "exports", "./SimpleConsumable", "../../internals/Utils", "../../PerkLib"], function (require, exports, SimpleConsumable_1, Utils_1, PerkLib_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * Created by K.Quesom 11.06.14
     */
    class RizzaRoot extends SimpleConsumable_1.SimpleConsumable {
        rizzaRootEffect(player) {
            this.clearOutput();
            var changes = 0;
            var changeLimit = 1;
            ...
            if (player.findPerk(PerkLib_1.PerkLib.HistoryAlchemist) >= 0)
                changeLimit++;
            this.outputText("You chew on the thin red roots.  They have a rubbery texture and the taste is something like lemons and oranges mixed together.  The roots dry out your mouth as you chew them but at the same time they cause a cooling and numbing sensation that’s rather pleasant.");
            if ((changes < changeLimit) && (player.skinType != 0) && (Utils_1.Utils.rand(6) == 0)) {
            ...
            if ((changes < changeLimit) && (player.earType != 4) && (Utils_1.Utils.rand(4) == 0)) {
                player.earType = 4;
                changes++;
            ...
            if ((changes < changeLimit) && (player.tallness < 108)) {
                player.tallness += changeLimit - changes + Utils_1.Utils.rand(2); //Add remaining changes as additional height
