define(["require", "exports", "../Consumable", "../../internals/Utils", "../../../console"], function (require, exports, Consumable_1, Utils_1, console_1) {
    "use strict";
    ...
    class KitsuneGift extends Consumable_1.Consumable {
        ...
        useItem() {
            this.clearOutput();
            this.outputText("Curiosity gets the best of you, and you decide to open the package.  After all, what's the worst that could happen?\n\n");
            //Opening the gift randomly results in one of the following:
            switch (Utils_1.Utils.rand(12)) {
                //[Fox Jewel]
                case 0:
                    this.outputText("As the paper falls away, you carefully lift the cover of the box, your hands trembling nervously.  The inside of the box is lined with purple velvet, and to your delight, sitting in the center is a small teardrop-shaped jewel!");
                    this.outputText("\n\n<b>You've received a shining Fox Jewel from the kitsune's gift!  How generous!</b>  ");
                    this.game.inventory.takeItem(this.game.consumables.FOXJEWL, this.game.inventory.inventoryMenu);
                    return (true);
                //[Fox Berries]
                case 1:
                    this.outputText("As the paper falls away, you carefully lift the cover of the box, your hands trembling nervously.  The inside of the box is lined with purple velvet, and to your delight, there is a small cluster of orange-colored berries sitting in the center!");
                    this.outputText("\n\n<b>You've received a fox berry from the kitsune's gift!  How generous!</b>  ");
                    //add Fox Berries to inventory
                    this.game.inventory.takeItem(this.game.consumables.FOXBERY, this.game.inventory.inventoryMenu);
                    return (true);
                //[Gems]
                case 2:
                    this.outputText("As the paper falls away, you carefully lift the cover of the box, your hands trembling nervously.  The inside of the box is lined with purple velvet, and to your delight, it is filled to the brim with shining gems!");
                    var gems = 2 + Utils_1.Utils.rand(20);
                    this.outputText("\n\n<b>You've received " + Utils_1.Utils.num2Text(gems) + " shining gems from the kitsune's gift!  How generous!</b>");
                ...
                case 3:
                    this.outputText("As the paper falls away, you carefully lift the cover of the box, your hands trembling nervously.  The inside of the box is lined with purple velvet, and to your delight, it contains a small bag of dried tea leaves!");
                    this.outputText("\n\n<b>You've received a bag of tea from the kitsune's gift!  How thoughtful!</b>  ");
                    //add Kitsune Tea/Scholar's Tea to inventory
                    this.game.inventory.takeItem(this.game.consumables.SMART_T, this.game.inventory.inventoryMenu);
                    return (true);
                //[Hair Dye]
                case 4:
                    this.outputText("As the paper falls away, you carefully lift the cover of the box, your hands trembling nervously.  The inside of the box is lined with purple velvet, and to your delight, it contains a small vial filled with hair dye!");
                    var itype = [
                        this.game.consumables.RED_DYE,
                        this.game.consumables.BLOND_D,
                        this.game.consumables.BLACK_D,
                        this.game.consumables.WHITEDY
                    ][Utils_1.Utils.rand(4)];
                ...
                case 6:
                    ...
                    this.game.player.gems -= 2 + Utils_1.Utils.rand(15);
                    this.game.statScreenRefresh();
                    break;
                //[Prank]
                case 7:
                ...
                //[Dud]
                case 10:
                    this.outputText("As the paper falls away, you carefully lift the cover of the box, your hands trembling nervously.  The inside of the box is lined with purple velvet, but to your disappointment, the only other contents appear to be nothing more than twigs, leaves, and other forest refuse.");
                ...
                case 11:
                    ...
                    this.game.inventory.takeItem(this.game.useables.B_CHITN, this.game.inventory.inventoryMenu);
                    return (true);
                default: console_1.trace("Kitsune's gift roll foobar...");
            }
