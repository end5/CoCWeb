define(["require", "exports", "../Consumable", "../../internals/Utils", "../../CockTypesEnum"], function (require, exports, Consumable_1, Utils_1, CockTypesEnum_1) {
    "use strict";
    ...
    class Reducto extends Consumable_1.Consumable {
        ...
        useItem() {
            ...
            this.game.choices("Balls", rdtBalls, "Breasts", rdtBreasts, "Butt", rdtButt, "Clit", rdtClit, "Cock", rdtCock, "Hips", rdtHips, "Nipples", rdtNipples, "", undefined, "", undefined, "Nevermind", this.reductoCancel);
            return (true);
        }
        reductoBalls() {
            this.clearOutput();
            ...
            if (this.game.player.ballSize < 1)
                this.game.player.ballSize = 1;
        ...
        reductoBreasts() {
            ...
            if (Utils_1.Utils.rand(2) == 0 && this.game.player.biggestTitSize() >= 1) {
        ...
        reductoButt() {
            ...
            if (this.game.player.buttRating >= 15) {
                ...
                this.game.player.buttRating -= Utils_1.Utils.rand(3) + 1;
                if (this.game.player.buttRating < 1)
                    this.game.player.buttRating = 1;
        ...
        reductoCock() {
            this.clearOutput();
            if (this.game.player.cocks[0].cockType == CockTypesEnum_1.CockTypesEnum.BEE) {
                ...
                this.game.player.cocks[0].cockType = CockTypesEnum_1.CockTypesEnum.HUMAN;
            }
            else {
        ...
        reductoHips() {
            ...
            if (this.game.player.hipRating >= 15) {
                ...
                this.game.player.hipRating -= Utils_1.Utils.rand(3) + 1;
                if (this.game.player.hipRating < 1)
                    this.game.player.hipRating = 1;
